...
// CHECK: ripple does not allow implicit broadcasting of a store address to the value address; the value has Tensor[32] and the address has Tensor[1]. Hint: use ripple_id() for the address computation or use a reduction operation
