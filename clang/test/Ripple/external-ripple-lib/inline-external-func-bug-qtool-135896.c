...
// RUN: %clang -ffreestanding -march=armv9.2-a+sme --target=aarch64-unknown-linux-gnu -O2 -msve-streaming-vector-bits=512 -fenable-ripple -fripple-lib=%t.bc %s -emit-llvm -S -o %t.ll
