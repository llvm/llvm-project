...
// RUN: %clang -Xclang -disable-llvm-passes -fenable-ripple -Wpedantic -S -O1 -emit-llvm %s -o - 2>&1 | FileCheck %s --check-prefixes=CHECKCLANGGEN,CHECKALL --implicit-check-not="warning:" --implicit-check-not="error:"
// RUN: %clang -Xclang -disable-llvm-passes -fenable-ripple -x c++ -Wpedantic -S -O1 -emit-llvm %s -o - 2>&1 | FileCheck %s --check-prefixes=CHECKCLANGGEN,CHECKALL --implicit-check-not="warning:" --implicit-check-not="error:"
// RUN: %clang -fenable-ripple -Wpedantic -S -O1 -emit-llvm %s -o - 2>&1 | FileCheck %s --check-prefixes=CHECKRIPPLEGEN,CHECKALL --implicit-check-not="warning:" --implicit-check-not="error:"
// RUN: %clang -fenable-ripple -x c++ -Wpedantic -S -O1 -emit-llvm %s -o - 2>&1 | FileCheck %s --check-prefixes=CHECKRIPPLEGEN,CHECKALL --implicit-check-not="warning:" --implicit-check-not="error:"

// We generate two successive reductions in the tests; In C++, clang generates a
// single lambda for both calls. Hence we make sure that at least one call
// exists in C/C++ clang output and we verify that both calls are present (after
// inlining) in the LLVM IR after the ripple pass.
...
// CHECKALL-LABEL: check_reduction_add_u8
...
// CHECKALL-LABEL: check_reduction_add_i8
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.add.v128i8

gen_reduce_test (64, add, uint16_t, u16)
// CHECKALL-LABEL: check_reduction_add_u16
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.add.v64i16

gen_reduce_test (64, add, int16_t, i16)
// CHECKALL-LABEL: check_reduction_add_i16
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.add.v64i16

gen_reduce_test (32, add, uint32_t, u32)
// CHECKALL-LABEL: check_reduction_add_u32
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.add.v32i32

gen_reduce_test (32, add, int32_t, i32)
// CHECKALL-LABEL: check_reduction_add_i32
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.add.v32i32

gen_reduce_test (16, add, uint64_t, u64)
// CHECKALL-LABEL: check_reduction_add_u64
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.add.v16i64

gen_reduce_test (16, add, int64_t, i64)
// CHECKALL-LABEL: check_reduction_add_i64
// CHECKCLANGGEN: @llvm.ripple.reduce.add.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.add.v16i64

gen_reduce_test (32, add, float, f32)
// CHECKALL-LABEL: check_reduction_add_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fadd.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fadd.v32f32

gen_reduce_test (16, add, double, f64)
// CHECKALL-LABEL: check_reduction_add_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fadd.f64(i64 1, double
...
// CHECKALL-LABEL: check_reduction_mul_u8
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.mul.v128i8

gen_reduce_test (128, mul, int8_t, i8)
// CHECKALL-LABEL: check_reduction_mul_i8
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.mul.v128i8

gen_reduce_test (64, mul, uint16_t, u16)
// CHECKALL-LABEL: check_reduction_mul_u16
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.mul.v64i16

gen_reduce_test (64, mul, int16_t, i16)
// CHECKALL-LABEL: check_reduction_mul_i16
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.mul.v64i16

gen_reduce_test (32, mul, uint32_t, u32)
// CHECKALL-LABEL: check_reduction_mul_u32
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.mul.v32i32

gen_reduce_test (32, mul, int32_t, i32)
// CHECKALL-LABEL: check_reduction_mul_i32
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.mul.v32i32

gen_reduce_test (16, mul, uint64_t, u64)
// CHECKALL-LABEL: check_reduction_mul_u64
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.mul.v16i64

gen_reduce_test (16, mul, int64_t, i64)
// CHECKALL-LABEL: check_reduction_mul_i64
// CHECKCLANGGEN: @llvm.ripple.reduce.mul.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.mul.v16i64

gen_reduce_test (32, mul, float, f32)
// CHECKALL-LABEL: check_reduction_mul_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fmul.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fmul.v32f32

gen_reduce_test (16, mul, double, f64)
// CHECKALL-LABEL: check_reduction_mul_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fmul.f64(i64 1, double
...
// CHECKALL-LABEL: check_reduction_max_u8
// CHECKCLANGGEN: @llvm.ripple.reduce.umax.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.umax.v128i8(

gen_reduce_test (128, max, int8_t, i8)
// CHECKALL-LABEL: check_reduction_max_i8
// CHECKCLANGGEN: @llvm.ripple.reduce.smax.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.smax.v128i8(

gen_reduce_test (64, max, uint16_t, u16)
// CHECKALL-LABEL: check_reduction_max_u16
// CHECKCLANGGEN: @llvm.ripple.reduce.umax.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.umax.v64i16(

gen_reduce_test (64, max, int16_t, i16)
// CHECKALL-LABEL: check_reduction_max_i16
// CHECKCLANGGEN: @llvm.ripple.reduce.smax.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.smax.v64i16(

gen_reduce_test (32, max, uint32_t, u32)
// CHECKALL-LABEL: check_reduction_max_u32
// CHECKCLANGGEN: @llvm.ripple.reduce.umax.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.umax.v32i32(

gen_reduce_test (32, max, int32_t, i32)
// CHECKALL-LABEL: check_reduction_max_i32
// CHECKCLANGGEN: @llvm.ripple.reduce.smax.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.smax.v32i32(

gen_reduce_test (16, max, uint64_t, u64)
// CHECKALL-LABEL: check_reduction_max_u64
// CHECKCLANGGEN: @llvm.ripple.reduce.umax.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.umax.v16i64(

gen_reduce_test (16, max, int64_t, i64)
// CHECKALL-LABEL: check_reduction_max_i64
// CHECKCLANGGEN: @llvm.ripple.reduce.smax.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.smax.v16i64(

gen_reduce_test (32, max, float, f32)
// CHECKALL-LABEL: check_reduction_max_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fmax.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fmax.v32f32(

gen_reduce_test (16, max, double, f64)
// CHECKALL-LABEL: check_reduction_max_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fmax.f64(i64 1, double
// CHECKRIPPLEGEN-COUNT-2: call reassoc double @llvm.vector.reduce.fmax.v16f64(

gen_reduce_test (32, maximum, float, f32)
// CHECKALL-LABEL: check_reduction_maximum_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fmaximum.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fmaximum.v32f32(

gen_reduce_test (16, maximum, double, f64)
// CHECKALL-LABEL: check_reduction_maximum_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fmaximum.f64(i64 1, double
...
// CHECKALL-LABEL: check_reduction_min_u8
// CHECKCLANGGEN: @llvm.ripple.reduce.umin.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.umin.v128i8(

gen_reduce_test (128, min, int8_t, i8)
// CHECKALL-LABEL: check_reduction_min_i8
// CHECKCLANGGEN: @llvm.ripple.reduce.smin.i8(i64 1, i8
// CHECKRIPPLEGEN-COUNT-2: call i8 @llvm.vector.reduce.smin.v128i8(

gen_reduce_test (64, min, uint16_t, u16)
// CHECKALL-LABEL: check_reduction_min_u16
// CHECKCLANGGEN: @llvm.ripple.reduce.umin.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.umin.v64i16(

gen_reduce_test (64, min, int16_t, i16)
// CHECKALL-LABEL: check_reduction_min_i16
// CHECKCLANGGEN: @llvm.ripple.reduce.smin.i16(i64 1, i16
// CHECKRIPPLEGEN-COUNT-2: call i16 @llvm.vector.reduce.smin.v64i16(

gen_reduce_test (32, min, uint32_t, u32)
// CHECKALL-LABEL: check_reduction_min_u32
// CHECKCLANGGEN: @llvm.ripple.reduce.umin.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.umin.v32i32(

gen_reduce_test (32, min, int32_t, i32)
// CHECKALL-LABEL: check_reduction_min_i32
// CHECKCLANGGEN: @llvm.ripple.reduce.smin.i32(i64 1, i32
// CHECKRIPPLEGEN-COUNT-2: call i32 @llvm.vector.reduce.smin.v32i32(

gen_reduce_test (16, min, uint64_t, u64)
// CHECKALL-LABEL: check_reduction_min_u64
// CHECKCLANGGEN: @llvm.ripple.reduce.umin.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.umin.v16i64(

gen_reduce_test (16, min, int64_t, i64)
// CHECKALL-LABEL: check_reduction_min_i64
// CHECKCLANGGEN: @llvm.ripple.reduce.smin.i64(i64 1, i64
// CHECKRIPPLEGEN-COUNT-2: call i64 @llvm.vector.reduce.smin.v16i64(

gen_reduce_test (32, min, float, f32)
// CHECKALL-LABEL: check_reduction_min_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fmin.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fmin.v32f32(

gen_reduce_test (16, min, double, f64)
// CHECKALL-LABEL: check_reduction_min_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fmin.f64(i64 1, double
// CHECKRIPPLEGEN-COUNT-2: call reassoc double @llvm.vector.reduce.fmin.v16f64(

gen_reduce_test (32, minimum, float, f32)
// CHECKALL-LABEL: check_reduction_minimum_f32
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}float @llvm.ripple.reduce.fminimum.f32(i64 1, float
// CHECKRIPPLEGEN-COUNT-2: call reassoc float @llvm.vector.reduce.fminimum.v32f32(

gen_reduce_test (16, minimum, double, f64)
// CHECKALL-LABEL: check_reduction_minimum_f64
// CHECKCLANGGEN: call{{.*}}reassoc{{.*}}double @llvm.ripple.reduce.fminimum.f64(i64 1, double
...
// CHECKCLANGGEN: @llvm.ripple.reduce.and.i8(i64 1, i8
...
// CHECKCLANGGEN: @llvm.ripple.reduce.and.i16(i64 1, i16
...
// CHECKCLANGGEN: @llvm.ripple.reduce.and.i32(i64 1, i32
...
// CHECKCLANGGEN: @llvm.ripple.reduce.and.i64(i64 1, i64
...
// CHECKCLANGGEN: @llvm.ripple.reduce.or.i8(i64 1, i8
...
// CHECKCLANGGEN: @llvm.ripple.reduce.or.i16(i64 1, i16
...
// CHECKCLANGGEN: @llvm.ripple.reduce.or.i32(i64 1, i32
...
// CHECKCLANGGEN: @llvm.ripple.reduce.or.i64(i64 1, i64
...
// CHECKCLANGGEN: @llvm.ripple.reduce.xor.i8(i64 1, i8
...
// CHECKCLANGGEN: @llvm.ripple.reduce.xor.i16(i64 1, i16
...
// CHECKCLANGGEN: @llvm.ripple.reduce.xor.i32(i64 1, i32
...
// CHECKCLANGGEN: @llvm.ripple.reduce.xor.i64(i64 1, i64
