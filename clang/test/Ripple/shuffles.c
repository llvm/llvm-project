...
// RUN: %clang -S -fenable-ripple -Xclang -disable-llvm-passes -emit-llvm %s -o - 2>&1 | FileCheck %s --implicit-check-not="warning:" --implicit-check-not="error:"
...
// CHECK: llvm.ripple.shuffle.i8(i8 %{{[0-9]+}}, i8 %{{[0-9]+}}, i1 false, ptr @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i16(i16 %{{[0-9]+}}, i16 %{{[0-9]+}}, i1 false, ptr @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i32(i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i1 false, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i64(i64 %{{[0-9]+}}, i64 %{{[0-9]+}}, i1 false, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.p0(ptr {{.*}}, ptr {{.*}}, i1 false, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i8(i8 %{{[0-9]+}}, i8 %{{[0-9]+}}, i1 true, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i16(i16 %{{[0-9]+}}, i16 %{{[0-9]+}}, i1 true, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i32(i32 %{{[0-9]+}}, i32 %{{[0-9]+}}, i1 true, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.i64(i64 %{{[0-9]+}}, i64 %{{[0-9]+}}, i1 true, ptr  @get_src_id)
// CHECK: ret
...
// CHECK: llvm.ripple.shuffle.p0(ptr %{{.*}}, ptr %{{.*}}, i1 true, ptr  @get_src_id)
// CHECK: ret
