...
// CHECK: call void @calleeWeak(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %[[AGG_TMP]], ptr nofree noundef align 8 dead_on_return dereferenceable(16) %[[AGG_TMP1]])
// CHECK: ret void
