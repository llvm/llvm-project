...
// CHECK-OFAST: use '-O3 -ffast math' for the same behavior, or '-O3' to enable conforming optimizations only
// CHECK-OFAST: -cc1
...
// CHECK-OFAST-NO-FAST-MATH: use '-O3 -ffast math' for the same behavior, or '-O3' to enable conforming optimizations only
...
// CHECK-OFAST-NO-STRICT-ALIASING: use '-O3 -ffast math' for the same behavior, or '-O3' to enable conforming optimizations only
...
// CHECK-OFAST-NO-VECTORIZE: use '-O3 -ffast math' for the same behavior, or '-O3' to enable conforming optimizations only
