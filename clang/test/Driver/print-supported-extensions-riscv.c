...
// CHECK-NEXT:     smip                 0.19      'Smip' (Support for Interrupt Handler Push/Pop at Machine Level)
...
// CHECK-NEXT:     sseihv               0.19      'Sseihv' (External Interrupt Hardware Vectoring at Supervisor Level)
// CHECK-NEXT:     ssijt                0.19      'Ssijt' (Interrupt Jump Table at Supervisor Level)
// CHECK-NEXT:     ssip                 0.19      'Ssip' (Support for Interrupt Handler Push/Pop at Supervisor Level)
