...
// RUN:   -no-hip-rt -nogpuinc -c -o e/a.o --target=x86_64-linux-gnu 2>&1 \
...
// RUN: %clang -### -ftime-trace -ftime-trace-granularity=0 -x hip d/a.cpp --offload-arch=gfx906 --offload-arch=gfx90a \
// RUN:   -no-hip-rt -nogpuinc -c -o e/a.o --target=x86_64-linux-gnu --offload-new-driver 2>&1 \
// RUN:   | FileCheck %s --check-prefix=HIP
...
// RUN:   -no-hip-rt -nogpuinc -c -o e/a.o --target=x86_64-linux-gnu --save-temps 2>&1 \
