...
// RUN: %clang -fsycl --offload-targets=spirv64-unknown-unknown -Xarch_spirv64 -O3 -### %s --no-offloadlib 2>&1 \
...
// RUN: %clang -fsycl --offload-targets=spirv64-unknown-unknown --no-offloadlib -Xarch_spirv64 -Wl,-lfoo -### %s 2>&1 \
