...
// CHECK-OPENMP-DAG: "-u" "__ubsan_device_init"
// CHECK-OPENMP-DAG: "{{[^"]*}}x86_64-unknown-linux-gnu{{/|\\\\}}libclang_rt.ubsan_device.a"
...
// CHECK-HIP-HOST-DAG: "-u" "__ubsan_device_init"
// CHECK-HIP-HOST-DAG: "{{[^"]*}}x86_64-unknown-linux-gnu{{/|\\\\}}libclang_rt.ubsan_device.a"
...
// CHECK-XARCH-DEV-DAG: "-u" "__ubsan_device_init"
// CHECK-XARCH-DEV-DAG: "{{[^"]*}}x86_64-unknown-linux-gnu{{/|\\\\}}libclang_rt.ubsan_device.a"
...
// CHECK-XARCH-HOST-NOT: ubsan_device
// CHECK-XARCH-HOST-NOT: __ubsan_device_init

// RUN: %clang -no-canonical-prefixes -### --target=x86_64-unknown-linux-gnu \
// RUN:     -fsanitize=undefined \
// RUN:     -resource-dir=%S/Inputs/resource_dir_with_amdgpu_per_target_subdir %s 2>&1 \
// RUN:   | FileCheck %s --check-prefix=CHECK-HOST
// CHECK-HOST-NOT: ubsan_device
// CHECK-HOST-NOT: __ubsan_device_init
...
// CHECK-MINIMAL-NOT: ubsan_device
// CHECK-MINIMAL-NOT: __ubsan_device_init
