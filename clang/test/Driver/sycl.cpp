// RUN: %clang -### -fsycl -c %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl -sycl-std=1.2.1 %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl -sycl-std=121 %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl -sycl-std=2017 %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl -sycl-std=2020 %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fsycl -sycl-std=sycl-1.2.1 %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -fno-sycl -fsycl %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang -### -sycl-std=2017 %s 2>&1 | FileCheck %s --check-prefix=DISABLED
// RUN: %clangxx -### -fsycl %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
...
// RUN: %clang_cl -### -fsycl -sycl-std=2017 -- %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
// RUN: %clang_cl -### -fsycl -- %s --sysroot=%S/Inputs/SYCL 2>&1 | FileCheck %s --check-prefix=ENABLED
