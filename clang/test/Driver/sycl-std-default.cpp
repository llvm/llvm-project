...
// RUN: %clangxx -### -fsycl -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefixes=CHECK-DEVICE,CHECK-HOST
...
// RUN: %clangxx -### -fsycl -std=c++20 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefixes=CHECK-OVERRIDE-DEVICE,CHECK-OVERRIDE-HOST
...
// RUN: not %clangxx -fsycl -std=c++14 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefix=CHECK-CXX14-ERROR
// RUN: not %clangxx -fsycl -std=c++11 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefix=CHECK-CXX11-ERROR
// RUN: not %clangxx -fsycl -std=c++98 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefix=CHECK-CXX98-ERROR
...
// RUN: not %clangxx -fsycl -std=c11 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefix=CHECK-C11-ERROR
// RUN: not %clangxx -fsycl -std=c99 -c %s --no-offloadlib 2>&1 | FileCheck %s --check-prefix=CHECK-C99-ERROR
...
// RUN: %clang_cl --no-offloadlib --target=x86_64-pc-windows-msvc -### -fsycl -- %s 2>&1 | FileCheck %s --check-prefixes=CHECK-MSVC-DEVICE,CHECK-MSVC-HOST
...
// RUN: %clang_cl --target=x86_64-pc-windows-msvc -### -fsycl /std:c++20 --no-offloadlib -- %s 2>&1 | FileCheck %s --check-prefixes=CHECK-MSVC-OVERRIDE-DEVICE,CHECK-MSVC-OVERRIDE-HOST
...
// RUN: not %clang_cl --target=x86_64-pc-windows-msvc -fsycl /std:c++14 --no-offloadlib -- %s 2>&1 | FileCheck %s --check-prefix=CHECK-MSVC-CXX14-ERROR
...
// RUN: not %clang_cl --target=x86_64-pc-windows-msvc -fsycl /std:c11 --no-offloadlib -- %s 2>&1 | FileCheck %s --check-prefix=CHECK-MSVC-C-ERROR
