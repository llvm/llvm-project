...
// RUN: %t/only-global.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK1
// CHECK1: remark: found C++20 module usage in file '{{.*}}' [-Rmodules-driver]
module;

//--- only-import.cpp
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/only-import.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK2
// CHECK2: remark: found C++20 module usage in file '{{.*}}' [-Rmodules-driver]
import A;

//--- only-export.cpp
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/only-export.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK3
// CHECK3: remark: found C++20 module usage in file '{{.*}}' [-Rmodules-driver]
export module A;

//--- leading-line-comment.cpp
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-line-comment.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK4
...
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-block-comment1.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK5
...
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-block-comment2.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK6
// CHECK6: remark: found C++20 module usage in file '{{.*}}' [-Rmodules-driver]
/*My line comment */ import A;

//--- inline-block-comment1.cpp
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-block-comment1.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK7
...
// RUN: %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-block-comment2.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK8
...
// RUN: %t/leading-directives.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK9
...
// RUN: %clang -std=c++23 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/multiline-directive.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK10
...
// RUN: %clang -std=c++23 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-line-splice.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK11
...
// RUN: %clang -std=c++23 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/leading-line-splice-trailing-whitespace.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK12
...
// RUN: %clang -std=c++23 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/line-splice-in-directive1.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK15
...
// RUN: %clang -std=c++23 -ccc-print-phases -fmodules-driver -Rmodules-driver \
// RUN: %t/line-splice-in-directive2.cpp %t/empty.cpp 2>&1 | FileCheck %s --check-prefix=CHECK16
...
// RUN: not %clang -std=c++20 -ccc-print-phases -fmodules-driver -Rmodules-driver -ccc-print-phases \
