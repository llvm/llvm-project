...
// RUN: %clang --target=riscv64 -### -c %s 2>&1 -mcpu=gr765 | FileCheck -check-prefix=MCPU-GR765 %s
// COM: The list of extensions are tested in `test/Driver/print-enabled-extensions/riscv-gr765.c`
