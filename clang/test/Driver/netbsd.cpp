...
// "{{.*}}.o" "-lc++" X86_64: "-lm" "-lc" "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" AARCH64: "-lm" "-lc"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" AARCH64_BE: "-lm"
// "-lc" AARCH64_BE: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"

// RISCV32: "-cc1" "-triple" "riscv32-unknown-netbsd"
// RISCV32: ld{{.*}}" "--eh-frame-hdr" "-dynamic-linker" "/libexec/ld.elf_so"
// RISCV32-SAME: "-X"
// RISCV32-SAME: "-o" "a.out" "{{.*}}/usr/lib{{/|\\\\}}crt0.o"
// "{{.*}}/usr/lib{{/|\\\\}}crti.o" RISCV32-SAME:
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" RISCV32-SAME: "-lm"
// "-lc" RISCV32-SAME: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"

// RISCV64: "-cc1" "-triple" "riscv64-unknown-netbsd"
// RISCV64: ld{{.*}}" "--eh-frame-hdr" "-dynamic-linker" "/libexec/ld.elf_so"
// RISCV64-SAME: "-X"
// RISCV64-SAME: "-o" "a.out" "{{.*}}/usr/lib{{/|\\\\}}crt0.o"
// "{{.*}}/usr/lib{{/|\\\\}}crti.o" RISCV64-SAME:
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" RISCV64-SAME: "-lm"
// "-lc" RISCV64-SAME: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" SPARC64: "-lm" "-lc"
...
// POWERPC: "-lm" "-lc" "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// POWERPC64: "-lm" "-lc" "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-X86_64: "-lm" "-lc"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-AARCH64: "-lm"
// "-lc" S-AARCH64: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-AARCH64_BE: "-lm"
// "-lc" S-AARCH64_BE: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"

// S-RISCV32: "-cc1" "-triple" "riscv32-unknown-netbsd"
// S-RISCV32: ld{{.*}}" "--eh-frame-hdr" "-Bstatic"
// S-RISCV32-SAME: "-X"
// S-RISCV32-SAME: "-o" "a.out" "{{.*}}/usr/lib{{/|\\\\}}crt0.o"
// "{{.*}}/usr/lib{{/|\\\\}}crti.o" S-RISCV32-SAME:
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-RISCV32-SAME: "-lm"
// "-lc" S-RISCV32-SAME: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"

// S-RISCV64: "-cc1" "-triple" "riscv64-unknown-netbsd"
// S-RISCV64: ld{{.*}}" "--eh-frame-hdr" "-Bstatic"
// S-RISCV64-SAME: "-X"
// S-RISCV64-SAME: "-o" "a.out" "{{.*}}/usr/lib{{/|\\\\}}crt0.o"
// "{{.*}}/usr/lib{{/|\\\\}}crti.o" S-RISCV64-SAME:
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-RISCV64-SAME: "-lm"
// "-lc" S-RISCV64-SAME: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// S-SPARC64: "-o" "a.out" "{{.*}}/usr/lib{{/|\\\\}}crt0.o"
// "{{.*}}/usr/lib{{/|\\\\}}crti.o" S-SPARC64:
// "{{.*}}/usr/lib{{/|\\\\}}crtbegin.o" "{{.*}}.o" "-lc++" S-SPARC64: "-lm"
// "-lc" S-SPARC64: "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// S-POWERPC: "-lm" "-lc" "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// S-POWERPC64: "-lm" "-lc" "{{.*}}/usr/lib{{/|\\\\}}crtend.o"
// "{{.*}}/usr/lib{{/|\\\\}}crtn.o"
...
// "[[RESOURCE]]{{/|\\\\}}include" DRIVER-PASS-INCLUDES:
...
// CHECK-BASIC-LIBSTDCXX-SYSROOT-SLASH-SAME: "-internal-isystem"
// "[[SYSROOT]]usr/include/g++"
