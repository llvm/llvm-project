...
// RUN: %clang -Wunused-command-line-argument -pthreads -target x86_64-apple-darwin -### /dev/null -o /dev/null 2>&1 | FileCheck %s
...
// CHECK-NOT: argument unused during compilation: '-pthreads'
