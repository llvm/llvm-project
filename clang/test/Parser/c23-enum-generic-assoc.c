...
static_assert(_Generic(0, struct S { enum F : int {A} : 1; } : 0, int: 1)); // expected-no-diagnostics
static_assert(_Generic(0, struct S { enum E : 1; } : 0, int: 1)); // expected-no-diagnostics
