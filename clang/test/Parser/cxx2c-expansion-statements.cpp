...
void bad() {
  ...
  template for (); // expected-error {{expected expression}} expected-error {{expected ';' in 'for' statement specifier}} expected-error {{expansion statement must use the syntax of a range-based for loop}} expected-error {{TODO (expansion statements)}}
  template for (;); // expected-error {{expected ';' in 'for' statement specifier}} expected-error {{expansion statement must use the syntax of a range-based for loop}} expected-error {{TODO (expansion statements)}}
  template for (;;); // expected-error {{expansion statement must use the syntax of a range-based for loop}} expected-error {{TODO (expansion statements)}}
  template for (int x;;); // expected-error {{expansion statement must use the syntax of a range-based for loop}} expected-error {{TODO (expansion statements)}}
  ...
  template for (: {1}); // expected-error {{expected expression}} expected-error {{expected ';' in 'for' statement specifier}} expected-error {{expansion statement must use the syntax of a range-based for loop}} expected-error {{TODO (expansion statements)}}
  ...
  template for (register auto y : {1, 2}); // expected-error {{expansion variable 'y' may not be declared 'register'}} expected-error {{ISO C++17 does not allow 'register' storage class specifier}} expected-error {{TODO (expansion statements)}}
  template for (__private_extern__ auto y : {1, 2}); // expected-error {{expansion variable 'y' may not be declared 'extern'}} expected-error {{TODO (expansion statements)}}
