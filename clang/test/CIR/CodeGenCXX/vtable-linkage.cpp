...
// RUN: %clang_cc1 %s -triple=x86_64-pc-linux -std=c++11 -emit-llvm -o - | FileCheck %s --check-prefixes=LLVM
...
// CIR-DAG: cir.global constant external @_ZTI1C = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv121__vmi_class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1C> : !cir.ptr<!u8i>, #cir.int<0> : !u32i, #cir.int<1> : !u32i, #cir.global_view<@_ZTI1B> : !cir.ptr<!u8i>, #cir.int<-8189> : !s64i}> : !{{.*}}{alignment = 8 : i64}
...
// LLVM-DAG: @_ZTI1C = {{.*}}{ ptr, ptr, i32, i32, ptr, i64 } { ptr getelementptr{{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv121__vmi_class_type_infoE, i64 {{.*}}), ptr @_ZTS1C, i32 0, i32 1, ptr @_ZTI1B, i64 -8189 }
...
// LLVM-DAG: @_ZTV1D = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI1D, ptr @_ZN1D1fEv] }, align 8
// LLVM-DAG: @_ZTS1D = {{.*}}[{{[0-9]}} x i8] c"1D\00", align 1
// LLVM-DAG: @_ZTI1D = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{[0-9]+}}), ptr @_ZTS1D }, align 8
...
// LLVM-DAG: @_ZTV1EIcE = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI1EIcE, ptr @_ZN1EIcE6anchorEv] }, align 8
// LLVM-DAG: @_ZTS1EIcE = {{.*}}[6 x i8] c"1EIcE\00", align 1
// LLVM-DAG: @_ZTI1EIcE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1EIcE }, align 8
...
// CIR-DAG: cir.global constant external @_ZTI1EIsE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1EIsE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
...
// LLVM-DAG: @_ZTV1EIsE = {{.*}}{ [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI1EIsE, ptr @_ZN1EIsED1Ev, ptr @_ZN1EIsED0Ev] }, comdat, align 8
// LLVM-DAG: @_ZTI1EIsE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1EIsE }
// LLVM-DAG: @_ZTS1EIsE = {{.*}}[6 x i8] c"1EIsE\00"
...
// CIR-DAG: cir.global constant external @_ZTI1FIsE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1FIsE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTV1FIsE = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI1FIsE, ptr @_ZN1FIsE3fooEv] }, comdat, align 8
// LLVM-DAG: @_ZTS1FIsE = {{.*}}[6 x i8] c"1FIsE\00", comdat, align 1
// LLVM-DAG: @_ZTI1FIsE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1FIsE }
...
// CIR-DAG: cir.global constant external @_ZTI1EIlE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1EIlE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTV1EIlE = {{.*}}{ [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI1EIlE, ptr @_ZN1EIlED1Ev, ptr @_ZN1EIlED0Ev] }, comdat, align 8
// LLVM-DAG: @_ZTS1EIlE = {{.*}}[6 x i8] c"1EIlE\00", comdat, align 1
// LLVM-DAG: @_ZTI1EIlE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1EIlE }
...
// CIR-DAG: cir.global constant external @_ZTI1FIlE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1FIlE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTV1FIlE = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI1FIlE, ptr @_ZN1FIlE3fooEv] }, comdat, align 8
// LLVM-DAG: @_ZTS1FIlE = {{.*}}[6 x i8] c"1FIlE\00", comdat, align 1
// LLVM-DAG: @_ZTI1FIlE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1FIlE }

// F<int> is an explicit template instantiation declaration without a
// key function, so its vtable should have external linkage.
// CIR-DAG: cir.global "private" external @_ZTV1FIiE : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTV1FIiE = {{.*}}{ [3 x ptr] }, align 8
...
// LLVM-DAG: @_ZTV1EIiE = {{.*}}{ [4 x ptr] }, align 8
...
// CIR-DAG: cir.global constant external @_ZTI3$_0 = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv120__si_class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS3$_0> : !cir.ptr<!u8i>, #cir.global_view<@_ZTI1D> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @"_ZTV3$_0" = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @"_ZTI3$_0", ptr @_ZN1D1fEv] }, align 8
// LLVM-DAG: @"_ZTS3$_0" = {{.*}}[5 x i8] c"3$_0\00", align 1
// LLVM-DAG: @"_ZTI3$_0" = {{.*}}{ ptr, ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 {{.*}}), ptr @"_ZTS3$_0", ptr @_ZTI1D }, align 8
...
// CIR-DAG: cir.global constant external @_ZTIN12_GLOBAL__N_11AE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTSN12_GLOBAL__N_11AE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTVN12_GLOBAL__N_11AE = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTIN12_GLOBAL__N_11AE, ptr @_ZN12_GLOBAL__N_11A1fEv] }, align 8
// LLVM-DAG: @_ZTSN12_GLOBAL__N_11AE = {{.*}}[19 x i8] c"N12_GLOBAL__N_11AE\00", align 1
// LLVM-DAG: @_ZTIN12_GLOBAL__N_11AE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTSN12_GLOBAL__N_11AE }, align 8
...
// CIR-DAG: cir.global constant external @_ZTI1FIcE = #cir.typeinfo<{#cir.global_view<@_ZTVN10__cxxabiv117__class_type_infoE, [2 : i32]> : !cir.ptr<!u8i>, #cir.global_view<@_ZTS1FIcE> : !cir.ptr<!u8i>}> : !{{.*}}{alignment = 8 : i64}
// LLVM-DAG: @_ZTV1FIcE = {{.*}}{ [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI1FIcE, ptr @_ZN1FIcE3fooEv] }, comdat, align 8
// LLVM-DAG: @_ZTS1FIcE = {{.*}}[6 x i8] c"1FIcE\00", comdat, align 1
// LLVM-DAG: @_ZTI1FIcE = {{.*}}{ ptr, ptr } { ptr getelementptr {{.*}}({{.*}}, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 {{.*}}), ptr @_ZTS1FIcE }
...
// LLVM-DAG: @_ZTV1GIiE = {{.*}}{ [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI1GIiE, ptr @_ZN1GIiE2f0Ev, ptr @_ZN1GIiE2f1Ev] }, comdat, align 8
template <typename T>
class G {
public:
  G() {}
...
// LLVM-DAG: @_ZTV1HIiE = {{.*}}{ [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI1HIiE, ptr @_ZN1HIiED1Ev, ptr @_ZN1HIiED0Ev] }, comdat, align 8
template <typename T>
class H {
public:
  virtual ~H();
...
// LLVM-DAG: @_ZTV1IIiE = {{.*}}{ [5 x ptr] }, align 8
// LLVM-DAG: @_ZTT1IIiE = {{.*}}[4 x ptr], align 8
