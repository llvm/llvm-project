...
void fn(int n) {
  ...
  // CIR: cir.libc.memset %[[REST_SIZE]] bytes at %[[REST_ALLOC_AS_VOID]] align(4) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i
...
void const_sufficient() {
  ...
  // CIR: %[[ZERO:.*]] = cir.const #cir.int<0> : !u8i
  // CIR: cir.libc.memset %[[REST_SIZE]] bytes at %[[REST_PTR_DECAY]] align(4) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i
  // CIR: cir.return
...
void string_nonconst(int n) {
  ...
  // CIR: %[[ZERO:.*]] = cir.const #cir.int<0> : !u8i
  // CIR: cir.libc.memset %[[SIZE_LEFT]] bytes at %[[AFTER_COPY_CAST]] align(1) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i
...
void aggr_sufficient(int n) {
  ...
  // CIR: %[[ZERO:.*]] = cir.const #cir.int<0> : !u8i
  // CIR: cir.libc.memset %[[REST_SIZE]] bytes at %[[REST_DECAY]] align(8) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i
