...
unsigned long long tc() {
  ...
  try {
    ...
    // CIR_FLAT:   cir.brcond %[[MATCH_CASE_INT_IDX]] ^[[BB_INT_IDX_CATCH:.*]](%[[INT_IDX_SEL]] : {{.*}}), ^[[BB_CHAR_MSG_SEL:.*]](%[[INT_IDX_SEL]] : {{.*}}) loc
    // CIR_FLAT: ^[[BB_INT_IDX_CATCH]](%[[INT_IDX_CATCH_SLOT:.*]]: !u32i
    ...
    // CIR_FLAT: ^[[BB_CHAR_MSG_SEL]](%[[CHAR_MSG_SEL:.*]]: !u32i
    // CIR_FLAT:   %[[CHAR_MSG_ID:.*]] = cir.eh.typeid @_ZTIPKc
    // CIR_FLAT:   %[[MATCH_CASE_CHAR_MSG:.*]] = cir.cmp(eq, %[[CHAR_MSG_SEL]], %[[CHAR_MSG_ID]])
    // CIR_FLAT:   cir.brcond %[[MATCH_CASE_CHAR_MSG]] ^[[BB_CHAR_MSG_CATCH:.*]](%[[CHAR_MSG_SEL]] : {{.*}}), ^[[BB_RESUME:.*]](%[[CHAR_MSG_SEL]] : {{.*}}) loc
    // CIR_FLAT: ^[[BB_CHAR_MSG_CATCH]](%[[CHAR_MSG_CATCH_SLOT:.*]]:
