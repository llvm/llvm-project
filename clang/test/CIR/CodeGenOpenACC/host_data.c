...
#pragma acc host_data use_device(var1)
  {}
  // CHECK-NEXT: %[[USE_DEV1:.*]] = acc.use_device varPtr(%[[V1]] : !cir.ptr<!s32i>) name("var1") -> !cir.ptr<!s32i>
...
#pragma acc host_data use_device(var1, var2)
  {}
  // CHECK-NEXT: %[[USE_DEV1:.*]] = acc.use_device varPtr(%[[V1]] : !cir.ptr<!s32i>) name("var1") -> !cir.ptr<!s32i>
  // CHECK-NEXT: %[[USE_DEV2:.*]] = acc.use_device varPtr(%[[V2]] : !cir.ptr<!s32i>) name("var2") -> !cir.ptr<!s32i>
...
#pragma acc host_data use_device(arr[0:var1])
  ...
  // CHECK-NEXT: %[[USE_DEV1:.*]] = acc.use_device varPtr(%[[ARR]] : !cir.ptr<!cir.ptr<!s32i>>) bounds(%[[BOUNDS]]) name("arr[0:var1]") -> !cir.ptr<!cir.ptr<!s32i>>
