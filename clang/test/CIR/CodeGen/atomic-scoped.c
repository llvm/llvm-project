// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -Wno-unused-value -fclangir -emit-cir -maiir --aiir-print-ir-before=cir-target-lowering %s -o %t.cir 2>%t-before-target-lowering.cir
