...
// CIR-DAG: cir.global external @w200 = #cir.int<5> : !cir.int<u, 200, bitint> align(8)
// LLVM-DAG: @w200 = global i256 5, align 8
signed _BitInt(256) w256 = -1;
// CIR-DAG: cir.global external @w256 = #cir.int<-1> : !s256i_bitint align(8)
// LLVM-DAG: @w256 = global i256 -1, align 8

signed _BitInt(129) g_neg = -1;
// CIR-DAG: cir.global external @g_neg = #cir.int<-1> : !cir.int<s, 129, bitint> align(8)
...
// CIR-DAG: cir.global external @g_struct = #cir.const_record<{#cir.int<7> : !s32i, #cir.zero : !cir.array<!u8i x 4>, #cir.int<-1> : !cir.int<s, 129, bitint>}> : !rec_HasWide129 align(8)
...
// CIR-DAG: cir.global external @g_arr = #cir.const_array<[#cir.int<-1> : !cir.int<s, 129, bitint>, #cir.int<-2> : !cir.int<s, 129, bitint>]> : !cir.array<!cir.int<s, 129, bitint> x 2> align(8)
...
// CIR-DAG: cir.global external @g_arr2 = #cir.const_record<{#cir.int<7> : !s32i, #cir.zero : !cir.array<!u8i x 4>, #cir.const_array<[#cir.int<-1> : !cir.int<s, 129, bitint>, #cir.int<-2> : !cir.int<s, 129, bitint>]> : !cir.array<!cir.int<s, 129, bitint> x 2>}> : !rec_HasWide129Array align(8)
...
// CIR-DAG: cir.global external @g320 = #cir.int<-1> : !cir.int<s, 320, bitint> align(8)
...
_BitInt(129) g_one = 1;
// CIR-DAG: cir.global external @g_one = #cir.int<1> : !cir.int<s, 129, bitint> align(8)
