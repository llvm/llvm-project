...
// !cir.ptr<![[MODEL_TY]]> CIR: %[[GET_MEM_PTR:.*]] = cir.get_member
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<1> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_bonnell(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 1
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<2> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_core2(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 2
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<3> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_corei7(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 3
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<4> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_amdfam10h(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 4
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<5> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_amdfam15h(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 5
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<6> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_silvermont(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 6
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<7> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_knl(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 7
TEST_CPU_IS(knl, "knl")
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<8> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_btver1(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 8
...
// %[[GET_MODEL]][1] {name = "__cpu_type"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR: %[[LOAD_TYPE:.*]]  = cir.load {{.*}}%[[GET_MEM_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR: %[[MASK:.*]] = cir.const #cir.int<9> : !u32i CIR:
// cir.cmp eq %[[LOAD_TYPE]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_btver2(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 9
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 10
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 11
TEST_CPU_IS(knm, "knm")
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 12
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 13
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 14
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 15
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 16
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 17
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 18
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 19
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 20
...
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 4) LLVM: = icmp eq i32 [[LOAD]], 21
