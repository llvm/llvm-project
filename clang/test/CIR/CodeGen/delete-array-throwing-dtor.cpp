...
// CIR-BEFORE-CXXABI:     cir.delete_array %[[PTR]] : !cir.ptr<!rec_ThrowingDtor> delete_fn(@_ZdaPvm) delete_params<size = true> element_dtor(@_ZN12ThrowingDtorD1Ev) dtor_may_throw element_align(4)
// CIR-BEFORE-CXXABI:   }
