...
// CHECK:     %4 = cir.load %1 lvalue_to_rvalue : cir.ptr <i32>, i32 loc(#[[loc7:loc[0-9]+]])
// CHECK:     %5 = cir.binop(add, %3, %4) : i32 loc(#[[loc8:loc[0-9]+]])
// CHECK:     cir.store %5, %0 : i32, cir.ptr <i32> loc(#[[loc4]])
// CHECK:     cir.scope {
// CHECK:       %7 = cir.load %0 lvalue_to_rvalue : cir.ptr <i32>, i32 loc(#[[loc10:loc[0-9]+]])
...
// CHECK:     %6 = cir.load %0 lvalue_to_rvalue : cir.ptr <i32>, i32 loc(#[[loc18:loc[0-9]+]])
