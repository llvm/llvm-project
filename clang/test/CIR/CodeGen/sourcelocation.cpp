...
// CHECK:     %2 = cir.alloca i32, cir.ptr <i32>, ["x", cinit] {alignment = 4 : i64} loc(#[[loc4:loc[0-9]+]])
// CHECK:     cir.store %arg0, %0 : i32, cir.ptr <i32> loc(#[[loc5:loc[0-9]+]])
// CHECK:     cir.store %arg1, %1 : i32, cir.ptr <i32> loc(#[[loc5]])
// CHECK:     %3 = cir.load %0 : cir.ptr <i32>, i32 loc(#[[loc6:loc[0-9]+]])
// CHECK:     %4 = cir.load %1 : cir.ptr <i32>, i32 loc(#[[loc7:loc[0-9]+]])
// CHECK:     %5 = cir.binop(add, %3, %4) : i32 loc(#[[loc8:loc[0-9]+]])
// CHECK:     cir.store %5, %2 : i32, cir.ptr <i32> loc(#[[loc4]])
// CHECK:     cir.scope {
// CHECK:       %7 = cir.load %2 : cir.ptr <i32>, i32 loc(#[[loc10:loc[0-9]+]])
...
// CHECK:         cir.store %10, %2 : i32, cir.ptr <i32> loc(#[[loc15:loc[0-9]+]])
// CHECK:       } else {
// CHECK:         %10 = cir.cst(1 : i32) : i32 loc(#[[loc16:loc[0-9]+]])
// CHECK:         cir.store %10, %2 : i32, cir.ptr <i32> loc(#[[loc17:loc[0-9]+]])
// CHECK:       } loc(#[[loc13:loc[0-9]+]])
// CHECK:     } loc(#[[loc9:loc[0-9]+]])
// CHECK:     %6 = cir.load %2 : cir.ptr <i32>, i32 loc(#[[loc18:loc[0-9]+]])
