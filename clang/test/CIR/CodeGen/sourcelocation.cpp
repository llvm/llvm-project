...
// CHECK: #loc21 = loc(fused["{{.*}}sourcelocation.cpp":4:8, "{{.*}}sourcelocation.cpp":4:12])
// CHECK: #loc22 = loc(fused["{{.*}}sourcelocation.cpp":4:15, "{{.*}}sourcelocation.cpp":4:19])
// CHECK: module {{.*}} {
...
// CHECK: #loc20 = loc(fused["{{.*}}sourcelocation.cpp":4:1, "{{.*}}sourcelocation.cpp":11:1])
// CHECK: #loc23 = loc(fused["{{.*}}sourcelocation.cpp":5:3, "{{.*}}sourcelocation.cpp":5:15])
// CHECK: #loc24 = loc(fused["{{.*}}sourcelocation.cpp":5:11, "{{.*}}sourcelocation.cpp":5:15])
// CHECK: #loc25 = loc(fused["{{.*}}sourcelocation.cpp":6:3, "{{.*}}sourcelocation.cpp":9:9])
// CHECK: #loc26 = loc(fused["{{.*}}sourcelocation.cpp":6:7, "{{.*}}sourcelocation.cpp":6:11])
// CHECK: #loc27 = loc(fused["{{.*}}sourcelocation.cpp":7:5, "{{.*}}sourcelocation.cpp":7:9, "{{.*}}sourcelocation.cpp":9:5, "{{.*}}sourcelocation.cpp":9:9])
// CHECK: #loc28 = loc(fused["{{.*}}sourcelocation.cpp":7:5, "{{.*}}sourcelocation.cpp":7:9])
// CHECK: #loc29 = loc(fused["{{.*}}sourcelocation.cpp":9:5, "{{.*}}sourcelocation.cpp":9:9])
// CHECK: #loc30 = loc(fused["{{.*}}sourcelocation.cpp":10:3, "{{.*}}sourcelocation.cpp":10:10])
