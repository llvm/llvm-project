...
// CIR-DAG: !rec_BitFieldBase = !cir.struct<"BitFieldBase" {empty_bitfield !u8i}>
...
// CIR-DAG: !rec_OnlyUnnamedBit = !cir.struct<"OnlyUnnamedBit" {empty_bitfield !cir.array<!u8i x 3>}>
...
// CIR-DAG: !rec_SpanMixed = !cir.struct<"SpanMixed" {bitfield !u8i, pad !cir.array<!u8i x 3>, empty_bitfield !u8i, pad !cir.array<!u8i x 3>}>

struct SpanEmptyFirst { int : 3; int : 0; int b : 3; };
// CIR-DAG: !rec_SpanEmptyFirst = !cir.struct<"SpanEmptyFirst" {empty_bitfield !u8i, pad !cir.array<!u8i x 3>, bitfield !u8i, pad !cir.array<!u8i x 3>}>
...
// CIR-DAG: !rec_WideSpanMixed = !cir.struct<"WideSpanMixed" {bitfield !u64i, empty_bitfield !u64i}>

struct WideSpanEmptyFirst { unsigned long : 64; unsigned long b : 64; };
// CIR-DAG: !rec_WideSpanEmptyFirst = !cir.struct<"WideSpanEmptyFirst" {empty_bitfield !u64i, bitfield !u64i}>

struct WideSpanAllEmpty { unsigned long : 64; unsigned long : 64; };
// CIR-DAG: !rec_WideSpanAllEmpty = !cir.struct<"WideSpanAllEmpty" {empty_bitfield !u64i, empty_bitfield !u64i}>
...
// CIR-DAG: !rec_Clipped = !cir.struct<"Clipped" packed {data !s32i, empty_bitfield !cir.array<!u8i x 3>, pad !u8i}>
// CIR-DAG: !rec_Clipped2Ebase = !cir.struct<"Clipped.base" packed {data !s32i, empty_bitfield !cir.array<!u8i x 3>}>
