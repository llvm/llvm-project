...
// CHECK: CIR Type:!cir.struct<"SimpleStruct" {data !cir.int<s, 32>, data !cir.float}>
// CHECK: NonVirtualBaseCIRType:!cir.struct<"SimpleStruct" {data !cir.int<s, 32>, data !cir.float}>
...
// CHECK: Layout: <CIRecordLayout
// CHECK:  CIR Type:!cir.struct<"BitfieldsInOrder" {data !cir.int<s, 8>, bitfield !cir.bitfield<!cir.int<u, 8>, [#cir.bitfield_decl<!cir.int<u, 32>, 8>]>, bitfield !cir.bitfield<!cir.int<u, 32>, [#cir.bitfield_decl<!cir.int<u, 32>, 20>, #cir.bitfield_decl<!cir.int<u, 32>, 3>, #cir.bitfield_decl<!cir.int<u, 32>, 1>]>}>
// CHECK:  NonVirtualBaseCIRType:!cir.struct<"BitfieldsInOrder" {data !cir.int<s, 8>, bitfield !cir.bitfield<!cir.int<u, 8>, [#cir.bitfield_decl<!cir.int<u, 32>, 8>]>, bitfield !cir.bitfield<!cir.int<u, 32>, [#cir.bitfield_decl<!cir.int<u, 32>, 20>, #cir.bitfield_decl<!cir.int<u, 32>, 3>, #cir.bitfield_decl<!cir.int<u, 32>, 1>]>}>
// CHECK:  IsZeroInitializable:1
// CHECK:  BitFields:[
