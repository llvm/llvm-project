// RUN: %clang_cc1 %s -triple=x86_64-apple-darwin -fclangir -S -verify -o - -target-feature +avx

// RUN: not %clang_cc1 %s -triple=x86_64-apple-darwin -fclangir -emit-obj -target-feature +avx 2> %t.err
