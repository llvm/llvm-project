...
// -fclangir -emit-llvm %s -o - | FileCheck %s --check-prefix=LLVM RUN:
...
// CIR: ![[MODEL_TY:.*]] = !cir.struct<{!u32i, !u32i, !u32i, !cir.array<!u32i x
// 1>}> CIR: cir.global "private" external dso_local @__cpu_model :
// ![[MODEL_TY]] LLVM: @__cpu_model = external dso_local global { i32, i32, i32,
// [1 x i32] }
...
// CIR:  %[[GET_MODEL:.*]] = cir.get_global @__cpu_model :
// !cir.ptr<![[MODEL_TY]]> CIR:  %[[GET_ST_PTR:.*]] = cir.get_member
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<1> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_nehalem(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 1
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<2> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_westmere(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 2
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<3> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_sandybridge(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 3
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<4> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_barcelona(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 4
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<5> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_shanghai(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 5
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<6> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_istanbul(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 6
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<7> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_bdver1(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 7
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<8> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_bdver2(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 8
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<9> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_bdver3(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 9
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<10> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_bdver4(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 10
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<11> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver1(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 11
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<12> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_ivybridge(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 12
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<13> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_haswell(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 13
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<14> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_broadwell(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 14
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<15> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_skylake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 15
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<16> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_skylake_avx512(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 16
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<17> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_cannonlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 17
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<18> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_icelake_client(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 18
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<19> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_icelake_server(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 19
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<20> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver2(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 20
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<21> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_cascadelake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 21
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<22> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_tigerlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 22
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<23> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_cooperlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 23
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<24> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_sapphirerapids(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 24
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<25> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_alderlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 25
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<26> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver3(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 26
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<27> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_rocketlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 27
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<28> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_zhaoxin_fam7h_lujiazui(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 28
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<29> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver4(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 29
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<30> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_graniterapids(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 30
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<31> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_graniterapids_d(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 31
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<32> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_arrowlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 32
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<33> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_arrowlake_s(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 33
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<34> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_pantherlake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 34
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<36> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver5(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 36
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<38> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_diamondrapids(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 38
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<39> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_novalake(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 39
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<40> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_znver6(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 40
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<41> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_c86_4g_m4(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 41
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<42> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_c86_4g_m6(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 42
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<43> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_c86_4g_m7(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 43
...
// %[[GET_MODEL]][2] {name = "__cpu_subtype"} : !cir.ptr<![[MODEL_TY]]> ->
// !cir.ptr<!u32i> CIR:  %[[ST:.*]] = cir.load {{.*}}%[[GET_ST_PTR]] :
// !cir.ptr<!u32i>, !u32i CIR:  %[[MASK:.*]] = cir.const #cir.int<44> : !u32i
// CIR:  cir.cmp eq %[[ST]], %[[MASK]] : !u32i

// LLVM-LABEL: define{{.*}} void @test_c86_4g_m8(
// LLVM: [[LOAD:%[^ ]+]] = load i32, ptr getelementptr inbounds nuw (i8, ptr
// @__cpu_model, i64 8) LLVM: = icmp eq i32 [[LOAD]], 44
