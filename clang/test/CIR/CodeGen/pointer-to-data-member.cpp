// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -std=c++17 -fclangir -Wno-unused-value -emit-cir -maiir -aiir-print-ir-before=cir-cxxabi-lowering %s -o %t.cir 2> %t-before.cir
