...
// CIR-BEFORE-LPP: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW7tls_int", "_ZTH7tls_int"> @tls_int = #cir.int<5> : !s32i
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW7tls_int", "_ZTH7tls_int"> @tls_int = #cir.int<5> : !s32i

thread_local int tls_int_dyn = get_i();
// CIR-BEFORE-LPP: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW11tls_int_dyn", "_ZTH11tls_int_dyn"> @tls_int_dyn = ctor : !s32i {
...
// CIR-BEFORE-LPP: }
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW11tls_int_dyn", "_ZTH11tls_int_dyn"> @tls_int_dyn = #cir.int<0> : !s32i 
...
// CIR-BEFORE-LPP: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW11tls_int_ref", "_ZTH11tls_int_ref"> @tls_int_ref = ctor : !cir.ptr<!s32i> {
...
// CIR-BEFORE-LPP: }
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW11tls_int_ref", "_ZTH11tls_int_ref"> @tls_int_ref = #cir.ptr<null> : !cir.ptr<!s32i>
...
// CIR-BEFORE-LPP:  cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW17tls_int_self_init", "_ZTH17tls_int_self_init"> @tls_int_self_init = ctor : !s32i {
...
// CIR-BEFORE-LPP:  }
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW17tls_int_self_init", "_ZTH17tls_int_self_init"> @tls_int_self_init = #cir.int<0> : !s32i
...
// CIR-BEFORE-LPP: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW17definitely_inited", "_ZTH17definitely_inited"> @definitely_inited = #cir.int<5> : !s32i
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW17definitely_inited", "_ZTH17definitely_inited"> @definitely_inited = #cir.int<5> : !s32i

extern thread_local int definitely_inited_dyn = get_i();
// CIR-BEFORE-LPP: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW21definitely_inited_dyn", "_ZTH21definitely_inited_dyn"> @definitely_inited_dyn = ctor : !s32i {
// CIR-BEFORE-LPP:   %[[GET_GLOB:.*]] = cir.get_global thread_local @definitely_inited_dyn : !cir.ptr<!s32i>
// CIR-BEFORE-LPP:   %[[CALL:.*]] = cir.call @_Z5get_iv() : () -> (!s32i {llvm.noundef})
// CIR-BEFORE-LPP:   cir.store {{.*}}%[[CALL]], %[[GET_GLOB]] : !s32i, !cir.ptr<!s32i>
// CIR-BEFORE-LPP: }
// CIR: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW21definitely_inited_dyn", "_ZTH21definitely_inited_dyn"> @definitely_inited_dyn = #cir.int<0> : !s32i
...
// CIR-BEFORE-LPP: cir.global "private" external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW12maybe_inited", "_ZTH12maybe_inited"> @maybe_inited : !s32i
// CIR: cir.global "private" external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW12maybe_inited", "_ZTH12maybe_inited"> @maybe_inited : !s32i
