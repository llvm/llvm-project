...
// CIR: !rec_anon{{.*}} = !cir.union<"anon{{.*}}" {data !cir.array<!s8i x 16>, data !u64i}, padding = {!cir.array<!u8i x 8>}>
// CIR: !rec_SSO = !cir.struct<"SSO" {data !cir.ptr<!s8i>, data !u64i, data !rec_anon{{.*}}}>
