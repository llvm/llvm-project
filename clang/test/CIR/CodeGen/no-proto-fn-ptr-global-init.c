...
// CHECK: !{{[^ ]+}} = !cir.struct<"S1" {data !cir.ptr<!cir.func<()>>, data !s32i, data !s32i}>
// CHECK: !{{[^ ]+}} = !cir.struct<"S2" {data !cir.ptr<!cir.func<(...)>>, data !s32i, data !s32i}>
// CHECK: !{{[^ ]+}} = !cir.struct<"S3" {data !cir.ptr<!cir.func<(...)>>, data !s32i, data !s32i}>
// CHECK: !{{[^ ]+}} = !cir.struct<"S4" {data !cir.ptr<!cir.func<(...)>>, data !s32i, data !s32i}>
