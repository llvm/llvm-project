...
// CHECK:    cir.libc.memset %[[ALLOCATION_SIZE]] bytes at %[[VOID_PTR]] align(4) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i

// LLVM: define {{.*}} void @_Z27t_constant_size_memset_initv()
// LLVM:   %[[P:.*]] = call noundef nonnull ptr @_Znam(i64 noundef 64)
// LLVM:   call void @llvm.memset.p0.i64(ptr align 4 %[[P]], i8 0, i64 64, i1 false)
...
// CHECK:    %[[ZERO:.*]] = cir.const #cir.int<0> : !u8i
// CHECK:    cir.libc.memset %[[REMAINING_SIZE]] bytes at %[[VOID_PTR]] align(4) to %[[ZERO]] : !cir.ptr<!void>, !u8i, !u64i
...
// CHECK:    %[[ZERO:.*]] = cir.const #cir.int<0> : !u8i
// CHECK:    cir.libc.memset{{.*}} bytes at %[[PTR_DOUBLE_3_VOID]] align(8) to %[[ZERO]]
...
// LLVM:   call void @llvm.memset.p0.i64(ptr align 8 %[[ELEM_3]], i8 0, i64 %[[REMAINING_SIZE]], i1 false)
