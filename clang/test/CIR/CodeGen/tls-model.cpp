...
// CIR-GD-DAG: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW1x", "_ZTH1x"> @x = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-GD-DAG: cir.global "private" internal tls_model = <tls_dyn> dso_local @_ZZ1fvE1y = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-GD-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW1z", "_ZTH1z"> @z = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-GD-DAG: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW2s1", "_ZTH2s1"> @s1 = #cir.zero : !rec_S {alignment = 1 : i64, ast = #cir.var.decl.ast}
// CIR-GD-DAG: cir.global external tls_model = <tls_dyn> dyn_tls_refs = <"_ZTW2t1", "_ZTH2t1"> @t1 = #cir.zero : !rec_T {alignment = 1 : i64, ast = #cir.var.decl.ast}
...
// CIR-LD-DAG: cir.global external tls_model = <tls_local_dyn> dyn_tls_refs = <"_ZTW1x", "_ZTH1x"> @x = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LD-DAG: cir.global "private" internal tls_model = <tls_local_dyn> dso_local @_ZZ1fvE1y = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LD-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW1z", "_ZTH1z"> @z = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LD-DAG: cir.global external tls_model = <tls_local_dyn> dyn_tls_refs = <"_ZTW2s1", "_ZTH2s1"> @s1 = #cir.zero : !rec_S {alignment = 1 : i64, ast = #cir.var.decl.ast}
// CIR-LD-DAG: cir.global external tls_model = <tls_local_dyn> dyn_tls_refs = <"_ZTW2t1", "_ZTH2t1"> @t1 = #cir.zero : !rec_T {alignment = 1 : i64, ast = #cir.var.decl.ast}
...
// CIR-IE-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW1x", "_ZTH1x"> @x = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-IE-DAG: cir.global "private" internal tls_model = <tls_init_exec> dso_local @_ZZ1fvE1y = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-IE-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW1z", "_ZTH1z"> @z = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-IE-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW2s1", "_ZTH2s1"> @s1 = #cir.zero : !rec_S {alignment = 1 : i64, ast = #cir.var.decl.ast}
// CIR-IE-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW2t1", "_ZTH2t1"> @t1 = #cir.zero : !rec_T {alignment = 1 : i64, ast = #cir.var.decl.ast}
...
// CIR-LE-DAG: cir.global external tls_model = <tls_local_exec> dyn_tls_refs = <"_ZTW1x", "_ZTH1x"> @x = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LE-DAG: cir.global "private" internal tls_model = <tls_local_exec> dso_local @_ZZ1fvE1y = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LE-DAG: cir.global external tls_model = <tls_init_exec> dyn_tls_refs = <"_ZTW1z", "_ZTH1z"> @z = #cir.int<0> : !s32i {alignment = 4 : i64}
// CIR-LE-DAG: cir.global external tls_model = <tls_local_exec> dyn_tls_refs = <"_ZTW2s1", "_ZTH2s1"> @s1 = #cir.zero : !rec_S {alignment = 1 : i64, ast = #cir.var.decl.ast}
// CIR-LE-DAG: cir.global external tls_model = <tls_local_exec> dyn_tls_refs = <"_ZTW2t1", "_ZTH2t1"> @t1 = #cir.zero : !rec_T {alignment = 1 : i64, ast = #cir.var.decl.ast}
