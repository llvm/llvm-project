...
// CHECK:    [[TMP7:%.*]] = cir.const #cir.int<65535> : !u32i
// CHECK:    [[TMP8:%.*]] = cir.binop(and, [[TMP5]], [[TMP7]]) : !u32i
// CHECK:    [[TMP9:%.*]] = cir.const #cir.int<4294901760> : !u32i
