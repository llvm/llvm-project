...
// @globalVar = #cir.int<123> : !s32i CIR-DAG:     cir.global external
// target_address_space(1) @globalVar = #cir.int<123> : !s32i LLVM-DAG:
// @globalVar = addrspace(1) global i32 123, align 4 OGCG-DAG: @globalVar =
// addrspace(1) global i32 123, align 4
...
// #cir.int<3> : !s32i, #cir.int<4> : !s32i]> : !cir.array<!s32i x 4> CIR-DAG:
// cir.global external target_address_space(1) @globalArray =
// #cir.const_array<[#cir.int<1> : !s32i, #cir.int<2> : !s32i, #cir.int<3> :
// !s32i, #cir.int<4> : !s32i]> : !cir.array<!s32i x 4> LLVM-DAG: @globalArray =
// addrspace(1) global [4 x i32] [i32 1, i32 2, i32 3, i32 4], align 4 OGCG-DAG:
// @globalArray = addrspace(1) global [4 x i32] [i32 1, i32 2, i32 3, i32 4],
// align 4
...
// #cir.int<555> : !s32i CIR-DAG:     cir.global "private"
// internal{{.*}}target_address_space(1) @_ZL12staticGlobal = #cir.int<555> :
// !s32i LLVM-DAG: @_ZL12staticGlobal = internal addrspace(1) global i32 555,
// align 4 OGCG-DAG: @_ZL12staticGlobal = internal addrspace(1) global i32 555,
// align 4
...
// @constGlobal = #cir.int<456> : !s32i LLVM-DAG: @constGlobal = addrspace(4)
// constant i32 456, align 4 OGCG-DAG: @constGlobal = addrspace(4) constant i32
// 456, align 4
...
// !s32i]> : !cir.array<!s32i x 3> CIR-DAG:     cir.global constant external
// target_address_space(4) @constArray = #cir.const_array<[#cir.int<10> : !s32i,
// #cir.int<20> : !s32i, #cir.int<30> : !s32i]> : !cir.array<!s32i x 3>
// LLVM-DAG: @constArray = addrspace(4) constant [3 x i32] [i32 10, i32 20, i32
// 30], align 4 OGCG-DAG: @constArray = addrspace(4) constant [3 x i32] [i32 10,
// i32 20, i32 30], align 4
