...
// CIR-NEXT: cir.copy %[[GET_GLOBAL]] align(8) to %[[WC_ALLOCA]] align(8) : !cir.ptr<!rec_WithCtor>
// CIR-NEXT: cir.return
...
// LLVM-NEXT: call void @llvm.memcpy.p0.p0.i64(ptr align 8 %1, ptr align 8 @__const.construct.c, i64 24, i1 false)
// LLVM-NEXT: ret void
