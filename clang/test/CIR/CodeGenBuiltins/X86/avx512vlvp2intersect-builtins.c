...
// CIR: !rec_anon_struct = !cir.struct<{data !cir.vector<8 x !cir.bool>, data !cir.vector<8 x !cir.bool>}>
// CIR: !rec_anon_struct1 = !cir.struct<{data !cir.vector<4 x !cir.bool>, data !cir.vector<4 x !cir.bool>}>
// CIR: !rec_anon_struct2 = !cir.struct<{data !cir.vector<2 x !cir.bool>, data !cir.vector<2 x !cir.bool>}>
