...
// CIR: !rec_anon_struct = !cir.struct<{data !cir.vector<16 x !cir.bool>, data !cir.vector<16 x !cir.bool>}>
// CIR: !rec_anon_struct1 = !cir.struct<{data !cir.vector<8 x !cir.bool>, data !cir.vector<8 x !cir.bool>}>
