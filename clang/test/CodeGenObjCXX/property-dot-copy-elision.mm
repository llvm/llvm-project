...
// CHECK: call void @_ZN2S1C1E2S0(ptr {{[^,]*}} %[[AGG_TMP]], ptr nofree noundef align 8 dereferenceable(8) %[[AGG_TMP_1]])
// CHECK: call void @objc_msgSend(ptr noundef %{{.*}}, ptr noundef %{{.*}}, ptr nofree noundef align 8 dereferenceable(8) %[[AGG_TMP]])
...
// CHECK: call void @objc_msgSend(ptr noundef %{{.*}}, ptr noundef %{{.*}}, ptr nofree noundef align 8 dereferenceable(8) %[[TEMP_LVALUE]])
