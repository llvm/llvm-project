...
// CHECK: define void @_Z24testParamAddrDiscStrong015AddrDiscStrong0(ptr noundef align 8 dead_on_return %[[A:.*]])
...
// CHECK: define void @_Z24testParamAddrDiscStrong115AddrDiscStrong1(ptr noundef align 8 %{{.*}})
// CHECK-NOT: call
// CHECK: ret void
