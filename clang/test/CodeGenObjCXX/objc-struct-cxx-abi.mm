...
// CHECK: define{{.*}} void @_Z27testParamContainsNonTrivial18ContainsNonTrivial(ptr dead_on_return noundef %{{.*}})
// CHECK-NOT: call
// CHECK: ret void
...
// CHECK: call void @_Z27testParamContainsNonTrivial18ContainsNonTrivial(ptr dead_on_return noundef %{{.*}})
