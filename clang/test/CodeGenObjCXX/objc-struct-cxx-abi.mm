...
// CHECK: define{{.*}} void @_Z19testParamStrongWeak10StrongWeak(ptr noundef align 8 dead_on_return %{{.*}})
...
// CHECK: call void @_Z19testParamStrongWeak10StrongWeak(ptr noundef align 8 dead_on_return %[[AGG_TMP]])
// CHECK-NOT: call
// CHECK: ret void
...
// CHECK: define{{.*}} void @_Z27testParamContainsStrongWeak18ContainsStrongWeak(ptr noundef align 8 dead_on_return %[[A:.*]])
// CHECK: call noundef ptr @_ZN18ContainsStrongWeakD1Ev(ptr {{[^,]*}} %[[A]])

void testParamContainsStrongWeak(ContainsStrongWeak a) {
}

// CHECK: define{{.*}} void @_Z26testParamDerivedStrongWeak17DerivedStrongWeak(ptr noundef align 8 dead_on_return %[[A:.*]])
...
// CHECK: define{{.*}} void @_Z21testParamWeakTemplate1SIU6__weakP11objc_objectE(ptr noundef align 8 dead_on_return %{{.*}})
...
// CHECK: define{{.*}} void @_Z27testParamContainsNonTrivial18ContainsNonTrivial(ptr noundef align 8 %{{.*}})
// CHECK-NOT: call
// CHECK: ret void
...
// CHECK: call void @_Z27testParamContainsNonTrivial18ContainsNonTrivial(ptr noundef align 8 %{{.*}})
...
// CHECK: call void @objc_msgSend({{.*}}, ptr noundef align 8 dead_on_return %[[AGG_TMP]])
// CHECK: br
...
// CHECK: call void @objc_msgSend({{.*}}, ptr noundef align 8 %[[AGG_TMP]])
