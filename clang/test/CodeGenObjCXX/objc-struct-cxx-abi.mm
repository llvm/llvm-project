...
// CHECK: %[[CALL1:.*]] = call noundef ptr @_ZN6StrongD1Ev(ptr nofree noundef nonnull align 8 dereferenceable(8) %[[AGG_TMP]])
// CHECK: br
...
// CHECK: %[[CALL1:.*]] = call noundef ptr @_ZN10StrongWeakD1Ev(ptr nofree noundef nonnull align 8 dereferenceable(16) %[[AGG_TMP]])
// CHECK: br
...
// CHECK: call void @objc_msgSend({{.*}}, ptr noundef %[[AGG_TMP]])
// CHECK-NEXT: call noundef ptr @_ZN10NonTrivialD1Ev(ptr nofree noundef nonnull align 8 dereferenceable(8) %[[AGG_TMP]])
