...
// CHECK: %[[CALL1:.*]] = call noundef ptr @_ZN6StrongD1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) %[[AGG_TMP]])
// CHECK: br
...
// CHECK: %[[CALL1:.*]] = call noundef ptr @_ZN10StrongWeakD1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(16) %[[AGG_TMP]])
// CHECK: br
...
// CHECK-NEXT: call noundef ptr @_ZN10NonTrivialD1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) %[[AGG_TMP]])
