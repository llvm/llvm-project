...
// -triple aarch64-managarm RUN: %clang_cc1 %s -Eonly -Wsystem-headers -Werror
...
// -triple riscv64-managarm RUN: %clang_cc1 %s -Eonly -Wsystem-headers -Werror
...
// x86_64-managarm RUN: %clang_cc1 %s -Eonly -Wsystem-headers -Werror -triple
...
// -Wsystem-headers -Werror -triple spirv64-amd-amdhsa RUN: %clang_cc1 %s -Eonly
