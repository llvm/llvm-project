...
#pragma clang __set_pp_state foo  // expected-error {{invalid argument 'foo' in
                                  // '#pragma clang __set_pp_state'}}
#pragma clang __set_pp_state void // expected-error {{invalid argument 'void' in
                                  // '#pragma clang __set_pp_state'}}

#pragma clang __set_pp_state __GLIBCXX__ foo // expected-error {{expected
                                             // integer after '#pragma clang
                                             // __set_pp_state __GLIBCXX__'}}
#pragma clang __set_pp_state                                                   \
    __GLIBCXX__ 100000000000000000000000000000 // expected-error {{expected
                                               // integer after '#pragma clang
                                               // __set_pp_state __GLIBCXX__'}}
#pragma clang __set_pp_state                                                   \
    __GLIBCXX__ 42.0 // expected-error {{expected integer after '#pragma clang
                     // __set_pp_state __GLIBCXX__'}}
...
#pragma clang __set_pp_state MACRO // expected-error {{invalid argument 'MACRO'
