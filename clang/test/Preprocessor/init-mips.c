...
// RUN: %clang_cc1 -E -dM -triple=nanomips < /dev/null | FileCheck -match-full-lines -check-prefix NANOMIPS %s
//NANOMIPS:#define _MIPSEL 1
//NANOMIPS:#define _MIPS_SIM _ABIP32
//NANOMIPS:#define _MIPS_SZINT 32
//NANOMIPS:#define _MIPS_SZLONG 32
//NANOMIPS:#define _MIPS_SZPTR 32
//NANOMIPS:#define __ATOMIC_ACQUIRE 2
//NANOMIPS:#define __ATOMIC_ACQ_REL 4
//NANOMIPS:#define __ATOMIC_CONSUME 1
//NANOMIPS:#define __ATOMIC_RELAXED 0
//NANOMIPS:#define __ATOMIC_RELEASE 3
//NANOMIPS:#define __ATOMIC_SEQ_CST 5
//NANOMIPS:#define __BIGGEST_ALIGNMENT__ 16
//NANOMIPS:#define __BYTE_ORDER__ __ORDER_LITTLE_ENDIAN__
//NANOMIPS:#define __CHAR_BIT__ 8
//NANOMIPS:#define __DBL_DECIMAL_DIG__ 17
//NANOMIPS:#define __DBL_DENORM_MIN__ 4.9406564584124654e-324
//NANOMIPS:#define __DBL_DIG__ 15
//NANOMIPS:#define __DBL_EPSILON__ 2.2204460492503131e-16
//NANOMIPS:#define __DBL_HAS_DENORM__ 1
//NANOMIPS:#define __DBL_HAS_INFINITY__ 1
//NANOMIPS:#define __DBL_HAS_QUIET_NAN__ 1
//NANOMIPS:#define __DBL_MANT_DIG__ 53
//NANOMIPS:#define __DBL_MAX_10_EXP__ 308
//NANOMIPS:#define __DBL_MAX_EXP__ 1024
//NANOMIPS:#define __DBL_MAX__ 1.7976931348623157e+308
//NANOMIPS:#define __DBL_MIN_10_EXP__ (-307)
//NANOMIPS:#define __DBL_MIN_EXP__ (-1021)
//NANOMIPS:#define __DBL_MIN__ 2.2250738585072014e-308
//NANOMIPS:#define __FINITE_MATH_ONLY__ 0
//NANOMIPS:#define __FLT_DECIMAL_DIG__ 9
//NANOMIPS:#define __FLT_DENORM_MIN__ 1.40129846e-45F
//NANOMIPS:#define __FLT_DIG__ 6
//NANOMIPS:#define __FLT_EPSILON__ 1.19209290e-7F
//NANOMIPS:#define __FLT_EVAL_METHOD__ 0
//NANOMIPS:#define __FLT_HAS_DENORM__ 1
//NANOMIPS:#define __FLT_HAS_INFINITY__ 1
//NANOMIPS:#define __FLT_HAS_QUIET_NAN__ 1
//NANOMIPS:#define __FLT_MANT_DIG__ 24
//NANOMIPS:#define __FLT_MAX_10_EXP__ 38
//NANOMIPS:#define __FLT_MAX_EXP__ 128
//NANOMIPS:#define __FLT_MAX__ 3.40282347e+38F
//NANOMIPS:#define __FLT_MIN_10_EXP__ (-37)
//NANOMIPS:#define __FLT_MIN_EXP__ (-125)
//NANOMIPS:#define __FLT_MIN__ 1.17549435e-38F
//NANOMIPS:#define __FLT_RADIX__ 2
//NANOMIPS:#define __GCC_HAVE_SYNC_COMPARE_AND_SWAP_1 1
//NANOMIPS:#define __GCC_HAVE_SYNC_COMPARE_AND_SWAP_2 1
//NANOMIPS:#define __GCC_HAVE_SYNC_COMPARE_AND_SWAP_4 1
//NANOMIPS:#define __INT16_MAX__ 32767
//NANOMIPS:#define __INT32_MAX__ 2147483647
//NANOMIPS:#define __INT64_MAX__ 9223372036854775807LL
//NANOMIPS:#define __INT64_TYPE__ long long int
//NANOMIPS:#define __INT8_MAX__ 127
//NANOMIPS:#define __INT8_TYPE__ signed char
//NANOMIPS:#define __INTMAX_MAX__ 9223372036854775807LL
//NANOMIPS:#define __INTMAX_TYPE__ long long int
//NANOMIPS:#define __INTPTR_MAX__ 2147483647L
//NANOMIPS:#define __INT_FAST32_MAX__ 2147483647
//NANOMIPS:#define __INT_FAST32_TYPE__ int
//NANOMIPS:#define __INT_FAST64_MAX__ 9223372036854775807LL
//NANOMIPS:#define __INT_FAST64_TYPE__ long long int
//NANOMIPS:#define __INT_LEAST16_MAX__ 32767
//NANOMIPS:#define __INT_LEAST32_MAX__ 2147483647
//NANOMIPS:#define __INT_LEAST64_MAX__ 9223372036854775807LL
//NANOMIPS:#define __INT_LEAST64_TYPE__ long long int
//NANOMIPS:#define __INT_LEAST8_MAX__ 127
//NANOMIPS:#define __INT_LEAST8_TYPE__ signed char
//NANOMIPS:#define __INT_MAX__ 2147483647
//NANOMIPS:#define __LDBL_DENORM_MIN__ 4.9406564584124654e-324L
//NANOMIPS:#define __LDBL_DIG__ 15
//NANOMIPS:#define __LDBL_EPSILON__ 2.2204460492503131e-16L
//NANOMIPS:#define __LDBL_HAS_DENORM__ 1
//NANOMIPS:#define __LDBL_HAS_INFINITY__ 1
//NANOMIPS:#define __LDBL_HAS_QUIET_NAN__ 1
//NANOMIPS:#define __LDBL_MANT_DIG__ 53
//NANOMIPS:#define __LDBL_MAX_10_EXP__ 308
//NANOMIPS:#define __LDBL_MAX_EXP__ 1024
//NANOMIPS:#define __LDBL_MAX__ 1.7976931348623157e+308L
//NANOMIPS:#define __LDBL_MIN_10_EXP__ (-307)
//NANOMIPS:#define __LDBL_MIN_EXP__ (-1021)
//NANOMIPS:#define __LDBL_MIN__ 2.2250738585072014e-308L
//NANOMIPS:#define __LONG_LONG_MAX__ 9223372036854775807LL
//NANOMIPS:#define __LONG_MAX__ 2147483647L
//NANOMIPS:#define __MIPSEL__ 1
//NANOMIPS:#define __NO_INLINE__ 1
//NANOMIPS:#define __ORDER_BIG_ENDIAN__ 4321
//NANOMIPS:#define __ORDER_LITTLE_ENDIAN__ 1234
//NANOMIPS:#define __ORDER_PDP_ENDIAN__ 3412
//NANOMIPS:#define __PRAGMA_REDEFINE_EXTNAME 1
//NANOMIPS:#define __PTRDIFF_MAX__ 2147483647
//NANOMIPS:#define __PTRDIFF_TYPE__ int
//NANOMIPS:#define __SCHAR_MAX__ 127
//NANOMIPS:#define __SHRT_MAX__ 32767
//NANOMIPS:#define __SIG_ATOMIC_MAX__ 2147483647
//NANOMIPS:#define __SIZEOF_DOUBLE__ 8
//NANOMIPS:#define __SIZEOF_FLOAT__ 4
//NANOMIPS:#define __SIZEOF_INT__ 4
//NANOMIPS:#define __SIZEOF_LONG_DOUBLE__ 8
//NANOMIPS:#define __SIZEOF_LONG_LONG__ 8
//NANOMIPS:#define __SIZEOF_LONG__ 4
//NANOMIPS:#define __SIZEOF_POINTER__ 4
//NANOMIPS:#define __SIZEOF_PTRDIFF_T__ 4
//NANOMIPS:#define __SIZEOF_SHORT__ 2
//NANOMIPS:#define __SIZEOF_SIZE_T__ 4
//NANOMIPS:#define __SIZEOF_WCHAR_T__ 4
//NANOMIPS:#define __SIZEOF_WINT_T__ 4
//NANOMIPS:#define __SIZE_MAX__ 4294967295U
//NANOMIPS:#define __SIZE_TYPE__ unsigned int
//NANOMIPS:#define __STDC_HOSTED__ 1
//NANOMIPS:#define __STDC_UTF_16__ 1
//NANOMIPS:#define __STDC_UTF_32__ 1
//NANOMIPS:#define __STDC__ 1
//NANOMIPS:#define __UINT16_MAX__ 65535
//NANOMIPS:#define __UINT32_MAX__ 4294967295U
//NANOMIPS:#define __UINT64_MAX__ 18446744073709551615ULL
//NANOMIPS:#define __UINT64_TYPE__ long long unsigned int
//NANOMIPS:#define __UINT8_MAX__ 255
//NANOMIPS:#define __UINT8_TYPE__ unsigned char
//NANOMIPS:#define __UINTMAX_MAX__ 18446744073709551615ULL
//NANOMIPS:#define __UINTMAX_TYPE__ long long unsigned int
//NANOMIPS:#define __UINTPTR_MAX__ 4294967295UL
//NANOMIPS:#define __UINT_FAST32_MAX__ 4294967295U
//NANOMIPS:#define __UINT_FAST32_TYPE__ unsigned int
//NANOMIPS:#define __UINT_FAST64_MAX__ 18446744073709551615ULL
//NANOMIPS:#define __UINT_FAST64_TYPE__ long long unsigned int
//NANOMIPS:#define __UINT_LEAST16_MAX__ 65535
//NANOMIPS:#define __UINT_LEAST32_MAX__ 4294967295U
//NANOMIPS:#define __UINT_LEAST64_MAX__ 18446744073709551615ULL
//NANOMIPS:#define __UINT_LEAST64_TYPE__ long long unsigned int
//NANOMIPS:#define __UINT_LEAST8_MAX__ 255
//NANOMIPS:#define __UINT_LEAST8_TYPE__ unsigned char
