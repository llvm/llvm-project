...
#line 'a' // expected-error {{#line directive requires a positive integer
          // argument}}
#line 0   // expected-warning {{#line directive with zero argument is a GNU
          // extension}}
#line 00  // expected-warning {{#line directive with zero argument is a GNU
          // extension}}
...
typedef int
    x; // expected-warning {{redefinition of typedef 'x' is a C11 feature}}
...
typedef int
    w; // expected-warning {{redefinition of typedef 'w' is a C11 feature}}
...
#define EMPTY()
#line 2 "foo.c" EMPTY()
#line 2 "foo.c" NONEMPTY() // expected-warning{{extra tokens at end of #line
                           // directive}}
...
/* PR3917 */
#line 41
extern char array2[_\
_LINE__ == 42
                       ? 1
                       : -1]; /* line marker is location of first _ */

# 51 // expected-warning {{this style of line directive is a GNU extension}}
extern char array2_gnuline[_\
_LINE__ == 52
                               ? 1
                               : -1]; /* line marker is location of first _ */
