...
#define IF_CONSTEXPR if constexpr               // CHECK-NEXT: Skipped,File 0, [[@LINE+1]]:3 -> [[@LINE+3]]:4 = 0
  IF_CONSTEXPR(false) {                         // CHECK-NEXT: MacroExpansion,File 0, [[@LINE]]:3 -> [[@LINE]]:15 = #0 (Expanded file = 1)
...
#define IF_RUNTIME if !consteval               // CHECK-NEXT: Skipped,File 0, [[@LINE+1]]:3 -> [[@LINE+1]]:14 = 0
  IF_RUNTIME {                                 // CHECK-NEXT: MacroExpansion,File 0, [[@LINE]]:3 -> [[@LINE]]:13 = #0 (Expanded file = 1)
