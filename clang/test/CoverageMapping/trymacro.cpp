...
void fn4() TRY2 // CHECK-DAG: MacroExpansion,File 0, [[@LINE]]:12 -> [[@LINE]]:16 = #1 (Expanded file = 1)
  for (;;)
    return;
}
catch (...) {}
...
#define TRY4 try { TRY3 { return; } } catch (...) // CHECK-DAG: MacroExpansion,File 1, [[@LINE]]:20 -> [[@LINE]]:24 = #1 (Expanded file = 2)
void fn5() {
  for (;;) {
    TRY4 { return; } // CHECK-DAG: MacroExpansion,File 0, [[@LINE]]:5 -> [[@LINE]]:9 = #1 (Expanded file = 1)
