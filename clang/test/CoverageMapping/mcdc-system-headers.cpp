...
int func0(int a) {
  ...
  // W_SYS: MacroExpansion,File 0, [[@LINE+2]]:11 -> [[@LINE+2]]:16 = #0 (Expanded file = 1)
...
int func1(int a, int b) {
  ...
  return (a || EXPR1(b));
  // W_SYS: MacroExpansion,File 0, [[@LINE-1]]:16 -> [[@LINE-1]]:21 = #1 (Expanded file = 1)
...
int func2(int a, int b) {
  ...
  // W_SYS: MacroExpansion,File 0, [[@LINE+3]]:11 -> [[@LINE+3]]:16 = #0 (Expanded file = 1)
  // W_SYS: MacroExpansion,File 0, [[@LINE+2]]:23 -> [[@LINE+2]]:28 = #1 (Expanded file = 2)
