...
// CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr @sa, align 2
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr @sf, align 1
...
// CHECK-NEXT:    store i16 [[RESIZE2]], ptr @sa, align 2
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr @a, align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr @lf, align 4
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i16, ptr @usa, align 2
...
// SIGNED-NEXT:    store i16 [[RESIZE2]], ptr @sa, align 2
// SIGNED-NEXT:    ret void
//
// UNSIGNED-LABEL: @smul_sasausa(
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i16, ptr @usa, align 2
// UNSIGNED-NEXT:    [[TMP2:%.*]] = call i16 @llvm.smul.fix.i16(i16 [[TMP0]], i16 [[TMP1]], i32 7)
// UNSIGNED-NEXT:    store i16 [[TMP2]], ptr @sa, align 2
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ua, align 4
...
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ua, align 4
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i8, ptr @usf, align 1
// SIGNED-NEXT:    [[RESIZE:%.*]] = sext i16 [[TMP0]] to i17
// SIGNED-NEXT:    [[UPSCALE:%.*]] = shl i17 [[RESIZE]], 1
...
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i8, ptr @usf, align 1
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ulf, align 4
...
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ulf, align 4
...
// UNSIGNED-NEXT:    store i16 [[RESIZE2]], ptr @sa, align 2
// UNSIGNED-NEXT:    ret void
//
...
// SIGNED-NEXT:    store i16 [[TMP2]], ptr @usa, align 2
// SIGNED-NEXT:    ret void
//
...
// SIGNED-NEXT:    store i16 [[RESIZE2]], ptr @usa, align 2
// SIGNED-NEXT:    ret void
//
...
// UNSIGNED-NEXT:    store i16 [[RESIZE2]], ptr @usa, align 2
// UNSIGNED-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr @ui, align 4
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ui, align 4
// SIGNED-NEXT:    [[RESIZE:%.*]] = zext i16 [[TMP0]] to i40
...
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i32, ptr @ui, align 4
// UNSIGNED-NEXT:    [[RESIZE:%.*]] = zext i16 [[TMP0]] to i39
...
// CHECK-NEXT:    store i32 [[RESIZE2]], ptr @lf, align 4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr @sa, align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr @sa_sat, align 2
...
// SIGNED-NEXT:  entry:
// SIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// SIGNED-NEXT:    [[TMP1:%.*]] = load i16, ptr @usa_sat, align 2
// SIGNED-NEXT:    [[TMP2:%.*]] = call i16 @llvm.umul.fix.sat.i16(i16 [[TMP0]], i16 [[TMP1]], i32 8)
// SIGNED-NEXT:    store i16 [[TMP2]], ptr @usa_sat, align 2
// SIGNED-NEXT:    ret void
//
// UNSIGNED-LABEL: @sat_usasusausas(
// UNSIGNED-NEXT:  entry:
// UNSIGNED-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// UNSIGNED-NEXT:    [[TMP1:%.*]] = load i16, ptr @usa_sat, align 2
...
// UNSIGNED-NEXT:    store i16 [[RESIZE1]], ptr @usa_sat, align 2
// UNSIGNED-NEXT:    ret void
//
...
// UNSIGNED-NEXT:    store i32 [[RESIZE2]], ptr @ua_sat, align 4
// UNSIGNED-NEXT:    ret void
//
...
// CHECK-NEXT:    store i16 [[RESIZE2]], ptr @sa_sat, align 2
// CHECK-NEXT:    ret void
//
...
// SIGNED-NEXT:    store i16 [[RESIZE2]], ptr @usa_sat, align 2
// SIGNED-NEXT:    ret void
//
...
// UNSIGNED-NEXT:    store i16 [[RESIZE2]], ptr @usa_sat, align 2
// UNSIGNED-NEXT:    ret void
//
