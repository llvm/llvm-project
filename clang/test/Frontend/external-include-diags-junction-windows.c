...
// junction points. Paths with partial path component matching are used
// as external include directory prefixes so that they do not nominate
// additional include paths.

// REQUIRES: system-windows
// RUN: rm -rf %t
// RUN: split-file %s %t
// RUN: cmd /c mklink /J %t\inc1\foo %t\inc2\foo
...
// junction point with path normalization removal of unnecessary ".." path
// components.
//
// RUN: %clang_cc1 \
// RUN:     -fsyntax-only -verify -Wall -Wno-system-headers \
