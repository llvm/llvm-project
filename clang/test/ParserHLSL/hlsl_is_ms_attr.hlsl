...
// CHECK: FieldDecl 0x{{[0-9a-f]+}} <line:[[# @LINE + 4]]:3, col:69> col:69 h '__hlsl_resource_t
...
// CHECK: VarDecl 0x{{[0-9a-f]+}} <line:[[# @LINE + 3]]:1, col:67> col:67 res '__hlsl_resource_t
...
// CHECK: VarDecl 0x{{[0-9a-f]+}} <col:3, col:73> col:73 r '__hlsl_resource_t
