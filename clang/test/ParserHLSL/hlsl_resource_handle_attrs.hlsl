...
// CHECK: ClassTemplateSpecializationDecl {{.*}} class RWBuffer definition external-linkage instantiated_from 0x{{.+}} implicit_instantiation
...
// CHECK: ClassTemplateSpecializationDecl {{.*}} class RasterizerOrderedBuffer definition external-linkage instantiated_from 0x{{.+}} implicit_instantiation
