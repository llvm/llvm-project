...
// reader's slice suppress the other's. Every other test in this directory has a
...
// parameter-selector lookup. The nonzero group is the whole point of this test:
