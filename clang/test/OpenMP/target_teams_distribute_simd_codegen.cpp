...
// CHECK21-NEXT:    [[LOADEDV:%.*]] = trunc i8 [[TMP10]] to i1
...
// CHECK21-NEXT:    [[LOADEDV2:%.*]] = trunc i8 [[TMP13]] to i1
...
// CHECK23-NEXT:    [[LOADEDV:%.*]] = trunc i8 [[TMP10]] to i1
...
// CHECK23-NEXT:    [[LOADEDV2:%.*]] = trunc i8 [[TMP13]] to i1
