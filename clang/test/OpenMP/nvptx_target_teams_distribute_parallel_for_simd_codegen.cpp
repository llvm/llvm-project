...
// CHECK1-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1:[0-9]+]], i32 [[TMP11]], i32 91, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_COMB_LB]], i32* [[DOTOMP_COMB_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 128)
...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[TMP27]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP20]], i64 [[TMP22]], i64 [[TMP24]], [1000 x i32]* [[TMP0]], i64 [[TMP26]]) #[[ATTR2]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP28]], [[TMP29]]
...
// CHECK1-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
...
// CHECK1-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
...
// CHECK1-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK1-NEXT:    [[SUB18:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK1-NEXT:    br i1 [[TMP45]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK1:       .omp.lastprivate.then:
// CHECK1-NEXT:    [[TMP46:%.*]] = load i32, i32* [[CONV1]], align 8
// CHECK1-NEXT:    store i32 [[TMP46]], i32* [[CONV1]], align 8
// CHECK1-NEXT:    br label [[DOTOMP_LASTPRIVATE_DONE]]
// CHECK1:       .omp.lastprivate.done:
// CHECK1-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK1:       omp.precond.end:
// CHECK1-NEXT:    [[TMP47:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK1-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP47]])
// CHECK1-NEXT:    ret void
//
//
...
//
//
// CHECK1-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK1-NEXT:    call void @__omp_outlined__3(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK1-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
...
// CHECK1-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK1-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK1-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
// CHECK1-NEXT:    br i1 [[CMP10]], label [[COND_TRUE11:%.*]], label [[COND_FALSE12:%.*]]
// CHECK1:       cond.true11:
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK1-NEXT:    br label [[COND_END13:%.*]]
// CHECK1:       cond.false12:
// CHECK1-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK1-NEXT:    br label [[COND_END13]]
// CHECK1:       cond.end13:
// CHECK1-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
...
// CHECK1-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP36]], 0
...
// CHECK1-NEXT:    call void @__omp_outlined__5(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK1-NEXT:    [[CMP4:%.*]] = icmp sgt i32 [[TMP18]], 9
...
// CHECK1-NEXT:    br label [[COND_END7]]
// CHECK1:       cond.end7:
// CHECK1-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP19]], [[COND_FALSE6]] ]
...
// CHECK1-NEXT:    call void @__omp_outlined__7(i32* [[TMP13]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x [10 x i32]]* [[TMP0]], i64 [[TMP12]]) #[[ATTR2]]
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK1-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK1-NEXT:    [[CMP6:%.*]] = icmp sgt i32 [[TMP20]], 99
...
// CHECK1-NEXT:    br label [[COND_END9]]
// CHECK1:       cond.end9:
// CHECK1-NEXT:    [[COND10:%.*]] = phi i32 [ 99, [[COND_TRUE7]] ], [ [[TMP21]], [[COND_FALSE8]] ]
...
// CHECK2-NEXT:    [[TMP5:%.*]] = load i64, i64* [[L_CASTED]], align 8
// CHECK2-NEXT:    store i32 [[TMP1]], i32* [[DOTTHREADID_TEMP_]], align 4
// CHECK2-NEXT:    call void @__omp_outlined__(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], i64 [[TMP3]], [1000 x i32]* [[TMP0]], i64 [[TMP5]]) #[[ATTR2:[0-9]+]]
...
// CHECK2-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1:[0-9]+]], i32 [[TMP8]], i32 91, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_COMB_LB]], i32* [[DOTOMP_COMB_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 128)
...
// CHECK2-NEXT:    call void @__omp_outlined__1(i32* [[TMP24]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP17]], i64 [[TMP19]], i64 [[TMP21]], [1000 x i32]* [[TMP0]], i64 [[TMP23]]) #[[ATTR2]]
...
// CHECK2-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK2-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
...
// CHECK2-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP29]], [[TMP30]]
...
// CHECK2-NEXT:    [[CMP13:%.*]] = icmp sgt i32 [[TMP31]], [[TMP32]]
...
// CHECK2-NEXT:    br label [[COND_END16]]
// CHECK2:       cond.end16:
// CHECK2-NEXT:    [[COND17:%.*]] = phi i32 [ [[TMP33]], [[COND_TRUE14]] ], [ [[TMP34]], [[COND_FALSE15]] ]
...
// CHECK2-NEXT:    [[SUB18:%.*]] = sub nsw i32 [[TMP40]], 0
...
// CHECK2-NEXT:    [[TMP43:%.*]] = load i32, i32* [[CONV1]], align 8
// CHECK2-NEXT:    store i32 [[TMP43]], i32* [[CONV1]], align 8
...
//
//
// CHECK2-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK2-NEXT:    [[TMP3:%.*]] = load i64, i64* [[N_CASTED]], align 8
// CHECK2-NEXT:    store i32 [[TMP1]], i32* [[DOTTHREADID_TEMP_]], align 4
// CHECK2-NEXT:    call void @__omp_outlined__2(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], i64 [[TMP3]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK2-NEXT:    br label [[DOTOMP_DEINIT:%.*]]
// CHECK2:       .omp.deinit:
// CHECK2-NEXT:    call void @__kmpc_spmd_kernel_deinit_v2(i16 0)
// CHECK2-NEXT:    br label [[DOTEXIT:%.*]]
...
// CHECK2-NEXT:    call void @__omp_outlined__3(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[TMP22:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
...
// CHECK2-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
...
// CHECK2-NEXT:    br label [[COND_END13]]
// CHECK2:       cond.end13:
// CHECK2-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
...
// CHECK2-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP36]], 0
...
// CHECK2-NEXT:    call void @__omp_outlined__5(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK2-NEXT:    br label [[COND_END7]]
// CHECK2:       cond.end7:
// CHECK2-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP19]], [[COND_FALSE6]] ]
...
//
//
// CHECK2-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK2-NEXT:    store i32 [[TMP2]], i32* [[CONV1]], align 4
// CHECK2-NEXT:    [[TMP3:%.*]] = load i64, i64* [[F_CASTED]], align 8
// CHECK2-NEXT:    store i32 [[TMP1]], i32* [[DOTTHREADID_TEMP_]], align 4
// CHECK2-NEXT:    call void @__omp_outlined__6(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], [10 x [10 x i32]]* [[TMP0]], i64 [[TMP3]]) #[[ATTR2]]
// CHECK2-NEXT:    br label [[DOTOMP_DEINIT:%.*]]
// CHECK2:       .omp.deinit:
// CHECK2-NEXT:    call void @__kmpc_spmd_kernel_deinit_v2(i16 0)
// CHECK2-NEXT:    br label [[DOTEXIT:%.*]]
...
// CHECK2-NEXT:    call void @__omp_outlined__7(i32* [[TMP13]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x [10 x i32]]* [[TMP0]], i64 [[TMP12]]) #[[ATTR2]]
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK2-NEXT:    [[TMP16:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK2-NEXT:    [[TMP17:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
...
// CHECK2-NEXT:    [[CMP6:%.*]] = icmp sgt i32 [[TMP20]], 99
...
// CHECK2-NEXT:    br label [[COND_END9]]
// CHECK2:       cond.end9:
// CHECK2-NEXT:    [[COND10:%.*]] = phi i32 [ 99, [[COND_TRUE7]] ], [ [[TMP21]], [[COND_FALSE8]] ]
...
// CHECK3-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1:[0-9]+]], i32 [[TMP11]], i32 91, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_COMB_LB]], i32* [[DOTOMP_COMB_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 128)
...
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[TMP25]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP19]], i32 [[TMP20]], i32 [[TMP22]], [1000 x i32]* [[TMP0]], i32 [[TMP24]]) #[[ATTR2]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], [[TMP27]]
...
// CHECK3-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK3-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP32]], [[TMP33]]
...
// CHECK3-NEXT:    br label [[COND_END13]]
// CHECK3:       cond.end13:
// CHECK3-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP34]], [[COND_TRUE11]] ], [ [[TMP35]], [[COND_FALSE12]] ]
// CHECK3-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK3-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK3-NEXT:    store i32 [[TMP36]], i32* [[DOTOMP_IV]], align 4
...
// CHECK3-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK3-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK3-NEXT:    br i1 [[TMP43]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK3:       .omp.lastprivate.then:
// CHECK3-NEXT:    [[TMP44:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK3-NEXT:    store i32 [[TMP44]], i32* [[L_ADDR]], align 4
// CHECK3-NEXT:    br label [[DOTOMP_LASTPRIVATE_DONE]]
// CHECK3:       .omp.lastprivate.done:
// CHECK3-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK3:       omp.precond.end:
// CHECK3-NEXT:    [[TMP45:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK3-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP45]])
// CHECK3-NEXT:    ret void
//
//
...
//
//
// CHECK3-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK3-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK3-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
...
// CHECK3-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK3-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK3-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK3-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK3:       cond.true10:
// CHECK3-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK3-NEXT:    br label [[COND_END12:%.*]]
// CHECK3:       cond.false11:
// CHECK3-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK3-NEXT:    br label [[COND_END12]]
// CHECK3:       cond.end12:
// CHECK3-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
...
// CHECK3-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
// CHECK3-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK3-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK3-NEXT:    [[CMP4:%.*]] = icmp sgt i32 [[TMP16]], 9
...
// CHECK3-NEXT:    br label [[COND_END7]]
// CHECK3:       cond.end7:
// CHECK3-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
// CHECK3-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
// CHECK3-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK3-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK3-NEXT:    [[CMP5:%.*]] = icmp sgt i32 [[TMP18]], 99
...
// CHECK3-NEXT:    br label [[COND_END8]]
// CHECK3:       cond.end8:
// CHECK3-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK4-NEXT:    call void @__omp_outlined__1(i32* [[TMP25]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP19]], i32 [[TMP20]], i32 [[TMP22]], [1000 x i32]* [[TMP0]], i32 [[TMP24]]) #[[ATTR2]]
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
// CHECK4-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK4-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK4-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], [[TMP27]]
...
// CHECK4-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP28]], [[TMP29]]
...
// CHECK4-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK4-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK4-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP32]], [[TMP33]]
...
// CHECK4-NEXT:    br label [[COND_END13]]
// CHECK4:       cond.end13:
// CHECK4-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP34]], [[COND_TRUE11]] ], [ [[TMP35]], [[COND_FALSE12]] ]
// CHECK4-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK4-NEXT:    store i32 [[TMP36]], i32* [[DOTOMP_IV]], align 4
...
// CHECK4-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK4-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK4-NEXT:    br i1 [[TMP43]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK4:       .omp.lastprivate.then:
// CHECK4-NEXT:    [[TMP44:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK4-NEXT:    store i32 [[TMP44]], i32* [[L_ADDR]], align 4
...
// CHECK4-NEXT:    [[TMP45:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK4-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP45]])
// CHECK4-NEXT:    ret void
//
//
...
//
//
// CHECK4-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK4-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
// CHECK4-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK4-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK4-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK4-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
...
// CHECK4-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
//
//
// CHECK4-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK4-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
// CHECK4-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK4-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK4-NEXT:    br label [[COND_END7]]
// CHECK4:       cond.end7:
// CHECK4-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
//
//
// CHECK4-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK4-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
// CHECK4-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK4-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK4-NEXT:    br label [[COND_END8]]
// CHECK4:       cond.end8:
// CHECK4-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK5-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP16]], i32 [[TMP17]], i32 [[TMP19]], [1000 x i32]* [[TMP0]], i32 [[TMP21]]) #[[ATTR2]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK5-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK5-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
...
// CHECK5-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
// CHECK5-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK5-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP29]], [[TMP30]]
...
// CHECK5:       cond.false12:
// CHECK5-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    br label [[COND_END13]]
// CHECK5:       cond.end13:
// CHECK5-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP31]], [[COND_TRUE11]] ], [ [[TMP32]], [[COND_FALSE12]] ]
// CHECK5-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK5-NEXT:    store i32 [[TMP33]], i32* [[DOTOMP_IV]], align 4
...
// CHECK5-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP35]])
// CHECK5-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK5-NEXT:    [[TMP37:%.*]] = icmp ne i32 [[TMP36]], 0
// CHECK5-NEXT:    br i1 [[TMP37]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK5:       .omp.final.then:
// CHECK5-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK5-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK5-NEXT:    br i1 [[TMP40]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK5:       .omp.lastprivate.then:
// CHECK5-NEXT:    [[TMP41:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK5-NEXT:    store i32 [[TMP41]], i32* [[L_ADDR]], align 4
...
//
//
// CHECK5-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK5-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
...
// CHECK5-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK5-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK5-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK5-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK5-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK5-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK5-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK5:       cond.true10:
// CHECK5-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK5-NEXT:    br label [[COND_END12:%.*]]
// CHECK5:       cond.false11:
// CHECK5-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    br label [[COND_END12]]
// CHECK5:       cond.end12:
// CHECK5-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
// CHECK5-NEXT:    store i32 [[COND13]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK5-NEXT:    store i32 [[TMP29]], i32* [[DOTOMP_IV]], align 4
...
// CHECK5:       .omp.final.then:
// CHECK5-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK5-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
//
//
// CHECK5-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK5-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK5-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK5-NEXT:    br label [[COND_END7]]
// CHECK5:       cond.end7:
// CHECK5-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
//
//
// CHECK5-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK5-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
// CHECK5-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK5-NEXT:    br label [[COND_END8]]
// CHECK5:       cond.end8:
// CHECK5-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK6-NEXT:    [[TMP22:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP16]], i32 [[TMP17]], i32 [[TMP19]], [1000 x i32]* [[TMP0]], i32 [[TMP21]]) #[[ATTR2]]
...
// CHECK6-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK6-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
...
// CHECK6-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
// CHECK6-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK6-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP29]], [[TMP30]]
...
// CHECK6:       cond.false12:
// CHECK6-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    br label [[COND_END13]]
// CHECK6:       cond.end13:
// CHECK6-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP31]], [[COND_TRUE11]] ], [ [[TMP32]], [[COND_FALSE12]] ]
// CHECK6-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP33]], i32* [[DOTOMP_IV]], align 4
...
// CHECK6-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP35]])
// CHECK6-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[TMP37:%.*]] = icmp ne i32 [[TMP36]], 0
// CHECK6-NEXT:    br i1 [[TMP37]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK6:       .omp.final.then:
// CHECK6-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK6-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK6-NEXT:    br i1 [[TMP40]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK6:       .omp.lastprivate.then:
// CHECK6-NEXT:    [[TMP41:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK6-NEXT:    store i32 [[TMP41]], i32* [[L_ADDR]], align 4
...
//
//
// CHECK6-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK6-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
...
// CHECK6-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK6-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK6-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK6-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK6:       cond.true10:
// CHECK6-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    br label [[COND_END12:%.*]]
// CHECK6:       cond.false11:
// CHECK6-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    br label [[COND_END12]]
// CHECK6:       cond.end12:
// CHECK6-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
// CHECK6-NEXT:    store i32 [[COND13]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP29]], i32* [[DOTOMP_IV]], align 4
...
// CHECK6-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP31]])
...
// CHECK6:       .omp.final.then:
// CHECK6-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK6-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
//
//
// CHECK6-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK6-NEXT:    [[TMP9:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
// CHECK6-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK6-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK6-NEXT:    br label [[COND_END7]]
// CHECK6:       cond.end7:
// CHECK6-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
//
//
// CHECK6-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK6-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
// CHECK6-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK6-NEXT:    br label [[COND_END8]]
// CHECK6:       cond.end8:
// CHECK6-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK7-NEXT:    call void @__omp_outlined__1(i32* [[TMP27]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP20]], i64 [[TMP22]], i64 [[TMP24]], [1000 x i32]* [[TMP0]], i64 [[TMP26]]) #[[ATTR2]]
...
// CHECK7-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP28]], [[TMP29]]
...
// CHECK7-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
// CHECK7-NEXT:    store i32 [[ADD11]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK7-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK7-NEXT:    store i32 [[ADD12]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP35:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK7-NEXT:    [[CMP13:%.*]] = icmp sgt i32 [[TMP34]], [[TMP35]]
// CHECK7-NEXT:    br i1 [[CMP13]], label [[COND_TRUE14:%.*]], label [[COND_FALSE15:%.*]]
// CHECK7:       cond.true14:
// CHECK7-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK7-NEXT:    br label [[COND_END16:%.*]]
// CHECK7:       cond.false15:
// CHECK7-NEXT:    [[TMP37:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    br label [[COND_END16]]
// CHECK7:       cond.end16:
// CHECK7-NEXT:    [[COND17:%.*]] = phi i32 [ [[TMP36]], [[COND_TRUE14]] ], [ [[TMP37]], [[COND_FALSE15]] ]
// CHECK7-NEXT:    store i32 [[COND17]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK7-NEXT:    store i32 [[TMP38]], i32* [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_COND]], !llvm.loop [[LOOP10:![0-9]+]]
// CHECK7:       omp.inner.for.end:
// CHECK7-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK7:       omp.loop.exit:
// CHECK7-NEXT:    [[TMP39:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK7-NEXT:    [[TMP40:%.*]] = load i32, i32* [[TMP39]], align 4
// CHECK7-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP40]])
// CHECK7-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK7-NEXT:    [[TMP42:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK7-NEXT:    br i1 [[TMP42]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK7:       .omp.final.then:
// CHECK7-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK7-NEXT:    [[SUB18:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK7-NEXT:    br i1 [[TMP45]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK7:       .omp.lastprivate.then:
// CHECK7-NEXT:    [[TMP46:%.*]] = load i32, i32* [[CONV1]], align 8
// CHECK7-NEXT:    store i32 [[TMP46]], i32* [[CONV1]], align 8
...
// CHECK7-NEXT:    [[TMP47:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK7-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP47]])
// CHECK7-NEXT:    ret void
//
//
...
//
//
// CHECK7-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK7-NEXT:    [[TMP20:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK7-NEXT:    call void @__omp_outlined__3(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[TMP22:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK7-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK7-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK7-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
...
// CHECK7-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK7-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK7-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
...
// CHECK7:       cond.false12:
// CHECK7-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK7-NEXT:    br label [[COND_END13]]
// CHECK7:       cond.end13:
// CHECK7-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
...
// CHECK7-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP33]])
// CHECK7-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK7-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK7-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK7:       .omp.final.then:
// CHECK7-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK7-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP36]], 0
...
//
//
// CHECK7-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK7-NEXT:    call void @__omp_outlined__5(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
//
//
// CHECK7-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK7-NEXT:    call void @__omp_outlined__7(i32* [[TMP13]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x [10 x i32]]* [[TMP0]], i64 [[TMP12]]) #[[ATTR2]]
// CHECK7-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK7:       omp.inner.for.inc:
// CHECK7-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK7-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK7-NEXT:    br label [[COND_END9]]
// CHECK7:       cond.end9:
// CHECK7-NEXT:    [[COND10:%.*]] = phi i32 [ 99, [[COND_TRUE7]] ], [ [[TMP21]], [[COND_FALSE8]] ]
...
// CHECK8-NEXT:    call void @__omp_outlined__1(i32* [[TMP24]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP17]], i64 [[TMP19]], i64 [[TMP21]], [1000 x i32]* [[TMP0]], i64 [[TMP23]]) #[[ATTR2]]
...
// CHECK8-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK8-NEXT:    store i32 [[ADD10]], i32* [[DOTOMP_IV]], align 4
// CHECK8-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK8-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK8-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
...
// CHECK8-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP29]], [[TMP30]]
// CHECK8-NEXT:    store i32 [[ADD12]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK8-NEXT:    [[CMP13:%.*]] = icmp sgt i32 [[TMP31]], [[TMP32]]
// CHECK8-NEXT:    br i1 [[CMP13]], label [[COND_TRUE14:%.*]], label [[COND_FALSE15:%.*]]
// CHECK8:       cond.true14:
// CHECK8-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK8-NEXT:    br label [[COND_END16:%.*]]
// CHECK8:       cond.false15:
// CHECK8-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    br label [[COND_END16]]
// CHECK8:       cond.end16:
// CHECK8-NEXT:    [[COND17:%.*]] = phi i32 [ [[TMP33]], [[COND_TRUE14]] ], [ [[TMP34]], [[COND_FALSE15]] ]
// CHECK8-NEXT:    store i32 [[COND17]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP35:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK8-NEXT:    store i32 [[TMP35]], i32* [[DOTOMP_IV]], align 4
...
// CHECK8-NEXT:    [[TMP36:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK8-NEXT:    [[TMP37:%.*]] = load i32, i32* [[TMP36]], align 4
// CHECK8-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP37]])
// CHECK8-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK8-NEXT:    [[TMP39:%.*]] = icmp ne i32 [[TMP38]], 0
// CHECK8-NEXT:    br i1 [[TMP39]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK8:       .omp.final.then:
// CHECK8-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK8-NEXT:    [[SUB18:%.*]] = sub nsw i32 [[TMP40]], 0
...
// CHECK8-NEXT:    br i1 [[TMP42]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK8:       .omp.lastprivate.then:
// CHECK8-NEXT:    [[TMP43:%.*]] = load i32, i32* [[CONV1]], align 8
// CHECK8-NEXT:    store i32 [[TMP43]], i32* [[CONV1]], align 8
...
//
//
// CHECK8-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK8-NEXT:    call void @__omp_outlined__3(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK8-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK8:       omp.inner.for.inc:
// CHECK8-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK8-NEXT:    [[TMP22:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK8-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK8-NEXT:    store i32 [[ADD7]], i32* [[DOTOMP_IV]], align 4
// CHECK8-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK8-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK8-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK8-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK8-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK8-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK8-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK8-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK8-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
...
// CHECK8-NEXT:    br label [[COND_END13]]
// CHECK8:       cond.end13:
// CHECK8-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
...
// CHECK8-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP33]])
// CHECK8-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK8-NEXT:    [[TMP35:%.*]] = icmp ne i32 [[TMP34]], 0
// CHECK8-NEXT:    br i1 [[TMP35]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK8:       .omp.final.then:
// CHECK8-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK8-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP36]], 0
...
//
//
// CHECK8-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK8-NEXT:    call void @__omp_outlined__5(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK8-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK8:       omp.inner.for.inc:
// CHECK8-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK8-NEXT:    br label [[COND_END7]]
// CHECK8:       cond.end7:
// CHECK8-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP19]], [[COND_FALSE6]] ]
...
//
//
// CHECK8-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK8-NEXT:    call void @__omp_outlined__7(i32* [[TMP13]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP8]], i64 [[TMP10]], [10 x [10 x i32]]* [[TMP0]], i64 [[TMP12]]) #[[ATTR2]]
// CHECK8-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK8:       omp.inner.for.inc:
// CHECK8-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK8-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK8-NEXT:    br label [[COND_END9]]
// CHECK8:       cond.end9:
// CHECK8-NEXT:    [[COND10:%.*]] = phi i32 [ 99, [[COND_TRUE7]] ], [ [[TMP21]], [[COND_FALSE8]] ]
...
// CHECK9-NEXT:    [[TMP25:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK9-NEXT:    call void @__omp_outlined__1(i32* [[TMP25]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP19]], i32 [[TMP20]], i32 [[TMP22]], [1000 x i32]* [[TMP0]], i32 [[TMP24]]) #[[ATTR2]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK9-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], [[TMP27]]
...
// CHECK9-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP28]], [[TMP29]]
...
// CHECK9-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
...
// CHECK9-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP32]], [[TMP33]]
...
// CHECK9-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK9-NEXT:    br i1 [[TMP43]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK9:       .omp.lastprivate.then:
// CHECK9-NEXT:    [[TMP44:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK9-NEXT:    store i32 [[TMP44]], i32* [[L_ADDR]], align 4
...
// CHECK9-NEXT:    [[TMP45:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK9-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP45]])
// CHECK9-NEXT:    ret void
//
//
...
//
//
// CHECK9-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK9-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK9-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
...
// CHECK9-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK9-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK9:       cond.true10:
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK9-NEXT:    br label [[COND_END12:%.*]]
// CHECK9:       cond.false11:
// CHECK9-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK9-NEXT:    br label [[COND_END12]]
// CHECK9:       cond.end12:
// CHECK9-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
...
// CHECK9-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
// CHECK9-NEXT:    [[TMP9:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK9-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP10]], [[TMP11]]
...
// CHECK9-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK9-NEXT:    br label [[COND_END7]]
// CHECK9:       cond.end7:
// CHECK9-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK9-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK9-NEXT:    br label [[COND_END8]]
// CHECK9:       cond.end8:
// CHECK9-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK10-NEXT:    [[TMP25:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK10-NEXT:    call void @__omp_outlined__1(i32* [[TMP25]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP19]], i32 [[TMP20]], i32 [[TMP22]], [1000 x i32]* [[TMP0]], i32 [[TMP24]]) #[[ATTR2]]
...
// CHECK10-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], [[TMP27]]
...
// CHECK10-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP28]], [[TMP29]]
...
// CHECK10-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
...
// CHECK10-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP32]], [[TMP33]]
...
// CHECK10-NEXT:    br label [[COND_END13]]
// CHECK10:       cond.end13:
// CHECK10-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP34]], [[COND_TRUE11]] ], [ [[TMP35]], [[COND_FALSE12]] ]
// CHECK10-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK10-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK10-NEXT:    store i32 [[TMP36]], i32* [[DOTOMP_IV]], align 4
...
// CHECK10-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK10-NEXT:    br i1 [[TMP43]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK10:       .omp.lastprivate.then:
// CHECK10-NEXT:    [[TMP44:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK10-NEXT:    store i32 [[TMP44]], i32* [[L_ADDR]], align 4
...
// CHECK10-NEXT:    [[TMP45:%.*]] = load i16, i16* @"_openmp_static_kernel$is_shared", align 2
// CHECK10-NEXT:    call void @__kmpc_restore_team_static_memory(i16 1, i16 [[TMP45]])
// CHECK10-NEXT:    ret void
//
//
...
//
//
// CHECK10-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK10-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
...
// CHECK10-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
...
// CHECK10-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK10-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK10-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK10:       cond.true10:
// CHECK10-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK10-NEXT:    br label [[COND_END12:%.*]]
// CHECK10:       cond.false11:
// CHECK10-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK10-NEXT:    br label [[COND_END12]]
// CHECK10:       cond.end12:
// CHECK10-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
...
// CHECK10-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
//
//
// CHECK10-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK10-NEXT:    [[TMP9:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK10-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
// CHECK10-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP10]], [[TMP11]]
...
// CHECK10-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK10-NEXT:    br label [[COND_END7]]
// CHECK10:       cond.end7:
// CHECK10-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
//
//
// CHECK10-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK10-NEXT:    [[TMP11:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK10-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
// CHECK10-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK10-NEXT:    br label [[COND_END8]]
// CHECK10:       cond.end8:
// CHECK10-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK11-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP16]], i32 [[TMP17]], i32 [[TMP19]], [1000 x i32]* [[TMP0]], i32 [[TMP21]]) #[[ATTR2]]
...
// CHECK11-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
...
// CHECK11-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP29]], [[TMP30]]
...
// CHECK11-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK11-NEXT:    br label [[COND_END13]]
// CHECK11:       cond.end13:
// CHECK11-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP31]], [[COND_TRUE11]] ], [ [[TMP32]], [[COND_FALSE12]] ]
// CHECK11-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK11-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK11-NEXT:    store i32 [[TMP33]], i32* [[DOTOMP_IV]], align 4
...
// CHECK11-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK11-NEXT:    br i1 [[TMP40]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK11:       .omp.lastprivate.then:
// CHECK11-NEXT:    [[TMP41:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK11-NEXT:    store i32 [[TMP41]], i32* [[L_ADDR]], align 4
...
//
//
// CHECK11-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK11-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK11-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK11-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK11-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
// CHECK11-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK11-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK11-NEXT:    br label [[COND_END7]]
// CHECK11:       cond.end7:
// CHECK11-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
// CHECK11-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
// CHECK11-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK11-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK11-NEXT:    br label [[COND_END8]]
// CHECK11:       cond.end8:
// CHECK11-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
...
// CHECK12-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP16]], i32 [[TMP17]], i32 [[TMP19]], [1000 x i32]* [[TMP0]], i32 [[TMP21]]) #[[ATTR2]]
...
// CHECK12-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
...
// CHECK12-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP29]], [[TMP30]]
...
// CHECK12-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK12-NEXT:    br label [[COND_END13]]
// CHECK12:       cond.end13:
// CHECK12-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP31]], [[COND_TRUE11]] ], [ [[TMP32]], [[COND_FALSE12]] ]
// CHECK12-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK12-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK12-NEXT:    store i32 [[TMP33]], i32* [[DOTOMP_IV]], align 4
...
// CHECK12-NEXT:    [[TMP34:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK12-NEXT:    [[TMP35:%.*]] = load i32, i32* [[TMP34]], align 4
// CHECK12-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP35]])
// CHECK12-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK12-NEXT:    [[TMP37:%.*]] = icmp ne i32 [[TMP36]], 0
// CHECK12-NEXT:    br i1 [[TMP37]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK12-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP38]], 0
...
// CHECK12-NEXT:    br i1 [[TMP40]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK12:       .omp.lastprivate.then:
// CHECK12-NEXT:    [[TMP41:%.*]] = load i32, i32* [[L_ADDR]], align 4
// CHECK12-NEXT:    store i32 [[TMP41]], i32* [[L_ADDR]], align 4
...
//
//
// CHECK12-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l50
...
// CHECK12-NEXT:    call void @__omp_outlined__3(i32* [[TMP18]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], [1000 x i16]* [[TMP0]]) #[[ATTR2]]
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
// CHECK12-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK12-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK12-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP19]], [[TMP20]]
...
// CHECK12-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK12-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP25]], [[TMP26]]
// CHECK12-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK12:       cond.true10:
// CHECK12-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK12-NEXT:    br label [[COND_END12:%.*]]
// CHECK12:       cond.false11:
// CHECK12-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK12-NEXT:    br label [[COND_END12]]
// CHECK12:       cond.end12:
// CHECK12-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP27]], [[COND_TRUE10]] ], [ [[TMP28]], [[COND_FALSE11]] ]
...
// CHECK12-NEXT:    [[SUB14:%.*]] = sub nsw i32 [[TMP34]], 0
...
//
//
// CHECK12-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l55
...
// CHECK12-NEXT:    call void @__omp_outlined__5(i32* [[TMP9]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x i32]* [[TMP0]]) #[[ATTR2]]
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
// CHECK12-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
...
// CHECK12-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP12]], [[TMP13]]
...
// CHECK12-NEXT:    br label [[COND_END7]]
// CHECK12:       cond.end7:
// CHECK12-NEXT:    [[COND8:%.*]] = phi i32 [ 9, [[COND_TRUE5]] ], [ [[TMP17]], [[COND_FALSE6]] ]
...
//
//
// CHECK12-LABEL: define {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z9ftemplateIiET_i_l60
...
// CHECK12-NEXT:    call void @__omp_outlined__7(i32* [[TMP11]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP7]], i32 [[TMP8]], [10 x [10 x i32]]* [[TMP0]], i32 [[TMP10]]) #[[ATTR2]]
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
// CHECK12-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK12-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK12-NEXT:    br label [[COND_END8]]
// CHECK12:       cond.end8:
// CHECK12-NEXT:    [[COND9:%.*]] = phi i32 [ 99, [[COND_TRUE6]] ], [ [[TMP19]], [[COND_FALSE7]] ]
