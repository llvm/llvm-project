...
// CHECK-TLS:      [[INIT_LABEL]]
// CHECK-TLS-NEXT: store i8 1, ptr [[TLS_ADR_1]]
...
// CHECK-TLS1-SAME: () #[[ATTR0]] {
// CHECK-TLS1-NEXT:  entry:
// CHECK-TLS1-NEXT:    [[TLS_ADR_2:%.*]] = call align 1 ptr @llvm.threadlocal.address.p0(ptr align 1 @__tls_guard)
// CHECK-TLS1-NEXT:    [[TMP0:%.*]] = load i8, ptr [[TLS_ADR_2]], align 1
// CHECK-TLS1-NEXT:    [[GUARD_UNINITIALIZED:%.*]] = icmp eq i8 [[TMP0]], 0
// CHECK-TLS1-NEXT:    br i1 [[GUARD_UNINITIALIZED]], label [[INIT:%.*]], label [[EXIT:%.*]], !prof [[PROF3]]
// CHECK-TLS1:       init:
// CHECK-TLS1-NEXT:    store i8 1, ptr [[TLS_ADR_2]], align 1
...
// CHECK-TLS2-SAME: () #[[ATTR6]] {
// CHECK-TLS2-NEXT:  entry:
// CHECK-TLS2-NEXT:    [[TLS_ADR_3:%.*]] = call align 1 ptr @llvm.threadlocal.address.p0(ptr align 1 @__tls_guard)
// CHECK-TLS2-NEXT:    [[TMP0:%.*]] = load i8, ptr [[TLS_ADR_3]], align 1
// CHECK-TLS2-NEXT:    [[GUARD_UNINITIALIZED:%.*]] = icmp eq i8 [[TMP0]], 0
// CHECK-TLS2-NEXT:    br i1 [[GUARD_UNINITIALIZED]], label [[INIT:%.*]], label [[EXIT:%.*]], !prof [[PROF3]]
// CHECK-TLS2:       init:
// CHECK-TLS2-NEXT:    store i8 1, ptr [[TLS_ADR_3]], align 1
...
// CHECK-TLS3-NEXT:  entry:
// CHECK-TLS3-NEXT:    [[TLS_ADR_4:%.*]] = call align 1 ptr @llvm.threadlocal.address.p0(ptr align 1 @__tls_guard)
// CHECK-TLS3-NEXT:    [[TMP0:%.*]] = load i8, ptr [[TLS_ADR_4]], align 1, !dbg [[DBG327:![0-9]+]]
...
// CHECK-TLS3:       init:
// CHECK-TLS3-NEXT:    store i8 1, ptr [[TLS_ADR_4]], align 1, !dbg [[DBG327]]
...
// CHECK-TLS4-NEXT:  entry:
// CHECK-TLS4-NEXT:    [[TLS_ADR_5:%.*]] = call align 1 ptr @llvm.threadlocal.address.p0(ptr align 1 @__tls_guard)
// CHECK-TLS4-NEXT:    [[TMP0:%.*]] = load i8, ptr [[TLS_ADR_5]], align 1, !dbg [[DBG327:![0-9]+]]
...
// CHECK-TLS4:       init:
// CHECK-TLS4-NEXT:    store i8 1, ptr [[TLS_ADR_5]], align 1, !dbg [[DBG327]]
