...
// CHECK1-NEXT:    store i32 19, ptr [[K]], align 4
// CHECK1-NEXT:    store i32 19, ptr [[L]], align 4
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    store i32 19, ptr [[K]], align 4
// CHECK2-NEXT:    store i32 19, ptr [[L]], align 4
// CHECK2-NEXT:    ret void
//
//
...
// CHECK1: [[LOOP5]] = distinct !{[[LOOP5]], [[META3]]}
// CHECK1: [[LOOP6]] = distinct !{[[LOOP6]], [[META3]]}
...
// CHECK1: [[META12]] = !{}
// CHECK1: [[META13]] = !{i64 8}
// CHECK1: [[LOOP14]] = distinct !{[[LOOP14]], [[META3]]}
// CHECK1: [[LOOP15]] = distinct !{[[LOOP15]], [[META3]]}
//.
...
// CHECK2: [[LOOP12]] = distinct !{[[LOOP12]], [[META3]]}
// CHECK2: [[LOOP13]] = distinct !{[[LOOP13]], [[META3]]}
// CHECK2: [[LOOP14]] = distinct !{[[LOOP14]], [[META3]]}
// CHECK2: [[LOOP15]] = distinct !{[[LOOP15]], [[META3]]}
//.
