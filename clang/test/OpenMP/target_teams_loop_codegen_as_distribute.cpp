...
// CHECK-NEXT:    [[CMP6:%.*]] = icmp slt i32 [[TMP17]], [[TMP18]]
// CHECK-NEXT:    br i1 [[CMP6]], label [[FOR_BODY7:%.*]], label [[FOR_END:%.*]]
// CHECK:       for.body7:
...
// CHECK-NEXT:    [[MUL8:%.*]] = mul nsw i32 [[TMP20]], [[TMP21]]
// CHECK-NEXT:    [[TMP22:%.*]] = load i32, ptr [[J_ASCAST]], align 4
// CHECK-NEXT:    [[ADD9:%.*]] = add nsw i32 [[MUL8]], [[TMP22]]
...
// CHECK-NEXT:    store i32 [[ADD9]], ptr [[ARRAYIDX11]], align 4
...
// CHECK-NEXT:    br label [[FOR_COND5]], !llvm.loop [[LOOP9:![0-9]+]]
// CHECK:       for.end:
// CHECK-NEXT:    br label [[FOR_INC12:%.*]]
// CHECK:       for.inc12:
// CHECK-NEXT:    [[NVPTX_NUM_THREADS13:%.*]] = call i32 @__kmpc_get_hardware_num_threads_in_block()
// CHECK-NEXT:    [[TMP25:%.*]] = call i32 @__kmpc_get_hardware_num_blocks()
// CHECK-NEXT:    [[TMP26:%.*]] = mul i32 [[NVPTX_NUM_THREADS13]], [[TMP25]]
// CHECK-NEXT:    [[TMP27:%.*]] = mul i32 [[TMP26]], 1
// CHECK-NEXT:    [[TMP28:%.*]] = load i32, ptr [[DOTOMP_IV_ASCAST]], align 4
// CHECK-NEXT:    [[TMP29:%.*]] = add i32 [[TMP27]], [[TMP28]]
// CHECK-NEXT:    store i32 [[TMP29]], ptr [[DOTOMP_IV_ASCAST]], align 4
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[B_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @[[GLOB1:[0-9]+]] to ptr), i8 1, i1 true)
...
// CHECK-SAME: (ptr noalias noundef [[DOTGLOBAL_TID_:%.*]], ptr noalias noundef [[DOTBOUND_TID_:%.*]], i64 noundef [[N:%.*]], i64 noundef [[VLA:%.*]], ptr noundef nonnull align 4 dereferenceable(4) [[A:%.*]], i64 noundef [[VLA1:%.*]], ptr noundef nonnull align 4 dereferenceable(4) [[B:%.*]]) #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    call void @_Z3fooi(i32 noundef [[TMP18]]) #[[ATTR6:[0-9]+]]
// CHECK-NEXT:    store i32 0, ptr [[J_ASCAST]], align 4
// CHECK-NEXT:    br label [[FOR_COND:%.*]]
// CHECK:       for.cond:
...
// CHECK-SAME: (i32 noundef [[I:%.*]]) #[[ATTR5:[0-9]+]] {
// CHECK-NEXT:  entry:
