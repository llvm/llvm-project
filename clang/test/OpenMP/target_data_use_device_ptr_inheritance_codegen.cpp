...
// CHECK-NEXT:    ret void
//.
// CHECK1: @.offload_sizes = private unnamed_addr constant [1 x i64] zeroinitializer
// CHECK1: @.offload_maptypes = private unnamed_addr constant [1 x i64] [i64 [[#0x40]]]
//.
// CHECK2: @.offload_sizes = private unnamed_addr constant [1 x i64] zeroinitializer
// CHECK2: @.offload_maptypes = private unnamed_addr constant [1 x i64] [i64 [[#0x40]]]
//.
...
// CHECK1-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[PTR]], align 8
...
// CHECK1-NEXT:    store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTV1B, i64 16), ptr [[THIS1]], align 8
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK1-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK1-NEXT:    store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTV1A, i64 16), ptr [[THIS1]], align 8
// CHECK1-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw [[CLASS_A:%.*]], ptr [[THIS1]], i32 0, i32 1
...
// CHECK2-NEXT:    [[DOTOFFLOAD_BASEPTRS:%.*]] = alloca [1 x ptr], align 4
// CHECK2-NEXT:    [[DOTOFFLOAD_PTRS:%.*]] = alloca [1 x ptr], align 4
// CHECK2-NEXT:    [[DOTOFFLOAD_MAPPERS:%.*]] = alloca [1 x ptr], align 4
...
// CHECK2-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[PTR]], align 4
// CHECK2-NEXT:    [[TMP2:%.*]] = getelementptr inbounds [1 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CHECK2-NEXT:    store ptr [[TMP1]], ptr [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [1 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
...
// CHECK2-NEXT:    store ptr getelementptr inbounds inrange(-8, 4) (i8, ptr @_ZTV1B, i32 8), ptr [[THIS1]], align 4
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 4
// CHECK2-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 4
// CHECK2-NEXT:    store ptr getelementptr inbounds inrange(-8, 4) (i8, ptr @_ZTV1A, i32 8), ptr [[THIS1]], align 4
// CHECK2-NEXT:    [[PTR:%.*]] = getelementptr inbounds nuw [[CLASS_A:%.*]], ptr [[THIS1]], i32 0, i32 1
