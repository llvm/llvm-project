...
int main(int argc, char **argv) {
  ...
  #pragma omp target update to(i) nowait (3.14) device (-10u) // expected-error {{arguments of OpenMP clause 'nowait' with bitwise operators cannot be of floating type}}
