...
T tmain(T argc, S **argv) {
  ...
  // expected-error@+3 2 {{directive '#pragma omp masked taskloop simd' cannot contain more than one 'collapse' clause}}
...
int main(int argc, char **argv) {
  ...
  // expected-error@+2 2 {{directive '#pragma omp masked taskloop simd' cannot contain more than one 'collapse' clause}}
