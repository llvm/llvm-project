...
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR3:[0-9]+]]
...
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[VAR1]]) #[[ATTR3]]
// CHECK7-NEXT:    [[CALL:%.*]] = call noundef i32 @_Z5tmainIiET_v()
// CHECK7-NEXT:    store i32 [[CALL]], ptr [[RETVAL]], align 4
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[VAR]]) #[[ATTR3]]
...
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[ARRAYDESTROY_ELEMENT15]]) #[[ATTR3]]
...
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[TEST]]) #[[ATTR3]]
// CHECK7-NEXT:    call void @_ZN1SIdED1Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[TTT]]) #[[ATTR3]]
...
// CHECK7-SAME: (ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK7-NEXT:  entry:
// CHECK7-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// CHECK7-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK7-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK7-NEXT:    call void @_ZN1SIdED2Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[THIS1]]) #[[ATTR3]]
// CHECK7-NEXT:    ret void
//
//
...
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[VAR4]]) #[[ATTR3]]
...
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR3]]
// CHECK7-NEXT:    [[ARRAYDESTROY_DONE:%.*]] = icmp eq ptr [[ARRAYDESTROY_ELEMENT]], [[ARRAY_BEGIN10]]
// CHECK7-NEXT:    br i1 [[ARRAYDESTROY_DONE]], label [[ARRAYDESTROY_DONE11:%.*]], label [[ARRAYDESTROY_BODY]]
// CHECK7:       arraydestroy.done11:
// CHECK7-NEXT:    store i32 0, ptr [[RETVAL]], align 4
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR3]]
...
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT15]]) #[[ATTR3]]
// CHECK7-NEXT:    [[ARRAYDESTROY_DONE16:%.*]] = icmp eq ptr [[ARRAYDESTROY_ELEMENT15]], [[ARRAY_BEGIN12]]
// CHECK7-NEXT:    br i1 [[ARRAYDESTROY_DONE16]], label [[ARRAYDESTROY_DONE17:%.*]], label [[ARRAYDESTROY_BODY13]]
// CHECK7:       arraydestroy.done17:
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[TEST]]) #[[ATTR3]]
// CHECK7-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[TTT]]) #[[ATTR3]]
...
// CHECK7-SAME: (ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK7-NEXT:  entry:
// CHECK7-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// CHECK7-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK7-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
// CHECK7-NEXT:    call void @_ZN1SIiED2Ev(ptr dead_on_return noundef nonnull align 4 dereferenceable(4) [[THIS1]]) #[[ATTR3]]
// CHECK7-NEXT:    ret void
//
//
