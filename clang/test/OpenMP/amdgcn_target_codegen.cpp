...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(1) [[ARR_ADDR_ASCAST]], align 8, !nonnull [[META6:![0-9]+]], !align [[META7:![0-9]+]]
...
// CHECK-NEXT:    store ptr [[ARR]], ptr addrspace(1) [[ARR_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store ptr [[DYN_PTR]], ptr [[DYN_PTR_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(1) [[ARR_ADDR_ASCAST]], align 8, !nonnull [[META6]], !align [[META7]]
