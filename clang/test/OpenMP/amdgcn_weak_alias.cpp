...
// UTC_ARGS: --check-globals all --version 6 RUN: %clang_cc1 -fopenmp -x c++
// -triple x86_64-unknown-unknown -fopenmp-targets=amdgpu-amd-amdhsa
// -emit-llvm-bc %s -o %t-ppc-host.bc RUN: %clang_cc1 -fopenmp -x c++ -triple
// x86_64-unknown-unknown -fopenmp-targets=amdgpu-amd-amdhsa -emit-llvm %s -o -
// | FileCheck %s --check-prefix=HOST RUN: %clang_cc1 -fopenmp -x c++ -triple
...
// addrspace(1) constant i32 0 DEVICE:
// @__omp_rtl_assume_threads_oversubscription = weak_odr hidden addrspace(1)
// constant i32 0 DEVICE: @__omp_rtl_assume_no_thread_state = weak_odr hidden
// addrspace(1) constant i32 0 DEVICE: @__omp_rtl_assume_no_nested_parallelism =
// weak_odr hidden addrspace(1) constant i32 0 DEVICE: @_Z3Twov = weak hidden
// alias i32 (), ptr @_Z5__Twov DEVICE: @_Z3Twof = weak hidden alias float
// (float), ptr @_Z5__Twof DEVICE: @_Z4Two_v = hidden alias i32 (), ptr
// @_Z5__Twov DEVICE: @_Z4Two_f = hidden alias float (float), ptr @_Z5__Twof
...
// [[F_ADDR]] to ptr DEVICE-NEXT:    store float [[F]], ptr [[F_ADDR_ASCAST]],
// align 4 DEVICE-NEXT:    [[TMP0:%.*]] = load float, ptr [[F_ADDR_ASCAST]],
// align 4 DEVICE-NEXT:    [[MUL:%.*]] = fmul float 2.000000e+00, [[TMP0]]
...
// DEVICE: [[META1:![0-9]+]] = !{i32 7, !"openmp", i32 51}
// DEVICE: [[META2:![0-9]+]] = !{i32 7, !"openmp-device", i32 51}
