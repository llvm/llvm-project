...
tx ftemplate(int n) {
  tx a = 0;
#ifdef TARGET
  // expected-warning@+2 {{clause 'message' is currently not supported on a GPU; clause ignored}} expected-warning@+2 {{clause 'severity' is currently not supported on a GPU; clause ignored}}
#endif
...
#ifdef TARGET
  // expected-warning@+2 {{clause 'message' is currently not supported on a GPU; clause ignored}}
#endif
...
#ifdef TARGET
  // expected-warning@+2 {{clause 'severity' is currently not supported on a GPU; clause ignored}}
#endif
