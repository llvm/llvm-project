...
// -fopenmp-targets=amdgpu-amd-amdhsa -emit-llvm-bc %s -o %t-ppc-host.bc RUN:
...
// -fopenmp-host-ir-file-path %t-ppc-host.bc -o - | FileCheck %s RUN: llvm-dis <
// %t-ppc-host.bc | FileCheck %s -check-prefix=HOST
