...
int test_amdgcn_target_temp_alloca() {
  ...
  // CHECK-NEXT: [[DYN_PTR_ADDR_CAST:%.+]] = addrspacecast ptr addrspace(5)
  // [[DYN_PTR_ADDR]] to ptr CHECK-NEXT: [[VAR_ADDR_CAST:%.+]] = addrspacecast
  // ptr addrspace(5) [[VAR_ADDR]] to ptr CHECK-NEXT: [[VAR2_ADDR_CAST:%.+]] =
  // addrspacecast ptr addrspace(5) [[VAR2_ADDR]] to ptr CHECK:  store ptr
  // [[VAR:%.+]], ptr [[VAR_ADDR_CAST]], align 8
