...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], i32* [[TMP0]], i64 [[TMP21]]) #[[ATTR3]]
...
// CHECK1-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
...
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK2-NEXT:    call void @__omp_outlined__1(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], i32* [[TMP0]], i32 [[TMP19]]) #[[ATTR3]]
...
// CHECK2:       cond.true11:
// CHECK2-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
...
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], i32* [[TMP0]], i32 [[TMP19]]) #[[ATTR3]]
...
// CHECK3:       cond.true11:
// CHECK3-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
...
// CHECK4-NEXT:    call void @__omp_outlined__1(i32* [[TMP22]], i32* [[DOTBOUND_ZERO_ADDR]], i64 [[TMP15]], i64 [[TMP17]], i64 [[TMP19]], i32* [[TMP0]], i64 [[TMP21]]) #[[ATTR3]]
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
// CHECK4-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK4-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK4-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
...
// CHECK4-NEXT:    [[ADD11:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
...
// CHECK4-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
// CHECK4-NEXT:    store i32 [[ADD12]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK4-NEXT:    [[CMP13:%.*]] = icmp sgt i32 [[TMP29]], [[TMP30]]
// CHECK4-NEXT:    br i1 [[CMP13]], label [[COND_TRUE14:%.*]], label [[COND_FALSE15:%.*]]
// CHECK4:       cond.true14:
// CHECK4-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK4-NEXT:    br label [[COND_END16:%.*]]
// CHECK4:       cond.false15:
// CHECK4-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    br label [[COND_END16]]
// CHECK4:       cond.end16:
// CHECK4-NEXT:    [[COND17:%.*]] = phi i32 [ [[TMP31]], [[COND_TRUE14]] ], [ [[TMP32]], [[COND_FALSE15]] ]
// CHECK4-NEXT:    store i32 [[COND17]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK4-NEXT:    [[TMP33:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK4-NEXT:    store i32 [[TMP33]], i32* [[DOTOMP_IV]], align 4
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK4-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP35]])
...
// CHECK5-NEXT:    call void @__omp_outlined__1(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], i32* [[TMP0]], i32 [[TMP19]]) #[[ATTR3]]
...
// CHECK5-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK5-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK5-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
...
// CHECK5-NEXT:    br label [[COND_END13]]
// CHECK5:       cond.end13:
// CHECK5-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
// CHECK5-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK5-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK5-NEXT:    store i32 [[TMP31]], i32* [[DOTOMP_IV]], align 4
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK6-NEXT:    [[TMP20:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    call void @__omp_outlined__1(i32* [[TMP20]], i32* [[DOTBOUND_ZERO_ADDR]], i32 [[TMP14]], i32 [[TMP15]], i32 [[TMP17]], i32* [[TMP0]], i32 [[TMP19]]) #[[ATTR3]]
...
// CHECK6-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK6-NEXT:    store i32 [[ADD9]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK6-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP27]], [[TMP28]]
...
// CHECK6-NEXT:    br label [[COND_END13]]
// CHECK6:       cond.end13:
// CHECK6-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP29]], [[COND_TRUE11]] ], [ [[TMP30]], [[COND_FALSE12]] ]
// CHECK6-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP31]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND]]
...
// CHECK6-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP33]])
