...
// CHECK-NEXT:    %[[OMP_GLOBAL_THREAD_NUM38:.+]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB5:.+]])
// CHECK-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 %[[OMP_GLOBAL_THREAD_NUM38]])
// CHECK-NEXT:    br label %[[OMP_PRECOND_END]]
// CHECK-EMPTY:
// CHECK-NEXT:  [[OMP_PRECOND_END]]:
// CHECK-NEXT:    %[[OMP_GLOBAL_THREAD_NUM39:.+]] = call i32 @__kmpc_global_thread_num(%struct.ident_t* @[[GLOB3]])
// CHECK-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB6:.+]], i32 %[[OMP_GLOBAL_THREAD_NUM39]])
// CHECK-NEXT:    ret void
// CHECK-NEXT:  }
