...
// CHECK45-64-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca ptr, align 8
...
// CHECK45-32-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca ptr, align 4
...
// CHECK45-32-EX-NEXT:    [[CAPTURED_VARS_ADDRS:%.*]] = alloca ptr, align 4
