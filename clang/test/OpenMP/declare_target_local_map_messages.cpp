...
void test_target() {
// expected-error@+1 {{device-local variable 'x_local' is not allowed in 'map'
// clause}}
#pragma omp target map(tofrom : x_local)
  { x_local = 1; }

// expected-error@+1 {{device-local variable 'arr_local' is not allowed in 'map'
// clause}}
...
// expected-error@+2 {{device-local variable 'x_local' is not allowed in 'map'
// clause}} expected-error@+1 {{device-local variable 'arr_local' is not allowed
// in 'map' clause}}
