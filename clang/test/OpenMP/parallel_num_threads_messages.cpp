...
T tmain(T argc, S **argv) {
  ...
  #pragma omp parallel num_threads (argv[1]=2) // expected-error 2 {{incompatible integer to pointer conversion assigning to 'char *' from 'int'}}
  ...
  #pragma omp parallel num_threads(strict 4) // omp60-error {{missing ':' after num_threads modifier}}
  ...
  #pragma omp parallel num_threads(strict: argv[1]=2) // omp60-error 2 {{incompatible integer to pointer conversion assigning to 'char *' from 'int'}}
  ...
  #pragma omp parallel num_threads(strict: 4, strict: 5) // omp60-error {{use of undeclared identifier 'strict'}}
...
int z;
  ...
  #pragma omp parallel num_threads (argv[1]=2) // expected-error {{incompatible integer to pointer conversion assigning to 'char *' from 'int'}}
  ...
  #pragma omp parallel num_threads(strict: argv[1]=2) // omp60-error {{incompatible integer to pointer conversion assigning to 'char *' from 'int'}}
