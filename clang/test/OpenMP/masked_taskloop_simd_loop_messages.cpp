...
// omp4-error@+3 {{loop iteration variable in the associated loop of 'omp masked taskloop simd' directive may not be private, predetermined as linear}}
#pragma omp parallel
...
// omp4-error@+3 {{loop iteration variable in the associated loop of 'omp masked taskloop simd' directive may not be lastprivate, predetermined as linear}}
#pragma omp parallel
...
#pragma omp parallel
  {
// expected-error@+2 {{loop iteration variable in the associated loop of 'omp masked taskloop simd' directive may not be threadprivate or thread local, predetermined as linear}}
#pragma omp masked taskloop simd
...
#pragma omp parallel
// omp4-error@+2 {{statement after '#pragma omp masked taskloop simd' must be a for loop}}
#pragma omp masked taskloop simd
  for (auto &item : a) {
    item = item + 1;
  }
