...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[ARRAYIDX3]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK1-NEXT:    [[CALL7:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_DESTELEMENTPAST]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_SRCELEMENTPAST]])
...
// CHECK1-NEXT:    [[CALL9:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[TMP8]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load i32*, i32** [[C11]], align 8
...
// CHECK1-SAME: (%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK1-NEXT:  entry:
...
// CHECK1-SAME: (%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS:%.*]], i32 noundef [[A:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK1-NEXT:  entry:
// CHECK1-NEXT:    [[THIS_ADDR:%.*]] = alloca %struct.S.4*, align 8
...
// CHECK1-NEXT:    call void @_ZN1SIiEC1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYCTOR_CUR]])
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYIDX6]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP21]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    [[CALL9:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_DESTELEMENTPAST]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_SRCELEMENTPAST]])
...
// CHECK1-NEXT:    [[CALL11:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP10]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP33]])
// CHECK1-NEXT:    br label [[DOTOMP_LASTPRIVATE_DONE]]
// CHECK1:       .omp.lastprivate.done:
...
// CHECK3-NEXT:    call void @"_ZZZ4mainENK3$_0clEvENKUlvE_clEv"(%class.anon.5* noundef nonnull align 8 dereferenceable(24) [[REF_TMP]])
// CHECK3-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK3:       omp.body.continue:
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK4-NEXT:    call void [[TMP22]](i8* noundef [[TMP20]])
...
// CHECK4-NEXT:    call void [[TMP28]](i8* noundef [[TMP26]])
// CHECK4-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK4:       omp.body.continue:
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
...
// CHECK5-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[ARRAYIDX3]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK5-NEXT:    [[CALL7:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_DESTELEMENTPAST]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_SRCELEMENTPAST]])
...
// CHECK5-NEXT:    [[CALL9:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(4) [[TMP8]], %struct.S* noundef nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK5-NEXT:    call void @_ZN1SIiEC1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TEST]])
...
// CHECK5-NEXT:    call void @_ZN1SIiEC1Ei(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYINIT_BEGIN]], i32 noundef 1)
// CHECK5-NEXT:    [[ARRAYINIT_ELEMENT:%.*]] = getelementptr inbounds [[STRUCT_S_4]], %struct.S.4* [[ARRAYINIT_BEGIN]], i64 1
// CHECK5-NEXT:    call void @_ZN1SIiEC1Ei(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYINIT_ELEMENT]], i32 noundef 2)
...
// CHECK5-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR5]]
...
// CHECK5-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TEST]]) #[[ATTR5]]
// CHECK5-NEXT:    [[TMP7:%.*]] = load i32, i32* [[RETVAL]], align 4
// CHECK5-NEXT:    ret i32 [[TMP7]]
//
//
...
// CHECK5-NEXT:    [[TMP13:%.*]] = load i32*, i32** [[C11]], align 8
...
// CHECK5-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP15]], 1
...
// CHECK5-SAME: (%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK5-NEXT:  entry:
...
// CHECK5-NEXT:    call void @_ZN1SIiEC2Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS1]])
// CHECK5-NEXT:    ret void
//
//
...
// CHECK5-SAME: (%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS:%.*]], i32 noundef [[A:%.*]]) unnamed_addr #[[ATTR1]] align 2 {
// CHECK5-NEXT:  entry:
// CHECK5-NEXT:    [[THIS_ADDR:%.*]] = alloca %struct.S.4*, align 8
...
// CHECK5-NEXT:    call void @_ZN1SIiEC2Ei(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS1]], i32 noundef [[TMP0]])
// CHECK5-NEXT:    ret void
//
//
...
// CHECK5-NEXT:    call void @_ZN1SIiEC1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYCTOR_CUR]])
...
// CHECK5-NEXT:    call void @_ZN1SIiEC1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK5-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[ARRAYIDX6]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP21]])
// CHECK5-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK5:       omp.body.continue:
// CHECK5-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK5:       omp.inner.for.inc:
...
// CHECK5-NEXT:    [[CALL9:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_DESTELEMENTPAST]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[OMP_ARRAYCPY_SRCELEMENTPAST]])
...
// CHECK5-NEXT:    [[CALL11:%.*]] = call noundef nonnull align 4 dereferenceable(4) %struct.S.4* @_ZN1SIiEaSERKS0_(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP10]], %struct.S.4* noundef nonnull align 4 dereferenceable(4) [[TMP33]])
// CHECK5-NEXT:    br label [[DOTOMP_LASTPRIVATE_DONE]]
// CHECK5:       .omp.lastprivate.done:
// CHECK5-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR5]]
...
// CHECK5-NEXT:    store %struct.S.4* [[THIS]], %struct.S.4** [[THIS_ADDR]], align 8
// CHECK5-NEXT:    [[THIS1:%.*]] = load %struct.S.4*, %struct.S.4** [[THIS_ADDR]], align 8
// CHECK5-NEXT:    call void @_ZN1SIiED2Ev(%struct.S.4* noundef nonnull align 4 dereferenceable(4) [[THIS1]]) #[[ATTR5]]
// CHECK5-NEXT:    ret void
//
//
