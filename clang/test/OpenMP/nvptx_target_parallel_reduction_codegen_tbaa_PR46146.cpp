...
// CHECK1-NEXT:    call void @__omp_outlined__(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6:[0-9]+]]
...
// CHECK1-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP18]]) #[[ATTR6]]
...
// CHECK1-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.0* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK1-NEXT:    [[TMP25:%.*]] = call align 16 i8* @__kmpc_alloc_shared(i64 24)
// CHECK1-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK1-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK1-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.0*
// CHECK1-NEXT:    store [[STRUCT_ANON_0]] [[TMP27]], %struct.anon.0* [[TMP28]], align 8
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__1_wrapper to i8*), i8* [[TMP26]])
...
// CHECK1-NEXT:    call void @__kmpc_distribute_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]])
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP34]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP35:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP35]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP7]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP10]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP12]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP21]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP24]]) #[[ATTR6]]
// CHECK1-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    [[TMP25:%.*]] = bitcast %"class.std::complex"* [[PARTIAL_SUM]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP25]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP27]]) #[[ATTR6]]
// CHECK1-NEXT:    store float 0.000000e+00, float* [[REF_TMP5]], align 4, !tbaa [[TBAA14]]
// CHECK1-NEXT:    call void @_ZNSt7complexIfEC1ERKfS2_(%"class.std::complex"* nonnull align 4 dereferenceable(8) [[PARTIAL_SUM]], float* nonnull align 4 dereferenceable(4) [[REF_TMP]], float* nonnull align 4 dereferenceable(4) [[REF_TMP5]]) #[[ATTR11]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP44]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP45:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP45]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP47]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @_ZNSt7complexIfEC1ERKfS2_(%"class.std::complex"* nonnull align 4 dereferenceable(8) [[REF_TMP13]], float* nonnull align 4 dereferenceable(4) [[REF_TMP14]], float* nonnull align 4 dereferenceable(4) [[REF_TMP15]]) #[[ATTR11]]
// CHECK1-NEXT:    [[CALL:%.*]] = call nonnull align 4 dereferenceable(8) %"class.std::complex"* @_ZNSt7complexIfEpLIfEERS0_RKS_IT_E(%"class.std::complex"* nonnull align 4 dereferenceable(8) [[PARTIAL_SUM]], %"class.std::complex"* nonnull align 4 dereferenceable(8) [[REF_TMP13]]) #[[ATTR11]]
// CHECK1-NEXT:    [[TMP49:%.*]] = bitcast float* [[REF_TMP15]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP49]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP50:%.*]] = bitcast float* [[REF_TMP14]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP50]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex"* [[REF_TMP13]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP51]]) #[[ATTR6]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    [[CALL20:%.*]] = call nonnull align 4 dereferenceable(8) %"class.std::complex"* @_ZNSt7complexIfEpLIfEERS0_RKS_IT_E(%"class.std::complex"* nonnull align 4 dereferenceable(8) [[TMP6]], %"class.std::complex"* nonnull align 4 dereferenceable(8) [[PARTIAL_SUM]]) #[[ATTR11]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP67]]) #[[ATTR6]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP72]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP73:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_1]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP73]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP74:%.*]] = bitcast i32* [[DOTCAPTURE_EXPR_]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP74]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP75:%.*]] = bitcast i32* [[DOTOMP_IV]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP75]]) #[[ATTR6]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP4]]) #[[ATTR6]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @__omp_outlined__2(i32* [[DOTTHREADID_TEMP_]], i32* [[DOTZERO_ADDR]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]]) #[[ATTR6]]
// CHECK1-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i8 1, i1 true)
// CHECK1-NEXT:    ret void
// CHECK1:       worker.exit:
// CHECK1-NEXT:    ret void
...
// CHECK1-NEXT:    [[TMP7:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP7]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    call void @__kmpc_distribute_static_init_4(%struct.ident_t* @[[GLOB2]], i32 [[TMP8]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
// CHECK1-NEXT:    [[TMP9:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP9]], 99
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP16]]) #[[ATTR6]]
// CHECK1-NEXT:    store double 0.000000e+00, double* [[REF_TMP2]], align 8, !tbaa [[TBAA22]]
// CHECK1-NEXT:    call void @_ZNSt7complexIdEC1ERKdS2_(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[PARTIAL_SUM_ON_STACK]], double* nonnull align 8 dereferenceable(8) [[REF_TMP]], double* nonnull align 8 dereferenceable(8) [[REF_TMP2]]) #[[ATTR11]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP18]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP19:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    [[MUL3:%.*]] = mul nsw i32 [[TMP19]], 4
// CHECK1-NEXT:    store i32 [[MUL3]], i32* [[ISTART_ON_STACK]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    [[TMP20:%.*]] = load i32, i32* [[IB]], align 4, !tbaa [[TBAA8]]
...
// CHECK1-NEXT:    [[TMP24:%.*]] = bitcast %struct.anon.3* [[DOTTMP_OUTLINED_AGG_ARG]] to i8*
// CHECK1-NEXT:    [[TMP25:%.*]] = call align 16 i8* @__kmpc_alloc_shared(i64 24)
// CHECK1-NEXT:    [[TMP26:%.*]] = call i8* @__kmpc_alloc_aggregate_arg(i8* [[TMP24]], i8* [[TMP25]])
// CHECK1-NEXT:    [[TMP27:%.*]] = load [[STRUCT_ANON_3]], %struct.anon.3* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK1-NEXT:    [[TMP28:%.*]] = bitcast i8* [[TMP26]] to %struct.anon.3*
// CHECK1-NEXT:    store [[STRUCT_ANON_3]] [[TMP27]], %struct.anon.3* [[TMP28]], align 8
// CHECK1-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB1]], i32 [[TMP8]], i32 1, i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.3*)* @__omp_outlined__3 to i8*), i8* bitcast (void (i16, i32)* @__omp_outlined__3_wrapper to i8*), i8* [[TMP26]])
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP25]], i64 24)
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
...
// CHECK1-NEXT:    call void @_ZNSt7complexIdEC2ERKdS2_(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[THIS1]], double* nonnull align 8 dereferenceable(8) [[TMP0]], double* nonnull align 8 dereferenceable(8) [[TMP1]]) #[[ATTR11]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP25]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP26:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP26]]) #[[ATTR6]]
// CHECK1-NEXT:    store double 0.000000e+00, double* [[REF_TMP]], align 8, !tbaa [[TBAA22]]
// CHECK1-NEXT:    [[TMP27:%.*]] = bitcast double* [[REF_TMP5]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP27]]) #[[ATTR6]]
// CHECK1-NEXT:    store double 0.000000e+00, double* [[REF_TMP5]], align 8, !tbaa [[TBAA22]]
// CHECK1-NEXT:    call void @_ZNSt7complexIdEC1ERKdS2_(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[PARTIAL_SUM]], double* nonnull align 8 dereferenceable(8) [[REF_TMP]], double* nonnull align 8 dereferenceable(8) [[REF_TMP5]]) #[[ATTR11]]
// CHECK1-NEXT:    [[TMP28:%.*]] = bitcast double* [[REF_TMP5]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP28]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP29:%.*]] = bitcast double* [[REF_TMP]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP29]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP30:%.*]] = bitcast i32* [[I6]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 4, i8* [[TMP30]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP31:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP32:%.*]] = load i32, i32* [[TMP31]], align 4, !tbaa [[TBAA8]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 16, i8* [[TMP44]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP45:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP45]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP46:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
...
// CHECK1-NEXT:    call void @llvm.lifetime.start.p0i8(i64 8, i8* [[TMP47]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP48:%.*]] = load i32, i32* [[I6]], align 4, !tbaa [[TBAA8]]
// CHECK1-NEXT:    [[CONV16:%.*]] = sitofp i32 [[TMP48]] to double
// CHECK1-NEXT:    store double [[CONV16]], double* [[REF_TMP15]], align 8, !tbaa [[TBAA22]]
// CHECK1-NEXT:    call void @_ZNSt7complexIdEC1ERKdS2_(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[REF_TMP13]], double* nonnull align 8 dereferenceable(8) [[REF_TMP14]], double* nonnull align 8 dereferenceable(8) [[REF_TMP15]]) #[[ATTR11]]
// CHECK1-NEXT:    [[CALL:%.*]] = call nonnull align 8 dereferenceable(16) %"class.std::complex.2"* @_ZNSt7complexIdEpLIdEERS0_RKS_IT_E(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[PARTIAL_SUM]], %"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[REF_TMP13]]) #[[ATTR11]]
// CHECK1-NEXT:    [[TMP49:%.*]] = bitcast double* [[REF_TMP15]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP49]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP50:%.*]] = bitcast double* [[REF_TMP14]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 8, i8* [[TMP50]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP51:%.*]] = bitcast %"class.std::complex.2"* [[REF_TMP13]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP51]]) #[[ATTR6]]
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    br i1 [[TMP65]], label [[DOTOMP_REDUCTION_THEN:%.*]], label [[DOTOMP_REDUCTION_DONE:%.*]]
// CHECK1:       .omp.reduction.then:
// CHECK1-NEXT:    [[CALL20:%.*]] = call nonnull align 8 dereferenceable(16) %"class.std::complex.2"* @_ZNSt7complexIdEpLIdEERS0_RKS_IT_E(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[TMP6]], %"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[PARTIAL_SUM]]) #[[ATTR11]]
// CHECK1-NEXT:    call void @__kmpc_nvptx_end_reduce_nowait(i32 [[TMP60]])
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DONE]]
// CHECK1:       .omp.reduction.done:
// CHECK1-NEXT:    [[TMP66:%.*]] = bitcast i32* [[I6]] to i8*
...
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 16, i8* [[TMP67]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP68:%.*]] = bitcast i32* [[DOTOMP_IS_LAST]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP68]]) #[[ATTR6]]
// CHECK1-NEXT:    [[TMP69:%.*]] = bitcast i32* [[DOTOMP_STRIDE]] to i8*
// CHECK1-NEXT:    call void @llvm.lifetime.end.p0i8(i64 4, i8* [[TMP69]]) #[[ATTR6]]
...
// CHECK1-NEXT:    [[CALL:%.*]] = call double @_ZNKSt7complexIdE4realEv(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[TMP0]]) #[[ATTR11]]
...
// CHECK1-NEXT:    [[CALL2:%.*]] = call double @_ZNKSt7complexIdE4imagEv(%"class.std::complex.2"* nonnull align 8 dereferenceable(16) [[TMP2]]) #[[ATTR11]]
...
// CHECK1-NEXT:    [[TMP8:%.*]] = load i16, i16* [[DOTADDR3]], align 2, !tbaa [[TBAA19]]
// CHECK1-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[TMP5]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP10:%.*]] = bitcast i8** [[TMP9]] to %"class.std::complex.2"**
// CHECK1-NEXT:    [[TMP11:%.*]] = load %"class.std::complex.2"*, %"class.std::complex.2"** [[TMP10]], align 8
// CHECK1-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[DOTOMP_REDUCTION_REMOTE_REDUCE_LIST]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP13:%.*]] = getelementptr %"class.std::complex.2", %"class.std::complex.2"* [[TMP11]], i64 1
// CHECK1-NEXT:    [[TMP14:%.*]] = bitcast %"class.std::complex.2"* [[TMP13]] to i8*
// CHECK1-NEXT:    [[TMP15:%.*]] = bitcast %"class.std::complex.2"* [[TMP11]] to i64*
...
// CHECK1-NEXT:    br label [[DOTSHUFFLE_PRE_COND]]
// CHECK1:       .shuffle.exit:
// CHECK1-NEXT:    [[TMP31:%.*]] = bitcast %"class.std::complex.2"* [[DOTOMP_REDUCTION_ELEMENT]] to i8*
...
// CHECK1-NEXT:    [[TMP50:%.*]] = bitcast i8** [[TMP49]] to %"class.std::complex.2"**
// CHECK1-NEXT:    [[TMP51:%.*]] = load %"class.std::complex.2"*, %"class.std::complex.2"** [[TMP50]], align 8
// CHECK1-NEXT:    [[TMP52:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[TMP5]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP53:%.*]] = bitcast i8** [[TMP52]] to %"class.std::complex.2"**
// CHECK1-NEXT:    [[TMP54:%.*]] = load %"class.std::complex.2"*, %"class.std::complex.2"** [[TMP53]], align 8
// CHECK1-NEXT:    [[TMP55:%.*]] = bitcast %"class.std::complex.2"* [[TMP54]] to i8*
// CHECK1-NEXT:    [[TMP56:%.*]] = bitcast %"class.std::complex.2"* [[TMP51]] to i8*
...
// CHECK1-NEXT:    call void @__omp_outlined__3(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.3* [[TMP4]]) #[[ATTR6]]
// CHECK1-NEXT:    ret void
//
//
