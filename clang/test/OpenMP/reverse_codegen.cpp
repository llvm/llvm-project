...
//
//
// CHECK1-LABEL: define internal void @foo4.omp_outlined(
...
//
//
// CHECK1-LABEL: define dso_local void @tfoo5(
// CHECK1-SAME: ) #[[ATTR0]] {
// CHECK1-NEXT:  entry:
...
//
//
// CHECK1-LABEL: define linkonce_odr void @_Z4foo5IiTnT_Li3EEvS0_S0_(
...
// CHECK1-NEXT:    [[SUB_PTR_LHS_CAST11:%.*]] = ptrtoint ptr [[TMP18]] to i64
// CHECK1-NEXT:    [[SUB_PTR_RHS_CAST12:%.*]] = ptrtoint ptr [[TMP19]] to i64
...
//
//
// CHECK1-LABEL: define internal void @_GLOBAL__sub_I_reverse_codegen.cpp(
...
//
//
// CHECK2-LABEL: define internal void @foo4.omp_outlined(
...
// CHECK2-NEXT:    [[SUB_PTR_LHS_CAST11:%.*]] = ptrtoint ptr [[TMP18]] to i64
// CHECK2-NEXT:    [[SUB_PTR_RHS_CAST12:%.*]] = ptrtoint ptr [[TMP19]] to i64
...
//
//
// CHECK2-LABEL: define dso_local void @tfoo5(
// CHECK2-SAME: ) #[[ATTR1]] {
// CHECK2-NEXT:  entry:
...
//
//
// CHECK2-LABEL: define linkonce_odr void @_Z4foo5IiTnT_Li3EEvS0_S0_(
...
//
//
// CHECK2-LABEL: define internal void @_GLOBAL__sub_I_reverse_codegen.cpp(
