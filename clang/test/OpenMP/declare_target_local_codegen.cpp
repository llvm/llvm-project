...
// -o - | FileCheck %s --check-prefix=HOST RUN: %clang_cc1 -verify=omp60
// -fopenmp -fopenmp-version=60 -x c++ -triple powerpc64le-unknown-unknown
// -fopenmp-targets=amdgpu-amd-amdhsa -emit-llvm-bc %s -o %t-host.bc RUN:
// %clang_cc1 -verify=omp60 -fopenmp -fopenmp-version=60 -x c++ -triple
...
// %s --check-prefix=DEVICE RUN: %clang_cc1 -verify=omp60 -fopenmp
// -fopenmp-version=60 -x c++ -triple amdgpu-amd-amdhsa %s
// -fopenmp-is-target-device -fvisibility=protected -fopenmp-host-ir-file-path
// %t-host.bc -emit-pch -o %t RUN: %clang_cc1 -fopenmp -fopenmp-version=60 -x
// c++ -triple amdgpu-amd-amdhsa -emit-llvm %s -fopenmp-is-target-device
...
#pragma omp declare target local(local_nohost_var) device_type(                \
        nohost) // omp60-warning {{'device_type(nohost)' is not yet supported
                // with 'local' clause; treating as 'device_type(any)'}}

double local_nohost_arr[32];
#pragma omp declare target local(local_nohost_arr) device_type(                \
        nohost) // omp60-warning {{'device_type(nohost)' is not yet supported
                // with 'local' clause; treating as 'device_type(any)'}}
...
#pragma omp target map(from : result)
  {
    ...
    result = local_scalar + local_array[0] + read_local_storage<int>();
  }
  return result;
}
...
// [[STRUCT___TGT_KERNEL_ARGUMENTS:%.*]], align 8 HOST-NEXT:    store i32 0, ptr
// [[RESULT]], align 4 HOST-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [2 x
// ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0 HOST-NEXT:    store ptr
// [[RESULT]], ptr [[TMP0]], align 8 HOST-NEXT:    [[TMP1:%.*]] = getelementptr
// inbounds [2 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0 HOST-NEXT:    store
// ptr [[RESULT]], ptr [[TMP1]], align 8 HOST-NEXT:    [[TMP2:%.*]] =
// getelementptr inbounds [2 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 0
// HOST-NEXT:    store ptr null, ptr [[TMP2]], align 8
// HOST-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [2 x ptr], ptr
// [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 1 HOST-NEXT:    store ptr null, ptr
// [[TMP3]], align 8 HOST-NEXT:    [[TMP4:%.*]] = getelementptr inbounds [2 x
// ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 1 HOST-NEXT:    store ptr null, ptr
// [[TMP4]], align 8 HOST-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [2 x
// ptr], ptr [[DOTOFFLOAD_MAPPERS]], i64 0, i64 1 HOST-NEXT:    store ptr null,
// ptr [[TMP5]], align 8 HOST-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [2
// x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0 HOST-NEXT:    [[TMP7:%.*]]
...
// ptr [[KERNEL_ARGS]]) HOST-NEXT:    [[TMP22:%.*]] = icmp ne i32 [[TMP21]], 0
// HOST-NEXT:    br i1 [[TMP22]], label [[OMP_OFFLOAD_FAILED:%.*]], label
// [[OMP_OFFLOAD_CONT:%.*]] HOST:       omp_offload.failed: HOST-NEXT:    call
// void @{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z14use_local_varsv_l70(ptr
// [[RESULT]], ptr null) #[[ATTR2:[0-9]+]] HOST-NEXT:    br label
// [[OMP_OFFLOAD_CONT]] HOST:       omp_offload.cont: HOST-NEXT: [[TMP23:%.*]] =
// load i32, ptr [[RESULT]], align 4 HOST-NEXT:    ret i32 [[TMP23]]
//
//
// HOST-LABEL: define
// {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z14use_local_varsv_l70
// HOST-SAME: (ptr noundef nonnull align 4 dereferenceable(4) [[RESULT:%.*]],
// ptr noalias noundef [[DYN_PTR:%.*]]) #[[ATTR1:[0-9]+]] { HOST-NEXT:  entry:
...
// HOST-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[RESULT_ADDR]], align 8, !nonnull
// [[META8:![0-9]+]], !align [[META9:![0-9]+]] HOST-NEXT:    store i32 42, ptr
// @local_scalar, align 4 HOST-NEXT:    store i32 1, ptr @local_array, align 4
...
// @_Z18read_local_storageIiET_v() HOST-NEXT:    [[ADD1:%.*]] = add nsw i32
// [[ADD]], [[CALL]] HOST-NEXT:    store i32 [[ADD1]], ptr [[TMP0]], align 4
// HOST-NEXT:    ret void
//
//
...
// align 4 HOST-NEXT:    ret i32 [[TMP0]]
//
//
...
// [[RESULT]], ptr null) #[[ATTR2]] HOST-NEXT:    br label [[OMP_OFFLOAD_CONT]]
...
// HOST-SAME: (ptr noundef nonnull align 4 dereferenceable(4) [[RESULT:%.*]],
// ptr noalias noundef [[DYN_PTR:%.*]]) #[[ATTR1]] { HOST-NEXT:  entry:
// HOST-NEXT:    [[RESULT_ADDR:%.*]] = alloca ptr, align 8
// HOST-NEXT:    [[DYN_PTR_ADDR:%.*]] = alloca ptr, align 8
// HOST-NEXT:    store ptr [[RESULT]], ptr [[RESULT_ADDR]], align 8
// HOST-NEXT:    store ptr [[DYN_PTR]], ptr [[DYN_PTR_ADDR]], align 8
// HOST-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[RESULT_ADDR]], align 8, !nonnull
// [[META8]], !align [[META9]] HOST-NEXT:    store i32 7, ptr @local_nohost_var,
// align 4 HOST-NEXT:    [[TMP1:%.*]] = load i32, ptr @local_nohost_var, align 4
...
// HOST-NEXT:    store ptr [[DYN_PTR]], ptr [[DYN_PTR_ADDR]], align 8
// HOST-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[RESULT_ADDR]], align 8, !nonnull
// [[META8]], !align [[META9]] HOST-NEXT:    store i32 55, ptr
// @_ZN11PlainStruct8s_memberE, align 4 HOST-NEXT:    store i32 77, ptr
// @local_init_var, align 4 HOST-NEXT:    [[TMP1:%.*]] = load i32, ptr
// @_ZN11PlainStruct8s_memberE, align 4 HOST-NEXT:    [[TMP2:%.*]] = load i32,
// ptr @local_init_var, align 4 HOST-NEXT:    [[ADD:%.*]] = add nsw i32
// [[TMP1]], [[TMP2]] HOST-NEXT:    store i32 [[ADD]], ptr [[TMP0]], align 4
// HOST-NEXT:    ret void
//
//
// DEVICE-LABEL: define
// {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z14use_local_varsv_l70
// DEVICE-SAME: (ptr noundef nonnull align 4 dereferenceable(4) [[RESULT:%.*]],
// ptr noalias noundef [[DYN_PTR:%.*]]) #[[ATTR0:[0-9]+]] { DEVICE-NEXT:  entry:
...
// [[RESULT_ADDR]] to ptr DEVICE-NEXT:    [[DYN_PTR_ADDR_ASCAST:%.*]] =
// addrspacecast ptr addrspace(5) [[DYN_PTR_ADDR]] to ptr DEVICE-NEXT:    store
// ptr [[RESULT]], ptr [[RESULT_ADDR_ASCAST]], align 8 DEVICE-NEXT:    store ptr
// [[DYN_PTR]], ptr [[DYN_PTR_ADDR_ASCAST]], align 8 DEVICE-NEXT: [[TMP0:%.*]] =
// load ptr, ptr [[RESULT_ADDR_ASCAST]], align 8, !nonnull [[META7:![0-9]+]],
// !align [[META8:![0-9]+]] DEVICE-NEXT:    [[TMP1:%.*]] = call i32
...
// to ptr), ptr [[DYN_PTR]]) DEVICE-NEXT:    [[EXEC_USER_CODE:%.*]] = icmp eq
// i32 [[TMP1]], -1 DEVICE-NEXT:    br i1 [[EXEC_USER_CODE]], label
// [[USER_CODE_ENTRY:%.*]], label [[WORKER_EXIT:%.*]] DEVICE: user_code.entry:
// DEVICE-NEXT:    store i32 42, ptr addrspacecast (ptr addrspace(1)
// @local_scalar to ptr), align 4 DEVICE-NEXT:    store i32 1, ptr addrspacecast
// (ptr addrspace(1) @local_array to ptr), align 4 DEVICE-NEXT:    store i32
// 100, ptr addrspacecast (ptr addrspace(1) @_ZN12LocalStorageIiE5valueE to
// ptr), align 4 DEVICE-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspacecast (ptr
// addrspace(1) @local_scalar to ptr), align 4 DEVICE-NEXT:    [[TMP3:%.*]] =
// load i32, ptr addrspacecast (ptr addrspace(1) @local_array to ptr), align 4
// DEVICE-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP2]], [[TMP3]]
// DEVICE-NEXT:    [[CALL:%.*]] = call noundef i32
// @_Z18read_local_storageIiET_v() #[[ATTR2:[0-9]+]] DEVICE-NEXT: [[ADD1:%.*]] =
// add nsw i32 [[ADD]], [[CALL]] DEVICE-NEXT:    store i32 [[ADD1]], ptr
// [[TMP0]], align 4 DEVICE-NEXT:    call void @__kmpc_target_deinit()
...
// DEVICE-NEXT:  entry:
// DEVICE-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspacecast (ptr addrspace(1)
// @_ZN12LocalStorageIiE5valueE to ptr), align 4 DEVICE-NEXT:    ret i32
// [[TMP0]]
//
//
// DEVICE-LABEL: define
// {{[^@]+}}@{{__omp_offloading_[0-9a-z]+_[0-9a-z]+}}__Z21use_nohost_local_varsv_l86
// DEVICE-SAME: (ptr noundef nonnull align 4 dereferenceable(4) [[RESULT:%.*]],
// ptr noalias noundef [[DYN_PTR:%.*]]) #[[ATTR0]] { DEVICE-NEXT:  entry:
// DEVICE-NEXT:    [[RESULT_ADDR:%.*]] = alloca ptr, align 8, addrspace(5)
// DEVICE-NEXT:    [[DYN_PTR_ADDR:%.*]] = alloca ptr, align 8, addrspace(5)
// DEVICE-NEXT:    [[RESULT_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5)
// [[RESULT_ADDR]] to ptr DEVICE-NEXT:    [[DYN_PTR_ADDR_ASCAST:%.*]] =
...
// ptr [[RESULT]], ptr [[RESULT_ADDR_ASCAST]], align 8 DEVICE-NEXT:    store ptr
// [[DYN_PTR]], ptr [[DYN_PTR_ADDR_ASCAST]], align 8 DEVICE-NEXT: [[TMP0:%.*]] =
// load ptr, ptr [[RESULT_ADDR_ASCAST]], align 8, !nonnull [[META7]], !align
// [[META8]] DEVICE-NEXT:    [[TMP1:%.*]] = call i32 @__kmpc_target_init(ptr
...
// @local_nohost_var to ptr), align 4 DEVICE-NEXT:    [[TMP2:%.*]] = load i32,
// ptr addrspacecast (ptr addrspace(1) @local_nohost_var to ptr), align 4
...
// @_ZN11PlainStruct8s_memberE to ptr), align 4 DEVICE-NEXT:    store i32 77,
// ptr addrspacecast (ptr addrspace(1) @local_init_var to ptr), align 4
// DEVICE-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspacecast (ptr addrspace(1)
// @_ZN11PlainStruct8s_memberE to ptr), align 4 DEVICE-NEXT:    [[TMP3:%.*]] =
// load i32, ptr addrspacecast (ptr addrspace(1) @local_init_var to ptr), align
// 4 DEVICE-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP2]], [[TMP3]] DEVICE-NEXT:
// store i32 [[ADD]], ptr [[TMP0]], align 4 DEVICE-NEXT:    call void
// @__kmpc_target_deinit() DEVICE-NEXT:    ret void DEVICE:       worker.exit:
// DEVICE-NEXT:    ret void
//
