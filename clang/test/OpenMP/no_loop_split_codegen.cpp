...
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(1) [[A_ADDR_ASCAST]], align 8, !nonnull [[META13:![0-9]+]], !align [[META14:![0-9]+]]
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr addrspace(1) [[B_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
...
// CHECK-NEXT:    store ptr [[DYN_PTR]], ptr [[DYN_PTR_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr [[VLA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(1) [[A_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr addrspace(1) [[B_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    call void @__kmpc_specialized_kernel_init()
// CHECK-NEXT:    store i32 0, ptr [[K_ASCAST]], align 4
...
// CHECK-NEXT:    store ptr [[DYN_PTR]], ptr [[DYN_PTR_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr [[VLA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(1) [[C_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr addrspace(1) [[B_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    call void @__kmpc_specialized_kernel_init()
// CHECK-NEXT:    store i32 0, ptr [[K_ASCAST]], align 4
...
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr addrspace(1) [[C_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
...
// CHECK-NEXT:    [[N_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[N_ADDR]] to ptr addrspace(1)
// CHECK-NEXT:    [[VLA_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[VLA_ADDR]] to ptr
// CHECK-NEXT:    [[A_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[A_ADDR]] to ptr addrspace(1)
// CHECK-NEXT:    [[VLA_ADDR2_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[VLA_ADDR2]] to ptr
// CHECK-NEXT:    [[B_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[B_ADDR]] to ptr addrspace(1)
...
// CHECK-NEXT:    store ptr [[N]], ptr addrspace(1) [[N_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store i64 [[VLA]], ptr [[VLA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store ptr [[A]], ptr addrspace(1) [[A_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store i64 [[VLA1]], ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    store ptr [[B]], ptr addrspace(1) [[B_ADDR_ASCAST]], align 8
// CHECK-NEXT:    store i64 [[VLA3]], ptr [[VLA_ADDR4_ASCAST]], align 8
// CHECK-NEXT:    store ptr [[C]], ptr addrspace(1) [[C_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(1) [[N_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr [[VLA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr addrspace(1) [[A_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(1) [[B_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP5:%.*]] = load i64, ptr [[VLA_ADDR4_ASCAST]], align 8
// CHECK-NEXT:    [[TMP6:%.*]] = load ptr, ptr addrspace(1) [[C_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(1) [[N_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr [[VLA_ADDR_ASCAST]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr addrspace(1) [[C_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[VLA_ADDR2_ASCAST]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(1) [[B_ADDR_ASCAST]], align 8, !nonnull [[META13]], !align [[META14]]
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP0]], align 4
// CHECK-NEXT:    store i32 [[TMP5]], ptr [[DOTCAPTURE_EXPR__ASCAST]], align 4
