...
// CHECK9-NEXT:    call void @_ZN1SIfED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK9-SAME: (ptr dead_on_return nonnull align 4 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] comdat {
// CHECK9-NEXT:  entry:
// CHECK9-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// CHECK9-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK9-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// CHECK9-SAME: (ptr dead_on_return nonnull align 4 dereferenceable(4) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] comdat {
// CHECK9-NEXT:  entry:
// CHECK9-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 8
// CHECK9-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 8
// CHECK9-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 8
...
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[TEST]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN2StD1Ev(ptr dead_on_return nonnull align 4 dereferenceable(8) [[AGG_TMP]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN2StD1Ev(ptr dead_on_return nonnull align 4 dereferenceable(8) [[AGG_TMP5]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN1SIfED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[VAR4]]) #[[ATTR4]]
...
// CHECK11-SAME: (ptr dead_on_return nonnull align 4 dereferenceable(8) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] comdat align 2 {
// CHECK11-NEXT:  entry:
// CHECK11-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 4
// CHECK11-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    call void @_ZN2StD2Ev(ptr dead_on_return nonnull align 4 dereferenceable(8) [[THIS1]]) #[[ATTR4]]
// CHECK11-NEXT:    ret void
//
//
// CHECK11-LABEL: define {{[^@]+}}@_ZN1SIfED1Ev
// CHECK11-SAME: (ptr dead_on_return nonnull align 4 dereferenceable(4) [[THIS:%.*]]) unnamed_addr #[[ATTR1]] comdat align 2 {
// CHECK11-NEXT:  entry:
// CHECK11-NEXT:    [[THIS_ADDR:%.*]] = alloca ptr, align 4
// CHECK11-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    call void @_ZN1SIfED2Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK11-NEXT:    ret void
//
//
...
// CHECK11:       omp_offload.cont7:
// CHECK11-NEXT:    store i32 0, ptr [[RETVAL]], align 4
// CHECK11-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[ARRAYDESTROY_ELEMENT]]) #[[ATTR4]]
// CHECK11-NEXT:    [[ARRAYDESTROY_DONE:%.*]] = icmp eq ptr [[ARRAYDESTROY_ELEMENT]], [[ARRAY_BEGIN]]
// CHECK11-NEXT:    br i1 [[ARRAYDESTROY_DONE]], label [[ARRAYDESTROY_DONE8:%.*]], label [[ARRAYDESTROY_BODY]]
// CHECK11:       arraydestroy.done8:
// CHECK11-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[TEST]]) #[[ATTR4]]
...
// CHECK11-NEXT:    call void @_ZN1SIiED1Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[VAR4]]) #[[ATTR4]]
...
// CHECK11-NEXT:    store ptr [[THIS]], ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    [[THIS1:%.*]] = load ptr, ptr [[THIS_ADDR]], align 4
// CHECK11-NEXT:    call void @_ZN1SIiED2Ev(ptr dead_on_return nonnull align 4 dereferenceable(4) [[THIS1]]) #[[ATTR4]]
// CHECK11-NEXT:    ret void
//
//
