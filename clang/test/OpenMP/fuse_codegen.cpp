...
// CHECK1-NEXT:    [[TMP47:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK1-NEXT:    [[TMP48:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK1-NEXT:    [[MUL28:%.*]] = mul i32 [[TMP47]], [[TMP48]]
// CHECK1-NEXT:    [[ADD29:%.*]] = add i32 [[TMP46]], [[MUL28]]
// CHECK1-NEXT:    store i32 [[ADD29]], ptr [[I]], align 4
// CHECK1-NEXT:    [[TMP49:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK1-NEXT:    [[TMP50:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK1-NEXT:    [[TMP51:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK1-NEXT:    [[MUL30:%.*]] = mul i32 [[TMP50]], [[TMP51]]
// CHECK1-NEXT:    [[ADD31:%.*]] = add i32 [[TMP49]], [[MUL30]]
...
// CHECK1:       [[FOR_END]]:
// CHECK1-NEXT:    [[TMP72:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK1-NEXT:    [[TMP73:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK1-NEXT:    [[TMP74:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK1-NEXT:    [[MUL53:%.*]] = mul i32 [[TMP73]], [[TMP74]]
// CHECK1-NEXT:    [[ADD54:%.*]] = add i32 [[TMP72]], [[MUL53]]
// CHECK1-NEXT:    store i32 [[ADD54]], ptr [[I]], align 4
// CHECK1-NEXT:    [[TMP75:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK1-NEXT:    [[TMP77:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK1-NEXT:    [[MUL55:%.*]] = mul i32 [[TMP76]], [[TMP77]]
// CHECK1-NEXT:    [[ADD56:%.*]] = add i32 [[TMP75]], [[MUL55]]
// CHECK1-NEXT:    store i32 [[ADD56]], ptr [[J]], align 4
// CHECK1-NEXT:    [[TMP78:%.*]] = load i32, ptr [[DOTOMP_LB2]], align 4
// CHECK1-NEXT:    [[TMP79:%.*]] = load i32, ptr [[DOTOMP_NI2]], align 4
// CHECK1-NEXT:    [[TMP80:%.*]] = load i32, ptr [[DOTOMP_ST2]], align 4
// CHECK1-NEXT:    [[MUL57:%.*]] = mul i32 [[TMP79]], [[TMP80]]
// CHECK1-NEXT:    [[ADD58:%.*]] = add i32 [[TMP78]], [[MUL57]]
// CHECK1-NEXT:    store i32 [[ADD58]], ptr [[K]], align 4
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5:![0-9]+]], !align [[META6:![0-9]+]]
...
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP65:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP76:%.*]] = load ptr, ptr [[VV]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    br label %[[FOR_COND19]]
// CHECK1:       [[FOR_END23]]:
// CHECK1-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK1-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK1-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[TMP35]], [[TMP36]]
// CHECK1-NEXT:    [[ADD25:%.*]] = add nsw i32 [[TMP34]], [[MUL24]]
// CHECK1-NEXT:    store i32 [[ADD25]], ptr [[J]], align 4
// CHECK1-NEXT:    [[TMP37:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK1-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK1-NEXT:    [[MUL26:%.*]] = mul nsw i32 [[TMP38]], [[TMP39]]
// CHECK1-NEXT:    [[ADD27:%.*]] = add nsw i32 [[TMP37]], [[MUL26]]
// CHECK1-NEXT:    store i32 [[ADD27]], ptr [[K]], align 4
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    [[DOTOMP_NI120:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_IV122:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_TEMP_123:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[DOTOMP_FUSE_MAX24:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[I:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[DOTOMP_FUSE_INDEX31:%.*]] = alloca i64, align 8
// CHECK1-NEXT:    [[V:%.*]] = alloca ptr, align 8
// CHECK1-NEXT:    [[CC:%.*]] = alloca i32, align 4
// CHECK1-NEXT:    [[__RANGE266:%.*]] = alloca ptr, align 8
// CHECK1-NEXT:    [[__BEGIN267:%.*]] = alloca ptr, align 8
// CHECK1-NEXT:    [[__END269:%.*]] = alloca ptr, align 8
// CHECK1-NEXT:    [[VV:%.*]] = alloca ptr, align 8
// CHECK1-NEXT:    store i32 0, ptr [[J]], align 4
// CHECK1-NEXT:    store i32 127, ptr [[DOTOMP_UB0]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_LB0]], align 4
...
// CHECK1-NEXT:    store i32 128, ptr [[DOTOMP_NI0]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[K]], align 4
// CHECK1-NEXT:    store i32 511, ptr [[DOTOMP_UB1]], align 4
// CHECK1-NEXT:    store i32 0, ptr [[DOTOMP_LB1]], align 4
// CHECK1-NEXT:    store i32 1, ptr [[DOTOMP_ST1]], align 4
...
// CHECK1-NEXT:    store i32 42, ptr [[C]], align 4
// CHECK1-NEXT:    store ptr [[ARR]], ptr [[__RANGE2]], align 8
// CHECK1-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5]], !align [[META6]]
// CHECK1-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP9]], i64 0, i64 0
// CHECK1-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds double, ptr [[ARRAYDECAY]], i64 256
// CHECK1-NEXT:    store ptr [[ADD_PTR]], ptr [[__END2]], align 8
// CHECK1-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META5]], !align [[META6]]
...
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i64 [[TMP16]], 1
// CHECK1-NEXT:    store i64 [[ADD21]], ptr [[DOTOMP_NI120]], align 8
// CHECK1-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_NI06]], align 8
// CHECK1-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_TEMP_123]], align 8
// CHECK1-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_TEMP_123]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK1-NEXT:    [[CMP25:%.*]] = icmp sgt i64 [[TMP18]], [[TMP19]]
// CHECK1-NEXT:    br i1 [[CMP25]], label %[[COND_TRUE26:.*]], label %[[COND_FALSE27:.*]]
// CHECK1:       [[COND_TRUE26]]:
// CHECK1-NEXT:    [[TMP20:%.*]] = load i64, ptr [[DOTOMP_TEMP_123]], align 8
// CHECK1-NEXT:    br label %[[COND_END28:.*]]
// CHECK1:       [[COND_FALSE27]]:
// CHECK1-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK1-NEXT:    br label %[[COND_END28]]
// CHECK1:       [[COND_END28]]:
// CHECK1-NEXT:    [[COND29:%.*]] = phi i64 [ [[TMP20]], %[[COND_TRUE26]] ], [ [[TMP21]], %[[COND_FALSE27]] ]
// CHECK1-NEXT:    store i64 [[COND29]], ptr [[DOTOMP_FUSE_MAX24]], align 8
// CHECK1-NEXT:    store i32 0, ptr [[I]], align 4
// CHECK1-NEXT:    br label %[[FOR_COND:.*]]
// CHECK1:       [[FOR_COND]]:
// CHECK1-NEXT:    [[TMP22:%.*]] = load i32, ptr [[I]], align 4
// CHECK1-NEXT:    [[CMP30:%.*]] = icmp slt i32 [[TMP22]], 128
// CHECK1-NEXT:    br i1 [[CMP30]], label %[[FOR_BODY:.*]], label %[[FOR_END:.*]]
// CHECK1:       [[FOR_BODY]]:
...
// CHECK1:       [[FOR_END]]:
// CHECK1-NEXT:    store i64 0, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    br label %[[FOR_COND32:.*]]
// CHECK1:       [[FOR_COND32]]:
// CHECK1-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[TMP26:%.*]] = load i64, ptr [[DOTOMP_FUSE_MAX24]], align 8
// CHECK1-NEXT:    [[CMP33:%.*]] = icmp slt i64 [[TMP25]], [[TMP26]]
// CHECK1-NEXT:    br i1 [[CMP33]], label %[[FOR_BODY34:.*]], label %[[FOR_END65:.*]]
// CHECK1:       [[FOR_BODY34]]:
// CHECK1-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[TMP28:%.*]] = load i64, ptr [[DOTOMP_NI06]], align 8
// CHECK1-NEXT:    [[CMP35:%.*]] = icmp slt i64 [[TMP27]], [[TMP28]]
// CHECK1-NEXT:    br i1 [[CMP35]], label %[[IF_THEN:.*]], label %[[IF_END55:.*]]
// CHECK1:       [[IF_THEN]]:
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_LB04]], align 4
// CHECK1-NEXT:    [[CONV36:%.*]] = sext i32 [[TMP29]] to i64
// CHECK1-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_ST05]], align 4
// CHECK1-NEXT:    [[CONV37:%.*]] = sext i32 [[TMP30]] to i64
// CHECK1-NEXT:    [[TMP31:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV37]], [[TMP31]]
// CHECK1-NEXT:    [[ADD38:%.*]] = add nsw i64 [[CONV36]], [[MUL]]
// CHECK1-NEXT:    [[CONV39:%.*]] = trunc i64 [[ADD38]] to i32
// CHECK1-NEXT:    store i32 [[CONV39]], ptr [[DOTOMP_IV07]], align 4
// CHECK1-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_IV07]], align 4
// CHECK1-NEXT:    [[MUL40:%.*]] = mul nsw i32 [[TMP32]], 1
// CHECK1-NEXT:    [[ADD41:%.*]] = add nsw i32 0, [[MUL40]]
// CHECK1-NEXT:    store i32 [[ADD41]], ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK1-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK1-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK1-NEXT:    [[CMP42:%.*]] = icmp slt i32 [[TMP33]], [[TMP34]]
// CHECK1-NEXT:    br i1 [[CMP42]], label %[[IF_THEN43:.*]], label %[[IF_END:.*]]
// CHECK1:       [[IF_THEN43]]:
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK1-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK1-NEXT:    [[TMP37:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK1-NEXT:    [[MUL44:%.*]] = mul nsw i32 [[TMP36]], [[TMP37]]
// CHECK1-NEXT:    [[ADD45:%.*]] = add nsw i32 [[TMP35]], [[MUL44]]
// CHECK1-NEXT:    store i32 [[ADD45]], ptr [[DOTOMP_IV0]], align 4
// CHECK1-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTOMP_IV0]], align 4
// CHECK1-NEXT:    [[MUL46:%.*]] = mul nsw i32 [[TMP38]], 2
// CHECK1-NEXT:    [[ADD47:%.*]] = add nsw i32 0, [[MUL46]]
// CHECK1-NEXT:    store i32 [[ADD47]], ptr [[J]], align 4
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32, ptr [[J]], align 4
// CHECK1-NEXT:    call void (...) @body(i32 noundef [[TMP39]])
// CHECK1-NEXT:    br label %[[IF_END]]
// CHECK1:       [[IF_END]]:
// CHECK1-NEXT:    [[TMP40:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK1-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK1-NEXT:    [[CMP48:%.*]] = icmp slt i32 [[TMP40]], [[TMP41]]
// CHECK1-NEXT:    br i1 [[CMP48]], label %[[IF_THEN49:.*]], label %[[IF_END54:.*]]
// CHECK1:       [[IF_THEN49]]:
// CHECK1-NEXT:    [[TMP42:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK1-NEXT:    [[TMP43:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK1-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK1-NEXT:    [[MUL50:%.*]] = mul nsw i32 [[TMP43]], [[TMP44]]
// CHECK1-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP42]], [[MUL50]]
// CHECK1-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_IV1]], align 4
// CHECK1-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_IV1]], align 4
// CHECK1-NEXT:    [[MUL52:%.*]] = mul nsw i32 [[TMP45]], 1
// CHECK1-NEXT:    [[ADD53:%.*]] = add nsw i32 0, [[MUL52]]
// CHECK1-NEXT:    store i32 [[ADD53]], ptr [[K]], align 4
// CHECK1-NEXT:    [[TMP46:%.*]] = load i32, ptr [[K]], align 4
// CHECK1-NEXT:    call void (...) @body(i32 noundef [[TMP46]])
// CHECK1-NEXT:    br label %[[IF_END54]]
// CHECK1:       [[IF_END54]]:
// CHECK1-NEXT:    br label %[[IF_END55]]
// CHECK1:       [[IF_END55]]:
// CHECK1-NEXT:    [[TMP47:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[TMP48:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK1-NEXT:    [[CMP56:%.*]] = icmp slt i64 [[TMP47]], [[TMP48]]
// CHECK1-NEXT:    br i1 [[CMP56]], label %[[IF_THEN57:.*]], label %[[IF_END62:.*]]
// CHECK1:       [[IF_THEN57]]:
// CHECK1-NEXT:    [[TMP49:%.*]] = load i64, ptr [[DOTOMP_LB118]], align 8
// CHECK1-NEXT:    [[TMP50:%.*]] = load i64, ptr [[DOTOMP_ST119]], align 8
// CHECK1-NEXT:    [[TMP51:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[MUL58:%.*]] = mul nsw i64 [[TMP50]], [[TMP51]]
// CHECK1-NEXT:    [[ADD59:%.*]] = add nsw i64 [[TMP49]], [[MUL58]]
// CHECK1-NEXT:    store i64 [[ADD59]], ptr [[DOTOMP_IV122]], align 8
// CHECK1-NEXT:    [[TMP52:%.*]] = load ptr, ptr [[DOTCAPTURE_EXPR_9]], align 8
// CHECK1-NEXT:    [[TMP53:%.*]] = load i64, ptr [[DOTOMP_IV122]], align 8
// CHECK1-NEXT:    [[MUL60:%.*]] = mul nsw i64 [[TMP53]], 1
// CHECK1-NEXT:    [[ADD_PTR61:%.*]] = getelementptr inbounds double, ptr [[TMP52]], i64 [[MUL60]]
// CHECK1-NEXT:    store ptr [[ADD_PTR61]], ptr [[__BEGIN2]], align 8
// CHECK1-NEXT:    [[TMP54:%.*]] = load ptr, ptr [[__BEGIN2]], align 8
// CHECK1-NEXT:    store ptr [[TMP54]], ptr [[V]], align 8
// CHECK1-NEXT:    [[TMP55:%.*]] = load i32, ptr [[C]], align 4
// CHECK1-NEXT:    [[TMP56:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META5]], !align [[META6]]
// CHECK1-NEXT:    [[TMP57:%.*]] = load double, ptr [[TMP56]], align 8
// CHECK1-NEXT:    call void (...) @body(i32 noundef [[TMP55]], double noundef [[TMP57]])
// CHECK1-NEXT:    br label %[[IF_END62]]
// CHECK1:       [[IF_END62]]:
// CHECK1-NEXT:    br label %[[FOR_INC63:.*]]
// CHECK1:       [[FOR_INC63]]:
// CHECK1-NEXT:    [[TMP58:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    [[INC64:%.*]] = add nsw i64 [[TMP58]], 1
// CHECK1-NEXT:    store i64 [[INC64]], ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK1-NEXT:    br label %[[FOR_COND32]], !llvm.loop [[LOOP11:![0-9]+]]
// CHECK1:       [[FOR_END65]]:
// CHECK1-NEXT:    store i32 37, ptr [[CC]], align 4
// CHECK1-NEXT:    store ptr [[ARR]], ptr [[__RANGE266]], align 8
// CHECK1-NEXT:    [[TMP59:%.*]] = load ptr, ptr [[__RANGE266]], align 8, !nonnull [[META5]], !align [[META6]]
// CHECK1-NEXT:    [[ARRAYDECAY68:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP59]], i64 0, i64 0
// CHECK1-NEXT:    store ptr [[ARRAYDECAY68]], ptr [[__BEGIN267]], align 8
// CHECK1-NEXT:    [[TMP60:%.*]] = load ptr, ptr [[__RANGE266]], align 8, !nonnull [[META5]], !align [[META6]]
// CHECK1-NEXT:    [[ARRAYDECAY70:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP60]], i64 0, i64 0
// CHECK1-NEXT:    [[ADD_PTR71:%.*]] = getelementptr inbounds double, ptr [[ARRAYDECAY70]], i64 256
// CHECK1-NEXT:    store ptr [[ADD_PTR71]], ptr [[__END269]], align 8
// CHECK1-NEXT:    br label %[[FOR_COND72:.*]]
// CHECK1:       [[FOR_COND72]]:
// CHECK1-NEXT:    [[TMP61:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
// CHECK1-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[__END269]], align 8
// CHECK1-NEXT:    [[CMP73:%.*]] = icmp ne ptr [[TMP61]], [[TMP62]]
// CHECK1-NEXT:    br i1 [[CMP73]], label %[[FOR_BODY74:.*]], label %[[FOR_END76:.*]]
// CHECK1:       [[FOR_BODY74]]:
// CHECK1-NEXT:    [[TMP63:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
...
// CHECK1-NEXT:    [[TMP66:%.*]] = load double, ptr [[TMP65]], align 8
// CHECK1-NEXT:    call void (...) @body(i32 noundef [[TMP64]], double noundef [[TMP66]])
// CHECK1-NEXT:    br label %[[FOR_INC75:.*]]
// CHECK1:       [[FOR_INC75]]:
// CHECK1-NEXT:    [[TMP67:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
// CHECK1-NEXT:    [[INCDEC_PTR:%.*]] = getelementptr inbounds nuw double, ptr [[TMP67]], i32 1
// CHECK1-NEXT:    store ptr [[INCDEC_PTR]], ptr [[__BEGIN267]], align 8
// CHECK1-NEXT:    br label %[[FOR_COND72]]
// CHECK1:       [[FOR_END76]]:
// CHECK1-NEXT:    ret void
//
...
// CHECK2-NEXT:    [[TMP47:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK2-NEXT:    [[TMP48:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK2-NEXT:    [[MUL28:%.*]] = mul i32 [[TMP47]], [[TMP48]]
// CHECK2-NEXT:    [[ADD29:%.*]] = add i32 [[TMP46]], [[MUL28]]
// CHECK2-NEXT:    store i32 [[ADD29]], ptr [[I]], align 4
// CHECK2-NEXT:    [[TMP49:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK2-NEXT:    [[TMP50:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK2-NEXT:    [[TMP51:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK2-NEXT:    [[MUL30:%.*]] = mul i32 [[TMP50]], [[TMP51]]
// CHECK2-NEXT:    [[ADD31:%.*]] = add i32 [[TMP49]], [[MUL30]]
...
// CHECK2-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4:![0-9]+]], !align [[META5:![0-9]+]]
...
// CHECK2-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP11:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP17:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP18:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP19:%.*]] = load ptr, ptr [[__RANGE223]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP65:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP76:%.*]] = load ptr, ptr [[VV]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP26:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[TMP31:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    br label %[[FOR_COND19]]
// CHECK2:       [[FOR_END23]]:
// CHECK2-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK2-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK2-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK2-NEXT:    [[MUL24:%.*]] = mul nsw i32 [[TMP35]], [[TMP36]]
// CHECK2-NEXT:    [[ADD25:%.*]] = add nsw i32 [[TMP34]], [[MUL24]]
// CHECK2-NEXT:    store i32 [[ADD25]], ptr [[J]], align 4
// CHECK2-NEXT:    [[TMP37:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK2-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK2-NEXT:    [[TMP39:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK2-NEXT:    [[MUL26:%.*]] = mul nsw i32 [[TMP38]], [[TMP39]]
// CHECK2-NEXT:    [[ADD27:%.*]] = add nsw i32 [[TMP37]], [[MUL26]]
// CHECK2-NEXT:    store i32 [[ADD27]], ptr [[K]], align 4
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[DOTOMP_NI120:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_IV122:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_TEMP_123:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[DOTOMP_FUSE_MAX24:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[I:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[DOTOMP_FUSE_INDEX31:%.*]] = alloca i64, align 8
// CHECK2-NEXT:    [[V:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    [[CC:%.*]] = alloca i32, align 4
// CHECK2-NEXT:    [[__RANGE266:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    [[__BEGIN267:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    [[__END269:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    [[VV:%.*]] = alloca ptr, align 8
// CHECK2-NEXT:    store i32 0, ptr [[J]], align 4
// CHECK2-NEXT:    store i32 127, ptr [[DOTOMP_UB0]], align 4
// CHECK2-NEXT:    store i32 0, ptr [[DOTOMP_LB0]], align 4
...
// CHECK2-NEXT:    store i32 128, ptr [[DOTOMP_NI0]], align 4
// CHECK2-NEXT:    store i32 0, ptr [[K]], align 4
// CHECK2-NEXT:    store i32 511, ptr [[DOTOMP_UB1]], align 4
// CHECK2-NEXT:    store i32 0, ptr [[DOTOMP_LB1]], align 4
// CHECK2-NEXT:    store i32 1, ptr [[DOTOMP_ST1]], align 4
...
// CHECK2-NEXT:    store i32 42, ptr [[C]], align 4
// CHECK2-NEXT:    store ptr [[ARR]], ptr [[__RANGE2]], align 8
// CHECK2-NEXT:    [[TMP9:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4]], !align [[META5]]
// CHECK2-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP9]], i64 0, i64 0
// CHECK2-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds double, ptr [[ARRAYDECAY]], i64 256
// CHECK2-NEXT:    store ptr [[ADD_PTR]], ptr [[__END2]], align 8
// CHECK2-NEXT:    [[TMP10:%.*]] = load ptr, ptr [[__RANGE2]], align 8, !nonnull [[META4]], !align [[META5]]
...
// CHECK2-NEXT:    [[ADD21:%.*]] = add nsw i64 [[TMP16]], 1
// CHECK2-NEXT:    store i64 [[ADD21]], ptr [[DOTOMP_NI120]], align 8
// CHECK2-NEXT:    [[TMP17:%.*]] = load i64, ptr [[DOTOMP_NI06]], align 8
// CHECK2-NEXT:    store i64 [[TMP17]], ptr [[DOTOMP_TEMP_123]], align 8
// CHECK2-NEXT:    [[TMP18:%.*]] = load i64, ptr [[DOTOMP_TEMP_123]], align 8
// CHECK2-NEXT:    [[TMP19:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK2-NEXT:    [[CMP25:%.*]] = icmp sgt i64 [[TMP18]], [[TMP19]]
// CHECK2-NEXT:    br i1 [[CMP25]], label %[[COND_TRUE26:.*]], label %[[COND_FALSE27:.*]]
// CHECK2:       [[COND_TRUE26]]:
// CHECK2-NEXT:    [[TMP20:%.*]] = load i64, ptr [[DOTOMP_TEMP_123]], align 8
// CHECK2-NEXT:    br label %[[COND_END28:.*]]
// CHECK2:       [[COND_FALSE27]]:
// CHECK2-NEXT:    [[TMP21:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK2-NEXT:    br label %[[COND_END28]]
// CHECK2:       [[COND_END28]]:
// CHECK2-NEXT:    [[COND29:%.*]] = phi i64 [ [[TMP20]], %[[COND_TRUE26]] ], [ [[TMP21]], %[[COND_FALSE27]] ]
// CHECK2-NEXT:    store i64 [[COND29]], ptr [[DOTOMP_FUSE_MAX24]], align 8
// CHECK2-NEXT:    store i32 0, ptr [[I]], align 4
// CHECK2-NEXT:    br label %[[FOR_COND:.*]]
// CHECK2:       [[FOR_COND]]:
// CHECK2-NEXT:    [[TMP22:%.*]] = load i32, ptr [[I]], align 4
// CHECK2-NEXT:    [[CMP30:%.*]] = icmp slt i32 [[TMP22]], 128
// CHECK2-NEXT:    br i1 [[CMP30]], label %[[FOR_BODY:.*]], label %[[FOR_END:.*]]
// CHECK2:       [[FOR_BODY]]:
...
// CHECK2:       [[FOR_END]]:
// CHECK2-NEXT:    store i64 0, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    br label %[[FOR_COND32:.*]]
// CHECK2:       [[FOR_COND32]]:
// CHECK2-NEXT:    [[TMP25:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[TMP26:%.*]] = load i64, ptr [[DOTOMP_FUSE_MAX24]], align 8
// CHECK2-NEXT:    [[CMP33:%.*]] = icmp slt i64 [[TMP25]], [[TMP26]]
// CHECK2-NEXT:    br i1 [[CMP33]], label %[[FOR_BODY34:.*]], label %[[FOR_END65:.*]]
// CHECK2:       [[FOR_BODY34]]:
// CHECK2-NEXT:    [[TMP27:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[TMP28:%.*]] = load i64, ptr [[DOTOMP_NI06]], align 8
// CHECK2-NEXT:    [[CMP35:%.*]] = icmp slt i64 [[TMP27]], [[TMP28]]
// CHECK2-NEXT:    br i1 [[CMP35]], label %[[IF_THEN:.*]], label %[[IF_END55:.*]]
// CHECK2:       [[IF_THEN]]:
// CHECK2-NEXT:    [[TMP29:%.*]] = load i32, ptr [[DOTOMP_LB04]], align 4
// CHECK2-NEXT:    [[CONV36:%.*]] = sext i32 [[TMP29]] to i64
// CHECK2-NEXT:    [[TMP30:%.*]] = load i32, ptr [[DOTOMP_ST05]], align 4
// CHECK2-NEXT:    [[CONV37:%.*]] = sext i32 [[TMP30]] to i64
// CHECK2-NEXT:    [[TMP31:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[MUL:%.*]] = mul nsw i64 [[CONV37]], [[TMP31]]
// CHECK2-NEXT:    [[ADD38:%.*]] = add nsw i64 [[CONV36]], [[MUL]]
// CHECK2-NEXT:    [[CONV39:%.*]] = trunc i64 [[ADD38]] to i32
// CHECK2-NEXT:    store i32 [[CONV39]], ptr [[DOTOMP_IV07]], align 4
// CHECK2-NEXT:    [[TMP32:%.*]] = load i32, ptr [[DOTOMP_IV07]], align 4
// CHECK2-NEXT:    [[MUL40:%.*]] = mul nsw i32 [[TMP32]], 1
// CHECK2-NEXT:    [[ADD41:%.*]] = add nsw i32 0, [[MUL40]]
// CHECK2-NEXT:    store i32 [[ADD41]], ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK2-NEXT:    [[TMP33:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK2-NEXT:    [[TMP34:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK2-NEXT:    [[CMP42:%.*]] = icmp slt i32 [[TMP33]], [[TMP34]]
// CHECK2-NEXT:    br i1 [[CMP42]], label %[[IF_THEN43:.*]], label %[[IF_END:.*]]
// CHECK2:       [[IF_THEN43]]:
// CHECK2-NEXT:    [[TMP35:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK2-NEXT:    [[TMP36:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK2-NEXT:    [[TMP37:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK2-NEXT:    [[MUL44:%.*]] = mul nsw i32 [[TMP36]], [[TMP37]]
// CHECK2-NEXT:    [[ADD45:%.*]] = add nsw i32 [[TMP35]], [[MUL44]]
// CHECK2-NEXT:    store i32 [[ADD45]], ptr [[DOTOMP_IV0]], align 4
// CHECK2-NEXT:    [[TMP38:%.*]] = load i32, ptr [[DOTOMP_IV0]], align 4
// CHECK2-NEXT:    [[MUL46:%.*]] = mul nsw i32 [[TMP38]], 2
// CHECK2-NEXT:    [[ADD47:%.*]] = add nsw i32 0, [[MUL46]]
// CHECK2-NEXT:    store i32 [[ADD47]], ptr [[J]], align 4
// CHECK2-NEXT:    [[TMP39:%.*]] = load i32, ptr [[J]], align 4
// CHECK2-NEXT:    call void (...) @body(i32 noundef [[TMP39]])
// CHECK2-NEXT:    br label %[[IF_END]]
// CHECK2:       [[IF_END]]:
// CHECK2-NEXT:    [[TMP40:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK2-NEXT:    [[TMP41:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK2-NEXT:    [[CMP48:%.*]] = icmp slt i32 [[TMP40]], [[TMP41]]
// CHECK2-NEXT:    br i1 [[CMP48]], label %[[IF_THEN49:.*]], label %[[IF_END54:.*]]
// CHECK2:       [[IF_THEN49]]:
// CHECK2-NEXT:    [[TMP42:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK2-NEXT:    [[TMP43:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK2-NEXT:    [[TMP44:%.*]] = load i32, ptr [[DOTOMP_FUSE_INDEX]], align 4
// CHECK2-NEXT:    [[MUL50:%.*]] = mul nsw i32 [[TMP43]], [[TMP44]]
// CHECK2-NEXT:    [[ADD51:%.*]] = add nsw i32 [[TMP42]], [[MUL50]]
// CHECK2-NEXT:    store i32 [[ADD51]], ptr [[DOTOMP_IV1]], align 4
// CHECK2-NEXT:    [[TMP45:%.*]] = load i32, ptr [[DOTOMP_IV1]], align 4
// CHECK2-NEXT:    [[MUL52:%.*]] = mul nsw i32 [[TMP45]], 1
// CHECK2-NEXT:    [[ADD53:%.*]] = add nsw i32 0, [[MUL52]]
// CHECK2-NEXT:    store i32 [[ADD53]], ptr [[K]], align 4
// CHECK2-NEXT:    [[TMP46:%.*]] = load i32, ptr [[K]], align 4
// CHECK2-NEXT:    call void (...) @body(i32 noundef [[TMP46]])
// CHECK2-NEXT:    br label %[[IF_END54]]
// CHECK2:       [[IF_END54]]:
// CHECK2-NEXT:    br label %[[IF_END55]]
// CHECK2:       [[IF_END55]]:
// CHECK2-NEXT:    [[TMP47:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[TMP48:%.*]] = load i64, ptr [[DOTOMP_NI120]], align 8
// CHECK2-NEXT:    [[CMP56:%.*]] = icmp slt i64 [[TMP47]], [[TMP48]]
// CHECK2-NEXT:    br i1 [[CMP56]], label %[[IF_THEN57:.*]], label %[[IF_END62:.*]]
// CHECK2:       [[IF_THEN57]]:
// CHECK2-NEXT:    [[TMP49:%.*]] = load i64, ptr [[DOTOMP_LB118]], align 8
// CHECK2-NEXT:    [[TMP50:%.*]] = load i64, ptr [[DOTOMP_ST119]], align 8
// CHECK2-NEXT:    [[TMP51:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[MUL58:%.*]] = mul nsw i64 [[TMP50]], [[TMP51]]
// CHECK2-NEXT:    [[ADD59:%.*]] = add nsw i64 [[TMP49]], [[MUL58]]
// CHECK2-NEXT:    store i64 [[ADD59]], ptr [[DOTOMP_IV122]], align 8
// CHECK2-NEXT:    [[TMP52:%.*]] = load ptr, ptr [[DOTCAPTURE_EXPR_9]], align 8
// CHECK2-NEXT:    [[TMP53:%.*]] = load i64, ptr [[DOTOMP_IV122]], align 8
// CHECK2-NEXT:    [[MUL60:%.*]] = mul nsw i64 [[TMP53]], 1
// CHECK2-NEXT:    [[ADD_PTR61:%.*]] = getelementptr inbounds double, ptr [[TMP52]], i64 [[MUL60]]
// CHECK2-NEXT:    store ptr [[ADD_PTR61]], ptr [[__BEGIN2]], align 8
// CHECK2-NEXT:    [[TMP54:%.*]] = load ptr, ptr [[__BEGIN2]], align 8
// CHECK2-NEXT:    store ptr [[TMP54]], ptr [[V]], align 8
// CHECK2-NEXT:    [[TMP55:%.*]] = load i32, ptr [[C]], align 4
// CHECK2-NEXT:    [[TMP56:%.*]] = load ptr, ptr [[V]], align 8, !nonnull [[META4]], !align [[META5]]
// CHECK2-NEXT:    [[TMP57:%.*]] = load double, ptr [[TMP56]], align 8
// CHECK2-NEXT:    call void (...) @body(i32 noundef [[TMP55]], double noundef [[TMP57]])
// CHECK2-NEXT:    br label %[[IF_END62]]
// CHECK2:       [[IF_END62]]:
// CHECK2-NEXT:    br label %[[FOR_INC63:.*]]
// CHECK2:       [[FOR_INC63]]:
// CHECK2-NEXT:    [[TMP58:%.*]] = load i64, ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    [[INC64:%.*]] = add nsw i64 [[TMP58]], 1
// CHECK2-NEXT:    store i64 [[INC64]], ptr [[DOTOMP_FUSE_INDEX31]], align 8
// CHECK2-NEXT:    br label %[[FOR_COND32]], !llvm.loop [[LOOP10:![0-9]+]]
// CHECK2:       [[FOR_END65]]:
// CHECK2-NEXT:    store i32 37, ptr [[CC]], align 4
// CHECK2-NEXT:    store ptr [[ARR]], ptr [[__RANGE266]], align 8
// CHECK2-NEXT:    [[TMP59:%.*]] = load ptr, ptr [[__RANGE266]], align 8, !nonnull [[META4]], !align [[META5]]
// CHECK2-NEXT:    [[ARRAYDECAY68:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP59]], i64 0, i64 0
// CHECK2-NEXT:    store ptr [[ARRAYDECAY68]], ptr [[__BEGIN267]], align 8
// CHECK2-NEXT:    [[TMP60:%.*]] = load ptr, ptr [[__RANGE266]], align 8, !nonnull [[META4]], !align [[META5]]
// CHECK2-NEXT:    [[ARRAYDECAY70:%.*]] = getelementptr inbounds [256 x double], ptr [[TMP60]], i64 0, i64 0
// CHECK2-NEXT:    [[ADD_PTR71:%.*]] = getelementptr inbounds double, ptr [[ARRAYDECAY70]], i64 256
// CHECK2-NEXT:    store ptr [[ADD_PTR71]], ptr [[__END269]], align 8
// CHECK2-NEXT:    br label %[[FOR_COND72:.*]]
// CHECK2:       [[FOR_COND72]]:
// CHECK2-NEXT:    [[TMP61:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
// CHECK2-NEXT:    [[TMP62:%.*]] = load ptr, ptr [[__END269]], align 8
// CHECK2-NEXT:    [[CMP73:%.*]] = icmp ne ptr [[TMP61]], [[TMP62]]
// CHECK2-NEXT:    br i1 [[CMP73]], label %[[FOR_BODY74:.*]], label %[[FOR_END76:.*]]
// CHECK2:       [[FOR_BODY74]]:
// CHECK2-NEXT:    [[TMP63:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
...
// CHECK2-NEXT:    [[TMP66:%.*]] = load double, ptr [[TMP65]], align 8
// CHECK2-NEXT:    call void (...) @body(i32 noundef [[TMP64]], double noundef [[TMP66]])
// CHECK2-NEXT:    br label %[[FOR_INC75:.*]]
// CHECK2:       [[FOR_INC75]]:
// CHECK2-NEXT:    [[TMP67:%.*]] = load ptr, ptr [[__BEGIN267]], align 8
// CHECK2-NEXT:    [[INCDEC_PTR:%.*]] = getelementptr inbounds nuw double, ptr [[TMP67]], i32 1
// CHECK2-NEXT:    store ptr [[INCDEC_PTR]], ptr [[__BEGIN267]], align 8
// CHECK2-NEXT:    br label %[[FOR_COND72]]
// CHECK2:       [[FOR_END76]]:
// CHECK2-NEXT:    ret void
//
...
// CHECK2:       [[FOR_END]]:
// CHECK2-NEXT:    [[TMP72:%.*]] = load i32, ptr [[DOTOMP_LB0]], align 4
// CHECK2-NEXT:    [[TMP73:%.*]] = load i32, ptr [[DOTOMP_NI0]], align 4
// CHECK2-NEXT:    [[TMP74:%.*]] = load i32, ptr [[DOTOMP_ST0]], align 4
// CHECK2-NEXT:    [[MUL53:%.*]] = mul i32 [[TMP73]], [[TMP74]]
// CHECK2-NEXT:    [[ADD54:%.*]] = add i32 [[TMP72]], [[MUL53]]
// CHECK2-NEXT:    store i32 [[ADD54]], ptr [[I]], align 4
// CHECK2-NEXT:    [[TMP75:%.*]] = load i32, ptr [[DOTOMP_LB1]], align 4
// CHECK2-NEXT:    [[TMP76:%.*]] = load i32, ptr [[DOTOMP_NI1]], align 4
// CHECK2-NEXT:    [[TMP77:%.*]] = load i32, ptr [[DOTOMP_ST1]], align 4
// CHECK2-NEXT:    [[MUL55:%.*]] = mul i32 [[TMP76]], [[TMP77]]
// CHECK2-NEXT:    [[ADD56:%.*]] = add i32 [[TMP75]], [[MUL55]]
// CHECK2-NEXT:    store i32 [[ADD56]], ptr [[J]], align 4
// CHECK2-NEXT:    [[TMP78:%.*]] = load i32, ptr [[DOTOMP_LB2]], align 4
// CHECK2-NEXT:    [[TMP79:%.*]] = load i32, ptr [[DOTOMP_NI2]], align 4
// CHECK2-NEXT:    [[TMP80:%.*]] = load i32, ptr [[DOTOMP_ST2]], align 4
// CHECK2-NEXT:    [[MUL57:%.*]] = mul i32 [[TMP79]], [[TMP80]]
// CHECK2-NEXT:    [[ADD58:%.*]] = add i32 [[TMP78]], [[MUL57]]
// CHECK2-NEXT:    store i32 [[ADD58]], ptr [[K]], align 4
// CHECK2-NEXT:    ret void
//
//.
// CHECK1: [[LOOP2]] = distinct !{[[LOOP2]], [[META3:![0-9]+]]}
// CHECK1: [[META3]] = !{!"llvm.loop.mustprogress"}
// CHECK1: [[LOOP4]] = distinct !{[[LOOP4]], [[META3]]}
// CHECK1: [[META5]] = !{}
// CHECK1: [[META6]] = !{i64 8}
// CHECK1: [[LOOP7]] = distinct !{[[LOOP7]], [[META3]]}
// CHECK1: [[LOOP8]] = distinct !{[[LOOP8]], [[META3]]}
// CHECK1: [[LOOP9]] = distinct !{[[LOOP9]], [[META3]]}
// CHECK1: [[LOOP10]] = distinct !{[[LOOP10]], [[META3]]}
// CHECK1: [[LOOP11]] = distinct !{[[LOOP11]], [[META3]]}
//.
// CHECK2: [[LOOP2]] = distinct !{[[LOOP2]], [[META3:![0-9]+]]}
// CHECK2: [[META3]] = !{!"llvm.loop.mustprogress"}
// CHECK2: [[META4]] = !{}
// CHECK2: [[META5]] = !{i64 8}
// CHECK2: [[LOOP6]] = distinct !{[[LOOP6]], [[META3]]}
// CHECK2: [[LOOP7]] = distinct !{[[LOOP7]], [[META3]]}
// CHECK2: [[LOOP8]] = distinct !{[[LOOP8]], [[META3]]}
// CHECK2: [[LOOP9]] = distinct !{[[LOOP9]], [[META3]]}
// CHECK2: [[LOOP10]] = distinct !{[[LOOP10]], [[META3]]}
// CHECK2: [[LOOP11]] = distinct !{[[LOOP11]], [[META3]]}
//.
