...
void func() {
  ...
  // CHECK: amdgpu_kernel void @__omp_offloading[[HASH:.*]]_l19() #3

  #pragma omp target ompx_attribute([[clang::amdgpu_flat_work_group_size(1, 257)]])
  {}
...
// CHECK: attributes #0
// CHECK-SAME: "amdgpu-flat-work-group-size"="1,257"
// CHECK: attributes #3
// CHECK-SAME: "amdgpu-flat-work-group-size"="1,256"
