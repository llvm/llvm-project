...
// RUN: %clang_cc1 -triple x86_64-apple-macos12 -fsyntax-only %t/src%{fs-sep}main.c -I %t/src%{fs-sep}inc -Wunknown-pragmas 2> %t/regular-diags1.txt
...
// RUN:     -emit-obj %t/src%{fs-sep}main.c -o %t/out/output.o -I %t/src%{fs-sep}inc -Wunknown-pragmas
...
// RUN: %clang_cc1 -triple x86_64-apple-macos12 -fsyntax-only %t/src2%{fs-sep}main.c -I %t/src2%{fs-sep}inc -Wunknown-pragmas 2> %t/regular-diags2.txt
