...
// RUN:   -x c-header %s -o %t.h.pch -fcas-path %t.dir/cas -fprofile-instrument-use=llvm -fprofile-instrument-use-path=%t.profdata
...
// RUN:   -x c %s -o %t.o -fcas-path %t.dir/cas -fprofile-instrument-use=llvm -fprofile-instrument-use-path=%t.profdata -include-pch %t.h.pch
