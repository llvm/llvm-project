...
namespace deduce_pack_non_pack {
  ...
  template <typename T> void g(C<A<T>>); // expected-note {{candidate template ignored: deduced type 'C<...>' of 1st parameter does not match adjusted type 'C<...>' of argument [with T = bool]}}
