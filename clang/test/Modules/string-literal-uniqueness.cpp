...
export module A;
export constexpr const char *hello() { return "hello"; }
export constexpr const char *helloA1 = hello();
...
export module B;
import A;
export constexpr const char *helloB1 = helloA1;
...
static_assert(helloA1 == helloB1);
static_assert(helloA1 == helloC1);
