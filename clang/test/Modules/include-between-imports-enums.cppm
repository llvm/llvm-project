...
// Verify that the enumerators' types match the original enum type.
// A previous version of this fix produced enumerators whose type was a
// throwaway enum, causing "cannot initialize a variable of type 'const E'
// with an rvalue of type 'ns::E'" errors.
ns::E z1 = ns::Value1;
ns::E z2 = ns::Value3;
