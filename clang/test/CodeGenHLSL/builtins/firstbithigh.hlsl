...
// DXCHECK-NEXT: [[SELECT:%.*]] = select i1 %cmp.i, i32 -1, i32 [[SUB]]
// CHECK-NEXT: ret i32
...
// DXCHECK-NEXT: [[SELECT:%.*]] = select <2 x i1> %cmp.i, <2 x i32> splat (i32 -1), <2 x i32> [[SUB]]
...
// DXCHECK-NEXT: [[SELECT:%.*]] = select <3 x i1> %cmp.i, <3 x i32> splat (i32 -1), <3 x i32> [[SUB]]
...
// DXCHECK-NEXT: [[SELECT:%.*]] = select <4 x i1> %cmp.i, <4 x i32> splat (i32 -1), <4 x i32> [[SUB]]
