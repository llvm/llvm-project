...
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <2 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <2 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <2 x float> {{.*}}, splat (float f0x42652EE1)
// NO_HALF: ret <2 x float>
half1x2 test_degrees_half1x2(half1x2 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half1x3
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <3 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <3 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <3 x float> {{.*}}, splat (float f0x42652EE1)
// NO_HALF: ret <3 x float>
half1x3 test_degrees_half1x3(half1x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half1x4
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <4 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <4 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <4 x float> {{.*}}, splat (float f0x42652EE1)
...
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <6 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <6 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <6 x float> {{.*}}, splat (float f0x42652EE1)
// NO_HALF: ret <6 x float>
half2x3 test_degrees_half2x3(half2x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half2x4
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <8 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <8 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <8 x float> {{.*}}, splat (float f0x42652EE1)
...
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <9 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <9 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <9 x float> {{.*}}, splat (float f0x42652EE1)
// NO_HALF: ret <9 x float>
half3x3 test_degrees_half3x3(half3x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half3x4
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <12 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <12 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <12 x float> {{.*}}, splat (float f0x42652EE1)
...
// NATIVE_HALF: fmul reassoc nnan ninf nsz arcp afn <16 x half> {{.*}}, splat (half 5.728130e+01)
// NATIVE_HALF: ret <16 x half>
// NO_HALF: fmul reassoc nnan ninf nsz arcp afn <16 x float> {{.*}}, splat (float f0x42652EE1)
