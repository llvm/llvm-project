...
// NATIVE_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <6 x half> @llvm.[[TARGET]].degrees.v6f16
// NATIVE_HALF: ret <6 x half>
// NO_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <6 x float> @llvm.[[TARGET]].degrees.v6f32
// NO_HALF: ret <6 x float>
half2x3 test_degrees_half2x3(half2x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half2x4
// NATIVE_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <8 x half> @llvm.[[TARGET]].degrees.v8f16
// NATIVE_HALF: ret <8 x half>
// NO_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <8 x float> @llvm.[[TARGET]].degrees.v8f32
...
// NATIVE_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <9 x half> @llvm.[[TARGET]].degrees.v9f16
// NATIVE_HALF: ret <9 x half>
// NO_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <9 x float> @llvm.[[TARGET]].degrees.v9f32
// NO_HALF: ret <9 x float>
half3x3 test_degrees_half3x3(half3x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_half3x4
// NATIVE_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <12 x half> @llvm.[[TARGET]].degrees.v12f16
// NATIVE_HALF: ret <12 x half>
// NO_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <12 x float> @llvm.[[TARGET]].degrees.v12f32
...
// NATIVE_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <16 x half> @llvm.[[TARGET]].degrees.v16f16
// NATIVE_HALF: ret <16 x half>
// NO_HALF: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <16 x float> @llvm.[[TARGET]].degrees.v16f32
...
// CHECK: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <6 x float> @llvm.[[TARGET]].degrees.v6f32
// CHECK: ret <6 x float>
float2x3 test_degrees_float2x3(float2x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_float2x4
// CHECK: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <8 x float> @llvm.[[TARGET]].degrees.v8f32
// CHECK: ret <8 x float>
...
// CHECK: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <9 x float> @llvm.[[TARGET]].degrees.v9f32
// CHECK: ret <9 x float>
float3x3 test_degrees_float3x3(float3x3 p0) { return degrees(p0); }

// CHECK-LABEL: test_degrees_float3x4
// CHECK: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <12 x float> @llvm.[[TARGET]].degrees.v12f32
...
// CHECK: %hlsl.degrees = call reassoc nnan ninf nsz arcp afn <16 x float> @llvm.[[TARGET]].degrees.v16f32
