...
// CHECK:    [[V3:%.*]] = call {{.*}} float @llvm.sinh.f32(float [[CONVI]])
// CHECK:    ret float [[V3]]
...
// CHECK:    [[V3:%.*]] = call {{.*}} <2 x float> @llvm.sinh.v2f32(<2 x float> [[CONVI]])
...
// CHECK:    [[V3:%.*]] = call {{.*}} <3 x float> @llvm.sinh.v3f32(<3 x float> [[CONVI]])
...
// CHECK:    [[V3:%.*]] = call {{.*}} <4 x float> @llvm.sinh.v4f32(<4 x float> [[CONVI]])
