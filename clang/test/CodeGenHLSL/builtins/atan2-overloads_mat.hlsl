...
// CHECK: define define hidden [[SPIR_FUNC]] noundef nofpclass(nan inf) <12 x float> @_{{.*}}test_atan2_double3x4{{.*}}(
...
// CHECK: define define hidden [[SPIR_FUNC]] noundef nofpclass(nan inf) <12 x float> @_{{.*}}test_atan2_uint3x4{{.*}}(
...
// CHECK: define define hidden [[SPIR_FUNC]] noundef nofpclass(nan inf) <12 x float> @_{{.*}}test_atan2_int3x4{{.*}}(
...
// CHECK: define define hidden [[SPIR_FUNC]] noundef nofpclass(nan inf) <12 x float> @_{{.*}}test_atan2_int64_t3x4{{.*}}(
...
// CHECK: define define hidden [[SPIR_FUNC]] noundef nofpclass(nan inf) <12 x float> @_{{.*}}test_atan2_uint64_t3x4{{.*}}(
