...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <2 x half> @llvm.[[TGT]].ddx.coarse.v2f16(<2 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <3 x half> @llvm.[[TGT]].ddx.coarse.v3f16(<3 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <4 x half> @llvm.[[TGT]].ddx.coarse.v4f16(<4 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <2 x float> @llvm.[[TGT]].ddx.coarse.v2f32(<2 x float> %{{.*}})
...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <3 x float> @llvm.[[TGT]].ddx.coarse.v3f32(<3 x float> %{{.*}})
...
// CHECK: %hlsl.ddx.coarse = call {{.*}} <4 x float> @llvm.[[TGT]].ddx.coarse.v4f32(<4 x float> %{{.*}})
...
vector<float, 5> test_f32_ddx_coarse5(vector<float, 5> val) {
    return ddx_coarse(val);
}
