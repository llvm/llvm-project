...
// Note: the f0x3C8EFA35 constants below equal Pi/180.
...
// CHECK:    ret float [[MUL]]
// expected-warning@+1 {{'radians' is deprecated: In 202x 64 bit API lowering for radians is deprecated. Explicitly cast parameters to 32 or 16 bit types.}}
