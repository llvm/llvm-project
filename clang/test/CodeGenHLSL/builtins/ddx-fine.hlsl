...
// CHECK: %hlsl.ddx.fine = call {{.*}} <2 x half> @llvm.[[TGT]].ddx.fine.v2f16(<2 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.fine = call {{.*}} <3 x half> @llvm.[[TGT]].ddx.fine.v3f16(<3 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.fine = call {{.*}} <4 x half> @llvm.[[TGT]].ddx.fine.v4f16(<4 x half> %{{.*}})
...
// CHECK: %hlsl.ddx.fine = call {{.*}} <2 x float> @llvm.[[TGT]].ddx.fine.v2f32(<2 x float> %{{.*}})
...
// CHECK: %hlsl.ddx.fine = call {{.*}} <3 x float> @llvm.[[TGT]].ddx.fine.v3f32(<3 x float> %{{.*}})
