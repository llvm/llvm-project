...
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.i16
// NATIVE_HALF: ret i1 %hlsl.all
bool test_all_int16_t(int16_t p0) { return all(p0); }
// DXIL_NATIVE_HALF: define noundef i1 @
// SPIR_NATIVE_HALF: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v2i16
// NATIVE_HALF: ret i1 %hlsl.all
bool test_all_int16_t2(int16_t2 p0) { return all(p0); }
// DXIL_NATIVE_HALF: define noundef i1 @
// SPIR_NATIVE_HALF: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v3i16
// NATIVE_HALF: ret i1 %hlsl.all
bool test_all_int16_t3(int16_t3 p0) { return all(p0); }
// DXIL_NATIVE_HALF: define noundef i1 @
// SPIR_NATIVE_HALF: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v4i16
// NATIVE_HALF: ret i1 %hlsl.all
...
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.f16
// NO_HALF: %hlsl.all = call i1 @llvm.hlsl.all.f32
// CHECK: ret i1 %hlsl.all
bool test_all_half(half p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v2f16
// NO_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v2f32
// CHECK: ret i1 %hlsl.all
bool test_all_half2(half2 p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v3f16
// NO_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v3f32
// CHECK: ret i1 %hlsl.all
bool test_all_half3(half3 p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// NATIVE_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v4f16
// NO_HALF: %hlsl.all = call i1 @llvm.hlsl.all.v4f32
// CHECK: ret i1 %hlsl.all
bool test_all_half4(half4 p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.f32
// CHECK: ret i1 %hlsl.all
bool test_all_float(float p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v2f32
// CHECK: ret i1 %hlsl.all
bool test_all_float2(float2 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v3f32
// CHECK: ret i1 %hlsl.all
bool test_all_float3(float3 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v4f32
// CHECK: ret i1 %hlsl.all
bool test_all_float4(float4 p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.f64
// CHECK: ret i1 %hlsl.all
bool test_all_double(double p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v2f64
// CHECK: ret i1 %hlsl.all
bool test_all_double2(double2 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v3f64
// CHECK: ret i1 %hlsl.all
bool test_all_double3(double3 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v4f64
// CHECK: ret i1 %hlsl.all
bool test_all_double4(double4 p0) { return all(p0); }

// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.i32
// CHECK: ret i1 %hlsl.all
bool test_all_int(int p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v2i32
// CHECK: ret i1 %hlsl.all
bool test_all_int2(int2 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v3i32
// CHECK: ret i1 %hlsl.all
bool test_all_int3(int3 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v4i32
// CHECK: ret i1 %hlsl.all
...
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.i64
// CHECK: ret i1 %hlsl.all
bool test_all_int64_t(int64_t p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v2i64
// CHECK: ret i1 %hlsl.all
bool test_all_int64_t2(int64_t2 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v3i64
// CHECK: ret i1 %hlsl.all
bool test_all_int64_t3(int64_t3 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v4i64
// CHECK: ret i1 %hlsl.all
...
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.i1
// CHECK: ret i1 %hlsl.all
bool test_all_bool(bool p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v2i1
// CHECK: ret i1 %hlsl.all
bool test_all_bool2(bool2 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v3i1
// CHECK: ret i1 %hlsl.all
bool test_all_bool3(bool3 p0) { return all(p0); }
// DXIL_CHECK: define noundef i1 @
// SPIR_CHECK: define spir_func noundef i1 @
// CHECK: %hlsl.all = call i1 @llvm.hlsl.all.v4i1
// CHECK: ret i1 %hlsl.all
