...
// CHECK: fmul reassoc nnan ninf nsz arcp afn <2 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <2 x float>
float1x2 test_radians_float1x2(float1x2 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float1x3
// CHECK: fmul reassoc nnan ninf nsz arcp afn <3 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <3 x float>
float1x3 test_radians_float1x3(float1x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float1x4
// CHECK: fmul reassoc nnan ninf nsz arcp afn <4 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <4 x float>
...
// CHECK: fmul reassoc nnan ninf nsz arcp afn <6 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <6 x float>
float2x3 test_radians_float2x3(float2x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float2x4
// CHECK: fmul reassoc nnan ninf nsz arcp afn <8 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <8 x float>
...
// CHECK: fmul reassoc nnan ninf nsz arcp afn <9 x float> {{.*}}, splat (float f0x3C8EFA35)
// CHECK: ret <9 x float>
float3x3 test_radians_float3x3(float3x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float3x4
// CHECK: fmul reassoc nnan ninf nsz arcp afn <12 x float> {{.*}}, splat (float f0x3C8EFA35)
...
// CHECK: fmul reassoc nnan ninf nsz arcp afn <16 x float> {{.*}}, splat (float f0x3C8EFA35)
