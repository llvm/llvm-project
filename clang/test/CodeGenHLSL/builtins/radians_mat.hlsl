...
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <2 x half> @llvm.[[TARGET]].radians.v2f16
// NATIVE_HALF: ret <2 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <2 x float> @llvm.[[TARGET]].radians.v2f32
// NO_HALF: ret <2 x float>
half1x2 test_radians_half1x2(half1x2 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_half1x3
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <3 x half> @llvm.[[TARGET]].radians.v3f16
// NATIVE_HALF: ret <3 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <3 x float> @llvm.[[TARGET]].radians.v3f32
// NO_HALF: ret <3 x float>
half1x3 test_radians_half1x3(half1x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_half1x4
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <4 x half> @llvm.[[TARGET]].radians.v4f16
// NATIVE_HALF: ret <4 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <4 x float> @llvm.[[TARGET]].radians.v4f32
...
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <6 x half> @llvm.[[TARGET]].radians.v6f16
// NATIVE_HALF: ret <6 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <6 x float> @llvm.[[TARGET]].radians.v6f32
// NO_HALF: ret <6 x float>
half2x3 test_radians_half2x3(half2x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_half2x4
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <8 x half> @llvm.[[TARGET]].radians.v8f16
// NATIVE_HALF: ret <8 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <8 x float> @llvm.[[TARGET]].radians.v8f32
...
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <9 x half> @llvm.[[TARGET]].radians.v9f16
// NATIVE_HALF: ret <9 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <9 x float> @llvm.[[TARGET]].radians.v9f32
// NO_HALF: ret <9 x float>
half3x3 test_radians_half3x3(half3x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_half3x4
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <12 x half> @llvm.[[TARGET]].radians.v12f16
// NATIVE_HALF: ret <12 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <12 x float> @llvm.[[TARGET]].radians.v12f32
...
// NATIVE_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <16 x half> @llvm.[[TARGET]].radians.v16f16
// NATIVE_HALF: ret <16 x half>
// NO_HALF: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <16 x float> @llvm.[[TARGET]].radians.v16f32
// NO_HALF: ret <16 x float>
half4x4 test_radians_half4x4(half4x4 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float1x2
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <2 x float> @llvm.[[TARGET]].radians.v2f32
// CHECK: ret <2 x float>
float1x2 test_radians_float1x2(float1x2 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float1x3
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <3 x float> @llvm.[[TARGET]].radians.v3f32
// CHECK: ret <3 x float>
float1x3 test_radians_float1x3(float1x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float1x4
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <4 x float> @llvm.[[TARGET]].radians.v4f32
// CHECK: ret <4 x float>
...
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <6 x float> @llvm.[[TARGET]].radians.v6f32
// CHECK: ret <6 x float>
float2x3 test_radians_float2x3(float2x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float2x4
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <8 x float> @llvm.[[TARGET]].radians.v8f32
// CHECK: ret <8 x float>
...
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <9 x float> @llvm.[[TARGET]].radians.v9f32
// CHECK: ret <9 x float>
float3x3 test_radians_float3x3(float3x3 p0) { return radians(p0); }

// CHECK-LABEL: test_radians_float3x4
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <12 x float> @llvm.[[TARGET]].radians.v12f32
...
// CHECK: %hlsl.radians = call reassoc nnan ninf nsz arcp afn <16 x float> @llvm.[[TARGET]].radians.v16f32
