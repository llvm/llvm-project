...
int test_int(int expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.i32([[TY]] %[[#]])
...
// CHECK-SPIRV: declare [[TY]] @llvm.spv.subgroup.bit.or.i32([[TY]]) #[[#attr:]]

// CHECK-LABEL: test_int2
int2 test_int2(int2 expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.v2i32([[TY]] %[[#]])
...
// CHECK-SPIRV: declare [[TY]] @llvm.spv.subgroup.bit.or.v2i32([[TY]]) #[[#attr:]]

// CHECK-LABEL: test_int3
int3 test_int3(int3 expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.v3i32([[TY]] %[[#]])
...
// CHECK-SPIRV: declare [[TY]] @llvm.spv.subgroup.bit.or.v3i32([[TY]]) #[[#attr:]]

// CHECK-LABEL: test_int4
int4 test_int4(int4 expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.v4i32([[TY]] %[[#]])
...
// CHECK-SPIRV: declare [[TY]] @llvm.spv.subgroup.bit.or.v4i32([[TY]]) #[[#attr:]]

// CHECK-LABEL: test_int16
int16_t test_int16_t(int16_t expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.i16([[TY]] %[[#]])
...
// CHECK-SPIRV: declare [[TY]] @llvm.spv.subgroup.bit.or.i16([[TY]]) #[[#attr:]]

// CHECK-LABEL: test_int64
int64_t test_int64_t(int64_t expr) {
  // CHECK-SPIRV:  %[[RET:.*]] = call spir_func [[TY:.*]] @llvm.spv.subgroup.bit.or.i64([[TY]] %[[#]])
