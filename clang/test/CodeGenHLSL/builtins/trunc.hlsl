...
// CHECK-LABEL: test_trunc_float5
// CHECK: call reassoc nnan ninf nsz arcp afn <5 x float> @llvm.trunc.v5f32
vector<float, 5> test_trunc_float5(vector<float, 5> p0) { return trunc(p0); }
