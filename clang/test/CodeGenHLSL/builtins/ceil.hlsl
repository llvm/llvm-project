...
// CHECK-LABEL: test_ceil_float5
// CHECK: call reassoc nnan ninf nsz arcp afn <5 x float> @llvm.ceil.v5f32
vector<float, 5> test_ceil_float5(vector<float, 5> p0) { return ceil(p0); }
