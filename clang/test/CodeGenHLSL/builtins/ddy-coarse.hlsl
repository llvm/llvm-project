...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <2 x half> @llvm.[[TGT]].ddy.coarse.v2f16(<2 x half> %{{.*}})
...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <3 x half> @llvm.[[TGT]].ddy.coarse.v3f16(<3 x half> %{{.*}})
...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <4 x half> @llvm.[[TGT]].ddy.coarse.v4f16(<4 x half> %{{.*}})
...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <2 x float> @llvm.[[TGT]].ddy.coarse.v2f32(<2 x float> %{{.*}})
...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <3 x float> @llvm.[[TGT]].ddy.coarse.v3f32(<3 x float> %{{.*}})
...
// CHECK: %hlsl.ddy.coarse = call {{.*}} <4 x float> @llvm.[[TGT]].ddy.coarse.v4f32(<4 x float> %{{.*}})
