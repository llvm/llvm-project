...
// CHECK-LABEL: test_log_float5
// CHECK: call reassoc nnan ninf nsz arcp afn <5 x float> @llvm.log.v5f32
vector<float, 5> test_log_float5(vector<float, 5> p0) { return log(p0); }
