...
// CHECK-DXIL: %[[#PTR:]] = call ptr ([3 x i32], ptr, ...) @llvm.structured.gep.p0.a3i32([3 x i32] poison, ptr %array, i32 2)
// CHECK-SPIR: %[[#PTR:]] = call ptr ([3 x i32], ptr, ...) @llvm.structured.gep.p0.a3i32([3 x i32] poison, ptr %array, i64 2)
