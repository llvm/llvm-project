...
// CHECK-NEXT: [[L:%.*]] = icmp ne <2 x i32> [[BoolVec:%.*]], zeroinitializer
...
// CHECK-NEXT: [[LoadV2:%.*]] = icmp ne <2 x i32> [[LoadBV]], zeroinitializer
...
// CHECK-NEXT: [[LV:%.*]] = icmp ne <2 x i32> [[LBV]], zeroinitializer
...
// CHECK-NEXT: [[LV:%.*]] = icmp ne <2 x i32> [[L]], zeroinitializer
