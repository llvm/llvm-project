...
// CHECK-NEXT:    [[CONV:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[TMP1]] to float
...
// CHECK-NEXT:    [[VECEXT:%.*]] = extractelement <2 x i32> [[TMP1]], i64 0
// CHECK-NEXT:    [[CONV:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[VECEXT]] to float
// CHECK-NEXT:    store float [[CONV]], ptr [[X]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP2:%.*]] = load <2 x i32>, ptr [[TWOVALS_ADDR]], align 4
// CHECK-NEXT:    [[VECEXT1:%.*]] = extractelement <2 x i32> [[TMP2]], i64 1
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_TWOINTS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF4:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[X]], align 1
...
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[Y]], align 1
// CHECK-NEXT:    [[CONV1:%.*]] = fptosi float [[TMP2]] to i32
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_DOGGO:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TI1:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TI2:%.*]], i32 noundef [[VAL:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF1:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF2:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF3:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF4:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[Z]], align 1
...
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[W]], align 1
// CHECK-NEXT:    [[VECINIT1:%.*]] = insertelement <4 x i32> [[VECINIT]], i32 [[TMP2]], i32 1
// CHECK-NEXT:    [[Z2:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOINTS]], ptr [[TI2]], i32 0, i32 0
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[Z2]], align 1
// CHECK-NEXT:    [[VECINIT3:%.*]] = insertelement <4 x i32> [[VECINIT1]], i32 [[TMP3]], i32 2
// CHECK-NEXT:    [[W4:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOINTS]], ptr [[TI2]], i32 0, i32 1
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[W4]], align 1
// CHECK-NEXT:    [[VECINIT5:%.*]] = insertelement <4 x i32> [[VECINIT3]], i32 [[TMP4]], i32 3
...
// CHECK-NEXT:    store i32 [[TMP5]], ptr [[TAILSTATE]], align 1
// CHECK-NEXT:    [[HAIRCOUNT:%.*]] = getelementptr inbounds nuw [[STRUCT_DOGGO]], ptr [[AGG_RESULT]], i32 0, i32 2
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[VAL_ADDR]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[TMP6]] to float
...
// CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[X]], align 1
// CHECK-NEXT:    [[VECINIT6:%.*]] = insertelement <4 x float> poison, float [[TMP7]], i32 0
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF1]], i32 0, i32 1
// CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[Y]], align 1
// CHECK-NEXT:    [[VECINIT7:%.*]] = insertelement <4 x float> [[VECINIT6]], float [[TMP8]], i32 1
// CHECK-NEXT:    [[X8:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF2]], i32 0, i32 0
// CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[X8]], align 1
// CHECK-NEXT:    [[VECINIT9:%.*]] = insertelement <4 x float> [[VECINIT7]], float [[TMP9]], i32 2
// CHECK-NEXT:    [[Y10:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF2]], i32 0, i32 1
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[Y10]], align 1
// CHECK-NEXT:    [[VECINIT11:%.*]] = insertelement <4 x float> [[VECINIT9]], float [[TMP10]], i32 3
...
// CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[X12]], align 1
// CHECK-NEXT:    [[VECINIT13:%.*]] = insertelement <4 x float> poison, float [[TMP11]], i32 0
// CHECK-NEXT:    [[Y14:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF3]], i32 0, i32 1
// CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[Y14]], align 1
// CHECK-NEXT:    [[VECINIT15:%.*]] = insertelement <4 x float> [[VECINIT13]], float [[TMP12]], i32 1
// CHECK-NEXT:    [[X16:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF4]], i32 0, i32 0
// CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[X16]], align 1
// CHECK-NEXT:    [[VECINIT17:%.*]] = insertelement <4 x float> [[VECINIT15]], float [[TMP13]], i32 2
// CHECK-NEXT:    [[Y18:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF4]], i32 0, i32 1
// CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[Y18]], align 1
// CHECK-NEXT:    [[VECINIT19:%.*]] = insertelement <4 x float> [[VECINIT17]], float [[TMP14]], i32 3
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_ANIMALBITS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(56) [[D1:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load <4 x i32>, ptr [[LEGSTATE]], align 1
// CHECK-NEXT:    [[VECEXT:%.*]] = extractelement <4 x i32> [[TMP1]], i64 0
...
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr [[LEGSTATE1]], align 1
// CHECK-NEXT:    [[VECEXT2:%.*]] = extractelement <4 x i32> [[TMP2]], i64 1
...
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i32>, ptr [[LEGSTATE4]], align 1
// CHECK-NEXT:    [[VECEXT5:%.*]] = extractelement <4 x i32> [[TMP3]], i64 2
...
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i32>, ptr [[LEGSTATE7]], align 1
// CHECK-NEXT:    [[VECEXT8:%.*]] = extractelement <4 x i32> [[TMP4]], i64 3
...
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TAILSTATE]], align 1
// CHECK-NEXT:    store i32 [[TMP5]], ptr [[STATE]], align 1
...
// CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[HAIRCOUNT]], align 1
// CHECK-NEXT:    [[CONV:%.*]] = fptosi float [[TMP6]] to i64
...
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[ARRAYIDX]], align 1
// CHECK-NEXT:    [[VECEXT9:%.*]] = extractelement <4 x float> [[TMP7]], i64 0
...
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x float>, ptr [[ARRAYIDX11]], align 1
// CHECK-NEXT:    [[VECEXT12:%.*]] = extractelement <4 x float> [[TMP8]], i64 1
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x float>, ptr [[ARRAYIDX15]], align 1
// CHECK-NEXT:    [[VECEXT16:%.*]] = extractelement <4 x float> [[TMP9]], i64 2
...
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x float>, ptr [[ARRAYIDX19]], align 1
// CHECK-NEXT:    [[VECEXT20:%.*]] = extractelement <4 x float> [[TMP10]], i64 3
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <4 x float>, ptr [[ARRAYIDX23]], align 1
// CHECK-NEXT:    [[VECEXT24:%.*]] = extractelement <4 x float> [[TMP11]], i64 0
...
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x float>, ptr [[ARRAYIDX27]], align 1
// CHECK-NEXT:    [[VECEXT28:%.*]] = extractelement <4 x float> [[TMP12]], i64 1
...
// CHECK-NEXT:    [[TMP13:%.*]] = load <4 x float>, ptr [[ARRAYIDX31]], align 1
// CHECK-NEXT:    [[VECEXT32:%.*]] = extractelement <4 x float> [[TMP13]], i64 2
...
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x float>, ptr [[ARRAYIDX35]], align 1
// CHECK-NEXT:    [[VECEXT36:%.*]] = extractelement <4 x float> [[TMP14]], i64 3
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_ZOO:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(56) [[D1:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(60) [[A1:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
// CHECK-NEXT:    [[D1_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr [[LEGSTATE2]], align 1
...
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i32>, ptr [[LEGSTATE5]], align 1
// CHECK-NEXT:    [[VECEXT6:%.*]] = extractelement <4 x i32> [[TMP3]], i64 2
...
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i32>, ptr [[LEGSTATE8]], align 1
// CHECK-NEXT:    [[VECEXT9:%.*]] = extractelement <4 x i32> [[TMP4]], i64 3
...
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TAILSTATE11]], align 1
// CHECK-NEXT:    store i32 [[TMP5]], ptr [[TAILSTATE]], align 1
...
// CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[HAIRCOUNT12]], align 1
// CHECK-NEXT:    store float [[TMP6]], ptr [[HAIRCOUNT]], align 1
...
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x float>, ptr [[ARRAYIDX]], align 1
// CHECK-NEXT:    [[VECEXT14:%.*]] = extractelement <4 x float> [[TMP7]], i64 0
...
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x float>, ptr [[ARRAYIDX17]], align 1
// CHECK-NEXT:    [[VECEXT18:%.*]] = extractelement <4 x float> [[TMP8]], i64 1
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x float>, ptr [[ARRAYIDX21]], align 1
// CHECK-NEXT:    [[VECEXT22:%.*]] = extractelement <4 x float> [[TMP9]], i64 2
...
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x float>, ptr [[ARRAYIDX25]], align 1
// CHECK-NEXT:    [[VECEXT26:%.*]] = extractelement <4 x float> [[TMP10]], i64 3
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <4 x float>, ptr [[ARRAYIDX29]], align 1
// CHECK-NEXT:    [[VECEXT30:%.*]] = extractelement <4 x float> [[TMP11]], i64 0
...
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x float>, ptr [[ARRAYIDX33]], align 1
// CHECK-NEXT:    [[VECEXT34:%.*]] = extractelement <4 x float> [[TMP12]], i64 1
...
// CHECK-NEXT:    [[TMP13:%.*]] = load <4 x float>, ptr [[ARRAYIDX37]], align 1
// CHECK-NEXT:    [[VECEXT38:%.*]] = extractelement <4 x float> [[TMP13]], i64 2
...
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x float>, ptr [[ARRAYIDX41]], align 1
// CHECK-NEXT:    [[VECEXT42:%.*]] = extractelement <4 x float> [[TMP14]], i64 3
...
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[ARRAYIDX46]], align 1
// CHECK-NEXT:    [[VECINIT47:%.*]] = insertelement <4 x i32> poison, i32 [[TMP15]], i32 0
...
// CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr [[ARRAYIDX49]], align 1
// CHECK-NEXT:    [[VECINIT50:%.*]] = insertelement <4 x i32> [[VECINIT47]], i32 [[TMP16]], i32 1
...
// CHECK-NEXT:    [[TMP17:%.*]] = load i32, ptr [[ARRAYIDX52]], align 1
// CHECK-NEXT:    [[VECINIT53:%.*]] = insertelement <4 x i32> [[VECINIT50]], i32 [[TMP17]], i32 2
...
// CHECK-NEXT:    [[TMP18:%.*]] = load i32, ptr [[ARRAYIDX55]], align 1
// CHECK-NEXT:    [[VECINIT56:%.*]] = insertelement <4 x i32> [[VECINIT53]], i32 [[TMP18]], i32 3
...
// CHECK-NEXT:    [[TMP19:%.*]] = load i32, ptr [[STATE]], align 1
// CHECK-NEXT:    store i32 [[TMP19]], ptr [[TAILSTATE57]], align 1
...
// CHECK-NEXT:    [[TMP20:%.*]] = load i64, ptr [[COUNTER]], align 1
// CHECK-NEXT:    [[CONV:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i64 [[TMP20]] to float
...
// CHECK-NEXT:    [[TMP21:%.*]] = load <4 x float>, ptr [[LEFTDIR]], align 1
// CHECK-NEXT:    [[VECEXT60:%.*]] = extractelement <4 x float> [[TMP21]], i64 0
...
// CHECK-NEXT:    [[TMP22:%.*]] = load <4 x float>, ptr [[LEFTDIR62]], align 1
// CHECK-NEXT:    [[VECEXT63:%.*]] = extractelement <4 x float> [[TMP22]], i64 1
...
// CHECK-NEXT:    [[TMP23:%.*]] = load <4 x float>, ptr [[LEFTDIR65]], align 1
// CHECK-NEXT:    [[VECEXT66:%.*]] = extractelement <4 x float> [[TMP23]], i64 2
...
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x float>, ptr [[LEFTDIR68]], align 1
// CHECK-NEXT:    [[VECEXT69:%.*]] = extractelement <4 x float> [[TMP24]], i64 3
...
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x float>, ptr [[RIGHTDIR]], align 1
// CHECK-NEXT:    [[VECEXT72:%.*]] = extractelement <4 x float> [[TMP25]], i64 0
...
// CHECK-NEXT:    [[TMP26:%.*]] = load <4 x float>, ptr [[RIGHTDIR74]], align 1
// CHECK-NEXT:    [[VECEXT75:%.*]] = extractelement <4 x float> [[TMP26]], i64 1
...
// CHECK-NEXT:    [[TMP27:%.*]] = load <4 x float>, ptr [[RIGHTDIR77]], align 1
// CHECK-NEXT:    [[VECEXT78:%.*]] = extractelement <4 x float> [[TMP27]], i64 2
...
// CHECK-NEXT:    [[TMP28:%.*]] = load <4 x float>, ptr [[RIGHTDIR80]], align 1
// CHECK-NEXT:    [[VECEXT81:%.*]] = extractelement <4 x float> [[TMP28]], i64 3
...
// CHECK-NEXT:    [[TMP29:%.*]] = load <4 x i32>, ptr [[LEGSTATE84]], align 1
// CHECK-NEXT:    [[VECEXT85:%.*]] = extractelement <4 x i32> [[TMP29]], i64 0
...
// CHECK-NEXT:    [[TMP30:%.*]] = load <4 x i32>, ptr [[LEGSTATE87]], align 1
// CHECK-NEXT:    [[VECEXT88:%.*]] = extractelement <4 x i32> [[TMP30]], i64 1
...
// CHECK-NEXT:    [[TMP31:%.*]] = load <4 x i32>, ptr [[LEGSTATE90]], align 1
// CHECK-NEXT:    [[VECEXT91:%.*]] = extractelement <4 x i32> [[TMP31]], i64 2
...
// CHECK-NEXT:    [[TMP32:%.*]] = load <4 x i32>, ptr [[LEGSTATE93]], align 1
// CHECK-NEXT:    [[VECEXT94:%.*]] = extractelement <4 x i32> [[TMP32]], i64 3
...
// CHECK-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TAILSTATE97]], align 1
// CHECK-NEXT:    store i32 [[TMP33]], ptr [[TAILSTATE96]], align 1
...
// CHECK-NEXT:    [[TMP34:%.*]] = load float, ptr [[HAIRCOUNT99]], align 1
// CHECK-NEXT:    store float [[TMP34]], ptr [[HAIRCOUNT98]], align 1
...
// CHECK-NEXT:    [[TMP35:%.*]] = load <4 x float>, ptr [[ARRAYIDX101]], align 1
// CHECK-NEXT:    [[VECEXT102:%.*]] = extractelement <4 x float> [[TMP35]], i64 0
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <4 x float>, ptr [[ARRAYIDX105]], align 1
// CHECK-NEXT:    [[VECEXT106:%.*]] = extractelement <4 x float> [[TMP36]], i64 1
...
// CHECK-NEXT:    [[TMP37:%.*]] = load <4 x float>, ptr [[ARRAYIDX109]], align 1
// CHECK-NEXT:    [[VECEXT110:%.*]] = extractelement <4 x float> [[TMP37]], i64 2
...
// CHECK-NEXT:    [[TMP38:%.*]] = load <4 x float>, ptr [[ARRAYIDX113]], align 1
// CHECK-NEXT:    [[VECEXT114:%.*]] = extractelement <4 x float> [[TMP38]], i64 3
...
// CHECK-NEXT:    [[TMP39:%.*]] = load <4 x float>, ptr [[ARRAYIDX118]], align 1
// CHECK-NEXT:    [[VECEXT119:%.*]] = extractelement <4 x float> [[TMP39]], i64 0
...
// CHECK-NEXT:    [[TMP40:%.*]] = load <4 x float>, ptr [[ARRAYIDX122]], align 1
// CHECK-NEXT:    [[VECEXT123:%.*]] = extractelement <4 x float> [[TMP40]], i64 1
...
// CHECK-NEXT:    [[TMP41:%.*]] = load <4 x float>, ptr [[ARRAYIDX126]], align 1
// CHECK-NEXT:    [[VECEXT127:%.*]] = extractelement <4 x float> [[TMP41]], i64 2
...
// CHECK-NEXT:    [[TMP42:%.*]] = load <4 x float>, ptr [[ARRAYIDX130]], align 1
// CHECK-NEXT:    [[VECEXT131:%.*]] = extractelement <4 x float> [[TMP42]], i64 3
...
// CHECK-NEXT:    [[TMP43:%.*]] = load i32, ptr [[ARRAYIDX136]], align 1
// CHECK-NEXT:    [[VECINIT137:%.*]] = insertelement <4 x i32> poison, i32 [[TMP43]], i32 0
...
// CHECK-NEXT:    [[TMP44:%.*]] = load i32, ptr [[ARRAYIDX139]], align 1
// CHECK-NEXT:    [[VECINIT140:%.*]] = insertelement <4 x i32> [[VECINIT137]], i32 [[TMP44]], i32 1
...
// CHECK-NEXT:    [[TMP45:%.*]] = load i32, ptr [[ARRAYIDX142]], align 1
// CHECK-NEXT:    [[VECINIT143:%.*]] = insertelement <4 x i32> [[VECINIT140]], i32 [[TMP45]], i32 2
...
// CHECK-NEXT:    [[TMP46:%.*]] = load i32, ptr [[ARRAYIDX145]], align 1
// CHECK-NEXT:    [[VECINIT146:%.*]] = insertelement <4 x i32> [[VECINIT143]], i32 [[TMP46]], i32 3
...
// CHECK-NEXT:    [[TMP47:%.*]] = load i32, ptr [[STATE148]], align 1
// CHECK-NEXT:    store i32 [[TMP47]], ptr [[TAILSTATE147]], align 1
...
// CHECK-NEXT:    [[TMP48:%.*]] = load i64, ptr [[COUNTER150]], align 1
// CHECK-NEXT:    [[CONV151:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i64 [[TMP48]] to float
...
// CHECK-NEXT:    [[TMP49:%.*]] = load <4 x float>, ptr [[LEFTDIR153]], align 1
// CHECK-NEXT:    [[VECEXT154:%.*]] = extractelement <4 x float> [[TMP49]], i64 0
...
// CHECK-NEXT:    [[TMP50:%.*]] = load <4 x float>, ptr [[LEFTDIR156]], align 1
// CHECK-NEXT:    [[VECEXT157:%.*]] = extractelement <4 x float> [[TMP50]], i64 1
...
// CHECK-NEXT:    [[TMP51:%.*]] = load <4 x float>, ptr [[LEFTDIR159]], align 1
// CHECK-NEXT:    [[VECEXT160:%.*]] = extractelement <4 x float> [[TMP51]], i64 2
...
// CHECK-NEXT:    [[TMP52:%.*]] = load <4 x float>, ptr [[LEFTDIR162]], align 1
// CHECK-NEXT:    [[VECEXT163:%.*]] = extractelement <4 x float> [[TMP52]], i64 3
...
// CHECK-NEXT:    [[TMP53:%.*]] = load <4 x float>, ptr [[RIGHTDIR166]], align 1
// CHECK-NEXT:    [[VECEXT167:%.*]] = extractelement <4 x float> [[TMP53]], i64 0
...
// CHECK-NEXT:    [[TMP54:%.*]] = load <4 x float>, ptr [[RIGHTDIR169]], align 1
// CHECK-NEXT:    [[VECEXT170:%.*]] = extractelement <4 x float> [[TMP54]], i64 1
...
// CHECK-NEXT:    [[TMP55:%.*]] = load <4 x float>, ptr [[RIGHTDIR172]], align 1
// CHECK-NEXT:    [[VECEXT173:%.*]] = extractelement <4 x float> [[TMP55]], i64 2
...
// CHECK-NEXT:    [[TMP56:%.*]] = load <4 x float>, ptr [[RIGHTDIR175]], align 1
// CHECK-NEXT:    [[VECEXT176:%.*]] = extractelement <4 x float> [[TMP56]], i64 3
...
// CHECK-NEXT:    [[TMP57:%.*]] = load <4 x i32>, ptr [[LEGSTATE180]], align 1
// CHECK-NEXT:    [[VECEXT181:%.*]] = extractelement <4 x i32> [[TMP57]], i64 0
...
// CHECK-NEXT:    [[TMP58:%.*]] = load <4 x i32>, ptr [[LEGSTATE183]], align 1
// CHECK-NEXT:    [[VECEXT184:%.*]] = extractelement <4 x i32> [[TMP58]], i64 1
...
// CHECK-NEXT:    [[TMP59:%.*]] = load <4 x i32>, ptr [[LEGSTATE186]], align 1
// CHECK-NEXT:    [[VECEXT187:%.*]] = extractelement <4 x i32> [[TMP59]], i64 2
...
// CHECK-NEXT:    [[TMP60:%.*]] = load <4 x i32>, ptr [[LEGSTATE189]], align 1
// CHECK-NEXT:    [[VECEXT190:%.*]] = extractelement <4 x i32> [[TMP60]], i64 3
...
// CHECK-NEXT:    [[TMP61:%.*]] = load i32, ptr [[TAILSTATE193]], align 1
// CHECK-NEXT:    store i32 [[TMP61]], ptr [[TAILSTATE192]], align 1
...
// CHECK-NEXT:    [[TMP62:%.*]] = load float, ptr [[HAIRCOUNT195]], align 1
// CHECK-NEXT:    store float [[TMP62]], ptr [[HAIRCOUNT194]], align 1
...
// CHECK-NEXT:    [[TMP63:%.*]] = load <4 x float>, ptr [[ARRAYIDX198]], align 1
// CHECK-NEXT:    [[VECEXT199:%.*]] = extractelement <4 x float> [[TMP63]], i64 0
...
// CHECK-NEXT:    [[TMP64:%.*]] = load <4 x float>, ptr [[ARRAYIDX202]], align 1
// CHECK-NEXT:    [[VECEXT203:%.*]] = extractelement <4 x float> [[TMP64]], i64 1
...
// CHECK-NEXT:    [[TMP65:%.*]] = load <4 x float>, ptr [[ARRAYIDX206]], align 1
// CHECK-NEXT:    [[VECEXT207:%.*]] = extractelement <4 x float> [[TMP65]], i64 2
...
// CHECK-NEXT:    [[TMP66:%.*]] = load <4 x float>, ptr [[ARRAYIDX210]], align 1
// CHECK-NEXT:    [[VECEXT211:%.*]] = extractelement <4 x float> [[TMP66]], i64 3
...
// CHECK-NEXT:    [[TMP67:%.*]] = load <4 x float>, ptr [[ARRAYIDX215]], align 1
// CHECK-NEXT:    [[VECEXT216:%.*]] = extractelement <4 x float> [[TMP67]], i64 0
...
// CHECK-NEXT:    [[TMP68:%.*]] = load <4 x float>, ptr [[ARRAYIDX219]], align 1
// CHECK-NEXT:    [[VECEXT220:%.*]] = extractelement <4 x float> [[TMP68]], i64 1
...
// CHECK-NEXT:    [[TMP69:%.*]] = load <4 x float>, ptr [[ARRAYIDX223]], align 1
// CHECK-NEXT:    [[VECEXT224:%.*]] = extractelement <4 x float> [[TMP69]], i64 2
...
// CHECK-NEXT:    [[TMP70:%.*]] = load <4 x float>, ptr [[ARRAYIDX227]], align 1
// CHECK-NEXT:    [[VECEXT228:%.*]] = extractelement <4 x float> [[TMP70]], i64 3
...
// CHECK-NEXT:    [[TMP71:%.*]] = load i32, ptr [[ARRAYIDX233]], align 1
// CHECK-NEXT:    [[VECINIT234:%.*]] = insertelement <4 x i32> poison, i32 [[TMP71]], i32 0
...
// CHECK-NEXT:    [[TMP72:%.*]] = load i32, ptr [[ARRAYIDX236]], align 1
// CHECK-NEXT:    [[VECINIT237:%.*]] = insertelement <4 x i32> [[VECINIT234]], i32 [[TMP72]], i32 1
...
// CHECK-NEXT:    [[TMP73:%.*]] = load i32, ptr [[ARRAYIDX239]], align 1
// CHECK-NEXT:    [[VECINIT240:%.*]] = insertelement <4 x i32> [[VECINIT237]], i32 [[TMP73]], i32 2
...
// CHECK-NEXT:    [[TMP74:%.*]] = load i32, ptr [[ARRAYIDX242]], align 1
// CHECK-NEXT:    [[VECINIT243:%.*]] = insertelement <4 x i32> [[VECINIT240]], i32 [[TMP74]], i32 3
...
// CHECK-NEXT:    [[TMP75:%.*]] = load i32, ptr [[STATE245]], align 1
// CHECK-NEXT:    store i32 [[TMP75]], ptr [[TAILSTATE244]], align 1
...
// CHECK-NEXT:    [[TMP76:%.*]] = load i64, ptr [[COUNTER247]], align 1
// CHECK-NEXT:    [[CONV248:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i64 [[TMP76]] to float
...
// CHECK-NEXT:    [[TMP77:%.*]] = load <4 x float>, ptr [[LEFTDIR250]], align 1
// CHECK-NEXT:    [[VECEXT251:%.*]] = extractelement <4 x float> [[TMP77]], i64 0
...
// CHECK-NEXT:    [[TMP78:%.*]] = load <4 x float>, ptr [[LEFTDIR253]], align 1
// CHECK-NEXT:    [[VECEXT254:%.*]] = extractelement <4 x float> [[TMP78]], i64 1
...
// CHECK-NEXT:    [[TMP79:%.*]] = load <4 x float>, ptr [[LEFTDIR256]], align 1
// CHECK-NEXT:    [[VECEXT257:%.*]] = extractelement <4 x float> [[TMP79]], i64 2
...
// CHECK-NEXT:    [[TMP80:%.*]] = load <4 x float>, ptr [[LEFTDIR259]], align 1
// CHECK-NEXT:    [[VECEXT260:%.*]] = extractelement <4 x float> [[TMP80]], i64 3
...
// CHECK-NEXT:    [[TMP81:%.*]] = load <4 x float>, ptr [[RIGHTDIR263]], align 1
// CHECK-NEXT:    [[VECEXT264:%.*]] = extractelement <4 x float> [[TMP81]], i64 0
...
// CHECK-NEXT:    [[TMP82:%.*]] = load <4 x float>, ptr [[RIGHTDIR266]], align 1
// CHECK-NEXT:    [[VECEXT267:%.*]] = extractelement <4 x float> [[TMP82]], i64 1
...
// CHECK-NEXT:    [[TMP83:%.*]] = load <4 x float>, ptr [[RIGHTDIR269]], align 1
// CHECK-NEXT:    [[VECEXT270:%.*]] = extractelement <4 x float> [[TMP83]], i64 2
...
// CHECK-NEXT:    [[TMP84:%.*]] = load <4 x float>, ptr [[RIGHTDIR272]], align 1
// CHECK-NEXT:    [[VECEXT273:%.*]] = extractelement <4 x float> [[TMP84]], i64 3
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_FOURFLOATS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF1:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF2:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
// CHECK-NEXT:    [[TF1_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[X1]], align 1
// CHECK-NEXT:    store float [[TMP1]], ptr [[X]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[Y2:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[TF1]], i32 0, i32 1
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[Y2]], align 1
...
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[X3]], align 1
...
// CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[Y4]], align 1
// CHECK-NEXT:    store float [[TMP4]], ptr [[W]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[CAST_SPLAT:%.*]] = insertelement <1 x float> poison, float [[TMP1]], i64 0
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <1 x float> [[CAST_SPLAT]], <1 x float> poison, <4 x i32> zeroinitializer
// CHECK-NEXT:    store <4 x float> [[TMP2]], ptr [[REF_TMP]], align 4
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x float>, ptr [[REF_TMP]], align 4
// CHECK-NEXT:    [[VECEXT:%.*]] = extractelement <4 x float> [[TMP3]], i64 0
// CHECK-NEXT:    store float [[VECEXT]], ptr [[X]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[F_ADDR]], align 4
// CHECK-NEXT:    [[CAST_SPLAT2:%.*]] = insertelement <1 x float> poison, float [[TMP4]], i64 0
// CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <1 x float> [[CAST_SPLAT2]], <1 x float> poison, <4 x i32> zeroinitializer
// CHECK-NEXT:    store <4 x float> [[TMP5]], ptr [[REF_TMP1]], align 4
// CHECK-NEXT:    [[TMP6:%.*]] = load <4 x float>, ptr [[REF_TMP1]], align 4
// CHECK-NEXT:    [[VECEXT3:%.*]] = extractelement <4 x float> [[TMP6]], i64 1
// CHECK-NEXT:    store float [[VECEXT3]], ptr [[Y]], align 1
// CHECK-NEXT:    [[Z:%.*]] = getelementptr inbounds nuw [[STRUCT_FOURFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[F_ADDR]], align 4
// CHECK-NEXT:    [[CAST_SPLAT5:%.*]] = insertelement <1 x float> poison, float [[TMP7]], i64 0
// CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <1 x float> [[CAST_SPLAT5]], <1 x float> poison, <4 x i32> zeroinitializer
// CHECK-NEXT:    store <4 x float> [[TMP8]], ptr [[REF_TMP4]], align 4
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x float>, ptr [[REF_TMP4]], align 4
// CHECK-NEXT:    [[VECEXT6:%.*]] = extractelement <4 x float> [[TMP9]], i64 2
// CHECK-NEXT:    store float [[VECEXT6]], ptr [[Z]], align 1
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_FOURFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 2
// CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[F_ADDR]], align 4
// CHECK-NEXT:    [[CAST_SPLAT8:%.*]] = insertelement <1 x float> poison, float [[TMP10]], i64 0
// CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <1 x float> [[CAST_SPLAT8]], <1 x float> poison, <4 x i32> zeroinitializer
// CHECK-NEXT:    store <4 x float> [[TMP11]], ptr [[REF_TMP7]], align 4
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x float>, ptr [[REF_TMP7]], align 4
// CHECK-NEXT:    [[VECEXT9:%.*]] = extractelement <4 x float> [[TMP12]], i64 3
...
// CHECK-NEXT:    store i8 [[TMP2]], ptr [[AGG_RESULT]], align 1
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_SLICYBITS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[J_ADDR]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = trunc i32 [[TMP3]] to i8
// CHECK-NEXT:    store i8 [[TMP4]], ptr [[W]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_SLICYBITS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TI:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[W1]], align 1
// CHECK-NEXT:    [[TMP4:%.*]] = trunc i32 [[TMP3]] to i8
// CHECK-NEXT:    store i8 [[TMP4]], ptr [[W]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_TWOINTS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(2) [[SB:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
...
// CHECK-SAME: ptr dead_on_unwind noalias writable sret([[STRUCT_TWOFLOATS:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(2) [[SB:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[RESULT_PTR:%.*]] = alloca ptr, align 4
// CHECK-NEXT:    [[SB_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[X_ADDR]], align 4, !nonnull [[META3:![0-9]+]], !align [[META4:![0-9]+]]
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[TMP1]], align 4
// CHECK-NEXT:    store float [[TMP2]], ptr [[X1]], align 1
// CHECK-NEXT:    [[Y:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 1
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr [[X_ADDR]], align 4, !nonnull [[META3]], !align [[META4]]
// CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[TMP3]], align 4
// CHECK-NEXT:    [[MUL:%.*]] = fmul reassoc nnan ninf nsz arcp afn float [[TMP4]], 1.500000e+00
// CHECK-NEXT:    store float [[MUL]], ptr [[Y]], align 1
// CHECK-NEXT:    [[TMP5:%.*]] = load ptr, ptr [[X_ADDR]], align 4, !nonnull [[META3]], !align [[META4]]
// CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[TMP5]], align 4
// CHECK-NEXT:    [[MUL2:%.*]] = fmul reassoc nnan ninf nsz arcp afn float [[TMP6]], 2.000000e+00
// CHECK-NEXT:    store float [[MUL2]], ptr [[TMP5]], align 4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[X]], align 4
// CHECK-NEXT:    store float [[TMP1]], ptr [[TMP]], align 4
// CHECK-NEXT:    call void @_Z7makeTwoRf(ptr dead_on_unwind writable sret([[STRUCT_TWOFLOATS]]) align 1 [[REF_TMP]], ptr noalias noundef nonnull align 4 dereferenceable(4) [[TMP]]) #[[ATTR3:[0-9]+]] [ "convergencectrl"(token [[TMP0]]) ]
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[TMP]], align 4
// CHECK-NEXT:    store float [[TMP2]], ptr [[X]], align 4
// CHECK-NEXT:    [[X1:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 0
...
// CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[X2]], align 1
...
// CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[Y3]], align 1
// CHECK-NEXT:    store float [[TMP4]], ptr [[Z]], align 1
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_FOURFLOATS]], ptr [[AGG_RESULT]], i32 0, i32 2
...
// CHECK-NEXT:    [[CALL1:%.*]] = call noundef i32 @_Z12case17Helperi(i32 noundef 0) #[[ATTR3]] [ "convergencectrl"(token [[TMP0]]) ]
// CHECK-NEXT:    [[CALL2:%.*]] = call noundef i32 @_Z12case17Helperi(i32 noundef 1) #[[ATTR3]] [ "convergencectrl"(token [[TMP0]]) ]
// CHECK-NEXT:    [[VECINIT:%.*]] = insertelement <2 x i32> poison, i32 [[CALL1]], i32 0
// CHECK-NEXT:    [[VECINIT3:%.*]] = insertelement <2 x i32> [[VECINIT]], i32 [[CALL2]], i32 1
// CHECK-NEXT:    store <2 x i32> [[VECINIT3]], ptr [[X]], align 4
// CHECK-NEXT:    ret void
//
void case17() {
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(5) [[U:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-NEXT:    store i32 [[TMP1]], ptr [[Z]], align 1
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) [[E:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) [[UO:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) [[ED:%.*]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) [[UD:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TI:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
// CHECK-NEXT:    [[TI_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
...
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOINTS]], ptr [[TI]], i32 0, i32 1
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[W]], align 1
// CHECK-NEXT:    [[CONV1:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[TMP2]] to float
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[Z5]], align 1
// CHECK-NEXT:    [[CONV6:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[TMP3]] to float
...
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[W8]], align 1
// CHECK-NEXT:    [[CONV9:%.*]] = sitofp reassoc nnan ninf nsz arcp afn i32 [[TMP4]] to float
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(4) [[A:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-NEXT:    [[TMP1:%.*]] = load target("dx.TypedBuffer", float, 1, 0, 0), ptr [[H1]], align 1
// CHECK-NEXT:    store target("dx.TypedBuffer", float, 1, 0, 0) [[TMP1]], ptr [[H]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(8) [[TF:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[GEP2]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = fptosi float [[TMP1]] to i32
// CHECK-NEXT:    store i32 [[CONV]], ptr [[GEP]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[GEP3]], align 4
// CHECK-NEXT:    [[CONV4:%.*]] = fptosi float [[TMP2]] to i32
...
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[W6]], align 1
// CHECK-NEXT:    store i32 [[TMP4]], ptr [[W]], align 1
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: ptr nofreeobj noundef align 1 dead_on_return dereferenceable(16) [[FF:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.experimental.convergence.entry()
...
// CHECK-NEXT:    store i32 [[CONV]], ptr [[GEP]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[GEP3]], align 4
// CHECK-NEXT:    [[CONV6:%.*]] = fptosi float [[TMP2]] to i32
...
// CHECK-NEXT:    store i32 [[TMP3]], ptr [[INTS]], align 4
...
// CHECK-NEXT:    store i32 [[TMP4]], ptr [[ARRAYINIT_ELEMENT]], align 4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[Z7]], align 1
// CHECK-NEXT:    store i32 [[TMP3]], ptr [[Z]], align 1
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_TWOINTS]], ptr [[TI]], i32 0, i32 1
...
// CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[F]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = fptosi float [[TMP1]] to i32
// CHECK-NEXT:    [[TMP2:%.*]] = trunc i32 [[CONV]] to i8
// CHECK-NEXT:    store i8 [[TMP2]], ptr [[SB]], align 1
// CHECK-NEXT:    [[W:%.*]] = getelementptr inbounds nuw [[STRUCT_SLICYBITS]], ptr [[SB]], i32 0, i32 1
