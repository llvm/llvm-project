...
// CHECK-LABEL: define hidden noundef nofpclass(nan inf) <3 x double> @_Z25testTemplatedMatrixAccessu11matrix_typeILm2ELm3EdE(
// CHECK-SAME: <6 x double> noundef nofpclass(nan inf) [[M:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[M_ADDR:%.*]] = alloca [6 x double], align 8
// CHECK-NEXT:    store <6 x double> [[M]], ptr [[M_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <6 x double>, ptr [[M_ADDR]], align 8
// CHECK-NEXT:    [[CALL:%.*]] = call reassoc nnan ninf nsz arcp afn noundef nofpclass(nan inf) <3 x double> @_Z21getVecFromTemplateMatIdEDv3_T_u11matrix_typeILm2ELm3ES0_E(<6 x double> noundef nofpclass(nan inf) [[TMP0]]) #[[ATTR1:[0-9]+]]
// CHECK-NEXT:    ret <3 x double> [[CALL]]
//
double3 testTemplatedMatrixAccess(double2x3 M) {
  return getVecFromTemplateMat(M);
}
// CHECK-LABEL: define linkonce_odr hidden noundef nofpclass(nan inf)  <3 x double> @_Z21getVecFromTemplateMatIdEDv3_T_u11matrix_typeILm2ELm3ES0_E(
// CHECK-SAME: <6 x double> noundef nofpclass(nan inf) [[M:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[M_ADDR:%.*]] = alloca [6 x double], align 8
// CHECK-NEXT:    store <6 x double> [[M]], ptr [[M_ADDR]], align 8
