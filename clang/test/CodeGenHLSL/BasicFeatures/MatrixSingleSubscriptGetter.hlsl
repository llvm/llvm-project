...
// CHECK-NEXT:    [[TMP1:%.*]] = load <16 x i32>, ptr [[M_ADDR]], align 4
// CHECK-NEXT:    [[LOADEDV:%.*]] = icmp ne <16 x i32> [[TMP1]], zeroinitializer
// CHECK-NEXT:    [[MATRIX_ELEM:%.*]] = extractelement <16 x i1> [[LOADEDV]], i32 0
// CHECK-NEXT:    [[MATRIX_ROW_INS:%.*]] = insertelement <4 x i1> poison, i1 [[MATRIX_ELEM]], i32 0
// CHECK-NEXT:    [[MATRIX_ELEM1:%.*]] = extractelement <16 x i1> [[LOADEDV]], i32 4
// CHECK-NEXT:    [[MATRIX_ROW_INS2:%.*]] = insertelement <4 x i1> [[MATRIX_ROW_INS]], i1 [[MATRIX_ELEM1]], i32 1
// CHECK-NEXT:    [[MATRIX_ELEM3:%.*]] = extractelement <16 x i1> [[LOADEDV]], i32 8
// CHECK-NEXT:    [[MATRIX_ROW_INS4:%.*]] = insertelement <4 x i1> [[MATRIX_ROW_INS2]], i1 [[MATRIX_ELEM3]], i32 2
// CHECK-NEXT:    [[MATRIX_ELEM5:%.*]] = extractelement <16 x i1> [[LOADEDV]], i32 12
// CHECK-NEXT:    [[MATRIX_ROW_INS6:%.*]] = insertelement <4 x i1> [[MATRIX_ROW_INS4]], i1 [[MATRIX_ELEM5]], i32 3
// CHECK-NEXT:    ret <4 x i1> [[MATRIX_ROW_INS6]]
//
...
// CHECK-NEXT:    [[MATRIX_ELEM:%.*]] = extractelement <3 x i1> [[LOADEDV]], i32 1
// CHECK-NEXT:    [[MATRIX_ROW_INS:%.*]] = insertelement <1 x i1> poison, i1 [[MATRIX_ELEM]], i32 0
// CHECK-NEXT:    [[CAST_VTRUNC:%.*]] = extractelement <1 x i1> [[MATRIX_ROW_INS]], i32 0
