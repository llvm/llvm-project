...
// CHECK: @A.cb = hidden global target("dx.CBuffer", %"n0::n1::__cblayout_A")
// CHECK: @_ZN2n02n11aE = external hidden addrspace(2) global float, align 4

// CHECK: @B.cb = hidden global target("dx.CBuffer", %"n0::__cblayout_B")
// CHECK: @_ZN2n01aE = external hidden addrspace(2) global float, align 4

// CHECK: @C.cb = hidden global target("dx.CBuffer", %"n0::n2::__cblayout_C")
