...
// CHECK-NEXT: call void @useMyStruct(MyStruct)(ptr nofreeobj noundef align 4 dead_on_return dereferenceable(8) [[TMP1]])
...
// CHECK-NEXT: call void @useMyStructWithCounter(MyStructWithCounter)(ptr nofreeobj noundef align 4 dead_on_return dereferenceable(12) [[TMP2]])
...
// CHECK-NEXT: call void @useWrappaStruct(WrappaStruct)(ptr nofreeobj noundef align 1 dead_on_return dereferenceable(36) [[TMP]])
...
// call useMyStruct with the temporary
// CHECK-NEXT: call void @useMyStruct(MyStruct)(ptr nofreeobj noundef align 4 dead_on_return dereferenceable(8) [[TMP]])
