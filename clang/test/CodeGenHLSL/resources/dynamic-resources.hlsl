...
// CHECK: @hlsl::ResourceDescriptorHeap = internal {{.*}}global %"struct.hlsl::__detail::__resource_descriptor_heap_struct" zeroinitializer, align 1
// CHECK: @hlsl::SamplerDescriptorHeap = internal {{.*}}global %"struct.hlsl::__detail::__sampler_descriptor_heap_struct" zeroinitializer, align 1

// CHECK-LABEL: testTypedBuffer
export void testTypedBuffer(unsigned Index) {
// CHECK: [[TMP0:%.*]] = alloca %"class.hlsl::__detail::__heap_resource_info"

// DXIL: call void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// DXIL-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP0]],
// DXIL-SAME: ptr {{.*}} @hlsl::ResourceDescriptorHeap, i32 noundef %{{[0-9]+}})

// SPV: call spir_func void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// SPV-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP0]],
// SPV-SAME: ptr {{.*}} addrspacecast ({{.*}} @hlsl::ResourceDescriptorHeap to ptr), i32 noundef %{{[0-9]+}})

// CHECK: call {{(spir_func )*}}void @hlsl::RWBuffer<int>::RWBuffer(hlsl::__detail::__heap_resource_info)
// CHECK-SAME: (ptr {{.*}} %Buffer, ptr noundef byval(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP0]])
...
// CHECK: [[TMP2:%.*]] = alloca %"class.hlsl::__detail::__heap_resource_info"
// CHECK: call {{(spir_func )*}}void @hlsl::ConstantBuffer<S>::ConstantBuffer()(ptr {{.*}} %CBS)

// DXIL: call void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// DXIL-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP2]],
// DXIL-SAME: ptr {{.*}} @hlsl::ResourceDescriptorHeap, i32 noundef %{{[0-9]+}})

// SPV: call spir_func void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// SPV-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP2]],
// SPV-SAME: ptr {{.*}} addrspacecast ({{.*}} @hlsl::ResourceDescriptorHeap to ptr), i32 noundef %{{[0-9]+}})

// CHECK: call {{(spir_func )*}}void @hlsl::ConstantBuffer<S>::ConstantBuffer(hlsl::__detail::__heap_resource_info)
// CHECK-SAME: (ptr {{.*}} [[TMP1]], ptr noundef byval(%"class.hlsl::__detail::__heap_resource_info") align 4 %{{.*}})
...
// CHECK: [[TMP3:%.*]] = alloca %"class.hlsl::__detail::__heap_sampler_info"
export SamplerState testSampler(unsigned Index) {

// DXIL: call void @hlsl::__detail::__sampler_descriptor_heap_struct::operator[](unsigned int)
// DXIL-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_sampler_info") align 4 [[TMP3]],
// DXIL-SAME: ptr {{.*}} @hlsl::SamplerDescriptorHeap, i32 noundef %{{[0-9]+}})

// SPV: call spir_func void @hlsl::__detail::__sampler_descriptor_heap_struct::operator[](unsigned int)
// SPV-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_sampler_info") align 4 [[TMP3]],
// SPV-SAME: ptr {{.*}} addrspacecast ({{.*}} @hlsl::SamplerDescriptorHeap to ptr), i32 noundef %{{[0-9]+}})

// CHECK: call {{(spir_func )*}}void @hlsl::SamplerState::SamplerState(hlsl::__detail::__heap_sampler_info)
// CHECK-SAME: (ptr {{.*}} [[RESULT]], ptr noundef byval(%"class.hlsl::__detail::__heap_sampler_info") align 4 [[TMP3]])
...
// CHECK: [[TMP4:%.*]] = alloca %"class.hlsl::__detail::__heap_resource_info"

// DXIL: call void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// DXIL-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP4]],
// DXIL-SAME: ptr {{.*}} @hlsl::ResourceDescriptorHeap, i32 noundef %{{[0-9]+}})

// SPV: call spir_func void @hlsl::__detail::__resource_descriptor_heap_struct::operator[](unsigned int)
// SPV-SAME: (ptr {{.*}} sret(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP4]],
// SPV-SAME: ptr {{.*}} addrspacecast ({{.*}} @hlsl::ResourceDescriptorHeap to ptr), i32 noundef %{{[0-9]+}})

// CHECK: call {{(spir_func )*}}void @hlsl::AppendStructuredBuffer<int>::AppendStructuredBuffer(hlsl::__detail::__heap_resource_info)
// CHECK-SAME: (ptr {{.*}} [[TMP_BUFFER]], ptr noundef byval(%"class.hlsl::__detail::__heap_resource_info") align 4 [[TMP4]])
