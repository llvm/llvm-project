...
// CHECK-NEXT: call {{.*}}void @useS(S)(ptr nofree noundef align 1 dead_on_return dereferenceable(20) [[TMP]])
  useS(CBS);
}
...
// CHECK-NEXT: call {{.*}}void @useP(P)(ptr nofree noundef align 1 dead_on_return dereferenceable(4) [[TMP]])
  useP(CBT.p);
}
