...
// SPARCV9-NOT: define{{.*}} void @ParamPassing4(ptr dead_on_return %{{.+}})
...
// RISCV64-NOT: define{{.*}} void @ParamPassing4(ptr dead_on_return %{{.+}})
// RISCV32-NOT: define{{.*}} void @ParamPassing4(ptr dead_on_return %{{.+}})
// WASM-NOT: define{{.*}} void @ParamPassing4(ptr byval(i129) align 8 %{{.+}})
// SYSTEMZ-NOT: define{{.*}} void @ParamPassing4(ptr dead_on_return %{{.+}})
