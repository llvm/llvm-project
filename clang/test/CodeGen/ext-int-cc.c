...
// WIN64: define dso_local void @ParamPassing(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i64 %{{.+}})
// LIN32: define{{.*}} void @ParamPassing(ptr nofree align 4 dead_on_return dereferenceable(16) %{{.+}}, i64 %{{.+}})
// WIN32: define dso_local void @ParamPassing(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i64 %{{.+}})
...
// RISCV32: define{{.*}} void @ParamPassing(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i64 signext %{{.+}})
// WASM: define{{.*}} void @ParamPassing(i128 %{{.+}}, i64 %{{.+}})
// SYSTEMZ: define{{.*}} void @ParamPassing(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i64 %{{.+}})
...
// LA32: define{{.*}} void @ParamPassing(ptr nofree align 16 dead_on_return dereferenceable(16) %{{.+}}, i64 %{{.+}})

void ParamPassing2(_BitInt(127) b, _BitInt(63) c) {}
// LIN64: define{{.*}} void @ParamPassing2(i64 %{{.+}}, i64 %{{.+}}, i64 %{{.+}})
// WIN64: define dso_local void @ParamPassing2(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i63 %{{.+}})
// LIN32: define{{.*}} void @ParamPassing2(ptr nofree align 4 dead_on_return dereferenceable(16) %{{.+}}, i63 %{{.+}})
// WIN32: define dso_local void @ParamPassing2(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i63 %{{.+}})
...
// RISCV32: define{{.*}} void @ParamPassing2(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i63 signext %{{.+}})
// WASM: define{{.*}} void @ParamPassing2(i127 %{{.+}}, i63 %{{.+}})
// SYSTEMZ: define{{.*}} void @ParamPassing2(ptr nofree align 8 dead_on_return dereferenceable(16) %{{.+}}, i63 signext %{{.+}})
...
// LA32: define{{.*}} void @ParamPassing2(ptr nofree align 16 dead_on_return dereferenceable(16) %{{.+}}, i63 %{{.+}})
...
// WIN64: define dso_local void @ParamPassing4(ptr nofree align 8 dead_on_return dereferenceable(24) %{{.+}})
// LIN32: define{{.*}} void @ParamPassing4(ptr nofree align 4 dead_on_return dereferenceable(20) %{{.+}})
// WIN32: define dso_local void @ParamPassing4(ptr nofree align 8 dead_on_return dereferenceable(24) %{{.+}})
// AARCH64: define{{.*}} void @ParamPassing4(ptr nofree align 16 dead_on_return dereferenceable(32) %{{.+}})
...
// LA64: define{{.*}} void @ParamPassing4(ptr nofree align 16 dead_on_return dereferenceable(32) %{{.+}})
// LA32: define{{.*}} void @ParamPassing4(ptr nofree align 16 dead_on_return dereferenceable(32) %{{.+}})
#endif
