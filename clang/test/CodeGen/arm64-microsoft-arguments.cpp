...
// CHECK: call void {{.*}}func3{{.*}}(ptr dead_on_unwind writable sret(%struct.S3) align 4 %agg.result, ptr nofreeobj noundef align 4 dead_on_return dereferenceable(20) %agg.tmp)
struct S3 {
  int a[5];
};
