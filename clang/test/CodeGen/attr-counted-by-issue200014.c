...
// RUN:   | opt -S -passes=mem2reg,sroa | FileCheck %s --check-prefix=O0
...
//
// The -O0 RUN line (with mem2reg/sroa only) pins down the IR
// emitCountedBySize emits directly (so a future regression that re-folds
// __bdos at AST time would lose the 'counted_by.load' / 'mul' /
// 'flexible_array_member_size' sequence in the runtime tests). The -O2 RUN
// line pins down the post-optimization shape -- in particular the concrete
...
// Expected: runtime counted_by path -- look for 'counted_by.load' at -O0
// and 'smax(%n, 0)' at -O2.
// O0-LABEL: define dso_local i64 @local_fam(
// O0-SAME: i64 noundef [[N:%.*]]) #[[ATTR0:[0-9]+]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[AF:%.*]] = alloca [[STRUCT_ANNOTATED_FLEX:%.*]], align 8
// O0-NEXT:    [[COUNT:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 0
// O0-NEXT:    store i64 [[N]], ptr [[COUNT]], align 8
// O0-NEXT:    [[INDUCE_PADDING:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 1
// O0-NEXT:    store i8 0, ptr [[INDUCE_PADDING]], align 8
// O0-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[AF]], i64 9
// O0-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[TMP0]], i8 0, i64 7, i1 false)
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM]], i64 0, i64 0
// O0-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[ARRAYDECAY]] to i64
// O0-NEXT:    store i64 [[TMP1]], ptr @sink, align 8
// O0-NEXT:    [[FAM1:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[ARRAYDECAY2:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM1]], i64 0, i64 0
// O0-NEXT:    [[COUNTED_BY_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 0
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr [[COUNTED_BY_GEP]], align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[TMP2:%.*]] = icmp sgt i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], -1
// O0-NEXT:    [[TMP3:%.*]] = select i1 [[TMP2]], i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], i64 0
// O0-NEXT:    ret i64 [[TMP3]]
//
...
// 'counted_by.load' + 'sub' at -O0 and 'add %n, -2' at -O2.
// O0-LABEL: define dso_local i64 @local_subscript(
// O0-SAME: i64 noundef [[N:%.*]]) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[AF:%.*]] = alloca [[STRUCT_ANNOTATED_FLEX:%.*]], align 8
// O0-NEXT:    [[COUNT:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 0
// O0-NEXT:    store i64 [[N]], ptr [[COUNT]], align 8
...
// O0-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[TMP0]], i8 0, i64 7, i1 false)
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM]], i64 0, i64 2
// O0-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[ARRAYIDX]] to i64
// O0-NEXT:    store i64 [[TMP1]], ptr @sink, align 8
// O0-NEXT:    [[FAM1:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM1]], i64 0, i64 2
// O0-NEXT:    [[COUNTED_BY_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 0
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr [[COUNTED_BY_GEP]], align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[RESULT:%.*]] = sub nuw i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], 2
// O0-NEXT:    [[TMP2:%.*]] = icmp sgt i64 [[RESULT]], -1
// O0-NEXT:    [[TMP3:%.*]] = and i1 true, [[TMP2]]
// O0-NEXT:    [[TMP4:%.*]] = select i1 [[TMP3]], i64 [[RESULT]], i64 0
// O0-NEXT:    ret i64 [[TMP4]]
//
...
// padding (7) at -O2.
// O0-LABEL: define dso_local i64 @local_addrof(
// O0-SAME: i64 noundef [[N:%.*]]) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[AF:%.*]] = alloca [[STRUCT_ANNOTATED_FLEX:%.*]], align 8
// O0-NEXT:    [[COUNT:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 0
...
// O0-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[TMP0]], i8 0, i64 7, i1 false)
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[FAM]] to i64
// O0-NEXT:    store i64 [[TMP1]], ptr @sink, align 8
// O0-NEXT:    [[FAM1:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX]], ptr [[AF]], i32 0, i32 2
// O0-NEXT:    [[TMP2:%.*]] = call i64 @llvm.objectsize.i64.p0(ptr [[FAM1]], i1 false, i1 true, i1 true)
// O0-NEXT:    ret i64 [[TMP2]]
//
...
// Expected: runtime path -- 'load i64, ptr @gaf' (the count field) at both
// -O0 and -O2.
// O0-LABEL: define dso_local i64 @global_fam(
// O0-SAME: ) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr @gaf, align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[TMP0:%.*]] = icmp sgt i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], -1
// O0-NEXT:    [[TMP1:%.*]] = select i1 [[TMP0]], i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], i64 0
...
// 'sub' at -O0 / 'add %count, -3' at -O2.
// O0-LABEL: define dso_local i64 @global_subscript(
// O0-SAME: ) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr @gaf, align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[RESULT:%.*]] = sub nuw i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], 3
// O0-NEXT:    [[TMP0:%.*]] = icmp sgt i64 [[RESULT]], -1
// O0-NEXT:    [[TMP1:%.*]] = and i1 true, [[TMP0]]
// O0-NEXT:    [[TMP2:%.*]] = select i1 [[TMP1]], i64 [[RESULT]], i64 0
// O0-NEXT:    ret i64 [[TMP2]]
//
...
// O0-LABEL: define dso_local i64 @global_addrof(
// O0-SAME: ) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[TMP0:%.*]] = call i64 @llvm.objectsize.i64.p0(ptr getelementptr inbounds nuw (i8, ptr @gaf, i64 9), i1 false, i1 true, i1 true)
...
// O0-LABEL: define dso_local i64 @ptr_fam(
// O0-SAME: ptr noundef [[P:%.*]]) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX:%.*]], ptr [[P]], i32 0, i32 2
// O0-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM]], i64 0, i64 0
// O0-NEXT:    [[COUNTED_BY_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANNOTATED_FLEX]], ptr [[P]], i32 0, i32 0
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr [[COUNTED_BY_GEP]], align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[TMP0:%.*]] = icmp sgt i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], -1
// O0-NEXT:    [[TMP1:%.*]] = select i1 [[TMP0]], i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], i64 0
...
// O0-LABEL: define dso_local i64 @ptr_subscript(
// O0-SAME: ptr noundef [[P:%.*]]) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX:%.*]], ptr [[P]], i32 0, i32 2
// O0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [0 x i8], ptr [[FAM]], i64 0, i64 3
// O0-NEXT:    [[COUNTED_BY_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANNOTATED_FLEX]], ptr [[P]], i32 0, i32 0
// O0-NEXT:    [[COUNTED_BY_LOAD:%.*]] = load i64, ptr [[COUNTED_BY_GEP]], align 4
// O0-NEXT:    [[FLEXIBLE_ARRAY_MEMBER_SIZE:%.*]] = mul nuw i64 [[COUNTED_BY_LOAD]], 1
// O0-NEXT:    [[RESULT:%.*]] = sub nuw i64 [[FLEXIBLE_ARRAY_MEMBER_SIZE]], 3
...
// O0-LABEL: define dso_local i64 @ptr_addrof(
// O0-SAME: ptr noundef [[P:%.*]]) #[[ATTR0]] {
// O0-NEXT:  [[ENTRY:.*:]]
// O0-NEXT:    [[FAM:%.*]] = getelementptr inbounds nuw [[STRUCT_ANNOTATED_FLEX:%.*]], ptr [[P]], i32 0, i32 2
// O0-NEXT:    [[TMP0:%.*]] = call i64 @llvm.objectsize.i64.p0(ptr [[FAM]], i1 false, i1 true, i1 true)
// O0-NEXT:    ret i64 [[TMP0]]
//
