...
// FileCheck %s RUN: %clang_cc1 -triple x86_64-windows-gnu       -emit-llvm %s
// -o - | FileCheck %s RUN: %clang_cc1 -triple x86_64-windows-msvc -emit-llvm %s
// -o - | FileCheck --check-prefix=MSVC %s
