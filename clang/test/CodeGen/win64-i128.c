...
// X64: define dso_local <2 x i64> @bar(ptr nofree noundef align 16 dead_on_return dereferenceable(16) %0, ptr nofree noundef align 16 dead_on_return dereferenceable(16) %1)
