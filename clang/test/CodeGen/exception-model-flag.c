...
// The cc1 -exception-model option accepts dwarf/sjlj/seh/wasm/emscripten/none;
// ARM EHABI is triple-inferred and not user-selectable here.
...
// RUN: %clang_cc1 -triple wasm32-unknown-unknown -fexceptions -exception-model=wasm -emit-llvm %s -o - | FileCheck %s --check-prefix=WASM
