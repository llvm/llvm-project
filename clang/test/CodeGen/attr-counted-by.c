...
// SANITIZE-WITH-ATTR-NEXT:    [[TMP2:%.*]] = shl nsw i32 [[DOT_COUNTED_BY_LOAD]], 2
...
// SANITIZE-WITH-ATTR-NEXT:    [[NARROW4:%.*]] = select i1 [[DOTINV]], i32 0, i32 [[NARROW]]
// SANITIZE-WITH-ATTR-NEXT:    store i32 [[NARROW4]], ptr [[ARRAYIDX]], align 4, !tbaa [[TBAA4]]
// SANITIZE-WITH-ATTR-NEXT:    ret void
//
...
// SANITIZE-WITH-ATTR-NEXT:    [[CONV25:%.*]] = select i1 [[DOTINV]], i32 0, i32 [[TMP17]]
...
// SANITIZE-WITH-ATTR-NEXT:    [[DOTINV:%.*]] = icmp slt i32 [[DOT_COUNTED_BY_LOAD]], 0
// SANITIZE-WITH-ATTR-NEXT:    [[TMP5:%.*]] = shl nsw i32 [[DOT_COUNTED_BY_LOAD]], 2
