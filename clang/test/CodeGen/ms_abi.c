...
__attribute__((ms_abi)) struct i128 f7(struct i128 a) {
  // WIN64: define dso_local void @f7(ptr dead_on_unwind noalias writable sret(%struct.i128) align 8 %agg.result, ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) %a)
  // FREEBSD: define{{.*}} win64cc void @f7(ptr dead_on_unwind noalias writable sret(%struct.i128) align 8 %agg.result, ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) %a)
  return a;
}
