...
long double test_f128(long double f, long double g) {
  ...
  return f;
// CHECK: define{{.*}} void @test_f128(ptr dead_on_unwind noalias nofree writable writeonly sret(fp128) align 8 captures(none) initializes((0, 16)) [[DEST:%.*]], ptr nofree noundef readonly align 8 captures(none) dead_on_return %0, ptr nofree noundef readonly align 8 captures(none) dead_on_return %1)
