...
// CHECK-LABEL: define [1 x i64] @_Z20pass_agg_float_class15agg_float_class(i64 %arg.coerce)

class agg_double_class { double a; };
class agg_double_class pass_agg_double_class(class agg_double_class arg) { return arg; }
// CHECK-LABEL: define [1 x i64] @_Z21pass_agg_double_class16agg_double_class(i64 %arg.coerce)
...
// CHECK-LABEL: define [1 x i64] @_Z18pass_agg_float_cpp13agg_float_cpp(i64 %arg.coerce)
...
// CHECK-LABEL: define [1 x i64] @_Z22pass_agg_nofloat_empty17agg_nofloat_empty(i64 %arg.coerce)
...
// CHECK-LABEL: define [2 x i64] @_Z35pass_complex_like_agg_nofloat_empty30complex_like_agg_nofloat_empty([2 x i64] %{{.*}})
...
// CHECK-LABEL: define [1 x i64] @_Z20pass_agg_float_empty15agg_float_empty(i64 %arg.coerce)
...
// CHECK-LABEL: define [1 x i64] @_Z33pass_complex_like_agg_float_empty28complex_like_agg_float_empty(i64 %{{.*}})
...
// CHECK-LABEL: define [1 x i64] @_Z27pass_agg_nofloat_emptyarray22agg_nofloat_emptyarray(i64 %arg.coerce)
...
// CHECK-LABEL: define [1 x i64] @_Z26pass_agg_nofloat_emptybase21agg_nofloat_emptybase(i64 %arg.coerce)
...
// CHECK-LABEL: define [2 x i64] @_Z26pass_agg_nofloat_emptybase34complex_like_agg_nofloat_emptybase([2 x i64] %{{.*}})
...
// CHECK-LABEL: define [1 x i64] @_Z24pass_agg_float_emptybase19agg_float_emptybase(i64 %arg.coerce)
...
// CHECK-LABEL: define [1 x i64] @_Z31pass_agg_nofloat_emptybasearray26agg_nofloat_emptybasearray(i64 %{{.*}})
