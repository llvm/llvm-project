...
// RUN: %clang -cc1 -triple amdgpu-amd-amdhsa -o - -emit-llvm %s | FileCheck %s -check-prefixes=DEFAULT
// RUN: %clang -cc1 -triple amdgpu-amd-amdhsa -o - -ffp-exception-behavior=ignore -emit-llvm %s | FileCheck %s -check-prefixes=IGNORE
// RUN: %clang -cc1 -triple amdgpu-amd-amdhsa -o - -ffp-exception-behavior=strict -emit-llvm %s | FileCheck %s -check-prefixes=STRICT
// RUN: %clang -cc1 -triple amdgpu-amd-amdhsa -o - -ffp-exception-behavior=maytrap -emit-llvm %s | FileCheck %s -check-prefixes=MAYTRAP
// RUN: %clang -cc1 -triple amdgpu-amd-amdhsa -o - -fmath-errno -emit-llvm %s | FileCheck %s -check-prefixes=ERRNO
