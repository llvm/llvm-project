...
// X86_LINUX: @llvm.compiler.used = appending global [2 x ptr] [ptr @foo7, ptr @foo8], section "llvm.metadata"
...
// X86_64_WIN: @llvm.used = appending global [2 x ptr] [ptr @foo7, ptr @foo8], section "llvm.metadata"
...
// X86_WIN: @llvm.used = appending global [2 x ptr] [ptr @foo7, ptr @foo8], section "llvm.metadata"
