...
// CHECK-DDEFAULT: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
// CHECK-DEBSTRICT: Function Attrs: mustprogress noipa noinline nounwind optnone strictfp{{$$}}
// CHECK-FAST: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
// CHECK-NOHONOR: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
...
#endif
    // CHECK-FAST: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
    // CHECK-DDEFAULT: Function Attrs: mustprogress noipa noinline nounwind optnone strictfp{{$$}}
    // CHECK-DEBSTRICT: Function Attrs: mustprogress noipa noinline nounwind optnone strictfp{{$$}}
    // CHECK-NOHONOR: Function Attrs: mustprogress noipa noinline nounwind optnone strictfp{{$$}}
    float exc_on FUN(2)
...
#pragma float_control(except, off)
// CHECK-DDEFAULT: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
// CHECK-DEBSTRICT: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
// CHECK-FAST: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
// CHECK-NOHONOR: Function Attrs: mustprogress noipa noinline nounwind optnone{{$$}}
class OFF {
  float w = 2 + y() * 7;
