...
// CHECK:         [[P1_ADDR:%.*]] = alloca ptr, align 8, !scope [[META6:![0-9]+]]
// CHECK-NEXT:    [[P2_ADDR:%.*]] = alloca ptr, align 8, !scope [[META8:![0-9]+]]
// CHECK-NEXT:    [[X_ADDR:%.*]] = alloca ptr, align 8, !scope [[META10:![0-9]+]]
//
...
// CHECK:         [[A:%.*]] = alloca ptr, align 8, !scope [[META15:![0-9]+]]
// CHECK-NEXT:    [[B:%.*]] = alloca ptr, align 8, !scope [[META15]]
// CHECK-NEXT:    [[C:%.*]] = alloca ptr, align 8, !scope [[META15]]
// CHECK-NEXT:    [[B_INT:%.*]] = alloca ptr, align 8, !scope [[META17:![0-9]+]]
// CHECK-NEXT:    [[B_FLOAT:%.*]] = alloca ptr, align 8, !scope [[META18:![0-9]+]]
// CHECK-NEXT:    [[I:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[C_DOUBLE:%.*]] = alloca ptr, align 8, !scope [[META19:![0-9]+]]
// CHECK-NEXT:    [[C_LONG:%.*]] = alloca ptr, align 8, !scope [[META20:![0-9]+]]
// CHECK-NEXT:    [[D_SHORT:%.*]] = alloca ptr, align 8, !scope [[META22:![0-9]+]]
// CHECK-NEXT:    [[D_UNSIGNED:%.*]] = alloca ptr, align 8, !scope [[META24:![0-9]+]]
// CHECK-NEXT:    [[E_STRUCT:%.*]] = alloca ptr, align 8, !scope [[META26:![0-9]+]]
//
...
// CHECK: [[META7]] = !{i64 1}
// CHECK: [[META8]] = !{!"test_basic_restrict_1", [[META9:![0-9]+]]}
// CHECK: [[META9]] = !{i64 2}
// CHECK: [[META10]] = !{!"test_basic_restrict_1", [[META11:![0-9]+]]}
// CHECK: [[META11]] = !{i64 3}
// CHECK: [[META15]] = !{!"test_nested_restrict_1", [[META16:![0-9]+]]}
// CHECK: [[META16]] = !{i64 0}
// CHECK: [[META17]] = !{!"test_nested_restrict_10", [[META7]]}
// CHECK: [[META18]] = !{!"test_nested_restrict_10", [[META9]]}
// CHECK: [[META19]] = !{!"test_nested_restrict_101", [[META11]]}
// CHECK: [[META20]] = !{!"test_nested_restrict_101", [[META21:![0-9]+]]}
// CHECK: [[META21]] = !{i64 4}
// CHECK: [[META22]] = !{!"test_nested_restrict_1011", [[META23:![0-9]+]]}
// CHECK: [[META23]] = !{i64 5}
// CHECK: [[META24]] = !{!"test_nested_restrict_1011", [[META25:![0-9]+]]}
// CHECK: [[META25]] = !{i64 6}
// CHECK: [[META26]] = !{!"test_nested_restrict_10111", [[META27:![0-9]+]]}
// CHECK: [[META27]] = !{i64 7}
// CHECK: [[META30]] = !{!"test_assignment_1", [[META7]]}
// CHECK: [[META31]] = !{!"test_assignment_1", [[META9]]}
// CHECK: [[META32]] = !{!"test_assignment_10", [[META16]]}
// CHECK: [[META33]] = !{!"test_assignment_101", [[META11]]}
// CHECK: [[META34]] = !{!"test_assignment_101", [[META21]]}
// CHECK: [[META37]] = !{!"test_mixed_qualifiers_1", [[META7]]}
// CHECK: [[META38]] = !{!"test_mixed_qualifiers_1", [[META9]]}
// CHECK: [[META39]] = !{!"test_mixed_qualifiers_1", [[META11]]}
// CHECK: [[META40]] = !{!"test_mixed_qualifiers_1", [[META21]]}
// CHECK: [[META41]] = !{!"test_mixed_qualifiers_10", [[META23]]}
// CHECK: [[META42]] = !{!"test_mixed_qualifiers_10", [[META25]]}
// CHECK: [[META43]] = !{!"test_aligned_types_1", [[META16]]}
// CHECK: [[META44]] = !{!"test_aligned_types_1", [[META7]]}
// CHECK: [[META45]] = !{!"test_aligned_types_10", [[META9]]}
// CHECK: [[META46]] = !{!"test_loops_10", [[META7]]}
// CHECK: [[META47]] = !{!"test_loops_100", [[META16]]}
// CHECK: [[META48]] = !{!"test_loops_1001", [[META9]]}
// CHECK: [[META49]] = !{!"test_loops_101", [[META11]]}
// CHECK: [[META50]] = !{!"test_loops_1010", [[META16]]}
// CHECK: [[META51]] = !{!"test_loops_1011", [[META21]]}
