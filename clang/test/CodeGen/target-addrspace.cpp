...
// RUN: %clang_cc1 -triple amdgpu-amd-amdhsa -emit-llvm \
...
// AMDGPU-NEXT:    [[P_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5)
// [[P_ADDR]] to ptr AMDGPU-NEXT:    store ptr [[P]], ptr [[P_ADDR_ASCAST]],
// align 8 AMDGPU-NEXT:    ret void
//
void f(void *p) {}
...
// AMDGPU-NEXT:    [[P_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5)
// [[P_ADDR]] to ptr AMDGPU-NEXT:    store ptr [[P]], ptr [[P_ADDR_ASCAST]],
// align 8 AMDGPU-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[P_ADDR_ASCAST]], align
// 8 AMDGPU-NEXT:    call void @_Z1fPv(ptr noundef [[TMP0]]) #[[ATTR1:[0-9]+]]
...
// AMDGPU-NEXT:  [[ENTRY:.*:]]
// AMDGPU-NEXT:    [[P_ADDR:%.*]] = alloca ptr addrspace(3), align 4,
// addrspace(5) AMDGPU-NEXT:    [[P_ADDR_ASCAST:%.*]] = addrspacecast ptr
// addrspace(5) [[P_ADDR]] to ptr AMDGPU-NEXT:    store ptr addrspace(3) [[P]],
// ptr [[P_ADDR_ASCAST]], align 4 AMDGPU-NEXT:    [[TMP0:%.*]] = load ptr
// addrspace(3), ptr [[P_ADDR_ASCAST]], align 4 AMDGPU-NEXT:    [[TMP1:%.*]] =
// addrspacecast ptr addrspace(3) [[TMP0]] to ptr AMDGPU-NEXT:    ret ptr
// [[TMP1]]
//
...
// [[P_ADDR]] to ptr AMDGPU-NEXT:    store ptr [[P]], ptr [[P_ADDR_ASCAST]],
// align 8 AMDGPU-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[P_ADDR_ASCAST]], align
// 8 AMDGPU-NEXT:    call void @_Z3fooIvEvPT_(ptr noundef [[TMP0]]) #[[ATTR1]]
// AMDGPU-NEXT:    ret void
//
...
// NVPTX-NEXT:    store ptr addrspace(3) [[P]], ptr [[P_ADDR]], align 8
// NVPTX-NEXT:    [[TMP0:%.*]] = load ptr addrspace(3), ptr [[P_ADDR]], align 8
// NVPTX-NEXT:    call void @_Z3fooIU3AS3vEvPT_(ptr addrspace(3) noundef
// [[TMP0]]) #[[ATTR1]] NVPTX-NEXT:    ret void
//
...
// addrspace(5) [[P_ADDR]] to ptr AMDGPU-NEXT:    store ptr addrspace(3) [[P]],
// ptr [[P_ADDR_ASCAST]], align 4 AMDGPU-NEXT:    [[TMP0:%.*]] = load ptr
// addrspace(3), ptr [[P_ADDR_ASCAST]], align 4 AMDGPU-NEXT:    call void
// @_Z3fooIU3AS3vEvPT_(ptr addrspace(3) noundef [[TMP0]]) #[[ATTR1]]
// AMDGPU-NEXT:    ret void
//
