...
// RUN: %clang_cc1 -cc1 -triple amdgpu-amd-amdhsa -emit-llvm %s -o - | FileCheck %s
...
//.
// CHECK: attributes #[[ATTR0]] = { convergent mustprogress noinline nounwind optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" "uniform-work-group-size" }
//.
