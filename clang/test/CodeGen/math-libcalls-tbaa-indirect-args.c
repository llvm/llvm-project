...
// CHECK-MINGW32-SAME: ptr dead_on_unwind noalias nofree writable writeonly sret({ x86_fp80, x86_fp80 }) align 16 captures(none) initializes((0, 10), (16, 26)) [[AGG_RESULT:%.*]], ptr nofree noundef readonly align 16 captures(none) dead_on_return dereferenceable(32) [[CLD:%.*]]) local_unnamed_addr #[[ATTR0]] {
