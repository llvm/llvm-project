...
// UTC_ARGS: --check-globals all --version 6 RUN: %clang_cc1 -triple
...
// unreachable AMDGCNSPIRV:       [[BB3:.*:]] AMDGCNSPIRV-NEXT:    br label
...
// memory(inaccessiblemem: write) } AMDGCN-GFX1010: attributes #[[ATTR2]] = {
// noreturn nounwind }
//.
