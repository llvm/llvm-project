...
// CHECK-RV64-LABEL: define dso_local riscv_m1x4 @test_vlsseg4e64_v_f64m1x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m1x4 @llvm.riscv.vlsseg4.riscv_m1x4.i64(riscv_m1x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x4 @test_vlsseg4e64_v_f64m2x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x4 @llvm.riscv.vlsseg4.riscv_m2x4.i64(riscv_m2x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x4 @test_vlsseg4e64_v_i64m1x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m1x4 @llvm.riscv.vlsseg4.riscv_m1x4.i64(riscv_m1x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret riscv_m1x4 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x4 @test_vlsseg4e64_v_i64m2x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x4 @llvm.riscv.vlsseg4.riscv_m2x4.i64(riscv_m2x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret riscv_m2x4 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x4 @test_vlsseg4e64_v_u64m1x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m1x4 @llvm.riscv.vlsseg4.riscv_m1x4.i64(riscv_m1x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret riscv_m1x4 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x4 @test_vlsseg4e64_v_u64m2x4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], i64 noundef [[BSTRIDE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x4 @llvm.riscv.vlsseg4.riscv_m2x4.i64(riscv_m2x4 poison, ptr [[BASE]], i64 [[BSTRIDE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret riscv_m2x4 [[TMP0]]
