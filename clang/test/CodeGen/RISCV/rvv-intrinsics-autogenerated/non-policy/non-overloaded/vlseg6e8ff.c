...
// CHECK-RV64-LABEL: define dso_local riscv_mf8x6 @test_vlseg6e8ff_v_i8mf8x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf8x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf8x6.i64(riscv_mf8x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_mf4x6 @test_vlseg6e8ff_v_i8mf4x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf4x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf4x6.i64(riscv_mf4x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x6 @test_vlseg6e8ff_v_i8mf2x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf2x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf2x6.i64(riscv_mf2x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x6 @test_vlseg6e8ff_v_i8m1x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x6, i64 } @llvm.riscv.vlseg6ff.riscv_m1x6.i64(riscv_m1x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_mf8x6 @test_vlseg6e8ff_v_u8mf8x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf8x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf8x6.i64(riscv_mf8x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_mf8x6, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_mf4x6 @test_vlseg6e8ff_v_u8mf4x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf4x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf4x6.i64(riscv_mf4x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_mf4x6, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x6 @test_vlseg6e8ff_v_u8mf2x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf2x6, i64 } @llvm.riscv.vlseg6ff.riscv_mf2x6.i64(riscv_mf2x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_mf2x6, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x6 @test_vlseg6e8ff_v_u8m1x6
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x6, i64 } @llvm.riscv.vlseg6ff.riscv_m1x6.i64(riscv_m1x6 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x6, i64 } [[TMP0]], 0
