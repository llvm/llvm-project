...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_f64m1x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x5, i64 } @llvm.riscv.vlseg5ff.riscv_m1x5.i64(riscv_m1x5 poison, ptr [[BASE]], i64 [[VL]], i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_i64m1x5
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_u64m1x5
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x5, i64 } @llvm.riscv.vlseg5ff.riscv_m1x5.i64(riscv_m1x5 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x5, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_f64m1x5_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x5, i64 } @llvm.riscv.vlseg5ff.mask.riscv_m1x5.i64.nxv1i1(riscv_m1x5 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x5, i64 } [[TMP0]], 0
// CHECK-RV64-NEXT:    [[TMP2:%.*]] = extractvalue { riscv_m1x5, i64 } [[TMP0]], 1
// CHECK-RV64-NEXT:    store i64 [[TMP2]], ptr [[NEW_VL]], align 8
// CHECK-RV64-NEXT:    ret riscv_m1x5 [[TMP1]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_i64m1x5_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x5, i64 } @llvm.riscv.vlseg5ff.mask.riscv_m1x5.i64.nxv1i1(riscv_m1x5 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x5, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x5 @test_vlseg5e64ff_v_u64m1x5_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x5, i64 } @llvm.riscv.vlseg5ff.mask.riscv_m1x5.i64.nxv1i1(riscv_m1x5 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x5, i64 } [[TMP0]], 0
