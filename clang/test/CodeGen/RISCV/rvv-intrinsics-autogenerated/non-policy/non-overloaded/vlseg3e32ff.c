...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x3 @test_vlseg3e32ff_v_f32mf2x3
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x3 @test_vlseg3e32ff_v_f32m1x3
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x3 @test_vlseg3e32ff_v_f32m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x3 @test_vlseg3e32ff_v_i32mf2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf2x3, i64 } @llvm.riscv.vlseg3ff.riscv_mf2x3.i64(riscv_mf2x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_mf2x3, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x3 @test_vlseg3e32ff_v_i32m1x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x3, i64 } @llvm.riscv.vlseg3ff.riscv_m1x3.i64(riscv_m1x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x3, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x3 @test_vlseg3e32ff_v_i32m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m2x3, i64 } @llvm.riscv.vlseg3ff.riscv_m2x3.i64(riscv_m2x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m2x3, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x3 @test_vlseg3e32ff_v_u32mf2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf2x3, i64 } @llvm.riscv.vlseg3ff.riscv_mf2x3.i64(riscv_mf2x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_mf2x3, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x3 @test_vlseg3e32ff_v_u32m1x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x3, i64 } @llvm.riscv.vlseg3ff.riscv_m1x3.i64(riscv_m1x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x3, i64 } [[TMP0]], 0
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x3 @test_vlseg3e32ff_v_u32m2x3
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m2x3, i64 } @llvm.riscv.vlseg3ff.riscv_m2x3.i64(riscv_m2x3 poison, ptr [[BASE]], i64 [[VL]], i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m2x3, i64 } [[TMP0]], 0
