...
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], riscv_m1x5 [[V_TUPLE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    call void @llvm.riscv.vsseg5.riscv_m1x5.i64(riscv_m1x5 [[V_TUPLE]], ptr [[BASE]], i64 [[VL]], i64 6)
...
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], riscv_m1x5 [[V_TUPLE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    call void @llvm.riscv.vsseg5.riscv_m1x5.i64(riscv_m1x5 [[V_TUPLE]], ptr [[BASE]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret void
//
...
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], riscv_m1x5 [[V_TUPLE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    call void @llvm.riscv.vsseg5.mask.riscv_m1x5.nxv1i1.i64(riscv_m1x5 [[V_TUPLE]], ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 6)
// CHECK-RV64-NEXT:    ret void
//
