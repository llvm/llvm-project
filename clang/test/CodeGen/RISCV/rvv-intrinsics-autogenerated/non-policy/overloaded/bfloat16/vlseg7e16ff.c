...
// CHECK-RV64-LABEL: define dso_local riscv_mf4x7 @test_vlseg7e16ff_v_bf16mf4x7_m(
// CHECK-RV64-SAME: <vscale x 1 x i1> [[VM:%.*]], ptr noundef [[RS1:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf4x7, i64 } @llvm.riscv.vlseg7ff.mask.riscv_mf4x7.i64.nxv1i1(riscv_mf4x7 poison, ptr [[RS1]], <vscale x 1 x i1> [[VM]], i64 [[VL]], i64 3, i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_mf2x7 @test_vlseg7e16ff_v_bf16mf2x7_m(
// CHECK-RV64-SAME: <vscale x 2 x i1> [[VM:%.*]], ptr noundef [[RS1:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_mf2x7, i64 } @llvm.riscv.vlseg7ff.mask.riscv_mf2x7.i64.nxv2i1(riscv_mf2x7 poison, ptr [[RS1]], <vscale x 2 x i1> [[VM]], i64 [[VL]], i64 3, i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x7 @test_vlseg7e16ff_v_bf16m1x7_m(
// CHECK-RV64-SAME: <vscale x 4 x i1> [[VM:%.*]], ptr noundef [[RS1:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x7, i64 } @llvm.riscv.vlseg7ff.mask.riscv_m1x7.i64.nxv4i1(riscv_m1x7 poison, ptr [[RS1]], <vscale x 4 x i1> [[VM]], i64 [[VL]], i64 3, i64 0)
