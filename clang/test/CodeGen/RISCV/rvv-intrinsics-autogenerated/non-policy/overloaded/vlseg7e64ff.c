...
// CHECK-RV64-LABEL: define dso_local riscv_m1x7 @test_vlseg7e64ff_v_f64m1x7_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x7, i64 } @llvm.riscv.vlseg7ff.mask.riscv_m1x7.i64.nxv1i1(riscv_m1x7 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 0)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x7 @test_vlseg7e64ff_v_i64m1x7_m
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x7 @test_vlseg7e64ff_v_u64m1x7_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { riscv_m1x7, i64 } @llvm.riscv.vlseg7ff.mask.riscv_m1x7.i64.nxv1i1(riscv_m1x7 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 0)
// CHECK-RV64-NEXT:    [[TMP1:%.*]] = extractvalue { riscv_m1x7, i64 } [[TMP0]], 0
