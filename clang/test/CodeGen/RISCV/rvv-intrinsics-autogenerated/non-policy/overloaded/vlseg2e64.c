...
// CHECK-RV64-LABEL: define dso_local riscv_m1x2 @test_vlseg2e64_v_f64m1x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m1x2 @llvm.riscv.vlseg2.mask.riscv_m1x2.nxv1i1.i64(riscv_m1x2 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m1x2 [[TMP0]]
//
vfloat64m1x2_t test_vlseg2e64_v_f64m1x2_m(vbool64_t mask, const double *base, size_t vl) {
  return __riscv_vlseg2e64(mask, base, vl);
}

// CHECK-RV64-LABEL: define dso_local riscv_m2x2 @test_vlseg2e64_v_f64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x2 @llvm.riscv.vlseg2.mask.riscv_m2x2.nxv2i1.i64(riscv_m2x2 poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
...
// CHECK-RV64-LABEL: define dso_local riscv_m4x2 @test_vlseg2e64_v_f64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m4x2 @llvm.riscv.vlseg2.mask.riscv_m4x2.nxv4i1.i64(riscv_m4x2 poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x2 @test_vlseg2e64_v_i64m1x2_m
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x2 @test_vlseg2e64_v_i64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x2 @llvm.riscv.vlseg2.mask.riscv_m2x2.nxv2i1.i64(riscv_m2x2 poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m2x2 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m4x2 @test_vlseg2e64_v_i64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m4x2 @llvm.riscv.vlseg2.mask.riscv_m4x2.nxv4i1.i64(riscv_m4x2 poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m4x2 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m1x2 @test_vlseg2e64_v_u64m1x2_m
// CHECK-RV64-SAME: (<vscale x 1 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m1x2 @llvm.riscv.vlseg2.mask.riscv_m1x2.nxv1i1.i64(riscv_m1x2 poison, ptr [[BASE]], <vscale x 1 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m1x2 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m2x2 @test_vlseg2e64_v_u64m2x2_m
// CHECK-RV64-SAME: (<vscale x 2 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m2x2 @llvm.riscv.vlseg2.mask.riscv_m2x2.nxv2i1.i64(riscv_m2x2 poison, ptr [[BASE]], <vscale x 2 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m2x2 [[TMP0]]
...
// CHECK-RV64-LABEL: define dso_local riscv_m4x2 @test_vlseg2e64_v_u64m4x2_m
// CHECK-RV64-SAME: (<vscale x 4 x i1> [[MASK:%.*]], ptr noundef [[BASE:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call riscv_m4x2 @llvm.riscv.vlseg2.mask.riscv_m4x2.nxv4i1.i64(riscv_m4x2 poison, ptr [[BASE]], <vscale x 4 x i1> [[MASK]], i64 [[VL]], i64 3, i64 6)
// CHECK-RV64-NEXT:    ret riscv_m4x2 [[TMP0]]
