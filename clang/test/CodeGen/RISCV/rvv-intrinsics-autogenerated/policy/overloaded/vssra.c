...
vint8mf8_t test_vssra_vv_i8mf8_tuma(vbool64_t mask, vint8mf8_t maskedoff, vint8mf8_t op1, vuint8mf8_t shift, size_t vl) {
  return vssra_tuma(mask, maskedoff, op1, shift, vl);
}
...
vint8mf8_t test_vssra_vv_i8mf8_tama(vbool64_t mask, vint8mf8_t op1, vuint8mf8_t shift, size_t vl) {
  return vssra_tama(mask, op1, shift, vl);
}
...
vint8mf8_t test_vssra_vv_i8mf8_tamu(vbool64_t mask, vint8mf8_t maskedoff, vint8mf8_t op1, vuint8mf8_t shift, size_t vl) {
  return vssra_tamu(mask, maskedoff, op1, shift, vl);
}
