...
// CHECK-RV64-LABEL: @test_vmfle_vv_f16mf4_b64_ma(
...
//
vbool64_t test_vmfle_vv_f16mf4_b64_ma(vbool64_t mask, vfloat16mf4_t op1, vfloat16mf4_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16mf4_b64_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i1> [[TMP0]]
//
vbool64_t test_vmfle_vf_f16mf4_b64_ma(vbool64_t mask, vfloat16mf4_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16mf2_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool32_t test_vmfle_vv_f16mf2_b32_ma(vbool32_t mask, vfloat16mf2_t op1, vfloat16mf2_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16mf2_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i1> [[TMP0]]
//
vbool32_t test_vmfle_vf_f16mf2_b32_ma(vbool32_t mask, vfloat16mf2_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16m1_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool16_t test_vmfle_vv_f16m1_b16_ma(vbool16_t mask, vfloat16m1_t op1, vfloat16m1_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16m1_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i1> [[TMP0]]
//
vbool16_t test_vmfle_vf_f16m1_b16_ma(vbool16_t mask, vfloat16m1_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16m2_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool8_t test_vmfle_vv_f16m2_b8_ma(vbool8_t mask, vfloat16m2_t op1, vfloat16m2_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16m2_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i1> [[TMP0]]
//
vbool8_t test_vmfle_vf_f16m2_b8_ma(vbool8_t mask, vfloat16m2_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16m4_b4_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool4_t test_vmfle_vv_f16m4_b4_ma(vbool4_t mask, vfloat16m4_t op1, vfloat16m4_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16m4_b4_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i1> [[TMP0]]
//
vbool4_t test_vmfle_vf_f16m4_b4_ma(vbool4_t mask, vfloat16m4_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16m8_b2_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool2_t test_vmfle_vv_f16m8_b2_ma(vbool2_t mask, vfloat16m8_t op1, vfloat16m8_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f16m8_b2_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i1> [[TMP0]]
//
vbool2_t test_vmfle_vf_f16m8_b2_ma(vbool2_t mask, vfloat16m8_t op1, _Float16 op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}
...
// CHECK-RV64-LABEL: @test_vmfle_vv_f32m1_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i1> [[TMP0]]
//
vbool32_t test_vmfle_vv_f32m1_b32_ma(vbool32_t mask, vfloat32m1_t op1, vfloat32m1_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f32m1_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i1> [[TMP0]]
//
vbool32_t test_vmfle_vf_f32m1_b32_ma(vbool32_t mask, vfloat32m1_t op1, float op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f32m2_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i1> [[TMP0]]
//
vbool16_t test_vmfle_vv_f32m2_b16_ma(vbool16_t mask, vfloat32m2_t op1, vfloat32m2_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f32m2_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i1> [[TMP0]]
//
vbool16_t test_vmfle_vf_f32m2_b16_ma(vbool16_t mask, vfloat32m2_t op1, float op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f32m4_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i1> [[TMP0]]
//
vbool8_t test_vmfle_vv_f32m4_b8_ma(vbool8_t mask, vfloat32m4_t op1, vfloat32m4_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f32m4_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i1> [[TMP0]]
//
vbool8_t test_vmfle_vf_f32m4_b8_ma(vbool8_t mask, vfloat32m4_t op1, float op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f32m8_b4_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i1> [[TMP0]]
//
vbool4_t test_vmfle_vv_f32m8_b4_ma(vbool4_t mask, vfloat32m8_t op1, vfloat32m8_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f32m8_b4_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i1> [[TMP0]]
//
vbool4_t test_vmfle_vf_f32m8_b4_ma(vbool4_t mask, vfloat32m8_t op1, float op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f64m1_b64_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i1> [[TMP0]]
//
vbool64_t test_vmfle_vv_f64m1_b64_ma(vbool64_t mask, vfloat64m1_t op1, vfloat64m1_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f64m1_b64_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i1> [[TMP0]]
//
vbool64_t test_vmfle_vf_f64m1_b64_ma(vbool64_t mask, vfloat64m1_t op1, double op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f64m2_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i1> [[TMP0]]
//
vbool32_t test_vmfle_vv_f64m2_b32_ma(vbool32_t mask, vfloat64m2_t op1, vfloat64m2_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f64m2_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i1> [[TMP0]]
//
vbool32_t test_vmfle_vf_f64m2_b32_ma(vbool32_t mask, vfloat64m2_t op1, double op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f64m4_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i1> [[TMP0]]
//
vbool16_t test_vmfle_vv_f64m4_b16_ma(vbool16_t mask, vfloat64m4_t op1, vfloat64m4_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f64m4_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i1> [[TMP0]]
//
vbool16_t test_vmfle_vf_f64m4_b16_ma(vbool16_t mask, vfloat64m4_t op1, double op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f64m8_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i1> [[TMP0]]
//
vbool8_t test_vmfle_vv_f64m8_b8_ma(vbool8_t mask, vfloat64m8_t op1, vfloat64m8_t op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vf_f64m8_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i1> [[TMP0]]
//
vbool8_t test_vmfle_vf_f64m8_b8_ma(vbool8_t mask, vfloat64m8_t op1, double op2, size_t vl) {
  return vmfle_ma(mask, op1, op2, vl);
}

// CHECK-RV64-LABEL: @test_vmfle_vv_f16mf4_b64_mu(
// CHECK-RV64-NEXT:  entry:
