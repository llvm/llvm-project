...
// CHECK-RV64-LABEL: @test_vmsif_m_b1_ma(
...
//
vbool1_t test_vmsif_m_b1_ma(vbool1_t mask, vbool1_t op1, size_t vl) {
  return vmsif_m_b1_ma(mask, op1, vl);
}

// CHECK-RV64-LABEL: @test_vmsif_m_b2_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool2_t test_vmsif_m_b2_ma(vbool2_t mask, vbool2_t op1, size_t vl) {
...
// CHECK-RV64-LABEL: @test_vmsif_m_b8_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool8_t test_vmsif_m_b8_ma(vbool8_t mask, vbool8_t op1, size_t vl) {
  return vmsif_m_b8_ma(mask, op1, vl);
}

// CHECK-RV64-LABEL: @test_vmsif_m_b16_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool16_t test_vmsif_m_b16_ma(vbool16_t mask, vbool16_t op1, size_t vl) {
  return vmsif_m_b16_ma(mask, op1, vl);
}

// CHECK-RV64-LABEL: @test_vmsif_m_b32_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool32_t test_vmsif_m_b32_ma(vbool32_t mask, vbool32_t op1, size_t vl) {
  return vmsif_m_b32_ma(mask, op1, vl);
}

// CHECK-RV64-LABEL: @test_vmsif_m_b64_ma(
// CHECK-RV64-NEXT:  entry:
...
//
vbool64_t test_vmsif_m_b64_ma(vbool64_t mask, vbool64_t op1, size_t vl) {
