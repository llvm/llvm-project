...
// CHECK-LLVM: define dso_local riscv_vls_cc(128) void @test_too_large(ptr nofree noundef align 256 dead_on_return dereferenceable(256) %0)
...
// CHECK-LLVM: define dso_local riscv_vls_cc(128) void @test_st_i32x64x2(ptr nofree noundef align 256 dead_on_return dereferenceable(512) %arg)
void __attribute__((riscv_vls_cc)) test_st_i32x64x2(struct st_i32x64x2 arg) {}
// CHECK-LLVM: define dso_local riscv_vls_cc(256) void @test_st_i32x64x2_256(ptr nofree noundef align 256 dead_on_return dereferenceable(512) %arg)
...
// CHECK-LLVM: define dso_local riscv_vls_cc(128) void @test_st_i32x4x9(ptr nofree noundef align 16 dead_on_return dereferenceable(144) %arg)
void __attribute__((riscv_vls_cc)) test_st_i32x4x9(struct st_i32x4x9 arg) {}
// CHECK-LLVM: define dso_local riscv_vls_cc(256) void @test_st_i32x4x9_256(ptr nofree noundef align 16 dead_on_return dereferenceable(144) %arg)
