...
// CHECK-NEXT:    [[CALL:%.*]] = call i32 (i32, ...) @f_va_callee(i32 noundef 1, i32 noundef 2, i64 noundef 3, double noundef 4.000000e+00, double noundef 5.000000e+00, i32 [[TMP0]], [2 x i32] [[TMP1]], i64 [[TMP2]], ptr nofree noundef align 4 dead_on_return dereferenceable(16) [[BYVAL_TEMP]])
// CHECK-NEXT:    ret void
//
