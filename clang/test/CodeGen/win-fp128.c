...
// CHECK-GNU64: define dso_local void @fp128_args(ptr dead_on_unwind noalias writable sret(fp128) align 16 %agg.result, ptr nofree noundef align 16 dead_on_return dereferenceable(16) %0, ptr nofree noundef align 16 dead_on_return dereferenceable(16) %1)
