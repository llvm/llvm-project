...
svuint8_t test_svqshrunt_n_s16(svuint8_t op, svint16_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqshrunt'}}
  // expected-warning@+1 {{implicit declaration of function 'svqshrunt_n_s16'}}
...
svuint16_t test_svqshrunt_n_s32(svuint16_t op, svint32_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqshrunt'}}
  // expected-warning@+1 {{implicit declaration of function 'svqshrunt_n_s32'}}
...
svuint32_t test_svqshrunt_n_s64(svuint32_t op, svint64_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqshrunt'}}
  // expected-warning@+1 {{implicit declaration of function 'svqshrunt_n_s64'}}
