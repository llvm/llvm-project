...
svint8_t test_svsubhnb_s16(svint16_t op1, svint16_t op2)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_s16'}}
...
svint16_t test_svsubhnb_s32(svint32_t op1, svint32_t op2)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_s32'}}
...
svint32_t test_svsubhnb_s64(svint64_t op1, svint64_t op2)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_s64'}}
...
svuint8_t test_svsubhnb_u16(svuint16_t op1, svuint16_t op2)
{
  ...
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_u16'}}
...
svuint16_t test_svsubhnb_u32(svuint32_t op1, svuint32_t op2)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_u32'}}
...
svuint32_t test_svsubhnb_u64(svuint64_t op1, svuint64_t op2)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_u64'}}
...
svint8_t test_svsubhnb_n_s16(svint16_t op1, int16_t op2)
{
  ...
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_s16'}}
...
svint16_t test_svsubhnb_n_s32(svint32_t op1, int32_t op2)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_s32'}}
...
svint32_t test_svsubhnb_n_s64(svint64_t op1, int64_t op2)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_s64'}}
...
svuint8_t test_svsubhnb_n_u16(svuint16_t op1, uint16_t op2)
{
  ...
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_u16'}}
...
svuint16_t test_svsubhnb_n_u32(svuint32_t op1, uint32_t op2)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_u32'}}
...
svuint32_t test_svsubhnb_n_u64(svuint64_t op1, uint64_t op2)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubhnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubhnb_n_u64'}}
