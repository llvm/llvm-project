...
svint16_t test_svsubltb_s16(svint8_t op1, svint8_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 8 x i16> @llvm.aarch64.sve.ssubltb.nxv8i16(<vscale x 16 x i8> %op1, <vscale x 16 x i8> %op2)
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_s16'}}
...
svint32_t test_svsubltb_s32(svint16_t op1, svint16_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 4 x i32> @llvm.aarch64.sve.ssubltb.nxv4i32(<vscale x 8 x i16> %op1, <vscale x 8 x i16> %op2)
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_s32'}}
...
svint64_t test_svsubltb_s64(svint32_t op1, svint32_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 2 x i64> @llvm.aarch64.sve.ssubltb.nxv2i64(<vscale x 4 x i32> %op1, <vscale x 4 x i32> %op2)
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_s64'}}
...
svint16_t test_svsubltb_n_s16(svint8_t op1, int8_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 8 x i16> @llvm.aarch64.sve.ssubltb.nxv8i16(<vscale x 16 x i8> %op1, <vscale x 16 x i8> %[[DUP]])
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_n_s16'}}
...
svint32_t test_svsubltb_n_s32(svint16_t op1, int16_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 4 x i32> @llvm.aarch64.sve.ssubltb.nxv4i32(<vscale x 8 x i16> %op1, <vscale x 8 x i16> %[[DUP]])
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_n_s32'}}
...
svint64_t test_svsubltb_n_s64(svint32_t op1, int32_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 2 x i64> @llvm.aarch64.sve.ssubltb.nxv2i64(<vscale x 4 x i32> %op1, <vscale x 4 x i32> %[[DUP]])
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsubltb'}}
  // expected-warning@+1 {{implicit declaration of function 'svsubltb_n_s64'}}
