...
svint8_t test_svqrshrnb_n_s16(svint16_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_s16'}}
...
svint16_t test_svqrshrnb_n_s32(svint32_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_s32'}}
...
svint32_t test_svqrshrnb_n_s64(svint64_t op1)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_s64'}}
...
svuint8_t test_svqrshrnb_n_u16(svuint16_t op1)
{
  ...
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_u16'}}
...
svuint16_t test_svqrshrnb_n_u32(svuint32_t op1)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_u32'}}
...
svuint32_t test_svqrshrnb_n_u64(svuint64_t op1)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svqrshrnb'}}
  // expected-warning@+1 {{implicit declaration of function 'svqrshrnb_n_u64'}}
