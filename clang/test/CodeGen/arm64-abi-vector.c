...
// CHECK: test_19c
// CHECK: call double (i32, ...) @varargs_vec_19c(i32 noundef 19, ptr noundef align 16 dead_on_return {{%.*}})
...
// CHECK: test_5i
// CHECK: call double (i32, ...) @varargs_vec_5i(i32 noundef 5, ptr noundef align 16 dead_on_return {{%.*}})
...
// CHECK: test_3d
// CHECK: call double (i32, ...) @varargs_vec_3d(i32 noundef 3, ptr noundef align 16 dead_on_return {{%.*}})
...
// CHECK: call double (i32, ...) @varargs_vec(i32 noundef 3, i32 {{%.*}}, <2 x i32> {{%.*}}, <4 x i32> {{%.*}}, ptr noundef align 16 dead_on_return {{%.*}}, <2 x i32> {{%.*}}, <4 x i32> {{%.*}}, <4 x i32> {{%.*}}, ptr noundef align 16 dead_on_return {{%.*}}, ptr noundef align 16 dead_on_return {{%.*}})
  return ret;
}
...
// CHECK: fixed_19c
// CHECK: call double @args_vec_19c(i32 noundef 19, ptr noundef align 16 dead_on_return {{%.*}})
...
// CHECK: fixed_5i
// CHECK: call double @args_vec_5i(i32 noundef 5, ptr noundef align 16 dead_on_return {{%.*}})
...
// CHECK: fixed_3d
// CHECK: call double @args_vec_3d(i32 noundef 3, ptr noundef align 16 dead_on_return {{%.*}})
