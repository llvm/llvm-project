...
// ALLOW-SAME: () local_unnamed_addr #[[ATTR0:[0-9]+]] !pcsections !{{[0-9]+}} {
// ALLOW-NEXT:  entry:
// ALLOW-NEXT:    [[TMP0:%.*]] = atomicrmw add ptr @y, i32 1 monotonic, align 4, !pcsections !{{[0-9]+}}
// ALLOW-NEXT:    ret void
//
...
// ALLOW-SAME: () local_unnamed_addr #[[ATTR0]] !pcsections !{{[0-9]+}} {
// ALLOW-NEXT:  entry:
// ALLOW-NEXT:    [[TMP0:%.*]] = atomicrmw add ptr @y, i32 2 monotonic, align 4, !pcsections !{{[0-9]+}}
// ALLOW-NEXT:    ret void
//
// FUN-LABEL: define {{[^@]+}}@bar
// FUN-SAME: () local_unnamed_addr #[[ATTR0]] !pcsections !{{[0-9]+}} {
// FUN-NEXT:  entry:
// FUN-NEXT:    [[TMP0:%.*]] = atomicrmw add ptr @y, i32 2 monotonic, align 4, !pcsections !{{[0-9]+}}
// FUN-NEXT:    ret void
//
