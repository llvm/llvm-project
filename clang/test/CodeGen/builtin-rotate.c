...
// CHECK-DAG: call i9 @llvm.fshl.i9
// CHECK-DAG: call i9 @llvm.fshr.i9
void test_wider_shift_amount(unsigned char uc, unsigned short us, unsigned int ui, unsigned _BitInt(9) val9) {
  volatile unsigned char result_uc;
  volatile unsigned short result_us;
  volatile unsigned int result_ui;
  volatile unsigned _BitInt(9) result_9;

  result_uc = __builtin_stdc_rotate_left(uc, (long long)-1);
  result_uc = __builtin_stdc_rotate_right(uc, (long long)-1000);

  result_us = __builtin_stdc_rotate_left(us, (long long)-5);
  result_us = __builtin_stdc_rotate_right(us, (long long)-100);

  result_ui = __builtin_stdc_rotate_left(ui, (long long)-2147483648);
  result_ui = __builtin_stdc_rotate_right(ui, (long long)-1073741824);

  result_9 = __builtin_stdc_rotate_left(val9, (long long)-1);
  result_9 = __builtin_stdc_rotate_right(val9, (long long)-1000000);

  result_uc = __builtin_stdc_rotate_left((unsigned char)0xFF, (long long)-2147483648);
  result_us = __builtin_stdc_rotate_right((unsigned short)0x1234, (long long)-1073741824);
  result_ui = __builtin_stdc_rotate_left(0x12345678U, (long long)-4294967296);

  result_9 = __builtin_stdc_rotate_left((unsigned _BitInt(9))0x1FF, (long long)-2147483647);
}
