...
// CHECK-NEXT:    call void (i64, ...) @f(i64 [[TMP0]], ptr nofreeobj noundef align 1 dead_on_return dereferenceable(6) [[BYVAL_TEMP]], ptr nofreeobj noundef align 4 dead_on_return dereferenceable(16) [[BYVAL_TEMP4]])
// CHECK-NEXT:    ret void
//
