...
#if defined(__cplusplus) && (__cplusplus >= 201103L)
TEST_CONSTEXPR(__blcic_u32(0x89ABCDEF) == ((~0x89ABCDEF) & (0x89ABCDEF + 1)));
#endif
...
#if defined(__cplusplus) && (__cplusplus >= 201103L)
TEST_CONSTEXPR(__blcic_u64(0xFEDCBA9876543210ULL) == ((~0xFEDCBA9876543210ULL) & (0xFEDCBA9876543210ULL + 1)));
#endif
#endif
