...
// CHECK-LABEL: define dso_local void @receive_vec_128(<4 x float> inreg noundef %x, <4 x float> inreg noundef %y, <4 x float> inreg noundef %z, ptr noundef align 16 dead_on_return %0, ptr noundef align 16 dead_on_return %1)
// CHECK-LABEL: define dso_local void @receive_vec_256(<8 x float> inreg noundef %x, <8 x float> inreg noundef %y, <8 x float> inreg noundef %z, ptr noundef align 32 dead_on_return %0, ptr noundef align 32 dead_on_return %1)
// CHECK-LABEL: define dso_local void @receive_vec_512(<16 x float> inreg noundef %x, <16 x float> inreg noundef %y, <16 x float> inreg noundef %z, ptr noundef align 64 dead_on_return %0, ptr noundef align 64 dead_on_return %1)
// CHECK-LABEL: define dso_local void @receive_vec_1024(ptr noundef align 128 dead_on_return %0, ptr noundef align 128 dead_on_return %1, ptr noundef align 128 dead_on_return %2, ptr noundef align 128 dead_on_return %3, ptr noundef align 128 dead_on_return %4)
...
// CHECK: call void @receive_vec_128(<4 x float> inreg noundef %{{[^,)]*}}, <4 x float> inreg noundef %{{[^,)]*}}, <4 x float> inreg noundef %{{[^,)]*}}, ptr noundef align 16 dead_on_return %{{[^,)]*}}, ptr noundef align 16 dead_on_return %{{[^,)]*}})


void __fastcall fastcall_indirect_vec(__m128 x, __m128 y, __m128 z, __m128 w, int edx, __m128 q) {
  gv128 = x + y + z + w + q;
}
// CHECK-LABEL: define dso_local x86_fastcallcc void @"\01@fastcall_indirect_vec@84"(<4 x float> inreg noundef %x, <4 x float> inreg noundef %y, <4 x float> inreg noundef %z, ptr inreg noundef align 16 dead_on_return %0, i32 inreg noundef %edx, ptr noundef align 16 dead_on_return %1)
...
// CHECK: call void (ptr, ...) @receive_fixed_align_variadic(ptr noundef align 8 dead_on_return %{{[^)]*}}, i32 noundef 42)
