...
#if defined(__cplusplus) && (__cplusplus >= 201103L)
constexpr unsigned long long test_mulx_u32(unsigned int X, unsigned int Y) {
  unsigned int H{};
...
#if defined(__cplusplus) && (__cplusplus >= 201103L)
constexpr unsigned __int128 test_mulx_u64(unsigned long long X, unsigned long long Y) {
