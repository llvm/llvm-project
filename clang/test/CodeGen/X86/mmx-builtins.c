...
TEST_CONSTEXPR(
match_v8qi(
    _mm_alignr_pi8(((__m64)(__v8qs){1, 2, 3, 4, 5, 6, 7, 8}), ((__m64)(__v8qs){9, 10, 11, 12, 13, 14, 15, 16}), 1),
    10, 11, 12, 13, 14, 15, 16, 1
  )
);
TEST_CONSTEXPR(
match_v8qi(
    _mm_alignr_pi8(((__m64)(__v8qs){1, 2, 3, 4, 5, 6, 7, 8}), ((__m64)(__v8qs){9, 10, 11, 12, 13, 14, 15, 16}), 16),
    0, 0, 0, 0, 0, 0, 0, 0
  )
);
