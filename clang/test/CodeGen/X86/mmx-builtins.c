...
TEST_CONSTEXPR(match_v8qu(_mm_avg_pu8((__m64)(__v8qu){0, 1, 2, 3, 180, 150, 120, 200}, (__m64)(__v8qu){0, 1, 2, 3, 160, 30, 200, 10}), 0, 1, 2, 3, 170, 90, 160, 105));
...
TEST_CONSTEXPR(match_v4hu(_mm_avg_pu16((__m64)(__v4hu){0, 1, 2, 3}, (__m64)(__v4u){0, 1, 2, 3}), 0, 1, 2, 3));
