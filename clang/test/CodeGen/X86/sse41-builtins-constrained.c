...
__m128d test_mm_round_pd2(__m128d x) {
  // CHECK-LABEL: test_mm_round_pd2
...
__m128 test_mm_round_ps1(__m128 x) {
  // CHECK-LABEL: test_mm_round_ps1
...
__m128 test_mm_round_ps2(__m128 x) {
  // CHECK-LABEL: test_mm_round_ps2
  // CHECK: %{{.*}} = call <4 x float> @llvm.experimental.constrained.floor.v4f32(<4 x float> %{{.*}}, metadata !"fpexcept.ignore")
  return _mm_round_ps(x, 1);
}

__m128d test_mm_round_sd1(__m128d x, __m128d y) {
  // CHECK-LABEL: test_mm_round_sd1
...
__m128d test_mm_round_sd2(__m128d x, __m128d y) {
  // CHECK-LABEL: test_mm_round_sd2
  // CHECK: %[[A:.*]] = extractelement <2 x double> %{{.*}}, i32 0
...
__m128 test_mm_round_ss1(__m128 x, __m128 y) {
  // CHECK-LABEL: test_mm_round_ss1
...
__m128 test_mm_round_ss2(__m128 x, __m128 y) {
  // CHECK-LABEL: test_mm_round_ss2
  // CHECK: %[[A:.*]] = extractelement <4 x float> %{{.*}}, i32 0
