...
// CHECK-O0-NEXT: call void @pass_large(ptr noundef align 8 dead_on_return %[[byvaltemp]])
...
// CHECK-O0-NEXT: call void @pass_large(ptr noundef align 8 dead_on_return %[[byvaltemp1]])
...
// Finally, call using a pointer to the temporary stack space.
// CHECK-O3-NEXT: call void @pass_large(ptr noundef align 8 dead_on_return %[[byvaltemp]])
//
...
// CHECK-O3-NEXT: call void @pass_large(ptr noundef align 8 dead_on_return %[[byvaltemp1]])
...
// CHECK-O0-NEXT:    call void @pass_large_BitInt(ptr noundef align 16 dead_on_return [[INDIRECT_ARG_TEMP]])
...
// CHECK-O3-NEXT:    call void @pass_large_BitInt(ptr noundef align 16 dead_on_return [[INDIRECT_ARG_TEMP]])
