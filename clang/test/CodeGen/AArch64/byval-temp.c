...
// CHECK-O0-NEXT: call void @pass_large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(64) %[[byvaltemp]])
...
// CHECK-O0-NEXT: call void @pass_large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(64) %[[byvaltemp1]])
...
// Finally, call using a pointer to the temporary stack space.
// CHECK-O3-NEXT: call void @pass_large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(64) %[[byvaltemp]])
//
...
// CHECK-O3-NEXT: call void @pass_large(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(64) %[[byvaltemp1]])
...
// CHECK-O0-NEXT:    call void @pass_large_BitInt(ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[INDIRECT_ARG_TEMP]])
...
// CHECK-O0-NEXT:    call void @pass_large_BitInt(ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[INDIRECT_ARG_TEMP1]])
// CHECK-O0-NEXT:    ret void
//
...
// CHECK-O3-NEXT:    call void @pass_large_BitInt(ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[INDIRECT_ARG_TEMP]])
...
// CHECK-O3-NEXT:    call void @pass_large_BitInt(ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[INDIRECT_ARG_TEMP1]])
