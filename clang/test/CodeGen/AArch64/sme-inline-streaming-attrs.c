...
void caller_compatible(void) __arm_streaming_compatible {
    inlined_fn(); // expected-warning {{always_inline function 'inlined_fn' and its caller 'caller_compatible' have mismatching streaming attributes, 'inlined_fn' may not be inlined}}
    inlined_fn_streaming_compatible();
...
void caller_streaming(void) __arm_streaming {
    inlined_fn(); // expected-warning {{always_inline function 'inlined_fn' and its caller 'caller_streaming' have mismatching streaming attributes, 'inlined_fn' may not be inlined}}
    inlined_fn_streaming_compatible();
...
void caller_local(void) {
    inlined_fn(); // expected-warning {{always_inline function 'inlined_fn' and its caller 'caller_local' have mismatching streaming attributes, 'inlined_fn' may not be inlined}}
    inlined_fn_streaming_compatible();
    inlined_fn_streaming();
    inlined_fn_local();
}
