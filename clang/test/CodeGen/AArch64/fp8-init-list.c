...
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    store <1 x i8> [[X]], ptr @s, align 1, !tbaa [[__MFP8_TBAA5:![0-9]+]]
// CHECK-NEXT:    ret void
//
// CHECK-CXX-LABEL: define dso_local void @_Z1fu6__mfp8(
// CHECK-CXX-SAME: <1 x i8> [[X:%.*]]) local_unnamed_addr #[[ATTR1:[0-9]+]] {
// CHECK-CXX-NEXT:  [[ENTRY:.*:]]
// CHECK-CXX-NEXT:    store <1 x i8> [[X]], ptr @s, align 1, !tbaa [[__MFP8_TBAA5:![0-9]+]]
...
// CHECK: [[__MFP8_TBAA5]] = !{[[META6:![0-9]+]], [[META7:![0-9]+]], i64 0}
// CHECK: [[META6]] = !{!"S", [[META7]], i64 0}
// CHECK: [[META7]] = !{!"__mfp8", [[META3]], i64 0}
//.
// CHECK-CXX: [[META3:![0-9]+]] = !{!"omnipotent char", [[META4:![0-9]+]], i64 0}
// CHECK-CXX: [[META4]] = !{!"Simple C++ TBAA"}
// CHECK-CXX: [[__MFP8_TBAA5]] = !{[[META6:![0-9]+]], [[META7:![0-9]+]], i64 0}
// CHECK-CXX: [[META6]] = !{!"_ZTS1S", [[META7]], i64 0}
// CHECK-CXX: [[META7]] = !{!"__mfp8", [[META3]], i64 0}
//.
