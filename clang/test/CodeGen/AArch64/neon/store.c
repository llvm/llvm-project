...
// --check-prefixes=ALL,LLVM RUN: %if cir-enabled %{%clang_cc1_cg_arm64_neon
// -fclangir -emit-llvm %s -disable-O0-optnone | opt -S
// -passes=mem2reg,sroa,instcombine | FileCheck %s --check-prefixes=ALL,LLVM %}
...
void test_vst1_lane_f16(float16_t *a, float16x4_t b) {
  ...
  // !cir.f16> CIR: cir.store align(2) {{.*}}, {{.*}} : !cir.f16,
  // !cir.ptr<!cir.f16>
...
void test_vst1_lane_f32(float32_t *a, float32x2_t b) {
  ...
  // !cir.float> CIR: cir.store align(4) {{.*}}, {{.*}} : !cir.float,
  // !cir.ptr<!cir.float>
...
void test_vst1_lane_f64(float64_t *a, float64x1_t b) {
  ...
  // !cir.double> CIR: cir.store align(8) {{.*}}, {{.*}} : !cir.double,
  // !cir.ptr<!cir.double>
...
void test_vst1_lane_mf8(mfloat8_t *a, mfloat8x8_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<8 x
  // !u8i> CIR: cir.store align(1) {{.*}}, {{.*}} : !u8i, !cir.ptr<!u8i>
...
void test_vst1_lane_p16(poly16_t *a, poly16x4_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<4 x
  // !s16i> CIR: cir.store align(2) {{.*}}, {{.*}} : !s16i, !cir.ptr<!s16i>
...
void test_vst1_lane_p64(poly64_t *a, poly64x1_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<1 x
  // !s64i> CIR: cir.store align(8) {{.*}}, {{.*}} : !s64i, !cir.ptr<!s64i>
...
void test_vst1_lane_p8(poly8_t *a, poly8x8_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<8 x
  // !s8i> CIR: cir.store align(1) {{.*}}, {{.*}} : !s8i, !cir.ptr<!s8i>
...
void test_vst1_lane_s32(int32_t *a, int32x2_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<2 x
  // !s32i> CIR: cir.store align(4) {{.*}}, {{.*}} : !s32i, !cir.ptr<!s32i>
...
void test_vst1_lane_u16(uint16_t *a, uint16x4_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<4 x
  // !u16i> CIR: cir.store align(2) {{.*}}, {{.*}} : !u16i, !cir.ptr<!u16i>
...
void test_vst1_lane_u32(uint32_t *a, uint32x2_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<2 x
  // !u32i> CIR: cir.store align(4) {{.*}}, {{.*}} : !u32i, !cir.ptr<!u32i>
...
void test_vst1_lane_u64(uint64_t *a, uint64x1_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<1 x
  // !u64i> CIR: cir.store align(8) {{.*}}, {{.*}} : !u64i, !cir.ptr<!u64i>
...
void test_vst1q_lane_mf8(mfloat8_t *a, mfloat8x16_t b) {
  // CIR: {{.*}} = cir.vec.extract {{.*}}[{{.*}} : !u64i] : !cir.vector<16 x
  // !u8i> CIR: cir.store align(1) {{.*}}, {{.*}} : !u8i, !cir.ptr<!u8i>
...
void test_vst1_f64_x2(float64_t *a, float64x1x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<1 x
  // !cir.double>, !cir.vector<1 x !cir.double>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v1f64.p0(<1 x double> {{.*}}, <1 x
  // double> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f64_x2(a, b);
}

// ALL-LABEL: @test_vst1_f64_x3(
void test_vst1_f64_x3(float64_t *a, float64x1x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<1 x
  // !cir.double>, !cir.vector<1 x !cir.double>, !cir.vector<1 x !cir.double>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v1f64.p0(<1 x double> {{.*}}, <1 x
  // double> {{.*}}, <1 x double> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f64_x3(a, b);
}

// ALL-LABEL: @test_vst1_f64_x4(
void test_vst1_f64_x4(float64_t *a, float64x1x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<1 x
  // !cir.double>, !cir.vector<1 x !cir.double>, !cir.vector<1 x !cir.double>,
  // !cir.vector<1 x !cir.double>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v1f64.p0(<1 x double> {{.*}}, <1 x
  // double> {{.*}}, <1 x double> {{.*}}, <1 x double> {{.*}}, ptr {{.*}}) LLVM:
  // ret void
  vst1_f64_x4(a, b);
}
...
void test_vst1_mf8_x2(mfloat8_t *a, mfloat8x8x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<8 x
  // !u8i>, !cir.vector<8 x !u8i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v8i8.p0(<8 x i8> {{.*}}, <8 x i8>
  // {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_mf8_x2(a, b);
}
...
void test_vst1_mf8_x3(mfloat8_t *a, mfloat8x8x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<8 x
  // !u8i>, !cir.vector<8 x !u8i>, !cir.vector<8 x !u8i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v8i8.p0(<8 x i8> {{.*}}, <8 x i8>
  // {{.*}}, <8 x i8> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_mf8_x3(a, b);
}

// ALL-LABEL: @test_vst1_mf8_x4(
void test_vst1_mf8_x4(mfloat8_t *a, mfloat8x8x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<8 x
  // !u8i>, !cir.vector<8 x !u8i>, !cir.vector<8 x !u8i>, !cir.vector<8 x !u8i>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v8i8.p0(<8 x i8> {{.*}}, <8 x i8>
  // {{.*}}, <8 x i8> {{.*}}, <8 x i8> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_mf8_x4(a, b);
}
...
void test_vst1_p64_x2(poly64_t *a, poly64x1x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<1 x
  // !s64i>, !cir.vector<1 x !s64i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v1i64.p0(<1 x i64> {{.*}}, <1 x
  // i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p64_x2(a, b);
}
...
void test_vst1_p64_x3(poly64_t *a, poly64x1x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<1 x
  // !s64i>, !cir.vector<1 x !s64i>, !cir.vector<1 x !s64i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v1i64.p0(<1 x i64> {{.*}}, <1 x
  // i64> {{.*}}, <1 x i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p64_x3(a, b);
}
...
void test_vst1_p64_x4(poly64_t *a, poly64x1x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<1 x
  // !s64i>, !cir.vector<1 x !s64i>, !cir.vector<1 x !s64i>, !cir.vector<1 x
  // !s64i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v1i64.p0(<1 x i64> {{.*}}, <1 x
  // i64> {{.*}}, <1 x i64> {{.*}}, <1 x i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p64_x4(a, b);
}

// ALL-LABEL: @test_vst1q_f64_x2(
void test_vst1q_f64_x2(float64_t *a, float64x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !cir.double>, !cir.vector<2 x !cir.double>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v2f64.p0(<2 x double> {{.*}}, <2 x
  // double> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f64_x2(a, b);
}
...
void test_vst1q_f64_x3(float64_t *a, float64x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !cir.double>, !cir.vector<2 x !cir.double>, !cir.vector<2 x !cir.double>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v2f64.p0(<2 x double> {{.*}}, <2 x
  // double> {{.*}}, <2 x double> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f64_x3(a, b);
}

// ALL-LABEL: @test_vst1q_f64_x4(
void test_vst1q_f64_x4(float64_t *a, float64x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !cir.double>, !cir.vector<2 x !cir.double>, !cir.vector<2 x !cir.double>,
  // !cir.vector<2 x !cir.double>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v2f64.p0(<2 x double> {{.*}}, <2 x
  // double> {{.*}}, <2 x double> {{.*}}, <2 x double> {{.*}}, ptr {{.*}}) LLVM:
  // ret void
  vst1q_f64_x4(a, b);
}
...
void test_vst1q_mf8_x2(mfloat8_t *a, mfloat8x16x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<16
  // x !u8i>, !cir.vector<16 x !u8i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v16i8.p0(<16 x i8> {{.*}}, <16 x
  // i8> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_mf8_x2(a, b);
}

// ALL-LABEL: @test_vst1q_mf8_x3(
void test_vst1q_mf8_x3(mfloat8_t *a, mfloat8x16x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<16
  // x !u8i>, !cir.vector<16 x !u8i>, !cir.vector<16 x !u8i>, !cir.ptr<!void>)
  // -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v16i8.p0(<16 x i8> {{.*}}, <16 x
  // i8> {{.*}}, <16 x i8> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_mf8_x3(a, b);
}

// ALL-LABEL: @test_vst1q_mf8_x4(
void test_vst1q_mf8_x4(mfloat8_t *a, mfloat8x16x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<16
  // x !u8i>, !cir.vector<16 x !u8i>, !cir.vector<16 x !u8i>, !cir.vector<16 x
  // !u8i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v16i8.p0(<16 x i8> {{.*}}, <16 x
  // i8> {{.*}}, <16 x i8> {{.*}}, <16 x i8> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_mf8_x4(a, b);
}
...
void test_vst1q_p64_x2(poly64_t *a, poly64x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !s64i>, !cir.vector<2 x !s64i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v2i64.p0(<2 x i64> {{.*}}, <2 x
  // i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p64_x2(a, b);
}
...
void test_vst1q_p64_x3(poly64_t *a, poly64x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !s64i>, !cir.vector<2 x !s64i>, !cir.vector<2 x !s64i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v2i64.p0(<2 x i64> {{.*}}, <2 x
  // i64> {{.*}}, <2 x i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p64_x3(a, b);
}
...
void test_vst1q_p64_x4(poly64_t *a, poly64x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !s64i>, !cir.vector<2 x !s64i>, !cir.vector<2 x !s64i>, !cir.vector<2 x
  // !s64i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v2i64.p0(<2 x i64> {{.*}}, <2 x
  // i64> {{.*}}, <2 x i64> {{.*}}, <2 x i64> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p64_x4(a, b);
}
...
void test_vst1_f16_x2(float16_t *a, float16x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !cir.f16>, !cir.vector<4 x !cir.f16>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v4f16.p0(<4 x half> {{.*}}, <4 x
  // half> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f16_x2(a, b);
}
...
void test_vst1_f32_x2(float32_t *a, float32x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !cir.float>, !cir.vector<2 x !cir.float>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v2f32.p0(<2 x float> {{.*}}, <2 x
  // float> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f32_x2(a, b);
}
...
void test_vst1_p16_x2(poly16_t *a, poly16x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !s16i>, !cir.vector<4 x !s16i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v4i16.p0(<4 x i16> {{.*}}, <4 x
  // i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p16_x2(a, b);
}
...
void test_vst1_p8_x2(poly8_t *a, poly8x8x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<8 x
  // !s8i>, !cir.vector<8 x !s8i>, !cir.ptr<!void>) -> !void
...
void test_vst1_s32_x2(int32_t *a, int32x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !s32i>, !cir.vector<2 x !s32i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v2i32.p0(<2 x i32> {{.*}}, <2 x
  // i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_s32_x2(a, b);
}
...
void test_vst1_u16_x2(uint16_t *a, uint16x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !u16i>, !cir.vector<4 x !u16i>, !cir.ptr<!void>) -> !void
...
void test_vst1_u32_x2(uint32_t *a, uint32x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !u32i>, !cir.vector<2 x !u32i>, !cir.ptr<!void>) -> !void
...
void test_vst1_u64_x2(uint64_t *a, uint64x1x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<1 x
  // !u64i>, !cir.vector<1 x !u64i>, !cir.ptr<!void>) -> !void
...
void test_vst1_f16_x3(float16_t *a, float16x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !cir.f16>, !cir.vector<4 x !cir.f16>, !cir.vector<4 x !cir.f16>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v4f16.p0(<4 x half> {{.*}}, <4 x
  // half> {{.*}}, <4 x half> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f16_x3(a, b);
}
...
void test_vst1_f32_x3(float32_t *a, float32x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !cir.float>, !cir.vector<2 x !cir.float>, !cir.vector<2 x !cir.float>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v2f32.p0(<2 x float> {{.*}}, <2 x
  // float> {{.*}}, <2 x float> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_f32_x3(a, b);
}
...
void test_vst1_p16_x3(poly16_t *a, poly16x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !s16i>, !cir.vector<4 x !s16i>, !cir.vector<4 x !s16i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v4i16.p0(<4 x i16> {{.*}}, <4 x
  // i16> {{.*}}, <4 x i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p16_x3(a, b);
}
...
void test_vst1_p8_x3(poly8_t *a, poly8x8x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<8 x
  // !s8i>, !cir.vector<8 x !s8i>, !cir.vector<8 x !s8i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1_s32_x3(int32_t *a, int32x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !s32i>, !cir.vector<2 x !s32i>, !cir.vector<2 x !s32i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v2i32.p0(<2 x i32> {{.*}}, <2 x
  // i32> {{.*}}, <2 x i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_s32_x3(a, b);
}
...
void test_vst1_u16_x3(uint16_t *a, uint16x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !u16i>, !cir.vector<4 x !u16i>, !cir.vector<4 x !u16i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1_u32_x3(uint32_t *a, uint32x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !u32i>, !cir.vector<2 x !u32i>, !cir.vector<2 x !u32i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1_u64_x3(uint64_t *a, uint64x1x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<1 x
  // !u64i>, !cir.vector<1 x !u64i>, !cir.vector<1 x !u64i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1_f16_x4(float16_t *a, float16x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !cir.f16>, !cir.vector<4 x !cir.f16>, !cir.vector<4 x !cir.f16>,
  // !cir.vector<4 x !cir.f16>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v4f16.p0(<4 x half> {{.*}}, <4 x
  // half> {{.*}}, <4 x half> {{.*}}, <4 x half> {{.*}}, ptr {{.*}}) LLVM: ret
  // void
  vst1_f16_x4(a, b);
}
...
void test_vst1_f32_x4(float32_t *a, float32x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !cir.float>, !cir.vector<2 x !cir.float>, !cir.vector<2 x !cir.float>,
  // !cir.vector<2 x !cir.float>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v2f32.p0(<2 x float> {{.*}}, <2 x
  // float> {{.*}}, <2 x float> {{.*}}, <2 x float> {{.*}}, ptr {{.*}}) LLVM:
  // ret void
  vst1_f32_x4(a, b);
}
...
void test_vst1_p16_x4(poly16_t *a, poly16x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !s16i>, !cir.vector<4 x !s16i>, !cir.vector<4 x !s16i>, !cir.vector<4 x
  // !s16i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v4i16.p0(<4 x i16> {{.*}}, <4 x
  // i16> {{.*}}, <4 x i16> {{.*}}, <4 x i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_p16_x4(a, b);
}
...
void test_vst1_p8_x4(poly8_t *a, poly8x8x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<8 x
  // !s8i>, !cir.vector<8 x !s8i>, !cir.vector<8 x !s8i>, !cir.vector<8 x !s8i>,
  // !cir.ptr<!void>) -> !void
...
void test_vst1_s32_x4(int32_t *a, int32x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !s32i>, !cir.vector<2 x !s32i>, !cir.vector<2 x !s32i>, !cir.vector<2 x
  // !s32i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v2i32.p0(<2 x i32> {{.*}}, <2 x
  // i32> {{.*}}, <2 x i32> {{.*}}, <2 x i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1_s32_x4(a, b);
}
...
void test_vst1_u16_x4(uint16_t *a, uint16x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !u16i>, !cir.vector<4 x !u16i>, !cir.vector<4 x !u16i>, !cir.vector<4 x
  // !u16i>, !cir.ptr<!void>) -> !void
...
void test_vst1_u32_x4(uint32_t *a, uint32x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !u32i>, !cir.vector<2 x !u32i>, !cir.vector<2 x !u32i>, !cir.vector<2 x
  // !u32i>, !cir.ptr<!void>) -> !void
...
void test_vst1_u64_x4(uint64_t *a, uint64x1x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<1 x
  // !u64i>, !cir.vector<1 x !u64i>, !cir.vector<1 x !u64i>, !cir.vector<1 x
  // !u64i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_f16_x2(float16_t *a, float16x8x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<8 x
  // !cir.f16>, !cir.vector<8 x !cir.f16>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v8f16.p0(<8 x half> {{.*}}, <8 x
  // half> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f16_x2(a, b);
}
...
void test_vst1q_f32_x2(float32_t *a, float32x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !cir.float>, !cir.vector<4 x !cir.float>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v4f32.p0(<4 x float> {{.*}}, <4 x
  // float> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f32_x2(a, b);
}
...
void test_vst1q_p16_x2(poly16_t *a, poly16x8x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<8 x
  // !s16i>, !cir.vector<8 x !s16i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v8i16.p0(<8 x i16> {{.*}}, <8 x
  // i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p16_x2(a, b);
}
...
void test_vst1q_p8_x2(poly8_t *a, poly8x16x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<16
  // x !s8i>, !cir.vector<16 x !s8i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_s32_x2(int32_t *a, int32x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !s32i>, !cir.vector<4 x !s32i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x2.v4i32.p0(<4 x i32> {{.*}}, <4 x
  // i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_s32_x2(a, b);
}
...
void test_vst1q_u16_x2(uint16_t *a, uint16x8x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<8 x
  // !u16i>, !cir.vector<8 x !u16i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_u32_x2(uint32_t *a, uint32x4x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<4 x
  // !u32i>, !cir.vector<4 x !u32i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_u64_x2(uint64_t *a, uint64x2x2_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x2" {{.*}} : (!cir.vector<2 x
  // !u64i>, !cir.vector<2 x !u64i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_f16_x3(float16_t *a, float16x8x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<8 x
  // !cir.f16>, !cir.vector<8 x !cir.f16>, !cir.vector<8 x !cir.f16>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v8f16.p0(<8 x half> {{.*}}, <8 x
  // half> {{.*}}, <8 x half> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f16_x3(a, b);
}
...
void test_vst1q_f32_x3(float32_t *a, float32x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !cir.float>, !cir.vector<4 x !cir.float>, !cir.vector<4 x !cir.float>,
  // !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v4f32.p0(<4 x float> {{.*}}, <4 x
  // float> {{.*}}, <4 x float> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_f32_x3(a, b);
}
...
void test_vst1q_p16_x3(poly16_t *a, poly16x8x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<8 x
  // !s16i>, !cir.vector<8 x !s16i>, !cir.vector<8 x !s16i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v8i16.p0(<8 x i16> {{.*}}, <8 x
  // i16> {{.*}}, <8 x i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p16_x3(a, b);
}
...
void test_vst1q_p8_x3(poly8_t *a, poly8x16x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<16
  // x !s8i>, !cir.vector<16 x !s8i>, !cir.vector<16 x !s8i>, !cir.ptr<!void>)
  // -> !void
...
void test_vst1q_s32_x3(int32_t *a, int32x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !s32i>, !cir.vector<4 x !s32i>, !cir.vector<4 x !s32i>, !cir.ptr<!void>) ->
  // !void

  // LLVM: call void @llvm.aarch64.neon.st1x3.v4i32.p0(<4 x i32> {{.*}}, <4 x
  // i32> {{.*}}, <4 x i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_s32_x3(a, b);
}
...
void test_vst1q_u16_x3(uint16_t *a, uint16x8x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<8 x
  // !u16i>, !cir.vector<8 x !u16i>, !cir.vector<8 x !u16i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1q_u32_x3(uint32_t *a, uint32x4x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<4 x
  // !u32i>, !cir.vector<4 x !u32i>, !cir.vector<4 x !u32i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1q_u64_x3(uint64_t *a, uint64x2x3_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x3" {{.*}} : (!cir.vector<2 x
  // !u64i>, !cir.vector<2 x !u64i>, !cir.vector<2 x !u64i>, !cir.ptr<!void>) ->
  // !void
...
void test_vst1q_f16_x4(float16_t *a, float16x8x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<8 x
  // !cir.f16>, !cir.vector<8 x !cir.f16>, !cir.vector<8 x !cir.f16>,
  // !cir.vector<8 x !cir.f16>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v8f16.p0(<8 x half> {{.*}}, <8 x
  // half> {{.*}}, <8 x half> {{.*}}, <8 x half> {{.*}}, ptr {{.*}}) LLVM: ret
  // void
  vst1q_f16_x4(a, b);
}
...
void test_vst1q_f32_x4(float32_t *a, float32x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !cir.float>, !cir.vector<4 x !cir.float>, !cir.vector<4 x !cir.float>,
  // !cir.vector<4 x !cir.float>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v4f32.p0(<4 x float> {{.*}}, <4 x
  // float> {{.*}}, <4 x float> {{.*}}, <4 x float> {{.*}}, ptr {{.*}}) LLVM:
  // ret void
  vst1q_f32_x4(a, b);
}
...
void test_vst1q_p16_x4(poly16_t *a, poly16x8x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<8 x
  // !s16i>, !cir.vector<8 x !s16i>, !cir.vector<8 x !s16i>, !cir.vector<8 x
  // !s16i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v8i16.p0(<8 x i16> {{.*}}, <8 x
  // i16> {{.*}}, <8 x i16> {{.*}}, <8 x i16> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_p16_x4(a, b);
}
...
void test_vst1q_p8_x4(poly8_t *a, poly8x16x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<16
  // x !s8i>, !cir.vector<16 x !s8i>, !cir.vector<16 x !s8i>, !cir.vector<16 x
  // !s8i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_s32_x4(int32_t *a, int32x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !s32i>, !cir.vector<4 x !s32i>, !cir.vector<4 x !s32i>, !cir.vector<4 x
  // !s32i>, !cir.ptr<!void>) -> !void

  // LLVM: call void @llvm.aarch64.neon.st1x4.v4i32.p0(<4 x i32> {{.*}}, <4 x
  // i32> {{.*}}, <4 x i32> {{.*}}, <4 x i32> {{.*}}, ptr {{.*}}) LLVM: ret void
  vst1q_s32_x4(a, b);
}
...
void test_vst1q_u16_x4(uint16_t *a, uint16x8x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<8 x
  // !u16i>, !cir.vector<8 x !u16i>, !cir.vector<8 x !u16i>, !cir.vector<8 x
  // !u16i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_u32_x4(uint32_t *a, uint32x4x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<4 x
  // !u32i>, !cir.vector<4 x !u32i>, !cir.vector<4 x !u32i>, !cir.vector<4 x
  // !u32i>, !cir.ptr<!void>) -> !void
...
void test_vst1q_u64_x4(uint64_t *a, uint64x2x4_t b) {
  // CIR: cir.call_llvm_intrinsic "aarch64.neon.st1x4" {{.*}} : (!cir.vector<2 x
  // !u64i>, !cir.vector<2 x !u64i>, !cir.vector<2 x !u64i>, !cir.vector<2 x
  // !u64i>, !cir.ptr<!void>) -> !void
