...
int8_t test_vqrshrnh_n_s16(int16_t a) {
  ...
  // LLVM-SAME: i16 noundef {{.*}})
  // LLVM:      call {{.*}}@llvm.aarch64.neon.sqrshrn.{{(v8i8|i8)}}(
  // LLVM:      ret i8 {{%.*}}
...
int16_t test_vqrshrns_n_s32(int32_t a) {
  ...
  // LLVM:      call {{.*}}@llvm.aarch64.neon.sqrshrn.{{(v4i16|i16)}}(
  // LLVM:      ret i16 {{%.*}}
...
uint8_t test_vqrshrnh_n_u16(uint16_t a) {
  ...
  // LLVM-SAME: i16 noundef {{.*}})
  // LLVM:      call {{.*}}@llvm.aarch64.neon.uqrshrn.{{(v8i8|i8)}}(
  // LLVM:      ret i8 {{%.*}}
...
uint16_t test_vqrshrns_n_u32(uint32_t a) {
  ...
  // LLVM-SAME: i32 noundef {{.*}})
  // LLVM:      call {{.*}}@llvm.aarch64.neon.uqrshrn.{{(v4i16|i16)}}(
  // LLVM:      ret i16 {{%.*}}
