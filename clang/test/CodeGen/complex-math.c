...
// RUN: %clang_cc1 %s -O0 -emit-llvm -triple aarch64-unknown-unknown -ffast-math -ffp-contract=fast -complex-range=cx_fortran -o - | FileCheck %s --check-prefix=AARCH64-FASTMATH
