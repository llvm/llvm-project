...
// TRAP:       [[TRAP]]:
// TRAP-NEXT:    call void @llvm.ubsantrap(i8 3) #[[ATTR6]], !nosanitize [[META2]]
// TRAP-NEXT:    unreachable, !nosanitize [[META2]]
//
...
// RECOVER:       [[TRAP]]:
// RECOVER-NEXT:    call void @__ubsan_handle_local_out_of_bounds() #[[ATTR7]], !nosanitize [[META2]]
// RECOVER-NEXT:    br label %[[BB1]], !nosanitize [[META2]]
//
