...
// TR-NEXT:    br i1 [[TMP9]], label %[[CONT:.*]], label %[[TRAP:.*]], !nosanitize [[META6]]
// TR:       [[TRAP]]:
// TR-NEXT:    tail call void @llvm.ubsantrap(i8 3) #[[ATTR5:[0-9]+]], !nosanitize [[META6]]
...
// CHECK-NEXT:    unreachable, !nosanitize [[META6]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[X]], align 4, !tbaa [[TBAA2:![0-9]+]]
...
// TR-NEXT:    br i1 [[DOTNOT1]], label %[[TRAP:.*]], label %[[CONT:.*]], !nosanitize [[META6]]
// TR:       [[TRAP]]:
// TR-NEXT:    tail call void @llvm.ubsantrap(i8 22) #[[ATTR5]], !nosanitize [[META6]]
// TR-NEXT:    unreachable, !nosanitize [[META6]]
// TR:       [[CONT]]:
// TR-NEXT:    [[TMP2:%.*]] = load i32, ptr [[X]], align 4, !tbaa [[TBAA2:![0-9]+]]
...
// REC-NEXT:    br label %[[CONT]], !nosanitize [[META6]]
// REC:       [[CONT]]:
// REC-NEXT:    [[TMP2:%.*]] = load i32, ptr [[X]], align 4, !tbaa [[TBAA2:![0-9]+]]
...
// TR-NEXT:    br i1 [[DOTDEMORGAN]], label %[[TRAP:.*]], label %[[CONT:.*]], !nosanitize [[META6]]
// TR:       [[TRAP]]:
// TR-NEXT:    tail call void @llvm.ubsantrap(i8 0) #[[ATTR5]], !nosanitize [[META6]]
// TR-NEXT:    unreachable, !nosanitize [[META6]]
// TR:       [[CONT]]:
...
// TR:       [[TRAP]]:
// TR-NEXT:    call void @llvm.ubsantrap(i8 71) #[[ATTR5]], !nosanitize [[META6]]
// TR-NEXT:    unreachable, !nosanitize [[META6]]
//
...
//.
// TR: [[TBAA2]] = !{[[META3:![0-9]+]], [[META3]], i64 0}
...
// TR: [[META8]] = !{!"double", [[META4]], i64 0}
//.
// REC: [[TBAA2]] = !{[[META3:![0-9]+]], [[META3]], i64 0}
