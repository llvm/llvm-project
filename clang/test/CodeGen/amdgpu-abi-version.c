...
//.
// CHECK: @llvm.amdgcn.abi.version = external addrspace(1) global i32
//.
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspacecast (ptr addrspace(1) @llvm.amdgcn.abi.version to ptr), align 4
