...
// CHECK: call addrspace(9) <8 x i32> @llvm.masked.expandload.v8i32.p4(ptr addrspace(4) align 4 %{{.*}}, <8 x i1> %{{.*}}, <8 x i32> %{{.*}})
...
// CHECK: call addrspace(9) void @llvm.masked.compressstore.v8i32.p4(<8 x i32> %{{.*}}, ptr addrspace(4) align 4 %{{.*}}, <8 x i1> %{{.*}})
