...
// CHECK: define{{.*}} void @test_v16i16(ptr dead_on_unwind noalias writable sret(<16 x i16>) align 32 %agg.result, ptr nofreeobj noundef align 32 dead_on_return dereferenceable(32) %0)
