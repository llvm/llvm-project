...
// UTC_ARGS: --version 5 RUN: %clang_cc1 -std=c11 -triple=x86_64-linux-gnu
// -emit-llvm -o - %s | FileCheck %s --check-prefix=LINUX RUN: %clang_cc1
// -std=c11 -triple=x86_64-pc-windows-msvc -emit-llvm -o - %s | FileCheck %s
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testPrimitiveNoPadding(ptr noundef %i)
// #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %i.addr = alloca ptr, align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testPrimitiveLongDouble(ptr noundef
// %ld) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %ld.addr = alloca ptr, align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testPrimitiveComplexLongDouble(ptr
// noundef %c) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %c.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %c, ptr %c.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %c.addr, align 8 WINDOWS-NEXT:   ret void
//
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnionDifferentLength(ptr noundef
// %u) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %u.addr = alloca ptr, align 8
...
void testUnionDifferentLength(union U1 *u) {
  // This should not clear the object representation bits of the non-active
  // member.
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnionTailPaddingOfLongestMember(ptr
// noundef %u) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %u.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %u, ptr %u.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %u.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 1 WINDOWS-NEXT:   store i8 0, ptr %1, align 1 WINDOWS-NEXT:   %2 =
// getelementptr i8, ptr %0, i32 2 WINDOWS-NEXT:   store i8 0, ptr %2, align 2
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testStructPaddingInBetweenMembers(ptr
// noundef %baz) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %baz.addr = alloca
// ptr, align 8 WINDOWS-NEXT:   store ptr %baz, ptr %baz.addr, align 8
...
// { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %baz.addr = alloca ptr, align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testStructWithLongDouble(ptr noundef
// %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr, align 8
...
struct S11 {
  ...
  unsigned char
      b2 : 2; // next 2 bits (in 1st byte). The rest bits in byte 1 are unused
  unsigned char
      b3 : 6; // 6 bits for b3 - doesn't fit into the 1st byte => starts a 2nd
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testArrOfStructsWithPadding(ptr noundef
// %arr) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %arr.addr = alloca ptr, align
// 8 WINDOWS-NEXT:   store ptr %arr, ptr %arr.addr, align 8 WINDOWS-NEXT:   %0 =
// load ptr, ptr %arr.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 1 WINDOWS-NEXT:   store i8 0, ptr %1, align 1 WINDOWS-NEXT:   %2 =
// getelementptr i8, ptr %0, i32 3 WINDOWS-NEXT:   store i8 0, ptr %2, align 1
// WINDOWS-NEXT:   %3 = getelementptr i8, ptr %0, i32 5
// WINDOWS-NEXT:   store i8 0, ptr %3, align 1
...
// WINDOWS-NEXT:   ret void
//
void testAtomic(_Atomic(struct Bar) *bar) { __builtin_clear_padding(bar); }
...
// WINDOWS-NEXT:   ret void
//
void testAttributedType(Float3Vec *v) { __builtin_clear_padding(v); }
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testAttributedLongDoubleType(ptr
// noundef %v) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %v.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %v, ptr %v.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %v.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 24 WINDOWS-NEXT:   store i8 0, ptr %1, align 8 WINDOWS-NEXT:   %2 =
// getelementptr i8, ptr %0, i32 25 WINDOWS-NEXT:   store i8 0, ptr %2, align 1
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnnamedBitfieldSingleBit(ptr
// noundef %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %s, ptr %s.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %s.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 0 WINDOWS-NEXT:   %2 = load i8, ptr %1, align 1 WINDOWS-NEXT:   %3 =
// and i8 %2, -9 WINDOWS-NEXT:   store i8 %3, ptr %1, align 1 WINDOWS-NEXT: ret
// void
//
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnnamedBitfieldMiddle(ptr noundef
// %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr, align 8
// WINDOWS-NEXT:   store ptr %s, ptr %s.addr, align 8
// WINDOWS-NEXT:   %0 = load ptr, ptr %s.addr, align 8
// WINDOWS-NEXT:   %1 = getelementptr i8, ptr %0, i32 0
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnnamedBitfieldSurrounding(ptr
// noundef %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %s, ptr %s.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %s.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 0 WINDOWS-NEXT:   %2 = load i8, ptr %1, align 1 WINDOWS-NEXT:   %3 =
// and i8 %2, -4 WINDOWS-NEXT:   store i8 %3, ptr %1, align 1 WINDOWS-NEXT:   %4
// = getelementptr i8, ptr %0, i32 0 WINDOWS-NEXT:   %5 = load i8, ptr %4, align
// 1 WINDOWS-NEXT:   %6 = and i8 %5, 63 WINDOWS-NEXT:   store i8 %6, ptr %4,
// align 1 WINDOWS-NEXT:   ret void
//
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnnamedZeroWidthBitfield(ptr
// noundef %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %s, ptr %s.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %s.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 0 WINDOWS-NEXT:   %2 = load i8, ptr %1, align 4 WINDOWS-NEXT:   %3 =
// and i8 %2, 15 WINDOWS-NEXT:   store i8 %3, ptr %1, align 4 WINDOWS-NEXT:   %4
// = getelementptr i8, ptr %0, i32 1 WINDOWS-NEXT:   store i8 0, ptr %4, align 1
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testUnnamedBitfieldMultiByte(ptr
// noundef %s) #0 { WINDOWS-NEXT: entry: WINDOWS-NEXT:   %s.addr = alloca ptr,
// align 8 WINDOWS-NEXT:   store ptr %s, ptr %s.addr, align 8 WINDOWS-NEXT:   %0
// = load ptr, ptr %s.addr, align 8 WINDOWS-NEXT:   %1 = getelementptr i8, ptr
// %0, i32 0 WINDOWS-NEXT:   %2 = load i8, ptr %1, align 2 WINDOWS-NEXT:   %3 =
// and i8 %2, 15 WINDOWS-NEXT:   store i8 %3, ptr %1, align 2 WINDOWS-NEXT:   %4
// = getelementptr i8, ptr %0, i32 1 WINDOWS-NEXT:   %5 = load i8, ptr %4, align
// 1 WINDOWS-NEXT:   %6 = and i8 %5, -16 WINDOWS-NEXT:   store i8 %6, ptr %4,
// align 1 WINDOWS-NEXT:   ret void
//
