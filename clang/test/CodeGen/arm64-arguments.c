...
// CHECK: define{{.*}} void @f33(ptr nofree noundef align 1 dead_on_return dereferenceable(1024) %s)
...
// CHECK: define{{.*}} void @f1_2(ptr dead_on_unwind noalias writable sret(<8 x float>) align 16 %{{.*}}, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %0)
T_float32x8 f1_2(T_float32x8 a0) { return a0; }
// CHECK: define{{.*}} void @f1_3(ptr dead_on_unwind noalias writable sret(<16 x float>) align 16 %{{.*}}, ptr nofree noundef align 16 dead_on_return dereferenceable(64) %0)
...
// CHECK: define{{.*}} <4 x i32> @f37(i32 noundef %i, ptr nofree noundef align 16 dead_on_return dereferenceable(80) %s1, ptr nofree noundef align 16 dead_on_return dereferenceable(80) %s2)
// CHECK: load <4 x i32>, ptr %s1, align 16
// CHECK: load <4 x i32>, ptr %s2, align 16
  int32x4_t v = vaddq_s32(*(int32x4_t *)&s1,
                          *(int32x4_t *)&s2);
...
// CHECK: call void @llvm.memcpy
// CHECK: call <4 x i32> @f37(i32 noundef 3, ptr nofree noundef align 16 dead_on_return dereferenceable(80) %[[a]], ptr nofree noundef align 16 dead_on_return dereferenceable(80) %[[b]])
...
// CHECK: define{{.*}} i32 @f42(i32 noundef %i, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s1, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s2)
...
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call i32 @f42(i32 noundef 3, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %[[a]], ptr nofree noundef align 4 dead_on_return dereferenceable(24) %[[b]])
...
// CHECK: define{{.*}} i32 @f42_stack(i32 noundef %i, i32 noundef %i2, i32 noundef %i3, i32 noundef %i4, i32 noundef %i5, i32 noundef %i6, i32 noundef %i7, i32 noundef %i8, i32 noundef %i9, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s1, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s2)
// CHECK: getelementptr inbounds nuw %struct.s42, ptr %s1, i32 0, i32 0
// CHECK: getelementptr inbounds nuw %struct.s42, ptr %s2, i32 0, i32 0
// CHECK: getelementptr inbounds nuw %struct.s42, ptr %s1, i32 0, i32 1
// CHECK: getelementptr inbounds nuw %struct.s42, ptr %s2, i32 0, i32 1
...
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call i32 @f42_stack(i32 noundef 1, i32 noundef 2, i32 noundef 3, i32 noundef 4, i32 noundef 5, i32 noundef 6, i32 noundef 7, i32 noundef 8, i32 noundef 9, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %[[a]], ptr nofree noundef align 4 dead_on_return dereferenceable(24) %[[b]])
...
// CHECK: define{{.*}} i32 @f43(i32 noundef %i, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %s1, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %s2)
...
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call i32 @f43(i32 noundef 3, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %[[a]], ptr nofree noundef align 16 dead_on_return dereferenceable(32) %[[b]])
...
// CHECK: define{{.*}} i32 @f43_stack(i32 noundef %i, i32 noundef %i2, i32 noundef %i3, i32 noundef %i4, i32 noundef %i5, i32 noundef %i6, i32 noundef %i7, i32 noundef %i8, i32 noundef %i9, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %s1, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %s2)
// CHECK: getelementptr inbounds nuw %struct.s43, ptr %s1, i32 0, i32 0
// CHECK: getelementptr inbounds nuw %struct.s43, ptr %s2, i32 0, i32 0
// CHECK: getelementptr inbounds nuw %struct.s43, ptr %s1, i32 0, i32 1
// CHECK: getelementptr inbounds nuw %struct.s43, ptr %s2, i32 0, i32 1
...
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call void @llvm.memcpy.p0.p0.i64
// CHECK: call i32 @f43_stack(i32 noundef 1, i32 noundef 2, i32 noundef 3, i32 noundef 4, i32 noundef 5, i32 noundef 6, i32 noundef 7, i32 noundef 8, i32 noundef 9, ptr nofree noundef align 16 dead_on_return dereferenceable(32) %[[a]], ptr nofree noundef align 16 dead_on_return dereferenceable(32) %[[b]])
