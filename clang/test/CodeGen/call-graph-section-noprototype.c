...
void bar() {
  ...
  // WARN_NO_PROTOTYPE_ITANIUM: warning: indirect call to a function with no prototype 'void ()'; generating type metadata as if it took no arguments (type string: _ZTSFvvE) [-Wcall-graph-section-no-prototype]
  // WARN_NO_PROTOTYPE_MS: warning: indirect call to a function with no prototype 'void ()'; generating type metadata as if it took no arguments (type string: ?6AXXZ) [-Wcall-graph-section-no-prototype]
  fp();
}
...
void test_struct_ptr_return() {
  ...
  // WARN_NO_PROTOTYPE_ITANIUM: warning: indirect call to a function with no prototype 'struct my_struct *()'; generating type metadata as if it took no arguments (type string: _ZTSFP9my_structvE) [-Wcall-graph-section-no-prototype]
  // WARN_NO_PROTOTYPE_MS: warning: indirect call to a function with no prototype 'struct my_struct *()'; generating type metadata as if it took no arguments (type string: ?6APEAUmy_struct@@XZ) [-Wcall-graph-section-no-prototype]
  fp();
}
...
void test_int_return() {
  ...
  // WARN_NO_PROTOTYPE_ITANIUM: warning: indirect call to a function with no prototype 'int ()'; generating type metadata as if it took no arguments (type string: _ZTSFivE) [-Wcall-graph-section-no-prototype]
  // WARN_NO_PROTOTYPE_MS: warning: indirect call to a function with no prototype 'int ()'; generating type metadata as if it took no arguments (type string: ?6AHXZ) [-Wcall-graph-section-no-prototype]
  fp();
}
