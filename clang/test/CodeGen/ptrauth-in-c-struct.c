...
// CHECK: define void @test_parameter_SA(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) %{{.*}})
// CHECK-NOT: call
// CHECK: ret void
...
// CHECK: call void @calleeSA(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) %[[AGG_TMP]])
// CHECK-NOT: call
// CHECK: ret void
