...
// CHECK: define void @test_parameter_SA(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %{{.*}})
// CHECK-NOT: call
// CHECK: ret void
...
// CHECK: call void @calleeSA(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %[[AGG_TMP]])
// CHECK-NOT: call
// CHECK: ret void
