...
// -ffreestanding \ RUN:   -fvisibility=hidden | FileCheck --check-prefix=X86_64
// %s
...
// AMDGCN_CL_DEF-NEXT:    [[ORD_ADDR_ASCAST:%.*]] = addrspacecast ptr
// addrspace(5) [[ORD_ADDR]] to ptr AMDGCN_CL_DEF-NEXT:    store i32 [[ORD]],
// ptr [[ORD_ADDR_ASCAST]], align 4 AMDGCN_CL_DEF-NEXT:    [[TMP0:%.*]] = load
// i32, ptr [[ORD_ADDR_ASCAST]], align 4 AMDGCN_CL_DEF-NEXT:    switch i32
// [[TMP0]], label %[[ATOMIC_SCOPE_CONTINUE:.*]] [ AMDGCN_CL_DEF-NEXT:      i32
// 1, label %[[ACQUIRE:.*]] AMDGCN_CL_DEF-NEXT:      i32 2, label %[[ACQUIRE]]
...
// AMDGCN_CL_20-NEXT:    store i32 [[ORD]], ptr addrspace(5) [[ORD_ADDR]], align
// 4 AMDGCN_CL_20-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspace(5)
// [[ORD_ADDR]], align 4 AMDGCN_CL_20-NEXT:    switch i32 [[TMP0]], label
// %[[ATOMIC_SCOPE_CONTINUE:.*]] [ AMDGCN_CL_20-NEXT:      i32 1, label
// %[[ACQUIRE:.*]] AMDGCN_CL_20-NEXT:      i32 2, label %[[ACQUIRE]]
...
// X86_64-NEXT:    br label %[[ATOMIC_SCOPE_CONTINUE]]
//
void fe1b(int ord) { __scoped_atomic_thread_fence(ord, __MEMORY_SCOPE_WRKGRP); }
...
// AMDGCN_CL_DEF-NEXT:    [[SCOPE_ADDR_ASCAST:%.*]] = addrspacecast ptr
// addrspace(5) [[SCOPE_ADDR]] to ptr AMDGCN_CL_DEF-NEXT:    store i32
// [[SCOPE]], ptr [[SCOPE_ADDR_ASCAST]], align 4 AMDGCN_CL_DEF-NEXT:
// [[TMP0:%.*]] = load i32, ptr [[SCOPE_ADDR_ASCAST]], align 4
// AMDGCN_CL_DEF-NEXT:    switch i32 [[TMP0]], label
// %[[ATOMIC_SCOPE_CONTINUE:.*]] [ AMDGCN_CL_DEF-NEXT:      i32 0, label
// %[[SYSTEM_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:      i32 1, label
// %[[DEVICE_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:      i32 2, label
// %[[WORKGROUP_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:      i32 5, label
// %[[CLUSTER_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:      i32 3, label
// %[[WAVEFRONT_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:      i32 4, label
// %[[SINGLE_SCOPE:.*]] AMDGCN_CL_DEF-NEXT:    ] AMDGCN_CL_DEF:
// [[ATOMIC_SCOPE_CONTINUE]]: AMDGCN_CL_DEF-NEXT:    ret void AMDGCN_CL_DEF:
// [[SYSTEM_SCOPE]]: AMDGCN_CL_DEF-NEXT:    fence release AMDGCN_CL_DEF-NEXT: br
// label %[[ATOMIC_SCOPE_CONTINUE]] AMDGCN_CL_DEF:       [[DEVICE_SCOPE]]:
...
// AMDGCN_CL_20-NEXT:    store i32 [[SCOPE]], ptr addrspace(5) [[SCOPE_ADDR]],
// align 4 AMDGCN_CL_20-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspace(5)
// [[SCOPE_ADDR]], align 4 AMDGCN_CL_20-NEXT:    switch i32 [[TMP0]], label
// %[[ATOMIC_SCOPE_CONTINUE:.*]] [ AMDGCN_CL_20-NEXT:      i32 0, label
// %[[SYSTEM_SCOPE:.*]] AMDGCN_CL_20-NEXT:      i32 1, label
// %[[DEVICE_SCOPE:.*]] AMDGCN_CL_20-NEXT:      i32 2, label
// %[[WORKGROUP_SCOPE:.*]] AMDGCN_CL_20-NEXT:      i32 5, label
// %[[CLUSTER_SCOPE:.*]] AMDGCN_CL_20-NEXT:      i32 3, label
// %[[WAVEFRONT_SCOPE:.*]] AMDGCN_CL_20-NEXT:      i32 4, label
// %[[SINGLE_SCOPE:.*]] AMDGCN_CL_20-NEXT:    ] AMDGCN_CL_20:
// [[ATOMIC_SCOPE_CONTINUE]]: AMDGCN_CL_20-NEXT:    ret void AMDGCN_CL_20:
// [[SYSTEM_SCOPE]]: AMDGCN_CL_20-NEXT:    fence release AMDGCN_CL_20-NEXT: br
// label %[[ATOMIC_SCOPE_CONTINUE]] AMDGCN_CL_20:       [[DEVICE_SCOPE]]:
...
// X86_64-NEXT:    br label %[[ATOMIC_SCOPE_CONTINUE]]
//
void fe1c(int scope) { __scoped_atomic_thread_fence(__ATOMIC_RELEASE, scope); }
...
// X86_64-NEXT:    ret void
//
void fe2a() { __scoped_atomic_thread_fence(999, __MEMORY_SCOPE_SYSTEM); }
...
// X86_64-NEXT:    ret void
//
void fe2b() { __scoped_atomic_thread_fence(__ATOMIC_RELEASE, 999); }
