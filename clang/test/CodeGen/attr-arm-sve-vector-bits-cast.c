...
// CHECK-SAME: ptr nofree noundef readonly align 16 captures(none) dead_on_return dereferenceable(64) [[TMP0:%.*]]) local_unnamed_addr #[[ATTR2:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-SAME: ptr nofree noundef readonly align 16 captures(none) dead_on_return dereferenceable(64) [[TMP0:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
