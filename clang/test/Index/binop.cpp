...
// CHECK: CallExpr=D:96:3 BinOp= 0
// CHECK: CallExpr=operator->*:99:8 BinOp=->* 2
// CHECK: CallExpr=operator*:100:6 BinOp=* 3
// CHECK: CallExpr=operator/:101:6 BinOp=/ 4
// CHECK: CallExpr=operator%:102:6 BinOp=% 5
// CHECK: CallExpr=operator+:103:6 BinOp=+ 6
// CHECK: CallExpr=operator-:104:6 BinOp=- 7
// CHECK: CallExpr=operator<<:106:6 BinOp=<< 8
// CHECK: CallExpr=operator>>:107:6 BinOp=>> 9
// CHECK: CallExpr=operator<:109:8 BinOp=< 11
// CHECK: CallExpr=operator>:110:8 BinOp=> 12
// CHECK: CallExpr=operator<=:111:8 BinOp=<= 13
// CHECK: CallExpr=operator>=:112:8 BinOp=>= 14
// CHECK: CallExpr=operator==:113:8 BinOp=== 15
// CHECK: CallExpr=operator!=:114:8 BinOp=!= 16
// CHECK: CallExpr=operator&:116:6 BinOp=& 17
// CHECK: CallExpr=operator^:117:6 BinOp=^ 18
// CHECK: CallExpr=operator|:118:6 BinOp=| 19
// CHECK: CallExpr=operator&&:120:8 BinOp=&& 20
// CHECK: CallExpr=operator||:121:8 BinOp=|| 21
// CHECK: CallExpr=operator=:123:6 BinOp== 22
// CHECK: CallExpr=operator*=:124:6 BinOp=*= 23
// CHECK: CallExpr=operator/=:125:6 BinOp=/= 24
// CHECK: CallExpr=operator%=:126:6 BinOp=%= 25
// CHECK: CallExpr=operator+=:127:6 BinOp=+= 26
// CHECK: CallExpr=operator-=:128:6 BinOp=-= 27
// CHECK: CallExpr=operator<<=:129:6 BinOp=<<= 28
// CHECK: CallExpr=operator>>=:130:6 BinOp=>>= 29
// CHECK: CallExpr=operator&=:131:6 BinOp=&= 30
// CHECK: CallExpr=operator^=:132:6 BinOp=^= 31
// CHECK: CallExpr=operator|=:133:6 BinOp=|= 32
// CHECK: CallExpr=operator,:134:6 BinOp=, 33
// CHECK: CallExpr=operator++:138:6 BinOp= 0
// CHECK: CallExpr=operator++:139:6 BinOp= 0
// CHECK: CallExpr=operator--:140:6 BinOp= 0
// CHECK: CallExpr=operator--:141:6 BinOp= 0
