...
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx950 -S -emit-llvm -o - %s | FileCheck --check-prefix=GFX950 %s
...
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1210 -S -emit-llvm -o - %s | FileCheck --check-prefix=GFX1210 %s
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1300 -S -emit-llvm -o - %s | FileCheck --check-prefix=GFX1300 %s
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1301 -S -emit-llvm -o - %s | FileCheck --check-prefix=GFX1301 %s
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1302 -S -emit-llvm -o - %s | FileCheck --check-prefix=GFX1302 %s
...
// GFX1210: "target-features"="+16-bit-insts,+ashr-pk-insts,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-10-insts,+gfx12-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
// GFX1300: "target-features"="+16-bit-insts,+ashr-pk-insts,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-10-insts,+gfx12-insts,+gfx13-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
// GFX1301: "target-features"="+16-bit-insts,+ashr-pk-insts,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-10-insts,+gfx12-insts,+gfx13-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
// GFX1302: "target-features"="+16-bit-insts,+ashr-pk-insts,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-10-insts,+gfx12-insts,+gfx13-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
