...
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1210 -emit-llvm -o - %s | FileCheck --check-prefix=GFX1210 %s
// RUN: %clang_cc1 -triple amdgcn -target-cpu gfx1211 -emit-llvm -o - %s | FileCheck --check-prefix=GFX1211 %s
...
// GFX1210: "target-features"="+16-bit-insts,+ashr-pk-insts,+atomic-buffer-pk-add-bf16-inst,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-insts,+gfx1210-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
// GFX1211: "target-features"="+16-bit-insts,+ashr-pk-insts,+atomic-buffer-pk-add-bf16-inst,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-insts,+gfx1210-insts,+gfx1211-gemm-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
// GFX1300: "target-features"="+16-bit-insts,+ashr-pk-insts,+atomic-buffer-pk-add-bf16-inst,+bf16-cvt-insts,+bf16-pk-insts,+bf16-trans-insts,+bitop3-insts,+ci-insts,+dl-insts,+dot7-insts,+dot8-insts,+dpp,+fp8-conversion-insts,+gfx10-3-insts,+gfx10-insts,+gfx11-insts,+gfx12-insts,+gfx1210-insts,+gfx1211-gemm-insts,+gfx13-insts,+gfx8-insts,+gfx9-insts,+permlane16-swap,+prng-inst,+tanh-insts,+wavefrontsize32"
