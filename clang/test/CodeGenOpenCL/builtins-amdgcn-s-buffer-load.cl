...
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i32 @llvm.amdgcn.s.buffer.load.i32(<4 x i32> [[TMP1]], i32 [[OFFSET:%.*]], i32 0)
// CHECK-NEXT:    ret i32 [[TMP2]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <2 x i32> @llvm.amdgcn.s.buffer.load.v2i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <3 x i32> @llvm.amdgcn.s.buffer.load.v3i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i32> @llvm.amdgcn.s.buffer.load.v4i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <8 x i32> @llvm.amdgcn.s.buffer.load.v8i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <16 x i32> @llvm.amdgcn.s.buffer.load.v16i32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <2 x float> @llvm.amdgcn.s.buffer.load.v2f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <3 x float> @llvm.amdgcn.s.buffer.load.v3f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x float> @llvm.amdgcn.s.buffer.load.v4f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <8 x float> @llvm.amdgcn.s.buffer.load.v8f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <16 x float> @llvm.amdgcn.s.buffer.load.v16f32(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i8 @llvm.amdgcn.s.buffer.load.i8(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i16 @llvm.amdgcn.s.buffer.load.i16(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call half @llvm.amdgcn.s.buffer.load.f16(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <2 x half> @llvm.amdgcn.s.buffer.load.v2f16(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <3 x half> @llvm.amdgcn.s.buffer.load.v3f16(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x half> @llvm.amdgcn.s.buffer.load.v4f16(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <2 x i8> @llvm.amdgcn.s.buffer.load.v2i8(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <3 x i8> @llvm.amdgcn.s.buffer.load.v3i8(<4 x i32> [[TMP1]], i32 0, i32 0)
...
// CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(8) [[RSRC:%.*]] to i128
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i128 [[TMP0]] to <4 x i32>
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i8> @llvm.amdgcn.s.buffer.load.v4i8(<4 x i32> [[TMP1]], i32 0, i32 0)
