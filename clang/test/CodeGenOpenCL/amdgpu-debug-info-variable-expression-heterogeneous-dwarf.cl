...
// CHECK-DAG: ![[FILEVAR0_LT]] = distinct !DILifetime(object: ![[FILEVAR0_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(1)* addrspace(1)*), DIOpDeref(i32 addrspace(1)*)), argObjects: {![[FILEVAR0_F]]})
...
// CHECK-DAG: ![[FILEVAR1_LT]] = distinct !DILifetime(object: ![[FILEVAR1_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(4)* addrspace(1)*), DIOpDeref(i32 addrspace(4)*)), argObjects: {![[FILEVAR1_F]]})
...
// CHECK-DAG: ![[FILEVAR2_LT]] = distinct !DILifetime(object: ![[FILEVAR2_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(3)* addrspace(1)*), DIOpDeref(i32 addrspace(3)*)), argObjects: {![[FILEVAR2_F]]})
...
// CHECK-DAG: ![[FILEVAR3_LT]] = distinct !DILifetime(object: ![[FILEVAR3_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(5)* addrspace(1)*), DIOpDeref(i32 addrspace(5)*)), argObjects: {![[FILEVAR3_F]]})
...
// CHECK-DAG: ![[FILEVAR4_LT]] = distinct !DILifetime(object: ![[FILEVAR4_GV]], location: !DIExpr(DIOpArg(0, i32* addrspace(1)*), DIOpDeref(i32*)), argObjects: {![[FILEVAR4_F]]})
...
// CHECK-DAG: ![[FILEVAR5_LT]] = distinct !DILifetime(object: ![[FILEVAR5_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(1)* addrspace(1)*), DIOpDeref(i32 addrspace(1)*)), argObjects: {![[FILEVAR5_F]]})
...
// CHECK-DAG: ![[FILEVAR6_LT]] = distinct !DILifetime(object: ![[FILEVAR6_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(4)* addrspace(1)*), DIOpDeref(i32 addrspace(4)*)), argObjects: {![[FILEVAR6_F]]})
...
// CHECK_DAG: ![[FILEVAR7_LT]] = distinct !DILifetime(object: ![[FILEVAR7_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(3)* addrspace(1)*), DIOpDeref(i32 addrspace(3)*)), argObjects: {![[FILEVAR7_F]]})
...
// CHECK-DAG: ![[FILEVAR8_LT]] = distinct !DILifetime(object: ![[FILEVAR8_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(5)* addrspace(1)*), DIOpDeref(i32 addrspace(5)*)), argObjects: {![[FILEVAR8_F]]})
...
// CHECK-DAG: ![[FILEVAR9_LT]] = distinct !DILifetime(object: ![[FILEVAR9_GV]], location: !DIExpr(DIOpArg(0, i32* addrspace(1)*), DIOpDeref(i32*)), argObjects: {![[FILEVAR9_F]]})
...
// CHECK-DAG: ![[FILEVAR10_LT]] = distinct !DILifetime(object: ![[FILEVAR10_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(1)* addrspace(4)*), DIOpDeref(i32 addrspace(1)*)), argObjects: {![[FILEVAR10_F]]})
...
// CHECK-DAG: ![[FILEVAR11_LT]] = distinct !DILifetime(object: ![[FILEVAR11_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(4)* addrspace(4)*), DIOpDeref(i32 addrspace(4)*)), argObjects: {![[FILEVAR11_F]]})
...
// CHECK_DAG: ![[FILEVAR12_LT]] = distinct !DILifetime(object: ![[FILEVAR12_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(3)* addrspace(4)*), DIOpDeref(i32 addrspace(3)*)), argObjects: {![[FILEVAR12_F]]})
...
// CHECK-DAG: ![[FILEVAR13_LT]] = distinct !DILifetime(object: ![[FILEVAR13_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(5)* addrspace(4)*), DIOpDeref(i32 addrspace(5)*)), argObjects: {![[FILEVAR13_F]]})
...
// CHECK-DAG: ![[FILEVAR14_LT]] = distinct !DILifetime(object: ![[FILEVAR14_GV]], location: !DIExpr(DIOpArg(0, i32* addrspace(4)*), DIOpDeref(i32*)), argObjects: {![[FILEVAR14_F]]})
...
kernel void kernel1(
  ...
  // CHECK-DAG: ![[FUNCVAR10_LT]] = distinct !DILifetime(object: ![[FUNCVAR10_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(1)* addrspace(4)*), DIOpDeref(i32 addrspace(1)*)), argObjects: {![[FUNCVAR10_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR11_LT]] = distinct !DILifetime(object: ![[FUNCVAR11_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(4)* addrspace(4)*), DIOpDeref(i32 addrspace(4)*)), argObjects: {![[FUNCVAR11_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR12_LT]] = distinct !DILifetime(object: ![[FUNCVAR12_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(3)* addrspace(4)*), DIOpDeref(i32 addrspace(3)*)), argObjects: {![[FUNCVAR12_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR13_LT]] = distinct !DILifetime(object: ![[FUNCVAR13_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(5)* addrspace(4)*), DIOpDeref(i32 addrspace(5)*)), argObjects: {![[FUNCVAR13_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR14_LT]] = distinct !DILifetime(object: ![[FUNCVAR14_GV]], location: !DIExpr(DIOpArg(0, i32* addrspace(4)*), DIOpDeref(i32*)), argObjects: {![[FUNCVAR14_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR15_LT]] = distinct !DILifetime(object: ![[FUNCVAR15_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(1)* addrspace(3)*), DIOpDeref(i32 addrspace(1)*)), argObjects: {![[FUNCVAR15_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR16_LT]] = distinct !DILifetime(object: ![[FUNCVAR16_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(4)* addrspace(3)*), DIOpDeref(i32 addrspace(4)*)), argObjects: {![[FUNCVAR16_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR17_LT]] = distinct !DILifetime(object: ![[FUNCVAR17_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(3)* addrspace(3)*), DIOpDeref(i32 addrspace(3)*)), argObjects: {![[FUNCVAR17_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR18_LT]] = distinct !DILifetime(object: ![[FUNCVAR18_GV]], location: !DIExpr(DIOpArg(0, i32 addrspace(5)* addrspace(3)*), DIOpDeref(i32 addrspace(5)*)), argObjects: {![[FUNCVAR18_F]]})
  ...
  // CHECK-DAG: ![[FUNCVAR19_LT]] = distinct !DILifetime(object: ![[FUNCVAR19_GV]], location: !DIExpr(DIOpArg(0, i32* addrspace(3)*), DIOpDeref(i32*)), argObjects: {![[FUNCVAR19_F]]})
