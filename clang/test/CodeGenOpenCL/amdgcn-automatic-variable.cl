...
// RUN: %clang_cc1 -O0 -cl-std=CL1.2 -triple amdgpu-amd-amdhsa -emit-llvm %s -o - | FileCheck -check-prefixes=CL12 %s
// RUN: %clang_cc1 -O0 -cl-std=CL2.0 -triple amdgpu-amd-amdhsa -emit-llvm %s -o - | FileCheck -check-prefixes=CL20 %s
