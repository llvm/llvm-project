...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_f16_w32(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.f16.v8f32.v8f16(<8 x half> [[A:%.*]], <8 x half> [[B:%.*]], <8 x float> [[C:%.*]])
// CHECK-NEXT:    store <8 x float> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 32, !tbaa [[TBAA4:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_bf16_w32(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v8f32.v8i16(<8 x i16> [[A:%.*]], <8 x i16> [[B:%.*]], <8 x float> [[C:%.*]])
// CHECK-NEXT:    store <8 x float> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 32, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_f16_16x16x16_f16_w32(
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <8 x half> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 16, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_bf16_16x16x16_bf16_w32(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <8 x i16> @llvm.amdgcn.wmma.bf16.16x16x16.bf16.v8i16.v8i16(<8 x i16> [[A:%.*]], <8 x i16> [[B:%.*]], <8 x i16> [[C:%.*]], i1 false)
// CHECK-NEXT:    store <8 x i16> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 16, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_i32_16x16x16_iu8_w32(
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <8 x i32> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 32, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_i32_16x16x16_iu4_w32(
// CHECK-NEXT:  entry:
