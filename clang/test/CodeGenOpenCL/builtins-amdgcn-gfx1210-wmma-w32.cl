...
typedef __bf16 v8sbf16 __attribute__((ext_vector_type(8)));
...
// CHECK-GFX1210-NEXT:    ret void
//
void test_amdgcn_wmma_bf16_16x16x32_bf16(global v8sbf16* out, v16bf16 a, v16bf16 b, v8sbf16 c)
{
...
// CHECK-GFX1210-NEXT:    ret void
//
void test_amdgcn_wmma_bf16f32_16x16x32_bf16(global v8sbf16* out, v16bf16 a, v16bf16 b, v8f c)
{
...
// CHECK-GFX1210-NEXT:    ret void
//
void test_amdgcn_swmmac_bf16_16x16x64_bf16(global v8sbf16* out, v16bf16 a, v32bf16 b, v8sbf16 c, short index)
{
