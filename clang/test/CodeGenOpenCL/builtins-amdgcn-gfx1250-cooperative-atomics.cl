...
// CHECK-LABEL: define dso_local void @test_amdgcn_cooperative_atomic_store_32x8B(
// CHECK-SAME: ptr addrspace(1) noundef writeonly captures(none) [[GADDR:%.*]], <2 x i32> noundef [[VAL:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.amdgcn.cooperative.atomic.store.32x8B.p1(ptr addrspace(1) [[GADDR]], <2 x i32> [[VAL]], i32 0, metadata [[META4]])
// CHECK-NEXT:    ret void
//
void test_amdgcn_cooperative_atomic_store_32x8B(global v2i* gaddr, v2i val)
{
  __builtin_amdgcn_cooperative_atomic_store_32x8B(gaddr, val, __ATOMIC_RELAXED, "agent");
}

// CHECK-LABEL: define dso_local <2 x i32> @test_amdgcn_cooperative_atomic_load_32x8B(
// CHECK-SAME: ptr addrspace(1) noundef readonly captures(none) [[GADDR:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <2 x i32> @llvm.amdgcn.cooperative.atomic.load.32x8B.p1(ptr addrspace(1) [[GADDR]], i32 0, metadata [[META4]])
// CHECK-NEXT:    ret <2 x i32> [[TMP0]]
//
v2i test_amdgcn_cooperative_atomic_load_32x8B(global v2i* gaddr)
{
  return __builtin_amdgcn_cooperative_atomic_load_32x8B(gaddr, __ATOMIC_RELAXED, "agent");
}

// CHECK-LABEL: define dso_local void @test_amdgcn_cooperative_atomic_store_16x16B(
// CHECK-SAME: ptr addrspace(1) noundef writeonly captures(none) [[GADDR:%.*]], <4 x i32> noundef [[VAL:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.amdgcn.cooperative.atomic.store.16x16B.p1(ptr addrspace(1) [[GADDR]], <4 x i32> [[VAL]], i32 0, metadata [[META4]])
// CHECK-NEXT:    ret void
//
void test_amdgcn_cooperative_atomic_store_16x16B(global v4i* gaddr, v4i val)
{
  __builtin_amdgcn_cooperative_atomic_store_16x16B(gaddr, val, __ATOMIC_RELAXED, "agent");
}

// CHECK-LABEL: define dso_local <4 x i32> @test_amdgcn_cooperative_atomic_load_16x16B(
// CHECK-SAME: ptr addrspace(1) noundef readonly captures(none) [[GADDR:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <4 x i32> @llvm.amdgcn.cooperative.atomic.load.16x16B.p1(ptr addrspace(1) [[GADDR]], i32 0, metadata [[META4]])
// CHECK-NEXT:    ret <4 x i32> [[TMP0]]
//
v4i test_amdgcn_cooperative_atomic_load_16x16B(global v4i* gaddr)
{
  return __builtin_amdgcn_cooperative_atomic_load_16x16B(gaddr, __ATOMIC_RELAXED, "agent");
}

// CHECK-LABEL: define dso_local <4 x i32> @test_amdgcn_cooperative_atomic_load_16x16B_acq(
// CHECK-SAME: ptr addrspace(1) noundef readonly captures(none) [[GADDR:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <4 x i32> @llvm.amdgcn.cooperative.atomic.load.16x16B.p1(ptr addrspace(1) [[GADDR]], i32 2, metadata [[META4]])
// CHECK-NEXT:    ret <4 x i32> [[TMP0]]
//
v4i test_amdgcn_cooperative_atomic_load_16x16B_acq(global v4i* gaddr)
{
  return __builtin_amdgcn_cooperative_atomic_load_16x16B(gaddr, __ATOMIC_ACQUIRE, "agent");
}

// CHECK-LABEL: define dso_local <4 x i32> @test_amdgcn_cooperative_atomic_load_16x16B_consume(
// CHECK-SAME: ptr addrspace(1) noundef readonly captures(none) [[GADDR:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <4 x i32> @llvm.amdgcn.cooperative.atomic.load.16x16B.p1(ptr addrspace(1) [[GADDR]], i32 1, metadata [[META4]])
// CHECK-NEXT:    ret <4 x i32> [[TMP0]]
//
v4i test_amdgcn_cooperative_atomic_load_16x16B_consume(global v4i* gaddr)
{
  return __builtin_amdgcn_cooperative_atomic_load_16x16B(gaddr, __ATOMIC_CONSUME, "agent");
}

// CHECK-LABEL: define dso_local void @test_amdgcn_cooperative_atomic_store_16x16B_rel(
// CHECK-SAME: ptr addrspace(1) noundef writeonly captures(none) [[GADDR:%.*]], <4 x i32> noundef [[VAL:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.amdgcn.cooperative.atomic.store.16x16B.p1(ptr addrspace(1) [[GADDR]], <4 x i32> [[VAL]], i32 3, metadata [[META4]])
// CHECK-NEXT:    ret void
//
void test_amdgcn_cooperative_atomic_store_16x16B_rel(global v4i* gaddr, v4i val)
{
  __builtin_amdgcn_cooperative_atomic_store_16x16B(gaddr, val, __ATOMIC_RELEASE, "agent");
}

// CHECK-LABEL: define dso_local void @test_amdgcn_cooperative_atomic_store_16x16B_seq_cst(
// CHECK-SAME: ptr addrspace(1) noundef writeonly captures(none) [[GADDR:%.*]], <4 x i32> noundef [[VAL:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.amdgcn.cooperative.atomic.store.16x16B.p1(ptr addrspace(1) [[GADDR]], <4 x i32> [[VAL]], i32 5, metadata [[META4]])
// CHECK-NEXT:    ret void
//
void test_amdgcn_cooperative_atomic_store_16x16B_seq_cst(global v4i* gaddr, v4i val)
{
  __builtin_amdgcn_cooperative_atomic_store_16x16B(gaddr, val, __ATOMIC_SEQ_CST, "agent");
}
