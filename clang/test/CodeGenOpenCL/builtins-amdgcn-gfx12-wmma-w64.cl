...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_f16_w64(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <4 x float> @llvm.amdgcn.wmma.f32.16x16x16.f16.v4f32.v4f16(<4 x half> [[A:%.*]], <4 x half> [[B:%.*]], <4 x float> [[C:%.*]])
// CHECK-NEXT:    store <4 x float> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 16, !tbaa [[TBAA4:![0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_bf16_w64(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call <4 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16.v4f32.v4i16(<4 x i16> [[A:%.*]], <4 x i16> [[B:%.*]], <4 x float> [[C:%.*]])
// CHECK-NEXT:    store <4 x float> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 16, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_f16_16x16x16_f16_w64(
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x half> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 8, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_i32_16x16x16_iu8_w64(
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    store <4 x i32> [[TMP0]], ptr addrspace(1) [[OUT:%.*]], align 16, !tbaa [[TBAA4]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: @test_amdgcn_wmma_i32_16x16x16_iu4_w64(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_fp8_fp8_w32(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_fp8_bf8_w32(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_bf8_fp8_w32(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_amdgcn_wmma_f32_16x16x16_bf8_bf8_w32(
// CHECK-NEXT:  entry:
...
// CHECK-LABEL: @test_amdgcn_wmma_i32_16x16x32_iu4_w32(
// CHECK-NEXT:  entry:
