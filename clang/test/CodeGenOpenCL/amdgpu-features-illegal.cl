...
// RUN: not %clang_cc1 -triple amdgcn -target-cpu gfx1210 -target-feature +wavefrontsize64 -o /dev/null %s 2>&1 | FileCheck %s --check-prefix=GFX1210
...
// GFX1210: error: option 'wavefrontsize64' cannot be specified on this target
