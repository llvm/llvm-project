...
// RUN: %clang_cc1 %s -cl-std=CL2.0 -finclude-default-header -fdeclare-opencl-builtins -emit-llvm -O0 -triple amdgpu -o - | FileCheck --check-prefix=SZ64 --check-prefix=AMDGCN %s
// RUN: %clang_cc1 %s -cl-std=CL2.0 -finclude-default-header -fdeclare-opencl-builtins -emit-llvm -O0 -triple amdgpu---opencl -o - | FileCheck --check-prefix=SZ64 --check-prefix=AMDGCN %s
...
//SZ32: ptrtoint ptr addrspace(4) [[CAST1]] to i32
//SZ32: ptrtoint ptr addrspace(4) %{{.*}} to i32
...
//SZ32: ptrtoint ptr addrspace(4) %{{.*}} to i32
//SZ32: ptrtoint ptr addrspace(4) [[CASTC1]] to i32
...
//SZ64ONLY: ptrtoint ptr addrspace(4) %{{.*}} to i64
//SZ64ONLY: ptrtoint ptr addrspace(4) [[CASTC2]] to i64
...
//AMDGCN: ptrtoint ptr %{{.*}} to i64
//AMDGCN: ptrtoint ptr [[CASTC3]] to i64
...
//SZ32: ptrtoint ptr addrspace(4) [[CASTLG1]] to i32
//SZ32: ptrtoint ptr addrspace(4) %{{.*}} to i32
...
//SZ64ONLY: ptrtoint ptr addrspace(4) [[CASTLG2]] to i64
//SZ64ONLY: ptrtoint ptr addrspace(4) %{{.*}} to i64
...
//AMDGCN: ptrtoint ptr [[CASTLG3]] to i64
//AMDGCN: ptrtoint ptr %{{.*}} to i64
...
//SZ32: ptrtoint ptr addrspace(4) %{{.*}} to i32
//SZ32: ptrtoint ptr addrspace(4) [[CASTGL1]] to i32
...
//SZ64ONLY: ptrtoint ptr addrspace(4) %{{.*}} to i64
//SZ64ONLY: ptrtoint ptr addrspace(4) [[CASTGL2]] to i64
...
//AMDGCN: ptrtoint ptr %{{.*}} to i64
//AMDGCN: ptrtoint ptr [[CASTGL3]] to i64
