...
// RUN: %clang_cc1 -cl-std=CL2.0 -triple amdgpu9.00-unknown-unknown  -emit-llvm -o - %s | FileCheck %s
// RUN: %clang_cc1 -cl-std=CL2.0 -triple amdgpu10.10-unknown-unknown -emit-llvm -o - %s | FileCheck %s
