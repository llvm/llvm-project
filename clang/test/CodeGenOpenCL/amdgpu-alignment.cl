...
// RUN: %clang_cc1 -triple amdgpu-unknown-unknown -disable-llvm-passes -emit-llvm -o - %s | FileCheck %s
// RUN: %clang_cc1 -triple amdgpu-unknown-unknown-opencl -disable-llvm-passes -emit-llvm -o - %s | FileCheck %s
