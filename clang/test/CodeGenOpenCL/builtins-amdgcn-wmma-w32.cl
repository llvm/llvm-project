...
// RUN: %clang_cc1 -triple amdgpu11.00-unknown-unknown -DWMMA_GFX1100_TESTS -emit-llvm -o - %s | FileCheck %s --check-prefix=CHECK-GFX1100
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <16 x half> noundef [[A:%.*]], <16 x half> noundef [[B:%.*]], <8 x float> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
...
// CHECK-GFX1100-NEXT:    store <8 x float> [[TMP0]], ptr addrspace(1) [[OUT]], align 32, !tbaa [[CHAR_TBAA7:![0-9]+]]
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <16 x i16> noundef [[A:%.*]], <16 x i16> noundef [[B:%.*]], <8 x float> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-GFX1100-NEXT:  [[ENTRY:.*:]]
...
// CHECK-GFX1100-NEXT:    store <8 x float> [[TMP0]], ptr addrspace(1) [[OUT]], align 32, !tbaa [[CHAR_TBAA7]]
// CHECK-GFX1100-NEXT:    ret void
//
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <16 x half> noundef [[A:%.*]], <16 x half> noundef [[B:%.*]], <16 x half> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-GFX1100-NEXT:  [[ENTRY:.*:]]
...
// CHECK-GFX1100-NEXT:    store <16 x half> [[TMP0]], ptr addrspace(1) [[OUT]], align 32, !tbaa [[CHAR_TBAA7]]
// CHECK-GFX1100-NEXT:    ret void
//
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <16 x i16> noundef [[A:%.*]], <16 x i16> noundef [[B:%.*]], <16 x i16> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-GFX1100-NEXT:  [[ENTRY:.*:]]
...
// CHECK-GFX1100-NEXT:    store <16 x i16> [[TMP0]], ptr addrspace(1) [[OUT]], align 32, !tbaa [[CHAR_TBAA7]]
// CHECK-GFX1100-NEXT:    ret void
//
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <4 x i32> noundef [[A:%.*]], <4 x i32> noundef [[B:%.*]], <8 x i32> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-GFX1100-NEXT:  [[ENTRY:.*:]]
...
// CHECK-GFX1100-NEXT:    store <8 x i32> [[TMP0]], ptr addrspace(1) [[OUT]], align 32, !tbaa [[CHAR_TBAA7]]
// CHECK-GFX1100-NEXT:    ret void
//
...
// CHECK-GFX1100-SAME: ptr addrspace(1) nofree noundef writeonly captures(none) initializes((0, 32)) [[OUT:%.*]], <2 x i32> noundef [[A:%.*]], <2 x i32> noundef [[B:%.*]], <8 x i32> noundef [[C:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-GFX1100-NEXT:  [[ENTRY:.*:]]
...
#endif
//.
// CHECK-GFX1100: [[META5:![0-9]+]] = !{!"omnipotent char", [[META6:![0-9]+]], i64 0}
// CHECK-GFX1100: [[META6]] = !{!"Simple C/C++ TBAA"}
// CHECK-GFX1100: [[CHAR_TBAA7]] = !{[[META5]], [[META5]], i64 0}
//.
