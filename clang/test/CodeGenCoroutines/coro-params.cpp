...
// CHECK: define{{.*}} void @_Z1fi8MoveOnly11MoveAndCopy10TrivialABI(i32 noundef %val, ptr nofreeobj noundef align 4 dereferenceable(4) %[[MoParam:.+]], ptr nofreeobj noundef align 4 dereferenceable(4) %[[McParam:.+]], i32 %[[TrivialParam:.+]]) #0 personality ptr @__gxx_personality_v0
...
// CHECK-LABEL: void @_Z16dependent_paramsI1A1BEvT_T0_S3_(ptr nofreeobj noundef align 4 dereferenceable(512) %x, ptr nofreeobj noundef align 4 dereferenceable(512) %0, ptr nofreeobj noundef align 4 dereferenceable(512) %y)
