...
// RUN: %clang_cc1 %s -std=c++20 -triple x86_64 -emit-llvm -disable-llvm-passes %s -fcxx-type-aware-allocators -o - | FileCheck %s
// RUN: %clang_cc1 %s -std=c++26 -triple x86_64 -emit-llvm -disable-llvm-passes %s -fcxx-type-aware-allocators -o - | FileCheck %s
