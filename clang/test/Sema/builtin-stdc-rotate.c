...
void test_errors(int si, float f) {
  ...
  __builtin_stdc_rotate_left(si, 1); // expected-error {{1st argument must be a scalar unsigned integer type}}
  __builtin_stdc_rotate_left(-5, 1); // expected-error {{1st argument must be a scalar unsigned integer type}}

  __builtin_stdc_rotate_left(ui, f); // expected-error {{2nd argument must be a scalar signed integer type}}
  __builtin_stdc_rotate_left(ui, 1.5); // expected-error {{2nd argument must be a scalar signed integer type}}

  __builtin_stdc_rotate_right(3.0, 1.5); // expected-error {{1st argument must be a scalar unsigned integer type}}
}
