...
void checkDeprecated() {
  ...
  bothDeprecated();
#ifndef INVERTED
  // expected-warning@-2 {{'bothDeprecated' is deprecated: first deprecated in macOS 10.14 and first deprecated in macCatalyst 12}}
#else
  // expected-warning@-4 {{'bothDeprecated' is deprecated: first deprecated in macCatalyst 12 and first deprecated in macOS 10.14}}
#endif
  macOSDeprecated(); // expected-warning {{'macOSDeprecated' is deprecated: first deprecated in macOS 10.14}}
  iOSDeprecated();   // expected-warning {{'iOSDeprecated' is deprecated: first deprecated in macCatalyst 12}}
  bothNotDeprecated();
}
...
void checkUnavailable() {
  ...
  bothObsoleted();
#ifndef INVERTED
  // expected-error@-2 {{'bothObsoleted' is unavailable: obsoleted in macOS 10.14 and obsoleted in macCatalyst 12}}
#else
  // expected-error@-4 {{'bothObsoleted' is unavailable: obsoleted in macCatalyst 12 and obsoleted in macOS 10.14}}
#endif
}
...
// expected-warning@-1 {{'ZipperedTypedefDifferentOffendingDecl' is deprecated: first deprecated in macCatalyst 12}}
...
#ifndef INVERTED
  // expected-warning@-2 {{'ZipperedTypedefDifferentOffendingDecl_t' is deprecated: first deprecated in macOS 10.14 and first deprecated in macCatalyst 12}}
#else
  // expected-warning@-4 {{'ZipperedTypedefDifferentOffendingDecl_t' is deprecated: first deprecated in macCatalyst 12 and first deprecated in macOS 10.14}}
#endif
}
...
#ifndef INVERTED
  // expected-warning@-2 {{'bothDeprecatedDiffReplacement' is deprecated: first deprecated in macOS 10.14 and first deprecated in macCatalyst 12}}
#else
  // expected-warning@-4 {{'bothDeprecatedDiffReplacement' is deprecated: first deprecated in macCatalyst 12 and first deprecated in macOS 10.14}}
#endif
...
#ifndef INVERTED
  // expected-warning@-2 {{'IntroducedLaterBoth' is only available on macOS 10.15 and macCatalyst 13 or newer}}
#else
  // expected-warning@-4 {{'IntroducedLaterBoth' is only available on macCatalyst 13 and macOS 10.15 or newer}}
#endif
};
