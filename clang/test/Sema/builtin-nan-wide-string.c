...
// c-warning@-1 {{incompatible pointer types passing 'int[1]' to parameter of type 'const char *'}}
// cxx-error@-2 {{cannot initialize a parameter of type 'const char *' with an lvalue of type 'const wchar_t[1]'}}
...
// c-warning@-1 {{incompatible pointer types passing 'unsigned short[1]' to parameter of type 'const char *'}}
// cxx-error@-2 {{cannot initialize a parameter of type 'const char *' with an lvalue of type 'const char16_t[1]'}}
...
// c-warning@-1 {{incompatible pointer types passing 'unsigned int[1]' to parameter of type 'const char *'}}
// cxx-error@-2 {{cannot initialize a parameter of type 'const char *' with an lvalue of type 'const char32_t[1]'}}
