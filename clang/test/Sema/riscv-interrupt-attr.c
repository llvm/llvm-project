...
__attribute__((interrupt("machine", "machine", "machine"))) void foo_three_machine_args(void) {} // expected-error {{RISC-V 'interrupt' attribute contains invalid combination of interrupt types}}
