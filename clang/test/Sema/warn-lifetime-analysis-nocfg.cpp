...
struct DanglingGslPtrField {
  ...
  DanglingGslPtrField(int i) : p(&i) {} // cfg-warning {{stack memory associated with parameter 'i' escapes to a field 'p' which will dangle}}
  DanglingGslPtrField() : p2(MyLongOwnerWithConversion{}) {}  // expected-warning {{initializing pointer member 'p2' to point to a temporary object whose lifetime is shorter than the lifetime of the constructed object}} \
                                                              // cfg-warning {{stack memory associated with local temporary object escapes to a field 'p2' which will dangle}}
  DanglingGslPtrField(double) : p(MyIntOwner{}) {}  // expected-warning {{initializing pointer member 'p' to point to a temporary object whose lifetime is shorter than the lifetime of the constructed object}} \
                                                    // cfg-warning {{stack memory associated with local temporary object escapes to a field 'p' which will dangle}}
  DanglingGslPtrField(MyIntOwner io) : p(io) {} // cfg-warning {{stack memory associated with parameter 'io' escapes to a field 'p' which will dangle}}
  DanglingGslPtrField(MyLongOwnerWithConversion lo) : p2(lo) {} // cfg-warning {{stack memory associated with parameter 'lo' escapes to a field 'p2' which will dangle}}
};
...
struct Test {
  Test(Foo2 foo) : bar(foo.bar.get()),  // cfg-warning-re {{stack memory associated with parameter 'foo' may escape to a field 'bar' which will dangle. {{.*}} may have been moved}}
