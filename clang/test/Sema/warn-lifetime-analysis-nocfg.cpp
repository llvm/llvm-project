...
MyIntPointer danglingGslPtrFromLocal() {
  ...
  return &j; // cfg-warning {{address of stack memory associated with local variable 'j' returned}} cfg-note {{returned here}}
}
...
MyIntPointer daglingGslPtrFromLocalOwner() {
  ...
  return localOwner; // expected-warning {{address of stack memory associated with local variable 'localOwner' returned}} \
                     // cfg-warning {{address of stack memory associated with local variable 'localOwner' returned}} cfg-note {{returned here}}
}
...
MyIntPointer danglingGslPtrFromTemporary() {
  return MyIntOwner{}; // expected-warning {{returning address of local temporary object}} \
                       // cfg-warning {{returning address of local temporary object}} cfg-note {{returned here}}
}
...
auto lifetimebound_make_unique_single_param() {
  return std::make_unique<LifetimeBoundCtor>(MyIntOwner{}); // tu-warning {{returning address of local temporary object}} tu-note {{returned here}}
}
...
int &modelAnyCast() {
  return std::any_cast<int&>(std::any{}); // expected-warning {{returning reference to local temporary object}} \
                                          // cfg-warning {{returning reference to local temporary object}} cfg-note {{returned here}}
}
...
const char *danglingRawPtrFromLocal() {
  ...
  return s.c_str(); // expected-warning {{address of stack memory associated with local variable 's' returned}} \
                    // cfg-warning {{address of stack memory associated with local variable 's' returned}} cfg-note {{returned here}}
}
...
int &danglingRawPtrFromLocal2() {
  ...
  return o.value(); // expected-warning {{reference to stack memory associated with local variable 'o' returned}} \
                    // cfg-warning {{reference to stack memory associated with local variable 'o' returned}} cfg-note {{returned here}}
}
...
std::string_view containerWithAnnotatedElements() {
  ...
  return local.at(0); // expected-warning {{address of stack memory associated with local variable}} \
                      // cfg-warning {{address of stack memory associated with local variable 'local' returned}} cfg-note {{returned here}}
}
...
std::string_view localUniquePtr(int i) {
  ...
  if (i)
    return *c1; // expected-warning {{address of stack memory associated with local variable}} \
                // cfg-warning {{address of stack memory associated with local variable 'c1' returned}} cfg-note {{returned here}}
...
std::string_view localOptional(int i) {
  ...
  if (i)
    return o.value(); // expected-warning {{address of stack memory associated with local variable}} \
                      // cfg-warning {{address of stack memory associated with local variable 'o' returned}} cfg-note {{returned here}}
...
// Warning caught by CFG analysis.
  ...
  int &p = *localOwner // cfg-warning {{reference to stack memory associated with local variable 'localOwner' returned}}
            .get();
...
std::string_view test_str_local() {
  ...
  return *std::find(v.begin(), // cfg-warning {{address of stack memory associated with local variable 'v' returned}} cfg-note {{returned here}}
                    v.end(), "42");
}
std::string_view test_str_temporary() {
  return *std::find(GetTemporaryString().begin(), // cfg-warning {{returning address of local temporary object}} cfg-note {{returned here}}
...
S test(std::vector<int> a) {
  return S(a);  // expected-warning {{address of stack memory associated with}} \
                // cfg-warning {{address of stack memory associated with parameter 'a' returned}} cfg-note {{returned here}}
}
...
FooView test3(int i, std::optional<Foo> a) {
  if (i)
    return *a; // expected-warning {{address of stack memory}} \
               // cfg-warning {{address of stack memory associated with parameter 'a' returned}} \
...
std::string_view test2() {
  ...
  return k.value(); // expected-warning {{address of stack memory associated}} \
                    // cfg-warning {{address of stack memory associated with local variable 'k' returned}} cfg-note {{returned here}}
}
} // namespace GH108272
...
Span<int*> test6(std::vector<int*> v) {
  ...
  return v; // expected-warning {{address of stack memory}} \
            // cfg-warning {{address of stack memory associated with parameter 'v' returned}} cfg-note {{returned here}}
}
...
Span<int*> test9(StatusOr<std::vector<int*>> aa) {
  return aa.valueLB(); // expected-warning {{address of stack memory associated}} \
                       // cfg-warning {{address of stack memory associated with parameter 'aa' returned}} cfg-note {{returned here}}
...
const int& test12(Span<int> a) {
  return a.getFieldLB(); // expected-warning {{reference to stack memory associated}} \
                         // cfg-warning {{reference to stack memory associated with parameter 'a' returned}} cfg-note {{returned here}}
...
std::string_view test2_1(Foo<std::string> r1, Foo<std::string_view> r2) {
  ...
  return r1.get(); // expected-warning {{address of stack}} \
                   // cfg-warning {{address of stack memory associated with parameter 'r1' returned}} cfg-note {{returned here}}
}
...
Pointer test3(Bar bar) {
  ...
  use(p);                     // cfg-note {{later used here}}
  return bar;                 // expected-warning {{address of stack}} cfg-warning {{address of stack memory associated with parameter 'bar' returned}} cfg-note {{returned here}}
}
...
std::string_view test_view_loop_var(std::vector<std::string> strings) {
  for (std::string_view s : strings) {  // cfg-warning {{address of stack memory associated with parameter 'strings' returned}}
...
std::string_view test_string_ref_var(std::vector<std::string> strings) {
  for (const std::string& s : strings) {  // cfg-warning {{address of stack memory associated with parameter 'strings' returned}}
    return s; //cfg-note {{returned here}}
  }
  return "";
}
...
std::string_view test_opt_strings(std::optional<std::vector<std::string>> strings_or) {
  for (const std::string& s : *strings_or) {  // cfg-warning {{address of stack memory associated with parameter 'strings_or' returned}}
    return s; //cfg-note {{returned here}}
  }
  return "";
}
...
std::string_view test() {
  ...
  return strings.begin()->data(); // cfg-warning {{address of stack memory associated with local variable 'strings' returned}} cfg-note {{returned here}}
}
