...
int a __attribute((model("tiny")));    // aarch64-error {{the model attribute is not supported on this target}} \
                                       // loongarch64-error {{code model 'tiny' is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int b __attribute((model("small")));   // aarch64-error {{the model attribute is not supported on this target}} \
                                       // loongarch64-error {{code model 'small' is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int c __attribute((model("normal")));  // aarch64-error {{the model attribute is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int d __attribute((model("kernel")));  // aarch64-error {{the model attribute is not supported on this target}} \
                                       // loongarch64-error {{code model 'kernel' is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int e __attribute((model("medium")));  // aarch64-error {{the model attribute is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int f __attribute((model("large")));   // aarch64-error {{the model attribute is not supported on this target}} \
                                       // loongarch64-error {{code model 'large' is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
int g __attribute((model("extreme"))); // aarch64-error {{the model attribute is not supported on this target}} \
                                       // mips64-error {{the model attribute is not supported on this target}} \
                                       // powerpc64-error {{the model attribute is not supported on this target}} \
                                       // riscv64-error {{the model attribute is not supported on this target}} \
                                       // x86_64-error {{the model attribute is not supported on this target}}
