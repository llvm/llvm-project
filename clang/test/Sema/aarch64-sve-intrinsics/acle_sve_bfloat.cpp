...
{
  // expected-error@+1 {{'svcreate2_bf16' needs target feature (sve,bf16)|sme}}
  svcreate2_bf16(bf16, bf16);
  // expected-error@+1 {{'svcreate3_bf16' needs target feature (sve,bf16)|sme}}
  svcreate3_bf16(bf16, bf16, bf16);
  // expected-error@+1 {{'svcreate4_bf16' needs target feature (sve,bf16)|sme}}
  svcreate4_bf16(bf16, bf16, bf16, bf16);
  // expected-error@+1 {{'svget2_bf16' needs target feature (sve,bf16)|sme}}
  svget2_bf16(bf16x2, 1);
  // expected-error@+1 {{'svget3_bf16' needs target feature (sve,bf16)|sme}}
  svget3_bf16(bf16x3, 1);
  // expected-error@+1 {{'svget4_bf16' needs target feature (sve,bf16)|sme}}
  svget4_bf16(bf16x4, 1);
  // expected-error@+1 {{'svld1_bf16' needs target feature (sve,bf16)|sme}}
  svld1_bf16(pg, const_bf16_ptr);
  // expected-error@+1 {{'svld1_vnum_bf16' needs target feature (sve,bf16)|sme}}
  svld1_vnum_bf16(pg, const_bf16_ptr, i64);
  // expected-error@+1 {{'svld1rq_bf16' needs target feature (sve,bf16)|sme}}
  ...
  // expected-error@+1 {{'svldnt1_bf16' needs target feature (sve,bf16)|sme}}
  svldnt1_bf16(pg, const_bf16_ptr);
  // expected-error@+1 {{'svldnt1_vnum_bf16' needs target feature (sve,bf16)|sme}}
  svldnt1_vnum_bf16(pg, const_bf16_ptr, i64);
  // expected-error@+1 {{'svrev_bf16' needs target feature (sve,bf16)|sme}}
  svrev_bf16(bf16);
  // expected-error@+1 {{'svset2_bf16' needs target feature (sve,bf16)|sme}}
  svset2_bf16(bf16x2, 1, bf16);
  // expected-error@+1 {{'svset3_bf16' needs target feature (sve,bf16)|sme}}
  svset3_bf16(bf16x3, 1, bf16);
  // expected-error@+1 {{'svset4_bf16' needs target feature (sve,bf16)|sme}}
  svset4_bf16(bf16x4, 1, bf16);
  // expected-error@+1 {{'svst1_bf16' needs target feature (sve,bf16)|sme}}
  svst1_bf16(pg, bf16_ptr, bf16);
  // expected-error@+1 {{'svst1_vnum_bf16' needs target feature (sve,bf16)|sme}}
  svst1_vnum_bf16(pg, bf16_ptr, i64, bf16);
  // expected-error@+1 {{'svstnt1_bf16' needs target feature (sve,bf16)|sme}}
  svstnt1_bf16(pg, bf16_ptr, bf16);
  // expected-error@+1 {{'svstnt1_vnum_bf16' needs target feature (sve,bf16)|sme}}
  svstnt1_vnum_bf16(pg, bf16_ptr, i64, bf16);
  // expected-error@+1 {{'svtrn1_bf16' needs target feature (sve,bf16)|sme}}
  svtrn1_bf16(bf16, bf16);
  // expected-error@+1 {{'svtrn1q_bf16' needs target feature sve,bf16}}
  svtrn1q_bf16(bf16, bf16);
  // expected-error@+1 {{'svtrn2_bf16' needs target feature (sve,bf16)|sme}}
  ...
  svundef_bf16();
  // expected-error@+1 {{'svundef2_bf16' needs target feature (sve,bf16)|sme}}
  svundef2_bf16();
  // expected-error@+1 {{'svundef3_bf16' needs target feature (sve,bf16)|sme}}
  svundef3_bf16();
  // expected-error@+1 {{'svundef4_bf16' needs target feature (sve,bf16)|sme}}
  svundef4_bf16();
  // expected-error@+1 {{'svuzp1_bf16' needs target feature (sve,bf16)|sme}}
  svuzp1_bf16(bf16, bf16);
  // expected-error@+1 {{'svuzp1q_bf16' needs target feature sve,bf16}}
  svuzp1q_bf16(bf16, bf16);
  // expected-error@+1 {{'svuzp2_bf16' needs target feature (sve,bf16)|sme}}
  svuzp2_bf16(bf16, bf16);
  // expected-error@+1 {{'svuzp2q_bf16' needs target feature sve,bf16}}
  svuzp2q_bf16(bf16, bf16);
  // expected-error@+1 {{'svzip1_bf16' needs target feature (sve,bf16)|sme}}
  svzip1_bf16(bf16, bf16);
  // expected-error@+1 {{'svzip1q_bf16' needs target feature sve,bf16}}
  svzip1q_bf16(bf16, bf16);
  // expected-error@+1 {{'svzip2_bf16' needs target feature (sve,bf16)|sme}}
