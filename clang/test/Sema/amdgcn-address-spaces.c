...
void *p2(void _AS2 *p) {
  return p;
} // expected-error {{returning '_AS2 void *' from a function with result type
...
void *pi(void _AS999 *p) {
  return p;
} // expected-error {{returning '_AS999 void *' from a function with result type
  // 'void *' changes address space of pointer}}
void *pc(void __attribute__((opencl_local)) * p) {
  return p;
} // expected-error {{returning '__local void *' from a function with result
  // type 'void *' changes address space of pointer}}
void _AS1 *r0(void _AS1 *p) { return p; }
void _AS1 *r1(void *p) {
  return p;
} // expected-error {{returning 'void *' from a function with result type '_AS1
  // void *' changes address space of pointer}}
