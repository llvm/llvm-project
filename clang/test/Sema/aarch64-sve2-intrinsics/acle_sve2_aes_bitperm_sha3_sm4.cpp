...
{
  // expected-error@+2 {{'svaesd_u8' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  // overload-error@+1 {{'svaesd' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  SVE_ACLE_FUNC(svaesd,_u8,,)(svundef_u8(), svundef_u8());
  // expected-error@+2 {{'svaese_u8' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  // overload-error@+1 {{'svaese' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  SVE_ACLE_FUNC(svaese,_u8,,)(svundef_u8(), svundef_u8());
  // expected-error@+2 {{'svaesimc_u8' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  // overload-error@+1 {{'svaesimc' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  SVE_ACLE_FUNC(svaesimc,_u8,,)(svundef_u8());
  // expected-error@+2 {{'svaesmc_u8' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  // overload-error@+1 {{'svaesmc' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}
  SVE_ACLE_FUNC(svaesmc,_u8,,)(svundef_u8());
  // expected-error@+2 {{'svbdep_u8' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  ...
  // expected-error@+2 {{'svbdep_n_u8' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbdep' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbdep,_n_u8,,)(svundef_u8(), u8);
  // expected-error@+2 {{'svbext_u8' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_u8,,)(svundef_u8(), svundef_u8());
  // expected-error@+2 {{'svbext_n_u8' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_n_u8,,)(svundef_u8(), u8);
  // expected-error@+2 {{'svbgrp_u8' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  ...
  // expected-error@+2 {{'svbdep_n_u16' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbdep' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbdep,_n_u16,,)(svundef_u16(), u16);
  // expected-error@+2 {{'svbext_u16' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_u16,,)(svundef_u16(), svundef_u16());
  // expected-error@+2 {{'svbext_n_u16' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_n_u16,,)(svundef_u16(), u16);
  // expected-error@+2 {{'svbgrp_u16' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbgrp' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  ...
  // expected-error@+2 {{'svbdep_n_u32' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbdep' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbdep,_n_u32,,)(svundef_u32(), u32);
  // expected-error@+2 {{'svbext_u32' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_u32,,)(svundef_u32(), svundef_u32());
  // expected-error@+2 {{'svbext_n_u32' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_n_u32,,)(svundef_u32(), u32);
  // expected-error@+2 {{'svbgrp_u32' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbgrp' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbgrp,_u32,,)(svundef_u32(), svundef_u32());
  // expected-error@+2 {{'svbgrp_n_u32' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbgrp' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  ...
  // expected-error@+2 {{'svbdep_n_u64' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbdep' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbdep,_n_u64,,)(svundef_u64(), u64);
  // expected-error@+2 {{'svbext_u64' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_u64,,)(svundef_u64(), svundef_u64());
  // expected-error@+2 {{'svbext_n_u64' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbext' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbext,_n_u64,,)(svundef_u64(), u64);
  // expected-error@+2 {{'svbgrp_u64' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbgrp' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbgrp,_u64,,)(svundef_u64(), svundef_u64());
  // expected-error@+2 {{'svbgrp_n_u64' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  // overload-error@+1 {{'svbgrp' needs target feature (sve,sve-bitperm)|(sme,ssve-bitperm)}}
  SVE_ACLE_FUNC(svbgrp,_n_u64,,)(svundef_u64(), u64);
  // expected-error@+2 {{'svpmullb_pair_u64' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}}
  // overload-error@+1 {{'svpmullb_pair' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}}
  SVE_ACLE_FUNC(svpmullb_pair,_u64,,)(svundef_u64(), svundef_u64());
  // expected-error@+2 {{'svpmullb_pair_n_u64' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}}
  // overload-error@+1 {{'svpmullb_pair' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}}
  SVE_ACLE_FUNC(svpmullb_pair,_n_u64,,)(svundef_u64(), u64);
  // expected-error@+2 {{'svpmullt_pair_u64' needs target feature (sve,sve-aes)|(sme,ssve-aes)}}}
