...
vector unsigned char test_bcdshift(void) {
  ...
  vector unsigned char res_b = __builtin_ppc_bcdshift(vec, f, i); // expected-error {{argument 1 must be of integer type}}
...
vector unsigned char test_bcdshiftround(void) {
  ...
  vector unsigned char res_b = __builtin_ppc_bcdshiftround(vec, f, i); // expected-error {{argument 1 must be of integer type}}
...
vector unsigned char test_bcdtruncate(void) {
  ...
  vector unsigned char res_b =  __builtin_ppc_bcdtruncate(vec, f, i); // expected-error {{argument 1 must be of integer type}}
