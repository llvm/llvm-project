...
void simple_case() {
  ...
  }             // expected-note {{local variable 's' destroyed here}}
...
void multiple_pointers() {
  ...
  }             // expected-note 3 {{local variable 's' destroyed here}}
  (void)*p;     // expected-note {{later used here}}
  (void)*q;     // expected-note {{later used here}}
...
void single_pointer_multiple_loans(bool cond) {
  ...
  }             // expected-note {{local variable 't' destroyed here}}
...
void if_branch(bool cond) {
  ...
  }             // expected-note {{local variable 'temp' destroyed here}}
  (void)*p;     // expected-note {{later used here}}
}
...
void potential_together(bool cond) {
  ...
  }                     // expected-note 2 {{local variable 's' destroyed here}}
...
void loop_with_break(bool cond) {
  ...
  for (int i = 0; i < 10; ++i) {
    if (cond) {
      ...
      break;     // expected-note {{local variable 'temp' destroyed here}}
    }           
  } 
  (void)*p;     // expected-note {{later used here}}
}
...
void multiple_expiry_of_same_loan(bool cond) {
  ...
  for (int i = 0; i < 10; ++i) {
    ...
    if (cond) {
      ...
      break;       // expected-note {{local variable 'unsafe' destroyed here}} 
    }
  }
  (void)*p;       // expected-note {{later used here}}
  ...
  for (int i = 0; i < 10; ++i) {
    if (cond) {
      ...
      break;          // expected-note {{local variable 'unsafe2' destroyed here}}
    }
  }
  (void)*p;           // expected-note {{later used here}}
...
void switch_uaf(int mode) {
  ...
  case 1: {
    ...
    break;      // expected-note {{local variable 'temp1' destroyed here}}
  }
  case 2: {
    MyObj temp2;
    p = &temp2; // expected-warning {{does not live long enough}}
    break;      // expected-note {{local variable 'temp2' destroyed here}}
  }
  default: {
    MyObj temp2;
    p = &temp2; // expected-warning {{does not live long enough}}
...
void switch_gsl(int mode) {
  ...
  default: {
    ...
    break;      // expected-note {{local variable 'temp3' destroyed here}}
  }
  }
...
void loan_from_previous_iteration(MyObj safe, bool condition) {
  ...
  while (condition) {
    ...
    (void)*p;
    (void)*q;   // expected-note {{later used here}}
  }             // expected-note {{local variable 'x' destroyed here}}
}
...
void trivial_int_uaf() {
  ...
  }            // expected-note {{local variable 'b' destroyed here}}
...
void test_view_pointer() {
  ...
  }              // expected-note {{local variable 'v' destroyed here}}
...
void test_view_double_pointer() {
  ...
  }              // expected-note {{local variable 'vp' destroyed here}}
...
void test_lifetimebound_multi_level() {
  ...
  }                   // expected-note {{local variable 'pp' destroyed here}}
...
MyObj* uaf_before_uar() {
  ...
  }                  // expected-note {{local variable 'local_obj' destroyed here}}
...
void lifetimebound_simple_function() {
  ...
  }                    // expected-note {{local variable 'obj' destroyed here}}
  v.use();             // expected-note {{later used here}}
}
...
void lifetimebound_multiple_args_definite() {
  ...
  }                              // expected-note {{local variable 'obj1' destroyed here}} expected-note {{local variable 'obj2' destroyed here}}
  v.use();                       // expected-note 2 {{later used here}}
}
  ...
  View v = safe;
  {
    ...
    if (cond) {
      ...
      v = Choose(true,
                 obj1,             // expected-warning {{local variable 'obj1' does not live long enough}}
                 obj2);            // expected-warning {{local variable 'obj2' does not live long enough}}
    }                              // expected-note {{local variable 'obj2' destroyed here}}
  }                                // expected-note {{local variable 'obj1' destroyed here}}
  v.use();                         // expected-note 2 {{later used here}}
}
...
void lifetimebound_partial_safety(bool cond) {
  ...
  }                       // expected-note {{local variable 'temp_obj' destroyed here}}
  v.use();                // expected-note {{later used here}}
}
...
void lifetimebound_make_unique() {
  ...
  }                                                 // tu-note {{local variable 'obj' destroyed here}}
...
void lifetimebound_make_unique_temp() {
  std::unique_ptr<LifetimeBoundCtor> ptr = std::make_unique<LifetimeBoundCtor>(MyObj()); // tu-warning {{temporary object does not live long enough}} \
                                                                                         // tu-note {{temporary object destroyed here}} \
...
void lifetimebound_make_unique_multi_params() {
  ...
  } // tu-note {{local variable 'obj_short' destroyed here}}
  (void)ptr; // tu-note {{later used here}}
}
...
void conditional_operator_two_unsafe_branches(bool cond) {
  ...
  }  // expected-note {{local variable 'b' destroyed here}} expected-note {{local variable 'a' destroyed here}}
  (void)*p;  // expected-note 2 {{later used here}}
}
...
void conditional_operator_nested(bool cond) {
  ...
  }  // expected-note {{local variable 'a' destroyed here}} expected-note {{local variable 'd' destroyed here}} expected-note {{local variable 'b' destroyed here}} expected-note {{local variable 'c' destroyed here}}
...
void parentheses(bool cond) {
  ...
  }                  // expected-note {{local variable 'a' destroyed here}}
  (void)*p;          // expected-note {{later used here}}
...

  {
    ...
    p = &(cond ? (cond ? a     // expected-warning {{local variable 'a' does not live long enough}}.
               ...
               : (cond ? c     // expected-warning {{local variable 'c' does not live long enough}}.
                       : d));  // expected-warning {{local variable 'd' does not live long enough}}.
  }  // expected-note {{local variable 'b' destroyed here}} expected-note {{local variable 'c' destroyed here}} expected-note {{local variable 'a' destroyed here}} expected-note {{local variable 'd' destroyed here}}
  (void)*p;  // expected-note 4 {{later used here}}
  ...
  }  // expected-note {{local variable 'd' destroyed here}} expected-note {{local variable 'b' destroyed here}} expected-note {{local variable 'c' destroyed here}} expected-note {{local variable 'a' destroyed here}}
  (void)*p;  // expected-note 4 {{later used here}}
...
void use_temporary_after_destruction() {
  ...
  a = non_trivially_destructed_temporary(); // expected-warning {{temporary object does not live long enough}} \
                  expected-note {{temporary object destroyed here}}
...
void var_initializer() {
  View v = non_trivially_destructed_temporary() // expected-warning {{temporary object does not live long enough}} \
               ...
               .getView(); // expected-note {{temporary object destroyed here}}
  v.use(); // expected-note {{later used here}}
}
...
void foobar() {
  View view;
  {
    ...
    view = string_or. // expected-warning {{local variable 'string_or' does not live long enough}} \
            ...
            value();
  }                     // expected-note {{local variable 'string_or' destroyed here}}
...
void range_based_for_not_reference() {
  ...
  {
    MyObjStorage s;
    for (MyObj o : s) { // expected-note {{local variable 'o' destroyed here}}
...
void test_user_defined_deref_uaf() {
  ...
  }                     // expected-note {{local variable 'smart_ptr' destroyed here}}
  (void)*p;             // expected-note {{later used here}}
}
...
void test_user_defined_deref_chained() {
  ...
  }                       // expected-note {{local variable 'double_ptr' destroyed here}}
  (void)*p;               // expected-note {{later used here}}
}
...
void test_release_no_uaf() {
  ...
  }                     // expected-note {{local variable 'p' destroyed here}}
  (void)*r;             // expected-note {{later used here}}
}
} // namespace strict_warn_on_move
...
void test_temporary() {
  const std::string& x = S().x(); // expected-warning {{temporary object does not live long enough}} expected-note {{temporary object destroyed here}} \
                                  // expected-note {{result of call to 'x' aliases the storage of temporary object}}
  (void)x; // expected-note {{later used here}}

  const std::string& y = identity(S().x()); // expected-warning {{temporary object does not live long enough}} expected-note {{temporary object destroyed here}} \
                                            // expected-note {{result of call to 'x' aliases the storage of temporary object}} \
...
void test_lifetime_extension_ok() {
  const S& x = S();
  (void)x;
  const S& y = identity(S()); // expected-warning {{temporary object does not live long enough}} expected-note {{temporary object destroyed here}} \
                              // expected-note {{result of call to 'identity' aliases the storage of temporary object}}
  (void)y; // expected-note {{later used here}}
}
...
void uaf() {
  ...
  } // expected-note {{local variable 'str' destroyed here}}
  (void)view;  // expected-note {{later used here}}
}
...
void uaf_union() {
  ...
  } // expected-note {{local variable 'u' destroyed here}}
  (void)view;  // expected-note {{later used here}}
}
...
void uaf_anonymous_union() {
  ...
  } // expected-note {{local variable 'au' destroyed here}}
...
void test() {
  ...
  const MyObj* pTMA = mtf.memberA(MyObj()); // expected-warning {{temporary object does not live long enough}} // expected-note {{temporary object destroyed here}} \
                                            // expected-note {{result of call to 'memberA' aliases the storage of temporary object}}
  const MyObj* pTMB = mtf.memberB(MyObj()); // tu-warning {{temporary object does not live long enough}} // tu-note {{temporary object destroyed here}} \
                                            // tu-note {{result of call to 'memberB' aliases the storage of temporary object}}
  const MyObj* pTMC = mtf.memberC(MyObj()); // expected-warning {{temporary object does not live long enough}} // expected-note {{temporary object destroyed here}} \
...
void test_optional_arrow() {
  ...
  }                   // expected-note {{local variable 'opt' destroyed here}}
  (void)*p;           // expected-note {{later used here}}
}
...
void test_unique_ptr_arrow() {
  ...
  }                  // expected-note {{local variable 'up' destroyed here}}
  (void)*p;          // expected-note {{later used here}}
}
...
void pointer_arithmetic_use_after_scope() {
  ...
  }             // expected-note 3 {{local variable 'a' destroyed here}}
  (void)*p;     // expected-note {{later used here}}
...
void indexing_with_static_operator() {
  ...
  S& x = S()("1", // expected-note 2 {{expression aliases the storage of temporary object}}
             ...
             3);  // expected-warning {{temporary object does not live long enough}} expected-note 2 {{temporary object destroyed here}}
...
void from_lifetimebound_this_method() {
  ...
  }                       // expected-note {{local variable 'f' destroyed here}}
...
void owner_outlives_lifetimebound_source() {
  ...
  } // expected-note {{local variable 'local' destroyed here}}
...
void placement_new_int_basic() {
  ...
  }                         // expected-note {{local variable 'storage' destroyed here}}
  (void)*p;                 // expected-note {{later used here}}
}
...
struct S {
  ...
  void foo() {
    ...
    }                  // expected-note {{local variable 'num' destroyed here}}
...
struct T {
  ...
  void bar();
  void foo() {
    v = std::string("tmp"); // expected-warning {{temporary object does not live long enough}} expected-note {{temporary object destroyed here}}
    bar();                  // expected-note {{later used here}}
  }
};
...
void multiple_captures() {
  ...
  }                              // expected-note {{local variable 'val2' destroyed here}}
  (void)res;                     // expected-note {{later used here}}              
}
...
void multiple_local_captures() {
  ...
  }                              // expected-note {{local variable 'val2' destroyed here}} expected-note {{local variable 'val1' destroyed here}}
...
void capturing_multiple_locals() {
    ...
    }                               // expected-note {{local variable 'local1' destroyed here}} expected-note {{local variable 'local2' destroyed here}} 
    (void)v;                        // expected-note 2 {{later used here}}
}
