...
#if FAST
// expected-warning@+5 {{infinity defined via a macro will result in an undefined behavior due to the currently enabled floating-point options}}
#endif
#if NO_INFS
// expected-warning@+2 {{infinity defined via a macro will result in an undefined behavior due to the currently enabled floating-point options}}
#endif
  i = a == INFINITY;
#if FAST
// expected-warning@+5 {{infinity defined via a macro will result in an undefined behavior due to the currently enabled floating-point option}}
#endif
#if NO_INFS
// expected-warning@+2 {{infinity defined via a macro will result in an undefined behavior due to the currently enabled floating-point options}}
#endif
...
#if FAST
// expected-warning@+11 {{use of NaN results in undefined behavior due to the currently enabled floating-point options}}
#endif
#if FAST
...
#if FAST
// expected-warning@+11 {{infinity defined via a macro will result in an undefined behavior due to the currently enabled floating-point option}}
#endif
#if FAST
// expected-warning@+8 {{use of NaN results in undefined behavior due to the currently enabled floating-point options}}
#endif
