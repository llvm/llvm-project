...
// no-inf-no-nan-warning@+6 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-nan-warning@+5 {{use of NaN via a macro is undefined behavior due to the currently enabled floating-point options}}
// no-nan-warning@+4 {{use of NaN via a macro is undefined behavior due to the currently enabled floating-point options}}
...
// no-inf-no-nan-warning@+3 {{use of NaN is undefined behavior due to the currently enabled floating-point option}}
...
// no-inf-no-nan-warning@+8 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-nan-warning@+7 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-nan-warning@+6 {{use of NaN via a macro is undefined behavior due to the currently enabled floating-point options}}
// no-nan-warning@+5 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-nan-warning@+4 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
...
// no-inf-no-nan-mix-mode-warning@+2 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-nan-mix-mode-warning@+1 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
  i = std::isunordered(a, NAN);

// no-inf-no-nan-warning@+7 {{use of infinity via a macro is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-nan-warning@+6 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-warning@+5 {{use of infinity via a macro is undefined behavior due to the currently enabled floating-point options}}
// no-nan-warning@+4 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-mix-mode-warning@+3 {{use of infinity via a macro is undefined behavior due to the currently enabled floating-point options; mix of safe and unsafe math options are used. Check the order of you command line arguments}}
// no-inf-no-nan-mix-mode-warning@+2 {{use of NaN is undefined behavior due to the currently enabled floating-point options}}
// no-inf-no-nan-mix-mode-warning@+1 {{use of infinity via a macro is undefined behavior due to the currently enabled floating-point options; mix of safe and unsafe math options are used. Check the order of you command line arguments}}
