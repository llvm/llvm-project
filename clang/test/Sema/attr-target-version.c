...
//expected-warning@+1 {{version priority '32' is outside the allowed range [1-31]; ignoring priority}}
int __attribute__((target_version("aes;priority=32"))) priority_out_of_range(void) { return 0; }
