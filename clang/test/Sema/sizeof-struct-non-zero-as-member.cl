// RUN: %clang_cc1 -verify -fsyntax-only -triple amdgcn -target-cpu verde -emit-llvm -o - %s
// RUN: %clang_cc1 -verify -fsyntax-only -triple amdgcn--opencl -target-cpu verde -emit-llvm -o - %s
