...
// -O3 \ RUN:   -o - %s | FileCheck --check-prefix=AMDGCNSPIRV %s
// RUN: %clang_cc1 -triple amdgpu9.06-amd-amdhsa -x hip -emit-llvm
// -fcuda-is-device -O3 \ RUN:   -o - %s | FileCheck --check-prefix=AMDGPU %s
...
// #[[ATTR0:[0-9]+]] !max_work_group_size [[META8:![0-9]+]] { AMDGCNSPIRV-NEXT:
// [[ENTRY:.*:]] AMDGCNSPIRV-NEXT:    ret void
//
...
// #[[ATTR0]] !max_work_group_size [[META8]] { AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]]
...
// addrspace(4) #[[ATTR0]] !max_work_group_size [[META8]] { AMDGCNSPIRV-NEXT:
// [[ENTRY:.*:]] AMDGCNSPIRV-NEXT:    ret void
//
...
// AMDGCNSPIRV-SAME: ptr addrspace(2) nofree noundef readnone
// byref([[STRUCT_BYREF:%.*]]) align 4 captures(none) [[TMP0:%.*]])
// local_unnamed_addr addrspace(4) #[[ATTR0]] !max_work_group_size [[META8]] {
// AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]]
// AMDGCNSPIRV-NEXT:    ret void
//
// AMDGPU-LABEL: define dso_local amdgpu_kernel void @_Z2k55ByRef(
// AMDGPU-SAME: ptr addrspace(4) nofree noundef readnone
// byref([[STRUCT_BYREF:%.*]]) align 4 captures(none) [[TMP0:%.*]])
// local_unnamed_addr #[[ATTR0]] { AMDGPU-NEXT:  [[ENTRY:.*:]] AMDGPU-NEXT: ret
// void
//
...
// AMDGPU-SAME: <1 x i32> noundef [[TMP0:%.*]], <2 x i32> noundef [[TMP1:%.*]],
// <3 x i32> noundef [[TMP2:%.*]], <4 x i32> noundef [[TMP3:%.*]])
// local_unnamed_addr #[[ATTR0]] { AMDGPU-NEXT:  [[ENTRY:.*:]] AMDGPU-NEXT: ret
// void
//
...
// AMDGCNSPIRV-SAME: ptr addrspace(1) nofree noundef readnone captures(none)
// [[DOTCOERCE:%.*]]) local_unnamed_addr addrspace(4) #[[ATTR0]]
// !max_work_group_size [[META8]] { AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]]
// AMDGCNSPIRV-NEXT:    ret void
//
// AMDGPU-LABEL: define dso_local amdgpu_kernel void @_Z2k7Pj(
// AMDGPU-SAME: ptr addrspace(1) nofree noundef readnone captures(none)
// [[DOTCOERCE:%.*]]) local_unnamed_addr #[[ATTR0]] { AMDGPU-NEXT: [[ENTRY:.*:]]
// AMDGPU-NEXT:    ret void
//
...
// AMDGCNSPIRV-SAME: ptr nofree noundef readnone byref([[STRUCT_BYREF:%.*]])
// align 4 captures(none) [[TMP0:%.*]]) local_unnamed_addr addrspace(4)
// #[[ATTR0]] { AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]] AMDGCNSPIRV-NEXT:    ret void
//
// AMDGPU-LABEL: define dso_local void @_Z2f55ByRef(
// AMDGPU-SAME: ptr addrspace(5) nofree noundef readnone
// byref([[STRUCT_BYREF:%.*]]) align 4 captures(none) [[TMP0:%.*]])
// local_unnamed_addr #[[ATTR1]] { AMDGPU-NEXT:  [[ENTRY:.*:]] AMDGPU-NEXT: ret
// void
//
...
// AMDGCNSPIRV-SAME: <1 x i32> noundef [[TMP0:%.*]], <2 x i32> noundef
// [[TMP1:%.*]], <3 x i32> noundef [[TMP2:%.*]], <4 x i32> noundef [[TMP3:%.*]])
// local_unnamed_addr addrspace(4) #[[ATTR0]] { AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]]
// AMDGCNSPIRV-NEXT:    ret void
//
...
// AMDGCNSPIRV-SAME: ptr dead_on_unwind noalias nofree writable writeonly
// sret([[STRUCT_BYREF:%.*]]) align 4 captures(none) initializes((0, 68))
// [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(4) #[[ATTR1:[0-9]+]] {
// AMDGCNSPIRV-NEXT:  [[ENTRY:.*:]]
...
// false) AMDGCNSPIRV-NEXT:    ret void
//
// AMDGPU-LABEL: define dso_local void @_Z3f12v(
// AMDGPU-SAME: ptr addrspace(5) dead_on_unwind noalias nofree writable
// writeonly sret([[STRUCT_BYREF:%.*]]) align 4 captures(none) initializes((0,
// 68)) [[AGG_RESULT:%.*]]) local_unnamed_addr #[[ATTR2:[0-9]+]] { AMDGPU-NEXT:
// [[ENTRY:.*:]] AMDGPU-NEXT:    tail call void @llvm.memset.p5.i64(ptr
// addrspace(5) noundef align 4 dereferenceable(68) [[AGG_RESULT]], i8 0, i64
// 68, i1 false) AMDGPU-NEXT:    ret void
//
