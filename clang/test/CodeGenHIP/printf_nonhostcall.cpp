...
// RUN: %clang_cc1 -triple amdgpu-amd-amdhsa -x hip -emit-llvm -mprintf-kind=buffered -fcuda-is-device \
// RUN:   -o - %s | FileCheck --enable-var-scope %s
// RUN: %clang_cc1 -triple amdgpu-amd-amdhsa -x hip -emit-llvm -ffp-exception-behavior=strict -mprintf-kind=buffered -fcuda-is-device \
