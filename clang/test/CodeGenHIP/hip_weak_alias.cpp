...
// amdgpu-amd-amdhsa -emit-llvm-bc %s -o %t-host.bc RUN: %clang_cc1 -x hip
// -triple x86_64-unknown-linux-gnu -aux-triple amdgpu-amd-amdhsa -emit-llvm %s
// -o - | FileCheck %s --check-prefix=HOST RUN: %clang_cc1 -x hip -triple
// amdgpu-amd-amdhsa -aux-triple x86_64-unknown-linux-gnu -emit-llvm %s
// -fcuda-is-device -o - | FileCheck %s --check-prefix=DEVICE
...
// section "llvm.metadata" HOST: @HostFunc = weak alias i32 (), ptr @__HostFunc
...
// addrspacecast (ptr addrspace(1) @__hip_cuid_ to ptr)], section
// "llvm.metadata" DEVICE: @One = weak alias i32 (), ptr @__One DEVICE: @One_ =
// alias i32 (), ptr @__One DEVICE: @Two = weak alias i32 (), ptr @__Two DEVICE:
// @Two_ = alias i32 (), ptr @__Two DEVICE: @_Z5Threev = weak alias i32 (), ptr
// @_Z7__Threev DEVICE: @_Z6Three_v = alias i32 (), ptr @_Z7__Threev DEVICE:
// @_Z4Fourv = weak alias i32 (), ptr @_Z6__Fourv DEVICE: @_Z4Fourf = weak alias
// float (float), ptr @_Z6__Fourf
//.
...
// align 4 DEVICE-NEXT:    [[MUL:%.*]] = fmul contract float 2.000000e+00,
// [[TMP0]] DEVICE-NEXT:    ret float [[MUL]]
//
...
__host__ __device__ float Four(float f)
    __attribute__((weak, alias("_Z6__Fourf")));
//.
// HOST: attributes #[[ATTR0]] = { mustprogress noinline nounwind optnone
// "min-legal-vector-width"="0" "no-trapping-math"="true"
// "stack-protector-buffer-size"="8"
// "target-features"="+cx8,+mmx,+sse,+sse2,+x87" "uniform-work-group-size" }
//.
