...
// WITH_NOALIAS: define{{.*}} void @take(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(32) %arg)
// NO_NOALIAS: define{{.*}} void @take(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(32) %arg)
