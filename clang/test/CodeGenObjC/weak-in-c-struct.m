...
// COMMON: define{{.*}} void @test_parameter_Weak(ptr nofreeobj noundef align {{[0-9]+}} dead_on_return dereferenceable({{[0-9]+}}) %[[A:.*]])
...
// COMMON: call void @calleeWeak(ptr nofreeobj noundef align {{[0-9]+}} dead_on_return dereferenceable({{[0-9]+}}) %[[AGG_TMP]])
// COMMON-NEXT: ret
...
// COMMON: call void @objc_msgSend({{.*}}, ptr nofreeobj noundef align {{[0-9]+}} dead_on_return dereferenceable({{[0-9]+}}) %[[AGG_TMP]])
// COMMON: br
