...
// COMMON: define{{.*}} void @test_parameter_Weak(ptr noundef align {{[0-9]+}} dead_on_return %[[A:.*]])
...
// COMMON: call void @calleeWeak(ptr noundef align {{[0-9]+}} dead_on_return %[[AGG_TMP]])
// COMMON-NEXT: ret
...
// COMMON: call void @objc_msgSend({{.*}}, ptr noundef align {{[0-9]+}} dead_on_return %[[AGG_TMP]])
// COMMON: br
