...
// RUN: %clang_cc1 -std=c++20 -triple=aarch64-none-eabi -emit-llvm -o - %s | FileCheck %s --check-prefix=AARCH64-LE
// RUN: %clang_cc1 -std=c++20 -triple=aarch64_be-none-eabi -emit-llvm -o - %s | FileCheck %s --check-prefix=AARCH64-BE
...
// LINUX-LABEL: define dso_local void @testNoUniqueAddress(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testNoUniqueAddress(
...
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testNoUniqueAddress(
...
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testNoUniqueAddress(
...
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testNoUniqueAddress(
...
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testStructWithEmptyBase(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testStructWithEmptyBase(
// WINDOWS-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// WINDOWS-NEXT:  [[ENTRY:.*:]]
// WINDOWS-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// WINDOWS-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testStructWithEmptyBase(
// ARM-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// ARM-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// ARM-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testStructWithEmptyBase(
// ARM-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// ARM-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// ARM-BE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testStructWithEmptyBase(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testStructWithEmptyBase(
// AARCH64-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// AARCH64-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testPaddingBetweenBases(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testPaddingBetweenBases(
// WINDOWS-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// WINDOWS-NEXT:  [[ENTRY:.*:]]
// WINDOWS-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// WINDOWS-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testPaddingBetweenBases(
// ARM-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
...
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testPaddingBetweenBases(
// ARM-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testPaddingBetweenBases(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 3
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP4]], align 1
...
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testPaddingBetweenBases(
// AARCH64-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testPaddingAfterLastBase(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testPaddingAfterLastBase(
// WINDOWS-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// WINDOWS-NEXT:  [[ENTRY:.*:]]
// WINDOWS-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// WINDOWS-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testPaddingAfterLastBase(
// ARM-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
...
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testPaddingAfterLastBase(
// ARM-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 4
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testPaddingAfterLastBase(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testPaddingAfterLastBase(
// AARCH64-BE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testVtable(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testVtable(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(12) [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 10
// ARM-LE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 11
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testVtable(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(12) [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 10
// ARM-BE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 11
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVtable(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testVtable(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 8 dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testMultipleBasesVtable(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testMultipleBasesVtable(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(32) [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 17
// ARM-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 18
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 19
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 29
// ARM-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// ARM-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 30
// ARM-LE-NEXT:    store i8 0, ptr [[TMP4]], align 2
// ARM-LE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 31
// ARM-LE-NEXT:    store i8 0, ptr [[TMP5]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testMultipleBasesVtable(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(32) [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 17
// ARM-BE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 18
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 19
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 29
// ARM-BE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// ARM-BE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 30
// ARM-BE-NEXT:    store i8 0, ptr [[TMP4]], align 2
// ARM-BE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 31
// ARM-BE-NEXT:    store i8 0, ptr [[TMP5]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testMultipleBasesVtable(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dereferenceable(48) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 12
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 4
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 13
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 29
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-LE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 30
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP5]], align 2
// AARCH64-LE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 31
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[S]], i32 45
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP7]], align 1
// AARCH64-LE-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[S]], i32 46
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP8]], align 2
// AARCH64-LE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[S]], i32 47
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP9]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testMultipleBasesVtable(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 8 dereferenceable(48) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 12
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP0]], align 4
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 13
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 2
// AARCH64-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-BE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 29
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-BE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 30
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP5]], align 2
// AARCH64-BE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 31
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-BE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[S]], i32 45
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP7]], align 1
// AARCH64-BE-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[S]], i32 46
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP8]], align 2
// AARCH64-BE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[S]], i32 47
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP9]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testVirtualChain(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testVirtualChain(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(20) [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 18
// ARM-LE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 19
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testVirtualChain(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(20) [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 18
// ARM-BE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 19
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVirtualChain(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dereferenceable(24) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 22
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 23
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testVirtualChain(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 8 dereferenceable(24) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 22
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP0]], align 2
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 23
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testVirtualInheritance(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testVirtualInheritance(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dead_on_return dereferenceable(28) [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
// ARM-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 10
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 11
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 22
// ARM-LE-NEXT:    store i8 0, ptr [[TMP3]], align 2
// ARM-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 23
// ARM-LE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testVirtualInheritance(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dead_on_return dereferenceable(28) [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
// ARM-BE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 10
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 11
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 22
// ARM-BE-NEXT:    store i8 0, ptr [[TMP3]], align 2
// ARM-BE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 23
// ARM-BE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVirtualInheritance(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dead_on_return dereferenceable(40) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 13
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 30
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 2
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 31
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-LE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 36
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP5]], align 4
// AARCH64-LE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 37
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[S]], i32 38
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP7]], align 2
// AARCH64-LE-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[S]], i32 39
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP8]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testVirtualInheritance(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 8 dead_on_return dereferenceable(40) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 13
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 30
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP3]], align 2
// AARCH64-BE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 31
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-BE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 36
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP5]], align 4
// AARCH64-BE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 37
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-BE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[S]], i32 38
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP7]], align 2
// AARCH64-BE-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[S]], i32 39
...
// LINUX-LABEL: define dso_local void @testVirtualInheritanceAndVirtualFunction(
// LINUX-SAME: ptr nofreeobj noundef align 8 dereferenceable(24) [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
...
// LINUX-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 15
// LINUX-NEXT:    store i8 0, ptr [[TMP2]], align 1
// LINUX-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 20
// LINUX-NEXT:    store i8 0, ptr [[TMP3]], align 4
// LINUX-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 21
// LINUX-NEXT:    store i8 0, ptr [[TMP4]], align 1
// LINUX-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 22
// LINUX-NEXT:    store i8 0, ptr [[TMP5]], align 2
// LINUX-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 23
// LINUX-NEXT:    store i8 0, ptr [[TMP6]], align 1
// LINUX-NEXT:    ret void
//
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testVirtualInheritanceAndVirtualFunction(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
...
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testVirtualInheritanceAndVirtualFunction(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVirtualInheritanceAndVirtualFunction(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dereferenceable(24) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
...
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 20
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 4
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 21
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-LE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 22
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP5]], align 2
// AARCH64-LE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 23
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testVirtualInheritanceAndVirtualFunction(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 8 dereferenceable(24) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
...
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-BE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 20
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP3]], align 4
// AARCH64-BE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[S]], i32 21
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP4]], align 1
// AARCH64-BE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[S]], i32 22
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP5]], align 2
// AARCH64-BE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 23
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP6]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testOversizedBitfield(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 3
// LINUX-NEXT:    store i8 0, ptr [[TMP3]], align 1
// LINUX-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[TMP0]], i32 12
// LINUX-NEXT:    store i8 0, ptr [[TMP4]], align 4
// LINUX-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[TMP0]], i32 13
// LINUX-NEXT:    store i8 0, ptr [[TMP5]], align 1
// LINUX-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[TMP0]], i32 14
// LINUX-NEXT:    store i8 0, ptr [[TMP6]], align 2
// LINUX-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 15
// LINUX-NEXT:    store i8 0, ptr [[TMP7]], align 1
// LINUX-NEXT:    ret void
//
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testOversizedBitfield(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP0]], i32 3
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP3]], align 1
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[TMP0]], i32 12
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP4]], align 4
// AARCH64-LE-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[TMP0]], i32 13
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP5]], align 1
// AARCH64-LE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[TMP0]], i32 14
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP6]], align 2
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP7]], align 1
// AARCH64-LE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testOversizedBitfieldVolatileStruct(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testOversizedBitfieldVolatileStruct(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testVolatileOversizedBitfield(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVolatileOversizedBitfield(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testVolatileOversizedBitfieldVolatileStruct(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testVolatileOversizedBitfieldVolatileStruct(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-LE-SAME: ) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S:%.*]] = alloca [2 x [[STRUCT_S_0:%.*]]], align 4
...
// ARM-BE-SAME: ) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S:%.*]] = alloca [2 x [[STRUCT_S_0:%.*]]], align 4
...
// AARCH64-LE-SAME: ) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S:%.*]] = alloca [2 x [[STRUCT_S_0:%.*]]], align 4
...
// AARCH64-BE-SAME: ) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S:%.*]] = alloca [2 x [[STRUCT_S_0:%.*]]], align 4
...
// LINUX-LABEL: define dso_local void @testTemplateStruct(
...
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testTemplateStruct(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testTemplateStruct(
// ARM-LE-SAME: ptr noundef [[S12:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[S12_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[S12]], ptr [[S12_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S12_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 2
...
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testTemplateStruct(
// ARM-BE-SAME: ptr noundef [[S12:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[S12_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[S12]], ptr [[S12_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S12_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 2
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testTemplateStruct(
// AARCH64-LE-SAME: ptr noundef [[S12:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S12_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S12]], ptr [[S12_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S12_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 2
...
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testTemplateStruct(
// AARCH64-BE-SAME: ptr noundef [[S12:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[S12_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[S12]], ptr [[S12_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S12_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 5
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 1
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 2
...
// LINUX-LABEL: define dso_local void @testNonTriviallyCopyable(
...
// WINDOWS-NEXT:    ret void
//
// ARM-LE-LABEL: define dso_local void @testNonTriviallyCopyable(
// ARM-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(8) [[NTC:%.*]]) #[[ATTR0]] {
// ARM-LE-NEXT:  [[ENTRY:.*:]]
// ARM-LE-NEXT:    [[NTC_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-LE-NEXT:    store ptr [[NTC]], ptr [[NTC_INDIRECT_ADDR]], align 4
// ARM-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[NTC]], i32 5
// ARM-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[NTC]], i32 6
// ARM-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[NTC]], i32 7
// ARM-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-LE-NEXT:    ret void
//
// ARM-BE-LABEL: define dso_local void @testNonTriviallyCopyable(
// ARM-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(8) [[NTC:%.*]]) #[[ATTR0]] {
// ARM-BE-NEXT:  [[ENTRY:.*:]]
// ARM-BE-NEXT:    [[NTC_INDIRECT_ADDR:%.*]] = alloca ptr, align 4
// ARM-BE-NEXT:    store ptr [[NTC]], ptr [[NTC_INDIRECT_ADDR]], align 4
// ARM-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[NTC]], i32 5
// ARM-BE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// ARM-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[NTC]], i32 6
// ARM-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// ARM-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[NTC]], i32 7
// ARM-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testNonTriviallyCopyable(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 4 dereferenceable(8) [[NTC:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[NTC_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[NTC]], ptr [[NTC_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[NTC]], i32 5
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[NTC]], i32 6
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[NTC]], i32 7
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-LE-NEXT:    ret void
//
// AARCH64-BE-LABEL: define dso_local void @testNonTriviallyCopyable(
// AARCH64-BE-SAME: ptr nofreeobj noundef align 4 dereferenceable(8) [[NTC:%.*]]) #[[ATTR0]] {
// AARCH64-BE-NEXT:  [[ENTRY:.*:]]
// AARCH64-BE-NEXT:    [[NTC_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-BE-NEXT:    store ptr [[NTC]], ptr [[NTC_INDIRECT_ADDR]], align 8
// AARCH64-BE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[NTC]], i32 5
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// AARCH64-BE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[NTC]], i32 6
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-BE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[NTC]], i32 7
// AARCH64-BE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-BE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testBitfieldOversizedAligned(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testBitfieldOversizedAligned(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testBitfieldOversizedBeyondBoundary(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testBitfieldOversizedBeyondBoundary(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-LABEL: define dso_local void @testBitfieldOversizedValueTypes(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    store i8 [[TMP6]], ptr [[TMP4]], align 2
// LINUX-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 3
// LINUX-NEXT:    [[TMP8:%.*]] = load i8, ptr [[TMP7]], align 1
// LINUX-NEXT:    [[TMP9:%.*]] = and i8 [[TMP8]], 31
// LINUX-NEXT:    store i8 [[TMP9]], ptr [[TMP7]], align 1
// LINUX-NEXT:    ret void
//
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testBitfieldOversizedValueTypes(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// AARCH64-LE-NEXT:    store i8 [[TMP6]], ptr [[TMP4]], align 2
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 3
// AARCH64-LE-NEXT:    [[TMP8:%.*]] = load i8, ptr [[TMP7]], align 1
// AARCH64-LE-NEXT:    [[TMP9:%.*]] = and i8 [[TMP8]], 31
// AARCH64-LE-NEXT:    store i8 [[TMP9]], ptr [[TMP7]], align 1
// AARCH64-LE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testBitfieldBaseOffset(
// LINUX-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// LINUX-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// LINUX-NEXT:    store i8 0, ptr [[TMP7]], align 1
// LINUX-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP0]], i32 9
// LINUX-NEXT:    store i8 0, ptr [[TMP8]], align 1
// LINUX-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP0]], i32 10
// LINUX-NEXT:    store i8 0, ptr [[TMP9]], align 2
// LINUX-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr [[TMP0]], i32 11
// LINUX-NEXT:    store i8 0, ptr [[TMP10]], align 1
// LINUX-NEXT:    ret void
//
// WINDOWS-LABEL: define dso_local void @testBitfieldBaseOffset(
// WINDOWS-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// WINDOWS-NEXT:  [[ENTRY:.*:]]
// WINDOWS-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// WINDOWS-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
...
// WINDOWS-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// WINDOWS-NEXT:    store i8 0, ptr [[TMP7]], align 1
// WINDOWS-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP0]], i32 9
// WINDOWS-NEXT:    store i8 0, ptr [[TMP8]], align 1
// WINDOWS-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP0]], i32 10
// WINDOWS-NEXT:    store i8 0, ptr [[TMP9]], align 2
// WINDOWS-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr [[TMP0]], i32 11
// WINDOWS-NEXT:    store i8 0, ptr [[TMP10]], align 1
// WINDOWS-NEXT:    ret void
//
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testBitfieldBaseOffset(
// AARCH64-LE-SAME: ptr noundef [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = load ptr, ptr [[S_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[TMP0]], i32 4
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = load i8, ptr [[TMP1]], align 4
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = and i8 [[TMP2]], -8
// AARCH64-LE-NEXT:    store i8 [[TMP3]], ptr [[TMP1]], align 4
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[TMP0]], i32 6
...
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP0]], i32 7
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP7]], align 1
// AARCH64-LE-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP0]], i32 9
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP8]], align 1
// AARCH64-LE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP0]], i32 10
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP9]], align 2
// AARCH64-LE-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr [[TMP0]], i32 11
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP10]], align 1
// AARCH64-LE-NEXT:    ret void
//
...
// LINUX-LABEL: define dso_local void @testBitfieldVirtualBase(
// LINUX-SAME: ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// LINUX-NEXT:  [[ENTRY:.*:]]
// LINUX-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// LINUX-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// LINUX-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
// LINUX-NEXT:    store i8 0, ptr [[TMP0]], align 1
// LINUX-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 10
// LINUX-NEXT:    store i8 0, ptr [[TMP1]], align 2
// LINUX-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 11
// LINUX-NEXT:    store i8 0, ptr [[TMP2]], align 1
// LINUX-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 12
// LINUX-NEXT:    [[TMP4:%.*]] = load i8, ptr [[TMP3]], align 4
// LINUX-NEXT:    [[TMP5:%.*]] = and i8 [[TMP4]], -8
// LINUX-NEXT:    store i8 [[TMP5]], ptr [[TMP3]], align 4
// LINUX-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 14
// LINUX-NEXT:    [[TMP7:%.*]] = load i8, ptr [[TMP6]], align 2
// LINUX-NEXT:    [[TMP8:%.*]] = and i8 [[TMP7]], 31
// LINUX-NEXT:    store i8 [[TMP8]], ptr [[TMP6]], align 2
// LINUX-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[S]], i32 15
// LINUX-NEXT:    store i8 0, ptr [[TMP9]], align 1
// LINUX-NEXT:    ret void
//
...
// ARM-BE-NEXT:    ret void
//
// AARCH64-LE-LABEL: define dso_local void @testBitfieldVirtualBase(
// AARCH64-LE-SAME: ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) [[S:%.*]]) #[[ATTR0]] {
// AARCH64-LE-NEXT:  [[ENTRY:.*:]]
// AARCH64-LE-NEXT:    [[S_INDIRECT_ADDR:%.*]] = alloca ptr, align 8
// AARCH64-LE-NEXT:    store ptr [[S]], ptr [[S_INDIRECT_ADDR]], align 8
// AARCH64-LE-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[S]], i32 9
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP0]], align 1
// AARCH64-LE-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr [[S]], i32 10
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP1]], align 2
// AARCH64-LE-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[S]], i32 11
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP2]], align 1
// AARCH64-LE-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[S]], i32 12
// AARCH64-LE-NEXT:    [[TMP4:%.*]] = load i8, ptr [[TMP3]], align 4
// AARCH64-LE-NEXT:    [[TMP5:%.*]] = and i8 [[TMP4]], -8
// AARCH64-LE-NEXT:    store i8 [[TMP5]], ptr [[TMP3]], align 4
// AARCH64-LE-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[S]], i32 14
// AARCH64-LE-NEXT:    [[TMP7:%.*]] = load i8, ptr [[TMP6]], align 2
// AARCH64-LE-NEXT:    [[TMP8:%.*]] = and i8 [[TMP7]], 31
// AARCH64-LE-NEXT:    store i8 [[TMP8]], ptr [[TMP6]], align 2
// AARCH64-LE-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[S]], i32 15
// AARCH64-LE-NEXT:    store i8 0, ptr [[TMP9]], align 1
// AARCH64-LE-NEXT:    ret void
//
