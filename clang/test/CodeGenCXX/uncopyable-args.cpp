...
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
// NEWABI: call void @_ZN9move_ctor3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8) %{{.*}})
// OLDABI: call void @_ZN9move_ctor3fooENS_1AE(ptr %{{.*}})
// NEWABI-LABEL: declare void @_ZN9move_ctor3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
// OLDABI-LABEL: declare void @_ZN9move_ctor3fooENS_1AE(ptr)

// WIN64-LABEL: declare dso_local void @"?foo@move_ctor@@YAXUA@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
...
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
// NEWABI: call void @_ZN11all_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8) %{{.*}})
// OLDABI: call void @_ZN11all_deleted3fooENS_1AE(ptr %{{.*}})
// NEWABI-LABEL: declare void @_ZN11all_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
// OLDABI-LABEL: declare void @_ZN11all_deleted3fooENS_1AE(ptr)

// WIN64-LABEL: declare dso_local void @"?foo@all_deleted@@YAXUA@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
...
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
// NEWABI: call void @_ZN18implicitly_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8) %{{.*}})
// OLDABI: call void @_ZN18implicitly_deleted3fooENS_1AE(ptr %{{.*}})
// NEWABI-LABEL: declare void @_ZN18implicitly_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
...
// WIN64-19-LABEL: declare dso_local void @"?foo@implicitly_deleted@@YAXUA@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
...
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
// NEWABI: call void @_ZN11one_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8) %{{.*}})
// OLDABI: call void @_ZN11one_deleted3fooENS_1AE(ptr %{{.*}})
// NEWABI-LABEL: declare void @_ZN11one_deleted3fooENS_1AE(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
// OLDABI-LABEL: declare void @_ZN11one_deleted3fooENS_1AE(ptr)

// WIN64-LABEL: declare dso_local void @"?foo@one_deleted@@YAXUA@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
...
// WIN64-LABEL: declare dso_local void @"?foo@move_defaulted@@YAXUA@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
...
// CHECK: call void @_Z{{.*}}C1Ev(
// NEWABI: call void @_ZN14two_copy_ctors3fooENS_1BE(ptr nofree noundef align 8 dead_on_return dereferenceable(8) %{{.*}})
// OLDABI: call void @_ZN14two_copy_ctors3fooENS_1BE(ptr noundef byval
// NEWABI-LABEL: declare void @_ZN14two_copy_ctors3fooENS_1BE(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
// OLDABI-LABEL: declare void @_ZN14two_copy_ctors3fooENS_1BE(ptr noundef byval

// WIN64-LABEL: declare dso_local void @"?foo@two_copy_ctors@@YAXUB@1@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(8))
}
