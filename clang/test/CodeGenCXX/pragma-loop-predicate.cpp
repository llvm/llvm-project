...
// [[GEN3:![0-9]+]]} CHECK:      [[MP]] = !{!"llvm.loop.mustprogress"}
// CHECK-NEXT: [[GEN3]] = !{!"llvm.loop.vectorize.enable"}

// CHECK-NEXT: ![[LOOP1]] = distinct !{![[LOOP1]], [[MP]], [[GEN6:![0-9]+]],
// [[GEN3]]} CHECK-NEXT: [[GEN6]] = !{!"llvm.loop.vectorize.predicate.enable",
// i1 true}

// CHECK-NEXT: ![[LOOP2]] = distinct !{![[LOOP2]], [[MP]], [[GEN8:![0-9]+]],
// [[GEN3]]} CHECK-NEXT: [[GEN8]] = !{!"llvm.loop.vectorize.predicate.enable",
// i1 false}
...
// CHECK-NEXT: ![[LOOP6]] = distinct !{![[LOOP6]], [[MP]], [[GEN8]], [[GEN10]],
// [[GEN11:![0-9]+]]} CHECK-NEXT: [[GEN11]] =
// !{!"llvm.loop.vectorize.scalable.enable", i1 false}

// CHECK-NEXT: ![[LOOP7]] = distinct !{![[LOOP7]], [[MP]], [[GEN8]],
// [[GEN12:![0-9]+]], [[GEN11]], [[GEN3]]} CHECK-NEXT: [[GEN12]] =
// !{!"llvm.loop.vectorize.width", i32 4}

// CHECK-NEXT: ![[LOOP8]] = distinct !{![[LOOP8]], [[MP]], [[GEN6]], [[GEN10]],
// [[GEN11]]}

// CHECK-NEXT: ![[LOOP9]] = distinct !{![[LOOP9]], [[MP]], [[GEN6]], [[GEN12]],
// [[GEN11]], [[GEN3]]}
