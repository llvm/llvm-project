...
// CHECK:   store ptr getelementptr inbounds inrange(-8, 4) (i8, ptr @_ZTV1S, i32 8), ptr %{{[.0-9A-Z_a-z]+}}

// CHECK-LABEL: define linkonce_odr dso_local x86_thiscallcc void @_ZN1IC2Ev(ptr {{[^,]*}} %this)
// CHECK:   store ptr getelementptr inbounds inrange(-8, 4) (i8, ptr @_ZTV1I, i32 8), ptr %{{[.0-9A-Z_a-z]+}}
