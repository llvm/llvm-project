...
// CHECK-NEXT:    [[TMP1:%.*]] = and i64 [[TMP0]], 2251799813718016
// CHECK-NEXT:    [[TMP2:%.*]] = icmp eq i64 [[TMP1]], 2251799813718016
...
// CHECK-NEXT:    call void @__init_cpu_features_resolver()
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr @__aarch64_cpu_features, align 8
// CHECK-NEXT:    [[TMP1:%.*]] = and i64 [[TMP0]], 5629499534213120
// CHECK-NEXT:    [[TMP2:%.*]] = icmp eq i64 [[TMP1]], 5629499534213120
// CHECK-NEXT:    [[TMP3:%.*]] = and i1 true, [[TMP2]]
// CHECK-NEXT:    br i1 [[TMP3]], label %[[RESOLVER_RETURN:.*]], label %[[RESOLVER_ELSE:.*]]
// CHECK:       [[RESOLVER_RETURN]]:
...
// CHECK-NEXT:    call void @__init_cpu_features_resolver()
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr @__aarch64_cpu_features, align 8
// CHECK-NEXT:    [[TMP1:%.*]] = and i64 [[TMP0]], 18155135997837312
// CHECK-NEXT:    [[TMP2:%.*]] = icmp eq i64 [[TMP1]], 18155135997837312
// CHECK-NEXT:    [[TMP3:%.*]] = and i1 true, [[TMP2]]
// CHECK-NEXT:    br i1 [[TMP3]], label %[[RESOLVER_RETURN:.*]], label %[[RESOLVER_ELSE:.*]]
// CHECK:       [[RESOLVER_RETURN]]:
...
// CHECK-NEXT:    [[TMP5:%.*]] = and i64 [[TMP4]], 8388608
// CHECK-NEXT:    [[TMP6:%.*]] = icmp eq i64 [[TMP5]], 8388608
