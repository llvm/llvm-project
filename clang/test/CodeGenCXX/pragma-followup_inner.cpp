...
// ![[DISTRIBUTE_FOLLOWUP_6:[0-9]+]]} CHECK-DAG: ![[PARALLEL_ACCESSES_4]] =
// !{!"llvm.loop.parallel_accesses", ![[ACCESSGROUP_2]]} CHECK-DAG:
// ![[DISTRIBUTE_5]] = !{!"llvm.loop.distribute.enable"}

// CHECK-DAG: ![[DISTRIBUTE_FOLLOWUP_6]] =
// !{!"llvm.loop.distribute.followup_all", ![[PARALLEL_ACCESSES_4]],
...
// CHECK-DAG: ![[UNROLLANDJAM_COUNT_10]] = !{!"llvm.loop.unroll_and_jam.count",
// i32 4}

// CHECK-DAG: ![[UNROLLANDJAM_FOLLOWUPINNER_11]] =
// !{!"llvm.loop.unroll_and_jam.followup_inner", ![[PARALLEL_ACCESSES_4]],
// ![[ISVECTORIZED_13:[0-9]+]], ![[UNROLL_COUNT_13:[0-9]+]],
// ![[UNROLL_FOLLOWUP_14:[0-9]+]]} CHECK-DAG: ![[ISVECTORIZED_13]] =
// !{!"llvm.loop.isvectorized"} CHECK-DAG: ![[UNROLL_COUNT_13]] =
// !{!"llvm.loop.unroll.count", i32 4}

// CHECK-DAG: ![[UNROLL_FOLLOWUP_14]] = !{!"llvm.loop.unroll.followup_all",
// ![[PARALLEL_ACCESSES_4]], ![[ISVECTORIZED_13]],
// ![[UNROLL_DISABLE_16:[0-9]+]], ![[PIPELINE_17:[0-9]+]]} CHECK-DAG:
// ![[UNROLL_DISABLE_16]] = !{!"llvm.loop.unroll.disable"} CHECK-DAG:
// ![[PIPELINE_17]] = !{!"llvm.loop.pipeline.initiationinterval", i32 10}
