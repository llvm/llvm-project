...
namespace InitVTable {
  ...
  // CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN10InitVTable1BE, i64 16), ptr [[THIS:%.*]],
  ...
  // CHECK-NEXT: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN10InitVTable1BE, i64 16), ptr [[THIS]]
  // CHECK-NEXT: ret void
  B::B() : A(foo()) {}
  ...
  // CHECK-NEXT: call void @_ZN10InitVTable1AC2Ei(ptr {{[^,]*}} {{%.*}}, i32 noundef [[ARG]])
  // CHECK-NEXT: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN10InitVTable1BE, i64 16), ptr {{%.*}}
  // CHECK-NEXT: ret void
  B::B(int x) : A(x + 5) {}
}
