...
// CHECK: @_ZTV1C.local = internal constant { [4 x i32], [3 x i32] } { [4 x i32] [i32 0, i32 trunc (i64 sub (i64 ptrtoint (ptr @_ZTI1C.rtti_proxy to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1C.local, i64 8) to i64)) to i32), i32 trunc (i64 sub (i64 ptrtoint (ptr dso_local_equivalent @_ZN1C3fooEv to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1C.local, i64 8) to i64)) to i32), i32 trunc (i64 sub (i64 ptrtoint (ptr dso_local_equivalent @_ZN1C3barEv to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1C.local, i64 8) to i64)) to i32)], [3 x i32] [i32 -8, i32 trunc (i64 sub (i64 ptrtoint (ptr @_ZTI1C.rtti_proxy to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1C.local, i64 24) to i64)) to i32), i32 trunc (i64 sub (i64 ptrtoint (ptr dso_local_equivalent @_ZThn8_N1C3barEv to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1C.local, i64 24) to i64)) to i32)] }, align 4

// CHECK: @_ZTV1C ={{.*}}alias { [4 x i32], [3 x i32] }, ptr @_ZTV1C.local
