...
// CHECK:      define{{.*}} ptr @_Z6upcastP1B(ptr nofree noundef readnone returned captures(ret: address, provenance) %b) local_unnamed_addr
// CHECK-NEXT: entry:
// CHECK-NEXT:   ret ptr %b
// CHECK-NEXT: }

// CHECK:      define{{.*}} ptr @_Z8downcastP1A(ptr nofree noundef readonly %a) local_unnamed_addr
// CHECK-NEXT: entry:
...
// CHECK:      define{{.*}} ptr @_Z8selfcastP1B(ptr nofree noundef readnone returned captures(ret: address, provenance) %b) local_unnamed_addr
// CHECK-NEXT: entry
// CHECK-NEXT:   ret ptr %b
// CHECK-NEXT: }

// CHECK: define{{.*}} ptr @_Z9void_castP1B(ptr nofree noundef readonly captures(address_is_null, ret: address, provenance) %b) local_unnamed_addr
// CHECK-NEXT: entry:
