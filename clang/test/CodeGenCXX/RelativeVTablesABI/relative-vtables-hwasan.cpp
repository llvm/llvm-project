...
/// hwasan-instrumented.
// CHECK-DAG: @_ZTV1A.local = internal constant { [3 x i32] } { [3 x i32] [i32 0, i32 trunc (i64 sub (i64 ptrtoint (ptr @_ZTI1A.rtti_proxy to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1A.local, i64 8) to i64)) to i32), i32 trunc (i64 sub (i64 ptrtoint (ptr dso_local_equivalent @_ZN1A3fooEv to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1A.local, i64 8) to i64)) to i32)] }, no_sanitize_hwaddress, align 4
// CHECK-DAG: @_ZTV1A = alias { [3 x i32] }, ptr @_ZTV1A.local
...
// CHECK-DAG: @_ZTV1B = hidden constant { [3 x i32] } { [3 x i32] [i32 0, i32 trunc (i64 sub (i64 ptrtoint (ptr @_ZTI1B.rtti_proxy to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1B, i64 8) to i64)) to i32), i32 trunc (i64 sub (i64 ptrtoint (ptr dso_local_equivalent @_ZN1B3fooEv to i64), i64 ptrtoint (ptr getelementptr inbounds (i8, ptr @_ZTV1B, i64 8) to i64)) to i32)] }, no_sanitize_hwaddress, align 4
