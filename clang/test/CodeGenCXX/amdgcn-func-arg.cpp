...
// CHECK-SAME: ptr addrspace(5) nofree noundef align 4 dereferenceable(4) [[A:%.*]]) #[[ATTR1]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    call void @_Z22func_with_indirect_arg1A(ptr addrspace(5) nofree noundef align 4 dereferenceable(4) [[AGG_TMP_ASCAST_ASCAST]]) #[[ATTR5]]
