...
// CHECK-LABEL: define{{.*}} void @_ZN16child5_virtual_sC1EOS_(ptr nofree noundef nonnull align 8 dereferenceable(12) %this, ptr noundef nonnull align 8 dereferenceable(12) %0)
