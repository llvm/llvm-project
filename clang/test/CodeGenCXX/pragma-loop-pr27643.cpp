...
// ![[VEC_WIDTH_1:.*]], ![[FIXED_WIDTH:.*]], ![[VEC_ENABLE:.*]]} CHECK:
// ![[VEC_WIDTH_1]] = !{!"llvm.loop.vectorize.width", i32 1} CHECK:
// ![[FIXED_WIDTH]] = !{!"llvm.loop.vectorize.scalable.enable", i1 false} CHECK:
// ![[VEC_ENABLE]] = !{!"llvm.loop.vectorize.enable"}

// CHECK: ![[LOOP2]] = distinct !{![[LOOP2]], [[MP]], ![[VEC_WIDTH_2:.*]],
// ![[FIXED_WIDTH:.*]], ![[VEC_ENABLE]]} CHECK: ![[VEC_WIDTH_2]] =
// !{!"llvm.loop.vectorize.width", i32 2}

// CHECK: ![[LOOP3]] = distinct !{![[LOOP3]], [[MP]], ![[VEC_WIDTH_1]],
// ![[FIXED_WIDTH]]}

// CHECK: ![[LOOP4]] = distinct !{![[LOOP4]], [[MP]], ![[VEC_WIDTH_2]],
