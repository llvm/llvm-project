...
// CHECK-LIN32: define dso_local x86_regcallcc void @_Z14__regcall4__f13Dyn(ptr inreg nofree noundef align 4 dead_on_return dereferenceable(16) %a)
// CHECK-WIN64: define dso_local x86_regcallcc void @"?f1@@YxXUDyn@@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(24) %a)
...
// CHECK-WIN64: define dso_local x86_regcallcc void @"?f2@@YxXUDerived@@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %a)
