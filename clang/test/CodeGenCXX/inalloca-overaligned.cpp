...
// CHECK-SAME: (ptr noundef align 8 dead_on_return %o)
...
// CHECK: call noundef i32 @"?receive_both@@Y{{.*}}"(ptr noundef align 8 dead_on_return [[TMP]])
...
// CHECK: call noundef i32 @"?receiveMyPtr@@Y{{.*}}"(ptr noundef align 8 dead_on_return [[TMP]])
