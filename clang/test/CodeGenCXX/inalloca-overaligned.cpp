...
// CHECK-SAME: (ptr nofreeobj noundef align 8 dead_on_return dereferenceable(8) %o)
...
// CHECK: call noundef i32 @"?receive_both@@Y{{.*}}"(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(8) [[TMP]])
...
// CHECK: call noundef i32 @"?receiveMyPtr@@Y{{.*}}"(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(8) [[TMP]])
