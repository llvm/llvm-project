...
// CHECK-NEXT:  [[T2:%.*]] = call noundef ptr [[T1]](ptr nofree noundef {{.*}}) [ "ptrauth"(i32 0, i64 [[BT1]]) ]
...
// CHECK-NEXT:  [[U2:%.*]] = call noundef ptr [[U1]](ptr nofree noundef {{.*}}) [ "ptrauth"(i32 0, i64 [[BU1]]) ]
  char* c = p->Base::abc();
}
...
// CHECK-NEXT:  [[V2:%.*]] = call noundef ptr [[V1]](ptr nofree noundef {{.*}}) [ "ptrauth"(i32 0, i64 [[BV1]]) ]
...
// CHECK-NEXT:  [[W2:%.*]] = call noundef ptr [[W1]](ptr nofree noundef {{.*}}) [ "ptrauth"(i32 0, i64 [[BW1]]) ]
  char* c = p->D2::abc();
}
...
// CHECK: call void %[[T5]](ptr nofree noundef nonnull align {{[0-9]+}} dereferenceable(8) %{{.*}}) [ "ptrauth"(i32 0, i64 %[[T7]]) ]
  p->abc();
}
