...
// RUN: %clang_cc1 -triple x86_64-windows-msvc -fms-extensions -fno-rtti -emit-llvm -std=c++1y -O0 -o - %s -fexperimental-new-constant-interpreter | FileCheck %s --check-prefix X64
