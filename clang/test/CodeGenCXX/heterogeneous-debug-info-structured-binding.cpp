...
// CHECK: [[META13]] = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "A", file: [[META7]], line: 36, size: 64, flags: DIFlagTypePassByValue, elements: [[META14:![0-9]+]], identifier: "_ZTS1A")
// CHECK: [[META14]] = !{[[META15:![0-9]+]], [[META16:![0-9]+]]}
// CHECK: [[META15]] = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: [[META13]], file: [[META7]], line: 37, baseType: [[META10]], size: 32)
// CHECK: [[META16]] = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: [[META13]], file: [[META7]], line: 38, baseType: [[META10]], size: 32, offset: 32)
...
// CHECK: [[DBG32]] = !DILocation(line: 45, column: 18, scope: [[DBG6]])
// CHECK: [[DBG33]] = !DILocation(line: 45, column: 25, scope: [[DBG6]])
// CHECK: [[DBG34]] = !DILocation(line: 45, column: 23, scope: [[DBG6]])
// CHECK: [[DBG35]] = !DILocation(line: 45, column: 3, scope: [[DBG6]])
// CHECK: [[DBG36]] = distinct !DISubprogram(name: "g", linkageName: "_Z1gv", scope: [[META7]], file: [[META7]], line: 48, type: [[META8]], scopeLine: 48, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: [[META0]], retainedNodes: [[META37:![0-9]+]])
// CHECK: [[META37]] = !{[[META38]]}
// CHECK: [[META38]] = !DILocalVariable(name: "A", scope: [[DBG36]], file: [[META7]], line: 49, type: [[META39:![0-9]+]])
...
// CHECK: [[META44]] = !DILocation(line: 49, column: 18, scope: [[DBG36]])
// CHECK: [[META45]] = !DILocalVariable(name: "x3", scope: [[DBG36]], file: [[META7]], line: 50, type: [[META40]])
// CHECK: [[META46]] = !DILocation(line: 50, column: 9, scope: [[DBG36]])
// CHECK: [[META47]] = !DILocalVariable(name: "y3", scope: [[DBG36]], file: [[META7]], line: 50, type: [[META40]])
// CHECK: [[META48]] = !DILocation(line: 50, column: 13, scope: [[DBG36]])
// CHECK: [[DBG49]] = !DILocation(line: 50, column: 8, scope: [[DBG36]])
// CHECK: [[META50]] = !DILocalVariable(name: "x4", scope: [[DBG36]], file: [[META7]], line: 51, type: [[META40]])
// CHECK: [[META51]] = !DILocation(line: 51, column: 10, scope: [[DBG36]])
// CHECK: [[META52]] = !DILocalVariable(name: "y4", scope: [[DBG36]], file: [[META7]], line: 51, type: [[META40]])
// CHECK: [[META53]] = !DILocation(line: 51, column: 14, scope: [[DBG36]])
// CHECK: [[DBG54]] = !DILocation(line: 51, column: 9, scope: [[DBG36]])
// CHECK: [[DBG55]] = !DILocation(line: 52, column: 10, scope: [[DBG36]])
// CHECK: [[DBG56]] = !DILocation(line: 52, column: 15, scope: [[DBG36]])
// CHECK: [[DBG57]] = !DILocation(line: 52, column: 13, scope: [[DBG36]])
// CHECK: [[DBG58]] = !DILocation(line: 52, column: 20, scope: [[DBG36]])
// CHECK: [[DBG59]] = !DILocation(line: 52, column: 18, scope: [[DBG36]])
// CHECK: [[DBG60]] = !DILocation(line: 52, column: 25, scope: [[DBG36]])
// CHECK: [[DBG61]] = !DILocation(line: 52, column: 23, scope: [[DBG36]])
// CHECK: [[DBG62]] = !DILocation(line: 52, column: 3, scope: [[DBG36]])
//.
