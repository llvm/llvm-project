...
namespace VirtualMembers {
  ...
  // CHECK: @_ZN14VirtualMembers1eE ={{.*}} global { ptr, double, i32, ptr, double, [5 x i8], i16, ptr, double, [5 x i8], [3 x i8] } { ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN14VirtualMembers1EE, i64 16), double 1.000000e+00, i32 64, ptr getelementptr inbounds inrange(-16, 16) (i8, ptr @_ZTVN14VirtualMembers1EE, i64 40), double 2.000000e+00, [5 x i8] c"hello", i16 5, ptr getelementptr inbounds inrange(-16, 16) (i8, ptr @_ZTVN14VirtualMembers1EE, i64 72), double 3.000000e+00, [5 x i8] c"world", [3 x i8] c"bye" }
  E e;

  struct nsMemoryImpl {
    virtual void f();
  };
  // CHECK: @_ZN14VirtualMembersL13sGlobalMemoryE = internal global %"struct.VirtualMembers::nsMemoryImpl" { ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN14VirtualMembers12nsMemoryImplE, i64 16) }
  __attribute__((used))
  ...
  // CHECK: @_ZN14VirtualMembers1tE ={{.*}} global { ptr, i32 } { ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN14VirtualMembers13TemplateClassIiEE, i64 16), i32 42 }
  TemplateClass<int> t;
}
