...
int foo(unsigned n) {
  ...
  // There are 7 variables: var_size_1, var_size_8, var_size_8p, var_size_1024,
  // var_size_4096, var_vla, and a builtin anonymous var ("%5").
  // - COMMON (auto-init regardless of the max size): "var_size_1", "var_size_8"
  //               "var_size_8p", "var_vla", and "%5"
  // - Max size 1: none (apart from COMMON).
  // - Max size 1024: "var_size_1024"
  // - Max size 4096: "var_size_1024", "var_size_4096"
  //
  ...
  // PATTERN-COMMON: store i8 -86, ptr %var_size_1, align 1, !annotation [[AUTO_INIT:!.+]]
  // PATTERN-COMMON: store i64 -6148914691236517206, ptr %var_size_8, align 8, !annotation [[AUTO_INIT:!.+]]
  // PATTERN-COMMON: store ptr inttoptr (i64 -6148914691236517206 to ptr), ptr %var_size_8p, align 8, !annotation [[AUTO_INIT:!.+]]
  ...
  // ZERO-COMMON: store i8 0, ptr %var_size_1, align 1, !annotation [[AUTO_INIT:!.+]]
  // ZERO-COMMON: store i64 0, ptr %var_size_8, align 8, !annotation [[AUTO_INIT:!.+]]
  // ZERO-COMMON: store ptr null, ptr %var_size_8p, align 8, !annotation [[AUTO_INIT:!.+]]
