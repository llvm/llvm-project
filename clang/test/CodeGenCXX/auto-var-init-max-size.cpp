// Pattern related max size tests: 1, 8, 4096
...
//
// Zero related max size tests: 1, 8, 4096
...
int foo(unsigned n) {
  ...
  // - Max size 1: "var_size_1", "var_vla", and "%5"
  // - Max size 8: "var_size_1", "var_size_8", "var_size_8p",
  //                    "var_vla", and "%5"
  ...
  // PATTERN-MAX-8: store i64 -6148914691236517206, ptr %var_size_8, align 8, !annotation [[AUTO_INIT:!.+]]
  // PATTERN-MAX-8: store ptr inttoptr (i64 -6148914691236517206 to ptr), ptr %var_size_8p, align 8, !annotation [[AUTO_INIT:!.+]]
  ...
  // ZERO-MAX-8: store i64 0, ptr %var_size_8, align 8, !annotation [[AUTO_INIT:!.+]]
  // ZERO-MAX-8: store ptr null, ptr %var_size_8p, align 8, !annotation [[AUTO_INIT:!.+]]
