// NOTE: Assertions have been autogenerated by utils/update_cc_test_checks.py UTC_ARGS: --check-globals all -include-generated-funcs
...
// CHECK: @_Z3fmvv = weak_odr ifunc void (), ptr @_Z3fmvv.resolver
//.
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @_Z3fmvv()
// CHECK-NEXT:    ret void
//
//
// CHECK-LABEL: @_Z3fmvv.default(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    ret void
//
//
...
// CHECK-NEXT:    br i1 [[TMP3]], label [[RESOLVER_RETURN:%.*]], label [[RESOLVER_ELSE:%.*]]
// CHECK:       resolver_return:
// CHECK-NEXT:    ret ptr @_Z3fmvv._Maes
// CHECK:       resolver_else:
// CHECK-NEXT:    ret ptr @_Z3fmvv.default
//
//.
