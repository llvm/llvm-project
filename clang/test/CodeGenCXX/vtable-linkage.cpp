...
// CHECK-DAG: @_ZTV1B = external constant

// C has no key function, so its vtable should have weak_odr linkage
// and hidden visibility.
// CHECK-DAG: @_ZTV1C = linkonce_odr constant {{.*}}, comdat, align 8{{$}}
...
// weak_odr linkage.
// CHECK-DAG: @_ZTV1EIsE = weak_odr constant {{.*}}, comdat,
...
// CHECK-DAG: @_ZTV1FIsE = weak_odr constant {{.*}}, comdat,
...
// CHECK-DAG: @_ZTV1EIlE = linkonce_odr constant {{.*}}, comdat,
...
// CHECK-DAG: @_ZTV1FIlE = linkonce_odr constant {{.*}}, comdat,
...
// CHECK-DAG: @_ZTV1FIiE = external constant
// CHECK-OPT-DAG: @_ZTV1FIiE = available_externally constant
...
// CHECK-DAG: @_ZTV1EIiE = external constant
// CHECK-OPT-DAG: @_ZTV1EIiE = available_externally constant

// The anonymous struct for e has no linkage, so the vtable should have
// internal linkage.
// CHECK-DAG: @"_ZTV3$_0" = internal constant
// CHECK-DAG: @"_ZTS3$_0" = internal constant
// CHECK-DAG: @"_ZTI3$_0" = internal constant

// The A vtable should have internal linkage since it is inside an anonymous 
// namespace.
// CHECK-DAG: @_ZTVN12_GLOBAL__N_11AE = internal constant
...
// CHECK-DAG: @_ZTV1HIiE = linkonce_odr constant {{.*}}, comdat,
template <typename T>
class H {
public:
  virtual ~H();
...
// CHECK-DAG: @_ZTV1IIiE = external constant
// CHECK-DAG: @_ZTT1IIiE = external unnamed_addr constant
// CHECK-NOT: @_ZTC1IIiE
//
// CHECK-OPT-DAG: @_ZTV1IIiE = available_externally constant
