...
// CHECK: @_ZTV1B = linkonce_odr constant { [7 x ptr] } { [7 x ptr] [ptr null, ptr @_ZTI1B, ptr @_ZN1A1fEv.ptrauth.97, ptr @_ZN1A1gEv.ptrauth.98, ptr @_ZN1A1hEz.ptrauth.99, ptr @_ZN1BD1Ev.ptrauth, ptr @_ZN1BD0Ev.ptrauth] }, align 8
