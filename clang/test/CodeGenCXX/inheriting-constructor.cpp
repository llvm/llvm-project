...
namespace inalloca_nonvirt {
  ...
  // WIN64: call {{.*}} @"??0A@inalloca_nonvirt@@QEAA@UQ@@H0$$QEAU2@@Z"(ptr{{.*}}, ptr nofree align 1 dead_on_return dereferenceable(1) %[[ARG1]], i32 2, ptr nofree align 1 dead_on_return dereferenceable(1) %[[ARG3]], ptr{{.*}} %[[TMP]])
  // WIN64: call {{.*}} @"??0Z@@QEAA@XZ"(
...
namespace inalloca_virt {
  ...
  // WIN64: call {{.*}} @"??0Q@@QEAA@H@Z"(ptr {{[^,]*}} %[[ARG1]], i32 1)
  // WIN64: br i1
  // WIN64: call {{.*}} @"??0A@inalloca_virt@@QEAA@UQ@@H0$$QEAU2@@Z"(ptr{{.*}}, ptr nofree align 1 dead_on_return dereferenceable(1) %[[ARG1]], i32 2, ptr nofree align 1 dead_on_return dereferenceable(1) %[[ARG3]], ptr{{.*}} %[[TMP]])
  // WIN64: br
  // WIN64: call {{.*}} @"??0Z@@QEAA@XZ"(
  // WIN64: call {{.*}} @"??0Z@@QEAA@XZ"(
  // WIN64: call void @"??1Q@@QEAA@XZ"(ptr {{[^,]*}} %[[TMP]])
