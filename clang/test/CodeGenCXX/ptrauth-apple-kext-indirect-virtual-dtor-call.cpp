...
// CHECK-NEXT: call noundef ptr [[T1]](ptr nofree noundef nonnull align 8 dereferenceable(8) [[T2:%.*]]) [ "ptrauth"(i32 0, i64 [[B1]]) ]
...
// CHECK-NEXT:  call noundef ptr [[T3]](ptr nofree noundef nonnull align 8 dereferenceable(8) [[T4:%.*]]) [ "ptrauth"(i32 0, i64 [[B3]])
...
// CHECK: declare void @_ZN5TemplIiED0Ev(ptr nofree noundef nonnull align 8 dereferenceable(8))
// CHECK: define internal void @_ZN5TemplIiE1fEv(ptr nofree noundef nonnull align 8 dereferenceable(8) %this)
// CHECK: define internal void @_ZN5TemplIiE1gEv(ptr nofree noundef nonnull align 8 dereferenceable(8) %this)
