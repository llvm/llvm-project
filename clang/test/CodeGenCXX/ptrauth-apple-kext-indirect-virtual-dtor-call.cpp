...
// CHECK-NEXT: call noundef ptr [[T1]](ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[T2:%.*]]) [ "ptrauth"(i32 0, i64 [[B1]]) ]
...
// CHECK-NEXT:  call noundef ptr [[T3]](ptr dead_on_return noundef nonnull align 8 dereferenceable(8) [[T4:%.*]]) [ "ptrauth"(i32 0, i64 [[B3]])
...
// CHECK: declare void @_ZN5TemplIiED0Ev(ptr dead_on_return noundef nonnull align 8 dereferenceable(8))
