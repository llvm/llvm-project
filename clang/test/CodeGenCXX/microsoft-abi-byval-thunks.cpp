...
// CHECK64:             (ptr noundef %this, ptr noundef align 4 dead_on_return %x)
// CHECK64:   getelementptr i8, ptr %{{.*}}, i32 -8
// CHECK64:   call void @"?foo@C@byval_thunk@@UEAAXUAgg@2@@Z"
// CHECK64:       (ptr {{[^,]*}} %{{.*}}, ptr noundef align 4 dead_on_return %x)
// CHECK64-NOT: call
// CHECK64:   ret void
}
...
// CHECK64:             (ptr noundef %this, ptr dead_on_unwind noalias writable sret(%"struct.sret_thunk::Agg") align 4 %agg.result, ptr noundef align 4 dead_on_return %x)
// CHECK64:   getelementptr i8, ptr %{{.*}}, i32 -8
// CHECK64:   call void @"?foo@C@sret_thunk@@UEAA?AUAgg@2@U32@@Z"
// CHECK64:       (ptr {{[^,]*}} %{{.*}}, ptr dead_on_unwind writable sret(%"struct.sret_thunk::Agg") align 4 %agg.result, ptr noundef align 4 dead_on_return %x)
// CHECK64-NOT: call
// CHECK64:   ret void
}
