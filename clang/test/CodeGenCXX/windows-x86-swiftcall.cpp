...
// CHECK-LABEL: define dso_local swiftcc noundef i32 @"?receiveNonTrivial@@YSHUNonTrivial@@@Z"(ptr nofreeobj noundef align 4 dead_on_return dereferenceable(4) %o)
...
// CHECK-NOT: stacksave
// CHECK: call swiftcc noundef i32 @"?receiveNonTrivial@@YSHUNonTrivial@@@Z"(ptr nofreeobj noundef align 4 dead_on_return dereferenceable(4) %{{.*}})
