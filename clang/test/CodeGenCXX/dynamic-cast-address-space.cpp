...
//.
// CHECK: attributes #[[ATTR0]] = { convergent mustprogress noipa noinline optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
...
//.
// WITH-NONZERO-DEFAULT-AS: attributes #[[ATTR0]] = { mustprogress noipa noinline optnone "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
