...
bool foo(Empty e) {
// CHECK: @_Z3foo5Empty(ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) %e)
...
// CHECK: call {{.*}} @_Z3foo5Empty(ptr nofreeobj noundef align 1 dead_on_return dereferenceable(1) [[NEWTMP]])
  foo(e);
}
