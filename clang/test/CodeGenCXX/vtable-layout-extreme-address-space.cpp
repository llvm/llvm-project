// RUN: %clang_cc1 %s -triple=amdgpu-amd-amdhsa -std=c++11 -emit-llvm-only
// -fdump-vtable-layouts 2>&1 | FileCheck %s
...
class C2 : public C0, virtual public C1 {
  int k0;
};
class C3 : virtual public C0, virtual public C1, public C2 {
  int k0;
  int k1;
  int k2;
  int k3;
};
class C4 : public C2, virtual public C3, public C0 {
  int k0;
};
class C5 : public C0,
           virtual public C4,
...
class C6 : virtual public C3, public C0, public C5, public C4, public C1 {
  int k0;
};
...
class C9 : virtual public C6, public C2, public C4, virtual public C8 {
  int k0;
  int k1;
  int k2;
  int k3;
