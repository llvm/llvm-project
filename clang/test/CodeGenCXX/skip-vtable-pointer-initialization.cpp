...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test21AE, i64 16), ptr
A::~A() {
  f();
}
...
// CHECK-NOT: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test31AE, i64 16), ptr
A::~A() {
...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test41AE, i64 16), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test51AE, i64 16), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test61AE, i64 16), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test71AE, i64 16), ptr
A::~A()
{
}
...
// CHECK: store ptr getelementptr inbounds inrange(-16, 8) (i8, ptr @_ZTVN5Test81AE, i64 16), ptr
A::~A()
{
}
