...
// UTC_ARGS: --version 4 REQUIRES: amdgpu-registered-target REQUIRES:
// spirv-registered-target
...
// [[META2:![0-9]+]] AMDGCNSPIRV-NEXT:    fence syncscope("device") acquire,
// !mmra [[META2]] AMDGCNSPIRV-NEXT:    fence seq_cst, !mmra [[META2]]
...
// AMDGCNSPIRV-NEXT:  entry:
// AMDGCNSPIRV-NEXT:    fence syncscope("workgroup") seq_cst, !mmra
// [[META3:![0-9]+]] AMDGCNSPIRV-NEXT:    fence syncscope("device") acquire,
// !mmra [[META3]] AMDGCNSPIRV-NEXT:    fence seq_cst, !mmra [[META3]]
...
// AMDGCNSPIRV-NEXT:  entry:
// AMDGCNSPIRV-NEXT:    fence syncscope("workgroup") seq_cst, !mmra
// [[META4:![0-9]+]] AMDGCNSPIRV-NEXT:    fence syncscope("workgroup") seq_cst,
// !mmra [[META4]] AMDGCNSPIRV-NEXT:    ret void
//
void test_mixed() {
