...
// -check-prefixes=X86,CHECK %s RUN: %clang_cc1 -std=c++11 -triple
// amdgpu-amd-amdhsa -DNO_TLS -fmerge-all-constants -emit-llvm -o - %s |
// FileCheck -check-prefixes=AMDGCN,CHECK %s
...
// X86: @_ZGR15globalInitList1_ = internal constant [3 x i32] [i32 1, i32 2, i32
// 3] X86: @globalInitList1 ={{.*}} global %{{[^ ]+}} { ptr
// @_ZGR15globalInitList1_, i{{32|64}} 3 } AMDGCN: @_ZGR15globalInitList1_ =
// internal addrspace(1) constant [3 x i32] [i32 1, i32 2, i32 3] AMDGCN:
// @globalInitList1 ={{.*}} addrspace(1) global %{{[^ ]+}} { ptr addrspacecast
// (ptr addrspace(1) @_ZGR15globalInitList1_ to ptr), i{{32|64}} 3 }
...
// X86: @_ZGRN25thread_local_global_array1xE_ = internal thread_local constant
...
// zeroinitializer AMDGCN: @globalInitList2 ={{.*}} addrspace(1) global %{{[^
// ]+}} zeroinitializer AMDGCN: @_ZGR15globalInitList2_ = internal addrspace(1)
// global [2 x %[[WITHARG:[^ ]*]]] zeroinitializer

// X86: @_ZN15partly_constant1kE ={{.*}} global i32 0, align 4
// X86: @_ZN15partly_constant2ilE ={{.*}} global {{.*}} null, align 8
// X86: @[[PARTLY_CONSTANT_OUTER:_ZGRN15partly_constant2ilE_]] = internal global
// {{.*}} zeroinitializer, align 8 X86:
// @[[PARTLY_CONSTANT_INNER:_ZGRN15partly_constant2ilE0_]] = internal global [3
// x {{.*}}] zeroinitializer, align 8 X86:
// @[[PARTLY_CONSTANT_FIRST:_ZGRN15partly_constant2ilE1_]] = internal constant
// [3 x i32] [i32 1, i32 2, i32 3], align 4 X86:
// @[[PARTLY_CONSTANT_SECOND:_ZGRN15partly_constant2ilE2_]] = internal global [2
// x i32] zeroinitializer, align 4 X86:
// @[[PARTLY_CONSTANT_THIRD:_ZGRN15partly_constant2ilE3_]] = internal constant
// [4 x i32] [i32 5, i32 6, i32 7, i32 8], align 4 AMDGCN:
// @_ZN15partly_constant1kE ={{.*}} addrspace(1) global i32 0, align 4 AMDGCN:
// @_ZN15partly_constant2ilE ={{.*}} addrspace(1) global {{.*}} null, align 8
// AMDGCN: @[[PARTLY_CONSTANT_OUTER:_ZGRN15partly_constant2ilE_]] = internal
// addrspace(1) global {{.*}} zeroinitializer, align 8 AMDGCN:
// @[[PARTLY_CONSTANT_INNER:_ZGRN15partly_constant2ilE0_]] = internal
// addrspace(1) global [3 x {{.*}}] zeroinitializer, align 8 AMDGCN:
// @[[PARTLY_CONSTANT_FIRST:_ZGRN15partly_constant2ilE1_]] = internal
// addrspace(1) constant [3 x i32] [i32 1, i32 2, i32 3], align 4 AMDGCN:
// @[[PARTLY_CONSTANT_SECOND:_ZGRN15partly_constant2ilE2_]] = internal
// addrspace(1) global [2 x i32] zeroinitializer, align 4 AMDGCN:
// @[[PARTLY_CONSTANT_THIRD:_ZGRN15partly_constant2ilE3_]] = internal
...
// %{{.*}} { i32 2 }, %{{.*}} { i32 3 }], align 4 AMDGCN: @[[REFTMP1:.*]] =
// private addrspace(4) constant [2 x i32] [i32 42, i32 43], align 4 AMDGCN:
// @[[REFTMP2:.*]] = private addrspace(4) constant [3 x %{{.*}}] [%{{.*}} { i32
...
// X86: [[ADDR:%.*]] = call {{.*}} ptr @llvm.threadlocal.address.p0(ptr {{.*}}
// @_ZN25thread_local_global_array1xE) X86: store ptr
// @_ZGRN25thread_local_global_array1xE_, ptr [[ADDR]], align 8 X86: store i64
// 4, ptr getelementptr inbounds nuw (i8, ptr
// @_ZN25thread_local_global_array1xE, i64 8), align 8

// CHECK-LABEL: define internal void @__cxx_global_var_init
// X86: call void @_ZN8witharg1C1ERK10destroyme1(ptr {{[^,]*}}
// @_ZGR15globalInitList2_, ptr X86: call void
// @_ZN8witharg1C1ERK10destroyme1(ptr {{[^,]*}} getelementptr inbounds nuw (i8,
// ptr @_ZGR15globalInitList2_, i64 1), ptr AMDGCN: call void
// @_ZN8witharg1C1ERK10destroyme1(ptr {{[^,]*}} addrspacecast ({{[^@]+}}
// @_ZGR15globalInitList2_ {{[^)]+}} AMDGCN: call void
// @_ZN8witharg1C1ERK10destroyme1(ptr {{[^,]*}} getelementptr inbounds nuw (i8,
// ptr addrspacecast ({{[^@]+}} @_ZGR15globalInitList2_ {{[^)]+}}), i64 1 CHECK:
// call i32 @__cxa_atexit X86: store ptr @_ZGR15globalInitList2_, ptr
// @globalInitList2, align 8 X86: store i64 2, ptr getelementptr inbounds nuw
// (i8, ptr @globalInitList2, i64 8), align 8 AMDGCN: store ptr addrspacecast
// ({{[^@]+}} @_ZGR15globalInitList2_ {{[^)]+}}), AMDGCN:       ptr
// addrspacecast ({{[^@]+}} @globalInitList2 {{[^)]+}}), align 8 AMDGCN: store
// i64 2, ptr getelementptr inbounds nuw (i8, ptr addrspacecast ({{[^@]+}}
// @globalInitList2 {{[^)]+}}), i64 8), align 8 CHECK: call void
// @_ZN10destroyme1D1Ev CHECK-NEXT: call void @_ZN10destroyme1D1Ev CHECK-NEXT:
// ret void
std::initializer_list<witharg1> globalInitList2 = {witharg1(destroyme1()),
                                                   witharg1(destroyme1())};
...
void fn1(int i) {
  ...
  // AMDGCN: [[array:%[^ ]+]] ={{.*}} addrspacecast ptr addrspace(5) [[alloca]]
  // to ptr CHECK:      store i32 1, ptr CHECK-NEXT: getelementptr CHECK-NEXT:
  // store CHECK-NEXT: getelementptr CHECK-NEXT: load CHECK-NEXT: store init the
  // list CHECK-NEXT: getelementptr CHECK-NEXT: store ptr CHECK-NEXT:
  // getelementptr CHECK-NEXT: store i{{32|64}} 3
...
// CHECK: store ptr {{.*}}@[[PARTLY_CONSTANT_FIRST]]{{.*}}, ptr
// {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}} CHECK: store i64 3, ptr getelementptr
// inbounds nuw (i8, ptr {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, i64 8)
// CHECK-NOT: @[[PARTLY_CONSTANT_FIRST]],
//
...
// CHECK: store i32 {{.*}}, ptr getelementptr inbounds nuw (i8, ptr
// {{.*}}@[[PARTLY_CONSTANT_SECOND]]{{.*}}, i64 4)
//
// Second init list.
// CHECK: store ptr {{.*}}@[[PARTLY_CONSTANT_SECOND]]{{.*}}, ptr getelementptr
// inbounds nuw (i8, ptr {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, i64 16) CHECK:
// store i64 2, ptr getelementptr inbounds nuw (i8, ptr
// {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, i64 24)
//
// Third init list.
// CHECK-NOT: @[[PARTLY_CONSTANT_THIRD]],
// CHECK: store ptr {{.*}}@[[PARTLY_CONSTANT_THIRD]]{{.*}}, ptr getelementptr
// inbounds nuw (i8, ptr {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, i64 32) CHECK:
// store i64 4, ptr getelementptr inbounds nuw (i8, ptr
// {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, i64 40) CHECK-NOT:
// @[[PARTLY_CONSTANT_THIRD]],
//
// Outer init list.
// CHECK: store ptr {{.*}}@[[PARTLY_CONSTANT_INNER]]{{.*}}, ptr
// {{.*}}@[[PARTLY_CONSTANT_OUTER]]{{.*}} CHECK: store i64 3, ptr getelementptr
// inbounds nuw (i8, ptr {{.*}}@[[PARTLY_CONSTANT_OUTER]]{{.*}}, i64 8)
//
// 'il' reference.
// CHECK: store ptr {{.*}}@[[PARTLY_CONSTANT_OUTER]]{{.*}}, ptr
// {{.*}}@_ZN15partly_constant2ilE{{.*}}, align 8
} // namespace partly_constant
namespace nested {
struct A {
  A();
...
struct MyClass {
  explicit MyClass(const vector &v);
};
...
void f2() {
  ...
  // X86: store ptr @_ZGRZN9B197730102f2EvE1p_, ptr getelementptr inbounds nuw
  // (i8, ptr @_ZZN9B197730102f2EvE1p, i64 16), align 16 AMDGCN: store ptr
  // addrspacecast{{.*}} @_ZGRZN9B197730102f2EvE1p_{{.*}}, ptr getelementptr
  // inbounds nuw (i8, ptr addrspacecast{{.*}}@_ZZN9B197730102f2EvE1p{{.*}}, i64
  // 16), align 8
  static std::initializer_list<pair<const char *, E>> a,
      p[2] = {a, {{"", ENUM_CONSTANT}}};
}
