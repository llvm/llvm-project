...
// CHECK:   call void @_ZN5CTestC1Eg(ptr nofree noundef nonnull align 16 dereferenceable(32) %ct, ppc_fp128 noundef %0)
...
// CHECK: define linkonce_odr void @_ZN5CTestC1Eg(ptr nofree noundef nonnull align 16 dereferenceable(32) %this, ppc_fp128 noundef %arg)
// CHECK: entry:
...
// CHECK:   call void @_ZN5CTestC2Eg(ptr nofree noundef nonnull align 16 dereferenceable(32) %this1, ppc_fp128 noundef %0)
// CHECK:   ret void
// CHECK: }
...
// CHECK: define linkonce_odr void @_ZN5CTestC2Eg(ptr nofree noundef nonnull align 16 dereferenceable(32) %this, ppc_fp128 noundef %arg)
// CHECK: entry:
// CHECK:   store ptr %this, ptr %this.addr, align 8
// CHECK:   store ppc_fp128 %arg, ptr %arg.addr, align 16
// CHECK:   %this1 = load ptr, ptr %this.addr, align 8
