...
// CHECK: call void @_ZN1AC1Ev(ptr nofree noundef {{[^,]*}} @a)
// CHECK: call {{.*}}@llvm.invariant.start.p0(i64 4, ptr @a)

// CHECK: call void @_ZN2A2C1Ev(ptr nofree noundef {{[^,]*}} @a2)
// CHECK: call {{.*}}@llvm.invariant.start.p0(i64 4, ptr @a2)

// CHECK: call void @_ZN1BC1Ev(ptr nofree noundef {{[^,]*}} @b)
// CHECK-NOT: call {{.*}}@llvm.invariant.start.p0(i64 noundef 4, ptr @b)

// CHECK: call void @_ZN1CC1Ev(ptr nofree noundef {{[^,]*}} @c)
...
// CHECK: call void @_ZN1AC1Ev(ptr nofree noundef {{[^,]*}} @_ZZ1evE1a)
