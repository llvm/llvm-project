...
int *test_new_int() { return new int; }

// CHECK-LABEL: define dso_local noundef ptr @_Z20test_new_ulong_arrayv(
// CHECK: call noalias noundef nonnull ptr @_Znam(i64 noundef 80){{.*}}
// !alloc_token [[META_ULONG:![0-9]+]]
unsigned long *test_new_ulong_array() { return new unsigned long[10]; }
...
int **test_new_ptr() { return new int *; }

// CHECK-LABEL: define dso_local noundef ptr @_Z18test_new_ptr_arrayv(
// CHECK: call noalias noundef nonnull ptr @_Znam(i64 noundef 80){{.*}}
// !alloc_token [[META_INTPTR]]
int **test_new_ptr_array() { return new int *[10]; }
...
void *test_malloc_struct_with_ptr() { return malloc(sizeof(ContainsPtr)); }

// CHECK-LABEL: define dso_local noundef ptr
// @_Z33test_malloc_struct_array_with_ptrv( CHECK: call noalias ptr @malloc(i64
// noundef 160){{.*}} !alloc_token [[META_CONTAINSPTR]]
void *test_malloc_struct_array_with_ptr() {
  return malloc(10 * sizeof(ContainsPtr));
}

// CHECK-LABEL: define dso_local noundef ptr
// @_Z31test_malloc_with_ptr_sizeof_vari( CHECK: call noalias ptr @malloc(i64
// noundef {{.*}}){{.*}} !alloc_token [[META_CONTAINSPTR]]
...
// CHECK-LABEL: define dso_local noundef ptr
// @_Z29test_malloc_with_ptr_castonlyv( CHECK: call noalias ptr @malloc(i64
// noundef 4096){{.*}} !alloc_token [[META_CONTAINSPTR]]
ContainsPtr *test_malloc_with_ptr_castonly() {
  return (ContainsPtr *)malloc(4096);
}

// CHECK-LABEL: define dso_local noundef ptr
// @_Z32test_operatornew_struct_with_ptrv( CHECK: call noalias noundef nonnull
// ptr @_Znwm(i64 noundef 16){{.*}} !alloc_token [[META_CONTAINSPTR]] CHECK:
// call noalias noundef nonnull ptr @_Znwm(i64 noundef 16){{.*}} !alloc_token
// [[META_CONTAINSPTR]]
...
// CHECK-LABEL: define dso_local noundef ptr
// @_Z38test_operatornew_struct_array_with_ptrv( CHECK: call noalias noundef
// nonnull ptr @_Znwm(i64 noundef 160){{.*}} !alloc_token [[META_CONTAINSPTR]]
...
ContainsPtr *test_operatornew_struct_array_with_ptr() {
  ContainsPtr *c =
      (ContainsPtr *)__builtin_operator_new(10 * sizeof(ContainsPtr));
  sink = ::operator new(10 * sizeof(ContainsPtr));
  return c;
}

// CHECK-LABEL: define dso_local noundef ptr
// @_Z33test_operatornew_struct_with_ptr2v( CHECK: call noalias noundef nonnull
// ptr @_Znwm(i64 noundef 16){{.*}} !alloc_token [[META_CONTAINSPTR]] CHECK:
// call noalias noundef nonnull ptr @_Znwm(i64 noundef 16){{.*}} !alloc_token
// [[META_CONTAINSPTR]]
...
// CHECK-LABEL: define dso_local noundef ptr
// @_Z39test_operatornew_struct_array_with_ptr2v( CHECK: call noalias noundef
// nonnull ptr @_Znwm(i64 noundef 160){{.*}} !alloc_token [[META_CONTAINSPTR]]
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 160){{.*}}
// !alloc_token [[META_CONTAINSPTR]]
...
// !alloc_token [[META_CONTAINSPTR]]
ContainsPtr *test_new_struct_with_ptr() { return new ContainsPtr; }

// CHECK-LABEL: define dso_local noundef ptr
// @_Z30test_new_struct_array_with_ptrv( CHECK: call noalias noundef nonnull ptr
// @_Znam(i64 noundef 160){{.*}} !alloc_token [[META_CONTAINSPTR]]
ContainsPtr *test_new_struct_array_with_ptr() { return new ContainsPtr[10]; }
...
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 64){{.*}}
// !alloc_token [[META_TESTCLASS:![0-9]+]]
TestClass *test_new_class() { return new TestClass(); }

// CHECK-LABEL: define dso_local noundef ptr @_Z20test_new_class_arrayv(
// CHECK: call noalias noundef nonnull ptr @_Znam(i64 noundef 648){{.*}}
// !alloc_token [[META_TESTCLASS]]
TestClass *test_new_class_array() { return new TestClass[10]; }
...
// !alloc_token [[META_VIRTUALTESTCLASS:![0-9]+]]
VirtualTestClass *test_new_virtual_class() { return new VirtualTestClass(); }
...
// !alloc_token [[META_VIRTUALTESTCLASS]]
...
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 16){{.*}}
// !alloc_token [[META_MYSTRUCTUINTPTR:![0-9]+]]
MyStructUintptr *test_uintptr_isptr() { return new MyStructUintptr; }

using uptr = uintptr_t;
// CHECK-LABEL: define dso_local noundef ptr @_Z19test_uintptr_isptr2v(
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 8){{.*}}
// !alloc_token [[META_UINTPTR:![0-9]+]]
uptr *test_uintptr_isptr2() { return new uptr; }
...
StructWithAtomic *test_struct_with_atomic() { return new StructWithAtomic; }
...
// CHECK-LABEL: define dso_local noundef ptr
// @_Z30test_struct_with_atomic_nonptrv( CHECK: call noalias noundef nonnull ptr
// @_Znwm(i64 noundef 4){{.*}} !alloc_token
// [[META_STRUCTWITHATOMICNONPTR:![0-9]+]]
...
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 8){{.*}}
// !alloc_token [[META_STRUCTWITHREF:![0-9]+]]
StructWithRef *test_struct_with_ref(int *p) { return new StructWithRef{*p}; }
...
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 16){{.*}}
// !alloc_token [[META_STRUCTWITHPMF:![0-9]+]]
StructWithPMF *test_struct_with_pmf() { return new StructWithPMF; }
...
// CHECK: call noalias noundef nonnull ptr @_Znwm(i64 noundef 8){{.*}}
// !alloc_token [[META_STRUCTWITHPMD:![0-9]+]]
StructWithPMD *test_struct_with_pmd() { return new StructWithPMD; }
...
// false} CHECK: [[META_STRUCTWITHREF]] = !{!"StructWithRef", i1 true} CHECK:
// [[META_STRUCTWITHPMF]] = !{!"StructWithPMF", i1 true} CHECK:
// [[META_STRUCTWITHPMD]] = !{!"StructWithPMD", i1 false}
