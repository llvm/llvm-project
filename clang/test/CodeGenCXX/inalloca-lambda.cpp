...
// CHECK-SAME: (ptr noundef %this, ptr noundef align 4 dead_on_return %[[V]])
...
// CHECK: %call = call x86_thiscallcc noundef i32
// CHECK-SAME: @"?__impl@<lambda_0>@?0??test@@YAXXZ@QBE?A?<auto>@@UA@@@Z"
// CHECK-SAME: (ptr noundef %unused.capture, ptr noundef align 4 dead_on_return %[[VAR]])
// CHECK: ret i32 %call

// CHECK: define internal x86_thiscallcc noundef i32
// CHECK-SAME: @"?__impl@<lambda_0>@?0??test@@YAXXZ@QBE?A?<auto>@@UA@@@Z"
// CHECK-SAME: (ptr noundef %this, ptr noundef align 4 dead_on_return %[[ARG:.*]])
