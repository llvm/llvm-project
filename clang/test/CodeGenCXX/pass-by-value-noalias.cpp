...
// WITH_NOALIAS: define{{.*}} void @_Z4take3Foo(ptr noalias noundef align 4 dead_on_return %arg)
// NO_NOALIAS: define{{.*}} void @_Z4take3Foo(ptr noundef align 4 dead_on_return %arg)
void take(Foo arg) {}
...
// WITH_NOALIAS: define{{.*}} void @_Z4take10NonTrivial(ptr noundef align 4 dead_on_return %arg)
// NO_NOALIAS:   define{{.*}} void @_Z4take10NonTrivial(ptr noundef align 4 dead_on_return %arg)
...
// WITH_NOALIAS: define{{.*}} void @_Z4take1A(ptr noalias noundef align 1 dead_on_return %arg)
// NO_NOALIAS: define{{.*}} void @_Z4take1A(ptr noundef align 1 dead_on_return %arg)
void take(A arg) {}
