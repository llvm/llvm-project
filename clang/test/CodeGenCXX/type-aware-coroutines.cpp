// RUN: %clang_cc1 -triple arm64-apple-macosx  %s -std=c++23 -fexperimental-cxx-type-aware-allocators -fcoroutines -fexceptions -emit-llvm  -Wno-coro-type-aware-allocation-function -o - | FileCheck %s
