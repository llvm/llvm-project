...
S f() { return S(); }
// CHECK-LABEL: define{{.*}} void @_Z1f1S(ptr nofreeobj noundef align 2 dereferenceable(2) %0)
void f(S) { }
...
// CHECK-LABEL: define{{.*}} void @_Z1f1C(ptr nofreeobj noundef align 4 dereferenceable(8) %0)
void f(C) { }
