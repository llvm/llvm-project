...
void test0(X x) {
  ...
  // CHECK-SAME: ptr nofreeobj noundef align 1 dereferenceable(2) [[ARG:%.*]])
  ...
  // CHECK-NEXT: call void @_Z12test0_helper1A(ptr nofreeobj noundef align 1 dereferenceable(1) [[TMP]])
