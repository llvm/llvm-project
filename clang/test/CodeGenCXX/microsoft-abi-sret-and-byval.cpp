...
// WIN64: define dso_local void @"?packed_arg@@YAXUPacked@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(12) %s)
...
// WOA: define dso_local arm_aapcs_vfpcc void @"?small_arg_with_dtor@@YAXUSmallWithDtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(4) %s) {{.*}} {
...
// WIN64-LABEL: define dso_local void @"?big_arg_with_dtor@@YAXUBigWithDtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s)
...
// WIN64:   call void @"?big_arg_with_dtor@@YAXUBigWithDtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(24) %{{.*}})
...
// LINUX-LABEL: define{{.*}} void @_Z22small_arg_with_vftable16SmallWithVftable(ptr nofree noundef align 4 dead_on_return dereferenceable(8) %s)
// WIN32: define dso_local void @"?small_arg_with_vftable@@YAXUSmallWithVftable@@@Z"(ptr inalloca(<{ %struct.SmallWithVftable }>) %0)
// WIN64: define dso_local void @"?small_arg_with_vftable@@YAXUSmallWithVftable@@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %s)
// WOA64: define dso_local void @"?small_arg_with_vftable@@YAXUSmallWithVftable@@@Z"(ptr nofree noundef align 8 dead_on_return dereferenceable(16) %s)

void medium_arg_with_copy_ctor(MediumWithCopyCtor s) {}
// LINUX-LABEL: define{{.*}} void @_Z25medium_arg_with_copy_ctor18MediumWithCopyCtor(ptr nofree noundef align 4 dead_on_return dereferenceable(8) %s)
// WIN32: define dso_local void @"?medium_arg_with_copy_ctor@@YAXUMediumWithCopyCtor@@@Z"(ptr inalloca(<{ %struct.MediumWithCopyCtor }>) %0)
// WIN64: define dso_local void @"?medium_arg_with_copy_ctor@@YAXUMediumWithCopyCtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(8) %s)
// WOA: define dso_local arm_aapcs_vfpcc void @"?medium_arg_with_copy_ctor@@YAXUMediumWithCopyCtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(8) %s)
// WOA64: define dso_local void @"?medium_arg_with_copy_ctor@@YAXUMediumWithCopyCtor@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(8) %s)
...
// WIN64: define dso_local void @"?big_arg@@YAXUBig@@@Z"(ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s)
...
class Class {
 public:
  ...
  // WIN64: define linkonce_odr dso_local void @"?thiscall_method_arg@Class@@QEAAXUBig@@@Z"(ptr {{[^,]*}} %this, ptr nofree noundef align 4 dead_on_return dereferenceable(24) %s)
};
