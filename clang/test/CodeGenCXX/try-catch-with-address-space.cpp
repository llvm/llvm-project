...
void f() {
  try {
    ...
    // WITH-NONZERO-DEFAULT-AS: call addrspace(4) i32 @llvm.eh.typeid.for.p0(ptr addrspacecast (ptr addrspace(1) @_ZTI1X to ptr))
  }
}
...
void h() {
  try {
    ...
    // WITH-NONZERO-DEFAULT-AS: call addrspace(4) i32 @llvm.eh.typeid.for.p0(ptr addrspacecast (ptr addrspace(1) @_ZTIA4_c to ptr))
  }
}
