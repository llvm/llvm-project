...
test(copy_ctor);
// CHECK: define void @_Z7forward9copy_ctor(ptr dead_on_unwind noalias {{[^,]*}} sret(%struct.copy_ctor) align 8 %{{.*}}, ptr nonnull align 8 dead_on_return %{{.*}})
//
...
// CHECK: call void @_Z3use9copy_ctor(ptr nonnull align 8 dead_on_return %[[tmp]])
// CHECK: ret void
//
// CHECK: declare void @_Z3use9copy_ctor(ptr align 8 dead_on_return)
...
// CHECK: define void @_Z7forward17aligned_copy_ctor(ptr dead_on_unwind noalias {{[^,]*}} sret(%struct.aligned_copy_ctor) align 16 %{{.*}}, ptr nonnull align 16 dead_on_return %{{.*}})
//
...
// CHECK: call void @_Z3use17aligned_copy_ctor(ptr nonnull align 16 dead_on_return %[[tmp]])
// CHECK: ret void
//
// CHECK: declare void @_Z3use17aligned_copy_ctor(ptr align 16 dead_on_return)
