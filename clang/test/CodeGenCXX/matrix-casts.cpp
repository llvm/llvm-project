...
Foo class_constructor_matrix_ty(matrix_5_5<int> m) {
  ...
  // CHECK-NEXT:    call void @_ZN3FooC1Eu11matrix_typeILm5ELm5EiE(ptr nofree noundef nonnull align 4 dereferenceable(40) %agg.result, <25 x i32> noundef [[M]])
  // CHECK-NEXT:    ret void
...
Bar struct_constructor_matrix_ty(matrix_4_4<float> m) {
  ...
  // CHECK-NEXT:    call void @_ZN3BarC1Eu11matrix_typeILm4ELm4EfE(ptr nofree noundef nonnull align 4 dereferenceable(40) %agg.result, <16 x float> noundef [[M]])
  // CHECK-NEXT:    ret void
