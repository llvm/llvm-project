...
void f_1(void) {
  ...
  doStuff_pointerToConstInt(
      tp); // expected-warning {{1st function call argument points to an
           // uninitialized value; this argument is const pointer and is likely
           // input data of the function}} expected-note@-1 {{1st function call
           // argument points to an uninitialized value; this argument is const
           // pointer and is likely input data of the function}}
}
...
void f_1_1(void) {
  ...
  doStuff_pointerToConstInt(
      tp2); // expected-warning {{1st function call argument points to an
            // uninitialized value; this argument is const pointer and is likely
            // input data of the function}} expected-note@-1 {{1st function call
            // argument points to an uninitialized value; this argument is const
            // pointer and is likely input data of the function}}
...
void f_5_1(void) {
  int ta[5]; // expected-note {{'ta' declared without an initial value}}
  doStuff_pointerToConstInt(
      ta); // expected-warning {{1st function call argument points to an
           // uninitialized value; this argument is const pointer and is likely
           // input data of the function}} expected-note@-1 {{1st function call
           // argument points to an uninitialized value; this argument is const
           // pointer and is likely input data of the function}}
...
void f_9(void) {
  ...
  doStuff_arrayOfConstInt(
      ptau); // expected-warning {{1st function call argument points to an
             // uninitialized value; this argument is const pointer and is
             // likely input data of the function}} expected-note@-1 {{1st
             // function call argument points to an uninitialized value; this
             // argument is const pointer and is likely input data of the
             // function}}
}
...
void f_10(void) {
  int a[6]; // expected-note {{'a' declared without an initial value}}
  doStuff_arrayOfConstInt(
      a); // expected-warning {{1st function call argument points to an
          // uninitialized value; this argument is const pointer and is likely
          // input data of the function}} expected-note@-1 {{1st function call
          // argument points to an uninitialized value; this argument is const
          // pointer and is likely input data of the function}}
...
void f_11(void) {
  ...
  doStuff_constStaticSizedArray(
      t); // expected-warning {{1st function call argument points to an
          // uninitialized value; this argument is const pointer and is likely
          // input data of the function}} expected-note@-1 {{1st function call
          // argument points to an uninitialized value; this argument is const
          // pointer and is likely input data of the function}}
...
int f_malloc_1(void) {
  ...
  doStuff_pointerToConstInt(
      ptr); // expected-warning {{1st function call argument points to an
            // uninitialized value; this argument is const pointer and is likely
            // input data of the function}} expected-note@-1 {{1st function call
            // argument points to an uninitialized value; this argument is const
            // pointer and is likely input data of the function}}
...
void f_variadic_unp_unv(void) {
  ...
  doStuff_variadic(
      tp,
      v); // expected-warning {{1st function call argument points to an
          // uninitialized value; this argument is const pointer and is likely
          // input data of the function}} expected-note@-1 {{1st function call
          // argument points to an uninitialized value; this argument is const
          // pointer and is likely input data of the function}}
...
void f_variadic_unp_inp(void) {
  ...
  doStuff_variadic(
      tp,
      vp); // expected-warning {{1st function call argument points to an
           // uninitialized value; this argument is const pointer and is likely
           // input data of the function}} expected-note@-1 {{1st function call
           // argument points to an uninitialized value; this argument is const
           // pointer and is likely input data of the function}}
