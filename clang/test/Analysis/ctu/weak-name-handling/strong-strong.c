...
// RUN: sed -e 's|%t\/||g' %t/extdef_err.txt | FileCheck %t/extdef_check
...
// CHECK: b.c:2:5: warning: multiple definitions are found for the same key during generating index, previous definition found in 'a.c.ast'
