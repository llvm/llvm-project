...
// CHECK-LABEL: define dso_local void @wide_array_subscript_ok(
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_trap1(
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_trap2(
...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT1:.*]], label %[[TRAP:.*]], !prof [[PROF8:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_read_ok(
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_read_ok2(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define dso_local void @wide_array_subscript_read_trap(
...
// CHECK-LABEL: define dso_local void @wide_deref_ok(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define dso_local void @wide_deref_trap(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR3]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR5]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
...
// CHECK-LABEL: define dso_local void @wide_member_assign_ok(
// CHECK-SAME: ) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    ret void
//
...
// CHECK-LABEL: define dso_local void @wide_member_assign_trap(
