...
// CHECK-NEXT:    br i1 [[TMP7]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF3:![0-9]+]], !annotation [[META2]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TMP9]], label %[[CONT18:.*]], label %[[TRAP17:.*]], !prof [[PROF3]], !annotation [[META4]]
// CHECK:       [[TRAP17]]:
...
// CHECK-NEXT:    br i1 [[TMP10]], label %[[CONT20:.*]], label %[[TRAP19:.*]], !prof [[PROF3]], !annotation [[META5]]
// CHECK:       [[TRAP19]]:
...
// CHECK-NEXT:    br i1 true, label %[[CONT23:.*]], label %[[TRAP22:.*]], !prof [[PROF3]], !annotation [[META6:![0-9]+]]
// CHECK:       [[TRAP22]]:
...
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT25:.*]], label %[[TRAP24:.*]], !prof [[PROF3]], !annotation [[META7]]
// CHECK:       [[TRAP24]]:
...
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT27:.*]], label %[[TRAP26:.*]], !prof [[PROF3]], !annotation [[META8]]
// CHECK:       [[TRAP26]]:
...
// CHECK-NEXT:    br i1 [[FLEX_COUNT_CHECK]], label %[[CONT29:.*]], label %[[TRAP28:.*]], !prof [[PROF3]], !annotation [[META9]]
// CHECK:       [[TRAP28]]:
...
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT37:.*]], label %[[TRAP36:.*]], !prof [[PROF3]], !annotation [[META4]]
// CHECK:       [[TRAP36]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT37]]:
// CHECK-NEXT:    [[TMP15:%.*]] = icmp uge ptr [[WIDE_PTR_PTR31]], [[WIDE_PTR_LB35]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP15]], label %[[CONT39:.*]], label %[[TRAP38:.*]], !prof [[PROF3]], !annotation [[META5]]
// CHECK:       [[TRAP38]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT39]]:
...
// CHECK-NEXT:    br i1 [[TMP28]], label %[[CONT59:.*]], label %[[TRAP58:.*]], !prof [[PROF3]], !annotation [[META4]]
// CHECK:       [[TRAP58]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT59]]:
// CHECK-NEXT:    [[TMP29:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB57]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP29]], label %[[CONT61:.*]], label %[[TRAP60:.*]], !prof [[PROF3]], !annotation [[META5]]
// CHECK:       [[TRAP60]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT61]]:
