...
// O0-NEXT:    br i1 [[TMP11]], label %[[CONT22:.*]], label %[[TRAP21:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP21]]:
...
// O0-NEXT:    br i1 [[TMP12]], label %[[CONT24:.*]], label %[[TRAP23:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP23]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT24]]:
...
// O0-NEXT:    br i1 [[TMP18]], label %[[CONT35:.*]], label %[[TRAP34:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP34]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT35]]:
// O0-NEXT:    [[TMP19:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB33]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP19]], label %[[CONT37:.*]], label %[[TRAP36:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP36]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT37]]:
