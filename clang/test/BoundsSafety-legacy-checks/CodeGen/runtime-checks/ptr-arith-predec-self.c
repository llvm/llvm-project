...
// CHECK-O0-LABEL: define dso_local i32 @main(
...
// CHECK-O0-NEXT:    br i1 [[TMP12]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP13]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP1]]:
...
//
// CHECK-O2-LABEL: define dso_local i32 @main(
...
// CHECK-O2-NEXT:    br i1 [[OR_COND]], label %[[CONT1:.*]], label %[[TRAP:.*]], !prof [[PROF7:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O2:       [[TRAP]]:
...
//.
// CHECK-O2: [[PROF7]] = !{!"branch_weights", i32 -8192, i32 8191}
//.
