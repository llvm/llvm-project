...
// O2-NEXT:    br i1 [[OR_COND]], label %[[CONT11:.*]], label %[[TRAP:.*]], !prof [[PROF7:![0-9]+]], {{!annotation ![0-9]+}}
// O2:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP9]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// O0:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP10]], label %[[CONT12:.*]], label %[[TRAP11:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP11]]:
