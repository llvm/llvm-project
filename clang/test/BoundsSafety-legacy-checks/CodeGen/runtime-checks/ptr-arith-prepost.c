...
// CHECK-O0-NEXT:    br i1 [[TMP21]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP22]], label %[[CONT4:.*]], label %[[TRAP3:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP3]]:
