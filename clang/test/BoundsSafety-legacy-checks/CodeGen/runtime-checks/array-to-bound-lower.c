...
// CHECK-O0-NEXT:    br i1 [[TMP18]], label %[[CONT14:.*]], label %[[TRAP13:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP13]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP19]], label %[[CONT16:.*]], label %[[TRAP15:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP15]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT16]]:
...
// CHECK-O2-NEXT:    br i1 [[OR_COND]], label %[[CONT14:.*]], label %[[TRAP:.*]], !prof [[PROF7:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O2:       [[TRAP]]:
...
//
// CHECK-ARM-O2-LABEL: define dso_local arm_aapcscc i32 @main(
// CHECK-ARM-O2-SAME: ) local_unnamed_addr #[[ATTR0:[0-9]+]] {
...
// CHECK-ARM-O2-NEXT:    br i1 [[OR_COND]], label %[[CONT14:.*]], label %[[TRAP:.*]], !prof [[PROF8:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-ARM-O2:       [[TRAP]]:
...
//.
// CHECK-ARM-O2: [[PROF8]] = !{!"branch_weights", i32 -8192, i32 8191}
//.
