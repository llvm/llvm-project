...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS]], label %[[CONT3:.*]], label %[[TRAP2:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP2]]:
...
// CHECK-NEXT:    br i1 [[TMP0]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT]]:
...
// CHECK-NEXT:    br i1 [[TMP3]], label %[[CONT7:.*]], label %[[TRAP6:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP6]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT7]]:
...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS]], label %[[CONT10:.*]], label %[[TRAP9:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP9]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT10]]:
