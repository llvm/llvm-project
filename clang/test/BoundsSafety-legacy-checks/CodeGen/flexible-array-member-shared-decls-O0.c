...
// CHECK-NEXT:    [[TMP19:%.*]] = icmp ult ptr [[WIDE_PTR_PTR70]], [[WIDE_PTR_UB72]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP19]], label %[[CONT76:.*]], label %[[TRAP75:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP75]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT76]]:
// CHECK-NEXT:    [[TMP20:%.*]] = icmp uge ptr [[WIDE_PTR_PTR70]], [[WIDE_PTR_LB74]], !annotation [[META6]]
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT78:.*]], label %[[TRAP77:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP77]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT78]]:
...
// CHECK-NEXT:    [[TMP24:%.*]] = icmp ne ptr [[TMP23]], null, !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP24]], label %[[BOUNDSCHECK_NOTNULL89:.*]], label %[[BOUNDSCHECK_NULL96:.*]], !annotation [[META3]]
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR97:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP88]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR98:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR97]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR99:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP88]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB100:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR99]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR101:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP88]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB102:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR101]], align 8
// CHECK-NEXT:    [[TMP32:%.*]] = icmp ne ptr [[WIDE_PTR_PTR98]], null, !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP32]], label %[[BOUNDSCHECK_NOTNULL103:.*]], label %[[BOUNDSCHECK_NULL108:.*]], !annotation [[META3]]
// CHECK:       [[BOUNDSCHECK_NOTNULL103]]:
// CHECK-NEXT:    [[TMP33:%.*]] = icmp ult ptr [[WIDE_PTR_PTR98]], [[WIDE_PTR_UB100]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP33]], label %[[CONT105:.*]], label %[[TRAP104:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP104]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT105]]:
// CHECK-NEXT:    [[TMP34:%.*]] = icmp uge ptr [[WIDE_PTR_PTR98]], [[WIDE_PTR_LB102]], !annotation [[META6]]
// CHECK-NEXT:    br i1 [[TMP34]], label %[[CONT107:.*]], label %[[TRAP106:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP106]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT107]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL108]]
// CHECK:       [[BOUNDSCHECK_NULL108]]:
// CHECK-NEXT:    ret ptr [[WIDE_PTR_PTR98]]
//
