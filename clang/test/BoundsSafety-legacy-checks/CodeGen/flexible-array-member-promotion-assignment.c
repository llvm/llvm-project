...
// CHECK-NEXT:    br i1 [[TMP20]], label [[BOUNDSCHECK_NOTNULL42:%.*]], label [[BOUNDSCHECK_NULL:%.*]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[TMP16]], label [[BOUNDSCHECK_NOTNULL30:%.*]], label [[BOUNDSCHECK_NULL:%.*]], {{!annotation ![0-9]+}}
