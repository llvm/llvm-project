...
// CHECK-NEXT:    [[TMP10:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB7]], !annotation [[META1:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP10]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3:[0-9]+]], !annotation [[META1]]
// CHECK-NEXT:    unreachable, !annotation [[META1]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP11:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META3:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT9:.*]], label %[[TRAP8:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP8]]:
...
// CHECK-SAME: ptr noundef align 8 dead_on_return [[BAR:%.*]], i32 noundef [[LEN:%.*]]) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    br i1 [[FLEX_BASE_NULL_CHECK]], label %[[FLEX_BASE_NONNULL:.*]], label %[[FLEX_BASE_NULL:.*]], !annotation [[META4]]
...
// CHECK-NEXT:    br i1 [[TMP5]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    [[TMP7:%.*]] = icmp ule ptr [[TMP6]], [[WIDE_PTR_UB14]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[TMP7]], label %[[CONT18:.*]], label %[[TRAP17:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// CHECK:       [[TRAP17]]:
...
// CHECK-NEXT:    br i1 [[TMP8]], label %[[CONT20:.*]], label %[[TRAP19:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP19]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT20]]:
...
// CHECK-NEXT:    br i1 [[FLEX_COUNT_MINUS]], label %[[CONT22:.*]], label %[[TRAP21:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP21]]:
...
// CHECK-NEXT:    br i1 [[TMP9]], label %[[CONT24:.*]], label %[[TRAP23:.*]], {{!prof ![0-9]+}}, !annotation [[META7]]
// CHECK:       [[TRAP23]]:
...
// CHECK-NEXT:    br i1 [[TMP10]], label %[[CONT26:.*]], label %[[TRAP25:.*]], {{!prof ![0-9]+}}, !annotation [[META8]]
// CHECK:       [[TRAP25]]:
...
// CHECK-NEXT:    br i1 [[FLEX_COUNT_CHECK]], label %[[CONT28:.*]], label %[[TRAP27:.*]], {{!prof ![0-9]+}}, !annotation [[META9]]
// CHECK:       [[TRAP27]]:
...
// CHECK-NEXT:    br i1 [[TMP11]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL]]:
// CHECK-NEXT:    [[TMP12:%.*]] = icmp ult ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_UB32]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT36:.*]], label %[[TRAP35:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// CHECK:       [[TRAP35]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META1]]
// CHECK-NEXT:    unreachable, !annotation [[META1]]
// CHECK:       [[CONT36]]:
// CHECK-NEXT:    [[TMP13:%.*]] = icmp uge ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_LB34]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT38:.*]], label %[[TRAP37:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT38]]:
...
// CHECK-NEXT:    br i1 [[TMP16]], label %[[BOUNDSCHECK_NOTNULL41:.*]], label %[[BOUNDSCHECK_NULL46:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL41]]:
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR47:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP40]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR48:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR47]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR49:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP40]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB50:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR49]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR51:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP40]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB52:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR51]], align 8
// CHECK-NEXT:    [[TMP24:%.*]] = icmp ne ptr [[WIDE_PTR_PTR48]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP24]], label %[[BOUNDSCHECK_NOTNULL53:.*]], label %[[BOUNDSCHECK_NULL58:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL53]]:
// CHECK-NEXT:    [[TMP25:%.*]] = icmp ult ptr [[WIDE_PTR_PTR48]], [[WIDE_PTR_UB50]], !annotation [[META1]]
// CHECK-NEXT:    br i1 [[TMP25]], label %[[CONT55:.*]], label %[[TRAP54:.*]], {{!prof ![0-9]+}}, !annotation [[META1]]
// CHECK:       [[TRAP54]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META1]]
// CHECK-NEXT:    unreachable, !annotation [[META1]]
// CHECK:       [[CONT55]]:
// CHECK-NEXT:    [[TMP26:%.*]] = icmp uge ptr [[WIDE_PTR_PTR48]], [[WIDE_PTR_LB52]], !annotation [[META3]]
// CHECK-NEXT:    br i1 [[TMP26]], label %[[CONT57:.*]], label %[[TRAP56:.*]], {{!prof ![0-9]+}}, !annotation [[META3]]
// CHECK:       [[TRAP56]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META3]]
// CHECK-NEXT:    unreachable, !annotation [[META3]]
// CHECK:       [[CONT57]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL58]]
// CHECK:       [[BOUNDSCHECK_NULL58]]:
// CHECK-NEXT:    ret ptr [[WIDE_PTR_PTR48]]
//
...
//.
// CHECK: [[META1]] = !{!"bounds-safety-check-ptr-lt-upper-bound"}
