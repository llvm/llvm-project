...
// CHECK-NEXT:    br i1 [[TMP4]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META2]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TMP6]], label %[[CONT18:.*]], label %[[TRAP17:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// CHECK:       [[TRAP17]]:
...
// CHECK-NEXT:    br i1 [[TMP7]], label %[[CONT20:.*]], label %[[TRAP19:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP19]]:
...
// CHECK-NEXT:    br i1 [[TMP8]], label %[[CONT24:.*]], label %[[TRAP23:.*]], {{!prof ![0-9]+}}, !annotation [[META7]]
// CHECK:       [[TRAP23]]:
...
// CHECK-NEXT:    br i1 [[TMP9]], label %[[CONT26:.*]], label %[[TRAP25:.*]], {{!prof ![0-9]+}}, !annotation [[META8]]
// CHECK:       [[TRAP25]]:
...
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT36:.*]], label %[[TRAP35:.*]], {{!prof ![0-9]+}}, !annotation [[META4]]
// CHECK:       [[TRAP35]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT36]]:
// CHECK-NEXT:    [[TMP12:%.*]] = icmp uge ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_LB34]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT38:.*]], label %[[TRAP37:.*]], {{!prof ![0-9]+}}, !annotation [[META5]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT38]]:
