...
// CHECK-NEXT:    [[TMP4:%.*]] = icmp ule ptr [[WIDE_PTR_PTR5]], [[TMP3]], !annotation [[META2:![0-9]+]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = icmp ule ptr [[TMP5]], [[WIDE_PTR_UB14]], !annotation [[META4:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP6]], label %[[CONT18:.*]], label %[[TRAP17:.*]], !prof [[PROF3]], !annotation [[META4]]
// CHECK:       [[TRAP17]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT18]]:
// CHECK-NEXT:    [[TMP7:%.*]] = icmp ule ptr [[WIDE_PTR_LB16]], [[WIDE_PTR_PTR12]], !annotation [[META5:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP7]], label %[[CONT20:.*]], label %[[TRAP19:.*]], !prof [[PROF3]], !annotation [[META5]]
// CHECK:       [[TRAP19]]:
...
// CHECK-NEXT:    [[FLEX_COUNT_MINUS:%.*]] = icmp sle i32 0, [[CALL]], !annotation [[META6:![0-9]+]]
// CHECK-NEXT:    br i1 [[FLEX_COUNT_MINUS]], label %[[CONT22:.*]], label %[[TRAP21:.*]], !prof [[PROF3]], !annotation [[META6]]
// CHECK:       [[TRAP21]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META6]]
// CHECK-NEXT:    unreachable, !annotation [[META6]]
// CHECK:       [[CONT22]]:
// CHECK-NEXT:    [[TMP8:%.*]] = icmp ule ptr [[ARRAYDECAY]], [[WIDE_PTR_UB7]], !annotation [[META7:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP8]], label %[[CONT24:.*]], label %[[TRAP23:.*]], !prof [[PROF3]], !annotation [[META7]]
// CHECK:       [[TRAP23]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META7]]
// CHECK-NEXT:    unreachable, !annotation [[META7]]
// CHECK:       [[CONT24]]:
// CHECK-NEXT:    [[TMP9:%.*]] = icmp uge ptr [[WIDE_PTR_PTR5]], [[WIDE_PTR_LB9]], !annotation [[META8:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP9]], label %[[CONT26:.*]], label %[[TRAP25:.*]], !prof [[PROF3]], !annotation [[META8]]
// CHECK:       [[TRAP25]]:
...
// CHECK-NEXT:    [[FLEX_COUNT_INTPTR:%.*]] = zext i32 [[CALL]] to i64, !annotation [[META9]]
// CHECK-NEXT:    [[FLEX_COUNT_CHECK:%.*]] = icmp ule i64 [[FLEX_COUNT_INTPTR]], [[FLEX_AVAIL_COUNT_DIV]], !annotation [[META9]]
// CHECK-NEXT:    br i1 [[FLEX_COUNT_CHECK]], label %[[CONT28:.*]], label %[[TRAP27:.*]], !prof [[PROF3]], !annotation [[META9]]
// CHECK:       [[TRAP27]]:
...
// CHECK-NEXT:    [[TMP10:%.*]] = icmp ne ptr [[WIDE_PTR_PTR30]], null, !annotation [[META1]]
// CHECK-NEXT:    br i1 [[TMP10]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META1]]
// CHECK:       [[BOUNDSCHECK_NOTNULL]]:
// CHECK-NEXT:    [[TMP11:%.*]] = icmp ult ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_UB32]], !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP11]], label %[[CONT36:.*]], label %[[TRAP35:.*]], !prof [[PROF3]], !annotation [[META4]]
// CHECK:       [[TRAP35]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META4]]
// CHECK-NEXT:    unreachable, !annotation [[META4]]
// CHECK:       [[CONT36]]:
// CHECK-NEXT:    [[TMP12:%.*]] = icmp uge ptr [[WIDE_PTR_PTR30]], [[WIDE_PTR_LB34]], !annotation [[META5]]
// CHECK-NEXT:    br i1 [[TMP12]], label %[[CONT38:.*]], label %[[TRAP37:.*]], !prof [[PROF3]], !annotation [[META5]]
// CHECK:       [[TRAP37]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META5]]
// CHECK-NEXT:    unreachable, !annotation [[META5]]
// CHECK:       [[CONT38]]:
