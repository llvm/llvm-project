...
// CHECK-NEXT:    br i1 [[TMP0]], label %[[TERMINATED_BY_LOOP_COND:.*]], label %[[TRAP:.*]], !prof [[PROF6:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS_NOT]], label %[[TRAP]], label %[[CONT2]], !prof [[PROF9:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[DOTNOT]], i1 [[TMP0]], i1 false, !prof [[PROF14:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[TERMINATED_BY_LOOP_COND:.*]], label %[[TRAP:.*]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS_NOT]], label %[[TRAP]], label %[[CONT8]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT8]]:
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TERMINATED_BY_CUR_0]], align 4
// CHECK-NEXT:    [[TERMINATED_BY_CHECK_TERMINATOR:%.*]] = icmp eq i32 [[TMP1]], 0
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_TERMINATOR]], label %[[TERMINATED_BY_LOOP_END:.*]], label %[[TERMINATED_BY_LOOP_COND]]
...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP0:%.*]] = icmp ult ptr [[PTR_COERCE0]], [[PTR_COERCE1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP0]], label %[[TERMINATED_BY_LOOP_COND:.*]], label %[[TRAP:.*]], !prof [[PROF6]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[TERMINATED_BY_LOOP_COND]]:
...
// CHECK-NEXT:    [[TERMINATED_BY_CHECK_ACCESS_NOT:%.*]] = icmp ugt ptr [[TERMINATED_BY_ONE_PAST_CUR]], [[PTR_COERCE1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TERMINATED_BY_CHECK_ACCESS_NOT]], label %[[TRAP]], label %[[CONT2]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
