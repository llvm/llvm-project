...
// CHECK-O0-NEXT:    [[AGG_TEMP55:%.*]] = alloca %"__bounds_safety::wide_ptr.bidi_indexable", align 8
// CHECK-O0-NEXT:    [[AGG_TEMP71:%.*]] = alloca %"__bounds_safety::wide_ptr.bidi_indexable", align 8
...
// CHECK-O0-NEXT:    [[TMP31:%.*]] = icmp ult ptr [[ARRAYIDX]], [[WIDE_PTR_UB48]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP31]], label %[[CONT52:.*]], label %[[TRAP51:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP51]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT52]]:
// CHECK-O0-NEXT:    [[TMP32:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB50]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP32]], label %[[CONT54:.*]], label %[[TRAP53:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP53]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT54]]:
...
// CHECK-O0:       [[FOR_END]]:
// CHECK-O0-NEXT:    [[L56:%.*]] = getelementptr inbounds nuw [[STRUCT_S]], ptr [[S]], i32 0, i32 2
// CHECK-O0-NEXT:    [[TMP34:%.*]] = load i32, ptr [[L56]], align 8
// CHECK-O0-NEXT:    [[BP257:%.*]] = getelementptr inbounds nuw [[STRUCT_S]], ptr [[S]], i32 0, i32 1
// CHECK-O0-NEXT:    [[TMP35:%.*]] = load ptr, ptr [[BP257]], align 8
// CHECK-O0-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP34]], 1
// CHECK-O0-NEXT:    [[IDX_EXT58:%.*]] = sext i32 [[ADD]] to i64
// CHECK-O0-NEXT:    [[ADD_PTR59:%.*]] = getelementptr inbounds i32, ptr [[TMP35]], i64 [[IDX_EXT58]]
// CHECK-O0-NEXT:    [[TMP36:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 0
// CHECK-O0-NEXT:    store ptr [[TMP35]], ptr [[TMP36]], align 8
// CHECK-O0-NEXT:    [[TMP37:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 1
// CHECK-O0-NEXT:    store ptr [[ADD_PTR59]], ptr [[TMP37]], align 8
// CHECK-O0-NEXT:    [[TMP38:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 2
// CHECK-O0-NEXT:    store ptr [[TMP35]], ptr [[TMP38]], align 8
// CHECK-O0-NEXT:    [[WIDE_PTR_PTR_ADDR60:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 0
// CHECK-O0-NEXT:    [[WIDE_PTR_PTR61:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR60]], align 8
// CHECK-O0-NEXT:    [[ARRAYIDX62:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR61]], i64 8
// CHECK-O0-NEXT:    [[WIDE_PTR_UB_ADDR63:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 1
// CHECK-O0-NEXT:    [[WIDE_PTR_UB64:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR63]], align 8
// CHECK-O0-NEXT:    [[WIDE_PTR_LB_ADDR65:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP55]], i32 0, i32 2
// CHECK-O0-NEXT:    [[WIDE_PTR_LB66:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR65]], align 8
// CHECK-O0-NEXT:    [[TMP39:%.*]] = icmp ult ptr [[ARRAYIDX62]], [[WIDE_PTR_UB64]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP39]], label %[[CONT68:.*]], label %[[TRAP67:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP67]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT68]]:
// CHECK-O0-NEXT:    [[TMP40:%.*]] = icmp uge ptr [[ARRAYIDX62]], [[WIDE_PTR_LB66]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP40]], label %[[CONT70:.*]], label %[[TRAP69:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP69]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT70]]:
// CHECK-O0-NEXT:    [[TMP41:%.*]] = load i32, ptr [[ARRAYIDX62]], align 4
// CHECK-O0-NEXT:    [[L72:%.*]] = getelementptr inbounds nuw [[STRUCT_S]], ptr [[S]], i32 0, i32 2
// CHECK-O0-NEXT:    [[TMP42:%.*]] = load i32, ptr [[L72]], align 8
// CHECK-O0-NEXT:    [[BP73:%.*]] = getelementptr inbounds nuw [[STRUCT_S]], ptr [[S]], i32 0, i32 0
// CHECK-O0-NEXT:    [[TMP43:%.*]] = load ptr, ptr [[BP73]], align 8
// CHECK-O0-NEXT:    [[IDX_EXT74:%.*]] = sext i32 [[TMP42]] to i64
// CHECK-O0-NEXT:    [[ADD_PTR75:%.*]] = getelementptr inbounds i32, ptr [[TMP43]], i64 [[IDX_EXT74]]
// CHECK-O0-NEXT:    [[TMP44:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 0
// CHECK-O0-NEXT:    store ptr [[TMP43]], ptr [[TMP44]], align 8
// CHECK-O0-NEXT:    [[TMP45:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 1
// CHECK-O0-NEXT:    store ptr [[ADD_PTR75]], ptr [[TMP45]], align 8
// CHECK-O0-NEXT:    [[TMP46:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 2
// CHECK-O0-NEXT:    store ptr [[TMP43]], ptr [[TMP46]], align 8
// CHECK-O0-NEXT:    [[WIDE_PTR_PTR_ADDR76:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 0
// CHECK-O0-NEXT:    [[WIDE_PTR_PTR77:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR76]], align 8
// CHECK-O0-NEXT:    [[ARRAYIDX78:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR77]], i64 8
// CHECK-O0-NEXT:    [[WIDE_PTR_UB_ADDR79:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 1
// CHECK-O0-NEXT:    [[WIDE_PTR_UB80:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR79]], align 8
// CHECK-O0-NEXT:    [[WIDE_PTR_LB_ADDR81:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[AGG_TEMP71]], i32 0, i32 2
// CHECK-O0-NEXT:    [[WIDE_PTR_LB82:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR81]], align 8
// CHECK-O0-NEXT:    [[TMP47:%.*]] = icmp ult ptr [[ARRAYIDX78]], [[WIDE_PTR_UB80]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP47]], label %[[CONT84:.*]], label %[[TRAP83:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP83]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT84]]:
// CHECK-O0-NEXT:    [[TMP48:%.*]] = icmp uge ptr [[ARRAYIDX78]], [[WIDE_PTR_LB82]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP48]], label %[[CONT86:.*]], label %[[TRAP85:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP85]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT86]]:
// CHECK-O0-NEXT:    [[TMP49:%.*]] = load i32, ptr [[ARRAYIDX78]], align 4
// CHECK-O0-NEXT:    [[ADD87:%.*]] = add nsw i32 [[TMP41]], [[TMP49]]
// CHECK-O0-NEXT:    ret i32 [[ADD87]]
//
