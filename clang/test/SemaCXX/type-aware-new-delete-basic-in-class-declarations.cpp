...
void f() {
  ...
  // no_type_aware-note@-2 {{in instantiation of template class 'S7<int>' requested here}}
...
struct S9 {
  ...
  // no_type_aware-error@-2 {{type aware 'operator new' declared but type aware allocator support is disabled. Pass -fcxx-type-aware-allocators to enable it}}
...
void test() {
  S9 *s9 = new S9;
  // no_type_aware-error@-1 {{no matching function for call to 'operator new'}}
  // no_type_aware-note@#S9_typed_new {{candidate function not viable: requires 2 arguments, but 1 was provided}}
  delete s9;
  // no_type_aware-error@-1 {{no suitable member 'operator delete' in 'S9'}}
  // no_type_aware-note@#S9_typed_delete {{member 'operator delete' declared here}}
  S10 *s10 = new S10;
  // no_type_aware-error@-1 {{no matching function for call to 'operator new'}}
  delete s10;
  // no_type_aware-error@-1 {{no suitable member 'operator delete' in 'S10'}}
