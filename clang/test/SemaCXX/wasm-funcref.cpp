// RUN: %clang_cc1 -std=c++11 -fcxx-exceptions -fexceptions -fsyntax-only
// -verify -triple wasm32 -Wno-unused-value -target-feature +reference-types %s
...
IntIntFuncref getFuncref() { return get; }
