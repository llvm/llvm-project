...
template <class T>
template <class U>
void A<T>::B<U>::f(X<int, long> &x) {
  x.n = 0;
  // expected-error@-1 {{'n' is a private member of 'GH104057::X<int, long>'}}
  //   expected-note@#GH104057-X-n {{implicitly declared private here}}
}
