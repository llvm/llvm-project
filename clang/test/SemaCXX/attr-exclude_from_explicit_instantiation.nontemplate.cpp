...
struct C {
  ...
  // expected-warning@-1{{'exclude_from_explicit_instantiation' attribute ignored on a non-template context}}
...
// expected-warning@-1{{'exclude_from_explicit_instantiation' attribute ignored on a non-member declaration}}
