...
// no_taa_disabled-error@-1 {{type aware 'operator new' declared but type aware allocator support is disabled. Pass -fcxx-type-aware-allocators to enable it}}
...
// no_taa_disabled-error@-1 {{type aware 'operator delete' declared but type aware allocator support is disabled. Pass -fcxx-type-aware-allocators to enable it}}
...
// both-error@-1 {{'operator new' cannot take a dependent type as its 1st parameter}}

template <typename T> void operator delete(T, void*, size_t, std::align_val_t);
// both-error@-1 {{'operator delete' cannot take a dependent type as its 1st parameter}}
...
// no_taa_disabled-error@-2 {{type aware 'operator new' declared but type aware allocator support is disabled. Pass -fcxx-type-aware-allocators to enable it}}
...
// no_taa_disabled-error@-2 {{type aware 'operator delete' declared but type aware allocator support is disabled. Pass -fcxx-type-aware-allocators to enable it}}
