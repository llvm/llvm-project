...
int main() {
  ...
  fwd_ref_arg_kernel<fwd_ref_arg_kernel_name>(std::move(lambda));
...
// CHECK-HOST-LINUX:      @.str.6 = private unnamed_addr constant [33 x i8] c"_ZTS26rvalue_ref_arg_kernel_name\00", align 1
...
// CHECK-HOST-LINUX-NEXT: }
//
// CHECK-HOST-LINUX:      define internal void @_Z18fwd_ref_arg_kernelI23fwd_ref_arg_kernel_nameZ4mainEUlT_E_EvOT0_(ptr noundef nonnull align 4 dereferenceable(4) %ref) #{{[0-9]+}} {
// CHECK-HOST-LINUX-NEXT: entry:
// CHECK-HOST-LINUX-NEXT:   %ref.addr = alloca ptr, align 8
// CHECK-HOST-LINUX-NEXT:   %agg.tmp = alloca %class.anon, align 4
// CHECK-HOST-LINUX-NEXT:   store ptr %ref, ptr %ref.addr, align 8
...
// CHECK-HOST-LINUX-NEXT:   %1 = load i32, ptr %coerce.dive, align 4
// CHECK-HOST-LINUX-NEXT:   call void @_Z18sycl_kernel_launchI26rvalue_ref_arg_kernel_nameJZ4mainEUlT_E0_EEvPKcDpT0_(ptr noundef @.str.6, i32 %1)
// CHECK-HOST-LINUX-NEXT:   ret void
// CHECK-HOST-LINUX-NEXT: }
...
// CHECK-HOST-WINDOWS-NEXT: }
//
// CHECK-HOST-WINDOWS:      define internal void @"??$fwd_ref_arg_kernel@Ufwd_ref_arg_kernel_name@@V<lambda_1>@?0??main@@9@@@YAX$$QEAV<lambda_1>@?0??main@@9@@Z"(ptr noundef nonnull align 4 dereferenceable(4) %ref) #{{[0-9]+}} {
// CHECK-HOST-WINDOWS-NEXT: entry:
// CHECK-HOST-WINDOWS-NEXT:   %ref.addr = alloca ptr, align 8
// CHECK-HOST-WINDOWS-NEXT:   %agg.tmp = alloca %class.anon, align 4
// CHECK-HOST-WINDOWS-NEXT:   store ptr %ref, ptr %ref.addr, align 8
