...
void callFns() {
  ...
  implicitFn(1); // Ok.
  inFn(1); // Ok.
  inoutFn(1); // expected-error{{cannot bind non-lvalue argument '1' to inout parameter}}
  outFn(1); // expected-error{{cannot bind non-lvalue argument '1' to out parameter}}
