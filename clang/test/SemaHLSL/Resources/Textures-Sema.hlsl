...
void main(COORD_TYPE loc) {
  ...
  // expected-error@+6 {{no matching member function for call to 'Sample'}}
  // dim1-note@*:* {{candidate function not viable: no known conversion from 'SamplerState' to 'int' for 3rd argument}}
