...
@.str = private unnamed_addr constant [5 x i8] c"gOut\00", align 1
@_ZL16sharedStruct.buf = internal global %"class.hlsl::RWByteAddressBuffer" poison, align 4
@.str.2 = private unnamed_addr constant [17 x i8] c"sharedStruct.buf\00", align 1
@sharedStruct = external hidden addrspace(3) global %struct.PassBufStruct, align 4
