...
void main(uint3 tid : SV_DispatchThreadID) {
    ...
    volatile RWByteAddressBuffer buf = gBuf0; // expected-error {{expected ';' at end of declaration}}
    buf.Store(tid.x * 4, 42); // expected-error {{use of undeclared identifier 'buf'}}
}
