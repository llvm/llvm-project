...
uint builtin_f32tof16_too_few_arg() {
  ...
  // expected-note@hlsl/hlsl_alias_intrinsics_gen.inc:* {{candidate function template not viable: requires 1 argument, but 0 were provided}}
}
...
uint builtin_f32tof16_too_many_arg(uint p0) {
  ...
  // expected-note@hlsl/hlsl_alias_intrinsics_gen.inc:* {{candidate function template not viable: requires 1 argument, but 2 were provided}}
}
