...
float4 test_mips() : SV_Target {
  // expected-error@+4 {{'mips_type' is a private member of 'hlsl::Texture2DArray<>'}}
  // expected-note@*:* {{implicitly declared private here}}
  // expected-error@+2 {{calling a protected constructor of class 'hlsl::Texture2DArray<>::mips_type'}}
  // expected-note@*:* {{implicitly declared protected here}}
  Texture2DArray<float4>::mips_type a;

  // expected-error@+4 {{'mips_slice_type' is a private member of 'hlsl::Texture2DArray<>'}}
  // expected-note@*:* {{implicitly declared private here}}
  // expected-error@+2 {{calling a protected constructor of class 'hlsl::Texture2DArray<>::mips_slice_type'}}
  // expected-note@*:* {{implicitly declared protected here}}
