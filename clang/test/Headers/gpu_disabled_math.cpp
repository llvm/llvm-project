...
// RUN:   -D __CLANG_GPU_DISABLE_MATH_WRAPPERS | FileCheck -check-prefix=AMDGPU
// %s
...
// AMDGPU-NEXT:    [[X_ADDR_ASCAST:%.*]] = addrspacecast ptr addrspace(5)
// [[X_ADDR]] to ptr AMDGPU-NEXT:    store double [[X]], ptr [[X_ADDR_ASCAST]],
// align 8 AMDGPU-NEXT:    [[TMP0:%.*]] = load double, ptr [[X_ADDR_ASCAST]],
// align 8 AMDGPU-NEXT:    [[TMP1:%.*]] = call double @llvm.sin.f64(double
// [[TMP0]]) AMDGPU-NEXT:    ret double [[TMP1]]
//
...
//
double foo(double x) { return sin(x); }
