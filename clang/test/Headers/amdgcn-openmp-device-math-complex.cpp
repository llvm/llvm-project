...
// -emit-llvm-bc %s -o %t-x86-host.bc RUN: %clang_cc1 -verify -internal-isystem
...
// %t-x86-host.bc -aux-triple x86_64-unknown-unknown -o - | FileCheck %s
...
// i32 504) CHECK-DAG: call i1 @llvm.is.fpclass.f64(double %{{.+}}, /* (inf) */
// i32 516) CHECK-DAG: call double @llvm.copysign.f64( CHECK-DAG: call double
// @llvm.ldexp.f64.i32( CHECK-DAG: call double @llvm.fabs.f64( CHECK-DAG: call {
// double, i32 } @llvm.frexp.f64.i32

// CHECK: define weak {{.*}} @__divsc3
// CHECK-DAG: call i1 @llvm.is.fpclass.f32(float %{{.+}}, /* (nan) */ i32 3)
// CHECK-DAG: call i1 @llvm.is.fpclass.f32(float %{{.+}}, /* (zero sub norm) */
// i32 504) CHECK-DAG: call i1 @llvm.is.fpclass.f32(float %{{.+}}, /* (inf) */
// i32 516) CHECK-DAG: call float @llvm.copysign.f32( CHECK-DAG: call float
// @llvm.ldexp.f32.i32( CHECK-DAG: call float @llvm.fabs.f32( CHECK-DAG: call {
// float, i32 } @llvm.frexp.f32.i32
