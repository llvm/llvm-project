...
// static and overloadable to get the same function annotations between C, C++
// and HIP.
...
// [[SRC_ADDR]] to ptr CHECK-NEXT:    store float [[SRC]], ptr
// [[SRC_ADDR_ASCAST]], align 4 CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr
// [[SRC_ADDR_ASCAST]], align 4 CHECK-NEXT:    [[CALL:%.*]] = call float
// @__ocml_acos_f32(float [[TMP0]]) #[[ATTR5:[0-9]+]] CHECK-NEXT:    ret float
// [[CALL]]
//
