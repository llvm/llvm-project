...
// -fopenmp-targets=amdgpu-amd-amdhsa -triple powerpc64le-unknown-unknown
...
// [[X_ADDR_ASCAST]], align 4 CHECK-NEXT:    [[__X_ADDR_ASCAST_I:%.*]] =
// addrspacecast ptr addrspace(5) [[__X_ADDR_I]] to ptr CHECK-NEXT:
// [[__SGN_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[__SGN_I]] to ptr
...
// [[X_ADDR_ASCAST]], align 8 CHECK-NEXT:    [[__X_ADDR_ASCAST_I:%.*]] =
// addrspacecast ptr addrspace(5) [[__X_ADDR_I]] to ptr CHECK-NEXT:
// [[__SGN_ASCAST_I:%.*]] = addrspacecast ptr addrspace(5) [[__SGN_I]] to ptr
