...
// CHECK-NEXT:    [[DYNAMIC_LDS_SIZE:%.*]] = getelementptr inbounds nuw [[STRUCT_AMDHSA_IMPLICIT_KERNARG_V5]], ptr addrspace(4) [[TMP37]], i32 0, i32 13
// CHECK-NEXT:    [[TMP38:%.*]] = load i32, ptr addrspace(4) [[DYNAMIC_LDS_SIZE]], align 8, !tbaa [[INT_TBAA21:![0-9]+]]
...
// CHECK-NEXT:    [[ASSERT_FAULT_BUFFER:%.*]] = getelementptr inbounds nuw [[STRUCT_AMDHSA_IMPLICIT_KERNARG_V5]], ptr addrspace(4) [[TMP39]], i32 0, i32 14
// CHECK-NEXT:    [[TMP40:%.*]] = load ptr addrspace(1), ptr addrspace(4) [[ASSERT_FAULT_BUFFER]], align 4, !tbaa [[ANYPTR_TBAA22:![0-9]+]]
// CHECK-NEXT:    call void @use_ptr(ptr addrspace(1) noundef [[TMP40]]) #[[ATTR5]]
...
// CHECK-NEXT:    [[QUEUE_PTR:%.*]] = getelementptr inbounds nuw [[STRUCT_AMDHSA_IMPLICIT_KERNARG_V5]], ptr addrspace(4) [[TMP41]], i32 0, i32 18
// CHECK-NEXT:    [[TMP42:%.*]] = load ptr addrspace(1), ptr addrspace(4) [[QUEUE_PTR]], align 8, !tbaa [[ANYPTR_TBAA23:![0-9]+]]
// CHECK-NEXT:    call void @use_ptr(ptr addrspace(1) noundef [[TMP42]]) #[[ATTR5]]
// CHECK-NEXT:    [[TMP43:%.*]] = load ptr addrspace(4), ptr addrspace(5) [[IMPLICIT_ARGS]], align 8, !tbaa [[_ZTS26AMDHSA_IMPLICIT_KERNARG_V5PTR_TBAA7]]
// CHECK-NEXT:    [[PRIVATE_BASE:%.*]] = getelementptr inbounds nuw [[STRUCT_AMDHSA_IMPLICIT_KERNARG_V5]], ptr addrspace(4) [[TMP43]], i32 0, i32 16
// CHECK-NEXT:    [[TMP44:%.*]] = load i32, ptr addrspace(4) [[PRIVATE_BASE]], align 8, !tbaa [[INT_TBAA24:![0-9]+]]
// CHECK-NEXT:    call void @use_u32(i32 noundef [[TMP44]]) #[[ATTR5]]
// CHECK-NEXT:    [[TMP45:%.*]] = load ptr addrspace(4), ptr addrspace(5) [[IMPLICIT_ARGS]], align 8, !tbaa [[_ZTS26AMDHSA_IMPLICIT_KERNARG_V5PTR_TBAA7]]
// CHECK-NEXT:    [[SHARED_BASE:%.*]] = getelementptr inbounds nuw [[STRUCT_AMDHSA_IMPLICIT_KERNARG_V5]], ptr addrspace(4) [[TMP45]], i32 0, i32 17
// CHECK-NEXT:    [[TMP46:%.*]] = load i32, ptr addrspace(4) [[SHARED_BASE]], align 4, !tbaa [[INT_TBAA25:![0-9]+]]
// CHECK-NEXT:    call void @use_u32(i32 noundef [[TMP46]]) #[[ATTR5]]
...
void test_implicit_args_v5() {
  ...
  use_u32(implicit_args->dynamic_lds_size);
  use_ptr(implicit_args->assert_fault_buffer);
...
// CHECK: [[META15]] = !{!"amdhsa_implicit_kernarg_v5", [[META5]], i64 0, [[META5]], i64 12, [[META5]], i64 18, [[META5]], i64 24, [[META5]], i64 40, [[META11]], i64 64, [[META5]], i64 66, [[META9]], i64 72, [[META9]], i64 80, [[META9]], i64 88, [[META9]], i64 96, [[META9]], i64 104, [[META9]], i64 112, [[META4]], i64 120, [[META9]], i64 124, [[META5]], i64 132, [[META4]], i64 192, [[META4]], i64 196, [[META9]], i64 200, [[META5]], i64 208}
...
// CHECK: [[INT_TBAA21]] = !{[[META15]], [[META4]], i64 120}
// CHECK: [[ANYPTR_TBAA22]] = !{[[META15]], [[META9]], i64 124}
// CHECK: [[ANYPTR_TBAA23]] = !{[[META15]], [[META9]], i64 200}
// CHECK: [[INT_TBAA24]] = !{[[META15]], [[META4]], i64 192}
// CHECK: [[INT_TBAA25]] = !{[[META15]], [[META4]], i64 196}
//.
