...
// AARCH64-C: define {{.*}} @f(i32 noundef %n, ptr noundef align 8 dead_on_return %list)
// AARCH64-CXX: define {{.*}} @_Z1fiSt9__va_list(i32 noundef %n, ptr noundef align 8 dead_on_return %list)
