...
// CHECK-NEXT:         }
// CHECK-NEXT:       },
// CHECK-NEXT:       "parentDeclContextId": "{{.*}}",
// CHECK-NEXT:       "name": "y",
// CHECK-NEXT:       "tagUsed": "struct",
// CHECK-NEXT:       "completeDefinition": true,
// CHECK-NEXT:       "inner": [
...
// CHECK-NEXT:       "name": "e",
// CHECK-NEXT:       "type": {
// CHECK-NEXT:         "desugaredQualType": "enum TestEnumDeclAnon::(unnamed at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:31:3)",
// CHECK-NEXT:         "qualType": "enum (unnamed enum at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:31:3)"
// CHECK-NEXT:       },
// CHECK-NEXT:       "qualType": {
// CHECK-NEXT:         "id": "{{.*}}",
// CHECK-NEXT:         "kind": "QualType",
...
// CHECK-NEXT:       "name": "testRecordDeclAnon1",
// CHECK-NEXT:       "type": {
// CHECK-NEXT:         "desugaredQualType": "struct TestRecordDeclAnon1::(unnamed at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:46:3)",
// CHECK-NEXT:         "qualType": "struct (unnamed struct at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:46:3)"
// CHECK-NEXT:       },
// CHECK-NEXT:       "qualType": {
// CHECK-NEXT:         "id": "{{.*}}",
// CHECK-NEXT:         "kind": "QualType",
...
// CHECK-NEXT:       "type": {
// CHECK-NEXT:         "qualType": "struct TestRecordDeclAnon2::(anonymous at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:51:3)"
// CHECK-NEXT:       },
// CHECK-NEXT:       "qualType": {
// CHECK-NEXT:         "id": "{{.*}}",
// CHECK-NEXT:         "kind": "QualType",
...
// CHECK-NEXT:       "isImplicit": true,
// CHECK-NEXT:       "type": {
// CHECK-NEXT:         "qualType": "struct TestIndirectFieldDecl::(anonymous at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:63:3)"
// CHECK-NEXT:       },
// CHECK-NEXT:       "qualType": {
// CHECK-NEXT:         "id": "{{.*}}",
// CHECK-NEXT:         "kind": "QualType",
...
// CHECK-NEXT:   "type": {
// CHECK-NEXT:     "qualType": "int (int, enum (unnamed enum at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:69:29))"
// CHECK-NEXT:   },
// CHECK-NEXT:   "inner": [
// CHECK-NEXT:     {
// CHECK-NEXT:       "id": "{{.*}}",
...
// CHECK-NEXT:       "name": "y",
// CHECK-NEXT:       "type": {
// CHECK-NEXT:         "desugaredQualType": "enum (unnamed at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:69:29)",
// CHECK-NEXT:         "qualType": "enum (unnamed enum at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:69:29)"
// CHECK-NEXT:       },
// CHECK-NEXT:       "typeDetails": [
// CHECK-NEXT:         {
// CHECK-NEXT:           "id": "{{.*}}",
...
// CHECK-NEXT:               "type": {
// CHECK-NEXT:                 "qualType": "enum (unnamed at C:\\Precision\\sei\\llvm-patch\\llvm-project\\clang\\test\\AST\\ast-dump-decl-json.c:69:29)"
// CHECK-NEXT:               },
// CHECK-NEXT:               "decl": {
// CHECK-NEXT:                 "id": "{{.*}}",
// CHECK-NEXT:                 "kind": "EnumDecl",
