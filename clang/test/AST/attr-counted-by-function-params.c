...
//==============================================================================
// Both declaration orders produce the same CountAttributedType
//==============================================================================

// Still late-parsed here: that is decided by the attribute and the language
// option, not by whether the name is already in scope.
...
// Parsed only once the whole prototype is known.
...
//==============================================================================
// The count resolves to the parameter, not the global of the same name
//==============================================================================
