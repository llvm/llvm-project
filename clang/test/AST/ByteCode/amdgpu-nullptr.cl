// RUN: %clang_cc1 -no-enable-noundef-analysis %s -cl-std=CL2.0 -triple amdgpu -emit-llvm -o - | FileCheck %s

// RUN: %clang_cc1 -no-enable-noundef-analysis %s -cl-std=CL2.0 -triple amdgpu -emit-llvm -fexperimental-new-constant-interpreter -o - | FileCheck %s
