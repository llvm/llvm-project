...
// CHECK-NEXT: |       | | | | | | | |   `-typeDetails: PredefinedSugarType {{.*}} '__size_t' sugar
// CHECK-NEXT: |       | | | | | | | |     `-typeDetails: BuiltinType {{.*}} 'unsigned long'
// CHECK-NEXT: |       | | | | | | | |-ImplicitParamDecl {{.*}} implicit __context 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:4:1) *const restrict'
// CHECK-NEXT: |       | | | | | | | | |-qualTypeDetail: QualType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:4:1) *const restrict' const __restrict
// CHECK-NEXT: |       | | | | | | | | | `-typeDetails: PointerType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:4:1) *'
// CHECK-NEXT: |       | | | | | | | | |   `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:4:1)'
// CHECK-NEXT: |       | | | | | | | | |     `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | | `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:4:1)'
// CHECK-NEXT: |       | | | | | | | |   `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | `-VarDecl {{.*}} used i 'int' cinit
...
// CHECK-NEXT: |       | | | | | | | |   `-typeDetails: PredefinedSugarType {{.*}} '__size_t' sugar
// CHECK-NEXT: |       | | | | | | | |     `-typeDetails: BuiltinType {{.*}} 'unsigned long'
// CHECK-NEXT: |       | | | | | | | |-ImplicitParamDecl {{.*}} implicit __context 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:10:1) *const restrict'
// CHECK-NEXT: |       | | | | | | | | |-qualTypeDetail: QualType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:10:1) *const restrict' const __restrict
// CHECK-NEXT: |       | | | | | | | | | `-typeDetails: PointerType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:10:1) *'
// CHECK-NEXT: |       | | | | | | | | |   `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:10:1)'
// CHECK-NEXT: |       | | | | | | | | |     `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | | `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:10:1)'
// CHECK-NEXT: |       | | | | | | | |   `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | |-VarDecl {{.*}} used i 'int' cinit
...
// CHECK-NEXT: |       | | | | | | | |   `-typeDetails: PredefinedSugarType {{.*}} '__size_t' sugar
// CHECK-NEXT: |       | | | | | | | |     `-typeDetails: BuiltinType {{.*}} 'unsigned long'
// CHECK-NEXT: |       | | | | | | | |-ImplicitParamDecl {{.*}} implicit __context 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:17:1) *const restrict'
// CHECK-NEXT: |       | | | | | | | | |-qualTypeDetail: QualType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:17:1) *const restrict' const __restrict
// CHECK-NEXT: |       | | | | | | | | | `-typeDetails: PointerType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:17:1) *'
// CHECK-NEXT: |       | | | | | | | | |   `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:17:1)'
// CHECK-NEXT: |       | | | | | | | | |     `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | | `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:17:1)'
// CHECK-NEXT: |       | | | | | | | |   `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | |-VarDecl {{.*}} used i 'int' cinit
...
// CHECK-NEXT: |       | | | | | | | |   `-typeDetails: PredefinedSugarType {{.*}} '__size_t' sugar
// CHECK-NEXT: |       | | | | | | | |     `-typeDetails: BuiltinType {{.*}} 'unsigned long'
// CHECK-NEXT: |       | | | | | | | |-ImplicitParamDecl {{.*}} implicit __context 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:24:1) *const restrict'
// CHECK-NEXT: |       | | | | | | | | |-qualTypeDetail: QualType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:24:1) *const restrict' const __restrict
// CHECK-NEXT: |       | | | | | | | | | `-typeDetails: PointerType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:24:1) *'
// CHECK-NEXT: |       | | | | | | | | |   `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:24:1)'
// CHECK-NEXT: |       | | | | | | | | |     `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | | `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:24:1)'
// CHECK-NEXT: |       | | | | | | | |   `-Record {{.*}} 
// CHECK-NEXT: |       | | | | | | | |-VarDecl {{.*}} used i 'int' cinit
...
// CHECK-NEXT:         | | | | | | | |   `-typeDetails: PredefinedSugarType {{.*}} '__size_t' sugar
// CHECK-NEXT:         | | | | | | | |     `-typeDetails: BuiltinType {{.*}} 'unsigned long'
// CHECK-NEXT:         | | | | | | | |-ImplicitParamDecl {{.*}} implicit __context 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:31:1) *const restrict'
// CHECK-NEXT:         | | | | | | | | |-qualTypeDetail: QualType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:31:1) *const restrict' const __restrict
// CHECK-NEXT:         | | | | | | | | | `-typeDetails: PointerType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:31:1) *'
// CHECK-NEXT:         | | | | | | | | |   `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:31:1)'
// CHECK-NEXT:         | | | | | | | | |     `-Record {{.*}} 
// CHECK-NEXT:         | | | | | | | | `-typeDetails: RecordType {{.*}} 'struct (unnamed at C:\Precision\sei\llvm-patch\llvm-project\clang\test\AST\ast-dump-openmp-target-teams-distribute-parallel-for-simd.c:31:1)'
// CHECK-NEXT:         | | | | | | | |   `-Record {{.*}} 
// CHECK-NEXT:         | | | | | | | |-VarDecl {{.*}} used i 'int' cinit
