...
// SAME-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef align 8 dead_on_return [[PTR:%.*]]) #[[ATTR0]] {
// SAME-NEXT:  [[ENTRY:.*]]:
// SAME-NEXT:    [[COUNT_PARAM_ADDR:%.*]] = alloca i32, align 4
...
// LEGACY-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef align 8 dead_on_return [[PTR:%.*]]) #[[ATTR0]] {
// LEGACY-NEXT:  [[ENTRY:.*:]]
// LEGACY-NEXT:    [[COUNT_PARAM_ADDR:%.*]] = alloca i32, align 4
...
// NEW-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef align 8 dead_on_return [[PTR:%.*]]) #[[ATTR0]] {
// NEW-NEXT:  [[ENTRY:.*]]:
// NEW-NEXT:    [[COUNT_PARAM_ADDR:%.*]] = alloca i32, align 4
