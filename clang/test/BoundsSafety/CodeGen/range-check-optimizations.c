...
// CHECK-NEXT:    br i1 [[OR_COND3]], label %[[CONT2]], label %[[TRAP:.*]], !prof [[PROF10:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND4]], label %[[CONT3]], label %[[TRAP:.*]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT3]]:
...
// CHECK-NEXT:    br i1 [[OR_COND4]], label %[[CONT2]], label %[[TRAP:.*]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND5]], label %[[CONT3]], label %[[TRAP:.*]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT3]]:
...
// CHECK-NEXT:    br i1 [[OR_COND21]], label %[[CONT17]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT17]]:
...
// CHECK-NEXT:    br i1 [[OR_COND19]], label %[[CONT2:.*]], label %[[TRAP:.*]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND55]], label %[[CONT2:.*]], label %[[TRAP:.*]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND57]], label %[[CONT15:.*]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT15]]:
// CHECK-NEXT:    store i32 0, ptr [[ARRAYIDX8]], align 4, {{!tbaa ![0-9]+}}
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ugt ptr [[ARRAYIDX8]], [[ADD_PTR]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP]], label %[[CONT54:.*]], !prof [[PROF25:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT54]]:
...
// CHECK-NEXT:    [[TMP6:%.*]] = icmp ule ptr [[ARRAYIDX8]], [[TMP4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND56:%.*]] = and i1 [[TMP6]], [[TMP5]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND56]], label %[[CONT15:.*]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT15]]:
// CHECK-NEXT:    store i32 0, ptr [[ARRAYIDX8]], align 4, {{!tbaa ![0-9]+}}
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ugt ptr [[ARRAYIDX8]], [[ADD_PTR]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP]], label %[[CONT41:.*]], !prof [[PROF25]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT41]]:
...
// CHECK-NEXT:    br i1 [[OR_COND63]], label %[[CONT54:.*]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT54]]:
...
// CHECK-NEXT:    br i1 [[CMP27_NOT]], label %[[TRAP:.*]], label %[[CONT61:.*]], !prof [[PROF29:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT61]]:
...
// CHECK-NEXT:    br i1 [[OR_COND93]], label %[[CONT74:.*]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT74]]:
...
// CHECK-NEXT:    br i1 [[OR_COND96]], label %[[CONT89:.*]], label %[[TRAP]], !prof [[PROF10]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT89]]:
...
// CHECK-NEXT:    [[OR_COND:%.*]] = and i1 [[TMP0]], [[TMP1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT1]], label %[[TRAP:.*]], !prof [[PROF35:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT1]]:
...
// CHECK-SAME: i32 noundef [[IDX:%.*]], ptr noundef [[TABLE:%.*]], i32 noundef [[TABLE_SIZE:%.*]], i32 noundef [[VALUE:%.*]]) local_unnamed_addr #[[ATTR2]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
...
//.
// CHECK: [[PROF10]] = !{!"branch_weights", i32 -12288, i32 12286}
// CHECK: [[PROF25]] = !{!"branch_weights", i32 12286, i32 -12288}
// CHECK: [[PROF29]] = !{!"branch_weights", i32 1, i32 1048575}
// CHECK: [[PROF35]] = !{!"branch_weights", i32 -8192, i32 8191}
//.
