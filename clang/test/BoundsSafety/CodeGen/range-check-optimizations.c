// NOTE: Assertions have been autogenerated by utils/update_cc_test_checks.py UTC_ARGS: --replace-value-regex "!annotation ![0-9]+" "!tbaa ![0-9]+" "!llvm.loop ![0-9]+" "#[0-9]+" "!prof ![0-9]+" --prefix-filecheck-ir-name TMP_ --version 6
...
// CHECK-NEXT:    br i1 [[OR_COND3]], label %[[CONT2]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND4]], label %[[CONT2]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND5]], label %[[CONT3]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT3]]:
...
// CHECK-NEXT:    br i1 [[OR_COND21]], label %[[CONT17]], label %[[TRAP]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[CONT17]]:
...
// CHECK-NEXT:    br i1 [[OR_COND19]], label %[[CONT2:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND55]], label %[[CONT2:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[CMP27_NOT]], label %[[TRAP:.*]], label %[[CONT61:.*]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT61]]:
...
// CHECK-NEXT:    br i1 [[OR_COND93]], label %[[CONT74:.*]], label %[[TRAP]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[CONT74]]:
...
// CHECK-NEXT:    br i1 [[OR_COND96]], label %[[CONT89:.*]], label %[[TRAP]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[CONT89]]:
...
// CHECK-NEXT:    br i1 [[DOTNOT31]], label %[[TRAP]], label %[[RETURN]], {{!prof ![0-9]+}}, {{!annotation ![0-9]+}}
// CHECK:       [[RETURN]]:
