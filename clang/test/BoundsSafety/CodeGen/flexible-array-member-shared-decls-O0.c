...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[CONT80:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL]]:
// CHECK-NEXT:    [[TMP19:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR70]], i64 1, !annotation [[META12:![0-9]+]]
// CHECK-NEXT:    [[TMP20:%.*]] = icmp ule ptr [[TMP19]], [[WIDE_PTR_UB72]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT76:.*]], label %[[TRAP75:.*]], !prof [[PROF3]], !annotation [[META12]]
// CHECK:       [[TRAP75]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META12]]
// CHECK-NEXT:    unreachable, !annotation [[META12]]
// CHECK:       [[CONT76]]:
// CHECK-NEXT:    [[TMP21:%.*]] = icmp ule ptr [[WIDE_PTR_PTR70]], [[TMP19]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[TMP21]], label %[[CONT78:.*]], label %[[TRAP77:.*]], !prof [[PROF3]], !annotation [[META12]]
// CHECK:       [[TRAP77]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META12]]
// CHECK-NEXT:    unreachable, !annotation [[META12]]
// CHECK:       [[CONT78]]:
// CHECK-NEXT:    [[TMP22:%.*]] = icmp uge ptr [[WIDE_PTR_PTR70]], [[WIDE_PTR_LB74]], !annotation [[META7]]
// CHECK-NEXT:    br i1 [[TMP22]], label %[[CONT80]], label %[[TRAP79:.*]], !prof [[PROF3]], !annotation [[META7]]
// CHECK:       [[TRAP79]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META7]]
// CHECK-NEXT:    unreachable, !annotation [[META7]]
// CHECK:       [[CONT80]]:
...
// CHECK-NEXT:    [[TMP26:%.*]] = icmp ne ptr [[TMP25]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP26]], label %[[BOUNDSCHECK_NOTNULL91:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META4]]
...
// CHECK-NEXT:    [[WIDE_PTR_PTR_ADDR98:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 0
// CHECK-NEXT:    [[WIDE_PTR_PTR99:%.*]] = load ptr, ptr [[WIDE_PTR_PTR_ADDR98]], align 8
// CHECK-NEXT:    [[WIDE_PTR_UB_ADDR100:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 1
// CHECK-NEXT:    [[WIDE_PTR_UB101:%.*]] = load ptr, ptr [[WIDE_PTR_UB_ADDR100]], align 8
// CHECK-NEXT:    [[WIDE_PTR_LB_ADDR102:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable.0", ptr [[AGG_TEMP90]], i32 0, i32 2
// CHECK-NEXT:    [[WIDE_PTR_LB103:%.*]] = load ptr, ptr [[WIDE_PTR_LB_ADDR102]], align 8
// CHECK-NEXT:    [[TMP34:%.*]] = icmp ne ptr [[WIDE_PTR_PTR99]], null, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP34]], label %[[BOUNDSCHECK_NOTNULL104:.*]], label %[[CONT110:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL104]]:
// CHECK-NEXT:    [[TMP35:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR99]], i64 1, !annotation [[META12]]
// CHECK-NEXT:    [[TMP36:%.*]] = icmp ule ptr [[TMP35]], [[WIDE_PTR_UB101]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[TMP36]], label %[[CONT106:.*]], label %[[TRAP105:.*]], !prof [[PROF3]], !annotation [[META12]]
// CHECK:       [[TRAP105]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META12]]
// CHECK-NEXT:    unreachable, !annotation [[META12]]
// CHECK:       [[CONT106]]:
// CHECK-NEXT:    [[TMP37:%.*]] = icmp ule ptr [[WIDE_PTR_PTR99]], [[TMP35]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[TMP37]], label %[[CONT108:.*]], label %[[TRAP107:.*]], !prof [[PROF3]], !annotation [[META12]]
// CHECK:       [[TRAP107]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META12]]
// CHECK-NEXT:    unreachable, !annotation [[META12]]
// CHECK:       [[CONT108]]:
// CHECK-NEXT:    [[TMP38:%.*]] = icmp uge ptr [[WIDE_PTR_PTR99]], [[WIDE_PTR_LB103]], !annotation [[META7]]
// CHECK-NEXT:    br i1 [[TMP38]], label %[[CONT110]], label %[[TRAP109:.*]], !prof [[PROF3]], !annotation [[META7]]
// CHECK:       [[TRAP109]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META7]]
// CHECK-NEXT:    unreachable, !annotation [[META7]]
// CHECK:       [[CONT110]]:
...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[CONT80:.*]], !annotation [[META4]]
// CHECK:       [[BOUNDSCHECK_NOTNULL]]:
// CHECK-NEXT:    [[TMP19:%.*]] = getelementptr [[STRUCT_OUTER]], ptr [[WIDE_PTR_PTR70]], i64 1, !annotation [[META12]]
// CHECK-NEXT:    [[TMP20:%.*]] = icmp ule ptr [[TMP19]], [[WIDE_PTR_UB72]], !annotation [[META12]]
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT76:.*]], label %[[TRAP75:.*]], !prof [[PROF3]], !annotation [[META12]]
// CHECK:       [[TRAP75]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR5]], !annotation [[META12]]
...
// CHECK: [[META12]] = !{!"bounds-safety-check-ptr-le-upper-bound"}
//.
