...
// CHECK-NEXT:    br i1 [[DOTNOT47]], label [[BOUNDSCHECK_NULL37:%.*]], label [[BOUNDSCHECK_NOTNULL33:%.*]], !annotation [[META11]]
...
// CHECK-NEXT:    br i1 [[OR_COND43:%.*]], label [[BOUNDSCHECK_NULL37]], label [[TRAP:%.*]], !prof [[PROF13:![0-9]+]], !annotation [[META12]]
