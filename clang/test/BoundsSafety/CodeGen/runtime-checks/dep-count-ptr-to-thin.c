...
// O0-NEXT:    br i1 [[TMP13]], label %[[CONT22:.*]], label %[[TRAP21:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP21]]:
...
// O0-NEXT:    br i1 [[TMP14]], label %[[CONT24:.*]], label %[[TRAP23:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP23]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT24]]:
// O0-NEXT:    [[TMP15:%.*]] = icmp uge ptr [[WIDE_PTR_PTR16]], [[WIDE_PTR_LB20]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP15]], label %[[CONT26:.*]], label %[[TRAP25:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP25]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT26]]:
