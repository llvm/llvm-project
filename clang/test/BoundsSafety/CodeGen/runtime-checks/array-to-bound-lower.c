...
// CHECK-O0-NEXT:    br i1 [[TMP19]], label [[CONT14:%.*]], label [[TRAP13:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap13:
...
// CHECK-O0-NEXT:    br i1 [[TMP20]], label [[CONT16:%.*]], label [[TRAP15:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap15:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont16:
// CHECK-O0-NEXT:    [[TMP21:%.*]] = icmp uge ptr [[WIDE_PTR_PTR8]], [[WIDE_PTR_LB12]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP21]], label [[CONT18:%.*]], label [[TRAP17:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap17:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont18:
