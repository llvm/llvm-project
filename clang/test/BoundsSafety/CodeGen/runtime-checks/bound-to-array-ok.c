...
// CHECK-O0-NEXT:    br i1 [[TMP3]], label [[CONT:%.*]], label [[TRAP:%.*]], !prof [[PROF3:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap:
...
// CHECK-O0-NEXT:    br i1 [[TMP10]], label [[CONT14:%.*]], label [[TRAP13:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap13:
...
// CHECK-O0-NEXT:    br i1 [[TMP11]], label [[CONT16:%.*]], label [[TRAP15:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap15:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont16:
// CHECK-O0-NEXT:    [[TMP12:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB12]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP12]], label [[CONT18:%.*]], label [[TRAP17:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK-O0:       trap17:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       cont18:
