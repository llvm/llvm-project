...
// CHECK-O0-NEXT:    br i1 [[TMP3]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
...
// CHECK-O0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr i32, ptr [[WIDE_PTR_PTR8]], i64 9
...
// CHECK-O0-NEXT:    [[TMP9:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    [[TMP10:%.*]] = icmp ule ptr [[TMP9]], [[WIDE_PTR_UB10]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP10]], label %[[CONT14:.*]], label %[[TRAP13:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP13]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT14]]:
// CHECK-O0-NEXT:    [[TMP11:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP9]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP11]], label %[[CONT16:.*]], label %[[TRAP15:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP15]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT16]]:
// CHECK-O0-NEXT:    [[TMP12:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB12]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP12]], label %[[CONT18:.*]], label %[[TRAP17:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP17]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT18]]:
// CHECK-O0-NEXT:    [[TMP13:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
// CHECK-O0-NEXT:    ret i32 [[TMP13]]
//
