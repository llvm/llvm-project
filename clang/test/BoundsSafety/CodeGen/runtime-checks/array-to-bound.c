...
// O2-NEXT:    br i1 [[OR_COND13]], label [[CONT12:%.*]], label [[TRAP:%.*]], !prof [[PROF4:![0-9]+]], {{!annotation ![0-9]+}}
// O2:       trap:
...
// O0-NEXT:    br i1 [[TMP10]], label [[CONT:%.*]], label [[TRAP:%.*]], !prof [[PROF3:![0-9]+]], {{!annotation ![0-9]+}}
// O0:       trap:
...
// O0-NEXT:    br i1 [[TMP11]], label [[CONT12:%.*]], label [[TRAP11:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// O0:       trap11:
...
// O0-NEXT:    br i1 [[TMP12]], label [[CONT14:%.*]], label [[TRAP13:%.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// O0:       trap13:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       cont14:
