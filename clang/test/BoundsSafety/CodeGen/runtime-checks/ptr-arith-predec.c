...
// O0-NEXT:    br i1 [[TMP14]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// O0:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP15]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP1]]:
...
// O0-NEXT:    br i1 [[TMP16]], label %[[CONT4:.*]], label %[[TRAP3:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP3]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT4]]:
