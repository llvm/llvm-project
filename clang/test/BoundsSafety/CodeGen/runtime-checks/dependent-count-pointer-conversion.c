...
// O0-NEXT:    br i1 [[TMP4]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// O0:       [[TRAP]]:
...
// O0-NEXT:    br i1 [[TMP12]], label %[[CONT22:.*]], label %[[TRAP21:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP21]]:
...
// O0-NEXT:    br i1 [[TMP13]], label %[[CONT24:.*]], label %[[TRAP23:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP23]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT24]]:
// O0-NEXT:    [[TMP14:%.*]] = icmp uge ptr [[WIDE_PTR_PTR16]], [[WIDE_PTR_LB20]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP14]], label %[[CONT26:.*]], label %[[TRAP25:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP25]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT26]]:
...
// O0-NEXT:    br i1 [[TMP21]], label %[[CONT37:.*]], label %[[TRAP36:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP36]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT37]]:
// O0-NEXT:    [[TMP22:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP20]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP22]], label %[[CONT39:.*]], label %[[TRAP38:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP38]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT39]]:
// O0-NEXT:    [[TMP23:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB35]], {{!annotation ![0-9]+}}
// O0-NEXT:    br i1 [[TMP23]], label %[[CONT41:.*]], label %[[TRAP40:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// O0:       [[TRAP40]]:
// O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// O0:       [[CONT41]]:
