...
// CHECK-NEXT:    br i1 [[TMP20]], label %[[BOUNDSCHECK_NOTNULL42:.*]], label %[[BOUNDSCHECK_NULL49:.*]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[TMP22]], label %[[CONT44:.*]], label %[[TRAP43:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP43]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT44]]:
// CHECK-NEXT:    [[TMP23:%.*]] = icmp ule ptr [[WIDE_PTR_PTR37]], [[TMP21]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP23]], label %[[CONT46:.*]], label %[[TRAP45:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP45]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT46]]:
// CHECK-NEXT:    [[TMP24:%.*]] = icmp uge ptr [[WIDE_PTR_PTR37]], [[WIDE_PTR_LB41]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP24]], label %[[CONT48:.*]], label %[[TRAP47:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP47]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT48]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL49]]
...
// CHECK-NEXT:    br i1 [[TMP16]], label %[[BOUNDSCHECK_NOTNULL30:.*]], label %[[BOUNDSCHECK_NULL37:.*]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[CONT32:.*]], label %[[TRAP31:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP31]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT32]]:
// CHECK-NEXT:    [[TMP19:%.*]] = icmp ule ptr [[WIDE_PTR_PTR25]], [[TMP17]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP19]], label %[[CONT34:.*]], label %[[TRAP33:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP33]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT34]]:
// CHECK-NEXT:    [[TMP20:%.*]] = icmp uge ptr [[WIDE_PTR_PTR25]], [[WIDE_PTR_LB29]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP20]], label %[[CONT36:.*]], label %[[TRAP35:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP35]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT36]]:
// CHECK-NEXT:    br label %[[BOUNDSCHECK_NULL37]]
// CHECK:       [[BOUNDSCHECK_NULL37]]:
// CHECK-NEXT:    store ptr [[WIDE_PTR_PTR25]], ptr [[B]], align 8
// CHECK-NEXT:    [[TMP21:%.*]] = load ptr, ptr [[B]], align 8
// CHECK-NEXT:    [[COUNT38:%.*]] = getelementptr inbounds nuw [[STRUCT_FLEX_T]], ptr [[TMP21]], i32 0, i32 0
// CHECK-NEXT:    store i32 10, ptr [[COUNT38]], align 4
// CHECK-NEXT:    ret void
//
