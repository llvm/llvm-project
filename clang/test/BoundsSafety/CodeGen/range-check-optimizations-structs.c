...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[CMP_NOT25_NOT:%.*]] = icmp eq i32 [[SIZE]], 0
// CHECK-NEXT:    br i1 [[CMP_NOT25_NOT]], label %[[CLEANUP14:.*]], label %[[FOR_BODY_LR_PH:.*]]
...
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[CMP_NOT39_NOT:%.*]] = icmp eq i32 [[SIZE]], 0
// CHECK-NEXT:    br i1 [[CMP_NOT39_NOT]], label %[[CLEANUP25:.*]], label %[[FOR_BODY_LR_PH:.*]]
// CHECK:       [[FOR_BODY_LR_PH]]:
// CHECK-NEXT:    [[IDX_EXT:%.*]] = zext i32 [[SIZE]] to i64
...
// CHECK:       [[BOUNDSCHECK_NOTNULL]]:
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp ugt ptr [[BOUND_PTR_ARITH]], [[TMP0]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP]], label %[[CLEANUP25]], {{!annotation ![0-9]+}}
// CHECK:       [[FOR_INC]]:
// CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 1
// CHECK-NEXT:    [[EXITCOND_NOT:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT]], [[IDX_EXT]]
