...
// CHECK-NEXT:    br i1 [[OR_COND8]], label %[[CONT7:.*]], label %[[TRAP:.*]], !prof [[PROF9:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND8_I]], label %[[FOO_EXIT:.*]], label %[[TRAP_I:.*]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP_I]]:
...
//.
// CHECK: [[PROF9]] = !{!"branch_weights", i32 -12288, i32 12286}
//.
