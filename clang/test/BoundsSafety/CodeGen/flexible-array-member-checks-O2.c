...
// CHECK-NEXT:    br i1 [[DOTB]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META6:![0-9]+]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[CMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP:.*]], label %[[CONT8:.*]], {{!prof ![0-9]+}}, !annotation [[META10:![0-9]+]]
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP:.*]], label %[[CONT8:.*]], {{!prof ![0-9]+}}, !annotation [[META10]]
// CHECK:       [[TRAP]]:
