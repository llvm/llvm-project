...
// UBSAN-NEXT:    br i1 [[TMP6]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF9:![0-9]+]], {{!nosanitize ![0-9]+}}
// UBSAN:       [[TRAP]]:
...
// UBSAN-NEXT:    br i1 [[OR_COND55]], label %[[TRAP45:.*]], label %[[CONT46:.*]], !prof [[PROF15:![0-9]+]], {{!annotation ![0-9]+}}
// UBSAN:       [[TRAP45]]:
...
// NOUBSAN-NEXT:    br i1 [[OR_COND52]], label %[[TRAP:.*]], label %[[CONT:.*]], !prof [[PROF10:![0-9]+]], {{!annotation ![0-9]+}}
// NOUBSAN:       [[TRAP]]:
...
//.
// UBSAN: [[PROF9]] = !{!"branch_weights", i32 1048575, i32 1}
// UBSAN: [[PROF15]] = !{!"branch_weights", i32 1048577, i32 1048575}
//.
// NOUBSAN: [[PROF10]] = !{!"branch_weights", i32 1048577, i32 1048575}
//.
