...
// IR: br i1 %{{[0-9]+}}, label %[[FOO_LABEL_CONT:[a-z0-9]+]], label %[[FOO_LABEL_TRAP:[a-z0-9]+]], !dbg ![[LOC_10_16]], !annotation ![[ANNOT_LT_UB]]
// ...
// IR: [[FOO_LABEL_TRAP]]:
...
// IR:   br i1 %{{[0-9]+}}, label %{{[a-z0-9]+}}, label %[[FOO_LABEL_TRAP2:[a-z0-9]+]], !dbg ![[LOC_10_16]], !annotation ![[ANNOT_GE_LB]]
// ...
// IR: [[FOO_LABEL_TRAP2]]:
