...
// CHECK-NEXT:    br i1 [[TMP3]], label [[CONT:%.*]], label [[TRAP:%.*]], !prof [[PROF4:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       trap:
...
// CHECK-NEXT:    br i1 [[TMP4]], label [[CONT2:%.*]], label [[TRAP1:%.*]], !prof [[PROF4]], {{!annotation ![0-9]+}}
// CHECK:       trap1:
...
// CHECK-NEXT:    br i1 [[TMP5]], label [[CONT4:%.*]], label [[TRAP3:%.*]], !prof [[PROF4]], {{!annotation ![0-9]+}}
// CHECK:       trap3:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont4:
