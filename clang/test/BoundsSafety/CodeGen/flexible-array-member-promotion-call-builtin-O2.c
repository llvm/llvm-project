...
// CHECK-LABEL: define dso_local noundef ptr @set(
...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[TRAP:.*]], label %[[CONT:.*]], !prof [[PROF9:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND91]], label %[[TRAP]], label %[[BOUNDSCHECK_NULL88:.*]], !prof [[PROF12:![0-9]+]], {{!annotation ![0-9]+}}
...
// CHECK-LABEL: define dso_local noundef ptr @cpy(
...
// CHECK-NEXT:    [[OR_COND191:%.*]] = select i1 [[OR_COND]], i1 true, i1 [[CMP101_NOT]], !prof [[PROF13:![0-9]+]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[OR_COND192:%.*]] = select i1 [[OR_COND191]], i1 true, i1 [[CMP156_NOT]], !prof [[PROF14:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND192]], label %[[TRAP:.*]], label %[[CONT159:.*]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND193]], label %[[TRAP]], label %[[BOUNDSCHECK_NULL186:.*]], !prof [[PROF12]], {{!annotation ![0-9]+}}
...
// CHECK-LABEL: define dso_local ptr @pcpy(
...
// CHECK-NEXT:    [[OR_COND:%.*]] = or i1 [[CMP_NOT]], [[CMP83_NOT]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[CMP101_NOT:%.*]] = icmp ugt ptr [[DEST]], [[AGG_TEMP1_SROA_3_0]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND176:%.*]] = select i1 [[OR_COND]], i1 true, i1 [[CMP101_NOT]], !prof [[PROF13]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST153:%.*]] = ptrtoint ptr [[AGG_TEMP1_SROA_3_0]] to i64, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST154:%.*]] = ptrtoint ptr [[DEST]] to i64, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_SUB155:%.*]] = sub i64 [[SUB_PTR_LHS_CAST153]], [[SUB_PTR_RHS_CAST154]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[CMP156_NOT:%.*]] = icmp ult i64 [[SUB_PTR_SUB155]], [[CONV]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND177:%.*]] = select i1 [[OR_COND176]], i1 true, i1 [[CMP156_NOT]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND177]], label %[[TRAP:.*]], label %[[CONT159:.*]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT159]]:
...
// CHECK-LABEL: define dso_local noundef ptr @move(
// CHECK-SAME: ptr noundef returned [[DEST:%.*]], ptr noundef [[SRC:%.*]], i32 noundef [[SIZE:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[DOTNOT:%.*]] = icmp eq ptr [[DEST]], null, {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[BOUNDSCHECK_CONT:.*]], label %[[BOUNDSCHECK_NOTNULL:.*]], {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    [[OR_COND:%.*]] = or i1 [[CMP_NOT]], [[CMP83_NOT]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[CMP101_NOT:%.*]] = icmp ugt ptr [[DEST]], [[AGG_TEMP1_SROA_3_0]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND191:%.*]] = select i1 [[OR_COND]], i1 true, i1 [[CMP101_NOT]], !prof [[PROF13]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST153:%.*]] = ptrtoint ptr [[AGG_TEMP1_SROA_3_0]] to i64, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST154:%.*]] = ptrtoint ptr [[DEST]] to i64, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[SUB_PTR_SUB155:%.*]] = sub i64 [[SUB_PTR_LHS_CAST153]], [[SUB_PTR_RHS_CAST154]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[CMP156_NOT:%.*]] = icmp ult i64 [[SUB_PTR_SUB155]], [[CONV]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND192:%.*]] = select i1 [[OR_COND191]], i1 true, i1 [[CMP156_NOT]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND192]], label %[[TRAP:.*]], label %[[CONT159:.*]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
...
//.
// CHECK: [[PROF9]] = !{!"branch_weights", i32 1048577, i32 1048575}
// CHECK: [[PROF12]] = !{!"branch_weights", i32 4095, i32 -4097}
// CHECK: [[PROF13]] = !{!"branch_weights", i32 3145729, i32 1048575}
// CHECK: [[PROF14]] = !{!"branch_weights", i32 -1073739777, i32 1073739776}
//.
