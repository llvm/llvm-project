...
// CHECK-NEXT:    br i1 [[OR_COND90]], label [[TRAP]], label [[CONT87:%.*]], !prof [[PROF13:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       cont87:
...
// CHECK-NEXT:    br i1 [[OR_COND191]], label [[TRAP:%.*]], label [[CONT159:%.*]], !prof [[PROF14:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       trap:
...
// CHECK-NEXT:    br i1 [[OR_COND192]], label [[TRAP]], label [[CONT185:%.*]], !prof [[PROF13]], {{!annotation ![0-9]+}}
// CHECK:       cont185:
...
// CHECK-NEXT:    [[CMP156_NOT:%.*]] = icmp ult i64 [[SUB_PTR_SUB155]], [[CONV]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND191:%.*]] = select i1 [[OR_COND190]], i1 true, i1 [[CMP156_NOT]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND191]], label [[TRAP:%.*]], label [[CONT159:%.*]], !prof [[PROF14]], {{!annotation ![0-9]+}}
// CHECK:       trap:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       cont159:
