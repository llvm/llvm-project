...
// CHECK-NEXT:    br i1 true, label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF1:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4:[0-9]+]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT]]:
// CHECK-NEXT:    br i1 true, label %[[CONT6:.*]], label %[[TRAP5:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP5]]:
...
// CHECK-NEXT:    br i1 [[TMP25]], label %[[CONT55:.*]], label %[[TRAP54:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP54]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT55]]:
// CHECK-NEXT:    br i1 true, label %[[CONT57:.*]], label %[[TRAP56:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP56]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT57]]:
...
// CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP_TMP1]], i32 0, i32 2
// CHECK-NEXT:    store ptr [[TMP13]], ptr [[TMP14]], align 8
// CHECK-NEXT:    br i1 true, label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT]]:
...
// CHECK-NEXT:    br i1 [[TMP34]], label %[[CONT57:.*]], label %[[TRAP56:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP56]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT57]]:
// CHECK-NEXT:    br i1 true, label %[[CONT59:.*]], label %[[TRAP58:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP58]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT59]]:
