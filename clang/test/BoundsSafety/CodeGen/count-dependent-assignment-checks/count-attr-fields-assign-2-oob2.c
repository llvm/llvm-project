...
// CHECK-O0-NEXT:    br i1 true, label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF1:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4:[0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT]]:
// CHECK-O0-NEXT:    br i1 true, label %[[CONT5:.*]], label %[[TRAP4:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP4]]:
...
// CHECK-O0-NEXT:    br i1 true, label %[[CONT21:.*]], label %[[TRAP20:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP20]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT21]]:
// CHECK-O0-NEXT:    br i1 true, label %[[CONT23:.*]], label %[[TRAP22:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP22]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT23]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP32]], label %[[CONT52:.*]], label %[[TRAP51:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP51]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT52]]:
// CHECK-O0-NEXT:    [[TMP33:%.*]] = icmp ule ptr [[ARRAYIDX]], [[TMP31]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP33]], label %[[CONT54:.*]], label %[[TRAP53:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP53]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT54]]:
// CHECK-O0-NEXT:    [[TMP34:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB50]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP34]], label %[[CONT56:.*]], label %[[TRAP55:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP55]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT56]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP42]], label %[[CONT70:.*]], label %[[TRAP69:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP69]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT70]]:
// CHECK-O0-NEXT:    [[TMP43:%.*]] = icmp ule ptr [[ARRAYIDX64]], [[TMP41]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP43]], label %[[CONT72:.*]], label %[[TRAP71:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP71]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT72]]:
// CHECK-O0-NEXT:    [[TMP44:%.*]] = icmp uge ptr [[ARRAYIDX64]], [[WIDE_PTR_LB68]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP44]], label %[[CONT74:.*]], label %[[TRAP73:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP73]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT74]]:
...
// CHECK-O0-NEXT:    br i1 [[TMP52]], label %[[CONT88:.*]], label %[[TRAP87:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP87]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT88]]:
// CHECK-O0-NEXT:    [[TMP53:%.*]] = icmp ule ptr [[ARRAYIDX82]], [[TMP51]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP53]], label %[[CONT90:.*]], label %[[TRAP89:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP89]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT90]]:
// CHECK-O0-NEXT:    [[TMP54:%.*]] = icmp uge ptr [[ARRAYIDX82]], [[WIDE_PTR_LB86]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP54]], label %[[CONT92:.*]], label %[[TRAP91:.*]], !prof [[PROF1]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP91]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT92]]:
...
//.
// CHECK-O0: [[PROF1]] = !{!"branch_weights", i32 1048575, i32 1}
