...
// CHECK-NEXT:    [[TMP14:%.*]] = alloca %"__bounds_safety::wide_ptr.bidi_indexable", align 8
...
// CHECK:       [[CONT]]:
// CHECK-NEXT:    br i1 true, label %[[CONT5:.*]], label %[[TRAP4:.*]], !prof [[PROF1]], !annotation [[META2]]
// CHECK:       [[TRAP4]]:
...
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[AGG_TEMP6]], ptr align 8 [[TMP1]], i64 24, i1 false)
...
// CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 0
// CHECK-NEXT:    store ptr [[ARRAYDECAY15]], ptr [[TMP7]], align 8
// CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 1
// CHECK-NEXT:    store ptr [[UPPER16]], ptr [[TMP8]], align 8
// CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 2
// CHECK-NEXT:    store ptr [[ARRAYDECAY15]], ptr [[TMP9]], align 8
// CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 0
...
// CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 1
...
// CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw %"__bounds_safety::wide_ptr.bidi_indexable", ptr [[TMP14]], i32 0, i32 2
...
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST:%.*]] = ptrtoint ptr [[WIDE_PTR_UB22]] to i64, !annotation [[META2]]
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST:%.*]] = ptrtoint ptr [[WIDE_PTR_PTR32]] to i64, !annotation [[META2]]
...
// CHECK-NEXT:    br i1 [[TMP26]], label %[[CONT41:.*]], label %[[TRAP40:.*]], !prof [[PROF1]], !annotation [[META2]]
// CHECK:       [[TRAP40]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META2]]
// CHECK-NEXT:    unreachable, !annotation [[META2]]
// CHECK:       [[CONT41]]:
...
// CHECK-NEXT:    [[SUB_PTR_LHS_CAST60:%.*]] = ptrtoint ptr [[WIDE_PTR_UB45]] to i64, !annotation [[META2]]
// CHECK-NEXT:    [[SUB_PTR_RHS_CAST61:%.*]] = ptrtoint ptr [[WIDE_PTR_PTR55]] to i64, !annotation [[META2]]
...
// CHECK-NEXT:    br i1 [[TMP30]], label %[[CONT70:.*]], label %[[TRAP69:.*]], !prof [[PROF1]], !annotation [[META2]]
// CHECK:       [[TRAP69]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], !annotation [[META2]]
// CHECK-NEXT:    unreachable, !annotation [[META2]]
// CHECK:       [[CONT70]]:
