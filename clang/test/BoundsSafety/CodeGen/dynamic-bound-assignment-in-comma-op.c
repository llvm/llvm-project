...
// CHECK-NEXT:    br i1 [[TMP23]], label %[[CONT40:.*]], label %[[TRAP39:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP39]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT40]]:
...
// CHECK-NEXT:    br i1 [[TMP32]], label %[[CONT52:.*]], label %[[TRAP51:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP51]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT52]]:
// CHECK-NEXT:    [[TMP33:%.*]] = icmp uge ptr [[WIDE_PTR_PTR46]], [[WIDE_PTR_LB50]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP33]], label %[[CONT54:.*]], label %[[TRAP53:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP53]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT54]]:
...
// CHECK-NEXT:    br i1 [[TMP51]], label %[[CONT107:.*]], label %[[TRAP106:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP106]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT107]]:
