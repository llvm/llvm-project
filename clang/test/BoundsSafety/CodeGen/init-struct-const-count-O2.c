...
// SAME-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef readonly captures(none) dead_on_return [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// SAME-NEXT:  [[ENTRY:.*:]]
...
// SAME-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[LAND_LHS_TRUE:.*]], !annotation [[META6]]
// SAME:       [[LAND_LHS_TRUE]]:
// SAME-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// SAME-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA7:![0-9]+]]
// SAME-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// SAME-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// SAME:       [[LAND_RHS]]:
...
// SAME-NEXT:    [[SUB_PTR_SUB:%.*]] = sub i64 [[SUB_PTR_LHS_CAST]], [[SUB_PTR_RHS_CAST]], !annotation [[META10:![0-9]+]]
...
// SAME-NEXT:    br i1 [[SPEC_SELECT]], label %[[CONT:.*]], label %[[TRAP]], !prof [[PROF12:![0-9]+]], !annotation [[META6]]
// SAME:       [[TRAP]]:
...
// LEGACY-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef readonly captures(none) dead_on_return [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// LEGACY-NEXT:  [[ENTRY:.*:]]
// LEGACY-NEXT:    [[C_SROA_0_0_INSERT_EXT:%.*]] = zext i32 [[COUNT_PARAM]] to i64
...
// NEW-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef readonly captures(none) dead_on_return [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// NEW-NEXT:  [[ENTRY:.*:]]
...
// NEW-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[LAND_LHS_TRUE:.*]], !annotation [[META6]]
// NEW:       [[LAND_LHS_TRUE]]:
// NEW-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// NEW-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA7:![0-9]+]]
// NEW-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// NEW-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// NEW:       [[LAND_RHS]]:
...
// NEW-NEXT:    [[SUB_PTR_SUB:%.*]] = sub i64 [[SUB_PTR_LHS_CAST]], [[SUB_PTR_RHS_CAST]], !annotation [[META10:![0-9]+]]
...
// NEW-NEXT:    br i1 [[SPEC_SELECT]], label %[[CONT:.*]], label %[[TRAP]], !prof [[PROF12:![0-9]+]], !annotation [[META6]]
// NEW:       [[TRAP]]:
...
// SAME-NEXT:  [[ENTRY:.*:]]
// SAME-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[PTR]], null, !annotation [[META13:![0-9]+]]
...
// SAME:       [[LAND_LHS_TRUE]]:
// SAME-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// SAME-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA7]]
// SAME-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// SAME-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// SAME:       [[LAND_RHS]]:
...
// SAME-NEXT:    [[SUB_PTR_SUB:%.*]] = sub i64 [[SUB_PTR_LHS_CAST]], [[SUB_PTR_RHS_CAST]], !annotation [[META10]]
// SAME-NEXT:    [[SUB_PTR_DIV:%.*]] = ashr exact i64 [[SUB_PTR_SUB]], 2, !annotation [[META6]]
...
// SAME-NEXT:    br i1 [[SPEC_SELECT]], label %[[CONT]], label %[[TRAP]], !prof [[PROF12]], !annotation [[META6]]
// SAME:       [[TRAP]]:
// SAME-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META6]]
// SAME-NEXT:    unreachable, !annotation [[META6]]
// SAME:       [[CONT]]:
...
// NEW-NEXT:  [[ENTRY:.*:]]
// NEW-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[PTR]], null, !annotation [[META13:![0-9]+]]
...
// NEW:       [[LAND_LHS_TRUE]]:
// NEW-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// NEW-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA7]]
// NEW-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// NEW-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// NEW:       [[LAND_RHS]]:
...
// NEW-NEXT:    [[SUB_PTR_SUB:%.*]] = sub i64 [[SUB_PTR_LHS_CAST]], [[SUB_PTR_RHS_CAST]], !annotation [[META10]]
// NEW-NEXT:    [[SUB_PTR_DIV:%.*]] = ashr exact i64 [[SUB_PTR_SUB]], 2, !annotation [[META6]]
...
// NEW-NEXT:    br i1 [[SPEC_SELECT]], label %[[CONT]], label %[[TRAP]], !prof [[PROF12]], !annotation [[META6]]
// NEW:       [[TRAP]]:
// NEW-NEXT:    tail call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META6]]
// NEW-NEXT:    unreachable, !annotation [[META6]]
// NEW:       [[CONT]]:
...
// SAME:       [[LAND_LHS_TRUE]]:
// SAME-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// SAME-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA14:![0-9]+]]
// SAME-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// SAME-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// SAME:       [[LAND_RHS]]:
// SAME-NEXT:    [[CONV:%.*]] = sext i32 [[COUNT_PARAM]] to i64, !annotation [[META6]]
...
// NEW:       [[LAND_LHS_TRUE]]:
// NEW-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// NEW-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA14:![0-9]+]]
// NEW-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// NEW-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// NEW:       [[LAND_RHS]]:
// NEW-NEXT:    [[CONV:%.*]] = sext i32 [[COUNT_PARAM]] to i64, !annotation [[META6]]
...
// SAME-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// SAME-NEXT:  [[ENTRY:.*:]]
// SAME-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[PTR]], null, !annotation [[META13]]
// SAME-NEXT:    [[CMP_NOT47:%.*]] = icmp slt i32 [[COUNT_PARAM]], 0
// SAME-NEXT:    [[CMP_NOT:%.*]] = and i1 [[CMP_NOT47]], [[DOTNOT]], !annotation [[META6]]
// SAME-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !annotation [[META6]]
// SAME:       [[TRAP]]:
...
// SAME:       [[LAND_LHS_TRUE]]:
// SAME-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// SAME-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA14]]
// SAME-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// SAME-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// SAME:       [[LAND_RHS]]:
// SAME-NEXT:    [[TOBOOL_NOT:%.*]] = icmp eq ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], null, !annotation [[META6]]
...
// NEW-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr noundef [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// NEW-NEXT:  [[ENTRY:.*:]]
// NEW-NEXT:    [[DOTNOT:%.*]] = icmp ne ptr [[PTR]], null, !annotation [[META13]]
// NEW-NEXT:    [[CMP_NOT47:%.*]] = icmp slt i32 [[COUNT_PARAM]], 0
// NEW-NEXT:    [[CMP_NOT:%.*]] = and i1 [[CMP_NOT47]], [[DOTNOT]], !annotation [[META6]]
// NEW-NEXT:    br i1 [[CMP_NOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !annotation [[META6]]
// NEW:       [[TRAP]]:
...
// NEW:       [[LAND_LHS_TRUE]]:
// NEW-NEXT:    [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX:%.*]] = getelementptr inbounds nuw i8, ptr [[PTR]], i64 16
// NEW-NEXT:    [[AGG_TEMP4_SROA_1_0_COPYLOAD:%.*]] = load ptr, ptr [[AGG_TEMP_SROA_3_0_PTR_SROA_IDX]], align 8, !tbaa [[TBAA14]]
// NEW-NEXT:    [[CMP14_NOT:%.*]] = icmp ugt ptr [[AGG_TEMP4_SROA_1_0_COPYLOAD]], [[AGG_TEMP_SROA_0_0_COPYLOAD]], !annotation [[META6]]
// NEW-NEXT:    br i1 [[CMP14_NOT]], label %[[TRAP]], label %[[LAND_RHS:.*]], !annotation [[META6]]
// NEW:       [[LAND_RHS]]:
// NEW-NEXT:    [[TOBOOL_NOT:%.*]] = icmp eq ptr [[AGG_TEMP_SROA_0_0_COPYLOAD]], null, !annotation [[META6]]
...
#endif
//.
// SAME: [[META4:![0-9]+]] = !{!"omnipotent char", [[META5:![0-9]+]], i64 0}
// SAME: [[META5]] = !{!"Simple C/C++ TBAA"}
// SAME: [[META6]] = !{!"bounds-safety-generic"}
// SAME: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0}
// SAME: [[META8]] = !{!"p1 int", [[META9:![0-9]+]], i64 0}
// SAME: [[META9]] = !{!"any pointer", [[META4]], i64 0}
// SAME: [[META10]] = !{!"bounds-safety-generic", [[META11:![0-9]+]]}
// SAME: [[META11]] = !{!"bounds-safety-missed-optimization-nsw", !"Check can not be removed because the arithmetic operation might wrap in the signed sense. Optimize the check by adding conditions to check for overflow before doing the operation"}
// SAME: [[PROF12]] = !{!"branch_weights", i32 1048575, i32 1}
// SAME: [[META13]] = !{!"bounds-safety-check-ptr-neq-null"}
// SAME: [[TBAA14]] = !{[[META15:![0-9]+]], [[META15]], i64 0}
// SAME: [[META15]] = !{!"p1 omnipotent char", [[META9]], i64 0}
//.
// NEW: [[META4:![0-9]+]] = !{!"omnipotent char", [[META5:![0-9]+]], i64 0}
// NEW: [[META5]] = !{!"Simple C/C++ TBAA"}
// NEW: [[META6]] = !{!"bounds-safety-generic"}
// NEW: [[TBAA7]] = !{[[META8:![0-9]+]], [[META8]], i64 0}
// NEW: [[META8]] = !{!"p1 int", [[META9:![0-9]+]], i64 0}
// NEW: [[META9]] = !{!"any pointer", [[META4]], i64 0}
// NEW: [[META10]] = !{!"bounds-safety-generic", [[META11:![0-9]+]]}
// NEW: [[META11]] = !{!"bounds-safety-missed-optimization-nsw", !"Check can not be removed because the arithmetic operation might wrap in the signed sense. Optimize the check by adding conditions to check for overflow before doing the operation"}
// NEW: [[PROF12]] = !{!"branch_weights", i32 1048575, i32 1}
// NEW: [[META13]] = !{!"bounds-safety-check-ptr-neq-null"}
// NEW: [[TBAA14]] = !{[[META15:![0-9]+]], [[META15]], i64 0}
// NEW: [[META15]] = !{!"p1 omnipotent char", [[META9]], i64 0}
//.
