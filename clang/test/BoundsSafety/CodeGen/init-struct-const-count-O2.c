...
// SAME-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr dead_on_return noundef readonly captures(none) [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// SAME-NEXT:  [[ENTRY:.*:]]
...
// LEGACY-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr dead_on_return noundef readonly captures(none) [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// LEGACY-NEXT:  [[ENTRY:.*:]]
// LEGACY-NEXT:    [[C_SROA_0_0_INSERT_EXT:%.*]] = zext i32 [[COUNT_PARAM]] to i64
...
// NEW-SAME: i32 noundef [[COUNT_PARAM:%.*]], ptr dead_on_return noundef readonly captures(none) [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// NEW-NEXT:  [[ENTRY:.*:]]
