...
// CHECK-NEXT:    br i1 [[TMP3]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!nosanitize ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TMP6]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF2]], {{!nosanitize ![0-9]+}}
// CHECK:       [[TRAP1]]:
...
// CHECK-NEXT:    br i1 [[TMP10]], label %[[CONT4:.*]], label %[[TRAP3:.*]], !prof [[PROF2]], {{!nosanitize ![0-9]+}}
// CHECK:       [[TRAP3]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 22) #[[ATTR3]], {{!nosanitize ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!nosanitize ![0-9]+}}
// CHECK:       [[CONT4]]:
...
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT6:.*]], label %[[TRAP5:.*]], !prof [[PROF2]], {{!nosanitize ![0-9]+}}
// CHECK:       [[TRAP5]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 22) #[[ATTR3]], {{!nosanitize ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!nosanitize ![0-9]+}}
// CHECK:       [[CONT6]]:
...
// CHECK-NEXT:    br i1 [[TMP18]], label %[[CONT8:.*]], label %[[TRAP7:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP7]]:
...
// CHECK-NEXT:    br i1 [[TMP19]], label %[[CONT10:.*]], label %[[TRAP9:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP9]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT10]]:
