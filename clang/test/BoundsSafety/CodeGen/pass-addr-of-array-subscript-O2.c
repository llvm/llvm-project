...
// CHECK-LABEL: define dso_local void @oob(
...
// CHECK-LABEL: define dso_local void @oob2(
...
// CHECK-NEXT:    br i1 [[OR_COND_NOT76_I]], label %[[FOO_EXIT:.*]], label %[[TRAP_I:.*]], !prof [[PROF6:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP_I]]:
...
// CHECK-LABEL: define dso_local void @oob3(
