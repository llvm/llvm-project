...
// CHECK-NEXT:    br i1 [[TMP13]], label %[[BOUNDSCHECK_NOTNULL:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META5]]
...
// CHECK-NEXT:    br i1 [[TMP22]], label %[[BOUNDSCHECK_NOTNULL61:.*]], label %[[BOUNDSCHECK_NULL:.*]], !annotation [[META5]]
