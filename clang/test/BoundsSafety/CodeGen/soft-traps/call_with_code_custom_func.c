...
// RUN:   -fbounds-safety-soft-trap-function=custom_func | \
...
// UNOPT:       [[TRAP]]:
// UNOPT-NEXT:    call void @custom_func(i16 0) #[[ATTR2:[0-9]+]], !annotation [[META2]]
...
// UNOPT:       [[TRAP1]]:
// UNOPT-NEXT:    call void @custom_func(i16 0) #[[ATTR2]], !annotation [[META2]]
...
// UNOPT:       [[TRAP3]]:
// UNOPT-NEXT:    call void @custom_func(i16 0) #[[ATTR2]], !annotation [[META4]]
...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call void @custom_func(i16 0) #[[ATTR1:[0-9]+]], !annotation [[META7]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call void @custom_func(i16 0) #[[ATTR1]], !annotation [[META7]]
...
// OPT:       [[TRAP3]]:
// OPT-NEXT:    tail call void @custom_func(i16 0) #[[ATTR1]], !annotation [[META9]]
