...
// OPT:       [[TRAP]]:
// OPT-NEXT:    tail call preserve_allcc void @custom_func() #[[ATTR1:[0-9]+]], !annotation [[META7]]
...
// OPT:       [[TRAP1]]:
// OPT-NEXT:    tail call preserve_allcc void @custom_func() #[[ATTR1]], !annotation [[META7]]
