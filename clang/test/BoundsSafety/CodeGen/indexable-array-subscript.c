...
// CHECK-O0-NEXT:    br i1 [[TMP15]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
...
// CHECK-O2-NEXT:    br i1 [[DOTNOT]], label %[[TRAP:.*]], label %[[CONT:.*]], !prof [[PROF6:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O2:       [[TRAP]]:
...
//.
// CHECK-O2: [[PROF6]] = !{!"branch_weights", i32 1, i32 1048575}
//.
