...
// CHECK-NEXT:    [[TMP17:%.*]] = icmp ule ptr [[TMP16]], [[WIDE_PTR_UB15]], !annotation [[META1:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP17]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], !annotation [[META1]]
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3:[0-9]+]], !annotation [[META1]]
// CHECK-NEXT:    unreachable, !annotation [[META1]]
// CHECK:       [[CONT]]:
// CHECK-NEXT:    [[TMP18:%.*]] = icmp ule ptr [[WIDE_PTR_LB17]], [[WIDE_PTR_PTR13]], !annotation [[META3:![0-9]+]]
// CHECK-NEXT:    br i1 [[TMP18]], label %[[CONT19:.*]], label %[[TRAP18:.*]], !prof [[PROF2]], !annotation [[META3]]
// CHECK:       [[TRAP18]]:
...
// CHECK-LABEL: define signext i8 @baz(
// CHECK-SAME: ) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[A:%.*]] = alloca i32, align 4
// CHECK-NEXT:    [[PTR:%.*]] = alloca ptr, align 8
...
// CHECK-NEXT:    store ptr [[TMP1]], ptr [[PTR]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[PTR]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i8, ptr [[TMP2]], align 1, !annotation [[META4:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = icmp ne i8 [[TMP3]], 65, !annotation [[META4]]
// CHECK-NEXT:    br i1 [[TMP4]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2]], !annotation [[META4]]
// CHECK:       [[TRAP]]:
...
// CHECK: [[META4]] = !{!"bounds-safety-check-terminated-by-ptr-arith"}
//.
