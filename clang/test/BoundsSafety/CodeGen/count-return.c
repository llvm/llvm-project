...
// CHECK-O0-NEXT:    br i1 [[TMP8]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
...
// CHECK-O2-NEXT:    br i1 [[OR_COND5]], label %[[CONT4:.*]], label %[[TRAP:.*]], !prof [[PROF7:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK-O2:       [[TRAP]]:
...
// CHECK-O0-NEXT:    [[TMP7:%.*]] = getelementptr i32, ptr [[ARRAYIDX]], i64 1, {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    [[TMP8:%.*]] = icmp ule ptr [[TMP7]], [[WIDE_PTR_UB]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    br i1 [[TMP8]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF2]], {{!annotation ![0-9]+}}
// CHECK-O0:       [[TRAP]]:
// CHECK-O0-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-O0-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK-O0:       [[CONT]]:
...
//.
// CHECK-O2: [[PROF7]] = !{!"branch_weights", i32 -12288, i32 12286}
//.
