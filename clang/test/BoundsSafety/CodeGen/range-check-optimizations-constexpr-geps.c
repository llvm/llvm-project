...
// CHECK-NEXT:    br i1 [[OR_COND4]], label %[[CONT3]], label %[[TRAP:.*]], !prof [[PROF8:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT3]]:
...
// CHECK-NEXT:    br i1 [[OR_COND137]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF20:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT]]:
...
// CHECK-NEXT:    br i1 [[CMP38_1]], label %[[CONT_1:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT_1]]:
...
// CHECK-NEXT:    br i1 [[CMP38_2]], label %[[CONT_2:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT_2]]:
...
// CHECK-NEXT:    br i1 [[CMP38_3]], label %[[CONT_3:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT_3]]:
...
// CHECK-NEXT:    br i1 [[OR_COND147]], label %[[CONT121:.*]], label %[[TRAP:.*]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT121]]:
...
// CHECK-NEXT:    [[CMP38_1:%.*]] = icmp samesign ugt i64 [[TMP2]], 10, {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[CMP38_1]], label %[[CONT121_1:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT121_1]]:
...
// CHECK-NEXT:    [[CMP38_2:%.*]] = icmp samesign ugt i64 [[TMP2]], 14, {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[CMP38_2]], label %[[CONT121_2:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT121_2]]:
// CHECK-NEXT:    [[ADD_PTR50_1:%.*]] = getelementptr i8, ptr [[P_BUF]], i64 15
// CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr i8, ptr [[P_BUF]], i64 18
...
// CHECK-NEXT:    [[CMP38_3:%.*]] = icmp samesign ugt i64 [[TMP2]], 18, {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[CMP38_3]], label %[[CONT121_3:.*]], label %[[TRAP]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT121_3]]:
// CHECK-NEXT:    [[ADD_PTR50_2:%.*]] = getelementptr i8, ptr [[P_BUF]], i64 19
// CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr i8, ptr [[P_BUF]], i64 22
...
// CHECK-NEXT:    [[CMP38:%.*]] = icmp samesign ugt i64 [[TMP2]], 6, {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND147:%.*]] = and i1 [[OR_COND146_NOT148]], [[CMP38]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND147]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT]]:
...
// CHECK-NEXT:    br i1 [[OR_COND124]], label %[[CONT121:.*]], label %[[TRAP]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT121]]:
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr i8, ptr [[P_BUF]], i64 10
...
// CHECK-NEXT:    [[OR_COND147:%.*]] = select i1 [[OR_COND146_NOT148]], i1 [[CMP38]], i1 false, !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND147]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF20]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
...
// CHECK-NEXT:    br i1 [[OR_COND125]], label %[[CONT64:.*]], label %[[TRAP]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT64]]:
...
// CHECK-NEXT:    br i1 [[OR_COND128]], label %[[CONT83:.*]], label %[[TRAP]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT83]]:
...
// CHECK-NEXT:    br i1 [[OR_COND130]], label %[[CONT102:.*]], label %[[TRAP]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT102]]:
...
// CHECK-NEXT:    br i1 [[OR_COND133]], label %[[CONT121]], label %[[TRAP]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT121]]:
...
//.
// CHECK: [[PROF8]] = !{!"branch_weights", i32 -12288, i32 12286}
// CHECK: [[PROF20]] = !{!"branch_weights", i32 1048575, i32 1048577}
//.
