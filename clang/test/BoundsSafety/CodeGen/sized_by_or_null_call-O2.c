...
// CHECK-NEXT:    [[CMP_NOT174:%.*]] = icmp slt i32 [[TMP1]], 0, !annotation [[META6]]
// CHECK-NEXT:    [[CMP_NOT:%.*]] = select i1 [[DOTNOT]], i1 [[CMP_NOT174]], i1 false, !annotation [[META6]]
// CHECK-NEXT:    br i1 [[CMP_NOT]], label [[TRAP:%.*]], label [[LAND_RHS:%.*]], !annotation [[META6]]
// CHECK:       trap:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR6]], !annotation [[META15:![0-9]+]]
// CHECK-NEXT:    unreachable, !annotation [[META15]]
// CHECK:       land.rhs:
// CHECK-NEXT:    br i1 [[DOTNOT]], label [[LOR_RHS:%.*]], label [[CONT148:%.*]], !annotation [[META6]]
// CHECK:       lor.rhs:
// CHECK-NEXT:    [[CMP65:%.*]] = icmp sge i32 [[TMP1]], [[LEN]], !annotation [[META6]]
// CHECK-NEXT:    [[CMP68:%.*]] = icmp sgt i32 [[LEN]], -1, !annotation [[META6]]
// CHECK-NEXT:    [[SPEC_SELECT:%.*]] = and i1 [[CMP68]], [[CMP65]]
// CHECK-NEXT:    br i1 [[SPEC_SELECT]], label [[CONT148]], label [[TRAP]], {{!prof ![0-9]+}}, !annotation [[META6]]
// CHECK:       cont148:
