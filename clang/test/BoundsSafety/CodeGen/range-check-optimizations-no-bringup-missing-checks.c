...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT1]], label %[[TRAP:.*]], !prof [[PROF9:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[TMP0]], label %[[CONT1]], label %[[TRAP:.*]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT1]]:
...
// CHECK-NEXT:    [[OR_COND:%.*]] = and i1 [[TMP0]], [[TMP1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT2]], label %[[TRAP:.*]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT2]]:
...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT1]], label %[[TRAP:.*]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT1]]:
...
// CHECK-NEXT:    br i1 [[OR_COND17]], label %[[CONT15]], label %[[TRAP]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT15]]:
...
// CHECK-NEXT:    br i1 [[OR_COND50]], label %[[CONT49:.*]], label %[[TRAP]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT49]]:
...
// CHECK-NEXT:    [[TMP1:%.*]] = icmp uge ptr [[ARRAYIDX]], [[DST]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND:%.*]] = and i1 [[TMP0]], [[TMP1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT37:.*]], label %[[TRAP:.*]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT37]]:
...
// CHECK-NEXT:    br i1 [[OR_COND53]], label %[[CONT49:.*]], label %[[TRAP]], !prof [[PROF9]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT49]]:
...
// CHECK-SAME: ptr noundef writeonly captures(none) [[ARG:%.*]], i32 noundef [[N:%.*]]) local_unnamed_addr #[[ATTR7]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
...
// CHECK-NEXT:    br i1 [[CMP27_NOT]], label %[[TRAP:.*]], label %[[CONT59:.*]], !prof [[PROF28:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    tail call void @llvm.ubsantrap(i8 25) {{#[0-9]+}}, {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT59]]:
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label %[[TRAP]], label %[[CONT85:.*]], !prof [[PROF30:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[CONT85]]:
...
// CHECK-NEXT:    br i1 [[DOTNOT29]], label %[[TRAP]], label %[[RETURN]], !prof [[PROF28]], {{!annotation ![0-9]+}}
// CHECK:       [[RETURN]]:
...
// CHECK: [[PROF28]] = !{!"branch_weights", i32 1, i32 1048575}
// CHECK: [[PROF30]] = !{!"branch_weights", i32 8191, i32 -8192}
//.
