...
// CHECK-NEXT:    [[AGG_TEMP_SROA_12_0_SROA_GEP86:%.*]] = getelementptr i8, ptr [[ARR]], i64 48
// CHECK-NEXT:    [[ADD_PTR55:%.*]] = getelementptr inbounds nuw i8, ptr [[ARR]], i64 44
// CHECK-NEXT:    [[TMP0:%.*]] = icmp ule ptr [[AGG_TEMP_SROA_12_0_SROA_GEP86]], [[ADD_PTR55]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[TMP1:%.*]] = icmp ule ptr [[ADD_PTR_I]], [[AGG_TEMP_SROA_12_0_SROA_GEP86]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND74:%.*]] = and i1 [[TMP1]], [[TMP0]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND74]], label [[CONT68:%.*]], label [[TRAP:%.*]], !prof [[PROF4:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       trap:
