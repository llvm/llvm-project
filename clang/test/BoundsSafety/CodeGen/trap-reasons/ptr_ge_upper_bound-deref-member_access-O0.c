...
// FIXME: This is the wrong opt-remark. It should be "bounds-safety-check-ptr-le-upper-bound" rdar://150380319
...
// CHECK-DAG: [[SRC_LOC]] = !DILocation(line: 24, column: 15, scope: {{![0-9]+}})
