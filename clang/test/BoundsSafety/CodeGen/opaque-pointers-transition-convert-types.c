...
// NOPQ-NEXT:    br i1 [[TMP7]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF3:![0-9]+]], !annotation [[META2]]
// NOPQ:       [[TRAP]]:
...
// NOPQ-NEXT:    br i1 [[TMP8]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF3]], !annotation [[META4]]
// NOPQ:       [[TRAP1]]:
...
// OPQ-NEXT:    br i1 [[TMP7]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF3:![0-9]+]], !annotation [[META2]]
// OPQ:       [[TRAP]]:
...
// OPQ-NEXT:    br i1 [[TMP8]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF3]], !annotation [[META4]]
// OPQ:       [[TRAP1]]:
...
// NOPQ-NEXT:    br i1 [[TMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF3]], !annotation [[META2]]
// NOPQ:       [[TRAP]]:
...
// NOPQ-NEXT:    br i1 [[TMP2]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF3]], !annotation [[META4]]
// NOPQ:       [[TRAP1]]:
// NOPQ-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META4]]
// NOPQ-NEXT:    unreachable, !annotation [[META4]]
// NOPQ:       [[CONT2]]:
...
// OPQ-NEXT:    br i1 [[TMP1]], label %[[CONT:.*]], label %[[TRAP:.*]], !prof [[PROF3]], !annotation [[META2]]
// OPQ:       [[TRAP]]:
...
// OPQ-NEXT:    br i1 [[TMP2]], label %[[CONT2:.*]], label %[[TRAP1:.*]], !prof [[PROF3]], !annotation [[META4]]
// OPQ:       [[TRAP1]]:
// OPQ-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR3]], !annotation [[META4]]
// OPQ-NEXT:    unreachable, !annotation [[META4]]
// OPQ:       [[CONT2]]:
...
// NOPQ: [[PROF3]] = !{!"branch_weights", i32 1048575, i32 1}
...
// OPQ: [[PROF3]] = !{!"branch_weights", i32 1048575, i32 1}
