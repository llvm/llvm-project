...
// CHECK-NEXT:    br i1 [[OR_COND10]], label %[[BOUNDSCHECK_NULL]], label %[[TRAP:.*]], !prof [[PROF8:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
...
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[BOUNDSCHECK_NULL:.*]], label %[[TRAP:.*]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR9]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[BOUNDSCHECK_NULL]]:
...
// CHECK-NEXT:    [[TMP2:%.*]] = icmp ule ptr [[ARR]], [[TMP0]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    [[OR_COND:%.*]] = and i1 [[TMP1]], [[TMP2]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[OR_COND]], label %[[CONT9:.*]], label %[[TRAP:.*]], !prof [[PROF8]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR9]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT9]]:
