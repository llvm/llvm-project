...
// CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 24, ptr nonnull [[W]]) #[[ATTR6:[0-9]+]]
...
// CHECK-NEXT:    br i1 [[DOTNOT]], label [[TRAP:%.*]], label [[CONT1:%.*]], !prof [[PROF5:![0-9]+]], {{!annotation ![0-9]+}}
// CHECK:       trap:
