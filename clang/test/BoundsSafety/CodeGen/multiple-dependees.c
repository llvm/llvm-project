...
// CHECK-NEXT:    [[TMP13:%.*]] = icmp ule ptr [[TMP12]], [[WIDE_PTR_UB48]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP13]], label %[[CONT52:.*]], label %[[TRAP51:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP51]]:
...
// CHECK-NEXT:    br i1 [[TMP14]], label %[[CONT54:.*]], label %[[TRAP53:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP53]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT54]]:
// CHECK-NEXT:    [[TMP15:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB50]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP15]], label %[[CONT56:.*]], label %[[TRAP55:.*]], !prof [[PROF3]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP55]]:
// CHECK-NEXT:    call void @llvm.ubsantrap(i8 25) #[[ATTR4]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    unreachable, {{!annotation ![0-9]+}}
// CHECK:       [[CONT56]]:
