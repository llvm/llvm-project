...
// X86_64-NEXT:    br i1 [[TMP6]], label [[CONT:%.*]], label [[TRAP:%.*]], !prof [[PROF3:![0-9]+]], !annotation [[META2]]
// X86_64:       trap:
...
// X86_64-NEXT:    br i1 [[TMP7]], label [[CONT2:%.*]], label [[TRAP1:%.*]], !prof [[PROF3]], !annotation [[META2]]
// X86_64:       trap1:
// X86_64-NEXT:    call void @fb_trap(i8 25) #[[ATTR1]], !annotation [[META2]]
// X86_64-NEXT:    br label [[CONT2]], !annotation [[META2]]
// X86_64:       cont2:
// X86_64-NEXT:    [[TMP8:%.*]] = icmp uge ptr [[ARRAYIDX]], [[WIDE_PTR_LB]], !annotation [[META4:![0-9]+]]
// X86_64-NEXT:    br i1 [[TMP8]], label [[CONT4:%.*]], label [[TRAP3:%.*]], !prof [[PROF3]], !annotation [[META4]]
// X86_64:       trap3:
// X86_64-NEXT:    call void @fb_trap(i8 25) #[[ATTR1]], !annotation [[META4]]
