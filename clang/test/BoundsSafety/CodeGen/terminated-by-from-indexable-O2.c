...
// CHECK-SAME: ptr noundef readonly returned [[PTR_COERCE0:%.*]], ptr noundef readnone [[PTR_COERCE1:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
...
// CHECK-SAME: ptr nocapture noundef readonly byval(%"__bounds_safety::wide_ptr.bidi_indexable") align 8 [[PTR:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
...
// CHECK-SAME: ptr noundef readonly returned [[PTR_COERCE0:%.*]], ptr noundef readnone [[PTR_COERCE1:%.*]]) local_unnamed_addr #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*]]:
// CHECK-NEXT:    [[TMP0:%.*]] = icmp ult ptr [[PTR_COERCE0]], [[PTR_COERCE1]], {{!annotation ![0-9]+}}
// CHECK-NEXT:    br i1 [[TMP0]], label %[[TERMINATED_BY_LOOP_COND:.*]], label %[[TRAP:.*]], {{!annotation ![0-9]+}}
// CHECK:       [[TRAP]]:
