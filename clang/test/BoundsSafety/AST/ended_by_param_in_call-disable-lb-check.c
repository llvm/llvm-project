...
// RUN: %clang_cc1 -ast-dump -fbounds-safety -fno-bounds-safety-bringup-missing-checks=ended_by_lower_bound -verify -x objective-c -fexperimental-bounds-safety-objc %s 2> /dev/null | FileCheck %s
#include <ptrcheck.h>
