...
void g() {
  ...
  for (constexpr int a : A()) {} // expected-error {{constexpr variable 'a' must be initialized by a constant expression}} expected-note-re {{'__begin{{[0-9]+}}'-variable of range-based 'for' loop is not a constant expression}}
  constexpr int arr[] = {1, 2, 3};
  for (constexpr int a : arr) {} // expected-error {{constexpr variable 'a' must be initialized by a constant expression}} expected-note-re {{'__begin{{[0-9]+}}'-variable of range-based 'for' loop is not a constant expression}}
