...
void g() {
  ...
  for (constexpr int a : A()) {} // expected-error {{constexpr variable 'a' must be initialized by a constant expression}} expected-note {{iterator of the range-based for loop is not a constant expression}}
  int arr[] = {1, 2, 3};
  for (constexpr int a : arr) {} // expected-error {{constexpr variable 'a' must be initialized by a constant expression}} expected-note {{iterator of the range-based for loop over 'arr' is not a constant expression}}
  constexpr int carr[] = {1, 2, 3};
  for (constexpr int a : carr) {} // expected-error {{constexpr variable 'a' must be initialized by a constant expression}} expected-note {{iterator of the range-based for loop over 'carr' is not a constant expression}}
