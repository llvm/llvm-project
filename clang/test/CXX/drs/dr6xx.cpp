...
// since-cxx11-error@-1 {{requested alignment must be 4294967296 bytes or smaller}}1
struct alignas(0x200000000) X {};
// since-cxx11-error@-1 {{requested alignment must be 4294967296 bytes or smaller}}
struct Y {
