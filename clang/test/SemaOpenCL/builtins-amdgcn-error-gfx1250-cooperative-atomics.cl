...
// RUN: %clang_cc1 -verify -cl-std=CL2.0 -triple amdgpu12.50-unknown-unknown -emit-llvm -o - %s
// RUN: %clang_cc1 -verify -cl-std=CL2.0 -triple amdgpu12.51-unknown-unknown -emit-llvm -o - %s
