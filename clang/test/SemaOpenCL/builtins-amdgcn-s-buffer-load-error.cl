...
int test_amdgcn_s_buffer_load_i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v2i32 test_amdgcn_s_buffer_load_v2i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v3i32 test_amdgcn_s_buffer_load_v3i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v4i32 test_amdgcn_s_buffer_load_v4i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v8i32 test_amdgcn_s_buffer_load_v8i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v16i32 test_amdgcn_s_buffer_load_v16i32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
float test_amdgcn_s_buffer_load_f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v2f32 test_amdgcn_s_buffer_load_v2f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v3f32 test_amdgcn_s_buffer_load_v3f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v4f32 test_amdgcn_s_buffer_load_v4f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v8f32 test_amdgcn_s_buffer_load_v8f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v16f32 test_amdgcn_s_buffer_load_v16f32_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
char test_amdgcn_s_buffer_load_i8_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
unsigned char test_amdgcn_s_buffer_load_u8_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
short test_amdgcn_s_buffer_load_i16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
unsigned short test_amdgcn_s_buffer_load_u16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v2i8 test_amdgcn_s_buffer_load_v2i8_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v3i8 test_amdgcn_s_buffer_load_v3i8_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v4i8 test_amdgcn_s_buffer_load_v4i8_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
half test_amdgcn_s_buffer_load_f16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v2f16 test_amdgcn_s_buffer_load_v2f16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v3f16 test_amdgcn_s_buffer_load_v3f16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
v4f16 test_amdgcn_s_buffer_load_v4f16_non_const_aux(__amdgpu_buffer_rsrc_t rsrc, int offset, int aux) {
...
int test_amdgcn_s_buffer_load_i32_too_few_args(__amdgpu_buffer_rsrc_t rsrc) {
  return __builtin_amdgcn_s_buffer_load_i32(rsrc, 0); //expected-error{{too few arguments to function call, expected 3, have 2}}
}

int test_amdgcn_s_buffer_load_i32_too_many_args(__amdgpu_buffer_rsrc_t rsrc) {
...
int test_amdgcn_s_buffer_load_i32_wrong_rsrc_type(v4i32 rsrc) {
  return __builtin_amdgcn_s_buffer_load_i32(rsrc, 0, 0); //expected-error{{passing '__private v4i32' (vector of 4 'int' values) to parameter of incompatible type '__amdgpu_buffer_rsrc_t'}}
}
