...
#ifndef LLVM_CLANG_UNITTESTS_SCALABLESTATICANALYSIS_FINDDECL_H
#define LLVM_CLANG_UNITTESTS_SCALABLESTATICANALYSIS_FINDDECL_H
...
#endif // LLVM_CLANG_UNITTESTS_SCALABLESTATICANALYSIS_FINDDECL_H
