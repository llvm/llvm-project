...
const inline ARMNeonVectorIntrinsicInfo AArch64SISDIntrinsicMap[] = {
  ...
  NEONMAP1(vqrshrnh_n_s16, aarch64_neon_sqrshrn, VectorRet | Use64BitVectors | ArgAsWidenedRetType),
  NEONMAP1(vqrshrnh_n_u16, aarch64_neon_uqrshrn, VectorRet | Use64BitVectors | ArgAsWidenedRetType),
  NEONMAP1(vqrshrns_n_s32, aarch64_neon_sqrshrn, VectorRet | Use64BitVectors | ArgAsWidenedRetType),
  NEONMAP1(vqrshrns_n_u32, aarch64_neon_uqrshrn, VectorRet | Use64BitVectors | ArgAsWidenedRetType),
