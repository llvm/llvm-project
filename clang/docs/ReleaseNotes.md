...
- Fixed a crash when a reference variable with static storage duration, such as a global reference, was used in an OpenMP `target` region inside a lambda or block at namespace scope. (#GH223397)
