...
**OFFLOAD_BUNDLER_MAGIC_STR\_\_**

: The magic string that marks the existence of offloading data i.e.
  "\_\_CLANG_OFFLOAD_BUNDLE\_\_".

(clang-bundled-code-object-layout)=
...
(additional-options-archive-unbundling)=
