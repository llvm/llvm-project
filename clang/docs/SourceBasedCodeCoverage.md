...
For a program such as the {external+llvm:doc}`Lit <CommandGuide/lit>`
...
list of options, please refer to the {external+llvm:doc}`command guide <CommandGuide/llvm-cov>`.
