...
not support [CMAKE_EXPORT_COMPILE_COMMANDS](https://cmake.org/cmake/help/latest/variable/CMAKE_EXPORT_COMPILE_COMMANDS.html).
...
First, you will need to install [Ninja]. Once installed, the Ninja
...
will locate the MSVC compiler for the Ninja generator. The [documentation](https://docs.microsoft.com/en-us/cpp/build/building-on-the-command-line?view=msvc-170#path_and_environment)
describes the necessary environment variable settings, but the simplest thing
is to use a [developer command-prompt window](https://docs.microsoft.com/en-us/cpp/build/building-on-the-command-line?view=msvc-170#developer_command_prompt_shortcuts)
or call a [developer command file](https://docs.microsoft.com/en-us/cpp/build/building-on-the-command-line?view=msvc-170#developer_command_file_locations)
...
Optionally you can use the [Ninja] build system instead of make. It is
