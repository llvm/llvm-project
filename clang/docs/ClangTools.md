...
directory tree, [clang-tools-extra](https://github.com/llvm/llvm-project/tree/main/clang-tools-extra).
...
[Clangd](https://clangd.llvm.org/) is a language server that can work with
...
- C++14: less verbose operator function objects ([N3421](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2012/n3421.htm)).
  For example:
