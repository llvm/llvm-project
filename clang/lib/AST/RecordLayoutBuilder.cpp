...
ASTContext::getASTRecordLayout(const RecordDecl *D) const {
  ...
  bool ShouldBeRandomized =
      (RandstructAutoSelect && Randstruct::isTriviallyRandomizable(D)) ||
      D->getAttr<RandomizeLayoutAttr>() != nullptr;
    ...
    if (const auto *RD = dyn_cast<CXXRecordDecl>(D)) {
      ...
      NewEntry = new (*this) ASTRecordLayout(
          *this, Builder.Size, Builder.Alignment, Builder.Alignment,
          Builder.RequiredAlignment, Builder.HasOwnVFPtr,
      ...
      NewEntry = new (*this) ASTRecordLayout(
          *this, Builder.Size, Builder.Alignment, Builder.Alignment,
          Builder.RequiredAlignment, Builder.Size, Builder.FieldOffsets);
    }
  } else {
    if (const auto *RD = dyn_cast<CXXRecordDecl>(D)) {
