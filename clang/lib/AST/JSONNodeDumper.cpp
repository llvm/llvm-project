...
void JSONNodeDumper::VisitCXXNewExpr(const CXXNewExpr *NE) {
  ...
  case CXXNewInitializationStyle::None: break;
  case CXXNewInitializationStyle::Implicit: break;
  case CXXNewInitializationStyle::Call: JOS.attribute("initStyle", "call"); break;
  case CXXNewInitializationStyle::List: JOS.attribute("initStyle", "list"); break;
  }
