...
static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotup_sc_h(uint32_t a0, uint16_t a1) {
  return __builtin_riscv_cv_simd_dotup_sc_h(a0, a1);
}

static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotup_sc_b(uint32_t a0, uint8_t a1) {
...
static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotusp_sc_h(uint32_t a0, int16_t a1) {
  return __builtin_riscv_cv_simd_dotusp_sc_h(a0, a1);
}

static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotusp_sc_b(uint32_t a0, int8_t a1) {
...
static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotsp_sc_h(uint32_t a0, int16_t a1) {
  return __builtin_riscv_cv_simd_dotsp_sc_h(a0, a1);
}

static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_dotsp_sc_b(uint32_t a0, int8_t a1) {
...
static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotup_sc_h(uint32_t a0, uint16_t a1, uint32_t a2) {
  return __builtin_riscv_cv_simd_sdotup_sc_h(a0, a1, a2);
}

static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotup_sc_b(uint32_t a0, uint8_t a1, uint32_t a2) {
...
static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotusp_sc_h(uint32_t a0, int16_t a1, int32_t a2) {
  return __builtin_riscv_cv_simd_sdotusp_sc_h(a0, a1, a2);
}

static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotusp_sc_b(uint32_t a0, int8_t a1, int32_t a2) {
...
static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotsp_sc_h(uint32_t a0, int16_t a1, int32_t a2) {
  return __builtin_riscv_cv_simd_sdotsp_sc_h(a0, a1, a2);
}

static __inline__ int32_t __DEFAULT_FN_ATTRS
__riscv_cv_simd_sdotsp_sc_b(uint32_t a0, int8_t a1, int32_t a2) {
