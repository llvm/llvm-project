...
{
  return (__m512i)__builtin_selectvector((__v8di)_mm512_conflict_epi64(__A),
                                         (__v8di)__W,
...
{
  return (__m512i)__builtin_selectvector((__v16si)_mm512_conflict_epi32(__A),
                                         (__v16si)__W,
...
{
  return (__m512i)__builtin_selectvector((__v16si)_mm512_lzcnt_epi32(__A),
                                         (__v16si)__W,
                                         __builtin_bit_cast(__vecmask16, __U));
}
...
{
  return (__m512i)__builtin_selectvector((__v8di)_mm512_lzcnt_epi64(__A),
                                         (__v8di)__W,
                                         __builtin_bit_cast(__vecmask8, __U));
}
