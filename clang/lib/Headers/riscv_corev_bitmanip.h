...
__riscv_cv_bitmanip_extract(int32_t i, uint16_t range) {
  return __builtin_riscv_cv_bitmanip_extract((uint32_t)i, (uint32_t)range);
}
...
__riscv_cv_bitmanip_extractu(uint32_t i, uint16_t range) {
  return __builtin_riscv_cv_bitmanip_extractu(i, (uint32_t)range);
}
 ...
 */
static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_bitmanip_bclr(uint32_t i, uint16_t range) {
  return __builtin_riscv_cv_bitmanip_bclr(i, (uint32_t)range);
}
 ...
 */
static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_bitmanip_bset(uint32_t i, uint16_t range) {
  return __builtin_riscv_cv_bitmanip_bset(i, (uint32_t)range);
}
 ...
 */
static __inline__ uint32_t __DEFAULT_FN_ATTRS
__riscv_cv_bitmanip_insert(uint32_t i, uint16_t range, uint32_t k) {
  return __builtin_riscv_cv_bitmanip_insert(i, (uint32_t)range, k);
}
 ...
 * ---------------------------------------------------------------------------
 */
static __inline__ uint8_t __DEFAULT_FN_ATTRS
__riscv_cv_bitmanip_clb(uint32_t i) {
  return (uint8_t)__builtin_riscv_cv_bitmanip_clb(i);
}
