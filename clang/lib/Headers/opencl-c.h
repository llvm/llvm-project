 ...
 */
float __ovld __purefn vloada_half(size_t offset, const __constant half *p);
...
#if defined(__opencl_c_generic_address_space)
float __ovld __purefn vloada_half(size_t offset, const half *p);
...
#else
float __ovld __purefn vloada_half(size_t offset, const __global half *p);
...
float __ovld __purefn vloada_half(size_t offset, const __local half *p);
...
float __ovld __purefn vloada_half(size_t offset, const __private half *p);
