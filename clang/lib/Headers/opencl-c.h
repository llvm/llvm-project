...
#endif //cl_khr_fp64
#ifdef cl_khr_fp16
void __ovld vstore(half data, size_t, half *);
void __ovld vstore2(half2 data, size_t, half *);
void __ovld vstore3(half3 data, size_t, half *);
void __ovld vstore4(half4 data, size_t, half *);
void __ovld vstore8(half8 data, size_t, half *);
void __ovld vstore16(half16 data, size_t, half *);
#endif //cl_khr_fp16
#else
...
#endif //cl_khr_fp64
#ifdef cl_khr_fp16
void __ovld vstore(half data, size_t, __global half *);
void __ovld vstore2(half2 data, size_t, __global half *);
void __ovld vstore3(half3 data, size_t, __global half *);
void __ovld vstore4(half4 data, size_t, __global half *);
void __ovld vstore8(half8 data, size_t, __global half *);
void __ovld vstore16(half16 data, size_t, __global half *);
void __ovld vstore(half data, size_t, __local half *);
void __ovld vstore2(half2 data, size_t, __local half *);
void __ovld vstore3(half3 data, size_t, __local half *);
void __ovld vstore4(half4 data, size_t, __local half *);
void __ovld vstore8(half8 data, size_t, __local half *);
void __ovld vstore16(half16 data, size_t, __local half *);
void __ovld vstore(half data, size_t, __private half *);
void __ovld vstore2(half2 data, size_t, __private half *);
void __ovld vstore3(half3 data, size_t, __private half *);
void __ovld vstore4(half4 data, size_t, __private half *);
void __ovld vstore8(half8 data, size_t, __private half *);
void __ovld vstore16(half16 data, size_t, __private half *);
#endif //cl_khr_fp16
#endif //defined(__opencl_c_generic_address_space)
