...
{
  return (__m128i)__builtin_selectvector((__v2di)_mm_conflict_epi64(__A),
                                         (__v2di)__W,
...
{
  return (__m256i)__builtin_selectvector((__v4di)_mm256_conflict_epi64(__A),
                                         (__v4di)__W,
...
{
  return (__m128i)__builtin_selectvector((__v4si)_mm_conflict_epi32(__A),
                                         (__v4si)__W,
                                         __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m256i)__builtin_selectvector((__v8si)_mm256_conflict_epi32(__A),
                                         (__v8si)__W,
...
{
  return (__m128i)__builtin_selectvector((__v4si)_mm_lzcnt_epi32(__A),
                                         (__v4si)__W,
                                         __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m256i)__builtin_selectvector((__v8si)_mm256_lzcnt_epi32(__A),
                                         (__v8si)__W,
                                         __builtin_bit_cast(__vecmask8, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v2di)_mm_lzcnt_epi64(__A),
                                         (__v2di)__W,
                                         __builtin_bit_cast(__vecmask2, __U));
}
...
{
  return (__m256i)__builtin_selectvector((__v4di)_mm256_lzcnt_epi64(__A),
                                         (__v4di)__W,
                                         __builtin_bit_cast(__vecmask4, __U));
}
