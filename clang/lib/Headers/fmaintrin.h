...
{
  return (__m128)__builtin_elementwise_fma((__v4sf)__A, (__v4sf)__B, (__v4sf)__C);
}
...
{
  return (__m128d)__builtin_elementwise_fma((__v2df)__A, (__v2df)__B, (__v2df)__C);
}
...
{
  return (__m256)__builtin_elementwise_fma((__v8sf)__A, (__v8sf)__B, (__v8sf)__C);
}
...
{
  return (__m256d)__builtin_elementwise_fma((__v4df)__A, (__v4df)__B, (__v4df)__C);
}
