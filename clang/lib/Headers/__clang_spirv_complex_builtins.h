...
#ifndef __CLANG_SPIRV_COMPLEX_BUILTINS
#define __CLANG_SPIRV_COMPLEX_BUILTINS

// This header defines __muldc3, __mulsc3, __divdc3, and __divsc3.  These are
// libgcc functions that clang assumes are available when compiling c99 complex
// operations.  (These implementations come from libc++, and have been modified
// to work with SPIRV and OpenMP target offloading [in C and C++ mode].)
...
// To make the algorithms available for C and C++ in SPIRV and OpenMP we select
...
#define _fmaxf max
#else
#define _ISNANd __spirv_IsNan
#define _ISNANf __spirv_IsNan
#define _ISINFd __spirv_IsInf
#define _ISINFf __spirv_IsInf
#define _ISFINITEd __spirv_IsFinite
#define _ISFINITEf __spirv_IsFinite
#define _COPYSIGNd __spirv_ocl_copysign
#define _COPYSIGNf __spirv_ocl_copysign
#define _SCALBNd __spirv_ocl_ldexp
#define _SCALBNf __spirv_ocl_ldexp
#define _ABSd __spirv_ocl_fabs
#define _ABSf __spirv_ocl_fabs
#define _LOGBd __spirv_ocl_logb
#define _LOGBf __spirv_ocl_logb
#define _fmaxd __spirv_ocl_fmax
#define _fmaxf __spirv_ocl_fmax
#endif
...
#endif // __CLANG_SPIRV_COMPLEX_BUILTINS