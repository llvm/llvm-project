...
#define _mm256_mask_shldi_epi64(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v4di)_mm256_shldi_epi64((A), (B), (I)),  \
                                   (__v4di)(__m256i)(S),                       \
...
#define _mm_mask_shldi_epi64(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v2di)_mm_shldi_epi64((A), (B), (I)),     \
                                   (__v2di)(__m128i)(S),                       \
...
#define _mm256_mask_shldi_epi32(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v8si)_mm256_shldi_epi32((A), (B), (I)),  \
                                   (__v8si)(__m256i)(S),                       \
...
#define _mm_mask_shldi_epi32(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v4si)_mm_shldi_epi32((A), (B), (I)),     \
                                   (__v4si)(__m128i)(S),                       \
                                   __builtin_bit_cast(__vecmask4, (U))))
...
#define _mm256_mask_shldi_epi16(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v16hi)_mm256_shldi_epi16((A), (B), (I)), \
                                   (__v16hi)(__m256i)(S),                      \
...
#define _mm_mask_shldi_epi16(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v8hi)_mm_shldi_epi16((A), (B), (I)),     \
                                   (__v8hi)(__m128i)(S),                       \
                                   __builtin_bit_cast(__vecmask8, (U))))
...
#define _mm256_mask_shrdi_epi64(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v4di)_mm256_shrdi_epi64((A), (B), (I)),  \
                                   (__v4di)(__m256i)(S),                       \
                                   __builtin_bit_cast(__vecmask4, (U))))
...
#define _mm_mask_shrdi_epi64(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v2di)_mm_shrdi_epi64((A), (B), (I)),     \
                                   (__v2di)(__m128i)(S),                       \
                                   __builtin_bit_cast(__vecmask2, (U))))
...
#define _mm256_mask_shrdi_epi32(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v8si)_mm256_shrdi_epi32((A), (B), (I)),  \
                                   (__v8si)(__m256i)(S),                       \
                                   __builtin_bit_cast(__vecmask8, (U))))
...
#define _mm_mask_shrdi_epi32(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v4si)_mm_shrdi_epi32((A), (B), (I)),     \
                                   (__v4si)(__m128i)(S),                       \
                                   __builtin_bit_cast(__vecmask4, (U))))
...
#define _mm256_mask_shrdi_epi16(S, U, A, B, I)                                 \
  ((__m256i)__builtin_selectvector((__v16hi)_mm256_shrdi_epi16((A), (B), (I)), \
                                   (__v16hi)(__m256i)(S),                      \
                                   __builtin_bit_cast(__vecmask16, (U))))
...
#define _mm_mask_shrdi_epi16(S, U, A, B, I)                                    \
  ((__m128i)__builtin_selectvector((__v8hi)_mm_shrdi_epi16((A), (B), (I)),     \
                                   (__v8hi)(__m128i)(S),                       \
                                   __builtin_bit_cast(__vecmask8, (U))))
...
_mm256_mask_shldv_epi64(__m256i __A, __mmask8 __U, __m256i __B, __m256i __C)
{
  return (__m256i)__builtin_selectvector(
      (__v4di)_mm256_shldv_epi64(__A, __B, __C), (__v4di)__A,
...
{
  return (__m256i)__builtin_selectvector(
      (__v4di)_mm256_shldv_epi64(__A, __B, __C), (__v4di)_mm256_setzero_si256(),
      __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v2di)_mm_shldv_epi64(__A, __B, __C),
                                         (__v2di)__A,
...
{
  return (__m256i)__builtin_selectvector(
      (__v8si)_mm256_shldv_epi32(__A, __B, __C), (__v8si)__A,
...
{
  return (__m256i)__builtin_selectvector(
      (__v8si)_mm256_shldv_epi32(__A, __B, __C), (__v8si)_mm256_setzero_si256(),
      __builtin_bit_cast(__vecmask8, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v4si)_mm_shldv_epi32(__A, __B, __C),
                                         (__v4si)__A,
                                         __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v16hi)_mm256_shldv_epi16(__A, __B, __C), (__v16hi)__A,
...
{
  return (__m128i)__builtin_selectvector((__v8hi)_mm_shldv_epi16(__A, __B, __C),
                                         (__v8hi)__A,
                                         __builtin_bit_cast(__vecmask8, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v4di)_mm256_shrdv_epi64(__A, __B, __C), (__v4di)__A,
      __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v4di)_mm256_shrdv_epi64(__A, __B, __C), (__v4di)_mm256_setzero_si256(),
      __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v2di)_mm_shrdv_epi64(__A, __B, __C),
                                         (__v2di)__A,
                                         __builtin_bit_cast(__vecmask2, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v8si)_mm256_shrdv_epi32(__A, __B, __C), (__v8si)__A,
      __builtin_bit_cast(__vecmask8, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v8si)_mm256_shrdv_epi32(__A, __B, __C), (__v8si)_mm256_setzero_si256(),
      __builtin_bit_cast(__vecmask8, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v4si)_mm_shrdv_epi32(__A, __B, __C),
                                         (__v4si)__A,
                                         __builtin_bit_cast(__vecmask4, __U));
}
...
{
  return (__m256i)__builtin_selectvector(
      (__v16hi)_mm256_shrdv_epi16(__A, __B, __C), (__v16hi)__A,
      __builtin_bit_cast(__vecmask16, __U));
}
...
{
  return (__m128i)__builtin_selectvector((__v8hi)_mm_shrdv_epi16(__A, __B, __C),
                                         (__v8hi)__A,
                                         __builtin_bit_cast(__vecmask8, __U));
}
