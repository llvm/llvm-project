...
void EmitAssemblyHelper::RunCodegenPipeline(
  ...
  if (CodeGenOpts.EnableNewPMCodeGen) {
    ...
    RunCodegenPipelineLegacy(Action, OS, DwoOS, CGFT, CasIDOS);
  }
}

void EmitAssemblyHelper::RunCodegenPipelineLegacy(
    BackendAction Action, std::unique_ptr<raw_pwrite_stream> &OS,
    std::unique_ptr<llvm::ToolOutputFile> &DwoOS, CodeGenFileType CGFT, std::unique_ptr<raw_pwrite_stream> &CasIDOS) {
