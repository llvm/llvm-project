...
IncrementalParser::ParseOrWrapTopLevelDecl() {
  ...
  // End the unit as a whole-file compile does. After an error, CodeGen drops
  // the input's IR and the next input starts a new module. CodeGen can also
  // report the input's first error here.
