...
bool Sema::isRedefinitionAllowedFor(NamedDecl *D, NamedDecl **Suggested,
  ...
  // definition for declaratins which is attached to named modules. We only did
  // this if the current module is named module as we have better diagnostics
  // for declarations in global module and named modules.
