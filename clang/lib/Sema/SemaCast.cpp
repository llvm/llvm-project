...
TryStaticMemberPointerUpcast(Sema &Self, ExprResult &SrcExpr, QualType SrcType,
  ...
  switch (Self.CheckMemberPointerConversion(
      ...
      Sema::CheckMemberPointerConversionDirection::Upcast)) {
  case Sema::CheckMemberPointerConversionResult::Success:
    if (Kind == CK_NullToMemberPointer) {
      msg = diag::err_bad_static_cast_member_pointer_nonmp;
      return TC_NotApplicable;
    }
    break;
  case Sema::CheckMemberPointerConversionResult::DifferentPointee:
  case Sema::CheckMemberPointerConversionResult::NotDerived:
    return TC_NotApplicable;
  case Sema::CheckMemberPointerConversionResult::Ambiguous:
  case Sema::CheckMemberPointerConversionResult::Virtual:
  case Sema::CheckMemberPointerConversionResult::Inaccessible:
    msg = 0;
    return TC_Failed;
  }
