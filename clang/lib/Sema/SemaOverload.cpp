...
Sema::CheckMemberPointerConversionResult Sema::CheckMemberPointerConversion(
  ...
  if (!FromPtrType) {
    ...
    return CheckMemberPointerConversionResult::Success;
  }
  ...
  // T == T, modulo cv
  if (Direction == CheckMemberPointerConversionDirection::Upcast &&
      !Context.hasSameUnqualifiedType(FromPtrType->getPointeeType(),
                                      ToPtrType->getPointeeType()))
    return CheckMemberPointerConversionResult::DifferentPointee;
  ...
  if (!IsDerivedFrom(OpRange.getBegin(), Derived, Base, Paths))
    return CheckMemberPointerConversionResult::NotDerived;
  ...
  if (Paths.isAmbiguous(
    ...
    Diag(CheckLoc, PD);
    return CheckMemberPointerConversionResult::Ambiguous;
  }
  ...
  if (const RecordType *VBase = Paths.getDetectedVirtual()) {
    ...
    Diag(CheckLoc, PD);
    return CheckMemberPointerConversionResult::Virtual;
  }

  // Must be a base to derived member conversion.
  BuildBasePathArray(Paths, BasePath);
  Kind = Direction == CheckMemberPointerConversionDirection::Upcast
  ...
  if (!IgnoreBaseAccess)
    switch (CheckBaseClassAccess(
        ...
        Direction == CheckMemberPointerConversionDirection::Upcast
    ...
    case Sema::AR_inaccessible:
      return CheckMemberPointerConversionResult::Inaccessible;
    }
