...
static void DiagnoseAllocationLookupFailure(
  ...
  ImplicitAllocationArguments *UnalignedShape = nullptr;
  ImplicitAllocationArguments *AlignedShape = nullptr;
  for (ImplicitAllocationArguments &AllocationArguments :
    ...
    if (AllocationArguments.PassAlignment == AlignedAllocationMode::Yes)
      AlignedShape = &AllocationArguments;
    else
      UnalignedShape = &AllocationArguments;
  }
  if (!UnalignedShape)
    return;
  ...
  auto Rerun = [&](ImplicitAllocationArguments &Shape,
                   OverloadCandidateSet &Candidates,
                   SmallVectorImpl<Expr *> &Args) {
    llvm::append_range(Args, Shape.getImplicitArguments());
    llvm::append_range(Args, PlacementArguments);
    FunctionDecl *Unused = nullptr;
    resolveAllocationOverload(SemaRef, R, Range, Shape, Args, Unused,
  ...
  if (AlignedShape) {
    ...
    Rerun(*AlignedShape, *AlignedCandidates, AlignedArgs);
    AlignArg = AlignedShape->getAlignmentArgument();
  }
  OverloadCandidateSet UnalignedCandidates(R.getNameLoc(),
                                           OverloadCandidateSet::CSK_Normal);
  SmallVector<Expr *, 4> UnalignedArgs;
  Rerun(*UnalignedShape, UnalignedCandidates, UnalignedArgs);
...
Sema::FindAllocationFunctions(SourceLocation StartLoc, SourceRange Range,
  ...
  // Find the allocation function.
  {
    ...
    for (ImplicitAllocationArguments &Shape : Candidates->Candidates) {
      SmallVector<Expr *, 4> TrialArguments(Shape.getImplicitArguments());
      ...
      switch (resolveAllocationOverload(*this, R, Range, Shape, TrialArguments,
                                        Operator, OverloadCandidates,
                                        Diagnose)) {
      ...
      case AllocatorResolveResult::Success:
        ...
        Result.IAP.PassTypeIdentity = Shape.PassTypeIdentity;
        Result.IAP.PassAlignment = Shape.PassAlignment;
