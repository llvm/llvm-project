...
foreach(target armv6m-none-eabi;armv7m-none-eabi;armv8m.main-none-eabi;armv8.1m.main-none-eabi)
  ...
  foreach(lang C;CXX;ASM)
    ...
    if(${target} STREQUAL "armv8.1m.main-none-eabi")
      set(BUILTINS_${target}_CMAKE_${lang}_local_flags "${BUILTINS_${target}_CMAKE_${lang}_local_flags} -mfloat-abi=hard -march=armv8.1-m.main+mve.fp -mcpu=cortex-m55" CACHE STRING "")
    endif()
  ...
  foreach(lang C;CXX;ASM)
    ...
    if(${target} STREQUAL "armv8.1m.main-none-eabi")
      set(RUNTIMES_${target}_CMAKE_${lang}_local_flags "${RUNTIMES_${target}_CMAKE_${lang}_local_flags} -mfloat-abi=hard -march=armv8.1-m.main+mve.fp -mcpu=cortex-m55" CACHE STRING "")
    endif()
