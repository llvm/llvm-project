...
foreach(target armv6m-none-eabi;armv7m-none-eabi;armv7em-none-eabi;armv8m.main-none-eabi;armv8.1m.main-none-eabi;aarch64-none-elf)
  ...
  endforeach()
  set(RUNTIMES_${target}_LIBCXX_COMPILE_FLAGS "${RUNTIMES_${target}_CMAKE_CXX_FLAGS} -fstack-size-section -fexperimental-call-graph-section" CACHE STRING "")
  set(RUNTIMES_${target}_LIBCXXABI_COMPILE_FLAGS "${RUNTIMES_${target}_CMAKE_CXX_FLAGS} -fstack-size-section -fexperimental-call-graph-section" CACHE STRING "")
