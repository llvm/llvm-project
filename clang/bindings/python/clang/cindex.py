...
class ClangLib(Protocol):
    ...
    def clang_CXRewriter_create(self, tu: TranslationUnit) -> CObjP:
        ...

    def clang_CXRewriter_dispose(self, rewriter: Rewriter) -> None:
        ...

    def clang_CXRewriter_insertTextBefore(self, rewriter: Rewriter, loc: SourceLocation, insert: str) -> None:
        ...

    def clang_CXRewriter_overwriteChangedFiles(self, rewriter: Rewriter) -> int:
        ...

    def clang_CXRewriter_removeText(self, rewriter: Rewriter, extent: SourceRange) -> None:
        ...

    def clang_CXRewriter_replaceText(self, rewriter: Rewriter, extent: SourceRange, replacement: str) -> None:
        ...

    def clang_CXRewriter_writeMainFileToStdOut(self, rewriter: Rewriter) -> None:
        ...
