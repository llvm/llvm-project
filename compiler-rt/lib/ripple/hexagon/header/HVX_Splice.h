...
#define _decl_hvx_splice(ct, t)                                                \
  extern ct hvx_splice_##t(ct left, ct right, size_t start);                   \
  extern ct hvx_lsplice_##t(ct left, ct right, size_t start);
...
#define hvx_splice(left, right, start)                                         \
  _Generic(                                                                    \
      (left), char                                                             \
      : __ripple_char_is_signed                                                \
            ? __hvx_splice_anyint(char, i, (start), (left), (right))           \
            : __hvx_splice_anyint(char, u, (start), (left), (right)),          \
        signed char                                                            \
      : __hvx_splice_anyint(signed char, i, (start), (left), (right)),         \
        unsigned char                                                          \
      : __hvx_splice_anyint(unsigned char, u, (start), (left), (right)),       \
        signed short                                                           \
      : __hvx_splice_anyint(signed short, i, (start), (left), (right)),        \
        unsigned short                                                         \
      : __hvx_splice_anyint(unsigned short, u, (start), (left), (right)),      \
        signed int                                                             \
      : __hvx_splice_anyint(signed int, i, (start), (left), (right)),          \
        unsigned int                                                           \
      : __hvx_splice_anyint(unsigned int, u, (start), (left), (right)),        \
        signed long                                                            \
      : __hvx_splice_anyint(signed long, i, (start), (left), (right)),         \
        unsigned long                                                          \
      : __hvx_splice_anyint(unsigned long, u, (start), (left), (right)),       \
        signed long long                                                       \
      : __hvx_splice_anyint(signed long long, i, (start), (left), (right)),    \
        unsigned long long                                                     \
      : __hvx_splice_anyint(unsigned long long, u, (start), (left), (right)),  \
        float                                                                  \
      : hvx_splice_f32((left), (right), (start)), double                       \
      : hvx_splice_f64((left), (right), (start)),                              \
...
#define hvx_lsplice(left, right, start)                                        \
  _Generic(                                                                    \
      ...
      : __ripple_char_is_signed                                                \
        ...
        signed char                                                            \
      : __hvx_lsplice_anyint(signed char, i, (start), (left), (right)),        \
        unsigned char                                                          \
      : __hvx_lsplice_anyint(unsigned char, u, (start), (left), (right)),      \
        signed short                                                           \
      : __hvx_lsplice_anyint(signed short, i, (start), (left), (right)),       \
        unsigned short                                                         \
      : __hvx_lsplice_anyint(unsigned short, u, (start), (left), (right)),     \
        signed int                                                             \
      : __hvx_lsplice_anyint(signed int, i, (start), (left), (right)),         \
        unsigned int                                                           \
      : __hvx_lsplice_anyint(unsigned int, u, (start), (left), (right)),       \
        signed long                                                            \
      : __hvx_lsplice_anyint(signed long, i, (start), (left), (right)),        \
        unsigned long                                                          \
      : __hvx_lsplice_anyint(unsigned long, u, (start), (left), (right)),      \
        signed long long                                                       \
      : __hvx_lsplice_anyint(signed long long, i, (start), (left), (right)),   \
        unsigned long long                                                     \
      : __hvx_lsplice_anyint(unsigned long long, u, (start), (left), (right)), \
        float                                                                  \
      : hvx_lsplice_f32((left), (right), (start)), double                      \
      : hvx_lsplice_f64((left), (right), (start)),                             \
