...
#define SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(KEYVAR, EXTNAME)            \
  SET_SINGLE_RISCV_FEATURE(KEYVAR & RISCV_HWPROBE_EXT_##EXTNAME, EXTNAME)
...
static void initRISCVFeature(struct riscv_hwprobe Hwprobes[]) {
  ...
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBS);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZICBOZ);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBC);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBKB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBKC);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZBKX);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKND);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKNE);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKNH);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKSED);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKSH);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZKT);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVBB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVBC);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKG);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKNED);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKNHA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKNHB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKSED);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKSH);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVKT);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZFH);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZFHMIN);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZIHINTNTL);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZIHINTPAUSE);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVFH);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVFHMIN);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZFA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZTSO);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZACAS);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZICOND);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVE32X);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVE32F);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVE64X);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVE64F);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZVE64D);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZIMOP);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZCA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZCB);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZCD);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZCF);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZCMOP);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT0Value, ZAWRS);

  // Check RISCV_HWPROBE_KEY_IMA_EXT_1
  unsigned long long IMAEXT1Value = Hwprobes[5].value;
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(IMAEXT1Value, ZICFISS);
...
void __init_riscv_feature_bits(void *PlatformArgs) {
  ...
  struct riscv_hwprobe Hwprobes[] = {
      ...
      {RISCV_HWPROBE_KEY_MIMPID, 0},        {RISCV_HWPROBE_KEY_IMA_EXT_1, 0},
  };
