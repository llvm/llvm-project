...
static void initRISCVFeature(struct riscv_hwprobe Hwprobes[]) {
  ...
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(SUPM);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZICNTR);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZIHPM);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZFBFMIN);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZVFBFMIN);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZVFBFWMA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZICBOM);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZAAMO);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZALRSC);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZABHA);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZALASR);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZICBOP);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZILSD);
  SET_RISCV_HWPROBE_EXT_SINGLE_RISCV_FEATURE(ZCLSD);
...
>>>>>>> adcbaac7da3f ([RISC-V] Update linux feature detection)
