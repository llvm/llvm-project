...
HANDLER(null_pointer_use, "null-pointer-use")
HANDLER(null_pointer_use_with_nullability, "null-pointer-use-with-nullability")
HANDLER(misaligned_pointer_use, "misaligned-pointer-use")
HANDLER(insufficient_object_size, "insufficient-object-size")
