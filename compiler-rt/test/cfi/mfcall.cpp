...
int main(int argc, char **argv) {
  ...
  switch (argv[1][0]) {
    case 'a':
      ...
      // A: SUMMARY: UndefinedBehaviorSanitizer: cfi-mfcall
    ...
    case 'b':
      ...
      // B: SUMMARY: UndefinedBehaviorSanitizer: cfi-mfcall
    ...
    case 'c':
      ...
      // C: SUMMARY: UndefinedBehaviorSanitizer: cfi-mfcall
    ...
    case 'd':
      ...
      // D: SUMMARY: UndefinedBehaviorSanitizer: cfi-mfcall
    ...
    case 'e':
      ...
      // E: SUMMARY: UndefinedBehaviorSanitizer: cfi-mfcall
