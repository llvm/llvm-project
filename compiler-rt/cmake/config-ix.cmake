...
macro(get_test_cc_for_arch arch cc_out cflags_out)
  ...
  if(ANDROID OR (NOT COMPILER_RT_TARGET_APPLE AND ${arch} MATCHES "arm|aarch64|riscv32|riscv64"))
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND ASAN_SUPPORTED_ARCH AND COMPILER_RT_TARGET_APPLE)
