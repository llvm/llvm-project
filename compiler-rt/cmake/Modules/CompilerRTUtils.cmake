...
macro(construct_compiler_rt_default_triple)
  if(COMPILER_RT_DEFAULT_TARGET_ONLY)
    ...
    elseif(NOT "${LLVM_TARGET_TRIPLE}" STREQUAL "")
      set(COMPILER_RT_DEFAULT_TARGET_TRIPLE ${LLVM_TARGET_TRIPLE})
    else()
      message(FATAL_ERROR "CMAKE_C_COMPILER_TARGET or LLVM_DEFAULT_TARGET_TRIPLE must be set when COMPILER_RT_DEFAULT_TARGET_ONLY is ON")
    endif()
  else()
