...
elseif (FLANG_RT_LIBC_PROVIDER STREQUAL "llvm")
  ...
  if (FLANG_RT_HAS_NOSTDLIB_FLAG)
    target_compile_options(flang-rt-libc-headers INTERFACE $<$<COMPILE_LANGUAGE:CXX>:-nostdlib>)
  endif ()
...
elseif (FLANG_RT_LIBCXX_PROVIDER STREQUAL "llvm")
  ...
  if (FLANG_RT_HAS_NOSTDINCXX_FLAG)
    target_compile_options(flang-rt-libc-headers INTERFACE $<$<COMPILE_LANGUAGE:CXX>:-nostdinc++>)
  endif ()

  if (FLANG_RT_HAS_STDLIB_FLAG)
    target_compile_options(flang-rt-libc-headers INTERFACE $<$<COMPILE_LANGUAGE:CXX>:-stdlib=libc++>)
  endif ()
endif ()
