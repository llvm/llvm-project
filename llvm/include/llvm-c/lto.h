...
/** opaque reference to an LLVM triple */
typedef struct LLVMOpaqueTriple *llvm_triple_t;
...
/**
 * Deprecated from LTO_API_VERSION=31: use
 * `lto_runtime_lib_symbols_list_for_triple`.
 *
...
/**
 * For a given triple, returns the list of libcall symbols that can be generated
 * by LTO that might not be visible from the symbol table of bitcode files.
 *
 * \since LTO_API_VERSION=31
 */
LLVM_C_ABI extern const char *const *
lto_runtime_lib_symbols_list_for_triple(size_t *size, llvm_triple_t TT);
