...
public:
  ...
  /// Returns true if the target supports the given sub naturally aligned
  /// atomic load without falling back to a libcall.
  ...
  /// Returns true if the target supports the given sub naturally aligned
  /// atomic store without falling back to a libcall.
