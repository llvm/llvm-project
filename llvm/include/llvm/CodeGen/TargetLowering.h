...
public:
  ...
  /// Expand a VECTOR_SHUFFLE_VAR by storing both source vectors contiguously
  /// to a stack temporary and loading each result element through a
  /// variable-indexed (clamped) element pointer.
