...
class LLVM_CLASS_ABI DWARF5AccelTable : public AccelTable<DWARF5AccelTableData> {
public:
...
LLVM_FUNC_ABI void emitDWARF5AccelTable(AsmPrinter *Asm, DWARF5AccelTable &Contents,
                          const DwarfDebug &DD,
