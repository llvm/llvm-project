...
struct ExtensionInfo {
  ...
  StringRef Feature;           // -mattr enable string, e.g. "+profile"
  StringRef NegFeature;        // -mattr disable string, e.g. "-profile"
...
inline constexpr ExtensionInfo Extensions[] = {
    ...
    {"pmuv3", AArch64::AEK_PMUV3, "+pmuv3", "-pmuv3", FEAT_INIT, "", 0},
    ...
    {"profile", AArch64::AEK_PROFILE, "+profile", "-profile", FEAT_INIT, "", 0},
...
inline constexpr CpuInfo CpuInfos[] = {
    ...
    {"cortex-a715", ARMV9A,
     AArch64::ExtensionBitset(
         {AArch64::AEK_SB, AArch64::AEK_SSBS, AArch64::AEK_MTE,
          ...
          AArch64::AEK_I8MM, AArch64::AEK_PREDRES, AArch64::AEK_PMUV3,
    ...
    {"cortex-x3", ARMV9A,
     AArch64::ExtensionBitset(
         {AArch64::AEK_SVE, AArch64::AEK_PMUV3, AArch64::AEK_PROFILE,
    ...
    {"neoverse-n3", ARMV9_2A,
     AArch64::ExtensionBitset(
         {AArch64::AEK_MTE, AArch64::AEK_SSBS, AArch64::AEK_SB,
          ...
          AArch64::AEK_FLAGM, AArch64::AEK_PMUV3, AArch64::AEK_RNG,
          AArch64::AEK_SVE2BITPERM, AArch64::AEK_PROFILE, AArch64::AEK_PMUV3})},
    ...
    {"neoverse-v3", ARMV9_2A,
     AArch64::ExtensionBitset(
         {AArch64::AEK_PROFILE, AArch64::AEK_MTE, AArch64::AEK_SSBS,
          ...
          AArch64::AEK_PMUV3, AArch64::AEK_RNG, AArch64::AEK_SVE2BITPERM,
          AArch64::AEK_FP16FML})},
