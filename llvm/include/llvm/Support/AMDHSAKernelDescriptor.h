...
enum : int32_t {
  ...
  COMPUTE_PGM_RSRC1_GFX6_GFX11(ENABLE_DX10_CLAMP, 21, 1), // GFX6-GFX11
  COMPUTE_PGM_RSRC1_GFX12_PLUS(ENABLE_WG_RR_EN, 21, 1),   // GFX12+
  COMPUTE_PGM_RSRC1(DEBUG_MODE, 22, 1),
  COMPUTE_PGM_RSRC1_GFX6_GFX11(ENABLE_IEEE_MODE, 23, 1),  // GFX6-GFX11
  COMPUTE_PGM_RSRC1_GFX12_PLUS(DISABLE_PERF, 23, 1),      // GFX12+
