...
// [GFX121].
#define COMPUTE_PGM_RSRC1_GFX121(NAME, SHIFT, WIDTH) \
  AMDHSA_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC1_GFX121_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
  ...
  COMPUTE_PGM_RSRC1_GFX121(FLAT_SCRATCH_IS_NV, 27, 1),
...
// [GFX121].
#define COMPUTE_PGM_RSRC2_GFX121(NAME, SHIFT, WIDTH) \
  AMDHSA_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC2_GFX121_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
  ...
  COMPUTE_PGM_RSRC2_GFX121(USER_SGPR_COUNT, 1, 6),
...
// [GFX121].
#define COMPUTE_PGM_RSRC3_GFX121(NAME, SHIFT, WIDTH) \
  AMDHSA_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC3_GFX121_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
  ...
  COMPUTE_PGM_RSRC3_GFX121(NAMED_BAR_CNT, 14, 3),
  COMPUTE_PGM_RSRC3_GFX121(ENABLE_DYNAMIC_VGPR, 17, 1),
  COMPUTE_PGM_RSRC3_GFX121(TCP_SPLIT, 18, 3),
  COMPUTE_PGM_RSRC3_GFX121(ENABLE_DIDT_THROTTLE, 21, 1),
