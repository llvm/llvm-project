...
namespace ISD {
  ...
  private:
    ...
    static const uint64_t SwiftSelf      = 1ULL<<13; ///< Swift self parameter
    static const uint64_t SwiftSelfOffs  = 13;
    static const uint64_t SwiftError     = 1ULL<<14; ///< Swift error parameter
    static const uint64_t SwiftErrorOffs = 14;
