...
#ifndef LLVM_TARGET_REGISTERTARGETPASSCONFIGCALLBACK
#define LLVM_TARGET_REGISTERTARGETPASSCONFIGCALLBACK
...
#endif // LLVM_TARGET_REGISTERTARGETPASSCONFIGCALLBACK
