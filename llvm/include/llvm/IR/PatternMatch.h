...
template <typename Op_t, unsigned Opcode> struct LLVM_CLASS_ABI CastOperator_match {
  Op_t Op;
...
template <typename Op_t, unsigned Opcode> struct LLVM_CLASS_ABI CastInst_match {
  Op_t Op;
