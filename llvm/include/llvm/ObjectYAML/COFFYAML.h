...
template <> struct LLVM_CLASS_ABI MappingTraits<object::coff_load_configuration32> {
  static void mapping(IO &IO, object::coff_load_configuration32 &ACT);
};

template <> struct LLVM_CLASS_ABI MappingTraits<object::coff_load_configuration64> {
  static void mapping(IO &IO, object::coff_load_configuration64 &ACT);
};

template <> struct LLVM_CLASS_ABI MappingTraits<object::coff_load_config_code_integrity> {
