...
void initializeNextSiliconImportRecursionLegacyPassPass(PassRegistry &);
void initializeNextSiliconIRFixupLegacyPassPass(PassRegistry &);
void initializeNextSiliconHostAtomicFixupLegacyPassPass(PassRegistry &);
void initializeEmbedSymbolTrackersLegacyPassPass(PassRegistry &);
