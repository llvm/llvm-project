...
template <bool ExtraIteratorBits> struct LLVM_CLASS_ABI ilist_iterator_bits {};
...
struct LLVM_CLASS_ABI extract_iterator_bits<ilist_iterator_bits<IteratorBits>, Options...>
    : std::integral_constant<bool, IteratorBits> {};
template <class Option1, class... Options>
struct LLVM_CLASS_ABI extract_iterator_bits<Option1, Options...>
    : extract_iterator_bits<Options...> {};
template <> struct LLVM_CLASS_ABI extract_iterator_bits<> : std::false_type, is_implicit {};
template <bool IteratorBits>
struct LLVM_CLASS_ABI is_valid_option<ilist_iterator_bits<IteratorBits>> : std::true_type {};
