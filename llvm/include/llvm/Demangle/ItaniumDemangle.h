...
class LLVM_CLASS_ABI TransformedType : public Node {
...
struct LLVM_CLASS_ABI MemberLikeFriendName : Node {
  Node *Qual;
  Node *Name;
...
class LLVM_CLASS_ABI TemplateParamQualifiedArg final : public Node {
  Node *Param;
  Node *Arg;
...
class LLVM_CLASS_ABI ConstrainedTypeTemplateParamDecl final : public Node {
  Node *Constraint;
  Node *Name;
...
class LLVM_CLASS_ABI RequiresExpr : public Node {
...
class LLVM_CLASS_ABI ExprRequirement : public Node {
  const Node *Expr;
  bool IsNoexcept;
...
class LLVM_CLASS_ABI TypeRequirement : public Node {
  const Node *Type;
public:
...
class LLVM_CLASS_ABI NestedRequirement : public Node {
