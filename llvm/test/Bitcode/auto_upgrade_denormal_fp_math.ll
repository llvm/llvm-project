...
; CHECK: attributes #[[ATTR11]] = { denormal_fpenv(dynamic) "denormal-fp-math-f32"="foo,ieee" }
; CHECK: attributes #[[ATTR12]] = { denormal_fpenv(dynamic) "denormal-fp-math"="foo,dynamic" }
