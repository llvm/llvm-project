...
; CHECK: DIVERGENT: %tmp0 = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 1, <16 x i32> %A, i32 2, <16 x i32> %B, i16 0, <8 x float> %C, i32 1, i32 1, i32 1, i32 1, i1 false, i1 false)
define amdgpu_ps void @wmma_scale_f32_16x16x128_f8f6f4(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
bb:
  %tmp0 = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 1, <16 x i32> %A, i32 2, <16 x i32> %B, i16 0, <8 x float> %C, i32 1, i32 1, i32 1, i32 1, i1 false, i1 false)
  store <8 x float> %tmp0, ptr addrspace(1) %out
  ret void
}

; CHECK: DIVERGENT: %tmp0 = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 1, i32 1, i32 1, i32 1, i1 false, i1 false)
define amdgpu_ps void @wmma_scale_bf16_16x16x128_f8f6f4(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
bb:
  %tmp0 = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 1, i32 1, i32 1, i32 1, i1 false, i1 false)
  store <8 x bfloat> %tmp0, ptr addrspace(1) %out
  ret void
}
