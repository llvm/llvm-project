...
; CHECK-NOT: DIVERGENT:   %readlane2 = call i32 @llvm.amdgcn.waterfall.end.i32(i32 %wf_token, i32 %readlane1)
; CHECK-NOT: DIVERGENT:   store i32 %readlane2, ptr addrspace(1) %out, align 4
