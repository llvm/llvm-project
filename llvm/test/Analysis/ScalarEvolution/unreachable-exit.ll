...
define dso_local void @optimize_trap(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @optimize_trap(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; Function Attrs: mustprogress uwtable
define dso_local void @no_optimize_atomic(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_atomic(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
; Function Attrs: mustprogress uwtable
define dso_local void @no_optimize_volatile(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_volatile(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
; Function Attrs: mustprogress uwtable
define dso_local void @no_optimize_call(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_call(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
define dso_local void @optimize_ubsan_trap(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @optimize_ubsan_trap(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
define dso_local void @no_optimize_arbitrary_call(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_arbitrary_call(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
define dso_local void @no_optimize_two_exits(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_two_exits(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
define dso_local void @no_optimize_two_exits2(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_two_exits2(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
...
define dso_local void @no_optimize_depdendent_ubsan_trap(i32 noundef %block_size) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @no_optimize_depdendent_ubsan_trap(
; CHECK-SAME: i32 noundef [[BLOCK_SIZE:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[FOO_ARR:%.*]] = alloca [2 x i8], align 16
; CHECK-NEXT:    [[BAR_ARR:%.*]] = alloca [2 x i8], align 16
