...
; CHECK-NEON-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %8 = urem i64 undef, 2
; CHECK-NEON-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
; CHECK-MVE-LABEL: 'i64'
...
; CHECK-V8R-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %8 = urem i64 undef, 2
; CHECK-V8R-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
