...
; RUN: opt -passes='print<cost-model>' 2>&1 -disable-output -mtriple=amdgpu6.01-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,UNPACKEDID %s
; RUN: opt -passes='print<cost-model>' 2>&1 -disable-output -mtriple=amdgpu9.42-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,PACKEDID %s

; RUN: opt -passes='print<cost-model>' -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu6.01-unknown-amdhsa < %s | FileCheck -check-prefixes=SIZE,SIZE-UNPACKEDID %s
; RUN: opt -passes='print<cost-model>' -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu9.42-unknown-amdhsa < %s | FileCheck -check-prefixes=SIZE,SIZE-PACKEDID %s
