...
; BASE-LABEL: 'exp2_f16'
; BASE-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %f16 = call half @llvm.exp2.f16(half undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 18 for instruction: %v2f16 = call <2 x half> @llvm.exp2.v2f16(<2 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v3f16 = call <3 x half> @llvm.exp2.v3f16(<3 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v4f16 = call <4 x half> @llvm.exp2.v4f16(<4 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v5f16 = call <5 x half> @llvm.exp2.v5f16(<5 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v8f16 = call <8 x half> @llvm.exp2.v8f16(<8 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 144 for instruction: %v16f16 = call <16 x half> @llvm.exp2.v16f16(<16 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 306 for instruction: %v17f16 = call <17 x half> @llvm.exp2.v17f16(<17 x half> undef)
...
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %f16 = call half @llvm.exp2.f16(half undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %v2f16 = call <2 x half> @llvm.exp2.v2f16(<2 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v3f16 = call <3 x half> @llvm.exp2.v3f16(<3 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v4f16 = call <4 x half> @llvm.exp2.v4f16(<4 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v5f16 = call <5 x half> @llvm.exp2.v5f16(<5 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v8f16 = call <8 x half> @llvm.exp2.v8f16(<8 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 112 for instruction: %v16f16 = call <16 x half> @llvm.exp2.v16f16(<16 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 238 for instruction: %v17f16 = call <17 x half> @llvm.exp2.v17f16(<17 x half> undef)
...
; BASE-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %bf16 = call bfloat @llvm.exp2.bf16(bfloat undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 18 for instruction: %v2bf16 = call <2 x bfloat> @llvm.exp2.v2bf16(<2 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v3bf16 = call <3 x bfloat> @llvm.exp2.v3bf16(<3 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v4bf16 = call <4 x bfloat> @llvm.exp2.v4bf16(<4 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v5bf16 = call <5 x bfloat> @llvm.exp2.v5bf16(<5 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v8bf16 = call <8 x bfloat> @llvm.exp2.v8bf16(<8 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 144 for instruction: %v16bf16 = call <16 x bfloat> @llvm.exp2.v16bf16(<16 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 306 for instruction: %v17bf16 = call <17 x bfloat> @llvm.exp2.v17bf16(<17 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
...
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %bf16 = call bfloat @llvm.exp2.bf16(bfloat undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %v2bf16 = call <2 x bfloat> @llvm.exp2.v2bf16(<2 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v3bf16 = call <3 x bfloat> @llvm.exp2.v3bf16(<3 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v4bf16 = call <4 x bfloat> @llvm.exp2.v4bf16(<4 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v5bf16 = call <5 x bfloat> @llvm.exp2.v5bf16(<5 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v8bf16 = call <8 x bfloat> @llvm.exp2.v8bf16(<8 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 112 for instruction: %v16bf16 = call <16 x bfloat> @llvm.exp2.v16bf16(<16 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 238 for instruction: %v17bf16 = call <17 x bfloat> @llvm.exp2.v17bf16(<17 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
...
; ALL-LABEL: 'exp2_f32'
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %f32 = call float @llvm.exp2.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 18 for instruction: %v2f32 = call <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 27 for instruction: %v3f32 = call <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v4f32 = call <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 45 for instruction: %v5f32 = call <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v8f32 = call <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 432 for instruction: %v16f32 = call <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1152 for instruction: %v17f32 = call <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp2_f32'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %f32 = call float @llvm.exp2.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %v2f32 = call <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %v3f32 = call <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v4f32 = call <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 35 for instruction: %v5f32 = call <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v8f32 = call <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 336 for instruction: %v16f32 = call <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 896 for instruction: %v17f32 = call <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
...
; ALL-LABEL: 'exp2_f64'
; ALL-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %f64 = call double @llvm.exp2.f64(double undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %v2f64 = call <2 x double> @llvm.exp2.v2f64(<2 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 240 for instruction: %v3f64 = call <3 x double> @llvm.exp2.v3f64(<3 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 320 for instruction: %v4f64 = call <4 x double> @llvm.exp2.v4f64(<4 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1920 for instruction: %v5f64 = call <5 x double> @llvm.exp2.v5f64(<5 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1920 for instruction: %v8f64 = call <8 x double> @llvm.exp2.v8f64(<8 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 6400 for instruction: %v16f64 = call <16 x double> @llvm.exp2.v16f64(<16 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 8960 for instruction: %v17f64 = call <17 x double> @llvm.exp2.v17f64(<17 x double> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp2_f64'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 40 for instruction: %f64 = call double @llvm.exp2.f64(double undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %v2f64 = call <2 x double> @llvm.exp2.v2f64(<2 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 120 for instruction: %v3f64 = call <3 x double> @llvm.exp2.v3f64(<3 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %v4f64 = call <4 x double> @llvm.exp2.v4f64(<4 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 960 for instruction: %v5f64 = call <5 x double> @llvm.exp2.v5f64(<5 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 960 for instruction: %v8f64 = call <8 x double> @llvm.exp2.v8f64(<8 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 3200 for instruction: %v16f64 = call <16 x double> @llvm.exp2.v16f64(<16 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 4480 for instruction: %v17f64 = call <17 x double> @llvm.exp2.v17f64(<17 x double> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %f32 = call afn float @llvm.exp2.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 18 for instruction: %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 27 for instruction: %v3f32 = call afn <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v4f32 = call afn <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 45 for instruction: %v5f32 = call afn <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %v8f32 = call afn <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 432 for instruction: %v16f32 = call afn <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1152 for instruction: %v17f32 = call afn <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp2_f32_afn_ieee'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %f32 = call afn float @llvm.exp2.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %v3f32 = call afn <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v4f32 = call afn <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 35 for instruction: %v5f32 = call afn <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v8f32 = call afn <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 336 for instruction: %v16f32 = call afn <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 896 for instruction: %v17f32 = call afn <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call afn float @llvm.exp2.f32(float undef)
  %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
  %v3f32 = call afn <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
  %v4f32 = call afn <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
  %v5f32 = call afn <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
  %v8f32 = call afn <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
  %v16f32 = call afn <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
  %v17f32 = call afn <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
  ret void
}

define void @exp2_f32_afn_daz() #1 {
; ALL-LABEL: 'exp2_f32_afn_daz'
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %f32 = call afn float @llvm.exp2.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v3f32 = call afn <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %v4f32 = call afn <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 20 for instruction: %v5f32 = call afn <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %v8f32 = call afn <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 192 for instruction: %v16f32 = call afn <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %v17f32 = call afn <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp2_f32_afn_daz'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %f32 = call afn float @llvm.exp2.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v3f32 = call afn <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %v4f32 = call afn <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: %v5f32 = call afn <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %v8f32 = call afn <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 96 for instruction: %v16f32 = call afn <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 256 for instruction: %v17f32 = call afn <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call afn float @llvm.exp2.f32(float undef)
  %v2f32 = call afn <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %f32 = call float @llvm.exp2.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %v2f32 = call <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %v3f32 = call <3 x float> @llvm.exp2.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %v4f32 = call <4 x float> @llvm.exp2.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 20 for instruction: %v5f32 = call <5 x float> @llvm.exp2.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %v8f32 = call <8 x float> @llvm.exp2.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 192 for instruction: %v16f32 = call <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %v17f32 = call <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
...
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 96 for instruction: %v16f32 = call <16 x float> @llvm.exp2.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 256 for instruction: %v17f32 = call <17 x float> @llvm.exp2.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call float @llvm.exp2.f32(float undef)
  %v2f32 = call <2 x float> @llvm.exp2.v2f32(<2 x float> undef)
