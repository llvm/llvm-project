...
; ALL-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %f32 = call afn float @llvm.sqrt.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v2f32 = call afn <2 x float> @llvm.sqrt.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v3f32 = call afn <3 x float> @llvm.sqrt.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %v4f32 = call afn <4 x float> @llvm.sqrt.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: %v5f32 = call afn <5 x float> @llvm.sqrt.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %v8f32 = call afn <8 x float> @llvm.sqrt.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %v16f32 = call afn <16 x float> @llvm.sqrt.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %v17f32 = call afn <17 x float> @llvm.sqrt.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'sqrt_f32_afn'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %f32 = call afn float @llvm.sqrt.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v2f32 = call afn <2 x float> @llvm.sqrt.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %v3f32 = call afn <3 x float> @llvm.sqrt.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %v4f32 = call afn <4 x float> @llvm.sqrt.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: %v5f32 = call afn <5 x float> @llvm.sqrt.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %v8f32 = call afn <8 x float> @llvm.sqrt.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %v16f32 = call afn <16 x float> @llvm.sqrt.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %v17f32 = call afn <17 x float> @llvm.sqrt.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call afn float @llvm.sqrt.f32(float undef)
  %v2f32 = call afn <2 x float> @llvm.sqrt.v2f32(<2 x float> undef)
  %v3f32 = call afn <3 x float> @llvm.sqrt.v3f32(<3 x float> undef)
  %v4f32 = call afn <4 x float> @llvm.sqrt.v4f32(<4 x float> undef)
  %v5f32 = call afn <5 x float> @llvm.sqrt.v5f32(<5 x float> undef)
  %v8f32 = call afn <8 x float> @llvm.sqrt.v8f32(<8 x float> undef)
  %v16f32 = call afn <16 x float> @llvm.sqrt.v16f32(<16 x float> undef)
  %v17f32 = call afn <17 x float> @llvm.sqrt.v17f32(<17 x float> undef)
  ret void
}
