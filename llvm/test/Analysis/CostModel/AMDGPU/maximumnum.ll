...
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu7.00-unknown-amdhsa < %s | FileCheck -check-prefix=GFX7 %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu8.03-unknown-amdhsa < %s | FileCheck -check-prefix=GFX8 %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu9.00-unknown-amdhsa < %s | FileCheck -check-prefix=GFX9 %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu12.00-unknown-amdhsa < %s | FileCheck -check-prefix=GFX12 %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu12.51-unknown-amdhsa < %s | FileCheck -check-prefix=GFX1251 %s

; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu7.00-unknown-amdhsa < %s | FileCheck -check-prefix=GFX7-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu8.03-unknown-amdhsa < %s | FileCheck -check-prefix=GFX8-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu9.00-unknown-amdhsa -mattr=+half-rate-64-ops < %s | FileCheck -check-prefix=GFX9-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu12.00-unknown-amdhsa < %s | FileCheck -check-prefix=GFX12-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu12.51-unknown-amdhsa < %s | FileCheck -check-prefix=GFX1251-SIZE %s
