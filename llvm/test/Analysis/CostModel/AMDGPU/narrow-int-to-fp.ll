...
; GFX9:  Cost Model: Found an estimated cost of 8 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX9:  Cost Model: Found an estimated cost of 3 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX9:  Cost Model: Found an estimated cost of 8 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
...
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
...
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
...
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 12 for instruction: %as = sitofp <4 x i8> %a to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 4 for instruction: %au = uitofp <4 x i8> %a to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 12 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
...
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 16 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 24 for instruction: %es = sitofp <8 x i8> %e to <8 x half>
;
...
; GFX950:  Cost Model: Found an estimated cost of 8 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX950:  Cost Model: Found an estimated cost of 3 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX950:  Cost Model: Found an estimated cost of 8 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
...
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
...
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 12 for instruction: %as = sitofp <4 x i8> %a to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 4 for instruction: %au = uitofp <4 x i8> %a to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 12 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
...
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 16 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 24 for instruction: %es = sitofp <8 x i8> %e to <8 x half>
;
; GFX6-SIZE-LABEL: 'narrow_lanes_to_fp'
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %as = sitofp <4 x i8> %a to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %au = uitofp <4 x i8> %a to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 6 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 16 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 16 for instruction: %es = sitofp <8 x i8> %e to <8 x half>
;
...
; GFX9-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %bs = sitofp <4 x i12> %b to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %bu = uitofp <4 x i12> %b to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %buf = uitofp <4 x i12> %b to <4 x float>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 3 for instruction: %cu = uitofp <3 x i16> %c to <3 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %ds = sitofp <8 x i16> %d to <8 x half>
...
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %bsf = sitofp <4 x i17> %b to <4 x float>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %buf = uitofp <4 x i17> %b to <4 x float>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %csf = sitofp <4 x i31> %c to <4 x float>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %cuf = uitofp <4 x i31> %c to <4 x float>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 4 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX9:  Cost Model: Found an estimated cost of 3 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX9:  Cost Model: Found an estimated cost of 3 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX9-NOSDWA:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX11-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
...
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX11-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %bsf = sitofp <4 x i17> %b to <4 x float>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %buf = uitofp <4 x i17> %b to <4 x float>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %csf = sitofp <4 x i31> %c to <4 x float>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %cuf = uitofp <4 x i31> %c to <4 x float>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 4 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX950:  Cost Model: Found an estimated cost of 3 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX950:  Cost Model: Found an estimated cost of 3 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX1250-FAKE16:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
...
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX1250-TRUE16:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
...
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
...
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 8 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 6 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX6-SIZE:  Cost Model: Found an estimated cost of 6 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
...
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %ash = sitofp <4 x i16> %a to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %auh = uitofp <4 x i16> %a to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %bsf = sitofp <4 x i17> %b to <4 x float>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %buf = uitofp <4 x i17> %b to <4 x float>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %bsh = sitofp <4 x i17> %b to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %buh = uitofp <4 x i17> %b to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %csf = sitofp <4 x i31> %c to <4 x float>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %cuf = uitofp <4 x i31> %c to <4 x float>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %csh = sitofp <4 x i31> %c to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 4 for instruction: %cuh = uitofp <4 x i31> %c to <4 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 3 for instruction: %dsh = sitofp <3 x i17> %d to <3 x half>
; GFX9-SIZE:  Cost Model: Found an estimated cost of 3 for instruction: %duh = uitofp <3 x i17> %d to <3 x half>
;
