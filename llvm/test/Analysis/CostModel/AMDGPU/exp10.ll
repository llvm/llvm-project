...
; BASE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 42 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 63 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 105 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 1008 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 2688 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; GFX8-LABEL: 'exp10_f32'
; GFX8-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 42 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 63 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 105 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 1008 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 2688 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX8-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; GFX9-LABEL: 'exp10_f32'
; GFX9-NEXT:  Cost Model: Found an estimated cost of 17 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 51 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 85 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 136 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 816 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 2176 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX9-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; GFX10-LABEL: 'exp10_f32'
; GFX10-NEXT:  Cost Model: Found an estimated cost of 17 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 51 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 85 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 136 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 816 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 2176 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX10-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; BASE-SIZE-LABEL: 'exp10_f32'
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 19 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 38 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 57 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 95 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 912 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 2432 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; GFX8-SIZE-LABEL: 'exp10_f32'
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 19 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 38 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 57 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 95 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 912 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 2432 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX8-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; GFX9-SIZE-LABEL: 'exp10_f32'
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 15 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 30 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 45 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 60 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 75 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 120 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 720 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 1920 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX9-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; GFX10-SIZE-LABEL: 'exp10_f32'
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 15 for instruction: %f32 = call float @llvm.exp10.f32(float undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 30 for instruction: %v2f32 = call <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 45 for instruction: %v3f32 = call <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 60 for instruction: %v4f32 = call <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 75 for instruction: %v5f32 = call <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 120 for instruction: %v8f32 = call <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 720 for instruction: %v16f32 = call <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 1920 for instruction: %v17f32 = call <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; GFX10-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %f32 = call afn float @llvm.exp10.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 48 for instruction: %v3f32 = call afn <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %v4f32 = call afn <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %v5f32 = call afn <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 128 for instruction: %v8f32 = call afn <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 768 for instruction: %v16f32 = call afn <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 2048 for instruction: %v17f32 = call afn <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp10_f32_afn_ieee'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %f32 = call afn float @llvm.exp10.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %v3f32 = call afn <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 48 for instruction: %v4f32 = call afn <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 60 for instruction: %v5f32 = call afn <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 96 for instruction: %v8f32 = call afn <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 576 for instruction: %v16f32 = call afn <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1536 for instruction: %v17f32 = call afn <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call afn float @llvm.exp10.f32(float undef)
  %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
  %v3f32 = call afn <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
  %v4f32 = call afn <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
  %v5f32 = call afn <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
  %v8f32 = call afn <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
  %v16f32 = call afn <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
  %v17f32 = call afn <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
  ret void
}

define void @exp10_f32_afn_daz() #1 {
; ALL-LABEL: 'exp10_f32_afn_daz'
; ALL-NEXT:  Cost Model: Found an estimated cost of 11 for instruction: %f32 = call afn float @llvm.exp10.f32(float undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 22 for instruction: %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 33 for instruction: %v3f32 = call afn <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 44 for instruction: %v4f32 = call afn <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 55 for instruction: %v5f32 = call afn <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 88 for instruction: %v8f32 = call afn <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 528 for instruction: %v16f32 = call afn <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1408 for instruction: %v17f32 = call afn <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; ALL-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
; ALL-SIZE-LABEL: 'exp10_f32_afn_daz'
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %f32 = call afn float @llvm.exp10.f32(float undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 14 for instruction: %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %v3f32 = call afn <3 x float> @llvm.exp10.v3f32(<3 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v4f32 = call afn <4 x float> @llvm.exp10.v4f32(<4 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 35 for instruction: %v5f32 = call afn <5 x float> @llvm.exp10.v5f32(<5 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 56 for instruction: %v8f32 = call afn <8 x float> @llvm.exp10.v8f32(<8 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 336 for instruction: %v16f32 = call afn <16 x float> @llvm.exp10.v16f32(<16 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 896 for instruction: %v17f32 = call afn <17 x float> @llvm.exp10.v17f32(<17 x float> undef)
; ALL-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
  %f32 = call afn float @llvm.exp10.f32(float undef)
  %v2f32 = call afn <2 x float> @llvm.exp10.v2f32(<2 x float> undef)
