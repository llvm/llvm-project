...
; BASE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %f16 = call half @llvm.exp10.f16(half undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 42 for instruction: %v2f16 = call <2 x half> @llvm.exp10.v2f16(<2 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v3f16 = call <3 x half> @llvm.exp10.v3f16(<3 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v4f16 = call <4 x half> @llvm.exp10.v4f16(<4 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v5f16 = call <5 x half> @llvm.exp10.v5f16(<5 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v8f16 = call <8 x half> @llvm.exp10.v8f16(<8 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 336 for instruction: %v16f16 = call <16 x half> @llvm.exp10.v16f16(<16 x half> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 714 for instruction: %v17f16 = call <17 x half> @llvm.exp10.v17f16(<17 x half> undef)
...
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 19 for instruction: %f16 = call half @llvm.exp10.f16(half undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 38 for instruction: %v2f16 = call <2 x half> @llvm.exp10.v2f16(<2 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v3f16 = call <3 x half> @llvm.exp10.v3f16(<3 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v4f16 = call <4 x half> @llvm.exp10.v4f16(<4 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v5f16 = call <5 x half> @llvm.exp10.v5f16(<5 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v8f16 = call <8 x half> @llvm.exp10.v8f16(<8 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 304 for instruction: %v16f16 = call <16 x half> @llvm.exp10.v16f16(<16 x half> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 646 for instruction: %v17f16 = call <17 x half> @llvm.exp10.v17f16(<17 x half> undef)
...
; BASE-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %bf16 = call bfloat @llvm.exp10.bf16(bfloat undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 42 for instruction: %v2bf16 = call <2 x bfloat> @llvm.exp10.v2bf16(<2 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v3bf16 = call <3 x bfloat> @llvm.exp10.v3bf16(<3 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 84 for instruction: %v4bf16 = call <4 x bfloat> @llvm.exp10.v4bf16(<4 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v5bf16 = call <5 x bfloat> @llvm.exp10.v5bf16(<5 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 168 for instruction: %v8bf16 = call <8 x bfloat> @llvm.exp10.v8bf16(<8 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 336 for instruction: %v16bf16 = call <16 x bfloat> @llvm.exp10.v16bf16(<16 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 714 for instruction: %v17bf16 = call <17 x bfloat> @llvm.exp10.v17bf16(<17 x bfloat> undef)
; BASE-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: ret void
;
...
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 19 for instruction: %bf16 = call bfloat @llvm.exp10.bf16(bfloat undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 38 for instruction: %v2bf16 = call <2 x bfloat> @llvm.exp10.v2bf16(<2 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v3bf16 = call <3 x bfloat> @llvm.exp10.v3bf16(<3 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 76 for instruction: %v4bf16 = call <4 x bfloat> @llvm.exp10.v4bf16(<4 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v5bf16 = call <5 x bfloat> @llvm.exp10.v5bf16(<5 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v8bf16 = call <8 x bfloat> @llvm.exp10.v8bf16(<8 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 304 for instruction: %v16bf16 = call <16 x bfloat> @llvm.exp10.v16bf16(<16 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 646 for instruction: %v17bf16 = call <17 x bfloat> @llvm.exp10.v17bf16(<17 x bfloat> undef)
; BASE-SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
