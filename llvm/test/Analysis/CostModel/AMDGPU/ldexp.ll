...
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu7.01-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,GFX7 %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu8.02-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,GFX8PLUS %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu9.00-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,GFX8PLUS %s
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=amdgpu10.30-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL,GFX8PLUS %s

; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu7.01-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL-SIZE,GFX7-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu8.02-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL-SIZE,GFX8PLUS-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu9.00-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL-SIZE,GFX8PLUS-SIZE %s
; RUN: opt -passes="print<cost-model>" -cost-kind=code-size 2>&1 -disable-output -mtriple=amdgpu10.30-unknown-amdhsa < %s | FileCheck -check-prefixes=ALL-SIZE,GFX8PLUS-SIZE %s
