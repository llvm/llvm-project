...
;
; AVX2-LABEL: 'pdep_i8'
; AVX2-NEXT:  Cost Model: Found costs of 1 for: %I8 = call i8 @llvm.pdep.i8(i8 undef, i8 undef)
; AVX2-NEXT:  Cost Model: Found costs of 32 for: %V16I8 = call <16 x i8> @llvm.pdep.v16i8(<16 x i8> undef, <16 x i8> undef)
; AVX2-NEXT:  Cost Model: Found costs of 65 for: %V32I8 = call <32 x i8> @llvm.pdep.v32i8(<32 x i8> undef, <32 x i8> undef)
; AVX2-NEXT:  Cost Model: Found costs of 130 for: %V64I8 = call <64 x i8> @llvm.pdep.v64i8(<64 x i8> undef, <64 x i8> undef)
; AVX2-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret i32 undef
;
; AVX512-LABEL: 'pdep_i8'
; AVX512-NEXT:  Cost Model: Found costs of 1 for: %I8 = call i8 @llvm.pdep.i8(i8 undef, i8 undef)
; AVX512-NEXT:  Cost Model: Found costs of 32 for: %V16I8 = call <16 x i8> @llvm.pdep.v16i8(<16 x i8> undef, <16 x i8> undef)
; AVX512-NEXT:  Cost Model: Found costs of 65 for: %V32I8 = call <32 x i8> @llvm.pdep.v32i8(<32 x i8> undef, <32 x i8> undef)
; AVX512-NEXT:  Cost Model: Found costs of 131 for: %V64I8 = call <64 x i8> @llvm.pdep.v64i8(<64 x i8> undef, <64 x i8> undef)
; AVX512-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret i32 undef
;
  %I8 = call i8 @llvm.pdep.i8(i8 undef, i8 undef)
  %V16I8 = call <16 x i8> @llvm.pdep.v16i8(<16 x i8> undef, <16 x i8> undef)
  %V32I8 = call <32 x i8> @llvm.pdep.v32i8(<32 x i8> undef, <32 x i8> undef)
  %V64I8 = call <64 x i8> @llvm.pdep.v64i8(<64 x i8> undef, <64 x i8> undef)
...
;
; AVX2-LABEL: 'pdep_i16'
; AVX2-NEXT:  Cost Model: Found costs of 1 for: %I16 = call i16 @llvm.pdep.i16(i16 undef, i16 undef)
; AVX2-NEXT:  Cost Model: Found costs of 16 for: %V8I16 = call <8 x i16> @llvm.pdep.v8i16(<8 x i16> undef, <8 x i16> undef)
; AVX2-NEXT:  Cost Model: Found costs of 33 for: %V16I16 = call <16 x i16> @llvm.pdep.v16i16(<16 x i16> undef, <16 x i16> undef)
; AVX2-NEXT:  Cost Model: Found costs of 66 for: %V32I16 = call <32 x i16> @llvm.pdep.v32i16(<32 x i16> undef, <32 x i16> undef)
; AVX2-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret i32 undef
;
; AVX512-LABEL: 'pdep_i16'
; AVX512-NEXT:  Cost Model: Found costs of 1 for: %I16 = call i16 @llvm.pdep.i16(i16 undef, i16 undef)
; AVX512-NEXT:  Cost Model: Found costs of 16 for: %V8I16 = call <8 x i16> @llvm.pdep.v8i16(<8 x i16> undef, <8 x i16> undef)
; AVX512-NEXT:  Cost Model: Found costs of 33 for: %V16I16 = call <16 x i16> @llvm.pdep.v16i16(<16 x i16> undef, <16 x i16> undef)
; AVX512-NEXT:  Cost Model: Found costs of 67 for: %V32I16 = call <32 x i16> @llvm.pdep.v32i16(<32 x i16> undef, <32 x i16> undef)
; AVX512-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret i32 undef
;
  %I16 = call i16 @llvm.pdep.i16(i16 undef, i16 undef)
  %V8I16  = call <8 x i16>  @llvm.pdep.v8i16(<8 x i16> undef, <8 x i16> undef)
  %V16I16 = call <16 x i16> @llvm.pdep.v16i16(<16 x i16> undef, <16 x i16> undef)
  %V32I16 = call <32 x i16> @llvm.pdep.v32i16(<32 x i16> undef, <32 x i16> undef)
...
; AVX512-NEXT:  Cost Model: Found costs of 8 for: %V4I32 = call <4 x i32> @llvm.pdep.v4i32(<4 x i32> undef, <4 x i32> undef)
...
;
  ...
  %V8I32  = call <8 x i32>  @llvm.pdep.v8i32(<8 x i32> undef, <8 x i32> undef)
  %V16I32 = call <16 x i32> @llvm.pdep.v16i32(<16 x i32> undef, <16 x i32> undef)
...
; AVX512-NEXT:  Cost Model: Found costs of 4 for: %V2I64 = call <2 x i64> @llvm.pdep.v2i64(<2 x i64> undef, <2 x i64> undef)
; AVX512-NEXT:  Cost Model: Found costs of 9 for: %V4I64 = call <4 x i64> @llvm.pdep.v4i64(<4 x i64> undef, <4 x i64> undef)
...
;
  ...
  %V8I64 = call <8 x i64> @llvm.pdep.v8i64(<8 x i64> undef, <8 x i64> undef)
