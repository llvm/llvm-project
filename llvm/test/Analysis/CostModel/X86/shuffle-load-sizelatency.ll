...
; RUN: opt < %s -mtriple=x86_64-unknown-linux-gnu -passes="print<cost-model>" 2>&1 -disable-output -cost-kind=size-latency -mattr=+sse3 | FileCheck %s -check-prefixes=SSE3
; RUN: opt < %s -mtriple=x86_64-unknown-linux-gnu -passes="print<cost-model>" 2>&1 -disable-output -cost-kind=size-latency -mattr=+sse3 | FileCheck %s -check-prefixes=AVX
; RUN: opt < %s -mtriple=x86_64-unknown-linux-gnu -passes="print<cost-model>" 2>&1 -disable-output -cost-kind=size-latency -mattr=+sse3 | FileCheck %s -check-prefixes=AVX2
; RUN: opt < %s -mtriple=x86_64-unknown-linux-gnu -passes="print<cost-model>" 2>&1 -disable-output -cost-kind=size-latency -mattr=+sse3 | FileCheck %s -check-prefixes=AVX512
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; SSE3-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; AVX2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi8 = load <32 x i8>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_64xi8 = load <64 x i8>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi16 = load <16 x i16>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xi16 = load <32 x i16>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi32 = load <8 x i32>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xi32 = load <16 x i32>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xi64 = load <4 x i64>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xi64 = load <8 x i64>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_2xf16 = load <2 x half>, ptr undef, align 4
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf16 = load <4 x half>, ptr undef, align 8
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf16 = load <16 x half>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_32xf16 = load <32 x half>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf32 = load <8 x float>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_16xf32 = load <16 x float>, ptr undef, align 64
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_4xf64 = load <4 x double>, ptr undef, align 32
...
; AVX512-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %ld_8xf64 = load <8 x double>, ptr undef, align 64
