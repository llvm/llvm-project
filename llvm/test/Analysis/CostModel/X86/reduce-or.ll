...
; AVX512F-NEXT:  Cost Model: Found costs of RThru:1 CodeSize:1 Lat:2 SizeLat:1 for: %V1 = call i1 @llvm.vector.reduce.or.v1i1(<1 x i1> undef)
...
; AVX512BW-NEXT:  Cost Model: Found costs of RThru:1 CodeSize:1 Lat:2 SizeLat:1 for: %V1 = call i1 @llvm.vector.reduce.or.v1i1(<1 x i1> undef)
...
; AVX512DQ-NEXT:  Cost Model: Found costs of RThru:1 CodeSize:1 Lat:2 SizeLat:1 for: %V1 = call i1 @llvm.vector.reduce.or.v1i1(<1 x i1> undef)
