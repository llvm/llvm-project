...
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v17 = fptosi <2 x double> undef to <2 x i32>
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v18 = fptosi <2 x double> undef to <2 x i16>
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v19 = fptosi <2 x double> undef to <2 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 6 for instruction:   %v22 = fptosi <2 x float> undef to <2 x i16>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v22 = fptosi <2 x float> undef to <2 x i16>
; Z13:   Cost Model: Found an estimated cost of 6 for instruction:   %v23 = fptosi <2 x float> undef to <2 x i8>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v23 = fptosi <2 x float> undef to <2 x i8>
...
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v29 = fptosi <4 x double> undef to <4 x i32>
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v30 = fptosi <4 x double> undef to <4 x i16>
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v31 = fptosi <4 x double> undef to <4 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 12 for instruction:  %v34 = fptosi <4 x float> undef to <4 x i16>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v34 = fptosi <4 x float> undef to <4 x i16>
; Z13:   Cost Model: Found an estimated cost of 12 for instruction:  %v35 = fptosi <4 x float> undef to <4 x i8>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v35 = fptosi <4 x float> undef to <4 x i8>
...
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v41 = fptosi <8 x double> undef to <8 x i32>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v42 = fptosi <8 x double> undef to <8 x i16>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v43 = fptosi <8 x double> undef to <8 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 24 for instruction:   %v46 = fptosi <8 x float> undef to <8 x i16>
; Z15:   Cost Model: Found an estimated cost of 4 for instruction:    %v46 = fptosi <8 x float> undef to <8 x i16>
; Z13:   Cost Model: Found an estimated cost of 24 for instruction:   %v47 = fptosi <8 x float> undef to <8 x i8>
; Z15:   Cost Model: Found an estimated cost of 4 for instruction:    %v47 = fptosi <8 x float> undef to <8 x i8>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v48 = fptosi <16 x double> undef to <16 x i64>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v49 = fptosi <16 x double> undef to <16 x i32>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v50 = fptosi <16 x double> undef to <16 x i16>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v51 = fptosi <16 x double> undef to <16 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 48 for instruction:   %v54 = fptosi <16 x float> undef to <16 x i16>
; Z15:   Cost Model: Found an estimated cost of 8 for instruction:    %v54 = fptosi <16 x float> undef to <16 x i16>
; Z13:   Cost Model: Found an estimated cost of 48 for instruction:   %v55 = fptosi <16 x float> undef to <16 x i8>
; Z15:   Cost Model: Found an estimated cost of 8 for instruction:    %v55 = fptosi <16 x float> undef to <16 x i8>
...
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v17 = fptoui <2 x double> undef to <2 x i32>
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v18 = fptoui <2 x double> undef to <2 x i16>
; CHECK: Cost Model: Found an estimated cost of 2 for instruction:   %v19 = fptoui <2 x double> undef to <2 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 6 for instruction:   %v22 = fptoui <2 x float> undef to <2 x i16>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v22 = fptoui <2 x float> undef to <2 x i16>
; Z13:   Cost Model: Found an estimated cost of 6 for instruction:   %v23 = fptoui <2 x float> undef to <2 x i8>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v23 = fptoui <2 x float> undef to <2 x i8>
...
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v29 = fptoui <4 x double> undef to <4 x i32>
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v30 = fptoui <4 x double> undef to <4 x i16>
; CHECK: Cost Model: Found an estimated cost of 4 for instruction:   %v31 = fptoui <4 x double> undef to <4 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 12 for instruction:   %v34 = fptoui <4 x float> undef to <4 x i16>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v34 = fptoui <4 x float> undef to <4 x i16>
; Z13:   Cost Model: Found an estimated cost of 12 for instruction:   %v35 = fptoui <4 x float> undef to <4 x i8>
; Z15:   Cost Model: Found an estimated cost of 2 for instruction:   %v35 = fptoui <4 x float> undef to <4 x i8>
...
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v41 = fptoui <8 x double> undef to <8 x i32>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v42 = fptoui <8 x double> undef to <8 x i16>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v43 = fptoui <8 x double> undef to <8 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 24 for instruction:   %v46 = fptoui <8 x float> undef to <8 x i16>
; Z15:   Cost Model: Found an estimated cost of 4 for instruction:   %v46 = fptoui <8 x float> undef to <8 x i16>
; Z13:   Cost Model: Found an estimated cost of 24 for instruction:   %v47 = fptoui <8 x float> undef to <8 x i8>
; Z15:   Cost Model: Found an estimated cost of 4 for instruction:   %v47 = fptoui <8 x float> undef to <8 x i8>
; CHECK: Cost Model: Found an estimated cost of 8 for instruction:   %v48 = fptoui <16 x double> undef to <16 x i64>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v49 = fptoui <16 x double> undef to <16 x i32>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v50 = fptoui <16 x double> undef to <16 x i16>
; CHECK: Cost Model: Found an estimated cost of 16 for instruction:   %v51 = fptoui <16 x double> undef to <16 x i8>
...
; Z13:   Cost Model: Found an estimated cost of 48 for instruction:   %v54 = fptoui <16 x float> undef to <16 x i16>
; Z15:   Cost Model: Found an estimated cost of 8 for instruction:   %v54 = fptoui <16 x float> undef to <16 x i16>
; Z13:   Cost Model: Found an estimated cost of 48 for instruction:   %v55 = fptoui <16 x float> undef to <16 x i8>
; Z15:   Cost Model: Found an estimated cost of 8 for instruction:   %v55 = fptoui <16 x float> undef to <16 x i8>
