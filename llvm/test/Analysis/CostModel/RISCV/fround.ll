...
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 18 for instruction: %2 = call <2 x half> @llvm.trunc.v2f16(<2 x half> undef)
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 36 for instruction: %3 = call <4 x half> @llvm.trunc.v4f16(<4 x half> undef)
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 72 for instruction: %4 = call <8 x half> @llvm.trunc.v8f16(<8 x half> undef)
...
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 21 for instruction: %1 = call <2 x half> @llvm.vp.roundtozero.v2f16(<2 x half> undef, <2 x i1> undef, i32 undef)
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 43 for instruction: %2 = call <4 x half> @llvm.vp.roundtozero.v4f16(<4 x half> undef, <4 x i1> undef, i32 undef)
; ZVFHMIN-NEXT:  Cost Model: Found an estimated cost of 87 for instruction: %3 = call <8 x half> @llvm.vp.roundtozero.v8f16(<8 x half> undef, <8 x i1> undef, i32 undef)
