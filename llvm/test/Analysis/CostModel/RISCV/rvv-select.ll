...
; RUN: opt -passes="print<cost-model>" 2>&1 -disable-output -mtriple=riscv64 -mattr=+v,+f,+d,+zfh,+zvfh -intrinsic-cost-strategy=type-based-intrinsic-cost < %s | FileCheck %s
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %7 = select i1 undef, <32 x i1> undef, <32 x i1> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %13 = select <32 x i1> undef, <32 x i1> undef, <32 x i1> undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %31 = call <32 x i1> @llvm.vp.select.v32i1(<32 x i1> undef, <32 x i1> undef, <32 x i1> undef, i32 undef)
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %6 = call <32 x i1> @llvm.vp.merge.v32i1(<32 x i1> undef, <32 x i1> undef, <32 x i1> undef, i32 undef)
