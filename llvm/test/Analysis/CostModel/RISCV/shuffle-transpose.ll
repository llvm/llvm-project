...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i32> %v0, <2 x i32> %v1, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i32> %tmp0
;
; SIZE-LABEL: 'trn1.v2i32'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i32> %v0, <2 x i32> %v1, <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i32> %v0, <2 x i32> %v1, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i32> %tmp0
;
; SIZE-LABEL: 'trn2.v2i32'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i32> %v0, <2 x i32> %v1, <2 x i32> <i32 1, i32 3>
; SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x i32> %tmp0
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i64> %v0, <2 x i64> %v1, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp0
;
; SIZE-LABEL: 'trn1.v2i64'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i64> %v0, <2 x i64> %v1, <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i64> %v0, <2 x i64> %v1, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x i64> %tmp0
;
; SIZE-LABEL: 'trn2.v2i64'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x i64> %v0, <2 x i64> %v1, <2 x i32> <i32 1, i32 3>
; SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x i64> %tmp0
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x float> %v0, <2 x float> %v1, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x float> %tmp0
;
; SIZE-LABEL: 'trn1.v2f32'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x float> %v0, <2 x float> %v1, <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x float> %v0, <2 x float> %v1, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x float> %tmp0
;
; SIZE-LABEL: 'trn2.v2f32'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x float> %v0, <2 x float> %v1, <2 x i32> <i32 1, i32 3>
; SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x float> %tmp0
;
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x double> %v0, <2 x double> %v1, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x double> %tmp0
;
; SIZE-LABEL: 'trn1.v2f64'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x double> %v0, <2 x double> %v1, <2 x i32> <i32 0, i32 2>
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x double> %v0, <2 x double> %v1, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret <2 x double> %tmp0
;
; SIZE-LABEL: 'trn2.v2f64'
; SIZE-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %tmp0 = shufflevector <2 x double> %v0, <2 x double> %v1, <2 x i32> <i32 1, i32 3>
; SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x double> %tmp0
;
