...
; CHECK-NEXT:  Cost Model: Found costs of RThru:10 CodeSize:7 Lat:10 SizeLat:10 for: %v4half = select <4 x i1> undef, <4 x half> undef, <4 x half> undef
; CHECK-NEXT:  Cost Model: Found costs of RThru:22 CodeSize:15 Lat:22 SizeLat:22 for: %v8half = select <8 x i1> undef, <8 x half> undef, <8 x half> undef
