...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:1 Lat:3 SizeLat:1 for: %V2F128 = fadd <vscale x 2 x fp128> poison, poison
...
;
  ...
  %V2F128 = fadd <vscale x 2 x fp128> poison, poison
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:1 Lat:3 SizeLat:1 for: %V2F128 = fsub <vscale x 2 x fp128> poison, poison
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = fsub <vscale x 2 x fp128> poison, poison
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:1 Lat:3 SizeLat:1 for: %V2F128 = fneg <vscale x 2 x fp128> poison
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = fneg <vscale x 2 x fp128> poison
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:1 Lat:3 SizeLat:1 for: %V2F128 = fmul <vscale x 2 x fp128> poison, poison
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = fmul <vscale x 2 x fp128> poison, poison
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:4 Lat:4 SizeLat:4 for: %V2F128 = fdiv <vscale x 2 x fp128> poison, poison
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = fdiv <vscale x 2 x fp128> poison, poison
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:Invalid CodeSize:4 Lat:4 SizeLat:4 for: %V2F128 = frem <vscale x 2 x fp128> poison, poison
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = frem <vscale x 2 x fp128> poison, poison
...
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %V2F128 = call <vscale x 2 x fp128> @llvm.fma.nxv2f128(<vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison)
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = call <vscale x 2 x fp128> @llvm.fma.v2f128(<vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison)
...
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %V2F128 = call <vscale x 2 x fp128> @llvm.fmuladd.nxv2f128(<vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison)
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
  ...
  %V2F128 = call <vscale x 2 x fp128> @llvm.fmuladd.v2f128(<vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison, <vscale x 2 x fp128> poison)
