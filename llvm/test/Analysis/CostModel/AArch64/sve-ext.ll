...
; CHECK-NEXT:  Cost Model: Found costs of 2 for: %zext_nxv8_i16_to_i32 = zext <vscale x 8 x i16> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 6 for: %zext_nxv8_i16_to_i64 = zext <vscale x 8 x i16> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 2 for: %zext_nxv4_i32_to_i64 = zext <vscale x 4 x i32> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %zext_nxv4_i8_to_i64 = zext <vscale x 4 x i8> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %zext_nxv8_i8_to_i32 = zext <vscale x 8 x i8> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %zext_nxv4_i16_to_i64 = zext <vscale x 4 x i16> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %zext_nxv8_i8_to_i64 = zext <vscale x 8 x i8> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 2 for: %sext_nxv16_i8_to_i16 = sext <vscale x 16 x i8> poison to <vscale x 16 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 6 for: %sext_nxv16_i8_to_i32 = sext <vscale x 16 x i8> poison to <vscale x 16 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 14 for: %sext_nxv16_i8_to_i64 = sext <vscale x 16 x i8> poison to <vscale x 16 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 2 for: %sext_nxv8_i16_to_i32 = sext <vscale x 8 x i16> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 6 for: %sext_nxv8_i16_to_i64 = sext <vscale x 8 x i16> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 2 for: %sext_nxv4_i32_to_i64 = sext <vscale x 4 x i32> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sext_nxv4_i8_to_i64 = sext <vscale x 4 x i8> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sext_nxv8_i8_to_i32 = sext <vscale x 8 x i8> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sext_nxv4_i16_to_i64 = sext <vscale x 4 x i16> poison to <vscale x 4 x i64>
