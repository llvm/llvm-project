...
define void @cmps() {
; CHECK-LABEL: 'cmps'
; CHECK-NEXT:  Cost Model: Found costs of 1 for: %c8 = icmp slt i8 undef, undef
...
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %cfv816 = fcmp olt <8 x half> undef, undef
...
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %cbfv816 = fcmp olt <8 x bfloat> undef, undef
...
define void @andcmp() {
; CHECK-LABEL: 'andcmp'
; CHECK-NEXT:  Cost Model: Found costs of 1 for: %a8 = and i8 undef, undef
; CHECK-NEXT:  Cost Model: Found costs of 1 for: %c8 = icmp eq i8 %a8, 0
...
; CHECK-NEXT:  Cost Model: Found costs of 1 for: %cv8i16 = icmp eq <8 x i16> %av8i16, zeroinitializer
...
define void @uscmp() {
; CHECK-LABEL: 'uscmp'
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %u8 = call i8 @llvm.ucmp.i8.i8(i8 undef, i8 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %u16 = call i16 @llvm.ucmp.i16.i16(i16 undef, i16 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %u32 = call i32 @llvm.ucmp.i32.i32(i32 undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %u64 = call i64 @llvm.ucmp.i64.i64(i64 undef, i64 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %uv16i8 = call <16 x i8> @llvm.ucmp.v16i8.v16i8(<16 x i8> undef, <16 x i8> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %uv8i16 = call <8 x i16> @llvm.ucmp.v8i16.v8i16(<8 x i16> undef, <8 x i16> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %uv4i32 = call <4 x i32> @llvm.ucmp.v4i32.v4i32(<4 x i32> undef, <4 x i32> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %uv2i64 = call <2 x i64> @llvm.ucmp.v2i64.v2i64(<2 x i64> undef, <2 x i64> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %s8 = call i8 @llvm.scmp.i8.i8(i8 undef, i8 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %s16 = call i16 @llvm.scmp.i16.i16(i16 undef, i16 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %s32 = call i32 @llvm.scmp.i32.i32(i32 undef, i32 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %s64 = call i64 @llvm.scmp.i64.i64(i64 undef, i64 undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sv16i8 = call <16 x i8> @llvm.scmp.v16i8.v16i8(<16 x i8> undef, <16 x i8> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sv8i16 = call <8 x i16> @llvm.scmp.v8i16.v8i16(<8 x i16> undef, <8 x i16> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sv4i32 = call <4 x i32> @llvm.scmp.v4i32.v4i32(<4 x i32> undef, <4 x i32> undef)
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %sv2i64 = call <2 x i64> @llvm.scmp.v2i64.v2i64(<2 x i64> undef, <2 x i64> undef)
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
