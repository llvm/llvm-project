...
; VSCALE-1-2-4-LABEL: 'reduce_fadd_strict_128b_types'
; VSCALE-1-2-4-NEXT:  Cost Model: Found costs of RThru:30 CodeSize:23 Lat:46 SizeLat:30 for: %fadd_v8f16 = call half @llvm.vector.reduce.fadd.v8f16(half 0.000000e+00, <8 x half> poison)
; VSCALE-1-2-4-NEXT:  Cost Model: Found costs of RThru:110 CodeSize:23 Lat:46 SizeLat:30 for: %fadd_v8bf16 = call bfloat @llvm.vector.reduce.fadd.v8bf16(bfloat 0.000000e+00, <8 x bfloat> poison)
; VSCALE-1-2-4-NEXT:  Cost Model: Found costs of RThru:14 CodeSize:11 Lat:22 SizeLat:14 for: %fadd_v4f32 = call float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> poison)
; VSCALE-1-2-4-NEXT:  Cost Model: Found costs of RThru:6 CodeSize:5 Lat:10 SizeLat:6 for: %fadd_v2f64 = call double @llvm.vector.reduce.fadd.v2f64(double 0.000000e+00, <2 x double> poison)
...
;
; VSCALE-2-4-LABEL: 'reduce_fadd_strict_256b_types'
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:62 CodeSize:47 Lat:94 SizeLat:62 for: %fadd_v16f16 = call half @llvm.vector.reduce.fadd.v16f16(half 0.000000e+00, <16 x half> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:220 CodeSize:46 Lat:92 SizeLat:60 for: %fadd_v16bf16 = call bfloat @llvm.vector.reduce.fadd.v16bf16(bfloat 0.000000e+00, <16 x bfloat> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:30 CodeSize:23 Lat:46 SizeLat:30 for: %fadd_v8f32 = call float @llvm.vector.reduce.fadd.v8f32(float 0.000000e+00, <8 x float> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:14 CodeSize:11 Lat:22 SizeLat:14 for: %fadd_v4f64 = call double @llvm.vector.reduce.fadd.v4f64(double 0.000000e+00, <4 x double> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:22 CodeSize:4 Lat:8 SizeLat:4 for: %fadd_v2f128 = call fp128 @llvm.vector.reduce.fadd.v2f128(fp128 poison, <2 x fp128> poison)
...
;
; VSCALE-4-LABEL: 'reduce_fadd_strict_512b_types'
...
; VSCALE-1-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
; VSCALE-2-4-LABEL: 'reduce_fadd_fast_128b_types'
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 3 for: %fadd_v8f16 = call fast half @llvm.vector.reduce.fadd.v8f16(half 0.000000e+00, <8 x half> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:57 CodeSize:27 Lat:33 SizeLat:27 for: %fadd_v8bf16 = call fast bfloat @llvm.vector.reduce.fadd.v8bf16(bfloat 0.000000e+00, <8 x bfloat> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 2 for: %fadd_v4f32 = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 1 for: %fadd_v2f64 = call fast double @llvm.vector.reduce.fadd.v2f64(double 0.000000e+00, <2 x double> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
...
; VSCALE-1-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
; VSCALE-2-4-LABEL: 'reduce_fadd_fast_256b_types'
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 2 for: %fadd_v16f16 = call fast half @llvm.vector.reduce.fadd.v16f16(half 0.000000e+00, <16 x half> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:84 CodeSize:44 Lat:52 SizeLat:44 for: %fadd_v16bf16 = call fast bfloat @llvm.vector.reduce.fadd.v16bf16(bfloat 0.000000e+00, <16 x bfloat> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 2 for: %fadd_v8f32 = call fast float @llvm.vector.reduce.fadd.v8f32(float 0.000000e+00, <8 x float> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of 2 for: %fadd_v4f64 = call fast double @llvm.vector.reduce.fadd.v4f64(double 0.000000e+00, <4 x double> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:10 CodeSize:1 Lat:3 SizeLat:1 for: %fadd_v2f128 = call fast fp128 @llvm.vector.reduce.fadd.v2f128(fp128 poison, <2 x fp128> poison)
; VSCALE-2-4-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
...
; VSCALE-2-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
; VSCALE-4-LABEL: 'reduce_fadd_fast_512b_types'
