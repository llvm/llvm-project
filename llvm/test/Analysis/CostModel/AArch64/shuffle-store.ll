...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:1 Lat:1 SizeLat:1 for: store <6 x i8> %v8i8, ptr %p, align 8
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:1 Lat:1 SizeLat:1 for: store <12 x i8> %v16i8, ptr %p, align 16
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:4 Lat:1 SizeLat:4 for: store <48 x i8> %v64i8, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:1 Lat:1 SizeLat:1 for: store <6 x i16> %v8i16, ptr %p, align 16
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:4 Lat:1 SizeLat:4 for: store <24 x i16> %v32i16, ptr %p, align 64
; CHECK-NEXT:  Cost Model: Found costs of 8 for: %v64i16 = shufflevector <32 x i16> undef, <32 x i16> undef, <48 x i32> <i32 0, i32 16, i32 32, i32 1, i32 17, i32 33, i32 2, i32 18, i32 34, i32 3, i32 19, i32 35, i32 4, i32 20, i32 36, i32 5, i32 21, i32 37, i32 6, i32 22, i32 38, i32 7, i32 23, i32 39, i32 8, i32 24, i32 40, i32 9, i32 25, i32 41, i32 10, i32 26, i32 42, i32 11, i32 27, i32 43, i32 12, i32 28, i32 44, i32 13, i32 29, i32 45, i32 14, i32 30, i32 46, i32 15, i32 31, i32 47>
; CHECK-NEXT:  Cost Model: Found costs of RThru:6 CodeSize:8 Lat:1 SizeLat:8 for: store <48 x i16> %v64i16, ptr %p, align 128
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:4 Lat:1 SizeLat:4 for: store <12 x i32> %v16i32, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:6 CodeSize:8 Lat:1 SizeLat:8 for: store <24 x i32> %v32i32, ptr %p, align 128
; CHECK-NEXT:  Cost Model: Found costs of 16 for: %v64i32 = shufflevector <32 x i32> undef, <32 x i32> undef, <48 x i32> <i32 0, i32 16, i32 32, i32 1, i32 17, i32 33, i32 2, i32 18, i32 34, i32 3, i32 19, i32 35, i32 4, i32 20, i32 36, i32 5, i32 21, i32 37, i32 6, i32 22, i32 38, i32 7, i32 23, i32 39, i32 8, i32 24, i32 40, i32 9, i32 25, i32 41, i32 10, i32 26, i32 42, i32 11, i32 27, i32 43, i32 12, i32 28, i32 44, i32 13, i32 29, i32 45, i32 14, i32 30, i32 46, i32 15, i32 31, i32 47>
; CHECK-NEXT:  Cost Model: Found costs of RThru:12 CodeSize:16 Lat:1 SizeLat:16 for: store <48 x i32> %v64i32, ptr %p, align 256
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:3 CodeSize:4 Lat:1 SizeLat:4 for: store <6 x i64> %v8i64, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:6 CodeSize:8 Lat:1 SizeLat:8 for: store <12 x i64> %v16i64, ptr %p, align 128
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:12 CodeSize:16 Lat:1 SizeLat:16 for: store <24 x i64> %v32i64, ptr %p, align 256
; CHECK-NEXT:  Cost Model: Found costs of 32 for: %v64i64 = shufflevector <32 x i64> undef, <32 x i64> undef, <48 x i32> <i32 0, i32 16, i32 32, i32 1, i32 17, i32 33, i32 2, i32 18, i32 34, i32 3, i32 19, i32 35, i32 4, i32 20, i32 36, i32 5, i32 21, i32 37, i32 6, i32 22, i32 38, i32 7, i32 23, i32 39, i32 8, i32 24, i32 40, i32 9, i32 25, i32 41, i32 10, i32 26, i32 42, i32 11, i32 27, i32 43, i32 12, i32 28, i32 44, i32 13, i32 29, i32 45, i32 14, i32 30, i32 46, i32 15, i32 31, i32 47>
; CHECK-NEXT:  Cost Model: Found costs of RThru:24 CodeSize:32 Lat:1 SizeLat:32 for: store <48 x i64> %v64i64, ptr %p, align 512
; CHECK-NEXT:  Cost Model: Found costs of RThru:0 CodeSize:1 Lat:1 SizeLat:1 for: ret void
;
