...
; CHECK-NEXT:  Cost Model: Found costs of RThru:4 CodeSize:4 Lat:7 SizeLat:4 for: %v16i8 = load <48 x i8>, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:4 CodeSize:4 Lat:7 SizeLat:4 for: %v8i16 = load <24 x i16>, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:8 CodeSize:8 Lat:11 SizeLat:8 for: %v16i16 = load <48 x i16>, ptr %p, align 128
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:4 CodeSize:4 Lat:7 SizeLat:4 for: %v4i32 = load <12 x i32>, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:8 CodeSize:8 Lat:11 SizeLat:8 for: %v8i32 = load <24 x i32>, ptr %p, align 128
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:16 CodeSize:16 Lat:19 SizeLat:16 for: %v16i32 = load <48 x i32>, ptr %p, align 256
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:4 CodeSize:4 Lat:7 SizeLat:4 for: %v2i64 = load <6 x i64>, ptr %p, align 64
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:8 CodeSize:8 Lat:11 SizeLat:8 for: %v4i64 = load <12 x i64>, ptr %p, align 128
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:16 CodeSize:16 Lat:19 SizeLat:16 for: %v8i64 = load <24 x i64>, ptr %p, align 256
...
; CHECK-NEXT:  Cost Model: Found costs of RThru:32 CodeSize:32 Lat:35 SizeLat:32 for: %v16i64 = load <48 x i64>, ptr %p, align 512
