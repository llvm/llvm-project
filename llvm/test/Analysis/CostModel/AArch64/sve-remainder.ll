...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 66 for instruction: %legal_type_urem_0 = urem <vscale x 16 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %legal_type_urem_1 = urem <vscale x 8 x i16> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 66 for instruction: %legal_type_srem_0 = srem <vscale x 16 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 34 for instruction: %legal_type_srem_1 = srem <vscale x 8 x i16> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 132 for instruction: %split_type_urem_0 = urem <vscale x 32 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %split_type_urem_1 = urem <vscale x 16 x i16> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 132 for instruction: %split_type_srem_0 = srem <vscale x 32 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %split_type_srem_1 = srem <vscale x 16 x i16> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 132 for instruction: %widen_type_urem_0 = urem <vscale x 31 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %widen_type_urem_1 = urem <vscale x 15 x i16> undef, undef
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 132 for instruction: %widen_type_srem_0 = srem <vscale x 31 x i8> undef, undef
; CHECK-NEXT:  Cost Model: Found an estimated cost of 68 for instruction: %widen_type_srem_1 = srem <vscale x 15 x i16> undef, undef
