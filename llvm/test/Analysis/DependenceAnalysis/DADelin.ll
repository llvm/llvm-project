...
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
...
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{1,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:    da analyze - consistent anti [-1 0 0]!
; CHECK-NEXT:  Src: store i32 %add12, ptr %arrayidx2, align 4 --> Dst: store i32 %add12, ptr %arrayidx2, align 4
; CHECK-NEXT:      Delinearized accesses:
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{1,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{1,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:    da analyze - none!
;
entry:
...
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{-1,+,1}<%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:    da analyze - consistent anti [1 0 0]!
; CHECK-NEXT:  Src: store i32 %add12, ptr %arrayidx2, align 4 --> Dst: store i32 %add12, ptr %arrayidx2, align 4
; CHECK-NEXT:      Delinearized accesses:
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{-1,+,1}<%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{-1,+,1}<%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{0,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:    da analyze - none!
;
entry:
...
; CHECK-NEXT:      Delinearized accesses:
; CHECK-NEXT:        Sizes[*][%m][%o]
; CHECK-NEXT:        Src[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{1,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:        Dst[{0,+,1}<nuw><nsw><%for.cond1.preheader>][{0,+,1}<nuw><nsw><%for.cond5.preheader>][{1,+,1}<nuw><nsw><%for.body8>]
; CHECK-NEXT:    da analyze - none!
; CHECK-NEXT:  Src: %0 = load i32, ptr %arrayidx, align 4 --> Dst: store i32 %add12, ptr %arrayidx2, align 4
; CHECK-NEXT:      Delinearized accesses:
; CHECK-NEXT:        Sizes[*][%m][%o]
