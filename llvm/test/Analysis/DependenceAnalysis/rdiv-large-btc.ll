...
; RUN: opt < %s -disable-output "-passes=print<da>" -da-enable-dependence-test=subscripts-range 2>&1 \
; RUN:     | FileCheck %s --check-prefixes=CHECK,CHECK-SUBSCRIPTS-RANGE
...
; CHECK-EXACT-RDIV-NEXT:    da analyze - output [*]!
;
; CHECK-SUBSCRIPTS-RANGE-LABEL: 'rdiv_large_btc'
; CHECK-SUBSCRIPTS-RANGE-NEXT:  Src: store i8 0, ptr %gep.0, align 1 --> Dst: store i8 0, ptr %gep.0, align 1
; CHECK-SUBSCRIPTS-RANGE-NEXT:    da analyze - output [*]!
; CHECK-SUBSCRIPTS-RANGE-NEXT:  Src: store i8 0, ptr %gep.0, align 1 --> Dst: store i8 0, ptr %gep.1, align 1
; CHECK-SUBSCRIPTS-RANGE-NEXT:    da analyze - output [|<]!
; CHECK-SUBSCRIPTS-RANGE-NEXT:  Src: store i8 0, ptr %gep.1, align 1 --> Dst: store i8 0, ptr %gep.1, align 1
; CHECK-SUBSCRIPTS-RANGE-NEXT:    da analyze - output [*]!
;
entry:
