...
; CHECK-ALL-NEXT:    da analyze - output [*]!
;
; CHECK-SUBSCRIPTS-RANGE-LABEL: 'symbolic_rdiv_addrec_wrap'
...
; CHECK-SUBSCRIPTS-RANGE-NEXT:  Src: store i8 0, ptr %gep.0, align 1 --> Dst: store i8 1, ptr %gep.1, align 1
; CHECK-SUBSCRIPTS-RANGE-NEXT:    da analyze - output [*|<]!
; CHECK-SUBSCRIPTS-RANGE-NEXT:  Src: store i8 1, ptr %gep.1, align 1 --> Dst: store i8 1, ptr %gep.1, align 1
; CHECK-SUBSCRIPTS-RANGE-NEXT:    da analyze - output [*]!
;
entry:
  %tc = shl i64 1, 60
