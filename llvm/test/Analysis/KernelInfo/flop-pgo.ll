...
define double @noProf() !dbg !200 {
  ; CHECK: remark: test.c:3:9: in function 'noProf', 'fadd' instruction ('%fadd') is a floating point op where the block profile count is 0
...
define double @f() !dbg !300 !prof !302 {
  ...
  ; CHECK: remark: test.c:5:9: in function 'f', 'fadd' instruction ('%fadd') is a floating point op where the block profile count is 2
...
.ret:                                         ; preds = %.many
  ; CHECK: remark: test.c:6:9: in function 'f', 'fsub' instruction ('%fsub') is a floating point op where the block profile count is 2
  %fsub = fsub double 0.000000e+00, 0.000000e+00, !dbg !306
  ; CHECK: remark: test.c:7:9: in function 'f', 'fmul' instruction ('%fmul') is a floating point op where the block profile count is 2
...
.many:                                         ; preds = %.none, %.many
  ...
  ; unnamed value.
  ;
  ; CHECK: remark: test.c:8:9: in function 'f', 'fdiv' instruction ('%1') is a floating point op where the block profile count is 6
  %1 = fdiv double 0.000000e+00, 0.000000e+00, !dbg !308
  ; CHECK: remark: test.c:9:9: in function 'f', 'fneg' instruction ('%fneg') is a floating point op where the block profile count is 6
  %fneg = fneg double 0.000000e+00, !dbg !309

  ; Check atomicrmw.
  ;
  ; CHECK: remark: test.c:10:9: in function 'f', 'atomicrmw' instruction ('%[[#]]') is a floating point op where the block profile count is 6
  atomicrmw fadd ptr addrspace(37) null, double 0.000000e+00 seq_cst, !dbg !310
  ; CHECK: remark: test.c:11:9: in function 'f', 'atomicrmw' instruction ('%[[#]]') is a floating point op where the block profile count is 6
  atomicrmw fsub ptr addrspace(37) null, double 0.000000e+00 seq_cst, !dbg !311
  ; CHECK: remark: test.c:12:9: in function 'f', 'atomicrmw' instruction ('%[[#]]') is a floating point op where the block profile count is 6
  atomicrmw fmax ptr addrspace(37) null, double 0.000000e+00 seq_cst, !dbg !312
  ; CHECK: remark: test.c:13:9: in function 'f', 'atomicrmw' instruction ('%[[#]]') is a floating point op where the block profile count is 6
  ...
  ;
  ; CHECK: remark: test.c:14:9: in function 'f', 'fadd' instruction ('%float') is a floating point op where the block profile count is 6
  %float = fadd float 0.000000e+00, 0.000000e+00, !dbg !314
  ; CHECK: remark: test.c:15:9: in function 'f', 'fadd' instruction ('%half') is a floating point op where the block profile count is 6
  %half = fadd half 0.000000e+00, 0.000000e+00, !dbg !315
  ; CHECK: remark: test.c:16:9: in function 'f', 'fadd' instruction ('%bfloat') is a floating point op where the block profile count is 6
  %bfloat = fadd bfloat 0.000000e+00, 0.000000e+00, !dbg !316
  ; CHECK: remark: test.c:17:9: in function 'f', 'fadd' instruction ('%fp128') is a floating point op where the block profile count is 6
  %fp128 = fadd fp128 0xL0, 0xL0, !dbg !317
  ; CHECK: remark: test.c:18:9: in function 'f', 'fadd' instruction ('%vector') is a floating point op where the block profile count is 6
