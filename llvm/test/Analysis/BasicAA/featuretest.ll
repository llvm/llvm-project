...
; CHECK-NEXT:    [[TMP1:%.*]] = shl i64 [[B:%.*]], 2
; CHECK-NEXT:    [[POINTER2:%.*]] = getelementptr i8, ptr [[ARRAY22]], i64 [[TMP1]]
...
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = shl i64 [[DISTANCE:%.*]], 3
; NO_ASSUME-NEXT:    [[B_SPLIT:%.*]] = getelementptr i8, ptr [[A:%.*]], i64 [[TMP1]]
; NO_ASSUME-NEXT:    [[B:%.*]] = getelementptr i8, ptr [[B_SPLIT]], i64 4
; NO_ASSUME-NEXT:    store i32 7, ptr [[B]], align 4
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: @gep_distance_test2(
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = shl i64 [[DISTANCE:%.*]], 3
; USE_ASSUME-NEXT:    [[B_SPLIT:%.*]] = getelementptr i8, ptr [[A:%.*]], i64 [[TMP1]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = shl nuw nsw i64 [[SUM5_CAST]], 1
; CHECK-NEXT:    [[P1:%.*]] = getelementptr i8, ptr [[ROW2COL:%.*]], i64 [[TMP0]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nuw nsw i64 [[SUM13_CAST]], 1
; CHECK-NEXT:    [[P2:%.*]] = getelementptr i8, ptr [[ROW2COL]], i64 [[TMP1]]
