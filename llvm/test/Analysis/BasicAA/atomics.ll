...
; CHECK:  NoModRef:  Ptr: i32* %a	<->  %3 = load atomic i32, ptr %a monotonic, align 4
; CHECK:  NoModRef:  Ptr: i32* %a	<->  store atomic i32 0, ptr %a monotonic, align 4
; CHECK:  NoModRef:  Ptr: i32* %a	<->  %4 = atomicrmw add ptr %a, i32 1 acq_rel, align 4
; CHECK:  NoModRef:  Ptr: i32* %a	<->  %5 = cmpxchg ptr %a, i32 0, i32 1 acq_rel monotonic, align 4
; CHECK:  NoModRef:  Ptr: i32* %a	<->  %6 = load atomic i32, ptr %a acquire, align 4
; CHECK:  NoModRef:  Ptr: i32* %a	<->  store atomic i32 0, ptr %a release, align 4
