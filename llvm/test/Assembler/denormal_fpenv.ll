...
; CHECK: Function Attrs: denormal_fpenv(ieee,ieee)
...
; CHECK: Function Attrs: denormal_fpenv(ieee,dynamic)
...
; CHECK: Function Attrs: denormal_fpenv(ieee,positivezero)
...
; CHECK: Function Attrs: denormal_fpenv(positivezero,ieee)
...
; CHECK: Function Attrs: denormal_fpenv(positivezero,dynamic)
...
; CHECK: Function Attrs: denormal_fpenv(dynamic,positivezero)
...
; CHECK: Function Attrs: denormal_fpenv(preservesign,dynamic)
...
; CHECK: Function Attrs: denormal_fpenv(float: positivezero,positivezero)
...
; CHECK: Function Attrs: denormal_fpenv(float: dynamic,positivezero)
...
;.
; CHECK: attributes #[[ATTR0]] = { denormal_fpenv(ieee,ieee) }
; CHECK: attributes #[[ATTR1]] = { denormal_fpenv(preservesign,preservesign) }
; CHECK: attributes #[[ATTR2]] = { denormal_fpenv(positivezero,positivezero) }
; CHECK: attributes #[[ATTR3]] = { denormal_fpenv(dynamic,dynamic) }
...
; CHECK: attributes #[[ATTR13]] = { denormal_fpenv(float: preservesign,preservesign) }
; CHECK: attributes #[[ATTR14]] = { denormal_fpenv(float: positivezero,positivezero) }
