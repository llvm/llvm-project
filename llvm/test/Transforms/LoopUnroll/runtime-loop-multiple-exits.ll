...
; EPILOG-NEXT:    %1 = icmp ugt i32 %0, 1
; EPILOG-NEXT:    %umax = select i1 %1, i32 %0, i32 1
; EPILOG-NEXT:    %2 = add i32 %umax, -1
...
; EPILOG-BLOCK-NEXT:    %1 = icmp ugt i32 %0, 1
; EPILOG-BLOCK-NEXT:    %umax = select i1 %1, i32 %0, i32 1
; EPILOG-BLOCK-NEXT:    %2 = add i32 %umax, -1
...
; PROLOG-NEXT:    %1 = icmp ugt i32 %0, 1
; PROLOG-NEXT:    %umax = select i1 %1, i32 %0, i32 1
; PROLOG-NEXT:    %2 = add i32 %umax, -1
...
; PROLOG-BLOCK-NEXT:    %1 = icmp ugt i32 %0, 1
; PROLOG-BLOCK-NEXT:    %umax = select i1 %1, i32 %0, i32 1
; PROLOG-BLOCK-NEXT:    %2 = add i32 %umax, -1
