...
; CHECK:       for.body.epil:
; CHECK-NEXT:    [[TMP16:%.*]] = shl nsw i64 [[INDVARS_IV_EPIL_INIT]], 2
; CHECK-NEXT:    [[ARRAYIDX_EPIL:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP16]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX_EPIL]], align 4
; CHECK-NEXT:    [[TMP18:%.*]] = shl nsw i64 [[INDVARS_IV_EPIL_INIT]], 2
; CHECK-NEXT:    [[ARRAYIDX2_EPIL:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP18]]
...
; CHECK-NEXT:    [[TMP20:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_EPIL]], 2
; CHECK-NEXT:    [[ARRAYIDX_EPIL_1:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP20]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[ARRAYIDX_EPIL_1]], align 4
; CHECK-NEXT:    [[TMP22:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_EPIL]], 2
; CHECK-NEXT:    [[ARRAYIDX2_EPIL_1:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP22]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_EPIL_1]], 2
; CHECK-NEXT:    [[ARRAYIDX_EPIL_2:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP24]]
; CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[ARRAYIDX_EPIL_2]], align 4
; CHECK-NEXT:    [[TMP26:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_EPIL_1]], 2
; CHECK-NEXT:    [[ARRAYIDX2_EPIL_2:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP26]]
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP28]]
; CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[TMP15:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[TMP15]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT]], 2
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP17]]
; CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[ARRAYIDX_1]], align 4
; CHECK-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT]], 2
; CHECK-NEXT:    [[ARRAYIDX2_1:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[TMP19]]
...
; CHECK-NEXT:    [[TMP21:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_1]], 2
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ARRAYIDX_2]], align 4
; CHECK-NEXT:    [[TMP23:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_1]], 2
; CHECK-NEXT:    [[ARRAYIDX2_2:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[TMP23]]
...
; CHECK-NEXT:    [[TMP25:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_2]], 2
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP25]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[ARRAYIDX_3]], align 4
; CHECK-NEXT:    [[TMP27:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT_2]], 2
; CHECK-NEXT:    [[ARRAYIDX2_3:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[TMP27]]
