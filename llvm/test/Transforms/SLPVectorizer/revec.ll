...
; RUN: opt -passes=slp-vectorizer -S -slp-revec -slp-max-reg-size=1024 -slp-threshold=-100 %s | FileCheck %s --check-prefixes=CHECK,POW2
; RUN: opt -passes=slp-vectorizer -S -slp-revec -slp-max-reg-size=1024 -slp-threshold=-100 -slp-vectorize-non-power-of-2 %s | FileCheck %s --check-prefixes=CHECK,NON-POW2
...
; CHECK-LABEL: @test3(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <2 x ptr> poison, ptr [[X:%.*]], i64 0
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <2 x ptr> [[TMP0]], ptr [[Y:%.*]], i64 1
...
; CHECK-LABEL: @test14(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <8 x i1> [[TMP0:%.*]], <8 x i1> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP2:%.*]] = sext <16 x i1> [[TMP1]] to <16 x i16>
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <16 x i16> [[TMP2]], <16 x i16> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    br label [[FOR_END_LOOPEXIT:%.*]]
; CHECK:       for.end.loopexit:
...
define <4 x i32> @hor_reduction_four_points_non_pow2(ptr %a) {
; POW2-LABEL: @hor_reduction_four_points_non_pow2(
; POW2-NEXT:  entry:
; POW2-NEXT:    [[GEP1:%.*]] = getelementptr <4 x i32>, ptr [[A:%.*]], i64 1
; POW2-NEXT:    [[GEP2:%.*]] = getelementptr <4 x i32>, ptr [[A]], i64 2
; POW2-NEXT:    [[A0:%.*]] = load <4 x i32>, ptr [[A]], align 16
; POW2-NEXT:    [[A1:%.*]] = load <4 x i32>, ptr [[GEP1]], align 16
; POW2-NEXT:    [[A2:%.*]] = load <4 x i32>, ptr [[GEP2]], align 16
; POW2-NEXT:    [[ADD0:%.*]] = add <4 x i32> <i32 0, i32 1, i32 2, i32 3>, [[A0]]
; POW2-NEXT:    [[ADD1:%.*]] = add <4 x i32> [[ADD0]], [[A1]]
; POW2-NEXT:    [[ADD2:%.*]] = add <4 x i32> [[ADD1]], [[A2]]
; POW2-NEXT:    ret <4 x i32> [[ADD2]]
;
; NON-POW2-LABEL: @hor_reduction_four_points_non_pow2(
; NON-POW2-NEXT:  entry:
; NON-POW2-NEXT:    [[TMP0:%.*]] = load <12 x i32>, ptr [[A:%.*]], align 16
; NON-POW2-NEXT:    [[TMP1:%.*]] = shufflevector <12 x i32> [[TMP0]], <12 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; NON-POW2-NEXT:    [[TMP2:%.*]] = shufflevector <12 x i32> [[TMP0]], <12 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
; NON-POW2-NEXT:    [[RDX_OP:%.*]] = add <4 x i32> [[TMP1]], [[TMP2]]
; NON-POW2-NEXT:    [[TMP3:%.*]] = shufflevector <12 x i32> [[TMP0]], <12 x i32> poison, <4 x i32> <i32 8, i32 9, i32 10, i32 11>
; NON-POW2-NEXT:    [[RDX_OP1:%.*]] = add <4 x i32> [[RDX_OP]], [[TMP3]]
; NON-POW2-NEXT:    [[OP_RDX:%.*]] = add <4 x i32> [[RDX_OP1]], <i32 0, i32 1, i32 2, i32 3>
; NON-POW2-NEXT:    ret <4 x i32> [[OP_RDX]]
;
entry:
  %gep1 = getelementptr <4 x i32>, ptr %a, i64 1
  %gep2 = getelementptr <4 x i32>, ptr %a, i64 2
