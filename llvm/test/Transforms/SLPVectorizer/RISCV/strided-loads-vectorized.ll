...
; RUN: opt -passes=slp-vectorizer -S -mtriple=riscv64-unknown-linux-gnu -mattr=+v,+zvfhmin,+zvfbfmin < %s | FileCheck %s
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P:%.*]], i64 0, i64 0
; CHECK-NEXT:    [[I:%.*]] = load bfloat, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 30
; CHECK-NEXT:    [[I1:%.*]] = load bfloat, ptr [[ARRAYIDX1]], align 4
; CHECK-NEXT:    [[ADD:%.*]] = fsub fast bfloat [[I1]], [[I]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds bfloat, ptr [[S:%.*]], i64 0
; CHECK-NEXT:    store bfloat [[ADD]], ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 4
; CHECK-NEXT:    [[I2:%.*]] = load bfloat, ptr [[ARRAYIDX4]], align 4
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 26
; CHECK-NEXT:    [[I3:%.*]] = load bfloat, ptr [[ARRAYIDX6]], align 4
; CHECK-NEXT:    [[ADD7:%.*]] = fsub fast bfloat [[I3]], [[I2]]
; CHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 1
; CHECK-NEXT:    store bfloat [[ADD7]], ptr [[ARRAYIDX9]], align 4
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 8
; CHECK-NEXT:    [[I4:%.*]] = load bfloat, ptr [[ARRAYIDX11]], align 4
; CHECK-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 22
; CHECK-NEXT:    [[I5:%.*]] = load bfloat, ptr [[ARRAYIDX13]], align 4
; CHECK-NEXT:    [[ADD14:%.*]] = fsub fast bfloat [[I5]], [[I4]]
; CHECK-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 2
; CHECK-NEXT:    store bfloat [[ADD14]], ptr [[ARRAYIDX16]], align 4
; CHECK-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 12
; CHECK-NEXT:    [[I6:%.*]] = load bfloat, ptr [[ARRAYIDX18]], align 4
; CHECK-NEXT:    [[ARRAYIDX20:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 18
; CHECK-NEXT:    [[I7:%.*]] = load bfloat, ptr [[ARRAYIDX20]], align 4
; CHECK-NEXT:    [[ADD21:%.*]] = fsub fast bfloat [[I7]], [[I6]]
; CHECK-NEXT:    [[ARRAYIDX23:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 3
; CHECK-NEXT:    store bfloat [[ADD21]], ptr [[ARRAYIDX23]], align 4
; CHECK-NEXT:    [[ARRAYIDX25:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 16
; CHECK-NEXT:    [[I8:%.*]] = load bfloat, ptr [[ARRAYIDX25]], align 4
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 14
; CHECK-NEXT:    [[I9:%.*]] = load bfloat, ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    [[ADD28:%.*]] = fsub fast bfloat [[I9]], [[I8]]
; CHECK-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 4
; CHECK-NEXT:    store bfloat [[ADD28]], ptr [[ARRAYIDX30]], align 4
; CHECK-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 20
; CHECK-NEXT:    [[I10:%.*]] = load bfloat, ptr [[ARRAYIDX32]], align 4
; CHECK-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 10
; CHECK-NEXT:    [[I11:%.*]] = load bfloat, ptr [[ARRAYIDX34]], align 4
; CHECK-NEXT:    [[ADD35:%.*]] = fsub fast bfloat [[I11]], [[I10]]
; CHECK-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 5
; CHECK-NEXT:    store bfloat [[ADD35]], ptr [[ARRAYIDX37]], align 4
; CHECK-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 24
; CHECK-NEXT:    [[I12:%.*]] = load bfloat, ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 6
; CHECK-NEXT:    [[I13:%.*]] = load bfloat, ptr [[ARRAYIDX41]], align 4
; CHECK-NEXT:    [[ADD42:%.*]] = fsub fast bfloat [[I13]], [[I12]]
; CHECK-NEXT:    [[ARRAYIDX44:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 6
; CHECK-NEXT:    store bfloat [[ADD42]], ptr [[ARRAYIDX44]], align 4
; CHECK-NEXT:    [[ARRAYIDX46:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 28
; CHECK-NEXT:    [[I14:%.*]] = load bfloat, ptr [[ARRAYIDX46]], align 4
; CHECK-NEXT:    [[ARRAYIDX48:%.*]] = getelementptr inbounds [48 x bfloat], ptr [[P]], i64 0, i64 2
; CHECK-NEXT:    [[I15:%.*]] = load bfloat, ptr [[ARRAYIDX48]], align 4
; CHECK-NEXT:    [[ADD49:%.*]] = fsub fast bfloat [[I15]], [[I14]]
; CHECK-NEXT:    [[ARRAYIDX51:%.*]] = getelementptr inbounds bfloat, ptr [[S]], i64 7
; CHECK-NEXT:    store bfloat [[ADD49]], ptr [[ARRAYIDX51]], align 4
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [48 x half], ptr [[P:%.*]], i64 0, i64 0
; CHECK-NEXT:    [[I:%.*]] = load half, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 30
; CHECK-NEXT:    [[I1:%.*]] = load half, ptr [[ARRAYIDX1]], align 4
; CHECK-NEXT:    [[ADD:%.*]] = fsub fast half [[I1]], [[I]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds half, ptr [[S:%.*]], i64 0
; CHECK-NEXT:    store half [[ADD]], ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 4
; CHECK-NEXT:    [[I2:%.*]] = load half, ptr [[ARRAYIDX4]], align 4
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 26
; CHECK-NEXT:    [[I3:%.*]] = load half, ptr [[ARRAYIDX6]], align 4
; CHECK-NEXT:    [[ADD7:%.*]] = fsub fast half [[I3]], [[I2]]
; CHECK-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds half, ptr [[S]], i64 1
; CHECK-NEXT:    store half [[ADD7]], ptr [[ARRAYIDX9]], align 4
; CHECK-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 8
; CHECK-NEXT:    [[I4:%.*]] = load half, ptr [[ARRAYIDX11]], align 4
; CHECK-NEXT:    [[ARRAYIDX13:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 22
; CHECK-NEXT:    [[I5:%.*]] = load half, ptr [[ARRAYIDX13]], align 4
; CHECK-NEXT:    [[ADD14:%.*]] = fsub fast half [[I5]], [[I4]]
; CHECK-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds half, ptr [[S]], i64 2
; CHECK-NEXT:    store half [[ADD14]], ptr [[ARRAYIDX16]], align 4
; CHECK-NEXT:    [[ARRAYIDX18:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 12
; CHECK-NEXT:    [[I6:%.*]] = load half, ptr [[ARRAYIDX18]], align 4
; CHECK-NEXT:    [[ARRAYIDX20:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 18
; CHECK-NEXT:    [[I7:%.*]] = load half, ptr [[ARRAYIDX20]], align 4
; CHECK-NEXT:    [[ADD21:%.*]] = fsub fast half [[I7]], [[I6]]
; CHECK-NEXT:    [[ARRAYIDX23:%.*]] = getelementptr inbounds half, ptr [[S]], i64 3
; CHECK-NEXT:    store half [[ADD21]], ptr [[ARRAYIDX23]], align 4
; CHECK-NEXT:    [[ARRAYIDX25:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 16
; CHECK-NEXT:    [[I8:%.*]] = load half, ptr [[ARRAYIDX25]], align 4
; CHECK-NEXT:    [[ARRAYIDX27:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 14
; CHECK-NEXT:    [[I9:%.*]] = load half, ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    [[ADD28:%.*]] = fsub fast half [[I9]], [[I8]]
; CHECK-NEXT:    [[ARRAYIDX30:%.*]] = getelementptr inbounds half, ptr [[S]], i64 4
; CHECK-NEXT:    store half [[ADD28]], ptr [[ARRAYIDX30]], align 4
; CHECK-NEXT:    [[ARRAYIDX32:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 20
; CHECK-NEXT:    [[I10:%.*]] = load half, ptr [[ARRAYIDX32]], align 4
; CHECK-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 10
; CHECK-NEXT:    [[I11:%.*]] = load half, ptr [[ARRAYIDX34]], align 4
; CHECK-NEXT:    [[ADD35:%.*]] = fsub fast half [[I11]], [[I10]]
; CHECK-NEXT:    [[ARRAYIDX37:%.*]] = getelementptr inbounds half, ptr [[S]], i64 5
; CHECK-NEXT:    store half [[ADD35]], ptr [[ARRAYIDX37]], align 4
; CHECK-NEXT:    [[ARRAYIDX39:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 24
; CHECK-NEXT:    [[I12:%.*]] = load half, ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[ARRAYIDX41:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 6
; CHECK-NEXT:    [[I13:%.*]] = load half, ptr [[ARRAYIDX41]], align 4
; CHECK-NEXT:    [[ADD42:%.*]] = fsub fast half [[I13]], [[I12]]
; CHECK-NEXT:    [[ARRAYIDX44:%.*]] = getelementptr inbounds half, ptr [[S]], i64 6
; CHECK-NEXT:    store half [[ADD42]], ptr [[ARRAYIDX44]], align 4
; CHECK-NEXT:    [[ARRAYIDX46:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 28
; CHECK-NEXT:    [[I14:%.*]] = load half, ptr [[ARRAYIDX46]], align 4
; CHECK-NEXT:    [[ARRAYIDX48:%.*]] = getelementptr inbounds [48 x half], ptr [[P]], i64 0, i64 2
; CHECK-NEXT:    [[I15:%.*]] = load half, ptr [[ARRAYIDX48]], align 4
; CHECK-NEXT:    [[ADD49:%.*]] = fsub fast half [[I15]], [[I14]]
; CHECK-NEXT:    [[ARRAYIDX51:%.*]] = getelementptr inbounds half, ptr [[S]], i64 7
; CHECK-NEXT:    store half [[ADD49]], ptr [[ARRAYIDX51]], align 4
; CHECK-NEXT:    ret void
;
entry:
