...
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <2 x i8> [[TMP0]], <2 x i8> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x i8> [[TMP3]], i8 [[VECTOR_RECUR_EXTRACT]], i64 0
; CHECK-NEXT:    [[TMP5:%.*]] = sext <2 x i8> [[TMP4]] to <2 x i32>
; CHECK-NEXT:    store <2 x i32> [[TMP5]], ptr getelementptr ([0 x i32], ptr null, i64 0, i64 -14), align 4
