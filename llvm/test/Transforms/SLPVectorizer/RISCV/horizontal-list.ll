...
; CHECK-NEXT:    [[TMP0:%.*]] = load <28 x float>, ptr [[ARRAYIDX]], align 4
...
; CHECK-NEXT:    [[OP_RDX1:%.*]] = call fast float @llvm.vector.reduce.fadd.v28f32(float 0.000000e+00, <28 x float> [[TMP0]])
