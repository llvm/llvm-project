...
; RUN: opt -passes=slp-vectorizer -S -mtriple=riscv64 --mattr=+v,+zvl256b,+zbb < %s | FileCheck %s

define void @splat_trim_combined(ptr %A, ptr %B, ptr %C, ptr %D, ptr %E, ptr %F, ptr %S) {
; CHECK-LABEL: define void @splat_trim_combined(
...
entry:
  ...
  %c1 = icmp sgt i64 %A0, 42
  %v1 = select i1 %c1, i64 %A0, i64 42
  %c2 = icmp sgt i64 %C0, 42
  %v2 = select i1 %c2, i64 %C0, i64 42
  %c3 = icmp sgt i64 %E0, 42
  %v3 = select i1 %c3, i64 %E0, i64 42
