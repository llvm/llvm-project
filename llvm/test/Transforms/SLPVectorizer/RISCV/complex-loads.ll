...
; CHECK-NEXT:    [[TMP31:%.*]] = add <2 x i32> [[TMP16]], [[TMP10]]
...
; CHECK-NEXT:    [[TMP35:%.*]] = add <2 x i32> [[TMP28]], [[TMP22]]
; CHECK-NEXT:    [[TMP17:%.*]] = add <2 x i32> [[TMP35]], [[TMP31]]
; CHECK-NEXT:    [[TMP30:%.*]] = sub <2 x i32> [[TMP31]], [[TMP35]]
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <2 x i32> [[TMP17]], i32 0
; CHECK-NEXT:    [[ADD46_2:%.*]] = extractelement <2 x i32> [[TMP17]], i32 1
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[ADD46_2]], [[TMP32]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = zext <2 x i8> [[TMP41]] to <2 x i32>
; CHECK-NEXT:    [[TMP42:%.*]] = sub <2 x i32> [[TMP33]], [[TMP40]]
...
; CHECK-NEXT:    [[TMP45:%.*]] = zext <2 x i8> [[TMP43]] to <2 x i32>
; CHECK-NEXT:    [[TMP36:%.*]] = sub <2 x i32> [[TMP39]], [[TMP45]]
; CHECK-NEXT:    [[TMP37:%.*]] = shl <2 x i32> [[TMP36]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = add <2 x i32> [[TMP37]], [[TMP42]]
...
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <2 x i8> poison, i8 [[TMP47]], i32 0
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <2 x i8> [[TMP54]], i8 [[TMP48]], i32 1
...
; CHECK-NEXT:    [[ADD43_3:%.*]] = add i32 [[TMP75]], [[TMP65]]
; CHECK-NEXT:    [[SUB45_3:%.*]] = sub i32 [[TMP65]], [[TMP75]]
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <2 x i32> [[TMP61]], i32 0
; CHECK-NEXT:    [[TMP66:%.*]] = extractelement <2 x i32> [[TMP61]], i32 1
; CHECK-NEXT:    [[ADD31_3:%.*]] = add i32 [[TMP66]], [[TMP64]]
; CHECK-NEXT:    [[SUB47_3:%.*]] = sub i32 [[TMP64]], [[TMP66]]
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[ADD31_3]], [[ADD43_3]]
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <2 x i32> [[TMP17]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
...
; CHECK-NEXT:    [[TMP77:%.*]] = sub <2 x i32> [[TMP70]], [[TMP71]]
...
; CHECK-NEXT:    [[SUB102_2:%.*]] = sub i32 [[TMP101]], [[TMP92]]
...
; CHECK-NEXT:    [[TMP111:%.*]] = zext <2 x i8> [[TMP94]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP98:%.*]] = zext <2 x i8> [[TMP119]] to <2 x i32>
; CHECK-NEXT:    [[TMP120:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP117:%.*]] = zext <2 x i8> [[TMP120]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP98]], [[TMP117]]
; CHECK-NEXT:    [[TMP96:%.*]] = shl <2 x i32> [[TMP95]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP118:%.*]] = sub <2 x i32> [[TMP97]], [[TMP115]]
; CHECK-NEXT:    [[TMP104:%.*]] = add <2 x i32> [[TMP96]], [[TMP118]]
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV1]], i32 0
; CHECK-NEXT:    [[TMP121:%.*]] = sub <2 x i32> [[TMP100]], [[TMP111]]
...
; CHECK-NEXT:    [[TMP123:%.*]] = zext <2 x i8> [[TMP130]] to <2 x i32>
; CHECK-NEXT:    [[TMP132:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP139:%.*]] = zext <2 x i8> [[TMP132]] to <2 x i32>
; CHECK-NEXT:    [[TMP124:%.*]] = sub <2 x i32> [[TMP123]], [[TMP139]]
...
; CHECK-NEXT:    [[TMP145:%.*]] = zext <2 x i8> [[TMP144]] to <2 x i32>
; CHECK-NEXT:    [[TMP138:%.*]] = shufflevector <4 x i8> [[TMP129]], <4 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP131:%.*]] = zext <2 x i8> [[TMP138]] to <2 x i32>
; CHECK-NEXT:    [[TMP147:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP133:%.*]] = zext <2 x i8> [[TMP147]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = sub <2 x i32> [[TMP131]], [[TMP133]]
; CHECK-NEXT:    [[TMP136:%.*]] = shl <2 x i32> [[TMP135]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP148:%.*]] = sub <2 x i32> [[TMP137]], [[TMP145]]
; CHECK-NEXT:    [[TMP149:%.*]] = add <2 x i32> [[TMP136]], [[TMP148]]
; CHECK-NEXT:    [[TMP140:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP150:%.*]] = sub <2 x i32> [[TMP140]], [[TMP134]]
; CHECK-NEXT:    [[TMP141:%.*]] = add <2 x i32> [[TMP125]], [[TMP150]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP149]], [[TMP141]]
; CHECK-NEXT:    [[TMP151:%.*]] = sub <2 x i32> [[TMP141]], [[TMP149]]
