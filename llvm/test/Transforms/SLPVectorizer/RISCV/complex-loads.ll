...
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX5_1:%.*]] = getelementptr i8, ptr [[PIX1]], i64 [[IDX_EXT]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD_PTR644:%.*]] = getelementptr i8, ptr [[PIX2]], i64 [[IDX_EXT63]]
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX3_1:%.*]] = getelementptr i8, ptr [[ARRAYIDX5_1]], i64 4
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX5_4:%.*]] = getelementptr i8, ptr [[ADD_PTR644]], i64 4
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX5_2:%.*]] = getelementptr i8, ptr [[ADD_PTR]], i64 [[IDX_EXT]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD_PTR64_1:%.*]] = getelementptr i8, ptr [[ADD_PTR64]], i64 [[IDX_EXT63]]
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX3_2:%.*]] = getelementptr i8, ptr [[ARRAYIDX5_2]], i64 4
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX5_5:%.*]] = getelementptr i8, ptr [[ADD_PTR64_1]], i64 4
; UNALIGNED_VEC_MEM-NEXT:    [[ARRAYIDX3_3:%.*]] = getelementptr i8, ptr null, i64 4
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP85:%.*]] = load i8, ptr null, align 1
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP88:%.*]] = load i8, ptr null, align 1
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP18:%.*]] = extractelement <4 x i32> [[TMP13]], i64 0
; UNALIGNED_VEC_MEM-NEXT:    [[TMP19:%.*]] = extractelement <4 x i32> [[TMP13]], i64 1
; UNALIGNED_VEC_MEM-NEXT:    [[ADD44:%.*]] = add i32 [[TMP19]], [[TMP18]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45:%.*]] = sub i32 [[TMP18]], [[TMP19]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP14:%.*]] = extractelement <4 x i32> [[TMP13]], i64 2
; UNALIGNED_VEC_MEM-NEXT:    [[TMP20:%.*]] = extractelement <4 x i32> [[TMP13]], i64 3
; UNALIGNED_VEC_MEM-NEXT:    [[ADD46:%.*]] = add i32 [[TMP20]], [[TMP14]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47:%.*]] = sub i32 [[TMP14]], [[TMP20]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD48:%.*]] = add i32 [[ADD46]], [[ADD44]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB51:%.*]] = sub i32 [[ADD44]], [[ADD46]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD56:%.*]] = add i32 [[SUB47]], [[SUB45]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB60:%.*]] = sub i32 [[SUB45]], [[SUB47]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP17:%.*]] = load <4 x i8>, ptr [[ARRAYIDX5_1]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP21:%.*]] = zext <4 x i8> [[TMP17]] to <4 x i32>
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP24:%.*]] = load <4 x i8>, ptr [[ARRAYIDX5_4]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP36:%.*]] = zext <4 x i8> [[TMP24]] to <4 x i32>
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB36_3:%.*]] = extractelement <4 x i32> [[TMP44]], i64 0
; UNALIGNED_VEC_MEM-NEXT:    [[SHL42_3:%.*]] = extractelement <4 x i32> [[TMP44]], i64 1
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_3:%.*]] = add i32 [[SHL42_3]], [[SUB36_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45_1:%.*]] = sub i32 [[SUB36_3]], [[SHL42_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP30:%.*]] = extractelement <4 x i32> [[TMP44]], i64 2
; UNALIGNED_VEC_MEM-NEXT:    [[TMP31:%.*]] = extractelement <4 x i32> [[TMP44]], i64 3
; UNALIGNED_VEC_MEM-NEXT:    [[ADD46_1:%.*]] = add i32 [[TMP31]], [[TMP30]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47_1:%.*]] = sub i32 [[TMP30]], [[TMP31]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD48_1:%.*]] = add i32 [[ADD46_1]], [[ADD43_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB51_1:%.*]] = sub i32 [[ADD43_3]], [[ADD46_1]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD55_4:%.*]] = add i32 [[SUB47_1]], [[SUB45_1]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_4:%.*]] = sub i32 [[SUB45_1]], [[SUB47_1]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP48:%.*]] = load <4 x i8>, ptr [[ARRAYIDX5_2]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP49:%.*]] = zext <4 x i8> [[TMP48]] to <4 x i32>
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP39:%.*]] = load <4 x i8>, ptr [[ARRAYIDX5_5]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP53:%.*]] = zext <4 x i8> [[TMP39]] to <4 x i32>
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45_4:%.*]] = sub i32 [[TMP63]], [[TMP64]]
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47_3:%.*]] = sub i32 [[TMP89]], [[TMP72]]
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_5:%.*]] = sub i32 [[SUB45_4]], [[SUB47_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP65:%.*]] = load i8, ptr null, align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV_3:%.*]] = zext i8 [[TMP65]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP68:%.*]] = load i8, ptr null, align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV2_3:%.*]] = zext i8 [[TMP68]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45_2:%.*]] = sub i32 [[CONV_3]], [[CONV2_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP70:%.*]] = load i8, ptr [[ARRAYIDX3_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV4_3:%.*]] = zext i8 [[TMP70]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP74:%.*]] = load i8, ptr [[ARRAYIDX5_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV6_3:%.*]] = zext i8 [[TMP74]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[SUB7_3:%.*]] = sub i32 [[CONV4_3]], [[CONV6_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47_2:%.*]] = shl i32 [[SUB7_3]], 16
; UNALIGNED_VEC_MEM-NEXT:    [[ADD55_2:%.*]] = add i32 [[SUB47_2]], [[SUB45_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP75:%.*]] = load i8, ptr [[ARRAYIDX8_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV9_3:%.*]] = zext i8 [[TMP75]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP84:%.*]] = load i8, ptr [[ARRAYIDX10_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV11_3:%.*]] = zext i8 [[TMP84]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[ADD44_4:%.*]] = sub i32 [[CONV9_3]], [[CONV11_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[CONV14_3:%.*]] = zext i8 [[TMP85]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP86:%.*]] = load i8, ptr [[ARRAYIDX15_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV16_3:%.*]] = zext i8 [[TMP86]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[SUB17_3:%.*]] = sub i32 [[CONV14_3]], [[CONV16_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD46_3:%.*]] = shl i32 [[SUB17_3]], 16
; UNALIGNED_VEC_MEM-NEXT:    [[ADD48_3:%.*]] = add i32 [[ADD46_3]], [[ADD44_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP87:%.*]] = load i8, ptr [[ARRAYIDX20_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV21_3:%.*]] = zext i8 [[TMP87]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP57:%.*]] = load i8, ptr [[ARRAYIDX22_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV23_3:%.*]] = zext i8 [[TMP57]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59:%.*]] = sub i32 [[CONV21_3]], [[CONV23_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[CONV26_3:%.*]] = zext i8 [[TMP88]] to i32
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_1:%.*]] = shl i32 [[SUB29_3]], 16
...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_2:%.*]] = sub i32 [[CONV33_3]], [[CONV35_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP62:%.*]] = load i8, ptr null, align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV38_3:%.*]] = zext i8 [[TMP62]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[TMP106:%.*]] = load i8, ptr [[ARRAYIDX39_3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[CONV40_3:%.*]] = zext i8 [[TMP106]] to i32
; UNALIGNED_VEC_MEM-NEXT:    [[SUB41_3:%.*]] = sub i32 [[CONV38_3]], [[CONV40_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_3:%.*]] = shl i32 [[SUB41_3]], 16
; UNALIGNED_VEC_MEM-NEXT:    [[ADD94_3:%.*]] = add i32 [[SUB59_3]], [[SUB59_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD55:%.*]] = add i32 [[ADD48_3]], [[ADD55_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45_3:%.*]] = sub i32 [[ADD55_2]], [[ADD48_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD55_1:%.*]] = add i32 [[ADD94_3]], [[ADD78_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47_4:%.*]] = sub i32 [[ADD78_3]], [[ADD94_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD78_1:%.*]] = add i32 [[ADD55_1]], [[ADD55]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB51_3:%.*]] = sub i32 [[ADD55]], [[ADD55_1]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD55_5:%.*]] = add i32 [[SUB47_4]], [[SUB45_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB59_6:%.*]] = sub i32 [[SUB45_3]], [[SUB47_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD78:%.*]] = add i32 [[ADD48_1]], [[ADD48]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB86:%.*]] = sub i32 [[ADD48]], [[ADD48_1]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD94:%.*]] = add i32 [[ADD78_1]], [[ADD48_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB102:%.*]] = sub i32 [[ADD48_2]], [[ADD78_1]]
...
; UNALIGNED_VEC_MEM-NEXT:    [[ADD78_4:%.*]] = add i32 [[ADD55_4]], [[ADD56]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB86_1:%.*]] = sub i32 [[ADD56]], [[ADD55_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD94_1:%.*]] = add i32 [[ADD55_5]], [[ADD55_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB102_1:%.*]] = sub i32 [[ADD55_3]], [[ADD55_5]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD103_1:%.*]] = add i32 [[ADD94_1]], [[ADD78_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB104_1:%.*]] = sub i32 [[ADD78_4]], [[ADD94_1]]
...
; UNALIGNED_VEC_MEM-NEXT:    [[ADD78_5:%.*]] = add i32 [[SUB59_4]], [[SUB60]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB86_3:%.*]] = sub i32 [[SUB60]], [[SUB59_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD94_4:%.*]] = add i32 [[SUB59_6]], [[SUB59_5]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB102_3:%.*]] = sub i32 [[SUB59_5]], [[SUB59_6]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD103_3:%.*]] = add i32 [[ADD94_4]], [[ADD78_5]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB104_3:%.*]] = sub i32 [[ADD78_5]], [[ADD94_4]]
