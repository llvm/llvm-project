...
; CHECK-NEXT:    [[TMP4:%.*]] = load <8 x i8>, ptr [[ADD_PTR_1]], align 1
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <8 x i8> [[TMP4]], <8 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP6:%.*]] = zext <2 x i8> [[TMP5]] to <2 x i32>
; CHECK-NEXT:    [[TMP7:%.*]] = load <8 x i8>, ptr [[ADD_PTR64_1]], align 1
; CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i8> [[TMP7]], <8 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP9:%.*]] = zext <2 x i8> [[TMP8]] to <2 x i32>
; CHECK-NEXT:    [[TMP10:%.*]] = sub <2 x i32> [[TMP6]], [[TMP9]]
; CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <8 x i8> [[TMP4]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP12:%.*]] = zext <2 x i8> [[TMP11]] to <2 x i32>
; CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <8 x i8> [[TMP7]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP14:%.*]] = zext <2 x i8> [[TMP13]] to <2 x i32>
; CHECK-NEXT:    [[TMP15:%.*]] = sub <2 x i32> [[TMP12]], [[TMP14]]
; CHECK-NEXT:    [[TMP42:%.*]] = shl <2 x i32> [[TMP15]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP17:%.*]] = add <2 x i32> [[TMP42]], [[TMP10]]
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <8 x i8> [[TMP4]], <8 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP19:%.*]] = zext <2 x i8> [[TMP18]] to <2 x i32>
; CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <8 x i8> [[TMP7]], <8 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP21:%.*]] = zext <2 x i8> [[TMP20]] to <2 x i32>
; CHECK-NEXT:    [[TMP22:%.*]] = sub <2 x i32> [[TMP19]], [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <8 x i8> [[TMP4]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP24:%.*]] = zext <2 x i8> [[TMP23]] to <2 x i32>
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i8> [[TMP7]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP26:%.*]] = zext <2 x i8> [[TMP25]] to <2 x i32>
; CHECK-NEXT:    [[TMP27:%.*]] = sub <2 x i32> [[TMP24]], [[TMP26]]
; CHECK-NEXT:    [[TMP28:%.*]] = shl <2 x i32> [[TMP27]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP29:%.*]] = add <2 x i32> [[TMP28]], [[TMP22]]
; CHECK-NEXT:    [[TMP30:%.*]] = sub <2 x i32> [[TMP17]], [[TMP29]]
; CHECK-NEXT:    [[TMP31:%.*]] = call <4 x i8> @llvm.masked.gather.v4i8.v4p0(<4 x ptr> getelementptr (i8, <4 x ptr> zeroinitializer, <4 x i64> <i64 4, i64 5, i64 0, i64 1>), i32 1, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i8> poison)
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <4 x i8> [[TMP31]], <4 x i8> poison, <2 x i32> <i32 2, i32 3>
...
; CHECK-NEXT:    [[TMP43:%.*]] = sub <2 x i32> [[TMP33]], [[TMP35]]
; CHECK-NEXT:    [[TMP44:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 4, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP38:%.*]] = zext <2 x i8> [[TMP44]] to <2 x i32>
; CHECK-NEXT:    [[TMP39:%.*]] = shufflevector <2 x i32> [[TMP38]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP40:%.*]] = shufflevector <4 x i8> [[TMP31]], <4 x i8> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP41:%.*]] = zext <2 x i8> [[TMP40]] to <2 x i32>
; CHECK-NEXT:    [[TMP36:%.*]] = sub <2 x i32> [[TMP39]], [[TMP41]]
; CHECK-NEXT:    [[TMP37:%.*]] = shl <2 x i32> [[TMP36]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP16:%.*]] = add <2 x i32> [[TMP37]], [[TMP43]]
...
; CHECK-NEXT:    [[TMP52:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i16>
; CHECK-NEXT:    [[TMP48:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX22_3]], i64 4, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP49:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i16>
; CHECK-NEXT:    [[TMP50:%.*]] = sub <2 x i16> [[TMP52]], [[TMP49]]
; CHECK-NEXT:    [[TMP55:%.*]] = extractelement <2 x i16> [[TMP50]], i32 1
; CHECK-NEXT:    [[TMP51:%.*]] = sext i16 [[TMP55]] to i32
; CHECK-NEXT:    [[SHL30_3:%.*]] = shl i32 [[TMP51]], 16
; CHECK-NEXT:    [[TMP56:%.*]] = extractelement <2 x i16> [[TMP50]], i32 0
; CHECK-NEXT:    [[TMP66:%.*]] = sext i16 [[TMP56]] to i32
; CHECK-NEXT:    [[ADD31_3:%.*]] = add i32 [[SHL30_3]], [[TMP66]]
; CHECK-NEXT:    [[ARRAYIDX32_3:%.*]] = getelementptr i8, ptr null, i64 3
; CHECK-NEXT:    [[ARRAYIDX34_3:%.*]] = getelementptr i8, ptr null, i64 3
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <2 x ptr> <ptr poison, ptr null>, ptr [[ARRAYIDX32_3]], i32 0
; CHECK-NEXT:    [[TMP54:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP53]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP57:%.*]] = zext <2 x i8> [[TMP54]] to <2 x i16>
; CHECK-NEXT:    [[TMP58:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX34_3]], i64 4, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP59:%.*]] = zext <2 x i8> [[TMP58]] to <2 x i16>
; CHECK-NEXT:    [[TMP60:%.*]] = sub <2 x i16> [[TMP57]], [[TMP59]]
; CHECK-NEXT:    [[TMP61:%.*]] = extractelement <2 x i16> [[TMP60]], i32 1
; CHECK-NEXT:    [[TMP62:%.*]] = sext i16 [[TMP61]] to i32
; CHECK-NEXT:    [[SHL42_3:%.*]] = shl i32 [[TMP62]], 16
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <2 x i16> [[TMP60]], i32 0
; CHECK-NEXT:    [[TMP64:%.*]] = sext i16 [[TMP63]] to i32
; CHECK-NEXT:    [[ADD43_3:%.*]] = add i32 [[SHL42_3]], [[TMP64]]
; CHECK-NEXT:    [[TMP65:%.*]] = extractelement <2 x i32> [[TMP16]], i32 0
; CHECK-NEXT:    [[TMP75:%.*]] = extractelement <2 x i32> [[TMP16]], i32 1
; CHECK-NEXT:    [[SUB45_3:%.*]] = sub i32 [[TMP65]], [[TMP75]]
; CHECK-NEXT:    [[SUB47_3:%.*]] = sub i32 [[ADD31_3]], [[ADD43_3]]
; CHECK-NEXT:    [[TMP67:%.*]] = shufflevector <2 x i32> [[TMP16]], <2 x i32> [[TMP29]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP68:%.*]] = shufflevector <2 x i32> [[TMP16]], <2 x i32> [[TMP17]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP47:%.*]] = add <2 x i32> [[TMP67]], [[TMP68]]
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <2 x i32> [[TMP29]], i32 [[ADD43_3]], i32 0
; CHECK-NEXT:    [[TMP71:%.*]] = insertelement <2 x i32> [[TMP17]], i32 [[ADD31_3]], i32 0
; CHECK-NEXT:    [[TMP72:%.*]] = add <2 x i32> [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP79:%.*]] = extractelement <2 x i32> [[TMP47]], i32 1
; CHECK-NEXT:    [[CONV:%.*]] = extractelement <2 x i32> [[TMP72]], i32 1
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[CONV]], [[TMP79]]
; CHECK-NEXT:    [[TMP86:%.*]] = extractelement <2 x i32> [[TMP47]], i32 0
; CHECK-NEXT:    [[TMP76:%.*]] = extractelement <2 x i32> [[TMP72]], i32 0
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[TMP76]], [[TMP86]]
; CHECK-NEXT:    [[TMP77:%.*]] = sub <2 x i32> [[TMP47]], [[TMP72]]
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <2 x i32> [[TMP30]], i32 [[SUB47_3]], i32 0
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <2 x i32> [[TMP30]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <2 x i32> [[TMP92]], i32 [[SUB45_3]], i32 0
; CHECK-NEXT:    [[TMP81:%.*]] = add <2 x i32> [[TMP91]], [[TMP80]]
; CHECK-NEXT:    [[TMP82:%.*]] = sub <2 x i32> [[TMP80]], [[TMP91]]
; CHECK-NEXT:    [[ADD94:%.*]] = add i32 [[ADD48_3]], [[ADD48_2]]
; CHECK-NEXT:    [[SUB102:%.*]] = sub i32 [[ADD48_2]], [[ADD48_3]]
; CHECK-NEXT:    [[TMP83:%.*]] = extractelement <2 x i32> [[TMP33]], i32 0
; CHECK-NEXT:    [[SHR_I49_2:%.*]] = lshr i32 [[TMP83]], 15
...
; CHECK-NEXT:    [[TMP84:%.*]] = extractelement <2 x i32> [[TMP81]], i32 0
; CHECK-NEXT:    [[TMP85:%.*]] = extractelement <2 x i32> [[TMP81]], i32 1
; CHECK-NEXT:    [[ADD78_2:%.*]] = add i32 [[TMP84]], [[TMP85]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP85]], [[TMP84]]
; CHECK-NEXT:    [[TMP107:%.*]] = extractelement <2 x i32> [[TMP6]], i32 0
...
; CHECK-NEXT:    [[TMP101:%.*]] = extractelement <2 x i32> [[TMP77]], i32 0
; CHECK-NEXT:    [[TMP111:%.*]] = extractelement <2 x i32> [[TMP77]], i32 1
; CHECK-NEXT:    [[ADD94_4:%.*]] = add i32 [[TMP101]], [[TMP111]]
...
; CHECK-NEXT:    [[TMP89:%.*]] = extractelement <2 x i32> [[TMP82]], i32 0
; CHECK-NEXT:    [[TMP90:%.*]] = extractelement <2 x i32> [[TMP82]], i32 1
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[TMP89]], [[TMP90]]
; CHECK-NEXT:    [[TMP228:%.*]] = sub i32 [[TMP90]], [[TMP89]]
...
; CHECK-NEXT:    [[TMP93:%.*]] = load <8 x i8>, ptr [[PIX2]], align 1
; CHECK-NEXT:    [[TMP94:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP113:%.*]] = zext <2 x i8> [[TMP94]] to <2 x i32>
; CHECK-NEXT:    [[TMP114:%.*]] = load <4 x i8>, ptr [[ARRAYIDX3]], align 1
; CHECK-NEXT:    [[TMP116:%.*]] = shufflevector <4 x i8> [[TMP114]], <4 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP98:%.*]] = zext <2 x i8> [[TMP116]] to <2 x i32>
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP117:%.*]] = zext <2 x i8> [[TMP99]] to <2 x i32>
; CHECK-NEXT:    [[TMP87:%.*]] = sub <2 x i32> [[TMP98]], [[TMP117]]
; CHECK-NEXT:    [[TMP88:%.*]] = shl <2 x i32> [[TMP87]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP118:%.*]] = zext <2 x i8> [[TMP103]] to <2 x i32>
; CHECK-NEXT:    [[TMP119:%.*]] = shufflevector <4 x i8> [[TMP114]], <4 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP106:%.*]] = zext <2 x i8> [[TMP119]] to <2 x i32>
; CHECK-NEXT:    [[TMP120:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP121:%.*]] = zext <2 x i8> [[TMP120]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP106]], [[TMP121]]
; CHECK-NEXT:    [[TMP96:%.*]] = shl <2 x i32> [[TMP95]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP112:%.*]] = sub <2 x i32> [[TMP97]], [[TMP118]]
; CHECK-NEXT:    [[TMP104:%.*]] = add <2 x i32> [[TMP96]], [[TMP112]]
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV1]], i32 0
; CHECK-NEXT:    [[TMP115:%.*]] = sub <2 x i32> [[TMP100]], [[TMP113]]
; CHECK-NEXT:    [[TMP200:%.*]] = add <2 x i32> [[TMP88]], [[TMP115]]
...
; CHECK-NEXT:    [[SUB51:%.*]] = sub i32 [[TMP238]], [[TMP143]]
; CHECK-NEXT:    [[TMP122:%.*]] = extractelement <2 x i32> [[TMP105]], i32 0
; CHECK-NEXT:    [[TMP108:%.*]] = extractelement <2 x i32> [[TMP105]], i32 1
; CHECK-NEXT:    [[TMP173:%.*]] = add i32 [[TMP108]], [[TMP122]]
; CHECK-NEXT:    [[SUB60:%.*]] = sub i32 [[TMP122]], [[TMP108]]
...
; CHECK-NEXT:    [[TMP126:%.*]] = load <8 x i8>, ptr [[ADD_PTR644]], align 1
; CHECK-NEXT:    [[TMP127:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP134:%.*]] = zext <2 x i8> [[TMP127]] to <2 x i32>
; CHECK-NEXT:    [[TMP129:%.*]] = load <4 x i8>, ptr [[ARRAYIDX3_1]], align 1
; CHECK-NEXT:    [[TMP130:%.*]] = shufflevector <4 x i8> [[TMP129]], <4 x i8> poison, <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP131:%.*]] = zext <2 x i8> [[TMP130]] to <2 x i32>
; CHECK-NEXT:    [[TMP132:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP133:%.*]] = zext <2 x i8> [[TMP132]] to <2 x i32>
; CHECK-NEXT:    [[TMP124:%.*]] = sub <2 x i32> [[TMP131]], [[TMP133]]
; CHECK-NEXT:    [[TMP125:%.*]] = shl <2 x i32> [[TMP124]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP142:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP144:%.*]] = zext <2 x i8> [[TMP142]] to <2 x i32>
; CHECK-NEXT:    [[TMP138:%.*]] = shufflevector <4 x i8> [[TMP129]], <4 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP139:%.*]] = zext <2 x i8> [[TMP138]] to <2 x i32>
; CHECK-NEXT:    [[TMP147:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP141:%.*]] = zext <2 x i8> [[TMP147]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = sub <2 x i32> [[TMP139]], [[TMP141]]
; CHECK-NEXT:    [[TMP136:%.*]] = shl <2 x i32> [[TMP135]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP145:%.*]] = sub <2 x i32> [[TMP137]], [[TMP144]]
; CHECK-NEXT:    [[TMP150:%.*]] = add <2 x i32> [[TMP136]], [[TMP145]]
; CHECK-NEXT:    [[TMP140:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP148:%.*]] = sub <2 x i32> [[TMP140]], [[TMP134]]
; CHECK-NEXT:    [[TMP149:%.*]] = add <2 x i32> [[TMP125]], [[TMP148]]
; CHECK-NEXT:    [[TMP257:%.*]] = add <2 x i32> [[TMP150]], [[TMP149]]
; CHECK-NEXT:    [[TMP151:%.*]] = sub <2 x i32> [[TMP149]], [[TMP150]]
; CHECK-NEXT:    [[TMP156:%.*]] = extractelement <2 x i32> [[TMP257]], i32 0
; CHECK-NEXT:    [[TMP146:%.*]] = extractelement <2 x i32> [[TMP257]], i32 1
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP146]], [[TMP156]]
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP156]], [[TMP146]]
; CHECK-NEXT:    [[TMP157:%.*]] = extractelement <2 x i32> [[TMP151]], i32 0
; CHECK-NEXT:    [[TMP155:%.*]] = extractelement <2 x i32> [[TMP151]], i32 1
; CHECK-NEXT:    [[TMP174:%.*]] = add i32 [[TMP155]], [[TMP157]]
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP157]], [[TMP155]]
; CHECK-NEXT:    [[SHR_I54:%.*]] = lshr i32 [[TMP146]], 15
; CHECK-NEXT:    [[AND_I55:%.*]] = and i32 [[SHR_I54]], 65537
; CHECK-NEXT:    [[MUL_I56:%.*]] = mul i32 [[AND_I55]], 65535
; CHECK-NEXT:    [[TMP152:%.*]] = lshr <2 x i32> [[TMP110]], <i32 15, i32 15>
; CHECK-NEXT:    [[TMP153:%.*]] = and <2 x i32> [[TMP152]], <i32 65537, i32 65537>
; CHECK-NEXT:    [[TMP154:%.*]] = mul <2 x i32> [[TMP153]], <i32 65535, i32 65535>
...
; CHECK-NEXT:    [[XOR_I:%.*]] = xor i32 [[ADD_I]], [[TMP83]]
...
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP174]], [[TMP173]]
...
; CHECK-NEXT:    [[TMP166:%.*]] = shufflevector <2 x i32> [[TMP19]], <2 x i32> [[TMP151]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP181:%.*]] = shufflevector <2 x i32> [[TMP77]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP175:%.*]] = insertelement <2 x i32> [[TMP181]], i32 [[SUB51]], i32 1
; CHECK-NEXT:    [[TMP176:%.*]] = insertelement <2 x i32> [[TMP77]], i32 [[SUB51_1]], i32 1
; CHECK-NEXT:    [[TMP194:%.*]] = sub <2 x i32> [[TMP175]], [[TMP176]]
...
; CHECK-NEXT:    [[TMP266:%.*]] = add <2 x i32> [[TMP154]], [[TMP248]]
...
; CHECK-NEXT:    [[TMP189:%.*]] = extractelement <2 x i32> [[TMP267]], i32 0
; CHECK-NEXT:    [[ADD110_2:%.*]] = add i32 [[ADD108_2]], [[TMP189]]
; CHECK-NEXT:    [[TMP190:%.*]] = extractelement <2 x i32> [[TMP267]], i32 1
; CHECK-NEXT:    [[ADD112_2:%.*]] = add i32 [[ADD110_2]], [[TMP190]]
; CHECK-NEXT:    [[ADD113_2:%.*]] = add i32 [[ADD112_2]], [[XOR_I63_2]]
; CHECK-NEXT:    [[SUB59:%.*]] = add i32 [[SUB59_1]], [[SUB60]]
; CHECK-NEXT:    [[TMP229:%.*]] = sub i32 [[SUB60]], [[SUB59_1]]
...
; CHECK-NEXT:    [[TMP204:%.*]] = extractelement <2 x i32> [[TMP287]], i32 0
; CHECK-NEXT:    [[ADD110_3:%.*]] = add i32 [[ADD108_3]], [[TMP204]]
