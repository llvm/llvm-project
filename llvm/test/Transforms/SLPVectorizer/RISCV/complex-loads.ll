...
; UNALIGNED_VEC_MEM-NEXT:    [[SUB30:%.*]] = sub i32 [[CONV4_4]], [[CONV6_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB29_4:%.*]] = sub i32 [[CONV4_2]], [[CONV6_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB29_5:%.*]] = sub i32 [[CONV14_3]], [[CONV16_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB29_6:%.*]] = sub i32 [[CONV14_2]], [[CONV16_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB42:%.*]] = sub i32 [[CONV26_3]], [[CONV28_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[SUB41_5:%.*]] = sub i32 [[CONV26_2]], [[CONV28_2]]
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP56:%.*]] = load <8 x i8>, ptr [[PIX1]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP58:%.*]] = load <8 x i8>, ptr [[PIX2]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP59:%.*]] = zext <8 x i8> [[TMP56]] to <8 x i32>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP60:%.*]] = zext <8 x i8> [[TMP58]] to <8 x i32>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP74:%.*]] = sub <8 x i32> [[TMP59]], [[TMP60]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP75:%.*]] = shl <8 x i32> [[TMP74]], <i32 0, i32 0, i32 0, i32 0, i32 16, i32 16, i32 16, i32 16>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP78:%.*]] = load <8 x i8>, ptr [[ADD_PTR3]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP107:%.*]] = load <8 x i8>, ptr [[ADD_PTR644]], align 1
; UNALIGNED_VEC_MEM-NEXT:    [[TMP108:%.*]] = zext <8 x i8> [[TMP78]] to <8 x i32>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP109:%.*]] = zext <8 x i8> [[TMP107]] to <8 x i32>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP110:%.*]] = sub <8 x i32> [[TMP108]], [[TMP109]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP111:%.*]] = shl <8 x i32> [[TMP110]], <i32 0, i32 0, i32 0, i32 0, i32 16, i32 16, i32 16, i32 16>
; UNALIGNED_VEC_MEM-NEXT:    [[SHL42_3:%.*]] = shl i32 [[SUB41_3]], 16
; UNALIGNED_VEC_MEM-NEXT:    [[SHL42_6:%.*]] = shl i32 [[SUB41_6]], 16
; UNALIGNED_VEC_MEM-NEXT:    [[ADD19_3:%.*]] = add i32 [[SHL31]], [[SUB12_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD19_2:%.*]] = add i32 [[SHL30_4]], [[SUB12_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP112:%.*]] = shufflevector <8 x i32> [[TMP75]], <8 x i32> poison, <2 x i32> <i32 4, i32 5>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP113:%.*]] = shufflevector <8 x i32> [[TMP74]], <8 x i32> poison, <2 x i32> <i32 0, i32 1>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP114:%.*]] = add <2 x i32> [[TMP112]], [[TMP113]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP115:%.*]] = shufflevector <8 x i32> [[TMP111]], <8 x i32> poison, <2 x i32> <i32 4, i32 5>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP116:%.*]] = shufflevector <8 x i32> [[TMP110]], <8 x i32> poison, <2 x i32> <i32 0, i32 1>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP49:%.*]] = add <2 x i32> [[TMP115]], [[TMP116]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_4:%.*]] = add i32 [[SHL30_5]], [[SUB36_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_2:%.*]] = add i32 [[SHL30_6]], [[SUB36_2]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31_4:%.*]] = add i32 [[SHL43]], [[SUB24_4]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31_5:%.*]] = add i32 [[SHL42_5]], [[SUB24_5]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP50:%.*]] = shufflevector <8 x i32> [[TMP75]], <8 x i32> poison, <2 x i32> <i32 6, i32 7>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP51:%.*]] = shufflevector <8 x i32> [[TMP74]], <8 x i32> poison, <2 x i32> <i32 2, i32 3>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP52:%.*]] = add <2 x i32> [[TMP50]], [[TMP51]]
; UNALIGNED_VEC_MEM-NEXT:    [[TMP53:%.*]] = shufflevector <8 x i32> [[TMP111]], <8 x i32> poison, <2 x i32> <i32 6, i32 7>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP54:%.*]] = shufflevector <8 x i32> [[TMP110]], <8 x i32> poison, <2 x i32> <i32 2, i32 3>
; UNALIGNED_VEC_MEM-NEXT:    [[TMP55:%.*]] = add <2 x i32> [[TMP53]], [[TMP54]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_3:%.*]] = add i32 [[SHL42_3]], [[SUB36_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_5:%.*]] = add i32 [[SHL42_6]], [[SUB36_5]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD_3:%.*]] = extractelement <2 x i32> [[TMP114]], i32 0
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31_3:%.*]] = extractelement <2 x i32> [[TMP114]], i32 1
; UNALIGNED_VEC_MEM-NEXT:    [[SUB45:%.*]] = sub i32 [[ADD_3]], [[ADD31_3]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD_2:%.*]] = extractelement <2 x i32> [[TMP49]], i32 0
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31_2:%.*]] = extractelement <2 x i32> [[TMP49]], i32 1
...
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31:%.*]] = extractelement <2 x i32> [[TMP52]], i32 0
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43:%.*]] = extractelement <2 x i32> [[TMP52]], i32 1
; UNALIGNED_VEC_MEM-NEXT:    [[SUB47:%.*]] = sub i32 [[ADD31]], [[ADD43]]
; UNALIGNED_VEC_MEM-NEXT:    [[ADD31_1:%.*]] = extractelement <2 x i32> [[TMP55]], i32 0
; UNALIGNED_VEC_MEM-NEXT:    [[ADD43_1:%.*]] = extractelement <2 x i32> [[TMP55]], i32 1
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP118:%.*]] = shufflevector <8 x i32> [[TMP108]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; UNALIGNED_VEC_MEM-NEXT:    [[TMP79:%.*]] = shufflevector <8 x i32> [[TMP59]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
