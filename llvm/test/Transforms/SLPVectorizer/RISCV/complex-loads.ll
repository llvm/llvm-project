...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i64> <i64 4, i64 6>
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, <2 x ptr> [[TMP5]], <2 x i64> <i64 4, i64 6>
; CHECK-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr i8, ptr [[PIX1]], i64 1
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, <2 x ptr> [[TMP5]], <2 x i64> <i64 1, i64 3>
; CHECK-NEXT:    [[TMP93:%.*]] = getelementptr i8, <2 x ptr> [[TMP2]], <2 x i64> <i64 5, i64 7>
...
; CHECK-NEXT:    [[SUB45_2:%.*]] = extractelement <2 x i32> [[TMP26]], i32 0
; CHECK-NEXT:    [[SUB47_2:%.*]] = extractelement <2 x i32> [[TMP26]], i32 1
; CHECK-NEXT:    [[ADD44_2:%.*]] = add i32 [[SUB47_2]], [[SUB45_2]]
...
; CHECK-NEXT:    [[SUB47_3:%.*]] = sub i32 [[TMP41]], [[TMP42]]
; CHECK-NEXT:    [[ADD48_4:%.*]] = add i32 [[ADD46_2]], [[ADD44_2]]
...
; CHECK-NEXT:    [[TMP76:%.*]] = sub <2 x i32> [[TMP58]], [[TMP73]]
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <2 x i32> [[TMP74]], i32 0
; CHECK-NEXT:    [[TMP75:%.*]] = extractelement <2 x i32> [[TMP74]], i32 1
; CHECK-NEXT:    [[ADD48_5:%.*]] = add i32 [[TMP77]], [[TMP75]]
...
; CHECK-NEXT:    [[TMP86:%.*]] = zext <2 x i8> [[TMP91]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP94:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP93]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP92:%.*]] = zext <2 x i8> [[TMP94]] to <2 x i32>
; CHECK-NEXT:    [[TMP128:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP9]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP164:%.*]] = zext <2 x i8> [[TMP128]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP92]], [[TMP164]]
...
; CHECK-NEXT:    [[TMP165:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV1]], i32 0
; CHECK-NEXT:    [[TMP101:%.*]] = sub <2 x i32> [[TMP165]], [[TMP82]]
; CHECK-NEXT:    [[TMP170:%.*]] = add <2 x i32> [[TMP88]], [[TMP101]]
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <2 x i32> [[TMP104]], <2 x i32> [[TMP170]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP106:%.*]] = add <2 x i32> [[TMP104]], [[TMP170]]
; CHECK-NEXT:    [[TMP105:%.*]] = sub <2 x i32> [[TMP170]], [[TMP104]]
...
; CHECK-NEXT:    [[TMP173:%.*]] = add <2 x i32> [[TMP125]], [[TMP141]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP139]], [[TMP173]]
; CHECK-NEXT:    [[TMP189:%.*]] = sub <2 x i32> [[TMP173]], [[TMP139]]
...
; CHECK-NEXT:    [[TMP151:%.*]] = insertelement <2 x i32> [[TMP150]], i32 [[SUB47_3]], i32 1
; CHECK-NEXT:    [[TMP152:%.*]] = insertelement <2 x i32> [[TMP105]], i32 [[SUB59_2]], i32 1
; CHECK-NEXT:    [[TMP153:%.*]] = add <2 x i32> [[TMP151]], [[TMP152]]
; CHECK-NEXT:    [[TMP154:%.*]] = shufflevector <2 x i32> [[TMP189]], <2 x i32> [[TMP76]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP155:%.*]] = shufflevector <2 x i32> [[TMP189]], <2 x i32> [[TMP76]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[SUB106_1:%.*]] = extractelement <2 x i32> [[TMP163]], i32 0
; CHECK-NEXT:    [[SUB102_1:%.*]] = extractelement <2 x i32> [[TMP163]], i32 1
...
; CHECK-NEXT:    [[ADD_I62_1:%.*]] = add i32 [[MUL_I61_4]], [[SUB106_3]]
...
; CHECK-NEXT:    [[TMP185:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP143]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP186:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> [[TMP143]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[ADD94_4:%.*]] = add i32 [[TMP195]], [[TMP188]]
...
; CHECK-NEXT:    [[TMP222:%.*]] = insertelement <2 x i32> [[TMP150]], i32 [[SUB59_2]], i32 0
; CHECK-NEXT:    [[TMP225:%.*]] = insertelement <2 x i32> [[TMP105]], i32 [[SUB47_3]], i32 0
; CHECK-NEXT:    [[TMP226:%.*]] = sub <2 x i32> [[TMP222]], [[TMP225]]
; CHECK-NEXT:    [[TMP227:%.*]] = shufflevector <2 x i32> [[TMP76]], <2 x i32> [[TMP189]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP212:%.*]] = shufflevector <2 x i32> [[TMP76]], <2 x i32> [[TMP189]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP237:%.*]] = sub <2 x i32> [[TMP227]], [[TMP212]]
; CHECK-NEXT:    [[TMP214:%.*]] = extractelement <2 x i32> [[TMP226]], i32 0
; CHECK-NEXT:    [[TMP239:%.*]] = extractelement <2 x i32> [[TMP237]], i32 0
; CHECK-NEXT:    [[TMP240:%.*]] = shufflevector <2 x i32> [[TMP237]], <2 x i32> [[TMP226]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[ADD94_3:%.*]] = add i32 [[TMP239]], [[TMP214]]
; CHECK-NEXT:    [[TMP217:%.*]] = extractelement <2 x i32> [[TMP226]], i32 1
; CHECK-NEXT:    [[TMP218:%.*]] = extractelement <2 x i32> [[TMP237]], i32 1
; CHECK-NEXT:    [[TMP219:%.*]] = shufflevector <2 x i32> [[TMP237]], <2 x i32> [[TMP226]], <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[ADD94_5:%.*]] = add i32 [[TMP218]], [[TMP217]]
; CHECK-NEXT:    [[TMP220:%.*]] = sub <2 x i32> [[TMP226]], [[TMP237]]
...
; CHECK-NEXT:    [[TMP100:%.*]] = add <2 x i32> [[TMP242]], [[TMP224]]
; CHECK-NEXT:    [[TMP99:%.*]] = sub <2 x i32> [[TMP242]], [[TMP224]]
...
; CHECK-NEXT:    [[SUB106_4:%.*]] = sub i32 [[TMP229]], [[TMP228]]
...
; CHECK-NEXT:    [[TMP233:%.*]] = add <2 x i32> [[TMP232]], [[TMP213]]
...
; CHECK-NEXT:    [[ADD_I62_3:%.*]] = add i32 [[MUL_I61_3]], [[SUB106_4]]
