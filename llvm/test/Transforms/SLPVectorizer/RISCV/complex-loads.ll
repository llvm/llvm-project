...
; CHECK-NEXT:    [[TMP16:%.*]] = shl <2 x i32> [[TMP15]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP17:%.*]] = add <2 x i32> [[TMP16]], [[TMP10]]
...
; CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_3]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = zext <2 x i8> [[TMP43]] to <2 x i32>
; CHECK-NEXT:    [[TMP36:%.*]] = sub <2 x i32> [[TMP39]], [[TMP40]]
; CHECK-NEXT:    [[TMP37:%.*]] = shl <2 x i32> [[TMP36]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = add <2 x i32> [[TMP37]], [[TMP35]]
...
; CHECK-NEXT:    [[TMP47:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i16>
; CHECK-NEXT:    [[TMP55:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 [[ARRAYIDX22_3]], i64 4, <2 x i1> <i1 true, i1 true>, i32 2)
; CHECK-NEXT:    [[TMP56:%.*]] = zext <2 x i8> [[TMP55]] to <2 x i16>
; CHECK-NEXT:    [[TMP50:%.*]] = sub <2 x i16> [[TMP47]], [[TMP56]]
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <2 x i16> [[TMP50]], i32 1
; CHECK-NEXT:    [[TMP52:%.*]] = sext i16 [[TMP51]] to i32
; CHECK-NEXT:    [[SHL30_3:%.*]] = shl i32 [[TMP52]], 16
; CHECK-NEXT:    [[TMP53:%.*]] = extractelement <2 x i16> [[TMP50]], i32 0
; CHECK-NEXT:    [[TMP54:%.*]] = sext i16 [[TMP53]] to i32
; CHECK-NEXT:    [[ADD31_3:%.*]] = add i32 [[SHL30_3]], [[TMP54]]
; CHECK-NEXT:    [[ARRAYIDX32_3:%.*]] = getelementptr i8, ptr null, i64 3
; CHECK-NEXT:    [[ARRAYIDX34_3:%.*]] = getelementptr i8, ptr null, i64 3
; CHECK-NEXT:    [[TMP48:%.*]] = insertelement <2 x ptr> <ptr poison, ptr null>, ptr [[ARRAYIDX32_3]], i32 0
; CHECK-NEXT:    [[TMP49:%.*]] = call <2 x i8> @llvm.masked.gather.v2i8.v2p0(<2 x ptr> [[TMP48]], i32 1, <2 x i1> <i1 true, i1 true>, <2 x i8> poison)
; CHECK-NEXT:    [[TMP57:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i16>
...
; CHECK-NEXT:    [[TMP65:%.*]] = extractelement <2 x i32> [[TMP72]], i32 0
...
; CHECK-NEXT:    [[TMP67:%.*]] = shufflevector <2 x i32> [[TMP72]], <2 x i32> [[TMP29]], <2 x i32> <i32 1, i32 2>
; CHECK-NEXT:    [[TMP68:%.*]] = shufflevector <2 x i32> [[TMP72]], <2 x i32> [[TMP17]], <2 x i32> <i32 0, i32 2>
; CHECK-NEXT:    [[TMP69:%.*]] = add <2 x i32> [[TMP67]], [[TMP68]]
...
; CHECK-NEXT:    [[TMP74:%.*]] = add <2 x i32> [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP73:%.*]] = extractelement <2 x i32> [[TMP69]], i32 1
; CHECK-NEXT:    [[ADD46_2:%.*]] = extractelement <2 x i32> [[TMP74]], i32 1
; CHECK-NEXT:    [[ADD48_2:%.*]] = add i32 [[ADD46_2]], [[TMP73]]
; CHECK-NEXT:    [[TMP86:%.*]] = extractelement <2 x i32> [[TMP69]], i32 0
; CHECK-NEXT:    [[TMP76:%.*]] = extractelement <2 x i32> [[TMP74]], i32 0
; CHECK-NEXT:    [[ADD48_3:%.*]] = add i32 [[TMP76]], [[TMP86]]
; CHECK-NEXT:    [[TMP77:%.*]] = sub <2 x i32> [[TMP69]], [[TMP74]]
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <2 x i32> [[TMP30]], i32 [[SUB47_3]], i32 0
; CHECK-NEXT:    [[TMP79:%.*]] = shufflevector <2 x i32> [[TMP30]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <2 x i32> [[TMP79]], i32 [[SUB45_3]], i32 0
...
; CHECK-NEXT:    [[TMP92:%.*]] = extractelement <2 x i32> [[TMP77]], i32 0
; CHECK-NEXT:    [[TMP101:%.*]] = extractelement <2 x i32> [[TMP77]], i32 1
; CHECK-NEXT:    [[ADD94_4:%.*]] = add i32 [[TMP92]], [[TMP101]]
...
; CHECK-NEXT:    [[ADD94_5:%.*]] = add i32 [[TMP89]], [[TMP90]]
; CHECK-NEXT:    [[SUB102_3:%.*]] = sub i32 [[TMP90]], [[TMP89]]
...
; CHECK-NEXT:    [[TMP98:%.*]] = zext <2 x i8> [[TMP94]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP112:%.*]] = zext <2 x i8> [[TMP116]] to <2 x i32>
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP113:%.*]] = zext <2 x i8> [[TMP99]] to <2 x i32>
; CHECK-NEXT:    [[TMP87:%.*]] = sub <2 x i32> [[TMP112]], [[TMP113]]
...
; CHECK-NEXT:    [[TMP117:%.*]] = zext <2 x i8> [[TMP119]] to <2 x i32>
; CHECK-NEXT:    [[TMP120:%.*]] = shufflevector <8 x i8> [[TMP93]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP118:%.*]] = zext <2 x i8> [[TMP120]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP117]], [[TMP118]]
; CHECK-NEXT:    [[TMP96:%.*]] = shl <2 x i32> [[TMP95]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP111:%.*]] = sub <2 x i32> [[TMP97]], [[TMP115]]
; CHECK-NEXT:    [[TMP104:%.*]] = add <2 x i32> [[TMP96]], [[TMP111]]
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV1]], i32 0
; CHECK-NEXT:    [[TMP121:%.*]] = sub <2 x i32> [[TMP100]], [[TMP98]]
; CHECK-NEXT:    [[TMP200:%.*]] = add <2 x i32> [[TMP88]], [[TMP121]]
...
; CHECK-NEXT:    [[ADD55:%.*]] = add i32 [[TMP142]], [[TMP122]]
; CHECK-NEXT:    [[SUB59:%.*]] = sub i32 [[TMP122]], [[TMP142]]
...
; CHECK-NEXT:    [[TMP133:%.*]] = zext <2 x i8> [[TMP130]] to <2 x i32>
; CHECK-NEXT:    [[TMP132:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 4, i32 6>
; CHECK-NEXT:    [[TMP134:%.*]] = zext <2 x i8> [[TMP132]] to <2 x i32>
; CHECK-NEXT:    [[TMP124:%.*]] = sub <2 x i32> [[TMP133]], [[TMP134]]
; CHECK-NEXT:    [[TMP125:%.*]] = shl <2 x i32> [[TMP124]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP144:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP139:%.*]] = zext <2 x i8> [[TMP144]] to <2 x i32>
; CHECK-NEXT:    [[TMP138:%.*]] = shufflevector <4 x i8> [[TMP129]], <4 x i8> poison, <2 x i32> <i32 1, i32 3>
; CHECK-NEXT:    [[TMP141:%.*]] = zext <2 x i8> [[TMP138]] to <2 x i32>
; CHECK-NEXT:    [[TMP147:%.*]] = shufflevector <8 x i8> [[TMP126]], <8 x i8> poison, <2 x i32> <i32 5, i32 7>
; CHECK-NEXT:    [[TMP149:%.*]] = zext <2 x i8> [[TMP147]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = sub <2 x i32> [[TMP141]], [[TMP149]]
; CHECK-NEXT:    [[TMP136:%.*]] = shl <2 x i32> [[TMP135]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP150:%.*]] = sub <2 x i32> [[TMP137]], [[TMP139]]
; CHECK-NEXT:    [[TMP145:%.*]] = add <2 x i32> [[TMP136]], [[TMP150]]
; CHECK-NEXT:    [[TMP140:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP156:%.*]] = sub <2 x i32> [[TMP140]], [[TMP131]]
; CHECK-NEXT:    [[TMP148:%.*]] = add <2 x i32> [[TMP125]], [[TMP156]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP145]], [[TMP148]]
; CHECK-NEXT:    [[TMP151:%.*]] = sub <2 x i32> [[TMP148]], [[TMP145]]
; CHECK-NEXT:    [[TMP157:%.*]] = extractelement <2 x i32> [[TMP143]], i32 0
; CHECK-NEXT:    [[TMP146:%.*]] = extractelement <2 x i32> [[TMP143]], i32 1
; CHECK-NEXT:    [[ADD48_1:%.*]] = add i32 [[TMP146]], [[TMP157]]
; CHECK-NEXT:    [[SUB51_1:%.*]] = sub i32 [[TMP157]], [[TMP146]]
; CHECK-NEXT:    [[TMP158:%.*]] = extractelement <2 x i32> [[TMP151]], i32 0
; CHECK-NEXT:    [[TMP155:%.*]] = extractelement <2 x i32> [[TMP151]], i32 1
; CHECK-NEXT:    [[ADD55_1:%.*]] = add i32 [[TMP155]], [[TMP158]]
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[TMP158]], [[TMP155]]
...
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[ADD55_1]], [[ADD55]]
...
; CHECK-NEXT:    [[TMP173:%.*]] = extractelement <2 x i32> [[TMP178]], i32 1
; CHECK-NEXT:    [[ADD112_1:%.*]] = add i32 [[ADD110_1]], [[TMP173]]
; CHECK-NEXT:    [[ADD113_1:%.*]] = add i32 [[ADD112_1]], [[XOR_I63_1]]
; CHECK-NEXT:    [[ADD94_2:%.*]] = add i32 [[SUB51_1]], [[SUB51]]
; CHECK-NEXT:    [[TMP174:%.*]] = shufflevector <2 x i32> [[TMP77]], <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
; CHECK-NEXT:    [[TMP175:%.*]] = insertelement <2 x i32> [[TMP174]], i32 [[SUB51]], i32 1
...
; CHECK-NEXT:    [[TMP266:%.*]] = add <2 x i32> [[TMP154]], [[TMP221]]
...
; CHECK-NEXT:    [[TMP204:%.*]] = extractelement <2 x i32> [[TMP234]], i32 0
