...
; CHECK-NEXT:    [[TMP21:%.*]] = zext <2 x i8> [[TMP15]] to <2 x i32>
; CHECK-NEXT:    [[TMP24:%.*]] = sub <2 x i32> [[TMP13]], [[TMP21]]
...
; CHECK-NEXT:    [[TMP38:%.*]] = add <2 x i32> [[TMP31]], [[TMP19]]
; CHECK-NEXT:    [[TMP34:%.*]] = sub <2 x i32> [[TMP19]], [[TMP31]]
...
; CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i8>, ptr null, align 1
; CHECK-NEXT:    [[TMP33:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP49:%.*]] = load <2 x i8>, ptr null, align 1
; CHECK-NEXT:    [[TMP39:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP50:%.*]] = shufflevector <2 x i32> [[TMP42]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_3]], align 1
; CHECK-NEXT:    [[TMP45:%.*]] = zext <2 x i8> [[TMP56]] to <2 x i32>
; CHECK-NEXT:    [[TMP46:%.*]] = sub <2 x i32> [[TMP50]], [[TMP45]]
; CHECK-NEXT:    [[TMP57:%.*]] = shl <2 x i32> [[TMP46]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = add <2 x i32> [[TMP57]], [[TMP40]]
...
; CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i8>, ptr [[ARRAYIDX20_3]], align 1
; CHECK-NEXT:    [[TMP52:%.*]] = zext <2 x i8> [[TMP51]] to <2 x i32>
; CHECK-NEXT:    [[TMP53:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_3]], align 1
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP53]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = sub <2 x i32> [[TMP52]], [[TMP54]]
...
; CHECK-NEXT:    [[TMP59:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27_3]], align 1
; CHECK-NEXT:    [[TMP60:%.*]] = zext <2 x i8> [[TMP59]] to <2 x i32>
; CHECK-NEXT:    [[TMP69:%.*]] = sub <2 x i32> [[TMP58]], [[TMP60]]
...
; CHECK-NEXT:    [[TMP68:%.*]] = shufflevector <2 x i32> [[TMP38]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <2 x i32> [[TMP68]], i32 [[ADD44_3]], i32 0
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <2 x i32> [[TMP38]], i32 [[ADD46_3]], i32 0
; CHECK-NEXT:    [[TMP71:%.*]] = sub <2 x i32> [[TMP77]], [[TMP78]]
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <2 x i32> [[TMP34]], i32 [[SUB47_3]], i32 0
; CHECK-NEXT:    [[TMP73:%.*]] = shufflevector <2 x i32> [[TMP34]], <2 x i32> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP109:%.*]] = insertelement <2 x i32> [[TMP73]], i32 [[SUB45_3]], i32 0
; CHECK-NEXT:    [[TMP16:%.*]] = add <2 x i32> [[TMP85]], [[TMP109]]
; CHECK-NEXT:    [[TMP76:%.*]] = sub <2 x i32> [[TMP109]], [[TMP85]]
...
; CHECK-NEXT:    [[TMP111:%.*]] = extractelement <2 x i32> [[TMP16]], i32 1
; CHECK-NEXT:    [[ADD94_1:%.*]] = add i32 [[TMP107]], [[TMP111]]
; CHECK-NEXT:    [[SUB102_1:%.*]] = sub i32 [[TMP111]], [[TMP107]]
...
; CHECK-NEXT:    [[TMP81:%.*]] = extractelement <2 x i32> [[TMP71]], i32 0
; CHECK-NEXT:    [[TMP82:%.*]] = extractelement <2 x i32> [[TMP71]], i32 1
; CHECK-NEXT:    [[ADD94_4:%.*]] = add i32 [[TMP81]], [[TMP82]]
; CHECK-NEXT:    [[SUB102_2:%.*]] = sub i32 [[TMP82]], [[TMP81]]
...
; CHECK-NEXT:    [[TMP83:%.*]] = extractelement <2 x i32> [[TMP76]], i32 0
; CHECK-NEXT:    [[TMP84:%.*]] = extractelement <2 x i32> [[TMP76]], i32 1
; CHECK-NEXT:    [[ADD94_5:%.*]] = add i32 [[TMP83]], [[TMP84]]
; CHECK-NEXT:    [[SUB102_3:%.*]] = sub i32 [[TMP84]], [[TMP83]]
...
; CHECK-NEXT:    [[TMP89:%.*]] = zext <2 x i8> [[TMP113]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP87:%.*]] = sub <2 x i32> [[TMP115]], [[TMP119]]
...
; CHECK-NEXT:    [[TMP103:%.*]] = zext <2 x i8> [[TMP120]] to <2 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP101]], [[TMP103]]
; CHECK-NEXT:    [[TMP96:%.*]] = shl <2 x i32> [[TMP95]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV33]], i32 1
; CHECK-NEXT:    [[TMP155:%.*]] = sub <2 x i32> [[TMP97]], [[TMP99]]
; CHECK-NEXT:    [[TMP105:%.*]] = add <2 x i32> [[TMP96]], [[TMP155]]
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[CONV1]], i32 0
; CHECK-NEXT:    [[TMP156:%.*]] = sub <2 x i32> [[TMP86]], [[TMP89]]
...
; CHECK-NEXT:    [[TMP124:%.*]] = sub <2 x i32> [[TMP160]], [[TMP162]]
...
; CHECK-NEXT:    [[TMP168:%.*]] = zext <2 x i8> [[TMP167]] to <2 x i32>
; CHECK-NEXT:    [[TMP135:%.*]] = sub <2 x i32> [[TMP166]], [[TMP168]]
; CHECK-NEXT:    [[TMP136:%.*]] = shl <2 x i32> [[TMP135]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV33_1]], i32 1
; CHECK-NEXT:    [[TMP169:%.*]] = sub <2 x i32> [[TMP137]], [[TMP164]]
; CHECK-NEXT:    [[TMP170:%.*]] = add <2 x i32> [[TMP136]], [[TMP169]]
; CHECK-NEXT:    [[TMP117:%.*]] = insertelement <2 x i32> [[TMP110]], i32 [[CONV_1]], i32 0
; CHECK-NEXT:    [[TMP171:%.*]] = sub <2 x i32> [[TMP117]], [[TMP123]]
; CHECK-NEXT:    [[TMP172:%.*]] = add <2 x i32> [[TMP125]], [[TMP171]]
; CHECK-NEXT:    [[TMP143:%.*]] = add <2 x i32> [[TMP170]], [[TMP172]]
; CHECK-NEXT:    [[TMP121:%.*]] = sub <2 x i32> [[TMP172]], [[TMP170]]
...
; THR15-NEXT:    [[TMP49:%.*]] = zext <2 x i8> [[TMP34]] to <2 x i32>
; THR15-NEXT:    [[TMP40:%.*]] = sub <2 x i32> [[TMP38]], [[TMP49]]
; THR15-NEXT:    [[TMP50:%.*]] = call <2 x i8> @llvm.experimental.vp.strided.load.v2i8.p0.i64(ptr align 1 null, i64 4, <2 x i1> <i1 true, i1 true>, i32 2)
; THR15-NEXT:    [[TMP53:%.*]] = zext <2 x i8> [[TMP50]] to <2 x i32>
; THR15-NEXT:    [[TMP64:%.*]] = shufflevector <2 x i32> [[TMP53]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; THR15-NEXT:    [[TMP39:%.*]] = load <2 x i8>, ptr [[ARRAYIDX5_3]], align 1
; THR15-NEXT:    [[TMP59:%.*]] = zext <2 x i8> [[TMP39]] to <2 x i32>
; THR15-NEXT:    [[TMP41:%.*]] = sub <2 x i32> [[TMP64]], [[TMP59]]
...
; THR15-NEXT:    [[TMP61:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i32>
; THR15-NEXT:    [[TMP48:%.*]] = load <2 x i8>, ptr [[ARRAYIDX22_3]], align 1
; THR15-NEXT:    [[TMP67:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; THR15-NEXT:    [[TMP55:%.*]] = sub <2 x i32> [[TMP61]], [[TMP67]]
; THR15-NEXT:    [[TMP51:%.*]] = insertelement <2 x i8> poison, i8 [[TMP44]], i32 0
; THR15-NEXT:    [[TMP52:%.*]] = insertelement <2 x i8> [[TMP51]], i8 [[TMP45]], i32 1
; THR15-NEXT:    [[TMP94:%.*]] = zext <2 x i8> [[TMP52]] to <2 x i32>
; THR15-NEXT:    [[TMP54:%.*]] = load <2 x i8>, ptr [[ARRAYIDX27_3]], align 1
; THR15-NEXT:    [[TMP108:%.*]] = zext <2 x i8> [[TMP54]] to <2 x i32>
; THR15-NEXT:    [[TMP56:%.*]] = sub <2 x i32> [[TMP94]], [[TMP108]]
; THR15-NEXT:    [[TMP57:%.*]] = shl <2 x i32> [[TMP56]], <i32 16, i32 16>
; THR15-NEXT:    [[TMP58:%.*]] = add <2 x i32> [[TMP57]], [[TMP55]]
; THR15-NEXT:    [[TMP109:%.*]] = extractelement <2 x i32> [[TMP43]], i32 0
; THR15-NEXT:    [[TMP60:%.*]] = extractelement <2 x i32> [[TMP43]], i32 1
; THR15-NEXT:    [[ADD44_3:%.*]] = add i32 [[TMP60]], [[TMP109]]
; THR15-NEXT:    [[SUB45_3:%.*]] = sub i32 [[TMP109]], [[TMP60]]
; THR15-NEXT:    [[TMP66:%.*]] = extractelement <2 x i32> [[TMP58]], i32 0
; THR15-NEXT:    [[TMP62:%.*]] = extractelement <2 x i32> [[TMP58]], i32 1
; THR15-NEXT:    [[ADD46_3:%.*]] = add i32 [[TMP62]], [[TMP66]]
; THR15-NEXT:    [[SUB47_3:%.*]] = sub i32 [[TMP66]], [[TMP62]]
