...
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <8 x i32> [[TMP95]], <8 x i32> [[TMP96]], <16 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7, i32 12, i32 8, i32 13, i32 9, i32 14, i32 10, i32 15, i32 11>
...
; THR15-NEXT:    [[TMP15:%.*]] = add <4 x i32> [[TMP14]], [[TMP47]]
; THR15-NEXT:    [[TMP49:%.*]] = sub <4 x i32> [[TMP14]], [[TMP47]]
; THR15-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> [[TMP15]], <4 x i32> [[TMP49]], <4 x i32> <i32 2, i32 7, i32 0, i32 5>
...
; THR15-NEXT:    [[TMP55:%.*]] = add <4 x i32> [[TMP54]], [[TMP62]]
; THR15-NEXT:    [[TMP56:%.*]] = sub <4 x i32> [[TMP54]], [[TMP62]]
...
; THR15-NEXT:    [[TMP96:%.*]] = sub <8 x i32> [[TMP94]], [[TMP90]]
; THR15-NEXT:    [[TMP102:%.*]] = shufflevector <8 x i32> [[TMP95]], <8 x i32> [[TMP96]], <16 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7, i32 12, i32 8, i32 13, i32 9, i32 14, i32 10, i32 15, i32 11>
