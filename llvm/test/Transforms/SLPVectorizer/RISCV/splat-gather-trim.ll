...
; RUN: opt -passes=slp-vectorizer -S -mtriple=riscv64 --mattr=+v,+zvl256b < %s | FileCheck %s  --check-prefixes=CHECK,DEFAULT
; RUN: opt -passes=slp-vectorizer -S -mtriple=riscv64 --mattr=+v,+zvl256b -slp-threshold=-2 < %s | FileCheck %s --check-prefixes=CHECK,THRESH
