...
; CHECK-SAME: i32 [[TMP0:%.*]]) {
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> <i32 0, i32 poison, i32 0, i32 0>, i32 [[TMP0]], i64 1
...
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <32 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>, i32 [[TMP11]], i64 30
...
; CHECK-NEXT:    [[TMP53:%.*]] = extractelement <32 x i1> [[TMP20]], i64 31
; CHECK-NEXT:    [[TMP74:%.*]] = and i1 false, [[TMP53]]
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <32 x i1> [[TMP20]], i64 30
; CHECK-NEXT:    [[TMP75:%.*]] = and i1 false, [[TMP19]]
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <32 x i1> [[TMP20]], i64 29
; CHECK-NEXT:    [[TMP22:%.*]] = and i1 false, [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = extractelement <32 x i1> [[TMP20]], i64 28
; CHECK-NEXT:    [[TMP24:%.*]] = and i1 false, [[TMP23]]
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <32 x i1> [[TMP20]], i64 27
; CHECK-NEXT:    [[TMP26:%.*]] = and i1 false, [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <32 x i1> [[TMP20]], i64 26
; CHECK-NEXT:    [[TMP28:%.*]] = and i1 false, [[TMP27]]
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <32 x i1> [[TMP20]], i64 25
; CHECK-NEXT:    [[TMP30:%.*]] = and i1 false, [[TMP29]]
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <32 x i1> [[TMP20]], i64 24
; CHECK-NEXT:    [[TMP32:%.*]] = and i1 false, [[TMP31]]
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <32 x i1> [[TMP20]], i64 23
; CHECK-NEXT:    [[TMP34:%.*]] = and i1 false, [[TMP33]]
; CHECK-NEXT:    [[TMP35:%.*]] = extractelement <32 x i1> [[TMP20]], i64 22
; CHECK-NEXT:    [[TMP36:%.*]] = and i1 false, [[TMP35]]
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <32 x i1> [[TMP20]], i64 21
; CHECK-NEXT:    [[TMP38:%.*]] = and i1 false, [[TMP37]]
; CHECK-NEXT:    [[TMP39:%.*]] = extractelement <32 x i1> [[TMP20]], i64 20
; CHECK-NEXT:    [[TMP40:%.*]] = and i1 false, [[TMP39]]
; CHECK-NEXT:    [[TMP41:%.*]] = extractelement <32 x i1> [[TMP20]], i64 19
; CHECK-NEXT:    [[TMP42:%.*]] = and i1 false, [[TMP41]]
; CHECK-NEXT:    [[TMP43:%.*]] = extractelement <32 x i1> [[TMP20]], i64 18
; CHECK-NEXT:    [[TMP44:%.*]] = and i1 false, [[TMP43]]
; CHECK-NEXT:    [[TMP45:%.*]] = extractelement <32 x i1> [[TMP20]], i64 17
; CHECK-NEXT:    [[TMP46:%.*]] = and i1 false, [[TMP45]]
; CHECK-NEXT:    [[TMP47:%.*]] = extractelement <32 x i1> [[TMP20]], i64 16
; CHECK-NEXT:    [[TMP48:%.*]] = and i1 false, [[TMP47]]
; CHECK-NEXT:    [[TMP49:%.*]] = extractelement <32 x i1> [[TMP20]], i64 15
; CHECK-NEXT:    [[TMP50:%.*]] = and i1 false, [[TMP49]]
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <32 x i1> [[TMP20]], i64 14
; CHECK-NEXT:    [[TMP52:%.*]] = and i1 false, [[TMP51]]
; CHECK-NEXT:    [[TMP80:%.*]] = icmp eq i32 [[TMP6]], 0
; CHECK-NEXT:    [[TMP54:%.*]] = extractelement <32 x i1> [[TMP20]], i64 13
; CHECK-NEXT:    [[TMP55:%.*]] = and i1 false, [[TMP54]]
; CHECK-NEXT:    [[TMP56:%.*]] = extractelement <32 x i1> [[TMP20]], i64 12
; CHECK-NEXT:    [[TMP57:%.*]] = and i1 false, [[TMP56]]
; CHECK-NEXT:    [[TMP58:%.*]] = extractelement <32 x i1> [[TMP20]], i64 11
; CHECK-NEXT:    [[TMP59:%.*]] = and i1 false, [[TMP58]]
; CHECK-NEXT:    [[TMP60:%.*]] = extractelement <32 x i1> [[TMP20]], i64 10
; CHECK-NEXT:    [[TMP61:%.*]] = and i1 false, [[TMP60]]
; CHECK-NEXT:    [[TMP62:%.*]] = extractelement <32 x i1> [[TMP20]], i64 9
; CHECK-NEXT:    [[TMP63:%.*]] = and i1 false, [[TMP62]]
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <32 x i1> [[TMP20]], i64 8
; CHECK-NEXT:    [[TMP65:%.*]] = and i1 false, [[TMP64]]
; CHECK-NEXT:    [[TMP66:%.*]] = extractelement <32 x i1> [[TMP20]], i64 7
; CHECK-NEXT:    [[TMP67:%.*]] = and i1 false, [[TMP66]]
; CHECK-NEXT:    [[TMP68:%.*]] = extractelement <32 x i1> [[TMP20]], i64 6
; CHECK-NEXT:    [[TMP69:%.*]] = and i1 false, [[TMP68]]
; CHECK-NEXT:    [[TMP70:%.*]] = extractelement <32 x i1> [[TMP20]], i64 5
; CHECK-NEXT:    [[TMP71:%.*]] = and i1 false, [[TMP70]]
; CHECK-NEXT:    [[TMP72:%.*]] = extractelement <32 x i1> [[TMP20]], i64 4
; CHECK-NEXT:    [[TMP73:%.*]] = and i1 false, [[TMP72]]
; CHECK-NEXT:    [[TMP77:%.*]] = extractelement <32 x i32> [[TMP18]], i64 0
