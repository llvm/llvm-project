...
; CHECK-NEXT:    [[TMP9:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x double> [[TMP9]], i32 1
; CHECK-NEXT:    [[TMP8:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x double> [[TMP8]], i32 1
...
; CHECK-NEXT:    [[TMP13:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <8 x double> [[TMP13]], i32 2
; CHECK-NEXT:    [[TMP12:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <8 x double> [[TMP12]], i32 2
...
; CHECK-NEXT:    [[TMP17:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <8 x double> [[TMP17]], i32 3
; CHECK-NEXT:    [[TMP16:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <8 x double> [[TMP16]], i32 3
...
; CHECK-NEXT:    [[TMP21:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <8 x double> [[TMP21]], i32 4
; CHECK-NEXT:    [[TMP20:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <8 x double> [[TMP20]], i32 4
...
; CHECK-NEXT:    [[TMP25:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP22:%.*]] = extractelement <8 x double> [[TMP25]], i32 5
; CHECK-NEXT:    [[TMP24:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP23:%.*]] = extractelement <8 x double> [[TMP24]], i32 5
...
; CHECK-NEXT:    [[TMP29:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <8 x double> [[TMP29]], i32 6
; CHECK-NEXT:    [[TMP28:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <8 x double> [[TMP28]], i32 6
...
; CHECK-NEXT:    [[TMP33:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 0
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x double> [[TMP33]], i32 7
; CHECK-NEXT:    [[TMP32:%.*]] = extractvalue { <8 x double>, <8 x double> } [[TMP1]], 1
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <8 x double> [[TMP32]], i32 7
