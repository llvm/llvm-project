...
; RUN: opt < %s -slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64    -slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,SSE
; RUN: opt < %s -slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v2 -slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,SSE
; RUN: opt < %s -slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v3 -slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX
; RUN: opt < %s -slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v4 -slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX
