...
; CHECK-NEXT:  [[BB:.*]]:
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <4 x i8> <i8 0, i8 0, i8 0, i8 poison>, i8 [[LOAD_311_I]], i64 3
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x i8> <i8 poison, i8 poison, i8 0, i8 0>, i8 [[LOAD_311_I]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x i64> poison, i64 [[ALLOCA_PROMOTED344]], i64 0
...
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <2 x i64> [[TMP6]], i64 [[SHL_I_I_PEEL]], i64 0
...
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <4 x i64> [[TMP12]], i64 1
...
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <8 x i8> [[TMP4]], i64 0
...
; CHECK:       [[BB12_3_I]]:
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <8 x i8> [[TMP4]], i64 1
...
; CHECK:       [[BB12_4_I]]:
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <8 x i8> [[TMP4]], i64 2
...
; CHECK:       [[BB12_5_I]]:
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i8> [[TMP4]], i64 3
...
; CHECK:       [[BB12_7_I]]:
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i8> [[TMP4]], i64 4
; CHECK-NEXT:    [[ICMP5_8_I1:%.*]] = icmp eq i8 [[TMP30]], 0
; CHECK-NEXT:    br i1 [[ICMP5_8_I1]], label %[[BB12_8_I]], label %[[BB8_8_I:.*]]
; CHECK:       [[BB8_8_I]]:
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <4 x i8> [[TMP1]], i8 [[LOAD_8_I]], i64 1
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i8> poison, i8 [[LOAD_8_I]], i64 0
...
; CHECK-NEXT:    [[TMP28]] = insertelement <2 x i64> [[TMP2]], i64 [[GETELEMENTPTR_I_I_PROMOTED346]], i64 1
