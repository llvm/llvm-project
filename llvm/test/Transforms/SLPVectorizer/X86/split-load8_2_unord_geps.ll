...
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <16 x ptr> poison, ptr [[P:%.*]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <16 x ptr> [[TMP1]], <16 x ptr> poison, <16 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <16 x i32> [[TMP0]], <16 x i32> poison, <16 x i32> <i32 1, i32 3, i32 5, i32 7, i32 9, i32 11, i32 13, i32 15, i32 0, i32 2, i32 4, i32 6, i32 8, i32 10, i32 12, i32 14>
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i32, <16 x ptr> [[TMP2]], <16 x i32> [[TMP3]]
