...
; SSE-NEXT:    [[TMP1:%.*]] = load <2 x i16>, ptr [[DATA]], align 2
...
; SSE-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i16> [[TMP1]], <2 x i16> poison, <4 x i32> <i32 0, i32 poison, i32 1, i32 poison>
; SSE-NEXT:    [[TMP3:%.*]] = insertelement <4 x i16> [[TMP2]], i16 [[T2]], i32 3
; SSE-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i16> [[TMP3]], <4 x i16> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
; SSE-NEXT:    [[TMP5:%.*]] = shufflevector <4 x i16> [[TMP4]], <4 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; SSE-NEXT:    [[VECINIT4_I_I:%.*]] = insertelement <8 x i16> [[TMP5]], i16 [[T3]], i64 4
...
; AVX-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds i16, ptr [[DATA:%.*]], i64 4
; AVX-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds i16, ptr [[DATA]], i64 6
; AVX-NEXT:    [[TMP1:%.*]] = load <4 x i16>, ptr [[DATA]], align 2
; AVX-NEXT:    [[TMP2:%.*]] = load <2 x i16>, ptr [[ARRAYIDX4]], align 2
; AVX-NEXT:    [[T6:%.*]] = load i16, ptr [[ARRAYIDX6]], align 2
; AVX-NEXT:    [[TMP3:%.*]] = shufflevector <4 x i16> [[TMP1]], <4 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP4:%.*]] = shufflevector <2 x i16> [[TMP2]], <2 x i16> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i16> [[TMP2]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP6:%.*]] = shufflevector <4 x i16> [[TMP1]], <4 x i16> [[TMP5]], <8 x i32> <i32 0, i32 poison, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison>
; AVX-NEXT:    [[TMP7:%.*]] = insertelement <8 x i16> [[TMP6]], i16 [[T6]], i32 7
; AVX-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i16> [[TMP7]], <8 x i16> poison, <8 x i32> <i32 0, i32 0, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; AVX-NEXT:    [[T7:%.*]] = bitcast <8 x i16> [[TMP8]] to <2 x i64>
