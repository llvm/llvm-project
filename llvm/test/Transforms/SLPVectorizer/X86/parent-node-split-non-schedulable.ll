...
; CHECK:       [[IF_END]]:
; CHECK-NEXT:    [[TMP3:%.*]] = phi <3 x i32> [ zeroinitializer, %[[ENTRY]] ], [ [[TMP36:%.*]], %[[WHILE_COND_PREHEADER:.*]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
; CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i32> [[TMP2]], <4 x i32> [[TMP4]], <4 x i32> <i32 0, i32 6, i32 2, i32 3>
...
; CHECK:       [[R]]:
; CHECK-NEXT:    [[TMP6:%.*]] = phi <4 x i32> [ [[TMP5]], %[[IF_END9]] ], [ [[TMP7]], %[[IF_END]] ]
...
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <3 x i32> [[TMP3]], i64 0
...
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <8 x i32> <i32 poison, i32 poison, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 poison>, <8 x i32> [[TMP29]], <8 x i32> <i32 10, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 poison>
; CHECK-NEXT:    br label %[[AH:.*]]
; CHECK:       [[AH]]:
; CHECK-NEXT:    [[TMP21:%.*]] = phi <8 x i32> [ [[TMP34:%.*]], %[[AH]] ], [ [[TMP18]], %[[IF_END14]] ]
; CHECK-NEXT:    [[TMP35:%.*]] = extractelement <8 x i32> [[TMP21]], i64 5
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i32> [[TMP21]], i64 7
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[TMP35]], [[TMP30]]
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <8 x i32> [[TMP21]], i64 4
; CHECK-NEXT:    [[TMP38:%.*]] = or i32 [[ADD]], [[TMP37]]
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <8 x i32> [[TMP21]], i64 6
; CHECK-NEXT:    [[OR27:%.*]] = or i32 [[TMP38]], [[TMP33]]
; CHECK-NEXT:    store i32 [[OR27]], ptr [[C]], align 4
; CHECK-NEXT:    [[TMP34]] = insertelement <8 x i32> [[TMP32]], i32 [[TMP0]], i64 7
...
; CHECK-NEXT:    [[TMP36]] = shufflevector <8 x i32> [[TMP21]], <8 x i32> poison, <3 x i32> <i32 2, i32 3, i32 0>
; CHECK-NEXT:    br label %[[IF_END]]
;
entry:
  br label %if.end
