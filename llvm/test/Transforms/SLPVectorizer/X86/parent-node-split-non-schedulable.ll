...
; CHECK:       [[IF_END]]:
; CHECK-NEXT:    [[TMP3:%.*]] = phi <3 x i32> [ zeroinitializer, %[[ENTRY]] ], [ [[TMP39:%.*]], %[[WHILE_COND_PREHEADER:.*]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <2 x i32> <i32 2, i32 poison>
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i32> <i32 poison, i32 1>, <2 x i32> [[TMP4]], <2 x i32> <i32 2, i32 1>
; CHECK-NEXT:    br i1 [[TOBOOL4_NOT]], label %[[R:.*]], label %[[IF_END9:.*]]
; CHECK:       [[IF_END9]]:
; CHECK-NEXT:    [[CONV11:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <2 x i32> <i32 poison, i32 0>, i32 [[CONV11]], i64 0
; CHECK-NEXT:    br label %[[R]]
; CHECK:       [[R]]:
; CHECK-NEXT:    [[TMP7:%.*]] = phi <2 x i32> [ <i32 1, i32 0>, %[[IF_END9]] ], [ [[TMP2]], %[[IF_END]] ]
; CHECK-NEXT:    [[TMP17:%.*]] = phi <2 x i32> [ [[TMP9]], %[[IF_END9]] ], [ [[TMP5]], %[[IF_END]] ]
; CHECK-NEXT:    [[B_0_PH:%.*]] = extractelement <3 x i32> [[TMP3]], i64 2
...
; CHECK:       [[IF_END14]]:
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <3 x i32> [[TMP3]], i64 0
; CHECK-NEXT:    [[AND17:%.*]] = and i32 [[TMP18]], 1
; CHECK-NEXT:    [[DIV20:%.*]] = sdiv i32 [[AND17]], [[TMP0]]
; CHECK-NEXT:    [[TMP10:%.*]] = load i32, ptr [[C]], align 4
; CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <2 x i32> <i32 1, i32 poison>
...
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <2 x i32> [[TMP17]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i32> poison, i32 [[NOT]], i64 2
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <4 x i32> [[TMP23]], <4 x i32> [[TMP6]], <4 x i32> <i32 poison, i32 poison, i32 2, i32 5>
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <2 x i32> [[TMP7]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <4 x i32> [[TMP32]], <4 x i32> [[TMP25]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i32> <i32 0, i32 0, i32 poison, i32 0>, i32 [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <3 x i32> [[TMP3]], <3 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, <4 x i32> [[TMP28]], <4 x i32> <i32 6, i32 1, i32 2, i32 3>
; CHECK-NEXT:    br label %[[AH:.*]]
; CHECK:       [[AH]]:
; CHECK-NEXT:    [[TMP36:%.*]] = phi <4 x i32> [ [[TMP29]], %[[AH]] ], [ [[TMP16]], %[[IF_END14]] ]
; CHECK-NEXT:    [[TMP40:%.*]] = phi <4 x i32> [ [[TMP34]], %[[AH]] ], [ [[TMP26]], %[[IF_END14]] ]
; CHECK-NEXT:    [[TMP35:%.*]] = extractelement <4 x i32> [[TMP36]], i64 2
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <4 x i32> [[TMP40]], i64 2
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[TMP35]], [[TMP30]]
; CHECK-NEXT:    [[TMP37:%.*]] = extractelement <4 x i32> [[TMP36]], i64 1
; CHECK-NEXT:    [[TMP38:%.*]] = or i32 [[ADD]], [[TMP37]]
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <4 x i32> [[TMP36]], i64 3
; CHECK-NEXT:    [[OR27:%.*]] = or i32 [[TMP38]], [[TMP33]]
...
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <4 x i32> [[TMP40]], i64 3
; CHECK-NEXT:    [[CALL69:%.*]] = tail call i32 @s(i32 [[TMP31]])
; CHECK-NEXT:    [[TMP39]] = shufflevector <4 x i32> [[TMP40]], <4 x i32> [[TMP36]], <3 x i32> <i32 0, i32 1, i32 4>
; CHECK-NEXT:    br label %[[IF_END]]
;
entry:
  br label %if.end
