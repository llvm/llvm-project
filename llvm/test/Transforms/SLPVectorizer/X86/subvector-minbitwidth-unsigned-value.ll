...
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i1> poison, i1 [[V4]], i64 0
...
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <4 x float> [[TMP16]], i64 3
...
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <4 x i1> [[TMP20]], i64 3
; CHECK-NEXT:    [[NARROW:%.*]] = select i1 [[TMP21]], i1 [[TMP18]], i1 false
; CHECK-NEXT:    [[TMP24:%.*]] = zext i1 [[NARROW]] to i32
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <4 x float> [[TMP16]], <4 x float> poison, <3 x i32> <i32 0, i32 1, i32 2>
; CHECK-NEXT:    [[TMP27:%.*]] = fptoui <3 x float> [[TMP23]] to <3 x i32>
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i1> [[TMP20]], <4 x i1> poison, <3 x i32> <i32 0, i32 1, i32 2>
; CHECK-NEXT:    [[TMP26:%.*]] = select <3 x i1> [[TMP28]], <3 x i32> [[TMP27]], <3 x i32> zeroinitializer
; CHECK-NEXT:    [[NARROW1:%.*]] = extractelement <3 x i32> [[TMP26]], i64 2
; CHECK-NEXT:    [[TMP25:%.*]] = or i32 [[NARROW1]], [[TMP24]]
; CHECK-NEXT:    [[NARROW2:%.*]] = extractelement <3 x i32> [[TMP26]], i64 1
; CHECK-NEXT:    [[RV3:%.*]] = or i32 [[TMP25]], [[NARROW2]]
; CHECK-NEXT:    [[NARROW4:%.*]] = extractelement <3 x i32> [[TMP26]], i64 0
