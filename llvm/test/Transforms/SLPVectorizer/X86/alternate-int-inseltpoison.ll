...
; AVX1-NEXT:    [[TMP1:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <4 x i32> <i32 1, i32 2, i32 3, i32 5>
; AVX1-NEXT:    [[TMP2:%.*]] = sdiv <4 x i32> [[TMP1]], <i32 4, i32 8, i32 16, i32 4>
...
; AVX1-NEXT:    [[R3:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP3]], <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 poison, i32 11, i32 poison, i32 poison>
; AVX1-NEXT:    [[R4:%.*]] = insertelement <8 x i32> [[R3]], i32 [[AB4]], i32 4
; AVX1-NEXT:    [[R6:%.*]] = insertelement <8 x i32> [[R4]], i32 [[AB6]], i32 6
...
; AVX2-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <2 x i32> <i32 1, i32 5>
; AVX2-NEXT:    [[TMP9:%.*]] = sdiv <2 x i32> [[TMP8]], splat (i32 4)
...
; AVX2-NEXT:    [[TMP7:%.*]] = shufflevector <2 x i32> [[TMP9]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX2-NEXT:    [[R1:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 8, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX2-NEXT:    [[R5:%.*]] = shufflevector <8 x i32> [[R4]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 9, i32 6, i32 7>
...
; AVX512-NEXT:    [[TMP8:%.*]] = shufflevector <8 x i32> [[A]], <8 x i32> poison, <2 x i32> <i32 1, i32 5>
; AVX512-NEXT:    [[TMP9:%.*]] = sdiv <2 x i32> [[TMP8]], splat (i32 4)
...
; AVX512-NEXT:    [[TMP7:%.*]] = shufflevector <2 x i32> [[TMP9]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX512-NEXT:    [[R1:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 8, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX512-NEXT:    [[R5:%.*]] = shufflevector <8 x i32> [[R4]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 9, i32 6, i32 7>
