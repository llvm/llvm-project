...
; CHECK-NEXT:    [[OP_RDX2:%.*]] = fadd double [[TMP8]], [[TMP9]]
...
; CHECK-NEXT:    [[OP_RDX1:%.*]] = fadd double [[TMP15]], [[TMP12]]
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <8 x double> [[TMP7]], i64 3
; CHECK-NEXT:    [[OP_RDX4:%.*]] = fadd double [[OP_RDX1]], [[TMP13]]
...
; CHECK-NEXT:    [[OP_RDX3:%.*]] = fadd double [[TMP19]], [[TMP16]]
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <8 x double> [[TMP7]], i64 5
; CHECK-NEXT:    [[OP_RDX6:%.*]] = fadd double [[OP_RDX3]], [[TMP17]]
; CHECK-NEXT:    [[TMP22:%.*]] = fptrunc double [[OP_RDX6]] to float
; CHECK-NEXT:    [[TMP23:%.*]] = fpext float [[TMP22]] to double
; CHECK-NEXT:    [[L7:%.*]] = extractelement <8 x double> [[TMP7]], i64 6
; CHECK-NEXT:    [[OP_RDX7:%.*]] = fadd double [[TMP23]], [[L7]]
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x double> [[TMP7]], i64 7
; CHECK-NEXT:    [[OP_RDX8:%.*]] = fadd double [[OP_RDX7]], [[TMP21]]
; CHECK-NEXT:    [[TMP24:%.*]] = fptrunc double [[OP_RDX8]] to float
; CHECK-NEXT:    [[TMP25:%.*]] = fpext float [[TMP24]] to double
; CHECK-NEXT:    [[OP_RDX9:%.*]] = fadd double [[TMP25]], [[L8]]
; CHECK-NEXT:    ret double [[OP_RDX9]]
;
  %l0 = load double, ptr %x, align 8
  %a0 = fadd double %l0, 1.000000e+00
  %t0 = fptrunc double %a0 to float
