...
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <3 x double> poison, double [[TMP11]], i64 0
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <2 x double> [[TMP1]], <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <3 x double> [[TMP2]], <3 x double> [[TMP3]], <3 x i32> <i32 0, i32 3, i32 4>
; CHECK-NEXT:    [[OP_RDX2:%.*]] = call double @llvm.vector.reduce.fadd.v3f64(double -0.000000e+00, <3 x double> [[TMP4]])
; CHECK-NEXT:    [[TMP14:%.*]] = fptrunc double [[OP_RDX2]] to float
; CHECK-NEXT:    [[TMP15:%.*]] = fpext float [[TMP14]] to double
; CHECK-NEXT:    [[P3:%.*]] = getelementptr inbounds i8, ptr [[X]], i64 24
; CHECK-NEXT:    [[TMP6:%.*]] = load <2 x double>, ptr [[P3]], align 8
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <3 x double> poison, double [[TMP15]], i64 0
; CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <2 x double> [[TMP6]], <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <3 x double> [[TMP7]], <3 x double> [[TMP8]], <3 x i32> <i32 0, i32 3, i32 4>
; CHECK-NEXT:    [[OP_RDX4:%.*]] = call double @llvm.vector.reduce.fadd.v3f64(double -0.000000e+00, <3 x double> [[TMP9]])
; CHECK-NEXT:    [[TMP18:%.*]] = fptrunc double [[OP_RDX4]] to float
; CHECK-NEXT:    [[TMP19:%.*]] = fpext float [[TMP18]] to double
; CHECK-NEXT:    [[P5:%.*]] = getelementptr inbounds i8, ptr [[X]], i64 40
; CHECK-NEXT:    [[TMP16:%.*]] = load <2 x double>, ptr [[P5]], align 8
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <3 x double> poison, double [[TMP19]], i64 0
; CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <2 x double> [[TMP16]], <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <3 x double> [[TMP12]], <3 x double> [[TMP13]], <3 x i32> <i32 0, i32 3, i32 4>
; CHECK-NEXT:    [[OP_RDX6:%.*]] = call double @llvm.vector.reduce.fadd.v3f64(double -0.000000e+00, <3 x double> [[TMP17]])
