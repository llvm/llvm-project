...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <4 x i32> poison, i32 [[TMP30]], i64 0
...
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <4 x i32> [[TMP17]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_120:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP18]], i32 [[TMP15]])
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <4 x i32> [[TMP17]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_1:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP19]], i32 [[SPEC_SELECT8_120]])
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <4 x i32> [[TMP17]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_1:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP20]], i32 [[SPEC_SELECT8_1_1]])
; CHECK-NEXT:    [[TMP21:%.*]] = insertelement <4 x i32> poison, i32 [[TMP15]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = insertelement <4 x i32> [[TMP21]], i32 [[SPEC_SELECT8_120]], i64 1
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i32> [[TMP22]], i32 [[SPEC_SELECT8_1_1]], i64 2
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x i32> [[TMP23]], i32 [[SPEC_SELECT8_2_1]], i64 3
...
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <4 x i32> [[TMP17]], i64 3
...
; CHECK-NEXT:    [[TMP50:%.*]] = extractelement <4 x i32> [[TMP38]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_226:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP50]], i32 [[SPEC_SELECT8_3_1]])
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <4 x i32> [[TMP38]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_2:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP31]], i32 [[SPEC_SELECT8_226]])
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <4 x i32> [[TMP38]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_2:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP32]], i32 [[SPEC_SELECT8_1_2]])
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_1]], i64 0
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i32> [[TMP33]], i32 [[SPEC_SELECT8_226]], i64 1
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <4 x i32> [[TMP34]], i32 [[SPEC_SELECT8_1_2]], i64 2
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[SPEC_SELECT8_2_2]], i64 3
...
; CHECK-NEXT:    [[TMP39:%.*]] = extractelement <4 x i32> [[TMP38]], i64 3
...
; CHECK-NEXT:    [[TMP42:%.*]] = extractelement <4 x i32> [[TMP41]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_332:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP42]], i32 [[SPEC_SELECT8_3_2]])
; CHECK-NEXT:    [[TMP43:%.*]] = extractelement <4 x i32> [[TMP41]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_3:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP43]], i32 [[SPEC_SELECT8_332]])
; CHECK-NEXT:    [[TMP44:%.*]] = extractelement <4 x i32> [[TMP41]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_3:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP44]], i32 [[SPEC_SELECT8_1_3]])
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_2]], i64 0
; CHECK-NEXT:    [[TMP46:%.*]] = insertelement <4 x i32> [[TMP45]], i32 [[SPEC_SELECT8_332]], i64 1
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <4 x i32> [[TMP46]], i32 [[SPEC_SELECT8_1_3]], i64 2
; CHECK-NEXT:    [[TMP48:%.*]] = insertelement <4 x i32> [[TMP47]], i32 [[SPEC_SELECT8_2_3]], i64 3
...
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <4 x i32> [[TMP41]], i64 3
...
; CHECK-NEXT:    [[TMP54:%.*]] = extractelement <4 x i32> [[TMP53]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_4:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP54]], i32 [[SPEC_SELECT8_3_3]])
; CHECK-NEXT:    [[TMP55:%.*]] = extractelement <4 x i32> [[TMP53]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_4:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP55]], i32 [[SPEC_SELECT8_4]])
; CHECK-NEXT:    [[TMP74:%.*]] = extractelement <4 x i32> [[TMP53]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_4:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP74]], i32 [[SPEC_SELECT8_1_4]])
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_3]], i64 0
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <4 x i32> [[TMP57]], i32 [[SPEC_SELECT8_4]], i64 1
; CHECK-NEXT:    [[TMP59:%.*]] = insertelement <4 x i32> [[TMP58]], i32 [[SPEC_SELECT8_1_4]], i64 2
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <4 x i32> [[TMP59]], i32 [[SPEC_SELECT8_2_4]], i64 3
...
; CHECK-NEXT:    [[TMP63:%.*]] = extractelement <4 x i32> [[TMP53]], i64 3
...
; CHECK-NEXT:    [[TMP66:%.*]] = extractelement <4 x i32> [[TMP65]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_5:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP66]], i32 [[SPEC_SELECT8_3_4]])
; CHECK-NEXT:    [[TMP86:%.*]] = extractelement <4 x i32> [[TMP65]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_5:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP86]], i32 [[SPEC_SELECT8_5]])
; CHECK-NEXT:    [[TMP68:%.*]] = extractelement <4 x i32> [[TMP65]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_5:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP68]], i32 [[SPEC_SELECT8_1_5]])
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_4]], i64 0
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <4 x i32> [[TMP69]], i32 [[SPEC_SELECT8_5]], i64 1
; CHECK-NEXT:    [[TMP71:%.*]] = insertelement <4 x i32> [[TMP70]], i32 [[SPEC_SELECT8_1_5]], i64 2
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <4 x i32> [[TMP71]], i32 [[SPEC_SELECT8_2_5]], i64 3
...
; CHECK-NEXT:    [[TMP75:%.*]] = extractelement <4 x i32> [[TMP65]], i64 3
...
; CHECK-NEXT:    [[TMP98:%.*]] = extractelement <4 x i32> [[TMP77]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_6:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP98]], i32 [[SPEC_SELECT8_3_5]])
; CHECK-NEXT:    [[TMP79:%.*]] = extractelement <4 x i32> [[TMP77]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_6:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP79]], i32 [[SPEC_SELECT8_6]])
; CHECK-NEXT:    [[TMP80:%.*]] = extractelement <4 x i32> [[TMP77]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_6:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP80]], i32 [[SPEC_SELECT8_1_6]])
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_5]], i64 0
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <4 x i32> [[TMP81]], i32 [[SPEC_SELECT8_6]], i64 1
; CHECK-NEXT:    [[TMP83:%.*]] = insertelement <4 x i32> [[TMP82]], i32 [[SPEC_SELECT8_1_6]], i64 2
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <4 x i32> [[TMP83]], i32 [[SPEC_SELECT8_2_6]], i64 3
...
; CHECK-NEXT:    [[TMP87:%.*]] = extractelement <4 x i32> [[TMP77]], i64 3
...
; CHECK-NEXT:    [[TMP90:%.*]] = extractelement <4 x i32> [[TMP101]], i64 0
; CHECK-NEXT:    [[SPEC_SELECT8_7:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP90]], i32 [[SPEC_SELECT8_3_6]])
; CHECK-NEXT:    [[TMP91:%.*]] = extractelement <4 x i32> [[TMP101]], i64 1
; CHECK-NEXT:    [[SPEC_SELECT8_1_7:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP91]], i32 [[SPEC_SELECT8_7]])
; CHECK-NEXT:    [[TMP92:%.*]] = extractelement <4 x i32> [[TMP101]], i64 2
; CHECK-NEXT:    [[SPEC_SELECT8_2_7:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP92]], i32 [[SPEC_SELECT8_1_7]])
; CHECK-NEXT:    [[TMP93:%.*]] = insertelement <4 x i32> poison, i32 [[SPEC_SELECT8_3_6]], i64 0
; CHECK-NEXT:    [[TMP94:%.*]] = insertelement <4 x i32> [[TMP93]], i32 [[SPEC_SELECT8_7]], i64 1
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <4 x i32> [[TMP94]], i32 [[SPEC_SELECT8_1_7]], i64 2
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <4 x i32> [[TMP95]], i32 [[SPEC_SELECT8_2_7]], i64 3
...
; CHECK-NEXT:    [[TMP99:%.*]] = extractelement <4 x i32> [[TMP101]], i64 3
