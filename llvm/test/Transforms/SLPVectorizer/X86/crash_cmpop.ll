...
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <2 x float> [[TMP10]], i64 0
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <2 x float> [[TMP10]], i64 1
...
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <2 x float> [[TMP16]], float [[ADD13]], i64 0
