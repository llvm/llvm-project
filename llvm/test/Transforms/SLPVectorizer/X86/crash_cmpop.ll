...
; RUN: opt -slp-inst-count-check=true < %s -passes=slp-vectorizer -S | FileCheck %s
; RUN: opt -slp-inst-count-check=true < %s -passes=slp-vectorizer -S -mattr=+avx | FileCheck %s
