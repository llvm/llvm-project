...
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[ARG]], i64 0
...
; CHECK-NEXT:    [[ZEXT2:%.*]] = extractelement <2 x i64> [[TMP4]], i64 0
; CHECK-NEXT:    [[GETELEMENTPTR4:%.*]] = getelementptr i64, ptr addrspace(1) null, i64 [[ZEXT2]]
; CHECK-NEXT:    [[SEXT:%.*]] = extractelement <2 x i64> [[TMP4]], i64 1
