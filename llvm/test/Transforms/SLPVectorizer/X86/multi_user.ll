...
; CHECK-NEXT:    [[TMP4:%.*]] = add nsw <4 x i32> [[TMP3]], <i32 7, i32 8, i32 9, i32 10>
...
; CHECK-NEXT:    [[TMP7:%.*]] = add nsw i32 [[TMP1]], 11
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP8]], align 4
; CHECK-NEXT:    [[TMP10:%.*]] = add nsw i32 [[TMP7]], [[TMP9]]
