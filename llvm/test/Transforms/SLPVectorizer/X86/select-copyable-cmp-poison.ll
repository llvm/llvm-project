...
; CHECK:       [[BB4]]:
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <8 x i32> poison, i32 [[V2]], i64 1
...
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[F2354]], align 8
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[ARRAYIDX6]], align 8
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[ARRAYIDX62]], align 8
; CHECK-NEXT:    [[DOTFR5736:%.*]] = freeze i32 [[TMP4]]
; CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i32>, ptr [[F2882]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <4 x i32> [[TMP5]], <4 x i32> poison, <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[TMP7:%.*]] = freeze <2 x i32> [[TMP16]]
; CHECK-NEXT:    [[DOTFR5728:%.*]] = freeze i32 [[TMP6]]
; CHECK-NEXT:    [[TMP8:%.*]] = insertelement <8 x i32> [[TMP0]], i32 [[DOTFR5736]], i64 0
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <2 x i32> [[TMP7]], <2 x i32> poison, <8 x i32> <i32 1, i32 poison, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <8 x i32> [[TMP8]], <8 x i32> [[TMP17]], <8 x i32> <i32 0, i32 1, i32 poison, i32 8, i32 poison, i32 10, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP19:%.*]] = insertelement <8 x i32> [[TMP18]], i32 [[DOTFR5728]], i64 6
; CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP19]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 3, i32 0, i32 5, i32 6, i32 1>
; CHECK-NEXT:    [[TMP34:%.*]] = srem <8 x i32> [[TMP33]], splat (i32 46337)
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <8 x i32> [[TMP34]], <8 x i32> poison, <8 x i32> <i32 2, i32 1, i32 0, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP15:%.*]] = shufflevector <8 x i32> [[TMP34]], <8 x i32> poison, <8 x i32> <i32 2, i32 1, i32 0, i32 3, i32 0, i32 5, i32 6, i32 2>
; CHECK-NEXT:    [[TMP9:%.*]] = or <8 x i32> [[TMP15]], zeroinitializer
; CHECK-NEXT:    [[TMP10:%.*]] = icmp slt <8 x i32> [[TMP14]], zeroinitializer
...
; CHECK-NEXT:    [[TMP31:%.*]] = shufflevector <2 x i32> [[TMP32]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <4 x i32> [[TMP31]], i32 [[TMP13]], i64 2
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[TMP3]], i64 3
; CHECK-NEXT:    [[TMP37:%.*]] = freeze <4 x i32> [[TMP36]]
; CHECK-NEXT:    [[TMP38:%.*]] = srem <4 x i32> [[TMP37]], splat (i32 1)
; CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> zeroinitializer, <4 x i32> zeroinitializer, <4 x i32> [[TMP38]]
; CHECK-NEXT:    [[TMP40:%.*]] = shufflevector <8 x i32> [[TMP12]], <8 x i32> poison, <4 x i32> <i32 2, i32 5, i32 6, i32 3>
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <4 x i32> [[TMP39]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP42:%.*]] = shufflevector <4 x i32> [[TMP40]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i32> [[TMP39]], <4 x i32> [[TMP40]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; CHECK:       [[BB18]]:
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i32> [[TMP24]], i64 4
