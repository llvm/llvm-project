...
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <8 x i32> [[TMP31]], i32 [[DOTFR5726]], i64 6
...
; CHECK-NEXT:    [[TMP18:%.*]] = load i32, ptr [[ARRAYIDX6]], align 8
; CHECK-NEXT:    [[TMP19:%.*]] = load i32, ptr [[ARRAYIDX62]], align 8
; CHECK-NEXT:    [[TMP20:%.*]] = load <2 x i32>, ptr [[V5]], align 4
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <2 x i32> [[TMP20]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[TMP19]], i64 2
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <4 x i32> [[TMP43]], i32 [[TMP18]], i64 3
