...
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <2 x i32> [[TMP32]], <2 x i32> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <4 x i32> [[TMP18]], i32 [[TMP3]], i64 0
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[TMP5]], i64 3
...
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> [[TMP12]], <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
; CHECK-NEXT:    [[TMP19:%.*]] = shufflevector <4 x i32> [[TMP36]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <4 x i32> [[TMP17]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
...
; CHECK-NEXT:    [[TMP37:%.*]] = shufflevector <8 x i32> [[TMP22]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 4, i32 5, i32 6, i32 7, i32 2, i32 3>
; CHECK-NEXT:    [[TMP23:%.*]] = urem <8 x i32> [[TMP37]], splat (i32 46337)
