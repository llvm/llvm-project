...
; CHECK:       [[BB1]]:
; CHECK-NEXT:    [[TMP0:%.*]] = ashr <3 x i32> zeroinitializer, <i32 0, i32 1, i32 -1>
; CHECK-NEXT:    [[TMP6:%.*]] = add <3 x i32> zeroinitializer, <i32 0, i32 1, i32 -1>
; CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <3 x i32> [[TMP0]], <3 x i32> [[TMP6]], <3 x i32> <i32 3, i32 1, i32 5>
; CHECK-NEXT:    [[TMP3:%.*]] = shufflevector <3 x i32> [[TMP2]], <3 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
; CHECK-NEXT:    br label %[[BB6]]
; CHECK:       [[BB6]]:
; CHECK-NEXT:    [[TMP5:%.*]] = phi <4 x i32> [ <i32 0, i32 0, i32 poison, i32 0>, %[[BB]] ], [ [[TMP4]], %[[BB1]] ]
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x i32> [[TMP5]], i64 3
