...
; CHECK-NEXT:    [[TMP52:%.*]] = fneg reassoc nnan ninf nsz arcp afn double [[TMP25]]
; CHECK-NEXT:    store double 1.000000e+00, ptr [[TMP26]], align 8
; CHECK-NEXT:    [[TMP56:%.*]] = fadd reassoc nnan ninf nsz arcp afn double [[TMP38]], 1.000000e+00
; CHECK-NEXT:    [[TMP51:%.*]] = fadd reassoc nnan ninf nsz arcp afn double [[TMP42]], 1.000000e+00
; CHECK-NEXT:    store double [[TMP44]], ptr getelementptr inbounds nuw (i8, ptr @hexsh_, i64 224), align 8
; CHECK-NEXT:    [[TMP49:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP8]], [[TMP9]]
; CHECK-NEXT:    [[TMP50:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP8]], [[TMP10]]
; CHECK-NEXT:    [[TMP62:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP13]], [[TMP49]]
; CHECK-NEXT:    [[TMP61:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP13]], [[TMP50]]
; CHECK-NEXT:    [[TMP54:%.*]] = fadd reassoc nnan ninf nsz arcp afn double [[TMP50]], 1.000000e+00
; CHECK-NEXT:    [[TMP57:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP39]], [[TMP40]]
; CHECK-NEXT:    [[TMP82:%.*]] = fsub reassoc nnan ninf nsz arcp afn double [[TMP56]], [[TMP57]]
; CHECK-NEXT:    [[TMP68:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP32]], [[TMP40]]
; CHECK-NEXT:    [[TMP81:%.*]] = fsub reassoc nnan ninf nsz arcp afn double [[TMP51]], [[TMP68]]
; CHECK-NEXT:    [[TMP92:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP36]], [[TMP46]]
; CHECK-NEXT:    [[TMP63:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP36]], [[TMP62]]
; CHECK-NEXT:    [[TMP64:%.*]] = fadd reassoc nnan ninf nsz arcp afn double [[TMP92]], 1.000000e+00
; CHECK-NEXT:    [[TMP55:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP48]], [[TMP40]]
; CHECK-NEXT:    [[TMP67:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP36]], [[TMP61]]
; CHECK-NEXT:    [[TMP60:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP24]], [[TMP52]]
; CHECK-NEXT:    [[TMP66:%.*]] = fmul reassoc nnan ninf nsz arcp afn double [[TMP45]], [[TMP62]]
; CHECK-NEXT:    [[TMP69:%.*]] = fsub reassoc nnan ninf nsz arcp afn double [[TMP63]], [[TMP64]]
; CHECK-NEXT:    [[TMP65:%.*]] = fadd reassoc nnan ninf nsz arcp afn double [[TMP67]], 2.000000e+00
