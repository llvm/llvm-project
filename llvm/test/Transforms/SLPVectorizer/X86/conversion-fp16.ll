...
; CHECK-F16C-NEXT:    [[T0:%.*]] = extractelement <2 x half> [[TMP2]], i64 0
; CHECK-F16C-NEXT:    store half [[T0]], ptr [[D0]], align 2
; CHECK-F16C-NEXT:    [[T1:%.*]] = extractelement <2 x half> [[TMP2]], i64 1
...
; CHECK-AVX512-NEXT:    [[T0:%.*]] = extractelement <2 x half> [[TMP2]], i64 0
; CHECK-AVX512-NEXT:    store half [[T0]], ptr [[D0]], align 2
; CHECK-AVX512-NEXT:    [[T1:%.*]] = extractelement <2 x half> [[TMP2]], i64 1
