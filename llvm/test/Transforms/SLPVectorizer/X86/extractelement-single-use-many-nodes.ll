...
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> poison, double [[I]], i32 0
...
; CHECK:       bb115:
; CHECK-NEXT:    [[TMP22:%.*]] = fmul <2 x double> zeroinitializer, [[TMP3]]
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <2 x double> [[TMP22]], i32 0
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <2 x double> [[TMP22]], i32 1
; CHECK-NEXT:    [[I118:%.*]] = fadd double [[TMP19]], [[TMP20]]
; CHECK-NEXT:    [[TMP21:%.*]] = fmul <4 x double> zeroinitializer, [[TMP1]]
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <2 x double> [[TMP3]], <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <4 x double> <double 0.000000e+00, double 0.000000e+00, double 0.000000e+00, double poison>, <4 x double> [[TMP18]], <4 x i32> <i32 0, i32 1, i32 2, i32 5>
