...
; RUN: opt -slp-inst-count-check=true < %s -passes=slp-vectorizer -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <8 x i32> [[T65]], i32 [[T28]], i32 1
...
; CHECK-NEXT:    [[T701:%.*]] = insertelement <8 x i32> [[T69]], i32 [[T50]], i32 5
