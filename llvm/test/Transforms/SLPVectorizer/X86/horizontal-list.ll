...
; CHECK-NEXT:    [[TMP8:%.*]] = fmul reassoc nsz arcp contract afn <5 x float> [[TMP5]], [[TMP7]]
...
; THRESHOLD-NEXT:    [[TMP8:%.*]] = fmul reassoc nsz arcp contract afn <5 x float> [[TMP5]], [[TMP7]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = fmul reassoc nsz arcp contract afn <10 x float> [[TMP9]], [[TMP11]]
...
; THRESHOLD-NEXT:    [[TMP12:%.*]] = fmul reassoc nsz arcp contract afn <10 x float> [[TMP9]], [[TMP11]]
