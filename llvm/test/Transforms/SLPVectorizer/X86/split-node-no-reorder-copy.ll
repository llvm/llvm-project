...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <8 x float> poison, float [[TMP6]], i64 0
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <8 x float> [[TMP10]], float [[TMP7]], i64 1
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <8 x float> [[TMP11]], float [[TMP8]], i64 6
...
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <8 x float> [[TMP14]], float [[TMP9]], i64 7
...
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <16 x float> [[TMP19]], float [[TMP9]], i64 15
