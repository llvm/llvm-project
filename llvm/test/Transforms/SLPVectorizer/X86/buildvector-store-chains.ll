...
; Tests store chains containing both scalar stores and build-vector stores at
; adjacent addresses. CHECK lines cover full vector stores and cases that must
; stay narrow because retiled stores would cross a memory dependency.
