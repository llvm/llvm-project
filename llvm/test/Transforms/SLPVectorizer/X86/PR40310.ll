...
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <16 x i32> <i32 poison, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31, i32 31>, i32 [[PARAM:%.*]], i64 0
...
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <16 x i32> poison, i32 [[OP_RDX]], i64 0
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <16 x i32> [[TMP7]], i32 [[V44]], i64 1
