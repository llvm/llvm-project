...
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <4 x i64> poison, i64 [[CONV8_I_I]], i64 0
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i64> [[TMP3]], <4 x i64> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <4 x i64> poison, i64 [[TMP2]], i64 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <8 x i16> poison, i16 [[TMP9]], i64 0
