...
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x double> @llvm.sin.v2f64(<2 x double> [[TMP1]])
; CHECK-NEXT:    store <2 x double> [[TMP2]], ptr [[B:%.*]], align 8
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[A:%.*]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x double> @llvm.cos.v2f64(<2 x double> [[TMP1]])
; CHECK-NEXT:    store <2 x double> [[TMP2]], ptr [[B:%.*]], align 8
; CHECK-NEXT:    ret void
;
  %a0 = load double, ptr %a, align 8
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[A:%.*]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x double> @llvm.tan.v2f64(<2 x double> [[TMP1]])
; CHECK-NEXT:    store <2 x double> [[TMP2]], ptr [[B:%.*]], align 8
; CHECK-NEXT:    ret void
;
  %a0 = load double, ptr %a, align 8
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[A:%.*]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x double> @llvm.pow.v2f64(<2 x double> [[TMP1]], <2 x double> [[TMP1]])
; CHECK-NEXT:    store <2 x double> [[TMP2]], ptr [[B:%.*]], align 8
; CHECK-NEXT:    ret void
;
  %a0 = load double, ptr %a, align 8
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x double>, ptr [[A:%.*]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = call <2 x double> @llvm.exp2.v2f64(<2 x double> [[TMP1]])
; CHECK-NEXT:    store <2 x double> [[TMP2]], ptr [[B:%.*]], align 8
; CHECK-NEXT:    ret void
;
  %a0 = load double, ptr %a, align 8
