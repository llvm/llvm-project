...
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x double> [[TMP3]], i64 2
; CHECK-NEXT:    [[DOT012:%.*]] = fadd double [[DOT01]], [[TMP6]]
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <4 x double> [[TMP3]], i64 3
...
; SSE2-NEXT:    [[TMP4:%.*]] = extractelement <3 x double> [[TMP3]], i64 0
; SSE2-NEXT:    [[TMP5:%.*]] = extractelement <3 x double> [[TMP3]], i64 1
; SSE2-NEXT:    [[DOT01:%.*]] = fadd double [[TMP4]], [[TMP5]]
; SSE2-NEXT:    [[TMP6:%.*]] = extractelement <3 x double> [[TMP3]], i64 2
...
; SSE4-NEXT:    [[TMP4:%.*]] = extractelement <3 x double> [[TMP3]], i64 0
; SSE4-NEXT:    [[TMP5:%.*]] = extractelement <3 x double> [[TMP3]], i64 1
; SSE4-NEXT:    [[DOT01:%.*]] = fadd double [[TMP4]], [[TMP5]]
; SSE4-NEXT:    [[TMP6:%.*]] = extractelement <3 x double> [[TMP3]], i64 2
...
; AVX2-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[TMP3]], i64 0
; AVX2-NEXT:    [[DOT01:%.*]] = fadd double [[MUL0]], [[TMP4]]
; AVX2-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP3]], i64 1
...
; SSE2-NEXT:    [[DOT01:%.*]] = fadd float [[MUL0]], [[TMP4]]
; SSE2-NEXT:    [[TMP5:%.*]] = extractelement <2 x float> [[TMP3]], i64 1
; SSE2-NEXT:    [[DOT012:%.*]] = fadd float [[DOT01]], [[TMP5]]
; SSE2-NEXT:    ret float [[DOT012]]
;
; SSE4-LABEL: @dot3f32(
; SSE4-NEXT:    [[TMP1:%.*]] = load <3 x float>, ptr [[PTRX:%.*]], align 4
; SSE4-NEXT:    [[TMP2:%.*]] = load <3 x float>, ptr [[PTRY:%.*]], align 4
; SSE4-NEXT:    [[TMP3:%.*]] = fmul <3 x float> [[TMP1]], [[TMP2]]
; SSE4-NEXT:    [[TMP4:%.*]] = extractelement <3 x float> [[TMP3]], i64 0
; SSE4-NEXT:    [[TMP5:%.*]] = extractelement <3 x float> [[TMP3]], i64 1
; SSE4-NEXT:    [[DOT01:%.*]] = fadd float [[TMP4]], [[TMP5]]
; SSE4-NEXT:    [[TMP6:%.*]] = extractelement <3 x float> [[TMP3]], i64 2
; SSE4-NEXT:    [[DOT012:%.*]] = fadd float [[DOT01]], [[TMP6]]
...
; AVX-NEXT:    [[TMP4:%.*]] = extractelement <3 x float> [[TMP3]], i64 0
; AVX-NEXT:    [[TMP5:%.*]] = extractelement <3 x float> [[TMP3]], i64 1
; AVX-NEXT:    [[DOT01:%.*]] = fadd float [[TMP4]], [[TMP5]]
; AVX-NEXT:    [[TMP6:%.*]] = extractelement <3 x float> [[TMP3]], i64 2
; AVX-NEXT:    [[DOT012:%.*]] = fadd float [[DOT01]], [[TMP6]]
; AVX-NEXT:    ret float [[DOT012]]
;
; AVX2-LABEL: @dot3f32(
; AVX2-NEXT:    [[TMP1:%.*]] = load <3 x float>, ptr [[PTRX:%.*]], align 4
; AVX2-NEXT:    [[TMP2:%.*]] = load <3 x float>, ptr [[PTRY:%.*]], align 4
; AVX2-NEXT:    [[TMP3:%.*]] = fmul <3 x float> [[TMP1]], [[TMP2]]
; AVX2-NEXT:    [[TMP4:%.*]] = extractelement <3 x float> [[TMP3]], i64 0
; AVX2-NEXT:    [[TMP5:%.*]] = extractelement <3 x float> [[TMP3]], i64 1
; AVX2-NEXT:    [[DOT01:%.*]] = fadd float [[TMP4]], [[TMP5]]
; AVX2-NEXT:    [[TMP6:%.*]] = extractelement <3 x float> [[TMP3]], i64 2
; AVX2-NEXT:    [[DOT012:%.*]] = fadd float [[DOT01]], [[TMP6]]
...
; AVX-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[PTRY1]], align 4
; AVX-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[TMP1]], [[TMP2]]
; AVX-NEXT:    [[TMP6:%.*]] = extractelement <2 x double> [[TMP3]], i64 0
; AVX-NEXT:    [[DOT01:%.*]] = fadd fast double [[MUL0]], [[TMP6]]
; AVX-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP3]], i64 1
; AVX-NEXT:    [[TMP4:%.*]] = fadd fast double [[DOT01]], [[TMP5]]
...
; SSE4-NEXT:    [[TMP2:%.*]] = load <3 x float>, ptr [[PTRY:%.*]], align 4
; SSE4-NEXT:    [[TMP3:%.*]] = fmul <3 x float> [[TMP1]], [[TMP2]]
; SSE4-NEXT:    [[TMP4:%.*]] = call fast float @llvm.vector.reduce.fadd.v3f32(float 0.000000e+00, <3 x float> [[TMP3]])
...
; AVX2-NEXT:    [[TMP2:%.*]] = load <3 x float>, ptr [[PTRY:%.*]], align 4
; AVX2-NEXT:    [[TMP3:%.*]] = fmul <3 x float> [[TMP1]], [[TMP2]]
; AVX2-NEXT:    [[TMP4:%.*]] = call fast float @llvm.vector.reduce.fadd.v3f32(float 0.000000e+00, <3 x float> [[TMP3]])
; AVX2-NEXT:    ret float [[TMP4]]
;
  %ptrx1 = getelementptr inbounds float, ptr %ptrx, i64 1
  %ptry1 = getelementptr inbounds float, ptr %ptry, i64 1
  %ptrx2 = getelementptr inbounds float, ptr %ptrx, i64 2
...
; SSE2-NEXT:    [[TMP4:%.*]] = call reassoc double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> [[TMP3]])
; SSE2-NEXT:    ret double [[TMP4]]
;
; SSE4-LABEL: @dot2f64(
...
; AVX-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[TMP3]], i64 0
; AVX-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP3]], i64 1
; AVX-NEXT:    [[DOT01:%.*]] = fadd double [[TMP4]], [[TMP5]]
...
; SSE2-NEXT:    [[TMP3:%.*]] = fmul <2 x float> [[TMP1]], [[TMP2]]
; SSE2-NEXT:    [[TMP4:%.*]] = call reassoc float @llvm.vector.reduce.fadd.v2f32(float -0.000000e+00, <2 x float> [[TMP3]])
...
; AVX2-NEXT:    [[TMP4:%.*]] = extractelement <2 x float> [[TMP3]], i64 0
; AVX2-NEXT:    [[TMP5:%.*]] = extractelement <2 x float> [[TMP3]], i64 1
; AVX2-NEXT:    [[DOT01:%.*]] = fadd float [[TMP4]], [[TMP5]]
...
; AVX2-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[PTRY:%.*]], align 4
; AVX2-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[TMP1]], [[TMP2]]
; AVX2-NEXT:    [[MUL0:%.*]] = extractelement <2 x double> [[TMP3]], i64 0
; AVX2-NEXT:    [[MUL1:%.*]] = extractelement <2 x double> [[TMP3]], i64 1
...
; AVX2-NEXT:    [[TMP2:%.*]] = load <2 x float>, ptr [[PTRY:%.*]], align 4
; AVX2-NEXT:    [[TMP3:%.*]] = fmul <2 x float> [[TMP1]], [[TMP2]]
; AVX2-NEXT:    [[MUL0:%.*]] = extractelement <2 x float> [[TMP3]], i64 0
; AVX2-NEXT:    [[MUL1:%.*]] = extractelement <2 x float> [[TMP3]], i64 1
