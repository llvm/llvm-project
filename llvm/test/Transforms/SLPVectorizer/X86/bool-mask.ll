...
; SSE-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i64>
; SSE-NEXT:    [[TMP3:%.*]] = shl <16 x i64> [[TMP2]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
; SSE-NEXT:    [[TMP4:%.*]] = call i64 @llvm.vector.reduce.or.v16i64(<16 x i64> [[TMP3]])
...
; AVX-NEXT:    [[TMP3:%.*]] = shl <16 x i64> [[TMP2]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
...
; AVX512-NEXT:    [[TMP3:%.*]] = shl <16 x i64> [[TMP2]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
...
; SSE2-NEXT:    [[TMP18:%.*]] = zext i8 [[TMP1]] to i64
; SSE2-NEXT:    [[TMP19:%.*]] = and i8 [[TMP0]], 127
; SSE2-NEXT:    [[TMP20:%.*]] = zext i8 [[TMP19]] to i64
; SSE2-NEXT:    [[TMP21:%.*]] = shl i64 [[TMP20]], 1
; SSE2-NEXT:    [[OP_RDX1:%.*]] = or i64 [[TMP18]], [[TMP21]]
; SSE2-NEXT:    [[TMP22:%.*]] = and i8 [[TMP2]], 63
; SSE2-NEXT:    [[TMP23:%.*]] = zext i8 [[TMP22]] to i64
; SSE2-NEXT:    [[TMP24:%.*]] = shl i64 [[TMP23]], 2
; SSE2-NEXT:    [[TMP25:%.*]] = and i8 [[TMP3]], 31
; SSE2-NEXT:    [[TMP26:%.*]] = zext i8 [[TMP25]] to i64
; SSE2-NEXT:    [[TMP27:%.*]] = shl i64 [[TMP26]], 3
; SSE2-NEXT:    [[OP_RDX2:%.*]] = or i64 [[TMP24]], [[TMP27]]
; SSE2-NEXT:    [[TMP28:%.*]] = and i8 [[TMP4]], 15
; SSE2-NEXT:    [[TMP29:%.*]] = zext i8 [[TMP28]] to i64
; SSE2-NEXT:    [[TMP30:%.*]] = shl i64 [[TMP29]], 4
; SSE2-NEXT:    [[TMP31:%.*]] = and i8 [[TMP5]], 7
; SSE2-NEXT:    [[TMP32:%.*]] = zext i8 [[TMP31]] to i64
; SSE2-NEXT:    [[TMP33:%.*]] = shl i64 [[TMP32]], 5
; SSE2-NEXT:    [[OP_RDX3:%.*]] = or i64 [[TMP30]], [[TMP33]]
; SSE2-NEXT:    [[TMP34:%.*]] = and i8 [[TMP6]], 3
; SSE2-NEXT:    [[TMP35:%.*]] = zext i8 [[TMP34]] to i64
; SSE2-NEXT:    [[TMP36:%.*]] = shl i64 [[TMP35]], 6
; SSE2-NEXT:    [[TMP37:%.*]] = and i8 [[TMP7]], 1
; SSE2-NEXT:    [[TMP38:%.*]] = zext i8 [[TMP37]] to i64
; SSE2-NEXT:    [[TMP39:%.*]] = shl i64 [[TMP38]], 7
; SSE2-NEXT:    [[OP_RDX4:%.*]] = or i64 [[TMP36]], [[TMP39]]
; SSE2-NEXT:    [[TMP40:%.*]] = zext i8 [[TMP9]] to i64
; SSE2-NEXT:    [[TMP41:%.*]] = shl i64 [[TMP40]], 9
; SSE2-NEXT:    [[TMP42:%.*]] = zext i8 [[TMP10]] to i64
; SSE2-NEXT:    [[TMP43:%.*]] = shl i64 [[TMP42]], 10
; SSE2-NEXT:    [[OP_RDX5:%.*]] = or i64 [[TMP41]], [[TMP43]]
...
; SSE2-NEXT:    [[TMP44:%.*]] = zext i8 [[TMP12]] to i64
; SSE2-NEXT:    [[TMP45:%.*]] = shl i64 [[TMP44]], 15
; SSE2-NEXT:    [[OP_RDX10:%.*]] = or i64 [[OP_RDX8]], [[TMP45]]
; SSE2-NEXT:    [[OP_RDX11:%.*]] = or i64 [[OP_RDX9]], [[OP_RDX10]]
; SSE2-NEXT:    ret i64 [[OP_RDX11]]
;
; SSE4-LABEL: @bitmask_16xi8_swap(
; SSE4-NEXT:  entry:
...
; SSE4-NEXT:    [[TMP6:%.*]] = and <8 x i8> [[TMP0]], <i8 127, i8 -1, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1>
; SSE4-NEXT:    [[TMP7:%.*]] = zext <8 x i8> [[TMP6]] to <8 x i64>
; SSE4-NEXT:    [[TMP8:%.*]] = shl <8 x i64> [[TMP7]], <i64 1, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7>
...
; AVX-NEXT:  entry:
; AVX-NEXT:    [[TMP0:%.*]] = load <16 x i8>, ptr [[SRC:%.*]], align 1
; AVX-NEXT:    [[TMP1:%.*]] = and <16 x i8> [[TMP0]], <i8 127, i8 -1, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; AVX-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i64>
; AVX-NEXT:    [[TMP3:%.*]] = shl <16 x i64> [[TMP2]], <i64 1, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
; AVX-NEXT:    [[TMP4:%.*]] = call i64 @llvm.vector.reduce.or.v16i64(<16 x i64> [[TMP3]])
; AVX-NEXT:    ret i64 [[TMP4]]
;
...
; AVX512-NEXT:  entry:
; AVX512-NEXT:    [[TMP0:%.*]] = load <16 x i8>, ptr [[SRC:%.*]], align 1
; AVX512-NEXT:    [[TMP1:%.*]] = and <16 x i8> [[TMP0]], <i8 127, i8 -1, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; AVX512-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i64>
; AVX512-NEXT:    [[TMP3:%.*]] = shl <16 x i64> [[TMP2]], <i64 1, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
; AVX512-NEXT:    [[TMP4:%.*]] = call i64 @llvm.vector.reduce.or.v16i64(<16 x i64> [[TMP3]])
; AVX512-NEXT:    ret i64 [[TMP4]]
;
entry:
...
; Not a bitmask: two leaves share bit position 1.
define i64 @bitmask_16xi8_dupshift(ptr %src) {
; SSE2-LABEL: @bitmask_16xi8_dupshift(
; SSE2-NEXT:  entry:
; SSE2-NEXT:    [[TMP0:%.*]] = load i8, ptr [[SRC:%.*]], align 1, !range [[RNG0]], !noundef [[META1]]
; SSE2-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 1
; SSE2-NEXT:    [[TMP1:%.*]] = load i8, ptr [[ARRAYIDX_1]], align 1, !range [[RNG0]], !noundef [[META1]]
; SSE2-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 2
; SSE2-NEXT:    [[TMP2:%.*]] = load i8, ptr [[ARRAYIDX_2]], align 1, !range [[RNG0]], !noundef [[META1]]
...
; SSE4-NEXT:    [[TMP0:%.*]] = load <8 x i8>, ptr [[SRC:%.*]], align 1
; SSE4-NEXT:    [[ARRAYIDX_8:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 8
; SSE4-NEXT:    [[TMP1:%.*]] = load i8, ptr [[ARRAYIDX_8]], align 1, !range [[RNG0]], !noundef [[META1]]
; SSE4-NEXT:    [[ARRAYIDX_9:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 9
; SSE4-NEXT:    [[TMP2:%.*]] = load <4 x i8>, ptr [[ARRAYIDX_9]], align 1
; SSE4-NEXT:    [[ARRAYIDX_13:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 13
; SSE4-NEXT:    [[TMP3:%.*]] = load i8, ptr [[ARRAYIDX_13]], align 1, !range [[RNG0]], !noundef [[META1]]
...
; SSE2-NEXT:    [[TMP17:%.*]] = shl i64 [[TMP16]], 8
; SSE2-NEXT:    [[OP_RDX:%.*]] = or i64 [[TMP15]], [[TMP17]]
; SSE2-NEXT:    [[TMP18:%.*]] = zext i8 [[TMP0]] to i64
; SSE2-NEXT:    [[TMP19:%.*]] = and i8 [[TMP1]], 127
; SSE2-NEXT:    [[TMP20:%.*]] = zext i8 [[TMP19]] to i64
; SSE2-NEXT:    [[TMP21:%.*]] = shl i64 [[TMP20]], 1
; SSE2-NEXT:    [[OP_RDX1:%.*]] = or i64 [[TMP18]], [[TMP21]]
; SSE2-NEXT:    [[TMP22:%.*]] = and i8 [[TMP2]], 63
...
; SSE4-NEXT:    [[ARRAYIDX_15:%.*]] = getelementptr inbounds nuw i8, ptr [[SRC]], i64 15
; SSE4-NEXT:    [[TMP5:%.*]] = load i8, ptr [[ARRAYIDX_15]], align 1, !range [[RNG0]], !noundef [[META1]]
; SSE4-NEXT:    [[TMP6:%.*]] = and <8 x i8> [[TMP0]], <i8 -1, i8 127, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1>
; SSE4-NEXT:    [[TMP7:%.*]] = zext <8 x i8> [[TMP6]] to <8 x i64>
; SSE4-NEXT:    [[TMP8:%.*]] = shl <8 x i64> [[TMP7]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7>
; SSE4-NEXT:    [[TMP9:%.*]] = zext <4 x i8> [[TMP2]] to <4 x i64>
; SSE4-NEXT:    [[TMP10:%.*]] = shl <4 x i64> [[TMP9]], <i64 9, i64 10, i64 11, i64 12>
; SSE4-NEXT:    [[TMP11:%.*]] = shufflevector <8 x i64> [[TMP8]], <8 x i64> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; SSE4-NEXT:    [[RDX_OP:%.*]] = or <4 x i64> [[TMP11]], [[TMP10]]
...
; AVX-NEXT:  entry:
; AVX-NEXT:    [[TMP0:%.*]] = load <16 x i8>, ptr [[SRC:%.*]], align 1
; AVX-NEXT:    [[TMP1:%.*]] = and <16 x i8> [[TMP0]], <i8 -1, i8 127, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; AVX-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i64>
; AVX-NEXT:    [[TMP4:%.*]] = shl <16 x i64> [[TMP2]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
; AVX-NEXT:    [[TMP3:%.*]] = call i64 @llvm.vector.reduce.or.v16i64(<16 x i64> [[TMP4]])
; AVX-NEXT:    ret i64 [[TMP3]]
;
; AVX512-LABEL: @bitmask_16xi8_shl(
; AVX512-NEXT:  entry:
; AVX512-NEXT:    [[TMP0:%.*]] = load <16 x i8>, ptr [[SRC:%.*]], align 1
; AVX512-NEXT:    [[TMP1:%.*]] = and <16 x i8> [[TMP0]], <i8 -1, i8 127, i8 63, i8 31, i8 15, i8 7, i8 3, i8 1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>
; AVX512-NEXT:    [[TMP2:%.*]] = zext <16 x i8> [[TMP1]] to <16 x i64>
; AVX512-NEXT:    [[TMP4:%.*]] = shl <16 x i64> [[TMP2]], <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
; AVX512-NEXT:    [[TMP3:%.*]] = call i64 @llvm.vector.reduce.or.v16i64(<16 x i64> [[TMP4]])
