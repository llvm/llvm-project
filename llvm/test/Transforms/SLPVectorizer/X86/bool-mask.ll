...
; SSE-NEXT:    [[TMP10:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v8i64(<8 x i64> [[TMP3]], i64 0)
; SSE-NEXT:    [[TMP11:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v8i64(<8 x i64> [[TMP3]], i64 2)
; SSE-NEXT:    [[TMP12:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v8i64(<8 x i64> [[TMP3]], i64 4)
; SSE-NEXT:    [[TMP13:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v8i64(<8 x i64> [[TMP3]], i64 6)
; SSE-NEXT:    [[RDX_OP:%.*]] = or <2 x i64> [[TMP10]], [[TMP11]]
; SSE-NEXT:    [[RDX_OP1:%.*]] = or <2 x i64> [[RDX_OP]], [[TMP12]]
; SSE-NEXT:    [[RDX_OP2:%.*]] = or <2 x i64> [[RDX_OP1]], [[TMP13]]
; SSE-NEXT:    [[TMP14:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v4i64(<4 x i64> [[TMP6]], i64 0)
; SSE-NEXT:    [[TMP15:%.*]] = call <2 x i64> @llvm.vector.extract.v2i64.v4i64(<4 x i64> [[TMP6]], i64 2)
; SSE-NEXT:    [[RDX_OP3:%.*]] = or <2 x i64> [[RDX_OP2]], [[TMP14]]
; SSE-NEXT:    [[RDX_OP4:%.*]] = or <2 x i64> [[RDX_OP3]], [[TMP15]]
; SSE-NEXT:    [[TMP16:%.*]] = call i64 @llvm.vector.reduce.or.v2i64(<2 x i64> [[RDX_OP4]])
...
; AVX-NEXT:    [[TMP11:%.*]] = call <4 x i64> @llvm.vector.extract.v4i64.v8i64(<8 x i64> [[TMP3]], i64 4)
; AVX-NEXT:    [[RDX_OP:%.*]] = or <4 x i64> [[TMP10]], [[TMP11]]
; AVX-NEXT:    [[RDX_OP1:%.*]] = or <4 x i64> [[RDX_OP]], [[TMP6]]
; AVX-NEXT:    [[TMP12:%.*]] = call i64 @llvm.vector.reduce.or.v4i64(<4 x i64> [[RDX_OP1]])
...
; AVX512-NEXT:    [[TMP11:%.*]] = call <4 x i64> @llvm.vector.extract.v4i64.v8i64(<8 x i64> [[TMP3]], i64 4)
; AVX512-NEXT:    [[RDX_OP:%.*]] = or <4 x i64> [[TMP10]], [[TMP11]]
; AVX512-NEXT:    [[RDX_OP1:%.*]] = or <4 x i64> [[RDX_OP]], [[TMP6]]
; AVX512-NEXT:    [[TMP12:%.*]] = call i64 @llvm.vector.reduce.or.v4i64(<4 x i64> [[RDX_OP1]])
