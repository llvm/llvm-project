...
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <2 x i8> <i8 0, i8 poison>, i8 [[V_5]], i64 1
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> <i32 poison, i32 poison, i32 1, i32 poison>, i32 [[M_4]], i64 1
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[J_6]], i64 3
...
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <8 x i32> [[TMP4]], <8 x i32> <i32 0, i32 1, i32 poison, i32 0, i32 0, i32 poison, i32 0, i32 poison>, <8 x i32> <i32 8, i32 9, i32 2, i32 11, i32 12, i32 1, i32 14, i32 3>
; CHECK-NEXT:    br i1 [[CMP_NOT_NOT]], label %[[O_SINK_SPLIT:.*]], label %[[P:.*]]
; CHECK:       [[P]]:
; CHECK-NEXT:    [[TMP7:%.*]] = phi <2 x i8> [ <i8 1, i8 0>, %[[IF_END18]] ], [ [[TMP0]], %[[N]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = phi <8 x i32> [ [[TMP35:%.*]], %[[IF_END18]] ], [ [[TMP5]], %[[N]] ]
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i32> [[TMP8]], i64 7
...
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <2 x i8> [[TMP7]], i64 0
...
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <8 x i32> [[TMP8]], i64 1
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <8 x i32> [[TMP8]], i64 4
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <2 x i1> [[TMP11]], i64 1
; CHECK-NEXT:    br i1 [[TMP21]], label %[[O_SINK_SPLIT]], label %[[Q:.*]]
; CHECK:       [[O_SINK_SPLIT]]:
; CHECK-NEXT:    [[SPEC_SELECT_SINK:%.*]] = phi i32 [ [[J_0]], %[[N]] ], [ [[SPEC_SELECT]], %[[P]] ]
; CHECK-NEXT:    [[I_3_PH:%.*]] = phi i32 [ 0, %[[N]] ], [ [[TMP25]], %[[P]] ]
; CHECK-NEXT:    [[L_3_PH:%.*]] = phi i8 [ 0, %[[N]] ], [ [[TMP13]], %[[P]] ]
; CHECK-NEXT:    [[TMP31:%.*]] = phi <4 x i32> [ [[TMP3]], %[[N]] ], [ [[TMP19]], %[[P]] ]
; CHECK-NEXT:    [[CONV10:%.*]] = zext i32 [[SPEC_SELECT_SINK]] to i64
; CHECK-NEXT:    [[CALL11:%.*]] = tail call i32 (ptr, ...) @printf(ptr null, i64 [[CONV10]])
; CHECK-NEXT:    br label %[[O]]
; CHECK:       [[O]]:
; CHECK-NEXT:    [[TMP23:%.*]] = phi <4 x i32> [ poison, %[[ENTRY_O_CRIT_EDGE]] ], [ [[TMP31]], %[[O_SINK_SPLIT]] ]
; CHECK-NEXT:    [[SUB:%.*]] = sub i32 0, [[J_6]]
; CHECK-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB]], [[I_3_PH]]
; CHECK-NEXT:    [[SUB13:%.*]] = sub i32 0, [[DIV]]
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x i32> poison, i32 [[SUB]], i64 0
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x i32> [[TMP24]], i32 [[SUB13]], i64 2
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <4 x i32> [[TMP39]], <4 x i32> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
...
; CHECK-NEXT:    [[TMP40:%.*]] = phi <2 x i32> [ [[TMP15]], %[[P]] ], [ [[TMP30]], %[[O]] ]
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <2 x i32> [[TMP40]], <2 x i32> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
; CHECK-NEXT:    [[CONV17:%.*]] = sext i8 [[V_44]] to i32
; CHECK-NEXT:    [[REM:%.*]] = mul i32 [[U_4]], [[CONV17]]
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 poison, i32 0, i32 0>, i32 [[REM]], i64 5
...
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <8 x i32> [[TMP33]], <8 x i32> [[TMP38]], <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    br label %[[IF_END18]]
; CHECK:       [[IF_END18]]:
; CHECK-NEXT:    [[L_4]] = phi i8 [ 0, %[[Q]] ], [ [[L_3_PH]], %[[O]] ]
; CHECK-NEXT:    [[TMP35]] = phi <8 x i32> [ [[TMP41]], %[[Q]] ], [ [[TMP28]], %[[O]] ]
