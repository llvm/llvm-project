...
; AVX1-NEXT:    [[R3:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP3]], <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 4, i32 11, i32 6, i32 7>
...
; AVX2-NEXT:    [[R1:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 8, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; AVX512-NEXT:    [[R1:%.*]] = shufflevector <8 x i32> [[R0]], <8 x i32> [[TMP7]], <8 x i32> <i32 0, i32 8, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
