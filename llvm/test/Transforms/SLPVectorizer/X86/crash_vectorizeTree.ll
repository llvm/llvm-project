...
; CHECK:       bb6:
; CHECK-NEXT:    [[TMP0]] = phi <2 x double> [ <double 1.800000e+01, double 2.800000e+01>, [[BB:%.*]] ], [ [[TMP1:%.*]], [[BB17:%.*]] ], [ [[TMP1]], [[BB16:%.*]] ], [ [[TMP1]], [[BB16]] ]
; CHECK-NEXT:    store <2 x double> [[TMP0]], ptr [[I]], align 8
; CHECK-NEXT:    [[TMP1]] = load <2 x double>, ptr [[I2]], align 8
; CHECK-NEXT:    br i1 [[ARG:%.*]], label [[BB11:%.*]], label [[BB12:%.*]]
; CHECK:       bb11:
; CHECK-NEXT:    ret void
; CHECK:       bb12:
; CHECK-NEXT:    store <2 x double> [[TMP1]], ptr [[I4]], align 8
