...
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> <i32 poison, i32 0, i32 poison, i32 0>, i32 [[TRUNC]], i64 0
...
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <4 x i32> [[TMP5]], i64 0
; CHECK-NEXT:    [[TMP10:%.*]] = zext i32 [[TMP4]] to i64
; CHECK-NEXT:    [[TRUNC10:%.*]] = trunc i64 [[TMP10]] to i32
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x i32> [[TMP5]], i64 2
...
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i32> [[TMP31]], i32 [[TRUNC27]], i64 3
