...
; CHECK-NEXT:    [[XOR38:%.*]] = xor i32 [[ARG]], [[TRUNC27]]
; CHECK-NEXT:    [[SHL34:%.*]] = shl i32 [[ARG1]], 0
; CHECK-NEXT:    [[SHL17:%.*]] = xor i32 [[ARG1]], [[TRUNC19]]
; CHECK-NEXT:    [[SHL:%.*]] = shl i32 0, 1
; CHECK-NEXT:    [[OP_RDX8:%.*]] = sext i32 [[SHL]] to i64
; CHECK-NEXT:    [[SHL35:%.*]] = xor i32 0, [[TRUNC]]
; CHECK-NEXT:    [[SEXT36:%.*]] = sext i32 [[SHL35]] to i64
; CHECK-NEXT:    [[SHL18:%.*]] = shl i32 [[SHL]], 0
; CHECK-NEXT:    [[SEXT22:%.*]] = sext i32 [[SHL18]] to i64
; CHECK-NEXT:    [[XOR37:%.*]] = xor i32 [[ARG]], [[TRUNC10]]
; CHECK-NEXT:    [[SEXT38:%.*]] = sext i32 [[XOR37]] to i64
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i32> poison, i32 [[SHL]], i32 0
; CHECK-NEXT:    [[TMP16:%.*]] = insertelement <4 x i32> [[TMP15]], i32 [[SHL17]], i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP16]], i32 [[SHL34]], i32 2
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[XOR38]], i32 3
; CHECK-NEXT:    [[TMP11:%.*]] = sext <4 x i32> [[TMP17]] to <4 x i64>
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <4 x i64> [[TMP11]], <4 x i64> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i64> [[TMP13]], <4 x i64> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <8 x i64> [[TMP12]], <8 x i64> [[TMP18]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
; CHECK-NEXT:    [[OP_RDX6:%.*]] = call i64 @llvm.vector.reduce.add.v8i64(<8 x i64> [[TMP14]])
; CHECK-NEXT:    [[OP_RDX9:%.*]] = add i64 [[OP_RDX6]], [[OP_RDX8]]
; CHECK-NEXT:    [[OP_RDX10:%.*]] = add i64 [[SEXT36]], [[SEXT22]]
