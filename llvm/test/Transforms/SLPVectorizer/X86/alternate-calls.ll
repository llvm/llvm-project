...
; AVX-NEXT:    [[TMP12:%.*]] = shufflevector <8 x float> [[TMP1]], <8 x float> poison, <2 x i32> <i32 0, i32 3>
; AVX-NEXT:    [[TMP13:%.*]] = call <2 x float> @llvm.ceil.v2f32(<2 x float> [[TMP12]])
...
; AVX-NEXT:    [[TMP9:%.*]] = shufflevector <2 x float> [[TMP13]], <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX-NEXT:    [[TMP14:%.*]] = shufflevector <8 x float> zeroinitializer, <8 x float> [[TMP9]], <8 x i32> <i32 8, i32 1, i32 2, i32 9, i32 4, i32 5, i32 6, i32 7>
; AVX-NEXT:    [[TMP11:%.*]] = shufflevector <2 x float> [[TMP8]], <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; AVX-NEXT:    [[R3:%.*]] = shufflevector <8 x float> [[TMP14]], <8 x float> [[TMP11]], <8 x i32> <i32 0, i32 8, i32 9, i32 3, i32 4, i32 5, i32 6, i32 7>
