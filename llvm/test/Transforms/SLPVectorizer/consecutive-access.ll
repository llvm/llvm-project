...
; X86-LABEL: @foo_loop(
; X86-NEXT:  entry:
; X86-NEXT:    [[A_ADDR:%.*]] = alloca ptr, align 8
; X86-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
; X86-NEXT:    [[SUM:%.*]] = alloca double, align 8
; X86-NEXT:    [[I:%.*]] = alloca i32, align 4
; X86-NEXT:    store ptr [[A:%.*]], ptr [[A_ADDR]], align 8
; X86-NEXT:    store i32 [[N:%.*]], ptr [[N_ADDR]], align 4
; X86-NEXT:    store double 0.000000e+00, ptr [[SUM]], align 8
; X86-NEXT:    store i32 0, ptr [[I]], align 4
; X86-NEXT:    [[CMP1:%.*]] = icmp slt i32 0, [[N]]
; X86-NEXT:    br i1 [[CMP1]], label [[FOR_BODY_LR_PH:%.*]], label [[FOR_END:%.*]]
; X86:       for.body.lr.ph:
; X86-NEXT:    br label [[FOR_BODY:%.*]]
; X86:       for.body:
; X86-NEXT:    [[TMP0:%.*]] = phi i32 [ 0, [[FOR_BODY_LR_PH]] ], [ [[INC:%.*]], [[FOR_BODY]] ]
; X86-NEXT:    [[TMP1:%.*]] = phi double [ 0.000000e+00, [[FOR_BODY_LR_PH]] ], [ [[ADD7:%.*]], [[FOR_BODY]] ]
; X86-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP0]], 2
; X86-NEXT:    [[IDXPROM:%.*]] = sext i32 [[MUL]] to i64
; X86-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds double, ptr [[A]], i64 [[IDXPROM]]
; X86-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[ARRAYIDX]], align 8
; X86-NEXT:    [[TMP3:%.*]] = fmul <2 x double> splat (double 7.000000e+00), [[TMP2]]
; X86-NEXT:    [[TMP4:%.*]] = call double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> [[TMP3]])
; X86-NEXT:    [[ADD7]] = fadd double [[TMP1]], [[TMP4]]
; X86-NEXT:    store double [[ADD7]], ptr [[SUM]], align 8
; X86-NEXT:    [[INC]] = add nsw i32 [[TMP0]], 1
; X86-NEXT:    store i32 [[INC]], ptr [[I]], align 4
; X86-NEXT:    [[CMP:%.*]] = icmp slt i32 [[INC]], [[N]]
; X86-NEXT:    br i1 [[CMP]], label [[FOR_BODY]], label [[FOR_COND_FOR_END_CRIT_EDGE:%.*]]
; X86:       for.cond.for.end_crit_edge:
; X86-NEXT:    [[SPLIT:%.*]] = phi double [ [[ADD7]], [[FOR_BODY]] ]
; X86-NEXT:    br label [[FOR_END]]
; X86:       for.end:
; X86-NEXT:    [[DOTLCSSA:%.*]] = phi double [ [[SPLIT]], [[FOR_COND_FOR_END_CRIT_EDGE]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; X86-NEXT:    [[CONV:%.*]] = fptosi double [[DOTLCSSA]] to i32
; X86-NEXT:    ret i32 [[CONV]]
;
; AARCH64-LABEL: @foo_loop(
; AARCH64-NEXT:  entry:
; AARCH64-NEXT:    [[A_ADDR:%.*]] = alloca ptr, align 8
; AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
; AARCH64-NEXT:    [[SUM:%.*]] = alloca double, align 8
; AARCH64-NEXT:    [[I:%.*]] = alloca i32, align 4
; AARCH64-NEXT:    store ptr [[A:%.*]], ptr [[A_ADDR]], align 8
; AARCH64-NEXT:    store i32 [[N:%.*]], ptr [[N_ADDR]], align 4
; AARCH64-NEXT:    store double 0.000000e+00, ptr [[SUM]], align 8
; AARCH64-NEXT:    store i32 0, ptr [[I]], align 4
; AARCH64-NEXT:    [[CMP1:%.*]] = icmp slt i32 0, [[N]]
; AARCH64-NEXT:    br i1 [[CMP1]], label [[FOR_BODY_LR_PH:%.*]], label [[FOR_END:%.*]]
; AARCH64:       for.body.lr.ph:
; AARCH64-NEXT:    br label [[FOR_BODY:%.*]]
; AARCH64:       for.body:
; AARCH64-NEXT:    [[TMP0:%.*]] = phi i32 [ 0, [[FOR_BODY_LR_PH]] ], [ [[INC:%.*]], [[FOR_BODY]] ]
; AARCH64-NEXT:    [[TMP1:%.*]] = phi double [ 0.000000e+00, [[FOR_BODY_LR_PH]] ], [ [[ADD7:%.*]], [[FOR_BODY]] ]
; AARCH64-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP0]], 2
; AARCH64-NEXT:    [[IDXPROM:%.*]] = sext i32 [[MUL]] to i64
; AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds double, ptr [[A]], i64 [[IDXPROM]]
; AARCH64-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[ARRAYIDX]], align 8
; AARCH64-NEXT:    [[TMP3:%.*]] = fmul <2 x double> splat (double 7.000000e+00), [[TMP2]]
; AARCH64-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[TMP3]], i32 0
; AARCH64-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP3]], i32 1
; AARCH64-NEXT:    [[ADD6:%.*]] = fadd double [[TMP4]], [[TMP5]]
; AARCH64-NEXT:    [[ADD7]] = fadd double [[TMP1]], [[ADD6]]
; AARCH64-NEXT:    store double [[ADD7]], ptr [[SUM]], align 8
; AARCH64-NEXT:    [[INC]] = add nsw i32 [[TMP0]], 1
; AARCH64-NEXT:    store i32 [[INC]], ptr [[I]], align 4
; AARCH64-NEXT:    [[CMP:%.*]] = icmp slt i32 [[INC]], [[N]]
; AARCH64-NEXT:    br i1 [[CMP]], label [[FOR_BODY]], label [[FOR_COND_FOR_END_CRIT_EDGE:%.*]]
; AARCH64:       for.cond.for.end_crit_edge:
; AARCH64-NEXT:    [[SPLIT:%.*]] = phi double [ [[ADD7]], [[FOR_BODY]] ]
; AARCH64-NEXT:    br label [[FOR_END]]
; AARCH64:       for.end:
; AARCH64-NEXT:    [[DOTLCSSA:%.*]] = phi double [ [[SPLIT]], [[FOR_COND_FOR_END_CRIT_EDGE]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
; AARCH64-NEXT:    [[CONV:%.*]] = fptosi double [[DOTLCSSA]] to i32
...
; X86-LABEL: @foo_loop_non_power_of_2(
; X86-NEXT:  entry:
; X86-NEXT:    [[A_ADDR:%.*]] = alloca ptr, align 8
; X86-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
; X86-NEXT:    [[SUM:%.*]] = alloca double, align 8
...
; X86-NEXT:    [[TMP0:%.*]] = phi i32 [ 0, [[FOR_BODY_LR_PH]] ], [ [[INC:%.*]], [[FOR_BODY]] ]
; X86-NEXT:    [[TMP1:%.*]] = phi double [ 0.000000e+00, [[FOR_BODY_LR_PH]] ], [ [[ADD7:%.*]], [[FOR_BODY]] ]
; X86-NEXT:    [[MUL:%.*]] = mul i32 [[TMP0]], 12
; X86-NEXT:    [[ADD_5:%.*]] = add i32 [[MUL]], 5
; X86-NEXT:    [[IDXPROM:%.*]] = sext i32 [[ADD_5]] to i64
; X86-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds double, ptr [[A]], i64 [[IDXPROM]]
; X86-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[ARRAYIDX]], align 8
; X86-NEXT:    [[TMP3:%.*]] = fmul <2 x double> splat (double 7.000000e+00), [[TMP2]]
; X86-NEXT:    [[TMP4:%.*]] = call double @llvm.vector.reduce.fadd.v2f64(double -0.000000e+00, <2 x double> [[TMP3]])
...
; X86-NEXT:    ret i32 [[CONV]]
;
; AARCH64-LABEL: @foo_loop_non_power_of_2(
; AARCH64-NEXT:  entry:
; AARCH64-NEXT:    [[A_ADDR:%.*]] = alloca ptr, align 8
; AARCH64-NEXT:    [[N_ADDR:%.*]] = alloca i32, align 4
; AARCH64-NEXT:    [[SUM:%.*]] = alloca double, align 8
...
; AARCH64-NEXT:    [[TMP0:%.*]] = phi i32 [ 0, [[FOR_BODY_LR_PH]] ], [ [[INC:%.*]], [[FOR_BODY]] ]
; AARCH64-NEXT:    [[TMP1:%.*]] = phi double [ 0.000000e+00, [[FOR_BODY_LR_PH]] ], [ [[ADD7:%.*]], [[FOR_BODY]] ]
; AARCH64-NEXT:    [[MUL:%.*]] = mul i32 [[TMP0]], 12
; AARCH64-NEXT:    [[ADD_5:%.*]] = add i32 [[MUL]], 5
; AARCH64-NEXT:    [[IDXPROM:%.*]] = sext i32 [[ADD_5]] to i64
; AARCH64-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds double, ptr [[A]], i64 [[IDXPROM]]
; AARCH64-NEXT:    [[TMP2:%.*]] = load <2 x double>, ptr [[ARRAYIDX]], align 8
; AARCH64-NEXT:    [[TMP3:%.*]] = fmul <2 x double> splat (double 7.000000e+00), [[TMP2]]
; AARCH64-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[TMP3]], i32 0
...
; AARCH64-NEXT:    [[ADD7]] = fadd double [[TMP1]], [[ADD6]]
; AARCH64-NEXT:    store double [[ADD7]], ptr [[SUM]], align 8
; AARCH64-NEXT:    [[INC]] = add i32 [[TMP0]], 1
; AARCH64-NEXT:    store i32 [[INC]], ptr [[I]], align 4
; AARCH64-NEXT:    [[CMP:%.*]] = icmp slt i32 [[INC]], [[N]]
; AARCH64-NEXT:    br i1 [[CMP]], label [[FOR_BODY]], label [[FOR_COND_FOR_END_CRIT_EDGE:%.*]]
; AARCH64:       for.cond.for.end_crit_edge:
