...
; RUN: %if x86-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=-10000 -mtriple=x86_64-unknown-unknown < %s | FileCheck %s --check-prefixes=CHECK,X86T %}
; RUN: %if x86-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=0 -mtriple=x86_64-unknown-unknown < %s | FileCheck %s --check-prefixes=CHECK,X86 %}
; RUN: %if x86-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=-10000 -slp-min-tree-size=0 -mtriple=x86_64-unknown-unknown < %s | FileCheck %s --check-prefixes=CHECK,X86TM %}
; RUN: %if aarch64-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=-10000 -mtriple=aarch64-unknown-linux-gnu < %s | FileCheck %s --check-prefixes=CHECK,AARCH64T %}
; RUN: %if aarch64-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=0 -mtriple=aarch64-unknown-linux-gnu < %s | FileCheck %s --check-prefixes=CHECK,AARCH64 %}
; RUN: %if aarch64-registered-target %{ opt -S -passes=slp-vectorizer -slp-threshold=-10000 -slp-min-tree-size=0 -mtriple=aarch64-unknown-linux-gnu < %s | FileCheck %s --check-prefixes=CHECK,AARCH64TM %}
...
; X86T-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; X86T-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; X86T-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; X86T-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; X86T-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; X86T-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; X86T-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; X86T-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; X86T-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; X86T-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; X86T-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; X86T-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; X86T-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; X86T-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; X86T-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; X86T-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; X86T-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; X86T-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; X86T-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; X86T-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; X86T-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; X86T-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; X86T-NEXT:    [[Q0:%.*]] = extractelement <4 x float> [[RD]], i32 0
; X86T-NEXT:    [[Q1:%.*]] = extractelement <4 x float> [[RD]], i32 1
; X86T-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
; X86T-NEXT:    [[Q3:%.*]] = extractelement <4 x float> [[RD]], i32 3
; X86T-NEXT:    [[Q4:%.*]] = fadd float [[Q0]], [[Q1]]
; X86T-NEXT:    [[Q5:%.*]] = fadd float [[Q2]], [[Q3]]
...
; X86-NEXT:    [[C1:%.*]] = extractelement <4 x i32> [[C]], i32 1
; X86-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; X86-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; X86-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; X86-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; X86-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; X86-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; X86-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; X86-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; X86-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; X86-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; X86-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; X86-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; X86-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; X86-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; X86-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; X86-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; X86-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; X86-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; X86-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; X86-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; X86-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; X86-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; X86-NEXT:    [[Q0:%.*]] = extractelement <4 x float> [[RD]], i32 0
; X86-NEXT:    [[Q1:%.*]] = extractelement <4 x float> [[RD]], i32 1
; X86-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
; X86-NEXT:    [[Q3:%.*]] = extractelement <4 x float> [[RD]], i32 3
; X86-NEXT:    [[Q4:%.*]] = fadd float [[Q0]], [[Q1]]
; X86-NEXT:    [[Q5:%.*]] = fadd float [[Q2]], [[Q3]]
...
; X86TM-NEXT:    [[C1:%.*]] = extractelement <4 x i32> [[C]], i32 1
; X86TM-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; X86TM-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; X86TM-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; X86TM-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; X86TM-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; X86TM-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; X86TM-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; X86TM-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; X86TM-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; X86TM-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; X86TM-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; X86TM-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; X86TM-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; X86TM-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; X86TM-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; X86TM-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; X86TM-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; X86TM-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; X86TM-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; X86TM-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; X86TM-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; X86TM-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; X86TM-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
...
; AARCH64T-NEXT:    [[C1:%.*]] = extractelement <4 x i32> [[C]], i32 1
; AARCH64T-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; AARCH64T-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; AARCH64T-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; AARCH64T-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; AARCH64T-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; AARCH64T-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; AARCH64T-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; AARCH64T-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; AARCH64T-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; AARCH64T-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; AARCH64T-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; AARCH64T-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; AARCH64T-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; AARCH64T-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; AARCH64T-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; AARCH64T-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; AARCH64T-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; AARCH64T-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; AARCH64T-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; AARCH64T-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; AARCH64T-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; AARCH64T-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; AARCH64T-NEXT:    [[Q0:%.*]] = extractelement <4 x float> [[RD]], i32 0
; AARCH64T-NEXT:    [[Q1:%.*]] = extractelement <4 x float> [[RD]], i32 1
; AARCH64T-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
; AARCH64T-NEXT:    [[Q3:%.*]] = extractelement <4 x float> [[RD]], i32 3
; AARCH64T-NEXT:    [[Q4:%.*]] = fadd float [[Q0]], [[Q1]]
; AARCH64T-NEXT:    [[Q5:%.*]] = fadd float [[Q2]], [[Q3]]
...
; AARCH64-NEXT:    [[C1:%.*]] = extractelement <4 x i32> [[C]], i32 1
; AARCH64-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; AARCH64-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; AARCH64-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; AARCH64-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; AARCH64-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; AARCH64-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; AARCH64-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; AARCH64-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; AARCH64-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; AARCH64-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; AARCH64-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; AARCH64-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; AARCH64-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; AARCH64-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; AARCH64-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; AARCH64-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; AARCH64-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; AARCH64-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; AARCH64-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; AARCH64-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; AARCH64-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; AARCH64-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; AARCH64-NEXT:    [[Q0:%.*]] = extractelement <4 x float> [[RD]], i32 0
; AARCH64-NEXT:    [[Q1:%.*]] = extractelement <4 x float> [[RD]], i32 1
; AARCH64-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
; AARCH64-NEXT:    [[Q3:%.*]] = extractelement <4 x float> [[RD]], i32 3
; AARCH64-NEXT:    [[Q4:%.*]] = fadd float [[Q0]], [[Q1]]
; AARCH64-NEXT:    [[Q5:%.*]] = fadd float [[Q2]], [[Q3]]
...
; AARCH64TM-NEXT:    [[C1:%.*]] = extractelement <4 x i32> [[C]], i32 1
; AARCH64TM-NEXT:    [[C2:%.*]] = extractelement <4 x i32> [[C]], i32 2
; AARCH64TM-NEXT:    [[C3:%.*]] = extractelement <4 x i32> [[C]], i32 3
; AARCH64TM-NEXT:    [[A0:%.*]] = extractelement <4 x float> [[A:%.*]], i32 0
; AARCH64TM-NEXT:    [[A1:%.*]] = extractelement <4 x float> [[A]], i32 1
; AARCH64TM-NEXT:    [[A2:%.*]] = extractelement <4 x float> [[A]], i32 2
; AARCH64TM-NEXT:    [[A3:%.*]] = extractelement <4 x float> [[A]], i32 3
; AARCH64TM-NEXT:    [[B0:%.*]] = extractelement <4 x float> [[B:%.*]], i32 0
; AARCH64TM-NEXT:    [[B1:%.*]] = extractelement <4 x float> [[B]], i32 1
; AARCH64TM-NEXT:    [[B2:%.*]] = extractelement <4 x float> [[B]], i32 2
; AARCH64TM-NEXT:    [[B3:%.*]] = extractelement <4 x float> [[B]], i32 3
; AARCH64TM-NEXT:    [[CMP0:%.*]] = icmp ne i32 [[C0]], 0
; AARCH64TM-NEXT:    [[CMP1:%.*]] = icmp ne i32 [[C1]], 0
; AARCH64TM-NEXT:    [[CMP2:%.*]] = icmp ne i32 [[C2]], 0
; AARCH64TM-NEXT:    [[CMP3:%.*]] = icmp ne i32 [[C3]], 0
; AARCH64TM-NEXT:    [[S0:%.*]] = select i1 [[CMP0]], float [[A0]], float [[B0]]
; AARCH64TM-NEXT:    [[S1:%.*]] = select i1 [[CMP1]], float [[A1]], float [[B1]]
; AARCH64TM-NEXT:    [[S2:%.*]] = select i1 [[CMP2]], float [[A2]], float [[B2]]
; AARCH64TM-NEXT:    [[S3:%.*]] = select i1 [[CMP3]], float [[A3]], float [[B3]]
; AARCH64TM-NEXT:    [[RA:%.*]] = insertelement <4 x float> poison, float [[S0]], i32 0
; AARCH64TM-NEXT:    [[RB:%.*]] = insertelement <4 x float> [[RA]], float [[S1]], i32 1
; AARCH64TM-NEXT:    [[RC:%.*]] = insertelement <4 x float> [[RB]], float [[S2]], i32 2
; AARCH64TM-NEXT:    [[RD:%.*]] = insertelement <4 x float> [[RC]], float [[S3]], i32 3
; AARCH64TM-NEXT:    [[Q2:%.*]] = extractelement <4 x float> [[RD]], i32 2
...
; CHECK-NEXT:    [[RD1:%.*]] = shufflevector <4 x float> [[TMP12]], <4 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 1>
