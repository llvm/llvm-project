...
; RUN: opt < %s -mtriple=amdgpu9.42-amd-amdhsa -passes=slp-vectorizer -S  | FileCheck %s --check-prefix=GFX9
...
; GFX9-SAME: i32 [[IN:%.*]], ptr addrspace(1) [[APTR1:%.*]], ptr addrspace(1) [[BPTR1:%.*]], ptr addrspace(1) [[APTR2:%.*]], ptr addrspace(1) [[BPTR2:%.*]]) {
; GFX9-NEXT:  [[ENTRY:.*]]:
