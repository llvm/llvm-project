...
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa -passes=slp-vectorizer %s | FileCheck -check-prefix=GFX9 %s
; RUN: opt -S -mtriple=amdgpu12.50-amd-amdhsa -passes=slp-vectorizer %s | FileCheck -check-prefix=GFX1250 %s
...
; GFX1250-SAME: ptr addrspace(1) [[ARG:%.*]]) {
