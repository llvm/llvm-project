...
; CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[SUB7]], [[SUB]]
; CHECK-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[SUB]], [[SUB7]]
; CHECK-NEXT:    [[SHL:%.*]] = shl nsw i32 [[SUB8]], 16
; CHECK-NEXT:    [[ADD9:%.*]] = add nsw i32 [[ADD]], [[SHL]]
...
; CHECK-NEXT:    [[ADD24:%.*]] = add nsw i32 [[ADD23]], [[ADD9]]
; CHECK-NEXT:    [[SUB27:%.*]] = sub nsw i32 [[ADD9]], [[ADD23]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = load i8, ptr [[ADD_PTR]], align 1
; CHECK-NEXT:    [[CONV_1:%.*]] = zext i8 [[TMP8]] to i32
; CHECK-NEXT:    [[TMP9:%.*]] = load i8, ptr [[ADD_PTR31]], align 1
; CHECK-NEXT:    [[CONV2_1:%.*]] = zext i8 [[TMP9]] to i32
; CHECK-NEXT:    [[SUB_1:%.*]] = sub nsw i32 [[CONV_1]], [[CONV2_1]]
; CHECK-NEXT:    [[ARRAYIDX3_1:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR]], i64 1
; CHECK-NEXT:    [[TMP10:%.*]] = load i8, ptr [[ARRAYIDX3_1]], align 1
; CHECK-NEXT:    [[CONV4_1:%.*]] = zext i8 [[TMP10]] to i32
; CHECK-NEXT:    [[ARRAYIDX5_1:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR31]], i64 1
; CHECK-NEXT:    [[TMP11:%.*]] = load i8, ptr [[ARRAYIDX5_1]], align 1
; CHECK-NEXT:    [[CONV6_1:%.*]] = zext i8 [[TMP11]] to i32
...
; CHECK-NEXT:    [[TMP12:%.*]] = load i8, ptr [[ARRAYIDX10_1]], align 1
; CHECK-NEXT:    [[CONV11_1:%.*]] = zext i8 [[TMP12]] to i32
...
; CHECK-NEXT:    [[TMP14:%.*]] = load i8, ptr [[ARRAYIDX15_1]], align 1
; CHECK-NEXT:    [[CONV16_1:%.*]] = zext i8 [[TMP14]] to i32
; CHECK-NEXT:    [[ARRAYIDX17_1:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR31]], i64 3
; CHECK-NEXT:    [[TMP15:%.*]] = load i8, ptr [[ARRAYIDX17_1]], align 1
; CHECK-NEXT:    [[CONV18_1:%.*]] = zext i8 [[TMP15]] to i32
...
; CHECK-NEXT:    [[TMP16:%.*]] = load i8, ptr [[ADD_PTR_1]], align 1
; CHECK-NEXT:    [[CONV_2:%.*]] = zext i8 [[TMP16]] to i32
; CHECK-NEXT:    [[TMP17:%.*]] = load i8, ptr [[ADD_PTR31_1]], align 1
; CHECK-NEXT:    [[CONV2_2:%.*]] = zext i8 [[TMP17]] to i32
; CHECK-NEXT:    [[SUB_2:%.*]] = sub nsw i32 [[CONV_2]], [[CONV2_2]]
; CHECK-NEXT:    [[ARRAYIDX3_2:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR_1]], i64 1
; CHECK-NEXT:    [[TMP18:%.*]] = load i8, ptr [[ARRAYIDX3_2]], align 1
; CHECK-NEXT:    [[CONV4_2:%.*]] = zext i8 [[TMP18]] to i32
; CHECK-NEXT:    [[ARRAYIDX5_2:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR31_1]], i64 1
; CHECK-NEXT:    [[TMP19:%.*]] = load i8, ptr [[ARRAYIDX5_2]], align 1
; CHECK-NEXT:    [[CONV6_2:%.*]] = zext i8 [[TMP19]] to i32
...
; CHECK-NEXT:    [[TMP20:%.*]] = load i8, ptr [[ARRAYIDX10_2]], align 1
; CHECK-NEXT:    [[CONV11_2:%.*]] = zext i8 [[TMP20]] to i32
...
; CHECK-NEXT:    [[CONV13_2:%.*]] = zext i8 [[TMP21]] to i32
...
; CHECK-NEXT:    [[TMP22:%.*]] = load i8, ptr [[ARRAYIDX15_2]], align 1
; CHECK-NEXT:    [[CONV16_2:%.*]] = zext i8 [[TMP22]] to i32
; CHECK-NEXT:    [[ARRAYIDX17_2:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR31_1]], i64 3
; CHECK-NEXT:    [[TMP23:%.*]] = load i8, ptr [[ARRAYIDX17_2]], align 1
; CHECK-NEXT:    [[CONV18_2:%.*]] = zext i8 [[TMP23]] to i32
...
; CHECK-NEXT:    [[TMP24:%.*]] = load i8, ptr [[ADD_PTR_2]], align 1
; CHECK-NEXT:    [[CONV_3:%.*]] = zext i8 [[TMP24]] to i32
; CHECK-NEXT:    [[TMP25:%.*]] = load i8, ptr [[ADD_PTR31_2]], align 1
; CHECK-NEXT:    [[CONV2_3:%.*]] = zext i8 [[TMP25]] to i32
...
; CHECK-NEXT:    [[TMP27:%.*]] = load i8, ptr [[ARRAYIDX5_3]], align 1
; CHECK-NEXT:    [[CONV6_3:%.*]] = zext i8 [[TMP27]] to i32
...
; CHECK-NEXT:    [[ADD9_3:%.*]] = add nsw i32 [[ADD_3]], [[SHL_3]]
; CHECK-NEXT:    [[ARRAYIDX10_3:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR_2]], i64 2
; CHECK-NEXT:    [[TMP28:%.*]] = load i8, ptr [[ARRAYIDX10_3]], align 1
; CHECK-NEXT:    [[CONV11_3:%.*]] = zext i8 [[TMP28]] to i32
...
; CHECK-NEXT:    [[TMP30:%.*]] = load i8, ptr [[ARRAYIDX15_3]], align 1
; CHECK-NEXT:    [[CONV16_3:%.*]] = zext i8 [[TMP30]] to i32
; CHECK-NEXT:    [[ARRAYIDX17_3:%.*]] = getelementptr inbounds nuw i8, ptr [[ADD_PTR31_2]], i64 3
; CHECK-NEXT:    [[TMP31:%.*]] = load i8, ptr [[ARRAYIDX17_3]], align 1
...
; CHECK-NEXT:    [[ADD23_3:%.*]] = add nsw i32 [[ADD20_3]], [[SHL22_3]]
; CHECK-NEXT:    [[ADD24_3:%.*]] = add nsw i32 [[ADD23_3]], [[ADD9_3]]
; CHECK-NEXT:    [[SUB27_3:%.*]] = sub nsw i32 [[ADD9_3]], [[ADD23_3]]
; CHECK-NEXT:    [[ADD44:%.*]] = add nsw i32 [[ADD24_1]], [[ADD24]]
; CHECK-NEXT:    [[SUB51:%.*]] = sub nsw i32 [[ADD24]], [[ADD24_1]]
; CHECK-NEXT:    [[ADD58:%.*]] = add nsw i32 [[ADD24_3]], [[ADD24_2]]
; CHECK-NEXT:    [[SUB65:%.*]] = sub nsw i32 [[ADD24_2]], [[ADD24_3]]
...
; CHECK-NEXT:    [[SHR_I131:%.*]] = lshr i32 [[ADD66]], 15
; CHECK-NEXT:    [[AND_I132:%.*]] = and i32 [[SHR_I131]], 65537
; CHECK-NEXT:    [[MUL_I133:%.*]] = mul nuw i32 [[AND_I132]], 65535
; CHECK-NEXT:    [[ADD_I134:%.*]] = add i32 [[MUL_I133]], [[ADD66]]
; CHECK-NEXT:    [[XOR_I135:%.*]] = xor i32 [[ADD_I134]], [[MUL_I133]]
...
; CHECK-NEXT:    [[SHR_I121:%.*]] = lshr i32 [[SUB67]], 15
; CHECK-NEXT:    [[AND_I122:%.*]] = and i32 [[SHR_I121]], 65537
; CHECK-NEXT:    [[MUL_I123:%.*]] = mul nuw i32 [[AND_I122]], 65535
; CHECK-NEXT:    [[ADD_I124:%.*]] = add i32 [[MUL_I123]], [[SUB67]]
; CHECK-NEXT:    [[XOR_I125:%.*]] = xor i32 [[ADD_I124]], [[MUL_I123]]
...
; CHECK-NEXT:    [[ADD66_1:%.*]] = add nsw i32 [[ADD58_1]], [[ADD44_1]]
; CHECK-NEXT:    [[SUB67_1:%.*]] = sub nsw i32 [[ADD44_1]], [[ADD58_1]]
; CHECK-NEXT:    [[ADD68_1:%.*]] = add nsw i32 [[SUB65_1]], [[SUB51_1]]
; CHECK-NEXT:    [[SUB69_1:%.*]] = sub nsw i32 [[SUB51_1]], [[SUB65_1]]
; CHECK-NEXT:    [[SHR_I131_1:%.*]] = lshr i32 [[ADD66_1]], 15
; CHECK-NEXT:    [[AND_I132_1:%.*]] = and i32 [[SHR_I131_1]], 65537
; CHECK-NEXT:    [[MUL_I133_1:%.*]] = mul nuw i32 [[AND_I132_1]], 65535
; CHECK-NEXT:    [[ADD_I134_1:%.*]] = add i32 [[MUL_I133_1]], [[ADD66_1]]
; CHECK-NEXT:    [[XOR_I135_1:%.*]] = xor i32 [[ADD_I134_1]], [[MUL_I133_1]]
...
; CHECK-NEXT:    [[SHR_I121_1:%.*]] = lshr i32 [[SUB67_1]], 15
; CHECK-NEXT:    [[AND_I122_1:%.*]] = and i32 [[SHR_I121_1]], 65537
; CHECK-NEXT:    [[MUL_I123_1:%.*]] = mul nuw i32 [[AND_I122_1]], 65535
; CHECK-NEXT:    [[ADD_I124_1:%.*]] = add i32 [[MUL_I123_1]], [[SUB67_1]]
; CHECK-NEXT:    [[XOR_I125_1:%.*]] = xor i32 [[ADD_I124_1]], [[MUL_I123_1]]
