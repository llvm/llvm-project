...
; vectorization requires a vector GEP + extracts, making the cost too high to vectorize.

define void @shouldnt_vectorize_gep(ptr %base1, ptr %base2, ptr %base_gep) {
; CHECK-LABEL: define void @shouldnt_vectorize_gep
