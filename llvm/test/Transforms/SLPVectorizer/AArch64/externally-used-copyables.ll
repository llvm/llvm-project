...
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <3 x i64> <i64 poison, i64 1, i64 1>, i64 [[TMP0]], i64 0
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <3 x i64> [[TMP15]], <3 x i64> <i64 -1, i64 poison, i64 poison>, <3 x i32> <i32 3, i32 0, i32 poison>
; CHECK-NEXT:    [[TMP21:%.*]] = insertelement <3 x i64> poison, i64 [[TMP25]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <3 x i64> [[TMP21]], <3 x i64> poison, <3 x i32> <i32 poison, i32 poison, i32 0>
; CHECK-NEXT:    [[TMP43:%.*]] = shufflevector <3 x i64> [[TMP16]], <3 x i64> [[TMP22]], <3 x i32> <i32 0, i32 1, i32 5>
; CHECK-NEXT:    [[TMP65:%.*]] = sub <3 x i64> [[TMP15]], [[TMP43]]
...
; CHECK-NEXT:    [[TMP78:%.*]] = shufflevector <3 x i64> [[TMP15]], <3 x i64> <i64 1, i64 1, i64 poison>, <3 x i32> <i32 3, i32 4, i32 0>
; CHECK-NEXT:    [[TMP89:%.*]] = shufflevector <3 x i64> [[TMP15]], <3 x i64> <i64 poison, i64 1, i64 poison>, <2 x i32> <i32 0, i32 4>
; CHECK-NEXT:    [[TMP90:%.*]] = shufflevector <2 x i64> [[TMP89]], <2 x i64> poison, <3 x i32> <i32 0, i32 0, i32 1>
...
; CHECK-NEXT:    [[TMP95:%.*]] = mul <3 x i64> [[TMP65]], [[TMP78]]
; CHECK-NEXT:    [[TMP114:%.*]] = mul <3 x i64> [[TMP95]], [[TMP90]]
; CHECK-NEXT:    [[TMP126:%.*]] = add <3 x i64> [[TMP95]], [[TMP90]]
; CHECK-NEXT:    [[TMP127:%.*]] = shufflevector <3 x i64> [[TMP114]], <3 x i64> [[TMP126]], <3 x i32> <i32 0, i32 1, i32 5>
...
; CHECK-NEXT:    [[TMP94:%.*]] = extractelement <3 x i64> [[TMP95]], i64 2
...
; CHECK-NEXT:    [[TMP128:%.*]] = shufflevector <3 x i64> [[TMP127]], <3 x i64> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP96:%.*]] = shufflevector <32 x i64> [[TMP93]], <32 x i64> [[TMP128]], <32 x i32> <i32 0, i32 1, i32 32, i32 33, i32 34, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
...
; CHECK-NEXT:    [[TMP129:%.*]] = shufflevector <3 x i64> [[TMP95]], <3 x i64> poison, <32 x i32> <i32 poison, i32 poison, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP130:%.*]] = shufflevector <3 x i64> [[TMP95]], <3 x i64> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP100:%.*]] = shufflevector <32 x i64> [[TMP99]], <32 x i64> [[TMP130]], <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 34, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
