...
; X86-DEFAULT-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; X86-DEFAULT-NEXT:    ret <4 x float> zeroinitializer
;
...
; X86-MIN-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; X86-MIN-NEXT:    ret <4 x float> zeroinitializer
;
