...
; X86T-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; X86T-NEXT:    ret <4 x float> zeroinitializer
;
...
; X86-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; X86-NEXT:    ret <4 x float> zeroinitializer
;
...
; X86TM-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; X86TM-NEXT:    ret <4 x float> zeroinitializer
;
...
; AARCH64T-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; AARCH64T-NEXT:    ret <4 x float> zeroinitializer
;
...
; AARCH64-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; AARCH64-NEXT:    ret <4 x float> zeroinitializer
;
...
; AARCH64TM-NEXT:    [[RA:%.*]] = insertelement <4 x float> zeroinitializer, float [[S0]], i32 0
...
; AARCH64TM-NEXT:    ret <4 x float> zeroinitializer
;
  %c0 = extractelement <4 x i32> %c, i32 0
  %c1 = extractelement <4 x i32> %c, i32 1
  %c2 = extractelement <4 x i32> %c, i32 2
