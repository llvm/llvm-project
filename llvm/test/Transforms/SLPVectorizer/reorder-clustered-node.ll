...
; X86-NEXT:    [[TMP2:%.*]] = insertelement <8 x ptr> <ptr null, ptr null, ptr poison, ptr poison, ptr null, ptr null, ptr null, ptr null>, ptr [[I242]], i64 2
; X86-NEXT:    [[TMP3:%.*]] = insertelement <8 x ptr> [[TMP2]], ptr [[I250]], i64 3
...
; X86-NEXT:    [[TMP7:%.*]] = insertelement <8 x ptr> poison, ptr [[I242]], i64 0
; X86-NEXT:    [[TMP8:%.*]] = insertelement <8 x ptr> [[TMP7]], ptr [[I248]], i64 1
; X86-NEXT:    [[TMP14:%.*]] = insertelement <8 x ptr> [[TMP8]], ptr [[I250]], i64 2
; X86-NEXT:    [[TMP15:%.*]] = insertelement <8 x ptr> [[TMP14]], ptr [[I245]], i64 3
...
; AARCH64-NEXT:    [[TMP2:%.*]] = insertelement <8 x ptr> <ptr poison, ptr null, ptr poison, ptr null, ptr null, ptr null, ptr null, ptr null>, ptr [[I242]], i64 0
; AARCH64-NEXT:    [[TMP3:%.*]] = insertelement <8 x ptr> [[TMP2]], ptr [[I250]], i64 2
...
; AARCH64-NEXT:    [[TMP6:%.*]] = insertelement <8 x ptr> [[TMP5]], ptr [[I245]], i64 2
; AARCH64-NEXT:    [[TMP7:%.*]] = insertelement <8 x ptr> [[TMP6]], ptr [[I248]], i64 3
