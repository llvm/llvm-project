...
;
; Loop bound loaded from an array element A[2], where A is also
...
; CHECK-NEXT:    [[DOTHOISTED:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
...
; CHECK-NEXT:    br i1 [[CONFLICT_RDX]], label %[[LOOP_PH_LVER_ORIG:.*]], label %[[LOOP_PH:.*]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[ARRAYIDX1_LVER_ORIG]], align 4
...
; CHECK-NEXT:    store i32 [[ADD_LVER_ORIG]], ptr [[ARRAYIDX5_LVER_ORIG]], align 4
...
; CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[ARRAYIDX1]], align 4, !alias.scope [[META2:![0-9]+]]
...
; CHECK-NEXT:    store i32 [[ADD]], ptr [[ARRAYIDX5]], align 4, !alias.scope [[META7:![0-9]+]], !noalias [[META9:![0-9]+]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 1
; CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !alias.scope [[META10:![0-9]+]]
