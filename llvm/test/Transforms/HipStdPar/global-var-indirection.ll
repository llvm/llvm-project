...
; CHECK: @[[GLOB6:[0-9]+]] = private addrspace(1) constant [3 x %struct.anon.1] [%struct.anon.1 { ptr addrspacecast (ptr addrspace(1) @[[GLOB0]] to ptr), ptr addrspacecast (ptr addrspace(1) @[[GLOB1]] to ptr) }, %struct.anon.1 { ptr addrspacecast (ptr addrspace(1) @[[GLOB2]] to ptr), ptr addrspacecast (ptr addrspace(1) @[[GLOB3]] to ptr) }, %struct.anon.1 { ptr addrspacecast (ptr addrspace(1) @[[GLOB4]] to ptr), ptr addrspacecast (ptr addrspace(1) @[[GLOB5]] to ptr) }]
; CHECK: @__hipstdpar_symbol_indirection_table = weak_odr protected addrspace(4) externally_initialized constant %class.anon { i64 3, ptr addrspacecast (ptr addrspace(1) @[[GLOB6]] to ptr), %struct.anon.1 poison }, align 8
;.
...
; CHECK-NEXT:    store ptr addrspace(1) [[TMP0]], ptr addrspace(1) poison, align 8
; CHECK-NEXT:    ret void
;
entry:
