...
; Address spaces 0, 5 and 6 are no-op-castable on this target; declare them as
; a no-op cast group so ArgumentPromotion can look through addrspacecasts when
; proving that promoted loads are dereferenceable.
target datalayout = "e-p:64:64-p5:32:32-p6:128:128:128:128-as:0:5:6"
