...
;
  ...
  %t18 = call i32 @llvm.wasm.trunc.signed.i32.f32(float f0x7FC00000); nan
  ...
  %t20 = call i32 @llvm.wasm.trunc.signed.i32.f32(float f0xFFC00000); -nan
...
;
  ...
  store volatile i32 %t16, ptr %p
  %t17 = call i32 @llvm.wasm.trunc.unsigned.i32.f32(float f0x7FC00000); nan
  store volatile i32 %t17, ptr %p
  %t18 = call i32 @llvm.wasm.trunc.unsigned.i32.f32(float 0x7ffa000000000000); nan:0x200000
  store volatile i32 %t18, ptr %p
  %t19 = call i32 @llvm.wasm.trunc.unsigned.i32.f32(float f0xFFC00000); -nan
  store volatile i32 %t19, ptr %p
...
;
  ...
  %t20 = call i64 @llvm.wasm.trunc.signed.i64.f32(float f0x7FC00000); nan
  ...
  %t22 = call i64 @llvm.wasm.trunc.signed.i64.f32(float f0xFFC00000); -nan
...
;
  ...
  store volatile i64 %t14, ptr %p
  %t15 = call i64 @llvm.wasm.trunc.unsigned.i64.f32(float f0x7FC00000); nan
  store volatile i64 %t15, ptr %p
  %t16 = call i64 @llvm.wasm.trunc.unsigned.i64.f32(float 0x7ffa000000000000); nan:0x200000
  store volatile i64 %t16, ptr %p
  %t17 = call i64 @llvm.wasm.trunc.unsigned.i64.f32(float f0xFFC00000); -nan
  store volatile i64 %t17, ptr %p
