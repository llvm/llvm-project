...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %min = call float @llvm.minnum.f32(float 0.0, float +qnan)
  ret float %min
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %min = call float @llvm.minnum.f32(float +qnan, float 0.0)
  ret float %min
}
...
;
  %1 = call <4 x float> @llvm.minnum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
;
  %1 = call <4 x bfloat> @llvm.minnum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
;
  %1 = call <4 x half> @llvm.minnum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %max = call float @llvm.maxnum.f32(float 0.0, float +qnan)
  ret float %max
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %max = call float @llvm.maxnum.f32(float +qnan, float 0.0)
  ret float %max
}
...
;
  %1 = call <4 x float> @llvm.maxnum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
;
  %1 = call <4 x bfloat> @llvm.maxnum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
;
  %1 = call <4 x half> @llvm.maxnum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
...
;
  %max = call float @llvm.minimum.f32(float 0.0, float +qnan)
  ret float %max
}
...
; CHECK-NEXT:    ret float +qnan
;
  %max = call float @llvm.minimum.f32(float +qnan, float 0.0)
  ret float %max
}
...
;
  %1 = call <4 x float> @llvm.minimum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
;
  %1 = call <4 x bfloat> @llvm.minimum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
;
  %1 = call <4 x half> @llvm.minimum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
...
; CHECK-NEXT:    ret float +qnan
;
  %max = call float @llvm.maximum.f32(float 0.0, float +qnan)
  ret float %max
}
...
; CHECK-NEXT:    ret float +qnan
;
  %max = call float @llvm.maximum.f32(float +qnan, float 0.0)
  ret float %max
}
...
;
  %1 = call <4 x float> @llvm.maximum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
;
  %1 = call <4 x bfloat> @llvm.maximum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
;
  %1 = call <4 x half> @llvm.maximum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %min = call float @llvm.minimumnum.f32(float 0.0, float +qnan)
  ret float %min
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %min = call float @llvm.minimumnum.f32(float +qnan, float 0.0)
  ret float %min
}
...
; CHECK-NEXT:    ret <4 x float> <float +qnan, float 5.000000e+00, float 4.200000e+01, float 5.000000e+00>
;
  %1 = call <4 x float> @llvm.minimumnum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
; CHECK-NEXT:    ret <4 x bfloat> <bfloat +qnan, bfloat 5.000000e+00, bfloat 4.200000e+01, bfloat 5.000000e+00>
;
  %1 = call <4 x bfloat> @llvm.minimumnum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
; CHECK-NEXT:    ret <4 x half> <half +qnan, half 5.000000e+00, half 4.200000e+01, half 5.000000e+00>
;
  %1 = call <4 x half> @llvm.minimumnum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %max = call float @llvm.maximumnum.f32(float 0.0, float +qnan)
  ret float %max
}
...
; CHECK-NEXT:    ret float 0.000000e+00
;
  %max = call float @llvm.maximumnum.f32(float +qnan, float 0.0)
  ret float %max
}
...
; CHECK-NEXT:    ret <4 x float> <float +qnan, float 5.000000e+00, float 4.200000e+01, float 4.200000e+01>
;
  %1 = call <4 x float> @llvm.maximumnum.v4f32(<4 x float> <float +qnan, float +qnan, float 42., float 42.>, <4 x float> <float +qnan, float 5., float +qnan, float 5.>)
  ret <4 x float> %1
}
...
; CHECK-NEXT:    ret <4 x bfloat> <bfloat +qnan, bfloat 5.000000e+00, bfloat 4.200000e+01, bfloat 4.200000e+01>
;
  %1 = call <4 x bfloat> @llvm.maximumnum.v4bf16(<4 x bfloat> <bfloat +qnan, bfloat +qnan, bfloat 42., bfloat 42.>, <4 x bfloat> <bfloat +qnan, bfloat 5., bfloat +qnan, bfloat 5.>)
  ret <4 x bfloat> %1
}
...
; CHECK-NEXT:    ret <4 x half> <half +qnan, half 5.000000e+00, half 4.200000e+01, half 4.200000e+01>
;
  %1 = call <4 x half> @llvm.maximumnum.v4f16(<4 x half> <half +qnan, half +qnan, half 42., half 42.>, <4 x half> <half +qnan, half 5., half +qnan, half 5.>)
  ret <4 x half> %1
}
