...
define float @canonicalize_pos_denorm_dynamic_dynamic() denormal_fpenv(dynamic,dynamic) {
...
define float @canonicalize_neg_denorm_dynamic_dynamic() denormal_fpenv(dynamic,dynamic) {
