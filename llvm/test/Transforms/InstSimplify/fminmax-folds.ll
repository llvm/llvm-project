...
; CHECK-NEXT:    ret void
;
  %minnum = call float @llvm.minnum.f32(float %x, float f0x7FA00000)
  store float %minnum, ptr %minnum_res
  %maxnum = call float @llvm.maxnum.f32(float %x, float f0x7FA00000)
  store float %maxnum, ptr %maxnum_res

  %minimum = call float @llvm.minimum.f32(float %x, float f0x7FA00000)
  store float %minimum, ptr %minimum_res
  %maximum = call float @llvm.maximum.f32(float %x, float f0x7FA00000)
  store float %maximum, ptr %maximum_res

  %minimumnum = call float @llvm.minimumnum.f32(float %x, float f0x7FA00000)
  store float %minimumnum, ptr %minimumnum_res
  %maximumnum = call float @llvm.maximumnum.f32(float %x, float f0x7FA00000)
  store float %maximumnum, ptr %maximumnum_res
  ret void
}
...
; CHECK-NEXT:    ret void
;
  %minnum = call nnan <3 x float> @llvm.minnum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
  store <3 x float> %minnum, ptr %minnum_res
  %maxnum = call nnan <3 x float> @llvm.maxnum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
  store <3 x float> %maxnum, ptr %maxnum_res

  %minimum = call nnan <3 x float> @llvm.minimum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
  store <3 x float> %minimum, ptr %minimum_res
  %maximum = call nnan <3 x float> @llvm.maximum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
  store <3 x float> %maximum, ptr %maximum_res

  %minimumnum = call nnan <3 x float> @llvm.minimumnum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
  store <3 x float> %minimumnum, ptr %minimumnum_res
  %maximumnum = call nnan <3 x float> @llvm.maximumnum.v3f32(<3 x float> <float poison, float +inf, float f0x7FA00000>, <3 x float> %x)
