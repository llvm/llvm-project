...
; CHECK-NEXT:    [[TMP3:%.*]] = tail call ptr @llvm.objc.retain(ptr [[VAL2]]) #[[ATTR0]]
; CHECK-NEXT:    call void (...) @llvm.objc.clang.arc.use(ptr [[VAL1]]) #[[ATTR0]]
; CHECK-NEXT:    call void @llvm.objc.release(ptr [[VAL1]]) #[[ATTR0]]
; CHECK-NEXT:    [[TMP4:%.*]] = call ptr @llvm.objc.autorelease(ptr [[X]]) #[[ATTR0]]
...
; ARC optimizer should be able to safely remove the retain/release pair as the
; call to @llvm.memcpy is a no-op from ARC's perspective.
declare void @llvm.memcpy.p0.p0.i64(ptr noalias nocapture writeonly, ptr noalias nocapture readonly, i64, i1 immarg) #1


define void @test_memcpy(ptr %out, ptr %x) {
; CHECK-LABEL: define void @test_memcpy(
; CHECK-SAME: ptr [[OUT:%.*]], ptr [[X:%.*]]) {
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[OUT]], ptr align 8 [[X]], i64 8, i1 false)
; CHECK-NEXT:    ret void
;
  call ptr @llvm.objc.retain(ptr %x)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %out, ptr align 8 %x, i64 8, i1 false)
  call void @llvm.objc.release(ptr %x), !clang.imprecise_release !0
  ret void
}
...
define void @test_memcpy_unordered_atomic(ptr %out, ptr %x) {
; CHECK-LABEL: define void @test_memcpy_unordered_atomic(
; CHECK-SAME: ptr [[OUT:%.*]], ptr [[X:%.*]]) {
; CHECK-NEXT:    call void @llvm.memcpy.element.unordered.atomic.p0.p0.i64(ptr align 8 [[OUT]], ptr align 8 [[X]], i64 8, i32 8)
; CHECK-NEXT:    ret void
;
  call ptr @llvm.objc.retain(ptr %x)
  call void @llvm.memcpy.element.unordered.atomic.p0.p0.i64(ptr align 8 %out, ptr align 8 %x, i64 8, i32 8)
  call void @llvm.objc.release(ptr %x), !clang.imprecise_release !0
  ret void
}

define void @test_memcpy_inline(ptr %out, ptr %x) {
; CHECK-LABEL: define void @test_memcpy_inline(
; CHECK-SAME: ptr [[OUT:%.*]], ptr [[X:%.*]]) {
; CHECK-NEXT:    call void @llvm.memcpy.inline.p0.p0.i64(ptr align 8 [[OUT]], ptr align 8 [[X]], i64 8, i1 false)
; CHECK-NEXT:    ret void
;
  call ptr @llvm.objc.retain(ptr %x)
  call void @llvm.memcpy.inline.p0.p0.i64(ptr align 8 %out, ptr align 8 %x, i64 8, i1 false)
  call void @llvm.objc.release(ptr %x), !clang.imprecise_release !0
  ret void
}

define void @test_memset(ptr %out, ptr %x) {
; CHECK-LABEL: define void @test_memset(
; CHECK-SAME: ptr [[OUT:%.*]], ptr [[X:%.*]]) {
...
define void @test_memcpy_precise(ptr %out, ptr %x) {
; CHECK-LABEL: define void @test_memcpy_precise(
; CHECK-SAME: ptr [[OUT:%.*]], ptr [[X:%.*]]) {
