...
; RUN: llvm-modextract --opaque-pointers=0 -n 0 -o - %t | llvm-dis --opaque-pointers=0 | FileCheck --check-prefix=CHECK0 %s
; RUN: llvm-modextract --opaque-pointers=0 -n 1 -o - %t | llvm-dis --opaque-pointers=0 | FileCheck --check-prefix=CHECK1 %s
; CHECK0-NOT: @{{.*}}anon{{.*}}=
