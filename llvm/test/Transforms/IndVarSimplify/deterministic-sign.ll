...
; RUN: opt --opaque-pointers=0 "-passes=loop-rotate,indvars" -S < %s | FileCheck %s
; RUN: opt --opaque-pointers=0 "-passes=loop-rotate" < %s | opt  --opaque-pointers=0 "-passes=indvars" -S - | FileCheck %s
