...
entry:
  ...
  %conv = trunc nuw i256 %shr to i128
  %0 = call i128 @llvm.cttz.i128(i128 %conv, i1 false)
  %add = add nuw nsw i128 %0, 128
  %1 = call i128 @llvm.cttz.i128(i128 %conv1, i1 true)
...
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @llvm.cttz.i32(i32 [[CONV]], i1 false)
; CHECK-NEXT:    [[ADD:%.*]] = add nuw nsw i32 [[TMP0]], 32
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.cttz.i32(i32 [[CONV1]], i1 true)
; CHECK-NEXT:    [[RETVAL:%.*]] = select i1 [[CMP]], i32 [[ADD]], i32 [[TMP1]]
...
entry:
  ...
  %0 = call i32 @llvm.cttz.i32(i32 %conv, i1 false)
  %add = add nuw nsw i32 %0, 32
  %1 = call i32 @llvm.cttz.i32(i32 %conv1, i1 true)
  %retval = select i1 %cmp, i32 %add, i32 %1
