...
define void @test(<5 x i16> %x) #0 {
; CHECK-LABEL: define void @test(
; CHECK-SAME: <5 x i16> [[X:%.*]]) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:    [[V1:%.*]] = shufflevector <5 x i16> [[X]], <5 x i16> poison, <10 x i32> zeroinitializer
; CHECK-NEXT:    [[V2:%.*]] = bitcast <10 x i16> [[V1]] to <4 x i40>
; CHECK-NEXT:    call void @use.vec(<4 x i40> [[V2]])
; CHECK-NEXT:    ret void
;
  %S = shufflevector <5 x i16> %x, <5 x i16> poison, <10 x i32> zeroinitializer
