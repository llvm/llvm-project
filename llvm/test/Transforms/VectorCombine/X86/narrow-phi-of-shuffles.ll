...
; RUN: opt -mtriple=x86_64-- -mcpu=x86-64 -passes=vector-combine -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-V1,CHECK-NO-AVX
; RUN: opt -mtriple=x86_64-- -mcpu=x86-64-v2 -passes=vector-combine -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-V2,CHECK-NO-AVX
; RUN: opt -mtriple=x86_64-- -mcpu=x86-64-v3 -passes=vector-combine -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-V3,CHECK-AVX
; RUN: opt -mtriple=x86_64-- -mcpu=x86-64-v4 -passes=vector-combine -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-V4,CHECK-AVX
...
; CHECK-NO-AVX-LABEL: define <4 x bfloat> @shuffle_v4bf16(
; CHECK-NO-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-NO-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-NO-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-NO-AVX:       [[THEN]]:
; CHECK-NO-AVX-NEXT:    [[TMP0:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <3 x i32> <i32 2, i32 0, i32 1>
; CHECK-NO-AVX-NEXT:    tail call void @func0()
; CHECK-NO-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-NO-AVX:       [[ELSE]]:
; CHECK-NO-AVX-NEXT:    tail call void @func1()
; CHECK-NO-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-NO-AVX:       [[FINALLY]]:
; CHECK-NO-AVX-NEXT:    [[TMP1:%.*]] = phi <3 x bfloat> [ [[TMP0]], %[[THEN]] ], [ [[ARG0]], %[[ELSE]] ]
; CHECK-NO-AVX-NEXT:    [[VAL3:%.*]] = shufflevector <3 x bfloat> [[TMP1]], <3 x bfloat> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
; CHECK-NO-AVX-NEXT:    ret <4 x bfloat> [[VAL3]]
;
; CHECK-AVX-LABEL: define <4 x bfloat> @shuffle_v4bf16(
; CHECK-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-AVX:       [[THEN]]:
; CHECK-AVX-NEXT:    [[VAL1:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
; CHECK-AVX-NEXT:    tail call void @func0()
; CHECK-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-AVX:       [[ELSE]]:
; CHECK-AVX-NEXT:    [[VAL2:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2>
; CHECK-AVX-NEXT:    tail call void @func1()
; CHECK-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-AVX:       [[FINALLY]]:
; CHECK-AVX-NEXT:    [[VAL3:%.*]] = phi <4 x bfloat> [ [[VAL1]], %[[THEN]] ], [ [[VAL2]], %[[ELSE]] ]
; CHECK-AVX-NEXT:    ret <4 x bfloat> [[VAL3]]
;
entry:
  br i1 %cond, label %then, label %else
...
; CHECK-NO-AVX-LABEL: define <6 x bfloat> @shuffle_v6bf16(
; CHECK-NO-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-NO-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-NO-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-NO-AVX:       [[THEN]]:
...
; CHECK-NO-AVX:       [[FINALLY]]:
; CHECK-NO-AVX-NEXT:    [[TMP1:%.*]] = phi <3 x bfloat> [ [[TMP0]], %[[THEN]] ], [ [[ARG0]], %[[ELSE]] ]
; CHECK-NO-AVX-NEXT:    [[VAL3:%.*]] = shufflevector <3 x bfloat> [[TMP1]], <3 x bfloat> poison, <6 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-NO-AVX-NEXT:    ret <6 x bfloat> [[VAL3]]
;
; CHECK-AVX-LABEL: define <6 x bfloat> @shuffle_v6bf16(
; CHECK-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-AVX:       [[THEN]]:
; CHECK-AVX-NEXT:    [[VAL1:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <6 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
; CHECK-AVX-NEXT:    tail call void @func0()
; CHECK-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-AVX:       [[ELSE]]:
; CHECK-AVX-NEXT:    [[VAL2:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <6 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-AVX-NEXT:    tail call void @func1()
; CHECK-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-AVX:       [[FINALLY]]:
; CHECK-AVX-NEXT:    [[VAL3:%.*]] = phi <6 x bfloat> [ [[VAL1]], %[[THEN]] ], [ [[VAL2]], %[[ELSE]] ]
; CHECK-AVX-NEXT:    ret <6 x bfloat> [[VAL3]]
;
entry:
  br i1 %cond, label %then, label %else
...
; CHECK-NO-AVX-LABEL: define <8 x bfloat> @shuffle_v8bf16(
; CHECK-NO-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-NO-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-NO-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-NO-AVX:       [[THEN]]:
...
; CHECK-NO-AVX:       [[FINALLY]]:
; CHECK-NO-AVX-NEXT:    [[TMP1:%.*]] = phi <3 x bfloat> [ [[TMP0]], %[[THEN]] ], [ [[ARG0]], %[[ELSE]] ]
; CHECK-NO-AVX-NEXT:    [[VAL3:%.*]] = shufflevector <3 x bfloat> [[TMP1]], <3 x bfloat> poison, <8 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-NO-AVX-NEXT:    ret <8 x bfloat> [[VAL3]]
;
; CHECK-AVX-LABEL: define <8 x bfloat> @shuffle_v8bf16(
; CHECK-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-AVX:       [[THEN]]:
; CHECK-AVX-NEXT:    [[VAL1:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
; CHECK-AVX-NEXT:    tail call void @func0()
; CHECK-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-AVX:       [[ELSE]]:
; CHECK-AVX-NEXT:    [[VAL2:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <8 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-AVX-NEXT:    tail call void @func1()
; CHECK-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-AVX:       [[FINALLY]]:
; CHECK-AVX-NEXT:    [[VAL3:%.*]] = phi <8 x bfloat> [ [[VAL1]], %[[THEN]] ], [ [[VAL2]], %[[ELSE]] ]
; CHECK-AVX-NEXT:    ret <8 x bfloat> [[VAL3]]
;
entry:
  br i1 %cond, label %then, label %else
...
; CHECK-NO-AVX-LABEL: define <16 x bfloat> @shuffle_v16bf16(
; CHECK-NO-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-NO-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-NO-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-NO-AVX:       [[THEN]]:
...
; CHECK-NO-AVX:       [[FINALLY]]:
; CHECK-NO-AVX-NEXT:    [[TMP1:%.*]] = phi <3 x bfloat> [ [[TMP0]], %[[THEN]] ], [ [[ARG0]], %[[ELSE]] ]
; CHECK-NO-AVX-NEXT:    [[VAL3:%.*]] = shufflevector <3 x bfloat> [[TMP1]], <3 x bfloat> poison, <16 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-NO-AVX-NEXT:    ret <16 x bfloat> [[VAL3]]
;
; CHECK-AVX-LABEL: define <16 x bfloat> @shuffle_v16bf16(
; CHECK-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-AVX:       [[THEN]]:
; CHECK-AVX-NEXT:    [[VAL1:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <16 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
; CHECK-AVX-NEXT:    tail call void @func0()
; CHECK-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-AVX:       [[ELSE]]:
; CHECK-AVX-NEXT:    [[VAL2:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <16 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-AVX-NEXT:    tail call void @func1()
; CHECK-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-AVX:       [[FINALLY]]:
; CHECK-AVX-NEXT:    [[VAL3:%.*]] = phi <16 x bfloat> [ [[VAL1]], %[[THEN]] ], [ [[VAL2]], %[[ELSE]] ]
; CHECK-AVX-NEXT:    ret <16 x bfloat> [[VAL3]]
;
entry:
  br i1 %cond, label %then, label %else
...
; CHECK-NO-AVX-LABEL: define <32 x bfloat> @shuffle_v32bf16(
; CHECK-NO-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-NO-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-NO-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-NO-AVX:       [[THEN]]:
...
; CHECK-NO-AVX:       [[FINALLY]]:
; CHECK-NO-AVX-NEXT:    [[TMP1:%.*]] = phi <3 x bfloat> [ [[TMP0]], %[[THEN]] ], [ [[ARG0]], %[[ELSE]] ]
; CHECK-NO-AVX-NEXT:    [[VAL3:%.*]] = shufflevector <3 x bfloat> [[TMP1]], <3 x bfloat> poison, <32 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-NO-AVX-NEXT:    ret <32 x bfloat> [[VAL3]]
;
; CHECK-AVX-LABEL: define <32 x bfloat> @shuffle_v32bf16(
; CHECK-AVX-SAME: <3 x bfloat> [[ARG0:%.*]], i1 [[COND:%.*]]) #[[ATTR0]] {
; CHECK-AVX-NEXT:  [[ENTRY:.*:]]
; CHECK-AVX-NEXT:    br i1 [[COND]], label %[[THEN:.*]], label %[[ELSE:.*]]
; CHECK-AVX:       [[THEN]]:
; CHECK-AVX-NEXT:    [[VAL1:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <32 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
; CHECK-AVX-NEXT:    tail call void @func0()
; CHECK-AVX-NEXT:    br label %[[FINALLY:.*]]
; CHECK-AVX:       [[ELSE]]:
; CHECK-AVX-NEXT:    [[VAL2:%.*]] = shufflevector <3 x bfloat> [[ARG0]], <3 x bfloat> poison, <32 x i32> <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
; CHECK-AVX-NEXT:    tail call void @func1()
; CHECK-AVX-NEXT:    br label %[[FINALLY]]
; CHECK-AVX:       [[FINALLY]]:
; CHECK-AVX-NEXT:    [[VAL3:%.*]] = phi <32 x bfloat> [ [[VAL1]], %[[THEN]] ], [ [[VAL2]], %[[ELSE]] ]
; CHECK-AVX-NEXT:    ret <32 x bfloat> [[VAL3]]
;
entry:
  br i1 %cond, label %then, label %else
