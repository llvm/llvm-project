...
; RUN: opt < %s -passes=vector-combine -S -mtriple=amdgpu12.01-amd-amdpal | FileCheck %s

define void @shrink_i32_load_prefix(ptr addrspace(1) %out, ptr addrspace(4) %p) {
; CHECK-LABEL: define void @shrink_i32_load_prefix(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], ptr addrspace(4) [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <3 x i32>, ptr addrspace(4) [[TMP0]], align 4, !tbaa [[TBAA2:![0-9]+]], !alias.scope [[META6:![0-9]+]], !noalias [[META9:![0-9]+]]
...
;
entry:
  %v = load <4 x i32>, ptr addrspace(4) %p, align 8, !tbaa.struct !6, !alias.scope !7, !noalias !10
  %e1 = extractelement <4 x i32> %v, i32 1
  %e2 = extractelement <4 x i32> %v, i32 2
  %e3 = extractelement <4 x i32> %v, i32 3
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], ptr addrspace(4) [[P:%.*]], i32 [[IDX:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[V:%.*]] = load <4 x i32>, ptr addrspace(4) [[P]], align 8
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], ptr addrspace(4) [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[E:%.*]] = load i32, ptr addrspace(4) [[P]], align 4
; CHECK-NEXT:    store i32 [[E]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
entry:
...
define void @do_not_shrink_too_many_users(ptr addrspace(1) %out, ptr addrspace(4) %p) {
; CHECK-LABEL: define void @do_not_shrink_too_many_users(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], ptr addrspace(4) [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[V:%.*]] = load <4 x i32>, ptr addrspace(4) [[P]], align 8
; CHECK-NEXT:    [[E0_0:%.*]] = extractelement <4 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1_0:%.*]] = extractelement <4 x i32> [[V]], i32 1
; CHECK-NEXT:    [[E0_1:%.*]] = extractelement <4 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1_1:%.*]] = extractelement <4 x i32> [[V]], i32 1
; CHECK-NEXT:    [[E0_2:%.*]] = extractelement <4 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1_2:%.*]] = extractelement <4 x i32> [[V]], i32 1
; CHECK-NEXT:    [[E0_3:%.*]] = extractelement <4 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1_3:%.*]] = extractelement <4 x i32> [[V]], i32 1
; CHECK-NEXT:    [[A0:%.*]] = add i32 [[E0_0]], [[E1_0]]
; CHECK-NEXT:    [[A1:%.*]] = add i32 [[E0_1]], [[E1_1]]
; CHECK-NEXT:    [[A2:%.*]] = add i32 [[E0_2]], [[E1_2]]
; CHECK-NEXT:    [[A3:%.*]] = add i32 [[E0_3]], [[E1_3]]
; CHECK-NEXT:    [[B0:%.*]] = add i32 [[A0]], [[A1]]
; CHECK-NEXT:    [[B1:%.*]] = add i32 [[A2]], [[A3]]
; CHECK-NEXT:    [[SUM:%.*]] = add i32 [[B0]], [[B1]]
; CHECK-NEXT:    store i32 [[SUM]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
entry:
  %v = load <4 x i32>, ptr addrspace(4) %p, align 8
  %e0.0 = extractelement <4 x i32> %v, i32 0
  %e1.0 = extractelement <4 x i32> %v, i32 1
  %e0.1 = extractelement <4 x i32> %v, i32 0
  %e1.1 = extractelement <4 x i32> %v, i32 1
  %e0.2 = extractelement <4 x i32> %v, i32 0
  %e1.2 = extractelement <4 x i32> %v, i32 1
  %e0.3 = extractelement <4 x i32> %v, i32 0
  %e1.3 = extractelement <4 x i32> %v, i32 1
  %a0 = add i32 %e0.0, %e1.0
  %a1 = add i32 %e0.1, %e1.1
  %a2 = add i32 %e0.2, %e1.2
  %a3 = add i32 %e0.3, %e1.3
  %b0 = add i32 %a0, %a1
  %b1 = add i32 %a2, %a3
  %sum = add i32 %b0, %b1
...
define void @do_not_shrink_when_split_loads_cost_more(ptr addrspace(1) %out, ptr addrspace(4) %p) {
; CHECK-LABEL: define void @do_not_shrink_when_split_loads_cost_more(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], ptr addrspace(4) [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[V:%.*]] = load <15 x i32>, ptr addrspace(4) [[P]], align 8
; CHECK-NEXT:    [[E0:%.*]] = extractelement <15 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1:%.*]] = extractelement <15 x i32> [[V]], i32 1
; CHECK-NEXT:    [[E3:%.*]] = extractelement <15 x i32> [[V]], i32 3
; CHECK-NEXT:    [[E4:%.*]] = extractelement <15 x i32> [[V]], i32 4
; CHECK-NEXT:    [[E6:%.*]] = extractelement <15 x i32> [[V]], i32 6
; CHECK-NEXT:    [[E7:%.*]] = extractelement <15 x i32> [[V]], i32 7
; CHECK-NEXT:    [[E9:%.*]] = extractelement <15 x i32> [[V]], i32 9
; CHECK-NEXT:    [[E10:%.*]] = extractelement <15 x i32> [[V]], i32 10
; CHECK-NEXT:    [[E12:%.*]] = extractelement <15 x i32> [[V]], i32 12
; CHECK-NEXT:    [[E13:%.*]] = extractelement <15 x i32> [[V]], i32 13
; CHECK-NEXT:    [[A0:%.*]] = add i32 [[E0]], [[E1]]
; CHECK-NEXT:    [[A1:%.*]] = add i32 [[E3]], [[E4]]
; CHECK-NEXT:    [[A2:%.*]] = add i32 [[E6]], [[E7]]
; CHECK-NEXT:    [[A3:%.*]] = add i32 [[E9]], [[E10]]
; CHECK-NEXT:    [[A4:%.*]] = add i32 [[E12]], [[E13]]
; CHECK-NEXT:    [[B0:%.*]] = add i32 [[A0]], [[A1]]
; CHECK-NEXT:    [[B1:%.*]] = add i32 [[A2]], [[A3]]
; CHECK-NEXT:    [[B2:%.*]] = add i32 [[B0]], [[B1]]
; CHECK-NEXT:    [[SUM:%.*]] = add i32 [[B2]], [[A4]]
; CHECK-NEXT:    store i32 [[SUM]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
entry:
  %v = load <15 x i32>, ptr addrspace(4) %p, align 8
  %e0 = extractelement <15 x i32> %v, i32 0
  %e1 = extractelement <15 x i32> %v, i32 1
  %e3 = extractelement <15 x i32> %v, i32 3
  %e4 = extractelement <15 x i32> %v, i32 4
  %e6 = extractelement <15 x i32> %v, i32 6
  %e7 = extractelement <15 x i32> %v, i32 7
  %e9 = extractelement <15 x i32> %v, i32 9
  %e10 = extractelement <15 x i32> %v, i32 10
  %e12 = extractelement <15 x i32> %v, i32 12
  %e13 = extractelement <15 x i32> %v, i32 13
  %a0 = add i32 %e0, %e1
  %a1 = add i32 %e3, %e4
  %a2 = add i32 %e6, %e7
  %a3 = add i32 %e9, %e10
...
define amdgpu_ps void @do_not_shrink_uniform_global_load(ptr addrspace(1) inreg %p,
; CHECK-LABEL: define amdgpu_ps void @do_not_shrink_uniform_global_load(
; CHECK-SAME: ptr addrspace(1) inreg [[P:%.*]], ptr addrspace(1) [[OUT:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[V:%.*]] = load <12 x i32>, ptr addrspace(1) [[P]], align 8, !invariant.load [[META1]]
; CHECK-NEXT:    [[E0:%.*]] = extractelement <12 x i32> [[V]], i32 0
; CHECK-NEXT:    [[E1:%.*]] = extractelement <12 x i32> [[V]], i32 1
; CHECK-NEXT:    [[E2:%.*]] = extractelement <12 x i32> [[V]], i32 2
; CHECK-NEXT:    [[E4:%.*]] = extractelement <12 x i32> [[V]], i32 4
; CHECK-NEXT:    [[E5:%.*]] = extractelement <12 x i32> [[V]], i32 5
; CHECK-NEXT:    [[E6:%.*]] = extractelement <12 x i32> [[V]], i32 6
; CHECK-NEXT:    [[E8:%.*]] = extractelement <12 x i32> [[V]], i32 8
; CHECK-NEXT:    [[E9:%.*]] = extractelement <12 x i32> [[V]], i32 9
; CHECK-NEXT:    [[E10:%.*]] = extractelement <12 x i32> [[V]], i32 10
; CHECK-NEXT:    [[A0:%.*]] = add i32 [[E0]], [[E1]]
; CHECK-NEXT:    [[A1:%.*]] = add i32 [[A0]], [[E2]]
; CHECK-NEXT:    [[A2:%.*]] = add i32 [[A1]], [[E4]]
; CHECK-NEXT:    [[A3:%.*]] = add i32 [[A2]], [[E5]]
; CHECK-NEXT:    [[A4:%.*]] = add i32 [[A3]], [[E6]]
; CHECK-NEXT:    [[A5:%.*]] = add i32 [[A4]], [[E8]]
; CHECK-NEXT:    [[A6:%.*]] = add i32 [[A5]], [[E9]]
; CHECK-NEXT:    [[SUM:%.*]] = add i32 [[A6]], [[E10]]
; CHECK-NEXT:    store i32 [[SUM]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
  ptr addrspace(1) %out) {
entry:
  %v = load <12 x i32>, ptr addrspace(1) %p, align 8, !invariant.load !1
  %e0 = extractelement <12 x i32> %v, i32 0
  %e1 = extractelement <12 x i32> %v, i32 1
  %e2 = extractelement <12 x i32> %v, i32 2
  %e4 = extractelement <12 x i32> %v, i32 4
  %e5 = extractelement <12 x i32> %v, i32 5
  %e6 = extractelement <12 x i32> %v, i32 6
  %e8 = extractelement <12 x i32> %v, i32 8
  %e9 = extractelement <12 x i32> %v, i32 9
  %e10 = extractelement <12 x i32> %v, i32 10
  %a0 = add i32 %e0, %e1
  %a1 = add i32 %a0, %e2
  %a2 = add i32 %a1, %e4
  %a3 = add i32 %a2, %e5
...
!7 = !{!8}
!8 = distinct !{!8, !9, !"scope"}
!9 = distinct !{!9, !"scope domain"}
!10 = !{!11}
!11 = distinct !{!11, !9, !"other scope"}
;.
...
; CHECK: [[META7]] = distinct !{[[META7]], [[META8:![0-9]+]], !"scope"}
; CHECK: [[META8]] = distinct !{[[META8]], !"scope domain"}
; CHECK: [[META9]] = !{[[META10:![0-9]+]]}
; CHECK: [[META10]] = distinct !{[[META10]], [[META8]], !"other scope"}
;.
