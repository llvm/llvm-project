...
; RUN: opt -S -mtriple=amdgpu9.42-amd-amdhsa -passes=vector-combine < %s | FileCheck -check-prefix=GFX9 %s
; RUN: opt -S -mtriple=amdgpu12.50-amd-amdhsa -passes=vector-combine < %s | FileCheck -check-prefix=GFX12 %s
