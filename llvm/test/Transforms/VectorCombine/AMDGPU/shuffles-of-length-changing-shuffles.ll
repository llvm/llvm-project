...
; RUN: opt -S -mtriple=amdgpu12.50-- -passes=vector-combine < %s | FileCheck -check-prefix=OPT %s

define <8 x i8> @extending0(<8 x i8> %a, <4 x i8> %b) {
; OPT-LABEL: define <8 x i8> @extending0(
; OPT-SAME: <8 x i8> [[A:%.*]], <4 x i8> [[B:%.*]]) {
