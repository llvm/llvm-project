...
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[IDX]] to i64
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <4 x i32>, ptr [[Q:%.*]], i64 0, i64 [[TMP1]]
...
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; CHECK-NEXT:    [[TMP2:%.*]] = zext i32 [[IDX]] to i64
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds <8 x i64>, ptr [[Q:%.*]], i64 0, i64 [[TMP2]]
...
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[IDX]] to i64
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <16 x i8>, ptr [[Q:%.*]], i64 0, i64 [[TMP1]]
; CHECK-NEXT:    store i8 [[S:%.*]], ptr [[TMP0]], align 1
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    call void @llvm.assume(i1 [[CMP]])
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[IDX]] to i64
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <vscale x 16 x i8>, ptr [[Q:%.*]], i64 0, i64 [[TMP1]]
; CHECK-NEXT:    store i8 [[S:%.*]], ptr [[TMP0]], align 1
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[IDX_CLAMPED]] to i64
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds <16 x i8>, ptr [[Q:%.*]], i64 0, i64 [[TMP1]]
; CHECK-NEXT:    store i8 [[S:%.*]], ptr [[TMP0]], align 1
; CHECK-NEXT:    ret void
;
