...
; RUN: opt -S -passes=vector-combine -data-layout=E < %s | FileCheck %s
declare void @might_throw() readnone

define void @insert_store_index_assume_after_load(ptr %p, i32 %x, i32 noundef %idx) {
; CHECK-LABEL: @insert_store_index_assume_after_load(
...
;
  ...
  %v1 = insertelement <4 x i32> %v, i32 %x, i32 %idx
