...
define <4 x i32> @negative_deinterleave2_extract_used_twice_in_member(<4 x i32> %a) {
; CHECK-LABEL: define <4 x i32> @negative_deinterleave2_extract_used_twice_in_member(
...
define <4 x i32> @negative_deinterleave2_extracts_feed_two_interleaves(<4 x i32> %a) {
; CHECK-LABEL: define <4 x i32> @negative_deinterleave2_extracts_feed_two_interleaves(
; CHECK-SAME: <4 x i32> [[A:%.*]]) {
; CHECK-NEXT:    [[DA:%.*]] = call { <2 x i32>, <2 x i32> } @llvm.vector.deinterleave2.v4i32(<4 x i32> [[A]])
; CHECK-NEXT:    [[A0:%.*]] = extractvalue { <2 x i32>, <2 x i32> } [[DA]], 0
; CHECK-NEXT:    [[A1:%.*]] = extractvalue { <2 x i32>, <2 x i32> } [[DA]], 1
