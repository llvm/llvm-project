...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ <i32 0, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1>, [[VECTOR_PH]] ], [ [[TMP5:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = and <8 x i32> [[VEC_PHI]], splat (i32 255)
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i8, ptr [[PTR:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i8>, ptr [[TMP1]], align 1
; CHECK-NEXT:    [[TMP2:%.*]] = zext <8 x i8> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEXT:    [[TMP6:%.*]] = and <8 x i32> [[TMP0]], [[TMP2]]
; CHECK-NEXT:    [[TMP4:%.*]] = trunc <8 x i32> [[TMP6]] to <8 x i8>
; CHECK-NEXT:    [[TMP5]] = zext <8 x i8> [[TMP4]] to <8 x i32>
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 8
; CHECK-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[INDEX_NEXT]], 256
; CHECK-NEXT:    br i1 [[TMP3]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP7:%.*]] = call i8 @llvm.vector.reduce.and.v8i8(<8 x i8> [[TMP4]])
; CHECK-NEXT:    [[TMP8:%.*]] = zext i8 [[TMP7]] to i32
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.end:
; CHECK-NEXT:    [[AND_LCSSA_OFF0:%.*]] = trunc i32 [[TMP8]] to i8
...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i16, ptr [[PTR:%.*]], i32 [[INDEX]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i16>, ptr [[TMP1]], align 2
; CHECK-NEXT:    [[TMP2:%.*]] = zext <8 x i16> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEXT:    [[TMP6:%.*]] = or <8 x i32> [[TMP0]], [[TMP2]]
; CHECK-NEXT:    [[TMP4:%.*]] = trunc <8 x i32> [[TMP6]] to <8 x i16>
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP7:%.*]] = call i16 @llvm.vector.reduce.or.v8i16(<8 x i16> [[TMP4]])
; CHECK-NEXT:    [[TMP8:%.*]] = zext i16 [[TMP7]] to i32
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.end:
; CHECK-NEXT:    [[XOR_LCSSA_OFF0:%.*]] = trunc i32 [[TMP8]] to i16
...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i16>, ptr [[TMP1]], align 2
; CHECK-NEXT:    [[TMP2:%.*]] = zext <8 x i16> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEXT:    [[TMP6:%.*]] = xor <8 x i32> [[TMP0]], [[TMP2]]
; CHECK-NEXT:    [[TMP4:%.*]] = trunc <8 x i32> [[TMP6]] to <8 x i16>
; CHECK-NEXT:    [[TMP5]] = zext <8 x i16> [[TMP4]] to <8 x i32>
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 8
; CHECK-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[INDEX_NEXT]], 256
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP7:%.*]] = call i16 @llvm.vector.reduce.xor.v8i16(<8 x i16> [[TMP4]])
; CHECK-NEXT:    [[TMP8:%.*]] = zext i16 [[TMP7]] to i32
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.end:
; CHECK-NEXT:    [[XOR_LCSSA_OFF0:%.*]] = trunc i32 [[TMP8]] to i16
...
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds i8, ptr [[PTR:%.*]], i32 [[IV]]
; CHECK-NEXT:    [[LOAD:%.*]] = load i8, ptr [[GEP]], align 1
; CHECK-NEXT:    [[EXT:%.*]] = sext i8 [[LOAD]] to i32
; CHECK-NEXT:    [[ICMP:%.*]] = icmp slt i32 [[SUM_02]], [[EXT]]
; CHECK-NEXT:    [[MIN]] = select i1 [[ICMP]], i32 [[SUM_02]], i32 [[EXT]]
; CHECK-NEXT:    [[IV_NEXT]] = add i32 [[IV]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[IV_NEXT]], 256
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
; CHECK:       for.end:
; CHECK-NEXT:    [[MIN_LCSSA:%.*]] = phi i32 [ [[MIN]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[RET:%.*]] = trunc i32 [[MIN_LCSSA]] to i8
...
; CHECK-NEXT:    [[ICMP:%.*]] = icmp ult i32 [[SUM_02]], [[EXT]]
; CHECK-NEXT:    [[MIN]] = select i1 [[ICMP]], i32 [[SUM_02]], i32 [[EXT]]
; CHECK-NEXT:    [[IV_NEXT]] = add i32 [[IV]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[IV_NEXT]], 256
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
...
; CHECK-NEXT:    [[ICMP:%.*]] = icmp sgt i32 [[SUM_02]], [[EXT]]
; CHECK-NEXT:    [[MIN]] = select i1 [[ICMP]], i32 [[SUM_02]], i32 [[EXT]]
; CHECK-NEXT:    [[IV_NEXT]] = add i32 [[IV]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[IV_NEXT]], 256
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
; CHECK:       for.end:
; CHECK-NEXT:    [[MIN_LCSSA:%.*]] = phi i32 [ [[MIN]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[RET:%.*]] = trunc i32 [[MIN_LCSSA]] to i16
...
; CHECK-NEXT:    [[ICMP:%.*]] = icmp ugt i32 [[SUM_02]], [[EXT]]
; CHECK-NEXT:    [[MIN]] = select i1 [[ICMP]], i32 [[SUM_02]], i32 [[EXT]]
; CHECK-NEXT:    [[IV_NEXT]] = add i32 [[IV]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[IV_NEXT]], 256
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
...
; CHECK-NEXT:    [[T:%.*]] = trunc i32 [[B:%.*]] to i16
; CHECK-NEXT:    [[EXT:%.*]] = sext i16 [[T]] to i32
; CHECK-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[EXT]], [[EXT1]]
; CHECK-NEXT:    [[EXT2:%.*]] = zext i1 [[CMP]] to i32
; CHECK-NEXT:    [[CMP3:%.*]] = icmp sge i32 [[IV]], [[EXT2]]
; CHECK-NEXT:    [[EXT4:%.*]] = zext i1 [[CMP3]] to i32
; CHECK-NEXT:    [[DIV:%.*]] = sdiv i32 [[EXT4]], [[B]]
; CHECK-NEXT:    [[AND:%.*]] = and i32 [[DIV]], 0
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i32 [[IV]]
; CHECK-NEXT:    [[L:%.*]] = load i32, ptr [[GEP]], align 4
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[AND]], [[L]]
; CHECK-NEXT:    [[OR]] = or i32 [[OR67]], [[ADD]]
...
; CHECK:       exit:
; CHECK-NEXT:    [[OR_LCSSA:%.*]] = phi i32 [ [[OR]], [[LOOP]] ]
