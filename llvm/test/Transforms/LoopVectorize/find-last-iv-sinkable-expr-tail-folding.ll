...
; RUN: opt -passes=loop-vectorize -force-vector-interleave=1 -force-vector-width=4 -prefer-tail-folding=fold-tail-else-epilogue -force-target-supports-masked-memory-ops -S < %s | FileCheck %s
