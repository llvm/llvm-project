...
; CHECK: Cost of 18 for VF 2: INTERLEAVE-GROUP with factor 4 at %10
; CHECK: Cost for VF 2: 62 (Estimated cost per lane: 31.0)
; CHECK: Cost of 18 for VF 4: INTERLEAVE-GROUP with factor 4 at %10
; CHECK: Cost for VF 4: 62 (Estimated cost per lane: 15.5)
; CHECK: Cost of 68 for VF 8: INTERLEAVE-GROUP with factor 4 at %10
...
; CHECK: Cost of 42 for VF 4: INTERLEAVE-GROUP with factor 5 at %10
; CHECK: Cost for VF 4: 135 (Estimated cost per lane: 33.8)
; CHECK: Cost of 84 for VF 8: INTERLEAVE-GROUP with factor 5 at %10
; CHECK: Cost for VF 8: 261 (Estimated cost per lane: 32.6)
; CHECK: Cost of 168 for VF 16: INTERLEAVE-GROUP with factor 5 at %10
...
; CHECK: Cost of 11 for VF 4: INTERLEAVE-GROUP with factor 2 at %10
; CHECK: Cost for VF 4: 61 (Estimated cost per lane: 15.2)
; CHECK: Cost of 7 for VF 8: INTERLEAVE-GROUP with factor 2 at %10
; CHECK: Cost for VF 8: 33 (Estimated cost per lane: 4.1)
; CHECK: Cost of 6 for VF 16: INTERLEAVE-GROUP with factor 2 at %10
...
; CHECK: Cost of 18 for VF 4: INTERLEAVE-GROUP with factor 4 at %10
; CHECK: Cost for VF 4: 62 (Estimated cost per lane: 15.5)
; CHECK: Cost of 26 for VF 8: INTERLEAVE-GROUP with factor 4 at %10
; CHECK: Cost for VF 8: 86 (Estimated cost per lane: 10.8)
; CHECK: Cost of 132 for VF 16: INTERLEAVE-GROUP with factor 4 at %10
...
; CHECK: Cost of 34 for VF 2: INTERLEAVE-GROUP with factor 8 at %10
; CHECK: Cost for VF 2: 154 (Estimated cost per lane: 77.0)
; CHECK: Cost of 66 for VF 4: INTERLEAVE-GROUP with factor 8 at %10
; CHECK: Cost for VF 4: 298 (Estimated cost per lane: 74.5)
; CHECK: Cost of 132 for VF 8: INTERLEAVE-GROUP with factor 8 at %10
; CHECK: Cost for VF 8: 432 (Estimated cost per lane: 54.0)
; CHECK: Cost of 264 for VF 16: INTERLEAVE-GROUP with factor 8 at %10
...
; CHECK: Cost of 14 for VF 2: INTERLEAVE-GROUP with factor 4 at %17
...
; CHECK: Cost of 14 for VF 2: INTERLEAVE-GROUP with factor 4 at <badref>
...
; CHECK: Cost of 18 for VF 4: INTERLEAVE-GROUP with factor 4 at %11
; CHECK: Cost of 11 for VF 4: INTERLEAVE-GROUP with factor 2 at <badref>
; CHECK: Cost for VF 4: 35 (Estimated cost per lane: 8.8)
; CHECK: Cost of 26 for VF 8: INTERLEAVE-GROUP with factor 4 at %11
; CHECK: Cost of 7 for VF 8: INTERLEAVE-GROUP with factor 2 at <badref>
; CHECK: Cost for VF 8: 39 (Estimated cost per lane: 4.9)
; CHECK: Cost of 68 for VF 16: INTERLEAVE-GROUP with factor 4 at %11
; CHECK: Cost of 6 for VF 16: INTERLEAVE-GROUP with factor 2 at <badref>
...
; CHECK: Cost of 10 for VF 2: INTERLEAVE-GROUP with factor 2 at %0
; CHECK: Cost for VF 2: 38 (Estimated cost per lane: 19.0)
; CHECK: Cost of 18 for VF 4: INTERLEAVE-GROUP with factor 2 at %0
; CHECK: Cost for VF 4: 62 (Estimated cost per lane: 15.5)
; CHECK: LV: Selecting VF: 1.
...
; CHECK: Cost of 10 for VF 2: INTERLEAVE-GROUP with factor 2 at <badref>
; CHECK: Cost for VF 2: 54 (Estimated cost per lane: 27.0)
; CHECK: Cost of 11 for VF 4: INTERLEAVE-GROUP with factor 2 at %0
...
; CHECK: LV: Scalar loop costs: 18.
; CHECK: Cost of 11 for VF 2: INTERLEAVE-GROUP with factor 2 at %0
; CHECK: Cost of 11 for VF 2: INTERLEAVE-GROUP with factor 2 at %1
; CHECK: Cost for VF 2: 48 (Estimated cost per lane: 24.0)
; CHECK: Cost of 7 for VF 4: INTERLEAVE-GROUP with factor 2 at %0
...
; CHECK: LV: Scalar loop costs: 24.
; CHECK: Cost of 18 for VF 2: INTERLEAVE-GROUP with factor 4 at %0
...
; CHECK: Cost of 18 for VF 2: INTERLEAVE-GROUP with factor 4 at %0
; CHECK: Cost for VF 2: 66 (Estimated cost per lane: 33.0)
; CHECK: Cost of 36 for VF 4: INTERLEAVE-GROUP with factor 4 at %0
...
; CHECK: Cost of 6 for VF 2: REPLICATE ir<%1> = load ir<%arrayidx1> (!alias.scope {{.*}})
; CHECK: Cost of 6 for VF 2: REPLICATE ir<%2> = load ir<%y> (!alias.scope {{.*}})
; CHECK: Cost of 18 for VF 2: INTERLEAVE-GROUP with factor 4 at <badref>
; CHECK: Cost for VF 2: 102 (Estimated cost per lane: 51.0)
; CHECK: Cost of 18 for VF 4: INTERLEAVE-GROUP with factor 4 at %0
