...
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 16 x i1> poison, i1 [[C1]], i64 0
...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 16 x i1> poison, i1 [[C0]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <vscale x 16 x i1> [[BROADCAST_SPLATINSERT1]], <vscale x 16 x i1> poison, <vscale x 16 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP0:%.*]] = select <vscale x 16 x i1> [[BROADCAST_SPLAT2]], <vscale x 16 x i1> [[BROADCAST_SPLAT]], <vscale x 16 x i1> zeroinitializer
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x i32> @llvm.vp.load.nxv16i32.p0(ptr align 4 [[GEP2]], <vscale x 16 x i1> [[TMP0]], i32 [[TMP1]])
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr i32, ptr [[P1]], <vscale x 16 x i32> [[VP_OP_LOAD]]
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv16i32.nxv16p0(<vscale x 16 x i32> zeroinitializer, <vscale x 16 x ptr> align 4 [[WIDE_GEP]], <vscale x 16 x i1> [[TMP0]], i32 [[TMP1]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x i32> @llvm.vp.load.nxv16i32.p0(ptr align 4 [[TMP2]], <vscale x 16 x i1> [[TMP0]], i32 [[TMP1]])
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr i32, ptr [[P1]], <vscale x 16 x i32> [[VP_OP_LOAD]]
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv16i32.nxv16p0(<vscale x 16 x i32> zeroinitializer, <vscale x 16 x ptr> align 4 [[WIDE_GEP]], <vscale x 16 x i1> [[TMP0]], i32 [[TMP1]])
