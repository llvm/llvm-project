...
; CHECK:       [[THEN_1]]:
; CHECK-NEXT:    [[GEP2:%.*]] = phi ptr [ [[P0]], %[[LOOP]] ], [ [[TMP5:%.*]], %[[THEN_1]] ]
...
; CHECK-NEXT:    [[TMP5]] = getelementptr i8, ptr [[GEP2]], i64 [[TMP7]]
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP2:%.*]] = phi ptr [ [[P0]], %[[VECTOR_PH]] ], [ [[TMP5:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP6:%.*]] = zext i32 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP6]], 2
; CHECK-NEXT:    [[TMP5]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP4:%.*]] = icmp eq i32 [[AVL_NEXT]], 0
