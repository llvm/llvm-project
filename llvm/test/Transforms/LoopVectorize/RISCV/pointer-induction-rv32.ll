...
; CHECK-NEXT:    [[VECTOR_GEP:%.*]] = getelementptr i8, ptr [[POINTER_PHI]], <vscale x 16 x i32> [[TMP0]]
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.experimental.get.vector.length.i32(i32 [[AVL]], i32 16, i1 true)
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv16p0.nxv16p0(<vscale x 16 x ptr> [[VECTOR_GEP]], <vscale x 16 x ptr> align 4 [[BROADCAST_SPLAT]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP1]])
