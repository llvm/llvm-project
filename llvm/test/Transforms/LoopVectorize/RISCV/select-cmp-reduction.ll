...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 16 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP3:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP2:%.*]] = icmp sge <vscale x 16 x i32> [[VP_OP_LOAD]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP3]] = call <vscale x 16 x i1> @llvm.vp.merge.nxv16i1(<vscale x 16 x i1> [[TMP2]], <vscale x 16 x i1> splat (i1 true), <vscale x 16 x i1> [[VEC_PHI]], i32 [[TMP14]])
...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP10:%.*]] = call i1 @llvm.vector.reduce.or.nxv16i1(<vscale x 16 x i1> [[TMP3]])
...
; CHECK-NEXT:    br label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 16 x float> poison, float [[X]], i64 0
...
; CHECK-NEXT:    [[TMP2:%.*]] = fcmp fast uge <vscale x 16 x float> [[VP_OP_LOAD]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP3]] = call <vscale x 16 x i1> @llvm.vp.merge.nxv16i1(<vscale x 16 x i1> [[TMP2]], <vscale x 16 x i1> splat (i1 true), <vscale x 16 x i1> [[VEC_PHI]], i32 [[TMP14]])
; CHECK-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP14]] to i64
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP9]], [[INDEX]]
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP9]]
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 16 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP3:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP21:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 16, i1 true)
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[V]], i64 [[INDEX]]
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x i32> @llvm.vp.load.nxv16i32.p0(ptr align 4 [[TMP6]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP21]])
; CHECK-NEXT:    [[TMP2:%.*]] = icmp ne <vscale x 16 x i32> [[VP_OP_LOAD]], splat (i32 3)
; CHECK-NEXT:    [[TMP3]] = call <vscale x 16 x i1> @llvm.vp.merge.nxv16i1(<vscale x 16 x i1> [[TMP2]], <vscale x 16 x i1> splat (i1 true), <vscale x 16 x i1> [[VEC_PHI]], i32 [[TMP21]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x float> @llvm.vp.load.nxv16f32.p0(ptr align 4 [[TMP6]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP21]])
; CHECK-NEXT:    [[TMP2:%.*]] = fcmp fast one <vscale x 16 x float> [[VP_OP_LOAD]], splat (float 3.000000e+00)
; CHECK-NEXT:    [[TMP3]] = call <vscale x 16 x i1> @llvm.vp.merge.nxv16i1(<vscale x 16 x i1> [[TMP2]], <vscale x 16 x i1> splat (i1 true), <vscale x 16 x i1> [[VEC_PHI]], i32 [[TMP21]])
; CHECK-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP21]] to i64
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP9]], [[INDEX]]
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP9]]
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 8 x float> [ splat (float 3.000000e+00), %[[VECTOR_PH]] ], [ [[TMP8:%.*]], %[[FOR_BODY]] ]
; CHECK-NEXT:    [[TMP9:%.*]] = phi <vscale x 8 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP7:%.*]], %[[FOR_BODY]] ]
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i32> @llvm.vp.load.nxv8i32.p0(ptr align 4 [[TMP2]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP1]])
; CHECK-NEXT:    [[TMP3:%.*]] = icmp ne <vscale x 8 x i32> [[VP_OP_LOAD]], splat (i32 3)
...
; CHECK-NEXT:    [[TMP7]] = select i1 [[TMP6]], <vscale x 8 x i1> [[TMP4]], <vscale x 8 x i1> [[TMP9]]
; CHECK-NEXT:    [[TMP8]] = select i1 [[TMP6]], <vscale x 8 x float> splat (float 7.000000e+00), <vscale x 8 x float> [[VEC_PHI]]
...
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[DOTLCSSA:%.*]] = call float @llvm.experimental.vector.extract.last.active.nxv8f32(<vscale x 8 x float> [[TMP8]], <vscale x 8 x i1> [[TMP7]], float 3.000000e+00)
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_EVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 16 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP7:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP17:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 16, i1 true)
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[SRC1]], i64 [[INDEX]]
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x i32> @llvm.vp.load.nxv16i32.p0(ptr align 4 [[TMP6]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP17]])
; CHECK-NEXT:    [[TMP2:%.*]] = icmp sgt <vscale x 16 x i32> [[VP_OP_LOAD]], splat (i32 35)
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i32, ptr [[SRC2]], i64 [[INDEX]]
; CHECK-NEXT:    [[VP_OP_LOAD1:%.*]] = call <vscale x 16 x i32> @llvm.vp.load.nxv16i32.p0(ptr align 4 [[TMP8]], <vscale x 16 x i1> [[TMP2]], i32 [[TMP17]])
; CHECK-NEXT:    [[TMP4:%.*]] = icmp eq <vscale x 16 x i32> [[VP_OP_LOAD1]], splat (i32 2)
; CHECK-NEXT:    [[TMP5:%.*]] = or <vscale x 16 x i1> [[VEC_PHI]], [[TMP4]]
; CHECK-NEXT:    [[TMP7]] = call <vscale x 16 x i1> @llvm.vp.merge.nxv16i1(<vscale x 16 x i1> [[TMP2]], <vscale x 16 x i1> [[TMP5]], <vscale x 16 x i1> [[VEC_PHI]], i32 [[TMP17]])
...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP12:%.*]] = call i1 @llvm.vector.reduce.or.nxv16i1(<vscale x 16 x i1> [[TMP7]])
