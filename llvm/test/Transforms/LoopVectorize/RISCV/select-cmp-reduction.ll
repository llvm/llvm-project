...
; CHECK-NEXT:    [[TMP6:%.*]] = phi ptr [ [[C]], %[[VECTOR_PH]] ], [ [[TMP12:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP9]], 2
; CHECK-NEXT:    [[TMP12]] = getelementptr i8, ptr [[TMP6]], i64 [[TMP5]]
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP8:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP6:%.*]] = phi ptr [ [[V]], %[[VECTOR_PH]] ], [ [[TMP12:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP2:%.*]] = phi ptr [ [[V]], %[[VECTOR_PH]] ], [ [[TMP13:%.*]], %[[FOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP13]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP14]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = phi ptr [ [[SRC1]], %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[SRC2]], %[[VECTOR_PH]] ], [ [[TMP10:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP14:%.*]] = shl i64 [[TMP21]], 2
; CHECK-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP6]], i64 [[TMP14]]
; CHECK-NEXT:    [[TMP10]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP14]]
