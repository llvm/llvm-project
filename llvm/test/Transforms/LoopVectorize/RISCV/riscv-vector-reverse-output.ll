...
; RV64-UF2-NEXT:    [[TMP61:%.*]] = insertelement <4 x i7> [[TMP60]], i7 [[TMP6]], i32 1
; RV64-UF2-NEXT:    [[TMP62:%.*]] = insertelement <4 x i7> [[TMP61]], i7 [[TMP26]], i32 2
; RV64-UF2-NEXT:    [[TMP31:%.*]] = insertelement <4 x i7> [[TMP62]], i7 [[TMP27]], i32 3
...
; RV64-UF2-NEXT:    [[TMP63:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP1]]
; RV64-UF2-NEXT:    [[TMP64:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP2]]
; RV64-UF2-NEXT:    [[TMP65:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP51]]
; RV64-UF2-NEXT:    [[TMP66:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP11]]
; RV64-UF2-NEXT:    [[TMP67:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP59]]
; RV64-UF2-NEXT:    [[TMP68:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP13]]
; RV64-UF2-NEXT:    [[TMP69:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP14]]
; RV64-UF2-NEXT:    [[TMP49:%.*]] = getelementptr inbounds i7, ptr [[A]], i64 [[TMP15]]
; RV64-UF2-NEXT:    store i7 [[TMP7]], ptr [[TMP63]], align 1
...
; RV64-UF2-NEXT:    store i7 [[TMP54]], ptr [[TMP67]], align 1
; RV64-UF2-NEXT:    store i7 [[TMP55]], ptr [[TMP68]], align 1
