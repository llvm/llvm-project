...
;.
; RV32: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; RV32: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; RV32: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
; RV32: [[LOOP3]] = distinct !{[[LOOP3]], [[META2]], [[META1]]}
; RV32: [[LOOP4]] = distinct !{[[LOOP4]], [[META1]], [[META2]]}
; RV32: [[LOOP5]] = distinct !{[[LOOP5]], [[META2]], [[META1]]}
;.
; RV64-UF2: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; RV64-UF2: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; RV64-UF2: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
; RV64-UF2: [[LOOP3]] = distinct !{[[LOOP3]], [[META2]], [[META1]]}
; RV64-UF2: [[LOOP4]] = distinct !{[[LOOP4]], [[META1]], [[META2]]}
; RV64-UF2: [[LOOP5]] = distinct !{[[LOOP5]], [[META2]], [[META1]]}
;.
