...
; RV64-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP0]] to i64
...
; RV64-NEXT:    [[TMP12:%.*]] = getelementptr i32, ptr [[TMP7]], i64 [[TMP11]]
; RV64-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP12]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> [[VP_OP_LOAD]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
...
; RV64-NEXT:    [[TMP18:%.*]] = getelementptr i32, ptr [[TMP15]], i64 [[TMP16]]
; RV64-NEXT:    [[TMP19:%.*]] = getelementptr i32, ptr [[TMP18]], i64 [[TMP17]]
; RV64-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> [[TMP14]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> [[VP_REVERSE1]], ptr align 4 [[TMP19]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP5]], [[INDEX]]
; RV64-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP5]]
; RV64-NEXT:    [[TMP20:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1023
...
; RV32-NEXT:    [[TMP6:%.*]] = getelementptr i32, ptr [[TMP9]], i32 [[TMP11]]
; RV32-NEXT:    [[TMP7:%.*]] = getelementptr i32, ptr [[TMP6]], i32 [[TMP12]]
; RV32-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP7]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> [[VP_OP_LOAD]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
...
; RV32-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x i32> @llvm.experimental.vp.reverse.nxv4i32(<vscale x 4 x i32> [[TMP15]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    call void @llvm.vp.store.nxv4i32.p0(<vscale x 4 x i32> [[VP_REVERSE1]], ptr align 4 [[TMP14]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    [[TMP17:%.*]] = zext i32 [[TMP10]] to i64
; RV32-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP17]], [[INDEX]]
; RV32-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP17]]
...
; RV64-UF2-NEXT:    [[TMP8:%.*]] = sub i64 1023, [[TMP7]]
...
; RV64-UF2-NEXT:    [[TMP36:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[TMP7]]
; RV64-UF2-NEXT:    br i1 [[TMP36]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; RV64-UF2:       [[MIDDLE_BLOCK]]:
; RV64-UF2-NEXT:    [[CMP_N:%.*]] = icmp eq i64 1023, [[TMP7]]
; RV64-UF2-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH]]
; RV64-UF2:       [[SCALAR_PH]]:
; RV64-UF2-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[TMP8]], %[[MIDDLE_BLOCK]] ], [ 1023, %[[ENTRY]] ]
...
; RV64-NEXT:    [[TMP12:%.*]] = getelementptr float, ptr [[TMP7]], i64 [[TMP11]]
; RV64-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 [[TMP12]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> [[VP_OP_LOAD]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
...
; RV64-NEXT:    [[TMP23:%.*]] = sub i64 [[TMP5]], 1
; RV64-NEXT:    [[TMP17:%.*]] = mul i64 -1, [[TMP23]]
; RV64-NEXT:    [[TMP18:%.*]] = getelementptr float, ptr [[TMP15]], i64 [[TMP16]]
; RV64-NEXT:    [[TMP19:%.*]] = getelementptr float, ptr [[TMP18]], i64 [[TMP17]]
; RV64-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> [[TMP14]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> [[VP_REVERSE1]], ptr align 4 [[TMP19]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP0]])
; RV64-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP5]], [[INDEX]]
; RV64-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP5]]
; RV64-NEXT:    [[TMP20:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1023
; RV64-NEXT:    br i1 [[TMP20]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; RV64:       [[MIDDLE_BLOCK]]:
; RV64-NEXT:    br label %[[EXIT:.*]]
; RV64:       [[SCALAR_PH]]:
; RV64-NEXT:    br label %[[FOR_BODY:.*]]
...
; RV32-NEXT:    [[TMP24:%.*]] = sub i32 [[TMP10]], 1
; RV32-NEXT:    [[TMP12:%.*]] = mul i32 -1, [[TMP24]]
; RV32-NEXT:    [[TMP6:%.*]] = getelementptr float, ptr [[TMP9]], i32 [[TMP11]]
; RV32-NEXT:    [[TMP7:%.*]] = getelementptr float, ptr [[TMP6]], i32 [[TMP12]]
; RV32-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x float> @llvm.vp.load.nxv4f32.p0(ptr align 4 [[TMP7]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> [[VP_OP_LOAD]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
...
; RV32-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x float> @llvm.experimental.vp.reverse.nxv4f32(<vscale x 4 x float> [[TMP15]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    call void @llvm.vp.store.nxv4f32.p0(<vscale x 4 x float> [[VP_REVERSE1]], ptr align 4 [[TMP14]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP10]])
; RV32-NEXT:    [[TMP17:%.*]] = zext i32 [[TMP10]] to i64
; RV32-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP17]], [[INDEX]]
; RV32-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP17]]
; RV32-NEXT:    [[TMP20:%.*]] = icmp eq i64 [[INDEX_EVL_NEXT]], 1023
...
; RV64-UF2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP6]]
; RV64-UF2-NEXT:    [[TMP36:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[TMP7]]
; RV64-UF2-NEXT:    br i1 [[TMP36]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; RV64-UF2:       [[MIDDLE_BLOCK]]:
; RV64-UF2-NEXT:    [[CMP_N:%.*]] = icmp eq i64 1023, [[TMP7]]
; RV64-UF2-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH]]
; RV64-UF2:       [[SCALAR_PH]]:
...
; RV64-NEXT:    br i1 [[TMP29]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; RV64:       [[MIDDLE_BLOCK]]:
...
; RV64-NEXT:    br i1 [[CMP]], label %[[FOR_BODY]], label %[[EXIT:.*]], !llvm.loop [[LOOP8:![0-9]+]]
; RV64:       [[EXIT]]:
; RV64-NEXT:    ret void
;
...
; RV32-NEXT:    br i1 [[TMP29]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; RV32:       [[MIDDLE_BLOCK]]:
...
; RV32-NEXT:    br i1 [[CMP]], label %[[FOR_BODY]], label %[[EXIT:.*]], !llvm.loop [[LOOP8:![0-9]+]]
; RV32:       [[EXIT]]:
; RV32-NEXT:    ret void
;
