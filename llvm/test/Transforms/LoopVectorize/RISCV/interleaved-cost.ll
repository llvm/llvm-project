...
; REQUIRES: asserts
; DEFINE: %{no-optimized-segment-load-store} = -optimized-nf2-segment-load-store,-optimized-nf3-segment-load-store,-optimized-nf4-segment-load-store,-optimized-nf5-segment-load-store,-optimized-nf6-segment-load-store,-optimized-nf7-segment-load-store,-optimized-nf8-segment-load-store
; DEFINE: %{optimized-segment-load-store} = +optimized-nf2-segment-load-store,+optimized-nf3-segment-load-store,+optimized-nf4-segment-load-store,+optimized-nf5-segment-load-store,+optimized-nf6-segment-load-store,+optimized-nf7-segment-load-store,+optimized-nf8-segment-load-store
; RUN: opt -passes=loop-vectorize -mtriple=riscv64 -mattr=+v,%{no-optimized-segment-load-store} -debug-only=loop-vectorize -disable-output < %s 2>&1 | FileCheck %s --check-prefix=NO-OPT
; RUN: opt -passes=loop-vectorize -mtriple=riscv64 -mattr=+v,%{optimized-segment-load-store} -debug-only=loop-vectorize -disable-output < %s 2>&1 | FileCheck %s --check-prefix=OPT
; RUN: opt -passes=loop-vectorize -mtriple=riscv64 -mattr=+v,%{no-optimized-segment-load-store} -scalable-vectorization=off -debug-only=loop-vectorize -disable-output < %s 2>&1 | FileCheck %s --check-prefix=FIXED-NO-OPT
; RUN: opt -passes=loop-vectorize -mtriple=riscv64 -mattr=+v,%{optimized-segment-load-store} -scalable-vectorization=off -debug-only=loop-vectorize -disable-output < %s 2>&1 | FileCheck %s --check-prefix=FIXED-OPT
