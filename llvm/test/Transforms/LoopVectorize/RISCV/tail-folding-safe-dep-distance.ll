...
; IF-EVL-LABEL: @test(
; IF-EVL-NEXT:  entry:
; IF-EVL-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[P:%.*]], i64 1600
; IF-EVL-NEXT:    br label [[VECTOR_PH:%.*]]
; IF-EVL:       vector.ph:
; IF-EVL-NEXT:    br label [[VECTOR_BODY:%.*]]
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP8:%.*]] = phi ptr [ [[P]], [[VECTOR_PH]] ], [ [[TMP9:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP11:%.*]] = phi ptr [ [[TMP0]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP10:%.*]] = shl i64 [[TMP13]], 3
; IF-EVL-NEXT:    [[TMP9]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP10]]
; IF-EVL-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP10]]
...
; IF-EVL-NEXT:  entry:
; IF-EVL-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[P:%.*]], i64 65536
; IF-EVL-NEXT:    br label [[VECTOR_PH:%.*]]
; IF-EVL:       vector.ph:
; IF-EVL-NEXT:    br label [[VECTOR_BODY:%.*]]
; IF-EVL:       vector.body:
...
; IF-EVL-NEXT:  entry:
; IF-EVL-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[P:%.*]], i64 8192
; IF-EVL-NEXT:    br label [[VECTOR_PH:%.*]]
; IF-EVL:       vector.ph:
; IF-EVL-NEXT:    br label [[VECTOR_BODY:%.*]]
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP2:%.*]] = phi ptr [ [[P]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP5:%.*]] = phi ptr [ [[TMP0]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP11]], 3
; IF-EVL-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP5]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
