...
; ZVFHMIN:       [[VECTOR_BODY]]:
; ZVFHMIN-NEXT:    [[TMP1:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP8:%.*]], %[[VECTOR_BODY]] ]
; ZVFHMIN-NEXT:    [[TMP2:%.*]] = phi ptr [ [[B]], %[[VECTOR_PH]] ], [ [[TMP9:%.*]], %[[VECTOR_BODY]] ]
...
; ZVFHMIN-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP13]], 1
; ZVFHMIN-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP1]], i64 [[TMP5]]
; ZVFHMIN-NEXT:    [[TMP9]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP5]]
