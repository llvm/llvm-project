...
; ZVFHMIN-NEXT:    [[TMP6:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 32, i1 true)
; ZVFHMIN-NEXT:    [[TMP1:%.*]] = getelementptr half, ptr [[A]], i64 [[INDEX]]
; ZVFHMIN-NEXT:    [[TMP2:%.*]] = getelementptr half, ptr [[B]], i64 [[INDEX]]
; ZVFHMIN-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 32 x half> @llvm.vp.load.nxv32f16.p0(ptr align 2 [[TMP1]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP6]])
; ZVFHMIN-NEXT:    [[VP_OP_LOAD1:%.*]] = call <vscale x 32 x half> @llvm.vp.load.nxv32f16.p0(ptr align 2 [[TMP2]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP6]])
; ZVFHMIN-NEXT:    [[TMP3:%.*]] = fadd <vscale x 32 x half> [[VP_OP_LOAD]], [[VP_OP_LOAD1]]
; ZVFHMIN-NEXT:    call void @llvm.vp.store.nxv32f16.p0(<vscale x 32 x half> [[TMP3]], ptr align 2 [[TMP1]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP6]])
