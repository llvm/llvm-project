...
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP15:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP19:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP21]], 2
; IF-EVL-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP15]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP19]], i64 [[TMP6]]
