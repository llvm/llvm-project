...
; CHECK:       vector.body:
; CHECK-NEXT:    [[TMP11:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP5:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP5]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP4]]
...
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP4:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[TMP12]], 3
; CHECK-NEXT:    [[TMP4]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP9:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
...
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP7:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
...
; CHECK-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP15]], 3
; CHECK-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP5]]
...
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[TMP0:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP4:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[BROADCAST_SPLAT]], ptr align 8 [[TMP0]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP9]])
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP7]]
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[TMP7]], 3
; CHECK-NEXT:    [[TMP4]] = getelementptr i8, ptr [[TMP0]], i64 [[TMP3]]
...
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP4:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP7:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
...
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[TMP9]], 3
; CHECK-NEXT:    [[TMP4]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP3]]
...
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = phi ptr [ [[A:%.*]], [[ENTRY]] ], [ [[TMP7:%.*]], [[FOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP5]], 3
; CHECK-NEXT:    [[TMP7]] = getelementptr i8, ptr [[ARRAYIDX]], i64 [[TMP4]]
