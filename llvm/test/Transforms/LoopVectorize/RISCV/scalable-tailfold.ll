...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i64> @llvm.vp.load.nxv8i64.p0(ptr align 8 [[TMP11]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP10]])
; CHECK-NEXT:    [[TMP2:%.*]] = add <vscale x 8 x i64> [[VP_OP_LOAD]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> [[TMP2]], ptr align 8 [[TMP11]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP10]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i64> @llvm.vp.load.nxv8i64.p0(ptr align 8 [[TMP8]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP7]])
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr inbounds i64, ptr [[A:%.*]], <vscale x 8 x i64> [[VP_OP_LOAD]]
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i64.nxv8p0(<vscale x 8 x i64> [[BROADCAST_SPLAT]], <vscale x 8 x ptr> align 8 [[WIDE_GEP]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP7]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i64> @llvm.vp.load.nxv8i64.p0(ptr align 8 [[TMP8]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP7]])
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr inbounds i64, ptr [[A:%.*]], <vscale x 8 x i64> [[VP_OP_LOAD]]
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 8 x i64> @llvm.vp.gather.nxv8i64.nxv8p0(<vscale x 8 x ptr> align 8 [[WIDE_GEP]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP7]])
; CHECK-NEXT:    [[TMP2:%.*]] = add <vscale x 8 x i64> [[VEC_PHI]], [[WIDE_MASKED_GATHER]]
; CHECK-NEXT:    [[TMP3]] = call <vscale x 8 x i64> @llvm.vp.merge.nxv8i64(<vscale x 8 x i1> splat (i1 true), <vscale x 8 x i64> [[TMP2]], <vscale x 8 x i64> [[VEC_PHI]], i32 [[TMP7]])
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP14:%.*]] = call i64 @llvm.vector.reduce.add.nxv8i64(<vscale x 8 x i64> [[TMP3]])
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.end:
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> [[BROADCAST_SPLAT]], ptr align 8 [[TMP10]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP9]])
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> [[BROADCAST_SPLAT]], ptr align 8 [[TMP8]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP7]])
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> [[BROADCAST_SPLAT]], ptr align 8 [[ARRAYIDX]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP0]])
