...
; CHECK-NEXT:    [[UMAX:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP2]], i64 18)
...
; CHECK-NEXT:    [[TMP9:%.*]] = or i1 [[TMP4]], [[MUL_OVERFLOW]]
...
; EPILOGUE-NEXT:    [[UMAX:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP2]], i64 20)
...
; EPILOGUE-NEXT:    [[TMP9:%.*]] = or i1 [[TMP4]], [[MUL_OVERFLOW]]
