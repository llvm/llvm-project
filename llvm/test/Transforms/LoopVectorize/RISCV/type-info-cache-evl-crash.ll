...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x i8> @llvm.vp.load.nxv16i8.p0(ptr align 1 [[TMP14]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP11]]), !alias.scope [[META0:![0-9]+]]
; CHECK-NEXT:    [[TMP23:%.*]] = zext <vscale x 16 x i8> [[VP_OP_LOAD]] to <vscale x 16 x i32>
; CHECK-NEXT:    [[TMP15:%.*]] = mul <vscale x 16 x i32> [[TMP23]], zeroinitializer
; CHECK-NEXT:    [[TMP16:%.*]] = ashr <vscale x 16 x i32> [[TMP23]], zeroinitializer
; CHECK-NEXT:    [[TMP17:%.*]] = or <vscale x 16 x i32> [[TMP16]], zeroinitializer
; CHECK-NEXT:    [[TMP18:%.*]] = icmp ult <vscale x 16 x i32> [[TMP23]], zeroinitializer
; CHECK-NEXT:    [[TMP19:%.*]] = call <vscale x 16 x i32> @llvm.vp.select.nxv16i32(<vscale x 16 x i1> [[TMP18]], <vscale x 16 x i32> [[TMP17]], <vscale x 16 x i32> zeroinitializer, i32 [[TMP11]])
; CHECK-NEXT:    [[TMP24:%.*]] = trunc <vscale x 16 x i32> [[TMP19]] to <vscale x 16 x i8>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv16i8.nxv16p0(<vscale x 16 x i8> [[TMP24]], <vscale x 16 x ptr> align 1 [[BROADCAST_SPLAT]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP11]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
; CHECK-NEXT:    [[TMP25:%.*]] = trunc <vscale x 16 x i32> [[TMP15]] to <vscale x 16 x i16>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv16i16.nxv16p0(<vscale x 16 x i16> [[TMP25]], <vscale x 16 x ptr> align 2 zeroinitializer, <vscale x 16 x i1> splat (i1 true), i32 [[TMP11]])
