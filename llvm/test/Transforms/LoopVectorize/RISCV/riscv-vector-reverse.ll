...
; RV64-NEXT:    [[TMP9:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.left.nxv4i32(<vscale x 4 x i32> poison, <vscale x 4 x i32> [[VP_OP_LOAD]], i32 [[TMP19]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP9]])
...
; RV64-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.right.nxv4i32(<vscale x 4 x i32> [[REVERSE1]], <vscale x 4 x i32> poison, i32 [[TMP19]])
...
; RV32-NEXT:    [[TMP10:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.left.nxv4i32(<vscale x 4 x i32> poison, <vscale x 4 x i32> [[VP_OP_LOAD]], i32 [[TMP9]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP10]])
...
; RV32-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.right.nxv4i32(<vscale x 4 x i32> [[REVERSE1]], <vscale x 4 x i32> poison, i32 [[TMP9]])
...
; RV64-UF2:       [[VECTOR_PH]]:
; RV64-UF2-NEXT:    [[TMP5:%.*]] = shl nuw i64 [[TMP0]], 2
...
; RV64-UF2-NEXT:    [[TMP15:%.*]] = sub i64 0, [[TMP10]]
; RV64-UF2-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i32, ptr [[TMP9]], i64 [[TMP15]]
; RV64-UF2-NEXT:    [[TMP11:%.*]] = sub i64 [[TMP15]], [[TMP5]]
...
; RV64-NEXT:    [[TMP24:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.left.nxv4i32(<vscale x 4 x i32> poison, <vscale x 4 x i32> [[VP_OP_LOAD]], i32 [[TMP20]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP24]])
; RV64-NEXT:    [[TMP29:%.*]] = add <vscale x 4 x i32> [[REVERSE]], splat (i32 1)
; RV64-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 [[TMP22]]
; RV64-NEXT:    [[REVERSE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP29]])
; RV64-NEXT:    [[TMP35:%.*]] = getelementptr i32, ptr [[TMP30]], i64 [[TMP18]]
; RV64-NEXT:    [[VP_REVERSE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.right.nxv4i32(<vscale x 4 x i32> [[REVERSE3]], <vscale x 4 x i32> poison, i32 [[TMP20]])
...
; RV32-NEXT:    [[TMP17:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.left.nxv4i32(<vscale x 4 x i32> poison, <vscale x 4 x i32> [[VP_OP_LOAD]], i32 [[TMP16]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP17]])
; RV32-NEXT:    [[TMP22:%.*]] = add <vscale x 4 x i32> [[REVERSE]], splat (i32 1)
; RV32-NEXT:    [[TMP23:%.*]] = getelementptr inbounds i32, ptr [[A]], i64 [[TMP14]]
; RV32-NEXT:    [[REVERSE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.reverse.nxv4i32(<vscale x 4 x i32> [[TMP22]])
; RV32-NEXT:    [[TMP25:%.*]] = getelementptr i32, ptr [[TMP23]], i32 [[TMP10]]
; RV32-NEXT:    [[VP_REVERSE3:%.*]] = call <vscale x 4 x i32> @llvm.vector.splice.right.nxv4i32(<vscale x 4 x i32> [[REVERSE3]], <vscale x 4 x i32> poison, i32 [[TMP16]])
...
; RV64-UF2:       [[VECTOR_PH]]:
; RV64-UF2-NEXT:    [[TMP18:%.*]] = shl nuw i64 [[TMP1]], 2
...
; RV64-UF2-NEXT:    [[TMP30:%.*]] = sub i64 0, [[TMP26]]
; RV64-UF2-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i32, ptr [[TMP24]], i64 [[TMP30]]
; RV64-UF2-NEXT:    [[TMP25:%.*]] = sub i64 [[TMP30]], [[TMP18]]
...
; RV64-NEXT:    [[TMP24:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.left.nxv4f32(<vscale x 4 x float> poison, <vscale x 4 x float> [[VP_OP_LOAD]], i32 [[TMP20]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP24]])
...
; RV64-NEXT:    [[REVERSE3:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP29]])
; RV64-NEXT:    [[TMP35:%.*]] = getelementptr float, ptr [[TMP30]], i64 [[TMP18]]
; RV64-NEXT:    [[VP_REVERSE3:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.right.nxv4f32(<vscale x 4 x float> [[REVERSE3]], <vscale x 4 x float> poison, i32 [[TMP20]])
...
; RV32-NEXT:    [[TMP17:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.left.nxv4f32(<vscale x 4 x float> poison, <vscale x 4 x float> [[VP_OP_LOAD]], i32 [[TMP16]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP17]])
...
; RV32-NEXT:    [[REVERSE3:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP22]])
; RV32-NEXT:    [[TMP25:%.*]] = getelementptr float, ptr [[TMP23]], i32 [[TMP10]]
; RV32-NEXT:    [[VP_REVERSE3:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.right.nxv4f32(<vscale x 4 x float> [[REVERSE3]], <vscale x 4 x float> poison, i32 [[TMP16]])
...
; RV64-NEXT:    [[TMP9:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.left.nxv4f32(<vscale x 4 x float> poison, <vscale x 4 x float> [[VP_OP_LOAD]], i32 [[TMP19]])
; RV64-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP9]])
...
; RV64-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.right.nxv4f32(<vscale x 4 x float> [[REVERSE1]], <vscale x 4 x float> poison, i32 [[TMP19]])
...
; RV32-NEXT:    [[TMP10:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.left.nxv4f32(<vscale x 4 x float> poison, <vscale x 4 x float> [[VP_OP_LOAD]], i32 [[TMP9]])
; RV32-NEXT:    [[REVERSE:%.*]] = call <vscale x 4 x float> @llvm.vector.reverse.nxv4f32(<vscale x 4 x float> [[TMP10]])
...
; RV32-NEXT:    [[VP_REVERSE1:%.*]] = call <vscale x 4 x float> @llvm.vector.splice.right.nxv4f32(<vscale x 4 x float> [[REVERSE1]], <vscale x 4 x float> poison, i32 [[TMP9]])
...
; RV64-NEXT:    [[TMP25:%.*]] = extractelement <4 x i7> [[TMP20]], i64 0
; RV64-NEXT:    [[TMP26:%.*]] = extractelement <4 x i7> [[TMP20]], i64 1
; RV64-NEXT:    [[TMP27:%.*]] = extractelement <4 x i7> [[TMP20]], i64 2
; RV64-NEXT:    [[TMP28:%.*]] = extractelement <4 x i7> [[TMP20]], i64 3
...
; RV32-NEXT:    [[TMP25:%.*]] = extractelement <4 x i7> [[TMP20]], i64 0
; RV32-NEXT:    [[TMP26:%.*]] = extractelement <4 x i7> [[TMP20]], i64 1
; RV32-NEXT:    [[TMP27:%.*]] = extractelement <4 x i7> [[TMP20]], i64 2
; RV32-NEXT:    [[TMP28:%.*]] = extractelement <4 x i7> [[TMP20]], i64 3
...
; RV64-UF2-NEXT:    [[TMP50:%.*]] = extractelement <4 x i7> [[TMP40]], i64 0
; RV64-UF2-NEXT:    [[TMP51:%.*]] = extractelement <4 x i7> [[TMP40]], i64 1
; RV64-UF2-NEXT:    [[TMP52:%.*]] = extractelement <4 x i7> [[TMP40]], i64 2
; RV64-UF2-NEXT:    [[TMP53:%.*]] = extractelement <4 x i7> [[TMP40]], i64 3
; RV64-UF2-NEXT:    [[TMP41:%.*]] = add <4 x i7> [[TMP39]], splat (i7 1)
; RV64-UF2-NEXT:    [[TMP54:%.*]] = extractelement <4 x i7> [[TMP41]], i64 0
; RV64-UF2-NEXT:    [[TMP55:%.*]] = extractelement <4 x i7> [[TMP41]], i64 1
; RV64-UF2-NEXT:    [[TMP56:%.*]] = extractelement <4 x i7> [[TMP41]], i64 2
; RV64-UF2-NEXT:    [[TMP57:%.*]] = extractelement <4 x i7> [[TMP41]], i64 3
