...
; RV64-NEXT:    [[TMP25:%.*]] = mul i64 0, [[TMP24]]
; RV64-NEXT:    [[TMP17:%.*]] = sub i64 [[TMP24]], 1
...
; RV64-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP24]], [[INDEX]]
; RV64-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP24]]
...
; RV64-NEXT:    [[TMP31:%.*]] = mul i64 0, [[TMP24]]
; RV64-NEXT:    [[TMP32:%.*]] = sub i64 [[TMP24]], 1
