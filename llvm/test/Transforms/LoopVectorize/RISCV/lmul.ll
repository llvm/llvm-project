...
; LMUL2:       vector.body:
; LMUL2-NEXT:    [[TMP5:%.*]] = phi ptr [ [[P:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; LMUL2-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP10]], 3
; LMUL2-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP5]], i64 [[TMP4]]
...
; LMUL4:       vector.body:
; LMUL4-NEXT:    [[TMP5:%.*]] = phi ptr [ [[P:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; LMUL4-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP10]], 3
; LMUL4-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP5]], i64 [[TMP4]]
...
; LMUL8:       vector.body:
; LMUL8-NEXT:    [[TMP5:%.*]] = phi ptr [ [[P:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; LMUL8-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP10]], 3
; LMUL8-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP5]], i64 [[TMP4]]
