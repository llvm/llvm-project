...
; CHECK-NEXT:    [[TMP11:%.*]] = freeze <4 x i1> [[TMP7]]
; CHECK-NEXT:    [[TMP5:%.*]] = freeze <4 x i1> [[TMP8]]
; CHECK-NEXT:    [[TMP6:%.*]] = or <4 x i1> [[TMP11]], [[TMP5]]
; CHECK-NEXT:    [[TMP12:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP6]])
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI1:%.*]] = phi <4 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI3:%.*]], %[[VECTOR_BODY]] ]
