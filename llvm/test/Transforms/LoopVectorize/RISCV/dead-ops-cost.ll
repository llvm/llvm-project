...
; CHECK-NEXT:    [[TMP16:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 32, i1 true)
; CHECK-NEXT:    [[TMP11:%.*]] = mul i64 [[INDEX]], 6
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP9]], i64 [[TMP11]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv32i16.p0.i64(<vscale x 32 x i16> zeroinitializer, ptr align 2 [[TMP12]], i64 6, <vscale x 32 x i1> splat (i1 true), i32 [[TMP16]])
...
; CHECK-NEXT:    [[TMP2:%.*]] = call i32 @llvm.experimental.get.vector.length.i32(i32 [[AVL]], i32 64, i1 true)
; CHECK-NEXT:    [[TMP5:%.*]] = zext i32 [[INDEX]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP5]], 2
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[TMP6]]
; CHECK-NEXT:    [[TMP4:%.*]] = call <vscale x 64 x i8> @llvm.experimental.vp.strided.load.nxv64i8.p0.i64(ptr align 1 [[TMP12]], i64 4, <vscale x 64 x i1> splat (i1 true), i32 [[TMP2]]), !alias.scope [[META3:![0-9]+]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[DST]], i64 [[TMP6]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv64i8.p0.i64(<vscale x 64 x i8> zeroinitializer, ptr align 1 [[TMP7]], i64 4, <vscale x 64 x i1> splat (i1 true), i32 [[TMP2]]), !alias.scope [[META6:![0-9]+]], !noalias [[META3]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <vscale x 64 x i8> [[TMP4]], i64 [[TMP11]]
; CHECK-NEXT:    br label %[[EXIT:.*]]
; CHECK:       [[SCALAR_PH]]:
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[R:%.*]] = phi i8 [ [[L]], %[[LOOP]] ], [ [[TMP9]], %[[MIDDLE_BLOCK]] ]
; CHECK-NEXT:    ret i8 [[R]]
;
entry:
  br label %loop
