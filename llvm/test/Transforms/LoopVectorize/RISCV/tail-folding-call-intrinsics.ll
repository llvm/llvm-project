...
; IF-EVL-NEXT:    [[TMP7:%.*]] = sub i64 [[TMP23]], 1
...
; IF-EVL-NEXT:    [[TMP10:%.*]] = sub i64 [[TMP25]], 1
; IF-EVL-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP8]], [[TMP10]]
...
; NO-VP-NEXT:    [[TMP2:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP11]], i64 24)
...
; NO-VP-NEXT:    [[TMP21:%.*]] = sub i64 [[TMP7]], 1
; NO-VP-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP20]], [[TMP21]]
...
; IF-EVL-NEXT:    [[TMP7:%.*]] = sub i64 [[TMP20]], 1
; IF-EVL-NEXT:    [[DIFF_CHECK:%.*]] = icmp ult i64 [[TMP6]], [[TMP7]]
...
; IF-EVL-NEXT:    [[TMP9:%.*]] = sub i64 [[TMP6]], 1
