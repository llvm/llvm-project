...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP2:%.*]] = phi ptr [ [[INPUT1]], %[[VECTOR_PH]] ], [ [[TMP18:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = phi ptr [ [[INPUT2]], %[[VECTOR_PH]] ], [ [[TMP19:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP7:%.*]] = phi ptr [ [[OUTPUT]], %[[VECTOR_PH]] ], [ [[TMP16:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP18]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP19]] = getelementptr i8, ptr [[TMP4]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP16]] = getelementptr i8, ptr [[TMP7]], i64 [[TMP21]]
...
; ZVFHMIN-NEXT:    br label %[[VECTOR_BODY:.*]]
; ZVFHMIN:       [[VECTOR_BODY]]:
; ZVFHMIN-NEXT:    [[TMP13:%.*]] = phi ptr [ [[INPUT1]], %[[VECTOR_PH]] ], [ [[TMP20:%.*]], %[[VECTOR_BODY]] ]
; ZVFHMIN-NEXT:    [[TMP15:%.*]] = phi ptr [ [[INPUT2]], %[[VECTOR_PH]] ], [ [[TMP21:%.*]], %[[VECTOR_BODY]] ]
; ZVFHMIN-NEXT:    [[TMP18:%.*]] = phi ptr [ [[OUTPUT]], %[[VECTOR_PH]] ], [ [[TMP22:%.*]], %[[VECTOR_BODY]] ]
...
; ZVFHMIN-NEXT:    [[TMP23:%.*]] = shl i64 [[TMP16]], 1
; ZVFHMIN-NEXT:    [[TMP20]] = getelementptr i8, ptr [[TMP13]], i64 [[TMP23]]
; ZVFHMIN-NEXT:    [[TMP21]] = getelementptr i8, ptr [[TMP15]], i64 [[TMP23]]
; ZVFHMIN-NEXT:    [[TMP22]] = getelementptr i8, ptr [[TMP18]], i64 [[TMP23]]
