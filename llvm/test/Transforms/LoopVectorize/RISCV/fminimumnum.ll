...
; CHECK-NEXT:    [[TMP14:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP13]], i64 22)
...
; CHECK-NEXT:    [[TMP19:%.*]] = sub i64 [[TMP1]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = sub i64 [[TMP7]], 1
; CHECK-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP19]], [[TMP11]]
...
; ZVFHMIN-NEXT:    [[TMP2:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP1]], i64 22)
...
; ZVFHMIN-NEXT:    [[TMP11:%.*]] = sub i64 [[TMP7]], 1
; ZVFHMIN-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP16]], [[TMP11]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = sub i64 [[TMP19]], 1
...
; ZVFHMIN-NEXT:    [[TMP9:%.*]] = sub i64 [[TMP7]], 1
; ZVFHMIN-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP12]], [[TMP9]]
; ZVFHMIN-NEXT:    [[CONFLICT_RDX:%.*]] = or i1 [[DIFF_CHECK]], [[DIFF_CHECK4]]
; ZVFHMIN-NEXT:    br i1 [[CONFLICT_RDX]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; ZVFHMIN:       [[VECTOR_PH]]:
; ZVFHMIN-NEXT:    br label %[[VECTOR_BODY:.*]]
