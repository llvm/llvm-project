...
; CHECK-NEXT:    [[TMP14:%.*]] = phi ptr [ [[A]], [[ENTRY]] ], [ [[TMP5:%.*]], [[FOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP12]], 3
; CHECK-NEXT:    [[TMP5]] = getelementptr i8, ptr [[TMP14]], i64 [[TMP4]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[A]], [[VECTOR_PH]] ], [ [[TMP11:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP9]], 3
