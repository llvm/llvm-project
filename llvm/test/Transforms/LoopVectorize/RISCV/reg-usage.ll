...
; CHECK-LMUL1-NEXT:  LV(REG): RegisterClass: RISCV::GPRRC, 9 registers
...
; CHECK-LMUL2-NEXT:  LV(REG): RegisterClass: RISCV::GPRRC, 9 registers
...
; CHECK-LMUL4-NEXT:  LV(REG): RegisterClass: RISCV::GPRRC, 9 registers
...
; CHECK-LMUL8-NEXT:  LV(REG): RegisterClass: RISCV::GPRRC, 9 registers
