...
; IF-EVL:       vector.body:
; IF-EVL-NEXT:    [[TMP14:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP16:%.*]] = phi ptr [ [[C:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP18:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP9:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP20]], 2
; IF-EVL-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP14]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP6]]
; IF-EVL-NEXT:    [[TMP9]] = getelementptr i8, ptr [[TMP18]], i64 [[TMP6]]
