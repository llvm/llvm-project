...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i64> @llvm.vp.load.nxv8i64.p0(ptr align 32 [[TMP7]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP8]])
; CHECK-NEXT:    [[TMP9:%.*]] = add i64 [[INDEX]], 200
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i64, ptr [[P]], i64 [[TMP9]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv8i64.p0(<vscale x 8 x i64> [[VP_OP_LOAD]], ptr align 32 [[TMP10]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP8]])
