...
; RV32-NEXT:    [[OFFSET_IDX:%.*]] = mul i64 [[INDEX]], 16
...
; RV32-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP20]], [[INDEX]]
...
; RV64-NEXT:    [[OFFSET_IDX:%.*]] = mul i64 [[INDEX]], 16
...
; RV64-NEXT:    [[INDEX_EVL_NEXT]] = add nuw i64 [[TMP20]], [[INDEX]]
