...
; CHECK-NEXT:    [[AVL:%.*]] = sub i64 9, [[INDEX]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[TMP5]], i32 0
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i8> @llvm.vp.load.nxv8i8.p0(ptr align 1 [[TMP6]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
; CHECK-NEXT:    [[TMP12:%.*]] = zext <vscale x 8 x i8> [[VP_OP_LOAD]] to <vscale x 8 x i16>
; CHECK-NEXT:    [[TMP7:%.*]] = mul <vscale x 8 x i16> zeroinitializer, [[TMP12]]
; CHECK-NEXT:    [[TMP8:%.*]] = lshr <vscale x 8 x i16> [[TMP7]], trunc (<vscale x 8 x i32> splat (i32 1) to <vscale x 8 x i16>)
; CHECK-NEXT:    [[TMP13:%.*]] = trunc <vscale x 8 x i16> [[TMP8]] to <vscale x 8 x i8>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i8.nxv8p0(<vscale x 8 x i8> [[TMP13]], <vscale x 8 x ptr> align 1 zeroinitializer, <vscale x 8 x i1> splat (i1 true), i32 [[TMP2]])
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP9]]
; CHECK-NEXT:    [[TMP10:%.*]] = icmp eq i64 [[INDEX_NEXT]], 9
