...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[GEP_SRC]], i32 0
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 8 x i8> @llvm.vp.load.nxv8i8.p0(ptr align 1 [[TMP8]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP5]])
; CHECK-NEXT:    [[TMP9:%.*]] = zext <vscale x 8 x i8> [[VP_OP_LOAD]] to <vscale x 8 x i16>
; CHECK-NEXT:    [[TMP10:%.*]] = mul <vscale x 8 x i16> zeroinitializer, [[TMP9]]
; CHECK-NEXT:    [[TMP15:%.*]] = lshr <vscale x 8 x i16> [[TMP10]], trunc (<vscale x 8 x i32> splat (i32 1) to <vscale x 8 x i16>)
; CHECK-NEXT:    [[TMP12:%.*]] = trunc <vscale x 8 x i16> [[TMP15]] to <vscale x 8 x i8>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i8.nxv8p0(<vscale x 8 x i8> [[TMP12]], <vscale x 8 x ptr> align 1 zeroinitializer, <vscale x 8 x i1> splat (i1 true), i32 [[TMP5]])
