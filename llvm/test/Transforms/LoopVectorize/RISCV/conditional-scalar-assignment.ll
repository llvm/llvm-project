...
; CHECK-NEXT:    br i1 true, label %[[EXIT3:.*]], label %[[SCALAR_PH1]]
; CHECK:       [[SCALAR_PH1]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N]], %[[EXIT1]] ], [ 0, %[[SCALAR_PH]] ]
...
; CHECK:       [[SCALAR_PH1]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N]], %[[IF_THEN]] ], [ 0, %[[SCALAR_PH]] ]
