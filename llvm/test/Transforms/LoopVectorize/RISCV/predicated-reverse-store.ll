...
; CHECK:       vector.ph:
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <vscale x 16 x i1> poison, i1 [[C:%.*]], i64 0
...
; CHECK-NEXT:    [[TMP5:%.*]] = call <vscale x 16 x i1> @llvm.experimental.vp.reverse.nxv16i1(<vscale x 16 x i1> [[BROADCAST_SPLAT]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP1]])
...
; CHECK-NEXT:    [[TMP10:%.*]] = call <vscale x 16 x float> @llvm.experimental.vp.reverse.nxv16f32(<vscale x 16 x float> zeroinitializer, <vscale x 16 x i1> splat (i1 true), i32 [[TMP1]])
; CHECK-NEXT:    call void @llvm.vp.store.nxv16f32.p0(<vscale x 16 x float> [[TMP10]], ptr align 4 [[TMP9]], <vscale x 16 x i1> [[TMP5]], i32 [[TMP1]])
