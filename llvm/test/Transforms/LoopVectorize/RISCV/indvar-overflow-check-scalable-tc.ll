...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x float> @llvm.vp.load.nxv16f32.p0(ptr align 4 [[TMP1]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP0]])
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw float, ptr [[B]], i64 [[INDEX]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv16f32.p0(<vscale x 16 x float> [[VP_OP_LOAD]], ptr align 4 [[TMP2]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP0]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 16 x float> @llvm.vp.load.nxv16f32.p0(ptr align 4 [[TMP2]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP0]])
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw float, ptr [[B]], i64 [[INDEX]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv16f32.p0(<vscale x 16 x float> [[VP_OP_LOAD]], ptr align 4 [[TMP3]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP0]])
...
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @llvm.experimental.get.vector.length.i32(i32 [[AVL]], i32 16, i1 true)
