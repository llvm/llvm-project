...
; CHECK-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 32, i1 true)
; CHECK-NEXT:    [[TMP4:%.*]] = mul i64 [[INDEX]], 6
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[TMP4]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv32i16.p0.i64(<vscale x 32 x i16> zeroinitializer, ptr align 2 [[TMP5]], i64 6, <vscale x 32 x i1> splat (i1 true), i32 [[TMP12]])
...
; CHECK-NEXT:    [[TMP9:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 16, i1 true)
; CHECK-NEXT:    [[TMP1:%.*]] = mul i64 [[INDEX]], 6
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[TMP1]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv16i16.p0.i64(<vscale x 16 x i16> zeroinitializer, ptr align 2 [[TMP2]], i64 6, <vscale x 16 x i1> splat (i1 true), i32 [[TMP9]])
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[CURRENT_ITERATION_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[TMP2]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP27:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 32, i1 true)
; CHECK-NEXT:    [[TMP4:%.*]] = mul i64 [[INDEX]], 6
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[TMP4]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv32i16.p0.i64(<vscale x 32 x i16> zeroinitializer, ptr align 2 [[TMP5]], i64 6, <vscale x 32 x i1> splat (i1 true), i32 [[TMP27]])
...
; CHECK-NEXT:    [[TMP13:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 32, i1 true)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i16, ptr [[SRC]], i64 [[TMP9]]
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 32 x i16> @llvm.vp.load.nxv32i16.p0(ptr align 2 [[TMP10]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP13]])
; CHECK-NEXT:    [[TMP2:%.*]] = icmp eq <vscale x 32 x i16> [[VP_OP_LOAD]], zeroinitializer
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <vscale x 32 x i1> [[TMP2]], <vscale x 32 x i16> splat (i16 99), <vscale x 32 x i16> [[VP_OP_LOAD]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv32i16.p0(<vscale x 32 x i16> [[PREDPHI]], ptr align 2 [[TMP10]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP13]])
...
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 32 x i16> @llvm.vp.load.nxv32i16.p0(ptr align 2 [[TMP10]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP13]])
; CHECK-NEXT:    [[TMP2:%.*]] = icmp eq <vscale x 32 x i16> [[VP_OP_LOAD]], zeroinitializer
; CHECK-NEXT:    [[PREDPHI:%.*]] = select <vscale x 32 x i1> [[TMP2]], <vscale x 32 x i16> [[VP_OP_LOAD]], <vscale x 32 x i16> splat (i16 99)
; CHECK-NEXT:    call void @llvm.vp.store.nxv32i16.p0(<vscale x 32 x i16> [[PREDPHI]], ptr align 2 [[TMP10]], <vscale x 32 x i1> splat (i1 true), i32 [[TMP13]])
; CHECK-NEXT:    [[TMP11:%.*]] = zext i32 [[TMP13]] to i64
; CHECK-NEXT:    [[INDEX_EVL_NEXT]] = add i64 [[TMP11]], [[TMP9]]
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP11]]
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[CURRENT_ITERATION_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[TMP2]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP18:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 16, i1 true)
; CHECK-NEXT:    [[TMP14:%.*]] = mul i64 [[INDEX]], 12
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[DST]], i64 [[TMP14]]
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv16i32.p0.i64(<vscale x 16 x i32> zeroinitializer, ptr align 4 [[TMP15]], i64 12, <vscale x 16 x i1> splat (i1 true), i32 [[TMP18]]), !alias.scope [[META10:![0-9]+]], !noalias [[META13:![0-9]+]]
