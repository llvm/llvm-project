...
; CHECK-NEXT:    [[TMP0:%.*]] = shl nsw i64 [[X_I64]], 1
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP0]]
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP19:%.*]] = phi ptr [ [[TMP5]], %[[VECTOR_PH]] ], [ [[TMP23:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.nxv8i16.p0.i64(<vscale x 8 x i16> zeroinitializer, ptr align 2 [[TMP19]], i64 6, <vscale x 8 x i1> splat (i1 true), i32 [[TMP27]]), !alias.scope [[META0:![0-9]+]], !noalias [[META3:![0-9]+]]
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP28]]
; CHECK-NEXT:    [[TMP22:%.*]] = mul i64 6, [[TMP28]]
; CHECK-NEXT:    [[TMP23]] = getelementptr i8, ptr [[TMP19]], i64 [[TMP22]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = phi ptr [ [[SRC]], %[[VECTOR_PH]] ], [ [[TMP12:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP8:%.*]] = phi ptr [ [[DST]], %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[AVL:%.*]] = phi i64 [ [[TMP0]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP9]], 2
; CHECK-NEXT:    [[TMP12]] = getelementptr i8, ptr [[TMP4]], i64 [[TMP13]]
; CHECK-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP9]]
