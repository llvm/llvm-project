...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP7:%.*]] = or <vscale x 2 x i32> [[VEC_IND1]], [[VEC_IND]]
; CHECK-NEXT:    [[TMP11:%.*]] = sext <vscale x 2 x i32> [[TMP7]] to <vscale x 2 x i64>
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr i8, ptr [[SRC]], <vscale x 2 x i64> [[TMP11]]
; CHECK-NEXT:    [[TMP12:%.*]] = sub i64 [[TMP8]], 1
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <vscale x 2 x ptr> [[WIDE_GEP]], i64 [[TMP12]]
