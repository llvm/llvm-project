...
; CHECK-NEXT:    [[TMP9:%.*]] = trunc i32 [[INDEX]] to i16
; CHECK-NEXT:    [[TMP5:%.*]] = add i16 [[START]], [[TMP9]]
; CHECK-NEXT:    [[TMP6:%.*]] = sext i16 [[TMP5]] to i64
; CHECK-NEXT:    [[TMP7:%.*]] = mul nsw i64 [[TMP6]], 3000000000
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr [[SRC]], i64 [[TMP7]]
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 16 x i8> @llvm.vp.load.nxv16i8.p0(ptr align 1 [[TMP10]], <vscale x 16 x i1> splat (i1 true), i32 [[TMP4]])
