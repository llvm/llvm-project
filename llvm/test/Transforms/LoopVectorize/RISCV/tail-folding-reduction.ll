...
; IF-EVL-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP15]], 2
; IF-EVL-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP6]]
...
; IF-EVL-NEXT:    [[TMP11:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[AVL:%.*]] = phi i64 [ [[N:%.*]], [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP16]], 2
; IF-EVL-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP5]]
...
; IF-EVL-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP14:%.*]] = phi ptr [ [[B:%.*]], [[VECTOR_PH]] ], [ [[TMP11:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[AVL:%.*]] = phi i64 [ [[N:%.*]], [[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], [[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP10:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 4, i1 true)
...
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP18]], 2
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP14]], i64 [[TMP7]]
