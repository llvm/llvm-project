...
; IF-EVL:       [[VECTOR_BODY]]:
; IF-EVL-NEXT:    [[TMP2:%.*]] = phi ptr [ [[B]], %[[VECTOR_PH]] ], [ [[TMP8:%.*]], %[[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP3:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP10:%.*]], %[[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x i32> @llvm.vp.load.nxv2i32.p0(ptr align 4 [[TMP2]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META0:![0-9]+]]
; IF-EVL-NEXT:    [[TMP11:%.*]] = sext <vscale x 2 x i32> [[VP_OP_LOAD]] to <vscale x 2 x i64>
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP11]], ptr align 8 [[TMP3]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP19]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP19]], 2
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP19]], 3
; IF-EVL-NEXT:    [[TMP10]] = getelementptr i8, ptr [[TMP3]], i64 [[TMP9]]
...
; IF-EVL-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
; IF-EVL-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP12]] to i64
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x i32> @llvm.vp.load.nxv2i32.p0(ptr align 4 [[TMP2]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META9:![0-9]+]]
; IF-EVL-NEXT:    [[TMP11:%.*]] = zext <vscale x 2 x i32> [[VP_OP_LOAD]] to <vscale x 2 x i64>
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP11]], ptr align 8 [[TMP3]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META12:![0-9]+]], !noalias [[META9]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP19]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP19]], 2
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP19]], 3
...
; IF-EVL-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
; IF-EVL-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP12]] to i64
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x i64> @llvm.vp.load.nxv2i64.p0(ptr align 8 [[TMP2]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META16:![0-9]+]]
; IF-EVL-NEXT:    [[TMP11:%.*]] = trunc <vscale x 2 x i64> [[VP_OP_LOAD]] to <vscale x 2 x i32>
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2i32.p0(<vscale x 2 x i32> [[TMP11]], ptr align 4 [[TMP3]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META19:![0-9]+]], !noalias [[META16]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP19]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP19]], 3
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP19]], 2
; IF-EVL-NEXT:    [[TMP10]] = getelementptr i8, ptr [[TMP3]], i64 [[TMP9]]
; IF-EVL-NEXT:    [[TMP13:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
...
; IF-EVL-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
; IF-EVL-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP12]] to i64
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x float> @llvm.vp.load.nxv2f32.p0(ptr align 4 [[TMP2]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META23:![0-9]+]]
; IF-EVL-NEXT:    [[TMP11:%.*]] = fpext <vscale x 2 x float> [[VP_OP_LOAD]] to <vscale x 2 x double>
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2f64.p0(<vscale x 2 x double> [[TMP11]], ptr align 8 [[TMP3]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META26:![0-9]+]], !noalias [[META23]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP19]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP19]], 2
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP19]], 3
...
; IF-EVL-NEXT:    [[TMP12:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
; IF-EVL-NEXT:    [[TMP19:%.*]] = zext i32 [[TMP12]] to i64
; IF-EVL-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 2 x double> @llvm.vp.load.nxv2f64.p0(ptr align 8 [[TMP2]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META30:![0-9]+]]
; IF-EVL-NEXT:    [[TMP11:%.*]] = fptrunc <vscale x 2 x double> [[VP_OP_LOAD]] to <vscale x 2 x float>
; IF-EVL-NEXT:    call void @llvm.vp.store.nxv2f32.p0(<vscale x 2 x float> [[TMP11]], ptr align 4 [[TMP3]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META33:![0-9]+]], !noalias [[META30]]
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP19]]
; IF-EVL-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP19]], 3
; IF-EVL-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
; IF-EVL-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP19]], 2
...
; IF-EVL-NEXT:    br label %[[VECTOR_BODY:.*]]
; IF-EVL:       [[VECTOR_BODY]]:
; IF-EVL-NEXT:    [[TMP16:%.*]] = phi ptr [ [[B]], %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[TMP19:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP12:%.*]], %[[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP10:%.*]] = shl i64 [[TMP21]], 2
; IF-EVL-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP10]]
; IF-EVL-NEXT:    [[TMP12]] = getelementptr i8, ptr [[TMP19]], i64 [[TMP10]]
...
; IF-EVL-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP21]]
; IF-EVL-NEXT:    [[TMP10:%.*]] = shl i64 [[TMP21]], 3
; IF-EVL-NEXT:    [[TMP11]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP10]]
; IF-EVL-NEXT:    [[TMP12]] = getelementptr i8, ptr [[TMP19]], i64 [[TMP10]]
; IF-EVL-NEXT:    [[TMP15:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
...
; IF-EVL-NEXT:    [[TMP16:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP6:%.*]], %[[VECTOR_BODY]] ]
; IF-EVL-NEXT:    [[AVL:%.*]] = phi i64 [ [[N]], %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; IF-EVL-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP12]], 3
; IF-EVL-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP5]]
