...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP27:%.*]] = mul i64 [[INDEX]], [[TMP19]]
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP28:%.*]] = getelementptr i8, ptr [[TMP24]], i64 [[TMP27]]
; NO-UNIT-STRIDE-MV-NEXT:    [[WIDE_MASKED_GATHER22:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.strided.load.nxv2i64.p0.i64(ptr align 8 [[TMP28]], i64 [[TMP19]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP25]]), !alias.scope [[META3:![0-9]+]]
