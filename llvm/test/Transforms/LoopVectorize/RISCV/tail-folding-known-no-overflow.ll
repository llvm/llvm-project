...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP11:%.*]] = phi ptr [ [[P]], %[[VECTOR_PH]] ], [ [[TMP6:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP5]]
...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP11:%.*]] = phi ptr [ [[P]], %[[VECTOR_PH]] ], [ [[TMP5:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    call void @llvm.vp.store.nxv2i64.p0(<vscale x 2 x i64> [[VP_OP]], ptr align 8 [[TMP11]], <vscale x 2 x i1> splat (i1 true), i32 [[TMP9]])
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP13]]
; CHECK-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP13]], 3
...
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[TMP7:%.*]] = phi ptr [ [[P]], %[[VECTOR_PH]] ], [ [[TMP6:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP9]], 3
; CHECK-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP7]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP10:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
