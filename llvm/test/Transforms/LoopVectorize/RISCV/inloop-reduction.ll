...
; IF-EVL-OUTLOOP-NEXT:    [[TMP7:%.*]] = phi ptr [ [[X:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-OUTLOOP-NEXT:    [[TMP8:%.*]] = zext i32 [[TMP5]] to i64
; IF-EVL-OUTLOOP-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP8]], 1
; IF-EVL-OUTLOOP-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP7]], i64 [[TMP13]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP8:%.*]] = phi ptr [ [[X:%.*]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-INLOOP-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP6]] to i64
; IF-EVL-INLOOP-NEXT:    [[TMP13:%.*]] = shl i64 [[TMP9]], 1
; IF-EVL-INLOOP-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP13]]
...
; IF-EVL-OUTLOOP-NEXT:    [[TMP11:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-OUTLOOP-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP16]], 2
; IF-EVL-OUTLOOP-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP5]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP11:%.*]] = phi ptr [ [[A:%.*]], [[VECTOR_PH]] ], [ [[TMP6:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-INLOOP-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP14]], 2
; IF-EVL-INLOOP-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP11]], i64 [[TMP5]]
