...
; RUN: opt -mtriple riscv64-linux-gnu -mattr=+v,+d -tail-folding-policy=none -passes=loop-vectorize < %s -S -o - | FileCheck %s -check-prefix=OUTLOOP
; RUN: opt -mtriple riscv64-linux-gnu -mattr=+v,+d -tail-folding-policy=none -passes=loop-vectorize -prefer-inloop-reductions < %s -S -o - | FileCheck %s -check-prefix=INLOOP
