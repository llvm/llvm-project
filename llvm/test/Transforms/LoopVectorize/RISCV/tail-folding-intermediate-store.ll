...
; IF-EVL-OUTLOOP-NEXT:    [[TMP2:%.*]] = phi ptr [ [[A]], [[ENTRY]] ], [ [[TMP8:%.*]], [[FOR_BODY]] ]
...
; IF-EVL-OUTLOOP-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP2]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP12]]), !alias.scope [[META0:![0-9]+]]
...
; IF-EVL-OUTLOOP-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP21]], 2
; IF-EVL-OUTLOOP-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP2]], i64 [[TMP7]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP1:%.*]] = phi ptr [ [[A]], [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
...
; IF-EVL-INLOOP-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr align 4 [[TMP1]], <vscale x 4 x i1> splat (i1 true), i32 [[TMP14]]), !alias.scope [[META0:![0-9]+]]
...
; IF-EVL-INLOOP-NEXT:    [[TMP6:%.*]] = shl i64 [[TMP23]], 2
; IF-EVL-INLOOP-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP1]], i64 [[TMP6]]
