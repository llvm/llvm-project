...
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <vscale x 2 x i64> [[VEC_IND]], i64 [[TMP6]]
; CHECK-NEXT:    store i64 [[TMP11]], ptr [[P]], align 8
...
; CHECK-NEXT:    [[TMP17:%.*]] = icmp eq <vscale x 2 x ptr> [[TMP30]], [[BROADCAST_SPLAT]]
