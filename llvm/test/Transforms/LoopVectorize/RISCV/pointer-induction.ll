...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i8, ptr [[START]], i64 4
...
; CHECK-NEXT:    [[TMP15:%.*]] = phi ptr [ [[TMP0]], %[[VECTOR_MEMCHECK]] ], [ [[TMP22:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP22]] = getelementptr i8, ptr [[TMP15]], i64 [[TMP27]]
