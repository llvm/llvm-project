...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 8 x ptr> poison, ptr [[P]], i64 0
...
; CHECK-NEXT:    [[VECTOR_GEP:%.*]] = getelementptr i8, ptr [[POINTER_PHI]], <vscale x 8 x i64> [[TMP6]]
; CHECK-NEXT:    [[TMP4:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 8, i1 true)
; CHECK-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP4]] to i64
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT3:%.*]] = insertelement <vscale x 8 x i64> poison, i64 [[TMP5]], i64 0
...
; CHECK-NEXT:    [[TMP9:%.*]] = ptrtoint <vscale x 8 x ptr> [[VECTOR_GEP]] to <vscale x 8 x i64>
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i64.nxv8p0(<vscale x 8 x i64> [[TMP9]], <vscale x 8 x ptr> align 8 [[BROADCAST_SPLAT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP4]])
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i64.nxv8p0(<vscale x 8 x i64> [[VEC_IND]], <vscale x 8 x ptr> align 8 [[BROADCAST_SPLAT2]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP4]])
; CHECK-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP5]]
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <vscale x 8 x i64> [[VEC_IND]], [[BROADCAST_SPLAT4]]
...
; CHECK-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <vscale x 8 x ptr> [[BROADCAST_SPLATINSERT]], <vscale x 8 x ptr> poison, <vscale x 8 x i32> zeroinitializer
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 8 x ptr> poison, ptr [[END]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <vscale x 8 x ptr> [[BROADCAST_SPLATINSERT1]], <vscale x 8 x ptr> poison, <vscale x 8 x i32> zeroinitializer
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
...
; CHECK-NEXT:    [[TMP8:%.*]] = mul <vscale x 8 x i64> [[TMP7]], splat (i64 12)
...
; CHECK-NEXT:    [[TMP13:%.*]] = call <vscale x 8 x i32> @llvm.experimental.vp.strided.load.nxv8i32.p0.i64(ptr align 4 [[TMP15]], i64 12, <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]])
; CHECK-NEXT:    [[TMP14:%.*]] = zext <vscale x 8 x i32> [[TMP13]] to <vscale x 8 x i64>
; CHECK-NEXT:    [[TMP17:%.*]] = mul <vscale x 8 x i64> [[TMP14]], splat (i64 -7070675565921424023)
; CHECK-NEXT:    [[TMP16:%.*]] = add <vscale x 8 x i64> [[TMP17]], splat (i64 -4)
; CHECK-NEXT:    call void @llvm.vp.scatter.nxv8i64.nxv8p0(<vscale x 8 x i64> [[TMP16]], <vscale x 8 x ptr> align 1 [[BROADCAST_SPLAT]], <vscale x 8 x i1> splat (i1 true), i32 [[TMP11]])
...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr nusw i8, <vscale x 8 x ptr> [[VECTOR_GEP]], i64 12
; CHECK-NEXT:    [[TMP19:%.*]] = icmp eq <vscale x 8 x ptr> [[WIDE_GEP]], [[BROADCAST_SPLAT2]]
; CHECK-NEXT:    [[TMP29:%.*]] = sub i64 [[TMP26]], 1
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <vscale x 8 x i1> [[TMP19]], i64 [[TMP29]]
