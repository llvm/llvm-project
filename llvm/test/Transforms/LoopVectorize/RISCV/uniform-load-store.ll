...
; SCALABLE-NEXT:    [[TMP8:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP5:%.*]], %[[VECTOR_BODY]] ]
...
; SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP11]], 3
; SCALABLE-NEXT:    [[TMP5]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP4]]
...
; TF-SCALABLE-NEXT:    [[TMP7:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP10:%.*]], %[[VECTOR_BODY]] ]
...
; TF-SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP8]], 3
; TF-SCALABLE-NEXT:    [[TMP10]] = getelementptr i8, ptr [[TMP7]], i64 [[TMP4]]
...
; SCALABLE-NEXT:    br label %[[VECTOR_BODY:.*]]
; SCALABLE:       [[VECTOR_BODY]]:
; SCALABLE-NEXT:    [[TMP8:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP7:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP5]], 3
; SCALABLE-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP8]], i64 [[TMP4]]
...
; TF-SCALABLE-NEXT:    br label %[[VECTOR_BODY:.*]]
; TF-SCALABLE:       [[VECTOR_BODY]]:
; TF-SCALABLE-NEXT:    [[ARRAYIDX:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP7:%.*]], %[[VECTOR_BODY]] ]
; TF-SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; TF-SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP5]], 3
; TF-SCALABLE-NEXT:    [[TMP7]] = getelementptr i8, ptr [[ARRAYIDX]], i64 [[TMP4]]
...
; SCALABLE-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP7:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; SCALABLE-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP8]], 3
; SCALABLE-NEXT:    [[TMP7]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP5]]
...
; TF-SCALABLE-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP6:%.*]], %[[VECTOR_BODY]] ]
; TF-SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; TF-SCALABLE-NEXT:    [[TMP8:%.*]] = shl i64 [[TMP11]], 3
; TF-SCALABLE-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP8]]
...
; SCALABLE-NEXT:    br label %[[VECTOR_BODY:.*]]
; SCALABLE:       [[VECTOR_BODY]]:
; SCALABLE-NEXT:    [[TMP7:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP4:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; SCALABLE-NEXT:    [[TMP3:%.*]] = shl i64 [[TMP10]], 3
; SCALABLE-NEXT:    [[TMP4]] = getelementptr i8, ptr [[TMP7]], i64 [[TMP3]]
; SCALABLE-NEXT:    [[TMP6:%.*]] = icmp eq i64 [[AVL_NEXT]], 0
...
; TF-SCALABLE-NEXT:    br label %[[VECTOR_BODY:.*]]
; TF-SCALABLE:       [[VECTOR_BODY]]:
; TF-SCALABLE-NEXT:    [[TMP6:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP4:%.*]], %[[VECTOR_BODY]] ]
; TF-SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; TF-SCALABLE-NEXT:    [[TMP3:%.*]] = shl i64 [[TMP7]], 3
; TF-SCALABLE-NEXT:    [[TMP4]] = getelementptr i8, ptr [[TMP6]], i64 [[TMP3]]
...
; SCALABLE-NEXT:    [[TMP16:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP5:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; SCALABLE-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP8]]
; SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP8]], 3
; SCALABLE-NEXT:    [[TMP5]] = getelementptr i8, ptr [[TMP16]], i64 [[TMP4]]
...
; TF-SCALABLE-NEXT:    [[TMP10:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP6:%.*]], %[[VECTOR_BODY]] ]
; TF-SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; TF-SCALABLE-NEXT:    [[TMP4:%.*]] = shl i64 [[TMP13]], 3
; TF-SCALABLE-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP10]], i64 [[TMP4]]
...
; SCALABLE:       [[VECTOR_BODY]]:
; SCALABLE-NEXT:    [[VEC_IND:%.*]] = phi <vscale x 2 x i64> [ [[TMP6]], %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[TMP12:%.*]] = phi ptr [ [[A]], %[[VECTOR_PH]] ], [ [[TMP8:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[AVL:%.*]] = phi i64 [ 1025, %[[VECTOR_PH]] ], [ [[AVL_NEXT:%.*]], %[[VECTOR_BODY]] ]
; SCALABLE-NEXT:    [[TMP7:%.*]] = call i32 @llvm.experimental.get.vector.length.i64(i64 [[AVL]], i32 2, i1 true)
...
; SCALABLE-NEXT:    [[TMP5:%.*]] = shl i64 [[TMP14]], 3
; SCALABLE-NEXT:    [[TMP8]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP5]]
...
; TF-SCALABLE-NEXT:    [[AVL_NEXT]] = sub nuw i64 [[AVL]], [[TMP11]]
; TF-SCALABLE-NEXT:    [[TMP7:%.*]] = shl i64 [[TMP11]], 3
; TF-SCALABLE-NEXT:    [[TMP6]] = getelementptr i8, ptr [[TMP12]], i64 [[TMP7]]
