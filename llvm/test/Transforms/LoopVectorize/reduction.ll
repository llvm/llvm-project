...
; CHECK:       for.end.loopexit:
; CHECK-NEXT:    [[SUB_LCSSA:%.*]] = phi i32 [ [[SUB]], [[FOR_BODY]] ]
; CHECK-NEXT:    br label [[FOR_END]]
; CHECK:       for.end:
...
; CHECK-NEXT:    [[ADD2:%.*]] = fadd fast float [[ADD_LCSSA]], [[ADD1_LCSSA]]
...
; CHECK-NEXT:    [[INC]] = add nsw i32 [[T_03]], 1
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], 16
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[FOR_END:%.*]], label [[FOR_BODY]]
; CHECK:       for.end:
; CHECK-NEXT:    [[P_ADDR_02_LCSSA:%.*]] = phi i32 [ [[P_ADDR_02]], [[FOR_BODY]] ]
; CHECK-NEXT:    ret i32 [[P_ADDR_02_LCSSA]]
;
entry:
  br label %for.body
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[P]], 0
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.body:
...
; CHECK-NEXT:    [[INC4_2:%.*]] = xor i32 [[INC4_1]], 1
; CHECK-NEXT:    [[INC511_1_INC4_1:%.*]] = add nsw i32 [[INC511_1]], [[INC4_2]]
; CHECK-NEXT:    [[INC5_1]] = add nsw i32 [[INC511_1_INC4_1]], 1
; CHECK-NEXT:    [[INC6_1]] = add nsw i32 [[INC613_1]], 1
; CHECK-NEXT:    [[EXITCOND_1:%.*]] = icmp eq i32 [[INC6_1]], 22
; CHECK-NEXT:    br i1 [[EXITCOND_1]], label [[EXIT:%.*]], label [[FOR_BODY]]
; CHECK:       exit:
; CHECK-NEXT:    [[INC511_1_INC4_1_LCSSA:%.*]] = phi i32 [ [[INC511_1_INC4_1]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[INC_2:%.*]] = add nsw i32 [[INC511_1_INC4_1_LCSSA]], 2
...
; CHECK-NEXT:    [[SUM_COPY1:%.*]] = phi i32 [ [[TMP17]], [[DOTLR_PH]] ], [ [[TMP9]], [[MIDDLE_BLOCK]] ]
; CHECK-NEXT:    br label [[END]]
; CHECK:       end:
; CHECK-NEXT:    [[F1:%.*]] = phi i32 [ 0, [[TMP0:%.*]] ], [ [[SUM_COPY]], [[DOT_CRIT_EDGE]] ]
; CHECK-NEXT:    [[F3:%.*]] = phi i32 [ 0, [[TMP0]] ], [ [[SUM_COPY1]], [[DOT_CRIT_EDGE]] ]
; CHECK-NEXT:    [[F2:%.*]] = add i32 [[F1]], [[F3]]
...
; CHECK:       ._crit_edge.loopexit:
; CHECK-NEXT:    [[CSEL_LCSSA:%.*]] = phi i32 [ [[CSEL]], [[DOTLR_PH]] ]
; CHECK-NEXT:    [[PHITMP19:%.*]] = sext i32 [[C5]] to i64
; CHECK-NEXT:    br label [[DOT_CRIT_EDGE]]
; CHECK:       ._crit_edge:
; CHECK-NEXT:    [[DOT015_LCSSA:%.*]] = phi i64 [ -1, [[ENTRY:%.*]] ], [ [[PHITMP19]], [[DOT_CRIT_EDGE_LOOPEXIT]] ]
; CHECK-NEXT:    [[DOT0_LCSSA:%.*]] = phi i32 [ 100, [[ENTRY]] ], [ [[CSEL_LCSSA]], [[DOT_CRIT_EDGE_LOOPEXIT]] ]
...
; CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[SMAX]] to i32
; CHECK-NEXT:    [[TMP1:%.*]] = add nsw i32 [[TMP2]], -1
...
; CHECK-NEXT:    [[GEP_A:%.*]] = getelementptr i64, ptr [[A]], i16 [[IV]]
; CHECK-NEXT:    [[LV_A:%.*]] = load i64, ptr [[GEP_A]], align 4
; CHECK-NEXT:    [[SUM_NEXT1:%.*]] = add nsw i64 [[SUM]], [[LV_A]]
; CHECK-NEXT:    br label [[LOOP_BB:%.*]]
; CHECK:       loop.bb:
; CHECK-NEXT:    [[SUM_NEXT]] = phi i64 [ [[SUM_NEXT1]], [[LOOP_HEADER]] ]
...
; CHECK-NEXT:    br label [[LOOP_LATCH]]
; CHECK:       loop.latch:
; CHECK-NEXT:    [[SUM_NEXT]] = phi i64 [ [[SUM_NEXT1]], [[LOOP_BB]] ], [ [[SUM_NEXT1]], [[LOOP_HEADER]] ]
; CHECK-NEXT:    [[IV_NEXT]] = add nsw i16 [[IV]], 1
; CHECK-NEXT:    [[COND:%.*]] = icmp slt i16 [[IV_NEXT]], [[N]]
