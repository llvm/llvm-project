...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <2 x i1> poison, i1 [[C_3:%.*]], i64 0
; CHECK-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <2 x i1> [[BROADCAST_SPLATINSERT1]], <2 x i1> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP5:%.*]] = select <2 x i1> [[BROADCAST_SPLAT4]], <2 x i1> [[BROADCAST_SPLAT2]], <2 x i1> zeroinitializer
...
; CHECK-NEXT:    [[PREDPHI7]] = select i1 [[C_1]], <2 x i32> [[VEC_PHI]], <2 x i32> [[PREDPHI6]]
