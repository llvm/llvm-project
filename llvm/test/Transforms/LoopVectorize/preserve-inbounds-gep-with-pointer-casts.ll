...
; CHECK-NEXT:    [[TMP25:%.*]] = insertelement <4 x double> poison, double [[TMP20]], i64 0
; CHECK-NEXT:    [[TMP26:%.*]] = insertelement <4 x double> [[TMP25]], double [[TMP21]], i64 1
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x double> [[TMP26]], double [[TMP22]], i64 2
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <4 x double> [[TMP24]], double [[TMP23]], i64 3
