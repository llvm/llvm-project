...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr @b, i64 [[TMP8]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = shl nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr @c, i64 [[TMP9]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr @a, i64 [[TMP7]]
