...
; CHECK-NEXT:    [[TMP0:%.*]] = ptrtoaddr ptr [[P]] to i64
; CHECK-NEXT:    [[TMP1:%.*]] = mul i64 [[TMP0]], -3074457345618258603
; CHECK-NEXT:    [[TMP17:%.*]] = ptrtoaddr ptr [[N]] to i64
; CHECK-NEXT:    [[TMP40:%.*]] = mul i64 [[TMP17]], 3074457345618258603
; CHECK-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], [[TMP40]]
