...
; CHECK-VF4UF2-NEXT:    [[TMP19:%.*]] = shl nuw nsw i64 [[TMP12]], 2
; CHECK-VF4UF2-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i8, ptr [[TMP18]], i64 [[TMP19]]
...
; CHECK-VF4UF2-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i8, ptr [[TMP25]], i64 [[TMP19]]
...
; CHECK-VF4UF2-NEXT:    [[TMP12:%.*]] = shl nuw nsw i64 [[TMP11]], 2
; CHECK-VF4UF2-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[TMP10]], i64 [[TMP12]]
...
; CHECK-VF4UF2-NEXT:    [[TMP21:%.*]] = shl nuw nsw i64 [[TMP13]], 1
; CHECK-VF4UF2-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i8, ptr [[TMP19]], i64 [[TMP21]]
...
; CHECK-VF4UF2-NEXT:    [[TMP35:%.*]] = shl nuw nsw i64 [[TMP13]], 3
; CHECK-VF4UF2-NEXT:    [[TMP36:%.*]] = getelementptr inbounds i8, ptr [[TMP34]], i64 [[TMP35]]
; CHECK-VF4UF2-NEXT:    store <vscale x 4 x double> [[TMP32]], ptr [[TMP34]], align 8, !alias.scope [[META9:![0-9]+]], !noalias [[META6]]
; CHECK-VF4UF2-NEXT:    store <vscale x 4 x double> [[TMP33]], ptr [[TMP36]], align 8, !alias.scope [[META9]], !noalias [[META6]]
...
; CHECK-VF4UF2-NEXT:    [[TMP15:%.*]] = shl nuw nsw i64 [[TMP7]], 1
; CHECK-VF4UF2-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[TMP13]], i64 [[TMP15]]
...
; CHECK-VF4UF2-NEXT:    [[TMP27:%.*]] = shl nuw nsw i64 [[TMP7]], 2
; CHECK-VF4UF2-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i8, ptr [[TMP26]], i64 [[TMP27]]
; CHECK-VF4UF2-NEXT:    store <vscale x 4 x i32> [[TMP24]], ptr [[TMP26]], align 4, !alias.scope [[META20:![0-9]+]], !noalias [[META17]]
; CHECK-VF4UF2-NEXT:    store <vscale x 4 x i32> [[TMP25]], ptr [[TMP28]], align 4, !alias.scope [[META20]], !noalias [[META17]]
