...
; VF2-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
...
; VF4-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP0]]
; VF4-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF4-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; VF4-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP3]]
...
; VF2-NEXT:    [[TMP7:%.*]] = extractelement <2 x i64> [[TMP6]], i32 0
; VF2-NEXT:    [[TMP8:%.*]] = extractelement <2 x i64> [[TMP6]], i32 1
; VF2-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF2-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; VF2-NEXT:    store i64 [[TMP7]], ptr [[TMP9]], align 8
; VF2-NEXT:    store i64 [[TMP8]], ptr [[TMP10]], align 8
; VF2-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
...
; VF4-NEXT:    [[TMP9:%.*]] = extractelement <4 x i64> [[TMP8]], i32 0
; VF4-NEXT:    [[TMP10:%.*]] = extractelement <4 x i64> [[TMP8]], i32 1
; VF4-NEXT:    [[TMP11:%.*]] = extractelement <4 x i64> [[TMP8]], i32 2
; VF4-NEXT:    [[TMP12:%.*]] = extractelement <4 x i64> [[TMP8]], i32 3
; VF4-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF4-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; VF4-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP3]]
; VF4-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP4]]
; VF4-NEXT:    store i64 [[TMP9]], ptr [[TMP13]], align 8
; VF4-NEXT:    store i64 [[TMP10]], ptr [[TMP14]], align 8
; VF4-NEXT:    store i64 [[TMP11]], ptr [[TMP15]], align 8
; VF4-NEXT:    store i64 [[TMP12]], ptr [[TMP16]], align 8
; VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
