...
; CHECK-NEXT:    [[TMP46:%.*]] = insertelement <16 x i64> poison, i64 [[TMP16]], i64 0
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <16 x i64> [[TMP46]], i64 [[TMP17]], i64 1
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <16 x i64> [[TMP32]], i64 [[TMP18]], i64 2
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <16 x i64> [[TMP33]], i64 [[TMP19]], i64 3
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <16 x i64> [[TMP34]], i64 [[TMP20]], i64 4
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <16 x i64> [[TMP35]], i64 [[TMP21]], i64 5
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <16 x i64> [[TMP36]], i64 [[TMP22]], i64 6
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <16 x i64> [[TMP37]], i64 [[TMP23]], i64 7
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <16 x i64> [[TMP38]], i64 [[TMP24]], i64 8
; CHECK-NEXT:    [[TMP40:%.*]] = insertelement <16 x i64> [[TMP39]], i64 [[TMP25]], i64 9
; CHECK-NEXT:    [[TMP41:%.*]] = insertelement <16 x i64> [[TMP40]], i64 [[TMP26]], i64 10
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <16 x i64> [[TMP41]], i64 [[TMP27]], i64 11
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <16 x i64> [[TMP42]], i64 [[TMP28]], i64 12
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <16 x i64> [[TMP43]], i64 [[TMP29]], i64 13
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <16 x i64> [[TMP44]], i64 [[TMP30]], i64 14
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <16 x i64> [[TMP45]], i64 [[TMP31]], i64 15
...
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <8 x i64> poison, i64 [[TMP61]], i64 0
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <8 x i64> [[TMP74]], i64 [[TMP62]], i64 1
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <8 x i64> [[TMP75]], i64 [[TMP63]], i64 2
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <8 x i64> [[TMP69]], i64 [[TMP64]], i64 3
; CHECK-NEXT:    [[TMP71:%.*]] = insertelement <8 x i64> [[TMP70]], i64 [[TMP65]], i64 4
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <8 x i64> [[TMP71]], i64 [[TMP66]], i64 5
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <8 x i64> [[TMP72]], i64 [[TMP67]], i64 6
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <8 x i64> [[TMP73]], i64 [[TMP68]], i64 7
...
; IC2-NEXT:    [[TMP62:%.*]] = insertelement <16 x i64> poison, i64 [[TMP32]], i64 0
; IC2-NEXT:    [[TMP48:%.*]] = insertelement <16 x i64> [[TMP62]], i64 [[TMP33]], i64 1
; IC2-NEXT:    [[TMP49:%.*]] = insertelement <16 x i64> [[TMP48]], i64 [[TMP34]], i64 2
; IC2-NEXT:    [[TMP50:%.*]] = insertelement <16 x i64> [[TMP49]], i64 [[TMP35]], i64 3
; IC2-NEXT:    [[TMP51:%.*]] = insertelement <16 x i64> [[TMP50]], i64 [[TMP36]], i64 4
; IC2-NEXT:    [[TMP52:%.*]] = insertelement <16 x i64> [[TMP51]], i64 [[TMP37]], i64 5
; IC2-NEXT:    [[TMP53:%.*]] = insertelement <16 x i64> [[TMP52]], i64 [[TMP38]], i64 6
; IC2-NEXT:    [[TMP54:%.*]] = insertelement <16 x i64> [[TMP53]], i64 [[TMP39]], i64 7
; IC2-NEXT:    [[TMP55:%.*]] = insertelement <16 x i64> [[TMP54]], i64 [[TMP40]], i64 8
; IC2-NEXT:    [[TMP56:%.*]] = insertelement <16 x i64> [[TMP55]], i64 [[TMP41]], i64 9
; IC2-NEXT:    [[TMP57:%.*]] = insertelement <16 x i64> [[TMP56]], i64 [[TMP42]], i64 10
; IC2-NEXT:    [[TMP58:%.*]] = insertelement <16 x i64> [[TMP57]], i64 [[TMP43]], i64 11
; IC2-NEXT:    [[TMP59:%.*]] = insertelement <16 x i64> [[TMP58]], i64 [[TMP44]], i64 12
; IC2-NEXT:    [[TMP60:%.*]] = insertelement <16 x i64> [[TMP59]], i64 [[TMP45]], i64 13
; IC2-NEXT:    [[TMP61:%.*]] = insertelement <16 x i64> [[TMP60]], i64 [[TMP46]], i64 14
; IC2-NEXT:    [[TMP63:%.*]] = insertelement <16 x i64> [[TMP61]], i64 [[TMP47]], i64 15
...
; IC2-NEXT:    [[TMP94:%.*]] = insertelement <16 x i64> poison, i64 [[TMP64]], i64 0
; IC2-NEXT:    [[TMP80:%.*]] = insertelement <16 x i64> [[TMP94]], i64 [[TMP65]], i64 1
; IC2-NEXT:    [[TMP81:%.*]] = insertelement <16 x i64> [[TMP80]], i64 [[TMP66]], i64 2
; IC2-NEXT:    [[TMP82:%.*]] = insertelement <16 x i64> [[TMP81]], i64 [[TMP67]], i64 3
; IC2-NEXT:    [[TMP83:%.*]] = insertelement <16 x i64> [[TMP82]], i64 [[TMP68]], i64 4
; IC2-NEXT:    [[TMP84:%.*]] = insertelement <16 x i64> [[TMP83]], i64 [[TMP69]], i64 5
; IC2-NEXT:    [[TMP85:%.*]] = insertelement <16 x i64> [[TMP84]], i64 [[TMP70]], i64 6
; IC2-NEXT:    [[TMP86:%.*]] = insertelement <16 x i64> [[TMP85]], i64 [[TMP71]], i64 7
; IC2-NEXT:    [[TMP87:%.*]] = insertelement <16 x i64> [[TMP86]], i64 [[TMP72]], i64 8
; IC2-NEXT:    [[TMP88:%.*]] = insertelement <16 x i64> [[TMP87]], i64 [[TMP73]], i64 9
; IC2-NEXT:    [[TMP89:%.*]] = insertelement <16 x i64> [[TMP88]], i64 [[TMP74]], i64 10
; IC2-NEXT:    [[TMP90:%.*]] = insertelement <16 x i64> [[TMP89]], i64 [[TMP75]], i64 11
; IC2-NEXT:    [[TMP91:%.*]] = insertelement <16 x i64> [[TMP90]], i64 [[TMP76]], i64 12
; IC2-NEXT:    [[TMP92:%.*]] = insertelement <16 x i64> [[TMP91]], i64 [[TMP77]], i64 13
; IC2-NEXT:    [[TMP93:%.*]] = insertelement <16 x i64> [[TMP92]], i64 [[TMP78]], i64 14
; IC2-NEXT:    [[TMP95:%.*]] = insertelement <16 x i64> [[TMP93]], i64 [[TMP79]], i64 15
...
; IC2-NEXT:    [[TMP126:%.*]] = insertelement <8 x i64> poison, i64 [[TMP113]], i64 0
; IC2-NEXT:    [[TMP127:%.*]] = insertelement <8 x i64> [[TMP126]], i64 [[TMP114]], i64 1
; IC2-NEXT:    [[TMP121:%.*]] = insertelement <8 x i64> [[TMP127]], i64 [[TMP115]], i64 2
; IC2-NEXT:    [[TMP122:%.*]] = insertelement <8 x i64> [[TMP121]], i64 [[TMP116]], i64 3
; IC2-NEXT:    [[TMP123:%.*]] = insertelement <8 x i64> [[TMP122]], i64 [[TMP117]], i64 4
; IC2-NEXT:    [[TMP124:%.*]] = insertelement <8 x i64> [[TMP123]], i64 [[TMP118]], i64 5
; IC2-NEXT:    [[TMP125:%.*]] = insertelement <8 x i64> [[TMP124]], i64 [[TMP119]], i64 6
; IC2-NEXT:    [[TMP128:%.*]] = insertelement <8 x i64> [[TMP125]], i64 [[TMP120]], i64 7
