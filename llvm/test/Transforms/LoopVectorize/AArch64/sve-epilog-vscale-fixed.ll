...
; DEBUG: Main Loop VF:vscale x 16, Main Loop UF:2, Epilogue Loop VF:4, Epilogue Loop UF:1
...
; DEBUG-EPILOG-PREFER-SCALABLE: Main Loop VF:vscale x 16, Main Loop UF:2, Epilogue Loop VF:vscale x 4, Epilogue Loop UF:1
...
; CHECK-NEXT:    store <4 x i8> splat (i8 1), ptr [[TMP9]], align 1
...
; CHECK-EPILOG-PREFER-SCALABLE-NEXT:    [[TMP1:%.*]] = shl nuw i64 [[TMP0]], 2
...
; CHECK-EPILOG-PREFER-SCALABLE-NEXT:    [[TMP11:%.*]] = shl nuw i64 [[TMP8]], 2
...
; CHECK-EPILOG-PREFER-SCALABLE-NEXT:    [[TMP14:%.*]] = shl nuw i64 [[TMP13]], 2
...
; CHECK-EPILOG-PREFER-SCALABLE-NEXT:    store <vscale x 4 x i8> splat (i8 1), ptr [[TMP15]], align 1
