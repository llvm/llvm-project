...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <16 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP180:%.*]], [[PRED_LOAD_CONTINUE62]] ]
...
; CHECK-NEXT:    [[TMP174:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP175:%.*]] = load i8, ptr [[TMP174]], align 1
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <16 x i8> [[TMP51]], i8 [[TMP175]], i32 7
...
; CHECK-NEXT:    [[TMP183:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP15]]
; CHECK-NEXT:    [[TMP184:%.*]] = load i8, ptr [[TMP183]], align 1
; CHECK-NEXT:    [[TMP176:%.*]] = insertelement <16 x i8> [[TMP172]], i8 [[TMP184]], i32 15
...
; CHECK-NEXT:    [[TMP180]] = add <16 x i32> [[TMP179]], [[VEC_PHI]]
; CHECK-NEXT:    [[TMP185:%.*]] = select <16 x i1> [[TMP16]], <16 x i32> [[TMP180]], <16 x i32> [[VEC_PHI]]
...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP182:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[TMP185]])
