...
; CHECK:       vector.ph:
; CHECK-NEXT:    [[IV_NEXT:%.*]] = and i64 [[TMP0]], -16
...
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = sub i64 [[TMP0]], [[IV_NEXT]]
...
; CHECK-NEXT:    [[N_VEC5:%.*]] = and i64 [[TMP0]], -2
...
; CHECK-NEXT:    [[TMP16:%.*]] = sext <2 x i8> [[BROADCAST_SPLAT9]] to <2 x i32>
; CHECK-NEXT:    [[TMP13:%.*]] = mul <2 x i32> [[TMP16]], [[TMP10]]
