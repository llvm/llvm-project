...
; CHECK-MAXBW-NEXT:    [[VEC_PHI:%.*]] = phi <16 x i32> [ zeroinitializer, [[ENTRY]] ], [ [[TMP9:%.*]], [[FOR_BODY]] ]
...
; CHECK-MAXBW-NEXT:    [[TMP12:%.*]] = zext <16 x i8> [[WIDE_LOAD1]] to <16 x i32>
; CHECK-MAXBW-NEXT:    [[TMP13:%.*]] = mul <16 x i32> [[TMP12]], [[TMP3]]
; CHECK-MAXBW-NEXT:    [[TMP14:%.*]] = sub <16 x i32> zeroinitializer, [[TMP13]]
; CHECK-MAXBW-NEXT:    [[TMP9]] = add <16 x i32> [[VEC_PHI]], [[TMP14]]
; CHECK-MAXBW-NEXT:    [[IV_NEXT]] = add nuw i64 [[IV]], 16
; CHECK-MAXBW-NEXT:    [[TMP15:%.*]] = icmp eq i64 [[IV_NEXT]], 1024
; CHECK-MAXBW-NEXT:    br i1 [[TMP15]], label [[MIDDLE_BLOCK:%.*]], label [[FOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
