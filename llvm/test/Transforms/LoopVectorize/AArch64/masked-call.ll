...
; TFALWAYS-NEXT:    store double [[TMP10]], ptr [[P]], align 8
; TFALWAYS-NEXT:    br label %[[PRED_STORE_CONTINUE]]
; TFALWAYS:       [[PRED_STORE_CONTINUE]]:
; TFALWAYS-NEXT:    [[TMP11:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK]], i32 1
; TFALWAYS-NEXT:    br i1 [[TMP11]], label %[[PRED_STORE_IF1:.*]], label %[[PRED_STORE_CONTINUE2]]
; TFALWAYS:       [[PRED_STORE_IF1]]:
; TFALWAYS-NEXT:    [[TMP12:%.*]] = extractelement <2 x double> [[PREDPHI]], i32 1
; TFALWAYS-NEXT:    store double [[TMP12]], ptr [[P]], align 8
...
; TFALWAYS-NEXT:    [[TMP13:%.*]] = xor <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], splat (i1 true)
; TFALWAYS-NEXT:    [[TMP14:%.*]] = extractelement <2 x i1> [[TMP13]], i32 0
; TFALWAYS-NEXT:    br i1 [[TMP14]], label %[[END:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; TFALWAYS:       [[END]]:
; TFALWAYS-NEXT:    ret void
;
...
; TFFALLBACK-NEXT:    [[TMP6:%.*]] = fcmp ogt <2 x double> [[TMP5]], zeroinitializer
; TFFALLBACK-NEXT:    [[TMP7:%.*]] = xor <2 x i1> [[TMP6]], splat (i1 true)
; TFFALLBACK-NEXT:    [[TMP8:%.*]] = select <2 x i1> [[ACTIVE_LANE_MASK]], <2 x i1> [[TMP7]], <2 x i1> zeroinitializer
; TFFALLBACK-NEXT:    [[PREDPHI:%.*]] = select <2 x i1> [[TMP8]], <2 x double> splat (double 1.000000e+00), <2 x double> zeroinitializer
; TFFALLBACK-NEXT:    [[TMP9:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK]], i32 0
; TFFALLBACK-NEXT:    br i1 [[TMP9]], label %[[PRED_STORE_IF:.*]], label %[[PRED_STORE_CONTINUE:.*]]
; TFFALLBACK:       [[PRED_STORE_IF]]:
; TFFALLBACK-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[PREDPHI]], i32 0
; TFFALLBACK-NEXT:    store double [[TMP10]], ptr [[P]], align 8
; TFFALLBACK-NEXT:    br label %[[PRED_STORE_CONTINUE]]
; TFFALLBACK:       [[PRED_STORE_CONTINUE]]:
; TFFALLBACK-NEXT:    [[TMP11:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK]], i32 1
; TFFALLBACK-NEXT:    br i1 [[TMP11]], label %[[PRED_STORE_IF1:.*]], label %[[PRED_STORE_CONTINUE2]]
; TFFALLBACK:       [[PRED_STORE_IF1]]:
; TFFALLBACK-NEXT:    [[TMP12:%.*]] = extractelement <2 x double> [[PREDPHI]], i32 1
; TFFALLBACK-NEXT:    store double [[TMP12]], ptr [[P]], align 8
...
; TFFALLBACK-NEXT:    [[TMP13:%.*]] = xor <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], splat (i1 true)
; TFFALLBACK-NEXT:    [[TMP14:%.*]] = extractelement <2 x i1> [[TMP13]], i32 0
; TFFALLBACK-NEXT:    br i1 [[TMP14]], label %[[END:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP9:![0-9]+]]
; TFFALLBACK:       [[END]]:
; TFFALLBACK-NEXT:    ret void
;
...
; TFA_INTERLEAVE-NEXT:    [[TMP7:%.*]] = fcmp ogt <2 x double> [[TMP5]], zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[TMP8:%.*]] = fcmp ogt <2 x double> [[TMP6]], zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[TMP9:%.*]] = xor <2 x i1> [[TMP7]], splat (i1 true)
; TFA_INTERLEAVE-NEXT:    [[TMP10:%.*]] = xor <2 x i1> [[TMP8]], splat (i1 true)
; TFA_INTERLEAVE-NEXT:    [[TMP11:%.*]] = select <2 x i1> [[ACTIVE_LANE_MASK]], <2 x i1> [[TMP9]], <2 x i1> zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[TMP12:%.*]] = select <2 x i1> [[ACTIVE_LANE_MASK2]], <2 x i1> [[TMP10]], <2 x i1> zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[PREDPHI:%.*]] = select <2 x i1> [[TMP11]], <2 x double> splat (double 1.000000e+00), <2 x double> zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[PREDPHI3:%.*]] = select <2 x i1> [[TMP12]], <2 x double> splat (double 1.000000e+00), <2 x double> zeroinitializer
; TFA_INTERLEAVE-NEXT:    [[TMP13:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK]], i32 0
; TFA_INTERLEAVE-NEXT:    br i1 [[TMP13]], label %[[PRED_STORE_IF:.*]], label %[[PRED_STORE_CONTINUE:.*]]
; TFA_INTERLEAVE:       [[PRED_STORE_IF]]:
; TFA_INTERLEAVE-NEXT:    [[TMP24:%.*]] = extractelement <2 x double> [[PREDPHI]], i32 0
...
; TFA_INTERLEAVE-NEXT:    [[TMP15:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK]], i32 1
; TFA_INTERLEAVE-NEXT:    br i1 [[TMP15]], label %[[PRED_STORE_IF4:.*]], label %[[PRED_STORE_CONTINUE5:.*]]
; TFA_INTERLEAVE:       [[PRED_STORE_IF4]]:
; TFA_INTERLEAVE-NEXT:    [[TMP26:%.*]] = extractelement <2 x double> [[PREDPHI]], i32 1
...
; TFA_INTERLEAVE-NEXT:    [[TMP17:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK2]], i32 0
; TFA_INTERLEAVE-NEXT:    br i1 [[TMP17]], label %[[PRED_STORE_IF6:.*]], label %[[PRED_STORE_CONTINUE7:.*]]
; TFA_INTERLEAVE:       [[PRED_STORE_IF6]]:
; TFA_INTERLEAVE-NEXT:    [[TMP18:%.*]] = extractelement <2 x double> [[PREDPHI3]], i32 0
...
; TFA_INTERLEAVE-NEXT:    [[TMP19:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK2]], i32 1
; TFA_INTERLEAVE-NEXT:    br i1 [[TMP19]], label %[[PRED_STORE_IF8:.*]], label %[[PRED_STORE_CONTINUE9]]
; TFA_INTERLEAVE:       [[PRED_STORE_IF8]]:
; TFA_INTERLEAVE-NEXT:    [[TMP20:%.*]] = extractelement <2 x double> [[PREDPHI3]], i32 1
...
; TFA_INTERLEAVE-NEXT:    [[TMP22:%.*]] = xor <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], splat (i1 true)
; TFA_INTERLEAVE-NEXT:    [[TMP23:%.*]] = extractelement <2 x i1> [[TMP22]], i32 0
; TFA_INTERLEAVE-NEXT:    br i1 [[TMP23]], label %[[END:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; TFA_INTERLEAVE:       [[END]]:
; TFA_INTERLEAVE-NEXT:    ret void
;
entry:
