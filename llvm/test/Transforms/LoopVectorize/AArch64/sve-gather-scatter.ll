...
; RUN: opt -passes='loop-vectorize,dce,instcombine<no-verify-fixpoint>' -mtriple aarch64-linux-gnu -mattr=+sve \
...
; CHECK-NEXT:    [[TMP16:%.*]] = shl nuw nsw i64 [[TMP2]], 4
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP12]], i64 [[TMP16]]
