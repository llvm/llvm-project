...
; CHECK-UF1-NEXT:    [[VECTOR_RECUR_INIT:%.*]] = insertelement <vscale x 2 x i64> poison, i64 0, i64 [[TMP2]]
...
; CHECK-UF4-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP1]], 1
; CHECK-UF4-NEXT:    [[VECTOR_RECUR_INIT:%.*]] = insertelement <vscale x 2 x i64> poison, i64 0, i64 [[TMP3]]
