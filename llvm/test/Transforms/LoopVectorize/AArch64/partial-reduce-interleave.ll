...
; IC2-NEXT:    [[WIDE_LOAD2:%.*]] = load <16 x i8>, ptr [[TMP2]], align 1
...
; IC4-NEXT:    [[WIDE_LOAD6:%.*]] = load <16 x i8>, ptr [[TMP2]], align 1
...
; IC4-NEXT:    [[TMP5:%.*]] = zext <16 x i8> [[WIDE_LOAD6]] to <16 x i32>
; IC4-NEXT:    [[TMP11:%.*]] = mul nuw nsw <16 x i32> [[TMP5]], [[TMP5]]
...
; IC4-NEXT:    [[TMP7:%.*]] = zext <16 x i8> [[WIDE_LOAD6]] to <16 x i32>
; IC4-NEXT:    [[TMP12:%.*]] = mul nuw nsw <16 x i32> [[TMP7]], [[TMP7]]
...
; IC4-NEXT:    [[TMP10:%.*]] = mul nuw nsw <16 x i32> [[TMP14]], [[TMP14]]
; IC4-NEXT:    [[PARTIAL_REDUCE9]] = call <4 x i32> @llvm.experimental.vector.partial.reduce.add.v4i32.v16i32(<4 x i32> [[VEC_PHI3]], <16 x i32> [[TMP10]])
