...
; CHECK-NEXT:    [[TMP14:%.*]] = freeze i1 [[TMP6]]
; CHECK-NEXT:    [[TMP9:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    [[TMP23:%.*]] = or i1 [[TMP14]], [[TMP9]]
; CHECK-NEXT:    br i1 [[TMP23]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP11:%.*]] = select i1 [[TMP14]], <4 x float> [[VEC_PHI]], <4 x float> [[TMP7]]
; CHECK-NEXT:    [[TMP12:%.*]] = select i1 [[TMP14]], <4 x float> [[VEC_PHI1]], <4 x float> [[TMP8]]
; CHECK-NEXT:    [[TMP18:%.*]] = select i1 [[TMP14]], <4 x float> [[VEC_PHI2]], <4 x float> [[TMP13]]
; CHECK-NEXT:    [[TMP19:%.*]] = select i1 [[TMP14]], <4 x float> [[VEC_PHI3]], <4 x float> [[TMP15]]
; CHECK-NEXT:    [[TMP25:%.*]] = select i1 [[TMP14]], i64 [[IV]], i64 [[N_VEC]]
...
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[TMP25]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
...
; CHECK-NEXT:    [[TMP41:%.*]] = freeze i1 [[TMP19]]
...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[TMP23:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI]], <4 x float> [[TMP6]]
; CHECK-NEXT:    [[TMP24:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI1]], <4 x float> [[TMP7]]
; CHECK-NEXT:    [[TMP32:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI4]], <4 x float> [[TMP14]]
; CHECK-NEXT:    [[TMP33:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI5]], <4 x float> [[TMP15]]
; CHECK-NEXT:    [[TMP25:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI2]], <4 x float> [[TMP4]]
; CHECK-NEXT:    [[TMP26:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI3]], <4 x float> [[TMP5]]
; CHECK-NEXT:    [[TMP36:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI6]], <4 x float> [[TMP10]]
; CHECK-NEXT:    [[TMP37:%.*]] = select i1 [[TMP41]], <4 x float> [[VEC_PHI7]], <4 x float> [[TMP11]]
; CHECK-NEXT:    [[TMP43:%.*]] = select i1 [[TMP41]], i64 [[IV]], i64 [[N_VEC]]
...
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; CHECK-NEXT:    [[TMP30:%.*]] = xor i1 [[TMP41]], true
