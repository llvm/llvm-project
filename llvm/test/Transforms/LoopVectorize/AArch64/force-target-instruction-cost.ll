...
; COST1-NEXT:    [[TMP31:%.*]] = load i8, ptr [[TMP17]], align 1, !alias.scope [[META19:![0-9]+]]
; COST1-NEXT:    [[TMP25:%.*]] = load i8, ptr [[TMP18]], align 1, !alias.scope [[META19]]
; COST1-NEXT:    [[TMP26:%.*]] = load i8, ptr [[TMP19]], align 1, !alias.scope [[META19]]
; COST1-NEXT:    [[TMP27:%.*]] = load i8, ptr [[TMP20]], align 1, !alias.scope [[META19]]
...
; COST1-NEXT:    [[TMP39:%.*]] = load i8, ptr [[TMP21]], align 1, !alias.scope [[META19]]
; COST1-NEXT:    [[TMP33:%.*]] = load i8, ptr [[TMP22]], align 1, !alias.scope [[META19]]
; COST1-NEXT:    [[TMP34:%.*]] = load i8, ptr [[TMP23]], align 1, !alias.scope [[META19]]
; COST1-NEXT:    [[TMP35:%.*]] = load i8, ptr [[TMP24]], align 1, !alias.scope [[META19]]
...
; COST10-NEXT:    [[TMP19:%.*]] = load i8, ptr [[TMP9]], align 1, !alias.scope [[META19:![0-9]+]]
; COST10-NEXT:    [[TMP13:%.*]] = load i8, ptr [[TMP10]], align 1, !alias.scope [[META19]]
; COST10-NEXT:    [[TMP14:%.*]] = load i8, ptr [[TMP11]], align 1, !alias.scope [[META19]]
; COST10-NEXT:    [[TMP15:%.*]] = load i8, ptr [[TMP12]], align 1, !alias.scope [[META19]]
