...
; CHECK-NEXT:    [[TMP8:%.*]] = shl nuw i64 [[TMP1]], 5
; CHECK-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[TMP0]], [[TMP2]]
; CHECK-NEXT:    [[TMP9:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-NEXT:    [[TMP43:%.*]] = shl nuw i64 [[TMP9]], 2
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 8 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP27:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI2:%.*]] = phi <vscale x 8 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP28:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI3:%.*]] = phi <vscale x 8 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP29:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI4:%.*]] = phi <vscale x 8 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP31:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 8 x i8>, ptr [[TMP16]], align 1
; CHECK-NEXT:    [[WIDE_LOAD5:%.*]] = load <vscale x 8 x i8>, ptr [[TMP19]], align 1
; CHECK-NEXT:    [[WIDE_LOAD6:%.*]] = load <vscale x 8 x i8>, ptr [[TMP20]], align 1
; CHECK-NEXT:    [[WIDE_LOAD7:%.*]] = load <vscale x 8 x i8>, ptr [[TMP21]], align 1
; CHECK-NEXT:    [[TMP23:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD]] to <vscale x 8 x i32>
; CHECK-NEXT:    [[TMP24:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD5]] to <vscale x 8 x i32>
; CHECK-NEXT:    [[TMP25:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD6]] to <vscale x 8 x i32>
; CHECK-NEXT:    [[TMP26:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD7]] to <vscale x 8 x i32>
; CHECK-NEXT:    [[TMP27]] = or <vscale x 8 x i32> [[VEC_PHI]], [[TMP23]]
; CHECK-NEXT:    [[TMP28]] = or <vscale x 8 x i32> [[VEC_PHI2]], [[TMP24]]
; CHECK-NEXT:    [[TMP29]] = or <vscale x 8 x i32> [[VEC_PHI3]], [[TMP25]]
; CHECK-NEXT:    [[TMP31]] = or <vscale x 8 x i32> [[VEC_PHI4]], [[TMP26]]
...
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[BIN_RDX:%.*]] = or <vscale x 8 x i32> [[TMP28]], [[TMP27]]
; CHECK-NEXT:    [[BIN_RDX8:%.*]] = or <vscale x 8 x i32> [[TMP29]], [[BIN_RDX]]
; CHECK-NEXT:    [[BIN_RDX9:%.*]] = or <vscale x 8 x i32> [[TMP31]], [[BIN_RDX8]]
; CHECK-NEXT:    [[TMP34:%.*]] = call i32 @llvm.vector.reduce.or.nxv8i32(<vscale x 8 x i32> [[BIN_RDX9]])
...
; CHECK-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i32 [ [[TMP34]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
...
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <vscale x 4 x i32> zeroinitializer, i32 [[BC_MERGE_RDX]], i32 0
; CHECK-NEXT:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK:       [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX12:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], %[[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT15:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI13:%.*]] = phi <vscale x 4 x i32> [ [[TMP39]], %[[VEC_EPILOG_PH]] ], [ [[TMP42:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[WIDE_LOAD14:%.*]] = load <vscale x 4 x i8>, ptr [[TMP38]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = zext <vscale x 4 x i8> [[WIDE_LOAD14]] to <vscale x 4 x i32>
; CHECK-NEXT:    [[TMP42]] = or <vscale x 4 x i32> [[VEC_PHI13]], [[TMP40]]
...
; CHECK-NEXT:    [[TMP44:%.*]] = call i32 @llvm.vector.reduce.or.nxv4i32(<vscale x 4 x i32> [[TMP42]])
...
; CHECK-NEXT:    [[BC_MERGE_RDX17:%.*]] = phi i32 [ [[TMP44]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[TMP34]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_SCEVCHECK]] ], [ 0, %[[ITER_CHECK]] ]
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[OR_LCSSA:%.*]] = phi i32 [ [[OR]], %[[LOOP]] ], [ [[TMP34]], %[[MIDDLE_BLOCK]] ], [ [[TMP44]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ]
...
; CHECK: [[PROF4]] = !{!"branch_weights", i32 4, i32 28}
