...
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[TMP0]], [[TMP8]]
; CHECK-NEXT:    [[N_VEC:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF]]
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 16 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP40:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI2:%.*]] = phi <vscale x 16 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP31:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI3:%.*]] = phi <vscale x 16 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP42:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI4:%.*]] = phi <vscale x 16 x i32> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP33:%.*]], %[[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP43:%.*]] = trunc <vscale x 16 x i32> [[TMP26]] to <vscale x 16 x i8>
; CHECK-NEXT:    [[TMP44:%.*]] = trunc <vscale x 16 x i32> [[TMP27]] to <vscale x 16 x i8>
; CHECK-NEXT:    [[TMP47:%.*]] = trunc <vscale x 16 x i32> [[TMP28]] to <vscale x 16 x i8>
; CHECK-NEXT:    [[TMP50:%.*]] = trunc <vscale x 16 x i32> [[TMP29]] to <vscale x 16 x i8>
; CHECK-NEXT:    [[TMP40]] = zext <vscale x 16 x i8> [[TMP43]] to <vscale x 16 x i32>
; CHECK-NEXT:    [[TMP31]] = zext <vscale x 16 x i8> [[TMP44]] to <vscale x 16 x i32>
; CHECK-NEXT:    [[TMP42]] = zext <vscale x 16 x i8> [[TMP47]] to <vscale x 16 x i32>
; CHECK-NEXT:    [[TMP33]] = zext <vscale x 16 x i8> [[TMP50]] to <vscale x 16 x i32>
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP8]]
; CHECK-NEXT:    [[TMP30:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP30]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[BIN_RDX:%.*]] = or <vscale x 16 x i8> [[TMP44]], [[TMP43]]
; CHECK-NEXT:    [[BIN_RDX8:%.*]] = or <vscale x 16 x i8> [[TMP47]], [[BIN_RDX]]
; CHECK-NEXT:    [[BIN_RDX9:%.*]] = or <vscale x 16 x i8> [[TMP50]], [[BIN_RDX8]]
; CHECK-NEXT:    [[TMP51:%.*]] = call i8 @llvm.vector.reduce.or.nxv16i8(<vscale x 16 x i8> [[BIN_RDX9]])
; CHECK-NEXT:    [[TMP52:%.*]] = zext i8 [[TMP51]] to i32
...
; CHECK-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i32 [ [[TMP52]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
...
; CHECK-NEXT:    [[VEC_PHI13:%.*]] = phi <16 x i32> [ [[TMP32]], %[[VEC_EPILOG_PH]] ], [ [[TMP46:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP34:%.*]] = zext <16 x i8> [[WIDE_LOAD14]] to <16 x i32>
; CHECK-NEXT:    [[TMP39:%.*]] = or <16 x i32> [[VEC_PHI13]], [[TMP34]]
; CHECK-NEXT:    [[TMP45:%.*]] = trunc <16 x i32> [[TMP39]] to <16 x i8>
; CHECK-NEXT:    [[TMP46]] = zext <16 x i8> [[TMP45]] to <16 x i32>
...
; CHECK-NEXT:    [[TMP48:%.*]] = call i8 @llvm.vector.reduce.or.v16i8(<16 x i8> [[TMP45]])
; CHECK-NEXT:    [[TMP49:%.*]] = zext i8 [[TMP48]] to i32
...
; CHECK-NEXT:    [[BC_MERGE_RDX16:%.*]] = phi i32 [ [[TMP49]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[TMP52]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_SCEVCHECK]] ], [ 0, %[[ITER_CHECK]] ]
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[VEC_EPILOG_SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; CHECK-NEXT:    [[SUM:%.*]] = phi i32 [ [[BC_MERGE_RDX16]], %[[VEC_EPILOG_SCALAR_PH]] ], [ [[OR:%.*]], %[[LOOP]] ]
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[OR_LCSSA:%.*]] = phi i32 [ [[OR]], %[[LOOP]] ], [ [[TMP52]], %[[MIDDLE_BLOCK]] ], [ [[TMP49]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ]
