...
; VF2-NEXT:    [[TMP5:%.*]] = shl nuw nsw i64 [[INDEX]], 4
; VF2-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 16, [[TMP5]]
...
; VF2IC2-NEXT:    [[TMP5:%.*]] = shl nuw nsw i64 [[INDEX]], 4
; VF2IC2-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 16, [[TMP5]]
...
; VF4-NEXT:    [[TMP5:%.*]] = shl nuw nsw i64 [[INDEX]], 4
; VF4-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 16, [[TMP5]]
...
; VF2:       [[VECTOR_BODY]]:
; VF2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; VF2-NEXT:    [[OFFSET_IDX:%.*]] = shl nuw nsw i64 [[INDEX]], 1
...
; VF2IC2:       [[VECTOR_BODY]]:
; VF2IC2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; VF2IC2-NEXT:    [[OFFSET_IDX:%.*]] = shl nuw nsw i64 [[INDEX]], 1
...
; VF4:       [[VECTOR_BODY]]:
; VF4-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; VF4-NEXT:    [[OFFSET_IDX:%.*]] = shl nuw nsw i64 [[INDEX]], 1
