...
; CHECK-NEXT:    [[TMP18:%.*]] = load i24, ptr [[TMP9]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP19:%.*]] = load i24, ptr [[TMP10]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i24, ptr [[TMP11]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i24, ptr [[TMP12]], align 4, !alias.scope [[META0]]
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i24> poison, i24 [[TMP18]], i64 0
; CHECK-NEXT:    [[TMP16:%.*]] = insertelement <4 x i24> [[TMP15]], i24 [[TMP19]], i64 1
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x i24> [[TMP16]], i24 [[TMP13]], i64 2
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <4 x i24> [[TMP17]], i24 [[TMP14]], i64 3
