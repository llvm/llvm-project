...
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF8:![0-9]+]], !llvm.loop [[LOOP6]]
...
; CHECK-V2-IC4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF9:![0-9]+]], !llvm.loop [[LOOP7]]
...
; CHECK-V1-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1:  [[FOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF5]], !llvm.loop [[LOOP10]]
; CHECK-V1-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[TMP6:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !prof [[PROF9:![0-9]+]], !llvm.loop [[LOOP10:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI4:  [[MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[VEC_EPILOG_ITER_CHECK:.*]], !prof [[PROF9]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_ITER_CHECK]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[MIN_EPILOG_ITERS_CHECK:%.*]], label %[[VEC_EPILOG_SCALAR_PH]], label %[[VEC_EPILOG_PH]], !prof [[PROF11:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_PH]]:
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[TMP9:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[CMP_N7:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF7]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[FOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF8]], !llvm.loop [[LOOP12]]
; CHECK-V1-IC1-FORCE-EPI4:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V2-IC1:  [[FOR_BODY]]:
; CHECK-V2-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF6]], !llvm.loop [[LOOP12]]
; CHECK-V2-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC4:    br label %[[VECTOR_BODY:.*]]
; CHECK-V2-IC4:  [[VECTOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[TMP8:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !prof [[PROF5]], !llvm.loop [[LOOP10:![0-9]+]]
; CHECK-V2-IC4:  [[MIDDLE_BLOCK]]:
; CHECK-V2-IC4:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[VEC_EPILOG_ITER_CHECK:.*]], !prof [[PROF1]]
; CHECK-V2-IC4:  [[VEC_EPILOG_ITER_CHECK]]:
; CHECK-V2-IC4:    br i1 [[MIN_EPILOG_ITERS_CHECK:%.*]], label %[[VEC_EPILOG_SCALAR_PH]], label %[[VEC_EPILOG_PH]], !prof [[PROF11:![0-9]+]]
; CHECK-V2-IC4:  [[VEC_EPILOG_PH]]:
; CHECK-V2-IC4:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V2-IC4:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[TMP11:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK-V2-IC4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V2-IC4:    br i1 [[CMP_N10:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]], !prof [[PROF13:![0-9]+]]
; CHECK-V2-IC4:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V2-IC4:    br label %[[FOR_BODY:.*]]
; CHECK-V2-IC4:  [[FOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !prof [[PROF9]], !llvm.loop [[LOOP12]]
; CHECK-V2-IC4:  [[FOR_COND_CLEANUP]]:
;
entry:
  br label %for.body
...
; CHECK-V1-IC1:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1:  [[VECTOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[TMP6:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK-V1-IC1:  [[MIDDLE_BLOCK]]:
; CHECK-V1-IC1:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[SCALAR_PH]]
; CHECK-V1-IC1:  [[SCALAR_PH]]:
; CHECK-V1-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1:  [[FOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP13:![0-9]+]]
; CHECK-V1-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[TMP6:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP13:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI4:  [[MIDDLE_BLOCK]]:
...
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[TMP9:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_MIDDLE_BLOCK]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[CMP_N7:%.*]], label %[[FOR_COND_CLEANUP]], label %[[VEC_EPILOG_SCALAR_PH]]
; CHECK-V1-IC1-FORCE-EPI4:  [[VEC_EPILOG_SCALAR_PH]]:
; CHECK-V1-IC1-FORCE-EPI4:    br label %[[FOR_BODY:.*]]
; CHECK-V1-IC1-FORCE-EPI4:  [[FOR_BODY]]:
; CHECK-V1-IC1-FORCE-EPI4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP14]]
; CHECK-V1-IC1-FORCE-EPI4:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC1:    br label %[[VECTOR_BODY:.*]]
; CHECK-V2-IC1:  [[VECTOR_BODY]]:
; CHECK-V2-IC1:    br i1 [[TMP2:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP13:![0-9]+]]
; CHECK-V2-IC1:  [[MIDDLE_BLOCK]]:
; CHECK-V2-IC1:    br i1 [[CMP_N:%.*]], label %[[FOR_COND_CLEANUP:.*]], label %[[SCALAR_PH]]
; CHECK-V2-IC1:  [[SCALAR_PH]]:
; CHECK-V2-IC1:    br label %[[FOR_BODY:.*]]
; CHECK-V2-IC1:  [[FOR_BODY]]:
; CHECK-V2-IC1:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; CHECK-V2-IC1:  [[FOR_COND_CLEANUP]]:
;
...
; CHECK-V2-IC4:    br label %[[VECTOR_BODY:.*]]
; CHECK-V2-IC4:  [[VECTOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[TMP8:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; CHECK-V2-IC4:  [[MIDDLE_BLOCK]]:
...
; CHECK-V2-IC4:    br label %[[FOR_BODY:.*]]
; CHECK-V2-IC4:  [[FOR_BODY]]:
; CHECK-V2-IC4:    br i1 [[EXITCOND:%.*]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP15]]
; CHECK-V2-IC4:  [[FOR_COND_CLEANUP]]:
;
entry:
  br label %for.body
...
; CHECK-V1-IC1: [[LOOP10]] = distinct !{[[LOOP10]], [[META3]], [[META2]]}
; CHECK-V1-IC1: [[PROF11]] = !{!"branch_weights", i32 1, i32 15}
; CHECK-V1-IC1: [[LOOP12]] = distinct !{[[LOOP12]], [[META2]], [[META3]]}
; CHECK-V1-IC1: [[LOOP13]] = distinct !{[[LOOP13]], [[META3]], [[META2]]}
;.
...
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP6]] = distinct !{[[LOOP6]], [[META3]], [[META2]]}
; CHECK-V1-IC1-FORCE-EPI4: [[PROF7]] = !{!"branch_weights", i32 1, i32 3}
; CHECK-V1-IC1-FORCE-EPI4: [[PROF8]] = !{!"branch_weights", i32 0, i32 0}
; CHECK-V1-IC1-FORCE-EPI4: [[PROF9]] = !{!"branch_weights", i32 1, i32 31}
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP10]] = distinct !{[[LOOP10]], [[META2]], [[META3]]}
; CHECK-V1-IC1-FORCE-EPI4: [[PROF11]] = !{!"branch_weights", i32 4, i32 28}
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP12]] = distinct !{[[LOOP12]], [[META3]], [[META2]]}
...
; CHECK-V2-IC1: [[LOOP12]] = distinct !{[[LOOP12]], [[META4]], [[META3]]}
; CHECK-V2-IC1: [[LOOP13]] = distinct !{[[LOOP13]], [[META3]], [[META4]]}
; CHECK-V2-IC1: [[LOOP14]] = distinct !{[[LOOP14]], [[META4]], [[META3]]}
;.
...
; CHECK-V2-IC4: [[LOOP10]] = distinct !{[[LOOP10]], [[META3]], [[META4]]}
; CHECK-V2-IC4: [[PROF11]] = !{!"branch_weights", i32 8, i32 56}
; CHECK-V2-IC4: [[LOOP12]] = distinct !{[[LOOP12]], [[META4]], [[META3]]}
; CHECK-V2-IC4: [[PROF13]] = !{!"branch_weights", i32 1, i32 7}
; CHECK-V2-IC4: [[LOOP14]] = distinct !{[[LOOP14]], [[META3]], [[META4]]}
