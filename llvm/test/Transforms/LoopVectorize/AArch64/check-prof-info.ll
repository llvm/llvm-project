...
; CHECK-V1-IC1:    br label %[[VECTOR_BODY:.*]]
; CHECK-V1-IC1:  [[VECTOR_BODY]]:
; CHECK-V1-IC1:    br i1 [[TMP8:%.*]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !prof [[PROF9:![0-9]+]], !llvm.loop [[LOOP10:![0-9]+]]
; CHECK-V1-IC1:  [[MIDDLE_BLOCK]]:
...
; CHECK-V1-IC1:    br i1 [[TMP15:%.*]], label %[[VEC_EPILOG_MIDDLE_BLOCK:.*]], label %[[VEC_EPILOG_VECTOR_BODY]], !llvm.loop [[LOOP13:![0-9]+]]
...
; CHECK-V1-IC1: [[LOOP13]] = distinct !{[[LOOP13]], [[META8]], [[META2]], [[META3]]}
; CHECK-V1-IC1: [[PROF14]] = !{!"branch_weights", i32 1, i32 15}
; CHECK-V1-IC1: [[LOOP15]] = distinct !{[[LOOP15]], [[META8]], [[META3]], [[META2]]}
;.
...
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP7]] = distinct !{[[LOOP7]], [[META8:![0-9]+]], [[META2]], [[META3]]}
...
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP11]] = distinct !{[[LOOP11]], [[META8]], [[META3]], [[META2]]}
...
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP16]] = distinct !{[[LOOP16]], [[META8]], [[META2]], [[META3]]}
; CHECK-V1-IC1-FORCE-EPI4: [[LOOP17]] = distinct !{[[LOOP17]], [[META8]], [[META3]], [[META2]]}
;.
...
; CHECK-V2-IC1: [[LOOP15]] = distinct !{[[LOOP15]], [[META9]], [[META3]], [[META4]]}
; CHECK-V2-IC1: [[LOOP16]] = distinct !{[[LOOP16]], [[META9]], [[META4]], [[META3]]}
;.
...
; CHECK-V2-IC4: [[LOOP16]] = distinct !{[[LOOP16]], [[META9]], [[META3]], [[META4]]}
; CHECK-V2-IC4: [[PROF17]] = !{!"branch_weights", i32 1, i32 7}
; CHECK-V2-IC4: [[LOOP18]] = distinct !{[[LOOP18]], [[META9]], [[META4]], [[META3]]}
;.
