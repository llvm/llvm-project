...
; INTERLEAVE-NEXT:    [[TMP15:%.*]] = extractelement <vscale x 2 x i1> [[ACTIVE_LANE_MASK_NEXT6]], i64 0
; INTERLEAVE-NEXT:    br i1 [[TMP15]], label [[VECTOR_BODY]], label [[FOR_COND_CLEANUP:%.*]], !llvm.loop [[LOOP0:![0-9]+]]
...
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_NEXT6]] = call <vscale x 2 x i1> @llvm.vector.extract.nxv2i1.nxv4i1(<vscale x 4 x i1> [[ACTIVE_LANE_MASK_NEXT]], i64 0)
; INTERLEAVE-NEXT:    [[TMP15:%.*]] = extractelement <vscale x 2 x i1> [[ACTIVE_LANE_MASK_NEXT6]], i64 0
; INTERLEAVE-NEXT:    br i1 [[TMP15]], label [[VECTOR_BODY]], label [[FOR_COND_CLEANUP:%.*]], !llvm.loop [[LOOP3:![0-9]+]]
; INTERLEAVE:       for.cond.cleanup:
; INTERLEAVE-NEXT:    ret void
;
entry:
...
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_ENTRY1:%.*]] = shufflevector <2 x i1> [[ACTIVE_LANE_MASK_ENTRY]], <2 x i1> poison, <1 x i32> <i32 1>
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_ENTRY2:%.*]] = shufflevector <2 x i1> [[ACTIVE_LANE_MASK_ENTRY]], <2 x i1> poison, <1 x i32> zeroinitializer
; INTERLEAVE-NEXT:    br label [[VECTOR_BODY:%.*]]
; INTERLEAVE:       vector.body:
; INTERLEAVE-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[ENTRY:%.*]] ], [ [[INDEX_NEXT:%.*]], [[PRED_STORE_CONTINUE5:%.*]] ]
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = phi <1 x i1> [ [[ACTIVE_LANE_MASK_ENTRY2]], [[ENTRY]] ], [ [[ACTIVE_LANE_MASK_NEXT7:%.*]], [[PRED_STORE_CONTINUE5]] ]
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK3:%.*]] = phi <1 x i1> [ [[ACTIVE_LANE_MASK_ENTRY1]], [[ENTRY]] ], [ [[ACTIVE_LANE_MASK_NEXT6:%.*]], [[PRED_STORE_CONTINUE5]] ]
; INTERLEAVE-NEXT:    [[TMP1:%.*]] = extractelement <1 x i1> [[ACTIVE_LANE_MASK]], i64 0
; INTERLEAVE-NEXT:    br i1 [[TMP1]], label [[PRED_STORE_IF:%.*]], label [[PRED_STORE_CONTINUE:%.*]]
...
; INTERLEAVE-NEXT:    [[TMP6:%.*]] = extractelement <1 x i1> [[ACTIVE_LANE_MASK3]], i64 0
; INTERLEAVE-NEXT:    br i1 [[TMP6]], label [[PRED_STORE_IF4:%.*]], label [[PRED_STORE_CONTINUE5]]
; INTERLEAVE:       pred.store.if4:
; INTERLEAVE-NEXT:    [[TMP7:%.*]] = or disjoint i64 [[INDEX]], 1
; INTERLEAVE-NEXT:    [[TMP8:%.*]] = getelementptr double, ptr [[SRC]], i64 [[TMP7]]
; INTERLEAVE-NEXT:    [[TMP9:%.*]] = load double, ptr [[TMP8]], align 8
; INTERLEAVE-NEXT:    [[TMP10:%.*]] = call double @foo(double [[TMP9]], i64 [[TMP7]]) #[[ATTR5]]
; INTERLEAVE-NEXT:    [[TMP11:%.*]] = getelementptr inbounds double, ptr [[DST]], i64 [[TMP7]]
; INTERLEAVE-NEXT:    store double [[TMP10]], ptr [[TMP11]], align 8
; INTERLEAVE-NEXT:    br label [[PRED_STORE_CONTINUE5]]
; INTERLEAVE:       pred.store.continue5:
...
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_NEXT6]] = shufflevector <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], <2 x i1> poison, <1 x i32> <i32 1>
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_NEXT7]] = shufflevector <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], <2 x i1> poison, <1 x i32> zeroinitializer
; INTERLEAVE-NEXT:    [[TMP12:%.*]] = extractelement <2 x i1> [[ACTIVE_LANE_MASK_NEXT]], i64 0
; INTERLEAVE-NEXT:    br i1 [[TMP12]], label [[VECTOR_BODY]], label [[FOR_COND_CLEANUP:%.*]], !llvm.loop [[LOOP4:![0-9]+]]
; INTERLEAVE:       for.cond.cleanup:
; INTERLEAVE-NEXT:    ret void
;
entry:
