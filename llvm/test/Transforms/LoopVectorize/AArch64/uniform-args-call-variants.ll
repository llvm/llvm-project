...
; INTERLEAVE-NEXT:    [[TMP3:%.*]] = sub i64 [[N]], [[TMP2]]
; INTERLEAVE-NEXT:    [[TMP4:%.*]] = icmp ugt i64 [[N]], [[TMP2]]
; INTERLEAVE-NEXT:    [[TMP5:%.*]] = select i1 [[TMP4]], i64 [[TMP3]], i64 0
...
; INTERLEAVE-NEXT:    [[TMP6:%.*]] = getelementptr double, ptr [[SRC]], i64 [[INDEX]]
; INTERLEAVE-NEXT:    [[TMP7:%.*]] = getelementptr double, ptr [[TMP6]], i64 [[TMP1]]
; INTERLEAVE-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <vscale x 2 x double> @llvm.masked.load.nxv2f64.p0(ptr align 8 [[TMP6]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK]], <vscale x 2 x double> poison)
; INTERLEAVE-NEXT:    [[WIDE_MASKED_LOAD3:%.*]] = call <vscale x 2 x double> @llvm.masked.load.nxv2f64.p0(ptr align 8 [[TMP7]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK2]], <vscale x 2 x double> poison)
...
; INTERLEAVE-NEXT:    [[TMP11:%.*]] = getelementptr inbounds double, ptr [[TMP10]], i64 [[TMP1]]
; INTERLEAVE-NEXT:    call void @llvm.masked.store.nxv2f64.p0(<vscale x 2 x double> [[TMP8]], ptr align 8 [[TMP10]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK]])
; INTERLEAVE-NEXT:    call void @llvm.masked.store.nxv2f64.p0(<vscale x 2 x double> [[TMP9]], ptr align 8 [[TMP11]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK2]])
; INTERLEAVE-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], [[TMP2]]
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK_NEXT:%.*]] = call <vscale x 4 x i1> @llvm.get.active.lane.mask.nxv4i1.i64(i64 [[INDEX]], i64 [[TMP5]])
...
; INTERLEAVE-NEXT:    [[TMP12:%.*]] = extractelement <vscale x 2 x i1> [[EXTRACT_NEXT_ALM_PART]], i64 0
; INTERLEAVE-NEXT:    [[TMP13:%.*]] = xor i1 [[TMP12]], true
; INTERLEAVE-NEXT:    br i1 [[TMP13]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
...
; INTERLEAVE-NEXT:    [[TMP12:%.*]] = extractelement <vscale x 2 x i1> [[EXTRACT_NEXT_ALM_PART]], i64 0
; INTERLEAVE-NEXT:    [[TMP13:%.*]] = xor i1 [[TMP12]], true
; INTERLEAVE-NEXT:    br i1 [[TMP13]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; INTERLEAVE:       middle.block:
; INTERLEAVE-NEXT:    br label [[FOR_COND_CLEANUP:%.*]]
; INTERLEAVE:       for.cond.cleanup:
; INTERLEAVE-NEXT:    ret void
...
; INTERLEAVE-NEXT:    [[TMP2:%.*]] = sub i64 [[N]], 2
; INTERLEAVE-NEXT:    [[TMP3:%.*]] = icmp ugt i64 [[N]], 2
; INTERLEAVE-NEXT:    [[TMP4:%.*]] = select i1 [[TMP3]], i64 [[TMP2]], i64 0
; INTERLEAVE-NEXT:    br label [[VECTOR_BODY:%.*]]
; INTERLEAVE:       vector.body:
; INTERLEAVE-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[PRED_STORE_CONTINUE3:%.*]] ]
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = phi i1 [ [[TMP0]], [[VECTOR_PH]] ], [ [[TMP14:%.*]], [[PRED_STORE_CONTINUE3]] ]
; INTERLEAVE-NEXT:    [[ACTIVE_LANE_MASK1:%.*]] = phi i1 [ [[TMP1]], [[VECTOR_PH]] ], [ [[TMP16:%.*]], [[PRED_STORE_CONTINUE3]] ]
...
; INTERLEAVE-NEXT:    [[TMP7:%.*]] = call double @foo(double [[TMP6]], i64 [[INDEX]]) #[[ATTR4:[0-9]+]]
...
; INTERLEAVE-NEXT:    br i1 [[ACTIVE_LANE_MASK1]], label [[PRED_STORE_IF2:%.*]], label [[PRED_STORE_CONTINUE3]]
; INTERLEAVE:       pred.store.if2:
; INTERLEAVE-NEXT:    [[TMP9:%.*]] = add i64 [[INDEX]], 1
; INTERLEAVE-NEXT:    [[TMP10:%.*]] = getelementptr double, ptr [[SRC]], i64 [[TMP9]]
; INTERLEAVE-NEXT:    [[TMP11:%.*]] = load double, ptr [[TMP10]], align 8
; INTERLEAVE-NEXT:    [[TMP12:%.*]] = call double @foo(double [[TMP11]], i64 [[TMP9]]) #[[ATTR4]]
; INTERLEAVE-NEXT:    [[TMP13:%.*]] = getelementptr inbounds double, ptr [[DST]], i64 [[TMP9]]
; INTERLEAVE-NEXT:    store double [[TMP12]], ptr [[TMP13]], align 8
; INTERLEAVE-NEXT:    br label [[PRED_STORE_CONTINUE3]]
; INTERLEAVE:       pred.store.continue3:
; INTERLEAVE-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 2
; INTERLEAVE-NEXT:    [[TMP14]] = icmp ult i64 [[INDEX]], [[TMP4]]
; INTERLEAVE-NEXT:    [[TMP15:%.*]] = add i64 [[INDEX]], 1
; INTERLEAVE-NEXT:    [[TMP16]] = icmp ult i64 [[TMP15]], [[TMP4]]
; INTERLEAVE-NEXT:    [[TMP17:%.*]] = xor i1 [[TMP14]], true
; INTERLEAVE-NEXT:    br i1 [[TMP17]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; INTERLEAVE:       middle.block:
; INTERLEAVE-NEXT:    br label [[FOR_COND_CLEANUP:%.*]]
; INTERLEAVE:       for.cond.cleanup:
; INTERLEAVE-NEXT:    ret void
