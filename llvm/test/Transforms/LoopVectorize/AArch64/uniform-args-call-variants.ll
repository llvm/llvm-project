...
; RUN: opt < %s -passes=loop-vectorize,simplifycfg,instcombine -force-vector-interleave=2 -tail-folding-policy=must-fold-tail -S | FileCheck %s --check-prefix=INTERLEAVE
