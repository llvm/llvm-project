...
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x float> poison, float [[TMP0]], i64 0
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <4 x float> [[TMP86]], float [[TMP33]], i64 1
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <4 x float> [[TMP87]], float [[TMP34]], i64 2
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x float> [[TMP88]], float [[TMP35]], i64 3
...
; CHECK-NEXT:    [[TMP94:%.*]] = insertelement <4 x float> poison, float [[TMP40]], i64 0
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <4 x float> [[TMP94]], float [[TMP41]], i64 1
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <4 x float> [[TMP95]], float [[TMP42]], i64 2
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <4 x float> [[TMP96]], float [[TMP43]], i64 3
...
; CHECK-NEXT:    [[TMP128:%.*]] = insertelement <4 x float> poison, float [[TMP220]], i64 0
; CHECK-NEXT:    [[TMP129:%.*]] = insertelement <4 x float> [[TMP128]], float [[TMP221]], i64 1
; CHECK-NEXT:    [[TMP130:%.*]] = insertelement <4 x float> [[TMP129]], float [[TMP222]], i64 2
; CHECK-NEXT:    [[TMP235:%.*]] = insertelement <4 x float> [[TMP130]], float [[TMP231]], i64 3
...
; CHECK-NEXT:    [[TMP136:%.*]] = insertelement <4 x float> poison, float [[TMP236]], i64 0
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <4 x float> [[TMP136]], float [[TMP237]], i64 1
; CHECK-NEXT:    [[TMP138:%.*]] = insertelement <4 x float> [[TMP137]], float [[TMP238]], i64 2
; CHECK-NEXT:    [[TMP251:%.*]] = insertelement <4 x float> [[TMP138]], float [[TMP247]], i64 3
...
; CHECK-NEXT:    [[TMP232:%.*]] = insertelement <4 x float> poison, float [[TMP82]], i64 0
; CHECK-NEXT:    [[TMP233:%.*]] = insertelement <4 x float> [[TMP232]], float [[TMP83]], i64 1
; CHECK-NEXT:    [[TMP234:%.*]] = insertelement <4 x float> [[TMP233]], float [[TMP84]], i64 2
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x float> [[TMP234]], float [[TMP85]], i64 3
...
; CHECK-NEXT:    [[TMP248:%.*]] = insertelement <4 x float> poison, float [[TMP90]], i64 0
; CHECK-NEXT:    [[TMP249:%.*]] = insertelement <4 x float> [[TMP248]], float [[TMP91]], i64 1
; CHECK-NEXT:    [[TMP250:%.*]] = insertelement <4 x float> [[TMP249]], float [[TMP92]], i64 2
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <4 x float> [[TMP250]], float [[TMP93]], i64 3
...
; CHECK-NEXT:    [[TMP329:%.*]] = insertelement <4 x float> poison, float [[TMP124]], i64 0
; CHECK-NEXT:    [[TMP384:%.*]] = insertelement <4 x float> [[TMP329]], float [[TMP125]], i64 1
; CHECK-NEXT:    [[TMP385:%.*]] = insertelement <4 x float> [[TMP384]], float [[TMP126]], i64 2
; CHECK-NEXT:    [[TMP131:%.*]] = insertelement <4 x float> [[TMP385]], float [[TMP127]], i64 3
...
; CHECK-NEXT:    [[TMP386:%.*]] = insertelement <4 x float> poison, float [[TMP132]], i64 0
; CHECK-NEXT:    [[TMP387:%.*]] = insertelement <4 x float> [[TMP386]], float [[TMP133]], i64 1
; CHECK-NEXT:    [[TMP388:%.*]] = insertelement <4 x float> [[TMP387]], float [[TMP134]], i64 2
; CHECK-NEXT:    [[TMP139:%.*]] = insertelement <4 x float> [[TMP388]], float [[TMP135]], i64 3
