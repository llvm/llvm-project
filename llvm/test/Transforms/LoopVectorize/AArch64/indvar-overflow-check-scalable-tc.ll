...
; RUN: opt -passes=loop-vectorize -force-tail-folding-style=data -tail-folding-policy=prefer-fold-tail -force-vector-width=4 -force-vector-interleave=1 -scalable-vectorization=off -S %s | FileCheck %s
