...
; CHECK-NEON-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[WIDE_TRIP_COUNT]], 8
; CHECK-NEON-NEXT:    br i1 [[MIN_ITERS_CHECK]], label [[SCALAR_PH:%.*]], label [[VECTOR_PH:%.*]]
; CHECK-NEON:       vector.ph:
; CHECK-NEON-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[WIDE_TRIP_COUNT]], 8
...
; CHECK-NEON-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP9:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEON-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i8>, ptr [[TMP1]], align 1
; CHECK-NEON-NEXT:    [[WIDE_LOAD1:%.*]] = load <8 x i8>, ptr [[TMP2]], align 1
; CHECK-NEON-NEXT:    [[WIDE_LOAD2:%.*]] = load <8 x i8>, ptr [[TMP3]], align 1
; CHECK-NEON-NEXT:    [[TMP10:%.*]] = sext <8 x i8> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP4:%.*]] = sext <8 x i8> [[WIDE_LOAD1]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP5:%.*]] = sext <8 x i8> [[WIDE_LOAD2]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP6:%.*]] = mul nsw <8 x i32> [[TMP10]], [[TMP4]]
; CHECK-NEON-NEXT:    [[TMP7:%.*]] = add <8 x i32> [[VEC_PHI]], [[TMP6]]
; CHECK-NEON-NEXT:    [[TMP8:%.*]] = mul nsw <8 x i32> [[TMP10]], [[TMP5]]
; CHECK-NEON-NEXT:    [[TMP9]] = sub <8 x i32> [[TMP7]], [[TMP8]]
; CHECK-NEON-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 8
...
; CHECK-NEON-NEXT:    [[TMP11:%.*]] = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[TMP9]])
...
; CHECK-NEON-NEXT:    [[TMP5:%.*]] = sext <8 x i8> [[WIDE_LOAD2]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP6:%.*]] = mul nsw <8 x i32> [[TMP10]], [[TMP4]]
; CHECK-NEON-NEXT:    [[TMP7:%.*]] = sub <8 x i32> [[VEC_PHI]], [[TMP6]]
; CHECK-NEON-NEXT:    [[TMP8:%.*]] = mul nsw <8 x i32> [[TMP10]], [[TMP5]]
; CHECK-NEON-NEXT:    [[TMP9]] = add <8 x i32> [[TMP7]], [[TMP8]]
; CHECK-NEON-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 8
; CHECK-NEON-NEXT:    [[TMP14:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
...
; CHECK-NEON:       vector.body:
; CHECK-NEON-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEON-NEXT:    [[VEC_PHI:%.*]] = phi <8 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP11:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEON-NEXT:    [[TMP1:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[INDEX]]
; CHECK-NEON-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[INDEX]]
; CHECK-NEON-NEXT:    [[TMP3:%.*]] = getelementptr inbounds nuw i8, ptr [[C]], i64 [[INDEX]]
; CHECK-NEON-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i8>, ptr [[TMP1]], align 1
; CHECK-NEON-NEXT:    [[WIDE_LOAD1:%.*]] = load <8 x i8>, ptr [[TMP2]], align 1
; CHECK-NEON-NEXT:    [[WIDE_LOAD2:%.*]] = load <8 x i8>, ptr [[TMP3]], align 1
; CHECK-NEON-NEXT:    [[TMP12:%.*]] = sext <8 x i8> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP4:%.*]] = sext <8 x i8> [[WIDE_LOAD1]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP5:%.*]] = sext <8 x i8> [[WIDE_LOAD2]] to <8 x i32>
; CHECK-NEON-NEXT:    [[TMP6:%.*]] = mul nsw <8 x i32> [[TMP12]], [[TMP4]]
; CHECK-NEON-NEXT:    [[TMP7:%.*]] = sub <8 x i32> [[VEC_PHI]], [[TMP6]]
; CHECK-NEON-NEXT:    [[TMP8:%.*]] = mul nsw <8 x i32> [[TMP12]], [[TMP5]]
; CHECK-NEON-NEXT:    [[TMP9:%.*]] = add <8 x i32> [[TMP7]], [[TMP8]]
; CHECK-NEON-NEXT:    [[TMP10:%.*]] = mul nsw <8 x i32> [[TMP4]], [[TMP5]]
; CHECK-NEON-NEXT:    [[TMP11]] = sub <8 x i32> [[TMP9]], [[TMP10]]
; CHECK-NEON-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 8
...
; CHECK-NEON:       middle.block:
; CHECK-NEON-NEXT:    [[TMP13:%.*]] = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> [[TMP11]])
; CHECK-NEON-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[WIDE_TRIP_COUNT]], [[N_VEC]]
; CHECK-NEON-NEXT:    br i1 [[CMP_N]], label [[FOR_COND_CLEANUP:%.*]], label [[SCALAR_PH]]
; CHECK-NEON:       scalar.ph:
;
