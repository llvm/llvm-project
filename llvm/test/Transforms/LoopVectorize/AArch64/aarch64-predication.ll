...
; RUN: opt < %s -passes=loop-vectorize,instcombine -force-vector-interleave=1 -force-vector-width=2 -S | FileCheck %s
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP16:%.*]], %[[PRED_UDIV_CONTINUE2]] ]
...
; CHECK-NEXT:    [[TMP6:%.*]] = udiv i64 [[TMP3]], [[TMP4]]
...
; CHECK-NEXT:    [[TMP13:%.*]] = udiv i64 [[TMP10]], [[TMP11]]
