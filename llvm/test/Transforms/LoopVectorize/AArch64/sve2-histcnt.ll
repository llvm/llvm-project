...
; CHECK-NEXT:    [[TMP18:%.*]] = shl nsw i64 [[INDEX4]], 2
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP18]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP2]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = zext <vscale x 4 x i32> [[WIDE_LOAD]] to <vscale x 4 x i64>
; CHECK-NEXT:    [[TMP6:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP9]], splat (i64 2)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP6]]
