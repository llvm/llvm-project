...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP6]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP9]], splat (i64 2)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP7]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = shl nsw <vscale x 4 x i64> [[TMP9]], splat (i64 2)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP7]]
; CHECK-NEXT:    call void @llvm.experimental.vector.histogram.add.nxv4p0.i32(<vscale x 4 x ptr> [[TMP10]], i32 -1, <vscale x 4 x i1> splat (i1 true))
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP5]]
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = shl nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP11]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 4 x i32>, ptr [[TMP8]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = zext <vscale x 4 x i32> [[WIDE_LOAD]] to <vscale x 4 x i64>
; CHECK-NEXT:    [[TMP7:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP9]], splat (i64 2)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP7]]
; CHECK-NEXT:    [[TMP15:%.*]] = shl nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[CONDS]], i64 [[TMP15]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = shl nsw i64 [[IV]], 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[DOTNOT1:%.*]] = sub nsw i64 0, [[TMP13]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = shl nsw i64 [[INDEX4]], 2
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP14]]
; CHECK-NEXT:    [[WIDE_LOAD5:%.*]] = load <vscale x 8 x i32>, ptr [[TMP15]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = zext <vscale x 8 x i32> [[WIDE_LOAD5]] to <vscale x 8 x i64>
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 8 x i64> [[TMP16]]
; CHECK-NEXT:    call void @llvm.experimental.vector.histogram.add.nxv8p0.i8(<vscale x 8 x ptr> [[TMP20]], i8 1, <vscale x 8 x i1> splat (i1 true))
; CHECK-NEXT:    [[INDEX_NEXT6]] = add nuw i64 [[INDEX4]], [[TMP13]]
; CHECK-NEXT:    [[TMP18:%.*]] = icmp eq i64 [[INDEX_NEXT6]], [[N_VEC3]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[IV1]], 2
; CHECK-NEXT:    [[GEP_INDICES:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP19]]
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[INDICES]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[IDXPROM1:%.*]] = zext i32 [[TMP0]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = shl nuw nsw i64 [[IDXPROM1]], 2
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[BUCKETS]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[IV]], 2
; CHECK-NEXT:    [[INCIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[INCVALS]], i64 [[TMP2]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP9]], splat (i64 2)
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP12]]
; CHECK-NEXT:    [[TMP13:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP19]], splat (i64 2)
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP13]]
; CHECK-NEXT:    call void @llvm.experimental.vector.histogram.add.nxv4p0.i32(<vscale x 4 x ptr> [[TMP10]], i32 1, <vscale x 4 x i1> splat (i1 true))
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP6:%.*]] = shl nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr @idx_array, i64 [[TMP6]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = shl nsw <vscale x 4 x i64> [[TMP14]], splat (i64 2)
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr @data_array, <vscale x 4 x i64> [[TMP7]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP9]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = shl nsw <vscale x 4 x i64> [[TMP6]], splat (i64 2)
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr [[DOTSPLIT]], <vscale x 4 x i64> [[TMP10]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP10]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = shl nuw nsw <vscale x 4 x i64> [[TMP13]], splat (i64 2)
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 4 x i64> [[TMP17]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[ARRAY]], i64 [[TMP18]]
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[INDICES]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP12:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[IDXPROM1:%.*]] = zext i32 [[TMP12]] to i64
; CHECK-NEXT:    [[TMP1:%.*]] = shl nuw nsw i64 [[IDXPROM1]], 2
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[BUCKETS]], i64 [[TMP1]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[INDICES]], i64 [[TMP8]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 2 x i64>, ptr [[TMP5]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = shl nsw <vscale x 2 x i64> [[WIDE_LOAD]], splat (i64 3)
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr [[BUCKETS]], <vscale x 2 x i64> [[TMP9]]
...
; CHECK:       for.body:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ 0, [[ENTRY:%.*]] ], [ [[IV_NEXT:%.*]], [[FOR_BODY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = shl i64 [[IV]], 22
; CHECK-NEXT:    [[GEP_INDICES:%.*]] = getelementptr i8, ptr [[INDICES]], i64 [[TMP0]]
; CHECK-NEXT:    [[L_IDX:%.*]] = load i32, ptr [[GEP_INDICES]], align 4
; CHECK-NEXT:    [[IDXPROM5:%.*]] = sext i32 [[L_IDX]] to i64
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[IDXPROM5]], 22
; CHECK-NEXT:    [[GEP_BUCKET:%.*]] = getelementptr i8, ptr [[DATA_ARRAY]], i64 [[TMP1]]
