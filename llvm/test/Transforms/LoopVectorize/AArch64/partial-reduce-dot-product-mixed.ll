...
; CHECK-NOI8MM-NEXT:    [[VEC_PHI1:%.*]] = phi <16 x i32> [ zeroinitializer, [[VECTOR_PH]] ], [ [[TMP16:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NOI8MM-NEXT:    [[TMP16]] = add <16 x i32> [[TMP11]], [[VEC_PHI1]]
...
; CHECK-NOI8MM-NEXT:    [[BIN_RDX:%.*]] = add <16 x i32> [[TMP16]], [[TMP12]]
