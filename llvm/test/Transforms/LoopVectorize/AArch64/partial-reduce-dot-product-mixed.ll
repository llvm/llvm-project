...
; CHECK-NOI8MM-NEXT:    [[TMP17:%.*]] = mul <16 x i32> [[TMP10]], [[TMP4]]
; CHECK-NOI8MM-NEXT:    [[TMP16:%.*]] = mul <16 x i32> [[TMP15]], [[TMP11]]
; CHECK-NOI8MM-NEXT:    [[TMP12]] = add <16 x i32> [[TMP17]], [[VEC_PHI]]
; CHECK-NOI8MM-NEXT:    [[TMP13]] = add <16 x i32> [[TMP16]], [[VEC_PHI1]]
...
; CHECK-NOI8MM-NEXT:    [[TMP18:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[BIN_RDX]])
