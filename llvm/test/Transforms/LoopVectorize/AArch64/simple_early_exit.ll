...
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP]], label [[LOOP_END]], !llvm.loop [[LOOP4:![0-9]+]]
; CHECK:       loop.end:
...
; CHECK-NEXT:    br i1 [[CMP]], label [[FOR_BODY]], label [[EXIT]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK:       found:
...
; CHECK: [[LOOP12]] = distinct !{[[LOOP12]], [[META1]], [[META5]]}
;.
