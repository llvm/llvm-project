...
; PRED-NEXT:    [[TMP16:%.*]] = load i32, ptr [[A]], align 4, !alias.scope [[META0:![0-9]+]]
...
; PRED-NEXT:    [[TMP17:%.*]] = load i32, ptr [[B]], align 4, !alias.scope [[META3:![0-9]+]]
...
; PRED-NEXT:    [[TMP19:%.*]] = load i32, ptr [[C]], align 4, !alias.scope [[META5:![0-9]+]]
...
; PRED-NEXT:    call void @llvm.masked.scatter.nxv4i32.nxv4p0(<vscale x 4 x i32> [[TMP18]], <vscale x 4 x ptr> [[BROADCAST_SPLAT33]], i32 4, <vscale x 4 x i1> [[TMP21]]), !alias.scope [[META7:![0-9]+]], !noalias [[META9:![0-9]+]]
; PRED-NEXT:    [[TMP23:%.*]] = getelementptr i32, ptr [[TMP22]], i32 0
; PRED-NEXT:    call void @llvm.masked.store.nxv4i32.p0(<vscale x 4 x i32> zeroinitializer, ptr [[TMP23]], i32 4, <vscale x 4 x i1> [[TMP21]]), !alias.scope [[META11:![0-9]+]], !noalias [[META12:![0-9]+]]
...
; PRED-NEXT:    br i1 [[TMP25]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP13:![0-9]+]]
; PRED:       middle.block:
...
; PRED-NEXT:    br i1 [[C_1]], label [[EXIT]], label [[LOOP_HEADER]], !llvm.loop [[LOOP16:![0-9]+]]
; PRED:       exit:
; PRED-NEXT:    ret i32 0
;
entry:
...
; PRED-NEXT:    br i1 [[TMP17]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP17:![0-9]+]]
; PRED:       middle.block:
; PRED-NEXT:    br i1 true, label [[EXIT:%.*]], label [[SCALAR_PH]]
; PRED:       scalar.ph:
...
; PRED-NEXT:    br i1 [[EC]], label [[EXIT]], label [[LOOP]], !llvm.loop [[LOOP18:![0-9]+]]
; PRED:       exit:
; PRED-NEXT:    ret void
;
entry:
...
; DEFAULT-NEXT:    br i1 [[EC]], label [[EXIT]], label [[LOOP_HEADER]], !llvm.loop [[LOOP25:![0-9]+]]
; DEFAULT:       exit:
; DEFAULT-NEXT:    ret void
;
...
; PRED-NEXT:    br i1 [[EC]], label [[EXIT]], label [[LOOP_HEADER]], !llvm.loop [[LOOP20:![0-9]+]]
; PRED:       exit:
; PRED-NEXT:    ret void
;
entry:
...
; DEFAULT-NEXT:    br i1 [[TMP11]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP26:![0-9]+]]
; DEFAULT:       middle.block:
...
; DEFAULT: [[LOOP25]] = distinct !{[[LOOP25]], [[META1]]}
; DEFAULT: [[LOOP26]] = distinct !{[[LOOP26]], [[META1]], [[META2]]}
; DEFAULT: [[LOOP27]] = distinct !{[[LOOP27]], [[META2]], [[META1]]}
;.
; PRED: [[META0]] = !{[[META1:![0-9]+]]}
; PRED: [[META1]] = distinct !{[[META1]], [[META2:![0-9]+]]}
; PRED: [[META2]] = distinct !{[[META2]], !"LVerDomain"}
; PRED: [[META3]] = !{[[META4:![0-9]+]]}
; PRED: [[META4]] = distinct !{[[META4]], [[META2]]}
; PRED: [[META5]] = !{[[META6:![0-9]+]]}
; PRED: [[META6]] = distinct !{[[META6]], [[META2]]}
; PRED: [[META7]] = !{[[META8:![0-9]+]]}
; PRED: [[META8]] = distinct !{[[META8]], [[META2]]}
; PRED: [[META9]] = !{[[META10:![0-9]+]], [[META1]], [[META4]], [[META6]]}
; PRED: [[META10]] = distinct !{[[META10]], [[META2]]}
; PRED: [[META11]] = !{[[META10]]}
; PRED: [[META12]] = !{[[META1]], [[META4]], [[META6]]}
; PRED: [[LOOP13]] = distinct !{[[LOOP13]], [[META14:![0-9]+]], [[META15:![0-9]+]]}
; PRED: [[META14]] = !{!"llvm.loop.isvectorized", i32 1}
; PRED: [[META15]] = !{!"llvm.loop.unroll.runtime.disable"}
; PRED: [[LOOP16]] = distinct !{[[LOOP16]], [[META14]]}
; PRED: [[LOOP17]] = distinct !{[[LOOP17]], [[META14]], [[META15]]}
; PRED: [[LOOP18]] = distinct !{[[LOOP18]], [[META15]], [[META14]]}
; PRED: [[LOOP19]] = distinct !{[[LOOP19]], [[META14]], [[META15]]}
; PRED: [[LOOP20]] = distinct !{[[LOOP20]], [[META14]]}
; PRED: [[LOOP21]] = distinct !{[[LOOP21]], [[META14]], [[META15]]}
; PRED: [[LOOP22]] = distinct !{[[LOOP22]], [[META15]], [[META14]]}
;.
