...
; DEFAULT-NEXT:    [[TMP93:%.*]] = sub i64 [[TMP37]], 1
; DEFAULT-NEXT:    [[TMP6:%.*]] = sub i64 [[C1]], [[A2]]
; DEFAULT-NEXT:    [[TMP92:%.*]] = sub i64 [[TMP6]], 1
; DEFAULT-NEXT:    [[DIFF_CHECK:%.*]] = icmp ult i64 [[TMP92]], [[TMP93]]
; DEFAULT-NEXT:    [[TMP7:%.*]] = sub i64 [[C1]], [[B3]]
; DEFAULT-NEXT:    [[TMP94:%.*]] = sub i64 [[TMP7]], 1
; DEFAULT-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP94]], [[TMP93]]
