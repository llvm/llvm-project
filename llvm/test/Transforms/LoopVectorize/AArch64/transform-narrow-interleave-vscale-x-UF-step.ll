...
; RUN: opt -passes=loop-vectorize -force-vector-interleave=2 -force-vector-width="vscale x 2" -epilogue-vectorization-force-VF="vscale x 2" -S %s | FileCheck %s
...
define void @test(ptr noalias %A, i64 %v, i64 %n) "target-features"="+sve" {
