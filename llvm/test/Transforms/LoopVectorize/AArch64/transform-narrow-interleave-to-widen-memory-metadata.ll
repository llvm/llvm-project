...
; Members carry mismatched !tbaa; the narrowed wide load/store intersect to no
; !tbaa.
...
loop:
  ...
  %mul.2 = shl nsw i64 %iv, 1
  %data.0 = getelementptr inbounds i64, ptr %data, i64 %mul.2
  %l.0 = load i64, ptr %data.0, align 8, !tbaa !2
  store i64 %l.0, ptr %data.0, align 8, !tbaa !2
  %add.1 = or disjoint i64 %mul.2, 1
  %data.1 = getelementptr inbounds i64, ptr %data, i64 %add.1
  %l.1 = load i64, ptr %data.1, align 8, !tbaa !2
  store i64 %l.1, ptr %data.1, align 8, !tbaa !2
  %iv.next = add nuw nsw i64 %iv, 1
  %ec = icmp eq i64 %iv.next, 100
  br i1 %ec, label %exit, label %loop
