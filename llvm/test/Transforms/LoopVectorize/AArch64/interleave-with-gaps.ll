...
; CHECK-NOTF-NEXT:    [[N_VEC14:%.*]] = and i64 [[N]], -4
...
; CHECK-NOTF-NEXT:    [[BC_MERGE_RDX21:%.*]] = phi i32 [ [[TMP51]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[TMP44]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[ENTRY]] ]
...
; CHECK-NOTF-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK-NOTF:       [[VECTOR_PH]]:
; CHECK-NOTF-NEXT:    [[N_VEC:%.*]] = and i32 [[N]], -4
; CHECK-NOTF-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK-NOTF:       [[VECTOR_BODY]]:
...
; CHECK-NOTF-NEXT:    [[N_VEC25:%.*]] = and i64 [[TMP0]], -4
...
; CHECK-NOTF-NEXT:    [[BC_MERGE_RDX36:%.*]] = phi i32 [ [[TMP55]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[TMP45]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[LOOP_PREHEADER]] ]
; CHECK-NOTF-NEXT:    br label %[[LOOP1:.*]]
; CHECK-NOTF:       [[LOOP1]]:
...
; CHECK-NOTF-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK-NOTF:       [[VECTOR_PH]]:
; CHECK-NOTF-NEXT:    [[N_VEC:%.*]] = and i64 [[TMP0]], -4
