...
; CHECK-NEXT:    [[VEC_PHI2:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI8:%.*]], %[[LOOP_IF_SPLIT]] ]
; CHECK-NEXT:    [[VEC_PHI3:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI9:%.*]], %[[LOOP_IF_SPLIT]] ]
...
; CHECK-NEXT:    [[TMP10:%.*]] = freeze <vscale x 2 x i1> [[TMP8]]
; CHECK-NEXT:    [[TMP11:%.*]] = or <vscale x 2 x i1> [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[TMP32:%.*]] = freeze <vscale x 2 x i1> [[TMP27]]
; CHECK-NEXT:    [[TMP18:%.*]] = or <vscale x 2 x i1> [[TMP11]], [[TMP32]]
; CHECK-NEXT:    [[TMP19:%.*]] = freeze <vscale x 2 x i1> [[TMP30]]
; CHECK-NEXT:    [[TMP20:%.*]] = or <vscale x 2 x i1> [[TMP18]], [[TMP19]]
; CHECK-NEXT:    [[TMP17:%.*]] = call i1 @llvm.vector.reduce.or.nxv2i1(<vscale x 2 x i1> [[TMP20]])
...
; CHECK-NEXT:    [[TMP25:%.*]] = freeze <vscale x 2 x i1> [[TMP30]]
; CHECK-NEXT:    [[TMP26:%.*]] = or <vscale x 2 x i1> [[TMP15]], [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = freeze <vscale x 2 x i1> [[TMP31]]
; CHECK-NEXT:    [[TMP28:%.*]] = or <vscale x 2 x i1> [[TMP26]], [[TMP27]]
; CHECK-NEXT:    [[TMP16:%.*]] = call i1 @llvm.vector.reduce.or.nxv2i1(<vscale x 2 x i1> [[TMP28]])
