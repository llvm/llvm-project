...
; RUN:      | FileCheck %s
; RUN: opt -p loop-vectorize -S -mtriple aarch64-linux-gnu -mattr=+sve -prefer-control-flow %s \
; RUN:     -tail-folding-policy=must-fold-tail -force-tail-folding-style=data | FileCheck %s --check-prefixes=TF
...
; TF:       [[VECTOR_BODY]]:
; TF-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[LOOP_CONT2:.*]] ]
...
; TF-NEXT:    [[TMP7:%.*]] = freeze <vscale x 2 x i1> [[TMP5]]
; TF-NEXT:    [[TMP10:%.*]] = call i1 @llvm.vector.reduce.or.nxv2i1(<vscale x 2 x i1> [[TMP7]])
; TF-NEXT:    br i1 [[TMP10]], label %[[LOOP_IF1:.*]], label %[[LOOP_CONT2]]
; TF:       [[LOOP_IF1]]:
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nuw i64 [[TMP5]], 3
; CHECK-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], [[TMP1]]
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI1:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI3:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI2:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI8:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI3:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI9:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[ADDR]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP21:%.*]] = shl nuw nsw i64 [[TMP3]], 1
; CHECK-NEXT:    [[TMP22:%.*]] = mul nuw nsw i64 [[TMP3]], 3
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP22]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 2 x i64>, ptr [[TMP0]], align 8
; CHECK-NEXT:    [[WIDE_LOAD2:%.*]] = load <vscale x 2 x i64>, ptr [[TMP6]], align 8
; CHECK-NEXT:    [[WIDE_LOAD5:%.*]] = load <vscale x 2 x i64>, ptr [[TMP23]], align 8
; CHECK-NEXT:    [[WIDE_LOAD6:%.*]] = load <vscale x 2 x i64>, ptr [[TMP26]], align 8
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP8:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD2]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP27:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD5]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP30:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD6]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP13:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD]], splat (i64 1)
; CHECK-NEXT:    [[TMP14:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD2]], splat (i64 1)
; CHECK-NEXT:    [[TMP24:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD5]], splat (i64 1)
; CHECK-NEXT:    [[TMP25:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD6]], splat (i64 1)
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP13]], ptr align 8 [[TMP0]], <vscale x 2 x i1> [[TMP7]])
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP14]], ptr align 8 [[TMP6]], <vscale x 2 x i1> [[TMP8]])
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP24]], ptr align 8 [[TMP23]], <vscale x 2 x i1> [[TMP27]])
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP25]], ptr align 8 [[TMP26]], <vscale x 2 x i1> [[TMP30]])
; CHECK-NEXT:    [[TMP15:%.*]] = add <vscale x 2 x i64> [[VEC_PHI]], splat (i64 1)
; CHECK-NEXT:    [[TMP16:%.*]] = add <vscale x 2 x i64> [[VEC_PHI1]], splat (i64 1)
; CHECK-NEXT:    [[TMP28:%.*]] = add <vscale x 2 x i64> [[VEC_PHI2]], splat (i64 1)
; CHECK-NEXT:    [[TMP29:%.*]] = add <vscale x 2 x i64> [[VEC_PHI3]], splat (i64 1)
...
; CHECK-NEXT:    [[PREDPHI8]] = select <vscale x 2 x i1> [[TMP27]], <vscale x 2 x i64> [[TMP28]], <vscale x 2 x i64> [[VEC_PHI2]]
; CHECK-NEXT:    [[PREDPHI9]] = select <vscale x 2 x i1> [[TMP30]], <vscale x 2 x i64> [[TMP29]], <vscale x 2 x i64> [[VEC_PHI3]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP4]]
; CHECK-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP12]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[BIN_RDX:%.*]] = add <vscale x 2 x i64> [[PREDPHI3]], [[PREDPHI]]
; CHECK-NEXT:    [[BIN_RDX10:%.*]] = add <vscale x 2 x i64> [[PREDPHI8]], [[BIN_RDX]]
; CHECK-NEXT:    [[BIN_RDX11:%.*]] = add <vscale x 2 x i64> [[PREDPHI9]], [[BIN_RDX10]]
; CHECK-NEXT:    [[TMP31:%.*]] = call i64 @llvm.vector.reduce.add.nxv2i64(<vscale x 2 x i64> [[BIN_RDX11]])
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH]]
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i64 [ [[TMP31]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SUM_NEXT_LCSSA:%.*]] = phi i64 [ [[SUM_NEXT]], %[[LOOP_CONT]] ], [ [[TMP31]], %[[MIDDLE_BLOCK]] ]
...
; TF-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP10:%.*]], %[[VECTOR_BODY]] ]
; TF-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = call <vscale x 2 x i1> @llvm.get.active.lane.mask.nxv2i1.i64(i64 [[INDEX]], i64 [[N]])
; TF-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[ADDR]], i64 [[INDEX]]
; TF-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <vscale x 2 x i64> @llvm.masked.load.nxv2i64.p0(ptr align 8 [[TMP0]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK]], <vscale x 2 x i64> poison)
; TF-NEXT:    [[TMP4:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_MASKED_LOAD]], [[BROADCAST_SPLAT]]
...
; CHECK-NEXT:    [[VEC_PHI3:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[PREDPHI9:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[ADDR]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP22:%.*]] = shl nuw nsw i64 [[TMP3]], 1
; CHECK-NEXT:    [[TMP23:%.*]] = mul nuw nsw i64 [[TMP3]], 3
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP22]]
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr i64, ptr [[TMP0]], i64 [[TMP23]]
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 2 x i64>, ptr [[TMP0]], align 8
; CHECK-NEXT:    [[WIDE_LOAD2:%.*]] = load <vscale x 2 x i64>, ptr [[TMP6]], align 8
; CHECK-NEXT:    [[WIDE_LOAD5:%.*]] = load <vscale x 2 x i64>, ptr [[TMP24]], align 8
; CHECK-NEXT:    [[WIDE_LOAD6:%.*]] = load <vscale x 2 x i64>, ptr [[TMP29]], align 8
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP8:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD2]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP30:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD5]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP31:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_LOAD6]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP9:%.*]] = add <vscale x 2 x i64> [[VEC_PHI]], [[WIDE_LOAD]]
; CHECK-NEXT:    [[TMP10:%.*]] = add <vscale x 2 x i64> [[VEC_PHI1]], [[WIDE_LOAD2]]
; CHECK-NEXT:    [[TMP34:%.*]] = add <vscale x 2 x i64> [[VEC_PHI2]], [[WIDE_LOAD5]]
; CHECK-NEXT:    [[TMP36:%.*]] = add <vscale x 2 x i64> [[VEC_PHI3]], [[WIDE_LOAD6]]
; CHECK-NEXT:    [[TMP11:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD]], splat (i64 1)
; CHECK-NEXT:    [[TMP12:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD2]], splat (i64 1)
; CHECK-NEXT:    [[TMP20:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD5]], splat (i64 1)
; CHECK-NEXT:    [[TMP21:%.*]] = add <vscale x 2 x i64> [[WIDE_LOAD6]], splat (i64 1)
...
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP20]], ptr align 8 [[TMP24]], <vscale x 2 x i1> [[TMP30]])
; CHECK-NEXT:    call void @llvm.masked.store.nxv2i64.p0(<vscale x 2 x i64> [[TMP21]], ptr align 8 [[TMP29]], <vscale x 2 x i1> [[TMP31]])
; CHECK-NEXT:    [[TMP17:%.*]] = add <vscale x 2 x i64> [[VEC_PHI]], [[TMP11]]
; CHECK-NEXT:    [[TMP18:%.*]] = add <vscale x 2 x i64> [[VEC_PHI1]], [[TMP12]]
; CHECK-NEXT:    [[TMP32:%.*]] = add <vscale x 2 x i64> [[VEC_PHI2]], [[TMP20]]
; CHECK-NEXT:    [[TMP33:%.*]] = add <vscale x 2 x i64> [[VEC_PHI3]], [[TMP21]]
...
; CHECK-NEXT:    [[PREDPHI8]] = select <vscale x 2 x i1> [[TMP30]], <vscale x 2 x i64> [[TMP32]], <vscale x 2 x i64> [[TMP34]]
; CHECK-NEXT:    [[PREDPHI9]] = select <vscale x 2 x i1> [[TMP31]], <vscale x 2 x i64> [[TMP33]], <vscale x 2 x i64> [[TMP36]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP4]]
...
; CHECK-NEXT:    [[BIN_RDX10:%.*]] = add <vscale x 2 x i64> [[PREDPHI8]], [[BIN_RDX]]
; CHECK-NEXT:    [[BIN_RDX11:%.*]] = add <vscale x 2 x i64> [[PREDPHI9]], [[BIN_RDX10]]
; CHECK-NEXT:    [[TMP35:%.*]] = call i64 @llvm.vector.reduce.add.nxv2i64(<vscale x 2 x i64> [[BIN_RDX11]])
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[CMP_N]], label %[[EXIT:.*]], label %[[SCALAR_PH]]
; CHECK:       [[SCALAR_PH]]:
; CHECK-NEXT:    [[BC_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i64 [ [[TMP35]], %[[MIDDLE_BLOCK]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    br label %[[LOOP:.*]]
; CHECK:       [[LOOP]]:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[BC_RESUME_VAL]], %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[LOOP_CONT:.*]] ]
...
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[ACC_NEXT_LCSSA:%.*]] = phi i64 [ [[ACC_NEXT]], %[[LOOP_CONT]] ], [ [[TMP35]], %[[MIDDLE_BLOCK]] ]
...
; TF:       [[VECTOR_BODY]]:
; TF-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; TF-NEXT:    [[VEC_PHI:%.*]] = phi <vscale x 2 x i64> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; TF-NEXT:    [[ACTIVE_LANE_MASK:%.*]] = call <vscale x 2 x i1> @llvm.get.active.lane.mask.nxv2i1.i64(i64 [[INDEX]], i64 [[N]])
; TF-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[ADDR]], i64 [[INDEX]]
; TF-NEXT:    [[WIDE_MASKED_LOAD:%.*]] = call <vscale x 2 x i64> @llvm.masked.load.nxv2i64.p0(ptr align 8 [[TMP0]], <vscale x 2 x i1> [[ACTIVE_LANE_MASK]], <vscale x 2 x i64> poison)
; TF-NEXT:    [[TMP4:%.*]] = icmp eq <vscale x 2 x i64> [[WIDE_MASKED_LOAD]], [[BROADCAST_SPLAT]]
