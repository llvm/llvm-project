...
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <4 x i16> [[TMP8]], i32 0
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <4 x i16> [[TMP8]], i32 1
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <4 x i16> [[TMP8]], i32 2
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <4 x i16> [[TMP8]], i32 3
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP17:%.*]] = load i64, ptr [[TMP13]], align 8
; CHECK-NEXT:    [[TMP18:%.*]] = load i64, ptr [[TMP14]], align 8
...
; CHECK-NEXT:    [[TMP24:%.*]] = ashr exact i64 [[TMP20]], 32
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i16, ptr [[M3]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i16, ptr [[M3]], i64 [[TMP22]]
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr inbounds i16, ptr [[M3]], i64 [[TMP23]]
; CHECK-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i16, ptr [[M3]], i64 [[TMP24]]
; CHECK-NEXT:    store i16 [[TMP9]], ptr [[TMP25]], align 2
; CHECK-NEXT:    store i16 [[TMP10]], ptr [[TMP26]], align 2
; CHECK-NEXT:    store i16 [[TMP11]], ptr [[TMP27]], align 2
; CHECK-NEXT:    store i16 [[TMP12]], ptr [[TMP28]], align 2
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
