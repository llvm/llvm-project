; NOTE: Assertions have been autogenerated by utils/update_analyze_test_checks.py UTC_ARGS: --filter "[Cc]ost.*(udiv|fneg|fmul|xor)"
...
; CHECK:  Cost of 1 for VF 2: EMIT vp<[[VP7:%[0-9]+]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 2: EMIT vp<[[VP12:%[0-9]+]]> = xor vp<[[VP11:%[0-9]+]]>, ir<true>
; CHECK:  Cost of 1 for VF 4: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 4: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 1 for VF 8: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 8: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 1 for VF 16: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 16: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 2 for VF 32: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 32: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 4 for VF 64: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 64: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 8 for VF 128: EMIT vp<[[VP7]]> = xor ir<%cmp1>, ir<true>
; CHECK:  Cost of 1 for VF 128: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
; CHECK:  Cost of 1 for VF 16: EMIT vp<[[VP12]]> = xor vp<[[VP11]]>, ir<true>
;
entry:
  br label %loop
