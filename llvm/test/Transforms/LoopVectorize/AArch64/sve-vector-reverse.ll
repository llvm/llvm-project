...
; CHECK-NEXT:    [[TMP9:%.*]] = shl nsw i64 [[TMP8]], 3
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP9]]
; CHECK-NEXT:    [[TMP12:%.*]] = sub i64 1, [[TMP5]]
; CHECK-NEXT:    [[TMP10:%.*]] = shl nsw i64 [[TMP12]], 3
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[TMP11]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP22:%.*]] = sub i64 [[TMP12]], [[TMP5]]
; CHECK-NEXT:    [[TMP13:%.*]] = shl nsw i64 [[TMP22]], 3
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[TMP11]], i64 [[TMP13]]
...
; CHECK-NEXT:    [[TMP23:%.*]] = shl nsw i64 [[TMP8]], 3
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP23]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[TMP12]], 3
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i8, ptr [[TMP18]], i64 [[TMP19]]
; CHECK-NEXT:    [[TMP21:%.*]] = shl nsw i64 [[TMP22]], 3
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i8, ptr [[TMP18]], i64 [[TMP21]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP12]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub i64 1, [[TMP8]]
; CHECK-NEXT:    [[TMP13:%.*]] = shl nsw i64 [[TMP15]], 3
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i8, ptr [[TMP14]], i64 [[TMP13]]
; CHECK-NEXT:    [[TMP25:%.*]] = sub i64 [[TMP15]], [[TMP8]]
; CHECK-NEXT:    [[TMP16:%.*]] = shl nsw i64 [[TMP25]], 3
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i8, ptr [[TMP14]], i64 [[TMP16]]
...
; CHECK-NEXT:    [[TMP26:%.*]] = shl nsw i64 [[TMP11]], 3
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP26]]
; CHECK-NEXT:    [[TMP22:%.*]] = shl nsw i64 [[TMP15]], 3
; CHECK-NEXT:    [[TMP23:%.*]] = getelementptr inbounds i8, ptr [[TMP21]], i64 [[TMP22]]
; CHECK-NEXT:    [[TMP24:%.*]] = shl nsw i64 [[TMP25]], 3
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr inbounds i8, ptr [[TMP21]], i64 [[TMP24]]
