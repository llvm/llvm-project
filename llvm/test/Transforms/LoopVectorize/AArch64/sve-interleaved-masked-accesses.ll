...
; RUN: opt -mtriple=aarch64-none-linux-gnu -S -passes=loop-vectorize,instcombine -mattr=+sve -force-vector-width=16 -force-vector-interleave=1 -scalable-vectorization=on -tail-folding-policy=none %s 2>&1 | FileCheck %s -check-prefix=SCALAR_TAIL_FOLDING
