...
; CHECK-VS1-NEXT:    [[TMP20:%.*]] = add nuw nsw i64 [[TMP0]], [[INDEX]]
...
; CHECK-VS1-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 [[TMP0]], [[INDEX5]]
...
; CHECK-VS2-NEXT:    [[TMP20:%.*]] = add nuw nsw i64 [[TMP0]], [[INDEX]]
...
; CHECK-VS2-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 [[TMP0]], [[INDEX5]]
...
; CHECK-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 [[TMP0]], [[INDEX]]
