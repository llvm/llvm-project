...
; DEBUG-VS1: Main Loop VF:vscale x 16, Main Loop UF:1, Epilogue Loop VF:vscale x 4, Epilogue Loop UF:1
; DEBUG-VS2: LV: VF is vscale x 8
; DEBUG-VS2: Main Loop VF:vscale x 8, Main Loop UF:1, Epilogue Loop VF:vscale x 2, Epilogue Loop UF:1
...
; CHECK-VS1-NEXT:    [[TMP5:%.*]] = shl nuw i64 [[TMP14]], 2
...
; CHECK-VS1-NEXT:    [[TMP19:%.*]] = shl nuw i64 [[TMP18]], 2
...
; CHECK-VS1-NEXT:    [[MIN_EPILOG_ITERS_CHECK:%.*]] = icmp ult i64 [[N_MOD_VF]], [[TMP19]]
...
; CHECK-VS1-NEXT:    [[TMP27:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-VS1-NEXT:    [[TMP23:%.*]] = shl nuw i64 [[TMP27]], 2
; CHECK-VS1-NEXT:    [[N_MOD_VF2:%.*]] = urem i64 [[TMP3]], [[TMP23]]
; CHECK-VS1-NEXT:    [[N_VEC3:%.*]] = sub i64 [[TMP3]], [[N_MOD_VF2]]
; CHECK-VS1-NEXT:    [[TMP39:%.*]] = add i64 [[TMP0]], [[N_VEC3]]
; CHECK-VS1-NEXT:    [[BROADCAST_SPLATINSERT4:%.*]] = insertelement <vscale x 4 x i8> poison, i8 [[CONV]], i64 0
; CHECK-VS1-NEXT:    [[BROADCAST_SPLAT5:%.*]] = shufflevector <vscale x 4 x i8> [[BROADCAST_SPLATINSERT4]], <vscale x 4 x i8> poison, <vscale x 4 x i32> zeroinitializer
...
; CHECK-VS1-NEXT:    [[WIDE_LOAD7:%.*]] = load <vscale x 4 x i8>, ptr [[TMP33]], align 1
; CHECK-VS1-NEXT:    [[TMP26:%.*]] = add <vscale x 4 x i8> [[WIDE_LOAD7]], [[BROADCAST_SPLAT5]]
; CHECK-VS1-NEXT:    store <vscale x 4 x i8> [[TMP26]], ptr [[TMP33]], align 1
; CHECK-VS1-NEXT:    [[INDEX_NEXT9]] = add nuw i64 [[INDEX5]], [[TMP23]]
...
; CHECK-VS2-NEXT:    [[TMP5:%.*]] = shl nuw i64 [[TMP14]], 1
...
; CHECK-VS2-NEXT:    [[TMP19:%.*]] = shl nuw i64 [[TMP18]], 1
...
; CHECK-VS2-NEXT:    [[MIN_EPILOG_ITERS_CHECK:%.*]] = icmp ult i64 [[N_MOD_VF]], [[TMP19]]
...
; CHECK-VS2-NEXT:    [[TMP27:%.*]] = call i64 @llvm.vscale.i64()
; CHECK-VS2-NEXT:    [[TMP23:%.*]] = shl nuw i64 [[TMP27]], 1
; CHECK-VS2-NEXT:    [[N_MOD_VF2:%.*]] = urem i64 [[TMP3]], [[TMP23]]
; CHECK-VS2-NEXT:    [[N_VEC3:%.*]] = sub i64 [[TMP3]], [[N_MOD_VF2]]
; CHECK-VS2-NEXT:    [[TMP39:%.*]] = add i64 [[TMP0]], [[N_VEC3]]
; CHECK-VS2-NEXT:    [[BROADCAST_SPLATINSERT4:%.*]] = insertelement <vscale x 2 x i8> poison, i8 [[CONV]], i64 0
; CHECK-VS2-NEXT:    [[BROADCAST_SPLAT5:%.*]] = shufflevector <vscale x 2 x i8> [[BROADCAST_SPLATINSERT4]], <vscale x 2 x i8> poison, <vscale x 2 x i32> zeroinitializer
...
; CHECK-VS2-NEXT:    [[WIDE_LOAD7:%.*]] = load <vscale x 2 x i8>, ptr [[TMP33]], align 1
; CHECK-VS2-NEXT:    [[TMP26:%.*]] = add <vscale x 2 x i8> [[WIDE_LOAD7]], [[BROADCAST_SPLAT5]]
; CHECK-VS2-NEXT:    store <vscale x 2 x i8> [[TMP26]], ptr [[TMP33]], align 1
; CHECK-VS2-NEXT:    [[INDEX_NEXT9]] = add nuw i64 [[INDEX5]], [[TMP23]]
...
; CHECK-VS1: [[PROF3]] = !{!"branch_weights", i32 4, i32 12}
...
; CHECK-VS2: [[PROF3]] = !{!"branch_weights", i32 4, i32 12}
