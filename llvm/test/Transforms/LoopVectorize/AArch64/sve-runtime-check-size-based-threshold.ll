...
; CHECK-NEXT:    [[TMP2:%.*]] = call i64 @llvm.umax.i64(i64 [[TMP1]], i64 30)
...
; CHECK-NEXT:    [[TMP21:%.*]] = sub i64 [[TMP5]], 1
...
; CHECK-NEXT:    [[TMP25:%.*]] = sub i64 [[TMP7]], 1
; CHECK-NEXT:    [[DIFF_CHECK4:%.*]] = icmp ult i64 [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[CONFLICT_RDX:%.*]] = or i1 [[DIFF_CHECK]], [[DIFF_CHECK4]]
; CHECK-NEXT:    [[TMP9:%.*]] = mul i64 [[TMP4]], 16
; CHECK-NEXT:    [[TMP10:%.*]] = sub i64 [[DST_12]], [[SRC_25]]
; CHECK-NEXT:    [[TMP26:%.*]] = sub i64 [[TMP10]], 1
; CHECK-NEXT:    [[TMP28:%.*]] = sub i64 [[TMP9]], 1
; CHECK-NEXT:    [[DIFF_CHECK6:%.*]] = icmp ult i64 [[TMP26]], [[TMP28]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = sub i64 [[TMP11]], 1
; CHECK-NEXT:    [[DIFF_CHECK8:%.*]] = icmp ult i64 [[TMP18]], [[TMP19]]
...
; CHECK-NEXT:    [[TMP22:%.*]] = sub i64 [[TMP14]], 1
; CHECK-NEXT:    [[TMP23:%.*]] = sub i64 [[TMP13]], 1
; CHECK-NEXT:    [[DIFF_CHECK10:%.*]] = icmp ult i64 [[TMP22]], [[TMP23]]
