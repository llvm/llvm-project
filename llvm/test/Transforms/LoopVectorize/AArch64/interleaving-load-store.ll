...
; INTERLEAVE-2-NEXT:    [[N_VEC:%.*]] = and i64 [[N]], -32
...
; INTERLEAVE-2-NEXT:    [[N_VEC8:%.*]] = and i64 [[N]], -8
...
; INTERLEAVE-4-NEXT:    [[N_VEC:%.*]] = and i64 [[N]], -64
...
; INTERLEAVE-4-NEXT:    [[N_VEC10:%.*]] = and i64 [[N]], -8
...
; INTERLEAVE-2-VLA-NEXT:    [[N_VEC:%.*]] = and i64 [[N]], -32
...
; INTERLEAVE-2-VLA-NEXT:    [[N_MOD_VF:%.*]] = sub i64 [[N]], [[N_VEC]]
...
; INTERLEAVE-2-VLA-NEXT:    [[N_VEC8:%.*]] = and i64 [[N]], -8
