...
; INTERLEAVE-4-VLA-NEXT:    [[TMP7:%.*]] = mul nuw i64 [[TMP6]], 64
...
; INTERLEAVE-4-VLA-NEXT:    [[TMP9:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP10:%.*]] = shl nuw i64 [[TMP9]], 4
; INTERLEAVE-4-VLA-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr [[TMP8]], i64 [[TMP10]]
; INTERLEAVE-4-VLA-NEXT:    [[TMP12:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP13:%.*]] = shl nuw i64 [[TMP12]], 5
; INTERLEAVE-4-VLA-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[TMP8]], i64 [[TMP13]]
; INTERLEAVE-4-VLA-NEXT:    [[TMP15:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP16:%.*]] = mul nuw i64 [[TMP15]], 48
...
; INTERLEAVE-4-VLA-NEXT:    [[TMP31:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP32:%.*]] = shl nuw i64 [[TMP31]], 4
; INTERLEAVE-4-VLA-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i8, ptr [[TMP30]], i64 [[TMP32]]
; INTERLEAVE-4-VLA-NEXT:    [[TMP34:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP35:%.*]] = shl nuw i64 [[TMP34]], 5
; INTERLEAVE-4-VLA-NEXT:    [[TMP36:%.*]] = getelementptr inbounds i8, ptr [[TMP30]], i64 [[TMP35]]
; INTERLEAVE-4-VLA-NEXT:    [[TMP37:%.*]] = call i64 @llvm.vscale.i64()
; INTERLEAVE-4-VLA-NEXT:    [[TMP38:%.*]] = mul nuw i64 [[TMP37]], 48
; INTERLEAVE-4-VLA-NEXT:    [[TMP39:%.*]] = getelementptr inbounds i8, ptr [[TMP30]], i64 [[TMP38]]
