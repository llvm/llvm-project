...
; CHECK-NEXT:   EXPRESSION vp<%8> = ir<%accum> + partial.reduce.add (mul (ir<%load.b> zext to i32), (ir<%load.a> zext to i32))
...
; CHECK-NEXT:   PARTIAL-REDUCE ir<%add> = ir<%accum> + reduce.add (ir<%mul>)
