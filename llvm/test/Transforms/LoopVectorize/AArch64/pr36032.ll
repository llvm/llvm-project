...
; RUN: opt -passes=loop-vectorize -S -mtriple=aarch64-unknown-linux-gnu -force-vector-interleave=1 -force-vector-width=4 < %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP12:%.*]] = sub nsw i64 4, [[TMP0]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = sub i64 [[TMP6]], 1
