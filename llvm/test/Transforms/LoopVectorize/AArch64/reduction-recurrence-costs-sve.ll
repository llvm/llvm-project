...
; VSCALEFORTUNING2-NEXT:    [[TMP14:%.*]] = xor i32 [[TMP13]], 1
; VSCALEFORTUNING2-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <vscale x 4 x i32> poison, i32 [[TMP14]], i64 0
...
; VSCALEFORTUNING2-NEXT:    [[TMP15:%.*]] = zext <vscale x 4 x i32> [[TMP12]] to <vscale x 4 x i64>
...
; PRED-NEXT:    [[BROADCAST_SPLATINSERT2:%.*]] = insertelement <vscale x 4 x i32> poison, i32 [[TMP10]], i64 0
...
; PRED-NEXT:    [[TMP19:%.*]] = zext <vscale x 4 x i32> [[TMP16]] to <vscale x 4 x i64>
