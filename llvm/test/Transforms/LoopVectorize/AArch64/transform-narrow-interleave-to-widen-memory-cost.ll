...
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr double, ptr [[TMP23]], i64 1
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr double, ptr [[TMP23]], i64 2
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr double, ptr [[TMP23]], i64 3
; CHECK-NEXT:    [[TMP38:%.*]] = load double, ptr [[TMP23]], align 8
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT1:%.*]] = insertelement <2 x double> poison, double [[TMP38]], i64 0
...
; CHECK-NEXT:    [[TMP39:%.*]] = load double, ptr [[TMP25]], align 8
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT14:%.*]] = insertelement <2 x double> poison, double [[TMP39]], i64 0
; CHECK-NEXT:    [[WIDE_LOAD13:%.*]] = shufflevector <2 x double> [[BROADCAST_SPLATINSERT14]], <2 x double> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP26:%.*]] = load double, ptr [[TMP36]], align 8
