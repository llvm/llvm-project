...
define void @test_widen_induction(i32 %init, ptr %A, i64 %N, i32 %step) {
...
define void @test_widen_induction_step_2(i32 %init, ptr %A, i64 %N, i32 %step) {
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP]], label [[EXIT]], !llvm.loop [[LOOP12:![0-9]+]]
; CHECK:       exit:
; CHECK-NEXT:    ret void
;
entry:
