...
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[TMP12]], i64 16
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr [[TMP12]], i64 32
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[TMP12]], i64 48
