...
; CHECK-NEXT:    [[TMP3:%.*]] = and i32 [[BLOCKSIZE]], 1
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[N_VEC:%.*]] = sub nuw nsw i64 [[TMP2]], [[N_MOD_VF]]
=======
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[TMP0]] to i64
; CHECK-NEXT:    [[TMP2:%.*]] = add nuw nsw i64 [[TMP1]], 1
...
>>>>>>> ef9e1e5a59656a85ce50d50c1357e1001a2701a5
...
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast i16* [[NEXT_GEP]] to <2 x i16>*
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <2 x i16>, <2 x i16>* [[TMP4]], align 2
; CHECK-NEXT:    [[TMP5:%.*]] = call <2 x i16> @llvm.sadd.sat.v2i16(<2 x i16> [[WIDE_LOAD]], <2 x i16> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i16* [[NEXT_GEP5]] to <2 x i16>*
; CHECK-NEXT:    store <2 x i16> [[TMP5]], <2 x i16>* [[TMP6]], align 2
...
<<<<<<< HEAD
; CHECK-NEXT:    [[TMP8:%.*]] = load i16, i16* [[PSRC_ADDR_08]], align 2
...
; CHECK-NEXT:    store i16 [[TMP9]], i16* [[PDST_ADDR_07]], align 2
=======
...
; CHECK-NEXT:    [[TMP5:%.*]] = call <16 x i8> @llvm.umin.v16i8(<16 x i8> [[WIDE_LOAD]], <16 x i8> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i8* [[NEXT_GEP2]] to <16 x i8>*
; CHECK-NEXT:    store <16 x i8> [[TMP5]], <16 x i8>* [[TMP6]], align 2
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 16
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP7]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], [[LOOP4:!llvm.loop !.*]]
=======
...
; CHECK-NEXT:    [[TMP8:%.*]] = add i32 [[BLOCKSIZE]], -1
; CHECK-NEXT:    [[TMP9:%.*]] = zext i32 [[TMP8]] to i64
; CHECK-NEXT:    [[TMP10:%.*]] = add nuw nsw i64 [[TMP9]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = and i32 [[BLOCKSIZE]], 7
; CHECK-NEXT:    [[N_MOD_VF3:%.*]] = zext i32 [[TMP11]] to i64
; CHECK-NEXT:    [[N_VEC4:%.*]] = sub nsw i64 [[TMP10]], [[N_MOD_VF3]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i8* [[NEXT_GEP17]] to <8 x i8>*
; CHECK-NEXT:    [[WIDE_LOAD19:%.*]] = load <8 x i8>, <8 x i8>* [[TMP12]], align 2
; CHECK-NEXT:    [[TMP13:%.*]] = call <8 x i8> @llvm.umin.v8i8(<8 x i8> [[WIDE_LOAD19]], <8 x i8> [[BROADCAST_SPLAT21]])
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i8* [[NEXT_GEP18]] to <8 x i8>*
; CHECK-NEXT:    store <8 x i8> [[TMP13]], <8 x i8>* [[TMP14]], align 2
; CHECK-NEXT:    [[INDEX_NEXT6]] = add i64 [[INDEX5]], 8
; CHECK-NEXT:    [[TMP15:%.*]] = icmp eq i64 [[INDEX_NEXT6]], [[N_VEC4]]
; CHECK-NEXT:    br i1 [[TMP15]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], [[LOOP5:!llvm.loop !.*]]
; CHECK:       vec.epilog.middle.block:
; CHECK-NEXT:    [[CMP_N15:%.*]] = icmp eq i32 [[TMP11]], 0
