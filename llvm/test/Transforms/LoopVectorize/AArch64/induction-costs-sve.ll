...
; PRED-NEXT:    [[TMP17:%.*]] = zext <vscale x 8 x i8> [[WIDE_MASKED_LOAD]] to <vscale x 8 x i16>
; PRED-NEXT:    [[TMP22:%.*]] = mul <vscale x 8 x i16> [[TMP17]], [[TMP16]]
; PRED-NEXT:    [[TMP24:%.*]] = zext <vscale x 8 x i8> [[WIDE_MASKED_LOAD]] to <vscale x 8 x i16>
; PRED-NEXT:    [[TMP20:%.*]] = or <vscale x 8 x i16> [[TMP22]], [[TMP24]]
; PRED-NEXT:    [[TMP21:%.*]] = lshr <vscale x 8 x i16> [[TMP20]], splat (i16 1)
; PRED-NEXT:    [[TMP23:%.*]] = trunc <vscale x 8 x i16> [[TMP21]] to <vscale x 8 x i8>
; PRED-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[DST]], i64 [[INDEX]]
; PRED-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[TMP26]], i32 0
; PRED-NEXT:    call void @llvm.masked.store.nxv8i8.p0(<vscale x 8 x i8> [[TMP23]], ptr [[TMP27]], i32 1, <vscale x 8 x i1> [[ACTIVE_LANE_MASK]])
