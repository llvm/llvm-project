...
; DEFAULT-NEXT:    [[TMP9:%.*]] = shl i64 [[TMP3]], 5
...
; DEFAULT-NEXT:    [[TMP8:%.*]] = shl nuw i64 [[TMP7]], 5
...
; DEFAULT:       [[VECTOR_PH]]:
; DEFAULT-NEXT:    [[TMP13:%.*]] = shl nuw i64 [[TMP7]], 4
...
; DEFAULT-NEXT:    [[TMP11:%.*]] = trunc <vscale x 16 x i32> [[BROADCAST_SPLAT]] to <vscale x 16 x i16>
...
; DEFAULT-NEXT:    [[TMP23:%.*]] = zext <vscale x 16 x i8> [[WIDE_LOAD]] to <vscale x 16 x i16>
; DEFAULT-NEXT:    [[TMP24:%.*]] = zext <vscale x 16 x i8> [[WIDE_LOAD4]] to <vscale x 16 x i16>
; DEFAULT-NEXT:    [[TMP25:%.*]] = mul <vscale x 16 x i16> [[TMP23]], [[TMP11]]
; DEFAULT-NEXT:    [[TMP16:%.*]] = mul <vscale x 16 x i16> [[TMP24]], [[TMP11]]
; DEFAULT-NEXT:    [[TMP17:%.*]] = or <vscale x 16 x i16> [[TMP25]], [[TMP23]]
; DEFAULT-NEXT:    [[TMP18:%.*]] = or <vscale x 16 x i16> [[TMP16]], [[TMP24]]
; DEFAULT-NEXT:    [[TMP19:%.*]] = lshr <vscale x 16 x i16> [[TMP17]], splat (i16 1)
; DEFAULT-NEXT:    [[TMP20:%.*]] = lshr <vscale x 16 x i16> [[TMP18]], splat (i16 1)
; DEFAULT-NEXT:    [[TMP21:%.*]] = trunc <vscale x 16 x i16> [[TMP19]] to <vscale x 16 x i8>
; DEFAULT-NEXT:    [[TMP22:%.*]] = trunc <vscale x 16 x i16> [[TMP20]] to <vscale x 16 x i8>
; DEFAULT-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[DST]], i64 [[INDEX]]
; DEFAULT-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr [[TMP26]], i64 [[TMP13]]
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP21]], ptr [[TMP26]], align 1
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP22]], ptr [[TMP29]], align 1
...
; DEFAULT-NEXT:    [[N_MOD_VF5:%.*]] = and i64 [[TMP0]], 15
...
; DEFAULT-NEXT:    [[TMP28:%.*]] = trunc <16 x i32> [[BROADCAST_SPLAT7]] to <16 x i16>
...
; DEFAULT-NEXT:    [[WIDE_LOAD9:%.*]] = load <16 x i8>, ptr [[TMP36]], align 1
; DEFAULT-NEXT:    [[TMP34:%.*]] = zext <16 x i8> [[WIDE_LOAD9]] to <16 x i16>
; DEFAULT-NEXT:    [[TMP35:%.*]] = mul <16 x i16> [[TMP34]], [[TMP28]]
; DEFAULT-NEXT:    [[TMP31:%.*]] = or <16 x i16> [[TMP35]], [[TMP34]]
; DEFAULT-NEXT:    [[TMP32:%.*]] = lshr <16 x i16> [[TMP31]], splat (i16 1)
; DEFAULT-NEXT:    [[TMP33:%.*]] = trunc <16 x i16> [[TMP32]] to <16 x i8>
; DEFAULT-NEXT:    [[TMP42:%.*]] = getelementptr i8, ptr [[DST]], i64 [[INDEX9]]
; DEFAULT-NEXT:    store <16 x i8> [[TMP33]], ptr [[TMP42]], align 1
; DEFAULT-NEXT:    [[INDEX_NEXT11]] = add nuw i64 [[INDEX9]], 16
