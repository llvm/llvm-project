...
; CHECK:  LV: Found an estimated cost of 6 for VF 1 For instruction: %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 6 for VF 2: CLONE ir<%div> = udiv ir<%iv.trunc>, ir<3>
; CHECK:  Cost of 0 for VF 2: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 6 for VF 4: CLONE ir<%div> = udiv ir<%iv.trunc>, ir<3>
; CHECK:  Cost of 0 for VF 4: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 6 for VF vscale x 1: CLONE ir<%div> = udiv ir<%iv.trunc>, ir<3>
; CHECK:  Cost of 6 for VF vscale x 2: CLONE ir<%div> = udiv ir<%iv.trunc>, ir<3>
; CHECK:  Cost of 0 for VF vscale x 2: IR %div = udiv i8 %iv.trunc, 3
; CHECK:  Cost of 6 for VF vscale x 4: CLONE ir<%div> = udiv ir<%iv.trunc>, ir<3>
