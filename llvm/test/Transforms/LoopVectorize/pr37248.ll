...
; CHECK-NEXT:    [[TMP8:%.*]] = add i16 [[TMP13]], -1
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [2 x i16], ptr @a, i16 0, i16 [[TMP8]]
; CHECK-NEXT:    store i16 0, ptr [[TMP15]], align 1
; CHECK-NEXT:    store i16 0, ptr [[TMP11]], align 1
...
; CHECK-NEXT:    [[TMP8:%.*]] = add i16 [[TMP11]], -1
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [2 x i16], ptr @a, i16 0, i16 [[TMP11]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds [2 x i16], ptr @a, i16 0, i16 [[TMP8]]
; CHECK-NEXT:    store i16 0, ptr [[TMP12]], align 1
; CHECK-NEXT:    store i16 0, ptr [[TMP9]], align 1
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 2
