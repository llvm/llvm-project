...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i8, ptr [[TMP20]], i64 8
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP7]], i64 8
; CHECK-NEXT:    [[TMP14:%.*]] = load i16, ptr [[TMP3]], align 2, !alias.scope [[META68:![0-9]+]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i16, ptr [[TMP8]], align 2, !alias.scope [[META68]]
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <2 x i16> poison, i16 [[TMP14]], i64 0
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <2 x i16> [[TMP15]], i16 [[TMP6]], i64 1
; CHECK-NEXT:    br label %[[PRED_LOAD_CONTINUE8]]
; CHECK:       [[THEN6]]:
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr [11 x i16], ptr [[SRC]], i64 [[INDEX]]
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr [11 x i16], ptr [[SRC]], i64 [[TMP2]]
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[TMP17]], i64 8
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP10]], i64 8
; CHECK-NEXT:    [[TMP13:%.*]] = load i16, ptr [[TMP18]], align 2, !alias.scope [[META68]]
; CHECK-NEXT:    [[TMP19:%.*]] = load i16, ptr [[TMP12]], align 2, !alias.scope [[META68]]
; CHECK-NEXT:    [[TMP16:%.*]] = insertelement <2 x i16> poison, i16 [[TMP13]], i64 0
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <2 x i16> [[TMP16]], i16 [[TMP19]], i64 1
; CHECK-NEXT:    br label %[[PRED_LOAD_CONTINUE8]]
; CHECK:       [[PRED_LOAD_CONTINUE8]]:
; CHECK-NEXT:    [[TMP22:%.*]] = phi <2 x i16> [ [[TMP9]], %[[ELSE3]] ], [ poison, %[[THEN6]] ]
; CHECK-NEXT:    [[TMP23:%.*]] = phi <2 x i16> [ poison, %[[ELSE3]] ], [ [[TMP27]], %[[THEN6]] ]
; CHECK-NEXT:    [[TMP24:%.*]] = phi <2 x i1> [ zeroinitializer, %[[ELSE3]] ], [ splat (i1 true), %[[THEN6]] ]
...
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <2 x i16> poison, i16 [[TMP5]], i64 0
...
; CHECK-NEXT:    [[TMP11:%.*]] = load i16, ptr [[TMP12]], align 2, !alias.scope [[META75]]
; CHECK-NEXT:    [[TMP17:%.*]] = load i16, ptr [[TMP16]], align 2, !alias.scope [[META75]]
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <2 x i16> poison, i16 [[TMP11]], i64 0
; CHECK-NEXT:    [[TMP18:%.*]] = insertelement <2 x i16> [[TMP15]], i16 [[TMP17]], i64 1
; CHECK-NEXT:    br label %[[LOOP_LATCH11]]
; CHECK:       [[LOOP_LATCH11]]:
; CHECK-NEXT:    [[TMP20:%.*]] = phi <2 x i16> [ [[TMP10]], %[[ELSE3]] ], [ poison, %[[THEN6]] ]
; CHECK-NEXT:    [[TMP24:%.*]] = phi <2 x i16> [ poison, %[[ELSE3]] ], [ [[TMP18]], %[[THEN6]] ]
; CHECK-NEXT:    [[TMP22:%.*]] = phi <2 x i1> [ zeroinitializer, %[[ELSE3]] ], [ splat (i1 true), %[[THEN6]] ]
