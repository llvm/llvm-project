...
; CHECK-NEXT:    [[TMP10:%.*]] = load i32, ptr [[TMP8]], align 4, !alias.scope [[META3:![0-9]+]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP9]], align 4, !alias.scope [[META3]]
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <2 x i32> poison, i32 [[TMP10]], i64 0
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <2 x i32> [[TMP7]], i32 [[TMP6]], i64 1
...
; CHECK-NEXT:    [[TMP15:%.*]] = icmp ule <2 x i32> [[WIDE_LOAD]], splat (i32 11)
; CHECK-NEXT:    [[TMP10:%.*]] = load i32, ptr [[TMP8]], align 2, !alias.scope [[META39:![0-9]+]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP9]], align 2, !alias.scope [[META39]]
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <2 x i32> poison, i32 [[TMP10]], i64 0
; CHECK-NEXT:    [[TMP25:%.*]] = insertelement <2 x i32> [[TMP7]], i32 [[TMP6]], i64 1
...
; CHECK-NEXT:    [[TMP8:%.*]] = load i32, ptr [[TMP10]], align 4, !alias.scope [[META49:![0-9]+]]
; CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP15]], align 4, !alias.scope [[META49]]
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <2 x i32> poison, i32 [[TMP8]], i64 0
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <2 x i32> [[TMP11]], i32 [[TMP9]], i64 1
...
; CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[TMP12]], align 4, !alias.scope [[META59:![0-9]+]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP17]], align 4, !alias.scope [[META59]]
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <2 x i32> poison, i32 [[TMP5]], i64 0
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <2 x i32> [[TMP10]], i32 [[TMP6]], i64 1
