...
; CHECK-NEXT:    [[STRIDED_VEC4:%.*]] = call { <2 x i64>, <2 x i64> } @llvm.vector.deinterleave2.v4i64(<4 x i64> [[WIDE_VEC3]])
; CHECK-NEXT:    [[TMP17:%.*]] = extractvalue { <2 x i64>, <2 x i64> } [[STRIDED_VEC4]], 0
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <2 x i64> [[TMP17]], i64 0
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <2 x i64> [[TMP17]], i64 1
