...
; CHECK-MASKED-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[UMAX]], 1
...
; CHECK-PREDICATE-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[UMAX]], 1
...
; CHECK-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[UMAX]], 1
