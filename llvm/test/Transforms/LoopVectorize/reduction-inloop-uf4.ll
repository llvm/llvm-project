...
; RUN: opt < %s -passes=loop-vectorize -force-vector-interleave=4 -force-vector-width=4 -prefer-inloop-reductions -S | FileCheck %s
...
; CHECK-NEXT:    br i1 [[TMP12]], label %[[__CRIT_EDGE:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; CHECK:       [[__CRIT_EDGE]]:
...
; CHECK-LABEL: define i64 @reduction_sum_chain(
...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i64, ptr [[TMP0]], i64 4
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr i64, ptr [[TMP0]], i64 8
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i64, ptr [[TMP0]], i64 12
...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i64, ptr [[TMP1]], i64 4
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i64, ptr [[TMP1]], i64 8
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i64, ptr [[TMP1]], i64 12
...
; CHECK-LABEL: define i32 @predicated(
; CHECK-SAME: ptr noalias captures(none) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
...
; CHECK-NEXT:    [[VEC_IV:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT]], <i64 0, i64 1, i64 2, i64 3>
; CHECK-NEXT:    [[VEC_IV4:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT]], <i64 4, i64 5, i64 6, i64 7>
; CHECK-NEXT:    [[VEC_IV5:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT]], <i64 8, i64 9, i64 10, i64 11>
; CHECK-NEXT:    [[VEC_IV6:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT]], <i64 12, i64 13, i64 14, i64 15>
; CHECK-NEXT:    [[TMP0:%.*]] = icmp ule <4 x i64> [[VEC_IV]], splat (i64 256)
; CHECK-NEXT:    [[TMP1:%.*]] = icmp ule <4 x i64> [[VEC_IV4]], splat (i64 256)
; CHECK-NEXT:    [[TMP2:%.*]] = icmp ule <4 x i64> [[VEC_IV5]], splat (i64 256)
; CHECK-NEXT:    [[TMP3:%.*]] = icmp ule <4 x i64> [[VEC_IV6]], splat (i64 256)
...
; CHECK:       [[PRED_LOAD_IF21]]:
; CHECK-NEXT:    [[TMP52:%.*]] = add i64 [[INDEX]], 8
...
; CHECK-NEXT:    [[TMP58:%.*]] = add i64 [[INDEX]], 9
...
; CHECK-NEXT:    [[TMP64:%.*]] = add i64 [[INDEX]], 10
...
; CHECK:       [[PRED_LOAD_IF27]]:
; CHECK-NEXT:    [[TMP70:%.*]] = add i64 [[INDEX]], 11
...
; CHECK-NEXT:    [[TMP76:%.*]] = add i64 [[INDEX]], 12
...
; CHECK-NEXT:    [[TMP82:%.*]] = add i64 [[INDEX]], 13
...
; CHECK-NEXT:    [[TMP88:%.*]] = add i64 [[INDEX]], 14
...
; CHECK-NEXT:    [[TMP94:%.*]] = add i64 [[INDEX]], 15
...
; CHECK-NEXT:    br i1 [[TMP111]], label %[[__CRIT_EDGE:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; CHECK:       [[__CRIT_EDGE]]:
...
; CHECK-LABEL: define i32 @cond_rdx_pred(
; CHECK-SAME: i32 [[COND:%.*]], ptr noalias [[A:%.*]], i64 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
...
; CHECK-NEXT:    [[VEC_IND:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT5]], <i64 0, i64 1, i64 2, i64 3>
; CHECK-NEXT:    [[STEP_ADD:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT5]], <i64 4, i64 5, i64 6, i64 7>
; CHECK-NEXT:    [[STEP_ADD1:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT5]], <i64 8, i64 9, i64 10, i64 11>
; CHECK-NEXT:    [[STEP_ADD2:%.*]] = add nuw <4 x i64> [[BROADCAST_SPLAT5]], <i64 12, i64 13, i64 14, i64 15>
...
; CHECK:       [[PRED_LOAD_IF11]]:
; CHECK-NEXT:    [[TMP24:%.*]] = add i64 [[INDEX]], 2
...
; CHECK:       [[PRED_LOAD_IF15]]:
; CHECK-NEXT:    [[TMP36:%.*]] = add i64 [[INDEX]], 4
...
; CHECK:       [[PRED_LOAD_IF19]]:
; CHECK-NEXT:    [[TMP48:%.*]] = add i64 [[INDEX]], 6
...
; CHECK:       [[PRED_LOAD_IF21]]:
; CHECK-NEXT:    [[TMP54:%.*]] = add i64 [[INDEX]], 7
...
; CHECK:       [[PRED_LOAD_IF23]]:
; CHECK-NEXT:    [[TMP60:%.*]] = add i64 [[INDEX]], 8
...
; CHECK:       [[PRED_LOAD_IF25]]:
; CHECK-NEXT:    [[TMP66:%.*]] = add i64 [[INDEX]], 9
...
; CHECK:       [[PRED_LOAD_IF27]]:
; CHECK-NEXT:    [[TMP72:%.*]] = add i64 [[INDEX]], 10
...
; CHECK:       [[PRED_LOAD_IF29]]:
; CHECK-NEXT:    [[TMP78:%.*]] = add i64 [[INDEX]], 11
...
; CHECK:       [[PRED_LOAD_IF31]]:
; CHECK-NEXT:    [[TMP84:%.*]] = add i64 [[INDEX]], 12
...
; CHECK:       [[PRED_LOAD_IF33]]:
; CHECK-NEXT:    [[TMP90:%.*]] = add i64 [[INDEX]], 13
...
; CHECK:       [[PRED_LOAD_IF35]]:
; CHECK-NEXT:    [[TMP96:%.*]] = add i64 [[INDEX]], 14
...
; CHECK-NEXT:    [[TMP102:%.*]] = add i64 [[INDEX]], 15
...
; CHECK-NEXT:    br i1 [[TMP119]], label %[[FOR_END:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; CHECK:       [[FOR_END]]:
