...
; VF-TWO-CHECK-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -32
...
; VF-TWO-CHECK-NEXT:    [[N_MOD_VF:%.*]] = sub i64 [[WIDE_TRIP_COUNT]], [[N_VEC]]
...
; VF-TWO-CHECK-NEXT:    [[N_VEC18:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -2
...
; VF-FOUR-CHECK-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -32
...
; VF-FOUR-CHECK-NEXT:    [[N_MOD_VF:%.*]] = sub i64 [[WIDE_TRIP_COUNT]], [[N_VEC]]
...
; VF-FOUR-CHECK-NEXT:    [[N_VEC18:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
...
; VF-TWO-CHECK:       [[VEC_EPILOG_PH]]:
; VF-TWO-CHECK-NEXT:    [[VEC_EPILOG_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
; VF-TWO-CHECK-NEXT:    [[N_VEC17:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -2
...
; VF-FOUR-CHECK:       [[VEC_EPILOG_PH]]:
; VF-FOUR-CHECK-NEXT:    [[VEC_EPILOG_RESUME_VAL:%.*]] = phi i64 [ [[N_VEC]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK]] ]
; VF-FOUR-CHECK-NEXT:    [[N_VEC17:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
