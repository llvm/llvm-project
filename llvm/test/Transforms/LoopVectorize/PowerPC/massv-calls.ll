...
; RUN: opt -vector-library=MASSV -vec-extabi -mattr=+altivec -mcpu=generic -mtriple=powerpc64-ibm-aix-xcoff -passes=inject-tli-mappings,loop-vectorize -force-vector-interleave=1 -S < %s | FileCheck %s
