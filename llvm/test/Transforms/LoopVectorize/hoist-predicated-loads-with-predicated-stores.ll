...
; CHECK:       [[PRED_STORE_IF14]]:
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr inbounds i32, ptr [[SRC]], i32 [[TMP4]]
; CHECK-NEXT:    [[TMP37:%.*]] = load i32, ptr [[TMP27]], align 4, !alias.scope [[META38]], !noalias [[META40]]
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds i32, ptr [[DST]], i32 [[TMP4]]
; CHECK-NEXT:    store i32 [[TMP37]], ptr [[TMP29]], align 4, !alias.scope [[META42]], !noalias [[META35]]
; CHECK-NEXT:    br label %[[PRED_STORE_CONTINUE15]]
; CHECK:       [[PRED_STORE_CONTINUE15]]:
...
; CHECK-NEXT:    [[TMP35:%.*]] = load i32, ptr [[TMP31]], align 4, !alias.scope [[META38]], !noalias [[META40]]
; CHECK-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i32, ptr [[DST]], i32 [[TMP5]]
; CHECK-NEXT:    store i32 [[TMP35]], ptr [[TMP33]], align 4, !alias.scope [[META42]], !noalias [[META35]]
; CHECK-NEXT:    br label %[[PRED_STORE_CONTINUE17]]
; CHECK:       [[PRED_STORE_CONTINUE17]]:
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 2
...
; CHECK-NEXT:    [[TMP37:%.*]] = load i32, ptr [[TMP33]], align 4, !alias.scope [[META53]]
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds i32, ptr [[DST]], i32 [[TMP5]]
; CHECK-NEXT:    store i32 [[TMP37]], ptr [[TMP35]], align 4, !alias.scope [[META54]], !noalias [[META55]]
