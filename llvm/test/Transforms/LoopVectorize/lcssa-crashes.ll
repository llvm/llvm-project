...
; CHECK:       middle.block:
; CHECK-NEXT:    [[TMP8:%.*]] = add i32 [[ADD41]], 0
; CHECK-NEXT:    [[TMP9:%.*]] = add i32 [[ADD41]], 1
; CHECK-NEXT:    [[TMP10:%.*]] = add i32 [[ADD41]], 2
; CHECK-NEXT:    [[TMP20:%.*]] = add i32 [[ADD41]], 3
; CHECK-NEXT:    [[TMP12:%.*]] = add i32 [[TMP8]], 1
; CHECK-NEXT:    [[TMP13:%.*]] = add i32 [[TMP9]], 1
; CHECK-NEXT:    [[TMP21:%.*]] = add i32 [[TMP10]], 1
