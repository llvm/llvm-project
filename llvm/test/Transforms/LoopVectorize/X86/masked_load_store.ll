...
; AVX2-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 32
; AVX2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 64
; AVX2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 96
...
; AVX2-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr [[TMP12]], i64 32
; AVX2-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[TMP12]], i64 64
; AVX2-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr [[TMP12]], i64 96
...
; AVX2-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr [[TMP21]], i64 32
; AVX2-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr [[TMP21]], i64 64
; AVX2-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr [[TMP21]], i64 96
...
; AVX512-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 64
; AVX512-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 128
; AVX512-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr [[TMP3]], i64 192
...
; AVX512-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr [[TMP12]], i64 64
; AVX512-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[TMP12]], i64 128
; AVX512-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr [[TMP12]], i64 192
...
; AVX512-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr [[TMP21]], i64 64
; AVX512-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr [[TMP21]], i64 128
; AVX512-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr [[TMP21]], i64 192
...
; AVX2-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 32
; AVX2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 64
; AVX2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 96
...
; AVX2-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 32
; AVX2-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 64
; AVX2-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 96
...
; AVX2-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 32
; AVX2-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 64
; AVX2-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 96
...
; AVX512-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 64
; AVX512-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 128
; AVX512-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[TMP3]], i64 192
...
; AVX512-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 64
; AVX512-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 128
; AVX512-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP12]], i64 192
...
; AVX512-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 64
; AVX512-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 128
; AVX512-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(1) [[TMP21]], i64 192
...
; AVX2-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[TMP25]], i64 32
; AVX2-NEXT:    [[TMP28:%.*]] = getelementptr i8, ptr [[TMP25]], i64 64
; AVX2-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr [[TMP25]], i64 96
...
; AVX512-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[TMP25]], i64 64
; AVX512-NEXT:    [[TMP28:%.*]] = getelementptr i8, ptr [[TMP25]], i64 128
; AVX512-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr [[TMP25]], i64 192
...
; AVX1-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 16
; AVX1-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 32
; AVX1-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 48
...
; AVX1-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP10]], i64 32
; AVX1-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[TMP10]], i64 64
; AVX1-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[TMP10]], i64 96
...
; AVX1-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr [[TMP23]], i64 32
; AVX1-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr [[TMP23]], i64 64
; AVX1-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[TMP23]], i64 96
...
; AVX2-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 32
; AVX2-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 48
...
; AVX2-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP10]], i64 32
; AVX2-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[TMP10]], i64 64
; AVX2-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[TMP10]], i64 96
...
; AVX2-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr [[TMP23]], i64 32
; AVX2-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr [[TMP23]], i64 64
; AVX2-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[TMP23]], i64 96
...
; AVX512-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 32
; AVX512-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 64
; AVX512-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 96
...
; AVX512-NEXT:    [[TMP12:%.*]] = getelementptr i8, ptr [[TMP10]], i64 64
; AVX512-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[TMP10]], i64 128
; AVX512-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[TMP10]], i64 192
...
; AVX512-NEXT:    [[TMP24:%.*]] = getelementptr i8, ptr [[TMP23]], i64 64
; AVX512-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr [[TMP23]], i64 128
; AVX512-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[TMP23]], i64 192
...
; AVX1-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP13]], i64 32
; AVX1-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr [[TMP13]], i64 64
; AVX1-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr [[TMP13]], i64 96
...
; AVX1-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr [[TMP35]], i64 32
; AVX1-NEXT:    [[TMP38:%.*]] = getelementptr i8, ptr [[TMP35]], i64 64
; AVX1-NEXT:    [[TMP39:%.*]] = getelementptr i8, ptr [[TMP35]], i64 96
...
; AVX2-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP18]], i64 32
; AVX2-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr [[TMP18]], i64 64
; AVX2-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr [[TMP18]], i64 96
...
; AVX2-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr [[TMP35]], i64 32
; AVX2-NEXT:    [[TMP38:%.*]] = getelementptr i8, ptr [[TMP35]], i64 64
; AVX2-NEXT:    [[TMP39:%.*]] = getelementptr i8, ptr [[TMP35]], i64 96
...
; AVX512-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP18]], i64 64
; AVX512-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr [[TMP18]], i64 128
; AVX512-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr [[TMP18]], i64 192
...
; AVX512-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr [[TMP35]], i64 64
; AVX512-NEXT:    [[TMP38:%.*]] = getelementptr i8, ptr [[TMP35]], i64 128
; AVX512-NEXT:    [[TMP39:%.*]] = getelementptr i8, ptr [[TMP35]], i64 192
...
; AVX1-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP18]], i64 32
; AVX1-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr [[TMP18]], i64 64
; AVX1-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr [[TMP18]], i64 96
...
; AVX2-NEXT:    [[TMP19:%.*]] = getelementptr i8, ptr [[TMP13]], i64 32
; AVX2-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr [[TMP13]], i64 64
; AVX2-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr [[TMP13]], i64 96
