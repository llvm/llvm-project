...
; CHECK-NEXT:    br i1 [[TOBOOL]], label %[[ITER_CHECK23:.*]], label %[[ITER_CHECK:.*]]
; CHECK:       [[ITER_CHECK]]:
...
; CHECK-NEXT:    [[MIN_ITERS_CHECK1:%.*]] = icmp ult i64 [[TMP6]], 32
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK1]], label %[[VEC_EPILOG_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = urem i64 [[TMP6]], 32
...
; CHECK-NEXT:    [[STEP_ADD:%.*]] = add <16 x i64> [[VEC_IND]], splat (i64 32)
; CHECK-NEXT:    [[STEP_ADD3:%.*]] = add <16 x i64> [[VEC_IND3]], splat (i64 32)
; CHECK-NEXT:    [[TMP10:%.*]] = sub nsw <16 x i64> splat (i64 8), [[VEC_IND]]
; CHECK-NEXT:    [[TMP35:%.*]] = sub nsw <16 x i64> splat (i64 8), [[STEP_ADD]]
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, i64 0, <16 x i64> [[VEC_IND]]
; CHECK-NEXT:    [[TMP38:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, i64 0, <16 x i64> [[STEP_ADD]]
; CHECK-NEXT:    [[TMP12:%.*]] = add nsw <16 x i64> [[TMP10]], [[VEC_IND3]]
; CHECK-NEXT:    [[TMP39:%.*]] = add nsw <16 x i64> [[TMP35]], [[STEP_ADD3]]
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[TMP11]], <16 x i64> [[TMP12]], i64 0
; CHECK-NEXT:    [[TMP40:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[TMP38]], <16 x i64> [[TMP39]], i64 0
; CHECK-NEXT:    [[TMP52:%.*]] = extractelement <16 x ptr> [[TMP13]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP52]], align 16
; CHECK-NEXT:    [[TMP53:%.*]] = extractelement <16 x ptr> [[TMP40]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP53]], align 16
; CHECK-NEXT:    [[TMP14:%.*]] = or disjoint <16 x i64> [[VEC_IND3]], splat (i64 1)
; CHECK-NEXT:    [[TMP65:%.*]] = or disjoint <16 x i64> [[STEP_ADD3]], splat (i64 1)
; CHECK-NEXT:    [[TMP15:%.*]] = add nsw <16 x i64> [[TMP10]], [[TMP14]]
; CHECK-NEXT:    [[TMP66:%.*]] = add nsw <16 x i64> [[TMP35]], [[TMP65]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[TMP11]], <16 x i64> [[TMP15]], i64 0
; CHECK-NEXT:    [[TMP67:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[TMP38]], <16 x i64> [[TMP66]], i64 0
; CHECK-NEXT:    [[TMP68:%.*]] = extractelement <16 x ptr> [[TMP16]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP68]], align 8
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <16 x ptr> [[TMP67]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP69]], align 8
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 32
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <16 x i64> [[STEP_ADD]], splat (i64 32)
; CHECK-NEXT:    [[VEC_IND_NEXT4]] = add <16 x i64> [[STEP_ADD3]], splat (i64 32)
...
; CHECK-NEXT:    [[TMP70:%.*]] = extractelement <8 x ptr> [[TMP21]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP70]], align 16
...
; CHECK-NEXT:    [[TMP71:%.*]] = extractelement <8 x ptr> [[TMP24]], i32 0
; CHECK-NEXT:    store i32 8, ptr [[TMP71]], align 8
...
; CHECK-NEXT:    [[BC_RESUME_VAL18:%.*]] = phi i64 [ [[IND_END8]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[IND_END9]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 8, %[[ITER_CHECK]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL19:%.*]] = phi i64 [ [[IND_END11]], %[[VEC_EPILOG_MIDDLE_BLOCK]] ], [ [[IND_END12]], %[[VEC_EPILOG_ITER_CHECK]] ], [ 0, %[[ITER_CHECK]] ]
...
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK25]], label %[[VEC_EPILOG_SCALAR_PH43:.*]], label %[[VECTOR_MAIN_LOOP_ITER_CHECK25:.*]]
; CHECK:       [[VECTOR_MAIN_LOOP_ITER_CHECK25]]:
; CHECK-NEXT:    [[MIN_ITERS_CHECK28:%.*]] = icmp ult i64 [[TMP28]], 16
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK28]], label %[[VEC_EPILOG_PH46:.*]], label %[[VECTOR_PH26:.*]]
; CHECK:       [[VECTOR_PH26]]:
...
; CHECK:       [[VECTOR_BODY31]]:
; CHECK-NEXT:    [[INDEX34:%.*]] = phi i64 [ 0, %[[VECTOR_PH26]] ], [ [[INDEX_NEXT39:%.*]], %[[VECTOR_BODY31]] ]
; CHECK-NEXT:    [[VEC_IND35:%.*]] = phi <16 x i64> [ <i64 8, i64 10, i64 12, i64 14, i64 16, i64 18, i64 20, i64 22, i64 24, i64 26, i64 28, i64 30, i64 32, i64 34, i64 36, i64 38>, %[[VECTOR_PH26]] ], [ [[VEC_IND_NEXT36:%.*]], %[[VECTOR_BODY31]] ]
; CHECK-NEXT:    [[VEC_IND37:%.*]] = phi <16 x i64> [ <i64 0, i64 2, i64 4, i64 6, i64 8, i64 10, i64 12, i64 14, i64 16, i64 18, i64 20, i64 22, i64 24, i64 26, i64 28, i64 30>, %[[VECTOR_PH26]] ], [ [[VEC_IND_NEXT38:%.*]], %[[VECTOR_BODY31]] ]
...
; CHECK-NEXT:    br i1 [[TMP41]], label %[[MIDDLE_BLOCK38:.*]], label %[[VECTOR_BODY31]], !llvm.loop [[LOOP5:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK38]]:
; CHECK-NEXT:    [[CMP_N40:%.*]] = icmp eq i64 [[TMP28]], [[N_VEC32]]
; CHECK-NEXT:    br i1 [[CMP_N40]], label %[[FOR_COND_CLEANUP_LOOPEXIT:.*]], label %[[VEC_EPILOG_ITER_CHECK44:.*]]
; CHECK:       [[VEC_EPILOG_ITER_CHECK44]]:
...
; CHECK-NEXT:    br i1 [[MIN_EPILOG_ITERS_CHECK50]], label %[[VEC_EPILOG_SCALAR_PH43]], label %[[VEC_EPILOG_PH46]], !prof [[PROF6:![0-9]+]]
; CHECK:       [[VEC_EPILOG_PH46]]:
; CHECK-NEXT:    [[VEC_EPILOG_RESUME_VAL40:%.*]] = phi i64 [ [[N_VEC32]], %[[VEC_EPILOG_ITER_CHECK44]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK25]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL42:%.*]] = phi i64 [ [[IND_END41]], %[[VEC_EPILOG_ITER_CHECK44]] ], [ 8, %[[VECTOR_MAIN_LOOP_ITER_CHECK25]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL44:%.*]] = phi i64 [ [[IND_END43]], %[[VEC_EPILOG_ITER_CHECK44]] ], [ 0, %[[VECTOR_MAIN_LOOP_ITER_CHECK25]] ]
...
; CHECK-NEXT:    br label %[[VEC_EPILOG_VECTOR_BODY57:.*]]
; CHECK:       [[VEC_EPILOG_VECTOR_BODY57]]:
; CHECK-NEXT:    [[INDEX61:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL40]], %[[VEC_EPILOG_PH46]] ], [ [[INDEX_NEXT74:%.*]], %[[VEC_EPILOG_VECTOR_BODY57]] ]
; CHECK-NEXT:    [[VEC_IND65:%.*]] = phi <8 x i64> [ [[INDUCTION64]], %[[VEC_EPILOG_PH46]] ], [ [[VEC_IND_NEXT66:%.*]], %[[VEC_EPILOG_VECTOR_BODY57]] ]
; CHECK-NEXT:    [[VEC_IND70:%.*]] = phi <8 x i64> [ [[INDUCTION69]], %[[VEC_EPILOG_PH46]] ], [ [[VEC_IND_NEXT71:%.*]], %[[VEC_EPILOG_VECTOR_BODY57]] ]
...
; CHECK-NEXT:    br i1 [[TMP55]], label %[[VEC_EPILOG_MIDDLE_BLOCK64:.*]], label %[[VEC_EPILOG_VECTOR_BODY57]], !llvm.loop [[LOOP7:![0-9]+]]
; CHECK:       [[VEC_EPILOG_MIDDLE_BLOCK64]]:
; CHECK-NEXT:    [[CMP_N65:%.*]] = icmp eq i64 [[TMP28]], [[N_VEC53]]
; CHECK-NEXT:    br i1 [[CMP_N65]], label %[[FOR_COND_CLEANUP_LOOPEXIT]], label %[[VEC_EPILOG_SCALAR_PH43]]
; CHECK:       [[VEC_EPILOG_SCALAR_PH43]]:
; CHECK-NEXT:    [[BC_RESUME_VAL66:%.*]] = phi i64 [ [[IND_END54]], %[[VEC_EPILOG_MIDDLE_BLOCK64]] ], [ [[IND_END55]], %[[VEC_EPILOG_ITER_CHECK44]] ], [ 8, %[[ITER_CHECK23]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL67:%.*]] = phi i64 [ [[IND_END57]], %[[VEC_EPILOG_MIDDLE_BLOCK64]] ], [ [[IND_END58]], %[[VEC_EPILOG_ITER_CHECK44]] ], [ 0, %[[ITER_CHECK23]] ]
; CHECK-NEXT:    br label %[[FOR_BODY_US:.*]]
; CHECK:       [[FOR_BODY_US]]:
; CHECK-NEXT:    [[INDVARS_IV78:%.*]] = phi i64 [ [[INDVARS_IV_NEXT79:%.*]], %[[FOR_COND_CLEANUP4_US_LCSSA_US_US:.*]] ], [ [[BC_RESUME_VAL66]], %[[VEC_EPILOG_SCALAR_PH43]] ]
; CHECK-NEXT:    [[INDVARS_IV70:%.*]] = phi i64 [ [[INDVARS_IV_NEXT71:%.*]], %[[FOR_COND_CLEANUP4_US_LCSSA_US_US]] ], [ [[BC_RESUME_VAL67]], %[[VEC_EPILOG_SCALAR_PH43]] ]
...
; CHECK-NEXT:    ret void
; CHECK:       [[FOR_BODY]]:
; CHECK-NEXT:    [[INDVARS_IV95:%.*]] = phi i64 [ [[INDVARS_IV_NEXT96:%.*]], %[[FOR_BODY]] ], [ [[BC_RESUME_VAL18]], %[[VEC_EPILOG_SCALAR_PH]] ]
; CHECK-NEXT:    [[INDVARS_IV87:%.*]] = phi i64 [ [[INDVARS_IV_NEXT88:%.*]], %[[FOR_BODY]] ], [ [[BC_RESUME_VAL19]], %[[VEC_EPILOG_SCALAR_PH]] ]
