...
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <4 x float> poison, float [[TMP71]], i64 0
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <4 x float> [[TMP28]], float [[TMP72]], i64 1
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <4 x float> [[TMP29]], float [[TMP73]], i64 2
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <4 x float> [[TMP30]], float [[TMP74]], i64 3
