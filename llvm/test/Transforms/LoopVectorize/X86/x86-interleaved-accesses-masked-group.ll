...
; RUN: opt -mcpu=skx -S -passes=loop-vectorize -force-vector-width=8 -force-vector-interleave=1 -enable-interleaved-mem-accesses < %s | FileCheck %s -check-prefix=DISABLED_MASKED_STRIDED
...
; DISABLED_MASKED_STRIDED-NEXT:    [[N_MOD_VF:%.*]] = urem i32 [[N_RND_UP]], 8
...
; ENABLED_MASKED_STRIDED-NEXT:    [[N_MOD_VF:%.*]] = urem i32 [[N_RND_UP]], 8
