...
; RUN: opt -mcpu=skx -S -passes=loop-vectorize -force-vector-width=8 -force-vector-interleave=1 -enable-interleaved-mem-accesses -enable-masked-interleaved-mem-accesses=0 < %s | FileCheck %s -check-prefix=DISABLED_MASKED_STRIDED
; RUN: opt -mcpu=skx -S -passes=loop-vectorize -force-vector-width=8 -force-vector-interleave=1 -enable-interleaved-mem-accesses < %s | FileCheck %s -check-prefix=ENABLED_MASKED_STRIDED
; RUN: opt -mcpu=skx -S -passes=loop-vectorize -force-vector-width=8 -force-vector-interleave=1 -enable-interleaved-mem-accesses  -enable-masked-interleaved-mem-accesses < %s | FileCheck %s -check-prefix=ENABLED_MASKED_STRIDED
...
; DISABLED_MASKED_STRIDED-NEXT:  [[VECTOR_PH:.*:]]
; DISABLED_MASKED_STRIDED-NEXT:    [[CONV:%.*]] = zext i8 [[GUARD]] to i32
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH1:.*]]
; DISABLED_MASKED_STRIDED:       [[VECTOR_PH1]]:
...
; DISABLED_MASKED_STRIDED-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_LOAD_CONTINUE14:.*]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[VEC_IND:%.*]] = phi <8 x i32> [ <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, %[[VECTOR_PH1]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_LOAD_CONTINUE14]] ]
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP51]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP4]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; ENABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[SCALAR_PH:.*]]
; ENABLED_MASKED_STRIDED:       [[SCALAR_PH]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_BODY:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_BODY]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[IX_09:%.*]] = phi i32 [ 1016, %[[SCALAR_PH]] ], [ [[INC:%.*]], %[[FOR_INC:.*]] ]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[VEC_IND_NEXT]] = add nuw nsw <8 x i32> [[VEC_IND]], splat (i32 8)
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP51:%.*]] = icmp eq i32 [[INDEX_NEXT]], 1024
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP51]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; DISABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_END]]:
; DISABLED_MASKED_STRIDED-NEXT:    ret void
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP5]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; ENABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP9]], label %[[FOR_BODY_LR_PH:.*]], label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_BODY_LR_PH]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[CONV:%.*]] = zext i8 [[GUARD]] to i32
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP9]], label %[[FOR_BODY_LR_PH:.*]], label %[[FOR_END:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_BODY_LR_PH]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[CONV:%.*]] = zext i8 [[GUARD]] to i32
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH:.*]]
; ENABLED_MASKED_STRIDED:       [[VECTOR_PH]]:
...
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_BODY:.*]]
; DISABLED_MASKED_STRIDED:       [[VECTOR_BODY]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[VEC_IND:%.*]] = phi <8 x i32> [ <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[VECTOR_BODY]] ]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP1]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP3:%.*]] = extractelement <8 x i32> [[TMP0]], i64 1
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP3]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP5:%.*]] = extractelement <8 x i32> [[TMP0]], i64 2
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP5]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP7:%.*]] = extractelement <8 x i32> [[TMP0]], i64 3
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP7]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP35:%.*]] = extractelement <8 x i32> [[TMP0]], i64 4
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP35]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP36:%.*]] = extractelement <8 x i32> [[TMP0]], i64 5
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP36]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP37:%.*]] = extractelement <8 x i32> [[TMP0]], i64 6
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP37]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP38:%.*]] = extractelement <8 x i32> [[TMP0]], i64 7
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i8, ptr [[P]], i32 [[TMP38]]
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP34]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; DISABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_END]]:
; DISABLED_MASKED_STRIDED-NEXT:    ret void
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP3]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP7:![0-9]+]]
; ENABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_END:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_END]]:
; ENABLED_MASKED_STRIDED-NEXT:    ret void
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP6]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP6]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
...
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_BODY:.*]]
; DISABLED_MASKED_STRIDED:       [[VECTOR_BODY]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE60:.*]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[VEC_IND:%.*]] = phi <8 x i32> [ <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, %[[VECTOR_PH1]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_STORE_CONTINUE60]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP0:%.*]] = icmp ugt <8 x i32> [[VEC_IND]], [[BROADCAST_SPLAT]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP1:%.*]] = shl nuw nsw <8 x i32> [[VEC_IND]], splat (i32 1)
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP2:%.*]] = extractelement <8 x i1> [[TMP0]], i64 0
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP2]], label %[[PRED_LOAD_IF:.*]], label %[[PRED_LOAD_CONTINUE:.*]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP93:%.*]] = phi <8 x i8> [ [[TMP92]], %[[PRED_LOAD_CONTINUE28]] ], [ [[TMP97]], %[[PRED_LOAD_IF29]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP98:%.*]] = icmp slt <8 x i8> [[TMP49]], [[TMP93]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP99:%.*]] = select <8 x i1> [[TMP98]], <8 x i8> [[TMP93]], <8 x i8> [[TMP49]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP134:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP133]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP146:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP145]]
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP157]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP8:![0-9]+]]
; DISABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_END]]:
; DISABLED_MASKED_STRIDED-NEXT:    ret void
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP6]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP9:![0-9]+]]
; ENABLED_MASKED_STRIDED:       [[MIDDLE_BLOCK]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[FOR_END:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_END]]:
; ENABLED_MASKED_STRIDED-NEXT:    ret void
...
; DISABLED_MASKED_STRIDED:       [[VECTOR_BODY]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE60:.*]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[VEC_IND:%.*]] = phi <8 x i32> [ <i32 1024, i32 1023, i32 1022, i32 1021, i32 1020, i32 1019, i32 1018, i32 1017>, %[[VECTOR_PH1]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_STORE_CONTINUE60]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP0:%.*]] = icmp ugt <8 x i32> [[VEC_IND]], [[BROADCAST_SPLAT]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP1:%.*]] = shl nuw nsw <8 x i32> [[VEC_IND]], splat (i32 1)
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP2:%.*]] = extractelement <8 x i1> [[TMP0]], i64 0
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[TMP2]], label %[[PRED_LOAD_IF:.*]], label %[[PRED_LOAD_CONTINUE:.*]]
...
; ENABLED_MASKED_STRIDED-SAME: ptr noalias readonly captures(none) [[P:%.*]], ptr noalias captures(none) [[Q:%.*]], i8 zeroext [[GUARD:%.*]]) #[[ATTR0]] {
; ENABLED_MASKED_STRIDED-NEXT:  [[VECTOR_PH:.*:]]
; ENABLED_MASKED_STRIDED-NEXT:    [[CONV:%.*]] = zext i8 [[GUARD]] to i32
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH1:.*]]
; ENABLED_MASKED_STRIDED:       [[VECTOR_PH1]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <8 x i32> poison, i32 [[CONV]], i64 0
; ENABLED_MASKED_STRIDED-NEXT:    [[BROADCAST_SPLAT:%.*]] = shufflevector <8 x i32> [[BROADCAST_SPLATINSERT]], <8 x i32> poison, <8 x i32> zeroinitializer
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_BODY:.*]]
; ENABLED_MASKED_STRIDED:       [[VECTOR_BODY]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_PH1]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE60:.*]] ]
; ENABLED_MASKED_STRIDED-NEXT:    [[VEC_IND:%.*]] = phi <8 x i32> [ <i32 1024, i32 1023, i32 1022, i32 1021, i32 1020, i32 1019, i32 1018, i32 1017>, %[[VECTOR_PH1]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_STORE_CONTINUE60]] ]
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP0:%.*]] = icmp ugt <8 x i32> [[VEC_IND]], [[BROADCAST_SPLAT]]
...
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP93:%.*]] = phi <8 x i8> [ [[TMP92]], %[[PRED_LOAD_CONTINUE28]] ], [ [[TMP97]], %[[PRED_LOAD_IF29]] ]
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP98:%.*]] = icmp slt <8 x i8> [[TMP49]], [[TMP93]]
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP99:%.*]] = select <8 x i1> [[TMP98]], <8 x i8> [[TMP93]], <8 x i8> [[TMP49]]
...
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP134:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP133]]
...
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP137:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP136]]
...
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP146:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP145]]
...
; ENABLED_MASKED_STRIDED-NEXT:    [[TMP149:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP148]]
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP22]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_BODY_PREHEADER]]:
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH:.*]]
; DISABLED_MASKED_STRIDED:       [[VECTOR_PH]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[N_RND_UP:%.*]] = add i32 [[N]], 7
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP95:%.*]] = phi <8 x i8> [ [[TMP94]], %[[PRED_LOAD_CONTINUE30]] ], [ [[TMP99]], %[[PRED_LOAD_IF31]] ]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP100:%.*]] = icmp slt <8 x i8> [[TMP51]], [[TMP95]]
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP101:%.*]] = select <8 x i1> [[TMP100]], <8 x i8> [[TMP95]], <8 x i8> [[TMP51]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP136:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP135]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP142:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP141]]
...
; DISABLED_MASKED_STRIDED-NEXT:    [[TMP154:%.*]] = getelementptr inbounds i8, ptr [[Q]], i32 [[TMP153]]
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP22]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_BODY_PREHEADER]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH:.*]]
; ENABLED_MASKED_STRIDED:       [[VECTOR_PH]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[N_RND_UP:%.*]] = add i32 [[N]], 7
...
; DISABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP20]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
; DISABLED_MASKED_STRIDED:       [[FOR_BODY_PREHEADER]]:
; DISABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH:.*]]
; DISABLED_MASKED_STRIDED:       [[VECTOR_PH]]:
; DISABLED_MASKED_STRIDED-NEXT:    [[N_RND_UP:%.*]] = add i32 [[N]], 7
...
; ENABLED_MASKED_STRIDED-NEXT:    br i1 [[CMP20]], label %[[FOR_BODY_PREHEADER:.*]], label %[[FOR_END:.*]]
; ENABLED_MASKED_STRIDED:       [[FOR_BODY_PREHEADER]]:
; ENABLED_MASKED_STRIDED-NEXT:    br label %[[VECTOR_PH:.*]]
; ENABLED_MASKED_STRIDED:       [[VECTOR_PH]]:
; ENABLED_MASKED_STRIDED-NEXT:    [[N_RND_UP:%.*]] = add i32 [[N]], 7
