...
; RUN: opt -S -mtriple=x86_64-pc_linux -passes=loop-vectorize < %s | FileCheck %s --check-prefix=SSE
; RUN: opt -S -mtriple=x86_64-pc_linux -passes=loop-vectorize -mcpu=sandybridge < %s | FileCheck %s --check-prefix=AVX1
; RUN: opt -S -mtriple=x86_64-pc_linux -passes=loop-vectorize -mcpu=haswell < %s | FileCheck %s --check-prefix=AVX2
; RUN: opt -S -mtriple=x86_64-pc_linux -passes=loop-vectorize -mcpu=slm < %s | FileCheck %s --check-prefix=SSE
; RUN: opt -S -mtriple=x86_64-pc_linux -passes=loop-vectorize -mcpu=atom < %s | FileCheck %s --check-prefix=ATOM
...
; SSE-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 4
; SSE-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[INDEX]], 1
; SSE-NEXT:    [[TMP9:%.*]] = shl nsw i64 [[TMP0]], 1
...
; SSE-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i32, ptr [[TMP6]], i64 4
...
; AVX1-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 4
; AVX1-NEXT:    [[TMP1:%.*]] = add i64 [[INDEX]], 8
; AVX1-NEXT:    [[TMP2:%.*]] = add i64 [[INDEX]], 12
; AVX1-NEXT:    [[TMP3:%.*]] = shl nsw i64 [[INDEX]], 1
; AVX1-NEXT:    [[TMP4:%.*]] = shl nsw i64 [[TMP0]], 1
; AVX1-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[TMP1]], 1
; AVX1-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[TMP2]], 1
; AVX1-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[B:%.*]], i64 [[TMP3]]
; AVX1-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 [[TMP4]]
...
; AVX1-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 4
; AVX1-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 8
; AVX1-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 12
...
; AVX2-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 8
; AVX2-NEXT:    [[TMP1:%.*]] = add i64 [[INDEX]], 16
; AVX2-NEXT:    [[TMP2:%.*]] = add i64 [[INDEX]], 24
; AVX2-NEXT:    [[TMP3:%.*]] = shl nsw i64 [[INDEX]], 1
; AVX2-NEXT:    [[TMP4:%.*]] = shl nsw i64 [[TMP0]], 1
; AVX2-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[TMP1]], 1
; AVX2-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[TMP2]], 1
; AVX2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[B:%.*]], i64 [[TMP3]]
; AVX2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i32, ptr [[B]], i64 [[TMP4]]
...
; AVX2-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 8
; AVX2-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 16
; AVX2-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i32, ptr [[TMP14]], i64 24
...
; ATOM-NEXT:    [[TMP0:%.*]] = shl nsw i64 [[INDVARS_IV]], 1
