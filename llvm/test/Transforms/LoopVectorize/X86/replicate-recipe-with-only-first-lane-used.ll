...
; CHECK-NEXT:    [[TMP36:%.*]] = extractelement <4 x i1> [[BROADCAST_SPLAT]], i32 0
; CHECK-NEXT:    [[TMP23:%.*]] = select i1 [[TMP36]], <4 x float> splat (float 1.000000e+01), <4 x float> splat (float 1.000000e+00)
