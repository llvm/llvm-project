...
; CHECK-NEXT:    [[TMP58:%.*]] = load i1, ptr [[TMP30]], align 1
; CHECK-NEXT:    [[TMP59:%.*]] = load i1, ptr [[TMP31]], align 1
; CHECK-NEXT:    [[TMP64:%.*]] = insertelement <4 x i1> poison, i1 [[TMP32]], i32 0
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i1> [[TMP64]], i1 [[TMP33]], i32 1
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <4 x i1> [[TMP69]], i1 [[TMP34]], i32 2
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x i1> [[TMP74]], i1 [[TMP35]], i32 3
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <4 x i1> poison, i1 [[TMP40]], i32 0
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <4 x i1> [[TMP52]], i1 [[TMP41]], i32 1
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <4 x i1> [[TMP53]], i1 [[TMP42]], i32 2
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <4 x i1> [[TMP54]], i1 [[TMP43]], i32 3
; CHECK-NEXT:    [[TMP79:%.*]] = insertelement <4 x i1> poison, i1 [[TMP48]], i32 0
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <4 x i1> [[TMP79]], i1 [[TMP49]], i32 1
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x i1> [[TMP84]], i1 [[TMP50]], i32 2
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <4 x i1> [[TMP89]], i1 [[TMP51]], i32 3
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <4 x i1> poison, i1 [[TMP56]], i32 0
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <4 x i1> [[TMP60]], i1 [[TMP57]], i32 1
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <4 x i1> [[TMP61]], i1 [[TMP58]], i32 2
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i1> [[TMP62]], i1 [[TMP59]], i32 3
...
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <4 x i1> poison, i1 [[TMP16]], i32 0
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <4 x i1> [[TMP60]], i1 [[TMP17]], i32 1
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <4 x i1> [[TMP61]], i1 [[TMP18]], i32 2
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i1> [[TMP62]], i1 [[TMP19]], i32 3
