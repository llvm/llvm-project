...
; I64-NEXT:    [[TMP9:%.*]] = getelementptr double, ptr [[PTR_B]], i64 [[TMP7]]
; I64-NEXT:    [[TMP10:%.*]] = load double, ptr [[PTR_A]], align 8
; I64-NEXT:    [[TMP11:%.*]] = fadd double [[TMP10]], 0.000000e+00
; I64-NEXT:    [[BROADCAST_SPLATINSERT:%.*]] = insertelement <2 x double> poison, double [[TMP11]], i64 0
...
; I64-NEXT:    [[TMP18:%.*]] = fmul <2 x double> [[BROADCAST_SPLAT]], zeroinitializer
