...
; IF-EVL-NEXT:    [[N_VEC:%.*]] = and i64 [[N_RND_UP]], -16
...
; IF-EVL-NEXT:    [[VEC_IV:%.*]] = phi <16 x i64> [ <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; NO-VP-NEXT:    [[N_MOD_VF:%.*]] = sub i64 [[N]], [[N_VEC]]
...
; NO-VP-NEXT:    [[N_VEC10:%.*]] = and i64 [[N]], -8
