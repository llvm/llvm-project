...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT16:%.*]] = insertelement <4 x i1> poison, i1 [[TMP1]], i64 0
...
; CHECK-NEXT:    [[VEC_PHI1:%.*]] = phi <4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP25:%.*]], %[[PRED_SDIV_CONTINUE17]] ]
...
; CHECK-NEXT:    [[TMP24]] = or <4 x i1> [[VEC_PHI]], [[BROADCAST_SPLAT17]]
; CHECK-NEXT:    [[TMP25]] = or <4 x i1> [[VEC_PHI1]], [[BROADCAST_SPLAT17]]
