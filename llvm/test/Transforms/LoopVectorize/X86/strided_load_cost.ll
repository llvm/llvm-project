...
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <8 x i32> poison, i32 [[TMP72]], i64 0
; CHECK-NEXT:    [[TMP83:%.*]] = insertelement <8 x i32> [[TMP82]], i32 [[TMP73]], i64 1
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <8 x i32> [[TMP83]], i32 [[TMP74]], i64 2
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <8 x i32> [[TMP84]], i32 [[TMP75]], i64 3
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <8 x i32> [[TMP85]], i32 [[TMP76]], i64 4
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <8 x i32> [[TMP86]], i32 [[TMP77]], i64 5
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <8 x i32> [[TMP80]], i32 [[TMP78]], i64 6
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <8 x i32> [[TMP81]], i32 [[TMP79]], i64 7
...
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <8 x i32> poison, i32 [[TMP88]], i64 0
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <8 x i32> [[TMP98]], i32 [[TMP89]], i64 1
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <8 x i32> [[TMP99]], i32 [[TMP90]], i64 2
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <8 x i32> [[TMP100]], i32 [[TMP91]], i64 3
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <8 x i32> [[TMP101]], i32 [[TMP92]], i64 4
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <8 x i32> [[TMP102]], i32 [[TMP93]], i64 5
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <8 x i32> [[TMP96]], i32 [[TMP94]], i64 6
; CHECK-NEXT:    [[TMP103:%.*]] = insertelement <8 x i32> [[TMP97]], i32 [[TMP95]], i64 7
...
; CHECK-NEXT:    [[TMP114:%.*]] = insertelement <8 x i32> poison, i32 [[TMP104]], i64 0
; CHECK-NEXT:    [[TMP115:%.*]] = insertelement <8 x i32> [[TMP114]], i32 [[TMP105]], i64 1
; CHECK-NEXT:    [[TMP116:%.*]] = insertelement <8 x i32> [[TMP115]], i32 [[TMP106]], i64 2
; CHECK-NEXT:    [[TMP117:%.*]] = insertelement <8 x i32> [[TMP116]], i32 [[TMP107]], i64 3
; CHECK-NEXT:    [[TMP118:%.*]] = insertelement <8 x i32> [[TMP117]], i32 [[TMP108]], i64 4
; CHECK-NEXT:    [[TMP112:%.*]] = insertelement <8 x i32> [[TMP118]], i32 [[TMP109]], i64 5
; CHECK-NEXT:    [[TMP113:%.*]] = insertelement <8 x i32> [[TMP112]], i32 [[TMP110]], i64 6
; CHECK-NEXT:    [[TMP119:%.*]] = insertelement <8 x i32> [[TMP113]], i32 [[TMP111]], i64 7
...
; CHECK-NEXT:    [[TMP130:%.*]] = insertelement <8 x i32> poison, i32 [[TMP120]], i64 0
; CHECK-NEXT:    [[TMP131:%.*]] = insertelement <8 x i32> [[TMP130]], i32 [[TMP121]], i64 1
; CHECK-NEXT:    [[TMP132:%.*]] = insertelement <8 x i32> [[TMP131]], i32 [[TMP122]], i64 2
; CHECK-NEXT:    [[TMP133:%.*]] = insertelement <8 x i32> [[TMP132]], i32 [[TMP123]], i64 3
; CHECK-NEXT:    [[TMP134:%.*]] = insertelement <8 x i32> [[TMP133]], i32 [[TMP124]], i64 4
; CHECK-NEXT:    [[TMP128:%.*]] = insertelement <8 x i32> [[TMP134]], i32 [[TMP125]], i64 5
; CHECK-NEXT:    [[TMP129:%.*]] = insertelement <8 x i32> [[TMP128]], i32 [[TMP126]], i64 6
; CHECK-NEXT:    [[TMP135:%.*]] = insertelement <8 x i32> [[TMP129]], i32 [[TMP127]], i64 7
...
; CHECK-NEXT:    [[TMP153:%.*]] = insertelement <4 x i32> zeroinitializer, i32 [[BC_MERGE_RDX]], i64 0
...
; MAX-BW-NEXT:    [[TMP82:%.*]] = insertelement <8 x i32> poison, i32 [[TMP72]], i64 0
; MAX-BW-NEXT:    [[TMP83:%.*]] = insertelement <8 x i32> [[TMP82]], i32 [[TMP73]], i64 1
; MAX-BW-NEXT:    [[TMP84:%.*]] = insertelement <8 x i32> [[TMP83]], i32 [[TMP74]], i64 2
; MAX-BW-NEXT:    [[TMP85:%.*]] = insertelement <8 x i32> [[TMP84]], i32 [[TMP75]], i64 3
; MAX-BW-NEXT:    [[TMP86:%.*]] = insertelement <8 x i32> [[TMP85]], i32 [[TMP76]], i64 4
; MAX-BW-NEXT:    [[TMP80:%.*]] = insertelement <8 x i32> [[TMP86]], i32 [[TMP77]], i64 5
; MAX-BW-NEXT:    [[TMP81:%.*]] = insertelement <8 x i32> [[TMP80]], i32 [[TMP78]], i64 6
; MAX-BW-NEXT:    [[TMP87:%.*]] = insertelement <8 x i32> [[TMP81]], i32 [[TMP79]], i64 7
...
; MAX-BW-NEXT:    [[TMP98:%.*]] = insertelement <8 x i32> poison, i32 [[TMP88]], i64 0
; MAX-BW-NEXT:    [[TMP99:%.*]] = insertelement <8 x i32> [[TMP98]], i32 [[TMP89]], i64 1
; MAX-BW-NEXT:    [[TMP100:%.*]] = insertelement <8 x i32> [[TMP99]], i32 [[TMP90]], i64 2
; MAX-BW-NEXT:    [[TMP101:%.*]] = insertelement <8 x i32> [[TMP100]], i32 [[TMP91]], i64 3
; MAX-BW-NEXT:    [[TMP102:%.*]] = insertelement <8 x i32> [[TMP101]], i32 [[TMP92]], i64 4
; MAX-BW-NEXT:    [[TMP96:%.*]] = insertelement <8 x i32> [[TMP102]], i32 [[TMP93]], i64 5
; MAX-BW-NEXT:    [[TMP97:%.*]] = insertelement <8 x i32> [[TMP96]], i32 [[TMP94]], i64 6
; MAX-BW-NEXT:    [[TMP103:%.*]] = insertelement <8 x i32> [[TMP97]], i32 [[TMP95]], i64 7
...
; MAX-BW-NEXT:    [[TMP114:%.*]] = insertelement <8 x i32> poison, i32 [[TMP104]], i64 0
; MAX-BW-NEXT:    [[TMP115:%.*]] = insertelement <8 x i32> [[TMP114]], i32 [[TMP105]], i64 1
; MAX-BW-NEXT:    [[TMP116:%.*]] = insertelement <8 x i32> [[TMP115]], i32 [[TMP106]], i64 2
; MAX-BW-NEXT:    [[TMP117:%.*]] = insertelement <8 x i32> [[TMP116]], i32 [[TMP107]], i64 3
; MAX-BW-NEXT:    [[TMP118:%.*]] = insertelement <8 x i32> [[TMP117]], i32 [[TMP108]], i64 4
; MAX-BW-NEXT:    [[TMP112:%.*]] = insertelement <8 x i32> [[TMP118]], i32 [[TMP109]], i64 5
; MAX-BW-NEXT:    [[TMP113:%.*]] = insertelement <8 x i32> [[TMP112]], i32 [[TMP110]], i64 6
; MAX-BW-NEXT:    [[TMP119:%.*]] = insertelement <8 x i32> [[TMP113]], i32 [[TMP111]], i64 7
...
; MAX-BW-NEXT:    [[TMP130:%.*]] = insertelement <8 x i32> poison, i32 [[TMP120]], i64 0
; MAX-BW-NEXT:    [[TMP131:%.*]] = insertelement <8 x i32> [[TMP130]], i32 [[TMP121]], i64 1
; MAX-BW-NEXT:    [[TMP132:%.*]] = insertelement <8 x i32> [[TMP131]], i32 [[TMP122]], i64 2
; MAX-BW-NEXT:    [[TMP133:%.*]] = insertelement <8 x i32> [[TMP132]], i32 [[TMP123]], i64 3
; MAX-BW-NEXT:    [[TMP134:%.*]] = insertelement <8 x i32> [[TMP133]], i32 [[TMP124]], i64 4
; MAX-BW-NEXT:    [[TMP128:%.*]] = insertelement <8 x i32> [[TMP134]], i32 [[TMP125]], i64 5
; MAX-BW-NEXT:    [[TMP129:%.*]] = insertelement <8 x i32> [[TMP128]], i32 [[TMP126]], i64 6
; MAX-BW-NEXT:    [[TMP135:%.*]] = insertelement <8 x i32> [[TMP129]], i32 [[TMP127]], i64 7
...
; MAX-BW-NEXT:    [[TMP153:%.*]] = insertelement <4 x i32> zeroinitializer, i32 [[BC_MERGE_RDX]], i64 0
