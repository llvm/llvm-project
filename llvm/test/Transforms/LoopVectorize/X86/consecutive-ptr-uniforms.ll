...
; REQUIRES: asserts
; RUN: opt < %s -aa-pipeline=basic-aa -passes=loop-vectorize -S -debug-only=loop-vectorize 2>%t -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP6:%.*]] = mul nuw nsw i64 [[INDEX]], 5
...
; FORCE-NEXT:    [[OFFSET_IDX:%.*]] = mul nuw nsw i64 [[INDEX]], 5
...
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [3 x i32], ptr @a, i32 0, i32 [[TMP0]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX1]], align 1
; CHECK-NEXT:    [[CMP2:%.*]] = icmp eq i32 [[TMP1]], 0
