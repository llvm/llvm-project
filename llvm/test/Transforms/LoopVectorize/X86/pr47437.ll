...
; SSE2:       vector.ph:
; SSE2-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
...
; SSE41:       vector.ph:
; SSE41-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -8
...
; AVX1-NEXT:    [[N_VEC25:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
...
; AVX2:       vector.ph:
; AVX2-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -8
