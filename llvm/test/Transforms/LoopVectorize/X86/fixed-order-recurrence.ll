...
; CHECK-NEXT:    [[TMP19:%.*]] = insertelement <4 x ptr> poison, ptr [[TMP13]], i32 0
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <4 x ptr> [[TMP19]], ptr [[TMP14]], i32 1
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <4 x ptr> [[TMP42]], ptr [[TMP15]], i32 2
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <4 x ptr> [[TMP43]], ptr [[TMP16]], i32 3
