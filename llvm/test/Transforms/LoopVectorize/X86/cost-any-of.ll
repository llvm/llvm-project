...
; CHECK-NEXT:    [[TMP8:%.*]] = freeze <16 x float> [[WIDE_LOAD]]
; CHECK-NEXT:    [[TMP9:%.*]] = freeze <16 x float> [[WIDE_LOAD4]]
; CHECK-NEXT:    [[TMP22:%.*]] = freeze <16 x float> [[WIDE_LOAD5]]
; CHECK-NEXT:    [[TMP23:%.*]] = freeze <16 x float> [[WIDE_LOAD6]]
; CHECK-NEXT:    [[TMP4]] = call <16 x float> @llvm.minnum.v16f32(<16 x float> [[VEC_PHI]], <16 x float> [[TMP8]])
; CHECK-NEXT:    [[TMP5]] = call <16 x float> @llvm.minnum.v16f32(<16 x float> [[VEC_PHI1]], <16 x float> [[TMP9]])
; CHECK-NEXT:    [[TMP6]] = call <16 x float> @llvm.minnum.v16f32(<16 x float> [[VEC_PHI2]], <16 x float> [[TMP22]])
; CHECK-NEXT:    [[TMP7]] = call <16 x float> @llvm.minnum.v16f32(<16 x float> [[VEC_PHI3]], <16 x float> [[TMP23]])
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 64
; CHECK-NEXT:    [[TMP10:%.*]] = fcmp uno <16 x float> [[TMP8]], [[TMP9]]
; CHECK-NEXT:    [[TMP11:%.*]] = fcmp uno <16 x float> [[TMP22]], [[TMP23]]
