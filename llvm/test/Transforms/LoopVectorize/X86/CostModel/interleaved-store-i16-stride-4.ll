...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 17 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:  Cost of 34 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:  Cost of 68 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:  Cost of 136 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 17 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 34 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 68 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 140 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 280 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
;
; AVX2-LABEL: 'test'
; AVX2:  Cost of 3 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 7 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 12 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 36 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 72 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
;
; AVX512DQ-LABEL: 'test'
; AVX512DQ:  Cost of 3 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
...
; AVX512DQ:  Cost of 7 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 11 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 34 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 68 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 568 for VF 64: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
;
; AVX512BW-LABEL: 'test'
; AVX512BW:  Cost of 8 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
...
; AVX512BW:  Cost of 8 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 8 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 17 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 34 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 68 for VF 64: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
