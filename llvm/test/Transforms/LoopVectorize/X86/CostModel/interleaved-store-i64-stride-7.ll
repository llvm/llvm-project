...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 50 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; SSE2:  Cost of 100 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
; SSE2:    store ir<%v5> to index 5
; SSE2:    store ir<%v6> to index 6
; SSE2:  Cost of 200 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
; SSE2:    store ir<%v5> to index 5
; SSE2:    store ir<%v6> to index 6
; SSE2:  Cost of 400 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 36 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX1:  Cost of 77 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 154 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 308 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 616 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
;
; AVX2-LABEL: 'test'
; AVX2:  Cost of 36 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX2:  Cost of 77 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 154 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 308 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 616 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
;
; AVX512-LABEL: 'test'
; AVX512:  Cost of 32 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
