...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 57 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; SSE2:  Cost of 112 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
; SSE2:    store ir<%v5> to index 5
; SSE2:    store ir<%v6> to index 6
; SSE2:  Cost of 225 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
; SSE2:    store ir<%v5> to index 5
; SSE2:    store ir<%v6> to index 6
; SSE2:  Cost of 456 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 34 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX1:  Cost of 63 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 119 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 232 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX1:    store ir<%v5> to index 5
; AVX1:    store ir<%v6> to index 6
; AVX1:  Cost of 469 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
;
; AVX2-LABEL: 'test'
; AVX2:  Cost of 34 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX2:  Cost of 63 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 119 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 232 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v5> to index 5
; AVX2:    store ir<%v6> to index 6
; AVX2:  Cost of 469 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
...
;
; AVX512DQ-LABEL: 'test'
; AVX512DQ:  Cost of 34 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX512DQ:  Cost of 63 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
...
; AVX512DQ:    store ir<%v5> to index 5
; AVX512DQ:    store ir<%v6> to index 6
; AVX512DQ:  Cost of 121 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
...
; AVX512DQ:    store ir<%v5> to index 5
; AVX512DQ:    store ir<%v6> to index 6
; AVX512DQ:  Cost of 234 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
...
; AVX512DQ:    store ir<%v5> to index 5
; AVX512DQ:    store ir<%v6> to index 6
; AVX512DQ:  Cost of 470 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
...
; AVX512DQ:    store ir<%v5> to index 5
; AVX512DQ:    store ir<%v6> to index 6
; AVX512DQ:  Cost of 945 for VF 64: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
...
;
; AVX512BW-LABEL: 'test'
; AVX512BW:  Cost of 22 for VF 2: INTERLEAVE-GROUP with factor 7, ir<%out0>
...
; AVX512BW:  Cost of 46 for VF 4: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
...
; AVX512BW:    store ir<%v5> to index 5
; AVX512BW:    store ir<%v6> to index 6
; AVX512BW:  Cost of 118 for VF 8: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
...
; AVX512BW:    store ir<%v5> to index 5
; AVX512BW:    store ir<%v6> to index 6
; AVX512BW:  Cost of 236 for VF 16: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
...
; AVX512BW:    store ir<%v5> to index 5
; AVX512BW:    store ir<%v6> to index 6
; AVX512BW:  Cost of 472 for VF 32: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
...
; AVX512BW:    store ir<%v5> to index 5
; AVX512BW:    store ir<%v6> to index 6
; AVX512BW:  Cost of 826 for VF 64: INTERLEAVE-GROUP with factor 7, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
