...
; AVX512DQ:  Cost of 68 for VF 4: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512DQ:    ir<%v6> = load from index 6
; AVX512DQ:    ir<%v7> = load from index 7
; AVX512DQ:  Cost of 136 for VF 8: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512DQ:    ir<%v6> = load from index 6
; AVX512DQ:    ir<%v7> = load from index 7
; AVX512DQ:  Cost of 280 for VF 16: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512DQ:    ir<%v6> = load from index 6
; AVX512DQ:    ir<%v7> = load from index 7
; AVX512DQ:  Cost of 568 for VF 32: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512DQ:    ir<%v6> = load from index 6
; AVX512DQ:    ir<%v7> = load from index 7
; AVX512DQ:  Cost of 1136 for VF 64: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512BW:  Cost of 17 for VF 4: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
...
; AVX512BW:    ir<%v6> = load from index 6
; AVX512BW:    ir<%v7> = load from index 7
; AVX512BW:  Cost of 22 for VF 8: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
...
; AVX512BW:    ir<%v6> = load from index 6
; AVX512BW:    ir<%v7> = load from index 7
; AVX512BW:  Cost of 64 for VF 16: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
...
; AVX512BW:    ir<%v6> = load from index 6
; AVX512BW:    ir<%v7> = load from index 7
; AVX512BW:  Cost of 148 for VF 32: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
...
; AVX512BW:    ir<%v6> = load from index 6
; AVX512BW:    ir<%v7> = load from index 7
; AVX512BW:  Cost of 616 for VF 64: INTERLEAVE-GROUP with factor 8, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
