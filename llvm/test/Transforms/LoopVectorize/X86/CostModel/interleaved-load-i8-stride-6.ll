...
; AVX2:  Cost of 17 for VF 4: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:    ir<%v3> = load from index 3
; AVX2:    ir<%v4> = load from index 4
; AVX2:    ir<%v5> = load from index 5
; AVX2:  Cost of 20 for VF 8: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:    ir<%v3> = load from index 3
; AVX2:    ir<%v4> = load from index 4
; AVX2:    ir<%v5> = load from index 5
; AVX2:  Cost of 46 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:    ir<%v3> = load from index 3
; AVX2:    ir<%v4> = load from index 4
; AVX2:    ir<%v5> = load from index 5
; AVX2:  Cost of 88 for VF 32: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:    ir<%v3> = load from index 3
...
; AVX512DQ:  Cost of 17 for VF 4: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
; AVX512DQ:    ir<%v4> = load from index 4
; AVX512DQ:    ir<%v5> = load from index 5
; AVX512DQ:  Cost of 21 for VF 8: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
; AVX512DQ:    ir<%v4> = load from index 4
; AVX512DQ:    ir<%v5> = load from index 5
; AVX512DQ:  Cost of 45 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
; AVX512DQ:    ir<%v4> = load from index 4
; AVX512DQ:    ir<%v5> = load from index 5
; AVX512DQ:  Cost of 85 for VF 32: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
; AVX512DQ:    ir<%v4> = load from index 4
; AVX512DQ:    ir<%v5> = load from index 5
; AVX512DQ:  Cost of 810 for VF 64: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:    ir<%v2> = load from index 2
; AVX512DQ:    ir<%v3> = load from index 3
...
; AVX512BW:  Cost of 25 for VF 4: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
; AVX512BW:    ir<%v4> = load from index 4
; AVX512BW:    ir<%v5> = load from index 5
; AVX512BW:  Cost of 49 for VF 8: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
; AVX512BW:    ir<%v4> = load from index 4
; AVX512BW:    ir<%v5> = load from index 5
; AVX512BW:  Cost of 119 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
; AVX512BW:    ir<%v4> = load from index 4
; AVX512BW:    ir<%v5> = load from index 5
; AVX512BW:  Cost of 237 for VF 32: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
; AVX512BW:    ir<%v4> = load from index 4
; AVX512BW:    ir<%v5> = load from index 5
; AVX512BW:  Cost of 591 for VF 64: INTERLEAVE-GROUP with factor 6, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:    ir<%v2> = load from index 2
; AVX512BW:    ir<%v3> = load from index 3
