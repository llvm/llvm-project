...
; AVX2:  Cost of 6 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 12 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 24 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 50 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
;
; AVX512-LABEL: 'test'
...
; AVX512:  Cost of 3 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX512:    ir<%v0> = load from index 0
; AVX512:    ir<%v1> = load from index 1
; AVX512:  Cost of 7 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX512:    ir<%v0> = load from index 0
; AVX512:    ir<%v1> = load from index 1
