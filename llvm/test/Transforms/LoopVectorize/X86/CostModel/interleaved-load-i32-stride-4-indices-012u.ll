...
; AVX2:  Cost of 8 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:  Cost of 16 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:  Cost of 32 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
; AVX2:  Cost of 67 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:    ir<%v2> = load from index 2
;
...
; AVX512:  Cost of 4 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX512:    ir<%v0> = load from index 0
; AVX512:    ir<%v1> = load from index 1
; AVX512:    ir<%v2> = load from index 2
; AVX512:  Cost of 9.5 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX512:    ir<%v0> = load from index 0
; AVX512:    ir<%v1> = load from index 1
; AVX512:    ir<%v2> = load from index 2
; AVX512:  Cost of 26.5 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%in0>
; AVX512:    ir<%v0> = load from index 0
; AVX512:    ir<%v1> = load from index 1
; AVX512:    ir<%v2> = load from index 2
