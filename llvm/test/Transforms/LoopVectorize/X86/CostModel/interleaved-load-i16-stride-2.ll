...
; SSE2:  Cost of 8 for VF 4: INTERLEAVE-GROUP with factor 2, ir<%in0>
; SSE2:    ir<%v0> = load from index 0
; SSE2:    ir<%v1> = load from index 1
...
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 7 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 11 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 22 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
;
; AVX512DQ-LABEL: 'test'
...
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 7 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 10 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 20 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 284 for VF 64: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
;
; AVX512BW-LABEL: 'test'
...
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 5 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 5 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 7 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 34 for VF 64: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
;
entry:
