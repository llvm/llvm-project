...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 44 for VF 2: INTERLEAVE-GROUP with factor 6, ir<%out0>
...
; SSE2:  Cost of 88 for VF 4: INTERLEAVE-GROUP with factor 6, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:    store ir<%v4> to index 4
; SSE2:    store ir<%v5> to index 5
; SSE2:  Cost of 176 for VF 8: INTERLEAVE-GROUP with factor 6, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:    store ir<%v4> to index 4
; SSE2:    store ir<%v5> to index 5
; SSE2:  Cost of 352 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 30 for VF 2: INTERLEAVE-GROUP with factor 6, ir<%out0>
...
; AVX1:  Cost of 66 for VF 4: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:    store ir<%v4> to index 4
; AVX1:    store ir<%v5> to index 5
; AVX1:  Cost of 132 for VF 8: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:    store ir<%v4> to index 4
; AVX1:    store ir<%v5> to index 5
; AVX1:  Cost of 264 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:    store ir<%v4> to index 4
; AVX1:    store ir<%v5> to index 5
; AVX1:  Cost of 528 for VF 32: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
...
; AVX2:    store ir<%v4> to index 4
; AVX2:    store ir<%v5> to index 5
; AVX2:  Cost of 264 for VF 16: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:    store ir<%v4> to index 4
; AVX2:    store ir<%v5> to index 5
; AVX2:  Cost of 528 for VF 32: INTERLEAVE-GROUP with factor 6, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
