...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 14 for VF 2: INTERLEAVE-GROUP with factor 2, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:  Cost of 28 for VF 4: INTERLEAVE-GROUP with factor 2, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:  Cost of 56 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:  Cost of 112 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 10 for VF 2: INTERLEAVE-GROUP with factor 2, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:  Cost of 22 for VF 4: INTERLEAVE-GROUP with factor 2, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:  Cost of 44 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:  Cost of 88 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:  Cost of 176 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
;
; AVX2-LABEL: 'test'
