...
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:  Cost of 124 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
; SSE2:  Cost of 252 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; SSE2:    store ir<%v> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:    store ir<%v3> to index 3
...
; AVX1:  Cost of 33 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 66 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 132 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
; AVX1:  Cost of 268 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX1:    store ir<%v> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:    store ir<%v3> to index 3
;
; AVX2-LABEL: 'test'
; AVX2:  Cost of 5 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 5 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 5 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 10 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
; AVX2:  Cost of 16 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX2:    store ir<%v> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:    store ir<%v3> to index 3
;
; AVX512DQ-LABEL: 'test'
; AVX512DQ:  Cost of 5 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
...
; AVX512DQ:  Cost of 5 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 5 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 9 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 14 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
; AVX512DQ:  Cost of 540 for VF 64: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512DQ:    store ir<%v> to index 0
; AVX512DQ:    store ir<%v1> to index 1
; AVX512DQ:    store ir<%v2> to index 2
; AVX512DQ:    store ir<%v3> to index 3
;
; AVX512BW-LABEL: 'test'
; AVX512BW:  Cost of 11 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%out0>
...
; AVX512BW:  Cost of 11 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 11 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 12 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 16 for VF 32: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
; AVX512BW:  Cost of 28 for VF 64: INTERLEAVE-GROUP with factor 4, ir<%out0>
; AVX512BW:    store ir<%v> to index 0
; AVX512BW:    store ir<%v1> to index 1
; AVX512BW:    store ir<%v2> to index 2
; AVX512BW:    store ir<%v3> to index 3
