...
; ENABLED_MASKED_STRIDED:  Cost of 3 for VF 2: INTERLEAVE-GROUP with factor 4, ir<%arrayidx2>
; ENABLED_MASKED_STRIDED:    ir<%i2> = load from index 0
; ENABLED_MASKED_STRIDED:    ir<%i4> = load from index 1
; ENABLED_MASKED_STRIDED:  Cost of 5 for VF 4: INTERLEAVE-GROUP with factor 4, ir<%arrayidx2>
; ENABLED_MASKED_STRIDED:    ir<%i2> = load from index 0
; ENABLED_MASKED_STRIDED:    ir<%i4> = load from index 1
; ENABLED_MASKED_STRIDED:  Cost of 5 for VF 8: INTERLEAVE-GROUP with factor 4, ir<%arrayidx2>
; ENABLED_MASKED_STRIDED:    ir<%i2> = load from index 0
; ENABLED_MASKED_STRIDED:    ir<%i4> = load from index 1
; ENABLED_MASKED_STRIDED:  Cost of 7 for VF 16: INTERLEAVE-GROUP with factor 4, ir<%arrayidx2>
; ENABLED_MASKED_STRIDED:    ir<%i2> = load from index 0
; ENABLED_MASKED_STRIDED:    ir<%i4> = load from index 1
;
entry:
