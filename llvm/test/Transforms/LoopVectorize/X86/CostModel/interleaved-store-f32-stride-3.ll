...
define void @test() {
; SSE2-LABEL: 'test'
; SSE2:  Cost of 11 for VF 2: INTERLEAVE-GROUP with factor 3, ir<%out0>
; SSE2:    store ir<%v0> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:  Cost of 24 for VF 4: INTERLEAVE-GROUP with factor 3, ir<%out0>
; SSE2:    store ir<%v0> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:  Cost of 48 for VF 8: INTERLEAVE-GROUP with factor 3, ir<%out0>
; SSE2:    store ir<%v0> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
; SSE2:  Cost of 96 for VF 16: INTERLEAVE-GROUP with factor 3, ir<%out0>
; SSE2:    store ir<%v0> to index 0
; SSE2:    store ir<%v1> to index 1
; SSE2:    store ir<%v2> to index 2
;
; AVX1-LABEL: 'test'
; AVX1:  Cost of 12 for VF 2: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX1:    store ir<%v0> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:  Cost of 22 for VF 4: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX1:    store ir<%v0> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:  Cost of 45 for VF 8: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX1:    store ir<%v0> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:  Cost of 90 for VF 16: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX1:    store ir<%v0> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
; AVX1:  Cost of 180 for VF 32: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX1:    store ir<%v0> to index 0
; AVX1:    store ir<%v1> to index 1
; AVX1:    store ir<%v2> to index 2
;
...
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
; AVX2:  Cost of 28 for VF 16: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX2:    store ir<%v0> to index 0
; AVX2:    store ir<%v1> to index 1
; AVX2:    store ir<%v2> to index 2
...
; AVX512:  Cost of 6 for VF 4: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX512:    store ir<%v0> to index 0
; AVX512:    store ir<%v1> to index 1
; AVX512:    store ir<%v2> to index 2
; AVX512:  Cost of 12 for VF 8: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX512:    store ir<%v0> to index 0
; AVX512:    store ir<%v1> to index 1
; AVX512:    store ir<%v2> to index 2
; AVX512:  Cost of 18 for VF 16: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX512:    store ir<%v0> to index 0
; AVX512:    store ir<%v1> to index 1
; AVX512:    store ir<%v2> to index 2
; AVX512:  Cost of 36 for VF 32: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX512:    store ir<%v0> to index 0
; AVX512:    store ir<%v1> to index 1
; AVX512:    store ir<%v2> to index 2
; AVX512:  Cost of 72 for VF 64: INTERLEAVE-GROUP with factor 3, ir<%out0>
; AVX512:    store ir<%v0> to index 0
; AVX512:    store ir<%v1> to index 1
; AVX512:    store ir<%v2> to index 2
;
