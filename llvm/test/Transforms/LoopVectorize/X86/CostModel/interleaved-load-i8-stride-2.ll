...
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 3 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 5 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
; AVX2:  Cost of 8 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX2:    ir<%v0> = load from index 0
; AVX2:    ir<%v1> = load from index 1
;
; AVX512DQ-LABEL: 'test'
...
; AVX512DQ:  Cost of 3 for VF 4: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 3 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 5 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 7 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
; AVX512DQ:  Cost of 270 for VF 64: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512DQ:    ir<%v0> = load from index 0
; AVX512DQ:    ir<%v1> = load from index 1
;
; AVX512BW-LABEL: 'test'
...
; AVX512BW:  Cost of 3 for VF 4: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 3 for VF 8: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 9 for VF 16: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 17 for VF 32: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
; AVX512BW:  Cost of 41 for VF 64: INTERLEAVE-GROUP with factor 2, ir<%in0>
; AVX512BW:    ir<%v0> = load from index 0
; AVX512BW:    ir<%v1> = load from index 1
;
entry:
