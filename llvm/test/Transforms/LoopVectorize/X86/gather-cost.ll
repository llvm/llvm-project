...
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <4 x float> poison, float [[TMP32]], i64 0
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <4 x float> [[TMP38]], float [[TMP33]], i64 1
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <4 x float> [[TMP36]], float [[TMP34]], i64 2
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x float> [[TMP37]], float [[TMP35]], i64 3
...
; CHECK-NEXT:    [[TMP46:%.*]] = insertelement <4 x float> poison, float [[TMP40]], i64 0
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <4 x float> [[TMP46]], float [[TMP41]], i64 1
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <4 x float> [[TMP44]], float [[TMP42]], i64 2
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <4 x float> [[TMP45]], float [[TMP43]], i64 3
...
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <4 x float> poison, float [[TMP82]], i64 0
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x float> [[TMP88]], float [[TMP83]], i64 1
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <4 x float> [[TMP86]], float [[TMP84]], i64 2
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x float> [[TMP87]], float [[TMP85]], i64 3
...
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <4 x float> poison, float [[TMP90]], i64 0
; CHECK-NEXT:    [[TMP94:%.*]] = insertelement <4 x float> [[TMP96]], float [[TMP91]], i64 1
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <4 x float> [[TMP94]], float [[TMP92]], i64 2
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <4 x float> [[TMP95]], float [[TMP93]], i64 3
...
; CHECK-NEXT:    [[TMP130:%.*]] = insertelement <4 x float> poison, float [[TMP124]], i64 0
; CHECK-NEXT:    [[TMP128:%.*]] = insertelement <4 x float> [[TMP130]], float [[TMP125]], i64 1
; CHECK-NEXT:    [[TMP129:%.*]] = insertelement <4 x float> [[TMP128]], float [[TMP126]], i64 2
; CHECK-NEXT:    [[TMP131:%.*]] = insertelement <4 x float> [[TMP129]], float [[TMP127]], i64 3
...
; CHECK-NEXT:    [[TMP138:%.*]] = insertelement <4 x float> poison, float [[TMP132]], i64 0
; CHECK-NEXT:    [[TMP136:%.*]] = insertelement <4 x float> [[TMP138]], float [[TMP133]], i64 1
; CHECK-NEXT:    [[TMP137:%.*]] = insertelement <4 x float> [[TMP136]], float [[TMP134]], i64 2
; CHECK-NEXT:    [[TMP139:%.*]] = insertelement <4 x float> [[TMP137]], float [[TMP135]], i64 3
