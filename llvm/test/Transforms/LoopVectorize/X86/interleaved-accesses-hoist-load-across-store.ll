...
; CHECK-NEXT:    [[TMP49:%.*]] = extractelement <4 x i32> [[TMP48]], i64 0
; CHECK-NEXT:    [[TMP50:%.*]] = extractelement <4 x i32> [[TMP48]], i64 1
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <4 x i32> [[TMP48]], i64 2
; CHECK-NEXT:    [[TMP52:%.*]] = extractelement <4 x i32> [[TMP48]], i64 3
