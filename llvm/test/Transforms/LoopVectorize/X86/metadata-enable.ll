...
; O1-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; O1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; O1-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; O1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; O1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; Oz-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; Oz-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; Oz-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; Oz-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; Oz-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; O1VEC2-NEXT:    [[TMP0:%.*]] = shl nsw i64 [[INDEX]], 2
; O1VEC2-NEXT:    [[TMP1:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP0]]
...
; O1VEC2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP0]]
...
; OzVEC2-NEXT:    [[TMP0:%.*]] = shl nsw i64 [[INDEX]], 2
; OzVEC2-NEXT:    [[TMP1:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP0]]
...
; OzVEC2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP0]]
...
; O3DIS-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; O3DIS-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; O3DIS-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; O3DIS-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; O3DIS-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; O2-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; O2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; O2-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; O2-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; O2-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; O3-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; O3-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; O3-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; O3-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; O3-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; Os-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; Os-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; Os-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; Os-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; Os-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; O1VEC2-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; O1VEC2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; O1VEC2-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; O1VEC2-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; O1VEC2-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
...
; OzVEC2-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; OzVEC2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[B:%.*]], i64 [[TMP2]]
; OzVEC2-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; OzVEC2-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP0]], [[N:%.*]]
; OzVEC2-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[A:%.*]], i64 [[TMP2]]
