...
; CHECK-NEXT:    [[TMP6:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP6]]
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[TMP7:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    [[IDXPROM3:%.*]] = sext i32 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = shl nsw i64 [[IDXPROM3]], 2
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP4]]
; CHECK-NEXT:    store i32 [[TMP0]], ptr [[ARRAYIDX4]], align 4
; CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add i64 [[INDVARS_IV]], 1
; CHECK-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT]], 2
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP5]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP0]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = shl nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP19]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP2]], i64 4
; CHECK-NEXT:    [[TMP20:%.*]] = shl i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP20]]
; CHECK-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr [[TMP4]], i64 8
; CHECK-NEXT:    [[TMP24:%.*]] = shl i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP24]]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[TMP6]], i64 12
; CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[TMP18]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[TMP34:%.*]] = shl nsw i64 [[TMP13]], 2
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP34]]
; CHECK-NEXT:    [[TMP36:%.*]] = shl nsw i64 [[TMP14]], 2
; CHECK-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP36]]
; CHECK-NEXT:    [[TMP37:%.*]] = shl nsw i64 [[TMP15]], 2
; CHECK-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP37]]
; CHECK-NEXT:    [[TMP31:%.*]] = shl nsw i64 [[TMP16]], 2
; CHECK-NEXT:    [[TMP32:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP31]]
; CHECK-NEXT:    store i32 [[TMP1]], ptr [[TMP35]], align 4, !llvm.access.group [[ACC_GRP1:![0-9]+]]
; CHECK-NEXT:    store i32 [[TMP21]], ptr [[TMP28]], align 4, !llvm.access.group [[ACC_GRP1]]
; CHECK-NEXT:    store i32 [[TMP22]], ptr [[TMP30]], align 4, !llvm.access.group [[ACC_GRP1]]
; CHECK-NEXT:    store i32 [[TMP23]], ptr [[TMP32]], align 4, !llvm.access.group [[ACC_GRP1]]
; CHECK-NEXT:    [[TMP33:%.*]] = shl i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[B]], i64 [[TMP33]]
...
; CHECK-NEXT:    store <4 x i32> [[WIDE_LOAD1]], ptr [[TMP18]], align 4, !llvm.access.group [[ACC_GRP0]]
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[ARRAYIDX]], align 4, !llvm.access.group [[ACC_GRP6:![0-9]+]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[INDVARS_IV]], 2
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP2]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX2]], align 4, !llvm.access.group [[ACC_GRP6]]
; CHECK-NEXT:    [[IDXPROM3:%.*]] = sext i32 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = shl nsw i64 [[IDXPROM3]], 2
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP4]]
; CHECK-NEXT:    store i32 [[TMP7]], ptr [[ARRAYIDX4]], align 4, !llvm.access.group [[ACC_GRP7:![0-9]+]]
; CHECK-NEXT:    [[INDVARS_IV_NEXT]] = add i64 [[INDVARS_IV]], 1
; CHECK-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[INDVARS_IV_NEXT]], 2
; CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[ARRAYIDX6]], align 4, !llvm.access.group [[ACC_GRP6]]
; CHECK-NEXT:    store i32 [[TMP6]], ptr [[ARRAYIDX2]], align 4, !llvm.access.group [[ACC_GRP6]]
; CHECK-NEXT:    [[TMP3:%.*]] = and i64 [[INDVARS_IV_NEXT]], 4294967295
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[TMP3]], 512
