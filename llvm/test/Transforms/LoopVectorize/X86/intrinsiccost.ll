...
; CHECK:       vector.ph:
; CHECK-NEXT:    [[TMP3:%.*]] = and i32 [[BLOCKSIZE]], 63
...
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i16* [[TMP5]] to <16 x i16>*
; CHECK-NEXT:    [[WIDE_LOAD9:%.*]] = load <16 x i16>, <16 x i16>* [[TMP6]], align 2
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i16, i16* [[NEXT_GEP]], i64 32
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i16* [[TMP7]] to <16 x i16>*
; CHECK-NEXT:    [[WIDE_LOAD10:%.*]] = load <16 x i16>, <16 x i16>* [[TMP8]], align 2
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i16, i16* [[NEXT_GEP]], i64 48
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i16* [[TMP9]] to <16 x i16>*
; CHECK-NEXT:    [[WIDE_LOAD11:%.*]] = load <16 x i16>, <16 x i16>* [[TMP10]], align 2
; CHECK-NEXT:    [[TMP11:%.*]] = call <16 x i16> @llvm.uadd.sat.v16i16(<16 x i16> [[WIDE_LOAD]], <16 x i16> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP12:%.*]] = call <16 x i16> @llvm.uadd.sat.v16i16(<16 x i16> [[WIDE_LOAD9]], <16 x i16> [[BROADCAST_SPLAT13]])
; CHECK-NEXT:    [[TMP13:%.*]] = call <16 x i16> @llvm.uadd.sat.v16i16(<16 x i16> [[WIDE_LOAD10]], <16 x i16> [[BROADCAST_SPLAT15]])
; CHECK-NEXT:    [[TMP14:%.*]] = call <16 x i16> @llvm.uadd.sat.v16i16(<16 x i16> [[WIDE_LOAD11]], <16 x i16> [[BROADCAST_SPLAT17]])
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i16* [[NEXT_GEP5]] to <16 x i16>*
; CHECK-NEXT:    store <16 x i16> [[TMP11]], <16 x i16>* [[TMP15]], align 2
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i16, i16* [[NEXT_GEP5]], i64 16
; CHECK-NEXT:    [[TMP17:%.*]] = bitcast i16* [[TMP16]] to <16 x i16>*
; CHECK-NEXT:    store <16 x i16> [[TMP12]], <16 x i16>* [[TMP17]], align 2
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i16, i16* [[NEXT_GEP5]], i64 32
; CHECK-NEXT:    [[TMP19:%.*]] = bitcast i16* [[TMP18]] to <16 x i16>*
; CHECK-NEXT:    store <16 x i16> [[TMP13]], <16 x i16>* [[TMP19]], align 2
...
; CHECK-NEXT:    br i1 [[TMP22]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], [[LOOP0:!llvm.loop !.*]]
; CHECK:       middle.block:
...
; CHECK-NEXT:    [[TMP23:%.*]] = add i32 [[BLOCKSIZE]], -1
; CHECK-NEXT:    [[TMP24:%.*]] = zext i32 [[TMP23]] to i64
; CHECK-NEXT:    [[TMP25:%.*]] = add nuw nsw i64 [[TMP24]], 1
; CHECK-NEXT:    [[TMP26:%.*]] = and i32 [[BLOCKSIZE]], 7
; CHECK-NEXT:    [[N_MOD_VF18:%.*]] = zext i32 [[TMP26]] to i64
; CHECK-NEXT:    [[N_VEC19:%.*]] = sub nsw i64 [[TMP25]], [[N_MOD_VF18]]
...
; CHECK-NEXT:    br i1 [[TMP30]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], [[LOOP2:!llvm.loop !.*]]
...
; CHECK-NEXT:    [[TMP31:%.*]] = load i16, i16* [[PSRC_ADDR_08]], align 2
; CHECK-NEXT:    [[TMP32:%.*]] = tail call i16 @llvm.uadd.sat.i16(i16 [[TMP31]], i16 [[OFFSET]])
; CHECK-NEXT:    [[INCDEC_PTR3]] = getelementptr inbounds i16, i16* [[PDST_ADDR_07]], i64 1
; CHECK-NEXT:    store i16 [[TMP32]], i16* [[PDST_ADDR_07]], align 2
...
; CHECK-NEXT:    br i1 [[MIN_ITERS_CHECK1]], label [[VEC_EPILOG_PH:%.*]], label [[VECTOR_PH:%.*]]
; CHECK:       vector.ph:
; CHECK-NEXT:    [[TMP3:%.*]] = and i32 [[BLOCKSIZE]], 127
; CHECK-NEXT:    [[N_MOD_VF:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[N_VEC:%.*]] = sub nsw i64 [[TMP2]], [[N_MOD_VF]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i8* [[TMP5]] to <32 x i8>*
; CHECK-NEXT:    [[WIDE_LOAD9:%.*]] = load <32 x i8>, <32 x i8>* [[TMP6]], align 2
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, i8* [[NEXT_GEP]], i64 64
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i8* [[TMP7]] to <32 x i8>*
; CHECK-NEXT:    [[WIDE_LOAD10:%.*]] = load <32 x i8>, <32 x i8>* [[TMP8]], align 2
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, i8* [[NEXT_GEP]], i64 96
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i8* [[TMP9]] to <32 x i8>*
; CHECK-NEXT:    [[WIDE_LOAD11:%.*]] = load <32 x i8>, <32 x i8>* [[TMP10]], align 2
; CHECK-NEXT:    [[TMP11:%.*]] = call <32 x i8> @llvm.fshl.v32i8(<32 x i8> [[WIDE_LOAD]], <32 x i8> [[WIDE_LOAD]], <32 x i8> [[BROADCAST_SPLAT]])
; CHECK-NEXT:    [[TMP12:%.*]] = call <32 x i8> @llvm.fshl.v32i8(<32 x i8> [[WIDE_LOAD9]], <32 x i8> [[WIDE_LOAD9]], <32 x i8> [[BROADCAST_SPLAT13]])
; CHECK-NEXT:    [[TMP13:%.*]] = call <32 x i8> @llvm.fshl.v32i8(<32 x i8> [[WIDE_LOAD10]], <32 x i8> [[WIDE_LOAD10]], <32 x i8> [[BROADCAST_SPLAT15]])
; CHECK-NEXT:    [[TMP14:%.*]] = call <32 x i8> @llvm.fshl.v32i8(<32 x i8> [[WIDE_LOAD11]], <32 x i8> [[WIDE_LOAD11]], <32 x i8> [[BROADCAST_SPLAT17]])
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i8* [[NEXT_GEP5]] to <32 x i8>*
; CHECK-NEXT:    store <32 x i8> [[TMP11]], <32 x i8>* [[TMP15]], align 2
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i8, i8* [[NEXT_GEP5]], i64 32
; CHECK-NEXT:    [[TMP17:%.*]] = bitcast i8* [[TMP16]] to <32 x i8>*
; CHECK-NEXT:    store <32 x i8> [[TMP12]], <32 x i8>* [[TMP17]], align 2
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i8, i8* [[NEXT_GEP5]], i64 64
; CHECK-NEXT:    [[TMP19:%.*]] = bitcast i8* [[TMP18]] to <32 x i8>*
; CHECK-NEXT:    store <32 x i8> [[TMP13]], <32 x i8>* [[TMP19]], align 2
...
; CHECK-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP22]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], [[LOOP5:!llvm.loop !.*]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i32 [[TMP3]], 0
; CHECK-NEXT:    br i1 [[CMP_N]], label [[WHILE_END]], label [[VEC_EPILOG_ITER_CHECK:%.*]]
; CHECK:       vec.epilog.iter.check:
...
; CHECK-NEXT:    [[TMP27:%.*]] = bitcast i8* [[NEXT_GEP32]] to <8 x i8>*
; CHECK-NEXT:    [[WIDE_LOAD34:%.*]] = load <8 x i8>, <8 x i8>* [[TMP27]], align 2
; CHECK-NEXT:    [[TMP28:%.*]] = call <8 x i8> @llvm.fshl.v8i8(<8 x i8> [[WIDE_LOAD34]], <8 x i8> [[WIDE_LOAD34]], <8 x i8> [[BROADCAST_SPLAT36]])
; CHECK-NEXT:    [[TMP29:%.*]] = bitcast i8* [[NEXT_GEP33]] to <8 x i8>*
; CHECK-NEXT:    store <8 x i8> [[TMP28]], <8 x i8>* [[TMP29]], align 2
; CHECK-NEXT:    [[INDEX_NEXT21]] = add i64 [[INDEX20]], 8
; CHECK-NEXT:    [[TMP30:%.*]] = icmp eq i64 [[INDEX_NEXT21]], [[N_VEC19]]
; CHECK-NEXT:    br i1 [[TMP30]], label [[VEC_EPILOG_MIDDLE_BLOCK:%.*]], label [[VEC_EPILOG_VECTOR_BODY]], [[LOOP6:!llvm.loop !.*]]
; CHECK:       vec.epilog.middle.block:
; CHECK-NEXT:    [[CMP_N30:%.*]] = icmp eq i32 [[TMP26]], 0
; CHECK-NEXT:    br i1 [[CMP_N30]], label [[WHILE_END]], label [[VEC_EPILOG_SCALAR_PH]]
; CHECK:       vec.epilog.scalar.ph:
...
; CHECK-NEXT:    [[TMP31:%.*]] = load i8, i8* [[PSRC_ADDR_08]], align 2
; CHECK-NEXT:    [[TMP32:%.*]] = tail call i8 @llvm.fshl.i8(i8 [[TMP31]], i8 [[TMP31]], i8 [[OFFSET]])
; CHECK-NEXT:    [[INCDEC_PTR3]] = getelementptr inbounds i8, i8* [[PDST_ADDR_07]], i64 1
; CHECK-NEXT:    store i8 [[TMP32]], i8* [[PDST_ADDR_07]], align 2
; CHECK-NEXT:    [[DEC]] = add i32 [[BLKCNT_09]], -1
; CHECK-NEXT:    [[CMP_NOT:%.*]] = icmp eq i32 [[DEC]], 0
