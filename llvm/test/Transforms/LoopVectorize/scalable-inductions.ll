...
; RUN: opt -passes=loop-vectorize -scalable-vectorization=on -force-target-instruction-cost=1 -force-target-supports-scalable-vectors < %s -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[TMP8]], i64 [[TMP0]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i64, ptr [[TMP13]], i64 [[TMP0]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = fmul float 2.000000e+00, [[DOTCAST]]
; CHECK-NEXT:    [[IND_END:%.*]] = fadd float 0.000000e+00, [[TMP4]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = fmul <vscale x 4 x float> [[TMP8]], splat (float 2.000000e+00)
; CHECK-NEXT:    [[TMP9:%.*]] = fadd <vscale x 4 x float> zeroinitializer, [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = uitofp i64 [[TMP1]] to float
; CHECK-NEXT:    [[TMP13:%.*]] = fmul float 2.000000e+00, [[TMP12]]
