...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP7]]
; CHECK-NEXT:    [[TMP10:%.*]] = shl i64 [[TMP4]], 4
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i8, ptr [[TMP9]], i64 [[TMP10]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP15]]
; CHECK-NEXT:    [[TMP20:%.*]] = shl i64 [[TMP4]], 4
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i8, ptr [[TMP14]], i64 [[TMP20]]
...
; CHECK-NEXT:    [[TMP21:%.*]] = shl nsw i64 [[I_08]], 3
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP21]]
; CHECK-NEXT:    [[TMP18:%.*]] = load i64, ptr [[ARRAYIDX]], align 8
; CHECK-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP18]], [[I_08]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[I_08]], 3
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP19]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP7:%.*]] = shl nsw i64 [[TMP2]], 3
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[TMP8]], i64 [[TMP7]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = shl nsw i64 [[INDEX]], 3
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP14]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[TMP2]], 3
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[TMP13]], i64 [[TMP19]]
...
; CHECK:       for.body:
; CHECK-NEXT:    [[I_08:%.*]] = phi i64 [ [[INC:%.*]], [[FOR_BODY]] ], [ [[BC_RESUME_VAL]], [[SCALAR_PH]] ]
; CHECK-NEXT:    [[TMP20:%.*]] = shl nsw i64 [[I_08]], 3
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[TMP20]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP13]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = shl nsw i64 [[I_08]], 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP12]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i64 [[TMP11]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = shl nsw i64 [[I_08]], 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[A]], i64 [[TMP16]]
