...
; VF8UF1:       [[VECTOR_PH]]:
; VF8UF1-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP0]], 1
...
; VF8UF2:       [[VECTOR_PH]]:
; VF8UF2-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP0]], 1
...
; VF16UF1:       [[VECTOR_PH]]:
; VF16UF1-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP0]], 1
...
; VF8UF1-NEXT:    br label %[[VECTOR_PH:.*]]
; VF8UF1:       [[VECTOR_PH]]:
; VF8UF1-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP1]], 1
...
; VF8UF2-NEXT:    br label %[[VECTOR_PH:.*]]
; VF8UF2:       [[VECTOR_PH]]:
; VF8UF2-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP1]], 1
...
; VF16UF1-NEXT:    br label %[[VECTOR_PH:.*]]
; VF16UF1:       [[VECTOR_PH]]:
; VF16UF1-NEXT:    [[TRIP_COUNT_MINUS_1:%.*]] = sub nuw i64 [[TMP1]], 1
