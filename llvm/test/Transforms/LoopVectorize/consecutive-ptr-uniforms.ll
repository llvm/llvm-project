...
; INTER-NEXT:    [[TMP31:%.*]] = load i32, ptr [[TMP7]], align 8
; INTER-NEXT:    [[TMP32:%.*]] = load i32, ptr [[TMP28]], align 8
; INTER-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP29]], align 8
; INTER-NEXT:    [[TMP34:%.*]] = load i32, ptr [[TMP30]], align 8
; INTER-NEXT:    [[TMP35:%.*]] = insertelement <4 x i32> poison, i32 [[TMP31]], i32 0
; INTER-NEXT:    [[TMP36:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[TMP32]], i32 1
; INTER-NEXT:    [[TMP37:%.*]] = insertelement <4 x i32> [[TMP36]], i32 [[TMP33]], i32 2
; INTER-NEXT:    [[STRIDED_VEC6:%.*]] = insertelement <4 x i32> [[TMP37]], i32 [[TMP34]], i32 3
