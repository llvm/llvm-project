...
; CHECK-NEXT:    [[VEC_IND:%.*]] = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, [[VECTOR_PH]] ], [ [[TMP13:%.*]], [[PRED_STORE_CONTINUE6]] ]
...
; CHECK-NEXT:    [[TMP13]] = add <4 x i32> [[VEC_IND]], <i32 4, i32 4, i32 4, i32 4>
