...
; CHECK-NEXT:    [[I:%.*]] = phi i64 [ 20, %[[SCALAR_PH]] ], [ [[I_NEXT:%.*]], %[[FOR_COND_CLEANUP3:.*]] ]
; CHECK-NEXT:      #dbg_value(i64 [[I]], [[META11]], !DIExpression(), [[META20]])
; CHECK-NEXT:    br label %[[FOR_COND5_PREHEADER:.*]], !dbg [[DBG29]]
; CHECK:       [[FOR_COND5_PREHEADER]]:
; CHECK-NEXT:    [[L_022:%.*]] = phi i64 [ 0, %[[FOR_COND1_PREHEADER]] ], [ [[L_NEXT:%.*]], %[[FOR_COND5_PREHEADER]] ], !dbg [[DBG23]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i32, ptr [[H]], i64 [[L_022]]
; CHECK-NEXT:    store i32 0, ptr [[TMP9]], align 4, !dbg [[DBG24]]
; CHECK-NEXT:    [[GEP_H_1:%.*]] = getelementptr i32, ptr [[TMP9]], i64 1, !dbg [[DBG26]]
; CHECK-NEXT:    store i32 1, ptr [[GEP_H_1]], align 4, !dbg [[DBG24]]
; CHECK-NEXT:    [[GEP_H_2:%.*]] = getelementptr i32, ptr [[TMP9]], i64 2, !dbg [[DBG26]]
; CHECK-NEXT:    store i32 2, ptr [[GEP_H_2]], align 4, !dbg [[DBG24]]
; CHECK-NEXT:    [[GEP_H_3:%.*]] = getelementptr i32, ptr [[TMP9]], i64 3, !dbg [[DBG26]]
; CHECK-NEXT:    store i32 3, ptr [[GEP_H_3]], align 4, !dbg [[DBG24]]
; CHECK-NEXT:    [[L_NEXT]] = add nuw nsw i64 [[L_022]], 1, !dbg [[DBG27]]
; CHECK-NEXT:    [[INNER_EC:%.*]] = icmp eq i64 [[L_NEXT]], 5, !dbg [[DBG28]]
; CHECK-NEXT:    br i1 [[INNER_EC]], label %[[FOR_COND_CLEANUP3]], label %[[FOR_COND5_PREHEADER]], !dbg [[DBG29]]
; CHECK:       [[FOR_COND_CLEANUP3]]:
; CHECK-NEXT:    [[I_NEXT]] = add nuw nsw i64 [[I]], 1, !dbg [[DBG22]]
; CHECK-NEXT:      #dbg_value(i64 [[I_NEXT]], [[META11]], !DIExpression(), [[META20]])
; CHECK-NEXT:    [[OUTER_EC:%.*]] = icmp eq i64 [[I_NEXT]], 23, !dbg [[DBG33:![0-9]+]]
; CHECK-NEXT:    br i1 [[OUTER_EC]], label %[[EXIT:.*]], label %[[FOR_COND1_PREHEADER]], !dbg [[DBG21]], !llvm.loop [[LOOP34:![0-9]+]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    ret void, !dbg [[DBG35:![0-9]+]]
;
entry:
  call void @llvm.dbg.value(metadata i64 0, metadata !11, metadata !DIExpression()), !dbg !20
  br label %outer.header, !dbg !21

outer.header:
  %i = phi i64 [ 0, %entry ], [ %i.next, %outer.latch ]
  call void @llvm.dbg.value(metadata i64 %i, metadata !11, metadata !DIExpression()), !dbg !20
  br label %inner, !dbg !22

inner:
  %l = phi i64 [ 0, %outer.header ], [ %l.next, %inner ], !dbg !34
  %gep.h = getelementptr i32, ptr %h, i64 %l
  store i32 0, ptr %gep.h, align 4, !dbg !24
  %gep.h.1 = getelementptr i32, ptr %gep.h, i64 1, !dbg !26
  store i32 1, ptr %gep.h.1, align 4, !dbg !24
  %gep.h.2 = getelementptr i32, ptr %gep.h, i64 2, !dbg !26
  store i32 2, ptr %gep.h.2, align 4, !dbg !24
  %gep.h.3 = getelementptr i32, ptr %gep.h, i64 3, !dbg !26
  store i32 3, ptr %gep.h.3, align 4, !dbg !24
  %l.next = add nuw nsw i64 %l, 1, !dbg !27
  %inner.ec = icmp eq i64 %l.next, 5, !dbg !28
  br i1 %inner.ec, label %outer.latch, label %inner, !dbg !22

outer.latch:
  %i.next = add nuw nsw i64 %i, 1, !dbg !29
  call void @llvm.dbg.value(metadata i64 %i.next, metadata !11, metadata !DIExpression()), !dbg !20
  %outer.ec = icmp eq i64 %i.next, 23, !dbg !30
  br i1 %outer.ec, label %exit, label %outer.header, !dbg !21, !llvm.loop !31
