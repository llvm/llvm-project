...
; CHECK:    Loop at depth 2 containing: %vector.body<header><exiting>,%vector.body.cond.1<latch><exiting>
entry:
  %p1 = alloca [1024 x i8]
  %p2 = alloca [1024 x i8]
...
; CHECK:        Loop at depth 3 containing: %vector.body<header><exiting>,%vector.body.cond.1<latch><exiting>
entry:
  %p1 = alloca [1024 x i8]
  %p2 = alloca [1024 x i8]
  call void @init_mem(ptr %p1, i64 1024)
