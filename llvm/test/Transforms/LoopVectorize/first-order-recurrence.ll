...
; UNROLL-NO-IC-NEXT:    [[TMP29:%.*]] = insertelement <4 x double> poison, double [[TMP16]], i64 0
; UNROLL-NO-IC-NEXT:    [[TMP30:%.*]] = insertelement <4 x double> [[TMP29]], double [[TMP17]], i64 1
; UNROLL-NO-IC-NEXT:    [[TMP28:%.*]] = insertelement <4 x double> [[TMP30]], double [[TMP18]], i64 2
; UNROLL-NO-IC-NEXT:    [[TMP23:%.*]] = insertelement <4 x double> [[TMP28]], double [[TMP19]], i64 3
...
; UNROLL-NO-IC-NEXT:    [[TMP50:%.*]] = insertelement <4 x double> poison, double [[TMP24]], i64 0
; UNROLL-NO-IC-NEXT:    [[TMP51:%.*]] = insertelement <4 x double> [[TMP50]], double [[TMP25]], i64 1
; UNROLL-NO-IC-NEXT:    [[TMP52:%.*]] = insertelement <4 x double> [[TMP51]], double [[TMP26]], i64 2
; UNROLL-NO-IC-NEXT:    [[TMP31]] = insertelement <4 x double> [[TMP52]], double [[TMP27]], i64 3
...
; SINK-AFTER-NEXT:    [[TMP29:%.*]] = insertelement <4 x double> poison, double [[TMP8]], i64 0
; SINK-AFTER-NEXT:    [[TMP30:%.*]] = insertelement <4 x double> [[TMP29]], double [[TMP9]], i64 1
; SINK-AFTER-NEXT:    [[TMP31:%.*]] = insertelement <4 x double> [[TMP30]], double [[TMP10]], i64 2
; SINK-AFTER-NEXT:    [[TMP15]] = insertelement <4 x double> [[TMP31]], double [[TMP11]], i64 3
...
; UNROLL-NO-IC-NEXT:    [[TMP24:%.*]] = insertelement <4 x i16> poison, i16 [[TMP19]], i64 0
; UNROLL-NO-IC-NEXT:    [[TMP25:%.*]] = insertelement <4 x i16> [[TMP24]], i16 [[TMP20]], i64 1
; UNROLL-NO-IC-NEXT:    [[TMP23:%.*]] = insertelement <4 x i16> [[TMP25]], i16 [[TMP21]], i64 2
; UNROLL-NO-IC-NEXT:    [[TMP26:%.*]] = insertelement <4 x i16> [[TMP23]], i16 [[TMP22]], i64 3
...
; UNROLL-NO-IC-NEXT:    [[TMP32:%.*]] = insertelement <4 x i16> poison, i16 [[TMP27]], i64 0
; UNROLL-NO-IC-NEXT:    [[TMP33:%.*]] = insertelement <4 x i16> [[TMP32]], i16 [[TMP28]], i64 1
; UNROLL-NO-IC-NEXT:    [[TMP31:%.*]] = insertelement <4 x i16> [[TMP33]], i16 [[TMP29]], i64 2
; UNROLL-NO-IC-NEXT:    [[TMP34]] = insertelement <4 x i16> [[TMP31]], i16 [[TMP30]], i64 3
...
; SINK-AFTER-NEXT:    [[TMP15:%.*]] = insertelement <4 x i16> poison, i16 [[TMP10]], i64 0
; SINK-AFTER-NEXT:    [[TMP16:%.*]] = insertelement <4 x i16> [[TMP15]], i16 [[TMP11]], i64 1
; SINK-AFTER-NEXT:    [[TMP14:%.*]] = insertelement <4 x i16> [[TMP16]], i16 [[TMP12]], i64 2
; SINK-AFTER-NEXT:    [[TMP17]] = insertelement <4 x i16> [[TMP14]], i16 [[TMP13]], i64 3
