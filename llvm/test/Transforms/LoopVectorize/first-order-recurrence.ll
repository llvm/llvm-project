...
; UNROLL-NO-IC-NEXT:    [[TMP45:%.*]] = insertelement <4 x double> poison, double [[TMP16]], i32 0
; UNROLL-NO-IC-NEXT:    [[TMP46:%.*]] = insertelement <4 x double> [[TMP45]], double [[TMP17]], i32 1
; UNROLL-NO-IC-NEXT:    [[TMP47:%.*]] = insertelement <4 x double> [[TMP46]], double [[TMP18]], i32 2
; UNROLL-NO-IC-NEXT:    [[TMP23:%.*]] = insertelement <4 x double> [[TMP47]], double [[TMP19]], i32 3
...
; UNROLL-NO-IC-NEXT:    [[TMP49:%.*]] = insertelement <4 x i16> poison, i16 [[TMP19]], i32 0
; UNROLL-NO-IC-NEXT:    [[TMP50:%.*]] = insertelement <4 x i16> [[TMP49]], i16 [[TMP20]], i32 1
; UNROLL-NO-IC-NEXT:    [[TMP51:%.*]] = insertelement <4 x i16> [[TMP50]], i16 [[TMP21]], i32 2
; UNROLL-NO-IC-NEXT:    [[TMP26:%.*]] = insertelement <4 x i16> [[TMP51]], i16 [[TMP22]], i32 3
