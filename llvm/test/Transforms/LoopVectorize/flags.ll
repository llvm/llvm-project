...
; CHECK-NEXT:    [[DIV_1:%.*]] = fdiv reassoc float [[L_A]], 2.000000e+00
; CHECK-NEXT:    store float [[DIV_1]], ptr [[GEP_A]], align 4
; CHECK-NEXT:    [[GEP_B:%.*]] = getelementptr float, ptr [[B]], i64 [[IV]]
; CHECK-NEXT:    [[DIV_2:%.*]] = fdiv float [[L_A]], 2.000000e+00
; CHECK-NEXT:    store float [[DIV_2]], ptr [[GEP_B]], align 4
; CHECK-NEXT:    [[IV_NEXT]] = add i64 [[IV]], 1
; CHECK-NEXT:    [[EC:%.*]] = icmp eq i64 [[IV]], 128
