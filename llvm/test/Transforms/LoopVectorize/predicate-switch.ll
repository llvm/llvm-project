...
; IC2-NEXT:    [[PREDPHI6:%.*]] = select <2 x i1> [[TMP9]], <2 x ptr> [[BROADCAST_SPLAT]], <2 x ptr> [[PREDPHI]]
; IC2-NEXT:    [[PREDPHI4:%.*]] = select <2 x i1> [[TMP10]], <2 x ptr> [[BROADCAST_SPLAT]], <2 x ptr> [[PREDPHI5]]
; IC2-NEXT:    [[TMP2:%.*]] = extractelement <2 x ptr> [[PREDPHI6]], i64 0
; IC2-NEXT:    store i32 0, ptr [[TMP2]], align 4
; IC2-NEXT:    [[TMP3:%.*]] = extractelement <2 x ptr> [[PREDPHI6]], i64 1
