...
; Verify that simplifyRecipe folds the four idempotent / self-cancelling
...
define void @xor_self(ptr noalias %dst, ptr noalias %src, i64 %n) {
; CHECK-LABEL: define void @xor_self(
; CHECK-SAME: ptr noalias [[DST:%.*]], ptr noalias [[SRC:%.*]], i64 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[UMAX:%.*]] = call i64 @llvm.umax.i64(i64 [[N]], i64 1)
; CHECK-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[UMAX]], 4
