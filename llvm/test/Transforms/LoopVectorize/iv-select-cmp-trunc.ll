...
; CHECK-VF4IC1-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
...
; CHECK-VF4IC4-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -16
...
; CHECK-VF1IC4-NEXT:    [[N_VEC:%.*]] = and i64 [[WIDE_TRIP_COUNT]], -4
...
; CHECK-VF1IC4-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK-VF1IC4:       [[VECTOR_PH]]:
; CHECK-VF1IC4-NEXT:    [[N_VEC:%.*]] = and i64 [[TMP0]], -4
