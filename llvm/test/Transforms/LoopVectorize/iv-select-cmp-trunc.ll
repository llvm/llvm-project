...
; CHECK-VF1IC4-NEXT:    [[OFFSET_IDX:%.*]] = add nuw i64 2147483646, [[INDEX]]
...
; CHECK-VF1IC4-NEXT:    [[TMP24:%.*]] = trunc i64 [[INDEX]] to i32
; CHECK-VF1IC4-NEXT:    [[TMP3:%.*]] = add i32 2147483646, [[TMP24]]
...
; CHECK-VF1IC4-NEXT:    [[TMP5:%.*]] = add i64 [[IV]], 2
; CHECK-VF1IC4-NEXT:    [[TMP6:%.*]] = add i64 [[IV]], 3
; CHECK-VF1IC4-NEXT:    [[TMP16:%.*]] = trunc i64 [[INDEX]] to i32
; CHECK-VF1IC4-NEXT:    [[TMP7:%.*]] = add i32 -2, [[TMP16]]
; CHECK-VF1IC4-NEXT:    [[TMP8:%.*]] = add i32 [[TMP7]], 0
; CHECK-VF1IC4-NEXT:    [[TMP9:%.*]] = add i32 [[TMP7]], 1
; CHECK-VF1IC4-NEXT:    [[TMP10:%.*]] = add i32 [[TMP7]], 2
; CHECK-VF1IC4-NEXT:    [[TMP11:%.*]] = add i32 [[TMP7]], 3
