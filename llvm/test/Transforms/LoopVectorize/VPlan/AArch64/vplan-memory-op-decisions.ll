...
; RUN: opt -passes=loop-vectorize -force-vector-width=2 -force-vector-interleave=1 -S -disable-output -vplan-print-after=makeVPlanMemOpDecision %s 2>&1 | FileCheck %s
