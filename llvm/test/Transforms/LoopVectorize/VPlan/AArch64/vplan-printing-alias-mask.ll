...
; FINAL-NEXT:    EMIT vp<[[VP8:%[0-9]+]]> = TC > VF ? TC - VF : 0 ir<%n>, vp<%num.active.lanes>
...
; FINAL-NEXT:    ACTIVE-LANE-MASK-PHI vp<[[VP9:%[0-9]+]]> = phi vp<%extract.entry.alm.part>, vp<%extract.next.alm.part>
...
; FINAL-NEXT:    EMIT vp<%active.lane.mask.next> = wide active lane mask vp<%index>, vp<[[VP8]]>, ir<1>
; FINAL-NEXT:    EMIT vp<%extract.next.alm.part> = extract-vector-for-part vp<%active.lane.mask.next>, ir<0>
; FINAL-NEXT:    EMIT vp<[[VP11:%[0-9]+]]> = not vp<%extract.next.alm.part>
