...
; RUN: opt -passes=loop-vectorize -force-vector-interleave=1 -force-vector-width=2 -enable-masked-memory-optimization=false -vplan-print-after=printOptimizedVPlan -disable-output %s 2>&1 | FileCheck %s
