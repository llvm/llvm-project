...
; IF-EVL-NEXT:    EMIT-SCALAR vp<[[C_ADDR:%.+]]> = phi [ ir<%c>, vector.ph ], [ vp<[[C_ADDR_NEXT:%.+]]>, vector.body ]
...
; IF-EVL-NEXT:    vp<[[PTR1:%[0-9]+]]> = vector-pointer inbounds i32, vp<[[B_ADDR]]>
; IF-EVL-NEXT:    WIDEN ir<[[LD1:%.+]]> = vp.load vp<[[PTR1]]>, vp<%evl>
; IF-EVL-NEXT:    vp<[[PTR2:%[0-9]+]]> = vector-pointer inbounds i32, vp<[[C_ADDR]]>
; IF-EVL-NEXT:    WIDEN ir<[[LD2:%.+]]> = vp.load vp<[[PTR2]]>, vp<%evl>
; IF-EVL-NEXT:    WIDEN ir<[[ADD:%.+]]> = add nsw ir<[[LD2]]>, ir<[[LD1]]>
; IF-EVL-NEXT:    vp<[[PTR3:%[0-9]+]]> = vector-pointer inbounds i32, vp<[[A_ADDR]]>
...
; IF-EVL-NEXT:    EMIT vp<[[C_STEP:%.+]]> = mul ir<4>, vp<[[CAST]]>
; IF-EVL-NEXT:    EMIT vp<[[C_ADDR_NEXT]]> = ptradd vp<[[C_ADDR]]>, vp<[[C_STEP]]>
