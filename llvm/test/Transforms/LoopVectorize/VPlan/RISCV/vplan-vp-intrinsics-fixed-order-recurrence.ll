...
; IF-EVL-EMPTY:
; IF-EVL: vector.ph:
; IF-EVL-NEXT:  EMIT vp<[[FORINIT:%.+]]> = insertelement ir<poison>, ir<33>, ir<0>
...
; IF-EVL-NEXT:     EMIT-SCALAR vp<[[PREV_EVL:%.+]]> = phi [ ir<1>, vector.ph ], [ vp<[[EVL:%.+]]>, vector.body ]
...
; IF-EVL-NEXT:     vp<[[PTR1:%[0-9]+]]> = vector-pointer inbounds nuw i32, ir<[[GEP1]]>, ir<1>
...
; IF-EVL-NEXT:     vp<[[PTR2:%[0-9]+]]> = vector-pointer inbounds nuw i32, ir<[[GEP2]]>, ir<1>
...
; IF-EVL: Cost of 0 for VF vscale x 4: FIRST-ORDER-RECURRENCE-PHI ir<[[FOR_PHI]]> = phi vp<[[FORINIT]]>, ir<[[LD]]>
