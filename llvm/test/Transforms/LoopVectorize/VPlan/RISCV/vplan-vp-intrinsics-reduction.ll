...
; IF-EVL-OUTLOOP-NEXT:    EMIT-SCALAR vp<[[A_ADDR:%.+]]> = phi [ ir<%a>, vector.ph ], [ vp<[[A_ADDR_NEXT:%.+]]>, vector.body ]
...
; IF-EVL-OUTLOOP-NEXT:    vp<[[PTR1:%[0-9]+]]> = vector-pointer inbounds i32, vp<[[A_ADDR]]>, ir<1>
...
; IF-EVL-OUTLOOP-NEXT:    EMIT vp<[[AVL_NEXT]]> = sub nuw vp<[[AVL]]>, vp<[[CAST2]]>
; IF-EVL-OUTLOOP-NEXT:    EMIT vp<[[IV_NEXT_EXIT:%.+]]> = add vp<[[IV]]>, vp<[[VFUF]]>
; IF-EVL-OUTLOOP-NEXT:    EMIT vp<[[A_STEP:%.+]]> = mul ir<4>, vp<[[CAST]]>
; IF-EVL-OUTLOOP-NEXT:    EMIT vp<[[A_ADDR_NEXT]]> = ptradd vp<[[A_ADDR]]>, vp<[[A_STEP]]>
...
; IF-EVL-INLOOP-NEXT:    EMIT-SCALAR vp<[[A_ADDR:%.+]]> = phi [ ir<%a>, vector.ph ], [ vp<[[A_ADDR_NEXT:%.+]]>, vector.body ]
...
; IF-EVL-INLOOP-NEXT:    vp<[[PTR1:%[0-9]+]]> = vector-pointer inbounds i32, vp<[[A_ADDR]]>, ir<1>
...
; IF-EVL-INLOOP-NEXT:    EMIT vp<[[AVL_NEXT]]> = sub nuw vp<[[AVL]]>, vp<[[CAST2]]>
; IF-EVL-INLOOP-NEXT:    EMIT vp<[[IV_NEXT_EXIT:%.+]]> = add vp<[[IV]]>, vp<[[VFUF]]>
; IF-EVL-INLOOP-NEXT:    EMIT vp<[[A_STEP:%.+]]> = mul ir<4>, vp<[[CAST]]>
; IF-EVL-INLOOP-NEXT:    EMIT vp<[[A_ADDR_NEXT]]> = ptradd vp<[[A_ADDR]]>, vp<[[A_STEP]]>
