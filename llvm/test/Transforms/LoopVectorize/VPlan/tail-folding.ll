...
; RUN: opt < %s -p loop-vectorize -force-vector-width=4 -tail-folding-policy=prefer-fold-tail -S -vplan-print-after=foldTailByMasking -disable-output -vplan-print-metadata=false 2>&1 | FileCheck %s
