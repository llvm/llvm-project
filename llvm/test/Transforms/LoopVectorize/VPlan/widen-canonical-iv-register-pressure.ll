...
; UF1-NEXT:    EMIT vp<[[VP3:%[0-9]+]]> = step-vector i64
; UF1-NEXT:    EMIT vp<[[VP4:%[0-9]+]]> = broadcast ir<4>
...
; UF1-NEXT:    WIDEN-PHI vp<[[VP5:%[0-9]+]]> = phi [ vp<[[VP3]]>, vector.ph ], [ vp<%vec.ind.next>, vector.body ]
; UF1-NEXT:    EMIT vp<[[VP6:%[0-9]+]]> = icmp ule vp<[[VP5]]>, vp<%trip.count.minus.1>
; UF1-NEXT:    CLONE ir<%ga> = getelementptr inbounds ir<%a>, vp<%index>
; UF1-NEXT:    CLONE ir<%gb> = getelementptr inbounds ir<%b>, vp<%index>
; UF1-NEXT:    WIDEN ir<%la> = load ir<%ga>, vp<[[VP6]]>
; UF1-NEXT:    WIDEN ir<%lb> = load ir<%gb>, vp<[[VP6]]>
...
; UF1-NEXT:    EMIT vp<%vec.ind.next> = add vp<[[VP5]]>, vp<[[VP4]]>
; UF1-NEXT:    EMIT vp<[[VP7:%[0-9]+]]> = icmp eq vp<%index.next>, vp<%n.vec>
; UF1-NEXT:    EMIT branch-on-cond vp<[[VP7]]>
...
; UF4-NEXT:    EMIT vp<[[VP3:%[0-9]+]]> = WIDEN-CANONICAL-INDUCTION vp<%index>
; UF4-NEXT:    EMIT vp<[[VP4:%[0-9]+]]> = WIDEN-CANONICAL-INDUCTION vp<%index>, ir<1>
; UF4-NEXT:    EMIT vp<[[VP5:%[0-9]+]]> = WIDEN-CANONICAL-INDUCTION vp<%index>, ir<2>
; UF4-NEXT:    EMIT vp<[[VP6:%[0-9]+]]> = WIDEN-CANONICAL-INDUCTION vp<%index>, ir<3>
; UF4-NEXT:    EMIT vp<[[VP7:%[0-9]+]]> = icmp ule vp<[[VP3]]>, vp<%trip.count.minus.1>
; UF4-NEXT:    EMIT vp<[[VP8:%[0-9]+]]> = icmp ule vp<[[VP4]]>, vp<%trip.count.minus.1>
; UF4-NEXT:    EMIT vp<[[VP9:%[0-9]+]]> = icmp ule vp<[[VP5]]>, vp<%trip.count.minus.1>
; UF4-NEXT:    EMIT vp<[[VP10:%[0-9]+]]> = icmp ule vp<[[VP6]]>, vp<%trip.count.minus.1>
