...
; CHECK-TF-NEXT:      EMIT vp<[[VP9:%[0-9]+]]> = logical-and ir<%select.cmp>, vp<[[VP6]]>
...
; CHECK-TF-NEXT:      WIDEN-PHI vp<[[VP5:%[0-9]+]]> = phi [ ir<false>, vector.ph ], [ vp<[[VP14:%[0-9]+]]>, if.then.1 ]
...
; CHECK-TF-NEXT:      EMIT vp<[[VP11:%[0-9]+]]> = logical-and ir<%if.cond>, vp<[[VP7]]>
; CHECK-TF-NEXT:      EMIT vp<[[VP12:%[0-9]+]]> = logical-and vp<[[VP7]]>, vp<[[VP11]]>
; CHECK-TF-NEXT:      EMIT vp<[[VP13:%[0-9]+]]> = any-of vp<[[VP12]]>
; CHECK-TF-NEXT:      EMIT vp<[[VP14]]> = select vp<[[VP13]]>, vp<[[VP12]]>, vp<[[VP5]]>
; CHECK-TF-NEXT:      EMIT vp<[[VP15]]> = select vp<[[VP13]]>, vp<[[VP10]]>, ir<%data.phi>
; CHECK-TF-NEXT:      EMIT vp<%index.next> = add vp<[[VP4]]>, vp<[[VP1]]>
; CHECK-TF-NEXT:      EMIT branch-on-count vp<%index.next>, vp<[[VP2]]>
; CHECK-TF-NEXT:    No successors
; CHECK-TF-NEXT:  }
