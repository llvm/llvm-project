...
; VECTOR-NEXT:      EMIT vp<[[VP27:%[0-9]+]]> = mul vp<[[VP26]]>, ir<1>
; VECTOR-NEXT:      vp<[[VP28:%[0-9]+]]> = vector-pointer ir<%gep.dst>, ir<1>
; VECTOR-NEXT:      vp<[[VP29:%[0-9]+]]> = vector-pointer ir<%gep.dst>, ir<1>, vp<[[VP27]]>
; VECTOR-NEXT:      WIDEN store vp<[[VP28]]>, ir<%pred.val>
; VECTOR-NEXT:      WIDEN store vp<[[VP29]]>, ir<%pred.val>.1
