...
; CHECK:       vector.ph:
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[ARRAYIDX9_2]], align 4, !alias.scope [[META0:![0-9]+]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[P2]], align 4, !alias.scope [[META0]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = sub nsw <4 x i32> zeroinitializer, [[BROADCAST_SPLAT5]]
; CHECK-NEXT:    [[TMP4:%.*]] = sub nsw <4 x i32> [[TMP6]], [[BROADCAST_SPLAT3]]
; CHECK-NEXT:    [[TMP9:%.*]] = sub nsw <4 x i32> [[TMP4]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    br label [[VECTOR_BODY:%.*]]
; CHECK:       vector.body:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, [[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], [[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i32, ptr [[P]], i64 [[INDEX]]
; CHECK-NEXT:    store <4 x i32> [[TMP9]], ptr [[TMP7]], align 4, !alias.scope [[META3:![0-9]+]], !noalias [[META0]]
