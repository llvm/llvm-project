...
; CHECK-NEXT:    [[ACCUM_1_LCSSA:%.*]] = phi float [ [[ACCUM_1]], %[[IF_END]] ], [ [[TMP16]], %[[MIDDLE_BLOCK]] ]
; CHECK-NEXT:    br label %[[WHILE_END]]
; CHECK:       [[WHILE_END]]:
; CHECK-NEXT:    [[ACCUM_0_LCSSA:%.*]] = phi float [ 0.000000e+00, %[[ENTRY]] ], [ [[ACCUM_1_LCSSA]], %[[WHILE_END_LOOPEXIT]] ]
