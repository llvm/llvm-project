...
; CHECK:       [[VECTOR_PH]]:
; CHECK-NEXT:    [[TMP0:%.*]] = and i32 [[SIZE]], -16
; CHECK-NEXT:    [[TMP1:%.*]] = and i32 [[SIZE]], 15
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr [[PTR]], i32 [[TMP0]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = icmp eq i32 [[INDEX_NEXT]], [[TMP0]]
; CHECK-NEXT:    br i1 [[TMP4]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP0:![0-9]+]]
; CHECK:       [[MIDDLE_BLOCK]]:
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i32 [[SIZE]], [[TMP0]]
...
; COMMON: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; COMMON: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; COMMON: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
; COMMON: [[LOOP3]] = distinct !{[[LOOP3]], [[META2]], [[META1]]}
;.
