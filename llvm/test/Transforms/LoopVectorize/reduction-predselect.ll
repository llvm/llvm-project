...
; CHECK:       pred.load.if:
; CHECK-NEXT:    [[TMP27:%.*]] = shl nsw i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i32 [[TMP27]]
...
; CHECK:       pred.load.if1:
; CHECK-NEXT:    [[TMP28:%.*]] = shl i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr [[A]], i32 [[TMP28]]
...
; CHECK:       pred.load.if3:
; CHECK-NEXT:    [[TMP29:%.*]] = shl i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[A]], i32 [[TMP29]]
...
; CHECK:       pred.load.if5:
; CHECK-NEXT:    [[TMP30:%.*]] = shl i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr i8, ptr [[A]], i32 [[TMP30]]
...
; CHECK-NEXT:    br i1 [[TMP1]], label [[PRED_LOAD_IF:%.*]], label [[PRED_LOAD_CONTINUE:%.*]]
; CHECK:       pred.load.if:
; CHECK-NEXT:    [[TMP45:%.*]] = shl nsw i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i32 [[TMP45]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> poison, i32 [[TMP3]], i64 0
; CHECK-NEXT:    [[TMP46:%.*]] = shl nsw i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i32 [[TMP46]]
...
; CHECK-NEXT:    [[TMP47:%.*]] = shl nsw i32 [[TMP11]], 2
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP47]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <4 x i32> [[TMP8]], i32 [[TMP13]], i64 1
; CHECK-NEXT:    [[TMP48:%.*]] = shl nsw i32 [[TMP11]], 2
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP48]]
...
; CHECK-NEXT:    [[TMP49:%.*]] = shl nsw i32 [[TMP21]], 2
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP49]]
; CHECK-NEXT:    [[TMP23:%.*]] = load i32, ptr [[TMP22]], align 4
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x i32> [[TMP18]], i32 [[TMP23]], i64 2
; CHECK-NEXT:    [[TMP50:%.*]] = shl nsw i32 [[TMP21]], 2
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP50]]
...
; CHECK-NEXT:    [[TMP51:%.*]] = shl nsw i32 [[TMP31]], 2
; CHECK-NEXT:    [[TMP32:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP51]]
; CHECK-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP32]], align 4
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i32> [[TMP28]], i32 [[TMP33]], i64 3
; CHECK-NEXT:    [[TMP52:%.*]] = shl nsw i32 [[TMP31]], 2
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP52]]
...
; CHECK-NEXT:    br i1 [[TMP1]], label [[PRED_LOAD_IF:%.*]], label [[PRED_LOAD_CONTINUE:%.*]]
; CHECK:       pred.load.if:
; CHECK-NEXT:    [[TMP44:%.*]] = shl nsw i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i8, ptr [[A:%.*]], i32 [[TMP44]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> poison, i32 [[TMP3]], i64 0
; CHECK-NEXT:    [[TMP45:%.*]] = shl nsw i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i8, ptr [[B:%.*]], i32 [[TMP45]]
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[TMP5]], align 4
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <4 x i32> poison, i32 [[TMP6]], i64 0
; CHECK-NEXT:    br label [[PRED_LOAD_CONTINUE]]
; CHECK:       pred.load.continue:
...
; CHECK:       pred.load.if1:
; CHECK-NEXT:    [[TMP11:%.*]] = or disjoint i32 [[INDEX]], 1
; CHECK-NEXT:    [[TMP46:%.*]] = shl nsw i32 [[TMP11]], 2
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP46]]
; CHECK-NEXT:    [[TMP13:%.*]] = load i32, ptr [[TMP12]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <4 x i32> [[TMP8]], i32 [[TMP13]], i64 1
; CHECK-NEXT:    [[TMP47:%.*]] = shl nsw i32 [[TMP11]], 2
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP47]]
; CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr [[TMP15]], align 4
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[TMP16]], i64 1
; CHECK-NEXT:    br label [[PRED_LOAD_CONTINUE2]]
; CHECK:       pred.load.continue2:
...
; CHECK:       pred.load.if3:
; CHECK-NEXT:    [[TMP21:%.*]] = or disjoint i32 [[INDEX]], 2
; CHECK-NEXT:    [[TMP48:%.*]] = shl nsw i32 [[TMP21]], 2
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP48]]
; CHECK-NEXT:    [[TMP23:%.*]] = load i32, ptr [[TMP22]], align 4
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x i32> [[TMP18]], i32 [[TMP23]], i64 2
; CHECK-NEXT:    [[TMP49:%.*]] = shl nsw i32 [[TMP21]], 2
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP49]]
; CHECK-NEXT:    [[TMP26:%.*]] = load i32, ptr [[TMP25]], align 4
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <4 x i32> [[TMP19]], i32 [[TMP26]], i64 2
; CHECK-NEXT:    br label [[PRED_LOAD_CONTINUE4]]
; CHECK:       pred.load.continue4:
...
; CHECK:       pred.load.if5:
; CHECK-NEXT:    [[TMP31:%.*]] = or disjoint i32 [[INDEX]], 3
; CHECK-NEXT:    [[TMP50:%.*]] = shl nsw i32 [[TMP31]], 2
; CHECK-NEXT:    [[TMP32:%.*]] = getelementptr inbounds i8, ptr [[A]], i32 [[TMP50]]
; CHECK-NEXT:    [[TMP33:%.*]] = load i32, ptr [[TMP32]], align 4
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i32> [[TMP28]], i32 [[TMP33]], i64 3
; CHECK-NEXT:    [[TMP51:%.*]] = shl nsw i32 [[TMP31]], 2
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr inbounds i8, ptr [[B]], i32 [[TMP51]]
; CHECK-NEXT:    [[TMP36:%.*]] = load i32, ptr [[TMP35]], align 4
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <4 x i32> [[TMP29]], i32 [[TMP36]], i64 3
; CHECK-NEXT:    br label [[PRED_LOAD_CONTINUE6]]
; CHECK:       pred.load.continue6:
