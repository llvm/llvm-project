...
; GFX9-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[INDEX]], 1
; GFX9-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[S:%.*]], i64 [[TMP5]]
...
; VI-NEXT:    [[TMP5:%.*]] = shl nsw i64 [[INDEX]], 1
; VI-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr addrspace(1) [[S:%.*]], i64 [[TMP5]]
...
; CI-NEXT:    [[TMP1:%.*]] = shl nuw nsw i64 [[INDVARS_IV]], 1
; CI-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr addrspace(1) [[S:%.*]], i64 [[TMP1]]
