...
; UNROLL-NEXT:    br label %[[VECTOR_BODY:.*]]
; UNROLL:       [[VECTOR_BODY]]:
; UNROLL-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE1:.*]] ]
; UNROLL-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 1
...
; UNROLL-NOSIMPLIFY-NEXT:    br label %[[VECTOR_BODY:.*]]
; UNROLL-NOSIMPLIFY:       [[VECTOR_BODY]]:
; UNROLL-NOSIMPLIFY-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE1:.*]] ]
; UNROLL-NOSIMPLIFY-NEXT:    [[TMP0:%.*]] = add i64 [[INDEX]], 1
...
; UNROLL-NEXT:  [[VECTOR_PH:.*:]]
; UNROLL-NEXT:    br label %[[VECTOR_BODY:.*]]
; UNROLL:       [[VECTOR_BODY]]:
; UNROLL-NEXT:    [[TMP1:%.*]] = sdiv i16 10, [[TMP0]]
; UNROLL-NEXT:    br label %[[PRED_STORE_CONTINUE1:.*]]
; UNROLL:       [[PRED_STORE_CONTINUE1]]:
; UNROLL-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_BODY]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE2:.*]] ]
...
; UNROLL-NEXT:    br i1 [[TMP3]], label %[[MIDDLE_BLOCK:.*]], label %[[PRED_STORE_CONTINUE1]], !llvm.loop [[LOOP7:![0-9]+]]
; UNROLL:       [[MIDDLE_BLOCK]]:
...
; UNROLL-NOSIMPLIFY-NEXT:  [[VECTOR_PH:.*:]]
; UNROLL-NOSIMPLIFY-NEXT:    br label %[[VECTOR_BODY:.*]]
; UNROLL-NOSIMPLIFY:       [[VECTOR_BODY]]:
; UNROLL-NOSIMPLIFY-NEXT:    [[TMP1:%.*]] = sdiv i16 10, [[TMP0]]
; UNROLL-NOSIMPLIFY-NEXT:    br label %[[PRED_STORE_CONTINUE1:.*]]
; UNROLL-NOSIMPLIFY:       [[PRED_STORE_CONTINUE1]]:
; UNROLL-NOSIMPLIFY-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_BODY]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE2:.*]] ]
...
; UNROLL-NOSIMPLIFY-NEXT:    br i1 [[TMP3]], label %[[MIDDLE_BLOCK:.*]], label %[[PRED_STORE_CONTINUE1]], !llvm.loop [[LOOP7:![0-9]+]]
; UNROLL-NOSIMPLIFY:       [[MIDDLE_BLOCK]]:
...
; VEC-NEXT:    br label %[[VECTOR_BODY:.*]]
; VEC:       [[VECTOR_BODY]]:
; VEC-NEXT:    [[TMP3:%.*]] = sdiv i16 10, [[TMP0]]
; VEC-NEXT:    br label %[[PRED_STORE_CONTINUE1:.*]]
; VEC:       [[PRED_STORE_CONTINUE1]]:
; VEC-NEXT:    [[INDEX:%.*]] = phi i32 [ 0, %[[VECTOR_BODY]] ], [ [[INDEX_NEXT:%.*]], %[[PRED_STORE_CONTINUE4:.*]] ]
...
; VEC-NEXT:    br i1 [[TMP4]], label %[[MIDDLE_BLOCK:.*]], label %[[PRED_STORE_CONTINUE1]], !llvm.loop [[LOOP7:![0-9]+]]
; VEC:       [[MIDDLE_BLOCK]]:
