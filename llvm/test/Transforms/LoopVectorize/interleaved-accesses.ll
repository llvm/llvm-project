...
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = lshr exact i64 [[INDVARS_IV]], 1
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw [4 x i8], ptr [[B]], i64 [[STRIDED_VEC]]
...
; CHECK-NEXT:    [[WIDE_VEC:%.*]] = load <8 x i32>, ptr [[TMP5]], align 4
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.vector.deinterleave2.v8i32(<8 x i32> [[WIDE_VEC]])
; CHECK-NEXT:    [[TMP18:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[STRIDED_VEC]], 0
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <4 x i32> [[TMP18]], i64 0
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <4 x i32> [[TMP18]], i64 1
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <4 x i32> [[TMP18]], i64 2
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <4 x i32> [[TMP18]], i64 3
...
; CHECK-NEXT:    [[WIDE_VEC:%.*]] = load <8 x i32>, ptr [[TMP5]], align 4
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.vector.deinterleave2.v8i32(<8 x i32> [[WIDE_VEC]])
; CHECK-NEXT:    [[TMP21:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[STRIDED_VEC]], 0
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <4 x i32> [[TMP21]], i64 0
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <4 x i32> [[TMP21]], i64 1
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <4 x i32> [[TMP21]], i64 2
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <4 x i32> [[TMP21]], i64 3
...
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.vector.deinterleave2.v8i32(<8 x i32> [[WIDE_VEC]])
; CHECK-NEXT:    [[TMP20:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[STRIDED_VEC]], 0
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <4 x i32> [[TMP20]], i64 0
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <4 x i32> [[TMP20]], i64 1
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <4 x i32> [[TMP20]], i64 2
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <4 x i32> [[TMP20]], i64 3
; CHECK-NEXT:    store i32 [[TMP14]], ptr [[TMP10]], align 4
; CHECK-NEXT:    store i32 [[TMP15]], ptr [[TMP11]], align 4
; CHECK-NEXT:    store i32 [[TMP16]], ptr [[TMP12]], align 4
...
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = call { <4 x i32>, <4 x i32> } @llvm.vector.deinterleave2.v8i32(<8 x i32> [[WIDE_VEC]])
; CHECK-NEXT:    [[TMP24:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[STRIDED_VEC]], 0
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <4 x i32> [[TMP24]], i64 0
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <4 x i32> [[TMP24]], i64 1
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <4 x i32> [[TMP24]], i64 2
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <4 x i32> [[TMP24]], i64 3
...
; CHECK-NEXT:    [[STRIDED_VEC1:%.*]] = call { <4 x i16>, <4 x i16> } @llvm.vector.deinterleave2.v8i16(<8 x i16> [[WIDE_VEC]])
; CHECK-NEXT:    [[STRIDED_VEC:%.*]] = extractvalue { <4 x i16>, <4 x i16> } [[STRIDED_VEC1]], 0
; CHECK-NEXT:    [[STRIDED_VEC4]] = extractvalue { <4 x i16>, <4 x i16> } [[STRIDED_VEC1]], 1
