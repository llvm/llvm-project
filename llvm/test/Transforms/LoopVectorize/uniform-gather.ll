...
; FIXED-NEXT:    [[TMP7:%.*]] = xor <2 x i1> [[TMP2]], splat (i1 true)
; FIXED-NEXT:    [[TMP8:%.*]] = select <2 x i1> [[TMP1]], <2 x i1> [[TMP7]], <2 x i1> zeroinitializer
; FIXED-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <2 x i32> @llvm.masked.gather.v2i32.v2p0(<2 x ptr> align 4 <ptr getelementptr inbounds nuw (i8, ptr @exp_table, i64 4), ptr getelementptr inbounds nuw (i8, ptr @exp_table, i64 4)>, <2 x i1> [[TMP8]], <2 x i32> poison)
...
; SCALABLE-NEXT:    [[TMP12:%.*]] = xor <vscale x 2 x i1> [[TMP4]], splat (i1 true)
; SCALABLE-NEXT:    [[TMP8:%.*]] = select <vscale x 2 x i1> [[TMP11]], <vscale x 2 x i1> [[TMP12]], <vscale x 2 x i1> zeroinitializer
...
; SCALABLE-NEXT:    [[BROADCAST_SPLATINSERT2:%.*]] = insertelement <vscale x 2 x ptr> poison, ptr [[TMP3]], i64 0
; SCALABLE-NEXT:    [[BROADCAST_SPLAT2:%.*]] = shufflevector <vscale x 2 x ptr> [[BROADCAST_SPLATINSERT2]], <vscale x 2 x ptr> poison, <vscale x 2 x i32> zeroinitializer
...
; SCALABLE-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 2 x i32> @llvm.masked.gather.nxv2i32.nxv2p0(<vscale x 2 x ptr> align 4 [[BROADCAST_SPLAT2]], <vscale x 2 x i1> [[TMP8]], <vscale x 2 x i32> poison)
...
; FIXED-NEXT:    [[TMP5:%.*]] = add <2 x i32> [[WIDE_MASKED_GATHER3]], [[WIDE_MASKED_GATHER3]]
...
; SCALABLE-NEXT:    [[TMP8:%.*]] = add <vscale x 2 x i32> [[WIDE_MASKED_GATHER5]], [[WIDE_MASKED_GATHER5]]
