...
; IC4VF4-NEXT:    [[TMP71:%.*]] = select <4 x i1> splat (i1 true), <4 x i1> [[TMP100]], <4 x i1> zeroinitializer
...
; IC4VF4-NEXT:    [[TMP18:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD]], [[WIDE_LOAD14]]
; IC4VF4-NEXT:    [[TMP23:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD8]], [[WIDE_LOAD15]]
; IC4VF4-NEXT:    [[TMP24:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD9]], [[WIDE_LOAD16]]
; IC4VF4-NEXT:    [[TMP25:%.*]] = icmp sgt <4 x i64> [[WIDE_LOAD10]], [[WIDE_LOAD17]]
; IC4VF4-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i1> [[TMP18]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP29:%.*]] = shufflevector <4 x i1> [[TMP23]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP20:%.*]] = shufflevector <4 x i1> [[TMP24]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; IC4VF4-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i1> [[TMP25]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
