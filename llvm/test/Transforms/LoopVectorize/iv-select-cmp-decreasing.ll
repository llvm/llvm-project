...
; IC4VF4-NEXT:    [[TMP28:%.*]] = select <4 x i1> [[TMP0]], <4 x i1> [[TMP103]], <4 x i1> zeroinitializer
...
; IC4VF4-NEXT:    [[TMP33:%.*]] = icmp eq i32 [[INDEX_NEXT]], 12
; IC4VF4-NEXT:    br i1 [[TMP33]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; IC4VF4:       [[MIDDLE_BLOCK]]:
...
; IC4VF1-NEXT:  [[VECTOR_PH:.*]]:
; IC4VF1-NEXT:    br label %[[VECTOR_BODY:.*]]
; IC4VF1:       [[VECTOR_BODY]]:
; IC4VF1-NEXT:    [[TMP2:%.*]] = phi i16 [ 12, %[[VECTOR_PH]] ], [ [[TMP18:%.*]], %[[VECTOR_BODY]] ]
; IC4VF1-NEXT:    [[VEC_PHI3:%.*]] = phi i16 [ 0, %[[VECTOR_PH]] ], [ [[TMP22:%.*]], %[[VECTOR_BODY]] ]
...
; IC4VF1-NEXT:    [[EXIT_COND:%.*]] = icmp eq i16 [[TMP18]], 0
; IC4VF1-NEXT:    br i1 [[EXIT_COND]], label %[[EXIT:.*]], label %[[VECTOR_BODY]]
; IC4VF1:       [[EXIT]]:
; IC4VF1-NEXT:    [[RDX_SELECT:%.*]] = phi i16 [ [[TMP22]], %[[VECTOR_BODY]] ]
...
; IC4VF4-NEXT:    [[VEC_IND_NEXT]] = add nsw <4 x i16> [[STEP_ADD_3]], splat (i16 -4)
; IC4VF4-NEXT:    [[TMP33:%.*]] = icmp eq i32 [[INDEX_NEXT]], 12
; IC4VF4-NEXT:    br i1 [[TMP33]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP4:![0-9]+]]
; IC4VF4:       [[MIDDLE_BLOCK]]:
; IC4VF4-NEXT:    [[RDX_SELECT:%.*]] = call i16 @llvm.experimental.vector.extract.last.active.v4i16(<4 x i16> [[TMP32]], <4 x i1> [[TMP31]], i16 0)
; IC4VF4-NEXT:    br label %[[EXIT:.*]]
; IC4VF4:       [[EXIT]]:
...
; IC4VF1-NEXT:    br i1 [[TMP19]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP3:![0-9]+]]
; IC4VF1:       [[MIDDLE_BLOCK]]:
...
; IC1VF4-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ [[BROADCAST_SPLAT]], %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; IC1VF4-NEXT:    [[TMP3:%.*]] = phi <4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP12:%.*]], %[[VECTOR_BODY]] ]
...
; IC1VF4-NEXT:    [[TMP15:%.*]] = freeze <4 x i1> [[TMP8]]
; IC1VF4-NEXT:    [[TMP9:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP15]])
; IC1VF4-NEXT:    [[TMP12]] = select i1 [[TMP9]], <4 x i1> [[TMP8]], <4 x i1> [[TMP3]]
; IC1VF4-NEXT:    [[TMP11]] = select i1 [[TMP9]], <4 x i64> [[TMP0]], <4 x i64> [[VEC_PHI]]
; IC1VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
...
; IC1VF4:       [[MIDDLE_BLOCK]]:
; IC1VF4-NEXT:    [[TMP13:%.*]] = extractelement <4 x i64> [[BROADCAST_SPLAT]], i32 0
; IC1VF4-NEXT:    [[TMP14:%.*]] = call i64 @llvm.experimental.vector.extract.last.active.v4i64(<4 x i64> [[TMP11]], <4 x i1> [[TMP12]], i64 [[TMP13]])
; IC1VF4-NEXT:    br label %[[SCALAR_PH:.*]]
; IC1VF4:       [[SCALAR_PH]]:
; IC1VF4-NEXT:    br label %[[LOOP:.*]]
; IC1VF4:       [[LOOP]]:
; IC1VF4-NEXT:    [[IV:%.*]] = phi i64 [ 3, %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; IC1VF4-NEXT:    [[RDX:%.*]] = phi i64 [ [[TMP14]], %[[SCALAR_PH]] ], [ [[COND:%.*]], %[[LOOP]] ]
...
; IC4VF4-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ [[BROADCAST_SPLAT]], %[[VECTOR_PH]] ], [ [[TMP11:%.*]], %[[VECTOR_BODY]] ]
; IC4VF4-NEXT:    [[TMP2:%.*]] = phi <4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP10:%.*]], %[[VECTOR_BODY]] ]
...
; IC4VF4-NEXT:    [[WIDE_LOAD6:%.*]] = load <4 x i8>, ptr [[TMP7]], align 1
...
; IC4VF4-NEXT:    [[WIDE_LOAD13:%.*]] = load <4 x i8>, ptr [[TMP16]], align 1
...
; IC4VF4-NEXT:    [[TMP8:%.*]] = freeze <4 x i1> [[TMP26]]
; IC4VF4-NEXT:    [[TMP9:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP8]])
; IC4VF4-NEXT:    [[TMP10]] = select i1 [[TMP9]], <4 x i1> [[TMP26]], <4 x i1> [[TMP2]]
; IC4VF4-NEXT:    [[TMP11]] = select i1 [[TMP9]], <4 x i64> [[TMP0]], <4 x i64> [[VEC_PHI]]
; IC4VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; IC4VF4-NEXT:    [[VEC_IND_NEXT]] = add <4 x i64> [[VEC_IND]], splat (i64 -4)
; IC4VF4-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[INDEX_NEXT]], -4
; IC4VF4-NEXT:    br i1 [[TMP12]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP6:![0-9]+]]
; IC4VF4:       [[MIDDLE_BLOCK]]:
; IC4VF4-NEXT:    [[TMP13:%.*]] = extractelement <4 x i64> [[BROADCAST_SPLAT]], i32 0
; IC4VF4-NEXT:    [[TMP15:%.*]] = call i64 @llvm.experimental.vector.extract.last.active.v4i64(<4 x i64> [[TMP11]], <4 x i1> [[TMP10]], i64 [[TMP13]])
...
; IC4VF1-NEXT:  [[SCALAR_PH:.*]]:
; IC4VF1-NEXT:    br label %[[LOOP:.*]]
; IC4VF1:       [[LOOP]]:
; IC4VF1-NEXT:    [[IV:%.*]] = phi i64 [ -1, %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; IC4VF1-NEXT:    [[RDX:%.*]] = phi i64 [ [[RDX_START]], %[[SCALAR_PH]] ], [ [[COND:%.*]], %[[LOOP]] ]
...
; IC1VF4-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ [[BROADCAST_SPLAT]], %[[VECTOR_PH]] ], [ [[TMP14:%.*]], %[[VECTOR_BODY]] ]
; IC1VF4-NEXT:    [[TMP6:%.*]] = phi <4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP13:%.*]], %[[VECTOR_BODY]] ]
...
; IC1VF4-NEXT:    [[TMP15:%.*]] = freeze <4 x i1> [[TMP11]]
; IC1VF4-NEXT:    [[TMP12:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP15]])
; IC1VF4-NEXT:    [[TMP13]] = select i1 [[TMP12]], <4 x i1> [[TMP11]], <4 x i1> [[TMP6]]
; IC1VF4-NEXT:    [[TMP14]] = select i1 [[TMP12]], <4 x i64> [[TMP3]], <4 x i64> [[VEC_PHI]]
; IC1VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; IC1VF4-NEXT:    [[VEC_IND_NEXT]] = add nsw <4 x i64> [[VEC_IND]], splat (i64 -4)
...
; IC1VF4:       [[MIDDLE_BLOCK]]:
; IC1VF4-NEXT:    [[TMP18:%.*]] = extractelement <4 x i64> [[BROADCAST_SPLAT]], i32 0
; IC1VF4-NEXT:    [[TMP17:%.*]] = call i64 @llvm.experimental.vector.extract.last.active.v4i64(<4 x i64> [[TMP14]], <4 x i1> [[TMP13]], i64 [[TMP18]])
...
; IC1VF4-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i64 [ [[TMP17]], %[[MIDDLE_BLOCK]] ], [ [[RDX_START]], %[[ENTRY]] ]
; IC1VF4-NEXT:    br label %[[LOOP:.*]]
; IC1VF4:       [[LOOP]]:
...
; IC1VF4:       [[EXIT]]:
; IC1VF4-NEXT:    [[COND_LCSSA:%.*]] = phi i64 [ [[COND]], %[[LOOP]] ], [ [[TMP17]], %[[MIDDLE_BLOCK]] ]
; IC1VF4-NEXT:    ret i64 [[COND_LCSSA]]
;
...
; IC4VF4-NEXT:    [[TMP6:%.*]] = phi <4 x i1> [ zeroinitializer, %[[VECTOR_PH]] ], [ [[TMP18:%.*]], %[[VECTOR_BODY]] ]
...
; IC4VF4-NEXT:    [[WIDE_LOAD10:%.*]] = load <4 x i64>, ptr [[TMP9]], align 8
...
; IC4VF4-NEXT:    [[WIDE_LOAD17:%.*]] = load <4 x i64>, ptr [[TMP14]], align 8
...
; IC4VF4-NEXT:    [[TMP11:%.*]] = freeze <4 x i1> [[TMP21]]
; IC4VF4-NEXT:    [[TMP12:%.*]] = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> [[TMP11]])
; IC4VF4-NEXT:    [[TMP18]] = select i1 [[TMP12]], <4 x i1> [[TMP21]], <4 x i1> [[TMP6]]
; IC4VF4-NEXT:    [[TMP15]] = select i1 [[TMP12]], <4 x i64> [[TMP3]], <4 x i64> [[VEC_PHI]]
; IC4VF4-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
...
; IC4VF4:       [[MIDDLE_BLOCK]]:
; IC4VF4-NEXT:    [[TMP19:%.*]] = extractelement <4 x i64> [[BROADCAST_SPLAT]], i32 0
; IC4VF4-NEXT:    [[TMP17:%.*]] = call i64 @llvm.experimental.vector.extract.last.active.v4i64(<4 x i64> [[TMP15]], <4 x i1> [[TMP18]], i64 [[TMP19]])
...
; IC4VF4-NEXT:    [[BC_MERGE_RDX:%.*]] = phi i64 [ [[TMP17]], %[[MIDDLE_BLOCK]] ], [ [[RDX_START]], %[[ENTRY]] ]
; IC4VF4-NEXT:    br label %[[LOOP:.*]]
; IC4VF4:       [[LOOP]]:
...
; IC4VF4:       [[EXIT]]:
; IC4VF4-NEXT:    [[COND_LCSSA:%.*]] = phi i64 [ [[COND]], %[[LOOP]] ], [ [[TMP17]], %[[MIDDLE_BLOCK]] ]
; IC4VF4-NEXT:    ret i64 [[COND_LCSSA]]
;
...
; IC4VF1:       [[LOOP1]]:
; IC4VF1-NEXT:    [[IV1:%.*]] = phi i64 [ [[IV_NEXT1:%.*]], %[[LOOP1]] ], [ [[N]], %[[EXIT]] ]
; IC4VF1-NEXT:    [[RDX1:%.*]] = phi i64 [ [[COND1:%.*]], %[[LOOP1]] ], [ [[RDX_START]], %[[EXIT]] ]
...
; IC4VF1-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP1]], label %[[EXIT1:.*]]
; IC4VF1:       [[EXIT1]]:
; IC4VF1-NEXT:    [[COND_LCSSA:%.*]] = phi i64 [ [[COND1]], %[[LOOP1]] ]
; IC4VF1-NEXT:    ret i64 [[COND_LCSSA]]
;
entry:
  br label %loop
