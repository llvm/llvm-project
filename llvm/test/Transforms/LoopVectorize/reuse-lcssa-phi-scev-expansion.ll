...
; CHECK-NEXT:    [[TMP12:%.*]] = sub i32 2, [[STEP]]
; CHECK-NEXT:    [[TMP14:%.*]] = add i32 [[IV_1_LCSSA]], [[TMP12]]
; CHECK-NEXT:    [[SMAX1:%.*]] = call i32 @llvm.smax.i32(i32 [[TMP14]], i32 0)
; CHECK-NEXT:    [[TMP16:%.*]] = add i32 [[TMP3]], -1
; CHECK-NEXT:    [[TMP15:%.*]] = add i32 [[SMAX1]], [[TMP16]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = sub i64 [[TMP2]], 1
; CHECK-NEXT:    [[DIFF_CHECK:%.*]] = icmp ult i64 [[TMP6]], 3
; CHECK-NEXT:    br i1 [[DIFF_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
; CHECK:       [[VECTOR_PH]]:
