...
; CHECK-VF1IC4-NEXT:    [[OFFSET_IDX:%.*]] = add nsw i64 -9223372036854775807, [[INDEX]]
...
; CHECK-VF1IC4-NEXT:    [[OFFSET_IDX:%.*]] = add nsw i64 -9223372036854775808, [[IV_I]]
...
; CHECK-VF1IC4-NEXT:    [[IV_J:%.*]] = add nsw i64 -9223372036854775808, [[IV_I]]
...
; CHECK-VF4IC1-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 [[IVSTART]], [[INDEX]]
...
; CHECK-VF4IC4-NEXT:    [[OFFSET_IDX:%.*]] = add nuw nsw i64 [[IVSTART]], [[INDEX]]
...
; CHECK-VF1IC4-NEXT:    [[IV:%.*]] = add nuw nsw i64 [[IVSTART]], [[INDEX]]
