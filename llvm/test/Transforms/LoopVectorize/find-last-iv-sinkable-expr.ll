...
; CHECK-NEXT:    [[TMP6:%.*]] = add nuw i64 10, [[TMP5]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = icmp sle <4 x i64> [[WIDE_LOAD]], [[WIDE_LOAD2]]
; CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <4 x i1> [[TMP19]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
