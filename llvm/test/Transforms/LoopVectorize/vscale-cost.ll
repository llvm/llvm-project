...
; CHECK:  Cost of 0 for VF vscale x 4: EMIT-SCALAR vp<%bc.resume.val> = phi [ vp<[[VP4:%[0-9]+]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
; CHECK:  Cost of 0 for VF vscale x 4: EMIT-SCALAR vp<%bc.resume.val>.1 = phi [ vp<[[VP5:%[0-9]+]]>, middle.block ], [ ir<%dst.start>, ir-bb<entry> ]
; CHECK:  Cost of 0 for VF vscale x 4: EMIT-SCALAR vp<[[VP2:%[0-9]+]]> = vscale i64
; CHECK:  Cost of 0 for VF vscale x 4: EMIT-SCALAR vp<%bc.resume.val> = phi [ vp<[[VP4]]>, middle.block ], [ ir<0>, ir-bb<entry> ]
; CHECK:  Cost of 0 for VF vscale x 4: EMIT-SCALAR vp<%bc.resume.val>.1 = phi [ vp<[[VP5]]>, middle.block ], [ ir<%dst.start>, ir-bb<entry> ]
