...
;.
; CHECK-GATHER-ENABLED: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; CHECK-GATHER-ENABLED: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; CHECK-GATHER-ENABLED: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
;.
; CHECK-GATHER-DISABLED: [[LOOP0]] = distinct !{[[LOOP0]], [[META1:![0-9]+]], [[META2:![0-9]+]]}
; CHECK-GATHER-DISABLED: [[META1]] = !{!"llvm.loop.isvectorized", i32 1}
; CHECK-GATHER-DISABLED: [[META2]] = !{!"llvm.loop.unroll.runtime.disable"}
;.
