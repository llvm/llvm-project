...
; By default, elementwise atomicrmws are expanded because it is not generally
; safe to treat an elementwise atomicrmw as a whole-vector atomicrmw.
;
; FIXME: X86ISelLowering and many other backends override
; shouldExpandAtomicRMWInIR and currently do not expand elementwise atomicrmws.
