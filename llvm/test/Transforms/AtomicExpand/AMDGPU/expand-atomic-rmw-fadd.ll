...
attributes #1 = { strictfp denormal_fpenv(float: preservesign,preservesign) }
attributes #2 = { strictfp }
attributes #3 = { denormal_fpenv(float: preservesign,preservesign) }
attributes #4 = { denormal_fpenv(float: dynamic,dynamic) }
