...
; CHECK: error: unsupported atomic load: instruction alignment 2 is not supported for this 8-byte atomic operation with 4-byte elements
...
; CHECK: error: unsupported atomic store: instruction alignment 2 is not supported for this 8-byte atomic operation with 4-byte elements
...
; CHECK: error: unsupported atomic load: instruction alignment 2 is not supported for this 4-byte atomic operation with 2-byte elements
...
; CHECK: error: unsupported atomic load: instruction alignment 4 is not supported for this 8-byte atomic operation with 4-byte elements
