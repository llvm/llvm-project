...
; CHECK-LABEL: define i16 @test_atomicrmw_xchg_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_xchg_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_add_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_add_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(1) [[PTR]], align 4
; CHECK-NEXT:    br label %[[ATOMICRMW_START:.*]]
...
; CHECK-LABEL: define i16 @test_atomicrmw_sub_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_drop_md(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_drop_md(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
; CHECK-NEXT:    [[TMP2:%.*]] = atomicrmw and ptr addrspace(1) [[PTR]], i32 [[ANDOPERAND]] syncscope("agent") seq_cst, align 4
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_preserve_mmra(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_preserve_mmra(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_preserve_alias_scope(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_preserve_noalias(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_preserve_tbaa_struct(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4_preserve_tbaa(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
; CHECK-NEXT:    [[TMP2:%.*]] = atomicrmw and ptr addrspace(1) [[PTR]], i32 [[ANDOPERAND]] syncscope("agent") seq_cst, align 4, !tbaa [[CHAR_TBAA5:![0-9]+]]
; CHECK-NEXT:    [[EXTRACTED:%.*]] = trunc i32 [[TMP2]] to i16
; CHECK-NEXT:    ret i16 [[EXTRACTED]]
;
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent__amdgpu_no_remote_memory(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4__amdgpu_no_remote_memory(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent__amdgpu_no_fine_grained_memory(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_and_i16_global_agent_align4__amdgpu_no_fine_grained_memory(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[ANDOPERAND:%.*]] = or i32 [[TMP1]], -65536
...
; CHECK-LABEL: define i16 @test_atomicrmw_nand_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_or_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_xor_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_max_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_min_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_umax_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_umin_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_cmpxchg_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i16 [[IN:%.*]], i16 [[OLD:%.*]]) {
...
; CHECK-LABEL: define i16 @test_cmpxchg_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i16 [[IN:%.*]], i16 [[OLD:%.*]]) {
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i16, ptr addrspace(1) [[OUT]], i64 4
...
; CHECK-LABEL: define i16 @test_atomicrmw_xchg_i16_local(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_cmpxchg_i16_local(
; CHECK-SAME: ptr addrspace(3) [[OUT:%.*]], i16 [[IN:%.*]], i16 [[OLD:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_xor_i16_local_align4(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_local(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(3) @llvm.ptrmask.p3.i32(ptr addrspace(3) [[PTR]], i32 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(3) [[PTR]] to i32
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i32 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_local_align4(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_flat_agent(
; CHECK-SAME: ptr [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_inc_i16_flat_agent_align4(
; CHECK-SAME: ptr [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(1) [[PTR]], align 4
; CHECK-NEXT:    br label %[[ATOMICRMW_START:.*]]
; CHECK:       [[ATOMICRMW_START]]:
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_local(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(3) @llvm.ptrmask.p3.i32(ptr addrspace(3) [[PTR]], i32 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(3) [[PTR]] to i32
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i32 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_local_align4(
; CHECK-SAME: ptr addrspace(3) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(3) [[PTR]], align 4
; CHECK-NEXT:    br label %[[ATOMICRMW_START:.*]]
; CHECK:       [[ATOMICRMW_START]]:
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_flat_agent(
; CHECK-SAME: ptr [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr @llvm.ptrmask.p0.i64(ptr [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_dec_i16_flat_agent_align4(
; CHECK-SAME: ptr [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[PTR]], align 4
; CHECK-NEXT:    br label %[[ATOMICRMW_START:.*]]
; CHECK:       [[ATOMICRMW_START]]:
...
; CHECK-LABEL: define half @test_atomicrmw_xchg_f16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], half [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[PTRLSB]], 3
...
; CHECK-LABEL: define half @test_atomicrmw_xchg_f16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], half [[VALUE:%.*]]) {
...
; CHECK-LABEL: define half @test_atomicrmw_xchg_f16_flat_agent(
; CHECK-SAME: ptr [[PTR:%.*]], half [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr @llvm.ptrmask.p0.i64(ptr [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[PTRLSB]], 3
...
; CHECK-LABEL: define half @test_atomicrmw_xchg_f16_flat_agent_align4(
; CHECK-SAME: ptr [[PTR:%.*]], half [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast half [[VALUE]] to i16
; CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[TMP1]] to i32
...
; CHECK-LABEL: define bfloat @test_atomicrmw_xchg_bf16_global_agent(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], bfloat [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) [[PTR]], i64 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(1) [[PTR]] to i64
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i64 [[TMP1]], 3
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[PTRLSB]], 3
...
; CHECK-LABEL: define bfloat @test_atomicrmw_xchg_bf16_global_agent_align4(
; CHECK-SAME: ptr addrspace(1) [[PTR:%.*]], bfloat [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_xchg_i16_buffer_fat_agent(
; CHECK-SAME: ptr addrspace(7) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
...
; CHECK-LABEL: define i16 @test_atomicrmw_xchg_i16_buffer_fat_agent_align4(
; CHECK-SAME: ptr addrspace(7) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
...
; CHECK-LABEL: define i16 @test_atomicrmw_add_i16_buffer_fat_agent(
; CHECK-SAME: ptr addrspace(7) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[ALIGNEDADDR:%.*]] = call ptr addrspace(7) @llvm.ptrmask.p7.i32(ptr addrspace(7) [[PTR]], i32 -4)
; CHECK-NEXT:    [[TMP1:%.*]] = ptrtoint ptr addrspace(7) [[PTR]] to i32
; CHECK-NEXT:    [[PTRLSB:%.*]] = and i32 [[TMP1]], 3
...
; CHECK-LABEL: define i16 @test_atomicrmw_add_i16_buffer_fat_agent_align4(
; CHECK-SAME: ptr addrspace(7) [[PTR:%.*]], i16 [[VALUE:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = zext i16 [[VALUE]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(7) [[PTR]], align 4
; CHECK-NEXT:    br label %[[ATOMICRMW_START:.*]]
...
; CHECK: [[TBAA_STRUCT4]] = !{i64 0, i64 4, [[META0]], i64 8, i64 4}
