...
; RUN: opt -S -mtriple=amdgpu12.00-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=GFX1200 %s
; RUN: opt -S -mtriple=amdgpu12.50-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=GFX1250,GFX1250-NOGAS %s
; RUN: opt -S -mtriple=amdgpu12.50-amd-amdhsa -amdgpu-globally-addressable-scratch -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=GFX1250,GFX1250-GAS %s
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[VAL:%.*]]) {
...
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[VAL:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[VAL:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[VAL:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]]) {
...
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[OLD:%.*]], i32 [[IN:%.*]]) {
; GFX1200-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr addrspace(5) [[ADDR]], align 4
; GFX1200-NEXT:    [[TMP2:%.*]] = icmp eq i32 [[TMP1]], [[OLD]]
; GFX1200-NEXT:    [[TMP3:%.*]] = select i1 [[TMP2]], i32 [[IN]], i32 [[TMP1]]
; GFX1200-NEXT:    store volatile i32 [[TMP3]], ptr addrspace(5) [[ADDR]], align 4
...
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[OLD:%.*]], i32 [[IN:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[OLD:%.*]], i32 [[IN:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[IN:%.*]]) {
; GFX1200-NEXT:    [[TMP1:%.*]] = load volatile i32, ptr addrspace(5) [[ADDR]], align 4
; GFX1200-NEXT:    store volatile i32 [[IN]], ptr addrspace(5) [[ADDR]], align 4
; GFX1200-NEXT:    ret i32 [[TMP1]]
;
; GFX1250-NOGAS-LABEL: define i32 @system_atomicrmw_xchg_acq_rel_i32(
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[IN:%.*]]) {
; GFX1250-NOGAS-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(5) [[ADDR]], align 4
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i32 [[IN:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], i16 [[IN:%.*]]) {
; GFX1200-NEXT:    [[TMP1:%.*]] = load volatile i16, ptr addrspace(5) [[ADDR]], align 2
; GFX1200-NEXT:    store volatile i16 [[IN]], ptr addrspace(5) [[ADDR]], align 2
; GFX1200-NEXT:    ret i16 [[TMP1]]
;
; GFX1250-NOGAS-LABEL: define i16 @system_atomicrmw_xchg_acq_rel_i16(
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i16 [[IN:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], i16 [[IN:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], half [[IN:%.*]]) {
; GFX1200-NEXT:    [[TMP1:%.*]] = load volatile half, ptr addrspace(5) [[ADDR]], align 2
; GFX1200-NEXT:    [[TMP2:%.*]] = call half @llvm.maxnum.f16(half [[TMP1]], half [[IN]])
; GFX1200-NEXT:    store volatile half [[TMP2]], ptr addrspace(5) [[ADDR]], align 2
; GFX1200-NEXT:    ret half [[TMP1]]
;
; GFX1250-NOGAS-LABEL: define half @system_atomicrmw_fmax_acq_rel_half(
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], half [[IN:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], half [[IN:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
...
; GFX1200-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[IN:%.*]]) {
; GFX1200-NEXT:    [[TMP1:%.*]] = load volatile float, ptr addrspace(5) [[ADDR]], align 4
; GFX1200-NEXT:    [[TMP2:%.*]] = call float @llvm.minimum.f32(float [[TMP1]], float [[IN]])
; GFX1200-NEXT:    store volatile float [[TMP2]], ptr addrspace(5) [[ADDR]], align 4
; GFX1200-NEXT:    ret float [[TMP1]]
;
; GFX1250-NOGAS-LABEL: define float @system_atomicrmw_fminimum_acq_rel_float(
; GFX1250-NOGAS-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[IN:%.*]]) {
...
; GFX1250-GAS-SAME: ptr addrspace(5) [[ADDR:%.*]], float [[IN:%.*]]) {
; GFX1250-GAS-NEXT:    [[SCRATCH_ASCAST:%.*]] = addrspacecast ptr addrspace(5) [[ADDR]] to ptr
