...
; RUN: opt -S -mtriple=amdgpu8.03-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX803 %s
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX900 %s
; RUN: opt -S -mtriple=amdgpu9.0a-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX90A %s
; RUN: opt -S -mtriple=amdgpu10.30-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX10 %s
; RUN: opt -S -mtriple=amdgpu11.00-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX11 %s
; RUN: opt -S -mtriple=amdgpu9.42-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX942 %s
; RUN: opt -S -mtriple=amdgpu12.00-amd-amdhsa -passes='require<libcall-lowering-info>,atomic-expand' %s | FileCheck -check-prefixes=CHECK,GFX12 %s
...
; GFX803-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX900-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX90A-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX10-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX11-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX942-SAME: ptr addrspace(1) [[PTR:%.*]]) {
...
; GFX12-SAME: ptr addrspace(1) [[PTR:%.*]]) {
