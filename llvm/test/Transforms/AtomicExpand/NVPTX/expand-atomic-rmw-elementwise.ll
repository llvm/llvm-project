...
; SM90PTX83-NEXT:    [[OLD:%.*]] = atomicrmw elementwise fadd ptr [[ADDR]], <4 x float> [[VAL]] monotonic, align 16
...
; SM90PTX83-NEXT:  [[ENTRY:.*:]]
; SM90PTX83-NEXT:    [[OLD:%.*]] = atomicrmw elementwise fadd ptr [[ADDR]], <2 x float> [[VAL]] monotonic, align 8
...
; SM90PTX81-NEXT:  [[ENTRY:.*:]]
; SM90PTX81-NEXT:    [[OLD:%.*]] = atomicrmw elementwise fadd ptr [[ADDR]], <2 x float> [[VAL]] monotonic, align 8
...
; SM90PTX83-NEXT:    [[OLD:%.*]] = atomicrmw elementwise fadd ptr [[ADDR]], <4 x float> [[VAL]] acquire, align 16
; SM90PTX83-NEXT:    ret <4 x float> [[OLD]]
;
