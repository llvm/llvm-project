...
; CHECK: @ifunc_nonvoid_1 = ifunc i32 (double), ptr @resolver5
; CHECK: @ifunc_constant_initializer_user = ifunc i32 (double), ptr @resolver5
;.
; CHECK-LABEL: define ptr @resolver1() {
; CHECK-NEXT:    ret ptr inttoptr (i64 123 to ptr)
;
;
; CHECK-LABEL: define ptr @resolver2() {
; CHECK-NEXT:    ret ptr inttoptr (i64 456 to ptr)
;
;
; CHECK-LABEL: define ptr @resolver3() {
; CHECK-NEXT:    ret ptr inttoptr (i64 789 to ptr)
;
;
; CHECK-LABEL: define ptr @resolver4() {
; CHECK-NEXT:    ret ptr inttoptr (i64 999 to ptr)
;
;
; CHECK-LABEL: define ptr @resolver5() {
...
;
;
; CHECK-LABEL: define i32 @call_addrspacecast_callee_type_ifunc_nonvoid(
; CHECK-SAME: double [[ARG:%.*]]) {
