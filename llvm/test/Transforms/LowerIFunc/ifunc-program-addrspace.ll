...
;.
; CHECK: @constant_init_user_addrspace1 = global ptr addrspace(1) @ifunc_used_in_constantinit_as1
; CHECK: @constant_init_user_addrspace1_cast = global ptr addrspace(1) addrspacecast (ptr @ifunc_used_in_constantinit_as1_cast to ptr addrspace(1))
; CHECK: @constant_init_user_addrspace0_cast = global ptr addrspacecast (ptr addrspace(1) @ifunc_used_in_constantinit_as0_cast to ptr)
; CHECK: @[[GLOB0:[0-9]+]] = internal global [6 x ptr addrspace(1)] poison, align 8
; CHECK: @llvm.global_ctors = appending global [1 x { i32, ptr addrspace(1), ptr }] [{ i32, ptr addrspace(1), ptr } { i32 10, ptr addrspace(1) @[[GLOB1:[0-9]+]], ptr null }]
; CHECK: @ifunc_used_in_constantinit_as1 = ifunc i32 (double), ptr addrspace(1) @resolver1_in_1
; CHECK: @ifunc_used_in_constantinit_as1_cast = ifunc i32 (double), ptr @resolver1_in_0
; CHECK: @ifunc_used_in_constantinit_as0_cast = ifunc i32 (double), ptr addrspace(1) @resolver0_in_1
;.
; CHECK-LABEL: define ptr addrspace(1) @resolver1_in_0() addrspace(0) {
; CHECK-NEXT:    ret ptr addrspace(1) inttoptr (i64 123 to ptr addrspace(1))
;
;
; CHECK-LABEL: define ptr addrspace(1) @resolver1_in_1() addrspace(1) {
; CHECK-NEXT:    ret ptr addrspace(1) inttoptr (i64 456 to ptr addrspace(1))
;
;
; CHECK-LABEL: define ptr @resolver0_in_1() addrspace(1) {
...
;
;
; CHECK-LABEL: define void @load_ifuncs() addrspace(0) {
...
;
;
; CHECK-LABEL: define internal void @1() addrspace(1) {
