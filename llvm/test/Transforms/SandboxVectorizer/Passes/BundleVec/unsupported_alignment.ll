...
; RUN: opt -mattr=-unaligned-access-mode,+unaligned-scratch-access -mtriple=amdgpu7.01-- -passes=sandbox-vectorizer -sbvec-passes="seed-collection<bundle-vec(bottom-up)>" %s -S | FileCheck %s
