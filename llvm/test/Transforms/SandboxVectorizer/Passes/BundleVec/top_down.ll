...
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=1024 -sbvec-allow-non-pow2 -sbvec-passes="seed-collection(loads)<tr-save,bundle-vec(top-down),tr-accept>" %s -S | FileCheck %s
