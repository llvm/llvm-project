...
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=1024 -sbvec-allow-non-pow2 -sbvec-passes="seed-collection(enable-diff-types)<load-store-vec>" %s -S | FileCheck %s --check-prefixes=CHECK,CHECK-CV
; RUN: opt -passes=sandbox-vectorizer -sbvec-vec-reg-bits=1024 -sbvec-allow-non-pow2 -sbvec-passes="seed-collection(enable-diff-types)<load-store-vec>" -use-constant-int-for-fixed-length-splat %s -S | FileCheck %s --check-prefixes=CHECK,CHECK-CI
...
; CHECK-CV-LABEL: define void @load_store_vec_constants_CI_vector(
; CHECK-CV-SAME: ptr [[PTR:%.*]]) {
; CHECK-CV-NEXT:    [[PTR0:%.*]] = getelementptr i8, ptr [[PTR]], i32 0
; CHECK-CV-NEXT:    store <8 x i8> <i8 0, i8 1, i8 1, i8 2, i8 2, i8 2, i8 2, i8 2>, ptr [[PTR0]], align 1, !sandboxvec [[META18:![0-9]+]]
; CHECK-CV-NEXT:    ret void
;
; CHECK-CI-LABEL: define void @load_store_vec_constants_CI_vector(
; CHECK-CI-SAME: ptr [[PTR:%.*]]) {
; CHECK-CI-NEXT:    [[PTR0:%.*]] = getelementptr i8, ptr [[PTR]], i32 0
; CHECK-CI-NEXT:    store <3 x i8> <i8 0, i8 1, i8 2>, ptr [[PTR0]], align 1, !sandboxvec [[META18:![0-9]+]]
...
; CHECK-SAME: ptr [[PTR:%.*]]) {
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr float, ptr [[PTR]], i32 0
; CHECK-NEXT:    store <3 x float> <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00>, ptr [[PTR0]], align 1, !sandboxvec [[META19:![0-9]+]]
; CHECK-NEXT:    ret void
;
  %ptr0 = getelementptr float, ptr %ptr, i32 0
  %ptr1 = getelementptr float, ptr %ptr, i32 1
...
;.
; CHECK-CV: [[META0]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META1]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META2]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META3]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META4]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META5]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META6]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META7]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META8]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META9]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META10]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META11]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META12]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META13]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META14]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META15]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META16]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META17]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META18]] = distinct !{!"sandboxregion"}
; CHECK-CV: [[META19]] = distinct !{!"sandboxregion"}
;.
; CHECK-CI: [[META0]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META1]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META2]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META3]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META4]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META5]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META6]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META7]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META8]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META9]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META10]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META11]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META12]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META13]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META14]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META15]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META16]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META17]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META18]] = distinct !{!"sandboxregion"}
; CHECK-CI: [[META19]] = distinct !{!"sandboxregion"}
;.
