...
; This test is intended to test that the sepaerate-const-offset-from-gep
; pass will still separate offsets even if the base offset is large.

@global_smem = external addrspace(3) global [0 x i8], align 16

define void @large_base_offset(ptr addrspace(1) writeonly %1, i32 %35) {
...
entry:
  ...
  store <8 x half> %424, ptr addrspace(1) %1, align 16
  ret void
}

define void @small_base_offset(ptr addrspace(1) writeonly %1, i32 %35) {
