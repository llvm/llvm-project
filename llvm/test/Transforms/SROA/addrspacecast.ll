...
; CHECK-LABEL: define i64 @alloca_addrspacecast_bitcast(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i64 @alloca_bitcast_addrspacecast(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    ret i64 [[X]]
;
...
; CHECK-LABEL: define i64 @alloca_addrspacecast_gep(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    ret i64 [[X]]
;
...
; CHECK-LABEL: define i64 @alloca_gep_addrspacecast(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    ret i64 [[X]]
;
...
; CHECK-LABEL: define i64 @alloca_gep_addrspacecast_gep(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    ret i64 [[X]]
;
...
; CHECK-LABEL: define i64 @getAdjustedPtr_addrspacecast_gep(
; CHECK-SAME: ptr [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i64 @getAdjustedPtr_gep_addrspacecast(
; CHECK-SAME: ptr [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i64 @getAdjustedPtr_gep_addrspacecast_gep(
; CHECK-SAME: ptr [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i64 @alloca_addrspacecast_bitcast_volatile_store(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i65 @volatile_store_addrspacecast_slice(
; CHECK-SAME: i65 [[X:%.*]], i16 [[IDX:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i64 @alloca_addrspacecast_bitcast_volatile_load(
; CHECK-SAME: i64 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca i64, align 8
...
; CHECK-LABEL: define i65 @volatile_load_addrspacecast_slice(
; CHECK-SAME: i65 [[X:%.*]], i16 [[IDX:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[A_SROA_0:%.*]] = alloca [9 x i8], align 4
; CHECK-NEXT:    [[A_SROA_1:%.*]] = alloca [9 x i8], align 8
...
; CHECK-LABEL: define i32 @volatile_memset() {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define void @select_addrspacecast(
...
; CHECK-PRESERVE-CFG-LABEL: define void @select_addrspacecast_const_op(
; CHECK-PRESERVE-CFG-SAME: i1 [[A:%.*]], i1 [[B:%.*]]) {
...
;
; CHECK-MODIFY-CFG-LABEL: define void @select_addrspacecast_const_op(
; CHECK-MODIFY-CFG-SAME: i1 [[A:%.*]], i1 [[B:%.*]]) {
; CHECK-MODIFY-CFG-NEXT:    br i1 [[B]], [[DOTCONT:label %.*]], label %[[DOTELSE:.*]]
; CHECK-MODIFY-CFG:       [[_ELSE:.*:]]
; CHECK-MODIFY-CFG-NEXT:    [[COND_ELSE_VAL:%.*]] = load i64, ptr addrspace(1) null, align 8
; CHECK-MODIFY-CFG-NEXT:    br [[DOTCONT]]
; CHECK-MODIFY-CFG:       [[_CONT:.*:]]
...
; CHECK-LABEL: define void @select_addrspacecast_gv(
; CHECK-SAME: i1 [[A:%.*]], i1 [[B:%.*]]) {
...
; CHECK-LABEL: define void @select_addrspacecast_gv_constexpr(
; CHECK-SAME: i1 [[A:%.*]], i1 [[B:%.*]]) {
...
; CHECK-LABEL: define i8 @select_addrspacecast_i8(
; CHECK-SAME: i1 [[C:%.*]]) {
...
!4 = !{!2, i64 1, !"type_3"}
;.
; CHECK-PRESERVE-CFG: [[TBAA0]] = !{[[META1:![0-9]+]], [[META1]], i64 0, i64 1}
; CHECK-PRESERVE-CFG: [[META1]] = !{[[META2:![0-9]+]], i64 1, !"type_0"}
; CHECK-PRESERVE-CFG: [[META2]] = !{!"root"}
; CHECK-PRESERVE-CFG: [[TBAA3]] = !{[[META4:![0-9]+]], [[META4]], i64 0, i64 1}
; CHECK-PRESERVE-CFG: [[META4]] = !{[[META2]], i64 1, !"type_3"}
;.
; CHECK-MODIFY-CFG: [[TBAA0]] = !{[[META1:![0-9]+]], [[META1]], i64 0, i64 1}
; CHECK-MODIFY-CFG: [[META1]] = !{[[META2:![0-9]+]], i64 1, !"type_0"}
; CHECK-MODIFY-CFG: [[META2]] = !{!"root"}
; CHECK-MODIFY-CFG: [[TBAA3]] = !{[[META4:![0-9]+]], [[META4]], i64 0, i64 1}
; CHECK-MODIFY-CFG: [[META4]] = !{[[META2]], i64 1, !"type_3"}
;.
