...
; RUN: opt < %s -passes='sroa<preserve-cfg>,infer-alignment' -S | FileCheck %s --check-prefixes=CHECK,CHECK-PRESERVE-CFG
; RUN: opt < %s -passes='sroa<modify-cfg>,infer-alignment' -S | FileCheck %s --check-prefixes=CHECK,CHECK-MODIFY-CFG
; RUN: opt < %s -passes=debugify,sroa,infer-alignment -S | FileCheck %s --check-prefix=DEBUG
...
; CHECK-NEXT:    [[RES:%.*]] = load i64, ptr [[ADDR]], align 8
...
; DEBUG-NEXT:    [[RES:%.*]] = load i64, ptr [[ADDR]], align 8, !dbg [[DBG174:![0-9]+]]
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP]], ptr [[X:%.*]], i64 16, i1 false)
; CHECK-NEXT:    tail call void @llvm.memcpy.p0.p0.i64(ptr [[X]], ptr [[Y:%.*]], i64 16, i1 false)
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[Y]], ptr align 8 [[TMP]], i64 16, i1 false)
; CHECK-NEXT:    ret void
;
...
; DEBUG-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 [[TMP]], ptr [[X:%.*]], i64 16, i1 false), !dbg [[DBG473:![0-9]+]]
; DEBUG-NEXT:    tail call void @llvm.memcpy.p0.p0.i64(ptr [[X]], ptr [[Y:%.*]], i64 16, i1 false), !dbg [[DBG474:![0-9]+]]
; DEBUG-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[Y]], ptr align 8 [[TMP]], i64 16, i1 false), !dbg [[DBG475:![0-9]+]]
...
; CHECK-NEXT:    [[VAL0:%.*]] = load ptr, ptr [[INIT:%.*]], align 8
; CHECK-NEXT:    [[OBJ:%.*]] = alloca <4 x ptr>, align 32
; CHECK-NEXT:    store <4 x ptr> splat (ptr null), ptr [[OBJ]], align 32
; CHECK-NEXT:    store ptr [[VAL0]], ptr [[OBJ]], align 32
; CHECK-NEXT:    [[OBJ_8_PTR2_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[OBJ]], i64 8
; CHECK-NEXT:    store i64 [[VAL2:%.*]], ptr [[OBJ_8_PTR2_SROA_IDX]], align 8
; CHECK-NEXT:    [[OBJ_12_PTR3_SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[OBJ]], i64 12
; CHECK-NEXT:    store i64 131072, ptr [[OBJ_12_PTR3_SROA_IDX]], align 4
; CHECK-NEXT:    [[OBJ_0_SROAVAL:%.*]] = load <4 x ptr>, ptr [[OBJ]], align 32
...
; DEBUG-NEXT:    [[OBJ:%.*]] = alloca <4 x ptr>, align 32, !dbg [[DBG542:![0-9]+]]
; DEBUG-NEXT:      #dbg_value(ptr [[OBJ]], [[META537:![0-9]+]], !DIExpression(), [[DBG542]])
; DEBUG-NEXT:    store <4 x ptr> splat (ptr null), ptr [[OBJ]], align 32, !dbg [[DBG543:![0-9]+]]
; DEBUG-NEXT:    store ptr [[VAL0]], ptr [[OBJ]], align 32, !dbg [[DBG544:![0-9]+]]
...
; DEBUG-NEXT:    [[OBJ_0_SROAVAL:%.*]] = load <4 x ptr>, ptr [[OBJ]], align 32, !dbg [[DBG549:![0-9]+]]
