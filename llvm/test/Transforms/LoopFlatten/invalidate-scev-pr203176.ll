...
; CHECK-NEXT:    --> {0,+,1}<nw><%outer.loop> U: full-set S: full-set Exits: (trunc i64 %n to i32) LoopDispositions: { %outer.loop: Computable, %mid.loop: Invariant, %inner.loop: Invariant }
; CHECK-NEXT:    %0 = zext i32 %tc to i64
; CHECK-NEXT:    --> (zext i32 {0,+,1}<nw><%outer.loop> to i64) U: [0,4294967296) S: [0,4294967296) Exits: (zext i32 (trunc i64 %n to i32) to i64) LoopDispositions: { %outer.loop: Computable, %mid.loop: Invariant, %inner.loop: Invariant }
...
; CHECK-NEXT:    --> {0,+,1}<nuw><nsw><%inner.loop> U: [0,4294967295) S: [0,4294967295) Exits: (-1 + (zext i32 {0,+,1}<nw><%outer.loop> to i64))<nsw> LoopDispositions: { %inner.loop: Computable, %mid.loop: Uniform, %outer.loop: Uniform }
; CHECK-NEXT:    %2 = mul i64 %indvar1, %1
; CHECK-NEXT:    --> {0,+,{0,+,1}<nuw><%outer.loop>}<nuw><nsw><%mid.loop> U: [0,1) S: [0,1) Exits: {0,+,{0,+,1}<nuw><%outer.loop>}<nuw><nsw><%mid.loop> LoopDispositions: { %inner.loop: Invariant, %mid.loop: Computable, %outer.loop: Variant }
; CHECK-NEXT:    %mul = mul i32 %k, %tc
; CHECK-NEXT:    --> {0,+,{0,+,1}<nw><%outer.loop>}<nuw><nsw><%mid.loop> U: [0,1) S: [0,1) Exits: {0,+,{0,+,1}<nw><%outer.loop>}<nuw><nsw><%mid.loop> LoopDispositions: { %inner.loop: Invariant, %mid.loop: Computable, %outer.loop: Variant }
; CHECK-NEXT:    %3 = trunc nuw nsw i64 %2 to i32
; CHECK-NEXT:    --> {0,+,{0,+,1}<nw><%outer.loop>}<nuw><nsw><%mid.loop> U: [0,1) S: [0,1) Exits: {0,+,{0,+,1}<nw><%outer.loop>}<nuw><nsw><%mid.loop> LoopDispositions: { %inner.loop: Invariant, %mid.loop: Computable, %outer.loop: Variant }
; CHECK-NEXT:    %gep = getelementptr i32, ptr @g, i32 %3
; CHECK-NEXT:    --> {@g,+,{0,+,4}<%outer.loop>}<nw><%mid.loop> U: [4,-7) S: [-9223372036854775808,9223372036854775805) Exits: {@g,+,{0,+,4}<%outer.loop>}<nuw><nsw><%mid.loop> LoopDispositions: { %inner.loop: Invariant, %mid.loop: Computable, %outer.loop: Variant }
; CHECK-NEXT:    %4 = trunc nuw i64 %indvar to i32
; CHECK-NEXT:    --> {0,+,1}<nuw><%inner.loop> U: [0,-1) S: [0,-1) Exits: {-1,+,1}<nw><%outer.loop> LoopDispositions: { %inner.loop: Computable, %mid.loop: Uniform, %outer.loop: Uniform }
; CHECK-NEXT:    %arrayidx = getelementptr i32, ptr %gep, i32 %4
; CHECK-NEXT:    --> ((4 * (sext i32 {0,+,1}<nuw><%inner.loop> to i64))<nsw> + {@g,+,{0,+,4}<%outer.loop>}<nuw><nsw><%mid.loop>) U: [0,-3) S: [-9223372036854775808,9223372036854775805) Exits: {{\{\{}}(-4 + @g),+,4}<%outer.loop>,+,{0,+,4}<%outer.loop>}<nw><%mid.loop> LoopDispositions: { %inner.loop: Computable, %mid.loop: Variant, %outer.loop: Variant }
; CHECK-NEXT:    %indvar.next = add i64 %indvar, 1
; CHECK-NEXT:    --> {1,+,1}<nuw><nsw><%inner.loop> U: [1,4294967296) S: [1,4294967296) Exits: (zext i32 {0,+,1}<nw><%outer.loop> to i64) LoopDispositions: { %inner.loop: Computable, %mid.loop: Uniform, %outer.loop: Uniform }
...
; CHECK-NEXT:  Loop %inner.loop: backedge-taken count is (-1 + (zext i32 {0,+,1}<nw><%outer.loop> to i64))<nsw>
; CHECK-NEXT:  Loop %inner.loop: constant max backedge-taken count is i64 4294967294
; CHECK-NEXT:  Loop %inner.loop: symbolic max backedge-taken count is (-1 + (zext i32 {0,+,1}<nw><%outer.loop> to i64))<nsw>
