...
; This run focuses on the IV widening transform itself, so assume the flattened
; trip count does not overflow rather than exercising the versioning fallback.
...
; RUN:     -loop-flatten-cost-threshold=6 -loop-flatten-assume-no-overflow=true | \
