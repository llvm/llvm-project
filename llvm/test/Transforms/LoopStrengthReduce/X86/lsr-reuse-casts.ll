...
;
; Verify that LSR's getOrCreateCast deduplicates inttoptr cast instructions
; when multiple ICmpZero fixups need the same type conversion of an IV value.
; Without the optimisation each fixup creates a separate inttoptr cast. This
; test exercises all three internal paths of getOrCreateCast: "create",
; "move and reuse" and "dominating reuse". It is target-dependent as TTI
; should report that scaled addressing modes are legal.
