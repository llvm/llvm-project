; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --prefix-filecheck-ir-name LCSSA --version 3
...
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH_PH_PH_PH:%.*]] = phi i64 [ [[TMP2:%.*]], [[IFMERGE_34:%.*]] ]
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLITSPLIT:%.*]]
; CHECK:       ifmerge.38.loop.exit.loopexitsplitsplit_crit_edge:
; CHECK-NEXT:    [[LSR_IV_LCSSA19:%.*]] = phi i64 [ [[LSR_IV:%.*]], [[IFMERGE_38:%.*]] ]
; CHECK-NEXT:    [[SPLIT16:%.*]] = phi i64 [ [[LCSSATMP3:%.*]], [[IFMERGE_38]] ]
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLITSPLIT]]
; CHECK:       loop.exit.loopexitsplitsplit:
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH_PH_PH:%.*]] = phi i64 [ [[LSR_IV_LCSSA19]], [[IFMERGE_38_LOOP_EXIT_LOOPEXITSPLITSPLIT_CRIT_EDGE:%.*]] ], [ [[INDVARS_IV_LCSSA_PH_PH_PH_PH]], [[LOOP_EXIT_LOOPEXITSPLITSPLITSPLIT:%.*]] ]
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLIT:%.*]]
; CHECK:       ifmerge.42.loop.exit.loopexitsplit_crit_edge:
; CHECK-NEXT:    [[LSR_IV_LCSSA14:%.*]] = phi i64 [ [[LSR_IV]], [[IFMERGE_42:%.*]] ]
; CHECK-NEXT:    [[SPLIT11:%.*]] = phi i64 [ [[LCSSATMP4:%.*]], [[IFMERGE_42]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = add i64 [[LSR_IV_LCSSA14]], 1
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXITSPLIT]]
; CHECK:       loop.exit.loopexitsplit:
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH_PH:%.*]] = phi i64 [ [[TMP0]], [[IFMERGE_42_LOOP_EXIT_LOOPEXITSPLIT_CRIT_EDGE:%.*]] ], [ [[INDVARS_IV_LCSSA_PH_PH_PH]], [[LOOP_EXIT_LOOPEXITSPLITSPLIT]] ]
...
; CHECK-NEXT:    [[SPLIT:%.*]] = phi i64 [ [[LCSSATMP1:%.*]], [[THEN_34]] ]
; CHECK-NEXT:    [[TMP1:%.*]] = add i64 [[LSR_IV_LCSSA]], -2
; CHECK-NEXT:    br label [[LOOP_EXIT_LOOPEXIT]]
; CHECK:       loop.exit.loopexit:
; CHECK-NEXT:    [[INDVARS_IV_LCSSA_PH:%.*]] = phi i64 [ [[TMP1]], [[THEN_34_LOOP_EXIT_LOOPEXIT_CRIT_EDGE:%.*]] ], [ [[INDVARS_IV_LCSSA_PH_PH]], [[LOOP_EXIT_LOOPEXITSPLIT]] ]
...
; CHECK-NEXT:    [[LCSSATMP1]] = shl i64 [[I1_I64_0]], 2
; CHECK-NEXT:    [[TMP2]] = add i64 [[LSR_IV]], -1
; CHECK-NEXT:    [[TMP3:%.*]] = shl nuw nsw i64 [[LSR_IV]], 2
; CHECK-NEXT:    [[SCEVGEP9:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP3]]
; CHECK-NEXT:    [[SCEVGEP10:%.*]] = getelementptr i8, ptr [[SCEVGEP9]], i64 -4
; CHECK-NEXT:    [[GEPLOAD:%.*]] = load i32, ptr [[SCEVGEP10]], align 4
...
; CHECK-NEXT:    [[SCEVGEP7:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP4]]
; CHECK-NEXT:    [[SCEVGEP8:%.*]] = getelementptr i8, ptr [[SCEVGEP7]], i64 -8
; CHECK-NEXT:    [[GEPLOAD18:%.*]] = load i32, ptr [[SCEVGEP8]], align 4
...
; CHECK:       ifmerge.34:
; CHECK-NEXT:    [[LCSSATMP3]] = or disjoint i64 [[LCSSATMP1]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = shl nuw nsw i64 [[LSR_IV]], 2
; CHECK-NEXT:    [[SCEVGEP6:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP5]]
; CHECK-NEXT:    [[GEPLOAD20:%.*]] = load i32, ptr [[SCEVGEP6]], align 4
...
; CHECK:       ifmerge.38:
; CHECK-NEXT:    [[LCSSATMP4]] = or disjoint i64 [[LCSSATMP1]], 3
; CHECK-NEXT:    [[TMP6:%.*]] = shl nuw nsw i64 [[LSR_IV]], 2
; CHECK-NEXT:    [[SCEVGEP4:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP6]]
; CHECK-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[SCEVGEP4]], i64 4
; CHECK-NEXT:    [[GEPLOAD24:%.*]] = load i32, ptr [[SCEVGEP5]], align 4
...
; CHECK-NEXT:    [[SCEVGEP3:%.*]] = getelementptr i8, ptr [[SCEVGEP]], i64 8
; CHECK-NEXT:    [[GEPLOAD28:%.*]] = load i32, ptr [[SCEVGEP3]], align 4
