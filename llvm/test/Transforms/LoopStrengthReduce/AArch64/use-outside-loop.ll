...
; CHECK-NEXT:    [[LSR_IV10:%.*]] = getelementptr i8, ptr [[SCEVGEP9]], i64 [[TMP0]]
; CHECK-NEXT:    [[VAL0:%.*]] = load i32, ptr [[LSR_IV10]], align 4
; CHECK-NEXT:    [[RET_1:%.*]] = add nsw i32 [[VAL0]], [[RET_0]]
; CHECK-NEXT:    [[TMP1:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV7:%.*]] = getelementptr i8, ptr [[SCEVGEP6]], i64 [[TMP1]]
; CHECK-NEXT:    [[VAL1:%.*]] = load i32, ptr [[LSR_IV7]], align 4
; CHECK-NEXT:    [[RET_2:%.*]] = add nsw i32 [[VAL1]], [[RET_1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV4:%.*]] = getelementptr i8, ptr [[SCEVGEP3]], i64 [[TMP2]]
; CHECK-NEXT:    [[VAL2:%.*]] = load i32, ptr [[LSR_IV4]], align 4
; CHECK-NEXT:    [[RET_3:%.*]] = add nsw i32 [[VAL2]], [[RET_2]]
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV1:%.*]] = getelementptr i8, ptr [[SCEVGEP]], i64 [[TMP3]]
...
; CHECK-NEXT:    [[RET_0:%.*]] = phi i32 [ [[RET_4:%.*]], %[[FOR_BODY]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV1:%.*]] = getelementptr i8, ptr [[SCEVGEP16]], i64 [[TMP0]]
; CHECK-NEXT:    [[VAL0:%.*]] = load i32, ptr [[LSR_IV1]], align 4
; CHECK-NEXT:    [[RET_1:%.*]] = add nsw i32 [[VAL0]], [[RET_0]]
; CHECK-NEXT:    [[LSR_IV4:%.*]] = getelementptr i8, ptr [[SCEVGEP3]], i64 [[TMP0]]
...
; CHECK-NEXT:    [[RET_3:%.*]] = add nsw i32 [[VAL2]], [[RET_2]]
; CHECK-NEXT:    [[LSR_IV10:%.*]] = getelementptr i8, ptr [[SCEVGEP9]], i64 [[TMP1]]
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[EXIT:.*]], label %[[FOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SCEVGEP4:%.*]] = getelementptr nuw i8, ptr [[P0_LOAD]], i64 128
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP2:%.*]] = getelementptr i8, ptr [[SCEVGEP4]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP2]], ptr [[P]], align 8
; CHECK-NEXT:    [[SCEVGEP7:%.*]] = getelementptr nuw i8, ptr [[P1_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[SCEVGEP7]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP5]], ptr [[ARRAYIDX1]], align 8
; CHECK-NEXT:    [[SCEVGEP10:%.*]] = getelementptr nuw i8, ptr [[P2_LOAD]], i64 128
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP8:%.*]] = getelementptr i8, ptr [[SCEVGEP10]], i64 [[TMP3]]
; CHECK-NEXT:    store ptr [[SCEVGEP8]], ptr [[ARRAYIDX2]], align 8
; CHECK-NEXT:    [[SCEVGEP14:%.*]] = getelementptr nuw i8, ptr [[P3_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP11:%.*]] = getelementptr i8, ptr [[SCEVGEP14]], i64 [[TMP3]]
...
; CHECK-NEXT:    [[LSR_IV:%.*]] = phi i64 [ [[LSR_IV_NEXT:%.*]], %[[FOR_BODY]] ], [ [[N]], %[[ENTRY]] ]
; CHECK-NEXT:    [[RET_0:%.*]] = phi i32 [ [[RET_4:%.*]], %[[FOR_BODY]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    [[P0_LOOP:%.*]] = getelementptr i8, ptr [[P0_LOAD]], i64 [[LSR_IV1]]
; CHECK-NEXT:    [[VAL0:%.*]] = load i32, ptr [[P0_LOOP]], align 4
; CHECK-NEXT:    [[RET_1:%.*]] = add nsw i32 [[VAL0]], [[RET_0]]
; CHECK-NEXT:    [[P1_LOOP:%.*]] = getelementptr i8, ptr [[P1_LOAD]], i64 [[LSR_IV1]]
; CHECK-NEXT:    [[VAL1:%.*]] = load i32, ptr [[P1_LOOP]], align 4
; CHECK-NEXT:    [[RET_2:%.*]] = add nsw i32 [[VAL1]], [[RET_1]]
; CHECK-NEXT:    [[P2_LOOP:%.*]] = getelementptr i8, ptr [[P2_LOAD]], i64 [[LSR_IV1]]
; CHECK-NEXT:    [[VAL2:%.*]] = load i32, ptr [[P2_LOOP]], align 4
; CHECK-NEXT:    [[RET_3:%.*]] = add nsw i32 [[VAL2]], [[RET_2]]
; CHECK-NEXT:    [[P3_LOOP:%.*]] = getelementptr i8, ptr [[P3_LOAD]], i64 [[LSR_IV1]]
; CHECK-NEXT:    [[VAL3:%.*]] = load i32, ptr [[P3_LOOP]], align 4
; CHECK-NEXT:    [[RET_4]] = add nsw i32 [[VAL3]], [[RET_3]]
; CHECK-NEXT:    [[LSR_IV_NEXT]] = add i64 [[LSR_IV]], -1
; CHECK-NEXT:    [[LSR_IV_NEXT2]] = add nuw i64 [[LSR_IV1]], 16
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[LSR_IV_NEXT]], 0
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[EXIT:.*]], label %[[FOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[P0_NEXT:%.*]] = getelementptr i8, ptr [[P0_LOAD]], i64 [[LSR_IV_NEXT2]]
...
; CHECK-NEXT:    [[RET_0:%.*]] = phi i32 [ [[RET_4:%.*]], %[[FOR_BODY]] ], [ 0, %[[ENTRY]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV:%.*]] = getelementptr i8, ptr [[SCEVGEP14]], i64 [[TMP0]]
; CHECK-NEXT:    [[VAL0:%.*]] = load i32, ptr [[LSR_IV]], align 4
; CHECK-NEXT:    [[RET_1:%.*]] = add nsw i32 [[VAL0]], [[RET_0]]
; CHECK-NEXT:    [[LSR_IV3:%.*]] = getelementptr i8, ptr [[SCEVGEP2]], i64 [[TMP0]]
; CHECK-NEXT:    [[VAL1:%.*]] = load i32, ptr [[LSR_IV3]], align 4
; CHECK-NEXT:    [[RET_2:%.*]] = add nsw i32 [[VAL1]], [[RET_1]]
; CHECK-NEXT:    [[TMP1:%.*]] = shl i64 [[IV]], 2
; CHECK-NEXT:    [[LSR_IV6:%.*]] = getelementptr i8, ptr [[SCEVGEP5]], i64 [[TMP1]]
; CHECK-NEXT:    [[VAL2:%.*]] = load i32, ptr [[LSR_IV6]], align 4
; CHECK-NEXT:    [[RET_3:%.*]] = add nsw i32 [[VAL2]], [[RET_2]]
; CHECK-NEXT:    [[LSR_IV9:%.*]] = getelementptr i8, ptr [[SCEVGEP8]], i64 [[TMP1]]
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[EXIT:.*]], label %[[FOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SCEVGEP3:%.*]] = getelementptr nuw i8, ptr [[P0_LOAD]], i64 128
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[SCEVGEP3]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP1]], ptr [[P]], align 8
; CHECK-NEXT:    [[SCEVGEP6:%.*]] = getelementptr nuw i8, ptr [[P1_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP4:%.*]] = getelementptr i8, ptr [[SCEVGEP6]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP4]], ptr [[ARRAYIDX1]], align 8
; CHECK-NEXT:    [[SCEVGEP11:%.*]] = getelementptr nuw i8, ptr [[P2_LOAD]], i64 128
; CHECK-NEXT:    [[TMP3:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP7:%.*]] = getelementptr i8, ptr [[SCEVGEP11]], i64 [[TMP3]]
; CHECK-NEXT:    store ptr [[SCEVGEP7]], ptr [[ARRAYIDX2]], align 8
; CHECK-NEXT:    [[SCEVGEP15:%.*]] = getelementptr nuw i8, ptr [[P3_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP10:%.*]] = getelementptr i8, ptr [[SCEVGEP15]], i64 [[TMP3]]
; CHECK-NEXT:    store ptr [[SCEVGEP10]], ptr [[ARRAYIDX3]], align 8
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds nuw i64, ptr [[P]], i64 4
; CHECK-NEXT:    [[IV_SUB_NEXT:%.*]] = sub i64 [[N]], [[IV_NEXT]]
...
; CHECK-NEXT:    [[LSR_IV_NEXT]] = add i64 [[LSR_IV]], -1
; CHECK-NEXT:    [[LSR_IV_NEXT2]] = add nuw i64 [[LSR_IV1]], 4
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp ult i64 [[LSR_IV_NEXT]], 1
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[EXIT:.*]], label %[[FOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SCEVGEP2:%.*]] = getelementptr i8, ptr [[P0_LOAD]], i64 [[LSR_IV_NEXT2]]
; CHECK-NEXT:    store ptr [[SCEVGEP2]], ptr [[P]], align 8
; CHECK-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[P1_LOAD]], i64 [[LSR_IV_NEXT2]]
; CHECK-NEXT:    store ptr [[SCEVGEP5]], ptr [[ARRAYIDX1]], align 8
; CHECK-NEXT:    [[SCEVGEP8:%.*]] = getelementptr i8, ptr [[P2_LOAD]], i64 [[LSR_IV_NEXT2]]
; CHECK-NEXT:    store ptr [[SCEVGEP8]], ptr [[ARRAYIDX2]], align 8
; CHECK-NEXT:    [[SCEVGEP11:%.*]] = getelementptr i8, ptr [[P3_LOAD]], i64 [[LSR_IV_NEXT2]]
; CHECK-NEXT:    store ptr [[SCEVGEP11]], ptr [[ARRAYIDX3]], align 8
...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[TMP0]], [[IV_NEXT]]
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[EXIT:.*]], label %[[FOR_BODY]]
; CHECK:       [[EXIT]]:
; CHECK-NEXT:    [[SCEVGEP3:%.*]] = getelementptr nuw i8, ptr [[P0_LOAD]], i64 128
; CHECK-NEXT:    [[TMP1:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP2:%.*]] = getelementptr i8, ptr [[SCEVGEP3]], i64 [[TMP1]]
; CHECK-NEXT:    store ptr [[SCEVGEP2]], ptr [[P]], align 8
; CHECK-NEXT:    [[SCEVGEP6:%.*]] = getelementptr nuw i8, ptr [[P1_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[SCEVGEP6]], i64 [[TMP1]]
; CHECK-NEXT:    store ptr [[SCEVGEP5]], ptr [[ARRAYIDX1]], align 8
; CHECK-NEXT:    [[SCEVGEP10:%.*]] = getelementptr nuw i8, ptr [[P2_LOAD]], i64 128
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[IV_NEXT]], 2
; CHECK-NEXT:    [[SCEVGEP8:%.*]] = getelementptr i8, ptr [[SCEVGEP10]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP8]], ptr [[ARRAYIDX2]], align 8
; CHECK-NEXT:    [[SCEVGEP14:%.*]] = getelementptr nuw i8, ptr [[P3_LOAD]], i64 128
; CHECK-NEXT:    [[SCEVGEP11:%.*]] = getelementptr i8, ptr [[SCEVGEP14]], i64 [[TMP2]]
; CHECK-NEXT:    store ptr [[SCEVGEP11]], ptr [[ARRAYIDX3]], align 8
; CHECK-NEXT:    [[TMP3:%.*]] = add i64 [[N]], 1
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i64 [[TMP3]], [[IV_NEXT]]
; CHECK-NEXT:    ret i1 [[CMP]]
;
entry:
  %p0.load = load ptr, ptr %p, align 8
