...
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x b32> [[LD_23]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast b32 [[LD_23]] to i32
; CHECK-NEXT:    store <4 x b32> zeroinitializer, ptr addrspace(3) [[A_0]], align 16
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[LD_12:%.*]] = extractelement <2 x b64> [[TMP0]], i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast b64 [[LD_12]] to i64
; CHECK-NEXT:    ret void
;
entry:
  %a.1 =  getelementptr inbounds i64, ptr addrspace(1) %a, i64 1
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(1) [[PTR0]] to i64
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i64 [[TMP0]] to b64
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x b64> poison, b64 [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i64 [[VAL1]] to b64
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x b64> [[TMP2]], b64 [[TMP3]], i32 1
; CHECK-NEXT:    store <2 x b64> [[TMP4]], ptr addrspace(1) [[A]], align 8
; CHECK-NEXT:    ret void
;
entry:
  %a.1 = getelementptr inbounds i64, ptr addrspace(1) %a, i64 1
...
; CHECK-NEXT:    [[TMP2:%.*]] = ptrtoint ptr addrspace(1) [[PTR1]] to i64
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i64 [[TMP2]] to b64
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x b64> [[TMP1]], b64 [[TMP3]], i32 1
; CHECK-NEXT:    store <2 x b64> [[TMP4]], ptr addrspace(1) [[A]], align 8
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[LD_12:%.*]] = extractelement <2 x b32> [[TMP0]], i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast b32 [[LD_12]] to i32
; CHECK-NEXT:    ret void
;
entry:
  %a.1 = getelementptr inbounds i32, ptr addrspace(3) %a, i32 1
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = ptrtoint ptr addrspace(3) [[PTR0]] to i32
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i32 [[TMP0]] to b32
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x b32> poison, b32 [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i32 [[VAL1]] to b32
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x b32> [[TMP2]], b32 [[TMP3]], i32 1
; CHECK-NEXT:    store <2 x b32> [[TMP4]], ptr addrspace(3) [[A]], align 4
; CHECK-NEXT:    ret void
;
entry:
  %a.1 = getelementptr inbounds i32, ptr addrspace(3) %a, i32 1
...
; CHECK-NEXT:    [[TMP2:%.*]] = ptrtoint ptr addrspace(3) [[PTR1]] to i32
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i32 [[TMP2]] to b32
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x b32> [[TMP1]], b32 [[TMP3]], i32 1
; CHECK-NEXT:    store <2 x b32> [[TMP4]], ptr addrspace(3) [[A]], align 4
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[TMP2:%.*]] = inttoptr i64 [[TMP1]] to ptr addrspace(1)
; CHECK-NEXT:    [[LD_12:%.*]] = extractelement <2 x b64> [[TMP0]], i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast b64 [[LD_12]] to double
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i64 [[TMP0]] to b64
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x b64> poison, b64 [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast double [[VAL1]] to b64
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x b64> [[TMP2]], b64 [[TMP3]], i32 1
; CHECK-NEXT:    store <2 x b64> [[TMP4]], ptr addrspace(1) [[A]], align 8
; CHECK-NEXT:    ret void
;
