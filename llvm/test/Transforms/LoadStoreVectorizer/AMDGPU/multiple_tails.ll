; RUN: opt -mtriple=amdgcn-amd-amdhsa -mcpu=hawaii -load-store-vectorizer -S -o - %s | FileCheck -check-prefixes=GCN,GFX7 %s
; RUN: opt -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 -load-store-vectorizer -S -o - %s | FileCheck -check-prefixes=GCN,GFX9 %s
