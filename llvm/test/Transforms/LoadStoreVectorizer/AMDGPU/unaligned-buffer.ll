...
; RUN: opt -mtriple=amdgpu--amdpal -passes=load-store-vectorizer -S -o - %s | FileCheck --check-prefix=OOB-STRICT %s
; RUN: cp %s %t.relaxed.ll && chmod +w %t.relaxed.ll
; RUN: printf '\n!llvm.module.flags = !{!0}\n!0 = !{i32 7, !"amdgpu.buffer.oob.mode", i32 1}\n' >> %t.relaxed.ll
; RUN: opt -mtriple=amdgpu--amdpal -passes=load-store-vectorizer -S -o - %t.relaxed.ll \
