...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast <2 x b32> [[LOAD11]] to i64
; CHECK-NEXT:    [[LOAD1:%.*]] = inttoptr i64 [[TMP2]] to ptr addrspace(1)
; CHECK-NEXT:    [[LOAD22:%.*]] = extractelement <2 x b32> [[TMP1]], i32 1
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast b32 [[LOAD22]] to i32
; CHECK-NEXT:    [[LOAD2:%.*]] = inttoptr i32 [[TMP4]] to ptr addrspace(2)
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds i32, ptr addrspace(2) [[PTR2]], i64 0
...
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast b32 [[LOAD11]] to i32
; CHECK-NEXT:    [[LOAD23:%.*]] = extractelement <2 x b32> [[TMP1]], i32 1
; CHECK-NEXT:    [[LOAD22:%.*]] = bitcast b32 [[LOAD23]] to i32
; CHECK-NEXT:    [[TMP2:%.*]] = inttoptr i32 [[LOAD22]] to ptr addrspace(3)
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds i32, ptr addrspace(2) [[PTR2]], i64 0
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast i32 [[TMP3]] to b32
...
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <2 x b32> [[TMP6]], b32 [[TMP8]], i32 1
; CHECK-NEXT:    store <2 x b32> [[TMP9]], ptr addrspace(2) [[STORE_GEP1]], align 4
; CHECK-NEXT:    ret void
;
  %gep1 = getelementptr inbounds i32, ptr addrspace(1) %ptr1, i64 0
  %load1 = load i32, ptr addrspace(1) %gep1, align 4
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x ptr addrspace(1)>, ptr addrspace(1) [[GEP2]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x ptr addrspace(1)> [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <2 x ptr addrspace(1)> [[TMP1]], i32 1
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds i32, ptr addrspace(2) [[PTR2]], i64 0
...
; CHECK-NEXT:    [[LOAD11:%.*]] = extractelement <6 x b32> [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast b32 [[LOAD11]] to i32
; CHECK-NEXT:    [[LOAD22:%.*]] = extractelement <6 x b32> [[TMP1]], i32 1
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast b32 [[LOAD22]] to i32
; CHECK-NEXT:    [[LOAD34:%.*]] = shufflevector <6 x b32> [[TMP1]], <6 x b32> poison, <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[LOAD33:%.*]] = bitcast <2 x b32> [[LOAD34]] to i64
; CHECK-NEXT:    [[TMP3:%.*]] = inttoptr i64 [[LOAD33]] to ptr addrspace(1)
; CHECK-NEXT:    [[LOAD45:%.*]] = shufflevector <6 x b32> [[TMP1]], <6 x b32> poison, <2 x i32> <i32 4, i32 5>
; CHECK-NEXT:    [[LOAD44:%.*]] = bitcast <2 x b32> [[LOAD45]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = inttoptr i64 [[LOAD44]] to ptr addrspace(1)
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds i32, ptr addrspace(2) [[PTR2]], i64 0
; CHECK-NEXT:    [[TMP8:%.*]] = insertelement <2 x i32> poison, i32 [[TMP2]], i32 0
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <2 x i32> [[TMP8]], i32 [[TMP5]], i32 1
...
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast <2 x b32> [[LOAD33]] to i64
; CHECK-NEXT:    [[LOAD3:%.*]] = inttoptr i64 [[TMP4]] to ptr addrspace(1)
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds i32, ptr addrspace(2) [[PTR2]], i64 0
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <2 x i32> poison, i32 [[TMP2]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> [[TMP6]], i32 [[TMP5]], i32 1
...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x ptr addrspace(3)>, ptr addrspace(1) [[GEP1]], align 4
; CHECK-NEXT:    [[LOAD11:%.*]] = extractelement <2 x ptr addrspace(3)> [[TMP1]], i32 0
; CHECK-NEXT:    [[LOAD22:%.*]] = extractelement <2 x ptr addrspace(3)> [[TMP1]], i32 1
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds ptr addrspace(3), ptr addrspace(2) [[PTR2]], i64 0
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x ptr addrspace(3)> poison, ptr addrspace(3) [[LOAD11]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x ptr addrspace(3)> [[TMP2]], ptr addrspace(3) [[LOAD22]], i32 1
; CHECK-NEXT:    store <2 x ptr addrspace(3)> [[TMP3]], ptr addrspace(2) [[STORE_GEP1]], align 4
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[LOAD13:%.*]] = bitcast <2 x b32> [[LOAD11]] to i64
...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <2 x ptr addrspace(3)> poison, ptr addrspace(3) [[TMP5]], i32 0
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <2 x ptr addrspace(3)> [[TMP10]], ptr addrspace(3) [[TMP6]], i32 1
; CHECK-NEXT:    store <2 x ptr addrspace(3)> [[TMP11]], ptr addrspace(2) [[STORE_GEP3]], align 4
; CHECK-NEXT:    ret void
;
  %gep1 = getelementptr inbounds ptr addrspace(1), ptr addrspace(1) %ptr1, i64 0
...
; CHECK-SAME: ptr addrspace(1) [[PTR1:%.*]], ptr addrspace(2) [[PTR2:%.*]]) {
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds ptr addrspace(1), ptr addrspace(1) [[PTR1]], i64 0
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x ptr addrspace(1)>, ptr addrspace(1) [[GEP1]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <2 x ptr addrspace(1)> [[TMP1]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <2 x ptr addrspace(1)> [[TMP1]], i32 1
; CHECK-NEXT:    [[STORE_GEP1:%.*]] = getelementptr inbounds ptr addrspace(1), ptr addrspace(2) [[PTR2]], i64 0
; CHECK-NEXT:    store ptr addrspace(1) [[TMP2]], ptr addrspace(2) [[STORE_GEP1]], align 8
...
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast b16 [[LOAD22]] to i16
; CHECK-NEXT:    [[LOAD34:%.*]] = shufflevector <6 x b16> [[TMP1]], <6 x b16> poison, <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[LOAD33:%.*]] = bitcast <2 x b16> [[LOAD34]] to i32
; CHECK-NEXT:    [[TMP3:%.*]] = inttoptr i32 [[LOAD33]] to ptr addrspace(3)
; CHECK-NEXT:    [[LOAD45:%.*]] = shufflevector <6 x b16> [[TMP1]], <6 x b16> poison, <2 x i32> <i32 4, i32 5>
; CHECK-NEXT:    [[LOAD44:%.*]] = bitcast <2 x b16> [[LOAD45]] to i32
...
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i16 [[TMP2]] to b16
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x b16> poison, b16 [[TMP8]], i32 0
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i16 [[TMP5]] to b16
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <4 x b16> [[TMP9]], b16 [[TMP10]], i32 1
; CHECK-NEXT:    [[TMP7:%.*]] = ptrtoint ptr addrspace(3) [[TMP3]] to i32
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i32 [[TMP7]] to <2 x b16>
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <2 x b16> [[TMP13]], i32 0
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x b16> [[TMP11]], b16 [[TMP14]], i32 2
; CHECK-NEXT:    [[TMP16:%.*]] = extractelement <2 x b16> [[TMP13]], i32 1
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x b16> [[TMP15]], b16 [[TMP16]], i32 3
; CHECK-NEXT:    store <4 x b16> [[TMP17]], ptr addrspace(2) [[STORE_GEP1]], align 4
; CHECK-NEXT:    [[STORE_GEP4:%.*]] = getelementptr inbounds ptr addrspace(3), ptr addrspace(2) [[PTR2]], i64 2
; CHECK-NEXT:    store ptr addrspace(3) [[TMP4]], ptr addrspace(2) [[STORE_GEP4]], align 4
; CHECK-NEXT:    ret void
;
