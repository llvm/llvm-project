...
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x b64>, ptr [[IDX0]], align 8
; CHECK-NEXT:    [[L1:%.*]] = extractelement <2 x b64> [[TMP1]], i32 0
; CHECK-NEXT:    [[L01:%.*]] = bitcast b64 [[L1]] to i64
; CHECK-NEXT:    [[L13:%.*]] = extractelement <2 x b64> [[TMP1]], i32 1
; CHECK-NEXT:    [[L12:%.*]] = bitcast b64 [[L13]] to i64
