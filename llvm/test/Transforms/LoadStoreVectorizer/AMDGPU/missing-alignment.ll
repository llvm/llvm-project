...
; RUN: opt -mtriple=amdgpu8.02-- -passes=load-store-vectorizer -S -o - %s | FileCheck %s
...
; CHECK-NEXT:    [[VAL01:%.*]] = extractelement <2 x float> [[TMP2]], i64 0
; CHECK-NEXT:    [[VAL12:%.*]] = extractelement <2 x float> [[TMP2]], i64 1
