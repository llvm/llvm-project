...
; RUN: grep 'load <2 x b8>' < %t | count 3
; RUN: grep 'load <4 x b8>' < %t | count 27
; RUN: grep 'call <4 x b8> @llvm.masked.load.v4b8.p1.*<4 x i1> <i1 false, i1 true, i1 true, i1 true>' < %t | count 6
