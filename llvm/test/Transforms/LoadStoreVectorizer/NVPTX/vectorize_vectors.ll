...
; CHECK-NEXT:    [[L01:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> poison, <3 x i32> <i32 0, i32 1, i32 2>
; CHECK-NEXT:    [[L12:%.*]] = extractelement <4 x i8> [[TMP1]], i32 3
; CHECK-NEXT:    store <4 x i8> zeroinitializer, ptr [[PTR0]], align 4
; CHECK-NEXT:    ret void
;
