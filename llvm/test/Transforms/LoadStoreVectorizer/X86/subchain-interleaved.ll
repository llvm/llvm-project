...
; CHECK-NEXT:    store <2 x i32> zeroinitializer, ptr [[PTR]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i32>, ptr [[NEXT_GEP1]], align 4
; CHECK-NEXT:    [[L31:%.*]] = extractelement <2 x i32> [[TMP1]], i32 0
; CHECK-NEXT:    [[L42:%.*]] = extractelement <2 x i32> [[TMP1]], i32 1
; CHECK-NEXT:    ret void
;
  %next.gep1 = getelementptr i32, ptr %ptr, i64 1
  %next.gep2 = getelementptr i32, ptr %ptr, i64 2
...
; CHECK-NEXT:    store <2 x i32> zeroinitializer, ptr [[NEXT_GEP1]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load <3 x i32>, ptr [[NEXT_GEP1]], align 4
; CHECK-NEXT:    [[L33:%.*]] = extractelement <3 x i32> [[TMP2]], i32 0
; CHECK-NEXT:    [[L44:%.*]] = extractelement <3 x i32> [[TMP2]], i32 1
; CHECK-NEXT:    [[L55:%.*]] = extractelement <3 x i32> [[TMP2]], i32 2
; CHECK-NEXT:    ret void
;
  %next.gep1 = getelementptr i32, ptr %ptr, i64 1
  %next.gep2 = getelementptr i32, ptr %ptr, i64 2
...
; CHECK-NEXT:    [[L12:%.*]] = extractelement <2 x i32> [[TMP1]], i32 1
; CHECK-NEXT:    store <2 x i32> zeroinitializer, ptr [[PTR]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load <3 x i32>, ptr [[GEP1]], align 4
; CHECK-NEXT:    [[L33:%.*]] = extractelement <3 x i32> [[TMP2]], i32 0
; CHECK-NEXT:    [[L44:%.*]] = extractelement <3 x i32> [[TMP2]], i32 1
; CHECK-NEXT:    [[L55:%.*]] = extractelement <3 x i32> [[TMP2]], i32 2
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[GEP4]], align 4
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[L12:%.*]] = extractelement <2 x i32> [[TMP1]], i32 1
; CHECK-NEXT:    store <2 x i32> zeroinitializer, ptr [[PTR]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i32>, ptr [[GEP1]], align 16
; CHECK-NEXT:    [[L33:%.*]] = extractelement <4 x i32> [[TMP2]], i32 0
; CHECK-NEXT:    [[L44:%.*]] = extractelement <4 x i32> [[TMP2]], i32 1
; CHECK-NEXT:    [[L55:%.*]] = extractelement <4 x i32> [[TMP2]], i32 2
; CHECK-NEXT:    [[L66:%.*]] = extractelement <4 x i32> [[TMP2]], i32 3
; CHECK-NEXT:    [[L77:%.*]] = extractelement <4 x i32> [[TMP2]], i32 3
; CHECK-NEXT:    ret void
;
  %tmp2 = getelementptr i32, ptr %ptr, i64 1
  %tmp3 = getelementptr i32, ptr %ptr, i64 2
