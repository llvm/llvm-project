...
; CHECK-NEXT:    [[L21:%.*]] = extractelement <2 x i32> [[TMP1]], i64 0
; CHECK-NEXT:    [[L12:%.*]] = extractelement <2 x i32> [[TMP1]], i64 1
; CHECK-NEXT:    store <2 x i32> zeroinitializer, ptr [[PTR]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load <2 x i32>, ptr [[NEXT_GEP1]], align 4
; CHECK-NEXT:    [[L33:%.*]] = extractelement <2 x i32> [[TMP2]], i64 0
; CHECK-NEXT:    [[L44:%.*]] = extractelement <2 x i32> [[TMP2]], i64 1
; CHECK-NEXT:    ret void
;
