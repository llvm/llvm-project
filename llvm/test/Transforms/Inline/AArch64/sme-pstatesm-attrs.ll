...
; CHECK-LABEL: define void @nonstreaming_caller_multiple_nonstreaming_callees_dont_inline
; CHECK-SAME: () #[[ATTR2]] {
; CHECK-NEXT:    call void @nonstreaming_caller_multiple_nonstreaming_callees()
; CHECK-NEXT:    ret void
;
  call void @nonstreaming_caller_multiple_nonstreaming_callees()
  ret void
}
...
define void @streaming_caller_single_streaming_compatible_callee_inline() #0 "aarch64_pstate_sm_enabled" {
...
define void @streaming_caller_multiple_streaming_compatible_callees_inline() #0 "aarch64_pstate_sm_enabled" {
