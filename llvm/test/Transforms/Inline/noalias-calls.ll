...
; RUN: opt -passes=inline -enable-noalias-to-md-conversion -disable-inline-history -S < %s | FileCheck %s
; RUN: opt -aa-pipeline=basic-aa -passes=inline -enable-noalias-to-md-conversion -disable-inline-history -S < %s | FileCheck %s
