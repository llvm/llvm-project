...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[CALL:%.*]] = call noalias noundef nonnull ptr @_Znam(i64 noundef 10) #[[ATTR8:[0-9]+]], !memprof [[META37:![0-9]+]], !callsite [[META46:![0-9]+]]
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[CALL_I:%.*]] = call noalias noundef nonnull ptr @_Znam(i64 noundef 10) #[[ATTR9:[0-9]+]], !memprof [[META47:![0-9]+]], !callsite [[META48:![0-9]+]]
...
; CHECK-SAME: ) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[CALL:%.*]] = call noundef ptr @_Z4foo2v(), !callsite [[META49:![0-9]+]]
; CHECK-NEXT:    ret ptr [[CALL]]
;
entry:
...
; CHECK-SAME: ) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[CALL:%.*]] = call noundef ptr @_Z4foo2v(), !callsite [[META50:![0-9]+]]
; CHECK-NEXT:    ret ptr [[CALL]]
;
entry:
...
; CHECK-NEXT:    [[CALL:%.*]] = call noundef ptr @_Z3foov() #[[ATTR10:[0-9]+]], !callsite [[META51:![0-9]+]]
; CHECK-NEXT:    store ptr [[CALL]], ptr [[C]], align 8
; CHECK-NEXT:    [[CALL1:%.*]] = call noundef ptr @_Z3foov() #[[ATTR10]], !callsite [[META52:![0-9]+]]
; CHECK-NEXT:    store ptr [[CALL1]], ptr [[D]], align 8
; CHECK-NEXT:    [[CALL2:%.*]] = call noundef ptr @_Z3barv() #[[ATTR10]], !callsite [[META53:![0-9]+]]
; CHECK-NEXT:    store ptr [[CALL2]], ptr [[E]], align 8
; CHECK-NEXT:    [[CALL3:%.*]] = call noundef ptr @_Z3bazv() #[[ATTR10]], !callsite [[META54:![0-9]+]]
...
;.
; CHECK: [[META37]] = !{[[META38:![0-9]+]], [[META40:![0-9]+]], [[META42:![0-9]+]], [[META44:![0-9]+]]}
; CHECK: [[META38]] = !{[[META39:![0-9]+]], !"cold"}
; CHECK: [[META39]] = !{i64 -2458008693472584243, i64 7394638144382192936}
; CHECK: [[META40]] = !{[[META41:![0-9]+]], !"notcold"}
; CHECK: [[META41]] = !{i64 -2458008693472584243, i64 -8908997186479157179}
; CHECK: [[META42]] = !{[[META43:![0-9]+]], !"notcold"}
; CHECK: [[META43]] = !{i64 -2458008693472584243, i64 -8079659623765193173, i64 -4805294506621015872}
; CHECK: [[META44]] = !{[[META45:![0-9]+]], !"cold"}
; CHECK: [[META45]] = !{i64 -2458008693472584243, i64 -8079659623765193173, i64 -972865200055133905}
; CHECK: [[META46]] = !{i64 -2458008693472584243}
; CHECK: [[META47]] = !{[[META42]], [[META44]]}
; CHECK: [[META48]] = !{i64 -2458008693472584243, i64 -8079659623765193173}
; CHECK: [[META49]] = !{i64 -972865200055133905}
; CHECK: [[META50]] = !{i64 -4805294506621015872}
; CHECK: [[META51]] = !{i64 -8908997186479157179}
; CHECK: [[META52]] = !{i64 7394638144382192936}
; CHECK: [[META53]] = !{i64 -5510257407004945023}
; CHECK: [[META54]] = !{i64 8771588133652501463}
;.
