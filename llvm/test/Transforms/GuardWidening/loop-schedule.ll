...
; Main point of this test is to check the scheduling. After hoisting a
; loop-invariant exit condition LICM requests the ShouldRunExtraSimpleLoopUnswitch
; marker; GuardWidening still follows LICM directly.

; CHECK: LICMPass
; CHECK-NEXT: ShouldRunExtraSimpleLoopUnswitch
