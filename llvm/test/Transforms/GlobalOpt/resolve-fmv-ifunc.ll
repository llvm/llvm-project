; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --filter "call i32 @(test_single_bb_resolver|test_multi_bb_resolver|test_caller_feats_not_implied|test_non_fmv_caller|test_priority|test_alternative_names|test_explicit_priority)" --version 4
...
$test_explicit_priority.resolver = comdat any
...
@test_explicit_priority = weak_odr ifunc i32 (), ptr @test_explicit_priority.resolver
...
attributes #18 = { "fmv-features"="P1,P3,mops" } ; priority=10
attributes #19 = { "fmv-features"="P2,P4,sve2" } ; priority=20
attributes #20 = { "fmv-features"="P1,P2,P3,P4,sve" } ; priority=30
attributes #21 = { "fmv-features"="P1,P4,P5,mops,sve2" } ; priority=50
attributes #22 = { "fmv-features"="P2,P5,P6,mops" } ; priority=100
attributes #23 = { "fmv-features"="P3,P6,P7,sve" } ; priority=200
