; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --filter "call i32 @(test_single_bb_resolver|test_multi_bb_resolver|test_caller_feats_not_implied|test_non_fmv_caller|test_priority|test_alternative_names|test_unrelated_callers|test_priority_override)" --version 4
...
declare i32 @test_priority_override._Maes() #19
declare i32 @test_priority_override._Msme() #20
...
define i32 @caller11._Maes() #21 {
; CHECK-LABEL: define i32 @caller11._Maes(
...
define i32 @caller11._Mbf16() #22 {
; CHECK-LABEL: define i32 @caller11._Mbf16(
...
define noundef i32 @caller11.default() #0 {
; CHECK-LABEL: define noundef i32 @caller11.default(
; CHECK-SAME: ) #[[ATTR0]] {
...
resolver_entry:
  ...
  %caller11._Mbf16.caller11.default = select i1 %4, ptr @caller11._Mbf16, ptr @caller11.default
  %common.ret.op = select i1 %2, ptr @caller11._Maes, ptr %caller11._Mbf16.caller11.default
  ret ptr %common.ret.op
}
...
attributes #19 = { "fmv-features"="P1,P4,P5,aes" } ; priority=50
attributes #20 = { "fmv-features"="P1,P2,P3,P4,sme" } ; priority=30
attributes #21 = { "fmv-features"="P3,P6,P7,aes" } ; priority=200
attributes #22 = { "fmv-features"="P2,P5,P6,bf16" } ; priority=100
