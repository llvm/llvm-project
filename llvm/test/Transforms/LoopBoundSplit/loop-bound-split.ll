...
; CHECK-NEXT:    [[TMP1:%.*]] = icmp slt i64 [[A:%.*]], [[SMAX]]
; CHECK-NEXT:    [[NEW_BOUND:%.*]] = select i1 [[TMP1]], i64 [[A]], i64 [[SMAX]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = icmp ult i64 [[A:%.*]], [[TMP0]]
; CHECK-NEXT:    [[NEW_BOUND:%.*]] = select i1 [[TMP1]], i64 [[A]], i64 [[TMP0]]
; CHECK-NEXT:    br label [[LOOP:%.*]]
; CHECK:       loop:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[INC:%.*]], [[FOR_INC:%.*]] ], [ 0, [[LOOP_PH_SPLIT]] ]
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt i64 [[IV]], [[A]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = icmp slt i64 [[A:%.*]], [[TMP1]]
; CHECK-NEXT:    [[NEW_BOUND:%.*]] = select i1 [[TMP2]], i64 [[A]], i64 [[TMP1]]
; CHECK-NEXT:    br label [[LOOP:%.*]]
; CHECK:       loop:
; CHECK-NEXT:    [[IV:%.*]] = phi i64 [ [[INC:%.*]], [[FOR_INC:%.*]] ], [ 0, [[LOOP_PH_SPLIT]] ]
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt i64 [[IV]], [[A]]
