...
; CHECK:       entry.split:
; CHECK-NEXT:    [[TMP0:%.*]] = icmp ult i16 [[QQQ:%.*]], 2
; CHECK-NEXT:    [[NEW_BOUND:%.*]] = select i1 [[TMP0]], i16 [[QQQ]], i16 2
...
; CHECK-NEXT:    [[TMP1:%.*]] = icmp ne i16 [[T8_LCSSA]], 3
; CHECK-NEXT:    br i1 [[TMP1]], label [[FOR_BODY_SPLIT_PREHEADER:%.*]], label [[FOR_COND_CLEANUP:%.*]]
