...
; CHECK-NEXT:    [[UD:%.*]] = load i64, ptr [[P]], align 8, !tbaa [[TBAA0:![0-9]+]], !alias.scope [[META4:![0-9]+]], !noalias [[META7:![0-9]+]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[TMP1]], ptr [[TMP0]], i64 64, i1 false), !tbaa [[TBAA12:![0-9]+]], !alias.scope [[META13:![0-9]+]], !noalias [[META14:![0-9]+]]
...
; CHECK-NEXT:    [[TMP6:%.*]] = load i64, ptr [[TMP4]], align 8, !tbaa [[TBAA0]], !alias.scope [[META4]], !noalias [[META7]]
; CHECK-NEXT:    ret i64 [[TMP6]]
; CHECK:       [[L2]]:
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i64, ptr [[TMP1]], i64 2
; CHECK-NEXT:    [[TMP3:%.*]] = load i64, ptr [[TMP5]], align 8, !tbaa [[TBAA0]], !alias.scope [[META4]], !noalias [[META7]]
...
; CHECK-NEXT:  [[TOP:.*]]:
; CHECK-NEXT:    [[TMP1:%.*]] = alloca [8 x i64], align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr [[TMP1]], ptr [[TMP0]], i64 64, i1 false), !tbaa [[TBAA12]], !alias.scope [[META13]], !noalias [[META14]]
; CHECK-NEXT:    br i1 [[C]], label %[[L1:.*]], label %[[L2:.*]]
; CHECK:       [[L1]]:
; CHECK-NEXT:    br label %[[L2]]
; CHECK:       [[L2]]:
...
; CHECK-NEXT:    [[TMP4:%.*]] = load i64, ptr [[TMP3]], align 8, !tbaa [[TBAA0]], !alias.scope [[META4]], !noalias [[META7]]
; CHECK-NEXT:    ret i64 [[TMP4]]
;
top:
  %1 = alloca [8 x i64], align 8
...
; CHECK: [[META7]] = !{[[META8:![0-9]+]], [[META9:![0-9]+]], [[META10:![0-9]+]], [[META11:![0-9]+]]}
