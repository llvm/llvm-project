; Test that FullLTO pre-slides subclass layout to account for superclass ivars
; that were not visible to the subclass translation unit.
;
; Hierarchy:
;   NSObject
;     `- SuperClass
;          int x;                        // x at offset 8
;          int hidden_y;                 // hidden_y at offset 12
;          `- SubClass
;               int z;                   // z compiled at 8, slid to 16
;
...
; CHECK: @"OBJC_IVAR_$_SuperClass.hidden_y" = {{.*}}constant i64 12
; CHECK: @"OBJC_IVAR_$_SubClass.z" = {{.*}}constant i64 16
; CHECK: @"_OBJC_CLASS_RO_$_SubClass" = internal global %struct._class_ro_t { i32 0, i32 16, i32 20,
...
@interface SuperClass () { int hidden_y; } @end
@implementation SuperClass @end

;--- sub.m
#import <objc/NSObject.h>
@interface SuperClass : NSObject @end
@interface SubClass : SuperClass { int z; } @end
...
@IvarHidden = private unnamed_addr constant [9 x i8] c"hidden_y\00"
...
@"OBJC_IVAR_$_SuperClass.hidden_y" = global i64 12, section "__DATA,__objc_ivar", align 8
@"_OBJC_IVARS_$_SuperClass" = internal global { i32, i32, [2 x %struct._ivar_t] } { i32 32, i32 2, [2 x %struct._ivar_t] [%struct._ivar_t { ptr @"OBJC_IVAR_$_SuperClass.x", ptr @IvarX, ptr @IntTy, i32 2, i32 4 }, %struct._ivar_t { ptr @"OBJC_IVAR_$_SuperClass.hidden_y", ptr @IvarHidden, ptr @IntTy, i32 2, i32 4 }] }
...
@"_OBJC_CLASS_RO_$_SuperClass" = internal global %struct._class_ro_t { i32 0, i32 8, i32 16, ptr null, ptr @SuperName, ptr null, ptr null, ptr @"_OBJC_IVARS_$_SuperClass", ptr null, ptr null }
...
@IvarZ = private unnamed_addr constant [2 x i8] c"z\00"
@IntTy = private unnamed_addr constant [2 x i8] c"i\00"
@"OBJC_IVAR_$_SubClass.z" = global i64 8, section "__DATA,__objc_ivar", align 8
@"_OBJC_IVARS_$_SubClass" = internal global { i32, i32, [1 x %struct._ivar_t] } { i32 32, i32 1, [1 x %struct._ivar_t] [%struct._ivar_t { ptr @"OBJC_IVAR_$_SubClass.z", ptr @IvarZ, ptr @IntTy, i32 2, i32 4 }] }
...
@"_OBJC_CLASS_RO_$_SubClass" = internal global %struct._class_ro_t { i32 0, i32 8, i32 12, ptr null, ptr @SubName, ptr null, ptr null, ptr @"_OBJC_IVARS_$_SubClass", ptr null, ptr null }
