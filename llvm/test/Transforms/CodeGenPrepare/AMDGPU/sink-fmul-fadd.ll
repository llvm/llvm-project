...
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgcn-amd-amdhsa -mcpu=gfx803 < %s | FileCheck -check-prefixes=CHECK,GFX8 %s
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgcn-amd-amdhsa -mcpu=gfx900 < %s | FileCheck -check-prefixes=CHECK,GFX9 %s
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1030 < %s | FileCheck -check-prefixes=CHECK,GFX10 %s
...
define float @sink_fmul_fsub_f32(i1 %cond, float %a, float %b, float %c) #0 {
...
define float @sink_fmul_fsub_rev_f32(i1 %cond, float %a, float %b, float %c) #0 {
...
define half @sink_fmul_fadd_f16(i1 %cond, half %a, half %b, half %c) #0 {
...
define double @sink_fmul_fadd_f64(i1 %cond, double %a, double %b, double %c) #0 {
; CHECK-LABEL: define double @sink_fmul_fadd_f64(
; CHECK-SAME: i1 [[COND:%.*]], double [[A:%.*]], double [[B:%.*]], double [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
define <2 x float> @sink_fmul_fadd_v2f32(i1 %cond, <2 x float> %a, <2 x float> %b, <2 x float> %c) #0 {
; CHECK-LABEL: define <2 x float> @sink_fmul_fadd_v2f32(
; CHECK-SAME: i1 [[COND:%.*]], <2 x float> [[A:%.*]], <2 x float> [[B:%.*]], <2 x float> [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
define float @sink_only_fusable_fmul(i1 %cond, float %a, float %b, float %c, float %d) #0 {
; CHECK-LABEL: define float @sink_only_fusable_fmul(
; CHECK-SAME: i1 [[COND:%.*]], float [[A:%.*]], float [[B:%.*]], float [[C:%.*]], float [[D:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
define float @no_sink_second_fmul(i1 %cond, float %a, float %b, float %c, float %d) #0 {
...
define float @sink_fmul_fadd_f32_no_denormals(i1 %cond, float %a, float %b, float %c) #1 {
; CHECK-LABEL: define float @sink_fmul_fadd_f32_no_denormals(
; CHECK-SAME: i1 [[COND:%.*]], float [[A:%.*]], float [[B:%.*]], float [[C:%.*]]) #[[ATTR1:[0-9]+]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; Same for v_mad_f16.
define half @sink_fmul_fadd_f16_no_denormals(i1 %cond, half %a, half %b, half %c) #1 {
; CHECK-LABEL: define half @sink_fmul_fadd_f16_no_denormals(
; CHECK-SAME: i1 [[COND:%.*]], half [[A:%.*]], half [[B:%.*]], half [[C:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
define float @no_sink_fmul_fadd_f32_denormals(i1 %cond, float %a, float %b, float %c) #0 {
...
define float @no_sink_fmul_not_contract_fadd(i1 %cond, float %a, float %b, float %c) #0 {
...
define float @no_sink_fadd_not_contract_fmul(i1 %cond, float %a, float %b, float %c) #0 {
...
define float @no_sink_same_block(float %a, float %b, float %c) #0 {
...
define float @no_sink_not_fmul(i1 %cond, float %a, float %b, float %c) #0 {
...
define float @sink_fmul_into_loop(float %a, float %b, i32 %n) #0 {
; CHECK-LABEL: define float @sink_fmul_into_loop(
; CHECK-SAME: float [[A:%.*]], float [[B:%.*]], i32 [[N:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[MUL:%.*]] = fmul contract float [[A]], [[B]]
...
define <2 x half> @sink_fmul_fadd_v2f16_no_denormals(i1 %cond, <2 x half> %a, <2 x half> %b, <2 x half> %c) #1 {
; CHECK-LABEL: define <2 x half> @sink_fmul_fadd_v2f16_no_denormals(
; CHECK-SAME: i1 [[COND:%.*]], <2 x half> [[A:%.*]], <2 x half> [[B:%.*]], <2 x half> [[C:%.*]]) #[[ATTR1]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
define <2 x half> @sink_fmul_fadd_v2f16_no_denormals_no_contract(i1 %cond, <2 x half> %a, <2 x half> %b, <2 x half> %c) #1 {
...
define <2 x half> @sink_fmul_fadd_v2f16_denormals(i1 %cond, <2 x half> %a, <2 x half> %b, <2 x half> %c) #0 {
...
define bfloat @sink_fmul_fadd_bf16(i1 %cond, bfloat %a, bfloat %b, bfloat %c) #0 {
; CHECK-LABEL: define bfloat @sink_fmul_fadd_bf16(
; CHECK-SAME: i1 [[COND:%.*]], bfloat [[A:%.*]], bfloat [[B:%.*]], bfloat [[C:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
