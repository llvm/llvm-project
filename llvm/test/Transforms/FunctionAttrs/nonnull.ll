...
; RUN: opt -S -passes=function-attrs -enable-poison-arg-attr-prop %s | FileCheck %s --check-prefixes=COMMON,FNATTRS
...
; FNATTRS-SAME: ptr nofree nonnull readnone returned captures(ret: address, provenance) [[P:%.*]]) #[[ATTR0:[0-9]+]] {
...
; FNATTRS-SAME: ptr nofree readnone returned captures(ret: address, provenance) [[A:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(ret: address, provenance) [[A:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(ret: address, provenance) [[A:%.*]], i64 [[N:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(address_is_null, ret: address, provenance) [[TMP0:%.*]]) local_unnamed_addr {
...
; FNATTRS-SAME: ptr nofree readnone captures(none) [[A:%.*]], ptr nofree readnone captures(none) [[B:%.*]], ptr nofree readnone captures(none) [[C:%.*]]) #[[ATTR0]] {
; FNATTRS-NEXT:    ret void
;
...
; FNATTRS-SAME: ptr nofree readonly captures(address_is_null) [[ARG:%.*]]) #[[ATTR4:[0-9]+]] {
; FNATTRS-NEXT:  bb:
...
; FNATTRS-SAME: ptr nofree readonly captures(address_is_null) [[ARG:%.*]]) #[[ATTR4]] {
; FNATTRS-NEXT:  bb:
...
; FNATTRS-SAME: ptr [[A:%.*]], ptr nofree captures(address) [[B:%.*]]) {
...
; FNATTRS-SAME: ptr nonnull [[A:%.*]], ptr nofree readnone captures(none) [[BOGUS1:%.*]], ptr nonnull [[B:%.*]]) #[[ATTR7]] personality ptr @esfp {
; FNATTRS-NEXT:  entry:
...
; FNATTRS-SAME: ptr nofree readnone captures(ret: address, provenance) [[P:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(ret: address, provenance) [[P:%.*]]) #[[ATTR8:[0-9]+]] {
; FNATTRS-NEXT:    [[Q:%.*]] = getelementptr inbounds i32, ptr [[P]], i32 1
; FNATTRS-NEXT:    ret ptr [[Q]]
;
...
; FNATTRS-SAME: ptr addrspace(3) nofree readnone captures(ret: address, provenance) [[P:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr addrspace(3) nofree readnone returned captures(ret: address, provenance) dereferenceable(4) [[P:%.*]]) #[[ATTR0]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(address) [[A:%.*]]) #[[ATTR10:[0-9]+]] {
...
; FNATTRS-SAME: ptr nofree readnone captures(address) dereferenceable(4) [[A:%.*]]) #[[ATTR10]] {
; FNATTRS-NEXT:    call void @use_i32_ptr(ptr [[A]])
; FNATTRS-NEXT:    ret void
;
...
; FNATTRS-SAME: ptr nofree nonnull readnone captures(ret: address, provenance) [[ARG:%.*]]) #[[ATTR0]] {
