...
;
; FNATTR: define ptr @ptr_sink_r0(ptr nofree readnone returned captures(ret: address, provenance) %r)
; FNATTR: define ptr @ptr_scc_r1(ptr nofree readnone %a, ptr nofree readnone %r, ptr nofree readnone captures(none) %b)
; FNATTR: define ptr @ptr_scc_r2(ptr nofree readnone %a, ptr nofree readnone %b, ptr nofree readnone %r)
;
;
...
; }
;
; FNATTR:  define ptr @rt0(ptr nofree readonly %a)
...
; }
;
; FNATTR:  define noalias ptr @rt1(ptr nofree readonly captures(none) %a)
...
;
; FNATTR:  define ptr @rt2_helper(ptr nofree readnone captures(address_is_null) %a)
; FNATTR:  define ptr @rt2(ptr nofree readnone captures(address_is_null) %a, ptr nofree readnone captures(ret: address, provenance) %b)
...
; TEST another SCC test
;
; FNATTR:  define ptr @rt3_helper(ptr nofree readnone captures(address_is_null) %a, ptr nofree readnone %b)
; FNATTR:  define ptr @rt3(ptr nofree readnone captures(address_is_null) %a, ptr nofree readnone %b)
...
;
;
; FNATTR:     define ptr @calls_unknown_fn(ptr nofree readnone returned captures(ret: address, provenance) %r)
...
;
;
; FNATTR:     define ptr @bitcast(ptr nofree readnone returned captures(ret: address, provenance) %b)
;
...
;
;
; FNATTR:     define ptr @bitcasts_select_and_phi(ptr nofree readnone captures(address_is_null, ret: address, provenance) %b)
;
...
;
;
; FNATTR:     define ptr @ret_arg_arg_undef(ptr nofree readnone captures(address_is_null, ret: address, provenance) %b)
;
...
;
;
; FNATTR:     define ptr @ret_undef_arg_arg(ptr nofree readnone captures(address_is_null, ret: address, provenance) %b)
;
...
;
;
; FNATTR:     define ptr @ret_undef_arg_undef(ptr nofree readnone captures(address_is_null, ret: address, provenance) %b)
