...
;
  ...
  %q.rsrc = call ptr addrspace(8) @llvm.amdgcn.make.buffer.rsrc.p8.p0.i64(ptr %q, i16 0, i64 4, i32 822243328)
...
declare ptr addrspace(8) @llvm.amdgcn.make.buffer.rsrc.p8.p0.i64(ptr readnone, i16, i64, i32) #0
