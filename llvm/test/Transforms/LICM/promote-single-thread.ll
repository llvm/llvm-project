...
; RUN: split-file %s %t
; RUN: opt -S -passes=licm < %t/body.ll | FileCheck %s --check-prefixes=CHECK,MT
; RUN: cat %t/body.ll %t/single.ll | opt -S -passes=licm | FileCheck %s --check-prefixes=CHECK,ST
