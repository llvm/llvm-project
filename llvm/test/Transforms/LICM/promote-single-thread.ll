...
;; The single-threaded thread model is selected by appending the "thread-model"
;; module flag to the body.
; RUN: cat %s %S/Inputs/thread-model-single.ll | opt -S -passes=licm | FileCheck %s --check-prefixes=CHECK,ST
