...
for.body.lr.ph:                                   ; preds = %entry
  ...
  br i1 %cmp1, label %for.body.us, label %for.cond.cleanup

for.body.us:                                      ; preds = %for.body.lr.ph, %for.body.us
  %add12.us = phi i64 [ %add.reass.us, %for.body.us ], [ %0, %for.body.lr.ph ]
  %i.011.us = phi i64 [ %add3.us, %for.body.us ], [ 0, %for.body.lr.ph ]
  %arrayidx.us = getelementptr inbounds nuw float, ptr %a, i64 %add12.us
  store float %conv, ptr %arrayidx.us, align 4, !tbaa !5
  %add3.us = add i64 %i.011.us, 8
  %add.reass.us = add i64 %i.011.us, %invariant.op
  %cmp.us = icmp ult i64 %add.reass.us, %N
  br i1 %cmp.us, label %for.body.us, label %for.cond.cleanup, !llvm.loop !9

for.cond.cleanup:                                 ; preds = %for.body.us, %for.body.lr.ph, %entry
  ret void
}
