...
entry:
  ...
  %cmp110 = icmp ult i64 %0, %N
  %or.cond = and i1 %cmp, %cmp110
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %i.011 = phi i64 [ 0, %for.body.lr.ph ], [ %add3, %for.body ]
  %add12 = or disjoint i64 %i.011, %0
  ...
  %add = or disjoint i64 %add3, %0
  %cmp1 = icmp ult i64 %add, %N
