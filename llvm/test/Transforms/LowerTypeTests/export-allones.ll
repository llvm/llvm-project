...
; RUN:   -lowertypetests-read-summary=%t/summary.bc -lowertypetests-write-summary=%t/out.summary %t/main.ll | FileCheck --check-prefixes=CHECK,X86 %s
...
; RUN:   -lowertypetests-read-summary=%t/summary.bc -lowertypetests-write-summary=%t/out.summary %t/main.ll | FileCheck --check-prefixes=CHECK,ARM %s
