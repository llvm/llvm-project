...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], i64 0, i64 [[UMIN]]
...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], i64 0, i64 [[SHL]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
  %cond = icmp eq i64 %a, 0
  %shl = shl i64 %a, %b
...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], i64 0, i64 [[AND]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
  %cond = icmp eq i64 %a, 0
  %and = and i64 %a, %b
...
; FIXED-ZERO-NEXT:    [[COND_NOT:%.*]] = icmp eq i64 [[A:%.*]], 0
; FIXED-ZERO-NEXT:    [[ASHR:%.*]] = ashr i64 [[A]], [[B_FR:%.*]]
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND_NOT]], i64 0, i64 [[ASHR]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND_NOT]], i64 0, i64 [[LSHR]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
  %cond = icmp ne i64 0, %a
  %lshr = lshr i64 %a, %b
...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], i64 0, i64 [[FSHL]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
  %cond = icmp eq i64 %a, 0
...
; FIXED-ZERO-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], i64 0, i64 [[DIV]]
; FIXED-ZERO-NEXT:    ret i64 [[SELECT]]
;
  %cond = icmp eq i64 %a, 0
  %div = sdiv i64 %a, %b
