...
;
; DEFAULT_ITER-LABEL: define void @br_true
; DEFAULT_ITER-SAME: (i1 [[X:%.*]]) {
; DEFAULT_ITER-NEXT:    br i1 true, label [[IF:%.*]], label [[ELSE:%.*]]
; DEFAULT_ITER:       if:
...
;
; DEFAULT_ITER-LABEL: define void @br_false
; DEFAULT_ITER-SAME: (i1 [[X:%.*]]) {
; DEFAULT_ITER-NEXT:    br i1 false, label [[IF:%.*]], label [[ELSE:%.*]]
; DEFAULT_ITER:       if:
; DEFAULT_ITER-NEXT:    ret void
; DEFAULT_ITER:       else:
; DEFAULT_ITER-NEXT:    call void @dummy()
...
;
; DEFAULT_ITER-LABEL: define void @switch_case
; DEFAULT_ITER-SAME: (i32 [[X:%.*]]) {
; DEFAULT_ITER-NEXT:    switch i32 0, label [[DEFAULT:%.*]] [
...
;
; DEFAULT_ITER-LABEL: define void @switch_default
; DEFAULT_ITER-SAME: (i32 [[X:%.*]]) {
; DEFAULT_ITER-NEXT:    switch i32 -1, label [[DEFAULT:%.*]] [
; DEFAULT_ITER-NEXT:    i32 0, label [[CASE0:%.*]]
; DEFAULT_ITER-NEXT:    ]
; DEFAULT_ITER:       case0:
; DEFAULT_ITER-NEXT:    ret void
...
;
; DEFAULT_ITER-LABEL: define void @br_into_loop
; DEFAULT_ITER-SAME: (i1 [[X:%.*]]) {
; DEFAULT_ITER-NEXT:    br i1 true, label [[LOOP:%.*]], label [[EXIT:%.*]]
; DEFAULT_ITER:       loop:
; DEFAULT_ITER-NEXT:    call void @dummy()
; DEFAULT_ITER-NEXT:    br label [[LOOP]]
; DEFAULT_ITER:       exit:
