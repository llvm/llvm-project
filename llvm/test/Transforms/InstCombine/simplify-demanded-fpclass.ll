...
define nofpclass(snan inf norm sub zero) float @ret_only_qnan__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(snan inf zero sub norm) float @ret_only_qnan__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[FABS:%.*]] = call float @llvm.fabs.f32(float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[FABS]]
;
...
define nofpclass(qnan inf norm sub zero) float @ret_only_snan__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(qnan inf zero sub norm) float @ret_only_snan__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    [[FABS:%.*]] = call float @llvm.fabs.f32(float [[UNKNOWN]])
; CHECK-NEXT:    ret float [[FABS]]
;
...
define nofpclass(nan ninf norm sub zero) float @ret_only_pinf__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(nan ninf zero sub norm) float @ret_only_pinf__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    ret float 0x7FF0000000000000
;
  %fabs = call float @llvm.fabs.f32(float %unknown)
...
define nofpclass(nan pinf norm sub zero) float @ret_only_ninf__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(nan pinf zero sub norm) float @ret_only_ninf__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    ret float poison
;
  %fabs = call float @llvm.fabs.f32(float %unknown)
...
define nofpclass(nan inf norm sub pzero) float @ret_only_nzero__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(nan inf pzero sub norm) float @ret_only_nzero__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    ret float poison
;
  %fabs = call float @llvm.fabs.f32(float %unknown)
...
define nofpclass(nan inf norm sub nzero) float @ret_only_pzero__fabs(float %unknown) {
; CHECK-LABEL: define nofpclass(nan inf nzero sub norm) float @ret_only_pzero__fabs
; CHECK-SAME: (float [[UNKNOWN:%.*]]) {
; CHECK-NEXT:    ret float 0.000000e+00
;
  %fabs = call float @llvm.fabs.f32(float %unknown)
...
define nofpclass(snan) float @copysign_nnan_sign_known_positive_or_nan(float %x, float nofpclass(ninf nnorm nsub nzero) %always.positive.or.nan) {
; CHECK-LABEL: define nofpclass(snan) float @copysign_nnan_sign_known_positive_or_nan
; CHECK-SAME: (float [[X:%.*]], float nofpclass(ninf nzero nsub nnorm) [[ALWAYS_POSITIVE_OR_NAN:%.*]]) {
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.fabs.f32(float [[X]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
  %copysign = call nnan float @llvm.copysign.f32(float %x, float %always.positive.or.nan)
  ret float %copysign
}
...
; Convert to fabs
define nofpclass(snan) float @copysign_nnan__known_negative__sign_known_positive_or_nan(float nofpclass(pinf pnorm psub pzero) %known.negative, float nofpclass(ninf nnorm nsub nzero) %always.positive.or.nan) {
; CHECK-LABEL: define nofpclass(snan) float @copysign_nnan__known_negative__sign_known_positive_or_nan
; CHECK-SAME: (float nofpclass(pinf pzero psub pnorm) [[KNOWN_NEGATIVE:%.*]], float nofpclass(ninf nzero nsub nnorm) [[ALWAYS_POSITIVE_OR_NAN:%.*]]) {
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.fabs.f32(float [[KNOWN_NEGATIVE]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
  %copysign = call nnan float @llvm.copysign.f32(float %known.negative, float %always.positive.or.nan)
  ret float %copysign
}

; Convert to fneg(fabs)
