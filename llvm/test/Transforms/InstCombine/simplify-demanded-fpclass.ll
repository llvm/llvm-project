...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[X]], float [[ALWAYS_POSITIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[X]], float [[ALWAYS_NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[KNOWN_POSITIVE]], float [[ALWAYS_POSITIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[KNOWN_NEGATIVE]], float [[ALWAYS_NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[KNOWN_NEGATIVE]], float [[ALWAYS_POSITIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
...
; CHECK-NEXT:    [[COPYSIGN:%.*]] = call nnan float @llvm.copysign.f32(float [[KNOWN_POSITIVE]], float [[ALWAYS_NEGATIVE_OR_NAN]])
; CHECK-NEXT:    ret float [[COPYSIGN]]
;
