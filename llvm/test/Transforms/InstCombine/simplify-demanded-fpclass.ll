...
; CHECK-NEXT:    ret float [[X]]
;
  %select0 = select i1 %cond, float f0x7FC00000, float %x
...
; CHECK-NEXT:    ret float poison
;
  %select0 = select i1 %cond, float %x, float f0x7FC00000
  %select1 = select i1 %cond, float +inf, float %select0
  ret float %select1
}
...
entry:
  ...
  %i9 = select i1 %i6, float f0x7FC00000, float 1.000000e+00
  ...
  %i14 = select i1 %i13, float f0x7FC00000, float %i12
  ret float %i14
}
...
bb:
  ...
  %i2 = select i1 %i, float f0x7FC00000, float %arg
  %i3 = tail call float @llvm.log2.f32(float noundef %i2) #2
  %i4 = select i1 %i, float f0x7FC00000, float %arg1
  %i5 = fmul float %i4, %i3
  ...
  %i11 = select i1 %i9, float f0x7FC00000, float %i8
...
bb:
  ...
  %i15 = select i1 %i7, float %i13, float f0x7FC00000
...
;
  %select = select i1 %cond, float %x, float f0x7FC00000
...
; CHECK-NEXT:    ret float [[FMUL]]
;
  %select = select i1 %cond, float f0x7FC00000, float %x
  %fmul = fmul float %select, %select
  ret float %fmul
}
