...
; CHECK-NEXT:    [[R:%.*]] = call <2 x i8> @llvm.vector.partial.reduce.add.v2i8.v4i8(<2 x i8> [[ACC]], <4 x i8> <i8 1, i8 2, i8 3, i8 4>)
...
; CHECK-SAME: (<2 x i8> [[ACC:%.*]]) {
; CHECK-NEXT:    [[R:%.*]] = call <2 x i8> @llvm.vector.partial.reduce.add.v2i8.v4i8(<2 x i8> [[ACC]], <4 x i8> <i8 1, i8 poison, i8 3, i8 4>)
; CHECK-NEXT:    ret <2 x i8> [[R]]
;
...
; CHECK-NEXT:    [[R:%.*]] = call <vscale x 2 x i8> @llvm.vector.partial.reduce.add.nxv2i8.nxv8i8(<vscale x 2 x i8> [[ACC]], <vscale x 8 x i8> splat (i8 3))
...
; CHECK-NEXT:    [[R:%.*]] = call <2 x i8> @llvm.vector.partial.reduce.add.v2i8.v2i8(<2 x i8> [[ACC]], <2 x i8> [[INPUT]])
; CHECK-NEXT:    ret <2 x i8> [[R]]
;
...
; CHECK-NEXT:    [[R:%.*]] = call <vscale x 2 x i8> @llvm.vector.partial.reduce.add.nxv2i8.nxv2i8(<vscale x 2 x i8> [[ACC]], <vscale x 2 x i8> [[INPUT]])
; CHECK-NEXT:    ret <vscale x 2 x i8> [[R]]
;
...
; CHECK-NEXT:    [[INS:%.*]] = insertelement <vscale x 6 x i8> poison, i8 [[X]], i64 0
; CHECK-NEXT:    [[SPLAT:%.*]] = shufflevector <vscale x 6 x i8> [[INS]], <vscale x 6 x i8> poison, <vscale x 6 x i32> zeroinitializer
; CHECK-NEXT:    [[R:%.*]] = call <vscale x 2 x i8> @llvm.vector.partial.reduce.add.nxv2i8.nxv6i8(<vscale x 2 x i8> [[ACC]], <vscale x 6 x i8> [[SPLAT]])
; CHECK-NEXT:    ret <vscale x 2 x i8> [[R]]
;
...
; CHECK-NEXT:    [[INS:%.*]] = insertelement <4 x i1> poison, i1 [[X]], i64 0
; CHECK-NEXT:    [[SPLAT:%.*]] = shufflevector <4 x i1> [[INS]], <4 x i1> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[R:%.*]] = call <2 x i1> @llvm.vector.partial.reduce.add.v2i1.v4i1(<2 x i1> [[ACC]], <4 x i1> [[SPLAT]])
