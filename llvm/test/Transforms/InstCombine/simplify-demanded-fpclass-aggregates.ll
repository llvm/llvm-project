...
;
  %select = select i1 %cond, [2 x float] %arg0, [2 x float] [float f0x7FC00000, float f0x7FC00000]
...
;
  %select = select i1 %cond, [2 x float] %arg0, [2 x float] [float f0x7FC00000, float 0.0]
...
; CHECK-NEXT:    ret float [[TMP1]]
;
  %select = select i1 %cond, [2 x float] %arg0, [2 x float] [float 0.0, float f0x7FC00000]
  %extract = extractvalue [2 x float] %select, 1
  ret float %extract
}
...
; CHECK-NEXT:    ret float [[TMP1]]
;
  %select = select i1 %cond, { float, float } %arg0, { float, float } {float f0x7FC00000, float f0x7FC00000}
...
;
  %select = select i1 %cond, float f0x7FC00000, float %unknown
...
; CHECK-NEXT:    ret [2 x float] [[INSERT]]
;
  %select = select i1 %cond, [2 x float] %array, [2 x float] [float f0x7FC00000, float f0x7FC00000]
...
; CHECK-NEXT:    ret [2 x float] [[INSERT]]
;
  %select.array = select i1 %cond, [2 x float] %array, [2 x float] [float f0x7FC00000, float f0x7FC00000]
  %select.scalar = select i1 %cond, float f0x7FC00000, float %unknown
...
;
  %select = select i1 %cond, { float, float } %array, { float, float } { float f0x7FC00000, float f0x7FC00000 }
