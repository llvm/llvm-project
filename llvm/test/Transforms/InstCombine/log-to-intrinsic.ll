...
define float @test_logf_pos_denormalpreserve(float %f) denormal_fpenv(preservesign,preservesign)  {
...
define float @test_logf_pos_denormaldynamic(float %f) denormal_fpenv(dynamic,dynamic)  {
