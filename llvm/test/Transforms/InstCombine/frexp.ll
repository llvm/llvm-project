...
;
  %ret = call { float, i32 } @llvm.frexp.f32.i32(float f0x7FC00000)
  ret { float, i32 } %ret
}
...
;
  %ret = call { <2 x float>, <2 x i32> } @llvm.frexp.v2f32.v2i32(<2 x float> <float f0x7FC00000, float f0x7FC00000>)
  ret { <2 x float>, <2 x i32> } %ret
}
