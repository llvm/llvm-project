...
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[TMP0]], 2
; CHECK-NEXT:    [[SRC_GEP:%.*]] = getelementptr inbounds i8, ptr [[SRC]], i64 [[TMP2]]
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[I]] to i64
; CHECK-NEXT:    [[TMP3:%.*]] = shl nsw i64 [[TMP1]], 2
; CHECK-NEXT:    [[DST_GEP:%.*]] = getelementptr inbounds i8, ptr [[DST]], i64 [[TMP3]]
