...
; RUN: opt -S -mtriple=amdgpu-amd-amdhsa -passes=instcombine < %s | FileCheck -check-prefixes=NO-FMED3F16,UNKNOWN %s

; Known target, no med3_f16
; RUN: opt -S -mtriple=amdgpu8.03-amd-amdhsa -passes=instcombine < %s | FileCheck -check-prefixes=NO-FMED3F16,GFX8 %s

; Has med3_f16
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa -passes=instcombine < %s | FileCheck -check-prefixes=GFX9 %s
