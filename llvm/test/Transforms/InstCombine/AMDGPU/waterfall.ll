...
; CHECK-NEXT:    [[WF_TOKEN2:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 [[WF_TOKEN1]], i32 [[INDEX]])
; CHECK-NEXT:    [[S_IDX:%.*]] = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 [[WF_TOKEN2]], i32 [[INDEX]])
...
; CHECK-NEXT:    [[WF_TOKEN1:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 [[INDEX:%.*]])
; CHECK-NEXT:    [[WF_TOKEN2:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 [[WF_TOKEN1]], i32 [[INDEX]])
; CHECK-NEXT:    [[WF_TOKEN3:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 [[WF_TOKEN2]], i32 [[INDEX]])
; CHECK-NEXT:    [[S_IDX:%.*]] = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 [[WF_TOKEN3]], i32 [[INDEX]])
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[S_IDX]] to i64
; CHECK-NEXT:    [[PTR:%.*]] = getelementptr <8 x i32>, <8 x i32> addrspace(4)* [[IN:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[RSRC:%.*]] = load <8 x i32>, <8 x i32> addrspace(4)* [[PTR]], align 32
; CHECK-NEXT:    [[R:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.1d.v4f32.f32(i32 15, float [[S:%.*]], <8 x i32> [[RSRC]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; CHECK-NEXT:    [[R1:%.*]] = call <4 x float> @llvm.amdgcn.waterfall.end.v4f32(i32 [[WF_TOKEN3]], <4 x float> [[R]])
; CHECK-NEXT:    ret <4 x float> [[R1]]
;
  %wf_token1 = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 %index)
  %wf_token2 = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 %wf_token1, i32 %index)
...
; CHECK-NEXT:    [[WF_TOKEN3:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 [[WF_TOKEN2]], i32 [[INDEX1]])
; CHECK-NEXT:    [[S_IDX:%.*]] = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 [[WF_TOKEN3]], i32 [[INDEX2]])
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[S_IDX]] to i64
; CHECK-NEXT:    [[PTR:%.*]] = getelementptr <8 x i32>, <8 x i32> addrspace(4)* [[IN:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[RSRC:%.*]] = load <8 x i32>, <8 x i32> addrspace(4)* [[PTR]], align 32
; CHECK-NEXT:    [[R:%.*]] = call <4 x float> @llvm.amdgcn.image.sample.1d.v4f32.f32(i32 15, float [[S:%.*]], <8 x i32> [[RSRC]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
