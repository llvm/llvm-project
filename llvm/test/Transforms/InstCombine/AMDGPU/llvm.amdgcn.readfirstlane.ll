...
; RUN: opt -mtriple=amdgpu10.30-- -passes=instcombine -S < %s | FileCheck %s
...
; CHECK-SAME: i32 [[ARG:%.*]], i32 [[V_OTHER:%.*]]) {
; CHECK-NEXT:  [[BB:.*:]]
...
; CHECK-SAME: i1 [[COND:%.*]], i32 [[ARG:%.*]]) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  [[BB:.*]]:
