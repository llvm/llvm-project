...
; RUN: opt -mtriple=amdgpu7.00--amdpal -S -passes=instcombine %s | FileCheck --check-prefixes=GFX7 %s
; RUN: opt -mtriple=amdgpu8.10--amdpal -S -passes=instcombine %s | FileCheck --check-prefixes=GFX81PLUS %s
; RUN: opt -mtriple=amdgpu9.00--amdpal -S -passes=instcombine %s | FileCheck --check-prefixes=GFX81PLUS %s
; RUN: opt -mtriple=amdgpu10.10--amdpal -S -passes=instcombine %s | FileCheck --check-prefixes=GFX81PLUS %s
; RUN: opt -mtriple=amdgpu11.00--amdpal -S -passes=instcombine %s | FileCheck --check-prefixes=GFX81PLUS %s
