...
; CHECK-SAME: double [[ARG:%.*]], i32 [[LANE:%.*]]) {
; CHECK-NEXT:  [[BB:.*:]]
...
; CHECK-SAME: i1 [[COND:%.*]], i32 [[ARG:%.*]], i32 [[BASE:%.*]]) {
; CHECK-NEXT:  [[BB:.*]]:
...
; CHECK-SAME: i1 [[COND:%.*]], i32 [[ARG:%.*]], i32 [[LANE:%.*]]) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  [[BB:.*]]:
