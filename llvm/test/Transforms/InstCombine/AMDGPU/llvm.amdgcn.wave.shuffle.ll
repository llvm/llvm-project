...
; GFX7-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX7-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX7-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 112
...
; GFX8-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX8-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX8-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 112
...
; NO-INFO-CHECK-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; NO-INFO-CHECK-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; NO-INFO-CHECK-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 112
...
; GFX9-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX9-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX9-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX10-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
...
; GFX10-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX10-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX11-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
...
; GFX11-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX11-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX12-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
...
; GFX12-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX12-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX7-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX7-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX7-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
; GFX7-NEXT:    [[SHARE_7:%.*]] = or disjoint i32 [[MASKED]], 7
; GFX7-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[SHARE_7]])
; GFX7-NEXT:    ret i32 [[RES]]
...
; GFX8-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX8-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX8-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
; GFX8-NEXT:    [[SHARE_7:%.*]] = or disjoint i32 [[MASKED]], 7
; GFX8-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[SHARE_7]])
; GFX8-NEXT:    ret i32 [[RES]]
...
; GFX9-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX9-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX9-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
...
; GFX10-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX10-W64-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
...
; GFX11-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX11-W64-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
...
; GFX12-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX12-W64-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
...
; NO-INFO-CHECK-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; NO-INFO-CHECK-NEXT:    [[LID:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; NO-INFO-CHECK-NEXT:    [[MASKED:%.*]] = and i32 [[LID]], 48
; NO-INFO-CHECK-NEXT:    [[SHARE_7:%.*]] = or disjoint i32 [[MASKED]], 7
; NO-INFO-CHECK-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[SHARE_7]])
; NO-INFO-CHECK-NEXT:    ret i32 [[RES]]
...
; GFX7-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX7-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX7-NEXT:    ret i32 [[RES]]
;
; GFX8-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX8-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX8-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX8-NEXT:    ret i32 [[RES]]
;
; GFX9-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX9-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX9-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX9-NEXT:    ret i32 [[RES]]
;
; GFX10-W32-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX10-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W32-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX10-W32-NEXT:    ret i32 [[RES]]
;
; GFX10-W64-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX10-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX10-W64-NEXT:    ret i32 [[RES]]
;
; GFX11-W32-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX11-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W32-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX11-W32-NEXT:    ret i32 [[RES]]
;
; GFX11-W64-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX11-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX11-W64-NEXT:    ret i32 [[RES]]
;
; GFX12-W32-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX12-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W32-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX12-W32-NEXT:    ret i32 [[RES]]
;
; GFX12-W64-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; GFX12-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; GFX12-W64-NEXT:    ret i32 [[RES]]
;
; NO-INFO-CHECK-LABEL: define i32 @test_wave_shuffle_not_quite_row_share(
; NO-INFO-CHECK-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; NO-INFO-CHECK-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 55)
; NO-INFO-CHECK-NEXT:    ret i32 [[RES]]
;
  %lo = tail call i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
  %lid = tail call i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 %lo)
...
; GFX7-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX7-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX7-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX8-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX8-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX8-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX9-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX9-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX9-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; NO-INFO-CHECK-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; NO-INFO-CHECK-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; NO-INFO-CHECK-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
...
; GFX7-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX7-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX7-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX7-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX7-NEXT:    ret i32 [[RES]]
;
...
; GFX8-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX8-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX8-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX8-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX8-NEXT:    ret i32 [[RES]]
;
...
; GFX9-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX9-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX9-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX9-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX9-NEXT:    ret i32 [[RES]]
;
...
; GFX10-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W64-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX10-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX10-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX10-W64-NEXT:    ret i32 [[RES]]
;
...
; GFX11-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W64-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX11-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX11-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX11-W64-NEXT:    ret i32 [[RES]]
;
...
; GFX12-W64-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W64-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX12-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; GFX12-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX12-W64-NEXT:    ret i32 [[RES]]
;
...
; NO-INFO-CHECK-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; NO-INFO-CHECK-NEXT:    [[TMP1:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; NO-INFO-CHECK-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 15
; NO-INFO-CHECK-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; NO-INFO-CHECK-NEXT:    ret i32 [[RES]]
;
...
; GFX7-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX7-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX7-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX7-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX7-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX7-NEXT:    ret i32 [[RES]]
;
...
; GFX8-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX8-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX8-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX8-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX8-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX8-NEXT:    ret i32 [[RES]]
;
...
; GFX9-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX9-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX9-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX9-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX9-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX9-NEXT:    ret i32 [[RES]]
;
...
; GFX10-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX10-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX10-W32-NEXT:    [[TMP1:%.*]] = and i32 [[LO]], 55
...
; GFX10-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX10-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX10-W64-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX10-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX10-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX10-W64-NEXT:    ret i32 [[RES]]
;
...
; GFX11-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX11-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX11-W32-NEXT:    [[TMP1:%.*]] = and i32 [[LO]], 55
...
; GFX11-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX11-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX11-W64-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX11-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX11-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX11-W64-NEXT:    ret i32 [[RES]]
;
...
; GFX12-W32-SAME: i32 [[VAL:%.*]]) #[[ATTR0]] {
; GFX12-W32-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX12-W32-NEXT:    [[TMP1:%.*]] = and i32 [[LO]], 55
...
; GFX12-W64-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; GFX12-W64-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; GFX12-W64-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; GFX12-W64-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; GFX12-W64-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; GFX12-W64-NEXT:    ret i32 [[RES]]
;
...
; NO-INFO-CHECK-NEXT:    [[LO:%.*]] = tail call range(i32 0, 33) i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
; NO-INFO-CHECK-NEXT:    [[LID:%.*]] = tail call range(i32 0, 65) i32 @llvm.amdgcn.mbcnt.hi(i32 -1, i32 [[LO]])
; NO-INFO-CHECK-NEXT:    [[TMP1:%.*]] = and i32 [[LID]], 119
; NO-INFO-CHECK-NEXT:    [[IDX:%.*]] = xor i32 [[TMP1]], 7
; NO-INFO-CHECK-NEXT:    [[RES:%.*]] = tail call i32 @llvm.amdgcn.wave.shuffle.i32(i32 [[VAL]], i32 [[IDX]])
; NO-INFO-CHECK-NEXT:    ret i32 [[RES]]
;
