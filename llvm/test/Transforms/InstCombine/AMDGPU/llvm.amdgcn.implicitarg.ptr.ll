...
; RUN: opt -S -passes='instcombine' -mtriple=amdgpu-amd-amdhsa < %s | FileCheck %s --check-prefix=AMDHSA
; RUN: opt -S -passes='instcombine' -mtriple=amdgpu-mesa-mesa3d < %s | FileCheck %s --check-prefix=MESA
