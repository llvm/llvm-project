...
; CHECK-NEXT:    [[R:%.*]] = call <2 x float> @llvm.amdgcn.image.sample.1d.v2f32.f32.v8i32.v4i32(i32 3, float [[S:%.*]], <8 x i32> [[RSRC]], <4 x i32> [[SAMP:%.*]], i1 false, i32 0, i32 0)
; CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <2 x float> [[R]], <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
