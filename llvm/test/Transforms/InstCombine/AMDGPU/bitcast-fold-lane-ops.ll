...
; CHECK-SAME: float [[VAL:%.*]], ptr [[USE_PTR:%.*]]) {
...
; CHECK-SAME: float [[VAL:%.*]], i32 inreg [[LANE_INDEX:%.*]]) {
...
; CHECK-SAME: float [[VAL0:%.*]], i32 inreg [[LANE_INDEX:%.*]], float [[VAL1:%.*]]) {
...
; CHECK-SAME: float [[VAL0:%.*]], i32 inreg [[LANE_INDEX:%.*]], <2 x half> [[VAL1:%.*]]) {
; CHECK-NEXT:    [[BITCAST0:%.*]] = bitcast float [[VAL0]] to i32
...
; CHECK-SAME: float [[VAL0:%.*]], float [[VAL1:%.*]]) {
; CHECK-NEXT:    [[BITCAST0:%.*]] = bitcast float [[VAL0]] to i32
; CHECK-NEXT:    [[BITCAST1:%.*]] = bitcast float [[VAL1]] to i32
...
; CHECK-SAME: float [[VAL0:%.*]], float [[VAL1:%.*]]) #[[ATTR0:[0-9]+]] {
...
; CHECK-SAME: float [[VAL0:%.*]], <2 x half> [[VAL1:%.*]]) {
; CHECK-NEXT:    [[BITCAST0:%.*]] = bitcast float [[VAL0]] to i32
; CHECK-NEXT:    [[BITCAST1:%.*]] = bitcast <2 x half> [[VAL1]] to i32
; CHECK-NEXT:    [[TMP0:%.*]] = call i32 @llvm.amdgcn.update.dpp.i32(i32 [[BITCAST0]], i32 [[BITCAST1]], i32 1, i32 1, i32 1, i1 false)
; CHECK-NEXT:    ret i32 [[TMP0]]
