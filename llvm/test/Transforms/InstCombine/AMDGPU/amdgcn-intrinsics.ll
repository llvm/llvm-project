...
; RUN: opt -mtriple=amdgpu10.10-amd-amdhsa -passes=instcombine -S < %s | FileCheck %s
...
;
  %rsrc = call ptr addrspace(8) @llvm.amdgcn.make.buffer.rsrc.p8.p1.i64(ptr addrspace(1) poison, i16 0, i64 1234, i32 5678)
