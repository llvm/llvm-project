...
; CHECK-NEXT:    [[GEP1_SPLIT:%.*]] = getelementptr nuw [100 x [100 x i8]], ptr [[FOO:%.*]], i64 0, i64 [[J:%.*]]
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr nuw [100 x i8], ptr [[GEP1_SPLIT]], i64 0, i64 [[I:%.*]]
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr nuw i8, ptr [[FOO]], i64 4200
; CHECK-NEXT:    [[CAST1:%.*]] = ptrtoint ptr [[GEP1]] to i64
; CHECK-NEXT:    [[CAST2:%.*]] = ptrtoint ptr [[GEP2]] to i64
; CHECK-NEXT:    [[GEPDIFF:%.*]] = sub i64 [[CAST1]], [[CAST2]]
; CHECK-NEXT:    store ptr [[GEP1]], ptr @dummy_global1, align 8
...
; CHECK-LABEL: @test61(
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds nuw i8, ptr [[FOO:%.*]], i64 4200
; CHECK-NEXT:    [[GEP2_SPLIT:%.*]] = getelementptr inbounds [100 x [100 x i8]], ptr [[FOO]], i64 0, i64 [[J:%.*]]
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds [100 x i8], ptr [[GEP2_SPLIT]], i64 0, i64 [[I:%.*]]
; CHECK-NEXT:    [[CAST1:%.*]] = ptrtoint ptr [[GEP1]] to i64
; CHECK-NEXT:    [[CAST2:%.*]] = ptrtoint ptr [[GEP2]] to i64
; CHECK-NEXT:    [[GEPDIFF:%.*]] = sub i64 [[CAST1]], [[CAST2]]
; CHECK-NEXT:    store ptr [[GEP2]], ptr @dummy_global2, align 8
