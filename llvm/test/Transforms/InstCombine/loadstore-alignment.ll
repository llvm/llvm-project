...
; CHECK-NEXT:    [[T:%.*]] = getelementptr i8, ptr @x, i64 [[TMP2]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = mul nsw i64 [[TMP1]], 208
; CHECK-NEXT:    [[T_SPLIT:%.*]] = getelementptr i8, ptr @xx, i64 [[TMP3]]
; CHECK-NEXT:    [[TMP4:%.*]] = shl nsw i64 [[TMP2]], 4
; CHECK-NEXT:    [[T:%.*]] = getelementptr i8, ptr [[T_SPLIT]], i64 [[TMP4]]
; CHECK-NEXT:    [[L:%.*]] = load <2 x i64>, ptr [[T]], align 1
; CHECK-NEXT:    ret <2 x i64> [[L]]
;
