...
;
  %x = call float @llvm.minimum.f32(float f0x7FC00000, float 2.0)
  ret float %x
}
...
; CHECK-NEXT:    ret float +qnan
;
  %x = call float @llvm.minimum.f32(float 2.0, float f0x7FC00000)
  ret float %x
}
...
; CHECK-NEXT:    ret float +qnan
;
  %x = call float @llvm.minimum.f32(float f0x7FC00000, float f0x7FC00000)
  ret float %x
}
...
; CHECK-NEXT:    ret float +qnan
;
  %y = call float @llvm.minimum.f32(float f0x7FC00000, float %x)
  ret float %y
}
...
; CHECK-NEXT:    ret float +qnan
;
  %y = call float @llvm.minimum.f32(float %x, float f0x7FC00000)
  ret float %y
}
