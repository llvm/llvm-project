...
@h = addrspace(200) constant [2 x i8] c"h\00"
@h2 = addrspace(200) constant [3 x i8] c"%%\00"
@percent = addrspace(200) constant [2 x i8] c"%\00"
@percent_c = addrspace(200) constant [3 x i8] c"%c\00"
@percent_d = addrspace(200) constant [3 x i8] c"%d\00"
@percent_f = addrspace(200) constant [3 x i8] c"%f\00"
@percent_s = addrspace(200) constant [4 x i8] c"%s\0A\00"
@empty = addrspace(200) constant [1 x i8] c"\00"
