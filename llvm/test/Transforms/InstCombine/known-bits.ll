...
define <16 x i1> @icmp_ne_zext_shuffle_tree(<4 x i1> %x0, <4 x i1> %x1, <4 x i1> %x2, <4 x i1> %x3) {
; CHECK-LABEL: @icmp_ne_zext_shuffle_tree(
; CHECK-NEXT:    [[LO:%.*]] = shufflevector <4 x i1> [[X0:%.*]], <4 x i1> [[X1:%.*]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[HI:%.*]] = shufflevector <4 x i1> [[X2:%.*]], <4 x i1> [[X3:%.*]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[ALL:%.*]] = shufflevector <8 x i1> [[LO]], <8 x i1> [[HI]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    ret <16 x i1> [[ALL]]
;
  %x0.ext = zext <4 x i1> %x0 to <4 x i8>
  %x1.ext = zext <4 x i1> %x1 to <4 x i8>
  %x2.ext = zext <4 x i1> %x2 to <4 x i8>
  %x3.ext = zext <4 x i1> %x3 to <4 x i8>
  %lo = shufflevector <4 x i8> %x0.ext, <4 x i8> %x1.ext, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %hi = shufflevector <4 x i8> %x2.ext, <4 x i8> %x3.ext, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %all = shufflevector <8 x i8> %lo, <8 x i8> %hi, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %cmp = icmp ne <16 x i8> %all, zeroinitializer
  ret <16 x i1> %cmp
}

define <4 x i1> @icmp_ne_nonbool_shuffle(<2 x i8> %x, <2 x i8> %y) {
; CHECK-LABEL: @icmp_ne_nonbool_shuffle(
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x i8> [[X:%.*]], <2 x i8> [[Y:%.*]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[CMP:%.*]] = icmp ne <4 x i8> [[SHUFFLE]], zeroinitializer
; CHECK-NEXT:    ret <4 x i1> [[CMP]]
;
  %shuffle = shufflevector <2 x i8> %x, <2 x i8> %y, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %cmp = icmp ne <4 x i8> %shuffle, zeroinitializer
  ret <4 x i1> %cmp
}

define <4 x i1> @icmp_ne_pointer_shuffle(<2 x i1> %x, <2 x i1> %y) {
; CHECK-LABEL: @icmp_ne_pointer_shuffle(
; CHECK-NEXT:    [[TMP1:%.*]] = zext <2 x i1> [[X:%.*]] to <2 x i64>
; CHECK-NEXT:    [[X_PTR:%.*]] = inttoptr <2 x i64> [[TMP1]] to <2 x ptr>
; CHECK-NEXT:    [[TMP2:%.*]] = zext <2 x i1> [[Y:%.*]] to <2 x i64>
; CHECK-NEXT:    [[Y_PTR:%.*]] = inttoptr <2 x i64> [[TMP2]] to <2 x ptr>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x ptr> [[X_PTR]], <2 x ptr> [[Y_PTR]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[CMP:%.*]] = icmp ne <4 x ptr> [[SHUFFLE]], splat (ptr null)
; CHECK-NEXT:    ret <4 x i1> [[CMP]]
;
  %x.ptr = inttoptr <2 x i1> %x to <2 x ptr>
  %y.ptr = inttoptr <2 x i1> %y to <2 x ptr>
  %shuffle = shufflevector <2 x ptr> %x.ptr, <2 x ptr> %y.ptr, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %cmp = icmp ne <4 x ptr> %shuffle, zeroinitializer
  ret <4 x i1> %cmp
}

define <4 x i1> @icmp_eq_zext_shuffle(<2 x i1> %x, <2 x i1> %y) {
; CHECK-LABEL: @icmp_eq_zext_shuffle(
; CHECK-NEXT:    [[X_EXT:%.*]] = zext <2 x i1> [[X:%.*]] to <2 x i8>
; CHECK-NEXT:    [[Y_EXT:%.*]] = zext <2 x i1> [[Y:%.*]] to <2 x i8>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x i8> [[X_EXT]], <2 x i8> [[Y_EXT]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq <4 x i8> [[SHUFFLE]], zeroinitializer
; CHECK-NEXT:    ret <4 x i1> [[CMP]]
;
  %x.ext = zext <2 x i1> %x to <2 x i8>
  %y.ext = zext <2 x i1> %y to <2 x i8>
  %shuffle = shufflevector <2 x i8> %x.ext, <2 x i8> %y.ext, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %cmp = icmp eq <4 x i8> %shuffle, zeroinitializer
  ret <4 x i1> %cmp
}

define <4 x i1> @icmp_ne_zext_shuffle_multiuse(<2 x i1> %x, <2 x i1> %y) {
; CHECK-LABEL: @icmp_ne_zext_shuffle_multiuse(
; CHECK-NEXT:    [[X_EXT:%.*]] = zext <2 x i1> [[X:%.*]] to <2 x i8>
; CHECK-NEXT:    [[Y_EXT:%.*]] = zext <2 x i1> [[Y:%.*]] to <2 x i8>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x i8> [[X_EXT]], <2 x i8> [[Y_EXT]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    call void @use_v4i8(<4 x i8> [[SHUFFLE]])
; CHECK-NEXT:    [[CMP:%.*]] = icmp ne <4 x i8> [[SHUFFLE]], zeroinitializer
; CHECK-NEXT:    ret <4 x i1> [[CMP]]
;
  %x.ext = zext <2 x i1> %x to <2 x i8>
  %y.ext = zext <2 x i1> %y to <2 x i8>
  %shuffle = shufflevector <2 x i8> %x.ext, <2 x i8> %y.ext, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  call void @use_v4i8(<4 x i8> %shuffle)
  %cmp = icmp ne <4 x i8> %shuffle, zeroinitializer
  ret <4 x i1> %cmp
}
