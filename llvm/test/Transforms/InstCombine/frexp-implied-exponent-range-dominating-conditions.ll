...
define float @frexp_fcmp_ogt_1(float %x, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define float @frexp_fcmp_ogt_1(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
...
define float @frexp_fcmp_oge_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ugt_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_uge_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_olt_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ole_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ult_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ule_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_cmp_ugt_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_cmp_uge_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ult_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ule_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ugt_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_uge_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_oeq_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ueq_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_one_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_une_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_oeq_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ueq_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_one_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_une_0.5(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_true_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_false_1(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_ord_1(float %x, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define float @frexp_fcmp_ord_1(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
; CHECK-NEXT:    [[IS_ORD:%.*]] = fcmp ord float [[X]], 0.000000e+00
; CHECK-NEXT:    br i1 [[IS_ORD]], label %[[SMALL:.*]], label %[[LARGE:.*]]
; CHECK:       [[SMALL]]:
; CHECK-NEXT:    [[FREXP:%.*]] = call { float, i32 } @llvm.frexp.f32.i32(float [[X]])
; CHECK-NEXT:    [[EXP:%.*]] = extractvalue { float, i32 } [[FREXP]], 1
; CHECK-NEXT:    [[SCALED:%.*]] = call float @llvm.ldexp.f32.i32(float [[NOT_INF]], i32 [[EXP]])
...
define float @frexp_fcmp_uno_1(float %x, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define float @frexp_fcmp_uno_1(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
; CHECK-NEXT:    [[IS_UNO:%.*]] = fcmp uno float [[X]], 0.000000e+00
; CHECK-NEXT:    br i1 [[IS_UNO]], label %[[SMALL:.*]], label %[[LARGE:.*]]
; CHECK:       [[SMALL]]:
; CHECK-NEXT:    [[FREXP:%.*]] = call { float, i32 } @llvm.frexp.f32.i32(float [[X]])
; CHECK-NEXT:    [[EXP:%.*]] = extractvalue { float, i32 } [[FREXP]], 1
; CHECK-NEXT:    [[SCALED:%.*]] = call float @llvm.ldexp.f32.i32(float [[NOT_INF]], i32 [[EXP]])
...
; Negative test
define float @frexp_fcmp_ogt_nextafter1(float %x, float nofpclass(inf) %not.inf) {
...
; Negative test
define float @frexp_fcmp_ole_nextafter1(float %x, float nofpclass(inf) %not.inf) {
...
; Negative test
define float @frexp_fcmp_ogt_nextdown1(float %x, float nofpclass(inf) %not.inf) {
...
; Negative test
define float @frexp_fcmp_ole_nextdown1(float %x, float nofpclass(inf) %not.inf) {
...
; Negative test
define float @frexp_fcmp_ole_inf(float %x, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define float @frexp_fcmp_ole_inf(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
; CHECK-NEXT:    [[IS_SMALL:%.*]] = fcmp ord float [[X]], 0.000000e+00
; CHECK-NEXT:    br i1 [[IS_SMALL]], label %[[SMALL:.*]], label %[[LARGE:.*]]
; CHECK:       [[SMALL]]:
; CHECK-NEXT:    [[FREXP:%.*]] = call { float, i32 } @llvm.frexp.f32.i32(float [[X]])
; CHECK-NEXT:    [[EXP:%.*]] = extractvalue { float, i32 } [[FREXP]], 1
...
; Negative test
define float @frexp_fcmp_ole_nan(float %x, float nofpclass(inf) %not.inf) {
...
; Negative test
define float @frexp_fcmp_olt_1_not_dominated(float %x, float nofpclass(inf) %not.inf, i1 %arg) {
; CHECK-LABEL: define float @frexp_fcmp_olt_1_not_dominated(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]], i1 [[ARG:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
define float @frexp_fcmp_olt_1_multiple_conditions_wrong_constant(float %x, float nofpclass(inf) %not.inf) {
...
; Make sure the inner compare against 1 is recognized and doesn't
; abort the search after seeing the outer compare.
define float @frexp_fcmp_olt_1_multiple_conditions_nonfinite_constant(float %x, float nofpclass(inf) %not.inf) {
; CHECK-LABEL: define float @frexp_fcmp_olt_1_multiple_conditions_nonfinite_constant(
; CHECK-SAME: float [[X:%.*]], float nofpclass(inf) [[NOT_INF:%.*]]) {
; CHECK-NEXT:    [[X_FABS:%.*]] = call float @llvm.fabs.f32(float [[X]])
; CHECK-NEXT:    [[IS_SMALL:%.*]] = fcmp ueq float [[X_FABS]], +inf
; CHECK-NEXT:    br i1 [[IS_SMALL]], label %[[EXIT:.*]], label %[[SMALL:.*]]
; CHECK:       [[SMALL]]:
; CHECK-NEXT:    [[OTHER_COND:%.*]] = fcmp olt float [[X_FABS]], 1.000000e+00
; CHECK-NEXT:    br i1 [[OTHER_COND]], label %[[BODY:.*]], label %[[EXIT]]
; CHECK:       [[BODY]]:
...
define float @frexp_fcmp_olt_1_multiple_conditions_edge_case_compare(float %x, float nofpclass(inf) %not.inf) {
...
define float @frexp_fcmp_olt_1_multiple_conditions_other(float %x, float nofpclass(inf) %not.inf) {
