...
define i64 @test_simplify9(i1 %x) !prof !1 {
; CHECK-LABEL: @test_simplify9(
; CHECK-NEXT:    [[L:%.*]] = select i1 [[X:%.*]], i64 5, i64 6, !prof [[PROF2:![0-9]+]]
; CHECK-NEXT:    ret i64 [[L]]
;
  %s = select i1 %x, ptr @hello, ptr @longer, !prof !2
