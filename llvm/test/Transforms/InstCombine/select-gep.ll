...
; CHECK-NEXT:    [[SELECT_V1:%.*]] = shl nsw i64 [[SELECT_V]], 2
; CHECK-NEXT:    [[SELECT:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[SELECT_V1]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
...
; CHECK-NEXT:    [[SELECT_IDX:%.*]] = select i1 [[CMP]], i64 [[TMP1]], i64 0
; CHECK-NEXT:    [[SELECT:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[SELECT_IDX]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
...
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i64 [[X]], [[Y:%.*]]
; CHECK-NEXT:    [[SELECT_IDX:%.*]] = select i1 [[CMP]], i64 [[TMP1]], i64 0
; CHECK-NEXT:    [[SELECT:%.*]] = getelementptr nusw i8, ptr [[P:%.*]], i64 [[SELECT_IDX]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nuw i64 [[X:%.*]], 2
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i64 [[X]], [[Y:%.*]]
; CHECK-NEXT:    [[SELECT_IDX:%.*]] = select i1 [[CMP]], i64 [[TMP1]], i64 0
; CHECK-NEXT:    [[SELECT:%.*]] = getelementptr nuw i8, ptr [[P:%.*]], i64 [[SELECT_IDX]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[X:%.*]], 2
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i64 [[X]], [[Y:%.*]]
; CHECK-NEXT:    [[SELECT_IDX:%.*]] = select i1 [[CMP]], i64 0, i64 [[TMP1]]
; CHECK-NEXT:    [[SELECT:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[SELECT_IDX]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
  %gep = getelementptr inbounds i32, ptr %p, i64 %x
...
; CHECK-LABEL: @test2c(
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[X:%.*]], 2
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[TMP1]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[X:%.*]], 2
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds i8, ptr [[GEP1_SPLIT]], i64 [[TMP1]]
; CHECK-NEXT:    [[GEP2_SPLIT:%.*]] = getelementptr inbounds nuw i8, ptr [[P]], i64 32
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[Y:%.*]], 2
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds i8, ptr [[GEP2_SPLIT]], i64 [[TMP2]]
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i64 [[X]], [[Y]]
...
; CHECK-LABEL: @test3c(
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[X:%.*]], 4
; CHECK-NEXT:    [[GEP1_SPLIT:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds nuw i8, ptr [[GEP1_SPLIT]], i64 8
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[X]], 2
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds i8, ptr [[Q:%.*]], i64 [[TMP2]]
; CHECK-NEXT:    [[CMP:%.*]] = icmp ugt i64 [[X]], [[Y:%.*]]
; CHECK-NEXT:    [[SELECT:%.*]] = select i1 [[CMP]], ptr [[GEP1]], ptr [[GEP2]]
; CHECK-NEXT:    ret ptr [[SELECT]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[X:%.*]], 2
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[X]], 4
; CHECK-NEXT:    [[GEP2_SPLIT:%.*]] = getelementptr inbounds i8, ptr [[Q:%.*]], i64 [[TMP2]]
...
; CHECK-LABEL: @test5(
; CHECK-NEXT:    [[TMP1:%.*]] = shl <2 x i64> [[IDX:%.*]], splat (i64 3)
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr i8, ptr [[P1:%.*]], <2 x i64> [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl <2 x i64> [[IDX]], splat (i64 3)
; CHECK-NEXT:    [[GEP2:%.*]] = getelementptr i8, ptr [[P2:%.*]], <2 x i64> [[TMP2]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[Y:%.*]], 2
; CHECK-NEXT:    [[ICMP:%.*]] = icmp ugt i64 [[X]], [[Y]]
; CHECK-NEXT:    [[SEL_IDX:%.*]] = select i1 [[ICMP]], i64 [[TMP2]], i64 0
...
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i8, <2 x ptr> [[P1:%.*]], i64 [[TMP1]]
