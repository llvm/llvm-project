...
; CHECK-NEXT:    ret float [[RESULT]]
;
  %result = call float @llvm.maximumnum.f32(float %not.nan0, float %not.nan1), !unknown.md !0
  ret float %result
}
...
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximumnum.f32(float [[SELECT]], float [[UNKNOWN1]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %snan = call float @returns_snan()
  %select = select i1 %cond, float %snan, float %unknown0
  %result = call float @llvm.maximumnum.f32(float %select, float %unknown1)
  ret float %result
}
...
; CHECK-NEXT:    [[SNAN:%.*]] = call float @returns_snan()
; CHECK-NEXT:    [[SELECT:%.*]] = select i1 [[COND]], float [[SNAN]], float [[UNKNOWN0]]
; CHECK-NEXT:    [[RESULT:%.*]] = call float @llvm.maximumnum.f32(float [[UNKNOWN1]], float [[SELECT]])
; CHECK-NEXT:    ret float [[RESULT]]
;
  %snan = call float @returns_snan()
  %select = select i1 %cond, float %snan, float %unknown0
  %result = call float @llvm.maximumnum.f32(float %unknown1, float %select)
  ret float %result
}
