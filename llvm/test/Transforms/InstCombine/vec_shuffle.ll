...
; CHECK-LABEL: @test8(
; CHECK-NEXT:    [[T132:%.*]] = shufflevector <4 x float> [[X:%.*]], <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 3, i32 poison>
; CHECK-NEXT:    [[T134:%.*]] = shufflevector <4 x float> [[T132]], <4 x float> [[Y:%.*]], <4 x i32> <i32 0, i32 poison, i32 2, i32 4>
...
; CHECK-NEXT:    [[SPLAT1:%.*]] = shufflevector <2 x float> [[SPLAT]], <2 x float> poison, <2 x i32> <i32 0, i32 poison>
...
; CHECK-NEXT:    [[SHUF:%.*]] = insertelement <2 x i32> poison, i32 [[X:%.*]], i64 0
...
; CHECK-NEXT:    [[SEL:%.*]] = select <2 x i1> [[COND:%.*]], <2 x float> zeroinitializer, <2 x float> splat (float 1.000000e+00)
