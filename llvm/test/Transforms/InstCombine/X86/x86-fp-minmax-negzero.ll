...
;
entry:
  %r = call <4 x float> @llvm.x86.sse.max.ss(<4 x float> <float -0.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>, <4 x float> <float 1.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>)
  ret <4 x float> %r
}
...
;
entry:
  %r = call <4 x float> @llvm.x86.sse.max.ss(<4 x float> <float 1.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>, <4 x float> <float -0.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>)
  ret <4 x float> %r
}
...
;
entry:
  %r = call <4 x float> @llvm.x86.sse.min.ss(<4 x float> <float 1.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>, <4 x float> <float -0.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>)
  ret <4 x float> %r
}
...
;
entry:
  %r = call <4 x float> @llvm.x86.sse.min.ss(<4 x float> <float -0.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>, <4 x float> <float 1.0, float f0x7FC00000, float f0x7FC00000, float f0x7FC00000>)
  ret <4 x float> %r
}