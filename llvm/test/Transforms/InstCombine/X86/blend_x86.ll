...
; CHECK-CV-LABEL: @constant_blendvpd_nzero(
; CHECK-CV-NEXT:    ret <2 x double> [[AB:%.*]]
;
; CHECK-CI-LABEL: @constant_blendvpd_nzero(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <2 x double> @llvm.x86.sse41.blendvpd(<2 x double> [[XY:%.*]], <2 x double> [[AB:%.*]], <2 x double> splat (double -0.000000e+00))
...
; CHECK-CV-LABEL: @constant_blendvps_nzero(
; CHECK-CV-NEXT:    ret <4 x float> [[ABCD:%.*]]
;
; CHECK-CI-LABEL: @constant_blendvps_nzero(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <4 x float> @llvm.x86.sse41.blendvps(<4 x float> [[XYZW:%.*]], <4 x float> [[ABCD:%.*]], <4 x float> splat (float -0.000000e+00))
...
; CHECK-CV-LABEL: @constant_pblendvb_all_ones(
; CHECK-CV-NEXT:    ret <16 x i8> [[ABCD:%.*]]
;
; CHECK-CI-LABEL: @constant_pblendvb_all_ones(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <16 x i8> @llvm.x86.sse41.pblendvb(<16 x i8> [[XYZW:%.*]], <16 x i8> [[ABCD:%.*]], <16 x i8> splat (i8 -1))
...
; CHECK-CV-LABEL: @constant_blendvpd_avx_nzero(
; CHECK-CV-NEXT:    ret <4 x double> [[AB:%.*]]
;
; CHECK-CI-LABEL: @constant_blendvpd_avx_nzero(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <4 x double> @llvm.x86.avx.blendv.pd.256(<4 x double> [[XY:%.*]], <4 x double> [[AB:%.*]], <4 x double> splat (double -0.000000e+00))
...
; CHECK-CV-LABEL: @constant_blendvps_avx_nzero(
; CHECK-CV-NEXT:    ret <8 x float> [[ABCD:%.*]]
;
; CHECK-CI-LABEL: @constant_blendvps_avx_nzero(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <8 x float> @llvm.x86.avx.blendv.ps.256(<8 x float> [[XYZW:%.*]], <8 x float> [[ABCD:%.*]], <8 x float> splat (float -0.000000e+00))
...
; CHECK-CV-LABEL: @constant_pblendvb_avx2_all_ones(
; CHECK-CV-NEXT:    ret <32 x i8> [[ABCD:%.*]]
;
; CHECK-CI-LABEL: @constant_pblendvb_avx2_all_ones(
; CHECK-CI-NEXT:    [[TMP1:%.*]] = tail call <32 x i8> @llvm.x86.avx2.pblendvb(<32 x i8> [[XYZW:%.*]], <32 x i8> [[ABCD:%.*]], <32 x i8> splat (i8 -1))
