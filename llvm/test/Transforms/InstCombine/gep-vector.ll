...
; CHECK-NEXT:    ret <2 x ptr> getelementptr inbounds (i8, ptr @block, <2 x i64> <i64 8192, i64 16384>)
;
...
; CHECK-NEXT:    ret <2 x ptr> getelementptr inbounds (i8, ptr @block, <2 x i64> <i64 16383, i64 16385>)
;
...
; CHECK-NEXT:    ret <2 x ptr> getelementptr inbounds (i8, ptr @block, <2 x i64> <i64 8191, i64 16385>)
;
