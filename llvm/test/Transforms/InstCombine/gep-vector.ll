...
; CHECK-NEXT:    [[TMP1:%.*]] = mul i64 [[Y:%.*]], 28
; CHECK-NEXT:    [[GEP_SPLIT:%.*]] = getelementptr i8, ptr [[X:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[Z:%.*]], 2
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr i8, ptr [[GEP_SPLIT]], i64 [[TMP2]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = shl nsw i64 [[Y:%.*]], 4
; CHECK-NEXT:    [[GEP_SPLIT:%.*]] = getelementptr inbounds i8, ptr [[X:%.*]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[Z:%.*]], 2
; CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds i8, ptr [[GEP_SPLIT]], i64 [[TMP2]]
; CHECK-NEXT:    ret ptr [[GEP1]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = mul i64 [[Y:%.*]], 28
; CHECK-NEXT:    [[GEP_SPLIT:%.*]] = getelementptr i8, ptr addrspace(3) [[ASC]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl i64 [[Z:%.*]], 2
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr i8, ptr addrspace(3) [[GEP_SPLIT]], i64 [[TMP2]]
...
; CHECK-NEXT:    [[ASC:%.*]] = addrspacecast ptr [[X:%.*]] to ptr addrspace(3)
; CHECK-NEXT:    [[TMP1:%.*]] = mul nsw i64 [[Y:%.*]], 28
; CHECK-NEXT:    [[GEP_SPLIT:%.*]] = getelementptr inbounds i8, ptr addrspace(3) [[ASC]], i64 [[TMP1]]
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[Z:%.*]], 2
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds i8, ptr addrspace(3) [[GEP_SPLIT]], i64 [[TMP2]]
; CHECK-NEXT:    ret ptr addrspace(3) [[GEP]]
;
  %asc = addrspacecast ptr %x to ptr addrspace(3)
