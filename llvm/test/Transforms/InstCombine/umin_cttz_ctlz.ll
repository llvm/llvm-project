...
define i8 @umin_cttz_i8_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_cttz_i8_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
...
define i8 @umin_cttz_i8_commuted_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_cttz_i8_commuted_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = or i8 [[X]], 64
; CHECK-NEXT:    [[RET:%.*]] = call range(i8 0, 7) i8 @llvm.cttz.i8(i8 [[TMP1]], i1 true)
; CHECK-NEXT:    ret i8 [[RET]]
...
define i8 @umin_cttz_i8_negative_ge_bitwidth_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_cttz_i8_negative_ge_bitwidth_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
...
define i16 @umin_cttz_i16_zero_poisoned(i16 %X) {
; CHECK-LABEL: define i16 @umin_cttz_i16_zero_poisoned(
; CHECK-SAME: i16 [[X:%.*]]) {
...
define i32 @umin_cttz_i32_zero_poisoned(i32 %X) {
; CHECK-LABEL: define i32 @umin_cttz_i32_zero_poisoned(
; CHECK-SAME: i32 [[X:%.*]]) {
...
define i64 @umin_cttz_i64_zero_poisoned(i64 %X) {
; CHECK-LABEL: define i64 @umin_cttz_i64_zero_poisoned(
; CHECK-SAME: i64 [[X:%.*]]) {
...
define i1 @umin_cttz_i1_zero_poisoned(i1 %X) {
; CHECK-LABEL: define i1 @umin_cttz_i1_zero_poisoned(
; CHECK-SAME: i1 [[X:%.*]]) {
...
define <2 x i32> @umin_cttz_2xi32_splat_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_cttz_2xi32_splat_zero_poisoned(
...
define <2 x i32> @umin_cttz_2xi32_splat_poison_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_cttz_2xi32_splat_poison_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_cttz_2xi32_no_splat_all_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_cttz_2xi32_no_splat_all_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_cttz_2xi32_negative_no_splat_some_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_cttz_2xi32_negative_no_splat_some_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_cttz_2xi32_negative_no_splat_none_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_cttz_2xi32_negative_no_splat_none_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[RET:%.*]] = call range(i32 0, 33) <2 x i32> @llvm.cttz.v2i32(<2 x i32> [[X]], i1 true)
...
define i8 @umin_ctlz_i8_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_ctlz_i8_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
...
define i8 @umin_ctlz_i8_commuted_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_ctlz_i8_commuted_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = or i8 [[X]], 2
; CHECK-NEXT:    [[RET:%.*]] = call range(i8 0, 7) i8 @llvm.ctlz.i8(i8 [[TMP1]], i1 true)
; CHECK-NEXT:    ret i8 [[RET]]
...
define i8 @umin_ctlz_i8_negative_ge_bitwidth_zero_poisoned(i8 %X) {
; CHECK-LABEL: define i8 @umin_ctlz_i8_negative_ge_bitwidth_zero_poisoned(
; CHECK-SAME: i8 [[X:%.*]]) {
...
define i16 @umin_ctlz_i16_zero_poisoned(i16 %X) {
; CHECK-LABEL: define i16 @umin_ctlz_i16_zero_poisoned(
; CHECK-SAME: i16 [[X:%.*]]) {
...
define i32 @umin_ctlz_i32_zero_poisoned(i32 %X) {
; CHECK-LABEL: define i32 @umin_ctlz_i32_zero_poisoned(
; CHECK-SAME: i32 [[X:%.*]]) {
...
define i64 @umin_ctlz_i64_zero_poisoned(i64 %X) {
; CHECK-LABEL: define i64 @umin_ctlz_i64_zero_poisoned(
; CHECK-SAME: i64 [[X:%.*]]) {
...
define i1 @umin_ctlz_i1_zero_poisoned(i1 %X) {
; CHECK-LABEL: define i1 @umin_ctlz_i1_zero_poisoned(
; CHECK-SAME: i1 [[X:%.*]]) {
; CHECK-NEXT:    ret i1 false
;
...
define <2 x i32> @umin_ctlz_2xi32_splat_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_ctlz_2xi32_splat_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_ctlz_2xi32_splat_poison_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_ctlz_2xi32_splat_poison_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_ctlz_2xi32_no_splat_all_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_ctlz_2xi32_no_splat_all_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_ctlz_2xi32_negative_no_splat_some_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_ctlz_2xi32_negative_no_splat_some_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
...
define <2 x i32> @umin_ctlz_2xi32_negative_no_splat_none_lt_bitwidth_zero_poisoned(<2 x i32> %X) {
; CHECK-LABEL: define <2 x i32> @umin_ctlz_2xi32_negative_no_splat_none_lt_bitwidth_zero_poisoned(
; CHECK-SAME: <2 x i32> [[X:%.*]]) {
; CHECK-NEXT:    [[RET:%.*]] = call range(i32 0, 33) <2 x i32> @llvm.ctlz.v2i32(<2 x i32> [[X]], i1 true)
; CHECK-NEXT:    [[RET1:%.*]] = call <2 x i32> @llvm.umin.v2i32(<2 x i32> [[RET]], <2 x i32> <i32 32, i32 64>)
; CHECK-NEXT:    ret <2 x i32> [[RET1]]
...
define i32 @umin_cttz_i32_zero_poison(i32 %X, i32 %Y) {
; CHECK-LABEL: define i32 @umin_cttz_i32_zero_poison(
...
define i32 @umin_ctlz_i32_zero_poison(i32 %X, i32 %Y) {
; CHECK-LABEL: define i32 @umin_ctlz_i32_zero_poison(
; CHECK-SAME: i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = or i32 [[X]], [[Y]]
...
define i32 @neg_umin_cttz_ctlz_i32_zero_poison(i32 %X, i32 %Y) {
; CHECK-LABEL: define i32 @neg_umin_cttz_ctlz_i32_zero_poison(
; CHECK-SAME: i32 [[X:%.*]], i32 [[Y:%.*]]) {
