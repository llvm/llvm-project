...
declare ptr addrspace(1) @llvm.experimental.gc.get.pointer.base.p1(ptr addrspace(1) readnone nocapture) nounwind readnone willreturn
declare void @foo()
...
entry:
  ...
  %base = call ptr addrspace(1) @llvm.experimental.gc.get.pointer.base.p1(ptr addrspace(1) %selected)
  call void @foo()
