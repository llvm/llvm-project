...
; CHECK-NEXT:    [[BASE_RELOCATED2:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN1]], i32 0, i32 0)
...
; CHECK-NEXT:    [[BASE_RELOCATED4:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN3]], i32 0, i32 0)
; CHECK-NEXT:    br label [[MERGE]]
; CHECK:       merge:
...
; CHECK-NEXT:    [[BASE_RELOCATED6:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN5]], i32 0, i32 0)
...
; CHECK-NEXT:    [[BASE_RELOCATED5:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN4]], i32 0, i32 0)
...
; CHECK-NEXT:    [[BASE_RELOCATED7:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN6]], i32 0, i32 0)
; CHECK-NEXT:    br label [[MERGE:%.*]]
; CHECK:       there:
...
; CHECK-NEXT:    [[BASE_RELOCATED9:%.*]] = call ptr addrspace(1) @llvm.experimental.gc.relocate.p1(token [[STATEPOINT_TOKEN8]], i32 0, i32 0)
; CHECK-NEXT:    br label [[MERGE]]
; CHECK:       merge:
