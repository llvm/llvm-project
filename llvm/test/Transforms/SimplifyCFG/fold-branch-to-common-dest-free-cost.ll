...
; CHECK-LABEL: @f(
; CHECK-NEXT:    [[A1:%.*]] = call ptr @llvm.launder.invariant.group.p0(ptr [[A:%.*]])
; CHECK-NEXT:    [[B1:%.*]] = call ptr @llvm.launder.invariant.group.p0(ptr [[B:%.*]])
...
l1:
  %a1 = call ptr @llvm.launder.invariant.group.p0(ptr %a)
  %b1 = call ptr @llvm.launder.invariant.group.p0(ptr %b)
  %i = icmp eq ptr %a1, %b1
