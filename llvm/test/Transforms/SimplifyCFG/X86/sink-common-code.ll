...
; CHECK-LABEL: define zeroext i1 @test1(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define zeroext i1 @test2(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[NBLKS]], [[BLKSB]]
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]], ptr [[Y:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]], ptr [[Y:%.*]], ptr [[S:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[W:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[W:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
; CHECK-NEXT:    [[DUMMY:%.*]] = add i32 [[W]], 5
...
; CHECK-NEXT:    [[W:%.*]] = load volatile i32, ptr [[Y]], align 4
; CHECK-NEXT:    [[B:%.*]] = add i32 [[W]], [[DOT]]
; CHECK-NEXT:    store volatile i32 [[B]], ptr [[Y]], align 4, !tbaa [[FLOAT_TBAA4:![0-9]+]]
; CHECK-NEXT:    ret i32 1
;
entry:
  br i1 %flag, label %if.then, label %if.else
...
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[W:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]], ptr [[S:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define zeroext i1 @test_crash(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], ptr [[I4:%.*]], ptr [[M:%.*]], ptr [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define zeroext i1 @test16(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i1 zeroext [[FLAG2:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
; CHECK-NEXT:    [[CMP:%.*]] = icmp uge i32 [[BLKSA]], [[NBLKS]]
...
; CHECK-LABEL: define zeroext i1 @test16a(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i1 zeroext [[FLAG2:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]], ptr [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
; CHECK-NEXT:    [[CMP:%.*]] = icmp uge i32 [[BLKSA]], [[NBLKS]]
...
; CHECK-LABEL: define zeroext i1 @test17(
; CHECK-SAME: i32 [[FLAG:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define zeroext i1 @test18(
; CHECK-SAME: i32 [[FLAG:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i32 @test_pr30188(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i32 @test_pr30188a(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[Y:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[Z:%.*]] = alloca i32, align 4
...
; CHECK-LABEL: define void @test_pr30292(
; CHECK-SAME: i1 [[COND:%.*]], i1 [[COND2:%.*]], i32 [[A:%.*]], i32 [[B:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define zeroext i1 @test_pr30244(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i1 zeroext [[FLAG2:%.*]], i32 [[BLKSA:%.*]], i32 [[BLKSB:%.*]], i32 [[NBLKS:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define i32 @test_pr30373a(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[X_Y:%.*]] = select i1 [[FLAG]], i32 [[X]], i32 [[Y]]
...
; CHECK-LABEL: define i32 @test_pr30373b(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[X_Y:%.*]] = select i1 [[FLAG]], i32 [[X]], i32 [[Y]]
; CHECK-NEXT:    [[X1:%.*]] = call i32 @foo(i32 [[X_Y]], i32 0) #[[ATTR0]]
...
; CHECK-LABEL: define float @allow_intrinsic_remove_constant(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], float [[W:%.*]], float [[X:%.*]], float [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define i32 @no_remove_constant_immarg(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[W:%.*]], i32 [[X:%.*]], i32 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define void @no_replace_memcpy_size(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], ptr addrspace(1) [[DST:%.*]], ptr addrspace(1) [[SRC:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define void @no_replace_memmove_size(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], ptr addrspace(1) [[DST:%.*]], ptr addrspace(1) [[SRC:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define void @no_replace_memset_size(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], ptr addrspace(1) [[DST:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    br i1 [[FLAG]], label %[[IF_THEN:.*]], label %[[IF_ELSE:.*]]
; CHECK:       [[IF_THEN]]:
...
; CHECK-LABEL: define i32 @test_inline_asm1(
; CHECK-SAME: i32 [[C:%.*]], i32 [[R6:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define void @test_operand_bundles(
...
; CHECK-LABEL: define i32 @test_insertvalue(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], [[TP:%.*]] [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define void @test_sink_void_calls(
; CHECK-SAME: i32 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define i32 @test_not_sink_lifetime_marker(
; CHECK-SAME: i1 zeroext [[FLAG:%.*]], i32 [[X:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[Y:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[Z:%.*]] = alloca i32, align 4
...
; CHECK-LABEL: define void @direct_caller(
; CHECK-SAME: i1 [[C:%.*]]) {
...
; CHECK-LABEL: define void @indirect_caller(
; CHECK-SAME: i1 [[C:%.*]], i32 [[V:%.*]], ptr [[FOO:%.*]], ptr [[BAR:%.*]]) {
; CHECK-NEXT:  [[END:.*:]]
...
; CHECK-LABEL: define void @maybe_indirect_caller(
; CHECK-SAME: ptr [[FUN:%.*]]) {
...
; CHECK-LABEL: define void @maybe_indirect_caller2(
; CHECK-SAME: ptr [[FUN:%.*]]) {
; CHECK-NEXT:    [[C:%.*]] = icmp eq ptr [[FUN]], @direct_callee
; CHECK-NEXT:    br i1 [[C]], label %[[IF_TRUE_DIRECT_TARG:.*]], label %[[IF_FALSE_ORIG_INDIRECT:.*]]
; CHECK:       [[IF_FALSE_ORIG_INDIRECT]]:
...
; CHECK-LABEL: define void @creating_too_many_phis(
; CHECK-SAME: i1 [[COND:%.*]], i32 [[A:%.*]], i32 [[B:%.*]], i32 [[C:%.*]], i32 [[D:%.*]], i32 [[E:%.*]], i32 [[F:%.*]], i32 [[G:%.*]], i32 [[H:%.*]]) {
...
; CHECK-LABEL: define void @multiple_cond_preds(
...
; CHECK-LABEL: define void @nontemporal(
...
; CHECK-LABEL: define void @nontemporal_mismatch(
; CHECK-SAME: ptr [[PTR:%.*]], i1 [[COND:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-LABEL: define void @loop_use_in_different_bb(
; CHECK-SAME: i32 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define void @loop_use_in_different_bb_phi(
; CHECK-SAME: i32 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[N]], 1
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
...
; CHECK-LABEL: define void @loop_use_in_wrong_phi_operand(
; CHECK-SAME: i32 [[N:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[N]], 1
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
...
; CHECK-LABEL: define ptr @multi_use_in_phi(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
...
; CHECK-LABEL: define ptr @multi_use_in_phi_inconsistent(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
...
; CHECK-LABEL: define i64 @multi_use_in_block(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[JOIN:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i64 @multi_use_in_block_inconsistent(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i64 @load_with_sunk_gep(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[JOIN:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i64 @load_with_non_sunk_gep_both(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P_A:%.*]], ptr [[P_B:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i64 @load_with_non_sunk_gep_left(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P_A:%.*]], ptr [[P_B:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i64 @load_with_non_sunk_gep_right(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P_A:%.*]], ptr [[P_B:%.*]], i64 [[A:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
; CHECK-NEXT:    [[GEP_A:%.*]] = getelementptr i8, ptr [[P_A]], i64 [[A]]
...
; CHECK-LABEL: define void @store_with_non_sunk_gep(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P_A:%.*]], ptr [[P_B:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define void @store_with_non_sunk_gep_as_value(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], ptr [[P_A:%.*]], ptr [[P_B:%.*]], i64 [[A:%.*]], i64 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
; CHECK-NEXT:    [[GEP_A:%.*]] = getelementptr i8, ptr [[P_A]], i64 [[A]]
...
; CHECK-LABEL: define i32 @many_indirect_phis(
...
; CHECK-LABEL: define i32 @store_and_unrelated_many_phi_add(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i32 [[A:%.*]], i32 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i32 @store_and_related_many_phi_add(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i32 [[A:%.*]], i32 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK-LABEL: define i32 @store_and_unrelated_many_phi_add2(
; CHECK-SAME: i1 [[COND:%.*]], ptr [[P:%.*]], i32 [[A:%.*]], i32 [[B:%.*]]) {
; CHECK-NEXT:    br i1 [[COND]], label %[[IF:.*]], label %[[ELSE:.*]]
; CHECK:       [[IF]]:
; CHECK-NEXT:    call void @dummy()
...
; CHECK: [[META5]] = !{!"float", [[META6:![0-9]+]]}
; CHECK: [[META6]] = !{!"an example type tree"}
; CHECK: [[META7]] = !{i32 1}
;.
