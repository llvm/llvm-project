...
; If range is preserved, hoisting br will result in UB.
...
; If nonnull is preserved, calling @foo will result in UB.
...
; If align is preserved, calling @foo will result in UB.
