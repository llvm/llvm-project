...
; CHECK-NEXT:    [[OR01234567:%.*]] = and <8 x i1> [[OR01]], [[XOR7]]
; CHECK-NEXT:    ret <8 x i1> [[OR01234567]]
;
...
; CHECK-NEXT:    [[OR123:%.*]] = or <8 x i1> [[OR01]], [[B4]]
; CHECK-NEXT:    [[OR7:%.*]] = or <8 x i1> [[OR123]], [[XOR3]]
...
; CHECK-NEXT:    [[OR0123:%.*]] = or <8 x i1> [[OR4567]], [[XOR7]]
; CHECK-NEXT:    ret <8 x i1> [[OR0123]]
;
  %xor0 = xor <8 x i1> %b0, %a
  %xor1 = xor <8 x i1> %b1, %a
