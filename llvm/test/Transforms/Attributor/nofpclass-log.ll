...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nzero sub) float @llvm.log.f32(float nofpclass(nan) [[ARG]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.log.f32(float %arg)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf nzero sub) float @llvm.log.f32(float nofpclass(nan inf) [[ARG]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.log.f32(float %arg)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(inf nzero sub) float @llvm.log.f32(float nofpclass(nan inf zero) [[ARG]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.log.f32(float %arg)
  ret float %call
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(nzero sub) float @llvm.log.f32(float [[UNKNOWN_SIGN_NOT_NAN]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-NEXT:    [[VAL:%.*]] = call nofpclass(nzero sub) float @llvm.experimental.constrained.log.f32(float nofpclass(nan) [[ARG]], metadata !"round.dynamic", metadata !"fpexcept.strict") #[[ATTR13]]
; CHECK-NEXT:    ret float [[VAL]]
;
  %val = call float @llvm.experimental.constrained.log.f32(float %arg, metadata !"round.dynamic", metadata !"fpexcept.strict")
  ret float %val
...
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf nzero sub) float @llvm.log2.f32(float nofpclass(snan inf nsub nnorm) [[ARG]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
  %call = call float @llvm.log2.f32(float %arg)
  ret float %call
...
; CHECK-LABEL: define nofpclass(pinf nzero sub) float @ret_log_negsubnormal_mode_dynamic_dynamic
; CHECK-SAME: (float nofpclass(nan inf zero psub norm) [[ARG0:%.*]]) #[[ATTR10:[0-9]+]] {
; CHECK-NEXT:    [[CALL:%.*]] = call nofpclass(pinf nzero sub) float @llvm.log.f32(float nofpclass(nan inf zero psub norm) [[ARG0]]) #[[ATTR12]]
; CHECK-NEXT:    ret float [[CALL]]
;
...
; CHECK-LABEL: define nofpclass(pinf nzero sub) float @ret_log_negsubnormal_mode_ftpz_dapz
