...
;
  %not.nan = fcmp ord float %arg, 0.0
  %select = select i1 %not.nan, float f0x7FC00000, float %arg
  ret float %select
}
...
;
  %fabs = call float @llvm.fabs.f32(float %arg)
  %is.inf = fcmp oeq float %fabs, +inf
  %select = select i1 %is.inf, float f0x7FC00000, float %arg
  ret float %select
}
...
;
  ...
  %select = select i1 %is.subnormal.or.inf, float f0x7FC00000, float %arg
  ret float %select
}
...
;
  ...
  %select = select i1 %not.is.subnormal.or.inf, float %arg, float f0x7FC00000
  ret float %select
}
