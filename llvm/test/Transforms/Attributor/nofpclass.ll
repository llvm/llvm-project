...
; CHECK-NEXT:    ret float [[EXTRACT]]
;
  %shuffle = shufflevector <3 x float> <float 1.0, float f0x7FC00000, float 0.0>, <3 x float> poison, <2 x i32> <i32 0, i32 2>
...
;
  ret [2 x float] [float f0x7FC00000, float f0x7FC00000]
}
...
;
  ret { float, float } { float f0x7FC00000, float f0x7FC00000 }
}
...
;
  ret { float, { float, float } } { float f0x7FC00000, { float, float } { float f0x7FC00000, float f0x7FC00000 } }
}
...
;
  ret { float, double } { float f0x7FC00000, double 0x7FF8000000000000 }
}
...
;
  ret { float, [2 x float] } { float f0x7FC00000, [2 x float] [float f0x7FC00000, float f0x7FC00000] }
}
