...
define float @ret_canonicalize_dynamic_denormal(float nofpclass(inf) %arg0) denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_daz_constant_pos_denormal() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_neg_denormal() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_pos_zero() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_neg_zero() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_pos_normal() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_neg_normal() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_pos_inf() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_neg_inf() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_qnan() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_constant_snan() denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_dynamic_constant_pos_denormal() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_neg_denormal() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_pos_zero() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_neg_zero() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_pos_normal() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_neg_normal() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_pos_inf() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_neg_inf() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_qnan() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_dynamic_constant_snan() denormal_fpenv(dynamic,dynamic) {
...
define float @ret_canonicalize_daz_not_nzero_not_nsub(float nofpclass(nzero nsub) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_nsub(float nofpclass(nsub) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_nzero(float nofpclass(nzero) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_pzero_not_psub(float nofpclass(pzero psub) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_psub(float nofpclass(psub) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_pzero(float nofpclass(pzero) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_zero(float nofpclass(zero) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_sub(float nofpclass(sub) %x) denormal_fpenv(preservesign,preservesign) {
...
define float @ret_canonicalize_daz_not_sub_not_nzero(float nofpclass(sub nzero) %x) denormal_fpenv(preservesign,preservesign) {
