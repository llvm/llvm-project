...
; TUNIT-NEXT:    [[CALL:%.*]] = call i16 @bar(i16 [[A]])
; TUNIT-NEXT:    ret i16 [[CALL]]
;
; CGSCC: Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
; CGSCC-LABEL: define {{[^@]+}}@foo
; CGSCC-SAME: (i16 [[A:%.*]]) #[[ATTR0:[0-9]+]] {
; CGSCC-NEXT:    [[CALL:%.*]] = call noundef i16 @bar()
...
; TUNIT-LABEL: define {{[^@]+}}@vararg_no_prop
; TUNIT-SAME: (i16 [[P1:%.*]], i16 [[P2:%.*]], ...) {
; TUNIT-NEXT:    ret i16 [[P1]]
;
; CGSCC: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
...
; CGSCC: attributes #[[ATTR2]] = { nosync nounwind memory(none) }
;.
