...
define float @fadd_no_nan(float nofpclass(nan) %arg0, float nofpclass(nan) %arg1) {
; CHECK-LABEL: define nofpclass(snan) float @fadd_no_nan(
...
define float @fadd_no_snan(float nofpclass(snan) %arg0, float nofpclass(snan) %arg1) {
; CHECK-LABEL: define nofpclass(snan) float @fadd_no_snan(
...
define float @fadd_lhs_no_snan(float nofpclass(snan) %arg0, float %arg1) {
; CHECK-LABEL: define float @fadd_lhs_no_snan(
...
define float @fadd_rhs_no_snan(float %arg0, float nofpclass(snan) %arg1) {
; CHECK-LABEL: define float @fadd_rhs_no_snan(
...
; CHECK-NEXT:    ret float [[ADD]]
;
  %add = fadd float %arg0, %arg0
  ret float %add
}

define float @fadd_self_no_snan(float noundef nofpclass(snan) %arg0) {
; CHECK-LABEL: define noundef nofpclass(snan) float @fadd_self_no_snan(
; CHECK-SAME: float noundef nofpclass(snan) [[ARG0:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[ADD:%.*]] = fadd float [[ARG0]], [[ARG0]]
; CHECK-NEXT:    ret float [[ADD]]
;
  %add = fadd float %arg0, %arg0
...
define float @fadd_self_no_qnan(float noundef nofpclass(qnan) %arg0) {
; CHECK-LABEL: define noundef float @fadd_self_no_qnan(
; CHECK-SAME: float noundef nofpclass(qnan) [[ARG0:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[ADD:%.*]] = fadd float [[ARG0]], [[ARG0]]
; CHECK-NEXT:    ret float [[ADD]]
;
  %add = fadd float %arg0, %arg0
...
define float @fsub_no_nan(float nofpclass(nan) %arg0, float nofpclass(nan) %arg1) {
; CHECK-LABEL: define nofpclass(snan) float @fsub_no_nan(
; CHECK-SAME: float nofpclass(nan) [[ARG0:%.*]], float nofpclass(nan) [[ARG1:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG1]]
; CHECK-NEXT:    ret float [[SUB]]
;
  %sub = fsub float %arg0, %arg1
  ret float %sub
}

define float @fsub_no_snan(float nofpclass(snan) %arg0, float nofpclass(snan) %arg1) {
; CHECK-LABEL: define nofpclass(snan) float @fsub_no_snan(
; CHECK-SAME: float nofpclass(snan) [[ARG0:%.*]], float nofpclass(snan) [[ARG1:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG1]]
; CHECK-NEXT:    ret float [[SUB]]
;
...
define float @fsub_lhs_no_snan(float nofpclass(snan) %arg0, float %arg1) {
; CHECK-LABEL: define float @fsub_lhs_no_snan(
; CHECK-SAME: float nofpclass(snan) [[ARG0:%.*]], float [[ARG1:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG1]]
; CHECK-NEXT:    ret float [[SUB]]
;
...
define float @fsub_rhs_no_snan(float %arg0, float nofpclass(snan) %arg1) {
; CHECK-LABEL: define float @fsub_rhs_no_snan(
; CHECK-SAME: float [[ARG0:%.*]], float nofpclass(snan) [[ARG1:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG1]]
; CHECK-NEXT:    ret float [[SUB]]
;
...
define float @fsub_self_no_nan(float noundef nofpclass(nan) %arg0) {
; CHECK-LABEL: define noundef nofpclass(snan) float @fsub_self_no_nan(
; CHECK-SAME: float noundef nofpclass(nan) [[ARG0:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG0]]
; CHECK-NEXT:    ret float [[SUB]]
;
  %sub = fsub float %arg0, %arg0
  ret float %sub
}

define float @fsub_self_no_snan(float noundef nofpclass(snan) %arg0) {
; CHECK-LABEL: define noundef nofpclass(snan) float @fsub_self_no_snan(
; CHECK-SAME: float noundef nofpclass(snan) [[ARG0:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG0]]
; CHECK-NEXT:    ret float [[SUB]]
;
...
define float @fsub_self_no_qnan(float noundef nofpclass(qnan) %arg0) {
; CHECK-LABEL: define noundef float @fsub_self_no_qnan(
; CHECK-SAME: float noundef nofpclass(qnan) [[ARG0:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[ARG0]], [[ARG0]]
; CHECK-NEXT:    ret float [[SUB]]
;
...
define float @fadd_p0_ftpz_ieee(float %arg0) #4 {
; CHECK-LABEL: define nofpclass(nzero) float @fadd_p0_ftpz_ieee(
...
define float @fsub_n0_commute_ieee_daz(float %arg0) #2 {
...
define float @fsub_n0_commute_ftz_ieee(float %arg0) #1 {
; CHECK-LABEL: define float @fsub_n0_commute_ftz_ieee(
...
; CHECK-LABEL: define nofpclass(snan) float @test_fadd_may_nan_from_no_pinf_no_ninf(
...
; CHECK-LABEL: define nofpclass(snan) float @test_fadd_may_nan_from_no_ninf_no_pinf(
...
define float @fadd_double_no_nzero_ftpz_dapz(float noundef nofpclass(nzero) %arg) #3 {
; CHECK-LABEL: define noundef nofpclass(nzero) float @fadd_double_no_nzero_ftpz_dapz(
...
define float @fadd_double_no_nzero_ftpz_ieee(float noundef nofpclass(nzero) %arg) #4 {
; CHECK-LABEL: define noundef nofpclass(nzero) float @fadd_double_no_nzero_ftpz_ieee(
...
; CHECK-SAME: float nofpclass(nan inf pzero sub norm) [[LHS:%.*]], float nofpclass(nan inf zero nsub norm) [[RHS:%.*]]) #[[ATTR10:[0-9]+]] {
; CHECK-NEXT:    [[SUB:%.*]] = fsub float [[LHS]], [[RHS]]
; CHECK-NEXT:    ret float [[SUB]]
;
  %sub = fsub float %lhs, %rhs
