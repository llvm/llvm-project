...
; IS__TUNIT____-NEXT:    [[CMP_EQ_1:%.*]] = icmp eq i32 [[RET]], 10
...
; IS__TUNIT____-NEXT:    [[CMP_EQ_6:%.*]] = icmp eq i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_EQ_1]], i1 [[CMP_EQ_2]], i1 [[CMP_EQ_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_EQ_4]], i1 [[CMP_EQ_5]], i1 [[CMP_EQ_6]])
; IS__TUNIT____-NEXT:    [[CMP_NE_1:%.*]] = icmp ne i32 [[RET]], 10
...
; IS__TUNIT____-NEXT:    [[CMP_NE_6:%.*]] = icmp ne i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_NE_1]], i1 [[CMP_NE_2]], i1 [[CMP_NE_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_NE_4]], i1 [[CMP_NE_5]], i1 [[CMP_NE_6]])
; IS__TUNIT____-NEXT:    [[CMP_UGT_1:%.*]] = icmp ugt i32 [[RET]], 10
; IS__TUNIT____-NEXT:    [[CMP_UGT_2:%.*]] = icmp ugt i32 [[RET]], 9
...
; IS__TUNIT____-NEXT:    [[CMP_UGT_6:%.*]] = icmp ugt i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_UGT_1]], i1 [[CMP_UGT_2]], i1 [[CMP_UGT_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_UGT_4]], i1 [[CMP_UGT_5]], i1 [[CMP_UGT_6]])
; IS__TUNIT____-NEXT:    [[CMP_UGE_1:%.*]] = icmp uge i32 [[RET]], 10
...
; IS__TUNIT____-NEXT:    [[CMP_UGE_5:%.*]] = icmp uge i32 [[RET]], 0
; IS__TUNIT____-NEXT:    [[CMP_UGE_6:%.*]] = icmp uge i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_UGE_1]], i1 [[CMP_UGE_2]], i1 [[CMP_UGE_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_UGE_4]], i1 [[CMP_UGE_5]], i1 [[CMP_UGE_6]])
; IS__TUNIT____-NEXT:    [[CMP_SGT_1:%.*]] = icmp sgt i32 [[RET]], 10
; IS__TUNIT____-NEXT:    [[CMP_SGT_2:%.*]] = icmp sgt i32 [[RET]], 9
...
; IS__TUNIT____-NEXT:    [[CMP_SGT_6:%.*]] = icmp sgt i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_SGT_1]], i1 [[CMP_SGT_2]], i1 [[CMP_SGT_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_SGT_4]], i1 [[CMP_SGT_5]], i1 [[CMP_SGT_6]])
; IS__TUNIT____-NEXT:    [[CMP_GTE_1:%.*]] = icmp sge i32 [[RET]], 10
...
; IS__TUNIT____-NEXT:    [[CMP_GTE_5:%.*]] = icmp sge i32 [[RET]], 0
; IS__TUNIT____-NEXT:    [[CMP_GTE_6:%.*]] = icmp sge i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_GTE_1]], i1 [[CMP_GTE_2]], i1 [[CMP_GTE_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_GTE_4]], i1 [[CMP_GTE_5]], i1 [[CMP_GTE_6]])
; IS__TUNIT____-NEXT:    [[CMP_SLT_1:%.*]] = icmp slt i32 [[RET]], 10
...
; IS__TUNIT____-NEXT:    [[CMP_SLT_5:%.*]] = icmp slt i32 [[RET]], 0
; IS__TUNIT____-NEXT:    [[CMP_SLT_6:%.*]] = icmp slt i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_SLT_1]], i1 [[CMP_SLT_2]], i1 [[CMP_SLT_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_SLT_4]], i1 [[CMP_SLT_5]], i1 [[CMP_SLT_6]])
; IS__TUNIT____-NEXT:    [[CMP_LTE_1:%.*]] = icmp sle i32 [[RET]], 10
; IS__TUNIT____-NEXT:    [[CMP_LTE_2:%.*]] = icmp sle i32 [[RET]], 9
...
; IS__TUNIT____-NEXT:    [[CMP_LTE_6:%.*]] = icmp sle i32 [[RET]], -1
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_LTE_1]], i1 [[CMP_LTE_2]], i1 [[CMP_LTE_3]])
; IS__TUNIT____-NEXT:    tail call void @use3(i1 [[CMP_LTE_4]], i1 [[CMP_LTE_5]], i1 [[CMP_LTE_6]])
...
; IS__CGSCC____-NEXT:    [[CMP_UGT_6:%.*]] = icmp ugt i32 [[RET]], -1
; IS__CGSCC____-NEXT:    tail call void @use3(i1 [[CMP_UGT_1]], i1 [[CMP_UGT_2]], i1 [[CMP_UGT_3]])
; IS__CGSCC____-NEXT:    tail call void @use3(i1 [[CMP_UGT_4]], i1 [[CMP_UGT_5]], i1 [[CMP_UGT_6]])
...
; IS__CGSCC____-NEXT:    [[CMP_UGE_5:%.*]] = icmp uge i32 [[RET]], 0
...
; IS__CGSCC____-NEXT:    tail call void @use3(i1 [[CMP_UGE_4]], i1 [[CMP_UGE_5]], i1 [[CMP_UGE_6]])
...
; IS__TUNIT____-NEXT:    [[CALL:%.*]] = tail call i32 @test2(i32* nocapture nofree readonly align 4 [[P]]) #[[ATTR3]]
; IS__TUNIT____-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CALL]], 5
...
; IS__TUNIT____-NEXT:    [[RETVAL_0:%.*]] = phi i32 [ 2, [[IF_THEN]] ], [ 3, [[IF_END]] ]
...
; IS__TUNIT_NPM-LABEL: define {{[^@]+}}@r1
; IS__TUNIT_NPM-SAME: () local_unnamed_addr #[[ATTR1:[0-9]+]] {
; IS__TUNIT_NPM-NEXT:    br label [[TMP4:%.*]]
; IS__TUNIT_NPM:       1:
; IS__TUNIT_NPM-NEXT:    [[TMP2:%.*]] = icmp sgt i32 [[TMP7:%.*]], 10000
; IS__TUNIT_NPM-NEXT:    br i1 [[TMP2]], label [[TMP3:%.*]], label [[F:%.*]]
; IS__TUNIT_NPM:       3:
; IS__TUNIT_NPM-NEXT:    ret i32 20
; IS__TUNIT_NPM:       f:
; IS__TUNIT_NPM-NEXT:    ret i32 10
; IS__TUNIT_NPM:       4:
; IS__TUNIT_NPM-NEXT:    [[TMP5:%.*]] = phi i32 [ 0, [[TMP0:%.*]] ], [ [[TMP8:%.*]], [[TMP4]] ]
; IS__TUNIT_NPM-NEXT:    [[TMP6:%.*]] = phi i32 [ 0, [[TMP0]] ], [ [[TMP7]], [[TMP4]] ]
; IS__TUNIT_NPM-NEXT:    [[TMP7]] = add nuw nsw i32 [[TMP5]], [[TMP6]]
; IS__TUNIT_NPM-NEXT:    [[TMP8]] = add nuw nsw i32 [[TMP5]], 1
; IS__TUNIT_NPM-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], 100
; IS__TUNIT_NPM-NEXT:    br i1 [[TMP9]], label [[TMP1:%.*]], label [[TMP4]]
;
...
; IS__CGSCC_NPM:       1:
; IS__CGSCC_NPM-NEXT:    [[TMP2:%.*]] = icmp sgt i32 [[TMP7:%.*]], 10000
; IS__CGSCC_NPM-NEXT:    br i1 [[TMP2]], label [[TMP3:%.*]], label [[F:%.*]]
; IS__CGSCC_NPM:       3:
; IS__CGSCC_NPM-NEXT:    ret i32 20
; IS__CGSCC_NPM:       f:
; IS__CGSCC_NPM-NEXT:    ret i32 10
; IS__CGSCC_NPM:       4:
; IS__CGSCC_NPM-NEXT:    [[TMP5:%.*]] = phi i32 [ 0, [[TMP0:%.*]] ], [ [[TMP8:%.*]], [[TMP4]] ]
; IS__CGSCC_NPM-NEXT:    [[TMP6:%.*]] = phi i32 [ 0, [[TMP0]] ], [ [[TMP7]], [[TMP4]] ]
; IS__CGSCC_NPM-NEXT:    [[TMP7]] = add nuw nsw i32 [[TMP5]], [[TMP6]]
; IS__CGSCC_NPM-NEXT:    [[TMP8]] = add nuw nsw i32 [[TMP5]], 1
; IS__CGSCC_NPM-NEXT:    [[TMP9:%.*]] = icmp eq i32 [[TMP8]], 100
; IS__CGSCC_NPM-NEXT:    br i1 [[TMP9]], label [[TMP1:%.*]], label [[TMP4]]
;
  br label %5
...
; IS__TUNIT____-SAME: (i32 [[TMP0:%.*]]) {
; IS__TUNIT____-NEXT:    [[TMP2:%.*]] = tail call i32 @r1() #[[ATTR4:[0-9]+]]
; IS__TUNIT____-NEXT:    [[TMP3:%.*]] = icmp sgt i32 [[TMP2]], 15
; IS__TUNIT____-NEXT:    br i1 [[TMP3]], label [[TMP4:%.*]], label [[TMP5:%.*]]
; IS__TUNIT____:       4:
; IS__TUNIT____-NEXT:    tail call void @unkown()
...
; IS__TUNIT_NPM-SAME: (i32 [[U:%.*]]) #[[ATTR1]] {
; IS__TUNIT_NPM-NEXT:  entry:
; IS__TUNIT_NPM-NEXT:    [[CALL:%.*]] = tail call i32 @test4-f1(i32 [[U]]) #[[ATTR4]]
...
; IS__TUNIT_OPM-NEXT:    br label [[BB3]]
; IS__TUNIT_OPM:       bb3:
; IS__TUNIT_OPM-NEXT:    [[DOT02:%.*]] = phi i32 [ 1, [[BB1]] ], [ 2, [[BB2]] ]
; IS__TUNIT_OPM-NEXT:    [[TMP4:%.*]] = icmp sgt i32 [[ARG]], 10
; IS__TUNIT_OPM-NEXT:    br i1 [[TMP4]], label [[BB5:%.*]], label [[BB7:%.*]]
; IS__TUNIT_OPM:       bb5:
; IS__TUNIT_OPM-NEXT:    [[TMP6:%.*]] = add nsw i32 [[DOT02]], 1
; IS__TUNIT_OPM-NEXT:    br label [[BB9:%.*]]
; IS__TUNIT_OPM:       bb7:
; IS__TUNIT_OPM-NEXT:    [[TMP8:%.*]] = add nsw i32 [[DOT02]], 2
; IS__TUNIT_OPM-NEXT:    br label [[BB9]]
; IS__TUNIT_OPM:       bb9:
; IS__TUNIT_OPM-NEXT:    [[DOT01:%.*]] = phi i32 [ [[TMP6]], [[BB5]] ], [ [[TMP8]], [[BB7]] ]
; IS__TUNIT_OPM-NEXT:    [[TMP10:%.*]] = icmp eq i32 [[DOT01]], 5
; IS__TUNIT_OPM-NEXT:    br i1 [[TMP10]], label [[BB11:%.*]], label [[BB12:%.*]]
; IS__TUNIT_OPM:       bb11:
; IS__TUNIT_OPM-NEXT:    br label [[BB13:%.*]]
; IS__TUNIT_OPM:       bb12:
; IS__TUNIT_OPM-NEXT:    br label [[BB13]]
; IS__TUNIT_OPM:       bb13:
; IS__TUNIT_OPM-NEXT:    [[DOT0:%.*]] = phi i1 [ true, [[BB11]] ], [ false, [[BB12]] ]
; IS__TUNIT_OPM-NEXT:    ret i1 [[DOT0]]
;
; IS__TUNIT_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__TUNIT_NPM-NEXT:    br label [[BB3]]
; IS__TUNIT_NPM:       bb3:
; IS__TUNIT_NPM-NEXT:    [[DOT02:%.*]] = phi i32 [ 1, [[BB1]] ], [ 2, [[BB2]] ]
; IS__TUNIT_NPM-NEXT:    [[TMP4:%.*]] = icmp sgt i32 [[ARG]], 10
; IS__TUNIT_NPM-NEXT:    br i1 [[TMP4]], label [[BB5:%.*]], label [[BB7:%.*]]
; IS__TUNIT_NPM:       bb5:
; IS__TUNIT_NPM-NEXT:    [[TMP6:%.*]] = add nsw i32 [[DOT02]], 1
; IS__TUNIT_NPM-NEXT:    br label [[BB9:%.*]]
; IS__TUNIT_NPM:       bb7:
; IS__TUNIT_NPM-NEXT:    [[TMP8:%.*]] = add nsw i32 [[DOT02]], 2
; IS__TUNIT_NPM-NEXT:    br label [[BB9]]
; IS__TUNIT_NPM:       bb9:
; IS__TUNIT_NPM-NEXT:    [[DOT01:%.*]] = phi i32 [ [[TMP6]], [[BB5]] ], [ [[TMP8]], [[BB7]] ]
; IS__TUNIT_NPM-NEXT:    [[TMP10:%.*]] = icmp eq i32 [[DOT01]], 5
; IS__TUNIT_NPM-NEXT:    br i1 [[TMP10]], label [[BB11:%.*]], label [[BB12:%.*]]
; IS__TUNIT_NPM:       bb11:
; IS__TUNIT_NPM-NEXT:    br label [[BB13:%.*]]
; IS__TUNIT_NPM:       bb12:
; IS__TUNIT_NPM-NEXT:    br label [[BB13]]
; IS__TUNIT_NPM:       bb13:
; IS__TUNIT_NPM-NEXT:    [[DOT0:%.*]] = phi i1 [ true, [[BB11]] ], [ false, [[BB12]] ]
; IS__TUNIT_NPM-NEXT:    ret i1 [[DOT0]]
;
; IS__CGSCC_OPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_OPM-NEXT:    br label [[BB3]]
; IS__CGSCC_OPM:       bb3:
; IS__CGSCC_OPM-NEXT:    [[DOT02:%.*]] = phi i32 [ 1, [[BB1]] ], [ 2, [[BB2]] ]
; IS__CGSCC_OPM-NEXT:    [[TMP4:%.*]] = icmp sgt i32 [[ARG]], 10
; IS__CGSCC_OPM-NEXT:    br i1 [[TMP4]], label [[BB5:%.*]], label [[BB7:%.*]]
; IS__CGSCC_OPM:       bb5:
; IS__CGSCC_OPM-NEXT:    [[TMP6:%.*]] = add nsw i32 [[DOT02]], 1
; IS__CGSCC_OPM-NEXT:    br label [[BB9:%.*]]
; IS__CGSCC_OPM:       bb7:
; IS__CGSCC_OPM-NEXT:    [[TMP8:%.*]] = add nsw i32 [[DOT02]], 2
; IS__CGSCC_OPM-NEXT:    br label [[BB9]]
; IS__CGSCC_OPM:       bb9:
; IS__CGSCC_OPM-NEXT:    [[DOT01:%.*]] = phi i32 [ [[TMP6]], [[BB5]] ], [ [[TMP8]], [[BB7]] ]
; IS__CGSCC_OPM-NEXT:    [[TMP10:%.*]] = icmp eq i32 [[DOT01]], 5
; IS__CGSCC_OPM-NEXT:    br i1 [[TMP10]], label [[BB11:%.*]], label [[BB12:%.*]]
; IS__CGSCC_OPM:       bb11:
; IS__CGSCC_OPM-NEXT:    br label [[BB13:%.*]]
; IS__CGSCC_OPM:       bb12:
; IS__CGSCC_OPM-NEXT:    br label [[BB13]]
; IS__CGSCC_OPM:       bb13:
; IS__CGSCC_OPM-NEXT:    [[DOT0:%.*]] = phi i1 [ true, [[BB11]] ], [ false, [[BB12]] ]
; IS__CGSCC_OPM-NEXT:    ret i1 [[DOT0]]
;
; IS__CGSCC_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_NPM-NEXT:    br label [[BB3]]
; IS__CGSCC_NPM:       bb3:
; IS__CGSCC_NPM-NEXT:    [[DOT02:%.*]] = phi i32 [ 1, [[BB1]] ], [ 2, [[BB2]] ]
; IS__CGSCC_NPM-NEXT:    [[TMP4:%.*]] = icmp sgt i32 [[ARG]], 10
; IS__CGSCC_NPM-NEXT:    br i1 [[TMP4]], label [[BB5:%.*]], label [[BB7:%.*]]
; IS__CGSCC_NPM:       bb5:
; IS__CGSCC_NPM-NEXT:    [[TMP6:%.*]] = add nsw i32 [[DOT02]], 1
; IS__CGSCC_NPM-NEXT:    br label [[BB9:%.*]]
; IS__CGSCC_NPM:       bb7:
; IS__CGSCC_NPM-NEXT:    [[TMP8:%.*]] = add nsw i32 [[DOT02]], 2
; IS__CGSCC_NPM-NEXT:    br label [[BB9]]
; IS__CGSCC_NPM:       bb9:
; IS__CGSCC_NPM-NEXT:    [[DOT01:%.*]] = phi i32 [ [[TMP6]], [[BB5]] ], [ [[TMP8]], [[BB7]] ]
; IS__CGSCC_NPM-NEXT:    [[TMP10:%.*]] = icmp eq i32 [[DOT01]], 5
; IS__CGSCC_NPM-NEXT:    br i1 [[TMP10]], label [[BB11:%.*]], label [[BB12:%.*]]
; IS__CGSCC_NPM:       bb11:
; IS__CGSCC_NPM-NEXT:    br label [[BB13:%.*]]
; IS__CGSCC_NPM:       bb12:
; IS__CGSCC_NPM-NEXT:    br label [[BB13]]
; IS__CGSCC_NPM:       bb13:
; IS__CGSCC_NPM-NEXT:    [[DOT0:%.*]] = phi i1 [ true, [[BB11]] ], [ false, [[BB12]] ]
; IS__CGSCC_NPM-NEXT:    ret i1 [[DOT0]]
;
bb:
...
; IS__TUNIT_OPM-NEXT:    ret i1 [[CMP6]]
;
; IS__TUNIT_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__TUNIT_NPM-NEXT:    ret i1 [[CMP6]]
;
; IS__CGSCC_OPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_OPM-NEXT:    ret i1 [[CMP6]]
;
; IS__CGSCC_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_NPM-NEXT:    ret i1 [[CMP6]]
;
entry:
...
; IS__TUNIT_OPM-NEXT:    [[Y_0:%.*]] = add nuw nsw i32 [[DOT]], [[Y_0_V]]
; IS__TUNIT_OPM-NEXT:    [[CMP6:%.*]] = icmp eq i32 [[Y_0]], 5
; IS__TUNIT_OPM-NEXT:    [[DOT13:%.*]] = zext i1 [[CMP6]] to i32
; IS__TUNIT_OPM-NEXT:    ret i32 [[DOT13]]
;
; IS__TUNIT_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__TUNIT_NPM-NEXT:    [[Y_0:%.*]] = add nuw nsw i32 [[DOT]], [[Y_0_V]]
; IS__TUNIT_NPM-NEXT:    [[CMP6:%.*]] = icmp eq i32 [[Y_0]], 5
; IS__TUNIT_NPM-NEXT:    [[DOT13:%.*]] = zext i1 [[CMP6]] to i32
; IS__TUNIT_NPM-NEXT:    ret i32 [[DOT13]]
;
; IS__CGSCC_OPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_OPM-NEXT:    [[Y_0:%.*]] = add nuw nsw i32 [[DOT]], [[Y_0_V]]
; IS__CGSCC_OPM-NEXT:    [[CMP6:%.*]] = icmp eq i32 [[Y_0]], 5
; IS__CGSCC_OPM-NEXT:    [[DOT13:%.*]] = zext i1 [[CMP6]] to i32
; IS__CGSCC_OPM-NEXT:    ret i32 [[DOT13]]
;
; IS__CGSCC_NPM: Function Attrs: nofree norecurse nosync nounwind readnone willreturn
...
; IS__CGSCC_NPM-NEXT:    [[Y_0:%.*]] = add nuw nsw i32 [[DOT]], [[Y_0_V]]
; IS__CGSCC_NPM-NEXT:    [[CMP6:%.*]] = icmp eq i32 [[Y_0]], 5
; IS__CGSCC_NPM-NEXT:    [[DOT13:%.*]] = zext i1 [[CMP6]] to i32
; IS__CGSCC_NPM-NEXT:    ret i32 [[DOT13]]
;
entry:
  %cmp = icmp sgt i32 %a, 5
  %. = select i1 %cmp, i32 1, i32 2
...
; IS__TUNIT_OPM-NEXT:    [[INDIRECTION:%.*]] = select i1 [[C3]], i32 [[R1]], i32 [[R2]]
; IS__TUNIT_OPM-NEXT:    [[A:%.*]] = add i32 [[R1]], [[INDIRECTION]]
; IS__TUNIT_OPM-NEXT:    [[I1:%.*]] = icmp sle i32 [[A]], 4
...
; IS__TUNIT_NPM-NEXT:    [[INDIRECTION:%.*]] = select i1 [[C3]], i32 [[R1]], i32 [[R2]]
; IS__TUNIT_NPM-NEXT:    [[A:%.*]] = add i32 [[R1]], [[INDIRECTION]]
; IS__TUNIT_NPM-NEXT:    [[I1:%.*]] = icmp sle i32 [[A]], 4
...
; IS__TUNIT_NPM-NEXT:    br label [[END]]
; IS__TUNIT_NPM:       end:
; IS__TUNIT_NPM-NEXT:    [[PHI:%.*]] = phi i32 [ [[V]], [[IF_TRUE]] ], [ 100, [[IF_FALSE]] ]
; IS__TUNIT_NPM-NEXT:    [[C2:%.*]] = icmp sge i32 [[PHI]], 100
; IS__TUNIT_NPM-NEXT:    ret i1 [[C2]]
;
; IS__CGSCC_OPM: Function Attrs: nofree nosync nounwind readnone willreturn
...
; IS__CGSCC_NPM-NEXT:    br i1 [[C]], label [[T:%.*]], label [[F:%.*]]
; IS__CGSCC_NPM:       t:
; IS__CGSCC_NPM-NEXT:    [[R:%.*]] = call i1 @non_zero(i8 [[L]]) #[[ATTR6]]
; IS__CGSCC_NPM-NEXT:    ret i1 [[R]]
; IS__CGSCC_NPM:       f:
...
; IS__TUNIT_OPM: Function Attrs: nofree norecurse nosync nounwind readnone
; IS__TUNIT_OPM-LABEL: define {{[^@]+}}@loop_1
; IS__TUNIT_OPM-SAME: (i32 [[N:%.*]]) #[[ATTR1]] {
; IS__TUNIT_OPM-NEXT:  entry:
; IS__TUNIT_OPM-NEXT:    br label [[HEADER:%.*]]
; IS__TUNIT_OPM:       header:
; IS__TUNIT_OPM-NEXT:    [[I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[AND:%.*]], [[HEADER]] ]
; IS__TUNIT_OPM-NEXT:    [[INC:%.*]] = add i32 [[I]], 1
; IS__TUNIT_OPM-NEXT:    [[AND]] = and i32 [[INC]], 9999
; IS__TUNIT_OPM-NEXT:    [[CMP:%.*]] = icmp ne i32 [[N]], [[AND]]
; IS__TUNIT_OPM-NEXT:    br i1 [[CMP]], label [[HEADER]], label [[EXIT:%.*]]
; IS__TUNIT_OPM:       exit:
; IS__TUNIT_OPM-NEXT:    [[R:%.*]] = icmp sle i32 [[I]], 5
; IS__TUNIT_OPM-NEXT:    ret i1 [[R]]
;
; IS__TUNIT_NPM: Function Attrs: nofree norecurse nosync nounwind readnone
; IS__TUNIT_NPM-LABEL: define {{[^@]+}}@loop_1
; IS__TUNIT_NPM-SAME: (i32 [[N:%.*]]) #[[ATTR2:[0-9]+]] {
; IS__TUNIT_NPM-NEXT:  entry:
; IS__TUNIT_NPM-NEXT:    br label [[HEADER:%.*]]
; IS__TUNIT_NPM:       header:
; IS__TUNIT_NPM-NEXT:    [[I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[AND:%.*]], [[HEADER]] ]
; IS__TUNIT_NPM-NEXT:    [[INC:%.*]] = add i32 [[I]], 1
; IS__TUNIT_NPM-NEXT:    [[AND]] = and i32 [[INC]], 9999
; IS__TUNIT_NPM-NEXT:    [[CMP:%.*]] = icmp ne i32 [[N]], [[AND]]
; IS__TUNIT_NPM-NEXT:    br i1 [[CMP]], label [[HEADER]], label [[EXIT:%.*]]
; IS__TUNIT_NPM:       exit:
; IS__TUNIT_NPM-NEXT:    [[R:%.*]] = icmp sle i32 [[I]], 5
; IS__TUNIT_NPM-NEXT:    ret i1 [[R]]
;
; IS__CGSCC_OPM: Function Attrs: nofree norecurse nosync nounwind readnone
; IS__CGSCC_OPM-LABEL: define {{[^@]+}}@loop_1
; IS__CGSCC_OPM-SAME: (i32 [[N:%.*]]) #[[ATTR2]] {
; IS__CGSCC_OPM-NEXT:  entry:
; IS__CGSCC_OPM-NEXT:    br label [[HEADER:%.*]]
; IS__CGSCC_OPM:       header:
; IS__CGSCC_OPM-NEXT:    [[I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[AND:%.*]], [[HEADER]] ]
; IS__CGSCC_OPM-NEXT:    [[INC:%.*]] = add i32 [[I]], 1
; IS__CGSCC_OPM-NEXT:    [[AND]] = and i32 [[INC]], 9999
; IS__CGSCC_OPM-NEXT:    [[CMP:%.*]] = icmp ne i32 [[N]], [[AND]]
; IS__CGSCC_OPM-NEXT:    br i1 [[CMP]], label [[HEADER]], label [[EXIT:%.*]]
; IS__CGSCC_OPM:       exit:
; IS__CGSCC_OPM-NEXT:    [[R:%.*]] = icmp sle i32 [[I]], 5
; IS__CGSCC_OPM-NEXT:    ret i1 [[R]]
;
...
; IS__TUNIT_OPM: attributes #[[ATTR2]] = { nofree norecurse nosync nounwind readnone willreturn }
