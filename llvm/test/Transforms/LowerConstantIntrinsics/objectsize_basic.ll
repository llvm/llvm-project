...
declare i64 @llvm.objectsize.i64(ptr, i1, i1, i1, i1, i64) nounwind readonly
declare i64 @llvm.objectsize.i64.p1(ptr addrspace(1), i1, i1, i1, i1, i64) nounwind readonly
...
;
entry:
  %0 = tail call i64 @llvm.objectsize.i64(ptr %ptr, i1 false, i1 false, i1 false, i1 true, i64 0)
  %1 = icmp ugt i64 %0, 3
...
;
entry:
  %0 = tail call i64 @llvm.objectsize.i64(ptr null, i1 false, i1 true, i1 false, i1 true, i64 0)
  ret i64 %0
}
...
;
entry:
  %0 = tail call i64 @llvm.objectsize.i64(ptr null, i1 true, i1 true, i1 false, i1 true, i64 0)
  ret i64 %0
}
...
;
  %size = tail call i64 @llvm.objectsize.i64(ptr %ptr, i1 true, i1 false, i1 false, i1 true, i64 0)
  ret i64 %size
}
...
;
  ...
  %objsize = call i64 @llvm.objectsize.i64(ptr %G1, i1 false, i1 true, i1 true, i1 true, i64 0)
  ret i64 %objsize
}
...
;
  ...
  %objsize = call i64 @llvm.objectsize.i64(ptr %ptr, i1 false, i1 true, i1 true, i1 true, i64 0)
  ret i64 %objsize
}
...
;
  %size = call i32 @llvm.objectsize.i32.p0(ptr @gv_weak, i1 false, i1 false, i1 false, i1 true, i64 0)
  ret i32 %size
}
...
;
  %size = call i32 @llvm.objectsize.i32.p0(ptr @gv_weak, i1 true, i1 false, i1 false, i1 true, i64 0)
  ret i32 %size
}
...
;
  %size = call i32 @llvm.objectsize.i32.p0(ptr @gv_extern, i1 true, i1 false, i1 false, i1 true, i64 0)
  ret i32 %size
}
...
; CHECK-NEXT:    ret i32 0
;
  %size = call i32 @llvm.objectsize.i32.p0(ptr @gv_extern, i1 true, i1 true, i1 false, i1 true, i64 0)
  ret i32 %size
}

declare i32 @llvm.objectsize.i32.p0(ptr, i1, i1, i1, i1, i64)
