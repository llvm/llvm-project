...
; CHECK-LABEL: define internal i8* @f.resume.0(i8* noalias nonnull, i1 zeroext, i8** swifterror)
; CHECK-NEXT:  :
; CHECK-NEXT:    br i1 %1,
; CHECK:       :
...
; CHECK-LABEL: define internal i8* @g.resume.0(i8* noalias nonnull, i1 zeroext)
; CHECK-NEXT:  :
; CHECK-NEXT:    [[ERRORSLOT:%.*]] = alloca swifterror i8*, align 4
; CHECK-NEXT:    br i1 %1,
; CHECK:       :
