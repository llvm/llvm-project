...
; RUN: opt -passes=loop-idiom -mtriple=riscv32 -mattr=-zbc -S %s | FileCheck --check-prefixes=ALL,NOZBC,NOZBC32 %s
; RUN: opt -passes=loop-idiom -mtriple=riscv64 -mattr=-zbc -S %s | FileCheck --check-prefixes=ALL,NOZBC,NOZBC64 %s
...
; NOZBC-LABEL: define i16 @crc16.le.tc8(
; NOZBC-SAME: i8 [[MSG:%.*]], i16 [[CHECKSUM:%.*]]) #[[ATTR0:[0-9]+]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[CRC:%.*]] = phi i16 [ [[CHECKSUM]], %[[ENTRY]] ], [ [[CRC_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA:%.*]] = phi i8 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[CRC_TRUNC:%.*]] = trunc i16 [[CRC]] to i8
; NOZBC-NEXT:    [[XOR_DATA_CRC:%.*]] = xor i8 [[DATA]], [[CRC_TRUNC]]
; NOZBC-NEXT:    [[AND_DATA_CRC:%.*]] = and i8 [[XOR_DATA_CRC]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i8 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp eq i8 [[AND_DATA_CRC]], 0
; NOZBC-NEXT:    [[CRC_LSHR:%.*]] = lshr i16 [[CRC]], 1
; NOZBC-NEXT:    [[XOR:%.*]] = xor i16 [[CRC_LSHR]], -24575
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i16 [[CRC_LSHR]], i16 [[XOR]]
...
; NOZBC:       [[EXIT]]:
; NOZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i16 [ [[CRC_NEXT]], %[[LOOP]] ]
; NOZBC-NEXT:    ret i16 [[CRC_NEXT_LCSSA]]
;
...
; ZBC:       [[EXIT]]:
; ZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i16 [ [[CRC_NEXT2]], %[[LOOP]] ]
...
; NOZBC-LABEL: define i16 @crc16.le.tc16(
; NOZBC-SAME: i16 [[MSG:%.*]], i16 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[CRC:%.*]] = phi i16 [ [[CHECKSUM]], %[[ENTRY]] ], [ [[CRC_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA:%.*]] = phi i16 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i16 [[CRC]], [[DATA]]
; NOZBC-NEXT:    [[AND_CRC_DATA:%.*]] = and i16 [[XOR_CRC_DATA]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i16 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp eq i16 [[AND_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_LSHR:%.*]] = lshr i16 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i16 [[CRC_LSHR]], -24575
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i16 [[CRC_LSHR]], i16 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 15
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
; NOZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i16 [ [[CRC_NEXT]], %[[LOOP]] ]
; NOZBC-NEXT:    ret i16 [[CRC_NEXT_LCSSA]]
...
; NOZBC-LABEL: define i8 @crc8.le.tc16(
; NOZBC-SAME: i16 [[MSG:%.*]], i8 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[CRC:%.*]] = phi i8 [ [[CHECKSUM]], %[[ENTRY]] ], [ [[CRC_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA:%.*]] = phi i16 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA_TRUNC:%.*]] = trunc i16 [[DATA]] to i8
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i8 [[CRC]], [[DATA_TRUNC]]
; NOZBC-NEXT:    [[AND_CRC_DATA:%.*]] = and i8 [[XOR_CRC_DATA]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i16 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp eq i8 [[AND_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_LSHR:%.*]] = lshr i8 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i8 [[CRC_LSHR]], 29
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i8 [[CRC_LSHR]], i8 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 15
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
; NOZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i8 [ [[CRC_NEXT]], %[[LOOP]] ]
; NOZBC-NEXT:    ret i8 [[CRC_NEXT_LCSSA]]
;
...
; NOZBC-LABEL: define i16 @crc16.be.tc16(
; NOZBC-SAME: i16 [[MSG:%.*]], i16 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
...
; NOZBC-NEXT:    [[DATA:%.*]] = phi i16 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i16 [[CRC]], [[DATA]]
; NOZBC-NEXT:    [[DATA_NEXT]] = shl i16 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp sge i16 [[XOR_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_SHL:%.*]] = shl i16 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i16 [[CRC_SHL]], 4129
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i16 [[CRC_SHL]], i16 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 15
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
...
; NOZBC-LABEL: define i16 @crc16.be.tc8.misalign(
; NOZBC-SAME: i8 [[MSG:%.*]], i16 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
...
; NOZBC-NEXT:    [[CRC_TRUNC:%.*]] = trunc i16 [[CRC]] to i8
; NOZBC-NEXT:    [[XOR_DATA_CRC:%.*]] = xor i8 [[DATA]], [[CRC_TRUNC]]
; NOZBC-NEXT:    [[DATA_NEXT]] = shl i8 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp sge i8 [[XOR_DATA_CRC]], 0
; NOZBC-NEXT:    [[CRC_SHL:%.*]] = shl i16 [[CRC]], 1
; NOZBC-NEXT:    [[XOR:%.*]] = xor i16 [[CRC_SHL]], 4129
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i16 [[CRC_SHL]], i16 [[XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 7
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
...
; NOZBC-LABEL: define i8 @crc8.be.tc16.misalign(
; NOZBC-SAME: i16 [[MSG:%.*]], i8 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
...
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i8 [[CRC]], [[DATA_TRUNC]]
; NOZBC-NEXT:    [[DATA_NEXT]] = shl i16 [[DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp sge i8 [[XOR_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_SHL:%.*]] = shl i8 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i8 [[CRC_SHL]], 29
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i8 [[CRC_SHL]], i8 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 15
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
...
; NOZBC-LABEL: define i8 @crc8.be.tc8.data16.misalign(
; NOZBC-SAME: i16 [[MSG:%.*]], i8 [[CHECKSUM:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
...
; NOZBC-LABEL: define i32 @crc32.le.tc8.data32(
; NOZBC-SAME: i32 [[CHECKSUM:%.*]], i32 [[MSG:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
...
;
; ZBC-LABEL: define i32 @crc32.le.tc8.data32(
; ZBC-SAME: i32 [[CHECKSUM:%.*]], i32 [[MSG:%.*]]) #[[ATTR0]] {
; ZBC-NEXT:  [[ENTRY:.*:]]
; ZBC-NEXT:    [[CRC_CAST:%.*]] = trunc i32 [[CHECKSUM]] to i8
; ZBC-NEXT:    [[DATA_CAST:%.*]] = trunc i32 [[MSG]] to i8
; ZBC-NEXT:    [[XOR_CRC_DATA1:%.*]] = xor i8 [[CRC_CAST]], [[DATA_CAST]]
; ZBC-NEXT:    [[TCBITS_CAST:%.*]] = zext i8 [[XOR_CRC_DATA1]] to i16
; ZBC-NEXT:    [[CLMUL_MU:%.*]] = call i16 @llvm.clmul.i16(i16 [[TCBITS_CAST]], i16 273)
; ZBC-NEXT:    [[QUOT_MASK:%.*]] = and i16 [[CLMUL_MU]], 255
; ZBC-NEXT:    [[QUOT_CAST:%.*]] = zext i16 [[QUOT_MASK]] to i40
; ZBC-NEXT:    [[CLMUL_GP:%.*]] = call i40 @llvm.clmul.i40(i40 [[QUOT_CAST]], i40 67601)
; ZBC-NEXT:    [[CRC_RECAST:%.*]] = zext i32 [[CHECKSUM]] to i40
; ZBC-NEXT:    [[XOR_CRC_MULT:%.*]] = xor i40 [[CRC_RECAST]], [[CLMUL_GP]]
; ZBC-NEXT:    [[CRC_LSHR2:%.*]] = lshr i40 [[XOR_CRC_MULT]], 8
; ZBC-NEXT:    [[CRC_NEXT3:%.*]] = trunc i40 [[CRC_LSHR2]] to i32
; ZBC-NEXT:    br label %[[LOOP:.*]]
; ZBC:       [[LOOP]]:
; ZBC-NEXT:    br i1 false, label %[[LOOP]], label %[[EXIT:.*]]
; ZBC:       [[EXIT]]:
...
; NOZBC-LABEL: define i8 @crc8.le.tc8.data32(
; NOZBC-SAME: i8 [[CHECKSUM:%.*]], i32 [[MSG:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[CRC:%.*]] = phi i8 [ [[CHECKSUM]], %[[ENTRY]] ], [ [[CRC_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA:%.*]] = phi i32 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA_TRUNC:%.*]] = trunc i32 [[DATA]] to i8
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i8 [[CRC]], [[DATA_TRUNC]]
; NOZBC-NEXT:    [[SB_CRC_DATA:%.*]] = and i8 [[XOR_CRC_DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp eq i8 [[SB_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_LSHR:%.*]] = lshr i8 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i8 [[CRC_LSHR]], 59
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i8 [[CRC_LSHR]], i8 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i32 [[DATA]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 7
...
; NOZBC-LABEL: define i32 @crc32.le.tc32(
; NOZBC-SAME: i32 [[CHECKSUM:%.*]], i32 [[MSG:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
...
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i32 [[DATA]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 31
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
; NOZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i32 [ [[CRC_NEXT]], %[[LOOP]] ]
; NOZBC-NEXT:    ret i32 [[CRC_NEXT_LCSSA]]
...
; ZBC-NEXT:    [[TCBITS_CAST:%.*]] = zext i32 [[XOR_CRC_DATA1]] to i64
; ZBC-NEXT:    [[CLMUL_MU:%.*]] = call i64 @llvm.clmul.i64(i64 [[TCBITS_CAST]], i64 4770502929)
; ZBC-NEXT:    [[QUOT_MASK:%.*]] = and i64 [[CLMUL_MU]], 4294967295
; ZBC-NEXT:    [[CLMUL_GP:%.*]] = call i64 @llvm.clmul.i64(i64 [[QUOT_MASK]], i64 67601)
...
; NOZBC-LABEL: define i64 @crc64.le.tc64(
; NOZBC-SAME: i64 [[CHECKSUM:%.*]], i64 [[MSG:%.*]]) #[[ATTR0]] {
; NOZBC-NEXT:  [[ENTRY:.*]]:
; NOZBC-NEXT:    br label %[[LOOP:.*]]
; NOZBC:       [[LOOP]]:
; NOZBC-NEXT:    [[CRC:%.*]] = phi i64 [ [[CHECKSUM]], %[[ENTRY]] ], [ [[CRC_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[DATA:%.*]] = phi i64 [ [[MSG]], %[[ENTRY]] ], [ [[DATA_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[IV:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; NOZBC-NEXT:    [[XOR_CRC_DATA:%.*]] = xor i64 [[CRC]], [[DATA]]
; NOZBC-NEXT:    [[SB_CRC_DATA:%.*]] = and i64 [[XOR_CRC_DATA]], 1
; NOZBC-NEXT:    [[CHECK_SB:%.*]] = icmp eq i64 [[SB_CRC_DATA]], 0
; NOZBC-NEXT:    [[CRC_LSHR:%.*]] = lshr i64 [[CRC]], 1
; NOZBC-NEXT:    [[CRC_XOR:%.*]] = xor i64 [[CRC_LSHR]], 33800
; NOZBC-NEXT:    [[CRC_NEXT]] = select i1 [[CHECK_SB]], i64 [[CRC_LSHR]], i64 [[CRC_XOR]]
; NOZBC-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; NOZBC-NEXT:    [[DATA_NEXT]] = lshr i64 [[DATA]], 1
; NOZBC-NEXT:    [[EXIT_COND:%.*]] = icmp samesign ult i8 [[IV]], 63
; NOZBC-NEXT:    br i1 [[EXIT_COND]], label %[[LOOP]], label %[[EXIT:.*]]
; NOZBC:       [[EXIT]]:
; NOZBC-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i64 [ [[CRC_NEXT]], %[[LOOP]] ]
; NOZBC-NEXT:    ret i64 [[CRC_NEXT_LCSSA]]
;
; ZBC-LABEL: define i64 @crc64.le.tc64(
; ZBC-SAME: i64 [[CHECKSUM:%.*]], i64 [[MSG:%.*]]) #[[ATTR0]] {
; ZBC-NEXT:  [[ENTRY:.*:]]
; ZBC-NEXT:    [[XOR_CRC_DATA1:%.*]] = xor i64 [[CHECKSUM]], [[MSG]]
; ZBC-NEXT:    [[TCBITS_CAST:%.*]] = zext i64 [[XOR_CRC_DATA1]] to i128
; ZBC-NEXT:    [[CLMUL_MU:%.*]] = call i128 @llvm.clmul.i128(i128 [[TCBITS_CAST]], i128 28074037147910805777)
; ZBC-NEXT:    [[QUOT_MASK:%.*]] = and i128 [[CLMUL_MU]], 18446744073709551615
; ZBC-NEXT:    [[CLMUL_GP:%.*]] = call i128 @llvm.clmul.i128(i128 [[QUOT_MASK]], i128 67601)
