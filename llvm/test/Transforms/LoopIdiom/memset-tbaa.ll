...
; CHECK-LABEL: define dso_local void @double_memset(
...
; CHECK-LABEL: define dso_local void @struct_memset(
; CHECK-SAME: ptr captures(none) [[P:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define dso_local void @var_memset(
; CHECK-SAME: ptr captures(none) [[P:%.*]], i64 [[LEN:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK-LABEL: define dso_local void @adjacent_store_memset(
; CHECK-SAME: ptr captures(none) [[A:%.*]], i64 [[LEN:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
; CHECK: [[TBAA4]] = !{[[META5:![0-9]+]], [[META7:![0-9]+]], i64 0, i64 16}
...
; CHECK: [[META9]] = !{!"any pointer", [[META2]], i64 0}
;.
