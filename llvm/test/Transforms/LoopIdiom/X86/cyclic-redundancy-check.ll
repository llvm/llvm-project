...
; RUN: opt -passes=loop-idiom -loop-idiom-force-crc-clmul -mtriple=x86_64 -mattr=-pclmul -S %s | FileCheck --check-prefixes=ALL,NOPCLMUL %s
; RUN: opt -passes=loop-idiom -loop-idiom-force-crc-clmul -mtriple=x86_64 -mattr=+pclmul -S %s | FileCheck --check-prefixes=ALL,PCLMUL %s
...
; PCLMUL-NEXT:    [[CRC_SHL1:%.*]] = shl i16 [[CRC_CAST]], 8
; PCLMUL-NEXT:    [[XOR_CRC_MULT:%.*]] = xor i16 [[CRC_SHL1]], [[CLMUL_GP]]
...
; PCLMUL:       [[INNER_EXIT]]:
; PCLMUL-NEXT:    [[CRC_NEXT_LCSSA]] = phi i8 [ [[CRC_NEXT2]], %[[INNER_LOOP]] ]
...
; NOPCLMUL-LABEL: define i32 @crc32.le.tc32.optsize(
...
; NOPCLMUL-NEXT:    ret i32 [[CRC_NEXT_LCSSA]]
;
; PCLMUL-LABEL: define i32 @crc32.le.tc32.optsize(
