...
; ALL-LABEL: define i16 @crc16.le.tc8.udiv(
...
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i16, ptr @.crctable.2, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD:%.*]] = load i16, ptr [[TBL_PTRADD]], align 2
; ALL-NEXT:    [[CRC_LE_SHIFT:%.*]] = lshr i16 [[CRC2]], 8
; ALL-NEXT:    [[CRC_NEXT3]] = xor i16 [[CRC_LE_SHIFT]], [[TBL_LD]]
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
...
; ALL-NEXT:    [[INDEXER_LO:%.*]] = trunc i16 [[CRC_DATA_INDEXER]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_LO]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i8, ptr @.crctable.3, i64 [[INDEXER_EXT]]
...
; ALL-LABEL: define i16 @crc16.be.tc8.crc.init.li(
; ALL-SAME: i16 [[CHECKSUM:%.*]], i8 [[MSG:%.*]]) #[[ATTR0]] {
; ALL-NEXT:  [[ENTRY:.*]]:
; ALL-NEXT:    [[MSG_EXT:%.*]] = zext i8 [[MSG]] to i16
; ALL-NEXT:    [[MSG_SHL:%.*]] = shl nuw i16 [[MSG_EXT]], 8
; ALL-NEXT:    [[CRC_INIT:%.*]] = xor i16 [[MSG_SHL]], [[CHECKSUM]]
; ALL-NEXT:    br label %[[LOOP:.*]]
; ALL:       [[LOOP]]:
; ALL-NEXT:    [[IV:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
; ALL-NEXT:    [[CRC2:%.*]] = phi i16 [ [[CRC_INIT]], %[[ENTRY]] ], [ [[CRC_NEXT3:%.*]], %[[LOOP]] ]
...
; ALL-NEXT:    [[EXIT_COND1:%.*]] = icmp ne i32 [[IV]], 0
; ALL-NEXT:    br i1 [[EXIT_COND1]], label %[[LOOP]], label %[[EXIT:.*]]
; ALL:       [[EXIT]]:
; ALL-NEXT:    [[CRC_NEXT_LCSSA:%.*]] = phi i16 [ [[CRC_NEXT3]], %[[LOOP]] ]
; ALL-NEXT:    ret i16 [[CRC_NEXT_LCSSA]]
...
; ALL-LABEL: define i16 @crc16.be.tc8.crc.init.arg(
; ALL-SAME: i16 [[CRC_INIT:%.*]]) #[[ATTR0]] {
; ALL-NEXT:  [[ENTRY:.*]]:
; ALL-NEXT:    br label %[[LOOP:.*]]
; ALL:       [[LOOP]]:
; ALL-NEXT:    [[IV:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[IV_NEXT:%.*]], %[[LOOP]] ]
...
; ALL-NEXT:    [[INDEXER_HI_LO_BYTE:%.*]] = trunc i16 [[INDEXER_HI]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i16, ptr @.crctable.5, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD:%.*]] = load i16, ptr [[TBL_PTRADD]], align 2
; ALL-NEXT:    [[CRC_BE_SHIFT:%.*]] = shl i16 [[CRC2]], 8
; ALL-NEXT:    [[CRC_NEXT3]] = xor i16 [[CRC_BE_SHIFT]], [[TBL_LD]]
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i32 [[IV]], 1
...
; ALL-LABEL: define i16 @crc16.be.tc8.crc.init.arg.flipped.sb.check(
; ALL-SAME: i16 [[CRC_INIT:%.*]]) #[[ATTR0]] {
; ALL-NEXT:  [[ENTRY:.*]]:
; ALL-NEXT:    br label %[[LOOP:.*]]
; ALL:       [[LOOP]]:
...
; ALL-NEXT:    [[INDEXER_HI_LO_BYTE:%.*]] = trunc i16 [[INDEXER_HI]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i16, ptr @.crctable.6, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD:%.*]] = load i16, ptr [[TBL_PTRADD]], align 2
; ALL-NEXT:    [[CRC_BE_SHIFT:%.*]] = shl i16 [[CRC2]], 8
; ALL-NEXT:    [[CRC_NEXT3]] = xor i16 [[CRC_BE_SHIFT]], [[TBL_LD]]
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i32 [[IV]], 1
...
; ALL-LABEL: define i8 @crc8.be.tc8.ptr.nested.loop(
; ALL-SAME: ptr [[MSG:%.*]], i32 [[LOOP_LIMIT:%.*]]) #[[ATTR0]] {
; ALL-NEXT:  [[ENTRY:.*]]:
; ALL-NEXT:    br label %[[OUTER_LOOP:.*]]
; ALL:       [[OUTER_LOOP]]:
; ALL-NEXT:    [[CRC_OUTER:%.*]] = phi i8 [ 0, %[[ENTRY]] ], [ [[CRC_NEXT_LCSSA:%.*]], %[[INNER_EXIT:.*]] ]
; ALL-NEXT:    [[OUTER_IV:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[OUTER_IV_NEXT:%.*]], %[[INNER_EXIT]] ]
; ALL-NEXT:    [[OUTER_EXIT_COND:%.*]] = icmp ult i32 [[OUTER_IV]], [[LOOP_LIMIT]]
; ALL-NEXT:    br i1 [[OUTER_EXIT_COND]], label %[[PH:.*]], label %[[EXIT:.*]]
; ALL:       [[PH]]:
; ALL-NEXT:    [[OUTER_IV_EXT:%.*]] = sext i32 [[OUTER_IV]] to i64
; ALL-NEXT:    [[MSG_OUTER_IV:%.*]] = getelementptr inbounds i8, ptr [[MSG]], i64 [[OUTER_IV_EXT]]
; ALL-NEXT:    [[MSG_LOAD:%.*]] = load i8, ptr [[MSG_OUTER_IV]], align 1
; ALL-NEXT:    [[CRC_INIT:%.*]] = xor i8 [[MSG_LOAD]], [[CRC_OUTER]]
; ALL-NEXT:    br label %[[INNER_LOOP:.*]]
; ALL:       [[INNER_LOOP]]:
; ALL-NEXT:    [[INNER_IV:%.*]] = phi i32 [ 0, %[[PH]] ], [ [[INNER_IV_NEXT:%.*]], %[[INNER_LOOP]] ]
; ALL-NEXT:    [[CRC2:%.*]] = phi i8 [ [[CRC_INIT]], %[[PH]] ], [ [[TBL_LD:%.*]], %[[INNER_LOOP]] ]
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[CRC2]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i8, ptr @.crctable.7, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD]] = load i8, ptr [[TBL_PTRADD]], align 1
; ALL-NEXT:    [[INNER_IV_NEXT]] = add nuw nsw i32 [[INNER_IV]], 1
; ALL-NEXT:    [[EXIT_COND1:%.*]] = icmp ne i32 [[INNER_IV]], 0
; ALL-NEXT:    br i1 [[EXIT_COND1]], label %[[INNER_LOOP]], label %[[INNER_EXIT]]
; ALL:       [[INNER_EXIT]]:
; ALL-NEXT:    [[CRC_NEXT_LCSSA]] = phi i8 [ [[TBL_LD]], %[[INNER_LOOP]] ]
; ALL-NEXT:    [[OUTER_IV_NEXT]] = add i32 [[OUTER_IV]], 1
; ALL-NEXT:    br label %[[OUTER_LOOP]]
; ALL:       [[EXIT]]:
; ALL-NEXT:    [[CRC_OUTER_LCSSA:%.*]] = phi i8 [ [[CRC_OUTER]], %[[OUTER_LOOP]] ]
; ALL-NEXT:    ret i8 [[CRC_OUTER_LCSSA]]
;
entry:
  br label %outer.loop
...
; ALL-NEXT:    [[INDEXER_HI_LO_BYTE:%.*]] = trunc i16 [[INDEXER_HI]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i16, ptr @.crctable.8, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD:%.*]] = load i16, ptr [[TBL_PTRADD]], align 2
; ALL-NEXT:    [[CRC_BE_SHIFT:%.*]] = shl i16 [[CRC2]], 8
; ALL-NEXT:    [[CRC_NEXT3]] = xor i16 [[CRC_BE_SHIFT]], [[TBL_LD]]
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
...
; ALL-NEXT:    [[INDEXER_HI_LO_BYTE:%.*]] = trunc i16 [[INDEXER_HI]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i16, ptr @.crctable.9, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD:%.*]] = load i16, ptr [[TBL_PTRADD]], align 2
; ALL-NEXT:    [[CRC_BE_SHIFT:%.*]] = shl i16 [[CRC2]], 8
; ALL-NEXT:    [[CRC_NEXT3]] = xor i16 [[CRC_BE_SHIFT]], [[TBL_LD]]
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
...
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i8, ptr @.crctable.10, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD]] = load i8, ptr [[TBL_PTRADD]], align 1
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; ALL-NEXT:    [[EXIT_COND1:%.*]] = icmp ne i8 [[IV]], 1
; ALL-NEXT:    br i1 [[EXIT_COND1]], label %[[LOOP]], label %[[EXIT:.*]]
...
; ALL-NEXT:    [[INDEXER_HI_LO_BYTE:%.*]] = trunc i16 [[CRC_DATA_INDEXER]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_HI_LO_BYTE]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i8, ptr @.crctable.11, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD]] = load i8, ptr [[TBL_PTRADD]], align 1
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; ALL-NEXT:    [[EXIT_COND1:%.*]] = icmp ne i8 [[IV]], 0
; ALL-NEXT:    br i1 [[EXIT_COND1]], label %[[LOOP]], label %[[EXIT:.*]]
...
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_LO]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i32, ptr @.crctable.12, i64 [[INDEXER_EXT]]
...
; ALL-NEXT:    [[INDEXER_LO:%.*]] = trunc i32 [[CRC_DATA_INDEXER]] to i8
; ALL-NEXT:    [[INDEXER_EXT:%.*]] = zext i8 [[INDEXER_LO]] to i64
; ALL-NEXT:    [[TBL_PTRADD:%.*]] = getelementptr inbounds i8, ptr @.crctable.13, i64 [[INDEXER_EXT]]
; ALL-NEXT:    [[TBL_LD]] = load i8, ptr [[TBL_PTRADD]], align 1
; ALL-NEXT:    [[IV_NEXT]] = add nuw nsw i8 [[IV]], 1
; ALL-NEXT:    [[EXIT_COND1:%.*]] = icmp ne i8 [[IV]], 0
; ALL-NEXT:    br i1 [[EXIT_COND1]], label %[[LOOP]], label %[[EXIT:.*]]
