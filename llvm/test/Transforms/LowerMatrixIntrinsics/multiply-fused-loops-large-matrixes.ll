...
; RUN: opt -passes=lower-matrix-intrinsics -matrix-allow-contract -force-fuse-matrix -fuse-matrix-tile-size-rows=2 -fuse-matrix-tile-size-inner=2 -fuse-matrix-tile-size-columns=2 %s -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP914:%.*]] = getelementptr inbounds double, ptr [[A]], i64 0
...
; CHECK-NEXT:    [[TMP915:%.*]] = getelementptr inbounds double, ptr [[B]], i64 0
...
; CHECK-NEXT:    [[BLOCK:%.*]] = shufflevector <2 x double> [[COL_LOAD1240]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:    [[SPLAT_SPLAT:%.*]] = shufflevector <2 x double> [[SPLAT_SPLATINSERT1248]], <2 x double> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[BLOCK1247:%.*]] = fmul contract <2 x double> [[BLOCK]], [[SPLAT_SPLAT]]
; CHECK-NEXT:    [[BLOCK1248:%.*]] = shufflevector <2 x double> [[COL_LOAD1243]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <2 x double> [[COL_LOAD1245]], i64 1
; CHECK-NEXT:    [[SPLAT_SPLATINSERT6:%.*]] = insertelement <2 x double> poison, double [[TMP4]], i64 0
; CHECK-NEXT:    [[SPLAT_SPLAT1249:%.*]] = shufflevector <2 x double> [[SPLAT_SPLATINSERT6]], <2 x double> poison, <2 x i32> zeroinitializer
...
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <2 x double> [[TMP917]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP912:%.*]] = shufflevector <2 x double> zeroinitializer, <2 x double> [[TMP6]], <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[BLOCK8:%.*]] = shufflevector <2 x double> [[COL_LOAD1240]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <2 x double> [[COL_LOAD1246]], i64 0
...
; CHECK-NEXT:    [[TMP918:%.*]] = extractelement <2 x double> [[COL_LOAD1246]], i64 1
...
; CHECK-NEXT:    [[TMP11:%.*]] = call contract <2 x double> @llvm.fmuladd.v2f64(<2 x double> [[BLOCK1250]], <2 x double> [[SPLAT_SPLAT1252]], <2 x double> [[TMP9]])
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <2 x double> [[TMP11]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP913:%.*]] = shufflevector <2 x double> zeroinitializer, <2 x double> [[TMP12]], <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds double, ptr [[A]], i64 16
; CHECK-NEXT:    [[COL_LOAD14:%.*]] = load <2 x double>, ptr [[TMP14]], align 8
; CHECK-NEXT:    [[VEC_GEP15:%.*]] = getelementptr inbounds double, ptr [[TMP14]], i64 8
; CHECK-NEXT:    [[COL_LOAD16:%.*]] = load <2 x double>, ptr [[VEC_GEP15]], align 8
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr inbounds double, ptr [[B]], i64 2
; CHECK-NEXT:    [[COL_LOAD17:%.*]] = load <2 x double>, ptr [[TMP15]], align 8
; CHECK-NEXT:    [[VEC_GEP18:%.*]] = getelementptr inbounds double, ptr [[TMP15]], i64 8
; CHECK-NEXT:    [[COL_LOAD19:%.*]] = load <2 x double>, ptr [[VEC_GEP18]], align 8
; CHECK-NEXT:    [[BLOCK20:%.*]] = shufflevector <2 x double> [[TMP912]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[BLOCK21:%.*]] = shufflevector <2 x double> [[COL_LOAD14]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:    [[TMP919:%.*]] = call contract <2 x double> @llvm.fmuladd.v2f64(<2 x double> [[BLOCK24]], <2 x double> [[SPLAT_SPLAT26]], <2 x double> [[TMP17]])
...
; CHECK-NEXT:    [[BLOCK1255:%.*]] = shufflevector <2 x double> [[COL_LOAD14]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP922:%.*]] = extractelement <2 x double> [[COL_LOAD19]], i64 0
...
; CHECK-NEXT:    [[BLOCK1257:%.*]] = shufflevector <2 x double> [[COL_LOAD16]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP924:%.*]] = extractelement <2 x double> [[COL_LOAD19]], i64 1
...
; CHECK-NEXT:    [[TMP28:%.*]] = getelementptr inbounds double, ptr [[A]], i64 32
; CHECK-NEXT:    [[COL_LOAD34:%.*]] = load <2 x double>, ptr [[TMP28]], align 8
; CHECK-NEXT:    [[VEC_GEP35:%.*]] = getelementptr inbounds double, ptr [[TMP28]], i64 8
; CHECK-NEXT:    [[COL_LOAD36:%.*]] = load <2 x double>, ptr [[VEC_GEP35]], align 8
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr inbounds double, ptr [[B]], i64 4
; CHECK-NEXT:    [[COL_LOAD37:%.*]] = load <2 x double>, ptr [[TMP29]], align 8
; CHECK-NEXT:    [[VEC_GEP38:%.*]] = getelementptr inbounds double, ptr [[TMP29]], i64 8
; CHECK-NEXT:    [[COL_LOAD39:%.*]] = load <2 x double>, ptr [[VEC_GEP38]], align 8
; CHECK-NEXT:    [[BLOCK40:%.*]] = shufflevector <2 x double> [[TMP921]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <2 x double> [[TMP921]], <2 x double> [[TMP34]], <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[BLOCK47:%.*]] = shufflevector <2 x double> [[TMP927]], <2 x double> poison, <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <2 x double> [[TMP927]], <2 x double> [[TMP40]], <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr inbounds double, ptr [[A]], i64 48
; CHECK-NEXT:    [[COL_LOAD54:%.*]] = load <2 x double>, ptr [[TMP42]], align 8
; CHECK-NEXT:    [[VEC_GEP55:%.*]] = getelementptr inbounds double, ptr [[TMP42]], i64 8
; CHECK-NEXT:    [[COL_LOAD56:%.*]] = load <2 x double>, ptr [[VEC_GEP55]], align 8
; CHECK-NEXT:    [[TMP43:%.*]] = getelementptr inbounds double, ptr [[B]], i64 6
; CHECK-NEXT:    [[COL_LOAD57:%.*]] = load <2 x double>, ptr [[TMP43]], align 8
; CHECK-NEXT:    [[VEC_GEP58:%.*]] = getelementptr inbounds double, ptr [[TMP43]], i64 8
...
; CHECK-NEXT:    [[TMP928:%.*]] = getelementptr inbounds double, ptr [[C]], i64 0
; CHECK-NEXT:    store <2 x double> [[TMP49]], ptr [[TMP928]], align 8
; CHECK-NEXT:    [[VEC_GEP1260:%.*]] = getelementptr inbounds double, ptr [[TMP928]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP55]], ptr [[VEC_GEP1260]], align 8
; CHECK-NEXT:    [[TMP57:%.*]] = getelementptr inbounds double, ptr [[A]], i64 2
; CHECK-NEXT:    [[COL_LOAD75:%.*]] = load <2 x double>, ptr [[TMP57]], align 8
; CHECK-NEXT:    [[VEC_GEP76:%.*]] = getelementptr inbounds double, ptr [[TMP57]], i64 8
; CHECK-NEXT:    [[COL_LOAD77:%.*]] = load <2 x double>, ptr [[VEC_GEP76]], align 8
; CHECK-NEXT:    [[TMP58:%.*]] = getelementptr inbounds double, ptr [[B]], i64 0
; CHECK-NEXT:    [[COL_LOAD78:%.*]] = load <2 x double>, ptr [[TMP58]], align 8
; CHECK-NEXT:    [[VEC_GEP79:%.*]] = getelementptr inbounds double, ptr [[TMP58]], i64 8
...
; CHECK-NEXT:    [[TMP71:%.*]] = getelementptr inbounds double, ptr [[A]], i64 18
; CHECK-NEXT:    [[COL_LOAD93:%.*]] = load <2 x double>, ptr [[TMP71]], align 8
; CHECK-NEXT:    [[VEC_GEP94:%.*]] = getelementptr inbounds double, ptr [[TMP71]], i64 8
; CHECK-NEXT:    [[COL_LOAD95:%.*]] = load <2 x double>, ptr [[VEC_GEP94]], align 8
; CHECK-NEXT:    [[TMP72:%.*]] = getelementptr inbounds double, ptr [[B]], i64 2
; CHECK-NEXT:    [[COL_LOAD96:%.*]] = load <2 x double>, ptr [[TMP72]], align 8
; CHECK-NEXT:    [[VEC_GEP97:%.*]] = getelementptr inbounds double, ptr [[TMP72]], i64 8
; CHECK-NEXT:    [[COL_LOAD98:%.*]] = load <2 x double>, ptr [[VEC_GEP97]], align 8
...
; CHECK-NEXT:    [[TMP85:%.*]] = getelementptr inbounds double, ptr [[A]], i64 34
; CHECK-NEXT:    [[COL_LOAD113:%.*]] = load <2 x double>, ptr [[TMP85]], align 8
; CHECK-NEXT:    [[VEC_GEP114:%.*]] = getelementptr inbounds double, ptr [[TMP85]], i64 8
; CHECK-NEXT:    [[COL_LOAD115:%.*]] = load <2 x double>, ptr [[VEC_GEP114]], align 8
; CHECK-NEXT:    [[TMP86:%.*]] = getelementptr inbounds double, ptr [[B]], i64 4
; CHECK-NEXT:    [[COL_LOAD116:%.*]] = load <2 x double>, ptr [[TMP86]], align 8
; CHECK-NEXT:    [[VEC_GEP117:%.*]] = getelementptr inbounds double, ptr [[TMP86]], i64 8
...
; CHECK-NEXT:    [[TMP99:%.*]] = getelementptr inbounds double, ptr [[A]], i64 50
; CHECK-NEXT:    [[COL_LOAD133:%.*]] = load <2 x double>, ptr [[TMP99]], align 8
; CHECK-NEXT:    [[VEC_GEP134:%.*]] = getelementptr inbounds double, ptr [[TMP99]], i64 8
; CHECK-NEXT:    [[COL_LOAD135:%.*]] = load <2 x double>, ptr [[VEC_GEP134]], align 8
; CHECK-NEXT:    [[TMP100:%.*]] = getelementptr inbounds double, ptr [[B]], i64 6
; CHECK-NEXT:    [[COL_LOAD136:%.*]] = load <2 x double>, ptr [[TMP100]], align 8
; CHECK-NEXT:    [[VEC_GEP137:%.*]] = getelementptr inbounds double, ptr [[TMP100]], i64 8
...
; CHECK-NEXT:    [[TMP113:%.*]] = getelementptr inbounds double, ptr [[C]], i64 2
; CHECK-NEXT:    store <2 x double> [[TMP106]], ptr [[TMP113]], align 8
; CHECK-NEXT:    [[VEC_GEP153:%.*]] = getelementptr inbounds double, ptr [[TMP113]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP112]], ptr [[VEC_GEP153]], align 8
; CHECK-NEXT:    [[TMP114:%.*]] = getelementptr inbounds double, ptr [[A]], i64 4
; CHECK-NEXT:    [[COL_LOAD154:%.*]] = load <2 x double>, ptr [[TMP114]], align 8
; CHECK-NEXT:    [[VEC_GEP155:%.*]] = getelementptr inbounds double, ptr [[TMP114]], i64 8
; CHECK-NEXT:    [[COL_LOAD156:%.*]] = load <2 x double>, ptr [[VEC_GEP155]], align 8
; CHECK-NEXT:    [[TMP115:%.*]] = getelementptr inbounds double, ptr [[B]], i64 0
; CHECK-NEXT:    [[COL_LOAD157:%.*]] = load <2 x double>, ptr [[TMP115]], align 8
; CHECK-NEXT:    [[VEC_GEP158:%.*]] = getelementptr inbounds double, ptr [[TMP115]], i64 8
...
; CHECK-NEXT:    [[TMP128:%.*]] = getelementptr inbounds double, ptr [[A]], i64 20
; CHECK-NEXT:    [[COL_LOAD172:%.*]] = load <2 x double>, ptr [[TMP128]], align 8
; CHECK-NEXT:    [[VEC_GEP173:%.*]] = getelementptr inbounds double, ptr [[TMP128]], i64 8
; CHECK-NEXT:    [[COL_LOAD174:%.*]] = load <2 x double>, ptr [[VEC_GEP173]], align 8
; CHECK-NEXT:    [[TMP129:%.*]] = getelementptr inbounds double, ptr [[B]], i64 2
; CHECK-NEXT:    [[COL_LOAD175:%.*]] = load <2 x double>, ptr [[TMP129]], align 8
; CHECK-NEXT:    [[VEC_GEP176:%.*]] = getelementptr inbounds double, ptr [[TMP129]], i64 8
...
; CHECK-NEXT:    [[TMP142:%.*]] = getelementptr inbounds double, ptr [[A]], i64 36
; CHECK-NEXT:    [[COL_LOAD192:%.*]] = load <2 x double>, ptr [[TMP142]], align 8
; CHECK-NEXT:    [[VEC_GEP193:%.*]] = getelementptr inbounds double, ptr [[TMP142]], i64 8
; CHECK-NEXT:    [[COL_LOAD194:%.*]] = load <2 x double>, ptr [[VEC_GEP193]], align 8
; CHECK-NEXT:    [[TMP143:%.*]] = getelementptr inbounds double, ptr [[B]], i64 4
; CHECK-NEXT:    [[COL_LOAD195:%.*]] = load <2 x double>, ptr [[TMP143]], align 8
; CHECK-NEXT:    [[VEC_GEP196:%.*]] = getelementptr inbounds double, ptr [[TMP143]], i64 8
...
; CHECK-NEXT:    [[TMP156:%.*]] = getelementptr inbounds double, ptr [[A]], i64 52
; CHECK-NEXT:    [[COL_LOAD212:%.*]] = load <2 x double>, ptr [[TMP156]], align 8
; CHECK-NEXT:    [[VEC_GEP213:%.*]] = getelementptr inbounds double, ptr [[TMP156]], i64 8
; CHECK-NEXT:    [[COL_LOAD214:%.*]] = load <2 x double>, ptr [[VEC_GEP213]], align 8
; CHECK-NEXT:    [[TMP157:%.*]] = getelementptr inbounds double, ptr [[B]], i64 6
; CHECK-NEXT:    [[COL_LOAD215:%.*]] = load <2 x double>, ptr [[TMP157]], align 8
; CHECK-NEXT:    [[VEC_GEP216:%.*]] = getelementptr inbounds double, ptr [[TMP157]], i64 8
...
; CHECK-NEXT:    [[TMP170:%.*]] = getelementptr inbounds double, ptr [[C]], i64 4
; CHECK-NEXT:    store <2 x double> [[TMP163]], ptr [[TMP170]], align 8
; CHECK-NEXT:    [[VEC_GEP232:%.*]] = getelementptr inbounds double, ptr [[TMP170]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP169]], ptr [[VEC_GEP232]], align 8
; CHECK-NEXT:    [[TMP171:%.*]] = getelementptr inbounds double, ptr [[A]], i64 6
; CHECK-NEXT:    [[COL_LOAD233:%.*]] = load <2 x double>, ptr [[TMP171]], align 8
; CHECK-NEXT:    [[VEC_GEP234:%.*]] = getelementptr inbounds double, ptr [[TMP171]], i64 8
; CHECK-NEXT:    [[COL_LOAD235:%.*]] = load <2 x double>, ptr [[VEC_GEP234]], align 8
; CHECK-NEXT:    [[TMP172:%.*]] = getelementptr inbounds double, ptr [[B]], i64 0
; CHECK-NEXT:    [[COL_LOAD236:%.*]] = load <2 x double>, ptr [[TMP172]], align 8
; CHECK-NEXT:    [[VEC_GEP237:%.*]] = getelementptr inbounds double, ptr [[TMP172]], i64 8
...
; CHECK-NEXT:    [[TMP185:%.*]] = getelementptr inbounds double, ptr [[A]], i64 22
; CHECK-NEXT:    [[COL_LOAD251:%.*]] = load <2 x double>, ptr [[TMP185]], align 8
; CHECK-NEXT:    [[VEC_GEP252:%.*]] = getelementptr inbounds double, ptr [[TMP185]], i64 8
; CHECK-NEXT:    [[COL_LOAD253:%.*]] = load <2 x double>, ptr [[VEC_GEP252]], align 8
; CHECK-NEXT:    [[TMP186:%.*]] = getelementptr inbounds double, ptr [[B]], i64 2
; CHECK-NEXT:    [[COL_LOAD254:%.*]] = load <2 x double>, ptr [[TMP186]], align 8
; CHECK-NEXT:    [[VEC_GEP255:%.*]] = getelementptr inbounds double, ptr [[TMP186]], i64 8
...
; CHECK-NEXT:    [[TMP199:%.*]] = getelementptr inbounds double, ptr [[A]], i64 38
; CHECK-NEXT:    [[COL_LOAD271:%.*]] = load <2 x double>, ptr [[TMP199]], align 8
; CHECK-NEXT:    [[VEC_GEP272:%.*]] = getelementptr inbounds double, ptr [[TMP199]], i64 8
; CHECK-NEXT:    [[COL_LOAD273:%.*]] = load <2 x double>, ptr [[VEC_GEP272]], align 8
; CHECK-NEXT:    [[TMP200:%.*]] = getelementptr inbounds double, ptr [[B]], i64 4
; CHECK-NEXT:    [[COL_LOAD274:%.*]] = load <2 x double>, ptr [[TMP200]], align 8
; CHECK-NEXT:    [[VEC_GEP275:%.*]] = getelementptr inbounds double, ptr [[TMP200]], i64 8
...
; CHECK-NEXT:    [[TMP213:%.*]] = getelementptr inbounds double, ptr [[A]], i64 54
; CHECK-NEXT:    [[COL_LOAD291:%.*]] = load <2 x double>, ptr [[TMP213]], align 8
; CHECK-NEXT:    [[VEC_GEP292:%.*]] = getelementptr inbounds double, ptr [[TMP213]], i64 8
; CHECK-NEXT:    [[COL_LOAD293:%.*]] = load <2 x double>, ptr [[VEC_GEP292]], align 8
; CHECK-NEXT:    [[TMP214:%.*]] = getelementptr inbounds double, ptr [[B]], i64 6
; CHECK-NEXT:    [[COL_LOAD294:%.*]] = load <2 x double>, ptr [[TMP214]], align 8
; CHECK-NEXT:    [[VEC_GEP295:%.*]] = getelementptr inbounds double, ptr [[TMP214]], i64 8
...
; CHECK-NEXT:    [[TMP227:%.*]] = getelementptr inbounds double, ptr [[C]], i64 6
; CHECK-NEXT:    store <2 x double> [[TMP220]], ptr [[TMP227]], align 8
; CHECK-NEXT:    [[VEC_GEP311:%.*]] = getelementptr inbounds double, ptr [[TMP227]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP226]], ptr [[VEC_GEP311]], align 8
; CHECK-NEXT:    [[TMP228:%.*]] = getelementptr inbounds double, ptr [[A]], i64 0
; CHECK-NEXT:    [[COL_LOAD312:%.*]] = load <2 x double>, ptr [[TMP228]], align 8
; CHECK-NEXT:    [[VEC_GEP313:%.*]] = getelementptr inbounds double, ptr [[TMP228]], i64 8
; CHECK-NEXT:    [[COL_LOAD314:%.*]] = load <2 x double>, ptr [[VEC_GEP313]], align 8
; CHECK-NEXT:    [[TMP229:%.*]] = getelementptr inbounds double, ptr [[B]], i64 16
; CHECK-NEXT:    [[COL_LOAD315:%.*]] = load <2 x double>, ptr [[TMP229]], align 8
; CHECK-NEXT:    [[VEC_GEP316:%.*]] = getelementptr inbounds double, ptr [[TMP229]], i64 8
...
; CHECK-NEXT:    [[TMP242:%.*]] = getelementptr inbounds double, ptr [[A]], i64 16
; CHECK-NEXT:    [[COL_LOAD330:%.*]] = load <2 x double>, ptr [[TMP242]], align 8
; CHECK-NEXT:    [[VEC_GEP331:%.*]] = getelementptr inbounds double, ptr [[TMP242]], i64 8
; CHECK-NEXT:    [[COL_LOAD332:%.*]] = load <2 x double>, ptr [[VEC_GEP331]], align 8
; CHECK-NEXT:    [[TMP243:%.*]] = getelementptr inbounds double, ptr [[B]], i64 18
; CHECK-NEXT:    [[COL_LOAD333:%.*]] = load <2 x double>, ptr [[TMP243]], align 8
; CHECK-NEXT:    [[VEC_GEP334:%.*]] = getelementptr inbounds double, ptr [[TMP243]], i64 8
...
; CHECK-NEXT:    [[TMP256:%.*]] = getelementptr inbounds double, ptr [[A]], i64 32
; CHECK-NEXT:    [[COL_LOAD350:%.*]] = load <2 x double>, ptr [[TMP256]], align 8
; CHECK-NEXT:    [[VEC_GEP351:%.*]] = getelementptr inbounds double, ptr [[TMP256]], i64 8
; CHECK-NEXT:    [[COL_LOAD352:%.*]] = load <2 x double>, ptr [[VEC_GEP351]], align 8
; CHECK-NEXT:    [[TMP257:%.*]] = getelementptr inbounds double, ptr [[B]], i64 20
; CHECK-NEXT:    [[COL_LOAD353:%.*]] = load <2 x double>, ptr [[TMP257]], align 8
; CHECK-NEXT:    [[VEC_GEP354:%.*]] = getelementptr inbounds double, ptr [[TMP257]], i64 8
; CHECK-NEXT:    [[COL_LOAD355:%.*]] = load <2 x double>, ptr [[VEC_GEP354]], align 8
...
; CHECK-NEXT:    [[TMP270:%.*]] = getelementptr inbounds double, ptr [[A]], i64 48
; CHECK-NEXT:    [[COL_LOAD370:%.*]] = load <2 x double>, ptr [[TMP270]], align 8
; CHECK-NEXT:    [[VEC_GEP371:%.*]] = getelementptr inbounds double, ptr [[TMP270]], i64 8
; CHECK-NEXT:    [[COL_LOAD372:%.*]] = load <2 x double>, ptr [[VEC_GEP371]], align 8
; CHECK-NEXT:    [[TMP271:%.*]] = getelementptr inbounds double, ptr [[B]], i64 22
; CHECK-NEXT:    [[COL_LOAD373:%.*]] = load <2 x double>, ptr [[TMP271]], align 8
; CHECK-NEXT:    [[VEC_GEP374:%.*]] = getelementptr inbounds double, ptr [[TMP271]], i64 8
...
; CHECK-NEXT:    [[TMP284:%.*]] = getelementptr inbounds double, ptr [[C]], i64 16
; CHECK-NEXT:    store <2 x double> [[TMP277]], ptr [[TMP284]], align 8
; CHECK-NEXT:    [[VEC_GEP390:%.*]] = getelementptr inbounds double, ptr [[TMP284]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP283]], ptr [[VEC_GEP390]], align 8
; CHECK-NEXT:    [[TMP285:%.*]] = getelementptr inbounds double, ptr [[A]], i64 2
; CHECK-NEXT:    [[COL_LOAD391:%.*]] = load <2 x double>, ptr [[TMP285]], align 8
; CHECK-NEXT:    [[VEC_GEP392:%.*]] = getelementptr inbounds double, ptr [[TMP285]], i64 8
; CHECK-NEXT:    [[COL_LOAD393:%.*]] = load <2 x double>, ptr [[VEC_GEP392]], align 8
; CHECK-NEXT:    [[TMP286:%.*]] = getelementptr inbounds double, ptr [[B]], i64 16
; CHECK-NEXT:    [[COL_LOAD394:%.*]] = load <2 x double>, ptr [[TMP286]], align 8
; CHECK-NEXT:    [[VEC_GEP395:%.*]] = getelementptr inbounds double, ptr [[TMP286]], i64 8
...
; CHECK-NEXT:    [[TMP299:%.*]] = getelementptr inbounds double, ptr [[A]], i64 18
; CHECK-NEXT:    [[COL_LOAD409:%.*]] = load <2 x double>, ptr [[TMP299]], align 8
; CHECK-NEXT:    [[VEC_GEP410:%.*]] = getelementptr inbounds double, ptr [[TMP299]], i64 8
; CHECK-NEXT:    [[COL_LOAD411:%.*]] = load <2 x double>, ptr [[VEC_GEP410]], align 8
; CHECK-NEXT:    [[TMP300:%.*]] = getelementptr inbounds double, ptr [[B]], i64 18
; CHECK-NEXT:    [[COL_LOAD412:%.*]] = load <2 x double>, ptr [[TMP300]], align 8
; CHECK-NEXT:    [[VEC_GEP413:%.*]] = getelementptr inbounds double, ptr [[TMP300]], i64 8
...
; CHECK-NEXT:    [[TMP313:%.*]] = getelementptr inbounds double, ptr [[A]], i64 34
; CHECK-NEXT:    [[COL_LOAD429:%.*]] = load <2 x double>, ptr [[TMP313]], align 8
; CHECK-NEXT:    [[VEC_GEP430:%.*]] = getelementptr inbounds double, ptr [[TMP313]], i64 8
; CHECK-NEXT:    [[COL_LOAD431:%.*]] = load <2 x double>, ptr [[VEC_GEP430]], align 8
; CHECK-NEXT:    [[TMP314:%.*]] = getelementptr inbounds double, ptr [[B]], i64 20
; CHECK-NEXT:    [[COL_LOAD432:%.*]] = load <2 x double>, ptr [[TMP314]], align 8
; CHECK-NEXT:    [[VEC_GEP433:%.*]] = getelementptr inbounds double, ptr [[TMP314]], i64 8
...
; CHECK-NEXT:    [[TMP327:%.*]] = getelementptr inbounds double, ptr [[A]], i64 50
; CHECK-NEXT:    [[COL_LOAD449:%.*]] = load <2 x double>, ptr [[TMP327]], align 8
; CHECK-NEXT:    [[VEC_GEP450:%.*]] = getelementptr inbounds double, ptr [[TMP327]], i64 8
; CHECK-NEXT:    [[COL_LOAD451:%.*]] = load <2 x double>, ptr [[VEC_GEP450]], align 8
; CHECK-NEXT:    [[TMP328:%.*]] = getelementptr inbounds double, ptr [[B]], i64 22
; CHECK-NEXT:    [[COL_LOAD452:%.*]] = load <2 x double>, ptr [[TMP328]], align 8
; CHECK-NEXT:    [[VEC_GEP453:%.*]] = getelementptr inbounds double, ptr [[TMP328]], i64 8
...
; CHECK-NEXT:    [[TMP341:%.*]] = getelementptr inbounds double, ptr [[C]], i64 18
; CHECK-NEXT:    store <2 x double> [[TMP334]], ptr [[TMP341]], align 8
; CHECK-NEXT:    [[VEC_GEP469:%.*]] = getelementptr inbounds double, ptr [[TMP341]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP340]], ptr [[VEC_GEP469]], align 8
; CHECK-NEXT:    [[TMP342:%.*]] = getelementptr inbounds double, ptr [[A]], i64 4
; CHECK-NEXT:    [[COL_LOAD470:%.*]] = load <2 x double>, ptr [[TMP342]], align 8
; CHECK-NEXT:    [[VEC_GEP471:%.*]] = getelementptr inbounds double, ptr [[TMP342]], i64 8
; CHECK-NEXT:    [[COL_LOAD472:%.*]] = load <2 x double>, ptr [[VEC_GEP471]], align 8
; CHECK-NEXT:    [[TMP343:%.*]] = getelementptr inbounds double, ptr [[B]], i64 16
; CHECK-NEXT:    [[COL_LOAD473:%.*]] = load <2 x double>, ptr [[TMP343]], align 8
; CHECK-NEXT:    [[VEC_GEP474:%.*]] = getelementptr inbounds double, ptr [[TMP343]], i64 8
...
; CHECK-NEXT:    [[TMP356:%.*]] = getelementptr inbounds double, ptr [[A]], i64 20
; CHECK-NEXT:    [[COL_LOAD488:%.*]] = load <2 x double>, ptr [[TMP356]], align 8
; CHECK-NEXT:    [[VEC_GEP489:%.*]] = getelementptr inbounds double, ptr [[TMP356]], i64 8
; CHECK-NEXT:    [[COL_LOAD490:%.*]] = load <2 x double>, ptr [[VEC_GEP489]], align 8
; CHECK-NEXT:    [[TMP357:%.*]] = getelementptr inbounds double, ptr [[B]], i64 18
; CHECK-NEXT:    [[COL_LOAD491:%.*]] = load <2 x double>, ptr [[TMP357]], align 8
; CHECK-NEXT:    [[VEC_GEP492:%.*]] = getelementptr inbounds double, ptr [[TMP357]], i64 8
...
; CHECK-NEXT:    [[TMP370:%.*]] = getelementptr inbounds double, ptr [[A]], i64 36
; CHECK-NEXT:    [[COL_LOAD508:%.*]] = load <2 x double>, ptr [[TMP370]], align 8
; CHECK-NEXT:    [[VEC_GEP509:%.*]] = getelementptr inbounds double, ptr [[TMP370]], i64 8
; CHECK-NEXT:    [[COL_LOAD510:%.*]] = load <2 x double>, ptr [[VEC_GEP509]], align 8
; CHECK-NEXT:    [[TMP371:%.*]] = getelementptr inbounds double, ptr [[B]], i64 20
; CHECK-NEXT:    [[COL_LOAD511:%.*]] = load <2 x double>, ptr [[TMP371]], align 8
; CHECK-NEXT:    [[VEC_GEP512:%.*]] = getelementptr inbounds double, ptr [[TMP371]], i64 8
...
; CHECK-NEXT:    [[TMP384:%.*]] = getelementptr inbounds double, ptr [[A]], i64 52
; CHECK-NEXT:    [[COL_LOAD528:%.*]] = load <2 x double>, ptr [[TMP384]], align 8
; CHECK-NEXT:    [[VEC_GEP529:%.*]] = getelementptr inbounds double, ptr [[TMP384]], i64 8
; CHECK-NEXT:    [[COL_LOAD530:%.*]] = load <2 x double>, ptr [[VEC_GEP529]], align 8
; CHECK-NEXT:    [[TMP385:%.*]] = getelementptr inbounds double, ptr [[B]], i64 22
; CHECK-NEXT:    [[COL_LOAD531:%.*]] = load <2 x double>, ptr [[TMP385]], align 8
; CHECK-NEXT:    [[VEC_GEP532:%.*]] = getelementptr inbounds double, ptr [[TMP385]], i64 8
...
; CHECK-NEXT:    [[TMP398:%.*]] = getelementptr inbounds double, ptr [[C]], i64 20
; CHECK-NEXT:    store <2 x double> [[TMP391]], ptr [[TMP398]], align 8
; CHECK-NEXT:    [[VEC_GEP548:%.*]] = getelementptr inbounds double, ptr [[TMP398]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP397]], ptr [[VEC_GEP548]], align 8
; CHECK-NEXT:    [[TMP399:%.*]] = getelementptr inbounds double, ptr [[A]], i64 6
; CHECK-NEXT:    [[COL_LOAD549:%.*]] = load <2 x double>, ptr [[TMP399]], align 8
; CHECK-NEXT:    [[VEC_GEP550:%.*]] = getelementptr inbounds double, ptr [[TMP399]], i64 8
; CHECK-NEXT:    [[COL_LOAD551:%.*]] = load <2 x double>, ptr [[VEC_GEP550]], align 8
; CHECK-NEXT:    [[TMP400:%.*]] = getelementptr inbounds double, ptr [[B]], i64 16
; CHECK-NEXT:    [[COL_LOAD552:%.*]] = load <2 x double>, ptr [[TMP400]], align 8
; CHECK-NEXT:    [[VEC_GEP553:%.*]] = getelementptr inbounds double, ptr [[TMP400]], i64 8
...
; CHECK-NEXT:    [[TMP413:%.*]] = getelementptr inbounds double, ptr [[A]], i64 22
; CHECK-NEXT:    [[COL_LOAD567:%.*]] = load <2 x double>, ptr [[TMP413]], align 8
; CHECK-NEXT:    [[VEC_GEP568:%.*]] = getelementptr inbounds double, ptr [[TMP413]], i64 8
; CHECK-NEXT:    [[COL_LOAD569:%.*]] = load <2 x double>, ptr [[VEC_GEP568]], align 8
; CHECK-NEXT:    [[TMP414:%.*]] = getelementptr inbounds double, ptr [[B]], i64 18
; CHECK-NEXT:    [[COL_LOAD570:%.*]] = load <2 x double>, ptr [[TMP414]], align 8
; CHECK-NEXT:    [[VEC_GEP571:%.*]] = getelementptr inbounds double, ptr [[TMP414]], i64 8
...
; CHECK-NEXT:    [[TMP427:%.*]] = getelementptr inbounds double, ptr [[A]], i64 38
; CHECK-NEXT:    [[COL_LOAD587:%.*]] = load <2 x double>, ptr [[TMP427]], align 8
; CHECK-NEXT:    [[VEC_GEP588:%.*]] = getelementptr inbounds double, ptr [[TMP427]], i64 8
; CHECK-NEXT:    [[COL_LOAD589:%.*]] = load <2 x double>, ptr [[VEC_GEP588]], align 8
; CHECK-NEXT:    [[TMP428:%.*]] = getelementptr inbounds double, ptr [[B]], i64 20
; CHECK-NEXT:    [[COL_LOAD590:%.*]] = load <2 x double>, ptr [[TMP428]], align 8
; CHECK-NEXT:    [[VEC_GEP591:%.*]] = getelementptr inbounds double, ptr [[TMP428]], i64 8
...
; CHECK-NEXT:    [[TMP441:%.*]] = getelementptr inbounds double, ptr [[A]], i64 54
; CHECK-NEXT:    [[COL_LOAD607:%.*]] = load <2 x double>, ptr [[TMP441]], align 8
; CHECK-NEXT:    [[VEC_GEP608:%.*]] = getelementptr inbounds double, ptr [[TMP441]], i64 8
; CHECK-NEXT:    [[COL_LOAD609:%.*]] = load <2 x double>, ptr [[VEC_GEP608]], align 8
; CHECK-NEXT:    [[TMP442:%.*]] = getelementptr inbounds double, ptr [[B]], i64 22
; CHECK-NEXT:    [[COL_LOAD610:%.*]] = load <2 x double>, ptr [[TMP442]], align 8
; CHECK-NEXT:    [[VEC_GEP611:%.*]] = getelementptr inbounds double, ptr [[TMP442]], i64 8
...
; CHECK-NEXT:    [[TMP455:%.*]] = getelementptr inbounds double, ptr [[C]], i64 22
; CHECK-NEXT:    store <2 x double> [[TMP448]], ptr [[TMP455]], align 8
; CHECK-NEXT:    [[VEC_GEP627:%.*]] = getelementptr inbounds double, ptr [[TMP455]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP454]], ptr [[VEC_GEP627]], align 8
; CHECK-NEXT:    [[TMP456:%.*]] = getelementptr inbounds double, ptr [[A]], i64 0
; CHECK-NEXT:    [[COL_LOAD628:%.*]] = load <2 x double>, ptr [[TMP456]], align 8
; CHECK-NEXT:    [[VEC_GEP629:%.*]] = getelementptr inbounds double, ptr [[TMP456]], i64 8
; CHECK-NEXT:    [[COL_LOAD630:%.*]] = load <2 x double>, ptr [[VEC_GEP629]], align 8
; CHECK-NEXT:    [[TMP457:%.*]] = getelementptr inbounds double, ptr [[B]], i64 32
; CHECK-NEXT:    [[COL_LOAD631:%.*]] = load <2 x double>, ptr [[TMP457]], align 8
; CHECK-NEXT:    [[VEC_GEP632:%.*]] = getelementptr inbounds double, ptr [[TMP457]], i64 8
...
; CHECK-NEXT:    [[TMP470:%.*]] = getelementptr inbounds double, ptr [[A]], i64 16
; CHECK-NEXT:    [[COL_LOAD646:%.*]] = load <2 x double>, ptr [[TMP470]], align 8
; CHECK-NEXT:    [[VEC_GEP647:%.*]] = getelementptr inbounds double, ptr [[TMP470]], i64 8
; CHECK-NEXT:    [[COL_LOAD648:%.*]] = load <2 x double>, ptr [[VEC_GEP647]], align 8
; CHECK-NEXT:    [[TMP471:%.*]] = getelementptr inbounds double, ptr [[B]], i64 34
; CHECK-NEXT:    [[COL_LOAD649:%.*]] = load <2 x double>, ptr [[TMP471]], align 8
; CHECK-NEXT:    [[VEC_GEP650:%.*]] = getelementptr inbounds double, ptr [[TMP471]], i64 8
...
; CHECK-NEXT:    [[TMP484:%.*]] = getelementptr inbounds double, ptr [[A]], i64 32
; CHECK-NEXT:    [[COL_LOAD666:%.*]] = load <2 x double>, ptr [[TMP484]], align 8
; CHECK-NEXT:    [[VEC_GEP667:%.*]] = getelementptr inbounds double, ptr [[TMP484]], i64 8
; CHECK-NEXT:    [[COL_LOAD668:%.*]] = load <2 x double>, ptr [[VEC_GEP667]], align 8
; CHECK-NEXT:    [[TMP485:%.*]] = getelementptr inbounds double, ptr [[B]], i64 36
; CHECK-NEXT:    [[COL_LOAD669:%.*]] = load <2 x double>, ptr [[TMP485]], align 8
; CHECK-NEXT:    [[VEC_GEP670:%.*]] = getelementptr inbounds double, ptr [[TMP485]], i64 8
...
; CHECK-NEXT:    [[TMP498:%.*]] = getelementptr inbounds double, ptr [[A]], i64 48
; CHECK-NEXT:    [[COL_LOAD686:%.*]] = load <2 x double>, ptr [[TMP498]], align 8
; CHECK-NEXT:    [[VEC_GEP687:%.*]] = getelementptr inbounds double, ptr [[TMP498]], i64 8
; CHECK-NEXT:    [[COL_LOAD688:%.*]] = load <2 x double>, ptr [[VEC_GEP687]], align 8
; CHECK-NEXT:    [[TMP499:%.*]] = getelementptr inbounds double, ptr [[B]], i64 38
; CHECK-NEXT:    [[COL_LOAD689:%.*]] = load <2 x double>, ptr [[TMP499]], align 8
; CHECK-NEXT:    [[VEC_GEP690:%.*]] = getelementptr inbounds double, ptr [[TMP499]], i64 8
...
; CHECK-NEXT:    [[TMP512:%.*]] = getelementptr inbounds double, ptr [[C]], i64 32
; CHECK-NEXT:    store <2 x double> [[TMP505]], ptr [[TMP512]], align 8
; CHECK-NEXT:    [[VEC_GEP706:%.*]] = getelementptr inbounds double, ptr [[TMP512]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP511]], ptr [[VEC_GEP706]], align 8
; CHECK-NEXT:    [[TMP513:%.*]] = getelementptr inbounds double, ptr [[A]], i64 2
; CHECK-NEXT:    [[COL_LOAD707:%.*]] = load <2 x double>, ptr [[TMP513]], align 8
; CHECK-NEXT:    [[VEC_GEP708:%.*]] = getelementptr inbounds double, ptr [[TMP513]], i64 8
; CHECK-NEXT:    [[COL_LOAD709:%.*]] = load <2 x double>, ptr [[VEC_GEP708]], align 8
; CHECK-NEXT:    [[TMP514:%.*]] = getelementptr inbounds double, ptr [[B]], i64 32
; CHECK-NEXT:    [[COL_LOAD710:%.*]] = load <2 x double>, ptr [[TMP514]], align 8
; CHECK-NEXT:    [[VEC_GEP711:%.*]] = getelementptr inbounds double, ptr [[TMP514]], i64 8
...
; CHECK-NEXT:    [[TMP527:%.*]] = getelementptr inbounds double, ptr [[A]], i64 18
; CHECK-NEXT:    [[COL_LOAD725:%.*]] = load <2 x double>, ptr [[TMP527]], align 8
; CHECK-NEXT:    [[VEC_GEP726:%.*]] = getelementptr inbounds double, ptr [[TMP527]], i64 8
; CHECK-NEXT:    [[COL_LOAD727:%.*]] = load <2 x double>, ptr [[VEC_GEP726]], align 8
; CHECK-NEXT:    [[TMP528:%.*]] = getelementptr inbounds double, ptr [[B]], i64 34
; CHECK-NEXT:    [[COL_LOAD728:%.*]] = load <2 x double>, ptr [[TMP528]], align 8
; CHECK-NEXT:    [[VEC_GEP729:%.*]] = getelementptr inbounds double, ptr [[TMP528]], i64 8
...
; CHECK-NEXT:    [[TMP541:%.*]] = getelementptr inbounds double, ptr [[A]], i64 34
; CHECK-NEXT:    [[COL_LOAD745:%.*]] = load <2 x double>, ptr [[TMP541]], align 8
; CHECK-NEXT:    [[VEC_GEP746:%.*]] = getelementptr inbounds double, ptr [[TMP541]], i64 8
; CHECK-NEXT:    [[COL_LOAD747:%.*]] = load <2 x double>, ptr [[VEC_GEP746]], align 8
; CHECK-NEXT:    [[TMP542:%.*]] = getelementptr inbounds double, ptr [[B]], i64 36
; CHECK-NEXT:    [[COL_LOAD748:%.*]] = load <2 x double>, ptr [[TMP542]], align 8
; CHECK-NEXT:    [[VEC_GEP749:%.*]] = getelementptr inbounds double, ptr [[TMP542]], i64 8
...
; CHECK-NEXT:    [[TMP555:%.*]] = getelementptr inbounds double, ptr [[A]], i64 50
; CHECK-NEXT:    [[COL_LOAD765:%.*]] = load <2 x double>, ptr [[TMP555]], align 8
; CHECK-NEXT:    [[VEC_GEP766:%.*]] = getelementptr inbounds double, ptr [[TMP555]], i64 8
; CHECK-NEXT:    [[COL_LOAD767:%.*]] = load <2 x double>, ptr [[VEC_GEP766]], align 8
; CHECK-NEXT:    [[TMP556:%.*]] = getelementptr inbounds double, ptr [[B]], i64 38
; CHECK-NEXT:    [[COL_LOAD768:%.*]] = load <2 x double>, ptr [[TMP556]], align 8
; CHECK-NEXT:    [[VEC_GEP769:%.*]] = getelementptr inbounds double, ptr [[TMP556]], i64 8
...
; CHECK-NEXT:    [[TMP569:%.*]] = getelementptr inbounds double, ptr [[C]], i64 34
; CHECK-NEXT:    store <2 x double> [[TMP562]], ptr [[TMP569]], align 8
; CHECK-NEXT:    [[VEC_GEP785:%.*]] = getelementptr inbounds double, ptr [[TMP569]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP568]], ptr [[VEC_GEP785]], align 8
; CHECK-NEXT:    [[TMP570:%.*]] = getelementptr inbounds double, ptr [[A]], i64 4
; CHECK-NEXT:    [[COL_LOAD786:%.*]] = load <2 x double>, ptr [[TMP570]], align 8
; CHECK-NEXT:    [[VEC_GEP787:%.*]] = getelementptr inbounds double, ptr [[TMP570]], i64 8
; CHECK-NEXT:    [[COL_LOAD788:%.*]] = load <2 x double>, ptr [[VEC_GEP787]], align 8
; CHECK-NEXT:    [[TMP571:%.*]] = getelementptr inbounds double, ptr [[B]], i64 32
; CHECK-NEXT:    [[COL_LOAD789:%.*]] = load <2 x double>, ptr [[TMP571]], align 8
; CHECK-NEXT:    [[VEC_GEP790:%.*]] = getelementptr inbounds double, ptr [[TMP571]], i64 8
...
; CHECK-NEXT:    [[TMP584:%.*]] = getelementptr inbounds double, ptr [[A]], i64 20
; CHECK-NEXT:    [[COL_LOAD804:%.*]] = load <2 x double>, ptr [[TMP584]], align 8
; CHECK-NEXT:    [[VEC_GEP805:%.*]] = getelementptr inbounds double, ptr [[TMP584]], i64 8
; CHECK-NEXT:    [[COL_LOAD806:%.*]] = load <2 x double>, ptr [[VEC_GEP805]], align 8
; CHECK-NEXT:    [[TMP585:%.*]] = getelementptr inbounds double, ptr [[B]], i64 34
; CHECK-NEXT:    [[COL_LOAD807:%.*]] = load <2 x double>, ptr [[TMP585]], align 8
; CHECK-NEXT:    [[VEC_GEP808:%.*]] = getelementptr inbounds double, ptr [[TMP585]], i64 8
...
; CHECK-NEXT:    [[TMP598:%.*]] = getelementptr inbounds double, ptr [[A]], i64 36
; CHECK-NEXT:    [[COL_LOAD824:%.*]] = load <2 x double>, ptr [[TMP598]], align 8
; CHECK-NEXT:    [[VEC_GEP825:%.*]] = getelementptr inbounds double, ptr [[TMP598]], i64 8
; CHECK-NEXT:    [[COL_LOAD826:%.*]] = load <2 x double>, ptr [[VEC_GEP825]], align 8
; CHECK-NEXT:    [[TMP599:%.*]] = getelementptr inbounds double, ptr [[B]], i64 36
; CHECK-NEXT:    [[COL_LOAD827:%.*]] = load <2 x double>, ptr [[TMP599]], align 8
; CHECK-NEXT:    [[VEC_GEP828:%.*]] = getelementptr inbounds double, ptr [[TMP599]], i64 8
...
; CHECK-NEXT:    [[TMP612:%.*]] = getelementptr inbounds double, ptr [[A]], i64 52
; CHECK-NEXT:    [[COL_LOAD844:%.*]] = load <2 x double>, ptr [[TMP612]], align 8
; CHECK-NEXT:    [[VEC_GEP845:%.*]] = getelementptr inbounds double, ptr [[TMP612]], i64 8
; CHECK-NEXT:    [[COL_LOAD846:%.*]] = load <2 x double>, ptr [[VEC_GEP845]], align 8
; CHECK-NEXT:    [[TMP613:%.*]] = getelementptr inbounds double, ptr [[B]], i64 38
; CHECK-NEXT:    [[COL_LOAD847:%.*]] = load <2 x double>, ptr [[TMP613]], align 8
; CHECK-NEXT:    [[VEC_GEP848:%.*]] = getelementptr inbounds double, ptr [[TMP613]], i64 8
...
; CHECK-NEXT:    [[TMP626:%.*]] = getelementptr inbounds double, ptr [[C]], i64 36
; CHECK-NEXT:    store <2 x double> [[TMP619]], ptr [[TMP626]], align 8
; CHECK-NEXT:    [[VEC_GEP864:%.*]] = getelementptr inbounds double, ptr [[TMP626]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP625]], ptr [[VEC_GEP864]], align 8
; CHECK-NEXT:    [[TMP627:%.*]] = getelementptr inbounds double, ptr [[A]], i64 6
; CHECK-NEXT:    [[COL_LOAD865:%.*]] = load <2 x double>, ptr [[TMP627]], align 8
; CHECK-NEXT:    [[VEC_GEP866:%.*]] = getelementptr inbounds double, ptr [[TMP627]], i64 8
; CHECK-NEXT:    [[COL_LOAD867:%.*]] = load <2 x double>, ptr [[VEC_GEP866]], align 8
; CHECK-NEXT:    [[TMP628:%.*]] = getelementptr inbounds double, ptr [[B]], i64 32
; CHECK-NEXT:    [[COL_LOAD868:%.*]] = load <2 x double>, ptr [[TMP628]], align 8
; CHECK-NEXT:    [[VEC_GEP869:%.*]] = getelementptr inbounds double, ptr [[TMP628]], i64 8
...
; CHECK-NEXT:    [[TMP641:%.*]] = getelementptr inbounds double, ptr [[A]], i64 22
; CHECK-NEXT:    [[COL_LOAD883:%.*]] = load <2 x double>, ptr [[TMP641]], align 8
; CHECK-NEXT:    [[VEC_GEP884:%.*]] = getelementptr inbounds double, ptr [[TMP641]], i64 8
; CHECK-NEXT:    [[COL_LOAD885:%.*]] = load <2 x double>, ptr [[VEC_GEP884]], align 8
; CHECK-NEXT:    [[TMP642:%.*]] = getelementptr inbounds double, ptr [[B]], i64 34
; CHECK-NEXT:    [[COL_LOAD886:%.*]] = load <2 x double>, ptr [[TMP642]], align 8
; CHECK-NEXT:    [[VEC_GEP887:%.*]] = getelementptr inbounds double, ptr [[TMP642]], i64 8
...
; CHECK-NEXT:    [[TMP655:%.*]] = getelementptr inbounds double, ptr [[A]], i64 38
; CHECK-NEXT:    [[COL_LOAD903:%.*]] = load <2 x double>, ptr [[TMP655]], align 8
; CHECK-NEXT:    [[VEC_GEP904:%.*]] = getelementptr inbounds double, ptr [[TMP655]], i64 8
; CHECK-NEXT:    [[COL_LOAD905:%.*]] = load <2 x double>, ptr [[VEC_GEP904]], align 8
; CHECK-NEXT:    [[TMP656:%.*]] = getelementptr inbounds double, ptr [[B]], i64 36
; CHECK-NEXT:    [[COL_LOAD906:%.*]] = load <2 x double>, ptr [[TMP656]], align 8
; CHECK-NEXT:    [[VEC_GEP907:%.*]] = getelementptr inbounds double, ptr [[TMP656]], i64 8
...
; CHECK-NEXT:    [[TMP669:%.*]] = getelementptr inbounds double, ptr [[A]], i64 54
; CHECK-NEXT:    [[COL_LOAD923:%.*]] = load <2 x double>, ptr [[TMP669]], align 8
; CHECK-NEXT:    [[VEC_GEP924:%.*]] = getelementptr inbounds double, ptr [[TMP669]], i64 8
; CHECK-NEXT:    [[COL_LOAD925:%.*]] = load <2 x double>, ptr [[VEC_GEP924]], align 8
; CHECK-NEXT:    [[TMP670:%.*]] = getelementptr inbounds double, ptr [[B]], i64 38
; CHECK-NEXT:    [[COL_LOAD926:%.*]] = load <2 x double>, ptr [[TMP670]], align 8
; CHECK-NEXT:    [[VEC_GEP927:%.*]] = getelementptr inbounds double, ptr [[TMP670]], i64 8
...
; CHECK-NEXT:    [[TMP683:%.*]] = getelementptr inbounds double, ptr [[C]], i64 38
; CHECK-NEXT:    store <2 x double> [[TMP676]], ptr [[TMP683]], align 8
; CHECK-NEXT:    [[VEC_GEP943:%.*]] = getelementptr inbounds double, ptr [[TMP683]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP682]], ptr [[VEC_GEP943]], align 8
; CHECK-NEXT:    [[TMP684:%.*]] = getelementptr inbounds double, ptr [[A]], i64 0
; CHECK-NEXT:    [[COL_LOAD944:%.*]] = load <2 x double>, ptr [[TMP684]], align 8
; CHECK-NEXT:    [[VEC_GEP945:%.*]] = getelementptr inbounds double, ptr [[TMP684]], i64 8
; CHECK-NEXT:    [[COL_LOAD946:%.*]] = load <2 x double>, ptr [[VEC_GEP945]], align 8
; CHECK-NEXT:    [[TMP685:%.*]] = getelementptr inbounds double, ptr [[B]], i64 48
; CHECK-NEXT:    [[COL_LOAD947:%.*]] = load <2 x double>, ptr [[TMP685]], align 8
; CHECK-NEXT:    [[VEC_GEP948:%.*]] = getelementptr inbounds double, ptr [[TMP685]], i64 8
...
; CHECK-NEXT:    [[TMP698:%.*]] = getelementptr inbounds double, ptr [[A]], i64 16
; CHECK-NEXT:    [[COL_LOAD962:%.*]] = load <2 x double>, ptr [[TMP698]], align 8
; CHECK-NEXT:    [[VEC_GEP963:%.*]] = getelementptr inbounds double, ptr [[TMP698]], i64 8
; CHECK-NEXT:    [[COL_LOAD964:%.*]] = load <2 x double>, ptr [[VEC_GEP963]], align 8
; CHECK-NEXT:    [[TMP699:%.*]] = getelementptr inbounds double, ptr [[B]], i64 50
; CHECK-NEXT:    [[COL_LOAD965:%.*]] = load <2 x double>, ptr [[TMP699]], align 8
; CHECK-NEXT:    [[VEC_GEP966:%.*]] = getelementptr inbounds double, ptr [[TMP699]], i64 8
...
; CHECK-NEXT:    [[TMP712:%.*]] = getelementptr inbounds double, ptr [[A]], i64 32
; CHECK-NEXT:    [[COL_LOAD982:%.*]] = load <2 x double>, ptr [[TMP712]], align 8
; CHECK-NEXT:    [[VEC_GEP983:%.*]] = getelementptr inbounds double, ptr [[TMP712]], i64 8
; CHECK-NEXT:    [[COL_LOAD984:%.*]] = load <2 x double>, ptr [[VEC_GEP983]], align 8
; CHECK-NEXT:    [[TMP713:%.*]] = getelementptr inbounds double, ptr [[B]], i64 52
; CHECK-NEXT:    [[COL_LOAD985:%.*]] = load <2 x double>, ptr [[TMP713]], align 8
; CHECK-NEXT:    [[VEC_GEP986:%.*]] = getelementptr inbounds double, ptr [[TMP713]], i64 8
...
; CHECK-NEXT:    [[TMP726:%.*]] = getelementptr inbounds double, ptr [[A]], i64 48
; CHECK-NEXT:    [[COL_LOAD1002:%.*]] = load <2 x double>, ptr [[TMP726]], align 8
; CHECK-NEXT:    [[VEC_GEP1003:%.*]] = getelementptr inbounds double, ptr [[TMP726]], i64 8
; CHECK-NEXT:    [[COL_LOAD1004:%.*]] = load <2 x double>, ptr [[VEC_GEP1003]], align 8
; CHECK-NEXT:    [[TMP727:%.*]] = getelementptr inbounds double, ptr [[B]], i64 54
; CHECK-NEXT:    [[COL_LOAD1005:%.*]] = load <2 x double>, ptr [[TMP727]], align 8
; CHECK-NEXT:    [[VEC_GEP1006:%.*]] = getelementptr inbounds double, ptr [[TMP727]], i64 8
...
; CHECK-NEXT:    [[TMP740:%.*]] = getelementptr inbounds double, ptr [[C]], i64 48
; CHECK-NEXT:    store <2 x double> [[TMP733]], ptr [[TMP740]], align 8
; CHECK-NEXT:    [[VEC_GEP1022:%.*]] = getelementptr inbounds double, ptr [[TMP740]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP739]], ptr [[VEC_GEP1022]], align 8
; CHECK-NEXT:    [[TMP741:%.*]] = getelementptr inbounds double, ptr [[A]], i64 2
; CHECK-NEXT:    [[COL_LOAD1023:%.*]] = load <2 x double>, ptr [[TMP741]], align 8
; CHECK-NEXT:    [[VEC_GEP1024:%.*]] = getelementptr inbounds double, ptr [[TMP741]], i64 8
; CHECK-NEXT:    [[COL_LOAD1025:%.*]] = load <2 x double>, ptr [[VEC_GEP1024]], align 8
; CHECK-NEXT:    [[TMP742:%.*]] = getelementptr inbounds double, ptr [[B]], i64 48
; CHECK-NEXT:    [[COL_LOAD1026:%.*]] = load <2 x double>, ptr [[TMP742]], align 8
; CHECK-NEXT:    [[VEC_GEP1027:%.*]] = getelementptr inbounds double, ptr [[TMP742]], i64 8
...
; CHECK-NEXT:    [[TMP755:%.*]] = getelementptr inbounds double, ptr [[A]], i64 18
; CHECK-NEXT:    [[COL_LOAD1041:%.*]] = load <2 x double>, ptr [[TMP755]], align 8
; CHECK-NEXT:    [[VEC_GEP1042:%.*]] = getelementptr inbounds double, ptr [[TMP755]], i64 8
; CHECK-NEXT:    [[COL_LOAD1043:%.*]] = load <2 x double>, ptr [[VEC_GEP1042]], align 8
; CHECK-NEXT:    [[TMP756:%.*]] = getelementptr inbounds double, ptr [[B]], i64 50
; CHECK-NEXT:    [[COL_LOAD1044:%.*]] = load <2 x double>, ptr [[TMP756]], align 8
; CHECK-NEXT:    [[VEC_GEP1045:%.*]] = getelementptr inbounds double, ptr [[TMP756]], i64 8
...
; CHECK-NEXT:    [[TMP769:%.*]] = getelementptr inbounds double, ptr [[A]], i64 34
; CHECK-NEXT:    [[COL_LOAD1061:%.*]] = load <2 x double>, ptr [[TMP769]], align 8
; CHECK-NEXT:    [[VEC_GEP1062:%.*]] = getelementptr inbounds double, ptr [[TMP769]], i64 8
; CHECK-NEXT:    [[COL_LOAD1063:%.*]] = load <2 x double>, ptr [[VEC_GEP1062]], align 8
; CHECK-NEXT:    [[TMP770:%.*]] = getelementptr inbounds double, ptr [[B]], i64 52
; CHECK-NEXT:    [[COL_LOAD1064:%.*]] = load <2 x double>, ptr [[TMP770]], align 8
; CHECK-NEXT:    [[VEC_GEP1065:%.*]] = getelementptr inbounds double, ptr [[TMP770]], i64 8
...
; CHECK-NEXT:    [[TMP783:%.*]] = getelementptr inbounds double, ptr [[A]], i64 50
; CHECK-NEXT:    [[COL_LOAD1081:%.*]] = load <2 x double>, ptr [[TMP783]], align 8
; CHECK-NEXT:    [[VEC_GEP1082:%.*]] = getelementptr inbounds double, ptr [[TMP783]], i64 8
; CHECK-NEXT:    [[COL_LOAD1083:%.*]] = load <2 x double>, ptr [[VEC_GEP1082]], align 8
; CHECK-NEXT:    [[TMP784:%.*]] = getelementptr inbounds double, ptr [[B]], i64 54
; CHECK-NEXT:    [[COL_LOAD1084:%.*]] = load <2 x double>, ptr [[TMP784]], align 8
; CHECK-NEXT:    [[VEC_GEP1085:%.*]] = getelementptr inbounds double, ptr [[TMP784]], i64 8
...
; CHECK-NEXT:    [[TMP797:%.*]] = getelementptr inbounds double, ptr [[C]], i64 50
; CHECK-NEXT:    store <2 x double> [[TMP790]], ptr [[TMP797]], align 8
; CHECK-NEXT:    [[VEC_GEP1101:%.*]] = getelementptr inbounds double, ptr [[TMP797]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP796]], ptr [[VEC_GEP1101]], align 8
; CHECK-NEXT:    [[TMP798:%.*]] = getelementptr inbounds double, ptr [[A]], i64 4
; CHECK-NEXT:    [[COL_LOAD1102:%.*]] = load <2 x double>, ptr [[TMP798]], align 8
; CHECK-NEXT:    [[VEC_GEP1103:%.*]] = getelementptr inbounds double, ptr [[TMP798]], i64 8
; CHECK-NEXT:    [[COL_LOAD1104:%.*]] = load <2 x double>, ptr [[VEC_GEP1103]], align 8
; CHECK-NEXT:    [[TMP799:%.*]] = getelementptr inbounds double, ptr [[B]], i64 48
; CHECK-NEXT:    [[COL_LOAD1105:%.*]] = load <2 x double>, ptr [[TMP799]], align 8
; CHECK-NEXT:    [[VEC_GEP1106:%.*]] = getelementptr inbounds double, ptr [[TMP799]], i64 8
...
; CHECK-NEXT:    [[TMP812:%.*]] = getelementptr inbounds double, ptr [[A]], i64 20
; CHECK-NEXT:    [[COL_LOAD1120:%.*]] = load <2 x double>, ptr [[TMP812]], align 8
; CHECK-NEXT:    [[VEC_GEP1121:%.*]] = getelementptr inbounds double, ptr [[TMP812]], i64 8
; CHECK-NEXT:    [[COL_LOAD1122:%.*]] = load <2 x double>, ptr [[VEC_GEP1121]], align 8
; CHECK-NEXT:    [[TMP813:%.*]] = getelementptr inbounds double, ptr [[B]], i64 50
; CHECK-NEXT:    [[COL_LOAD1123:%.*]] = load <2 x double>, ptr [[TMP813]], align 8
; CHECK-NEXT:    [[VEC_GEP1124:%.*]] = getelementptr inbounds double, ptr [[TMP813]], i64 8
...
; CHECK-NEXT:    [[TMP826:%.*]] = getelementptr inbounds double, ptr [[A]], i64 36
; CHECK-NEXT:    [[COL_LOAD1140:%.*]] = load <2 x double>, ptr [[TMP826]], align 8
; CHECK-NEXT:    [[VEC_GEP1141:%.*]] = getelementptr inbounds double, ptr [[TMP826]], i64 8
; CHECK-NEXT:    [[COL_LOAD1142:%.*]] = load <2 x double>, ptr [[VEC_GEP1141]], align 8
; CHECK-NEXT:    [[TMP827:%.*]] = getelementptr inbounds double, ptr [[B]], i64 52
; CHECK-NEXT:    [[COL_LOAD1143:%.*]] = load <2 x double>, ptr [[TMP827]], align 8
; CHECK-NEXT:    [[VEC_GEP1144:%.*]] = getelementptr inbounds double, ptr [[TMP827]], i64 8
...
; CHECK-NEXT:    [[TMP840:%.*]] = getelementptr inbounds double, ptr [[A]], i64 52
; CHECK-NEXT:    [[COL_LOAD1160:%.*]] = load <2 x double>, ptr [[TMP840]], align 8
; CHECK-NEXT:    [[VEC_GEP1161:%.*]] = getelementptr inbounds double, ptr [[TMP840]], i64 8
; CHECK-NEXT:    [[COL_LOAD1162:%.*]] = load <2 x double>, ptr [[VEC_GEP1161]], align 8
; CHECK-NEXT:    [[TMP841:%.*]] = getelementptr inbounds double, ptr [[B]], i64 54
; CHECK-NEXT:    [[COL_LOAD1163:%.*]] = load <2 x double>, ptr [[TMP841]], align 8
; CHECK-NEXT:    [[VEC_GEP1164:%.*]] = getelementptr inbounds double, ptr [[TMP841]], i64 8
...
; CHECK-NEXT:    [[TMP854:%.*]] = getelementptr inbounds double, ptr [[C]], i64 52
; CHECK-NEXT:    store <2 x double> [[TMP847]], ptr [[TMP854]], align 8
; CHECK-NEXT:    [[VEC_GEP1180:%.*]] = getelementptr inbounds double, ptr [[TMP854]], i64 8
; CHECK-NEXT:    store <2 x double> [[TMP853]], ptr [[VEC_GEP1180]], align 8
; CHECK-NEXT:    [[TMP855:%.*]] = getelementptr inbounds double, ptr [[A]], i64 6
; CHECK-NEXT:    [[COL_LOAD1181:%.*]] = load <2 x double>, ptr [[TMP855]], align 8
; CHECK-NEXT:    [[VEC_GEP1182:%.*]] = getelementptr inbounds double, ptr [[TMP855]], i64 8
; CHECK-NEXT:    [[COL_LOAD1183:%.*]] = load <2 x double>, ptr [[VEC_GEP1182]], align 8
; CHECK-NEXT:    [[TMP856:%.*]] = getelementptr inbounds double, ptr [[B]], i64 48
; CHECK-NEXT:    [[COL_LOAD1184:%.*]] = load <2 x double>, ptr [[TMP856]], align 8
; CHECK-NEXT:    [[VEC_GEP1185:%.*]] = getelementptr inbounds double, ptr [[TMP856]], i64 8
...
; CHECK-NEXT:    [[TMP869:%.*]] = getelementptr inbounds double, ptr [[A]], i64 22
; CHECK-NEXT:    [[COL_LOAD1199:%.*]] = load <2 x double>, ptr [[TMP869]], align 8
; CHECK-NEXT:    [[VEC_GEP1200:%.*]] = getelementptr inbounds double, ptr [[TMP869]], i64 8
; CHECK-NEXT:    [[COL_LOAD1201:%.*]] = load <2 x double>, ptr [[VEC_GEP1200]], align 8
; CHECK-NEXT:    [[TMP870:%.*]] = getelementptr inbounds double, ptr [[B]], i64 50
; CHECK-NEXT:    [[COL_LOAD1202:%.*]] = load <2 x double>, ptr [[TMP870]], align 8
; CHECK-NEXT:    [[VEC_GEP1203:%.*]] = getelementptr inbounds double, ptr [[TMP870]], i64 8
...
; CHECK-NEXT:    [[TMP883:%.*]] = getelementptr inbounds double, ptr [[A]], i64 38
; CHECK-NEXT:    [[COL_LOAD1219:%.*]] = load <2 x double>, ptr [[TMP883]], align 8
; CHECK-NEXT:    [[VEC_GEP1220:%.*]] = getelementptr inbounds double, ptr [[TMP883]], i64 8
; CHECK-NEXT:    [[COL_LOAD1221:%.*]] = load <2 x double>, ptr [[VEC_GEP1220]], align 8
; CHECK-NEXT:    [[TMP884:%.*]] = getelementptr inbounds double, ptr [[B]], i64 52
; CHECK-NEXT:    [[COL_LOAD1222:%.*]] = load <2 x double>, ptr [[TMP884]], align 8
; CHECK-NEXT:    [[VEC_GEP1223:%.*]] = getelementptr inbounds double, ptr [[TMP884]], i64 8
...
; CHECK-NEXT:    [[TMP897:%.*]] = getelementptr inbounds double, ptr [[A]], i64 54
; CHECK-NEXT:    [[COL_LOAD1239:%.*]] = load <2 x double>, ptr [[TMP897]], align 8
; CHECK-NEXT:    [[VEC_GEP1240:%.*]] = getelementptr inbounds double, ptr [[TMP897]], i64 8
; CHECK-NEXT:    [[COL_LOAD1241:%.*]] = load <2 x double>, ptr [[VEC_GEP1240]], align 8
; CHECK-NEXT:    [[TMP898:%.*]] = getelementptr inbounds double, ptr [[B]], i64 54
; CHECK-NEXT:    [[COL_LOAD1242:%.*]] = load <2 x double>, ptr [[TMP898]], align 8
; CHECK-NEXT:    [[VEC_GEP1243:%.*]] = getelementptr inbounds double, ptr [[TMP898]], i64 8
...
; CHECK-NEXT:    [[TMP911:%.*]] = getelementptr inbounds double, ptr [[C]], i64 54
; CHECK-NEXT:    store <2 x double> [[TMP904]], ptr [[TMP911]], align 8
; CHECK-NEXT:    [[VEC_GEP1259:%.*]] = getelementptr inbounds double, ptr [[TMP911]], i64 8
