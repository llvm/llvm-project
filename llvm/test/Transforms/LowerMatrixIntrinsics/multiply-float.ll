...
; CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <2 x float> poison, <2 x float> [[TMP19]], <2 x i32> <i32 2, i32 1>
...
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <3 x float> poison, <3 x float> [[TMP5]], <3 x i32> <i32 3, i32 1, i32 2>
...
; CHECK-NEXT:    [[TMP27:%.*]] = shufflevector <3 x float> poison, <3 x float> [[TMP26]], <3 x i32> <i32 3, i32 1, i32 2>
...
; CHECK-NEXT:    [[TMP48:%.*]] = shufflevector <3 x float> poison, <3 x float> [[TMP47]], <3 x i32> <i32 3, i32 1, i32 2>
