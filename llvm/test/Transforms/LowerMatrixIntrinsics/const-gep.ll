...
; CHECK-NEXT:    [[COL_LOAD1:%.*]] = load <2 x double>, ptr getelementptr inbounds (i8, ptr @foo, i64 16), align 8
...
; CHECK-NEXT:    store <2 x double> [[COL_LOAD1]], ptr getelementptr inbounds (i8, ptr getelementptr inbounds ([5 x <4 x double>], ptr @foo, i64 0, i64 2), i64 16), align 8
; CHECK-NEXT:    ret void
;
entry:
