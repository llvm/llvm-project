...
; RUN: opt -passes=lower-matrix-intrinsics,instcombine -fuse-matrix-use-loops -fuse-matrix-tile-size-rows=2 -fuse-matrix-tile-size-inner=2 -fuse-matrix-tile-size-columns=2 -matrix-allow-contract -force-fuse-matrix -verify-dom-info %s -S | FileCheck %s
...
; CHECK-NEXT:    [[SPLAT_SPLAT7:%.*]] = shufflevector <2 x i64> [[COL_LOAD2]], <2 x i64> poison, <2 x i32> <i32 1, i32 1>
; CHECK-NEXT:    [[TMP2:%.*]] = mul <2 x i64> [[COL_LOAD1]], [[SPLAT_SPLAT7]]
; CHECK-NEXT:    [[RESULT_VEC_1:%.*]] = add <2 x i64> [[TMP4]], [[TMP2]]
; CHECK-NEXT:    [[SPLAT_SPLAT10:%.*]] = shufflevector <2 x i64> [[COL_LOAD4]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP5:%.*]] = mul <2 x i64> [[COL_LOAD]], [[SPLAT_SPLAT10]]
; CHECK-NEXT:    [[SPLAT_SPLAT8:%.*]] = shufflevector <2 x i64> [[COL_LOAD4]], <2 x i64> poison, <2 x i32> <i32 1, i32 1>
; CHECK-NEXT:    [[TMP6:%.*]] = mul <2 x i64> [[COL_LOAD1]], [[SPLAT_SPLAT8]]
; CHECK-NEXT:    [[TMP7:%.*]] = add <2 x i64> [[TMP5]], [[TMP6]]
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 32
; CHECK-NEXT:    [[COL_LOAD14:%.*]] = load <2 x i64>, ptr [[TMP16]], align 8
; CHECK-NEXT:    [[VEC_GEP15:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP1]], i64 48
; CHECK-NEXT:    [[COL_LOAD16:%.*]] = load <2 x i64>, ptr [[VEC_GEP15]], align 8
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP3]], i64 16
; CHECK-NEXT:    [[COL_LOAD17:%.*]] = load <2 x i64>, ptr [[TMP17]], align 8
; CHECK-NEXT:    [[VEC_GEP18:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP3]], i64 48
; CHECK-NEXT:    [[COL_LOAD19:%.*]] = load <2 x i64>, ptr [[VEC_GEP18]], align 8
; CHECK-NEXT:    [[SPLAT_SPLAT23:%.*]] = shufflevector <2 x i64> [[COL_LOAD17]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP8:%.*]] = mul <2 x i64> [[COL_LOAD14]], [[SPLAT_SPLAT23]]
; CHECK-NEXT:    [[TMP9:%.*]] = add <2 x i64> [[RESULT_VEC_1]], [[TMP8]]
; CHECK-NEXT:    [[SPLAT_SPLAT26:%.*]] = shufflevector <2 x i64> [[COL_LOAD17]], <2 x i64> poison, <2 x i32> <i32 1, i32 1>
; CHECK-NEXT:    [[TMP10:%.*]] = mul <2 x i64> [[COL_LOAD16]], [[SPLAT_SPLAT26]]
; CHECK-NEXT:    [[TMP11:%.*]] = add <2 x i64> [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[SPLAT_SPLAT30:%.*]] = shufflevector <2 x i64> [[COL_LOAD19]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP12:%.*]] = mul <2 x i64> [[COL_LOAD14]], [[SPLAT_SPLAT30]]
; CHECK-NEXT:    [[TMP18:%.*]] = add <2 x i64> [[TMP7]], [[TMP12]]
; CHECK-NEXT:    [[SPLAT_SPLAT33:%.*]] = shufflevector <2 x i64> [[COL_LOAD19]], <2 x i64> poison, <2 x i32> <i32 1, i32 1>
; CHECK-NEXT:    [[TMP14:%.*]] = mul <2 x i64> [[COL_LOAD16]], [[SPLAT_SPLAT33]]
; CHECK-NEXT:    [[TMP15:%.*]] = add <2 x i64> [[TMP18]], [[TMP14]]
; CHECK-NEXT:    store <2 x i64> [[TMP11]], ptr [[TMP13:%.*]], align 8
; CHECK-NEXT:    [[VEC_GEP16:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP13]], i64 16
; CHECK-NEXT:    store <2 x i64> [[TMP15]], ptr [[VEC_GEP16]], align 8
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[COL_LOAD:%.*]] = load <2 x float>, ptr [[TMP3]], align 8
; CHECK-NEXT:    [[VEC_GEP:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP3]], i64 8
; CHECK-NEXT:    [[COL_LOAD8:%.*]] = load <2 x float>, ptr [[VEC_GEP]], align 8
; CHECK-NEXT:    [[COL_LOAD9:%.*]] = load <2 x float>, ptr [[TMP7]], align 8
; CHECK-NEXT:    [[VEC_GEP8:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP7]], i64 8
; CHECK-NEXT:    [[COL_LOAD11:%.*]] = load <2 x float>, ptr [[VEC_GEP8]], align 8
; CHECK-NEXT:    [[SPLAT_SPLAT:%.*]] = shufflevector <2 x float> [[COL_LOAD9]], <2 x float> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP14:%.*]] = fmul contract <2 x float> [[COL_LOAD]], [[SPLAT_SPLAT]]
...
; CHECK-NEXT:    [[TMP16:%.*]] = fmul contract <2 x float> [[COL_LOAD]], [[SPLAT_SPLAT19]]
...
; CHECK-NEXT:    store <2 x float> [[TMP15]], ptr [[C]], align 8
; CHECK-NEXT:    [[VEC_GEP23:%.*]] = getelementptr inbounds nuw i8, ptr [[C]], i64 8
