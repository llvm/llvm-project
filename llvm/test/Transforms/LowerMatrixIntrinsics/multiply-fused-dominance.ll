...
; RUN: opt -passes=lower-matrix-intrinsics,instcombine -fuse-matrix-tile-size-rows=1 -fuse-matrix-tile-size-inner=1 -fuse-matrix-tile-size-columns=1 -matrix-allow-contract -force-fuse-matrix -verify-dom-info %s -S | FileCheck %s
...
; CHECK-NEXT:    [[VEC_GEP14:%.*]] = getelementptr inbounds nuw i8, ptr [[DST]], i64 16
; CHECK-NEXT:    store <2 x double> [[TMP3]], ptr [[VEC_GEP14]], align 8
