...
; CHECK-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[SUB_PTR_DIV_I_I]]) ]
...
; CHECK-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[I_010]]) ]
...
; CHECK-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i32 [[K_07]]) ]
