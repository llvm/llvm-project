...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[MUL:%.*]] = shl nuw nsw i32 [[BEAM]], 3
...
; CHECK:       if.else:
; CHECK-NEXT:    [[MUL2:%.*]] = shl nuw nsw i32 [[I_06]], 3
; CHECK-NEXT:    [[TMP1:%.*]] = zext nneg i32 [[MUL2]] to i64
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP1]]
