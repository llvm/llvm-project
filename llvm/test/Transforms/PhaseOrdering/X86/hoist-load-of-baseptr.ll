...
; O1-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[J_05]]) ]
...
; O2-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[INDEX]]) ]
...
; O2-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[J_05]]) ]
...
; O3-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[INDEX]]) ]
...
; O3-NEXT:    call void @llvm.assume(i1 true) [ "noundef"(i64 [[J_05_US]]) ]
