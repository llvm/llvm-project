...
; SSE2-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.vector.reduce.umin.v2i64(<2 x i64> [[A0:%.*]])
...
; SSE42-NEXT:    [[TMP2:%.*]] = tail call <2 x i64> @llvm.umin.v2i64(<2 x i64> [[A0]], <2 x i64> [[TMP1]])
...
; AVX-NEXT:    [[TMP2:%.*]] = tail call <2 x i64> @llvm.umin.v2i64(<2 x i64> [[A0]], <2 x i64> [[TMP1]])
...
; CHECK-NEXT:    [[TMP10:%.*]] = tail call i16 @llvm.vector.reduce.umin.v8i16(<8 x i16> [[TMP1]])
; CHECK-NEXT:    ret i16 [[TMP10]]
;
...
; CHECK-NEXT:    [[TMP13:%.*]] = tail call i8 @llvm.vector.reduce.umin.v16i8(<16 x i8> [[TMP1]])
; CHECK-NEXT:    ret i8 [[TMP13]]
;
