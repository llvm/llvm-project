...
; RUN: opt < %s -passes="default<O2>" -S -mtriple=i686--   -mcpu=x86-64    | FileCheck %s --check-prefixes=CHECK,SSE,SSE2
; RUN: opt < %s -passes="default<O2>" -S -mtriple=i686--   -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=CHECK,SSE,SSE42
...
; RUN: opt < %s -passes="default<O2>" -S -mtriple=x86_64-- -mcpu=x86-64    | FileCheck %s --check-prefixes=CHECK,SSE,SSE2
; RUN: opt < %s -passes="default<O2>" -S -mtriple=x86_64-- -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=CHECK,SSE,SSE42
...
; SSE2-LABEL: @test_reduce_v2i64(
; SSE2-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.vector.reduce.umax.v2i64(<2 x i64> [[A0:%.*]])
; SSE2-NEXT:    ret i64 [[TMP1]]
;
; SSE42-LABEL: @test_reduce_v2i64(
; SSE42-NEXT:    [[TMP1:%.*]] = shufflevector <2 x i64> [[A0:%.*]], <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
; SSE42-NEXT:    [[TMP2:%.*]] = tail call <2 x i64> @llvm.umax.v2i64(<2 x i64> [[A0]], <2 x i64> [[TMP1]])
; SSE42-NEXT:    [[TMP3:%.*]] = extractelement <2 x i64> [[TMP2]], i64 0
; SSE42-NEXT:    ret i64 [[TMP3]]
;
; AVX-LABEL: @test_reduce_v2i64(
; AVX-NEXT:    [[TMP1:%.*]] = shufflevector <2 x i64> [[A0:%.*]], <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
; AVX-NEXT:    [[TMP2:%.*]] = tail call <2 x i64> @llvm.umax.v2i64(<2 x i64> [[A0]], <2 x i64> [[TMP1]])
; AVX-NEXT:    [[TMP3:%.*]] = extractelement <2 x i64> [[TMP2]], i64 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = tail call i16 @llvm.vector.reduce.umax.v8i16(<8 x i16> [[TMP1]])
; CHECK-NEXT:    ret i16 [[TMP10]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <32 x i16> [[A0:%.*]], <32 x i16> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP10:%.*]] = tail call i16 @llvm.vector.reduce.umax.v8i16(<8 x i16> [[TMP1]])
; CHECK-NEXT:    ret i16 [[TMP10]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <32 x i8> [[A0:%.*]], <32 x i8> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP13:%.*]] = tail call i8 @llvm.vector.reduce.umax.v16i8(<16 x i8> [[TMP1]])
; CHECK-NEXT:    ret i8 [[TMP13]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <64 x i8> [[A0:%.*]], <64 x i8> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP13:%.*]] = tail call i8 @llvm.vector.reduce.umax.v16i8(<16 x i8> [[TMP1]])
; CHECK-NEXT:    ret i8 [[TMP13]]
;
