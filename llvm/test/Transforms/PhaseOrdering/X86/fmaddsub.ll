...
; SSE-NEXT:    [[TMP11:%.*]] = shufflevector <12 x float> [[TMP4]], <12 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 poison, i32 11, i32 poison, i32 poison>
...
; SSE-NEXT:    [[VECINSERT161:%.*]] = shufflevector <16 x float> [[TMP11]], <16 x float> [[TMP10]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 13, i32 16, i32 17>
...
; AVX-NEXT:    [[TMP16:%.*]] = shufflevector <8 x float> [[TMP4]], <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX-NEXT:    [[VECINSERT141:%.*]] = shufflevector <16 x float> [[TMP16]], <16 x float> [[TMP14]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 6, i32 7, i32 8, i32 16, i32 17, i32 18, i32 poison, i32 20, i32 poison, i32 poison>
...
; AVX-NEXT:    [[VECINSERT162:%.*]] = shufflevector <16 x float> [[VECINSERT141]], <16 x float> [[TMP15]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 13, i32 16, i32 17>
...
; SSE-NEXT:    [[TMP7:%.*]] = shufflevector <6 x double> [[TMP6]], <6 x double> poison, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 poison, i32 3, i32 poison>
...
; AVX_FMA4-NEXT:    [[TMP8:%.*]] = shufflevector <4 x double> [[TMP4]], <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX_FMA4-NEXT:    [[VECINSERT71:%.*]] = shufflevector <8 x double> [[TMP8]], <8 x double> [[TMP7]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 poison, i32 10, i32 poison>
...
; AVX_FMA3-NEXT:    [[TMP9:%.*]] = shufflevector <4 x double> [[TMP4]], <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX_FMA3-NEXT:    [[VECINSERT71:%.*]] = shufflevector <8 x double> [[TMP9]], <8 x double> [[TMP8]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 poison, i32 10, i32 poison>
; AVX_FMA3-NEXT:    [[VECINSERT8:%.*]] = shufflevector <8 x double> [[VECINSERT71]], <8 x double> [[TMP5]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 6, i32 15>
...
; AVX512-NEXT:    [[TMP9:%.*]] = shufflevector <4 x double> [[TMP4]], <4 x double> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
...
; AVX512-NEXT:    [[VECINSERT71:%.*]] = shufflevector <8 x double> [[TMP9]], <8 x double> [[TMP8]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 poison, i32 10, i32 poison>
; AVX512-NEXT:    [[VECINSERT8:%.*]] = shufflevector <8 x double> [[VECINSERT71]], <8 x double> [[TMP5]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 6, i32 15>
