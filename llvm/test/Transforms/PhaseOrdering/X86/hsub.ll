...
; SSE2-NEXT:    [[HSUB7:%.*]] = shufflevector <8 x i16> [[HSUB6]], <8 x i16> [[TMP3]], <7 x i32> <i32 15, i32 6, i32 4, i32 3, i32 2, i32 1, i32 0>
; SSE2-NEXT:    [[RESULT:%.*]] = shufflevector <7 x i16> [[HSUB7]], <7 x i16> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 2, i32 3, i32 4, i32 5, i32 6>
; SSE2-NEXT:    ret <8 x i16> [[RESULT]]
;
