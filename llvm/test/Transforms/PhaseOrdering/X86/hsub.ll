...
; SSE2-NEXT:    [[TMP11:%.*]] = sub <16 x i16> [[TMP3]], [[TMP7]]
...
; SSE2-NEXT:    [[HSUB92:%.*]] = shufflevector <16 x i16> [[TMP11]], <16 x i16> [[TMP6]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 5, i32 6, i32 7, i32 16, i32 17, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; SSE4-NEXT:    [[TMP4:%.*]] = shufflevector <8 x float> [[B:%.*]], <8 x float> [[A:%.*]], <8 x i32> <i32 6, i32 4, i32 poison, i32 12, i32 2, i32 0, i32 10, i32 8>
; SSE4-NEXT:    [[TMP5:%.*]] = shufflevector <8 x float> [[B]], <8 x float> [[A]], <8 x i32> <i32 7, i32 5, i32 poison, i32 13, i32 3, i32 1, i32 11, i32 9>
; SSE4-NEXT:    [[TMP6:%.*]] = fsub <8 x float> [[TMP4]], [[TMP5]]
; SSE4-NEXT:    ret <8 x float> [[TMP6]]
;
; AVX-LABEL: @sub_v8f32_76u43210(
; AVX-NEXT:    [[TMP1:%.*]] = shufflevector <8 x float> [[B:%.*]], <8 x float> [[A:%.*]], <8 x i32> <i32 6, i32 4, i32 poison, i32 12, i32 2, i32 0, i32 10, i32 8>
; AVX-NEXT:    [[TMP2:%.*]] = shufflevector <8 x float> [[B]], <8 x float> [[A]], <8 x i32> <i32 7, i32 5, i32 poison, i32 13, i32 3, i32 1, i32 11, i32 9>
