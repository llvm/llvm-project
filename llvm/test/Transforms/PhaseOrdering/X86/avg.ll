...
; SSE2-NEXT:  entry:
; SSE2-NEXT:    [[B_SROA_2_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE2:%.*]], 16
; SSE2-NEXT:    [[B_SROA_3_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE2]], 32
; SSE2-NEXT:    [[B_SROA_4_0_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE2]], 48
...
; SSE2-NEXT:    [[TMP0:%.*]] = trunc i64 [[B_COERCE2]] to i16
; SSE2-NEXT:    [[TMP14:%.*]] = insertelement <2 x i16> poison, i16 [[TMP0]], i64 0
; SSE2-NEXT:    [[TMP17:%.*]] = trunc i64 [[B_SROA_2_0_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[TMP18:%.*]] = insertelement <2 x i16> [[TMP14]], i16 [[TMP17]], i64 1
; SSE2-NEXT:    [[TMP4:%.*]] = trunc i64 [[B_COERCE1]] to i16
; SSE2-NEXT:    [[TMP5:%.*]] = insertelement <2 x i16> poison, i16 [[TMP4]], i64 0
; SSE2-NEXT:    [[TMP6:%.*]] = trunc i64 [[B_SROA_7_8_EXTRACT_SHIFT]] to i16
...
; SSE2-NEXT:    [[TMP36:%.*]] = shufflevector <2 x i16> [[TMP7]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE2-NEXT:    [[TMP37:%.*]] = shufflevector <2 x i16> [[TMP18]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE2-NEXT:    [[TMP41:%.*]] = shufflevector <2 x i16> [[TMP10]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE2-NEXT:    [[A_SROA_7_8_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE0:%.*]], 16
; SSE2-NEXT:    [[A_SROA_8_8_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE0]], 32
; SSE2-NEXT:    [[A_SROA_9_8_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE0]], 48
; SSE2-NEXT:    [[B_SROA_7_8_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE3:%.*]], 16
; SSE2-NEXT:    [[B_SROA_8_8_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE3]], 32
; SSE2-NEXT:    [[B_SROA_9_8_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE3]], 48
; SSE2-NEXT:    [[TMP11:%.*]] = trunc i64 [[B_COERCE0]] to i16
; SSE2-NEXT:    [[TMP23:%.*]] = insertelement <2 x i16> poison, i16 [[TMP11]], i64 0
; SSE2-NEXT:    [[TMP28:%.*]] = trunc i64 [[A_SROA_7_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[TMP27:%.*]] = insertelement <2 x i16> [[TMP23]], i16 [[TMP28]], i64 1
; SSE2-NEXT:    [[TMP29:%.*]] = trunc i64 [[B_COERCE3]] to i16
; SSE2-NEXT:    [[TMP32:%.*]] = insertelement <2 x i16> poison, i16 [[TMP29]], i64 0
; SSE2-NEXT:    [[TMP40:%.*]] = trunc i64 [[B_SROA_7_8_EXTRACT_SHIFT1]] to i16
; SSE2-NEXT:    [[TMP46:%.*]] = insertelement <2 x i16> [[TMP32]], i16 [[TMP40]], i64 1
; SSE2-NEXT:    [[TMP42:%.*]] = lshr <2 x i16> [[TMP27]], splat (i16 1)
; SSE2-NEXT:    [[TMP44:%.*]] = lshr <2 x i16> [[TMP46]], splat (i16 1)
; SSE2-NEXT:    [[TMP34:%.*]] = add nuw <2 x i16> [[TMP44]], [[TMP42]]
; SSE2-NEXT:    [[B_SROA_0_0_EXTRACT_TRUNC:%.*]] = trunc i64 [[B_SROA_3_0_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[B_SROA_2_0_EXTRACT_TRUNC:%.*]] = trunc nuw i64 [[B_SROA_4_0_EXTRACT_SHIFT1]] to i16
; SSE2-NEXT:    [[B_SROA_4_0_EXTRACT_TRUNC:%.*]] = trunc i64 [[B_SROA_8_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[B_SROA_3_0_EXTRACT_TRUNC:%.*]] = trunc nuw i64 [[B_SROA_9_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[TMP38:%.*]] = insertelement <4 x i16> [[TMP36]], i16 [[B_SROA_4_0_EXTRACT_TRUNC]], i64 2
; SSE2-NEXT:    [[TMP39:%.*]] = insertelement <4 x i16> [[TMP38]], i16 [[B_SROA_3_0_EXTRACT_TRUNC]], i64 3
; SSE2-NEXT:    [[TMP45:%.*]] = insertelement <4 x i16> [[TMP37]], i16 [[B_SROA_0_0_EXTRACT_TRUNC]], i64 2
; SSE2-NEXT:    [[TMP47:%.*]] = insertelement <4 x i16> [[TMP45]], i16 [[B_SROA_2_0_EXTRACT_TRUNC]], i64 3
; SSE2-NEXT:    [[TMP58:%.*]] = or <4 x i16> [[TMP39]], [[TMP47]]
; SSE2-NEXT:    [[TMP9:%.*]] = and <4 x i16> [[TMP58]], splat (i16 1)
; SSE2-NEXT:    [[A_SROA_5_8_EXTRACT_TRUNC:%.*]] = trunc i64 [[A_SROA_8_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[NARROW:%.*]] = trunc nuw i64 [[A_SROA_9_8_EXTRACT_SHIFT]] to i16
; SSE2-NEXT:    [[B_SROA_8_8_EXTRACT_TRUNC:%.*]] = trunc i64 [[B_SROA_8_8_EXTRACT_SHIFT1]] to i16
; SSE2-NEXT:    [[B_SROA_9_8_EXTRACT_TRUNC:%.*]] = trunc nuw i64 [[B_SROA_9_8_EXTRACT_SHIFT1]] to i16
...
; SSE2-NEXT:    [[TMP57:%.*]] = shufflevector <4 x i16> [[TMP41]], <4 x i16> [[TMP56]], <4 x i32> <i32 0, i32 1, i32 4, i32 6>
...
; SSE2-NEXT:    [[TMP59:%.*]] = insertelement <4 x i16> [[TMP35]], i16 [[B_SROA_8_8_EXTRACT_TRUNC]], i64 2
; SSE2-NEXT:    [[TMP20:%.*]] = insertelement <4 x i16> [[TMP59]], i16 [[B_SROA_9_8_EXTRACT_TRUNC]], i64 3
; SSE2-NEXT:    [[TMP22:%.*]] = shufflevector <2 x i16> [[TMP27]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE2-NEXT:    [[TMP60:%.*]] = insertelement <4 x i16> [[TMP22]], i16 [[A_SROA_5_8_EXTRACT_TRUNC]], i64 2
; SSE2-NEXT:    [[TMP24:%.*]] = insertelement <4 x i16> [[TMP60]], i16 [[NARROW]], i64 3
...
; SSE2-NEXT:    [[TMP30:%.*]] = shufflevector <4 x i16> [[TMP43]], <4 x i16> [[TMP56]], <4 x i32> <i32 0, i32 1, i32 5, i32 7>
...
; SSE4-NEXT:  entry:
; SSE4-NEXT:    [[B_SROA_2_0_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE2:%.*]], 16
; SSE4-NEXT:    [[B_SROA_3_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE2]], 32
; SSE4-NEXT:    [[A_SROA_7_8_EXTRACT_TRUNC:%.*]] = trunc i64 [[B_SROA_3_0_EXTRACT_SHIFT]] to i16
; SSE4-NEXT:    [[B_SROA_4_0_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE2]], 48
; SSE4-NEXT:    [[B_SROA_3_0_EXTRACT_TRUNC:%.*]] = trunc nuw i64 [[B_SROA_4_0_EXTRACT_SHIFT1]] to i16
; SSE4-NEXT:    [[B_SROA_2_0_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE1:%.*]], 16
; SSE4-NEXT:    [[B_SROA_8_8_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE1]], 32
; SSE4-NEXT:    [[B_SROA_9_8_EXTRACT_TRUNC:%.*]] = trunc i64 [[B_SROA_8_8_EXTRACT_SHIFT]] to i16
...
; SSE4-NEXT:    [[TMP0:%.*]] = trunc i64 [[B_COERCE2]] to i16
; SSE4-NEXT:    [[TMP14:%.*]] = insertelement <2 x i16> poison, i16 [[TMP0]], i64 0
; SSE4-NEXT:    [[TMP17:%.*]] = trunc i64 [[B_SROA_2_0_EXTRACT_SHIFT1]] to i16
; SSE4-NEXT:    [[TMP18:%.*]] = insertelement <2 x i16> [[TMP14]], i16 [[TMP17]], i64 1
; SSE4-NEXT:    [[TMP4:%.*]] = trunc i64 [[B_COERCE1]] to i16
...
; SSE4-NEXT:    [[SHR_6:%.*]] = lshr i16 [[A_SROA_7_8_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[SHR5_6:%.*]] = lshr i16 [[B_SROA_9_8_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[NARROW_7:%.*]] = add nuw i16 [[SHR5_6]], [[SHR_6]]
; SSE4-NEXT:    [[SHR_7:%.*]] = lshr i16 [[B_SROA_3_0_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[SHR5_7:%.*]] = lshr i16 [[B_SROA_8_8_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[NARROW_6:%.*]] = add nuw i16 [[SHR5_7]], [[SHR_7]]
; SSE4-NEXT:    [[TMP11:%.*]] = shufflevector <2 x i16> [[TMP7]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE4-NEXT:    [[TMP12:%.*]] = insertelement <4 x i16> [[TMP11]], i16 [[B_SROA_9_8_EXTRACT_TRUNC]], i64 2
; SSE4-NEXT:    [[TMP39:%.*]] = insertelement <4 x i16> [[TMP12]], i16 [[B_SROA_8_8_EXTRACT_TRUNC]], i64 3
; SSE4-NEXT:    [[TMP22:%.*]] = shufflevector <2 x i16> [[TMP18]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE4-NEXT:    [[TMP37:%.*]] = insertelement <4 x i16> [[TMP22]], i16 [[A_SROA_7_8_EXTRACT_TRUNC]], i64 2
; SSE4-NEXT:    [[TMP3:%.*]] = insertelement <4 x i16> [[TMP37]], i16 [[B_SROA_3_0_EXTRACT_TRUNC]], i64 3
; SSE4-NEXT:    [[TMP8:%.*]] = or <4 x i16> [[TMP39]], [[TMP3]]
; SSE4-NEXT:    [[TMP9:%.*]] = and <4 x i16> [[TMP8]], splat (i16 1)
; SSE4-NEXT:    [[TMP40:%.*]] = shufflevector <2 x i16> [[TMP10]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE4-NEXT:    [[TMP41:%.*]] = insertelement <4 x i16> [[TMP40]], i16 [[NARROW_7]], i64 2
; SSE4-NEXT:    [[TMP13:%.*]] = insertelement <4 x i16> [[TMP41]], i16 [[NARROW_6]], i64 3
...
; SSE4-NEXT:    [[B_SROA_7_8_EXTRACT_SHIFT:%.*]] = lshr i64 [[B_COERCE3:%.*]], 16
; SSE4-NEXT:    [[B_SROA_8_8_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE3]], 32
; SSE4-NEXT:    [[B_SROA_8_8_EXTRACT_TRUNC1:%.*]] = trunc i64 [[B_SROA_8_8_EXTRACT_SHIFT1]] to i16
; SSE4-NEXT:    [[B_SROA_9_8_EXTRACT_SHIFT1:%.*]] = lshr i64 [[B_COERCE3]], 48
; SSE4-NEXT:    [[B_SROA_9_8_EXTRACT_TRUNC1:%.*]] = trunc nuw i64 [[B_SROA_9_8_EXTRACT_SHIFT1]] to i16
; SSE4-NEXT:    [[TMP42:%.*]] = trunc i64 [[A_COERCE1]] to i16
; SSE4-NEXT:    [[TMP45:%.*]] = insertelement <2 x i16> poison, i16 [[TMP42]], i64 0
; SSE4-NEXT:    [[TMP46:%.*]] = trunc i64 [[A_SROA_7_8_EXTRACT_SHIFT]] to i16
; SSE4-NEXT:    [[TMP27:%.*]] = insertelement <2 x i16> [[TMP45]], i16 [[TMP46]], i64 1
; SSE4-NEXT:    [[TMP28:%.*]] = trunc i64 [[B_COERCE3]] to i16
; SSE4-NEXT:    [[TMP29:%.*]] = insertelement <2 x i16> poison, i16 [[TMP28]], i64 0
; SSE4-NEXT:    [[TMP47:%.*]] = trunc i64 [[B_SROA_7_8_EXTRACT_SHIFT]] to i16
; SSE4-NEXT:    [[TMP48:%.*]] = insertelement <2 x i16> [[TMP29]], i16 [[TMP47]], i64 1
; SSE4-NEXT:    [[TMP32:%.*]] = lshr <2 x i16> [[TMP27]], splat (i16 1)
; SSE4-NEXT:    [[TMP49:%.*]] = lshr <2 x i16> [[TMP48]], splat (i16 1)
; SSE4-NEXT:    [[TMP34:%.*]] = add nuw <2 x i16> [[TMP49]], [[TMP32]]
; SSE4-NEXT:    [[SHR_8:%.*]] = lshr i16 [[A_SROA_8_8_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[SHR5_8:%.*]] = lshr i16 [[B_SROA_8_8_EXTRACT_TRUNC1]], 1
; SSE4-NEXT:    [[NARROW_8:%.*]] = add nuw i16 [[SHR5_8]], [[SHR_8]]
; SSE4-NEXT:    [[SHR_9:%.*]] = lshr i16 [[A_SROA_5_8_EXTRACT_TRUNC]], 1
; SSE4-NEXT:    [[SHR5_9:%.*]] = lshr i16 [[B_SROA_9_8_EXTRACT_TRUNC1]], 1
; SSE4-NEXT:    [[NARROW_9:%.*]] = add nuw i16 [[SHR5_9]], [[SHR_9]]
; SSE4-NEXT:    [[TMP35:%.*]] = shufflevector <2 x i16> [[TMP48]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE4-NEXT:    [[TMP36:%.*]] = insertelement <4 x i16> [[TMP35]], i16 [[B_SROA_8_8_EXTRACT_TRUNC1]], i64 2
; SSE4-NEXT:    [[TMP20:%.*]] = insertelement <4 x i16> [[TMP36]], i16 [[B_SROA_9_8_EXTRACT_TRUNC1]], i64 3
; SSE4-NEXT:    [[TMP38:%.*]] = shufflevector <2 x i16> [[TMP27]], <2 x i16> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
; SSE4-NEXT:    [[TMP23:%.*]] = insertelement <4 x i16> [[TMP38]], i16 [[A_SROA_8_8_EXTRACT_TRUNC]], i64 2
...
; SSE4-NEXT:    [[TMP44:%.*]] = insertelement <4 x i16> [[TMP43]], i16 [[NARROW_8]], i64 2
; SSE4-NEXT:    [[TMP30:%.*]] = insertelement <4 x i16> [[TMP44]], i16 [[NARROW_9]], i64 3
