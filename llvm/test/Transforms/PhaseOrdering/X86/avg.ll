...
; SSE2-NEXT:    [[TMP22:%.*]] = add nuw nsw <2 x i64> [[TMP17]], [[TMP16]]
...
; SSE4-NEXT:    [[TMP22:%.*]] = add nuw nsw <2 x i64> [[TMP17]], [[TMP16]]
...
; AVX-NEXT:    [[TMP13:%.*]] = add nuw nsw i64 [[CONV4]], [[CONV1]]
; AVX-NEXT:    [[ADD5:%.*]] = add nuw nsw i64 [[TMP13]], 1
; AVX-NEXT:    [[ADD5_1:%.*]] = add nuw nsw i16 [[TMP5]], [[TMP1]]
; AVX-NEXT:    [[CONV1_8:%.*]] = and i64 [[A_COERCE1]], 255
; AVX-NEXT:    [[CONV4_8:%.*]] = and i64 [[B_COERCE1]], 255
; AVX-NEXT:    [[TMP30:%.*]] = add nuw nsw i64 [[CONV4_8]], [[CONV1_8]]
; AVX-NEXT:    [[ADD5_8:%.*]] = add nuw nsw i64 [[TMP30]], 1
; AVX-NEXT:    [[ADD5_9:%.*]] = add nuw nsw i16 [[TMP7]], [[TMP3]]
...
; SSE2-NEXT:    [[TMP8:%.*]] = add nuw nsw i64 [[CONV2]], [[CONV]]
; SSE2-NEXT:    [[ADD3:%.*]] = add nuw nsw i64 [[TMP8]], 1
; SSE2-NEXT:    [[SHR:%.*]] = lshr i64 [[ADD3]], 1
; SSE2-NEXT:    [[TMP9:%.*]] = add nuw nsw i32 [[TMP5]], [[TMP1]]
...
; SSE2-NEXT:    [[ADD3_3:%.*]] = add nuw nsw i64 [[B_SROA_4_0_EXTRACT_SHIFT]], [[ADD_3]]
; SSE2-NEXT:    [[TMP11:%.*]] = add nuw nsw i64 [[B_SROA_4_0_EXTRACT_SHIFT1]], [[A_SROA_4_0_EXTRACT_SHIFT]]
; SSE2-NEXT:    [[CONV_4:%.*]] = and i64 [[A_COERCE1]], 65535
; SSE2-NEXT:    [[CONV2_5:%.*]] = and i64 [[B_COERCE0]], 65535
; SSE2-NEXT:    [[A_SROA_9_8_EXTRACT_SHIFT:%.*]] = add nuw nsw i64 [[CONV2_5]], [[CONV_4]]
; SSE2-NEXT:    [[ADD_7:%.*]] = add nuw nsw i64 [[A_SROA_9_8_EXTRACT_SHIFT]], 1
; SSE2-NEXT:    [[SHR_4:%.*]] = lshr i64 [[ADD_7]], 1
; SSE2-NEXT:    [[TMP14:%.*]] = add nuw nsw i32 [[TMP7]], [[TMP3]]
...
; SSE2-NEXT:    [[ADD3_7:%.*]] = add nuw nsw i64 [[B_SROA_9_8_EXTRACT_SHIFT]], [[ADD_6]]
; SSE2-NEXT:    [[TMP15:%.*]] = add nuw nsw i64 [[CONV2_4]], [[A_SROA_9_8_EXTRACT_SHIFT1]]
...
; SSE4-NEXT:    [[TMP16:%.*]] = add nuw nsw <2 x i64> [[TMP8]], [[TMP7]]
; SSE4-NEXT:    [[TMP14:%.*]] = add nuw nsw <2 x i64> [[TMP16]], splat (i64 1)
; SSE4-NEXT:    [[TMP15:%.*]] = lshr <2 x i64> [[TMP14]], splat (i64 1)
; SSE4-NEXT:    [[TMP17:%.*]] = add nuw nsw <2 x i32> [[TMP12]], [[TMP11]]
; SSE4-NEXT:    [[CONV_6:%.*]] = and i64 [[A_SROA_8_8_EXTRACT_SHIFT]], 65535
; SSE4-NEXT:    [[CONV2_6:%.*]] = and i64 [[B_SROA_8_8_EXTRACT_SHIFT]], 65535
; SSE4-NEXT:    [[ADD3_6:%.*]] = add nuw nsw i64 [[CONV2_6]], [[CONV_6]]
; SSE4-NEXT:    [[ADD3_3:%.*]] = add nuw nsw i64 [[B_SROA_4_0_EXTRACT_SHIFT]], [[ADD_3]]
; SSE4-NEXT:    [[ADD3_7:%.*]] = add nuw nsw i64 [[B_SROA_9_8_EXTRACT_SHIFT]], [[A_SROA_9_8_EXTRACT_SHIFT]]
; SSE4-NEXT:    [[ADD3_2:%.*]] = add nuw nsw i64 [[CONV2_2]], [[CONV_2]]
...
; AVX2-NEXT:    [[TMP14:%.*]] = add nuw nsw <2 x i64> [[TMP8]], [[TMP13]]
; AVX2-NEXT:    [[TMP19:%.*]] = add nuw nsw <2 x i64> [[TMP14]], splat (i64 1)
; AVX2-NEXT:    [[TMP15:%.*]] = lshr <2 x i64> [[TMP19]], splat (i64 1)
; AVX2-NEXT:    [[TMP17:%.*]] = add nuw nsw <2 x i32> [[TMP12]], [[TMP11]]
; AVX2-NEXT:    [[TMP34:%.*]] = and <2 x i64> [[TMP21]], <i64 -1, i64 65535>
; AVX2-NEXT:    [[TMP25:%.*]] = and <2 x i64> [[TMP16]], <i64 -1, i64 65535>
; AVX2-NEXT:    [[TMP38:%.*]] = add nuw nsw <2 x i64> [[TMP25]], [[TMP34]]
; AVX2-NEXT:    [[ADD3_7:%.*]] = add nuw nsw i64 [[B_SROA_9_8_EXTRACT_SHIFT]], [[A_SROA_9_8_EXTRACT_SHIFT]]
; AVX2-NEXT:    [[ADD3_2:%.*]] = add nuw nsw i64 [[CONV2_2]], [[CONV_2]]
