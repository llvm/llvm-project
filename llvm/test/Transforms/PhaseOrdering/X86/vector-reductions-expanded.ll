...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP1:%.*]] = load <8 x i16>, ptr [[TMP0]], align 2, !tbaa [[TBAA4:![0-9]+]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP1:%.*]] = load <16 x i8>, ptr [[TMP0]], align 1, !tbaa [[TBAA6:![0-9]+]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP1:%.*]] = load <4 x i32>, ptr [[TMP0]], align 4, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[RDX_SHUF:%.*]] = shufflevector <4 x i32> [[TMP1]], <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[TMP0]], align 4, !tbaa [[TBAA7:![0-9]+]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast ptr [[P:%.*]] to ptr
; CHECK-NEXT:    [[TMP1:%.*]] = load <4 x float>, ptr [[TMP0]], align 4, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[RDX_SHUF:%.*]] = shufflevector <4 x float> [[TMP1]], <4 x float> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[P:%.*]], align 4, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[TMP1:%.*]] = tail call fast float @llvm.minnum.f32(float [[TMP0]], float 0x47EFFFFFE0000000)
; CHECK-NEXT:    [[ARRAYIDX_1:%.*]] = getelementptr inbounds float, ptr [[P]], i64 1
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[ARRAYIDX_1]], align 4, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[TMP3:%.*]] = tail call fast float @llvm.minnum.f32(float [[TMP2]], float [[TMP1]])
; CHECK-NEXT:    [[ARRAYIDX_2:%.*]] = getelementptr inbounds float, ptr [[P]], i64 2
; CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[ARRAYIDX_2]], align 4, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[TMP5:%.*]] = tail call fast float @llvm.minnum.f32(float [[TMP4]], float [[TMP3]])
; CHECK-NEXT:    [[ARRAYIDX_3:%.*]] = getelementptr inbounds float, ptr [[P]], i64 3
; CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[ARRAYIDX_3]], align 4, !tbaa [[TBAA7]]
...
; CHECK-NEXT:    [[VECEXT:%.*]] = extractelement <8 x float> [[V]], i32 0
; CHECK-NEXT:    [[VECEXT1:%.*]] = extractelement <8 x float> [[V]], i32 1
; CHECK-NEXT:    [[TMP1:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[VECEXT]], float [[VECEXT1]])
; CHECK-NEXT:    [[VECEXT2:%.*]] = extractelement <8 x float> [[V]], i32 2
; CHECK-NEXT:    [[TMP2:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP1]], float [[VECEXT2]])
; CHECK-NEXT:    [[VECEXT4:%.*]] = extractelement <8 x float> [[V]], i32 3
; CHECK-NEXT:    [[TMP3:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP2]], float [[VECEXT4]])
; CHECK-NEXT:    [[VECEXT6:%.*]] = extractelement <8 x float> [[V]], i32 4
; CHECK-NEXT:    [[TMP4:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP3]], float [[VECEXT6]])
; CHECK-NEXT:    [[VECEXT8:%.*]] = extractelement <8 x float> [[V]], i32 5
; CHECK-NEXT:    [[TMP5:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP4]], float [[VECEXT8]])
; CHECK-NEXT:    [[VECEXT10:%.*]] = extractelement <8 x float> [[V]], i32 6
; CHECK-NEXT:    [[TMP6:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP5]], float [[VECEXT10]])
; CHECK-NEXT:    [[VECEXT12:%.*]] = extractelement <8 x float> [[V]], i32 7
; CHECK-NEXT:    [[TMP7:%.*]] = tail call nnan ninf nsz float @llvm.maxnum.f32(float [[TMP6]], float [[VECEXT12]])
; CHECK-NEXT:    ret float [[TMP7]]
;
entry:
