...
; RUN: opt -mtriple=nvptx64-nvidia-cuda -O1 -S -o - %s | FileCheck %s --check-prefix=CHECK-O1
; RUN: opt -mtriple=nvptx64-nvidia-cuda -O2 -S -o - %s | FileCheck %s --check-prefix=CHECK-O2
; RUN: opt -mtriple=nvptx64-nvidia-cuda -O3 -S -o - %s | FileCheck %s --check-prefix=CHECK-O3
...
; CHECK-DAG: <4 x i16>
; CHECK-DAG: or disjoint
; CHECK-O1: or disjoint
; CHECK-O2: or disjoint
; CHECK-O3: or disjoint
}
