...
; CHECK-NEXT:    [[ADD_6:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[ADD_8:%.*]], %[[FOR_BODY4]] ]
...
; CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[ADD_PTR]], align 4, !tbaa [[INT_TBAA3:![0-9]+]]
...
; CHECK-NEXT:    [[ADD_111:%.*]] = add i32 [[TMP1]], [[ADD_7]]
...
; CHECK-NEXT:    [[ADD_9:%.*]] = add i32 [[TMP6]], [[ADD_5]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = load i32, ptr [[ADD_PTR_7]], align 4, !tbaa [[INT_TBAA3]]
; CHECK-NEXT:    [[ADD_8]] = add i32 [[TMP24]], [[ADD_9]]
...
; CHECK-NEXT:    [[ADD_PTR_1_1:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_1]]
...
; CHECK-NEXT:    [[ADD_PTR_1_2:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_2]]
; CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[ADD_PTR_1_2]], align 4, !tbaa [[INT_TBAA3]]
; CHECK-NEXT:    [[TMP12:%.*]] = add i32 [[TMP10]], [[TMP11]]
; CHECK-NEXT:    [[IDX_NEG_1_3:%.*]] = xor i64 [[INDVARS_IV_1]], -3
; CHECK-NEXT:    [[ADD_PTR_1_3:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_3]]
...
; CHECK-NEXT:    [[ADD_PTR_1_4:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_4]]
...
; CHECK-NEXT:    [[ADD_PTR_1_5:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_5]]
...
; CHECK-NEXT:    [[ADD_PTR_1_6:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_6]]
...
; CHECK-NEXT:    [[ADD_PTR_1_7:%.*]] = getelementptr inbounds [4 x i8], ptr getelementptr inbounds nuw (i8, ptr @ARR, i64 396), i64 [[IDX_NEG_1_7]]
...
; CHECK-NEXT:    [[ADD_2_6:%.*]] = phi i32 [ [[ADD_2_8:%.*]], %[[FOR_BODY4_2]] ], [ [[ADD_1_7]], %[[FOR_BODY4_1]] ]
...
; CHECK-NEXT:    [[TMP31:%.*]] = load i32, ptr [[ADD_PTR_2]], align 4, !tbaa [[INT_TBAA3]]
...
; CHECK-NEXT:    [[ADD_2_1:%.*]] = add i32 [[MUL_2_1]], [[ADD_2_7]]
...
; CHECK-NEXT:    [[ADD_2_9:%.*]] = add i32 [[MUL_2_6]], [[ADD_2_5]]
...
; CHECK-NEXT:    [[TMP32:%.*]] = load i32, ptr [[ADD_PTR_2_7]], align 4, !tbaa [[INT_TBAA3]]
; CHECK-NEXT:    [[MUL_2_8:%.*]] = mul i32 [[TMP32]], 3
; CHECK-NEXT:    [[ADD_2_8]] = add i32 [[MUL_2_8]], [[ADD_2_9]]
