...
; CHECK-NEXT:    br i1 [[DOTNOT]], label %[[VECTOR_BODY_COND_1:.*]], label %[[VECTOR_EARLY_EXIT:.*]]
...
; CHECK-NEXT:    br i1 [[DOTNOT_1]], label %[[VECTOR_BODY_COND_1_1:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_1]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_2]], label %[[VECTOR_BODY_COND_1_2:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_2]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_3]], label %[[VECTOR_BODY_COND_1_3:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_3]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_4]], label %[[VECTOR_BODY_COND_1_4:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_4]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_5]], label %[[VECTOR_BODY_COND_1_5:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_5]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_6]], label %[[VECTOR_BODY_COND_1_6:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_6]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_7]], label %[[VECTOR_BODY_COND_1_7:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_7]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_8]], label %[[VECTOR_BODY_COND_1_8:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_8]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_9]], label %[[VECTOR_BODY_COND_1_9:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_9]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_10]], label %[[VECTOR_BODY_COND_1_10:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_10]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_11]], label %[[VECTOR_BODY_COND_1_11:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_11]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_12]], label %[[VECTOR_BODY_COND_1_12:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_12]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_13]], label %[[VECTOR_BODY_COND_1_13:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_13]]:
...
; CHECK-NEXT:    br i1 [[DOTNOT_14]], label %[[VECTOR_BODY_COND_1_14:.*]], label %[[VECTOR_EARLY_EXIT]]
; CHECK:       [[VECTOR_BODY_COND_1_14]]:
...
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[ENTRY]] ], [ 8, %[[VECTOR_BODY_COND_1]] ], [ 16, %[[VECTOR_BODY_COND_1_1]] ], [ 24, %[[VECTOR_BODY_COND_1_2]] ], [ 32, %[[VECTOR_BODY_COND_1_3]] ], [ 40, %[[VECTOR_BODY_COND_1_4]] ], [ 48, %[[VECTOR_BODY_COND_1_5]] ], [ 56, %[[VECTOR_BODY_COND_1_6]] ], [ 64, %[[VECTOR_BODY_COND_1_7]] ], [ 72, %[[VECTOR_BODY_COND_1_8]] ], [ 80, %[[VECTOR_BODY_COND_1_9]] ], [ 88, %[[VECTOR_BODY_COND_1_10]] ], [ 96, %[[VECTOR_BODY_COND_1_11]] ], [ 104, %[[VECTOR_BODY_COND_1_12]] ], [ 112, %[[VECTOR_BODY_COND_1_13]] ], [ 120, %[[VECTOR_BODY_COND_1_14]] ]
; CHECK-NEXT:    [[DOTLCSSA:%.*]] = phi <8 x i1> [ [[TMP2]], %[[ENTRY]] ], [ [[TMP0]], %[[VECTOR_BODY_COND_1]] ], [ [[TMP4]], %[[VECTOR_BODY_COND_1_1]] ], [ [[TMP33]], %[[VECTOR_BODY_COND_1_2]] ], [ [[TMP35]], %[[VECTOR_BODY_COND_1_3]] ], [ [[TMP10]], %[[VECTOR_BODY_COND_1_4]] ], [ [[TMP12]], %[[VECTOR_BODY_COND_1_5]] ], [ [[TMP14]], %[[VECTOR_BODY_COND_1_6]] ], [ [[TMP16]], %[[VECTOR_BODY_COND_1_7]] ], [ [[TMP18]], %[[VECTOR_BODY_COND_1_8]] ], [ [[TMP20]], %[[VECTOR_BODY_COND_1_9]] ], [ [[TMP22]], %[[VECTOR_BODY_COND_1_10]] ], [ [[TMP24]], %[[VECTOR_BODY_COND_1_11]] ], [ [[TMP26]], %[[VECTOR_BODY_COND_1_12]] ], [ [[TMP28]], %[[VECTOR_BODY_COND_1_13]] ], [ [[TMP30]], %[[VECTOR_BODY_COND_1_14]] ]
...
; CHECK:       [[RETURN]]:
; CHECK-NEXT:    [[__FIRST_ADDR_0_LCSSA_I_I_PH:%.*]] = phi ptr [ [[TMP8]], %[[VECTOR_EARLY_EXIT]] ], [ [[COERCE_VAL_IP]], %[[VECTOR_BODY_COND_1_14]] ]
...
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[PROL_ITER_NEXT:%.*]], %[[VECTOR_BODY_COND_1:.*]] ]
