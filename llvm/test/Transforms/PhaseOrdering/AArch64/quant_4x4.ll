...
; CHECK-SAME: (ptr nofree noundef captures(none) [[DCT:%.*]], ptr nofree noundef readonly captures(none) [[MF:%.*]], ptr nofree noundef readonly captures(none) [[BIAS:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[WIDE_LOAD28:%.*]] = load <8 x i16>, ptr [[TMP0]], align 2, !alias.scope [[META0]], !noalias [[META3]]
; CHECK-NEXT:    [[TMP1:%.*]] = sext <8 x i16> [[WIDE_LOAD]] to <8 x i32>
; CHECK-NEXT:    [[TMP2:%.*]] = sext <8 x i16> [[WIDE_LOAD28]] to <8 x i32>
; CHECK-NEXT:    [[TMP3:%.*]] = icmp sgt <8 x i16> [[WIDE_LOAD]], zeroinitializer
; CHECK-NEXT:    [[TMP4:%.*]] = icmp sgt <8 x i16> [[WIDE_LOAD28]], zeroinitializer
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD29:%.*]] = load <8 x i16>, ptr [[BIAS]], align 2, !alias.scope [[META6:![0-9]+]]
; CHECK-NEXT:    [[WIDE_LOAD30:%.*]] = load <8 x i16>, ptr [[TMP5]], align 2, !alias.scope [[META6]]
; CHECK-NEXT:    [[TMP6:%.*]] = zext <8 x i16> [[WIDE_LOAD29]] to <8 x i32>
; CHECK-NEXT:    [[TMP7:%.*]] = zext <8 x i16> [[WIDE_LOAD30]] to <8 x i32>
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 16
; CHECK-NEXT:    [[WIDE_LOAD31:%.*]] = load <8 x i16>, ptr [[MF]], align 2, !alias.scope [[META7:![0-9]+]]
; CHECK-NEXT:    [[WIDE_LOAD32:%.*]] = load <8 x i16>, ptr [[TMP8]], align 2, !alias.scope [[META7]]
; CHECK-NEXT:    [[TMP9:%.*]] = zext <8 x i16> [[WIDE_LOAD31]] to <8 x i32>
; CHECK-NEXT:    [[TMP10:%.*]] = zext <8 x i16> [[WIDE_LOAD32]] to <8 x i32>
...
; CHECK-NEXT:    [[PREDPHI33:%.*]] = select <8 x i1> [[TMP4]], <8 x i16> [[TMP28]], <8 x i16> [[TMP20]]
; CHECK-NEXT:    store <8 x i16> [[PREDPHI]], ptr [[DCT]], align 2, !alias.scope [[META0]], !noalias [[META3]]
; CHECK-NEXT:    store <8 x i16> [[PREDPHI33]], ptr [[TMP0]], align 2, !alias.scope [[META0]], !noalias [[META3]]
; CHECK-NEXT:    [[BIN_RDX34:%.*]] = or <8 x i16> [[PREDPHI33]], [[PREDPHI]]
; CHECK-NEXT:    [[TMP29:%.*]] = tail call i16 @llvm.vector.reduce.or.v8i16(<8 x i16> [[BIN_RDX34]])
; CHECK-NEXT:    br label [[FOR_COND_CLEANUP:%.*]]
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    [[OR_LCSSA_IN:%.*]] = phi i16 [ [[TMP29]], [[VECTOR_BODY]] ], [ [[OR_1550:%.*]], [[IF_END_15:%.*]] ]
...
; CHECK-NEXT:    [[OR_136:%.*]] = or i16 [[STOREMERGE]], [[STOREMERGE_1]]
...
; CHECK-NEXT:    [[OR_237:%.*]] = or i16 [[OR_136]], [[STOREMERGE_2]]
...
; CHECK-NEXT:    [[OR_338:%.*]] = or i16 [[OR_237]], [[STOREMERGE_3]]
...
; CHECK-NEXT:    [[OR_439:%.*]] = or i16 [[OR_338]], [[STOREMERGE_4]]
...
; CHECK-NEXT:    [[OR_540:%.*]] = or i16 [[OR_439]], [[STOREMERGE_5]]
...
; CHECK-NEXT:    [[OR_641:%.*]] = or i16 [[OR_540]], [[STOREMERGE_6]]
...
; CHECK-NEXT:    [[OR_742:%.*]] = or i16 [[OR_641]], [[STOREMERGE_7]]
...
; CHECK-NEXT:    [[OR_843:%.*]] = or i16 [[OR_742]], [[STOREMERGE_8]]
...
; CHECK-NEXT:    [[OR_944:%.*]] = or i16 [[OR_843]], [[STOREMERGE_9]]
...
; CHECK-NEXT:    [[OR_1045:%.*]] = or i16 [[OR_944]], [[STOREMERGE_10]]
...
; CHECK-NEXT:    [[OR_1146:%.*]] = or i16 [[OR_1045]], [[STOREMERGE_11]]
...
; CHECK-NEXT:    [[OR_1247:%.*]] = or i16 [[OR_1146]], [[STOREMERGE_12]]
...
; CHECK-NEXT:    [[OR_1348:%.*]] = or i16 [[OR_1247]], [[STOREMERGE_13]]
...
; CHECK-NEXT:    [[OR_1449:%.*]] = or i16 [[OR_1348]], [[STOREMERGE_14]]
...
; CHECK-LTO-NEXT:    [[SHR26_7:%.*]] = lshr i32 [[MUL25_7]], 16
; CHECK-LTO-NEXT:    [[TMP61:%.*]] = trunc nuw i32 [[SHR26_7]] to i16
; CHECK-LTO-NEXT:    [[CONV28_7:%.*]] = sub i16 0, [[TMP61]]
; CHECK-LTO-NEXT:    br label [[IF_END_7:%.*]]
; CHECK-LTO:       if.then.7:
; CHECK-LTO-NEXT:    [[ADD_7:%.*]] = add nuw nsw i32 [[CONV5_7]], [[CONV_7]]
; CHECK-LTO-NEXT:    [[MUL_7:%.*]] = mul i32 [[ADD_7]], [[CONV11_7]]
; CHECK-LTO-NEXT:    [[SHR_7:%.*]] = lshr i32 [[MUL_7]], 16
; CHECK-LTO-NEXT:    [[CONV12_7:%.*]] = trunc nuw i32 [[SHR_7]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_7]]
; CHECK-LTO:       if.end.7:
; CHECK-LTO-NEXT:    [[STOREMERGE_7:%.*]] = phi i16 [ [[CONV28_7]], [[IF_ELSE_7]] ], [ [[CONV12_7]], [[IF_THEN_7]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_7]], ptr [[ARRAYIDX_7]], align 2
; CHECK-LTO-NEXT:    [[OR_742:%.*]] = or i16 [[OR_641]], [[STOREMERGE_7]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_8:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 16
; CHECK-LTO-NEXT:    [[TMP62:%.*]] = load i16, ptr [[ARRAYIDX_8]], align 2
; CHECK-LTO-NEXT:    [[CONV_8:%.*]] = sext i16 [[TMP62]] to i32
; CHECK-LTO-NEXT:    [[CMP1_8:%.*]] = icmp sgt i16 [[TMP62]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_8:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 16
; CHECK-LTO-NEXT:    [[TMP63:%.*]] = load i16, ptr [[ARRAYIDX4_8]], align 2
; CHECK-LTO-NEXT:    [[CONV5_8:%.*]] = zext i16 [[TMP63]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_8:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 16
; CHECK-LTO-NEXT:    [[TMP64:%.*]] = load i16, ptr [[ARRAYIDX10_8]], align 2
; CHECK-LTO-NEXT:    [[CONV11_8:%.*]] = zext i16 [[TMP64]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_8]], label [[IF_THEN_8:%.*]], label [[IF_ELSE_8:%.*]]
; CHECK-LTO:       if.else.8:
; CHECK-LTO-NEXT:    [[ADD21_8:%.*]] = sub nsw i32 [[CONV5_8]], [[CONV_8]]
; CHECK-LTO-NEXT:    [[MUL25_8:%.*]] = mul i32 [[ADD21_8]], [[CONV11_8]]
; CHECK-LTO-NEXT:    [[SHR26_8:%.*]] = lshr i32 [[MUL25_8]], 16
; CHECK-LTO-NEXT:    [[TMP65:%.*]] = trunc nuw i32 [[SHR26_8]] to i16
; CHECK-LTO-NEXT:    [[CONV28_8:%.*]] = sub i16 0, [[TMP65]]
; CHECK-LTO-NEXT:    br label [[IF_END_8:%.*]]
; CHECK-LTO:       if.then.8:
; CHECK-LTO-NEXT:    [[ADD_8:%.*]] = add nuw nsw i32 [[CONV5_8]], [[CONV_8]]
; CHECK-LTO-NEXT:    [[MUL_8:%.*]] = mul i32 [[ADD_8]], [[CONV11_8]]
; CHECK-LTO-NEXT:    [[SHR_8:%.*]] = lshr i32 [[MUL_8]], 16
; CHECK-LTO-NEXT:    [[CONV12_8:%.*]] = trunc nuw i32 [[SHR_8]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_8]]
; CHECK-LTO:       if.end.8:
; CHECK-LTO-NEXT:    [[STOREMERGE_8:%.*]] = phi i16 [ [[CONV28_8]], [[IF_ELSE_8]] ], [ [[CONV12_8]], [[IF_THEN_8]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_8]], ptr [[ARRAYIDX_8]], align 2
; CHECK-LTO-NEXT:    [[OR_843:%.*]] = or i16 [[OR_742]], [[STOREMERGE_8]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_9:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 18
; CHECK-LTO-NEXT:    [[TMP66:%.*]] = load i16, ptr [[ARRAYIDX_9]], align 2
; CHECK-LTO-NEXT:    [[CONV_9:%.*]] = sext i16 [[TMP66]] to i32
; CHECK-LTO-NEXT:    [[CMP1_9:%.*]] = icmp sgt i16 [[TMP66]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_9:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 18
; CHECK-LTO-NEXT:    [[TMP67:%.*]] = load i16, ptr [[ARRAYIDX4_9]], align 2
; CHECK-LTO-NEXT:    [[CONV5_9:%.*]] = zext i16 [[TMP67]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_9:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 18
; CHECK-LTO-NEXT:    [[TMP68:%.*]] = load i16, ptr [[ARRAYIDX10_9]], align 2
; CHECK-LTO-NEXT:    [[CONV11_9:%.*]] = zext i16 [[TMP68]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_9]], label [[IF_THEN_9:%.*]], label [[IF_ELSE_9:%.*]]
; CHECK-LTO:       if.else.9:
; CHECK-LTO-NEXT:    [[ADD21_9:%.*]] = sub nsw i32 [[CONV5_9]], [[CONV_9]]
; CHECK-LTO-NEXT:    [[MUL25_9:%.*]] = mul i32 [[ADD21_9]], [[CONV11_9]]
; CHECK-LTO-NEXT:    [[SHR26_9:%.*]] = lshr i32 [[MUL25_9]], 16
; CHECK-LTO-NEXT:    [[TMP69:%.*]] = trunc nuw i32 [[SHR26_9]] to i16
; CHECK-LTO-NEXT:    [[CONV28_9:%.*]] = sub i16 0, [[TMP69]]
; CHECK-LTO-NEXT:    br label [[IF_END_9:%.*]]
; CHECK-LTO:       if.then.9:
; CHECK-LTO-NEXT:    [[ADD_9:%.*]] = add nuw nsw i32 [[CONV5_9]], [[CONV_9]]
; CHECK-LTO-NEXT:    [[MUL_9:%.*]] = mul i32 [[ADD_9]], [[CONV11_9]]
; CHECK-LTO-NEXT:    [[SHR_9:%.*]] = lshr i32 [[MUL_9]], 16
; CHECK-LTO-NEXT:    [[CONV12_9:%.*]] = trunc nuw i32 [[SHR_9]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_9]]
; CHECK-LTO:       if.end.9:
; CHECK-LTO-NEXT:    [[STOREMERGE_9:%.*]] = phi i16 [ [[CONV28_9]], [[IF_ELSE_9]] ], [ [[CONV12_9]], [[IF_THEN_9]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_9]], ptr [[ARRAYIDX_9]], align 2
; CHECK-LTO-NEXT:    [[OR_944:%.*]] = or i16 [[OR_843]], [[STOREMERGE_9]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_10:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 20
; CHECK-LTO-NEXT:    [[TMP70:%.*]] = load i16, ptr [[ARRAYIDX_10]], align 2
; CHECK-LTO-NEXT:    [[CONV_10:%.*]] = sext i16 [[TMP70]] to i32
; CHECK-LTO-NEXT:    [[CMP1_10:%.*]] = icmp sgt i16 [[TMP70]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_10:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 20
; CHECK-LTO-NEXT:    [[TMP71:%.*]] = load i16, ptr [[ARRAYIDX4_10]], align 2
; CHECK-LTO-NEXT:    [[CONV5_10:%.*]] = zext i16 [[TMP71]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_10:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 20
; CHECK-LTO-NEXT:    [[TMP72:%.*]] = load i16, ptr [[ARRAYIDX10_10]], align 2
; CHECK-LTO-NEXT:    [[CONV11_10:%.*]] = zext i16 [[TMP72]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_10]], label [[IF_THEN_10:%.*]], label [[IF_ELSE_10:%.*]]
; CHECK-LTO:       if.else.10:
; CHECK-LTO-NEXT:    [[ADD21_10:%.*]] = sub nsw i32 [[CONV5_10]], [[CONV_10]]
; CHECK-LTO-NEXT:    [[MUL25_10:%.*]] = mul i32 [[ADD21_10]], [[CONV11_10]]
; CHECK-LTO-NEXT:    [[SHR26_10:%.*]] = lshr i32 [[MUL25_10]], 16
; CHECK-LTO-NEXT:    [[TMP73:%.*]] = trunc nuw i32 [[SHR26_10]] to i16
; CHECK-LTO-NEXT:    [[CONV28_10:%.*]] = sub i16 0, [[TMP73]]
; CHECK-LTO-NEXT:    br label [[IF_END_10:%.*]]
; CHECK-LTO:       if.then.10:
; CHECK-LTO-NEXT:    [[ADD_10:%.*]] = add nuw nsw i32 [[CONV5_10]], [[CONV_10]]
; CHECK-LTO-NEXT:    [[MUL_10:%.*]] = mul i32 [[ADD_10]], [[CONV11_10]]
; CHECK-LTO-NEXT:    [[SHR_10:%.*]] = lshr i32 [[MUL_10]], 16
; CHECK-LTO-NEXT:    [[CONV12_10:%.*]] = trunc nuw i32 [[SHR_10]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_10]]
; CHECK-LTO:       if.end.10:
; CHECK-LTO-NEXT:    [[STOREMERGE_10:%.*]] = phi i16 [ [[CONV28_10]], [[IF_ELSE_10]] ], [ [[CONV12_10]], [[IF_THEN_10]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_10]], ptr [[ARRAYIDX_10]], align 2
; CHECK-LTO-NEXT:    [[OR_1045:%.*]] = or i16 [[OR_944]], [[STOREMERGE_10]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_11:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 22
; CHECK-LTO-NEXT:    [[TMP74:%.*]] = load i16, ptr [[ARRAYIDX_11]], align 2
; CHECK-LTO-NEXT:    [[CONV_11:%.*]] = sext i16 [[TMP74]] to i32
; CHECK-LTO-NEXT:    [[CMP1_11:%.*]] = icmp sgt i16 [[TMP74]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_11:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 22
; CHECK-LTO-NEXT:    [[TMP75:%.*]] = load i16, ptr [[ARRAYIDX4_11]], align 2
; CHECK-LTO-NEXT:    [[CONV5_11:%.*]] = zext i16 [[TMP75]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_11:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 22
; CHECK-LTO-NEXT:    [[TMP76:%.*]] = load i16, ptr [[ARRAYIDX10_11]], align 2
; CHECK-LTO-NEXT:    [[CONV11_11:%.*]] = zext i16 [[TMP76]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_11]], label [[IF_THEN_11:%.*]], label [[IF_ELSE_11:%.*]]
; CHECK-LTO:       if.else.11:
; CHECK-LTO-NEXT:    [[ADD21_11:%.*]] = sub nsw i32 [[CONV5_11]], [[CONV_11]]
; CHECK-LTO-NEXT:    [[MUL25_11:%.*]] = mul i32 [[ADD21_11]], [[CONV11_11]]
; CHECK-LTO-NEXT:    [[SHR26_11:%.*]] = lshr i32 [[MUL25_11]], 16
; CHECK-LTO-NEXT:    [[TMP77:%.*]] = trunc nuw i32 [[SHR26_11]] to i16
; CHECK-LTO-NEXT:    [[CONV28_11:%.*]] = sub i16 0, [[TMP77]]
; CHECK-LTO-NEXT:    br label [[IF_END_11:%.*]]
; CHECK-LTO:       if.then.11:
; CHECK-LTO-NEXT:    [[ADD_11:%.*]] = add nuw nsw i32 [[CONV5_11]], [[CONV_11]]
; CHECK-LTO-NEXT:    [[MUL_11:%.*]] = mul i32 [[ADD_11]], [[CONV11_11]]
; CHECK-LTO-NEXT:    [[SHR_11:%.*]] = lshr i32 [[MUL_11]], 16
; CHECK-LTO-NEXT:    [[CONV12_11:%.*]] = trunc nuw i32 [[SHR_11]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_11]]
; CHECK-LTO:       if.end.11:
; CHECK-LTO-NEXT:    [[STOREMERGE_11:%.*]] = phi i16 [ [[CONV28_11]], [[IF_ELSE_11]] ], [ [[CONV12_11]], [[IF_THEN_11]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_11]], ptr [[ARRAYIDX_11]], align 2
; CHECK-LTO-NEXT:    [[OR_1146:%.*]] = or i16 [[OR_1045]], [[STOREMERGE_11]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_12:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 24
; CHECK-LTO-NEXT:    [[TMP78:%.*]] = load i16, ptr [[ARRAYIDX_12]], align 2
; CHECK-LTO-NEXT:    [[CONV_12:%.*]] = sext i16 [[TMP78]] to i32
; CHECK-LTO-NEXT:    [[CMP1_12:%.*]] = icmp sgt i16 [[TMP78]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_12:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 24
; CHECK-LTO-NEXT:    [[TMP79:%.*]] = load i16, ptr [[ARRAYIDX4_12]], align 2
; CHECK-LTO-NEXT:    [[CONV5_12:%.*]] = zext i16 [[TMP79]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_12:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 24
; CHECK-LTO-NEXT:    [[TMP80:%.*]] = load i16, ptr [[ARRAYIDX10_12]], align 2
; CHECK-LTO-NEXT:    [[CONV11_12:%.*]] = zext i16 [[TMP80]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_12]], label [[IF_THEN_12:%.*]], label [[IF_ELSE_12:%.*]]
; CHECK-LTO:       if.else.12:
; CHECK-LTO-NEXT:    [[ADD21_12:%.*]] = sub nsw i32 [[CONV5_12]], [[CONV_12]]
; CHECK-LTO-NEXT:    [[MUL25_12:%.*]] = mul i32 [[ADD21_12]], [[CONV11_12]]
; CHECK-LTO-NEXT:    [[SHR26_12:%.*]] = lshr i32 [[MUL25_12]], 16
; CHECK-LTO-NEXT:    [[TMP81:%.*]] = trunc nuw i32 [[SHR26_12]] to i16
; CHECK-LTO-NEXT:    [[CONV28_12:%.*]] = sub i16 0, [[TMP81]]
; CHECK-LTO-NEXT:    br label [[IF_END_12:%.*]]
; CHECK-LTO:       if.then.12:
; CHECK-LTO-NEXT:    [[ADD_12:%.*]] = add nuw nsw i32 [[CONV5_12]], [[CONV_12]]
; CHECK-LTO-NEXT:    [[MUL_12:%.*]] = mul i32 [[ADD_12]], [[CONV11_12]]
; CHECK-LTO-NEXT:    [[SHR_12:%.*]] = lshr i32 [[MUL_12]], 16
; CHECK-LTO-NEXT:    [[CONV12_12:%.*]] = trunc nuw i32 [[SHR_12]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_12]]
; CHECK-LTO:       if.end.12:
; CHECK-LTO-NEXT:    [[STOREMERGE_12:%.*]] = phi i16 [ [[CONV28_12]], [[IF_ELSE_12]] ], [ [[CONV12_12]], [[IF_THEN_12]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_12]], ptr [[ARRAYIDX_12]], align 2
; CHECK-LTO-NEXT:    [[OR_1247:%.*]] = or i16 [[OR_1146]], [[STOREMERGE_12]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_13:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 26
; CHECK-LTO-NEXT:    [[TMP82:%.*]] = load i16, ptr [[ARRAYIDX_13]], align 2
; CHECK-LTO-NEXT:    [[CONV_13:%.*]] = sext i16 [[TMP82]] to i32
; CHECK-LTO-NEXT:    [[CMP1_13:%.*]] = icmp sgt i16 [[TMP82]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_13:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 26
; CHECK-LTO-NEXT:    [[TMP83:%.*]] = load i16, ptr [[ARRAYIDX4_13]], align 2
; CHECK-LTO-NEXT:    [[CONV5_13:%.*]] = zext i16 [[TMP83]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_13:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 26
; CHECK-LTO-NEXT:    [[TMP84:%.*]] = load i16, ptr [[ARRAYIDX10_13]], align 2
; CHECK-LTO-NEXT:    [[CONV11_13:%.*]] = zext i16 [[TMP84]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_13]], label [[IF_THEN_13:%.*]], label [[IF_ELSE_13:%.*]]
; CHECK-LTO:       if.else.13:
; CHECK-LTO-NEXT:    [[ADD21_13:%.*]] = sub nsw i32 [[CONV5_13]], [[CONV_13]]
; CHECK-LTO-NEXT:    [[MUL25_13:%.*]] = mul i32 [[ADD21_13]], [[CONV11_13]]
; CHECK-LTO-NEXT:    [[SHR26_13:%.*]] = lshr i32 [[MUL25_13]], 16
; CHECK-LTO-NEXT:    [[TMP85:%.*]] = trunc nuw i32 [[SHR26_13]] to i16
; CHECK-LTO-NEXT:    [[CONV28_13:%.*]] = sub i16 0, [[TMP85]]
; CHECK-LTO-NEXT:    br label [[IF_END_13:%.*]]
; CHECK-LTO:       if.then.13:
; CHECK-LTO-NEXT:    [[ADD_13:%.*]] = add nuw nsw i32 [[CONV5_13]], [[CONV_13]]
; CHECK-LTO-NEXT:    [[MUL_13:%.*]] = mul i32 [[ADD_13]], [[CONV11_13]]
; CHECK-LTO-NEXT:    [[SHR_13:%.*]] = lshr i32 [[MUL_13]], 16
; CHECK-LTO-NEXT:    [[CONV12_13:%.*]] = trunc nuw i32 [[SHR_13]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_13]]
; CHECK-LTO:       if.end.13:
; CHECK-LTO-NEXT:    [[STOREMERGE_13:%.*]] = phi i16 [ [[CONV28_13]], [[IF_ELSE_13]] ], [ [[CONV12_13]], [[IF_THEN_13]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_13]], ptr [[ARRAYIDX_13]], align 2
; CHECK-LTO-NEXT:    [[OR_1348:%.*]] = or i16 [[OR_1247]], [[STOREMERGE_13]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_14:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 28
; CHECK-LTO-NEXT:    [[TMP86:%.*]] = load i16, ptr [[ARRAYIDX_14]], align 2
; CHECK-LTO-NEXT:    [[CONV_14:%.*]] = sext i16 [[TMP86]] to i32
; CHECK-LTO-NEXT:    [[CMP1_14:%.*]] = icmp sgt i16 [[TMP86]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_14:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 28
; CHECK-LTO-NEXT:    [[TMP87:%.*]] = load i16, ptr [[ARRAYIDX4_14]], align 2
; CHECK-LTO-NEXT:    [[CONV5_14:%.*]] = zext i16 [[TMP87]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_14:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 28
; CHECK-LTO-NEXT:    [[TMP88:%.*]] = load i16, ptr [[ARRAYIDX10_14]], align 2
; CHECK-LTO-NEXT:    [[CONV11_14:%.*]] = zext i16 [[TMP88]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_14]], label [[IF_THEN_14:%.*]], label [[IF_ELSE_14:%.*]]
; CHECK-LTO:       if.else.14:
; CHECK-LTO-NEXT:    [[ADD21_14:%.*]] = sub nsw i32 [[CONV5_14]], [[CONV_14]]
; CHECK-LTO-NEXT:    [[MUL25_14:%.*]] = mul i32 [[ADD21_14]], [[CONV11_14]]
; CHECK-LTO-NEXT:    [[SHR26_14:%.*]] = lshr i32 [[MUL25_14]], 16
; CHECK-LTO-NEXT:    [[TMP89:%.*]] = trunc nuw i32 [[SHR26_14]] to i16
; CHECK-LTO-NEXT:    [[CONV28_14:%.*]] = sub i16 0, [[TMP89]]
; CHECK-LTO-NEXT:    br label [[IF_END_14:%.*]]
; CHECK-LTO:       if.then.14:
; CHECK-LTO-NEXT:    [[ADD_14:%.*]] = add nuw nsw i32 [[CONV5_14]], [[CONV_14]]
; CHECK-LTO-NEXT:    [[MUL_14:%.*]] = mul i32 [[ADD_14]], [[CONV11_14]]
; CHECK-LTO-NEXT:    [[SHR_14:%.*]] = lshr i32 [[MUL_14]], 16
; CHECK-LTO-NEXT:    [[CONV12_14:%.*]] = trunc nuw i32 [[SHR_14]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_14]]
; CHECK-LTO:       if.end.14:
; CHECK-LTO-NEXT:    [[STOREMERGE_14:%.*]] = phi i16 [ [[CONV28_14]], [[IF_ELSE_14]] ], [ [[CONV12_14]], [[IF_THEN_14]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_14]], ptr [[ARRAYIDX_14]], align 2
; CHECK-LTO-NEXT:    [[OR_1449:%.*]] = or i16 [[OR_1348]], [[STOREMERGE_14]]
; CHECK-LTO-NEXT:    [[ARRAYIDX_15:%.*]] = getelementptr inbounds nuw i8, ptr [[DCT]], i64 30
; CHECK-LTO-NEXT:    [[TMP90:%.*]] = load i16, ptr [[ARRAYIDX_15]], align 2
; CHECK-LTO-NEXT:    [[CONV_15:%.*]] = sext i16 [[TMP90]] to i32
; CHECK-LTO-NEXT:    [[CMP1_15:%.*]] = icmp sgt i16 [[TMP90]], 0
; CHECK-LTO-NEXT:    [[ARRAYIDX4_15:%.*]] = getelementptr inbounds nuw i8, ptr [[BIAS]], i64 30
; CHECK-LTO-NEXT:    [[TMP91:%.*]] = load i16, ptr [[ARRAYIDX4_15]], align 2
; CHECK-LTO-NEXT:    [[CONV5_15:%.*]] = zext i16 [[TMP91]] to i32
; CHECK-LTO-NEXT:    [[ARRAYIDX10_15:%.*]] = getelementptr inbounds nuw i8, ptr [[MF]], i64 30
; CHECK-LTO-NEXT:    [[TMP92:%.*]] = load i16, ptr [[ARRAYIDX10_15]], align 2
; CHECK-LTO-NEXT:    [[CONV11_15:%.*]] = zext i16 [[TMP92]] to i32
; CHECK-LTO-NEXT:    br i1 [[CMP1_15]], label [[IF_THEN_15:%.*]], label [[IF_ELSE_15:%.*]]
; CHECK-LTO:       if.else.15:
; CHECK-LTO-NEXT:    [[ADD21_15:%.*]] = sub nsw i32 [[CONV5_15]], [[CONV_15]]
; CHECK-LTO-NEXT:    [[MUL25_15:%.*]] = mul i32 [[ADD21_15]], [[CONV11_15]]
; CHECK-LTO-NEXT:    [[SHR26_15:%.*]] = lshr i32 [[MUL25_15]], 16
; CHECK-LTO-NEXT:    [[TMP93:%.*]] = trunc nuw i32 [[SHR26_15]] to i16
; CHECK-LTO-NEXT:    [[CONV28_15:%.*]] = sub i16 0, [[TMP93]]
; CHECK-LTO-NEXT:    br label [[IF_END_15]]
; CHECK-LTO:       if.then.15:
; CHECK-LTO-NEXT:    [[ADD_15:%.*]] = add nuw nsw i32 [[CONV5_15]], [[CONV_15]]
; CHECK-LTO-NEXT:    [[MUL_15:%.*]] = mul i32 [[ADD_15]], [[CONV11_15]]
; CHECK-LTO-NEXT:    [[SHR_15:%.*]] = lshr i32 [[MUL_15]], 16
; CHECK-LTO-NEXT:    [[CONV12_15:%.*]] = trunc nuw i32 [[SHR_15]] to i16
; CHECK-LTO-NEXT:    br label [[IF_END_15]]
; CHECK-LTO:       if.end.15:
; CHECK-LTO-NEXT:    [[STOREMERGE_15:%.*]] = phi i16 [ [[CONV28_15]], [[IF_ELSE_15]] ], [ [[CONV12_15]], [[IF_THEN_15]] ]
; CHECK-LTO-NEXT:    store i16 [[STOREMERGE_15]], ptr [[ARRAYIDX_15]], align 2
; CHECK-LTO-NEXT:    [[OR_1550]] = or i16 [[OR_1449]], [[STOREMERGE_15]]
; CHECK-LTO-NEXT:    br label [[FOR_COND_CLEANUP]]
;
entry:
