...
; CHECK-NEXT:    [[TMP10:%.*]] = shl nuw nsw i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds nuw i8, ptr [[ARRAY]], i64 [[TMP10]]
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[ARRAY]], i64 [[TMP9]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i8, ptr [[S_COERCE0]], i64 [[TMP6]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = shl nsw i64 [[I_07]], 2
; CHECK-NEXT:    [[ARRAYIDX_I:%.*]] = getelementptr inbounds i8, ptr [[S_COERCE0]], i64 [[TMP8]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = shl nsw i64 [[__IDX]], 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 [[TMP2]]
