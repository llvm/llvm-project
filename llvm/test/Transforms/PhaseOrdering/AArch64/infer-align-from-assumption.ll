...
; CHECK-SAME: ptr nofree captures(none) [[P:%.*]]) local_unnamed_addr {
...
; CHECK-NEXT:    call void @llvm.assume(i1 true) [ "align"(ptr [[L_2_I]], i64 4, i64 0) ]
...
; CHECK-SAME: ptr nofree readonly captures(none) [[P:%.*]]) local_unnamed_addr {
...
; CHECK-SAME: ptr nofree readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR1:[0-9]+]] {
...
; CHECK-SAME: ptr nofree readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR2:[0-9]+]] {
; CHECK-NEXT:    [[L:%.*]] = load ptr, ptr [[P]], align 8
...
; CHECK-SAME: ptr nofree readonly captures(none) [[P:%.*]]) local_unnamed_addr #[[ATTR3:[0-9]+]] {
; CHECK-NEXT:    call void @llvm.assume(i1 true) [ "align"(ptr [[P]], i64 8) ]
...
; CHECK-SAME: ptr nofree readonly captures(none) [[TMP0:%.*]]) local_unnamed_addr #[[ATTR3]] {
