...
; CHECK-NEXT:    [[INVARIANT_GEP:%.*]] = getelementptr i8, ptr [[ARRAY]], i64 32
; CHECK-NEXT:    [[INVARIANT_GEP8:%.*]] = getelementptr i8, ptr [[ARRAY]], i64 64
; CHECK-NEXT:    [[INVARIANT_GEP10:%.*]] = getelementptr i8, ptr [[ARRAY]], i64 96
; CHECK-NEXT:    br label %[[VECTOR_BODY:.*]]
; CHECK:       [[VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr nusw %"class.dealii::VectorizedArray", ptr [[ARRAY]], i64 [[INDEX]]
; CHECK-NEXT:    [[GEP7:%.*]] = getelementptr %"class.dealii::VectorizedArray", ptr [[INVARIANT_GEP]], i64 [[INDEX]]
; CHECK-NEXT:    [[GEP9:%.*]] = getelementptr %"class.dealii::VectorizedArray", ptr [[INVARIANT_GEP8]], i64 [[INDEX]]
; CHECK-NEXT:    [[GEP11:%.*]] = getelementptr %"class.dealii::VectorizedArray", ptr [[INVARIANT_GEP10]], i64 [[INDEX]]
...
; CHECK-NEXT:    [[WIDE_VEC4:%.*]] = load <8 x double>, ptr [[GEP9]], align 8, !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    [[STRIDED_VEC5:%.*]] = shufflevector <8 x double> [[WIDE_VEC4]], <8 x double> poison, <2 x i32> <i32 0, i32 4>
; CHECK-NEXT:    [[TMP6:%.*]] = fadd <2 x double> [[BROADCAST_SPLAT]], [[STRIDED_VEC]]
; CHECK-NEXT:    [[TMP7:%.*]] = fadd <2 x double> [[BROADCAST_SPLAT]], [[STRIDED_VEC5]]
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <2 x double> [[TMP6]], i64 0
; CHECK-NEXT:    store double [[TMP8]], ptr [[TMP5]], align 8, !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <2 x double> [[TMP6]], i64 1
; CHECK-NEXT:    store double [[TMP9]], ptr [[GEP7]], align 8, !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <2 x double> [[TMP7]], i64 0
; CHECK-NEXT:    store double [[TMP10]], ptr [[GEP9]], align 8, !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <2 x double> [[TMP7]], i64 1
; CHECK-NEXT:    store double [[TMP11]], ptr [[GEP11]], align 8, !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[TMP12]], label %[[LOOP_LATCH_PREHEADER6]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP5:![0-9]+]]
; CHECK:       [[LOOP_LATCH_PREHEADER6]]:
; CHECK-NEXT:    [[I2_PH:%.*]] = phi i64 [ 0, %[[VECTOR_MEMCHECK]] ], [ 0, %[[LOOP_LATCH_PREHEADER]] ], [ [[N_VEC]], %[[VECTOR_BODY]] ]
; CHECK-NEXT:    br label %[[LOOP_LATCH:.*]]
; CHECK:       [[LOOP_LATCH]]:
; CHECK-NEXT:    [[I2:%.*]] = phi i64 [ [[I_NEXT:%.*]], %[[LOOP_LATCH]] ], [ [[I2_PH]], %[[LOOP_LATCH_PREHEADER6]] ]
