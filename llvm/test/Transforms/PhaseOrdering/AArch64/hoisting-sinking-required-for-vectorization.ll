...
; CHECK-NEXT:    [[TMP16:%.*]] = shl nuw nsw i64 [[INDEX]], 3
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds nuw i8, ptr [[Y]], i64 [[TMP16]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds nuw i8, ptr [[X]], i64 [[TMP16]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = shl nuw nsw i64 [[INDVARS_IV]], 3
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[Y]], i64 [[TMP15]]
...
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds nuw i8, ptr [[X]], i64 [[TMP15]]
...
; CHECK-NEXT:    [[TMP12:%.*]] = shl i64 [[INDEX]], 2
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds nuw i8, ptr [[C]], i64 [[TMP12]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP12]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[B]], i64 [[TMP12]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = shl nuw nsw i64 [[IV1]], 2
; CHECK-NEXT:    [[C_GEP:%.*]] = getelementptr inbounds nuw i8, ptr [[C]], i64 [[TMP14]]
; CHECK-NEXT:    [[C_LV:%.*]] = load i32, ptr [[C_GEP]], align 4
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[C_LV]], 20
; CHECK-NEXT:    [[A_GEP_0:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 [[TMP14]]
; CHECK-NEXT:    [[A_LV_0:%.*]] = load float, ptr [[A_GEP_0]], align 4
; CHECK-NEXT:    [[MUL2_I81_I:%.*]] = fmul float [[X]], [[A_LV_0]]
; CHECK-NEXT:    [[B_GEP_0:%.*]] = getelementptr inbounds nuw i8, ptr [[B]], i64 [[TMP14]]
