...
; CHECK-NEXT:    br i1 [[TMP7]], label %[[FP_TO_I_IF_SATURATE:.*]], label %[[FP_TO_I_IF_CHECK_EXP_SIZE:.*]], !prof [[PROF0:![0-9]+]]
...
; CHECK-NEXT:    br i1 [[TMP6]], label %[[FP_TO_I_IF_SATURATE:.*]], label %[[FP_TO_I_IF_CHECK_EXP_SIZE:.*]], !prof [[PROF0]]
; CHECK:       [[FP_TO_I_IF_SATURATE]]:
; CHECK-NEXT:    br label %[[FP_TO_I_CLEANUP]]
; CHECK:       [[FP_TO_I_IF_CHECK_EXP_SIZE]]:
; CHECK-NEXT:    [[EXP_SMALLER_MANTISSA_WIDTH:%.*]] = icmp ult i16 [[BIASED_EXP]], 25
