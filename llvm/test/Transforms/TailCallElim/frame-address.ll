...
; A call that is passed an address in the current frame must not be marked tail.
...
; A non-zero level refers to a caller's frame.
...
; llvm.returnaddress is a code address.
