...
; CHECK:       [[FLOW]]:
; CHECK-NEXT:    [[TMP2:%.*]] = phi i32 [ [[SUM_ELSE:%.*]], %[[ELSE]] ], [ undef, %[[ENTRY]] ]
...
; CHECK:       [[MERGE]]:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[TMP2]], %[[FLOW]] ], [ [[A_THEN]], %[[THEN]] ]
...
; CHECK-NEXT:    br label %[[FLOW]]
; CHECK:       [[FLOW]]:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[A_THEN]], %[[THEN]] ], [ undef, %[[ENTRY]] ]
...
; CHECK-NEXT:    br label %[[FLOW]]
; CHECK:       [[FLOW1:.*]]:
; CHECK-NEXT:    [[TMP4:%.*]] = phi i32 [ [[Y:%.*]], %[[ELSE:.*]] ], [ undef, %[[FLOW]] ]
...
; CHECK:       [[LATCH]]:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[A_THEN]], %[[THEN]] ], [ [[TMP4]], %[[FLOW1]] ]
; CHECK-NEXT:    store i32 [[TMP0]], ptr [[PTR]], align 4
