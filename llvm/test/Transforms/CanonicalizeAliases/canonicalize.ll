; RUN: opt --opaque-pointers=0 -S -passes=canonicalize-aliases < %s | FileCheck %s
; RUN: opt --opaque-pointers=0 -passes='thinlto-pre-link<O0>,require<module-summary>' -o - < %s | llvm-dis --opaque-pointers=0 -o - | FileCheck %s
