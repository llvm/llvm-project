...
; NO_ASSUME-LABEL: define i8 @test_bypass1(
...
;
; USE_ASSUME-LABEL: define i8 @test_bypass1(
...
; NO_ASSUME-LABEL: define i8 @test_bypass2(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    store i8 42, ptr [[P]], align 1
; NO_ASSUME-NEXT:    [[I:%.*]] = call ptr @llvm.invariant.start.p0(i64 1, ptr [[P]])
; NO_ASSUME-NEXT:    ret i8 42
;
; USE_ASSUME-LABEL: define i8 @test_bypass2(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
...
; NO_ASSUME-LABEL: define i8 @test_bypass_store_load(
...
; NO_ASSUME-NEXT:    ret i8 42
;
; USE_ASSUME-LABEL: define i8 @test_bypass_store_load(
...
; NO_ASSUME-LABEL: define i8 @test_bypass_store_load_aatags_1(
; NO_ASSUME-SAME: ptr [[P:%.*]], ptr [[P2:%.*]]) {
; NO_ASSUME-NEXT:    store i8 42, ptr [[P]], align 1, !tbaa [[FLOAT_TBAA0:![0-9]+]]
; NO_ASSUME-NEXT:    [[I:%.*]] = call ptr @llvm.invariant.start.p0(i64 1, ptr [[P]])
; NO_ASSUME-NEXT:    store i8 0, ptr [[P2]], align 1
; NO_ASSUME-NEXT:    ret i8 42
;
; USE_ASSUME-LABEL: define i8 @test_bypass_store_load_aatags_1(
; USE_ASSUME-SAME: ptr [[P:%.*]], ptr [[P2:%.*]]) {
; USE_ASSUME-NEXT:    store i8 42, ptr [[P]], align 1, !tbaa [[FLOAT_TBAA0:![0-9]+]]
; USE_ASSUME-NEXT:    [[I:%.*]] = call ptr @llvm.invariant.start.p0(i64 1, ptr [[P]])
; USE_ASSUME-NEXT:    store i8 0, ptr [[P2]], align 1
; USE_ASSUME-NEXT:    call void @llvm.assume(i1 true) [ "dereferenceable"(ptr [[P]], i64 1), "nonnull"(ptr [[P]]) ]
; USE_ASSUME-NEXT:    ret i8 42
...
; CHECK-LABEL: define i8 @test_bypass_store_load_aatags_2(
...
; CHECK-NEXT:    [[V1:%.*]] = load i8, ptr [[P]], align 1, !tbaa [[FLOAT_TBAA0:![0-9]+]]
...
; NO_ASSUME-LABEL: define void @test_bypass3(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    [[I:%.*]] = call ptr @llvm.invariant.start.p0(i64 1, ptr [[P]])
; NO_ASSUME-NEXT:    store i8 60, ptr [[P]], align 1
; NO_ASSUME-NEXT:    ret void
;
; USE_ASSUME-LABEL: define void @test_bypass3(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
; USE_ASSUME-NEXT:    [[I:%.*]] = call ptr @llvm.invariant.start.p0(i64 1, ptr [[P]])
; USE_ASSUME-NEXT:    call void @llvm.assume(i1 true) [ "dereferenceable"(ptr [[P]], i64 1), "nonnull"(ptr [[P]]) ]
...
; CHECK-LABEL: define void @test_bypass4(
; CHECK-SAME: ptr [[P:%.*]]) {
...
; NO_ASSUME-LABEL: define i32 @test_before_load(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
...
;
; USE_ASSUME-LABEL: define i32 @test_before_load(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
...
; NO_ASSUME-LABEL: define i32 @test_before_clobber(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_before_clobber(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    call void @clobber()
...
; NO_ASSUME-LABEL: define i32 @test_duplicate_scope(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    call void @clobber()
...
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_duplicate_scope(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    call void @clobber()
...
; NO_ASSUME-LABEL: define i32 @test_unanalzyable_load(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
...
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_unanalzyable_load(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    call void @clobber()
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
...
; CHECK-LABEL: define i32 @test_negative_after_clobber(
; CHECK-SAME: ptr [[P:%.*]]) {
...
; NO_ASSUME-LABEL: define i32 @test_merge(
...
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_merge(
...
; CHECK-LABEL: define i32 @test_negative_after_mergeclobber(
...
; CHECK-LABEL: define i32 @test_false_negative_merge(
; CHECK-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; CHECK-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; CHECK-NEXT:    br i1 [[CND]], label %[[MERGE:.*]], label %[[TAKEN:.*]]
; CHECK:       [[TAKEN]]:
...
; NO_ASSUME-LABEL: define i32 @test_merge_unanalyzable_load(
; NO_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
...
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_merge_unanalyzable_load(
; USE_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    call void @clobber()
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
...
; NO_ASSUME-LABEL: define void @test_dse_before_load(
; NO_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    ret void
;
; USE_ASSUME-LABEL: define void @test_dse_before_load(
; USE_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; USE_ASSUME-NEXT:    call void @clobber()
...
; NO_ASSUME-LABEL: define void @test_dse_after_load(
; NO_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; NO_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    ret void
;
; USE_ASSUME-LABEL: define void @test_dse_after_load(
; USE_ASSUME-SAME: ptr [[P:%.*]], i1 [[CND:%.*]]) {
; USE_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; USE_ASSUME-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; USE_ASSUME-NEXT:    call void @clobber()
...
; CHECK-LABEL: define i32 @test_false_negative_types(
; CHECK-SAME: ptr [[P:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; CHECK-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; CHECK-NEXT:    call void @clobber()
...
; CHECK-LABEL: define i32 @test_negative_size1(
; CHECK-SAME: ptr [[P:%.*]]) {
...
; CHECK-LABEL: define i32 @test_negative_size2(
; CHECK-SAME: ptr [[P:%.*]]) {
...
; CHECK-LABEL: define i32 @test_negative_scope(
; CHECK-SAME: ptr [[P:%.*]]) {
...
; CHECK-LABEL: define i32 @test_false_negative_scope(
; CHECK-SAME: ptr [[P:%.*]]) {
; CHECK-NEXT:    [[SCOPE:%.*]] = call ptr @llvm.invariant.start.p0(i64 4, ptr [[P]])
; CHECK-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4
; CHECK-NEXT:    call void @clobber()
...
; NO_ASSUME-LABEL: define i32 @test_invariant_load_scope(
; NO_ASSUME-SAME: ptr [[P:%.*]]) {
; NO_ASSUME-NEXT:    [[V1:%.*]] = load i32, ptr [[P]], align 4, !invariant.load [[META4:![0-9]+]]
; NO_ASSUME-NEXT:    call void @clobber()
; NO_ASSUME-NEXT:    ret i32 0
;
; USE_ASSUME-LABEL: define i32 @test_invariant_load_scope(
; USE_ASSUME-SAME: ptr [[P:%.*]]) {
...
!3 = !{!"Simple C/C++ TBAA"}
;.
; NO_ASSUME: [[FLOAT_TBAA0]] = !{[[META1:![0-9]+]], [[META1]], i64 0}
; NO_ASSUME: [[META1]] = !{!"float", [[META2:![0-9]+]], i64 0}
; NO_ASSUME: [[META2]] = !{!"omnipotent char", [[META3:![0-9]+]], i64 0}
; NO_ASSUME: [[META3]] = !{!"Simple C/C++ TBAA"}
; NO_ASSUME: [[META4]] = !{}
;.
; USE_ASSUME: [[FLOAT_TBAA0]] = !{[[META1:![0-9]+]], [[META1]], i64 0}
; USE_ASSUME: [[META1]] = !{!"float", [[META2:![0-9]+]], i64 0}
; USE_ASSUME: [[META2]] = !{!"omnipotent char", [[META3:![0-9]+]], i64 0}
; USE_ASSUME: [[META3]] = !{!"Simple C/C++ TBAA"}
; USE_ASSUME: [[META4]] = !{}
;.
