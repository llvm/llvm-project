...
; RV32IZFINX-NEXT:    lui a1, 913408
; RV32IZFINX-NEXT:    mv s0, a0
; RV32IZFINX-NEXT:    fle.s s1, a1, a0
; RV32IZFINX-NEXT:    call __fixsfdi
...
; RV32IF-NEXT:    fmv.w.x fa5, a0
; RV32IF-NEXT:    lui a0, 290816
; RV32IF-NEXT:    addi a0, a0, -512
...
; RV64IF-NEXT:    lui a0, 290816
; RV64IF-NEXT:    addi a0, a0, -512
...
; RV32IZFINX:       # %bb.0: # %start
; RV32IZFINX-NEXT:    lui a1, 815104
; RV32IZFINX-NEXT:    fmax.s a1, a0, a1
; RV32IZFINX-NEXT:    lui a2, 290816
; RV32IZFINX-NEXT:    addi a2, a2, -512
; RV32IZFINX-NEXT:    fmin.s a1, a1, a2
; RV32IZFINX-NEXT:    feq.s a0, a0, a0
; RV32IZFINX-NEXT:    fcvt.w.s a1, a1, rtz
; RV32IZFINX-NEXT:    neg a0, a0
