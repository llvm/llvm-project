...
; RV32I-NEXT:    li t0, 32
; RV32I-NEXT:    neg t4, a2
; RV32I-NEXT:    srl t2, a3, a2
; RV32I-NEXT:    sll t6, a7, t4
...
; RV64I-NEXT:    srl a5, a0, a2
; RV64I-NEXT:    sll a4, a1, a4
...
; RV32I-NEXT:  .LBB8_14:
; RV32I-NEXT:    srl t6, t2, t5
; RV32I-NEXT:    sll s0, a1, a2
; RV32I-NEXT:    sll t5, t2, a2
...
; RV32I-NEXT:  .LBB8_19:
; RV32I-NEXT:    neg t1, s0
; RV32I-NEXT:    srl s1, a7, t1
; RV32I-NEXT:    sll t1, a7, a2
; RV32I-NEXT:    or a7, s1, t0
...
; RV64I-NEXT:    srl a4, a3, a0
; RV64I-NEXT:    sll a5, a1, a2
; RV64I-NEXT:    sll a0, a3, a2
; RV64I-NEXT:    or a3, a4, a5
...
; RV32I-NEXT:    j .LBB9_3
; RV32I-NEXT:  .LBB9_2:
; RV32I-NEXT:    neg a3, a5
; RV32I-NEXT:    srl a6, a0, a2
; RV32I-NEXT:    sll a3, a1, a3
...
; RV32I-NEXT:    sll t5, a2, t6
; RV32I-NEXT:    bltu t4, a6, .LBB10_2
; RV32I-NEXT:  # %bb.1:
; RV32I-NEXT:    srl a5, a2, t4
; RV32I-NEXT:    j .LBB10_3
; RV32I-NEXT:  .LBB10_2:
; RV32I-NEXT:    srl a4, a3, t3
...
; RV32I-NEXT:  # %bb.18:
; RV32I-NEXT:    srl s2, a2, s1
; RV32I-NEXT:    j .LBB10_20
; RV32I-NEXT:  .LBB10_19:
; RV32I-NEXT:    neg s0, s1
; RV32I-NEXT:    srl s2, a3, t4
; RV32I-NEXT:    sll s0, a2, s0
; RV32I-NEXT:    or s2, s2, s0
; RV32I-NEXT:  .LBB10_20:
; RV32I-NEXT:    mv s0, a3
...
; RV32I-NEXT:  .LBB10_42:
; RV32I-NEXT:    srl s2, a3, s2
; RV32I-NEXT:    sll s3, a2, t6
; RV32I-NEXT:    sll t6, a3, t6
; RV32I-NEXT:    or s4, s2, s3
...
; RV32I-NEXT:  .LBB10_44:
; RV32I-NEXT:    li t6, 0
; RV32I-NEXT:    sll s4, a3, t3
; RV32I-NEXT:  .LBB10_45:
; RV32I-NEXT:    addi s3, t3, -64
; RV32I-NEXT:    mv s2, a2
; RV32I-NEXT:    beqz t3, .LBB10_47
; RV32I-NEXT:  # %bb.46:
; RV32I-NEXT:    mv s2, s4
; RV32I-NEXT:  .LBB10_47:
; RV32I-NEXT:    bltu s3, a6, .LBB10_49
; RV32I-NEXT:  # %bb.48:
; RV32I-NEXT:    li a6, 0
; RV32I-NEXT:    sll a7, a7, s3
; RV32I-NEXT:    bnez s3, .LBB10_50
; RV32I-NEXT:    j .LBB10_51
; RV32I-NEXT:  .LBB10_49:
; RV32I-NEXT:    neg a6, s3
; RV32I-NEXT:    srl s4, a7, a6
; RV32I-NEXT:    sll s5, a5, t3
; RV32I-NEXT:    sll a6, a7, t3
; RV32I-NEXT:    or a7, s4, s5
; RV32I-NEXT:    beqz s3, .LBB10_51
; RV32I-NEXT:  .LBB10_50:
; RV32I-NEXT:    mv a5, a7
; RV32I-NEXT:  .LBB10_51:
...
; RV64I-NEXT:  .LBB10_2:
; RV64I-NEXT:    neg a3, a5
; RV64I-NEXT:    srl a6, a0, a2
; RV64I-NEXT:    sll a3, a1, a3
; RV64I-NEXT:    or a6, a6, a3
; RV64I-NEXT:  .LBB10_3:
; RV64I-NEXT:    mv a3, a0
...
; RV64I-NEXT:  .LBB10_8:
; RV64I-NEXT:    andi a5, a6, 127
; RV64I-NEXT:    bltu a5, a4, .LBB10_10
; RV64I-NEXT:  # %bb.9:
; RV64I-NEXT:    li a6, 0
; RV64I-NEXT:    sub a4, a5, a4
; RV64I-NEXT:    sll a0, a0, a4
; RV64I-NEXT:    bnez a5, .LBB10_11
; RV64I-NEXT:    j .LBB10_12
; RV64I-NEXT:  .LBB10_10:
; RV64I-NEXT:    neg a4, a5
; RV64I-NEXT:    srl a4, a0, a4
; RV64I-NEXT:    sll a7, a1, a6
; RV64I-NEXT:    sll a6, a0, a6
; RV64I-NEXT:    or a0, a4, a7
; RV64I-NEXT:    beqz a5, .LBB10_12
; RV64I-NEXT:  .LBB10_11:
; RV64I-NEXT:    mv a1, a0
; RV64I-NEXT:  .LBB10_12:
; RV64I-NEXT:    or a0, a3, a6
