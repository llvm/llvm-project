...
; RUN: llc -mtriple=riscv32 -O0 -global-isel -stop-after=irtranslator -verify-machineinstrs -o - %s | FileCheck %s
...
define i32 @test_multiple_registers_output() nounwind ssp {
...
define i32 @asm_multiple_registers_early_clobber() nounwind ssp {
