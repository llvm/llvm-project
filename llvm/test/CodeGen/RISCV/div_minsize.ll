...
; RV32IM-NEXT:    sltu a3, a5, a3
; RV32IM-NEXT:    add a6, a4, a3
...
; RV32IM:       # %bb.0:
; RV32IM-NEXT:    lw a4, 28(a1)
; RV32IM-NEXT:    lw a3, 0(a1)
; RV32IM-NEXT:    lw a5, 4(a1)
; RV32IM-NEXT:    srai a2, a4, 31
; RV32IM-NEXT:    srli a2, a2, 30
; RV32IM-NEXT:    lw t3, 8(a1)
; RV32IM-NEXT:    lw t1, 12(a1)
; RV32IM-NEXT:    add a2, a3, a2
; RV32IM-NEXT:    sltu t2, a2, a3
; RV32IM-NEXT:    add a3, a5, t2
; RV32IM-NEXT:    sltu a5, a3, a5
; RV32IM-NEXT:    lw a6, 24(a1)
; RV32IM-NEXT:    lw a7, 20(a1)
; RV32IM-NEXT:    lw t0, 16(a1)
; RV32IM-NEXT:    and t2, t2, a5
; RV32IM-NEXT:    add a1, t3, t2
; RV32IM-NEXT:    sltu t3, a1, t3
; RV32IM-NEXT:    add a5, t1, t3
; RV32IM-NEXT:    beqz t2, .LBB5_2
; RV32IM-NEXT:  # %bb.1:
; RV32IM-NEXT:    sltu t1, a5, t1
; RV32IM-NEXT:    and t2, t3, t1
; RV32IM-NEXT:  .LBB5_2:
; RV32IM-NEXT:    add t2, t0, t2
; RV32IM-NEXT:    srli t1, a5, 2
; RV32IM-NEXT:    sltu t0, t2, t0
; RV32IM-NEXT:    slli t3, t2, 30
; RV32IM-NEXT:    or t1, t1, t3
; RV32IM-NEXT:    add t3, a7, t0
; RV32IM-NEXT:    srli t2, t2, 2
; RV32IM-NEXT:    sltu a7, t3, a7
; RV32IM-NEXT:    and a7, t0, a7
; RV32IM-NEXT:    srli t0, t3, 2
; RV32IM-NEXT:    slli t3, t3, 30
; RV32IM-NEXT:    add a7, a6, a7
; RV32IM-NEXT:    or t2, t2, t3
; RV32IM-NEXT:    sltu a6, a7, a6
...
; RV32IM-NEXT:    slli a5, a5, 30
; RV32IM-NEXT:    srai a4, a4, 2
; RV32IM-NEXT:    or a5, t0, a5
; RV32IM-NEXT:    slli a1, a1, 30
; RV32IM-NEXT:    srli t0, a3, 2
; RV32IM-NEXT:    srli a2, a2, 2
; RV32IM-NEXT:    slli a3, a3, 30
...
; RV64IM-NEXT:    ld a3, 0(a1)
; RV64IM-NEXT:    ld a4, 8(a1)
; RV64IM-NEXT:    srai a5, a2, 63
; RV64IM-NEXT:    srli a5, a5, 62
; RV64IM-NEXT:    ld a1, 16(a1)
; RV64IM-NEXT:    add a5, a3, a5
; RV64IM-NEXT:    sltu a3, a5, a3
; RV64IM-NEXT:    add a6, a4, a3
; RV64IM-NEXT:    sltu a4, a6, a4
