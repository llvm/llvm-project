...
; RV32XTHEADBB-NEXT:    and a4, a6, a4
...
; RV32I-NEXT:    srai a2, a5, 31
; RV32I-NEXT:    addi a5, a7, -32
; RV32I-NEXT:    and a2, a2, a4
; RV32I-NEXT:    bltz a5, .LBB10_5
; RV32I-NEXT:  # %bb.4:
...
; RV32ZBB-NEXT:    srai a2, a5, 31
; RV32ZBB-NEXT:    addi a5, a7, -32
; RV32ZBB-NEXT:    and a2, a2, a4
; RV32ZBB-NEXT:    bltz a5, .LBB10_5
; RV32ZBB-NEXT:  # %bb.4:
...
; RV32XTHEADBB-NEXT:    andi a7, a6, 63
; RV32XTHEADBB-NEXT:    srai a2, a5, 31
; RV32XTHEADBB-NEXT:    addi a5, a7, -32
; RV32XTHEADBB-NEXT:    and a2, a2, a4
; RV32XTHEADBB-NEXT:    bltz a5, .LBB10_5
; RV32XTHEADBB-NEXT:  # %bb.4:
...
; RV32XTHEADBB-NEXT:    srl a1, a1, a6
; RV32XTHEADBB-NEXT:    srai a5, a5, 31
...
; RV32XTHEADBB-NEXT:    sll a6, a1, a2
; RV32XTHEADBB-NEXT:    srl a3, a5, a3
; RV32XTHEADBB-NEXT:    or a3, a6, a3
; RV32XTHEADBB-NEXT:  .LBB11_3:
; RV32XTHEADBB-NEXT:    neg a5, a2
; RV32XTHEADBB-NEXT:    sll a2, a0, a2
; RV32XTHEADBB-NEXT:    andi a6, a5, 63
; RV32XTHEADBB-NEXT:    srai a7, a4, 31
; RV32XTHEADBB-NEXT:    addi a4, a6, -32
; RV32XTHEADBB-NEXT:    and a2, a7, a2
; RV32XTHEADBB-NEXT:    bltz a4, .LBB11_5
; RV32XTHEADBB-NEXT:  # %bb.4:
...
; RV32XTHEADBB-NEXT:    addi a5, a7, -32
; RV32XTHEADBB-NEXT:    and a2, a2, a4
; RV32XTHEADBB-NEXT:    bltz a5, .LBB13_5
; RV32XTHEADBB-NEXT:  # %bb.4:
...
; RV32XTHEADBB-NEXT:    slli a5, a1, 1
; RV32XTHEADBB-NEXT:    not a3, a3
; RV32XTHEADBB-NEXT:    srl a6, a0, a2
; RV32XTHEADBB-NEXT:    sll a3, a5, a3
; RV32XTHEADBB-NEXT:    or a3, a6, a3
...
; RV32XTHEADBB-NEXT:    addi a4, a6, -32
; RV32XTHEADBB-NEXT:    and a2, a7, a2
; RV32XTHEADBB-NEXT:    bltz a4, .LBB14_5
; RV32XTHEADBB-NEXT:  # %bb.4:
...
; RV32XTHEADBB-NEXT:    srl a1, a0, t0
...
; RV32XTHEADBB-NEXT:    srli a6, a6, 1
; RV32XTHEADBB-NEXT:    sll t1, a0, a4
; RV32XTHEADBB-NEXT:    srl t2, a6, a1
...
; RV32XTHEADBB-NEXT:    or a2, a2, a0
; RV32XTHEADBB-NEXT:    add a0, a6, a3
; RV32XTHEADBB-NEXT:    add a1, a7, a2
; RV32XTHEADBB-NEXT:    sltu a2, a0, a6
; RV32XTHEADBB-NEXT:    add a1, a1, a2
; RV32XTHEADBB-NEXT:    ret
;
...
; RV32I-NEXT:    mv a7, a3
; RV32I-NEXT:  .LBB23_6:
; RV32I-NEXT:    or a1, t1, t0
; RV32I-NEXT:    or a6, t2, a6
; RV32I-NEXT:    srl t0, a7, a4
...
; RV32ZBB-NEXT:  # %bb.5:
; RV32ZBB-NEXT:    mv a7, a3
; RV32ZBB-NEXT:  .LBB23_6:
; RV32ZBB-NEXT:    or a1, t1, t0
; RV32ZBB-NEXT:    or a6, t2, a6
; RV32ZBB-NEXT:    srl t0, a7, a4
...
; RV32XTHEADBB-NEXT:    sll t1, a7, a0
; RV32XTHEADBB-NEXT:    slli a7, a6, 1
; RV32XTHEADBB-NEXT:    srl a6, a1, a4
; RV32XTHEADBB-NEXT:    sll t2, a7, a0
; RV32XTHEADBB-NEXT:    mv a7, a2
; RV32XTHEADBB-NEXT:    beqz a5, .LBB23_6
; RV32XTHEADBB-NEXT:  # %bb.5:
; RV32XTHEADBB-NEXT:    mv a7, a3
; RV32XTHEADBB-NEXT:  .LBB23_6:
; RV32XTHEADBB-NEXT:    or a1, t1, t0
; RV32XTHEADBB-NEXT:    or a6, t2, a6
; RV32XTHEADBB-NEXT:    srl t0, a7, a4
...
; RV32XTHEADBB-NEXT:    slli a7, a7, 1
; RV32XTHEADBB-NEXT:    or a2, a2, t0
; RV32XTHEADBB-NEXT:    srl a3, a3, a4
; RV32XTHEADBB-NEXT:    sll a0, a7, a0
; RV32XTHEADBB-NEXT:    or a3, a0, a3
...
; RV32I-NEXT:    srl a3, a7, a3
; RV32I-NEXT:    or a3, t0, a3
; RV32I-NEXT:  .LBB24_3:
; RV32I-NEXT:    li a7, 32
; RV32I-NEXT:    srai t0, a6, 31
...
; RV32ZBB-NEXT:    srai t0, a6, 31
; RV32ZBB-NEXT:    sub a6, a7, a2
; RV32ZBB-NEXT:    and a5, t0, a5
...
; RV32XTHEADBB-NEXT:    srl a3, a7, a3
; RV32XTHEADBB-NEXT:    or a3, t0, a3
; RV32XTHEADBB-NEXT:  .LBB24_3:
; RV32XTHEADBB-NEXT:    li a7, 32
; RV32XTHEADBB-NEXT:    srai t0, a6, 31
; RV32XTHEADBB-NEXT:    sub a6, a7, a2
; RV32XTHEADBB-NEXT:    and a5, t0, a5
