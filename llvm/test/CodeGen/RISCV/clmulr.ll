...
; RV32I-NEXT:    sw ra, 92(sp) # 4-byte Spill
; RV32I-NEXT:    sw s0, 88(sp) # 4-byte Spill
; RV32I-NEXT:    sw s1, 84(sp) # 4-byte Spill
; RV32I-NEXT:    sw s2, 80(sp) # 4-byte Spill
; RV32I-NEXT:    sw s3, 76(sp) # 4-byte Spill
; RV32I-NEXT:    sw s4, 72(sp) # 4-byte Spill
; RV32I-NEXT:    sw s5, 68(sp) # 4-byte Spill
; RV32I-NEXT:    sw s6, 64(sp) # 4-byte Spill
; RV32I-NEXT:    sw s7, 60(sp) # 4-byte Spill
; RV32I-NEXT:    sw s8, 56(sp) # 4-byte Spill
; RV32I-NEXT:    sw s9, 52(sp) # 4-byte Spill
; RV32I-NEXT:    sw s10, 48(sp) # 4-byte Spill
; RV32I-NEXT:    sw s11, 44(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a4, 40(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a3, 36(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a1, 32(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a0, 4(sp) # 4-byte Spill
...
; RV32I-NEXT:    lw a5, 12(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a4, 4(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a2, 40(sp) # 4-byte Reload
...
; RV32I-NEXT:    slli a0, a0, 1
; RV32I-NEXT:    or a0, a1, a0
; RV32I-NEXT:    lw ra, 92(sp) # 4-byte Reload
; RV32I-NEXT:    lw s0, 88(sp) # 4-byte Reload
; RV32I-NEXT:    lw s1, 84(sp) # 4-byte Reload
; RV32I-NEXT:    lw s2, 80(sp) # 4-byte Reload
; RV32I-NEXT:    lw s3, 76(sp) # 4-byte Reload
; RV32I-NEXT:    lw s4, 72(sp) # 4-byte Reload
; RV32I-NEXT:    lw s5, 68(sp) # 4-byte Reload
; RV32I-NEXT:    lw s6, 64(sp) # 4-byte Reload
; RV32I-NEXT:    lw s7, 60(sp) # 4-byte Reload
; RV32I-NEXT:    lw s8, 56(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 52(sp) # 4-byte Reload
; RV32I-NEXT:    lw s10, 48(sp) # 4-byte Reload
; RV32I-NEXT:    lw s11, 44(sp) # 4-byte Reload
; RV32I-NEXT:    addi sp, sp, 96
; RV32I-NEXT:    ret
;
...
; RV32IM-NEXT:    sw t0, 20(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul t2, a0, t2
; RV32IM-NEXT:    xor t0, t0, t2
; RV32IM-NEXT:    sw t0, 16(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw t0, 12(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw t0, 4(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw a2, 20(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a2, a2, a3
; RV32IM-NEXT:    lw a3, 16(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, a3, s3
; RV32IM-NEXT:    lw s3, 12(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a4, s3, a4
; RV32IM-NEXT:    lw s3, 8(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a1, s3
; RV32IM-NEXT:    lw s3, 4(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a2, 24(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    sw a5, 36(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a4, 32(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw s8, 20(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, s8
; RV32IMZBS-NEXT:    lw s8, 16(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 12(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s8, s9
; RV32IMZBS-NEXT:    lw s9, 8(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    xor a1, a1, s8
; RV32IMZBS-NEXT:    lw t1, 4(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t5, 24(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a4, 40(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    and a0, a0, a4
; RV32IMZBS-NEXT:    and a1, a1, a4
; RV32IMZBS-NEXT:    slli a0, a0, 8
...
; RV32I-NEXT:    sw ra, 796(sp) # 4-byte Spill
; RV32I-NEXT:    sw s0, 792(sp) # 4-byte Spill
; RV32I-NEXT:    sw s1, 788(sp) # 4-byte Spill
; RV32I-NEXT:    sw s2, 784(sp) # 4-byte Spill
; RV32I-NEXT:    sw s3, 780(sp) # 4-byte Spill
; RV32I-NEXT:    sw s4, 776(sp) # 4-byte Spill
; RV32I-NEXT:    sw s5, 772(sp) # 4-byte Spill
; RV32I-NEXT:    sw s6, 768(sp) # 4-byte Spill
; RV32I-NEXT:    sw s7, 764(sp) # 4-byte Spill
; RV32I-NEXT:    sw s8, 760(sp) # 4-byte Spill
; RV32I-NEXT:    sw s9, 756(sp) # 4-byte Spill
; RV32I-NEXT:    sw s10, 752(sp) # 4-byte Spill
; RV32I-NEXT:    sw s11, 748(sp) # 4-byte Spill
; RV32I-NEXT:    sw a3, 736(sp) # 4-byte Spill
; RV32I-NEXT:    sw a2, 732(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw s11, 744(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw s10, 724(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw s9, 728(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw s3, 716(sp) # 4-byte Spill
; RV32I-NEXT:    and s2, s2, t6
; RV32I-NEXT:    sw s2, 720(sp) # 4-byte Spill
; RV32I-NEXT:    and a5, a5, t6
; RV32I-NEXT:    sw a5, 712(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a4, 700(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a4, 676(sp) # 4-byte Spill
; RV32I-NEXT:    andi a4, a1, 8
; RV32I-NEXT:    seqz a4, a4
...
; RV32I-NEXT:    sw a5, 628(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
...
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 608(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 652(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 584(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 5
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 592(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 636(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 648(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 6
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 656(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 672(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 568(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 596(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 588(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 660(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 10
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 664(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 680(sp) # 4-byte Spill
; RV32I-NEXT:    li a4, 1
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 488(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 11
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 500(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 520(sp) # 4-byte Spill
; RV32I-NEXT:    lui a5, 1
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 476(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 12
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 484(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 508(sp) # 4-byte Spill
; RV32I-NEXT:    lui a5, 2
; RV32I-NEXT:    and a4, a1, a5
; RV32I-NEXT:    seqz a4, a4
; RV32I-NEXT:    and a5, a3, a5
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 512(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 13
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 516(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 572(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 14
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 580(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 616(sp) # 4-byte Spill
; RV32I-NEXT:    lui a5, 8
; RV32I-NEXT:    and a4, a1, a5
; RV32I-NEXT:    seqz a4, a4
; RV32I-NEXT:    and a5, a3, a5
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 620(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 15
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 624(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 644(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 416(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 448(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 396(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 17
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 404(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 420(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 436(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 18
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 444(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 496(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 19
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 504(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 524(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 528(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 20
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 532(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
...
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 564(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 384(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 360(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 23
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 364(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 376(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a5, a5, t6
; RV32I-NEXT:    sw a5, 388(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, t6
; RV32I-NEXT:    sw a4, 392(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 408(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 424(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 428(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 26
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 432(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 460(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a6, a4, a6
; RV32I-NEXT:    sw a6, 452(sp) # 4-byte Spill
; RV32I-NEXT:    slli a6, a0, 27
; RV32I-NEXT:    and a5, a5, a6
; RV32I-NEXT:    sw a5, 456(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a6
...
; RV32I-NEXT:    and a4, a4, a6
; RV32I-NEXT:    sw a4, 492(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a2, 308(sp) # 4-byte Spill
; RV32I-NEXT:    and a5, a5, a0
; RV32I-NEXT:    sw a5, 332(sp) # 4-byte Spill
; RV32I-NEXT:    and a4, a4, a0
; RV32I-NEXT:    sw a4, 356(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 336(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 276(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 224(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
...
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 248(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a7, 440(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a2, a0, a2
; RV32I-NEXT:    sw a2, 112(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a2, a0, a2
; RV32I-NEXT:    sw a2, 148(sp) # 4-byte Spill
; RV32I-NEXT:    slli a2, t0, 13
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 156(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 180(sp) # 4-byte Spill
; RV32I-NEXT:    lui a1, 4
; RV32I-NEXT:    and a0, t3, a1
; RV32I-NEXT:    seqz a0, a0
; RV32I-NEXT:    and a1, s6, a1
...
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 232(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
...
; RV32I-NEXT:    and a2, a0, a2
; RV32I-NEXT:    sw a2, 76(sp) # 4-byte Spill
; RV32I-NEXT:    slli a2, t0, 18
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 80(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
...
; RV32I-NEXT:    and a2, a0, a2
; RV32I-NEXT:    sw a2, 136(sp) # 4-byte Spill
; RV32I-NEXT:    slli a2, t0, 19
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 140(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 152(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a2, a0, a2
; RV32I-NEXT:    sw a2, 160(sp) # 4-byte Spill
; RV32I-NEXT:    slli a2, t0, 20
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 168(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
; RV32I-NEXT:    sw a0, 176(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a1, a1, a2
; RV32I-NEXT:    sw a1, 188(sp) # 4-byte Spill
; RV32I-NEXT:    and a0, a0, a2
...
; RV32I-NEXT:    and a0, s9, s11
; RV32I-NEXT:    sw a0, 120(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw a0, 0(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 308(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, s4
; RV32I-NEXT:    sw a0, 308(sp) # 4-byte Spill
...
; RV32I-NEXT:    lw a0, 488(sp) # 4-byte Reload
; RV32I-NEXT:    lw a1, 476(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
; RV32I-NEXT:    sw a0, 536(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 412(sp) # 4-byte Reload
; RV32I-NEXT:    lw a1, 396(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
; RV32I-NEXT:    sw a0, 488(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 368(sp) # 4-byte Reload
; RV32I-NEXT:    lw a1, 360(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
...
; RV32I-NEXT:    lw a1, 540(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
...
; RV32I-NEXT:    lw a1, 164(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
; RV32I-NEXT:    sw a0, 360(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 112(sp) # 4-byte Reload
; RV32I-NEXT:    lw a1, 104(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
...
; RV32I-NEXT:    lw a1, 376(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a1, 296(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a1
; RV32I-NEXT:    lw a1, 276(sp) # 4-byte Reload
; RV32I-NEXT:    lw a2, 252(sp) # 4-byte Reload
; RV32I-NEXT:    xor a1, a1, a2
; RV32I-NEXT:    lw a2, 208(sp) # 4-byte Reload
; RV32I-NEXT:    lw a3, 204(sp) # 4-byte Reload
; RV32I-NEXT:    xor a2, a2, a3
; RV32I-NEXT:    lw a3, 144(sp) # 4-byte Reload
; RV32I-NEXT:    lw a4, 132(sp) # 4-byte Reload
; RV32I-NEXT:    xor a3, a3, a4
; RV32I-NEXT:    lw a4, 64(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a6, 4(sp) # 4-byte Reload
; RV32I-NEXT:    lw s8, 0(sp) # 4-byte Reload
; RV32I-NEXT:    xor a6, a6, s8
; RV32I-NEXT:    lw s8, 308(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 612(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s8, s9
; RV32I-NEXT:    sw s8, 596(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 648(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 604(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 584(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 588(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 556(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 588(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 512(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 536(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 576(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 436(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 488(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 568(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 380(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 476(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 556(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 716(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 412(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 716(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 640(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 396(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s8, s9
; RV32I-NEXT:    sw s8, 512(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 656(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 608(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 508(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 600(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 592(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 500(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 516(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 540(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 516(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 444(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 484(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 488(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 388(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 416(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 484(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 720(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 404(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 720(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 628(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 368(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s8, s9
; RV32I-NEXT:    sw s8, 676(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 284(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 364(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 668(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 216(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 360(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s9, s8
; RV32I-NEXT:    sw s8, 656(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 148(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 352(sp) # 4-byte Reload
; RV32I-NEXT:    xor s9, s9, s8
; RV32I-NEXT:    lw s8, 76(sp) # 4-byte Reload
; RV32I-NEXT:    xor s10, s10, s8
; RV32I-NEXT:    lw s8, 24(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, ra, s8
; RV32I-NEXT:    sw s8, 652(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 704(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s11, s8
; RV32I-NEXT:    sw s8, 704(sp) # 4-byte Spill
; RV32I-NEXT:    lw s8, 372(sp) # 4-byte Reload
; RV32I-NEXT:    xor s8, s8, s2
; RV32I-NEXT:    lw s2, 292(sp) # 4-byte Reload
; RV32I-NEXT:    xor s2, s5, s2
; RV32I-NEXT:    sw s2, 648(sp) # 4-byte Spill
; RV32I-NEXT:    lw s2, 228(sp) # 4-byte Reload
; RV32I-NEXT:    xor s2, s7, s2
; RV32I-NEXT:    sw s2, 640(sp) # 4-byte Spill
; RV32I-NEXT:    lw s2, 156(sp) # 4-byte Reload
; RV32I-NEXT:    xor s0, s0, s2
; RV32I-NEXT:    sw s0, 636(sp) # 4-byte Spill
; RV32I-NEXT:    lw s0, 80(sp) # 4-byte Reload
; RV32I-NEXT:    xor s0, s1, s0
; RV32I-NEXT:    sw s0, 628(sp) # 4-byte Spill
; RV32I-NEXT:    lw s0, 28(sp) # 4-byte Reload
; RV32I-NEXT:    xor s0, s3, s0
; RV32I-NEXT:    sw s0, 612(sp) # 4-byte Spill
; RV32I-NEXT:    lw s0, 708(sp) # 4-byte Reload
; RV32I-NEXT:    xor s0, s6, s0
; RV32I-NEXT:    sw s0, 708(sp) # 4-byte Spill
...
; RV32I-NEXT:    sw t0, 672(sp) # 4-byte Spill
; RV32I-NEXT:    lw t0, 560(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t3, t0
; RV32I-NEXT:    sw t0, 632(sp) # 4-byte Spill
; RV32I-NEXT:    lw t0, 480(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t4, t0
; RV32I-NEXT:    sw t0, 604(sp) # 4-byte Spill
; RV32I-NEXT:    lw t0, 392(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t5, t0
; RV32I-NEXT:    sw t0, 600(sp) # 4-byte Spill
; RV32I-NEXT:    lw t0, 712(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t6, t0
; RV32I-NEXT:    sw t0, 712(sp) # 4-byte Spill
...
; RV32I-NEXT:    lw a1, 744(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a0, 596(sp) # 4-byte Reload
; RV32I-NEXT:    lw a2, 584(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a2, 576(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a2, a0
; RV32I-NEXT:    sw a0, 588(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 496(sp) # 4-byte Reload
; RV32I-NEXT:    lw a2, 568(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a2, a0
; RV32I-NEXT:    sw a0, 584(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 400(sp) # 4-byte Reload
; RV32I-NEXT:    lw a2, 556(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a2, a0
; RV32I-NEXT:    sw a0, 576(sp) # 4-byte Spill
; RV32I-NEXT:    lw a0, 512(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a0, 324(sp) # 4-byte Reload
; RV32I-NEXT:    lw s0, 640(sp) # 4-byte Reload
; RV32I-NEXT:    xor s0, s0, a0
; RV32I-NEXT:    lw a0, 232(sp) # 4-byte Reload
; RV32I-NEXT:    lw s1, 636(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a0, 680(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a3, 520(sp) # 4-byte Reload
; RV32I-NEXT:    xor a3, a3, a0
; RV32I-NEXT:    lw a0, 596(sp) # 4-byte Reload
; RV32I-NEXT:    xor ra, a0, ra
; RV32I-NEXT:    lw a0, 620(sp) # 4-byte Reload
; RV32I-NEXT:    lw a1, 588(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a1, a0
; RV32I-NEXT:    lw a1, 528(sp) # 4-byte Reload
; RV32I-NEXT:    lw a2, 584(sp) # 4-byte Reload
; RV32I-NEXT:    xor a1, a2, a1
; RV32I-NEXT:    lw a2, 428(sp) # 4-byte Reload
; RV32I-NEXT:    lw s8, 576(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw s10, 580(sp) # 4-byte Reload
; RV32I-NEXT:    xor s9, s10, s9
; RV32I-NEXT:    lw s10, 432(sp) # 4-byte Reload
; RV32I-NEXT:    lw s7, 572(sp) # 4-byte Reload
; RV32I-NEXT:    xor s10, s7, s10
; RV32I-NEXT:    lw s7, 676(sp) # 4-byte Reload
; RV32I-NEXT:    xor s5, s7, s5
; RV32I-NEXT:    lw s7, 256(sp) # 4-byte Reload
; RV32I-NEXT:    xor s6, s6, s7
; RV32I-NEXT:    lw s7, 160(sp) # 4-byte Reload
; RV32I-NEXT:    xor s2, s2, s7
; RV32I-NEXT:    lw s7, 68(sp) # 4-byte Reload
; RV32I-NEXT:    xor s3, s3, s7
; RV32I-NEXT:    xor s0, s4, s0
; RV32I-NEXT:    lw s4, 264(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw t6, 644(sp) # 4-byte Reload
; RV32I-NEXT:    xor t3, t3, t6
; RV32I-NEXT:    lw t6, 552(sp) # 4-byte Reload
; RV32I-NEXT:    xor a7, a7, t6
; RV32I-NEXT:    lw t6, 460(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t0, t6
; RV32I-NEXT:    xor a4, t1, a4
; RV32I-NEXT:    lw t1, 272(sp) # 4-byte Reload
; RV32I-NEXT:    xor a5, a5, t1
; RV32I-NEXT:    lw t1, 176(sp) # 4-byte Reload
; RV32I-NEXT:    xor a6, a6, t1
; RV32I-NEXT:    lw t1, 84(sp) # 4-byte Reload
; RV32I-NEXT:    xor a3, a3, t1
; RV32I-NEXT:    xor a0, ra, a0
; RV32I-NEXT:    lw t1, 544(sp) # 4-byte Reload
; RV32I-NEXT:    xor a1, a1, t1
; RV32I-NEXT:    lw t1, 452(sp) # 4-byte Reload
; RV32I-NEXT:    xor a2, a2, t1
; RV32I-NEXT:    xor t1, s11, s8
; RV32I-NEXT:    lw t6, 548(sp) # 4-byte Reload
; RV32I-NEXT:    xor t6, s9, t6
; RV32I-NEXT:    lw s4, 456(sp) # 4-byte Reload
; RV32I-NEXT:    xor s4, s10, s4
; RV32I-NEXT:    xor s5, s5, s6
; RV32I-NEXT:    lw s6, 184(sp) # 4-byte Reload
; RV32I-NEXT:    xor s2, s2, s6
; RV32I-NEXT:    lw s6, 88(sp) # 4-byte Reload
; RV32I-NEXT:    xor s3, s3, s6
; RV32I-NEXT:    xor s0, s0, s1
; RV32I-NEXT:    lw s1, 188(sp) # 4-byte Reload
; RV32I-NEXT:    xor t4, t4, s1
; RV32I-NEXT:    lw s1, 92(sp) # 4-byte Reload
; RV32I-NEXT:    xor t5, t5, s1
; RV32I-NEXT:    xor t2, t2, t3
; RV32I-NEXT:    lw t3, 564(sp) # 4-byte Reload
; RV32I-NEXT:    xor a7, a7, t3
; RV32I-NEXT:    lw t3, 464(sp) # 4-byte Reload
...
; RV32I-NEXT:    xor a3, a3, a5
; RV32I-NEXT:    lw a6, 684(sp) # 4-byte Reload
; RV32I-NEXT:    srli a5, a6, 2
; RV32I-NEXT:    lw s6, 724(sp) # 4-byte Reload
; RV32I-NEXT:    and a6, a6, s6
; RV32I-NEXT:    and a5, a5, s6
; RV32I-NEXT:    slli a6, a6, 2
; RV32I-NEXT:    or s1, a5, a6
; RV32I-NEXT:    lw a6, 688(sp) # 4-byte Reload
; RV32I-NEXT:    srli a5, a6, 2
; RV32I-NEXT:    and a6, a6, s6
; RV32I-NEXT:    and a5, a5, s6
; RV32I-NEXT:    slli a6, a6, 2
...
; RV32I-NEXT:    xor a0, a0, a1
; RV32I-NEXT:    lw a1, 472(sp) # 4-byte Reload
; RV32I-NEXT:    xor a1, a2, a1
; RV32I-NEXT:    xor a2, t1, t6
; RV32I-NEXT:    lw a6, 468(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw s0, 116(sp) # 4-byte Reload
; RV32I-NEXT:    xor t5, t5, s0
; RV32I-NEXT:    xor a7, t2, a7
; RV32I-NEXT:    lw t2, 492(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t0, t2
; RV32I-NEXT:    xor a4, a4, t3
; RV32I-NEXT:    lw t2, 124(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a4, 716(sp) # 4-byte Reload
; RV32I-NEXT:    xor a0, a0, a4
; RV32I-NEXT:    lw a4, 720(sp) # 4-byte Reload
; RV32I-NEXT:    xor a4, a1, a4
; RV32I-NEXT:    lw a1, 704(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw s2, 728(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a3, 740(sp) # 4-byte Reload
; RV32I-NEXT:    and a0, a0, a3
...
; RV32I-NEXT:    lw a3, 440(sp) # 4-byte Reload
...
; RV32I-NEXT:    and a2, a2, a4
; RV32I-NEXT:    sw a2, 588(sp) # 4-byte Spill
...
; RV32I-NEXT:    and a2, a2, a4
; RV32I-NEXT:    sw a2, 584(sp) # 4-byte Spill
; RV32I-NEXT:    andi a2, a0, 1
; RV32I-NEXT:    seqz a2, a2
; RV32I-NEXT:    addi a2, a2, -1
; RV32I-NEXT:    and a2, a2, a1
; RV32I-NEXT:    sw a2, 576(sp) # 4-byte Spill
...
; RV32I-NEXT:    lw a2, 548(sp) # 4-byte Reload
; RV32I-NEXT:    xor a1, a1, a2
; RV32I-NEXT:    lw a2, 532(sp) # 4-byte Reload
; RV32I-NEXT:    lw ra, 528(sp) # 4-byte Reload
; RV32I-NEXT:    xor a2, a2, ra
; RV32I-NEXT:    lw ra, 516(sp) # 4-byte Reload
; RV32I-NEXT:    xor s9, ra, s9
; RV32I-NEXT:    xor s3, s8, s3
; RV32I-NEXT:    xor t6, s0, t6
; RV32I-NEXT:    xor t2, t2, t4
; RV32I-NEXT:    xor a7, t5, a7
; RV32I-NEXT:    lw t4, 684(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t0, t4
; RV32I-NEXT:    lw t4, 664(sp) # 4-byte Reload
; RV32I-NEXT:    xor t1, t1, t4
; RV32I-NEXT:    lw t4, 644(sp) # 4-byte Reload
; RV32I-NEXT:    xor t4, a3, t4
; RV32I-NEXT:    lw a3, 620(sp) # 4-byte Reload
; RV32I-NEXT:    xor a4, a4, a3
; RV32I-NEXT:    lw a3, 596(sp) # 4-byte Reload
; RV32I-NEXT:    xor a5, a5, a3
; RV32I-NEXT:    lw a3, 708(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw s0, 700(sp) # 4-byte Reload
; RV32I-NEXT:    srli t2, s0, 4
; RV32I-NEXT:    lw s3, 744(sp) # 4-byte Reload
; RV32I-NEXT:    and s0, s0, s3
; RV32I-NEXT:    and t2, t2, s3
; RV32I-NEXT:    slli s0, s0, 4
; RV32I-NEXT:    or t2, t2, s0
; RV32I-NEXT:    lw s1, 712(sp) # 4-byte Reload
...
; RV32I-NEXT:    xor a7, a7, t0
; RV32I-NEXT:    lw t0, 692(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t1, t0
; RV32I-NEXT:    lw t1, 660(sp) # 4-byte Reload
; RV32I-NEXT:    xor t1, t4, t1
; RV32I-NEXT:    lw t4, 632(sp) # 4-byte Reload
; RV32I-NEXT:    xor a4, a4, t4
; RV32I-NEXT:    lw t4, 600(sp) # 4-byte Reload
; RV32I-NEXT:    xor a5, a5, t4
; RV32I-NEXT:    xor a1, a6, a1
; RV32I-NEXT:    lw a6, 564(sp) # 4-byte Reload
; RV32I-NEXT:    xor a2, a2, a6
; RV32I-NEXT:    lw a6, 536(sp) # 4-byte Reload
; RV32I-NEXT:    xor a6, t3, a6
; RV32I-NEXT:    lw t3, 508(sp) # 4-byte Reload
; RV32I-NEXT:    xor t3, t5, t3
; RV32I-NEXT:    xor t4, t6, s4
; RV32I-NEXT:    xor a7, a7, t0
; RV32I-NEXT:    lw t0, 668(sp) # 4-byte Reload
; RV32I-NEXT:    xor t0, t1, t0
; RV32I-NEXT:    lw t1, 640(sp) # 4-byte Reload
; RV32I-NEXT:    xor a4, a4, t1
; RV32I-NEXT:    lw t1, 608(sp) # 4-byte Reload
; RV32I-NEXT:    xor a5, a5, t1
; RV32I-NEXT:    xor a1, a1, a2
; RV32I-NEXT:    lw a2, 544(sp) # 4-byte Reload
; RV32I-NEXT:    xor a2, a6, a2
; RV32I-NEXT:    lw a6, 512(sp) # 4-byte Reload
; RV32I-NEXT:    xor a6, t3, a6
; RV32I-NEXT:    xor t1, t4, s5
; RV32I-NEXT:    xor a7, a7, t0
; RV32I-NEXT:    lw t0, 648(sp) # 4-byte Reload
; RV32I-NEXT:    xor a4, a4, t0
; RV32I-NEXT:    lw t0, 616(sp) # 4-byte Reload
...
; RV32I-NEXT:    lw a7, 624(sp) # 4-byte Reload
; RV32I-NEXT:    xor a5, a5, a7
; RV32I-NEXT:    xor a1, a1, a2
...
; RV32I-NEXT:    lw t0, 740(sp) # 4-byte Reload
...
; RV32I-NEXT:    slli a3, a3, 1
; RV32I-NEXT:    or a3, a5, a3
; RV32I-NEXT:    lw a4, 732(sp) # 4-byte Reload
; RV32I-NEXT:    sw a2, 0(a4)
; RV32I-NEXT:    sw a1, 4(a4)
; RV32I-NEXT:    sw a3, 8(a4)
; RV32I-NEXT:    sw a0, 12(a4)
; RV32I-NEXT:    lw a4, 736(sp) # 4-byte Reload
; RV32I-NEXT:    sw a2, 0(a4)
; RV32I-NEXT:    sw a1, 4(a4)
; RV32I-NEXT:    sw a3, 8(a4)
; RV32I-NEXT:    sw a0, 12(a4)
; RV32I-NEXT:    lw ra, 796(sp) # 4-byte Reload
; RV32I-NEXT:    lw s0, 792(sp) # 4-byte Reload
; RV32I-NEXT:    lw s1, 788(sp) # 4-byte Reload
; RV32I-NEXT:    lw s2, 784(sp) # 4-byte Reload
; RV32I-NEXT:    lw s3, 780(sp) # 4-byte Reload
; RV32I-NEXT:    lw s4, 776(sp) # 4-byte Reload
; RV32I-NEXT:    lw s5, 772(sp) # 4-byte Reload
; RV32I-NEXT:    lw s6, 768(sp) # 4-byte Reload
; RV32I-NEXT:    lw s7, 764(sp) # 4-byte Reload
; RV32I-NEXT:    lw s8, 760(sp) # 4-byte Reload
; RV32I-NEXT:    lw s9, 756(sp) # 4-byte Reload
; RV32I-NEXT:    lw s10, 752(sp) # 4-byte Reload
; RV32I-NEXT:    lw s11, 748(sp) # 4-byte Reload
; RV32I-NEXT:    addi sp, sp, 800
; RV32I-NEXT:    ret
;
...
; RV64I-NEXT:    sd a0, 952(sp) # 8-byte Spill
...
; RV64I-NEXT:    mv s6, s2
; RV64I-NEXT:    sd s2, 992(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd s6, 440(sp) # 8-byte Spill
...
; RV64I-NEXT:    ld t3, 952(sp) # 8-byte Reload
...
; RV64I-NEXT:    sd s9, 984(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd ra, 968(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd s0, 960(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd a0, 480(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd a0, 880(sp) # 8-byte Spill
...
; RV64I-NEXT:    and a2, a2, a3
; RV64I-NEXT:    sd a2, 896(sp) # 8-byte Spill
; RV64I-NEXT:    lui a2, 8
; RV64I-NEXT:    and a2, s1, a2
; RV64I-NEXT:    seqz a2, a2
; RV64I-NEXT:    addi a2, a2, -1
...
; RV64I-NEXT:    and a2, a2, a3
; RV64I-NEXT:    sd a2, 704(sp) # 8-byte Spill
...
; RV64I-NEXT:    and a2, a2, a3
; RV64I-NEXT:    sd a2, 608(sp) # 8-byte Spill
...
; RV64I-NEXT:    and a2, a2, a3
; RV64I-NEXT:    sd a2, 592(sp) # 8-byte Spill
...
; RV64I-NEXT:    sd a2, 352(sp) # 8-byte Spill
; RV64I-NEXT:    and a2, s1, a2
; RV64I-NEXT:    seqz a2, a2
; RV64I-NEXT:    addi a2, a2, -1
...
; RV64I-NEXT:    and a2, a2, a4
; RV64I-NEXT:    sd a2, 688(sp) # 8-byte Spill
...
; RV64I-NEXT:    and a4, a4, a5
; RV64I-NEXT:    sd a4, 584(sp) # 8-byte Spill
...
; RV64I-NEXT:    and a4, a4, a5
; RV64I-NEXT:    sd a4, 600(sp) # 8-byte Spill
...
; RV64I-NEXT:    ld a4, 384(sp) # 8-byte Reload
; RV64I-NEXT:    and a4, t0, a4
; RV64I-NEXT:    seqz a4, a4
; RV64I-NEXT:    addi a4, a4, -1
...
; RV64I-NEXT:    ld a4, 352(sp) # 8-byte Reload
; RV64I-NEXT:    and a4, t0, a4
; RV64I-NEXT:    seqz a4, a4
; RV64I-NEXT:    addi a4, a4, -1
...
; RV64I-NEXT:    and a3, a3, a4
; RV64I-NEXT:    sd a3, 384(sp) # 8-byte Spill
...
; RV64I-NEXT:    ld a0, 480(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 472(sp) # 8-byte Reload
; RV64I-NEXT:    xor t4, a0, a1
; RV64I-NEXT:    ld a0, 880(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 464(sp) # 8-byte Reload
; RV64I-NEXT:    xor t5, a1, a0
; RV64I-NEXT:    ld a0, 856(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 848(sp) # 8-byte Reload
; RV64I-NEXT:    xor t6, a0, a1
; RV64I-NEXT:    ld a0, 808(sp) # 8-byte Reload
; RV64I-NEXT:    ld s0, 792(sp) # 8-byte Reload
; RV64I-NEXT:    xor s0, a0, s0
; RV64I-NEXT:    ld a0, 744(sp) # 8-byte Reload
; RV64I-NEXT:    ld s1, 736(sp) # 8-byte Reload
; RV64I-NEXT:    xor s1, a0, s1
; RV64I-NEXT:    ld a0, 680(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 664(sp) # 8-byte Reload
; RV64I-NEXT:    xor s2, a0, a1
; RV64I-NEXT:    ld a0, 608(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 592(sp) # 8-byte Reload
; RV64I-NEXT:    xor s3, a0, a1
; RV64I-NEXT:    ld a0, 552(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 544(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, a0, a1
; RV64I-NEXT:    ld a0, 496(sp) # 8-byte Reload
; RV64I-NEXT:    ld a1, 488(sp) # 8-byte Reload
; RV64I-NEXT:    xor t2, a0, a1
; RV64I-NEXT:    ld a0, 392(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld s4, 872(sp) # 8-byte Reload
; RV64I-NEXT:    xor t6, t6, s4
; RV64I-NEXT:    ld s4, 824(sp) # 8-byte Reload
; RV64I-NEXT:    xor s0, s0, s4
; RV64I-NEXT:    ld s4, 768(sp) # 8-byte Reload
; RV64I-NEXT:    xor s1, s1, s4
; RV64I-NEXT:    ld s4, 704(sp) # 8-byte Reload
; RV64I-NEXT:    xor s2, s2, s4
; RV64I-NEXT:    ld s4, 640(sp) # 8-byte Reload
; RV64I-NEXT:    xor s3, s3, s4
; RV64I-NEXT:    ld s4, 560(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, t1, s4
; RV64I-NEXT:    ld s4, 504(sp) # 8-byte Reload
; RV64I-NEXT:    xor t2, t2, s4
; RV64I-NEXT:    xor a0, t0, a0
; RV64I-NEXT:    ld t0, 360(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld t5, 896(sp) # 8-byte Reload
; RV64I-NEXT:    xor t5, t6, t5
; RV64I-NEXT:    ld t6, 840(sp) # 8-byte Reload
; RV64I-NEXT:    xor t6, s0, t6
; RV64I-NEXT:    ld s0, 784(sp) # 8-byte Reload
; RV64I-NEXT:    xor s0, s1, s0
; RV64I-NEXT:    ld s1, 720(sp) # 8-byte Reload
; RV64I-NEXT:    xor s1, s2, s1
; RV64I-NEXT:    ld s2, 648(sp) # 8-byte Reload
; RV64I-NEXT:    xor s2, s3, s2
; RV64I-NEXT:    ld s3, 568(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, t1, s3
; RV64I-NEXT:    ld s3, 512(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld a6, 352(sp) # 8-byte Reload
...
; RV64I-NEXT:    xor t4, t5, t4
; RV64I-NEXT:    ld t5, 864(sp) # 8-byte Reload
; RV64I-NEXT:    xor t5, t6, t5
; RV64I-NEXT:    ld t6, 800(sp) # 8-byte Reload
; RV64I-NEXT:    xor t6, s0, t6
; RV64I-NEXT:    ld s0, 728(sp) # 8-byte Reload
; RV64I-NEXT:    xor s0, s1, s0
; RV64I-NEXT:    ld s1, 656(sp) # 8-byte Reload
; RV64I-NEXT:    xor s1, s2, s1
; RV64I-NEXT:    ld s2, 576(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, t1, s2
; RV64I-NEXT:    ld s2, 520(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld t3, 888(sp) # 8-byte Reload
; RV64I-NEXT:    xor t3, t5, t3
; RV64I-NEXT:    ld t4, 816(sp) # 8-byte Reload
; RV64I-NEXT:    xor t4, t6, t4
; RV64I-NEXT:    ld t5, 752(sp) # 8-byte Reload
; RV64I-NEXT:    xor t5, s0, t5
; RV64I-NEXT:    ld t6, 672(sp) # 8-byte Reload
; RV64I-NEXT:    xor t6, s1, t6
; RV64I-NEXT:    ld s0, 584(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, t1, s0
; RV64I-NEXT:    ld s0, 528(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld t0, 832(sp) # 8-byte Reload
; RV64I-NEXT:    xor t0, t4, t0
; RV64I-NEXT:    ld t3, 760(sp) # 8-byte Reload
; RV64I-NEXT:    xor t3, t5, t3
; RV64I-NEXT:    ld t4, 688(sp) # 8-byte Reload
; RV64I-NEXT:    xor t4, t6, t4
; RV64I-NEXT:    ld t5, 600(sp) # 8-byte Reload
; RV64I-NEXT:    xor t1, t1, t5
; RV64I-NEXT:    ld t5, 536(sp) # 8-byte Reload
...
; RV64I-NEXT:    xor a2, a3, a2
; RV64I-NEXT:    ld a3, 384(sp) # 8-byte Reload
; RV64I-NEXT:    xor a3, a4, a3
...
; RV64I-NEXT:    ld a7, 776(sp) # 8-byte Reload
; RV64I-NEXT:    xor a7, t3, a7
; RV64I-NEXT:    ld t0, 696(sp) # 8-byte Reload
; RV64I-NEXT:    xor t0, t4, t0
; RV64I-NEXT:    ld t3, 616(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld a6, 712(sp) # 8-byte Reload
; RV64I-NEXT:    xor a6, t0, a6
; RV64I-NEXT:    ld a7, 632(sp) # 8-byte Reload
...
; RV64I-NEXT:    ld a5, 624(sp) # 8-byte Reload
...
; RV32IM-NEXT:    sw a3, 640(sp) # 4-byte Spill
; RV32IM-NEXT:    sw a2, 636(sp) # 4-byte Spill
...
; RV32IM-NEXT:    srli t0, a1, 2
; RV32IM-NEXT:    sw s8, 632(sp) # 4-byte Spill
...
; RV32IM-NEXT:    or a7, s1, a7
; RV32IM-NEXT:    srli t0, a1, 1
; RV32IM-NEXT:    sw t2, 628(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a7, 576(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a7, 608(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw s11, 644(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw ra, 624(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw t1, 616(sp) # 4-byte Spill
; RV32IM-NEXT:    and t4, s7, t4
; RV32IM-NEXT:    sw t4, 620(sp) # 4-byte Spill
; RV32IM-NEXT:    mul t1, s4, t1
; RV32IM-NEXT:    mul t3, s4, t4
; RV32IM-NEXT:    xor t1, t1, t3
; RV32IM-NEXT:    sw t1, 532(sp) # 4-byte Spill
...
; RV32IM-NEXT:    xor a4, a4, t5
; RV32IM-NEXT:    sw a4, 556(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a4, 548(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a5, 544(sp) # 4-byte Reload
; RV32IM-NEXT:    or a4, a5, a4
; RV32IM-NEXT:    sw a4, 592(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a4, 540(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a5, 536(sp) # 4-byte Reload
; RV32IM-NEXT:    or a4, a5, a4
; RV32IM-NEXT:    sw a4, 600(sp) # 4-byte Spill
; RV32IM-NEXT:    lui t2, 2
; RV32IM-NEXT:    and a4, s7, t2
; RV32IM-NEXT:    sw a4, 420(sp) # 4-byte Spill
; RV32IM-NEXT:    mul t6, s4, a4
; RV32IM-NEXT:    xor a4, s5, t6
; RV32IM-NEXT:    sw a4, 552(sp) # 4-byte Spill
; RV32IM-NEXT:    lui a4, 256
; RV32IM-NEXT:    and a5, s7, a4
; RV32IM-NEXT:    sw a5, 444(sp) # 4-byte Spill
; RV32IM-NEXT:    mul t6, s4, a5
; RV32IM-NEXT:    xor a5, s0, t6
; RV32IM-NEXT:    sw a5, 548(sp) # 4-byte Spill
; RV32IM-NEXT:    lui t5, 65536
; RV32IM-NEXT:    and a5, s7, t5
; RV32IM-NEXT:    sw a5, 464(sp) # 4-byte Spill
; RV32IM-NEXT:    mul t6, s4, a5
; RV32IM-NEXT:    lw a5, 532(sp) # 4-byte Reload
...
; RV32IM-NEXT:    sw a4, 536(sp) # 4-byte Spill
; RV32IM-NEXT:    and t1, s3, t5
; RV32IM-NEXT:    mul t1, s2, t1
; RV32IM-NEXT:    xor a4, t4, t1
; RV32IM-NEXT:    sw a4, 532(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a4, 492(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 1
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 500(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 524(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 468(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 2
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 484(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 516(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 436(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 3
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 456(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 496(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 400(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 4
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 416(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 480(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 372(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 5
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 388(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 448(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 460(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 6
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 476(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 508(sp) # 4-byte Spill
; RV32IM-NEXT:    andi t1, a1, 128
; RV32IM-NEXT:    seqz t1, t1
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 340(sp) # 4-byte Spill
; RV32IM-NEXT:    slli t4, a0, 7
; RV32IM-NEXT:    and a4, t3, t4
; RV32IM-NEXT:    sw a4, 348(sp) # 4-byte Spill
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 384(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 360(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a4, t1, t4
; RV32IM-NEXT:    sw a4, 432(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw t0, 520(sp) # 4-byte Spill
; RV32IM-NEXT:    lw t0, 528(sp) # 4-byte Reload
; RV32IM-NEXT:    mul t0, a2, t0
; RV32IM-NEXT:    sw t0, 528(sp) # 4-byte Spill
; RV32IM-NEXT:    andi t0, a3, 1
; RV32IM-NEXT:    seqz t0, t0
; RV32IM-NEXT:    and t5, a3, a6
; RV32IM-NEXT:    mul a6, a0, t5
; RV32IM-NEXT:    sw a6, 280(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, a7
; RV32IM-NEXT:    mul a6, a0, t5
; RV32IM-NEXT:    sw a6, 328(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, a5
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 412(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, t1
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 504(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, s6
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 272(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, s8
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 316(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and t5, a3, a5
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 488(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and t5, a3, a5
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 260(sp) # 4-byte Spill
; RV32IM-NEXT:    and t5, a3, t2
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 300(sp) # 4-byte Spill
; RV32IM-NEXT:    lui a5, 524288
; RV32IM-NEXT:    and t5, a3, a5
; RV32IM-NEXT:    mul a5, a0, t5
; RV32IM-NEXT:    sw a5, 364(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a5, 472(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a5, a0, a5
; RV32IM-NEXT:    mul a6, a2, t4
; RV32IM-NEXT:    sw a6, 252(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, t4
; RV32IM-NEXT:    sw a6, 276(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, t6
; RV32IM-NEXT:    sw a6, 288(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, t6
; RV32IM-NEXT:    sw a6, 312(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, s0
; RV32IM-NEXT:    sw a6, 352(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, s0
; RV32IM-NEXT:    sw a6, 408(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, s1
; RV32IM-NEXT:    sw a6, 440(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, s1
; RV32IM-NEXT:    sw a6, 472(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a6, 392(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a7, a0, a6
; RV32IM-NEXT:    mul a6, a2, s5
; RV32IM-NEXT:    sw a6, 244(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, s5
; RV32IM-NEXT:    sw a6, 264(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, s10
; RV32IM-NEXT:    sw a6, 284(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, s10
; RV32IM-NEXT:    sw a6, 308(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, s11
; RV32IM-NEXT:    sw a6, 336(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, s11
; RV32IM-NEXT:    sw a6, 392(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a6, 612(sp) # 4-byte Reload
; RV32IM-NEXT:    mul t4, a0, a6
; RV32IM-NEXT:    lw a6, 608(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a6, a0, a6
; RV32IM-NEXT:    sw a6, 256(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a6, 376(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a6, a0, a6
; RV32IM-NEXT:    sw a6, 296(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, ra
; RV32IM-NEXT:    sw a6, 236(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a0, ra
; RV32IM-NEXT:    sw a6, 376(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a6, a2, a4
; RV32IM-NEXT:    sw a6, 268(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a4, a0, a4
; RV32IM-NEXT:    sw a4, 608(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a4, a2, a1
; RV32IM-NEXT:    sw a4, 324(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a2, 224(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw a3, 344(sp) # 4-byte Reload
; RV32IM-NEXT:    seqz a3, a3
; RV32IM-NEXT:    seqz a2, a2
; RV32IM-NEXT:    addi a3, a3, -1
; RV32IM-NEXT:    addi a2, a2, -1
; RV32IM-NEXT:    and a1, a3, a1
; RV32IM-NEXT:    sw a1, 292(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw a0, 452(sp) # 4-byte Reload
...
; RV32IM-NEXT:    and a2, a0, a2
; RV32IM-NEXT:    sw a2, 156(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a2, a0, a2
; RV32IM-NEXT:    sw a2, 172(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a1, a1, a2
; RV32IM-NEXT:    sw a1, 96(sp) # 4-byte Spill
; RV32IM-NEXT:    and a0, a0, a2
; RV32IM-NEXT:    sw a0, 112(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a2, a0, a2
; RV32IM-NEXT:    sw a2, 108(sp) # 4-byte Spill
; RV32IM-NEXT:    slli a2, s2, 9
; RV32IM-NEXT:    and a1, a1, a2
; RV32IM-NEXT:    sw a1, 116(sp) # 4-byte Spill
; RV32IM-NEXT:    and a0, a0, a2
...
; RV32IM-NEXT:    lw a2, 428(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a2, s4, a2
; RV32IM-NEXT:    sw a2, 428(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a2, 424(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a2, s4, a2
; RV32IM-NEXT:    sw a2, 452(sp) # 4-byte Spill
; RV32IM-NEXT:    andi a2, s3, 1
; RV32IM-NEXT:    seqz t2, a2
; RV32IM-NEXT:    and t0, s3, t0
; RV32IM-NEXT:    mul a2, s2, t0
; RV32IM-NEXT:    sw a2, 36(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul a2, s2, t0
; RV32IM-NEXT:    sw a2, 220(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul a2, s2, t0
; RV32IM-NEXT:    sw a2, 208(sp) # 4-byte Spill
; RV32IM-NEXT:    lui a2, 8192
; RV32IM-NEXT:    and t0, s3, a2
; RV32IM-NEXT:    mul a2, s2, t0
; RV32IM-NEXT:    sw a2, 424(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul a2, s2, t0
; RV32IM-NEXT:    sw a2, 140(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a2, 420(sp) # 4-byte Reload
...
; RV32IM-NEXT:    sw a2, 120(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a2, s2, t1
; RV32IM-NEXT:    sw a2, 144(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a2, s4, t5
; RV32IM-NEXT:    sw a2, 164(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a2, s2, t5
; RV32IM-NEXT:    sw a2, 420(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a5, 32(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a5, s2, s5
; RV32IM-NEXT:    sw a5, 48(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a5, s4, a0
; RV32IM-NEXT:    sw a5, 104(sp) # 4-byte Spill
; RV32IM-NEXT:    mul a0, s2, a0
; RV32IM-NEXT:    sw a0, 444(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a0, 616(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a0, s2, a0
; RV32IM-NEXT:    lw a5, 620(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a5, s2, a5
; RV32IM-NEXT:    sw a5, 16(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a5, 464(sp) # 4-byte Reload
; RV32IM-NEXT:    mul a5, s2, a5
...
; RV32IM-NEXT:    sw a1, 64(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw a1, 224(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a0, a1, a0
...
; RV32IM-NEXT:    lw a1, 496(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a0, 232(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a2, 152(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a1, a2
; RV32IM-NEXT:    lw a2, 112(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 100(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a2, a2, a3
; RV32IM-NEXT:    lw a3, 12(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, a3, ra
; RV32IM-NEXT:    lw a4, 20(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a5, 584(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a4, a5, a4
...
; RV32IM-NEXT:    lw ra, 460(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 468(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 468(sp) # 4-byte Spill
; RV32IM-NEXT:    lw ra, 368(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 436(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 460(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw s5, 572(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
...
; RV32IM-NEXT:    lw s5, 416(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 476(sp) # 4-byte Spill
; RV32IM-NEXT:    lw ra, 380(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 388(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 416(sp) # 4-byte Spill
; RV32IM-NEXT:    lw ra, 328(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 372(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 404(sp) # 4-byte Spill
; RV32IM-NEXT:    lw ra, 316(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 560(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    sw ra, 400(sp) # 4-byte Spill
; RV32IM-NEXT:    lw ra, 300(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 556(sp) # 4-byte Reload
; RV32IM-NEXT:    xor ra, s5, ra
; RV32IM-NEXT:    lw s5, 568(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s6, s5, s6
; RV32IM-NEXT:    sw s6, 584(sp) # 4-byte Spill
; RV32IM-NEXT:    lw s6, 172(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s6, s11, s6
; RV32IM-NEXT:    sw s6, 576(sp) # 4-byte Spill
; RV32IM-NEXT:    lw s6, 108(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s5, 348(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw s5, 32(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s5, s9, s5
; RV32IM-NEXT:    sw s5, 564(sp) # 4-byte Spill
; RV32IM-NEXT:    lw s5, 28(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s5, s7, s5
; RV32IM-NEXT:    sw s5, 560(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a7, 556(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a7, 508(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a7, 296(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a1, 48(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a4, a1
; RV32IM-NEXT:    sw a1, 496(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a1, 44(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a5, a1
; RV32IM-NEXT:    sw a1, 492(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a3, 596(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a2, 484(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 468(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s7, a2, a3
; RV32IM-NEXT:    lw a2, 292(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 460(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s5, a3, a2
; RV32IM-NEXT:    lw a2, 352(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 456(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s6, a3, a2
; RV32IM-NEXT:    lw a2, 336(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 448(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s4, a3, a2
; RV32IM-NEXT:    lw a2, 324(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 436(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a2, a3, a2
; RV32IM-NEXT:    sw a2, 604(sp) # 4-byte Spill
; RV32IM-NEXT:    lw a2, 480(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 476(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s3, a2, a3
; RV32IM-NEXT:    lw a2, 304(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a3, 416(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s2, a3, a2
; RV32IM-NEXT:    lw a2, 412(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s0, 404(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s0, s0, a2
; RV32IM-NEXT:    lw a2, 396(sp) # 4-byte Reload
; RV32IM-NEXT:    lw s1, 400(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a1, 140(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a2, 536(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a2, a1
...
; RV32IM-NEXT:    lw a4, 524(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a2, 508(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a2, a1
; RV32IM-NEXT:    sw a1, 584(sp) # 4-byte Spill
...
; RV32IM-NEXT:    lw a0, 444(sp) # 4-byte Reload
; RV32IM-NEXT:    lw ra, 496(sp) # 4-byte Reload
...
; RV32IM-NEXT:    xor a0, ra, a0
; RV32IM-NEXT:    xor s5, s7, s5
; RV32IM-NEXT:    lw s7, 440(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s6, s6, s7
; RV32IM-NEXT:    lw s7, 520(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s4, s4, s7
; RV32IM-NEXT:    xor s2, s3, s2
; RV32IM-NEXT:    lw s3, 504(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s0, s0, s3
; RV32IM-NEXT:    lw s3, 488(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s1, s1, s3
; RV32IM-NEXT:    xor t1, t4, t1
; RV32IM-NEXT:    lw t4, 164(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t2, t2, t4
; RV32IM-NEXT:    lw t4, 428(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t3, t3, t4
; RV32IM-NEXT:    xor t0, t0, a6
; RV32IM-NEXT:    lw a6, 220(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a7, a7, a6
; RV32IM-NEXT:    lw a6, 208(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a5, a5, a6
; RV32IM-NEXT:    xor a6, s11, a4
; RV32IM-NEXT:    lw a4, 472(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, a3, a4
; RV32IM-NEXT:    lw a4, 608(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a2, a2, a4
; RV32IM-NEXT:    xor a4, s8, s9
; RV32IM-NEXT:    lw t4, 420(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a1, t4
; RV32IM-NEXT:    lw t4, 616(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a0, a0, t4
; RV32IM-NEXT:    xor t4, s5, s6
; RV32IM-NEXT:    lw s3, 528(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s3, s4, s3
; RV32IM-NEXT:    xor s0, s2, s0
; RV32IM-NEXT:    lw s2, 512(sp) # 4-byte Reload
; RV32IM-NEXT:    xor s1, s1, s2
; RV32IM-NEXT:    xor t1, t1, t2
; RV32IM-NEXT:    lw t2, 452(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t2, t3, t2
; RV32IM-NEXT:    xor t0, t0, a7
; RV32IM-NEXT:    lw a7, 424(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw s4, 632(sp) # 4-byte Reload
; RV32IM-NEXT:    and a2, s10, s4
; RV32IM-NEXT:    and a0, a0, s4
; RV32IM-NEXT:    slli a2, a2, 2
; RV32IM-NEXT:    or a0, a0, a2
; RV32IM-NEXT:    lw s2, 588(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw t2, 584(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t2, a3, t2
; RV32IM-NEXT:    xor a1, a4, a1
; RV32IM-NEXT:    lw a3, 580(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t3, a1, a3
; RV32IM-NEXT:    lw a1, 604(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, t4, a1
; RV32IM-NEXT:    lw a3, 596(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, s0, a3
; RV32IM-NEXT:    lw t4, 600(sp) # 4-byte Reload
; RV32IM-NEXT:    xor t1, t1, t4
; RV32IM-NEXT:    lw t4, 592(sp) # 4-byte Reload
...
; RV32IM-NEXT:    sw a1, 616(sp) # 4-byte Spill
; RV32IM-NEXT:    srli a1, a0, 1
; RV32IM-NEXT:    lw s4, 628(sp) # 4-byte Reload
; RV32IM-NEXT:    and a0, a0, s4
...
; RV32IM-NEXT:    sw a6, 608(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a6, 624(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a6, a7, t0
; RV32IM-NEXT:    sw a6, 596(sp) # 4-byte Spill
...
; RV32IM-NEXT:    and a6, a7, t0
; RV32IM-NEXT:    sw a6, 580(sp) # 4-byte Spill
; RV32IM-NEXT:    andi a7, a0, 128
; RV32IM-NEXT:    seqz a7, a7
; RV32IM-NEXT:    addi a7, a7, -1
; RV32IM-NEXT:    slli t0, a1, 7
; RV32IM-NEXT:    and a6, a7, t0
; RV32IM-NEXT:    sw a6, 552(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a6, 528(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul a6, a1, t1
; RV32IM-NEXT:    sw a6, 560(sp) # 4-byte Spill
...
; RV32IM-NEXT:    sw a6, 520(sp) # 4-byte Spill
; RV32IM-NEXT:    lui ra, 1024
; RV32IM-NEXT:    and t2, a0, ra
; RV32IM-NEXT:    mul a6, a1, t2
; RV32IM-NEXT:    sw a6, 532(sp) # 4-byte Spill
; RV32IM-NEXT:    lui s8, 2048
; RV32IM-NEXT:    and t2, a0, s8
; RV32IM-NEXT:    mul a6, a1, t2
; RV32IM-NEXT:    sw a6, 544(sp) # 4-byte Spill
...
; RV32IM-NEXT:    mul t3, a1, t3
; RV32IM-NEXT:    sw t3, 524(sp) # 4-byte Spill
; RV32IM-NEXT:    lui s2, 131072
; RV32IM-NEXT:    and t3, a0, s2
; RV32IM-NEXT:    mul t3, a1, t3
; RV32IM-NEXT:    sw t3, 536(sp) # 4-byte Spill
; RV32IM-NEXT:    lui t4, 262144
; RV32IM-NEXT:    and t3, a0, t4
; RV32IM-NEXT:    mul t3, a1, t3
; RV32IM-NEXT:    sw t3, 564(sp) # 4-byte Spill
; RV32IM-NEXT:    lui t5, 524288
...
; RV32IM-NEXT:    sw a1, 444(sp) # 4-byte Spill
...
; RV32IM-NEXT:    xor a7, a0, a1
; RV32IM-NEXT:    lw a0, 552(sp) # 4-byte Reload
; RV32IM-NEXT:    lw a2, 540(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw s10, 472(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a1, s10
; RV32IM-NEXT:    lw s10, 452(sp) # 4-byte Reload
; RV32IM-NEXT:    lw ra, 448(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw s0, 580(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a7, a7, s0
; RV32IM-NEXT:    lw s0, 556(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a2, a2, s0
; RV32IM-NEXT:    lw s0, 548(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, a3, s0
; RV32IM-NEXT:    lw s0, 532(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a4, a4, s0
; RV32IM-NEXT:    lw s0, 524(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a5, a5, s0
; RV32IM-NEXT:    xor a0, t0, a0
; RV32IM-NEXT:    lw t0, 480(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a1, a1, t0
; RV32IM-NEXT:    lw t0, 464(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a7, 544(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a4, a4, a7
...
; RV32IM-NEXT:    lw a6, 564(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a5, a5, a6
; RV32IM-NEXT:    xor a6, a0, a1
; RV32IM-NEXT:    lw a0, 468(sp) # 4-byte Reload
...
; RV32IM-NEXT:    lw a7, 568(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a5, a5, a7
...
; RV32IM-NEXT:    or a4, a5, a4
; RV32IM-NEXT:    srli a3, a2, 4
; RV32IM-NEXT:    lw a7, 648(sp) # 4-byte Reload
...
; RV32IM-NEXT:    xor a2, a2, a4
; RV32IM-NEXT:    lw a4, 616(sp) # 4-byte Reload
; RV32IM-NEXT:    xor a3, a3, a4
...
; RV32IM-NEXT:    lw a4, 640(sp) # 4-byte Reload
; RV32IM-NEXT:    sw a2, 0(a4)
; RV32IM-NEXT:    sw a0, 4(a4)
; RV32IM-NEXT:    sw a3, 8(a4)
; RV32IM-NEXT:    sw a1, 12(a4)
...
; RV64IM-NEXT:    sd a0, 848(sp) # 8-byte Spill
...
; RV64IM-NEXT:    sd a0, 840(sp) # 8-byte Spill
...
; RV64IM-NEXT:    ld a5, 840(sp) # 8-byte Reload
...
; RV64IM-NEXT:    sd s10, 232(sp) # 8-byte Spill
...
; RV32IMZBS-NEXT:    sw s11, 744(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw s10, 728(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw s5, 724(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw t5, 716(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and t5, s2, t6
; RV32IMZBS-NEXT:    sw t5, 720(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and t2, t2, t6
; RV32IMZBS-NEXT:    sw t2, 712(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli t2, a7, 31
; RV32IMZBS-NEXT:    seqz t5, s0
; RV32IMZBS-NEXT:    addi a2, a2, -1
; RV32IMZBS-NEXT:    addi t5, t5, -1
; RV32IMZBS-NEXT:    and t3, a2, t3
; RV32IMZBS-NEXT:    sw t3, 704(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and t3, t5, t2
; RV32IMZBS-NEXT:    sw t3, 708(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, t2
; RV32IMZBS-NEXT:    sw a2, 692(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    sw ra, 740(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a1, 688(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a0, a0, a3
; RV32IMZBS-NEXT:    sw a0, 672(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a1, a1, a3
; RV32IMZBS-NEXT:    sw a1, 616(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a3
...
; RV32IMZBS-NEXT:    and a3, a0, a3
; RV32IMZBS-NEXT:    sw a3, 568(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a1, a1, a3
; RV32IMZBS-NEXT:    sw a1, 656(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a3
...
; RV32IMZBS-NEXT:    and a3, a0, a3
; RV32IMZBS-NEXT:    sw a3, 536(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a3, s6, 7
; RV32IMZBS-NEXT:    and a1, a1, a3
; RV32IMZBS-NEXT:    sw a1, 540(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a3
; RV32IMZBS-NEXT:    sw a0, 592(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a3, a0, a3
; RV32IMZBS-NEXT:    sw a3, 516(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a3, a0, a3
; RV32IMZBS-NEXT:    sw a3, 572(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a3, s6, 9
; RV32IMZBS-NEXT:    and a1, a1, a3
; RV32IMZBS-NEXT:    sw a1, 600(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a3
...
; RV32IMZBS-NEXT:    and a1, a1, a3
; RV32IMZBS-NEXT:    sw a1, 664(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a3
...
; RV32IMZBS-NEXT:    sw a5, 456(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 452(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 508(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 588(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 644(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a1, a1, a5
; RV32IMZBS-NEXT:    sw a1, 436(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 404(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a5, s6, 17
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 408(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 440(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a5, s6, 18
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 444(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
...
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 512(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
...
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 596(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
...
; RV32IMZBS-NEXT:    and a1, a1, a5
; RV32IMZBS-NEXT:    sw a1, 392(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 372(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a5, s6, 23
; RV32IMZBS-NEXT:    and a4, a4, a5
; RV32IMZBS-NEXT:    sw a4, 376(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a5
; RV32IMZBS-NEXT:    sw a1, 388(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a5, a1, a5
; RV32IMZBS-NEXT:    sw a5, 396(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a4, a4, a2
; RV32IMZBS-NEXT:    sw a4, 400(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a2
...
; RV32IMZBS-NEXT:    sw a4, 424(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, s6, 25
; RV32IMZBS-NEXT:    and a2, a2, a4
; RV32IMZBS-NEXT:    sw a2, 432(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a4
...
; RV32IMZBS-NEXT:    and a4, a1, a4
; RV32IMZBS-NEXT:    sw a4, 464(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, s6, 26
; RV32IMZBS-NEXT:    and a2, a2, a4
; RV32IMZBS-NEXT:    sw a2, 472(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a4
; RV32IMZBS-NEXT:    sw a1, 480(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a4, a1, a4
; RV32IMZBS-NEXT:    sw a4, 528(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, s6, 28
; RV32IMZBS-NEXT:    and a2, a2, a4
; RV32IMZBS-NEXT:    sw a2, 524(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a1, a1, a4
...
; RV32IMZBS-NEXT:    sw a6, 324(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a0, a0, a2
; RV32IMZBS-NEXT:    sw a0, 288(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a0, a0, a2
; RV32IMZBS-NEXT:    sw a0, 264(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a0, a0, a2
; RV32IMZBS-NEXT:    sw a0, 220(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 176(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a0, a0, a2
; RV32IMZBS-NEXT:    sw a0, 204(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a3, a3, a4
; RV32IMZBS-NEXT:    sw a3, 96(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, a4
...
; RV32IMZBS-NEXT:    and a3, a3, a4
; RV32IMZBS-NEXT:    sw a3, 152(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, a4
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 244(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, a7, 14
; RV32IMZBS-NEXT:    and a3, a3, a4
; RV32IMZBS-NEXT:    sw a3, 252(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, a4
; RV32IMZBS-NEXT:    sw a2, 272(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 280(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, a7, 15
; RV32IMZBS-NEXT:    and a3, a3, a4
; RV32IMZBS-NEXT:    sw a3, 284(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, a4
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 56(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a2, a2, a4
; RV32IMZBS-NEXT:    sw a2, 112(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 148(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 196(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    slli a4, a7, 20
; RV32IMZBS-NEXT:    and a3, a3, a4
; RV32IMZBS-NEXT:    sw a3, 200(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, a2, a4
...
; RV32IMZBS-NEXT:    and a4, a2, a4
; RV32IMZBS-NEXT:    sw a4, 28(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a2, 48(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a2, 104(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    and a2, s5, s11
...
; RV32IMZBS-NEXT:    sw a1, 16(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw a2, 448(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 516(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 412(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 404(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 456(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 380(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 372(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 448(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 356(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 320(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 412(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 340(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, s1
; RV32IMZBS-NEXT:    sw a1, 620(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 624(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, s3, a1
; RV32IMZBS-NEXT:    sw a1, 404(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw a2, 532(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 580(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 420(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 384(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 376(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 408(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 364(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 332(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 384(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 376(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 184(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 156(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 372(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 108(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 92(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 364(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 56(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 44(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    sw a1, 356(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a1, 28(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 24(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a2, 276(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s5, a1, a2
; RV32IMZBS-NEXT:    lw a1, 256(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s1, 236(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, a1, s1
; RV32IMZBS-NEXT:    lw a1, 192(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 176(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s2, a1, a2
; RV32IMZBS-NEXT:    lw a1, 120(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 96(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s3, a1, a2
; RV32IMZBS-NEXT:    lw a1, 60(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 52(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a1, 388(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a1, 312(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a0, a0, a1
; RV32IMZBS-NEXT:    lw a1, 288(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 264(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    lw a2, 220(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a3, 204(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a2, a2, a3
; RV32IMZBS-NEXT:    lw a3, 140(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a4, 132(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a3, a4
; RV32IMZBS-NEXT:    lw a4, 68(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a5, 64(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a4, a4, a5
; RV32IMZBS-NEXT:    lw a5, 32(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a5, a5, a6
; RV32IMZBS-NEXT:    lw a6, 16(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a6, s8, a6
; RV32IMZBS-NEXT:    lw s8, 324(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 12(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s8, s9
; RV32IMZBS-NEXT:    sw s8, 568(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 640(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 608(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 564(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 572(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 536(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 540(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 508(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 516(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 536(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 440(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 456(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 532(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 396(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 448(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 516(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 716(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 412(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 716(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw s9, 616(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 468(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 600(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 580(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 456(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 520(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 452(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 452(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 444(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 420(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 448(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 400(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 408(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 444(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 720(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 384(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 720(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 624(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 380(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s8, s9
; RV32IMZBS-NEXT:    sw s8, 672(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 296(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 376(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 656(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 228(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 372(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 652(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 144(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 364(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    sw s8, 640(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s8, 80(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 356(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s9, s9, s8
; RV32IMZBS-NEXT:    lw s8, 36(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s10, s10, s8
; RV32IMZBS-NEXT:    lw s8, 704(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s11, s8
; RV32IMZBS-NEXT:    sw s8, 704(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    xor s8, ra, s5
; RV32IMZBS-NEXT:    lw s5, 308(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s1, s5
; RV32IMZBS-NEXT:    sw s1, 632(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s1, 240(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s2, s1
; RV32IMZBS-NEXT:    sw s1, 624(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s1, 152(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s3, s1
; RV32IMZBS-NEXT:    sw s1, 620(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s1, 84(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s4, s1
; RV32IMZBS-NEXT:    sw s1, 616(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s1, 40(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s6, s1
; RV32IMZBS-NEXT:    sw s1, 608(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw s1, 708(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s0, s0, s1
; RV32IMZBS-NEXT:    sw s0, 708(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    xor t0, s7, t0
; RV32IMZBS-NEXT:    sw t0, 600(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw t0, 676(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t1, t1, t0
; RV32IMZBS-NEXT:    lw t0, 628(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t2, t0
; RV32IMZBS-NEXT:    sw t0, 676(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw t0, 552(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t3, t0
; RV32IMZBS-NEXT:    sw t0, 628(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw t0, 476(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t4, t0
; RV32IMZBS-NEXT:    sw t0, 592(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw t0, 416(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t5, t0
; RV32IMZBS-NEXT:    sw t0, 580(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw t0, 712(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t6, t0
; RV32IMZBS-NEXT:    sw t0, 712(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw a0, 112(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a5, 684(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a2, 564(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a0, 588(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 536(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a0, a2, a0
; RV32IMZBS-NEXT:    sw a0, 588(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a0, 496(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 532(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a0, a2, a0
; RV32IMZBS-NEXT:    sw a0, 564(sp) # 4-byte Spill
; RV32IMZBS-NEXT:    lw a0, 424(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a2, 516(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a0, a2, a0
...
; RV32IMZBS-NEXT:    lw a2, 456(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a2, 444(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a0, a2, a0
...
; RV32IMZBS-NEXT:    lw a0, 148(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw s0, 624(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s0, s0, a0
; RV32IMZBS-NEXT:    lw a0, 252(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s1, 620(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s1, a0
; RV32IMZBS-NEXT:    lw a0, 160(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a1, 616(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t4, a1, a0
; RV32IMZBS-NEXT:    lw a0, 76(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a1, 608(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t5, a1, a0
; RV32IMZBS-NEXT:    lw a0, 600(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a1, 592(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a7, a1, a0
...
; RV32IMZBS-NEXT:    lw a4, 520(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a3, 504(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a3, a0
; RV32IMZBS-NEXT:    lw a0, 568(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a2, 464(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw s8, 648(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s9, 664(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s8, s9, s8
; RV32IMZBS-NEXT:    lw s9, 560(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s10, 604(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s9, s10, s9
; RV32IMZBS-NEXT:    lw s10, 472(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw s7, 536(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s10, s7, s10
; RV32IMZBS-NEXT:    lw s7, 672(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s5, s7, s5
; RV32IMZBS-NEXT:    lw s7, 280(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s6, s6, s7
; RV32IMZBS-NEXT:    lw s7, 196(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s2, s2, s7
; RV32IMZBS-NEXT:    lw s7, 100(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s3, s3, s7
; RV32IMZBS-NEXT:    xor s0, s4, s0
; RV32IMZBS-NEXT:    lw s4, 284(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s1, s1, s4
; RV32IMZBS-NEXT:    lw s4, 200(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t4, t4, s4
; RV32IMZBS-NEXT:    lw s4, 104(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t5, t5, s4
; RV32IMZBS-NEXT:    xor t2, t6, t2
; RV32IMZBS-NEXT:    lw t6, 668(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t3, t3, t6
; RV32IMZBS-NEXT:    lw t6, 576(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a7, a7, t6
; RV32IMZBS-NEXT:    lw t6, 480(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t1, 208(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t1, 584(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a1, a1, t1
; RV32IMZBS-NEXT:    lw t1, 484(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a2, a2, t1
; RV32IMZBS-NEXT:    xor t1, s11, s8
; RV32IMZBS-NEXT:    lw t6, 596(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t6, s9, t6
; RV32IMZBS-NEXT:    lw s4, 492(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s4, s10, s4
; RV32IMZBS-NEXT:    xor s5, s5, s6
; RV32IMZBS-NEXT:    lw s6, 212(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s2, s2, s6
; RV32IMZBS-NEXT:    lw s6, 124(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s3, s3, s6
; RV32IMZBS-NEXT:    xor s0, s0, s1
; RV32IMZBS-NEXT:    lw s1, 216(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t4, t4, s1
; RV32IMZBS-NEXT:    lw s1, 128(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t5, t5, s1
; RV32IMZBS-NEXT:    xor t2, t2, t3
; RV32IMZBS-NEXT:    lw t3, 612(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a7, a7, t3
; RV32IMZBS-NEXT:    lw t3, 500(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t0, t3
; RV32IMZBS-NEXT:    xor a4, a4, a5
; RV32IMZBS-NEXT:    lw a5, 232(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a5, a6, a5
; RV32IMZBS-NEXT:    lw a6, 136(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a3, a6
; RV32IMZBS-NEXT:    lw t3, 684(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw s1, 688(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw s4, 168(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor s3, s3, s4
; RV32IMZBS-NEXT:    xor t4, s0, t4
; RV32IMZBS-NEXT:    lw s0, 164(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t5, t5, s0
; RV32IMZBS-NEXT:    xor a7, t2, a7
; RV32IMZBS-NEXT:    lw t2, 544(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t0, t2
; RV32IMZBS-NEXT:    xor a4, a4, a5
; RV32IMZBS-NEXT:    lw a5, 172(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a3, a5
; RV32IMZBS-NEXT:    xor a0, a0, a1
; RV32IMZBS-NEXT:    xor a1, a2, t1
; RV32IMZBS-NEXT:    srli a2, a6, 1
; RV32IMZBS-NEXT:    lw s4, 724(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    addi a2, a2, -1
; RV32IMZBS-NEXT:    and a2, a2, t5
; RV32IMZBS-NEXT:    sw a2, 700(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a4, 704(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a5, 692(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    sw a6, 672(sp) # 4-byte Spill
...
; RV32IMZBS-NEXT:    lw a0, 612(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a3, 608(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a0, a3
; RV32IMZBS-NEXT:    lw a0, 600(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a4, 596(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a4, a0, a4
; RV32IMZBS-NEXT:    lw a0, 592(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw a5, 588(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    xor a1, a1, a2
; RV32IMZBS-NEXT:    lw a2, 540(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    lw ra, 536(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t4, 684(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a6, a6, t4
; RV32IMZBS-NEXT:    lw t4, 660(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a7, a7, t4
; RV32IMZBS-NEXT:    lw t4, 644(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t0, t4
; RV32IMZBS-NEXT:    lw t4, 620(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t4, a3, t4
; RV32IMZBS-NEXT:    lw a3, 604(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a4, a4, a3
; RV32IMZBS-NEXT:    lw a3, 700(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw s1, 704(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    srli t3, s1, 4
; RV32IMZBS-NEXT:    lw s3, 744(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    and s1, s1, s3
; RV32IMZBS-NEXT:    and t3, t3, s3
; RV32IMZBS-NEXT:    slli s1, s1, 4
; RV32IMZBS-NEXT:    or t3, t3, s1
; RV32IMZBS-NEXT:    lw s2, 712(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t2, 696(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a7, a7, t2
; RV32IMZBS-NEXT:    lw t2, 668(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t0, t0, t2
; RV32IMZBS-NEXT:    lw t2, 648(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor t2, t4, t2
; RV32IMZBS-NEXT:    lw t4, 616(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    xor a6, a6, a7
; RV32IMZBS-NEXT:    lw a7, 640(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw t0, 740(sp) # 4-byte Reload
...
; RV32IMZBS-NEXT:    lw a4, 720(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a2, a2, a4
; RV32IMZBS-NEXT:    lw a4, 716(sp) # 4-byte Reload
; RV32IMZBS-NEXT:    xor a3, a3, a4
...
; RV64IMZBS-NEXT:    sd a0, 936(sp) # 8-byte Spill
...
; RV64IMZBS-NEXT:    sd ra, 944(sp) # 8-byte Spill
...
; RV64IMZBS-NEXT:    sd t4, 928(sp) # 8-byte Spill
...
; RV64IMZBS-NEXT:    xor a7, t0, a7
; RV64IMZBS-NEXT:    xor a0, a0, a1
; RV64IMZBS-NEXT:    ld a1, 208(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    xor a1, a2, a1
; RV64IMZBS-NEXT:    ld a2, 128(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    xor a2, a3, a2
; RV64IMZBS-NEXT:    xor a3, a5, a6
; RV64IMZBS-NEXT:    ld a5, 632(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    xor a5, a7, a5
; RV64IMZBS-NEXT:    xor a0, a0, a1
; RV64IMZBS-NEXT:    ld a1, 120(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    xor a1, a2, a1
; RV64IMZBS-NEXT:    xor a3, a3, a5
; RV64IMZBS-NEXT:    xor a0, a0, a1
...
; RV64IMZBS-NEXT:    ld t4, 936(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    and a1, a1, t4
...
; RV64IMZBS-NEXT:    ld a4, 952(sp) # 8-byte Reload
...
; RV64IMZBS-NEXT:    ld a4, 944(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    and a1, a1, a4
...
; RV64IMZBS-NEXT:    ld a4, 928(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    and a1, a1, a4
...
; RV64IMZBS-NEXT:    or a1, a2, a1
; RV64IMZBS-NEXT:    or a0, a3, a0
; RV64IMZBS-NEXT:    ld a2, 968(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    sd a1, 0(a2)
; RV64IMZBS-NEXT:    sd a0, 8(a2)
; RV64IMZBS-NEXT:    ld a2, 976(sp) # 8-byte Reload
; RV64IMZBS-NEXT:    sd a1, 0(a2)
; RV64IMZBS-NEXT:    sd a0, 8(a2)
