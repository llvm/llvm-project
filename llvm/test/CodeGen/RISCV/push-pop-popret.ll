...
; RV32I-NEXT:    lw t1, 64(a0)
; RV32I-NEXT:    lw t2, 68(a0)
; RV32I-NEXT:    lw t3, 48(a0)
; RV32I-NEXT:    lw t4, 52(a0)
; RV32I-NEXT:    lw t5, 56(a0)
; RV32I-NEXT:    lw t6, 60(a0)
; RV32I-NEXT:    lw s0, 32(a0)
; RV32I-NEXT:    lw s1, 36(a0)
; RV32I-NEXT:    lw s2, 40(a0)
; RV32I-NEXT:    lw s3, 44(a0)
; RV32I-NEXT:    sw t2, 68(a0)
; RV32I-NEXT:    sw t1, 64(a0)
; RV32I-NEXT:    sw t6, 60(a0)
; RV32I-NEXT:    sw t5, 56(a0)
; RV32I-NEXT:    sw t4, 52(a0)
; RV32I-NEXT:    sw t3, 48(a0)
...
; RV64I-NEXT:    lw t1, 64(a0)
; RV64I-NEXT:    lw t2, 68(a0)
; RV64I-NEXT:    lw t3, 48(a0)
; RV64I-NEXT:    lw t4, 52(a0)
; RV64I-NEXT:    lw t5, 56(a0)
; RV64I-NEXT:    lw t6, 60(a0)
; RV64I-NEXT:    lw s0, 32(a0)
; RV64I-NEXT:    lw s1, 36(a0)
; RV64I-NEXT:    lw s2, 40(a0)
; RV64I-NEXT:    lw s3, 44(a0)
; RV64I-NEXT:    sw t2, 68(a0)
; RV64I-NEXT:    sw t1, 64(a0)
; RV64I-NEXT:    sw t6, 60(a0)
; RV64I-NEXT:    sw t5, 56(a0)
; RV64I-NEXT:    sw t4, 52(a0)
; RV64I-NEXT:    sw t3, 48(a0)
