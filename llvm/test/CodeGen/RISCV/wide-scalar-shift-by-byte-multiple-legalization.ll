...
; RV32I-NEXT:    add t3, t4, t3
; RV32I-NEXT:    add t5, t6, t5
; RV32I-NEXT:    add a4, a6, a4
; RV32I-NEXT:    add a0, a0, t0
; RV32I-NEXT:    andi a1, a1, 12
; RV32I-NEXT:    add a3, a5, a3
; RV32I-NEXT:    add a7, t1, a7
; RV32I-NEXT:    add t3, t5, t3
...
; RV64I-NEXT:    add a4, a6, a3
; RV64I-NEXT:    add a3, a7, a1
...
; RV32I-NEXT:    add a5, a6, a5
; RV32I-NEXT:    add t2, t3, t2
; RV32I-NEXT:    add a0, a0, t4
; RV32I-NEXT:    add s4, s5, s4
; RV32I-NEXT:    add a7, a7, t5
; RV32I-NEXT:    add t1, s1, t1
; RV32I-NEXT:    add s3, s8, s3
; RV32I-NEXT:    add a1, a1, a3
; RV32I-NEXT:    sw s4, 24(sp)
; RV32I-NEXT:    sw a7, 28(sp)
; RV32I-NEXT:    sw t1, 32(sp)
; RV32I-NEXT:    sw s3, 36(sp)
; RV32I-NEXT:    sw a4, 8(sp)
...
; RV32I-NEXT:    add a7, t0, a7
; RV32I-NEXT:    add t0, s1, t1
; RV32I-NEXT:    add t1, s8, s7
...
; RV32I-NEXT:    add s5, s10, s5
; RV32I-NEXT:    add s6, ra, s11
...
; RV64I-NEXT:    add a5, a7, a5
; RV64I-NEXT:    add a7, s3, t2
; RV64I-NEXT:    add t0, s8, t0
; RV64I-NEXT:    add t2, s10, s9
...
; RV64I-NEXT:    add s2, s4, s2
; RV64I-NEXT:    add s4, s6, s5
; RV64I-NEXT:    add s5, s11, s7
...
; RV64I-NEXT:    slli a0, a0, 24
; RV64I-NEXT:    slli a1, a1, 3
; RV64I-NEXT:    add a3, a6, a3
; RV64I-NEXT:    add t4, t5, t4
; RV64I-NEXT:    add a4, t6, a4
; RV64I-NEXT:    add s0, s1, s0
; RV64I-NEXT:    add s3, s8, s3
; RV64I-NEXT:    add s9, s10, s9
; RV64I-NEXT:    add s6, s7, s6
; RV64I-NEXT:    add a0, a0, s11
; RV64I-NEXT:    andi a1, a1, 24
; RV64I-NEXT:    add a5, a7, a5
; RV64I-NEXT:    add t0, t2, t0
; RV64I-NEXT:    add s2, s4, s2
; RV64I-NEXT:    add t1, t1, s5
; RV64I-NEXT:    add a3, t4, a3
; RV64I-NEXT:    add a4, s0, a4
; RV64I-NEXT:    add s3, s9, s3
...
; RV32I-NEXT:    add s1, s8, s1
; RV32I-NEXT:    add a0, a0, s10
; RV32I-NEXT:    sub t0, t6, a1
; RV32I-NEXT:    sw a3, 56(sp)
; RV32I-NEXT:    sw a4, 60(sp)
; RV32I-NEXT:    sw s1, 64(sp)
; RV32I-NEXT:    sw a0, 68(sp)
; RV32I-NEXT:    sw a7, 40(sp)
; RV32I-NEXT:    sw t1, 44(sp)
; RV32I-NEXT:    sw s5, 48(sp)
; RV32I-NEXT:    sw a5, 52(sp)
; RV32I-NEXT:    lw a1, 0(t0)
; RV32I-NEXT:    lw a0, 4(t0)
; RV32I-NEXT:    lw a4, 8(t0)
; RV32I-NEXT:    lw a3, 12(t0)
; RV32I-NEXT:    lw a7, 24(t0)
; RV32I-NEXT:    lw a5, 20(t0)
; RV32I-NEXT:    lw a6, 16(t0)
; RV32I-NEXT:    lw t0, 28(t0)
; RV32I-NEXT:    srli t1, a7, 24
; RV32I-NEXT:    srli t2, a7, 16
; RV32I-NEXT:    srli t3, a7, 8
; RV32I-NEXT:    srli t4, t0, 24
...
; RV32I-NEXT:    slli t4, t4, 16
; RV32I-NEXT:    slli t5, t5, 24
; RV32I-NEXT:    add a4, a4, t6
; RV32I-NEXT:    sw a4, 4(sp) # 4-byte Folded Spill
; RV32I-NEXT:    add a4, a6, a5
; RV32I-NEXT:    add a5, t3, t1
; RV32I-NEXT:    add a6, t5, t4
; RV32I-NEXT:    lbu t1, 24(a0)
; RV32I-NEXT:    lbu t5, 25(a0)
; RV32I-NEXT:    lbu t6, 26(a0)
; RV32I-NEXT:    lbu s0, 27(a0)
; RV32I-NEXT:    slli s1, s1, 8
; RV32I-NEXT:    slli t3, s7, 16
; RV32I-NEXT:    slli s8, s8, 24
; RV32I-NEXT:    slli t4, s10, 8
; RV32I-NEXT:    add t2, s1, t2
; RV32I-NEXT:    add t3, s8, t3
; RV32I-NEXT:    add t4, t4, s9
...
; RV32I-NEXT:    slli s6, s6, 24
; RV32I-NEXT:    slli s11, s11, 8
; RV32I-NEXT:    slli s4, ra, 16
; RV32I-NEXT:    slli a3, a3, 24
; RV32I-NEXT:    add a0, s6, a0
; RV32I-NEXT:    add s5, s11, s5
...
; RV32I-NEXT:    slli a1, a1, 24
; RV32I-NEXT:    add a7, t0, a7
; RV32I-NEXT:    add t1, t5, t1
; RV32I-NEXT:    add t6, s0, t6
; RV32I-NEXT:    add s1, s7, s1
; RV32I-NEXT:    add s8, s9, s8
; RV32I-NEXT:    add a3, s6, a3
; RV32I-NEXT:    add a1, a1, s10
; RV32I-NEXT:    srai t0, s9, 31
...
; RV32I-NEXT:    add a0, a0, t4
; RV32I-NEXT:    add s4, s4, s5
; RV32I-NEXT:    add a7, a7, s2
; RV32I-NEXT:    add t1, t6, t1
; RV32I-NEXT:    add s1, s8, s1
; RV32I-NEXT:    add a1, a1, a3
; RV32I-NEXT:    sw t0, 56(sp)
; RV32I-NEXT:    sw t0, 60(sp)
; RV32I-NEXT:    sw t0, 64(sp)
; RV32I-NEXT:    sw t0, 68(sp)
; RV32I-NEXT:    sw t0, 40(sp)
...
; RV32I-NEXT:    add s4, s9, s4
; RV32I-NEXT:    add s5, s11, s10
...
; RV32I-NEXT:    add a3, t2, a3
; RV32I-NEXT:    add t3, t4, t3
; RV32I-NEXT:    add a4, t5, a4
; RV32I-NEXT:    add s0, s1, s0
; RV32I-NEXT:    add t6, s7, t6
; RV32I-NEXT:    add s8, ra, s8
; RV32I-NEXT:    add s9, s10, s9
; RV32I-NEXT:    add s11, a0, s11
; RV32I-NEXT:    srai a0, a0, 31
; RV32I-NEXT:    andi a1, a1, 28
; RV32I-NEXT:    add a6, t0, a6
; RV32I-NEXT:    add t1, s3, t1
; RV32I-NEXT:    add s4, s5, s4
; RV32I-NEXT:    add a5, a5, s2
; RV32I-NEXT:    add a3, t3, a3
; RV32I-NEXT:    add a4, s0, a4
; RV32I-NEXT:    add t6, s8, t6
; RV32I-NEXT:    add s9, s11, s9
...
; RV64I-NEXT:    slli s10, s10, 24
; RV64I-NEXT:    add a5, a7, a5
; RV64I-NEXT:    add a7, s3, t1
; RV64I-NEXT:    add t0, s8, t0
; RV64I-NEXT:    add t1, s10, s9
; RV64I-NEXT:    lbu s3, 24(a0)
; RV64I-NEXT:    lbu s8, 25(a0)
; RV64I-NEXT:    lbu s9, 26(a0)
; RV64I-NEXT:    lbu s10, 27(a0)
...
; RV64I-NEXT:    add s2, s4, s2
; RV64I-NEXT:    add s4, s6, s5
; RV64I-NEXT:    add s7, s11, s7
; RV64I-NEXT:    lbu s5, 28(a0)
...
; RV64I-NEXT:    andi a1, a1, 24
; RV64I-NEXT:    add a5, a7, a5
; RV64I-NEXT:    add t0, t1, t0
; RV64I-NEXT:    add s2, s4, s2
; RV64I-NEXT:    add t4, t4, s7
; RV64I-NEXT:    add a3, t2, a3
; RV64I-NEXT:    add a4, s0, a4
; RV64I-NEXT:    add s3, s9, s3
