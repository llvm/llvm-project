...
; RV32IF-NEXT:    fsw fs0, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs0, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs0
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs0, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs1, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs1, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs1
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs1, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs1, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs1, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs1
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs1, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs2, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs2, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs2
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs2, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs2, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs2, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs2
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs2, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs3, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs3, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs3
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs3, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs3, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs3, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs3
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs3, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs4, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs4, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs4
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs4, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs4, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs4, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs4
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs4, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs5, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs5, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs5
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs5, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs5, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs5, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs5
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs5, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs6, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs6, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs6
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs6, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs6, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs6, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs6
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs6, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs7, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs7, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs7
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs7, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs7, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs7, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs7
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs7, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs8, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs8, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs8
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs8, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs8, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs8, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs8
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs8, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs9, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs9, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs9
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs9, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs9, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs9, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs9
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs9, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs10, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs10, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs10
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs10, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs10, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs10, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs10
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs10, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
...
; RV32IF:       # %bb.0:
; RV32IF-NEXT:    addi sp, sp, -16
; RV32IF-NEXT:    fsw fs11, 12(sp) # 4-byte Spill
; RV32IF-NEXT:    fmv.s fs11, fa0
; RV32IF-NEXT:    #APP
; RV32IF-NEXT:    fcvt.w.s a0, fs11
; RV32IF-NEXT:    #NO_APP
; RV32IF-NEXT:    flw fs11, 12(sp) # 4-byte Reload
; RV32IF-NEXT:    addi sp, sp, 16
; RV32IF-NEXT:    ret
;
...
; RV64IF:       # %bb.0:
; RV64IF-NEXT:    addi sp, sp, -16
; RV64IF-NEXT:    fsw fs11, 12(sp) # 4-byte Spill
; RV64IF-NEXT:    fmv.s fs11, fa0
; RV64IF-NEXT:    #APP
; RV64IF-NEXT:    fcvt.w.s a0, fs11
; RV64IF-NEXT:    #NO_APP
; RV64IF-NEXT:    flw fs11, 12(sp) # 4-byte Reload
; RV64IF-NEXT:    addi sp, sp, 16
; RV64IF-NEXT:    ret
