...
; RUN: llc -mtriple=riscv32-apple-none-macho < %s                          | FileCheck %s --check-prefixes=COMMON,DEFAULT
; RUN: llc -mtriple=riscv32-apple-none-macho < %s -relocation-model=static | FileCheck %s --check-prefixes=COMMON,STATIC
