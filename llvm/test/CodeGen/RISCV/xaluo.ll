...
; RV32-NEXT:    sltu a0, t0, a1
; RV32-NEXT:    add a0, a3, a0
; RV32-NEXT:    srai a1, a5, 31
; RV32-NEXT:    xor a0, a0, a1
...
; RV32ZBA-NEXT:    sltu a0, t0, a1
; RV32ZBA-NEXT:    add a0, a3, a0
; RV32ZBA-NEXT:    srai a1, a5, 31
; RV32ZBA-NEXT:    xor a0, a0, a1
...
; RV32ZICOND-NEXT:    sltu a0, t0, a1
; RV32ZICOND-NEXT:    add a0, a3, a0
; RV32ZICOND-NEXT:    srai a1, a5, 31
; RV32ZICOND-NEXT:    xor a0, a0, a1
; RV32ZICOND-NEXT:    xor a1, t0, a1
