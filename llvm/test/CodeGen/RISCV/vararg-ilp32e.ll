...
; ILP32E-NEXT:    sw ra, 4(sp) # 4-byte Spill
; ILP32E-NEXT:    sw s0, 0(sp) # 4-byte Spill
...
; ILP32E-NEXT:    lw ra, 4(sp) # 4-byte Reload
; ILP32E-NEXT:    lw s0, 0(sp) # 4-byte Reload
...
; ILP32E-WITHFP-NEXT:    sw ra, 8(sp) # 4-byte Spill
; ILP32E-WITHFP-NEXT:    sw s0, 4(sp) # 4-byte Spill
; ILP32E-WITHFP-NEXT:    sw s1, 0(sp) # 4-byte Spill
...
; ILP32E-WITHFP-NEXT:    lw ra, 8(sp) # 4-byte Reload
; ILP32E-WITHFP-NEXT:    lw s0, 4(sp) # 4-byte Reload
; ILP32E-WITHFP-NEXT:    lw s1, 0(sp) # 4-byte Reload
