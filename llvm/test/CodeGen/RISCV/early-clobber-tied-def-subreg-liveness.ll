...
entry:
  ...
  %v_0 = call riscv_m2x4 @llvm.vector.insert.riscv_m2x4.nxv8i16(riscv_m2x4 poison, <vscale x 8 x i16> %10, i64 0)
  %v_1 = call riscv_m2x4 @llvm.vector.insert.riscv_m2x4.nxv8i16(riscv_m2x4 %v_0, <vscale x 8 x i16> %2, i64 1)
  %v_2 = call riscv_m2x4 @llvm.vector.insert.riscv_m2x4.nxv8i16(riscv_m2x4 %v_1, <vscale x 8 x i16> %3, i64 2)
  %v_3 = call riscv_m2x4 @llvm.vector.insert.riscv_m2x4.nxv8i16(riscv_m2x4 %v_2, <vscale x 8 x i16> %4, i64 3)
  tail call void @llvm.riscv.vsseg4.nxv8i16.i64(riscv_m2x4 %v_3, ptr nonnull @var_47, i64 2, i64 4)
  ret void
}
...
declare riscv_m2x4 @llvm.vector.insert.riscv_m2x4.nxv8i16(riscv_m2x4, <vscale x 8 x i16>, i64)

declare void @llvm.riscv.vsseg4.nxv8i16.i64(riscv_m2x4, ptr nocapture, i64, i64)
