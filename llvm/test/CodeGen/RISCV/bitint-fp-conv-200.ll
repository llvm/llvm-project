...
; RV64-NEXT:    mv s2, a0
; RV64-NEXT:    mv s4, a1
; RV64-NEXT:    add s8, a0, s7
; RV64-NEXT:    mv a0, s1
; RV64-NEXT:    mv a1, s1
; RV64-NEXT:    mv a2, s0
; RV64-NEXT:    li a3, 0
; RV64-NEXT:    call __multi3
; RV64-NEXT:    add a0, s8, a0
; RV64-NEXT:    sltu a2, s8, s2
; RV64-NEXT:    sltu a3, s7, s6
; RV64-NEXT:    sltu a4, a0, s8
...
; RV64-NEXT:    or s0, a2, a6
; RV64-NEXT:    or a2, a5, a7
; RV64-NEXT:    or a3, a1, a3
; RV64-NEXT:    sll s3, a4, a0
; RV64-NEXT:    mv a0, s2
; RV64-NEXT:    mv a1, s1
; RV64-NEXT:    call __multi3
; RV64-NEXT:    mv s4, a0
...
; RV64-NEXT:    call __multi3
; RV64-NEXT:    mv s2, a0
; RV64-NEXT:    add s8, s4, a1
; RV64-NEXT:    sltu a0, s8, s4
; RV64-NEXT:    add s4, s5, a0
; RV64-NEXT:    mv a0, s3
; RV64-NEXT:    li a1, 0
; RV64-NEXT:    mv a2, s1
; RV64-NEXT:    li a3, 0
; RV64-NEXT:    call __multi3
; RV64-NEXT:    add s5, a0, s8
; RV64-NEXT:    sltu a0, s5, a0
; RV64-NEXT:    add a0, a1, a0
; RV64-NEXT:    add s8, s4, a0
; RV64-NEXT:    sltu s4, s8, s4
; RV64-NEXT:    mv a0, s0
; RV64-NEXT:    li a1, 0
; RV64-NEXT:    mv a2, s1
; RV64-NEXT:    li a3, 0
...
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    add s4, a0, s4
; RV32-NEXT:    sw s4, 128(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a0, s4, a0
...
; RV32-NEXT:    add s8, s5, s8
; RV32-NEXT:    add a3, a2, s2
; RV32-NEXT:    sw s8, 124(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu s2, s8, s5
; RV32-NEXT:    add a3, a3, s2
; RV32-NEXT:    beq a3, a2, .LBB2_5
; RV32-NEXT:  # %bb.4: # %fp-to-i-if-exp.small
; RV32-NEXT:    sltu s2, a3, a2
; RV32-NEXT:  .LBB2_5: # %fp-to-i-if-exp.small
; RV32-NEXT:    sw a3, 120(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a3, s6, s4
...
; RV32-NEXT:    mv s1, a0
; RV32-NEXT:    mv s4, a1
; RV32-NEXT:    add s9, a0, s8
; RV32-NEXT:    add s10, s9, s2
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s3
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    mv s5, a1
; RV32-NEXT:    add s2, s10, a0
; RV32-NEXT:    sltu a0, s10, s9
; RV32-NEXT:    sltu a1, s9, s1
; RV32-NEXT:    sltu a2, s8, s6
; RV32-NEXT:    sltu s6, s2, s10
...
; RV32-NEXT:    add s5, s8, a2
; RV32-NEXT:    add s5, s5, s6
; RV32-NEXT:    beq s5, s8, .LBB2_7
; RV32-NEXT:  # %bb.6: # %fp-to-i-if-exp.small
; RV32-NEXT:    sltu s6, s5, s8
...
; RV32-NEXT:    sltu a0, s4, a0
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s3, s5, a0
; RV32-NEXT:    sltu s4, s3, s5
...
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    add a2, a0, s10
; RV32-NEXT:    add s4, s5, s4
; RV32-NEXT:    add s6, a2, s11
; RV32-NEXT:    sltu s5, s4, s5
; RV32-NEXT:    add s6, s6, s5
; RV32-NEXT:    beq s6, a2, .LBB2_10
; RV32-NEXT:  # %bb.9: # %fp-to-i-if-exp.large
; RV32-NEXT:    sltu s5, s6, a2
; RV32-NEXT:  .LBB2_10: # %fp-to-i-if-exp.large
; RV32-NEXT:    lw a3, 124(sp) # 4-byte Folded Reload
; RV32-NEXT:    or a3, a3, s8
; RV32-NEXT:    sw a3, 76(sp) # 4-byte Folded Spill
; RV32-NEXT:    or a3, s7, s9
; RV32-NEXT:    sw a3, 116(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a3, s10, s3
; RV32-NEXT:    sltu a0, a2, a0
...
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    mv s5, a0
; RV32-NEXT:    add s8, s3, a1
; RV32-NEXT:    mv a0, s2
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    add a2, a0, s8
; RV32-NEXT:    add s4, s5, s4
; RV32-NEXT:    sw s4, 124(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu s4, s4, s5
; RV32-NEXT:    add a3, a2, s4
...
; RV32-NEXT:    sw a3, 120(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a3, s8, s3
; RV32-NEXT:    sltu a0, a2, a0
; RV32-NEXT:    add s3, s1, a3
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s6, s3, a0
; RV32-NEXT:    lw a0, 148(sp) # 4-byte Folded Reload
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    add s1, a0, s6
; RV32-NEXT:    add s4, s1, s4
; RV32-NEXT:    add s2, s7, s4
...
; RV32-NEXT:    add a6, a0, s8
; RV32-NEXT:    sw a6, 8(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a7, s2, s7
...
; RV32-NEXT:    sltu a2, s7, a3
; RV32-NEXT:    sltu a3, s4, s1
; RV32-NEXT:    sltu a4, s6, s3
; RV32-NEXT:    sltu a5, s1, s9
; RV32-NEXT:    add a6, s10, a6
...
; RV32-NEXT:    sw a6, 80(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu s3, a6, s10
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add a4, a4, a5
; RV32-NEXT:    add s9, a0, a2
; RV32-NEXT:    add a3, a4, a3
; RV32-NEXT:    add a3, s9, a3
; RV32-NEXT:    sw a7, 56(sp) # 4-byte Folded Spill
; RV32-NEXT:    add s1, a3, a7
; RV32-NEXT:    lw a0, 144(sp) # 4-byte Folded Reload
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    lw s8, 60(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    sw s8, 32(sp) # 4-byte Folded Spill
; RV32-NEXT:    sw a0, 16(sp) # 4-byte Folded Spill
; RV32-NEXT:    add s8, a0, s8
; RV32-NEXT:    sltu s4, s10, s5
; RV32-NEXT:    add s10, s8, s4
; RV32-NEXT:    add s10, s10, s1
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
...
; RV32-NEXT:    srli a1, a0, 1
; RV32-NEXT:    beq s10, s8, .LBB2_16
; RV32-NEXT:  # %bb.15: # %fp-to-i-if-exp.large
; RV32-NEXT:    sltu s4, s10, s8
...
; RV32-NEXT:    beq s1, s9, .LBB2_18
; RV32-NEXT:  # %bb.17: # %fp-to-i-if-exp.large
; RV32-NEXT:    sltu s3, s1, s9
; RV32-NEXT:  .LBB2_18: # %fp-to-i-if-exp.large
; RV32-NEXT:    or s10, a0, a2
; RV32-NEXT:    or s9, a3, a1
...
; RV32-NEXT:    lw s1, 44(sp) # 4-byte Folded Reload
...
; RV32-NEXT:    add s4, a0, s4
; RV32-NEXT:    lw s8, 48(sp) # 4-byte Folded Reload
; RV32-NEXT:    beq s6, s2, .LBB2_20
; RV32-NEXT:  # %bb.19: # %fp-to-i-if-exp.large
; RV32-NEXT:    sltu s8, s6, s2
...
; RV32-NEXT:    sltu a1, a2, a1
; RV32-NEXT:    lw s2, 72(sp) # 4-byte Folded Reload
; RV32-NEXT:    add s2, s2, a0
; RV32-NEXT:    lw s6, 64(sp) # 4-byte Folded Reload
; RV32-NEXT:    add s6, s6, a1
; RV32-NEXT:    mv a0, s0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s7
