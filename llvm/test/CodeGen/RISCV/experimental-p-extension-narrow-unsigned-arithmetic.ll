...
; RV32-LABEL: zexti32_padd_neg:
; RV32:       # %bb.0: # %entry
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: zexti32_padd_neg:
; RV64:       # %bb.0: # %entry
...
define zeroext i16 @zexti16_paddh2_neg_minsize(i16 zeroext %a, i16 zeroext %b, i16 zeroext %c, i16 zeroext %d) #0 {
; CHECK-LABEL: zexti16_paddh2_neg_minsize:
; CHECK:       # %bb.0: # %entry
