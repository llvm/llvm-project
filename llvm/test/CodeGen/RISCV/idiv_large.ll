...
; RV32-NEXT:    j .LBB3_6
; RV32-NEXT:  .LBB3_5:
; RV32-NEXT:    srli t2, a4, 1
; RV32-NEXT:    or t2, a4, t2
...
; RV32-NEXT:    slli a4, a3, 16
; RV32-NEXT:    add a3, a3, a4
; RV32-NEXT:    srli s2, a3, 24
; RV32-NEXT:  .LBB3_19: # %_udiv-special-cases
; RV32-NEXT:    srli a3, t2, 1
; RV32-NEXT:    slli a4, a1, 31
; RV32-NEXT:    slli a5, t2, 31
; RV32-NEXT:    slli s3, a7, 31
; RV32-NEXT:    srli s4, a6, 1
; RV32-NEXT:    beqz s3, .LBB3_21
; RV32-NEXT:  # %bb.20:
; RV32-NEXT:    srli s1, s3, 1
; RV32-NEXT:    or s1, s3, s1
...
; RV32-NEXT:    or s5, a4, a3
; RV32-NEXT:    or s4, s4, a5
; RV32-NEXT:    bnez s3, .LBB3_23
; RV32-NEXT:  # %bb.22: # %_udiv-special-cases
; RV32-NEXT:    li s1, 128
; RV32-NEXT:  .LBB3_23: # %_udiv-special-cases
; RV32-NEXT:    or a5, s4, s5
; RV32-NEXT:    addi a4, s2, 64
; RV32-NEXT:    or a0, a0, s5
; RV32-NEXT:    or a3, a2, s4
; RV32-NEXT:    or a3, a3, a0
; RV32-NEXT:    addi a0, s1, 128
; RV32-NEXT:    bnez a3, .LBB3_26
; RV32-NEXT:  # %bb.24: # %_udiv-special-cases
; RV32-NEXT:    sltu a2, a0, s1
; RV32-NEXT:    beqz s5, .LBB3_27
; RV32-NEXT:  .LBB3_25:
; RV32-NEXT:    srli s1, s5, 1
; RV32-NEXT:    or s1, s5, s1
; RV32-NEXT:    srli s2, s1, 2
; RV32-NEXT:    or s1, s1, s2
; RV32-NEXT:    srli s2, s1, 4
; RV32-NEXT:    or s1, s1, s2
; RV32-NEXT:    srli s2, s1, 8
; RV32-NEXT:    or s1, s1, s2
; RV32-NEXT:    srli s2, s1, 16
; RV32-NEXT:    or s1, s1, s2
; RV32-NEXT:    not s1, s1
; RV32-NEXT:    srli s2, s1, 1
; RV32-NEXT:    and t5, s2, t5
; RV32-NEXT:    sub t5, s1, t5
; RV32-NEXT:    and s1, t5, t4
; RV32-NEXT:    srli t5, t5, 2
; RV32-NEXT:    and t4, t5, t4
; RV32-NEXT:    add t4, s1, t4
...
; RV32-NEXT:    j .LBB3_28
; RV32-NEXT:  .LBB3_26:
; RV32-NEXT:    snez a2, a5
; RV32-NEXT:    sltu s1, a4, s2
; RV32-NEXT:    addi a2, a2, -1
; RV32-NEXT:    and a2, a2, s1
; RV32-NEXT:    bnez s5, .LBB3_25
; RV32-NEXT:  .LBB3_27: # %_udiv-special-cases
; RV32-NEXT:    srli s1, s4, 1
...
; RV32-NEXT:    neg a4, t1
; RV32-NEXT:    snez t4, t1
; RV32-NEXT:    sub t1, a2, a3
; RV32-NEXT:    neg t4, t4
; RV32-NEXT:    or a2, a4, t4
; RV32-NEXT:    sub a3, s0, t3
; RV32-NEXT:    beqz a2, .LBB3_36
; RV32-NEXT:  # %bb.35: # %_udiv-special-cases
; RV32-NEXT:    snez a2, a2
; RV32-NEXT:    or a1, a1, a5
; RV32-NEXT:    bnez a0, .LBB3_37
; RV32-NEXT:    j .LBB3_38
; RV32-NEXT:  .LBB3_36:
; RV32-NEXT:    snez a2, t1
; RV32-NEXT:    sltiu t3, a3, 129
; RV32-NEXT:    xori t3, t3, 1
; RV32-NEXT:    or a2, t3, a2
; RV32-NEXT:    or a1, a1, a5
; RV32-NEXT:    beqz a0, .LBB3_38
; RV32-NEXT:  .LBB3_37: # %_udiv-special-cases
; RV32-NEXT:    mv a2, a0
; RV32-NEXT:  .LBB3_38: # %_udiv-special-cases
; RV32-NEXT:    or t6, a1, a2
; RV32-NEXT:    addi a1, t6, -1
; RV32-NEXT:    and a2, s11, a1
; RV32-NEXT:    and a5, a1, t2
...
; RV32-NEXT:    srl a0, t2, a1
; RV32-NEXT:    or a0, a0, s8
; RV32-NEXT:    lw a5, 28(sp) # 4-byte Folded Reload
; RV32-NEXT:    sub t2, a5, a4
; RV32-NEXT:    sw t2, 36(sp) # 4-byte Folded Spill
; RV32-NEXT:    sltu a4, a5, a4
; RV32-NEXT:    addi a7, a7, 1
...
; RV32-NEXT:    xor a7, s6, t2
; RV32-NEXT:    or a6, a6, a7
; RV32-NEXT:    beqz a6, .LBB3_51
...
; RV32-NEXT:    sw a1, 0(s6)
; RV32-NEXT:    sw t5, 4(s6)
; RV32-NEXT:    sw t3, 8(s6)
; RV32-NEXT:    sw a5, 12(s6)
; RV32-NEXT:    andi a2, a2, 1
; RV32-NEXT:    sb a2, 16(s6)
