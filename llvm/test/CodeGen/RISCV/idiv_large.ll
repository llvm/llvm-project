...
; RV32-NEXT:    lw a1, 8(a1)
; RV32-NEXT:    snez s4, s0
; RV32-NEXT:    bnez a6, .LBB2_10
; RV32-NEXT:  # %bb.9: # %_udiv-special-cases
; RV32-NEXT:    srli a0, t0, 1
; RV32-NEXT:    or a0, t0, a0
; RV32-NEXT:    srli s0, a0, 2
; RV32-NEXT:    or a0, a0, s0
; RV32-NEXT:    srli s0, a0, 4
; RV32-NEXT:    or a0, a0, s0
; RV32-NEXT:    srli s0, a0, 8
; RV32-NEXT:    or a0, a0, s0
; RV32-NEXT:    srli s0, a0, 16
; RV32-NEXT:    or a0, a0, s0
; RV32-NEXT:    not a0, a0
; RV32-NEXT:    srli s0, a0, 1
; RV32-NEXT:    and s0, s0, t3
; RV32-NEXT:    sub a0, a0, s0
; RV32-NEXT:    srli s0, a0, 2
; RV32-NEXT:    and a0, a0, t2
; RV32-NEXT:    and s0, s0, t2
; RV32-NEXT:    add a0, a0, s0
; RV32-NEXT:    srli s0, a0, 4
; RV32-NEXT:    add a0, a0, s0
; RV32-NEXT:    and a0, a0, t1
; RV32-NEXT:    slli s0, a0, 8
; RV32-NEXT:    add a0, a0, s0
; RV32-NEXT:    slli s0, a0, 16
; RV32-NEXT:    add a0, a0, s0
; RV32-NEXT:    srli a0, a0, 24
...
; RV32-NEXT:    or s0, a5, s11
; RV32-NEXT:    or s1, ra, s10
; RV32-NEXT:    or s2, a6, a7
; RV32-NEXT:    or s3, t0, a1
; RV32-NEXT:    sltu t5, t6, t5
; RV32-NEXT:    addi s4, s4, -1
; RV32-NEXT:    or s5, a1, a7
; RV32-NEXT:    addi t6, a0, 64
; RV32-NEXT:    snez s7, s5
; RV32-NEXT:    sltu s6, t6, a0
...
; RV32-NEXT:    and t3, s8, t3
; RV32-NEXT:    sub a0, a0, t3
; RV32-NEXT:    srli t3, a0, 2
; RV32-NEXT:    and a0, a0, t2
; RV32-NEXT:    and t2, t3, t2
; RV32-NEXT:    add a0, a0, t2
; RV32-NEXT:    srli t2, a0, 4
; RV32-NEXT:    add a0, a0, t2
; RV32-NEXT:    and a0, a0, t1
...
; RV32-NEXT:    lw s1, 0(a4)
; RV32-NEXT:    lw a4, 12(a4)
; RV32-NEXT:    or s2, t1, t4
; RV32-NEXT:    andi a0, a0, 31
; RV32-NEXT:    or s3, s2, t6
; RV32-NEXT:    xori a0, a0, 31
; RV32-NEXT:    srli t6, a3, 1
; RV32-NEXT:    not t5, t5
; RV32-NEXT:    srl t6, t6, a0
; RV32-NEXT:    sll a4, a4, t5
; RV32-NEXT:    or t6, a4, t6
; RV32-NEXT:    srli a4, s0, 1
; RV32-NEXT:    srl a4, a4, a0
; RV32-NEXT:    sll a3, a3, t5
; RV32-NEXT:    or a3, a3, a4
; RV32-NEXT:    srli a4, s1, 1
; RV32-NEXT:    srl a0, a4, a0
; RV32-NEXT:    sll a4, s0, t5
; RV32-NEXT:    or s2, a4, a0
; RV32-NEXT:    sll t5, s1, t5
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    beqz s3, .LBB2_31
...
; RV32-NEXT:    or t5, a0, t5
; RV32-NEXT:    or s2, s3, a4
; RV32-NEXT:    or a3, s4, a3
; RV32-NEXT:    or t6, s5, t6
; RV32-NEXT:    andi a0, s1, 1
; RV32-NEXT:    and a4, s1, a2
; RV32-NEXT:    and s1, s1, a7
; RV32-NEXT:    sub s0, s7, a4
; RV32-NEXT:    sltu a4, s7, a4
; RV32-NEXT:    sub s1, s6, s1
; RV32-NEXT:    sltu s3, s0, s8
; RV32-NEXT:    sub s1, s1, a4
; RV32-NEXT:    sub s6, s0, s8
; RV32-NEXT:    sub s7, s1, s3
; RV32-NEXT:    sub a4, s10, ra
; RV32-NEXT:    or s0, t1, t2
; RV32-NEXT:    sub s8, a4, t0
; RV32-NEXT:    seqz a4, s0
; RV32-NEXT:    seqz t0, t1
; RV32-NEXT:    sltu s0, t4, a4
; RV32-NEXT:    sub t4, t4, a4
; RV32-NEXT:    sub t2, t2, t0
; RV32-NEXT:    sub t3, t3, s0
; RV32-NEXT:    addi t1, t1, -1
; RV32-NEXT:    or a4, t2, t3
; RV32-NEXT:    or t0, t1, t4
...
; RV32-NEXT:    li s5, 0
; RV32-NEXT:    mv ra, a5
; RV32-NEXT:    beqz a4, .LBB2_31
; RV32-NEXT:  .LBB2_26: # %udiv-do-while
; RV32-NEXT:    # =>This Inner Loop Header: Depth=1
; RV32-NEXT:    srli t0, s9, 31
; RV32-NEXT:    slli s1, s8, 1
; RV32-NEXT:    or s10, s1, t0
; RV32-NEXT:    slli s9, s9, 1
; RV32-NEXT:    srli t0, t6, 31
; RV32-NEXT:    or s9, s9, t0
; RV32-NEXT:    beq a1, s10, .LBB2_28
...
; RV32-NEXT:    srli a4, s2, 31
; RV32-NEXT:    or t1, a2, a1
; RV32-NEXT:    slli a1, a3, 1
; RV32-NEXT:    or t4, a1, a4
; RV32-NEXT:    srli s0, a3, 31
; RV32-NEXT:    slli t6, t6, 1
; RV32-NEXT:    slli t5, t5, 1
...
; RV32-NEXT:    or a5, s5, a5
; RV32-NEXT:    bnez a4, .LBB3_23
; RV32-NEXT:  # %bb.22: # %_udiv-special-cases
; RV32-NEXT:    li s3, 128
; RV32-NEXT:  .LBB3_23: # %_udiv-special-cases
; RV32-NEXT:    or s7, a5, a2
; RV32-NEXT:    or a0, a0, a2
; RV32-NEXT:    or a3, s4, a5
; RV32-NEXT:    addi s6, s3, 128
; RV32-NEXT:    or s5, a3, a0
; RV32-NEXT:    addi a3, s8, 64
...
; RV32-NEXT:    lw s4, 0(a4)
; RV32-NEXT:    lw a2, 12(a4)
...
; RV32-NEXT:    slli a6, a6, 1
; RV32-NEXT:    srl a7, a5, a1
; RV32-NEXT:    sll a6, a6, t0
; RV32-NEXT:    or a0, a0, a4
; RV32-NEXT:    or s5, a7, a6
; RV32-NEXT:    andi ra, a3, 1
; RV32-NEXT:    or a3, s1, s6
; RV32-NEXT:    li s1, 0
...
; RV32-NEXT:    andi s1, s1, 1
; RV32-NEXT:    sltu t0, a0, a7
; RV32-NEXT:    sub a7, a0, a7
; RV32-NEXT:    sub a0, a7, a5
; RV32-NEXT:    sub a3, a3, s11
...
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    andi a4, ra, 1
; RV32-NEXT:    or s6, s6, a4
; RV32-NEXT:    mv t4, s3
; RV32-NEXT:    beq a6, s5, .LBB3_50
...
; RV32-NEXT:    mv a5, a6
; RV32-NEXT:    beq s5, a2, .LBB3_44
; RV32-NEXT:  # %bb.54: # %udiv-do-while
; RV32-NEXT:    # in Loop: Header=BB3_45 Depth=1
; RV32-NEXT:    sltu a5, s5, a2
; RV32-NEXT:    j .LBB3_44
; RV32-NEXT:  .LBB3_55:
; RV32-NEXT:    li s1, 0
; RV32-NEXT:    mv t1, t5
...
; RV32-NEXT:    sw t4, 0(s9)
; RV32-NEXT:    sw a2, 4(s9)
; RV32-NEXT:    sw a1, 8(s9)
; RV32-NEXT:    sw a4, 12(s9)
; RV32-NEXT:    sb a5, 16(s9)
