...
; RISCV32-NEXT:    lw t1, 4(a1)
; RISCV32-NEXT:    lw a4, 8(a1)
; RISCV32-NEXT:    lw a1, 12(a1)
; RISCV32-NEXT:    lw a7, 4(a2)
; RISCV32-NEXT:    lw a6, 8(a2)
; RISCV32-NEXT:    lw a2, 12(a2)
; RISCV32-NEXT:    mulhu t0, a5, a3
; RISCV32-NEXT:    mul t2, t1, a3
; RISCV32-NEXT:    mulhu t3, t1, a3
; RISCV32-NEXT:    mul t4, a5, a7
; RISCV32-NEXT:    mulhu t5, a5, a7
; RISCV32-NEXT:    mul s0, t1, a7
; RISCV32-NEXT:    mul s1, a6, a5
; RISCV32-NEXT:    mul s2, a4, a3
; RISCV32-NEXT:    mulhu s3, t1, a7
; RISCV32-NEXT:    mul s4, t1, a6
; RISCV32-NEXT:    mul s5, a2, a5
; RISCV32-NEXT:    mul s6, a7, a4
; RISCV32-NEXT:    add t0, t2, t0
; RISCV32-NEXT:    mul s7, a1, a3
; RISCV32-NEXT:    sltu t2, t0, t2
; RISCV32-NEXT:    add t0, t4, t0
; RISCV32-NEXT:    add t2, t3, t2
; RISCV32-NEXT:    sltu t3, t0, t4
; RISCV32-NEXT:    mulhu t6, a6, a5
; RISCV32-NEXT:    add t3, t5, t3
; RISCV32-NEXT:    mulhu t5, a4, a3
; RISCV32-NEXT:    add t3, t2, t3
; RISCV32-NEXT:    add s4, s5, s4
; RISCV32-NEXT:    sltu t2, t3, t2
; RISCV32-NEXT:    add s3, s3, t2
; RISCV32-NEXT:    add t3, s0, t3
; RISCV32-NEXT:    add t4, s2, s1
; RISCV32-NEXT:    add s6, s7, s6
; RISCV32-NEXT:    add t2, t3, t4
; RISCV32-NEXT:    sltu s5, t3, s0
; RISCV32-NEXT:    add s1, t6, s4
; RISCV32-NEXT:    add s0, t5, s6
; RISCV32-NEXT:    sltu t4, t4, s2
; RISCV32-NEXT:    add s4, s0, s1
; RISCV32-NEXT:    add s2, s3, s5
; RISCV32-NEXT:    add s4, s4, t4
; RISCV32-NEXT:    sltu t4, t2, t3
; RISCV32-NEXT:    add t3, s2, s4
...
; RISCV32-NEXT:    mulhu s2, a2, a5
; RISCV32-NEXT:    mulhu s3, t1, a6
; RISCV32-NEXT:    sltu t6, s1, t6
; RISCV32-NEXT:    snez t1, t1
; RISCV32-NEXT:    snez s1, a2
; RISCV32-NEXT:    mulhu s4, a1, a3
; RISCV32-NEXT:    sltu t5, s0, t5
; RISCV32-NEXT:    mulhu s0, a7, a4
; RISCV32-NEXT:    snez a7, a7
; RISCV32-NEXT:    snez s5, a1
; RISCV32-NEXT:    and t1, s1, t1
; RISCV32-NEXT:    and a7, s5, a7
; RISCV32-NEXT:    snez s1, s2
; RISCV32-NEXT:    snez s2, s3
; RISCV32-NEXT:    or t1, t1, s1
; RISCV32-NEXT:    or t6, s2, t6
; RISCV32-NEXT:    snez s1, s4
; RISCV32-NEXT:    or t1, t1, t6
; RISCV32-NEXT:    or a7, a7, s1
; RISCV32-NEXT:    snez t6, s0
; RISCV32-NEXT:    or t5, t6, t5
; RISCV32-NEXT:    mul a3, a5, a3
; RISCV32-NEXT:    or a2, a6, a2
; RISCV32-NEXT:    or a1, a4, a1
; RISCV32-NEXT:    snez a2, a2
; RISCV32-NEXT:    snez a1, a1
; RISCV32-NEXT:    or a4, a7, t5
; RISCV32-NEXT:    and a1, a1, a2
; RISCV32-NEXT:    or a1, a1, a4
; RISCV32-NEXT:    or a2, t1, t4
