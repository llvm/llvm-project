...
; RV64ID-NEXT:  .LBB4_2:
; RV64ID-NEXT:    lui a2, %hi(.LCPI4_0)
; RV64ID-NEXT:    fld fa5, %lo(.LCPI4_0)(a2)
; RV64ID-NEXT:    flt.d a2, fa5, fs0
; RV64ID-NEXT:    beqz a2, .LBB4_4
; RV64ID-NEXT:  # %bb.3:
...
; RV64IDINX-NEXT:    li a1, -449
; RV64IDINX-NEXT:    slli a1, a1, 53
; RV64IDINX-NEXT:    mv s0, a0
; RV64IDINX-NEXT:    fle.d s1, a1, a0
