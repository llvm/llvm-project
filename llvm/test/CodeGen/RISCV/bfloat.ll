...
; RV32I-ILP32-NEXT:    sw ra, 12(sp) # 4-byte Spill
; RV32I-ILP32-NEXT:    call __truncsfbf2
; RV32I-ILP32-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32I-ILP32-NEXT:    addi sp, sp, 16
...
; RV64I-LP64-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-LP64-NEXT:    call __truncsfbf2
; RV64I-LP64-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-LP64-NEXT:    addi sp, sp, 16
; RV64I-LP64-NEXT:    ret
;
...
; RV32ID-ILP32D-NEXT:    sw ra, 12(sp) # 4-byte Spill
...
; RV32ID-ILP32D-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32ID-ILP32D-NEXT:    addi sp, sp, 16
...
; RV64ID-LP64D-NEXT:    sd ra, 8(sp) # 8-byte Spill
...
; RV64ID-LP64D-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64ID-LP64D-NEXT:    addi sp, sp, 16
...
; RV32I-ILP32-NEXT:    addi sp, sp, -16
; RV32I-ILP32-NEXT:    sw ra, 12(sp) # 4-byte Spill
; RV32I-ILP32-NEXT:    sw s0, 8(sp) # 4-byte Spill
...
; RV32I-ILP32-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32I-ILP32-NEXT:    lw s0, 8(sp) # 4-byte Reload
; RV32I-ILP32-NEXT:    addi sp, sp, 16
; RV32I-ILP32-NEXT:    ret
;
...
; RV64I-LP64-NEXT:    addi sp, sp, -16
; RV64I-LP64-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-LP64-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64I-LP64-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-LP64-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-LP64-NEXT:    addi sp, sp, 16
; RV64I-LP64-NEXT:    ret
;
...
; RV32ID-ILP32-NEXT:    addi sp, sp, -16
; RV32ID-ILP32-NEXT:    sw ra, 12(sp) # 4-byte Spill
; RV32ID-ILP32-NEXT:    sw s0, 8(sp) # 4-byte Spill
...
; RV32ID-ILP32-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32ID-ILP32-NEXT:    lw s0, 8(sp) # 4-byte Reload
; RV32ID-ILP32-NEXT:    addi sp, sp, 16
; RV32ID-ILP32-NEXT:    ret
;
...
; RV64ID-LP64-NEXT:    addi sp, sp, -16
; RV64ID-LP64-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64ID-LP64-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64ID-LP64-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64ID-LP64-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64ID-LP64-NEXT:    addi sp, sp, 16
; RV64ID-LP64-NEXT:    ret
;
...
; RV32ID-ILP32D-NEXT:    addi sp, sp, -16
; RV32ID-ILP32D-NEXT:    sw ra, 12(sp) # 4-byte Spill
; RV32ID-ILP32D-NEXT:    sw s0, 8(sp) # 4-byte Spill
...
; RV32ID-ILP32D-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32ID-ILP32D-NEXT:    lw s0, 8(sp) # 4-byte Reload
; RV32ID-ILP32D-NEXT:    addi sp, sp, 16
; RV32ID-ILP32D-NEXT:    ret
;
...
; RV64ID-LP64D-NEXT:    addi sp, sp, -16
; RV64ID-LP64D-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64ID-LP64D-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64ID-LP64D-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64ID-LP64D-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64ID-LP64D-NEXT:    addi sp, sp, 16
; RV64ID-LP64D-NEXT:    ret
  %1 = fadd bfloat %b, %c
