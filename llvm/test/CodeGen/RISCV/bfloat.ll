...
; RV32ID-ILP32-NEXT:    fmv.w.x fa4, a1
; RV32ID-ILP32-NEXT:    fadd.s fa5, fa4, fa5
; RV32ID-ILP32-NEXT:    fmv.x.w a1, fa5
; RV32ID-ILP32-NEXT:    mv s0, a0
; RV32ID-ILP32-NEXT:    mv a0, a1
; RV32ID-ILP32-NEXT:    call __truncsfbf2
...
; RV64ID-LP64-NEXT:    fmv.w.x fa4, a1
; RV64ID-LP64-NEXT:    fadd.s fa5, fa4, fa5
; RV64ID-LP64-NEXT:    fmv.x.w a1, fa5
; RV64ID-LP64-NEXT:    mv s0, a0
; RV64ID-LP64-NEXT:    mv a0, a1
; RV64ID-LP64-NEXT:    call __truncsfbf2
...
; RV32ID-ILP32D-NEXT:    fmv.x.w a1, fa0
; RV32ID-ILP32D-NEXT:    fmv.x.w a2, fa1
; RV32ID-ILP32D-NEXT:    slli a2, a2, 16
; RV32ID-ILP32D-NEXT:    slli a1, a1, 16
; RV32ID-ILP32D-NEXT:    fmv.w.x fa5, a2
; RV32ID-ILP32D-NEXT:    fmv.w.x fa4, a1
; RV32ID-ILP32D-NEXT:    fadd.s fa0, fa4, fa5
...
; RV64ID-LP64D-NEXT:    fmv.x.w a1, fa0
; RV64ID-LP64D-NEXT:    fmv.x.w a2, fa1
; RV64ID-LP64D-NEXT:    slli a2, a2, 16
; RV64ID-LP64D-NEXT:    slli a1, a1, 16
; RV64ID-LP64D-NEXT:    fmv.w.x fa5, a2
; RV64ID-LP64D-NEXT:    fmv.w.x fa4, a1
; RV64ID-LP64D-NEXT:    fadd.s fa0, fa4, fa5
