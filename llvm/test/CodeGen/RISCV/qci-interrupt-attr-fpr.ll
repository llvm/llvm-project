...
; QCI-F-NEXT:    .cfi_offset ft10, -172
; QCI-F-NEXT:    .cfi_offset ft11, -176
; QCI-F-NEXT:    lui a0, 266496
; QCI-F-NEXT:    li a1, 5
; QCI-F-NEXT:    lui a2, 260096
; QCI-F-NEXT:    lui a7, 262144
; QCI-F-NEXT:    lui a6, 263168
; QCI-F-NEXT:    lui t0, 264192
; QCI-F-NEXT:    lui a4, 264704
; QCI-F-NEXT:    lui a3, 265216
; QCI-F-NEXT:    lui a5, 265728
; QCI-F-NEXT:    sw a1, 0(sp)
; QCI-F-NEXT:    sw a0, 4(sp)
; QCI-F-NEXT:    lui a1, 266240
; QCI-F-NEXT:    fmv.w.x fa0, a2
; QCI-F-NEXT:    li a0, 1
; QCI-F-NEXT:    fmv.w.x fa1, a7
; QCI-F-NEXT:    li a2, 2
; QCI-F-NEXT:    fmv.w.x fa2, a6
; QCI-F-NEXT:    fmv.w.x fa3, t0
; QCI-F-NEXT:    fmv.w.x fa4, a4
; QCI-F-NEXT:    fmv.w.x fa5, a3
; QCI-F-NEXT:    fmv.w.x fa6, a5
; QCI-F-NEXT:    fmv.w.x fa7, a1
; QCI-F-NEXT:    li a4, 3
; QCI-F-NEXT:    li a6, 4
; QCI-F-NEXT:    li a1, 0
; QCI-F-NEXT:    li a3, 0
...
; QCI-D-NEXT:    .cfi_offset ft10, -248
; QCI-D-NEXT:    .cfi_offset ft11, -256
; QCI-D-NEXT:    lui a0, 266496
; QCI-D-NEXT:    li a1, 5
; QCI-D-NEXT:    lui a2, 260096
; QCI-D-NEXT:    lui a7, 262144
; QCI-D-NEXT:    lui a6, 263168
; QCI-D-NEXT:    lui t0, 264192
; QCI-D-NEXT:    lui a4, 264704
; QCI-D-NEXT:    lui a3, 265216
; QCI-D-NEXT:    lui a5, 265728
; QCI-D-NEXT:    sw a1, 0(sp)
; QCI-D-NEXT:    sw a0, 4(sp)
; QCI-D-NEXT:    lui a1, 266240
; QCI-D-NEXT:    fmv.w.x fa0, a2
; QCI-D-NEXT:    li a0, 1
; QCI-D-NEXT:    fmv.w.x fa1, a7
; QCI-D-NEXT:    li a2, 2
; QCI-D-NEXT:    fmv.w.x fa2, a6
; QCI-D-NEXT:    fmv.w.x fa3, t0
; QCI-D-NEXT:    fmv.w.x fa4, a4
; QCI-D-NEXT:    fmv.w.x fa5, a3
; QCI-D-NEXT:    fmv.w.x fa6, a5
; QCI-D-NEXT:    fmv.w.x fa7, a1
; QCI-D-NEXT:    li a4, 3
; QCI-D-NEXT:    li a6, 4
; QCI-D-NEXT:    li a1, 0
; QCI-D-NEXT:    li a3, 0
...
; QCI-F-NEXT:    lui s1, 264704
; QCI-F-NEXT:    lui a4, 265216
; QCI-F-NEXT:    lui a3, 265728
; QCI-F-NEXT:    sw a1, 0(sp)
; QCI-F-NEXT:    sw a0, 4(sp)
; QCI-F-NEXT:    lui a1, 266240
; QCI-F-NEXT:    fmv.w.x fa0, a2
...
; QCI-F-NEXT:    fmv.w.x fa4, s1
; QCI-F-NEXT:    fmv.w.x fa5, a4
; QCI-F-NEXT:    fmv.w.x fa6, a3
; QCI-F-NEXT:    fmv.w.x fa7, a1
; QCI-F-NEXT:    li a4, 3
; QCI-F-NEXT:    li a6, 4
; QCI-F-NEXT:    li a1, 0
...
; QCI-D-NEXT:    lui s1, 264704
; QCI-D-NEXT:    lui a4, 265216
; QCI-D-NEXT:    lui a3, 265728
; QCI-D-NEXT:    sw a1, 0(sp)
; QCI-D-NEXT:    sw a0, 4(sp)
; QCI-D-NEXT:    lui a1, 266240
; QCI-D-NEXT:    fmv.w.x fa0, a2
...
; QCI-D-NEXT:    fmv.w.x fa4, s1
; QCI-D-NEXT:    fmv.w.x fa5, a4
; QCI-D-NEXT:    fmv.w.x fa6, a3
; QCI-D-NEXT:    fmv.w.x fa7, a1
; QCI-D-NEXT:    li a4, 3
; QCI-D-NEXT:    li a6, 4
; QCI-D-NEXT:    li a1, 0
