...
; RV32I-FPELIM-NEXT:    sw s0, 56(sp) # 4-byte Spill
...
; RV32I-FPELIM-NEXT:    lw s0, 56(sp) # 4-byte Reload
; RV32I-FPELIM-NEXT:    addi sp, sp, 64
; RV32I-FPELIM-NEXT:    ret
;
...
; RV32I-WITHFP-NEXT:    sw s1, 52(sp) # 4-byte Spill
...
; RV32I-WITHFP-NEXT:    lw s1, 52(sp) # 4-byte Reload
; RV32I-WITHFP-NEXT:    addi sp, sp, 64
; RV32I-WITHFP-NEXT:    ret
