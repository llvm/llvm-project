...
; RV32IF-NEXT:    and a0, a7, a0
; RV32IF-NEXT:    and a5, a7, a2
; RV32IF-NEXT:    beq a1, a3, .LBB18_8
; RV32IF-NEXT:  # %bb.7: # %entry
; RV32IF-NEXT:    sltu a2, a3, a1
; RV32IF-NEXT:    j .LBB18_9
; RV32IF-NEXT:  .LBB18_8:
; RV32IF-NEXT:    snez a2, a4
...
; RV64IF-NEXT:  # %bb.1: # %entry
; RV64IF-NEXT:    slti a5, a1, 0
; RV64IF-NEXT:    j .LBB18_3
; RV64IF-NEXT:  .LBB18_2:
; RV64IF-NEXT:    sltu a5, a0, a3
; RV64IF-NEXT:  .LBB18_3: # %entry
; RV64IF-NEXT:    neg a4, a5
; RV64IF-NEXT:    and a4, a4, a1
; RV64IF-NEXT:    bnez a5, .LBB18_5
; RV64IF-NEXT:  # %bb.4: # %entry
; RV64IF-NEXT:    mv a0, a3
; RV64IF-NEXT:  .LBB18_5: # %entry
; RV64IF-NEXT:    slli a1, a2, 63
; RV64IF-NEXT:    beq a4, a2, .LBB18_7
; RV64IF-NEXT:  # %bb.6: # %entry
; RV64IF-NEXT:    slti a2, a4, 0
...
; RV32IFD-NEXT:    and a0, a7, a0
; RV32IFD-NEXT:    and a5, a7, a2
; RV32IFD-NEXT:    beq a1, a3, .LBB18_8
; RV32IFD-NEXT:  # %bb.7: # %entry
; RV32IFD-NEXT:    sltu a2, a3, a1
; RV32IFD-NEXT:    j .LBB18_9
; RV32IFD-NEXT:  .LBB18_8:
; RV32IFD-NEXT:    snez a2, a4
...
; RV32IF-NEXT:    and a6, a2, a1
; RV32IF-NEXT:    beqz a6, .LBB20_7
; RV32IF-NEXT:  # %bb.6: # %entry
; RV32IF-NEXT:    sgtz a4, a6
; RV32IF-NEXT:    j .LBB20_8
; RV32IF-NEXT:  .LBB20_7:
; RV32IF-NEXT:    snez a4, a0
; RV32IF-NEXT:  .LBB20_8: # %entry
; RV32IF-NEXT:    and a1, a2, a5
; RV32IF-NEXT:    or a0, a0, a6
...
; RV32IFD-NEXT:    and a6, a2, a1
; RV32IFD-NEXT:    beqz a6, .LBB20_7
; RV32IFD-NEXT:  # %bb.6: # %entry
; RV32IFD-NEXT:    sgtz a4, a6
; RV32IFD-NEXT:    j .LBB20_8
; RV32IFD-NEXT:  .LBB20_7:
; RV32IFD-NEXT:    snez a4, a0
; RV32IFD-NEXT:  .LBB20_8: # %entry
; RV32IFD-NEXT:    and a1, a2, a5
; RV32IFD-NEXT:    or a0, a0, a6
...
; RV32-NEXT:    xori a2, a0, 1
; RV32-NEXT:  .LBB21_11: # %entry
; RV32-NEXT:    bnez a2, .LBB21_13
...
; RV32-NEXT:    and a6, a2, a1
; RV32-NEXT:    beqz a6, .LBB23_7
; RV32-NEXT:  # %bb.6: # %entry
; RV32-NEXT:    sgtz a4, a6
; RV32-NEXT:    j .LBB23_8
; RV32-NEXT:  .LBB23_7:
; RV32-NEXT:    snez a4, a0
; RV32-NEXT:  .LBB23_8: # %entry
; RV32-NEXT:    and a1, a2, a5
; RV32-NEXT:    or a0, a0, a6
; RV32-NEXT:    and a2, a2, a3
; RV32-NEXT:    bnez a0, .LBB23_10
; RV32-NEXT:  # %bb.9:
; RV32-NEXT:    or a0, a2, a1
; RV32-NEXT:    snez a4, a0
...
; RV64IF-NEXT:    neg a4, a5
; RV64IF-NEXT:    and a4, a4, a1
; RV64IF-NEXT:    bnez a5, .LBB45_5
; RV64IF-NEXT:  # %bb.4: # %entry
; RV64IF-NEXT:    mv a0, a3
; RV64IF-NEXT:  .LBB45_5: # %entry
; RV64IF-NEXT:    slli a1, a2, 63
; RV64IF-NEXT:    beq a4, a2, .LBB45_7
; RV64IF-NEXT:  # %bb.6: # %entry
; RV64IF-NEXT:    slti a2, a4, 0
; RV64IF-NEXT:    xori a2, a2, 1
...
; RV64-NEXT:    neg a4, a5
; RV64-NEXT:    and a4, a4, a1
; RV64-NEXT:    bnez a5, .LBB51_5
; RV64-NEXT:  # %bb.4: # %entry
; RV64-NEXT:    mv a0, a3
; RV64-NEXT:  .LBB51_5: # %entry
; RV64-NEXT:    slli a1, a2, 63
; RV64-NEXT:    beq a4, a2, .LBB51_7
; RV64-NEXT:  # %bb.6: # %entry
; RV64-NEXT:    slti a2, a4, 0
; RV64-NEXT:    xori a2, a2, 1
