...
; RV32IF-NEXT:    .cfi_def_cfa_offset 0
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB18_16: # %fp-to-i-if-check.exp.size
...
; RV32IF-NEXT:    bltu a4, a2, .LBB18_19
; RV32IF-NEXT:  # %bb.17: # %fp-to-i-if-exp.small
...
; RV32IF-NEXT:    and s2, a4, a5
; RV32IF-NEXT:    bltz a1, .LBB18_20
; RV32IF-NEXT:  # %bb.18: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl s3, a0, a1
; RV32IF-NEXT:    j .LBB18_21
; RV32IF-NEXT:  .LBB18_19: # %fp-to-i-if-exp.large
...
; RV32IF-NEXT:    add s8, s4, a1
; RV32IF-NEXT:    sltu a0, s8, s4
; RV32IF-NEXT:    add s5, s5, a0
; RV32IF-NEXT:    mv a0, s3
; RV32IF-NEXT:    li a1, 0
...
; RV32IF-NEXT:    add s3, s5, a0
; RV32IF-NEXT:    sltu s5, s3, s5
; RV32IF-NEXT:    mv a0, s2
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s0
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    call __muldi3
; RV32IF-NEXT:    mv s4, s1
; RV32IF-NEXT:    mv a2, a1
; RV32IF-NEXT:    mv a1, s8
; RV32IF-NEXT:    add a2, a2, s5
; RV32IF-NEXT:    add s3, a0, s3
; RV32IF-NEXT:    sltu a3, s3, a0
; RV32IF-NEXT:    add a0, s3, s6
; RV32IF-NEXT:    add a2, a2, a3
; RV32IF-NEXT:    add a2, a2, s7
; RV32IF-NEXT:    sltu a3, a0, s3
; RV32IF-NEXT:    add a2, a2, a3
; RV32IF-NEXT:    j .LBB18_2
; RV32IF-NEXT:  .LBB18_20:
; RV32IF-NEXT:    srl a1, a3, a2
; RV32IF-NEXT:    not a2, a2
; RV32IF-NEXT:    slli a0, a0, 1
; RV32IF-NEXT:    sll a0, a0, a2
; RV32IF-NEXT:    or s3, a1, a0
; RV32IF-NEXT:  .LBB18_21: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    mv a0, s3
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s1
; RV32IF-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    beq a5, a3, .LBB18_13
...
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB18_16: # %fp-to-i-if-check.exp.size
...
; RV32IFD-NEXT:    add a1, a1, a4
; RV32IFD-NEXT:    bltu a3, a0, .LBB18_19
; RV32IFD-NEXT:  # %bb.17: # %fp-to-i-if-exp.small
...
; RV32IFD-NEXT:    and s2, a4, a5
; RV32IFD-NEXT:    bltz a3, .LBB18_20
; RV32IFD-NEXT:  # %bb.18: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl s3, a1, a3
; RV32IFD-NEXT:    j .LBB18_21
; RV32IFD-NEXT:  .LBB18_19: # %fp-to-i-if-exp.large
...
; RV32IFD-NEXT:    mv a3, s2
; RV32IFD-NEXT:    call __muldi3
; RV32IFD-NEXT:    add a1, a1, s5
; RV32IFD-NEXT:    add s6, a0, s4
...
; RV32IFD-NEXT:    add s8, s4, a1
; RV32IFD-NEXT:    sltu a0, s8, s4
; RV32IFD-NEXT:    add s5, s5, a0
; RV32IFD-NEXT:    mv a0, s3
; RV32IFD-NEXT:    li a1, 0
...
; RV32IFD-NEXT:    add s3, s5, a0
; RV32IFD-NEXT:    sltu s5, s3, s5
; RV32IFD-NEXT:    mv a0, s2
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s0
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    call __muldi3
; RV32IFD-NEXT:    mv s4, s1
; RV32IFD-NEXT:    mv a2, a1
; RV32IFD-NEXT:    mv a1, s8
; RV32IFD-NEXT:    add a2, a2, s5
; RV32IFD-NEXT:    add s3, a0, s3
; RV32IFD-NEXT:    sltu a3, s3, a0
; RV32IFD-NEXT:    add a0, s3, s6
; RV32IFD-NEXT:    add a2, a2, a3
; RV32IFD-NEXT:    add a2, a2, s7
; RV32IFD-NEXT:    sltu a3, a0, s3
; RV32IFD-NEXT:    add a2, a2, a3
; RV32IFD-NEXT:    j .LBB18_2
; RV32IFD-NEXT:  .LBB18_20:
; RV32IFD-NEXT:    srl a2, a2, a0
; RV32IFD-NEXT:    not a0, a0
; RV32IFD-NEXT:    slli a1, a1, 1
; RV32IFD-NEXT:    sll a0, a1, a0
; RV32IFD-NEXT:    or s3, a2, a0
; RV32IFD-NEXT:  .LBB18_21: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    mv a0, s3
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s1
; RV32IFD-NEXT:    li a3, 0
...
; RV32IF-NEXT:    srli a2, a2, 21
; RV32IF-NEXT:    li a3, 1023
; RV32IF-NEXT:    bgeu a2, a3, .LBB19_3
; RV32IF-NEXT:  # %bb.1:
; RV32IF-NEXT:    li a0, 0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    li a2, 0
; RV32IF-NEXT:  .LBB19_2: # %fp-to-i-cleanup
...
; RV32IF-NEXT:    and a1, a2, a1
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB19_3: # %fp-to-i-if-check.exp.size
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a4, a0
; RV32IF-NEXT:    addi a0, a0, -1
...
; RV32IF-NEXT:  .LBB19_8: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    li a2, 0
...
; RV32IFD-NEXT:    srli a0, a0, 21
; RV32IFD-NEXT:    li a2, 1023
; RV32IFD-NEXT:    bgeu a0, a2, .LBB19_3
; RV32IFD-NEXT:  # %bb.1:
; RV32IFD-NEXT:    li a0, 0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    li a2, 0
; RV32IFD-NEXT:  .LBB19_2: # %fp-to-i-cleanup
...
; RV32IFD-NEXT:    .cfi_def_cfa_offset 0
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB19_3: # %fp-to-i-if-check.exp.size
; RV32IFD-NEXT:    .cfi_restore_state
; RV32IFD-NEXT:    lw a2, 8(sp)
; RV32IFD-NEXT:    lui a3, 256
; RV32IFD-NEXT:    addi a3, a3, -1
...
; RV32IFD-NEXT:  .LBB19_8: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    li a2, 0
...
; RV32IF-NEXT:    srli a2, a2, 21
; RV32IF-NEXT:    li a3, 1023
; RV32IF-NEXT:    bgeu a2, a3, .LBB20_13
; RV32IF-NEXT:  # %bb.1:
; RV32IF-NEXT:    li s4, 0
; RV32IF-NEXT:    li s3, 0
; RV32IF-NEXT:    li a0, 0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:  .LBB20_2: # %fp-to-i-cleanup
; RV32IF-NEXT:    beqz a1, .LBB20_4
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a2, a1, 31
; RV32IF-NEXT:    j .LBB20_5
; RV32IF-NEXT:  .LBB20_4:
; RV32IF-NEXT:    seqz a2, a0
; RV32IF-NEXT:  .LBB20_5: # %fp-to-i-cleanup
...
; RV32IF-NEXT:    bnez a3, .LBB20_7
; RV32IF-NEXT:  # %bb.6: # %fp-to-i-cleanup
; RV32IF-NEXT:    li a0, 1
; RV32IF-NEXT:  .LBB20_7: # %fp-to-i-cleanup
; RV32IF-NEXT:    and a4, a2, a1
; RV32IF-NEXT:    beqz a4, .LBB20_9
...
; RV32IF-NEXT:    and a3, a2, s3
; RV32IF-NEXT:    or a4, a0, a4
; RV32IF-NEXT:    and a0, a2, s4
; RV32IF-NEXT:    bnez a4, .LBB20_12
; RV32IF-NEXT:  # %bb.11:
...
; RV32IF-NEXT:    .cfi_def_cfa_offset 0
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB20_13: # %fp-to-i-if-check.exp.size
; RV32IF-NEXT:    .cfi_restore_state
; RV32IF-NEXT:    srai s0, a1, 31
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a4, a0
...
; RV32IF-NEXT:    li a4, 1074
; RV32IF-NEXT:    add a0, a0, a1
; RV32IF-NEXT:    bltu a4, a2, .LBB20_16
; RV32IF-NEXT:  # %bb.14: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a1, 1043
; RV32IF-NEXT:    li a4, 1075
; RV32IF-NEXT:    sub a1, a1, a2
; RV32IF-NEXT:    sub a2, a4, a2
...
; RV32IF-NEXT:    srl a5, a0, a2
; RV32IF-NEXT:    and s2, a4, a5
; RV32IF-NEXT:    bltz a1, .LBB20_17
; RV32IF-NEXT:  # %bb.15: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl s3, a0, a1
; RV32IF-NEXT:    j .LBB20_18
; RV32IF-NEXT:  .LBB20_16: # %fp-to-i-if-exp.large
; RV32IF-NEXT:    sw a3, 16(sp)
; RV32IF-NEXT:    sw a0, 20(sp)
; RV32IF-NEXT:    sw zero, 24(sp)
; RV32IF-NEXT:    sw zero, 28(sp)
...
; RV32IF-NEXT:    add a0, a1, a0
; RV32IF-NEXT:    add s8, s5, a0
; RV32IF-NEXT:    sltu s5, s8, s5
; RV32IF-NEXT:    mv a0, s2
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s0
; RV32IF-NEXT:    li a3, 0
...
; RV32IF-NEXT:    add a1, a1, s5
; RV32IF-NEXT:    add s8, a0, s8
; RV32IF-NEXT:    sltu a2, s8, a0
; RV32IF-NEXT:    add a0, s8, s6
; RV32IF-NEXT:    add a1, a1, a2
; RV32IF-NEXT:    add a1, a1, s7
; RV32IF-NEXT:    sltu a2, a0, s8
; RV32IF-NEXT:    add a1, a1, a2
; RV32IF-NEXT:    j .LBB20_2
; RV32IF-NEXT:  .LBB20_17:
; RV32IF-NEXT:    srl a1, a3, a2
; RV32IF-NEXT:    not a2, a2
; RV32IF-NEXT:    slli a0, a0, 1
; RV32IF-NEXT:    sll a0, a0, a2
; RV32IF-NEXT:    or s3, a1, a0
; RV32IF-NEXT:  .LBB20_18: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    mv a0, s3
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s1
; RV32IF-NEXT:    li a3, 0
...
; RV32IF-NEXT:    mv a1, s0
; RV32IF-NEXT:    mv a2, s3
; RV32IF-NEXT:    mv s3, s7
; RV32IF-NEXT:    mv a3, s2
; RV32IF-NEXT:    call __muldi3
; RV32IF-NEXT:    add a0, s9, a0
; RV32IF-NEXT:    sltu a2, s9, s1
; RV32IF-NEXT:    sltu a3, s8, s6
...
; RV32IFD-NEXT:    srli a0, a0, 21
; RV32IFD-NEXT:    li a2, 1023
; RV32IFD-NEXT:    bgeu a0, a2, .LBB20_13
; RV32IFD-NEXT:  # %bb.1:
; RV32IFD-NEXT:    li s4, 0
; RV32IFD-NEXT:    li s3, 0
; RV32IFD-NEXT:    li a0, 0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:  .LBB20_2: # %fp-to-i-cleanup
; RV32IFD-NEXT:    beqz a1, .LBB20_4
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32IFD-NEXT:    srli a2, a1, 31
; RV32IFD-NEXT:    j .LBB20_5
; RV32IFD-NEXT:  .LBB20_4:
; RV32IFD-NEXT:    seqz a2, a0
; RV32IFD-NEXT:  .LBB20_5: # %fp-to-i-cleanup
...
; RV32IFD-NEXT:    bnez a3, .LBB20_7
; RV32IFD-NEXT:  # %bb.6: # %fp-to-i-cleanup
; RV32IFD-NEXT:    li a0, 1
; RV32IFD-NEXT:  .LBB20_7: # %fp-to-i-cleanup
; RV32IFD-NEXT:    and a4, a2, a1
; RV32IFD-NEXT:    beqz a4, .LBB20_9
...
; RV32IFD-NEXT:    and a3, a2, s3
; RV32IFD-NEXT:    or a4, a0, a4
; RV32IFD-NEXT:    and a0, a2, s4
; RV32IFD-NEXT:    bnez a4, .LBB20_12
; RV32IFD-NEXT:  # %bb.11:
...
; RV32IFD-NEXT:    .cfi_def_cfa_offset 0
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB20_13: # %fp-to-i-if-check.exp.size
; RV32IFD-NEXT:    .cfi_restore_state
; RV32IFD-NEXT:    lw a2, 8(sp)
; RV32IFD-NEXT:    srai s0, a1, 31
; RV32IFD-NEXT:    lui a3, 256
...
; RV32IFD-NEXT:    li a3, 1074
; RV32IFD-NEXT:    add a1, a1, a4
; RV32IFD-NEXT:    bltu a3, a0, .LBB20_16
; RV32IFD-NEXT:  # %bb.14: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a3, 1043
; RV32IFD-NEXT:    li a4, 1075
; RV32IFD-NEXT:    sub a3, a3, a0
; RV32IFD-NEXT:    sub a0, a4, a0
...
; RV32IFD-NEXT:    srl a5, a1, a0
; RV32IFD-NEXT:    and s2, a4, a5
; RV32IFD-NEXT:    bltz a3, .LBB20_17
; RV32IFD-NEXT:  # %bb.15: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl s3, a1, a3
; RV32IFD-NEXT:    j .LBB20_18
; RV32IFD-NEXT:  .LBB20_16: # %fp-to-i-if-exp.large
; RV32IFD-NEXT:    sw a2, 32(sp)
; RV32IFD-NEXT:    sw a1, 36(sp)
; RV32IFD-NEXT:    sw zero, 40(sp)
; RV32IFD-NEXT:    sw zero, 44(sp)
...
; RV32IFD-NEXT:    add a0, a1, a0
; RV32IFD-NEXT:    add s8, s5, a0
; RV32IFD-NEXT:    sltu s5, s8, s5
; RV32IFD-NEXT:    mv a0, s2
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s0
; RV32IFD-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    add a1, a1, s5
; RV32IFD-NEXT:    add s8, a0, s8
; RV32IFD-NEXT:    sltu a2, s8, a0
; RV32IFD-NEXT:    add a0, s8, s6
; RV32IFD-NEXT:    add a1, a1, a2
; RV32IFD-NEXT:    add a1, a1, s7
; RV32IFD-NEXT:    sltu a2, a0, s8
; RV32IFD-NEXT:    add a1, a1, a2
; RV32IFD-NEXT:    j .LBB20_2
; RV32IFD-NEXT:  .LBB20_17:
; RV32IFD-NEXT:    srl a2, a2, a0
; RV32IFD-NEXT:    not a0, a0
; RV32IFD-NEXT:    slli a1, a1, 1
; RV32IFD-NEXT:    sll a0, a1, a0
; RV32IFD-NEXT:    or s3, a2, a0
; RV32IFD-NEXT:  .LBB20_18: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    mv a0, s3
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s1
; RV32IFD-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    mv a1, s0
; RV32IFD-NEXT:    mv a2, s3
; RV32IFD-NEXT:    mv s3, s7
; RV32IFD-NEXT:    mv a3, s2
; RV32IFD-NEXT:    call __muldi3
; RV32IFD-NEXT:    add a0, s9, a0
; RV32IFD-NEXT:    sltu a2, s9, s1
; RV32IFD-NEXT:    sltu a3, s8, s6
...
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB21_16
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li s3, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a2, 0
; RV32-NEXT:  .LBB21_2: # %fp-to-i-cleanup
; RV32-NEXT:    lui a3, 524288
; RV32-NEXT:    addi a4, a3, -1
; RV32-NEXT:    beq a1, a4, .LBB21_4
; RV32-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32-NEXT:    sltu a5, a1, a4
; RV32-NEXT:    or a6, a0, a2
; RV32-NEXT:    bnez a6, .LBB21_5
; RV32-NEXT:    j .LBB21_6
; RV32-NEXT:  .LBB21_4:
; RV32-NEXT:    sltiu a5, s3, -1
; RV32-NEXT:    or a6, a0, a2
; RV32-NEXT:    beqz a6, .LBB21_6
...
; RV32-NEXT:    or a4, a7, s3
; RV32-NEXT:    and a2, a6, a2
; RV32-NEXT:    and a5, a6, a0
; RV32-NEXT:    beq a1, a3, .LBB21_10
; RV32-NEXT:  # %bb.9: # %fp-to-i-cleanup
...
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB21_16: # %fp-to-i-if-check.exp.size
...
; RV32-NEXT:    bltu a3, a0, .LBB21_18
; RV32-NEXT:  # %bb.17: # %fp-to-i-if-exp.small
; RV32-NEXT:    li a2, 150
; RV32-NEXT:    sub a2, a2, a0
; RV32-NEXT:    srl s2, a1, a2
; RV32-NEXT:    mv a0, s2
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s1
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    j .LBB21_2
; RV32-NEXT:  .LBB21_18: # %fp-to-i-if-exp.large
...
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    mv s1, a0
; RV32-NEXT:    add s8, s4, a1
; RV32-NEXT:    sltu a0, s8, s4
...
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s4, s5, a0
; RV32-NEXT:    sltu s5, s4, s5
; RV32-NEXT:    mv a0, s2
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    srli a0, a0, 24
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB22_3
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    li a2, 0
; RV32-NEXT:  .LBB22_2: # %fp-to-i-cleanup
...
; RV32-NEXT:    and a1, a2, a1
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB22_3: # %fp-to-i-if-check.exp.size
; RV32-NEXT:    slli a1, a1, 9
; RV32-NEXT:    lui a2, 2048
; RV32-NEXT:    srli a1, a1, 9
; RV32-NEXT:    li a3, 149
...
; RV32-NEXT:    j .LBB22_2
; RV32-NEXT:  .LBB22_5: # %fp-to-i-if-exp.large
...
; RV32-NEXT:    srli a0, a0, 24
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB23_13
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li s3, 0
; RV32-NEXT:    li s5, 0
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:  .LBB23_2: # %fp-to-i-cleanup
...
; RV32-NEXT:  .LBB23_5: # %fp-to-i-cleanup
...
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB23_13: # %fp-to-i-if-check.exp.size
; RV32-NEXT:    .cfi_restore_state
; RV32-NEXT:    srai s0, a1, 31
; RV32-NEXT:    slli a1, a1, 9
; RV32-NEXT:    lui a2, 2048
...
; RV32-NEXT:    or a1, a1, a2
; RV32-NEXT:    ori s1, s0, 1
; RV32-NEXT:    bltu a3, a0, .LBB23_15
; RV32-NEXT:  # %bb.14: # %fp-to-i-if-exp.small
; RV32-NEXT:    li a2, 150
; RV32-NEXT:    sub a2, a2, a0
; RV32-NEXT:    srl s2, a1, a2
; RV32-NEXT:    mv a0, s2
...
; RV32-NEXT:    j .LBB23_2
; RV32-NEXT:  .LBB23_15: # %fp-to-i-if-exp.large
; RV32-NEXT:    addi a0, a0, -150
; RV32-NEXT:    sw a1, 24(sp)
; RV32-NEXT:    sw zero, 28(sp)
; RV32-NEXT:    sw zero, 32(sp)
...
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    call __muldi3
; RV32-NEXT:    add s5, a0, s8
; RV32-NEXT:    sltu a0, s5, a0
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    add s8, s4, a0
; RV32-NEXT:    sltu s4, s8, s4
; RV32-NEXT:    mv a0, s2
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    mv a2, s0
; RV32-NEXT:    li a3, 0
...
; RV32-NEXT:    add s8, a0, s8
; RV32-NEXT:    sltu a2, s8, a0
; RV32-NEXT:    add a0, s8, s6
; RV32-NEXT:    add a1, a1, a2
; RV32-NEXT:    add a1, a1, s7
; RV32-NEXT:    sltu a2, a0, s8
; RV32-NEXT:    add a1, a1, a2
; RV32-NEXT:    j .LBB23_2
;
...
; RV32IF-NEXT:    srli a2, a2, 21
; RV32IF-NEXT:    li a3, 1023
; RV32IF-NEXT:    bgeu a2, a3, .LBB45_16
; RV32IF-NEXT:  # %bb.1:
; RV32IF-NEXT:    li s4, 0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    li a0, 0
; RV32IF-NEXT:    li a2, 0
; RV32IF-NEXT:  .LBB45_2: # %fp-to-i-cleanup
; RV32IF-NEXT:    lui a3, 524288
; RV32IF-NEXT:    addi a4, a3, -1
; RV32IF-NEXT:    beq a1, a4, .LBB45_4
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32IF-NEXT:    sltu a5, a1, a4
; RV32IF-NEXT:    or a6, a0, a2
; RV32IF-NEXT:    bnez a6, .LBB45_5
; RV32IF-NEXT:    j .LBB45_6
; RV32IF-NEXT:  .LBB45_4:
; RV32IF-NEXT:    sltiu a5, s4, -1
; RV32IF-NEXT:    or a6, a0, a2
; RV32IF-NEXT:    beqz a6, .LBB45_6
; RV32IF-NEXT:  .LBB45_5: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a5, a2, 31
; RV32IF-NEXT:  .LBB45_6: # %fp-to-i-cleanup
; RV32IF-NEXT:    neg a6, a5
; RV32IF-NEXT:    addi a7, a5, -1
; RV32IF-NEXT:    bnez a5, .LBB45_8
; RV32IF-NEXT:  # %bb.7: # %fp-to-i-cleanup
; RV32IF-NEXT:    mv a1, a4
...
; RV32IF-NEXT:    and a2, a6, a2
; RV32IF-NEXT:    and a5, a6, a0
; RV32IF-NEXT:    beq a1, a3, .LBB45_10
; RV32IF-NEXT:  # %bb.9: # %fp-to-i-cleanup
; RV32IF-NEXT:    sltu a0, a3, a1
...
; RV32IF-NEXT:    and a5, a5, a2
; RV32IF-NEXT:    li a3, -1
; RV32IF-NEXT:    beq a5, a3, .LBB45_13
; RV32IF-NEXT:  # %bb.12: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a2, a2, 31
; RV32IF-NEXT:    xori a0, a2, 1
; RV32IF-NEXT:  .LBB45_13: # %fp-to-i-cleanup
; RV32IF-NEXT:    bnez a0, .LBB45_15
; RV32IF-NEXT:  # %bb.14: # %fp-to-i-cleanup
; RV32IF-NEXT:    lui a1, 524288
...
; RV32IF-NEXT:    .cfi_def_cfa_offset 0
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB45_16: # %fp-to-i-if-check.exp.size
; RV32IF-NEXT:    .cfi_restore_state
; RV32IF-NEXT:    srai s0, a1, 31
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a4, a0
...
; RV32IF-NEXT:    li a4, 1074
; RV32IF-NEXT:    add a0, a0, a1
; RV32IF-NEXT:    bltu a4, a2, .LBB45_19
; RV32IF-NEXT:  # %bb.17: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a1, 1043
; RV32IF-NEXT:    li a4, 1075
; RV32IF-NEXT:    sub a1, a1, a2
...
; RV32IF-NEXT:    srl a5, a0, a2
; RV32IF-NEXT:    and s2, a4, a5
; RV32IF-NEXT:    bltz a1, .LBB45_20
; RV32IF-NEXT:  # %bb.18: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl s3, a0, a1
; RV32IF-NEXT:    j .LBB45_21
; RV32IF-NEXT:  .LBB45_19: # %fp-to-i-if-exp.large
; RV32IF-NEXT:    sw a3, 16(sp)
; RV32IF-NEXT:    sw a0, 20(sp)
; RV32IF-NEXT:    sw zero, 24(sp)
; RV32IF-NEXT:    sw zero, 28(sp)
...
; RV32IF-NEXT:    sltu a3, a0, s3
; RV32IF-NEXT:    add a2, a2, a3
; RV32IF-NEXT:    j .LBB45_2
; RV32IF-NEXT:  .LBB45_20:
; RV32IF-NEXT:    srl a1, a3, a2
; RV32IF-NEXT:    not a2, a2
; RV32IF-NEXT:    slli a0, a0, 1
; RV32IF-NEXT:    sll a0, a0, a2
; RV32IF-NEXT:    or s3, a1, a0
; RV32IF-NEXT:  .LBB45_21: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    mv a0, s3
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s1
; RV32IF-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    srli a0, a0, 21
; RV32IFD-NEXT:    li a2, 1023
; RV32IFD-NEXT:    bgeu a0, a2, .LBB45_16
; RV32IFD-NEXT:  # %bb.1:
; RV32IFD-NEXT:    li s4, 0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    li a0, 0
; RV32IFD-NEXT:    li a2, 0
; RV32IFD-NEXT:  .LBB45_2: # %fp-to-i-cleanup
; RV32IFD-NEXT:    lui a3, 524288
; RV32IFD-NEXT:    addi a4, a3, -1
; RV32IFD-NEXT:    beq a1, a4, .LBB45_4
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32IFD-NEXT:    sltu a5, a1, a4
; RV32IFD-NEXT:    or a6, a0, a2
; RV32IFD-NEXT:    bnez a6, .LBB45_5
; RV32IFD-NEXT:    j .LBB45_6
; RV32IFD-NEXT:  .LBB45_4:
; RV32IFD-NEXT:    sltiu a5, s4, -1
; RV32IFD-NEXT:    or a6, a0, a2
; RV32IFD-NEXT:    beqz a6, .LBB45_6
; RV32IFD-NEXT:  .LBB45_5: # %fp-to-i-cleanup
; RV32IFD-NEXT:    srli a5, a2, 31
; RV32IFD-NEXT:  .LBB45_6: # %fp-to-i-cleanup
; RV32IFD-NEXT:    neg a6, a5
; RV32IFD-NEXT:    addi a7, a5, -1
; RV32IFD-NEXT:    bnez a5, .LBB45_8
; RV32IFD-NEXT:  # %bb.7: # %fp-to-i-cleanup
; RV32IFD-NEXT:    mv a1, a4
...
; RV32IFD-NEXT:    and a2, a6, a2
; RV32IFD-NEXT:    and a5, a6, a0
; RV32IFD-NEXT:    beq a1, a3, .LBB45_10
; RV32IFD-NEXT:  # %bb.9: # %fp-to-i-cleanup
; RV32IFD-NEXT:    sltu a0, a3, a1
...
; RV32IFD-NEXT:    and a5, a5, a2
; RV32IFD-NEXT:    li a3, -1
; RV32IFD-NEXT:    beq a5, a3, .LBB45_13
; RV32IFD-NEXT:  # %bb.12: # %fp-to-i-cleanup
; RV32IFD-NEXT:    srli a2, a2, 31
; RV32IFD-NEXT:    xori a0, a2, 1
; RV32IFD-NEXT:  .LBB45_13: # %fp-to-i-cleanup
; RV32IFD-NEXT:    bnez a0, .LBB45_15
; RV32IFD-NEXT:  # %bb.14: # %fp-to-i-cleanup
; RV32IFD-NEXT:    lui a1, 524288
...
; RV32IFD-NEXT:    .cfi_def_cfa_offset 0
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB45_16: # %fp-to-i-if-check.exp.size
; RV32IFD-NEXT:    .cfi_restore_state
; RV32IFD-NEXT:    lw a2, 8(sp)
; RV32IFD-NEXT:    srai s0, a1, 31
; RV32IFD-NEXT:    lui a3, 256
...
; RV32IFD-NEXT:    li a3, 1074
; RV32IFD-NEXT:    add a1, a1, a4
; RV32IFD-NEXT:    bltu a3, a0, .LBB45_19
; RV32IFD-NEXT:  # %bb.17: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a3, 1043
; RV32IFD-NEXT:    li a4, 1075
; RV32IFD-NEXT:    sub a3, a3, a0
...
; RV32IFD-NEXT:    srl a5, a1, a0
; RV32IFD-NEXT:    and s2, a4, a5
; RV32IFD-NEXT:    bltz a3, .LBB45_20
; RV32IFD-NEXT:  # %bb.18: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl s3, a1, a3
; RV32IFD-NEXT:    j .LBB45_21
; RV32IFD-NEXT:  .LBB45_19: # %fp-to-i-if-exp.large
; RV32IFD-NEXT:    sw a2, 32(sp)
; RV32IFD-NEXT:    sw a1, 36(sp)
; RV32IFD-NEXT:    sw zero, 40(sp)
; RV32IFD-NEXT:    sw zero, 44(sp)
...
; RV32IFD-NEXT:    sltu a3, a0, s3
; RV32IFD-NEXT:    add a2, a2, a3
; RV32IFD-NEXT:    j .LBB45_2
; RV32IFD-NEXT:  .LBB45_20:
; RV32IFD-NEXT:    srl a2, a2, a0
; RV32IFD-NEXT:    not a0, a0
; RV32IFD-NEXT:    slli a1, a1, 1
; RV32IFD-NEXT:    sll a0, a1, a0
; RV32IFD-NEXT:    or s3, a2, a0
; RV32IFD-NEXT:  .LBB45_21: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    mv a0, s3
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s1
; RV32IFD-NEXT:    li a3, 0
...
; RV32IF-NEXT:    srli a2, a2, 21
; RV32IF-NEXT:    li a3, 1023
; RV32IF-NEXT:    bgeu a2, a3, .LBB46_3
; RV32IF-NEXT:  # %bb.1:
; RV32IF-NEXT:    li a0, 0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    li a2, 0
; RV32IF-NEXT:  .LBB46_2: # %fp-to-i-cleanup
; RV32IF-NEXT:    or a4, a2, a3
; RV32IF-NEXT:    xori a3, a3, 1
; RV32IF-NEXT:    seqz a4, a4
; RV32IF-NEXT:    or a2, a3, a2
...
; RV32IF-NEXT:    and a1, a2, a1
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB46_3: # %fp-to-i-if-check.exp.size
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a4, a0
; RV32IF-NEXT:    addi a0, a0, -1
; RV32IF-NEXT:    addi a3, a3, -1
...
; RV32IF-NEXT:    sub a4, a4, a2
; RV32IF-NEXT:    sub a5, a5, a2
; RV32IF-NEXT:    bltz a4, .LBB46_7
; RV32IF-NEXT:  # %bb.5: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl a0, a1, a4
; RV32IF-NEXT:    j .LBB46_8
; RV32IF-NEXT:  .LBB46_6: # %fp-to-i-if-exp.large
; RV32IF-NEXT:    addi sp, sp, -32
; RV32IF-NEXT:    .cfi_def_cfa_offset 32
; RV32IF-NEXT:    sw a0, 16(sp)
; RV32IF-NEXT:    sw a1, 20(sp)
...
; RV32IF-NEXT:    sll a2, a3, a2
; RV32IF-NEXT:    or a0, a0, a2
; RV32IF-NEXT:  .LBB46_8: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    li a2, 0
; RV32IF-NEXT:    srl a1, a1, a5
; RV32IF-NEXT:    srai a4, a4, 31
...
; RV32IFD-NEXT:    srli a0, a0, 21
; RV32IFD-NEXT:    li a2, 1023
; RV32IFD-NEXT:    bgeu a0, a2, .LBB46_3
; RV32IFD-NEXT:  # %bb.1:
; RV32IFD-NEXT:    li a0, 0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    li a2, 0
; RV32IFD-NEXT:  .LBB46_2: # %fp-to-i-cleanup
; RV32IFD-NEXT:    or a4, a2, a3
; RV32IFD-NEXT:    xori a3, a3, 1
; RV32IFD-NEXT:    seqz a4, a4
; RV32IFD-NEXT:    or a2, a3, a2
...
; RV32IFD-NEXT:    .cfi_def_cfa_offset 0
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB46_3: # %fp-to-i-if-check.exp.size
; RV32IFD-NEXT:    .cfi_restore_state
; RV32IFD-NEXT:    lw a2, 8(sp)
; RV32IFD-NEXT:    lui a3, 256
; RV32IFD-NEXT:    addi a3, a3, -1
...
; RV32IFD-NEXT:    sub a4, a4, a0
; RV32IFD-NEXT:    sub a5, a5, a0
; RV32IFD-NEXT:    bltz a4, .LBB46_7
; RV32IFD-NEXT:  # %bb.5: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl a0, a1, a4
; RV32IFD-NEXT:    j .LBB46_8
; RV32IFD-NEXT:  .LBB46_6: # %fp-to-i-if-exp.large
; RV32IFD-NEXT:    sw a2, 32(sp)
; RV32IFD-NEXT:    sw a1, 36(sp)
; RV32IFD-NEXT:    sw zero, 40(sp)
; RV32IFD-NEXT:    sw zero, 44(sp)
...
; RV32IFD-NEXT:    or a1, a4, t0
; RV32IFD-NEXT:    sll a0, a6, a0
; RV32IFD-NEXT:    j .LBB46_2
; RV32IFD-NEXT:  .LBB46_7:
; RV32IFD-NEXT:    srl a0, a2, a5
; RV32IFD-NEXT:    not a2, a5
; RV32IFD-NEXT:    slli a3, a1, 1
; RV32IFD-NEXT:    sll a2, a3, a2
; RV32IFD-NEXT:    or a0, a0, a2
; RV32IFD-NEXT:  .LBB46_8: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    li a2, 0
; RV32IFD-NEXT:    srl a1, a1, a5
; RV32IFD-NEXT:    srai a4, a4, 31
...
; RV32IF-NEXT:    srli a2, a2, 21
; RV32IF-NEXT:    li a3, 1023
; RV32IF-NEXT:    bgeu a2, a3, .LBB47_6
; RV32IF-NEXT:  # %bb.1:
; RV32IF-NEXT:    li s1, 0
; RV32IF-NEXT:    li s3, 0
; RV32IF-NEXT:    li a0, 0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:  .LBB47_2: # %fp-to-i-cleanup
; RV32IF-NEXT:    beqz a1, .LBB47_4
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a2, a1, 31
; RV32IF-NEXT:    j .LBB47_5
; RV32IF-NEXT:  .LBB47_4:
; RV32IF-NEXT:    seqz a2, a0
; RV32IF-NEXT:  .LBB47_5: # %fp-to-i-cleanup
...
; RV32IF-NEXT:    .cfi_def_cfa_offset 0
; RV32IF-NEXT:    ret
; RV32IF-NEXT:  .LBB47_6: # %fp-to-i-if-check.exp.size
; RV32IF-NEXT:    .cfi_restore_state
; RV32IF-NEXT:    srai s0, a1, 31
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a4, a0
...
; RV32IF-NEXT:    li a4, 1074
; RV32IF-NEXT:    add a0, a0, a1
; RV32IF-NEXT:    bltu a4, a2, .LBB47_9
; RV32IF-NEXT:  # %bb.7: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a1, 1043
; RV32IF-NEXT:    li a4, 1075
; RV32IF-NEXT:    sub a1, a1, a2
; RV32IF-NEXT:    sub a2, a4, a2
...
; RV32IF-NEXT:    srl a5, a0, a2
; RV32IF-NEXT:    and s2, a4, a5
; RV32IF-NEXT:    bltz a1, .LBB47_10
; RV32IF-NEXT:  # %bb.8: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl s3, a0, a1
; RV32IF-NEXT:    j .LBB47_11
; RV32IF-NEXT:  .LBB47_9: # %fp-to-i-if-exp.large
; RV32IF-NEXT:    sw a3, 16(sp)
; RV32IF-NEXT:    sw a0, 20(sp)
; RV32IF-NEXT:    sw zero, 24(sp)
; RV32IF-NEXT:    sw zero, 28(sp)
...
; RV32IF-NEXT:    sltu a0, s3, a0
; RV32IF-NEXT:    add a0, a1, a0
; RV32IF-NEXT:    add s4, s5, a0
; RV32IF-NEXT:    sltu s5, s4, s5
; RV32IF-NEXT:    mv a0, s2
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s0
; RV32IF-NEXT:    li a3, 0
...
; RV32IF-NEXT:    add a0, s4, s6
; RV32IF-NEXT:    add a1, a1, a2
; RV32IF-NEXT:    add a1, a1, s7
; RV32IF-NEXT:    sltu a2, a0, s4
; RV32IF-NEXT:    add a1, a1, a2
; RV32IF-NEXT:    j .LBB47_2
; RV32IF-NEXT:  .LBB47_10:
; RV32IF-NEXT:    srl a1, a3, a2
; RV32IF-NEXT:    not a2, a2
; RV32IF-NEXT:    slli a0, a0, 1
; RV32IF-NEXT:    sll a0, a0, a2
; RV32IF-NEXT:    or s3, a1, a0
; RV32IF-NEXT:  .LBB47_11: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    mv a0, s3
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv a2, s1
; RV32IF-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    srli a0, a0, 21
; RV32IFD-NEXT:    li a2, 1023
; RV32IFD-NEXT:    bgeu a0, a2, .LBB47_6
; RV32IFD-NEXT:  # %bb.1:
; RV32IFD-NEXT:    li s1, 0
; RV32IFD-NEXT:    li s3, 0
; RV32IFD-NEXT:    li a0, 0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:  .LBB47_2: # %fp-to-i-cleanup
...
; RV32IFD-NEXT:    seqz a2, a0
; RV32IFD-NEXT:  .LBB47_5: # %fp-to-i-cleanup
...
; RV32IFD-NEXT:    .cfi_def_cfa_offset 0
; RV32IFD-NEXT:    ret
; RV32IFD-NEXT:  .LBB47_6: # %fp-to-i-if-check.exp.size
; RV32IFD-NEXT:    .cfi_restore_state
; RV32IFD-NEXT:    lw a2, 8(sp)
; RV32IFD-NEXT:    srai s0, a1, 31
; RV32IFD-NEXT:    lui a3, 256
...
; RV32IFD-NEXT:    li a3, 1074
; RV32IFD-NEXT:    add a1, a1, a4
; RV32IFD-NEXT:    bltu a3, a0, .LBB47_9
; RV32IFD-NEXT:  # %bb.7: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a3, 1043
; RV32IFD-NEXT:    li a4, 1075
; RV32IFD-NEXT:    sub a3, a3, a0
; RV32IFD-NEXT:    sub a0, a4, a0
...
; RV32IFD-NEXT:    srl a5, a1, a0
; RV32IFD-NEXT:    and s2, a4, a5
; RV32IFD-NEXT:    bltz a3, .LBB47_10
; RV32IFD-NEXT:  # %bb.8: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl s3, a1, a3
; RV32IFD-NEXT:    j .LBB47_11
; RV32IFD-NEXT:  .LBB47_9: # %fp-to-i-if-exp.large
; RV32IFD-NEXT:    sw a2, 32(sp)
; RV32IFD-NEXT:    sw a1, 36(sp)
; RV32IFD-NEXT:    sw zero, 40(sp)
; RV32IFD-NEXT:    sw zero, 44(sp)
...
; RV32IFD-NEXT:    sltu a0, s3, a0
; RV32IFD-NEXT:    add a0, a1, a0
; RV32IFD-NEXT:    add s4, s5, a0
; RV32IFD-NEXT:    sltu s5, s4, s5
; RV32IFD-NEXT:    mv a0, s2
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s0
; RV32IFD-NEXT:    li a3, 0
...
; RV32IFD-NEXT:    add a0, s4, s6
; RV32IFD-NEXT:    add a1, a1, a2
; RV32IFD-NEXT:    add a1, a1, s7
; RV32IFD-NEXT:    sltu a2, a0, s4
; RV32IFD-NEXT:    add a1, a1, a2
; RV32IFD-NEXT:    j .LBB47_2
; RV32IFD-NEXT:  .LBB47_10:
; RV32IFD-NEXT:    srl a2, a2, a0
; RV32IFD-NEXT:    not a0, a0
; RV32IFD-NEXT:    slli a1, a1, 1
; RV32IFD-NEXT:    sll a0, a1, a0
; RV32IFD-NEXT:    or s3, a2, a0
; RV32IFD-NEXT:  .LBB47_11: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    mv a0, s3
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv a2, s1
; RV32IFD-NEXT:    li a3, 0
...
; RV32-NEXT:    srli a0, a0, 24
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB48_16
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li s3, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a2, 0
; RV32-NEXT:  .LBB48_2: # %fp-to-i-cleanup
; RV32-NEXT:    lui a3, 524288
; RV32-NEXT:    addi a4, a3, -1
; RV32-NEXT:    beq a1, a4, .LBB48_4
; RV32-NEXT:  # %bb.3: # %fp-to-i-cleanup
; RV32-NEXT:    sltu a5, a1, a4
; RV32-NEXT:    or a6, a0, a2
; RV32-NEXT:    bnez a6, .LBB48_5
; RV32-NEXT:    j .LBB48_6
; RV32-NEXT:  .LBB48_4:
; RV32-NEXT:    sltiu a5, s3, -1
; RV32-NEXT:    or a6, a0, a2
; RV32-NEXT:    beqz a6, .LBB48_6
...
; RV32-NEXT:    and a5, a5, a2
; RV32-NEXT:    li a3, -1
; RV32-NEXT:    beq a5, a3, .LBB48_13
; RV32-NEXT:  # %bb.12: # %fp-to-i-cleanup
; RV32-NEXT:    srli a2, a2, 31
; RV32-NEXT:    xori a0, a2, 1
; RV32-NEXT:  .LBB48_13: # %fp-to-i-cleanup
; RV32-NEXT:    bnez a0, .LBB48_15
; RV32-NEXT:  # %bb.14: # %fp-to-i-cleanup
; RV32-NEXT:    lui a1, 524288
...
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB48_16: # %fp-to-i-if-check.exp.size
; RV32-NEXT:    .cfi_restore_state
; RV32-NEXT:    srai s0, a1, 31
; RV32-NEXT:    slli a1, a1, 9
; RV32-NEXT:    lui a2, 2048
...
; RV32-NEXT:    add a2, a2, a5
; RV32-NEXT:    j .LBB48_2
; RV32-NEXT:  .LBB48_18: # %fp-to-i-if-exp.large
; RV32-NEXT:    addi a0, a0, -150
; RV32-NEXT:    sw a1, 24(sp)
; RV32-NEXT:    sw zero, 28(sp)
; RV32-NEXT:    sw zero, 32(sp)
...
; RV32-NEXT:    srli a0, a0, 24
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB49_3
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:    li a3, 0
; RV32-NEXT:    li a2, 0
; RV32-NEXT:  .LBB49_2: # %fp-to-i-cleanup
; RV32-NEXT:    or a4, a2, a3
; RV32-NEXT:    xori a3, a3, 1
; RV32-NEXT:    seqz a4, a4
; RV32-NEXT:    or a2, a3, a2
...
; RV32-NEXT:    and a1, a2, a1
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB49_3: # %fp-to-i-if-check.exp.size
; RV32-NEXT:    slli a1, a1, 9
; RV32-NEXT:    lui a2, 2048
; RV32-NEXT:    srli a1, a1, 9
; RV32-NEXT:    li a3, 149
...
; RV32-NEXT:    srl a0, a4, a5
; RV32-NEXT:    j .LBB49_2
; RV32-NEXT:  .LBB49_5: # %fp-to-i-if-exp.large
; RV32-NEXT:    addi sp, sp, -32
; RV32-NEXT:    .cfi_def_cfa_offset 32
; RV32-NEXT:    addi a0, a0, -150
; RV32-NEXT:    sw a4, 16(sp)
...
; RV32-NEXT:    srli a0, a0, 24
; RV32-NEXT:    li a2, 127
; RV32-NEXT:    bgeu a0, a2, .LBB50_6
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    li s3, 0
; RV32-NEXT:    li s5, 0
; RV32-NEXT:    li a0, 0
; RV32-NEXT:    li a1, 0
; RV32-NEXT:  .LBB50_2: # %fp-to-i-cleanup
...
; RV32-NEXT:  .LBB50_4:
; RV32-NEXT:    seqz a2, a0
; RV32-NEXT:  .LBB50_5: # %fp-to-i-cleanup
...
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB50_6: # %fp-to-i-if-check.exp.size
; RV32-NEXT:    .cfi_restore_state
; RV32-NEXT:    srai s0, a1, 31
; RV32-NEXT:    slli a1, a1, 9
; RV32-NEXT:    lui a2, 2048
...
; RV32-NEXT:    or a1, a1, a2
; RV32-NEXT:    ori s1, s0, 1
; RV32-NEXT:    bltu a3, a0, .LBB50_8
; RV32-NEXT:  # %bb.7: # %fp-to-i-if-exp.small
; RV32-NEXT:    li a2, 150
; RV32-NEXT:    sub a2, a2, a0
; RV32-NEXT:    srl s2, a1, a2
; RV32-NEXT:    mv a0, s2
...
; RV32-NEXT:    add a1, a1, a4
; RV32-NEXT:    j .LBB50_2
; RV32-NEXT:  .LBB50_8: # %fp-to-i-if-exp.large
; RV32-NEXT:    addi a0, a0, -150
; RV32-NEXT:    sw a1, 24(sp)
; RV32-NEXT:    sw zero, 28(sp)
; RV32-NEXT:    sw zero, 32(sp)
