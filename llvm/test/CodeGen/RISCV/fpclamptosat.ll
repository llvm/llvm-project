...
; RV32IF-NEXT:    srai s1, a1, 31
; RV32IF-NEXT:    lui a3, 256
; RV32IF-NEXT:    snez a6, a0
; RV32IF-NEXT:    addi a0, a0, -1
; RV32IF-NEXT:    ori s3, s1, 1
; RV32IF-NEXT:    addi a7, a3, -1
; RV32IF-NEXT:    addi a3, a0, 1
; RV32IF-NEXT:    and a0, a1, a7
; RV32IF-NEXT:    add a0, a0, a6
; RV32IF-NEXT:    seqz a5, a3
; RV32IF-NEXT:    add a5, a5, a7
; RV32IF-NEXT:    li a6, 1074
; RV32IF-NEXT:    add a0, a0, a5
; RV32IF-NEXT:    bltu a6, a2, .LBB18_5
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a5, 1043
; RV32IF-NEXT:    li a6, 1075
; RV32IF-NEXT:    sub a5, a5, a2
; RV32IF-NEXT:    sub a2, a6, a2
; RV32IF-NEXT:    srai a6, a5, 31
; RV32IF-NEXT:    srl a7, a0, a2
; RV32IF-NEXT:    and s4, a6, a7
; RV32IF-NEXT:    mv s5, s1
; RV32IF-NEXT:    bltz a5, .LBB18_6
; RV32IF-NEXT:  # %bb.4: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    srl s0, a0, a5
...
; RV32IF-NEXT:    addi a2, sp, 16
; RV32IF-NEXT:    srli a3, a0, 3
; RV32IF-NEXT:    andi a5, a0, 31
; RV32IF-NEXT:    andi a3, a3, 12
; RV32IF-NEXT:    xori a5, a5, 31
; RV32IF-NEXT:    sub a2, a2, a3
; RV32IF-NEXT:    lw a6, 0(a2)
; RV32IF-NEXT:    lw a3, 4(a2)
; RV32IF-NEXT:    lw a7, 8(a2)
; RV32IF-NEXT:    lw a2, 12(a2)
; RV32IF-NEXT:    srli t0, a6, 1
; RV32IF-NEXT:    srli t1, a3, 1
; RV32IF-NEXT:    srli t2, a7, 1
; RV32IF-NEXT:    srl t0, t0, a5
; RV32IF-NEXT:    srl t1, t1, a5
; RV32IF-NEXT:    srl a5, t2, a5
; RV32IF-NEXT:    sll a3, a3, a0
; RV32IF-NEXT:    sll a7, a7, a0
; RV32IF-NEXT:    sll t2, a2, a0
; RV32IF-NEXT:    or s0, a3, t0
; RV32IF-NEXT:    or a2, a7, t1
; RV32IF-NEXT:    or a3, t2, a5
; RV32IF-NEXT:    sll s2, a6, a0
...
; RV32IF-NEXT:    sll s0, a0, a2
; RV32IF-NEXT:    or s0, a1, s0
; RV32IF-NEXT:  .LBB18_7: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    mv a0, s0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv s1, s3
; RV32IF-NEXT:    mv a2, s3
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    call __muldi3
...
; RV32IF-NEXT:    mv a0, s0
; RV32IF-NEXT:    li a1, 0
; RV32IF-NEXT:    mv s1, s5
; RV32IF-NEXT:    mv a2, s5
; RV32IF-NEXT:    li a3, 0
; RV32IF-NEXT:    call __muldi3
; RV32IF-NEXT:    add s7, a0, s3
...
; RV32IF-NEXT:    beq a1, a3, .LBB18_16
...
; RV32IF-NEXT:    li a3, -1
; RV32IF-NEXT:    beq a5, a3, .LBB18_19
...
; RV32IFD-NEXT:    srai s1, a2, 31
; RV32IFD-NEXT:    lui a5, 256
; RV32IFD-NEXT:    ori s3, s1, 1
; RV32IFD-NEXT:    addi a5, a5, -1
; RV32IFD-NEXT:    and a2, a2, a5
; RV32IFD-NEXT:    snez a6, a3
; RV32IFD-NEXT:    addi a3, a3, -1
; RV32IFD-NEXT:    add a2, a2, a6
; RV32IFD-NEXT:    addi a3, a3, 1
; RV32IFD-NEXT:    seqz a6, a3
; RV32IFD-NEXT:    add a2, a2, a5
; RV32IFD-NEXT:    li a5, 1074
; RV32IFD-NEXT:    add a2, a2, a6
; RV32IFD-NEXT:    bltu a5, a0, .LBB18_5
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a5, 1043
; RV32IFD-NEXT:    li a6, 1075
; RV32IFD-NEXT:    sub a5, a5, a0
; RV32IFD-NEXT:    sub a0, a6, a0
; RV32IFD-NEXT:    srai a6, a5, 31
; RV32IFD-NEXT:    srl a7, a2, a0
; RV32IFD-NEXT:    and s4, a6, a7
; RV32IFD-NEXT:    mv s5, s1
; RV32IFD-NEXT:    bltz a5, .LBB18_6
; RV32IFD-NEXT:  # %bb.4: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    srl s0, a2, a5
; RV32IFD-NEXT:    j .LBB18_7
; RV32IFD-NEXT:  .LBB18_5: # %fp-to-i-if-exp.large
; RV32IFD-NEXT:    sw a3, 32(sp)
; RV32IFD-NEXT:    sw a2, 36(sp)
...
; RV32IFD-NEXT:    addi a2, sp, 32
; RV32IFD-NEXT:    srli a3, a0, 3
; RV32IFD-NEXT:    andi a5, a0, 31
; RV32IFD-NEXT:    andi a3, a3, 12
; RV32IFD-NEXT:    xori a5, a5, 31
; RV32IFD-NEXT:    sub a2, a2, a3
; RV32IFD-NEXT:    lw a6, 0(a2)
; RV32IFD-NEXT:    lw a3, 4(a2)
; RV32IFD-NEXT:    lw a7, 8(a2)
; RV32IFD-NEXT:    lw a2, 12(a2)
; RV32IFD-NEXT:    srli t0, a6, 1
; RV32IFD-NEXT:    srli t1, a3, 1
; RV32IFD-NEXT:    srli t2, a7, 1
; RV32IFD-NEXT:    srl t0, t0, a5
; RV32IFD-NEXT:    srl t1, t1, a5
; RV32IFD-NEXT:    srl a5, t2, a5
; RV32IFD-NEXT:    sll a3, a3, a0
; RV32IFD-NEXT:    sll a7, a7, a0
; RV32IFD-NEXT:    sll t2, a2, a0
; RV32IFD-NEXT:    or s0, a3, t0
; RV32IFD-NEXT:    or a2, a7, t1
; RV32IFD-NEXT:    or a3, t2, a5
; RV32IFD-NEXT:    sll s2, a6, a0
...
; RV32IFD-NEXT:    srl a1, a3, a0
; RV32IFD-NEXT:    not a0, a0
; RV32IFD-NEXT:    slli a2, a2, 1
; RV32IFD-NEXT:    sll s0, a2, a0
; RV32IFD-NEXT:    or s0, a1, s0
; RV32IFD-NEXT:  .LBB18_7: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    mv a0, s0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv s1, s3
; RV32IFD-NEXT:    mv a2, s3
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    call __muldi3
...
; RV32IFD-NEXT:    mv a0, s0
; RV32IFD-NEXT:    li a1, 0
; RV32IFD-NEXT:    mv s1, s5
; RV32IFD-NEXT:    mv a2, s5
; RV32IFD-NEXT:    li a3, 0
; RV32IFD-NEXT:    call __muldi3
; RV32IFD-NEXT:    add s7, a0, s3
...
; RV32IFD-NEXT:    beq a1, a3, .LBB18_16
...
; RV32IFD-NEXT:    beq a5, a3, .LBB18_19
...
; RV32IF-NEXT:    li a6, 1074
; RV32IF-NEXT:    add a0, a0, a5
; RV32IF-NEXT:    bltu a6, a2, .LBB20_5
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a5, 1043
; RV32IF-NEXT:    li a6, 1075
; RV32IF-NEXT:    sub a5, a5, a2
...
; RV32IFD-NEXT:    li a5, 1074
; RV32IFD-NEXT:    add a2, a2, a6
; RV32IFD-NEXT:    bltu a5, a0, .LBB20_5
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a5, 1043
; RV32IFD-NEXT:    li a6, 1075
; RV32IFD-NEXT:    sub a5, a5, a0
...
; RV32IF-NEXT:    li a6, 1074
; RV32IF-NEXT:    add a0, a0, a5
; RV32IF-NEXT:    bltu a6, a2, .LBB45_5
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a5, 1043
; RV32IF-NEXT:    li a6, 1075
; RV32IF-NEXT:    sub a5, a5, a2
...
; RV32IF-NEXT:    lui a3, 524288
; RV32IF-NEXT:    addi a4, a3, -1
; RV32IF-NEXT:    beq a1, a4, .LBB45_10
; RV32IF-NEXT:  # %bb.9: # %fp-to-i-cleanup
; RV32IF-NEXT:    sltu a5, a1, a4
; RV32IF-NEXT:    or a6, a0, a2
; RV32IF-NEXT:    bnez a6, .LBB45_11
; RV32IF-NEXT:    j .LBB45_12
; RV32IF-NEXT:  .LBB45_10:
; RV32IF-NEXT:    sltiu a5, s2, -1
; RV32IF-NEXT:    or a6, a0, a2
; RV32IF-NEXT:    beqz a6, .LBB45_12
; RV32IF-NEXT:  .LBB45_11: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a5, a2, 31
; RV32IF-NEXT:  .LBB45_12: # %fp-to-i-cleanup
; RV32IF-NEXT:    neg a6, a5
; RV32IF-NEXT:    addi a7, a5, -1
; RV32IF-NEXT:    bnez a5, .LBB45_14
; RV32IF-NEXT:  # %bb.13: # %fp-to-i-cleanup
; RV32IF-NEXT:    mv a1, a4
...
; RV32IF-NEXT:    and a2, a6, a2
; RV32IF-NEXT:    and a5, a6, a0
; RV32IF-NEXT:    beq a1, a3, .LBB45_16
; RV32IF-NEXT:  # %bb.15: # %fp-to-i-cleanup
; RV32IF-NEXT:    sltu a0, a3, a1
...
; RV32IF-NEXT:    and a5, a5, a2
; RV32IF-NEXT:    li a3, -1
; RV32IF-NEXT:    beq a5, a3, .LBB45_19
; RV32IF-NEXT:  # %bb.18: # %fp-to-i-cleanup
; RV32IF-NEXT:    srli a2, a2, 31
; RV32IF-NEXT:    xori a0, a2, 1
...
; RV32IFD-NEXT:    li a5, 1074
; RV32IFD-NEXT:    add a2, a2, a6
; RV32IFD-NEXT:    bltu a5, a0, .LBB45_5
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a5, 1043
; RV32IFD-NEXT:    li a6, 1075
; RV32IFD-NEXT:    sub a5, a5, a0
...
; RV32IFD-NEXT:    lui a3, 524288
; RV32IFD-NEXT:    addi a4, a3, -1
; RV32IFD-NEXT:    beq a1, a4, .LBB45_10
; RV32IFD-NEXT:  # %bb.9: # %fp-to-i-cleanup
; RV32IFD-NEXT:    sltu a5, a1, a4
; RV32IFD-NEXT:    or a6, a0, a2
; RV32IFD-NEXT:    bnez a6, .LBB45_11
; RV32IFD-NEXT:    j .LBB45_12
; RV32IFD-NEXT:  .LBB45_10:
; RV32IFD-NEXT:    sltiu a5, s2, -1
; RV32IFD-NEXT:    or a6, a0, a2
; RV32IFD-NEXT:    beqz a6, .LBB45_12
; RV32IFD-NEXT:  .LBB45_11: # %fp-to-i-cleanup
; RV32IFD-NEXT:    srli a5, a2, 31
; RV32IFD-NEXT:  .LBB45_12: # %fp-to-i-cleanup
; RV32IFD-NEXT:    neg a6, a5
; RV32IFD-NEXT:    addi a7, a5, -1
; RV32IFD-NEXT:    bnez a5, .LBB45_14
; RV32IFD-NEXT:  # %bb.13: # %fp-to-i-cleanup
; RV32IFD-NEXT:    mv a1, a4
...
; RV32IFD-NEXT:    and a2, a6, a2
; RV32IFD-NEXT:    and a5, a6, a0
; RV32IFD-NEXT:    beq a1, a3, .LBB45_16
; RV32IFD-NEXT:  # %bb.15: # %fp-to-i-cleanup
; RV32IFD-NEXT:    sltu a0, a3, a1
...
; RV32IFD-NEXT:    and a5, a5, a2
; RV32IFD-NEXT:    li a3, -1
; RV32IFD-NEXT:    beq a5, a3, .LBB45_19
; RV32IFD-NEXT:  # %bb.18: # %fp-to-i-cleanup
; RV32IFD-NEXT:    srli a2, a2, 31
; RV32IFD-NEXT:    xori a0, a2, 1
...
; RV32IF-NEXT:    li a6, 1074
; RV32IF-NEXT:    add a0, a0, a5
; RV32IF-NEXT:    bltu a6, a2, .LBB47_5
; RV32IF-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IF-NEXT:    li a5, 1043
; RV32IF-NEXT:    li a6, 1075
; RV32IF-NEXT:    sub a5, a5, a2
...
; RV32IFD-NEXT:    li a5, 1074
; RV32IFD-NEXT:    add a2, a2, a6
; RV32IFD-NEXT:    bltu a5, a0, .LBB47_5
; RV32IFD-NEXT:  # %bb.3: # %fp-to-i-if-exp.small
; RV32IFD-NEXT:    li a5, 1043
; RV32IFD-NEXT:    li a6, 1075
; RV32IFD-NEXT:    sub a5, a5, a0
...
; RV32-NEXT:    lui a3, 524288
; RV32-NEXT:    addi a4, a3, -1
; RV32-NEXT:    beq a1, a4, .LBB48_7
; RV32-NEXT:  # %bb.6: # %fp-to-i-cleanup
; RV32-NEXT:    sltu a5, a1, a4
; RV32-NEXT:    or a6, a0, a2
; RV32-NEXT:    bnez a6, .LBB48_8
; RV32-NEXT:    j .LBB48_9
; RV32-NEXT:  .LBB48_7:
; RV32-NEXT:    sltiu a5, s3, -1
; RV32-NEXT:    or a6, a0, a2
