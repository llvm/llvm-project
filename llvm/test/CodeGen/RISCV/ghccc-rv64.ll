...
; CHECK-NEXT:    ld s1, %lo(base)(a6)
; CHECK-NEXT:    ld s3, %lo(hp)(a5)
; CHECK-NEXT:    ld s2, %lo(sp)(a7)
; CHECK-NEXT:    ld s5, %lo(r2)(a3)
; CHECK-NEXT:    ld s4, %lo(r1)(a4)
; CHECK-NEXT:    ld s7, %lo(r4)(a1)
; CHECK-NEXT:    ld s6, %lo(r3)(a2)
