...
; CHECKRV64D:       # %bb.0: # %entry
; CHECKRV64D-NEXT:    li a0, 1023
; CHECKRV64D-NEXT:    slli a0, a0, 52
; CHECKRV64D-NEXT:    fmv.d.x fa5, a0
; CHECKRV64D-NEXT:    flt.d a0, fa5, fa0
; CHECKRV64D-NEXT:    bnez a0, .LBB20_3
; CHECKRV64D-NEXT:  # %bb.1: # %entry
; CHECKRV64D-NEXT:    fmv.d.x fa5, zero
; CHECKRV64D-NEXT:    flt.d a0, fa0, fa5
; CHECKRV64D-NEXT:    bnez a0, .LBB20_3
; CHECKRV64D-NEXT:  # %bb.2: # %entry
; CHECKRV64D-NEXT:    fmv.d fa5, fa0
; CHECKRV64D-NEXT:  .LBB20_3: # %entry
; CHECKRV64D-NEXT:    fmv.d fa0, fa5
; CHECKRV64D-NEXT:    ret
;
