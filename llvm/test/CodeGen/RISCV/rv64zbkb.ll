...
; RUN: llc -mtriple=riscv64 -mattr=+m,+zbkb -verify-machineinstrs < %s \
...
; The 0x0101010101010101 can be materialized with lui+addi+pack
...
; RV64ZBKB:       # %bb.0:
; RV64ZBKB-NEXT:    lui a1, %hi(.LCPI33_0)
; RV64ZBKB-NEXT:    ld a1, %lo(.LCPI33_0)(a1)
; RV64ZBKB-NEXT:    lui a2, 65664
; RV64ZBKB-NEXT:    addi a2, a2, 1024
; RV64ZBKB-NEXT:    slli a3, a2, 27
; RV64ZBKB-NEXT:    and a0, a0, a1
; RV64ZBKB-NEXT:    add a2, a2, a3
; RV64ZBKB-NEXT:    mul a0, a0, a2
; RV64ZBKB-NEXT:    ret
