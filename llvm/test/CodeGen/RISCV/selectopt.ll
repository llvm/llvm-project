...
; NO-SELECT-OPT-NEXT:    [[DIV:%.*]] = sdiv i32 [[TMP0]], [[TMP1]]
; NO-SELECT-OPT-NEXT:    [[DIV1:%.*]] = sdiv i32 [[DIV]], [[TMP1]]
; NO-SELECT-OPT-NEXT:    [[DIV2:%.*]] = sdiv i32 [[DIV1]], [[TMP1]]
; NO-SELECT-OPT-NEXT:    [[CMP5:%.*]] = icmp sgt i32 [[DIV2]], 0
; NO-SELECT-OPT-NEXT:    [[CONV:%.*]] = zext i1 [[CMP5]] to i32
; NO-SELECT-OPT-NEXT:    [[OR1:%.*]] = or i32 [[CONV]], [[ADD]]
; NO-SELECT-OPT-NEXT:    [[OR:%.*]] = add i32 [[OR1]], 1
...
; SELECT-OPT-NEXT:    [[DIV:%.*]] = sdiv i32 [[TMP0]], [[TMP1]]
; SELECT-OPT-NEXT:    [[DIV1:%.*]] = sdiv i32 [[DIV]], [[TMP1]]
; SELECT-OPT-NEXT:    [[DIV2:%.*]] = sdiv i32 [[DIV1]], [[TMP1]]
; SELECT-OPT-NEXT:    [[CMP5:%.*]] = icmp sgt i32 [[DIV2]], 0
; SELECT-OPT-NEXT:    [[CONV:%.*]] = zext i1 [[CMP5]] to i32
; SELECT-OPT-NEXT:    [[OR1:%.*]] = or i32 [[CONV]], [[ADD]]
; SELECT-OPT-NEXT:    [[OR:%.*]] = add i32 [[OR1]], 1
; SELECT-OPT-NEXT:    br label [[IF_END]]
; SELECT-OPT:       if.end:
; SELECT-OPT-NEXT:    [[Y_1]] = phi i32 [ [[OR]], [[IF_THEN]] ], [ 0, [[FOR_BODY]] ]
