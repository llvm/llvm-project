...
; RV32IM-NEXT:    mulhu a2, a0, a2
; RV32IM-NEXT:    slli a3, a1, 8
; RV32IM-NEXT:    slli a1, a1, 12
; RV32IM-NEXT:    add a1, a1, a3
; RV32IM-NEXT:    slli a3, a0, 8
; RV32IM-NEXT:    slli a0, a0, 12
; RV32IM-NEXT:    add a1, a2, a1
; RV32IM-NEXT:    add a0, a0, a3
; RV32IM-NEXT:    ret
...
; RV32I-NEXT:    slli a2, a4, 12
; RV32I-NEXT:    srli a7, a3, 24
; RV32I-NEXT:    slli t0, a4, 8
; RV32I-NEXT:    srli t1, a4, 20
; RV32I-NEXT:    or a1, a2, a1
; RV32I-NEXT:    slli t2, a5, 12
; RV32I-NEXT:    or a2, t0, a7
; RV32I-NEXT:    srli a4, a4, 24
; RV32I-NEXT:    sltu t3, a2, a1
; RV32I-NEXT:    slli a5, a5, 8
; RV32I-NEXT:    or a7, t2, t1
; RV32I-NEXT:    or a4, a5, a4
; RV32I-NEXT:    srli a5, a6, 20
; RV32I-NEXT:    slli t0, a3, 12
; RV32I-NEXT:    sub t1, a4, a7
; RV32I-NEXT:    or a4, t0, a5
; RV32I-NEXT:    srli a7, a6, 24
; RV32I-NEXT:    slli t0, a3, 8
; RV32I-NEXT:    slli a3, a6, 12
; RV32I-NEXT:    slli a5, a6, 8
; RV32I-NEXT:    or t0, t0, a7
; RV32I-NEXT:    sltu a7, a5, a3
; RV32I-NEXT:    sub a6, t1, t3
; RV32I-NEXT:    mv t1, a7
; RV32I-NEXT:    beq t0, a4, .LBB43_2
; RV32I-NEXT:  # %bb.1:
; RV32I-NEXT:    sltu t1, t0, a4
; RV32I-NEXT:  .LBB43_2:
; RV32I-NEXT:    sub a2, a2, a1
; RV32I-NEXT:    sub a1, t0, a4
...
; RV64I:       # %bb.0:
; RV64I-NEXT:    srli a2, a0, 58
; RV64I-NEXT:    slli a3, a1, 6
; RV64I-NEXT:    slli a4, a0, 6
; RV64I-NEXT:    or a2, a3, a2
; RV64I-NEXT:    sltu a3, a0, a4
; RV64I-NEXT:    sub a1, a1, a2
...
; RV32I-NEXT:    and s4, a1, s10
; RV32I-NEXT:    mv s0, a1
; RV32I-NEXT:    sw a1, 20(sp) # 4-byte Folded Spill
; RV32I-NEXT:    and s8, a2, s10
; RV32I-NEXT:    mv a0, s4
; RV32I-NEXT:    mv a1, s8
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    and s11, a0, s10
...
; RV32I-NEXT:    and s0, s3, s10
; RV32I-NEXT:    srli s9, s6, 16
; RV32I-NEXT:    mv a0, s4
; RV32I-NEXT:    mv a1, s9
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    and s7, s1, s10
...
; RV32I-NEXT:    add a0, a0, s8
; RV32I-NEXT:    add s1, s11, a0
; RV32I-NEXT:    sltu s11, s1, s11
; RV32I-NEXT:    srli s0, s0, 16
; RV32I-NEXT:    lw s2, 12(sp) # 4-byte Folded Reload
; RV32I-NEXT:    mv a0, s2
; RV32I-NEXT:    mv a1, s9
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    and s8, s5, s10
; RV32I-NEXT:    add a0, a0, s3
; RV32I-NEXT:    add a0, a0, s0
; RV32I-NEXT:    add s9, a0, s11
; RV32I-NEXT:    mv a0, s7
; RV32I-NEXT:    mv a1, s8
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    and s0, a0, s10
; RV32I-NEXT:    srli s3, a0, 16
; RV32I-NEXT:    mv a0, s6
; RV32I-NEXT:    mv a1, s8
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    add s3, a0, s3
; RV32I-NEXT:    and s11, s3, s10
...
; RV32I-NEXT:    and s1, s6, s10
; RV32I-NEXT:    mv a0, s4
; RV32I-NEXT:    mv a1, s5
; RV32I-NEXT:    call __mulsi3
; RV32I-NEXT:    add s4, a0, s1
; RV32I-NEXT:    slli a0, s4, 16
; RV32I-NEXT:    or s1, s0, a0
; RV32I-NEXT:    add s7, s1, s3
...
; RV32I-NEXT:    call __muldi3
; RV32I-NEXT:    mv s0, a1
; RV32I-NEXT:    sltu s8, s7, s1
; RV32I-NEXT:    add s1, s7, a0
; RV32I-NEXT:    sltu s3, s3, s9
; RV32I-NEXT:    sltu s7, s1, s7
...
; RV32IM-NEXT:    mulhu t0, t0, a0
; RV32IM-NEXT:    add a0, a6, a4
; RV32IM-NEXT:    sltu a4, a4, a5
; RV32IM-NEXT:    sltu a0, a0, a6
; RV32IM-NEXT:    add a2, a2, a4
; RV32IM-NEXT:    add a0, a7, a0
