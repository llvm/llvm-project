...
; RV32I-NEXT:    bgeu a2, a3, .LBB5_3
; RV32I-NEXT:  # %bb.1:
; RV32I-NEXT:    li s1, 0
; RV32I-NEXT:    li s7, 0
; RV32I-NEXT:    li a1, 0
; RV32I-NEXT:  .LBB5_2: # %fp-to-i-cleanup
; RV32I-NEXT:    sw s1, 0(a0)
; RV32I-NEXT:    sw s7, 4(a0)
...
; RV32I-NEXT:    addi sp, sp, 128
; RV32I-NEXT:    ret
; RV32I-NEXT:  .LBB5_3: # %fp-to-i-if-check.exp.size
; RV32I-NEXT:    sw a0, 12(sp) # 4-byte Folded Spill
; RV32I-NEXT:    lw a4, 0(a1)
; RV32I-NEXT:    lw a3, 4(a1)
; RV32I-NEXT:    lw a0, 8(a1)
; RV32I-NEXT:    srai s0, a5, 31
; RV32I-NEXT:    addi a1, a6, 110
; RV32I-NEXT:    ori s1, s0, 1
; RV32I-NEXT:    bltu a1, a2, .LBB5_5
; RV32I-NEXT:  # %bb.4: # %fp-to-i-if-exp.small
...
; RV32I-NEXT:    or s2, a3, a6
; RV32I-NEXT:    or s3, a1, a7
; RV32I-NEXT:    or s4, a0, a5
; RV32I-NEXT:    srl s5, a4, a2
; RV32I-NEXT:    mv a0, s4
; RV32I-NEXT:    li a1, 0
; RV32I-NEXT:    mv a2, s1
; RV32I-NEXT:    li a3, 0
...
; RV32I-NEXT:    add a1, s9, a0
; RV32I-NEXT:    j .LBB5_6
; RV32I-NEXT:  .LBB5_5: # %fp-to-i-if-exp.large
; RV32I-NEXT:    sw zero, 48(sp)
; RV32I-NEXT:    sw zero, 52(sp)
; RV32I-NEXT:    sw zero, 56(sp)
; RV32I-NEXT:    sw zero, 60(sp)
; RV32I-NEXT:    sw a4, 64(sp)
; RV32I-NEXT:    sw a3, 68(sp)
...
; RV32I-NEXT:    call __muldi3
; RV32I-NEXT:    mv s1, a0
; RV32I-NEXT:    add s7, s4, a1
; RV32I-NEXT:    sltu a0, s7, s4
