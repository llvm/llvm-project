...
; RV32IZFH-NEXT:    fsw fs0, 8(sp) # 4-byte Spill
...
; RV32IZFH-NEXT:    flw fs0, 8(sp) # 4-byte Reload
; RV32IZFH-NEXT:    addi sp, sp, 16
; RV32IZFH-NEXT:    ret
;
...
; RV64IZFH-NEXT:    fsw fs0, 4(sp) # 4-byte Spill
...
; RV64IZFH-NEXT:    flw fs0, 4(sp) # 4-byte Reload
; RV64IZFH-NEXT:    addi sp, sp, 16
; RV64IZFH-NEXT:    ret
;
...
; RV32IZFHMIN-NEXT:    fsw fs0, 8(sp) # 4-byte Spill
...
; RV32IZFHMIN-NEXT:    flw fs0, 8(sp) # 4-byte Reload
; RV32IZFHMIN-NEXT:    addi sp, sp, 16
; RV32IZFHMIN-NEXT:    ret
;
...
; RV64IZFHMIN-NEXT:    fsw fs0, 4(sp) # 4-byte Spill
...
; RV64IZFHMIN-NEXT:    flw fs0, 4(sp) # 4-byte Reload
; RV64IZFHMIN-NEXT:    addi sp, sp, 16
; RV64IZFHMIN-NEXT:    ret
;
