...
; CHECK-ALIGNED-RV64-V:       # %bb.0: # %entry
; CHECK-ALIGNED-RV64-V-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-ALIGNED-RV64-V-NEXT:    vle8.v v8, (a1)
; CHECK-ALIGNED-RV64-V-NEXT:    vle8.v v9, (a0)
; CHECK-ALIGNED-RV64-V-NEXT:    vmv.x.s a0, v8
; CHECK-ALIGNED-RV64-V-NEXT:    vmv.x.s a1, v9
; CHECK-ALIGNED-RV64-V-NEXT:    xor a0, a1, a0
; CHECK-ALIGNED-RV64-V-NEXT:    seqz a0, a0
; CHECK-ALIGNED-RV64-V-NEXT:    ret
;
