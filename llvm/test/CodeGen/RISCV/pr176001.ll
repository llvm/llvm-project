...
define <32 x i64> @main(i1 %tobool93.not, <32 x i64> %0, <32 x i64> %1) #0 {
  ...
  ; CHECK-NEXT:   renamable $v8m8 = PseudoVLE64_V_M8 undef renamable $v8m8, [[COPY]], 16 /* vl */, 6 /* e64 */, 2 /* tu, ma */ :: (load (s1024))
  ...
  ; CHECK-NEXT:   liveins: $v8m8:0x0000000000000002, $v16m8:0x0000000000000006, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.4.cond.end98:
  ; CHECK-NEXT:   successors: %bb.6(0x30000000), %bb.5(0x50000000)
  ; CHECK-NEXT:   liveins: $v8m8:0x0000000000000002, $v16m8:0x0000000000000006, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PseudoVMV_X_S:%[0-9]+]]:gpr = PseudoVMV_X_S killed renamable $v8, 6 /* e64 */
  ; CHECK-NEXT:   BEQ [[PseudoVMV_X_S]], $x0, %bb.6
  ; CHECK-NEXT:   PseudoBR %bb.5
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.5.cond.true108:
  ; CHECK-NEXT:   successors: %bb.7(0x80000000)
  ; CHECK-NEXT:   liveins: $v16m8:0x0000000000000006, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   liveins: $v16m8:0x0000000000000006, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   renamable $v0m8 = COPY renamable $v24m8
  ; CHECK-NEXT:   renamable $v0m8 = PseudoVMV_V_V_M8 killed renamable $v0m8, renamable $v24m8, 1 /* vl */, 6 /* e64 */, 0 /* tu, mu */
  ...
  ; CHECK-NEXT:   liveins: $v0m8, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.9.cond.end133:
  ; CHECK-NEXT:   liveins: $v0m8, $v24m8:0x00000000000001FE
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   early-clobber renamable $v16 = PseudoVMSLEU_VV_M8 renamable $v24m8, killed renamable $v0m8, 16 /* vl */, 6 /* e64 */
  ...
  ; CHECK-NEXT:   renamable $v17 = COPY renamable $v24
  ; CHECK-NEXT:   renamable $v17 = PseudoVMV_S_X killed renamable $v17, $x0, 16 /* vl */, 6 /* e64 */
  ; CHECK-NEXT:   renamable $v17 = PseudoVMV_S_X killed renamable $v17, [[PseudoVMV_X_S2]], 16 /* vl */, 6 /* e64 */
  ; CHECK-NEXT:   renamable $v0 = COPY killed renamable $v16
  ; CHECK-NEXT:   renamable $v8m8 = lr-split COPY killed renamable $v24m8
  ; CHECK-NEXT:   renamable $v24m8 = COPY renamable $v8m8
  ; CHECK-NEXT:   renamable $v24 = COPY killed renamable $v17
  ; CHECK-NEXT:   renamable $v16m8 = PseudoVMV_V_I_M8 undef renamable $v16m8, 0, 16 /* vl */, 6 /* e64 */, 0 /* tu, mu */
  ; CHECK-NEXT:   renamable $v16m8 = PseudoVMERGE_VIM_M8 undef renamable $v16m8, killed renamable $v16m8, -1, killed renamable $v0, 16 /* vl */, 6 /* e64 */
  ; CHECK-NEXT:   early-clobber renamable $v7 = PseudoVMSLEU_VV_M8 killed renamable $v8m8, killed renamable $v24m8, 16 /* vl */, 6 /* e64 */
  ; CHECK-NEXT:   renamable $v0 = COPY killed renamable $v7
  ; CHECK-NEXT:   renamable $v8m8 = PseudoVMV_V_I_M8 undef renamable $v8m8, 0, 16 /* vl */, 6 /* e64 */, 0 /* tu, mu */
  ; CHECK-NEXT:   renamable $v8m8 = PseudoVMERGE_VIM_M8 undef renamable $v8m8, killed renamable $v8m8, -1, killed renamable $v0, 16 /* vl */, 6 /* e64 */
  ; CHECK-NEXT:   PseudoRET implicit $v8m8, implicit $v16m8
entry:
