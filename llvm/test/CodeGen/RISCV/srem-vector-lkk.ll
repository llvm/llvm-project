...
; RV64IM-NEXT:    lui a3, %hi(.LCPI0_1)
; RV64IM-NEXT:    ld a3, %lo(.LCPI0_1)(a3)
...
; RV32IM-NEXT:    lh a2, 0(a1)
; RV32IM-NEXT:    lh a3, 4(a1)
; RV32IM-NEXT:    lui a4, 706409
; RV32IM-NEXT:    addi a4, a4, 389
; RV32IM-NEXT:    lh a5, 8(a1)
; RV32IM-NEXT:    lh a1, 12(a1)
; RV32IM-NEXT:    mulhsu a6, a2, a4
; RV32IM-NEXT:    mulhsu a7, a3, a4
; RV32IM-NEXT:    mulhsu t0, a5, a4
; RV32IM-NEXT:    mulhsu a4, a1, a4
...
; RV32IM-NEXT:    sub a4, a5, t2
; RV32IM-NEXT:    sub a3, a3, t1
...
; RV64IM-NEXT:    sub a1, a1, t3
; RV64IM-NEXT:    sub a2, a5, t2
; RV64IM-NEXT:    sub a4, a4, t1
; RV64IM-NEXT:    sub a3, a3, t4
...
; RV64IM-NEXT:    mulhsu a4, a6, a4
; RV64IM-NEXT:    mulh a5, a1, a5
; RV64IM-NEXT:    srli a7, a2, 63
; RV64IM-NEXT:    srli a2, a2, 8
; RV64IM-NEXT:    srli t0, a4, 63
...
; RV64IM-NEXT:    lui a3, %hi(.LCPI5_1)
; RV64IM-NEXT:    lh a4, 16(a1)
; RV64IM-NEXT:    lh a5, 24(a1)
; RV64IM-NEXT:    ld a3, %lo(.LCPI5_1)(a3)
; RV64IM-NEXT:    mulhsu a2, a4, a2
; RV64IM-NEXT:    mulh a3, a5, a3
; RV64IM-NEXT:    lh a1, 8(a1)
; RV64IM-NEXT:    srli a6, a2, 63
; RV64IM-NEXT:    srli a2, a2, 4
; RV64IM-NEXT:    srli a7, a3, 63
