...
; SLOWBASE-NEXT:    add a1, a1, a2
; SLOWBASE-NEXT:    slli a0, a0, 16
; SLOWBASE-NEXT:    add a0, a1, a0
; SLOWBASE-NEXT:    ret
;
...
; SLOWBASE-NEXT:    add a0, a0, a3
; SLOWBASE-NEXT:    add a0, a0, a1
; SLOWBASE-NEXT:    ret
;
...
; RV64IZBKB-NEXT:    add a0, a0, a3
; RV64IZBKB-NEXT:    add a0, a0, a1
; RV64IZBKB-NEXT:    ret
;
; FAST-LABEL: load_i32:
; FAST:       # %bb.0:
