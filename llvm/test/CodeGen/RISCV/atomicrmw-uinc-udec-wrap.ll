...
; RV64IA-NEXT:    sc.w.rl a6, a5, (a2)
; RV64IA-NEXT:    bnez a6, .LBB0_3
...
; RV64IA-NEXT:    bne a2, a3, .LBB2_1
; RV64IA-NEXT:  # %bb.4: # %atomicrmw.start
; RV64IA-NEXT:    # in Loop: Header=BB2_3 Depth=2
; RV64IA-NEXT:    sc.w.rl a5, a4, (a0)
