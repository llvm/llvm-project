...
; CHECK-NEXT:    lui a2, %hi(r3)
; CHECK-NEXT:    lui a3, %hi(r2)
; CHECK-NEXT:    lui a4, %hi(r1)
; CHECK-NEXT:    lui a5, %hi(hp)
; CHECK-NEXT:    lui a6, %hi(base)
; CHECK-NEXT:    lui a7, %hi(sp)
; CHECK-NEXT:    lw s1, %lo(base)(a6)
; CHECK-NEXT:    lw s3, %lo(hp)(a5)
; CHECK-NEXT:    lw s2, %lo(sp)(a7)
; CHECK-NEXT:    lw s5, %lo(r2)(a3)
; CHECK-NEXT:    lw s4, %lo(r1)(a4)
; CHECK-NEXT:    lw s7, %lo(r4)(a1)
; CHECK-NEXT:    lw s6, %lo(r3)(a2)
