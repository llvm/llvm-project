...
; CHECK-NEXT:    lui a1, %hi(d2)
; CHECK-NEXT:    fld fs8, %lo(d3)(a0)
; CHECK-NEXT:    fld fs7, %lo(d2)(a1)
; CHECK-NEXT:    lui a0, %hi(d1)
; CHECK-NEXT:    lui a1, %hi(f6)
; CHECK-NEXT:    fld fs6, %lo(d1)(a0)
; CHECK-NEXT:    flw fs5, %lo(f6)(a1)
; CHECK-NEXT:    lui a0, %hi(f5)
; CHECK-NEXT:    lui a1, %hi(f4)
; CHECK-NEXT:    flw fs4, %lo(f5)(a0)
; CHECK-NEXT:    flw fs3, %lo(f4)(a1)
; CHECK-NEXT:    lui a0, %hi(f3)
; CHECK-NEXT:    lui a1, %hi(f2)
; CHECK-NEXT:    flw fs2, %lo(f3)(a0)
; CHECK-NEXT:    flw fs1, %lo(f2)(a1)
...
; CHECK-NEXT:    lui a1, %hi(r6)
; CHECK-NEXT:    lw s10, %lo(r7)(a0)
; CHECK-NEXT:    lw s9, %lo(r6)(a1)
; CHECK-NEXT:    lui a0, %hi(r5)
; CHECK-NEXT:    lui a1, %hi(r4)
; CHECK-NEXT:    lw s8, %lo(r5)(a0)
; CHECK-NEXT:    lw s7, %lo(r4)(a1)
; CHECK-NEXT:    lui a0, %hi(r3)
; CHECK-NEXT:    lui a1, %hi(r2)
; CHECK-NEXT:    lw s6, %lo(r3)(a0)
; CHECK-NEXT:    lw s5, %lo(r2)(a1)
; CHECK-NEXT:    lui a0, %hi(r1)
; CHECK-NEXT:    lui a1, %hi(hp)
; CHECK-NEXT:    lw s4, %lo(r1)(a0)
; CHECK-NEXT:    lw s3, %lo(hp)(a1)
; CHECK-NEXT:    lui a0, %hi(sp)
; CHECK-NEXT:    lui a1, %hi(base)
; CHECK-NEXT:    lw s2, %lo(sp)(a0)
; CHECK-NEXT:    lw s1, %lo(base)(a1)
; CHECK-NEXT:    tail bar
entry:
