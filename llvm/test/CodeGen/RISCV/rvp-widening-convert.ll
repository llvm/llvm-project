...
; RV64-NEXT:    ret
  ...
  %shuffle = shufflevector <4 x i8> zeroinitializer, <4 x i8> %vec, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
...
; RV64-NEXT:    ret
  ...
  %shuffle = shufflevector <2 x i16> zeroinitializer, <2 x i16> %vec, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
