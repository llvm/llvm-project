...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_nxv4i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vcpop.m a0, v0
; ZVE-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_nxv8i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVE-NEXT:    vcpop.m a0, v0
; ZVE-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_nxv16i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; ZVE-NEXT:    vcpop.m a0, v0
; ZVE-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_nxv32i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; ZVE-NEXT:    vcpop.m a0, v0
; ZVE-NEXT:    ret
entry:
...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_nxv64i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; ZVE-NEXT:    vcpop.m a0, v0
; ZVE-NEXT:    ret
entry:
...
; ZVE-NEXT:    slli a0, a0, 3
; ZVE-NEXT:    sub sp, sp, a0
; ZVE-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x08, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 8 * vlenb
; ZVE-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmv1r.v v7, v8
; ZVE-NEXT:    vmv1r.v v6, v0
; ZVE-NEXT:    vmv.v.i v16, 0
; ZVE-NEXT:    csrr a0, vlenb
; ZVE-NEXT:    vmerge.vim v8, v16, 1, v0
; ZVE-NEXT:    addi a1, sp, 16
; ZVE-NEXT:    vs8r.v v8, (a1) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    srli a1, a0, 1
; ZVE-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v0, a1
; ZVE-NEXT:    srli a0, a0, 2
; ZVE-NEXT:    vmv8r.v v8, v16
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v24, v16, 1, v0
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v0, a0
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v16, v16, 1, v0
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v6, a0
; ZVE-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; ZVE-NEXT:    vslidedown.vx v6, v7, a1
; ZVE-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v5, v6, a0
; ZVE-NEXT:    vslidedown.vx v4, v7, a0
; ZVE-NEXT:    vsetvli a0, zero, e32, m8, ta, mu
; ZVE-NEXT:    vmerge.vim v8, v8, 1, v0
; ZVE-NEXT:    vmv1r.v v0, v4
; ZVE-NEXT:    vadd.vi v8, v8, 1, v0.t
; ZVE-NEXT:    vmv1r.v v0, v5
; ZVE-NEXT:    vadd.vi v16, v16, 1, v0.t
; ZVE-NEXT:    vadd.vv v8, v8, v16
; ZVE-NEXT:    vmv1r.v v0, v6
; ZVE-NEXT:    vadd.vi v24, v24, 1, v0.t
; ZVE-NEXT:    vmv1r.v v0, v7
; ZVE-NEXT:    addi a0, sp, 16
; ZVE-NEXT:    vl8r.v v16, (a0) # vscale x 64-byte Folded Reload
; ZVE-NEXT:    vadd.vi v16, v16, 1, v0.t
...
; ZVE-NEXT:    add a0, a0, a1
; ZVE-NEXT:    sub sp, sp, a0
; ZVE-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x30, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 48 * vlenb
; ZVE-NEXT:    vsetvli a0, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmv1r.v v6, v10
; ZVE-NEXT:    vmv1r.v v7, v9
; ZVE-NEXT:    vmv1r.v v5, v8
; ZVE-NEXT:    vmv1r.v v4, v0
; ZVE-NEXT:    vmv.v.i v16, 0
; ZVE-NEXT:    csrr a1, vlenb
; ZVE-NEXT:    vmerge.vim v8, v16, 1, v0
; ZVE-NEXT:    csrr a0, vlenb
...
; ZVE-NEXT:    addi a0, a0, 16
; ZVE-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    srli a0, a1, 1
; ZVE-NEXT:    srli a1, a1, 2
; ZVE-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; ZVE-NEXT:    vslidedown.vx v3, v4, a0
; ZVE-NEXT:    vslidedown.vx v2, v5, a0
; ZVE-NEXT:    vmv.v.v v0, v3
; ZVE-NEXT:    vmv8r.v v8, v16
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v16, v16, 1, v0
; ZVE-NEXT:    csrr a2, vlenb
; ZVE-NEXT:    slli a2, a2, 3
; ZVE-NEXT:    mv a3, a2
; ZVE-NEXT:    slli a2, a2, 1
; ZVE-NEXT:    add a2, a2, a3
; ZVE-NEXT:    add a2, sp, a2
; ZVE-NEXT:    addi a2, a2, 16
; ZVE-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    vmv1r.v v0, v2
; ZVE-NEXT:    vmerge.vim v16, v8, 1, v0
; ZVE-NEXT:    csrr a2, vlenb
; ZVE-NEXT:    slli a2, a2, 4
; ZVE-NEXT:    add a2, sp, a2
; ZVE-NEXT:    addi a2, a2, 16
; ZVE-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v3, a1
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v16, v8, 1, v0
; ZVE-NEXT:    csrr a2, vlenb
; ZVE-NEXT:    slli a2, a2, 3
...
; ZVE-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v2, a1
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v24, v8, 1, v0
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v4, a1
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, ma
; ZVE-NEXT:    vmerge.vim v16, v8, 1, v0
; ZVE-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v5, a1
; ZVE-NEXT:    vslidedown.vx v5, v7, a1
; ZVE-NEXT:    vslidedown.vx v4, v6, a1
; ZVE-NEXT:    vsetvli a2, zero, e32, m8, ta, mu
; ZVE-NEXT:    vmerge.vim v8, v8, 1, v0
; ZVE-NEXT:    vmv1r.v v0, v4
; ZVE-NEXT:    vadd.vi v8, v8, 1, v0.t
; ZVE-NEXT:    vmv1r.v v0, v5
; ZVE-NEXT:    vadd.vi v16, v16, 1, v0.t
; ZVE-NEXT:    vadd.vv v8, v16, v8
; ZVE-NEXT:    addi a2, sp, 16
; ZVE-NEXT:    vs8r.v v8, (a2) # vscale x 64-byte Folded Spill
; ZVE-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; ZVE-NEXT:    vslidedown.vx v5, v7, a0
; ZVE-NEXT:    vslidedown.vx v4, v6, a0
; ZVE-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; ZVE-NEXT:    vslidedown.vx v0, v4, a1
; ZVE-NEXT:    vslidedown.vx v3, v5, a1
; ZVE-NEXT:    vsetvli a0, zero, e32, m8, ta, mu
; ZVE-NEXT:    vadd.vi v24, v24, 1, v0.t
; ZVE-NEXT:    vmv1r.v v0, v3
; ZVE-NEXT:    csrr a0, vlenb
...
; CHECK-NEXT:    ret
;
; ZVE-LABEL: test_narrow_nxv64i1:
; ZVE:       # %bb.0: # %entry
; ZVE-NEXT:    csrr a0, vlenb
; ZVE-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
; ZVE-NEXT:    vmv.v.i v16, 0
; ZVE-NEXT:    srli a0, a0, 1
; ZVE-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; ZVE-NEXT:    vslidedown.vx v8, v0, a0
; ZVE-NEXT:    vsetvli a0, zero, e16, m8, ta, mu
; ZVE-NEXT:    vmerge.vim v16, v16, 1, v0
; ZVE-NEXT:    vmv1r.v v0, v8
; ZVE-NEXT:    vadd.vi v16, v16, 1, v0.t
; ZVE-NEXT:    vmv.s.x v8, zero
; ZVE-NEXT:    vredsum.vs v8, v16, v8
; ZVE-NEXT:    vmv.x.s a0, v8
; ZVE-NEXT:    ret
entry:
