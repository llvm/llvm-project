...
; CHECK-NEXT:    vslidedown.vi v16, v7, 8
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    slli a2, a1, 5
; CHECK-NEXT:    add a1, a2, a1
; CHECK-NEXT:    add a1, sp, a1
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vs1r.v v16, (a1) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vl1r.v v16, (a1) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vslidedown.vi v7, v16, 4
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; CHECK-NEXT:    vmerge.vim v16, v8, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v7
...
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslidedown.vx v7, v7, a0
...
; CHECK-NEXT:    add a2, sp, a2
; CHECK-NEXT:    addi a2, a2, 16
; CHECK-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vadd.vi v8, v8, 1, v0.t
; CHECK-NEXT:    addi a2, sp, 16
; CHECK-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    csrr a2, vlenb
...
; CHECK-NEXT:    add a2, sp, a2
; CHECK-NEXT:    addi a2, a2, 16
; CHECK-NEXT:    vl1r.v v8, (a2) # vscale x 8-byte Folded Reload
