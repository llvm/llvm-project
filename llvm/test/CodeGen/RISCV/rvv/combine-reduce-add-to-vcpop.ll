...
; CHECK-NEXT:    vslidedown.vi v26, v16, 8
; CHECK-NEXT:    vmv1r.v v25, v16
; CHECK-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vi v0, v26, 4
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
...
; CHECK-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vi v0, v25, 4
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; CHECK-NEXT:    vmerge.vim v16, v8, 1, v0
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    mv a2, a1
...
; CHECK-NEXT:    addi a1, sp, 16
; CHECK-NEXT:    vl1r.v v7, (a1) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
...
; CHECK-NEXT:    vmv1r.v v0, v7
; CHECK-NEXT:    addi a2, sp, 16
; CHECK-NEXT:    vs1r.v v7, (a2) # vscale x 8-byte Folded Spill
; CHECK-NEXT:    csrr a2, vlenb
; CHECK-NEXT:    add a2, sp, a2
; CHECK-NEXT:    addi a2, a2, 16
; CHECK-NEXT:    vl8r.v v24, (a2) # vscale x 64-byte Folded Reload
...
; CHECK-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Folded Spill
; CHECK-NEXT:    addi a2, sp, 16
; CHECK-NEXT:    vl1r.v v24, (a2) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
