...
; CHECK-NEXT:    vs1r.v v0, (a0) # vscale x 8-byte Folded Spill
; CHECK-NEXT:    li a0, 32
...
; CHECK-NEXT:    add a1, sp, a1
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vl1r.v v16, (a1) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vi v0, v16, 4
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    mv a2, a1
; CHECK-NEXT:    slli a1, a1, 1
; CHECK-NEXT:    add a2, a2, a1
...
; CHECK-NEXT:    add a1, sp, a1
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vl1r.v v24, (a1) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
...
; CHECK-NEXT:    addi a1, a1, 16
; CHECK-NEXT:    vl1r.v v24, (a1) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vslidedown.vi v7, v24, 4
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; CHECK-NEXT:    vmerge.vim v24, v8, 1, v0
...
; CHECK-NEXT:    vslidedown.vx v6, v24, a1
...
; CHECK-NEXT:    vslidedown.vx v7, v5, a0
; CHECK-NEXT:    vsetvli a1, zero, e32, m8, ta, ma
; CHECK-NEXT:    vmerge.vim v24, v8, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v7
; CHECK-NEXT:    vmerge.vim v8, v8, 1, v0
; CHECK-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vx v0, v4, a0
; CHECK-NEXT:    vsetvli a1, zero, e32, m8, ta, mu
; CHECK-NEXT:    vadd.vi v24, v24, 1, v0.t
; CHECK-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
...
; CHECK-NEXT:    vslidedown.vx v2, v0, a0
...
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslidedown.vx v4, v4, a1
; CHECK-NEXT:    vslidedown.vx v3, v7, a1
; CHECK-NEXT:    vslidedown.vx v6, v6, a1
...
; CHECK-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vx v0, v3, a0
; CHECK-NEXT:    vslidedown.vx v5, v5, a0
; CHECK-NEXT:    vsetvli a1, zero, e32, m8, ta, ma
