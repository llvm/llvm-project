...
; CHECK-NEXT:    vlse8.v v10, (a1), a4, v0.t
...
; CHECK-NEXT:    addi a1, a1, 32
; CHECK-NEXT:    vsse8.v v10, (a0), a4, v0.t
; CHECK-NEXT:    addi a0, a0, 160
...
; ZVE32F-NEXT:    slli a6, a2, 3
; ZVE32F-NEXT:    slli a7, a2, 5
; ZVE32F-NEXT:    slli t0, a4, 5
; ZVE32F-NEXT:    add a6, a7, a6
; ZVE32F-NEXT:    add a5, t0, a5
; ZVE32F-NEXT:    add a6, a1, a6
; ZVE32F-NEXT:    add a5, a1, a5
; ZVE32F-NEXT:    ld a7, 0(a6)
; ZVE32F-NEXT:    ld t0, 0(a5)
; ZVE32F-NEXT:    ld a6, 80(a6)
; ZVE32F-NEXT:    ld a5, 80(a5)
; ZVE32F-NEXT:    sd a7, 0(a0)
...
; OPTV-NEXT:    slli a6, a2, 3
; OPTV-NEXT:    slli a7, a2, 5
; OPTV-NEXT:    slli t0, a4, 5
; OPTV-NEXT:    add a6, a7, a6
; OPTV-NEXT:    add a5, t0, a5
; OPTV-NEXT:    add a6, a1, a6
; OPTV-NEXT:    add a5, a1, a5
; OPTV-NEXT:    ld a7, 0(a6)
; OPTV-NEXT:    ld t0, 0(a5)
; OPTV-NEXT:    ld a6, 80(a6)
; OPTV-NEXT:    ld a5, 80(a5)
; OPTV-NEXT:    sd a7, 0(a0)
; OPTV-NEXT:    sd t0, 8(a0)
; OPTV-NEXT:    sd a6, 16(a0)
...
; ZVE32F-NEXT:    slli t2, a2, 3
; ZVE32F-NEXT:    slli t3, a2, 5
; ZVE32F-NEXT:    add t2, t3, t2
; ZVE32F-NEXT:    slli t3, a4, 5
; ZVE32F-NEXT:    add t1, t3, t1
...
; OPTV-NEXT:    slli t2, a2, 3
; OPTV-NEXT:    slli t3, a2, 5
; OPTV-NEXT:    add t2, t3, t2
; OPTV-NEXT:    slli t3, a4, 5
; OPTV-NEXT:    add t1, t3, t1
...
; CHECK-NEXT:    add a2, t1, t0
; CHECK-NEXT:    add t0, a0, a4
; CHECK-NEXT:    li t2, 32
; CHECK-NEXT:    li t1, 5
