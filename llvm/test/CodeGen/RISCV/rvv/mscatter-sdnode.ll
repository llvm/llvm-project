...
; CHECK-NEXT:    vwaddu.vv v2, v10, v10
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vsoxei16.v v8, (a0), v2, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsoxei32.v v8, (a0), v4, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; CHECK-NEXT:    vzext.vf2 v2, v16
; CHECK-NEXT:    vsll.vi v2, v2, 3
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a1, zero, e32, m4, ta, ma
; CHECK-NEXT:    vzext.vf2 v4, v16
; CHECK-NEXT:    vsll.vi v4, v4, 3
; CHECK-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; CHECK-NEXT:    vsoxei32.v v8, (a0), v4, v0.t
; CHECK-NEXT:    ret
