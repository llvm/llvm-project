...
; RV32-NEXT:    vslidedown.vx v8, v0, a0
...
; RV64-NEXT:    vslidedown.vx v8, v0, a0
...
; RV32-NEXT:    vslidedown.vx v8, v0, a1
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    vsetvli a1, zero, e64, m8, ta, ma
...
; RV64-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; RV64-NEXT:    vl2r.v v16, (a1)
; RV64-NEXT:    vsetvli a1, zero, e64, m8, ta, ma
; RV64-NEXT:    vsext.vf8 v24, v16
; RV64-NEXT:    vsll.vi v24, v24, 3
; RV64-NEXT:    vsext.vf8 v0, v17
...
; RV64-NEXT:    vslidedown.vx v0, v7, a1
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; RV64-NEXT:    vl4re16.v v16, (a1)
; RV64-NEXT:    vsetvli a1, zero, e64, m8, ta, ma
; RV64-NEXT:    vsext.vf4 v24, v16
; RV64-NEXT:    vsll.vi v24, v24, 3
; RV64-NEXT:    vsext.vf4 v0, v18
; RV64-NEXT:    vsll.vi v16, v0, 3
; RV64-NEXT:    addi a1, sp, 16
; RV64-NEXT:    vl1r.v v7, (a1) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vmv1r.v v0, v7
