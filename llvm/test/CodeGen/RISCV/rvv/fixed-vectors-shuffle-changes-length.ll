...
; RV32-NEXT:    vslidedown.vi v9, v10, 4, v0.t
...
; RV64-NEXT:    vslidedown.vi v9, v10, 4, v0.t
...
; CHECK-NEXT:    vslidedown.vx v16, v14, a0
; CHECK-NEXT:    vslidedown.vx v18, v16, a0
; CHECK-NEXT:    vmv1r.v v12, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v9, v8, v14
; CHECK-NEXT:    vrgatherei16.vv v8, v12, v10
; CHECK-NEXT:    vrgatherei16.vv v10, v12, v16
; CHECK-NEXT:    vrgatherei16.vv v11, v12, v18
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslidedown.vx v24, v12, a0
; CHECK-NEXT:    vslidedown.vx v28, v24, a0
; CHECK-NEXT:    vslidedown.vx v4, v28, a0
; CHECK-NEXT:    vslidedown.vx v0, v4, a0
; CHECK-NEXT:    vslidedown.vx v16, v0, a0
; CHECK-NEXT:    vslidedown.vx v20, v16, a0
; CHECK-NEXT:    vmv1r.v v17, v8
; CHECK-NEXT:    vsetvli a0, zero, e32, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v9, v8, v12
; CHECK-NEXT:    addi a0, sp, 16
; CHECK-NEXT:    vl4r.v v12, (a0) # vscale x 32-byte Folded Reload
; CHECK-NEXT:    vrgatherei16.vv v8, v17, v12
; CHECK-NEXT:    vrgatherei16.vv v10, v17, v24
; CHECK-NEXT:    vrgatherei16.vv v11, v17, v28
; CHECK-NEXT:    vrgatherei16.vv v12, v17, v4
; CHECK-NEXT:    vrgatherei16.vv v13, v17, v0
; CHECK-NEXT:    vrgatherei16.vv v14, v17, v16
; CHECK-NEXT:    vrgatherei16.vv v15, v17, v20
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 2
