...
; RV32-NEXT:    li a1, 63
; RV32-NEXT:    vsrl.vx v8, v11, a1
; RV32-NEXT:    vsra.vv v9, v11, v10
...
; CHECK-NEXT:    li a1, -128
; CHECK-NEXT:    vmerge.vxm v8, v10, a1, v0
...
; RV64-NEXT:    vmadd.vv v12, v10, v8
; RV64-NEXT:    lui a1, 4096
; RV64-NEXT:    addi a1, a1, 256
; RV64-NEXT:    vmv.s.x v14, a1
; RV64-NEXT:    li a1, 63
; RV64-NEXT:    vsrl.vx v8, v12, a1
; RV64-NEXT:    vsext.vf8 v10, v14
; RV64-NEXT:    vsra.vv v10, v12, v10
