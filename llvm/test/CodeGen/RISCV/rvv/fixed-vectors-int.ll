...
; CHECK-NEXT:    lui a2, 1048571
; CHECK-NEXT:    vmv.s.x v0, a1
; CHECK-NEXT:    addi a1, a2, 1755
; CHECK-NEXT:    vmerge.vxm v8, v8, a1, v0
...
; CHECK-NEXT:    li a1, 22
; CHECK-NEXT:    vmv.s.x v0, a1
; CHECK-NEXT:    vmerge.vim v8, v8, 7, v0
; CHECK-NEXT:    vle16.v v9, (a0)
...
; RV32-NEXT:    vmerge.vxm v10, v8, a1, v0
...
; RV32-NEXT:    vmv1r.v v0, v8
; RV32-NEXT:    vmerge.vim v12, v9, 1, v0
; RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV32-NEXT:    vsext.vf2 v8, v12
...
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    li a1, 85
; RV32-NEXT:    lui a2, 629146
; RV32-NEXT:    vmv.s.x v0, a1
; RV32-NEXT:    addi a1, a2, -1639
; RV32-NEXT:    vmerge.vxm v8, v8, a1, v0
...
; RV64-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV64-NEXT:    vmerge.vxm v8, v8, a1, v0
