...
; CHECK-ZVE64X-NEXT:    vsub.vx v1, v8, a0
; CHECK-ZVE64X-NEXT:    vnot.v v2, v8
; CHECK-ZVE64X-NEXT:    vand.vv v1, v2, v1
...
; CHECK-F-NEXT:    vrsub.vi v1, v8, 0
; CHECK-F-NEXT:    vand.vv v1, v8, v1
; CHECK-F-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-F-NEXT:    vzext.vf2 v2, v1
; CHECK-F-NEXT:    vfwcvt.f.xu.v v1, v2
...
; CHECK-F-NEXT:    vsub.vx v1, v1, a0
; CHECK-F-NEXT:    vmerge.vim v8, v1, 8, v0
; CHECK-F-NEXT:    ret
;
; CHECK-D-LABEL: cttz_nxv1i8:
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; CHECK-D-NEXT:    vrsub.vi v1, v8, 0
; CHECK-D-NEXT:    vand.vv v1, v8, v1
; CHECK-D-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-D-NEXT:    vzext.vf2 v2, v1
; CHECK-D-NEXT:    vfwcvt.f.xu.v v1, v2
...
; CHECK-D-NEXT:    vsub.vx v1, v1, a0
; CHECK-D-NEXT:    vmerge.vim v8, v1, 8, v0
; CHECK-D-NEXT:    ret
;
...
; CHECK-F-NEXT:    vnsrl.wi v1, v4, 23
...
; CHECK-D-NEXT:    vnsrl.wi v1, v4, 23
...
; CHECK-ZVE64X-NEXT:    vsub.vx v2, v8, a0
; CHECK-ZVE64X-NEXT:    vnot.v v4, v8
; CHECK-ZVE64X-NEXT:    vand.vv v2, v4, v2
...
; CHECK-F-NEXT:    vmerge.vxm v8, v1, a0, v0
; CHECK-F-NEXT:    ret
;
...
; CHECK-D-NEXT:    vmerge.vxm v8, v1, a0, v0
; CHECK-D-NEXT:    ret
;
...
; CHECK-F-NEXT:    vmseq.vi v0, v8, 0
; CHECK-F-NEXT:    li a0, 16
; CHECK-F-NEXT:    vmerge.vxm v8, v2, a0, v0
; CHECK-F-NEXT:    ret
;
...
; CHECK-D-NEXT:    vmseq.vi v0, v8, 0
; CHECK-D-NEXT:    li a0, 16
; CHECK-D-NEXT:    vmerge.vxm v8, v2, a0, v0
; CHECK-D-NEXT:    ret
;
...
; CHECK-ZVE64X-NEXT:    vsub.vx v4, v8, a0
; CHECK-ZVE64X-NEXT:    vnot.v v8, v8
; CHECK-ZVE64X-NEXT:    vand.vv v4, v8, v4
...
; CHECK-F-NEXT:    vrsub.vi v4, v8, 0
; CHECK-F-NEXT:    vand.vv v4, v8, v4
; CHECK-F-NEXT:    vfwcvt.f.xu.v v16, v4
; CHECK-F-NEXT:    vnsrl.wi v4, v16, 23
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsub.vx v4, v4, a0
; CHECK-F-NEXT:    vmseq.vi v0, v8, 0
; CHECK-F-NEXT:    li a0, 16
; CHECK-F-NEXT:    vmerge.vxm v8, v4, a0, v0
; CHECK-F-NEXT:    ret
;
; CHECK-D-LABEL: cttz_nxv16i16:
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; CHECK-D-NEXT:    vrsub.vi v4, v8, 0
; CHECK-D-NEXT:    vand.vv v4, v8, v4
; CHECK-D-NEXT:    vfwcvt.f.xu.v v16, v4
; CHECK-D-NEXT:    vnsrl.wi v4, v16, 23
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsub.vx v4, v4, a0
; CHECK-D-NEXT:    vmseq.vi v0, v8, 0
; CHECK-D-NEXT:    li a0, 16
; CHECK-D-NEXT:    vmerge.vxm v8, v4, a0, v0
; CHECK-D-NEXT:    ret
;
...
; CHECK-F-NEXT:    vfcvt.f.xu.v v1, v1
; CHECK-F-NEXT:    vsrl.vi v1, v1, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v1, v1, a1
; CHECK-F-NEXT:    vmseq.vi v0, v8, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmerge.vxm v8, v1, a1, v0
...
; CHECK-F-NEXT:    vand.vv v2, v8, v2
; CHECK-F-NEXT:    fsrmi a0, 1
; CHECK-F-NEXT:    vfcvt.f.xu.v v2, v2
; CHECK-F-NEXT:    vsrl.vi v2, v2, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v2, v2, a1
; CHECK-F-NEXT:    vmseq.vi v0, v8, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmerge.vxm v8, v2, a1, v0
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
...
; CHECK-F-NEXT:    vand.vv v4, v8, v4
; CHECK-F-NEXT:    fsrmi a0, 1
; CHECK-F-NEXT:    vfcvt.f.xu.v v4, v4
; CHECK-F-NEXT:    vsrl.vi v4, v4, 23
; CHECK-F-NEXT:    li a1, 127
; CHECK-F-NEXT:    vsub.vx v4, v4, a1
; CHECK-F-NEXT:    vmseq.vi v0, v8, 0
; CHECK-F-NEXT:    li a1, 32
; CHECK-F-NEXT:    vmerge.vxm v8, v4, a1, v0
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
...
; RV32I-NEXT:    vsub.vx v1, v8, a0
; RV32I-NEXT:    vnot.v v2, v8
; RV32I-NEXT:    vand.vv v1, v2, v1
...
; RV64I-NEXT:    vsub.vx v1, v8, a0
; RV64I-NEXT:    vnot.v v2, v8
; RV64I-NEXT:    vand.vv v1, v2, v1
...
; RV32F-NEXT:    vrsub.vi v1, v8, 0
; RV32F-NEXT:    vand.vv v1, v8, v1
; RV32F-NEXT:    fsrmi a0, 1
; RV32F-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV32F-NEXT:    vfncvt.f.xu.w v2, v1
; RV32F-NEXT:    vsrl.vi v1, v2, 23
; RV32F-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV32F-NEXT:    vzext.vf2 v2, v1
; RV32F-NEXT:    li a1, 127
; RV32F-NEXT:    vsub.vx v1, v2, a1
; RV32F-NEXT:    li a1, 64
; RV32F-NEXT:    vmerge.vxm v8, v1, a1, v0
; RV32F-NEXT:    fsrm a0
; RV32F-NEXT:    ret
;
...
; RV64F-NEXT:    vrsub.vi v1, v8, 0
; RV64F-NEXT:    vand.vv v1, v8, v1
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV64F-NEXT:    vfncvt.f.xu.w v2, v1
; RV64F-NEXT:    vsrl.vi v1, v2, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV64F-NEXT:    vzext.vf2 v2, v1
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v1, v2, a1
; RV64F-NEXT:    vmseq.vi v0, v8, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmerge.vxm v8, v1, a1, v0
; RV64F-NEXT:    fsrm a0
; RV64F-NEXT:    ret
;
...
; RV32D-NEXT:    vrsub.vi v1, v8, 0
; RV32D-NEXT:    vand.vv v1, v8, v1
; RV32D-NEXT:    fsrmi a0, 1
; RV32D-NEXT:    vfcvt.f.xu.v v1, v1
; RV32D-NEXT:    li a1, 52
; RV32D-NEXT:    vsrl.vx v1, v1, a1
; RV32D-NEXT:    li a1, 1023
; RV32D-NEXT:    vsub.vx v1, v1, a1
; RV32D-NEXT:    li a1, 64
; RV32D-NEXT:    vmerge.vxm v8, v1, a1, v0
; RV32D-NEXT:    fsrm a0
; RV32D-NEXT:    ret
;
...
; RV64D-NEXT:    vrsub.vi v1, v8, 0
; RV64D-NEXT:    vand.vv v1, v8, v1
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v1, v1
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v1, v1, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v1, v1, a1
; RV64D-NEXT:    vmseq.vi v0, v8, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmerge.vxm v8, v1, a1, v0
; RV64D-NEXT:    fsrm a0
; RV64D-NEXT:    ret
;
...
; RV32I-NEXT:    vsub.vx v2, v8, a0
; RV32I-NEXT:    vnot.v v4, v8
; RV32I-NEXT:    vand.vv v2, v4, v2
...
; RV64I-NEXT:    vsub.vx v2, v8, a0
; RV64I-NEXT:    vnot.v v4, v8
; RV64I-NEXT:    vand.vv v2, v4, v2
...
; RV32F-NEXT:    vmseq.vx v0, v8, zero
; RV32F-NEXT:    vrsub.vi v2, v8, 0
; RV32F-NEXT:    vand.vv v2, v8, v2
; RV32F-NEXT:    fsrmi a0, 1
; RV32F-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV32F-NEXT:    vfncvt.f.xu.w v1, v2
; RV32F-NEXT:    vsrl.vi v1, v1, 23
; RV32F-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV32F-NEXT:    vzext.vf2 v2, v1
; RV32F-NEXT:    li a1, 127
; RV32F-NEXT:    vsub.vx v2, v2, a1
; RV32F-NEXT:    li a1, 64
; RV32F-NEXT:    vmerge.vxm v8, v2, a1, v0
; RV32F-NEXT:    fsrm a0
; RV32F-NEXT:    ret
;
...
; RV64F-NEXT:    vrsub.vi v2, v8, 0
; RV64F-NEXT:    vand.vv v2, v8, v2
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; RV64F-NEXT:    vfncvt.f.xu.w v1, v2
; RV64F-NEXT:    vsrl.vi v1, v1, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; RV64F-NEXT:    vzext.vf2 v2, v1
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v2, v2, a1
; RV64F-NEXT:    vmseq.vi v0, v8, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmerge.vxm v8, v2, a1, v0
; RV64F-NEXT:    fsrm a0
; RV64F-NEXT:    ret
;
...
; RV32D-NEXT:    vmseq.vx v0, v8, zero
; RV32D-NEXT:    vrsub.vi v2, v8, 0
; RV32D-NEXT:    vand.vv v2, v8, v2
; RV32D-NEXT:    fsrmi a0, 1
; RV32D-NEXT:    vfcvt.f.xu.v v2, v2
; RV32D-NEXT:    li a1, 52
; RV32D-NEXT:    vsrl.vx v2, v2, a1
; RV32D-NEXT:    li a1, 1023
; RV32D-NEXT:    vsub.vx v2, v2, a1
; RV32D-NEXT:    li a1, 64
; RV32D-NEXT:    vmerge.vxm v8, v2, a1, v0
; RV32D-NEXT:    fsrm a0
; RV32D-NEXT:    ret
;
...
; RV64D-NEXT:    vrsub.vi v2, v8, 0
; RV64D-NEXT:    vand.vv v2, v8, v2
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v2, v2
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v2, v2, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v2, v2, a1
; RV64D-NEXT:    vmseq.vi v0, v8, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmerge.vxm v8, v2, a1, v0
; RV64D-NEXT:    fsrm a0
; RV64D-NEXT:    ret
;
...
; RV32I-NEXT:    vsub.vx v4, v8, a0
; RV32I-NEXT:    vnot.v v8, v8
; RV32I-NEXT:    vand.vv v4, v8, v4
...
; RV64I-NEXT:    vsub.vx v4, v8, a0
; RV64I-NEXT:    vnot.v v8, v8
; RV64I-NEXT:    vand.vv v4, v8, v4
...
; RV32F-NEXT:    vmseq.vx v0, v8, zero
; RV32F-NEXT:    vrsub.vi v4, v8, 0
; RV32F-NEXT:    vand.vv v4, v8, v4
; RV32F-NEXT:    fsrmi a0, 1
; RV32F-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV32F-NEXT:    vfncvt.f.xu.w v2, v4
; RV32F-NEXT:    vsrl.vi v2, v2, 23
; RV32F-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV32F-NEXT:    vzext.vf2 v4, v2
; RV32F-NEXT:    li a1, 127
; RV32F-NEXT:    vsub.vx v4, v4, a1
; RV32F-NEXT:    li a1, 64
; RV32F-NEXT:    vmerge.vxm v8, v4, a1, v0
; RV32F-NEXT:    fsrm a0
; RV32F-NEXT:    ret
;
...
; RV64F-NEXT:    vrsub.vi v4, v8, 0
; RV64F-NEXT:    vand.vv v4, v8, v4
; RV64F-NEXT:    fsrmi a0, 1
; RV64F-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; RV64F-NEXT:    vfncvt.f.xu.w v2, v4
; RV64F-NEXT:    vsrl.vi v2, v2, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV64F-NEXT:    vzext.vf2 v4, v2
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v4, v4, a1
; RV64F-NEXT:    vmseq.vi v0, v8, 0
; RV64F-NEXT:    li a1, 64
; RV64F-NEXT:    vmerge.vxm v8, v4, a1, v0
; RV64F-NEXT:    fsrm a0
; RV64F-NEXT:    ret
;
...
; RV32D-NEXT:    vmseq.vx v0, v8, zero
; RV32D-NEXT:    vrsub.vi v4, v8, 0
; RV32D-NEXT:    vand.vv v4, v8, v4
; RV32D-NEXT:    fsrmi a0, 1
; RV32D-NEXT:    vfcvt.f.xu.v v4, v4
; RV32D-NEXT:    li a1, 52
; RV32D-NEXT:    vsrl.vx v4, v4, a1
; RV32D-NEXT:    li a1, 1023
; RV32D-NEXT:    vsub.vx v4, v4, a1
; RV32D-NEXT:    li a1, 64
; RV32D-NEXT:    vmerge.vxm v8, v4, a1, v0
; RV32D-NEXT:    fsrm a0
; RV32D-NEXT:    ret
;
...
; RV64D-NEXT:    vrsub.vi v4, v8, 0
; RV64D-NEXT:    vand.vv v4, v8, v4
; RV64D-NEXT:    fsrmi a0, 1
; RV64D-NEXT:    vfcvt.f.xu.v v4, v4
; RV64D-NEXT:    li a1, 52
; RV64D-NEXT:    vsrl.vx v4, v4, a1
; RV64D-NEXT:    li a1, 1023
; RV64D-NEXT:    vsub.vx v4, v4, a1
; RV64D-NEXT:    vmseq.vi v0, v8, 0
; RV64D-NEXT:    li a1, 64
; RV64D-NEXT:    vmerge.vxm v8, v4, a1, v0
; RV64D-NEXT:    fsrm a0
; RV64D-NEXT:    ret
;
...
; RV32F-NEXT:    vfncvt.f.xu.w v4, v8
; RV32F-NEXT:    vsrl.vi v4, v4, 23
; RV32F-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV32F-NEXT:    vzext.vf2 v8, v4
; RV32F-NEXT:    li a1, 127
; RV32F-NEXT:    vsub.vx v8, v8, a1
; RV32F-NEXT:    li a1, 64
...
; RV64F-NEXT:    vfncvt.f.xu.w v4, v16
; RV64F-NEXT:    vsrl.vi v4, v4, 23
; RV64F-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64F-NEXT:    vzext.vf2 v16, v4
; RV64F-NEXT:    li a1, 127
; RV64F-NEXT:    vsub.vx v16, v16, a1
; RV64F-NEXT:    vmseq.vi v0, v8, 0
; RV64F-NEXT:    li a1, 64
...
; CHECK-D-NEXT:    vfwcvt.f.xu.v v8, v4
; CHECK-D-NEXT:    li a0, 52
; CHECK-D-NEXT:    vnsrl.wx v4, v8, a0
; CHECK-D-NEXT:    li a0, 1023
; CHECK-D-NEXT:    vsub.vx v8, v4, a0
; CHECK-D-NEXT:    ret
;
...
; CHECK-F-NEXT:    vfncvt.f.xu.w v2, v1
; CHECK-F-NEXT:    vsrl.vi v1, v2, 23
...
; CHECK-F-NEXT:    vfncvt.f.xu.w v1, v2
; CHECK-F-NEXT:    vsrl.vi v1, v1, 23
...
; CHECK-D-NEXT:    vand.vv v2, v8, v2
; CHECK-D-NEXT:    fsrmi a0, 1
; CHECK-D-NEXT:    vfcvt.f.xu.v v2, v2
; CHECK-D-NEXT:    li a1, 52
; CHECK-D-NEXT:    vsrl.vx v2, v2, a1
; CHECK-D-NEXT:    li a1, 1023
; CHECK-D-NEXT:    vsub.vx v8, v2, a1
; CHECK-D-NEXT:    fsrm a0
; CHECK-D-NEXT:    ret
;
...
; CHECK-F-NEXT:    vfncvt.f.xu.w v2, v4
; CHECK-F-NEXT:    vsrl.vi v2, v2, 23
...
; CHECK-D-NEXT:    vand.vv v4, v8, v4
; CHECK-D-NEXT:    fsrmi a0, 1
; CHECK-D-NEXT:    vfcvt.f.xu.v v4, v4
; CHECK-D-NEXT:    li a1, 52
; CHECK-D-NEXT:    vsrl.vx v4, v4, a1
; CHECK-D-NEXT:    li a1, 1023
; CHECK-D-NEXT:    vsub.vx v8, v4, a1
; CHECK-D-NEXT:    fsrm a0
; CHECK-D-NEXT:    ret
;
