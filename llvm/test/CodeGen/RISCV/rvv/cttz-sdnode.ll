...
; CHECK-F-NEXT:    vsetvli a1, zero, e8, mf8, ta, ma
...
; CHECK-D-NEXT:    vsetvli a1, zero, e8, mf8, ta, ma
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e8, mf4, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e8, mf4, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e8, m2, ta, ma
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e8, m2, ta, ma
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e16, mf4, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e16, mf2, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
; CHECK-F-NEXT:    vfwcvt.f.xu.v v10, v9
; CHECK-F-NEXT:    vnsrl.wi v9, v10, 23
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e16, mf2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
; CHECK-D-NEXT:    vfwcvt.f.xu.v v10, v9
; CHECK-D-NEXT:    vnsrl.wi v9, v10, 23
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e16, m1, ta, ma
; CHECK-F-NEXT:    vrsub.vi v9, v8, 0
; CHECK-F-NEXT:    vand.vv v9, v8, v9
; CHECK-F-NEXT:    vfwcvt.f.xu.v v10, v9
; CHECK-F-NEXT:    vnsrl.wi v9, v10, 23
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e16, m1, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
; CHECK-D-NEXT:    vfwcvt.f.xu.v v10, v9
; CHECK-D-NEXT:    vnsrl.wi v9, v10, 23
...
; CHECK-F:       # %bb.0:
; CHECK-F-NEXT:    li a0, 127
; CHECK-F-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; CHECK-F-NEXT:    vrsub.vi v10, v8, 0
; CHECK-F-NEXT:    vand.vv v10, v8, v10
; CHECK-F-NEXT:    vfwcvt.f.xu.v v12, v10
; CHECK-F-NEXT:    vnsrl.wi v10, v12, 23
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 127
; CHECK-D-NEXT:    vsetvli a1, zero, e16, m2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v10, v8, 0
; CHECK-D-NEXT:    vand.vv v10, v8, v10
; CHECK-D-NEXT:    vfwcvt.f.xu.v v12, v10
; CHECK-D-NEXT:    vnsrl.wi v10, v12, 23
...
; CHECK-D-NEXT:    vsetvli a1, zero, e32, mf2, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
; CHECK-D-NEXT:    vfwcvt.f.xu.v v10, v9
...
; CHECK-D:       # %bb.0:
; CHECK-D-NEXT:    li a0, 52
; CHECK-D-NEXT:    vsetvli a1, zero, e32, m1, ta, ma
; CHECK-D-NEXT:    vrsub.vi v9, v8, 0
; CHECK-D-NEXT:    vand.vv v9, v8, v9
; CHECK-D-NEXT:    vfwcvt.f.xu.v v10, v9
; CHECK-D-NEXT:    vnsrl.wx v9, v10, a0
...
; CHECK-D-NEXT:    vmseq.vi v24, v8, 0
...
; CHECK-D-NEXT:    vmseq.vi v0, v8, 0
; CHECK-D-NEXT:    li a1, 52
; CHECK-D-NEXT:    vsrl.vx v8, v10, a1
; CHECK-D-NEXT:    li a1, 1023
; CHECK-D-NEXT:    vsub.vx v8, v8, a1
; CHECK-D-NEXT:    li a1, 64
; CHECK-D-NEXT:    vmerge.vxm v8, v8, a1, v0
