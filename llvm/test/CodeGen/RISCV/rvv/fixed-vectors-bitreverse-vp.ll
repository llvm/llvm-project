...
; RV32-NEXT:    vsll.vi v10, v10, 4, v0.t
; RV32-NEXT:    vsrl.vi v8, v8, 4, v0.t
; RV32-NEXT:    vand.vv v8, v8, v9, v0.t
; RV32-NEXT:    vor.vv v8, v8, v10, v0.t
; RV32-NEXT:    vand.vv v9, v8, v12, v0.t
...
; RV64-NEXT:    vand.vx v9, v8, a7, v0.t
; RV64-NEXT:    vsll.vi v9, v9, 4, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 4, v0.t
; RV64-NEXT:    vand.vx v8, v8, a7, v0.t
; RV64-NEXT:    vor.vv v8, v8, v9, v0.t
; RV64-NEXT:    vand.vx v9, v8, a6, v0.t
; RV64-NEXT:    vsll.vi v9, v9, 2, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 2, v0.t
; RV64-NEXT:    vand.vx v8, v8, a6, v0.t
; RV64-NEXT:    vor.vv v8, v8, v9, v0.t
; RV64-NEXT:    vand.vx v9, v8, a5, v0.t
...
; RV32-NEXT:    vsll.vi v12, v12, 4, v0.t
; RV32-NEXT:    vsrl.vi v8, v8, 4, v0.t
; RV32-NEXT:    vand.vv v8, v8, v10, v0.t
; RV32-NEXT:    vor.vv v8, v8, v12, v0.t
; RV32-NEXT:    vand.vv v10, v8, v16, v0.t
...
; RV64-NEXT:    vand.vx v10, v8, a7, v0.t
; RV64-NEXT:    vsll.vi v10, v10, 4, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 4, v0.t
; RV64-NEXT:    vand.vx v8, v8, a7, v0.t
; RV64-NEXT:    vor.vv v8, v8, v10, v0.t
; RV64-NEXT:    vand.vx v10, v8, a6, v0.t
; RV64-NEXT:    vsll.vi v10, v10, 2, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 2, v0.t
; RV64-NEXT:    vand.vx v8, v8, a6, v0.t
; RV64-NEXT:    vor.vv v8, v8, v10, v0.t
; RV64-NEXT:    vand.vx v10, v8, a5, v0.t
...
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vor.vv v16, v16, v20, v0.t
; RV32-NEXT:    vand.vv v20, v16, v28, v0.t
; RV32-NEXT:    vsll.vi v20, v20, 4, v0.t
; RV32-NEXT:    vsrl.vi v16, v16, 4, v0.t
; RV32-NEXT:    vand.vv v16, v16, v28, v0.t
; RV32-NEXT:    vor.vv v16, v16, v20, v0.t
; RV32-NEXT:    vand.vv v20, v16, v12, v0.t
; RV32-NEXT:    vsll.vi v20, v20, 2, v0.t
; RV32-NEXT:    vsrl.vi v16, v16, 2, v0.t
; RV32-NEXT:    vand.vv v12, v16, v12, v0.t
; RV32-NEXT:    vor.vv v12, v12, v20, v0.t
...
; RV64-NEXT:    vand.vx v12, v8, a7, v0.t
; RV64-NEXT:    vsll.vi v12, v12, 4, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 4, v0.t
; RV64-NEXT:    vand.vx v8, v8, a7, v0.t
; RV64-NEXT:    vor.vv v8, v8, v12, v0.t
; RV64-NEXT:    vand.vx v12, v8, a6, v0.t
; RV64-NEXT:    vsll.vi v12, v12, 2, v0.t
; RV64-NEXT:    vsrl.vi v8, v8, 2, v0.t
; RV64-NEXT:    vand.vx v8, v8, a6, v0.t
; RV64-NEXT:    vor.vv v8, v8, v12, v0.t
; RV64-NEXT:    vand.vx v12, v8, a5, v0.t
...
; CHECK-NEXT:    vand.vx v24, v8, a4, v0.t
; CHECK-NEXT:    vsll.vi v24, v24, 4, v0.t
; CHECK-NEXT:    vsrl.vi v8, v8, 4, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a4, v0.t
; CHECK-NEXT:    vor.vv v8, v8, v24, v0.t
; CHECK-NEXT:    vand.vx v24, v8, a1, v0.t
; CHECK-NEXT:    vsll.vi v24, v24, 2, v0.t
; CHECK-NEXT:    vsrl.vi v8, v8, 2, v0.t
...
; CHECK-NEXT:    vand.vx v24, v16, a4, v0.t
; CHECK-NEXT:    vsll.vi v24, v24, 4, v0.t
; CHECK-NEXT:    vsrl.vi v16, v16, 4, v0.t
...
; CHECK-NEXT:    vor.vv v16, v16, v24, v0.t
; CHECK-NEXT:    vand.vx v24, v16, a0, v0.t
; CHECK-NEXT:    vsll.vi v24, v24, 1, v0.t
