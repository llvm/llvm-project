...
; CHECK-NEXT:    vwredsum.vs v1, v1, v2
...
; CHECK-NEXT:    vmv.s.x v2, zero
; CHECK-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; CHECK-NEXT:    vwredsumu.vs v1, v1, v2
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <2 x i8>, ptr %x
...
; CHECK-NEXT:    vmv.s.x v1, zero
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vwredsum.vs v1, v2, v1
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vmv.s.x v1, zero
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vwredsumu.vs v1, v2, v1
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vmv.s.x v1, zero
; CHECK-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; CHECK-NEXT:    vwredsum.vs v1, v4, v1
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vmv.s.x v1, zero
; CHECK-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; CHECK-NEXT:    vwredsumu.vs v1, v4, v1
; CHECK-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vredsum.vs v1, v24, v1
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <128 x i8>, ptr %x
...
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsrl.vx v2, v1, a0
; RV32-NEXT:    vmv.x.s a1, v2
...
; RV32-NEXT:    vsext.vf2 v2, v1
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsrl.vx v1, v2, a0
...
; RV32-NEXT:    vredsum.vs v1, v1, v2
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
; RV32-NEXT:    vmv.x.s a1, v1
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vwredsum.vs v1, v1, v2
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vwredsum.vs v1, v1, v2
...
; RV32-NEXT:    vmv.s.x v2, zero
; RV32-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV32-NEXT:    vwredsumu.vs v1, v1, v2
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v2, zero
; RV64-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV64-NEXT:    vwredsumu.vs v1, v1, v2
; RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <2 x i32>, ptr %x
...
; RV32-NEXT:    vle64.v v2, (a0)
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vredsum.vs v1, v2, v1
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vle64.v v2, (a0)
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vredsum.vs v1, v2, v1
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vle32.v v2, (a0)
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV32-NEXT:    vwredsum.vs v1, v2, v1
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vle32.v v2, (a0)
; RV64-NEXT:    vsetivli zero, 8, e64, m1, ta, ma
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV64-NEXT:    vwredsum.vs v1, v2, v1
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <8 x i32>, ptr %x
...
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV32-NEXT:    vwredsumu.vs v1, v2, v1
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV64-NEXT:    vwredsumu.vs v1, v2, v1
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <8 x i32>, ptr %x
...
; RV32-NEXT:    vle32.v v4, (a0)
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV32-NEXT:    vwredsum.vs v1, v4, v1
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vle32.v v4, (a0)
; RV64-NEXT:    vsetivli zero, 16, e64, m1, ta, ma
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV64-NEXT:    vwredsum.vs v1, v4, v1
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <16 x i32>, ptr %x
...
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV32-NEXT:    vwredsumu.vs v1, v4, v1
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV64-NEXT:    vwredsumu.vs v1, v4, v1
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <16 x i32>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vredsum.vs v1, v24, v1
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
; RV32-NEXT:    vmv.x.s a1, v1
...
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vredsum.vs v1, v24, v1
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <32 x i32>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vle8.v v2, (a0)
; CHECK-NEXT:    vredand.vs v1, v2, v2
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vmv.s.x v1, zero
; CHECK-NEXT:    vredxor.vs v1, v4, v1
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vredmin.vs v1, v4, v4
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vredmax.vs v1, v4, v4
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vle8.v v2, (a0)
; CHECK-NEXT:    vredminu.vs v1, v2, v2
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vle64.v v1, (a0)
; RV32-NEXT:    vredminu.vs v1, v1, v1
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v2, v1, a0
; RV32-NEXT:    vmv.x.s a1, v2
...
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vle64.v v1, (a0)
; RV64-NEXT:    vredminu.vs v1, v1, v1
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <2 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV32-NEXT:    vle64.v v2, (a0)
; RV32-NEXT:    vredminu.vs v1, v2, v2
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV64-NEXT:    vle64.v v2, (a0)
; RV64-NEXT:    vredminu.vs v1, v2, v2
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <4 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vle64.v v4, (a0)
; RV32-NEXT:    vredminu.vs v1, v4, v4
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV64-NEXT:    vle64.v v4, (a0)
; RV64-NEXT:    vredminu.vs v1, v4, v4
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <8 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    vredminu.vs v1, v8, v8
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v8, (a0)
; RV64-NEXT:    vredminu.vs v1, v8, v8
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <16 x i64>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vredmaxu.vs v1, v4, v4
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
  %v = load <64 x i8>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vle64.v v1, (a0)
; RV32-NEXT:    vredmaxu.vs v1, v1, v1
; RV32-NEXT:    li a0, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v2, v1, a0
; RV32-NEXT:    vmv.x.s a1, v2
...
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vle64.v v1, (a0)
; RV64-NEXT:    vredmaxu.vs v1, v1, v1
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <2 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV32-NEXT:    vle64.v v2, (a0)
; RV32-NEXT:    vredmaxu.vs v1, v2, v2
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV64-NEXT:    vle64.v v2, (a0)
; RV64-NEXT:    vredmaxu.vs v1, v2, v2
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <4 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vle64.v v4, (a0)
; RV32-NEXT:    vredmaxu.vs v1, v4, v4
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV64-NEXT:    vle64.v v4, (a0)
; RV64-NEXT:    vredmaxu.vs v1, v4, v4
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <8 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle64.v v8, (a0)
; RV32-NEXT:    vredmaxu.vs v1, v8, v8
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v8, (a0)
; RV64-NEXT:    vredmaxu.vs v1, v8, v8
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %v = load <16 x i64>, ptr %x
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vslidedown.vi v2, v1, 4
; CHECK-NEXT:    vmul.vv v1, v1, v2
; CHECK-NEXT:    vslidedown.vi v2, v1, 2
; CHECK-NEXT:    vmul.vv v1, v1, v2
; CHECK-NEXT:    vrgather.vi v2, v1, 1
...
; CHECK-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vslidedown.vi v2, v1, 8
; CHECK-NEXT:    vmul.vv v1, v1, v2
; CHECK-NEXT:    vslidedown.vi v2, v1, 4
; CHECK-NEXT:    vmul.vv v1, v1, v2
; CHECK-NEXT:    vslidedown.vi v2, v1, 2
...
; CHECK-NEXT:    vmul.vv v2, v2, v4
; CHECK-NEXT:    vslidedown.vi v4, v2, 8
; CHECK-NEXT:    vmul.vv v2, v2, v4
; CHECK-NEXT:    vslidedown.vi v4, v2, 4
; CHECK-NEXT:    vmul.vv v2, v2, v4
; CHECK-NEXT:    vslidedown.vi v4, v2, 2
; CHECK-NEXT:    vmul.vv v2, v2, v4
; CHECK-NEXT:    vrgather.vi v4, v2, 1
; CHECK-NEXT:    vmul.vv v2, v2, v4
; CHECK-NEXT:    vmv.x.s a0, v2
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    li a0, 32
; CHECK-NEXT:    vslidedown.vx v8, v4, a0
; CHECK-NEXT:    vmul.vv v4, v4, v8
; CHECK-NEXT:    vslidedown.vi v8, v4, 16
; CHECK-NEXT:    vmul.vv v4, v4, v8
; CHECK-NEXT:    vslidedown.vi v8, v4, 8
; CHECK-NEXT:    vmul.vv v4, v4, v8
; CHECK-NEXT:    vslidedown.vi v8, v4, 4
; CHECK-NEXT:    vmul.vv v4, v4, v8
; CHECK-NEXT:    vslidedown.vi v8, v4, 2
; CHECK-NEXT:    vmul.vv v4, v4, v8
; CHECK-NEXT:    vrgather.vi v8, v4, 1
; CHECK-NEXT:    vmul.vv v4, v4, v8
...
; RV32-NEXT:    vrgather.vi v4, v2, 1
; RV32-NEXT:    vmul.vv v2, v2, v4
; RV32-NEXT:    vmv.x.s a0, v2
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV32-NEXT:    vsrl.vx v2, v2, a1
; RV32-NEXT:    vmv.x.s a1, v2
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmul.vv v2, v2, v4
; RV64-NEXT:    vrgather.vi v4, v2, 1
; RV64-NEXT:    vmul.vv v2, v2, v4
; RV64-NEXT:    vmv.x.s a0, v2
; RV64-NEXT:    ret
  %v = load <4 x i64>, ptr %x
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vle64.v v4, (a0)
; RV32-NEXT:    vslidedown.vi v8, v4, 4
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    vslidedown.vi v8, v4, 2
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    vrgather.vi v8, v4, 1
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    vmv.x.s a0, v4
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m4, ta, ma
; RV32-NEXT:    vsrl.vx v4, v4, a1
; RV32-NEXT:    vmv.x.s a1, v4
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV64-NEXT:    vle64.v v4, (a0)
; RV64-NEXT:    vslidedown.vi v8, v4, 4
; RV64-NEXT:    vmul.vv v4, v4, v8
; RV64-NEXT:    vslidedown.vi v8, v4, 2
; RV64-NEXT:    vmul.vv v4, v4, v8
; RV64-NEXT:    vrgather.vi v8, v4, 1
; RV64-NEXT:    vmul.vv v4, v4, v8
; RV64-NEXT:    vmv.x.s a0, v4
; RV64-NEXT:    ret
  %v = load <8 x i64>, ptr %x
