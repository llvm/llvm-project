...
; CHECK-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vwredsum.vs v8, v9, v8
...
; RV32-NEXT:    vwredsum.vs v8, v9, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vwredsum.vs v8, v9, v8
...
; RV32-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; RV32-NEXT:    vle32.v v9, (a0)
; RV32-NEXT:    vwredsumu.vs v8, v9, v8
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v8, a1
...
; RV64-NEXT:    vle32.v v9, (a0)
; RV64-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; RV64-NEXT:    vwredsumu.vs v8, v9, v8
; RV64-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
  %v = load <2 x i32>, ptr %x
...
; RV32-NEXT:    vslidedown.vi v0, v24, 16
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV32-NEXT:    vwaddu.vv v16, v8, v24
; RV32-NEXT:    addi a0, sp, 16
; RV32-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
...
; RV64-NEXT:    vslidedown.vi v0, v24, 16
; RV64-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV64-NEXT:    vwaddu.vv v16, v8, v24
; RV64-NEXT:    addi a0, sp, 16
; RV64-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
...
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vredand.vs v8, v9, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <3 x i8>, ptr %x
...
; CHECK-NEXT:    vmv.s.x v8, a1
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vredmin.vs v8, v9, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <3 x i8>, ptr %x
...
; RV32-NEXT:    addi a1, a0, 128
; RV32-NEXT:    vle64.v v16, (a1)
; RV32-NEXT:    vmin.vv v8, v16, v8
; RV32-NEXT:    vle64.v v16, (a0)
; RV32-NEXT:    addi a0, a0, 256
; RV32-NEXT:    vle64.v v24, (a0)
; RV32-NEXT:    vmin.vv v16, v16, v24
; RV32-NEXT:    vmin.vv v8, v16, v8
; RV32-NEXT:    vredmin.vs v8, v8, v8
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    addi a1, a0, 128
; RV64-NEXT:    vle64.v v16, (a1)
; RV64-NEXT:    vmin.vv v8, v16, v8
; RV64-NEXT:    vle64.v v16, (a0)
; RV64-NEXT:    addi a0, a0, 256
; RV64-NEXT:    vle64.v v24, (a0)
; RV64-NEXT:    vmin.vv v16, v16, v24
; RV64-NEXT:    vmin.vv v8, v16, v8
; RV64-NEXT:    vredmin.vs v8, v8, v8
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a1
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vredmax.vs v8, v9, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <3 x i8>, ptr %x
...
; RV32-NEXT:    addi a1, a0, 128
; RV32-NEXT:    vle64.v v16, (a1)
; RV32-NEXT:    vmax.vv v8, v16, v8
; RV32-NEXT:    vle64.v v16, (a0)
; RV32-NEXT:    addi a0, a0, 256
; RV32-NEXT:    vle64.v v24, (a0)
; RV32-NEXT:    vmax.vv v16, v16, v24
; RV32-NEXT:    vmax.vv v8, v16, v8
; RV32-NEXT:    vredmax.vs v8, v8, v8
; RV32-NEXT:    vmv.x.s a0, v8
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    addi a1, a0, 128
; RV64-NEXT:    vle64.v v16, (a1)
; RV64-NEXT:    vmax.vv v8, v16, v8
; RV64-NEXT:    vle64.v v16, (a0)
; RV64-NEXT:    addi a0, a0, 256
; RV64-NEXT:    vle64.v v24, (a0)
; RV64-NEXT:    vmax.vv v16, v16, v24
; RV64-NEXT:    vmax.vv v8, v16, v8
; RV64-NEXT:    vredmax.vs v8, v8, v8
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, a1
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vredminu.vs v8, v9, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <3 x i8>, ptr %x
...
; RV64-NEXT:    addi a1, a0, 128
; RV64-NEXT:    vle64.v v16, (a1)
; RV64-NEXT:    vminu.vv v8, v16, v8
; RV64-NEXT:    vle64.v v16, (a0)
; RV64-NEXT:    addi a0, a0, 256
; RV64-NEXT:    vle64.v v24, (a0)
; RV64-NEXT:    vminu.vv v16, v16, v24
; RV64-NEXT:    vminu.vv v8, v16, v8
; RV64-NEXT:    vredminu.vs v8, v8, v8
; RV64-NEXT:    vmv.x.s a0, v8
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v8, zero
; CHECK-NEXT:    vle8.v v9, (a0)
; CHECK-NEXT:    vredmaxu.vs v8, v9, v8
; CHECK-NEXT:    vmv.x.s a0, v8
; CHECK-NEXT:    ret
  %v = load <3 x i8>, ptr %x
