...
; CHECK-NEXT:    vfclass.v v1, v8, v0.t
...
; CHECK-NEXT:    vfclass.v v2, v8, v0.t
; CHECK-NEXT:    li a0, 512
; CHECK-NEXT:    vmseq.vx v1, v2, a0, v0.t
...
; CHECK-NEXT:    vfclass.v v4, v8, v0.t
; CHECK-NEXT:    li a0, 256
; CHECK-NEXT:    vmseq.vx v1, v4, a0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfclass.v v4, v8, v0.t
; CHECK-NEXT:    vmseq.vi v1, v4, 1, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmsne.vi v1, v8, 0, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
