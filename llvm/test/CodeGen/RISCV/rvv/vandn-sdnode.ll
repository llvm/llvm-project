...
; CHECK-NEXT:    vnot.v v1, v8
; CHECK-NEXT:    vand.vv v8, v1, v9
; CHECK-NEXT:    ret
;
...
; CHECK-RV32-NEXT:    vand.vv v8, v1, v8
; CHECK-RV32-NEXT:    addi sp, sp, 16
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-ZVKB32-NEXT:    vand.vv v8, v1, v8
; CHECK-ZVKB32-NEXT:    addi sp, sp, 16
...
; CHECK-RV32-NEXT:    vand.vv v8, v2, v8
; CHECK-RV32-NEXT:    addi sp, sp, 16
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-ZVKB32-NEXT:    vand.vv v8, v2, v8
; CHECK-ZVKB32-NEXT:    addi sp, sp, 16
; CHECK-ZVKB32-NEXT:    ret
;
...
; CHECK-RV32-NEXT:    vand.vv v8, v4, v8
; CHECK-RV32-NEXT:    addi sp, sp, 16
; CHECK-RV32-NEXT:    ret
;
...
; CHECK-ZVKB32-NEXT:    vand.vv v8, v4, v8
; CHECK-ZVKB32-NEXT:    addi sp, sp, 16
; CHECK-ZVKB32-NEXT:    ret
;
