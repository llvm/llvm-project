...
; CHECK-NEXT:    vsub.vv v8, v8, v9
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 5 x i1> poison, i1 true, i32 0
  %m = shufflevector <vscale x 5 x i1> %head, <vscale x 5 x i1> poison, <vscale x 5 x i32> zeroinitializer
  %v = call <vscale x 5 x i8> @llvm.vp.sub.nxv5i8(<vscale x 5 x i8> %va, <vscale x 5 x i8> %b, <vscale x 5 x i1> %m, i32 %evl)
  ret <vscale x 5 x i8> %v
}
...
; RV32-NEXT:    vsub.vv v8, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vsub.vv v8, v8, v2, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vsub.vv v8, v8, v4, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
