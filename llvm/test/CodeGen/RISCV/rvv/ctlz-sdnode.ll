...
; CHECK-F-NEXT:    vzext.vf2 v8, v8
; CHECK-F-NEXT:    li a0, 134
; CHECK-F-NEXT:    vfwcvt.f.xu.v v8, v8
...
; CHECK-D-NEXT:    vzext.vf2 v8, v8
; CHECK-D-NEXT:    li a0, 134
; CHECK-D-NEXT:    vfwcvt.f.xu.v v8, v8
...
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    vwsubu.vv v8, v9, v8
...
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    vwsubu.vv v8, v10, v8
; CHECK-F-NEXT:    li a0, 64
...
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    vwsubu.vv v8, v12, v8
; CHECK-F-NEXT:    li a0, 64
...
; CHECK-F-NEXT:    vfncvt.f.xu.w v8, v8
; CHECK-F-NEXT:    vsrl.vi v8, v8, 23
; CHECK-F-NEXT:    vwsubu.vv v8, v16, v8
; CHECK-F-NEXT:    fsrm a0
; CHECK-F-NEXT:    ret
;
