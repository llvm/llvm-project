...
; CHECK-NEXT:    vmsle.vv v1, v9, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsle.vv v2, v10, v9, v0.t
...
; CHECK-NEXT:    vmsle.vv v1, v10, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsle.vv v2, v12, v10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsle.vv v1, v12, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsle.vv v2, v16, v12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsle.vv v1, v2, v8, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, -15, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsge.mask.nxv1i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, -13, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsge.mask.nxv2i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, -11, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsge.mask.nxv4i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, -9, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsge.mask.nxv8i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgt.vi v1, v8, -7, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i1> @llvm.riscv.vmsge.mask.nxv16i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsgt.vi v1, v8, -5, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i1> @llvm.riscv.vmsge.mask.nxv32i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, -1, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsge.mask.nxv2i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, 0, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsge.mask.nxv4i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgt.vi v1, v8, 2, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsge.mask.nxv8i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, mf2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, 6, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsge.mask.nxv1i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgt.vi v1, v8, 8, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsge.mask.nxv2i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgt.vi v1, v8, 10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsge.mask.nxv4i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsgt.vi v1, v8, 12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsge.mask.nxv8i32.i32(
