...
; RV32-NEXT:    vslideup.vi v12, v8, 10, v0.t
; RV32-NEXT:    vmv1r.v v22, v0
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li a5, 56
; RV32-NEXT:    mul a4, a4, a5
; RV32-NEXT:    add a4, sp, a4
...
; RV32-NEXT:    vrgatherei16.vv v0, v8, v20
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 48
; RV32-NEXT:    mul a1, a1, a4
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vrgatherei16.vv v12, v24, v20
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vl4r.v v24, (a2) # vscale x 32-byte Folded Reload
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    li a3, 36
; RV32-NEXT:    mul a2, a2, a3
; RV32-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs1r.v v8, (a2) # vscale x 8-byte Folded Spill
...
; RV64-NEXT:    addi a2, sp, 16
; RV64-NEXT:    vl8r.v v24, (a2) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vrgather.vi v12, v24, 2
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 20
; RV64-NEXT:    mul a2, a2, a3
...
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs1r.v v8, (a2) # vscale x 8-byte Folded Spill
; RV64-NEXT:    vmerge.vvm v8, v12, v4, v0
; RV64-NEXT:    csrr a2, vlenb
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vslideup.vi v28, v24, 5, v0.t
; RV64-NEXT:    li a1, 64
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vrgather.vi v28, v8, 4, v0.t
; RV64-NEXT:    vrgather.vi v12, v24, 3
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 20
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vcompress.vm v20, v12, v8
...
; RV32-NEXT:    vmv1r.v v15, v0
; RV32-NEXT:    li a0, 36
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    vmerge.vvm v8, v16, v12, v0
; RV32-NEXT:    lui a0, %hi(.LCPI67_0)
; RV32-NEXT:    addi a0, a0, %lo(.LCPI67_0)
; RV32-NEXT:    vle16.v v14, (a0)
; RV32-NEXT:    vrgatherei16.vv v10, v8, v14
; RV32-NEXT:    li a0, 73
