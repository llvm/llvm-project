...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xca, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 74 * vlenb
; RV32-NEXT:    addi a4, a1, 128
; RV32-NEXT:    li a2, 32
; RV32-NEXT:    lui a5, 12291
; RV32-NEXT:    lui a3, %hi(.LCPI27_0)
; RV32-NEXT:    addi a3, a3, %lo(.LCPI27_0)
; RV32-NEXT:    lui a6, 49164
; RV32-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV32-NEXT:    vle32.v v8, (a4)
; RV32-NEXT:    lui a4, 196656
...
; RV32-NEXT:    vmv.s.x v4, a6
; RV32-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV32-NEXT:    vle16.v v6, (a3)
...
; RV32-NEXT:    addi a1, a3, 12
; RV32-NEXT:    vmv.s.x v16, a5
...
; RV32-NEXT:    vslideup.vi v4, v24, 10, v0.t
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v12, v4, v3
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x3e, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 62 * vlenb
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v8, (a1)
; RV64-NEXT:    addi a5, a1, 128
; RV64-NEXT:    lui a3, 1
; RV64-NEXT:    lui a2, %hi(.LCPI27_0)
; RV64-NEXT:    addi a2, a2, %lo(.LCPI27_0)
; RV64-NEXT:    lui a4, 2
; RV64-NEXT:    vle64.v v16, (a5)
; RV64-NEXT:    li a5, 1040
; RV64-NEXT:    vmv.s.x v5, a5
; RV64-NEXT:    addi a5, a3, 65
; RV64-NEXT:    vmv.s.x v0, a5
; RV64-NEXT:    lui a5, 4
; RV64-NEXT:    addi a4, a4, 130
...
; RV64-NEXT:    li a1, 128
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    vslideup.vi v28, v16, 2
