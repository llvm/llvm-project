...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xcc, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 76 * vlenb
; RV32-NEXT:    addi a5, a1, 128
; RV32-NEXT:    li a6, 32
; RV32-NEXT:    lui a4, 12291
; RV32-NEXT:    lui a3, 49164
; RV32-NEXT:    lui a2, 196656
...
; RV32-NEXT:    addi a3, a3, 3
; RV32-NEXT:    addi a1, a2, 12
; RV32-NEXT:    vmv.s.x v0, a3
; RV32-NEXT:    vsetivli zero, 16, e32, m8, ta, ma
; RV32-NEXT:    vslidedown.vi v24, v8, 16
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, mu
; RV32-NEXT:    vmerge.vvm v12, v24, v8, v0
; RV32-NEXT:    csrr a3, vlenb
; RV32-NEXT:    slli a3, a3, 3
; RV32-NEXT:    add a3, sp, a3
; RV32-NEXT:    addi a3, a3, 16
; RV32-NEXT:    vs4r.v v12, (a3) # vscale x 32-byte Folded Spill
...
; RV32-NEXT:    vslideup.vi v4, v24, 8, v0.t
...
; RV32-NEXT:    vrgatherei16.vv v16, v24, v10
...
; RV32-NEXT:    vrgatherei16.vv v16, v12, v20
...
; RV32-NEXT:    vl4r.v v12, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v20, v12, v26
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    vrgatherei16.vv v24, v4, v12
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    vl4r.v v4, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v12, v4, v30
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xc4, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 68 * vlenb
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle64.v v8, (a1)
; RV64-NEXT:    addi a4, a1, 128
; RV64-NEXT:    lui a3, 1
; RV64-NEXT:    lui a2, %hi(.LCPI27_0)
; RV64-NEXT:    addi a2, a2, %lo(.LCPI27_0)
; RV64-NEXT:    lui a5, 2
; RV64-NEXT:    lui a6, 4
; RV64-NEXT:    vle64.v v16, (a4)
; RV64-NEXT:    addi a4, a3, 65
; RV64-NEXT:    vmv.s.x v0, a4
; RV64-NEXT:    lui a4, 8
; RV64-NEXT:    addi a5, a5, 130
...
; RV64-NEXT:    vs8r.v v24, (a7) # vscale x 64-byte Folded Spill
; RV64-NEXT:    vmv.s.x v0, a5
; RV64-NEXT:    li a5, 1040
; RV64-NEXT:    addi a6, a6, 260
; RV64-NEXT:    addi a4, a4, 520
; RV64-NEXT:    addi a3, a3, -2016
; RV64-NEXT:    vmerge.vvm v24, v16, v8, v0
; RV64-NEXT:    csrr a7, vlenb
; RV64-NEXT:    li t0, 12
; RV64-NEXT:    mul a7, a7, t0
...
; RV64-NEXT:    addi a7, a7, 16
; RV64-NEXT:    vs8r.v v24, (a7) # vscale x 64-byte Folded Spill
; RV64-NEXT:    vmv.s.x v0, a6
; RV64-NEXT:    vmerge.vvm v24, v16, v8, v0
; RV64-NEXT:    csrr a6, vlenb
; RV64-NEXT:    slli a6, a6, 2
; RV64-NEXT:    add a6, sp, a6
; RV64-NEXT:    addi a6, a6, 16
; RV64-NEXT:    vs8r.v v24, (a6) # vscale x 64-byte Folded Spill
; RV64-NEXT:    vmv.s.x v0, a4
; RV64-NEXT:    vmerge.vvm v24, v16, v8, v0
; RV64-NEXT:    csrr a4, vlenb
; RV64-NEXT:    li a6, 36
; RV64-NEXT:    mul a4, a4, a6
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v0, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vrgatherei16.vv v24, v0, v10
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 12
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vslidedown.vi v4, v16, 1
; RV64-NEXT:    vslideup.vi v4, v16, 4, v0.t
; RV64-NEXT:    li a1, 128
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    vslideup.vi v12, v16, 2
; RV64-NEXT:    vsetivli zero, 8, e64, m8, ta, ma
; RV64-NEXT:    vslidedown.vi v24, v16, 8
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vslideup.vi v12, v24, 5, v0.t
; RV64-NEXT:    vslideup.vi v20, v16, 1
; RV64-NEXT:    vslideup.vi v20, v24, 4, v0.t
; RV64-NEXT:    vmv.v.v v28, v20
...
; RV64-NEXT:    vslideup.vi v20, v24, 6
; RV64-NEXT:    vslideup.vi v20, v24, 1, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 2
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
...
; RV64-NEXT:    vmerge.vvm v24, v8, v12, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 44
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vmerge.vvm v16, v8, v20, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 52
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
