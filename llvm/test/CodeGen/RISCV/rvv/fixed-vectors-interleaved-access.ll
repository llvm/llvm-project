...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs8r.v v8, (a1) # vscale x 64-byte Folded Spill
; RV32-NEXT:    lui a1, %hi(.LCPI20_3)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI20_3)
...
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs4r.v v12, (a2) # vscale x 32-byte Folded Spill
; RV64-NEXT:    lui a2, %hi(.LCPI20_0)
; RV64-NEXT:    addi a2, a2, %lo(.LCPI20_0)
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI20_1)
...
; RV64-NEXT:    lui a1, %hi(.LCPI20_2)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI20_2)
