...
; RV32-NEXT:    vmv1r.v v26, v0
; RV32-NEXT:    vrgatherei16.vv v12, v16, v2, v0.t
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li a5, 21
; RV32-NEXT:    mul a4, a4, a5
; RV32-NEXT:    add a4, sp, a4
...
; RV32-NEXT:    vmv2r.v v2, v24
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; RV32-NEXT:    vmv1r.v v1, v26
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v16, v24, v12, v0.t
...
; RV32-NEXT:    vrgatherei16.vv v20, v8, v12, v0.t
; RV32-NEXT:    vmv.v.v v8, v20
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v16, v24, v4
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 25
; RV32-NEXT:    mul a1, a1, a3
; RV32-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x36, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 54 * vlenb
...
; RV64-NEXT:    vrgatherei16.vv v16, v0, v14
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    li a1, 56
; RV64-NEXT:    vmv.s.x v9, a1
; RV64-NEXT:    vadd.vi v10, v14, -16
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgather.vi v16, v24, 5
; RV64-NEXT:    vmv1r.v v13, v8
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 21
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v0, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v16, v0, v10
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    li a1, 24
; RV64-NEXT:    vmv.s.x v9, a1
; RV64-NEXT:    vadd.vi v10, v14, -14
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    vmv1r.v v0, v9
; RV64-NEXT:    vrgatherei16.vv v16, v24, v10, v0.t
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v20, v24, v10
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 21
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    vrgatherei16.vv v28, v16, v12
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgather.vi v28, v16, 5, v0.t
; RV64-NEXT:    vsetivli zero, 5, e64, m4, tu, ma
...
; RV64-NEXT:    lui a1, 96
; RV64-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV64-NEXT:    vmv.v.x v13, a1
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    li a1, 192
; RV64-NEXT:    vmv.s.x v12, a1
; RV64-NEXT:    vrgather.vi v20, v8, 2
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vrgatherei16.vv v20, v16, v13, v0.t
; RV64-NEXT:    vmv.v.v v8, v20
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vadd.vi v24, v14, 4
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 45
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v0, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v16, v0, v24
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    li a1, 28
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    addi a1, sp, 16
; RV64-NEXT:    vs1r.v v0, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vadd.vi v2, v14, -12
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 37
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v16, v24, v2, v0.t
; RV64-NEXT:    vsetivli zero, 5, e64, m4, tu, ma
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v8, v16, v13, v0.t
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vadd.vi v12, v14, 5
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 45
; RV64-NEXT:    mul a1, a1, a2
