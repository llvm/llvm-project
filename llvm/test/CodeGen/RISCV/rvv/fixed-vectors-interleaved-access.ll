...
; RV32-NEXT:    vslideup.vi v12, v24, 2
; RV32-NEXT:    vmv1r.v v0, v7
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 84
; RV32-NEXT:    mul a1, a1, a4
...
; RV32-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vrgatherei16.vv v8, v8, v30
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 24
; RV32-NEXT:    mul a1, a1, a3
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vmerge.vvm v4, v24, v8, v0
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    vrgatherei16.vv v28, v16, v3
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v16, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vrgatherei16.vv v16, v16, v26
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 40
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v24, v20, v24
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
; RV32-NEXT:    vmv.v.v v24, v16
; RV32-NEXT:    addi a1, sp, 16
; RV32-NEXT:    vl8r.v v16, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vrgatherei16.vv v16, v16, v2
...
; RV32-NEXT:    vle16.v v2, (a1)
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vle16.v v1, (a2)
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 5
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl4r.v v20, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vrgatherei16.vv v20, v20, v0
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
; RV32-NEXT:    vmv.v.v v20, v16
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vrgatherei16.vv v8, v8, v2
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v12, v4, v1
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    vslideup.vi v12, v12, 5, v0.t
; RV64-NEXT:    vmv1r.v v0, v3
; RV64-NEXT:    vrgather.vi v12, v8, 4, v0.t
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 20
; RV64-NEXT:    mul a2, a2, a3
; RV64-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vl8r.v v16, (a2) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vslidedown.vi v12, v16, 1
; RV64-NEXT:    vmv1r.v v0, v2
; RV64-NEXT:    vslideup.vi v12, v16, 4, v0.t
; RV64-NEXT:    vmv1r.v v0, v3
; RV64-NEXT:    vrgather.vi v12, v8, 5, v0.t
; RV64-NEXT:    csrr a2, vlenb
...
; RV64-NEXT:    vmv.s.x v0, a2
; RV64-NEXT:    vslideup.vi v12, v8, 6
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 76
; RV64-NEXT:    mul a2, a2, a3
; RV64-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    vslideup.vi v8, v8, 5, v0.t
; RV64-NEXT:    lui a1, %hi(.LCPI8_0)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI8_0)
...
; RV64-NEXT:    vle16.v v26, (a2)
; RV64-NEXT:    vle16.v v2, (a3)
; RV64-NEXT:    vmv1r.v v0, v7
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v16, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vrgatherei16.vv v16, v16, v26
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 24
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vrgatherei16.vv v24, v24, v2
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs2r.v v12, (a1) # vscale x 16-byte Folded Spill
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 52
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vrgatherei16.vv v8, v8, v18
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 56
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
