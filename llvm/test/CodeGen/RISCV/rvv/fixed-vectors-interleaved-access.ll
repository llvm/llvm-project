...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vslideup.vi v24, v16, 6
; RV32-NEXT:    lui a1, 15
; RV32-NEXT:    vmv.s.x v0, a1
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 40
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs1r.v v12, (a1) # Unknown-size Folded Spill
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs1r.v v16, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vadd.vi v30, v28, -16
; RV64-NEXT:    vmv.v.v v6, v28
...
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    vadd.vi v18, v6, -15
; RV64-NEXT:    vmv2r.v v16, v6
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 46
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    vs4r.v v8, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vmv2r.v v30, v6
; RV64-NEXT:    vadd.vi v20, v6, 2
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 38
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    vrgatherei16.vv v8, v0, v20
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV64-NEXT:    li a1, 24
...
; RV64-NEXT:    vadd.vi v20, v30, -14
; RV64-NEXT:    vmv2r.v v22, v30
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 46
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v0, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vmv4r.v v16, v0
; RV64-NEXT:    vrgatherei16.vv v4, v0, v12
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 29
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs1r.v v20, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vadd.vi v20, v22, -12
; RV64-NEXT:    vmv2r.v v6, v22
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 46
; RV64-NEXT:    mul a1, a1, a2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl1r.v v0, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v16, v24, v8, v0.t
; RV64-NEXT:    vsetivli zero, 5, e64, m4, tu, ma
