...
; RV32-NEXT:    vslideup.vi v8, v24, 4
; RV32-NEXT:    lui a3, 12
; RV32-NEXT:    vmv.s.x v24, a3
...
; RV32-NEXT:    vrgatherei16.vv v0, v8, v28
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 44
; RV32-NEXT:    mul a1, a1, a4
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vl8r.v v16, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV32-NEXT:    vmerge.vvm v4, v8, v16, v0
...
; RV32-NEXT:    vrgatherei16.vv v20, v4, v3
; RV32-NEXT:    lui a1, %hi(.LCPI27_8)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI27_8)
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl4r.v v24, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vrgatherei16.vv v0, v24, v7
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 5
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xd1, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 81 * vlenb
