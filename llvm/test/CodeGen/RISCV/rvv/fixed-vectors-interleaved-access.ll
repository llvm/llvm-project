...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xc6, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 70 * vlenb
; RV32-NEXT:    addi a6, a1, 128
; RV32-NEXT:    li a2, 32
; RV32-NEXT:    lui a4, 12291
; RV32-NEXT:    lui a7, %hi(.LCPI27_0)
; RV32-NEXT:    addi a7, a7, %lo(.LCPI27_0)
; RV32-NEXT:    lui a3, 49164
; RV32-NEXT:    lui a5, 196656
; RV32-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV32-NEXT:    vle32.v v16, (a6)
; RV32-NEXT:    lui a6, 786624
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV32-NEXT:    vle16.v v8, (a7)
; RV32-NEXT:    csrr a7, vlenb
; RV32-NEXT:    li t0, 66
; RV32-NEXT:    mul a7, a7, t0
; RV32-NEXT:    add a7, sp, a7
; RV32-NEXT:    addi a7, a7, 16
; RV32-NEXT:    vs2r.v v8, (a7) # vscale x 16-byte Folded Spill
; RV32-NEXT:    lui a7, 768
; RV32-NEXT:    addi a4, a4, 3
...
; RV32-NEXT:    addi a6, a6, 192
; RV32-NEXT:    addi a7, a7, 768
; RV32-NEXT:    addi a4, a4, -1024
...
; RV32-NEXT:    vs1r.v v25, (a3) # vscale x 8-byte Folded Spill
; RV32-NEXT:    vmv.s.x v7, a5
; RV32-NEXT:    vmv.s.x v6, a6
; RV32-NEXT:    vmv.s.x v5, a7
...
; RV32-NEXT:    vmv.s.x v4, a4
; RV32-NEXT:    csrr a3, vlenb
; RV32-NEXT:    li a4, 58
; RV32-NEXT:    mul a3, a3, a4
; RV32-NEXT:    add a3, sp, a3
; RV32-NEXT:    addi a3, a3, 16
; RV32-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
; RV32-NEXT:    vmerge.vvm v24, v16, v8, v0
; RV32-NEXT:    csrr a3, vlenb
...
; RV32-NEXT:    add a3, sp, a3
; RV32-NEXT:    addi a3, a3, 16
; RV32-NEXT:    vl2r.v v8, (a3) # vscale x 16-byte Folded Reload
; RV32-NEXT:    csrr a3, vlenb
; RV32-NEXT:    li a4, 34
; RV32-NEXT:    mul a3, a3, a4
; RV32-NEXT:    add a3, sp, a3
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs4r.v v12, (a1) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vslideup.vi v12, v8, 4
; RV32-NEXT:    vslideup.vi v28, v8, 2
; RV32-NEXT:    vmv1r.v v0, v7
; RV32-NEXT:    vmerge.vvm v8, v16, v8, v0
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 30
...
; RV32-NEXT:    vs4r.v v12, (a2) # vscale x 32-byte Folded Spill
...
; RV32-NEXT:    vl8r.v v0, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    addi a1, sp, 16
; RV32-NEXT:    vl2r.v v22, (a1) # vscale x 16-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vrgatherei16.vv v8, v0, v22
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 14
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vrgatherei16.vv v16, v24, v20
...
; RV32-NEXT:    vle16.v v20, (a2)
; RV32-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV32-NEXT:    vle16.v v7, (a1)
; RV32-NEXT:    lui a1, %hi(.LCPI27_7)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI27_7)
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle16.v v22, (a1)
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 42
; RV32-NEXT:    mul a1, a1, a2
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vl4r.v v12, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v0, v12, v7
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    vl8r.v v24, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vrgatherei16.vv v8, v24, v22
...
; RV32-NEXT:    vrgatherei16.vv v20, v24, v12
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    vl4r.v v24, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v12, v24, v7
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xce, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 78 * vlenb
...
; RV64-NEXT:    vle16.v v6, (a3)
; RV64-NEXT:    li a3, 1040
; RV64-NEXT:    vmv.s.x v5, a3
; RV64-NEXT:    addi a3, a2, 65
; RV64-NEXT:    vmv.s.x v0, a3
; RV64-NEXT:    lui a3, 2
; RV64-NEXT:    addi a3, a3, 130
; RV64-NEXT:    vmv.s.x v3, a3
; RV64-NEXT:    lui a3, 4
; RV64-NEXT:    addi a3, a3, 260
; RV64-NEXT:    vmv.s.x v4, a3
; RV64-NEXT:    lui a3, 8
; RV64-NEXT:    addi a3, a3, 520
; RV64-NEXT:    addi a2, a2, -2016
...
; RV64-NEXT:    vrgatherei16.vv v8, v16, v6
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 30
; RV64-NEXT:    mul a2, a2, a3
; RV64-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    lui a3, %hi(.LCPI27_2)
; RV64-NEXT:    addi a3, a3, %lo(.LCPI27_2)
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs2r.v v10, (a2) # vscale x 16-byte Folded Spill
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl2r.v v6, (a1) # vscale x 16-byte Folded Reload
...
; RV64-NEXT:    vslideup.vi v4, v16, 2
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vrgather.vi v24, v8, 4, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 62
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vrgather.vi v28, v8, 5, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 10
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vslideup.vi v24, v8, 1, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 18
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vslideup.vi v24, v8, 5, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 14
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    addi a1, sp, 16
; RV64-NEXT:    vl2r.v v20, (a1) # vscale x 16-byte Folded Reload
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:    vsetivli zero, 5, e64, m4, tu, ma
; RV64-NEXT:    vmv.v.v v28, v0
; RV64-NEXT:    li a1, 192
; RV64-NEXT:    lui a2, %hi(.LCPI27_4)
; RV64-NEXT:    addi a2, a2, %lo(.LCPI27_4)
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vle16.v v8, (a2)
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 38
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs2r.v v8, (a2) # vscale x 16-byte Folded Spill
; RV64-NEXT:    vmv.s.x v0, a1
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV64-NEXT:    vrgather.vi v8, v16, 2
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 18
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl4r.v v12, (a1) # vscale x 32-byte Folded Reload
; RV64-NEXT:    vmerge.vvm v20, v8, v12, v0
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl2r.v v24, (a1) # vscale x 16-byte Folded Reload
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:    vmerge.vvm v16, v8, v12, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 54
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vrgatherei16.vv v10, v12, v18
