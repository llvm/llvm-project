...
; CHECK-NEXT:    vrgather.vv v8, v2, v1
; CHECK-NEXT:    vmv.v.i v0, 4
; CHECK-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
; CHECK-NEXT:    vslidedown.vi v4, v2, 4
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, mu
; CHECK-NEXT:    vrgather.vi v8, v4, 0, v0.t
; CHECK-NEXT:    vadd.vi v1, v1, 1
; CHECK-NEXT:    vrgather.vv v9, v2, v1
; CHECK-NEXT:    vrgather.vi v9, v4, 1, v0.t
; CHECK-NEXT:    ret
...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xc2, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 66 * vlenb
...
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vs2r.v v4, (a4) # Unknown-size Folded Spill
; RV32-NEXT:    vadd.vi v2, v4, -4
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li a5, 13
; RV32-NEXT:    mul a4, a4, a5
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vs2r.v v2, (a4) # Unknown-size Folded Spill
...
; RV32-NEXT:    vmv4r.v v4, v8
; RV32-NEXT:    vrgatherei16.vv v4, v16, v2, v0.t
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li a5, 37
; RV32-NEXT:    mul a4, a4, a5
; RV32-NEXT:    add a4, sp, a4
...
; RV32-NEXT:    vrgatherei16.vv v4, v8, v2
; RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a3, a1, 5
; RV32-NEXT:    add a1, a3, a1
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl2r.v v2, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vadd.vi v2, v2, -6
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 3
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs2r.v v2, (a1) # Unknown-size Folded Spill
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 57
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v4, v8, v2, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a3, a1, 5
; RV32-NEXT:    add a1, a3, a1
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl2r.v v4, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a3, 57
; RV32-NEXT:    mul a1, a1, a3
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v16, v8, v2, v0.t
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV32-NEXT:    vrgatherei16.vv v4, v24, v8, v0.t
...
; RV32-NEXT:    vl4r.v v4, (a2) # Unknown-size Folded Reload
; RV32-NEXT:    vse32.v v4, (a1)
...
; RV64-NEXT:    vrgather.vi v4, v16, 2, v0.t
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 4
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vs8r.v v16, (a1) # Unknown-size Folded Spill
; RV64-NEXT:    vmv.v.v v16, v4
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    li a1, 6
; RV64-NEXT:    vid.v v2
; RV64-NEXT:    vmul.vx v2, v2, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgather.vi v4, v8, 3, v0.t
; RV64-NEXT:    vmv.v.v v24, v4
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vadd.vi v4, v2, 1
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 5
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v16, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v12, v16, v4
; RV64-NEXT:    vmv1r.v v0, v1
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 4
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgatherei16.vv v24, v8, v4
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV64-NEXT:    li a1, 192
; RV64-NEXT:    vmv.s.x v22, a1
; RV64-NEXT:    vrgather.vi v4, v8, 2
; RV64-NEXT:    vmv1r.v v0, v22
; RV64-NEXT:    vrgatherei16.vv v4, v16, v12, v0.t
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vadd.vi v20, v2, 4
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    slli a1, a1, 5
; RV64-NEXT:    add a1, sp, a1
...
; RV64-NEXT:    addi a1, a1, 16
; RV64-NEXT:    vl8r.v v24, (a1) # Unknown-size Folded Reload
; RV64-NEXT:    vrgather.vi v8, v24, 3
; RV64-NEXT:    vmv1r.v v0, v22
