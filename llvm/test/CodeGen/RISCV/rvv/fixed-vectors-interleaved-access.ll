...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_0)
...
; RV32-NEXT:    lui a1, %hi(.LCPI28_1)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_1)
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs8r.v v8, (a1) # vscale x 64-byte Folded Spill
; RV32-NEXT:    lui a1, %hi(.LCPI28_3)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_3)
...
; RV32-NEXT:    lui a1, %hi(.LCPI28_2)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_2)
...
; RV32-NEXT:    lui a1, %hi(.LCPI28_4)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_4)
; RV32-NEXT:    lui a2, %hi(.LCPI28_5)
; RV32-NEXT:    addi a2, a2, %lo(.LCPI28_5)
; RV32-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV32-NEXT:    vle16.v v28, (a2)
; RV32-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV32-NEXT:    vle16.v v1, (a1)
; RV32-NEXT:    lui a1, %hi(.LCPI28_7)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_7)
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle16.v v2, (a1)
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    lui a1, %hi(.LCPI28_6)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_6)
; RV32-NEXT:    lui a2, %hi(.LCPI28_8)
; RV32-NEXT:    addi a2, a2, %lo(.LCPI28_8)
; RV32-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV32-NEXT:    vle16.v v8, (a1)
; RV32-NEXT:    lui a1, %hi(.LCPI28_9)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI28_9)
; RV32-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
...
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs4r.v v12, (a2) # vscale x 32-byte Folded Spill
; RV64-NEXT:    lui a2, %hi(.LCPI28_0)
; RV64-NEXT:    addi a2, a2, %lo(.LCPI28_0)
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI28_1)
...
; RV64-NEXT:    lui a1, %hi(.LCPI28_2)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI28_2)
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI28_3)
; RV64-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; RV64-NEXT:    vle16.v v8, (a1)
; RV64-NEXT:    lui a1, %hi(.LCPI28_4)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI28_4)
...
; RV64-NEXT:    lui a1, %hi(.LCPI28_5)
; RV64-NEXT:    addi a1, a1, %lo(.LCPI28_5)
; RV64-NEXT:    vle16.v v12, (a1)
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 61
; RV64-NEXT:    mul a1, a1, a2
...
; RV32-NEXT:    addi a1, a1, %lo(.LCPI79_0)
; RV32-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV32-NEXT:    vle16.v v21, (a1)
; RV32-NEXT:    vcompress.vm v8, v12, v11
; RV32-NEXT:    vsetivli zero, 8, e32, m4, ta, ma
