...
; RV32-NEXT:    vslideup.vi v24, v8, 10, v0.t
; RV32-NEXT:    csrr a5, vlenb
; RV32-NEXT:    li a6, 56
; RV32-NEXT:    mul a5, a5, a6
; RV32-NEXT:    add a5, sp, a5
; RV32-NEXT:    addi a5, a5, 16
; RV32-NEXT:    vs4r.v v24, (a5) # vscale x 32-byte Folded Spill
...
; RV32-NEXT:    lui a3, %hi(.LCPI27_2)
; RV32-NEXT:    addi a3, a3, %lo(.LCPI27_2)
...
; RV32-NEXT:    lui a1, %hi(.LCPI27_5)
; RV32-NEXT:    addi a1, a1, %lo(.LCPI27_5)
; RV32-NEXT:    lui a2, %hi(.LCPI27_4)
; RV32-NEXT:    addi a2, a2, %lo(.LCPI27_4)
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV32-NEXT:    vrgatherei16.vv v24, v0, v8
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
...
; RV32-NEXT:    vrgatherei16.vv v28, v12, v8
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV32-NEXT:    lui a2, %hi(.LCPI27_6)
; RV32-NEXT:    addi a2, a2, %lo(.LCPI27_6)
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV32-NEXT:    vle16.v v8, (a1)
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    slli a1, a1, 2
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vle16.v v12, (a2)
; RV32-NEXT:    addi a1, sp, 16
; RV32-NEXT:    vl4r.v v20, (a1) # vscale x 32-byte Folded Reload
; RV32-NEXT:    vrgatherei16.vv v16, v20, v12
; RV32-NEXT:    vsetivli zero, 10, e32, m4, tu, ma
...
; RV64-NEXT:    vslideup.vi v24, v16, 2
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vl1r.v v20, (a2) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vmv1r.v v0, v20
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 52
; RV64-NEXT:    mul a2, a2, a3
...
; RV64-NEXT:    vmerge.vvm v8, v28, v24, v0
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    slli a2, a2, 4
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
...
; RV64-NEXT:    vmv1r.v v0, v22
; RV64-NEXT:    vmerge.vvm v8, v8, v4, v0
...
; RV64-NEXT:    addi a1, a1, %lo(.LCPI27_0)
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vle16.v v16, (a1)
; RV64-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    vcompress.vm v14, v12, v9
; RV32-NEXT:    vrgather.vi v14, v16, 2, v0.t
; RV32-NEXT:    li a0, 36
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    vmerge.vvm v12, v16, v12, v0
; RV32-NEXT:    lui a0, %hi(.LCPI65_0)
; RV32-NEXT:    addi a0, a0, %lo(.LCPI65_0)
...
; RV64-NEXT:    vcompress.vm v14, v12, v9
...
; RV32-NEXT:    addi a0, a0, %lo(.LCPI78_0)
; RV32-NEXT:    vle16.v v9, (a0)
; RV32-NEXT:    vrgatherei16.vv v10, v12, v9
; RV32-NEXT:    vmv1r.v v9, v14
; RV32-NEXT:    ret
...
; RV64-NEXT:    li a0, 36
; RV64-NEXT:    vmv.s.x v0, a0
; RV64-NEXT:    lui a0, %hi(.LCPI78_0)
; RV64-NEXT:    vmerge.vvm v12, v16, v12, v0
; RV64-NEXT:    ld a0, %lo(.LCPI78_0)(a0)
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vmv.v.x v9, a0
; RV64-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV64-NEXT:    vrgatherei16.vv v10, v12, v9
