...
; CHECK-NEXT:    vmulh.vv v1, v8, v9
; CHECK-NEXT:    vmul.vv v2, v8, v9
; CHECK-NEXT:    vsra.vi v3, v2, 7
; CHECK-NEXT:    vmsne.vv v0, v1, v3
...
; CHECK-NEXT:    vmulh.vv v2, v8, v10
; CHECK-NEXT:    vmul.vv v4, v8, v10
; CHECK-NEXT:    vsra.vi v6, v4, 7
; CHECK-NEXT:    vmsne.vv v0, v2, v6
...
; CHECK-NEXT:    vmulh.vv v4, v8, v12
; CHECK-NEXT:    vmul.vv v8, v8, v12
; CHECK-NEXT:    vsra.vi v12, v8, 7
; CHECK-NEXT:    vmsne.vv v0, v4, v12
