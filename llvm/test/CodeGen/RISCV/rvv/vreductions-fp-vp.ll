...
; ZVFHMIN-NEXT:    srli a1, a2, 1
; ZVFHMIN-NEXT:    vsetvli a3, zero, e8, m1, ta, ma
; ZVFHMIN-NEXT:    slli a3, a2, 2
; ZVFHMIN-NEXT:    vslidedown.vx v1, v0, a1
; ZVFHMIN-NEXT:    mv a4, a0
; ZVFHMIN-NEXT:    bltu a0, a3, .LBB6_2
; ZVFHMIN-NEXT:  # %bb.1:
; ZVFHMIN-NEXT:    mv a4, a3
; ZVFHMIN-NEXT:  .LBB6_2:
; ZVFHMIN-NEXT:    slli a1, a2, 1
; ZVFHMIN-NEXT:    sub a5, a4, a1
; ZVFHMIN-NEXT:    sltu a6, a4, a5
; ZVFHMIN-NEXT:    addi a6, a6, -1
; ZVFHMIN-NEXT:    and a5, a6, a5
; ZVFHMIN-NEXT:    srli a2, a2, 2
; ZVFHMIN-NEXT:    vsetvli a6, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v26, v24, a2
; ZVFHMIN-NEXT:    vsetvli zero, a5, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vmv1r.v v0, v26
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
; ZVFHMIN-NEXT:    addi a6, sp, 16
; ZVFHMIN-NEXT:    vs8r.v v16, (a6) # Unknown-size Folded Spill
; ZVFHMIN-NEXT:    bltu a4, a1, .LBB6_4
; ZVFHMIN-NEXT:  # %bb.3:
...
; ZVFHMIN-NEXT:    vfredusum.vs v8, v16, v8, v0.t
; ZVFHMIN-NEXT:    vfmv.f.s fa5, v8
...
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa5
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m8, ta, ma
; ZVFHMIN-NEXT:    sub a3, a0, a3
; ZVFHMIN-NEXT:    sltu a0, a0, a3
; ZVFHMIN-NEXT:    addi a0, a0, -1
; ZVFHMIN-NEXT:    and a0, a0, a3
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    mv a3, a0
; ZVFHMIN-NEXT:    bltu a0, a1, .LBB6_6
; ZVFHMIN-NEXT:  # %bb.5:
...
; ZVFHMIN-NEXT:    vslidedown.vx v1, v0, a1
; ZVFHMIN-NEXT:    mv a4, a0
; ZVFHMIN-NEXT:    bltu a0, a3, .LBB7_2
; ZVFHMIN-NEXT:  # %bb.1:
; ZVFHMIN-NEXT:    mv a4, a3
; ZVFHMIN-NEXT:  .LBB7_2:
; ZVFHMIN-NEXT:    slli a1, a2, 1
...
; ZVFHMIN-NEXT:    addi a6, sp, 16
; ZVFHMIN-NEXT:    vs8r.v v16, (a6) # Unknown-size Folded Spill
; ZVFHMIN-NEXT:    bltu a4, a1, .LBB7_4
; ZVFHMIN-NEXT:  # %bb.3:
; ZVFHMIN-NEXT:    mv a4, a1
; ZVFHMIN-NEXT:  .LBB7_4:
; ZVFHMIN-NEXT:    vsetvli zero, a4, e16, m4, ta, ma
...
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    vsetvli zero, a4, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vfredosum.vs v8, v16, v8, v0.t
; ZVFHMIN-NEXT:    vfmv.f.s fa5, v8
; ZVFHMIN-NEXT:    fcvt.h.s fa5, fa5
; ZVFHMIN-NEXT:    fcvt.s.h fa5, fa5
; ZVFHMIN-NEXT:    vsetivli zero, 1, e32, m8, ta, ma
...
; ZVFHMIN-NEXT:    vfmv.s.f v8, fa5
; ZVFHMIN-NEXT:    mv a3, a0
; ZVFHMIN-NEXT:    bltu a0, a1, .LBB7_6
; ZVFHMIN-NEXT:  # %bb.5:
; ZVFHMIN-NEXT:    mv a3, a1
; ZVFHMIN-NEXT:  .LBB7_6:
; ZVFHMIN-NEXT:    vsetvli zero, a3, e16, m4, ta, ma
