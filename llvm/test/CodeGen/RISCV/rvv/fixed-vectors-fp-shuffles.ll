...
; CHECK-NEXT:    vrgather.vi v2, v10, 1, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrsub.vi v1, v1, 4
; CHECK-NEXT:    vmv.v.i v0, 12
; CHECK-NEXT:    vsetvli zero, zero, e64, m2, ta, mu
; CHECK-NEXT:    vrgatherei16.vv v2, v8, v1, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vrgatherei16.vv v2, v8, v1, v0.t
...
; RV64-NEXT:    vlse64.v v2, (a0), zero
; RV64-NEXT:    li a0, 3
; RV64-NEXT:    vmul.vx v1, v1, a0
; RV64-NEXT:    vmv.v.i v0, 3
; RV64-NEXT:    vsetvli zero, zero, e64, m2, ta, mu
; RV64-NEXT:    vrgatherei16.vv v2, v8, v1, v0.t
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; CHECK-NEXT:    vslideup.vi v2, v8, 3
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslideup.vi v2, v8, 7
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslidedown.vi v4, v8, 6
; CHECK-NEXT:    vslideup.vi v4, v8, 2
...
; CHECK-NEXT:    vslideup.vi v4, v8, 3
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
