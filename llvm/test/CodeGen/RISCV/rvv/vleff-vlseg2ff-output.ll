...
declare {riscv_m1x2, i64} @llvm.riscv.vlseg2ff.mask.riscv_m1x2(riscv_m1x2, ptr, <vscale x 8 x i1>, i64, i64, i64)
...
define i64 @test_vlseg2ff_nxv8i8(ptr %base, i64 %vl, ptr %outvl) {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:gprnox0 = COPY $x11
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:gpr = COPY $x10
  ; CHECK-NEXT:   [[PseudoVLSEG2E8FF_V_M1_:%[0-9]+]]:vrn2m1, [[PseudoVLSEG2E8FF_V_M1_1:%[0-9]+]]:gpr = PseudoVLSEG2E8FF_V_M1 $noreg, [[COPY1]], [[COPY]], 3 /* e8 */, 2 /* tu, ma */, implicit-def dead $vl :: (load unknown-size from %ir.base, align 8)
...
entry:
  ...
  %1 = extractvalue {riscv_m1x2, i64} %0, 1
  ret i64 %1
}

define i64 @test_vlseg2ff_nxv8i8_tu(riscv_m1x2 %val, ptr %base, i64 %vl, ptr %outvl) {
  ...
  ; CHECK-NEXT:   [[PseudoVLSEG2E8FF_V_M1_:%[0-9]+]]:vrn2m1, [[PseudoVLSEG2E8FF_V_M1_1:%[0-9]+]]:gpr = PseudoVLSEG2E8FF_V_M1 [[COPY2]], [[COPY1]], [[COPY]], 3 /* e8 */, 2 /* tu, ma */, implicit-def dead $vl :: (load unknown-size from %ir.base, align 8)
  ; CHECK-NEXT:   $x10 = COPY [[PseudoVLSEG2E8FF_V_M1_1]]
  ; CHECK-NEXT:   PseudoRET implicit $x10
entry:
  %0 = tail call {riscv_m1x2, i64} @llvm.riscv.vlseg2ff.riscv_m1x2(riscv_m1x2 %val, ptr %base, i64 %vl, i64 3)
  %1 = extractvalue {riscv_m1x2, i64} %0, 1
  ret i64 %1
}

define i64 @test_vlseg2ff_nxv8i8_mask(riscv_m1x2 %val, ptr %base, <vscale x 8 x i1> %mask, i64 %vl, ptr %outvl) {
  ...
  ; CHECK-NEXT:   $v0 = COPY [[COPY1]]
  ; CHECK-NEXT:   [[PseudoVLSEG2E8FF_V_M1_MASK:%[0-9]+]]:vrn2m1nov0, [[PseudoVLSEG2E8FF_V_M1_MASK1:%[0-9]+]]:gpr = PseudoVLSEG2E8FF_V_M1_MASK [[COPY3]], [[COPY2]], $v0, [[COPY]], 3 /* e8 */, 0 /* tu, mu */, implicit-def dead $vl :: (load unknown-size from %ir.base, align 8)
  ; CHECK-NEXT:   $x10 = COPY [[PseudoVLSEG2E8FF_V_M1_MASK1]]
  ; CHECK-NEXT:   PseudoRET implicit $x10
entry:
  %0 = tail call {riscv_m1x2, i64} @llvm.riscv.vlseg2ff.mask.riscv_m1x2(riscv_m1x2 %val, ptr %base, <vscale x 8 x i1> %mask, i64 %vl, i64 0, i64 3)
  %1 = extractvalue {riscv_m1x2, i64} %0, 1
  ret i64 %1
}
