...
; RUN: llc -mtriple=riscv32 -mattr=+v,+experimental-xrivosvizip -verify-machineinstrs < %s | FileCheck %s --check-prefixes=ZIP,ZIP-RV32
; RUN: llc -mtriple=riscv64 -mattr=+v,+experimental-xrivosvizip -verify-machineinstrs < %s | FileCheck %s --check-prefixes=ZIP,ZIP-RV64
...
; ZIP-RV32:       # %bb.0: # %entry
; ZIP-RV32-NEXT:    lh a3, 0(a1)
; ZIP-RV32-NEXT:    lh a4, 0(a2)
; ZIP-RV32-NEXT:    lh a1, 8(a1)
; ZIP-RV32-NEXT:    lh a2, 8(a2)
; ZIP-RV32-NEXT:    sh a3, 0(a0)
; ZIP-RV32-NEXT:    sh a4, 2(a0)
; ZIP-RV32-NEXT:    sh a1, 4(a0)
; ZIP-RV32-NEXT:    sh a2, 6(a0)
; ZIP-RV32-NEXT:    ret
;
; ZIP-RV64-LABEL: zipeven_v4f16:
; ZIP-RV64:       # %bb.0: # %entry
; ZIP-RV64-NEXT:    lh a3, 0(a1)
; ZIP-RV64-NEXT:    lh a4, 0(a2)
; ZIP-RV64-NEXT:    lh a1, 16(a1)
; ZIP-RV64-NEXT:    lh a2, 16(a2)
; ZIP-RV64-NEXT:    sh a3, 0(a0)
; ZIP-RV64-NEXT:    sh a4, 2(a0)
; ZIP-RV64-NEXT:    sh a1, 4(a0)
; ZIP-RV64-NEXT:    sh a2, 6(a0)
; ZIP-RV64-NEXT:    ret
entry:
