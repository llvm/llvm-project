...
; V-NEXT:    vslideup.vi v20, v13, 2
; V-NEXT:    vslideup.vi v21, v11, 2
; V-NEXT:    vslideup.vi v22, v9, 2
; V-NEXT:    li a0, -256
...
; V-NEXT:    vmv.v.v v0, v16
; V-NEXT:    vslideup.vi v20, v13, 1, v0.t
; V-NEXT:    vmv.v.v v0, v17
; V-NEXT:    vslidedown.vi v12, v12, 1, v0.t
; V-NEXT:    vmv.v.v v0, v18
; V-NEXT:    vmerge.vvm v14, v12, v20, v0
; V-NEXT:    vmv.v.v v0, v16
; V-NEXT:    vslideup.vi v21, v11, 1, v0.t
; V-NEXT:    vmv.v.v v0, v17
; V-NEXT:    vslidedown.vi v10, v10, 1, v0.t
; V-NEXT:    vmv.v.v v0, v18
; V-NEXT:    vmerge.vvm v13, v10, v21, v0
; V-NEXT:    vmv.v.v v0, v16
; V-NEXT:    vslideup.vi v22, v9, 1, v0.t
; V-NEXT:    vmv.v.v v0, v17
; V-NEXT:    vslidedown.vi v8, v8, 1, v0.t
; V-NEXT:    vmv.v.v v0, v18
; V-NEXT:    vmerge.vvm v12, v8, v22, v0
; V-NEXT:    vmv.s.x v0, a0
...
; ZVE32F-NEXT:    vslide1down.vx v13, v8, a7
; ZVE32F-NEXT:    ld a7, 0(a2)
; ZVE32F-NEXT:    ld t0, 16(a2)
; ZVE32F-NEXT:    ld t1, 32(a2)
; ZVE32F-NEXT:    ld t2, 48(a2)
; ZVE32F-NEXT:    vmv.v.x v8, a7
; ZVE32F-NEXT:    srli a7, a7, 32
; ZVE32F-NEXT:    vmv.v.x v9, t1
; ZVE32F-NEXT:    srli t1, t1, 32
; ZVE32F-NEXT:    vslide1down.vx v14, v9, t1
; ZVE32F-NEXT:    vslide1down.vx v15, v8, a7
; ZVE32F-NEXT:    ld a7, 64(a2)
; ZVE32F-NEXT:    ld t1, 112(a2)
; ZVE32F-NEXT:    vmv.v.x v8, a4
; ZVE32F-NEXT:    srli a4, a4, 32
; ZVE32F-NEXT:    vslide1down.vx v16, v8, a4
; ZVE32F-NEXT:    ld a2, 80(a2)
; ZVE32F-NEXT:    vmv.v.x v8, a7
; ZVE32F-NEXT:    srli a4, a7, 32
; ZVE32F-NEXT:    vslide1down.vx v17, v8, a4
; ZVE32F-NEXT:    vslide1down.vx v8, v11, a1
; ZVE32F-NEXT:    srli a1, a1, 32
; ZVE32F-NEXT:    vslide1down.vx v9, v8, a1
; ZVE32F-NEXT:    vslide1down.vx v8, v10, a6
; ZVE32F-NEXT:    srli a1, a6, 32
; ZVE32F-NEXT:    vslide1down.vx v18, v8, a1
; ZVE32F-NEXT:    vslide1down.vx v8, v12, a5
; ZVE32F-NEXT:    srli a5, a5, 32
; ZVE32F-NEXT:    vslide1down.vx v8, v8, a5
; ZVE32F-NEXT:    vslide1down.vx v10, v13, a3
; ZVE32F-NEXT:    srli a3, a3, 32
; ZVE32F-NEXT:    vslide1down.vx v12, v10, a3
; ZVE32F-NEXT:    vslide1down.vx v10, v14, t2
; ZVE32F-NEXT:    srli a1, t2, 32
; ZVE32F-NEXT:    vslide1down.vx v10, v10, a1
; ZVE32F-NEXT:    vslide1down.vx v11, v15, t0
; ZVE32F-NEXT:    srli a1, t0, 32
; ZVE32F-NEXT:    vslide1down.vx v13, v11, a1
; ZVE32F-NEXT:    vslide1down.vx v11, v16, t1
; ZVE32F-NEXT:    srli a1, t1, 32
; ZVE32F-NEXT:    vslide1down.vx v11, v11, a1
; ZVE32F-NEXT:    vmv.v.i v0, 15
; ZVE32F-NEXT:    vslide1down.vx v14, v17, a2
; ZVE32F-NEXT:    srli a2, a2, 32
; ZVE32F-NEXT:    vslide1down.vx v14, v14, a2
; ZVE32F-NEXT:    vslidedown.vi v9, v18, 4, v0.t
; ZVE32F-NEXT:    vslidedown.vi v8, v12, 4, v0.t
; ZVE32F-NEXT:    vslidedown.vi v10, v13, 4, v0.t
