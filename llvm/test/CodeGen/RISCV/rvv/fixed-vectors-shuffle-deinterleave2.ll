...
; V-NOZIP-LABEL: vnsrl_0_i64_two_source:
; V-NOZIP:       # %bb.0: # %entry
; V-NOZIP-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; V-NOZIP-NEXT:    vle64.v v8, (a0)
; V-NOZIP-NEXT:    vle64.v v9, (a1)
; V-NOZIP-NEXT:    vslideup.vi v8, v9, 1
; V-NOZIP-NEXT:    vse64.v v8, (a2)
; V-NOZIP-NEXT:    ret
;
...
; ZIP-NEXT:    ri.vunzip2a.vv v11, v8, v10
; ZIP-NEXT:    ri.vunzip2a.vv v10, v9, v8
; ZIP-NEXT:    vslideup.vi v11, v10, 1
; ZIP-NEXT:    vse64.v v11, (a2)
; ZIP-NEXT:    ret
entry:
...
; V-NOZIP-LABEL: vnsrl_64_i64_two_source:
; V-NOZIP:       # %bb.0: # %entry
; V-NOZIP-NEXT:    vsetivli zero, 2, e64, m1, ta, mu
; V-NOZIP-NEXT:    vle64.v v8, (a0)
; V-NOZIP-NEXT:    vle64.v v9, (a1)
...
; ZIP-NEXT:    vle64.v v8, (a0)
; ZIP-NEXT:    vle64.v v9, (a1)
; ZIP-NEXT:    ri.vunzip2b.vv v11, v8, v10
; ZIP-NEXT:    ri.vunzip2b.vv v10, v9, v8
; ZIP-NEXT:    vslideup.vi v11, v10, 1
; ZIP-NEXT:    vse64.v v11, (a2)
; ZIP-NEXT:    ret
entry:
...
; V-NOZIP-LABEL: vnsrl_64_double_two_source:
; V-NOZIP:       # %bb.0: # %entry
; V-NOZIP-NEXT:    vsetivli zero, 2, e64, m1, ta, mu
; V-NOZIP-NEXT:    vle64.v v8, (a0)
; V-NOZIP-NEXT:    vle64.v v9, (a1)
