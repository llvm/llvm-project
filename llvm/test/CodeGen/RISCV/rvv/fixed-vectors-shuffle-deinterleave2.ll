...
; ZVE32F:       # %bb.0: # %entry
; ZVE32F-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVE32F-NEXT:    vmv.v.i v8, 1
; ZVE32F-NEXT:    vle32.v v9, (a0)
; ZVE32F-NEXT:    vsetivli zero, 2, e32, m1, ta, mu
; ZVE32F-NEXT:    vslidedown.vi v10, v9, 2
; ZVE32F-NEXT:    vmv1r.v v0, v8
; ZVE32F-NEXT:    vslidedown.vi v10, v9, 1, v0.t
...
; V-NEXT:    vsetivli zero, 4, e64, m1, ta, ma
; V-NEXT:    vmv.v.i v8, 1
; V-NEXT:    vle64.v v9, (a0)
; V-NEXT:    vsetivli zero, 2, e64, m1, ta, mu
; V-NEXT:    vslidedown.vi v10, v9, 2
; V-NEXT:    vmv1r.v v0, v8
; V-NEXT:    vslidedown.vi v10, v9, 1, v0.t
