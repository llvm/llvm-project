...
; SPILL-O0-NEXT:    sw ra, 28(sp) # 4-byte Spill
...
; SPILL-O0-NEXT:    sw a0, 8(sp) # 4-byte Spill
...
; SPILL-O0-NEXT:    vs1r.v v9, (a1) # vscale x 8-byte Spill
...
; SPILL-O0-NEXT:    vl1r.v v10, (a1) # vscale x 8-byte Reload
; SPILL-O0-NEXT:    csrr a1, vlenb
; SPILL-O0-NEXT:    add a1, sp, a1
; SPILL-O0-NEXT:    addi a1, a1, 16
; SPILL-O0-NEXT:    vl1r.v v9, (a1) # vscale x 8-byte Reload
; SPILL-O0-NEXT:    # kill: def $x11 killed $x10
; SPILL-O0-NEXT:    lw a0, 8(sp) # 4-byte Reload
; SPILL-O0-NEXT:    # implicit-def: $v8
; SPILL-O0-NEXT:    vsetvli zero, a0, e64, m1, tu, ma
; SPILL-O0-NEXT:    vfadd.vv v8, v9, v10
...
; SPILL-O0-NEXT:    lw ra, 28(sp) # 4-byte Reload
...
; SPILL-O2-NEXT:    sw ra, 28(sp) # 4-byte Spill
; SPILL-O2-NEXT:    sw s0, 24(sp) # 4-byte Spill
...
; SPILL-O2-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; SPILL-O2-NEXT:    vs1r.v v9, (a0) # vscale x 8-byte Spill
...
; SPILL-O2-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
...
; SPILL-O2-NEXT:    lw ra, 28(sp) # 4-byte Reload
; SPILL-O2-NEXT:    lw s0, 24(sp) # 4-byte Reload
...
; SPILL-O2-ZCMP-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; SPILL-O2-ZCMP-NEXT:    vs1r.v v9, (a0) # vscale x 8-byte Spill
...
; SPILL-O2-ZCMP-NEXT:    add a0, a0, sp
; SPILL-O2-ZCMP-NEXT:    addi a0, a0, 16
; SPILL-O2-ZCMP-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O2-ZCMP-NEXT:    addi a0, sp, 16
; SPILL-O2-ZCMP-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
...
; SPILL-O0-VSETVLI-NEXT:    sw ra, 28(sp) # 4-byte Spill
...
; SPILL-O0-VSETVLI-NEXT:    sw a0, 8(sp) # 4-byte Spill
...
; SPILL-O0-VSETVLI-NEXT:    vs1r.v v9, (a1) # vscale x 8-byte Spill
...
; SPILL-O0-VSETVLI-NEXT:    vl1r.v v10, (a1) # vscale x 8-byte Reload
; SPILL-O0-VSETVLI-NEXT:    csrr a1, vlenb
; SPILL-O0-VSETVLI-NEXT:    add a1, sp, a1
; SPILL-O0-VSETVLI-NEXT:    addi a1, a1, 16
; SPILL-O0-VSETVLI-NEXT:    vl1r.v v9, (a1) # vscale x 8-byte Reload
; SPILL-O0-VSETVLI-NEXT:    # kill: def $x11 killed $x10
; SPILL-O0-VSETVLI-NEXT:    lw a0, 8(sp) # 4-byte Reload
; SPILL-O0-VSETVLI-NEXT:    # implicit-def: $v8
; SPILL-O0-VSETVLI-NEXT:    vsetvli zero, a0, e64, m1, tu, ma
; SPILL-O0-VSETVLI-NEXT:    vfadd.vv v8, v9, v10
...
; SPILL-O0-VSETVLI-NEXT:    lw ra, 28(sp) # 4-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    sw ra, 28(sp) # 4-byte Spill
; SPILL-O2-VSETVLI-NEXT:    sw s0, 24(sp) # 4-byte Spill
...
; SPILL-O2-VSETVLI-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; SPILL-O2-VSETVLI-NEXT:    vs1r.v v9, (a0) # vscale x 8-byte Spill
...
; SPILL-O2-VSETVLI-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    lw ra, 28(sp) # 4-byte Reload
; SPILL-O2-VSETVLI-NEXT:    lw s0, 24(sp) # 4-byte Reload
...
; SPILL-O2-ZCMP-VSETVLI-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; SPILL-O2-ZCMP-VSETVLI-NEXT:    vs1r.v v9, (a0) # vscale x 8-byte Spill
...
; SPILL-O2-ZCMP-VSETVLI-NEXT:    add a0, a0, sp
; SPILL-O2-ZCMP-VSETVLI-NEXT:    addi a0, a0, 16
; SPILL-O2-ZCMP-VSETVLI-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O2-ZCMP-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O2-ZCMP-VSETVLI-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
...
; SPILL-O2-ZCMP-VSETVLI-NEXT:    cm.popret {ra, s0}, 32
{
   ...
   %z = call <vscale x 1 x double> @llvm.riscv.vfadd.nxv1f64.nxv1f64(<vscale x 1 x double> poison, <vscale x 1 x double> %a, <vscale x 1 x double> %x, i32 7, i32 %gvl)
