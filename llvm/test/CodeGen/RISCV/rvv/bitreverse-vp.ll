...
; CHECK-NEXT:    vand.vi v1, v8, 15, v0.t
; CHECK-NEXT:    vsll.vi v1, v1, 4, v0.t
; CHECK-NEXT:    vsrl.vi v2, v8, 4, v0.t
; CHECK-NEXT:    vand.vi v2, v2, 15, v0.t
; CHECK-NEXT:    vor.vv v1, v2, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 2, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vand.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vsll.vi v1, v1, 2, v0.t
; CHECK-NEXT:    vor.vv v1, v2, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vand.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vsll.vi v1, v1, 1, v0.t
...
; CHECK-NEXT:    vand.vi v2, v8, 15, v0.t
; CHECK-NEXT:    vsll.vi v2, v2, 4, v0.t
; CHECK-NEXT:    vsrl.vi v4, v8, 4, v0.t
; CHECK-NEXT:    vand.vi v4, v4, 15, v0.t
; CHECK-NEXT:    vor.vv v2, v4, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 2, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsll.vi v2, v2, 2, v0.t
; CHECK-NEXT:    vor.vv v2, v4, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsll.vi v2, v2, 1, v0.t
...
; CHECK-NEXT:    vand.vi v4, v8, 15, v0.t
; CHECK-NEXT:    vsll.vi v4, v4, 4, v0.t
...
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsll.vi v4, v4, 2, v0.t
; CHECK-NEXT:    vor.vv v4, v8, v4, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsll.vi v4, v4, 1, v0.t
...
; RV32-NEXT:    vand.vv v1, v1, v3, v0.t
; RV32-NEXT:    vsll.vi v1, v1, 4, v0.t
; RV32-NEXT:    vor.vv v1, v2, v1, v0.t
...
; RV32-NEXT:    vand.vv v2, v2, v3, v0.t
; RV32-NEXT:    vand.vv v1, v1, v3, v0.t
; RV32-NEXT:    vsll.vi v1, v1, 2, v0.t
; RV32-NEXT:    vor.vv v1, v2, v1, v0.t
...
; RV32-NEXT:    vand.vv v2, v2, v3, v0.t
; RV32-NEXT:    vand.vv v1, v1, v3, v0.t
; RV32-NEXT:    vsll.vi v1, v1, 1, v0.t
; RV32-NEXT:    vor.vv v8, v2, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsll.vi v1, v1, 4, v0.t
; RV64-NEXT:    vor.vv v1, v2, v1, v0.t
...
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vand.vx v1, v1, a0, v0.t
; RV64-NEXT:    vsll.vi v1, v1, 2, v0.t
; RV64-NEXT:    vor.vv v1, v2, v1, v0.t
...
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vand.vx v1, v1, a0, v0.t
; RV64-NEXT:    vsll.vi v1, v1, 1, v0.t
; RV64-NEXT:    vor.vv v8, v2, v1, v0.t
; RV64-NEXT:    ret
;
...
; RV32-NEXT:    vand.vv v2, v2, v6, v0.t
; RV32-NEXT:    vsll.vi v2, v2, 4, v0.t
; RV32-NEXT:    vor.vv v2, v4, v2, v0.t
...
; RV32-NEXT:    vand.vv v4, v4, v6, v0.t
; RV32-NEXT:    vand.vv v2, v2, v6, v0.t
; RV32-NEXT:    vsll.vi v2, v2, 2, v0.t
; RV32-NEXT:    vor.vv v2, v4, v2, v0.t
...
; RV32-NEXT:    vand.vv v4, v4, v6, v0.t
; RV32-NEXT:    vand.vv v2, v2, v6, v0.t
; RV32-NEXT:    vsll.vi v2, v2, 1, v0.t
; RV32-NEXT:    vor.vv v8, v4, v2, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vsll.vi v2, v2, 4, v0.t
; RV64-NEXT:    vor.vv v2, v4, v2, v0.t
...
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vsll.vi v2, v2, 2, v0.t
; RV64-NEXT:    vor.vv v2, v4, v2, v0.t
...
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vsll.vi v2, v2, 1, v0.t
; RV64-NEXT:    vor.vv v8, v4, v2, v0.t
; RV64-NEXT:    ret
;
...
; RV32-NEXT:    vor.vv v4, v12, v4, v0.t
...
; RV32-NEXT:    vsll.vi v4, v4, 4, v0.t
...
; RV32-NEXT:    vand.vv v8, v8, v12, v0.t
; RV32-NEXT:    vand.vv v4, v4, v12, v0.t
; RV32-NEXT:    vsll.vi v4, v4, 2, v0.t
; RV32-NEXT:    vor.vv v4, v8, v4, v0.t
...
; RV32-NEXT:    vand.vv v8, v8, v12, v0.t
; RV32-NEXT:    vand.vv v4, v4, v12, v0.t
; RV32-NEXT:    vsll.vi v4, v4, 1, v0.t
...
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vsll.vi v4, v4, 4, v0.t
...
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vsll.vi v4, v4, 2, v0.t
; RV64-NEXT:    vor.vv v4, v8, v4, v0.t
...
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vsll.vi v4, v4, 1, v0.t
; RV64-NEXT:    vor.vv v8, v8, v4, v0.t
; RV64-NEXT:    ret
;
...
; CHECK-NEXT:    vsll.vi v1, v1, 1, v0.t
; CHECK-NEXT:    vor.vv v1, v2, v1, v0.t
; CHECK-NEXT:    vsrl.vi v8, v1, 7, v0.t
; CHECK-NEXT:    ret
;
; CHECK-ZVBB-LABEL: vp_bitreverse_nxv1i9:
; CHECK-ZVBB:       # %bb.0:
; CHECK-ZVBB-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-ZVBB-NEXT:    vbrev.v v1, v8, v0.t
; CHECK-ZVBB-NEXT:    vsrl.vi v8, v1, 7, v0.t
; CHECK-ZVBB-NEXT:    ret
