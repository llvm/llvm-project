...
; CHECK-NEXT:    vsll.vi v10, v8, 24, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
...
; CHECK-NEXT:    vsll.vi v12, v8, 24, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    lui a0, 61681
; CHECK-NEXT:    addi a0, a0, -241
; CHECK-NEXT:    vsll.vi v8, v8, 8, v0.t
...
; CHECK-NEXT:    vsll.vi v16, v8, 24, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    lui a0, 61681
; CHECK-NEXT:    addi a0, a0, -241
; CHECK-NEXT:    vsll.vi v8, v8, 8, v0.t
...
; CHECK-NEXT:    vsll.vi v24, v8, 24, v0.t
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    lui a0, 61681
; CHECK-NEXT:    addi a0, a0, -241
; CHECK-NEXT:    vsll.vi v8, v8, 8, v0.t
...
; RV64-NEXT:    vand.vx v9, v9, a2, v0.t
...
; RV32-NEXT:    vsrl.vx v16, v8, a5, v0.t
; RV32-NEXT:    vand.vx v18, v8, a2, v0.t
; RV32-NEXT:    vand.vx v16, v16, a2, v0.t
; RV32-NEXT:    vor.vv v10, v16, v10, v0.t
; RV32-NEXT:    vlse64.v v16, (a6), zero
; RV32-NEXT:    vsll.vx v18, v18, a5, v0.t
; RV32-NEXT:    vor.vv v12, v12, v18, v0.t
; RV32-NEXT:    vsrl.vi v18, v8, 8, v0.t
; RV32-NEXT:    vand.vx v14, v14, a1, v0.t
...
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vor.vv v10, v14, v10, v0.t
...
; RV32-NEXT:    vand.vx v28, v8, a2, v0.t
; RV32-NEXT:    vand.vx v24, v24, a2, v0.t
; RV32-NEXT:    vor.vv v12, v24, v12, v0.t
; RV32-NEXT:    vlse64.v v24, (a6), zero
; RV32-NEXT:    vsll.vx v28, v28, a5, v0.t
; RV32-NEXT:    vor.vv v16, v16, v28, v0.t
; RV32-NEXT:    vsrl.vi v28, v8, 8, v0.t
; RV32-NEXT:    vand.vx v20, v20, a1, v0.t
; RV32-NEXT:    vand.vv v28, v28, v24, v0.t
; RV32-NEXT:    vor.vv v20, v28, v20, v0.t
; RV32-NEXT:    lui a2, 61681
; RV32-NEXT:    lui a3, 209715
; RV32-NEXT:    lui a4, 349525
...
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vor.vv v20, v20, v12, v0.t
...
; RV32-NEXT:    vand.vv v20, v20, v24, v0.t
; RV32-NEXT:    vsll.vi v16, v16, 4, v0.t
; RV32-NEXT:    vor.vv v16, v20, v16, v0.t
; RV32-NEXT:    vsrl.vi v20, v16, 2, v0.t
; RV32-NEXT:    vand.vv v16, v16, v12, v0.t
; RV32-NEXT:    vand.vv v12, v20, v12, v0.t
...
; RV64-NEXT:    vor.vv v24, v8, v24, v0.t
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    slli a0, a0, 4
; RV64-NEXT:    add a0, sp, a0
; RV64-NEXT:    addi a0, a0, 16
