...
; RV32-NEXT:    vand.vx v14, v14, a5, v0.t
...
; RV32-NEXT:    vand.vx v20, v20, a5, v0.t
...
; RV32-NEXT:    vand.vv v12, v12, v24, v0.t
; RV32-NEXT:    vsll.vi v8, v8, 4, v0.t
; RV32-NEXT:    vor.vv v8, v12, v8, v0.t
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Folded Reload
; RV32-NEXT:    vor.vv v16, v24, v8, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a2, 24
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x19, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 25 * vlenb
