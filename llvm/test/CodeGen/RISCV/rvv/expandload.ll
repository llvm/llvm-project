...
; CHECK-RV32-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Spill
...
; CHECK-RV32-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
; CHECK-RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
...
; CHECK-RV32-NEXT:    vs8r.v v8, (a3) # vscale x 64-byte Spill
...
; CHECK-RV32-NEXT:    vl8r.v v16, (a0) # vscale x 64-byte Reload
; CHECK-RV32-NEXT:    addi a0, sp, 16
; CHECK-RV32-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Reload
...
; CHECK-RV64-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    vs8r.v v8, (a4) # vscale x 64-byte Spill
; CHECK-RV64-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
...
; CHECK-RV64-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Reload
; CHECK-RV64-NEXT:    csrr a0, vlenb
; CHECK-RV64-NEXT:    li a1, 24
; CHECK-RV64-NEXT:    mul a0, a0, a1
; CHECK-RV64-NEXT:    add a0, sp, a0
; CHECK-RV64-NEXT:    addi a0, a0, 16
; CHECK-RV64-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
...
; CHECK-RV64-NEXT:    add a0, sp, a0
; CHECK-RV64-NEXT:    addi a0, a0, 16
; CHECK-RV64-NEXT:    vl8r.v v16, (a0) # vscale x 64-byte Reload
; CHECK-RV64-NEXT:    addi a0, sp, 16
; CHECK-RV64-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Reload
...
; CHECK-RV32-NEXT:    vs8r.v v24, (a5) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    add a4, sp, a4
; CHECK-RV64-NEXT:    addi a4, a4, 16
; CHECK-RV64-NEXT:    vs8r.v v24, (a4) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    add a0, sp, a0
; CHECK-RV64-NEXT:    addi a0, a0, 16
; CHECK-RV64-NEXT:    vs8r.v v24, (a0) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    add a0, sp, a0
; CHECK-RV64-NEXT:    addi a0, a0, 16
; CHECK-RV64-NEXT:    vs8r.v v16, (a0) # vscale x 64-byte Spill
; CHECK-RV64-NEXT:    vmv1r.v v0, v7
; CHECK-RV64-NEXT:    csrr a0, vlenb
; CHECK-RV64-NEXT:    li a1, 24
; CHECK-RV64-NEXT:    mul a0, a0, a1
...
; CHECK-RV32-NEXT:    vs8r.v v24, (a4) # vscale x 64-byte Spill
...
; CHECK-RV32-NEXT:    add a0, sp, a0
; CHECK-RV32-NEXT:    addi a0, a0, 16
; CHECK-RV32-NEXT:    vs8r.v v24, (a0) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    vs8r.v v24, (a3) # vscale x 64-byte Spill
; CHECK-RV64-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-RV64-NEXT:    vcpop.m a3, v7
...
; CHECK-RV32-NEXT:    add a1, sp, a1
; CHECK-RV32-NEXT:    addi a1, a1, 16
; CHECK-RV32-NEXT:    vs8r.v v24, (a1) # vscale x 64-byte Spill
...
; CHECK-RV64-NEXT:    add a1, sp, a1
; CHECK-RV64-NEXT:    addi a1, a1, 16
; CHECK-RV64-NEXT:    vs8r.v v24, (a1) # vscale x 64-byte Spill
