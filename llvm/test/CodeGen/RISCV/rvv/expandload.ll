...
; CHECK-RV32-NEXT:    add a3, a5, a3
; CHECK-RV32-NEXT:    add a4, a6, a4
...
; CHECK-RV64-NEXT:    vsetvli zero, a3, e8, m8, ta, ma
...
; CHECK-RV64-NEXT:    vmv.x.s a4, v8
; CHECK-RV64-NEXT:    cpop a3, a3
; CHECK-RV64-NEXT:    cpop a4, a4
; CHECK-RV64-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
...
; CHECK-RV64-NEXT:    vsetvli zero, a1, e8, m8, ta, ma
; CHECK-RV64-NEXT:    vmset.m v8
; CHECK-RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; CHECK-RV64-NEXT:    vmv.x.s a2, v8
...
; CHECK-RV64-NEXT:    vsetvli zero, a1, e8, m8, ta, ma
; CHECK-RV64-NEXT:    vle8.v v8, (a0)
; CHECK-RV64-NEXT:    add a2, a2, a3
; CHECK-RV64-NEXT:    vle8.v v16, (a2)
; CHECK-RV64-NEXT:    ret
...
; CHECK-RV32-NEXT:    vsetvli zero, a3, e16, m8, ta, ma
...
; CHECK-RV32-NEXT:    vmv2r.v v20, v8
; CHECK-RV32-NEXT:    li a2, 94
; CHECK-RV32-NEXT:    li a4, 93
; CHECK-RV32-NEXT:    vsetvli zero, a2, e8, m2, tu, ma
; CHECK-RV32-NEXT:    vslideup.vx v20, v18, a4
; CHECK-RV32-NEXT:    addi a0, a0, 1
; CHECK-RV32-NEXT:    vmv2r.v v8, v20
...
; CHECK-RV32-NEXT:    vslideup.vx v18, v16, a4
; CHECK-RV32-NEXT:    addi a0, a0, 1
...
; CHECK-RV32-NEXT:    vslideup.vx v24, v20, a4
; CHECK-RV32-NEXT:    addi a0, a0, 1
; CHECK-RV32-NEXT:    vmv4r.v v8, v24
...
; CHECK-RV32-NEXT:    vslideup.vx v20, v16, a4
; CHECK-RV32-NEXT:    addi a0, a0, 1
...
; CHECK-RV64-NEXT:    vslideup.vx v18, v16, a3
; CHECK-RV64-NEXT:    addi a0, a0, 1
...
; CHECK-RV64-NEXT:    vmv2r.v v20, v8
; CHECK-RV64-NEXT:    li a2, 127
; CHECK-RV64-NEXT:    li a3, 126
; CHECK-RV64-NEXT:    vsetvli zero, a2, e8, m2, tu, ma
; CHECK-RV64-NEXT:    vslideup.vx v20, v18, a3
; CHECK-RV64-NEXT:    addi a0, a0, 1
; CHECK-RV64-NEXT:    vmv2r.v v8, v20
...
; CHECK-RV64-NEXT:    vslideup.vx v20, v16, a3
; CHECK-RV64-NEXT:    addi a0, a0, 1
...
; CHECK-RV64-NEXT:    vsetvli zero, a1, e8, m4, tu, ma
; CHECK-RV64-NEXT:    vslideup.vx v24, v20, a3
; CHECK-RV64-NEXT:    addi a0, a0, 1
; CHECK-RV64-NEXT:    vmv4r.v v8, v24
