...
; CHECK-NEXT:    mv a3, a2
; CHECK-NEXT:    bltu a2, a6, .LBB45_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    mv a3, a6
; CHECK-NEXT:  .LBB45_2:
; CHECK-NEXT:    sub a5, a3, a4
; CHECK-NEXT:    slli a7, a4, 3
; CHECK-NEXT:    sltu t0, a3, a5
; CHECK-NEXT:    addi t0, t0, -1
; CHECK-NEXT:    and a5, t0, a5
; CHECK-NEXT:    srli t0, a4, 3
; CHECK-NEXT:    sub t1, a2, a6
; CHECK-NEXT:    add a6, a0, a7
; CHECK-NEXT:    sltu a2, a2, t1
; CHECK-NEXT:    addi a2, a2, -1
; CHECK-NEXT:    and a2, a2, t1
; CHECK-NEXT:    vsetvli a7, zero, e8, mf4, ta, ma
; CHECK-NEXT:    vslidedown.vx v0, v9, t0
; CHECK-NEXT:    bltu a2, a4, .LBB45_4
; CHECK-NEXT:  # %bb.3:
; CHECK-NEXT:    mv a2, a4
; CHECK-NEXT:  .LBB45_4:
...
; CHECK-NEXT:    srli a6, a4, 2
; CHECK-NEXT:    add a5, a0, a5
; CHECK-NEXT:    vsetvli a7, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vx v0, v9, a6
