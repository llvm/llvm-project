...
define <vscale x 1 x i32> @vabdu_vx_i32mf2(<vscale x 1 x i32> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i32mf2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, mf2, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 1 x i32> @llvm.riscv.vabdu(<vscale x 1 x i32> poison, <vscale x 1 x i32> %a, iXLen %b, iXLen %vl)
  ret <vscale x 1 x i32> %res
}

define <vscale x 1 x i32> @vabdu_vx_mask_i32mf2(<vscale x 1 x i32> %passthru, <vscale x 1 x i32> %a, iXLen %b, <vscale x 1 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i32mf2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, mf2, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v9, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 1 x i32> @llvm.riscv.vabdu.mask(<vscale x 1 x i32> %passthru, <vscale x 1 x i32> %a, iXLen %b, <vscale x 1 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 1 x i32> %res
}
...
define <vscale x 4 x i32> @vabdu_vx_i32m2(<vscale x 4 x i32> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i32m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 4 x i32> @llvm.riscv.vabdu(<vscale x 4 x i32> poison, <vscale x 4 x i32> %a, iXLen %b, iXLen %vl)
  ret <vscale x 4 x i32> %res
}

define <vscale x 4 x i32> @vabdu_vx_mask_i32m2(<vscale x 4 x i32> %passthru, <vscale x 4 x i32> %a, iXLen %b, <vscale x 4 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i32m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m2, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v10, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 4 x i32> @llvm.riscv.vabdu.mask(<vscale x 4 x i32> %passthru, <vscale x 4 x i32> %a, iXLen %b, <vscale x 4 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 4 x i32> %res
}

define <vscale x 8 x i32> @vabdu_vx_i32m4(<vscale x 8 x i32> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i32m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 8 x i32> @llvm.riscv.vabdu(<vscale x 8 x i32> poison, <vscale x 8 x i32> %a, iXLen %b, iXLen %vl)
  ret <vscale x 8 x i32> %res
}

define <vscale x 8 x i32> @vabdu_vx_mask_i32m4(<vscale x 8 x i32> %passthru, <vscale x 8 x i32> %a, iXLen %b, <vscale x 8 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i32m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v12, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 8 x i32> @llvm.riscv.vabdu.mask(<vscale x 8 x i32> %passthru, <vscale x 8 x i32> %a, iXLen %b, <vscale x 8 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 8 x i32> %res
}

define <vscale x 16 x i32> @vabdu_vx_i32m8(<vscale x 16 x i32> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i32m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 16 x i32> @llvm.riscv.vabdu(<vscale x 16 x i32> poison, <vscale x 16 x i32> %a, iXLen %b, iXLen %vl)
  ret <vscale x 16 x i32> %res
}

define <vscale x 16 x i32> @vabdu_vx_mask_i32m8(<vscale x 16 x i32> %passthru, <vscale x 16 x i32> %a, iXLen %b, <vscale x 16 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i32m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e32, m8, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v16, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 16 x i32> @llvm.riscv.vabdu.mask(<vscale x 16 x i32> %passthru, <vscale x 16 x i32> %a, iXLen %b, <vscale x 16 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 16 x i32> %res
}
...
define <vscale x 1 x i64> @vabdu_vx_mask_i64m1(<vscale x 1 x i64> %passthru, <vscale x 1 x i64> %a, iXLen %b, <vscale x 1 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i64m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m1, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v9, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 1 x i64> @llvm.riscv.vabdu.mask(<vscale x 1 x i64> %passthru, <vscale x 1 x i64> %a, iXLen %b, <vscale x 1 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 1 x i64> %res
}

define <vscale x 2 x i64> @vabdu_vx_i64m2(<vscale x 2 x i64> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i64m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m2, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 2 x i64> @llvm.riscv.vabdu(<vscale x 2 x i64> poison, <vscale x 2 x i64> %a, iXLen %b, iXLen %vl)
  ret <vscale x 2 x i64> %res
}

define <vscale x 2 x i64> @vabdu_vx_mask_i64m2(<vscale x 2 x i64> %passthru, <vscale x 2 x i64> %a, iXLen %b, <vscale x 2 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i64m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m2, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v10, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 2 x i64> @llvm.riscv.vabdu.mask(<vscale x 2 x i64> %passthru, <vscale x 2 x i64> %a, iXLen %b, <vscale x 2 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 2 x i64> %res
}

define <vscale x 4 x i64> @vabdu_vx_i64m4(<vscale x 4 x i64> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i64m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m4, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 4 x i64> @llvm.riscv.vabdu(<vscale x 4 x i64> poison, <vscale x 4 x i64> %a, iXLen %b, iXLen %vl)
  ret <vscale x 4 x i64> %res
}

define <vscale x 4 x i64> @vabdu_vx_mask_i64m4(<vscale x 4 x i64> %passthru, <vscale x 4 x i64> %a, iXLen %b, <vscale x 4 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i64m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m4, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v12, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 4 x i64> @llvm.riscv.vabdu.mask(<vscale x 4 x i64> %passthru, <vscale x 4 x i64> %a, iXLen %b, <vscale x 4 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 4 x i64> %res
}

define <vscale x 8 x i64> @vabdu_vx_i64m8(<vscale x 8 x i64> %a, iXLen %b, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_i64m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; CHECK-NEXT:    vabdu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %res = call <vscale x 8 x i64> @llvm.riscv.vabdu(<vscale x 8 x i64> poison, <vscale x 8 x i64> %a, iXLen %b, iXLen %vl)
  ret <vscale x 8 x i64> %res
}

define <vscale x 8 x i64> @vabdu_vx_mask_i64m8(<vscale x 8 x i64> %passthru, <vscale x 8 x i64> %a, iXLen %b, <vscale x 8 x i1> %mask, iXLen %vl) {
; CHECK-LABEL: vabdu_vx_mask_i64m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a1, e64, m8, ta, mu
; CHECK-NEXT:    vabdu.vx v8, v16, a0, v0.t
; CHECK-NEXT:    ret
  %res = call <vscale x 8 x i64> @llvm.riscv.vabdu.mask(<vscale x 8 x i64> %passthru, <vscale x 8 x i64> %a, iXLen %b, <vscale x 8 x i1> %mask, iXLen %vl, iXLen 1)
  ret <vscale x 8 x i64> %res
}
