...
; CHECK-NEXT:    vmsltu.vv v1, v9, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsltu.vv v2, v10, v9, v0.t
...
; CHECK-NEXT:    vmsltu.vv v1, v10, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
...
; CHECK-NEXT:    vmsltu.vv v1, v12, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsltu.vv v2, v16, v12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsltu.vv v1, v2, v8, v0.t
