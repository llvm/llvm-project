...
; RV32-NEXT:    vluxei32.v v10, (a0), v4, v0.t
; RV32-NEXT:    vmv.v.v v8, v10
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vwaddu.vv v2, v8, v8
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, mu
; CHECK-NEXT:    vluxei16.v v10, (a0), v2, v0.t
...
; RV32-NEXT:    vluxei32.v v12, (a0), v4, v0.t
; RV32-NEXT:    vmv.v.v v8, v12
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vluxei16.v v12, (a0), v2, v0.t
...
; CHECK-NEXT:    vluxei32.v v12, (a0), v4, v0.t
; CHECK-NEXT:    vmv.v.v v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vluxei16.v v16, (a0), v2, v0.t
...
; CHECK-NEXT:    vsetvli zero, zero, e64, m8, ta, mu
; CHECK-NEXT:    vluxei32.v v16, (a0), v4, v0.t
; CHECK-NEXT:    vmv.v.v v8, v16
; CHECK-NEXT:    ret
...
; RV64-NEXT:    vslidedown.vx v0, v1, a1
; RV64-NEXT:    vsetvli a1, zero, e64, m8, ta, ma
