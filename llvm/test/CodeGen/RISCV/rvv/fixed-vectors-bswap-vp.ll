...
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vand.vv v28, v8, v24
; RV32-NEXT:    vsll.vi v20, v20, 24
; RV32-NEXT:    vsll.vi v28, v28, 8
; RV32-NEXT:    vor.vv v12, v16, v12
; RV32-NEXT:    vor.vv v16, v20, v28
; RV32-NEXT:    vsrl.vi v20, v8, 8
; RV32-NEXT:    vsrl.vx v28, v8, a2
...
; RV64-NEXT:    vsrl.vi v28, v8, 24
; RV64-NEXT:    vsrl.vi v8, v8, 8
; RV64-NEXT:    vand.vx v28, v28, a1
; RV64-NEXT:    vand.vx v8, v8, a0
