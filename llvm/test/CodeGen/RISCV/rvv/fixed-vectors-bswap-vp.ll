...
; RV32-NEXT:    vsrl.vi v9, v8, 24, v0.t
...
; RV32-NEXT:    vand.vx v13, v8, a1, v0.t
; RV32-NEXT:    vand.vx v12, v12, a1, v0.t
; RV32-NEXT:    vor.vv v11, v12, v11, v0.t
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vlse64.v v12, (a6), zero
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vsll.vx v13, v13, a4, v0.t
; RV32-NEXT:    vor.vv v10, v10, v13, v0.t
; RV32-NEXT:    vsrl.vi v13, v8, 8, v0.t
; RV32-NEXT:    vand.vx v9, v9, a5, v0.t
; RV32-NEXT:    vand.vv v13, v13, v12, v0.t
; RV32-NEXT:    vor.vv v9, v13, v9, v0.t
...
; RV64-NEXT:    vsll.vx v8, v8, a5, v0.t
; RV64-NEXT:    vor.vv v8, v12, v8, v0.t
; RV64-NEXT:    vor.vv v8, v8, v10, v0.t
; RV64-NEXT:    vor.vv v9, v9, v11, v0.t
...
; RV32-NEXT:    vand.vx v18, v8, a1, v0.t
; RV32-NEXT:    vand.vx v16, v16, a1, v0.t
; RV32-NEXT:    vor.vv v14, v16, v14, v0.t
; RV32-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV32-NEXT:    vlse64.v v16, (a6), zero
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vsll.vx v18, v18, a4, v0.t
; RV32-NEXT:    vor.vv v12, v12, v18, v0.t
; RV32-NEXT:    vsrl.vi v18, v8, 8, v0.t
; RV32-NEXT:    vand.vx v10, v10, a5, v0.t
; RV32-NEXT:    vand.vv v18, v18, v16, v0.t
; RV32-NEXT:    vor.vv v10, v18, v10, v0.t
...
; RV64-NEXT:    vor.vv v10, v10, v14, v0.t
; RV64-NEXT:    vor.vv v8, v8, v10, v0.t
; RV64-NEXT:    ret
...
; RV32-NEXT:    sw a1, 8(sp)
; RV32-NEXT:    sw zero, 12(sp)
; RV32-NEXT:    vsll.vx v20, v8, a2, v0.t
; RV32-NEXT:    addi a1, a3, -256
; RV32-NEXT:    vsrl.vx v12, v8, a2, v0.t
; RV32-NEXT:    vsrl.vx v24, v8, a4, v0.t
; RV32-NEXT:    vand.vx v28, v8, a1, v0.t
; RV32-NEXT:    vand.vx v24, v24, a1, v0.t
; RV32-NEXT:    vor.vv v12, v24, v12, v0.t
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; RV32-NEXT:    vlse64.v v24, (a6), zero
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vsll.vx v28, v28, a4, v0.t
; RV32-NEXT:    vor.vv v20, v20, v28, v0.t
; RV32-NEXT:    vsrl.vi v28, v8, 8, v0.t
; RV32-NEXT:    vand.vx v16, v16, a5, v0.t
; RV32-NEXT:    vand.vv v28, v28, v24, v0.t
; RV32-NEXT:    vor.vv v16, v28, v16, v0.t
...
; RV64-NEXT:    vsrl.vi v20, v8, 8, v0.t
; RV64-NEXT:    addi a0, a4, -256
; RV64-NEXT:    vsrl.vx v12, v8, a3, v0.t
; RV64-NEXT:    vsrl.vx v24, v8, a5, v0.t
; RV64-NEXT:    vand.vx v24, v24, a0, v0.t
; RV64-NEXT:    vor.vv v12, v24, v12, v0.t
; RV64-NEXT:    vand.vx v24, v8, a1, v0.t
; RV64-NEXT:    slli a2, a2, 24
; RV64-NEXT:    vand.vx v16, v16, a1, v0.t
; RV64-NEXT:    vsll.vi v24, v24, 24, v0.t
; RV64-NEXT:    vand.vx v20, v20, a2, v0.t
; RV64-NEXT:    vor.vv v16, v20, v16, v0.t
; RV64-NEXT:    vand.vx v20, v8, a2, v0.t
; RV64-NEXT:    vsll.vi v20, v20, 8, v0.t
; RV64-NEXT:    vor.vv v20, v24, v20, v0.t
; RV64-NEXT:    vsll.vx v24, v8, a3, v0.t
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vsll.vx v8, v8, a5, v0.t
; RV64-NEXT:    vor.vv v8, v24, v8, v0.t
...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x21, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 33 * vlenb
; RV32-NEXT:    li a1, 56
; RV32-NEXT:    lui a2, 16
; RV32-NEXT:    li a3, 40
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x11, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 17 * vlenb
; RV64-NEXT:    lui a2, 4080
; RV64-NEXT:    li a3, 255
; RV64-NEXT:    li a1, 56
; RV64-NEXT:    lui a4, 16
; RV64-NEXT:    li a5, 40
; RV64-NEXT:    addi a4, a4, -256
...
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl1r.v v0, (a0) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vsll.vx v24, v24, a5, v0.t
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    slli a0, a0, 4
; RV64-NEXT:    add a0, sp, a0
; RV64-NEXT:    addi a0, a0, 16
; RV64-NEXT:    vl1r.v v0, (a0) # vscale x 8-byte Folded Reload
; RV64-NEXT:    vsll.vx v8, v8, a1, v0.t
; RV64-NEXT:    csrr a0, vlenb
; RV64-NEXT:    slli a0, a0, 4
; RV64-NEXT:    add a0, sp, a0
; RV64-NEXT:    addi a0, a0, 16
