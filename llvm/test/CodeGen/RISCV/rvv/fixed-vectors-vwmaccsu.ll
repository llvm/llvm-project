...
; CHECK-NEXT:    vwmaccsu.vv v8, v1, v2
; CHECK-NEXT:    ret
  %a = load <2 x i8>, ptr %x
  %b = load <2 x i8>, ptr %y
...
; CHECK-NEXT:    vwmaccsu.vv v8, v2, v4
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vwmaccsu.vv v8, v4, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vwmaccsu.vx v8, a1, v1
; CHECK-NEXT:    ret
  %a = load <2 x i8>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a2, e8, m2, ta, ma
; CHECK-NEXT:    vle8.v v2, (a0)
; CHECK-NEXT:    vwmaccsu.vx v8, a1, v2
; CHECK-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
; CHECK-NEXT:    vsetvli zero, a2, e8, m4, ta, ma
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vwmaccsu.vx v8, a1, v4
; CHECK-NEXT:    ret
  %a = load <64 x i8>, ptr %x
