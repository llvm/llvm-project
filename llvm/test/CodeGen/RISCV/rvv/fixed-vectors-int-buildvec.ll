...
; CHECK-NEXT:    vmv.v.i v2, 8
; CHECK-NEXT:    vsetivli zero, 4, e16, m1, tu, ma
; CHECK-NEXT:    vslideup.vi v2, v1, 3
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vse16.v v2, (a0)
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v0, a1
; CHECK-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; CHECK-NEXT:    vmerge.vim v1, v1, 2, v0
...
; RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32-NEXT:    vid.v v1
; RV32-NEXT:    vsrl.vi v1, v1, 1
; RV32-NEXT:    vse32.v v1, (a0)
; RV32-NEXT:    vse32.v v1, (a1)
; RV32-NEXT:    vmv.v.i v2, 1
; RV32-NEXT:    vse32.v v1, (a2)
; RV32-NEXT:    vse32.v v1, (a3)
; RV32-NEXT:    vse32.v v1, (a4)
; RV32-NEXT:    vmv.s.x v1, zero
; RV32-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; RV32-NEXT:    vslideup.vi v2, v1, 1
; RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32-NEXT:    vse32.v v2, (a5)
; RV32-NEXT:    vmv.v.i v1, 0
; RV32-NEXT:    li a0, 1
; RV32-NEXT:    vslide1down.vx v1, v1, a0
; RV32-NEXT:    vse32.v v1, (a6)
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vid.v v1
; RV64-NEXT:    vsrl.vi v1, v1, 1
; RV64-NEXT:    vse32.v v1, (a0)
; RV64-NEXT:    vmv.v.i v2, 1
; RV64-NEXT:    vse32.v v1, (a1)
; RV64-NEXT:    vse32.v v1, (a2)
; RV64-NEXT:    vse32.v v1, (a3)
; RV64-NEXT:    vse32.v v1, (a4)
; RV64-NEXT:    vmv.s.x v1, zero
; RV64-NEXT:    vsetivli zero, 2, e32, m1, tu, ma
; RV64-NEXT:    vslideup.vi v2, v1, 1
; RV64-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV64-NEXT:    vse32.v v2, (a5)
; RV64-NEXT:    vmv.v.i v1, 0
; RV64-NEXT:    li a0, 1
; RV64-NEXT:    vslide1down.vx v1, v1, a0
; RV64-NEXT:    vse32.v v1, (a6)
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vadd.vi v1, v1, 3
; CHECK-NEXT:    vse16.v v1, (a0)
; CHECK-NEXT:    vmv.v.i v2, 3
; CHECK-NEXT:    vse16.v v1, (a1)
; CHECK-NEXT:    vse16.v v1, (a2)
; CHECK-NEXT:    vse16.v v1, (a3)
; CHECK-NEXT:    vse16.v v1, (a4)
; CHECK-NEXT:    vmv.v.i v1, 4
; CHECK-NEXT:    vsetivli zero, 2, e16, mf2, tu, ma
; CHECK-NEXT:    vslideup.vi v1, v2, 1
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vse16.v v1, (a5)
; CHECK-NEXT:    li a0, 4
; CHECK-NEXT:    vslide1down.vx v1, v2, a0
; CHECK-NEXT:    vse16.v v1, (a6)
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslideup.vi v8, v1, 6
; CHECK-NEXT:    ret
