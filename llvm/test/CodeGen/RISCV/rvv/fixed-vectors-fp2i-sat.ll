...
; CHECK-NEXT:    vmfne.vv v0, v2, v2
; CHECK-NEXT:    vfcvt.rtz.x.f.v v2, v2
...
; CHECK-NEXT:    vmerge.vim v1, v2, 0, v0
...
; CHECK-NEXT:    vle32.v v2, (a0)
; CHECK-NEXT:    vmfne.vv v0, v2, v2
; CHECK-NEXT:    vfwcvt.rtz.x.f.v v4, v2
...
; CHECK-NEXT:    vle32.v v2, (a0)
; CHECK-NEXT:    vmfne.vv v0, v2, v2
; CHECK-NEXT:    vfwcvt.rtz.xu.f.v v4, v2
; CHECK-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; CHECK-NEXT:    vmerge.vim v4, v4, 0, v0
; CHECK-NEXT:    vse64.v v4, (a1)
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vslidedown.vi v2, v1, 1
; RV32-NEXT:    vfmv.f.s fa5, v2
...
; RV64-NEXT:    vslidedown.vi v2, v1, 1
; RV64-NEXT:    vfmv.f.s fa5, v2
...
; RV32-NEXT:    vle64.v v4, (a0)
; RV32-NEXT:    mv a0, sp
; RV32-NEXT:    vse64.v v4, (a0)
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vslidedown.vi v1, v4, 1
; RV32-NEXT:    vfmv.f.s fa3, v1
...
; RV32-NEXT:    vslide1down.vx v1, v1, a0
; RV32-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV32-NEXT:    vslidedown.vi v2, v4, 3
; RV32-NEXT:    vfmv.f.s fa3, v2
; RV32-NEXT:    feq.d a0, fa3, fa3
; RV32-NEXT:    fmax.d fa3, fa3, fa5
; RV32-NEXT:    fmin.d fa3, fa3, fa4
...
; RV64-NEXT:    vle64.v v4, (a0)
; RV64-NEXT:    mv a0, sp
; RV64-NEXT:    vse64.v v4, (a0)
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vslidedown.vi v1, v4, 1
; RV64-NEXT:    vfmv.f.s fa3, v1
...
; RV64-NEXT:    vslide1down.vx v1, v1, a0
; RV64-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v4, 3
; RV64-NEXT:    vfmv.f.s fa3, v2
; RV64-NEXT:    feq.d a0, fa3, fa3
; RV64-NEXT:    fmax.d fa3, fa3, fa5
; RV64-NEXT:    fmin.d fa3, fa3, fa4
...
; RV32-NEXT:    vslide1down.vx v1, v1, a0
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vslidedown.vi v2, v4, 1
; RV32-NEXT:    vfmv.f.s fa4, v2
; RV32-NEXT:    fmax.d fa4, fa4, fa3
; RV32-NEXT:    fmin.d fa4, fa4, fa5
; RV32-NEXT:    fcvt.wu.d a0, fa4, rtz
; RV32-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
...
; RV64-NEXT:    vslide1down.vx v1, v1, a0
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v4, 1
; RV64-NEXT:    vfmv.f.s fa4, v2
; RV64-NEXT:    fmax.d fa4, fa4, fa3
; RV64-NEXT:    fmin.d fa4, fa4, fa5
; RV64-NEXT:    fcvt.lu.d a0, fa4, rtz
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
