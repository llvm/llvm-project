...
; ZVFBFMIN-LABEL: vfmul_vv_nxv1bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv1bf16:
; ZVFBFMIN:       # %bb.0:
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v9, v10, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v9
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv1bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: vfmul_vv_nxv2bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv2bf16:
; ZVFBFA:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv2bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv2bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: vfmul_vv_nxv4bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv4bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v10, v10, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v10
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv4bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: vfmul_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v12, v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v12
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: vfmul_vv_nxv16bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv16bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v16, v16, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v16
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv16bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: vfmul_vv_nxv32bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vs8r.v v24, (a0) # vscale x 64-byte Spill
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v0, v8
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v24, v20
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v12
; ZVFBFMIN-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v0, v0, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v16, v16, v24
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_nxv32bf16:
; ZVFBFA:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfmul_vf_nxv32bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    addi sp, sp, -16
; ZVFBFMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFMIN-NEXT:    csrr a0, vlenb
...
; ZVFBFMIN-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
...
; ZVFBFMIN-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v0, v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmul.vv v16, v24, v16
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_nxv32bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vf v8, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v16, v12
; ZVFHMIN-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
