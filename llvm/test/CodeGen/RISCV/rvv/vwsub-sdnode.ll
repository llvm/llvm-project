...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; CHECK-NEXT:    vwsubu.vv v4, v8, v10
; CHECK-NEXT:    vmv4r.v v8, v4
; CHECK-NEXT:    ret
