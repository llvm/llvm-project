...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v1, v8, v10
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v2, v8, v12
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wv v4, v8, v16
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v1, v8, a0
; CHECK-NEXT:    vmv.v.v v8, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v2, v8, a0
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    vnclipu.wx v4, v8, a0
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
entry:
