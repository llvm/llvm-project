...
; NO_FOLDING-NEXT:    ret
;
; FOLDING-LABEL: vfwmul_v2f116_multiple_users:
; FOLDING:       # %bb.0:
...
; FOLDING-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; FOLDING-NEXT:    vfmul.vv v10, v11, v8
; FOLDING-NEXT:    vfadd.vv v11, v11, v9
; FOLDING-NEXT:    vfsub.vv v8, v8, v9
; FOLDING-NEXT:    vse32.v v10, (a0)
; FOLDING-NEXT:    vse32.v v11, (a1)
; FOLDING-NEXT:    vse32.v v8, (a2)
; FOLDING-NEXT:    ret
...
; FOLDING:       # %bb.0:
; FOLDING-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; FOLDING-NEXT:    vfwcvt.f.f.v v12, v8
; FOLDING-NEXT:    vfwcvt.f.f.v v8, v9
; FOLDING-NEXT:    vfwcvt.f.f.v v9, v10
; FOLDING-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; FOLDING-NEXT:    vfmul.vv v10, v12, v8
; FOLDING-NEXT:    vfmadd.vv v12, v9, v11
; FOLDING-NEXT:    vfsub.vv v8, v8, v9
; FOLDING-NEXT:    vse64.v v10, (a0)
