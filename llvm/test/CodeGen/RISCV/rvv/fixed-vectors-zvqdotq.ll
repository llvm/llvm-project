...
; NODOT-NEXT:    vmul.vv v12, v12, v10
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vzext.vf2 v8, v12
; NODOT-NEXT:    vmv.s.x v12, zero
; NODOT-NEXT:    vredsum.vs v8, v8, v12
; NODOT-NEXT:    vmv.x.s a0, v8
; NODOT-NEXT:    ret
...
; NODOT-NEXT:    vmul.vv v16, v16, v10
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vzext.vf2 v8, v16
; NODOT-NEXT:    vadd.vv v8, v8, v12
; NODOT-NEXT:    vmv.s.x v12, zero
; NODOT-NEXT:    vredsum.vs v8, v8, v12
; NODOT-NEXT:    vmv.x.s a0, v8
...
; NODOT-NEXT:    vzext.vf2 v10, v9
; NODOT-NEXT:    vzext.vf2 v9, v8
; NODOT-NEXT:    vmul.vv v8, v9, v10
...
; CHECK-NEXT:    vslidedown.vx v28, v12, a0
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; CHECK-NEXT:    vsext.vf4 v8, v24
; CHECK-NEXT:    vsext.vf4 v0, v28
...
; NODOT-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x08, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 8 * vlenb
; NODOT-NEXT:    li a0, 32
; NODOT-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v16, v8
...
; NODOT-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v16, v12
; NODOT-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; NODOT-NEXT:    vslidedown.vx v0, v12, a0
; NODOT-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v24, v4
; NODOT-NEXT:    vsext.vf4 v8, v0
; NODOT-NEXT:    addi a0, sp, 16
; NODOT-NEXT:    vl8r.v v0, (a0) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vmul.vv v16, v0, v16
; NODOT-NEXT:    vmul.vv v8, v24, v8
; NODOT-NEXT:    vsetivli zero, 16, e32, m8, ta, ma
; NODOT-NEXT:    vslidedown.vi v24, v16, 16
; NODOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; NODOT-NEXT:    vadd.vv v16, v24, v16
; NODOT-NEXT:    vadd.vv v16, v16, v8
; NODOT-NEXT:    vsetivli zero, 16, e32, m8, ta, ma
; NODOT-NEXT:    vslidedown.vi v8, v8, 16
; NODOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; NODOT-NEXT:    vadd.vv v8, v8, v16
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 3
...
; NODOT-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xc8, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 72 * vlenb
; NODOT-NEXT:    csrr a1, vlenb
; NODOT-NEXT:    slli a1, a1, 3
; NODOT-NEXT:    mv a2, a1
...
; NODOT-NEXT:    add a1, sp, a1
; NODOT-NEXT:    addi a1, a1, 16
; NODOT-NEXT:    vs8r.v v0, (a1) # vscale x 64-byte Folded Spill
; NODOT-NEXT:    li a1, 32
...
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v8, v16
; NODOT-NEXT:    vzext.vf4 v24, v0
; NODOT-NEXT:    vmul.vv v8, v24, v8
; NODOT-NEXT:    csrr a0, vlenb
...
; NODOT-NEXT:    vzext.vf4 v24, v8
; NODOT-NEXT:    vmul.vv v8, v24, v0
; NODOT-NEXT:    csrr a0, vlenb
...
; NODOT-NEXT:    vl8r.v v16, (a2) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vzext.vf4 v24, v16
; NODOT-NEXT:    vmul.vv v24, v24, v0
; NODOT-NEXT:    csrr a2, vlenb
; NODOT-NEXT:    slli a2, a2, 3
; NODOT-NEXT:    add a2, sp, a2
; NODOT-NEXT:    addi a2, a2, 16
; NODOT-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Folded Spill
...
; NODOT-NEXT:    addi a2, a2, 16
; NODOT-NEXT:    vl8r.v v16, (a2) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vslidedown.vx v24, v16, a1
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v0, v8
; NODOT-NEXT:    vzext.vf4 v16, v24
; NODOT-NEXT:    vmul.vv v8, v16, v0
; NODOT-NEXT:    csrr a2, vlenb
; NODOT-NEXT:    slli a2, a2, 3
; NODOT-NEXT:    mv a3, a2
; NODOT-NEXT:    slli a2, a2, 2
...
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vzext.vf4 v0, v8
; NODOT-NEXT:    vmul.vv v24, v0, v24
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 3
; NODOT-NEXT:    mv a2, a0
; NODOT-NEXT:    slli a0, a0, 1
...
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vs8r.v v24, (a0) # vscale x 64-byte Folded Spill
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 6
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; NODOT-NEXT:    vslidedown.vx v12, v24, a1
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 3
; NODOT-NEXT:    mv a2, a0
; NODOT-NEXT:    slli a0, a0, 1
...
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vslidedown.vx v20, v24, a1
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v24, v12
; NODOT-NEXT:    vzext.vf4 v0, v20
; NODOT-NEXT:    vmul.vv v24, v0, v24
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 3
; NODOT-NEXT:    mv a2, a0
...
; NODOT-NEXT:    vslidedown.vx v4, v8, a1
; NODOT-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; NODOT-NEXT:    vsext.vf4 v8, v16
; NODOT-NEXT:    vzext.vf4 v16, v4
; NODOT-NEXT:    vmul.vv v8, v16, v8
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 4
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
...
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vadd.vv v16, v16, v24
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 5
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
