...
; RV32-NEXT:    vwmaccu.vx v10, a3, v9
...
; RV32-NEXT:    vslidedown.vx v10, v10, a3
; RV32-NEXT:    vsetvli zero, a2, e8, mf2, ta, ma
...
; RV32-NEXT:    vnsrl.wx v11, v8, a2
; RV32-NEXT:    vnsrl.wi v10, v8, 0
; RV32-NEXT:    vmv.x.s a1, v8
; RV32-NEXT:    vmv1r.v v0, v12
; RV32-NEXT:    vsseg2e32.v v10, (a0), v0.t
; RV32-NEXT:    mv a0, a1
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetvli a3, zero, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vx v10, v11, a2
...
; RV64-NEXT:    vnsrl.wx v11, v8, a2
; RV64-NEXT:    vnsrl.wi v10, v8, 0
; RV64-NEXT:    vmv.x.s a1, v8
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vsseg2e32.v v10, (a0), v0.t
; RV64-NEXT:    mv a0, a1
; RV64-NEXT:    ret
  %rvl = mul nuw i32 %evl, 2
  %interleaved.mask = tail call <vscale x 4 x i1> @llvm.vector.interleave2.nxv4i1(<vscale x 2 x i1> %mask, <vscale x 2 x i1> %mask)
...
; RV32-NEXT:    vmerge.vim v9, v12, 1, v0
; RV32-NEXT:    vmv1r.v v0, v10
; RV32-NEXT:    vmerge.vim v10, v12, 1, v0
; RV32-NEXT:    vwaddu.vv v11, v10, v9
; RV32-NEXT:    vwmaccu.vx v11, a2, v9
...
; RV32-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
; RV32-NEXT:    vmsne.vi v0, v10, 0
; RV32-NEXT:    vmerge.vim v8, v12, 1, v0
; RV32-NEXT:    vsetvli zero, a1, e8, mf2, ta, ma
...
; RV64-NEXT:    vmv.v.i v13, 0
; RV64-NEXT:    li a2, -1
; RV64-NEXT:    vsetvli a3, zero, e8, mf2, ta, ma
; RV64-NEXT:    vmv.v.i v9, 0
; RV64-NEXT:    vmv1r.v v0, v8
; RV64-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
; RV64-NEXT:    vmerge.vim v10, v13, 1, v0
; RV64-NEXT:    vmv1r.v v0, v11
; RV64-NEXT:    vmerge.vim v11, v13, 1, v0
; RV64-NEXT:    vwaddu.vv v12, v11, v10
...
; RV64-NEXT:    vsetvli a3, zero, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vx v10, v12, a2
; RV64-NEXT:    vmerge.vim v9, v9, 1, v0
; RV64-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
; RV64-NEXT:    vmsne.vi v0, v10, 0
; RV64-NEXT:    vmerge.vim v8, v13, 1, v0
; RV64-NEXT:    vsetvli a3, zero, e8, mf2, ta, ma
; RV64-NEXT:    vslideup.vx v9, v8, a2
; RV64-NEXT:    vmsne.vi v0, v9, 0
