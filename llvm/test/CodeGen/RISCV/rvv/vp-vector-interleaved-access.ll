...
; RV32-NEXT:    vsseg2e32.v v10, (a2), v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    li a1, 32
; RV64-NEXT:    vnsrl.wx v11, v8, a1
; RV64-NEXT:    vnsrl.wi v10, v8, 0
; RV64-NEXT:    vmv1r.v v0, v12
; RV64-NEXT:    vsseg2e32.v v10, (a2), v0.t
; RV64-NEXT:    ret
  %rvl = mul nuw i32 %evl, 2
  %interleaved.mask = tail call <vscale x 4 x i1> @llvm.vector.interleave2.nxv4i1(<vscale x 2 x i1> %mask, <vscale x 2 x i1> %mask)
  %wide.masked.load = tail call <vscale x 4 x i32> @llvm.vp.load.nxv4i32.p0(ptr %ptr, <vscale x 4 x i1> %interleaved.mask, i32 %rvl)
...
; RV32-NEXT:    vwaddu.vv v11, v10, v8
; RV32-NEXT:    li a2, -1
; RV32-NEXT:    vwmaccu.vx v11, a2, v8
...
; RV64-NEXT:    vwaddu.vv v11, v10, v8
; RV64-NEXT:    li a2, -1
; RV64-NEXT:    vwmaccu.vx v11, a2, v8
