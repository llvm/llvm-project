...
; CHECK-NEXT:    vmsle.vv v1, v8, v9
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsle.vv v2, v9, v10, v0.t
...
; CHECK-NEXT:    vmsle.vv v1, v8, v12
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsle.vv v2, v12, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsle.vv v1, v8, v2, v0.t
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsle.vi v1, v8, 9, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsle.mask.nxv1i8.i8(
