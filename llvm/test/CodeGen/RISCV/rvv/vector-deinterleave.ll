...
; V-NEXT:    vslidedown.vx v12, v0, a0
; V-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; ZVZIP-NEXT:    vslidedown.vx v12, v0, a0
; ZVZIP-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; V-NEXT:    vs1r.v v16, (a0) # vscale x 8-byte Folded Spill
; V-NEXT:    addi a0, sp, 16
...
; V-NEXT:    add a0, sp, a0
; V-NEXT:    addi a0, a0, 16
; V-NEXT:    vl1r.v v0, (a0) # vscale x 8-byte Folded Reload
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a1, a0, 3
; V-NEXT:    add a0, a1, a0
; V-NEXT:    add sp, sp, a0
...
; CHECK-NEXT:    vslidedown.vx v14, v0, a0
; CHECK-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; CHECK-NEXT:    vslidedown.vx v8, v0, a2
; CHECK-NEXT:    srli a0, a0, 1
...
; CHECK-NEXT:    srli a1, a0, 2
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslidedown.vx v12, v0, a1
; CHECK-NEXT:    srli a2, a0, 1
; CHECK-NEXT:    vslidedown.vx v13, v0, a2
...
; CHECK-NEXT:    sub a0, a0, a1
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslidedown.vx v9, v11, a0
; CHECK-NEXT:    addi a0, sp, 16
; CHECK-NEXT:    vs8r.v v16, (a0)
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vslidedown.vx v14, v8, a1
; CHECK-NEXT:    vsetvli a1, zero, e8, m2, ta, ma
; CHECK-NEXT:    vmerge.vim v10, v12, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmerge.vim v8, v12, 1, v0
...
; CHECK-NEXT:    srli a1, a0, 2
; CHECK-NEXT:    sub a2, a0, a1
; CHECK-NEXT:    vslidedown.vx v9, v0, a2
; CHECK-NEXT:    vsetvli a2, zero, e8, m2, ta, ma
; CHECK-NEXT:    vmv.v.i v12, 0
; CHECK-NEXT:    srli a0, a0, 1
; CHECK-NEXT:    vmv1r.v v0, v9
...
; CHECK-NEXT:    vslidedown.vx v12, v13, a0
; CHECK-NEXT:    vsetvli a3, zero, e8, m2, ta, ma
; CHECK-NEXT:    vmerge.vim v16, v10, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vsetvli a3, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslidedown.vx v9, v8, a2
; CHECK-NEXT:    vsetvli a2, zero, e8, m2, ta, ma
; CHECK-NEXT:    vmerge.vim v18, v10, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
