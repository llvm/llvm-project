...
; V-NEXT:    vslidedown.vi v12, v10, 4
; V-NEXT:    vslidedown.vi v14, v8, 4
; V-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; V-NEXT:    vzext.vf2 v16, v12
; V-NEXT:    li a0, 32
; V-NEXT:    vsll.vx v12, v16, a0
; V-NEXT:    li a1, 170
; V-NEXT:    vmv.s.x v0, a1
; V-NEXT:    vzext.vf2 v16, v14
; V-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; V-NEXT:    vmerge.vvm v12, v16, v12, v0
; V-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V-NEXT:    vwaddu.vv v14, v8, v10
; V-NEXT:    li a1, -1
; V-NEXT:    vwmaccu.vx v14, a1, v10
; V-NEXT:    vnsrl.wi v8, v14, 0
; V-NEXT:    vnsrl.wi v10, v12, 0
; V-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; V-NEXT:    vslideup.vi v8, v10, 4
; V-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V-NEXT:    vnsrl.wx v10, v14, a0
; V-NEXT:    vnsrl.wx v14, v12, a0
; V-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; V-NEXT:    vslideup.vi v10, v14, 4
; V-NEXT:    ret
;
; ZVZIP-LABEL: interleave_deinterleave2:
; ZVZIP:       # %bb.0: # %entry
; ZVZIP-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
; ZVZIP-NEXT:    vslidedown.vi v12, v10, 4
; ZVZIP-NEXT:    vslidedown.vi v14, v8, 4
; ZVZIP-NEXT:    li a0, 170
; ZVZIP-NEXT:    vmv.s.x v0, a0
; ZVZIP-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVZIP-NEXT:    vzip.vv v16, v9, v12
; ZVZIP-NEXT:    vzip.vv v12, v14, v9
; ZVZIP-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVZIP-NEXT:    vmerge.vvm v12, v12, v16, v0
; ZVZIP-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVZIP-NEXT:    vzip.vv v14, v8, v10
; ZVZIP-NEXT:    vnsrl.wi v10, v12, 0
; ZVZIP-NEXT:    vnsrl.wi v8, v14, 0
; ZVZIP-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVZIP-NEXT:    vslideup.vi v8, v10, 4
; ZVZIP-NEXT:    li a0, 32
; ZVZIP-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVZIP-NEXT:    vnsrl.wx v16, v12, a0
; ZVZIP-NEXT:    vnsrl.wx v10, v14, a0
; ZVZIP-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVZIP-NEXT:    vslideup.vi v10, v16, 4
; ZVZIP-NEXT:    ret
entry:
