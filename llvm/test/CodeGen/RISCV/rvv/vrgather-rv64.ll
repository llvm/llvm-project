...
; CHECK-NEXT:    vrgather.vv v1, v8, v9
...
; CHECK-NEXT:    vrgather.vv v2, v8, v10
...
; CHECK-NEXT:    vrgather.vx v1, v8, a0
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vrgather.vx v2, v8, a0
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vrgather.vx v4, v8, a0
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vrgather.vi v1, v8, 9
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i8> @llvm.riscv.vrgather.vx.nxv1i8.i64(
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, ma
; CHECK-NEXT:    vrgather.vi v2, v8, 9
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.vrgather.vx.nxv16i8.i64(
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; CHECK-NEXT:    vrgather.vi v4, v8, 9
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.vrgather.vx.nxv32i8.i64(
