...
; CHECK-NEXT:    vsll.vv v2, v8, v9
; CHECK-NEXT:    vsra.vv v1, v2, v9
; CHECK-NEXT:    vmsne.vv v1, v8, v1
; CHECK-NEXT:    vmv.v.x v3, a1
; CHECK-NEXT:    slli a0, a0, 63
; CHECK-NEXT:    vmerge.vxm v3, v3, a0, v0
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    vmerge.vvm v8, v2, v3, v0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    srli a1, a0, 1
; CHECK-NEXT:    vsll.vv v2, v8, v10
; CHECK-NEXT:    vsra.vv v4, v2, v10
; CHECK-NEXT:    vmsne.vv v1, v8, v4
; CHECK-NEXT:    vmv.v.x v4, a1
; CHECK-NEXT:    slli a0, a0, 63
; CHECK-NEXT:    vmerge.vxm v4, v4, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmerge.vvm v8, v2, v4, v0
; CHECK-NEXT:    ret
