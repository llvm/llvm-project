...
; RV32-BOTH-NEXT:    vmv.v.x v1, a1
; RV32-BOTH-NEXT:    vse8.v v1, (a0)
; RV32-BOTH-NEXT:    ret
;
; RV64-BOTH-LABEL: memset_16:
; RV64-BOTH:       # %bb.0:
; RV64-BOTH-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; RV64-BOTH-NEXT:    vmv.v.x v1, a1
; RV64-BOTH-NEXT:    vse8.v v1, (a0)
; RV64-BOTH-NEXT:    ret
