...
; RV32-BOTH-NEXT:    vsetvli zero, a2, e8, m2, ta, ma
; RV32-BOTH-NEXT:    vmv.v.x v8, a1
; RV32-BOTH-NEXT:    vse8.v v8, (a0)
; RV32-BOTH-NEXT:    ret
;
...
; RV64-BOTH:       # %bb.0:
; RV64-BOTH-NEXT:    li a2, 32
; RV64-BOTH-NEXT:    vsetvli zero, a2, e8, m2, ta, ma
; RV64-BOTH-NEXT:    vmv.v.x v8, a1
; RV64-BOTH-NEXT:    vse8.v v8, (a0)
; RV64-BOTH-NEXT:    ret
...
; RV32-BOTH:       # %bb.0:
; RV32-BOTH-NEXT:    li a2, 64
; RV32-BOTH-NEXT:    vsetvli zero, a2, e8, m4, ta, ma
; RV32-BOTH-NEXT:    vmv.v.x v8, a1
; RV32-BOTH-NEXT:    vse8.v v8, (a0)
; RV32-BOTH-NEXT:    ret
;
...
; RV64-BOTH:       # %bb.0:
; RV64-BOTH-NEXT:    li a2, 64
; RV64-BOTH-NEXT:    vsetvli zero, a2, e8, m4, ta, ma
; RV64-BOTH-NEXT:    vmv.v.x v8, a1
; RV64-BOTH-NEXT:    vse8.v v8, (a0)
; RV64-BOTH-NEXT:    ret
