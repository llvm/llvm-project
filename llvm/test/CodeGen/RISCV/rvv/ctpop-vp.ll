...
; CHECK-NEXT:    vsrl.vi v1, v8, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vsub.vv v1, v8, v1, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v2, v1, a0, v0.t
; CHECK-NEXT:    vsrl.vi v1, v1, 2, v0.t
; CHECK-NEXT:    vand.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vadd.vv v1, v2, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 4, v0.t
; CHECK-NEXT:    vadd.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vand.vi v8, v1, 15, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vsrl.vi v1, v8, 1
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v1, v1, a0
; CHECK-NEXT:    vsub.vv v1, v8, v1
; CHECK-NEXT:    li a0, 51
...
; CHECK-NEXT:    vsrl.vi v2, v8, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsub.vv v2, v8, v2, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v4, v2, a0, v0.t
; CHECK-NEXT:    vsrl.vi v2, v2, 2, v0.t
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vadd.vv v2, v4, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 4, v0.t
; CHECK-NEXT:    vadd.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vand.vi v8, v2, 15, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vsub.vv v2, v8, v2
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v4, v2, a0
; CHECK-NEXT:    vsrl.vi v2, v2, 2
; CHECK-NEXT:    vand.vx v2, v2, a0
; CHECK-NEXT:    vadd.vv v2, v4, v2
; CHECK-NEXT:    vsrl.vi v4, v2, 4
; CHECK-NEXT:    vadd.vv v2, v2, v4
; CHECK-NEXT:    vand.vi v8, v2, 15
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vsrl.vi v4, v8, 1, v0.t
; CHECK-NEXT:    li a0, 85
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsub.vv v4, v8, v4, v0.t
; CHECK-NEXT:    li a0, 51
; CHECK-NEXT:    vand.vx v8, v4, a0, v0.t
; CHECK-NEXT:    vsrl.vi v4, v4, 2, v0.t
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vadd.vv v4, v8, v4, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 4, v0.t
; CHECK-NEXT:    vadd.vv v4, v4, v8, v0.t
; CHECK-NEXT:    vand.vi v8, v4, 15, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vmul.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v1, 8, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    li a0, 257
; CHECK-NEXT:    vmul.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v2, 8, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vx v2, v2, a0
; CHECK-NEXT:    li a0, 257
; CHECK-NEXT:    vmul.vx v2, v2, a0
; CHECK-NEXT:    vsrl.vi v8, v2, 8
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    li a0, 257
; CHECK-NEXT:    vmul.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 8, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vx v4, v4, a0
; CHECK-NEXT:    li a0, 257
; CHECK-NEXT:    vmul.vx v4, v4, a0
; CHECK-NEXT:    vsrl.vi v8, v4, 8
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vmul.vx v1, v1, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v1, 24, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    addi a0, a0, 257
; CHECK-NEXT:    vmul.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v2, 24, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    addi a0, a0, 257
; CHECK-NEXT:    vmul.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 24, v0.t
; CHECK-NEXT:    ret
;
...
; RV32-NEXT:    vsrl.vi v1, v8, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v2, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v1, v1, v2, v0.t
; RV32-NEXT:    vsub.vv v1, v8, v1, v0.t
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v2, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v3, v1, v2, v0.t
; RV32-NEXT:    vsrl.vi v1, v1, 2, v0.t
; RV32-NEXT:    vand.vv v1, v1, v2, v0.t
; RV32-NEXT:    vadd.vv v1, v3, v1, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 4, v0.t
; RV32-NEXT:    vadd.vv v1, v1, v2, v0.t
...
; RV32-NEXT:    vmv.v.x v2, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vmul.vv v1, v1, v2, v0.t
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v1, a0, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv1i64:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV64-NEXT:    vsrl.vi v1, v8, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v1, v1, a0, v0.t
; RV64-NEXT:    vsub.vv v1, v8, v1, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v2, v1, a0, v0.t
; RV64-NEXT:    vsrl.vi v1, v1, 2, v0.t
; RV64-NEXT:    vand.vx v1, v1, a0, v0.t
; RV64-NEXT:    vadd.vv v1, v2, v1, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 4, v0.t
; RV64-NEXT:    vadd.vv v1, v1, v2, v0.t
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v1, v1, a0, v0.t
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v1, a0, v0.t
; RV64-NEXT:    ret
;
...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vi v1, v8, 1
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v2, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v1, v1, v2
; RV32-NEXT:    vsub.vv v1, v8, v1
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v2, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v3, v1, v2
; RV32-NEXT:    vsrl.vi v1, v1, 2
; RV32-NEXT:    vand.vv v1, v1, v2
; RV32-NEXT:    vadd.vv v1, v3, v1
...
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v1, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv1i64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV64-NEXT:    vsrl.vi v1, v8, 1
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v1, v1, a0
; RV64-NEXT:    vsub.vv v1, v8, v1
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v2, v1, a0
; RV64-NEXT:    vsrl.vi v1, v1, 2
; RV64-NEXT:    vand.vx v1, v1, a0
; RV64-NEXT:    vadd.vv v1, v2, v1
; RV64-NEXT:    vsrl.vi v2, v1, 4
; RV64-NEXT:    vadd.vv v1, v1, v2
; RV64-NEXT:    lui a0, 61681
; RV64-NEXT:    addiw a0, a0, -241
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v1, v1, a0
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v1, a0
; RV64-NEXT:    ret
;
...
; RV32-NEXT:    vsrl.vi v2, v8, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v2, v2, v4, v0.t
; RV32-NEXT:    vsub.vv v2, v8, v2, v0.t
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v6, v2, v4, v0.t
; RV32-NEXT:    vsrl.vi v2, v2, 2, v0.t
; RV32-NEXT:    vand.vv v2, v2, v4, v0.t
; RV32-NEXT:    vadd.vv v2, v6, v2, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 4, v0.t
; RV32-NEXT:    vadd.vv v2, v2, v4, v0.t
; RV32-NEXT:    lui a1, 61681
; RV32-NEXT:    addi a1, a1, -241
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v4, a1
...
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vmul.vv v2, v2, v4, v0.t
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v2, a0, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv2i64:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV64-NEXT:    vsrl.vi v2, v8, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vsub.vv v2, v8, v2, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v4, v2, a0, v0.t
; RV64-NEXT:    vsrl.vi v2, v2, 2, v0.t
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vadd.vv v2, v4, v2, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 4, v0.t
; RV64-NEXT:    vadd.vv v2, v2, v4, v0.t
; RV64-NEXT:    lui a0, 61681
; RV64-NEXT:    addiw a0, a0, -241
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v2, v2, a0, v0.t
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v2, a0, v0.t
; RV64-NEXT:    ret
;
...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vsrl.vi v2, v8, 1
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v2, v2, v4
; RV32-NEXT:    vsub.vv v2, v8, v2
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v6, v2, v4
; RV32-NEXT:    vsrl.vi v2, v2, 2
; RV32-NEXT:    vand.vv v2, v2, v4
; RV32-NEXT:    vadd.vv v2, v6, v2
...
; RV32-NEXT:    vmv.v.x v4, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vmul.vv v2, v2, v4
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v2, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv2i64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV64-NEXT:    vsrl.vi v2, v8, 1
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v2, v2, a0
; RV64-NEXT:    vsub.vv v2, v8, v2
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v4, v2, a0
; RV64-NEXT:    vsrl.vi v2, v2, 2
; RV64-NEXT:    vand.vx v2, v2, a0
; RV64-NEXT:    vadd.vv v2, v4, v2
; RV64-NEXT:    vsrl.vi v4, v2, 4
; RV64-NEXT:    vadd.vv v2, v2, v4
; RV64-NEXT:    lui a0, 61681
; RV64-NEXT:    addiw a0, a0, -241
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v2, v2, a0
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v2, a0
; RV64-NEXT:    ret
;
...
; RV32-NEXT:    vsrl.vi v4, v8, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV32-NEXT:    vmv.v.x v12, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vand.vv v4, v4, v12, v0.t
; RV32-NEXT:    vsub.vv v4, v8, v4, v0.t
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vand.vv v12, v4, v8, v0.t
; RV32-NEXT:    vsrl.vi v4, v4, 2, v0.t
; RV32-NEXT:    vand.vv v4, v4, v8, v0.t
; RV32-NEXT:    vadd.vv v4, v12, v4, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 4, v0.t
; RV32-NEXT:    vadd.vv v4, v4, v8, v0.t
; RV32-NEXT:    lui a1, 61681
; RV32-NEXT:    addi a1, a1, -241
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV32-NEXT:    vmv.v.x v8, a1
...
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vmul.vv v4, v4, v8, v0.t
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v4, a0, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv4i64:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV64-NEXT:    vsrl.vi v4, v8, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vsub.vv v4, v8, v4, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v4, a0, v0.t
; RV64-NEXT:    vsrl.vi v4, v4, 2, v0.t
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vadd.vv v4, v8, v4, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 4, v0.t
; RV64-NEXT:    vadd.vv v4, v4, v8, v0.t
; RV64-NEXT:    lui a0, 61681
; RV64-NEXT:    addiw a0, a0, -241
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v4, v4, a0, v0.t
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v4, a0, v0.t
; RV64-NEXT:    ret
;
...
; RV32-NEXT:    vsub.vv v4, v8, v4
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vand.vv v12, v4, v8
; RV32-NEXT:    vsrl.vi v4, v4, 2
; RV32-NEXT:    vand.vv v4, v4, v8
; RV32-NEXT:    vadd.vv v4, v12, v4
...
; RV32-NEXT:    vmv.v.x v8, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    li a0, 56
; RV32-NEXT:    vsrl.vx v8, v4, a0
; RV32-NEXT:    ret
;
; RV64-LABEL: vp_ctpop_nxv4i64_unmasked:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV64-NEXT:    vsrl.vi v4, v8, 1
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v4, v4, a0
; RV64-NEXT:    vsub.vv v4, v8, v4
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v4, a0
; RV64-NEXT:    vsrl.vi v4, v4, 2
; RV64-NEXT:    vand.vx v4, v4, a0
; RV64-NEXT:    vadd.vv v4, v8, v4
; RV64-NEXT:    vsrl.vi v8, v4, 4
; RV64-NEXT:    vadd.vv v4, v4, v8
; RV64-NEXT:    lui a0, 61681
; RV64-NEXT:    addiw a0, a0, -241
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmul.vx v4, v4, a0
; RV64-NEXT:    li a0, 56
; RV64-NEXT:    vsrl.vx v8, v4, a0
; RV64-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vx v1, v8, a1
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vsrl.vi v2, v1, 1, v0.t
; CHECK-NEXT:    lui a0, 5
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
; CHECK-NEXT:    vsub.vv v1, v1, v2, v0.t
; CHECK-NEXT:    lui a0, 3
; CHECK-NEXT:    addi a0, a0, 819
; CHECK-NEXT:    vand.vx v2, v1, a0, v0.t
; CHECK-NEXT:    vsrl.vi v1, v1, 2, v0.t
...
; CHECK-ZVBB-NEXT:    vand.vx v1, v8, a1
; CHECK-ZVBB-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-ZVBB-NEXT:    vcpop.v v8, v1, v0.t
; CHECK-ZVBB-NEXT:    ret
