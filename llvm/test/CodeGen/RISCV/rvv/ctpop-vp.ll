...
; CHECK-ZVBB-NEXT:    srli a4, a1, 3
; CHECK-ZVBB-NEXT:    addi a3, a3, -1
; CHECK-ZVBB-NEXT:    vslidedown.vx v0, v0, a4
...
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vsub.vv v8, v16, v0
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vi v16, v24, 2
; RV64-NEXT:    lui a2, 209715
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vi v0, v8, 2
...
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmul.vx v16, v16, a2
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vmul.vx v24, v8, a2
; RV64-NEXT:    li a2, 56
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vx v8, v16, a2
; RV64-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vx v16, v24, a2
; RV64-NEXT:    ret
;
