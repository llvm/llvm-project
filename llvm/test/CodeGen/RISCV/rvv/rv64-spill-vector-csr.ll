...
; SPILL-O2-VLEN128-NEXT:    vfadd.vv v1, v8, v9
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 32
; SPILL-O2-VLEN128-NEXT:    vs1r.v v1, (a0) # Unknown-size Folded Spill
...
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 32
; SPILL-O2-VLEN128-NEXT:    vl1r.v v1, (a0) # Unknown-size Folded Reload
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 16
; SPILL-O2-VLEN128-NEXT:    vl1r.v v2, (a0) # Unknown-size Folded Reload
; SPILL-O2-VLEN128-NEXT:    vfadd.vv v8, v2, v1
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 32
