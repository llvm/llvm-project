...
; SPILL-O0-NEXT:    ld a0, 16(sp) # 8-byte Reload
; SPILL-O0-NEXT:    # implicit-def: $v8
; SPILL-O0-NEXT:    vsetvli zero, a0, e64, m1, tu, ma
; SPILL-O0-NEXT:    vfadd.vv v8, v9, v10
...
; SPILL-O0-NEXT:    ld ra, 40(sp) # 8-byte Reload
; SPILL-O0-NEXT:    addi sp, sp, 48
; SPILL-O0-NEXT:    ret
;
; SPILL-O2-LABEL: foo:
...
; SPILL-O2-NEXT:    sd ra, 24(sp) # 8-byte Spill
; SPILL-O2-NEXT:    sd s0, 16(sp) # 8-byte Spill
...
; SPILL-O2-NEXT:    ld ra, 24(sp) # 8-byte Reload
; SPILL-O2-NEXT:    ld s0, 16(sp) # 8-byte Reload
; SPILL-O2-NEXT:    addi sp, sp, 32
; SPILL-O2-NEXT:    ret
;
...
; SPILL-O2-VLEN128-NEXT:    sd ra, 24(sp) # 8-byte Spill
; SPILL-O2-VLEN128-NEXT:    sd s0, 16(sp) # 8-byte Spill
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, -32
; SPILL-O2-VLEN128-NEXT:    mv s0, a0
; SPILL-O2-VLEN128-NEXT:    addi a1, sp, 16
; SPILL-O2-VLEN128-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; SPILL-O2-VLEN128-NEXT:    vs1r.v v9, (a0) # vscale x 8-byte Spill
...
; SPILL-O2-VLEN128-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
; SPILL-O2-VLEN128-NEXT:    vsetvli zero, s0, e64, m1, ta, ma
; SPILL-O2-VLEN128-NEXT:    vfadd.vv v8, v9, v8
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 32
; SPILL-O2-VLEN128-NEXT:    ld ra, 24(sp) # 8-byte Reload
; SPILL-O2-VLEN128-NEXT:    ld s0, 16(sp) # 8-byte Reload
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 32
...
; SPILL-O0-VSETVLI-NEXT:    sd ra, 40(sp) # 8-byte Spill
; SPILL-O0-VSETVLI-NEXT:    vsetvli a1, zero, e8, m2, ta, ma
; SPILL-O0-VSETVLI-NEXT:    sub sp, sp, a1
; SPILL-O0-VSETVLI-NEXT:    sd a0, 16(sp) # 8-byte Spill
...
; SPILL-O0-VSETVLI-NEXT:    ld a0, 16(sp) # 8-byte Reload
; SPILL-O0-VSETVLI-NEXT:    # implicit-def: $v8
; SPILL-O0-VSETVLI-NEXT:    vsetvli zero, a0, e64, m1, tu, ma
; SPILL-O0-VSETVLI-NEXT:    vfadd.vv v8, v9, v10
; SPILL-O0-VSETVLI-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; SPILL-O0-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    ld ra, 40(sp) # 8-byte Reload
; SPILL-O0-VSETVLI-NEXT:    addi sp, sp, 48
...
; SPILL-O2-VSETVLI-NEXT:    sd ra, 24(sp) # 8-byte Spill
; SPILL-O2-VSETVLI-NEXT:    sd s0, 16(sp) # 8-byte Spill
...
; SPILL-O2-VSETVLI-NEXT:    ld ra, 24(sp) # 8-byte Reload
; SPILL-O2-VSETVLI-NEXT:    ld s0, 16(sp) # 8-byte Reload
; SPILL-O2-VSETVLI-NEXT:    addi sp, sp, 32
