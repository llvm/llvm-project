...
; RV32-NEXT:    vwaddu.vv v9, v9, v9
; RV32-NEXT:    vsetvli zero, a1, e16, m1, ta, ma
; RV32-NEXT:    vsoxei16.v v8, (a0), v9, v0.t
; RV32-NEXT:    ret
;
; RV64-LABEL: vpscatter_baseidx_zext_v8i8_v8i16:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV64-NEXT:    vwaddu.vv v9, v9, v9
; RV64-NEXT:    vsetvli zero, a1, e16, m1, ta, ma
; RV64-NEXT:    vsoxei16.v v8, (a0), v9, v0.t
; RV64-NEXT:    ret
...
; RV32-NEXT:    li a2, 4
; RV32-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV32-NEXT:    vwmulu.vx v10, v10, a2
; RV32-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
...
; RV64-NEXT:    li a2, 4
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV64-NEXT:    vwmulu.vx v10, v10, a2
; RV64-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
...
; RV32-NEXT:    li a2, 4
; RV32-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; RV32-NEXT:    vwmulsu.vx v10, v10, a2
; RV32-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; RV32-NEXT:    vsoxei32.v v8, (a0), v10, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    li a2, 8
; RV64-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; RV64-NEXT:    vwmulsu.vx v12, v12, a2
; RV64-NEXT:    vsetvli zero, a1, e64, m4, ta, ma
; RV64-NEXT:    vsoxei64.v v8, (a0), v12, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    vwmulsu.vx v24, v24, a1
; RV64-NEXT:    mv a1, a2
...
; RV64-NEXT:    vwmulu.vx v24, v24, a1
; RV64-NEXT:    mv a1, a2
