...
; ZVFH-NEXT:    add a2, a2, a1
; ZVFH-NEXT:    slli a1, a1, 1
; ZVFH-NEXT:    add a1, a1, a2
; ZVFH-NEXT:    sub sp, sp, a1
; ZVFH-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x19, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 25 * vlenb
...
; ZVFH-NEXT:    slli a4, a4, 4
; ZVFH-NEXT:    add a4, sp, a4
; ZVFH-NEXT:    addi a4, a4, 16
; ZVFH-NEXT:    vs1r.v v0, (a4) # vscale x 8-byte Folded Spill
; ZVFH-NEXT:    vslidedown.vx v7, v0, a2
; ZVFH-NEXT:    vmv1r.v v0, v7
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 3
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Folded Spill
; ZVFH-NEXT:    vsetvli zero, a3, e16, m4, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v8, v28, v0.t
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a3, a2, 4
; ZVFH-NEXT:    add a2, a3, a2
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v24, v20, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFH-NEXT:    vfadd.vv v24, v24, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v12, v24, v0.t
...
; ZVFHMIN-NEXT:    vfwcvtbf16.f.f.v v8, v28, v0.t
; ZVFHMIN-NEXT:    csrr a2, vlenb
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vfadd.vv v24, v24, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vfncvtbf16.f.f.w v12, v24, v0.t
...
; ZVFBFA-NEXT:    add a2, a2, a1
; ZVFBFA-NEXT:    slli a1, a1, 1
; ZVFBFA-NEXT:    add a1, a1, a2
; ZVFBFA-NEXT:    sub sp, sp, a1
; ZVFBFA-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x19, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 25 * vlenb
; ZVFBFA-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; ZVFBFA-NEXT:    vmv8r.v v24, v16
...
; ZVFBFA-NEXT:    sltu a4, a0, a3
; ZVFBFA-NEXT:    addi a4, a4, -1
; ZVFBFA-NEXT:    and a3, a4, a3
; ZVFBFA-NEXT:    csrr a4, vlenb
; ZVFBFA-NEXT:    slli a4, a4, 4
; ZVFBFA-NEXT:    add a4, sp, a4
; ZVFBFA-NEXT:    addi a4, a4, 16
; ZVFBFA-NEXT:    vs1r.v v0, (a4) # vscale x 8-byte Folded Spill
; ZVFBFA-NEXT:    vslidedown.vx v7, v0, a2
...
; ZVFBFA-NEXT:    vfwcvt.f.f.v v8, v28, v0.t
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    slli a3, a2, 4
; ZVFBFA-NEXT:    add a2, a3, a2
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVFBFA-NEXT:    vfwcvt.f.f.v v24, v20, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v24, v24, v8, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v12, v24, v0.t
...
; ZVFBFA-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Folded Reload
; ZVFBFA-NEXT:    csrr a1, vlenb
; ZVFBFA-NEXT:    slli a1, a1, 3
; ZVFBFA-NEXT:    add a1, sp, a1
; ZVFBFA-NEXT:    addi a1, a1, 16
; ZVFBFA-NEXT:    vl8r.v v16, (a1) # vscale x 64-byte Folded Reload
; ZVFBFA-NEXT:    vsetvli zero, a0, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v24, v16, v0.t
; ZVFBFA-NEXT:    addi a0, sp, 16
; ZVFBFA-NEXT:    vs8r.v v24, (a0) # vscale x 64-byte Folded Spill
; ZVFBFA-NEXT:    vmv1r.v v8, v0
; ZVFBFA-NEXT:    csrr a0, vlenb
; ZVFBFA-NEXT:    slli a1, a0, 4
; ZVFBFA-NEXT:    add a0, a1, a0
...
; ZVFH-NEXT:    .cfi_def_cfa_offset 16
; ZVFH-NEXT:    csrr a1, vlenb
; ZVFH-NEXT:    slli a2, a1, 4
; ZVFH-NEXT:    add a1, a2, a1
; ZVFH-NEXT:    sub sp, sp, a1
; ZVFH-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x11, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 17 * vlenb
; ZVFH-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
; ZVFH-NEXT:    vmv8r.v v24, v16
; ZVFH-NEXT:    vmv8r.v v16, v8
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    vmset.m v8
; ZVFH-NEXT:    slli a1, a2, 1
; ZVFH-NEXT:    srli a2, a2, 2
; ZVFH-NEXT:    sub a3, a0, a1
; ZVFH-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFH-NEXT:    vslidedown.vx v8, v8, a2
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 4
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vs1r.v v8, (a2) # vscale x 8-byte Folded Spill
...
; ZVFH-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
...
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 3
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
...
; ZVFBFA-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFA-NEXT:    csrr a1, vlenb
; ZVFBFA-NEXT:    slli a2, a1, 4
; ZVFBFA-NEXT:    add a1, a2, a1
; ZVFBFA-NEXT:    sub sp, sp, a1
; ZVFBFA-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x11, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 17 * vlenb
; ZVFBFA-NEXT:    vsetvli a1, zero, e8, m4, ta, ma
; ZVFBFA-NEXT:    vmv8r.v v24, v16
; ZVFBFA-NEXT:    vmv8r.v v16, v8
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    vmset.m v8
; ZVFBFA-NEXT:    slli a1, a2, 1
; ZVFBFA-NEXT:    srli a2, a2, 2
; ZVFBFA-NEXT:    sub a3, a0, a1
; ZVFBFA-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFBFA-NEXT:    vslidedown.vx v8, v8, a2
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    slli a2, a2, 4
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vs1r.v v8, (a2) # vscale x 8-byte Folded Spill
; ZVFBFA-NEXT:    sltu a2, a0, a3
; ZVFBFA-NEXT:    addi a2, a2, -1
; ZVFBFA-NEXT:    and a2, a2, a3
; ZVFBFA-NEXT:    csrr a3, vlenb
; ZVFBFA-NEXT:    slli a3, a3, 4
; ZVFBFA-NEXT:    add a3, sp, a3
; ZVFBFA-NEXT:    addi a3, a3, 16
; ZVFBFA-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
...
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    slli a2, a2, 3
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
...
; ZVFH-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFH-NEXT:    vslidedown.vx v6, v0, a2
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 3
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
...
; ZVFBFA-NEXT:    vslidedown.vx v6, v0, a2
; ZVFBFA-NEXT:    addi a2, sp, 16
; ZVFBFA-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Folded Spill
; ZVFBFA-NEXT:    vmv1r.v v0, v6
; ZVFBFA-NEXT:    vsetvli zero, a3, e16alt, m4, ta, ma
; ZVFBFA-NEXT:    vfwcvt.f.f.v v24, v20, v0.t
; ZVFBFA-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
...
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    vsetvli a3, zero, e16, m8, ta, ma
; ZVFH-NEXT:    vmset.m v16
; ZVFH-NEXT:    vmv.v.x v8, a1
; ZVFH-NEXT:    slli a1, a2, 1
; ZVFH-NEXT:    srli a2, a2, 2
; ZVFH-NEXT:    sub a3, a0, a1
; ZVFH-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFH-NEXT:    vslidedown.vx v16, v16, a2
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 4
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vs1r.v v16, (a2) # vscale x 8-byte Folded Spill
; ZVFH-NEXT:    sltu a2, a0, a3
; ZVFH-NEXT:    addi a2, a2, -1
; ZVFH-NEXT:    and a2, a2, a3
; ZVFH-NEXT:    csrr a3, vlenb
...
; ZVFH-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
; ZVFH-NEXT:    addi a3, sp, 16
; ZVFH-NEXT:    vs8r.v v8, (a3) # vscale x 64-byte Folded Spill
; ZVFH-NEXT:    vsetvli zero, a2, e16, m4, ta, ma
...
; ZVFH-NEXT:    add a2, sp, a2
; ZVFH-NEXT:    addi a2, a2, 16
; ZVFH-NEXT:    vl8r.v v8, (a2) # vscale x 64-byte Folded Reload
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v16, v12, v0.t
; ZVFH-NEXT:    csrr a2, vlenb
; ZVFH-NEXT:    slli a2, a2, 4
; ZVFH-NEXT:    add a2, sp, a2
...
; ZVFBFA-NEXT:    vfmv.v.f v24, fa0
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    vmset.m v16
; ZVFBFA-NEXT:    slli a1, a2, 1
; ZVFBFA-NEXT:    srli a2, a2, 2
; ZVFBFA-NEXT:    sub a3, a0, a1
; ZVFBFA-NEXT:    vsetvli a4, zero, e8alt, mf2, ta, ma
; ZVFBFA-NEXT:    vslidedown.vx v16, v16, a2
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    slli a2, a2, 4
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vs1r.v v16, (a2) # vscale x 8-byte Folded Spill
; ZVFBFA-NEXT:    sltu a2, a0, a3
; ZVFBFA-NEXT:    addi a2, a2, -1
; ZVFBFA-NEXT:    and a2, a2, a3
; ZVFBFA-NEXT:    csrr a3, vlenb
...
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vl8r.v v24, (a2) # vscale x 64-byte Folded Reload
...
; ZVFBFA-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
; ZVFBFA-NEXT:    addi a3, sp, 16
; ZVFBFA-NEXT:    vs8r.v v8, (a3) # vscale x 64-byte Folded Spill
; ZVFBFA-NEXT:    vsetvli zero, a2, e16, m4, ta, ma
...
; ZVFBFA-NEXT:    add a2, sp, a2
; ZVFBFA-NEXT:    addi a2, a2, 16
; ZVFBFA-NEXT:    vl8r.v v8, (a2) # vscale x 64-byte Folded Reload
; ZVFBFA-NEXT:    vfwcvt.f.f.v v16, v12, v0.t
; ZVFBFA-NEXT:    csrr a2, vlenb
; ZVFBFA-NEXT:    slli a2, a2, 4
; ZVFBFA-NEXT:    add a2, sp, a2
