...
; CHECK-NEXT:    vslidedown.vi v1, v2, 2
...
; CHECK-RV32-NEXT:    vslidedown.vi v0, v1, 4
; CHECK-RV32-NEXT:    vsetvli zero, a6, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vlse64.v v8, (a5), a2, v0.t
...
; CHECK-RV32-NEXT:    vslidedown.vi v0, v1, 2
; CHECK-RV32-NEXT:    vsetvli zero, a5, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vlse64.v v16, (a4), a2, v0.t
; CHECK-RV32-NEXT:    vsetvli zero, a3, e64, m8, ta, ma
; CHECK-RV32-NEXT:    vmv1r.v v0, v1
...
; CHECK-RV64-NEXT:    vslidedown.vi v0, v1, 4
; CHECK-RV64-NEXT:    vsetvli zero, a6, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vlse64.v v8, (a5), a2, v0.t
...
; CHECK-RV64-NEXT:    vslidedown.vi v0, v1, 2
; CHECK-RV64-NEXT:    vsetvli zero, a5, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vlse64.v v16, (a3), a2, v0.t
; CHECK-RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; CHECK-RV64-NEXT:    vmv1r.v v0, v1
