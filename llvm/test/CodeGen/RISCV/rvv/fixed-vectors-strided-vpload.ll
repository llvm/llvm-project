...
; CHECK-RV32-LABEL: zero_strided_unmasked_vpload_4i8_i8:
; CHECK-RV32:       # %bb.0:
; CHECK-RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-RV32-NEXT:    vle8.v v8, (a0)
; CHECK-RV32-NEXT:    vmv.x.s a0, v8
; CHECK-RV32-NEXT:    vsetivli zero, 3, e8, mf4, ta, ma
; CHECK-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-RV32-NEXT:    ret
;
; CHECK-RV64-LABEL: zero_strided_unmasked_vpload_4i8_i8:
; CHECK-RV64:       # %bb.0:
; CHECK-RV64-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; CHECK-RV64-NEXT:    vle8.v v8, (a0)
; CHECK-RV64-NEXT:    vmv.x.s a0, v8
; CHECK-RV64-NEXT:    vsetivli zero, 3, e8, mf4, ta, ma
; CHECK-RV64-NEXT:    vmv.v.x v8, a0
; CHECK-RV64-NEXT:    ret
