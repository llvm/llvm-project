...
; CHECK-NEXT:    vnsrl.wi v1, v8, 0, v0.t
...
; CHECK-NEXT:    vnsrl.wi v6, v24, 0, v0.t
...
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vnsrl.wi v4, v16, 0, v0.t
...
; CHECK-NEXT:    vslidedown.vx v0, v2, a3
...
; CHECK-NEXT:    vslidedown.vx v3, v1, a3
