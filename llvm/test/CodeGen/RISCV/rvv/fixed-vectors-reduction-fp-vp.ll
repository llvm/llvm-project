...
; CHECK-NEXT:    vfredusum.vs v2, v8, v2, v0.t
...
; CHECK-NEXT:    vfredusum.vs v2, v16, v2, v0.t
; CHECK-NEXT:    vfmv.f.s fa0, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfmv.s.f v2, fa0
; CHECK-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; CHECK-NEXT:    vfredosum.vs v2, v8, v2, v0.t
; CHECK-NEXT:    addi a1, a0, -32
; CHECK-NEXT:    sltu a0, a0, a1
; CHECK-NEXT:    addi a0, a0, -1
; CHECK-NEXT:    and a0, a0, a1
; CHECK-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vfredosum.vs v2, v16, v2, v0.t
; CHECK-NEXT:    vfmv.f.s fa0, v2
; CHECK-NEXT:    ret
