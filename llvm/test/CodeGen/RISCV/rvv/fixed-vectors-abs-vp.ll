...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
