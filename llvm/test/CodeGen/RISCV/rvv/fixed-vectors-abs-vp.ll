...
; CHECK-NEXT:    vrsub.vi v1, v8, 0, v0.t
; CHECK-NEXT:    vmax.vv v8, v8, v1, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrsub.vi v2, v8, 0, v0.t
; CHECK-NEXT:    vmax.vv v8, v8, v2, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; CHECK-NEXT:    vrsub.vi v2, v8, 0
; CHECK-NEXT:    vmax.vv v8, v8, v2
; CHECK-NEXT:    ret
  %head = insertelement <16 x i1> poison, i1 true, i32 0
  %m = shufflevector <16 x i1> %head, <16 x i1> poison, <16 x i32> zeroinitializer
  %v = call <16 x i16> @llvm.vp.abs.v16i16(<16 x i16> %va, i1 false, <16 x i1> %m, i32 %evl)
...
; CHECK-NEXT:    vrsub.vi v4, v8, 0, v0.t
; CHECK-NEXT:    vmax.vv v8, v8, v4, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; CHECK-NEXT:    vrsub.vi v4, v8, 0
; CHECK-NEXT:    vmax.vv v8, v8, v4
; CHECK-NEXT:    ret
  %head = insertelement <16 x i1> poison, i1 true, i32 0
  %m = shufflevector <16 x i1> %head, <16 x i1> poison, <16 x i32> zeroinitializer
  %v = call <16 x i32> @llvm.vp.abs.v16i32(<16 x i32> %va, i1 false, <16 x i1> %m, i32 %evl)
