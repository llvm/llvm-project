...
; CHECK-NEXT:    vs8r.v v8, (t1) # vscale x 64-byte Spill
; CHECK-NEXT:    add t1, a1, a6
; CHECK-NEXT:    vl8re32.v v8, (t2)
; CHECK-NEXT:    addi t2, sp, 16
; CHECK-NEXT:    vs8r.v v8, (t2) # vscale x 64-byte Spill
...
; CHECK-NEXT:    vl8r.v v0, (a1) # vscale x 64-byte Reload
; CHECK-NEXT:    vs8r.v v0, (a0)
...
; RV64-NEXT:    sd s0, 128(sp) # 8-byte Spill
...
; RV64-NEXT:    ld s0, 128(sp) # 8-byte Reload
...
; RV64-NEXT:    sd ra, 152(sp) # 8-byte Spill
; RV64-NEXT:    sd s0, 144(sp) # 8-byte Spill
; RV64-NEXT:    sd s1, 136(sp) # 8-byte Spill
; RV64-NEXT:    .cfi_offset ra, -8
; RV64-NEXT:    .cfi_offset s0, -16
...
; RV64-NEXT:    ld ra, 152(sp) # 8-byte Reload
; RV64-NEXT:    ld s0, 144(sp) # 8-byte Reload
; RV64-NEXT:    ld s1, 136(sp) # 8-byte Reload
; RV64-NEXT:    .cfi_restore ra
; RV64-NEXT:    .cfi_restore s0
...
; RV32-NEXT:    sw s1, 68(sp) # 4-byte Spill
; RV32-NEXT:    .cfi_offset ra, -4
; RV32-NEXT:    .cfi_offset s0, -8
; RV32-NEXT:    .cfi_offset s1, -12
...
; RV32-NEXT:    lw s1, 68(sp) # 4-byte Reload
; RV32-NEXT:    .cfi_restore ra
; RV32-NEXT:    .cfi_restore s0
; RV32-NEXT:    .cfi_restore s1
; RV32-NEXT:    addi sp, sp, 80
...
; RV64-NEXT:    sd ra, 88(sp) # 8-byte Spill
; RV64-NEXT:    sd s0, 80(sp) # 8-byte Spill
; RV64-NEXT:    sd s1, 72(sp) # 8-byte Spill
; RV64-NEXT:    .cfi_offset ra, -8
; RV64-NEXT:    .cfi_offset s0, -16
; RV64-NEXT:    .cfi_offset s1, -24
...
; RV64-NEXT:    ld ra, 88(sp) # 8-byte Reload
; RV64-NEXT:    ld s0, 80(sp) # 8-byte Reload
; RV64-NEXT:    ld s1, 72(sp) # 8-byte Reload
; RV64-NEXT:    .cfi_restore ra
; RV64-NEXT:    .cfi_restore s0
; RV64-NEXT:    .cfi_restore s1
; RV64-NEXT:    addi sp, sp, 96
