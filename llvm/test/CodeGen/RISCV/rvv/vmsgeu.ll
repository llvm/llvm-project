...
; CHECK-NEXT:    vmsleu.vv v1, v9, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsleu.vv v2, v10, v9, v0.t
...
; CHECK-NEXT:    vmsleu.vv v1, v10, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsleu.vv v2, v12, v10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsleu.vv v1, v12, v8
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsleu.vv v2, v16, v12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsltu.vx v1, v8, a0, v0.t
; CHECK-NEXT:    vmxor.mm v0, v1, v9
; CHECK-NEXT:    ret
entry:
...
; RV64-NEXT:    vmsltu.vx v1, v8, a0
; RV64-NEXT:    vmnot.m v0, v1
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsleu.vv v1, v2, v8, v0.t
...
; RV64-NEXT:    vmsltu.vx v1, v8, a0, v0.t
; RV64-NEXT:    vmxor.mm v0, v1, v9
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsleu.vv v1, v4, v8, v0.t
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, -15, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsgeu.mask.nxv1i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, -13, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsgeu.mask.nxv2i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, -11, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsgeu.mask.nxv4i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, -9, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsgeu.mask.nxv8i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgtu.vi v1, v8, -7, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i1> @llvm.riscv.vmsgeu.mask.nxv16i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e8, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsgtu.vi v1, v8, -5, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i1> @llvm.riscv.vmsgeu.mask.nxv32i8.i8(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, -3, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsgeu.mask.nxv1i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, 0, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsgeu.mask.nxv4i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgtu.vi v1, v8, 2, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsgeu.mask.nxv8i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e16, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsgtu.vi v1, v8, 4, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i1> @llvm.riscv.vmsgeu.mask.nxv16i16.i16(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, mf2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, 6, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsgeu.mask.nxv1i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, 8, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsgeu.mask.nxv2i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgtu.vi v1, v8, 10, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i1> @llvm.riscv.vmsgeu.mask.nxv4i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e32, m4, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmsgtu.vi v1, v8, 12, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i1> @llvm.riscv.vmsgeu.mask.nxv8i32.i32(
...
; CHECK-NEXT:    vsetvli zero, a0, e64, m1, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmsgtu.vi v1, v8, 14, v0.t
; CHECK-NEXT:    vmv.v.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmsgeu.mask.nxv1i64.i64(
...
; CHECK-NEXT:    vsetvli zero, a0, e64, m2, ta, mu
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmsgtu.vi v1, v8, -16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i1> @llvm.riscv.vmsgeu.mask.nxv2i64.i64(
...
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, mu
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vmsleu.vv v0, v1, v8, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
