...
; CHECK-NEXT:    vand.vv v1, v8, v1, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-NEXT:    vzext.vf2 v2, v1, v0.t
; CHECK-NEXT:    vfwcvt.f.xu.v v1, v2, v0.t
...
; CHECK-NEXT:    vand.vv v1, v8, v1
; CHECK-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; CHECK-NEXT:    vzext.vf2 v2, v1
; CHECK-NEXT:    vfwcvt.f.xu.v v1, v2
; CHECK-NEXT:    vnsrl.wi v1, v1, 23
; CHECK-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; CHECK-NEXT:    vnsrl.wi v1, v1, 0
; CHECK-NEXT:    li a0, 127
; CHECK-NEXT:    vsub.vx v8, v1, a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vsrl.vi v2, v4, 23, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
...
; CHECK-NEXT:    vand.vv v2, v8, v2, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; CHECK-NEXT:    vzext.vf2 v4, v2, v0.t
...
; CHECK-NEXT:    vnsrl.wi v2, v4, 0, v0.t
; CHECK-NEXT:    li a0, 127
; CHECK-NEXT:    vsub.vx v8, v2, a0, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vnsrl.wi v4, v8, 0, v0.t
; CHECK-NEXT:    li a0, 127
; CHECK-NEXT:    vsub.vx v8, v4, a0, v0.t
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vsrl.vx v1, v2, a0, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vnsrl.wi v1, v1, 0, v0.t
...
; CHECK-NEXT:    vand.vv v1, v8, v1, v0.t
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v1, v1, v0.t
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v1, v1, a1, v0.t
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v1, a1, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vv v1, v8, v1
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v1, v1
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v1, v1, a1
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v1, a1
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vv v2, v8, v2, v0.t
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v2, v2, v0.t
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v2, v2, a1, v0.t
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v2, a1, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vv v2, v8, v2
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v2, v2
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v2, v2, a1
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v2, a1
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vv v4, v8, v4, v0.t
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v4, v4, v0.t
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v4, v4, a1, v0.t
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v4, a1, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vand.vv v4, v8, v4
; CHECK-NEXT:    fsrmi a0, 1
; CHECK-NEXT:    vfcvt.f.xu.v v4, v4
; CHECK-NEXT:    li a1, 52
; CHECK-NEXT:    vsrl.vx v4, v4, a1
; CHECK-NEXT:    li a1, 1023
; CHECK-NEXT:    vsub.vx v8, v4, a1
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
;
...
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-NEXT:    vor.vx v1, v8, a1, v0.t
; CHECK-NEXT:    li a0, 1
; CHECK-NEXT:    vsub.vx v2, v1, a0, v0.t
; CHECK-NEXT:    vnot.v v1, v1, v0.t
; CHECK-NEXT:    vand.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 1, v0.t
; CHECK-NEXT:    lui a0, 5
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v2, v2, a0, v0.t
...
; CHECK-ZVBB-NEXT:    vsetvli zero, a0, e16, mf4, ta, ma
; CHECK-ZVBB-NEXT:    vor.vx v1, v8, a1, v0.t
; CHECK-ZVBB-NEXT:    vctz.v v8, v1, v0.t
; CHECK-ZVBB-NEXT:    ret
