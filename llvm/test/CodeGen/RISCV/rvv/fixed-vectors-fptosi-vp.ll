...
; ZVFH-NEXT:    vfncvt.rtz.x.f.w v1, v8, v0.t
...
; ZVFHMIN-NEXT:    vfncvt.rtz.x.f.w v2, v1, v0.t
; ZVFHMIN-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; ZVFHMIN-NEXT:    vnsrl.wi v8, v2, 0, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rtz.x.f.w v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.x.f.v v1, v8, v0.t
; ZVFH-NEXT:    vmv1r.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfcvt.rtz.x.f.v v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.f.f.v v1, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.x.f.v v8, v1, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.x.f.v v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFH-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.x.f.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.x.f.v v8, v1
; ZVFHMIN-NEXT:    ret
...
; CHECK-NEXT:    vfncvt.rtz.x.f.w v1, v8, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; CHECK-NEXT:    vnsrl.wi v8, v1, 0, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-NEXT:    vfwcvt.rtz.x.f.v v2, v8, v0.t
...
; CHECK-NEXT:    vnsrl.wi v1, v1, 0, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; CHECK-NEXT:    vnsrl.wi v8, v1, 0, v0.t
; CHECK-NEXT:    ret
