...
; ZVFHMIN-NEXT:    vfncvt.rtz.x.f.w v8, v8, v0.t
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.x.f.v v8, v8, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.f.f.v v8, v8, v0.t
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.x.f.v v8, v8, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.x.f.v v8, v8
; ZVFHMIN-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-NEXT:    vfwcvt.rtz.x.f.v v8, v8, v0.t
; CHECK-NEXT:    ret
