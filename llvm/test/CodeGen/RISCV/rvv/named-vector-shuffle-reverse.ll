...
; CHECK-NEXT:    vid.v v16
; CHECK-NEXT:    addi a0, a0, -1
; CHECK-NEXT:    vrsub.vx v20, v16, a0
; CHECK-NEXT:    vrgather.vv v23, v8, v20
; CHECK-NEXT:    vrgather.vv v19, v12, v20
; CHECK-NEXT:    vrgather.vv v22, v9, v20
; CHECK-NEXT:    vrgather.vv v18, v13, v20
; CHECK-NEXT:    vrgather.vv v13, v10, v20
; CHECK-NEXT:    vrgather.vv v12, v11, v20
; CHECK-NEXT:    vmv2r.v v8, v18
; CHECK-NEXT:    vmv2r.v v10, v12
; CHECK-NEXT:    vrgather.vv v17, v14, v20
; CHECK-NEXT:    vrgather.vv v16, v15, v20
