...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v8, v9
...
; RV32-BITS-256-NEXT:    vrgather.vv v8, v8, v9
...
; RV32-BITS-512-NEXT:    vrgather.vv v8, v8, v9
...
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v8, v9
...
; RV64-BITS-256-NEXT:    vrgather.vv v8, v8, v9
...
; RV64-BITS-512-NEXT:    vrgather.vv v8, v8, v9
...
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v8
; RV32-BITS-UNKNOWN-NEXT:    vmsne.vi v0, v8, 0
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v10, v8
; RV64-BITS-UNKNOWN-NEXT:    vmsne.vi v0, v8, 0
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vmerge.vim v8, v8, 1, v0
; RV32-BITS-256-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; RV32-BITS-256-NEXT:    vrgather.vv v11, v8, v10
; RV32-BITS-256-NEXT:    vrgather.vv v10, v9, v10
; RV32-BITS-256-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; RV32-BITS-512-NEXT:    vmerge.vim v8, v8, 1, v0
; RV32-BITS-512-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; RV32-BITS-512-NEXT:    vrgather.vv v11, v8, v10
; RV32-BITS-512-NEXT:    vrgather.vv v10, v9, v10
; RV32-BITS-512-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; RV64-BITS-256-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-BITS-256-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; RV64-BITS-256-NEXT:    vrgather.vv v11, v8, v10
; RV64-BITS-256-NEXT:    vrgather.vv v10, v9, v10
; RV64-BITS-256-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; RV64-BITS-512-NEXT:    vmerge.vim v8, v8, 1, v0
; RV64-BITS-512-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; RV64-BITS-512-NEXT:    vrgather.vv v11, v8, v10
; RV64-BITS-512-NEXT:    vrgather.vv v10, v9, v10
; RV64-BITS-512-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
...
; RV32-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV32-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v8, v10
; RV32-BITS-UNKNOWN-NEXT:    ret
;
...
; RV64-BITS-UNKNOWN-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV64-BITS-UNKNOWN-NEXT:    vrgatherei16.vv v8, v8, v10
; RV64-BITS-UNKNOWN-NEXT:    ret
;
...
; RV32-BITS-256-NEXT:    vrgather.vv v15, v8, v12
; RV32-BITS-256-NEXT:    vrgather.vv v14, v9, v12
; RV32-BITS-256-NEXT:    vrgather.vv v13, v10, v12
; RV32-BITS-256-NEXT:    vrgather.vv v12, v11, v12
...
; RV32-BITS-512-NEXT:    vrgather.vv v15, v8, v12
; RV32-BITS-512-NEXT:    vrgather.vv v14, v9, v12
; RV32-BITS-512-NEXT:    vrgather.vv v13, v10, v12
; RV32-BITS-512-NEXT:    vrgather.vv v12, v11, v12
...
; RV64-BITS-256-NEXT:    vrgather.vv v15, v8, v12
; RV64-BITS-256-NEXT:    vrgather.vv v14, v9, v12
; RV64-BITS-256-NEXT:    vrgather.vv v13, v10, v12
; RV64-BITS-256-NEXT:    vrgather.vv v12, v11, v12
...
; RV64-BITS-512-NEXT:    vrgather.vv v15, v8, v12
; RV64-BITS-512-NEXT:    vrgather.vv v14, v9, v12
; RV64-BITS-512-NEXT:    vrgather.vv v13, v10, v12
; RV64-BITS-512-NEXT:    vrgather.vv v12, v11, v12
...
; RV32-BITS-256-NEXT:    vrgather.vv v15, v16, v8
; RV32-BITS-256-NEXT:    vrgather.vv v14, v17, v8
; RV32-BITS-256-NEXT:    vrgather.vv v13, v18, v8
; RV32-BITS-256-NEXT:    vrgather.vv v12, v19, v8
; RV32-BITS-256-NEXT:    vrgather.vv v11, v20, v8
; RV32-BITS-256-NEXT:    vrgather.vv v10, v21, v8
; RV32-BITS-256-NEXT:    vrgather.vv v9, v22, v8
; RV32-BITS-256-NEXT:    vrgather.vv v8, v23, v8
; RV32-BITS-256-NEXT:    ret
;
...
; RV32-BITS-512-NEXT:    vrgather.vv v15, v16, v8
; RV32-BITS-512-NEXT:    vrgather.vv v14, v17, v8
; RV32-BITS-512-NEXT:    vrgather.vv v13, v18, v8
; RV32-BITS-512-NEXT:    vrgather.vv v12, v19, v8
; RV32-BITS-512-NEXT:    vrgather.vv v11, v20, v8
; RV32-BITS-512-NEXT:    vrgather.vv v10, v21, v8
; RV32-BITS-512-NEXT:    vrgather.vv v9, v22, v8
; RV32-BITS-512-NEXT:    vrgather.vv v8, v23, v8
; RV32-BITS-512-NEXT:    ret
;
...
; RV64-BITS-256-NEXT:    vrgather.vv v15, v16, v8
; RV64-BITS-256-NEXT:    vrgather.vv v14, v17, v8
; RV64-BITS-256-NEXT:    vrgather.vv v13, v18, v8
; RV64-BITS-256-NEXT:    vrgather.vv v12, v19, v8
; RV64-BITS-256-NEXT:    vrgather.vv v11, v20, v8
; RV64-BITS-256-NEXT:    vrgather.vv v10, v21, v8
; RV64-BITS-256-NEXT:    vrgather.vv v9, v22, v8
; RV64-BITS-256-NEXT:    vrgather.vv v8, v23, v8
; RV64-BITS-256-NEXT:    ret
;
...
; RV64-BITS-512-NEXT:    vrgather.vv v15, v16, v8
; RV64-BITS-512-NEXT:    vrgather.vv v14, v17, v8
; RV64-BITS-512-NEXT:    vrgather.vv v13, v18, v8
; RV64-BITS-512-NEXT:    vrgather.vv v12, v19, v8
; RV64-BITS-512-NEXT:    vrgather.vv v11, v20, v8
; RV64-BITS-512-NEXT:    vrgather.vv v10, v21, v8
; RV64-BITS-512-NEXT:    vrgather.vv v9, v22, v8
; RV64-BITS-512-NEXT:    vrgather.vv v8, v23, v8
; RV64-BITS-512-NEXT:    ret
...
; CHECK-NEXT:    vrgather.vv v17, v14, v16
; CHECK-NEXT:    vrgather.vv v16, v15, v16
...
; RV32-NEXT:    vrgather.vv v31, v12, v24
; RV32-NEXT:    vrgather.vv v23, v8, v24
; RV32-NEXT:    vrgather.vv v30, v13, v24
; RV32-NEXT:    vrgather.vv v22, v9, v24
; RV32-NEXT:    vrgather.vv v29, v14, v24
; RV32-NEXT:    vrgather.vv v21, v10, v24
; RV32-NEXT:    vrgather.vv v28, v15, v24
; RV32-NEXT:    vrgather.vv v20, v11, v24
; RV32-NEXT:    addi a1, sp, 64
; RV32-NEXT:    slli a0, a0, 3
; RV32-NEXT:    add a0, a1, a0
; RV32-NEXT:    vrgather.vv v27, v16, v24
; RV32-NEXT:    vs4r.v v20, (a0)
; RV32-NEXT:    vrgather.vv v26, v17, v24
; RV32-NEXT:    vrgather.vv v25, v18, v24
; RV32-NEXT:    vrgather.vv v24, v19, v24
...
; RV64-NEXT:    vrgather.vv v31, v12, v24
; RV64-NEXT:    vrgather.vv v23, v8, v24
; RV64-NEXT:    vrgather.vv v30, v13, v24
; RV64-NEXT:    vrgather.vv v22, v9, v24
; RV64-NEXT:    vrgather.vv v29, v14, v24
; RV64-NEXT:    vrgather.vv v21, v10, v24
; RV64-NEXT:    vrgather.vv v28, v15, v24
; RV64-NEXT:    vrgather.vv v20, v11, v24
; RV64-NEXT:    addi a1, sp, 64
; RV64-NEXT:    slli a0, a0, 3
; RV64-NEXT:    add a0, a1, a0
; RV64-NEXT:    vrgather.vv v27, v16, v24
; RV64-NEXT:    vs4r.v v20, (a0)
; RV64-NEXT:    vrgather.vv v26, v17, v24
; RV64-NEXT:    vrgather.vv v25, v18, v24
; RV64-NEXT:    vrgather.vv v24, v19, v24
