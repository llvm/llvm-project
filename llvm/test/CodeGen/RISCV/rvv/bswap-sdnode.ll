...
; CHECK-NEXT:    vsrl.vi v20, v8, 24
; CHECK-NEXT:    vsll.vi v16, v16, 8
; CHECK-NEXT:    vsll.vi v8, v8, 24
; CHECK-NEXT:    vor.vv v12, v12, v20
; CHECK-NEXT:    vor.vv v8, v8, v16
; CHECK-NEXT:    vor.vv v8, v8, v12
; CHECK-NEXT:    ret
;
...
; RV32-NEXT:    vand.vx v14, v8, a2
; RV32-NEXT:    vsll.vx v14, v14, a1
...
; RV64-NEXT:    vsll.vx v8, v8, a1
; RV64-NEXT:    vsll.vx v28, v28, a0
; RV64-NEXT:    vor.vv v20, v20, v24
; RV64-NEXT:    vor.vv v8, v8, v28
...
; RV64-NEXT:    vs8r.v v24, (a3) # vscale x 64-byte Folded Spill
