...
; CHECK-NO-FELEN64-NEXT:    vle64.v v1, (a0)
; CHECK-NO-FELEN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; CHECK-NO-FELEN64-NEXT:    vfmv.s.f v2, fa0
; CHECK-NO-FELEN64-NEXT:    #APP
; CHECK-NO-FELEN64-NEXT:    # use v1 v2
...
; CHECK-FELEN64-NEXT:    vle64.v v1, (a0)
; CHECK-FELEN64-NEXT:    vfmv.s.f v2, fa0
; CHECK-FELEN64-NEXT:    #APP
; CHECK-FELEN64-NEXT:    # use v1 v2
...
; CHECK-NO-FELEN64-NEXT:    vle32.v v1, (a0)
; CHECK-NO-FELEN64-NEXT:    vfmv.s.f v2, fa0
; CHECK-NO-FELEN64-NEXT:    #APP
; CHECK-NO-FELEN64-NEXT:    # use v1 v2
; CHECK-NO-FELEN64-NEXT:    #NO_APP
...
; CHECK-FELEN64-NEXT:    vle32.v v1, (a0)
; CHECK-FELEN64-NEXT:    vfmv.s.f v2, fa0
; CHECK-FELEN64-NEXT:    #APP
; CHECK-FELEN64-NEXT:    # use v1 v2
; CHECK-FELEN64-NEXT:    #NO_APP
