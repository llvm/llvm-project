...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <4 x i8> @llvm.ssub.sat.v4i8(<4 x i8> %va, <4 x i8> splat (i8 1))
  ret <4 x i8> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <16 x i8> @llvm.ssub.sat.v16i8(<16 x i8> %va, <16 x i8> splat (i8 1))
  ret <16 x i8> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <4 x i16> @llvm.ssub.sat.v4i16(<4 x i16> %va, <4 x i16> splat (i16 1))
  ret <4 x i16> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <16 x i16> @llvm.ssub.sat.v16i16(<16 x i16> %va, <16 x i16> splat (i16 1))
  ret <16 x i16> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <4 x i32> @llvm.ssub.sat.v4i32(<4 x i32> %va, <4 x i32> splat (i32 1))
  ret <4 x i32> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <16 x i32> @llvm.ssub.sat.v16i32(<16 x i32> %va, <16 x i32> splat (i32 1))
  ret <16 x i32> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <2 x i64> @llvm.ssub.sat.v2i64(<2 x i64> %va, <2 x i64> splat (i64 1))
  ret <2 x i64> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <4 x i64> @llvm.ssub.sat.v4i64(<4 x i64> %va, <4 x i64> splat (i64 1))
  ret <4 x i64> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <8 x i64> @llvm.ssub.sat.v8i64(<8 x i64> %va, <8 x i64> splat (i64 1))
  ret <8 x i64> %v
}
...
; CHECK-NEXT:    vssub.vx v8, v8, a0
; CHECK-NEXT:    ret
  %v = call <16 x i64> @llvm.ssub.sat.v16i64(<16 x i64> %va, <16 x i64> splat (i64 1))
  ret <16 x i64> %v
}
