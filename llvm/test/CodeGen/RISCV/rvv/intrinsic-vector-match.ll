...
; CHECK-NEXT:    vrgather.vi v10, v10, 0
...
; CHECK-NEXT:    vmseq.vv v12, v8, v12
; CHECK-NEXT:    vrgather.vi v10, v10, 3
; CHECK-NEXT:    vmor.mm v13, v14, v16
; CHECK-NEXT:    vmor.mm v12, v13, v12
; CHECK-NEXT:    vmseq.vv v8, v8, v10
...
; CHECK-NEXT:    vrgather.vi v18, v10, 3
; CHECK-NEXT:    vmseq.vv v11, v8, v12
; CHECK-NEXT:    vmseq.vv v20, v8, v14
...
; CHECK-NEXT:    vmseq.vv v12, v8, v12
; CHECK-NEXT:    vmor.mm v11, v20, v11
; CHECK-NEXT:    vmor.mm v11, v11, v16
; CHECK-NEXT:    vmor.mm v11, v11, v17
; CHECK-NEXT:    vmor.mm v13, v11, v18
; CHECK-NEXT:    vrgather.vi v10, v10, 7
; CHECK-NEXT:    vmor.mm v13, v13, v14
; CHECK-NEXT:    vmor.mm v12, v13, v12
; CHECK-NEXT:    vmseq.vv v8, v8, v10
; CHECK-NEXT:    vmor.mm v8, v12, v8
; CHECK-NEXT:    vmand.mm v0, v8, v0
...
; CHECK-NEXT:    vmseq.vv v12, v8, v12
; CHECK-NEXT:    vmor.mm v11, v28, v11
; CHECK-NEXT:    vmor.mm v11, v11, v29
; CHECK-NEXT:    vmor.mm v11, v11, v30
; CHECK-NEXT:    vmor.mm v11, v11, v20
; CHECK-NEXT:    vmor.mm v11, v11, v21
; CHECK-NEXT:    vmor.mm v11, v11, v22
; CHECK-NEXT:    vmor.mm v11, v11, v23
; CHECK-NEXT:    vmor.mm v11, v11, v24
; CHECK-NEXT:    vmor.mm v11, v11, v25
; CHECK-NEXT:    vmor.mm v11, v11, v16
; CHECK-NEXT:    vmor.mm v11, v11, v17
; CHECK-NEXT:    vmor.mm v13, v11, v18
; CHECK-NEXT:    vrgather.vi v10, v10, 15
; CHECK-NEXT:    vmor.mm v13, v13, v14
; CHECK-NEXT:    vmor.mm v12, v13, v12
; CHECK-NEXT:    vmseq.vv v8, v8, v10
; CHECK-NEXT:    vmor.mm v8, v12, v8
...
; CHECK-NEXT:    vrgather.vi v9, v9, 0
...
; CHECK-NEXT:    vrgather.vi v9, v9, 3
; CHECK-NEXT:    vmseq.vv v11, v8, v11
...
; CHECK-NEXT:    vrgather.vi v9, v9, 7
; CHECK-NEXT:    vmseq.vv v11, v8, v11
; CHECK-NEXT:    vmor.mm v10, v10, v11
; CHECK-NEXT:    vmseq.vv v8, v8, v9
; CHECK-NEXT:    vmor.mm v8, v10, v8
...
; CHECK-NEXT:    vrgather.vi v9, v9, 15
; CHECK-NEXT:    vmseq.vv v11, v8, v11
; CHECK-NEXT:    vmor.mm v10, v10, v11
; CHECK-NEXT:    vmseq.vv v8, v8, v9
; CHECK-NEXT:    vmor.mm v8, v10, v8
...
; RV32-NEXT:    vrgather.vi v10, v10, 15
...
; RV64-NEXT:    vrgather.vi v10, v10, 15
; RV64-NEXT:    vmseq.vv v10, v8, v10
...
; RV32-NEXT:    vmseq.vv v12, v8, v12
; RV32-NEXT:    vmor.mm v9, v12, v9
; RV32-NEXT:    vmseq.vv v12, v8, v13
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v14
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v15
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v16
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v17
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v18
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v19
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v20
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v21
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v22
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vv v12, v8, v23
; RV32-NEXT:    vmor.mm v9, v9, v12
; RV32-NEXT:    vmseq.vx v12, v8, a0
; RV32-NEXT:    vmseq.vv v11, v8, v11
; RV32-NEXT:    vmor.mm v9, v9, v11
; RV32-NEXT:    vmseq.vx v11, v8, a1
; RV32-NEXT:    vmseq.vv v13, v8, v24
...
; RV64-NEXT:    vmseq.vv v12, v8, v12
; RV64-NEXT:    vmor.mm v9, v12, v9
; RV64-NEXT:    vmseq.vv v12, v8, v13
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v14
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v15
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v16
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v17
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v18
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v19
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v20
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v21
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v22
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vv v12, v8, v23
; RV64-NEXT:    vmor.mm v9, v9, v12
; RV64-NEXT:    vmseq.vx v12, v8, a0
; RV64-NEXT:    vmseq.vv v11, v8, v11
; RV64-NEXT:    vmor.mm v9, v9, v11
; RV64-NEXT:    vmseq.vx v11, v8, a1
; RV64-NEXT:    vmseq.vv v13, v8, v24
