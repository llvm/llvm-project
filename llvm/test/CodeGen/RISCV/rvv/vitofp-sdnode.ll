...
; CHECK-NEXT:    vfncvtbf16.f.f.w v8, v8
; CHECK-NEXT:    vfwcvt.f.x.v v16, v16
; CHECK-NEXT:    vfncvtbf16.f.f.w v12, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfncvtbf16.f.f.w v8, v8
; CHECK-NEXT:    vfwcvt.f.xu.v v16, v16
; CHECK-NEXT:    vfncvtbf16.f.f.w v12, v16
; CHECK-NEXT:    ret
...
; ZVFHMIN-NEXT:    vmerge.vim v8, v16, -1, v0
...
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v8
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v16, v16
; ZVFHMIN-NEXT:    vfncvt.f.f.w v12, v16
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v8
; ZVFHMIN-NEXT:    vfwcvt.f.xu.v v16, v16
; ZVFHMIN-NEXT:    vfncvt.f.f.w v12, v16
; ZVFHMIN-NEXT:    ret
