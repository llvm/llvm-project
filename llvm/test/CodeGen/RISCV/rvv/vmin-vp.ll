...
; CHECK-NEXT:    vadd.vv v1, v8, v8
; CHECK-NEXT:    vsra.vi v1, v1, 1
; CHECK-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; CHECK-NEXT:    vmin.vx v8, v1, a0, v0.t
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vmin.vv v8, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vmin.vv v8, v8, v2, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vmin.vv v8, v8, v4, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
