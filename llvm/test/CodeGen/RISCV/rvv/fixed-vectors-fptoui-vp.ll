...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e8, mf4, ta, ma
; ZVFH-NEXT:    vfncvt.rtz.xu.f.w v1, v8, v0.t
; ZVFH-NEXT:    vmv1r.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rtz.xu.f.w v2, v1, v0.t
; ZVFHMIN-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; ZVFHMIN-NEXT:    vnsrl.wi v8, v2, 0, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rtz.xu.f.w v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.xu.f.v v1, v8, v0.t
; ZVFH-NEXT:    vmv1r.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfcvt.rtz.xu.f.v v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vfwcvt.rtz.xu.f.v v8, v1, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.xu.f.v v8, v1, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; ZVFH-NEXT:    vfwcvt.rtz.xu.f.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.rtz.xu.f.v v8, v1
; ZVFHMIN-NEXT:    ret
...
; CHECK-NEXT:    vfncvt.rtz.xu.f.w v1, v8, v0.t
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-NEXT:    vfwcvt.rtz.xu.f.v v2, v8, v0.t
