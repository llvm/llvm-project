...
; CHECK-NEXT:    li a2, 64
; CHECK-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; CHECK-NEXT:    vse32.v v14, (a2)
; CHECK-NEXT:    vmv.s.x v8, a4
; CHECK-NEXT:    lui a2, 1
; CHECK-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; CHECK-NEXT:    vmin.vx v8, v8, a3
; CHECK-NEXT:    sw zero, 80(zero)
; CHECK-NEXT:    sh zero, -392(a2)
; CHECK-NEXT:    sh zero, 534(a2)
; CHECK-NEXT:    li a3, 16
; CHECK-NEXT:    vse32.v v15, (a3)
; CHECK-NEXT:    sh zero, 1460(a2)
; CHECK-NEXT:    lui a2, 2
; CHECK-NEXT:    vmin.vx v9, v8, a1
; CHECK-NEXT:    sh zero, -1710(a2)
; CHECK-NEXT:    li a1, 24
; CHECK-NEXT:    vse32.v v16, (a1)
; CHECK-NEXT:    sh zero, -784(a2)
; CHECK-NEXT:    sh zero, 142(a2)
; CHECK-NEXT:    li a1, 32
; CHECK-NEXT:    vse32.v v16, (a1)
