...
; RV32-NEXT:    vwaddu.vv v10, v10, v10
; RV32-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; RV64-NEXT:    vwaddu.vv v10, v10, v10
; RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; RV32-NEXT:    li a2, 4
; RV32-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; RV32-NEXT:    vwmulu.vx v12, v12, a2
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
...
; RV64-NEXT:    li a2, 4
; RV64-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; RV64-NEXT:    vwmulu.vx v12, v12, a2
; RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
...
; RV32-NEXT:    li a2, 4
; RV32-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
; RV32-NEXT:    vwmulsu.vx v12, v12, a2
; RV32-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; RV32-NEXT:    vsoxei32.v v8, (a0), v12, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    li a2, 8
; RV32-NEXT:    vsetvli zero, a1, e8, m1, ta, ma
; RV32-NEXT:    vwmulu.vx v16, v16, a2
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
...
; RV32-NEXT:    li a2, 8
; RV32-NEXT:    vsetvli zero, a1, e16, m2, ta, ma
; RV32-NEXT:    vwmulsu.vx v16, v16, a2
; RV32-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV32-NEXT:    vsoxei32.v v8, (a0), v16, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vwmulsu.vx v24, v24, a3
; RV32-NEXT:    mv a3, a2
...
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    vsetvli a4, zero, e16, m4, ta, ma
; RV32-NEXT:    vwmulu.vx v24, v24, a3
; RV32-NEXT:    mv a3, a2
...
; RV64-NEXT:    vwmulu.vx v24, v24, a3
; RV64-NEXT:    mv a3, a2
