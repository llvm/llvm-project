...
; CHECK-128-65536-NEXT:    vslide1up.vx v1, v8, a1
; CHECK-128-65536-NEXT:    vslide1up.vx v8, v1, a0
...
; CHECK-512-NEXT:    vslide1up.vx v1, v8, a1
; CHECK-512-NEXT:    vslide1up.vx v8, v1, a0
; CHECK-512-NEXT:    ret
;
; CHECK-64-LABEL: intrinsic_vslide1up_vx_nxv1i64_nxv1i64_i64_vl2:
; CHECK-64:       # %bb.0: # %entry
; CHECK-64-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; CHECK-64-NEXT:    vslide1up.vx v1, v8, a1
; CHECK-64-NEXT:    vslide1up.vx v8, v1, a0
; CHECK-64-NEXT:    ret
entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.vslide1up.nxv1i64.i64(
    <vscale x 1 x i64> undef,
