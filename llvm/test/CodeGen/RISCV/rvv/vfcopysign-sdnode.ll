...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v1, v9
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v1
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfcopysign_exttrunc_vv_nxv1f16_nxv1f32:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v1, v9
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v2, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v3, v1
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfsgnj.vv v1, v2, v3
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vfncvt.f.f.w v2, v1
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v2
; ZVFH-NEXT:    ret
;
; ZVFHMIN-LABEL: vfcopysign_exttrunc_vf_nxv1f16_nxv1f32:
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfmv.v.f v1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v1
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v3, v2
...
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v9
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v3, v2
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; ZVFH-NEXT:    vfncvt.rod.f.f.w v1, v9
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v2, v1
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v2
; ZVFH-NEXT:    ret
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rod.f.f.w v1, v9
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v1
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v3, v2
...
; ZVFH-NEXT:    vfncvt.rod.f.f.w v2, v1
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v1, v2
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfmv.v.f v1, fa0
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rod.f.f.w v2, v1
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v1, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rod.f.f.w v2, v9
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v3, v2
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v2, v3
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v2, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rod.f.f.w v3, v1
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
...
; ZVFHMIN-NEXT:    vfsgnj.vv v2, v4, v2
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFHMIN-NEXT:    vfsgnj.vv v2, v2, v4
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v2
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfsgnj.vv v4, v12, v4
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vfsgnj.vv v4, v4, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v4
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v12
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v4, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v2
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vfsgnj.vv v4, v4, v8
...
; ZVFH-NEXT:    vfmv.v.f v4, fa0
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v2, v4
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v2
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v2
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vfsgnj.vv v4, v4, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfncvt.rod.f.f.w v4, v16
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvt.f.f.w v2, v4
; ZVFH-NEXT:    vfsgnj.vv v8, v8, v2
; ZVFH-NEXT:    ret
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.rod.f.f.w v4, v16
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v2, v4
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v4, v8
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v2
...
; ZVFHMIN-NEXT:    vs4r.v v4, (a0) # Unknown-size Folded Spill
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v24, v16
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
...
; CHECK-NEXT:    vfwcvt.f.f.v v1, v9
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vfsgnjn.vv v8, v8, v1
; CHECK-NEXT:    ret
  %n = fneg <vscale x 1 x half> %vs
...
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vfncvt.f.f.w v2, v1
; CHECK-NEXT:    vfsgnjn.vv v8, v8, v2
; CHECK-NEXT:    ret
  %head = insertelement <vscale x 1 x double> poison, double %s, i32 0
  %splat = shufflevector <vscale x 1 x double> %head, <vscale x 1 x double> poison, <vscale x 1 x i32> zeroinitializer
  %n = fneg <vscale x 1 x double> %splat
...
; CHECK-NEXT:    vfwcvt.f.f.v v4, v12
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfsgnj.vv v8, v8, v4
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfwcvt.f.f.v v4, v12
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfsgnjn.vv v8, v8, v4
; CHECK-NEXT:    ret
  %n = fneg <vscale x 8 x half> %vs
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfncvt.f.f.w v4, v16
; CHECK-NEXT:    vfsgnj.vv v8, v8, v4
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; CHECK-NEXT:    vfwcvt.f.f.v v4, v16
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-NEXT:    vfwcvt.f.f.v v16, v4
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; CHECK-NEXT:    vfsgnj.vv v2, v8, v10
