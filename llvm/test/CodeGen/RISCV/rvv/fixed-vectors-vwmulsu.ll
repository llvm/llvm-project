...
; RV32-LABEL: vwmulsu_vx_v4i32_i16_and:
; RV32:       # %bb.0:
...
; RV32-NEXT:    vmul.vx v8, v9, a1
; RV32-NEXT:    ret
;
; RV64-LABEL: vwmulsu_vx_v4i32_i16_and:
; RV64:       # %bb.0:
...
; RV32-LABEL: vwmulsu_vx_v4i32_i16_zext:
; RV32:       # %bb.0:
; RV32-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32-NEXT:    vle16.v v8, (a0)
; RV32-NEXT:    slli a1, a1, 16
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vwmulsu_vx_v4i32_i16_zext:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV64-NEXT:    vle16.v v8, (a0)
; RV64-NEXT:    slli a1, a1, 48
