...
; RV32-NEXT:    vor.vv v2, v3, v2, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    vsrl.vi v8, v1, 16, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vor.vv v2, v3, v2, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    vsrl.vi v8, v1, 16, v0.t
; RV64-NEXT:    ret
;
; CHECK-ZVKB-LABEL: vp_bswap_nxv1i48:
; CHECK-ZVKB:       # %bb.0:
; CHECK-ZVKB-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; CHECK-ZVKB-NEXT:    vrev8.v v1, v8, v0.t
; CHECK-ZVKB-NEXT:    vsrl.vi v8, v1, 16, v0.t
; CHECK-ZVKB-NEXT:    ret
