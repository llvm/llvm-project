...
; ZVE32F-NEXT:    vmv.v.i v8, 3
; ZVE32F-NEXT:    vmv.v.x v9, a1
; ZVE32F-NEXT:    vmv1r.v v0, v8
; ZVE32F-NEXT:    vmerge.vxm v8, v9, a0, v0
; ZVE32F-NEXT:    vand.vi v8, v8, 1
; ZVE32F-NEXT:    vmsne.vi v0, v8, 0
; ZVE32F-NEXT:    ret
...
; RV64-NEXT:    ld a0, %lo(.LCPI20_1)(a1)
