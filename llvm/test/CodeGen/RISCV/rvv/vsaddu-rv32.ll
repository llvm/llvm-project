...
; CHECK-NEXT:    vlse64.v v1, (a0), zero
; CHECK-NEXT:    vsaddu.vv v8, v9, v1, v0.t
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vlse64.v v2, (a0), zero
; CHECK-NEXT:    vsaddu.vv v8, v10, v2, v0.t
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vlse64.v v4, (a0), zero
; CHECK-NEXT:    vsaddu.vv v8, v12, v4, v0.t
; CHECK-NEXT:    addi sp, sp, 16
; CHECK-NEXT:    ret
entry:
