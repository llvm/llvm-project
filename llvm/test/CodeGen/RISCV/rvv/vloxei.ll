...
; CHECK-NEXT:    vloxei32.v v1, (a0), v8
...
; CHECK-NEXT:    vloxei32.v v2, (a0), v8
...
; CHECK-NEXT:    vloxei32.v v4, (a0), v8
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vloxei16.v v1, (a0), v8
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, ma
; CHECK-NEXT:    vloxei16.v v2, (a0), v8
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vloxei16.v v4, (a0), v8
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
entry:
