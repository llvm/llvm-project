...
; CHECK-NEXT:    vmfeq.vv v14, v10, v10, v0.t
...
; CHECK-NEXT:    vfmax.vv v10, v10, v8, v0.t
...
; CHECK-NEXT:    vmfeq.vv v20, v12, v12, v0.t
; CHECK-NEXT:    vmv1r.v v21, v0
; CHECK-NEXT:    vmv1r.v v0, v8
...
; CHECK-NEXT:    vmfeq.vv v7, v16, v16, v0.t
...
; CHECK-NEXT:    vs1r.v v24, (a2) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; CHECK-NEXT:    vmfeq.vv v7, v24, v24, v0.t
; CHECK-NEXT:    csrr a2, vlenb
; CHECK-NEXT:    li a3, 24
; CHECK-NEXT:    mul a2, a2, a3
; CHECK-NEXT:    add a2, sp, a2
...
; ZVFHMIN-NEXT:    vmfeq.vv v14, v10, v10, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v15, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    vmerge.vvm v8, v12, v10, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v14
; ZVFHMIN-NEXT:    vmerge.vvm v10, v10, v12, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v15
; ZVFHMIN-NEXT:    vfmax.vv v10, v10, v8, v0.t
...
; ZVFH-NEXT:    vmfeq.vv v12, v8, v8, v0.t
; ZVFH-NEXT:    vmfeq.vv v14, v10, v10, v0.t
; ZVFH-NEXT:    vmv1r.v v15, v0
; ZVFH-NEXT:    vmv1r.v v0, v12
; ZVFH-NEXT:    vmerge.vvm v12, v8, v10, v0
; ZVFH-NEXT:    vmv1r.v v0, v14
; ZVFH-NEXT:    vmerge.vvm v8, v10, v8, v0
; ZVFH-NEXT:    vmv1r.v v0, v15
...
; ZVFHMIN-NEXT:    vmfeq.vv v20, v12, v12, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v21, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
...
; ZVFH-NEXT:    vmfeq.vv v16, v8, v8, v0.t
; ZVFH-NEXT:    vmfeq.vv v20, v12, v12, v0.t
; ZVFH-NEXT:    vmv1r.v v21, v0
; ZVFH-NEXT:    vmv1r.v v0, v16
; ZVFH-NEXT:    vmerge.vvm v16, v8, v12, v0
; ZVFH-NEXT:    vmv1r.v v0, v20
; ZVFH-NEXT:    vmerge.vvm v8, v12, v8, v0
; ZVFH-NEXT:    vmv1r.v v0, v21
...
; ZVFHMIN-NEXT:    vmfeq.vv v7, v16, v16, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v6, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
...
; ZVFH-NEXT:    vmfeq.vv v7, v16, v16, v0.t
...
; ZVFHMIN-NEXT:    vs1r.v v24, (a2) # vscale x 8-byte Folded Spill
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v9, v16, v16, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v7, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v8
; ZVFHMIN-NEXT:    vmv1r.v v6, v9
; ZVFHMIN-NEXT:    vmerge.vvm v8, v24, v16, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v6
; ZVFHMIN-NEXT:    vmerge.vvm v16, v16, v24, v0
; ZVFHMIN-NEXT:    vmv1r.v v0, v7
...
; ZVFHMIN-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v7, v24, v24, v0.t
; ZVFHMIN-NEXT:    csrr a2, vlenb
; ZVFHMIN-NEXT:    li a3, 24
; ZVFHMIN-NEXT:    mul a2, a2, a3
; ZVFHMIN-NEXT:    add a2, sp, a2
...
; ZVFHMIN-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v17, v8, v8, v0.t
; ZVFHMIN-NEXT:    vmv1r.v v0, v7
...
; CHECK-NEXT:    vs1r.v v0, (a5) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    add a4, sp, a4
; CHECK-NEXT:    addi a4, a4, 16
; CHECK-NEXT:    vl1r.v v0, (a4) # vscale x 8-byte Folded Reload
...
; CHECK-NEXT:    addi a3, a3, 16
; CHECK-NEXT:    vl1r.v v0, (a3) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vmfeq.vv v4, v24, v24, v0.t
; CHECK-NEXT:    csrr a3, vlenb
; CHECK-NEXT:    slli a4, a3, 3
; CHECK-NEXT:    add a3, a4, a3
; CHECK-NEXT:    add a3, sp, a3
; CHECK-NEXT:    addi a3, a3, 16
; CHECK-NEXT:    vs1r.v v5, (a3) # vscale x 8-byte Folded Spill
; CHECK-NEXT:    csrr a3, vlenb
; CHECK-NEXT:    slli a3, a3, 3
; CHECK-NEXT:    add a3, sp, a3
; CHECK-NEXT:    addi a3, a3, 16
; CHECK-NEXT:    vs1r.v v4, (a3) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    add a3, sp, a3
; CHECK-NEXT:    addi a3, a3, 16
; CHECK-NEXT:    vs1r.v v8, (a3) # vscale x 8-byte Folded Spill
