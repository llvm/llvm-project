...
; RV32-NEXT:    vasubu.vv v8, v9, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v2, (a0), zero
; RV32-NEXT:    csrwi vxrm, 1
; RV32-NEXT:    vasubu.vv v8, v10, v2, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v4, (a0), zero
; RV32-NEXT:    csrwi vxrm, 1
; RV32-NEXT:    vasubu.vv v8, v12, v4, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
