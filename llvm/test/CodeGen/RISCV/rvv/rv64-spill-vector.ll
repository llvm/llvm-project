...
; SPILL-O0-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O0-NEXT:    csrr a0, vlenb
...
; SPILL-O2-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O2-NEXT:    csrr a0, vlenb
...
; SPILL-O2-VLEN128-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 16
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 16
...
; SPILL-O0-VSETVLI-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; SPILL-O0-VSETVLI-NEXT:    #APP
; SPILL-O0-VSETVLI-NEXT:    #NO_APP
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O0-VSETVLI-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
...
; SPILL-O2-VSETVLI-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; SPILL-O2-VSETVLI-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
...
; SPILL-O0-NEXT:    sub sp, sp, a0
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
; SPILL-O0-NEXT:    csrr a0, vlenb
; SPILL-O0-NEXT:    slli a0, a0, 1
; SPILL-O0-NEXT:    add sp, sp, a0
; SPILL-O0-NEXT:    addi sp, sp, 16
...
; SPILL-O2-NEXT:    sub sp, sp, a0
; SPILL-O2-NEXT:    addi a0, sp, 16
; SPILL-O2-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
; SPILL-O2-NEXT:    csrr a0, vlenb
; SPILL-O2-NEXT:    slli a0, a0, 1
; SPILL-O2-NEXT:    add sp, sp, a0
; SPILL-O2-NEXT:    addi sp, sp, 16
...
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 16
; SPILL-O2-VLEN128-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 32
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 16
; SPILL-O2-VLEN128-NEXT:    ret
;
...
; SPILL-O0-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
; SPILL-O0-VSETVLI-NEXT:    #APP
; SPILL-O0-VSETVLI-NEXT:    #NO_APP
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
; SPILL-O0-VSETVLI-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; SPILL-O0-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O0-VSETVLI-NEXT:    ret
...
; SPILL-O2-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O2-VSETVLI-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
; SPILL-O2-VSETVLI-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; SPILL-O2-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O2-VSETVLI-NEXT:    ret
...
; SPILL-O0-NEXT:    sub sp, sp, a0
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vs4r.v v8, (a0) # vscale x 32-byte Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vl4r.v v8, (a0) # vscale x 32-byte Reload
; SPILL-O0-NEXT:    csrr a0, vlenb
; SPILL-O0-NEXT:    slli a0, a0, 2
; SPILL-O0-NEXT:    add sp, sp, a0
; SPILL-O0-NEXT:    addi sp, sp, 16
...
; SPILL-O2-NEXT:    sub sp, sp, a0
; SPILL-O2-NEXT:    addi a0, sp, 16
; SPILL-O2-NEXT:    vs4r.v v8, (a0) # vscale x 32-byte Spill
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    vl4r.v v8, (a0) # vscale x 32-byte Reload
; SPILL-O2-NEXT:    csrr a0, vlenb
; SPILL-O2-NEXT:    slli a0, a0, 2
; SPILL-O2-NEXT:    add sp, sp, a0
; SPILL-O2-NEXT:    addi sp, sp, 16
...
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 16
; SPILL-O2-VLEN128-NEXT:    vs4r.v v8, (a0) # vscale x 32-byte Spill
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl4r.v v8, (a0) # vscale x 32-byte Reload
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 64
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 16
; SPILL-O2-VLEN128-NEXT:    ret
;
...
; SPILL-O0-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vs4r.v v8, (a0) # vscale x 32-byte Spill
; SPILL-O0-VSETVLI-NEXT:    #APP
; SPILL-O0-VSETVLI-NEXT:    #NO_APP
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vl4r.v v8, (a0) # vscale x 32-byte Reload
; SPILL-O0-VSETVLI-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; SPILL-O0-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O0-VSETVLI-NEXT:    ret
...
; SPILL-O2-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O2-VSETVLI-NEXT:    vs4r.v v8, (a0) # vscale x 32-byte Spill
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl4r.v v8, (a0) # vscale x 32-byte Reload
; SPILL-O2-VSETVLI-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; SPILL-O2-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O2-VSETVLI-NEXT:    ret
...
; SPILL-O0-NEXT:    sub sp, sp, a0
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; SPILL-O0-NEXT:    csrr a0, vlenb
; SPILL-O0-NEXT:    slli a0, a0, 3
; SPILL-O0-NEXT:    add sp, sp, a0
; SPILL-O0-NEXT:    addi sp, sp, 16
...
; SPILL-O2-NEXT:    sub sp, sp, a0
; SPILL-O2-NEXT:    addi a0, sp, 16
; SPILL-O2-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; SPILL-O2-NEXT:    csrr a0, vlenb
; SPILL-O2-NEXT:    slli a0, a0, 3
; SPILL-O2-NEXT:    add sp, sp, a0
; SPILL-O2-NEXT:    addi sp, sp, 16
...
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 16
; SPILL-O2-VLEN128-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 128
; SPILL-O2-VLEN128-NEXT:    addi sp, sp, 16
; SPILL-O2-VLEN128-NEXT:    ret
;
...
; SPILL-O0-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
; SPILL-O0-VSETVLI-NEXT:    #APP
; SPILL-O0-VSETVLI-NEXT:    #NO_APP
; SPILL-O0-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O0-VSETVLI-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; SPILL-O0-VSETVLI-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; SPILL-O0-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O0-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O0-VSETVLI-NEXT:    ret
...
; SPILL-O2-VSETVLI-NEXT:    sub sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O2-VSETVLI-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Reload
; SPILL-O2-VSETVLI-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; SPILL-O2-VSETVLI-NEXT:    add sp, sp, a0
; SPILL-O2-VSETVLI-NEXT:    addi sp, sp, 16
; SPILL-O2-VSETVLI-NEXT:    ret
