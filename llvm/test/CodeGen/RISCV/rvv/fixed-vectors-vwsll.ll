...
; CHECK-ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; CHECK-ZVBB-NEXT:    vzext.vf2 v10, v8
; CHECK-ZVBB-NEXT:    vzext.vf2 v8, v12
; CHECK-ZVBB-NEXT:    vsll.vv v8, v10, v8
; CHECK-ZVBB-NEXT:    ret
  %head = insertelement <4 x i32> poison, i32 %b, i32 0
  %splat = shufflevector <4 x i32> %head, <4 x i32> poison, <4 x i32> zeroinitializer
...
; CHECK-ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; CHECK-ZVBB-NEXT:    vzext.vf2 v10, v8
; CHECK-ZVBB-NEXT:    vzext.vf4 v8, v12
; CHECK-ZVBB-NEXT:    vsll.vv v8, v10, v8
; CHECK-ZVBB-NEXT:    ret
  %head = insertelement <4 x i16> poison, i16 %b, i32 0
  %splat = shufflevector <4 x i16> %head, <4 x i16> poison, <4 x i32> zeroinitializer
...
; CHECK-ZVBB-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; CHECK-ZVBB-NEXT:    vzext.vf2 v10, v8
; CHECK-ZVBB-NEXT:    vzext.vf8 v8, v12
; CHECK-ZVBB-NEXT:    vsll.vv v8, v10, v8
; CHECK-ZVBB-NEXT:    ret
  %head = insertelement <4 x i8> poison, i8 %b, i32 0
  %splat = shufflevector <4 x i8> %head, <4 x i8> poison, <4 x i32> zeroinitializer
...
; CHECK-ZVBB-RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; CHECK-ZVBB-RV64-NEXT:    vmv.v.x v16, a0
; CHECK-ZVBB-RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-ZVBB-RV64-NEXT:    vzext.vf2 v12, v8
; CHECK-ZVBB-RV64-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-ZVBB-RV64-NEXT:    vnsrl.wi v8, v16, 0
; CHECK-ZVBB-RV64-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-ZVBB-RV64-NEXT:    vnsrl.wi v14, v8, 0
; CHECK-ZVBB-RV64-NEXT:    vsll.vv v8, v12, v14
