...
; CHECK-NEXT:    vid.v v1
; CHECK-NEXT:    vsaddu.vx v1, v1, a1
; CHECK-NEXT:    vmsltu.vx v0, v1, a2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vid.v v4
; CHECK-NEXT:    vsaddu.vx v4, v4, a1
; CHECK-NEXT:    vmsltu.vx v0, v4, a2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslideup.vi v0, v1, 4
...
; CHECK-NEXT:    vslideup.vi v0, v1, 8
...
; CHECK-NEXT:    vslideup.vi v0, v1, 10
...
; CHECK-NEXT:    vslideup.vi v0, v1, 12
...
; CHECK-NEXT:    vslideup.vi v0, v1, 14
; CHECK-NEXT:    ret
