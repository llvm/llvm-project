...
; RV32-NEXT:    add a2, s1, s9
; RV32-NEXT:    add a3, s3, s7
; RV32-NEXT:    add a4, s1, a0
...
; RV64-NEXT:    add a2, s1, s9
; RV64-NEXT:    add a3, s3, s7
; RV64-NEXT:    add a4, s1, a0
