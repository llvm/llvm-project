...
; RV32-NEXT:    sw s2, 64(sp) # 4-byte Spill
; RV32-NEXT:    sw s3, 60(sp) # 4-byte Spill
; RV32-NEXT:    sw s4, 56(sp) # 4-byte Spill
; RV32-NEXT:    sw s5, 52(sp) # 4-byte Spill
; RV32-NEXT:    sw s6, 48(sp) # 4-byte Spill
; RV32-NEXT:    sw s7, 44(sp) # 4-byte Spill
; RV32-NEXT:    sw s8, 40(sp) # 4-byte Spill
; RV32-NEXT:    sw s9, 36(sp) # 4-byte Spill
...
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 32
; RV32-NEXT:    vl8r.v v24, (a1) # vscale x 64-byte Reload
...
; RV32-NEXT:    lw s2, 64(sp) # 4-byte Reload
; RV32-NEXT:    lw s3, 60(sp) # 4-byte Reload
; RV32-NEXT:    lw s4, 56(sp) # 4-byte Reload
; RV32-NEXT:    lw s5, 52(sp) # 4-byte Reload
; RV32-NEXT:    lw s6, 48(sp) # 4-byte Reload
; RV32-NEXT:    lw s7, 44(sp) # 4-byte Reload
; RV32-NEXT:    lw s8, 40(sp) # 4-byte Reload
; RV32-NEXT:    lw s9, 36(sp) # 4-byte Reload
...
; RV64-NEXT:    sd s1, 104(sp) # 8-byte Spill
; RV64-NEXT:    sd s2, 96(sp) # 8-byte Spill
; RV64-NEXT:    sd s3, 88(sp) # 8-byte Spill
; RV64-NEXT:    sd s4, 80(sp) # 8-byte Spill
; RV64-NEXT:    sd s5, 72(sp) # 8-byte Spill
; RV64-NEXT:    sd s6, 64(sp) # 8-byte Spill
; RV64-NEXT:    sd s7, 56(sp) # 8-byte Spill
; RV64-NEXT:    sd s8, 48(sp) # 8-byte Spill
; RV64-NEXT:    sd s9, 40(sp) # 8-byte Spill
...
; RV64-NEXT:    ld s1, 104(sp) # 8-byte Reload
; RV64-NEXT:    ld s2, 96(sp) # 8-byte Reload
; RV64-NEXT:    ld s3, 88(sp) # 8-byte Reload
; RV64-NEXT:    ld s4, 80(sp) # 8-byte Reload
; RV64-NEXT:    ld s5, 72(sp) # 8-byte Reload
; RV64-NEXT:    ld s6, 64(sp) # 8-byte Reload
; RV64-NEXT:    ld s7, 56(sp) # 8-byte Reload
; RV64-NEXT:    ld s8, 48(sp) # 8-byte Reload
; RV64-NEXT:    ld s9, 40(sp) # 8-byte Reload
