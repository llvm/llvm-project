...
; RV32-NEXT:    vmul.vx v1, v8, a0
; RV32-NEXT:    vsll.vi v2, v1, 15
; RV32-NEXT:    vsrl.vi v1, v1, 1
; RV32-NEXT:    vor.vv v1, v1, v2
; RV32-NEXT:    lui a0, 3
; RV32-NEXT:    addi a0, a0, -1366
; RV32-NEXT:    vmsgtu.vx v0, v1, a0
; RV32-NEXT:    vmv.v.i v1, 0
; RV32-NEXT:    vmerge.vim v8, v1, -1, v0
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmul.vx v1, v8, a0
; RV64-NEXT:    vsll.vi v2, v1, 15
; RV64-NEXT:    vsrl.vi v1, v1, 1
; RV64-NEXT:    vor.vv v1, v1, v2
; RV64-NEXT:    lui a0, 3
; RV64-NEXT:    addi a0, a0, -1366
; RV64-NEXT:    vmsgtu.vx v0, v1, a0
; RV64-NEXT:    vmv.v.i v1, 0
; RV64-NEXT:    vmerge.vim v8, v1, -1, v0
; RV64-NEXT:    ret
