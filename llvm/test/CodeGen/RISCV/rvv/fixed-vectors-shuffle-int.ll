; NOTE: Assertions have been autogenerated by utils/update_llc_test_checks.py UTC_ARGS: --include-constant-pool
...
; RV32-LABEL: LCPI11_0
; RV32-NEXT: 	.half	1                               # 0x1
; RV32-NEXT: 	.half	2                               # 0x2
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.half	5                               # 0x5
; RV32-NEXT: 	.half	1                               # 0x1
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.half	3                               # 0x3
; RV32-NEXT: 	.zero	2
...
; RV64-NEXT:    ld a0, %lo(.LCPI11_0)(a0)
...
; RV32-LABEL: LCPI12_0
; RV32-NEXT: 	.half	0                               # 0x0
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.half	0                               # 0x0
; RV32-NEXT: 	.half	4                               # 0x4
; RV32-NEXT: 	.half	6                               # 0x6
; RV32-NEXT: 	.zero	2
; RV32-LABEL: LCPI12_1
; RV32-NEXT: 	.zero	2
; RV32-NEXT: 	.half	3                               # 0x3
...
;
; RV64-LABEL: LCPI13_0
; RV64-NEXT: 	.half	0                               # 0x0
; RV64-NEXT: 	.half	3                               # 0x3
; RV64-NEXT: 	.zero	2
; RV64-NEXT: 	.zero	2
; RV64-NEXT: 	.half	4                               # 0x4
; RV64-NEXT: 	.half	1                               # 0x1
; RV64-NEXT: 	.half	7                               # 0x7
; RV64-NEXT: 	.zero	2
...
; RV32-NEXT:    sw a3, 56(sp)
; RV32-NEXT:    lw a3, 52(a1)
; RV32-NEXT:    sw a3, 52(sp)
; RV32-NEXT:    lw a3, 48(a1)
; RV32-NEXT:    sw a3, 48(sp)
; RV32-NEXT:    lw a3, 44(a1)
; RV32-NEXT:    sw a3, 44(sp)
; RV32-NEXT:    lw a3, 40(a1)
; RV32-NEXT:    sw a3, 40(sp)
; RV32-NEXT:    lw a3, 36(a1)
; RV32-NEXT:    sw a3, 36(sp)
; RV32-NEXT:    lw a3, 32(a1)
...
; RV64-NEXT: 	.half	0                               # 0x0
; RV64-NEXT: 	.half	1                               # 0x1
; RV64-NEXT: 	.half	6                               # 0x6
; RV64-NEXT: 	.half	7                               # 0x7
; RV64-NEXT: 	.half	4                               # 0x4
; RV64-NEXT: 	.half	5                               # 0x5
...
; RV64-NEXT:    sd a3, 48(sp)
; RV64-NEXT:    ld a3, 40(a1)
; RV64-NEXT:    sd a3, 40(sp)
; RV64-NEXT:    ld a3, 32(a1)
...
; CHECK-NEXT:    vsetvli a1, zero, e64, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v14, v8, v9
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
