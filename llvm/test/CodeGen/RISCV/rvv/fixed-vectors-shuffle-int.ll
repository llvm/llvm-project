...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, mu
; CHECK-NEXT:    vmv.v.i v0, 8
; CHECK-NEXT:    vslideup.vi v8, v8, 2, v0.t
...
; RV32-NEXT:    vmv.v.i v17, 2
; RV32-NEXT:    li a0, 164
; RV32-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; RV32-NEXT:    vrgatherei16.vv v8, v8, v16
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    li a0, 5
; RV32-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; RV32-NEXT:    vslide1down.vx v16, v17, a0
; RV32-NEXT:    vsetvli zero, zero, e64, m4, ta, mu
; RV32-NEXT:    vrgatherei16.vv v8, v12, v16, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vrgatherei16.vv v8, v8, v16
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vmv.v.x v16, a0
...
; RV32-NEXT:    li a0, 113
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    vrgatherei16.vv v12, v12, v16
...
; RV32-NEXT:    li a0, 140
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    vrgatherei16.vv v8, v8, v12
; RV32-NEXT:    vmv.v.i v12, 5
; RV32-NEXT:    vrgatherei16.vv v8, v12, v16, v0.t
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vrgather.vi v8, v8, 4
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vi v8, v8, 2
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    vrgather.vi v8, v8, 2
; CHECK-NEXT:    vrgather.vv v8, v9, v11, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; CHECK-NEXT:    vslideup.vi v8, v8, 3
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vmv.s.x v9, a0
; CHECK-NEXT:    vcompress.vm v8, v8, v9
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vcompress.vm v8, v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    li a0, 1
; CHECK-NEXT:    vslide1down.vx v10, v9, a0
; CHECK-NEXT:    csrr a0, vlenb
...
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vi v8, v8, 7
; CHECK-NEXT:    vrgatherei16.vv v8, v12, v16, v0.t
; CHECK-NEXT:    ret
...
; RV64-NEXT:    vrgatherei16.vv v8, v8, v12
...
; CHECK-NEXT:    vrgatherei16.vv v8, v8, v9
; CHECK-NEXT:    vmv.v.v v9, v8
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vi v8, v8, 0, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vi v8, v8, 2, v0.t
; CHECK-NEXT:    ret
