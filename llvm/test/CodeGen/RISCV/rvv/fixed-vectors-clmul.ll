...
; ZVBC-NEXT:    vnsrl.wi v8, v8, 0
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v1i32:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v8, v8, v9
; ZVBC32E-NEXT:    ret
...
; CHECK-NEXT:    ret
;
; ZVBC-LABEL: clmul_v8i32:
; ZVBC:       # %bb.0:
; ZVBC-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; ZVBC-NEXT:    vzext.vf2 v12, v8
; ZVBC-NEXT:    vclmul.vv v12, v12, v12
; ZVBC-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVBC-NEXT:    vnsrl.wi v8, v12, 0
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v8i32:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v8, v8, v8
; ZVBC32E-NEXT:    ret
...
; ZVBC-NEXT:    vnsrl.wi v8, v16, 0
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v16i32:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v8, v8, v12
; ZVBC32E-NEXT:    ret
...
; RV64-NEXT:    ret
;
; ZVBC-LABEL: clmul_v1i64:
; ZVBC:       # %bb.0:
; ZVBC-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; ZVBC-NEXT:    vclmul.vv v8, v8, v9
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v1i64:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    li a0, 32
; ZVBC32E-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; ZVBC32E-NEXT:    vnsrl.wx v10, v8, a0
; ZVBC32E-NEXT:    vnsrl.wi v11, v9, 0
; ZVBC32E-NEXT:    vnsrl.wx v9, v9, a0
; ZVBC32E-NEXT:    vnsrl.wi v8, v8, 0
; ZVBC32E-NEXT:    vclmul.vv v10, v10, v11
; ZVBC32E-NEXT:    vclmul.vv v9, v8, v9
; ZVBC32E-NEXT:    vxor.vv v9, v9, v10
; ZVBC32E-NEXT:    vclmulh.vv v10, v8, v11
; ZVBC32E-NEXT:    vxor.vv v9, v10, v9
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v10, v9
; ZVBC32E-NEXT:    vsll.vx v9, v10, a0
; ZVBC32E-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v8, v8, v11
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v10, v8
; ZVBC32E-NEXT:    vor.vv v8, v10, v9
; ZVBC32E-NEXT:    ret
...
; RV64-NEXT:    ret
;
; ZVBC-LABEL: clmul_v2i64:
; ZVBC:       # %bb.0:
; ZVBC-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; ZVBC-NEXT:    vclmul.vv v8, v8, v9
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v2i64:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    li a0, 32
; ZVBC32E-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; ZVBC32E-NEXT:    vnsrl.wx v10, v8, a0
...
; RV64-NEXT:    ret
;
; ZVBC-LABEL: clmul_v4i64:
; ZVBC:       # %bb.0:
; ZVBC-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; ZVBC-NEXT:    vclmul.vv v8, v8, v10
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v4i64:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    li a0, 32
; ZVBC32E-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVBC32E-NEXT:    vnsrl.wx v12, v8, a0
; ZVBC32E-NEXT:    vnsrl.wi v13, v10, 0
; ZVBC32E-NEXT:    vnsrl.wx v14, v10, a0
; ZVBC32E-NEXT:    vnsrl.wi v10, v8, 0
; ZVBC32E-NEXT:    vclmul.vv v8, v12, v13
; ZVBC32E-NEXT:    vclmul.vv v9, v10, v14
; ZVBC32E-NEXT:    vxor.vv v8, v9, v8
; ZVBC32E-NEXT:    vclmulh.vv v9, v10, v13
; ZVBC32E-NEXT:    vxor.vv v11, v9, v8
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v8, v11
; ZVBC32E-NEXT:    vsll.vx v8, v8, a0
; ZVBC32E-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v12, v10, v13
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v10, v12
; ZVBC32E-NEXT:    vor.vv v8, v10, v8
; ZVBC32E-NEXT:    ret
...
; RV64-NEXT:    ret
;
; ZVBC-LABEL: clmul_v8i64:
; ZVBC:       # %bb.0:
; ZVBC-NEXT:    vsetivli zero, 8, e64, m4, ta, ma
; ZVBC-NEXT:    vclmul.vv v8, v8, v12
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmul_v8i64:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    li a0, 32
; ZVBC32E-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; ZVBC32E-NEXT:    vnsrl.wx v16, v8, a0
; ZVBC32E-NEXT:    vnsrl.wi v18, v12, 0
; ZVBC32E-NEXT:    vnsrl.wx v20, v12, a0
; ZVBC32E-NEXT:    vnsrl.wi v12, v8, 0
; ZVBC32E-NEXT:    vclmul.vv v8, v16, v18
; ZVBC32E-NEXT:    vclmul.vv v10, v12, v20
; ZVBC32E-NEXT:    vxor.vv v8, v10, v8
; ZVBC32E-NEXT:    vclmulh.vv v10, v12, v18
; ZVBC32E-NEXT:    vxor.vv v14, v10, v8
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v8, v14
; ZVBC32E-NEXT:    vsll.vx v8, v8, a0
; ZVBC32E-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVBC32E-NEXT:    vclmul.vv v16, v12, v18
; ZVBC32E-NEXT:    vsetvli zero, zero, e64, m4, ta, ma
; ZVBC32E-NEXT:    vzext.vf2 v12, v16
...
; ZVBC-NEXT:    vnsrl.wi v8, v10, 0
; ZVBC-NEXT:    vsetvli zero, zero, e8, mf4, ta, ma
; ZVBC-NEXT:    vnsrl.wi v8, v8, 7
; ZVBC-NEXT:    ret
;
; ZVBC32E-LABEL: clmulr_v4i8:
; ZVBC32E:       # %bb.0:
; ZVBC32E-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; ZVBC32E-NEXT:    vclmulh.vv v10, v8, v9
; ZVBC32E-NEXT:    vclmul.vv v8, v8, v9
; ZVBC32E-NEXT:    vadd.vv v9, v10, v10
; ZVBC32E-NEXT:    vsrl.vi v8, v8, 7
; ZVBC32E-NEXT:    vor.vv v8, v8, v9
; ZVBC32E-NEXT:    ret
