...
; CHECK-NEXT:    li a2, 432
; CHECK-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
; CHECK-NEXT:    vslide1down.vx v24, v24, a1
...
; CHECK-NEXT:    vsetvli zero, a1, e8, m8, tu, ma
; CHECK-NEXT:    vslideup.vx v24, v0, a2
; CHECK-NEXT:    vsetvli zero, a0, e8, m8, ta, ma
