...
; CHECK-NEXT:    vfwsub.vv v8, v4, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; CHECK-NEXT:    vle16.v v1, (a0)
; CHECK-NEXT:    vfwsub.vf v8, v1, fa0
; CHECK-NEXT:    ret
  %a = load <2 x half>, ptr %x
...
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vle16.v v2, (a0)
; CHECK-NEXT:    vfwsub.vf v8, v2, fa0
; CHECK-NEXT:    ret
  %a = load <16 x half>, ptr %x
...
; CHECK-NEXT:    vle16.v v4, (a0)
; CHECK-NEXT:    vfwsub.vf v8, v4, fa0
; CHECK-NEXT:    ret
  %a = load <32 x half>, ptr %x
...
; CHECK-NEXT:    vfsub.vv v16, v24, v8
; CHECK-NEXT:    vl8r.v v24, (a0) # Unknown-size Folded Reload
; CHECK-NEXT:    vfsub.vv v8, v24, v8
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    add sp, sp, a0
; CHECK-NEXT:    addi sp, sp, 16
...
; CHECK-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; CHECK-NEXT:    vle32.v v1, (a0)
; CHECK-NEXT:    vfwsub.wf v8, v1, fa0
; CHECK-NEXT:    ret
  %a = load <2 x float>, ptr %x
  %b = insertelement <2 x half> poison, half %y, i32 0
  %c = shufflevector <2 x half> %b, <2 x half> poison, <2 x i32> zeroinitializer
...
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vle32.v v2, (a0)
; CHECK-NEXT:    vfwsub.wf v8, v2, fa0
; CHECK-NEXT:    ret
  %a = load <8 x float>, ptr %x
  %b = insertelement <8 x half> poison, half %y, i32 0
  %c = shufflevector <8 x half> %b, <8 x half> poison, <8 x i32> zeroinitializer
...
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vle32.v v4, (a0)
; CHECK-NEXT:    vfwsub.wf v8, v4, fa0
; CHECK-NEXT:    ret
  %a = load <16 x float>, ptr %x
  %b = insertelement <16 x half> poison, half %y, i32 0
  %c = shufflevector <16 x half> %b, <16 x half> poison, <16 x i32> zeroinitializer
