...
; ZVFH-NEXT:    vfabs.v v1, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, mu
; ZVFH-NEXT:    vmflt.vf v0, v1, fa5, v0.t
...
; ZVFHMIN-NEXT:    vfabs.v v4, v2, v0.t
; ZVFHMIN-NEXT:    lui a0, 307200
; ZVFHMIN-NEXT:    fmv.w.x fa5, a0
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; ZVFHMIN-NEXT:    vmflt.vf v1, v4, fa5, v0.t
; ZVFHMIN-NEXT:    fsrmi a0, 4
...
; ZVFH-NEXT:    vfabs.v v2, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, mu
; ZVFH-NEXT:    vmflt.vf v1, v2, fa5, v0.t
; ZVFH-NEXT:    fsrmi a0, 4
...
; ZVFHMIN-NEXT:    vfabs.v v8, v4, v0.t
; ZVFHMIN-NEXT:    lui a0, 307200
; ZVFHMIN-NEXT:    fmv.w.x fa5, a0
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; ZVFHMIN-NEXT:    vmflt.vf v1, v8, fa5, v0.t
; ZVFHMIN-NEXT:    fsrmi a0, 4
...
; ZVFH-NEXT:    vfabs.v v4, v8, v0.t
; ZVFH-NEXT:    vsetvli zero, zero, e16, m4, ta, mu
; ZVFH-NEXT:    vmflt.vf v1, v4, fa5, v0.t
; ZVFH-NEXT:    fsrmi a0, 4
...
; ZVFH-NEXT:    vmflt.vf v1, v16, fa5, v0.t
; ZVFH-NEXT:    fsrmi a0, 4
...
; ZVFHMIN-NEXT:    vslidedown.vx v2, v0, a2
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, mu
; ZVFHMIN-NEXT:    vmflt.vf v2, v24, fa5, v0.t
...
; ZVFHMIN-NEXT:    srli a2, a2, 2
; ZVFHMIN-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v1, v1, a2
; ZVFHMIN-NEXT:    vsetvli a2, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v16, v12
; ZVFHMIN-NEXT:    vsetvli zero, a3, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmv1r.v v0, v1
