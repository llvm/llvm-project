...
; ZVFH-NEXT:    fsrm a0
; ZVFH-NEXT:    vfcvt.f.x.v v12, v16, v0.t
...
; ZVFHMIN-NEXT:    fsrm a0
; ZVFHMIN-NEXT:    vfcvt.f.x.v v8, v24, v0.t
...
; ZVFH-NEXT:    fsrm a0
; ZVFH-NEXT:    vfcvt.f.x.v v16, v24, v0.t
...
; ZVFHMIN-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; ZVFHMIN-NEXT:    vfsgnj.vv v24, v8, v24
; ZVFHMIN-NEXT:    vsetvli a2, zero, e16, m4, ta, ma
...
; ZVFHMIN-NEXT:    fsrm a0
; ZVFHMIN-NEXT:    vfcvt.f.x.v v16, v24, v0.t
; ZVFHMIN-NEXT:    vfsgnj.vv v16, v16, v8
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
...
; ZVFHMIN-NEXT:    fsrm a2
; ZVFHMIN-NEXT:    vfcvt.f.x.v v8, v8, v0.t
; ZVFHMIN-NEXT:    vfsgnj.vv v16, v8, v24
; ZVFHMIN-NEXT:    vsetvli a2, zero, e16, m4, ta, ma
