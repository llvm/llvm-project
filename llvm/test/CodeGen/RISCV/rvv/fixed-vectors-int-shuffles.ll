...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, mu
; CHECK-NEXT:    vid.v v1
; CHECK-NEXT:    vrsub.vi v2, v1, 4
; CHECK-NEXT:    vmv.v.i v0, 12
; CHECK-NEXT:    vmv.v.i v1, 5
; CHECK-NEXT:    vrgather.vv v1, v8, v2, v0.t
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; RV64-NEXT:    vrgatherei16.vv v8, v4, v1
; RV64-NEXT:    li a0, 164
...
; RV64-NEXT:    vrgatherei16.vv v8, v12, v1, v0.t
; RV64-NEXT:    ret
...
; RV32-NEXT:    li a0, 113
; RV32-NEXT:    vmv.s.x v0, a0
; RV32-NEXT:    vrgatherei16.vv v4, v12, v1
...
; RV64-NEXT:    vrgatherei16.vv v4, v8, v1, v0.t
...
; RV32-NEXT:    vsetivli zero, 8, e64, m4, ta, mu
; RV32-NEXT:    vle16.v v1, (a0)
; RV32-NEXT:    vrgatherei16.vv v4, v8, v1
...
; RV32-NEXT:    vrgatherei16.vv v4, v8, v1, v0.t
; RV32-NEXT:    vmv.v.v v8, v4
; RV32-NEXT:    ret
;
...
; CHECK-NEXT:    vrgather.vi v1, v8, 0
; CHECK-NEXT:    vrgather.vi v2, v8, 1
; CHECK-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; CHECK-NEXT:    vwaddu.vv v8, v1, v2
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    vwmaccu.vx v8, a0, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vrgather.vi v1, v8, 4
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslideup.vi v2, v1, 1
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vrgather.vv v1, v8, v2
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    li a0, 66
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vi v1, v8, 2
; CHECK-NEXT:    vrgather.vi v1, v9, 0, v0.t
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vmv.v.i v1, 6
; CHECK-NEXT:    vmv.v.i v2, 0
; CHECK-NEXT:    vsetivli zero, 6, e8, mf2, tu, ma
; CHECK-NEXT:    vslideup.vi v2, v1, 5
; CHECK-NEXT:    lui a0, 8256
; CHECK-NEXT:    addi a0, a0, 2
; CHECK-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; CHECK-NEXT:    vmv.v.x v3, a0
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    li a0, 98
; CHECK-NEXT:    vmv.s.x v0, a0
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vrgather.vi v1, v8, 3
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; CHECK-NEXT:    vslidedown.vi v2, v8, 5
; CHECK-NEXT:    vslideup.vi v2, v8, 3
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, mu
; CHECK-NEXT:    vid.v v1
; CHECK-NEXT:    vadd.vi v2, v1, 2
; CHECK-NEXT:    lui a0, %hi(.LCPI46_0)
; CHECK-NEXT:    addi a0, a0, %lo(.LCPI46_0)
; CHECK-NEXT:    vle8.v v3, (a0)
; CHECK-NEXT:    li a0, 234
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vv v1, v8, v2
; CHECK-NEXT:    vrgather.vv v1, v9, v3, v0.t
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
