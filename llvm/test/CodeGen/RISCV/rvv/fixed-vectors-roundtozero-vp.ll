...
; CHECK-NEXT:    vfsgnj.vv v8, v9, v8, v0.t
; CHECK-NEXT:    ret
  %v = call <2 x float> @llvm.vp.roundtozero.v2f32(<2 x float> %va, <2 x i1> splat (i1 true), i32 %evl)
  ret <2 x float> %v
}
...
; CHECK-NEXT:    vfsgnj.vv v8, v9, v8, v0.t
; CHECK-NEXT:    ret
  %v = call <4 x float> @llvm.vp.roundtozero.v4f32(<4 x float> %va, <4 x i1> splat (i1 true), i32 %evl)
  ret <4 x float> %v
}
...
; CHECK-NEXT:    vfsgnj.vv v8, v10, v8, v0.t
; CHECK-NEXT:    ret
  %v = call <8 x float> @llvm.vp.roundtozero.v8f32(<8 x float> %va, <8 x i1> splat (i1 true), i32 %evl)
  ret <8 x float> %v
}
...
; CHECK-NEXT:    vfsgnj.vv v8, v12, v8, v0.t
; CHECK-NEXT:    ret
  %v = call <16 x float> @llvm.vp.roundtozero.v16f32(<16 x float> %va, <16 x i1> splat (i1 true), i32 %evl)
  ret <16 x float> %v
}
...
; RV32ZVFH-NEXT:    vslidedown.vi v6, v0, 2
...
; RV32ZVFH-NEXT:    lui a2, %hi(.LCPI26_0)
; RV32ZVFH-NEXT:    fld fa5, %lo(.LCPI26_0)(a2)
...
; RV64ZVFH-NEXT:    vslidedown.vi v6, v0, 2
...
; RV32ZVFHMIN-NEXT:    vslidedown.vi v6, v0, 2
...
; RV32ZVFHMIN-NEXT:    lui a2, %hi(.LCPI26_0)
; RV32ZVFHMIN-NEXT:    fld fa5, %lo(.LCPI26_0)(a2)
...
; RV64ZVFHMIN-NEXT:    vslidedown.vi v6, v0, 2
