...
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vle8.v v2, (a1)
; CHECK-NEXT:    vle8.v v3, (a2)
; CHECK-NEXT:    vwmul.vv v4, v1, v2
; CHECK-NEXT:    vwmul.vv v2, v1, v3
