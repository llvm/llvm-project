...
; CHECK-NEXT:    vmadc.vvm v1, v8, v9, v0
...
; CHECK-NEXT:    vmadc.vvm v1, v8, v10, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vvm v1, v8, v12, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vvm v1, v8, v16, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmadc.vxm v1, v8, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmadc.vvm v1, v8, v2, v0
; RV32-NEXT:    vmv.v.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmadc.vxm v1, v8, a0, v0
; RV64-NEXT:    vmv.v.v v0, v1
; RV64-NEXT:    ret
entry:
...
; RV32-NEXT:    vmadc.vvm v1, v8, v4, v0
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vmadc.vvm v1, v8, v16, v0
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vmadc.vim v1, v8, 9, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i1> @llvm.riscv.vmadc.carry.in.nxv1i8.i8(
