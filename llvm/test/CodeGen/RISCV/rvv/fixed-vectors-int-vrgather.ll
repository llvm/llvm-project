...
; LMULMAX4-NEXT:    vlse8.v v4, (a2), zero
; LMULMAX4-NEXT:    vse8.v v4, (a0)
; LMULMAX4-NEXT:    ret
;
...
; LMULMAX4-NEXT:    vlse16.v v4, (a2), zero
; LMULMAX4-NEXT:    vse16.v v4, (a0)
; LMULMAX4-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vlse16.v v1, (a1), zero
...
; LMULMAX4-NEXT:    vlse32.v v4, (a1), zero
; LMULMAX4-NEXT:    vse32.v v4, (a0)
; LMULMAX4-NEXT:    ret
;
...
; LMULMAX1-NEXT:    vlse32.v v1, (a1), zero
; LMULMAX1-NEXT:    addi a1, a0, 32
; LMULMAX1-NEXT:    addi a2, a0, 16
; LMULMAX1-NEXT:    addi a3, a0, 48
...
; LMULMAX4-NEXT:    vlse64.v v4, (a1), zero
; LMULMAX4-NEXT:    vse64.v v4, (a0)
; LMULMAX4-NEXT:    ret
;
...
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vlse16.v v1, (a0), zero
