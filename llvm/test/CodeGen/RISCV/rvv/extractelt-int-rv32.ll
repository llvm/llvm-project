...
; RV32NOM-NEXT:    vsetvli a1, zero, e32, m2, ta, mu
; RV32NOM-NEXT:    vmul.vx v8, v8, a0
; RV32NOM-NEXT:    vsetivli zero, 1, e32, m2, ta, mu
...
; RV32M:       # %bb.0:
; RV32M-NEXT:    vsetivli zero, 1, e32, m2, ta, mu
...
; RV32M:       # %bb.0:
; RV32M-NEXT:    vsetivli zero, 0, e32, m2, ta, mu
; RV32M-NEXT:    vmv.x.s a0, v8
