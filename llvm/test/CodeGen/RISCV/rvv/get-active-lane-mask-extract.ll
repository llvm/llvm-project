...
; CHECK-NEXT:    # fake_use: $v0
; CHECK-NEXT:    # fake_use: $v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmsltu.vx v24, v16, a1
; CHECK-NEXT:    csrr a2, vlenb
; CHECK-NEXT:    vadd.vx v8, v8, a2
; CHECK-NEXT:    vsaddu.vx v8, v8, a0
; CHECK-NEXT:    vmsltu.vx v16, v8, a1
; CHECK-NEXT:    # fake_use: $v24
; CHECK-NEXT:    # fake_use: $v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    ret
  ...
  call void (...) @llvm.fake.use(<4 x i1> %v0)
  call void (...) @llvm.fake.use(<4 x i1> %v1)
  ret void
}
...
; CHECK-NEXT:    vmsne.vi v8, v8, 0
; CHECK-NEXT:    # fake_use: $v0
; CHECK-NEXT:    # fake_use: $v9
; CHECK-NEXT:    # fake_use: $v10
; CHECK-NEXT:    # fake_use: $v8
