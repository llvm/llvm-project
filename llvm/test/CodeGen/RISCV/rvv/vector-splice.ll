...
; NOVLDEP-NEXT:    vmerge.vim v9, v8, 1, v0
...
; VLDEP-NEXT:    vmerge.vim v9, v8, 1, v0
...
; NOVLDEP-NEXT:    vmerge.vim v12, v16, 1, v0
...
; VLDEP-NEXT:    vmerge.vim v12, v16, 1, v0
; VLDEP-NEXT:    csrr a0, vlenb
; VLDEP-NEXT:    li a1, 63
; VLDEP-NEXT:    slli a0, a0, 2
; VLDEP-NEXT:    addi a0, a0, -63
; VLDEP-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; VLDEP-NEXT:    vslidedown.vx v12, v12, a1
; VLDEP-NEXT:    vmv1r.v v0, v8
