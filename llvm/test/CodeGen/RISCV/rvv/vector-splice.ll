...
; CHECK-NEXT:    vmerge.vim v3, v2, 1, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmerge.vim v1, v2, 1, v0
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    srli a0, a0, 3
; CHECK-NEXT:    addi a0, a0, -1
; CHECK-NEXT:    vslidedown.vx v1, v1, a0
; CHECK-NEXT:    vslideup.vi v1, v3, 1
...
; CHECK-NEXT:    vslideup.vx v1, v3, a0
; CHECK-NEXT:    vand.vi v1, v1, 1
; CHECK-NEXT:    vmsne.vi v0, v1, 0
; CHECK-NEXT:    ret
  %res = call <vscale x 1 x i1> @llvm.experimental.vector.splice.nxv1i1(<vscale x 1 x i1> %a, <vscale x 1 x i1> %b, i32 1)
...
; CHECK-NEXT:    vslidedown.vi v1, v1, 7
...
; CHECK-NEXT:    vslidedown.vi v1, v1, 15
...
; CHECK-NEXT:    vslidedown.vx v2, v2, a0
; CHECK-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; CHECK-NEXT:    vslideup.vi v2, v4, 1
...
; CHECK-NEXT:    vslidedown.vi v2, v2, 31
; CHECK-NEXT:    vsetvli a1, zero, e8, m2, ta, ma
; CHECK-NEXT:    vslideup.vx v2, v4, a0
; CHECK-NEXT:    vand.vi v2, v2, 1
; CHECK-NEXT:    vmsne.vi v0, v2, 0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; CHECK-NEXT:    vslideup.vi v4, v8, 1
...
; CHECK-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; CHECK-NEXT:    vmv.v.i v4, 0
; CHECK-NEXT:    vmerge.vim v12, v4, 1, v0
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 2
...
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vmerge.vim v4, v4, 1, v0
; CHECK-NEXT:    vslideup.vx v12, v4, a0
; CHECK-NEXT:    vand.vi v4, v12, 1
; CHECK-NEXT:    vmsne.vi v0, v4, 0
; CHECK-NEXT:    ret
