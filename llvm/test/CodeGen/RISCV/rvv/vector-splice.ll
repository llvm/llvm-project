...
; NOVLDEP-NEXT:    vmv1r.v v0, v10
; NOVLDEP-NEXT:    vmerge.vim v9, v9, 1, v0
; NOVLDEP-NEXT:    vslidedown.vi v9, v9, 7
; NOVLDEP-NEXT:    csrr a0, vlenb
; NOVLDEP-NEXT:    srli a0, a0, 1
...
; VLDEP-NEXT:    vslidedown.vi v9, v9, 7
...
; NOVLDEP-NEXT:    vmv1r.v v0, v10
; NOVLDEP-NEXT:    vmerge.vim v9, v9, 1, v0
; NOVLDEP-NEXT:    vslidedown.vi v9, v9, 15
; NOVLDEP-NEXT:    csrr a0, vlenb
...
; VLDEP-NEXT:    vslidedown.vi v9, v9, 15
...
; NOVLDEP-NEXT:    vslideup.vi v10, v8, 1
; NOVLDEP-NEXT:    vand.vi v8, v10, 1
; NOVLDEP-NEXT:    vmsne.vi v0, v8, 0
; NOVLDEP-NEXT:    ret
;
...
; VLDEP-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; VLDEP-NEXT:    vslideup.vi v10, v8, 1
; VLDEP-NEXT:    vand.vi v8, v10, 1
; VLDEP-NEXT:    vmsne.vi v0, v8, 0
; VLDEP-NEXT:    ret
...
; NOVLDEP-NEXT:    vmv1r.v v0, v12
; NOVLDEP-NEXT:    vmerge.vim v10, v10, 1, v0
; NOVLDEP-NEXT:    vslidedown.vi v10, v10, 31
; NOVLDEP-NEXT:    csrr a0, vlenb
; NOVLDEP-NEXT:    slli a0, a0, 1
...
; VLDEP-NEXT:    vslidedown.vi v10, v10, 31
...
; NOVLDEP-NEXT:    vslideup.vi v12, v8, 1
; NOVLDEP-NEXT:    vand.vi v8, v12, 1
; NOVLDEP-NEXT:    vmsne.vi v0, v8, 0
; NOVLDEP-NEXT:    ret
;
...
; VLDEP-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; VLDEP-NEXT:    vslideup.vi v12, v8, 1
; VLDEP-NEXT:    vand.vi v8, v12, 1
; VLDEP-NEXT:    vmsne.vi v0, v8, 0
; VLDEP-NEXT:    ret
...
; NOVLDEP-NEXT:    vslideup.vi v16, v8, 1
; NOVLDEP-NEXT:    vand.vi v8, v16, 1
; NOVLDEP-NEXT:    vmsne.vi v0, v8, 0
; NOVLDEP-NEXT:    ret
;
...
; VLDEP-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; VLDEP-NEXT:    vslideup.vi v16, v8, 1
; VLDEP-NEXT:    vand.vi v8, v16, 1
; VLDEP-NEXT:    vmsne.vi v0, v8, 0
; VLDEP-NEXT:    ret
...
; NOVLDEP:       # %bb.0:
; NOVLDEP-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; NOVLDEP-NEXT:    vslidedown.vi v8, v8, 15
; NOVLDEP-NEXT:    csrr a0, vlenb
; NOVLDEP-NEXT:    addi a0, a0, -15
; NOVLDEP-NEXT:    vslideup.vx v8, v10, a0
...
; NOVLDEP:       # %bb.0:
; NOVLDEP-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; NOVLDEP-NEXT:    vslidedown.vi v8, v8, 15
; NOVLDEP-NEXT:    csrr a0, vlenb
; NOVLDEP-NEXT:    addi a0, a0, -15
; NOVLDEP-NEXT:    vslideup.vx v8, v12, a0
...
; NOVLDEP:       # %bb.0:
; NOVLDEP-NEXT:    vsetvli a0, zero, e64, m8, ta, ma
; NOVLDEP-NEXT:    vslidedown.vi v8, v8, 15
; NOVLDEP-NEXT:    csrr a0, vlenb
; NOVLDEP-NEXT:    addi a0, a0, -15
; NOVLDEP-NEXT:    vslideup.vx v8, v16, a0
