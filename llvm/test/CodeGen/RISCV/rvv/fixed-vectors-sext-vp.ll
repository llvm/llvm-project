...
; CHECK-NEXT:    vsext.vf2 v1, v8, v0.t
...
; CHECK-NEXT:    vsext.vf4 v1, v8, v0.t
...
; CHECK-NEXT:    vsext.vf8 v2, v8, v0.t
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; CHECK-NEXT:    vsext.vf4 v2, v8, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; CHECK-NEXT:    vsext.vf2 v2, v8, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; CHECK-NEXT:    vzext.vf2 v1, v8, v0.t
; CHECK-NEXT:    vsll.vi v1, v1, 9, v0.t
; CHECK-NEXT:    vsra.vi v8, v1, 9, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsll.vi v1, v8, 1, v0.t
; CHECK-NEXT:    vsra.vi v8, v1, 1, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; CHECK-NEXT:    vsll.vi v1, v8, 7, v0.t
; CHECK-NEXT:    vsra.vi v8, v1, 7, v0.t
; CHECK-NEXT:    ret
