...
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vmsleu.vv v1, v4, v8, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x i32> poison, i32 %b, i32 0
  %vb = shufflevector <vscale x 8 x i32> %elt.head, <vscale x 8 x i32> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vmv.v.x v4, a0
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vmsle.vv v1, v4, v8, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x i32> poison, i32 %b, i32 0
  %vb = shufflevector <vscale x 8 x i32> %elt.head, <vscale x 8 x i32> poison, <vscale x 8 x i32> zeroinitializer
...
; CHECK-NEXT:    vsetvli zero, a0, e8, mf2, tu, ma
; CHECK-NEXT:    vslideup.vx v1, v2, a2
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmseq.vv v0, v1, v8, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsne.vv v0, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsne.vv v0, v1, v8, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsltu.vv v0, v1, v8, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsltu.vv v0, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vmsleu.vv v0, v1, v8, v0.t
; RV64-NEXT:    ret
  %elt.head = insertelement <vscale x 1 x i64> poison, i64 %b, i32 0
  %vb = shufflevector <vscale x 1 x i64> %elt.head, <vscale x 1 x i64> poison, <vscale x 1 x i32> zeroinitializer
  %v = call <vscale x 1 x i1> @llvm.vp.icmp.nxv1i64(<vscale x 1 x i64> %va, <vscale x 1 x i64> %vb, metadata !"uge", <vscale x 1 x i1> %m, i32 %evl)
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsleu.vv v0, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmslt.vv v0, v1, v8, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmslt.vv v0, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmv.v.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vmsle.vv v0, v1, v8, v0.t
; RV64-NEXT:    ret
  %elt.head = insertelement <vscale x 1 x i64> poison, i64 %b, i32 0
  %vb = shufflevector <vscale x 1 x i64> %elt.head, <vscale x 1 x i64> poison, <vscale x 1 x i32> zeroinitializer
  %v = call <vscale x 1 x i1> @llvm.vp.icmp.nxv1i64(<vscale x 1 x i64> %va, <vscale x 1 x i64> %vb, metadata !"sge", <vscale x 1 x i1> %m, i32 %evl)
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vmsle.vv v0, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmsne.vv v1, v8, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; CHECK-NEXT:    vmsleu.vv v1, v16, v8, v0.t
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
...
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmsleu.vv v1, v16, v8, v0.t
; RV64-NEXT:    vmv1r.v v0, v1
; RV64-NEXT:    ret
  %elt.head = insertelement <vscale x 8 x i64> poison, i64 %b, i32 0
  %vb = shufflevector <vscale x 8 x i64> %elt.head, <vscale x 8 x i64> poison, <vscale x 8 x i32> zeroinitializer
