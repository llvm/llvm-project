...
; CHECK-NEXT:    vmulhu.vv v1, v8, v9
; CHECK-NEXT:    vmsne.vi v0, v1, 0
; CHECK-NEXT:    vmul.vv v1, v8, v9
; CHECK-NEXT:    vmerge.vim v8, v1, 0, v0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmulhu.vv v2, v8, v10
; CHECK-NEXT:    vmsne.vi v0, v2, 0
; CHECK-NEXT:    vmul.vv v2, v8, v10
; CHECK-NEXT:    vmerge.vim v8, v2, 0, v0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmulhu.vv v4, v8, v12
; CHECK-NEXT:    vmsne.vi v0, v4, 0
; CHECK-NEXT:    vmul.vv v4, v8, v12
; CHECK-NEXT:    vmerge.vim v8, v4, 0, v0
; CHECK-NEXT:    ret
