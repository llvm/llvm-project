...
; CHECK-NEXT:    vrem.vx v8, v1, a0, v0.t
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vrem.vv v8, v8, v1, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vrem.vv v8, v8, v2, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vrem.vv v8, v8, v4, v0.t
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
