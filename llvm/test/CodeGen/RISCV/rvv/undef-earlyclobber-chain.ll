...
; CHECK-NEXT:    vid.v v2
; CHECK-NEXT:    vadd.vi v4, v2, 1
; CHECK-NEXT:    vadd.vi v6, v2, 3
; CHECK-NEXT:    j .LBB2_3
...
; CHECK-NEXT:    vadd.vi v3, v1, 1
; CHECK-NEXT:    vsetvli zero, a1, e16, m1, ta, ma
; CHECK-NEXT:    vslideup.vx v4, v3, a0
; CHECK-NEXT:    vsetvli a2, zero, e16, mf4, ta, ma
; CHECK-NEXT:    vadd.vi v1, v1, 3
; CHECK-NEXT:    vsetvli zero, a1, e16, m1, ta, ma
; CHECK-NEXT:    vslideup.vx v6, v1, a0
; CHECK-NEXT:  .LBB2_3: # %UseSR
; CHECK-NEXT:    vl1r.v v1, (zero)
; CHECK-NEXT:    vsetivli zero, 4, e8, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v7, v1, v2
; CHECK-NEXT:    vrgatherei16.vv v2, v1, v4
; CHECK-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-NEXT:    vand.vv v2, v7, v2
; CHECK-NEXT:    vsetivli zero, 4, e8, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v3, v1, v6
; CHECK-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-NEXT:    vand.vv v1, v2, v3
; CHECK-NEXT:    vs1r.v v1, (zero)
; CHECK-NEXT:    ret
start:
...
; CHECK-NEXT:    vsetivli zero, 4, e8, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v7, v1, v2
; CHECK-NEXT:    vrgatherei16.vv v3, v1, v4
; CHECK-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-NEXT:    vand.vv v3, v7, v3
; CHECK-NEXT:    vsetivli zero, 4, e8, m1, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v5, v1, v6
; CHECK-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-NEXT:    vand.vv v1, v3, v5
; CHECK-NEXT:    vs1r.v v1, (zero)
; CHECK-NEXT:    j .LBB3_1
...
; CHECK-NEXT:    vslideup.vi v2, v8, 2
