...
; CHECK-NEXT:    vfwmul.vv v8, v4, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; CHECK-NEXT:    vle16.v v1, (a0)
; CHECK-NEXT:    vfwmul.vf v8, v1, fa0
; CHECK-NEXT:    ret
  %a = load <2 x half>, ptr %x
...
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vle16.v v2, (a0)
; CHECK-NEXT:    vfwmul.vf v8, v2, fa0
; CHECK-NEXT:    ret
  %a = load <16 x half>, ptr %x
...
; CHECK-NEXT:    vle16.v v4, (a0)
; CHECK-NEXT:    vfwmul.vf v8, v4, fa0
; CHECK-NEXT:    ret
  %a = load <32 x half>, ptr %x
...
; CHECK-NEXT:    vfmul.vv v16, v24, v8
; CHECK-NEXT:    vl8r.v v24, (a0) # Unknown-size Folded Reload
; CHECK-NEXT:    vfmul.vv v8, v24, v8
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    add sp, sp, a0
; CHECK-NEXT:    addi sp, sp, 16
