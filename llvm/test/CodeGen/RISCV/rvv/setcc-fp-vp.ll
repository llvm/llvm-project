...
; ZVFHMIN-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x1a, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 26 * vlenb
; ZVFHMIN-NEXT:    csrr a1, vlenb
...
; ZVFHMIN-NEXT:    li t1, 25
; ZVFHMIN-NEXT:    mul t0, t0, t1
...
; ZVFHMIN-NEXT:    vmfeq.vv v20, v24, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    csrr a0, vlenb
; ZVFHMIN-NEXT:    add a0, sp, a0
; ZVFHMIN-NEXT:    addi a0, a0, 16
...
; ZVFHMIN-NEXT:    vs1r.v v16, (a5) # Unknown-size Folded Spill
...
; ZVFHMIN-NEXT:    vs1r.v v8, (a6) # Unknown-size Folded Spill
; ZVFHMIN-NEXT:    vsetvli a6, zero, e16, m4, ta, ma
; ZVFHMIN-NEXT:    csrr a6, vlenb
; ZVFHMIN-NEXT:    slli a7, a6, 3
...
; ZVFHMIN-NEXT:    add a6, sp, a6
; ZVFHMIN-NEXT:    addi a6, a6, 16
; ZVFHMIN-NEXT:    vl8r.v v0, (a6) # Unknown-size Folded Reload
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v8, v4
; ZVFHMIN-NEXT:    vsetvli zero, a5, e32, m8, ta, ma
; ZVFHMIN-NEXT:    addi a5, sp, 16
; ZVFHMIN-NEXT:    vl1r.v v0, (a5) # Unknown-size Folded Reload
...
; CHECK-NEXT:    vmfeq.vv v7, v16, v8, v0.t
...
; CHECK-NEXT:    vslideup.vx v16, v17, a4
