...
; CHECK-NEXT:    vslidedown.vx v8, v24, a3
; CHECK-NEXT:    csrr a0, vlenb
...
; CHECK-NEXT:    vmfeq.vv v20, v8, v24, v0.t
...
; CHECK-NEXT:    vslidedown.vx v17, v8, a3
...
; CHECK-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslideup.vx v16, v20, a3
...
; CHECK-NEXT:    vslideup.vx v18, v16, a1
...
; ZVFHMIN-NEXT:    vslidedown.vx v24, v24, a1
...
; ZVFHMIN-NEXT:    vslidedown.vx v17, v8, a3
...
; ZVFHMIN-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslideup.vx v16, v20, a3
...
; ZVFHMIN-NEXT:    vslideup.vx v18, v16, a1
...
; CHECK32-NEXT:    vslidedown.vx v25, v8, s4
; CHECK32-NEXT:    vmv1r.v v7, v25
; CHECK32-NEXT:    add a2, s3, a4
; CHECK32-NEXT:    vl8re64.v v24, (a2)
; CHECK32-NEXT:    slli a6, s0, 4
; CHECK32-NEXT:    slli a2, s0, 1
; CHECK32-NEXT:    vmv1r.v v6, v8
...
; CHECK32-NEXT:    mv a7, a4
; CHECK32-NEXT:    slli a4, a4, 3
; CHECK32-NEXT:    add a7, a7, a4
; CHECK32-NEXT:    slli a4, a4, 1
; CHECK32-NEXT:    add a4, a4, a7
...
; CHECK64-NEXT:    vslidedown.vx v25, v8, s4
; CHECK64-NEXT:    vmv1r.v v7, v25
; CHECK64-NEXT:    add a2, s3, a4
; CHECK64-NEXT:    vl8re64.v v24, (a2)
; CHECK64-NEXT:    slli a6, s0, 4
; CHECK64-NEXT:    slli a2, s0, 1
; CHECK64-NEXT:    vmv1r.v v6, v8
...
; CHECK64-NEXT:    mv a7, a4
; CHECK64-NEXT:    slli a4, a4, 3
; CHECK64-NEXT:    add a7, a7, a4
; CHECK64-NEXT:    slli a4, a4, 1
; CHECK64-NEXT:    add a4, a4, a7
