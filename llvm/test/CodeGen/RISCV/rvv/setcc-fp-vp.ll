...
; CHECK-NEXT:    vl1r.v v8, (t0) # vscale x 8-byte Reload
...
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vs1r.v v16, (a0) # vscale x 8-byte Spill
...
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vs8r.v v0, (a0) # vscale x 64-byte Spill
...
; CHECK-NEXT:    vl1r.v v8, (a5) # vscale x 8-byte Reload
...
; CHECK-NEXT:    add a5, sp, a5
; CHECK-NEXT:    addi a5, a5, 16
; CHECK-NEXT:    vl8r.v v24, (a5) # vscale x 64-byte Reload
...
; ZVFH-NEXT:    vs8r.v v8, (a1) # vscale x 64-byte Spill
...
; ZVFH-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Reload
...
; ZVFHMIN-NEXT:    vs1r.v v0, (a1) # vscale x 8-byte Spill
...
; ZVFHMIN-NEXT:    vl1r.v v8, (t0) # vscale x 8-byte Reload
...
; ZVFHMIN-NEXT:    add a0, sp, a0
; ZVFHMIN-NEXT:    addi a0, a0, 16
; ZVFHMIN-NEXT:    vs1r.v v16, (a0) # vscale x 8-byte Spill
; ZVFHMIN-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v8, v16, a3
; ZVFHMIN-NEXT:    addi a0, sp, 16
; ZVFHMIN-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
...
; ZVFHMIN-NEXT:    addi a0, sp, 16
; ZVFHMIN-NEXT:    vl1r.v v0, (a0) # vscale x 8-byte Reload
...
; ZVFHMIN-NEXT:    vl1r.v v8, (a5) # vscale x 8-byte Reload
...
; CHECK32-NEXT:    sw ra, 44(sp) # 4-byte Spill
; CHECK32-NEXT:    sw s0, 40(sp) # 4-byte Spill
; CHECK32-NEXT:    sw s1, 36(sp) # 4-byte Spill
; CHECK32-NEXT:    sw s2, 32(sp) # 4-byte Spill
; CHECK32-NEXT:    sw s3, 28(sp) # 4-byte Spill
; CHECK32-NEXT:    sw s4, 24(sp) # 4-byte Spill
...
; CHECK32-NEXT:    vs1r.v v0, (a1) # vscale x 8-byte Spill
...
; CHECK32-NEXT:    vs8r.v v16, (a0) # vscale x 64-byte Spill
; CHECK32-NEXT:    csrr a0, vlenb
...
; CHECK32-NEXT:    add a0, sp, a0
; CHECK32-NEXT:    addi a0, a0, 16
; CHECK32-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
...
; CHECK32-NEXT:    add a1, sp, a1
; CHECK32-NEXT:    addi a1, a1, 16
; CHECK32-NEXT:    vl1r.v v6, (a1) # vscale x 8-byte Reload
; CHECK32-NEXT:    mv a1, a0
...
; CHECK32-NEXT:    vs1r.v v9, (a4) # vscale x 8-byte Spill
...
; CHECK32-NEXT:    vl8r.v v8, (a7) # vscale x 64-byte Reload
...
; CHECK32-NEXT:    vs8r.v v8, (a5) # vscale x 64-byte Spill
; CHECK32-NEXT:    csrr a5, vlenb
...
; CHECK32-NEXT:    add a5, sp, a5
; CHECK32-NEXT:    addi a5, a5, 16
; CHECK32-NEXT:    vl8r.v v16, (a5) # vscale x 64-byte Reload
...
; CHECK32-NEXT:    add a1, sp, a1
; CHECK32-NEXT:    addi a1, a1, 16
; CHECK32-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
...
; CHECK32-NEXT:    add a1, sp, a1
; CHECK32-NEXT:    addi a1, a1, 16
; CHECK32-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; CHECK32-NEXT:    add a1, sp, a1
; CHECK32-NEXT:    addi a1, a1, 16
; CHECK32-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Reload
; CHECK32-NEXT:    csrr a1, vlenb
; CHECK32-NEXT:    slli a1, a1, 1
; CHECK32-NEXT:    mv a2, a1
; CHECK32-NEXT:    slli a1, a1, 3
...
; CHECK32-NEXT:    add a1, sp, a1
; CHECK32-NEXT:    addi a1, a1, 16
; CHECK32-NEXT:    vl1r.v v9, (a1) # vscale x 8-byte Reload
; CHECK32-NEXT:    addi a1, sp, 16
; CHECK32-NEXT:    vl1r.v v8, (a1) # vscale x 8-byte Reload
...
; CHECK32-NEXT:    vl8r.v v16, (a2) # vscale x 64-byte Reload
; CHECK32-NEXT:    csrr a2, vlenb
; CHECK32-NEXT:    add a2, sp, a2
; CHECK32-NEXT:    addi a2, a2, 16
; CHECK32-NEXT:    vl8r.v v24, (a2) # vscale x 64-byte Reload
; CHECK32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; CHECK32-NEXT:    vmfeq.vv v8, v24, v16, v0.t
...
; CHECK32-NEXT:    lw ra, 44(sp) # 4-byte Reload
; CHECK32-NEXT:    lw s0, 40(sp) # 4-byte Reload
; CHECK32-NEXT:    lw s1, 36(sp) # 4-byte Reload
; CHECK32-NEXT:    lw s2, 32(sp) # 4-byte Reload
; CHECK32-NEXT:    lw s3, 28(sp) # 4-byte Reload
; CHECK32-NEXT:    lw s4, 24(sp) # 4-byte Reload
...
; CHECK64-NEXT:    sd ra, 56(sp) # 8-byte Spill
; CHECK64-NEXT:    sd s0, 48(sp) # 8-byte Spill
; CHECK64-NEXT:    sd s1, 40(sp) # 8-byte Spill
; CHECK64-NEXT:    sd s2, 32(sp) # 8-byte Spill
; CHECK64-NEXT:    sd s3, 24(sp) # 8-byte Spill
; CHECK64-NEXT:    sd s4, 16(sp) # 8-byte Spill
...
; CHECK64-NEXT:    vs1r.v v0, (a1) # vscale x 8-byte Spill
...
; CHECK64-NEXT:    vs8r.v v16, (a0) # vscale x 64-byte Spill
; CHECK64-NEXT:    csrr a0, vlenb
...
; CHECK64-NEXT:    add a0, sp, a0
; CHECK64-NEXT:    addi a0, a0, 16
; CHECK64-NEXT:    vs8r.v v8, (a0) # vscale x 64-byte Spill
...
; CHECK64-NEXT:    add a1, sp, a1
; CHECK64-NEXT:    addi a1, a1, 16
; CHECK64-NEXT:    vl1r.v v6, (a1) # vscale x 8-byte Reload
; CHECK64-NEXT:    mv a1, a0
...
; CHECK64-NEXT:    vs1r.v v9, (a4) # vscale x 8-byte Spill
...
; CHECK64-NEXT:    vl8r.v v8, (a7) # vscale x 64-byte Reload
...
; CHECK64-NEXT:    vs8r.v v8, (a5) # vscale x 64-byte Spill
; CHECK64-NEXT:    csrr a5, vlenb
...
; CHECK64-NEXT:    add a5, sp, a5
; CHECK64-NEXT:    addi a5, a5, 16
; CHECK64-NEXT:    vl8r.v v16, (a5) # vscale x 64-byte Reload
...
; CHECK64-NEXT:    add a1, sp, a1
; CHECK64-NEXT:    addi a1, a1, 16
; CHECK64-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
...
; CHECK64-NEXT:    add a1, sp, a1
; CHECK64-NEXT:    addi a1, a1, 16
; CHECK64-NEXT:    vs1r.v v8, (a1) # vscale x 8-byte Spill
...
; CHECK64-NEXT:    add a1, sp, a1
; CHECK64-NEXT:    addi a1, a1, 16
; CHECK64-NEXT:    vl1r.v v0, (a1) # vscale x 8-byte Reload
; CHECK64-NEXT:    csrr a1, vlenb
; CHECK64-NEXT:    slli a1, a1, 1
; CHECK64-NEXT:    mv a2, a1
; CHECK64-NEXT:    slli a1, a1, 3
...
; CHECK64-NEXT:    add a1, sp, a1
; CHECK64-NEXT:    addi a1, a1, 16
; CHECK64-NEXT:    vl1r.v v9, (a1) # vscale x 8-byte Reload
; CHECK64-NEXT:    addi a1, sp, 16
; CHECK64-NEXT:    vl1r.v v8, (a1) # vscale x 8-byte Reload
...
; CHECK64-NEXT:    vl8r.v v16, (a2) # vscale x 64-byte Reload
; CHECK64-NEXT:    csrr a2, vlenb
; CHECK64-NEXT:    add a2, sp, a2
; CHECK64-NEXT:    addi a2, a2, 16
; CHECK64-NEXT:    vl8r.v v24, (a2) # vscale x 64-byte Reload
; CHECK64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; CHECK64-NEXT:    vmfeq.vv v8, v24, v16, v0.t
...
; CHECK64-NEXT:    ld ra, 56(sp) # 8-byte Reload
; CHECK64-NEXT:    ld s0, 48(sp) # 8-byte Reload
; CHECK64-NEXT:    ld s1, 40(sp) # 8-byte Reload
; CHECK64-NEXT:    ld s2, 32(sp) # 8-byte Reload
; CHECK64-NEXT:    ld s3, 24(sp) # 8-byte Reload
; CHECK64-NEXT:    ld s4, 16(sp) # 8-byte Reload
