...
; CHECK-NEXT:    vfwcvtbf16.f.f.v v9, v8
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vmfle.vv v0, v10, v9, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vmfeq.vf v8, v9, fa5, v0.t
...
; CHECK-NEXT:    vfwcvtbf16.f.f.v v9, v8
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vmfle.vv v8, v10, v9, v0.t
; CHECK-NEXT:    vmnot.m v0, v8
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vfwcvtbf16.f.f.v v10, v8
; CHECK-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; CHECK-NEXT:    vmfne.vf v8, v9, fa5, v0.t
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x33, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 51 * vlenb
; CHECK-NEXT:    csrr a1, vlenb
; CHECK-NEXT:    slli a1, a1, 1
; CHECK-NEXT:    mv a3, a1
...
; CHECK-NEXT:    add a7, sp, a7
; CHECK-NEXT:    addi a7, a7, 16
; CHECK-NEXT:    vl1r.v v16, (a7) # vscale x 8-byte Folded Reload
...
; CHECK-NEXT:    add a7, sp, a7
; CHECK-NEXT:    addi a7, a7, 16
; CHECK-NEXT:    vs1r.v v24, (a7) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    add a7, sp, a7
; CHECK-NEXT:    addi a7, a7, 16
; CHECK-NEXT:    vl8r.v v16, (a7) # vscale x 64-byte Folded Reload
; CHECK-NEXT:    addi a7, sp, 16
; CHECK-NEXT:    vl8r.v v8, (a7) # vscale x 64-byte Folded Reload
...
; CHECK-NEXT:    vs1r.v v24, (a6) # vscale x 8-byte Folded Spill
; CHECK-NEXT:    csrr a6, vlenb
...
; CHECK-NEXT:    vmfeq.vv v7, v16, v24, v0.t
; CHECK-NEXT:    csrr a5, vlenb
; CHECK-NEXT:    slli a5, a5, 1
; CHECK-NEXT:    mv a6, a5
; CHECK-NEXT:    slli a5, a5, 2
...
; CHECK-NEXT:    add a5, sp, a5
; CHECK-NEXT:    addi a5, a5, 16
; CHECK-NEXT:    vs1r.v v7, (a5) # vscale x 8-byte Folded Spill
...
; CHECK-NEXT:    add a5, sp, a5
; CHECK-NEXT:    addi a5, a5, 16
; CHECK-NEXT:    vl1r.v v13, (a5) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetvli a5, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslidedown.vx v0, v13, a3
; CHECK-NEXT:    vsetvli zero, a4, e32, m8, ta, ma
; CHECK-NEXT:    vmfeq.vv v12, v16, v24, v0.t
...
; CHECK-NEXT:    vl1r.v v14, (a4) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    csrr a4, vlenb
; CHECK-NEXT:    slli a5, a4, 4
; CHECK-NEXT:    add a4, a5, a4
; CHECK-NEXT:    add a4, sp, a4
; CHECK-NEXT:    addi a4, a4, 16
; CHECK-NEXT:    vl1r.v v15, (a4) # vscale x 8-byte Folded Reload
; CHECK-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslideup.vx v14, v15, a3
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v9, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmflt.vv v0, v10, v9, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v9, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfle.vv v0, v10, v9, v0.t
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vf v8, v9, fa5, v0.t
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v9, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfle.vv v8, v10, v9, v0.t
; ZVFHMIN-NEXT:    vmnot.m v0, v8
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN-NEXT:    vfwcvt.f.f.v v10, v8
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vmfne.vf v8, v9, fa5, v0.t
...
; ZVFHMIN-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x33, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 51 * vlenb
; ZVFHMIN-NEXT:    csrr a1, vlenb
; ZVFHMIN-NEXT:    slli a1, a1, 1
; ZVFHMIN-NEXT:    mv a3, a1
...
; ZVFHMIN-NEXT:    slli a7, a7, 1
; ZVFHMIN-NEXT:    mv t0, a7
; ZVFHMIN-NEXT:    slli a7, a7, 3
; ZVFHMIN-NEXT:    add a7, a7, t0
; ZVFHMIN-NEXT:    add a7, sp, a7
; ZVFHMIN-NEXT:    addi a7, a7, 16
; ZVFHMIN-NEXT:    vs8r.v v16, (a7) # vscale x 64-byte Folded Spill
...
; ZVFHMIN-NEXT:    slli a7, a7, 1
; ZVFHMIN-NEXT:    mv t0, a7
; ZVFHMIN-NEXT:    slli a7, a7, 2
; ZVFHMIN-NEXT:    add t0, t0, a7
; ZVFHMIN-NEXT:    slli a7, a7, 2
; ZVFHMIN-NEXT:    add a7, a7, t0
; ZVFHMIN-NEXT:    add a7, sp, a7
; ZVFHMIN-NEXT:    addi a7, a7, 16
; ZVFHMIN-NEXT:    vl1r.v v16, (a7) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli a7, zero, e8, m1, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v24, v16, a0
; ZVFHMIN-NEXT:    srli a3, a3, 2
; ZVFHMIN-NEXT:    csrr a7, vlenb
; ZVFHMIN-NEXT:    slli a7, a7, 4
; ZVFHMIN-NEXT:    add a7, sp, a7
; ZVFHMIN-NEXT:    addi a7, a7, 16
; ZVFHMIN-NEXT:    vs1r.v v24, (a7) # vscale x 8-byte Folded Spill
...
; ZVFHMIN-NEXT:    add a7, sp, a7
; ZVFHMIN-NEXT:    addi a7, a7, 16
; ZVFHMIN-NEXT:    vs8r.v v8, (a7) # vscale x 64-byte Folded Spill
...
; ZVFHMIN-NEXT:    add a7, sp, a7
; ZVFHMIN-NEXT:    addi a7, a7, 16
; ZVFHMIN-NEXT:    vl8r.v v16, (a7) # vscale x 64-byte Folded Reload
; ZVFHMIN-NEXT:    addi a7, sp, 16
; ZVFHMIN-NEXT:    vl8r.v v8, (a7) # vscale x 64-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli zero, a6, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v24, v8, v16, v0.t
...
; ZVFHMIN-NEXT:    vs1r.v v24, (a6) # vscale x 8-byte Folded Spill
; ZVFHMIN-NEXT:    csrr a6, vlenb
...
; ZVFHMIN-NEXT:    vmfeq.vv v7, v16, v24, v0.t
; ZVFHMIN-NEXT:    csrr a5, vlenb
; ZVFHMIN-NEXT:    slli a5, a5, 1
; ZVFHMIN-NEXT:    mv a6, a5
; ZVFHMIN-NEXT:    slli a5, a5, 2
...
; ZVFHMIN-NEXT:    add a5, sp, a5
; ZVFHMIN-NEXT:    addi a5, a5, 16
; ZVFHMIN-NEXT:    vs1r.v v7, (a5) # vscale x 8-byte Folded Spill
...
; ZVFHMIN-NEXT:    add a5, sp, a5
; ZVFHMIN-NEXT:    addi a5, a5, 16
; ZVFHMIN-NEXT:    vl1r.v v13, (a5) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli a5, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslidedown.vx v0, v13, a3
; ZVFHMIN-NEXT:    vsetvli zero, a4, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vmfeq.vv v12, v16, v24, v0.t
...
; ZVFHMIN-NEXT:    vl1r.v v14, (a4) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    csrr a4, vlenb
; ZVFHMIN-NEXT:    slli a5, a4, 4
; ZVFHMIN-NEXT:    add a4, a5, a4
; ZVFHMIN-NEXT:    add a4, sp, a4
; ZVFHMIN-NEXT:    addi a4, a4, 16
; ZVFHMIN-NEXT:    vl1r.v v15, (a4) # vscale x 8-byte Folded Reload
; ZVFHMIN-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; ZVFHMIN-NEXT:    vslideup.vx v14, v15, a3
...
; ZVFHMIN-NEXT:    vslideup.vx v8, v12, a3
; ZVFHMIN-NEXT:    vsetvli a1, zero, e8, m1, ta, ma
; ZVFHMIN-NEXT:    vslideup.vx v8, v14, a0
...
; CHECK32-NEXT:    mv a1, a0
; CHECK32-NEXT:    slli a3, s0, 3
; CHECK32-NEXT:    add a0, s3, a3
...
; CHECK32-NEXT:    mv a4, s1
; CHECK32-NEXT:    bltu s1, a2, .LBB257_2
; CHECK32-NEXT:  # %bb.1:
; CHECK32-NEXT:    mv a4, a2
; CHECK32-NEXT:  .LBB257_2:
; CHECK32-NEXT:    sub a6, a4, s0
; CHECK32-NEXT:    sltu a7, a4, a6
...
; CHECK32-NEXT:    add a3, s2, a3
; CHECK32-NEXT:    add a5, s3, a5
; CHECK32-NEXT:    bltu a4, s0, .LBB257_4
; CHECK32-NEXT:  # %bb.3:
; CHECK32-NEXT:    mv a4, s0
...
; CHECK32-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
...
; CHECK64-NEXT:    mv a1, a0
; CHECK64-NEXT:    slli a3, s0, 3
; CHECK64-NEXT:    add a0, s3, a3
...
; CHECK64-NEXT:    mv a4, s1
; CHECK64-NEXT:    bltu s1, a2, .LBB257_2
; CHECK64-NEXT:  # %bb.1:
; CHECK64-NEXT:    mv a4, a2
; CHECK64-NEXT:  .LBB257_2:
; CHECK64-NEXT:    sub a6, a4, s0
...
; CHECK64-NEXT:    add a3, s2, a3
; CHECK64-NEXT:    add a5, s3, a5
; CHECK64-NEXT:    bltu a4, s0, .LBB257_4
; CHECK64-NEXT:  # %bb.3:
; CHECK64-NEXT:    mv a4, s0
...
; CHECK64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
