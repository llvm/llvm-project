...
; CHECK-NEXT:    vslidedown.vi v1, v2, 7
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vslidedown.vi v2, v2, 3
; RV32-NEXT:    li a0, 32
...
; RV64-NEXT:    vslidedown.vi v2, v2, 3
...
; RV32-NEXT:    vslidedown.vi v2, v2, 5
; RV32-NEXT:    vmv.x.s a1, v2
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vle64.v v2, (a0)
; RV64-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV64-NEXT:    vslidedown.vi v2, v2, 2
; RV64-NEXT:    vmv.x.s a0, v2
; RV64-NEXT:    ret
...
; RV32-NEXT:    vslidedown.vx v1, v1, a1
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
...
; RV64-NEXT:    vslidedown.vx v1, v1, a1
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
  %a = load <2 x i64>, ptr %x
  %b = add <2 x i64> %a, %a
...
; RV32-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV32-NEXT:    vslidedown.vx v2, v2, a1
; RV32-NEXT:    vmv.x.s a0, v2
; RV32-NEXT:    li a1, 32
...
; RV64-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV64-NEXT:    vslidedown.vx v2, v2, a1
; RV64-NEXT:    vmv.x.s a0, v2
; RV64-NEXT:    ret
  %a = load <4 x i64>, ptr %x
  %b = add <4 x i64> %a, %a
...
; RV32-NEXT:    vsetivli zero, 1, e32, m2, ta, ma
; RV32-NEXT:    vslidedown.vx v4, v2, a1
; RV32-NEXT:    vmv.x.s a0, v4
...
; RV32NOM-NEXT:    vmul.vx v1, v8, a0
; RV32NOM-NEXT:    vslidedown.vi v1, v1, 2
...
; RV32M-NEXT:    vslidedown.vi v1, v8, 2
...
; RV64NOM-NEXT:    vmul.vx v1, v8, a0
; RV64NOM-NEXT:    vslidedown.vi v1, v1, 2
...
; RV64M-NEXT:    vslidedown.vi v1, v8, 2
...
; RV32NOM-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32NOM-NEXT:    vle32.v v1, (a0)
; RV32NOM-NEXT:    vmulh.vv v1, v8, v1
; RV32NOM-NEXT:    lui a0, 1044480
; RV32NOM-NEXT:    vmv.s.x v2, a0
; RV32NOM-NEXT:    vsext.vf4 v3, v2
; RV32NOM-NEXT:    vand.vv v2, v8, v3
; RV32NOM-NEXT:    vadd.vv v1, v1, v2
; RV32NOM-NEXT:    lui a0, 12320
; RV32NOM-NEXT:    addi a0, a0, 257
; RV32NOM-NEXT:    vmv.s.x v2, a0
; RV32NOM-NEXT:    vsext.vf4 v3, v2
; RV32NOM-NEXT:    vsra.vv v2, v1, v3
; RV32NOM-NEXT:    vsrl.vi v1, v1, 31
; RV32NOM-NEXT:    vadd.vv v1, v2, v1
; RV32NOM-NEXT:    vslidedown.vi v1, v1, 2
; RV32NOM-NEXT:    vmv.x.s a0, v1
; RV32NOM-NEXT:    ret
;
...
; RV64NOM-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV64NOM-NEXT:    vle32.v v1, (a0)
; RV64NOM-NEXT:    vmulh.vv v1, v8, v1
; RV64NOM-NEXT:    lui a0, 1044480
; RV64NOM-NEXT:    vmv.s.x v2, a0
; RV64NOM-NEXT:    vsext.vf4 v3, v2
; RV64NOM-NEXT:    vand.vv v2, v8, v3
; RV64NOM-NEXT:    vadd.vv v1, v1, v2
; RV64NOM-NEXT:    lui a0, 12320
; RV64NOM-NEXT:    addi a0, a0, 257
; RV64NOM-NEXT:    vmv.s.x v2, a0
; RV64NOM-NEXT:    vsext.vf4 v3, v2
; RV64NOM-NEXT:    vsra.vv v1, v1, v3
; RV64NOM-NEXT:    vsrl.vi v2, v1, 31
; RV64NOM-NEXT:    vadd.vv v1, v1, v2
; RV64NOM-NEXT:    vslidedown.vi v1, v1, 2
; RV64NOM-NEXT:    vmv.x.s a0, v1
; RV64NOM-NEXT:    ret
...
; RV32NOM:       # %bb.0:
; RV32NOM-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV32NOM-NEXT:    vsrl.vi v1, v8, 0
; RV32NOM-NEXT:    lui a0, 322639
; RV32NOM-NEXT:    addi a0, a0, -945
; RV32NOM-NEXT:    vmulhu.vx v1, v1, a0
; RV32NOM-NEXT:    vslidedown.vi v1, v1, 2
; RV32NOM-NEXT:    vmv.x.s a0, v1
...
; RV64NOM:       # %bb.0:
; RV64NOM-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; RV64NOM-NEXT:    vsrl.vi v1, v8, 0
; RV64NOM-NEXT:    lui a0, 322639
; RV64NOM-NEXT:    addi a0, a0, -945
; RV64NOM-NEXT:    vmulhu.vx v1, v1, a0
; RV64NOM-NEXT:    vslidedown.vi v1, v1, 2
; RV64NOM-NEXT:    vmv.x.s a0, v1
