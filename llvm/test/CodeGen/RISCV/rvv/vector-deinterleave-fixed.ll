...
; V-NEXT:    vmv1r.v v0, v15
; V-NEXT:    vmerge.vvm v10, v10, v8, v0
...
; V-NEXT:    vid.v v16
; V-NEXT:    vadd.vv v16, v16, v16
; V-NEXT:    vadd.vi v20, v16, -8
; V-NEXT:    vmv.v.i v0, -16
; V-NEXT:    vadd.vi v21, v16, -7
...
; V-NEXT:    vrgatherei16.vv v16, v24, v20, v0.t
; V-NEXT:    li a0, 170
; V-NEXT:    vmv.s.x v20, a0
; V-NEXT:    vcompress.vm v12, v8, v20
; V-NEXT:    vrgatherei16.vv v12, v24, v21, v0.t
...
; CHECK-NEXT:    vsetvli zero, a1, e8, mf2, tu, ma
; CHECK-NEXT:    vslideup.vx v8, v11, a2
; CHECK-NEXT:    vsetvli zero, a3, e8, mf2, tu, ma
; CHECK-NEXT:    vslideup.vx v8, v12, a1
; CHECK-NEXT:    srli a0, a0, 1
; CHECK-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; CHECK-NEXT:    vslideup.vx v8, v13, a3
; CHECK-NEXT:    addi a1, sp, 16
