...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x20, 0x22, 0x11, 0x38, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 32 + 56 * vlenb
...
; RV32-NEXT:    vslidedown.vi v6, v0, 8
; RV32-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vi v5, v0, 4
; RV32-NEXT:    addi a2, a7, -64
; RV32-NEXT:    vslidedown.vi v4, v6, 4
...
; RV32-NEXT:    vslidedown.vi v0, v4, 2
; RV32-NEXT:    addi t1, t1, -1
; RV32-NEXT:    addi t3, a1, 384
; RV32-NEXT:    vslidedown.vi v3, v6, 2
; RV32-NEXT:    li a3, 32
...
; RV32-NEXT:    vle64.v v8, (a1)
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v4, v7, 2
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x30, 0x22, 0x11, 0x38, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 48 + 56 * vlenb
...
; RV64-NEXT:    vslidedown.vi v6, v0, 8
; RV64-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; RV64-NEXT:    vslidedown.vi v5, v0, 4
; RV64-NEXT:    addi a2, a7, -64
; RV64-NEXT:    vslidedown.vi v4, v6, 4
...
; RV64-NEXT:    vslidedown.vi v3, v6, 2
; RV64-NEXT:    li a3, 32
...
; RV64-NEXT:    vle64.v v8, (a1)
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v4, v7, 2
