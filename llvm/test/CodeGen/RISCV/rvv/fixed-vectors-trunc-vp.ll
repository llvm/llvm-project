...
; CHECK-NEXT:    bltu a4, a2, .LBB16_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    li a4, 16
; CHECK-NEXT:  .LBB16_2:
; CHECK-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; CHECK-NEXT:    vslidedown.vi v28, v2, 2
; CHECK-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; CHECK-NEXT:    addi a1, a3, -16
; CHECK-NEXT:    sltu a5, a3, a1
; CHECK-NEXT:    addi a5, a5, -1
; CHECK-NEXT:    and a1, a5, a1
; CHECK-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vnsrl.wi v16, v24, 0, v0.t
; CHECK-NEXT:    bltu a3, a2, .LBB16_10
; CHECK-NEXT:  # %bb.9:
; CHECK-NEXT:    li a3, 16
; CHECK-NEXT:  .LBB16_10:
; CHECK-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
...
; CHECK-NEXT:    bltu a7, a4, .LBB16_12
; CHECK-NEXT:  # %bb.11:
; CHECK-NEXT:    li a7, 32
; CHECK-NEXT:  .LBB16_12:
