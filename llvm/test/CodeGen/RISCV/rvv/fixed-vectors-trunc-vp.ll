...
; RV32-NEXT:    vs8r.v v24, (t2) # vscale x 64-byte Spill
...
; RV32-NEXT:    add t2, sp, t2
; RV32-NEXT:    addi t2, t2, 16
; RV32-NEXT:    vl8r.v v24, (t2) # vscale x 64-byte Reload
...
; RV32-NEXT:    vs8r.v v8, (a5) # vscale x 64-byte Spill
...
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs8r.v v24, (a1) # vscale x 64-byte Spill
; RV32-NEXT:    mv a1, a7
...
; RV32-NEXT:    vl8r.v v8, (a4) # vscale x 64-byte Reload
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    slli a4, a4, 4
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vl8r.v v24, (a4) # vscale x 64-byte Reload
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li a5, 24
; RV32-NEXT:    mul a4, a4, a5
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vs8r.v v16, (a4) # vscale x 64-byte Spill
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    slli a4, a4, 6
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vl8r.v v16, (a4) # vscale x 64-byte Reload
...
; RV32-NEXT:    add a5, sp, a5
; RV32-NEXT:    addi a5, a5, 16
; RV32-NEXT:    vl8r.v v16, (a5) # vscale x 64-byte Reload
...
; RV32-NEXT:    add a5, sp, a5
; RV32-NEXT:    addi a5, a5, 16
; RV32-NEXT:    vs8r.v v16, (a5) # vscale x 64-byte Spill
; RV32-NEXT:    csrr a5, vlenb
; RV32-NEXT:    li a6, 48
; RV32-NEXT:    mul a5, a5, a6
; RV32-NEXT:    add a5, sp, a5
...
; RV64-NEXT:    vs8r.v v8, (t6) # vscale x 64-byte Spill
...
; RV64-NEXT:    vs8r.v v24, (t2) # vscale x 64-byte Spill
...
; RV64-NEXT:    add t2, sp, t2
; RV64-NEXT:    addi t2, t2, 32
; RV64-NEXT:    vl8r.v v24, (t2) # vscale x 64-byte Reload
...
; RV64-NEXT:    vs8r.v v8, (a5) # vscale x 64-byte Spill
...
; RV64-NEXT:    add a1, sp, a1
; RV64-NEXT:    addi a1, a1, 32
; RV64-NEXT:    vs8r.v v24, (a1) # vscale x 64-byte Spill
; RV64-NEXT:    mv a1, a7
...
; RV64-NEXT:    vl8r.v v8, (a4) # vscale x 64-byte Reload
; RV64-NEXT:    csrr a4, vlenb
; RV64-NEXT:    slli a4, a4, 4
; RV64-NEXT:    add a4, sp, a4
; RV64-NEXT:    addi a4, a4, 32
; RV64-NEXT:    vl8r.v v24, (a4) # vscale x 64-byte Reload
; RV64-NEXT:    csrr a4, vlenb
; RV64-NEXT:    li a5, 24
; RV64-NEXT:    mul a4, a4, a5
; RV64-NEXT:    add a4, sp, a4
; RV64-NEXT:    addi a4, a4, 32
; RV64-NEXT:    vs8r.v v16, (a4) # vscale x 64-byte Spill
; RV64-NEXT:    csrr a4, vlenb
; RV64-NEXT:    slli a4, a4, 6
; RV64-NEXT:    add a4, sp, a4
; RV64-NEXT:    addi a4, a4, 32
; RV64-NEXT:    vl8r.v v16, (a4) # vscale x 64-byte Reload
...
; RV64-NEXT:    add a5, sp, a5
; RV64-NEXT:    addi a5, a5, 32
; RV64-NEXT:    vl8r.v v16, (a5) # vscale x 64-byte Reload
...
; RV64-NEXT:    add a5, sp, a5
; RV64-NEXT:    addi a5, a5, 32
; RV64-NEXT:    vs8r.v v16, (a5) # vscale x 64-byte Spill
; RV64-NEXT:    csrr a5, vlenb
; RV64-NEXT:    li a6, 48
; RV64-NEXT:    mul a5, a5, a6
; RV64-NEXT:    add a5, sp, a5
...
; RV64-NEXT:    add a5, sp, a5
; RV64-NEXT:    addi a5, a5, 32
; RV64-NEXT:    vl8r.v v8, (a5) # vscale x 64-byte Reload
; RV64-NEXT:    vslideup.vi v16, v8, 16
; RV64-NEXT:    csrr a5, vlenb
; RV64-NEXT:    li a6, 48
; RV64-NEXT:    mul a5, a5, a6
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 32
; RV64-NEXT:    vl8r.v v8, (a2) # vscale x 64-byte Reload
