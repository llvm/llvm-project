...
; RV32-NEXT:    addi t3, sp, 16
; RV32-NEXT:    vs8r.v v8, (t3) # vscale x 64-byte Folded Spill
...
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v13, v7, 2
; RV32-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:    addi t3, sp, 32
; RV64-NEXT:    vs8r.v v8, (t3) # vscale x 64-byte Folded Spill
...
; RV64-NEXT:    vl8r.v v24, (a6) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vsetvli zero, a5, e32, m4, ta, ma
; RV64-NEXT:    vnsrl.wi v16, v24, 0, v0.t
; RV64-NEXT:    csrr a5, vlenb
; RV64-NEXT:    slli a5, a5, 5
...
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v13, v7, 2
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
