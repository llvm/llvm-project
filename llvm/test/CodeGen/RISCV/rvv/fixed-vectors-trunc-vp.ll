...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x20, 0x22, 0x11, 0xca, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 32 + 74 * vlenb
; RV32-NEXT:    csrr a2, vlenb
...
; RV32-NEXT:    vs1r.v v0, (a6) # vscale x 8-byte Folded Spill
...
; RV32-NEXT:    vslidedown.vi v31, v9, 2
...
; RV32-NEXT:    vslidedown.vi v29, v28, 2
...
; RV32-NEXT:    vs8r.v v8, (s0) # vscale x 64-byte Folded Spill
...
; RV64-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x30, 0x22, 0x11, 0xca, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 48 + 74 * vlenb
; RV64-NEXT:    csrr a2, vlenb
...
; RV64-NEXT:    vs1r.v v0, (a6) # vscale x 8-byte Folded Spill
...
; RV64-NEXT:    vslidedown.vi v31, v9, 2
...
; RV64-NEXT:    vslidedown.vi v29, v28, 2
...
; RV64-NEXT:    vs8r.v v8, (s0) # vscale x 64-byte Folded Spill
