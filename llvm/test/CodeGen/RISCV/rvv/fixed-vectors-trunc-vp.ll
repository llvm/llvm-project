...
; CHECK-NEXT:    vnsrl.wi v4, v8, 0, v0.t
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vnsrl.wi v8, v4, 0, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vslidedown.vi v3, v0, 4
...
; CHECK-NEXT:    vslidedown.vi v0, v4, 2
...
; CHECK-NEXT:  .LBB16_2:
; CHECK-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; CHECK-NEXT:    vslidedown.vi v5, v3, 2
; CHECK-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; CHECK-NEXT:    vs8r.v v16, (t0) # Unknown-size Folded Spill
