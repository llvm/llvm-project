...
; RV32-NEXT:    vs8r.v v16, (t3) # Unknown-size Folded Spill
...
; RV32-NEXT:    add t3, sp, t3
; RV32-NEXT:    addi t3, t3, 16
; RV32-NEXT:    vs8r.v v24, (t3) # Unknown-size Folded Spill
; RV32-NEXT:    vle64.v v24, (t2)
; RV32-NEXT:    csrr t2, vlenb
; RV32-NEXT:    slli t2, t2, 5
; RV32-NEXT:    add t2, sp, t2
; RV32-NEXT:    addi t2, t2, 16
; RV32-NEXT:    vs8r.v v24, (t2) # Unknown-size Folded Spill
...
; RV32-NEXT:    vs8r.v v16, (t2) # Unknown-size Folded Spill
; RV32-NEXT:    vmv1r.v v0, v3
; RV32-NEXT:    csrr t2, vlenb
; RV32-NEXT:    slli t2, t2, 6
; RV32-NEXT:    add t2, sp, t2
; RV32-NEXT:    addi t2, t2, 16
; RV32-NEXT:    vl8r.v v16, (t2) # Unknown-size Folded Reload
...
; RV32-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV32-NEXT:    vslidedown.vi v8, v7, 2
; RV32-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    vs8r.v v16, (t3) # Unknown-size Folded Spill
...
; RV64-NEXT:    add t3, sp, t3
; RV64-NEXT:    addi t3, t3, 32
; RV64-NEXT:    vs8r.v v24, (t3) # Unknown-size Folded Spill
; RV64-NEXT:    vle64.v v24, (t2)
; RV64-NEXT:    csrr t2, vlenb
; RV64-NEXT:    slli t2, t2, 5
; RV64-NEXT:    add t2, sp, t2
; RV64-NEXT:    addi t2, t2, 32
; RV64-NEXT:    vs8r.v v24, (t2) # Unknown-size Folded Spill
...
; RV64-NEXT:    vs8r.v v16, (t2) # Unknown-size Folded Spill
; RV64-NEXT:    vmv1r.v v0, v3
; RV64-NEXT:    csrr t2, vlenb
; RV64-NEXT:    slli t2, t2, 6
; RV64-NEXT:    add t2, sp, t2
; RV64-NEXT:    addi t2, t2, 32
; RV64-NEXT:    vl8r.v v16, (t2) # Unknown-size Folded Reload
...
; RV64-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vi v8, v7, 2
; RV64-NEXT:    csrr a1, vlenb
...
; RV64-NEXT:    vl8r.v v0, (a4) # Unknown-size Folded Reload
; RV64-NEXT:    csrr a4, vlenb
; RV64-NEXT:    li a5, 72
; RV64-NEXT:    mul a4, a4, a5
; RV64-NEXT:    add a4, sp, a4
