...
; RV32-NEXT:    vmsltu.vx v7, v16, a1
; RV32-NEXT:    vmsltu.vx v16, v24, a1
; RV32-NEXT:    li a1, 64
; RV32-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; RV32-NEXT:    vmv.v.i v12, 1
; RV32-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV32-NEXT:    vslideup.vi v7, v16, 4
; RV32-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; RV32-NEXT:    vmand.mm v0, v7, v0
...
; RV64-NEXT:    vmsltu.vx v7, v16, a1
; RV64-NEXT:    vmsltu.vx v16, v24, a1
; RV64-NEXT:    li a1, 64
; RV64-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; RV64-NEXT:    vmv.v.i v12, 1
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV64-NEXT:    vslideup.vi v7, v16, 4
; RV64-NEXT:    vsetvli zero, a1, e8, m4, ta, ma
; RV64-NEXT:    vmand.mm v0, v7, v0
