...
; CHECK-NEXT:    vredsum.vs v1, v8, v1, v0.t
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmaxu.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmax.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredminu.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredmin.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredand.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredor.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv.s.x v1, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, mf8, ta, ma
; CHECK-NEXT:    vredxor.vs v1, v8, v1, v0.t
; CHECK-NEXT:    vmv.x.s a0, v1
; CHECK-NEXT:    ret
...
; RV32-NEXT:    vmv.s.x v1, a0
; RV32-NEXT:    vsetvli zero, a1, e16, mf4, ta, ma
; RV32-NEXT:    vredmaxu.vs v1, v8, v1, v0.t
...
; RV64-NEXT:    vredmaxu.vs v1, v8, v1, v0.t
...
; RV32-NEXT:    vmv.s.x v1, a0
; RV32-NEXT:    vsetvli zero, a1, e16, mf4, ta, ma
; RV32-NEXT:    vredminu.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e16, mf4, ta, ma
; RV64-NEXT:    vredminu.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; CHECK-NEXT:    vredxor.vs v2, v8, v2, v0.t
...
; CHECK-NEXT:    vredxor.vs v2, v16, v2, v0.t
...
; RV32-NEXT:    vredsum.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
...
; RV64-NEXT:    vredsum.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vredmax.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredmax.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vredmin.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredmin.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vredand.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredand.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vredor.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredor.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e64, m1, ta, ma
; RV32-NEXT:    vredxor.vs v1, v8, v1, v0.t
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e64, m1, ta, ma
; RV64-NEXT:    vredxor.vs v1, v8, v1, v0.t
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
...
; RV32-NEXT:    vmsne.vi v1, v1, 0
; RV32-NEXT:    vmand.mm v0, v1, v0
; RV32-NEXT:    vmv.v.i v1, 1
; RV32-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; RV32-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    mv a1, a2
...
; RV64-NEXT:    vmsne.vi v1, v1, 0
; RV64-NEXT:    vmand.mm v0, v1, v0
; RV64-NEXT:    vmv.v.i v1, 1
; RV64-NEXT:    vsetvli zero, zero, e8, mf8, ta, ma
; RV64-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    mv a1, a2
...
; RV32-NEXT:    vid.v v2
; RV32-NEXT:    vmsltu.vx v1, v2, a1
; RV32-NEXT:    vmand.mm v0, v1, v0
; RV32-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV32-NEXT:    vmv.v.i v1, 1
; RV32-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV32-NEXT:    vslidedown.vi v2, v1, 4
; RV32-NEXT:    vmul.vv v1, v1, v2
; RV32-NEXT:    vslidedown.vi v2, v1, 2
; RV32-NEXT:    vmul.vv v1, v1, v2
; RV32-NEXT:    vrgather.vi v2, v1, 1
...
; RV64-NEXT:    vid.v v2
; RV64-NEXT:    vmsltu.vx v1, v2, a1
; RV64-NEXT:    vmand.mm v0, v1, v0
; RV64-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; RV64-NEXT:    vmv.v.i v1, 1
; RV64-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV64-NEXT:    vslidedown.vi v2, v1, 4
; RV64-NEXT:    vmul.vv v1, v1, v2
; RV64-NEXT:    vslidedown.vi v2, v1, 2
; RV64-NEXT:    vmul.vv v1, v1, v2
; RV64-NEXT:    vrgather.vi v2, v1, 1
...
; RV32-NEXT:    vid.v v4
; RV32-NEXT:    vmsltu.vx v1, v4, a1
; RV32-NEXT:    vmand.mm v0, v1, v0
; RV32-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV32-NEXT:    vmv.v.i v1, 1
; RV32-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV32-NEXT:    vslidedown.vi v2, v1, 8
; RV32-NEXT:    vmul.vv v1, v1, v2
; RV32-NEXT:    vslidedown.vi v2, v1, 4
; RV32-NEXT:    vmul.vv v1, v1, v2
; RV32-NEXT:    vslidedown.vi v2, v1, 2
...
; RV64-NEXT:    vid.v v4
; RV64-NEXT:    vmsltu.vx v1, v4, a1
; RV64-NEXT:    vmand.mm v0, v1, v0
; RV64-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; RV64-NEXT:    vmv.v.i v1, 1
; RV64-NEXT:    vmerge.vvm v1, v1, v8, v0
; RV64-NEXT:    vslidedown.vi v2, v1, 8
; RV64-NEXT:    vmul.vv v1, v1, v2
; RV64-NEXT:    vslidedown.vi v2, v1, 4
; RV64-NEXT:    vmul.vv v1, v1, v2
; RV64-NEXT:    vslidedown.vi v2, v1, 2
...
; RV32-NEXT:    vid.v v16
; RV32-NEXT:    vmsltu.vx v1, v16, a1
; RV32-NEXT:    vmand.mm v0, v1, v0
; RV32-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; RV32-NEXT:    vmv.v.i v2, 1
; RV32-NEXT:    vmerge.vvm v2, v2, v8, v0
; RV32-NEXT:    vslidedown.vi v4, v2, 16
; RV32-NEXT:    vmul.vv v2, v2, v4
; RV32-NEXT:    vslidedown.vi v4, v2, 8
; RV32-NEXT:    vmul.vv v2, v2, v4
; RV32-NEXT:    vslidedown.vi v4, v2, 4
; RV32-NEXT:    vmul.vv v2, v2, v4
...
; RV64-NEXT:    vid.v v16
; RV64-NEXT:    vmsltu.vx v1, v16, a1
; RV64-NEXT:    vmand.mm v0, v1, v0
; RV64-NEXT:    vsetvli zero, zero, e8, m2, ta, ma
; RV64-NEXT:    vmv.v.i v2, 1
; RV64-NEXT:    vmerge.vvm v2, v2, v8, v0
; RV64-NEXT:    vslidedown.vi v4, v2, 16
; RV64-NEXT:    vmul.vv v2, v2, v4
; RV64-NEXT:    vslidedown.vi v4, v2, 8
; RV64-NEXT:    vmul.vv v2, v2, v4
; RV64-NEXT:    vslidedown.vi v4, v2, 4
; RV64-NEXT:    vmul.vv v2, v2, v4
...
; RV32-NEXT:    vle8.v v2, (a2)
; RV32-NEXT:    mv a2, a0
; RV32-NEXT:    vid.v v16
; RV32-NEXT:    vmsltu.vx v1, v16, a1
; RV32-NEXT:    vsext.vf4 v16, v2
; RV32-NEXT:    vmsltu.vx v2, v16, a1
; RV32-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV32-NEXT:    vslideup.vi v1, v2, 4
; RV32-NEXT:    li a0, 64
; RV32-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; RV32-NEXT:    vmand.mm v0, v1, v0
; RV32-NEXT:    vmv.v.i v4, 1
; RV32-NEXT:    vmerge.vvm v4, v4, v8, v0
; RV32-NEXT:    vslidedown.vx v8, v4, a3
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    vslidedown.vi v8, v4, 16
; RV32-NEXT:    vmul.vv v4, v4, v8
; RV32-NEXT:    vslidedown.vi v8, v4, 8
; RV32-NEXT:    vmul.vv v4, v4, v8
...
; RV64-NEXT:    vle8.v v2, (a2)
; RV64-NEXT:    mv a2, a0
; RV64-NEXT:    vid.v v16
; RV64-NEXT:    vmsltu.vx v1, v16, a1
; RV64-NEXT:    vsext.vf4 v16, v2
; RV64-NEXT:    vmsltu.vx v2, v16, a1
; RV64-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; RV64-NEXT:    vslideup.vi v1, v2, 4
; RV64-NEXT:    li a0, 64
; RV64-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; RV64-NEXT:    vmand.mm v0, v1, v0
; RV64-NEXT:    vmv.v.i v4, 1
; RV64-NEXT:    vmerge.vvm v4, v4, v8, v0
; RV64-NEXT:    vslidedown.vx v8, v4, a3
; RV64-NEXT:    vmul.vv v4, v4, v8
; RV64-NEXT:    vslidedown.vi v8, v4, 16
; RV64-NEXT:    vmul.vv v4, v4, v8
; RV64-NEXT:    vslidedown.vi v8, v4, 8
; RV64-NEXT:    vmul.vv v4, v4, v8
