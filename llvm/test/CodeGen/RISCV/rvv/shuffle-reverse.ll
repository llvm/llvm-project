...
; CHECK-NEXT:    vslideup.vi v8, v1, 2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vid.v v2
; CHECK-NEXT:    vrsub.vi v3, v2, 7
; CHECK-NEXT:    vrgather.vv v1, v8, v3
; CHECK-NEXT:    vmv.v.i v0, 15
; CHECK-NEXT:    vrsub.vi v2, v2, 3
...
; CHECK-NEXT:    vid.v v2
; CHECK-NEXT:    vrsub.vi v3, v2, 15
; CHECK-NEXT:    vrgather.vv v1, v8, v3
; CHECK-NEXT:    vrsub.vi v2, v2, 7
...
; CHECK-NEXT:    vmv1r.v v6, v9
; CHECK-NEXT:    vrgather.vv v2, v8, v4
; CHECK-NEXT:    vid.v v4
; CHECK-NEXT:    vrsub.vi v4, v4, 15
; CHECK-NEXT:    lui a0, 16
; CHECK-NEXT:    addi a0, a0, -1
; CHECK-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vsetvli zero, a1, e8, m2, ta, mu
; CHECK-NEXT:    vrgather.vv v2, v6, v4, v0.t
...
; CHECK-NEXT:    vid.v v6
; CHECK-NEXT:    vrsub.vi v10, v6, 15
; CHECK-NEXT:    vrgather.vv v2, v8, v10
; CHECK-NEXT:    vrsub.vi v6, v6, 7
; CHECK-NEXT:    li a0, 255
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vrgather.vv v2, v4, v6, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmv2r.v v4, v8
; CHECK-NEXT:    vrgather.vv v8, v4, v16
; CHECK-NEXT:    vid.v v4
; CHECK-NEXT:    vrsub.vi v4, v4, 15
; CHECK-NEXT:    lui a0, 16
; CHECK-NEXT:    addi a0, a0, -1
...
; CHECK-NEXT:    vrgather.vv v8, v12, v4, v0.t
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; CHECK-NEXT:    vid.v v1
; CHECK-NEXT:    vrsub.vi v5, v1, 7
; CHECK-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v2, v8, v5
; CHECK-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; CHECK-NEXT:    vrsub.vi v1, v1, 3
; CHECK-NEXT:    vmv.v.i v0, 15
; CHECK-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; CHECK-NEXT:    vrgatherei16.vv v2, v4, v1, v0.t
; CHECK-NEXT:    vmv.v.v v8, v2
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vid.v v2
; CHECK-NEXT:    vrsub.vi v6, v2, 15
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; CHECK-NEXT:    vrgatherei16.vv v8, v4, v6
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vrsub.vi v2, v2, 7
; CHECK-NEXT:    li a0, 255
; CHECK-NEXT:    vmv.s.x v0, a0
; CHECK-NEXT:    vsetvli zero, zero, e32, m4, ta, mu
; CHECK-NEXT:    vrgatherei16.vv v8, v12, v2, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; CHECK-NEXT:    vslidedown.vi v2, v8, 1
; CHECK-NEXT:    vslideup.vi v2, v8, 1
; CHECK-NEXT:    vslidedown.vi v8, v9, 1
; CHECK-NEXT:    vslideup.vi v8, v9, 1
...
; CHECK-NEXT:    vrgatherei16.vv v4, v12, v1, v0.t
; CHECK-NEXT:    vmv.v.v v8, v4
; CHECK-NEXT:    ret
