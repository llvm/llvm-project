...
define <4 x i16> @vwsubu_v4i16(ptr %x, ptr %y) {
...
define <2 x i32> @vwsubu_v2i32(ptr %x, ptr %y) {
...
define <8 x i16> @vwsubu_v8i16(ptr %x, ptr %y) {
...
define <4 x i32> @vwsubu_v4i32(ptr %x, ptr %y) {
...
define <2 x i64> @vwsubu_v2i64(ptr %x, ptr %y) {
...
define <16 x i16> @vwsubu_v16i16(ptr %x, ptr %y) {
...
define <8 x i32> @vwsubu_v8i32(ptr %x, ptr %y) {
...
define <4 x i64> @vwsubu_v4i64(ptr %x, ptr %y) {
...
define <32 x i16> @vwsubu_v32i16(ptr %x, ptr %y) {
...
define <16 x i32> @vwsubu_v16i32(ptr %x, ptr %y) {
...
define <8 x  i64> @vwsubu_v8i64(ptr %x, ptr %y) {
...
define <64 x i16> @vwsubu_v64i16(ptr %x, ptr %y) {
...
; CHECK-NEXT:    vwsubu.vv v8, v4, v16
; CHECK-NEXT:    ret
...
define <32 x i32> @vwsubu_v32i32(ptr %x, ptr %y) {
...
define <16 x i64> @vwsubu_v16i64(ptr %x, ptr %y) {
...
define <128 x i16> @vwsubu_v128i16(ptr %x, ptr %y) nounwind {
...
define <64 x i32> @vwsubu_v64i32(ptr %x, ptr %y) nounwind {
...
define <32 x i64> @vwsubu_v32i64(ptr %x, ptr %y) nounwind {
...
define <4 x i32> @vwsubu_v4i32_v4i8_v4i16(ptr %x, ptr %y) {
...
define <4 x i64> @vwsubu_v4i64_v4i32_v4i8(ptr %x, ptr %y) {
...
define <2 x i16> @vwsubu_vx_v2i16(ptr %x, i8 %y) {
; CHECK-LABEL: vwsubu_vx_v2i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vwsubu.vx v8, v1, a1
; CHECK-NEXT:    ret
  %a = load <2 x i8>, ptr %x
...
define <4 x i16> @vwsubu_vx_v4i16(ptr %x, i8 %y) {
...
define <2 x i32> @vwsubu_vx_v2i32(ptr %x, i16 %y) {
...
define <8 x i16> @vwsubu_vx_v8i16(ptr %x, i8 %y) {
...
define <4 x i32> @vwsubu_vx_v4i32(ptr %x, i16 %y) {
...
define <2 x i64> @vwsubu_vx_v2i64(ptr %x, i32 %y) {
...
define <16 x i16> @vwsubu_vx_v16i16(ptr %x, i8 %y) {
...
define <8 x i32> @vwsubu_vx_v8i32(ptr %x, i16 %y) {
...
define <4 x i64> @vwsubu_vx_v4i64(ptr %x, i32 %y) {
...
define <32 x i16> @vwsubu_vx_v32i16(ptr %x, i8 %y) {
; CHECK-LABEL: vwsubu_vx_v32i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    li a2, 32
; CHECK-NEXT:    vsetvli zero, a2, e8, m2, ta, ma
; CHECK-NEXT:    vle8.v v2, (a0)
; CHECK-NEXT:    vwsubu.vx v8, v2, a1
; CHECK-NEXT:    ret
  %a = load <32 x i8>, ptr %x
...
define <16 x i32> @vwsubu_vx_v16i32(ptr %x, i16 %y) {
...
define <8 x i64> @vwsubu_vx_v8i64(ptr %x, i32 %y) {
...
define <64 x i16> @vwsubu_vx_v64i16(ptr %x, i8 %y) {
; CHECK-LABEL: vwsubu_vx_v64i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    li a2, 64
; CHECK-NEXT:    vsetvli zero, a2, e8, m4, ta, ma
; CHECK-NEXT:    vle8.v v4, (a0)
; CHECK-NEXT:    vwsubu.vx v8, v4, a1
; CHECK-NEXT:    ret
  %a = load <64 x i8>, ptr %x
...
define <32 x i32> @vwsubu_vx_v32i32(ptr %x, i16 %y) {
...
define <16 x i64> @vwsubu_vx_v16i64(ptr %x, i32 %y) {
...
; CHECK-NEXT:    vsetivli zero, 8, e8, mf2, ta, ma
; CHECK-NEXT:    vle8.v v1, (a0)
; CHECK-NEXT:    vlse8.v v2, (a1), zero
; CHECK-NEXT:    vwsubu.vv v8, v2, v1
; CHECK-NEXT:    ret
  %a = load <8 x i8>, ptr %x
  %b = load i8, ptr %y
  %c = zext i8 %b to i16
...
; CHECK-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; CHECK-NEXT:    vle16.v v1, (a0)
; CHECK-NEXT:    vlse16.v v2, (a1), zero
; CHECK-NEXT:    vwsubu.vv v8, v2, v1
; CHECK-NEXT:    ret
  %a = load <4 x i16>, ptr %x
  %b = load i16, ptr %y
...
define <2 x i64> @vwsubu_vx_v2i64_i8(ptr %x, ptr %y) nounwind {
...
define <2 x i64> @vwsubu_vx_v2i64_i16(ptr %x, ptr %y) nounwind {
...
define <2 x i64> @vwsubu_vx_v2i64_i32(ptr %x, ptr %y) nounwind {
...
define <2 x i64> @vwsubu_vx_v2i64_i64(ptr %x, ptr %y) nounwind {
