...
; RV32-LABEL: vwsubu_vx_v8i16_i16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vwsubu_vx_v8i16_i16:
; RV64:       # %bb.0:
...
; RV32-LABEL: vwsubu_vx_v4i32_i32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vwsubu_vx_v4i32_i32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vslideup.vi v8, v9, 8
; RV64-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; RV64-NEXT:    vwsubu.wv v8, v8, v10
; RV64-NEXT:    ret
  %a = load <2 x i32>, ptr %x
  %b = load i8, ptr %y
  %c = zext i8 %b to i64
