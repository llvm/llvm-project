...
; RV32-LABEL: vwmulu_vx_v8i16_i16:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vwmulu_vx_v8i16_i16:
; RV64:       # %bb.0:
...
; RV32-LABEL: vwmulu_vx_v4i32_i32:
; RV32:       # %bb.0:
...
; RV32-NEXT:    ret
;
; RV64-LABEL: vwmulu_vx_v4i32_i32:
; RV64:       # %bb.0:
...
; RV64-NEXT:    vslideup.vi v10, v8, 8
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vzext.vf2 v8, v9
; RV64-NEXT:    vmul.vv v8, v10, v8
; RV64-NEXT:    ret
  %a = load <2 x i32>, ptr %x
  %b = load i8, ptr %y
  %c = zext i8 %b to i64
...
; RV64-NEXT:    vslideup.vi v10, v8, 4
; RV64-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV64-NEXT:    vzext.vf2 v8, v9
; RV64-NEXT:    vmul.vv v8, v10, v8
; RV64-NEXT:    ret
