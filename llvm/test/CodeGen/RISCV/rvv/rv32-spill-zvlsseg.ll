...
; SPILL-O2-VLEN128-NEXT:    vl1r.v v7, (a0) # vscale x 8-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    vl1r.v v7, (a0) # vscale x 8-byte Reload
...
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
; SPILL-O2-NEXT:    csrr a1, vlenb
...
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
; SPILL-O2-VSETVLI-NEXT:    csrr a1, vlenb
...
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    vl4r.v v4, (a0) # vscale x 32-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    vl4r.v v4, (a0) # vscale x 32-byte Reload
; SPILL-O2-VSETVLI-NEXT:    csrr a1, vlenb
...
; SPILL-O2-NEXT:    slli a1, a1, 2
; SPILL-O2-NEXT:    add a0, a0, a1
; SPILL-O2-NEXT:    vs2r.v v12, (a0) # vscale x 16-byte Spill
; SPILL-O2-NEXT:    #APP
; SPILL-O2-NEXT:    #NO_APP
; SPILL-O2-NEXT:    addi a0, sp, 16
; SPILL-O2-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
...
; SPILL-O2-VLEN128-NEXT:    li a1, 64
; SPILL-O2-VLEN128-NEXT:    add a0, a0, a1
; SPILL-O2-VLEN128-NEXT:    vs2r.v v12, (a0) # vscale x 16-byte Spill
; SPILL-O2-VLEN128-NEXT:    #APP
; SPILL-O2-VLEN128-NEXT:    #NO_APP
; SPILL-O2-VLEN128-NEXT:    addi a0, sp, 16
; SPILL-O2-VLEN128-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
...
; SPILL-O2-VSETVLI-NEXT:    slli a1, a1, 2
; SPILL-O2-VSETVLI-NEXT:    add a0, a0, a1
; SPILL-O2-VSETVLI-NEXT:    vs2r.v v12, (a0) # vscale x 16-byte Spill
; SPILL-O2-VSETVLI-NEXT:    #APP
; SPILL-O2-VSETVLI-NEXT:    #NO_APP
; SPILL-O2-VSETVLI-NEXT:    addi a0, sp, 16
; SPILL-O2-VSETVLI-NEXT:    vl2r.v v6, (a0) # vscale x 16-byte Reload
