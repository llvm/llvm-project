...
; SPILL-O0-NEXT:    # implicit-def: $v2m2
; SPILL-O0-NEXT:    # implicit-def: $v2m2
; SPILL-O0-NEXT:    # implicit-def: $v4m2
; SPILL-O0-NEXT:    # kill: def $v8m2 killed $v8m2 def $v8m2_v10m2
; SPILL-O0-NEXT:    vmv2r.v v10, v2
; SPILL-O0-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; SPILL-O0-NEXT:    vlseg2e32.v v8, (a0)
; SPILL-O0-NEXT:    vmv2r.v v2, v10
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vs2r.v v2, (a0) # Unknown-size Folded Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
...
; SPILL-O0-NEXT:    # implicit-def: $v4m4
; SPILL-O0-NEXT:    # implicit-def: $v4m4
; SPILL-O0-NEXT:    # implicit-def: $v12m4
; SPILL-O0-NEXT:    # kill: def $v8m4 killed $v8m4 def $v8m4_v12m4
; SPILL-O0-NEXT:    vmv4r.v v12, v4
; SPILL-O0-NEXT:    vsetvli zero, a1, e32, m4, ta, ma
; SPILL-O0-NEXT:    vlseg2e32.v v8, (a0)
; SPILL-O0-NEXT:    vmv4r.v v4, v12
; SPILL-O0-NEXT:    addi a0, sp, 16
; SPILL-O0-NEXT:    vs4r.v v4, (a0) # Unknown-size Folded Spill
; SPILL-O0-NEXT:    #APP
; SPILL-O0-NEXT:    #NO_APP
; SPILL-O0-NEXT:    addi a0, sp, 16
...
; SPILL-O0-NEXT:    # implicit-def: $v2m2
; SPILL-O0-NEXT:    # implicit-def: $v2m2
; SPILL-O0-NEXT:    # implicit-def: $v6m2
; SPILL-O0-NEXT:    # kill: def $v8m2 killed $v8m2 def $v8m2_v10m2_v12m2
; SPILL-O0-NEXT:    vmv2r.v v10, v4
; SPILL-O0-NEXT:    vmv2r.v v12, v2
; SPILL-O0-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
