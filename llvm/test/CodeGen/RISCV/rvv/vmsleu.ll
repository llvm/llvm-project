...
; CHECK-NEXT:    vmsleu.vv v1, v8, v9
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsleu.vv v2, v9, v10, v0.t
...
; CHECK-NEXT:    vmsleu.vv v1, v8, v10
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
...
; CHECK-NEXT:    vmsleu.vv v1, v8, v12
; CHECK-NEXT:    vmv1r.v v2, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    vmsleu.vv v2, v12, v16, v0.t
; CHECK-NEXT:    vmv1r.v v0, v2
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsleu.vv v1, v8, v2, v0.t
