...
; CHECK-NEXT:    vor.vv v1, v8, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 2, v0.t
...
; CHECK-NEXT:    vsrl.vi v2, v1, 4, v0.t
; CHECK-NEXT:    vor.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 8, v0.t
; CHECK-NEXT:    vor.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vnot.v v1, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 1, v0.t
; CHECK-NEXT:    lui a0, 5
...
; CHECK-NEXT:    vor.vv v2, v8, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 2, v0.t
; CHECK-NEXT:    vor.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 4, v0.t
; CHECK-NEXT:    vor.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 8, v0.t
; CHECK-NEXT:    vor.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vnot.v v2, v2, v0.t
...
; CHECK-NEXT:    vor.vv v2, v2, v4
; CHECK-NEXT:    vsrl.vi v4, v2, 8
; CHECK-NEXT:    vor.vv v2, v2, v4
; CHECK-NEXT:    vnot.v v2, v2
...
; CHECK-NEXT:    vsrl.vi v2, v1, 8, v0.t
; CHECK-NEXT:    vor.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 16, v0.t
; CHECK-NEXT:    vor.vv v1, v1, v2, v0.t
; CHECK-NEXT:    vnot.v v1, v1, v0.t
; CHECK-NEXT:    vsrl.vi v2, v1, 1, v0.t
...
; CHECK-NEXT:    vsrl.vi v4, v2, 8, v0.t
; CHECK-NEXT:    vor.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 16, v0.t
; CHECK-NEXT:    vor.vv v2, v2, v4, v0.t
; CHECK-NEXT:    vnot.v v2, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 1, v0.t
; CHECK-NEXT:    lui a0, 349525
...
; CHECK-NEXT:    vor.vv v4, v4, v8, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 16, v0.t
; CHECK-NEXT:    vor.vv v4, v4, v8, v0.t
...
; RV32-NEXT:    vor.vv v1, v8, v1, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 2, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 4, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 8, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 16, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v2, v1, a1, v0.t
; RV32-NEXT:    vor.vv v1, v1, v2, v0.t
; RV32-NEXT:    vnot.v v1, v1, v0.t
...
; RV64-NEXT:    vor.vv v1, v8, v1, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 2, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 4, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 8, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 16, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v2, v1, a0, v0.t
; RV64-NEXT:    vor.vv v1, v1, v2, v0.t
; RV64-NEXT:    vnot.v v1, v1, v0.t
...
; RV32-NEXT:    vor.vv v1, v1, v2
; RV32-NEXT:    vsrl.vi v2, v1, 16
; RV32-NEXT:    vor.vv v1, v1, v2
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v2, v1, a1
; RV32-NEXT:    vor.vv v1, v1, v2
; RV32-NEXT:    vnot.v v1, v1
...
; RV64-NEXT:    vor.vv v1, v1, v2
; RV64-NEXT:    vsrl.vi v2, v1, 16
; RV64-NEXT:    vor.vv v1, v1, v2
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v2, v1, a0
; RV64-NEXT:    vor.vv v1, v1, v2
; RV64-NEXT:    vnot.v v1, v1
...
; RV32-NEXT:    vor.vv v2, v8, v2, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 2, v0.t
; RV32-NEXT:    vor.vv v2, v2, v4, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 4, v0.t
; RV32-NEXT:    vor.vv v2, v2, v4, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 8, v0.t
; RV32-NEXT:    vor.vv v2, v2, v4, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 16, v0.t
; RV32-NEXT:    vor.vv v2, v2, v4, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v4, v2, a1, v0.t
; RV32-NEXT:    vor.vv v2, v2, v4, v0.t
; RV32-NEXT:    vnot.v v2, v2, v0.t
...
; RV64-NEXT:    vor.vv v2, v8, v2, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 2, v0.t
; RV64-NEXT:    vor.vv v2, v2, v4, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 4, v0.t
; RV64-NEXT:    vor.vv v2, v2, v4, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 8, v0.t
; RV64-NEXT:    vor.vv v2, v2, v4, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 16, v0.t
; RV64-NEXT:    vor.vv v2, v2, v4, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v4, v2, a0, v0.t
; RV64-NEXT:    vor.vv v2, v2, v4, v0.t
; RV64-NEXT:    vnot.v v2, v2, v0.t
...
; RV32-NEXT:    vor.vv v2, v8, v2
; RV32-NEXT:    vsrl.vi v4, v2, 2
; RV32-NEXT:    vor.vv v2, v2, v4
; RV32-NEXT:    vsrl.vi v4, v2, 4
; RV32-NEXT:    vor.vv v2, v2, v4
; RV32-NEXT:    vsrl.vi v4, v2, 8
; RV32-NEXT:    vor.vv v2, v2, v4
; RV32-NEXT:    vsrl.vi v4, v2, 16
; RV32-NEXT:    vor.vv v2, v2, v4
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v4, v2, a1
; RV32-NEXT:    vor.vv v2, v2, v4
; RV32-NEXT:    vnot.v v2, v2
...
; RV64-NEXT:    vor.vv v2, v8, v2
; RV64-NEXT:    vsrl.vi v4, v2, 2
; RV64-NEXT:    vor.vv v2, v2, v4
; RV64-NEXT:    vsrl.vi v4, v2, 4
; RV64-NEXT:    vor.vv v2, v2, v4
; RV64-NEXT:    vsrl.vi v4, v2, 8
; RV64-NEXT:    vor.vv v2, v2, v4
; RV64-NEXT:    vsrl.vi v4, v2, 16
; RV64-NEXT:    vor.vv v2, v2, v4
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v4, v2, a0
; RV64-NEXT:    vor.vv v2, v2, v4
; RV64-NEXT:    vnot.v v2, v2
...
; RV32-NEXT:    vor.vv v4, v8, v4, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 2, v0.t
; RV32-NEXT:    vor.vv v4, v4, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 4, v0.t
; RV32-NEXT:    vor.vv v4, v4, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 8, v0.t
; RV32-NEXT:    vor.vv v4, v4, v8, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 16, v0.t
; RV32-NEXT:    vor.vv v4, v4, v8, v0.t
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v4, a1, v0.t
; RV32-NEXT:    vor.vv v4, v4, v8, v0.t
; RV32-NEXT:    vnot.v v4, v4, v0.t
...
; RV64-NEXT:    vor.vv v4, v8, v4, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 2, v0.t
; RV64-NEXT:    vor.vv v4, v4, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 4, v0.t
; RV64-NEXT:    vor.vv v4, v4, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 8, v0.t
; RV64-NEXT:    vor.vv v4, v4, v8, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 16, v0.t
; RV64-NEXT:    vor.vv v4, v4, v8, v0.t
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v4, a0, v0.t
; RV64-NEXT:    vor.vv v4, v4, v8, v0.t
; RV64-NEXT:    vnot.v v4, v4, v0.t
...
; RV32-NEXT:    vor.vv v4, v4, v8
; RV32-NEXT:    vsrl.vi v8, v4, 4
; RV32-NEXT:    vor.vv v4, v4, v8
; RV32-NEXT:    vsrl.vi v8, v4, 8
; RV32-NEXT:    vor.vv v4, v4, v8
; RV32-NEXT:    vsrl.vi v8, v4, 16
; RV32-NEXT:    vor.vv v4, v4, v8
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v8, v4, a1
; RV32-NEXT:    vor.vv v4, v4, v8
; RV32-NEXT:    vnot.v v4, v4
...
; RV64-NEXT:    vor.vv v4, v4, v8
; RV64-NEXT:    vsrl.vi v8, v4, 4
; RV64-NEXT:    vor.vv v4, v4, v8
; RV64-NEXT:    vsrl.vi v8, v4, 8
; RV64-NEXT:    vor.vv v4, v4, v8
; RV64-NEXT:    vsrl.vi v8, v4, 16
; RV64-NEXT:    vor.vv v4, v4, v8
; RV64-NEXT:    li a0, 32
; RV64-NEXT:    vsrl.vx v8, v4, a0
; RV64-NEXT:    vor.vv v4, v4, v8
; RV64-NEXT:    vnot.v v4, v4
