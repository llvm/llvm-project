...
; RV32-NEXT:    add a4, sp, a4
; RV32-NEXT:    addi a4, a4, 16
; RV32-NEXT:    vs1r.v v6, (a4) # vscale x 8-byte Folded Spill
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vs1r.v v7, (a2) # vscale x 8-byte Folded Spill
; RV32-NEXT:    addi a2, sp, 16
...
; RV64-NEXT:    addi a7, a2, 1365
; RV64-NEXT:    addi a2, a3, 819
; RV64-NEXT:    addi a3, a4, -241
; RV64-NEXT:    addi a4, a5, 257
