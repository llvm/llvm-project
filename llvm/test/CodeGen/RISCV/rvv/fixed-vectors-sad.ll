...
; CHECK-NEXT:    vminu.vv v10, v12, v13
; CHECK-NEXT:    vmaxu.vv v12, v12, v13
; CHECK-NEXT:    vwaddu.vv v8, v9, v8
; CHECK-NEXT:    vsub.vv v10, v12, v10
; CHECK-NEXT:    vminu.vv v12, v15, v11
; CHECK-NEXT:    vmaxu.vv v13, v15, v11
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vzext.vf2 v10, v10
; CHECK-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; CHECK-NEXT:    vsub.vv v12, v13, v12
; CHECK-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; CHECK-NEXT:    vwaddu.vv v8, v10, v8
; CHECK-NEXT:    vzext.vf2 v12, v12
