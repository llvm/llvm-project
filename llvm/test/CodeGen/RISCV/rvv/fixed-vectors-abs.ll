...
; CHECK-NEXT:    vrsub.vi v2, v1, 0
; CHECK-NEXT:    vmax.vv v1, v1, v2
...
; LMULMAX2-NEXT:    vrsub.vi v4, v2, 0
; LMULMAX2-NEXT:    vmax.vv v2, v2, v4
...
; LMULMAX1-RV32-NEXT:    vle8.v v1, (a1)
; LMULMAX1-RV32-NEXT:    vle8.v v2, (a0)
; LMULMAX1-RV32-NEXT:    vrsub.vi v3, v1, 0
; LMULMAX1-RV32-NEXT:    vmax.vv v1, v1, v3
; LMULMAX1-RV32-NEXT:    vrsub.vi v3, v2, 0
; LMULMAX1-RV32-NEXT:    vmax.vv v2, v2, v3
; LMULMAX1-RV32-NEXT:    vse8.v v2, (a0)
; LMULMAX1-RV32-NEXT:    vse8.v v1, (a1)
...
; LMULMAX1-RV64-NEXT:    vle8.v v1, (a1)
; LMULMAX1-RV64-NEXT:    vle8.v v2, (a0)
; LMULMAX1-RV64-NEXT:    vrsub.vi v3, v1, 0
; LMULMAX1-RV64-NEXT:    vmax.vv v1, v1, v3
; LMULMAX1-RV64-NEXT:    vrsub.vi v3, v2, 0
; LMULMAX1-RV64-NEXT:    vmax.vv v2, v2, v3
; LMULMAX1-RV64-NEXT:    vse8.v v2, (a0)
; LMULMAX1-RV64-NEXT:    vse8.v v1, (a1)
...
; LMULMAX1-RV32-NEXT:    vse64.v v1, (a1)
; LMULMAX1-RV32-NEXT:    ret
;
