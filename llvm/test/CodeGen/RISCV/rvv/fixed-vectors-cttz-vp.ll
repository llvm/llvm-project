...
; RV32-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x1a, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 26 * vlenb
; RV32-NEXT:    csrr a1, vlenb
...
; RV32-NEXT:    vs1r.v v0, (a3) # vscale x 8-byte Folded Spill
...
; RV32-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vsrl.vi v24, v24, 4, v0.t
; RV32-NEXT:    addi a2, sp, 16
; RV32-NEXT:    vl8r.v v8, (a2) # vscale x 64-byte Folded Reload
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    li a3, 25
...
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vl1r.v v0, (a2) # vscale x 8-byte Folded Reload
; RV32-NEXT:    vadd.vv v24, v8, v24, v0.t
; RV32-NEXT:    csrr a2, vlenb
; RV32-NEXT:    slli a2, a2, 4
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
...
; RV32-NEXT:    vmv1r.v v0, v6
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vmul.vv v16, v8, v16, v0.t
; RV32-NEXT:    li a2, 56
; RV32-NEXT:    vmv1r.v v0, v7
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
...
; RV32-NEXT:    vmv1r.v v0, v6
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
; RV32-NEXT:    vsrl.vx v16, v16, a2, v0.t
...
; RV64-NEXT:    vmv1r.v v0, v7
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV64-NEXT:    vadd.vv v24, v24, v8, v0.t
; RV64-NEXT:    vmv1r.v v0, v6
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vmul.vx v8, v16, a3, v0.t
; RV64-NEXT:    vmv1r.v v0, v7
; RV64-NEXT:    vsetvli zero, a4, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vi v16, v24, 4, v0.t
; RV64-NEXT:    vmv1r.v v0, v6
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vsrl.vx v8, v8, a0, v0.t
; RV64-NEXT:    vmv1r.v v0, v7
