...
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Folded Spill
; RV32-NEXT:    vnot.v v24, v8
; RV32-NEXT:    lui a2, 349525
; RV32-NEXT:    addi a2, a2, 1365
; RV32-NEXT:    vsetvli a3, zero, e32, m8, ta, ma
; RV32-NEXT:    vmv.v.x v0, a2
; RV32-NEXT:    addi a2, sp, 16
; RV32-NEXT:    vs8r.v v0, (a2) # vscale x 64-byte Folded Spill
; RV32-NEXT:    addi a2, a0, -16
; RV32-NEXT:    sltu a0, a0, a2
; RV32-NEXT:    addi a0, a0, -1
; RV32-NEXT:    and a0, a0, a2
...
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vsrl.vi v8, v0, 4
; RV32-NEXT:    vadd.vv v0, v0, v8
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
