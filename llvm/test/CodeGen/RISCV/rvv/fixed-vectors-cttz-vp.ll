...
; CHECK-NEXT:    vsub.vx v1, v8, a1, v0.t
; CHECK-NEXT:    vnot.v v2, v8, v0.t
; CHECK-NEXT:    vand.vv v1, v2, v1, v0.t
...
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    vsetvli zero, a0, e8, mf8, ta, ma
; CHECK-NEXT:    vsub.vx v1, v8, a1
; CHECK-NEXT:    vnot.v v2, v8
; CHECK-NEXT:    vand.vv v1, v2, v1
...
; CHECK-NEXT:    vsub.vx v2, v8, a1, v0.t
; CHECK-NEXT:    vnot.v v4, v8, v0.t
; CHECK-NEXT:    vand.vv v2, v4, v2, v0.t
; CHECK-NEXT:    vsrl.vi v4, v2, 1, v0.t
; CHECK-NEXT:    lui a0, 5
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v4, v4, a0, v0.t
; CHECK-NEXT:    vsub.vv v2, v2, v4, v0.t
; CHECK-NEXT:    lui a0, 3
; CHECK-NEXT:    addi a0, a0, 819
...
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, ma
; CHECK-NEXT:    vsub.vx v2, v8, a1
; CHECK-NEXT:    vnot.v v4, v8
; CHECK-NEXT:    vand.vv v2, v4, v2
; CHECK-NEXT:    vsrl.vi v4, v2, 1
; CHECK-NEXT:    lui a0, 5
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v4, v4, a0
; CHECK-NEXT:    vsub.vv v2, v2, v4
; CHECK-NEXT:    lui a0, 3
; CHECK-NEXT:    addi a0, a0, 819
...
; CHECK-NEXT:    vsub.vx v4, v8, a1, v0.t
; CHECK-NEXT:    vnot.v v8, v8, v0.t
; CHECK-NEXT:    vand.vv v4, v8, v4, v0.t
; CHECK-NEXT:    vsrl.vi v8, v4, 1, v0.t
; CHECK-NEXT:    lui a0, 349525
; CHECK-NEXT:    addi a0, a0, 1365
; CHECK-NEXT:    vand.vx v8, v8, a0, v0.t
; CHECK-NEXT:    vsub.vv v4, v4, v8, v0.t
; CHECK-NEXT:    lui a0, 209715
; CHECK-NEXT:    addi a0, a0, 819
...
; CHECK-NEXT:    li a1, 1
; CHECK-NEXT:    vsetvli zero, a0, e32, m4, ta, ma
; CHECK-NEXT:    vsub.vx v4, v8, a1
; CHECK-NEXT:    vnot.v v8, v8
; CHECK-NEXT:    vand.vv v4, v8, v4
...
; RV32-NEXT:    vsub.vx v1, v8, a1, v0.t
; RV32-NEXT:    vnot.v v2, v8, v0.t
; RV32-NEXT:    vand.vv v1, v2, v1, v0.t
; RV32-NEXT:    vsrl.vi v2, v1, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; RV32-NEXT:    vmv.v.x v3, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vand.vv v2, v2, v3, v0.t
; RV32-NEXT:    vsub.vv v1, v1, v2, v0.t
...
; RV64-NEXT:    vsub.vx v1, v8, a1, v0.t
; RV64-NEXT:    vnot.v v2, v8, v0.t
; RV64-NEXT:    vand.vv v1, v2, v1, v0.t
; RV64-NEXT:    vsrl.vi v2, v1, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v2, v2, a0, v0.t
; RV64-NEXT:    vsub.vv v1, v1, v2, v0.t
...
; RV32-NEXT:    li a1, 1
; RV32-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV32-NEXT:    vsub.vx v1, v8, a1
; RV32-NEXT:    vnot.v v2, v8
; RV32-NEXT:    vand.vv v1, v2, v1
...
; RV64-NEXT:    li a1, 1
; RV64-NEXT:    vsetvli zero, a0, e64, m1, ta, ma
; RV64-NEXT:    vsub.vx v1, v8, a1
; RV64-NEXT:    vnot.v v2, v8
; RV64-NEXT:    vand.vv v1, v2, v1
...
; RV32-NEXT:    vsub.vx v2, v8, a1, v0.t
; RV32-NEXT:    vnot.v v4, v8, v0.t
; RV32-NEXT:    vand.vv v2, v4, v2, v0.t
; RV32-NEXT:    vsrl.vi v4, v2, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
; RV32-NEXT:    vmv.v.x v6, a1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vand.vv v4, v4, v6, v0.t
; RV32-NEXT:    vsub.vv v2, v2, v4, v0.t
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m2, ta, ma
...
; RV64-NEXT:    vsub.vx v2, v8, a1, v0.t
; RV64-NEXT:    vnot.v v4, v8, v0.t
; RV64-NEXT:    vand.vv v2, v4, v2, v0.t
; RV64-NEXT:    vsrl.vi v4, v2, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v4, v4, a0, v0.t
; RV64-NEXT:    vsub.vv v2, v2, v4, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV32-NEXT:    li a1, 1
; RV32-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV32-NEXT:    vsub.vx v2, v8, a1
; RV32-NEXT:    vnot.v v4, v8
; RV32-NEXT:    vand.vv v2, v4, v2
...
; RV64-NEXT:    li a1, 1
; RV64-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; RV64-NEXT:    vsub.vx v2, v8, a1
; RV64-NEXT:    vnot.v v4, v8
; RV64-NEXT:    vand.vv v2, v4, v2
...
; RV32-NEXT:    vsub.vx v4, v8, a1, v0.t
; RV32-NEXT:    vnot.v v8, v8, v0.t
; RV32-NEXT:    vand.vv v4, v8, v4, v0.t
; RV32-NEXT:    vsrl.vi v8, v4, 1, v0.t
; RV32-NEXT:    lui a1, 349525
; RV32-NEXT:    addi a1, a1, 1365
...
; RV32-NEXT:    vsub.vv v4, v4, v8, v0.t
; RV32-NEXT:    lui a1, 209715
; RV32-NEXT:    addi a1, a1, 819
; RV32-NEXT:    vsetvli a2, zero, e32, m4, ta, ma
...
; RV64-NEXT:    vsub.vx v4, v8, a1, v0.t
; RV64-NEXT:    vnot.v v8, v8, v0.t
; RV64-NEXT:    vand.vv v4, v8, v4, v0.t
; RV64-NEXT:    vsrl.vi v8, v4, 1, v0.t
; RV64-NEXT:    lui a0, 349525
; RV64-NEXT:    addiw a0, a0, 1365
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vand.vx v8, v8, a0, v0.t
; RV64-NEXT:    vsub.vv v4, v4, v8, v0.t
; RV64-NEXT:    lui a0, 209715
; RV64-NEXT:    addiw a0, a0, 819
; RV64-NEXT:    slli a1, a0, 32
; RV64-NEXT:    add a0, a0, a1
...
; RV64-NEXT:    li a1, 1
; RV64-NEXT:    vsetvli zero, a0, e64, m4, ta, ma
; RV64-NEXT:    vsub.vx v4, v8, a1
; RV64-NEXT:    vnot.v v8, v8
; RV64-NEXT:    vand.vv v4, v8, v4
