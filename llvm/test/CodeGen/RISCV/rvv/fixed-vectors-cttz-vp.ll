...
; RV32-NEXT:    vs8r.v v16, (a1) # vscale x 64-byte Spill
; RV32-NEXT:    li a2, 16
...
; RV32-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Spill
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vs8r.v v16, (a2) # vscale x 64-byte Spill
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vs8r.v v8, (a2) # vscale x 64-byte Spill
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vl8r.v v8, (a2) # vscale x 64-byte Reload
; RV32-NEXT:    vsetvli zero, a0, e64, m8, ta, ma
...
; RV32-NEXT:    add a2, sp, a2
; RV32-NEXT:    addi a2, a2, 16
; RV32-NEXT:    vl8r.v v0, (a2) # vscale x 64-byte Reload
