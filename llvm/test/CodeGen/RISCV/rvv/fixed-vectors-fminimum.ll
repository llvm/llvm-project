...
; ZVFHMIN-NEXT:    vfmin.vv v1, v1, v4
...
; ZVFHMIN-NEXT:    vfmin.vv v2, v2, v6
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; ZVFH-NEXT:    vfadd.vv v2, v8, v8
; ZVFH-NEXT:    vmfeq.vv v0, v9, v9
; ZVFH-NEXT:    vmfeq.vv v1, v2, v2
; ZVFH-NEXT:    vmerge.vvm v3, v9, v2, v0
; ZVFH-NEXT:    vmv1r.v v0, v1
; ZVFH-NEXT:    vmerge.vvm v1, v2, v9, v0
; ZVFH-NEXT:    vfmin.vv v8, v3, v1
; ZVFH-NEXT:    ret
;
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetivli zero, 2, e16, mf4, ta, ma
; ZVFH-NEXT:    vfadd.vv v2, v9, v9
; ZVFH-NEXT:    vmfeq.vv v0, v8, v8
; ZVFH-NEXT:    vmfeq.vv v1, v2, v2
; ZVFH-NEXT:    vmerge.vvm v3, v8, v2, v0
; ZVFH-NEXT:    vmv1r.v v0, v1
; ZVFH-NEXT:    vmerge.vvm v1, v2, v8, v0
; ZVFH-NEXT:    vfmin.vv v8, v1, v3
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vmv1r.v v0, v1
; ZVFHMIN-NEXT:    vmerge.vvm v1, v4, v3, v0
; ZVFHMIN-NEXT:    vfmin.vv v1, v1, v2
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
