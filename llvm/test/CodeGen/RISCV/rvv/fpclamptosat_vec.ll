...
; CHECK-NOV-NEXT:    sd ra, 56(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s0, 48(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s1, 40(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s2, 32(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s3, 24(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs0, 16(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs1, 8(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs2, 0(sp) # 8-byte Spill
...
; CHECK-NOV-NEXT:    ld ra, 56(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s0, 48(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s1, 40(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s2, 32(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s3, 24(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs0, 16(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs1, 8(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs2, 0(sp) # 8-byte Reload
...
; CHECK-V-NEXT:    sd ra, 40(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s0, 32(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s1, 24(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s2, 16(sp) # 8-byte Spill
...
; CHECK-V-NEXT:    vs1r.v v8, (a0) # vscale x 8-byte Spill
; CHECK-V-NEXT:    call __extendhfsf2
; CHECK-V-NEXT:    fcvt.l.s a0, fa0, rtz
; CHECK-V-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; CHECK-V-NEXT:    vmv.s.x v8, a0
; CHECK-V-NEXT:    addi a0, sp, 16
; CHECK-V-NEXT:    vl1r.v v9, (a0) # vscale x 8-byte Reload
; CHECK-V-NEXT:    vslideup.vi v8, v9, 1
; CHECK-V-NEXT:    csrr a0, vlenb
; CHECK-V-NEXT:    add a0, sp, a0
; CHECK-V-NEXT:    addi a0, a0, 16
; CHECK-V-NEXT:    vs2r.v v8, (a0) # vscale x 16-byte Spill
...
; CHECK-V-NEXT:    addi a0, sp, 16
; CHECK-V-NEXT:    vl1r.v v8, (a0) # vscale x 8-byte Reload
; CHECK-V-NEXT:    vslideup.vi v10, v8, 1
; CHECK-V-NEXT:    csrr a0, vlenb
; CHECK-V-NEXT:    add a0, sp, a0
; CHECK-V-NEXT:    addi a0, a0, 16
; CHECK-V-NEXT:    vl2r.v v8, (a0) # vscale x 16-byte Reload
...
; CHECK-V-NEXT:    ld ra, 40(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s0, 32(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s1, 24(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s2, 16(sp) # 8-byte Reload
...
; CHECK-V-NEXT:    add a0, sp, a0
; CHECK-V-NEXT:    addi a0, a0, 16
; CHECK-V-NEXT:    vl2r.v v10, (a0) # vscale x 16-byte Reload
; CHECK-V-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
...
; CHECK-NOV-NEXT:    sd ra, 120(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s0, 112(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s1, 104(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s2, 96(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s3, 88(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s4, 80(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s5, 72(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s6, 64(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s7, 56(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs0, 48(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs1, 40(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs2, 32(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs3, 24(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs4, 16(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs5, 8(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs6, 0(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    .cfi_offset ra, -8
; CHECK-NOV-NEXT:    .cfi_offset s0, -16
; CHECK-NOV-NEXT:    .cfi_offset s1, -24
; CHECK-NOV-NEXT:    .cfi_offset s2, -32
...
; CHECK-NOV-NEXT:    ld ra, 120(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s0, 112(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s1, 104(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s2, 96(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s3, 88(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s4, 80(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s5, 72(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s6, 64(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s7, 56(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs0, 48(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs1, 40(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs2, 32(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs3, 24(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs4, 16(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs5, 8(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs6, 0(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    .cfi_restore ra
; CHECK-NOV-NEXT:    .cfi_restore s0
; CHECK-NOV-NEXT:    .cfi_restore s1
; CHECK-NOV-NEXT:    .cfi_restore s2
...
; CHECK-V-NEXT:    sd ra, 72(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s0, 64(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s1, 56(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s2, 48(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s3, 40(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s4, 32(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s5, 24(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s6, 16(sp) # 8-byte Spill
; CHECK-V-NEXT:    .cfi_offset ra, -8
; CHECK-V-NEXT:    .cfi_offset s0, -16
; CHECK-V-NEXT:    .cfi_offset s1, -24
; CHECK-V-NEXT:    .cfi_offset s2, -32
...
; CHECK-V-NEXT:    ld ra, 72(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s0, 64(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s1, 56(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s2, 48(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s3, 40(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s4, 32(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s5, 24(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s6, 16(sp) # 8-byte Reload
; CHECK-V-NEXT:    .cfi_restore ra
; CHECK-V-NEXT:    .cfi_restore s0
; CHECK-V-NEXT:    .cfi_restore s1
; CHECK-V-NEXT:    .cfi_restore s2
...
; CHECK-NOV-NEXT:    sd ra, 24(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s0, 16(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s1, 8(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    fsd fs0, 0(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    .cfi_offset ra, -8
; CHECK-NOV-NEXT:    .cfi_offset s0, -16
; CHECK-NOV-NEXT:    .cfi_offset s1, -24
...
; CHECK-NOV-NEXT:    mv a1, a2
; CHECK-NOV-NEXT:    ld ra, 24(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s0, 16(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s1, 8(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    fld fs0, 0(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    .cfi_restore ra
; CHECK-NOV-NEXT:    .cfi_restore s0
; CHECK-NOV-NEXT:    .cfi_restore s1
; CHECK-NOV-NEXT:    .cfi_restore fs0
...
; CHECK-V-NEXT:    sd ra, 56(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s0, 48(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s1, 40(sp) # 8-byte Spill
; CHECK-V-NEXT:    .cfi_offset ra, -8
; CHECK-V-NEXT:    .cfi_offset s0, -16
; CHECK-V-NEXT:    .cfi_offset s1, -24
; CHECK-V-NEXT:    csrr a0, vlenb
...
; CHECK-V-NEXT:    fld fa0, 32(sp) # 8-byte Reload
; CHECK-V-NEXT:    call __fixdfti
...
; CHECK-V-NEXT:    ld ra, 56(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s0, 48(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s1, 40(sp) # 8-byte Reload
; CHECK-V-NEXT:    .cfi_restore ra
; CHECK-V-NEXT:    .cfi_restore s0
; CHECK-V-NEXT:    .cfi_restore s1
; CHECK-V-NEXT:    addi sp, sp, 64
...
; CHECK-V-NEXT:    mv s0, a0
; CHECK-V-NEXT:    mv s1, a1
; CHECK-V-NEXT:    flw fa0, 32(sp) # 8-byte Reload
; CHECK-V-NEXT:    call __fixsfti
; CHECK-V-NEXT:    li a2, -1
; CHECK-V-NEXT:    srli a3, a2, 1
...
; CHECK-NOV-NEXT:    sd s0, 16(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s1, 8(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    sd s2, 0(sp) # 8-byte Spill
; CHECK-NOV-NEXT:    .cfi_offset ra, -8
; CHECK-NOV-NEXT:    .cfi_offset s0, -16
; CHECK-NOV-NEXT:    .cfi_offset s1, -24
; CHECK-NOV-NEXT:    .cfi_offset s2, -32
...
; CHECK-NOV-NEXT:    ld s0, 16(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s1, 8(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    ld s2, 0(sp) # 8-byte Reload
; CHECK-NOV-NEXT:    .cfi_restore ra
; CHECK-NOV-NEXT:    .cfi_restore s0
; CHECK-NOV-NEXT:    .cfi_restore s1
; CHECK-NOV-NEXT:    .cfi_restore s2
...
; CHECK-V-NEXT:    sd ra, 24(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s0, 16(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s1, 8(sp) # 8-byte Spill
; CHECK-V-NEXT:    sd s2, 0(sp) # 8-byte Spill
; CHECK-V-NEXT:    .cfi_offset ra, -8
; CHECK-V-NEXT:    .cfi_offset s0, -16
; CHECK-V-NEXT:    .cfi_offset s1, -24
; CHECK-V-NEXT:    .cfi_offset s2, -32
...
; CHECK-V-NEXT:    vslideup.vi v8, v9, 1
; CHECK-V-NEXT:    ld ra, 24(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s0, 16(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s1, 8(sp) # 8-byte Reload
; CHECK-V-NEXT:    ld s2, 0(sp) # 8-byte Reload
; CHECK-V-NEXT:    .cfi_restore ra
; CHECK-V-NEXT:    .cfi_restore s0
; CHECK-V-NEXT:    .cfi_restore s1
; CHECK-V-NEXT:    .cfi_restore s2
