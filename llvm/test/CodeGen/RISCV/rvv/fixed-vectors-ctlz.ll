...
; LMULMAX8-NEXT:    vrsub.vx v1, v1, a1
; LMULMAX8-NEXT:    li a1, 8
; LMULMAX8-NEXT:    vminu.vx v1, v1, a1
...
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 2
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 4
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 8
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
...
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 2
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 4
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 8
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
...
; LMULMAX1-NEXT:    vor.vv v1, v1, v2
; LMULMAX1-NEXT:    vsrl.vi v2, v1, 2
; LMULMAX1-NEXT:    vor.vv v1, v1, v2
; LMULMAX1-NEXT:    vsrl.vi v2, v1, 4
; LMULMAX1-NEXT:    vor.vv v1, v1, v2
; LMULMAX1-NEXT:    vsrl.vi v2, v1, 8
; LMULMAX1-NEXT:    vor.vv v1, v1, v2
...
; LMULMAX2-RV32F-NEXT:    vrsub.vx v1, v1, a1
; LMULMAX2-RV32F-NEXT:    li a1, 16
; LMULMAX2-RV32F-NEXT:    vminu.vx v1, v1, a1
...
; LMULMAX2-RV64F-NEXT:    vrsub.vx v1, v1, a1
; LMULMAX2-RV64F-NEXT:    li a1, 16
; LMULMAX2-RV64F-NEXT:    vminu.vx v1, v1, a1
...
; LMULMAX2-RV32D-NEXT:    vrsub.vx v1, v1, a1
; LMULMAX2-RV32D-NEXT:    li a1, 16
; LMULMAX2-RV32D-NEXT:    vminu.vx v1, v1, a1
...
; LMULMAX2-RV64D-NEXT:    vrsub.vx v1, v1, a1
; LMULMAX2-RV64D-NEXT:    li a1, 16
; LMULMAX2-RV64D-NEXT:    vminu.vx v1, v1, a1
...
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 8
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 16
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vnot.v v1, v1
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 1
...
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 8
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 16
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vnot.v v1, v1
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 1
...
; LMULMAX2-RV32I-NEXT:    vsrl.vx v2, v1, a1
; LMULMAX2-RV32I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV32I-NEXT:    vnot.v v1, v1
; LMULMAX2-RV32I-NEXT:    vsrl.vi v2, v1, 1
; LMULMAX2-RV32I-NEXT:    lui a1, 349525
...
; LMULMAX2-RV64I-NEXT:    vsrl.vx v2, v1, a1
; LMULMAX2-RV64I-NEXT:    vor.vv v1, v1, v2
; LMULMAX2-RV64I-NEXT:    vnot.v v1, v1
; LMULMAX2-RV64I-NEXT:    vsrl.vi v2, v1, 1
; LMULMAX2-RV64I-NEXT:    lui a1, 349525
...
; LMULMAX2-RV32F-NEXT:    vmv.v.x v2, a1
; LMULMAX2-RV32F-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; LMULMAX2-RV32F-NEXT:    vwsubu.wv v2, v2, v1
; LMULMAX2-RV32F-NEXT:    li a1, 64
; LMULMAX2-RV32F-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; LMULMAX2-RV32F-NEXT:    vminu.vx v1, v2, a1
...
; LMULMAX2-RV64F-NEXT:    vmv.v.x v2, a1
; LMULMAX2-RV64F-NEXT:    vwsubu.vv v3, v2, v1
; LMULMAX2-RV64F-NEXT:    li a1, 64
; LMULMAX2-RV64F-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; LMULMAX2-RV64F-NEXT:    vminu.vx v1, v3, a1
...
; LMULMAX2-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-NEXT:    vsrl.vi v4, v2, 2
; LMULMAX2-NEXT:    vor.vv v2, v2, v4
...
; LMULMAX1-NEXT:    vor.vv v1, v1, v3
; LMULMAX1-NEXT:    vsrl.vi v3, v1, 2
; LMULMAX1-NEXT:    vor.vv v1, v1, v3
...
; LMULMAX1-NEXT:    vor.vv v2, v2, v3
; LMULMAX1-NEXT:    vsrl.vi v3, v2, 2
; LMULMAX1-NEXT:    vor.vv v2, v2, v3
...
; LMULMAX8-NEXT:    li a1, 134
; LMULMAX8-NEXT:    vrsub.vx v2, v2, a1
; LMULMAX8-NEXT:    li a1, 8
; LMULMAX8-NEXT:    vminu.vx v2, v2, a1
...
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    vsrl.vi v4, v2, 2
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    vsrl.vi v4, v2, 4
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    vsrl.vi v4, v2, 8
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    vsrl.vi v4, v2, 16
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
...
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    vsrl.vi v4, v2, 2
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    vsrl.vi v4, v2, 4
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    vsrl.vi v4, v2, 8
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    vsrl.vi v4, v2, 16
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
...
; LMULMAX2-RV32F-NEXT:    li a1, 158
; LMULMAX2-RV32F-NEXT:    vrsub.vx v2, v2, a1
; LMULMAX2-RV32F-NEXT:    li a1, 32
; LMULMAX2-RV32F-NEXT:    vminu.vx v2, v2, a1
...
; LMULMAX2-RV64F-NEXT:    li a1, 158
; LMULMAX2-RV64F-NEXT:    vrsub.vx v2, v2, a1
; LMULMAX2-RV64F-NEXT:    li a1, 32
; LMULMAX2-RV64F-NEXT:    vminu.vx v2, v2, a1
...
; LMULMAX2-RV32D-NEXT:    vrsub.vx v2, v2, a1
; LMULMAX2-RV32D-NEXT:    li a1, 32
; LMULMAX2-RV32D-NEXT:    vminu.vx v2, v2, a1
...
; LMULMAX2-RV64D-NEXT:    vrsub.vx v2, v2, a1
; LMULMAX2-RV64D-NEXT:    li a1, 32
; LMULMAX2-RV64D-NEXT:    vminu.vx v2, v2, a1
...
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    li a1, 32
; LMULMAX2-RV32I-NEXT:    vsrl.vx v4, v2, a1
; LMULMAX2-RV32I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV32I-NEXT:    vnot.v v2, v2
; LMULMAX2-RV32I-NEXT:    vsrl.vi v4, v2, 1
; LMULMAX2-RV32I-NEXT:    lui a1, 349525
...
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    li a1, 32
; LMULMAX2-RV64I-NEXT:    vsrl.vx v4, v2, a1
; LMULMAX2-RV64I-NEXT:    vor.vv v2, v2, v4
; LMULMAX2-RV64I-NEXT:    vnot.v v2, v2
; LMULMAX2-RV64I-NEXT:    vsrl.vi v4, v2, 1
; LMULMAX2-RV64I-NEXT:    lui a1, 349525
...
; LMULMAX2-RV64F-NEXT:    li a1, 190
; LMULMAX2-RV64F-NEXT:    vmv.v.x v2, a1
; LMULMAX2-RV64F-NEXT:    vwsubu.vv v4, v2, v1
; LMULMAX2-RV64F-NEXT:    li a1, 64
; LMULMAX2-RV64F-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; LMULMAX2-RV64F-NEXT:    vminu.vx v2, v4, a1
...
; LMULMAX2-RV64F-NEXT:    vmv.v.x v2, a1
; LMULMAX2-RV64F-NEXT:    vwsubu.vv v3, v2, v1
; LMULMAX2-RV64F-NEXT:    vse64.v v3, (a0)
; LMULMAX2-RV64F-NEXT:    ret
;
...
; LMULMAX2-RV64F-NEXT:    vmv.v.x v2, a1
; LMULMAX2-RV64F-NEXT:    vwsubu.vv v4, v2, v1
; LMULMAX2-RV64F-NEXT:    vse64.v v4, (a0)
; LMULMAX2-RV64F-NEXT:    ret
;
