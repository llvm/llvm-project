...
; CHECK-NEXT:    vwaddu.vv v1, v9, v8
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    vwmaccu.vx v1, a0, v8
; CHECK-NEXT:    vmv1r.v v8, v1
; CHECK-NEXT:    ret
...
; V128:       # %bb.0:
; V128-NEXT:    vmv1r.v v4, v9
; V128-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; V128-NEXT:    vid.v v1
; V128-NEXT:    vsrl.vi v1, v1, 1
; V128-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; V128-NEXT:    vrgatherei16.vv v2, v8, v1
; V128-NEXT:    vsetivli zero, 1, e8, mf8, ta, ma
; V128-NEXT:    vmv.v.i v0, 10
; V128-NEXT:    vsetivli zero, 4, e64, m2, ta, mu
; V128-NEXT:    vrgatherei16.vv v2, v4, v1, v0.t
; V128-NEXT:    vmv.v.v v8, v2
; V128-NEXT:    ret
;
; RV32-V512-LABEL: interleave_v2i64:
; RV32-V512:       # %bb.0:
; RV32-V512-NEXT:    vsetivli zero, 4, e16, mf4, ta, ma
; RV32-V512-NEXT:    vid.v v1
; RV32-V512-NEXT:    vsrl.vi v2, v1, 1
; RV32-V512-NEXT:    vsetvli zero, zero, e64, m1, ta, mu
; RV32-V512-NEXT:    vmv.v.i v0, 10
; RV32-V512-NEXT:    vrgatherei16.vv v1, v8, v2
; RV32-V512-NEXT:    vrgatherei16.vv v1, v9, v2, v0.t
; RV32-V512-NEXT:    vmv.v.v v8, v1
; RV32-V512-NEXT:    ret
;
; RV64-V512-LABEL: interleave_v2i64:
; RV64-V512:       # %bb.0:
; RV64-V512-NEXT:    vsetivli zero, 4, e64, m1, ta, mu
; RV64-V512-NEXT:    vid.v v1
; RV64-V512-NEXT:    vsrl.vi v2, v1, 1
; RV64-V512-NEXT:    vmv.v.i v0, 10
; RV64-V512-NEXT:    vrgather.vv v1, v8, v2
; RV64-V512-NEXT:    vrgather.vv v1, v9, v2, v0.t
; RV64-V512-NEXT:    vmv.v.v v8, v1
; RV64-V512-NEXT:    ret
...
; V128-NEXT:    vwaddu.vv v1, v9, v8
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v1, a0, v8
; V128-NEXT:    vmv1r.v v8, v1
; V128-NEXT:    ret
;
; V512-LABEL: interleave_v4i8:
; V512:       # %bb.0:
; V512-NEXT:    vsetivli zero, 4, e8, mf8, ta, ma
; V512-NEXT:    vwaddu.vv v1, v9, v8
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v1, a0, v8
; V512-NEXT:    vmv1r.v v8, v1
; V512-NEXT:    ret
...
; V128:       # %bb.0:
; V128-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; V128-NEXT:    vwaddu.vv v1, v8, v9
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v1, a0, v9
; V128-NEXT:    vmv1r.v v8, v1
; V128-NEXT:    ret
;
...
; V512-NEXT:    vwaddu.vv v1, v8, v9
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v1, a0, v9
; V512-NEXT:    vmv1r.v v8, v1
; V512-NEXT:    ret
...
; V128-NEXT:    vwaddu.vv v2, v8, v9
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v2, a0, v9
; V128-NEXT:    vmv2r.v v8, v2
; V128-NEXT:    ret
;
...
; V128-NEXT:    vslidedown.vi v2, v9, 2
; V128-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; V128-NEXT:    vwaddu.vv v1, v8, v2
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v1, a0, v2
; V128-NEXT:    vmv1r.v v8, v1
; V128-NEXT:    ret
;
...
; V512-NEXT:    vslidedown.vi v2, v9, 2
; V512-NEXT:    vwaddu.vv v1, v8, v2
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v1, a0, v2
; V512-NEXT:    vmv1r.v v8, v1
; V512-NEXT:    ret
...
; V128-NEXT:    vid.v v1
; V128-NEXT:    vsrl.vi v2, v1, 1
; V128-NEXT:    vrgather.vv v1, v8, v2
; V128-NEXT:    vmv.v.i v0, 10
; V128-NEXT:    vadd.vi v2, v2, 1
; V128-NEXT:    vrgather.vv v1, v9, v2, v0.t
; V128-NEXT:    vmv.v.v v8, v1
; V128-NEXT:    ret
;
...
; V512-NEXT:    vid.v v1
; V512-NEXT:    vsrl.vi v2, v1, 1
; V512-NEXT:    vrgather.vv v1, v8, v2
; V512-NEXT:    vmv.v.i v0, 10
; V512-NEXT:    vadd.vi v2, v2, 1
; V512-NEXT:    vrgather.vv v1, v9, v2, v0.t
; V512-NEXT:    vmv1r.v v8, v1
; V512-NEXT:    ret
...
; V128-NEXT:    vwaddu.vv v2, v9, v8
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v2, a0, v8
; V128-NEXT:    vmv2r.v v8, v2
; V128-NEXT:    ret
;
...
; V128-NEXT:    vwaddu.vv v4, v8, v10
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v4, a0, v10
; V128-NEXT:    vmv4r.v v8, v4
; V128-NEXT:    ret
;
...
; V512-NEXT:    vwaddu.vv v2, v8, v9
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v2, a0, v9
; V512-NEXT:    vmv2r.v v8, v2
; V512-NEXT:    ret
...
; V128-NEXT:    vrgatherei16.vv v24, v16, v4, v0.t
; V128-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
...
; V512-NEXT:    vwaddu.vv v4, v8, v10
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v4, a0, v10
; V512-NEXT:    vmv4r.v v8, v4
; V512-NEXT:    ret
...
; V128-NEXT:    vslidedown.vi v2, v8, 2
...
; V512-NEXT:    vslidedown.vi v2, v8, 2
; V512-NEXT:    vwaddu.vv v1, v8, v2
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v1, a0, v2
; V512-NEXT:    vmv1r.v v8, v1
...
; V128-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V128-NEXT:    vmv.s.x v1, a0
; V128-NEXT:    vsetvli zero, zero, e16, mf2, ta, ma
; V128-NEXT:    vsext.vf2 v4, v1
; V128-NEXT:    vsetvli zero, zero, e64, m2, ta, ma
; V128-NEXT:    vrgatherei16.vv v2, v8, v4
; V128-NEXT:    vmv.v.v v8, v2
; V128-NEXT:    ret
;
...
; RV32-V512-NEXT:    vmv.s.x v1, a0
; RV32-V512-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; RV32-V512-NEXT:    vsext.vf2 v2, v1
...
; RV64-V512-NEXT:    vmv.s.x v1, a0
; RV64-V512-NEXT:    vsext.vf8 v2, v1
; RV64-V512-NEXT:    vrgather.vv v1, v8, v2
; RV64-V512-NEXT:    vmv.v.v v8, v1
; RV64-V512-NEXT:    ret
...
; V128-NEXT:    vslidedown.vi v2, v8, 4
; V128-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; V128-NEXT:    vwaddu.vv v1, v8, v2
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v1, a0, v2
...
; V512:       # %bb.0:
; V512-NEXT:    vsetivli zero, 4, e8, mf8, ta, ma
; V512-NEXT:    vslidedown.vi v2, v8, 4
; V512-NEXT:    vwaddu.vv v1, v8, v2
; V512-NEXT:    li a0, -1
; V512-NEXT:    vwmaccu.vx v1, a0, v2
; V512-NEXT:    vmv1r.v v8, v1
...
; V128-NEXT:    vslidedown.vi v4, v8, 4
; V128-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V128-NEXT:    vwaddu.vv v2, v8, v4
; V128-NEXT:    li a0, -1
; V128-NEXT:    vwmaccu.vx v2, a0, v4
; V128-NEXT:    vmv2r.v v8, v2
; V128-NEXT:    ret
;
