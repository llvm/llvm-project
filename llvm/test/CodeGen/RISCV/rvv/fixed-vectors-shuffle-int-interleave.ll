...
; V128-NEXT:    vmv.v.i v14, 10
; V128-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; V128-NEXT:    vslideup.vi v10, v8, 1
; V128-NEXT:    vmv1r.v v0, v14
...
; V128-NEXT:    vmv1r.v v0, v9
; V128-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; V128-NEXT:    vmerge.vvm v8, v10, v11, v0
; V128-NEXT:    ret
;
...
; V512-NEXT:    vmv1r.v v0, v9
; V512-NEXT:    vsetivli zero, 4, e32, mf2, ta, ma
; V512-NEXT:    vmerge.vvm v8, v10, v11, v0
; V512-NEXT:    ret
;
...
; ZVZIP-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; ZVZIP-NEXT:    vmerge.vvm v8, v12, v11, v0
; ZVZIP-NEXT:    ret
