...
; ZIP-NEXT:    slli a1, a0, 4
; ZIP-NEXT:    add a0, a1, a0
; ZIP-NEXT:    sub sp, sp, a0
; ZIP-NEXT:    .cfi_escape 0x0f, 0x0d, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x11, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 17 * vlenb
; ZIP-NEXT:    csrr a0, vlenb
; ZIP-NEXT:    slli a1, a0, 3
; ZIP-NEXT:    add a0, a1, a0
...
; ZIP-NEXT:    vslidedown.vi v0, v16, 16
; ZIP-NEXT:    li a0, 32
; ZIP-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
...
; ZIP-NEXT:    vmv.s.x v16, a1
; ZIP-NEXT:    addi a1, sp, 16
; ZIP-NEXT:    vs1r.v v16, (a1) # vscale x 8-byte Folded Spill
; ZIP-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; ZIP-NEXT:    ri.vzip2a.vv v16, v0, v24
; ZIP-NEXT:    addi a0, sp, 16
; ZIP-NEXT:    vl1r.v v0, (a0) # vscale x 8-byte Folded Reload
; ZIP-NEXT:    csrr a0, vlenb
; ZIP-NEXT:    add a0, sp, a0
; ZIP-NEXT:    addi a0, a0, 16
; ZIP-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; ZIP-NEXT:    vmerge.vvm v24, v16, v24, v0
; ZIP-NEXT:    csrr a0, vlenb
; ZIP-NEXT:    slli a1, a0, 3
; ZIP-NEXT:    add a0, a1, a0
; ZIP-NEXT:    add a0, sp, a0
