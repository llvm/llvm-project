...
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vluxei32.v v16, (a0), v16, v0.t
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    and a1, a1, a2
; RV32-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV32-NEXT:    vluxei16.v v16, (a0), v16, v0.t
; RV32-NEXT:    ret
;
...
; RV64-NEXT:    and a1, a1, a2
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vluxei16.v v16, (a0), v16, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    and a1, a1, a2
; RV64-NEXT:    vsetvli zero, a1, e64, m8, ta, ma
; RV64-NEXT:    vluxei32.v v16, (a0), v16, v0.t
; RV64-NEXT:    ret
...
; RV64-NEXT:    vwmulsu.vx v16, v16, a2
; RV64-NEXT:    vwmulsu.vx v8, v8, a2
; RV64-NEXT:    mv a2, a1
...
; RV64-NEXT:    li a3, 16
; RV64-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV64-NEXT:    vwmulu.vx v16, v16, a2
; RV64-NEXT:    vwmulu.vx v8, v8, a2
; RV64-NEXT:    mv a2, a1
