...
; RV32-NEXT:    vredxor.vs v12, v8, v10
; RV32-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; RV32-NEXT:    vslidedown.vi v10, v8, 2
; RV32-NEXT:    vmv.x.s a0, v10
...
; RV64-NEXT:    vredxor.vs v12, v8, v10
; RV64-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; RV64-NEXT:    vslidedown.vi v10, v8, 2
; RV64-NEXT:    vmv.x.s a0, v10
...
; RV32-NEXT:    lw a5, 36(sp)
; RV32-NEXT:    lw a6, 40(sp)
; RV32-NEXT:    lw a7, 44(sp)
; RV32-NEXT:    vmv.x.s t0, v10
; RV32-NEXT:    add a0, a0, a1
; RV32-NEXT:    vmv.s.x v10, zero
; RV32-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; RV32-NEXT:    vredxor.vs v10, v8, v10
; RV32-NEXT:    lw a1, 48(sp)
; RV32-NEXT:    lw t1, 52(sp)
; RV32-NEXT:    lw t2, 56(sp)
; RV32-NEXT:    lw t3, 60(sp)
; RV32-NEXT:    add a0, a0, a2
; RV32-NEXT:    add a0, a0, a3
; RV32-NEXT:    vsetivli zero, 1, e32, m2, ta, ma
; RV32-NEXT:    vslidedown.vi v8, v8, 7
...
; RV64-NEXT:    lw a5, 36(sp)
; RV64-NEXT:    lw a6, 40(sp)
; RV64-NEXT:    lw a7, 44(sp)
; RV64-NEXT:    vmv.x.s t0, v10
; RV64-NEXT:    add a0, a0, a1
; RV64-NEXT:    vmv.s.x v10, zero
; RV64-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; RV64-NEXT:    vredxor.vs v10, v8, v10
; RV64-NEXT:    lw a1, 48(sp)
; RV64-NEXT:    lw t1, 52(sp)
; RV64-NEXT:    lw t2, 56(sp)
; RV64-NEXT:    lw t3, 60(sp)
; RV64-NEXT:    add a0, a0, a2
; RV64-NEXT:    add a0, a0, a3
; RV64-NEXT:    vsetivli zero, 1, e32, m2, ta, ma
; RV64-NEXT:    vslidedown.vi v8, v8, 7
...
; RV32-NEXT:    vmv.s.x v11, zero
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vredxor.vs v11, v8, v11
; RV32-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
; RV32-NEXT:    vslidedown.vi v8, v8, 3
; RV32-NEXT:    vsrl.vx v14, v8, a0
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v9, v11, a0
; RV32-NEXT:    vmv.x.s a0, v10
...
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vredxor.vs v25, v8, v12
; RV32-NEXT:    vsetivli zero, 1, e64, m4, ta, ma
; RV32-NEXT:    vslidedown.vi v12, v8, 4
; RV32-NEXT:    vsrl.vx v16, v12, a0
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vsrl.vx v13, v25, a0
; RV32-NEXT:    vsetivli zero, 1, e64, m4, ta, ma
; RV32-NEXT:    vslidedown.vi v0, v8, 5
; RV32-NEXT:    vsrl.vx v20, v0, a0
; RV32-NEXT:    vslidedown.vi v4, v8, 6
; RV32-NEXT:    vsrl.vx v28, v4, a0
...
; RV32-NEXT:    sltu a0, a7, a4
; RV32-NEXT:    add a3, a7, a3
; RV32-NEXT:    add a0, a2, a0
; RV32-NEXT:    sltu a2, a3, a7
; RV32-NEXT:    add a0, a1, a0
...
; RV64-NEXT:    vredxor.vs v12, v8, v12
; RV64-NEXT:    mv a0, sp
...
; RV32-NEXT:    sub sp, sp, a0
; RV32-NEXT:    .cfi_escape 0x0f, 0x0f, 0x72, 0x00, 0x11, 0xc0, 0x00, 0x22, 0x11, 0xb9, 0x01, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 64 + 185 * vlenb
; RV32-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RV32-NEXT:    vmv.s.x v16, zero
; RV32-NEXT:    vredxor.vs v16, v8, v16
; RV32-NEXT:    sw s9, 4(sp) # 4-byte Folded Spill
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    li a1, 168
; RV32-NEXT:    mul a0, a0, a1
; RV32-NEXT:    add a0, sp, a0
...
; RV32-NEXT:    add a1, sp, a1
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs1r.v v17, (a1) # vscale x 8-byte Folded Spill
; RV32-NEXT:    vsetivli zero, 1, e64, m8, ta, ma
...
; RV32-NEXT:    li s0, 72
; RV32-NEXT:    mul t6, t6, s0
; RV32-NEXT:    add t6, sp, t6
; RV32-NEXT:    addi t6, t6, 16
; RV32-NEXT:    vl8r.v v16, (t6) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vmv.x.s t6, v16
; RV32-NEXT:    csrr s0, vlenb
; RV32-NEXT:    li s7, 168
; RV32-NEXT:    mul s0, s0, s7
; RV32-NEXT:    add s0, sp, s0
; RV32-NEXT:    addi s0, s0, 16
; RV32-NEXT:    vl1r.v v16, (s0) # vscale x 8-byte Folded Reload
; RV32-NEXT:    vmv.x.s s7, v16
; RV32-NEXT:    csrr s0, vlenb
; RV32-NEXT:    li s8, 144
; RV32-NEXT:    mul s0, s0, s8
; RV32-NEXT:    add s0, sp, s0
; RV32-NEXT:    addi s0, s0, 16
; RV32-NEXT:    vl8r.v v16, (s0) # vscale x 64-byte Folded Reload
...
; RV32-NEXT:    add a3, a0, a3
; RV32-NEXT:    vmv.x.s a0, v16
; RV32-NEXT:    add s3, t6, s3
; RV32-NEXT:    sltu a2, s3, t6
; RV32-NEXT:    add a1, s3, a1
; RV32-NEXT:    add a2, a2, s5
; RV32-NEXT:    sltu a4, a1, s3
...
; RV64-NEXT:    vredxor.vs v18, v8, v16
; RV64-NEXT:    mv a0, sp
; RV64-NEXT:    vsetivli zero, 1, e64, m2, ta, ma
...
; RV64-NEXT:    ld a2, 40(sp)
; RV64-NEXT:    ld a3, 48(sp)
; RV64-NEXT:    ld a4, 56(sp)
...
; RV64-NEXT:    vslidedown.vi v8, v11, 2
