...
; CHECK-ZVBB-NEXT:    vwsll.vx v2, v8, a0, v0.t
; CHECK-ZVBB-NEXT:    vmv2r.v v8, v2
; CHECK-ZVBB-NEXT:    ret
...
; CHECK-NEXT:    vzext.vf2 v2, v8
; CHECK-NEXT:    vsetvli zero, a0, e64, m2, ta, ma
; CHECK-NEXT:    vsll.vi v8, v2, 2, v0.t
; CHECK-NEXT:    ret
;
; CHECK-ZVBB-LABEL: vwsll_vi_nxv2i64:
; CHECK-ZVBB:       # %bb.0:
; CHECK-ZVBB-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-ZVBB-NEXT:    vwsll.vi v2, v8, 2, v0.t
; CHECK-ZVBB-NEXT:    vmv2r.v v8, v2
; CHECK-ZVBB-NEXT:    ret
  %x = zext <vscale x 2 x i32> %a to <vscale x 2 x i64>
...
; CHECK-NEXT:    vsll.vx v8, v2, a0, v0.t
; CHECK-NEXT:    ret
;
