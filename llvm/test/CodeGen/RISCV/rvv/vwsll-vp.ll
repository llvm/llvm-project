...
; CHECK-ZVBB-NEXT:    vwsll.vv v8, v8, v9, v0.t
; CHECK-ZVBB-NEXT:    ret
...
; CHECK-ZVBB-NEXT:    vwsll.vx v8, v8, a0, v0.t
; CHECK-ZVBB-NEXT:    ret
...
; CHECK-NEXT:    vwmulu.vx v8, v8, a1, v0.t
; CHECK-NEXT:    ret
;
; CHECK-ZVBB-LABEL: vwsll_vi_nxv2i64:
; CHECK-ZVBB:       # %bb.0:
; CHECK-ZVBB-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-ZVBB-NEXT:    vwsll.vi v8, v8, 2, v0.t
; CHECK-ZVBB-NEXT:    ret
  %x = zext <vscale x 2 x i32> %a to <vscale x 2 x i64>
