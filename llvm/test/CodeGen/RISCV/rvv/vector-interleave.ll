...
; ZVBB-RV32-NEXT:    vsseg6e8.v v9, (a0)
...
; ZVBB-RV32-NEXT:    vsseg6e8.v v8, (a1)
; ZVBB-RV32-NEXT:    vl1r.v v14, (a0)
; ZVBB-RV32-NEXT:    csrr a2, vlenb
; ZVBB-RV32-NEXT:    add a0, a0, a2
...
; ZVBB-RV64-NEXT:    vsseg6e8.v v9, (a0)
...
; ZVBB-RV64-NEXT:    vsseg6e8.v v8, (a1)
; ZVBB-RV64-NEXT:    vl1r.v v14, (a0)
; ZVBB-RV64-NEXT:    csrr a2, vlenb
; ZVBB-RV64-NEXT:    add a0, a0, a2
...
; ZVBB-RV32-NEXT:    addi a0, a0, 64
; ZVBB-RV32-NEXT:    vmv1r.v v14, v19
; ZVBB-RV32-NEXT:    vsseg6e32.v v9, (a0)
; ZVBB-RV32-NEXT:    vmv1r.v v9, v24
; ZVBB-RV32-NEXT:    vmv1r.v v10, v22
; ZVBB-RV32-NEXT:    vmv1r.v v11, v20
; ZVBB-RV32-NEXT:    vmv1r.v v12, v16
; ZVBB-RV32-NEXT:    vmv1r.v v13, v18
; ZVBB-RV32-NEXT:    addi a1, sp, 64
; ZVBB-RV32-NEXT:    vsseg6e32.v v8, (a1)
; ZVBB-RV32-NEXT:    vl1re32.v v14, (a0)
; ZVBB-RV32-NEXT:    csrr a2, vlenb
; ZVBB-RV32-NEXT:    add a0, a0, a2
; ZVBB-RV32-NEXT:    add a3, a1, a2
...
; ZVBB-RV64-NEXT:    addi a0, a0, 64
; ZVBB-RV64-NEXT:    vmv1r.v v14, v19
; ZVBB-RV64-NEXT:    vsseg6e32.v v9, (a0)
; ZVBB-RV64-NEXT:    vmv1r.v v9, v24
; ZVBB-RV64-NEXT:    vmv1r.v v10, v22
; ZVBB-RV64-NEXT:    vmv1r.v v11, v20
; ZVBB-RV64-NEXT:    vmv1r.v v12, v16
; ZVBB-RV64-NEXT:    vmv1r.v v13, v18
; ZVBB-RV64-NEXT:    addi a1, sp, 64
; ZVBB-RV64-NEXT:    vsseg6e32.v v8, (a1)
; ZVBB-RV64-NEXT:    vl1re32.v v14, (a0)
; ZVBB-RV64-NEXT:    csrr a2, vlenb
; ZVBB-RV64-NEXT:    add a0, a0, a2
; ZVBB-RV64-NEXT:    add a3, a1, a2
...
; ZVBB-RV32-NEXT:    addi a0, a0, 64
; ZVBB-RV32-NEXT:    vmv1r.v v14, v19
; ZVBB-RV32-NEXT:    vsseg6e64.v v9, (a0)
; ZVBB-RV32-NEXT:    vmv1r.v v9, v24
; ZVBB-RV32-NEXT:    vmv1r.v v10, v22
; ZVBB-RV32-NEXT:    vmv1r.v v11, v20
; ZVBB-RV32-NEXT:    vmv1r.v v12, v16
; ZVBB-RV32-NEXT:    vmv1r.v v13, v18
; ZVBB-RV32-NEXT:    addi a1, sp, 64
; ZVBB-RV32-NEXT:    vsseg6e64.v v8, (a1)
; ZVBB-RV32-NEXT:    vl1re64.v v14, (a0)
; ZVBB-RV32-NEXT:    csrr a2, vlenb
; ZVBB-RV32-NEXT:    add a0, a0, a2
; ZVBB-RV32-NEXT:    add a3, a1, a2
...
; ZVBB-RV64-NEXT:    addi a0, a0, 64
; ZVBB-RV64-NEXT:    vmv1r.v v14, v19
; ZVBB-RV64-NEXT:    vsseg6e64.v v9, (a0)
; ZVBB-RV64-NEXT:    vmv1r.v v9, v24
; ZVBB-RV64-NEXT:    vmv1r.v v10, v22
; ZVBB-RV64-NEXT:    vmv1r.v v11, v20
; ZVBB-RV64-NEXT:    vmv1r.v v12, v16
; ZVBB-RV64-NEXT:    vmv1r.v v13, v18
; ZVBB-RV64-NEXT:    addi a1, sp, 64
; ZVBB-RV64-NEXT:    vsseg6e64.v v8, (a1)
; ZVBB-RV64-NEXT:    vl1re64.v v14, (a0)
; ZVBB-RV64-NEXT:    csrr a2, vlenb
; ZVBB-RV64-NEXT:    add a0, a0, a2
; ZVBB-RV64-NEXT:    add a3, a1, a2
...
; ZVBB-NEXT:    vmv1r.v v0, v13
; ZVBB-NEXT:    vmerge.vim v12, v22, 1, v0
...
; ZVBB-NEXT:    add a3, a6, a0
; ZVBB-NEXT:    add a7, a3, a0
; ZVBB-NEXT:    vmsne.vi v17, v10, 0
...
; ZVBB-NEXT:    vl1r.v v14, (t0)
; ZVBB-NEXT:    add t0, t0, a2
; ZVBB-NEXT:    vl1r.v v15, (t0)
...
; ZVBB-NEXT:    vl1r.v v23, (a2)
; ZVBB-NEXT:    vl1r.v v20, (a3)
; ZVBB-NEXT:    vl1r.v v21, (a6)
...
; ZVBB-NEXT:    add a7, a6, a2
; ZVBB-NEXT:    add t0, a7, a2
; ZVBB-NEXT:    vl1re16.v v14, (t0)
; ZVBB-NEXT:    add t0, t0, a2
; ZVBB-NEXT:    vl1re16.v v15, (t0)
; ZVBB-NEXT:    vl1re16.v v12, (a6)
; ZVBB-NEXT:    vl1re16.v v13, (a7)
...
; ZVBB-NEXT:    add a2, a7, a2
; ZVBB-NEXT:    vl1re16.v v23, (a2)
; ZVBB-NEXT:    vl1re16.v v20, (a3)
; ZVBB-NEXT:    vl1re16.v v21, (a6)
; ZVBB-NEXT:    vl1re16.v v18, (a4)
; ZVBB-NEXT:    vl1re16.v v19, (a5)
; ZVBB-NEXT:    vl1re16.v v16, (a0)
; ZVBB-NEXT:    vl1re16.v v17, (a1)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
...
; ZVBB-NEXT:    add a7, a6, a2
; ZVBB-NEXT:    add t0, a7, a2
; ZVBB-NEXT:    vl1re32.v v14, (t0)
; ZVBB-NEXT:    add t0, t0, a2
; ZVBB-NEXT:    vl1re32.v v15, (t0)
; ZVBB-NEXT:    vl1re32.v v12, (a6)
; ZVBB-NEXT:    vl1re32.v v13, (a7)
...
; ZVBB-NEXT:    add a2, a7, a2
; ZVBB-NEXT:    vl1re32.v v23, (a2)
; ZVBB-NEXT:    vl1re32.v v20, (a3)
; ZVBB-NEXT:    vl1re32.v v21, (a6)
; ZVBB-NEXT:    vl1re32.v v18, (a4)
; ZVBB-NEXT:    vl1re32.v v19, (a5)
; ZVBB-NEXT:    vl1re32.v v16, (a0)
; ZVBB-NEXT:    vl1re32.v v17, (a1)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
...
; ZVBB-NEXT:    add a7, a6, a2
; ZVBB-NEXT:    add t0, a7, a2
; ZVBB-NEXT:    vl1re64.v v14, (t0)
; ZVBB-NEXT:    add t0, t0, a2
; ZVBB-NEXT:    vl1re64.v v15, (t0)
; ZVBB-NEXT:    vl1re64.v v12, (a6)
; ZVBB-NEXT:    vl1re64.v v13, (a7)
...
; ZVBB-NEXT:    add a2, a7, a2
; ZVBB-NEXT:    vl1re64.v v23, (a2)
; ZVBB-NEXT:    vl1re64.v v20, (a3)
; ZVBB-NEXT:    vl1re64.v v21, (a6)
; ZVBB-NEXT:    vl1re64.v v18, (a4)
; ZVBB-NEXT:    vl1re64.v v19, (a5)
; ZVBB-NEXT:    vl1re64.v v16, (a0)
; ZVBB-NEXT:    vl1re64.v v17, (a1)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
...
; ZVBB-RV32-NEXT:    addi a0, a0, 64
; ZVBB-RV32-NEXT:    vmv1r.v v14, v19
; ZVBB-RV32-NEXT:    vsseg6e16.v v9, (a0)
; ZVBB-RV32-NEXT:    vmv1r.v v9, v24
; ZVBB-RV32-NEXT:    vmv1r.v v10, v22
; ZVBB-RV32-NEXT:    vmv1r.v v11, v20
; ZVBB-RV32-NEXT:    vmv1r.v v12, v16
; ZVBB-RV32-NEXT:    vmv1r.v v13, v18
; ZVBB-RV32-NEXT:    addi a1, sp, 64
; ZVBB-RV32-NEXT:    vsseg6e16.v v8, (a1)
; ZVBB-RV32-NEXT:    vl1re16.v v14, (a0)
; ZVBB-RV32-NEXT:    csrr a2, vlenb
; ZVBB-RV32-NEXT:    add a0, a0, a2
; ZVBB-RV32-NEXT:    add a3, a1, a2
...
; ZVBB-RV64-NEXT:    addi a0, a0, 64
; ZVBB-RV64-NEXT:    vmv1r.v v14, v19
; ZVBB-RV64-NEXT:    vsseg6e16.v v9, (a0)
; ZVBB-RV64-NEXT:    vmv1r.v v9, v24
; ZVBB-RV64-NEXT:    vmv1r.v v10, v22
; ZVBB-RV64-NEXT:    vmv1r.v v11, v20
; ZVBB-RV64-NEXT:    vmv1r.v v12, v16
; ZVBB-RV64-NEXT:    vmv1r.v v13, v18
; ZVBB-RV64-NEXT:    addi a1, sp, 64
; ZVBB-RV64-NEXT:    vsseg6e16.v v8, (a1)
; ZVBB-RV64-NEXT:    vl1re16.v v14, (a0)
; ZVBB-RV64-NEXT:    csrr a2, vlenb
; ZVBB-RV64-NEXT:    add a0, a0, a2
; ZVBB-RV64-NEXT:    add a3, a1, a2
...
; CHECK-NEXT:    vsetvli a3, zero, e16, m1, ta, ma
; CHECK-NEXT:    vslideup.vx v11, v8, a2
; CHECK-NEXT:    vsetvli a3, zero, e16, mf2, ta, ma
; CHECK-NEXT:    vle16.v v10, (a6)
; CHECK-NEXT:    vle16.v v8, (a5)
; CHECK-NEXT:    vsetvli a3, zero, e16, m1, ta, ma
...
; ZVBB-NEXT:    addi a0, sp, 16
; ZVBB-NEXT:    csrr a2, vlenb
; ZVBB-NEXT:    srli a3, a2, 1
; ZVBB-NEXT:    add a1, a0, a3
...
; ZVBB-NEXT:    add a7, a6, a3
; ZVBB-NEXT:    add t0, a7, a3
; ZVBB-NEXT:    add a3, t0, a3
; ZVBB-NEXT:    vle16.v v8, (a3)
; ZVBB-NEXT:    vle16.v v11, (t0)
; ZVBB-NEXT:    vle16.v v9, (a7)
; ZVBB-NEXT:    srli a2, a2, 2
; ZVBB-NEXT:    vsetvli a3, zero, e16, m1, ta, ma
; ZVBB-NEXT:    vslideup.vx v11, v8, a2
; ZVBB-NEXT:    vsetvli a3, zero, e16, mf2, ta, ma
; ZVBB-NEXT:    vle16.v v10, (a6)
; ZVBB-NEXT:    vle16.v v8, (a5)
; ZVBB-NEXT:    vsetvli a3, zero, e16, m1, ta, ma
; ZVBB-NEXT:    vslideup.vx v10, v9, a2
; ZVBB-NEXT:    vsetvli a3, zero, e16, mf2, ta, ma
; ZVBB-NEXT:    vle16.v v9, (a4)
