...
; CHECK-NEXT:    li a0, -1
; CHECK-NEXT:    vwmaccu.vx v24, a0, v16
; CHECK-NEXT:    vwaddu.vv v0, v12, v20
...
; CHECK-NEXT:    vrgatherei16.vv v24, v16, v2
; CHECK-NEXT:    addi a0, sp, 16
; CHECK-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
...
; ZVBB-NEXT:    vsrl.vi v2, v24, 1
; ZVBB-NEXT:    csrr a1, vlenb
; ZVBB-NEXT:    slli a1, a1, 3
; ZVBB-NEXT:    add a1, sp, a1
; ZVBB-NEXT:    addi a1, a1, 16
; ZVBB-NEXT:    vl8r.v v8, (a1) # Unknown-size Folded Reload
; ZVBB-NEXT:    vadd.vx v2, v2, a0, v0.t
; ZVBB-NEXT:    vmv4r.v v12, v16
; ZVBB-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; ZVBB-NEXT:    vrgatherei16.vv v24, v8, v2
; ZVBB-NEXT:    addi a0, sp, 16
; ZVBB-NEXT:    vs8r.v v24, (a0) # Unknown-size Folded Spill
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 3
; ZVBB-NEXT:    add a0, sp, a0
; ZVBB-NEXT:    addi a0, a0, 16
...
; ZVBB-NEXT:    vrgatherei16.vv v24, v16, v2
; ZVBB-NEXT:    addi a0, sp, 16
; ZVBB-NEXT:    vl8r.v v8, (a0) # Unknown-size Folded Reload
