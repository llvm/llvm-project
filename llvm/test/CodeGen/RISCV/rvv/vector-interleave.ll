...
; CHECK-NEXT:    vmv1r.v v0, v8
; CHECK-NEXT:    vmerge.vim v28, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v1, v19
; CHECK-NEXT:    vmv1r.v v0, v9
; CHECK-NEXT:    vmerge.vim v20, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v2, v29
; CHECK-NEXT:    vmv1r.v v0, v10
; CHECK-NEXT:    vmerge.vim v8, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v3, v21
; CHECK-NEXT:    vmv1r.v v0, v11
; CHECK-NEXT:    vmerge.vim v22, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v4, v9
; CHECK-NEXT:    vmv1r.v v0, v12
; CHECK-NEXT:    vmerge.vim v26, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v5, v23
; CHECK-NEXT:    vmv1r.v v0, v13
; CHECK-NEXT:    vmerge.vim v24, v16, 1, v0
; CHECK-NEXT:    vmv1r.v v6, v27
; CHECK-NEXT:    add a3, a2, a0
; CHECK-NEXT:    vmv1r.v v7, v25
; CHECK-NEXT:    vmv1r.v v19, v28
; CHECK-NEXT:    vmv1r.v v0, v14
; CHECK-NEXT:    vmerge.vim v10, v16, 1, v0
...
; CHECK-NEXT:    vmsne.vi v11, v18, 0
; CHECK-NEXT:    vmsne.vi v0, v12, 0
; CHECK-NEXT:    vmsne.vi v12, v22, 0
; CHECK-NEXT:    vmsne.vi v13, v20, 0
...
; CHECK-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; CHECK-NEXT:    vslideup.vx v0, v13, a2
...
; ZVBB-NEXT:    vmv1r.v v0, v8
; ZVBB-NEXT:    vmerge.vim v28, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v1, v19
; ZVBB-NEXT:    vmv1r.v v0, v9
; ZVBB-NEXT:    vmerge.vim v20, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v2, v29
; ZVBB-NEXT:    vmv1r.v v0, v10
; ZVBB-NEXT:    vmerge.vim v8, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v3, v21
; ZVBB-NEXT:    vmv1r.v v0, v11
; ZVBB-NEXT:    vmerge.vim v22, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v4, v9
; ZVBB-NEXT:    vmv1r.v v0, v12
; ZVBB-NEXT:    vmerge.vim v26, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v5, v23
; ZVBB-NEXT:    vmv1r.v v0, v13
; ZVBB-NEXT:    vmerge.vim v24, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v6, v27
; ZVBB-NEXT:    add a3, a2, a0
; ZVBB-NEXT:    vmv1r.v v7, v25
; ZVBB-NEXT:    vmv1r.v v19, v28
; ZVBB-NEXT:    vmv1r.v v0, v14
; ZVBB-NEXT:    vmerge.vim v10, v16, 1, v0
; ZVBB-NEXT:    vmv1r.v v21, v8
; ZVBB-NEXT:    add a4, a1, a0
; ZVBB-NEXT:    vmv1r.v v8, v11
; ZVBB-NEXT:    vmv1r.v v23, v26
; ZVBB-NEXT:    vsetvli a5, zero, e8, m1, ta, ma
; ZVBB-NEXT:    vsseg8e8.v v1, (a2)
; ZVBB-NEXT:    vmv1r.v v25, v10
; ZVBB-NEXT:    vsseg8e8.v v18, (a1)
...
; ZVBB-NEXT:    add a3, a4, a0
; ZVBB-NEXT:    vl1r.v v18, (a3)
; ZVBB-NEXT:    add a3, a3, a0
...
; ZVBB-NEXT:    vmsne.vi v24, v8, 0
; ZVBB-NEXT:    vmsne.vi v8, v10, 0
; ZVBB-NEXT:    vmsne.vi v9, v16, 0
; ZVBB-NEXT:    vmsne.vi v10, v14, 0
; ZVBB-NEXT:    vmsne.vi v11, v18, 0
; ZVBB-NEXT:    vmsne.vi v0, v12, 0
; ZVBB-NEXT:    vmsne.vi v12, v22, 0
; ZVBB-NEXT:    vmsne.vi v13, v20, 0
; ZVBB-NEXT:    vsetvli a1, zero, e8, mf2, ta, ma
; ZVBB-NEXT:    vslideup.vx v13, v12, a0
; ZVBB-NEXT:    vslideup.vx v0, v11, a0
; ZVBB-NEXT:    vslideup.vx v10, v9, a0
; ZVBB-NEXT:    vslideup.vx v8, v24, a0
; ZVBB-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVBB-NEXT:    vslideup.vx v0, v13, a2
...
; CHECK-NEXT:    vsseg8e8.v v24, (a1)
; CHECK-NEXT:    vl1r.v v22, (t5)
; CHECK-NEXT:    add t5, t5, a3
; CHECK-NEXT:    add a3, t6, a3
; CHECK-NEXT:    vl1r.v v14, (t6)
; CHECK-NEXT:    vl1r.v v23, (t5)
; CHECK-NEXT:    vl1r.v v15, (a3)
; CHECK-NEXT:    vl1r.v v20, (t1)
; CHECK-NEXT:    vl1r.v v12, (t2)
; CHECK-NEXT:    vl1r.v v21, (t3)
; CHECK-NEXT:    vl1r.v v13, (t4)
...
; ZVBB-NEXT:    vl1r.v v22, (t5)
; ZVBB-NEXT:    add t5, t5, a3
; ZVBB-NEXT:    add a3, t6, a3
; ZVBB-NEXT:    vl1r.v v14, (t6)
; ZVBB-NEXT:    vl1r.v v23, (t5)
; ZVBB-NEXT:    vl1r.v v15, (a3)
; ZVBB-NEXT:    vl1r.v v20, (t1)
; ZVBB-NEXT:    vl1r.v v12, (t2)
; ZVBB-NEXT:    vl1r.v v21, (t3)
; ZVBB-NEXT:    vl1r.v v13, (t4)
...
; CHECK-NEXT:    vmv1r.v v31, v22
; CHECK-NEXT:    vsseg8e16.v v24, (a1)
; CHECK-NEXT:    vl1re16.v v22, (t5)
; CHECK-NEXT:    add t5, t5, a3
; CHECK-NEXT:    add a3, t6, a3
; CHECK-NEXT:    vl1re16.v v14, (t6)
; CHECK-NEXT:    vl1re16.v v23, (t5)
; CHECK-NEXT:    vl1re16.v v15, (a3)
; CHECK-NEXT:    vl1re16.v v20, (t1)
; CHECK-NEXT:    vl1re16.v v12, (t2)
; CHECK-NEXT:    vl1re16.v v21, (t3)
; CHECK-NEXT:    vl1re16.v v13, (t4)
; CHECK-NEXT:    vl1re16.v v18, (a5)
; CHECK-NEXT:    vl1re16.v v10, (a6)
; CHECK-NEXT:    vl1re16.v v19, (a7)
; CHECK-NEXT:    vl1re16.v v11, (t0)
; CHECK-NEXT:    vl1re16.v v16, (a0)
; CHECK-NEXT:    vl1re16.v v8, (a1)
; CHECK-NEXT:    vl1re16.v v17, (a2)
; CHECK-NEXT:    vl1re16.v v9, (a4)
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 4
; CHECK-NEXT:    add sp, sp, a0
; CHECK-NEXT:    addi sp, sp, 16
...
; ZVBB-NEXT:    vl1re16.v v22, (t5)
; ZVBB-NEXT:    add t5, t5, a3
; ZVBB-NEXT:    add a3, t6, a3
; ZVBB-NEXT:    vl1re16.v v14, (t6)
; ZVBB-NEXT:    vl1re16.v v23, (t5)
; ZVBB-NEXT:    vl1re16.v v15, (a3)
; ZVBB-NEXT:    vl1re16.v v20, (t1)
; ZVBB-NEXT:    vl1re16.v v12, (t2)
; ZVBB-NEXT:    vl1re16.v v21, (t3)
; ZVBB-NEXT:    vl1re16.v v13, (t4)
; ZVBB-NEXT:    vl1re16.v v18, (a5)
; ZVBB-NEXT:    vl1re16.v v10, (a6)
; ZVBB-NEXT:    vl1re16.v v19, (a7)
; ZVBB-NEXT:    vl1re16.v v11, (t0)
; ZVBB-NEXT:    vl1re16.v v16, (a0)
; ZVBB-NEXT:    vl1re16.v v8, (a1)
; ZVBB-NEXT:    vl1re16.v v17, (a2)
; ZVBB-NEXT:    vl1re16.v v9, (a4)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
...
; CHECK-NEXT:    vmv1r.v v31, v22
; CHECK-NEXT:    vsseg8e32.v v24, (a1)
; CHECK-NEXT:    vl1re32.v v22, (t5)
; CHECK-NEXT:    add t5, t5, a3
; CHECK-NEXT:    add a3, t6, a3
; CHECK-NEXT:    vl1re32.v v14, (t6)
; CHECK-NEXT:    vl1re32.v v23, (t5)
; CHECK-NEXT:    vl1re32.v v15, (a3)
; CHECK-NEXT:    vl1re32.v v20, (t1)
; CHECK-NEXT:    vl1re32.v v12, (t2)
; CHECK-NEXT:    vl1re32.v v21, (t3)
; CHECK-NEXT:    vl1re32.v v13, (t4)
; CHECK-NEXT:    vl1re32.v v18, (a5)
; CHECK-NEXT:    vl1re32.v v10, (a6)
; CHECK-NEXT:    vl1re32.v v19, (a7)
; CHECK-NEXT:    vl1re32.v v11, (t0)
; CHECK-NEXT:    vl1re32.v v16, (a0)
; CHECK-NEXT:    vl1re32.v v8, (a1)
; CHECK-NEXT:    vl1re32.v v17, (a2)
...
; ZVBB-NEXT:    vl1re32.v v22, (t5)
; ZVBB-NEXT:    add t5, t5, a3
; ZVBB-NEXT:    add a3, t6, a3
; ZVBB-NEXT:    vl1re32.v v14, (t6)
; ZVBB-NEXT:    vl1re32.v v23, (t5)
; ZVBB-NEXT:    vl1re32.v v15, (a3)
; ZVBB-NEXT:    vl1re32.v v20, (t1)
; ZVBB-NEXT:    vl1re32.v v12, (t2)
; ZVBB-NEXT:    vl1re32.v v21, (t3)
; ZVBB-NEXT:    vl1re32.v v13, (t4)
; ZVBB-NEXT:    vl1re32.v v18, (a5)
; ZVBB-NEXT:    vl1re32.v v10, (a6)
; ZVBB-NEXT:    vl1re32.v v19, (a7)
; ZVBB-NEXT:    vl1re32.v v11, (t0)
; ZVBB-NEXT:    vl1re32.v v16, (a0)
; ZVBB-NEXT:    vl1re32.v v8, (a1)
; ZVBB-NEXT:    vl1re32.v v17, (a2)
; ZVBB-NEXT:    vl1re32.v v9, (a4)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
...
; CHECK-NEXT:    vmv1r.v v31, v22
; CHECK-NEXT:    vsseg8e64.v v24, (a1)
; CHECK-NEXT:    vl1re64.v v22, (t5)
; CHECK-NEXT:    add t5, t5, a3
; CHECK-NEXT:    add a3, t6, a3
; CHECK-NEXT:    vl1re64.v v14, (t6)
; CHECK-NEXT:    vl1re64.v v23, (t5)
; CHECK-NEXT:    vl1re64.v v15, (a3)
; CHECK-NEXT:    vl1re64.v v20, (t1)
; CHECK-NEXT:    vl1re64.v v12, (t2)
; CHECK-NEXT:    vl1re64.v v21, (t3)
; CHECK-NEXT:    vl1re64.v v13, (t4)
; CHECK-NEXT:    vl1re64.v v18, (a5)
; CHECK-NEXT:    vl1re64.v v10, (a6)
; CHECK-NEXT:    vl1re64.v v19, (a7)
; CHECK-NEXT:    vl1re64.v v11, (t0)
; CHECK-NEXT:    vl1re64.v v16, (a0)
; CHECK-NEXT:    vl1re64.v v8, (a1)
; CHECK-NEXT:    vl1re64.v v17, (a2)
; CHECK-NEXT:    vl1re64.v v9, (a4)
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 4
; CHECK-NEXT:    add sp, sp, a0
; CHECK-NEXT:    addi sp, sp, 16
...
; ZVBB-NEXT:    vl1re64.v v22, (t5)
; ZVBB-NEXT:    add t5, t5, a3
; ZVBB-NEXT:    add a3, t6, a3
; ZVBB-NEXT:    vl1re64.v v14, (t6)
; ZVBB-NEXT:    vl1re64.v v23, (t5)
; ZVBB-NEXT:    vl1re64.v v15, (a3)
; ZVBB-NEXT:    vl1re64.v v20, (t1)
; ZVBB-NEXT:    vl1re64.v v12, (t2)
; ZVBB-NEXT:    vl1re64.v v21, (t3)
; ZVBB-NEXT:    vl1re64.v v13, (t4)
; ZVBB-NEXT:    vl1re64.v v18, (a5)
; ZVBB-NEXT:    vl1re64.v v10, (a6)
; ZVBB-NEXT:    vl1re64.v v19, (a7)
; ZVBB-NEXT:    vl1re64.v v11, (t0)
; ZVBB-NEXT:    vl1re64.v v16, (a0)
; ZVBB-NEXT:    vl1re64.v v8, (a1)
; ZVBB-NEXT:    vl1re64.v v17, (a2)
; ZVBB-NEXT:    vl1re64.v v9, (a4)
; ZVBB-NEXT:    csrr a0, vlenb
; ZVBB-NEXT:    slli a0, a0, 4
; ZVBB-NEXT:    add sp, sp, a0
; ZVBB-NEXT:    addi sp, sp, 16
