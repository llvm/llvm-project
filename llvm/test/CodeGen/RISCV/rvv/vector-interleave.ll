...
; ZVZIP-NEXT:    vslideup.vx v0, v8, a1
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m4, ta, ma
; ZVZIP-NEXT:    vmv.v.i v12, 0
; ZVZIP-NEXT:    vmerge.vim v16, v12, 1, v0
; ZVZIP-NEXT:    vmv1r.v v0, v9
...
; ZVZIP-NEXT:    vslideup.vx v0, v16, a0
; ZVZIP-NEXT:    ret
...
; V-NEXT:    add a2, a2, a1
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vl2r.v v14, (a2)
; V-NEXT:    vl2r.v v8, (a0)
; V-NEXT:    add a0, a0, a1
; V-NEXT:    vl2r.v v10, (a0)
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a0, a0, 3
; V-NEXT:    add sp, sp, a0
; V-NEXT:    addi sp, sp, 16
...
; V-NEXT:    add a2, a2, a1
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vl2re32.v v14, (a2)
; V-NEXT:    vl2re32.v v8, (a0)
; V-NEXT:    add a0, a0, a1
; V-NEXT:    vl2re32.v v10, (a0)
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a0, a0, 3
; V-NEXT:    add sp, sp, a0
; V-NEXT:    addi sp, sp, 16
...
; V-NEXT:    add a2, a2, a1
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vl2re64.v v14, (a2)
; V-NEXT:    vl2re64.v v8, (a0)
; V-NEXT:    add a0, a0, a1
; V-NEXT:    vl2re64.v v10, (a0)
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a0, a0, 3
; V-NEXT:    add sp, sp, a0
; V-NEXT:    addi sp, sp, 16
...
; V-NEXT:    add a3, a0, a5
; V-NEXT:    vl1r.v v9, (a3)
; V-NEXT:    vl1r.v v10, (a0)
; V-NEXT:    add a6, a0, a1
; V-NEXT:    slli a3, a1, 2
; V-NEXT:    vl1r.v v11, (a6)
; V-NEXT:    add a6, a3, a4
; V-NEXT:    add a7, a0, a6
; V-NEXT:    slli t0, a1, 3
; V-NEXT:    vl1r.v v12, (a7)
; V-NEXT:    sub a7, t0, a1
; V-NEXT:    add t0, a0, a7
; V-NEXT:    vl1r.v v13, (t0)
; V-NEXT:    add a4, a2, a4
; V-NEXT:    vl1r.v v14, (a4)
; V-NEXT:    vsetvli a4, zero, e8, m2, ta, ma
...
; V-NEXT:    add a4, a2, a1
; V-NEXT:    vl1r.v v11, (a4)
; V-NEXT:    vmsne.vi v9, v12, 0
; V-NEXT:    add a6, a2, a6
; V-NEXT:    vl1r.v v12, (a6)
; V-NEXT:    vmsne.vi v17, v14, 0
; V-NEXT:    add a7, a2, a7
; V-NEXT:    vl1r.v v13, (a7)
; V-NEXT:    add a4, a2, a3
...
; V-NEXT:    srli a0, a1, 2
; V-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; V-NEXT:    vslideup.vx v15, v14, a0
; V-NEXT:    vslideup.vx v0, v17, a0
; V-NEXT:    vslideup.vx v10, v9, a0
; V-NEXT:    vslideup.vx v8, v16, a0
; V-NEXT:    srli a1, a1, 1
; V-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; V-NEXT:    vslideup.vx v0, v15, a1
...
; ZVZIP:       # %bb.0:
; ZVZIP-NEXT:    vsetvli a0, zero, e8, m2, ta, ma
; ZVZIP-NEXT:    vmv1r.v v15, v14
; ZVZIP-NEXT:    vmv1r.v v14, v8
; ZVZIP-NEXT:    vmv1r.v v8, v0
; ZVZIP-NEXT:    vmv.v.i v2, 0
...
; ZVZIP-NEXT:    csrr a1, vlenb
; ZVZIP-NEXT:    srli a0, a1, 2
; ZVZIP-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVZIP-NEXT:    vslideup.vx v0, v10, a0
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m4, ta, ma
; ZVZIP-NEXT:    vmv.v.i v4, 0
; ZVZIP-NEXT:    vmerge.vim v16, v4, 1, v0
...
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; ZVZIP-NEXT:    vslideup.vx v0, v10, a1
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m8, ta, ma
; ZVZIP-NEXT:    vmv.v.i v16, 0
; ZVZIP-NEXT:    vmerge.vim v24, v16, 1, v0
...
; ZVZIP-NEXT:    vmsne.vi v0, v12, 0
; ZVZIP-NEXT:    vsetvli a2, zero, e8, mf2, ta, ma
; ZVZIP-NEXT:    vslideup.vx v0, v9, a0
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m4, ta, ma
; ZVZIP-NEXT:    vmerge.vim v16, v4, 1, v0
; ZVZIP-NEXT:    vmv1r.v v0, v11
; ZVZIP-NEXT:    vsetvli a2, zero, e8, m2, ta, ma
...
; ZVZIP-NEXT:    vmsne.vi v0, v8, 0
; ZVZIP-NEXT:    vsetvli a0, zero, e8, m1, ta, ma
; ZVZIP-NEXT:    vslideup.vx v0, v16, a1
; ZVZIP-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
...
; V-NEXT:    add a5, a1, a2
; V-NEXT:    vl1r.v v17, (a5)
; V-NEXT:    slli a5, a2, 2
; V-NEXT:    add a6, a5, a3
; V-NEXT:    add a7, a1, a6
; V-NEXT:    vl1r.v v22, (a7)
; V-NEXT:    slli a7, a2, 3
; V-NEXT:    sub a7, a7, a2
; V-NEXT:    add t0, a1, a7
; V-NEXT:    vl1r.v v23, (t0)
; V-NEXT:    add t0, a1, a5
; V-NEXT:    vl1r.v v20, (t0)
; V-NEXT:    add t0, a5, a2
; V-NEXT:    add a1, a1, t0
; V-NEXT:    vl1r.v v21, (a1)
; V-NEXT:    add a3, a0, a3
; V-NEXT:    vl1r.v v10, (a3)
; V-NEXT:    add a4, a0, a4
; V-NEXT:    vl1r.v v11, (a4)
...
; V-NEXT:    vl1r.v v9, (a2)
; V-NEXT:    add a6, a0, a6
; V-NEXT:    vl1r.v v14, (a6)
; V-NEXT:    add a7, a0, a7
; V-NEXT:    vl1r.v v15, (a7)
; V-NEXT:    add a5, a0, a5
; V-NEXT:    vl1r.v v12, (a5)
; V-NEXT:    add a0, a0, t0
; V-NEXT:    vl1r.v v13, (a0)
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a0, a0, 4
...
; V-NEXT:    add a5, a1, a2
; V-NEXT:    vl1re16.v v17, (a5)
; V-NEXT:    slli a5, a2, 2
; V-NEXT:    add a6, a5, a3
; V-NEXT:    add a7, a1, a6
; V-NEXT:    vl1re16.v v22, (a7)
; V-NEXT:    slli a7, a2, 3
; V-NEXT:    sub a7, a7, a2
; V-NEXT:    add t0, a1, a7
; V-NEXT:    vl1re16.v v23, (t0)
; V-NEXT:    add t0, a1, a5
; V-NEXT:    vl1re16.v v20, (t0)
; V-NEXT:    add t0, a5, a2
; V-NEXT:    add a1, a1, t0
; V-NEXT:    vl1re16.v v21, (a1)
; V-NEXT:    add a3, a0, a3
...
; V-NEXT:    add a6, a0, a6
; V-NEXT:    vl1re16.v v14, (a6)
; V-NEXT:    add a7, a0, a7
; V-NEXT:    vl1re16.v v15, (a7)
; V-NEXT:    add a5, a0, a5
...
; V-NEXT:    add a5, a1, a2
; V-NEXT:    vl1re32.v v17, (a5)
; V-NEXT:    slli a5, a2, 2
; V-NEXT:    add a6, a5, a3
; V-NEXT:    add a7, a1, a6
; V-NEXT:    vl1re32.v v22, (a7)
; V-NEXT:    slli a7, a2, 3
; V-NEXT:    sub a7, a7, a2
; V-NEXT:    add t0, a1, a7
; V-NEXT:    vl1re32.v v23, (t0)
; V-NEXT:    add t0, a1, a5
; V-NEXT:    vl1re32.v v20, (t0)
; V-NEXT:    add t0, a5, a2
; V-NEXT:    add a1, a1, t0
; V-NEXT:    vl1re32.v v21, (a1)
; V-NEXT:    add a3, a0, a3
...
; V-NEXT:    add a6, a0, a6
; V-NEXT:    vl1re32.v v14, (a6)
; V-NEXT:    add a7, a0, a7
; V-NEXT:    vl1re32.v v15, (a7)
; V-NEXT:    add a5, a0, a5
...
; V-NEXT:    add a5, a1, a2
; V-NEXT:    vl1re64.v v17, (a5)
; V-NEXT:    slli a5, a2, 2
; V-NEXT:    add a6, a5, a3
; V-NEXT:    add a7, a1, a6
; V-NEXT:    vl1re64.v v22, (a7)
; V-NEXT:    slli a7, a2, 3
; V-NEXT:    sub a7, a7, a2
; V-NEXT:    add t0, a1, a7
; V-NEXT:    vl1re64.v v23, (t0)
; V-NEXT:    add t0, a1, a5
; V-NEXT:    vl1re64.v v20, (t0)
; V-NEXT:    add t0, a5, a2
; V-NEXT:    add a1, a1, t0
; V-NEXT:    vl1re64.v v21, (a1)
; V-NEXT:    add a3, a0, a3
...
; V-NEXT:    add a6, a0, a6
; V-NEXT:    vl1re64.v v14, (a6)
; V-NEXT:    add a7, a0, a7
; V-NEXT:    vl1re64.v v15, (a7)
; V-NEXT:    add a5, a0, a5
...
; V-NEXT:    add a3, a0, a1
; V-NEXT:    add a4, a3, a2
; V-NEXT:    vle16.v v8, (a4)
; V-NEXT:    vle16.v v9, (a3)
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vle16.v v10, (a2)
; V-NEXT:    srli a1, a1, 2
...
; V-NEXT:    add a2, a2, a1
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vl2re16.v v14, (a2)
; V-NEXT:    vl2re16.v v8, (a0)
; V-NEXT:    add a0, a0, a1
; V-NEXT:    vl2re16.v v10, (a0)
; V-NEXT:    csrr a0, vlenb
; V-NEXT:    slli a0, a0, 3
; V-NEXT:    add sp, sp, a0
; V-NEXT:    addi sp, sp, 16
...
; V-NEXT:    add a3, a0, a1
; V-NEXT:    add a4, a3, a2
; V-NEXT:    vle32.v v8, (a4)
; V-NEXT:    vle32.v v9, (a3)
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vle32.v v10, (a2)
; V-NEXT:    srli a1, a1, 3
...
; V-NEXT:    sub a3, a3, a2
; V-NEXT:    add a3, a0, a3
; V-NEXT:    vle16.v v8, (a3)
; V-NEXT:    slli a3, a1, 1
; V-NEXT:    add a4, a0, a1
; V-NEXT:    add a5, a4, a3
; V-NEXT:    vle16.v v11, (a5)
; V-NEXT:    add a5, a3, a2
; V-NEXT:    add a5, a0, a5
; V-NEXT:    vle16.v v9, (a5)
; V-NEXT:    srli a1, a1, 2
; V-NEXT:    vsetvli a5, zero, e16, m1, ta, ma
; V-NEXT:    vslideup.vx v11, v8, a1
; V-NEXT:    add a3, a0, a3
; V-NEXT:    vsetvli a5, zero, e16, mf2, ta, ma
; V-NEXT:    vle16.v v10, (a3)
; V-NEXT:    add a3, a4, a2
; V-NEXT:    vle16.v v8, (a3)
; V-NEXT:    vsetvli a3, zero, e16, m1, ta, ma
; V-NEXT:    vslideup.vx v10, v9, a1
; V-NEXT:    vsetvli a3, zero, e16, mf2, ta, ma
; V-NEXT:    vle16.v v9, (a4)
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vle16.v v12, (a2)
; V-NEXT:    vsetvli a2, zero, e16, m1, ta, ma
; V-NEXT:    vslideup.vx v9, v8, a1
; V-NEXT:    vsetvli a2, zero, e16, mf2, ta, ma
; V-NEXT:    vle16.v v8, (a0)
...
; V-NEXT:    add a4, a3, a2
; V-NEXT:    add a4, a0, a4
; V-NEXT:    vl1re16.v v14, (a4)
; V-NEXT:    slli a4, a1, 3
; V-NEXT:    sub a5, a0, a1
; V-NEXT:    add a4, a5, a4
; V-NEXT:    vl1re16.v v15, (a4)
; V-NEXT:    add a4, a0, a3
; V-NEXT:    vl1re16.v v12, (a4)
; V-NEXT:    add a1, a0, a1
; V-NEXT:    add a3, a1, a3
; V-NEXT:    vl1re16.v v13, (a3)
; V-NEXT:    add a3, a0, a2
; V-NEXT:    vl1re16.v v10, (a3)
; V-NEXT:    add a2, a1, a2
; V-NEXT:    vl1re16.v v11, (a2)
...
; V-NEXT:    sub a3, a3, a2
; V-NEXT:    add a3, a0, a3
; V-NEXT:    vle32.v v8, (a3)
; V-NEXT:    slli a3, a1, 1
; V-NEXT:    add a4, a0, a1
; V-NEXT:    add a5, a4, a3
; V-NEXT:    vle32.v v11, (a5)
; V-NEXT:    add a5, a3, a2
; V-NEXT:    add a5, a0, a5
; V-NEXT:    vle32.v v9, (a5)
; V-NEXT:    srli a1, a1, 3
; V-NEXT:    vsetvli a5, zero, e32, m1, ta, ma
; V-NEXT:    vslideup.vx v11, v8, a1
; V-NEXT:    add a3, a0, a3
; V-NEXT:    vsetvli a5, zero, e32, mf2, ta, ma
; V-NEXT:    vle32.v v10, (a3)
; V-NEXT:    add a3, a4, a2
; V-NEXT:    vle32.v v8, (a3)
; V-NEXT:    vsetvli a3, zero, e32, m1, ta, ma
; V-NEXT:    vslideup.vx v10, v9, a1
; V-NEXT:    vsetvli a3, zero, e32, mf2, ta, ma
; V-NEXT:    vle32.v v9, (a4)
; V-NEXT:    add a2, a0, a2
; V-NEXT:    vle32.v v12, (a2)
; V-NEXT:    vsetvli a2, zero, e32, m1, ta, ma
; V-NEXT:    vslideup.vx v9, v8, a1
; V-NEXT:    vsetvli a2, zero, e32, mf2, ta, ma
; V-NEXT:    vle32.v v8, (a0)
...
; V-NEXT:    add a4, a3, a2
; V-NEXT:    add a4, a0, a4
; V-NEXT:    vl1re32.v v14, (a4)
; V-NEXT:    slli a4, a1, 3
; V-NEXT:    sub a5, a0, a1
; V-NEXT:    add a4, a5, a4
; V-NEXT:    vl1re32.v v15, (a4)
; V-NEXT:    add a4, a0, a3
; V-NEXT:    vl1re32.v v12, (a4)
; V-NEXT:    add a1, a0, a1
; V-NEXT:    add a3, a1, a3
; V-NEXT:    vl1re32.v v13, (a3)
; V-NEXT:    add a3, a0, a2
; V-NEXT:    vl1re32.v v10, (a3)
; V-NEXT:    add a2, a1, a2
; V-NEXT:    vl1re32.v v11, (a2)
...
; V-NEXT:    add a4, a3, a2
; V-NEXT:    add a4, a0, a4
; V-NEXT:    vl1re64.v v14, (a4)
; V-NEXT:    slli a4, a1, 3
; V-NEXT:    sub a5, a0, a1
; V-NEXT:    add a4, a5, a4
; V-NEXT:    vl1re64.v v15, (a4)
; V-NEXT:    add a4, a0, a3
; V-NEXT:    vl1re64.v v12, (a4)
; V-NEXT:    add a1, a0, a1
; V-NEXT:    add a3, a1, a3
; V-NEXT:    vl1re64.v v13, (a3)
; V-NEXT:    add a3, a0, a2
; V-NEXT:    vl1re64.v v10, (a3)
; V-NEXT:    add a2, a1, a2
; V-NEXT:    vl1re64.v v11, (a2)
