...
; CHECK-OPT-NEXT:    ret
;
; CHECK-NO-OPT-RV32-LABEL: zero_strided_unmasked_vpload_nxv1i8_i8:
; CHECK-NO-OPT-RV32:       # %bb.0:
; CHECK-NO-OPT-RV32-NEXT:    lbu a0, 0(a0)
; CHECK-NO-OPT-RV32-NEXT:    vsetivli zero, 4, e8, mf8, ta, ma
; CHECK-NO-OPT-RV32-NEXT:    vmv.v.x v8, a0
; CHECK-NO-OPT-RV32-NEXT:    ret
;
; CHECK-NO-OPT-RV64-LABEL: zero_strided_unmasked_vpload_nxv1i8_i8:
; CHECK-NO-OPT-RV64:       # %bb.0:
; CHECK-NO-OPT-RV64-NEXT:    lb a0, 0(a0)
; CHECK-NO-OPT-RV64-NEXT:    vsetivli zero, 4, e8, mf8, ta, ma
