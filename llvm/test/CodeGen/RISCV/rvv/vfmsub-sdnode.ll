...
; ZVFBFMIN-NEXT:    vxor.vx v10, v10, a0
...
; ZVFBFMIN-NEXT:    vfmadd.vv v10, v11, v8
...
; ZVFBFMIN-NEXT:    vfmadd.vv v9, v11, v8
...
; ZVFBFMIN-NEXT:    csrr a2, vlenb
; ZVFBFMIN-NEXT:    slli a2, a2, 4
; ZVFBFMIN-NEXT:    add a2, sp, a2
; ZVFBFMIN-NEXT:    addi a2, a2, 16
; ZVFBFMIN-NEXT:    vs8r.v v24, (a2) # vscale x 64-byte Folded Spill
; ZVFBFMIN-NEXT:    vsetvli a2, zero, e16, m8, ta, ma
; ZVFBFMIN-NEXT:    vxor.vx v16, v8, a1
...
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v24, v0
; ZVFBFMIN-NEXT:    csrr a0, vlenb
...
; ZVFBFWMA-NEXT:    lui a1, 8
; ZVFBFWMA-NEXT:    vsetvli a2, zero, e16, m8, ta, ma
; ZVFBFWMA-NEXT:    vxor.vx v24, v8, a1
; ZVFBFWMA-NEXT:    vsetvli a1, zero, e16, m4, ta, ma
...
; ZVFBFMIN-NEXT:    vxor.vx v16, v8, a0
; ZVFBFMIN-NEXT:    addi a0, sp, 16
; ZVFBFMIN-NEXT:    vs8r.v v16, (a0) # vscale x 64-byte Folded Spill
...
; ZVFBFWMA-NEXT:    addi a0, sp, 16
; ZVFBFWMA-NEXT:    vl8r.v v16, (a0) # vscale x 64-byte Folded Reload
; ZVFBFWMA-NEXT:    vfwmaccbf16.vv v24, v16, v0
; ZVFBFWMA-NEXT:    vfncvtbf16.f.f.w v16, v24
