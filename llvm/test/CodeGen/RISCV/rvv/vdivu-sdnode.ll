...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64, m1, ta, ma
; CHECK-NEXT:    vadd.vi v1, v9, 4
; CHECK-NEXT:    vsrl.vv v8, v8, v1
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64, m2, ta, ma
; CHECK-NEXT:    vadd.vi v2, v10, 4
; CHECK-NEXT:    vsrl.vv v8, v8, v2
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e64, m4, ta, ma
; CHECK-NEXT:    vadd.vi v4, v12, 4
; CHECK-NEXT:    vsrl.vv v8, v8, v4
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmulhu.vx v4, v8, a0
; CHECK-NEXT:    vsub.vv v12, v8, v4
; CHECK-NEXT:    vsrl.vi v12, v12, 1
; CHECK-NEXT:    vadd.vv v4, v12, v4
; CHECK-NEXT:    vsrl.vi v8, v4, 2, v0.t
; CHECK-NEXT:    ret
  %head1 = insertelement <vscale x 8 x i32> poison, i32 1, i32 0
  %one = shufflevector <vscale x 8 x i32> %head1, <vscale x 8 x i32> poison, <vscale x 8 x i32> zeroinitializer
