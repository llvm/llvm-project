...
; RV32-NEXT:  .LBB67_2:
; RV32-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; RV32-NEXT:    vmv.s.x v2, a0
; RV32-NEXT:    vsetvli zero, a1, e32, m8, ta, ma
; RV32-NEXT:    vredmaxu.vs v2, v8, v2, v0.t
; RV32-NEXT:    vsetvli zero, a2, e32, m8, ta, ma
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    vredmaxu.vs v2, v16, v2, v0.t
...
; RV64-NEXT:    vredmaxu.vs v2, v8, v2, v0.t
; RV64-NEXT:    vsetvli zero, a0, e32, m8, ta, ma
; RV64-NEXT:    vmv1r.v v0, v1
; RV64-NEXT:    vredmaxu.vs v2, v16, v2, v0.t
...
; RV32-NEXT:    vwredsum.vs v1, v8, v1, v0.t
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e32, mf2, ta, ma
; RV64-NEXT:    vwredsum.vs v1, v8, v1, v0.t
...
; RV32-NEXT:    vlse64.v v1, (a0), zero
; RV32-NEXT:    vsetvli zero, a2, e32, m2, ta, ma
; RV32-NEXT:    vwredsumu.vs v1, v8, v1, v0.t
; RV32-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV32-NEXT:    vmv.x.s a0, v1
; RV32-NEXT:    li a1, 32
; RV32-NEXT:    vsrl.vx v1, v1, a1
...
; RV64-NEXT:    vmv.s.x v1, a0
; RV64-NEXT:    vsetvli zero, a1, e32, m2, ta, ma
; RV64-NEXT:    vwredsumu.vs v1, v8, v1, v0.t
; RV64-NEXT:    vsetivli zero, 1, e64, m1, ta, ma
; RV64-NEXT:    vmv.x.s a0, v1
; RV64-NEXT:    ret
