...
; CHECK-NEXT:    vredmaxu.vs v9, v10, v10
...
; RV64-NEXT:    vredmaxu.vs v9, v10, v10
...
; RV32-NEXT:    vslidedown.vx v7, v5, a4
; RV32-NEXT:    vsetvli a4, zero, e8, mf2, ta, ma
; RV32-NEXT:    vslidedown.vx v6, v7, a3
...
; RV64-NEXT:    vsetvli zero, zero, e64, m8, ta, ma
; RV64-NEXT:    vmerge.vvm v16, v24, v16, v0
; RV64-NEXT:    vredmaxu.vs v16, v16, v16
...
; RV64-NEXT:    vslidedown.vx v7, v4, a3
; RV64-NEXT:    vsetvli a4, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v6, v7, a2
; RV64-NEXT:    vsetvli a4, zero, e8, m1, ta, ma
; RV64-NEXT:    vcpop.m a4, v6
...
; RV64-NEXT:    vsetvli a3, zero, e8, mf4, ta, ma
; RV64-NEXT:    vslidedown.vx v5, v6, a2
; RV64-NEXT:    vsetvli a2, zero, e8, m1, ta, ma
; RV64-NEXT:    vcpop.m a2, v5
