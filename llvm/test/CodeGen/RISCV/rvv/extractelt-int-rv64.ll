...
; RV64NOM-NEXT:    vmul.vx v2, v8, a0
; RV64NOM-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; RV64NOM-NEXT:    vslidedown.vi v1, v2, 3
; RV64NOM-NEXT:    vmv.x.s a0, v1
; RV64NOM-NEXT:    ret
;
; RV64M-LABEL: extractelt_mul_nxv4i32_splat:
; RV64M:       # %bb.0:
; RV64M-NEXT:    vsetivli zero, 1, e32, m1, ta, ma
; RV64M-NEXT:    vslidedown.vi v1, v8, 3
; RV64M-NEXT:    vmv.x.s a0, v1
...
; RV64NOM-NEXT:    vsetvli a1, zero, e32, m2, ta, ma
; RV64NOM-NEXT:    vmulh.vx v2, v8, a0
; RV64NOM-NEXT:    vsrl.vi v4, v2, 31
; RV64NOM-NEXT:    vadd.vv v2, v2, v4
; RV64NOM-NEXT:    vmv.x.s a0, v2
; RV64NOM-NEXT:    ret
;
