...
; LMULMAX2-NEXT:    vle8.v v1, (a0)
; LMULMAX2-NEXT:    vsext.vf4 v2, v1
...
; LMULMAX2-NEXT:    vslidedown.vi v1, v2, 8
; LMULMAX2-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-NEXT:    vsext.vf4 v4, v1
; LMULMAX2-NEXT:    vsext.vf4 v6, v2
; LMULMAX2-NEXT:    vsetivli zero, 16, e8, m2, ta, ma
; LMULMAX2-NEXT:    vslidedown.vi v2, v2, 16
; LMULMAX2-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-NEXT:    vsext.vf4 v8, v2
; LMULMAX2-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX2-NEXT:    vslidedown.vi v1, v2, 8
; LMULMAX2-NEXT:    vsetivli zero, 8, e32, m2, ta, ma
; LMULMAX2-NEXT:    vsext.vf4 v2, v1
...
; LMULMAX1-NEXT:    vle8.v v1, (a2)
; LMULMAX1-NEXT:    vle8.v v2, (a0)
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v3, v1, 4
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v4, v3
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v3, v2, 4
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v5, v3
; LMULMAX1-NEXT:    vsext.vf4 v3, v1
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v1, v1, 8
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v6, v1
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v1, v1, 4
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v7, v1
; LMULMAX1-NEXT:    vsext.vf4 v1, v2
; LMULMAX1-NEXT:    vsetivli zero, 8, e8, m1, ta, ma
; LMULMAX1-NEXT:    vslidedown.vi v2, v2, 8
; LMULMAX1-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; LMULMAX1-NEXT:    vsext.vf4 v8, v2
; LMULMAX1-NEXT:    vsetivli zero, 4, e8, mf2, ta, ma
...
; LMULMAX2-NEXT:    vnsrl.wi v1, v2, 0
; LMULMAX2-NEXT:    vsetvli zero, zero, e8, mf2, ta, ma
; LMULMAX2-NEXT:    vnsrl.wi v1, v1, 0
; LMULMAX2-NEXT:    vse8.v v1, (a1)
; LMULMAX2-NEXT:    ret
;
