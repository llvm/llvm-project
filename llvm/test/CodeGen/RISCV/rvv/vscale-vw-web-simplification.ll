...
; NO_FOLDING-NEXT:    vmerge.vim v9, v8, 1, v0
; NO_FOLDING-NEXT:    vlm.v v0, (a2)
; NO_FOLDING-NEXT:    vmv.v.v v10, v9
; NO_FOLDING-NEXT:    vadd.vi v10, v9, 1, v0.t
; NO_FOLDING-NEXT:    vmv.v.v v11, v9
; NO_FOLDING-NEXT:    vlm.v v8, (a1)
; NO_FOLDING-NEXT:    vadd.vi v11, v9, -1, v0.t
; NO_FOLDING-NEXT:    vmv.v.v v0, v8
; NO_FOLDING-NEXT:    vor.vv v10, v10, v9, v0.t
; NO_FOLDING-NEXT:    vor.vv v8, v10, v11
; NO_FOLDING-NEXT:    ret
;
...
; FOLDING-NEXT:    vmerge.vim v9, v8, 1, v0
; FOLDING-NEXT:    vlm.v v0, (a2)
; FOLDING-NEXT:    vmv.v.v v10, v9
; FOLDING-NEXT:    vadd.vi v10, v9, 1, v0.t
; FOLDING-NEXT:    vmv.v.v v11, v9
; FOLDING-NEXT:    vlm.v v8, (a1)
; FOLDING-NEXT:    vadd.vi v11, v9, -1, v0.t
...
; NO_FOLDING-NEXT:    vmerge.vim v9, v8, 1, v0
; NO_FOLDING-NEXT:    vlm.v v0, (a2)
; NO_FOLDING-NEXT:    vmv1r.v v10, v9
; NO_FOLDING-NEXT:    vadd.vi v10, v9, 1, v0.t
; NO_FOLDING-NEXT:    vmv1r.v v11, v9
; NO_FOLDING-NEXT:    vlm.v v8, (a1)
; NO_FOLDING-NEXT:    vadd.vi v11, v9, -1, v0.t
...
; FOLDING-NEXT:    vmerge.vim v9, v8, 1, v0
; FOLDING-NEXT:    vlm.v v0, (a2)
; FOLDING-NEXT:    vmv1r.v v10, v9
; FOLDING-NEXT:    vadd.vi v10, v9, 1, v0.t
; FOLDING-NEXT:    vmv1r.v v11, v9
; FOLDING-NEXT:    vlm.v v8, (a1)
; FOLDING-NEXT:    vadd.vi v11, v9, -1, v0.t
