...
; CHECK-NEXT:    vmsbc.vvm v1, v8, v9, v0
...
; CHECK-NEXT:    vmsbc.vvm v1, v8, v10, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vvm v1, v8, v12, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vvm v1, v8, v16, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; CHECK-NEXT:    vmsbc.vxm v1, v8, a0, v0
; CHECK-NEXT:    vmv1r.v v0, v1
; CHECK-NEXT:    ret
entry:
...
; RV32-NEXT:    vmsbc.vvm v1, v8, v2, v0
...
; RV64-NEXT:    vmsbc.vxm v1, v8, a0, v0
...
; RV32-NEXT:    vmsbc.vvm v1, v8, v4, v0
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    vmsbc.vvm v1, v8, v16, v0
; RV32-NEXT:    vmv1r.v v0, v1
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    ret
;
