...
; ZVFH-NEXT:    vfwcvt.f.x.v v8, v1, v0.t
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vsext.vf2 v2, v1, v0.t
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v1, v2, v0.t
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e8, mf4, ta, ma
; ZVFH-NEXT:    vfwcvt.f.x.v v1, v8, v0.t
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vsext.vf2 v1, v8, v0.t
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v2, v1, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfwcvt.f.x.v v1, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli zero, a0, e16, mf2, ta, ma
; ZVFH-NEXT:    vfncvt.f.x.w v1, v8, v0.t
; ZVFH-NEXT:    vmv1r.v v8, v1
; ZVFH-NEXT:    ret
;
...
; ZVFHMIN-NEXT:    vfcvt.f.x.v v1, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.x.w v1, v8, v0.t
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
...
; ZVFHMIN:       # %bb.0:
; ZVFHMIN-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.x.w v1, v8
; ZVFHMIN-NEXT:    vsetvli a0, zero, e16, mf2, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v1
; ZVFHMIN-NEXT:    ret
...
; CHECK-NEXT:    vfwcvt.f.x.v v8, v1, v0.t
; CHECK-NEXT:    ret
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e32, m1, ta, ma
; CHECK-NEXT:    vfwcvt.f.x.v v2, v8, v0.t
