...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; RV32-NEXT:    vfwcvt.rtz.x.f.v v1, v8
; RV32-NEXT:    vmv1r.v v8, v1
; RV32-NEXT:    ret
;
...
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; RV64-NEXT:    vfwcvt.rtz.x.f.v v1, v8
; RV64-NEXT:    vmv1r.v v8, v1
; RV64-NEXT:    ret
  %a = call <vscale x 1 x float> @llvm.trunc.nxv1f32(<vscale x 1 x float> %x)
...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; RV32-NEXT:    vfwcvt.rtz.xu.f.v v1, v8
; RV32-NEXT:    vmv1r.v v8, v1
; RV32-NEXT:    ret
;
...
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli a0, zero, e32, mf2, ta, ma
; RV64-NEXT:    vfwcvt.rtz.xu.f.v v1, v8
; RV64-NEXT:    vmv1r.v v8, v1
; RV64-NEXT:    ret
  %a = call <vscale x 1 x float> @llvm.trunc.nxv1f32(<vscale x 1 x float> %x)
...
; RV32-NEXT:    vfabs.v v2, v8
; RV32-NEXT:    lui a0, 307200
; RV32-NEXT:    fmv.w.x fa5, a0
; RV32-NEXT:    vmflt.vf v0, v2, fa5
; RV32-NEXT:    vfcvt.rtz.x.f.v v2, v8, v0.t
; RV32-NEXT:    vfcvt.f.x.v v2, v2, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV32-NEXT:    vfsgnj.vv v8, v2, v8, v0.t
...
; RV64-NEXT:    vfabs.v v2, v8
; RV64-NEXT:    lui a0, 307200
; RV64-NEXT:    fmv.w.x fa5, a0
; RV64-NEXT:    vmflt.vf v0, v2, fa5
; RV64-NEXT:    vfcvt.rtz.x.f.v v2, v8, v0.t
; RV64-NEXT:    vfcvt.f.x.v v2, v2, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV64-NEXT:    vfsgnj.vv v8, v2, v8, v0.t
...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; RV32-NEXT:    vfwcvt.rtz.x.f.v v4, v8
; RV32-NEXT:    vmv4r.v v8, v4
; RV32-NEXT:    ret
;
; RV64-LABEL: trunc_nxv4f32_to_si64:
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; RV64-NEXT:    vfwcvt.rtz.x.f.v v4, v8
...
; RV32:       # %bb.0:
; RV32-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; RV32-NEXT:    vfwcvt.rtz.xu.f.v v4, v8
; RV32-NEXT:    vmv4r.v v8, v4
; RV32-NEXT:    ret
;
...
; RV64:       # %bb.0:
; RV64-NEXT:    vsetvli a0, zero, e32, m2, ta, ma
; RV64-NEXT:    vfwcvt.rtz.xu.f.v v4, v8
; RV64-NEXT:    vmv4r.v v8, v4
; RV64-NEXT:    ret
  %a = call <vscale x 4 x float> @llvm.trunc.nxv4f32(<vscale x 4 x float> %x)
...
; RV32-NEXT:    vmflt.vf v0, v2, fa5
; RV32-NEXT:    fsrmi a0, 3
; RV32-NEXT:    vfcvt.x.f.v v2, v8, v0.t
; RV32-NEXT:    fsrm a0
; RV32-NEXT:    vfcvt.f.x.v v2, v2, v0.t
; RV32-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV32-NEXT:    vfsgnj.vv v8, v2, v8, v0.t
...
; RV64-NEXT:    vmflt.vf v0, v2, fa5
; RV64-NEXT:    fsrmi a0, 3
; RV64-NEXT:    vfcvt.x.f.v v2, v8, v0.t
; RV64-NEXT:    fsrm a0
; RV64-NEXT:    vfcvt.f.x.v v2, v2, v0.t
; RV64-NEXT:    vsetvli zero, zero, e32, m2, ta, mu
; RV64-NEXT:    vfsgnj.vv v8, v2, v8, v0.t
