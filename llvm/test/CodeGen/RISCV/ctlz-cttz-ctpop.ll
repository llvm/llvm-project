...
; RV32_NOZBB-NEXT:    srli a2, a0, 2
; RV32_NOZBB-NEXT:    and a0, a0, a1
; RV32_NOZBB-NEXT:    and a1, a2, a1
; RV32_NOZBB-NEXT:    add a0, a0, a1
; RV32_NOZBB-NEXT:    srli a1, a0, 4
; RV32_NOZBB-NEXT:    add a0, a0, a1
; RV32_NOZBB-NEXT:    slli a1, a0, 20
; RV32_NOZBB-NEXT:    andi a0, a0, 15
...
; RV64NOZBB-NEXT:    addi a1, a1, 819
; RV64NOZBB-NEXT:    srli a2, a0, 2
; RV64NOZBB-NEXT:    and a0, a0, a1
; RV64NOZBB-NEXT:    and a1, a2, a1
; RV64NOZBB-NEXT:    add a0, a0, a1
; RV64NOZBB-NEXT:    srli a1, a0, 4
; RV64NOZBB-NEXT:    add a0, a0, a1
; RV64NOZBB-NEXT:    slli a1, a0, 52
; RV64NOZBB-NEXT:    andi a0, a0, 15
...
; RV32_NOZBB-LABEL: test_cttz_i8_zero_poison:
; RV32_NOZBB:       # %bb.0:
; RV32_NOZBB-NEXT:    addi a1, a0, -1
; RV32_NOZBB-NEXT:    not a0, a0
; RV32_NOZBB-NEXT:    and a0, a0, a1
...
; RV32_NOZBB-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i8_zero_poison:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    addi a1, a0, -1
; RV64NOZBB-NEXT:    not a0, a0
; RV64NOZBB-NEXT:    and a0, a0, a1
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_cttz_i8_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    ctz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_cttz_i8_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    neg a1, a0
; RV32XTHEADBB-NEXT:    and a0, a0, a1
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_cttz_i8_zero_poison:
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    neg a1, a0
; RV64XTHEADBB-NEXT:    and a0, a0, a1
; RV64XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32_NOZBB-LABEL: test_cttz_i16_zero_poison:
; RV32_NOZBB:       # %bb.0:
; RV32_NOZBB-NEXT:    lui a1, 5
...
; RV32_NOZBB-NEXT:    ret
;
; RV64NOZBB-LABEL: test_cttz_i16_zero_poison:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    lui a1, 5
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_cttz_i16_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    ctz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_cttz_i16_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    neg a1, a0
; RV32XTHEADBB-NEXT:    and a0, a0, a1
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_cttz_i16_zero_poison:
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    neg a1, a0
; RV64XTHEADBB-NEXT:    and a0, a0, a1
; RV64XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32I-NEXT:    ret
;
; RV64I-LABEL: test_cttz_i32_zero_poison:
; RV64I:       # %bb.0:
...
; RV64I-NEXT:    ret
;
; RV32M-LABEL: test_cttz_i32_zero_poison:
; RV32M:       # %bb.0:
...
; RV32M-NEXT:    ret
;
; RV64M-LABEL: test_cttz_i32_zero_poison:
; RV64M:       # %bb.0:
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_cttz_i32_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    ctzw a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_cttz_i32_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    neg a1, a0
; RV32XTHEADBB-NEXT:    and a0, a0, a1
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_cttz_i32_zero_poison:
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    neg a1, a0
; RV64XTHEADBB-NEXT:    and a0, a0, a1
; RV64XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32I-NEXT:    ret
;
; RV64I-LABEL: test_cttz_i64_zero_poison:
; RV64I:       # %bb.0:
; RV64I-NEXT:    addi sp, sp, -16
; RV64I-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; RV64I-NEXT:    neg a1, a0
...
; RV64I-NEXT:    ret
;
; RV32M-LABEL: test_cttz_i64_zero_poison:
; RV32M:       # %bb.0:
; RV32M-NEXT:    lui a3, 30667
; RV32M-NEXT:    addi a3, a3, 1329
...
; RV32M-NEXT:    ret
;
; RV64M-LABEL: test_cttz_i64_zero_poison:
; RV64M:       # %bb.0:
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_cttz_i64_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    ctz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_cttz_i64_zero_poison:
; RV32XTHEADBB:       # %bb.0:
...
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_cttz_i64_zero_poison:
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    neg a1, a0
; RV64XTHEADBB-NEXT:    and a0, a0, a1
; RV64XTHEADBB-NEXT:    th.ff1 a0, a0
...
; RV32M-NEXT:    lui a2, 4112
; RV32M-NEXT:    and a0, a0, a1
; RV32M-NEXT:    addi a1, a2, 257
; RV32M-NEXT:    mul a0, a0, a1
...
; RV32M-NEXT:    addi a3, a2, -241
; RV32M-NEXT:    addi a2, a6, 257
...
; RV32_NOZBB-LABEL: test_ctlz_i8_zero_poison:
; RV32_NOZBB:       # %bb.0:
; RV32_NOZBB-NEXT:    slli a1, a0, 24
; RV32_NOZBB-NEXT:    srli a1, a1, 25
; RV32_NOZBB-NEXT:    or a0, a0, a1
...
; RV32_NOZBB-NEXT:    ret
;
; RV64NOZBB-LABEL: test_ctlz_i8_zero_poison:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    slli a1, a0, 56
; RV64NOZBB-NEXT:    srli a1, a1, 57
; RV64NOZBB-NEXT:    or a0, a0, a1
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_ctlz_i8_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    slli a0, a0, 56
; RV64ZBB-NEXT:    clz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_ctlz_i8_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    slli a0, a0, 24
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_ctlz_i8_zero_poison:
; RV64XTHEADBB:       # %bb.0:
...
; RV32_NOZBB-LABEL: test_ctlz_i16_zero_poison:
; RV32_NOZBB:       # %bb.0:
; RV32_NOZBB-NEXT:    lui a1, 5
...
; RV32_NOZBB-NEXT:    ret
;
; RV64NOZBB-LABEL: test_ctlz_i16_zero_poison:
; RV64NOZBB:       # %bb.0:
; RV64NOZBB-NEXT:    lui a1, 5
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_ctlz_i16_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    slli a0, a0, 48
; RV64ZBB-NEXT:    clz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_ctlz_i16_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    slli a0, a0, 16
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_ctlz_i16_zero_poison:
; RV64XTHEADBB:       # %bb.0:
...
; RV32I-NEXT:    ret
;
; RV64I-LABEL: test_ctlz_i32_zero_poison:
; RV64I:       # %bb.0:
; RV64I-NEXT:    lui a1, 349525
...
; RV64I-NEXT:    ret
;
; RV32M-LABEL: test_ctlz_i32_zero_poison:
; RV32M:       # %bb.0:
; RV32M-NEXT:    lui a1, 349525
; RV32M-NEXT:    srli a2, a0, 1
...
; RV32M-NEXT:    ret
;
; RV64M-LABEL: test_ctlz_i32_zero_poison:
; RV64M:       # %bb.0:
; RV64M-NEXT:    lui a1, 349525
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_ctlz_i32_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    clzw a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_ctlz_i32_zero_poison:
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    th.ff1 a0, a0
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_ctlz_i32_zero_poison:
; RV64XTHEADBB:       # %bb.0:
...
; RV32I-NEXT:    ret
;
; RV64I-LABEL: test_ctlz_i64_zero_poison:
; RV64I:       # %bb.0:
; RV64I-NEXT:    lui a1, 349525
; RV64I-NEXT:    srli a2, a0, 1
; RV64I-NEXT:    or a0, a0, a2
...
; RV64I-NEXT:    ret
;
; RV32M-LABEL: test_ctlz_i64_zero_poison:
; RV32M:       # %bb.0:
; RV32M-NEXT:    lui a2, 349525
; RV32M-NEXT:    lui a3, 209715
; RV32M-NEXT:    addi a5, a2, 1365
...
; RV32M-NEXT:    ret
;
; RV64M-LABEL: test_ctlz_i64_zero_poison:
; RV64M:       # %bb.0:
; RV64M-NEXT:    lui a1, 349525
; RV64M-NEXT:    srli a2, a0, 1
; RV64M-NEXT:    or a0, a0, a2
...
; RV32ZBB-NEXT:    ret
;
; RV64ZBB-LABEL: test_ctlz_i64_zero_poison:
; RV64ZBB:       # %bb.0:
; RV64ZBB-NEXT:    clz a0, a0
; RV64ZBB-NEXT:    ret
;
; RV32XTHEADBB-LABEL: test_ctlz_i64_zero_poison:
; RV32XTHEADBB:       # %bb.0:
...
; RV32XTHEADBB-NEXT:    ret
;
; RV64XTHEADBB-LABEL: test_ctlz_i64_zero_poison:
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    th.ff1 a0, a0
; RV64XTHEADBB-NEXT:    ret
...
; RV32XTHEADBB-NEXT:    andi a1, a1, 51
...
; RV64XTHEADBB-NEXT:    andi a1, a1, 51
...
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    lui a1, 5
; RV32XTHEADBB-NEXT:    srli a2, a0, 1
; RV32XTHEADBB-NEXT:    addi a1, a1, 1365
; RV32XTHEADBB-NEXT:    and a1, a2, a1
; RV32XTHEADBB-NEXT:    sub a0, a0, a1
...
; RV64XTHEADBB:       # %bb.0:
; RV64XTHEADBB-NEXT:    lui a1, 5
; RV64XTHEADBB-NEXT:    srli a2, a0, 1
; RV64XTHEADBB-NEXT:    addi a1, a1, 1365
; RV64XTHEADBB-NEXT:    and a1, a2, a1
; RV64XTHEADBB-NEXT:    sub a0, a0, a1
; RV64XTHEADBB-NEXT:    lui a1, 3
; RV64XTHEADBB-NEXT:    addi a1, a1, 819
; RV64XTHEADBB-NEXT:    srli a2, a0, 2
; RV64XTHEADBB-NEXT:    and a0, a0, a1
; RV64XTHEADBB-NEXT:    and a1, a2, a1
; RV64XTHEADBB-NEXT:    add a0, a0, a1
; RV64XTHEADBB-NEXT:    srli a1, a0, 4
...
; RV32XTHEADBB:       # %bb.0:
; RV32XTHEADBB-NEXT:    lui a1, 349525
; RV32XTHEADBB-NEXT:    srli a2, a0, 1
; RV32XTHEADBB-NEXT:    addi a1, a1, 1365
; RV32XTHEADBB-NEXT:    and a1, a2, a1
; RV32XTHEADBB-NEXT:    sub a0, a0, a1
...
; RV64XTHEADBB-NEXT:    lui a3, 209715
; RV64XTHEADBB-NEXT:    add a1, a1, a2
; RV64XTHEADBB-NEXT:    srli a2, a0, 1
; RV64XTHEADBB-NEXT:    addi a3, a3, 819
; RV64XTHEADBB-NEXT:    and a1, a2, a1
