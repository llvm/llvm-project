...
; RV32IMB:       # %bb.0:
; RV32IMB-NEXT:    li a1, 52
; RV32IMB-NEXT:    mul a0, a0, a1
; RV32IMB-NEXT:    addi a0, a0, 1924
; RV32IMB-NEXT:    ret
;
; RV64IMB-LABEL: add_mul_combine_accept_a1:
; RV64IMB:       # %bb.0:
; RV64IMB-NEXT:    li a1, 52
; RV64IMB-NEXT:    mul a0, a0, a1
; RV64IMB-NEXT:    addiw a0, a0, 1924
; RV64IMB-NEXT:    ret
  %tmp0 = add i32 %x, 37
  %tmp1 = mul i32 %tmp0, 52
  ret i32 %tmp1
}
...
; RV64IMB-NEXT:    li a1, 52
; RV64IMB-NEXT:    mul a0, a0, a1
; RV64IMB-NEXT:    addi a0, a0, 1924
; RV64IMB-NEXT:    ret
  %tmp0 = add i64 %x, 37
  %tmp1 = mul i64 %tmp0, 52
  ret i64 %tmp1
}
...
; RV32IMB-NEXT:    li a1, 52
; RV32IMB-NEXT:    mul a0, a0, a1
; RV32IMB-NEXT:    lui a1, 114
; RV32IMB-NEXT:    addi a1, a1, -1388
...
; RV64IMB-NEXT:    li a1, 52
; RV64IMB-NEXT:    mul a0, a0, a1
; RV64IMB-NEXT:    lui a1, 114
; RV64IMB-NEXT:    addiw a1, a1, -1388
...
; RV32IMB-NEXT:    add a1, a3, a1
; RV32IMB-NEXT:    mul a2, a0, a2
; RV32IMB-NEXT:    lui a0, 114
; RV32IMB-NEXT:    addi a0, a0, -1388
...
; RV32IMB-NEXT:    add a1, a3, a1
; RV32IMB-NEXT:    mul a2, a0, a2
; RV32IMB-NEXT:    lui a0, 25
; RV32IMB-NEXT:    addi a0, a0, 92
; RV32IMB-NEXT:    add a0, a2, a0
; RV32IMB-NEXT:    sltu a2, a0, a2
; RV32IMB-NEXT:    add a1, a1, a2
; RV32IMB-NEXT:    ret
