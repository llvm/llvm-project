...
; RV64-NEXT:  .Ltlsdesc_hi1:
; RV64-NEXT:    auipc a0, %tlsdesc_hi(tls_var)
; RV64-NEXT:    vse32.v v8, (a1)
; RV64-NEXT:    ld a3, %tlsdesc_load_lo(.Ltlsdesc_hi1)(a0)
; RV64-NEXT:    addi a0, a0, %tlsdesc_add_lo(.Ltlsdesc_hi1)
; RV64-NEXT:    jalr t0, 0(a3), %tlsdesc_call(.Ltlsdesc_hi1)
; RV64-NEXT:    add a0, a0, tp
; RV64-NEXT:    li a3, 1
...
; RV32-NEXT:  .Ltlsdesc_hi1:
; RV32-NEXT:    auipc a0, %tlsdesc_hi(tls_var)
; RV32-NEXT:    vse32.v v8, (a1)
; RV32-NEXT:    lw a3, %tlsdesc_load_lo(.Ltlsdesc_hi1)(a0)
; RV32-NEXT:    addi a0, a0, %tlsdesc_add_lo(.Ltlsdesc_hi1)
; RV32-NEXT:    jalr t0, 0(a3), %tlsdesc_call(.Ltlsdesc_hi1)
; RV32-NEXT:    add a0, a0, tp
; RV32-NEXT:    li a3, 1
