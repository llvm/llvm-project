...
; CHECK-RV64-NEXT:    lb t6, 96(a1)
; CHECK-RV64-NEXT:    lb s0, 104(a1)
; CHECK-RV64-NEXT:    lb s1, 112(a1)
; CHECK-RV64-NEXT:    lb a1, 120(a1)
; CHECK-RV64-NEXT:    ntl.all
...
; CHECK-RV64C-NEXT:    lb a6, 0(a1)
; CHECK-RV64C-NEXT:    lb a7, 8(a1)
; CHECK-RV64C-NEXT:    lb t0, 16(a1)
; CHECK-RV64C-NEXT:    lb t1, 24(a1)
; CHECK-RV64C-NEXT:    lb t2, 32(a1)
; CHECK-RV64C-NEXT:    lb t3, 40(a1)
; CHECK-RV64C-NEXT:    lb t4, 48(a1)
; CHECK-RV64C-NEXT:    lb t5, 56(a1)
; CHECK-RV64C-NEXT:    lb t6, 64(a1)
; CHECK-RV64C-NEXT:    lb a3, 72(a1)
; CHECK-RV64C-NEXT:    lb a4, 80(a1)
; CHECK-RV64C-NEXT:    lb a5, 88(a1)
; CHECK-RV64C-NEXT:    lb a2, 96(a1)
; CHECK-RV64C-NEXT:    lb s0, 104(a1)
; CHECK-RV64C-NEXT:    lb s1, 112(a1)
; CHECK-RV64C-NEXT:    lb a1, 120(a1)
; CHECK-RV64C-NEXT:    c.ntl.all
