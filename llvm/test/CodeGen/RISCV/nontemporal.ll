...
; CHECK-RV64-NEXT:    sd s0, 8(sp) # 8-byte Spill
; CHECK-RV64-NEXT:    sd s1, 0(sp) # 8-byte Spill
...
; CHECK-RV64-NEXT:    ld s0, 8(sp) # 8-byte Reload
; CHECK-RV64-NEXT:    ld s1, 0(sp) # 8-byte Reload
...
; CHECK-RV32-NEXT:    sw s0, 12(sp) # 4-byte Spill
; CHECK-RV32-NEXT:    sw s1, 8(sp) # 4-byte Spill
...
; CHECK-RV32-NEXT:    lw s0, 12(sp) # 4-byte Reload
; CHECK-RV32-NEXT:    lw s1, 8(sp) # 4-byte Reload
...
; CHECK-RV64C-NEXT:    sd s0, 8(sp) # 8-byte Spill
; CHECK-RV64C-NEXT:    sd s1, 0(sp) # 8-byte Spill
...
; CHECK-RV64C-NEXT:    ld s0, 8(sp) # 8-byte Reload
; CHECK-RV64C-NEXT:    ld s1, 0(sp) # 8-byte Reload
...
; CHECK-RV32C-NEXT:    sw s0, 12(sp) # 4-byte Spill
; CHECK-RV32C-NEXT:    sw s1, 8(sp) # 4-byte Spill
...
; CHECK-RV32C-NEXT:    lw s0, 12(sp) # 4-byte Reload
; CHECK-RV32C-NEXT:    lw s1, 8(sp) # 4-byte Reload
