...
; RV32IFZFHMIN-NEXT:    add a1, a1, a2
...
; RV32IFZFHMIN-NEXT:    add a0, a1, a0
...
; RV32IFDZFHMIN-NEXT:    add a0, a1, a0
...
; RV64IFDZFHMIN-NEXT:    add a0, a1, a0
...
; RV32IZDINX-NEXT:    add a0, a0, a2
; RV32IZDINX-NEXT:    add a0, a0, a1
...
; RV64IZDINX-NEXT:    add a0, a0, a1
; RV64IZDINX-NEXT:    lui a1, 1048560
...
; RV64IFD-NEXT:    add a1, a1, a2
; RV64IFD-NEXT:    add a0, a1, a0
; RV64IFD-NEXT:    fmv.w.x fa0, a0
; RV64IFD-NEXT:    ret
;
...
; RV32IFZFHMIN-NEXT:    add a0, a0, a1
; RV32IFZFHMIN-NEXT:    fmv.h.x fa0, a0
; RV32IFZFHMIN-NEXT:    ret
;
