...
; CHECK-NEXT:    ld a2, 0(a2)
; CHECK-NEXT:    ld a1, 0(a1)
; CHECK-NEXT:    srliw a3, a2, 16
; CHECK-NEXT:    srliw a4, a1, 16
; CHECK-NEXT:    zext.h a5, a2
; CHECK-NEXT:    zext.h a6, a1
