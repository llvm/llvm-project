...
; RV64IM-NEXT:    lui a6, %hi(.LCPI7_0)
; RV64IM-NEXT:    ld a6, %lo(.LCPI7_0)(a6)
...
; RV64IM-NEXT:    xor a3, a3, a0
; RV64IM-NEXT:    xor a1, a1, s4
; RV64IM-NEXT:    lui a5, %hi(.LCPI8_0)
; RV64IM-NEXT:    ld a5, %lo(.LCPI8_0)(a5)
...
; RV64IM-NEXT:    xor a2, a2, a0
; RV64IM-NEXT:    xor a1, a1, s4
; RV64IM-NEXT:    lui a6, %hi(.LCPI9_0)
; RV64IM-NEXT:    ld a6, %lo(.LCPI9_0)(a6)
; RV64IM-NEXT:    slli t0, t0, 56
; RV64IM-NEXT:    ld a0, 304(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a0, a5, a0
; RV64IM-NEXT:    ld t1, 344(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    xor a2, a2, a0
; RV64IM-NEXT:    xor a1, a1, s4
; RV64IM-NEXT:    lui a6, %hi(.LCPI10_0)
; RV64IM-NEXT:    ld a0, 304(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a0, a5, a0
; RV64IM-NEXT:    lui a5, 5
; RV64IM-NEXT:    ld a6, %lo(.LCPI10_0)(a6)
