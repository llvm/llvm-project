...
; RUN: llc -mtriple=riscv32 -O2 -verify-machineinstrs -mattr=+b,+xventanacondops < %s | FileCheck %s -check-prefix=RV32XVENTANACONDOPS
; RUN: llc -mtriple=riscv64 -O2 -verify-machineinstrs -mattr=+b,+xventanacondops < %s | FileCheck %s -check-prefix=RV64XVENTANACONDOPS
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    snez a2, a2
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a2, a0
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and:
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and_x_multiple_uses:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    snez a0, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a1, a0, a2
; RV32XVENTANACONDOPS-NEXT:    add a0, a1, a0
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and_x_multiple_uses:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    snez a0, a0
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a1, a0, a1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and_y_multiple_uses:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    snez a2, a2
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
...
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and_y_multiple_uses:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    snez a1, a1
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a1, a0
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and_xy_multiple_uses:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    snez a1, a2
; RV32XVENTANACONDOPS-NEXT:    snez a0, a0
; RV32XVENTANACONDOPS-NEXT:    and a2, a0, a1
; RV32XVENTANACONDOPS-NEXT:    add a0, a1, a0
; RV32XVENTANACONDOPS-NEXT:    add a0, a2, a0
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and_xy_multiple_uses:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    snez a1, a1
; RV64XVENTANACONDOPS-NEXT:    snez a0, a0
; RV64XVENTANACONDOPS-NEXT:    and a2, a0, a1
; RV64XVENTANACONDOPS-NEXT:    add a0, a1, a0
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and_select:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    sgtz a5, a3
; RV32XVENTANACONDOPS-NEXT:    snez a2, a2
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a5, a5, a3
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a5
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a2, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a4, a0
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and_select:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    sgtz a1, a1
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a1, a0
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: icmp_and_and:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    snez a0, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    or a4, a4, a5
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: icmp_and_and:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    snez a0, a0
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: and_icmp_eq_non_constant:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    xor t0, a1, a5
; RV32XVENTANACONDOPS-NEXT:    sltu a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, t0
; RV32XVENTANACONDOPS-NEXT:    sltu a1, a1, a5
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    xor a1, a3, a7
; RV32XVENTANACONDOPS-NEXT:    xor a4, a2, a6
; RV32XVENTANACONDOPS-NEXT:    or a4, a4, a1
; RV32XVENTANACONDOPS-NEXT:    sltu a2, a2, a6
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a1, a2, a1
; RV32XVENTANACONDOPS-NEXT:    sltu a2, a3, a7
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    or a1, a1, a2
; RV32XVENTANACONDOPS-NEXT:    or a0, a1, a0
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: and_icmp_eq_non_constant:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    sltu a0, a0, a2
; RV64XVENTANACONDOPS-NEXT:    xor a2, a1, a3
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a2
; RV64XVENTANACONDOPS-NEXT:    sltu a1, a1, a3
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: and_icmp_ne_non_constant:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    xor t0, a1, a5
; RV32XVENTANACONDOPS-NEXT:    sltu a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, t0
...
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: and_icmp_ne_non_constant:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    sltu a0, a0, a2
; RV64XVENTANACONDOPS-NEXT:    xor a2, a1, a3
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a2
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: and_icmp_eq_non_constant_multiple_uses:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    xor t0, a1, a5
; RV32XVENTANACONDOPS-NEXT:    sltu a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, t0
; RV32XVENTANACONDOPS-NEXT:    xor a3, a3, a7
; RV32XVENTANACONDOPS-NEXT:    xor a2, a2, a6
; RV32XVENTANACONDOPS-NEXT:    sltu a1, a1, a5
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    seqz a1, a2
; RV32XVENTANACONDOPS-NEXT:    and a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    add a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: and_icmp_eq_non_constant_multiple_uses:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    xor a1, a1, a3
; RV64XVENTANACONDOPS-NEXT:    sltu a0, a0, a2
; RV64XVENTANACONDOPS-NEXT:    seqz a1, a1
; RV64XVENTANACONDOPS-NEXT:    and a0, a0, a1
; RV64XVENTANACONDOPS-NEXT:    add a0, a0, a1
; RV64XVENTANACONDOPS-NEXT:    ret
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: rotate_l_nez:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a4, a4, 1
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a2, a2, a4
; RV32XVENTANACONDOPS-NEXT:    bexti a3, a2, 5
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a4, a0, a3
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a5, a1, a3
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a3
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a3
; RV32XVENTANACONDOPS-NEXT:    or a4, a5, a4
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    sll a1, a4, a2
; RV32XVENTANACONDOPS-NEXT:    srli a3, a0, 1
; RV32XVENTANACONDOPS-NEXT:    not a5, a2
; RV32XVENTANACONDOPS-NEXT:    srl a3, a3, a5
; RV32XVENTANACONDOPS-NEXT:    srli a4, a4, 1
; RV32XVENTANACONDOPS-NEXT:    sll a2, a0, a2
; RV32XVENTANACONDOPS-NEXT:    srl a4, a4, a5
; RV32XVENTANACONDOPS-NEXT:    or a0, a1, a3
; RV32XVENTANACONDOPS-NEXT:    or a1, a2, a4
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: rotate_l_nez:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a2
; RV64XVENTANACONDOPS-NEXT:    rol a0, a0, a1
; RV64XVENTANACONDOPS-NEXT:    ret
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: rotate_l_eqz:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a4, a4, 1
...
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: rotate_l_eqz:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a2, a2, 1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_imm_reg:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV32XVENTANACONDOPS-NEXT:    addi a0, a0, -3
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a2
; RV32XVENTANACONDOPS-NEXT:    addi a0, a0, 3
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_imm_reg:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a1, a1, 1
; RV64XVENTANACONDOPS-NEXT:    addi a0, a0, -3
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_reg_imm:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV32XVENTANACONDOPS-NEXT:    addi a0, a0, -3
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a2
...
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_reg_imm:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a1, a1, 1
; RV64XVENTANACONDOPS-NEXT:    addi a0, a0, -3
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_imm_reg_neg_2048:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV32XVENTANACONDOPS-NEXT:    xori a0, a0, -2048
; RV32XVENTANACONDOPS-NEXT:    neg a3, a2
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    or a1, a3, a1
; RV32XVENTANACONDOPS-NEXT:    xori a0, a0, -2048
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_imm_reg_neg_2048:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a1, a1, 1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_imm_reg_2048:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV32XVENTANACONDOPS-NEXT:    bseti a3, zero, 11
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a3, a3, a2
; RV32XVENTANACONDOPS-NEXT:    or a0, a3, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a2
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_imm_reg_2048:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a1, a1, 1
; RV64XVENTANACONDOPS-NEXT:    bseti a2, zero, 11
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: test_inv_and_nez:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a4, a4, 1
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a3, a3, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a2, a2, a4
; RV32XVENTANACONDOPS-NEXT:    andn a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    andn a1, a1, a3
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: test_inv_and_nez:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a1, a1, a2
; RV64XVENTANACONDOPS-NEXT:    andn a0, a0, a1
; RV64XVENTANACONDOPS-NEXT:    ret
  %5 = xor i64 %x, -1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: test_inv_and_eqz:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    andi a4, a4, 1
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a3, a3, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a2, a2, a4
; RV32XVENTANACONDOPS-NEXT:    andn a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    andn a1, a1, a3
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: test_inv_and_eqz:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    andi a2, a2, 1
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a2
; RV64XVENTANACONDOPS-NEXT:    andn a0, a0, a1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: pr166596:
; RV32XVENTANACONDOPS:       # %bb.0: # %entry
; RV32XVENTANACONDOPS-NEXT:    xori a0, a0, 1
; RV32XVENTANACONDOPS-NEXT:    zext.h a0, a0
; RV32XVENTANACONDOPS-NEXT:    clz a0, a0
; RV32XVENTANACONDOPS-NEXT:    andi a1, a1, 1
; RV32XVENTANACONDOPS-NEXT:    addi a0, a0, 41
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    addi a0, a0, -9
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: pr166596:
; RV64XVENTANACONDOPS:       # %bb.0: # %entry
; RV64XVENTANACONDOPS-NEXT:    xori a0, a0, 1
; RV64XVENTANACONDOPS-NEXT:    zext.h a0, a0
; RV64XVENTANACONDOPS-NEXT:    clz a0, a0
; RV64XVENTANACONDOPS-NEXT:    andi a1, a1, 1
; RV64XVENTANACONDOPS-NEXT:    addi a0, a0, 9
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a0, a0, a1
; RV64XVENTANACONDOPS-NEXT:    addi a0, a0, -9
; RV64XVENTANACONDOPS-NEXT:    ret
entry:
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_wo_optsize_minsize:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a2, a2, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a3, a3, a4
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a1, a1, a4
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    or a1, a1, a3
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_wo_optsize_minsize:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a1, a1, a2
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a0, a2
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_w_optsize:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    bnez a4, .LBB19_2
; RV32XVENTANACONDOPS-NEXT:  # %bb.1:
; RV32XVENTANACONDOPS-NEXT:    mv a0, a2
; RV32XVENTANACONDOPS-NEXT:    mv a1, a3
; RV32XVENTANACONDOPS-NEXT:  .LBB19_2:
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_w_optsize:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    bnez a2, .LBB19_2
; RV64XVENTANACONDOPS-NEXT:  # %bb.1:
; RV64XVENTANACONDOPS-NEXT:    mv a0, a1
; RV64XVENTANACONDOPS-NEXT:  .LBB19_2:
; RV64XVENTANACONDOPS-NEXT:    ret
  %r = select i1 %c, i64 %true, i64 %false
  ret i64 %r
}
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: select_w_minsize:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    bnez a4, .LBB20_2
; RV32XVENTANACONDOPS-NEXT:  # %bb.1:
; RV32XVENTANACONDOPS-NEXT:    mv a0, a2
; RV32XVENTANACONDOPS-NEXT:    mv a1, a3
; RV32XVENTANACONDOPS-NEXT:  .LBB20_2:
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: select_w_minsize:
; RV64XVENTANACONDOPS:       # %bb.0:
; RV64XVENTANACONDOPS-NEXT:    bnez a2, .LBB20_2
; RV64XVENTANACONDOPS-NEXT:  # %bb.1:
; RV64XVENTANACONDOPS-NEXT:    mv a0, a1
; RV64XVENTANACONDOPS-NEXT:  .LBB20_2:
; RV64XVENTANACONDOPS-NEXT:    ret
  %r = select i1 %c, i64 %true, i64 %false
  ret i64 %r
}
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: and_icmp_eq_non_zero:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    srli a3, a3, 31
; RV32XVENTANACONDOPS-NEXT:    xori a0, a0, 1234
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
...
; RV64ZICOND-NEXT:    ret
;
; RV32XVENTANACONDOPS-LABEL: and_icmp_ne_non_zero:
; RV32XVENTANACONDOPS:       # %bb.0:
; RV32XVENTANACONDOPS-NEXT:    xori a2, a2, 1234
; RV32XVENTANACONDOPS-NEXT:    or a2, a2, a3
; RV32XVENTANACONDOPS-NEXT:    xori a0, a0, 1234
; RV32XVENTANACONDOPS-NEXT:    snez a2, a2
; RV32XVENTANACONDOPS-NEXT:    or a0, a0, a1
...
; RV32XVENTANACONDOPS-NEXT:    ret
;
; RV64XVENTANACONDOPS-LABEL: and_icmp_ne_non_zero:
; RV64XVENTANACONDOPS:       # %bb.0:
