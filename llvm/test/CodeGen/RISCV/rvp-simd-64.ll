...
; RV32-NEXT:    pmseq.db a6, a0, a6
; RV32-NEXT:    sw a6, 8(sp)
; RV32-NEXT:    sw a7, 12(sp)
; RV32-NEXT:    lbu a3, 12(sp)
; RV32-NEXT:    lbu a6, 13(sp)
; RV32-NEXT:    lbu a7, 14(sp)
; RV32-NEXT:    lbu t0, 15(sp)
; RV32-NEXT:    lbu t1, 8(sp)
; RV32-NEXT:    lbu t2, 9(sp)
; RV32-NEXT:    lbu t3, 10(sp)
; RV32-NEXT:    lbu t4, 11(sp)
; RV32-NEXT:    not t6, t0
; RV32-NEXT:    not t5, a6
; RV32-NEXT:    not a7, a7
; RV32-NEXT:    not a6, a3
; RV32-NEXT:    ppaire.db a6, a6, t5
; RV32-NEXT:    not t6, t4
; RV32-NEXT:    not t5, t2
; RV32-NEXT:    not t2, t3
; RV32-NEXT:    not t1, t1
; RV32-NEXT:    pli.b a3, 127
; RV32-NEXT:    pmsltz.db t3, a0
; RV32-NEXT:    merge t4, a3, a2
; RV32-NEXT:    ppaire.db t1, t1, t5
; RV32-NEXT:    pack a1, a6, a7
; RV32-NEXT:    pack a0, t1, t2
; RV32-NEXT:    merge a1, a5, t4
; RV32-NEXT:    merge t3, a3, a2
; RV32-NEXT:    merge a0, a4, t3
; RV32-NEXT:    addi sp, sp, 16
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
;
...
; RV32-NEXT:    .cfi_def_cfa_offset 16
; RV32-NEXT:    lui a3, 8
; RV32-NEXT:    psll.dhs a4, a0, a2
; RV32-NEXT:    psra.dhs a6, a4, a2
; RV32-NEXT:    pmseq.dh a6, a0, a6
; RV32-NEXT:    sw a6, 8(sp)
; RV32-NEXT:    sw a7, 12(sp)
; RV32-NEXT:    lh a2, 14(sp)
; RV32-NEXT:    lh a6, 12(sp)
; RV32-NEXT:    lh a7, 10(sp)
; RV32-NEXT:    lh t0, 8(sp)
; RV32-NEXT:    not a2, a2
; RV32-NEXT:    not a6, a6
; RV32-NEXT:    pack a2, a6, a2
; RV32-NEXT:    plui.h a6, -512
; RV32-NEXT:    pmsltz.dh t1, a0
; RV32-NEXT:    addi a3, a3, -1
; RV32-NEXT:    pmv.hs a0, a3
; RV32-NEXT:    merge t2, a0, a6
; RV32-NEXT:    merge a2, a5, t2
; RV32-NEXT:    merge t1, a0, a6
; RV32-NEXT:    not a0, a7
; RV32-NEXT:    not a1, t0
...
; RV32-NEXT:    lh a2, 6(sp)
; RV32-NEXT:    sll a2, a2, a3
; RV32-NEXT:    sext.h a4, a2
; RV32-NEXT:    sra a3, a4, a3
; RV32-NEXT:    sh a3, 22(sp)
; RV32-NEXT:    lhu a4, 12(sp)
; RV32-NEXT:    lh a3, 4(sp)
; RV32-NEXT:    sll a3, a3, a4
; RV32-NEXT:    sext.h a5, a3
; RV32-NEXT:    sra a4, a5, a4
; RV32-NEXT:    sh a4, 20(sp)
; RV32-NEXT:    lhu a4, 10(sp)
; RV32-NEXT:    lh a5, 2(sp)
; RV32-NEXT:    sll a5, a5, a4
; RV32-NEXT:    sext.h a6, a5
; RV32-NEXT:    sra a4, a6, a4
; RV32-NEXT:    sh a4, 18(sp)
; RV32-NEXT:    lhu a4, 8(sp)
; RV32-NEXT:    lh a6, 0(sp)
; RV32-NEXT:    lw a7, 20(sp)
; RV32-NEXT:    sll t0, a6, a4
; RV32-NEXT:    sext.h a6, t0
; RV32-NEXT:    sra a4, a6, a4
; RV32-NEXT:    sh a4, 16(sp)
; RV32-NEXT:    lw a6, 16(sp)
; RV32-NEXT:    pmseq.dh a6, a0, a6
; RV32-NEXT:    sw a6, 24(sp)
; RV32-NEXT:    sw a7, 28(sp)
; RV32-NEXT:    lh a4, 24(sp)
; RV32-NEXT:    lh a6, 26(sp)
; RV32-NEXT:    lh a7, 28(sp)
; RV32-NEXT:    lh t1, 30(sp)
; RV32-NEXT:    pack a3, a3, a2
; RV32-NEXT:    pack a5, t0, a5
; RV32-NEXT:    lui t0, 8
; RV32-NEXT:    not a2, t1
; RV32-NEXT:    not a7, a7
; RV32-NEXT:    pack a2, a7, a2
; RV32-NEXT:    plui.h a7, -512
; RV32-NEXT:    pmsltz.dh t1, a0
; RV32-NEXT:    addi t0, t0, -1
; RV32-NEXT:    pmv.hs a0, t0
; RV32-NEXT:    merge t2, a0, a7
; RV32-NEXT:    not a1, a6
; RV32-NEXT:    not a4, a4
; RV32-NEXT:    merge a2, a3, t2
; RV32-NEXT:    merge t1, a0, a7
; RV32-NEXT:    pack a0, a4, a1
; RV32-NEXT:    merge a0, a5, t1
; RV32-NEXT:    mv a1, a2
; RV32-NEXT:    addi sp, sp, 32
; RV32-NEXT:    .cfi_def_cfa_offset 0
; RV32-NEXT:    ret
...
; RV32-NEXT:    bnez a0, .LBB211_5
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    lh a1, 22(sp)
; RV32-NEXT:    sh a1, 30(sp)
; RV32-NEXT:    beqz a0, .LBB211_6
; RV32-NEXT:  .LBB211_2:
; RV32-NEXT:    lh a1, 12(sp)
; RV32-NEXT:    sh a1, 28(sp)
; RV32-NEXT:    beqz a0, .LBB211_7
; RV32-NEXT:  .LBB211_3:
; RV32-NEXT:    lh a1, 10(sp)
; RV32-NEXT:    sh a1, 26(sp)
; RV32-NEXT:    beqz a0, .LBB211_8
; RV32-NEXT:  .LBB211_4:
; RV32-NEXT:    lh a0, 8(sp)
; RV32-NEXT:    j .LBB211_9
; RV32-NEXT:  .LBB211_5:
; RV32-NEXT:    lh a1, 14(sp)
; RV32-NEXT:    sh a1, 30(sp)
; RV32-NEXT:    bnez a0, .LBB211_2
; RV32-NEXT:  .LBB211_6:
; RV32-NEXT:    lh a1, 20(sp)
; RV32-NEXT:    sh a1, 28(sp)
; RV32-NEXT:    bnez a0, .LBB211_3
; RV32-NEXT:  .LBB211_7:
; RV32-NEXT:    lh a1, 18(sp)
; RV32-NEXT:    sh a1, 26(sp)
; RV32-NEXT:    bnez a0, .LBB211_4
; RV32-NEXT:  .LBB211_8:
; RV32-NEXT:    lh a0, 16(sp)
; RV32-NEXT:  .LBB211_9:
; RV32-NEXT:    sh a0, 24(sp)
...
; RV32-NEXT:    sw a3, 16(sp)
; RV32-NEXT:    sw a1, 8(sp)
; RV32-NEXT:    bnez a0, .LBB212_9
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    lbu a1, 23(sp)
; RV32-NEXT:    sb a1, 31(sp)
; RV32-NEXT:    beqz a0, .LBB212_10
; RV32-NEXT:  .LBB212_2:
; RV32-NEXT:    lbu a1, 14(sp)
; RV32-NEXT:    sb a1, 30(sp)
; RV32-NEXT:    beqz a0, .LBB212_11
; RV32-NEXT:  .LBB212_3:
; RV32-NEXT:    lbu a1, 13(sp)
; RV32-NEXT:    sb a1, 29(sp)
; RV32-NEXT:    beqz a0, .LBB212_12
; RV32-NEXT:  .LBB212_4:
; RV32-NEXT:    lbu a1, 12(sp)
; RV32-NEXT:    sb a1, 28(sp)
; RV32-NEXT:    beqz a0, .LBB212_13
; RV32-NEXT:  .LBB212_5:
; RV32-NEXT:    lbu a1, 11(sp)
; RV32-NEXT:    sb a1, 27(sp)
; RV32-NEXT:    beqz a0, .LBB212_14
; RV32-NEXT:  .LBB212_6:
; RV32-NEXT:    lbu a1, 10(sp)
; RV32-NEXT:    sb a1, 26(sp)
; RV32-NEXT:    beqz a0, .LBB212_15
; RV32-NEXT:  .LBB212_7:
; RV32-NEXT:    lbu a1, 9(sp)
; RV32-NEXT:    sb a1, 25(sp)
; RV32-NEXT:    beqz a0, .LBB212_16
; RV32-NEXT:  .LBB212_8:
; RV32-NEXT:    lbu a0, 8(sp)
; RV32-NEXT:    j .LBB212_17
; RV32-NEXT:  .LBB212_9:
; RV32-NEXT:    lbu a1, 15(sp)
; RV32-NEXT:    sb a1, 31(sp)
; RV32-NEXT:    bnez a0, .LBB212_2
; RV32-NEXT:  .LBB212_10:
; RV32-NEXT:    lbu a1, 22(sp)
; RV32-NEXT:    sb a1, 30(sp)
; RV32-NEXT:    bnez a0, .LBB212_3
; RV32-NEXT:  .LBB212_11:
; RV32-NEXT:    lbu a1, 21(sp)
; RV32-NEXT:    sb a1, 29(sp)
; RV32-NEXT:    bnez a0, .LBB212_4
; RV32-NEXT:  .LBB212_12:
; RV32-NEXT:    lbu a1, 20(sp)
; RV32-NEXT:    sb a1, 28(sp)
; RV32-NEXT:    bnez a0, .LBB212_5
; RV32-NEXT:  .LBB212_13:
; RV32-NEXT:    lbu a1, 19(sp)
; RV32-NEXT:    sb a1, 27(sp)
; RV32-NEXT:    bnez a0, .LBB212_6
; RV32-NEXT:  .LBB212_14:
; RV32-NEXT:    lbu a1, 18(sp)
; RV32-NEXT:    sb a1, 26(sp)
; RV32-NEXT:    bnez a0, .LBB212_7
; RV32-NEXT:  .LBB212_15:
; RV32-NEXT:    lbu a1, 17(sp)
; RV32-NEXT:    sb a1, 25(sp)
; RV32-NEXT:    bnez a0, .LBB212_8
; RV32-NEXT:  .LBB212_16:
; RV32-NEXT:    lbu a0, 16(sp)
; RV32-NEXT:  .LBB212_17:
; RV32-NEXT:    sb a0, 24(sp)
