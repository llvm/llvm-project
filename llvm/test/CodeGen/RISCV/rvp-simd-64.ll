...
; RV32-NEXT:    mv a0, a4
; RV32-NEXT:    beqz a7, .LBB229_3
; RV32-NEXT:  # %bb.1:
; RV32-NEXT:    beqz a6, .LBB229_4
; RV32-NEXT:  .LBB229_2:
; RV32-NEXT:    mv a1, a5
; RV32-NEXT:    ret
; RV32-NEXT:  .LBB229_3:
; RV32-NEXT:    mv a5, a3
; RV32-NEXT:    bnez a6, .LBB229_2
; RV32-NEXT:  .LBB229_4:
; RV32-NEXT:    mv a0, a2
; RV32-NEXT:    mv a1, a5
; RV32-NEXT:    ret
