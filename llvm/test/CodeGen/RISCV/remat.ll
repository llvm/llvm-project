...
; CHECK-NEXT:    ld a1, 272(sp)
; CHECK-NEXT:    lbu a2, 208(sp)
; CHECK-NEXT:    lw a0, 224(sp)
; CHECK-NEXT:    lh a4, 216(sp)
; CHECK-NEXT:    flh fa4, 240(sp)
; CHECK-NEXT:    ld a3, 232(sp)
; CHECK-NEXT:    flw fa5, 256(sp)
; CHECK-NEXT:    flh fa2, 248(sp)
; CHECK-NEXT:    fld fa3, 264(sp)
; CHECK-NEXT:    sb a2, 0(a1)
; CHECK-NEXT:    sh a4, 0(a1)
; CHECK-NEXT:    sw a0, 0(a1)
; CHECK-NEXT:    sd a3, 0(a1)
; CHECK-NEXT:    fsh fa4, 0(a1)
