...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sgt_constant_2046:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, 2047
; RV32XQCILIA-NEXT:    xori a0, a0, 1
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sgt_constant_2047:
; RV32XQCILIA:       # %bb.0:
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sgt_constant_neg_2049:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, -2048
; RV32XQCILIA-NEXT:    xori a0, a0, 1
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sgt_constant_neg_2050:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    lui a1, 1048575
; RV32XQCILIA-NEXT:    addi a1, a1, 2046
; RV32XQCILIA-NEXT:    slt a0, a1, a0
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slt a0, a0, a1
; RV32XQCILIA-NEXT:    xori a0, a0, 1
; RV32XQCILIA-NEXT:    ret
  %1 = icmp sge i32 %a, %b
  %2 = zext i1 %1 to i32
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge_constant_zero:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    not a0, a0
; RV32XQCILIA-NEXT:    srli a0, a0, 31
; RV32XQCILIA-NEXT:    ret
  %1 = icmp sge i32 %a, 0
  %2 = zext i1 %1 to i32
  ret i32 %2
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge_constant_2047:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, 2047
; RV32XQCILIA-NEXT:    xori a0, a0, 1
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge_constant_2048:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    li a1, 2047
; RV32XQCILIA-NEXT:    slt a0, a1, a0
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge_constant_neg_2047:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, -2047
; RV32XQCILIA-NEXT:    xori a0, a0, 1
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sge_constant_neg_2048:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    not a0, a0
; RV32XQCILIA-NEXT:    srli a0, a0, 31
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_slt_constant_zero:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    srli a0, a0, 31
; RV32XQCILIA-NEXT:    ret
  %1 = icmp slt i32 %a, 0
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_slt_constant_2047:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, 2047
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_slt_constant_2048:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    li a1, 1
; RV32XQCILIA-NEXT:    slli a1, a1, 11
; RV32XQCILIA-NEXT:    slt a0, a0, a1
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_slt_constant_neg_2048:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, -2048
; RV32XQCILIA-NEXT:    ret
  %1 = icmp slt i32 %a, -2048
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_slt_constant_neg_2049:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    lui a1, 1048575
; RV32XQCILIA-NEXT:    addi a1, a1, 2047
; RV32XQCILIA-NEXT:    slt a0, a0, a1
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sle_constant_zero:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, 1
; RV32XQCILIA-NEXT:    ret
  %1 = icmp sle i32 %a, 0
  %2 = zext i1 %1 to i32
  ret i32 %2
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sle_constant_2046:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, 2047
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sle_constant_2047:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    li a1, 1
; RV32XQCILIA-NEXT:    slli a1, a1, 11
; RV32XQCILIA-NEXT:    slt a0, a0, a1
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sle_constant_neg_2049:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    slti a0, a0, -2048
; RV32XQCILIA-NEXT:    ret
...
; RV32I-NEXT:    ret
;
; RV32XQCILIA-LABEL: icmp_sle_constant_neg_2050:
; RV32XQCILIA:       # %bb.0:
; RV32XQCILIA-NEXT:    lui a1, 1048575
; RV32XQCILIA-NEXT:    addi a1, a1, 2047
; RV32XQCILIA-NEXT:    slt a0, a0, a1
