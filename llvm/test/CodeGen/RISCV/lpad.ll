...
; RUN: llc -mtriple riscv32 -mattr=+zicfilp < %s | FileCheck %s --check-prefixes=CHECK,RV32
; RUN: llc -mtriple riscv64 -mattr=+zicfilp < %s | FileCheck %s --check-prefixes=CHECK,RV64
