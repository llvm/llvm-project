...
; RV64I-FPELIM-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-FPELIM-NEXT:    sd s0, 0(sp) # 8-byte Spill
; RV64I-FPELIM-NEXT:    mv s0, a0
; RV64I-FPELIM-NEXT:    mv a0, a1
; RV64I-FPELIM-NEXT:    call __fixsfdi
; RV64I-FPELIM-NEXT:    add a0, s0, a0
; RV64I-FPELIM-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-FPELIM-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-FPELIM-NEXT:    addi sp, sp, 16
...
; RV64I-WITHFP-NEXT:    sd ra, 24(sp) # 8-byte Spill
; RV64I-WITHFP-NEXT:    sd s0, 16(sp) # 8-byte Spill
; RV64I-WITHFP-NEXT:    sd s1, 8(sp) # 8-byte Spill
...
; RV64I-WITHFP-NEXT:    ld ra, 24(sp) # 8-byte Reload
; RV64I-WITHFP-NEXT:    ld s0, 16(sp) # 8-byte Reload
; RV64I-WITHFP-NEXT:    ld s1, 8(sp) # 8-byte Reload
; RV64I-WITHFP-NEXT:    addi sp, sp, 32
...
; RV64I-WITHFP-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-WITHFP-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64I-WITHFP-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-WITHFP-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-WITHFP-NEXT:    addi sp, sp, 16
; RV64I-WITHFP-NEXT:    ret
