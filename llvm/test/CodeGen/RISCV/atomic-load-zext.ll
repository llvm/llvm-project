...
;
; RV32IA-ZALASR-LABEL: atomic_load_i1_acquire:
; RV32IA-ZALASR:       # %bb.0:
; RV32IA-ZALASR-NEXT:    lbu a0, 0(a0)
; RV32IA-ZALASR-NEXT:    ret
;
; RV64IA-ZALASR-LABEL: atomic_load_i1_acquire:
; RV64IA-ZALASR:       # %bb.0:
; RV64IA-ZALASR-NEXT:    lbu a0, 0(a0)
...
; RV64IA-TSO-TRAILING-FENCE-NEXT:    ret
;
; RV32IA-ZALASR-LABEL: atomic_load_i8_acquire:
; RV32IA-ZALASR:       # %bb.0:
; RV32IA-ZALASR-NEXT:    lbu a0, 0(a0)
; RV32IA-ZALASR-NEXT:    ret
;
; RV64IA-ZALASR-LABEL: atomic_load_i8_acquire:
; RV64IA-ZALASR:       # %bb.0:
; RV64IA-ZALASR-NEXT:    lbu a0, 0(a0)
; RV64IA-ZALASR-NEXT:    ret
  %1 = load atomic i8, ptr %a acquire, align 1
...
; RV64IA-TSO-TRAILING-FENCE-NEXT:    ret
;
; RV32IA-ZALASR-LABEL: atomic_load_i16_acquire:
; RV32IA-ZALASR:       # %bb.0:
; RV32IA-ZALASR-NEXT:    lhu a0, 0(a0)
; RV32IA-ZALASR-NEXT:    ret
;
; RV64IA-ZALASR-LABEL: atomic_load_i16_acquire:
; RV64IA-ZALASR:       # %bb.0:
; RV64IA-ZALASR-NEXT:    lhu a0, 0(a0)
; RV64IA-ZALASR-NEXT:    ret
...
;
; RV64IA-ZALASR-LABEL: atomic_load_i32_acquire:
; RV64IA-ZALASR:       # %bb.0:
; RV64IA-ZALASR-NEXT:    lwu a0, 0(a0)
; RV64IA-ZALASR-NEXT:    ret
