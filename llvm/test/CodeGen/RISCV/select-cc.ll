...
; RV32IXQCI-NEXT:    sw ra, 12(sp) # 4-byte Spill
; RV32IXQCI-NEXT:    sw s0, 8(sp) # 4-byte Spill
...
; RV32IXQCI-NEXT:    mv a0, s0
; RV32IXQCI-NEXT:    lw ra, 12(sp) # 4-byte Reload
; RV32IXQCI-NEXT:    lw s0, 8(sp) # 4-byte Reload
; RV32IXQCI-NEXT:    addi sp, sp, 16
; RV32IXQCI-NEXT:    ret
;
...
; RV64I-CCMOV-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64I-CCMOV-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-CCMOV-NEXT:    addi sp, sp, 16
; RV64I-CCMOV-NEXT:    ret
  %5 = icmp eq i16 %0, 0
