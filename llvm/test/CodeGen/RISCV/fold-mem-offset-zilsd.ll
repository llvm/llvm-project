...
; RUN: llc -mtriple=riscv32 -mattr=+zilsd | FileCheck %s --check-prefixes=RV32ZILSD
; RUN: llc -mtriple=riscv32 -mattr=+zilsd,+zba | FileCheck %s --check-prefixes=RV32ZILSDZBA
