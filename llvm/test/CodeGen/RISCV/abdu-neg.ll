...
; RV32I-NEXT:  # %bb.6:
; RV32I-NEXT:    sltu a3, t0, a6
; RV32I-NEXT:    j .LBB11_8
; RV32I-NEXT:  .LBB11_7:
; RV32I-NEXT:    sltu a3, a3, a7
; RV32I-NEXT:  .LBB11_8:
...
; RV32ZBB-NEXT:    sub a7, a3, a7
; RV32ZBB-NEXT:    beq a6, t0, .LBB11_7
; RV32ZBB-NEXT:  # %bb.6:
; RV32ZBB-NEXT:    sltu a3, t0, a6
; RV32ZBB-NEXT:    j .LBB11_8
; RV32ZBB-NEXT:  .LBB11_7:
; RV32ZBB-NEXT:    sltu a3, a3, a7
...
; RV32ZBB-NEXT:    neg t1, a3
; RV32ZBB-NEXT:    xor a5, a7, t1
; RV32ZBB-NEXT:    xor t3, a6, t1
; RV32ZBB-NEXT:    sltu t2, a5, t1
; RV32ZBB-NEXT:    add a4, t3, a3
; RV32ZBB-NEXT:    sub a4, a4, t2
; RV32ZBB-NEXT:    add a5, a5, a3
; RV32ZBB-NEXT:    snez t0, a4
; RV32ZBB-NEXT:    snez a7, a5
; RV32ZBB-NEXT:    or t0, a7, t0
; RV32ZBB-NEXT:    beqz a6, .LBB11_12
; RV32ZBB-NEXT:  # %bb.11:
; RV32ZBB-NEXT:    sltu t2, t3, t1
; RV32ZBB-NEXT:  .LBB11_12:
; RV32ZBB-NEXT:    xor a2, a2, t1
; RV32ZBB-NEXT:    xor a1, a1, t1
; RV32ZBB-NEXT:    add a6, a2, a3
; RV32ZBB-NEXT:    sltu a2, a2, t1
; RV32ZBB-NEXT:    add a1, a1, a3
; RV32ZBB-NEXT:    sub a3, a6, t2
; RV32ZBB-NEXT:    sub a1, a1, a2
; RV32ZBB-NEXT:    neg a2, a3
; RV32ZBB-NEXT:    sltu a6, a6, t2
; RV32ZBB-NEXT:    sub a1, a1, a6
; RV32ZBB-NEXT:    snez a3, a3
; RV32ZBB-NEXT:    sltu a6, a2, t0
; RV32ZBB-NEXT:    add a1, a1, a3
