...
; RV64I-NEXT:    or a4, a5, a1
; RV64I-NEXT:    or a5, a6, a3
...
; RV64I-NEXT:    lbu t1, 14(a0)
; RV64I-NEXT:    lbu t2, 15(a0)
; RV64I-NEXT:    lbu t3, 12(a0)
; RV64I-NEXT:    lbu t4, 10(a0)
; RV64I-NEXT:    lbu a0, 11(a0)
; RV64I-NEXT:    slli a6, a6, 8
; RV64I-NEXT:    or a6, a6, a7
; RV64I-NEXT:    slli t0, t0, 8
; RV64I-NEXT:    slli t1, t1, 16
...
; RV64I-NEXT:    lbu t3, 29(a0)
; RV64I-NEXT:    lbu t4, 30(a0)
; RV64I-NEXT:    lbu t5, 31(a0)
; RV64I-NEXT:    or a7, t0, a7
; RV64I-NEXT:    or t0, t6, t1
; RV64I-NEXT:    or a0, a6, a5
; RV64I-NEXT:    or a5, t0, a7
; RV64I-NEXT:    slli t3, t3, 8
...
; RV32I-NEXT:    sll a5, t2, a5
; RV32I-NEXT:    or a5, t1, a5
; RV32I-NEXT:    srl a6, t3, a6
...
; RV64I-NEXT:    sraiw a1, a6, 31
; RV64I-NEXT:    srli a6, a7, 3
; RV64I-NEXT:    sd a1, 32(sp)
; RV64I-NEXT:    sd a1, 40(sp)
; RV64I-NEXT:    sd a1, 48(sp)
; RV64I-NEXT:    sd a1, 56(sp)
; RV64I-NEXT:    andi a1, a6, 24
; RV64I-NEXT:    mv a6, sp
; RV64I-NEXT:    sd a3, 0(sp)
; RV64I-NEXT:    sd a4, 8(sp)
; RV64I-NEXT:    sd a0, 16(sp)
; RV64I-NEXT:    sd a5, 24(sp)
; RV64I-NEXT:    add a1, a6, a1
; RV64I-NEXT:    ld a3, 16(a1)
; RV64I-NEXT:    ld a4, 8(a1)
; RV64I-NEXT:    andi a0, a7, 63
; RV64I-NEXT:    xori a5, a0, 63
; RV64I-NEXT:    ld a6, 0(a1)
; RV64I-NEXT:    ld t0, 24(a1)
; RV64I-NEXT:    slli a0, a3, 1
; RV64I-NEXT:    srl a1, a4, a7
; RV64I-NEXT:    sll a0, a0, a5
; RV64I-NEXT:    or a0, a1, a0
; RV64I-NEXT:    slli a4, a4, 1
; RV64I-NEXT:    srl a1, a6, a7
; RV64I-NEXT:    sll a4, a4, a5
; RV64I-NEXT:    or a1, a1, a4
; RV64I-NEXT:    slli a4, t0, 1
...
; RV32I-NEXT:    slli a6, t1, 1
; RV32I-NEXT:    srl t4, t0, a7
; RV32I-NEXT:    sll a6, a6, a5
; RV32I-NEXT:    or a6, t4, a6
; RV32I-NEXT:    slli t0, t0, 1
; RV32I-NEXT:    srl t2, t2, a7
; RV32I-NEXT:    sll t0, t0, a5
; RV32I-NEXT:    or t0, t2, t0
; RV32I-NEXT:    slli t2, t3, 1
