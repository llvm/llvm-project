...
; CHECK-NEXT:   experimental-smeihv              - 'Smeihv' (External Interrupt Hardware Vectoring at Machine Level).
...
; CHECK-NEXT:   experimental-sseihv              - 'Sseihv' (External Interrupt Hardware Vectoring at Supervisor Level).
