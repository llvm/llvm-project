...
; RV32I-FPELIM-NEXT:    sw s0, 8(sp) # 4-byte Spill
...
; RV32I-FPELIM-NEXT:    lw s0, 8(sp) # 4-byte Reload
; RV32I-FPELIM-NEXT:    addi sp, sp, 16
...
; RV32I-WITHFP-NEXT:    sw s1, 4(sp) # 4-byte Spill
...
; RV32I-WITHFP-NEXT:    lw s1, 4(sp) # 4-byte Reload
; RV32I-WITHFP-NEXT:    addi sp, sp, 16
