...
; RV64I-LP64E-FPELIM-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-LP64E-FPELIM-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64I-LP64E-FPELIM-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-LP64E-FPELIM-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-LP64E-FPELIM-NEXT:    addi sp, sp, 16
...
; RV64I-LP64E-WITHFP-NEXT:    sd ra, 16(sp) # 8-byte Spill
; RV64I-LP64E-WITHFP-NEXT:    sd s0, 8(sp) # 8-byte Spill
; RV64I-LP64E-WITHFP-NEXT:    sd s1, 0(sp) # 8-byte Spill
...
; RV64I-LP64E-WITHFP-NEXT:    ld ra, 16(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    ld s0, 8(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    ld s1, 0(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    addi sp, sp, 24
...
; RV64I-LP64E-WITHFP-NEXT:    sd ra, 8(sp) # 8-byte Spill
; RV64I-LP64E-WITHFP-NEXT:    sd s0, 0(sp) # 8-byte Spill
...
; RV64I-LP64E-WITHFP-NEXT:    ld ra, 8(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    ld s0, 0(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    addi sp, sp, 16
; RV64I-LP64E-WITHFP-NEXT:    ret
...
; RV64I-LP64E-FPELIM-NEXT:    sd ra, 40(sp) # 8-byte Spill
; RV64I-LP64E-FPELIM-NEXT:    sd s0, 32(sp) # 8-byte Spill
...
; RV64I-LP64E-FPELIM-NEXT:    ld ra, 40(sp) # 8-byte Reload
; RV64I-LP64E-FPELIM-NEXT:    ld s0, 32(sp) # 8-byte Reload
; RV64I-LP64E-FPELIM-NEXT:    addi sp, sp, 48
; RV64I-LP64E-FPELIM-NEXT:    ret
;
...
; RV64I-LP64E-WITHFP-NEXT:    sd ra, 40(sp) # 8-byte Spill
; RV64I-LP64E-WITHFP-NEXT:    sd s0, 32(sp) # 8-byte Spill
...
; RV64I-LP64E-WITHFP-NEXT:    ld ra, 40(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    ld s0, 32(sp) # 8-byte Reload
; RV64I-LP64E-WITHFP-NEXT:    addi sp, sp, 48
; RV64I-LP64E-WITHFP-NEXT:    ret
