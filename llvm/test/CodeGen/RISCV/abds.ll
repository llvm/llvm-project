...
; RV32I-NEXT:  .LBB11_2:
; RV32I-NEXT:    sltu t2, a5, a4
; RV32I-NEXT:    sltu t5, a1, a3
; RV32I-NEXT:    mv t3, t2
; RV32I-NEXT:    beq a3, a1, .LBB11_4
; RV32I-NEXT:  # %bb.3:
; RV32I-NEXT:    mv t3, t5
; RV32I-NEXT:  .LBB11_4:
...
; RV32I-NEXT:  .LBB11_6:
; RV32I-NEXT:    mv t4, t2
; RV32I-NEXT:    beq a1, a3, .LBB11_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    mv t4, t5
; RV32I-NEXT:  .LBB11_8:
; RV32I-NEXT:    sltu t5, a4, a5
; RV32I-NEXT:    mv t6, t5
; RV32I-NEXT:    beq a3, a1, .LBB11_10
; RV32I-NEXT:  # %bb.9:
; RV32I-NEXT:    sltu t6, a3, a1
; RV32I-NEXT:  .LBB11_10:
...
; RV32I-NEXT:    sub a1, a3, t5
; RV32I-NEXT:    sub a3, a6, t6
; RV32I-NEXT:  .LBB11_13:
...
; RV32ZBB-NEXT:    sltu t2, a5, a4
; RV32ZBB-NEXT:    sltu t5, a1, a3
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq a3, a1, .LBB11_4
; RV32ZBB-NEXT:  # %bb.3:
...
; RV32ZBB-NEXT:    sub a1, a3, t5
; RV32ZBB-NEXT:    sub a3, a6, t6
...
; RV32I-NEXT:  .LBB12_6:
; RV32I-NEXT:    mv t4, t2
; RV32I-NEXT:    beq a1, a3, .LBB12_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    mv t4, t5
; RV32I-NEXT:  .LBB12_8:
; RV32I-NEXT:    sltu t5, a4, a5
; RV32I-NEXT:    mv t6, t5
; RV32I-NEXT:    beq a3, a1, .LBB12_10
; RV32I-NEXT:  # %bb.9:
; RV32I-NEXT:    sltu t6, a3, a1
; RV32I-NEXT:  .LBB12_10:
...
; RV32ZBB-NEXT:    sltu t5, a1, a3
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq a3, a1, .LBB12_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, t5
...
; RV32ZBB-NEXT:    mv t4, t2
; RV32ZBB-NEXT:    beq a1, a3, .LBB12_8
; RV32ZBB-NEXT:  # %bb.7:
; RV32ZBB-NEXT:    mv t4, t5
; RV32ZBB-NEXT:  .LBB12_8:
; RV32ZBB-NEXT:    sltu t5, a4, a5
; RV32ZBB-NEXT:    mv t6, t5
; RV32ZBB-NEXT:    beq a3, a1, .LBB12_10
; RV32ZBB-NEXT:  # %bb.9:
; RV32ZBB-NEXT:    sltu t6, a3, a1
...
; RV32I-NEXT:  .LBB17_6:
; RV32I-NEXT:    mv t4, t2
; RV32I-NEXT:    beq a1, a3, .LBB17_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    mv t4, t5
; RV32I-NEXT:  .LBB17_8:
; RV32I-NEXT:    sltu t5, a4, a5
; RV32I-NEXT:    mv t6, t5
; RV32I-NEXT:    beq a3, a1, .LBB17_10
; RV32I-NEXT:  # %bb.9:
; RV32I-NEXT:    sltu t6, a3, a1
; RV32I-NEXT:  .LBB17_10:
...
; RV32ZBB-NEXT:    sltu t5, a1, a3
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq a3, a1, .LBB17_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, t5
...
; RV32ZBB-NEXT:    mv t4, t2
; RV32ZBB-NEXT:    beq a1, a3, .LBB17_8
; RV32ZBB-NEXT:  # %bb.7:
; RV32ZBB-NEXT:    mv t4, t5
; RV32ZBB-NEXT:  .LBB17_8:
; RV32ZBB-NEXT:    sltu t5, a4, a5
; RV32ZBB-NEXT:    mv t6, t5
; RV32ZBB-NEXT:    beq a3, a1, .LBB17_10
; RV32ZBB-NEXT:  # %bb.9:
; RV32ZBB-NEXT:    sltu t6, a3, a1
...
; RV32I-NEXT:  .LBB22_6:
; RV32I-NEXT:    mv t4, t2
; RV32I-NEXT:    beq a1, a3, .LBB22_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    mv t4, t5
; RV32I-NEXT:  .LBB22_8:
; RV32I-NEXT:    sltu t5, a4, a5
; RV32I-NEXT:    mv t6, t5
; RV32I-NEXT:    beq a3, a1, .LBB22_10
; RV32I-NEXT:  # %bb.9:
; RV32I-NEXT:    sltu t6, a3, a1
; RV32I-NEXT:  .LBB22_10:
...
; RV32ZBB-NEXT:    sltu t5, a1, a3
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq a3, a1, .LBB22_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, t5
...
; RV32ZBB-NEXT:    mv t4, t2
; RV32ZBB-NEXT:    beq a1, a3, .LBB22_8
; RV32ZBB-NEXT:  # %bb.7:
; RV32ZBB-NEXT:    mv t4, t5
; RV32ZBB-NEXT:  .LBB22_8:
; RV32ZBB-NEXT:    sltu t5, a4, a5
; RV32ZBB-NEXT:    mv t6, t5
; RV32ZBB-NEXT:    beq a3, a1, .LBB22_10
; RV32ZBB-NEXT:  # %bb.9:
; RV32ZBB-NEXT:    sltu t6, a3, a1
...
; RV32I-NEXT:    sltu a1, a3, a7
; RV32I-NEXT:    sub t1, t0, t1
; RV32I-NEXT:    sltu t0, a4, a5
; RV32I-NEXT:    sub a1, t1, a1
; RV32I-NEXT:    mv t1, t0
; RV32I-NEXT:    beq a6, a2, .LBB31_2
; RV32I-NEXT:  # %bb.1:
...
; RV32ZBB-NEXT:    sltu a1, a3, a7
; RV32ZBB-NEXT:    sub t1, t0, t1
; RV32ZBB-NEXT:    sltu t0, a4, a5
; RV32ZBB-NEXT:    sub a1, t1, a1
; RV32ZBB-NEXT:    mv t1, t0
; RV32ZBB-NEXT:    beq a6, a2, .LBB31_2
; RV32ZBB-NEXT:  # %bb.1:
...
; RV32ZBB-NEXT:    sub a1, t1, a1
; RV32ZBB-NEXT:    mv t1, t0
; RV32ZBB-NEXT:    beq a6, a2, .LBB32_2
; RV32ZBB-NEXT:  # %bb.1:
; RV32ZBB-NEXT:    sltu t1, a6, a2
...
; RV32I-NEXT:  .LBB38_6:
; RV32I-NEXT:    mv t4, t2
; RV32I-NEXT:    beq a1, a3, .LBB38_8
; RV32I-NEXT:  # %bb.7:
; RV32I-NEXT:    mv t4, t5
; RV32I-NEXT:  .LBB38_8:
; RV32I-NEXT:    sltu t5, a4, a5
; RV32I-NEXT:    mv t6, t5
; RV32I-NEXT:    beq a3, a1, .LBB38_10
; RV32I-NEXT:  # %bb.9:
; RV32I-NEXT:    sltu t6, a3, a1
; RV32I-NEXT:  .LBB38_10:
...
; RV32ZBB-NEXT:    sltu t5, a1, a3
; RV32ZBB-NEXT:    mv t3, t2
; RV32ZBB-NEXT:    beq a3, a1, .LBB38_4
; RV32ZBB-NEXT:  # %bb.3:
; RV32ZBB-NEXT:    mv t3, t5
...
; RV32ZBB-NEXT:    mv t4, t2
; RV32ZBB-NEXT:    beq a1, a3, .LBB38_8
; RV32ZBB-NEXT:  # %bb.7:
; RV32ZBB-NEXT:    mv t4, t5
; RV32ZBB-NEXT:  .LBB38_8:
; RV32ZBB-NEXT:    sltu t5, a4, a5
; RV32ZBB-NEXT:    mv t6, t5
; RV32ZBB-NEXT:    beq a3, a1, .LBB38_10
; RV32ZBB-NEXT:  # %bb.9:
; RV32ZBB-NEXT:    sltu t6, a3, a1
