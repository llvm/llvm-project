...
; TODO: Use an out-of-order tune to test fusion without anti-dep breaking.
;       We should find a way to coordinate fusion/anti-dep breaker then
;       remove -mtune=generic-ooo below.
;RUN: llc < %s -mtriple=riscv64 -mattr=+f,+fusion-lui-addi -mcpu=sifive-u74 \
;RUN:   -mtune=generic-ooo \
...
; NOFUSION:       # %bb.0:
; NOFUSION-NEXT:    lui a5, 3014
; NOFUSION-NEXT:    mv a0, a1
; NOFUSION-NEXT:    addi a1, a5, 334
; NOFUSION-NEXT:    tail bar
;
...
; FUSION-GENERIC-NEXT:    addi a1, a1, 334
; FUSION-GENERIC-NEXT:    tail bar
