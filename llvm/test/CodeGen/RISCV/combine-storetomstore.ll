...
; RISCV-NEXT:    vmv1r.v v0, v9
; RISCV-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; RISCV-NEXT:    vle16.v v9, (a3)
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vmerge.vim v10, v10, 1, v0
; RISCV-NEXT:    vslidedown.vi v10, v10, 1
; RISCV-NEXT:    vmv.x.s a3, v10
; RISCV-NEXT:    andi a3, a3, 1
; RISCV-NEXT:    bnez a3, .LBB4_7
; RISCV-NEXT:  # %bb.6:
; RISCV-NEXT:    addi a3, a1, 2
; RISCV-NEXT:    j .LBB4_8
; RISCV-NEXT:  .LBB4_7:
; RISCV-NEXT:    addi a3, a0, 8
; RISCV-NEXT:  .LBB4_8:
; RISCV-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; RISCV-NEXT:    vle16.v v10, (a3)
; RISCV-NEXT:    lh a3, 0(a2)
; RISCV-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RISCV-NEXT:    vmv.x.s a2, v9
; RISCV-NEXT:    vfirst.m a5, v8
; RISCV-NEXT:    vmv.x.s a4, v10
...
; RISCV-NEXT:    sh a3, 0(a1)
; RISCV-NEXT:    vmv.x.s a0, v8
; RISCV-NEXT:    sh a4, 2(a1)
...
; RISCV-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; RISCV-NEXT:    vmsne.vi v8, v8, 0
; RISCV-NEXT:    vmv.v.i v11, 0
; RISCV-NEXT:    vmv1r.v v0, v8
; RISCV-NEXT:    vmerge.vim v10, v11, 1, v0
; RISCV-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
...
; RISCV-NEXT:    vmv1r.v v0, v9
; RISCV-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; RISCV-NEXT:    vmerge.vim v11, v11, 1, v0
; RISCV-NEXT:    vsetivli zero, 2, e8, mf4, ta, ma
; RISCV-NEXT:    vslidedown.vi v11, v11, 2
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vmsne.vi v11, v11, 0
; RISCV-NEXT:    vmv1r.v v0, v11
; RISCV-NEXT:    vmerge.vim v13, v12, 1, v0
; RISCV-NEXT:    vslidedown.vi v13, v13, 1
; RISCV-NEXT:    vmv.x.s a4, v13
; RISCV-NEXT:    andi a4, a4, 1
; RISCV-NEXT:    bnez a4, .LBB11_7
; RISCV-NEXT:  # %bb.6:
; RISCV-NEXT:    addi a4, a1, 6
; RISCV-NEXT:    j .LBB11_8
; RISCV-NEXT:  .LBB11_7:
...
; RISCV-NEXT:    vmerge.vim v13, v12, 1, v0
; RISCV-NEXT:    vslidedown.vi v13, v13, 1
; RISCV-NEXT:    vmv.x.s a5, v13
; RISCV-NEXT:    andi a5, a5, 1
; RISCV-NEXT:    bnez a5, .LBB11_12
; RISCV-NEXT:  # %bb.9:
; RISCV-NEXT:    addi a5, a1, 10
; RISCV-NEXT:    vfirst.m a6, v10
; RISCV-NEXT:    bnez a6, .LBB11_13
; RISCV-NEXT:  .LBB11_10:
; RISCV-NEXT:    addi a6, a0, 48
; RISCV-NEXT:    vfirst.m a7, v11
; RISCV-NEXT:    bnez a7, .LBB11_14
; RISCV-NEXT:  .LBB11_11:
; RISCV-NEXT:    addi a7, a0, 16
; RISCV-NEXT:    j .LBB11_15
; RISCV-NEXT:  .LBB11_12:
; RISCV-NEXT:    addi a5, a0, 40
; RISCV-NEXT:    vfirst.m a6, v10
; RISCV-NEXT:    beqz a6, .LBB11_10
; RISCV-NEXT:  .LBB11_13:
; RISCV-NEXT:    addi a6, a1, 12
; RISCV-NEXT:    vfirst.m a7, v11
; RISCV-NEXT:    beqz a7, .LBB11_11
; RISCV-NEXT:  .LBB11_14:
; RISCV-NEXT:    addi a7, a1, 4
; RISCV-NEXT:  .LBB11_15:
; RISCV-NEXT:    vmv1r.v v0, v9
; RISCV-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; RISCV-NEXT:    vle16.v v11, (a3)
; RISCV-NEXT:    vle16.v v13, (a4)
; RISCV-NEXT:    vle16.v v14, (a5)
; RISCV-NEXT:    vsetivli zero, 2, e8, mf8, ta, ma
; RISCV-NEXT:    vle32.v v9, (a6)
; RISCV-NEXT:    vle32.v v10, (a7)
; RISCV-NEXT:    vmerge.vim v12, v12, 1, v0
; RISCV-NEXT:    vslidedown.vi v12, v12, 1
; RISCV-NEXT:    vmv.x.s a3, v12
; RISCV-NEXT:    andi a3, a3, 1
; RISCV-NEXT:    bnez a3, .LBB11_17
; RISCV-NEXT:  # %bb.16:
; RISCV-NEXT:    addi a6, a1, 2
; RISCV-NEXT:    j .LBB11_18
; RISCV-NEXT:  .LBB11_17:
; RISCV-NEXT:    addi a6, a0, 8
; RISCV-NEXT:  .LBB11_18:
; RISCV-NEXT:    lh a5, 0(a2)
; RISCV-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; RISCV-NEXT:    vmv.x.s a2, v11
; RISCV-NEXT:    vmv.x.s a4, v13
; RISCV-NEXT:    vmv.x.s a3, v14
; RISCV-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; RISCV-NEXT:    vle16.v v11, (a6)
; RISCV-NEXT:    vsetivli zero, 2, e64, m1, ta, ma
; RISCV-NEXT:    vmv.x.s a6, v9
; RISCV-NEXT:    vmv.x.s a7, v10
; RISCV-NEXT:    vfirst.m t1, v8
; RISCV-NEXT:    vmv.x.s t0, v11
; RISCV-NEXT:    beqz t1, .LBB11_20
; RISCV-NEXT:  # %bb.19:
; RISCV-NEXT:    addi a0, a1, 8
; RISCV-NEXT:    j .LBB11_21
; RISCV-NEXT:  .LBB11_20:
; RISCV-NEXT:    addi a0, a0, 32
; RISCV-NEXT:  .LBB11_21:
; RISCV-NEXT:    lh a0, 0(a0)
; RISCV-NEXT:    sh a5, 0(a1)
; RISCV-NEXT:    sh t0, 2(a1)
; RISCV-NEXT:    sh a7, 4(a1)
; RISCV-NEXT:    sh a4, 6(a1)
; RISCV-NEXT:    sh a0, 8(a1)
; RISCV-NEXT:    sh a3, 10(a1)
