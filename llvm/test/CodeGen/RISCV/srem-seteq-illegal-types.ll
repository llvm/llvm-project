...
; RV32-NEXT:    slli a4, a0, 6
; RV32-NEXT:    add a2, a0, a2
; RV32-NEXT:    add a3, a3, a4
; RV32-NEXT:    slli a4, a0, 8
; RV32-NEXT:    slli a5, a0, 15
; RV32-NEXT:    add a4, a4, a5
; RV32-NEXT:    slli a5, a0, 17
; RV32-NEXT:    sub a3, a3, a2
; RV32-NEXT:    add a4, a4, a5
; RV32-NEXT:    slli a2, a0, 19
; RV32-NEXT:    slli a5, a0, 21
...
; RV32-NEXT:    lui a0, 1324
; RV32-NEXT:    srli a3, a3, 3
; RV32-NEXT:    addi a0, a0, -165
...
; RV64-NEXT:    slli a5, a0, 15
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a5, a0, 17
; RV64-NEXT:    sub a3, a3, a2
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a2, a0, 19
; RV64-NEXT:    slli a5, a0, 21
...
; RV64-NEXT:    slli a3, a3, 35
; RV64-NEXT:    lui a0, 1324
; RV64-NEXT:    srli a3, a3, 35
; RV64-NEXT:    addi a0, a0, -165
...
; RV64-NEXT:    mv a0, s2
; RV64-NEXT:    call __moddi3
; RV64-NEXT:    slli a1, s4, 2
; RV64-NEXT:    slli a2, s4, 4
; RV64-NEXT:    slli a3, s4, 6
; RV64-NEXT:    add a1, s4, a1
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s4, 8
; RV64-NEXT:    slli a4, s4, 10
; RV64-NEXT:    add a3, a3, a4
; RV64-NEXT:    slli a4, s4, 12
; RV64-NEXT:    add a1, a1, a2
; RV64-NEXT:    add a3, a3, a4
; RV64-NEXT:    slli a2, s4, 14
; RV64-NEXT:    slli a4, s4, 16
; RV64-NEXT:    add a2, a2, a4
; RV64-NEXT:    slli a4, s4, 18
; RV64-NEXT:    add a2, a2, a4
; RV64-NEXT:    slli a4, s4, 20
; RV64-NEXT:    add a1, a1, a3
; RV64-NEXT:    add a2, a2, a4
; RV64-NEXT:    slli a3, s4, 22
; RV64-NEXT:    slli a4, s4, 24
; RV64-NEXT:    add a3, a3, a4
; RV64-NEXT:    slli a4, s4, 26
; RV64-NEXT:    add a3, a3, a4
; RV64-NEXT:    slli a4, s4, 28
; RV64-NEXT:    add a3, a3, a4
; RV64-NEXT:    slli s4, s4, 30
; RV64-NEXT:    add a1, a1, a2
; RV64-NEXT:    add a3, a3, s4
; RV64-NEXT:    add a1, a1, a3
; RV64-NEXT:    slli a2, s3, 32
; RV64-NEXT:    slli a3, s3, 34
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s3, 36
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s3, 38
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s3, 40
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s3, 42
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    slli a3, s3, 44
; RV64-NEXT:    slli a4, s3, 48
; RV64-NEXT:    slli a5, s3, 50
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a5, s3, 52
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a5, s3, 54
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a5, s3, 56
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    slli a5, s3, 58
; RV64-NEXT:    add a4, a4, a5
; RV64-NEXT:    lui a5, %hi(.LCPI3_0)
; RV64-NEXT:    slli a6, s3, 60
...
; RV64-NEXT:    add a2, a2, a3
; RV64-NEXT:    add a4, a4, s3
; RV64-NEXT:    add a1, a1, a2
; RV64-NEXT:    sub a2, a5, a4
...
; RV64-NEXT:    srli a3, a0, 61
; RV64-NEXT:    srli a4, a2, 62
...
; RV64M-NEXT:    mul a3, a3, a6
; RV64M-NEXT:    srli a6, a5, 63
...
; RV64M-NEXT:    slli a5, a5, 2
; RV64M-NEXT:    add a4, a4, a6
; RV64M-NEXT:    add a1, a1, a5
; RV64M-NEXT:    add a3, a3, a7
; RV64M-NEXT:    add a2, a2, a4
; RV64M-NEXT:    slli a4, a4, 3
; RV64M-NEXT:    addi a1, a1, -2
; RV64M-NEXT:    sub a2, a2, a4
...
; RV32MV-NEXT:    lw a3, 8(a0)
; RV32MV-NEXT:    lw a4, 4(a0)
; RV32MV-NEXT:    lw a0, 0(a0)
; RV32MV-NEXT:    slli a5, a1, 30
; RV32MV-NEXT:    srli s1, a3, 2
; RV32MV-NEXT:    slli a6, a3, 31
; RV32MV-NEXT:    or s1, s1, a5
; RV32MV-NEXT:    srli a5, a4, 1
; RV32MV-NEXT:    srli a1, a1, 2
; RV32MV-NEXT:    or s2, a5, a6
; RV32MV-NEXT:    slli a1, a1, 31
; RV32MV-NEXT:    srli a3, a3, 1
; RV32MV-NEXT:    srai s3, a1, 31
; RV32MV-NEXT:    slli a3, a3, 31
; RV32MV-NEXT:    srai s4, a3, 31
; RV32MV-NEXT:    slli a1, a4, 31
...
; RV32MV-NEXT:    vslidedown.vi v9, v8, 3
; RV32MV-NEXT:    vmv.x.s a4, v9
; RV32MV-NEXT:    slli a5, a1, 1
; RV32MV-NEXT:    sub a5, a5, a0
; RV32MV-NEXT:    srli a0, a2, 30
; RV32MV-NEXT:    slli a3, a3, 2
; RV32MV-NEXT:    or a0, a3, a0
; RV32MV-NEXT:    andi a4, a4, 1
; RV32MV-NEXT:    srli a1, a1, 31
; RV32MV-NEXT:    slli a4, a4, 1
; RV32MV-NEXT:    or a1, a1, a4
; RV32MV-NEXT:    vse32.v v8, (s0)
; RV32MV-NEXT:    andi a0, a0, 7
; RV32MV-NEXT:    slli a2, a2, 2
; RV32MV-NEXT:    or a1, a1, a2
; RV32MV-NEXT:    sw a5, 4(s0)
...
; RV64MV-NEXT:    lui a2, %hi(.LCPI3_1)
; RV64MV-NEXT:    ld a2, %lo(.LCPI3_1)(a2)
; RV64MV-NEXT:    lwu a3, 8(a0)
; RV64MV-NEXT:    lbu a4, 12(a0)
; RV64MV-NEXT:    slli a5, a1, 31
; RV64MV-NEXT:    lui a6, %hi(.LCPI3_0)
; RV64MV-NEXT:    srai a5, a5, 31
; RV64MV-NEXT:    ld a6, %lo(.LCPI3_0)(a6)
; RV64MV-NEXT:    mulh a2, a5, a2
; RV64MV-NEXT:    srli a1, a1, 2
; RV64MV-NEXT:    slli a7, a3, 62
; RV64MV-NEXT:    or a1, a7, a1
; RV64MV-NEXT:    lui a7, %hi(.LCPI3_2)
; RV64MV-NEXT:    srai a1, a1, 31
; RV64MV-NEXT:    slli a4, a4, 32
; RV64MV-NEXT:    mulh a6, a1, a6
; RV64MV-NEXT:    ld a7, %lo(.LCPI3_2)(a7)
; RV64MV-NEXT:    or a3, a3, a4
; RV64MV-NEXT:    slli a3, a3, 29
; RV64MV-NEXT:    srli a4, a2, 63
; RV64MV-NEXT:    srai a3, a3, 31
; RV64MV-NEXT:    add a2, a2, a4
; RV64MV-NEXT:    slli a4, a2, 1
; RV64MV-NEXT:    slli a2, a2, 2
; RV64MV-NEXT:    add a2, a2, a4
; RV64MV-NEXT:    mulh a4, a3, a7
; RV64MV-NEXT:    sub a5, a5, a2
; RV64MV-NEXT:    srli a2, a6, 63
; RV64MV-NEXT:    srai a6, a6, 1
; RV64MV-NEXT:    vsetivli zero, 4, e64, m2, ta, ma
; RV64MV-NEXT:    vmv.v.x v8, a5
; RV64MV-NEXT:    add a2, a6, a2
; RV64MV-NEXT:    slli a5, a2, 3
; RV64MV-NEXT:    add a1, a1, a2
; RV64MV-NEXT:    sub a1, a1, a5
; RV64MV-NEXT:    vslide1down.vx v8, v8, a1
; RV64MV-NEXT:    srli a1, a4, 63
; RV64MV-NEXT:    srai a4, a4, 1
; RV64MV-NEXT:    add a1, a4, a1
; RV64MV-NEXT:    slli a2, a1, 2
; RV64MV-NEXT:    add a1, a3, a1
; RV64MV-NEXT:    add a1, a1, a2
; RV64MV-NEXT:    vslide1down.vx v8, v8, a1
; RV64MV-NEXT:    vslidedown.vi v8, v8, 1
; RV64MV-NEXT:    lui a1, 32
; RV64MV-NEXT:    addi a1, a1, 256
; RV64MV-NEXT:    vmv.s.x v12, a1
; RV64MV-NEXT:    vsext.vf8 v10, v12
; RV64MV-NEXT:    li a1, -1
...
; RV64MV-NEXT:    vmv.x.s a3, v9
; RV64MV-NEXT:    vmv.x.s a4, v8
; RV64MV-NEXT:    slli a5, a2, 2
; RV64MV-NEXT:    srli a6, a3, 62
; RV64MV-NEXT:    or a5, a6, a5
; RV64MV-NEXT:    and a1, a4, a1
; RV64MV-NEXT:    slli a3, a3, 33
; RV64MV-NEXT:    slli a2, a2, 31
; RV64MV-NEXT:    or a1, a1, a3
; RV64MV-NEXT:    srli a2, a2, 61
; RV64MV-NEXT:    sd a1, 0(a0)
; RV64MV-NEXT:    sw a5, 8(a0)
