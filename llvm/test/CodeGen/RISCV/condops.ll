...
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a4, a4, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a2, a2, a0
; RV32XVENTANACONDOPS-NEXT:    add a0, a1, a3
; RV32XVENTANACONDOPS-NEXT:    add a1, a2, a4
; RV32XVENTANACONDOPS-NEXT:    ret
;
...
; RV64XVENTANACONDOPS-NEXT:    vt.maskc a0, a1, a0
; RV64XVENTANACONDOPS-NEXT:    add a0, a0, a2
; RV64XVENTANACONDOPS-NEXT:    ret
;
...
; RV32ZICOND-NEXT:    czero.nez a4, a4, a0
; RV32ZICOND-NEXT:    czero.eqz a2, a2, a0
; RV32ZICOND-NEXT:    add a0, a1, a3
; RV32ZICOND-NEXT:    add a1, a2, a4
; RV32ZICOND-NEXT:    ret
;
...
; RV32XVENTANACONDOPS-NEXT:    add a0, a2, a1
; RV32XVENTANACONDOPS-NEXT:    add a1, a4, a3
; RV32XVENTANACONDOPS-NEXT:    ret
;
...
; RV32ZICOND-NEXT:    add a0, a2, a1
; RV32ZICOND-NEXT:    add a1, a4, a3
; RV32ZICOND-NEXT:    ret
;
...
; RV32XVENTANACONDOPS-NEXT:    add a0, a0, a1
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a1, a6, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a2, a4, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a3, a7, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskc a4, a5, a0
...
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a3, a3, a0
; RV32XVENTANACONDOPS-NEXT:    add a0, a2, a1
; RV32XVENTANACONDOPS-NEXT:    add a1, a3, a4
; RV32XVENTANACONDOPS-NEXT:    ret
;
...
; RV32XVENTANACONDOPS-NEXT:    add a0, a0, a2
; RV32XVENTANACONDOPS-NEXT:    add a1, a1, a3
; RV32XVENTANACONDOPS-NEXT:    ret
;
...
; RV32XVENTANACONDOPS-NEXT:    sw ra, 12(sp) # 4-byte Folded Spill
; RV32XVENTANACONDOPS-NEXT:    sw s0, 8(sp) # 4-byte Folded Spill
; RV32XVENTANACONDOPS-NEXT:    vt.maskc s0, a2, a0
; RV32XVENTANACONDOPS-NEXT:    vt.maskcn a0, a3, a0
; RV32XVENTANACONDOPS-NEXT:    add s0, a0, s0
...
; RV64XVENTANACONDOPS-NEXT:    vt.maskcn a0, a3, a0
; RV64XVENTANACONDOPS-NEXT:    add s0, a0, s0
...
; RV64ZICOND-NEXT:    czero.nez a0, a3, a0
; RV64ZICOND-NEXT:    add s0, a0, s0
