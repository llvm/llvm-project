...
; RV32I-FPELIM-NEXT:    add a0, a0, a1
; RV32I-FPELIM-NEXT:    xor a1, a4, t0
...
; RV32I-FPELIM-NEXT:    add a0, a0, t1
...
; RV32I-WITHFP-NEXT:    sw s0, 8(sp) # 4-byte Folded Spill
; RV32I-WITHFP-NEXT:    addi s0, sp, 16
; RV32I-WITHFP-NEXT:    lw t0, 16(sp)
; RV32I-WITHFP-NEXT:    lw t1, 20(sp)
...
; RV32I-WITHFP-NEXT:    add a0, a0, a1
; RV32I-WITHFP-NEXT:    xor a1, a4, t0
...
; RV32I-WITHFP-NEXT:    add a0, a0, t1
...
; RV32I-FPELIM-NEXT:    lw a7, 0(a0)
; RV32I-FPELIM-NEXT:    lw a0, 8(a0)
; RV32I-FPELIM-NEXT:    xor a4, a4, a6
; RV32I-FPELIM-NEXT:    xor a2, a2, a5
; RV32I-FPELIM-NEXT:    xor a0, a3, a0
; RV32I-FPELIM-NEXT:    xor a1, a1, a7
...
; RV32I-WITHFP-NEXT:    lw a7, 0(a0)
; RV32I-WITHFP-NEXT:    lw a0, 8(a0)
; RV32I-WITHFP-NEXT:    xor a4, a4, a6
; RV32I-WITHFP-NEXT:    xor a2, a2, a5
; RV32I-WITHFP-NEXT:    xor a0, a3, a0
; RV32I-WITHFP-NEXT:    xor a1, a1, a7
...
; RV32I-FPELIM-NEXT:    lui a1, 545260
; RV32I-FPELIM-NEXT:    addi t0, a0, 491
; RV32I-FPELIM-NEXT:    addi t1, a1, -1967
; RV32I-FPELIM-NEXT:    lui a0, 964690
; RV32I-FPELIM-NEXT:    lui a1, 335544
; RV32I-FPELIM-NEXT:    addi a0, a0, -328
; RV32I-FPELIM-NEXT:    addi a1, a1, 1311
; RV32I-FPELIM-NEXT:    lui a2, 688509
; RV32I-FPELIM-NEXT:    sw a1, 32(sp)
; RV32I-FPELIM-NEXT:    sw a0, 36(sp)
; RV32I-FPELIM-NEXT:    addi a5, a2, -2048
; RV32I-FPELIM-NEXT:    li a0, 1
...
; RV32I-WITHFP-NEXT:    li a1, 19
; RV32I-WITHFP-NEXT:    sw a0, 20(sp)
; RV32I-WITHFP-NEXT:    sw a1, 24(sp)
...
; RV32I-WITHFP-NEXT:    lui a1, 545260
; RV32I-WITHFP-NEXT:    addi t0, a0, 491
; RV32I-WITHFP-NEXT:    addi t1, a1, -1967
; RV32I-WITHFP-NEXT:    lui a0, 964690
; RV32I-WITHFP-NEXT:    lui a1, 335544
...
; RV32I-FPELIM-NEXT:    lui a3, 200614
; RV32I-FPELIM-NEXT:    addi a2, a2, 580
; RV32I-FPELIM-NEXT:    addi a3, a3, 647
; RV32I-FPELIM-NEXT:    xor a1, a1, a2
; RV32I-FPELIM-NEXT:    xor a0, a0, a3
; RV32I-FPELIM-NEXT:    or a0, a0, a1
; RV32I-FPELIM-NEXT:    seqz a0, a0
; RV32I-FPELIM-NEXT:    lw ra, 12(sp) # 4-byte Folded Reload
; RV32I-FPELIM-NEXT:    addi sp, sp, 16
...
; RV32I-WITHFP-NEXT:    lui a3, 200614
; RV32I-WITHFP-NEXT:    addi a2, a2, 580
; RV32I-WITHFP-NEXT:    addi a3, a3, 647
; RV32I-WITHFP-NEXT:    xor a1, a1, a2
; RV32I-WITHFP-NEXT:    xor a0, a0, a3
; RV32I-WITHFP-NEXT:    or a0, a0, a1
; RV32I-WITHFP-NEXT:    seqz a0, a0
; RV32I-WITHFP-NEXT:    lw ra, 12(sp) # 4-byte Folded Reload
; RV32I-WITHFP-NEXT:    lw s0, 8(sp) # 4-byte Folded Reload
