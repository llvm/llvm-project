...
entry:
  %i = call riscv_m4x2 @llvm.riscv.vloxseg2.nxv16f16.nxv16i32.i64(riscv_m4x2 undef, ptr nonnull poison, <vscale x 16 x i32> poison, i64 55, i64 4)
  %i1 = tail call <vscale x 16 x half> @llvm.vector.extract.v16f16.riscv_m4x2(riscv_m4x2 %i, i64 0)
...
declare void @func()
declare riscv_m4x2 @llvm.riscv.vloxseg2.nxv16f16.nxv16i32.i64(riscv_m4x2, ptr nocapture, <vscale x 16 x i32>, i64, i64)
declare <vscale x 16 x half> @llvm.vector.extract.v16f16.riscv_m4x2(riscv_m4x2, i64)
