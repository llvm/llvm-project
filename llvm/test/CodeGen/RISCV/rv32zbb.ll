...
; CHECK-NEXT:    slli a3, a1, 8
; CHECK-NEXT:    slli a4, a0, 8
; CHECK-NEXT:    or a2, a3, a2
; CHECK-NEXT:    sltu a3, a4, a0
; CHECK-NEXT:    sub a1, a2, a1
; CHECK-NEXT:    sub a1, a1, a3
; CHECK-NEXT:    sub a0, a4, a0
; CHECK-NEXT:    ret
...
; CHECK-NEXT:  .LBB57_2:
; CHECK-NEXT:    sltu t1, a4, a6
; CHECK-NEXT:  .LBB57_3:
; CHECK-NEXT:    lw a1, 0(a1)
; CHECK-NEXT:    lw a2, 0(a2)
; CHECK-NEXT:    beq a3, a7, .LBB57_5
; CHECK-NEXT:  # %bb.4:
...
; CHECK-NEXT:    and a2, t2, a2
; CHECK-NEXT:    and a7, t2, a7
; CHECK-NEXT:    sltu t0, a1, a2
; CHECK-NEXT:    and t2, t2, a6
; CHECK-NEXT:    mv a6, t0
; CHECK-NEXT:    beq a3, a7, .LBB57_10
; CHECK-NEXT:  # %bb.9:
; CHECK-NEXT:    sltu a6, a3, a7
; CHECK-NEXT:  .LBB57_10:
; CHECK-NEXT:    sub t3, a4, t2
; CHECK-NEXT:    sltu a4, a4, t2
; CHECK-NEXT:    sub a5, a5, t1
; CHECK-NEXT:    sltu t1, t3, a6
; CHECK-NEXT:    sub a5, a5, a4
; CHECK-NEXT:    sub a4, a5, t1
...
; RV32ZBB-NEXT:    addi a1, a0, 17
; RV32ZBB-NEXT:    andi a0, a0, 127
; RV32ZBB-NEXT:    andi a1, a1, 92
; RV32ZBB-NEXT:    minu a0, a1, a0
; RV32ZBB-NEXT:    ret
  %x = or i7 %a, 51
  %c = icmp ugt i7 %x, -18
