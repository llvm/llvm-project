...
define void @test_memset_i8_const() {
; CHECK-LABEL: test_memset_i8_const:
; CHECK:       LBB0_0:
...
; CHECK-NEXT:    movl call_addr, memset
...
; CHECK-NEXT:    writer.64 call_addr, r2
; CHECK-NEXT:    writer.8 call_addr, r2
...
entry:
    call void @llvm.memset.p0.i8(ptr null, i8 0, i8 220, i1 false)
    ret void
}

define void @test_memset_i8(i8 %size) {
; CHECK-LABEL: test_memset_i8:
; CHECK:       LBB1_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
; CHECK-NEXT:    feeder.8 r1
; CHECK-NEXT:    movl r2, 0x5
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i8(ptr null, i8 5, i8 %size, i1 false)
    ret void
}

define void @test_memset_i16_const() {
; CHECK-LABEL: test_memset_i16_const:
; CHECK:       LBB2_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i16(ptr null, i8 0, i16 220, i1 false)
    ret void
}

define void @test_memset_i16(i16 %size) {
; CHECK-LABEL: test_memset_i16:
; CHECK:       LBB3_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i16(ptr null, i8 5, i16 %size, i1 false)
    ret void
}

define void @test_memset_i32_const() {
; CHECK-LABEL: test_memset_i32_const:
; CHECK:       LBB4_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i32(ptr null, i8 0, i32 220, i1 false)
    ret void
}

define void @test_memset_i32(i32 %size) {
; CHECK-LABEL: test_memset_i32:
; CHECK:       LBB5_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i32(ptr null, i8 5, i32 %size, i1 false)
    ret void
}

define void @test_memset_i64_const() {
; CHECK-LABEL: test_memset_i64_const:
; CHECK:       LBB6_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i64(ptr null, i8 0, i64 220, i1 false)
    ret void
}

define void @test_memset_i64(i64 %size) {
; CHECK-LABEL: test_memset_i64:
; CHECK:       LBB7_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.64 call_addr, r4
; CHECK-NEXT:    writer.8 call_addr, r3
; CHECK-NEXT:    writer.64 call_addr, r1
; CHECK-NEXT:    writer.64 call_addr, r2
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i64(ptr null, i8 5, i64 %size, i1 false)
    ret void
}

define void @test_memset_i128_const() {
; CHECK-LABEL: test_memset_i128_const:
; CHECK:       LBB8_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i128(ptr null, i8 0, i128 220, i1 false)
    ret void
}

define void @test_memset_i128(i128 %size) {
; CHECK-LABEL: test_memset_i128:
; CHECK:       LBB9_0:
; CHECK-NEXT:  # %bb.0: # %entry
; CHECK-NEXT:    feeder.32 tid
; CHECK-NEXT:    feeder.32 ret_fid
...
; CHECK-NEXT:    writer.32 ret_fid, tid
entry:
    call void @llvm.memset.p0.i128(ptr null, i8 5, i128 %size, i1 false)
    ret void
}

declare void @llvm.memset.p0.i8(ptr nocapture writeonly, i8, i8, i1 immarg) #1
