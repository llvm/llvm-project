...
; DOPCHECK: call half @dx.op.dot2.f16(i32 54, half [[A1]], half [[A2]], half [[B1]], half [[B2]])
...
; DOPCHECK-DAG: declare half @dx.op.dot2.f16(i32, half, half, half, half) #[[#ATTR0:]]
; DOPCHECK-DAG: declare half @dx.op.dot3.f16(i32, half, half, half, half, half, half) #[[#ATTR0]]
; DOPCHECK-DAG: declare half @dx.op.dot4.f16(i32, half, half, half, half, half, half, half, half) #[[#ATTR0]]
; DOPCHECK-DAG: declare float @dx.op.dot2.f32(i32, float, float, float, float) #[[#ATTR0]]
; DOPCHECK-DAG: declare float @dx.op.dot3.f32(i32, float, float, float, float, float, float) #[[#ATTR0]]
; DOPCHECK-DAG: declare float @dx.op.dot4.f32(i32, float, float, float, float, float, float, float, float) #[[#ATTR0]]
