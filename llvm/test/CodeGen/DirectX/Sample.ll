...
; Test basic Sample on a Texture2D with float4 result.
; CHECK-LABEL: define void @sample_texture2d_float4(
define void @sample_texture2d_float4(<2 x float> %coords) {
...
; Test Sample with clamp on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_with_clamp(
define void @sample_texture2d_with_clamp(<2 x float> %coords, float %clamp) {
  %texture = call target("dx.Texture", <4 x float>, 0, 0, 0, 2)
      @llvm.dx.resource.handlefrombinding.tdx.Texture_v4f32_0_0_0_2t(
          i32 0, i32 0, i32 1, i32 0, ptr null)
  %sampler = call target("dx.Sampler", 0)
  ...
  %data = call <4 x float>
      @llvm.dx.resource.sample.clamp.v4f32.tdx.Texture_v4f32_0_0_0_2t.tdx.Sampler_0t.v2f32.v2i32(
          target("dx.Texture", <4 x float>, 0, 0, 0, 2) %texture,
          target("dx.Sampler", 0) %sampler,
          <2 x float> %coords, <2 x i32> zeroinitializer, float %clamp)
...
; Test Sample with constant non-zero offsets on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_with_offset(
define void @sample_texture2d_with_offset(<2 x float> %coords) {
  %texture = call target("dx.Texture", <4 x float>, 0, 0, 0, 2)
      @llvm.dx.resource.handlefrombinding.tdx.Texture_v4f32_0_0_0_2t(
          i32 0, i32 0, i32 1, i32 0, ptr null)
  %sampler = call target("dx.Sampler", 0)
  ...
  %data = call <4 x float>
      @llvm.dx.resource.sample.v4f32.tdx.Texture_v4f32_0_0_0_2t.tdx.Sampler_0t.v2f32.v2i32(
          target("dx.Texture", <4 x float>, 0, 0, 0, 2) %texture,
          target("dx.Sampler", 0) %sampler,
          <2 x float> %coords, <2 x i32> <i32 1, i32 -2>)
...
; Test Sample with dynamic (non-constant) offsets on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_with_dynamic_offset(
define void @sample_texture2d_with_dynamic_offset(<2 x float> %coords, <2 x i32> %offsets) {
  %texture = call target("dx.Texture", <4 x float>, 0, 0, 0, 2)
      @llvm.dx.resource.handlefrombinding.tdx.Texture_v4f32_0_0_0_2t(
          i32 0, i32 0, i32 1, i32 0, ptr null)
  %sampler = call target("dx.Sampler", 0)
...
; Test Sample with both offset and clamp on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_with_offset_and_clamp(
define void @sample_texture2d_with_offset_and_clamp(<2 x float> %coords, float %clamp) {
  %texture = call target("dx.Texture", <4 x float>, 0, 0, 0, 2)
      @llvm.dx.resource.handlefrombinding.tdx.Texture_v4f32_0_0_0_2t(
          i32 0, i32 0, i32 1, i32 0, ptr null)
  %sampler = call target("dx.Sampler", 0)
  ...
  %data = call <4 x float>
      @llvm.dx.resource.sample.clamp.v4f32.tdx.Texture_v4f32_0_0_0_2t.tdx.Sampler_0t.v2f32.v2i32(
          target("dx.Texture", <4 x float>, 0, 0, 0, 2) %texture,
          target("dx.Sampler", 0) %sampler,
          <2 x float> %coords, <2 x i32> <i32 3, i32 -1>, float %clamp)
...
; Test Sample on a Texture1D (scalar coordinate, scalar offset).
; CHECK-LABEL: define void @sample_texture1d_float4(
define void @sample_texture1d_float4(float %coord) {
...
; Test Sample on a Texture3D (3-component coordinates).
; CHECK-LABEL: define void @sample_texture3d_float4(
define void @sample_texture3d_float4(<3 x float> %coords) {
  ...
  %data = call <4 x float>
      @llvm.dx.resource.sample.v4f32.tdx.Texture_v4f32_0_0_0_4t.tdx.Sampler_0t.v3f32.v3i32(
          ...
          target("dx.Sampler", 0) %sampler,
          <3 x float> %coords, <3 x i32> zeroinitializer)
...
; Test Sample with a scalar return type on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_scalar(
define void @sample_texture2d_scalar(<2 x float> %coords) {
...
; Test Sample with half-precision result type on a Texture2D.
; CHECK-LABEL: define void @sample_texture2d_half4(
define void @sample_texture2d_half4(<2 x float> %coords) {
