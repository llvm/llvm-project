...
; Test hoisting a sunk resource load through a phi where the GEP index is
; computed in the merge block. The index computation is part of the pointer's
; def chain and must be duplicated into each predecessor along with the GEP and
; the hoisted load.
