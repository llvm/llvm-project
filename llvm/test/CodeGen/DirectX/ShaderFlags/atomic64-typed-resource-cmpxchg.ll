...
; A 64-bit atomic compare-exchange on a typed UAV (RWBuffer<uint64_t>) sets
; the same flags as the other 64-bit atomics: Int64Ops (bit 20) and
; AtomicInt64OnTypedResource (bit 27), which give 0x8100000.
...
define void @main() #0 {
  ...
  %old = call i64 @llvm.dx.resource.atomic.compare.exchange.i64(
      target("dx.TypedBuffer", i64, 1, 0, 0) %handle,
      i32 0, i32 poison, i32 poison, i64 1, i64 2)
  ret void
}
