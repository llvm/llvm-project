...
entry:
; CHECK: call half @dx.op.wavePrefixOp.f16(i32 121, half %expr, i8 0)
...
entry:
; CHECK: call float @dx.op.wavePrefixOp.f32(i32 121, float %expr, i8 0)
...
entry:
; CHECK: call double @dx.op.wavePrefixOp.f64(i32 121, double %expr, i8 0)
...
entry:
; CHECK: call i16 @dx.op.wavePrefixOp.i16(i32 121, i16 %expr, i8 0)
...
entry:
; CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32 %expr, i8 0)
...
entry:
; CHECK: call i64 @dx.op.wavePrefixOp.i64(i32 121, i64 %expr, i8 0)
...
entry:
; CHECK: call half @dx.op.wavePrefixOp.f16(i32 121, half %expr.i0, i8 0)
; CHECK: call half @dx.op.wavePrefixOp.f16(i32 121, half %expr.i1, i8 0)
...
entry:
; CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32 %expr.i0, i8 0)
; CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32 %expr.i1, i8 0)
; CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32 %expr.i2, i8 0)
...
entry:
; CHECK: call double @dx.op.wavePrefixOp.f64(i32 121, double %expr.i0, i8 0)
; CHECK: call double @dx.op.wavePrefixOp.f64(i32 121, double %expr.i1, i8 0)
; CHECK: call double @dx.op.wavePrefixOp.f64(i32 121, double %expr.i2, i8 0)
; CHECK: call double @dx.op.wavePrefixOp.f64(i32 121, double %expr.i3, i8 0)
