...
; CHECK-NEXT:    [[BC:%.*]] = bitcast ptr addrspace(3) @arrayofVecData.scalarized.1dim to ptr addrspace(3)
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds nuw [6 x float], ptr addrspace(3) [[BC]], i32 0, i32 0
; CHECK-NEXT:    store float 1.000000e+00, ptr addrspace(3) [[GEP]], align 16
; CHECK-NEXT:    store float 2.000000e+00, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @arrayofVecData.scalarized.1dim, i32 4), align 4
; CHECK-NEXT:    store float 3.000000e+00, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @arrayofVecData.scalarized.1dim, i32 8), align 8
; CHECK-NEXT:    store float 2.000000e+00, ptr addrspace(3) getelementptr inbounds (i8, ptr addrspace(3) @arrayofVecData.scalarized.1dim, i32 12), align 16
; CHECK-NEXT:    store float 4.000000e+00, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @arrayofVecData.scalarized.1dim, i32 16), align 4
; CHECK-NEXT:    store float 6.000000e+00, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @arrayofVecData.scalarized.1dim, i32 20), align 8
; CHECK-NEXT:    ret void
...
; CHECK-NEXT:    [[BC:%.*]] = bitcast ptr addrspace(3) @vecData.scalarized to ptr
; CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds nuw [4 x i32], ptr addrspace(3) [[BC]], i32 0, i32 0
...
; CHECK-NEXT:    store i32 [[INPUTVEC_I12]], ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @vecData.scalarized, i32 4), align 4
; CHECK-NEXT:    [[INPUTVEC_I23:%.*]] = extractelement <4 x i32> %inputVec, i32 2
; CHECK-NEXT:    store i32 [[INPUTVEC_I23]], ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @vecData.scalarized, i32 8), align 4
; CHECK-NEXT:    [[INPUTVEC_I34:%.*]] = extractelement <4 x i32> %inputVec, i32 3
; CHECK-NEXT:    store i32 [[INPUTVEC_I34]], ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @vecData.scalarized, i32 12), align 4
; CHECK-NEXT:    ret void
;
