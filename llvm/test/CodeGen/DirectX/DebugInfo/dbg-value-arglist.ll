...
;; CHECK-NEXT: entry:
;; CHECK-COMMENT-NEXT:   ; DXIL: to be replaced with: tail call addrspace(0) void @llvm.dbg.value(metadata i32 0, i64 0, metadata [[LV:![0-9]+]], metadata !DIExpression())
...
;; CHECK-COMMENT-NEXT:   ; DXIL: to be replaced with: tail call addrspace(0) void @llvm.dbg.value(metadata i1 poison, i64 0, metadata [[LV]], metadata !DIExpression())
