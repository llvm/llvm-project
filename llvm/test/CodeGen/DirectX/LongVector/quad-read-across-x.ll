...
; CHECK-COUNT-17: call i32 @dx.op.quadOp.i32(i32 123, i32 {{.*}}, i8 0)
; SM69-CHECK-LABEL: define <17 x i32> @test_quad_read_across_x(
; SM69-CHECK: call <17 x i32> @llvm.dx.quad.read.across.x.v17i32
