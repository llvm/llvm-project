...
; CHECK-COUNT-17: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32 {{.*}}, i8 1, i8 0)
; SM69-CHECK-LABEL: define <17 x i32> @test_wave_prefix_product(
; SM69-CHECK: call <17 x i32> @llvm.dx.wave.prefix.product.v17i32
