...
;
; SCHECK-NEXT:    [[GEP0:%.*]] = getelementptr inbounds i8, ptr addrspace(3) @aTile.scalarized, i32 160
...
; FCHECK-NEXT:    [[DOTI07:%.*]] = load i32, ptr addrspace(3) getelementptr inbounds (i8, ptr addrspace(3) @aTile.scalarized.1dim, i32 192), align 16
; FCHECK-NEXT:    [[DOTI119:%.*]] = load i32, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @aTile.scalarized.1dim, i32 196), align 4
; FCHECK-NEXT:    [[DOTI2211:%.*]] = load i32, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @aTile.scalarized.1dim, i32 200), align 8
; FCHECK-NEXT:    [[DOTI3313:%.*]] = load i32, ptr addrspace(3) getelementptr (i8, ptr addrspace(3) @aTile.scalarized.1dim, i32 204), align 4
...
;
; FCHECK-NEXT:    [[LOAD:%.*]] = load i32, ptr addrspace(3) getelementptr inbounds (i8, ptr addrspace(3) @bTile.1dim, i32 44), align 16
...
; SCHECK-NEXT:    [[GEP0:%.*]] = getelementptr inbounds i8, ptr @cTile.scalarized, i32 16
...
;
; FCHECK-NEXT:    load i32, ptr getelementptr inbounds (i8, ptr @cTile.scalarized.1dim, i32 28), align 4
;
; CHECK-NEXT:    ret void
...
; SCHECK-NEXT:    [[GEP0:%.*]] = getelementptr inbounds i8, ptr @dTile.scalarized, i32 32
...
;
; FCHECK-NEXT:    load i32, ptr getelementptr inbounds (i8, ptr @dTile.scalarized.1dim, i32 60), align 4
;
; CHECK-NEXT:    ret void
