...
; SPARC-NEXT:    rd %y, %l7
; SPARC-NEXT:    ld [%fp+92], %l5
; SPARC-NEXT:    umul %i4, %i3, %i3
; SPARC-NEXT:    rd %y, %o2
; SPARC-NEXT:    ld [%fp+96], %g3
; SPARC-NEXT:    umul %i5, %g2, %l1
; SPARC-NEXT:    rd %y, %o0
; SPARC-NEXT:    umul %l5, %i1, %l3
; SPARC-NEXT:    rd %y, %l2
