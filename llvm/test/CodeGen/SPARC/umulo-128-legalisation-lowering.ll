...
; RUN: llc < %s -mtriple=sparc-unknown-linux-gnu -disable-sparc-leaf-proc | FileCheck %s --check-prefixes=SPARC
; RUN: llc < %s -mtriple=sparc64-unknown-linux-gnu | FileCheck %s --check-prefixes=SPARC64
; RUN: llc < %s -mtriple=sparc64-unknown-linux-gnu -mattr=vis3 -disable-sparc-leaf-proc | FileCheck %s --check-prefixes=SPARC64-VIS3
