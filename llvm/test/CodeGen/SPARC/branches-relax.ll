...
; RUN: llc < %s -mtriple=sparc | FileCheck --check-prefix=SPARC %s
; RUN: llc < %s -mtriple=sparc64 -sparc-bpcc-offset-bits=4 -sparc-bpr-offset-bits=4 | FileCheck --check-prefix=SPARC64 %s

;; Note that 32-bit SPARC branches all have +- 8 MiB range (i.e. same with `ba`)
;; so for it only @branch_relax_large test is really relevant.

define i32 @branch_relax_int(i32 %in) {
; SPARC-LABEL: branch_relax_int:
; SPARC:         .cfi_startproc
; SPARC-NEXT:  ! %bb.0:
...
; SPARC-NEXT:    ret
; SPARC-NEXT:    restore %g0, %g0, %o1
; SPARC-NEXT:  .LBB1_2: ! %true
; SPARC-NEXT:    mov 4, %i1
; SPARC-NEXT:    !APP
; SPARC-NEXT:    nop
; SPARC-NEXT:    nop
...
; SPARC-LABEL: branch_relax_float:
; SPARC:         .cfi_startproc
; SPARC-NEXT:  ! %bb.0:
; SPARC-NEXT:    save %sp, -96, %sp
; SPARC-NEXT:    .cfi_def_cfa_register %fp
; SPARC-NEXT:    .cfi_window_save
; SPARC-NEXT:    .cfi_register %o7, %i7
; SPARC-NEXT:    st %i0, [%fp+-4]
; SPARC-NEXT:    ld [%fp+-4], %f1
; SPARC-NEXT:    sethi %hi(.LCPI2_0), %i0
; SPARC-NEXT:    ld [%i0+%lo(.LCPI2_0)], %f0
; SPARC-NEXT:    fcmps %f1, %f0
; SPARC-NEXT:    nop
; SPARC-NEXT:    fbne .LBB2_2
; SPARC-NEXT:    nop
; SPARC-NEXT:  ! %bb.1: ! %true
; SPARC-NEXT:    sethi %hi(.LCPI2_1), %i0
; SPARC-NEXT:    ld [%i0+%lo(.LCPI2_1)], %f0
; SPARC-NEXT:    !APP
; SPARC-NEXT:    nop
; SPARC-NEXT:    nop
; SPARC-NEXT:    nop
...
; SPARC-LABEL: branch_relax_large:
; SPARC:         .cfi_startproc
; SPARC-NEXT:  ! %bb.0:
; SPARC-NEXT:    save %sp, -96, %sp
; SPARC-NEXT:    .cfi_def_cfa_register %fp
...
; SPARC-NEXT:    .cfi_register %o7, %i7
; SPARC-NEXT:    cmp %i0, 0
; SPARC-NEXT:    bne .LBB3_1
; SPARC-NEXT:    nop
; SPARC-NEXT:  ! %bb.3:
; SPARC-NEXT:    call .LBB3_2
; SPARC-NEXT:    nop
; SPARC-NEXT:  .LBB3_1: ! %false
; SPARC-NEXT:    !APP
; SPARC-NEXT:    .skip 268435456
; SPARC-NEXT:    !NO_APP
; SPARC-NEXT:    ret
; SPARC-NEXT:    restore %g0, %g0, %o0
; SPARC-NEXT:  .LBB3_2: ! %true
; SPARC-NEXT:    mov 4, %i0
; SPARC-NEXT:    !APP
; SPARC-NEXT:    .skip 268435456
; SPARC-NEXT:    !NO_APP
