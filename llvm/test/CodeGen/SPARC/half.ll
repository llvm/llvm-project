...
; RUN: llc %s -o - -mtriple=sparcel-linux-gnu         | FileCheck %s -check-prefixes=CHECK,SMARC32,V8
; RUN: llc %s -o - -mtriple=sparc-linux-gnu -mattr=v9 | FileCheck %s -check-prefixes=CHECK,SMARC32,V9
...
; SMARC32-LABEL: store:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i0, %o0
; SMARC32-NEXT:    sth %o0, [%i1]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
; SPARC64-LABEL: store:
; SPARC64:       ! %bb.0:
...
; SMARC32-LABEL: return:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0], %o0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+2], %o0
; SMARC32-NEXT:    fstod %f0, %f0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
; SPARC64-LABEL: loadd:
...
; SMARC32-LABEL: stored:
; SMARC32:       ! %bb.0: ! %entry
; SMARC32-NEXT:    save %sp, -112, %sp
; SMARC32-NEXT:    mov %i2, %i3
; SMARC32-NEXT:    mov %i1, %i2
; SMARC32-NEXT:    std %i2, [%fp+-8]
; SMARC32-NEXT:    ldd [%fp+-8], %f0
; SMARC32-NEXT:    std %f0, [%fp+-16]
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-16], %o0
; SMARC32-NEXT:    sth %o0, [%i0]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: storef:
; SMARC32:       ! %bb.0: ! %entry
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i1, %o0
; SMARC32-NEXT:    sth %o0, [%i0]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: to_bits:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i0, %o0
; SMARC32-NEXT:    sethi 4194240, %i0
; SMARC32-NEXT:    andn %o0, %i0, %i0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_trunc64:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -112, %sp
; SMARC32-NEXT:    ! kill: def $i1 killed $i1 killed $i0_i1 def $i0_i1
; SMARC32-NEXT:    ! kill: def $i0 killed $i0 killed $i0_i1 def $i0_i1
; SMARC32-NEXT:    std %i0, [%fp+-8]
; SMARC32-NEXT:    ldd [%fp+-8], %f0
; SMARC32-NEXT:    std %f0, [%fp+-16]
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-16], %o0
; SMARC32-NEXT:    sth %o0, [%i2]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_fptosi_i64:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0], %o0
; SMARC32-NEXT:    st %f0, [%fp+-4]
; SMARC32-NEXT:    call __fixsfdi
; SMARC32-NEXT:    ld [%fp+-4], %o0
; SMARC32-NEXT:    mov %o0, %i0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore %g0, %o1, %o1
;
...
; SMARC32-LABEL: test_sitofp_i64:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    mov %i1, %o1
; SMARC32-NEXT:    call __floatdisf
; SMARC32-NEXT:    mov %i0, %o0
; SMARC32-NEXT:    st %f0, [%fp+-4]
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    ld [%fp+-4], %o0
...
; SMARC32-LABEL: test_fptoui_i64:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0], %o0
; SMARC32-NEXT:    st %f0, [%fp+-4]
; SMARC32-NEXT:    call __fixunssfdi
; SMARC32-NEXT:    ld [%fp+-4], %o0
; SMARC32-NEXT:    mov %o0, %i0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore %g0, %o1, %o1
...
; SMARC32-LABEL: test_uitofp_i64:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    mov %i1, %o1
; SMARC32-NEXT:    call __floatundisf
; SMARC32-NEXT:    mov %i0, %o0
; SMARC32-NEXT:    st %f0, [%fp+-4]
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    ld [%fp+-4], %o0
...
; SMARC32-LABEL: test_extend32_vec4:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -104, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0], %o0
; SMARC32-NEXT:    st %f0, [%fp+-4] ! 4-byte Folded Spill
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+2], %o0
; SMARC32-NEXT:    st %f0, [%fp+-8] ! 4-byte Folded Spill
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+4], %o0
; SMARC32-NEXT:    st %f0, [%fp+-12] ! 4-byte Folded Spill
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+6], %o0
; SMARC32-NEXT:    fmovs %f0, %f3
; SMARC32-NEXT:    ld [%fp+-4], %f0 ! 4-byte Folded Reload
; SMARC32-NEXT:    ld [%fp+-8], %f1 ! 4-byte Folded Reload
; SMARC32-NEXT:    ld [%fp+-12], %f2 ! 4-byte Folded Reload
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_extend64_vec4:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -120, %sp
; SMARC32-NEXT:    ld [%fp+64], %i1
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+4], %o0
; SMARC32-NEXT:    st %f0, [%fp+-8] ! 4-byte Folded Spill
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0+2], %o0
; SMARC32-NEXT:    st %f0, [%fp+-16] ! 4-byte Folded Spill
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i0], %o0
; SMARC32-NEXT:    lduh [%i0+6], %o0
; SMARC32-NEXT:    fstod %f0, %f0
; SMARC32-NEXT:    std %f0, [%fp+-24] ! 8-byte Folded Spill
; SMARC32-NEXT:    ld [%fp+-16], %f0 ! 4-byte Folded Reload
; SMARC32-NEXT:    fstod %f0, %f0
; SMARC32-NEXT:    std %f0, [%fp+-16] ! 8-byte Folded Spill
; SMARC32-NEXT:    ld [%fp+-8], %f0 ! 4-byte Folded Reload
; SMARC32-NEXT:    fstod %f0, %f0
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    std %f0, [%fp+-8]
; SMARC32-NEXT:    fstod %f0, %f0
; SMARC32-NEXT:    std %f0, [%i1+24]
; SMARC32-NEXT:    ldd [%fp+-8], %f0 ! 8-byte Folded Reload
; SMARC32-NEXT:    std %f0, [%i1+16]
; SMARC32-NEXT:    ldd [%fp+-16], %f0 ! 8-byte Folded Reload
; SMARC32-NEXT:    std %f0, [%i1+8]
; SMARC32-NEXT:    ldd [%fp+-24], %f0 ! 8-byte Folded Reload
; SMARC32-NEXT:    std %f0, [%i1]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_trunc32_vec4:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -96, %sp
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i0, %o0
...
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i1, %o0
; SMARC32-NEXT:    mov %o0, %i1
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i2, %o0
; SMARC32-NEXT:    mov %o0, %i2
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    mov %i3, %o0
; SMARC32-NEXT:    sth %o0, [%i4+6]
; SMARC32-NEXT:    sth %i2, [%i4+4]
; SMARC32-NEXT:    sth %i1, [%i4+2]
; SMARC32-NEXT:    sth %i0, [%i4]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_trunc64_vec4:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -160, %sp
; SMARC32-NEXT:    ld [%fp+92], %g2
; SMARC32-NEXT:    ld [%fp+96], %g3
; SMARC32-NEXT:    ! kill: def $i5 killed $i5 killed $i4_i5 def $i4_i5
; SMARC32-NEXT:    ! kill: def $i3 killed $i3 killed $i2_i3 def $i2_i3
; SMARC32-NEXT:    ! kill: def $i1 killed $i1 killed $i0_i1 def $i0_i1
; SMARC32-NEXT:    std %g2, [%fp+-32]
; SMARC32-NEXT:    ! kill: def $i4 killed $i4 killed $i4_i5 def $i4_i5
; SMARC32-NEXT:    std %i4, [%fp+-24]
; SMARC32-NEXT:    ! kill: def $i2 killed $i2 killed $i2_i3 def $i2_i3
; SMARC32-NEXT:    std %i2, [%fp+-16]
; SMARC32-NEXT:    ! kill: def $i0 killed $i0 killed $i0_i1 def $i0_i1
; SMARC32-NEXT:    std %i0, [%fp+-8]
; SMARC32-NEXT:    ld [%fp+100], %i3
; SMARC32-NEXT:    ldd [%fp+-8], %f0
; SMARC32-NEXT:    ldd [%fp+-16], %f2
; SMARC32-NEXT:    ldd [%fp+-24], %f4
; SMARC32-NEXT:    ldd [%fp+-32], %f6
; SMARC32-NEXT:    std %f0, [%fp+-40]
; SMARC32-NEXT:    std %f2, [%fp+-48]
; SMARC32-NEXT:    std %f4, [%fp+-56]
; SMARC32-NEXT:    std %f6, [%fp+-64]
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-40], %o0
; SMARC32-NEXT:    mov %o0, %i0
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-48], %o0
; SMARC32-NEXT:    mov %o0, %i1
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-56], %o0
; SMARC32-NEXT:    mov %o0, %i2
; SMARC32-NEXT:    call __truncdfhf2
; SMARC32-NEXT:    ldd [%fp+-64], %o0
; SMARC32-NEXT:    sth %o0, [%i3+6]
; SMARC32-NEXT:    sth %i2, [%i3+4]
; SMARC32-NEXT:    sth %i1, [%i3+2]
; SMARC32-NEXT:    sth %i0, [%i3]
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
...
; SMARC32-LABEL: test_sitofp_fadd_i32:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -104, %sp
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    lduh [%i1], %o0
; SMARC32-NEXT:    st %i0, [%fp+-4]
; SMARC32-NEXT:    ld [%fp+-4], %f1
; SMARC32-NEXT:    st %f0, [%fp+-12] ! 4-byte Folded Spill
; SMARC32-NEXT:    fitos %f1, %f0
; SMARC32-NEXT:    st %f0, [%fp+-8]
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    ld [%fp+-8], %o0
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    nop
; SMARC32-NEXT:    ld [%fp+-12], %f1 ! 4-byte Folded Reload
; SMARC32-NEXT:    fadds %f1, %f0, %f0
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
;
