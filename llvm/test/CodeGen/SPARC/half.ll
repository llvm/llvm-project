...
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    save %sp, -112, %sp
; SMARC32-NEXT:    lduh [%i1], %i1
; SMARC32-NEXT:    st %i0, [%fp+-4]
; SMARC32-NEXT:    ld [%fp+-4], %f0
; SMARC32-NEXT:    fitos %f0, %f0
...
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    mov %i1, %o0
; SMARC32-NEXT:    ld [%fp+-16], %f1 ! 4-byte Folded Reload
; SMARC32-NEXT:    fadds %f0, %f1, %f0
; SMARC32-NEXT:    st %f0, [%fp+-12]
; SMARC32-NEXT:    call __truncsfhf2
; SMARC32-NEXT:    ld [%fp+-12], %o0
; SMARC32-NEXT:    call __extendhfsf2
; SMARC32-NEXT:    nop
; SMARC32-NEXT:    ret
; SMARC32-NEXT:    restore
...
; SMARC32-LABEL: fabs:
; SMARC32:       ! %bb.0:
; SMARC32-NEXT:    sethi 4194272, %o1
; SMARC32-NEXT:    retl
; SMARC32-NEXT:    andn %o0, %o1, %o0
;
; SPARC64-LABEL: fabs:
; SPARC64:       ! %bb.0:
