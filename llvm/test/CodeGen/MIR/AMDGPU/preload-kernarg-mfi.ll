...
; MIR: argumentInfo:
; MIR: kernargSegmentPtr: { reg: '$sgpr4_5' }
...
; MIR: machineFunctionInfo:
; MIR: argumentInfo:
; MIR: dispatchPtr: { reg: '$sgpr0_1' }
; MIR: kernargSegmentPtr: { reg: '$sgpr2_3' }
...
; MIR: argumentInfo:
; MIR: dispatchPtr: { reg: '$sgpr0_1' }
; MIR: queuePtr: { reg: '$sgpr2_3' }
; MIR: kernargSegmentPtr: { reg: '$sgpr4_5' }
; MIR: dispatchID: { reg: '$sgpr6_7' }
; MIR: firstKernArgPreloadReg: { reg: '$sgpr8' }
; MIR: numKernargPreloadSGPRs: 2
...
; MIR: machineFunctionInfo:
; MIR: argumentInfo:
; MIR: kernargSegmentPtr: { reg: '$sgpr0_1' }
