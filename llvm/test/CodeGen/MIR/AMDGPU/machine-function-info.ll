...
; CHECK-NEXT: privateSegmentBuffer: { reg: '$sgpr0_3' }
; CHECK-NEXT: dispatchPtr: { reg: '$sgpr4_5' }
; CHECK-NEXT: queuePtr: { reg: '$sgpr6_7' }
; CHECK-NEXT: kernargSegmentPtr: { reg: '$sgpr8_9' }
; CHECK-NEXT: dispatchID: { reg: '$sgpr10_11' }
...
; CHECK-NEXT: implicitBufferPtr: { reg: '$sgpr0_1' }
...
; CHECK-NEXT: numWaveDispatchVGPRs: 0
; CHECK-NEXT: scratchRSrcReg: '$sgpr0_3'
...
; CHECK-NEXT: implicitArgPtr:  { reg: '$sgpr8_9' }
