...
; RUN: llc -mtriple=armv8.6a-none-none-eabi -mattr=+neon < %s | FileCheck %s --check-prefixes=CHECK
; RUN: llc -mtriple=armv8.6a-none-none-eabi -mattr=+neon,+fullfp16 < %s | FileCheck %s --check-prefix=CHECK-FP16
; RUN: llc -mtriple=armv8.6a-none-none-eabi -mattr=+neon -float-abi=hard < %s | FileCheck %s --check-prefix=CHECK-HARD
