...
; on zero. Such clamps appear after InstCombine sinks a constant out of a
; saturating clamp (e.g. a quantized requantize with a non-zero output
; zero-point). PerformMinMaxToSatCombine rewrites clamp(X, Lo, Hi) into
