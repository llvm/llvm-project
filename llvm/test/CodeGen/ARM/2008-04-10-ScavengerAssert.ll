...
@.str127 = external constant [2 x i8]		; <ptr> [#uses=1]
@.str584 = external constant [5 x i8]		; <ptr> [#uses=1]
@.str8115 = external constant [9 x i8]		; <ptr> [#uses=1]
...
@scalefac_band.1 = external global [14 x i32]		; <ptr> [#uses=2]
