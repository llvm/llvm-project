...
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i16* [[ADDR_A_1]] to i32*
...
; CHECK-NEXT:    [[TMP22:%.*]] = bitcast i16* [[ADDR_B_1]] to i32*
; CHECK-NEXT:    [[TMP23:%.*]] = load i32, i32* [[TMP22]], align 2
...
; CHECK-NEXT:    [[LD_B_2:%.*]] = load i16, i16* [[ADDR_B_2]], align 2
...
; CHECK-NEXT:    [[LD_A_1:%.*]] = load i16, i16* [[ADDR_A_1]], align 2
; CHECK-NEXT:    [[LD_B_1:%.*]] = load i16, i16* [[ADDR_B_1]], align 2
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i16* [[ADDR_B_1]] to i32*
; CHECK-NEXT:    [[TMP16:%.*]] = load i32, i32* [[TMP15]], align 2
; CHECK-NEXT:    [[TMP17:%.*]] = trunc i32 [[TMP16]] to i16
; CHECK-NEXT:    [[TMP18:%.*]] = sext i16 [[TMP17]] to i32
; CHECK-NEXT:    [[TMP19:%.*]] = lshr i32 [[TMP16]], 16
...
; CHECK-NEXT:    [[LD_A_2:%.*]] = load i16, i16* [[ADDR_A_2]], align 2
; CHECK-NEXT:    [[TMP22:%.*]] = bitcast i16* [[ADDR_A_2]] to i32*
; CHECK-NEXT:    [[TMP23:%.*]] = load i32, i32* [[TMP22]], align 2
; CHECK-NEXT:    [[TMP24:%.*]] = trunc i32 [[TMP23]] to i16
