...
; CHECK-NEXT:    [[ADDR_A_3:%.*]] = getelementptr i16, i16* [[A]], i32 3
; CHECK-NEXT:    [[LD_A_2:%.*]] = load i16, i16* [[ADDR_A_2]], align 2
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i16* [[ADDR_A_2]] to i32*
; CHECK-NEXT:    [[TMP16:%.*]] = load i32, i32* [[TMP15]], align 2
...
; CHECK-NEXT:    [[LD_A_3:%.*]] = load i16, i16* [[ADDR_A_3]], align 2
...
; CHECK-NEXT:    [[SEXT_A_0:%.*]] = sext i16 [[LD_A_0]] to i32
; CHECK-NEXT:    [[LD_B_0:%.*]] = load i16, i16* [[B]], align 2
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast i16* [[B]] to i32*
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, i32* [[TMP0]], align 2
; CHECK-NEXT:    [[TMP2:%.*]] = trunc i32 [[TMP1]] to i16
; CHECK-NEXT:    [[TMP3:%.*]] = sext i16 [[TMP2]] to i32
; CHECK-NEXT:    [[TMP4:%.*]] = lshr i32 [[TMP1]], 16
...
; CHECK-NEXT:    [[ADDR_A_3:%.*]] = getelementptr i16, i16* [[A]], i32 3
; CHECK-NEXT:    [[LD_A_2:%.*]] = load i16, i16* [[ADDR_A_2]], align 2
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast i16* [[ADDR_A_2]] to i32*
; CHECK-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP7]], align 2
; CHECK-NEXT:    [[TMP9:%.*]] = trunc i32 [[TMP8]] to i16
...
; CHECK-NEXT:    [[ADDR_A_3:%.*]] = getelementptr i16, i16* [[A]], i32 3
; CHECK-NEXT:    [[LD_A_2:%.*]] = load i16, i16* [[ADDR_A_2]], align 2
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i16* [[ADDR_A_2]] to i32*
