...
; RUN: llc -mtriple=arm-- < %s | FileCheck -check-prefix=NOFP16 %s
...
; NOFP16-NEXT:    mov r1, #255
; NOFP16-NEXT:    orr r1, r1, #65280
; NOFP16-NEXT:    and r0, r0, r1
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4]
; NOFP16-NEXT:    pop {r4, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16-NEXT:    mov r6, #255
; NOFP16-NEXT:    mov r5, r0
; NOFP16-NEXT:    orr r6, r6, #65280
; NOFP16-NEXT:    mov r4, r2
; NOFP16-NEXT:    and r0, r1, r6
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4, #4]
; NOFP16-NEXT:    and r0, r5, r6
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4]
; NOFP16-NEXT:    pop {r4, r5, r6, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16-NEXT:    mov r7, #255
; NOFP16-NEXT:    mov r6, r0
; NOFP16-NEXT:    orr r7, r7, #65280
; NOFP16-NEXT:    mov r4, r3
; NOFP16-NEXT:    and r0, r2, r7
; NOFP16-NEXT:    mov r5, r1
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4, #8]
; NOFP16-NEXT:    and r0, r5, r7
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4, #4]
; NOFP16-NEXT:    and r0, r6, r7
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r4]
; NOFP16-NEXT:    pop {r4, r5, r6, r7, r11, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16:       @ %bb.0:
; NOFP16-NEXT:    push {r4, r5, r6, r7, r8, lr}
; NOFP16-NEXT:    mov r7, #255
; NOFP16-NEXT:    mov r8, r0
; NOFP16-NEXT:    orr r7, r7, #65280
; NOFP16-NEXT:    mov r4, r2
; NOFP16-NEXT:    and r0, r3, r7
; NOFP16-NEXT:    mov r5, r1
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    ldr r6, [sp, #24]
; NOFP16-NEXT:    str r0, [r6, #12]
; NOFP16-NEXT:    and r0, r4, r7
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r6, #8]
; NOFP16-NEXT:    and r0, r5, r7
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r6, #4]
; NOFP16-NEXT:    and r0, r8, r7
; NOFP16-NEXT:    bl __gnu_h2f_ieee
; NOFP16-NEXT:    str r0, [r6]
; NOFP16-NEXT:    pop {r4, r5, r6, r7, r8, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16-NEXT:    bl __gnu_f2h_ieee
; NOFP16-NEXT:    mov r1, r5
; NOFP16-NEXT:    pop {r4, r5, r11, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16-NEXT:    bl __gnu_f2h_ieee
; NOFP16-NEXT:    mov r1, r4
; NOFP16-NEXT:    mov r2, r6
; NOFP16-NEXT:    pop {r4, r5, r6, lr}
; NOFP16-NEXT:    mov pc, lr
...
; NOFP16-NEXT:    bl __gnu_f2h_ieee
; NOFP16-NEXT:    mov r1, r5
; NOFP16-NEXT:    mov r2, r4
; NOFP16-NEXT:    mov r3, r7
; NOFP16-NEXT:    pop {r4, r5, r6, r7, r11, lr}
; NOFP16-NEXT:    mov pc, lr
