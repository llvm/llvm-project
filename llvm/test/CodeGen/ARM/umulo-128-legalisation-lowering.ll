...
; ARMV6-NEXT:    mov r5, lr
; ARMV6-NEXT:    ldr r1, [sp, #68]
; ARMV6-NEXT:    umull r12, r8, r7, r6
; ARMV6-NEXT:    umull r11, lr, r1, lr
; ARMV6-NEXT:    add r12, r11, r12
; ARMV6-NEXT:    umull r11, r10, r6, r5
; ARMV6-NEXT:    mov r6, #0
; ARMV6-NEXT:    adds r12, r10, r12
; ARMV6-NEXT:    umull r2, r10, r2, r7
...
; ARMV6-NEXT:    ldr r6, [sp, #8] @ 4-byte Reload
; ARMV6-NEXT:    ldr r5, [sp, #64]
; ARMV6-NEXT:    adds r0, r2, r0
; ARMV6-NEXT:    str r0, [r6, #4]
; ARMV6-NEXT:    adcs r0, r12, r10
; ARMV6-NEXT:    mov r2, #0
; ARMV6-NEXT:    adc r2, r2, #0
; ARMV6-NEXT:    orrs r10, r5, r1
; ARMV6-NEXT:    ldr r5, [sp, #80]
; ARMV6-NEXT:    movne r10, #1
; ARMV6-NEXT:    umlal r0, r2, r3, r7
; ARMV6-NEXT:    orrs r12, r5, r4
...
; ARMV7-NEXT:    ldr r9, [sp, #80]
; ARMV7-NEXT:    umull r7, r6, r4, r1
; ARMV7-NEXT:    umull r1, r5, r1, r9
; ARMV7-NEXT:    str r7, [sp, #24] @ 4-byte Spill
; ARMV7-NEXT:    ldr r7, [sp, #88]
; ARMV7-NEXT:    umull r0, r12, r2, r9
; ARMV7-NEXT:    str r5, [sp, #16] @ 4-byte Spill
; ARMV7-NEXT:    str r1, [sp, #28] @ 4-byte Spill
; ARMV7-NEXT:    umull r5, lr, r3, r7
; ARMV7-NEXT:    ldr r1, [sp, #92]
; ARMV7-NEXT:    str r0, [sp, #32] @ 4-byte Spill
; ARMV7-NEXT:    umull r0, r11, r2, r4
; ARMV7-NEXT:    str r5, [sp, #12] @ 4-byte Spill
; ARMV7-NEXT:    umull r5, r1, r1, r2
; ARMV7-NEXT:    str r0, [sp, #20] @ 4-byte Spill
; ARMV7-NEXT:    mov r0, #0
; ARMV7-NEXT:    umull r2, r10, r7, r2
; ARMV7-NEXT:    str r5, [sp, #4] @ 4-byte Spill
; ARMV7-NEXT:    ldr r5, [sp, #76]
; ARMV7-NEXT:    umlal r12, r0, r3, r9
; ARMV7-NEXT:    str r2, [sp, #8] @ 4-byte Spill
; ARMV7-NEXT:    ldr r2, [sp, #20] @ 4-byte Reload
; ARMV7-NEXT:    umull r7, r5, r5, r9
; ARMV7-NEXT:    adds r2, r2, r12
; ARMV7-NEXT:    adcs r9, r0, r11
; ARMV7-NEXT:    ldr r11, [sp, #32] @ 4-byte Reload
; ARMV7-NEXT:    str r11, [r8]
; ARMV7-NEXT:    mov r0, #0
; ARMV7-NEXT:    str r2, [r8, #4]
; ARMV7-NEXT:    adc r12, r0, #0
; ARMV7-NEXT:    ldr r2, [sp, #24] @ 4-byte Reload
; ARMV7-NEXT:    umlal r9, r12, r3, r4
; ARMV7-NEXT:    add r2, r7, r2
; ARMV7-NEXT:    ldr r7, [sp, #16] @ 4-byte Reload
; ARMV7-NEXT:    adds r11, r7, r2
; ARMV7-NEXT:    ldr r2, [sp, #4] @ 4-byte Reload
; ARMV7-NEXT:    adc r7, r0, #0
; ARMV7-NEXT:    str r7, [sp, #32] @ 4-byte Spill
; ARMV7-NEXT:    ldr r7, [sp, #12] @ 4-byte Reload
; ARMV7-NEXT:    add r7, r2, r7
; ARMV7-NEXT:    ldr r2, [sp, #8] @ 4-byte Reload
; ARMV7-NEXT:    adds r7, r10, r7
; ARMV7-NEXT:    adc r10, r0, #0
; ARMV7-NEXT:    ldr r0, [sp, #28] @ 4-byte Reload
; ARMV7-NEXT:    adds r0, r0, r2
; ARMV7-NEXT:    adc r11, r11, r7
; ARMV7-NEXT:    ldr r7, [sp, #92]
; ARMV7-NEXT:    cmp r3, #0
; ARMV7-NEXT:    movwne r3, #1
; ARMV7-NEXT:    cmp r7, #0
; ARMV7-NEXT:    mov r2, r7
...
; ARMV7-NEXT:    cmp r3, #0
; ARMV7-NEXT:    mov r2, r3
; ARMV7-NEXT:    movwne r2, #1
; ARMV7-NEXT:    cmp r5, #0
; ARMV7-NEXT:    movwne r5, #1
; ARMV7-NEXT:    and r2, r2, r4
; ARMV7-NEXT:    cmp r6, #0
; ARMV7-NEXT:    orr r1, r1, lr
; ARMV7-NEXT:    mov lr, r3
; ARMV7-NEXT:    orr r2, r2, r5
; ARMV7-NEXT:    movwne r6, #1
; ARMV7-NEXT:    ldr r3, [sp, #72]
; ARMV7-NEXT:    orr r2, r2, r6
; ARMV7-NEXT:    ldr r6, [sp, #88]
; ARMV7-NEXT:    orrs r3, r3, lr
; ARMV7-NEXT:    orr r1, r1, r10
; ARMV7-NEXT:    movwne r3, #1
; ARMV7-NEXT:    orrs r7, r6, r7
; ARMV7-NEXT:    movwne r7, #1
; ARMV7-NEXT:    adds r0, r9, r0
; ARMV7-NEXT:    str r0, [r8, #8]
; ARMV7-NEXT:    adcs r0, r12, r11
; ARMV7-NEXT:    str r0, [r8, #12]
; ARMV7-NEXT:    ldr r0, [sp, #32] @ 4-byte Reload
; ARMV7-NEXT:    orr r0, r2, r0
; ARMV7-NEXT:    and r2, r3, r7
; ARMV7-NEXT:    orr r0, r2, r0
