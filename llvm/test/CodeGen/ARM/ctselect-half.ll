...
; BFLOAT-F16-NATIVE-NEXT:    ldrh r3, [sp, #68]
; BFLOAT-F16-NATIVE-NEXT:    vmov.32 d16[0], r2
; BFLOAT-F16-NATIVE-NEXT:    ldrh r2, [sp, #64]
; BFLOAT-F16-NATIVE-NEXT:    orr r7, r7, r12, lsl #16
; BFLOAT-F16-NATIVE-NEXT:    ldrh r5, [sp, #52]
; BFLOAT-F16-NATIVE-NEXT:    orr r2, r2, r3, lsl #16
; BFLOAT-F16-NATIVE-NEXT:    vmov.32 d17[0], r7
; BFLOAT-F16-NATIVE-NEXT:    ldrh r7, [sp, #48]
; BFLOAT-F16-NATIVE-NEXT:    ldrh r3, [sp, #28]
; BFLOAT-F16-NATIVE-NEXT:    vmov.32 d19[0], r2
; BFLOAT-F16-NATIVE-NEXT:    ldrh r2, [sp, #24]
; BFLOAT-F16-NATIVE-NEXT:    orr r7, r7, r5, lsl #16
; BFLOAT-F16-NATIVE-NEXT:    ldrh r5, [sp, #60]
; BFLOAT-F16-NATIVE-NEXT:    vmov.32 d18[0], r7
; BFLOAT-F16-NATIVE-NEXT:    orr r2, r2, r3, lsl #16
; BFLOAT-F16-NATIVE-NEXT:    ldrh r7, [sp, #56]
; BFLOAT-F16-NATIVE-NEXT:    ldrh lr, [sp, #76]
; BFLOAT-F16-NATIVE-NEXT:    vmov.32 d16[1], r2
; BFLOAT-F16-NATIVE-NEXT:    orr r2, r7, r5, lsl #16
; BFLOAT-F16-NATIVE-NEXT:    ldrh r4, [sp, #72]
...
; F16-NATIVE-NEXT:    ldrh r3, [sp, #68]
; F16-NATIVE-NEXT:    vmov.32 d16[0], r2
; F16-NATIVE-NEXT:    ldrh r2, [sp, #64]
; F16-NATIVE-NEXT:    orr r7, r7, r12, lsl #16
; F16-NATIVE-NEXT:    ldrh r5, [sp, #52]
; F16-NATIVE-NEXT:    orr r2, r2, r3, lsl #16
; F16-NATIVE-NEXT:    vmov.32 d17[0], r7
; F16-NATIVE-NEXT:    ldrh r7, [sp, #48]
; F16-NATIVE-NEXT:    ldrh r3, [sp, #28]
; F16-NATIVE-NEXT:    vmov.32 d19[0], r2
; F16-NATIVE-NEXT:    ldrh r2, [sp, #24]
; F16-NATIVE-NEXT:    orr r7, r7, r5, lsl #16
; F16-NATIVE-NEXT:    ldrh r5, [sp, #60]
; F16-NATIVE-NEXT:    vmov.32 d18[0], r7
; F16-NATIVE-NEXT:    orr r2, r2, r3, lsl #16
; F16-NATIVE-NEXT:    ldrh r7, [sp, #56]
; F16-NATIVE-NEXT:    ldrh lr, [sp, #76]
; F16-NATIVE-NEXT:    vmov.32 d16[1], r2
; F16-NATIVE-NEXT:    orr r2, r7, r5, lsl #16
; F16-NATIVE-NEXT:    ldrh r4, [sp, #72]
