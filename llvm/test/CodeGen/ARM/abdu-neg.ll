...
; CHECK-THUMB-NEXT:    ldr r2, [sp, #60]
; CHECK-THUMB-NEXT:    ldr r5, [sp, #56]
; CHECK-THUMB-NEXT:    ldr r6, [sp, #52]
; CHECK-THUMB-NEXT:    ldr r1, [sp, #48]
; CHECK-THUMB-NEXT:    subs r7, r1, r0
...
; CHECK-THUMB-NEXT:    ldr r0, [sp, #4] @ 4-byte Reload
