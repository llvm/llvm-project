...
; RUN: llc < %s -mtriple=thumbv8.1m.main-none-eabi -mattr=+fullfp16 | FileCheck %s
; RUN: llc < %s -mtriple=thumbv8.1m.main-none-eabi -mattr=+fullfp16,+slowfpvfmx | FileCheck %s -check-prefix=DONT-FUSE
...
; DONT-FUSE-NEXT:    vmla.f16 s4, s2, s0
...
; DONT-FUSE-NEXT:    bx lr
  ...
  %1 = fmul contract half %f1, %f2
  %2 = fadd contract half %1, %f3
...
; DONT-FUSE-NEXT:    vmls.f16 s4, s2, s0
; DONT-FUSE-NEXT:    vstr.16 s4, [r0]
; DONT-FUSE-NEXT:    bx lr
  ...
  %f2 = load half, ptr %a2, align 2
  %f3 = load half, ptr %a3, align 2
  %1 = fmul contract half %f2, %f3
  %2 = fsub contract half %f1, %1
  store half %2, ptr %a1, align 2
  ret void
}
...
; DONT-FUSE-NEXT:    vldr.16 s2, [r0]
; DONT-FUSE-NEXT:    vldr.16 s4, [r2]
; DONT-FUSE-NEXT:    vnmla.f16 s4, s2, s0
; DONT-FUSE-NEXT:    vstr.16 s4, [r0]
; DONT-FUSE-NEXT:    bx lr
...
; DONT-FUSE-NEXT:    vldr.16 s2, [r0]
; DONT-FUSE-NEXT:    vldr.16 s4, [r2]
; DONT-FUSE-NEXT:    vnmls.f16 s4, s2, s0
; DONT-FUSE-NEXT:    vstr.16 s4, [r0]
; DONT-FUSE-NEXT:    bx lr
...
; CHECK-NEXT:    vmov.f16 s0, #2.000000e+00
; CHECK-NEXT:    vfma.f16 s4, s2, s0
; CHECK-NEXT:    vstr.16 s4, [r0]
; CHECK-NEXT:    bx lr
;
...
; DONT-FUSE-NEXT:    vmov.f16 s0, #2.000000e+00
; DONT-FUSE-NEXT:    vfma.f16 s4, s2, s0
; DONT-FUSE-NEXT:    vstr.16 s4, [r0]
; DONT-FUSE-NEXT:    bx lr
