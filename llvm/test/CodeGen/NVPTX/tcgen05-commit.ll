...
; RUN: llc < %s -march=nvptx64 -mcpu=sm_100a -mattr=+ptx86 -target-abi=shortptr | FileCheck --check-prefixes=CHECK_PTX64_SHARED32 %s
...
; RUN: %if ptxas-sm_100a && ptxas-isa-8.6 %{ llc < %s -march=nvptx64 -mcpu=sm_100a -mattr=+ptx86 -target-abi=shortptr | %ptxas-verify -arch=sm_100a %}
