...
; CHECK-NEXT:    subc.cc.s64 %rd4, %rd57, 0;
...
; CHECK-NEXT:    xor.b64 %rd19, %rd3, 127;
; CHECK-NEXT:    or.b64 %rd20, %rd19, %rd4;
...
; CHECK-NEXT:    sub.s32 %r6, 127, %r5;
; CHECK-NEXT:    shl.b64 %rd22, %rd8, %r6;
; CHECK-NEXT:    sub.s32 %r7, 64, %r6;
; CHECK-NEXT:    shr.u64 %rd23, %rd7, %r7;
; CHECK-NEXT:    or.b64 %rd24, %rd22, %rd23;
; CHECK-NEXT:    sub.s32 %r8, 63, %r5;
; CHECK-NEXT:    shl.b64 %rd25, %rd7, %r8;
...
; CHECK-NEXT:    shr.u64 %rd26, %rd7, %r9;
; CHECK-NEXT:    sub.s32 %r10, 64, %r9;
; CHECK-NEXT:    shl.b64 %rd27, %rd8, %r10;
; CHECK-NEXT:    or.b64 %rd28, %rd26, %rd27;
; CHECK-NEXT:    add.s32 %r11, %r9, -64;
; CHECK-NEXT:    shr.u64 %rd29, %rd8, %r11;
...
; CHECK-NEXT:    subc.cc.s64 %rd2, %rd51, 0;
...
; CHECK-NEXT:    or.pred %p10, %p8, %p9;
; CHECK-NEXT:    or.pred %p11, %p3, %p10;
; CHECK-NEXT:    xor.b64 %rd19, %rd1, 127;
; CHECK-NEXT:    or.b64 %rd20, %rd19, %rd2;
; CHECK-NEXT:    setp.eq.b64 %p12, %rd20, 0;
...
; CHECK-NEXT:    and.b64 %rd43, %rd42, %rd7;
; CHECK-NEXT:    and.b64 %rd44, %rd42, %rd8;
