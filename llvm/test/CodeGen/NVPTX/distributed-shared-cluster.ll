...
; RUN: llc < %s -o - -mcpu=sm_90 -mattr=+ptx78 -target-abi=sharedshortptr | FileCheck %s --check-prefix=CHECK-SHARED-SHORT
...
; CHECK-SHARED-SHORT-LABEL: test_distributed_shared_cluster_common(
; CHECK-SHARED-SHORT:         .param .b32 test_distributed_shared_cluster_common_param_1
; CHECK-SHARED-SHORT:         mapa.shared::cluster.u32
