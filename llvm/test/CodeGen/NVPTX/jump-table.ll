...
; PTX60-NEXT:  $L__BB0_3: // %case2
; PTX60-NEXT:    st.global.b32 [out], 2;
; PTX60-NEXT:    bra.uni $L__BB0_6;
; PTX60-NEXT:  $L__BB0_4: // %case3
; PTX60-NEXT:    st.global.b32 [out], 3;
; PTX60-NEXT:    bra.uni $L__BB0_6;
; PTX60-NEXT:  $L__BB0_5: // %case1
...
; PTX60-NEXT:    @%p1 bra $L__BB1_3;
; PTX60-NEXT:  // %bb.1: // %entry
; PTX60-NEXT:    setp.lt.u32 %p4, %r1, 6;
; PTX60-NEXT:    @%p4 bra $L__BB1_7;
; PTX60-NEXT:  // %bb.2: // %entry
; PTX60-NEXT:    setp.lt.s32 %p5, %r1, -2147483645;
; PTX60-NEXT:    @%p5 bra $L__BB1_7;
; PTX60-NEXT:    bra.uni $L__BB1_9;
; PTX60-NEXT:  $L__BB1_3: // %entry
; PTX60-NEXT:    add.s32 %r2, %r1, -120;
; PTX60-NEXT:    setp.gt.u32 %p2, %r2, 5;
; PTX60-NEXT:    @%p2 bra $L__BB1_6;
; PTX60-NEXT:  // %bb.4: // %entry
; PTX60-NEXT:    $L_brx_0: .branchtargets
; PTX60-NEXT:     $L__BB1_7,
; PTX60-NEXT:     $L__BB1_5,
