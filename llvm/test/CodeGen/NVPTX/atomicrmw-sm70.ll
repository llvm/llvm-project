...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB60_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    add.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB60_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
...
; SM70-NOFTZ-DISALLOW-LABEL: fsub_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fsub_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fsub_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB61_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    sub.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB61_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmin_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmin_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmin_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB62_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    min.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB62_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fmin_acq_rel_float_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmin_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmin_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB62_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    min.f32 %r3, %r4, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    @%p1 bra $L__BB62_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fmin_acq_rel_float_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmin_acq_rel_float_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmin_acq_rel_float_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:  $L__BB62_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    min.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p1 bra $L__BB62_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fmin_acq_rel_float_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmin_acq_rel_float_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmin_acq_rel_float_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-FTZ-ALLOW-NEXT:  $L__BB62_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    min.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-ALLOW-NEXT:    @%p1 bra $L__BB62_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmax_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmax_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmax_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB63_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    max.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB63_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fmax_acq_rel_float_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmax_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmax_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB63_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    max.f32 %r3, %r4, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    @%p1 bra $L__BB63_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fmax_acq_rel_float_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmax_acq_rel_float_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmax_acq_rel_float_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:  $L__BB63_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    max.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p1 bra $L__BB63_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fmax_acq_rel_float_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmax_acq_rel_float_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmax_acq_rel_float_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-FTZ-ALLOW-NEXT:  $L__BB63_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    max.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-ALLOW-NEXT:    @%p1 bra $L__BB63_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fminimum_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<6>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fminimum_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fminimum_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b32 %p3, %r2, -2147483648;
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB64_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f32 %p1, %r8, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    min.f32 %r3, %r8, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b32 %p2, %r8, -2147483648;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.f32 %p4, %r4, 0f00000000;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r8, %r7;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p5 bra $L__BB64_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fminimum_acq_rel_float_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<6>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fminimum_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fminimum_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b32 %p3, %r2, -2147483648;
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB64_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f32 %p1, %r8, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    min.f32 %r3, %r8, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b32 %p2, %r8, -2147483648;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.f32 %p4, %r4, 0f00000000;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
; SM70-NOFTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r8, %r7;
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    @%p5 bra $L__BB64_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fminimum_acq_rel_float_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<6>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fminimum_acq_rel_float_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fminimum_acq_rel_float_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b32 %p3, %r2, -2147483648;
; SM70-FTZ-DISALLOW-NEXT:  $L__BB64_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f32 %p1, %r8, %r2;
; SM70-FTZ-DISALLOW-NEXT:    min.ftz.f32 %r3, %r8, %r2;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b32 %p2, %r8, -2147483648;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.ftz.f32 %p4, %r4, 0f00000000;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r8, %r7;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p5 bra $L__BB64_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fminimum_acq_rel_float_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<6>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fminimum_acq_rel_float_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fminimum_acq_rel_float_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b32 %p3, %r2, -2147483648;
; SM70-FTZ-ALLOW-NEXT:  $L__BB64_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f32 %p1, %r8, %r2;
; SM70-FTZ-ALLOW-NEXT:    min.ftz.f32 %r3, %r8, %r2;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b32 %p2, %r8, -2147483648;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.ftz.f32 %p4, %r4, 0f00000000;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
; SM70-FTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r8, %r7;
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-FTZ-ALLOW-NEXT:    @%p5 bra $L__BB64_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmaximum_acq_rel_float_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<6>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmaximum_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmaximum_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b32 %p3, %r2, 0;
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB65_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f32 %p1, %r8, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    max.f32 %r3, %r8, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b32 %p2, %r8, 0;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.f32 %p4, %r4, 0f00000000;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
...
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p5 bra $L__BB65_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fmaximum_acq_rel_float_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<6>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmaximum_acq_rel_float_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmaximum_acq_rel_float_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b32 %p3, %r2, 0;
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB65_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f32 %p1, %r8, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    max.f32 %r3, %r8, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b32 %p2, %r8, 0;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.f32 %p4, %r4, 0f00000000;
; SM70-NOFTZ-ALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
...
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    @%p5 bra $L__BB65_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fmaximum_acq_rel_float_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<6>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fmaximum_acq_rel_float_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fmaximum_acq_rel_float_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b32 %p3, %r2, 0;
; SM70-FTZ-DISALLOW-NEXT:  $L__BB65_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f32 %p1, %r8, %r2;
; SM70-FTZ-DISALLOW-NEXT:    max.ftz.f32 %r3, %r8, %r2;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b32 %p2, %r8, 0;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.ftz.f32 %p4, %r4, 0f00000000;
; SM70-FTZ-DISALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
...
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p5 bra $L__BB65_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fmaximum_acq_rel_float_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<6>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<9>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r2, [fmaximum_acq_rel_float_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fmaximum_acq_rel_float_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r8, [%rd1];
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b32 %p3, %r2, 0;
; SM70-FTZ-ALLOW-NEXT:  $L__BB65_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f32 %p1, %r8, %r2;
; SM70-FTZ-ALLOW-NEXT:    max.ftz.f32 %r3, %r8, %r2;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r4, 0f7FC00000, %r3, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b32 %p2, %r8, 0;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r5, %r8, %r4, %p2;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r6, %r2, %r5, %p3;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.ftz.f32 %p4, %r4, 0f00000000;
; SM70-FTZ-ALLOW-NEXT:    selp.f32 %r7, %r6, %r4, %p4;
...
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p5, %r1, %r8;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r8, %r1;
; SM70-FTZ-ALLOW-NEXT:    @%p5 bra $L__BB65_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmin_acq_rel_half_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<4>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_half_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_half_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_half_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_half_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmax_acq_rel_half_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<4>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<18>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_half_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_half_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_half_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_half_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fminimum_acq_rel_half_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<9>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<15>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB76_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.lt.f16 %p1, %rs2, %rs1;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f16 %p2, %rs2, %rs1;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.f16 %p5, %rs4, %rs7;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs8, %rs6, %rs4, %p5;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u16 %r9, %rs8;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r10, %r9, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r11, %r14, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    or.b32 %r12, %r11, %r10;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r14, %r12;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p6 bra $L__BB76_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b16 %rs<9>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<15>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB76_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    setp.lt.f16 %p1, %rs2, %rs1;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f16 %p2, %rs2, %rs1;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.f16 %p5, %rs4, %rs7;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs8, %rs6, %rs4, %p5;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u16 %r9, %rs8;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r10, %r9, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r11, %r14, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    or.b32 %r12, %r11, %r10;
; SM70-NOFTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r14, %r12;
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    @%p6 bra $L__BB76_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b16 %rs<9>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<15>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_half_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_half_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-FTZ-DISALLOW-NEXT:  $L__BB76_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-DISALLOW-NEXT:    setp.lt.ftz.f16 %p1, %rs2, %rs1;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f16 %p2, %rs2, %rs1;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.ftz.f16 %p5, %rs4, %rs7;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs8, %rs6, %rs4, %p5;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u16 %r9, %rs8;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r10, %r9, %r1;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r11, %r14, %r2;
; SM70-FTZ-DISALLOW-NEXT:    or.b32 %r12, %r11, %r10;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r14, %r12;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-FTZ-DISALLOW-NEXT:    @%p6 bra $L__BB76_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<7>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b16 %rs<9>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<15>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_half_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_half_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-FTZ-ALLOW-NEXT:  $L__BB76_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-FTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-ALLOW-NEXT:    setp.lt.ftz.f16 %p1, %rs2, %rs1;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f16 %p2, %rs2, %rs1;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-ALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.ftz.f16 %p5, %rs4, %rs7;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs8, %rs6, %rs4, %p5;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u16 %r9, %rs8;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r10, %r9, %r1;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r11, %r14, %r2;
; SM70-FTZ-ALLOW-NEXT:    or.b32 %r12, %r11, %r10;
; SM70-FTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r14, %r12;
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-FTZ-ALLOW-NEXT:    @%p6 bra $L__BB76_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmaximum_acq_rel_half_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<9>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<15>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, 0;
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB77_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.gt.f16 %p1, %rs2, %rs1;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f16 %p2, %rs2, %rs1;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.f16 %p5, %rs4, %rs7;
...
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p6 bra $L__BB77_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_half_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_half_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, 0;
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB77_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    setp.gt.f16 %p1, %rs2, %rs1;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f16 %p2, %rs2, %rs1;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.f16 %p5, %rs4, %rs7;
...
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    @%p6 bra $L__BB77_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_half_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_half_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, 0;
; SM70-FTZ-DISALLOW-NEXT:  $L__BB77_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-DISALLOW-NEXT:    setp.gt.ftz.f16 %p1, %rs2, %rs1;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f16 %p2, %rs2, %rs1;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.ftz.f16 %p5, %rs4, %rs7;
...
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-FTZ-DISALLOW-NEXT:    @%p6 bra $L__BB77_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_half_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_half_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r14, [%rd1];
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, 0;
; SM70-FTZ-ALLOW-NEXT:  $L__BB77_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r8, %r14, %r1;
; SM70-FTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-ALLOW-NEXT:    setp.gt.ftz.f16 %p1, %rs2, %rs1;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f16 %p2, %rs2, %rs1;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7E00, %rs3, %p2;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-ALLOW-NEXT:    mov.b16 %rs7, 0x0000;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.ftz.f16 %p5, %rs4, %rs7;
...
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r14;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r14, %r3;
; SM70-FTZ-ALLOW-NEXT:    @%p6 bra $L__BB77_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r13, %r3, %r1;
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r13;
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fadd_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fadd_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fadd_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fadd_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fsub_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<3>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<24>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fsub_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fsub_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fsub_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fsub_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fsub_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fsub_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fsub_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fsub_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmin_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<3>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<24>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmin_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmin_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmax_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<3>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<24>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmax_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmax_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-LABEL: fminimum_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<8>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<20>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r7, %r6, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r19, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u16 %r10, %rs1;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r11, %r10, 16;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB82_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r8, %r19, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.lt.f32 %p1, %r9, %r11;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f32 %p2, %r9, %r11;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u16 %r12, %rs4;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r13, %r12, 16;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.f32 %p5, %r13, 0f00000000;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs7, %rs6, %rs4, %p5;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u16 %r14, %rs7;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r15, %r14, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r16, %r19, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    or.b32 %r17, %r16, %r15;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r19, %r17;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p6 bra $L__BB82_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fminimum_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b16 %rs<8>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<20>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r7, %r6, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-NOFTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r19, [%rd1];
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u16 %r10, %rs1;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r11, %r10, 16;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-NOFTZ-ALLOW-NEXT:  $L__BB82_1: // %atomicrmw.start
; SM70-NOFTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r8, %r19, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-NOFTZ-ALLOW-NEXT:    setp.lt.f32 %p1, %r9, %r11;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f32 %p2, %r9, %r11;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u16 %r12, %rs4;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r13, %r12, 16;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.f32 %p5, %r13, 0f00000000;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs7, %rs6, %rs4, %p5;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u16 %r14, %rs7;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r15, %r14, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r16, %r19, %r2;
; SM70-NOFTZ-ALLOW-NEXT:    or.b32 %r17, %r16, %r15;
; SM70-NOFTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r19, %r17;
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    @%p6 bra $L__BB82_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fminimum_acq_rel_bfloat_global_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b16 %rs<8>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<20>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r7, %r6, %r1;
; SM70-FTZ-DISALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r19, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u16 %r10, %rs1;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r11, %r10, 16;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-FTZ-DISALLOW-NEXT:  $L__BB82_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r8, %r19, %r1;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-FTZ-DISALLOW-NEXT:    setp.lt.ftz.f32 %p1, %r9, %r11;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f32 %p2, %r9, %r11;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u16 %r12, %rs4;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r13, %r12, 16;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.ftz.f32 %p5, %r13, 0f00000000;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs7, %rs6, %rs4, %p5;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u16 %r14, %rs7;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r15, %r14, %r1;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r16, %r19, %r2;
; SM70-FTZ-DISALLOW-NEXT:    or.b32 %r17, %r16, %r15;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r19, %r17;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-FTZ-DISALLOW-NEXT:    @%p6 bra $L__BB82_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fminimum_acq_rel_bfloat_global_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .pred %p<7>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b16 %rs<8>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<20>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<3>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fminimum_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fminimum_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r7, %r6, %r1;
; SM70-FTZ-ALLOW-NEXT:    not.b32 %r2, %r7;
; SM70-FTZ-ALLOW-NEXT:    ld.relaxed.cta.global.b32 %r19, [%rd1];
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u16 %r10, %rs1;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r11, %r10, 16;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p4, %rs1, -32768;
; SM70-FTZ-ALLOW-NEXT:  $L__BB82_1: // %atomicrmw.start
; SM70-FTZ-ALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r8, %r19, %r1;
; SM70-FTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-FTZ-ALLOW-NEXT:    setp.lt.ftz.f32 %p1, %r9, %r11;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f32 %p2, %r9, %r11;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, -32768;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs5, %rs2, %rs4, %p3;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs6, %rs1, %rs5, %p4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u16 %r12, %rs4;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r13, %r12, 16;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.ftz.f32 %p5, %r13, 0f00000000;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs7, %rs6, %rs4, %p5;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u16 %r14, %rs7;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r15, %r14, %r1;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r16, %r19, %r2;
; SM70-FTZ-ALLOW-NEXT:    or.b32 %r17, %r16, %r15;
; SM70-FTZ-ALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r3, [%rd1], %r19, %r17;
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-FTZ-ALLOW-NEXT:    @%p6 bra $L__BB82_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fmaximum_acq_rel_bfloat_global_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<7>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b16 %rs<8>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<20>;
...
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-DISALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.gt.f32 %p1, %r9, %r11;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.nan.f32 %p2, %r9, %r11;
; SM70-NOFTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
...
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p6 bra $L__BB83_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
...
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_bfloat_global_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_bfloat_global_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-NOFTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-NOFTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-NOFTZ-ALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-NOFTZ-ALLOW-NEXT:    setp.gt.f32 %p1, %r9, %r11;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-NOFTZ-ALLOW-NEXT:    setp.nan.f32 %p2, %r9, %r11;
; SM70-NOFTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-NOFTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
...
; SM70-NOFTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-NOFTZ-ALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-NOFTZ-ALLOW-NEXT:    @%p6 bra $L__BB83_1;
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-ALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-NOFTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
...
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-DISALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-DISALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-DISALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-DISALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-FTZ-DISALLOW-NEXT:    setp.gt.ftz.f32 %p1, %r9, %r11;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-DISALLOW-NEXT:    setp.nan.ftz.f32 %p2, %r9, %r11;
; SM70-FTZ-DISALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-FTZ-DISALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
...
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-FTZ-DISALLOW-NEXT:    @%p6 bra $L__BB83_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
...
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b16 %rs1, [fmaximum_acq_rel_bfloat_global_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd2, [fmaximum_acq_rel_bfloat_global_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    and.b64 %rd1, %rd2, -4;
; SM70-FTZ-ALLOW-NEXT:    cvt.u32.u64 %r4, %rd2;
; SM70-FTZ-ALLOW-NEXT:    and.b32 %r5, %r4, 3;
...
; SM70-FTZ-ALLOW-NEXT:    cvt.u16.u32 %rs2, %r8;
; SM70-FTZ-ALLOW-NEXT:    shl.b32 %r9, %r8, 16;
; SM70-FTZ-ALLOW-NEXT:    setp.gt.ftz.f32 %p1, %r9, %r11;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs3, %rs2, %rs1, %p1;
; SM70-FTZ-ALLOW-NEXT:    setp.nan.ftz.f32 %p2, %r9, %r11;
; SM70-FTZ-ALLOW-NEXT:    selp.b16 %rs4, 0x7FC0, %rs3, %p2;
; SM70-FTZ-ALLOW-NEXT:    setp.eq.b16 %p3, %rs2, 0;
...
; SM70-FTZ-ALLOW-NEXT:    setp.ne.b32 %p6, %r3, %r19;
; SM70-FTZ-ALLOW-NEXT:    mov.b32 %r19, %r3;
; SM70-FTZ-ALLOW-NEXT:    @%p6 bra $L__BB83_1;
; SM70-FTZ-ALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-ALLOW-NEXT:    shr.u32 %r18, %r3, %r1;
; SM70-FTZ-ALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-ALLOW-NEXT:    st.param.b16 [func_retval0], %r18;
...
define i32 @add_acq_rel_i32_global_sys(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: add_acq_rel_i32_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i32_global_sys_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [add_acq_rel_i32_global_sys_param_1];
; SM70-NEXT:    atom.acq_rel.sys.global.add.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i64 @add_acq_rel_i64_global_sys(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: add_acq_rel_i64_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i64_global_sys_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [add_acq_rel_i64_global_sys_param_1];
; SM70-NEXT:    atom.acq_rel.sys.global.add.u64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @min_acq_rel_i32_global_sys(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: min_acq_rel_i32_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [min_acq_rel_i32_global_sys_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [min_acq_rel_i32_global_sys_param_1];
; SM70-NEXT:    atom.acq_rel.sys.global.min.s32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @umax_acq_rel_i32_global_sys(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: umax_acq_rel_i32_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [umax_acq_rel_i32_global_sys_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [umax_acq_rel_i32_global_sys_param_1];
; SM70-NEXT:    atom.acq_rel.sys.global.max.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @nand_acq_rel_i32_global_sys(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: nand_acq_rel_i32_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b32 %r<6>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b32 %r2, [nand_acq_rel_i32_global_sys_param_1];
; SM70-NEXT:    ld.param.b64 %rd1, [nand_acq_rel_i32_global_sys_param_0];
; SM70-NEXT:    fence.acq_rel.sys;
; SM70-NEXT:    ld.relaxed.sys.global.b32 %r5, [%rd1];
; SM70-NEXT:  $L__BB104_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b32 %r3, %r5, %r2;
; SM70-NEXT:    not.b32 %r4, %r3;
; SM70-NEXT:    atom.relaxed.sys.global.cas.b32 %r1, [%rd1], %r5, %r4;
; SM70-NEXT:    setp.ne.b32 %p1, %r1, %r5;
; SM70-NEXT:    mov.b32 %r5, %r1;
; SM70-NEXT:    @%p1 bra $L__BB104_1;
; SM70-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NEXT:    fence.acq_rel.sys;
; SM70-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NEXT:    ret;
...
define i64 @nand_acq_rel_i64_global_sys(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: nand_acq_rel_i64_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b64 %rd<7>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd3, [nand_acq_rel_i64_global_sys_param_1];
; SM70-NEXT:    ld.param.b64 %rd2, [nand_acq_rel_i64_global_sys_param_0];
; SM70-NEXT:    fence.acq_rel.sys;
; SM70-NEXT:    ld.relaxed.sys.global.b64 %rd6, [%rd2];
; SM70-NEXT:  $L__BB105_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b64 %rd4, %rd6, %rd3;
; SM70-NEXT:    not.b64 %rd5, %rd4;
; SM70-NEXT:    atom.relaxed.sys.global.cas.b64 %rd1, [%rd2], %rd6, %rd5;
; SM70-NEXT:    setp.ne.b64 %p1, %rd1, %rd6;
; SM70-NEXT:    mov.b64 %rd6, %rd1;
; SM70-NEXT:    @%p1 bra $L__BB105_1;
; SM70-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NEXT:    fence.acq_rel.sys;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd1;
; SM70-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_sys(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_global_sys_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_sys_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.sys;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.sys.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB106_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    add.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.sys.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB106_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.sys;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_global_sys(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_sys_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_sys_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.sys.global.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_sys(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_sys_param_0];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_sys_param_1];
; SM70-FTZ-DISALLOW-NEXT:    atom.acq_rel.sys.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_global_sys(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_sys_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_sys_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.sys.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
define double @fadd_acq_rel_double_global_sys(ptr addrspace(1) %addr, double %val) {
; SM70-LABEL: fadd_acq_rel_double_global_sys(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_double_global_sys_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_double_global_sys_param_1];
; SM70-NEXT:    atom.acq_rel.sys.global.add.f64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @add_acq_rel_i32_global_cluster(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: add_acq_rel_i32_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i32_global_cluster_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [add_acq_rel_i32_global_cluster_param_1];
; SM70-NEXT:    atom.acq_rel.cta.global.add.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i64 @add_acq_rel_i64_global_cluster(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: add_acq_rel_i64_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i64_global_cluster_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [add_acq_rel_i64_global_cluster_param_1];
; SM70-NEXT:    atom.acq_rel.cta.global.add.u64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @min_acq_rel_i32_global_cluster(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: min_acq_rel_i32_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [min_acq_rel_i32_global_cluster_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [min_acq_rel_i32_global_cluster_param_1];
; SM70-NEXT:    atom.acq_rel.cta.global.min.s32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @umax_acq_rel_i32_global_cluster(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: umax_acq_rel_i32_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [umax_acq_rel_i32_global_cluster_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [umax_acq_rel_i32_global_cluster_param_1];
; SM70-NEXT:    atom.acq_rel.cta.global.max.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @nand_acq_rel_i32_global_cluster(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: nand_acq_rel_i32_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b32 %r<6>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b32 %r2, [nand_acq_rel_i32_global_cluster_param_1];
; SM70-NEXT:    ld.param.b64 %rd1, [nand_acq_rel_i32_global_cluster_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.global.b32 %r5, [%rd1];
...
define i64 @nand_acq_rel_i64_global_cluster(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: nand_acq_rel_i64_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b64 %rd<7>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd3, [nand_acq_rel_i64_global_cluster_param_1];
; SM70-NEXT:    ld.param.b64 %rd2, [nand_acq_rel_i64_global_cluster_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.global.b64 %rd6, [%rd2];
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_cluster(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_global_cluster_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cluster_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB114_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    add.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB114_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_global_cluster(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cluster_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cluster_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_cluster(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cluster_param_0];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cluster_param_1];
; SM70-FTZ-DISALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_global_cluster(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_cluster_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_cluster_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.cta.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
define double @fadd_acq_rel_double_global_cluster(ptr addrspace(1) %addr, double %val) {
; SM70-LABEL: fadd_acq_rel_double_global_cluster(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_double_global_cluster_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_double_global_cluster_param_1];
; SM70-NEXT:    atom.acq_rel.cta.global.add.f64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @add_acq_rel_i32_global_gpu(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: add_acq_rel_i32_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i32_global_gpu_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [add_acq_rel_i32_global_gpu_param_1];
; SM70-NEXT:    atom.acq_rel.gpu.global.add.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i64 @add_acq_rel_i64_global_gpu(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: add_acq_rel_i64_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i64_global_gpu_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [add_acq_rel_i64_global_gpu_param_1];
; SM70-NEXT:    atom.acq_rel.gpu.global.add.u64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @min_acq_rel_i32_global_gpu(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: min_acq_rel_i32_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [min_acq_rel_i32_global_gpu_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [min_acq_rel_i32_global_gpu_param_1];
; SM70-NEXT:    atom.acq_rel.gpu.global.min.s32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @umax_acq_rel_i32_global_gpu(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: umax_acq_rel_i32_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [umax_acq_rel_i32_global_gpu_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [umax_acq_rel_i32_global_gpu_param_1];
; SM70-NEXT:    atom.acq_rel.gpu.global.max.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @nand_acq_rel_i32_global_gpu(ptr addrspace(1) %addr, i32 %val) {
; SM70-LABEL: nand_acq_rel_i32_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b32 %r<6>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b32 %r2, [nand_acq_rel_i32_global_gpu_param_1];
; SM70-NEXT:    ld.param.b64 %rd1, [nand_acq_rel_i32_global_gpu_param_0];
; SM70-NEXT:    fence.acq_rel.gpu;
; SM70-NEXT:    ld.relaxed.gpu.global.b32 %r5, [%rd1];
; SM70-NEXT:  $L__BB120_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b32 %r3, %r5, %r2;
; SM70-NEXT:    not.b32 %r4, %r3;
; SM70-NEXT:    atom.relaxed.gpu.global.cas.b32 %r1, [%rd1], %r5, %r4;
; SM70-NEXT:    setp.ne.b32 %p1, %r1, %r5;
; SM70-NEXT:    mov.b32 %r5, %r1;
...
define i64 @nand_acq_rel_i64_global_gpu(ptr addrspace(1) %addr, i64 %val) {
; SM70-LABEL: nand_acq_rel_i64_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b64 %rd<7>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd3, [nand_acq_rel_i64_global_gpu_param_1];
; SM70-NEXT:    ld.param.b64 %rd2, [nand_acq_rel_i64_global_gpu_param_0];
; SM70-NEXT:    fence.acq_rel.gpu;
; SM70-NEXT:    ld.relaxed.gpu.global.b64 %rd6, [%rd2];
; SM70-NEXT:  $L__BB121_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b64 %rd4, %rd6, %rd3;
; SM70-NEXT:    not.b64 %rd5, %rd4;
; SM70-NEXT:    atom.relaxed.gpu.global.cas.b64 %rd1, [%rd2], %rd6, %rd5;
; SM70-NEXT:    setp.ne.b64 %p1, %rd1, %rd6;
; SM70-NEXT:    mov.b64 %rd6, %rd1;
; SM70-NEXT:    @%p1 bra $L__BB121_1;
; SM70-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NEXT:    fence.acq_rel.gpu;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd1;
; SM70-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_gpu(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_global_gpu_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_gpu_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.gpu;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.gpu.global.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB122_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    add.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.gpu.global.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB122_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.gpu;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_global_gpu(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_gpu_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_gpu_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.gpu.global.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_global_gpu(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_gpu_param_0];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_gpu_param_1];
; SM70-FTZ-DISALLOW-NEXT:    atom.acq_rel.gpu.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_global_gpu(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_global_gpu_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_global_gpu_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.gpu.global.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
define double @fadd_acq_rel_double_global_gpu(ptr addrspace(1) %addr, double %val) {
; SM70-LABEL: fadd_acq_rel_double_global_gpu(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_double_global_gpu_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_double_global_gpu_param_1];
; SM70-NEXT:    atom.acq_rel.gpu.global.add.f64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @add_acq_rel_i32_generic_cta(ptr %addr, i32 %val) {
; SM70-LABEL: add_acq_rel_i32_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i32_generic_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [add_acq_rel_i32_generic_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.add.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i64 @add_acq_rel_i64_generic_cta(ptr %addr, i64 %val) {
; SM70-LABEL: add_acq_rel_i64_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i64_generic_cta_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [add_acq_rel_i64_generic_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.add.u64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @min_acq_rel_i32_generic_cta(ptr %addr, i32 %val) {
; SM70-LABEL: min_acq_rel_i32_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [min_acq_rel_i32_generic_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [min_acq_rel_i32_generic_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.min.s32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @umax_acq_rel_i32_generic_cta(ptr %addr, i32 %val) {
; SM70-LABEL: umax_acq_rel_i32_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [umax_acq_rel_i32_generic_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [umax_acq_rel_i32_generic_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.max.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @nand_acq_rel_i32_generic_cta(ptr %addr, i32 %val) {
; SM70-LABEL: nand_acq_rel_i32_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b32 %r<6>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b32 %r2, [nand_acq_rel_i32_generic_cta_param_1];
; SM70-NEXT:    ld.param.b64 %rd1, [nand_acq_rel_i32_generic_cta_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.b32 %r5, [%rd1];
; SM70-NEXT:  $L__BB128_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b32 %r3, %r5, %r2;
; SM70-NEXT:    not.b32 %r4, %r3;
; SM70-NEXT:    atom.relaxed.cta.cas.b32 %r1, [%rd1], %r5, %r4;
; SM70-NEXT:    setp.ne.b32 %p1, %r1, %r5;
; SM70-NEXT:    mov.b32 %r5, %r1;
...
define i64 @nand_acq_rel_i64_generic_cta(ptr %addr, i64 %val) {
; SM70-LABEL: nand_acq_rel_i64_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b64 %rd<7>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd3, [nand_acq_rel_i64_generic_cta_param_1];
; SM70-NEXT:    ld.param.b64 %rd2, [nand_acq_rel_i64_generic_cta_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.b64 %rd6, [%rd2];
; SM70-NEXT:  $L__BB129_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b64 %rd4, %rd6, %rd3;
; SM70-NEXT:    not.b64 %rd5, %rd4;
; SM70-NEXT:    atom.relaxed.cta.cas.b64 %rd1, [%rd2], %rd6, %rd5;
; SM70-NEXT:    setp.ne.b64 %p1, %rd1, %rd6;
; SM70-NEXT:    mov.b64 %rd6, %rd1;
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_generic_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_generic_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_generic_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    ld.relaxed.cta.b32 %r4, [%rd1];
; SM70-NOFTZ-DISALLOW-NEXT:  $L__BB130_1: // %atomicrmw.start
; SM70-NOFTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NOFTZ-DISALLOW-NEXT:    add.rn.f32 %r3, %r4, %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    atom.relaxed.cta.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-NOFTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-NOFTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    @%p1 bra $L__BB130_1;
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NOFTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_generic_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_generic_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_generic_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.cta.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_generic_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_generic_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_generic_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.b32 %r4, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:  $L__BB130_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    add.rn.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p1 bra $L__BB130_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_generic_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_generic_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_generic_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.cta.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
define double @fadd_acq_rel_double_generic_cta(ptr %addr, double %val) {
; SM70-LABEL: fadd_acq_rel_double_generic_cta(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_double_generic_cta_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_double_generic_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.add.f64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @add_acq_rel_i32_shared_cta(ptr addrspace(3) %addr, i32 %val) {
; SM70-LABEL: add_acq_rel_i32_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i32_shared_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [add_acq_rel_i32_shared_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.shared.add.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i64 @add_acq_rel_i64_shared_cta(ptr addrspace(3) %addr, i64 %val) {
; SM70-LABEL: add_acq_rel_i64_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [add_acq_rel_i64_shared_cta_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [add_acq_rel_i64_shared_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.shared.add.u64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
...
define i32 @min_acq_rel_i32_shared_cta(ptr addrspace(3) %addr, i32 %val) {
; SM70-LABEL: min_acq_rel_i32_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [min_acq_rel_i32_shared_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [min_acq_rel_i32_shared_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.shared.min.s32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @umax_acq_rel_i32_shared_cta(ptr addrspace(3) %addr, i32 %val) {
; SM70-LABEL: umax_acq_rel_i32_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .b32 %r<3>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [umax_acq_rel_i32_shared_cta_param_0];
; SM70-NEXT:    ld.param.b32 %r1, [umax_acq_rel_i32_shared_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.shared.max.u32 %r2, [%rd1], %r1;
; SM70-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NEXT:    ret;
...
define i32 @nand_acq_rel_i32_shared_cta(ptr addrspace(3) %addr, i32 %val) {
; SM70-LABEL: nand_acq_rel_i32_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b32 %r<6>;
; SM70-NEXT:    .reg .b64 %rd<2>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b32 %r2, [nand_acq_rel_i32_shared_cta_param_1];
; SM70-NEXT:    ld.param.b64 %rd1, [nand_acq_rel_i32_shared_cta_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.shared.b32 %r5, [%rd1];
; SM70-NEXT:  $L__BB136_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b32 %r3, %r5, %r2;
; SM70-NEXT:    not.b32 %r4, %r3;
; SM70-NEXT:    atom.relaxed.cta.shared.cas.b32 %r1, [%rd1], %r5, %r4;
; SM70-NEXT:    setp.ne.b32 %p1, %r1, %r5;
; SM70-NEXT:    mov.b32 %r5, %r1;
; SM70-NEXT:    @%p1 bra $L__BB136_1;
; SM70-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-NEXT:    ret;
...
define i64 @nand_acq_rel_i64_shared_cta(ptr addrspace(3) %addr, i64 %val) {
; SM70-LABEL: nand_acq_rel_i64_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .pred %p<2>;
; SM70-NEXT:    .reg .b64 %rd<7>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd3, [nand_acq_rel_i64_shared_cta_param_1];
; SM70-NEXT:    ld.param.b64 %rd2, [nand_acq_rel_i64_shared_cta_param_0];
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    ld.relaxed.cta.shared.b64 %rd6, [%rd2];
; SM70-NEXT:  $L__BB137_1: // %atomicrmw.start
; SM70-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-NEXT:    and.b64 %rd4, %rd6, %rd3;
; SM70-NEXT:    not.b64 %rd5, %rd4;
; SM70-NEXT:    atom.relaxed.cta.shared.cas.b64 %rd1, [%rd2], %rd6, %rd5;
; SM70-NEXT:    setp.ne.b64 %p1, %rd1, %rd6;
; SM70-NEXT:    mov.b64 %rd6, %rd1;
; SM70-NEXT:    @%p1 bra $L__BB137_1;
; SM70-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-NEXT:    fence.acq_rel.cta;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd1;
; SM70-NEXT:    ret;
...
; SM70-NOFTZ-DISALLOW-LABEL: fadd_acq_rel_float_shared_cta(
; SM70-NOFTZ-DISALLOW:       {
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-DISALLOW-EMPTY:
; SM70-NOFTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_shared_cta_param_0];
; SM70-NOFTZ-DISALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_shared_cta_param_1];
; SM70-NOFTZ-DISALLOW-NEXT:    atom.acq_rel.cta.shared.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-DISALLOW-NEXT:    ret;
;
; SM70-NOFTZ-ALLOW-LABEL: fadd_acq_rel_float_shared_cta(
; SM70-NOFTZ-ALLOW:       {
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-NOFTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-NOFTZ-ALLOW-EMPTY:
; SM70-NOFTZ-ALLOW-NEXT:  // %bb.0:
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_shared_cta_param_0];
; SM70-NOFTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_shared_cta_param_1];
; SM70-NOFTZ-ALLOW-NEXT:    atom.acq_rel.cta.shared.add.f32 %r2, [%rd1], %r1;
; SM70-NOFTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-NOFTZ-ALLOW-NEXT:    ret;
;
; SM70-FTZ-DISALLOW-LABEL: fadd_acq_rel_float_shared_cta(
; SM70-FTZ-DISALLOW:       {
; SM70-FTZ-DISALLOW-NEXT:    .reg .pred %p<2>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b32 %r<5>;
; SM70-FTZ-DISALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-DISALLOW-EMPTY:
; SM70-FTZ-DISALLOW-NEXT:  // %bb.0:
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b32 %r2, [fadd_acq_rel_float_shared_cta_param_1];
; SM70-FTZ-DISALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_shared_cta_param_0];
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    ld.relaxed.cta.shared.b32 %r4, [%rd1];
; SM70-FTZ-DISALLOW-NEXT:  $L__BB138_1: // %atomicrmw.start
; SM70-FTZ-DISALLOW-NEXT:    // =>This Inner Loop Header: Depth=1
; SM70-FTZ-DISALLOW-NEXT:    add.rn.ftz.f32 %r3, %r4, %r2;
; SM70-FTZ-DISALLOW-NEXT:    atom.relaxed.cta.shared.cas.b32 %r1, [%rd1], %r4, %r3;
; SM70-FTZ-DISALLOW-NEXT:    setp.ne.b32 %p1, %r1, %r4;
; SM70-FTZ-DISALLOW-NEXT:    mov.b32 %r4, %r1;
; SM70-FTZ-DISALLOW-NEXT:    @%p1 bra $L__BB138_1;
; SM70-FTZ-DISALLOW-NEXT:  // %bb.2: // %atomicrmw.end
; SM70-FTZ-DISALLOW-NEXT:    fence.acq_rel.cta;
; SM70-FTZ-DISALLOW-NEXT:    st.param.b32 [func_retval0], %r1;
; SM70-FTZ-DISALLOW-NEXT:    ret;
;
; SM70-FTZ-ALLOW-LABEL: fadd_acq_rel_float_shared_cta(
; SM70-FTZ-ALLOW:       {
; SM70-FTZ-ALLOW-NEXT:    .reg .b32 %r<3>;
; SM70-FTZ-ALLOW-NEXT:    .reg .b64 %rd<2>;
; SM70-FTZ-ALLOW-EMPTY:
; SM70-FTZ-ALLOW-NEXT:  // %bb.0:
; SM70-FTZ-ALLOW-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_float_shared_cta_param_0];
; SM70-FTZ-ALLOW-NEXT:    ld.param.b32 %r1, [fadd_acq_rel_float_shared_cta_param_1];
; SM70-FTZ-ALLOW-NEXT:    atom.acq_rel.cta.shared.add.f32 %r2, [%rd1], %r1;
; SM70-FTZ-ALLOW-NEXT:    st.param.b32 [func_retval0], %r2;
; SM70-FTZ-ALLOW-NEXT:    ret;
...
define double @fadd_acq_rel_double_shared_cta(ptr addrspace(3) %addr, double %val) {
; SM70-LABEL: fadd_acq_rel_double_shared_cta(
; SM70:       {
; SM70-NEXT:    .reg .b64 %rd<4>;
; SM70-EMPTY:
; SM70-NEXT:  // %bb.0:
; SM70-NEXT:    ld.param.b64 %rd1, [fadd_acq_rel_double_shared_cta_param_0];
; SM70-NEXT:    ld.param.b64 %rd2, [fadd_acq_rel_double_shared_cta_param_1];
; SM70-NEXT:    atom.acq_rel.cta.shared.add.f64 %rd3, [%rd1], %rd2;
; SM70-NEXT:    st.param.b64 [func_retval0], %rd3;
; SM70-NEXT:    ret;
