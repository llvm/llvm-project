...
; define float @fadd_f32_atomicrmw(ptr %addr, float %val) {
; entry:
;   %old = atomicrmw fadd ptr %addr, float %val monotonic, align 1
;   ret float %old
; }

; define <2 x float> @load_v2f32(ptr %addr) {
; entry:
;   %load = load <2 x float>, ptr %addr
;   ret <2 x float> %load
; }
...
; ; CHECK-NEXT:    atom.sys.add.v4.f32 {%r5, %r6, %r7, %r8}, [%rd1], {%r1, %r2, %r3, %r4};
...
; ; CHECK-NEXT:    atom.cta.add.v4.f32 {%r5, %r6, %r7, %r8}, [%rd1], {%r1, %r2, %r3, %r4};
; ; CHECK-NEXT:    st.param.v4.b32 [func_retval0], {%r5, %r6, %r7, %r8};
; ; CHECK-NEXT:    ret;
; entry:
...
; ; CHECK-NEXT:    atom.sys.min.v8.f16 {%rs9, %rs10, %rs11, %rs12, %rs13, %rs14, %rs15, %rs16}, [%rd1], {%rs7, %rs8, %rs5, %rs6, %rs3, %rs4, %rs1, %rs2};
...
; ; CHECK-NEXT:    mov.b32 {%rs5, %rs6}, %r2;
; ; CHECK-NEXT:    mov.b32 {%rs7, %rs8}, %r1;
; ; CHECK-NEXT:    atom.sys.max.v8.f16 {%rs9, %rs10, %rs11, %rs12, %rs13, %rs14, %rs15, %rs16}, [%rd1], {%rs7, %rs8, %rs5, %rs6, %rs3, %rs4, %rs1, %rs2};
; ; CHECK-NEXT:    mov.b32 %r5, {%rs15, %rs16};
; ; CHECK-NEXT:    mov.b32 %r6, {%rs13, %rs14};
; ; CHECK-NEXT:    mov.b32 %r7, {%rs11, %rs12};
; ; CHECK-NEXT:    mov.b32 %r8, {%rs9, %rs10};
