...
; CHECK-SM100-NEXT:    st.param.f32 [func_retval0], %f4;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM80-NEXT:    ld.param.f32 %f7, [reduce_fadd_float_reassoc_nonpow2_param_0+24];
; CHECK-SM80-NEXT:    ld.param.v4.f32 {%f1, %f2, %f3, %f4}, [reduce_fadd_float_reassoc_nonpow2_param_0];
...
; CHECK-SM100-NEXT:    ld.param.v4.f32 {%f1, %f2, %f3, %f4}, [reduce_fadd_float_reassoc_nonpow2_param_0];
; CHECK-SM100-NEXT:    mov.b64 %rd2, {%f1, %f2};
; CHECK-SM100-NEXT:    mov.b64 %rd3, {%f3, %f4};
; CHECK-SM100-NEXT:    ld.param.f32 %f7, [reduce_fadd_float_reassoc_nonpow2_param_0+24];
...
; CHECK-SM100-NEXT:    mov.b64 {%f3, _}, %rd9;
; CHECK-SM100-NEXT:    st.param.f32 [func_retval0], %f3;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM80-NEXT:    mov.b64 {%f5, %f6}, %rd1;
; CHECK-SM80-NEXT:    ld.param.f32 %f7, [reduce_fmul_float_reassoc_nonpow2_param_0+24];
; CHECK-SM80-NEXT:    ld.param.v4.f32 {%f1, %f2, %f3, %f4}, [reduce_fmul_float_reassoc_nonpow2_param_0];
...
; CHECK-SM100-NEXT:    mov.b64 {%f5, %f6}, %rd1;
; CHECK-SM100-NEXT:    ld.param.v4.f32 {%f1, %f2, %f3, %f4}, [reduce_fmul_float_reassoc_nonpow2_param_0];
; CHECK-SM100-NEXT:    mov.b64 %rd2, {%f1, %f2};
; CHECK-SM100-NEXT:    mov.b64 %rd3, {%f3, %f4};
; CHECK-SM100-NEXT:    ld.param.f32 %f7, [reduce_fmul_float_reassoc_nonpow2_param_0+24];
...
; CHECK-SM100-NEXT:    st.param.f32 [func_retval0], %f11;
; CHECK-SM100-NEXT:    ret;
