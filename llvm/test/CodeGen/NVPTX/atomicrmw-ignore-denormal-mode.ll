...
; denormal mode:
;   - atom.add.f32 on global memory flushes denormals prior to PTX 9.4 / SM90
;     (which added atom.add.noftz.f32)
;   - atom.add.f32 on shared/generic memory does not flush (PTX still has no
;     flushing atom.add.ftz.f32)
;   - atom.add.f16 never flushes denormals (PTX still has no flushing
;     atom.add.ftz.f16)
...
; STRICT-EMPTY:
; STRICT-NEXT:  // %bb.0:
; STRICT-NEXT:    ld.param::func.b32 %r2, [fadd_f32_global_ieee_no_md_param_1];
; STRICT-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_global_ieee_no_md_param_0];
...
; STRICT-NEXT:    st.param::func.b32 [func_retval0], %r1;
; STRICT-NEXT:    ret;
;
...
; DEFAULT-EMPTY:
; DEFAULT-NEXT:  // %bb.0:
; DEFAULT-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_global_ieee_no_md_param_0];
; DEFAULT-NEXT:    ld.param::func.b32 %r1, [fadd_f32_global_ieee_no_md_param_1];
; DEFAULT-NEXT:    atom.relaxed.sys.global.add.f32 %r2, [%rd1], %r1;
; DEFAULT-NEXT:    st.param::func.b32 [func_retval0], %r2;
; DEFAULT-NEXT:    ret;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_global_ieee_md_param_0];
; CHECK-NEXT:    ld.param::func.b32 %r1, [fadd_f32_global_ieee_md_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_global_ftz_no_md_param_0];
; CHECK-NEXT:    ld.param::func.b32 %r1, [fadd_f32_global_ftz_no_md_param_1];
; CHECK-NEXT:    atom.relaxed.sys.global.add.f32 %r2, [%rd1], %r1;
; CHECK-NEXT:    st.param::func.b32 [func_retval0], %r2;
; CHECK-NEXT:    ret;
  %r = atomicrmw fadd ptr addrspace(1) %addr, float %val monotonic
...
; STRICT-EMPTY:
; STRICT-NEXT:  // %bb.0:
; STRICT-NEXT:    ld.param::func.b32 %r2, [fadd_f32_generic_ieee_no_md_param_1];
; STRICT-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_generic_ieee_no_md_param_0];
...
; DEFAULT-EMPTY:
; DEFAULT-NEXT:  // %bb.0:
; DEFAULT-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_generic_ieee_no_md_param_0];
; DEFAULT-NEXT:    ld.param::func.b32 %r1, [fadd_f32_generic_ieee_no_md_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_generic_ieee_md_param_0];
; CHECK-NEXT:    ld.param::func.b32 %r1, [fadd_f32_generic_ieee_md_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f32_shared_ieee_no_md_param_0];
; CHECK-NEXT:    ld.param::func.b32 %r1, [fadd_f32_shared_ieee_no_md_param_1];
...
; STRICT-EMPTY:
; STRICT-NEXT:  // %bb.0:
; STRICT-NEXT:    ld.param::func.b16 %rs1, [fadd_f16_global_ftz_no_md_param_1];
; STRICT-NEXT:    ld.param::func.b64 %rd2, [fadd_f16_global_ftz_no_md_param_0];
...
; DEFAULT-EMPTY:
; DEFAULT-NEXT:  // %bb.0:
; DEFAULT-NEXT:    ld.param::func.b64 %rd1, [fadd_f16_global_ftz_no_md_param_0];
; DEFAULT-NEXT:    ld.param::func.b16 %rs1, [fadd_f16_global_ftz_no_md_param_1];
; DEFAULT-NEXT:    atom.relaxed.sys.global.add.noftz.f16 %rs2, [%rd1], %rs1;
; DEFAULT-NEXT:    st.param::func.b16 [func_retval0], %rs2;
; DEFAULT-NEXT:    ret;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f16_global_ftz_md_param_0];
; CHECK-NEXT:    ld.param::func.b16 %rs1, [fadd_f16_global_ftz_md_param_1];
; CHECK-NEXT:    atom.relaxed.sys.global.add.noftz.f16 %rs2, [%rd1], %rs1;
; CHECK-NEXT:    st.param::func.b16 [func_retval0], %rs2;
; CHECK-NEXT:    ret;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param::func.b64 %rd1, [fadd_f16_global_f32_ftz_only_no_md_param_0];
; CHECK-NEXT:    ld.param::func.b16 %rs1, [fadd_f16_global_f32_ftz_only_no_md_param_1];
; CHECK-NEXT:    atom.relaxed.sys.global.add.noftz.f16 %rs2, [%rd1], %rs1;
; CHECK-NEXT:    st.param::func.b16 [func_retval0], %rs2;
; CHECK-NEXT:    ret;
  %r = atomicrmw fadd ptr addrspace(1) %addr, half %val monotonic
