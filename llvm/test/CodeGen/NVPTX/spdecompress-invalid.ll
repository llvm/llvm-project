...
; BAD-ELEM: immarg value 9 for arg 2 out of range set
  %res = call i32 @llvm.nvvm.spdecompress.sp2to4.i32.i32.i32(i32 %metadata, i32 %compdata, i32 9, i32 2)
  ret i32 %res
}
...
; BAD-IDX: immarg value 3 for arg 3 out of range set
  %res = call i32 @llvm.nvvm.spdecompress.sp2to4.i32.i32.i32(i32 %metadata, i32 %compdata, i32 8, i32 3)
  ret i32 %res
}
...
; BAD-IDX-TARGET: LLVM ERROR: Invalid spdecompress flags: num_src=1, num_tgt=8, elem_size=8, idx_size=2
  %res = call <8 x i32> @llvm.nvvm.spdecompress.sp1to8.v8i32.i32.i32(i32 %metadata, i32 %compdata, i32 8, i32 2)
  ret <8 x i32> %res
}
...
; BAD-INPUT-SPAN: LLVM ERROR: Invalid spdecompress flags: num_src=4, num_tgt=8, elem_size=16, idx_size=4
  %res = call <4 x i32> @llvm.nvvm.spdecompress.sp4to8.v4i32.v2i32.v2i32(<2 x i32> %metadata, <2 x i32> %compdata, i32 16, i32 4)
  ret <4 x i32> %res
}
...
; BAD-MDATA: LLVM ERROR: spdecompress operand/result types do not match the SP intrinsic flags
  %res = call <4 x i32> @llvm.nvvm.spdecompress.sp2to4.v4i32.v2i32.v2i32(<2 x i32> %metadata, <2 x i32> %compdata, i32 8, i32 4)
  ret <4 x i32> %res
}
...
; BAD-CDATA: LLVM ERROR: spdecompress operand/result types do not match the SP intrinsic flags
  %res = call <4 x i32> @llvm.nvvm.spdecompress.sp2to4.v4i32.i32.i32(i32 %metadata, i32 %compdata, i32 16, i32 4)
  ret <4 x i32> %res
}

;--- bad-data-size.ll

define <3 x i32> @bad_spdecompress_data_register_count(
    i32 %metadata, <2 x i32> %compdata) {
; BAD-DATA: LLVM ERROR: spdecompress operand/result types do not match the SP intrinsic flags
  %res = call <3 x i32> @llvm.nvvm.spdecompress.sp2to4.v3i32.i32.v2i32(i32 %metadata, <2 x i32> %compdata, i32 8, i32 4)
  ret <3 x i32> %res
}
...
; BAD-RESULT-TY: LLVM ERROR: spdecompress expects scalarized i32 results
  %res = call i64 @llvm.nvvm.spdecompress.sp2to4.i64.i32.i32(i32 %metadata, i32 %compdata, i32 8, i32 2)
  ret i64 %res
}
...
; BAD-MDATA-TY: LLVM ERROR: spdecompress expects scalarized i32 operands
  %res = call i32 @llvm.nvvm.spdecompress.sp2to4.i32.i64.i32(i64 %metadata, i32 %compdata, i32 8, i32 2)
  ret i32 %res
}
