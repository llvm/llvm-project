...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_collector_b_ti16_cta1_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_collector_b_ti16_cta1_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_collector_b_ti16_cta1_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_collector_b_ti16_cta1_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_collector_b_ti16_cta1_param_4];
; CHECK-NEXT:    tcgen05.mma.cta_group::1.kind::ti16.collector::a::discard.collector::b::lastuse [%r1], %rd1, %rd2, %r2, %p1;
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_collector_b_ti16_cta1_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_collector_b_ti16_cta2_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_collector_b_ti16_cta2_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_collector_b_ti16_cta2_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_collector_b_ti16_cta2_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_collector_b_ti16_cta2_param_4];
; CHECK-NEXT:    tcgen05.mma.cta_group::2.kind::ti16.collector::a::discard.collector::b::lastuse [%r1], %rd1, %rd2, %r2, %p1;
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_collector_b_ti16_cta2_param_1];
