...
define void @tcgen05_mma_mxf8f6f4(ptr addrspace(6) %dtmem, ptr addrspace(6) %atensor, i64 %ashared, i64 %b, i32 %idesc, i1 %enable_inp_d, ptr addrspace(6) %scale_a, ptr addrspace(6) %scale_b) {
; CHECK-LABEL: tcgen05_mma_mxf8f6f4(
; CHECK:       {
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_mxf8f6f4_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_mxf8f6f4_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_mxf8f6f4_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_mxf8f6f4_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_mxf8f6f4_param_4];
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_mxf8f6f4_param_6];
; CHECK-NEXT:    ld.param.b32 %r4, [tcgen05_mma_mxf8f6f4_param_7];
; CHECK-NEXT:    tcgen05.mma.cta_group::1.kind::mxf8f6f4.block_scale.collector::a::discard [%r1], %rd1, %rd2, %r2, [%r3], [%r4], %p1;
; CHECK-NEXT:    ld.param.b32 %r5, [tcgen05_mma_mxf8f6f4_param_1];
...
define void @tcgen05_mma_sp_mxf8f6f4(ptr addrspace(6) %dtmem, ptr addrspace(6) %atensor, i64 %ashared, i64 %b, i32 %idesc, i1 %enable_inp_d, ptr addrspace(6) %scale_a, ptr addrspace(6) %scale_b, ptr addrspace(6) %spmetadata) {
; CHECK-LABEL: tcgen05_mma_sp_mxf8f6f4(
; CHECK:       {
; CHECK-NEXT:    .reg .pred %p<2>;
; CHECK-NEXT:    .reg .b16 %rs<3>;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_sp_mxf8f6f4_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_sp_mxf8f6f4_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_sp_mxf8f6f4_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_sp_mxf8f6f4_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_sp_mxf8f6f4_param_4];
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_sp_mxf8f6f4_param_6];
; CHECK-NEXT:    ld.param.b32 %r4, [tcgen05_mma_sp_mxf8f6f4_param_7];
; CHECK-NEXT:    ld.param.b32 %r5, [tcgen05_mma_sp_mxf8f6f4_param_8];
; CHECK-NEXT:    tcgen05.mma.sp.cta_group::1.kind::mxf8f6f4.block_scale.collector::a::discard [%r1], %rd1, %rd2, [%r5], %r2, [%r3], [%r4], %p1;
; CHECK-NEXT:    ld.param.b32 %r6, [tcgen05_mma_sp_mxf8f6f4_param_1];
...
define void @tcgen05_mma_mxf4(ptr addrspace(6) %dtmem, ptr addrspace(6) %atensor, i64 %ashared, i64 %b, i32 %idesc, i1 %enable_inp_d, ptr addrspace(6) %scale_a, ptr addrspace(6) %scale_b) {
; CHECK-LABEL: tcgen05_mma_mxf4(
; CHECK:       {
; CHECK-NEXT:    .reg .pred %p<2>;
; CHECK-NEXT:    .reg .b16 %rs<3>;
; CHECK-NEXT:    .reg .b32 %r<6>;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_mxf4_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_mxf4_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_mxf4_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_mxf4_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_mxf4_param_4];
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_mxf4_param_6];
; CHECK-NEXT:    ld.param.b32 %r4, [tcgen05_mma_mxf4_param_7];
; CHECK-NEXT:    tcgen05.mma.cta_group::1.kind::mxf4.block_scale.collector::a::discard [%r1], %rd1, %rd2, %r2, [%r3], [%r4], %p1;
; CHECK-NEXT:    ld.param.b32 %r5, [tcgen05_mma_mxf4_param_1];
...
define void @tcgen05_mma_sp_mxf4(ptr addrspace(6) %dtmem, ptr addrspace(6) %atensor, i64 %ashared, i64 %b, i32 %idesc, i1 %enable_inp_d, ptr addrspace(6) %scale_a, ptr addrspace(6) %scale_b, ptr addrspace(6) %spmetadata) {
; CHECK-LABEL: tcgen05_mma_sp_mxf4(
; CHECK:       {
; CHECK-NEXT:    .reg .pred %p<2>;
; CHECK-NEXT:    .reg .b16 %rs<3>;
; CHECK-NEXT:    .reg .b32 %r<7>;
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b8 %rs1, [tcgen05_mma_sp_mxf4_param_5];
; CHECK-NEXT:    and.b16 %rs2, %rs1, 1;
; CHECK-NEXT:    setp.ne.b16 %p1, %rs2, 0;
; CHECK-NEXT:    ld.param.b32 %r1, [tcgen05_mma_sp_mxf4_param_0];
; CHECK-NEXT:    ld.param.b64 %rd1, [tcgen05_mma_sp_mxf4_param_2];
; CHECK-NEXT:    ld.param.b64 %rd2, [tcgen05_mma_sp_mxf4_param_3];
; CHECK-NEXT:    ld.param.b32 %r2, [tcgen05_mma_sp_mxf4_param_4];
; CHECK-NEXT:    ld.param.b32 %r3, [tcgen05_mma_sp_mxf4_param_6];
; CHECK-NEXT:    ld.param.b32 %r4, [tcgen05_mma_sp_mxf4_param_7];
; CHECK-NEXT:    ld.param.b32 %r5, [tcgen05_mma_sp_mxf4_param_8];
; CHECK-NEXT:    tcgen05.mma.sp.cta_group::1.kind::mxf4.block_scale.collector::a::discard [%r1], %rd1, %rd2, [%r5], %r2, [%r3], [%r4], %p1;
; CHECK-NEXT:    ld.param.b32 %r6, [tcgen05_mma_sp_mxf4_param_1];
