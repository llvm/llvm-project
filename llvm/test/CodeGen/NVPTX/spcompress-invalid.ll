...
; BAD-IDX: immarg value 3 for arg 2 out of range set
  %res = call { i32, <4 x i8> } @llvm.nvvm.spcompress.i32.v4i8.v8i8(<8 x i8> %data, i32 %spdesc, i32 3, i32 4)
  ret { i32, <4 x i8> } %res
}

;--- bad-num-tgt.ll

define { i32, <4 x i8> } @bad_spcompress_num_tgt(i32 %spdesc,
                                                 <8 x i8> %data) {
; BAD-NUM-TGT: immarg value 8 for arg 3 out of range set
  %res = call { i32, <4 x i8> } @llvm.nvvm.spcompress.i32.v4i8.v8i8(<8 x i8> %data, i32 %spdesc, i32 2, i32 8)
  ret { i32, <4 x i8> } %res
}
