...
; RUN: llc < %t/all-sm80.ll -mtriple=nvptx64 -mcpu=sm_80 -mattr=+ptx70 | FileCheck --check-prefixes=SM80,SM80-NOFTZ,SM80-PTX70 %s
; RUN: %if ptxas-sm_80 && ptxas-isa-7.0 %{ llc < %t/all-sm80.ll -mtriple=nvptx64 -mcpu=sm_80 -mattr=+ptx70 | %ptxas-verify -arch=sm_80 %}
; RUN: llc < %t/all-sm80.ll -mtriple=nvptx64 -mcpu=sm_80 -mattr=+ptx71 | FileCheck --check-prefixes=SM80,SM80-NOFTZ,SM80-PTX71 %s
; RUN: %if ptxas-sm_80 && ptxas-isa-7.1 %{ llc < %t/all-sm80.ll -mtriple=nvptx64 -mcpu=sm_80 -mattr=+ptx71 | %ptxas-verify -arch=sm_80 %}
; RUN: llc < %t/all-sm80.ll -mtriple=nvptx64 -mcpu=sm_80 -mattr=+ptx71 -denormal-fp-math-f32=preserve-sign | FileCheck --check-prefixes=SM80,SM80-FTZ,SM80-PTX71 %s
...
; SM80-PTX71:       ld.param.b16 [[A:%rs[0-9]+]], [cvt_f16_bf16_param_0];
; SM80-PTX71-NEXT:  cvt.f32.bf16 [[EXT:%r[0-9]+]], [[A]];
...
; SM80-PTX70:       shl.b32 [[EXT:%r[0-9]+]], {{%r[0-9]+}}, 16;
; SM80-PTX71:       ld.param.b16 [[A:%rs[0-9]+]], [cvt_rn_f16_bf16_param_0];
; SM80-PTX71-NEXT:  cvt.f32.bf16 [[EXT:%r[0-9]+]], [[A]];
; SM80-NEXT:        cvt.rn.f16.f32 [[RES:%rs[0-9]+]], [[EXT]];
; SM80-NEXT:        st.param.b16 [func_retval0], [[RES]];
; SM80-NEXT:        ret;
...
; SM80-PTX70:       shl.b32 [[EXT:%r[0-9]+]], {{%r[0-9]+}}, 16;
; SM80-PTX71:       ld.param.b16 [[A:%rs[0-9]+]], [cvt_rz_f16_bf16_param_0];
; SM80-PTX71-NEXT:  cvt.f32.bf16 [[EXT:%r[0-9]+]], [[A]];
...
; SM80-PTX70:       shl.b32 [[EXT:%r[0-9]+]], {{%r[0-9]+}}, 16;
; SM80-PTX71:       ld.param.b16 [[A:%rs[0-9]+]], [cvt_rm_f16_bf16_param_0];
; SM80-PTX71-NEXT:  cvt.f32.bf16 [[EXT:%r[0-9]+]], [[A]];
...
; SM80-PTX70:       shl.b32 [[EXT:%r[0-9]+]], {{%r[0-9]+}}, 16;
; SM80-PTX71:       ld.param.b16 [[A:%rs[0-9]+]], [cvt_rp_f16_bf16_param_0];
; SM80-PTX71-NEXT:  cvt.f32.bf16 [[EXT:%r[0-9]+]], [[A]];
