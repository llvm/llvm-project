...
; RUN: llc < %s -mtriple=nvptx64 -mcpu=sm_60 -mattr=+ptx50 | FileCheck %s --check-prefixes=SM60,CHECK
; RUN: %if ptxas-sm_60 && ptxas-isa-5.0 %{ llc < %s -mtriple=nvptx64 -mcpu=sm_60 -mattr=+ptx50 | %ptxas-verify -arch=sm_60 %}
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b8 %rs1, [relaxed_sys_i8_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [relaxed_sys_i8_param_0];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    ld.param.b8 %r7, [relaxed_sys_i8_param_1];
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b8 %rs1, [acquire_sys_i8_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [acquire_sys_i8_param_0];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    ld.param.b8 %r7, [acquire_sys_i8_param_1];
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
; SM60-NEXT:    mov.b32 %r10, 255;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b8 %rs1, [release_sys_i8_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [release_sys_i8_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b8 %r7, [release_sys_i8_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b8 %rs1, [acq_rel_sys_i8_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [acq_rel_sys_i8_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b8 %r7, [acq_rel_sys_i8_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b8 %rs1, [seq_cst_sys_i8_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [seq_cst_sys_i8_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b8 %r7, [seq_cst_sys_i8_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b16 %rs1, [relaxed_sys_i16_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [relaxed_sys_i16_param_0];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    ld.param.b16 %r7, [relaxed_sys_i16_param_1];
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b16 %rs1, [acquire_sys_i16_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [acquire_sys_i16_param_0];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    ld.param.b16 %r7, [acquire_sys_i16_param_1];
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
; SM60-NEXT:    mov.b32 %r10, 65535;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b16 %rs1, [release_sys_i16_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [release_sys_i16_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b16 %r7, [release_sys_i16_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b16 %rs1, [acq_rel_sys_i16_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [acq_rel_sys_i16_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b16 %r7, [acq_rel_sys_i16_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b16 %rs1, [seq_cst_sys_i16_param_2];
; SM60-NEXT:    ld.param.b64 %rd2, [seq_cst_sys_i16_param_0];
; SM60-NEXT:    membar.sys;
; SM60-NEXT:    ld.param.b16 %r7, [seq_cst_sys_i16_param_1];
; SM60-NEXT:    and.b64 %rd1, %rd2, -4;
; SM60-NEXT:    cvt.u32.u64 %r8, %rd2;
; SM60-NEXT:    and.b32 %r9, %r8, 3;
; SM60-NEXT:    shl.b32 %r1, %r9, 3;
...
;
; SM60-LABEL: relaxed_sys_i32(
; SM60:       {
; SM60-NEXT:    .reg .b32 %r<4>;
; SM60-NEXT:    .reg .b64 %rd<2>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [relaxed_sys_i32_param_0];
; SM60-NEXT:    ld.param.b32 %r1, [relaxed_sys_i32_param_1];
; SM60-NEXT:    ld.param.b32 %r2, [relaxed_sys_i32_param_2];
...
;
; SM60-LABEL: acquire_sys_i32(
; SM60:       {
; SM60-NEXT:    .reg .b32 %r<4>;
; SM60-NEXT:    .reg .b64 %rd<2>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [acquire_sys_i32_param_0];
...
;
; SM60-LABEL: seq_cst_sys_i32(
; SM60:       {
; SM60-NEXT:    .reg .b32 %r<4>;
; SM60-NEXT:    .reg .b64 %rd<2>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [seq_cst_sys_i32_param_0];
; SM60-NEXT:    membar.sys;
...
;
; SM60-LABEL: relaxed_sys_i64(
; SM60:       {
; SM60-NEXT:    .reg .b64 %rd<5>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [relaxed_sys_i64_param_0];
; SM60-NEXT:    ld.param.b64 %rd2, [relaxed_sys_i64_param_1];
; SM60-NEXT:    ld.param.b64 %rd3, [relaxed_sys_i64_param_2];
...
;
; SM60-LABEL: acquire_sys_i64(
; SM60:       {
; SM60-NEXT:    .reg .b64 %rd<5>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [acquire_sys_i64_param_0];
...
;
; SM60-LABEL: seq_cst_sys_i64(
; SM60:       {
; SM60-NEXT:    .reg .b64 %rd<5>;
; SM60-EMPTY:
; SM60-NEXT:  // %bb.0:
; SM60-NEXT:    ld.param.b64 %rd1, [seq_cst_sys_i64_param_0];
; SM60-NEXT:    membar.sys;
