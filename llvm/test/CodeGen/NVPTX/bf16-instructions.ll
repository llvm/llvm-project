...
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r5, %rs2;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r6, %rs1;
; SM80-FTZ-NEXT:    mov.b32 {%rs3, %rs4}, %r1;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r7, %rs4;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r8, %rs3;
; SM80-FTZ-NEXT:    mov.b32 {%rs5, %rs6}, %r4;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r9, %rs6;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r10, %rs5;
; SM80-FTZ-NEXT:    mov.b32 {%rs7, %rs8}, %r3;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r11, %rs8;
; SM80-FTZ-NEXT:    cvt.f32.bf16 %r12, %rs7;
...
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r5, %rs2;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r6, %rs1;
; SM90-FTZ-NEXT:    mov.b32 {%rs3, %rs4}, %r1;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r7, %rs4;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r8, %rs3;
; SM90-FTZ-NEXT:    mov.b32 {%rs5, %rs6}, %r4;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r9, %rs6;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r10, %rs5;
; SM90-FTZ-NEXT:    mov.b32 {%rs7, %rs8}, %r3;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r11, %rs8;
; SM90-FTZ-NEXT:    cvt.ftz.f32.bf16 %r12, %rs7;
