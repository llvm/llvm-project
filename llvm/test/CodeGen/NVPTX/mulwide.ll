...
; RUN: llc < %s -mtriple=nvptx64 -mcpu=sm_20 -O3 | FileCheck %s --check-prefixes=CHECK,OPT
; RUN: llc < %s -mtriple=nvptx64 -mcpu=sm_20 -O0 | FileCheck %s --check-prefixes=CHECK,NOOPT
...
define i32 @mulwide_sext_shl_topbit_i16(i16 %x) {
; CHECK-LABEL: mulwide_sext_shl_topbit_i16(
; CHECK:       {
; CHECK-NEXT:    .reg .b16 %rs<3>;
; CHECK-NEXT:    .reg .b32 %r<2>;
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b16 %rs1, [mulwide_sext_shl_topbit_i16_param_0];
; CHECK-NEXT:    shl.b16 %rs2, %rs1, 15;
...
define i64 @mulwide_sext_shl_topbit_i32(i32 %x) {
; CHECK-LABEL: mulwide_sext_shl_topbit_i32(
; CHECK:       {
; CHECK-NEXT:    .reg .b32 %r<3>;
; CHECK-NEXT:    .reg .b64 %rd<2>;
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.b32 %r1, [mulwide_sext_shl_topbit_i32_param_0];
; CHECK-NEXT:    shl.b32 %r2, %r1, 31;
