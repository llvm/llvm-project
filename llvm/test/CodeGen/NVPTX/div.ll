...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_rr_param_0];
; CHECK-NEXT:    ld.param.f32 %f2, [div_fast_rr_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_rr_ftz_param_0];
; CHECK-NEXT:    ld.param.f32 %f2, [div_fast_rr_ftz_param_1];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_ri_param_0];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_ri_ftz_param_0];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [rcp_fast_param_0];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [rcp_fast_ftz_param_0];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_vec_param_0];
; CHECK-NEXT:    ld.param.f32 %f2, [div_fast_vec_param_1];
; CHECK-NEXT:    ld.param.f32 %f3, [div_fast_vec_param_2];
; CHECK-NEXT:    ld.param.f32 %f4, [div_fast_vec_param_3];
...
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    ld.param.f32 %f1, [div_fast_vec_ftz_param_0];
; CHECK-NEXT:    ld.param.f32 %f2, [div_fast_vec_ftz_param_1];
; CHECK-NEXT:    ld.param.f32 %f3, [div_fast_vec_ftz_param_2];
; CHECK-NEXT:    ld.param.f32 %f4, [div_fast_vec_ftz_param_3];
