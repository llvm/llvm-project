...
@csize = external global [100 x [20 x [4 x i8]]]		; <ptr> [#uses=1]
@vsize = external global [100 x [20 x [4 x i8]]]		; <ptr> [#uses=1]
@cll = external global [20 x [10 x i8]]		; <ptr> [#uses=1]
@lefline = external global [100 x [20 x i32]]		; <ptr> [#uses=1]
@sep = external global [20 x i32]		; <ptr> [#uses=1]
