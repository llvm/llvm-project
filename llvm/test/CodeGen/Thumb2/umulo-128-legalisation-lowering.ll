...
; THUMBV7-NEXT:    ldr r0, [sp, #100]
; THUMBV7-NEXT:    adc.w r9, r9, r4
...
; THUMBV7-NEXT:    ldr r2, [sp, #28] @ 4-byte Reload
; THUMBV7-NEXT:    ands r0, r4
; THUMBV7-NEXT:    ldr r4, [sp, #84]
; THUMBV7-NEXT:    adds.w r2, r2, r8
; THUMBV7-NEXT:    str.w r2, [r11, #4]
; THUMBV7-NEXT:    orr.w r0, r0, r1
; THUMBV7-NEXT:    ldr r1, [sp, #36] @ 4-byte Reload
; THUMBV7-NEXT:    adcs.w r1, r1, r12
; THUMBV7-NEXT:    mov.w r12, #0
; THUMBV7-NEXT:    adc r2, r12, #0
; THUMBV7-NEXT:    cmp.w lr, #0
; THUMBV7-NEXT:    it ne
; THUMBV7-NEXT:    movne.w lr, #1
; THUMBV7-NEXT:    umlal r1, r2, r3, r6
...
; THUMBV7-NEXT:    ands r3, r6
; THUMBV7-NEXT:    cmp r5, #0
; THUMBV7-NEXT:    orr.w r3, r3, r7
; THUMBV7-NEXT:    it ne
; THUMBV7-NEXT:    movne r5, #1
; THUMBV7-NEXT:    ldr r7, [sp, #80]
; THUMBV7-NEXT:    orrs r3, r5
; THUMBV7-NEXT:    ldrd r6, r5, [sp, #96]
; THUMBV7-NEXT:    orrs r7, r4
; THUMBV7-NEXT:    it ne
; THUMBV7-NEXT:    movne r7, #1
; THUMBV7-NEXT:    orrs r6, r5
; THUMBV7-NEXT:    it ne
; THUMBV7-NEXT:    movne r6, #1
; THUMBV7-NEXT:    adds.w r1, r1, r10
; THUMBV7-NEXT:    str.w r1, [r11, #8]
; THUMBV7-NEXT:    adcs.w r1, r2, r9
; THUMBV7-NEXT:    str.w r1, [r11, #12]
; THUMBV7-NEXT:    and.w r2, r7, r6
; THUMBV7-NEXT:    ldr r1, [sp, #40] @ 4-byte Reload
; THUMBV7-NEXT:    orr.w r1, r1, r3
