...
; CHECK-NEXT:    it ge
; CHECK-NEXT:    movge.w r0, #-1
; CHECK-NEXT:    cset r5, lt
; CHECK-NEXT:    csel r3, r5, r3, ge
; CHECK-NEXT:    csel r2, r5, r2, ge
; CHECK-NEXT:    cmp r5, #0
...
; CHECK-NEXT:    csel r8, r1, r5, lt
; CHECK-NEXT:    csel r9, r2, r0, ge
...
; CHECK-NEXT:    csel r4, r2, r1, hs
; CHECK-NEXT:    csel r5, r2, r0, hs
; CHECK-NEXT:    mov r0, r12
; CHECK-NEXT:    mov r1, lr
; CHECK-NEXT:    bl __fixunsdfti
; CHECK-NEXT:    subs r2, #1
; CHECK-NEXT:    sbcs r2, r3, #0
; CHECK-NEXT:    cset r2, lo
; CHECK-NEXT:    csel r0, r2, r0, hs
; CHECK-NEXT:    csel r1, r2, r1, hs
...
; CHECK-NEXT:    csel r3, r4, r3, ge
; CHECK-NEXT:    csel r1, r4, r1, ge
; CHECK-NEXT:    csel r0, r4, r0, ge
; CHECK-NEXT:    cmp r4, #0
...
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    csel r6, r2, r1, ge
; CHECK-NEXT:    csel r7, r2, r0, ge
; CHECK-NEXT:    mov r0, r12
; CHECK-NEXT:    mov r1, lr
; CHECK-NEXT:    bl __fixdfti
...
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    csel r9, r1, r6, lt
; CHECK-NEXT:    csel r10, r2, r0, ge
...
; CHECK-NEXT:    sbcs r2, r3, #0
; CHECK-NEXT:    cset r2, lo
; CHECK-NEXT:    csel r6, r2, r0, hs
; CHECK-NEXT:    mov r0, r4
; CHECK-NEXT:    csel r5, r2, r1, hs
; CHECK-NEXT:    bl __fixunssfti
; CHECK-NEXT:    subs r2, #1
; CHECK-NEXT:    sbcs r2, r3, #0
; CHECK-NEXT:    cset r2, lo
...
; CHECK-NEXT:    sbcs.w r2, r5, r3
; CHECK-NEXT:    it ge
; CHECK-NEXT:    movge.w r4, #-2147483648
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    csel r7, r2, r0, ge
; CHECK-NEXT:    mov r0, r12
; CHECK-NEXT:    bl __fixdfti
; CHECK-NEXT:    subs.w r6, r0, #-1
; CHECK-NEXT:    sbcs.w r6, r1, r8
...
; CHECK-NEXT:    csel r3, r6, r3, ge
; CHECK-NEXT:    csel r2, r6, r2, ge
; CHECK-NEXT:    rsbs r6, r0, #0
; CHECK-NEXT:    sbcs.w r6, r9, r1
; CHECK-NEXT:    sbcs.w r2, r5, r2
; CHECK-NEXT:    sbcs.w r2, r5, r3
; CHECK-NEXT:    it ge
; CHECK-NEXT:    movge.w r1, #-2147483648
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    csel r0, r2, r0, ge
; CHECK-NEXT:    vmov q0[2], q0[0], r0, r7
; CHECK-NEXT:    vmov q0[3], q0[1], r1, r4
...
; CHECK-NEXT:    sbcs r2, r3, #0
; CHECK-NEXT:    cset r2, lt
; CHECK-NEXT:    csel r5, r2, r0, ge
; CHECK-NEXT:    csel r0, r2, r3, ge
; CHECK-NEXT:    csel r4, r2, r1, ge
; CHECK-NEXT:    cmp r0, #0
; CHECK-NEXT:    itt mi
...
; CHECK-NEXT:    bl __fixsfti
; CHECK-NEXT:    mov r4, r1
; CHECK-NEXT:    subs.w r1, r0, #-1
; CHECK-NEXT:    mvn r8, #-2147483648
; CHECK-NEXT:    sbcs.w r1, r4, r8
; CHECK-NEXT:    sbcs r1, r2, #0
; CHECK-NEXT:    mov.w r9, #-2147483648
...
; CHECK-NEXT:    mov.w r6, #-1
; CHECK-NEXT:    csel r3, r1, r3, ge
; CHECK-NEXT:    csel r1, r1, r2, ge
; CHECK-NEXT:    rsbs r2, r0, #0
; CHECK-NEXT:    sbcs.w r2, r9, r4
; CHECK-NEXT:    sbcs.w r1, r6, r1
; CHECK-NEXT:    sbcs.w r1, r6, r3
; CHECK-NEXT:    it ge
; CHECK-NEXT:    movge.w r4, #-2147483648
; CHECK-NEXT:    cset r1, lt
; CHECK-NEXT:    csel r7, r1, r0, ge
; CHECK-NEXT:    mov r0, r5
; CHECK-NEXT:    bl __fixsfti
; CHECK-NEXT:    subs.w r5, r0, #-1
