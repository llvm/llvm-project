...
; CHECK-NEXT:    vmov r4, r8, d2
; CHECK-NEXT:    vmov.i32 q1, #0x0
; CHECK-NEXT:    vmov r6, r9, d0
; CHECK-NEXT:    umull r1, r3, r2, r0
; CHECK-NEXT:    umull r5, r7, r6, r4
; CHECK-NEXT:    vmov q0[2], q0[0], r5, r1
; CHECK-NEXT:    mla r1, r2, r12, r3
; CHECK-NEXT:    mla r0, lr, r0, r1
; CHECK-NEXT:    mla r1, r6, r8, r7
; CHECK-NEXT:    mla r1, r9, r4, r1
...
; CHECK-NEXT:    vmov q3[2], q3[0], r5, r2
...
; CHECK-NEXT:    vmov.16 q3[1], r6
; CHECK-NEXT:    vmov.u8 r6, q6[10]
; CHECK-NEXT:    vmov.16 q3[2], r6
; CHECK-NEXT:    vmov.u8 r6, q6[11]
; CHECK-NEXT:    vmov.16 q3[3], r6
; CHECK-NEXT:    vmov.u8 r6, q6[12]
; CHECK-NEXT:    vmov.16 q3[4], r6
; CHECK-NEXT:    vmov.u8 r6, q6[13]
; CHECK-NEXT:    vmov.16 q3[5], r6
; CHECK-NEXT:    vmov.u8 r6, q6[14]
; CHECK-NEXT:    vmov.16 q3[6], r6
; CHECK-NEXT:    vmov.u8 r6, q6[15]
; CHECK-NEXT:    vmov.16 q3[7], r6
; CHECK-NEXT:    adcs r3, r5
; CHECK-NEXT:    vcmp.i16 ne, q3, zr
; CHECK-NEXT:    vpsel q6, q7, q4
; CHECK-NEXT:    vmov.u16 r6, q6[2]
; CHECK-NEXT:    vmov.u16 r5, q6[0]
; CHECK-NEXT:    vmov q3[2], q3[0], r5, r6
; CHECK-NEXT:    vmov.u16 r6, q6[3]
; CHECK-NEXT:    vmov.u16 r5, q6[1]
; CHECK-NEXT:    vmov q3[3], q3[1], r5, r6
; CHECK-NEXT:    vcmp.i32 ne, q3, zr
; CHECK-NEXT:    vpsel q3, q7, q4
; CHECK-NEXT:    vmov r6, r5, d6
...
; CHECK-NEXT:    adcs r3, r5
; CHECK-NEXT:    vmov.u16 r5, q6[4]
; CHECK-NEXT:    vmov q3[2], q3[0], r5, r6
; CHECK-NEXT:    vmov.u16 r6, q6[7]
; CHECK-NEXT:    vmov.u16 r5, q6[5]
; CHECK-NEXT:    vmov q3[3], q3[1], r5, r6
; CHECK-NEXT:    vcmp.i32 ne, q3, zr
; CHECK-NEXT:    vldrw.u32 q3, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vpsel q3, q3, q4
...
; CHECK-NEXT:    vmov.s8 r6, q1[5]
; CHECK-NEXT:    vmov.s8 r5, q3[5]
; CHECK-NEXT:    vcmp.i32 ne, q0, zr
...
; CHECK-NEXT:    vmov r6, r5, d1
; CHECK-NEXT:    adds.w r12, r2, r6
; CHECK-NEXT:    vmov.u8 r6, q5[8]
; CHECK-NEXT:    vmov.16 q0[0], r6
; CHECK-NEXT:    vmov.u8 r6, q5[9]
; CHECK-NEXT:    vmov.16 q0[1], r6
; CHECK-NEXT:    vmov.u8 r6, q5[10]
; CHECK-NEXT:    vmov.16 q0[2], r6
; CHECK-NEXT:    vmov.u8 r6, q5[11]
; CHECK-NEXT:    vmov.16 q0[3], r6
; CHECK-NEXT:    vmov.u8 r6, q5[12]
; CHECK-NEXT:    vmov.16 q0[4], r6
; CHECK-NEXT:    vmov.u8 r6, q5[13]
; CHECK-NEXT:    vmov.16 q0[5], r6
; CHECK-NEXT:    vmov.u8 r6, q5[14]
; CHECK-NEXT:    vmov.16 q0[6], r6
; CHECK-NEXT:    vmov.u8 r6, q5[15]
; CHECK-NEXT:    vmov.16 q0[7], r6
; CHECK-NEXT:    adcs r3, r5
; CHECK-NEXT:    vcmp.i16 ne, q0, zr
; CHECK-NEXT:    vmov.s8 r2, q3[8]
; CHECK-NEXT:    vpsel q5, q2, q7
; CHECK-NEXT:    smull r2, r4, r2, r4
; CHECK-NEXT:    vmov.u16 r6, q5[2]
; CHECK-NEXT:    vmov.u16 r5, q5[0]
; CHECK-NEXT:    vmov q0[2], q0[0], r5, r6
; CHECK-NEXT:    vmov.u16 r6, q5[3]
...
; CHECK-NEXT:    vmov q0[2], q0[0], r6, r5
; CHECK-NEXT:    vmov q0[3], q0[1], r6, r5
; CHECK-NEXT:    vmov.s8 r6, q1[9]
; CHECK-NEXT:    vmov.s8 r5, q3[9]
; CHECK-NEXT:    vcmp.i32 ne, q0, zr
; CHECK-NEXT:    smull r6, r5, r5, r6
; CHECK-NEXT:    vmov q0[2], q0[0], r2, r6
; CHECK-NEXT:    vmov q0[3], q0[1], r4, r5
...
; CHECK-NEXT:    vmov.s8 r5, q3[11]
; CHECK-NEXT:    vcmp.i32 ne, q0, zr
; CHECK-NEXT:    smull r6, r5, r5, r6
; CHECK-NEXT:    vmov q0[2], q0[0], r2, r6
; CHECK-NEXT:    vmov q0[3], q0[1], r4, r5
; CHECK-NEXT:    vmov.s8 r4, q1[12]
; CHECK-NEXT:    vpsel q0, q0, q4
; CHECK-NEXT:    vmov r2, r6, d0
; CHECK-NEXT:    adds.w r2, r2, r12
; CHECK-NEXT:    adcs r3, r6
...
; CHECK-NEXT:    vmov q0[2], q0[0], r6, r5
; CHECK-NEXT:    vmov q0[3], q0[1], r6, r5
; CHECK-NEXT:    vmov.s8 r6, q1[13]
; CHECK-NEXT:    vmov.s8 r5, q3[13]
; CHECK-NEXT:    vcmp.i32 ne, q0, zr
; CHECK-NEXT:    smull r6, r5, r5, r6
; CHECK-NEXT:    vmov q0[2], q0[0], r2, r6
; CHECK-NEXT:    vmov q0[3], q0[1], r4, r5
...
; CHECK-NEXT:    vmov r6, r8, d2
; CHECK-NEXT:    vmov.i32 q1, #0x0
; CHECK-NEXT:    vmov r7, r9, d0
; CHECK-NEXT:    umull r4, r10, r3, r2
; CHECK-NEXT:    umull r5, r11, r7, r6
; CHECK-NEXT:    mla r3, r3, r12, r10
; CHECK-NEXT:    vmov q0[2], q0[0], r5, r4
; CHECK-NEXT:    mla r2, lr, r2, r3
; CHECK-NEXT:    mla r3, r7, r8, r11
