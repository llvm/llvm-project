...
; CHECK-NEXT:    add.w r4, r0, #36
; CHECK-NEXT:    add.w r11, r6, #128
; CHECK-NEXT:    add.w r7, r6, #112
; CHECK-NEXT:    add.w r2, r6, #96
; CHECK-NEXT:    add.w r5, r6, #64
; CHECK-NEXT:    add.w r1, r6, #48
; CHECK-NEXT:    add.w r0, r6, #32
...
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    str r8, [r4, #-4]
; CHECK-NEXT:    vstrh.16 q1, [r4, #-36]
; CHECK-NEXT:    strh.w r9, [r4]
...
; CHECK-NEXT:    movt r0, :upper16:arr_21
; CHECK-NEXT:    addw r5, r0, #1860
; CHECK-NEXT:    add.w r0, r2, #7392
; CHECK-NEXT:    add.w r7, r2, #7360
; CHECK-NEXT:    add.w r3, r2, #7328
...
; CHECK-NEXT:    vstrh.16 q0, [r12], #152
; CHECK-NEXT:    vstrh.16 q0, [r1], #152
; CHECK-NEXT:    strd r10, r11, [r4, #64]
; CHECK-NEXT:    adds r5, #38
; CHECK-NEXT:    adds r4, #152
...
; CHECK-NEXT:    movw r0, :lower16:arr_21
; CHECK-NEXT:    add.w r5, r7, #14720
; CHECK-NEXT:    add.w r3, r7, #14656
; CHECK-NEXT:    add.w r6, r7, #14592
; CHECK-NEXT:    ldr r7, [sp, #8] @ 4-byte Reload
; CHECK-NEXT:    movt r0, :upper16:arr_21
; CHECK-NEXT:    addw r0, r0, #3684
; CHECK-NEXT:    mov.w r10, #5
...
; CHECK-NEXT:    vstrh.16 q0, [r12], #152
; CHECK-NEXT:    vstrh.16 q0, [r3], #152
; CHECK-NEXT:    strd r10, r11, [r1, #64]
; CHECK-NEXT:    adds r2, #38
; CHECK-NEXT:    adds r1, #152
