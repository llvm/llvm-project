...
; CHECK-NEXT:    adds r6, r1, #3
; CHECK-NEXT:    add.w r7, r3, #8
; CHECK-NEXT:  .LBB5_7: @ %for.body
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ldrb r9, [r5, #-3]
; CHECK-NEXT:    add.w r8, r8, #4
; CHECK-NEXT:    ldrb r4, [r6, #-3]
; CHECK-NEXT:    smlabb r4, r4, r9, r2
; CHECK-NEXT:    str r4, [r7, #-8]
; CHECK-NEXT:    ldrb r9, [r5, #-2]
; CHECK-NEXT:    ldrb r4, [r6, #-2]
; CHECK-NEXT:    smlabb r4, r4, r9, r2
; CHECK-NEXT:    str r4, [r7, #-4]
; CHECK-NEXT:    ldrb r9, [r5, #-1]
; CHECK-NEXT:    ldrb r4, [r6, #-1]
; CHECK-NEXT:    smlabb r4, r4, r9, r2
; CHECK-NEXT:    str r4, [r7]
; CHECK-NEXT:    ldrb r9, [r5], #4
; CHECK-NEXT:    ldrb r4, [r6], #4
; CHECK-NEXT:    smlabb r4, r4, r9, r2
; CHECK-NEXT:    str r4, [r7, #4]
