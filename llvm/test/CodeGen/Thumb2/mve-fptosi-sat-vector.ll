...
; CHECK-NEXT:    csinv r3, r6, zr, le
; CHECK-NEXT:    csinv r1, r1, zr, le
; CHECK-NEXT:    csinv r2, r2, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    it vs
; CHECK-NEXT:    movvs r2, #0
...
; CHECK-NEXT:    vcmp.f32 s17, s17
; CHECK-NEXT:    csinv r0, r0, zr, le
; CHECK-NEXT:    csinv r10, r2, zr, le
; CHECK-NEXT:    csinv r11, r1, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    ittt vs
; CHECK-NEXT:    movvs r6, #0
; CHECK-NEXT:    movvs.w r10, #0
...
; CHECK-NEXT:    vcmp.f32 s19, s19
; CHECK-NEXT:    csinv r5, r0, zr, le
; CHECK-NEXT:    vmov r0, s16
; CHECK-NEXT:    csinv r9, r1, zr, le
; CHECK-NEXT:    csinv r8, r2, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    itttt vs
; CHECK-NEXT:    movvs r7, #0
; CHECK-NEXT:    movvs.w r8, #0
...
; CHECK-NEXT:    csinv r5, r2, zr, le
; CHECK-NEXT:    csinv r8, r1, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    itttt vs
; CHECK-NEXT:    movvs r6, #0
; CHECK-NEXT:    movvs.w r9, #0
...
; CHECK-NEXT:    vcmp.f32 s24, s24
; CHECK-NEXT:    csinv r8, r2, zr, le
; CHECK-NEXT:    csinv r10, r1, zr, le
; CHECK-NEXT:    csinv r9, r7, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    it vs
; CHECK-NEXT:    movvs r3, #0
...
; CHECK-NEXT:    csinv r7, r0, zr, le
; CHECK-NEXT:    vmov r0, s24
; CHECK-NEXT:    csinv r6, r2, zr, le
; CHECK-NEXT:    csinv r5, r1, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    it vs
; CHECK-NEXT:    movvs r3, #0
...
; CHECK-NEXT:    movgt r3, #7
; CHECK-NEXT:    vcvtt.f32.f16 s24, s17
; CHECK-NEXT:    csinv r7, r1, zr, le
; CHECK-NEXT:    csinv r0, r0, zr, le
; CHECK-NEXT:    csinv r1, r2, zr, le
; CHECK-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-NEXT:    it vs
; CHECK-NEXT:    movvs r3, #0
