...
; RUN: llc -mtriple=thumbv8.1m.main-none-eabihf -mattr=+mve.fp -enable-arm-maskedgatscat=false %s -o - | FileCheck --check-prefix NOGATSCAT %s
; RUN: llc -mtriple=thumbv8.1m.main-none-eabi -mattr=-mve %s -o - | FileCheck --check-prefix NOMVE %s

define <4 x i32> @unscaled_i32_i32_gather(ptr %base, ptr %offptr) {
...
define void @unscaled_i32_i8_scatter(ptr %base, ptr %offptr, <4 x i32> %input) {
