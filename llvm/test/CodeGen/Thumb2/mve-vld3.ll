...
; CHECK-LV:       @ %bb.0: @ %entry
; CHECK-LV-NEXT:    vldrw.u32 q2, [r0]
; CHECK-LV-NEXT:    vldr s5, [r0, #16]
; CHECK-LV-NEXT:    vldr s1, [r0, #20]
; CHECK-LV-NEXT:    @ implicit-def: $s14
; CHECK-LV-NEXT:    @ implicit-def: $s15
; CHECK-LV-NEXT:    @ implicit-def: $s6
; CHECK-LV-NEXT:    @ implicit-def: $s7
; CHECK-LV-NEXT:    @ implicit-def: $s2
; CHECK-LV-NEXT:    @ implicit-def: $s3
; CHECK-LV-NEXT:    vmov.f32 s12, s8
; CHECK-LV-NEXT:    vmov.f32 s13, s11
; CHECK-LV-NEXT:    vmov.f32 s4, s9
; CHECK-LV-NEXT:    vadd.f32 q1, q3, q1
; CHECK-LV-NEXT:    vmov.f32 s0, s10
; CHECK-LV-NEXT:    vadd.f32 q0, q1, q0
