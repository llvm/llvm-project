...
; CHECK-NEXT:    bic r1, r9, #3
; CHECK-NEXT:    adds r2, r1, r3
; CHECK-NEXT:    mov r3, r12
; CHECK-NEXT:    add.w r2, r12, r2, lsl #2
...
; CHECK-NEXT:    ldm.w r9, {r10, r11, r12}
...
; CHECK-NEXT:    @ => This Inner Loop Header: Depth=2
; CHECK-NEXT:    ldr.w r10, [r1, #12]
; CHECK-NEXT:    vldrw.u32 q7, [r0]
; CHECK-NEXT:    vldrw.u32 q5, [r0, #16]
; CHECK-NEXT:    ldm.w r1, {r2, r3, r11}
; CHECK-NEXT:    vmul.f32 q7, q7, r10
; CHECK-NEXT:    vldrw.u32 q6, [r0, #32]
; CHECK-NEXT:    vfma.f32 q7, q5, r11
; CHECK-NEXT:    vldrw.u32 q3, [r0, #48]
; CHECK-NEXT:    vfma.f32 q7, q6, r3
; CHECK-NEXT:    vldrw.u32 q4, [r0, #64]
; CHECK-NEXT:    vfma.f32 q7, q3, r2
; CHECK-NEXT:    vldrw.u32 q1, [r0, #80]
; CHECK-NEXT:    vfma.f32 q7, q4, r7
; CHECK-NEXT:    vldrw.u32 q2, [r0, #96]
; CHECK-NEXT:    vfma.f32 q7, q1, r4
; CHECK-NEXT:    vldrw.u32 q0, [r0, #112]
; CHECK-NEXT:    vfma.f32 q7, q2, r12
; CHECK-NEXT:    adds r1, #16
; CHECK-NEXT:    vfma.f32 q7, q0, r5
; CHECK-NEXT:    mov r4, r11
; CHECK-NEXT:    vmov r5, r12, d15
; CHECK-NEXT:    vstrb.8 q7, [r6], #16
; CHECK-NEXT:    mov r7, r10
...
; CHECK-NEXT:    vfma.f32 q6, q1, r7
; CHECK-NEXT:    vmov r7, s24
; CHECK-NEXT:    vmov q3, q6
; CHECK-NEXT:    vfma.f32 q3, q2, r7
