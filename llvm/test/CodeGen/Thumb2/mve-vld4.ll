...
; CHECK-NEXT:    adds r0, r5, r3
; CHECK-NEXT:    adc.w r5, r4, r2
; CHECK-NEXT:    vmov r4, r8, d0
; CHECK-NEXT:    vmov.f32 s0, s18
; CHECK-NEXT:    vmov.f32 s1, s19
; CHECK-NEXT:    adds.w r2, r7, lr
; CHECK-NEXT:    adc.w r7, r6, r12
; CHECK-NEXT:    vmov r3, r6, d12
...
; CHECK-NEXT:    adds.w r9, r7, r3
; CHECK-NEXT:    adc.w r8, r0, r6
