...
; CHECK-NEXT:    ldrd r12, lr, [r0]
; CHECK-NEXT:    ldr r0, [r0, #28]
; CHECK-NEXT:    ldm r6, {r2, r3, r4, r5, r6}
; CHECK-NEXT:    vmov q0[2], q0[0], r4, r6
; CHECK-NEXT:    vmov q0[3], q0[1], r5, r0
; CHECK-NEXT:    vmov.f32 s10, s0
; CHECK-NEXT:    vmov q1[2], q1[0], r12, r2
; CHECK-NEXT:    vmov.f32 s11, s2
; CHECK-NEXT:    vmov q1[3], q1[1], lr, r3
...
; CHECK-NEXT:    vmov q3[2], q3[0], r12, r2
; CHECK-NEXT:    vmovx.f16 s2, s2
; CHECK-NEXT:    vmov q3[3], q3[1], lr, r3
...
; CHECK-NEXT:    vins.f16 s15, s12
; CHECK-NEXT:    vmovx.f16 s12, s8
; CHECK-NEXT:    vmovx.f16 s14, s24
; CHECK-NEXT:    vmovx.f16 s23, s3
; CHECK-NEXT:    vins.f16 s12, s14
; CHECK-NEXT:    vmovx.f16 s14, s19
; CHECK-NEXT:    vins.f16 s23, s14
; CHECK-NEXT:    vmovx.f16 s22, s11
; CHECK-NEXT:    vmovx.f16 s14, s27
; CHECK-NEXT:    vins.f16 s3, s19
; CHECK-NEXT:    vins.f16 s22, s14
