...
; CHECK-NEXT:    asrs r5, r7, #3
; CHECK-NEXT:    cmp r5, #1
; CHECK-NEXT:    it gt
; CHECK-NEXT:    asrgt r1, r7, #3
; CHECK-NEXT:    add.w r7, r6, r3, lsl #1
