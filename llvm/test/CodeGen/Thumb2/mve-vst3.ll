...
; CHECK-NEXT:    vmovx.f16 s18, s23
; CHECK-NEXT:    vins.f16 s23, s15
; CHECK-NEXT:    vmovx.f16 s15, s24
; CHECK-NEXT:    vins.f16 s6, s28
; CHECK-NEXT:    vmov.f32 s28, s12
...
; CHECK-NEXT:    vins.f16 s30, s11
; CHECK-NEXT:    vmov.u16 r0, q3[3]
; CHECK-NEXT:    vins.f16 s8, s14
; CHECK-NEXT:    vmov.16 q3[2], r0
; CHECK-NEXT:    vins.f16 s19, s18
...
; CHECK-NEXT:    vmovx.f16 s13, s21
; CHECK-NEXT:    vins.f16 s6, s10
; CHECK-NEXT:    vins.f16 s3, s23
; CHECK-NEXT:    vins.f16 s0, s20
; CHECK-NEXT:    vins.f16 s1, s21
; CHECK-NEXT:    vins.f16 s2, s22
; CHECK-NEXT:    vins.f16 s13, s14
...
; CHECK-NEXT:    vldrw.u32 q5, [r0, #16]
; CHECK-NEXT:    vstr s2, [sp, #52] @ 4-byte Spill
; CHECK-NEXT:    vmovx.f16 s2, s6
...
; CHECK-NEXT:    vmovx.f16 s9, s25
; CHECK-NEXT:    vmovx.f16 s5, s1
; CHECK-NEXT:    vins.f16 s5, s9
; CHECK-NEXT:    vmovx.f16 s6, s31
; CHECK-NEXT:    vmovx.f16 s19, s11
; CHECK-NEXT:    vmovx.f16 s10, s21
; CHECK-NEXT:    vins.f16 s19, s6
; CHECK-NEXT:    vstrw.32 q1, [sp, #16] @ 16-byte Spill
; CHECK-NEXT:    vmovx.f16 s9, s24
; CHECK-NEXT:    vmovx.f16 s6, s0
; CHECK-NEXT:    vins.f16 s25, s10
; CHECK-NEXT:    vmovx.f16 s10, s20
; CHECK-NEXT:    vins.f16 s6, s9
; CHECK-NEXT:    vins.f16 s20, s0
; CHECK-NEXT:    vmovx.f16 s0, s12
; CHECK-NEXT:    vstrw.32 q1, [sp, #72] @ 16-byte Spill
