...
; CHECK-NEXT:    vstrw.32 q2, [sp, #40] @ 16-byte Spill
...
; CHECK-NEXT:    vmovx.f16 s2, s27
; CHECK-NEXT:    vmov.f32 s1, s31
; CHECK-NEXT:    vldrw.u32 q3, [sp, #40] @ 16-byte Reload
; CHECK-NEXT:    vmov r0, s8
; CHECK-NEXT:    vins.f16 s1, s2
...
; CHECK-NEXT:    vstrw.32 q3, [sp, #40] @ 16-byte Spill
