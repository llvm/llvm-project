...
; CHECK-NEXT:    vstr s0, [sp, #92] @ 4-byte Spill
...
; CHECK-NEXT:    vstr s4, [sp, #68] @ 4-byte Spill
...
; CHECK-NEXT:    vstr s2, [sp] @ 4-byte Spill
...
; CHECK-NEXT:    vmovx.f16 s6, s26
; CHECK-NEXT:    vins.f16 s18, s6
; CHECK-NEXT:    vldrw.u32 q1, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vmov.16 q5[2], r0
; CHECK-NEXT:    vldrw.u32 q6, [sp, #72] @ 16-byte Reload
; CHECK-NEXT:    vmov.f64 d6, d2
; CHECK-NEXT:    vins.f16 s21, s11
; CHECK-NEXT:    vstrw.32 q0, [r1, #80]
; CHECK-NEXT:    vmov.f32 s15, s7
; CHECK-NEXT:    vldrw.u32 q1, [sp, #48] @ 16-byte Reload
; CHECK-NEXT:    vldr s7, [sp, #68] @ 4-byte Reload
; CHECK-NEXT:    vmov.f32 s14, s19
; CHECK-NEXT:    vldr s27, [sp, #92] @ 4-byte Reload
; CHECK-NEXT:    vmov.f32 s5, s16
; CHECK-NEXT:    vldr s30, [sp, #32] @ 4-byte Reload
; CHECK-NEXT:    vmov.f32 s25, s8
; CHECK-NEXT:    vldr s22, [sp] @ 4-byte Reload
; CHECK-NEXT:    vmov.f32 s28, s9
; CHECK-NEXT:    vmov.f32 s31, s10
