...
; CHECK-NEXT:    vldrw.u32 q6, [r6], #16
; CHECK-NEXT:    vldrw.u32 q2, [r3], #16
; CHECK-NEXT:    vmov q3, q4
; CHECK-NEXT:    vldrw.u32 q4, [r4], #16
; CHECK-NEXT:    vfma.f32 q1, q2, q6
; CHECK-NEXT:    vldrw.u32 q2, [r0], #16
; CHECK-NEXT:    vmov q5, q1
; CHECK-NEXT:    vfma.f32 q3, q2, q6
; CHECK-NEXT:    vmov q2, q0
; CHECK-NEXT:    vfma.f32 q2, q4, q6
; CHECK-NEXT:    vmov q4, q3
; CHECK-NEXT:    vmov q0, q2
; CHECK-NEXT:    letp lr, .LBB2_3
; CHECK-NEXT:  @ %bb.4: @ %middle.block
; CHECK-NEXT:    @ in Loop: Header=BB2_2 Depth=1
; CHECK-NEXT:    vadd.f32 s0, s14, s15
; CHECK-NEXT:    adds r0, r5, #1
; CHECK-NEXT:    vadd.f32 s2, s12, s13
...
; CHECK-NEXT:    vldrw.u32 q1, [sp, #24] @ 16-byte Reload
; CHECK-NEXT:    vmov q7, q4
; CHECK-NEXT:    vfma.f32 q1, q5, q0
; CHECK-NEXT:    vmov q5, q2
; CHECK-NEXT:    vmov q0, q1
; CHECK-NEXT:    letp lr, .LBB3_3
; CHECK-NEXT:  @ %bb.4: @ %middle.block
; CHECK-NEXT:    @ in Loop: Header=BB3_2 Depth=1
; CHECK-NEXT:    vadd.f32 s0, s18, s19
; CHECK-NEXT:    ldr r1, [sp, #12] @ 4-byte Reload
; CHECK-NEXT:    vadd.f32 s2, s16, s17
...
; CHECK-NEXT:    vadd.f32 s4, s4, s5
; CHECK-NEXT:    vadd.f32 s0, s2, s0
; CHECK-NEXT:    vadd.f32 s2, s12, s14
...
; CHECK-NEXT:    vadd.f32 s16, s30, s31
; CHECK-NEXT:    add.w r1, r2, r4, lsl #2
; CHECK-NEXT:    vadd.f32 s18, s28, s29
; CHECK-NEXT:    vadd.f32 s14, s14, s15
; CHECK-NEXT:    vadd.f32 s12, s12, s13
; CHECK-NEXT:    vadd.f32 s10, s10, s11
; CHECK-NEXT:    vadd.f32 s8, s8, s9
; CHECK-NEXT:    vadd.f32 s4, s4, s5
; CHECK-NEXT:    vadd.f32 s6, s6, s7
; CHECK-NEXT:    vadd.f32 s5, s18, s16
; CHECK-NEXT:    vadd.f32 s2, s2, s3
...
; CHECK-NEXT:    vadd.f32 s9, s22, s23
; CHECK-NEXT:    vadd.f32 s11, s20, s21
; CHECK-NEXT:    vadd.f32 s6, s6, s7
; CHECK-NEXT:    vadd.f32 s4, s4, s5
; CHECK-NEXT:    vadd.f32 s2, s2, s3
; CHECK-NEXT:    vadd.f32 s0, s0, s1
...
; CHECK-NEXT:    vadd.f32 s12, s12, s13
; CHECK-NEXT:    vadd.f32 s4, s4, s6
; CHECK-NEXT:    vadd.f32 s20, s30, s31
; CHECK-NEXT:    vadd.f32 s0, s0, s2
; CHECK-NEXT:    vstr s8, [r1]
; CHECK-NEXT:    add.w r1, r2, r0, lsl #2
; CHECK-NEXT:    vadd.f32 s22, s28, s29
; CHECK-NEXT:    vstr s10, [r1]
; CHECK-NEXT:    add.w r1, r2, r4, lsl #2
; CHECK-NEXT:    vadd.f32 s12, s12, s14
; CHECK-NEXT:    vstr s4, [r1]
; CHECK-NEXT:    adds r1, r0, #3
; CHECK-NEXT:    vadd.f32 s16, s26, s27
; CHECK-NEXT:    vadd.f32 s18, s24, s25
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
; CHECK-NEXT:    vstr s0, [r1]
; CHECK-NEXT:    adds r1, r0, #4
; CHECK-NEXT:    vadd.f32 s3, s22, s20
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
; CHECK-NEXT:    vstr s12, [r1]
; CHECK-NEXT:    adds r1, r0, #5
; CHECK-NEXT:    vadd.f32 s1, s18, s16
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
...
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q1, q3, q0
; CHECK-NEXT:    vldrwt.u32 q3, [r5]
; CHECK-NEXT:    adds r5, r7, r6
; CHECK-NEXT:    vstrw.32 q1, [sp, #16] @ 16-byte Spill
; CHECK-NEXT:    vpst
; CHECK-NEXT:    vfmat.f32 q4, q3, q0
; CHECK-NEXT:    vldrw.u32 q3, [sp, #112] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q4, [sp, #32] @ 16-byte Spill
; CHECK-NEXT:    vpst
; CHECK-NEXT:    vldrwt.u32 q4, [r7]
; CHECK-NEXT:    adds r7, r5, r6
; CHECK-NEXT:    sub.w r10, r10, #4
; CHECK-NEXT:    vpsttt
; CHECK-NEXT:    vfmat.f32 q3, q4, q0
; CHECK-NEXT:    vldrwt.u32 q4, [r5]
; CHECK-NEXT:    vldrwt.u32 q7, [r7]
; CHECK-NEXT:    adds r5, r7, r6
; CHECK-NEXT:    vpst
; CHECK-NEXT:    vfmat.f32 q6, q4, q0
; CHECK-NEXT:    vldrw.u32 q4, [sp, #144] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q5, [sp, #80] @ 16-byte Spill
; CHECK-NEXT:    vstrw.32 q6, [sp, #128] @ 16-byte Spill
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q4, q7, q0
; CHECK-NEXT:    vldrwt.u32 q7, [r5]
; CHECK-NEXT:    vstrw.32 q2, [sp, #64] @ 16-byte Spill
; CHECK-NEXT:    vstrw.32 q3, [sp, #112] @ 16-byte Spill
...
; CHECK-NEXT:    vstrw.32 q4, [sp, #144] @ 16-byte Spill
; CHECK-NEXT:    vpst
; CHECK-NEXT:    vfmat.f32 q7, q1, q0
; CHECK-NEXT:    vldrw.u32 q0, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q7, [sp, #160] @ 16-byte Spill
; CHECK-NEXT:    vmov q1, q0
; CHECK-NEXT:    vstrw.32 q0, [sp, #48] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q0, [sp, #32] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q0, [sp, #96] @ 16-byte Spill
...
; CHECK-NEXT:    vadd.f32 s6, s6, s7
; CHECK-NEXT:    vadd.f32 s4, s4, s5
; CHECK-NEXT:    vadd.f32 s5, s2, s3
; CHECK-NEXT:    vadd.f32 s7, s0, s1
; CHECK-NEXT:    vadd.f32 s14, s14, s15
; CHECK-NEXT:    vstr s10, [sp, #160] @ 4-byte Spill
; CHECK-NEXT:    vadd.f32 s10, s20, s21
; CHECK-NEXT:    vstr s8, [sp, #144] @ 4-byte Spill
; CHECK-NEXT:    vadd.f32 s8, s22, s23
; CHECK-NEXT:    vldr s0, [sp, #160] @ 4-byte Reload
; CHECK-NEXT:    vadd.f32 s12, s12, s13
; CHECK-NEXT:    vldr s2, [sp, #144] @ 4-byte Reload
; CHECK-NEXT:    vadd.f32 s4, s4, s6
; CHECK-NEXT:    vadd.f32 s20, s18, s19
; CHECK-NEXT:    vadd.f32 s0, s2, s0
; CHECK-NEXT:    vadd.f32 s6, s7, s5
; CHECK-NEXT:    vadd.f32 s22, s16, s17
; CHECK-NEXT:    vadd.f32 s2, s10, s8
; CHECK-NEXT:    vadd.f32 s16, s26, s27
; CHECK-NEXT:    vadd.f32 s18, s24, s25
; CHECK-NEXT:    vadd.f32 s12, s12, s14
; CHECK-NEXT:    vstr s0, [r1]
; CHECK-NEXT:    add.w r1, r2, r0, lsl #2
; CHECK-NEXT:    vadd.f32 s9, s30, s31
; CHECK-NEXT:    vadd.f32 s11, s28, s29
; CHECK-NEXT:    vstr s2, [r1]
; CHECK-NEXT:    add.w r1, r2, r8, lsl #2
; CHECK-NEXT:    vadd.f32 s8, s22, s20
; CHECK-NEXT:    vstr s4, [r1]
; CHECK-NEXT:    add.w r1, r2, r4, lsl #2
; CHECK-NEXT:    vadd.f32 s1, s18, s16
