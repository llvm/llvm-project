...
; CHECK-NEXT:    vadd.f32 s0, s0, s2
; CHECK-NEXT:    vadd.f32 s2, s8, s10
; CHECK-NEXT:    vadd.f32 s8, s12, s14
; CHECK-NEXT:    vstr s1, [r1]
; CHECK-NEXT:    add.w r1, r2, r0, lsl #2
...
; CHECK-NEXT:    vstrw.32 q7, [sp, #40] @ 16-byte Spill
...
; CHECK-NEXT:    adds r7, r6, r5
; CHECK-NEXT:    vstrw.32 q1, [sp, #40] @ 16-byte Spill
; CHECK-NEXT:    vpstt
...
; CHECK-NEXT:    vldrw.u32 q7, [sp, #56] @ 16-byte Reload
...
; CHECK-NEXT:    vadd.f32 s8, s8, s10
; CHECK-NEXT:    vadd.f32 s10, s12, s14
; CHECK-NEXT:    vadd.f32 s12, s11, s9
; CHECK-NEXT:    vstr s0, [r1]
; CHECK-NEXT:    add.w r1, r2, r0, lsl #2
...
; CHECK-NEXT:    ldr r1, [sp, #24] @ 4-byte Reload
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
; CHECK-NEXT:    vadd.f32 s1, s22, s20
; CHECK-NEXT:    vstr s4, [r1]
; CHECK-NEXT:    ldr r1, [sp, #28] @ 4-byte Reload
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
...
; CHECK-NEXT:    vstrw.32 q0, [sp, #56] @ 16-byte Spill
; CHECK-NEXT:    vstrw.32 q0, [sp, #72] @ 16-byte Spill
...
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vldrwt.u32 q1, [r8], #16
; CHECK-NEXT:    vldrwt.u32 q2, [r3], #16
; CHECK-NEXT:    add.w r5, r11, r6
; CHECK-NEXT:    vstrw.32 q0, [sp, #40] @ 16-byte Spill
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q6, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r11]
; CHECK-NEXT:    vldrw.u32 q0, [sp, #56] @ 16-byte Reload
; CHECK-NEXT:    adds r7, r5, r6
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q7, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r5]
; CHECK-NEXT:    adds r5, r7, r6
; CHECK-NEXT:    sub.w r10, r10, #4
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q0, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r7]
; CHECK-NEXT:    vstrw.32 q0, [sp, #56] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q0, [sp, #72] @ 16-byte Reload
; CHECK-NEXT:    adds r7, r5, r6
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q0, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r5]
...
; CHECK-NEXT:    vstrw.32 q0, [sp, #72] @ 16-byte Spill
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q3, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r7]
; CHECK-NEXT:    vldrw.u32 q0, [sp, #40] @ 16-byte Reload
; CHECK-NEXT:    vpstt
; CHECK-NEXT:    vfmat.f32 q4, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r5]
; CHECK-NEXT:    add r5, r6
; CHECK-NEXT:    vpsttt
; CHECK-NEXT:    vfmat.f32 q5, q2, q1
; CHECK-NEXT:    vldrwt.u32 q2, [r5]
; CHECK-NEXT:    vfmat.f32 q0, q2, q1
; CHECK-NEXT:    le lr, .LBB7_3
; CHECK-NEXT:  @ %bb.4: @ %middle.block
; CHECK-NEXT:    @ in Loop: Header=BB7_2 Depth=1
; CHECK-NEXT:    vadd.f32 s4, s30, s31
; CHECK-NEXT:    add.w r1, r2, r1, lsl #2
; CHECK-NEXT:    vadd.f32 s6, s28, s29
; CHECK-NEXT:    vadd.f32 s2, s2, s3
; CHECK-NEXT:    vadd.f32 s0, s0, s1
; CHECK-NEXT:    vadd.f32 s8, s26, s27
; CHECK-NEXT:    vadd.f32 s10, s24, s25
; CHECK-NEXT:    vadd.f32 s1, s14, s15
; CHECK-NEXT:    vadd.f32 s3, s12, s13
; CHECK-NEXT:    vldrw.u32 q3, [sp, #56] @ 16-byte Reload
; CHECK-NEXT:    vadd.f32 s5, s22, s23
; CHECK-NEXT:    vadd.f32 s7, s20, s21
...
; CHECK-NEXT:    vadd.f32 s11, s12, s13
; CHECK-NEXT:    vadd.f32 s13, s18, s19
; CHECK-NEXT:    vadd.f32 s15, s16, s17
; CHECK-NEXT:    vadd.f32 s4, s6, s4
; CHECK-NEXT:    vadd.f32 s6, s10, s8
; CHECK-NEXT:    vadd.f32 s10, s3, s1
; CHECK-NEXT:    vadd.f32 s0, s0, s2
; CHECK-NEXT:    vadd.f32 s12, s11, s9
; CHECK-NEXT:    vadd.f32 s2, s22, s20
; CHECK-NEXT:    vadd.f32 s14, s15, s13
; CHECK-NEXT:    vstr s4, [r1]
; CHECK-NEXT:    add.w r1, r2, r0, lsl #2
; CHECK-NEXT:    vadd.f32 s8, s7, s5
