...
; CHECK-NEXT:    eor.w r7, r1, r2
; CHECK-NEXT:    adc r3, r3, #0
; CHECK-NEXT:    asrl r0, r3, r2
; CHECK-NEXT:    subs r5, r0, r2
; CHECK-NEXT:    sbc lr, r3, #0
; CHECK-NEXT:    asrs r3, r4, #31
; CHECK-NEXT:    adds r0, r4, r6
; CHECK-NEXT:    umull r12, r8, r5, r2
; CHECK-NEXT:    adc r3, r3, #0
; CHECK-NEXT:    asrl r0, r3, r6
; CHECK-NEXT:    subs r0, r0, r6
; CHECK-NEXT:    sbc r3, r3, #0
; CHECK-NEXT:    orrs.w r7, r7, r1, asr #31
; CHECK-NEXT:    umull r0, r5, r0, r6
; CHECK-NEXT:    csetm r9, eq
; CHECK-NEXT:    movs r7, #0
; CHECK-NEXT:    bfi r7, r9, #0, #8
; CHECK-NEXT:    mla r5, r3, r6, r5
; CHECK-NEXT:    eor.w r3, r4, r6
; CHECK-NEXT:    orrs.w r3, r3, r4, asr #31
...
; CHECK-NEXT:    lsll r12, r7, r1
; CHECK-NEXT:    vmov r1, s6
; CHECK-NEXT:    lsll r12, r7, r2
; CHECK-NEXT:    vmov r2, s2
; CHECK-NEXT:    vmov r7, s0
; CHECK-NEXT:    lsll r0, r5, r6
; CHECK-NEXT:    vmov q3[2], q3[0], r12, r0
; CHECK-NEXT:    vpsel q2, q3, q2
; CHECK-NEXT:    adds r6, r2, r1
; CHECK-NEXT:    asr.w r0, r2, #31
; CHECK-NEXT:    adc r3, r0, #0
; CHECK-NEXT:    asrl r6, r3, r1
; CHECK-NEXT:    subs r0, r6, r1
; CHECK-NEXT:    sbc r12, r3, #0
; CHECK-NEXT:    asrs r3, r7, #31
; CHECK-NEXT:    adds r6, r7, r4
; CHECK-NEXT:    umull r0, r5, r0, r1
; CHECK-NEXT:    adc r3, r3, #0
; CHECK-NEXT:    asrl r6, r3, r4
; CHECK-NEXT:    subs.w r8, r6, r4
; CHECK-NEXT:    eor.w r6, r7, r4
; CHECK-NEXT:    sbc lr, r3, #0
; CHECK-NEXT:    eor.w r3, r2, r1
; CHECK-NEXT:    orrs.w r3, r3, r2, asr #31
; CHECK-NEXT:    mla r5, r12, r1, r5
; CHECK-NEXT:    csetm r3, eq
; CHECK-NEXT:    orrs.w r6, r6, r7, asr #31
; CHECK-NEXT:    csetm r6, eq
; CHECK-NEXT:    rsbs r2, r2, #0
; CHECK-NEXT:    bfi r10, r6, #0, #8
; CHECK-NEXT:    lsll r0, r5, r2
; CHECK-NEXT:    bfi r10, r3, #8, #8
; CHECK-NEXT:    umull r6, r3, r8, r4
; CHECK-NEXT:    lsll r0, r5, r1
; CHECK-NEXT:    rsbs r1, r7, #0
; CHECK-NEXT:    vmsr p0, r10
; CHECK-NEXT:    mla r3, lr, r4, r3
