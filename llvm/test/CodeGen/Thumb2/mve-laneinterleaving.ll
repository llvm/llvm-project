...
; CHECK-NEXT:    umull r2, lr, r0, r3
; CHECK-NEXT:    vmov r0, s4
; CHECK-NEXT:    adds r6, r4, r0
; CHECK-NEXT:    adc r7, r5, #0
; CHECK-NEXT:    mla r5, r8, r3, lr
; CHECK-NEXT:    asrl r6, r7, r0
; CHECK-NEXT:    subs.w r8, r6, r0
; CHECK-NEXT:    eor.w r6, r4, r0
; CHECK-NEXT:    sbc lr, r7, #0
; CHECK-NEXT:    eor.w r7, r1, r3
; CHECK-NEXT:    orrs.w r6, r6, r4, asr #31
; CHECK-NEXT:    orr.w r7, r7, r1, asr #31
...
; CHECK-NEXT:    rsb.w r8, r1, #0
; CHECK-NEXT:    lsll r2, r5, r8
; CHECK-NEXT:    vmsr p0, r12
; CHECK-NEXT:    mla r1, lr, r0, r7
; CHECK-NEXT:    lsll r2, r5, r3
