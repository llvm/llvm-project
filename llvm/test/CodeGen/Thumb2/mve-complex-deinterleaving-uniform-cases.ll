...
; CHECK-NEXT:    vldr s13, [sp, #144]
; CHECK-NEXT:    vfma.f32 q0, q6, q5
; CHECK-NEXT:    vldr s12, [sp, #136]
; CHECK-NEXT:    vadd.f32 q4, q2, q0
; CHECK-NEXT:    vmul.f32 q2, q7, q1
; CHECK-NEXT:    vldrw.u32 q6, [sp, #48] @ 16-byte Reload
; CHECK-NEXT:    vneg.f32 q2, q2
; CHECK-NEXT:    vldr s1, [sp, #192]
; CHECK-NEXT:    vfma.f32 q2, q3, q6
; CHECK-NEXT:    vmul.f32 q3, q3, q1
; CHECK-NEXT:    vldr s0, [sp, #184]
; CHECK-NEXT:    vfma.f32 q3, q7, q6
; CHECK-NEXT:    vldr s21, [sp, #196]
; CHECK-NEXT:    vldrw.u32 q1, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vldr s20, [sp, #188]
; CHECK-NEXT:    vsub.f32 q3, q0, q3
; CHECK-NEXT:    vmov.f32 s0, s4
; CHECK-NEXT:    vadd.f32 q5, q5, q2
; CHECK-NEXT:    vmov.f32 s2, s5
