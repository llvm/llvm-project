...
; CHECK-NEXT:    ldrh r0, [r2]
; CHECK-NEXT:    ldrh.w r11, [r1]
; CHECK-NEXT:    mov r1, r7
; CHECK-NEXT:    str r0, [sp, #92] @ 4-byte Spill
; CHECK-NEXT:    add r0, sp, #112
; CHECK-NEXT:    ldrh.w r10, [r5]
; CHECK-NEXT:    ldrh r2, [r6]
; CHECK-NEXT:    ldrh r3, [r3]
; CHECK-NEXT:    ldrh.w r5, [r9]
; CHECK-NEXT:    vstrw.32 q6, [r7]
; CHECK-NEXT:    vldrh.s32 q1, [r7]
; CHECK-NEXT:    vmov.16 q7[0], r3
; CHECK-NEXT:    vmov.16 q7[1], r5
...
; CHECK-NEXT:    vldrh.s32 q3, [r0]
; CHECK-NEXT:    vmov.16 q1[6], r3
; CHECK-NEXT:    vmov.16 q1[7], r5
; CHECK-NEXT:    vshl.i32 q3, q3, #1
; CHECK-NEXT:    vadd.i32 q0, q3, r4
...
; CHECK-NEXT:    vmov.16 q7[4], r11
; CHECK-NEXT:    vmov.16 q7[5], r0
; CHECK-NEXT:    vmov.16 q7[6], r10
...
; CHECK-NEXT:    adr r7, .LCPI13_8
; CHECK-NEXT:    vldrw.u32 q0, [r3]
; CHECK-NEXT:    adr r3, .LCPI13_1
; CHECK-NEXT:    adr r6, .LCPI13_7
; CHECK-NEXT:    adr r5, .LCPI13_6
; CHECK-NEXT:    vstrw.32 q0, [sp, #96] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q0, [r3]
; CHECK-NEXT:    adr r3, .LCPI13_5
; CHECK-NEXT:    bic r10, r2, #7
; CHECK-NEXT:    vstrw.32 q0, [sp, #80] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q0, [r7]
; CHECK-NEXT:    adr r7, .LCPI13_9
; CHECK-NEXT:    vmov.i32 q6, #0x30
; CHECK-NEXT:    vstrw.32 q0, [sp, #64] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q0, [r6]
; CHECK-NEXT:    vstrw.32 q6, [sp, #120] @ 16-byte Spill
...
; CHECK-NEXT:    vstrw.32 q7, [sp, #216] @ 16-byte Spill
...
; CHECK-NEXT:    vstrw.32 q4, [sp, #152] @ 16-byte Spill
; CHECK-NEXT:    vadd.i32 q0, q0, r0
; CHECK-NEXT:    vldrw.u32 q4, [sp, #232] @ 16-byte Reload
...
; CHECK-NEXT:    ldrb.w r5, [r8]
; CHECK-NEXT:    vmov.8 q6[3], r6
; CHECK-NEXT:    vmov.8 q6[4], r7
; CHECK-NEXT:    vmov r7, r6, d5
; CHECK-NEXT:    vmov.8 q6[5], r5
...
; CHECK-NEXT:    ldrb r7, [r7]
; CHECK-NEXT:    ldrb r6, [r6]
; CHECK-NEXT:    vmov.8 q6[6], r7
; CHECK-NEXT:    vmov r7, r5, d0
; CHECK-NEXT:    vmov.8 q6[7], r6
; CHECK-NEXT:    ldrb r4, [r4]
; CHECK-NEXT:    ldrb r7, [r7]
; CHECK-NEXT:    ldrb r5, [r5]
; CHECK-NEXT:    vmov.8 q7[4], r7
...
; CHECK-NEXT:    ldrb r7, [r7]
; CHECK-NEXT:    ldrb r6, [r6]
; CHECK-NEXT:    vmov.8 q7[6], r7
; CHECK-NEXT:    vmov r7, r5, d0
; CHECK-NEXT:    vmov.8 q7[7], r6
; CHECK-NEXT:    ldrb.w r6, [r12]
; CHECK-NEXT:    vmov.8 q7[8], r1
; CHECK-NEXT:    vmov r1, lr, d1
; CHECK-NEXT:    vldrw.u32 q0, [sp, #296] @ 16-byte Reload
; CHECK-NEXT:    vmov.8 q7[9], r3
; CHECK-NEXT:    vmov.8 q7[10], r4
; CHECK-NEXT:    vadd.i32 q0, q0, r0
; CHECK-NEXT:    vmov.8 q7[11], r6
...
; CHECK-NEXT:    vldrw.u32 q3, [sp, #200] @ 16-byte Reload
; CHECK-NEXT:    ldrb r6, [r6]
; CHECK-NEXT:    ldrb r5, [r5]
; CHECK-NEXT:    vmov.8 q6[10], r6
; CHECK-NEXT:    vmov.8 q6[11], r5
...
; CHECK-NEXT:    vstrw.32 q4, [sp, #232] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q4, [sp, #152] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q1, [sp, #296] @ 16-byte Spill
; CHECK-NEXT:    vldrw.u32 q1, [sp, #136] @ 16-byte Reload
; CHECK-NEXT:    vstrw.32 q3, [sp, #200] @ 16-byte Spill
...
; CHECK-NEXT:    vmov r9, r10, d2
; CHECK-NEXT:    vadd.i32 q1, q7, lr
; CHECK-NEXT:    vmov r5, r8, d5
; CHECK-NEXT:    subs r4, #16
; CHECK-NEXT:    vadd.i32 q4, q4, lr
; CHECK-NEXT:    vadd.i32 q5, q5, lr
; CHECK-NEXT:    ldrb.w r11, [r6]
; CHECK-NEXT:    ldrb.w r6, [r9]
; CHECK-NEXT:    ldrb.w r9, [r10]
; CHECK-NEXT:    vmov r10, r12, d4
; CHECK-NEXT:    vadd.i32 q2, q7, r0
; CHECK-NEXT:    vadd.i32 q7, q0, r0
; CHECK-NEXT:    ldrb r5, [r5]
; CHECK-NEXT:    ldrb.w r8, [r8]
; CHECK-NEXT:    ldrb r7, [r7]
; CHECK-NEXT:    ldrb.w r2, [r10]
; CHECK-NEXT:    ldrb.w r1, [r12]
; CHECK-NEXT:    vmov.8 q0[0], r2
; CHECK-NEXT:    vmov r10, r2, d15
; CHECK-NEXT:    vmov.8 q0[1], r1
; CHECK-NEXT:    vmov.8 q0[2], r5
; CHECK-NEXT:    vmov.8 q0[3], r8
; CHECK-NEXT:    vmov.8 q0[4], r6
; CHECK-NEXT:    vmov.8 q0[5], r9
; CHECK-NEXT:    vmov.8 q0[6], r7
; CHECK-NEXT:    vmov r7, r1, d14
; CHECK-NEXT:    vmov.8 q0[7], r11
; CHECK-NEXT:    vmov q7, q1
; CHECK-NEXT:    ldrb.w r12, [r2]
; CHECK-NEXT:    vmov r5, r2, d5
; CHECK-NEXT:    ldrb r7, [r7]
; CHECK-NEXT:    ldrb r1, [r1]
; CHECK-NEXT:    vmov.8 q0[8], r7
; CHECK-NEXT:    vmov.8 q0[9], r1
; CHECK-NEXT:    ldrb.w r8, [r2]
...
; CHECK-NEXT:    ldrb r6, [r6]
; CHECK-NEXT:    vmov.8 q0[10], r2
; CHECK-NEXT:    vmov.8 q0[11], r12
; CHECK-NEXT:    vmov.8 q0[12], r6
; CHECK-NEXT:    vmov.8 q0[13], r9
; CHECK-NEXT:    vmov.8 q0[14], r5
; CHECK-NEXT:    vmov.8 q0[15], r8
