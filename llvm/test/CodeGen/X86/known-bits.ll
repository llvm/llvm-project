...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx512fp16,+avx512vl,+fast-vector-fp16-div | FileCheck %s --check-prefix=AVX512FP16
...
;
; AVX512FP16-LABEL: knownbits_zext_in_reg:
; AVX512FP16:       # %bb.0: # %BB
; AVX512FP16-NEXT:    xorl %eax, %eax
; AVX512FP16-NEXT:    .p2align 4
; AVX512FP16-NEXT:  .LBB0_1: # %CF237
; AVX512FP16-NEXT:    # =>This Inner Loop Header: Depth=1
; AVX512FP16-NEXT:    testb %al, %al
; AVX512FP16-NEXT:    jne .LBB0_1
; AVX512FP16-NEXT:    jmp .LBB0_1
BB:
  %L5 = load i8, ptr %0
