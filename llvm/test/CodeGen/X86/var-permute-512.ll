...
; AVX512BW-NEXT:    vextracti128 $1, %ymm4, %xmm1
; AVX512BW-NEXT:    andl $63, %eax
; AVX512BW-NEXT:    vpinsrb $3, (%rsp,%rax), %xmm0, %xmm0
...
; AVX512VBMI-NEXT:    vpbroadcastd %esi, %zmm2
; AVX512VBMI-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm1
; AVX512VBMI-NEXT:    vmovd %xmm1, %eax
...
; AVX512VBMI-NEXT:    vpextrd $1, %xmm1, %eax
; AVX512VBMI-NEXT:    andl $63, %eax
; AVX512VBMI-NEXT:    vpinsrb $1, (%rsp,%rax), %xmm3, %xmm3
; AVX512VBMI-NEXT:    vpextrd $2, %xmm1, %eax
; AVX512VBMI-NEXT:    andl $63, %eax
; AVX512VBMI-NEXT:    vpinsrb $2, (%rsp,%rax), %xmm3, %xmm3
; AVX512VBMI-NEXT:    vpextrd $3, %xmm1, %eax
; AVX512VBMI-NEXT:    vextracti128 $1, %ymm1, %xmm4
; AVX512VBMI-NEXT:    andl $63, %eax
...
; AVX512VBMI-NEXT:    vextracti32x4 $2, %zmm1, %xmm4
; AVX512VBMI-NEXT:    andl $63, %eax
...
; AVX512VBMI-NEXT:    vpextrd $3, %xmm1, %eax
; AVX512VBMI-NEXT:    andl $63, %eax
; AVX512VBMI-NEXT:    vpinsrb $15, (%rsp,%rax), %xmm3, %xmm1
; AVX512VBMI-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm3
; AVX512VBMI-NEXT:    vpmovdb %zmm3, %xmm3
; AVX512VBMI-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm4
; AVX512VBMI-NEXT:    vpmovdb %zmm4, %xmm4
; AVX512VBMI-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm2, %zmm2
; AVX512VBMI-NEXT:    vpmovdb %zmm2, %xmm2
; AVX512VBMI-NEXT:    vpmovsxbd %xmm1, %zmm1
; AVX512VBMI-NEXT:    vcvtdq2ps %zmm1, %zmm1
; AVX512VBMI-NEXT:    vpermb %zmm0, %zmm2, %zmm2
...
; AVX512VBMI-NEXT:    vmovaps %zmm2, (%rdi)
; AVX512VBMI-NEXT:    vmovaps %zmm1, 192(%rdi)
