...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan i1 %cmp1, float %x2, float %t0
  %cmp2 = fcmp olt float %x3, %sel1
  %sel2 = select nsz nnan i1 %cmp2, float %x3, float %sel1
  ret float %sel2
}
...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan i1 %cmp1, double %x2, double %t0
  %cmp2 = fcmp olt double %x3, %sel1
  %sel2 = select nsz nnan i1 %cmp2, double %x3, double %sel1
  ret double %sel2
}
...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan <4 x i1> %cmp1, <4 x float> %x2, <4 x float> %t0
  %cmp2 = fcmp olt <4 x float> %x3, %sel1
  %sel2 = select nsz nnan <4 x i1> %cmp2, <4 x float> %x3, <4 x float> %sel1
  ret <4 x float> %sel2
}
...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan <2 x i1> %cmp1, <2 x double> %x2, <2 x double> %t0
  %cmp2 = fcmp olt <2 x double> %x3, %sel1
  %sel2 = select nsz nnan <2 x i1> %cmp2, <2 x double> %x3, <2 x double> %sel1
  ret <2 x double> %sel2
}
...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan <8 x i1> %cmp1, <8 x float> %x2, <8 x float> %t0
  %cmp2 = fcmp olt <8 x float> %x3, %sel1
  %sel2 = select nsz nnan <8 x i1> %cmp2, <8 x float> %x3, <8 x float> %sel1
  ret <8 x float> %sel2
}
...
; AVX-NEXT:    retq
  ...
  %sel1 = select nsz nnan <4 x i1> %cmp1, <4 x double> %x2, <4 x double> %t0
  %cmp2 = fcmp olt <4 x double> %x3, %sel1
  %sel2 = select nsz nnan <4 x i1> %cmp2, <4 x double> %x3, <4 x double> %sel1
  ret <4 x double> %sel2
}
...
; AVX512-NEXT:    retq
  ...
  %sel1 = select nsz nnan <16 x i1> %cmp1, <16 x float> %x2, <16 x float> %t0
  %cmp2 = fcmp olt <16 x float> %x3, %sel1
  %sel2 = select nsz nnan <16 x i1> %cmp2, <16 x float> %x3, <16 x float> %sel1
  ret <16 x float> %sel2
}
...
; AVX512-NEXT:    retq
  ...
  %sel1 = select nsz nnan <8 x i1> %cmp1, <8 x double> %x2, <8 x double> %t0
  %cmp2 = fcmp olt <8 x double> %x3, %sel1
  %sel2 = select nsz nnan <8 x i1> %cmp2, <8 x double> %x3, <8 x double> %sel1
  ret <8 x double> %sel2
}
