...
define fastcc void @l186(ptr %r1) nounwind {
entry:
  %r2 = load i32, ptr %r1
  %ptr3 = getelementptr %tupl, ptr %r1, i32 0, i32 1
  %r3 = load i32, ptr %ptr3
  %ptr5 = getelementptr %tupl, ptr %r1, i32 0, i32 2
  %r4 = load i32, ptr %ptr5
  %ptr7 = getelementptr %tupl, ptr %r1, i32 0, i32 3
  %r5 = load i32, ptr %ptr7
  %ptr9 = getelementptr %tupl, ptr %r1, i32 0, i32 4
  %r6 = load i32, ptr %ptr9
  %ptr11 = getelementptr %tupl, ptr %r1, i32 0, i32 5
  %r7 = load i32, ptr %ptr11
  %ptr13 = getelementptr %tupl, ptr %r1, i32 0, i32 6
  %r8 = load i32, ptr %ptr13
  %ptr15 = getelementptr %tupl, ptr %r1, i32 0, i32 7
  %r9 = load i32, ptr %ptr15
  %ptr17 = getelementptr %tupl, ptr %r1, i32 0, i32 8
  %r10 = load i32, ptr %ptr17
