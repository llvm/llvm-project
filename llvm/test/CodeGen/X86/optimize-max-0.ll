...
; CHECK-NEXT:    movzbl -2(%ecx,%edi,4), %ebx
; CHECK-NEXT:    movb %bl, (%edx,%edi)
; CHECK-NEXT:    movzbl (%ecx,%edi,4), %ebx
; CHECK-NEXT:    movb %bl, (%eax,%edi)
; CHECK-NEXT:    incl %edi
...
; CHECK-NEXT:    cmpl {{[-0-9]+}}(%e{{[sb]}}p), %ecx ## 4-byte Folded Reload
...
; CHECK-NEXT:    ## => This Inner Loop Header: Depth=2
; CHECK-NEXT:    movzbl -2(%ecx,%ebp,4), %ebx
; CHECK-NEXT:    movb %bl, (%edx,%ebp)
; CHECK-NEXT:    movzbl (%ecx,%ebp,4), %ebx
; CHECK-NEXT:    movb %bl, (%eax,%ebp)
; CHECK-NEXT:    incl %ebp
; CHECK-NEXT:    cmpl %esi, %ebp
