...
; CHECK-LABEL: v4f32:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm0 ^ (m32bcst & (xmm0 ^ xmm1))
; CHECK-NEXT:    retq
...
; CHECK-LABEL: v8f32:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpternlogd {{.*#+}} ymm0 = ymm0 ^ (m32bcst & (ymm0 ^ ymm1))
; CHECK-NEXT:    retq
...
; CHECK-LABEL: v2f64:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpternlogq {{.*#+}} xmm0 = xmm0 ^ (m64bcst & (xmm0 ^ xmm1))
; CHECK-NEXT:    retq
...
; CHECK-LABEL: v4f64:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm0 ^ (m64bcst & (ymm0 ^ ymm1))
; CHECK-NEXT:    retq
...
; CHECK-LABEL: v8f64:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 ^ (m64bcst & (zmm0 ^ zmm1))
; CHECK-NEXT:    retq
