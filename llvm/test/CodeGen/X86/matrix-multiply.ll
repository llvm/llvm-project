...
; SSE-NEXT:    mulsd %xmm11, %xmm7
; SSE-NEXT:    unpcklpd {{.*#+}} xmm11 = xmm11[0,0]
; SSE-NEXT:    mulpd %xmm0, %xmm11
; SSE-NEXT:    movapd %xmm5, %xmm12
; SSE-NEXT:    mulsd %xmm10, %xmm12
...
; SSE-NEXT:    addsd %xmm7, %xmm12
; SSE-NEXT:    addsd %xmm11, %xmm12
; SSE-NEXT:    movsd {{.*#+}} xmm7 = mem[0],zero
; SSE-NEXT:    mulsd %xmm7, %xmm2
; SSE-NEXT:    unpcklpd {{.*#+}} xmm7 = xmm7[0,0]
...
; AVX2-NEXT:    retq
;
; AVX512-LABEL: test_mul3x3_f64:
; AVX512:       # %bb.0: # %entry
; AVX512-NEXT:    movq %rdi, %rax
; AVX512-NEXT:    vmovsd {{.*#+}} xmm8 = mem[0],zero
; AVX512-NEXT:    vunpcklpd {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; AVX512-NEXT:    vmovddup {{.*#+}} xmm1 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm1, %xmm0, %xmm9
; AVX512-NEXT:    vunpcklpd {{.*#+}} xmm3 = xmm3[0],xmm4[0]
; AVX512-NEXT:    vmovddup {{.*#+}} xmm4 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm4, %xmm3, %xmm10
; AVX512-NEXT:    vaddpd %xmm10, %xmm9, %xmm9
; AVX512-NEXT:    vunpcklpd {{.*#+}} xmm6 = xmm6[0],xmm7[0]
; AVX512-NEXT:    vmovddup {{.*#+}} xmm7 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm7, %xmm6, %xmm10
; AVX512-NEXT:    vaddpd %xmm10, %xmm9, %xmm9
; AVX512-NEXT:    vmulsd %xmm1, %xmm2, %xmm1
; AVX512-NEXT:    vmulsd %xmm4, %xmm5, %xmm4
; AVX512-NEXT:    vaddsd %xmm4, %xmm1, %xmm1
; AVX512-NEXT:    vmulsd %xmm7, %xmm8, %xmm4
; AVX512-NEXT:    vaddsd %xmm4, %xmm1, %xmm1
; AVX512-NEXT:    vinsertf128 $1, %xmm1, %ymm9, %ymm1
; AVX512-NEXT:    vmovddup {{.*#+}} xmm4 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm4, %xmm0, %xmm7
; AVX512-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm3, %xmm9, %xmm10
; AVX512-NEXT:    vaddpd %xmm7, %xmm10, %xmm7
; AVX512-NEXT:    vmovddup {{.*#+}} xmm10 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm6, %xmm10, %xmm11
; AVX512-NEXT:    vaddpd %xmm7, %xmm11, %xmm7
; AVX512-NEXT:    vmulsd %xmm4, %xmm2, %xmm4
; AVX512-NEXT:    vmulsd %xmm5, %xmm9, %xmm9
; AVX512-NEXT:    vaddsd %xmm4, %xmm9, %xmm4
; AVX512-NEXT:    vmulsd %xmm10, %xmm8, %xmm9
; AVX512-NEXT:    vaddsd %xmm4, %xmm9, %xmm4
; AVX512-NEXT:    vinsertf128 $1, %xmm4, %ymm7, %ymm4
; AVX512-NEXT:    vmovddup {{.*#+}} xmm7 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm7, %xmm0, %xmm0
; AVX512-NEXT:    vmovddup {{.*#+}} xmm9 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm3, %xmm9, %xmm3
; AVX512-NEXT:    vaddpd %xmm3, %xmm0, %xmm0
; AVX512-NEXT:    vmovddup {{.*#+}} xmm3 = mem[0,0]
; AVX512-NEXT:    vmulpd %xmm3, %xmm6, %xmm6
; AVX512-NEXT:    vaddpd %xmm6, %xmm0, %xmm0
; AVX512-NEXT:    vmulsd %xmm7, %xmm2, %xmm2
; AVX512-NEXT:    vmulsd %xmm5, %xmm9, %xmm5
; AVX512-NEXT:    vaddsd %xmm5, %xmm2, %xmm2
; AVX512-NEXT:    vmulsd %xmm3, %xmm8, %xmm3
; AVX512-NEXT:    vaddsd %xmm3, %xmm2, %xmm2
; AVX512-NEXT:    vinsertf64x4 $1, %ymm4, %zmm1, %zmm1
; AVX512-NEXT:    vmovapd {{.*#+}} zmm3 = [0,1,2,4,5,6,8,9]
; AVX512-NEXT:    vpermi2pd %zmm0, %zmm1, %zmm3
; AVX512-NEXT:    vmovsd %xmm2, 64(%rdi)
; AVX512-NEXT:    vmovapd %zmm3, (%rdi)
...
; SSE-NEXT:    addps %xmm4, %xmm5
; SSE-NEXT:    movaps %xmm6, %xmm4
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[2,2],xmm6[2,2]
...
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,0],xmm7[0,0]
...
; SSE-NEXT:    mulps %xmm15, %xmm11
; SSE-NEXT:    mulps %xmm0, %xmm15
; SSE-NEXT:    movaps %xmm14, %xmm3
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[1,1],xmm14[1,1]
; SSE-NEXT:    movaps %xmm12, %xmm13
; SSE-NEXT:    mulps %xmm3, %xmm13
...
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    mulps %xmm11, %xmm3
; SSE-NEXT:    addps %xmm1, %xmm3
; SSE-NEXT:    movaps %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    mulps %xmm9, %xmm11
...
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,0],xmm9[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulps %xmm1, %xmm2
; SSE-NEXT:    addps %xmm0, %xmm2
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
...
; SSE-NEXT:    addps %xmm2, %xmm0
; SSE-NEXT:    movaps %xmm9, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,2],xmm9[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulps %xmm1, %xmm2
; SSE-NEXT:    addps %xmm0, %xmm2
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm1
...
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,0],xmm2[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; SSE-NEXT:    mulps %xmm1, %xmm14
; SSE-NEXT:    addps %xmm0, %xmm14
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    addps %xmm6, %xmm1
...
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulps %xmm1, %xmm0
; SSE-NEXT:    addps %xmm14, %xmm0
; SSE-NEXT:    movaps %xmm2, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,2],xmm2[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; SSE-NEXT:    mulps %xmm1, %xmm14
; SSE-NEXT:    addps %xmm0, %xmm14
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm1
...
; SSE-NEXT:    mulps %xmm15, %xmm8
; SSE-NEXT:    addps %xmm14, %xmm8
; SSE-NEXT:    movaps %xmm10, %xmm7
; SSE-NEXT:    mulps %xmm10, %xmm1
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE-NEXT:    mulps %xmm3, %xmm15
; SSE-NEXT:    addps %xmm1, %xmm15
; SSE-NEXT:    movaps %xmm0, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,2],xmm0[2,2]
; SSE-NEXT:    movaps %xmm4, %xmm14
; SSE-NEXT:    mulps %xmm1, %xmm14
; SSE-NEXT:    addps %xmm15, %xmm14
...
; SSE-NEXT:    movaps %xmm1, %xmm14
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[2,2],xmm1[2,2]
...
; SSE-NEXT:    addps %xmm14, %xmm15
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulps %xmm0, %xmm1
; SSE-NEXT:    addps %xmm13, %xmm1
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    movaps %xmm8, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,0],xmm8[0,0]
; SSE-NEXT:    mulps %xmm0, %xmm11
; SSE-NEXT:    movaps %xmm8, %xmm14
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[1,1],xmm8[1,1]
; SSE-NEXT:    movaps %xmm12, %xmm10
; SSE-NEXT:    mulps %xmm14, %xmm10
; SSE-NEXT:    addps %xmm11, %xmm10
...
; SSE-NEXT:    addps %xmm0, %xmm14
; SSE-NEXT:    movaps %xmm8, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,2],xmm8[2,2]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE-NEXT:    movaps %xmm3, %xmm13
; SSE-NEXT:    mulps %xmm0, %xmm13
; SSE-NEXT:    addps %xmm14, %xmm13
; SSE-NEXT:    mulps %xmm4, %xmm0
; SSE-NEXT:    addps %xmm10, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[3,3,3,3]
; SSE-NEXT:    movaps %xmm5, %xmm10
; SSE-NEXT:    mulps %xmm8, %xmm10
; SSE-NEXT:    addps %xmm0, %xmm10
; SSE-NEXT:    mulps %xmm6, %xmm8
; SSE-NEXT:    addps %xmm13, %xmm8
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    movaps %xmm0, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,0],xmm0[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; SSE-NEXT:    mulps %xmm13, %xmm14
; SSE-NEXT:    addps %xmm8, %xmm14
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm7
; SSE-NEXT:    mulps %xmm7, %xmm13
; SSE-NEXT:    addps %xmm10, %xmm13
; SSE-NEXT:    movaps %xmm0, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,1],xmm0[1,1]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm10
; SSE-NEXT:    mulps %xmm8, %xmm10
; SSE-NEXT:    addps %xmm13, %xmm10
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    addps %xmm14, %xmm8
; SSE-NEXT:    movaps %xmm0, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[2,2],xmm0[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm7
; SSE-NEXT:    mulps %xmm13, %xmm7
; SSE-NEXT:    addps %xmm8, %xmm7
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm8
...
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; SSE-NEXT:    mulps %xmm0, %xmm14
; SSE-NEXT:    addps %xmm13, %xmm14
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    mulps %xmm8, %xmm0
; SSE-NEXT:    addps %xmm7, %xmm0
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm7
; SSE-NEXT:    movaps %xmm7, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[0,0],xmm7[0,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; SSE-NEXT:    mulps %xmm8, %xmm13
; SSE-NEXT:    mulps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    movaps %xmm7, %xmm10
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[1,1],xmm7[1,1]
; SSE-NEXT:    mulps %xmm10, %xmm12
; SSE-NEXT:    addps %xmm13, %xmm12
; SSE-NEXT:    mulps %xmm11, %xmm10
; SSE-NEXT:    addps %xmm8, %xmm10
; SSE-NEXT:    movaps %xmm7, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[2,2],xmm7[2,2]
; SSE-NEXT:    mulps %xmm8, %xmm3
; SSE-NEXT:    addps %xmm10, %xmm3
; SSE-NEXT:    mulps %xmm4, %xmm8
; SSE-NEXT:    addps %xmm12, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[3,3,3,3]
; SSE-NEXT:    mulps %xmm7, %xmm5
; SSE-NEXT:    addps %xmm8, %xmm5
; SSE-NEXT:    mulps %xmm6, %xmm7
; SSE-NEXT:    addps %xmm3, %xmm7
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    movaps %xmm8, %xmm10
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,0],xmm8[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulps %xmm10, %xmm13
; SSE-NEXT:    addps %xmm7, %xmm13
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm10
; SSE-NEXT:    addps %xmm5, %xmm10
; SSE-NEXT:    movaps %xmm8, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,1],xmm8[1,1]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm12
; SSE-NEXT:    mulps %xmm7, %xmm12
; SSE-NEXT:    addps %xmm10, %xmm12
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm7
; SSE-NEXT:    addps %xmm13, %xmm7
; SSE-NEXT:    movaps %xmm8, %xmm10
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[2,2],xmm8[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    mulps %xmm10, %xmm3
; SSE-NEXT:    addps %xmm7, %xmm3
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm10
; SSE-NEXT:    addps %xmm12, %xmm10
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[3,3,3,3]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm4
; SSE-NEXT:    mulps %xmm8, %xmm4
; SSE-NEXT:    addps %xmm10, %xmm4
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    addps %xmm3, %xmm8
; SSE-NEXT:    movaps %xmm4, 240(%rdi)
; SSE-NEXT:    movaps %xmm8, 224(%rdi)
; SSE-NEXT:    movaps %xmm14, 208(%rdi)
; SSE-NEXT:    movaps %xmm0, 192(%rdi)
; SSE-NEXT:    movaps %xmm15, 176(%rdi)
; SSE-NEXT:    movaps %xmm1, 160(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 144(%rdi)
; SSE-NEXT:    movaps %xmm2, 128(%rdi)
; SSE-NEXT:    movaps (%rsp), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 112(%rdi)
; SSE-NEXT:    movaps %xmm9, 96(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX512F-NEXT:    vaddps %ymm14, %ymm13, %ymm12
; AVX512F-NEXT:    vmovups %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-NEXT:    vmovshdup {{.*#+}} xmm13 = xmm15[1,1,3,3]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm13, %ymm11, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} xmm13 = xmm15[2,2,2,2]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm1, %ymm13, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} xmm13 = xmm15[3,3,3,3]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm13, %ymm10, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
...
; AVX512F-NEXT:    vaddps %ymm6, %ymm12, %ymm6
; AVX512F-NEXT:    vmovshdup {{.*#+}} ymm12 = ymm15[1,1,3,3,5,5,7,7]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm12, %ymm9, %ymm12
; AVX512F-NEXT:    vaddps %ymm6, %ymm12, %ymm6
; AVX512F-NEXT:    vshufps {{.*#+}} ymm12 = ymm15[2,2,2,2,6,6,6,6]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm3, %ymm12, %ymm12
; AVX512F-NEXT:    vaddps %ymm6, %ymm12, %ymm6
; AVX512F-NEXT:    vshufps {{.*#+}} ymm12 = ymm15[3,3,3,3,7,7,7,7]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm12, %ymm8, %ymm12
; AVX512F-NEXT:    vaddps %ymm6, %ymm12, %ymm6
; AVX512F-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm12 # 64-byte Reload
; AVX512F-NEXT:    vinsertf64x4 $1, %ymm4, %zmm12, %zmm4
; AVX512F-NEXT:    vbroadcastss %xmm7, %ymm12
; AVX512F-NEXT:    vmulps %ymm0, %ymm12, %ymm12
; AVX512F-NEXT:    vmovshdup {{.*#+}} xmm13 = xmm7[1,1,3,3]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm13, %ymm11, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} xmm13 = xmm7[2,2,2,2]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm1, %ymm13, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} xmm13 = xmm7[3,3,3,3]
; AVX512F-NEXT:    vbroadcastsd %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm13, %ymm10, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vextractf128 $1, %ymm7, %xmm13
; AVX512F-NEXT:    vbroadcastss %xmm13, %ymm13
; AVX512F-NEXT:    vmulps %ymm2, %ymm13, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vmovshdup {{.*#+}} ymm13 = ymm7[1,1,3,3,5,5,7,7]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm13, %ymm9, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} ymm13 = ymm7[2,2,2,2,6,6,6,6]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm3, %ymm13, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
; AVX512F-NEXT:    vshufps {{.*#+}} ymm13 = ymm7[3,3,3,3,7,7,7,7]
; AVX512F-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,2]
; AVX512F-NEXT:    vmulps %ymm13, %ymm8, %ymm13
; AVX512F-NEXT:    vaddps %ymm13, %ymm12, %ymm12
...
; SSE-NEXT:    mulpd %xmm15, %xmm7
; SSE-NEXT:    addpd %xmm8, %xmm7
; SSE-NEXT:    mulpd %xmm4, %xmm15
; SSE-NEXT:    addpd %xmm12, %xmm15
; SSE-NEXT:    movapd %xmm14, %xmm2
; SSE-NEXT:    unpcklpd {{.*#+}} xmm2 = xmm2[0],xmm14[0]
; SSE-NEXT:    movapd %xmm9, %xmm5
; SSE-NEXT:    mulpd %xmm2, %xmm5
; SSE-NEXT:    addpd %xmm15, %xmm5
...
; SSE-NEXT:    movapd %xmm14, %xmm2
; SSE-NEXT:    mulpd %xmm1, %xmm2
; SSE-NEXT:    movapd %xmm12, %xmm4
; SSE-NEXT:    movapd %xmm12, %xmm6
; SSE-NEXT:    mulpd %xmm0, %xmm6
; SSE-NEXT:    addpd %xmm2, %xmm6
; SSE-NEXT:    movapd %xmm9, %xmm2
; SSE-NEXT:    movapd %xmm9, %xmm12
; SSE-NEXT:    mulpd %xmm1, %xmm2
...
; SSE-NEXT:    unpcklpd {{.*#+}} xmm2 = xmm2[0],xmm1[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    mulpd %xmm2, %xmm9
; SSE-NEXT:    addpd %xmm0, %xmm9
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm2, %xmm0
; SSE-NEXT:    addpd %xmm8, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm8
...
; SSE-NEXT:    addpd %xmm8, %xmm10
; SSE-NEXT:    mulpd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    addpd %xmm5, %xmm1
; SSE-NEXT:    unpckhpd {{.*#+}} xmm15 = xmm15[1,1]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulpd %xmm15, %xmm2
; SSE-NEXT:    addpd %xmm1, %xmm2
; SSE-NEXT:    movapd %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
...
; SSE-NEXT:    mulpd %xmm1, %xmm8
; SSE-NEXT:    unpckhpd {{.*#+}} xmm0 = xmm0[1,1]
; SSE-NEXT:    movapd %xmm3, %xmm9
; SSE-NEXT:    mulpd %xmm0, %xmm9
; SSE-NEXT:    addpd %xmm8, %xmm9
; SSE-NEXT:    movapd %xmm14, %xmm2
; SSE-NEXT:    movapd %xmm14, %xmm8
; SSE-NEXT:    mulpd %xmm1, %xmm8
; SSE-NEXT:    movapd %xmm4, %xmm10
...
; SSE-NEXT:    movapd %xmm7, %xmm12
; SSE-NEXT:    mulpd %xmm0, %xmm12
; SSE-NEXT:    addpd %xmm8, %xmm12
; SSE-NEXT:    mulpd %xmm11, %xmm1
; SSE-NEXT:    movapd %xmm13, %xmm7
; SSE-NEXT:    mulpd %xmm13, %xmm0
; SSE-NEXT:    addpd %xmm1, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    movapd %xmm1, %xmm8
; SSE-NEXT:    unpcklpd {{.*#+}} xmm8 = xmm8[0],xmm1[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulpd %xmm8, %xmm13
; SSE-NEXT:    addpd %xmm0, %xmm13
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm8, %xmm0
; SSE-NEXT:    addpd %xmm12, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm12
; SSE-NEXT:    mulpd %xmm8, %xmm12
; SSE-NEXT:    addpd %xmm10, %xmm12
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm4
...
; SSE-NEXT:    unpcklpd {{.*#+}} xmm12 = xmm12[0],xmm0[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulpd %xmm12, %xmm13
; SSE-NEXT:    addpd %xmm1, %xmm13
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
...
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm10
; SSE-NEXT:    mulpd %xmm11, %xmm10
; SSE-NEXT:    addpd %xmm14, %xmm10
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    mulpd %xmm11, %xmm9
; SSE-NEXT:    addpd %xmm0, %xmm9
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm0, %xmm11
; SSE-NEXT:    addpd %xmm13, %xmm11
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    movapd %xmm0, %xmm12
; SSE-NEXT:    unpcklpd {{.*#+}} xmm12 = xmm12[0],xmm0[0]
; SSE-NEXT:    mulpd %xmm12, %xmm5
; SSE-NEXT:    unpckhpd {{.*#+}} xmm0 = xmm0[1,1]
...
; SSE-NEXT:    unpcklpd {{.*#+}} xmm13 = xmm13[0],xmm12[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    mulpd %xmm13, %xmm3
; SSE-NEXT:    addpd %xmm0, %xmm3
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm13, %xmm0
; SSE-NEXT:    addpd %xmm1, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulpd %xmm13, %xmm1
; SSE-NEXT:    addpd %xmm2, %xmm1
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm2
...
; SSE-NEXT:    mulpd {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Folded Reload
; SSE-NEXT:    addpd %xmm3, %xmm1
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    movapd %xmm3, %xmm14
; SSE-NEXT:    unpcklpd {{.*#+}} xmm14 = xmm14[0],xmm3[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    mulpd %xmm14, %xmm6
; SSE-NEXT:    addpd %xmm1, %xmm6
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm4
; SSE-NEXT:    mulpd %xmm14, %xmm4
; SSE-NEXT:    addpd %xmm2, %xmm4
...
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    movapd %xmm1, %xmm14
; SSE-NEXT:    unpcklpd {{.*#+}} xmm14 = xmm14[0],xmm1[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulpd %xmm14, %xmm2
; SSE-NEXT:    addpd %xmm3, %xmm2
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm3
...
; SSE-NEXT:    mulpd {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    addpd %xmm2, %xmm3
; SSE-NEXT:    movapd %xmm4, 496(%rdi)
; SSE-NEXT:    movapd %xmm5, 480(%rdi)
; SSE-NEXT:    movapd %xmm6, 464(%rdi)
; SSE-NEXT:    movapd %xmm3, 448(%rdi)
; SSE-NEXT:    movapd %xmm7, 432(%rdi)
; SSE-NEXT:    movapd %xmm13, 416(%rdi)
; SSE-NEXT:    movapd %xmm12, 400(%rdi)
; SSE-NEXT:    movapd %xmm0, 384(%rdi)
; SSE-NEXT:    movaps (%rsp), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 368(%rdi)
; SSE-NEXT:    movapd %xmm10, 352(%rdi)
; SSE-NEXT:    movapd %xmm9, 336(%rdi)
; SSE-NEXT:    movapd %xmm11, 320(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 336(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm13, %ymm5
; AVX1-NEXT:    vmovapd %ymm13, %ymm0
...
; AVX1-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX1-NEXT:    vmovapd 80(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
; AVX1-NEXT:    vbroadcastsd 384(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm10, %ymm15, %ymm11
; AVX1-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX1-NEXT:    vmovapd 176(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
...
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmovapd 208(%rbp), %ymm15
; AVX1-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 464(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
; AVX1-NEXT:    vmovapd %ymm1, %ymm13
; AVX1-NEXT:    vbroadcastsd 472(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm10, %ymm9, %ymm11
; AVX1-NEXT:    vmovapd %ymm9, %ymm14
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX1-NEXT:    vmulpd %ymm2, %ymm8, %ymm2
; AVX1-NEXT:    vmovapd %ymm8, %ymm9
; AVX1-NEXT:    vmovapd %ymm6, %ymm8
; AVX1-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
...
; AVX1-NEXT:    vmovapd 240(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm4
; AVX1-NEXT:    vmovapd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm1
; AVX1-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 528(%rbp), %ymm2
; AVX1-NEXT:    vmovapd %ymm13, %ymm1
; AVX1-NEXT:    vmulpd %ymm2, %ymm13, %ymm5
; AVX1-NEXT:    vbroadcastsd 536(%rbp), %ymm10
; AVX1-NEXT:    vmovapd %ymm14, %ymm4
; AVX1-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX1-NEXT:    vmovapd %ymm9, %ymm3
...
; AVX1-NEXT:    vmovapd %ymm0, %ymm8
; AVX1-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX1-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
...
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 592(%rbp), %ymm2
; AVX1-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
...
; AVX1-NEXT:    vmulpd %ymm7, %ymm10, %ymm11
; AVX1-NEXT:    vmovapd %ymm7, %ymm12
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX1-NEXT:    vmovapd %ymm13, %ymm7
; AVX1-NEXT:    vmulpd %ymm10, %ymm13, %ymm10
; AVX1-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
; AVX1-NEXT:    vbroadcastsd 624(%rbp), %ymm10
; AVX1-NEXT:    vmovapd 16(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX1-NEXT:    vmovapd 48(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
; AVX1-NEXT:    vbroadcastsd 632(%rbp), %ymm10
; AVX1-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX1-NEXT:    vmovapd 80(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm10, %ymm10
; AVX1-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
...
; AVX1-NEXT:    vmovapd 240(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX1-NEXT:    vaddpd %ymm5, %ymm11, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
...
; AVX1-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
; AVX1-NEXT:    vmovapd %ymm1, %ymm15
; AVX1-NEXT:    vbroadcastsd 664(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm4, %ymm14
; AVX1-NEXT:    vaddpd %ymm5, %ymm14, %ymm5
; AVX1-NEXT:    vmulpd %ymm2, %ymm3, %ymm2
; AVX1-NEXT:    vmulpd %ymm0, %ymm9, %ymm0
; AVX1-NEXT:    vmovapd %ymm9, %ymm11
...
; AVX1-NEXT:    vmovapd %ymm6, %ymm9
; AVX1-NEXT:    vmulpd %ymm2, %ymm6, %ymm2
; AVX1-NEXT:    vaddpd %ymm2, %ymm5, %ymm2
; AVX1-NEXT:    vbroadcastsd 680(%rbp), %ymm5
; AVX1-NEXT:    vmovapd %ymm12, %ymm10
; AVX1-NEXT:    vmulpd %ymm5, %ymm12, %ymm14
; AVX1-NEXT:    vaddpd %ymm2, %ymm14, %ymm2
; AVX1-NEXT:    vmulpd %ymm5, %ymm7, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm0, %ymm0
; AVX1-NEXT:    vbroadcastsd 688(%rbp), %ymm5
; AVX1-NEXT:    vmulpd 16(%rbp), %ymm5, %ymm14
; AVX1-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1-NEXT:    vmulpd 48(%rbp), %ymm5, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
; AVX1-NEXT:    vbroadcastsd 696(%rbp), %ymm5
; AVX1-NEXT:    vmovapd 112(%rbp), %ymm6
; AVX1-NEXT:    vmulpd %ymm5, %ymm6, %ymm14
; AVX1-NEXT:    vaddpd %ymm2, %ymm14, %ymm2
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm5, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm0, %ymm0
; AVX1-NEXT:    vbroadcastsd 704(%rbp), %ymm5
; AVX1-NEXT:    vmovapd 144(%rbp), %ymm12
; AVX1-NEXT:    vmulpd %ymm5, %ymm12, %ymm14
; AVX1-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1-NEXT:    vmulpd %ymm5, %ymm13, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
; AVX1-NEXT:    vbroadcastsd 712(%rbp), %ymm14
; AVX1-NEXT:    vmovapd 240(%rbp), %ymm13
; AVX1-NEXT:    vmulpd %ymm14, %ymm13, %ymm5
; AVX1-NEXT:    vaddpd %ymm5, %ymm2, %ymm5
; AVX1-NEXT:    vmovapd 208(%rbp), %ymm1
; AVX1-NEXT:    vmulpd %ymm1, %ymm14, %ymm2
; AVX1-NEXT:    vmovapd %ymm1, %ymm14
; AVX1-NEXT:    vaddpd %ymm2, %ymm0, %ymm2
; AVX1-NEXT:    vbroadcastsd 720(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm15, %ymm1
; AVX1-NEXT:    vmulpd %ymm0, %ymm3, %ymm0
; AVX1-NEXT:    vbroadcastsd 728(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm4, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX1-NEXT:    vmulpd %ymm3, %ymm11, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX1-NEXT:    vbroadcastsd 736(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm8, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd %ymm3, %ymm9, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastsd 744(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm10, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX1-NEXT:    vmulpd %ymm3, %ymm7, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX1-NEXT:    vbroadcastsd 752(%rbp), %ymm3
; AVX1-NEXT:    vmulpd 16(%rbp), %ymm3, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd 48(%rbp), %ymm3, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastsd 760(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm6, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX1-NEXT:    vmulpd 80(%rbp), %ymm3, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX1-NEXT:    vbroadcastsd 768(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm12, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX1-NEXT:    vmulpd 176(%rbp), %ymm3, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX1-NEXT:    vbroadcastsd 776(%rbp), %ymm3
; AVX1-NEXT:    vmulpd %ymm3, %ymm13, %ymm4
; AVX1-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX1-NEXT:    vmulpd %ymm3, %ymm14, %ymm3
; AVX1-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm1, 480(%rdi)
; AVX1-NEXT:    vmovapd %ymm0, 448(%rdi)
; AVX1-NEXT:    vmovapd %ymm5, 416(%rdi)
; AVX1-NEXT:    vmovapd %ymm2, 384(%rdi)
...
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd 208(%rbp), %ymm10, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 336(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm13, %ymm5
; AVX2-NEXT:    vmovapd %ymm13, %ymm0
...
; AVX2-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX2-NEXT:    vmovapd 80(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
; AVX2-NEXT:    vbroadcastsd 384(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm10, %ymm15, %ymm11
; AVX2-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX2-NEXT:    vmovapd 176(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
...
; AVX2-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 464(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
; AVX2-NEXT:    vmovapd %ymm1, %ymm13
; AVX2-NEXT:    vbroadcastsd 472(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm10, %ymm9, %ymm11
; AVX2-NEXT:    vmovapd %ymm9, %ymm14
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX2-NEXT:    vmulpd %ymm2, %ymm8, %ymm2
; AVX2-NEXT:    vmovapd %ymm8, %ymm9
; AVX2-NEXT:    vmovapd %ymm6, %ymm8
; AVX2-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
...
; AVX2-NEXT:    vmovapd 240(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm4
; AVX2-NEXT:    vmovapd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm1
; AVX2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 528(%rbp), %ymm2
; AVX2-NEXT:    vmovapd %ymm13, %ymm1
; AVX2-NEXT:    vmulpd %ymm2, %ymm13, %ymm5
; AVX2-NEXT:    vbroadcastsd 536(%rbp), %ymm10
; AVX2-NEXT:    vmovapd %ymm14, %ymm4
; AVX2-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX2-NEXT:    vmovapd %ymm9, %ymm3
...
; AVX2-NEXT:    vmovapd %ymm0, %ymm8
; AVX2-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX2-NEXT:    vmulpd %ymm6, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
...
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 592(%rbp), %ymm2
; AVX2-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
...
; AVX2-NEXT:    vmulpd %ymm7, %ymm10, %ymm11
; AVX2-NEXT:    vmovapd %ymm7, %ymm12
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX2-NEXT:    vmovapd %ymm13, %ymm7
; AVX2-NEXT:    vmulpd %ymm10, %ymm13, %ymm10
; AVX2-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
; AVX2-NEXT:    vbroadcastsd 624(%rbp), %ymm10
; AVX2-NEXT:    vmovapd 16(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm2, %ymm11, %ymm2
; AVX2-NEXT:    vmovapd 48(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm5, %ymm10, %ymm5
; AVX2-NEXT:    vbroadcastsd 632(%rbp), %ymm10
; AVX2-NEXT:    vmulpd %ymm10, %ymm14, %ymm11
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm5
; AVX2-NEXT:    vmovapd 80(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm10, %ymm10
; AVX2-NEXT:    vaddpd %ymm2, %ymm10, %ymm2
...
; AVX2-NEXT:    vmovapd 240(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm10, %ymm11
; AVX2-NEXT:    vaddpd %ymm5, %ymm11, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmulpd %ymm10, %ymm15, %ymm5
...
; AVX2-NEXT:    vmulpd %ymm2, %ymm1, %ymm5
; AVX2-NEXT:    vmovapd %ymm1, %ymm15
; AVX2-NEXT:    vbroadcastsd 664(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm4, %ymm14
; AVX2-NEXT:    vaddpd %ymm5, %ymm14, %ymm5
; AVX2-NEXT:    vmulpd %ymm2, %ymm3, %ymm2
; AVX2-NEXT:    vmulpd %ymm0, %ymm9, %ymm0
; AVX2-NEXT:    vmovapd %ymm9, %ymm11
...
; AVX2-NEXT:    vmovapd %ymm6, %ymm9
; AVX2-NEXT:    vmulpd %ymm2, %ymm6, %ymm2
; AVX2-NEXT:    vaddpd %ymm2, %ymm5, %ymm2
; AVX2-NEXT:    vbroadcastsd 680(%rbp), %ymm5
; AVX2-NEXT:    vmovapd %ymm12, %ymm10
; AVX2-NEXT:    vmulpd %ymm5, %ymm12, %ymm14
; AVX2-NEXT:    vaddpd %ymm2, %ymm14, %ymm2
; AVX2-NEXT:    vmulpd %ymm5, %ymm7, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm0, %ymm0
; AVX2-NEXT:    vbroadcastsd 688(%rbp), %ymm5
; AVX2-NEXT:    vmulpd 16(%rbp), %ymm5, %ymm14
; AVX2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX2-NEXT:    vmulpd 48(%rbp), %ymm5, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
; AVX2-NEXT:    vbroadcastsd 696(%rbp), %ymm5
; AVX2-NEXT:    vmovapd 112(%rbp), %ymm6
; AVX2-NEXT:    vmulpd %ymm5, %ymm6, %ymm14
; AVX2-NEXT:    vaddpd %ymm2, %ymm14, %ymm2
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm5, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm0, %ymm0
; AVX2-NEXT:    vbroadcastsd 704(%rbp), %ymm5
; AVX2-NEXT:    vmovapd 144(%rbp), %ymm12
; AVX2-NEXT:    vmulpd %ymm5, %ymm12, %ymm14
; AVX2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX2-NEXT:    vmulpd %ymm5, %ymm13, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
; AVX2-NEXT:    vbroadcastsd 712(%rbp), %ymm14
; AVX2-NEXT:    vmovapd 240(%rbp), %ymm13
; AVX2-NEXT:    vmulpd %ymm14, %ymm13, %ymm5
; AVX2-NEXT:    vaddpd %ymm5, %ymm2, %ymm5
; AVX2-NEXT:    vmovapd 208(%rbp), %ymm1
; AVX2-NEXT:    vmulpd %ymm1, %ymm14, %ymm2
; AVX2-NEXT:    vmovapd %ymm1, %ymm14
; AVX2-NEXT:    vaddpd %ymm2, %ymm0, %ymm2
; AVX2-NEXT:    vbroadcastsd 720(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm15, %ymm1
; AVX2-NEXT:    vmulpd %ymm0, %ymm3, %ymm0
; AVX2-NEXT:    vbroadcastsd 728(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm4, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX2-NEXT:    vmulpd %ymm3, %ymm11, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX2-NEXT:    vbroadcastsd 736(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm8, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd %ymm3, %ymm9, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX2-NEXT:    vbroadcastsd 744(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm10, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX2-NEXT:    vmulpd %ymm3, %ymm7, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX2-NEXT:    vbroadcastsd 752(%rbp), %ymm3
; AVX2-NEXT:    vmulpd 16(%rbp), %ymm3, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd 48(%rbp), %ymm3, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX2-NEXT:    vbroadcastsd 760(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm6, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX2-NEXT:    vmulpd 80(%rbp), %ymm3, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX2-NEXT:    vbroadcastsd 768(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm12, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm0, %ymm0
; AVX2-NEXT:    vmulpd 176(%rbp), %ymm3, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm1, %ymm1
; AVX2-NEXT:    vbroadcastsd 776(%rbp), %ymm3
; AVX2-NEXT:    vmulpd %ymm3, %ymm13, %ymm4
; AVX2-NEXT:    vaddpd %ymm4, %ymm1, %ymm1
; AVX2-NEXT:    vmulpd %ymm3, %ymm14, %ymm3
; AVX2-NEXT:    vaddpd %ymm3, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm1, 480(%rdi)
; AVX2-NEXT:    vmovapd %ymm0, 448(%rdi)
; AVX2-NEXT:    vmovapd %ymm5, 416(%rdi)
; AVX2-NEXT:    vmovapd %ymm2, 384(%rdi)
