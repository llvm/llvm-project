...
; RUN: llc < %s -denormal-fp-math=preserve-sign -mtriple=x86_64-unknown-unknown -mattr=+avx512bf16,+avx512vl | FileCheck %s --check-prefixes=CHECK,BF16
; RUN: llc < %s -denormal-fp-math=preserve-sign -mtriple=x86_64-unknown-unknown -mattr=+avx10.2 | FileCheck %s --check-prefixes=CHECK,AVX10_2
