...
; CHECK-NEXT:    movswl %si, %esi
; CHECK-NEXT:    movl %esi, %r8d
; CHECK-NEXT:    shrl $16, %r8d
; CHECK-NEXT:    shldw $1, %di, %r8w
; CHECK-NEXT:    sarl $16, %esi
; CHECK-NEXT:    cmpl $16384, %esi # imm = 0x4000
; CHECK-NEXT:    cmovgel %eax, %r8d
; CHECK-NEXT:    cmpl $-16384, %esi # imm = 0xC000
...
; CHECK-NEXT:    movzwl %di, %esi
; CHECK-NEXT:    movd %esi, %xmm1
; CHECK-NEXT:    pinsrw $1, %r8d, %xmm1
