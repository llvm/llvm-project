...
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -relocation-model=static -mcpu=x86-64    | FileCheck %s --check-prefixes=SSE2
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -relocation-model=static -mcpu=x86-64-v2 | FileCheck %s --check-prefixes=SSE42
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -relocation-model=static -mcpu=x86-64-v3 | FileCheck %s --check-prefixes=AVX2
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -relocation-model=static -mcpu=x86-64-v4 | FileCheck %s --check-prefixes=AVX512BW
