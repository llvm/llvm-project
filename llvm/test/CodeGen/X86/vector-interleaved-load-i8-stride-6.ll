...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm8[2,1,2,3,4,5,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,2],xmm3[0,3]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm4[0,3,2,1]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm4[0,1,2,3,7,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm6[3,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm13[0,1,0,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,5,7,6,4]
...
; SSE-NEXT:    punpcklwd {{.*#+}} xmm4 = xmm4[0],xmm1[0],xmm4[1],xmm1[1],xmm4[2],xmm1[2],xmm4[3],xmm1[3]
; SSE-NEXT:    psrld $16, %xmm1
; SSE-NEXT:    pshufd {{.*#+}} xmm8 = xmm15[0,1,0,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,5,7,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm12[2,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,5,4,7]
; SSE-NEXT:    pand %xmm11, %xmm2
; SSE-NEXT:    movdqa %xmm11, %xmm8
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,3,2,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,5,6,7,4]
; SSE-NEXT:    packuswb %xmm0, %xmm0
; SSE-NEXT:    movdqa {{.*#+}} xmm8 = [255,255,255,255,255,255,255,255,255,255,255,0,0,0,0,0]
; SSE-NEXT:    movdqa %xmm8, %xmm2
; SSE-NEXT:    pandn %xmm0, %xmm2
; SSE-NEXT:    pand %xmm8, %xmm3
; SSE-NEXT:    por %xmm3, %xmm2
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm10[0,2,0,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,5,7,7]
; SSE-NEXT:    pand %xmm4, %xmm0
; SSE-NEXT:    por %xmm2, %xmm0
; SSE-NEXT:    packuswb %xmm0, %xmm0
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[0,2,1,3]
; SSE-NEXT:    movdqa %xmm0, %xmm2
; SSE-NEXT:    pand %xmm10, %xmm7
...
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[1,0],xmm8[0,0]
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[2,0],xmm8[2,3]
...
; AVX2-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm9
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm9
...
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm9
