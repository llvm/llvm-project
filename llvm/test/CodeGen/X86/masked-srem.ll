...
; AVX512-NEXT:    vpabsq %zmm0, %zmm3
; AVX512-NEXT:    vcvtuqq2pd {rd-sae}, %zmm3, %zmm4
; AVX512-NEXT:    vmulpd {rd-sae}, %zmm1, %zmm4, %zmm4
; AVX512-NEXT:    vcvtpd2uqq {rd-sae}, %zmm4, %zmm4
; AVX512-NEXT:    vpmullq %zmm2, %zmm4, %zmm4
; AVX512-NEXT:    vpsubq %zmm4, %zmm3, %zmm3
; AVX512-NEXT:    vcvtuqq2pd {rd-sae}, %zmm3, %zmm4
; AVX512-NEXT:    vmulpd {rd-sae}, %zmm1, %zmm4, %zmm1
; AVX512-NEXT:    vcvtpd2uqq {rd-sae}, %zmm1, %zmm1
; AVX512-NEXT:    vpmullq %zmm2, %zmm1, %zmm1
; AVX512-NEXT:    vpsubq %zmm1, %zmm3, %zmm1
; AVX512-NEXT:    vpcmpnltuq %zmm2, %zmm1, %k1
; AVX512-NEXT:    vpsubq %zmm2, %zmm1, %zmm1 {%k1}
; AVX512-NEXT:    vpmovq2m %zmm0, %k1
; AVX512-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vpsubq %zmm1, %zmm0, %zmm1 {%k1}
