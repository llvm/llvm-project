...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm5 = ymm1[0],ymm0[1,2,3,4,5,6,7],ymm1[8],ymm0[9,10,11,12,13,14,15]
; AVX2-NEXT:    vextracti128 $1, %ymm5, %xmm6
; AVX2-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0],xmm6[1],xmm5[2,3]
; AVX2-NEXT:    vpshufb {{.*#+}} xmm5 = xmm5[2,3,12,13,6,7,0,1,u,u,u,u,u,u,u,u]
; AVX2-NEXT:    vmovq %xmm5, (%rdx)
; AVX2-NEXT:    vpblendd {{.*#+}} xmm5 = xmm4[0],xmm2[1,2,3]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0,1],xmm3[2],xmm5[3]
...
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm2[2],xmm3[3]
; AVX2-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[8,9,2,3,12,13,u,u,u,u,u,u,u,u,u,u]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm4[3],xmm0[4,5,6,7]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm1[0],ymm0[1,2,3,4,5,6,7],ymm1[8],ymm0[9,10,11,12,13,14,15]
; AVX2-FP-NEXT:    vextracti128 $1, %ymm5, %xmm6
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0],xmm6[1],xmm5[2,3]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm5 = xmm5[2,3,12,13,6,7,0,1,u,u,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vmovq %xmm5, (%rdx)
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm4[0],xmm2[1,2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0,1],xmm3[2],xmm5[3]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm5 = xmm5[4,5,14,15,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vmovq %xmm5, (%rcx)
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6,7,8,9],ymm1[10],ymm0[11,12,13,14,15]
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm2[2],xmm3[3]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[8,9,2,3,12,13,u,u,u,u,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm4[3],xmm0[4,5,6,7]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm1[0],ymm0[1,2,3,4,5,6,7],ymm1[8],ymm0[9,10,11,12,13,14,15]
; AVX2-FCP-NEXT:    vextracti128 $1, %ymm5, %xmm6
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0],xmm6[1],xmm5[2,3]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm5 = xmm5[2,3,12,13,6,7,0,1,u,u,u,u,u,u,u,u]
...
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm2 = [4,1,6,7]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6,7,8,9],ymm1[10],ymm0[11,12,13,14,15]
; AVX2-FCP-NEXT:    vpermd %ymm1, %ymm2, %ymm1
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[6,7,0,1,10,11,4,5,u,u,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vmovq %xmm1, (%r8)
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [4,5,2,7]
; AVX2-FCP-NEXT:    vpermd %ymm0, %ymm1, %ymm0
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[8,9,2,3,12,13,u,u,u,u,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm4[3],xmm0[4,5,6,7]
...
; AVX512-NEXT:    vpinsrw $1, %r10d, %xmm0, %xmm0
; AVX512-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm1[2],xmm0[3,4,5,6,7]
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0,1],mem[2],ymm3[3,4,5,6,7,8,9],mem[10],ymm3[11,12,13,14,15]
; AVX512-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX512-NEXT:    vpblendd {{.*#+}} xmm4 = xmm4[0,1],mem[2],xmm4[3]
; AVX512-NEXT:    vmovq %xmm0, (%rsi)
; AVX512-NEXT:    vmovd %r14d, %xmm0
; AVX512-NEXT:    vpinsrw $1, %ebp, %xmm0, %xmm0
; AVX512-NEXT:    vpinsrw $2, %ebx, %xmm0, %xmm0
; AVX512-NEXT:    vpinsrw $3, %r11d, %xmm0, %xmm0
; AVX512-NEXT:    vmovq %xmm0, (%rdx)
; AVX512-NEXT:    vpshufb {{.*#+}} xmm0 = xmm1[4,5,14,15,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512-NEXT:    vmovq %xmm0, (%rcx)
; AVX512-NEXT:    vextracti128 $1, %ymm3, %xmm0
; AVX512-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0],xmm3[1],xmm0[2,3]
; AVX512-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,0,1,10,11,4,5,u,u,u,u,u,u,u,u]
; AVX512-NEXT:    vmovq %xmm0, (%r8)
; AVX512-NEXT:    vpshufb {{.*#+}} xmm0 = xmm4[8,9,2,3,12,13,u,u,u,u,u,u,u,u,u,u]
...
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [8,1,6,3]
; AVX512-FCP-NEXT:    vpermd (%rdi), %zmm3, %zmm3
; AVX512-FCP-NEXT:    vmovdqa (%rdi), %ymm4
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm4[0,1],mem[2],ymm4[3,4,5,6,7,8,9],mem[10],ymm4[11,12,13,14,15]
; AVX512-FCP-NEXT:    vmovq %xmm1, (%rsi)
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[2,3,12,13,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX512-FCP-NEXT:    vpinsrw $2, %r11d, %xmm0, %xmm0
; AVX512-FCP-NEXT:    vpinsrw $3, %r10d, %xmm0, %xmm0
; AVX512-FCP-NEXT:    vmovq %xmm0, (%rdx)
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm3[4,5,14,15,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512-FCP-NEXT:    vmovq %xmm0, (%rcx)
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,1,6,7]
; AVX512-FCP-NEXT:    vpermd %ymm5, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,0,1,10,11,4,5,u,u,u,u,u,u,u,u]
; AVX512-FCP-NEXT:    vmovq %xmm0, (%r8)
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,5,2,7]
...
; AVX512DQ-NEXT:    vpinsrw $1, %r10d, %xmm0, %xmm0
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0,1],mem[2],ymm3[3,4,5,6,7,8,9],mem[10],ymm3[11,12,13,14,15]
; AVX512DQ-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX512DQ-NEXT:    vpblendd {{.*#+}} xmm4 = xmm4[0,1],mem[2],xmm4[3]
; AVX512DQ-NEXT:    vmovq %xmm0, (%rsi)
; AVX512DQ-NEXT:    vmovd %r14d, %xmm0
; AVX512DQ-NEXT:    vpinsrw $1, %ebp, %xmm0, %xmm0
; AVX512DQ-NEXT:    vpinsrw $2, %ebx, %xmm0, %xmm0
; AVX512DQ-NEXT:    vpinsrw $3, %r11d, %xmm0, %xmm0
; AVX512DQ-NEXT:    vmovq %xmm0, (%rdx)
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm0 = xmm1[4,5,14,15,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512DQ-NEXT:    vmovq %xmm0, (%rcx)
; AVX512DQ-NEXT:    vextracti128 $1, %ymm3, %xmm0
; AVX512DQ-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0],xmm3[1],xmm0[2,3]
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,0,1,10,11,4,5,u,u,u,u,u,u,u,u]
; AVX512DQ-NEXT:    vmovq %xmm0, (%r8)
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm0 = xmm4[8,9,2,3,12,13,u,u,u,u,u,u,u,u,u,u]
...
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [8,1,6,3]
; AVX512DQ-FCP-NEXT:    vpermd (%rdi), %zmm3, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdi), %ymm4
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm4[0,1],mem[2],ymm4[3,4,5,6,7,8,9],mem[10],ymm4[11,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vmovq %xmm1, (%rsi)
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[2,3,12,13,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpinsrw $2, %r11d, %xmm0, %xmm0
; AVX512DQ-FCP-NEXT:    vpinsrw $3, %r10d, %xmm0, %xmm0
; AVX512DQ-FCP-NEXT:    vmovq %xmm0, (%rdx)
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm3[4,5,14,15,8,9,2,3,u,u,u,u,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vmovq %xmm0, (%rcx)
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,1,6,7]
; AVX512DQ-FCP-NEXT:    vpermd %ymm5, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,0,1,10,11,4,5,u,u,u,u,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vmovq %xmm0, (%r8)
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm0 = [4,5,2,7]
...
; AVX512BW-NEXT:    vpextrw $5, %xmm1, %r10d
; AVX512BW-NEXT:    movl 32(%rdi), %edi
; AVX512BW-NEXT:    vpextrw $3, %xmm2, %r11d
; AVX512BW-NEXT:    vpextrw $6, %xmm1, %ebx
; AVX512BW-NEXT:    vpextrw $1, %xmm1, %ebp
; AVX512BW-NEXT:    vpinsrw $1, %r10d, %xmm1, %xmm1
...
; AVX512BW-NEXT:    vmovd %ebp, %xmm1
; AVX512BW-NEXT:    vpinsrw $1, %ebx, %xmm1, %xmm1
; AVX512BW-NEXT:    vpinsrw $2, %r11d, %xmm1, %xmm1
; AVX512BW-NEXT:    vpinsrw $3, %edi, %xmm1, %xmm1
...
; AVX512BW-NEXT:    vmovq {{.*#+}} xmm1 = [3,8,13,18,0,0,0,0]
; AVX512BW-NEXT:    vpermw %zmm0, %zmm1, %zmm1
; AVX512BW-NEXT:    vmovq %xmm1, (%r8)
; AVX512BW-NEXT:    vmovq {{.*#+}} xmm1 = [4,9,14,19,0,0,0,0]
...
; AVX512BW-FCP-NEXT:    vpextrw $3, %xmm2, %r10d
; AVX512BW-FCP-NEXT:    vpshufb {{.*#+}} xmm3 = xmm1[0,1,10,11,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX512BW-FCP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0,1],xmm2[2],xmm3[3,4,5,6,7]
...
; AVX512BW-FCP-NEXT:    vpinsrw $2, %r10d, %xmm1, %xmm1
; AVX512BW-FCP-NEXT:    vpinsrw $3, %edi, %xmm1, %xmm1
...
; AVX512BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = [3,8,13,18,0,0,0,0]
; AVX512BW-FCP-NEXT:    vpermw %zmm0, %zmm1, %zmm1
; AVX512BW-FCP-NEXT:    vmovq %xmm1, (%r8)
; AVX512BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = [4,9,14,19,0,0,0,0]
...
; AVX512DQ-BW-NEXT:    vpextrw $5, %xmm1, %r10d
; AVX512DQ-BW-NEXT:    movl 32(%rdi), %edi
; AVX512DQ-BW-NEXT:    vpextrw $3, %xmm2, %r11d
; AVX512DQ-BW-NEXT:    vpextrw $6, %xmm1, %ebx
; AVX512DQ-BW-NEXT:    vpextrw $1, %xmm1, %ebp
; AVX512DQ-BW-NEXT:    vpinsrw $1, %r10d, %xmm1, %xmm1
; AVX512DQ-BW-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1],xmm2[2],xmm1[3,4,5,6,7]
; AVX512DQ-BW-NEXT:    vpinsrw $3, %eax, %xmm1, %xmm1
; AVX512DQ-BW-NEXT:    vmovq %xmm1, (%rsi)
; AVX512DQ-BW-NEXT:    vmovd %ebp, %xmm1
; AVX512DQ-BW-NEXT:    vpinsrw $1, %ebx, %xmm1, %xmm1
; AVX512DQ-BW-NEXT:    vpinsrw $2, %r11d, %xmm1, %xmm1
; AVX512DQ-BW-NEXT:    vpinsrw $3, %edi, %xmm1, %xmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpextrw $3, %xmm2, %r10d
; AVX512DQ-BW-FCP-NEXT:    vpshufb {{.*#+}} xmm3 = xmm1[0,1,10,11,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX512DQ-BW-FCP-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0,1],xmm2[2],xmm3[3,4,5,6,7]
...
; AVX512DQ-BW-FCP-NEXT:    vpinsrw $2, %r10d, %xmm1, %xmm1
; AVX512DQ-BW-FCP-NEXT:    vpinsrw $3, %edi, %xmm1, %xmm1
...
; AVX512DQ-BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = [3,8,13,18,0,0,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermw %zmm0, %zmm1, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovq %xmm1, (%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovq {{.*#+}} xmm1 = [4,9,14,19,0,0,0,0]
