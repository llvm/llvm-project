...
; SSE-NEXT:    pandn %xmm4, %xmm2
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm9[1,3,2,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,0,1,3]
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[0,1,1,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,0],xmm14[2,3]
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,0,1,3]
; SSE-NEXT:    movdqa %xmm15, %xmm2
; SSE-NEXT:    pandn %xmm0, %xmm2
; SSE-NEXT:    por %xmm2, %xmm4
...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,0],xmm7[0,0]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[2,0],xmm7[2,3]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,0,1,3]
; SSE-NEXT:    movdqa %xmm15, %xmm2
; SSE-NEXT:    pandn %xmm9, %xmm2
; SSE-NEXT:    por %xmm2, %xmm12
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm9[0,1,2,3,6,5,6,7]
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm5[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,5,6,5]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,1],xmm0[2,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm0[0,1,2,3,4,7,6,7]
...
; SSE-NEXT:    movdqa %xmm15, %xmm0
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm6[2,2,2,2,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm8 = xmm2[1,0,3,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm6[0,1,2,3,7,4,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,1],xmm0[2,3]
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[0,1],xmm2[2,0]
; SSE-NEXT:    movdqa %xmm15, %xmm0
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm6[0,3,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm2[1,0,3,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm0[2,1,3,3,4,5,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[3,1],xmm3[2,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[3,1],xmm3[1,3]
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,1],xmm14[2,0]
; SSE-NEXT:    por {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Folded Reload
; SSE-NEXT:    pshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSE-NEXT:    # xmm3 = mem[0,1,1,3]
; SSE-NEXT:    pshuflw $196, {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Folded Reload
; SSE-NEXT:    # xmm14 = mem[0,1,0,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,5,4,7]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[3,1],xmm14[1,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,5,4,7]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[3,1],xmm5[1,3]
