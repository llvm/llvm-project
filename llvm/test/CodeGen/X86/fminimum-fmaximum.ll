...
; X86:       # %bb.0:
; X86-NEXT:    pushl %eax
; X86-NEXT:    vpinsrw $0, {{[0-9]+}}(%esp), %xmm0, %xmm0
; X86-NEXT:    vpinsrw $0, {{[0-9]+}}(%esp), %xmm0, %xmm1
...
; AVX512F-NEXT:    .cfi_def_cfa_offset 128
; AVX512F-NEXT:    vmovq %xmm0, %rax
; AVX512F-NEXT:    movl %eax, %ecx
; AVX512F-NEXT:    shrl $16, %ecx
; AVX512F-NEXT:    vpinsrw $0, %ecx, %xmm0, %xmm2
...
; AVX512F-NEXT:    vpinsrw $0, %edx, %xmm0, %xmm2
; AVX512F-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    subq $120, %rsp
; AVX512DQ-NEXT:    .cfi_def_cfa_offset 128
; AVX512DQ-NEXT:    vmovq %xmm0, %rax
; AVX512DQ-NEXT:    movl %eax, %ecx
; AVX512DQ-NEXT:    shrl $16, %ecx
; AVX512DQ-NEXT:    vpinsrw $0, %ecx, %xmm0, %xmm2
...
; AVX512DQ-NEXT:    vpinsrw $0, %edx, %xmm0, %xmm2
; AVX512DQ-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512DQ-NEXT:    vpinsrw $0, %eax, %xmm0, %xmm2
; AVX512DQ-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    shrq $48, %rcx
; AVX512DQ-NEXT:    vpinsrw $0, %ecx, %xmm0, %xmm2
; AVX512DQ-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vpslld $16, %xmm0, %xmm2
; AVX512DQ-NEXT:    vpbroadcastd {{.*#+}} xmm0 = [NaN,NaN,NaN,NaN]
