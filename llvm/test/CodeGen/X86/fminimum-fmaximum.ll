...
define bfloat @test_fmaximum_bf16(bfloat %x, bfloat %y) #0 {
...
define <4 x bfloat> @test_fmaximum_v4bf16(<4 x bfloat> %x, <4 x bfloat> %y) denormal_fpenv(preservesign) {
...
define bfloat @test_fminimum_bf16(bfloat %x, bfloat %y) #0 {
