...
; AVX512VL-NEXT:    vinserti64x4 $1, %ymm6, %zmm4, %zmm4
; AVX512VL-NEXT:    vpxor %xmm5, %xmm5, %xmm5
; AVX512VL-NEXT:    vpsadbw %zmm5, %zmm4, %zmm4
; AVX512VL-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [0,4,0,4,0,4,8,12]
...
; AVX512VL-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [0,4,8,12]
...
; AVX512VPOPCNT-NEXT:    vinserti64x4 $1, %ymm6, %zmm4, %zmm4
; AVX512VPOPCNT-NEXT:    vpxor %xmm5, %xmm5, %xmm5
; AVX512VPOPCNT-NEXT:    vpsadbw %zmm5, %zmm4, %zmm4
; AVX512VPOPCNT-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [0,4,0,4,0,4,8,12]
...
; AVX512VPOPCNT-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512VPOPCNT-NEXT:    vpsadbw %zmm5, %zmm0, %zmm0
; AVX512VPOPCNT-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [0,4,8,12]
