...
; X86-SSE2-NEXT:    packuswb %xmm1, %xmm1
; X86-SSE2-NEXT:    psadbw %xmm0, %xmm1
; X86-SSE2-NEXT:    movd %xmm1, %eax
; X86-SSE2-NEXT:    retl
;
...
; X86-SSE4-NEXT:    packuswb %xmm2, %xmm2
; X86-SSE4-NEXT:    psadbw %xmm0, %xmm2
...
; X64-SSE4-NEXT:    packuswb %xmm1, %xmm1
; X64-SSE4-NEXT:    psadbw %xmm0, %xmm1
; X64-SSE4-NEXT:    movd %xmm1, %eax
...
; X86-SSE4-NEXT:    packuswb %xmm0, %xmm0
...
; X64-SSE4-NEXT:    packuswb %xmm0, %xmm0
...
; X64-AVX1-NEXT:    vpsadbw %xmm2, %xmm8, %xmm1
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; X64-AVX1-NEXT:    vpaddq %xmm2, %xmm1, %xmm1
; X64-AVX1-NEXT:    vpsadbw %xmm3, %xmm8, %xmm2
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm3 = xmm2[2,3,2,3]
; X64-AVX1-NEXT:    vpaddq %xmm3, %xmm2, %xmm2
; X64-AVX1-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; X64-AVX1-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; X64-AVX1-NEXT:    vpsadbw %xmm4, %xmm8, %xmm1
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; X64-AVX1-NEXT:    vpaddq %xmm2, %xmm1, %xmm1
; X64-AVX1-NEXT:    vpsadbw %xmm5, %xmm8, %xmm2
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm3 = xmm2[2,3,2,3]
; X64-AVX1-NEXT:    vpaddq %xmm3, %xmm2, %xmm2
; X64-AVX1-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; X64-AVX1-NEXT:    vpsadbw %xmm6, %xmm8, %xmm2
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm3 = xmm2[2,3,2,3]
; X64-AVX1-NEXT:    vpaddq %xmm3, %xmm2, %xmm2
; X64-AVX1-NEXT:    vpsadbw %xmm7, %xmm8, %xmm3
; X64-AVX1-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[2,3,2,3]
...
; X64-AVX2-NEXT:    vpaddq %xmm1, %xmm8, %xmm1
; X64-AVX2-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; X64-AVX2-NEXT:    vextracti128 $1, %ymm2, %xmm1
; X64-AVX2-NEXT:    vpaddq %xmm1, %xmm2, %xmm1
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm2, %xmm1, %xmm1
; X64-AVX2-NEXT:    vextracti128 $1, %ymm3, %xmm2
; X64-AVX2-NEXT:    vpaddq %xmm2, %xmm3, %xmm2
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm3 = xmm2[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm3, %xmm2, %xmm2
; X64-AVX2-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1]
; X64-AVX2-NEXT:    vextracti128 $1, %ymm4, %xmm2
; X64-AVX2-NEXT:    vpaddq %xmm2, %xmm4, %xmm2
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm3 = xmm2[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm3, %xmm2, %xmm2
; X64-AVX2-NEXT:    vextracti128 $1, %ymm5, %xmm3
; X64-AVX2-NEXT:    vpaddq %xmm3, %xmm5, %xmm3
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm4, %xmm3, %xmm3
; X64-AVX2-NEXT:    vpunpckldq {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1]
; X64-AVX2-NEXT:    vextracti128 $1, %ymm6, %xmm3
; X64-AVX2-NEXT:    vpaddq %xmm3, %xmm6, %xmm3
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm4, %xmm3, %xmm3
; X64-AVX2-NEXT:    vextracti128 $1, %ymm7, %xmm4
; X64-AVX2-NEXT:    vpaddq %xmm4, %xmm7, %xmm4
; X64-AVX2-NEXT:    vpshufd {{.*#+}} xmm5 = xmm4[2,3,2,3]
; X64-AVX2-NEXT:    vpaddq %xmm5, %xmm4, %xmm4
; X64-AVX2-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; X64-AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm1, %ymm1
; X64-AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; X64-AVX2-NEXT:    vpunpcklqdq {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; X64-AVX2-NEXT:    retq
...
; AVX512VL-NEXT:    vinserti128 $1, %xmm7, %ymm3, %ymm3
; AVX512VL-NEXT:    vpsadbw %ymm0, %ymm3, %ymm3
; AVX512VL-NEXT:    vinserti128 $1, %xmm6, %ymm2, %ymm2
; AVX512VL-NEXT:    vpsadbw %ymm0, %ymm2, %ymm2
; AVX512VL-NEXT:    vpunpckldq {{.*#+}} ymm2 = ymm2[0],ymm3[0],ymm2[1],ymm3[1],ymm2[4],ymm3[4],ymm2[5],ymm3[5]
; AVX512VL-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX512VL-NEXT:    vpsadbw %ymm0, %ymm1, %ymm1
; AVX512VL-NEXT:    vinserti128 $1, %xmm4, %ymm8, %ymm3
; AVX512VL-NEXT:    vpsadbw %ymm0, %ymm3, %ymm0
; AVX512VL-NEXT:    vpunpckldq {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
...
; AVX512VPOPCNT-NEXT:    vinserti128 $1, %xmm7, %ymm3, %ymm3
; AVX512VPOPCNT-NEXT:    vpxor %xmm7, %xmm7, %xmm7
; AVX512VPOPCNT-NEXT:    vpsadbw %ymm7, %ymm3, %ymm3
; AVX512VPOPCNT-NEXT:    vinserti128 $1, %xmm6, %ymm2, %ymm2
; AVX512VPOPCNT-NEXT:    vpsadbw %ymm7, %ymm2, %ymm2
; AVX512VPOPCNT-NEXT:    vpunpckldq {{.*#+}} ymm2 = ymm2[0],ymm3[0],ymm2[1],ymm3[1],ymm2[4],ymm3[4],ymm2[5],ymm3[5]
; AVX512VPOPCNT-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX512VPOPCNT-NEXT:    vpsadbw %ymm7, %ymm1, %ymm1
; AVX512VPOPCNT-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm0
; AVX512VPOPCNT-NEXT:    vpsadbw %ymm7, %ymm0, %ymm0
; AVX512VPOPCNT-NEXT:    vpunpckldq {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
