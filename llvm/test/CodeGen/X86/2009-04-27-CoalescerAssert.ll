...
; PR4034
	...
	%struct.ImageParameters = type { i32, i32, i32, i32, ptr, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [16 x [16 x i16]], [6 x [32 x i32]], [16 x [16 x i32]], [4 x [12 x [4 x [4 x i32]]]], [16 x i32], ptr, ptr, ptr, ptr, i32, i32, i32, i32, ptr, ptr, i32, i32, i32, i32, i32, i32, ptr, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [3 x i32], i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, ptr, ptr, ptr, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [3 x [2 x i32]], [3 x [2 x i32]], i32, i32, i64, i64, %struct.timeb, %struct.timeb, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32 }
...
@get_mb_block_pos = external global ptr		; <ptr> [#uses=1]
@img = external global ptr		; <ptr> [#uses=14]
@llvm.used = appending global [1 x ptr] [ptr @getAffNeighbour], section "llvm.metadata"		; <ptr> [#uses=0]

define void @getAffNeighbour(i32 %curr_mb_nr, i32 %xN, i32 %yN, i32 %is_chroma, ptr %pix) nounwind {
entry:
	%Opq.sa.calc = add i32 0, 2		; <i32> [#uses=2]
	%0 = load ptr, ptr @img, align 8		; <ptr> [#uses=3]
	%1 = getelementptr %struct.ImageParameters, ptr %0, i64 0, i32 39		; <ptr> [#uses=1]
	%2 = load ptr, ptr %1, align 8		; <ptr> [#uses=24]
...
entry.fragment:		; preds = %meshBB392
	...
	%5 = getelementptr %struct.ImageParameters, ptr %0, i64 0, i32 119, i64 %4, i64 0		; <ptr> [#uses=1]
	%6 = load i32, ptr %5, align 4		; <i32> [#uses=2]
	%7 = getelementptr %struct.ImageParameters, ptr %0, i64 0, i32 119, i64 %4, i64 1		; <ptr> [#uses=1]
	%8 = load i32, ptr %7, align 4		; <i32> [#uses=5]
	br label %entry.fragment181

entry.fragment181:		; preds = %entry.fragment
	%Opq.sa.calc863 = add i32 %Opq.sa.calc921, -50		; <i32> [#uses=4]
	%9 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 0		; <ptr> [#uses=4]
...
bb5:		; preds = %meshBB428
	...
	%17 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 20		; <ptr> [#uses=1]
	%18 = load i32, ptr %17, align 4		; <i32> [#uses=1]
...
bb7:		; preds = %bb6
	...
	%22 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 25		; <ptr> [#uses=1]
	%23 = load i32, ptr %22, align 8		; <i32> [#uses=1]
	%24 = add i32 %23, 1		; <i32> [#uses=1]
	%25 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	br label %meshBB388
...
bb7.fragment:		; preds = %meshBB388
	...
	store i32 %.SV194.phi, ptr %.SV196.phi, align 4
	%26 = getelementptr %struct.Macroblock, ptr %.load17.SV.phi, i64 %.load36.SV.phi, i32 29		; <ptr> [#uses=1]
	%27 = load i32, ptr %26, align 8		; <i32> [#uses=2]
	store i32 %27, ptr %.load67.SV.phi, align 4
	br label %bb96

bb8:		; preds = %meshBB348
	%Opq.sa.calc479 = sub i32 %Opq.sa.calc805, 141		; <i32> [#uses=1]
	%28 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 22		; <ptr> [#uses=2]
	%29 = load i32, ptr %28, align 4		; <i32> [#uses=2]
	%30 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=2]
	br label %meshBB368

bb8.fragment:		; preds = %meshBB368
	%Opq.sa.calc765 = sub i32 %Opq.sa.calc768, -115		; <i32> [#uses=2]
	store i32 %.SV198.phi, ptr %.SV200.phi, align 4
	%31 = getelementptr %struct.Macroblock, ptr %.load16.SV.phi, i64 %.load35.SV.phi, i32 26		; <ptr> [#uses=2]
	%32 = load i32, ptr %31, align 4		; <i32> [#uses=4]
	store i32 %32, ptr %.load66.SV.phi, align 4
	%33 = load i32, ptr %31, align 4		; <i32> [#uses=1]
...
bb9:		; preds = %bb8.fragment
	...
	%35 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%36 = getelementptr %struct.ImageParameters, ptr %35, i64 0, i32 39		; <ptr> [#uses=1]
	%37 = load ptr, ptr %36, align 8		; <ptr> [#uses=1]
	%38 = load i32, ptr %.SV76.phi, align 4		; <i32> [#uses=1]
...
bb9.fragment:		; preds = %bb9
	...
	%40 = getelementptr %struct.Macroblock, ptr %37, i64 %39, i32 20		; <ptr> [#uses=1]
...
bb11.fragment:		; preds = %meshBB332
	...
	store i32 %.SV206.phi, ptr %.load81.SV.phi, align 4
...
bb13:		; preds = %bb5.fragment
	...
	%46 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 25		; <ptr> [#uses=1]
	br label %meshBB360

bb13.fragment:		; preds = %meshBB360
	%Opq.sa.calc870 = add i32 %Opq.sa.calc866, -129		; <i32> [#uses=3]
	%47 = load i32, ptr %.SV208.phi, align 8		; <i32> [#uses=3]
...
bb14:		; preds = %bb13.fragment
	...
	%48 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=2]
	store i32 %47, ptr %48, align 4
	%49 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 29		; <ptr> [#uses=2]
	br label %bb14.fragment

bb14.fragment:		; preds = %bb14
	%Opq.sa.calc723 = sub i32 %Opq.sa.calc493, 117		; <i32> [#uses=4]
	%50 = load i32, ptr %49, align 8		; <i32> [#uses=4]
	store i32 %50, ptr %.SV52.phi1113, align 4
	%51 = load i32, ptr %49, align 8		; <i32> [#uses=1]
...
bb15:		; preds = %bb14.fragment
	...
	%53 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%54 = getelementptr %struct.ImageParameters, ptr %53, i64 0, i32 39		; <ptr> [#uses=1]
	%55 = load ptr, ptr %54, align 8		; <ptr> [#uses=1]
	%56 = load i32, ptr %.SV208.phi, align 8		; <i32> [#uses=1]
	br label %meshBB324

bb15.fragment:		; preds = %meshBB324
	%Opq.sa.calc925 = xor i32 %Opq.sa.calc750, 215		; <i32> [#uses=2]
	%57 = sext i32 %.SV214.phi to i64		; <i64> [#uses=1]
	%58 = getelementptr %struct.Macroblock, ptr %.SV212.phi, i64 %57, i32 20		; <ptr> [#uses=1]
...
bb16.fragment:		; preds = %bb16
	...
	store i32 %61, ptr %.SV91.phi, align 4
...
bb19:		; preds = %meshBB412
	...
	%64 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	br label %bb19.fragment

bb19.fragment:		; preds = %bb19
	%Opq.sa.calc880 = xor i32 %Opq.sa.calc932, 246		; <i32> [#uses=0]
	store i32 %63, ptr %64, align 4
	%65 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 29		; <ptr> [#uses=1]
	%66 = load i32, ptr %65, align 8		; <i32> [#uses=2]
	store i32 %66, ptr %.SV52.phi1186, align 4
	br label %bb96
...
bb23:		; preds = %meshBB360
	...
	%67 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 20		; <ptr> [#uses=1]
	%68 = load i32, ptr %67, align 4		; <i32> [#uses=1]
...
bb23.fragment:		; preds = %bb23
	...
	%72 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 22		; <ptr> [#uses=3]
	%73 = load i32, ptr %72, align 4		; <i32> [#uses=3]
	%74 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=3]
...
bb23.fragment182:		; preds = %bb23.fragment
	...
	%75 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 26		; <ptr> [#uses=2]
	%76 = load i32, ptr %75, align 4		; <i32> [#uses=3]
	store i32 %76, ptr %.SV52.phi1113, align 4
	%77 = load i32, ptr %75, align 4		; <i32> [#uses=1]
...
bb26:		; preds = %bb25
	...
	%79 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%80 = getelementptr %struct.ImageParameters, ptr %79, i64 0, i32 39		; <ptr> [#uses=1]
	%81 = load ptr, ptr %80, align 8		; <ptr> [#uses=1]
	%82 = load i32, ptr %.SV99.phi, align 4		; <i32> [#uses=1]
	br label %meshBB340
...
bb26.fragment:		; preds = %meshBB340
	...
	%84 = getelementptr %struct.Macroblock, ptr %.SV228.phi, i64 %83, i32 20		; <ptr> [#uses=1]
	%85 = load i32, ptr %84, align 4		; <i32> [#uses=1]
...
bb30.fragment:		; preds = %bb30
	...
	store i32 %90, ptr %.SV111.phi1159, align 4
...
bb33:		; preds = %bb32
	...
	%92 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%93 = getelementptr %struct.ImageParameters, ptr %92, i64 0, i32 39		; <ptr> [#uses=1]
	%94 = load ptr, ptr %93, align 8		; <ptr> [#uses=1]
	%95 = load i32, ptr %.SV99.phi, align 4		; <i32> [#uses=1]
...
bb33.fragment:		; preds = %bb33
	...
	%97 = getelementptr %struct.Macroblock, ptr %94, i64 %96, i32 20		; <ptr> [#uses=1]
	%98 = load i32, ptr %97, align 4		; <i32> [#uses=1]
...
bb34.fragment:		; preds = %meshBB328
	...
	store i32 %.SV238.phi, ptr %.load116.SV.phi, align 4
	br label %bb96
...
bb37.fragment:		; preds = %meshBB348
	...
	store i32 %.SV242.phi, ptr %.load115.SV.phi, align 4
...
bb41:		; preds = %meshBB336
	...
	%108 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%109 = getelementptr %struct.ImageParameters, ptr %108, i64 0, i32 39		; <ptr> [#uses=1]
	%110 = load ptr, ptr %109, align 8		; <ptr> [#uses=1]
	%111 = load i32, ptr %.SV99.phi1128, align 4		; <i32> [#uses=1]
...
bb41.fragment:		; preds = %bb41
	...
	%113 = getelementptr %struct.Macroblock, ptr %110, i64 %112, i32 20		; <ptr> [#uses=1]
	%114 = load i32, ptr %113, align 4		; <i32> [#uses=1]
...
bb44.fragment:		; preds = %meshBB332
	...
	store i32 %.SV248.phi, ptr %.load114.SV.phi, align 4
...
bb49:		; preds = %bb48
	...
	%122 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%123 = getelementptr %struct.ImageParameters, ptr %122, i64 0, i32 39		; <ptr> [#uses=1]
	%124 = load ptr, ptr %123, align 8		; <ptr> [#uses=1]
	%125 = load i32, ptr %.SV99.phi1037, align 4		; <i32> [#uses=1]
...
bb49.fragment:		; preds = %bb49
	...
	%127 = getelementptr %struct.Macroblock, ptr %124, i64 %126, i32 20		; <ptr> [#uses=1]
...
bb52:		; preds = %bb50
	...
	store i32 %134, ptr %.SV111.phi1035, align 4
	br label %meshBB384
...
bb54.fragment:		; preds = %bb54
	...
	store i32 %138, ptr %.SV111.phi1123, align 4
	br label %meshBB440
...
bb59:		; preds = %bb58
	...
	%141 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 20		; <ptr> [#uses=1]
	%142 = load i32, ptr %141, align 4		; <i32> [#uses=1]
...
bb61:		; preds = %bb60
	...
	%146 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 23		; <ptr> [#uses=2]
	%147 = load i32, ptr %146, align 8		; <i32> [#uses=3]
	%148 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=3]
	br label %bb61.fragment

bb61.fragment:		; preds = %bb61
	%Opq.sa.calc700 = sub i32 %Opq.sa.calc605, 108		; <i32> [#uses=3]
	store i32 %147, ptr %148, align 4
	%149 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 27		; <ptr> [#uses=4]
	%150 = load i32, ptr %149, align 8		; <i32> [#uses=1]
...
bb62:		; preds = %bb61.fragment
	...
	%152 = load ptr, ptr @img, align 8		; <ptr> [#uses=2]
	%153 = getelementptr %struct.ImageParameters, ptr %152, i64 0, i32 45		; <ptr> [#uses=1]
	%154 = load i32, ptr %153, align 4		; <i32> [#uses=1]
	%155 = icmp eq i32 %154, 1		; <i1> [#uses=1]
	br i1 %155, label %bb63, label %bb64

bb63:		; preds = %bb62
	%Opq.sa.calc611 = add i32 %Opq.sa.calc700, -101		; <i32> [#uses=2]
	%156 = getelementptr %struct.ImageParameters, ptr %152, i64 0, i32 39		; <ptr> [#uses=1]
	%157 = load ptr, ptr %156, align 8		; <ptr> [#uses=1]
	%158 = load i32, ptr %146, align 8		; <i32> [#uses=1]
	br label %meshBB452
...
bb63.fragment:		; preds = %meshBB452
	...
	%160 = getelementptr %struct.Macroblock, ptr %.SV264.phi, i64 %159, i32 20		; <ptr> [#uses=1]
	%161 = load i32, ptr %160, align 4		; <i32> [#uses=1]
...
bb64:		; preds = %bb63.fragment, %bb62
	...
	%.SV52.phi1131 = phi ptr [ %.SV52.phi1109, %bb63.fragment ], [ %.SV52.phi1097, %bb62 ]		; <ptr> [#uses=1]
	...
	%.SV150.phi = phi ptr [ %.SV150.phi1060, %bb63.fragment ], [ %148, %bb62 ]		; <ptr> [#uses=1]
	%.SV152.phi = phi ptr [ %.SV152.phi1059, %bb63.fragment ], [ %149, %bb62 ]		; <ptr> [#uses=1]
	...
	store i32 %163, ptr %.SV150.phi, align 4
	br label %bb65
...
bb65:		; preds = %meshBB456, %bb64, %bb61.fragment
	...
	%.SV52.phi1143 = phi ptr [ %.SV52.phi1136, %meshBB456 ], [ %.SV52.phi1097, %bb61.fragment ], [ %.SV52.phi1131, %bb64 ]		; <ptr> [#uses=1]
	...
	%.SV152.phi1058 = phi ptr [ %.SV152.phi1133, %meshBB456 ], [ %149, %bb61.fragment ], [ %.SV152.phi, %bb64 ]		; <ptr> [#uses=1]
...
bb66.fragment:		; preds = %meshBB420
	...
	store i32 %.SV270.phi, ptr %.SV272.phi, align 4
	store i32 1, ptr %.load61.SV.phi, align 4
	br label %meshBB444

bb68:		; preds = %bb59.fragment
	%Opq.sa.calc624 = sub i32 %Opq.sa.calc731, 229		; <i32> [#uses=3]
	%167 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 23		; <ptr> [#uses=1]
	br label %meshBB344

bb68.fragment:		; preds = %meshBB344
	%Opq.sa.calc784 = sub i32 %Opq.link.mask722, 3		; <i32> [#uses=5]
	%168 = load i32, ptr %.SV274.phi, align 8		; <i32> [#uses=3]
...
bb69:		; preds = %bb68.fragment
	...
	%169 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=2]
	store i32 %168, ptr %169, align 4
	%170 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 27		; <ptr> [#uses=2]
...
bb69.fragment:		; preds = %bb69
	...
	%171 = load i32, ptr %170, align 8		; <i32> [#uses=3]
	store i32 %171, ptr %.SV52.phi1170, align 4
	%172 = load i32, ptr %170, align 8		; <i32> [#uses=1]
...
bb70:		; preds = %meshBB400
	...
	%174 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%175 = getelementptr %struct.ImageParameters, ptr %174, i64 0, i32 39		; <ptr> [#uses=1]
	%176 = load ptr, ptr %175, align 8		; <ptr> [#uses=1]
	%177 = load i32, ptr %.SV156.phi, align 8		; <i32> [#uses=1]
	br label %meshBB428
...
bb70.fragment:		; preds = %meshBB428
	...
	%179 = getelementptr %struct.Macroblock, ptr %.SV278.phi, i64 %178, i32 20		; <ptr> [#uses=1]
	%180 = load i32, ptr %179, align 4		; <i32> [#uses=1]
...
bb71.fragment:		; preds = %meshBB352
	...
	store i32 %.SV282.phi, ptr %.load163.SV.phi, align 4
...
bb74:		; preds = %meshBB412
	...
	%185 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	br label %bb74.fragment

bb74.fragment:		; preds = %bb74
	%Opq.sa.calc1011 = sub i32 %Opq.sa.calc636, -19		; <i32> [#uses=0]
	store i32 %184, ptr %185, align 4
	%186 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 27		; <ptr> [#uses=1]
	%187 = load i32, ptr %186, align 8		; <i32> [#uses=2]
	store i32 %187, ptr %.SV52.phi1186, align 4
	br label %bb96
...
bb77:		; preds = %bb76
	...
	%189 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%190 = getelementptr %struct.ImageParameters, ptr %189, i64 0, i32 45		; <ptr> [#uses=1]
...
bb78:		; preds = %meshBB416
	...
	%193 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 23		; <ptr> [#uses=1]
	%194 = load i32, ptr %193, align 8		; <i32> [#uses=1]
...
bb78.fragment:		; preds = %bb78
	...
	%196 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	store i32 %195, ptr %196, align 4
	store i32 1, ptr %.SV52.phi1200, align 4
...
bb81:		; preds = %meshBB456
	...
	%198 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	store i32 %curr_mb_nr, ptr %198, align 4
	store i32 1, ptr %.SV52.phi1136, align 4
	br label %bb98
...
bb84:		; preds = %bb83
	...
	%199 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 20		; <ptr> [#uses=1]
	%200 = load i32, ptr %199, align 4		; <i32> [#uses=1]
	br label %meshBB400
...
bb86:		; preds = %meshBB336
	...
	%204 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 24		; <ptr> [#uses=1]
	%205 = load i32, ptr %204, align 4		; <i32> [#uses=1]
	%206 = add i32 %205, 1		; <i32> [#uses=1]
	%207 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	br label %bb86.fragment

bb86.fragment:		; preds = %bb86
	%Opq.sa.calc943 = xor i32 %Opq.sa.calc670, 123		; <i32> [#uses=2]
	store i32 %206, ptr %207, align 4
	%208 = getelementptr %struct.Macroblock, ptr %2, i64 %3, i32 28		; <ptr> [#uses=1]
	%209 = load i32, ptr %208, align 4		; <i32> [#uses=2]
	store i32 %209, ptr %.SV52.phi1234, align 4
	br label %meshBB424
...
bb90.fragment:		; preds = %bb90
	...
	%214 = load i32, ptr %213, align 4		; <i32> [#uses=3]
	store i32 %214, ptr %.SV52.phi1190, align 4
	%215 = load i32, ptr %213, align 4		; <i32> [#uses=1]
...
bb91:		; preds = %meshBB368
	...
	%217 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%218 = getelementptr %struct.ImageParameters, ptr %217, i64 0, i32 39		; <ptr> [#uses=1]
	%219 = load ptr, ptr %218, align 8		; <ptr> [#uses=1]
	%220 = load i32, ptr %.SV170.phi, align 4		; <i32> [#uses=1]
...
bb91.fragment:		; preds = %bb91
	...
	%222 = getelementptr %struct.Macroblock, ptr %219, i64 %221, i32 20		; <ptr> [#uses=1]
...
bb92.fragment:		; preds = %bb92
	...
	store i32 %225, ptr %.SV176.phi, align 4
...
bb95:		; preds = %meshBB408
	...
	%228 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	br label %meshBB384

bb95.fragment:		; preds = %meshBB384
	%Opq.sa.calc841 = sub i32 %Opq.sa.calc901, 76		; <i32> [#uses=0]
	store i32 %.SV306.phi, ptr %.SV308.phi, align 4
	%229 = getelementptr %struct.Macroblock, ptr %.load.SV.phi, i64 %.load20.SV.phi, i32 28		; <ptr> [#uses=1]
	%230 = load i32, ptr %229, align 4		; <i32> [#uses=2]
	store i32 %230, ptr %.load53.SV.phi, align 4
	br label %bb96
...
bb97:		; preds = %meshBB424, %meshBB408, %meshBB352, %bb96, %bb21
	...
	%232 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%233 = getelementptr %struct.ImageParameters, ptr %232, i64 0, i32 45		; <ptr> [#uses=1]
...
bb98:		; preds = %meshBB444, %meshBB404, %bb97.fragment, %bb81, %bb78.fragment
	...
	%237 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 2		; <ptr> [#uses=2]
	store i32 %236, ptr %237, align 4
	%238 = and i32 %yM.0.reg2mem.1.SV.phi1068, %.SV68.phi1092		; <i32> [#uses=1]
	%239 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 3		; <ptr> [#uses=2]
	store i32 %238, ptr %239, align 4
	%240 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 5		; <ptr> [#uses=1]
	br label %meshBB376

bb98.fragment:		; preds = %meshBB376
	%Opq.sa.calc1008 = sub i32 %Opq.link.mask911, 13		; <i32> [#uses=1]
	%241 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 4		; <ptr> [#uses=4]
	%242 = getelementptr %struct.PixelPos, ptr %pix, i64 0, i32 1		; <ptr> [#uses=1]
	%243 = load i32, ptr %242, align 4		; <i32> [#uses=1]
	%244 = load ptr, ptr @get_mb_block_pos, align 8		; <ptr> [#uses=1]
	tail call void %244(i32 %243, ptr %241, ptr %.SV317.phi) nounwind
	%245 = load i32, ptr %241, align 4		; <i32> [#uses=1]
	%246 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%247 = getelementptr %struct.ImageParameters, ptr %246, i64 0, i32 119, i64 %.load39.SV.phi, i64 0		; <ptr> [#uses=1]
	%248 = load i32, ptr %247, align 4		; <i32> [#uses=1]
...
bb98.fragment183:		; preds = %bb98.fragment
	...
	%250 = load i32, ptr %.SV317.phi, align 4		; <i32> [#uses=1]
	%251 = load ptr, ptr @img, align 8		; <ptr> [#uses=1]
	%252 = getelementptr %struct.ImageParameters, ptr %251, i64 0, i32 119, i64 %.load39.SV.phi, i64 1		; <ptr> [#uses=1]
	%253 = load i32, ptr %252, align 4		; <i32> [#uses=1]
	%254 = mul i32 %253, %250		; <i32> [#uses=1]
	%255 = load i32, ptr %.SV313.phi, align 4		; <i32> [#uses=1]
	%256 = add i32 %255, %249		; <i32> [#uses=1]
	store i32 %256, ptr %241, align 4
	%257 = load i32, ptr %.SV315.phi, align 4		; <i32> [#uses=1]
	%258 = add i32 %257, %254		; <i32> [#uses=1]
	store i32 %258, ptr %.SV317.phi, align 4
	ret void
...
meshBB:		; preds = %bb33.fragment, %bb14.fragment
	...
	%.SV111.phi1083 = phi ptr [ undef, %bb14.fragment ], [ %.SV111.phi, %bb33.fragment ]		; <ptr> [#uses=1]
...
meshBB324:		; preds = %bb32, %bb15
	...
	%.SV212.phi = phi ptr [ undef, %bb32 ], [ %55, %bb15 ]		; <ptr> [#uses=1]
	...
	%.SV91.phi = phi ptr [ undef, %bb32 ], [ %48, %bb15 ]		; <ptr> [#uses=1]
...
meshBB328:		; preds = %bb50, %bb34
	...
	%.load116.SV.phi = phi ptr [ undef, %bb50 ], [ %.SV111.phi, %bb34 ]		; <ptr> [#uses=1]
...
meshBB332:		; preds = %bb44, %bb11
	...
	%.load114.SV.phi = phi ptr [ %.SV111.phi1126, %bb44 ], [ undef, %bb11 ]		; <ptr> [#uses=1]
	...
	%.load81.SV.phi = phi ptr [ undef, %bb44 ], [ %.SV80.phi, %bb11 ]		; <ptr> [#uses=1]
...
meshBB336:		; preds = %bb85, %bb40
	%.SV52.phi1234 = phi ptr [ %.SV52.phi1213, %bb85 ], [ undef, %bb40 ]		; <ptr> [#uses=1]
	...
	%.SV99.phi1128 = phi ptr [ undef, %bb85 ], [ %.SV99.phi1037, %bb40 ]		; <ptr> [#uses=1]
	%.SV104.phi1127 = phi i32 [ undef, %bb85 ], [ %.SV104.phi1036, %bb40 ]		; <i32> [#uses=2]
	%.SV111.phi1126 = phi ptr [ undef, %bb85 ], [ %.SV111.phi1035, %bb40 ]		; <ptr> [#uses=2]
...
meshBB340:		; preds = %bb29, %bb26
	...
	%.SV111.phi1079 = phi ptr [ undef, %bb29 ], [ %.SV111.phi, %bb26 ]		; <ptr> [#uses=1]
	...
	%.SV228.phi = phi ptr [ undef, %bb29 ], [ %81, %bb26 ]		; <ptr> [#uses=1]
...
meshBB344:		; preds = %bb68, %bb23.fragment182
	...
	%.SV52.phi1170 = phi ptr [ undef, %bb23.fragment182 ], [ %.SV52.phi1097, %bb68 ]		; <ptr> [#uses=2]
	...
	%.SV274.phi = phi ptr [ undef, %bb23.fragment182 ], [ %167, %bb68 ]		; <ptr> [#uses=2]
	...
	%.SV99.phi = phi ptr [ %72, %bb23.fragment182 ], [ undef, %bb68 ]		; <ptr> [#uses=2]
	%.SV104.phi = phi i32 [ %73, %bb23.fragment182 ], [ undef, %bb68 ]		; <i32> [#uses=3]
	%.SV111.phi = phi ptr [ %74, %bb23.fragment182 ], [ undef, %bb68 ]		; <ptr> [#uses=3]
...
meshBB348:		; preds = %bb37, %bb6
	...
	%.SV52.phi1101 = phi ptr [ %.SV52.phi, %bb6 ], [ undef, %bb37 ]		; <ptr> [#uses=1]
	...
	%.load115.SV.phi = phi ptr [ undef, %bb6 ], [ %.SV111.phi1156, %bb37 ]		; <ptr> [#uses=1]
...
meshBB352:		; preds = %bb79, %bb71
	...
	%.load163.SV.phi = phi ptr [ %.SV162.phi1105, %bb71 ], [ undef, %bb79 ]		; <ptr> [#uses=1]
...
meshBB356:		; preds = %bb70.fragment, %bb26.fragment
	...
	%.SV111.phi1159 = phi ptr [ undef, %bb70.fragment ], [ %.SV111.phi1079, %bb26.fragment ]		; <ptr> [#uses=1]
...
meshBB360:		; preds = %bb21, %bb13
	...
	%.SV52.phi1113 = phi ptr [ %.SV52.phi1022, %bb21 ], [ %.SV52.phi, %bb13 ]		; <ptr> [#uses=3]
	...
	%.SV208.phi = phi ptr [ undef, %bb21 ], [ %46, %bb13 ]		; <ptr> [#uses=2]
...
meshBB364:		; preds = %bb65.fragment, %bb56
	...
	%.SV52.phi1097 = phi ptr [ %.SV52.phi1024, %bb56 ], [ undef, %bb65.fragment ]		; <ptr> [#uses=8]
...
meshBB368:		; preds = %bb90.fragment, %bb8
	...
	%.SV176.phi = phi ptr [ undef, %bb8 ], [ %212, %bb90.fragment ]		; <ptr> [#uses=1]
	%.SV170.phi = phi ptr [ undef, %bb8 ], [ %210, %bb90.fragment ]		; <ptr> [#uses=1]
	%.SV172.phi = phi i32 [ undef, %bb8 ], [ %211, %bb90.fragment ]		; <i32> [#uses=1]
	%.SV76.phi = phi ptr [ %28, %bb8 ], [ undef, %bb90.fragment ]		; <ptr> [#uses=1]
	%.SV78.phi = phi i32 [ %29, %bb8 ], [ undef, %bb90.fragment ]		; <i32> [#uses=1]
	%.SV80.phi = phi ptr [ %30, %bb8 ], [ undef, %bb90.fragment ]		; <ptr> [#uses=1]
	%.load66.SV.phi = phi ptr [ %.SV52.phi1101, %bb8 ], [ undef, %bb90.fragment ]		; <ptr> [#uses=1]
	%.load35.SV.phi = phi i64 [ %3, %bb8 ], [ undef, %bb90.fragment ]		; <i64> [#uses=1]
	%.load16.SV.phi = phi ptr [ %2, %bb8 ], [ undef, %bb90.fragment ]		; <ptr> [#uses=1]
	%.SV198.phi = phi i32 [ %29, %bb8 ], [ undef, %bb90.fragment ]		; <i32> [#uses=1]
	%.SV200.phi = phi ptr [ %30, %bb8 ], [ undef, %bb90.fragment ]		; <ptr> [#uses=1]
...
meshBB372:		; preds = %bb84.fragment, %bb35
	...
	%.SV52.phi1213 = phi ptr [ %.SV52.phi1190, %bb84.fragment ], [ undef, %bb35 ]		; <ptr> [#uses=2]
...
meshBB376:		; preds = %bb98, %bb44.fragment
	...
	%.SV313.phi = phi ptr [ %237, %bb98 ], [ undef, %bb44.fragment ]		; <ptr> [#uses=1]
	%.SV315.phi = phi ptr [ %239, %bb98 ], [ undef, %bb44.fragment ]		; <ptr> [#uses=1]
	%.SV317.phi = phi ptr [ %240, %bb98 ], [ undef, %bb44.fragment ]		; <ptr> [#uses=3]
...
meshBB380:		; preds = %bb92.fragment, %bb49.fragment
	...
	%.SV111.phi1123 = phi ptr [ undef, %bb92.fragment ], [ %.SV111.phi1035, %bb49.fragment ]		; <ptr> [#uses=1]
...
meshBB384:		; preds = %bb95, %bb52
	...
	%.load53.SV.phi = phi ptr [ undef, %bb52 ], [ %.SV52.phi1217, %bb95 ]		; <ptr> [#uses=1]
	%.load20.SV.phi = phi i64 [ undef, %bb52 ], [ %3, %bb95 ]		; <i64> [#uses=1]
	%.load.SV.phi = phi ptr [ undef, %bb52 ], [ %2, %bb95 ]		; <ptr> [#uses=1]
	%.SV306.phi = phi i32 [ undef, %bb52 ], [ %227, %bb95 ]		; <i32> [#uses=1]
	%.SV308.phi = phi ptr [ undef, %bb52 ], [ %228, %bb95 ]		; <ptr> [#uses=1]
...
meshBB388:		; preds = %bb52.fragment, %bb7
	...
	%.load67.SV.phi = phi ptr [ %.SV52.phi, %bb7 ], [ undef, %bb52.fragment ]		; <ptr> [#uses=1]
	%.load36.SV.phi = phi i64 [ %3, %bb7 ], [ undef, %bb52.fragment ]		; <i64> [#uses=1]
	%.load17.SV.phi = phi ptr [ %2, %bb7 ], [ undef, %bb52.fragment ]		; <ptr> [#uses=1]
	%.SV194.phi = phi i32 [ %24, %bb7 ], [ undef, %bb52.fragment ]		; <i32> [#uses=1]
	%.SV196.phi = phi ptr [ %25, %bb7 ], [ undef, %bb52.fragment ]		; <ptr> [#uses=1]
...
meshBB392:		; preds = %bb4, %entry
	...
	%.SV52.phi1022 = phi ptr [ %9, %bb4 ], [ undef, %entry ]		; <ptr> [#uses=1]
...
meshBB400:		; preds = %bb84, %bb69.fragment
	...
	%.SV52.phi1190 = phi ptr [ %.SV52.phi1097, %bb84 ], [ undef, %bb69.fragment ]		; <ptr> [#uses=3]
	...
	%.SV162.phi = phi ptr [ undef, %bb84 ], [ %169, %bb69.fragment ]		; <ptr> [#uses=1]
	%.SV156.phi = phi ptr [ undef, %bb84 ], [ %.SV274.phi, %bb69.fragment ]		; <ptr> [#uses=1]
...
meshBB404:		; preds = %bb96, %bb3
	...
	%.SV52.phi1024 = phi ptr [ undef, %bb96 ], [ %9, %bb3 ]		; <ptr> [#uses=1]
...
meshBB408:		; preds = %bb89.fragment, %bb87
	...
	%.SV52.phi1217 = phi ptr [ %.SV52.phi1190, %bb89.fragment ], [ %.SV52.phi1235, %bb87 ]		; <ptr> [#uses=1]
...
meshBB412:		; preds = %bb68.fragment, %bb13.fragment
	...
	%.SV52.phi1186 = phi ptr [ %.SV52.phi1113, %bb13.fragment ], [ %.SV52.phi1170, %bb68.fragment ]		; <ptr> [#uses=2]
...
meshBB416:		; preds = %bb90.fragment, %bb77
	...
	%.SV52.phi1200 = phi ptr [ undef, %bb90.fragment ], [ %.SV52.phi1097, %bb77 ]		; <ptr> [#uses=1]
...
meshBB420:		; preds = %bb66, %bb26.fragment
	...
	%.load61.SV.phi = phi ptr [ %.SV52.phi1097, %bb66 ], [ undef, %bb26.fragment ]		; <ptr> [#uses=1]
	%.SV270.phi = phi i32 [ %165, %bb66 ], [ undef, %bb26.fragment ]		; <i32> [#uses=1]
	%.SV272.phi = phi ptr [ %166, %bb66 ], [ undef, %bb26.fragment ]		; <ptr> [#uses=1]
...
meshBB428:		; preds = %bb70, %bb4
	...
	%.SV52.phi = phi ptr [ undef, %bb70 ], [ %9, %bb4 ]		; <ptr> [#uses=3]
...
meshBB432:		; preds = %bb42, %bb23.fragment182
	...
	%.SV99.phi1037 = phi ptr [ %72, %bb23.fragment182 ], [ undef, %bb42 ]		; <ptr> [#uses=2]
	%.SV104.phi1036 = phi i32 [ %73, %bb23.fragment182 ], [ %.SV104.phi1127, %bb42 ]		; <i32> [#uses=3]
	%.SV111.phi1035 = phi ptr [ %74, %bb23.fragment182 ], [ %.SV111.phi1126, %bb42 ]		; <ptr> [#uses=3]
...
meshBB436:		; preds = %bb71.fragment, %bb65
	...
	%.load62.SV.phi = phi ptr [ %.SV52.phi1143, %bb65 ], [ undef, %bb71.fragment ]		; <ptr> [#uses=1]
...
meshBB440:		; preds = %bb85, %bb54.fragment
	%.SV52.phi1235 = phi ptr [ %.SV52.phi1213, %bb85 ], [ undef, %bb54.fragment ]		; <ptr> [#uses=2]
...
meshBB448:		; preds = %bb35, %entry.fragment181
	...
	%.SV111.phi1156 = phi ptr [ undef, %entry.fragment181 ], [ %.SV111.phi1083, %bb35 ]		; <ptr> [#uses=1]
...
meshBB452:		; preds = %bb70.fragment, %bb63
	...
	%.SV52.phi1109 = phi ptr [ undef, %bb70.fragment ], [ %.SV52.phi1097, %bb63 ]		; <ptr> [#uses=2]
	...
	%.SV162.phi1105 = phi ptr [ %.SV162.phi1089, %bb70.fragment ], [ undef, %bb63 ]		; <ptr> [#uses=1]
	%.SV164.phi1104 = phi i32 [ %.SV164.phi1088, %bb70.fragment ], [ undef, %bb63 ]		; <i32> [#uses=1]
	%.SV264.phi = phi ptr [ undef, %bb70.fragment ], [ %157, %bb63 ]		; <ptr> [#uses=1]
	...
	%.SV150.phi1060 = phi ptr [ undef, %bb70.fragment ], [ %148, %bb63 ]		; <ptr> [#uses=1]
	%.SV152.phi1059 = phi ptr [ undef, %bb70.fragment ], [ %149, %bb63 ]		; <ptr> [#uses=2]
...
meshBB456:		; preds = %bb79, %bb63.fragment
	...
	%.SV52.phi1136 = phi ptr [ %.SV52.phi1109, %bb63.fragment ], [ %.SV52.phi1097, %bb79 ]		; <ptr> [#uses=2]
	...
	%.SV152.phi1133 = phi ptr [ %.SV152.phi1059, %bb63.fragment ], [ undef, %bb79 ]		; <ptr> [#uses=1]
