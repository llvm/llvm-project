...
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm4 = [15,0,0,0]
; AVX512F-NEXT:    vpandn %ymm4, %ymm1, %ymm1
...
; AVX512BW-NEXT:    vpandnq %zmm3, %zmm1, %zmm1
...
; AVX512VLBW-NEXT:    vpandnq %zmm3, %zmm1, %zmm1
