...
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %ebp
; CHECK-BASELINE-NEXT:    xorb %r10b, %bpl
...
; CHECK-BASELINE-NEXT:    movb %bpl, 6(%rax)
...
; CHECK-SSE1-NEXT:    movb %bpl, 6(%rax)
...
; CHECK-BASELINE-NEXT:    movl %esi, %ebx
...
; CHECK-BASELINE-NEXT:    xorb %r10b, %r11b
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %cl
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    xorb %r12b, %r8b
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r8b
; CHECK-BASELINE-NEXT:    xorb %r12b, %r8b
...
; CHECK-BASELINE-NEXT:    xorb %r13b, %sil
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; CHECK-BASELINE-NEXT:    xorb %r9b, %dl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %dl
...
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r10d
; CHECK-BASELINE-NEXT:    xorb %r10b, %r13b
...
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r10d
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; CHECK-BASELINE-NEXT:    xorb %r9b, %r10b
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r10b
; CHECK-BASELINE-NEXT:    xorb %r9b, %r10b
; CHECK-BASELINE-NEXT:    movb %r10b, 15(%rdi)
; CHECK-BASELINE-NEXT:    movb %al, 14(%rdi)
; CHECK-BASELINE-NEXT:    movb %r13b, 13(%rdi)
; CHECK-BASELINE-NEXT:    movb %bpl, 12(%rdi)
; CHECK-BASELINE-NEXT:    movb %r15b, 11(%rdi)
; CHECK-BASELINE-NEXT:    movb %cl, 10(%rdi)
; CHECK-BASELINE-NEXT:    movb %dl, 9(%rdi)
; CHECK-BASELINE-NEXT:    movb %sil, 8(%rdi)
; CHECK-BASELINE-NEXT:    movb %r8b, 7(%rdi)
...
; CHECK-BASELINE-NEXT:    movb %bl, (%rdi)
; CHECK-BASELINE-NEXT:    movq %rdi, %rax
; CHECK-BASELINE-NEXT:    popq %rbx
; CHECK-BASELINE-NEXT:    popq %r12
...
; CHECK-SSE1-NEXT:    xorb %r10b, %r11b
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %cl
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    xorb %r12b, %r8b
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %r8b
; CHECK-SSE1-NEXT:    xorb %r12b, %r8b
...
; CHECK-SSE1-NEXT:    xorb %r13b, %sil
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; CHECK-SSE1-NEXT:    xorb %r9b, %dl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %dl
...
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r10d
; CHECK-SSE1-NEXT:    xorb %r10b, %r13b
...
; CHECK-SSE1-NEXT:    movb %cl, 10(%rdi)
; CHECK-SSE1-NEXT:    movb %dl, 9(%rdi)
; CHECK-SSE1-NEXT:    movb %sil, 8(%rdi)
; CHECK-SSE1-NEXT:    movb %r8b, 7(%rdi)
...
; CHECK-BASELINE-NEXT:    movl (%rsi), %edi
; CHECK-BASELINE-NEXT:    xorl %r9d, %edi
; CHECK-BASELINE-NEXT:    andl (%rcx), %edi
; CHECK-BASELINE-NEXT:    xorl %r9d, %edi
...
; CHECK-BASELINE-NEXT:    movl 12(%rdx), %edx
; CHECK-BASELINE-NEXT:    xorl %r8d, %r10d
; CHECK-BASELINE-NEXT:    movl 12(%rsi), %esi
; CHECK-BASELINE-NEXT:    xorl %edx, %esi
...
; CHECK-BASELINE-NEXT:    movl %edi, (%rax)
; CHECK-BASELINE-NEXT:    retq
;
...
; CHECK-BASELINE-NEXT:    movl (%rdx), %r8d
...
; CHECK-BASELINE-NEXT:    xorl %r8d, %r10d
; CHECK-BASELINE-NEXT:    movl 4(%rsi), %r8d
; CHECK-BASELINE-NEXT:    xorl %r9d, %r8d
; CHECK-BASELINE-NEXT:    andl 4(%rcx), %r8d
; CHECK-BASELINE-NEXT:    movl 12(%rdx), %edx
; CHECK-BASELINE-NEXT:    xorl %r9d, %r8d
; CHECK-BASELINE-NEXT:    movl 12(%rsi), %esi
; CHECK-BASELINE-NEXT:    xorl %edx, %esi
...
; CHECK-BASELINE-NEXT:    movzbl 3(%r9), %ecx
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    andb 3(%r10), %cl
; CHECK-BASELINE-NEXT:    xorb %dil, %al
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
...
; CHECK-BASELINE-NEXT:    movzbl 7(%r9), %ecx
; CHECK-BASELINE-NEXT:    xorb %r14b, %cl
; CHECK-BASELINE-NEXT:    andb 7(%r10), %cl
; CHECK-BASELINE-NEXT:    xorb %r15b, %al
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    xorb %r14b, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %sil, %al
; CHECK-BASELINE-NEXT:    andb 10(%r10), %al
; CHECK-BASELINE-NEXT:    movzbl 11(%r9), %ecx
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    andb 11(%r10), %cl
; CHECK-BASELINE-NEXT:    xorb %sil, %al
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-BASELINE-NEXT:    xorb %cl, %al
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 14(%r9), %ecx
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    andb 14(%r10), %cl
; CHECK-BASELINE-NEXT:    movzbl 15(%r8), %eax
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 15(%r9), %ecx
; CHECK-BASELINE-NEXT:    xorb %al, %cl
; CHECK-BASELINE-NEXT:    andb 15(%r10), %cl
; CHECK-BASELINE-NEXT:    xorb %al, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-SSE1-NEXT:    movzbl 3(%r9), %ecx
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    andb 3(%r10), %cl
; CHECK-SSE1-NEXT:    xorb %dil, %al
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    xorb %dl, %cl
...
; CHECK-SSE1-NEXT:    movzbl 7(%r9), %ecx
; CHECK-SSE1-NEXT:    xorb %r14b, %cl
; CHECK-SSE1-NEXT:    andb 7(%r10), %cl
; CHECK-SSE1-NEXT:    xorb %r15b, %al
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    xorb %r14b, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %sil, %al
; CHECK-SSE1-NEXT:    andb 10(%r10), %al
; CHECK-SSE1-NEXT:    movzbl 11(%r9), %ecx
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    andb 11(%r10), %cl
; CHECK-SSE1-NEXT:    xorb %sil, %al
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-SSE1-NEXT:    xorb %cl, %al
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 14(%r9), %ecx
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    andb 14(%r10), %cl
; CHECK-SSE1-NEXT:    movzbl 15(%r8), %eax
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 15(%r9), %ecx
; CHECK-SSE1-NEXT:    xorb %al, %cl
; CHECK-SSE1-NEXT:    andb 15(%r10), %cl
; CHECK-SSE1-NEXT:    xorb %al, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-BASELINE-NEXT:    movzwl 10(%rdx), %r12d
...
; CHECK-BASELINE-NEXT:    movzwl 2(%rdx), %r15d
; CHECK-BASELINE-NEXT:    movzwl (%rsi), %eax
; CHECK-BASELINE-NEXT:    xorw %r8w, %ax
; CHECK-BASELINE-NEXT:    movl %r8d, %r13d
; CHECK-BASELINE-NEXT:    andw (%rcx), %ax
; CHECK-BASELINE-NEXT:    movzwl 2(%rsi), %r8d
; CHECK-BASELINE-NEXT:    xorw %r15w, %r8w
; CHECK-BASELINE-NEXT:    andw 2(%rcx), %r8w
; CHECK-BASELINE-NEXT:    xorl %eax, %r13d
; CHECK-BASELINE-NEXT:    movl %r13d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    xorl %r8d, %r15d
...
; CHECK-BASELINE-NEXT:    movzwl 10(%rsi), %r8d
; CHECK-BASELINE-NEXT:    xorw %r12w, %r8w
; CHECK-BASELINE-NEXT:    andw 10(%rcx), %r8w
; CHECK-BASELINE-NEXT:    xorl %eax, %r11d
; CHECK-BASELINE-NEXT:    movl %r11d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    xorl %r8d, %r12d
...
; CHECK-BASELINE-NEXT:    movzwl 18(%rdx), %r12d
...
; CHECK-BASELINE-NEXT:    movw %r12w, 18(%rdi)
...
; CHECK-BASELINE-NEXT:    movw %r15w, 2(%rdi)
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
...
; CHECK-SSE1-NEXT:    movzwl 10(%rdx), %r12d
...
; CHECK-SSE1-NEXT:    movzwl 2(%rdx), %r15d
; CHECK-SSE1-NEXT:    movzwl (%rsi), %eax
; CHECK-SSE1-NEXT:    xorw %r8w, %ax
; CHECK-SSE1-NEXT:    movl %r8d, %r13d
; CHECK-SSE1-NEXT:    andw (%rcx), %ax
; CHECK-SSE1-NEXT:    movzwl 2(%rsi), %r8d
; CHECK-SSE1-NEXT:    xorw %r15w, %r8w
; CHECK-SSE1-NEXT:    andw 2(%rcx), %r8w
; CHECK-SSE1-NEXT:    xorl %eax, %r13d
; CHECK-SSE1-NEXT:    movl %r13d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    xorl %r8d, %r15d
...
; CHECK-SSE1-NEXT:    movzwl 10(%rsi), %r8d
; CHECK-SSE1-NEXT:    xorw %r12w, %r8w
; CHECK-SSE1-NEXT:    andw 10(%rcx), %r8w
; CHECK-SSE1-NEXT:    xorl %eax, %r11d
; CHECK-SSE1-NEXT:    movl %r11d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    xorl %r8d, %r12d
...
; CHECK-SSE1-NEXT:    movzwl 18(%rdx), %r12d
...
; CHECK-SSE1-NEXT:    movw %r12w, 18(%rdi)
...
; CHECK-SSE1-NEXT:    movw %r15w, 2(%rdi)
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
...
; CHECK-BASELINE-NEXT:    xorl %ebx, %r11d
...
; CHECK-BASELINE-NEXT:    xorl %r14d, %ebp
; CHECK-BASELINE-NEXT:    movl 20(%rsi), %r14d
; CHECK-BASELINE-NEXT:    xorl %r10d, %r14d
; CHECK-BASELINE-NEXT:    andl 20(%rcx), %r14d
; CHECK-BASELINE-NEXT:    xorl %r10d, %r14d
; CHECK-BASELINE-NEXT:    movl 24(%rsi), %r10d
; CHECK-BASELINE-NEXT:    xorl %r8d, %r10d
; CHECK-BASELINE-NEXT:    andl 24(%rcx), %r10d
; CHECK-BASELINE-NEXT:    movl 28(%rdx), %edx
; CHECK-BASELINE-NEXT:    xorl %r8d, %r10d
...
; CHECK-BASELINE-NEXT:    movl %r14d, 20(%rax)
; CHECK-BASELINE-NEXT:    movl %ebp, 16(%rax)
; CHECK-BASELINE-NEXT:    movl %ebx, 12(%rax)
...
; CHECK-SSE1-NEXT:    movl (%rsi), %edi
; CHECK-SSE1-NEXT:    xorl %r9d, %edi
; CHECK-SSE1-NEXT:    andl (%rcx), %edi
...
; CHECK-BASELINE-NEXT:    movq (%rsi), %rdi
; CHECK-BASELINE-NEXT:    xorq %r9, %rdi
; CHECK-BASELINE-NEXT:    andq (%rcx), %rdi
; CHECK-BASELINE-NEXT:    xorq %r9, %rdi
...
; CHECK-BASELINE-NEXT:    movq 24(%rdx), %rdx
; CHECK-BASELINE-NEXT:    xorq %r8, %r10
; CHECK-BASELINE-NEXT:    movq 24(%rsi), %rsi
; CHECK-BASELINE-NEXT:    xorq %rdx, %rsi
...
; CHECK-SSE1-NEXT:    movq (%rsi), %rdi
; CHECK-SSE1-NEXT:    xorq %r9, %rdi
; CHECK-SSE1-NEXT:    andq (%rcx), %rdi
; CHECK-SSE1-NEXT:    xorq %r9, %rdi
...
; CHECK-SSE1-NEXT:    movq 24(%rdx), %rdx
; CHECK-SSE1-NEXT:    xorq %r8, %r10
; CHECK-SSE1-NEXT:    movq 24(%rsi), %rsi
; CHECK-SSE1-NEXT:    xorq %rdx, %rsi
...
; CHECK-BASELINE-NEXT:    xorb %r14b, %cl
; CHECK-BASELINE-NEXT:    xorb %bpl, %r8b
; CHECK-BASELINE-NEXT:    xorb {{[0-9]+}}(%rsp), %r9b
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r15d
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
...
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %al
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r13b
; CHECK-BASELINE-NEXT:    xorb %bl, %r15b
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r15b
; CHECK-BASELINE-NEXT:    xorb %r11b, %sil
; CHECK-BASELINE-NEXT:    xorb %r12b, %dl
; CHECK-BASELINE-NEXT:    xorb %r14b, %cl
...
; CHECK-SSE1-NEXT:    xorb %r14b, %cl
; CHECK-SSE1-NEXT:    xorb %bpl, %r8b
; CHECK-SSE1-NEXT:    xorb {{[0-9]+}}(%rsp), %r9b
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r15d
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
...
; CHECK-BASELINE-NEXT:    movq %rdi, %rcx
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %esi
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %ebp
...
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %edi
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r11b
; CHECK-BASELINE-NEXT:    xorb %bl, %dil
; CHECK-BASELINE-NEXT:    xorb %r10b, %r11b
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r10d
...
; CHECK-BASELINE-NEXT:    xorb %bl, %dil
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %ebx
; CHECK-BASELINE-NEXT:    xorb %r12b, %bl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r10b
; CHECK-BASELINE-NEXT:    xorb %r13b, %r10b
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
; CHECK-BASELINE-NEXT:    xorb %r15b, %r13b
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %bl
; CHECK-BASELINE-NEXT:    xorb %r12b, %bl
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r12d
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r13b
; CHECK-BASELINE-NEXT:    xorb %r14b, %r12b
; CHECK-BASELINE-NEXT:    xorb %r15b, %r13b
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r15d
; CHECK-BASELINE-NEXT:    xorb %bpl, %r15b
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %r12b
; CHECK-BASELINE-NEXT:    xorb %r14b, %r12b
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %r14d
; CHECK-BASELINE-NEXT:    xorb %al, %r14b
...
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %al
; CHECK-BASELINE-NEXT:    xorb %sil, %bpl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %bpl
; CHECK-BASELINE-NEXT:    xorb %sil, %bpl
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %esi
; CHECK-BASELINE-NEXT:    xorb %dl, %al
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-BASELINE-NEXT:    xorb %sil, %dl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-BASELINE-NEXT:    xorb %sil, %dl
; CHECK-BASELINE-NEXT:    movb %dl, 15(%rcx)
; CHECK-BASELINE-NEXT:    movb %al, 14(%rcx)
; CHECK-BASELINE-NEXT:    movb %bpl, 13(%rcx)
; CHECK-BASELINE-NEXT:    movb %r14b, 12(%rcx)
; CHECK-BASELINE-NEXT:    movb %r15b, 11(%rcx)
; CHECK-BASELINE-NEXT:    movb %r12b, 10(%rcx)
; CHECK-BASELINE-NEXT:    movb %r13b, 9(%rcx)
; CHECK-BASELINE-NEXT:    movb %bl, 8(%rcx)
; CHECK-BASELINE-NEXT:    movb %r10b, 7(%rcx)
; CHECK-BASELINE-NEXT:    movb %dil, 6(%rcx)
; CHECK-BASELINE-NEXT:    movb %r11b, 5(%rcx)
; CHECK-BASELINE-NEXT:    movb %r9b, 4(%rcx)
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
...
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-BASELINE-NEXT:    movb %r8b, 3(%rcx)
; CHECK-BASELINE-NEXT:    xorb %al, %dl
...
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    movl %edx, %esi
; CHECK-BASELINE-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 4-byte Reload
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-BASELINE-NEXT:    movb %sil, 1(%rcx)
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    movb %dl, (%rcx)
...
; CHECK-SSE1-NEXT:    xorb %bl, %dil
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %ebx
; CHECK-SSE1-NEXT:    xorb %r12b, %bl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %r10b
; CHECK-SSE1-NEXT:    xorb %r13b, %r10b
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r13d
; CHECK-SSE1-NEXT:    xorb %r15b, %r13b
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %bl
; CHECK-SSE1-NEXT:    xorb %r12b, %bl
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r12d
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %r13b
; CHECK-SSE1-NEXT:    xorb %r14b, %r12b
; CHECK-SSE1-NEXT:    xorb %r15b, %r13b
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r15d
; CHECK-SSE1-NEXT:    xorb %bpl, %r15b
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %r12b
; CHECK-SSE1-NEXT:    xorb %r14b, %r12b
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %r14d
; CHECK-SSE1-NEXT:    xorb %al, %r14b
...
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %al
; CHECK-SSE1-NEXT:    xorb %sil, %bpl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %bpl
; CHECK-SSE1-NEXT:    xorb %sil, %bpl
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %esi
; CHECK-SSE1-NEXT:    xorb %dl, %al
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-SSE1-NEXT:    xorb %sil, %dl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-SSE1-NEXT:    xorb %sil, %dl
; CHECK-SSE1-NEXT:    movb %dl, 15(%rcx)
; CHECK-SSE1-NEXT:    movb %al, 14(%rcx)
; CHECK-SSE1-NEXT:    movb %bpl, 13(%rcx)
; CHECK-SSE1-NEXT:    movb %r14b, 12(%rcx)
; CHECK-SSE1-NEXT:    movb %r15b, 11(%rcx)
; CHECK-SSE1-NEXT:    movb %r12b, 10(%rcx)
; CHECK-SSE1-NEXT:    movb %r13b, 9(%rcx)
; CHECK-SSE1-NEXT:    movb %bl, 8(%rcx)
; CHECK-SSE1-NEXT:    movb %r10b, 7(%rcx)
; CHECK-SSE1-NEXT:    movb %dil, 6(%rcx)
; CHECK-SSE1-NEXT:    movb %r11b, 5(%rcx)
; CHECK-SSE1-NEXT:    movb %r9b, 4(%rcx)
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
...
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-SSE1-NEXT:    movb %r8b, 3(%rcx)
; CHECK-SSE1-NEXT:    xorb %al, %dl
...
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    movl %edx, %esi
; CHECK-SSE1-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 4-byte Reload
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    andb {{[0-9]+}}(%rsp), %dl
; CHECK-SSE1-NEXT:    movb %sil, 1(%rcx)
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    movb %dl, (%rcx)
...
; CHECK-BASELINE-NEXT:    movzwl {{[0-9]+}}(%rsp), %edi
; CHECK-BASELINE-NEXT:    xorw %r10w, %di
...
; CHECK-BASELINE-NEXT:    movw %r11w, 10(%rax)
; CHECK-BASELINE-NEXT:    movw %r9w, 8(%rax)
; CHECK-BASELINE-NEXT:    movw %r8w, 6(%rax)
; CHECK-BASELINE-NEXT:    movw %cx, 4(%rax)
; CHECK-BASELINE-NEXT:    movw %dx, 2(%rax)
...
; CHECK-BASELINE-NEXT:    movzbl 10(%rdx), %eax
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 9(%rdx), %eax
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 8(%rdx), %r8d
; CHECK-BASELINE-NEXT:    movzbl 7(%rdx), %r9d
; CHECK-BASELINE-NEXT:    movzbl 6(%rdx), %esi
; CHECK-BASELINE-NEXT:    movzbl 5(%rdx), %ebp
; CHECK-BASELINE-NEXT:    movzbl 4(%rdx), %edx
; CHECK-BASELINE-NEXT:    movzbl 3(%rbx), %eax
; CHECK-BASELINE-NEXT:    movzbl 2(%rbx), %ecx
; CHECK-BASELINE-NEXT:    movzbl (%rbx), %r13d
; CHECK-BASELINE-NEXT:    movzbl 1(%rbx), %edi
; CHECK-BASELINE-NEXT:    movzbl (%r14), %r10d
; CHECK-BASELINE-NEXT:    xorb %r13b, %r10b
; CHECK-BASELINE-NEXT:    movzbl 1(%r14), %r11d
; CHECK-BASELINE-NEXT:    xorb %dil, %r11b
; CHECK-BASELINE-NEXT:    andb (%r15), %r10b
; CHECK-BASELINE-NEXT:    xorb %r13b, %r10b
; CHECK-BASELINE-NEXT:    movb %r10b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 2(%r14), %r10d
; CHECK-BASELINE-NEXT:    andb 1(%r15), %r11b
; CHECK-BASELINE-NEXT:    xorb %cl, %r10b
; CHECK-BASELINE-NEXT:    xorb %dil, %r11b
; CHECK-BASELINE-NEXT:    movb %r11b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 3(%r14), %edi
; CHECK-BASELINE-NEXT:    xorb %al, %dil
; CHECK-BASELINE-NEXT:    andb 2(%r15), %r10b
; CHECK-BASELINE-NEXT:    xorb %cl, %r10b
; CHECK-BASELINE-NEXT:    movb %r10b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 4(%r14), %ecx
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    andb 3(%r15), %dil
; CHECK-BASELINE-NEXT:    xorb %al, %dil
; CHECK-BASELINE-NEXT:    movb %dil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 5(%r14), %eax
; CHECK-BASELINE-NEXT:    xorb %bpl, %al
; CHECK-BASELINE-NEXT:    andb 4(%r15), %cl
; CHECK-BASELINE-NEXT:    xorb %dl, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 6(%r14), %ecx
...
; CHECK-BASELINE-NEXT:    xorb %r9b, %al
; CHECK-BASELINE-NEXT:    andb 6(%r15), %cl
; CHECK-BASELINE-NEXT:    xorb %sil, %cl
; CHECK-BASELINE-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 8(%r14), %edx
; CHECK-BASELINE-NEXT:    xorb %r8b, %dl
; CHECK-BASELINE-NEXT:    andb 7(%r15), %al
; CHECK-BASELINE-NEXT:    xorb %r9b, %al
; CHECK-BASELINE-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 9(%r14), %esi
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %cl, %sil
; CHECK-BASELINE-NEXT:    andb 8(%r15), %dl
; CHECK-BASELINE-NEXT:    xorb %r8b, %dl
; CHECK-BASELINE-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 10(%r14), %edx
; CHECK-BASELINE-NEXT:    andb 9(%r15), %sil
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    xorb %cl, %sil
; CHECK-BASELINE-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 11(%r14), %esi
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %cl, %sil
; CHECK-BASELINE-NEXT:    andb 10(%r15), %dl
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 12(%r14), %edx
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    andb 11(%r15), %sil
; CHECK-BASELINE-NEXT:    xorb %cl, %sil
; CHECK-BASELINE-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 13(%r14), %esi
; CHECK-BASELINE-NEXT:    andb 12(%r15), %dl
; CHECK-BASELINE-NEXT:    xorb %al, %dl
; CHECK-BASELINE-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-BASELINE-NEXT:    movzbl 14(%r14), %edx
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %cl, %dl
; CHECK-BASELINE-NEXT:    andb 14(%r15), %dl
; CHECK-BASELINE-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-BASELINE-NEXT:    xorb %al, %sil
; CHECK-BASELINE-NEXT:    andb 13(%r15), %sil
; CHECK-BASELINE-NEXT:    xorb %al, %sil
; CHECK-BASELINE-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-SSE1-NEXT:    movzbl 10(%rdx), %eax
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 9(%rdx), %eax
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 8(%rdx), %r8d
; CHECK-SSE1-NEXT:    movzbl 7(%rdx), %r9d
; CHECK-SSE1-NEXT:    movzbl 6(%rdx), %esi
; CHECK-SSE1-NEXT:    movzbl 5(%rdx), %ebp
; CHECK-SSE1-NEXT:    movzbl 4(%rdx), %edx
; CHECK-SSE1-NEXT:    movzbl 3(%rbx), %eax
; CHECK-SSE1-NEXT:    movzbl 2(%rbx), %ecx
; CHECK-SSE1-NEXT:    movzbl (%rbx), %r13d
; CHECK-SSE1-NEXT:    movzbl 1(%rbx), %edi
; CHECK-SSE1-NEXT:    movzbl (%r14), %r10d
; CHECK-SSE1-NEXT:    xorb %r13b, %r10b
; CHECK-SSE1-NEXT:    movzbl 1(%r14), %r11d
; CHECK-SSE1-NEXT:    xorb %dil, %r11b
; CHECK-SSE1-NEXT:    andb (%r15), %r10b
; CHECK-SSE1-NEXT:    xorb %r13b, %r10b
; CHECK-SSE1-NEXT:    movb %r10b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 2(%r14), %r10d
; CHECK-SSE1-NEXT:    andb 1(%r15), %r11b
; CHECK-SSE1-NEXT:    xorb %cl, %r10b
; CHECK-SSE1-NEXT:    xorb %dil, %r11b
; CHECK-SSE1-NEXT:    movb %r11b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 3(%r14), %edi
; CHECK-SSE1-NEXT:    xorb %al, %dil
; CHECK-SSE1-NEXT:    andb 2(%r15), %r10b
; CHECK-SSE1-NEXT:    xorb %cl, %r10b
; CHECK-SSE1-NEXT:    movb %r10b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 4(%r14), %ecx
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    andb 3(%r15), %dil
; CHECK-SSE1-NEXT:    xorb %al, %dil
; CHECK-SSE1-NEXT:    movb %dil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 5(%r14), %eax
; CHECK-SSE1-NEXT:    xorb %bpl, %al
; CHECK-SSE1-NEXT:    andb 4(%r15), %cl
; CHECK-SSE1-NEXT:    xorb %dl, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 6(%r14), %ecx
...
; CHECK-SSE1-NEXT:    xorb %r9b, %al
; CHECK-SSE1-NEXT:    andb 6(%r15), %cl
; CHECK-SSE1-NEXT:    xorb %sil, %cl
; CHECK-SSE1-NEXT:    movb %cl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 8(%r14), %edx
; CHECK-SSE1-NEXT:    xorb %r8b, %dl
; CHECK-SSE1-NEXT:    andb 7(%r15), %al
; CHECK-SSE1-NEXT:    xorb %r9b, %al
; CHECK-SSE1-NEXT:    movb %al, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 9(%r14), %esi
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %cl, %sil
; CHECK-SSE1-NEXT:    andb 8(%r15), %dl
; CHECK-SSE1-NEXT:    xorb %r8b, %dl
; CHECK-SSE1-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 10(%r14), %edx
; CHECK-SSE1-NEXT:    andb 9(%r15), %sil
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    xorb %cl, %sil
; CHECK-SSE1-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 11(%r14), %esi
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %cl, %sil
; CHECK-SSE1-NEXT:    andb 10(%r15), %dl
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 12(%r14), %edx
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    andb 11(%r15), %sil
; CHECK-SSE1-NEXT:    xorb %cl, %sil
; CHECK-SSE1-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 13(%r14), %esi
; CHECK-SSE1-NEXT:    andb 12(%r15), %dl
; CHECK-SSE1-NEXT:    xorb %al, %dl
; CHECK-SSE1-NEXT:    movb %dl, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; CHECK-SSE1-NEXT:    movzbl 14(%r14), %edx
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %cl, %dl
; CHECK-SSE1-NEXT:    andb 14(%r15), %dl
; CHECK-SSE1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; CHECK-SSE1-NEXT:    xorb %al, %sil
; CHECK-SSE1-NEXT:    andb 13(%r15), %sil
; CHECK-SSE1-NEXT:    xorb %al, %sil
; CHECK-SSE1-NEXT:    movb %sil, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
...
; CHECK-SSE2-NEXT:    movaps 16(%rdx), %xmm1
; CHECK-SSE2-NEXT:    andps (%rdi), %xmm0
; CHECK-SSE2-NEXT:    movaps %xmm1, %xmm3
; CHECK-SSE2-NEXT:    andnps 16(%rsi), %xmm3
; CHECK-SSE2-NEXT:    andps 16(%rdi), %xmm1
; CHECK-SSE2-NEXT:    orps %xmm2, %xmm0
; CHECK-SSE2-NEXT:    orps %xmm3, %xmm1
; CHECK-SSE2-NEXT:    retq
;
...
; CHECK-BASELINE-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movzwl 22(%rdx), %edi
; CHECK-BASELINE-NEXT:    movl %edi, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movl 20(%rdx), %r10d
; CHECK-BASELINE-NEXT:    movl %r10d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; CHECK-BASELINE-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movl 4(%rdx), %ecx
; CHECK-BASELINE-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movzwl 2(%rdx), %eax
; CHECK-BASELINE-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movzwl 2(%rsi), %edx
...
; CHECK-BASELINE-NEXT:    xorw %bx, %r13w
; CHECK-BASELINE-NEXT:    movzwl 18(%rsi), %r12d
; CHECK-BASELINE-NEXT:    xorw %r11w, %r12w
; CHECK-BASELINE-NEXT:    movzwl 20(%rsi), %r15d
; CHECK-BASELINE-NEXT:    xorw %r10w, %r15w
; CHECK-BASELINE-NEXT:    movzwl 22(%rsi), %r14d
; CHECK-BASELINE-NEXT:    xorw %di, %r14w
...
; CHECK-BASELINE-NEXT:    movzwl 28(%rsi), %r10d
; CHECK-BASELINE-NEXT:    xorw {{[-0-9]+}}(%r{{[sb]}}p), %r10w # 2-byte Folded Reload
; CHECK-BASELINE-NEXT:    movzwl (%rsi), %ebp
; CHECK-BASELINE-NEXT:    movzwl 30(%rsi), %edi
; CHECK-BASELINE-NEXT:    xorw {{[-0-9]+}}(%r{{[sb]}}p), %di # 2-byte Folded Reload
; CHECK-BASELINE-NEXT:    andw 30(%r8), %di
; CHECK-BASELINE-NEXT:    andw 28(%r8), %r10w
; CHECK-BASELINE-NEXT:    andw 26(%r8), %r11w
; CHECK-BASELINE-NEXT:    andw 24(%r8), %bx
; CHECK-BASELINE-NEXT:    andw 22(%r8), %r14w
; CHECK-BASELINE-NEXT:    andw 20(%r8), %r15w
; CHECK-BASELINE-NEXT:    andw 18(%r8), %r12w
; CHECK-BASELINE-NEXT:    andw 16(%r8), %r13w
; CHECK-BASELINE-NEXT:    andw 14(%r8), %ax
; CHECK-BASELINE-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    andw 12(%r8), %dx
; CHECK-BASELINE-NEXT:    movl %edx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-BASELINE-NEXT:    andw 10(%r8), %ax
; CHECK-BASELINE-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 4-byte Reload
; CHECK-BASELINE-NEXT:    andw 8(%r8), %dx
; CHECK-BASELINE-NEXT:    andw 6(%r8), %cx
; CHECK-BASELINE-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-BASELINE-NEXT:    andw 4(%r8), %ax
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 4-byte Reload
; CHECK-BASELINE-NEXT:    andw 2(%r8), %cx
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 4-byte Reload
; CHECK-BASELINE-NEXT:    xorw %si, %bp
; CHECK-BASELINE-NEXT:    andw (%r8), %bp
; CHECK-BASELINE-NEXT:    xorl %esi, %ebp
...
; CHECK-BASELINE-NEXT:    movw %di, 30(%r9)
; CHECK-BASELINE-NEXT:    movw %r10w, 28(%r9)
; CHECK-BASELINE-NEXT:    movw %r11w, 26(%r9)
; CHECK-BASELINE-NEXT:    movw %bx, 24(%r9)
; CHECK-BASELINE-NEXT:    movw %r14w, 22(%r9)
; CHECK-BASELINE-NEXT:    movw %r15w, 20(%r9)
; CHECK-BASELINE-NEXT:    movw %r12w, 18(%r9)
; CHECK-BASELINE-NEXT:    movw %r13w, 16(%r9)
; CHECK-BASELINE-NEXT:    movw %si, 14(%r9)
; CHECK-BASELINE-NEXT:    movw %ax, 12(%r9)
; CHECK-BASELINE-NEXT:    movw %dx, 10(%r9)
; CHECK-BASELINE-NEXT:    movw %cx, 8(%r9)
; CHECK-BASELINE-NEXT:    movw %r8w, 6(%r9)
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-BASELINE-NEXT:    movw %ax, 4(%r9)
; CHECK-BASELINE-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-BASELINE-NEXT:    movw %ax, 2(%r9)
; CHECK-BASELINE-NEXT:    movw %bp, (%r9)
...
; CHECK-SSE1-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movzwl 22(%rdx), %edi
; CHECK-SSE1-NEXT:    movl %edi, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movl 20(%rdx), %r10d
; CHECK-SSE1-NEXT:    movl %r10d, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; CHECK-SSE1-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movl 4(%rdx), %ecx
; CHECK-SSE1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movzwl 2(%rdx), %eax
; CHECK-SSE1-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movzwl 2(%rsi), %edx
...
; CHECK-SSE1-NEXT:    xorw %bx, %r13w
; CHECK-SSE1-NEXT:    movzwl 18(%rsi), %r12d
; CHECK-SSE1-NEXT:    xorw %r11w, %r12w
; CHECK-SSE1-NEXT:    movzwl 20(%rsi), %r15d
; CHECK-SSE1-NEXT:    xorw %r10w, %r15w
; CHECK-SSE1-NEXT:    movzwl 22(%rsi), %r14d
; CHECK-SSE1-NEXT:    xorw %di, %r14w
...
; CHECK-SSE1-NEXT:    movzwl 28(%rsi), %r10d
; CHECK-SSE1-NEXT:    xorw {{[-0-9]+}}(%r{{[sb]}}p), %r10w # 2-byte Folded Reload
; CHECK-SSE1-NEXT:    movzwl (%rsi), %ebp
; CHECK-SSE1-NEXT:    movzwl 30(%rsi), %edi
; CHECK-SSE1-NEXT:    xorw {{[-0-9]+}}(%r{{[sb]}}p), %di # 2-byte Folded Reload
; CHECK-SSE1-NEXT:    andw 30(%r8), %di
; CHECK-SSE1-NEXT:    andw 28(%r8), %r10w
; CHECK-SSE1-NEXT:    andw 26(%r8), %r11w
; CHECK-SSE1-NEXT:    andw 24(%r8), %bx
; CHECK-SSE1-NEXT:    andw 22(%r8), %r14w
; CHECK-SSE1-NEXT:    andw 20(%r8), %r15w
; CHECK-SSE1-NEXT:    andw 18(%r8), %r12w
; CHECK-SSE1-NEXT:    andw 16(%r8), %r13w
; CHECK-SSE1-NEXT:    andw 14(%r8), %ax
; CHECK-SSE1-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    andw 12(%r8), %dx
; CHECK-SSE1-NEXT:    movl %edx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-SSE1-NEXT:    andw 10(%r8), %ax
; CHECK-SSE1-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 4-byte Reload
; CHECK-SSE1-NEXT:    andw 8(%r8), %dx
; CHECK-SSE1-NEXT:    andw 6(%r8), %cx
; CHECK-SSE1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-SSE1-NEXT:    andw 4(%r8), %ax
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 4-byte Reload
; CHECK-SSE1-NEXT:    andw 2(%r8), %cx
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 4-byte Reload
; CHECK-SSE1-NEXT:    xorw %si, %bp
; CHECK-SSE1-NEXT:    andw (%r8), %bp
; CHECK-SSE1-NEXT:    xorl %esi, %ebp
...
; CHECK-SSE1-NEXT:    movw %di, 30(%r9)
; CHECK-SSE1-NEXT:    movw %r10w, 28(%r9)
; CHECK-SSE1-NEXT:    movw %r11w, 26(%r9)
; CHECK-SSE1-NEXT:    movw %bx, 24(%r9)
; CHECK-SSE1-NEXT:    movw %r14w, 22(%r9)
; CHECK-SSE1-NEXT:    movw %r15w, 20(%r9)
; CHECK-SSE1-NEXT:    movw %r12w, 18(%r9)
; CHECK-SSE1-NEXT:    movw %r13w, 16(%r9)
; CHECK-SSE1-NEXT:    movw %si, 14(%r9)
; CHECK-SSE1-NEXT:    movw %ax, 12(%r9)
; CHECK-SSE1-NEXT:    movw %dx, 10(%r9)
; CHECK-SSE1-NEXT:    movw %cx, 8(%r9)
; CHECK-SSE1-NEXT:    movw %r8w, 6(%r9)
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-SSE1-NEXT:    movw %ax, 4(%r9)
; CHECK-SSE1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 4-byte Reload
; CHECK-SSE1-NEXT:    movw %ax, 2(%r9)
; CHECK-SSE1-NEXT:    movw %bp, (%r9)
...
; CHECK-BASELINE-NEXT:    pushq %rbx
; CHECK-BASELINE-NEXT:    movq %rcx, %r8
; CHECK-BASELINE-NEXT:    movl 28(%rdx), %ebx
; CHECK-BASELINE-NEXT:    movl 24(%rdx), %r11d
; CHECK-BASELINE-NEXT:    movl 20(%rdx), %ecx
; CHECK-BASELINE-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; CHECK-BASELINE-NEXT:    movl 8(%rsi), %r10d
; CHECK-BASELINE-NEXT:    xorl %r14d, %r10d
; CHECK-BASELINE-NEXT:    movl 12(%rsi), %ebp
; CHECK-BASELINE-NEXT:    xorl %r15d, %ebp
; CHECK-BASELINE-NEXT:    movl 16(%rsi), %r15d
...
; CHECK-BASELINE-NEXT:    andl 20(%r8), %edx
; CHECK-BASELINE-NEXT:    andl 16(%r8), %r15d
; CHECK-BASELINE-NEXT:    andl 12(%r8), %ebp
; CHECK-BASELINE-NEXT:    andl 8(%r8), %r10d
; CHECK-BASELINE-NEXT:    andl 4(%r8), %r9d
; CHECK-BASELINE-NEXT:    xorl %r13d, %ecx
; CHECK-BASELINE-NEXT:    andl (%r8), %ecx
; CHECK-BASELINE-NEXT:    xorl %r13d, %ecx
; CHECK-BASELINE-NEXT:    xorl %r12d, %r9d
; CHECK-BASELINE-NEXT:    xorl %r14d, %r10d
...
; CHECK-BASELINE-NEXT:    movl %r15d, 16(%rdi)
; CHECK-BASELINE-NEXT:    movl %ebp, 12(%rdi)
; CHECK-BASELINE-NEXT:    movl %r10d, 8(%rdi)
; CHECK-BASELINE-NEXT:    movl %r9d, 4(%rdi)
; CHECK-BASELINE-NEXT:    movl %ecx, (%rdi)
; CHECK-BASELINE-NEXT:    movq %rdi, %rax
; CHECK-BASELINE-NEXT:    popq %rbx
; CHECK-BASELINE-NEXT:    popq %r12
; CHECK-BASELINE-NEXT:    popq %r13
...
; CHECK-SSE1-NEXT:    pushq %rbx
; CHECK-SSE1-NEXT:    movq %rcx, %r8
; CHECK-SSE1-NEXT:    movl 28(%rdx), %ebx
; CHECK-SSE1-NEXT:    movl 24(%rdx), %r11d
; CHECK-SSE1-NEXT:    movl 20(%rdx), %ecx
; CHECK-SSE1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; CHECK-SSE1-NEXT:    movl 8(%rsi), %r10d
; CHECK-SSE1-NEXT:    xorl %r14d, %r10d
; CHECK-SSE1-NEXT:    movl 12(%rsi), %ebp
; CHECK-SSE1-NEXT:    xorl %r15d, %ebp
; CHECK-SSE1-NEXT:    movl 16(%rsi), %r15d
...
; CHECK-SSE1-NEXT:    andl 20(%r8), %edx
; CHECK-SSE1-NEXT:    andl 16(%r8), %r15d
; CHECK-SSE1-NEXT:    andl 12(%r8), %ebp
; CHECK-SSE1-NEXT:    andl 8(%r8), %r10d
; CHECK-SSE1-NEXT:    andl 4(%r8), %r9d
; CHECK-SSE1-NEXT:    xorl %r13d, %ecx
; CHECK-SSE1-NEXT:    andl (%r8), %ecx
; CHECK-SSE1-NEXT:    xorl %r13d, %ecx
; CHECK-SSE1-NEXT:    xorl %r12d, %r9d
; CHECK-SSE1-NEXT:    xorl %r14d, %r10d
...
; CHECK-SSE1-NEXT:    movl %r15d, 16(%rdi)
; CHECK-SSE1-NEXT:    movl %ebp, 12(%rdi)
; CHECK-SSE1-NEXT:    movl %r10d, 8(%rdi)
; CHECK-SSE1-NEXT:    movl %r9d, 4(%rdi)
; CHECK-SSE1-NEXT:    movl %ecx, (%rdi)
; CHECK-SSE1-NEXT:    movq %rdi, %rax
; CHECK-SSE1-NEXT:    popq %rbx
; CHECK-SSE1-NEXT:    popq %r12
; CHECK-SSE1-NEXT:    popq %r13
