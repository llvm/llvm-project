...
entry:
	...
	store <5 x i16> < i16 1, i16 1, i16 1, i16 0, i16 0 >, ptr %v
	store i32 0, ptr %i
	br label %forcond
...
forbody:
	...
	%arrayidx = getelementptr <5 x i16>, ptr %tmp3, i32 %tmp2
	%tmp4 = load i32, ptr %i
	%tmp5 = load ptr, ptr %src.addr
	%arrayidx6 = getelementptr <5 x i16>, ptr %tmp5, i32 %tmp4
	%tmp7 = load <5 x i16>, ptr %arrayidx6
	%sub = sub <5 x i16> %tmp7, < i16 271, i16 271, i16 271, i16 271, i16 271 >
	%mul = mul <5 x i16> %sub, < i16 2, i16 4, i16 2, i16 2, i16 2 >
	store <5 x i16> %mul, ptr %arrayidx
	br label %forinc
