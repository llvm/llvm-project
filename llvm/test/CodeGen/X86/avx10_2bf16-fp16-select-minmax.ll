...
define half @select_ogt_f16(half %a, half %b) {
; CHECK-LABEL: select_ogt_f16:
; CHECK:       # %bb.0:
...
define <8 x half> @select_olt_v8f16(<8 x half> %a, <8 x half> %b) {
; CHECK-LABEL: select_olt_v8f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vminph %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    retq
  %cmp = fcmp olt <8 x half> %a, %b
  %sel = select <8 x i1> %cmp, <8 x half> %a, <8 x half> %b
  ret <8 x half> %sel
}

define <16 x half> @select_ogt_v16f16(<16 x half> %a, <16 x half> %b) {
; CHECK-LABEL: select_ogt_v16f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxph %ymm1, %ymm0, %ymm0
; CHECK-NEXT:    retq
  %cmp = fcmp ogt <16 x half> %a, %b
  %sel = select <16 x i1> %cmp, <16 x half> %a, <16 x half> %b
  ret <16 x half> %sel
}

define <32 x half> @select_olt_v32f16(<32 x half> %a, <32 x half> %b) {
; CHECK-LABEL: select_olt_v32f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vminph %zmm1, %zmm0, %zmm0
; CHECK-NEXT:    retq
  %cmp = fcmp olt <32 x half> %a, %b
  %sel = select <32 x i1> %cmp, <32 x half> %a, <32 x half> %b
  ret <32 x half> %sel
}
