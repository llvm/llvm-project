...
; CHECK-NEXT:    retq
  ...
  %tmp4 = select fast <16 x i1> %tmp, <16 x float> %a, <16 x float> %b
  ret <16 x float> %tmp4;
}
...
; CHECK-NEXT:    retq
  ...
  %tmp4 = select fast <8 x i1> %tmp, <8 x double> %a, <8 x double> %b
  ret <8 x double> %tmp4;
}
...
entry:
  ...
  %2 = select fast i1 %1, float %0, float %a
  ret float %2
}
...
entry:
  ...
  %2 = select fast i1 %1, double %0, double %a
  ret double %2
}
