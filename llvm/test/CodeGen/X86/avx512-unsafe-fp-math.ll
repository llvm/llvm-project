...
; RUN: llc < %s -mtriple=x86_64 -mattr=+avx512f | FileCheck %s --check-prefix=SAFE
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_max_v16f32:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmaxps (%rdi), %zmm0, %zmm0
; SAFE-NEXT:    retq
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_max_v16f32_safe:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovaps (%rdi), %zmm1
; SAFE-NEXT:    vmaxps %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
  %a = load <16 x float>, ptr %a_ptr
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_min_v16f32:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovaps (%rdi), %zmm1
; SAFE-NEXT:    vminps %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
  %a = load <16 x float>, ptr %a_ptr
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_min_v16f32_safe:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovaps (%rdi), %zmm1
; SAFE-NEXT:    vminps %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_max_v8f64:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmaxpd (%rdi), %zmm0, %zmm0
; SAFE-NEXT:    retq
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_max_v8f64_safe:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovapd (%rdi), %zmm1
; SAFE-NEXT:    vmaxpd %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
  %a = load <8 x double>, ptr %a_ptr
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_min_v8f64:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovapd (%rdi), %zmm1
; SAFE-NEXT:    vminpd %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
  %a = load <8 x double>, ptr %a_ptr
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_min_v8f64_safe:
; SAFE:       # %bb.0:
; SAFE-NEXT:    vmovapd (%rdi), %zmm1
; SAFE-NEXT:    vminpd %zmm0, %zmm1, %zmm0
; SAFE-NEXT:    retq
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_min_f32:
; SAFE:       # %bb.0: # %entry
; SAFE-NEXT:    vmovss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; SAFE-NEXT:    vminss %xmm0, %xmm1, %xmm0
; SAFE-NEXT:    retq
entry:
...
; CHECK-NEXT:    retq
;
; SAFE-LABEL: test_max_f64:
; SAFE:       # %bb.0: # %entry
; SAFE-NEXT:    vmovsd {{.*#+}} xmm1 = mem[0],zero
; SAFE-NEXT:    vmaxsd %xmm0, %xmm1, %xmm0
; SAFE-NEXT:    retq
entry:
