...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[0,1,0,3]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,5,7,6,7]
; AVX2-NEXT:    vpunpckhdq {{.*#+}} xmm0 = xmm4[2],xmm0[2],xmm4[3],xmm0[3]
; AVX2-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm2[3],xmm0[4,5,6,7]
; AVX2-NEXT:    vmovq %xmm0, (%rdx)
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm2[2,3]
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3]
; AVX2-NEXT:    vpshufb {{.*#+}} xmm4 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
; AVX2-NEXT:    vmovq %xmm4, (%rcx)
; AVX2-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,2,3,14,15,10,11,u,u,u,u,u,u,u,u]
; AVX2-NEXT:    vmovq %xmm0, (%r8)
; AVX2-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm3[2],xmm2[3]
...
; AVX2-FP-NEXT:    vpsrld $16, %xmm1, %xmm0
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm3[u,u,u,u,u,u,u,u,2,3,14,15,12,13,14,15]
; AVX2-FP-NEXT:    vpunpckhdq {{.*#+}} xmm0 = xmm4[2],xmm0[2],xmm4[3],xmm0[3]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm2[3],xmm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovq %xmm0, (%rdx)
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm2[2,3]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vmovq %xmm4, (%rcx)
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,2,3,14,15,10,11,u,u,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vmovq %xmm0, (%r8)
; AVX2-FP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm3[2],xmm2[3]
...
; AVX2-FCP-NEXT:    vpsrld $16, %xmm1, %xmm0
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm3[u,u,u,u,u,u,u,u,2,3,14,15,12,13,14,15]
; AVX2-FCP-NEXT:    vpunpckhdq {{.*#+}} xmm0 = xmm4[2],xmm0[2],xmm4[3],xmm0[3]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm2[3],xmm0[4,5,6,7]
; AVX2-FCP-NEXT:    vmovq %xmm0, (%rdx)
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm3[0,1],xmm2[2,3]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vmovq %xmm4, (%rcx)
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[6,7,2,3,14,15,10,11,u,u,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vmovq %xmm0, (%r8)
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm3[2],xmm2[3]
...
; AVX512-NEXT:    vpermd %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vpshufb {{.*#+}} xmm2 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
...
; AVX512-FCP-NEXT:    vpermd %zmm1, %zmm0, %zmm0
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm2 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
...
; AVX512DQ-NEXT:    vpermd %zmm1, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufb {{.*#+}} xmm2 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
...
; AVX512DQ-FCP-NEXT:    vpermd %zmm1, %zmm0, %zmm0
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm2 = xmm0[4,5,0,1,12,13,8,9,u,u,u,u,u,u,u,u]
...
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm2[0],ymm3[1],ymm2[2,3],ymm3[4],ymm2[5,6],ymm3[7]
; AVX512-FCP-NEXT:    vpshufb %xmm1, %xmm5, %xmm6
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [6,5,4,7]
; AVX512-FCP-NEXT:    vpermd %ymm5, %ymm7, %ymm8
; AVX512-FCP-NEXT:    vpshufb %xmm1, %xmm8, %xmm1
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm6[0,1],xmm1[2],xmm6[3],xmm1[4,5],xmm6[6,7]
...
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm4 = ymm9[u,u,u,u,u,u,u,u,u,u,u,u,8,9,4,5,16,17,28,29,24,25,28,29,24,25,28,29,24,25,20,21]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0,1,2],ymm4[3,4,5,6,7]
; AVX512-FCP-NEXT:    vmovdqa 160(%rdi), %ymm4
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm10 = ymm0[0,1],ymm4[2],ymm0[3,4],ymm4[5],ymm0[6,7]
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm5 = xmm5[0,1],xmm8[2],xmm5[3],xmm8[4,5],xmm5[6,7]
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm8 = ymm9[u,u,u,u,u,u,u,u,u,u,u,u,10,11,6,7,18,19,30,31,26,27,26,27,30,31,26,27,26,27,22,23]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1,2],ymm8[3,4,5,6,7]
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm8 = ymm5[0,1,2],ymm8[3,4,5,6,7],ymm5[8,9,10],ymm8[11,12,13,14,15]
...
; AVX512-FCP-NEXT:    vmovdqa64 128(%rdi), %xmm17
; AVX512-FCP-NEXT:    vmovdqa 160(%rdi), %xmm14
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm15 = [6,1,0,3]
; AVX512-FCP-NEXT:    vpermi2d %xmm17, %xmm14, %xmm15
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm15[0,1,0,1,0,1,0,1,u,u,8,9,12,13,u,u]
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm16 = [12,5,14,5]
; AVX512-FCP-NEXT:    vpermd 128(%rdi), %zmm16, %zmm12
; AVX512-FCP-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm12[0,1,2,3,6,5,6,4]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2,3],xmm1[4],xmm0[5,6],xmm1[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm8[0,1,2],ymm0[3,4,5,6,7],ymm8[8,9,10],ymm0[11,12,13,14,15]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm13[0,1,2,3],ymm0[4,5,6,7]
; AVX512-FCP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm9[3,1,2,1,4,5,6,7]
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm10[u,u,2,3,6,7,u,u,14,15,u,u,u,u,u,u]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm1[1,2],xmm0[3],xmm1[4,5,6,7]
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm11[6,7,2,3,14,15,14,15,14,15,2,3,14,15,10,11,22,23,18,19,30,31,30,31,30,31,18,19,30,31,26,27]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm9 = xmm0[0,1,2,3,4],xmm1[5,6,7]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm15[2,3,2,3,2,3,2,3,u,u,10,11,14,15,u,u]
; AVX512-FCP-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm12[0,1,2,3,7,5,6,5]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1,2,3],xmm10[4],xmm1[5,6],xmm10[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4,5,6,7],ymm0[8,9,10],ymm1[11,12,13,14,15]
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm9 = ymm9[0,1,2,3],ymm0[4,5,6,7]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} xmm1 = [0,1,2,3,0,1,4,5,8,9,12,13,0,1,12,13]
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm10 = [0,3,2,5]
; AVX512-FCP-NEXT:    vpermi2d %xmm14, %xmm17, %xmm10
; AVX512-FCP-NEXT:    vmovdqa64 %ymm19, %ymm11
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm11[0],ymm4[1],ymm11[2,3],ymm4[4],ymm11[5,6],ymm4[7]
; AVX512-FCP-NEXT:    vpshufb %xmm1, %xmm10, %xmm11
; AVX512-FCP-NEXT:    vextracti128 $1, %ymm4, %xmm4
; AVX512-FCP-NEXT:    vpshufb %xmm1, %xmm4, %xmm1
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm11[0,1,2,3],xmm1[4],xmm11[5],xmm1[6,7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm6[0,1,2,3,4],ymm1[5,6,7]
...
; AVX512-FCP-NEXT:    vpshufb %xmm2, %xmm10, %xmm3
...
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm2[0],ymm3[1],ymm2[2,3],ymm3[4],ymm2[5,6],ymm3[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm1, %xmm5, %xmm6
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm7 = [6,5,4,7]
; AVX512DQ-FCP-NEXT:    vpermd %ymm5, %ymm7, %ymm8
; AVX512DQ-FCP-NEXT:    vpshufb %xmm1, %xmm8, %xmm1
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm6[0,1],xmm1[2],xmm6[3],xmm1[4,5],xmm6[6,7]
...
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm4 = ymm9[u,u,u,u,u,u,u,u,u,u,u,u,8,9,4,5,16,17,28,29,24,25,28,29,24,25,28,29,24,25,20,21]
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0,1,2],ymm4[3,4,5,6,7]
; AVX512DQ-FCP-NEXT:    vmovdqa 160(%rdi), %ymm4
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm10 = ymm0[0,1],ymm4[2],ymm0[3,4],ymm4[5],ymm0[6,7]
...
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm8 = ymm9[u,u,u,u,u,u,u,u,u,u,u,u,10,11,6,7,18,19,30,31,26,27,26,27,30,31,26,27,26,27,22,23]
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0,1,2],ymm8[3,4,5,6,7]
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm8 = ymm5[0,1,2],ymm8[3,4,5,6,7],ymm5[8,9,10],ymm8[11,12,13,14,15]
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rdi), %xmm17
; AVX512DQ-FCP-NEXT:    vmovdqa 160(%rdi), %xmm14
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm15 = [6,1,0,3]
; AVX512DQ-FCP-NEXT:    vpermi2d %xmm17, %xmm14, %xmm15
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm0 = xmm15[0,1,0,1,0,1,0,1,u,u,8,9,12,13,u,u]
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm16 = [12,5,14,5]
; AVX512DQ-FCP-NEXT:    vpermd 128(%rdi), %zmm16, %zmm12
; AVX512DQ-FCP-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm12[0,1,2,3,6,5,6,4]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1,2,3],xmm1[4],xmm0[5,6],xmm1[7]
...
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm8 = ymm13[0,1,2,3],ymm0[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm9[3,1,2,1,4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm10[u,u,2,3,6,7,u,u,14,15,u,u,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm1[1,2],xmm0[3],xmm1[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm11[6,7,2,3,14,15,14,15,14,15,2,3,14,15,10,11,22,23,18,19,30,31,30,31,30,31,18,19,30,31,26,27]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm9 = xmm0[0,1,2,3,4],xmm1[5,6,7]
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} xmm1 = xmm15[2,3,2,3,2,3,2,3,u,u,10,11,14,15,u,u]
; AVX512DQ-FCP-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm12[0,1,2,3,7,5,6,5]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1,2,3],xmm10[4],xmm1[5,6],xmm10[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4,5,6,7],ymm0[8,9,10],ymm1[11,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm9 = ymm9[0,1,2,3],ymm0[4,5,6,7]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} xmm1 = [0,1,2,3,0,1,4,5,8,9,12,13,0,1,12,13]
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} xmm10 = [0,3,2,5]
; AVX512DQ-FCP-NEXT:    vpermi2d %xmm14, %xmm17, %xmm10
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm19, %ymm11
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm11[0],ymm4[1],ymm11[2,3],ymm4[4],ymm11[5,6],ymm4[7]
...
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} xmm1 = xmm11[0,1,2,3],xmm1[4],xmm11[5],xmm1[6,7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm6[0,1,2,3,4],ymm1[5,6,7]
...
; AVX512DQ-FCP-NEXT:    vpshufb %xmm2, %xmm10, %xmm3
