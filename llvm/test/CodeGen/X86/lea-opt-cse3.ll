...
; X86-NEXT:    leal (%esi,%edx,4), %ecx
; X86-NEXT:    addl $4, %ecx
; X86-NEXT:    xorl %eax, %eax
; X86-NEXT:    cmpl $10, %ecx
; X86-NEXT:    je .LBB2_2
; X86-NEXT:  # %bb.1: # %mid
; X86-NEXT:    leal (%esi,%edx,8), %eax
; X86-NEXT:    addl $4, %eax
