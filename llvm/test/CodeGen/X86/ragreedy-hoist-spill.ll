...
; CHECK-NEXT:  ## %bb.11: ## %while.body200.preheader
...
; CHECK-NEXT:    ja LBB0_13
; CHECK-NEXT:  ## %bb.24: ## %while.body200
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    movslq (%rdx,%rax,4), %rax
; CHECK-NEXT:    addq %rdx, %rax
; CHECK-NEXT:    jmpq *%rax
; CHECK-NEXT:  LBB0_25: ## %while.cond201.preheader
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    movl $1, %ebp
; CHECK-NEXT:    jmp LBB0_13
; CHECK-NEXT:  LBB0_26: ## %sw.bb1134
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    leaq {{[0-9]+}}(%rsp), %rax
; CHECK-NEXT:    leaq {{[0-9]+}}(%rsp), %rcx
; CHECK-NEXT:    cmpq %rax, %rcx
; CHECK-NEXT:    jb LBB0_56
; CHECK-NEXT:  ## %bb.27: ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) ## 4-byte Folded Spill
; CHECK-NEXT:    movl $268, %ebp ## imm = 0x10C
; CHECK-NEXT:    jmp LBB0_13
; CHECK-NEXT:  LBB0_28: ## %sw.bb566
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
...
; CHECK-NEXT:    jmp LBB0_13
; CHECK-NEXT:  LBB0_30: ## %if.end517.loopexitsplit
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    incq %rbx
; CHECK-NEXT:  LBB0_31: ## %if.end517
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
; CHECK-NEXT:    leal -324(%r15), %eax
; CHECK-NEXT:    cmpl $59, %eax
; CHECK-NEXT:    ja LBB0_33
; CHECK-NEXT:  ## %bb.32: ## %if.end517
; CHECK-NEXT:    ## in Loop: Header=BB0_14 Depth=1
...
; CHECK-NEXT:    jmp LBB0_13
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_38: ## %while.cond864
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    jmp LBB0_38
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_39: ## %while.cond962
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    jmp LBB0_39
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_40: ## %for.cond357
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    jmp LBB0_40
; CHECK-NEXT:  LBB0_41:
; CHECK-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) ## 4-byte Folded Spill
; CHECK-NEXT:  LBB0_42: ## %while.end1465
; CHECK-NEXT:    incl %ebp
; CHECK-NEXT:    cmpl $16, %ebp
; CHECK-NEXT:    ja LBB0_51
; CHECK-NEXT:  ## %bb.43: ## %while.end1465
...
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_46: ## %for.body1723
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    decq %rax
...
; CHECK-NEXT:  LBB0_48: ## %while.cond635.preheader
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:    je LBB0_50
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_49: ## %for.body643.us
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
...
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:    je LBB0_56
; CHECK-NEXT:  ## %bb.52: ## %for.body1664.lr.ph
; CHECK-NEXT:    xorl %eax, %eax
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r14 ## 8-byte Reload
; CHECK-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %ebp ## 4-byte Reload
; CHECK-NEXT:    jne LBB0_55
; CHECK-NEXT:  ## %bb.53: ## %while.body1679.preheader
; CHECK-NEXT:    incl %ebp
; CHECK-NEXT:    xorl %ebx, %ebx
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_54: ## %while.body1679
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    movq (%r14), %rdi
...
; CHECK-NEXT:  LBB0_55: ## %while.cond1683.preheader
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:  LBB0_56: ## %if.then.i
; CHECK-NEXT:    ud2
entry:
