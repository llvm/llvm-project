...
; RUN: llc -mtriple=i686-none-linux -fast-isel -mattr=+sse2 < %s | FileCheck %s --check-prefixes=X86,X86-SSE
; RUN: llc -mtriple=x86_64-none-linux -fast-isel -mattr=+sse2 < %s | FileCheck %s --check-prefixes=X64,X64-SSE
; RUN: llc -mtriple=i686-none-linux -fast-isel -mattr=+avx < %s | FileCheck %s --check-prefixes=X86,X86-AVX,X86-AVX1
; RUN: llc -mtriple=x86_64-none-linux -fast-isel -mattr=+avx < %s | FileCheck %s --check-prefixes=X64,X64-AVX,X64-AVX1
; RUN: llc -mtriple=i686-none-linux -fast-isel -mattr=+avx512f < %s | FileCheck %s --check-prefixes=X86,X86-AVX,X86-AVX512
; RUN: llc -mtriple=x86_64-none-linux -fast-isel -mattr=+avx512f < %s | FileCheck %s --check-prefixes=X64,X64-AVX,X64-AVX512
; RUN: llc -mtriple=i686-none-linux -fast-isel -mattr=+avx512f,+avx512dq,+avx512bw < %s | FileCheck %s --check-prefixes=X86,X86-AVX,X86-AVX512
; RUN: llc -mtriple=x86_64-none-linux -fast-isel -mattr=+avx512vl,+avx512dq,+avx512bw < %s | FileCheck %s --check-prefixes=X64,X64-AVX,X64-AVX512
