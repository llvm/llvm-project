...
declare <8 x i32> @llvm.x86.avx512.mask.vpdpbusd.256(<8 x i32>, <32 x i8>, <32 x i8>, i8)
declare <8 x i32> @llvm.x86.avx512.maskz.vpdpbusd.256(<8 x i32>, <32 x i8>, <32 x i8>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <8 x i32> @llvm.x86.avx512.mask.vpdpbusd.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x2, i8 -1)
  ret <8 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  ...
  %res0 = call <8 x i32> @llvm.x86.avx512.mask.vpdpbusd.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x2, i8 %x3)
  %res1 = call <8 x i32> @llvm.x86.avx512.maskz.vpdpbusd.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x4, i8  %x3)
...
declare <4 x i32> @llvm.x86.avx512.mask.vpdpbusd.128(<4 x i32>, <16 x i8>, <16 x i8>, i8)
declare <4 x i32> @llvm.x86.avx512.maskz.vpdpbusd.128(<4 x i32>, <16 x i8>, <16 x i8>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <4 x i32> @llvm.x86.avx512.mask.vpdpbusd.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x2, i8 -1)
  ret <4 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  ...
  %res0 = call <4 x i32> @llvm.x86.avx512.mask.vpdpbusd.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x2, i8 %x3)
  %res1 = call <4 x i32> @llvm.x86.avx512.maskz.vpdpbusd.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x4, i8  %x3)
...
declare <8 x i32> @llvm.x86.avx512.mask.vpdpbusds.256(<8 x i32>, <32 x i8>, <32 x i8>, i8)
declare <8 x i32> @llvm.x86.avx512.maskz.vpdpbusds.256(<8 x i32>, <32 x i8>, <32 x i8>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <8 x i32> @llvm.x86.avx512.mask.vpdpbusds.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x2, i8 -1)
  ret <8 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  %x2 = load <32 x i8>, ptr %x2p
  %res0 = call <8 x i32> @llvm.x86.avx512.mask.vpdpbusds.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x2, i8 %x3)
  %res1 = call <8 x i32> @llvm.x86.avx512.maskz.vpdpbusds.256(<8 x i32> %x0, <32 x i8> %x1, <32 x i8> %x4, i8  %x3)
  %res2 = insertvalue { <8 x i32>, <8 x i32> } poison, <8 x i32> %res0, 0
  %res3 = insertvalue { <8 x i32>, <8 x i32> }  %res2, <8 x i32> %res1, 1
  ret { <8 x i32>, <8 x i32> } %res3
}

declare <4 x i32> @llvm.x86.avx512.mask.vpdpbusds.128(<4 x i32>, <16 x i8>, <16 x i8>, i8)
declare <4 x i32> @llvm.x86.avx512.maskz.vpdpbusds.128(<4 x i32>, <16 x i8>, <16 x i8>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <4 x i32> @llvm.x86.avx512.mask.vpdpbusds.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x2, i8 -1)
  ret <4 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  %x2 = load <16 x i8>, ptr %x2p
  %res0 = call <4 x i32> @llvm.x86.avx512.mask.vpdpbusds.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x2, i8 %x3)
  %res1 = call <4 x i32> @llvm.x86.avx512.maskz.vpdpbusds.128(<4 x i32> %x0, <16 x i8> %x1, <16 x i8> %x4, i8  %x3)
  %res2 = insertvalue { <4 x i32>, <4 x i32> } poison, <4 x i32> %res0, 0
  %res3 = insertvalue { <4 x i32>, <4 x i32> }  %res2, <4 x i32> %res1, 1
  ret { <4 x i32>, <4 x i32> } %res3
}

declare <8 x i32> @llvm.x86.avx512.mask.vpdpwssd.256(<8 x i32>, <16 x i16>, <16 x i16>, i8)
declare <8 x i32> @llvm.x86.avx512.maskz.vpdpwssd.256(<8 x i32>, <16 x i16>, <16 x i16>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <8 x i32> @llvm.x86.avx512.mask.vpdpwssd.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x2, i8 -1)
  ret <8 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  ...
  %res0 = call <8 x i32> @llvm.x86.avx512.mask.vpdpwssd.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x2, i8 %x3)
  %res1 = call <8 x i32> @llvm.x86.avx512.maskz.vpdpwssd.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x4, i8  %x3)
  %res2 = insertvalue { <8 x i32>, <8 x i32> } poison, <8 x i32> %res0, 0
  %res3 = insertvalue { <8 x i32>, <8 x i32> }  %res2, <8 x i32> %res1, 1
  ret { <8 x i32>, <8 x i32> } %res3
}

declare <4 x i32> @llvm.x86.avx512.mask.vpdpwssd.128(<4 x i32>, <8 x i16>, <8 x i16>, i8)
declare <4 x i32> @llvm.x86.avx512.maskz.vpdpwssd.128(<4 x i32>, <8 x i16>, <8 x i16>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <4 x i32> @llvm.x86.avx512.mask.vpdpwssd.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x2, i8 -1)
  ret <4 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  ...
  %res0 = call <4 x i32> @llvm.x86.avx512.mask.vpdpwssd.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x2, i8 %x3)
  %res1 = call <4 x i32> @llvm.x86.avx512.maskz.vpdpwssd.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x4, i8  %x3)
  %res2 = insertvalue { <4 x i32>, <4 x i32> } poison, <4 x i32> %res0, 0
  %res3 = insertvalue { <4 x i32>, <4 x i32> }  %res2, <4 x i32> %res1, 1
  ret { <4 x i32>, <4 x i32> } %res3
}
...
declare <8 x i32> @llvm.x86.avx512.mask.vpdpwssds.256(<8 x i32>, <16 x i16>, <16 x i16>, i8)
declare <8 x i32> @llvm.x86.avx512.maskz.vpdpwssds.256(<8 x i32>, <16 x i16>, <16 x i16>, i8)
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <8 x i32> @llvm.x86.avx512.mask.vpdpwssds.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x2, i8 -1)
  ret <8 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  %x2 = load <16 x i16>, ptr %x2p
  %res0 = call <8 x i32> @llvm.x86.avx512.mask.vpdpwssds.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x2, i8 %x3)
  %res1 = call <8 x i32> @llvm.x86.avx512.maskz.vpdpwssds.256(<8 x i32> %x0, <16 x i16> %x1, <16 x i16> %x4, i8  %x3)
  %res2 = insertvalue { <8 x i32>, <8 x i32> } poison, <8 x i32> %res0, 0
  %res3 = insertvalue { <8 x i32>, <8 x i32> }  %res2, <8 x i32> %res1, 1
  ret { <8 x i32>, <8 x i32> } %res3
}

declare <4 x i32> @llvm.x86.avx512.mask.vpdpwssds.128(<4 x i32>, <8 x i16>, <8 x i16>, i8)
declare <4 x i32> @llvm.x86.avx512.maskz.vpdpwssds.128(<4 x i32>, <8 x i16>, <8 x i16>, i8)

define <4 x i32>@test_int_x86_avx512_vpdpwssds_128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x2) {
; CHECK-LABEL: test_int_x86_avx512_vpdpwssds_128:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vpdpwssds %xmm2, %xmm1, %xmm0 # encoding: [0x62,0xf2,0x75,0x08,0x53,0xc2]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
  %res = call <4 x i32> @llvm.x86.avx512.mask.vpdpwssds.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x2, i8 -1)
  ret <4 x i32> %res
}
...
; X64-NEXT:    retq # encoding: [0xc3]
  %x2 = load <8 x i16>, ptr %x2p
  %res0 = call <4 x i32> @llvm.x86.avx512.mask.vpdpwssds.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x2, i8 %x3)
  %res1 = call <4 x i32> @llvm.x86.avx512.maskz.vpdpwssds.128(<4 x i32> %x0, <8 x i16> %x1, <8 x i16> %x4, i8  %x3)
  %res2 = insertvalue { <4 x i32>, <4 x i32> } poison, <4 x i32> %res0, 0
  %res3 = insertvalue { <4 x i32>, <4 x i32> }  %res2, <4 x i32> %res1, 1
  ret { <4 x i32>, <4 x i32> } %res3
}
