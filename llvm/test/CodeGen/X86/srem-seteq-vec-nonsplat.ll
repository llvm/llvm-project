...
; CHECK-SSE2-NEXT:    punpckhbw {{.*#+}} xmm4 = xmm4[8],xmm6[8],xmm4[9],xmm6[9],xmm4[10],xmm6[10],xmm4[11],xmm6[11],xmm4[12],xmm6[12],xmm4[13],xmm6[13],xmm4[14],xmm6[14],xmm4[15],xmm6[15]
; CHECK-SSE2-NEXT:    pmullw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm4
...
; CHECK-SSE2-NEXT:    pcmpgtb %xmm7, %xmm1
...
; CHECK-SSE2-NEXT:    pcmpeqb %xmm7, %xmm3
; CHECK-SSE2-NEXT:    pandn %xmm6, %xmm3
; CHECK-SSE2-NEXT:    pcmpeqb %xmm7, %xmm2
...
; CHECK-SSE41-NEXT:    pcmpeqb %xmm7, %xmm3
; CHECK-SSE41-NEXT:    pandn %xmm1, %xmm3
; CHECK-SSE41-NEXT:    pcmpeqb %xmm7, %xmm2
