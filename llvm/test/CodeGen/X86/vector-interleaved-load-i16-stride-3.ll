...
; SSE-NEXT:    pshuflw $236, (%rsp), %xmm3 # 16-byte Folded Reload
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm8[2,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,5,4,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,3,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm3[1,2,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshufhw $236, (%rsp), %xmm1 # 16-byte Folded Reload
; SSE-NEXT:    # xmm1 = mem[0,1,2,3,4,7,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm1[0,1,0,2]
; SSE-NEXT:    movdqa %xmm0, %xmm3
; SSE-NEXT:    pandn %xmm12, %xmm3
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm2[3,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,6,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[2,1,0,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm12[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pand %xmm0, %xmm12
; SSE-NEXT:    por %xmm12, %xmm3
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; SSE-NEXT:    pand %xmm9, %xmm1
; SSE-NEXT:    por %xmm5, %xmm1
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm14[0,1,2,3,4,7,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm5[0,1,0,2]
; SSE-NEXT:    movdqa %xmm0, %xmm5
; SSE-NEXT:    pandn %xmm12, %xmm5
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm1[3,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,6,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[2,1,0,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm12[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pand %xmm0, %xmm12
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm10[0,1,2,3,4,7,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm2[0,1,0,2]
; SSE-NEXT:    movdqa %xmm0, %xmm2
; SSE-NEXT:    pandn %xmm12, %xmm2
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm13[3,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,6,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[2,1,0,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm12[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pand %xmm0, %xmm12
