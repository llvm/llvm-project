...
; RUN: llc < %s -mtriple=i686--   -mattr=+sse2           | FileCheck %s --check-prefixes=SSE,X86-SSE,X86-SSE2
; RUN: llc < %s -mtriple=x86_64-- -mattr=+sse2           | FileCheck %s --check-prefixes=SSE,X64-SSE,X64-SSE2
; RUN: llc < %s -mtriple=i686--   -mattr=+sse4.1         | FileCheck %s --check-prefixes=SSE,X86-SSE,X86-SSE4
; RUN: llc < %s -mtriple=x86_64-- -mattr=+sse4.1         | FileCheck %s --check-prefixes=SSE,X64-SSE,X64-SSE4
; RUN: llc < %s -mtriple=i686--   -mattr=+sse4.2         | FileCheck %s --check-prefixes=SSE,X86-SSE,X86-SSE4
; RUN: llc < %s -mtriple=x86_64-- -mattr=+sse4.2         | FileCheck %s --check-prefixes=SSE,X64-SSE,X64-SSE4
; RUN: llc < %s -mtriple=i686--   -mattr=+avx            | FileCheck %s --check-prefixes=AVX,X86-AVX,AVX1,AVX1-SLOW,X86-AVX1
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx            | FileCheck %s --check-prefixes=AVX,X64-AVX,AVX1,AVX1-SLOW,X64-AVX1
; RUN: llc < %s -mtriple=i686--   -mattr=+avx,+fast-hops | FileCheck %s --check-prefixes=AVX,X86-AVX,AVX1,AVX1-FAST,X86-AVX1
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx,+fast-hops | FileCheck %s --check-prefixes=AVX,X64-AVX,AVX1,AVX1-FAST,X64-AVX1
...
; AVX1-FAST-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,0,1]
...
; X86-SSE2-LABEL: test_v32i8_v16i8_mid:
; X86-SSE2:       # %bb.0:
...
; X86-SSE2-NEXT:    retl
;
; X64-SSE2-LABEL: test_v32i8_v16i8_mid:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,3],xmm1[0,1]
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,1,0,1]
...
; X64-SSE2-NEXT:    retq
;
; X86-SSE4-LABEL: test_v32i8_v16i8_mid:
; X86-SSE4:       # %bb.0:
; X86-SSE4-NEXT:    pshufd {{.*#+}} xmm2 = xmm1[0,1,0,1]
; X86-SSE4-NEXT:    palignr {{.*#+}} xmm1 = xmm0[8,9,10,11,12,13,14,15],xmm1[0,1,2,3,4,5,6,7]
...
; X86-SSE4-NEXT:    retl
;
; X64-SSE4-LABEL: test_v32i8_v16i8_mid:
; X64-SSE4:       # %bb.0:
; X64-SSE4-NEXT:    pshufd {{.*#+}} xmm2 = xmm1[0,1,0,1]
; X64-SSE4-NEXT:    palignr {{.*#+}} xmm1 = xmm0[8,9,10,11,12,13,14,15],xmm1[0,1,2,3,4,5,6,7]
