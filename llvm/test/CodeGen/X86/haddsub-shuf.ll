...
; SSE_SLOW-LABEL: PR34724_2:
; SSE_SLOW:       # %bb.0:
; SSE_SLOW-NEXT:    haddps %xmm1, %xmm0
; SSE_SLOW-NEXT:    movsldup {{.*#+}} xmm2 = xmm1[0,0,2,2]
; SSE_SLOW-NEXT:    addps %xmm1, %xmm2
; SSE_SLOW-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,0],xmm0[2,0]
; SSE_SLOW-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm2[2,0]
; SSE_SLOW-NEXT:    retq
;
; SSE_FAST-LABEL: PR34724_2:
; SSE_FAST:       # %bb.0:
; SSE_FAST-NEXT:    haddps %xmm1, %xmm0
; SSE_FAST-NEXT:    retq
;
