...
; AVX1-ONLY-NEXT:    vmovapd (%r9), %ymm2
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %xmm3
; AVX1-ONLY-NEXT:    vmovaps (%rdx), %xmm4
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm5 = xmm4[1],xmm3[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%r9), %ymm5, %ymm6
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm1[0,1],ymm9[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm9[0],ymm6[1],ymm9[2,3]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm2[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm10 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm10[2,3]
...
; AVX1-ONLY-NEXT:    vmovapd 16(%rdx), %xmm9
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm9 = xmm9[1],mem[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 24(%r8), %ymm10
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],ymm10[2,3]
...
; AVX1-ONLY-NEXT:    vmovapd %ymm1, 128(%rax)
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm0, %ymm6
; AVX2-ONLY-NEXT:    vmovaps (%rcx), %xmm7
; AVX2-ONLY-NEXT:    vmovaps (%rdx), %xmm8
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm9 = xmm8[1],xmm7[1]
; AVX2-ONLY-NEXT:    vbroadcastsd 8(%r8), %ymm10
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm4[0,1,2,3],ymm11[4,5,6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm5 = ymm11[0,1],ymm5[2,3],ymm11[4,5,6,7]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm9, %ymm7
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm10, %ymm8
...
; AVX2-ONLY-NEXT:    vmovaps %ymm6, 64(%rax)
; AVX2-ONLY-NEXT:    vzeroupper
; AVX2-ONLY-NEXT:    retq
;
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%r9), %ymm1, %ymm8
; AVX1-ONLY-NEXT:    vbroadcastsd 8(%r8), %ymm10
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm10[4,5,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm8[2,3],ymm1[4,5],ymm8[6,7]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm10[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = ymm13[0,1],ymm11[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm11[0],ymm8[1],ymm11[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rdx), %xmm12
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm12[1],xmm5[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 40(%r8), %ymm15
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm15 = ymm11[0,1,2,3],ymm15[4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 32(%r9), %ymm11, %ymm11
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0,1],ymm11[2,3],ymm15[4,5],ymm11[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm15 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3],ymm15[2,3]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm9[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm14 = ymm14[0],ymm15[0],ymm14[2],ymm15[3]
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm15 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm13 = ymm13[2,3],ymm15[2,3]
; AVX1-ONLY-NEXT:    vmovapd 32(%r9), %ymm0
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm0[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm15 = ymm13[0],ymm15[0],ymm13[2],ymm15[3]
...
; AVX1-ONLY-NEXT:    vbroadcastsd 48(%rcx), %ymm9
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2,3,4,5],ymm9[6,7]
; AVX1-ONLY-NEXT:    vmovapd 48(%rdx), %xmm9
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm9 = xmm9[1],mem[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 56(%r8), %ymm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],ymm11[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm9[0,1,2],ymm0[3]
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm3 = xmm4[0],xmm3[0]
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm4 = xmm7[0],xmm6[0]
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm2 = xmm10[0],xmm2[0]
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm12[0],xmm5[0]
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX1-ONLY-NEXT:    vmovaps %xmm5, 208(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm2, 192(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm4, 16(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm3, (%rax)
; AVX1-ONLY-NEXT:    vmovapd %ymm15, 320(%rax)
; AVX1-ONLY-NEXT:    vmovapd %ymm14, 128(%rax)
; AVX1-ONLY-NEXT:    vmovapd %ymm0, 352(%rax)
...
; AVX2-ONLY-NEXT:    vmovaps 32(%rcx), %xmm11
; AVX2-ONLY-NEXT:    vmovaps (%rdx), %xmm12
; AVX2-ONLY-NEXT:    vmovaps 32(%rdx), %xmm13
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm12[1],xmm10[1]
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm14 = xmm7[1],xmm8[1]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm14, %ymm0, %ymm14
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm1[0,1,2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm14[0,1],ymm3[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm14 = xmm13[1],xmm11[1]
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm6, %ymm6
; AVX2-ONLY-NEXT:    vmovaps 32(%rsi), %ymm12
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm13, %ymm7, %ymm7
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm7[0],ymm8[0],ymm7[2],ymm8[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm10[0],ymm9[0],ymm10[2],ymm9[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm8[2,3],ymm11[2,3]
; AVX2-ONLY-NEXT:    vbroadcastsd 16(%rcx), %ymm13
...
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm4[2,3],ymm9[2,3]
; AVX2-ONLY-NEXT:    vbroadcastsd 16(%r9), %ymm9
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm9[2,3],ymm4[4,5,6,7]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm14[0],ymm12[0],ymm14[2],ymm12[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm10[2,3],ymm13[2,3]
; AVX2-ONLY-NEXT:    vbroadcastsd 48(%rcx), %ymm11
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5],ymm11[6,7]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm14[1],ymm12[1],ymm14[3],ymm12[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm11[2,3]
; AVX2-ONLY-NEXT:    vbroadcastsd 48(%r9), %ymm11
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm11[2,3],ymm1[4,5,6,7]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm13[1],mem[1],ymm13[3],mem[3]
; AVX2-ONLY-NEXT:    vbroadcastsd 56(%r8), %ymm12
...
; AVX2-ONLY-NEXT:    vmovaps %ymm10, 288(%rax)
...
; AVX2-ONLY-NEXT:    vmovaps %ymm5, 256(%rax)
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 224(%rax)
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm15[1],xmm1[1]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm6[1],xmm7[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 104(%r8), %ymm8
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm2[0,1,2,3],ymm8[4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%r9), %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm8[0,1],ymm2[2,3],ymm8[4,5],ymm2[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm2 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm11[2,3],ymm2[2,3]
; AVX1-ONLY-NEXT:    vmovapd (%r9), %ymm8
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm8[2,3],mem[2,3]
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm2[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[0],ymm11[0],ymm0[2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm0[2,3]
; AVX1-ONLY-NEXT:    vmovapd 64(%r9), %ymm0
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm0[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[0],ymm11[0],ymm3[2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm3 = mem[0,0,3,2]
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm12[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1,2],ymm8[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 48(%rdi), %xmm3
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} xmm3 = xmm3[0],mem[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],mem[4,5,6,7]
; AVX1-ONLY-NEXT:    vbroadcastsd 48(%rcx), %ymm8
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm3[0,1,2,3,4,5],ymm8[6,7]
; AVX1-ONLY-NEXT:    vmovapd 48(%rdx), %xmm3
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm3[1],mem[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 56(%r8), %ymm14
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],ymm14[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm3[0,1,2],ymm2[3]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm5 = ymm2[0,1,2,3,4,5],ymm14[6,7]
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = ymm13[0,1,2],ymm0[3]
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm12[0,1,2],ymm1[3]
...
; AVX1-ONLY-NEXT:    vmovapd %ymm3, 736(%rax)
...
; AVX1-ONLY-NEXT:    vmovaps %ymm5, 480(%rax)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm9[1],xmm10[1]
...
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 64(%rcx), %xmm5
; AVX2-ONLY-NEXT:    vmovaps 64(%rdx), %xmm6
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm12[1],xmm2[1]
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm15, %ymm1
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm8, %ymm0
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm7, %ymm1
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm3, %ymm0
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm4, %ymm1
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[2],ymm0[2]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm7[0],ymm8[0],ymm7[2],ymm8[2]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm8[2,3],ymm7[4,5,6,7]
...
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm19, %zmm16
...
; AVX512F-NEXT:    vpermt2q %zmm7, %zmm10, %zmm9
; AVX512F-NEXT:    movb $48, %r9b
; AVX512F-NEXT:    kmovw %r9d, %k2
; AVX512F-NEXT:    vmovdqa64 %zmm16, %zmm9 {%k2}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm20 = <0,1,9,u,4,5,6,7>
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm20, %zmm9
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm21 = [0,1,2,9,4,5,6,7]
...
; AVX512F-NEXT:    vmovdqa64 %zmm13, %zmm18
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm22, %zmm18
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm17 = [5,13,6,14,5,13,6,14]
; AVX512F-NEXT:    # zmm17 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm5, %zmm16
; AVX512F-NEXT:    vpermt2q %zmm7, %zmm17, %zmm16
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm16 {%k2}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <0,1,13,u,4,5,6,7>
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm23, %zmm16
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm24 = [0,1,2,13,4,5,6,7]
; AVX512F-NEXT:    vpermt2q %zmm14, %zmm24, %zmm16
...
; AVX512F-NEXT:    vpermt2q %zmm7, %zmm25, %zmm18
; AVX512F-NEXT:    vmovdqa64 %zmm13, %zmm26
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm25, %zmm26
; AVX512F-NEXT:    vshufi64x2 {{.*#+}} zmm18 = zmm26[0,1,2,3],zmm18[4,5,6,7]
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm26 = <14,u,2,3,4,5,15,u>
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm26, %zmm18
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm27 = [0,14,2,3,4,5,6,15]
; AVX512F-NEXT:    vpermt2q %zmm14, %zmm27, %zmm18
; AVX512F-NEXT:    vpermi2q %zmm11, %zmm8, %zmm19
; AVX512F-NEXT:    vpermi2q %zmm4, %zmm2, %zmm10
; AVX512F-NEXT:    vmovdqa64 %zmm19, %zmm10 {%k2}
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm20, %zmm10
; AVX512F-NEXT:    vpermt2q %zmm12, %zmm21, %zmm10
; AVX512F-NEXT:    vpermi2q %zmm11, %zmm8, %zmm22
; AVX512F-NEXT:    vpermi2q %zmm4, %zmm2, %zmm17
; AVX512F-NEXT:    vmovdqa64 %zmm22, %zmm17 {%k2}
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm23, %zmm17
; AVX512F-NEXT:    vpermt2q %zmm12, %zmm24, %zmm17
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm19
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm25, %zmm19
; AVX512F-NEXT:    vpermi2q %zmm11, %zmm8, %zmm25
; AVX512F-NEXT:    vshufi64x2 {{.*#+}} zmm19 = zmm25[0,1,2,3],zmm19[4,5,6,7]
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm26, %zmm19
; AVX512F-NEXT:    vpermt2q %zmm12, %zmm27, %zmm19
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [0,8,1,9,0,8,1,9]
; AVX512F-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm20, %zmm13
...
; AVX512F-NEXT:    vinserti64x4 $0, %ymm15, %zmm0, %zmm13 {%k1}
; AVX512F-NEXT:    vinserti32x4 $2, (%r8), %zmm13, %zmm13
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [0,1,2,3,4,8,6,7]
; AVX512F-NEXT:    vpermt2q %zmm14, %zmm15, %zmm13
...
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm7, %zmm5
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [0,10,2,3,4,5,6,11]
; AVX512F-NEXT:    vpermt2q %zmm14, %zmm6, %zmm5
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm20 = [0,1,2,3,4,12,6,7]
; AVX512F-NEXT:    vpermt2q %zmm14, %zmm20, %zmm0
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm11, %zmm2
; AVX512F-NEXT:    vpunpckhqdq {{.*#+}} ymm4 = ymm15[1],mem[1],ymm15[3],mem[3]
; AVX512F-NEXT:    vinserti64x4 $0, %ymm4, %zmm2, %zmm2
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm7, %zmm2
; AVX512F-NEXT:    vpermt2q %zmm12, %zmm6, %zmm2
; AVX512F-NEXT:    vpermt2q %zmm12, %zmm20, %zmm1
; AVX512F-NEXT:    vmovdqa64 %zmm19, 704(%rax)
; AVX512F-NEXT:    vmovdqa64 %zmm17, 640(%rax)
; AVX512F-NEXT:    vmovdqa64 %zmm1, 576(%rax)
...
; AVX512BW-NEXT:    vpermi2q %zmm15, %zmm13, %zmm0
...
; AVX512BW-NEXT:    vmovdqa64 64(%r9), %zmm12
...
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm19, %zmm16
...
; AVX512BW-NEXT:    vpermt2q %zmm7, %zmm10, %zmm9
; AVX512BW-NEXT:    movb $48, %r9b
; AVX512BW-NEXT:    kmovd %r9d, %k2
; AVX512BW-NEXT:    vmovdqa64 %zmm16, %zmm9 {%k2}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm20 = <0,1,9,u,4,5,6,7>
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm20, %zmm9
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm21 = [0,1,2,9,4,5,6,7]
...
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm22, %zmm18
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm17 = [5,13,6,14,5,13,6,14]
; AVX512BW-NEXT:    # zmm17 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm5, %zmm16
; AVX512BW-NEXT:    vpermt2q %zmm7, %zmm17, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm16 {%k2}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <0,1,13,u,4,5,6,7>
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm23, %zmm16
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm24 = [0,1,2,13,4,5,6,7]
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm24, %zmm16
...
; AVX512BW-NEXT:    vpermt2q %zmm7, %zmm25, %zmm18
; AVX512BW-NEXT:    vmovdqa64 %zmm13, %zmm26
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm25, %zmm26
; AVX512BW-NEXT:    vshufi64x2 {{.*#+}} zmm18 = zmm26[0,1,2,3],zmm18[4,5,6,7]
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm26 = <14,u,2,3,4,5,15,u>
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm26, %zmm18
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm27 = [0,14,2,3,4,5,6,15]
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm27, %zmm18
; AVX512BW-NEXT:    vpermi2q %zmm11, %zmm8, %zmm19
; AVX512BW-NEXT:    vpermi2q %zmm4, %zmm2, %zmm10
; AVX512BW-NEXT:    vmovdqa64 %zmm19, %zmm10 {%k2}
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm20, %zmm10
; AVX512BW-NEXT:    vpermt2q %zmm12, %zmm21, %zmm10
; AVX512BW-NEXT:    vpermi2q %zmm11, %zmm8, %zmm22
; AVX512BW-NEXT:    vpermi2q %zmm4, %zmm2, %zmm17
; AVX512BW-NEXT:    vmovdqa64 %zmm22, %zmm17 {%k2}
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm23, %zmm17
; AVX512BW-NEXT:    vpermt2q %zmm12, %zmm24, %zmm17
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm19
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm25, %zmm19
; AVX512BW-NEXT:    vpermi2q %zmm11, %zmm8, %zmm25
; AVX512BW-NEXT:    vshufi64x2 {{.*#+}} zmm19 = zmm25[0,1,2,3],zmm19[4,5,6,7]
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm26, %zmm19
; AVX512BW-NEXT:    vpermt2q %zmm12, %zmm27, %zmm19
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [0,8,1,9,0,8,1,9]
; AVX512BW-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm20, %zmm13
...
; AVX512BW-NEXT:    vinserti64x4 $0, %ymm15, %zmm0, %zmm13 {%k1}
; AVX512BW-NEXT:    vinserti32x4 $2, (%r8), %zmm13, %zmm13
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [0,1,2,3,4,8,6,7]
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm15, %zmm13
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm20 = [0,1,2,3,4,12,6,7]
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm20, %zmm0
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm11, %zmm2
; AVX512BW-NEXT:    vpunpckhqdq {{.*#+}} ymm4 = ymm15[1],mem[1],ymm15[3],mem[3]
...
; AVX512BW-NEXT:    vmovdqa64 %zmm1, 576(%rax)
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm14[1],xmm13[1]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm2[1],xmm9[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm2
; AVX1-ONLY-NEXT:    vmovapd 64(%r8), %ymm3
...
; AVX1-ONLY-NEXT:    vmovddup {{.*#+}} xmm6 = mem[0,0]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0],ymm6[1],ymm2[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 128(%rcx), %xmm6
; AVX1-ONLY-NEXT:    vmovaps %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 128(%rdx), %xmm2
; AVX1-ONLY-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm2[1],xmm6[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 136(%r8), %ymm6
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm2[0,1,2,3],ymm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 128(%r9), %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm6[0,1],ymm2[2,3],ymm6[4,5],ymm2[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm2[0,1],ymm6[2,3]
...
; AVX1-ONLY-NEXT:    vmovaps 160(%rcx), %xmm7
; AVX1-ONLY-NEXT:    vmovaps %xmm7, (%rsp) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 160(%rdx), %xmm6
; AVX1-ONLY-NEXT:    vmovaps %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm6 = xmm6[1],xmm7[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 168(%r8), %ymm7
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm6[0,1,2,3],ymm7[4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%r9), %ymm6, %ymm6
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm15[0,1],ymm6[2,3]
; AVX1-ONLY-NEXT:    vmovddup {{.*#+}} xmm7 = mem[0,0]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0],ymm7[1],ymm6[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1],ymm6[2,3],ymm7[4,5],ymm6[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm6 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm0[2,3],ymm6[2,3]
; AVX1-ONLY-NEXT:    vmovapd (%r9), %ymm12
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm12[2,3],mem[2,3]
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm6[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm0[2,3]
; AVX1-ONLY-NEXT:    vmovapd 64(%r9), %ymm11
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm11[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm5[2,3],ymm0[2,3]
; AVX1-ONLY-NEXT:    vmovapd 96(%r9), %ymm5
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm5[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm4[2,3],ymm0[2,3]
; AVX1-ONLY-NEXT:    vmovapd 128(%r9), %ymm3
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm3[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[0],ymm1[0],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm0 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm2[2,3],ymm0[2,3]
; AVX1-ONLY-NEXT:    vmovapd 160(%r9), %ymm0
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm0[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[0],ymm2[0],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm1 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm8[2,3],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovapd 192(%r9), %ymm1
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm1[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm2[0],ymm4[0],ymm2[2],ymm4[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm2 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm15[2,3],ymm2[2,3]
; AVX1-ONLY-NEXT:    vmovapd 224(%r9), %ymm2
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1,2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm12[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm14 = xmm14[0],xmm13[0]
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    # xmm12 = xmm0[0],mem[0]
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm0[0],xmm9[0]
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vunpcklpd (%rsp), %xmm0, %xmm4 # 16-byte Folded Reload
...
; AVX1-ONLY-NEXT:    vmovaps %xmm6, 784(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm7, 768(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm8, 592(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm9, 576(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm10, 400(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm11, 384(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm12, 208(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm13, 192(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm15, 16(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm14, (%rax)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX1-ONLY-NEXT:    vmovapd %ymm7, %ymm3
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm2[0],ymm1[1],ymm2[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rdx), %xmm1
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX1-ONLY-NEXT:    vmovapd 192(%r8), %ymm12
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 200(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 232(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 264(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 296(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 328(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 360(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX1-ONLY-NEXT:    vmovapd 384(%r8), %ymm11
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 392(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX1-ONLY-NEXT:    vmovapd 416(%r8), %ymm14
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm14[0,1],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovddup {{.*#+}} xmm2 = mem[0,0]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 424(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 456(%r8), %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm1 = xmm1[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX1-ONLY-NEXT:    vmovapd 480(%r8), %ymm15
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm15[0,1],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovddup {{.*#+}} xmm2 = mem[0,0]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 480(%rcx), %xmm2
; AVX1-ONLY-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm7[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm1[0],ymm2[0],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm1 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm3[2,3],ymm1[2,3]
; AVX1-ONLY-NEXT:    vmovapd 32(%r9), %ymm1
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm1[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm2[0],ymm3[0],ymm2[2],ymm3[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm2 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm9[2,3],ymm2[2,3]
; AVX1-ONLY-NEXT:    vmovapd 64(%r9), %ymm2
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm2[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[0],ymm9[0],ymm3[2],ymm9[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm3 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm13[2,3],ymm3[2,3]
; AVX1-ONLY-NEXT:    vmovapd 96(%r9), %ymm13
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm13[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[0],ymm9[0],ymm3[2],ymm9[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm3 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm4[2,3],ymm3[2,3]
; AVX1-ONLY-NEXT:    vmovapd 128(%r9), %ymm3
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm3[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm4 = ymm9[0],ymm6[0],ymm9[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm6 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm5[2,3],ymm6[2,3]
; AVX1-ONLY-NEXT:    vmovapd 160(%r9), %ymm9
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm9[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm4 = ymm6[0],ymm5[0],ymm6[2],ymm5[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm5 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm12[2,3],ymm5[2,3]
; AVX1-ONLY-NEXT:    vmovapd 192(%r9), %ymm6
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm6[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm4 = ymm5[0],ymm4[0],ymm5[2],ymm4[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm4 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm8[2,3],ymm4[2,3]
; AVX1-ONLY-NEXT:    vmovapd 224(%r9), %ymm5
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm5[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm4 = ymm4[0],ymm8[0],ymm4[2],ymm8[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm4 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 $19, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm8 # 32-byte Folded Reload
; AVX1-ONLY-NEXT:    # ymm8 = mem[2,3],ymm4[2,3]
; AVX1-ONLY-NEXT:    vmovapd 256(%r9), %ymm4
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm4[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 $19, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm12 # 32-byte Folded Reload
; AVX1-ONLY-NEXT:    # ymm12 = mem[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 288(%r9), %ymm0
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm0[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm12[0],ymm8[0],ymm12[2],ymm8[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 $19, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX1-ONLY-NEXT:    # ymm8 = mem[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 320(%r9), %ymm0
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm0[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 $19, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
...
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm11[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 384(%r9), %ymm11
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm11[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm14[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 416(%r9), %ymm14
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm14[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm10[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 448(%r9), %ymm10
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm10[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpermilpd {{.*#+}} ymm8 = mem[0,0,3,2]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm15[2,3],ymm8[2,3]
; AVX1-ONLY-NEXT:    vmovapd 480(%r9), %ymm15
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm15[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm8[0],ymm12[0],ymm8[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],mem[1]
; AVX1-ONLY-NEXT:    vbroadcastsd 56(%r8), %ymm8
...
; AVX1-ONLY-NEXT:    # xmm0 = xmm0[0],mem[0]
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 2896(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm1, 2880(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm2, 2704(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm3, 2688(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm4, 2512(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm5, 2496(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm6, 2320(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm7, 2304(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm8, 2128(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm9, 2112(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm10, 1936(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm11, 1920(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm12, 1744(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm13, 1728(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm14, 1552(%rax)
; AVX1-ONLY-NEXT:    vmovaps %xmm15, 1536(%rax)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1360(%rax)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
