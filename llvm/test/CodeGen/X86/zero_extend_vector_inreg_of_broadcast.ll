...
; AVX1-NEXT:    vmovdqa {{.*#+}} xmm3 = [0,255,255,0,255,255,0,255,255,0,255,255,0,255,255,0]
; AVX1-NEXT:    vpblendvb %xmm3, %xmm1, %xmm2, %xmm1
...
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm3 = [0,255,255,255,0,255,255,255,0,255,255,255,0,255,255,255]
; AVX1-NEXT:    vpblendvb %xmm3, %xmm1, %xmm2, %xmm1
...
; AVX1-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,0,0,0,4,5,6,7]
; AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[0,1,0,1]
; AVX1-NEXT:    vmovdqa {{.*#+}} xmm3 = [0,255,255,255,255,255,0,255,255,255,255,255,0,255,255,255]
; AVX1-NEXT:    vpblendvb %xmm3, %xmm1, %xmm2, %xmm1
...
; AVX1-NEXT:    vpmovsxwq {{.*#+}} xmm3 = [18446744073709551360,18446744073709551360]
; AVX1-NEXT:    vpblendvb %xmm3, %xmm1, %xmm2, %xmm1
...
; AVX1-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[0,0,0,0]
; AVX1-NEXT:    vpmovsxwd {{.*#+}} xmm3 = [4294967040,4294967295,4294967295,4294967040]
; AVX1-NEXT:    vpblendvb %xmm3, %xmm1, %xmm2, %xmm1
...
; AVX1-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX1-NEXT:    vpblendw {{.*#+}} xmm3 = xmm2[0,1],xmm0[2],xmm2[3,4],xmm0[5],xmm2[6,7]
; AVX1-NEXT:    vpaddb (%rdx), %xmm1, %xmm1
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm3, %xmm3
; AVX1-NEXT:    vpblendw {{.*#+}} xmm0 = xmm2[0],xmm0[1],xmm2[2,3],xmm0[4],xmm2[5,6],xmm0[7]
; AVX1-NEXT:    vpaddb 16(%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vmovdqa %xmm1, (%rcx)
; AVX1-NEXT:    vmovdqa %xmm0, 16(%rcx)
...
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} ymm1 = ymm0[0],ymm1[1,2,3],ymm0[4],ymm1[5,6,7],ymm0[8],ymm1[9,10,11],ymm0[12],ymm1[13,14,15]
...
; AVX1-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX1-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[0,0,0,0]
; AVX1-NEXT:    vpblendw {{.*#+}} xmm1 = xmm2[0],xmm1[1,2,3,4,5],xmm2[6],xmm1[7]
...
; AVX1-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[0,0],ymm1[1,3],ymm2[4,4],ymm1[5,7]
; AVX1-NEXT:    vshufps {{.*#+}} xmm2 = xmm1[0,2,1,3]
; AVX1-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; AVX1-NEXT:    vpxor %xmm3, %xmm3, %xmm3
...
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vpxor %xmm3, %xmm3, %xmm3
; AVX1-NEXT:    vpblendw {{.*#+}} xmm2 = xmm3[0,1,2,3],xmm2[4,5],xmm3[6,7]
; AVX1-NEXT:    vpaddb 16(%rdx), %xmm2, %xmm2
; AVX1-NEXT:    vmovdqa %xmm1, (%rcx)
; AVX1-NEXT:    vmovdqa %xmm2, 16(%rcx)
; AVX1-NEXT:    vmovdqa %xmm0, 32(%rcx)
...
; SSE42-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,0,1]
...
; AVX1-NEXT:    vpaddb (%rsi), %xmm0, %xmm0
; AVX1-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX1-NEXT:    vpaddb 32(%rdx), %xmm0, %xmm1
; AVX1-NEXT:    vpaddb (%rdx), %xmm0, %xmm0
; AVX1-NEXT:    vmovaps 16(%rdx), %xmm2
; AVX1-NEXT:    vmovaps 48(%rdx), %xmm3
; AVX1-NEXT:    vmovaps %xmm2, 16(%rcx)
; AVX1-NEXT:    vmovaps %xmm3, 48(%rcx)
; AVX1-NEXT:    vmovdqa %xmm0, (%rcx)
...
; AVX2-SLOW-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
; AVX2-SLOW-NEXT:    vpaddb (%rdx), %ymm0, %ymm0
; AVX2-SLOW-NEXT:    vmovdqa %ymm0, (%rcx)
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rdi), %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpaddb (%rsi), %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovd {{.*#+}} xmm1 = [65535,0,0,0]
; AVX2-FAST-PERLANE-NEXT:    vpand %ymm1, %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
; AVX2-FAST-PERLANE-NEXT:    vpaddb (%rdx), %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, (%rcx)
...
; AVX2-FAST-NEXT:    vmovdqa (%rdi), %ymm0
; AVX2-FAST-NEXT:    vpaddb (%rsi), %ymm0, %ymm0
; AVX2-FAST-NEXT:    vmovd {{.*#+}} xmm1 = [65535,0,0,0]
; AVX2-FAST-NEXT:    vpand %ymm1, %ymm0, %ymm0
; AVX2-FAST-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
; AVX2-FAST-NEXT:    vpaddb (%rdx), %ymm0, %ymm0
; AVX2-FAST-NEXT:    vmovdqa %ymm0, (%rcx)
...
; AVX512F-SLOW-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
; AVX512F-SLOW-NEXT:    vpaddb (%rdx), %ymm0, %ymm0
; AVX512F-SLOW-NEXT:    vmovdqa %ymm0, (%rcx)
...
; AVX512F-FAST-NEXT:    vmovdqa (%rdi), %ymm0
; AVX512F-FAST-NEXT:    vpaddb (%rsi), %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vmovd {{.*#+}} xmm1 = [65535,0,0,0]
; AVX512F-FAST-NEXT:    vpand %ymm1, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
...
; AVX512DQ-SLOW-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
; AVX512DQ-SLOW-NEXT:    vpaddb (%rdx), %ymm0, %ymm0
; AVX512DQ-SLOW-NEXT:    vmovdqa %ymm0, (%rcx)
...
; AVX512DQ-FAST-NEXT:    vmovdqa (%rdi), %ymm0
; AVX512DQ-FAST-NEXT:    vpaddb (%rsi), %ymm0, %ymm0
; AVX512DQ-FAST-NEXT:    vmovd {{.*#+}} xmm1 = [65535,0,0,0]
; AVX512DQ-FAST-NEXT:    vpand %ymm1, %ymm0, %ymm0
; AVX512DQ-FAST-NEXT:    vpaddb 32(%rdx), %ymm0, %ymm1
