...
; X64-AVX2-NEXT:    vpcmpgtw %xmm0, %xmm3, %xmm3
; X64-AVX2-NEXT:    vmovdqa {{.*#+}} xmm4 = [32767,32767,32767,32767,32767,32767,32767,32767]
; X64-AVX2-NEXT:    vpblendvb %xmm3, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm4, %xmm3
; X64-AVX2-NEXT:    vpcmpeqw %xmm1, %xmm0, %xmm0
; X64-AVX2-NEXT:    vpblendvb %xmm0, %xmm2, %xmm3, %xmm0
...
; X64-AVX2-NEXT:    vpblendvb %xmm0, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm3, %xmm3
