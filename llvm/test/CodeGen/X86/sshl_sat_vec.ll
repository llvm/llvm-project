...
; X64-NEXT:    psllq %xmm4, %xmm6
; X64-NEXT:    movdqa %xmm6, %xmm7
; X64-NEXT:    movsd {{.*#+}} xmm6 = xmm3[0],xmm6[1]
; X64-NEXT:    psrlq %xmm1, %xmm3
...
; X86-NEXT:    testb $32, %cl
; X86-NEXT:    cmovnel (%esp), %eax # 4-byte Folded Reload
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-NEXT:    movb %ch, %cl
...
; X86-NEXT:    cmovel %edi, %ecx
; X86-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-NEXT:    movw %cx, 14(%esi)
; X86-NEXT:    movw %ax, 12(%esi)
; X86-NEXT:    movw %dx, 10(%esi)
; X86-NEXT:    movw %bx, 8(%esi)
; X86-NEXT:    movl (%esp), %eax # 4-byte Reload
; X86-NEXT:    movw %ax, 6(%esi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    movw %ax, 4(%esi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    movw %ax, 2(%esi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X64-NEXT:    punpckhbw {{.*#+}} xmm6 = xmm6[8],xmm1[8],xmm6[9],xmm1[9],xmm6[10],xmm1[10],xmm6[11],xmm1[11],xmm6[12],xmm1[12],xmm6[13],xmm1[13],xmm6[14],xmm1[14],xmm6[15],xmm1[15]
; X64-NEXT:    punpcklbw {{.*#+}} xmm4 = xmm4[0],xmm1[0],xmm4[1],xmm1[1],xmm4[2],xmm1[2],xmm4[3],xmm1[3],xmm4[4],xmm1[4],xmm4[5],xmm1[5],xmm4[6],xmm1[6],xmm4[7],xmm1[7]
; X64-NEXT:    paddb %xmm1, %xmm1
; X64-NEXT:    pxor %xmm5, %xmm5
; X64-NEXT:    pcmpgtb %xmm1, %xmm5
; X64-NEXT:    movdqa %xmm5, %xmm7
; X64-NEXT:    pandn %xmm3, %xmm7
...
; X64-NEXT:    pxor %xmm1, %xmm1
; X64-NEXT:    pcmpgtw %xmm6, %xmm1
; X64-NEXT:    movdqa %xmm1, %xmm7
; X64-NEXT:    pandn %xmm5, %xmm7
; X64-NEXT:    psraw $4, %xmm5
; X64-NEXT:    pand %xmm1, %xmm5
; X64-NEXT:    por %xmm7, %xmm5
; X64-NEXT:    paddw %xmm6, %xmm6
; X64-NEXT:    pxor %xmm1, %xmm1
; X64-NEXT:    pcmpgtw %xmm6, %xmm1
; X64-NEXT:    movdqa %xmm1, %xmm7
; X64-NEXT:    pandn %xmm5, %xmm7
; X64-NEXT:    psraw $2, %xmm5
; X64-NEXT:    pand %xmm1, %xmm5
; X64-NEXT:    por %xmm7, %xmm5
; X64-NEXT:    paddw %xmm6, %xmm6
; X64-NEXT:    pxor %xmm1, %xmm1
...
; X64-NEXT:    pandn %xmm5, %xmm6
; X64-NEXT:    psraw $1, %xmm5
; X64-NEXT:    pand %xmm1, %xmm5
; X64-NEXT:    por %xmm6, %xmm5
; X64-NEXT:    psrlw $8, %xmm5
