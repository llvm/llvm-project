...
; CHECK-PREG:    dead $esi = lr-split MOV32r0 implicit-def dead $eflags, implicit-def $rsi
; CHECK-PREG:    $rdx = COPY killed renamable $r14
; CHECK-PREG:    dead $ecx = lr-split MOV32r0 implicit-def dead $eflags, implicit-def $rcx
