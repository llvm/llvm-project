...
; CHECK-NEXT:    jne .LBB0_1
; CHECK-NEXT:    jp .LBB0_1
; CHECK-NEXT:  # %bb.4: # %vector.body807.preheader
; CHECK-NEXT:    leaq 1(%rcx), %rdx
; CHECK-NEXT:    movl %edx, %esi
; CHECK-NEXT:    andl $7, %esi
; CHECK-NEXT:    cmpq $7, %rcx
; CHECK-NEXT:    jae .LBB0_6
; CHECK-NEXT:  # %bb.5:
; CHECK-NEXT:    xorl %r9d, %r9d
; CHECK-NEXT:    jmp .LBB0_8
; CHECK-NEXT:  .LBB0_6: # %vector.body807.preheader.new
; CHECK-NEXT:    movq %rdx, %r10
; CHECK-NEXT:    andq $-8, %r10
; CHECK-NEXT:    xorl %r9d, %r9d
; CHECK-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_7: # %vector.body807
...
; CHECK-NEXT:  .LBB0_8: # %.lr.ph373.unr-lcssa
; CHECK-NEXT:    testq %rsi, %rsi
; CHECK-NEXT:    je .LBB0_11
; CHECK-NEXT:  # %bb.9: # %vector.body807.epil.preheader
; CHECK-NEXT:    addq %rdi, %r9
; CHECK-NEXT:    xorl %r10d, %r10d
; CHECK-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_10: # %vector.body807.epil
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
...
; CHECK-NEXT:  .LBB0_11: # %.lr.ph373
; CHECK-NEXT:    testb $1, %r8b
; CHECK-NEXT:    je .LBB0_13
; CHECK-NEXT:  # %bb.12: # %scalar.ph839.preheader
; CHECK-NEXT:    movl $0, (%rdi)
; CHECK-NEXT:    vzeroupper
; CHECK-NEXT:    retq
; CHECK-NEXT:  .LBB0_13: # %vector.body847.preheader
; CHECK-NEXT:    movl %edx, %esi
; CHECK-NEXT:    andl $7, %esi
; CHECK-NEXT:    cmpq $7, %rcx
...
; CHECK-NEXT:  .LBB0_15: # %vector.body847.preheader.new
; CHECK-NEXT:    andq $-8, %rdx
; CHECK-NEXT:    xorl %ecx, %ecx
; CHECK-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_16: # %vector.body847
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
...
; CHECK-NEXT:  .LBB0_17: # %common.ret.loopexit.unr-lcssa
; CHECK-NEXT:    testq %rsi, %rsi
; CHECK-NEXT:    je .LBB0_20
; CHECK-NEXT:  # %bb.18: # %vector.body847.epil.preheader
; CHECK-NEXT:    leaq 96(%rcx,%rdi), %rcx
; CHECK-NEXT:    xorl %edx, %edx
; CHECK-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_19: # %vector.body847.epil
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
