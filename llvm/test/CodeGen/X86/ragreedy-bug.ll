...
; CHECK-NEXT:    ## in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    movzbl (%rcx,%r8), %eax
; CHECK-NEXT:    cmpb (%rdx,%r8), %al
...
; CHECK-NEXT:    movq 16(%rdi), %rdi
; CHECK-NEXT:    cmpb $83, (%rdi)
; CHECK-NEXT:    movzbl (%rcx,%r8), %esi
...
; CHECK-NEXT:  LBB0_16: ## %land.lhs.true28
; CHECK-NEXT:    movzbl %sil, %r9d
; CHECK-NEXT:    movl $1, %eax
; CHECK-NEXT:    testl %r9d, %r9d
; CHECK-NEXT:    je LBB0_14
; CHECK-NEXT:  ## %bb.17: ## %land.lhs.true28
; CHECK-NEXT:    cmpl $112, %r9d
; CHECK-NEXT:    jne LBB0_22
; CHECK-NEXT:  ## %bb.18: ## %land.lhs.true35
; CHECK-NEXT:    cmpb $112, (%rdx,%r8)
; CHECK-NEXT:    jne LBB0_22
; CHECK-NEXT:  ## %bb.19: ## %land.lhs.true43
; CHECK-NEXT:    movq %rcx, %r9
; CHECK-NEXT:    subq %rdi, %r9
; CHECK-NEXT:    addq %r8, %r9
; CHECK-NEXT:    cmpq $1, %r9
; CHECK-NEXT:    je LBB0_14
; CHECK-NEXT:  ## %bb.20: ## %lor.lhs.false47
; CHECK-NEXT:    cmpq $2, %r9
; CHECK-NEXT:    jne LBB0_12
; CHECK-NEXT:  ## %bb.21: ## %land.lhs.true52
; CHECK-NEXT:    cmpb $73, -1(%rcx,%r8)
; CHECK-NEXT:    jne LBB0_13
; CHECK-NEXT:    jmp LBB0_14
; CHECK-NEXT:  LBB0_22: ## %land.rhs
; CHECK-NEXT:    movzbl (%rdx,%r8), %edi
; CHECK-NEXT:    testb %dil, %dil
; CHECK-NEXT:    jne LBB0_23
; CHECK-NEXT:  LBB0_14:
; CHECK-NEXT:    addq $40, %rsp
; CHECK-NEXT:    retq
; CHECK-NEXT:  LBB0_23: ## %while.body66
