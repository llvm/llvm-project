...
; RUN: llc -fast-isel=false -denormal-fp-math=preserve-sign -mtriple=x86_64-linux-unknown -mattr=+avx512bf16,avx512vl < %s | FileCheck -check-prefixes=AVX512BF16 %s
; RUN: llc -fast-isel -denormal-fp-math=preserve-sign -mtriple=x86_64-linux-unknown -mattr=+avx512bf16,avx512vl < %s | FileCheck -check-prefixes=FAST_ISEL_AVX512BF16 %s
; RUN: llc -fast-isel=false -denormal-fp-math=preserve-sign -mtriple=x86_64-linux-unknown -mattr=+avxneconvert < %s | FileCheck -check-prefixes=AVXNECONVERT %s
; RUN: llc -fast-isel -denormal-fp-math=preserve-sign -mtriple=x86_64-linux-unknown -mattr=+avxneconvert < %s | FileCheck -check-prefixes=FAST_ISEL_AVXNECONVERT %s
