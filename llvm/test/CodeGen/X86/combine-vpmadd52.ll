...
; AVX512-LABEL: test_vpmadd52l_mul_zero:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX512-NEXT:    vpmadd52luq %xmm1, %xmm2, %xmm0
; AVX512-NEXT:    retq
;
; AVX-LABEL: test_vpmadd52l_mul_zero:
; AVX:       # %bb.0:
...
; AVX512-LABEL: test_vpmadd52h_mul_zero:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX512-NEXT:    vpmadd52huq %xmm1, %xmm2, %xmm0
; AVX512-NEXT:    retq
;
; AVX-LABEL: test_vpmadd52h_mul_zero:
; AVX:       # %bb.0:
; AVX-NEXT:    vpxor %xmm2, %xmm2, %xmm2
...
; AVX512-LABEL: test_vpmadd52l_mul_zero_commuted:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX512-NEXT:    vpmadd52luq %xmm2, %xmm1, %xmm0
; AVX512-NEXT:    retq
;
; AVX-LABEL: test_vpmadd52l_mul_zero_commuted:
; AVX:       # %bb.0:
; AVX-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX-NEXT:    {vex} vpmadd52luq %xmm2, %xmm1, %xmm0
; AVX-NEXT:    retq
...
; AVX512-LABEL: test_vpmadd52l_mul_zero_both:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; AVX512-NEXT:    vpmadd52luq %xmm1, %xmm1, %xmm0
; AVX512-NEXT:    retq
;
; AVX-LABEL: test_vpmadd52l_mul_zero_both:
; AVX:       # %bb.0:
...
; AVX512-LABEL: test_vpmadd52l_mul_zero_in_52bits:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpmadd52luq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to2}, %xmm1, %xmm0
; AVX512-NEXT:    retq
;
; AVX-LABEL: test_vpmadd52l_mul_zero_in_52bits:
; AVX:       # %bb.0:
