...
; RUN: llc < %s -mtriple=x86_64-apple-macosx -mattr=+avx -opaque-pointers | FileCheck %s --check-prefixes=AVX,AVX1
; RUN: llc < %s -mtriple=x86_64-apple-macosx -mattr=+avx2 -opaque-pointers | FileCheck %s --check-prefixes=AVX,AVX2
