...
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm4 = [1431655766,1431655766,1431655766,1431655766]
...
; AVX2-NEXT:    vpaddd %xmm3, %xmm3, %xmm4
; AVX2-NEXT:    vpaddd %xmm4, %xmm3, %xmm3
...
; AVX512-NEXT:    vpbroadcastd {{.*#+}} xmm4 = [1431655766,1431655766,1431655766,1431655766]
; AVX512-NEXT:    vpmuldq %xmm4, %xmm3, %xmm3
; AVX512-NEXT:    vpmuldq %xmm4, %xmm0, %xmm4
; AVX512-NEXT:    vpshufd {{.*#+}} xmm4 = xmm4[1,1,3,3]
; AVX512-NEXT:    vpblendd {{.*#+}} xmm3 = xmm4[0],xmm3[1],xmm4[2],xmm3[3]
; AVX512-NEXT:    vpsrld $31, %xmm3, %xmm4
; AVX512-NEXT:    vpaddd %xmm4, %xmm3, %xmm3
; AVX512-NEXT:    vpaddd %xmm3, %xmm3, %xmm4
; AVX512-NEXT:    vpaddd %xmm4, %xmm3, %xmm3
; AVX512-NEXT:    vpsubd %xmm3, %xmm0, %xmm0
...
; AVX1-NEXT:    vmovups 0, %xmm2
; AVX1-NEXT:    vmovups 16, %xmm3
; AVX1-NEXT:    vmovups 32, %xmm4
; AVX1-NEXT:    vblendps {{.*#+}} xmm5 = xmm2[0],xmm4[1],xmm2[2,3]
; AVX1-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm3[2],xmm5[3]
; AVX1-NEXT:    vshufps {{.*#+}} xmm5 = xmm5[0,3,2,1]
; AVX1-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm4[2,3]
; AVX1-NEXT:    vblendps {{.*#+}} xmm2 = xmm3[0],xmm2[1,2],xmm3[3]
; AVX1-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[1,0,3,2]
; AVX1-NEXT:    vxorps %xmm3, %xmm3, %xmm3
; AVX1-NEXT:    vcmpneqps %xmm3, %xmm1, %xmm3
; AVX1-NEXT:    vblendvps %xmm3, %xmm5, %xmm1, %xmm1
