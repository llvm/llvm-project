...
;CHECK:     dead $edi = lr-split MOV32r0 implicit-def dead $eflags, implicit-def $rdi
;CHECK:     $xmm0 = COPY %68
;CHECK:     $xmm1 = COPY %64
;CHECK:     $xmm2 = COPY %6
;CHECK:     $xmm3 = COPY %52
...
;CHECK:     %80:fr64 = lr-split MOVSDrm_alt %fixed-stack.3, 1, $noreg, 0, $noreg :: (load (s64) from %fixed-stack.3, align 16)
;CHECK:     $xmm6 = COPY %80
;CHECK:     $esi = MOV32ri 51
;CHECK:     %75:fr64 = lr-split MOVSDrm_alt %fixed-stack.2, 1, $noreg, 0, $noreg :: (load (s64) from %fixed-stack.2)
;CHECK:     $xmm7 = COPY %75
