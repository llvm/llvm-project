...
; AVX1-ONLY-NEXT:    retq
;
; AVX2-SLOW-LABEL: store_i16_stride2_vf8:
; AVX2-SLOW:       # %bb.0:
; AVX2-SLOW-NEXT:    vmovdqa (%rdi), %xmm0
; AVX2-SLOW-NEXT:    vinserti128 $1, (%rsi), %ymm0, %ymm0
; AVX2-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,2,3,10,11,4,5,12,13,6,7,14,15,16,17,24,25,18,19,26,27,20,21,28,29,22,23,30,31]
; AVX2-SLOW-NEXT:    vmovdqa %ymm0, (%rdx)
; AVX2-SLOW-NEXT:    vzeroupper
; AVX2-SLOW-NEXT:    retq
;
; AVX2-FAST-LABEL: store_i16_stride2_vf8:
; AVX2-FAST:       # %bb.0:
; AVX2-FAST-NEXT:    vmovdqa (%rdi), %xmm0
; AVX2-FAST-NEXT:    vinserti128 $1, (%rsi), %ymm0, %ymm0
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,4,1,5,2,6,3,7]
...
; AVX2-FAST-NEXT:    retq
;
; AVX2-FAST-PERLANE-LABEL: store_i16_stride2_vf8:
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,2,3,10,11,4,5,12,13,6,7,14,15,16,17,24,25,18,19,26,27,20,21,28,29,22,23,30,31]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, (%rdx)
; AVX2-FAST-PERLANE-NEXT:    vzeroupper
; AVX2-FAST-PERLANE-NEXT:    retq
;
; AVX512F-SLOW-LABEL: store_i16_stride2_vf8:
; AVX512F-SLOW:       # %bb.0:
...
; AVX512F-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,2,3,10,11,4,5,12,13,6,7,14,15,16,17,24,25,18,19,26,27,20,21,28,29,22,23,30,31]
; AVX512F-SLOW-NEXT:    vmovdqa %ymm0, (%rdx)
; AVX512F-SLOW-NEXT:    vzeroupper
; AVX512F-SLOW-NEXT:    retq
;
; AVX512F-FAST-LABEL: store_i16_stride2_vf8:
; AVX512F-FAST:       # %bb.0:
; AVX512F-FAST-NEXT:    vmovdqa (%rdi), %xmm0
; AVX512F-FAST-NEXT:    vinserti128 $1, (%rsi), %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,4,1,5,2,6,3,7]
; AVX512F-FAST-NEXT:    vpermd %ymm0, %ymm1, %ymm0
; AVX512F-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,4,5,2,3,6,7,8,9,12,13,10,11,14,15,16,17,20,21,18,19,22,23,24,25,28,29,26,27,30,31]
...
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm5[4],xmm1[4],xmm5[5],xmm1[5],xmm5[6],xmm1[6],xmm5[7],xmm1[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm5[0],xmm1[0],xmm5[1],xmm1[1],xmm5[2],xmm1[2],xmm5[3],xmm1[3]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm6[4],xmm2[4],xmm6[5],xmm2[5],xmm6[6],xmm2[6],xmm6[7],xmm2[7]
...
; SSE-NEXT:    punpcklwd {{.*#+}} xmm14 = xmm14[0],xmm15[0],xmm14[1],xmm15[1],xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; SSE-NEXT:    punpckhwd {{.*#+}} xmm5 = xmm5[4],xmm15[4],xmm5[5],xmm15[5],xmm5[6],xmm15[6],xmm5[7],xmm15[7]
...
; SSE-NEXT:    movdqa %xmm0, 240(%rdx)
; SSE-NEXT:    movdqa %xmm7, 224(%rdx)
; SSE-NEXT:    movdqa %xmm6, 208(%rdx)
; SSE-NEXT:    movdqa %xmm12, 192(%rdx)
; SSE-NEXT:    movdqa %xmm4, 176(%rdx)
; SSE-NEXT:    movdqa %xmm13, 160(%rdx)
; SSE-NEXT:    movdqa %xmm3, 144(%rdx)
; SSE-NEXT:    movdqa %xmm15, 128(%rdx)
; SSE-NEXT:    movdqa %xmm5, 112(%rdx)
; SSE-NEXT:    movdqa %xmm14, 96(%rdx)
; SSE-NEXT:    movdqa %xmm2, 80(%rdx)
; SSE-NEXT:    movdqa %xmm10, 64(%rdx)
; SSE-NEXT:    movdqa %xmm1, 48(%rdx)
; SSE-NEXT:    movdqa %xmm9, 32(%rdx)
...
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm7[4],xmm4[4],xmm7[5],xmm4[5],xmm7[6],xmm4[6],xmm7[7],xmm4[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm7[0],xmm4[0],xmm7[1],xmm4[1],xmm7[2],xmm4[2],xmm7[3],xmm4[3]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm8[4],xmm5[4],xmm8[5],xmm5[5],xmm8[6],xmm5[6],xmm8[7],xmm5[7]
...
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX1-ONLY-NEXT:    vmovdqa 80(%rsi), %xmm9
; AVX1-ONLY-NEXT:    vmovdqa 80(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm12 = xmm11[4],xmm9[4],xmm11[5],xmm9[5],xmm11[6],xmm9[6],xmm11[7],xmm9[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm11[0],xmm9[0],xmm11[1],xmm9[1],xmm11[2],xmm9[2],xmm11[3],xmm9[3]
; AVX1-ONLY-NEXT:    vmovdqa 96(%rsi), %xmm11
; AVX1-ONLY-NEXT:    vmovdqa 96(%rdi), %xmm13
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm13[4],xmm11[4],xmm13[5],xmm11[5],xmm13[6],xmm11[6],xmm13[7],xmm11[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3]
; AVX1-ONLY-NEXT:    vmovdqa 112(%rsi), %xmm13
; AVX1-ONLY-NEXT:    vmovdqa 112(%rdi), %xmm15
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX1-ONLY-NEXT:    vmovdqa %xmm13, 224(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, 240(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm11, 192(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm14, 208(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm9, 160(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm12, 176(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm8, 128(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm10, 144(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, 96(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, 112(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm4, 64(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm6, 80(%rdx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, 32(%rdx)
...
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm4 = ymm0[0,1],ymm8[0,1]
...
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm5 = ymm1[0,1],ymm8[0,1]
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm1 = ymm1[2,3],ymm8[2,3]
...
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm6 = ymm2[0,1],ymm8[0,1]
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm2 = ymm2[2,3],ymm8[2,3]
...
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm7 = ymm3[0,1],ymm8[0,1]
; AVX2-ONLY-NEXT:    vperm2i128 {{.*#+}} ymm3 = ymm3[2,3],ymm8[2,3]
; AVX2-ONLY-NEXT:    vmovdqa %ymm3, 224(%rdx)
; AVX2-ONLY-NEXT:    vmovdqa %ymm7, 192(%rdx)
; AVX2-ONLY-NEXT:    vmovdqa %ymm2, 160(%rdx)
; AVX2-ONLY-NEXT:    vmovdqa %ymm6, 128(%rdx)
; AVX2-ONLY-NEXT:    vmovdqa %ymm1, 96(%rdx)
...
; AVX512F-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX512F-NEXT:    vmovdqa 48(%rsi), %xmm5
; AVX512F-NEXT:    vmovdqa (%rdi), %xmm2
; AVX512F-NEXT:    vmovdqa 16(%rdi), %xmm6
; AVX512F-NEXT:    vmovdqa 32(%rdi), %xmm7
; AVX512F-NEXT:    vmovdqa 48(%rdi), %xmm8
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
; AVX512F-NEXT:    vmovdqa64 %xmm0, %xmm16
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm6[4],xmm3[4],xmm6[5],xmm3[5],xmm6[6],xmm3[6],xmm6[7],xmm3[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm3[0],xmm6[1],xmm3[1],xmm6[2],xmm3[2],xmm6[3],xmm3[3]
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm7[4],xmm4[4],xmm7[5],xmm4[5],xmm7[6],xmm4[6],xmm7[7],xmm4[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm7[0],xmm4[0],xmm7[1],xmm4[1],xmm7[2],xmm4[2],xmm7[3],xmm4[3]
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm8[4],xmm5[4],xmm8[5],xmm5[5],xmm8[6],xmm5[6],xmm8[7],xmm5[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm8[0],xmm5[0],xmm8[1],xmm5[1],xmm8[2],xmm5[2],xmm8[3],xmm5[3]
; AVX512F-NEXT:    vmovdqa 64(%rsi), %xmm8
; AVX512F-NEXT:    vmovdqa 64(%rdi), %xmm9
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512F-NEXT:    vmovdqa 80(%rsi), %xmm9
; AVX512F-NEXT:    vmovdqa 80(%rdi), %xmm11
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm12 = xmm11[4],xmm9[4],xmm11[5],xmm9[5],xmm11[6],xmm9[6],xmm11[7],xmm9[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm11[0],xmm9[0],xmm11[1],xmm9[1],xmm11[2],xmm9[2],xmm11[3],xmm9[3]
; AVX512F-NEXT:    vmovdqa 96(%rsi), %xmm11
; AVX512F-NEXT:    vmovdqa 96(%rdi), %xmm13
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm13[4],xmm11[4],xmm13[5],xmm11[5],xmm13[6],xmm11[6],xmm13[7],xmm11[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3]
; AVX512F-NEXT:    vmovdqa 112(%rsi), %xmm13
; AVX512F-NEXT:    vmovdqa 112(%rdi), %xmm15
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm0 = xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX512F-NEXT:    vmovdqa %xmm13, 224(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm0, 240(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm11, 192(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm14, 208(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm9, 160(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm12, 176(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm8, 128(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm10, 144(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm5, 96(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm7, 112(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm4, 64(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm6, 80(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm3, 32(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm2, 48(%rdx)
; AVX512F-NEXT:    vmovdqa %xmm1, (%rdx)
; AVX512F-NEXT:    vmovdqa64 %xmm16, 16(%rdx)
; AVX512F-NEXT:    retq
;
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm4 = [0,32,1,33,2,34,3,35,4,36,5,37,6,38,7,39,8,40,9,41,10,42,11,43,12,44,13,45,14,46,15,47]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512BW-NEXT:    vpermt2w %zmm2, %zmm4, %zmm5
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [16,48,17,49,18,50,19,51,20,52,21,53,22,54,23,55,24,56,25,57,26,58,27,59,28,60,29,61,30,62,31,63]
