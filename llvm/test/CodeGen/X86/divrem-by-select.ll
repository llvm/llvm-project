...
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} {z} = [1,1]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
...
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} = [0,5]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm0, %rcx
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
; CHECK-X64-V4-NEXT:    xorl %edx, %edx
; CHECK-X64-V4-NEXT:    divq %rcx
...
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} = [1,1]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm0, %rcx
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
; CHECK-X64-V4-NEXT:    xorl %edx, %edx
; CHECK-X64-V4-NEXT:    divq %rcx
...
; CHECK-X64-V4-NEXT:    vpmovq2m %xmm0, %k1
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 = [1,1]
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} = [11,13]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm0, %rcx
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
...
; CHECK-X64-V4-NEXT:    vpmovq2m %xmm0, %k1
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 = [1,1]
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} = [11,17]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm0, %rcx
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
; CHECK-X64-V4-NEXT:    cqto
; CHECK-X64-V4-NEXT:    idivq %rcx
...
; CHECK-X64-V4-NEXT:    vpmovq2m %xmm0, %k1
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 = [1,1]
; CHECK-X64-V4-NEXT:    vpmovsxbq {{.*#+}} xmm0 {%k1} = [11,11]
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm0, %rcx
; CHECK-X64-V4-NEXT:    vpextrq $1, %xmm1, %rax
; CHECK-X64-V4-NEXT:    xorl %edx, %edx
; CHECK-X64-V4-NEXT:    divq %rcx
