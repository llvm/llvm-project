...
; SSE2-NEXT:    movdqa %xmm3, %xmm4
; SSE2-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm2[0,2]
...
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm3[0,2]
; SSE2-NEXT:    movdqa %xmm6, %xmm8
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[0,2],xmm5[0,2]
...
; SSE2-NEXT:    psraw $8, %xmm11
; SSE2-NEXT:    punpcklbw {{.*#+}} xmm13 = xmm13[0],xmm9[0],xmm13[1],xmm9[1],xmm13[2],xmm9[2],xmm13[3],xmm9[3],xmm13[4],xmm9[4],xmm13[5],xmm9[5],xmm13[6],xmm9[6],xmm13[7],xmm9[7]
; SSE2-NEXT:    psraw $8, %xmm13
; SSE2-NEXT:    pmullw %xmm11, %xmm13
; SSE2-NEXT:    punpckhwd {{.*#+}} xmm12 = xmm12[4],xmm13[4],xmm12[5],xmm13[5],xmm12[6],xmm13[6],xmm12[7],xmm13[7]
; SSE2-NEXT:    psrad $16, %xmm12
; SSE2-NEXT:    punpcklwd {{.*#+}} xmm11 = xmm11[0],xmm13[0],xmm11[1],xmm13[1],xmm11[2],xmm13[2],xmm11[3],xmm13[3]
...
; SSE2-NEXT:    movdqa %xmm9, %xmm13
; SSE2-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,2],xmm10[0,2]
; SSE2-NEXT:    movdqa %xmm11, %xmm14
; SSE2-NEXT:    shufps {{.*#+}} xmm14 = xmm14[0,2],xmm12[0,2]
; SSE2-NEXT:    movdqa %xmm7, %xmm15
; SSE2-NEXT:    shufps {{.*#+}} xmm15 = xmm15[0,2],xmm8[0,2]
; SSE2-NEXT:    movdqa %xmm5, %xmm0
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,2],xmm6[0,2]
; SSE2-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,3],xmm10[1,3]
; SSE2-NEXT:    paddd %xmm13, %xmm9
; SSE2-NEXT:    paddd %xmm9, %xmm3
; SSE2-NEXT:    shufps {{.*#+}} xmm11 = xmm11[1,3],xmm12[1,3]
; SSE2-NEXT:    paddd %xmm14, %xmm11
; SSE2-NEXT:    paddd %xmm11, %xmm1
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,3],xmm8[1,3]
; SSE2-NEXT:    paddd %xmm15, %xmm7
; SSE2-NEXT:    paddd %xmm7, %xmm4
; SSE2-NEXT:    shufps {{.*#+}} xmm5 = xmm5[1,3],xmm6[1,3]
; SSE2-NEXT:    paddd %xmm0, %xmm5
; SSE2-NEXT:    paddd %xmm5, %xmm2
...
; AVX512-NEXT:    vmovdqa {{.*#+}} xmm1 = [1,3,5,7]
...
; AVX256-NEXT:    vpmaddwd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0
; AVX256-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX256-NEXT:    vphaddd %xmm1, %xmm0, %xmm0
; AVX256-NEXT:    vzeroupper
; AVX256-NEXT:    retq
...
; AVX512-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
; AVX512-NEXT:    vphaddd %ymm1, %ymm0, %ymm0
; AVX512-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,5,4,3,2,7,6]
...
; AVX2-NEXT:    vpblendw {{.*#+}} xmm4 = xmm1[0],xmm0[1],xmm1[2],xmm0[3],xmm1[4],xmm0[5],xmm1[6],xmm0[7]
...
; AVX2-NEXT:    vpblendw {{.*#+}} xmm5 = xmm4[0],xmm0[1],xmm4[2],xmm0[3],xmm4[4],xmm0[5],xmm4[6],xmm0[7]
...
; AVX2-NEXT:    vpmovsxwd %xmm0, %ymm0
; AVX2-NEXT:    vpmulld %ymm0, %ymm3, %ymm0
; AVX2-NEXT:    vpmovsxwd %xmm1, %ymm1
...
; SSE2-NEXT:    pshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,5,4,6,7]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm0 = mem[1,0,2,3,4,5,6,7]
...
; SSE2-NEXT:    paddd %xmm3, %xmm0
; SSE2-NEXT:    paddd %xmm1, %xmm0
; SSE2-NEXT:    movdqu (%r8), %xmm1
; SSE2-NEXT:    movdqu (%r9), %xmm2
; SSE2-NEXT:    movdqa %xmm1, %xmm3
; SSE2-NEXT:    pmulhw %xmm2, %xmm3
; SSE2-NEXT:    pmullw %xmm2, %xmm1
; SSE2-NEXT:    movdqa %xmm1, %xmm2
