...
; AVX1-NEXT:    vshufpd {{.*#+}} xmm2 = xmm1[1,0]
; AVX1-NEXT:    vshufpd {{.*#+}} xmm3 = xmm0[1,0]
; AVX1-NEXT:    vmaxsd %xmm0, %xmm3, %xmm4
; AVX1-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm0
; AVX1-NEXT:    vblendvpd %xmm0, %xmm3, %xmm4, %xmm0
; AVX1-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm3
; AVX1-NEXT:    vmaxsd %xmm0, %xmm1, %xmm0
; AVX1-NEXT:    vblendvpd %xmm3, %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm1
; AVX1-NEXT:    vmaxsd %xmm0, %xmm2, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm0[3,2,2,3]
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm2
; AVX2-NEXT:    vshufpd {{.*#+}} xmm3 = xmm0[1,0]
; AVX2-NEXT:    vmaxsd %xmm0, %xmm3, %xmm4
; AVX2-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm0
; AVX2-NEXT:    vblendvpd %xmm0, %xmm3, %xmm4, %xmm0
; AVX2-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm3
; AVX2-NEXT:    vmaxsd %xmm0, %xmm2, %xmm0
; AVX2-NEXT:    vblendvpd %xmm3, %xmm2, %xmm0, %xmm0
; AVX2-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm2
; AVX2-NEXT:    vmaxsd %xmm0, %xmm1, %xmm0
...
; AVX1-NEXT:    vblendvpd %xmm2, %xmm0, %xmm1, %xmm1
; AVX1-NEXT:    vcmpunordsd %xmm1, %xmm1, %xmm2
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vmaxpd %ymm0, %ymm1, %ymm2
...
; AVX2-NEXT:    vcmpunordsd %xmm0, %xmm0, %xmm3
; AVX2-NEXT:    vblendvpd %xmm3, %xmm1, %xmm2, %xmm1
; AVX2-NEXT:    vcmpunordsd %xmm1, %xmm1, %xmm2
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm3
; AVX2-NEXT:    vmaxsd %xmm1, %xmm3, %xmm1
; AVX2-NEXT:    vblendvpd %xmm2, %xmm3, %xmm1, %xmm1
; AVX2-NEXT:    vcmpunordsd %xmm1, %xmm1, %xmm2
...
; AVX512BW-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[3,2,2,3]
...
; AVX512VL-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[3,2,2,3]
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vmaxpd %ymm0, %ymm2, %ymm4
; AVX2-NEXT:    vcmpunordpd %ymm0, %ymm0, %ymm0
; AVX2-NEXT:    vblendvpd %ymm0, %ymm2, %ymm4, %ymm0
; AVX2-NEXT:    vmaxpd %ymm1, %ymm3, %ymm2
; AVX2-NEXT:    vcmpunordpd %ymm1, %ymm1, %ymm1
...
; AVX512-NEXT:    vmovsd %xmm0, %xmm1, %xmm1 {%k1}
; AVX512-NEXT:    vcmpunordsd %xmm1, %xmm1, %k1
; AVX512-NEXT:    vpermpd {{.*#+}} ymm0 = ymm2[3,2,2,3]
; AVX512-NEXT:    vmaxsd %xmm1, %xmm0, %xmm1
; AVX512-NEXT:    vmovsd %xmm0, %xmm1, %xmm1 {%k1}
; AVX512-NEXT:    vcmpunordsd %xmm1, %xmm1, %k1
