...
; SSE42-NEXT:    pshufb {{.*#+}} xmm2 = xmm2[0,1,6,7,12,13,2,3,8,9,14,15,u,u,u,u]
; SSE42-NEXT:    movdqu 32(%rdi), %xmm3
; SSE42-NEXT:    movdqa %xmm0, %xmm4
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0,1],xmm1[2],xmm4[3,4],xmm1[5],xmm4[6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1],xmm0[2],xmm1[3,4],xmm0[5],xmm1[6,7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[0,1,2,1]
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm3[0],xmm4[1,2],xmm3[3],xmm4[4,5],xmm3[6],xmm4[7]
; SSE42-NEXT:    pshufb {{.*#+}} xmm4 = xmm4[2,3,8,9,14,15,4,5,10,11,0,1,6,7,12,13]
; SSE42-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,5,6,5]
; SSE42-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0],xmm3[1],xmm1[2,3],xmm3[4],xmm1[5,6],xmm3[7]
; SSE42-NEXT:    pshufb {{.*#+}} xmm1 = xmm1[4,5,10,11,0,1,6,7,12,13,2,3,8,9,14,15]
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,5],xmm0[6,7]
; SSE42-NEXT:    movdqu %xmm2, (%rsi)
; SSE42-NEXT:    movdqu %xmm4, (%rdx)
...
; AVX1-NEXT:    vpblendw {{.*#+}} xmm3 = xmm0[0],xmm1[1],xmm0[2,3],xmm1[4],xmm0[5,6],xmm1[7]
...
; AVX1-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[0,1,2,1]
...
; AVX1-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,5,6,5]
...
; SSE42:       # %bb.0:
; SSE42-NEXT:    movdqu 16(%rdi), %xmm0
; SSE42-NEXT:    movdqu 32(%rdi), %xmm1
; SSE42-NEXT:    movdqa %xmm0, %xmm2
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0],xmm1[1],xmm2[2,3],xmm1[4],xmm2[5,6],xmm1[7]
; SSE42-NEXT:    pshufb {{.*#+}} xmm2 = xmm2[14,15,8,9,2,3,12,13,6,7,0,1,u,u,u,u]
; SSE42-NEXT:    movdqu (%rdi), %xmm3
; SSE42-NEXT:    movdqa %xmm1, %xmm4
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0,1],xmm0[2],xmm4[3,4],xmm0[5],xmm4[6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1],xmm1[2],xmm0[3,4],xmm1[5],xmm0[6,7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm3[0,1,2,1]
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0],xmm3[1],xmm4[2,3],xmm3[4],xmm4[5,6],xmm3[7]
; SSE42-NEXT:    pshufb {{.*#+}} xmm4 = xmm4[12,13,6,7,0,1,10,11,4,5,14,15,8,9,2,3]
; SSE42-NEXT:    pshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,5,5,6]
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm3[0],xmm0[1,2],xmm3[3],xmm0[4,5],xmm3[6],xmm0[7]
; SSE42-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[10,11,4,5,14,15,8,9,2,3,12,13,6,7,0,1]
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,5],xmm1[6,7]
; SSE42-NEXT:    movdqu %xmm2, (%rsi)
; SSE42-NEXT:    movdqu %xmm4, (%rdx)
; SSE42-NEXT:    movdqu %xmm0, (%rcx)
; SSE42-NEXT:    retq
;
...
; AVX2-NEXT:    vmovdqu 192(%rdi), %ymm1
