...
; SSE4-NEXT:    movq {{.*#+}} xmm3 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm3
; SSE4-NEXT:    movd %xmm3, %r12d
; SSE4-NEXT:    movq {{.*#+}} xmm3 = mem[0],zero
; SSE4-NEXT:    movq {{.*#+}} xmm4 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm4
; SSE4-NEXT:    movq {{.*#+}} xmm5 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm5
; SSE4-NEXT:    movd %xmm5, %eax
; SSE4-NEXT:    movq {{.*#+}} xmm5 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm5
; SSE4-NEXT:    movq {{.*#+}} xmm6 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm6
; SSE4-NEXT:    movq {{.*#+}} xmm7 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm7
; SSE4-NEXT:    movd %xmm7, %ecx
; SSE4-NEXT:    movq {{.*#+}} xmm7 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm7
; SSE4-NEXT:    movq {{.*#+}} xmm8 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm8
; SSE4-NEXT:    movq {{.*#+}} xmm9 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm9
; SSE4-NEXT:    movd %xmm9, %ebx
; SSE4-NEXT:    movq {{.*#+}} xmm9 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm9
; SSE4-NEXT:    movd %xmm9, %esi
...
; SSE4-NEXT:    movq {{[0-9]+}}(%rsp), %rsi
; SSE4-NEXT:    sbbb $0, %r12b
; SSE4-NEXT:    cmpq %rcx, %rsi
; SSE4-NEXT:    movq %rdx, %rdi
; SSE4-NEXT:    sbbq %rax, %rdi
; SSE4-NEXT:    movq {{.*#+}} xmm1 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm1
; SSE4-NEXT:    setb %r15b
; SSE4-NEXT:    cmpq %rsi, %rcx
; SSE4-NEXT:    movd %xmm1, %ecx
; SSE4-NEXT:    movq {{.*#+}} xmm1 = mem[0],zero
; SSE4-NEXT:    pand %xmm0, %xmm1
...
; SSE4-NEXT:    movzbl %r13b, %esi
; SSE4-NEXT:    movd %esi, %xmm7
; SSE4-NEXT:    movzbl %r12b, %esi
; SSE4-NEXT:    movd %esi, %xmm0
; SSE4-NEXT:    movzbl %r15b, %esi
; SSE4-NEXT:    movd %esi, %xmm8
; SSE4-NEXT:    movzbl %r14b, %esi
; SSE4-NEXT:    movd %esi, %xmm9
; SSE4-NEXT:    movzbl %bpl, %esi
; SSE4-NEXT:    movd %esi, %xmm10
; SSE4-NEXT:    movzbl %bl, %esi
; SSE4-NEXT:    movd %esi, %xmm11
; SSE4-NEXT:    movzbl %r10b, %esi
; SSE4-NEXT:    movd %esi, %xmm12
; SSE4-NEXT:    movzbl %dl, %edx
...
; SSE2-NEXT:    pushq %r12
; SSE2-NEXT:    pushq %rbx
; SSE2-NEXT:    pinsrq $1, {{[0-9]+}}(%rsp), %xmm1
...
; SSE2-NEXT:    pinsrb $1, %esi, %xmm0
; SSE2-NEXT:    pinsrb $2, %ebp, %xmm0
; SSE2-NEXT:    pinsrb $3, %r8d, %xmm0
; SSE2-NEXT:    andl $3, %eax
; SSE2-NEXT:    movb %al, 4(%r10)
; SSE2-NEXT:    movd %xmm0, %eax
; SSE2-NEXT:    andl $3, %eax
; SSE2-NEXT:    andl $3, %esi
; SSE2-NEXT:    leal (%rax,%rsi,4), %eax
; SSE2-NEXT:    andl $3, %ebp
; SSE2-NEXT:    shll $4, %ebp
; SSE2-NEXT:    orl %eax, %ebp
; SSE2-NEXT:    andl $3, %r8d
; SSE2-NEXT:    shll $6, %r8d
; SSE2-NEXT:    orl %ebp, %r8d
; SSE2-NEXT:    movzbl %dil, %eax
; SSE2-NEXT:    andl $3, %eax
; SSE2-NEXT:    shll $8, %eax
; SSE2-NEXT:    orl %r8d, %eax
...
; AVX2-NEXT:    pushq %r12
; AVX2-NEXT:    pushq %rbx
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm1
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
...
; AVX2-NEXT:    cmpq %rbp, %r14
; AVX2-NEXT:    movq %r13, %r12
; AVX2-NEXT:    sbbq %r15, %r12
; AVX2-NEXT:    setb %r8b
; AVX2-NEXT:    cmpq %r14, %rbp
; AVX2-NEXT:    vpextrq $1, %xmm2, %r14
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
...
; AVX2-NEXT:    cmpq %r12, %r15
; AVX2-NEXT:    movq %r14, %r13
; AVX2-NEXT:    sbbq %rbx, %r13
; AVX2-NEXT:    vpextrq $1, %xmm2, %r13
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX2-NEXT:    setb %r8b
; AVX2-NEXT:    cmpq %r15, %r12
; AVX2-NEXT:    vpextrq $1, %xmm2, %r15
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r12
...
; AVX2-NEXT:    sbbb $0, %r8b
; AVX2-NEXT:    movb %r8b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; AVX2-NEXT:    cmpq %r12, %rbx
; AVX2-NEXT:    movq %r15, %r14
; AVX2-NEXT:    sbbq %r13, %r14
; AVX2-NEXT:    setb %r8b
; AVX2-NEXT:    cmpq %rbx, %r12
; AVX2-NEXT:    vpextrq $1, %xmm2, %rbx
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r14
...
; AVX2-NEXT:    cmpq %r15, %r11
; AVX2-NEXT:    movq %r14, %rbx
; AVX2-NEXT:    sbbq %r12, %rbx
; AVX2-NEXT:    setb %r8b
; AVX2-NEXT:    cmpq %r11, %r15
; AVX2-NEXT:    vpextrq $1, %xmm2, %r11
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
...
; AVX2-NEXT:    sbbb $0, %r8b
; AVX2-NEXT:    movb %r8b, {{[-0-9]+}}(%r{{[sb]}}p) # 1-byte Spill
; AVX2-NEXT:    cmpq %r14, %r11
; AVX2-NEXT:    movq %rbx, %r10
; AVX2-NEXT:    sbbq %r15, %r10
; AVX2-NEXT:    setb %r8b
; AVX2-NEXT:    cmpq %r11, %r14
; AVX2-NEXT:    vpextrq $1, %xmm2, %r14
; AVX2-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX2-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r12
...
; AVX512-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm1
; AVX512-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX512-NEXT:    vpand %xmm0, %xmm2, %xmm2
...
; AVX512-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm2
; AVX512-NEXT:    vpand %xmm0, %xmm1, %xmm1
; AVX512-NEXT:    vpand %xmm0, %xmm2, %xmm2
; AVX512-NEXT:    setb %dil
...
; AVX512-NEXT:    cmpq %r14, %rsi
; AVX512-NEXT:    movq %rdx, %rdi
; AVX512-NEXT:    sbbq %r12, %rdi
; AVX512-NEXT:    vpinsrq $1, {{[0-9]+}}(%rsp), %xmm0, %xmm1
; AVX512-NEXT:    setb %dil
; AVX512-NEXT:    cmpq %rsi, %r14
