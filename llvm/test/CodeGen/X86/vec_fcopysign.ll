...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogq {{.*#+}} xmm0 = xmm1 ^ (mem & (xmm0 ^ xmm1))
...
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogq {{.*#+}} xmm0 = xmm1 ^ (mem & (xmm0 ^ xmm1))
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (mem & (xmm0 ^ xmm1))
; X86-AVX512-NEXT:    retl
;
...
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (mem & (xmm0 ^ xmm1))
; X64-AVX512-NEXT:    retq
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm1 ^ (mem & (ymm0 ^ ymm1))
; X86-AVX512-NEXT:    retl
;
...
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogq {{.*#+}} ymm0 = ymm1 ^ (mem & (ymm0 ^ ymm1))
; X64-AVX512-NEXT:    retq
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogd {{.*#+}} ymm0 = ymm1 ^ (mem & (ymm0 ^ ymm1))
; X86-AVX512-NEXT:    retl
;
...
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogd {{.*#+}} ymm0 = ymm1 ^ (mem & (ymm0 ^ ymm1))
; X64-AVX512-NEXT:    retq
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: fcopysign_v8f64:
; X86-AVX2:       # %bb.0:
...
; X86-AVX2-NEXT:    vbroadcastsd {{.*#+}} ymm3 = [NaN,NaN,NaN,NaN]
; X86-AVX2-NEXT:    vandnps %ymm2, %ymm3, %ymm2
; X86-AVX2-NEXT:    vandps %ymm3, %ymm0, %ymm0
; X86-AVX2-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X86-AVX2-NEXT:    vandnps 8(%ebp), %ymm3, %ymm2
; X86-AVX2-NEXT:    vandps %ymm3, %ymm1, %ymm1
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm1 ^ (mem & (zmm0 ^ zmm1))
; X86-AVX512-NEXT:    retl
;
...
; X64-SSE-NEXT:    retq
;
; X64-AVX1-LABEL: fcopysign_v8f64:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vmovaps {{.*#+}} ymm4 = [NaN,NaN,NaN,NaN]
; X64-AVX1-NEXT:    vandnps %ymm2, %ymm4, %ymm2
; X64-AVX1-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X64-AVX1-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X64-AVX1-NEXT:    vandnps %ymm3, %ymm4, %ymm2
; X64-AVX1-NEXT:    vandps %ymm4, %ymm1, %ymm1
; X64-AVX1-NEXT:    vorps %ymm2, %ymm1, %ymm1
; X64-AVX1-NEXT:    retq
;
; X64-AVX2-LABEL: fcopysign_v8f64:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vbroadcastsd {{.*#+}} ymm4 = [NaN,NaN,NaN,NaN]
; X64-AVX2-NEXT:    vandnps %ymm2, %ymm4, %ymm2
; X64-AVX2-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X64-AVX2-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X64-AVX2-NEXT:    vandnps %ymm3, %ymm4, %ymm2
; X64-AVX2-NEXT:    vandps %ymm4, %ymm1, %ymm1
; X64-AVX2-NEXT:    vorps %ymm2, %ymm1, %ymm1
; X64-AVX2-NEXT:    retq
;
; X64-AVX512-LABEL: fcopysign_v8f64:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm1 ^ (mem & (zmm0 ^ zmm1))
; X64-AVX512-NEXT:    retq
...
; X86-SSE-NEXT:    retl
;
; X86-AVX1-LABEL: fcopysign_v16f32:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    pushl %ebp
; X86-AVX1-NEXT:    movl %esp, %ebp
; X86-AVX1-NEXT:    andl $-32, %esp
; X86-AVX1-NEXT:    subl $32, %esp
; X86-AVX1-NEXT:    vmovaps {{.*#+}} ymm3 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
; X86-AVX1-NEXT:    vandnps %ymm2, %ymm3, %ymm2
; X86-AVX1-NEXT:    vandps %ymm3, %ymm0, %ymm0
; X86-AVX1-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X86-AVX1-NEXT:    vandnps 8(%ebp), %ymm3, %ymm2
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: fcopysign_v16f32:
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    pushl %ebp
; X86-AVX2-NEXT:    movl %esp, %ebp
; X86-AVX2-NEXT:    andl $-32, %esp
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vpternlogd {{.*#+}} zmm0 = zmm1 ^ (mem & (zmm0 ^ zmm1))
; X86-AVX512-NEXT:    retl
;
...
; X64-SSE-NEXT:    retq
;
; X64-AVX1-LABEL: fcopysign_v16f32:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vmovaps {{.*#+}} ymm4 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
; X64-AVX1-NEXT:    vandnps %ymm2, %ymm4, %ymm2
; X64-AVX1-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X64-AVX1-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X64-AVX1-NEXT:    vandnps %ymm3, %ymm4, %ymm2
...
; X64-AVX1-NEXT:    retq
;
; X64-AVX2-LABEL: fcopysign_v16f32:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vbroadcastss {{.*#+}} ymm4 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
; X64-AVX2-NEXT:    vandnps %ymm2, %ymm4, %ymm2
; X64-AVX2-NEXT:    vandps %ymm4, %ymm0, %ymm0
; X64-AVX2-NEXT:    vorps %ymm2, %ymm0, %ymm0
; X64-AVX2-NEXT:    vandnps %ymm3, %ymm4, %ymm2
...
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpternlogd {{.*#+}} zmm0 = zmm1 ^ (mem & (zmm0 ^ zmm1))
; X64-AVX512-NEXT:    retq
...
; X86-AVX1-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-AVX1-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-AVX1-NEXT:    vmovaps {{.*#+}} ymm0 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
...
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vmovaps {{.*#+}} ymm0 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
