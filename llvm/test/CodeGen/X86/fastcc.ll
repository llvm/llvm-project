...
@d = external global double		; <ptr> [#uses=1]
@c = external global double		; <ptr> [#uses=1]
@b = external global double		; <ptr> [#uses=1]
@a = external global double		; <ptr> [#uses=1]

define i32 @foo() nounwind {
entry:
	%0 = load double, ptr @d, align 8		; <double> [#uses=1]
	%1 = load double, ptr @c, align 8		; <double> [#uses=1]
	%2 = load double, ptr @b, align 8		; <double> [#uses=1]
	%3 = load double, ptr @a, align 8		; <double> [#uses=1]
