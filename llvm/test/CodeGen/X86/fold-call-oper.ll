...
; CHECK: callq *{{.*}}(%rbp)
; CHECK: callq *{{.*}}(%rbp)
define void @foldCallOper(ptr nocapture %p1) #0 {
entry:
...
for.body3.lr.ph.i:                                ; preds = %for.body.i
  %call.i = tail call i32 %p1(ptr undef, i32 0, ptr null)
  %tobool.i = icmp eq i32 %call.i, 0
  br label %for.body3.i

for.body3.i:                                      ; preds = %for.inc8.i, %for.body3.lr.ph.i
  %1 = phi ptr [ undef, %for.body3.lr.ph.i ], [ %.pre.i, %for.inc8.i ]
  %indvars.iv.i = phi i64 [ 1, %for.body3.lr.ph.i ], [ %phitmp.i, %for.inc8.i ]
  %call5.i = tail call i32 %p1(ptr %1, i32 0, ptr %0)
...
for.inc8.i:                                       ; preds = %if.then.i, %for.body3.i
  ...
  %arrayidx4.phi.trans.insert.i = getelementptr inbounds [0 x ptr], ptr undef, i64 0, i64 %indvars.iv.i
  %.pre.i = load ptr, ptr %arrayidx4.phi.trans.insert.i, align 8
