...
%"class.llvm::SDNode.10.610.970.1930.2050.2290.4090" = type { %"class.llvm::FoldingSetImpl::Node.0.600.960.1920.2040.2280.4080", %"class.llvm::ilist_node.2.602.962.1922.2042.2282.4082", i16, [2 x i8], i32, ptr, ptr, ptr, i16, i16, %"class.llvm::DebugLoc.9.609.969.1929.2049.2289.4089", i32 }
%"class.llvm::FoldingSetImpl::Node.0.600.960.1920.2040.2280.4080" = type { ptr }
%"class.llvm::ilist_node.2.602.962.1922.2042.2282.4082" = type { %"class.llvm::ilist_half_node.1.601.961.1921.2041.2281.4081", ptr }
%"class.llvm::ilist_half_node.1.601.961.1921.2041.2281.4081" = type { ptr }
%"struct.llvm::EVT.8.608.968.1928.2048.2288.4088" = type { %"class.llvm::MVT.5.605.965.1925.2045.2285.4085", ptr }
%"class.llvm::MVT.5.605.965.1925.2045.2285.4085" = type { i32 }
%"class.llvm::SDUse.4.604.964.1924.2044.2284.4084" = type { %"class.llvm::SDValue.3.603.963.1923.2043.2283.4083", ptr, ptr, ptr }
%"class.llvm::SDValue.3.603.963.1923.2043.2283.4083" = type { ptr, i32 }
%"class.llvm::DebugLoc.9.609.969.1929.2049.2289.4089" = type { i32, i32 }
%"class.llvm::SelectionDAG.104.704.1064.2024.2144.2384.4184" = type { ptr, ptr, ptr, ptr, ptr, ptr, i32, %"class.llvm::SDNode.10.610.970.1930.2050.2290.4090", %"class.llvm::SDValue.3.603.963.1923.2043.2283.4083", %"struct.llvm::ilist.55.655.1015.1975.2095.2335.4135", %"class.llvm::RecyclingAllocator.65.665.1025.1985.2105.2345.4145", %"class.llvm::FoldingSet.67.667.1027.1987.2107.2347.4147", %"class.llvm::BumpPtrAllocator.64.664.1024.1984.2104.2344.4144", %"class.llvm::BumpPtrAllocator.64.664.1024.1984.2104.2344.4144", ptr, i8, ptr, %"class.std::map.43.84.684.1044.2004.2124.2364.4164", %"class.llvm::FoldingSet.50.85.685.1045.2005.2125.2365.4165", %"class.std::vector.51.89.689.1049.2009.2129.2369.4169", %"class.std::vector.56.92.692.1052.2012.2132.2372.4172", %"class.std::map.61.96.696.1056.2016.2136.2376.4176", %"class.llvm::StringMap.99.699.1059.2019.2139.2379.4179", %"class.std::map.66.103.703.1063.2023.2143.2383.4183" }
%"class.llvm::TargetMachine.17.617.977.1937.2057.2297.4097" = type { ptr, ptr, %"class.std::basic_string.13.613.973.1933.2053.2293.4093", %"class.std::basic_string.13.613.973.1933.2053.2293.4093", %"class.std::basic_string.13.613.973.1933.2053.2293.4093", ptr, ptr, i8, %"class.llvm::TargetOptions.16.616.976.1936.2056.2296.4096" }
...
%"struct.std::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider.12.612.972.1932.2052.2292.4092" = type { ptr }
...
%"class.llvm::TargetLoweringBase.50.650.1010.1970.2090.2330.4130" = type { ptr, ptr, ptr, ptr, i8, i8, i8, i8, %"class.llvm::DenseMap.11.38.638.998.1958.2078.2318.4118", i8, i8, i8, i8, i8, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i8, i32, i32, i32, [58 x ptr], [58 x i8], [58 x %"class.llvm::MVT.5.605.965.1925.2045.2285.4085"], [58 x ptr], [58 x i8], [58 x %"class.llvm::MVT.5.605.965.1925.2045.2285.4085"], [58 x [188 x i8]], [58 x [4 x i8]], [58 x [58 x i8]], [58 x [5 x i8]], [24 x [4 x i32]], %"class.llvm::TargetLoweringBase::ValueTypeActionImpl.40.640.1000.1960.2080.2320.4120", %"class.std::vector.15.44.644.1004.1964.2084.2324.4124", [24 x i8], %"class.std::map.49.649.1009.1969.2089.2329.4129", [341 x ptr], [341 x i32], [341 x i32], i32, i32, i32, i32, i32, i32, i8 }
%"class.llvm::DataLayout.35.635.995.1955.2075.2315.4115" = type { [28 x i8], i8, i32, i32, %"class.llvm::SmallVector.23.623.983.1943.2063.2303.4103", %"class.llvm::SmallVector.3.31.631.991.1951.2071.2311.4111", %"class.llvm::DenseMap.34.634.994.1954.2074.2314.4114", ptr }
...
%"class.llvm::SmallVectorBase.24.624.984.1944.2064.2304.4104" = type { ptr, ptr, ptr }
...
%"class.llvm::DenseMap.34.634.994.1954.2074.2314.4114" = type { ptr, i32, i32, i32 }
...
%"class.llvm::DenseMap.11.38.638.998.1958.2078.2318.4118" = type { ptr, i32, i32, i32 }
...
%"struct.std::_Vector_base<std::pair<llvm::MVT, const llvm::TargetRegisterClass *>, std::allocator<std::pair<llvm::MVT, const llvm::TargetRegisterClass *> > >::_Vector_impl.42.642.1002.1962.2082.2322.4122" = type { ptr, ptr, ptr }
%"struct.std::pair.20.41.641.1001.1961.2081.2321.4121" = type { %"class.llvm::MVT.5.605.965.1925.2045.2285.4085", ptr }
...
%"struct.std::_Rb_tree_node_base.46.646.1006.1966.2086.2326.4126" = type { i32, ptr, ptr, ptr }
...
%"class.llvm::iplist.54.654.1014.1974.2094.2334.4134" = type { %"struct.llvm::ilist_traits.53.653.1013.1973.2093.2333.4133", ptr }
...
%"class.llvm::iplist.24.58.658.1018.1978.2098.2338.4138" = type { %"struct.llvm::ilist_traits.25.57.657.1017.1977.2097.2337.4137", ptr }
...
%"struct.llvm::RecyclerStruct.56.656.1016.1976.2096.2336.4136" = type { ptr, ptr }
%"class.llvm::FoldingSet.67.667.1027.1987.2107.2347.4147" = type { %"class.llvm::FoldingSetImpl.66.666.1026.1986.2106.2346.4146" }
%"class.llvm::FoldingSetImpl.66.666.1026.1986.2106.2346.4146" = type { ptr, ptr, i32, i32 }
%"class.llvm::BumpPtrAllocator.64.664.1024.1984.2104.2344.4144" = type { i64, i64, %"class.llvm::MallocSlabAllocator.62.662.1022.1982.2102.2342.4142", ptr, ptr, ptr, ptr, i64 }
...
%"class.llvm::SlabAllocator.60.660.1020.1980.2100.2340.4140" = type { ptr }
%"class.llvm::MallocAllocator.61.661.1021.1981.2101.2341.4141" = type { i8 }
%"class.llvm::MemSlab.63.663.1023.1983.2103.2343.4143" = type { i64, ptr }
...
%"class.llvm::DenseMap.37.78.678.1038.1998.2118.2358.4158" = type { ptr, i32, i32, i32 }
%"struct.std::pair.40.77.677.1037.1997.2117.2357.4157" = type { ptr, %"class.llvm::SmallVector.41.76.676.1036.1996.2116.2356.4156" }
...
%"struct.llvm::SelectionDAG::DAGUpdateListener.80.680.1040.2000.2120.2360.4160" = type { ptr, ptr, ptr }
...
%"struct.std::_Vector_base<llvm::CondCodeSDNode *, std::allocator<llvm::CondCodeSDNode *> >::_Vector_impl.87.687.1047.2007.2127.2367.4167" = type { ptr, ptr, ptr }
...
%"struct.std::_Vector_base<llvm::SDNode *, std::allocator<llvm::SDNode *> >::_Vector_impl.90.690.1050.2010.2130.2370.4170" = type { ptr, ptr, ptr }
...
%"class.llvm::StringMapImpl.98.698.1058.2018.2138.2378.4178" = type { ptr, i32, i32, i32, i32 }
...
%"class.llvm::Type.7.607.967.1927.2047.2287.4087" = type { ptr, i32, i32, ptr }
%"class.llvm::DAGTypeLegalizer.117.717.1077.2037.2157.2397.4197" = type { ptr, ptr, %"class.llvm::TargetLoweringBase::ValueTypeActionImpl.40.640.1000.1960.2080.2320.4120", [6 x i8], %"class.llvm::SmallDenseMap.107.707.1067.2027.2147.2387.4187", %"class.llvm::SmallDenseMap.77.110.710.1070.2030.2150.2390.4190", %"class.llvm::SmallDenseMap.107.707.1067.2027.2147.2387.4187", %"class.llvm::SmallDenseMap.77.110.710.1070.2030.2150.2390.4190", %"class.llvm::SmallDenseMap.107.707.1067.2027.2147.2387.4187", %"class.llvm::SmallDenseMap.77.110.710.1070.2030.2150.2390.4190", %"class.llvm::SmallDenseMap.107.707.1067.2027.2147.2387.4187", %"class.llvm::SmallDenseMap.107.707.1067.2027.2147.2387.4187", %"class.llvm::SmallVector.82.116.716.1076.2036.2156.2396.4196" }
...
declare { ptr, i32 } @_ZN4llvm12SelectionDAG7getNodeEjNS_5SDLocENS_3EVTENS_7SDValueES3_(ptr, i32, ptr, i32, i32, ptr, ptr byval(%"class.llvm::SDValue.3.603.963.1923.2043.2283.4083") align 8, ptr byval(%"class.llvm::SDValue.3.603.963.1923.2043.2283.4083") align 8)

; Function Attrs: noreturn nounwind
declare void @__assert_fail(ptr, ptr, i32, ptr) #0
...
define hidden { ptr, i32 } @_ZN4llvm16DAGTypeLegalizer18WidenVecRes_BinaryEPNS_6SDNodeE(ptr %this, ptr %N) #2 align 2 {
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr %ref.tmp.i) #1
  %retval.sroa.0.0.idx.i36 = getelementptr inbounds %"struct.std::pair.112.119.719.1079.2039.2159.2399.4199", ptr %ref.tmp.i, i64 0, i32 1, i32 0, i32 0
  %retval.sroa.0.0.copyload.i37 = load i32, ptr %retval.sroa.0.0.idx.i36, align 8
  call void @llvm.lifetime.end.p0(i64 24, ptr %ref.tmp.i) #1
  %agg.tmp8.sroa.2.0.copyload = load i32, ptr undef, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr %Op.i) #1
  %0 = getelementptr %"class.llvm::SDValue.3.603.963.1923.2043.2283.4083", ptr %Op.i, i64 0, i32 1
  store i32 %agg.tmp8.sroa.2.0.copyload, ptr %0, align 8
...
; CHECK: callq	_ZN4llvm12SelectionDAG7getNodeEjNS_5SDLocENS_3EVTENS_7SDValueES3_
  ...
  %call18 = call { ptr, i32 } @_ZN4llvm12SelectionDAG7getNodeEjNS_5SDLocENS_3EVTENS_7SDValueES3_(ptr undef, i32 undef, ptr undef, i32 -1, i32 %retval.sroa.0.0.copyload.i37, ptr undef, ptr byval(%"class.llvm::SDValue.3.603.963.1923.2043.2283.4083") align 8 undef, ptr byval(%"class.llvm::SDValue.3.603.963.1923.2043.2283.4083") align 8 undef) #1
  ret { ptr, i32 } %call18
}

; Function Attrs: nounwind uwtable
declare hidden ptr @_ZN4llvm12DenseMapBaseINS_13SmallDenseMapINS_7SDValueES2_Lj8ENS_12DenseMapInfoIS2_EEEES2_S2_S4_EixERKS2_(ptr, ptr nocapture readonly) #2 align 2

declare hidden void @_ZN4llvm16DAGTypeLegalizer10RemapValueERNS_7SDValueE(ptr, ptr)

; Function Attrs: nounwind uwtable
declare hidden void @_ZNK4llvm18TargetLoweringBase17getTypeConversionERNS_11LLVMContextENS_3EVTE(ptr noalias sret(%"struct.std::pair.112.119.719.1079.2039.2159.2399.4199"), ptr readonly, ptr, i32, ptr) #2 align 2
