...
; KNL-NEXT:    vmovdqa {{.*#+}} ymm2 = [2,3,2,3,0,1,0,1,10,11,10,11,8,9,8,9,18,19,18,19,16,17,16,17,26,27,26,27,24,25,24,25]
; KNL-NEXT:    vpshufb %ymm2, %ymm1, %ymm1
; KNL-NEXT:    vpshufb %ymm2, %ymm0, %ymm0
; KNL-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; KNL-NEXT:    retq
;
