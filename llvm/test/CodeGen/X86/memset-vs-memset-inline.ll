...
; RUN: llc < %s -opaque-pointers=1 -mtriple=x86_64-unknown-linux-gnu -mcpu=core2 | FileCheck %s

declare void @llvm.memset.p0.i64(i8* nocapture, i8, i64, i1) nounwind
declare void @llvm.memset.inline.p0.i64(i8* nocapture, i8, i64, i1) nounwind
...
; CHECK-NEXT:    retq
  tail call void @llvm.memset.inline.p0.i64(i8* %a, i8 %value, i64 8, i1 0)
  ret void
}
...
; CHECK-NEXT:    jmp memset@PLT # TAILCALL
  tail call void @llvm.memset.p0.i64(i8* %a, i8 %value, i64 1024, i1 0)
  ret void
}
