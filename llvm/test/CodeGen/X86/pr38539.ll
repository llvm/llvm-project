...
; X86-NEXT:  # %bb.11: # %select.false.sink3
; X86-NEXT:    movl %eax, %ecx
; X86-NEXT:    xorl $65, %ecx
; X86-NEXT:    orl %ebx, %ecx
; X86-NEXT:    orl %edx, %ecx
; X86-NEXT:    sete %cl
; X86-NEXT:  .LBB0_12: # %select.end2
; X86-NEXT:    testb %cl, %cl
; X86-NEXT:    jne .LBB0_16
; X86-NEXT:  # %bb.13: # %udiv-bb1
...
; X86-NEXT:    .p2align 4
; X86-NEXT:  .LBB0_15: # %udiv-do-while
