...
; CHECK-X86-NEXT:    movl 72032(%esp), %edx
; CHECK-X86-NEXT:    addl 72036(%esp), %edx
; CHECK-X86-NEXT:    movl 72040(%esp), %esi
; CHECK-X86-NEXT:    addl 72044(%esp), %esi
; CHECK-X86-NEXT:    addl %edx, %esi
