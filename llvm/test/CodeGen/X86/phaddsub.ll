...
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+sse3            | FileCheck %s --check-prefixes=SSE2
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+sse3,fast-hops  | FileCheck %s --check-prefixes=SSE2
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movaps %xmm0, %xmm2
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,2],xmm1[1,2]
...
; SSE2-LABEL: phaddd5:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,3,2,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,2,2,3]
; SSE2-NEXT:    paddd %xmm1, %xmm0
; SSE2-NEXT:    retq
;
; SSSE3-LABEL: phaddd5:
...
; SSE2-LABEL: phaddd_single_source1:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,1,0,2]
...
; SSE2-LABEL: phaddd_single_source2:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddd_single_source3:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddd_single_source4:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddd_single_source5:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[2,2,2,2]
...
; SSE2-LABEL: phaddd_single_source6:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddw_single_source1:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddw_single_source2:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshuflw {{.*#+}} xmm1 = xmm0[3,1,2,3,4,5,6,7]
...
; SSE2-LABEL: phaddw_single_source3:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshuflw {{.*#+}} xmm1 = xmm0[0,2,2,3,4,5,6,7]
...
; SSE2-LABEL: phaddw_single_source4:
; SSE2:       # %bb.0:
...
; SSE2-LABEL: phaddw_single_source6:
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa %xmm0, %xmm1
; SSE2-NEXT:    pslld $16, %xmm1
; SSE2-NEXT:    paddw %xmm1, %xmm0
