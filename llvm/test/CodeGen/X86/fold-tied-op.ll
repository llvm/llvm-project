...
; CHECK-NEXT:    movl 16(%eax), %ebx
; CHECK-NEXT:    movl 20(%eax), %edi
; CHECK-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; CHECK-NEXT:    shldl $2, %ebx, %edi
