...
; SSE2-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,0,2,2]
...
; AVX512VL-NEXT:    vpmovusqd %zmm0, %ymm0
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm11 = xmm9[1,1,3,3]
; SSE2-NEXT:    pand %xmm10, %xmm11
...
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm0[0,2]
...
; AVX512BWVL-NEXT:    vpmovusqw %zmm0, %xmm0
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm6 = [9223372039002259455,9223372039002259455]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm7 = [9223372039002259711,9223372039002259711]
...
; AVX512BWVL-NEXT:    vpmovusdw %zmm0, %ymm0
...
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BWVL-NEXT:    vpmovusdb %zmm0, %xmm0
; AVX512BWVL-NEXT:    vmovdqu8 %xmm0, (%rdi) {%k1}
; AVX512BWVL-NEXT:    vzeroupper
; AVX512BWVL-NEXT:    retq
  %a = icmp ne <16 x i32> %mask, zeroinitializer
