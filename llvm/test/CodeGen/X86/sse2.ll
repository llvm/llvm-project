...
; X86-SSE:       # %bb.0: # %entry
; X86-SSE-NEXT:    shufpd {{.*#+}} xmm0 = xmm0[0],mem[1]
; X86-SSE-NEXT:    movapd %xmm0, (%eax)
; X86-SSE-NEXT:    retl
;
; X86-AVX1-LABEL: test17:
; X86-AVX1:       # %bb.0: # %entry
; X86-AVX1-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1],mem[2,3]
...
; X86-AVX512-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1,2,3]
...
; X64-AVX512-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1,2,3]
