...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf2:
; AVX1-ONLY:       # %bb.0:
...
; AVX1-ONLY-NEXT:    retq
;
; AVX2-ONLY-LABEL: store_i64_stride4_vf2:
; AVX2-ONLY:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf4:
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    vmovaps (%rdi), %ymm0
; AVX1-ONLY-NEXT:    vmovaps (%rsi), %ymm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%rdx), %ymm0, %ymm2
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%rcx), %ymm1, %ymm3
...
; AVX1-ONLY-NEXT:    retq
;
; AVX2-ONLY-LABEL: store_i64_stride4_vf4:
; AVX2-ONLY:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf8:
; AVX1-ONLY:       # %bb.0:
...
; AVX2-ONLY-NEXT:    retq
;
; AVX512F-LABEL: store_i64_stride4_vf8:
; AVX512F:       # %bb.0:
...
; SSE-NEXT:    movaps %xmm6, 416(%r8)
; SSE-NEXT:    movaps %xmm7, 400(%r8)
; SSE-NEXT:    movaps %xmm9, 384(%r8)
; SSE-NEXT:    movaps %xmm8, 368(%r8)
; SSE-NEXT:    movaps %xmm11, 352(%r8)
; SSE-NEXT:    movaps %xmm10, 336(%r8)
; SSE-NEXT:    movaps %xmm14, 320(%r8)
; SSE-NEXT:    movaps %xmm12, 304(%r8)
; SSE-NEXT:    movaps %xmm13, 288(%r8)
...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf16:
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    subq $152, %rsp
; AVX1-ONLY-NEXT:    vmovaps 96(%rdx), %ymm7
; AVX1-ONLY-NEXT:    vmovaps 64(%rdx), %ymm5
; AVX1-ONLY-NEXT:    vmovaps 32(%rdx), %ymm3
; AVX1-ONLY-NEXT:    vmovaps (%rdx), %ymm1
; AVX1-ONLY-NEXT:    vmovaps 96(%rcx), %ymm8
; AVX1-ONLY-NEXT:    vmovaps 64(%rcx), %ymm6
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %ymm4
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %ymm2
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm2[0],ymm1[2],ymm2[2]
; AVX1-ONLY-NEXT:    vmovaps 16(%rsi), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 16(%rdi), %xmm10
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm10[0],xmm9[0]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm10[1],xmm9[1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1,2,3],ymm1[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm3[0],ymm4[0],ymm3[2],ymm4[2]
...
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm5[0],ymm6[0],ymm5[2],ymm6[2]
; AVX1-ONLY-NEXT:    vmovaps 80(%rsi), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 80(%rdi), %xmm10
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm10[0],xmm9[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1,2,3],ymm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm5[1],ymm6[1],ymm5[3],ymm6[3]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm6 = xmm10[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vmovaps 112(%rdi), %xmm10
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm10[0],xmm9[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1,2,3],ymm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm8[1],ymm7[3],ymm8[3]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm8 = xmm10[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm0 = xmm11[0],xmm10[0]
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %xmm12
; AVX1-ONLY-NEXT:    vmovaps 64(%rcx), %xmm13
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm14[1],xmm13[1]
...
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm8 = xmm14[0],xmm12[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm12 = xmm14[1],xmm12[1]
; AVX1-ONLY-NEXT:    vmovaps 96(%rsi), %xmm14
; AVX1-ONLY-NEXT:    vmovaps 96(%rdi), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm0[0],xmm14[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm6 = xmm0[1],xmm14[1]
; AVX1-ONLY-NEXT:    vmovaps 96(%rcx), %xmm14
; AVX1-ONLY-NEXT:    vmovaps 96(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm0[0],xmm14[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm4 = xmm0[1],xmm14[1]
; AVX1-ONLY-NEXT:    vmovaps (%rsi), %xmm14
; AVX1-ONLY-NEXT:    vmovaps (%rdi), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm3 = xmm0[0],xmm14[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm0[1],xmm14[1]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 48(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm2, 32(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm1, 16(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm3, (%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm4, 432(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm6, 416(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm5, 400(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm7, 384(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm12, 176(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm13, 160(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm8, 144(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm15, 128(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm11, 304(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm10, 288(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm9, 272(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 256(%r8)
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, (%rdx), %ymm0, %ymm6
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm6[0],ymm1[0],ymm6[2],ymm1[2]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm6[1],ymm1[1],ymm6[3],ymm1[3]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vinsertf128 $1, 32(%rcx), %ymm2, %ymm6
; AVX2-ONLY-NEXT:    vinsertf128 $1, 32(%rdx), %ymm3, %ymm3
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm3[0],ymm6[0],ymm3[2],ymm6[2]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm3[1],ymm6[1],ymm3[3],ymm6[3]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vinsertf128 $1, 64(%rcx), %ymm4, %ymm6
; AVX2-ONLY-NEXT:    vinsertf128 $1, 64(%rdx), %ymm5, %ymm5
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 96(%rcx), %ymm6, %ymm8
; AVX2-ONLY-NEXT:    vmovaps 96(%rdi), %xmm6
; AVX2-ONLY-NEXT:    vinsertf128 $1, 96(%rdx), %ymm6, %ymm10
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm10[0],ymm8[0],ymm10[2],ymm8[2]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm10[1],ymm8[1],ymm10[3],ymm8[3]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm13[0],ymm14[0],ymm13[2],ymm14[2]
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm13[1],ymm14[1],ymm13[3],ymm14[3]
; AVX2-ONLY-NEXT:    vmovaps 32(%rcx), %ymm14
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm11[1],ymm12[1],ymm11[3],ymm12[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm11[2,3],ymm13[2,3]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm15[0],ymm14[0],ymm15[2],ymm14[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
...
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm7[2,3],ymm14[2,3]
; AVX2-ONLY-NEXT:    vmovaps 64(%rcx), %ymm14
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm9[0],ymm14[0],ymm9[2],ymm14[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm13[0],ymm15[0],ymm13[2],ymm15[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm1[2,3],ymm0[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm9[1],ymm14[1],ymm9[3],ymm14[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm13[1],ymm15[1],ymm13[3],ymm15[3]
; AVX2-ONLY-NEXT:    vmovaps 96(%rdi), %ymm13
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm9[2,3],ymm1[2,3]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm13[0],ymm9[0],ymm13[2],ymm9[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm0[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm13[1],ymm9[1],ymm13[3],ymm9[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm9[2,3],ymm3[2,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 480(%r8)
...
; AVX2-ONLY-NEXT:    vmovaps %ymm12, 192(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm11, 96(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm10, 64(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm8, 416(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm6, 384(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm5, 288(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 256(%r8)
...
; AVX2-ONLY-NEXT:    retq
;
; AVX512F-LABEL: store_i64_stride4_vf16:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vmovdqa64 (%rdi), %zmm0
...
; AVX512F-NEXT:    vpermi2q %zmm7, %zmm5, %zmm12
; AVX512F-NEXT:    vpermi2q %zmm3, %zmm1, %zmm16
...
; SSE-NEXT:    unpckhpd {{.*#+}} xmm6 = xmm6[1],xmm0[1]
; SSE-NEXT:    movaps 224(%rdx), %xmm5
; SSE-NEXT:    movaps 224(%rcx), %xmm1
; SSE-NEXT:    movaps %xmm5, %xmm7
; SSE-NEXT:    movlhps {{.*#+}} xmm7 = xmm7[0],xmm1[0]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm5 = xmm5[1],xmm1[1]
...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf32:
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    subq $664, %rsp # imm = 0x298
; AVX1-ONLY-NEXT:    vmovaps 160(%rdx), %ymm0
...
; AVX1-ONLY-NEXT:    vmovaps 128(%rcx), %ymm3
; AVX1-ONLY-NEXT:    vmovaps 96(%rcx), %ymm5
; AVX1-ONLY-NEXT:    vmovaps 64(%rcx), %ymm9
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %ymm10
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %ymm11
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm8[0],ymm11[0],ymm8[2],ymm11[2]
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm8[1],ymm11[1],ymm8[3],ymm11[3]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm14[1],xmm13[1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm11[0,1,2,3],ymm8[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm7[0],ymm10[0],ymm7[2],ymm10[2]
...
; AVX1-ONLY-NEXT:    vmovaps 80(%rsi), %xmm8
; AVX1-ONLY-NEXT:    vmovaps 80(%rdi), %xmm10
...
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm3[0],ymm2[2],ymm3[2]
; AVX1-ONLY-NEXT:    vmovaps 144(%rsi), %xmm5
; AVX1-ONLY-NEXT:    vmovaps 144(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm6[0],xmm5[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1,2,3],ymm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm3[1],ymm2[3],ymm3[3]
...
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 176(%rsi), %xmm3
...
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm2 = xmm1[0],xmm0[0]
; AVX1-ONLY-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm15 = xmm1[1],xmm0[1]
; AVX1-ONLY-NEXT:    vmovaps 160(%rcx), %xmm0
; AVX1-ONLY-NEXT:    vmovaps 160(%rdx), %xmm1
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm14 = xmm1[0],xmm0[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm13 = xmm1[1],xmm0[1]
; AVX1-ONLY-NEXT:    vmovaps 224(%rsi), %xmm1
; AVX1-ONLY-NEXT:    vmovaps 224(%rdi), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm12 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm11 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps 224(%rcx), %xmm1
; AVX1-ONLY-NEXT:    vmovaps 224(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm10 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm9 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps 192(%rsi), %xmm1
; AVX1-ONLY-NEXT:    vmovaps 192(%rdi), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm8 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm7 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps 192(%rcx), %xmm1
; AVX1-ONLY-NEXT:    vmovaps 192(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm6 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm5 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps (%rsi), %xmm1
; AVX1-ONLY-NEXT:    vmovaps (%rdi), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm4 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %xmm1
; AVX1-ONLY-NEXT:    vmovaps (%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm2 = xmm0[0],xmm1[0]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm1[1]
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 48(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm3, 32(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm2, 16(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm4, (%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm5, 816(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm7, 800(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm6, 784(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm8, 768(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm9, 944(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm11, 928(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm10, 912(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm12, 896(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm13, 688(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm15, 672(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm14, 656(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 640(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 432(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 416(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 400(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 384(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 176(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 160(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 144(%r8)
; AVX1-ONLY-NEXT:    vmovaps (%rsp), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 128(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 304(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 288(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 272(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 256(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 560(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 544(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 528(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 512(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 992(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 960(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 864(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 832(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 736(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 64(%r8)
; AVX1-ONLY-NEXT:    addq $664, %rsp # imm = 0x298
; AVX1-ONLY-NEXT:    vzeroupper
; AVX1-ONLY-NEXT:    retq
;
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm3[0],ymm2[2],ymm3[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm5[2,3],ymm4[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm3[1],ymm2[3],ymm3[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm0[2,3],ymm2[2,3]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm11[2,3],ymm4[2,3]
...
; AVX2-ONLY-NEXT:    vmovaps 128(%rdx), %ymm11
; AVX2-ONLY-NEXT:    vmovaps 128(%rcx), %ymm0
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm11[0],ymm0[0],ymm11[2],ymm0[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm13[2,3],ymm2[2,3]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm15[2,3],ymm0[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm11[1],ymm13[1],ymm11[3],ymm13[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm1[2,3],ymm11[2,3]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm3[0],ymm11[0],ymm3[2],ymm11[2]
...
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 864(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm1, 832(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm2, 736(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 704(%r8)
...
; AVX2-ONLY-NEXT:    retq
;
; AVX512F-LABEL: store_i64_stride4_vf32:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512F-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512F-NEXT:    vpermt2q %zmm19, %zmm13, %zmm7
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm8 = <2,10,u,u,3,11,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm8, %zmm4
; AVX512F-NEXT:    movb $-52, %al
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vmovdqa64 %zmm7, %zmm4 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm22 = <u,u,0,8,u,u,1,9>
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm11
; AVX512F-NEXT:    vpermt2q %zmm19, %zmm22, %zmm11
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm14 = <0,8,u,u,1,9,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm7
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm14, %zmm7
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm7 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <u,u,6,14,u,u,7,15>
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm24
; AVX512F-NEXT:    vpermt2q %zmm19, %zmm23, %zmm24
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm25 = <6,14,u,u,7,15,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm11
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm25, %zmm11
; AVX512F-NEXT:    vmovdqa64 %zmm24, %zmm11 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm24 = <u,u,4,12,u,u,5,13>
; AVX512F-NEXT:    vpermt2q %zmm19, %zmm24, %zmm17
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm19 = <4,12,u,u,5,13,u,u>
; AVX512F-NEXT:    vpermt2q %zmm15, %zmm19, %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm20, %zmm13, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm1, %zmm17
; AVX512F-NEXT:    vpermt2q %zmm16, %zmm8, %zmm17
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm17 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm20, %zmm22, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm1, %zmm26
; AVX512F-NEXT:    vpermt2q %zmm16, %zmm14, %zmm26
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm26 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm20, %zmm23, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm1, %zmm27
; AVX512F-NEXT:    vpermt2q %zmm16, %zmm25, %zmm27
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm27 {%k1}
; AVX512F-NEXT:    vpermt2q %zmm20, %zmm24, %zmm18
; AVX512F-NEXT:    vpermt2q %zmm16, %zmm19, %zmm1
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm1 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm21, %zmm13, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm16
; AVX512F-NEXT:    vpermt2q %zmm10, %zmm8, %zmm16
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm16 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm21, %zmm22, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm18
; AVX512F-NEXT:    vpermt2q %zmm10, %zmm14, %zmm18
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm18 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm21, %zmm23, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm20
; AVX512F-NEXT:    vpermt2q %zmm10, %zmm25, %zmm20
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm20 {%k1}
; AVX512F-NEXT:    vpermt2q %zmm21, %zmm24, %zmm12
...
; AVX512F-NEXT:    vpermi2q %zmm9, %zmm6, %zmm22
; AVX512F-NEXT:    vpermi2q %zmm5, %zmm3, %zmm14
; AVX512F-NEXT:    vmovdqa64 %zmm22, %zmm14 {%k1}
; AVX512F-NEXT:    vpermi2q %zmm9, %zmm6, %zmm23
; AVX512F-NEXT:    vpermi2q %zmm5, %zmm3, %zmm25
; AVX512F-NEXT:    vmovdqa64 %zmm23, %zmm25 {%k1}
; AVX512F-NEXT:    vpermt2q %zmm9, %zmm24, %zmm6
; AVX512F-NEXT:    vpermt2q %zmm5, %zmm19, %zmm3
...
; AVX512BW-NEXT:    vpermt2q %zmm19, %zmm13, %zmm7
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm8 = <2,10,u,u,3,11,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm8, %zmm4
; AVX512BW-NEXT:    movb $-52, %al
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqa64 %zmm7, %zmm4 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm22 = <u,u,0,8,u,u,1,9>
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm11
; AVX512BW-NEXT:    vpermt2q %zmm19, %zmm22, %zmm11
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm14 = <0,8,u,u,1,9,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm7
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm14, %zmm7
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm7 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <u,u,6,14,u,u,7,15>
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm24
; AVX512BW-NEXT:    vpermt2q %zmm19, %zmm23, %zmm24
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm25 = <6,14,u,u,7,15,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm11
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm25, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm24, %zmm11 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm24 = <u,u,4,12,u,u,5,13>
; AVX512BW-NEXT:    vpermt2q %zmm19, %zmm24, %zmm17
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm19 = <4,12,u,u,5,13,u,u>
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm19, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm20, %zmm13, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm17
; AVX512BW-NEXT:    vpermt2q %zmm16, %zmm8, %zmm17
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm17 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm20, %zmm22, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm26
; AVX512BW-NEXT:    vpermt2q %zmm16, %zmm14, %zmm26
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm26 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm20, %zmm23, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm27
; AVX512BW-NEXT:    vpermt2q %zmm16, %zmm25, %zmm27
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm27 {%k1}
; AVX512BW-NEXT:    vpermt2q %zmm20, %zmm24, %zmm18
; AVX512BW-NEXT:    vpermt2q %zmm16, %zmm19, %zmm1
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm1 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm21, %zmm13, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm16
; AVX512BW-NEXT:    vpermt2q %zmm10, %zmm8, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm16 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm21, %zmm22, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm18
; AVX512BW-NEXT:    vpermt2q %zmm10, %zmm14, %zmm18
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm18 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm21, %zmm23, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm20
; AVX512BW-NEXT:    vpermt2q %zmm10, %zmm25, %zmm20
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm20 {%k1}
; AVX512BW-NEXT:    vpermt2q %zmm21, %zmm24, %zmm12
...
; AVX512BW-NEXT:    vpermi2q %zmm9, %zmm6, %zmm22
; AVX512BW-NEXT:    vpermi2q %zmm5, %zmm3, %zmm14
; AVX512BW-NEXT:    vmovdqa64 %zmm22, %zmm14 {%k1}
; AVX512BW-NEXT:    vpermi2q %zmm9, %zmm6, %zmm23
; AVX512BW-NEXT:    vpermi2q %zmm5, %zmm3, %zmm25
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm25 {%k1}
; AVX512BW-NEXT:    vpermt2q %zmm9, %zmm24, %zmm6
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm19, %zmm3
...
; SSE-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    unpckhpd {{.*#+}} xmm11 = xmm11[1],xmm0[1]
; SSE-NEXT:    movaps 448(%rdx), %xmm14
; SSE-NEXT:    movaps 448(%rcx), %xmm0
; SSE-NEXT:    movaps %xmm14, %xmm1
; SSE-NEXT:    movlhps {{.*#+}} xmm1 = xmm1[0],xmm0[0]
; SSE-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    unpckhpd {{.*#+}} xmm14 = xmm14[1],xmm0[1]
; SSE-NEXT:    movaps 464(%rdi), %xmm12
...
; SSE-NEXT:    movlhps {{.*#+}} xmm10 = xmm10[0],xmm0[0]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm8 = xmm8[1],xmm0[1]
; SSE-NEXT:    movaps 480(%rdi), %xmm6
; SSE-NEXT:    movaps 480(%rsi), %xmm0
; SSE-NEXT:    movaps %xmm6, %xmm9
; SSE-NEXT:    movlhps {{.*#+}} xmm9 = xmm9[0],xmm0[0]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm6 = xmm6[1],xmm0[1]
; SSE-NEXT:    movaps 480(%rdx), %xmm5
; SSE-NEXT:    movaps 480(%rcx), %xmm1
; SSE-NEXT:    movaps %xmm5, %xmm7
; SSE-NEXT:    movlhps {{.*#+}} xmm7 = xmm7[0],xmm1[0]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm5 = xmm5[1],xmm1[1]
...
; SSE-NEXT:    movaps 496(%rcx), %xmm4
; SSE-NEXT:    movaps %xmm3, %xmm0
; SSE-NEXT:    movlhps {{.*#+}} xmm0 = xmm0[0],xmm4[0]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm3 = xmm3[1],xmm4[1]
; SSE-NEXT:    movaps %xmm3, 2032(%r8)
; SSE-NEXT:    movaps %xmm1, 2016(%r8)
; SSE-NEXT:    movaps %xmm0, 2000(%r8)
; SSE-NEXT:    movaps %xmm2, 1984(%r8)
; SSE-NEXT:    movaps %xmm5, 1968(%r8)
; SSE-NEXT:    movaps %xmm6, 1952(%r8)
; SSE-NEXT:    movaps %xmm7, 1936(%r8)
; SSE-NEXT:    movaps %xmm9, 1920(%r8)
; SSE-NEXT:    movaps %xmm8, 1904(%r8)
; SSE-NEXT:    movaps %xmm12, 1888(%r8)
; SSE-NEXT:    movaps %xmm10, 1872(%r8)
; SSE-NEXT:    movaps %xmm13, 1856(%r8)
; SSE-NEXT:    movaps %xmm14, 1840(%r8)
; SSE-NEXT:    movaps %xmm11, 1824(%r8)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    retq
;
; AVX1-ONLY-LABEL: store_i64_stride4_vf64:
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    subq $1688, %rsp # imm = 0x698
; AVX1-ONLY-NEXT:    vmovaps 160(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 128(%rdx), %ymm2
; AVX1-ONLY-NEXT:    vmovaps 96(%rdx), %ymm4
; AVX1-ONLY-NEXT:    vmovaps 64(%rdx), %ymm6
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 256(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 256(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 272(%rsi), %xmm3
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 288(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 288(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 304(%rsi), %xmm3
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 320(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 320(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 336(%rsi), %xmm3
; AVX1-ONLY-NEXT:    vmovaps 336(%rdi), %xmm4
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm4[0],xmm3[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1,2,3],ymm2[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 352(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 352(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 368(%rsi), %xmm3
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 384(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 384(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 400(%rsi), %xmm3
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 416(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 416(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 432(%rsi), %xmm3
; AVX1-ONLY-NEXT:    vmovaps 432(%rdi), %xmm4
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm4[0],xmm3[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1,2,3],ymm2[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 448(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 448(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 464(%rsi), %xmm3
; AVX1-ONLY-NEXT:    vmovaps 464(%rdi), %xmm4
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm4[0],xmm3[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1,2,3],ymm2[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 480(%rdx), %ymm0
; AVX1-ONLY-NEXT:    vmovaps 480(%rcx), %ymm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm0[0],ymm1[0],ymm0[2],ymm1[2]
; AVX1-ONLY-NEXT:    vmovaps 496(%rsi), %xmm3
; AVX1-ONLY-NEXT:    vmovaps 496(%rdi), %xmm4
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm4[0],xmm3[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1,2,3],ymm2[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm2, 16(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm4, (%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm5, 1584(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm7, 1568(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm6, 1552(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm8, 1536(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm9, 1840(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm11, 1824(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm10, 1808(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm12, 1792(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm13, 1968(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm15, 1952(%r8)
; AVX1-ONLY-NEXT:    vmovaps %xmm14, 1936(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1920(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1712(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1696(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1680(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1664(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1328(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1312(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1296(%r8)
; AVX1-ONLY-NEXT:    vmovaps (%rsp), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1280(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1456(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1440(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1424(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1408(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1200(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1184(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1168(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1152(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 816(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 800(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 784(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 768(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 944(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 928(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 912(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 896(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 688(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 672(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 656(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 640(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 432(%r8)
...
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 512(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1072(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1056(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1040(%r8)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 1024(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 2016(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1984(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1888(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1856(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1760(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1728(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1632(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1600(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1504(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1472(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1376(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1344(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1248(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1216(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1120(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 1088(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 992(%r8)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 960(%r8)
...
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 64(%r8)
; AVX1-ONLY-NEXT:    addq $1688, %rsp # imm = 0x698
; AVX1-ONLY-NEXT:    vzeroupper
; AVX1-ONLY-NEXT:    retq
;
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm1[1],ymm0[3],ymm1[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm0[2,3],ymm2[2,3]
; AVX2-ONLY-NEXT:    vmovaps 352(%rdi), %ymm3
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm13[2,3],ymm0[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm1[2,3],ymm13[2,3]
...
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm12[2,3],ymm0[2,3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
...
; AVX2-ONLY-NEXT:    vmovaps %ymm11, 2016(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm0, 1984(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 1888(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm1, 1856(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm2, 1760(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 1728(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm5, 1632(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm6, 1600(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm7, 1504(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm8, 1472(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm9, 1376(%r8)
; AVX2-ONLY-NEXT:    vmovaps %ymm10, 1344(%r8)
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-ONLY-NEXT:    retq
;
; AVX512F-LABEL: store_i64_stride4_vf64:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    subq $2120, %rsp # imm = 0x848
; AVX512F-NEXT:    vmovdqa64 384(%rdx), %zmm8
; AVX512F-NEXT:    vmovdqa64 320(%rdx), %zmm9
; AVX512F-NEXT:    vmovdqa64 256(%rdx), %zmm10
; AVX512F-NEXT:    vmovdqa64 (%rdx), %zmm14
; AVX512F-NEXT:    vmovdqa64 64(%rdx), %zmm13
; AVX512F-NEXT:    vmovdqa64 128(%rdx), %zmm12
; AVX512F-NEXT:    vmovdqa64 192(%rdx), %zmm11
; AVX512F-NEXT:    vmovdqa64 384(%rcx), %zmm0
; AVX512F-NEXT:    vmovdqa64 320(%rcx), %zmm1
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm18 = <u,u,0,8,u,u,1,9>
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm18, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm16 = <u,u,2,10,u,u,3,11>
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm16, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm15 = <u,u,4,12,u,u,5,13>
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm15, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm7 = <u,u,6,14,u,u,7,15>
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm7, %zmm14
; AVX512F-NEXT:    vmovdqu64 %zmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm13, %zmm3
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm18, %zmm13
; AVX512F-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm16, %zmm13
; AVX512F-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm15, %zmm13
; AVX512F-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2q %zmm4, %zmm7, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm4
; AVX512F-NEXT:    vpermt2q %zmm5, %zmm18, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm4
; AVX512F-NEXT:    vpermt2q %zmm5, %zmm16, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm3
; AVX512F-NEXT:    vpermt2q %zmm5, %zmm15, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm18, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm4
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm16, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm3
; AVX512F-NEXT:    vpermt2q %zmm6, %zmm15, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm4
; AVX512F-NEXT:    vpermt2q %zmm2, %zmm16, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512F-NEXT:    vpermt2q %zmm2, %zmm15, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2q %zmm2, %zmm7, %zmm10
...
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm9, %zmm3
; AVX512F-NEXT:    vpermt2q %zmm1, %zmm16, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm9, %zmm2
; AVX512F-NEXT:    vpermt2q %zmm1, %zmm15, %zmm2
...
; AVX512F-NEXT:    vmovdqa64 448(%rdx), %zmm26
; AVX512F-NEXT:    vmovdqa64 448(%rcx), %zmm0
; AVX512F-NEXT:    vpermi2q %zmm0, %zmm26, %zmm18
; AVX512F-NEXT:    vpermi2q %zmm0, %zmm26, %zmm16
; AVX512F-NEXT:    vpermi2q %zmm0, %zmm26, %zmm15
; AVX512F-NEXT:    vpermt2q %zmm0, %zmm7, %zmm26
; AVX512F-NEXT:    vmovdqa64 (%rdi), %zmm28
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm4 = <2,10,u,u,3,11,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm0
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm2 = <4,12,u,u,5,13,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm0
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm29
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <6,14,u,u,7,15,u,u>
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm23, %zmm28
...
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2q %zmm3, %zmm23, %zmm27
...
; AVX512F-NEXT:    vmovdqu64 %zmm31, (%rsp) # 64-byte Spill
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm2 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm26, %zmm1 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm1, 1984(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm2, 1920(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm9, 1728(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm8, 1600(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm10, 1536(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm11, 1408(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm12, 1344(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm13, 1280(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm7, 1216(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm14, 1152(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm17, 1088(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm19, 1024(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm21, 960(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm20, 896(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm22, 832(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm24, 768(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm25, 704(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm29, 640(%r8)
; AVX512F-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovaps %zmm0, 576(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm30, 512(%r8)
; AVX512F-NEXT:    vmovdqa64 %zmm27, 448(%r8)
; AVX512F-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 %zmm23, 128(%r8)
; AVX512F-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovaps %zmm0, 64(%r8)
; AVX512F-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovaps %zmm0, (%r8)
; AVX512F-NEXT:    addq $2120, %rsp # imm = 0x848
; AVX512F-NEXT:    vzeroupper
; AVX512F-NEXT:    retq
;
...
; AVX512BW-NEXT:    vmovdqa64 256(%rdx), %zmm10
...
; AVX512BW-NEXT:    vmovdqa64 320(%rcx), %zmm1
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm18 = <u,u,0,8,u,u,1,9>
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm18, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm16 = <u,u,2,10,u,u,3,11>
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm16, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm15 = <u,u,4,12,u,u,5,13>
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm15, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm7 = <u,u,6,14,u,u,7,15>
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm7, %zmm14
; AVX512BW-NEXT:    vmovdqu64 %zmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm13, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm18, %zmm13
; AVX512BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm16, %zmm13
; AVX512BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm15, %zmm13
; AVX512BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm18, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm16, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm15, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm18, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm16, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm15, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm7, %zmm11
...
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm2, %zmm16, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm2, %zmm15, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm2, %zmm7, %zmm10
...
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm9, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm1, %zmm16, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vmovdqa64 448(%rdx), %zmm26
; AVX512BW-NEXT:    vmovdqa64 448(%rcx), %zmm0
; AVX512BW-NEXT:    vpermi2q %zmm0, %zmm26, %zmm18
; AVX512BW-NEXT:    vpermi2q %zmm0, %zmm26, %zmm16
; AVX512BW-NEXT:    vpermi2q %zmm0, %zmm26, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm7, %zmm26
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %zmm28
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm4 = <2,10,u,u,3,11,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm28, %zmm0
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <6,14,u,u,7,15,u,u>
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm23, %zmm28
...
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm23, %zmm27
...
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm23, %zmm25
; AVX512BW-NEXT:    vmovdqa64 192(%rdi), %zmm21
; AVX512BW-NEXT:    vmovdqa64 192(%rsi), %zmm3
; AVX512BW-NEXT:    vmovdqa64 %zmm21, %zmm24
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm5, %zmm24
; AVX512BW-NEXT:    vmovdqa64 %zmm21, %zmm22
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm4, %zmm22
...
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm23, %zmm9
...
; AVX512BW-NEXT:    vmovdqu64 %zmm31, (%rsp) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm2 {%k1}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm7, 1216(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm14, 1152(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm17, 1088(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm19, 1024(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm21, 960(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm20, 896(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm22, 832(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm24, 768(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm25, 704(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm29, 640(%r8)
; AVX512BW-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovaps %zmm0, 576(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm30, 512(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm27, 448(%r8)
; AVX512BW-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 %zmm23, 128(%r8)
; AVX512BW-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
