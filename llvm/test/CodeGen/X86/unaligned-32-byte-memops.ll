...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=avx,+slow-unaligned-mem-32 | FileCheck %s --check-prefixes=CHECK,AVX1,AVXSLOW
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=avx,-slow-unaligned-mem-32 | FileCheck %s --check-prefixes=CHECK,AVX1,AVXFAST
...
; CHECK-LABEL: combine_16_byte_loads_aligned:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmovaps 48(%rdi), %ymm0
; CHECK-NEXT:    retq
  %ptr1 = getelementptr inbounds <4 x float>, ptr %ptr, i64 3
  %ptr2 = getelementptr inbounds <4 x float>, ptr %ptr, i64 4
...
; AVX1-LABEL: combine_16_byte_loads_i64:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; AVX1-NEXT:    vpaddq 96(%rdi), %xmm1, %xmm1
; AVX1-NEXT:    vpaddq 80(%rdi), %xmm0, %xmm0
...
; AVX1-LABEL: combine_16_byte_loads_i32:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; AVX1-NEXT:    vpaddd 112(%rdi), %xmm1, %xmm1
; AVX1-NEXT:    vpaddd 96(%rdi), %xmm0, %xmm0
; AVX1-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX1-NEXT:    retq
;
...
; AVX1-LABEL: combine_16_byte_loads_i16:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; AVX1-NEXT:    vpaddw 128(%rdi), %xmm1, %xmm1
; AVX1-NEXT:    vpaddw 112(%rdi), %xmm0, %xmm0
; AVX1-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX1-NEXT:    retq
;
...
; AVX1-LABEL: combine_16_byte_loads_i8:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; AVX1-NEXT:    vpaddb 144(%rdi), %xmm1, %xmm1
; AVX1-NEXT:    vpaddb 128(%rdi), %xmm0, %xmm0
; AVX1-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX1-NEXT:    retq
;
