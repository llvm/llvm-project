...
; AVX1-NEXT:    vpcmpgtq %xmm4, %xmm5, %xmm3
; AVX1-NEXT:    vblendvpd %xmm3, %xmm5, %xmm4, %xmm3
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa %xmm0, %xmm6
; SSE4-NEXT:    movdqa {{.*#+}} xmm8 = [32767,32767]
...
; SSE4-NEXT:    movdqa {{.*#+}} xmm3 = [2147483647,2147483647]
; SSE4-NEXT:    movdqa %xmm3, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm2, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm2, %xmm3
; SSE4-NEXT:    pxor %xmm2, %xmm2
; SSE4-NEXT:    movdqa {{.*#+}} xmm4 = [18446744071562067968,18446744071562067968]
; SSE4-NEXT:    movapd %xmm3, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm3 = [32767,32767]
; AVX2-NEXT:    vpcmpgtq %xmm0, %xmm3, %xmm4
; AVX2-NEXT:    vblendvpd %xmm4, %xmm0, %xmm3, %xmm0
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm3 = [18446744073709518848,18446744073709518848]
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm3 = [127,127]
; AVX2-NEXT:    vpcmpgtq %xmm0, %xmm3, %xmm4
; AVX2-NEXT:    vblendvpd %xmm4, %xmm0, %xmm3, %xmm0
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm3 = [18446744073709551488,18446744073709551488]
; AVX2-NEXT:    vpcmpgtq %xmm3, %xmm0, %xmm4
; AVX2-NEXT:    vblendvpd %xmm4, %xmm0, %xmm3, %xmm0
