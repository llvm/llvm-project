...
; SSE2-NEXT:    movdqa {{.*#+}} xmm6 = [18446744071562067968,18446744071562067968]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm14 = xmm12[0,0,2,2]
...
; SSE2-NEXT:    pxor %xmm8, %xmm12
; SSE2-NEXT:    pshufd {{.*#+}} xmm14 = xmm12[1,1,3,3]
; SSE2-NEXT:    pcmpeqd %xmm11, %xmm14
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [4294967295,4294967295]
; SSE2-NEXT:    movdqa %xmm1, %xmm15
; SSE2-NEXT:    pcmpgtd %xmm12, %xmm15
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm15[0,0,2,2]
; SSE2-NEXT:    pand %xmm14, %xmm6
; SSE2-NEXT:    pshufd {{.*#+}} xmm12 = xmm15[1,1,3,3]
...
; SSE2-NEXT:    pcmpeqd %xmm14, %xmm13
; SSE2-NEXT:    pcmpgtd %xmm10, %xmm6
; SSE2-NEXT:    pshufd {{.*#+}} xmm14 = xmm6[0,0,2,2]
; SSE2-NEXT:    pand %xmm13, %xmm14
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSE2-NEXT:    por %xmm14, %xmm6
...
; SSE2-NEXT:    pcmpgtd %xmm10, %xmm6
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm6[0,0,2,2]
; SSE2-NEXT:    pand %xmm12, %xmm13
; SSE2-NEXT:    pshufd {{.*#+}} xmm12 = xmm6[1,1,3,3]
; SSE2-NEXT:    por %xmm13, %xmm12
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm14[0,0,2,2]
...
; SSE2-NEXT:    pandn %xmm15, %xmm13
; SSE2-NEXT:    pand %xmm2, %xmm3
; SSE2-NEXT:    pandn %xmm15, %xmm2
...
; SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm12[0,2]
...
; SSE4-NEXT:    pmovsxdq {{.*#+}} xmm7 = [2147483647,2147483647]
; SSE4-NEXT:    pmovsxdq {{.*#+}} xmm9 = [18446744071562067968,18446744071562067968]
...
; SSE4-NEXT:    movdqa %xmm7, %xmm11
; SSE4-NEXT:    blendvpd %xmm0, %xmm10, %xmm11
; SSE4-NEXT:    movdqa %xmm6, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm9, %xmm0
; SSE4-NEXT:    movdqa %xmm9, %xmm10
; SSE4-NEXT:    blendvpd %xmm0, %xmm6, %xmm10
; SSE4-NEXT:    movdqa %xmm7, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm10, %xmm0
...
; SSE4-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm3[0,2]
...
; AVX1-NEXT:    vblendvpd %xmm6, %xmm3, %xmm5, %xmm3
...
; AVX1-NEXT:    vpcmpgtq %xmm1, %xmm5, %xmm4
...
; AVX2-NEXT:    vpcmpgtq %ymm1, %ymm3, %ymm5
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm7 = [32767,32767]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm11 = [18446744071562035200,18446744071562035200]
...
; SSE2-NEXT:    pxor %xmm8, %xmm12
; SSE2-NEXT:    pshufd {{.*#+}} xmm14 = xmm12[1,1,3,3]
; SSE2-NEXT:    pcmpeqd %xmm6, %xmm14
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [2147516415,2147516415]
; SSE2-NEXT:    movdqa %xmm1, %xmm15
; SSE2-NEXT:    pcmpgtd %xmm12, %xmm15
; SSE2-NEXT:    pshufd {{.*#+}} xmm12 = xmm15[0,0,2,2]
; SSE2-NEXT:    pand %xmm14, %xmm12
; SSE2-NEXT:    pshufd {{.*#+}} xmm14 = xmm15[1,1,3,3]
; SSE2-NEXT:    por %xmm12, %xmm14
; SSE2-NEXT:    pand %xmm14, %xmm13
; SSE2-NEXT:    pandn %xmm7, %xmm14
...
; SSE2-NEXT:    pcmpeqd %xmm10, %xmm13
; SSE2-NEXT:    pcmpgtd %xmm11, %xmm12
; SSE2-NEXT:    pshufd {{.*#+}} xmm15 = xmm12[0,0,2,2]
; SSE2-NEXT:    pand %xmm13, %xmm15
...
; SSE2-NEXT:    pxor %xmm8, %xmm0
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm0[1,1,3,3]
; SSE2-NEXT:    pcmpeqd %xmm6, %xmm13
; SSE2-NEXT:    movdqa %xmm1, %xmm15
; SSE2-NEXT:    pcmpgtd %xmm0, %xmm15
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm15[0,0,2,2]
; SSE2-NEXT:    pand %xmm13, %xmm0
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm15[1,1,3,3]
; SSE2-NEXT:    por %xmm0, %xmm13
; SSE2-NEXT:    pand %xmm13, %xmm12
; SSE2-NEXT:    pandn %xmm7, %xmm13
; SSE2-NEXT:    por %xmm12, %xmm13
; SSE2-NEXT:    packssdw %xmm14, %xmm13
...
; SSE4-NEXT:    pmovsxwq {{.*#+}} xmm9 = [18446744073709518848,18446744073709518848]
; SSE4-NEXT:    movdqa %xmm1, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm9, %xmm0
; SSE4-NEXT:    movdqa %xmm9, %xmm10
; SSE4-NEXT:    blendvpd %xmm0, %xmm1, %xmm10
...
; SSE4-NEXT:    movdqa %xmm8, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm9, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm9, %xmm8
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} ymm5 = [18446744073709518848,18446744073709518848,18446744073709518848,18446744073709518848]
...
; SSE2-NEXT:    packssdw %xmm3, %xmm1
; SSE2-NEXT:    packssdw %xmm1, %xmm13
; SSE2-NEXT:    packsswb %xmm13, %xmm13
; SSE2-NEXT:    pcmpeqd %xmm6, %xmm5
; SSE2-NEXT:    pcmpeqd %xmm6, %xmm4
; SSE2-NEXT:    packssdw %xmm5, %xmm4
; SSE2-NEXT:    packsswb %xmm4, %xmm4
...
; SSE4-NEXT:    pmovsxbq {{.*#+}} xmm9 = [18446744073709551488,18446744073709551488]
; SSE4-NEXT:    movdqa %xmm1, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm9, %xmm0
; SSE4-NEXT:    movdqa %xmm9, %xmm10
; SSE4-NEXT:    blendvpd %xmm0, %xmm1, %xmm10
...
; SSE4-NEXT:    pmovsxdq {{.*#+}} xmm6 = [18446744071562067968,18446744071562067968]
; SSE4-NEXT:    movdqa %xmm1, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm6, %xmm0
...
; SSE4-NEXT:    movdqa %xmm4, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm6, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm6, %xmm4
; SSE4-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm1[0,2]
...
; SSE4-NEXT:    extractps $2, %xmm4, 8(%rdi)
; SSE4-NEXT:    testb $8, %al
; SSE4-NEXT:    je .LBB3_8
...
; AVX1-NEXT:    vpcmpgtq %xmm0, %xmm4, %xmm3
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm6 = [18446744073709518848,18446744073709518848]
; SSE2-NEXT:    movdqa {{.*#+}} xmm5 = [2147483648,2147483648]
; SSE2-NEXT:    movdqa %xmm1, %xmm7
; SSE2-NEXT:    pxor %xmm5, %xmm7
; SSE2-NEXT:    pshufd {{.*#+}} xmm10 = xmm7[1,1,3,3]
...
; SSE4-NEXT:    pcmpgtq %xmm6, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm6, %xmm4
; SSE4-NEXT:    packssdw %xmm1, %xmm4
; SSE4-NEXT:    packssdw %xmm4, %xmm4
; SSE4-NEXT:    pcmpeqd %xmm2, %xmm5
; SSE4-NEXT:    movmskps %xmm5, %eax
; SSE4-NEXT:    xorl $15, %eax
; SSE4-NEXT:    testb $1, %al
...
; SSE4-NEXT:    pextrw $0, %xmm4, (%rdi)
; SSE4-NEXT:    testb $2, %al
; SSE4-NEXT:    je .LBB4_4
; SSE4-NEXT:  .LBB4_3: # %cond.store1
; SSE4-NEXT:    pextrw $1, %xmm4, 2(%rdi)
; SSE4-NEXT:    testb $4, %al
; SSE4-NEXT:    je .LBB4_6
; SSE4-NEXT:  .LBB4_5: # %cond.store3
; SSE4-NEXT:    pextrw $2, %xmm4, 4(%rdi)
; SSE4-NEXT:    testb $8, %al
; SSE4-NEXT:    je .LBB4_8
; SSE4-NEXT:  .LBB4_7: # %cond.store5
; SSE4-NEXT:    pextrw $3, %xmm4, 6(%rdi)
; SSE4-NEXT:    retq
;
...
; AVX1-NEXT:    vpcmpgtq %xmm4, %xmm0, %xmm6
; AVX1-NEXT:    vblendvpd %xmm6, %xmm0, %xmm4, %xmm0
; AVX1-NEXT:    vpcmpgtq %xmm0, %xmm5, %xmm4
...
; SSE4-NEXT:    pextrb $0, %xmm4, (%rdi)
; SSE4-NEXT:    testb $2, %al
; SSE4-NEXT:    je .LBB5_4
; SSE4-NEXT:  .LBB5_3: # %cond.store1
; SSE4-NEXT:    pextrb $1, %xmm4, 1(%rdi)
; SSE4-NEXT:    testb $4, %al
; SSE4-NEXT:    je .LBB5_6
; SSE4-NEXT:  .LBB5_5: # %cond.store3
; SSE4-NEXT:    pextrb $2, %xmm4, 2(%rdi)
; SSE4-NEXT:    testb $8, %al
; SSE4-NEXT:    je .LBB5_8
; SSE4-NEXT:  .LBB5_7: # %cond.store5
; SSE4-NEXT:    pextrb $3, %xmm4, 3(%rdi)
; SSE4-NEXT:    retq
;
...
; SSE4-NEXT:    pmovsxdq {{.*#+}} xmm4 = [2147483647,2147483647]
; SSE4-NEXT:    pmovsxdq {{.*#+}} xmm5 = [18446744071562067968,18446744071562067968]
...
; AVX2-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [18446744071562067968,18446744071562067968]
...
; SSE4-NEXT:    pxor %xmm3, %xmm3
; SSE4-NEXT:    pmovsxwq {{.*#+}} xmm4 = [32767,32767]
; SSE4-NEXT:    pmovsxwq {{.*#+}} xmm5 = [18446744073709518848,18446744073709518848]
; SSE4-NEXT:    pcmpgtq %xmm5, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm2, %xmm5
; SSE4-NEXT:    movdqa %xmm4, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm5, %xmm0
...
; AVX-NEXT:    vpmovsxwq {{.*#+}} xmm4 = [18446744073709518848,18446744073709518848]
; AVX-NEXT:    vpcmpgtq %xmm4, %xmm0, %xmm5
; AVX-NEXT:    vblendvpd %xmm5, %xmm0, %xmm4, %xmm0
...
; SSE4-NEXT:    pmovsxbq {{.*#+}} xmm3 = [127,127]
; SSE4-NEXT:    pmovsxbq {{.*#+}} xmm5 = [18446744073709551488,18446744073709551488]
; SSE4-NEXT:    pcmpgtq %xmm5, %xmm0
; SSE4-NEXT:    blendvpd %xmm0, %xmm2, %xmm5
; SSE4-NEXT:    movdqa %xmm3, %xmm0
; SSE4-NEXT:    pcmpgtq %xmm5, %xmm0
...
; AVX-NEXT:    vpmovsxbq {{.*#+}} xmm4 = [18446744073709551488,18446744073709551488]
; AVX-NEXT:    vpcmpgtq %xmm4, %xmm0, %xmm5
; AVX-NEXT:    vblendvpd %xmm5, %xmm0, %xmm4, %xmm0
; AVX-NEXT:    vpcmpgtq %xmm0, %xmm3, %xmm4
; AVX-NEXT:    vblendvpd %xmm4, %xmm0, %xmm3, %xmm0
