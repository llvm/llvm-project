...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm2 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm2, %xmm0, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX2-NEXT:    vshufpd {{.*#+}} xmm2 = xmm1[1,0]
; AVX2-NEXT:    vmulsd %xmm2, %xmm0, %xmm0
...
; AVX1-NEXT:    vmulsd %xmm3, %xmm0, %xmm0
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm2, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm2[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
...
; AVX2-NEXT:    vmulsd %xmm3, %xmm0, %xmm0
...
; AVX1-NEXT:    vmulsd %xmm5, %xmm0, %xmm0
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
...
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm3, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm3[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vextractf128 $1, %ymm3, %xmm1
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm4, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm4[1,0]
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
...
; AVX2-NEXT:    vmulsd %xmm5, %xmm0, %xmm0
...
; AVX2-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX2-NEXT:    vmulsd %xmm4, %xmm0, %xmm0
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: test_v8f64_one:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vshufpd {{.*#+}} xmm2 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm2, %xmm0, %xmm2
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm0, %xmm2, %xmm2
; AVX1-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm0, %xmm2, %xmm0
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm2 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm2, %xmm0, %xmm0
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: test_v8f64_one:
; AVX2:       # %bb.0:
; AVX2-NEXT:    vshufpd {{.*#+}} xmm2 = xmm0[1,0]
; AVX2-NEXT:    vmulsd %xmm2, %xmm0, %xmm2
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm3
; AVX2-NEXT:    vmulsd %xmm3, %xmm2, %xmm2
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[3,2,2,3]
; AVX2-NEXT:    vmulsd %xmm0, %xmm2, %xmm0
; AVX2-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX2-NEXT:    vshufpd {{.*#+}} xmm2 = xmm1[1,0]
; AVX2-NEXT:    vmulsd %xmm2, %xmm0, %xmm0
; AVX2-NEXT:    vextractf128 $1, %ymm1, %xmm2
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: test_v16f64_one:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vshufpd {{.*#+}} xmm4 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm4, %xmm0, %xmm4
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm0, %xmm4, %xmm4
; AVX1-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm0, %xmm4, %xmm0
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm4 = xmm1[1,0]
; AVX1-NEXT:    vmulsd %xmm4, %xmm0, %xmm0
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
; AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm1[1,0]
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: test_v16f64_one:
; AVX2:       # %bb.0:
; AVX2-NEXT:    vshufpd {{.*#+}} xmm4 = xmm0[1,0]
; AVX2-NEXT:    vmulsd %xmm4, %xmm0, %xmm4
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm5
; AVX2-NEXT:    vmulsd %xmm5, %xmm4, %xmm4
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[3,2,2,3]
; AVX2-NEXT:    vmulsd %xmm0, %xmm4, %xmm0
; AVX2-NEXT:    vmulsd %xmm1, %xmm0, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]
; AVX2-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1, %xmm1
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm2
; AVX2-NEXT:    vmulsd %xmm2, %xmm1, %xmm1
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[3,2,2,3]
; AVX2-NEXT:    vmulsd %xmm0, %xmm1, %xmm0
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: test_v8f64_undef:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vshufpd {{.*#+}} xmm2 = xmm0[1,0]
; AVX1-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm2, %xmm2
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm0, %xmm2, %xmm2
; AVX1-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm0, %xmm2, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vshufpd {{.*#+}} xmm2 = xmm0[1,0]
; AVX2-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm2, %xmm2
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm3
; AVX2-NEXT:    vmulsd %xmm3, %xmm2, %xmm2
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[3,2,2,3]
; AVX2-NEXT:    vmulsd %xmm0, %xmm2, %xmm0
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: test_v16f64_undef:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vshufpd {{.*#+}} xmm4 = xmm0[1,0]
; AVX1-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm4, %xmm4
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; AVX1-NEXT:    vmulsd %xmm0, %xmm4, %xmm4
; AVX1-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; AVX1-NEXT:    vmulsd %xmm0, %xmm4, %xmm0
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vshufpd {{.*#+}} xmm4 = xmm0[1,0]
; AVX2-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm4, %xmm4
; AVX2-NEXT:    vextractf128 $1, %ymm0, %xmm5
; AVX2-NEXT:    vmulsd %xmm5, %xmm4, %xmm4
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[3,2,2,3]
; AVX2-NEXT:    vmulsd %xmm0, %xmm4, %xmm0
