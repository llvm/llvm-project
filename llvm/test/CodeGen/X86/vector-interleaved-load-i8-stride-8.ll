...
; SSE-NEXT:    movdqa {{.*#+}} xmm1 = [255,0,0,0,255,0,0,0]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm0[2,0,2,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm7[0,1,2,0,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm7[0,1,3,1,4,5,6,7]
; SSE-NEXT:    packuswb %xmm6, %xmm6
...
; SSE-NEXT:    movd %xmm8, (%rcx)
; SSE-NEXT:    movd %xmm10, (%r8)
; SSE-NEXT:    movd %xmm11, (%r9)
; SSE-NEXT:    movd %xmm9, (%r11)
; SSE-NEXT:    movd %xmm5, (%r10)
...
; SSE-NEXT:    packuswb %xmm5, %xmm5
; SSE-NEXT:    pshufd {{.*#+}} xmm14 = xmm5[0,0,2,3]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm15 = xmm7[0,1,1,3]
...
; SSE-NEXT:    movdqa {{.*#+}} xmm14 = [255,255,255,255,255,255,255,255]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm15[0,1,2,0]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm4[1,1,2,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm5[0,1,2,0,4,5,6,7]
; SSE-NEXT:    packuswb %xmm4, %xmm4
; SSE-NEXT:    movdqa %xmm3, %xmm6
; SSE-NEXT:    pandn %xmm4, %xmm6
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm11[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm7[2,0,2,3,4,5,6,7]
; SSE-NEXT:    packuswb %xmm11, %xmm11
; SSE-NEXT:    pand %xmm3, %xmm11
; SSE-NEXT:    por %xmm6, %xmm11
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm2[0,1,1,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm12[0,1,2,3,4,5,4,6]
; SSE-NEXT:    packuswb %xmm2, %xmm2
; SSE-NEXT:    movdqa %xmm0, %xmm6
; SSE-NEXT:    pandn %xmm2, %xmm6
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm15[0,1,1,3]
...
; SSE-NEXT:    packuswb %xmm10, %xmm10
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm10[0,0,2,3]
...
; SSE-NEXT:    pshufd $236, (%rsp), %xmm0 # 16-byte Folded Reload
...
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm2[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm10 = xmm10[0,1,2,3,4,5,7,5]
; SSE-NEXT:    packuswb %xmm10, %xmm10
...
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[1,1,1,1]
...
; SSE-NEXT:    pshufd $212, (%rsp), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = mem[0,1,1,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm4[0,1,2,3,4,5,4,6]
; SSE-NEXT:    packuswb %xmm0, %xmm0
; SSE-NEXT:    movdqa %xmm6, %xmm1
; SSE-NEXT:    pandn %xmm0, %xmm1
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm11[0,1,2,0,4,5,6,7]
; SSE-NEXT:    packuswb %xmm1, %xmm1
; SSE-NEXT:    movdqa %xmm3, %xmm10
; SSE-NEXT:    pandn %xmm1, %xmm10
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm15[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm9[2,0,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm7[0,1,2,2]
; SSE-NEXT:    movdqa %xmm6, %xmm14
...
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm4[0,1,2,3,4,5,5,7]
; SSE-NEXT:    packuswb %xmm1, %xmm1
; SSE-NEXT:    movdqa %xmm6, %xmm14
; SSE-NEXT:    pandn %xmm1, %xmm14
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm11[0,1,3,1,4,5,6,7]
; SSE-NEXT:    packuswb %xmm1, %xmm1
...
; SSE-NEXT:    pshufd $255, {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Folded Reload
; SSE-NEXT:    # xmm9 = mem[3,3,3,3]
; SSE-NEXT:    packuswb %xmm9, %xmm9
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm15[0,1,3,3]
...
; SSE:       # %bb.0:
; SSE-NEXT:    subq $888, %rsp # imm = 0x378
...
; SSE-NEXT:    packuswb %xmm14, %xmm14
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm14[0,0,2,3]
...
; SSE-NEXT:    movdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm2[0,1,2,2]
; SSE-NEXT:    movdqa {{.*#+}} xmm6 = [65535,65535,65535,65535,65535,65535,65535,0]
...
; SSE-NEXT:    packuswb %xmm9, %xmm9
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm9[0,0,2,3]
; SSE-NEXT:    movdqa %xmm13, %xmm8
; SSE-NEXT:    pandn %xmm4, %xmm8
...
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm8[0,1,1,3]
; SSE-NEXT:    packuswb %xmm4, %xmm4
; SSE-NEXT:    pand %xmm6, %xmm4
; SSE-NEXT:    por %xmm7, %xmm4
...
; SSE-NEXT:    pand %xmm1, %xmm2
; SSE-NEXT:    movdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm2[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,5,7,5]
; SSE-NEXT:    packuswb %xmm4, %xmm4
...
; SSE-NEXT:    movsd {{.*#+}} xmm1 = xmm0[0],xmm1[1]
; SSE-NEXT:    movapd %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm12[1,1,2,3]
; SSE-NEXT:    movdqa %xmm11, %xmm1
; SSE-NEXT:    pandn %xmm0, %xmm1
; SSE-NEXT:    pshufd $255, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[3,3,3,3]
...
; SSE-NEXT:    movdqa %xmm6, %xmm4
; SSE-NEXT:    pandn %xmm1, %xmm4
; SSE-NEXT:    pshufd $212, (%rsp), %xmm1 # 16-byte Folded Reload
; SSE-NEXT:    # xmm1 = mem[0,1,1,3]
...
; SSE-NEXT:    movdqa %xmm5, %xmm7
; SSE-NEXT:    pandn %xmm4, %xmm7
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm3[3,1,2,3]
...
; SSE-NEXT:    movdqa %xmm6, %xmm14
; SSE-NEXT:    pandn %xmm0, %xmm14
; SSE-NEXT:    pshufhw $237, (%rsp), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[0,1,2,3,5,7,6,7]
; SSE-NEXT:    packuswb %xmm0, %xmm0
; SSE-NEXT:    pand %xmm6, %xmm0
; SSE-NEXT:    por %xmm14, %xmm0
...
; SSE-NEXT:    por %xmm2, %xmm3
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[0,1,3,3]
; SSE-NEXT:    movdqa %xmm5, %xmm8
; SSE-NEXT:    pandn %xmm2, %xmm8
...
; SSE-NEXT:    addq $888, %rsp # imm = 0x378
; SSE-NEXT:    retq
;
...
; AVX2-SLOW-NEXT:    vmovdqa 144(%rdi), %xmm15
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm15, %xmm0
...
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm15, %xmm3
...
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm14, %xmm1
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm15, %xmm2
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX2-SLOW-NEXT:    vmovdqa %xmm13, %xmm8
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm13, %xmm7
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm6[0],xmm4[1],xmm6[2,3]
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm4[0,1],xmm1[2,3]
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm15, %xmm4
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6,7]
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm10, %xmm6
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm8, %xmm4
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm5
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
...
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm14, %xmm4
; AVX2-SLOW-NEXT:    vmovdqa %xmm15, %xmm10
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm15, %xmm0
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm4[0],xmm0[1],xmm4[1],xmm0[2],xmm4[2],xmm0[3],xmm4[3]
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm9, %xmm4
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm12, %xmm2
...
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm2
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm15, %xmm3
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm9, %xmm3
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm5, %xmm11, %xmm4
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6,7]
...
; AVX2-FAST-NEXT:    vmovdqa 112(%rdi), %xmm2
...
; AVX2-FAST-NEXT:    vpermd %ymm6, %ymm2, %ymm0
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm1 = ymm0[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28]
; AVX2-FAST-NEXT:    vmovdqa %ymm0, %ymm6
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermd %ymm4, %ymm2, %ymm10
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm11 = ymm10[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28,u,u,u,u]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm11[0,1,2,3,4,5,6],ymm1[7]
; AVX2-FAST-NEXT:    vmovdqa 128(%rdi), %ymm0
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovdqa 160(%rdi), %ymm4
; AVX2-FAST-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermd %ymm4, %ymm2, %ymm15
; AVX2-FAST-NEXT:    vpermd %ymm0, %ymm2, %ymm2
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm12 = ymm2[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0],xmm1[1],xmm3[2,3]
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,21,25,29,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm12 = ymm11[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,21,25,29,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm2, %xmm0
; AVX2-FAST-NEXT:    vmovdqa %xmm2, %xmm9
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3]
...
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm5, %xmm3
; AVX2-FAST-NEXT:    vmovdqa %xmm5, %xmm2
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm12[0],xmm3[1],xmm12[1],xmm3[2],xmm12[2],xmm3[3],xmm12[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0],xmm1[1],xmm3[2,3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm1 = ymm11[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm10[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30,u,u,u,u]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5,6],ymm1[7]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm12 = ymm10[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm3 = ymm12[0,1,2,3,4],ymm3[5],ymm12[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-NEXT:    vmovdqa %xmm9, %xmm4
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3]
...
; AVX2-FAST-NEXT:    vpshufb %xmm1, %xmm8, %xmm3
; AVX2-FAST-NEXT:    vpshufb %xmm1, %xmm13, %xmm1
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm1 = [3,11,3,11,3,11,3,11,3,11,3,11,3,11,3,11]
...
; AVX2-FAST-NEXT:    vmovdqa %xmm6, %xmm7
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm3 = [3,11,3,11,3,11,3,11,3,11,3,11,3,11,3,11]
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm14, %xmm12
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm2, %xmm3
; AVX2-FAST-NEXT:    vmovdqa %xmm2, %xmm6
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm12[0],xmm3[1],xmm12[1],xmm3[2],xmm12[2],xmm3[3],xmm12[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0],xmm1[1],xmm3[2,3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm1 = ymm11[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31]
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm2[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31,u,u,u,u]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5,6],ymm1[7]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm2 = ymm10[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-NEXT:    vpermd (%rsp), %ymm2, %ymm5 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm5[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28]
...
; AVX2-FAST-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm14 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm2 = ymm11[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm4 = ymm14[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm2 = [5,13,5,13,5,13,5,13,5,13,5,13,5,13,5,13]
; AVX2-FAST-NEXT:    vpshufb %xmm2, %xmm9, %xmm3
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm2 = ymm5[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,21,25,29]
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm4 = ymm14[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,21,25,29,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm7, %xmm3
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm4[0],xmm3[1],xmm4[1],xmm3[2],xmm4[2],xmm3[3],xmm4[3]
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm4 = [6,14,6,14,6,14,6,14,6,14,6,14,6,14,6,14]
; AVX2-FAST-NEXT:    vpshufb %xmm4, %xmm8, %xmm0
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm1 = ymm5[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30]
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm4 = ymm14[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30,u,u,u,u,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm3 = ymm4[0,1,2,3,4],ymm3[5],ymm4[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
...
; AVX2-FAST-NEXT:    vpshufb %xmm4, %xmm8, %xmm6
; AVX2-FAST-NEXT:    vpshufb %xmm4, %xmm10, %xmm4
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm3 = ymm5[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31]
...
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm5 = ymm14[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 144(%rdi), %xmm15
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm15, %xmm0
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm6, %xmm14
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm15, %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm5, %xmm15, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm5, %xmm10, %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm8, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm11, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
...
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm4 = xmm6[0],xmm4[1],xmm6[2,3]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm1 = xmm4[0,1],xmm1[2,3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rsp), %xmm14 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm5, %xmm9, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm5, %xmm11, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6,7]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm0, %xmm3
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm0, %xmm7
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, %xmm8
; AVX512F-SLOW-NEXT:    vmovdqa 192(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm0, %xmm10
...
; AVX512F-SLOW-NEXT:    vmovdqa 128(%rdi), %ymm7
; AVX512F-SLOW-NEXT:    vpmovqb %ymm7, %xmm7
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm0, %ymm7
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm7[0,1,2,3,4],ymm1[5],ymm7[6,7]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm10 = ymm1[0,1,2,3,4,5],ymm3[6,7]
; AVX512F-SLOW-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm0, %xmm7
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa 96(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm0, %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm0, %xmm18
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm4[0],xmm7[0],xmm4[1],xmm7[1],xmm4[2],xmm7[2],xmm4[3],xmm7[3]
; AVX512F-SLOW-NEXT:    vmovdqa 80(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm0, %xmm12
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm0, %xmm19
; AVX512F-SLOW-NEXT:    vmovdqa 64(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm0, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, %xmm7
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm12[0],xmm5[1],xmm12[1],xmm5[2],xmm12[2],xmm5[3],xmm12[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm5 = xmm5[0,1,2],xmm11[3]
; AVX512F-SLOW-NEXT:    vpmovqb %zmm16, %xmm11
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm5 = xmm11[0,1],xmm5[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm5[0,1,2,3],ymm10[4,5,6,7]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm0, %ymm17
; AVX512F-SLOW-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa 176(%rdi), %xmm11
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm5 = [0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9]
; AVX512F-SLOW-NEXT:    vmovdqa %xmm6, %xmm10
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm6, %xmm12
; AVX512F-SLOW-NEXT:    vmovdqa %xmm2, %xmm6
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm2, %xmm13
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm9, %xmm15
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm15 = ymm13[0,1,2,3,4,5,6],ymm12[7]
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm12 = [0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9]
; AVX512F-SLOW-NEXT:    vpshufb %xmm12, %xmm11, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm12, %xmm0, %xmm12
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm0, %xmm21
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm12[0],xmm13[0],xmm12[1],xmm13[1],xmm12[2],xmm13[2],xmm12[3],xmm13[3]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm3, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm18, %xmm4
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm4, %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm13, %xmm2
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm7, %xmm5
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm1
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm8, %xmm5
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm4, %xmm5
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm5
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm4, %xmm21
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm7, %xmm2
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm7, %xmm23
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm5[0],xmm2[1],xmm5[1],xmm2[2],xmm5[2],xmm2[3],xmm5[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1,2],xmm0[3]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm3, %xmm5
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm9, %xmm14
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm14[0],xmm5[0],xmm14[1],xmm5[1],xmm14[2],xmm5[2],xmm14[3],xmm5[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm11, %xmm14
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm11, %xmm25
; AVX512F-SLOW-NEXT:    vmovdqa %xmm6, %xmm4
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm6, %xmm5
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm14[0],xmm5[1],xmm14[1],xmm5[2],xmm14[2],xmm5[3],xmm14[3]
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm27, %xmm12
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm9, %xmm14
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm4, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm4, %xmm25
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm14[0],xmm5[1],xmm14[1],xmm5[2],xmm14[2],xmm5[3],xmm14[3]
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm14 = [5,13,0,0,5,13,0,0,5,13,0,0,5,13,0,0]
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm13, %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm28, %xmm4
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm4, %xmm14
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm10, %xmm1
...
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm14 = [0,0,6,14,0,0,6,14,0,0,6,14,0,0,6,14]
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm6, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm6, %xmm26
; AVX512F-SLOW-NEXT:    vmovdqa %xmm11, %xmm6
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm11, %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm15, %xmm5
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm5[0],xmm3[0],xmm5[1],xmm3[1],xmm5[2],xmm3[2],xmm5[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
...
; AVX512F-SLOW-NEXT:    vmovdqa %xmm9, %xmm11
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm25, %xmm7
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm13, %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm13, %xmm25
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm28, %xmm9
; AVX512F-SLOW-NEXT:    vpshufb %xmm5, %xmm9, %xmm5
...
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm10, %xmm1
...
; AVX512F-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm14 = ymm1[0,1,2,3],ymm0[4,5,6,7]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm6, %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [7,15,0,0,7,15,0,0,7,15,0,0,7,15,0,0]
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm8, %xmm3
...
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5,6],ymm1[7]
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm3 = [0,0,7,15,0,0,7,15,0,0,7,15,0,0,7,15]
...
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm4 = [7,15,0,0,7,15,0,0,7,15,0,0,7,15,0,0]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm25, %xmm6
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm6, %xmm6
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm9, %xmm4
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm4[0],xmm6[0],xmm4[1],xmm6[1],xmm4[2],xmm6[2],xmm4[3],xmm6[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $56, %zmm16, %zmm2
; AVX512F-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
...
; AVX512F-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-SLOW-NEXT:    vmovdqa %ymm14, (%rax)
; AVX512F-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-FAST-NEXT:    vpermd %ymm9, %ymm8, %ymm10
; AVX512BW-FAST-NEXT:    vpshufb %ymm12, %ymm10, %ymm9
...
; AVX512BW-FAST-NEXT:    vpermd %ymm13, %ymm8, %ymm12
; AVX512BW-FAST-NEXT:    vpshufb %ymm31, %ymm12, %ymm13
...
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm8 = ymm8[0,1,2,3,4,5],ymm9[6,7]
; AVX512BW-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm9 = [4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12]
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm1, %xmm13
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm2, %xmm9
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm9[0],xmm13[0],xmm9[1],xmm13[1],xmm9[2],xmm13[2],xmm9[3],xmm13[3]
...
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm13[0,1,2],xmm9[3]
; AVX512BW-FAST-NEXT:    vpsrlq $32, %zmm0, %zmm13
; AVX512BW-FAST-NEXT:    vpmovqb %zmm13, %xmm13
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm13[0,1],xmm9[2,3]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm8 = ymm9[0,1,2,3],ymm8[4,5,6,7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm16, %ymm10, %ymm9
; AVX512BW-FAST-NEXT:    vpshufb %ymm17, %ymm11, %ymm13
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm13[0,1,2,3,4,5,6],ymm9[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm18, %ymm12, %ymm13
; AVX512BW-FAST-NEXT:    vpshufb %ymm19, %ymm15, %ymm14
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm13 = ymm14[0,1,2,3,4],ymm13[5],ymm14[6,7]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm13[0,1,2,3,4,5],ymm9[6,7]
...
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm13[0,1,2,3],ymm9[4,5,6,7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm20, %ymm10, %ymm13
; AVX512BW-FAST-NEXT:    vpshufb %ymm21, %ymm11, %ymm14
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm13 = ymm14[0,1,2,3,4,5,6],ymm13[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm22, %ymm12, %ymm14
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm24, %ymm10, %ymm10
; AVX512BW-FAST-NEXT:    vpshufb %ymm25, %ymm11, %ymm11
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm10 = ymm11[0,1,2,3,4,5,6],ymm10[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm26, %ymm12, %ymm11
; AVX512BW-FAST-NEXT:    vpshufb %ymm27, %ymm15, %ymm12
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm11 = ymm12[0,1,2,3,4],ymm11[5],ymm12[6,7]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm10 = ymm11[0,1,2,3,4,5],ymm10[6,7]
; AVX512BW-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm11 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX512BW-FAST-NEXT:    vpshufb %xmm11, %xmm1, %xmm1
; AVX512BW-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm2
...
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm10[4,5,6,7]
...
; AVX512BW-FAST-NEXT:    vmovdqa %ymm9, (%r11)
...
; SSE-NEXT:    movdqa {{.*#+}} xmm15 = [255,0,0,0,255,0,0,0]
; SSE-NEXT:    movdqa %xmm11, %xmm0
...
; SSE-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pand %xmm3, %xmm15
; SSE-NEXT:    packuswb %xmm0, %xmm15
; SSE-NEXT:    packuswb %xmm1, %xmm0
; SSE-NEXT:    packuswb %xmm15, %xmm15
; SSE-NEXT:    packuswb %xmm0, %xmm15
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[0,3],xmm2[0,3]
; SSE-NEXT:    pxor %xmm7, %xmm7
; SSE-NEXT:    movdqa %xmm12, %xmm1
; SSE-NEXT:    movdqa %xmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movdqa %xmm12, %xmm0
...
; SSE-NEXT:    packuswb %xmm10, %xmm10
; SSE-NEXT:    movdqa %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm10[0,0,2,3]
; SSE-NEXT:    movdqa %xmm13, %xmm2
; SSE-NEXT:    pandn %xmm1, %xmm2
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE-NEXT:    movdqa %xmm3, %xmm1
...
; SSE-NEXT:    packuswb %xmm5, %xmm5
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm5[0,0,2,3]
; SSE-NEXT:    movdqa %xmm13, %xmm14
; SSE-NEXT:    pandn %xmm1, %xmm14
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; SSE-NEXT:    movdqa %xmm2, %xmm1
...
; SSE-NEXT:    pshufd {{.*#+}} xmm14 = xmm10[1,1,1,1]
; SSE-NEXT:    packuswb %xmm14, %xmm14
...
; SSE-NEXT:    movdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm1[0,1,2,0]
...
; SSE-NEXT:    pand %xmm2, %xmm0
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm0[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,4,5,7,5]
; SSE-NEXT:    packuswb %xmm6, %xmm6
; SSE-NEXT:    movdqa %xmm13, %xmm7
; SSE-NEXT:    pandn %xmm6, %xmm7
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm10[2,0,2,3,4,5,6,7]
; SSE-NEXT:    packuswb %xmm2, %xmm2
; SSE-NEXT:    pand %xmm9, %xmm2
; SSE-NEXT:    por %xmm3, %xmm2
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[2,2,2,2]
...
; SSE-NEXT:    punpckhwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    # xmm8 = xmm8[4],mem[4],xmm8[5],mem[5],xmm8[6],mem[6],xmm8[7],mem[7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm8[0,1,1,3]
; SSE-NEXT:    packuswb %xmm1, %xmm1
; SSE-NEXT:    pand %xmm13, %xmm1
; SSE-NEXT:    por %xmm2, %xmm1
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
...
; SSE-NEXT:    pand %xmm9, %xmm3
; SSE-NEXT:    por %xmm2, %xmm3
; SSE-NEXT:    pshufd {{.*#+}} xmm14 = xmm3[2,2,2,2]
...
; SSE-NEXT:    pshufd $229, {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = mem[1,1,2,3]
; SSE-NEXT:    pshufd $255, {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Folded Reload
; SSE-NEXT:    # xmm5 = mem[3,3,3,3]
; SSE-NEXT:    packuswb %xmm5, %xmm5
; SSE-NEXT:    pand %xmm12, %xmm5
...
; SSE-NEXT:    pshufd $244, {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = mem[0,1,3,3]
; SSE-NEXT:    pshufd $255, {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Folded Reload
; SSE-NEXT:    # xmm5 = mem[3,3,3,3]
; SSE-NEXT:    packuswb %xmm5, %xmm5
...
; SSE-NEXT:    punpckhdq {{.*#+}} xmm5 = xmm5[2],xmm11[2],xmm5[3],xmm11[3]
...
; AVX1-ONLY-NEXT:    vmovdqa 336(%rdi), %xmm13
...
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm15, %xmm0
; AVX1-ONLY-NEXT:    vmovdqa %xmm15, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vbroadcastss {{.*#+}} xmm0 = [0,8,0,0,0,8,0,0,0,8,0,0,0,8,0,0]
; AVX1-ONLY-NEXT:    vmovdqa 272(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vmovdqa %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm6, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa 256(%rdi), %xmm14
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm14, %xmm7
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vmovdqa 480(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm11, %xmm6
...
; AVX1-ONLY-NEXT:    vmovdqa 448(%rdi), %xmm8
...
; AVX1-ONLY-NEXT:    vmovdqa 432(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vmovdqa %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm7, %xmm7
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX1-ONLY-NEXT:    vmovdqa 400(%rdi), %xmm7
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm7, %xmm7
; AVX1-ONLY-NEXT:    vmovdqa 384(%rdi), %xmm8
; AVX1-ONLY-NEXT:    vmovdqa %xmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm7, %xmm6
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX1-ONLY-NEXT:    vmovdqa (%rdi), %xmm8
; AVX1-ONLY-NEXT:    vmovdqa %xmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa 16(%rdi), %xmm7
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm7, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, %xmm12
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm8, %xmm7
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm5 = xmm6[0,1],xmm5[2,3],xmm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm4 = xmm5[0,1,2,3],xmm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovdqa 240(%rdi), %xmm5
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm5, %xmm5
...
; AVX1-ONLY-NEXT:    vpshufb %xmm6, %xmm0, %xmm1
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm9, %xmm15
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm9, %xmm15
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm12, %xmm5
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm8, %xmm6
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm6, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm0, %xmm9, %xmm5
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm9, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm6, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm12, %xmm14
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufb %xmm3, %xmm12, %xmm14
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm1
...
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm4, %xmm1
...
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm12, %xmm0
...
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm0[0],xmm5[1],xmm0[1],xmm5[2],xmm0[2],xmm5[3],xmm0[3]
; AVX2-SLOW-NEXT:    vmovdqa 272(%rdi), %xmm11
...
; AVX2-SLOW-NEXT:    vmovdqa 256(%rdi), %xmm10
; AVX2-SLOW-NEXT:    vpshufb %xmm9, %xmm10, %xmm7
...
; AVX2-SLOW-NEXT:    vmovdqa 416(%rdi), %xmm14
...
; AVX2-SLOW-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-SLOW-NEXT:    vpshufb %xmm9, %xmm0, %xmm8
...
; AVX2-SLOW-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm0, %xmm4
...
; AVX2-SLOW-NEXT:    vmovdqa 176(%rdi), %xmm0
; AVX2-SLOW-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm0, %xmm3
; AVX2-SLOW-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX2-SLOW-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-SLOW-NEXT:    vpshufb %xmm6, %xmm12, %xmm0
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm6, %xmm7, %xmm5
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm0[0],xmm5[1],xmm0[1],xmm5[2],xmm0[2],xmm5[3],xmm0[3]
; AVX2-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm1 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm11, %xmm0
...
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm4
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm10, %xmm5
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm6, %xmm8, %xmm5
; AVX2-SLOW-NEXT:    vpshufb %xmm6, %xmm14, %xmm15
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
; AVX2-SLOW-NEXT:    vmovdqa (%rsp), %xmm14 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm7, %xmm5
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm14
...
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm6
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm6
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm15
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm11, %xmm6
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm6, %xmm6
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm7, %xmm3
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm5, %xmm5
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm3[0],xmm5[1],xmm3[1],xmm5[2],xmm3[2],xmm5[3],xmm3[3]
; AVX2-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm3 = [4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12]
...
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm6, %xmm6
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm13, %xmm14
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} ymm5 = ymm6[0,1,2,3,4,5,6],ymm5[7]
...
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm6, %xmm6
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm1, %xmm13, %xmm14
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX2-SLOW-NEXT:    vmovdqa (%rsp), %xmm13 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm14
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm15
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm14, %ymm0, %ymm14
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} ymm6 = ymm14[0,1,2,3,4],ymm6[5],ymm14[6,7]
...
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm5[0,1],xmm4[2,3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm5
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[1],xmm2[1],xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm2
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm14, %xmm14
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm15, %xmm15
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm14, %ymm0, %ymm14
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} ymm6 = ymm14[0,1,2,3,4],ymm6[5],ymm14[6,7]
...
; AVX2-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm2[0,1,2],xmm0[3]
; AVX2-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm2 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm0 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm14
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm15
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm14
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm15
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX2-SLOW-NEXT:    vmovdqa (%rsp), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm15
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm13
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm13
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm14
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1],xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm12
; AVX2-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm3
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm12[0],xmm3[1],xmm12[1],xmm3[2],xmm12[2],xmm3[3],xmm12[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
...
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm9, %xmm3
; AVX2-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm0
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FAST-NEXT:    vmovdqa 368(%rdi), %xmm1
...
; AVX2-FAST-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermd %ymm4, %ymm1, %ymm13
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm4 = ymm8[0,1,2,3],ymm10[4,5,6,7]
; AVX2-FAST-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovdqa 112(%rdi), %xmm4
; AVX2-FAST-NEXT:    vmovdqa %xmm4, (%rsp) # 16-byte Spill
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm4, %xmm8
...
; AVX2-FAST-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vpshufb %xmm2, %xmm4, %xmm8
; AVX2-FAST-NEXT:    vmovdqa 64(%rdi), %xmm4
; AVX2-FAST-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vpshufb %xmm2, %xmm4, %xmm2
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm8[0],xmm2[1],xmm8[1],xmm2[2],xmm8[2],xmm2[3],xmm8[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1,2],xmm0[3]
; AVX2-FAST-NEXT:    vmovdqa 32(%rdi), %xmm4
; AVX2-FAST-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vmovdqa 48(%rdi), %xmm2
; AVX2-FAST-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-FAST-NEXT:    vpshufb %xmm9, %xmm4, %xmm9
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm9[0],xmm3[0],xmm9[1],xmm3[1],xmm9[2],xmm3[2],xmm9[3],xmm3[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm2 = xmm3[0],xmm2[1],xmm3[2,3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm2[0,1],xmm0[2,3]
...
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,16,20,24,28]
; AVX2-FAST-NEXT:    vpermd %ymm2, %ymm1, %ymm2
; AVX2-FAST-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpshufb %ymm7, %ymm2, %ymm10
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm10 = ymm10[0,1,2,3,4,5,6],ymm0[7]
; AVX2-FAST-NEXT:    vmovdqa 128(%rdi), %ymm0
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-NEXT:    vpshufb %ymm6, %ymm1, %ymm11
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm11[0,1,2,3,4],ymm0[5],ymm11[6,7]
...
; AVX2-FAST-NEXT:    vpshufb %xmm10, %xmm15, %xmm11
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm10, %xmm2, %xmm12
...
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm14, %xmm4, %xmm8
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm9[2,3]
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm3 # 32-byte Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm8 = ymm3[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,21,25,29]
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm8 = ymm9[0,1,2,3,4,5,6],ymm8[7]
...
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm0 = [2,10,2,10,2,10,2,10,2,10,2,10,2,10,2,10]
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm6, %xmm1
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm7, %xmm8
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm8[0],xmm1[0],xmm8[1],xmm1[1],xmm8[2],xmm1[2],xmm8[3],xmm1[3]
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm8 = [2,10,2,10,2,10,2,10,2,10,2,10,2,10,2,10]
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm6, %xmm9
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm2, %xmm10
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm10[0,1],xmm1[2,3]
...
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm5, %xmm8
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm8[0],xmm1[0],xmm8[1],xmm1[1],xmm8[2],xmm1[2],xmm8[3],xmm1[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
...
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm0, %xmm5, %xmm8
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm8[0],xmm1[0],xmm8[1],xmm1[1],xmm8[2],xmm1[2],xmm8[3],xmm1[3]
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm8 = [3,11,3,11,3,11,3,11,3,11,3,11,3,11,3,11]
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm6, %xmm9
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm5, %xmm10
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm9[0,1,2],xmm1[3]
...
; AVX2-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm12 = [3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15]
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Reload
...
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm6[0],xmm1[0],xmm6[1],xmm1[1],xmm6[2],xmm1[2],xmm6[3],xmm1[3]
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm6
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm7
...
; AVX2-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Reload
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm4 = ymm2[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,19,23,27,31,u,u,u,u]
...
; AVX2-FAST-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm8 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm1, %xmm10
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm8, %xmm1, %xmm11
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm11[0],xmm10[0],xmm11[1],xmm10[1],xmm11[2],xmm10[2],xmm11[3],xmm10[3]
...
; AVX2-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FAST-NEXT:    vpshufb %xmm14, %xmm1, %xmm9
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm9[0],xmm15[0],xmm9[1],xmm15[1],xmm9[2],xmm15[2],xmm9[3],xmm15[3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm9[0],xmm13[1],xmm9[2,3]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm9[0,1],xmm10[2,3]
...
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vpblendd {{.*#+}} ymm1 = ymm9[0,1,2,3],ymm1[4,5,6,7]
...
; AVX2-FAST-PERLANE:       # %bb.0:
; AVX2-FAST-PERLANE-NEXT:    subq $808, %rsp # imm = 0x328
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 288(%rdi), %xmm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm5, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm0[0],xmm5[1],xmm0[1],xmm5[2],xmm0[2],xmm5[3],xmm0[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 272(%rdi), %xmm11
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm9 = [0,8,0,8,0,8,0,8,0,8,0,8,0,8,0,8]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm9, %xmm11, %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 256(%rdi), %xmm10
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm9, %xmm10, %xmm7
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm9, %xmm0, %xmm8
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 176(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm0, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3]
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm2 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm15, %xmm1
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm13, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm4[0],xmm1[0],xmm4[1],xmm1[1],xmm4[2],xmm1[2],xmm4[3],xmm1[3]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm4 = xmm1[0,1,2],xmm0[3]
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm6 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm12, %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm7, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm0[0],xmm5[1],xmm0[1],xmm5[2],xmm0[2],xmm5[3],xmm0[3]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm9, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm10, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm8, %xmm5
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm7, %xmm5
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm13, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm5 = xmm6[0],xmm5[1],xmm6[2,3]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm4 = xmm5[0,1],xmm4[2,3]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm9, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm10, %xmm6
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm11, %xmm6
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm11, %xmm15
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm7, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm5, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm3[0],xmm5[1],xmm3[1],xmm5[2],xmm3[2],xmm5[3],xmm3[3]
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm3 = [4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm6, %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm13, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm5 = ymm6[0,1,2,3,4,5,6],ymm5[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm6, %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm13, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rsp), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm13, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm13, %xmm15
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm6, %ymm0, %ymm6
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm14, %ymm0, %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm6 = ymm14[0,1,2,3,4],ymm6[5],ymm14[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm4 = xmm5[0,1],xmm4[2,3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm11, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4],ymm1[5],ymm2[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} ymm5 = ymm4[0,1,2,3],ymm0[4,5,6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm11, %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3]
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm3 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm12, %xmm2
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vpblendd {{.*#+}} xmm4 = xmm2[0,1,2],xmm0[3]
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm2 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastw {{.*#+}} xmm0 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm11, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm11, %xmm15
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rsp), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm11, %xmm15
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm11, %xmm13
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm11, %xmm13
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm11, %xmm14
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm14[0],xmm13[0],xmm14[1],xmm13[1],xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm11, %xmm12
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm11, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm12[0],xmm3[1],xmm12[1],xmm3[2],xmm12[2],xmm3[3],xmm12[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm9, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm0, %xmm10, %xmm0
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FAST-PERLANE-NEXT:    addq $808, %rsp # imm = 0x328
; AVX2-FAST-PERLANE-NEXT:    vzeroupper
; AVX2-FAST-PERLANE-NEXT:    retq
;
; AVX512F-SLOW-LABEL: load_i8_stride8_vf64:
; AVX512F-SLOW:       # %bb.0:
; AVX512F-SLOW-NEXT:    subq $504, %rsp # imm = 0x1F8
; AVX512F-SLOW-NEXT:    vmovdqa64 256(%rdi), %zmm30
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm4, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa %xmm4, %xmm14
...
; AVX512F-SLOW-NEXT:    vpmovqb %zmm30, %xmm4
...
; AVX512F-SLOW-NEXT:    vmovdqa 224(%rdi), %xmm5
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm5, %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa %xmm5, %xmm13
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm4[0],xmm2[0],xmm4[1],xmm2[1],xmm4[2],xmm2[2],xmm4[3],xmm2[3]
; AVX512F-SLOW-NEXT:    vmovdqa 208(%rdi), %xmm11
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm4, %zmm28
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm12, %xmm2
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm9, %xmm3
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm15, %xmm4
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm3[0,1,2,3,4,5,6],ymm2[7]
; AVX512F-SLOW-NEXT:    vmovdqa 416(%rdi), %xmm12
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm12, %xmm5
...
; AVX512F-SLOW-NEXT:    vmovdqa 400(%rdi), %xmm2
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm9 = [1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0]
; AVX512F-SLOW-NEXT:    vpshufb %xmm9, %xmm2, %xmm6
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm24
; AVX512F-SLOW-NEXT:    vpshufb %xmm9, %xmm0, %xmm7
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm14, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm14, %xmm23
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm16, %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm0, %xmm6
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm16, %xmm18
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm0, %xmm6
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm0
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm0, %xmm7
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm5 = xmm6[0,1,2],xmm5[3]
; AVX512F-SLOW-NEXT:    vpsrlq $8, %zmm30, %zmm6
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm0, %xmm4
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm13, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm13, %xmm26
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm11, %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm11, %xmm31
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm10, %xmm6
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm10, %xmm27
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm5[0,1,2,3,4,5,6],ymm4[7]
; AVX512F-SLOW-NEXT:    vmovdqa 160(%rdi), %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa 176(%rdi), %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm9, %xmm4, %xmm9
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm8, %xmm14, %xmm3
...
; AVX512F-SLOW-NEXT:    vpsrlq $8, %zmm28, %zmm2
; AVX512F-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
...
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm0, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm2
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm12, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa %xmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm13, %xmm0
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm30, %zmm19
; AVX512F-SLOW-NEXT:    vpsrlq $16, %zmm30, %zmm9
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm6, %xmm0
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm4, %xmm14, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm25, %xmm29
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm10, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm10, %xmm30
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm10
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm17, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm10, %xmm1
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm1[0,1,2],xmm2[3]
; AVX512F-SLOW-NEXT:    vpsrlq $16, %zmm28, %zmm2
; AVX512F-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm7, %xmm15
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm18, (%rsp) # 16-byte Spill
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1,2],xmm8[3]
; AVX512F-SLOW-NEXT:    vpsrlq $24, %zmm19, %zmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512F-SLOW-NEXT:    vpmovqb %zmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3]
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm8, %zmm0, %zmm8
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm8 {%k1}
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm6, %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm6, %xmm24
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $24, %zmm28, %zmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm28, %zmm19
; AVX512F-SLOW-NEXT:    vpmovqb %zmm1, %xmm1
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm8, %zmm0
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm18, %zmm28
; AVX512F-SLOW-NEXT:    vpmovqb %zmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3]
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm8, %zmm0, %zmm8
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm8 {%k1}
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm5, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm26, %xmm25
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm9[0],xmm4[0],xmm9[1],xmm4[1],xmm9[2],xmm4[2],xmm9[3],xmm4[3]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm31, %xmm5
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm5, %xmm9
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm7, %xmm15
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm27, %xmm23
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm9, %ymm0, %ymm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm9[0,1,2,3,4,5,6],ymm4[7]
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $32, %zmm19, %zmm1
; AVX512F-SLOW-NEXT:    vpmovqb %zmm1, %xmm1
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm8, %zmm0
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm11, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm11, %xmm29
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm2
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm10, %xmm26
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm6, %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm27
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm3[0,1,2,3,4,5,6],ymm2[7]
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [0,0,5,13,0,0,5,13,0,0,5,13,0,0,5,13]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm20, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm13, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm6, %xmm8
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm8[0],xmm3[0],xmm8[1],xmm3[1],xmm8[2],xmm3[2],xmm8[3],xmm3[3]
...
; AVX512F-SLOW-NEXT:    vmovdqa (%rsp), %xmm6 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm6, %xmm9
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm22, %xmm6
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm6, %xmm9
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm14, %xmm15
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm14, %xmm31
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1,2],xmm8[3]
; AVX512F-SLOW-NEXT:    vpsrlq $40, %zmm18, %zmm9
; AVX512F-SLOW-NEXT:    vpmovqb %zmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3]
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm8, %zmm0, %zmm8
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm8 {%k1}
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $40, %zmm19, %zmm1
; AVX512F-SLOW-NEXT:    vpmovqb %zmm1, %xmm1
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm8, %zmm0
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm4
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm4, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm20
...
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm13, %xmm15
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm8, %ymm0, %ymm8
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm9, %ymm0, %ymm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm8 = ymm9[0,1,2,3,4],ymm8[5],ymm9[6,7]
...
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm8, %xmm8
; AVX512F-SLOW-NEXT:    vmovdqa (%rsp), %xmm9 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm22, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm13, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm31, %xmm13
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm13, %xmm15
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm9[0],xmm15[1],xmm9[1],xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1,2],xmm8[3]
; AVX512F-SLOW-NEXT:    vpsrlq $48, %zmm18, %zmm9
; AVX512F-SLOW-NEXT:    vpmovqb %zmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3]
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm8, %zmm0, %zmm8
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm8 {%k1}
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm12, %xmm9
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm9[0],xmm4[0],xmm9[1],xmm4[1],xmm9[2],xmm4[2],xmm9[3],xmm4[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm5, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm5, %xmm25
...
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm9[0,1,2,3,4,5,6],ymm4[7]
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm6, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm6, %xmm18
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm14, %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm9[0],xmm2[1],xmm9[1],xmm2[2],xmm9[2],xmm2[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm11, %xmm30
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm10, %xmm3
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm9[0],xmm3[1],xmm9[1],xmm3[2],xmm9[2],xmm3[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm13, %xmm3
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm7, %xmm24
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm6, %xmm1
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $48, %zmm19, %zmm1
; AVX512F-SLOW-NEXT:    vpmovqb %zmm1, %xmm1
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm8, %zmm23
; AVX512F-SLOW-NEXT:    vpbroadcastd {{.*#+}} xmm0 = [0,0,7,15,0,0,7,15,0,0,7,15,0,0,7,15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm29, %xmm1
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm1, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm26, %xmm2
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm7, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm7
; AVX512F-SLOW-NEXT:    vpshufb %xmm3, %xmm7, %xmm11
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm0, %xmm7, %xmm9
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm22, %xmm7
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm7, %xmm9
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm31, %xmm7
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm7, %xmm11
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm11[0],xmm9[0],xmm11[1],xmm9[1],xmm11[2],xmm9[2],xmm11[3],xmm9[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1,2],xmm8[3]
; AVX512F-SLOW-NEXT:    vpsrlq $56, %zmm28, %zmm9
; AVX512F-SLOW-NEXT:    vpmovqb %zmm9, %xmm9
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3]
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm8, %zmm0, %zmm8
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm8 {%k1}
...
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm9[0,1,2,3,4,5,6],ymm4[7]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm18, %xmm5
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm5, %xmm7
; AVX512F-SLOW-NEXT:    vpshufb %xmm2, %xmm14, %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm7[0],xmm2[1],xmm7[1],xmm2[2],xmm7[2],xmm2[3],xmm7[3]
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX512F-SLOW-NEXT:    vpsrlq $56, %zmm19, %zmm1
; AVX512F-SLOW-NEXT:    vpmovqb %zmm1, %xmm1
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX512F-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm2[4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm8, %zmm0
...
; AVX512F-SLOW-NEXT:    addq $504, %rsp # imm = 0x1F8
; AVX512F-SLOW-NEXT:    vzeroupper
; AVX512F-SLOW-NEXT:    retq
;
...
; AVX512F-FAST-NEXT:    vmovdqa %ymm4, %ymm13
...
; AVX512F-FAST-NEXT:    vpermd %ymm3, %ymm0, %ymm4
...
; AVX512F-FAST-NEXT:    vmovdqa 384(%rdi), %ymm4
; AVX512F-FAST-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-FAST-NEXT:    vpermd %ymm4, %ymm0, %ymm4
...
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm0, %ymm8
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm0, %ymm21
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} ymm7 = ymm8[0,1,2,3,4],ymm7[5],ymm8[6,7]
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm0, %xmm19
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm2, %zmm29
...
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm11 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm12, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm12, %ymm26
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm7 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm13, %ymm1
...
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm14, %ymm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm14, %ymm24
; AVX512F-FAST-NEXT:    vmovdqa %ymm2, %ymm14
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm13 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm31, %ymm9
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm9, %ymm3
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm23, %xmm10
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm10, %xmm3
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm15, %xmm5
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm25, %xmm12
; AVX512F-FAST-NEXT:    vpshufb %xmm5, %xmm12, %xmm0
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm2, %ymm30
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14]
; AVX512F-FAST-NEXT:    vpshufb %ymm3, %ymm9, %ymm2
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm31, %ymm21
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm3, %ymm31
...
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm10, %xmm2
; AVX512F-FAST-NEXT:    vmovdqa %xmm10, %xmm9
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm23, %xmm10
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm10, %xmm3
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm12, %xmm27
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm25, %xmm12
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm25, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm12, %xmm6
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm28, %zmm18
...
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm11, %ymm5
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm11, %ymm28
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm31, %ymm4
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm7, %ymm6
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm9, %xmm24
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm10, %xmm3
; AVX512F-FAST-NEXT:    vmovdqa %xmm10, %xmm11
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} xmm3 = [3,11,0,0,3,11,0,0,3,11,0,0,3,11,0,0]
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm27, %xmm5
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm5, %xmm5
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm12, %xmm6
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm2 = xmm5[0,1,2],xmm2[3]
; AVX512F-FAST-NEXT:    vpsrlq $24, %zmm18, %zmm5
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm18, %zmm25
; AVX512F-FAST-NEXT:    vpmovqb %zmm5, %xmm5
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm2 = xmm5[0,1],xmm2[2,3]
; AVX512F-FAST-NEXT:    vinserti32x4 $2, %xmm2, %zmm0, %zmm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm2 {%k1}
...
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm4[0,1,2,3,4,5],ymm0[6,7]
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm14, %xmm4
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm14, %xmm19
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm15, %xmm1
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm15, %xmm18
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm29, %zmm30
; AVX512F-FAST-NEXT:    vpmovqb %zmm3, %xmm3
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0,1],xmm1[2,3]
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0,1,2,3],ymm0[4,5,6,7]
; AVX512F-FAST-NEXT:    vinserti64x4 $0, %ymm0, %zmm2, %zmm0
...
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} ymm6 = ymm9[0,1,2,3,4],ymm6[5],ymm9[6,7]
...
; AVX512F-FAST-NEXT:    vpshufb %xmm6, %xmm2, %xmm9
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm24, %xmm17
; AVX512F-FAST-NEXT:    vpshufb %xmm6, %xmm10, %xmm10
...
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm4, %xmm10
...
; AVX512F-FAST-NEXT:    vpsrlq $32, %zmm25, %zmm10
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512F-FAST-NEXT:    vpmovqb %zmm10, %xmm10
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm10[0,1],xmm9[2,3]
; AVX512F-FAST-NEXT:    vinserti32x4 $2, %xmm9, %zmm0, %zmm12
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm12 {%k1}
; AVX512F-FAST-NEXT:    vpermd {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm2, %ymm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm2, %ymm27
; AVX512F-FAST-NEXT:    vpermd (%rsp), %ymm0, %ymm2 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    vpshufb %ymm8, %ymm2, %ymm13
...
; AVX512F-FAST-NEXT:    vpshufb %xmm6, %xmm8, %xmm14
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm18, %xmm7
...
; AVX512F-FAST-NEXT:    vpsrlq $32, %zmm30, %zmm11
...
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm0, %ymm6
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm2 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
...
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm10, %ymm11
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm22 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm22, %ymm1
; AVX512F-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm5 # 32-byte Reload
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm5, %ymm12
...
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm9, %xmm13
...
; AVX512F-FAST-NEXT:    vmovdqa %xmm4, %xmm1
; AVX512F-FAST-NEXT:    vpshufb %xmm13, %xmm4, %xmm14
; AVX512F-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Reload
; AVX512F-FAST-NEXT:    vpshufb %xmm13, %xmm4, %xmm15
...
; AVX512F-FAST-NEXT:    vpshufb %ymm6, %ymm14, %ymm6
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm26, %ymm14
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm19, %xmm21
...
; AVX512F-FAST-NEXT:    vpsrlq $40, %zmm30, %zmm13
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm30, %zmm20
...
; AVX512F-FAST-NEXT:    vinserti64x4 $0, %ymm6, %zmm12, %zmm2
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm2 = [2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14]
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm0, %ymm6
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm22, %ymm11
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm10, %ymm11
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm23, %ymm16
; AVX512F-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm18 = [2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm18, %ymm12
...
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3]
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm12 = xmm14[0,1,2],xmm12[3]
; AVX512F-FAST-NEXT:    vpsrlq $48, %zmm24, %zmm14
; AVX512F-FAST-NEXT:    vpmovqb %zmm14, %xmm14
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm12 = xmm14[0,1],xmm12[2,3]
; AVX512F-FAST-NEXT:    vinserti32x4 $2, %xmm12, %zmm0, %zmm12
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm12 {%k1}
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm27, %ymm9
; AVX512F-FAST-NEXT:    vpshufb {{.*#+}} ymm6 = ymm9[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,22,26,30]
...
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm13[0],xmm14[0],xmm13[1],xmm14[1],xmm13[2],xmm14[2],xmm13[3],xmm14[3]
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm11 = xmm13[0,1,2],xmm11[3]
; AVX512F-FAST-NEXT:    vpsrlq $48, %zmm20, %zmm13
; AVX512F-FAST-NEXT:    vpmovqb %zmm13, %xmm13
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} xmm11 = xmm13[0,1],xmm11[2,3]
; AVX512F-FAST-NEXT:    vpblendd {{.*#+}} ymm6 = ymm11[0,1,2,3],ymm6[4,5,6,7]
; AVX512F-FAST-NEXT:    vinserti64x4 $0, %ymm6, %zmm12, %zmm18
...
; AVX512F-FAST-NEXT:    vpshufb %ymm6, %ymm10, %ymm4
...
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm23, %xmm5
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm5, %xmm5
...
; AVX512F-FAST-NEXT:    vpshufb %xmm5, %xmm10, %xmm11
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm30, %xmm10
; AVX512F-FAST-NEXT:    vpshufb %xmm5, %xmm10, %xmm12
...
; AVX512F-FAST-NEXT:    vpsrlq $56, %zmm24, %zmm11
; AVX512F-FAST-NEXT:    vpmovqb %zmm11, %xmm11
...
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm1, %ymm9
...
; AVX512F-FAST-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-FAST-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-FAST-NEXT:    vmovaps %zmm1, (%rax)
; AVX512F-FAST-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-SLOW:       # %bb.0:
; AVX512BW-SLOW-NEXT:    subq $728, %rsp # imm = 0x2D8
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%rdi), %zmm3
; AVX512BW-SLOW-NEXT:    vmovdqa64 128(%rdi), %zmm0
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm0, %xmm0
; AVX512BW-SLOW-NEXT:    vmovdqa64 256(%rdi), %zmm16
; AVX512BW-SLOW-NEXT:    vmovdqa64 384(%rdi), %zmm2
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512BW-SLOW-NEXT:    vmovdqa 496(%rdi), %xmm5
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm14 = [0,8,0,8,0,8,0,8,0,8,0,8,0,8,0,8]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm5, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm5, %xmm8
; AVX512BW-SLOW-NEXT:    vmovdqa 480(%rdi), %xmm6
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm6, %xmm5
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm19, %xmm6, %xmm7
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm6, %xmm27
...
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm9 = ymm2[0,1,2,3,4,5],ymm4[6,7]
; AVX512BW-SLOW-NEXT:    vmovdqa64 368(%rdi), %xmm26
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm26, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa 352(%rdi), %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm2, %xmm7
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm23
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vmovdqa 336(%rdi), %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm19, %xmm2, %xmm12
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm28
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm2, (%rsp) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vmovdqa64 320(%rdi), %xmm31
...
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm10 = xmm12[0,1,2],xmm10[3]
...
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm9, %zmm0, %zmm20 {%k1}
; AVX512BW-SLOW-NEXT:    vmovdqa 240(%rdi), %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm1, %xmm10
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm1, %xmm29
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vmovdqa 224(%rdi), %xmm11
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm11, %xmm13
...
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm1, %xmm12
; AVX512BW-SLOW-NEXT:    vmovdqa 192(%rdi), %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm19, %xmm1, %xmm17
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm1, %xmm22
...
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm10 = ymm13[0,1,2,3,4,5,6],ymm10[7]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm0[0,1,2,3,4,5],ymm10[6,7]
; AVX512BW-SLOW-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm0, %xmm17
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm0, %xmm10
; AVX512BW-SLOW-NEXT:    vmovdqa 96(%rdi), %xmm13
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm13, %xmm14
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm14[0],xmm17[0],xmm14[1],xmm17[1],xmm14[2],xmm17[2],xmm14[3],xmm17[3]
; AVX512BW-SLOW-NEXT:    vmovdqa 80(%rdi), %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm19, %xmm2, %xmm21
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm17
; AVX512BW-SLOW-NEXT:    vmovdqa64 64(%rdi), %xmm18
; AVX512BW-SLOW-NEXT:    vpshufb %xmm19, %xmm18, %xmm19
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm19[0],xmm21[0],xmm19[1],xmm21[1],xmm19[2],xmm21[2],xmm19[3],xmm21[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm15[0,1,2],xmm0[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm3, %zmm5
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm3, %xmm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm15[0,1],xmm0[2,3]
...
; AVX512BW-SLOW-NEXT:    vmovdqa 384(%rdi), %xmm0
; AVX512BW-SLOW-NEXT:    vmovdqa64 400(%rdi), %xmm21
; AVX512BW-SLOW-NEXT:    vmovdqa 416(%rdi), %xmm6
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vmovdqa 432(%rdi), %xmm9
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm8, %xmm1
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm24, %xmm19
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm24, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm15[0],xmm1[0],xmm15[1],xmm1[1],xmm15[2],xmm1[2],xmm15[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm15 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm25, %xmm24
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm27, %xmm14
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm27, %xmm25
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm27, %xmm9, %xmm24
; AVX512BW-SLOW-NEXT:    vpshufb %xmm27, %xmm6, %xmm25
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm24 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3]
; AVX512BW-SLOW-NEXT:    vinserti32x4 $1, %xmm24, %ymm0, %ymm2
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm30 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm21, %xmm24
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm0, %xmm25
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm0, %xmm20
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm24 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm26, %xmm2
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm26, %xmm9
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm23, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm23, %xmm6
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm28, %xmm3
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm31, %xmm24
...
; AVX512BW-SLOW-NEXT:    vpsrlq $8, %zmm16, %zmm3
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm3, %xmm3
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm29, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm11, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm12, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm12, %xmm29
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm22, %xmm24
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm22, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm24[0],xmm3[0],xmm24[1],xmm3[1],xmm24[2],xmm3[2],xmm24[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 176(%rdi), %xmm24
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5,6],ymm1[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm27, %xmm24, %xmm3
; AVX512BW-SLOW-NEXT:    vpshufb %xmm27, %xmm7, %xmm25
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm25[0],xmm3[0],xmm25[1],xmm3[1],xmm25[2],xmm3[2],xmm25[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 128(%rdi), %xmm25
; AVX512BW-SLOW-NEXT:    vmovdqa64 144(%rdi), %xmm23
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm23, %xmm0
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm23, %xmm27
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm23, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm25, %xmm30
...
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm10, %xmm12
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm13, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm17, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm10
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm18, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0,1,2],xmm1[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm8, %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm19, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm23
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm11, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm14, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm26, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm17 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm17, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm30[0],xmm15[0],xmm30[1],xmm15[1],xmm30[2],xmm15[2],xmm30[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm30 = [2,10,2,10,2,10,2,10,2,10,2,10,2,10,2,10]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm8
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm21, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm21, %xmm0
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm20, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm28[0],xmm0[0],xmm28[1],xmm0[1],xmm28[2],xmm0[2],xmm28[3],xmm0[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3,4],ymm15[5],ymm0[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm2[6,7]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm9, %xmm19
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm9, %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm6, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm15[0],xmm2[0],xmm15[1],xmm2[1],xmm15[2],xmm2[2],xmm15[3],xmm2[3]
; AVX512BW-SLOW-NEXT:    vmovdqa (%rsp), %xmm9 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm31, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm31, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm2 = xmm15[0,1,2],xmm2[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm16, %zmm6
; AVX512BW-SLOW-NEXT:    vpsrlq $16, %zmm16, %zmm15
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm15, %xmm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm2 = xmm15[0,1],xmm2[2,3]
; AVX512BW-SLOW-NEXT:    vinserti32x4 $2, %xmm2, %zmm0, %zmm2
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm2 {%k1}
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm21 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm21, %xmm0
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm16 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm16, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm15[0],xmm0[0],xmm15[1],xmm0[1],xmm15[2],xmm0[2],xmm15[3],xmm0[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm29, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm22, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm15[0,1,2,3,4,5,6],ymm0[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm24, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm7, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm4[0],xmm15[0],xmm4[1],xmm15[1],xmm4[2],xmm15[2],xmm4[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm27, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm30, %xmm25, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm15[0,1,2,3,4],ymm4[5],ymm15[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm4[0,1,2,3,4,5],ymm0[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm12, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm13, %xmm1
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm1[0],xmm4[0],xmm1[1],xmm4[1],xmm1[2],xmm4[2],xmm1[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm10, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm10, %xmm27
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm18, %xmm3
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm22, %xmm1
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm23, %xmm10
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm23, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm23, %xmm2
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm3
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm14, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5,6],ymm1[7]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm17, %xmm28
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm11
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm28[0],xmm4[0],xmm28[1],xmm4[1],xmm28[2],xmm4[2],xmm28[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm28 = [3,11,3,11,3,11,3,11,3,11,3,11,3,11,3,11]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm8, %xmm30
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm20, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm15[0],xmm30[0],xmm15[1],xmm30[1],xmm15[2],xmm30[2],xmm15[3],xmm30[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm15[0,1,2,3,4],ymm4[5],ymm15[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm4[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm19, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm5, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm9, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm31, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm30[0],xmm15[0],xmm30[1],xmm15[1],xmm30[2],xmm15[2],xmm30[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm15[0,1,2],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpsrlq $24, %zmm6, %zmm15
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm6, %zmm23
; AVX512BW-SLOW-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm15, %xmm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm15[0,1],xmm4[2,3]
; AVX512BW-SLOW-NEXT:    vinserti32x4 $2, %xmm4, %zmm0, %zmm4
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm4 {%k1}
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm12
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm21, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm16, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm15[0],xmm1[0],xmm15[1],xmm1[1],xmm15[2],xmm1[2],xmm15[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm29, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm29, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm8, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm30[0],xmm15[0],xmm30[1],xmm15[1],xmm30[2],xmm15[2],xmm30[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm15[0,1,2,3,4,5,6],ymm1[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm24, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm7, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm15[0],xmm3[1],xmm15[1],xmm3[2],xmm15[2],xmm3[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm31 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm31, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm25, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm3 = ymm15[0,1,2,3,4],ymm3[5],ymm15[6,7]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm13, %xmm0
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm27, %xmm3
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm18, %xmm2
...
; AVX512BW-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm21 # 64-byte Reload
; AVX512BW-SLOW-NEXT:    vpsrlq $24, %zmm21, %zmm2
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
...
; AVX512BW-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm0 = [4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm22, %xmm6
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm22, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm10, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm27, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm14, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm26, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm11, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm28 = [4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12]
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm10, %xmm30
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm20, %xmm2
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm20, %xmm26
...
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm0, %ymm15
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1,2,3,4],ymm15[5],ymm2[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm19, %xmm2
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm20
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm5, %xmm7
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm5, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm15[0],xmm2[0],xmm15[1],xmm2[1],xmm15[2],xmm2[2],xmm15[3],xmm2[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm9, %xmm11
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm9, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm30[0],xmm15[0],xmm30[1],xmm15[1],xmm30[2],xmm15[2],xmm30[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm2 = xmm15[0,1,2],xmm2[3]
; AVX512BW-SLOW-NEXT:    vpsrlq $32, %zmm23, %zmm15
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm15, %xmm15
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm2 = xmm15[0,1],xmm2[2,3]
; AVX512BW-SLOW-NEXT:    vinserti32x4 $2, %xmm2, %zmm0, %zmm2
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm2 {%k1}
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm12, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm16, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm15[0],xmm1[0],xmm15[1],xmm1[1],xmm15[2],xmm1[2],xmm15[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm29, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm8, %xmm23
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm24, %xmm15
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm8, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm4[0],xmm15[0],xmm4[1],xmm15[1],xmm4[2],xmm15[2],xmm4[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm31, %xmm29
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm31, %xmm15
; AVX512BW-SLOW-NEXT:    vpshufb %xmm28, %xmm25, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm28[0],xmm15[0],xmm28[1],xmm15[1],xmm28[2],xmm15[2],xmm28[3],xmm15[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
...
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm15[0,1,2,3,4],ymm4[5],ymm15[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm4[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm17, %xmm22
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm17, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm13, %xmm0
...
; AVX512BW-SLOW-NEXT:    vpsrlq $32, %zmm21, %zmm3
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm3, %xmm3
...
; AVX512BW-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm0 = [5,13,5,13,5,13,5,13,5,13,5,13,5,13,5,13]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm6, %xmm1
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm31 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm31, %xmm2
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm6, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm19 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm19, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm15 = [5,13,5,13,5,13,5,13,5,13,5,13,5,13,5,13]
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm10, %xmm17
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm10, %xmm28
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm26, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm28 = xmm30[0],xmm28[0],xmm30[1],xmm28[1],xmm30[2],xmm28[2],xmm30[3],xmm28[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vinserti32x4 $1, %xmm28, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm4 = ymm5[0,1,2,3,4],ymm4[5],ymm5[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm4[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm20, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm20, %xmm26
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm20, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm7, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm7, %xmm10
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm9, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm28[0],xmm5[0],xmm28[1],xmm5[1],xmm28[2],xmm5[2],xmm28[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm5[0,1,2],xmm4[3]
; AVX512BW-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm13 # 64-byte Reload
; AVX512BW-SLOW-NEXT:    vpsrlq $40, %zmm13, %zmm5
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm5, %xmm5
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm4 = xmm5[0,1],xmm4[2,3]
; AVX512BW-SLOW-NEXT:    vinserti32x4 $2, %xmm4, %zmm0, %zmm4
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm4 {%k1}
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{[-0-9]+}}(%r{{[sb]}}p), %xmm27 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm27, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm16, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm16, %xmm20
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm5[0],xmm1[0],xmm5[1],xmm1[1],xmm5[2],xmm1[2],xmm5[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm23, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm28[0],xmm5[0],xmm28[1],xmm5[1],xmm28[2],xmm5[2],xmm28[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm5[0,1,2,3,4,5,6],ymm1[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm24, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm8, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm8, %xmm7
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm5[0],xmm3[1],xmm5[1],xmm3[2],xmm5[2],xmm3[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm29, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm25, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm3
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm3 = ymm5[0,1,2,3,4],ymm3[5],ymm5[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm22, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm14, %xmm0
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vmovdqa %xmm12, %xmm8
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm12, %xmm3
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm18, %xmm2
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1,2],xmm0[3]
; AVX512BW-SLOW-NEXT:    vpsrlq $40, %zmm21, %zmm2
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm0[2,3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $0, %ymm0, %zmm4, %zmm0
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm29, %xmm5
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm4[0,1,2,3,4,5,6],ymm1[7]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm4 = [6,14,6,14,6,14,6,14,6,14,6,14,6,14,6,14]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm6, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm21
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm19, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm15 = [6,14,6,14,6,14,6,14,6,14,6,14,6,14,6,14]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm17, %xmm28
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm12, %xmm30
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm28 = xmm30[0],xmm28[0],xmm30[1],xmm28[1],xmm30[2],xmm28[2],xmm30[3],xmm28[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vinserti32x4 $1, %xmm28, %ymm0, %ymm3
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1,2,3,4],ymm5[5],ymm3[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm3[0,1,2,3,4,5],ymm1[6,7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm26, %xmm3
...
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%rsp), %xmm30 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm30, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm9, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm28[0],xmm5[0],xmm28[1],xmm5[1],xmm28[2],xmm5[2],xmm28[3],xmm5[3]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm27, %xmm1
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm20, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm20, %xmm26
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm5[0],xmm1[0],xmm5[1],xmm1[1],xmm5[2],xmm1[2],xmm5[3],xmm1[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm11, %xmm5
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm11, %xmm20
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm23, %xmm28
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm28[0],xmm5[0],xmm28[1],xmm5[1],xmm28[2],xmm5[2],xmm28[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm5[0,1,2,3,4,5,6],ymm1[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm24, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm7, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm9, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm15, %xmm25, %xmm15
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm28, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm14, %xmm0
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm4[0],xmm0[1],xmm4[1],xmm0[2],xmm4[2],xmm0[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm8, %xmm4
; AVX512BW-SLOW-NEXT:    vmovdqa64 %xmm8, %xmm19
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm18, %xmm2
...
; AVX512BW-SLOW-NEXT:    vpsrlq $48, %zmm15, %zmm2
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm2, %xmm2
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm0 = xmm2[0,1],xmm0[2,3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm22, %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm31, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm3 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm16, %xmm4
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm29, %xmm5
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm4
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm4[0,1,2,3,4,5,6],ymm2[7]
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm6, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm21, %xmm6
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vpbroadcastw {{.*#+}} xmm6 = [7,15,7,15,7,15,7,15,7,15,7,15,7,15,7,15]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm6, %xmm17, %xmm8
; AVX512BW-SLOW-NEXT:    vpshufb %xmm6, %xmm12, %xmm11
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm11[0],xmm8[0],xmm11[1],xmm8[1],xmm11[2],xmm8[2],xmm11[3],xmm8[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm5
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm8, %ymm0, %ymm8
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm5 = ymm8[0,1,2,3,4],ymm5[5],ymm8[6,7]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm5[0,1,2,3,4,5],ymm2[6,7]
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm5, %xmm5
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm10, %xmm8
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm8[0],xmm5[0],xmm8[1],xmm5[1],xmm8[2],xmm5[2],xmm8[3],xmm5[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm30, %xmm8
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm7, %xmm7
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm27, %xmm2
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm26, %xmm7
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm7[0],xmm2[0],xmm7[1],xmm2[1],xmm7[2],xmm2[2],xmm7[3],xmm2[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm20, %xmm7
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm23, %xmm8
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm2
; AVX512BW-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm0, %ymm7
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm2 = ymm7[0,1,2,3,4,5,6],ymm2[7]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm24, %xmm7
; AVX512BW-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb %xmm4, %xmm8, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm4[0],xmm7[0],xmm4[1],xmm7[1],xmm4[2],xmm7[2],xmm4[3],xmm7[3]
; AVX512BW-SLOW-NEXT:    vpshufb %xmm6, %xmm9, %xmm7
; AVX512BW-SLOW-NEXT:    vpshufb %xmm6, %xmm25, %xmm6
...
; AVX512BW-SLOW-NEXT:    vpshufb %xmm1, %xmm28, %xmm4
...
; AVX512BW-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm3[0],xmm4[0],xmm3[1],xmm4[1],xmm3[2],xmm4[2],xmm3[3],xmm4[3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0,1,2],xmm1[3]
; AVX512BW-SLOW-NEXT:    vpsrlq $56, %zmm15, %zmm3
; AVX512BW-SLOW-NEXT:    vpmovqb %zmm3, %xmm3
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0,1],xmm1[2,3]
; AVX512BW-SLOW-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5,6,7]
...
; AVX512BW-SLOW-NEXT:    addq $728, %rsp # imm = 0x2D8
; AVX512BW-SLOW-NEXT:    vzeroupper
; AVX512BW-SLOW-NEXT:    retq
;
...
; AVX512BW-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm25 = [0,8,0,8,0,8,0,8,0,8,0,8,0,8,0,8]
; AVX512BW-FAST-NEXT:    vmovdqa64 336(%rdi), %xmm18
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm18, %xmm5
; AVX512BW-FAST-NEXT:    vmovdqa 320(%rdi), %xmm12
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm12, %xmm6
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm11, %ymm16, %ymm1
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm10, %ymm1, %ymm8
...
; AVX512BW-FAST-NEXT:    vmovdqa64 112(%rdi), %xmm29
; AVX512BW-FAST-NEXT:    vpshufb %xmm7, %xmm29, %xmm8
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm22, %xmm26
; AVX512BW-FAST-NEXT:    vmovdqa 64(%rdi), %xmm8
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm8, %xmm25
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm25[0],xmm26[0],xmm25[1],xmm26[1],xmm25[2],xmm26[2],xmm25[3],xmm26[3]
...
; AVX512BW-FAST-NEXT:    vmovdqa %ymm9, %ymm5
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm13[0,1,2,3,4,5,6],ymm0[7]
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm9 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512BW-FAST-NEXT:    vpshufb %ymm9, %ymm17, %ymm13
; AVX512BW-FAST-NEXT:    vmovdqa64 %ymm9, %ymm24
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm9 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512BW-FAST-NEXT:    vpshufb %ymm9, %ymm14, %ymm15
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm19, %xmm25
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm25[0],xmm15[0],xmm25[1],xmm15[1],xmm25[2],xmm15[2],xmm25[3],xmm15[3]
; AVX512BW-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm25 = [1,9,1,9,1,9,1,9,1,9,1,9,1,9,1,9]
; AVX512BW-FAST-NEXT:    vmovdqa64 %xmm18, %xmm6
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm18, %xmm26
; AVX512BW-FAST-NEXT:    vmovdqa %xmm12, %xmm7
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm12, %xmm21
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm11, %ymm16, %ymm0
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm3, %ymm15
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm15[0,1,2,3,4,5,6],ymm0[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm24, %ymm2, %ymm15
; AVX512BW-FAST-NEXT:    vpshufb %ymm9, %ymm1, %ymm11
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm29, %xmm11
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm22, %xmm13
; AVX512BW-FAST-NEXT:    vpshufb %xmm25, %xmm8, %xmm15
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm6, %xmm15
; AVX512BW-FAST-NEXT:    vmovdqa64 %xmm6, %xmm25
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm7, %xmm21
; AVX512BW-FAST-NEXT:    vmovdqa64 %xmm7, %xmm26
...
; AVX512BW-FAST-NEXT:    vinserti32x4 $2, %xmm12, %zmm0, %zmm12
; AVX512BW-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm12 {%k1}
; AVX512BW-FAST-NEXT:    vpshufb %ymm18, %ymm16, %ymm0
; AVX512BW-FAST-NEXT:    vpshufb %ymm24, %ymm3, %ymm15
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm15[0,1,2,3,4,5,6],ymm0[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm9, %ymm2, %ymm15
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm1, %ymm9
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm11, %xmm29, %xmm9
...
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm5 = [3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15,3,7,11,15]
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm31, %ymm9
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm31, %ymm17, %ymm9
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm20, %xmm11
; AVX512BW-FAST-NEXT:    vmovdqa64 %xmm19, %xmm24
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm19, %xmm12
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm12, %xmm25, %xmm14
; AVX512BW-FAST-NEXT:    vpshufb %xmm12, %xmm7, %xmm15
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm29, %xmm1
; AVX512BW-FAST-NEXT:    vpshufb %xmm9, %xmm23, %xmm2
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm5 = [0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12]
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm2, %ymm11
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm21, %xmm25, %xmm15
; AVX512BW-FAST-NEXT:    vpshufb %xmm21, %xmm7, %xmm28
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm15, %ymm3
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm21, %xmm8, %xmm13
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} xmm9 = xmm11[0,1,2],xmm9[3]
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm6, %ymm0, %ymm9
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm4 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512BW-FAST-NEXT:    vpshufb %ymm4, %ymm1, %ymm11
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm11[0,1,2,3,4,5,6],ymm9[7]
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm5 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm2, %ymm11
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm7 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512BW-FAST-NEXT:    vpshufb %ymm7, %ymm14, %ymm12
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm11 = ymm12[0,1,2,3,4],ymm11[5],ymm12[6,7]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm11[0,1,2,3,4,5],ymm9[6,7]
...
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3]
; AVX512BW-FAST-NEXT:    vpbroadcastw {{.*#+}} xmm13 = [5,13,5,13,5,13,5,13,5,13,5,13,5,13,5,13]
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm25, %xmm21
; AVX512BW-FAST-NEXT:    vpshufb %xmm13, %xmm26, %xmm27
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm6, %ymm19, %ymm9
; AVX512BW-FAST-NEXT:    vpshufb %ymm4, %ymm18, %ymm12
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm12[0,1,2,3,4,5,6],ymm9[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm15, %ymm12
; AVX512BW-FAST-NEXT:    vpshufb %ymm7, %ymm20, %ymm4
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm6, %ymm2, %ymm4
; AVX512BW-FAST-NEXT:    vpbroadcastd {{.*#+}} ymm7 = [2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14,2,6,10,14]
; AVX512BW-FAST-NEXT:    vpshufb %ymm7, %ymm14, %ymm9
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm11, %xmm25, %xmm12
; AVX512BW-FAST-NEXT:    vpshufb %xmm11, %xmm26, %xmm13
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3]
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm19, %ymm3
; AVX512BW-FAST-NEXT:    vpshufb %ymm17, %ymm18, %ymm12
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm3 = ymm12[0,1,2,3,4,5,6],ymm3[7]
; AVX512BW-FAST-NEXT:    vpshufb %ymm6, %ymm15, %ymm12
; AVX512BW-FAST-NEXT:    vpshufb %ymm7, %ymm20, %ymm13
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm4, %xmm29, %xmm12
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm6, %ymm1, %ymm1
...
; AVX512BW-FAST-NEXT:    vpshufb %xmm4, %xmm25, %xmm9
; AVX512BW-FAST-NEXT:    vpshufb %xmm4, %xmm26, %xmm11
; AVX512BW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm11[0],xmm9[0],xmm11[1],xmm9[1],xmm11[2],xmm9[2],xmm11[3],xmm9[3]
...
; AVX512BW-FAST-NEXT:    vpshufb %ymm5, %ymm19, %ymm0
...
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm9 = ymm11[0,1,2,3,4],ymm9[5],ymm11[6,7]
; AVX512BW-FAST-NEXT:    vpblendd {{.*#+}} ymm0 = ymm9[0,1,2,3,4,5],ymm0[6,7]
; AVX512BW-FAST-NEXT:    vpshufb %xmm1, %xmm29, %xmm5
