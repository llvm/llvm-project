...
; AVX512-NEXT:    retq
  ...
  %in.vec2 = load <2 x i8>, ptr %in.vecptr2, align 32
  ...
  store <6 x i8> %interleaved.vec, ptr %out.vec, align 32
...
; AVX512-NEXT:    retq
  ...
  %in.vec2 = load <4 x i8>, ptr %in.vecptr2, align 32
  ...
  store <12 x i8> %interleaved.vec, ptr %out.vec, align 32
...
; AVX512-NEXT:    retq
  ...
  %in.vec2 = load <8 x i8>, ptr %in.vecptr2, align 32
  ...
  store <24 x i8> %interleaved.vec, ptr %out.vec, align 32
...
; AVX512-NEXT:    retq
  ...
  %in.vec2 = load <16 x i8>, ptr %in.vecptr2, align 32
  ...
  store <48 x i8> %interleaved.vec, ptr %out.vec, align 32
...
; AVX512-NEXT:    retq
  ...
  %in.vec2 = load <32 x i8>, ptr %in.vecptr2, align 32
  ...
  store <96 x i8> %interleaved.vec, ptr %out.vec, align 32
