...
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[3,3],xmm11[3,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[3,3],xmm8[3,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm6[3,3,3,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm3[2,3,2,3]
; SSE-NEXT:    movss {{.*#+}} xmm10 = xmm13[0],xmm10[1,2,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[3,0],xmm8[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[1,1],xmm13[1,1]
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[1,1],xmm4[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,2],xmm0[0,1]
; SSE-NEXT:    movdqa %xmm7, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,1],xmm4[2,3]
; SSE-NEXT:    punpckhqdq {{.*#+}} xmm15 = xmm15[1],xmm8[1]
...
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm9[0,1]
; SSE-NEXT:    movdqa %xmm0, %xmm9
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,1],xmm1[2,3]
; SSE-NEXT:    punpckhqdq {{.*#+}} xmm6 = xmm6[1],xmm14[1]
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[2,0],xmm9[2,0]
; SSE-NEXT:    movaps (%rsp), %xmm9 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Folded Reload
; SSE-NEXT:    # xmm9 = xmm9[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[0,1],xmm9[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm12 = xmm9[0],xmm12[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Folded Reload
; SSE-NEXT:    # xmm9 = xmm9[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm9[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm7 = xmm9[0],xmm7[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Folded Reload
; SSE-NEXT:    # xmm9 = xmm9[1,1],mem[1,1]
...
; SSE-NEXT:    movaps %xmm6, 288(%r9)
; SSE-NEXT:    movaps %xmm4, 272(%r9)
; SSE-NEXT:    movdqa %xmm2, 240(%r9)
; SSE-NEXT:    movaps %xmm5, 208(%r9)
; SSE-NEXT:    movaps %xmm11, 192(%r9)
; SSE-NEXT:    movdqa %xmm8, 160(%r9)
; SSE-NEXT:    movaps %xmm15, 128(%r9)
; SSE-NEXT:    movaps %xmm13, 112(%r9)
...
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm1 = zero,xmm10[1],xmm6[1],zero
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5,6],ymm7[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%r8), %ymm5, %ymm5
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0],ymm1[1,2,3],ymm5[4],ymm1[5,6,7]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm15[0],ymm5[1,2,3],ymm15[4],ymm5[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm6[0],ymm10[1],ymm6[2,3,4,5],ymm10[6],ymm6[7]
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm7[1,1],ymm3[1,1],ymm7[5,5],ymm3[5,5]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[3,3],ymm2[3,3],ymm4[7,7],ymm2[7,7]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm14[1,1],ymm13[1,1],ymm14[5,5],ymm13[5,5]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm2[1,2,3,4],ymm0[5],ymm2[6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm4[3,0,2,3,7,4,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4],ymm2[5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm7[0,1,3,0,4,5,7,4]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm6[1,0,2,2]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1,2,3],ymm2[4,5],ymm3[6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],ymm12[3],ymm2[4,5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm15[3,0,2,3,7,4,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm5[4],ymm3[5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm14[0,1,3,0,4,5,7,4]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm7 = ymm13[1,0,2,2]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1],ymm4[2],ymm7[3,4,5,6],ymm4[7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1,2,3],ymm3[4,5],ymm4[6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1,2],ymm1[3],ymm3[4,5,6,7]
...
; AVX2-SLOW-NEXT:    vmovaps 32(%rcx), %ymm8
; AVX2-SLOW-NEXT:    vmovaps (%r8), %ymm0
...
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm4 = ymm15[0,1],ymm4[2,3],ymm15[4,5],ymm4[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm15 = ymm0[0,1,2,1]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm15[1],ymm4[2,3,4,5],ymm15[6],ymm4[7]
; AVX2-SLOW-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm13 = ymm7[0,1,2,1]
...
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm12 = ymm8[1,1,1,1,5,5,5,5]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm5[1],ymm12[2,3,4],ymm5[5],ymm12[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm13 = ymm6[1,1,2,2,5,5,6,6]
...
; AVX2-SLOW-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm6[2],ymm3[2],ymm6[3],ymm3[3],ymm6[6],ymm3[6],ymm6[7],ymm3[7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[3,3,3,3]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm14 = ymm8[0,2,3,3,4,6,7,7]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm15 = ymm5[2,3,2,3,6,7,6,7]
...
; AVX2-SLOW-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm0[2],ymm15[2],ymm0[3],ymm15[3],ymm0[6],ymm15[6],ymm0[7],ymm15[7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[3,3,3,3]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,1,3,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm4 = ymm14[0,1,2],ymm4[3,4],ymm14[5,6,7]
; AVX2-SLOW-NEXT:    vbroadcastsd 24(%r8), %ymm14
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm14[2],ymm4[3,4,5,6],ymm14[7]
...
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[3,0,2,3,7,4,6,7]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm3 = ymm6[0,1,2,3],ymm3[4],ymm6[5,6,7]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm6 = ymm8[0,1,3,0,4,5,7,4]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[2,3,0,1,6,7,4,5]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm6[2],ymm5[3,4,5,6],ymm6[7]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2,3],ymm3[4,5],ymm5[6,7]
...
; AVX2-FAST-NEXT:    vmovaps (%rcx), %xmm13
; AVX2-FAST-NEXT:    vmovaps 32(%rcx), %xmm15
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm5 = xmm13[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm11[2],xmm5[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1],ymm2[2,3],ymm5[4,5],ymm2[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm5[1],ymm2[2,3,4,5],ymm5[6],ymm2[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm7 = ymm1[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0],ymm7[1],ymm5[2,3,4,5],ymm7[6],ymm5[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps 32(%rdx), %ymm7
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm11[0],xmm13[0],xmm11[1],xmm13[1]
...
; AVX2-FAST-NEXT:    vpermps %ymm6, %ymm0, %ymm8
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm11[2,3],ymm8[4,5,6],ymm11[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm13 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm3[1,2],ymm13[3,4],ymm3[5,6],ymm13[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm2 = ymm7[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm13[1,2],ymm2[3,4],ymm13[5,6],ymm2[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],ymm13[3,4],ymm2[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 56(%r8), %ymm13
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm13 = ymm2[0,1],ymm13[2],ymm2[3,4,5,6],ymm13[7]
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX2-FAST-NEXT:    vpermps %ymm2, %ymm12, %ymm2
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm2[2,3],ymm0[4,5,6],ymm2[7]
; AVX2-FAST-NEXT:    vinsertf128 $1, 32(%r8), %ymm9, %ymm2
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm2[0],ymm0[1,2,3],ymm2[4],ymm0[5,6,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm0 = ymm10[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm2 = ymm12[2,3,2,3,6,7,6,7]
...
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm14[2],ymm2[2],ymm14[3],ymm2[3],ymm14[6],ymm2[6],ymm14[7],ymm2[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm5 = ymm14[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm2[1,2],ymm5[3,4],ymm2[5,6],ymm5[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm4 = ymm11[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[2,3,0,1,6,7,4,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1],ymm4[2],ymm7[3,4,5,6],ymm4[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm14[3,0,2,3,7,4,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1,2,3],ymm2[4],ymm3[5,6,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm10[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm4 = ymm12[2,3,0,1,6,7,4,5]
...
; AVX2-FAST-PERLANE-NEXT:    vmovaps 32(%rcx), %ymm8
; AVX2-FAST-PERLANE-NEXT:    vmovaps (%r8), %ymm0
...
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm4 = ymm15[0,1],ymm4[2,3],ymm15[4,5],ymm4[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm15 = ymm0[0,1,2,1]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm15[1],ymm4[2,3,4,5],ymm15[6],ymm4[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm13 = ymm7[0,1,2,1]
...
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm12 = ymm8[1,1,1,1,5,5,5,5]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm5[1],ymm12[2,3,4],ymm5[5],ymm12[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm13 = ymm6[1,1,2,2,5,5,6,6]
...
; AVX2-FAST-PERLANE-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm6[2],ymm3[2],ymm6[3],ymm3[3],ymm6[6],ymm3[6],ymm6[7],ymm3[7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[3,3,3,3]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm14 = ymm8[0,2,3,3,4,6,7,7]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm15 = ymm5[2,3,2,3,6,7,6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm0[2],ymm15[2],ymm0[3],ymm15[3],ymm0[6],ymm15[6],ymm0[7],ymm15[7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[3,3,3,3]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,1,3,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm4 = ymm14[0,1,2],ymm4[3,4],ymm14[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vbroadcastsd 24(%r8), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm14[2],ymm4[3,4,5,6],ymm14[7]
...
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[3,0,2,3,7,4,6,7]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm3 = ymm6[0,1,2,3],ymm3[4],ymm6[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm6 = ymm8[0,1,3,0,4,5,7,4]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[2,3,0,1,6,7,4,5]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm6[2],ymm5[3,4,5,6],ymm6[7]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2,3],ymm3[4,5],ymm5[6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[1,1],xmm15[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm0[0,1]
; SSE-NEXT:    movaps %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movdqa %xmm2, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,0],xmm15[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,1],xmm14[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm0[0,1]
...
; SSE-NEXT:    movaps %xmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[1,1],xmm12[1,1]
...
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm14[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm0 = xmm14[0],xmm0[1,2,3]
; SSE-NEXT:    movaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps %xmm9, 416(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 384(%r9)
; SSE-NEXT:    movaps %xmm11, 336(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 304(%r9)
; SSE-NEXT:    movaps %xmm15, 256(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 224(%r9)
; SSE-NEXT:    movaps %xmm14, 176(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 144(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 96(%r9)
...
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm0 = zero,xmm9[1],xmm8[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm1 = xmm9[0],xmm8[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vmovaps (%rdx), %xmm6
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %xmm14
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm3 = xmm14[0],xmm6[0]
...
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm0 = zero,xmm4[1],xmm2[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm1 = xmm4[0],xmm2[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 32(%rdx), %xmm3
; AVX1-ONLY-NEXT:    vmovaps %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %xmm7
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm7[0],xmm3[0]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm5 = xmm5[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 36(%rdx), %xmm10
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm10, %ymm5, %ymm5
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm5[2,3],ymm0[4,5,6],ymm5[7]
...
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm5[0],xmm10[0]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 68(%rdx), %xmm12
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm11
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm12 = zero,xmm1[1],xmm3[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm13 = xmm1[0],xmm3[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm13, %ymm12
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0,1],ymm11[2,3],ymm12[4,5,6],ymm11[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 64(%r8), %ymm13, %ymm12
...
; AVX1-ONLY-NEXT:    vmovaps 96(%rcx), %xmm11
; AVX1-ONLY-NEXT:    vmovaps %xmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm11[0],xmm0[0]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 100(%rdx), %xmm12
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm11
; AVX1-ONLY-NEXT:    vmovaps 96(%rsi), %xmm12
; AVX1-ONLY-NEXT:    vmovaps 96(%rdi), %xmm13
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm15 = zero,xmm13[1],xmm12[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm0 = xmm13[0],xmm12[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm15, %ymm0, %ymm15
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm15[0,1],ymm11[2,3],ymm15[4,5,6],ymm11[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%r8), %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm11[1,2,3],ymm0[4],ymm11[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm6[2],xmm14[2],xmm6[3],xmm14[3]
; AVX1-ONLY-NEXT:    vbroadcastss 4(%rcx), %xmm6
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm6, %ymm0
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm6 = zero,zero,xmm9[2],xmm8[2]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm6, %ymm6
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm6[2,3],ymm0[4,5],ymm6[6,7]
; AVX1-ONLY-NEXT:    vbroadcastf128 {{.*#+}} ymm6 = mem[0,1,0,1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm6[1],ymm0[2,3,4,5],ymm6[6],ymm0[7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 16(%rsi), %xmm0
; AVX1-ONLY-NEXT:    vmovaps 16(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm8 = zero,zero,xmm6[2],xmm0[2]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm0 = xmm6[1,1],xmm0[1,1]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[1,1],ymm15[1,1],ymm6[5,5],ymm15[5,5]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm6[3,4],ymm0[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps 16(%rcx), %xmm6
; AVX1-ONLY-NEXT:    vmovaps 16(%rdx), %xmm8
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm9 = xmm8[3,3],xmm6[3,3]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm6, %ymm6
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[3,3],ymm8[3,3],ymm9[7,7],ymm8[7,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm8[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm8[3,4],ymm6[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps (%r8), %ymm8
; AVX1-ONLY-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm8[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm8[0],ymm0[1,2,3,4],ymm8[5],ymm0[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm6[0,1],ymm8[2],ymm6[3,4,5,6],ymm8[7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm7[2],xmm0[3],xmm7[3]
; AVX1-ONLY-NEXT:    vbroadcastss 36(%rcx), %xmm6
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm6, %ymm0
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm2 = zero,zero,xmm4[2],xmm2[2]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm4[1,1],ymm2[1,1],ymm4[5,5],ymm2[5,5]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm6 = xmm4[3,3],xmm2[3,3]
...
; AVX1-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rsi), %ymm11
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm11[3,3],ymm4[3,3],ymm11[7,7],ymm4[7,7]
...
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1],ymm4[2],ymm2[3,4,5,6],ymm4[7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm10[2],xmm5[2],xmm10[3],xmm5[3]
; AVX1-ONLY-NEXT:    vbroadcastss 68(%rcx), %xmm2
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm2, %ymm0
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm2 = zero,zero,xmm1[2],xmm3[2]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm8[1,1],ymm9[1,1],ymm8[5,5],ymm9[5,5]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps 64(%rsi), %ymm10
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm10[3,3],ymm7[3,3],ymm10[7,7],ymm7[7,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm1[0,1,2],ymm3[3,4],ymm1[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps 64(%r8), %ymm5
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm5[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm2[1,2,3,4],ymm14[5],ymm2[6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1],ymm14[2],ymm3[3,4,5,6],ymm14[7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vunpckhps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm2 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm2 = xmm0[2],mem[2],xmm0[3],mem[3]
; AVX1-ONLY-NEXT:    vbroadcastss 100(%rcx), %xmm3
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm3, %ymm2
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm3 = zero,zero,xmm13[2],xmm12[2]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0],ymm3[1],ymm2[2,3,4,5],ymm3[6],ymm2[7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 112(%rsi), %xmm2
; AVX1-ONLY-NEXT:    vmovaps 112(%rdi), %xmm3
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm12 = zero,zero,xmm3[2],xmm2[2]
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm2[0,1,2],ymm3[3,4],ymm2[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps 112(%rcx), %xmm3
; AVX1-ONLY-NEXT:    vmovaps 112(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm3[3,3]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX1-ONLY-NEXT:    vmovaps 96(%rsi), %ymm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm3[3,3],ymm1[3,3],ymm3[7,7],ymm1[7,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm0[0,1,2],ymm14[3,4],ymm0[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps 96(%r8), %ymm4
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm4[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm2[0],ymm6[1,2,3,4],ymm2[5],ymm6[6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm14[0,1],ymm2[2],ymm14[3,4,5,6],ymm2[7]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[3,0,2,3,7,4,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm10[0,1,2,3],ymm7[4],ymm10[5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[0,1,3,0,4,5,7,4]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm5 = ymm7[0,1,2],ymm5[3],ymm7[4,5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[3,0,2,3,7,4,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1,2,3],ymm1[4],ymm3[5,6,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm13[0,1,3,0,4,5,7,4]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm7 = ymm12[1,0,2,2]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm7[0,1],ymm3[2],ymm7[3,4,5,6],ymm3[7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2,3],ymm1[4,5],ymm3[6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm4[3],ymm1[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovaps %ymm1, 544(%r9)
; AVX1-ONLY-NEXT:    vmovaps %ymm5, 384(%r9)
; AVX1-ONLY-NEXT:    vmovaps %ymm11, 224(%r9)
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 64(%r9)
; AVX1-ONLY-NEXT:    vmovaps %ymm2, 608(%r9)
; AVX1-ONLY-NEXT:    vmovaps %ymm6, 576(%r9)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-SLOW-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[0,1,2,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[0,0,2,1]
; AVX2-SLOW-NEXT:    vmovaps (%rsi), %xmm8
; AVX2-SLOW-NEXT:    vmovaps 32(%rsi), %xmm9
; AVX2-SLOW-NEXT:    vmovaps 64(%rsi), %xmm2
; AVX2-SLOW-NEXT:    vmovaps (%rdi), %xmm10
; AVX2-SLOW-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm10[0],xmm8[0],xmm10[1],xmm8[1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,3,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm12 = ymm11[0,1,1,1]
...
; AVX2-SLOW-NEXT:    vunpckhps {{.*#+}} xmm8 = xmm10[2],xmm8[2],xmm10[3],xmm8[3]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[0,1,2,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,0,2,1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} xmm6 = xmm6[0,1],xmm7[2],xmm6[3]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,1,1,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm8[2,3],ymm6[4,5],ymm8[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm7 = ymm15[0,1,2,1]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm7[1],ymm6[2,3,4,5],ymm7[6],ymm6[7]
; AVX2-SLOW-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-SLOW-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm12[0],xmm9[0],xmm12[1],xmm9[1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,3,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm8 = ymm7[0,1,1,1]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm6 = ymm8[0,1],ymm6[2,3],ymm8[4,5,6],ymm6[7]
; AVX2-SLOW-NEXT:    vinsertf128 $1, 32(%r8), %ymm7, %ymm7
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2,3],ymm7[4],ymm6[5,6,7]
; AVX2-SLOW-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm12[2],xmm9[2],xmm12[3],xmm9[3]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
...
; AVX2-FAST-NEXT:    vmovaps (%r8), %ymm12
...
; AVX2-FAST-NEXT:    vmovaps (%rsi), %xmm5
; AVX2-FAST-NEXT:    vmovaps 32(%rsi), %xmm14
; AVX2-FAST-NEXT:    vmovaps 64(%rsi), %xmm4
; AVX2-FAST-NEXT:    vmovaps %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vmovaps (%rdi), %xmm6
; AVX2-FAST-NEXT:    vmovaps 32(%rdi), %xmm1
; AVX2-FAST-NEXT:    vmovaps 64(%rdi), %xmm15
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm6[2],xmm5[2],xmm6[3],xmm5[3]
; AVX2-FAST-NEXT:    vmovaps {{.*#+}} ymm11 = <0,1,0,1,u,u,2,2>
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm11, %ymm0
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm9 = xmm8[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm9 = xmm9[0,1],xmm7[2],xmm9[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm12[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm9[1],ymm0[2,3,4,5],ymm9[6],ymm0[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm1[2],xmm14[2],xmm1[3],xmm14[3]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm11, %ymm0
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm9 = xmm3[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm9 = xmm9[0,1],xmm2[2],xmm9[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm10[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm9[1],ymm0[2,3,4,5],ymm9[6],ymm0[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm11, %ymm9
; AVX2-FAST-NEXT:    vmovaps 64(%rdx), %xmm12
; AVX2-FAST-NEXT:    vmovaps 64(%rcx), %xmm4
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm10 = xmm4[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm10 = xmm10[0,1],xmm12[2],xmm10[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1],ymm9[2,3],ymm10[4,5],ymm9[6,7]
; AVX2-FAST-NEXT:    vmovaps 64(%r8), %ymm10
; AVX2-FAST-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm10[1],ymm9[2,3,4,5],ymm10[6],ymm9[7]
; AVX2-FAST-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps 96(%rsi), %xmm10
...
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm9 = xmm9[2],xmm10[2],xmm9[3],xmm10[3]
; AVX2-FAST-NEXT:    vpermps %ymm9, %ymm11, %ymm9
; AVX2-FAST-NEXT:    vmovaps 96(%rdx), %xmm13
; AVX2-FAST-NEXT:    vmovaps %xmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vmovaps 96(%rcx), %xmm0
; AVX2-FAST-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm10 = xmm0[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm10 = xmm10[0,1],xmm13[2],xmm10[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1],ymm9[2,3],ymm10[4,5],ymm9[6,7]
; AVX2-FAST-NEXT:    vmovaps 96(%r8), %ymm10
; AVX2-FAST-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm10[1],ymm9[2,3,4,5],ymm10[6],ymm9[7]
; AVX2-FAST-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm6[0],xmm5[0],xmm6[1],xmm5[1]
; AVX2-FAST-NEXT:    vpermps %ymm7, %ymm11, %ymm6
; AVX2-FAST-NEXT:    vmovaps {{.*#+}} ymm9 = [0,1,3,2,3,2,3,2]
; AVX2-FAST-NEXT:    vpermps %ymm5, %ymm9, %ymm7
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1],ymm6[2,3],ymm7[4,5,6],ymm6[7]
; AVX2-FAST-NEXT:    vinsertf128 $1, (%r8), %ymm5, %ymm5
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm5 = ymm7[1,1,1,1,5,5,5,5]
; AVX2-FAST-NEXT:    vmovaps %ymm7, %ymm8
; AVX2-FAST-NEXT:    vmovups %ymm7, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm6[1],ymm5[2,3,4],ymm6[5],ymm5[6,7]
; AVX2-FAST-NEXT:    vmovaps %ymm6, %ymm7
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm6 = ymm10[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm13[1,2],ymm6[3,4],ymm13[5,6],ymm6[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,2,2,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1,2],ymm5[3,4],ymm6[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 16(%r8), %ymm6
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0],ymm5[1,2,3,4],ymm6[5],ymm5[6,7]
; AVX2-FAST-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0],ymm5[1,2],ymm6[3,4],ymm5[5,6],ymm6[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm6 = ymm10[2],ymm13[2],ymm10[3],ymm13[3],ymm10[6],ymm13[6],ymm10[7],ymm13[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2],ymm6[3,4],ymm5[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 24(%r8), %ymm6
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm6[2],ymm5[3,4,5,6],ymm6[7]
; AVX2-FAST-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1]
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm1[0],xmm14[0],xmm1[1],xmm14[1]
; AVX2-FAST-NEXT:    vpermps %ymm2, %ymm11, %ymm2
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm9, %ymm3
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2,3],ymm3[4,5,6],ymm2[7]
...
; AVX2-FAST-NEXT:    vmovaps 32(%rcx), %ymm7
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm2 = ymm5[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm6[1,2],ymm2[3,4],ymm6[5,6],ymm2[7]
...
; AVX2-FAST-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm1 = ymm7[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm2 = ymm8[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0],ymm1[1,2],ymm2[3,4],ymm1[5,6],ymm2[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm5[2],ymm6[2],ymm5[3],ymm6[3],ymm5[6],ymm6[6],ymm5[7],ymm6[7]
...
; AVX2-FAST-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm12[0],xmm4[0],xmm12[1],xmm4[1]
; AVX2-FAST-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15, %xmm1 # 16-byte Folded Reload
; AVX2-FAST-NEXT:    # xmm1 = xmm15[0],mem[0],xmm15[1],mem[1]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm11, %ymm0
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm9, %ymm2
...
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps 64(%rdx), %ymm15
; AVX2-FAST-NEXT:    vmovaps 64(%rcx), %ymm4
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm0 = ymm4[1,1,1,1,5,5,5,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm15[1],ymm0[2,3,4],ymm15[5],ymm0[6,7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm1 = ymm15[2,3,2,3,6,7,6,7]
...
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm9, %ymm9
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm0[2,3],ymm9[4,5,6],ymm0[7]
; AVX2-FAST-NEXT:    vinsertf128 $1, 96(%r8), %ymm1, %ymm1
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps 96(%rdx), %ymm11
; AVX2-FAST-NEXT:    vmovaps 96(%rcx), %ymm12
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm0 = ymm12[1,1,1,1,5,5,5,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm11[1],ymm0[2,3,4],ymm11[5],ymm0[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[2,2,2,2]
; AVX2-FAST-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-FAST-NEXT:    vmovaps 96(%rsi), %ymm0
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm1[1,2],ymm14[3,4],ymm1[5,6],ymm14[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm14[0,1,2],ymm9[3,4],ymm14[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 112(%r8), %ymm14
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm14[0],ymm9[1,2,3,4],ymm14[5],ymm9[6,7]
; AVX2-FAST-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm9 = ymm12[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm14 = ymm11[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm14[0],ymm9[1,2],ymm14[3,4],ymm9[5,6],ymm14[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1,2],ymm14[3,4],ymm9[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 120(%r8), %ymm14
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm14[2],ymm9[3,4,5,6],ymm14[7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[3,0,2,3,7,4,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3],ymm13[4],ymm10[5,6,7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0,1],ymm13[2],ymm14[3,4,5,6],ymm13[7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm13[1,2,3],ymm10[4,5],ymm13[6,7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm4[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm4 = ymm15[2,3,0,1,6,7,4,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1],ymm3[2],ymm4[3,4,5,6],ymm3[7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1,2,3],ymm2[4,5],ymm3[6,7]
; AVX2-FAST-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2, %ymm2 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm2 = ymm2[0,1,2],mem[3],ymm2[4,5,6,7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm1 = ymm12[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm11[2,3,0,1,6,7,4,5]
...
; AVX2-FAST-NEXT:    vmovaps %ymm9, 608(%r9)
; AVX2-FAST-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FAST-PERLANE-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[0,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[0,0,2,1]
; AVX2-FAST-PERLANE-NEXT:    vmovaps (%rsi), %xmm8
; AVX2-FAST-PERLANE-NEXT:    vmovaps 32(%rsi), %xmm9
; AVX2-FAST-PERLANE-NEXT:    vmovaps 64(%rsi), %xmm2
; AVX2-FAST-PERLANE-NEXT:    vmovaps (%rdi), %xmm10
; AVX2-FAST-PERLANE-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm10[0],xmm8[0],xmm10[1],xmm8[1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,3,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm12 = ymm11[0,1,1,1]
...
; AVX2-FAST-PERLANE-NEXT:    vunpckhps {{.*#+}} xmm8 = xmm10[2],xmm8[2],xmm10[3],xmm8[3]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm8 = xmm8[0,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,0,2,1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} xmm6 = xmm6[0,1],xmm7[2],xmm6[3]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,1,1,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm8[2,3],ymm6[4,5],ymm8[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm7 = ymm15[0,1,2,1]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm7[1],ymm6[2,3,4,5],ymm7[6],ymm6[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FAST-PERLANE-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm12[0],xmm9[0],xmm12[1],xmm9[1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,3,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm8 = ymm7[0,1,1,1]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm6 = ymm8[0,1],ymm6[2,3],ymm8[4,5,6],ymm6[7]
; AVX2-FAST-PERLANE-NEXT:    vinsertf128 $1, 32(%r8), %ymm7, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2,3],ymm7[4],ymm6[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm12[2],xmm9[2],xmm12[3],xmm9[3]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
...
; AVX512F-NEXT:    vmovdqa64 64(%r8), %zmm10
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512F-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512F-NEXT:    vpermt2d %zmm6, %zmm11, %zmm12
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm13 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512F-NEXT:    # zmm13 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm3
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm13, %zmm3
; AVX512F-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vmovdqa32 %zmm12, %zmm3 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512F-NEXT:    vpermt2d %zmm5, %zmm12, %zmm3
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm14 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512F-NEXT:    # zmm14 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm8, %zmm15
; AVX512F-NEXT:    vpermt2d %zmm9, %zmm14, %zmm15
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512F-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm17
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm16, %zmm17
; AVX512F-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512F-NEXT:    kmovw %eax, %k2
; AVX512F-NEXT:    vmovdqa32 %zmm15, %zmm17 {%k2}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm15, %zmm17
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512F-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm19
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm18, %zmm19
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512F-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm9, %zmm21
; AVX512F-NEXT:    vpermt2d %zmm8, %zmm20, %zmm21
; AVX512F-NEXT:    vmovdqa32 %zmm19, %zmm21 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm19 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm19, %zmm21
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512F-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm22, %zmm23
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512F-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm8, %zmm25
; AVX512F-NEXT:    vpermt2d %zmm9, %zmm24, %zmm25
; AVX512F-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k2}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm23 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm23, %zmm25
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512F-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm8, %zmm27
; AVX512F-NEXT:    vpermt2d %zmm9, %zmm26, %zmm27
...
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm27, %zmm29
; AVX512F-NEXT:    vpermt2d %zmm9, %zmm11, %zmm8
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm13, %zmm0
; AVX512F-NEXT:    vmovdqa32 %zmm8, %zmm0 {%k1}
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm12, %zmm0
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm4, %zmm14
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm2, %zmm16
; AVX512F-NEXT:    vmovdqa32 %zmm14, %zmm16 {%k2}
; AVX512F-NEXT:    vpermt2d %zmm5, %zmm15, %zmm16
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm2, %zmm18
; AVX512F-NEXT:    vpermi2d %zmm4, %zmm6, %zmm20
; AVX512F-NEXT:    vmovdqa32 %zmm18, %zmm20 {%k1}
; AVX512F-NEXT:    vpermt2d %zmm5, %zmm19, %zmm20
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm2, %zmm22
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm4, %zmm24
; AVX512F-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k2}
; AVX512F-NEXT:    vpermt2d %zmm5, %zmm23, %zmm24
...
; AVX512F-NEXT:    vmovdqa64 %zmm25, 448(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm21, 512(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm17, 576(%r9)
...
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
; AVX512BW-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm12
; AVX512BW-NEXT:    vpermt2d %zmm6, %zmm11, %zmm12
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm13 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
; AVX512BW-NEXT:    # zmm13 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm3
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm13, %zmm3
; AVX512BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqa32 %zmm12, %zmm3 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm12, %zmm3
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm14 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512BW-NEXT:    # zmm14 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm8, %zmm15
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm14, %zmm15
...
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm16, %zmm17
; AVX512BW-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512BW-NEXT:    kmovd %eax, %k2
; AVX512BW-NEXT:    vmovdqa32 %zmm15, %zmm17 {%k2}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm15, %zmm17
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm18 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-NEXT:    # zmm18 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm19
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm18, %zmm19
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512BW-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm9, %zmm21
; AVX512BW-NEXT:    vpermt2d %zmm8, %zmm20, %zmm21
; AVX512BW-NEXT:    vmovdqa32 %zmm19, %zmm21 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm19 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm19, %zmm21
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm22 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512BW-NEXT:    # zmm22 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm23
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm22, %zmm23
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm24 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512BW-NEXT:    # zmm24 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm8, %zmm25
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm24, %zmm25
; AVX512BW-NEXT:    vmovdqa32 %zmm23, %zmm25 {%k2}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm23 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm23, %zmm25
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm26 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512BW-NEXT:    # zmm26 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm8, %zmm27
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm26, %zmm27
...
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm27, %zmm29
; AVX512BW-NEXT:    vpermt2d %zmm9, %zmm11, %zmm8
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm13, %zmm0
; AVX512BW-NEXT:    vmovdqa32 %zmm8, %zmm0 {%k1}
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm12, %zmm0
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm4, %zmm14
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm2, %zmm16
; AVX512BW-NEXT:    vmovdqa32 %zmm14, %zmm16 {%k2}
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm15, %zmm16
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm2, %zmm18
; AVX512BW-NEXT:    vpermi2d %zmm4, %zmm6, %zmm20
; AVX512BW-NEXT:    vmovdqa32 %zmm18, %zmm20 {%k1}
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm19, %zmm20
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm2, %zmm22
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm4, %zmm24
; AVX512BW-NEXT:    vmovdqa32 %zmm22, %zmm24 {%k2}
; AVX512BW-NEXT:    vpermt2d %zmm5, %zmm23, %zmm24
...
; SSE-NEXT:    movaps 32(%rcx), %xmm9
; SSE-NEXT:    movaps (%r8), %xmm5
; SSE-NEXT:    movaps 16(%r8), %xmm8
; SSE-NEXT:    movaps 32(%r8), %xmm7
; SSE-NEXT:    movaps %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps %xmm4, %xmm0
...
; SSE-NEXT:    punpcklqdq {{.*#+}} xmm14 = xmm14[0],xmm0[0]
; SSE-NEXT:    movdqa %xmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movdqa %xmm2, %xmm0
...
; SSE-NEXT:    movaps %xmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[1,1],xmm8[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,2],xmm0[0,1]
; SSE-NEXT:    movaps %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movdqa %xmm2, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,1],xmm8[2,3]
; SSE-NEXT:    punpckhqdq {{.*#+}} xmm6 = xmm6[1],xmm13[1]
...
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm2[0,1]
; SSE-NEXT:    movaps %xmm5, %xmm2
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,1],xmm0[2,3]
; SSE-NEXT:    unpckhpd {{.*#+}} xmm14 = xmm14[1],xmm1[1]
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[2,0],xmm2[2,0]
; SSE-NEXT:    movaps %xmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = xmm0[1,1],mem[1,1]
...
; SSE-NEXT:    movaps %xmm4, 1200(%r9)
; SSE-NEXT:    movaps %xmm6, 1168(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps %xmm11, 1040(%r9)
; SSE-NEXT:    movaps %xmm12, 1008(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps %xmm7, 1136(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 1104(%r9)
; SSE-NEXT:    movaps %xmm10, 1056(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 1024(%r9)
; SSE-NEXT:    movaps %xmm13, 976(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 944(%r9)
; SSE-NEXT:    movaps %xmm1, 896(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vmovaps 32(%rsi), %xmm15
; AVX1-ONLY-NEXT:    vmovaps (%rdi), %xmm5
; AVX1-ONLY-NEXT:    vmovaps 32(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm3 = zero,xmm5[1],xmm10[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm4 = xmm5[0],xmm10[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm4, %ymm3
; AVX1-ONLY-NEXT:    vmovaps (%rdx), %xmm14
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %xmm12
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm12[0],xmm14[0]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 4(%rdx), %xmm8
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm7, %ymm7
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm7[2,3],ymm3[4,5,6],ymm7[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, (%r8), %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm3[1,2,3],ymm4[4],ymm3[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm3 = zero,xmm6[1],xmm15[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm4 = xmm6[0],xmm15[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm4, %ymm3
; AVX1-ONLY-NEXT:    vmovaps 32(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %xmm1
; AVX1-ONLY-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm7 = xmm1[0],xmm0[0]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,0]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 68(%rdx), %xmm4
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm4 = zero,xmm13[1],xmm0[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm7 = xmm13[0],xmm0[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm7, %ymm4
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1],ymm3[2,3],ymm4[4,5,6],ymm3[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 64(%r8), %ymm7, %ymm4
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm3[1,2,3],ymm4[4],ymm3[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 96(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,2,0]
; AVX1-ONLY-NEXT:    vbroadcastss 100(%rdx), %xmm4
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm4
; AVX1-ONLY-NEXT:    vmovaps 96(%rsi), %xmm0
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 96(%rdi), %xmm8
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm7 = zero,xmm8[1],xmm0[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm9 = xmm8[0],xmm0[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm9, %ymm7
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1],ymm4[2,3],ymm7[4,5,6],ymm4[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%r8), %ymm9, %ymm7
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0],ymm4[1,2,3],ymm7[4],ymm4[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vbroadcastss 132(%rdx), %xmm7
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm4, %ymm7
; AVX1-ONLY-NEXT:    vmovaps 128(%rsi), %xmm0
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 128(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm9 = zero,xmm11[1],xmm0[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm0 = xmm11[0],xmm0[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm0, %ymm9
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm9[0,1],ymm7[2,3],ymm9[4,5,6],ymm7[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 128(%r8), %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm7[1,2,3],ymm0[4],ymm7[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vbroadcastss 164(%rdx), %xmm7
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm1
; AVX1-ONLY-NEXT:    vmovaps 160(%rsi), %xmm0
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 160(%rdi), %xmm7
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm9 = zero,xmm7[1],xmm0[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm0 = xmm7[0],xmm0[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm0, %ymm9
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm9[0,1],ymm1[2,3],ymm9[4,5,6],ymm1[7]
...
; AVX1-ONLY-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm3 = zero,xmm0[1],xmm1[1],zero
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm2 = xmm0[0],xmm1[0],zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm1
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm4[2,3],ymm1[4,5,6],ymm4[7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 224(%r8), %ymm2, %ymm1
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm14[2],xmm12[2],xmm14[3],xmm12[3]
; AVX1-ONLY-NEXT:    vbroadcastss 4(%rcx), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm5[2],xmm10[2]
...
; AVX1-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,3],ymm14[3,3],ymm2[7,7],ymm14[7,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[2,3,2,3]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vinsertps {{.*#+}} xmm1 = zero,zero,xmm6[2],xmm15[2]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vinsertps $51, {{[-0-9]+}}(%r{{[sb]}}p), %xmm13, %xmm1 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm1 = zero,zero,xmm13[2],mem[0]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vinsertps $51, {{[-0-9]+}}(%r{{[sb]}}p), %xmm11, %xmm1 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm1 = zero,zero,xmm11[2],mem[0]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm0[3,3],ymm2[3,3],ymm0[7,7],ymm2[7,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm1[0,1,2],ymm6[3,4],ymm1[5,6,7]
; AVX1-ONLY-NEXT:    vmovaps 224(%r8), %ymm1
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm1[2,3,2,3]
...
; AVX2-SLOW-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 64(%r8), %ymm14
; AVX2-SLOW-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps (%rcx), %xmm6
; AVX2-SLOW-NEXT:    vmovaps 32(%rcx), %xmm3
; AVX2-SLOW-NEXT:    vmovaps 64(%rcx), %xmm0
...
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[0,1,1,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm6[2,3],ymm3[4,5],ymm6[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,1,2,1]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3,4,5],ymm4[6],ymm3[7]
; AVX2-SLOW-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,2,2]
...
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm2[2,3],ymm0[4,5],ymm2[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm1 = ymm14[0,1,2,1]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
; AVX2-SLOW-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 96(%rcx), %xmm0
; AVX2-SLOW-NEXT:    vmovaps 96(%rdx), %xmm1
...
; AVX2-SLOW-NEXT:    vmovaps (%rsi), %ymm3
; AVX2-SLOW-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm1 = ymm3[1,1,2,2,5,5,6,6]
...
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-SLOW-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 32(%rdx), %ymm14
; AVX2-SLOW-NEXT:    vmovaps 32(%rcx), %ymm1
...
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-SLOW-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 64(%rdx), %ymm14
; AVX2-SLOW-NEXT:    vmovaps 64(%rcx), %ymm1
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[1,1,1,1,5,5,5,5]
; AVX2-SLOW-NEXT:    vmovaps %ymm1, %ymm2
; AVX2-SLOW-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm14[1],ymm0[2,3,4],ymm14[5],ymm0[6,7]
...
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-SLOW-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 96(%rdx), %ymm14
...
; AVX2-SLOW-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovaps 128(%rsi), %ymm5
; AVX2-SLOW-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4],ymm3[5],ymm0[6,7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm8 = ymm0[2,2,2,2]
; AVX2-SLOW-NEXT:    vmovaps 224(%rdi), %ymm1
; AVX2-SLOW-NEXT:    vmovaps 224(%rsi), %ymm0
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm13 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm1[1,2],ymm13[3,4],ymm1[5,6],ymm13[7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0,1,2],ymm8[3,4],ymm13[5,6,7]
; AVX2-SLOW-NEXT:    vbroadcastsd 240(%r8), %ymm13
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1,2,3,4],ymm13[5],ymm8[6,7]
; AVX2-SLOW-NEXT:    vmovups %ymm8, (%rsp) # 32-byte Spill
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm8 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm13 = ymm3[2,3,2,3,6,7,6,7]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1,2],ymm13[3,4],ymm8[5,6],ymm13[7]
; AVX2-SLOW-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[3,3,3,3]
; AVX2-SLOW-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm13[3,4],ymm8[5,6,7]
; AVX2-SLOW-NEXT:    vbroadcastsd 248(%r8), %ymm13
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm13[2],ymm8[3,4,5,6],ymm13[7]
; AVX2-SLOW-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm8 = mem[3,0,2,3,7,4,6,7]
; AVX2-SLOW-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm8 = ymm8[0,1,2,3],mem[4],ymm8[5,6,7]
; AVX2-SLOW-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm13 = mem[0,1,3,0,4,5,7,4]
; AVX2-SLOW-NEXT:    vshufps {{.*#+}} ymm15 = ymm15[2,3,0,1,6,7,4,5]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm13 = ymm15[0,1],ymm13[2],ymm15[3,4,5,6],ymm13[7]
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm13[1,2,3],ymm8[4,5],ymm13[6,7]
; AVX2-SLOW-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm8 = ymm8[0,1,2],mem[3],ymm8[4,5,6,7]
; AVX2-SLOW-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
...
; AVX2-SLOW-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm14[1,2,3],ymm8[4,5],ymm14[6,7]
; AVX2-SLOW-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm8 = ymm8[0,1,2],mem[3],ymm8[4,5,6,7]
; AVX2-SLOW-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX2-SLOW-NEXT:    # ymm14 = mem[3,0,2,3,7,4,6,7]
...
; AVX2-SLOW-NEXT:    vmovaps %ymm8, 544(%r9)
; AVX2-SLOW-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FAST:       # %bb.0:
; AVX2-FAST-NEXT:    subq $1832, %rsp # imm = 0x728
; AVX2-FAST-NEXT:    vmovaps (%r8), %ymm5
; AVX2-FAST-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-NEXT:    vmovaps 64(%rsi), %xmm7
...
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm13[2],xmm10[2],xmm13[3],xmm10[3]
; AVX2-FAST-NEXT:    vmovaps {{.*#+}} ymm15 = <0,1,0,1,u,u,2,2>
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm1
; AVX2-FAST-NEXT:    vmovaps (%rdx), %xmm14
; AVX2-FAST-NEXT:    vmovaps 32(%rdx), %xmm11
; AVX2-FAST-NEXT:    vmovaps (%rcx), %xmm3
; AVX2-FAST-NEXT:    vmovaps 32(%rcx), %xmm12
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm2 = xmm3[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm14[2],xmm2[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm5[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm2[1],ymm1[2,3,4,5],ymm2[6],ymm1[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm9[2],xmm6[2],xmm9[3],xmm6[3]
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm15, %ymm1
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm2 = xmm12[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm11[2],xmm2[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm4[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm2[1],ymm1[2,3,4,5],ymm2[6],ymm1[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm8[2],xmm7[2],xmm8[3],xmm7[3]
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm15, %ymm1
; AVX2-FAST-NEXT:    vmovaps 64(%rdx), %xmm7
; AVX2-FAST-NEXT:    vmovaps 64(%rcx), %xmm8
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm2 = xmm8[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm7[2],xmm2[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FAST-NEXT:    vmovaps 64(%r8), %ymm0
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,1,2,1]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm2[1],ymm1[2,3,4,5],ymm2[6],ymm1[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm1[2],xmm0[2],xmm1[3],xmm0[3]
; AVX2-FAST-NEXT:    vpermps %ymm1, %ymm15, %ymm0
; AVX2-FAST-NEXT:    vmovaps 96(%rdx), %xmm1
; AVX2-FAST-NEXT:    vmovaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vmovaps 96(%rcx), %xmm4
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm5 = xmm4[1,1,2,2]
...
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm0
...
; AVX2-FAST-NEXT:    vmovaps %xmm2, (%rsp) # 16-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm5 = xmm2[1,1,2,2]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm1[2],xmm5[3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1],ymm0[2,3],ymm5[4,5],ymm0[6,7]
...
; AVX2-FAST-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm1[2],xmm0[3],xmm1[3]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm2
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm5[1],ymm0[2,3,4,5],ymm5[6],ymm0[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm14[0],xmm3[0],xmm14[1],xmm3[1]
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm13[0],xmm10[0],xmm13[1],xmm10[1]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm0
...
; AVX2-FAST-NEXT:    vinsertf128 $1, (%r8), %ymm3, %ymm3
...
; AVX2-FAST-NEXT:    vmovaps %ymm2, %ymm10
...
; AVX2-FAST-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm2[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm1[1,2],ymm3[3,4],ymm1[5,6],ymm3[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[2,2,2,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1,2],ymm0[3,4],ymm3[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 16(%r8), %ymm3
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm0[1,2,3,4],ymm3[5],ymm0[6,7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm0 = ymm10[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm5[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm0[1,2],ymm3[3,4],ymm0[5,6],ymm3[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm3 = ymm2[2],ymm1[2],ymm2[3],ymm1[3],ymm2[6],ymm1[6],ymm2[7],ymm1[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3,4],ymm0[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 24(%r8), %ymm3
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm3[2],ymm0[3,4,5,6],ymm3[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm11[0],xmm12[0],xmm11[1],xmm12[1]
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm9[0],xmm6[0],xmm9[1],xmm6[1]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm0
; AVX2-FAST-NEXT:    vpermps %ymm3, %ymm14, %ymm5
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1],ymm0[2,3],ymm5[4,5,6],ymm0[7]
...
; AVX2-FAST-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps 32(%rsi), %ymm6
; AVX2-FAST-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm6[1,1,2,2,5,5,6,6]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2],ymm3[3,4],ymm5[5,6],ymm3[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[2,2,2,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1,2],ymm0[3,4],ymm3[5,6,7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm3 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm0[1,2],ymm3[3,4],ymm0[5,6],ymm3[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm3 = ymm6[2],ymm5[2],ymm6[3],ymm5[3],ymm6[6],ymm5[6],ymm6[7],ymm5[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3,4],ymm0[5,6,7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm3[2],ymm0[3,4,5,6],ymm3[7]
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX2-FAST-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
...
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FAST-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm0[0],xmm4[0],xmm0[1],xmm4[1]
; AVX2-FAST-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FAST-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm1 # 16-byte Folded Reload
; AVX2-FAST-NEXT:    # xmm1 = xmm1[0],mem[0],xmm1[1],mem[1]
; AVX2-FAST-NEXT:    vpermps %ymm0, %ymm15, %ymm0
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-FAST-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm5[2],ymm4[2],ymm5[3],ymm4[3],ymm5[6],ymm4[6],ymm5[7],ymm4[7]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-FAST-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX2-FAST-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm1 = ymm13[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0,1,2],ymm6[3,4],ymm9[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 240(%r8), %ymm9
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0],ymm6[1,2,3,4],ymm9[5],ymm6[6,7]
; AVX2-FAST-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm6 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm9 = ymm3[2,3,2,3,6,7,6,7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm9[0],ymm6[1,2],ymm9[3,4],ymm6[5,6],ymm9[7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm9[3,4],ymm6[5,6,7]
; AVX2-FAST-NEXT:    vbroadcastsd 248(%r8), %ymm9
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm9[2],ymm6[3,4,5,6],ymm9[7]
; AVX2-FAST-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm6 = mem[3,0,2,3,7,4,6,7]
; AVX2-FAST-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm6 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm6 = ymm6[0,1,2,3],mem[4],ymm6[5,6,7]
; AVX2-FAST-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm9 = mem[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm14 = mem[2,3,0,1,6,7,4,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm9 = ymm14[0,1],ymm9[2],ymm14[3,4,5,6],ymm9[7]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm9[1,2,3],ymm6[4,5],ymm9[6,7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm9[1,2,3],ymm6[4,5],ymm9[6,7]
; AVX2-FAST-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm9 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm9 = ymm6[0,1,2],mem[3],ymm6[4,5,6,7]
; AVX2-FAST-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm6 = mem[3,0,2,3,7,4,6,7]
; AVX2-FAST-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm6 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm6 = ymm6[0,1,2,3],mem[4],ymm6[5,6,7]
...
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm14[1,2,3],ymm6[4,5],ymm14[6,7]
; AVX2-FAST-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6, %ymm6 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm6 = ymm6[0,1,2],mem[3],ymm6[4,5,6,7]
...
; AVX2-FAST-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm15 = mem[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[2,3,0,1,6,7,4,5]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Folded Reload
; AVX2-FAST-NEXT:    # ymm12 = mem[2,3,0,1,6,7,4,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0,1],ymm11[2],ymm12[3,4,5,6],ymm11[7]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm5 = ymm7[0,1,3,0,4,5,7,4]
; AVX2-FAST-NEXT:    vshufps {{.*#+}} ymm7 = ymm8[2,3,0,1,6,7,4,5]
; AVX2-FAST-NEXT:    vblendps {{.*#+}} ymm5 = ymm7[0,1],ymm5[2],ymm7[3,4,5,6],ymm5[7]
...
; AVX2-FAST-NEXT:    vmovaps %ymm6, 544(%r9)
...
; AVX2-FAST-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FAST-NEXT:    vmovaps %ymm0, 32(%r9)
; AVX2-FAST-NEXT:    addq $1832, %rsp # imm = 0x728
; AVX2-FAST-NEXT:    vzeroupper
; AVX2-FAST-NEXT:    retq
;
...
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm13, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 64(%r8), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps (%rcx), %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovaps 32(%rcx), %xmm3
; AVX2-FAST-PERLANE-NEXT:    vmovaps 64(%rcx), %xmm0
...
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[0,1,1,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm6[2,3],ymm3[4,5],ymm6[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,1,2,1]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1],ymm3[2,3,4,5],ymm4[6],ymm3[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,2,2]
...
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm2[2,3],ymm0[4,5],ymm2[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm1 = ymm14[0,1,2,1]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 96(%rcx), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovaps 96(%rdx), %xmm1
...
; AVX2-FAST-PERLANE-NEXT:    vmovaps (%rsi), %ymm3
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm1 = ymm3[1,1,2,2,5,5,6,6]
...
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 32(%rdx), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vmovaps 32(%rcx), %ymm1
...
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 64(%rdx), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vmovaps 64(%rcx), %ymm1
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm0 = ymm1[1,1,1,1,5,5,5,5]
; AVX2-FAST-PERLANE-NEXT:    vmovaps %ymm1, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm14[1],ymm0[2,3,4],ymm14[5],ymm0[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 96(%rdx), %ymm14
...
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovaps 128(%rsi), %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4],ymm3[5],ymm0[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm8 = ymm0[2,2,2,2]
; AVX2-FAST-PERLANE-NEXT:    vmovaps 224(%rdi), %ymm1
; AVX2-FAST-PERLANE-NEXT:    vmovaps 224(%rsi), %ymm0
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm13 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm1[1,2],ymm13[3,4],ymm1[5,6],ymm13[7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0,1,2],ymm8[3,4],ymm13[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vbroadcastsd 240(%r8), %ymm13
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1,2,3,4],ymm13[5],ymm8[6,7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm8, (%rsp) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm8 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm13 = ymm3[2,3,2,3,6,7,6,7]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm13[0],ymm8[1,2],ymm13[3,4],ymm8[5,6],ymm13[7]
; AVX2-FAST-PERLANE-NEXT:    vunpckhps {{.*#+}} ymm13 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[3,3,3,3]
; AVX2-FAST-PERLANE-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[2,1,3,3]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm13[3,4],ymm8[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vbroadcastsd 248(%r8), %ymm13
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm13[2],ymm8[3,4,5,6],ymm13[7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm8 = mem[3,0,2,3,7,4,6,7]
; AVX2-FAST-PERLANE-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm8 = ymm8[0,1,2,3],mem[4],ymm8[5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm13 = mem[0,1,3,0,4,5,7,4]
; AVX2-FAST-PERLANE-NEXT:    vshufps {{.*#+}} ymm15 = ymm15[2,3,0,1,6,7,4,5]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm13 = ymm15[0,1],ymm13[2],ymm15[3,4,5,6],ymm13[7]
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm13[1,2,3],ymm8[4,5],ymm13[6,7]
; AVX2-FAST-PERLANE-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm8 = ymm8[0,1,2],mem[3],ymm8[4,5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vmovups %ymm8, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
...
; AVX2-FAST-PERLANE-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0],ymm14[1,2,3],ymm8[4,5],ymm14[6,7]
; AVX2-FAST-PERLANE-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm8 = ymm8[0,1,2],mem[3],ymm8[4,5,6,7]
; AVX2-FAST-PERLANE-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX2-FAST-PERLANE-NEXT:    # ymm14 = mem[3,0,2,3,7,4,6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vmovaps %ymm8, 544(%r9)
; AVX2-FAST-PERLANE-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 (%rdx), %zmm4
; AVX512F-NEXT:    vmovdqa64 64(%rdx), %zmm28
...
; AVX512F-NEXT:    vmovdqa64 128(%rcx), %zmm15
; AVX512F-NEXT:    vmovdqa64 192(%rcx), %zmm10
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm17 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
...
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm27 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
...
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm3, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm5
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm6 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512F-NEXT:    # zmm6 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm3
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm6, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512F-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
...
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm8 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512F-NEXT:    # zmm8 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm18, %zmm8, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512F-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm29
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm11, %zmm29
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm21 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512F-NEXT:    # zmm21 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm18, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm21, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, (%rsp) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm10, %zmm17, %zmm18
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm15, %zmm5, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm15, %zmm25
; AVX512F-NEXT:    vpermt2d %zmm14, %zmm8, %zmm25
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm23
; AVX512F-NEXT:    vpermt2d %zmm15, %zmm11, %zmm23
; AVX512F-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm15, %zmm21, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm15, %zmm17, %zmm14
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm7
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm15
; AVX512F-NEXT:    vpermt2d %zmm28, %zmm8, %zmm15
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm16
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm9
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm17, %zmm28
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512F-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm5, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm11, %zmm16
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm21, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm13
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm20, %zmm13
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm4, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm4, %zmm1, %zmm8
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm4, %zmm11
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm21, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512F-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm17
; AVX512F-NEXT:    vpermt2d %zmm12, %zmm1, %zmm17
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm27, %zmm12
...
; AVX512F-NEXT:    vpermt2d %zmm19, %zmm1, %zmm22
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm27, %zmm19
; AVX512F-NEXT:    vmovdqa64 (%rdi), %zmm21
; AVX512F-NEXT:    vmovdqa64 (%rsi), %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm21, %zmm5
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm27, %zmm5
; AVX512F-NEXT:    vmovdqa64 64(%rdi), %zmm31
; AVX512F-NEXT:    vmovdqa64 64(%rsi), %zmm2
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm4
; AVX512F-NEXT:    vpermt2d %zmm31, %zmm1, %zmm4
; AVX512F-NEXT:    vmovdqa64 %zmm31, %zmm30
; AVX512F-NEXT:    vmovdqa64 %zmm31, %zmm7
; AVX512F-NEXT:    vmovdqa64 %zmm31, %zmm10
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm27, %zmm31
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm6, %zmm30
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm3, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm20, %zmm10
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm21, %zmm6
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm21, %zmm3
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm21, %zmm20
; AVX512F-NEXT:    vpermt2d %zmm21, %zmm1, %zmm0
; AVX512F-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512F-NEXT:    kmovw %eax, %k1
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm5 {%k1}
; AVX512F-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512F-NEXT:    kmovw %eax, %k2
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm21 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm21 {%k2}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm27 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm27 {%k1}
; AVX512F-NEXT:    vmovdqa32 %zmm13, %zmm29 {%k2}
; AVX512F-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512F-NEXT:    kmovw %eax, %k3
; AVX512F-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm17 {%k3}
; AVX512F-NEXT:    vmovdqa32 %zmm18, %zmm12 {%k1}
; AVX512F-NEXT:    vmovdqa64 192(%r8), %zmm1
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm2 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm2, %zmm21
; AVX512F-NEXT:    vmovdqu64 %zmm21, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm13 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm13, %zmm27
; AVX512F-NEXT:    vmovdqu64 %zmm27, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm18 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm18, %zmm29
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm21 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm21, %zmm17
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm27 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm27, %zmm12
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm9 {%k2}
; AVX512F-NEXT:    vmovdqa32 %zmm26, %zmm25 {%k1}
; AVX512F-NEXT:    vmovdqa32 %zmm24, %zmm23 {%k2}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm22 {%k3}
; AVX512F-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k1}
; AVX512F-NEXT:    vmovdqa64 128(%r8), %zmm1
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm2, %zmm9
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm13, %zmm25
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm18, %zmm23
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm21, %zmm22
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm27, %zmm19
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm30 {%k2}
; AVX512F-NEXT:    vmovdqa32 %zmm7, %zmm15 {%k1}
; AVX512F-NEXT:    vmovdqa32 %zmm10, %zmm16 {%k2}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm1, %zmm4 {%k3}
; AVX512F-NEXT:    vmovdqa64 (%r8), %zmm1
; AVX512F-NEXT:    vmovdqa32 %zmm28, %zmm31 {%k1}
; AVX512F-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm27, %zmm5
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm27, %zmm31
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm2, %zmm30
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm13, %zmm15
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm18, %zmm16
; AVX512F-NEXT:    vpermt2d %zmm7, %zmm21, %zmm4
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm7, %zmm6 {%k2}
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm2, %zmm6
; AVX512F-NEXT:    vmovdqa32 %zmm3, %zmm8 {%k1}
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm13, %zmm8
; AVX512F-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm18, %zmm11
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa32 %zmm2, %zmm0 {%k3}
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm21, %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm0, 64(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm11, 128(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm8, 192(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm6, 256(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm31, 320(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm4, 384(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm16, 448(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm15, 512(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm30, 576(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm19, 640(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm22, 704(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm23, 768(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm25, 832(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm9, 896(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm12, 960(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm17, 1024(%r9)
; AVX512F-NEXT:    vmovdqa64 %zmm29, 1088(%r9)
...
; AVX512BW-NEXT:    vmovdqa64 (%rdx), %zmm4
; AVX512BW-NEXT:    vmovdqa64 64(%rdx), %zmm28
...
; AVX512BW-NEXT:    vmovdqa64 128(%rcx), %zmm15
; AVX512BW-NEXT:    vmovdqa64 192(%rcx), %zmm10
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm17 = [17,0,0,16,2,18,0,1,17,0,0,16,2,18,0,1]
...
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm27 = [0,16,2,18,0,1,17,3,0,16,2,18,0,1,17,3]
...
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm3, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm5
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm6 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512BW-NEXT:    # zmm6 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm3
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm6, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
...
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm8 = [9,27,11,0,26,10,28,12,9,27,11,0,26,10,28,12]
; AVX512BW-NEXT:    # zmm8 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm18, %zmm8, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm11 = [6,22,8,24,0,7,23,9,6,22,8,24,0,7,23,9]
; AVX512BW-NEXT:    # zmm11 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm29
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm11, %zmm29
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm21 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512BW-NEXT:    # zmm21 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm21, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, (%rsp) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm10, %zmm17, %zmm18
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm15, %zmm5, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm25
; AVX512BW-NEXT:    vpermt2d %zmm14, %zmm8, %zmm25
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm23
; AVX512BW-NEXT:    vpermt2d %zmm15, %zmm11, %zmm23
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm15, %zmm21, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm15, %zmm17, %zmm14
; AVX512BW-NEXT:    vmovdqa64 %zmm28, %zmm7
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm15
; AVX512BW-NEXT:    vpermt2d %zmm28, %zmm8, %zmm15
; AVX512BW-NEXT:    vmovdqa64 %zmm28, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm28, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm17, %zmm28
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm20 = [8,24,0,7,23,9,25,0,8,24,0,7,23,9,25,0]
; AVX512BW-NEXT:    # zmm20 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm5, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm11, %zmm16
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm21, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm13
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm20, %zmm13
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm4, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm4, %zmm1, %zmm8
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm4, %zmm11
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm21, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm17
; AVX512BW-NEXT:    vpermt2d %zmm12, %zmm1, %zmm17
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm27, %zmm12
...
; AVX512BW-NEXT:    vpermt2d %zmm19, %zmm1, %zmm22
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm27, %zmm19
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %zmm21
; AVX512BW-NEXT:    vmovdqa64 (%rsi), %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm21, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm27, %zmm5
; AVX512BW-NEXT:    vmovdqa64 64(%rdi), %zmm31
; AVX512BW-NEXT:    vmovdqa64 64(%rsi), %zmm2
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm4
; AVX512BW-NEXT:    vpermt2d %zmm31, %zmm1, %zmm4
; AVX512BW-NEXT:    vmovdqa64 %zmm31, %zmm30
; AVX512BW-NEXT:    vmovdqa64 %zmm31, %zmm7
; AVX512BW-NEXT:    vmovdqa64 %zmm31, %zmm10
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm27, %zmm31
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm6, %zmm30
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm3, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm20, %zmm10
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm21, %zmm6
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm21, %zmm3
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm21, %zmm20
; AVX512BW-NEXT:    vpermt2d %zmm21, %zmm1, %zmm0
; AVX512BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm5 {%k1}
; AVX512BW-NEXT:    movw $25368, %ax # imm = 0x6318
; AVX512BW-NEXT:    kmovd %eax, %k2
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm21 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm21 {%k2}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm27 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm27 {%k1}
; AVX512BW-NEXT:    vmovdqa32 %zmm13, %zmm29 {%k2}
; AVX512BW-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512BW-NEXT:    kmovd %eax, %k3
; AVX512BW-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm17 {%k3}
; AVX512BW-NEXT:    vmovdqa32 %zmm18, %zmm12 {%k1}
; AVX512BW-NEXT:    vmovdqa64 192(%r8), %zmm1
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm2 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm2, %zmm21
; AVX512BW-NEXT:    vmovdqu64 %zmm21, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm13 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm13, %zmm27
; AVX512BW-NEXT:    vmovdqu64 %zmm27, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm18 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm18, %zmm29
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm21 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm21, %zmm17
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm27 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm27, %zmm12
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm9 {%k2}
; AVX512BW-NEXT:    vmovdqa32 %zmm26, %zmm25 {%k1}
; AVX512BW-NEXT:    vmovdqa32 %zmm24, %zmm23 {%k2}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm22 {%k3}
; AVX512BW-NEXT:    vmovdqa32 %zmm14, %zmm19 {%k1}
; AVX512BW-NEXT:    vmovdqa64 128(%r8), %zmm1
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm2, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm13, %zmm25
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm18, %zmm23
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm21, %zmm22
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm27, %zmm19
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm30 {%k2}
; AVX512BW-NEXT:    vmovdqa32 %zmm7, %zmm15 {%k1}
; AVX512BW-NEXT:    vmovdqa32 %zmm10, %zmm16 {%k2}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm4 {%k3}
; AVX512BW-NEXT:    vmovdqa64 (%r8), %zmm1
; AVX512BW-NEXT:    vmovdqa32 %zmm28, %zmm31 {%k1}
; AVX512BW-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm27, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm27, %zmm31
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm2, %zmm30
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm13, %zmm15
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm18, %zmm16
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm21, %zmm4
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm7, %zmm6 {%k2}
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm2, %zmm6
; AVX512BW-NEXT:    vmovdqa32 %zmm3, %zmm8 {%k1}
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm13, %zmm8
; AVX512BW-NEXT:    vmovdqa32 %zmm20, %zmm11 {%k2}
...
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm21, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm0, 64(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm11, 128(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm8, 192(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm6, 256(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm31, 320(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm4, 384(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm16, 448(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm15, 512(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm30, 576(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm19, 640(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm22, 704(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm23, 768(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm25, 832(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm9, 896(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm12, 960(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm17, 1024(%r9)
; AVX512BW-NEXT:    vmovdqa64 %zmm29, 1088(%r9)
