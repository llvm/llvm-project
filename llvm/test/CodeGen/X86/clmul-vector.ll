...
; RUN: llc < %s -mtriple=x86_64-- -mcpu=x86-64 -mattr=+pclmul | FileCheck %s --check-prefixes=SSE,SSE2
; RUN: llc < %s -mtriple=x86_64-- -mcpu=x86-64-v2 -mattr=+pclmul | FileCheck %s --check-prefixes=SSE,SSE42
; RUN: llc < %s -mtriple=x86_64-- -mcpu=x86-64-v3 -mattr=+pclmul | FileCheck %s --check-prefixes=AVX,AVX2
; RUN: llc < %s -mtriple=x86_64-- -mcpu=x86-64-v4 -mattr=+pclmul | FileCheck %s --check-prefixes=AVX,AVX512
