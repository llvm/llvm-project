...
; SSE41-NEXT:    pinsrd $2, {{[0-9]+}}(%rsp), %xmm0
; SSE41-NEXT:    movdqa %xmm0, %xmm1
...
; SSE2-NEXT:    imulq %r14, %r15
; SSE2-NEXT:    addq %rdi, %r8
; SSE2-NEXT:    adcq %r15, %r9
; SSE2-NEXT:    movq %r9, %r14
; SSE2-NEXT:    sarq $63, %r14
; SSE2-NEXT:    movq %r11, %r15
; SSE2-NEXT:    sarq $63, %r15
; SSE2-NEXT:    imulq %r10, %r15
; SSE2-NEXT:    movq %r10, %rax
; SSE2-NEXT:    mulq %r11
; SSE2-NEXT:    movq %rdx, %rdi
; SSE2-NEXT:    movq %rax, %r10
; SSE2-NEXT:    addq %r8, %r10
; SSE2-NEXT:    adcq %r15, %rdi
; SSE2-NEXT:    movq %rdi, %r8
; SSE2-NEXT:    sarq $63, %r8
; SSE2-NEXT:    addq %r9, %rdi
; SSE2-NEXT:    adcq %r14, %r8
; SSE2-NEXT:    movq %rbx, %rax
; SSE2-NEXT:    imulq %r11
; SSE2-NEXT:    addq %rdi, %rax
; SSE2-NEXT:    adcq %r8, %rdx
...
; SSSE3-NEXT:    imulq %r8, %r13
; SSSE3-NEXT:    addq %rsi, %r14
; SSSE3-NEXT:    adcq %r13, %r15
; SSSE3-NEXT:    movq %r15, %r8
; SSSE3-NEXT:    sarq $63, %r8
; SSSE3-NEXT:    movq %r9, %r13
; SSSE3-NEXT:    sarq $63, %r13
; SSSE3-NEXT:    imulq %rdi, %r13
; SSSE3-NEXT:    movq %rdi, %rax
; SSSE3-NEXT:    mulq %r9
...
; SSSE3-NEXT:    imulq %r14, %r15
; SSSE3-NEXT:    addq %rdi, %r8
; SSSE3-NEXT:    adcq %r15, %r9
; SSSE3-NEXT:    movq %r9, %r14
; SSSE3-NEXT:    sarq $63, %r14
; SSSE3-NEXT:    movq %r11, %r15
; SSSE3-NEXT:    sarq $63, %r15
; SSSE3-NEXT:    imulq %r10, %r15
; SSSE3-NEXT:    movq %r10, %rax
; SSSE3-NEXT:    mulq %r11
; SSSE3-NEXT:    movq %rdx, %rdi
; SSSE3-NEXT:    movq %rax, %r10
; SSSE3-NEXT:    addq %r8, %r10
; SSSE3-NEXT:    adcq %r15, %rdi
; SSSE3-NEXT:    movq %rdi, %r8
; SSSE3-NEXT:    sarq $63, %r8
; SSSE3-NEXT:    addq %r9, %rdi
; SSSE3-NEXT:    adcq %r14, %r8
; SSSE3-NEXT:    movq %rbx, %rax
; SSSE3-NEXT:    imulq %r11
; SSSE3-NEXT:    addq %rdi, %rax
; SSSE3-NEXT:    adcq %r8, %rdx
...
; SSE41-NEXT:    imulq %r8, %r13
; SSE41-NEXT:    addq %rsi, %r14
; SSE41-NEXT:    adcq %r13, %r15
; SSE41-NEXT:    movq %r15, %r8
; SSE41-NEXT:    sarq $63, %r8
; SSE41-NEXT:    movq %r9, %r13
; SSE41-NEXT:    sarq $63, %r13
; SSE41-NEXT:    imulq %rdi, %r13
; SSE41-NEXT:    movq %rdi, %rax
; SSE41-NEXT:    mulq %r9
...
; SSE41-NEXT:    addq %r15, %rdi
; SSE41-NEXT:    adcq %r8, %r14
; SSE41-NEXT:    movq %r11, %rax
; SSE41-NEXT:    imulq %r9
...
; SSE41-NEXT:    movq %rcx, %r15
; SSE41-NEXT:    sarq $63, %r15
; SSE41-NEXT:    imulq %r9, %r15
...
; SSE41-NEXT:    movq %rdx, %r8
; SSE41-NEXT:    imulq %r10, %r15
; SSE41-NEXT:    addq %r14, %r9
; SSE41-NEXT:    adcq %r15, %r8
; SSE41-NEXT:    movq %r8, %r10
; SSE41-NEXT:    sarq $63, %r10
; SSE41-NEXT:    addq %r11, %r8
; SSE41-NEXT:    adcq %r13, %r10
...
; SSE41-NEXT:    movq %rsi, 8(%r12)
; SSE41-NEXT:    movq %rdi, 16(%r12)
...
; AVX-NEXT:    imulq %r8, %r13
; AVX-NEXT:    addq %rsi, %r14
; AVX-NEXT:    adcq %r13, %r15
; AVX-NEXT:    movq %r15, %r8
; AVX-NEXT:    sarq $63, %r8
...
; AVX-NEXT:    addq %r15, %rdi
; AVX-NEXT:    adcq %r8, %r14
; AVX-NEXT:    movq %r11, %rax
; AVX-NEXT:    imulq %r9
...
; AVX-NEXT:    movq %rdx, %r8
; AVX-NEXT:    imulq %r10, %r15
; AVX-NEXT:    addq %r14, %r9
; AVX-NEXT:    adcq %r15, %r8
; AVX-NEXT:    movq %r8, %r10
; AVX-NEXT:    sarq $63, %r10
; AVX-NEXT:    addq %r11, %r8
; AVX-NEXT:    adcq %r13, %r10
...
; AVX-NEXT:    movq %rsi, 8(%r12)
; AVX-NEXT:    movq %rdi, 16(%r12)
...
; AVX512BW-NEXT:    vpcmpeqd %xmm0, %xmm0, %xmm0
; AVX512BW-NEXT:    vmovdqa32 %xmm0, %xmm0 {%k1} {z}
; AVX512BW-NEXT:    movq %rcx, 16(%r15)
; AVX512BW-NEXT:    movq %r10, (%r15)
