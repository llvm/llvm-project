...
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vpsrldq {{.*#+}} xmm3 = xmm5[14,15],zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero
...
; AVX512-NEXT:    vpshufd {{.*#+}} xmm0 = xmm2[3,3,3,3]
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm0
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
...
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3]
; AVX512-NEXT:    vpsrldq {{.*#+}} xmm0 = xmm2[10,11,12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,zero,zero
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm0
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
...
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovss %xmm0, %xmm6, %xmm6 {%k2}
; AVX512-NEXT:    vcvtps2ph $4, %xmm6, %xmm7
; AVX512-NEXT:    vcvtph2ps %xmm7, %xmm6
...
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovss %xmm0, %xmm8, %xmm8 {%k2}
; AVX512-NEXT:    vcvtps2ph $4, %xmm8, %xmm9
; AVX512-NEXT:    vcvtph2ps %xmm9, %xmm8
; AVX512-NEXT:    vmovss %xmm8, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm8
; AVX512-NEXT:    seta %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovss %xmm8, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm8
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX512-NEXT:    vpunpckldq {{.*#+}} xmm10 = xmm0[0],xmm10[0],xmm0[1],xmm10[1]
; AVX512-NEXT:    vpsrlq $48, %xmm2, %xmm0
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm0
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vpsrlq $48, %xmm5, %xmm11
; AVX512-NEXT:    vcvtph2ps %xmm11, %xmm11
; AVX512-NEXT:    vucomiss %xmm11, %xmm11
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovss %xmm0, %xmm11, %xmm11 {%k2}
; AVX512-NEXT:    vcvtps2ph $4, %xmm11, %xmm11
; AVX512-NEXT:    vcvtph2ps %xmm11, %xmm13
; AVX512-NEXT:    vmovss %xmm13, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm12
; AVX512-NEXT:    vucomiss %xmm12, %xmm13
; AVX512-NEXT:    seta %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovss %xmm13, %xmm12, %xmm12 {%k1}
; AVX512-NEXT:    vmovshdup {{.*#+}} xmm0 = xmm2[1,1,3,3]
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm0
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
...
; AVX512-NEXT:    vucomiss %xmm13, %xmm13
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovss %xmm0, %xmm13, %xmm13 {%k2}
; AVX512-NEXT:    vcvtps2ph $4, %xmm13, %xmm13
; AVX512-NEXT:    vcvtph2ps %xmm13, %xmm15
; AVX512-NEXT:    vmovss %xmm15, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm14
; AVX512-NEXT:    vucomiss %xmm14, %xmm15
; AVX512-NEXT:    seta %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovss %xmm15, %xmm14, %xmm14 {%k1}
; AVX512-NEXT:    vcvtph2ps %xmm2, %xmm0
; AVX512-NEXT:    vucomiss %xmm0, %xmm0
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vcvtph2ps %xmm5, %xmm15
; AVX512-NEXT:    vucomiss %xmm15, %xmm15
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k2
; AVX512-NEXT:    vmovss %xmm0, %xmm15, %xmm15 {%k2}
; AVX512-NEXT:    vcvtps2ph $4, %xmm15, %xmm15
; AVX512-NEXT:    vcvtph2ps %xmm15, %xmm1
; AVX512-NEXT:    vmovss %xmm1, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; AVX512-NEXT:    vcvtph2ps %xmm0, %xmm0
...
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovss %xmm1, %xmm0, %xmm0 {%k1}
; AVX512-NEXT:    vpsrld $16, %xmm2, %xmm1
; AVX512-NEXT:    vcvtph2ps %xmm1, %xmm1
; AVX512-NEXT:    vucomiss %xmm1, %xmm1
; AVX512-NEXT:    setp %al
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vpsrld $16, %xmm5, %xmm2
...
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vmovss %xmm2, %xmm1, %xmm1 {%k1}
; AVX512-NEXT:    vcvtps2ph $4, %xmm12, %xmm2
; AVX512-NEXT:    vcvtps2ph $4, %xmm14, %xmm12
; AVX512-NEXT:    vcvtps2ph $4, %xmm0, %xmm14
; AVX512-NEXT:    vcvtps2ph $4, %xmm1, %xmm1
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm12[0],xmm2[0],xmm12[1],xmm2[1],xmm12[2],xmm2[2],xmm12[3],xmm2[3]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm14[0],xmm1[0],xmm14[1],xmm1[1],xmm14[2],xmm1[2],xmm14[3],xmm1[3]
; AVX512-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
; AVX512-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm10[0]
; AVX512-NEXT:    vpunpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm3, %xmm3 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm9[0],xmm7[0],xmm9[1],xmm7[1],xmm9[2],xmm7[2],xmm9[3],xmm7[3]
; AVX512-NEXT:    vpunpckldq {{.*#+}} xmm3 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3]
; AVX512-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm15[0],xmm5[0],xmm15[1],xmm5[1],xmm15[2],xmm5[2],xmm15[3],xmm5[3]
...
; AVX512-NEXT:    vpcmpeqw %xmm4, %xmm3, %xmm4
; AVX512-NEXT:    vpblendvb %xmm4, %xmm3, %xmm0, %xmm3
; AVX512-NEXT:    vcvtph2ps %xmm1, %xmm1
...
; AVX512-NEXT:    vcvtph2ps %xmm6, %xmm1
; AVX512-NEXT:    vucomiss %xmm4, %xmm1
