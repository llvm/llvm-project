...
; AVX2-NEXT:    vmovss %xmm0, -24(%rsp,%rdx,4)
...
; AVX2-NEXT:    vpackuswb %xmm4, %xmm2, %xmm2
...
; AVX512F-NEXT:    vpsrlw $15, %ymm3, %ymm3
; AVX512F-NEXT:    vextracti128 $1, %ymm3, %xmm4
; AVX512F-NEXT:    vpackuswb %xmm4, %xmm3, %xmm3
; AVX512F-NEXT:    vpxor %xmm4, %xmm4, %xmm4
; AVX512F-NEXT:    vpsadbw %xmm4, %xmm3, %xmm3
...
; AVX512F-NEXT:    vpmovdw %zmm3, %ymm5
; AVX512F-NEXT:    vpsrlw $15, %ymm5, %ymm5
; AVX512F-NEXT:    vextracti128 $1, %ymm5, %xmm6
; AVX512F-NEXT:    vpackuswb %xmm6, %xmm5, %xmm5
...
; AVX512F-NEXT:    vpmovdw %zmm0, %ymm4
; AVX512F-NEXT:    vpsrlw $15, %ymm4, %ymm4
; AVX512F-NEXT:    vextracti128 $1, %ymm4, %xmm5
; AVX512F-NEXT:    vpackuswb %xmm5, %xmm4, %xmm4
; AVX512F-NEXT:    vpxor %xmm5, %xmm5, %xmm5
; AVX512F-NEXT:    vpsadbw %xmm5, %xmm4, %xmm4
...
; AVX512F-NEXT:    vpsadbw %xmm5, %xmm1, %xmm1
...
; AVX512VL-NEXT:    vpmovm2w %k1, %ymm0
...
; AVX512VL-NEXT:    vmovq %xmm0, %rax
; AVX512VL-NEXT:    andl $31, %eax
; AVX512VL-NEXT:    vpcompressd %zmm4, %zmm0 {%k2} {z}
; AVX512VL-NEXT:    vmovdqa64 %zmm0, 128(%rsp,%rax,4)
; AVX512VL-NEXT:    vmovdqa64 (%rsp), %zmm0
; AVX512VL-NEXT:    vmovaps {{[0-9]+}}(%rsp), %zmm1
; AVX512VL-NEXT:    vmovdqa64 %zmm0, {{[0-9]+}}(%rsp)
; AVX512VL-NEXT:    vpternlogd {{.*#+}} zmm0 {%k3} {z} = -1
; AVX512VL-NEXT:    vpsrld $31, %zmm0, %zmm0
; AVX512VL-NEXT:    vpternlogd {{.*#+}} zmm2 = -1
; AVX512VL-NEXT:    vpsubd %zmm2, %zmm0, %zmm0 {%k1}
; AVX512VL-NEXT:    vextracti64x4 $1, %zmm0, %ymm2
; AVX512VL-NEXT:    vpaddd %ymm2, %ymm0, %ymm0
; AVX512VL-NEXT:    vextracti128 $1, %ymm0, %xmm2
; AVX512VL-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
; AVX512VL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[2,3,2,3]
; AVX512VL-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
; AVX512VL-NEXT:    vpshufd {{.*#+}} xmm2 = xmm0[1,1,1,1]
; AVX512VL-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
