...
; CHECK-NEXT:    vpmovsxdq %ymm3, %zmm3
; CHECK-NEXT:    vpaddq %zmm3, %zmm3, %zmm3
; CHECK-NEXT:    vpaddq %zmm3, %zmm2, %zmm3
...
; CHECK-NEXT:    vmovsh %xmm2, (%rax)
; CHECK-NEXT:    vmovshdup {{.*#+}} xmm2 = xmm1[1,1,3,3]
...
; CHECK-NEXT:    vextracti32x4 $2, %zmm3, %xmm2
; CHECK-NEXT:    vmovq %xmm2, %rax
; CHECK-NEXT:    vmovsh %xmm1, (%rax)
...
; CHECK-NEXT:    vextracti32x4 $3, %zmm3, %xmm2
; CHECK-NEXT:    vmovq %xmm2, %rax
; CHECK-NEXT:    vmovsh %xmm1, (%rax)
...
; CHECK-NEXT:    retq
{
  %gep = getelementptr half, ptr %base, <16 x i32> %index
  call void @llvm.masked.scatter.v16f16.v16p0(<16 x half> %val, <16 x ptr> %gep, i32 4, <16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>)
  ret void
}
