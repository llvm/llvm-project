...
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm0, %xmm0 ## encoding: [0xc4,0xe3,0x79,0x21,0x44,0x24,0x18,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm0 = xmm0[0],mem[0],zero,zero
...
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm0, %xmm0 ## encoding: [0xc4,0xe3,0x79,0x21,0x44,0x24,0x28,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm0 = xmm0[0],mem[0],zero,zero
; FMACALL32_BDVER2-NEXT:    vmovss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; FMACALL32_BDVER2-NEXT:    ## encoding: [0xc5,0xfa,0x10,0x4c,0x24,0x1c]
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm1, %xmm1 ## encoding: [0xc4,0xe3,0x71,0x21,0x4c,0x24,0x18,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm1 = xmm1[0],mem[0],zero,zero
...
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm0, %xmm0 ## encoding: [0xc4,0xe3,0x79,0x21,0x44,0x24,0x38,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm0 = xmm0[0],mem[0],zero,zero
; FMACALL32_BDVER2-NEXT:    vmovss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; FMACALL32_BDVER2-NEXT:    ## encoding: [0xc5,0xfa,0x10,0x4c,0x24,0x2c]
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm1, %xmm1 ## encoding: [0xc4,0xe3,0x71,0x21,0x4c,0x24,0x28,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm1 = xmm1[0],mem[0],zero,zero
; FMACALL32_BDVER2-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; FMACALL32_BDVER2-NEXT:    ## encoding: [0xc5,0xfa,0x10,0x54,0x24,0x4c]
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm2, %xmm2 ## encoding: [0xc4,0xe3,0x69,0x21,0x54,0x24,0x48,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm2 = xmm2[0],mem[0],zero,zero
...
; FMACALL32_BDVER2-NEXT:    vinsertps $28, {{[0-9]+}}(%esp), %xmm1, %xmm1 ## encoding: [0xc4,0xe3,0x71,0x21,0x4c,0x24,0x58,0x1c]
; FMACALL32_BDVER2-NEXT:    ## xmm1 = xmm1[0],mem[0],zero,zero
