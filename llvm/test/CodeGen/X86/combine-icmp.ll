...
; SSE-NEXT:    retq
;
; AVX-LABEL: concat_icmp_v64i8_v16i8:
; AVX:       # %bb.0:
; AVX-NEXT:    movq $-1, %rax
; AVX-NEXT:    retq
  %v0 = icmp uge <16 x i8> %a0, zeroinitializer
  %v1 = icmp uge <16 x i8> %a1, zeroinitializer
  %v2 = icmp uge <16 x i8> %a2, zeroinitializer
  %v3 = icmp uge <16 x i8> %a3, zeroinitializer
