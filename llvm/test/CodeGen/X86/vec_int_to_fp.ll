...
; SSE2-NEXT:    movq 8(%rdi), %rcx
; SSE2-NEXT:    testq %rcx, %rcx
; SSE2-NEXT:    js .LBB87_9
; SSE2-NEXT:  # %bb.7:
; SSE2-NEXT:    cvtsi2ss %rcx, %xmm3
; SSE2-NEXT:    testq %rax, %rax
; SSE2-NEXT:    jns .LBB87_10
; SSE2-NEXT:  .LBB87_8:
; SSE2-NEXT:    movq %rax, %rcx
; SSE2-NEXT:    shrq %rcx
; SSE2-NEXT:    andl $1, %eax
