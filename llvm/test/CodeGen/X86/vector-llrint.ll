...
; X64-AVX-NEXT:    retq
;
; X64-AVX-512-LABEL: llrint_v2i64_v2f64:
; X64-AVX-512:       # %bb.0:
; X64-AVX-512-NEXT:    vcvtpd2qq %xmm0, %xmm0
; X64-AVX-512-NEXT:    retq
...
; X64-SSE-NEXT:    retq
;
; X64-AVX-LABEL: llrint_v4i64_v4f64:
; X64-AVX:       # %bb.0:
; X64-AVX-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X64-AVX-NEXT:    vcvtsd2si %xmm1, %rax
; X64-AVX-NEXT:    vmovq %rax, %xmm2
; X64-AVX-NEXT:    vshufpd {{.*#+}} xmm1 = xmm1[1,0]
; X64-AVX-NEXT:    vcvtsd2si %xmm1, %rax
; X64-AVX-NEXT:    vmovq %rax, %xmm1
; X64-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; X64-AVX-NEXT:    vcvtsd2si %xmm0, %rax
...
; X64-AVX-NEXT:    retq
;
; X64-AVX-512-LABEL: llrint_v4i64_v4f64:
; X64-AVX-512:       # %bb.0:
; X64-AVX-512-NEXT:    vcvtpd2qq %ymm0, %ymm0
; X64-AVX-512-NEXT:    retq
...
; X64-SSE-NEXT:    retq
;
; X64-AVX-LABEL: llrint_v8i64_v8f64:
; X64-AVX:       # %bb.0:
; X64-AVX-NEXT:    vextractf128 $1, %ymm0, %xmm2
; X64-AVX-NEXT:    vcvtsd2si %xmm2, %rax
; X64-AVX-NEXT:    vmovq %rax, %xmm3
; X64-AVX-NEXT:    vshufpd {{.*#+}} xmm2 = xmm2[1,0]
; X64-AVX-NEXT:    vcvtsd2si %xmm2, %rax
; X64-AVX-NEXT:    vmovq %rax, %xmm2
; X64-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm2 = xmm3[0],xmm2[0]
; X64-AVX-NEXT:    vcvtsd2si %xmm0, %rax
...
; X64-AVX-NEXT:    vextractf128 $1, %ymm1, %xmm2
; X64-AVX-NEXT:    vcvtsd2si %xmm2, %rax
; X64-AVX-NEXT:    vmovq %rax, %xmm3
; X64-AVX-NEXT:    vshufpd {{.*#+}} xmm2 = xmm2[1,0]
; X64-AVX-NEXT:    vcvtsd2si %xmm2, %rax
...
; X64-AVX-NEXT:    vmovq %rax, %xmm1
; X64-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm3[0],xmm1[0]
; X64-AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; X64-AVX-NEXT:    retq
;
; X64-AVX-512-LABEL: llrint_v8i64_v8f64:
; X64-AVX-512:       # %bb.0:
; X64-AVX-512-NEXT:    vcvtpd2qq %zmm0, %zmm0
; X64-AVX-512-NEXT:    retq
