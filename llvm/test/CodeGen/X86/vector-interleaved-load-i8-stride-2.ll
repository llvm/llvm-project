...
; SSE-NEXT:    movdqa %xmm8, 32(%rsi)
; SSE-NEXT:    movdqa %xmm12, 48(%rsi)
; SSE-NEXT:    movdqa %xmm11, (%rsi)
; SSE-NEXT:    movdqa %xmm10, 16(%rsi)
