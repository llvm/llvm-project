...
; AVX512-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm2 = [0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14]
; AVX512-FCP-NEXT:    vpshufb %ymm2, %ymm1, %ymm3
; AVX512-FCP-NEXT:    vpshufb %ymm2, %ymm0, %ymm2
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} ymm4 = [0,2,5,7]
; AVX512-FCP-NEXT:    vpermt2q %ymm3, %ymm4, %ymm2
...
; AVX512DQ-FCP-NEXT:    vpbroadcastq {{.*#+}} ymm2 = [0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14,0,2,4,6,8,10,12,14]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm1, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm0, %ymm2
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} ymm4 = [0,2,5,7]
; AVX512DQ-FCP-NEXT:    vpermt2q %ymm3, %ymm4, %ymm2
