...
define void @single_v8f32(<8 x float> noundef %x) #5 {
; CHECK-LABEL: define {{[^@]+}}@single_v8f32(<8 x float> noundef %x) #5 {
; CHECK-NEXT:  entry:
...
define void @single_v16f32(<16 x float> noundef %x) #6 {
; CHECK-LABEL: define {{[^@]+}}@single_v16f32(<16 x float> noundef %x) #6 {
; CHECK-NEXT:  entry:
...
define void @single_v32f32(<32 x float> noundef %x) #7 {
; CHECK-LABEL: define {{[^@]+}}@single_v32f32(<32 x float> noundef %x) #7 {
; CHECK-NEXT:  entry:
...
define void @i32_libcS(i32 noundef %x, ptr noundef byval(%struct.libcS) align 4 %y) #0 {
; CHECK-LABEL: define {{[^@]+}}@i32_libcS(i32 noundef %x, ptr noundef byval(%struct.libcS) align 4 %y) #0 {
; CHECK-NEXT:  entry:
...
define void @libcS_i32(ptr noundef byval(%struct.libcS) align 4 %x, i32 noundef %y) #0 {
; CHECK-LABEL: define {{[^@]+}}@libcS_i32(ptr noundef byval(%struct.libcS) align 4 %x, i32 noundef %y) #0 {
; CHECK-NEXT:  entry:
...
define void @i32_v8f32(i32 noundef %x, <8 x float> noundef %y) #5 {
; CHECK-LABEL: define {{[^@]+}}@i32_v8f32(i32 noundef %x, <8 x float> noundef %y) #5 {
; CHECK-NEXT:  entry:
...
define void @v8f32_i32(<8 x float> noundef %x, i32 noundef %y) #5 {
; CHECK-LABEL: define {{[^@]+}}@v8f32_i32(<8 x float> noundef %x, i32 noundef %y) #5 {
; CHECK-NEXT:  entry:
...
define void @i32_v16f32(i32 noundef %x, <16 x float> noundef %y) #6 {
; CHECK-LABEL: define {{[^@]+}}@i32_v16f32(i32 noundef %x, <16 x float> noundef %y) #6 {
; CHECK-NEXT:  entry:
...
define void @v16f32_i32(<16 x float> noundef %x, i32 noundef %y) #6 {
; CHECK-LABEL: define {{[^@]+}}@v16f32_i32(<16 x float> noundef %x, i32 noundef %y) #6 {
; CHECK-NEXT:  entry:
...
define void @i32_v32f32(i32 noundef %x, <32 x float> noundef %y) #7 {
; CHECK-LABEL: define {{[^@]+}}@i32_v32f32(i32 noundef %x, <32 x float> noundef %y) #7 {
; CHECK-NEXT:  entry:
...
define void @v32f32_i32(<32 x float> noundef %x, i32 noundef %y) #7 {
; CHECK-LABEL: define {{[^@]+}}@v32f32_i32(<32 x float> noundef %x, i32 noundef %y) #7 {
; CHECK-NEXT:  entry:
