...
; AVX512VL-NEXT:    vpmovd2m %ymm0, %k0
; AVX512VL-NEXT:    kortestb %k0, %k0
; AVX512VL-NEXT:    setne %al
; AVX512VL-NEXT:    negb %al
; AVX512VL-NEXT:    vzeroupper
...
; X86-SSE4-NEXT:    testl $43690, %eax # imm = 0xAAAA
...
; X64-SSE4-NEXT:    testl $43690, %eax # imm = 0xAAAA
...
; X86-AVX1-NEXT:    vpcmpeqq 24(%ebp), %xmm4, %xmm4
; X86-AVX1-NEXT:    vpor %xmm4, %xmm3, %xmm3
...
; X64-AVX1-NEXT:    vpcmpeqq %xmm5, %xmm6, %xmm5
...
; X64-AVX1-NEXT:    vpackssdw %xmm4, %xmm0, %xmm0
