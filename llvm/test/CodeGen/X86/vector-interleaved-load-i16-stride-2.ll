...
; AVX2-NEXT:    vpmovsxdq {{.*#+}} ymm2 = [84148480,218892552,353636624,488380696]
; AVX2-NEXT:    vpshufb %ymm2, %ymm1, %ymm3
; AVX2-NEXT:    vpshufb %ymm2, %ymm0, %ymm2
; AVX2-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
...
; AVX2-NEXT:    vpmovsxdq {{.*#+}} ymm4 = [84148480,218892552,353636624,488380696]
; AVX2-NEXT:    vpshufb %ymm4, %ymm3, %ymm5
; AVX2-NEXT:    vpshufb %ymm4, %ymm2, %ymm6
; AVX2-NEXT:    vshufps {{.*#+}} ymm5 = ymm6[0,2],ymm5[0,2],ymm6[4,6],ymm5[4,6]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm4, %ymm1, %ymm6
; AVX2-NEXT:    vpshufb %ymm4, %ymm0, %ymm4
; AVX2-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,2],ymm6[0,2],ymm4[4,6],ymm6[4,6]
...
; AVX2-NEXT:    vpmovsxdq {{.*#+}} ymm9 = [84148480,218892552,353636624,488380696]
; AVX2-NEXT:    vpshufb %ymm9, %ymm8, %ymm2
; AVX2-NEXT:    vpshufb %ymm9, %ymm7, %ymm10
; AVX2-NEXT:    vshufps {{.*#+}} ymm2 = ymm10[0,2],ymm2[0,2],ymm10[4,6],ymm2[4,6]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm9, %ymm4, %ymm10
; AVX2-NEXT:    vpshufb %ymm9, %ymm3, %ymm11
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[0,2],ymm10[0,2],ymm11[4,6],ymm10[4,6]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm9, %ymm6, %ymm11
; AVX2-NEXT:    vpshufb %ymm9, %ymm5, %ymm12
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[0,2],ymm11[0,2],ymm12[4,6],ymm11[4,6]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,1,3]
; AVX2-NEXT:    vpshufb %ymm9, %ymm1, %ymm12
; AVX2-NEXT:    vpshufb %ymm9, %ymm0, %ymm9
; AVX2-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[0,2],ymm12[0,2],ymm9[4,6],ymm12[4,6]
...
; AVX2-NEXT:    vpshufb %ymm12, %ymm6, %ymm4
