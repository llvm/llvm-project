...
; EGPR-NEXT:    movl $buf+2048, %ecx # encoding: [0xb9,A,A,A,A]
; EGPR-NEXT:    # fixup A - offset: 1, value: buf+2048, kind: FK_Data_4
; EGPR-NEXT:    tileloadd (%rcx,%rax), %tmm5 # EVEX TO VEX Compression encoding: [0xc4,0xe2,0x7b,0x4b,0x2c,0x01]
