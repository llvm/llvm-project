...
define void @foo(i32 %M, i32 %N, i32 %K, ptr %A, ptr %B_rcr4, ptr %C, i32 %c_row_from, i32 %c_row_to, i32 %c_row_tile, i32 %c_col_from, i32 %c_col_to, i32 %c_col_tile) {
  ...
  ; CHECK-NEXT:   CMP32mr %fixed-stack.5, 1, $noreg, 0, $noreg, [[MOV32rm]], implicit-def $eflags :: (load (s32) from %fixed-stack.5, align 16)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   undef [[MOV32rm1:%[0-9]+]].sub_32bit:gr64_nosp = MOV32rm %fixed-stack.0, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.0, align 8)
  ; CHECK-NEXT:   MOV16mr %stack.0, 1, $noreg, 16, $noreg, [[MOV32rm1]].sub_16bit :: (store (s512) into %stack.0 + 16, align 4)
  ...
  ; CHECK-NEXT:   MOV8mr %stack.0, 1, $noreg, 50, $noreg, [[MOVZX32rr16_]].sub_8bit :: (store (s512) into %stack.0 + 50, align 2, basealign 4)
  ; CHECK-NEXT:   [[LEA64_32r1:%[0-9]+]]:gr32 = LEA64_32r $noreg, 4, [[MOV32rm1]], 0, $noreg
  ...
  ; CHECK-NEXT:   [[MOVSX64rr32_:%[0-9]+]]:gr64 = MOVSX64rr32 [[COPY2]].sub_32bit
  ; CHECK-NEXT:   MOV64mr %stack.3, 1, $noreg, 0, $noreg, [[MOVSX64rr32_]] :: (store (s64) into %stack.3)
  ...
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:gr32 = COPY [[LEA64_32r1]]
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:gr32 = COPY [[COPY4]]
  ; CHECK-NEXT:   ADD64mr %stack.1, 1, $noreg, 0, $noreg, [[MOVZX32rr16_1]], implicit-def dead $eflags :: (store (s64) into %stack.1)
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:gr64 = COPY [[COPY]]
  ; CHECK-NEXT:   undef [[COPY8:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = COPY [[MOVZX32rr16_1]].sub_32bit
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]].sub_32bit:gr64_with_sub_8bit = IMUL32rr [[COPY8]].sub_32bit, [[COPY3]].sub_32bit, implicit-def dead $eflags
  ; CHECK-NEXT:   [[LEA64_32r2:%[0-9]+]]:gr32 = LEA64_32r $noreg, 4, [[COPY3]], 0, $noreg
  ; CHECK-NEXT:   [[MOVSX64rr32_1:%[0-9]+]]:gr64 = MOVSX64rr32 [[LEA64_32r2]]
  ; CHECK-NEXT:   MOV64mr %stack.10, 1, $noreg, 0, $noreg, [[MOVSX64rr32_1]] :: (store (s64) into %stack.10)
  ...
  ; CHECK-NEXT:   [[MOVSX64rr32_3:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[MOV32rm1]].sub_32bit
  ; CHECK-NEXT:   [[MOVSX64rm32_1:%[0-9]+]]:gr64 = MOVSX64rm32 %fixed-stack.1, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.1, align 16)
  ; CHECK-NEXT:   [[MOVSX64rm32_2:%[0-9]+]]:gr64 = MOVSX64rm32 %fixed-stack.5, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.5, align 16)
  ; CHECK-NEXT:   [[MOVSX64rr32_4:%[0-9]+]]:gr64 = MOVSX64rr32 [[MOV32rm2]]
  ; CHECK-NEXT:   [[MOVSX64rm32_3:%[0-9]+]]:gr64 = MOVSX64rm32 %fixed-stack.4, 1, $noreg, 0, $noreg :: (load (s32) from %fixed-stack.4, align 8)
  ; CHECK-NEXT:   MOV64mr %stack.7, 1, $noreg, 0, $noreg, [[MOVSX64rm32_3]] :: (store (s64) into %stack.7)
  ; CHECK-NEXT:   MOV64mr %stack.11, 1, $noreg, 0, $noreg, [[COPY1]] :: (store (s64) into %stack.11)
  ; CHECK-NEXT:   MOV64mr %stack.5, 1, $noreg, 0, $noreg, [[MOVSX64rm32_2]] :: (store (s64) into %stack.5)
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr64_nosp = COPY [[MOVSX64rm32_2]]
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr64_nosp = IMUL64rr [[COPY9]], [[MOVSX64rr32_2]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:gr64_nosp = ADD64rr [[COPY9]], [[MOVSX64rm32_]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[LEA64r:%[0-9]+]]:gr64 = LEA64r [[COPY7]], 4, [[COPY9]], 0, $noreg
  ; CHECK-NEXT:   MOV64mr %stack.8, 1, $noreg, 0, $noreg, [[LEA64r]] :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:gr64_with_sub_8bit = COPY [[MOV32rm1]]
  ; CHECK-NEXT:   MOV64mr %stack.6, 1, $noreg, 0, $noreg, [[MOVSX64rr32_4]] :: (store (s64) into %stack.6)
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_4]]
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr64 = IMUL64rr [[COPY11]], [[MOVSX64rr32_2]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:gr64 = SHL64ri [[COPY11]], 2, implicit-def dead $eflags
  ; CHECK-NEXT:   MOV64mr %stack.9, 1, $noreg, 0, $noreg, [[COPY11]] :: (store (s64) into %stack.9)
  ...
  ; CHECK-NEXT:   [[LEA64_32r3:%[0-9]+]]:gr32 = LEA64_32r [[COPY8]], 4, [[MOVSX64rm32_]], 0, $noreg
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV64rm:%[0-9]+]]:gr64 = MOV64rm %stack.5, 1, $noreg, 0, $noreg :: (load (s64) from %stack.5)
  ; CHECK-NEXT:   [[MOV64rm:%[0-9]+]]:gr64 = IMUL64rm [[MOV64rm]], %stack.3, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   [[MOV64rm:%[0-9]+]]:gr64 = ADD64rm [[MOV64rm]], %stack.1, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.1)
  ; CHECK-NEXT:   [[MOV32rm4:%[0-9]+]]:gr32 = MOV32rm %stack.12, 1, $noreg, 0, $noreg :: (load (s32) from %stack.12)
  ; CHECK-NEXT:   undef [[COPY12:%[0-9]+]].sub_32bit:gr64_nosp = COPY [[MOV32rm4]]
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = MOV64rm %stack.8, 1, $noreg, 0, $noreg :: (load (s64) from %stack.8)
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = MOV64rm %stack.4, 1, $noreg, 0, $noreg :: (load (s64) from %stack.4)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[MOV64rm3:%[0-9]+]]:gr64 = MOV64rm %stack.5, 1, $noreg, 0, $noreg :: (load (s64) from %stack.5)
  ; CHECK-NEXT:   [[MOV64rm3:%[0-9]+]]:gr64 = ADD64rm [[MOV64rm3]], %stack.6, 1, $noreg, 0, $noreg, implicit-def dead $eflags :: (load (s64) from %stack.6)
  ; CHECK-NEXT:   [[MOV64rm4:%[0-9]+]]:gr64 = MOV64rm %stack.9, 1, $noreg, 0, $noreg :: (load (s64) from %stack.9)
  ; CHECK-NEXT:   ADD64mr %stack.8, 1, $noreg, 0, $noreg, [[MOV64rm4]], implicit-def dead $eflags :: (store (s64) into %stack.8)
  ; CHECK-NEXT:   MOV64mr %stack.5, 1, $noreg, 0, $noreg, [[MOV64rm3]] :: (store (s64) into %stack.5)
  ; CHECK-NEXT:   CMP64rm [[MOV64rm3]], %stack.7, 1, $noreg, 0, $noreg, implicit-def $eflags :: (load (s64) from %stack.7)
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTILEZEROV [[MOV32rm2]].sub_16bit, [[COPY10]].sub_16bit
  ; CHECK-NEXT:   [[MOV64rm5:%[0-9]+]]:gr64_nosp = MOV64rm %stack.3, 1, $noreg, 0, $noreg :: (load (s64) from %stack.3)
  ; CHECK-NEXT:   [[PTILELOADDV:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm2]].sub_16bit, [[COPY6]].sub_16bit, [[MOV64rm]], 1, [[MOV64rm5]], 0, $noreg
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:gr64_nosp = MOVSX64rr32 [[COPY12]].sub_32bit
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:gr64 = COPY [[COPY10]]
  ; CHECK-NEXT:   [[MOV64rm6:%[0-9]+]]:gr64 = MOV64rm %stack.11, 1, $noreg, 0, $noreg :: (load (s64) from %stack.11)
  ; CHECK-NEXT:   [[LEA64r2:%[0-9]+]]:gr64 = LEA64r [[MOV64rm6]], 1, [[COPY12]], 0, $noreg
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:gr64 = COPY [[MOVSX64rm32_1]]
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_3]]
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:gr64 = COPY [[MOVSX64rr32_2]]
  ; CHECK-NEXT:   [[COPY17:%[0-9]+]]:gr64 = COPY [[LEA64r1]]
  ; CHECK-NEXT:   [[MOV32rm5:%[0-9]+]]:gr32 = MOV32rm %stack.2, 1, $noreg, 0, $noreg :: (load (s32) from %stack.2)
  ; CHECK-NEXT:   [[MOV64rm7:%[0-9]+]]:gr64_nosp = MOV64rm %stack.10, 1, $noreg, 0, $noreg :: (load (s64) from %stack.10)
  ; CHECK-NEXT:   [[PTILELOADDV1:%[0-9]+]]:tile = PTILELOADDV [[MOV32rm5]].sub_16bit, [[COPY5]].sub_16bit, [[LEA64r2]], 1, [[MOV64rm7]], 0, $noreg
  ; CHECK-NEXT:   [[LEA64r1:%[0-9]+]]:gr64 = COPY [[COPY17]]
  ; CHECK-NEXT:   [[MOVSX64rr32_2:%[0-9]+]]:gr64_nosp = COPY [[COPY16]]
  ; CHECK-NEXT:   [[MOVSX64rr32_3:%[0-9]+]]:gr64_nosp = COPY [[COPY15]]
  ; CHECK-NEXT:   [[MOVSX64rm32_1:%[0-9]+]]:gr64 = COPY [[COPY14]]
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:gr64_with_sub_8bit = COPY [[COPY13]]
  ; CHECK-NEXT:   [[PTILEZEROV:%[0-9]+]]:tile = PTDPBSSDV [[MOV32rm2]].sub_16bit, [[COPY5]].sub_16bit, [[COPY6]].sub_16bit, [[PTILEZEROV]], [[PTILELOADDV]], [[PTILELOADDV1]]
  ; CHECK-NEXT:   PTILESTOREDV [[MOV32rm2]].sub_16bit, [[COPY10]].sub_16bit, [[MOV64rm1]], 1, [[MOVSX64rr32_2]], 0, $noreg, [[PTILEZEROV]]
  ; CHECK-NEXT:   [[MOV64rm2:%[0-9]+]]:gr64 = ADD64rr [[MOV64rm2]], [[MOVSX64rr32_3]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[MOV64rm1:%[0-9]+]]:gr64 = ADD64rr [[MOV64rm1]], [[LEA64r1]], implicit-def dead $eflags
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]].sub_32bit:gr64_nosp = ADD32rr [[COPY12]].sub_32bit, [[COPY5]], implicit-def dead $eflags
  ; CHECK-NEXT:   CMP64rr [[MOV64rm2]], [[MOVSX64rm32_1]], implicit-def $eflags
