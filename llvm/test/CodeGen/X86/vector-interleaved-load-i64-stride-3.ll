...
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm5[1],ymm3[0],ymm5[3],ymm3[3]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm13[1],ymm9[0],ymm13[3],ymm9[3]
; AVX-NEXT:    vbroadcastsd 176(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm11[1],ymm5[0],ymm11[3],ymm5[3]
; AVX-NEXT:    vbroadcastsd 368(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm14[1],ymm8[0],ymm14[3],ymm8[3]
; AVX-NEXT:    vbroadcastsd 560(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm2[1],ymm10[0],ymm2[3],ymm10[3]
; AVX-NEXT:    vbroadcastsd 752(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm3[1],ymm4[0],ymm3[3],ymm4[3]
; AVX-NEXT:    vbroadcastsd 80(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm6[1],ymm7[0],ymm6[3],ymm7[3]
; AVX-NEXT:    vbroadcastsd 272(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm15[1],ymm12[0],ymm15[3],ymm12[3]
; AVX-NEXT:    vbroadcastsd 464(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 608(%rdi), %ymm1
; AVX-NEXT:    vblendpd {{.*#+}} ymm2 = mem[0,1],ymm1[2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm2[1],ymm1[0],ymm2[3],ymm1[3]
...
; AVX-NEXT:    vmovupd %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovupd {{[-0-9]+}}(%r{{[sb]}}p), %ymm4 # 32-byte Reload
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm4[1],ymm0[0],ymm4[3],ymm0[3]
...
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm0[1],ymm15[0],ymm0[3],ymm15[3]
; AVX-NEXT:    vbroadcastsd 464(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm12[1],ymm7[0],ymm12[3],ymm7[3]
; AVX-NEXT:    vbroadcastsd 656(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm9[1],ymm6[0],ymm9[3],ymm6[3]
; AVX-NEXT:    vbroadcastsd 848(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm5[1],ymm3[0],ymm5[3],ymm3[3]
; AVX-NEXT:    vbroadcastsd 1040(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm1[1],ymm13[0],ymm1[3],ymm13[3]
; AVX-NEXT:    vbroadcastsd 1232(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm0 = ymm4[0,1,2],ymm8[3]
; AVX-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovapd 1376(%rdi), %ymm8
; AVX-NEXT:    vblendpd {{.*#+}} ymm12 = mem[0,1],ymm8[2,3]
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm12[1],ymm8[0],ymm12[3],ymm8[3]
