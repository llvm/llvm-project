...
; AVX1-ONLY-NEXT:    vmovapd 32(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 64(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = ymm3[0],ymm1[1],ymm3[2],ymm1[3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm3[1],ymm0[0],ymm3[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm3
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm3[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
...
; AVX1-ONLY-NEXT:    vmovapd 32(%rdi), %xmm3
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm5[0],ymm2[1],ymm5[2],ymm2[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm7 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm7[0],ymm4[1],ymm7[2],ymm4[3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm5[1],ymm1[0],ymm5[3],ymm1[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm5
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm5[3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm7[1],ymm0[0],ymm7[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 176(%rdi), %ymm5
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm5[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2],ymm3[3]
; AVX1-ONLY-NEXT:    vmovapd 128(%rdi), %xmm3
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm4[0],ymm3[1],ymm4[2],ymm3[3]
; AVX1-ONLY-NEXT:    vmovapd %ymm8, 32(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm6, (%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm0, 32(%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm1, (%rdx)
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = mem[0,1],ymm4[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 64(%rdi), %ymm0, %ymm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm10[0],ymm6[1],ymm10[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovaps 208(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = mem[0,1],ymm8[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 256(%rdi), %ymm1, %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm11[0],ymm2[1],ymm11[2],ymm2[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm12 = mem[0,1],ymm7[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm9, %ymm9
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm4 = ymm10[1],ymm4[0],ymm10[3],ymm4[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm10
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1,2],ymm10[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = ymm12[0],ymm9[1],ymm12[2],ymm9[3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm8 = ymm11[1],ymm8[0],ymm11[3],ymm8[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 272(%rdi), %ymm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm8[0,1,2],ymm11[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = mem[0,1],ymm5[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm7 = ymm12[1],ymm7[0],ymm12[3],ymm7[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 176(%rdi), %ymm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm7 = ymm7[0,1,2],ymm12[3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm5 = ymm11[1],ymm5[0],ymm11[3],ymm5[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 368(%rdi), %ymm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm5 = ymm5[0,1,2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovaps 304(%rdi), %xmm12
; AVX1-ONLY-NEXT:    vinsertf128 $1, 352(%rdi), %ymm12, %ymm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0],ymm12[1],ymm11[2],ymm12[3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm6[0],ymm3[1],ymm6[2],ymm3[3]
; AVX1-ONLY-NEXT:    vmovapd 128(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm9[0],ymm6[1],ymm9[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovapd 224(%rdi), %xmm9
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0],ymm9[1],ymm2[2],ymm9[3]
; AVX1-ONLY-NEXT:    vmovapd 320(%rdi), %xmm9
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm12[0],ymm9[1],ymm12[2],ymm9[3]
; AVX1-ONLY-NEXT:    vmovapd %ymm11, 96(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm10, 32(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm1, 64(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm0, (%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm5, 96(%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm7, 32(%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm8, 64(%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm4, (%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm9, 96(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm2, 64(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm6, 32(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm3, (%rcx)
; AVX1-ONLY-NEXT:    vzeroupper
; AVX1-ONLY-NEXT:    retq
;
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm0, %ymm2
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2,3],ymm8[4,5,6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1,2,3,4,5],ymm2[6,7]
; AVX2-ONLY-NEXT:    vinsertf128 $1, 352(%rdi), %ymm0, %ymm4
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm12 = ymm6[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm5[4,5,6,7]
...
; AVX2-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm11
...
; AVX2-ONLY-NEXT:    vbroadcastsd 272(%rdi), %ymm10
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm10[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm9[2,3],ymm8[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 176(%rdi), %ymm9
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2,3,4,5],ymm9[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm6[2,3],ymm5[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 368(%rdi), %ymm6
...
; AVX2-ONLY-NEXT:    vmovaps 112(%rdi), %xmm9
...
; AVX2-ONLY-NEXT:    vmovaps 304(%rdi), %xmm11
...
; AVX1-ONLY-NEXT:    vmovapd 704(%rdi), %ymm9
; AVX1-ONLY-NEXT:    vmovapd 512(%rdi), %ymm11
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm14 = mem[0,1],ymm2[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = mem[0,1],ymm1[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = mem[0,1],ymm3[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm5 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm13 = mem[0,1],ymm6[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm15 = mem[0,1],ymm7[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = mem[0,1],ymm11[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm14[1],ymm2[0],ymm14[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1,2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm8[1],ymm1[0],ymm8[3],ymm1[2]
...
; AVX1-ONLY-NEXT:    vbroadcastsd 464(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm5[1],ymm0[0],ymm5[3],ymm0[2]
; AVX1-ONLY-NEXT:    vmovapd %ymm5, %ymm12
...
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm13[1],ymm6[0],ymm13[3],ymm6[2]
...
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm3[1],ymm9[0],ymm3[3],ymm9[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 752(%rdi), %ymm2
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm13[0],ymm1[1],ymm13[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovapd 128(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm13 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovaps 208(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 256(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm7 = ymm8[0],ymm1[1],ymm8[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovapd 224(%rdi), %xmm8
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm8[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm1[0],ymm8[1],ymm1[2],ymm8[3]
; AVX1-ONLY-NEXT:    vmovaps 304(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 352(%rdi), %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm15[0],ymm0[1],ymm15[2],ymm0[3]
; AVX1-ONLY-NEXT:    vmovapd 320(%rdi), %xmm15
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm15 = ymm15[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm15 = ymm0[0],ymm15[1],ymm0[2],ymm15[3]
...
; AVX1-ONLY-NEXT:    vmovapd 416(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm5 = ymm0[0],ymm6[1],ymm0[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovaps 496(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vinsertf128 $1, 544(%rdi), %ymm6, %ymm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm10[0],ymm6[1],ymm10[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovapd 512(%rdi), %xmm10
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = ymm10[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = ymm6[0],ymm10[1],ymm6[2],ymm10[3]
; AVX1-ONLY-NEXT:    vmovaps 592(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vinsertf128 $1, 640(%rdi), %ymm6, %ymm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm12[0],ymm6[1],ymm12[2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovapd 608(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0],ymm11[1],ymm6[2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovaps 688(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vinsertf128 $1, 736(%rdi), %ymm11, %ymm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0],ymm11[1],ymm3[2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovapd 704(%rdi), %xmm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm12 = ymm12[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0],ymm12[1],ymm11[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovapd %ymm3, 224(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm1, 160(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm2, 96(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm9, 32(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm0, 192(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm4, 128(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm7, 64(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm14, (%rsi)
...
; AVX1-ONLY-NEXT:    vmovapd %ymm11, 224(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm6, 192(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm10, 160(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm5, 128(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm15, 96(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm8, 64(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm13, 32(%rcx)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-ONLY-NEXT:    vmovaps 608(%rdi), %ymm11
; AVX2-ONLY-NEXT:    vmovaps 576(%rdi), %ymm14
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 256(%rdi), %ymm0, %ymm0
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 544(%rdi), %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 736(%rdi), %ymm0, %ymm13
...
; AVX2-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm7
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 176(%rdi), %ymm10
...
; AVX2-ONLY-NEXT:    vmovaps 496(%rdi), %xmm5
...
; AVX2-ONLY-NEXT:    vmovaps 688(%rdi), %xmm10
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm10[0,1],mem[2,3]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm6 = mem[0,1,0,3]
...
; AVX2-ONLY-NEXT:    vmovaps %ymm15, 160(%rdx)
; AVX2-ONLY-NEXT:    vmovaps %ymm13, 96(%rdx)
; AVX2-ONLY-NEXT:    vmovaps %ymm12, 32(%rdx)
...
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 32(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm14, (%rcx)
...
; AVX1-ONLY-NEXT:    vmovapd 1376(%rdi), %ymm4
; AVX1-ONLY-NEXT:    vmovapd 1184(%rdi), %ymm0
; AVX1-ONLY-NEXT:    vmovapd 992(%rdi), %ymm2
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm12 = mem[0,1],ymm3[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm13 = mem[0,1],ymm7[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = mem[0,1],ymm6[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm15 = mem[0,1],ymm5[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = mem[0,1],ymm1[2,3]
...
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm12[1],ymm3[0],ymm12[3],ymm3[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 80(%rdi), %ymm9
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1,2],ymm9[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm13[1],ymm7[0],ymm13[3],ymm7[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 272(%rdi), %ymm7
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1,2],ymm7[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm8[1],ymm6[0],ymm8[3],ymm6[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 464(%rdi), %ymm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1,2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm3 = ymm15[1],ymm5[0],ymm15[3],ymm5[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 656(%rdi), %ymm5
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm3[0,1,2],ymm5[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm11[1],ymm1[0],ymm11[3],ymm1[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 848(%rdi), %ymm3
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm3[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm1 = ymm14[1],ymm2[0],ymm14[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1040(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm10[1],ymm0[0],ymm10[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1232(%rdi), %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = mem[0,1],ymm4[2,3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm0[1],ymm4[0],ymm0[3],ymm4[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1424(%rdi), %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 128(%rdi), %ymm0
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm1[1],ymm0[0],ymm1[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 176(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 320(%rdi), %ymm0
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm3[1],ymm0[0],ymm3[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 368(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 512(%rdi), %ymm0
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = mem[0,1],ymm0[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm0 = ymm4[1],ymm0[0],ymm4[3],ymm0[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 560(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = ymm0[0,1,2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm0 = mem[0,1],ymm2[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm0[1],ymm2[0],ymm0[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 944(%rdi), %ymm5
...
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm11[1],ymm2[0],ymm11[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1136(%rdi), %ymm6
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1,2],ymm6[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 1280(%rdi), %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = mem[0,1],ymm2[2,3]
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm6[1],ymm2[0],ymm6[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1328(%rdi), %ymm7
...
; AVX1-ONLY-NEXT:    vshufpd {{.*#+}} ymm2 = ymm9[1],ymm2[0],ymm9[3],ymm2[2]
; AVX1-ONLY-NEXT:    vbroadcastsd 1520(%rdi), %ymm7
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1,2],ymm7[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 16(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vinsertf128 $1, 64(%rdi), %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm5 = ymm12[0],ymm2[1],ymm12[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 32(%rdi), %xmm7
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm7 = ymm7[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0],ymm7[1],ymm2[2],ymm7[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 112(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 128(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm2[0],ymm1[1],ymm2[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 208(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 256(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm13[0],ymm1[1],ymm13[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 224(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 304(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 352(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm3[0],ymm1[1],ymm3[2],ymm1[3]
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm8[0],ymm1[1],ymm8[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 416(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 496(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 544(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm4[0],ymm1[1],ymm4[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm15[0],ymm1[1],ymm15[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovapd 608(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm2 = ymm2[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3]
; AVX1-ONLY-NEXT:    vmovupd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 688(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vinsertf128 $1, 736(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm8 = ymm10[0],ymm1[1],ymm10[2],ymm1[3]
...
; AVX1-ONLY-NEXT:    vblendps $51, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm7 # 32-byte Folded Reload
; AVX1-ONLY-NEXT:    # ymm7 = mem[0,1],ymm1[2,3],mem[4,5],ymm1[6,7]
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm3 = ymm0[0],ymm1[1],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovapd 896(%rdi), %xmm0
...
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm5 = ymm14[0],ymm0[1],ymm14[2],ymm0[3]
; AVX1-ONLY-NEXT:    vmovapd 992(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm1[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm15 = ymm0[0],ymm1[1],ymm0[2],ymm1[3]
; AVX1-ONLY-NEXT:    vmovaps 1072(%rdi), %xmm0
; AVX1-ONLY-NEXT:    vinsertf128 $1, 1120(%rdi), %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm1 = ymm11[0],ymm0[1],ymm11[2],ymm0[3]
; AVX1-ONLY-NEXT:    vmovapd 1088(%rdi), %xmm4
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm4 = ymm4[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm10 = ymm0[0],ymm4[1],ymm0[2],ymm4[3]
; AVX1-ONLY-NEXT:    vmovaps 1168(%rdi), %xmm0
; AVX1-ONLY-NEXT:    vinsertf128 $1, 1216(%rdi), %ymm0, %ymm4
; AVX1-ONLY-NEXT:    vblendps $51, {{[-0-9]+}}(%r{{[sb]}}p), %ymm4, %ymm2 # 32-byte Folded Reload
; AVX1-ONLY-NEXT:    # ymm2 = mem[0,1],ymm4[2,3],mem[4,5],ymm4[6,7]
; AVX1-ONLY-NEXT:    vmovaps 1184(%rdi), %xmm14
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3],mem[4,5,6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm14[2,3],ymm4[4,5],ymm14[6,7]
; AVX1-ONLY-NEXT:    vmovaps 1264(%rdi), %xmm14
; AVX1-ONLY-NEXT:    vinsertf128 $1, 1312(%rdi), %ymm14, %ymm14
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm6 = ymm6[0],ymm14[1],ymm6[2],ymm14[3]
; AVX1-ONLY-NEXT:    vmovapd 1280(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm11 = ymm11[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm14 = ymm14[0],ymm11[1],ymm14[2],ymm11[3]
; AVX1-ONLY-NEXT:    vmovaps 1360(%rdi), %xmm11
; AVX1-ONLY-NEXT:    vinsertf128 $1, 1408(%rdi), %ymm11, %ymm11
...
; AVX1-ONLY-NEXT:    vmovaps 1376(%rdi), %xmm12
...
; AVX1-ONLY-NEXT:    vmovaps 1456(%rdi), %xmm12
; AVX1-ONLY-NEXT:    vinsertf128 $1, 1504(%rdi), %ymm12, %ymm12
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm9 = ymm9[0],ymm12[1],ymm9[2],ymm12[3]
; AVX1-ONLY-NEXT:    vmovapd 1472(%rdi), %xmm13
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm13 = ymm13[0,1],mem[2,3]
; AVX1-ONLY-NEXT:    vblendpd {{.*#+}} ymm12 = ymm12[0],ymm13[1],ymm12[2],ymm13[3]
; AVX1-ONLY-NEXT:    vmovapd %ymm9, 480(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm6, 416(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm1, 352(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm3, 288(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm8, 224(%rsi)
...
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 448(%rsi)
; AVX1-ONLY-NEXT:    vmovaps %ymm2, 384(%rsi)
; AVX1-ONLY-NEXT:    vmovapd %ymm5, 320(%rsi)
; AVX1-ONLY-NEXT:    vmovaps %ymm7, 256(%rsi)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, (%rdx)
; AVX1-ONLY-NEXT:    vmovapd %ymm12, 480(%rcx)
; AVX1-ONLY-NEXT:    vmovaps %ymm11, 448(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm14, 416(%rcx)
; AVX1-ONLY-NEXT:    vmovaps %ymm4, 384(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm10, 352(%rcx)
; AVX1-ONLY-NEXT:    vmovapd %ymm15, 320(%rcx)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-ONLY-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 608(%rdi), %ymm4
; AVX2-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 576(%rdi), %ymm5
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vinsertf128 $1, 832(%rdi), %ymm0, %ymm0
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4,5,6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2,3,4,5],ymm0[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-ONLY-NEXT:    vinsertf128 $1, 1408(%rdi), %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 704(%rdi), %ymm9
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 736(%rdi), %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 896(%rdi), %ymm7
; AVX2-ONLY-NEXT:    vmovaps 864(%rdi), %ymm6
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm0 = ymm6[0,3,2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm7[4,5,6,7]
; AVX2-ONLY-NEXT:    vinsertf128 $1, 928(%rdi), %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 1088(%rdi), %ymm5
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, 1504(%rdi), %ymm0, %ymm14
...
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 272(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 464(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 656(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 848(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 1040(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
...
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 1232(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
; AVX2-ONLY-NEXT:    # ymm14 = ymm14[0,1],mem[2,3],ymm14[4,5,6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-ONLY-NEXT:    vbroadcastsd 1424(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3,4,5],ymm15[6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vblendps $12, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14, %ymm14 # 32-byte Folded Reload
...
; AVX2-ONLY-NEXT:    vmovaps %ymm13, 416(%rdx)
...
; AVX2-ONLY-NEXT:    vmovaps %ymm3, 384(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 352(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm5, 320(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm6, 288(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm7, 256(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm8, 224(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm9, 192(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm10, 160(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm12, 128(%rcx)
; AVX2-ONLY-NEXT:    vmovaps %ymm14, 96(%rcx)
...
; AVX512-NEXT:    vmovdqa64 {{.*#+}} zmm20 = <1,4,7,10,13,u,u,u>
