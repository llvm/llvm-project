...
define void @test_cl(ptr  %dst, ptr %src, i32 %idx) {
entry:
  %arrayidx = getelementptr inbounds <4 x i64>, ptr %src, i32 %idx
  %0 = load <4 x i64> , ptr %arrayidx, align 32
  %arrayidx1 = getelementptr inbounds <4 x i64>, ptr %dst, i32 %idx
  %1 = load <4 x i64> , ptr %arrayidx1, align 32
  ...
  store <4 x i64> %shl, ptr %arrayidx1, align 32
  ret void
}
