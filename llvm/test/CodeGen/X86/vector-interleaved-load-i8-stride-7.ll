...
; AVX512-NEXT:    vpternlogq $248, %ymm15, %ymm0, %ymm2
...
; AVX512DQ-NEXT:    vpternlogq $202, %ymm25, %ymm4, %ymm1
...
; AVX512DQ-NEXT:    vpternlogq $248, %ymm27, %ymm0, %ymm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $202, %ymm24, %ymm31, %ymm1
; AVX512DQ-FCP-NEXT:    vextracti128 $1, %ymm1, %xmm2
