...
; SSE-NEXT:    imull $51307, %ecx, %eax # imm = 0xC86B
; SSE-NEXT:    shrl $25, %eax
; SSE-NEXT:    imull $654, %eax, %eax # imm = 0x28E
...
; AVX-NEXT:    imull $51307, %ecx, %eax # imm = 0xC86B
; AVX-NEXT:    shrl $25, %eax
; AVX-NEXT:    imull $654, %eax, %eax # imm = 0x28E
