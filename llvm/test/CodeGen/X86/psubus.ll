...
; AVX1-NEXT:    vpmaxud %xmm4, %xmm2, %xmm4
; AVX1-NEXT:    vpcmpeqd %xmm4, %xmm2, %xmm2
; AVX1-NEXT:    vpmaxud %xmm1, %xmm3, %xmm4
...
; AVX1-NEXT:    vpmovzxwd {{.*#+}} xmm3 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm4
; AVX1-NEXT:    vpminud %xmm4, %xmm2, %xmm4
; AVX1-NEXT:    vpcmpeqd %xmm4, %xmm2, %xmm2
...
; SSE2OR3-NEXT:    movdqa %xmm6, %xmm8
; SSE2OR3-NEXT:    pcmpgtd %xmm7, %xmm8
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm6, %xmm7
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm9 = xmm7[1,1,3,3]
; SSE2OR3-NEXT:    pand %xmm8, %xmm9
; SSE2OR3-NEXT:    pcmpeqd %xmm7, %xmm7
; SSE2OR3-NEXT:    pand %xmm9, %xmm4
; SSE2OR3-NEXT:    pxor %xmm7, %xmm9
; SSE2OR3-NEXT:    por %xmm4, %xmm9
; SSE2OR3-NEXT:    movdqa %xmm3, %xmm4
; SSE2OR3-NEXT:    pxor %xmm5, %xmm4
; SSE2OR3-NEXT:    movdqa %xmm6, %xmm8
; SSE2OR3-NEXT:    pcmpgtd %xmm4, %xmm8
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm6, %xmm4
...
; SSSE3-NEXT:    punpckhwd {{.*#+}} xmm7 = xmm7[4],xmm8[4],xmm7[5],xmm8[5],xmm7[6],xmm8[6],xmm7[7],xmm8[7]
...
; SSSE3-NEXT:    pcmpgtd %xmm2, %xmm8
; SSSE3-NEXT:    psubd %xmm3, %xmm7
; SSSE3-NEXT:    pand %xmm8, %xmm7
; SSSE3-NEXT:    movdqa {{.*#+}} xmm2 = [0,1,4,5,8,9,12,13,8,9,12,13,12,13,14,15]
; SSSE3-NEXT:    pshufb %xmm2, %xmm7
; SSSE3-NEXT:    pshufb %xmm2, %xmm0
; SSSE3-NEXT:    punpcklqdq {{.*#+}} xmm0 = xmm0[0],xmm7[0]
; SSSE3-NEXT:    pshufb %xmm2, %xmm6
; SSSE3-NEXT:    pshufb %xmm2, %xmm1
; SSSE3-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm6[0]
; SSSE3-NEXT:    retq
;
...
; SSE41-NEXT:    pmovzxwd {{.*#+}} xmm7 = xmm1[0],zero,xmm1[1],zero,xmm1[2],zero,xmm1[3],zero
...
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm7, %xmm8
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm10 = xmm8[1,1,3,3]
; SSE2OR3-NEXT:    pand %xmm9, %xmm10
...
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm7, %xmm3
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[1,1,3,3]
; SSE2OR3-NEXT:    pand %xmm9, %xmm3
; SSE2OR3-NEXT:    pand %xmm3, %xmm2
; SSE2OR3-NEXT:    pxor %xmm8, %xmm3
; SSE2OR3-NEXT:    por %xmm2, %xmm3
; SSE2OR3-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,2],xmm10[0,2]
; SSE2OR3-NEXT:    movdqa %xmm0, %xmm2
...
; SSE2OR3-NEXT:    movdqa %xmm7, %xmm3
; SSE2OR3-NEXT:    pcmpgtd %xmm2, %xmm3
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm7, %xmm2
...
; SSE2OR3-NEXT:    pxor %xmm6, %xmm3
; SSE2OR3-NEXT:    movdqa %xmm7, %xmm5
; SSE2OR3-NEXT:    pcmpgtd %xmm3, %xmm5
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[0,0,2,2]
; SSE2OR3-NEXT:    pcmpeqd %xmm7, %xmm3
; SSE2OR3-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[1,1,3,3]
