...
; SSE41-NEXT:    packusdw %xmm3, %xmm9
; SSE41-NEXT:    packusdw %xmm4, %xmm9
; SSE41-NEXT:    psubusw %xmm9, %xmm6
...
; SSE41-NEXT:    movapd {{.*#+}} xmm10 = [4294967295,4294967295]
...
; SSE41-NEXT:    movdqa %xmm6, %xmm0
; SSE41-NEXT:    blendvpd %xmm0, %xmm4, %xmm10
; SSE41-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,2],xmm2[0,2]
; SSE41-NEXT:    pmaxud %xmm10, %xmm1
; SSE41-NEXT:    psubd %xmm10, %xmm1
