...
@"\01LC" = internal constant [7 x i8] c"n0=%d\0A\00"		; <ptr> [#uses=1]
@llvm.used = appending global [1 x ptr] [ ptr @umoddi3 ], section "llvm.metadata"		; <ptr> [#uses=0]
...
entry:
	...
	%4 = tail call i32 (ptr, ...) @printf(ptr @"\01LC", i32 %1) nounwind		; <i32> [#uses=0]
