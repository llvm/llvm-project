...
; AVX512FP16-NEXT:    divb %sil
; AVX512FP16-NEXT:    movzbl %ah, %ecx
...
; AVX512FP16-NEXT:    vcvtw2ph %ymm1, %ymm2
; AVX512FP16-NEXT:    vpmovzxbw {{.*#+}} ymm3 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero,xmm0[8],zero,xmm0[9],zero,xmm0[10],zero,xmm0[11],zero,xmm0[12],zero,xmm0[13],zero,xmm0[14],zero,xmm0[15],zero
; AVX512FP16-NEXT:    vcvtw2ph %ymm3, %ymm3
; AVX512FP16-NEXT:    vdivph %ymm2, %ymm3, %ymm2
; AVX512FP16-NEXT:    vcvttph2uw %ymm2, %ymm2
