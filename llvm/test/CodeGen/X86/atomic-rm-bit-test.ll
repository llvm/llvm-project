...
; X86-NEXT:    movb %al, %bh
; X86-NEXT:    andb %bl, %bh
; X86-NEXT:    lock cmpxchgb %bh, (%edx)
; X86-NEXT:    jne .LBB8_1
; X86-NEXT:  # %bb.2: # %atomicrmw.end
; X86-NEXT:    movzbl %al, %esi
; X86-NEXT:    testl %esi, %ecx
; X86-NEXT:    je .LBB8_3
; X86-NEXT:  # %bb.4: # %if.then
...
; X86-NEXT:    movl %eax, %edi
; X86-NEXT:    orl %esi, %edi
; X86-NEXT:    lock cmpxchgl %edi, (%ecx)
