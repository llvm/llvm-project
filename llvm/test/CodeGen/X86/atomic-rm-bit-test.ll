...
; X64-NEXT:    jae .LBB7_4
; X64-NEXT:  # %bb.3: # %if.then
; X64-NEXT:    movzbl (%rdi,%rcx), %eax
; X64-NEXT:  .LBB7_4: # %return
; X64-NEXT:    retq
entry:
  %0 = and i8 %c, 7
  %shl = shl nuw i8 1, %0
