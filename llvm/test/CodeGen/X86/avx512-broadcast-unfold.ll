...
; CHECK-NEXT:    vaddps %ymm0, %ymm0, %ymm1
...
; CHECK-NEXT:    vaddps %zmm0, %zmm0, %zmm1
...
; CHECK-NEXT:    vaddpd %xmm0, %xmm0, %xmm1
...
; CHECK-NEXT:    vaddpd %ymm0, %ymm0, %ymm1
...
; CHECK-NEXT:    vaddpd %zmm0, %zmm0, %zmm1
