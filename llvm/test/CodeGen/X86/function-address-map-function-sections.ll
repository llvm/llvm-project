...
; CHECK:		.section .llvm_func_addr_map,"o",@llvm_func_addr_map,.text._Z3barv{{$}}
...
; CHECK:		.section  .llvm_func_addr_map,"o",@llvm_func_addr_map,.text._Z3foov{{$}}
; CHECK-NEXT:		.byte 1			# version
; CHECK-NEXT:		.byte 1			# feature
...
; CHECK:		.section .llvm_func_addr_map,"oG",@llvm_func_addr_map,.text._Z4fooTIiET_v,_Z4fooTIiET_v,comdat{{$}}
; CHECK-NEXT:		.byte 1				# version
; CHECK-NEXT:		.byte 1				# feature
