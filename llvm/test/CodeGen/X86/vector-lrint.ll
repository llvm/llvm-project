...
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=i686-unknown -mattr=avx512dq,avx512vl | FileCheck %s --check-prefixes=X86-AVX,X86-AVX512
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=x86_64-unknown -mattr=avx | FileCheck %s --check-prefixes=X64-AVX-i32,X64-AVX1-i32
; RUN: sed 's/iXLen/i32/g' %s | llc -mtriple=x86_64-unknown -mattr=avx512dq,avx512vl | FileCheck %s --check-prefixes=X64-AVX-i32,X64-AVX512-i32
...
;
; X64-AVX512-i64-LABEL: lrint_v2f32:
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtps2qq %xmm0, %xmm0
...
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtps2qq %xmm0, %ymm0
; X64-AVX512-i64-NEXT:    retq
...
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtps2qq %ymm0, %zmm0
; X64-AVX512-i64-NEXT:    retq
...
; X64-AVX1-i64-NEXT:    retq
;
; X64-AVX512-i64-LABEL: lrint_v2f64:
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtpd2qq %xmm0, %xmm0
; X64-AVX512-i64-NEXT:    retq
...
; X86-SSE2-NEXT:    retl
;
; X86-AVX1-LABEL: lrint_v4f64:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]
; X86-AVX1-NEXT:    vcvtsd2si %xmm1, %eax
; X86-AVX1-NEXT:    vcvtsd2si %xmm0, %ecx
; X86-AVX1-NEXT:    vmovd %ecx, %xmm1
; X86-AVX1-NEXT:    vpinsrd $1, %eax, %xmm1, %xmm1
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm0
; X86-AVX1-NEXT:    vcvtsd2si %xmm0, %eax
; X86-AVX1-NEXT:    vpinsrd $2, %eax, %xmm1, %xmm1
; X86-AVX1-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; X86-AVX1-NEXT:    vcvtsd2si %xmm0, %eax
; X86-AVX1-NEXT:    vpinsrd $3, %eax, %xmm1, %xmm0
; X86-AVX1-NEXT:    vzeroupper
; X86-AVX1-NEXT:    retl
;
; X86-AVX512-LABEL: lrint_v4f64:
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vcvtpd2dq %ymm0, %xmm0
; X86-AVX512-NEXT:    vzeroupper
; X86-AVX512-NEXT:    retl
;
; X64-AVX1-i32-LABEL: lrint_v4f64:
; X64-AVX1-i32:       # %bb.0:
; X64-AVX1-i32-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]
; X64-AVX1-i32-NEXT:    vcvtsd2si %xmm1, %eax
; X64-AVX1-i32-NEXT:    vcvtsd2si %xmm0, %ecx
; X64-AVX1-i32-NEXT:    vmovd %ecx, %xmm1
; X64-AVX1-i32-NEXT:    vpinsrd $1, %eax, %xmm1, %xmm1
; X64-AVX1-i32-NEXT:    vextractf128 $1, %ymm0, %xmm0
; X64-AVX1-i32-NEXT:    vcvtsd2si %xmm0, %eax
; X64-AVX1-i32-NEXT:    vpinsrd $2, %eax, %xmm1, %xmm1
; X64-AVX1-i32-NEXT:    vshufpd {{.*#+}} xmm0 = xmm0[1,0]
; X64-AVX1-i32-NEXT:    vcvtsd2si %xmm0, %eax
; X64-AVX1-i32-NEXT:    vpinsrd $3, %eax, %xmm1, %xmm0
; X64-AVX1-i32-NEXT:    vzeroupper
; X64-AVX1-i32-NEXT:    retq
;
; X64-AVX512-i32-LABEL: lrint_v4f64:
; X64-AVX512-i32:       # %bb.0:
; X64-AVX512-i32-NEXT:    vcvtpd2dq %ymm0, %xmm0
; X64-AVX512-i32-NEXT:    vzeroupper
...
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtpd2qq %ymm0, %ymm0
; X64-AVX512-i64-NEXT:    retq
...
; X86-AVX512:       # %bb.0:
; X86-AVX512-NEXT:    vcvtpd2dq %zmm0, %ymm0
; X86-AVX512-NEXT:    retl
;
...
; X64-AVX512-i32:       # %bb.0:
; X64-AVX512-i32-NEXT:    vcvtpd2dq %zmm0, %ymm0
; X64-AVX512-i32-NEXT:    retq
;
...
; X64-AVX512-i64:       # %bb.0:
; X64-AVX512-i64-NEXT:    vcvtpd2qq %zmm0, %zmm0
; X64-AVX512-i64-NEXT:    retq
