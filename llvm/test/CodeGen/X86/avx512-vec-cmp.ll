...
; KNL-NEXT:    movl $65535, %eax ## encoding: [0xb8,0xff,0xff,0x00,0x00]
; KNL-NEXT:    ## imm = 0xFFFF
; KNL-NEXT:    movl $0, %ecx ## encoding: [0xb9,0x00,0x00,0x00,0x00]
; KNL-NEXT:    movl $0, %edx ## encoding: [0xba,0x00,0x00,0x00,0x00]
; KNL-NEXT:    cmovnel %eax, %edx ## encoding: [0x0f,0x45,0xd0]
; KNL-NEXT:    cmovpl %eax, %edx ## encoding: [0x0f,0x4a,0xd0]
...
; KNL-NEXT:    cmovnel %eax, %ecx ## encoding: [0x0f,0x45,0xc8]
; KNL-NEXT:    cmovpl %eax, %ecx ## encoding: [0x0f,0x4a,0xc8]
...
; AVX512BW-NEXT:    movl $65535, %eax ## encoding: [0xb8,0xff,0xff,0x00,0x00]
; AVX512BW-NEXT:    ## imm = 0xFFFF
; AVX512BW-NEXT:    movl $0, %ecx ## encoding: [0xb9,0x00,0x00,0x00,0x00]
; AVX512BW-NEXT:    movl $0, %edx ## encoding: [0xba,0x00,0x00,0x00,0x00]
; AVX512BW-NEXT:    cmovnel %eax, %edx ## encoding: [0x0f,0x45,0xd0]
; AVX512BW-NEXT:    cmovpl %eax, %edx ## encoding: [0x0f,0x4a,0xd0]
...
; AVX512BW-NEXT:    cmovnel %eax, %ecx ## encoding: [0x0f,0x45,0xc8]
; AVX512BW-NEXT:    cmovpl %eax, %ecx ## encoding: [0x0f,0x4a,0xc8]
