...
; AVX512F-SLOW-NEXT:    vpternlogd $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm1
...
; AVX512F-FAST-NEXT:    vpternlogd $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm9, %zmm0
...
; AVX512F-FAST-NEXT:    vpternlogd $228, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm15, %zmm0
...
; AVX512F-SLOW-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm9, %zmm7
...
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm9 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm9, %zmm1
...
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm10, %zmm9, %zmm9
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm10 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm10, %zmm9
; AVX512F-SLOW-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm8, %zmm9
...
; AVX512F-SLOW-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm27, %zmm2
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm3, %zmm22, %zmm2
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm3, %zmm25, %zmm0
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm2, %zmm4, %zmm23
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm1, %zmm4, %zmm20
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm2, %zmm25, %zmm19
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm13, %zmm30, %zmm21
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm10, %zmm30, %zmm9
...
; AVX512F-FAST-NEXT:    vpternlogd $184, %zmm4, %zmm22, %zmm3
...
; AVX512F-FAST-NEXT:    vpternlogd $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm1, %zmm12
; AVX512F-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 64(%r8), %zmm30
; AVX512BW-NEXT:    vmovdqa64 (%r9), %zmm8
; AVX512BW-NEXT:    vmovdqa64 64(%r9), %zmm26
; AVX512BW-NEXT:    vmovdqa64 (%rax), %zmm20
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm21 = [0,0,30,62,28,60,0,0,0,31,63,29,61,0,0,0,0,0,30,62,28,60,0,0,0,31,63,29,61,0,0,0]
; AVX512BW-NEXT:    # zmm21 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm0
; AVX512BW-NEXT:    vpermt2w %zmm9, %zmm21, %zmm0
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm6 = [27,0,0,0,62,30,60,28,0,0,0,63,31,61,29,0,27,0,0,0,62,30,60,28,0,0,0,63,31,61,29,0]
; AVX512BW-NEXT:    # zmm6 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm13, %zmm3
; AVX512BW-NEXT:    vpermt2w %zmm25, %zmm6, %zmm3
; AVX512BW-NEXT:    movl $101455920, %ecx # imm = 0x60C1830
; AVX512BW-NEXT:    kmovd %ecx, %k1
...
; AVX512BW-NEXT:    vpermt2w %zmm13, %zmm24, %zmm0
...
; AVX512BW-NEXT:    vpermt2w %zmm9, %zmm11, %zmm3
; AVX512BW-NEXT:    movl $-2096755688, %ecx # imm = 0x83060C18
; AVX512BW-NEXT:    kmovd %ecx, %k2
...
; AVX512BW-NEXT:    vpermt2w %zmm12, %zmm19, %zmm0
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm28 = [0,32,0,0,0,3,35,1,33,0,0,0,4,36,2,34,0,32,0,0,0,3,35,1,33,0,0,0,4,36,2,34]
; AVX512BW-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm14, %zmm7
; AVX512BW-NEXT:    vpermt2w %zmm15, %zmm28, %zmm7
; AVX512BW-NEXT:    movl $-1048377844, %ecx # imm = 0xC183060C
; AVX512BW-NEXT:    kmovd %ecx, %k3
; AVX512BW-NEXT:    vmovdqu16 %zmm0, %zmm7 {%k3}
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [0,0,2,34,0,32,0,0,0,3,35,1,33,0,0,0,0,0,2,34,0,32,0,0,0,3,35,1,33,0,0,0]
...
; AVX512BW-NEXT:    vpermt2w %zmm8, %zmm1, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm3
; AVX512BW-NEXT:    vmovdqa64 %zmm25, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm25, %zmm27
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm17
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm23 = [9,0,0,0,44,12,42,10,0,0,0,45,13,43,11,0,9,0,0,0,44,12,42,10,0,0,0,45,13,43,11,0]
; AVX512BW-NEXT:    # zmm23 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm9, %zmm31
; AVX512BW-NEXT:    vpermt2w %zmm29, %zmm23, %zmm31
...
; AVX512BW-NEXT:    vpermt2w %zmm30, %zmm0, %zmm10
...
; AVX512BW-NEXT:    vpermt2w %zmm26, %zmm25, %zmm30
; AVX512BW-NEXT:    vmovdqa64 64(%rax), %zmm25
; AVX512BW-NEXT:    vpermt2w %zmm25, %zmm2, %zmm30
; AVX512BW-NEXT:    vmovdqu16 %zmm30, %zmm29 {%k3}
; AVX512BW-NEXT:    vpermi2w %zmm15, %zmm14, %zmm21
; AVX512BW-NEXT:    vpermi2w %zmm5, %zmm12, %zmm6
; AVX512BW-NEXT:    vmovdqu16 %zmm21, %zmm6 {%k1}
...
; AVX512BW-NEXT:    vmovdqu16 %zmm21, %zmm6 {%k3}
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,0,0,21,53,19,51,0,0,0,22,54,20,52,0,0,0,0,0,21,53,19,51,0,0,0,22,54,20,52,0,0]
; AVX512BW-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm9, %zmm2, %zmm3
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm21 = [18,50,0,0,0,21,53,19,51,0,0,0,22,54,20,52,18,50,0,0,0,21,53,19,51,0,0,0,22,54,20,52]
; AVX512BW-NEXT:    # zmm21 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm13, %zmm21, %zmm16
; AVX512BW-NEXT:    movl $202911840, %eax # imm = 0xC183060
; AVX512BW-NEXT:    kmovd %eax, %k3
; AVX512BW-NEXT:    vmovdqu16 %zmm3, %zmm16 {%k3}
; AVX512BW-NEXT:    vpermi2w %zmm12, %zmm5, %zmm24
; AVX512BW-NEXT:    vpermi2w %zmm15, %zmm14, %zmm11
; AVX512BW-NEXT:    vmovdqu16 %zmm24, %zmm11 {%k2}
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [0,0,0,25,57,23,55,0,0,0,26,58,24,56,0,0,0,0,0,25,57,23,55,0,0,0,26,58,24,56,0,0]
; AVX512BW-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
...
; AVX512BW-NEXT:    vpermi2w %zmm15, %zmm14, %zmm2
; AVX512BW-NEXT:    vpermi2w %zmm12, %zmm5, %zmm21
; AVX512BW-NEXT:    vmovdqu16 %zmm2, %zmm21 {%k3}
; AVX512BW-NEXT:    vpermi2w %zmm8, %zmm4, %zmm3
; AVX512BW-NEXT:    vpermt2w %zmm20, %zmm24, %zmm3
; AVX512BW-NEXT:    vmovdqu16 %zmm3, %zmm21 {%k2}
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,0,16,48,14,46,0,0,0,17,49,15,47,0,0,0,0,0,16,48,14,46,0,0,0,17,49,15,47,0,0,0]
; AVX512BW-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm13, %zmm2, %zmm27
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [16,48,14,46,0,0,0,17,49,15,47,0,0,0,18,50,16,48,14,46,0,0,0,17,49,15,47,0,0,0,18,50]
; AVX512BW-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm9, %zmm3, %zmm17
; AVX512BW-NEXT:    vmovdqu16 %zmm27, %zmm17 {%k1}
...
; AVX512BW-NEXT:    vmovdqu16 %zmm10, %zmm17 {%k1}
...
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqu16 %zmm31, %zmm18 {%k1}
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm2 = [0,11,43,9,41,0,0,0,12,44,10,42,0,0,0,13,0,11,43,9,41,0,0,0,12,44,10,42,0,0,0,13]
; AVX512BW-NEXT:    # zmm2 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm26, %zmm2, %zmm1
...
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vmovdqu16 %zmm1, %zmm18 {%k1}
; AVX512BW-NEXT:    vpermi2w %zmm8, %zmm4, %zmm2
; AVX512BW-NEXT:    vpermt2w %zmm20, %zmm10, %zmm2
; AVX512BW-NEXT:    vmovdqu16 %zmm2, %zmm0 {%k1}
...
; AVX512BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2w %zmm9, %zmm1, %zmm19
; AVX512BW-NEXT:    vpermt2w %zmm15, %zmm1, %zmm14
; AVX512BW-NEXT:    vmovdqu16 %zmm2, %zmm19 {%k3}
