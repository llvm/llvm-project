...
define i32 @zext_eq_zero_i32(i32 %a) {
; X86-LABEL: zext_eq_zero_i32:
; X86:       ## %bb.0:
; X86-NEXT:    xorl %eax, %eax
; X86-NEXT:    cmpl $0, {{[0-9]+}}(%esp)
; X86-NEXT:    sete %al
...
define i32 @zext_and31_eq_zero_i32(i32 %a) {
; X86-LABEL: zext_and31_eq_zero_i32:
; X86:       ## %bb.0:
; X86-NEXT:    xorl %eax, %eax
; X86-NEXT:    testb $31, {{[0-9]+}}(%esp)
; X86-NEXT:    sete %al
; X86-NEXT:    retl
;
; X64-NOBMI2-LABEL: zext_and31_eq_zero_i32:
; X64-NOBMI2:       ## %bb.0:
; X64-NOBMI2-NEXT:    xorl %eax, %eax
; X64-NOBMI2-NEXT:    testb $31, %dil
; X64-NOBMI2-NEXT:    sete %al
; X64-NOBMI2-NEXT:    retq
;
; X64-BMI2-LABEL: zext_and31_eq_zero_i32:
; X64-BMI2:       ## %bb.0:
...
define i64 @zext_and63_eq_zero_i64(i64 %a) {
; X86-LABEL: zext_and63_eq_zero_i64:
; X86:       ## %bb.0:
; X86-NEXT:    xorl %eax, %eax
; X86-NEXT:    testb $63, {{[0-9]+}}(%esp)
; X86-NEXT:    sete %al
; X86-NEXT:    xorl %edx, %edx
; X86-NEXT:    retl
;
; X64-NOBMI2-LABEL: zext_and63_eq_zero_i64:
; X64-NOBMI2:       ## %bb.0:
; X64-NOBMI2-NEXT:    xorl %eax, %eax
; X64-NOBMI2-NEXT:    testb $63, %dil
; X64-NOBMI2-NEXT:    sete %al
; X64-NOBMI2-NEXT:    retq
;
; X64-BMI2-LABEL: zext_and63_eq_zero_i64:
; X64-BMI2:       ## %bb.0:
; X64-BMI2-NEXT:    movl $1, %eax
; X64-BMI2-NEXT:    shrxq %rdi, %rax, %rax
; X64-BMI2-NEXT:    retq
  %and = and i64 %a, 63
...
define i32 @zext_and31_ne_zero_i32(i32 %a) {
; X86-LABEL: zext_and31_ne_zero_i32:
; X86:       ## %bb.0:
; X86-NEXT:    xorl %eax, %eax
; X86-NEXT:    testb $31, {{[0-9]+}}(%esp)
; X86-NEXT:    setne %al
; X86-NEXT:    retl
;
; X64-LABEL: zext_and31_ne_zero_i32:
; X64:       ## %bb.0:
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    testb $31, %dil
; X64-NEXT:    setne %al
; X64-NEXT:    retq
  %and = and i32 %a, 31
