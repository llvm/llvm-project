...
; XOP-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1,2,3,4,5,6,7]
...
; AVX1-NEXT:    vblendps {{.*#+}} ymm3 = ymm2[0,1,2,3,4,5,6,7]
...
; XOP-NEXT:    vblendps {{.*#+}} ymm5 = ymm4[0,1,2,3,4,5,6,7]
...
; AVX1-NEXT:    vblendps {{.*#+}} ymm5 = ymm4[0,1,2,3,4,5,6,7]
