...
; CHECK-NEXT:    retq
;
; AVX512FP16-LABEL: test_char_div:
; AVX512FP16:       # %bb.0:
; AVX512FP16-NEXT:    movsbl %dil, %eax
; AVX512FP16-NEXT:    idivb %cl
; AVX512FP16-NEXT:    movl %eax, %ecx
; AVX512FP16-NEXT:    movsbl %sil, %eax
; AVX512FP16-NEXT:    idivb %r8b
; AVX512FP16-NEXT:    movl %eax, %esi
; AVX512FP16-NEXT:    movsbl %dl, %eax
; AVX512FP16-NEXT:    idivb %r9b
; AVX512FP16-NEXT:    movl %eax, %edi
; AVX512FP16-NEXT:    movl %ecx, %eax
; AVX512FP16-NEXT:    movl %esi, %edx
; AVX512FP16-NEXT:    movl %edi, %ecx
...
; CHECK-NEXT:    retq
;
; AVX512FP16-LABEL: test_uchar_div:
; AVX512FP16:       # %bb.0:
; AVX512FP16-NEXT:    movzbl %dil, %eax
; AVX512FP16-NEXT:    divb %cl
; AVX512FP16-NEXT:    movl %eax, %ecx
; AVX512FP16-NEXT:    movzbl %sil, %eax
; AVX512FP16-NEXT:    divb %r8b
; AVX512FP16-NEXT:    movl %eax, %esi
; AVX512FP16-NEXT:    movzbl %dl, %eax
; AVX512FP16-NEXT:    divb %r9b
; AVX512FP16-NEXT:    movl %eax, %edi
; AVX512FP16-NEXT:    movl %ecx, %eax
; AVX512FP16-NEXT:    movl %esi, %edx
; AVX512FP16-NEXT:    movl %edi, %ecx
