...
; Promotion
define <8 x i8> @urem_v8i8(<8 x i8> %x, <8 x i8> %y, <8 x i1> %m) {
...
; SSE2-NEXT:    divps %xmm4, %xmm6
; SSE2-NEXT:    cvttps2dq %xmm6, %xmm4
...
; SSE42-NEXT:    pmovzxbd {{.*#+}} xmm3 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
...
; AVX2-NEXT:    retq
;
; AVX512-LABEL: urem_v8i8:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpmovzxbd {{.*#+}} ymm2 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero,xmm1[2],zero,zero,zero,xmm1[3],zero,zero,zero,xmm1[4],zero,zero,zero,xmm1[5],zero,zero,zero,xmm1[6],zero,zero,zero,xmm1[7],zero,zero,zero
; AVX512-NEXT:    vcvtdq2ps %ymm2, %ymm2
; AVX512-NEXT:    vpmovzxbd {{.*#+}} ymm3 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero,xmm0[4],zero,zero,zero,xmm0[5],zero,zero,zero,xmm0[6],zero,zero,zero,xmm0[7],zero,zero,zero
...
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
  %res = call <8 x i8> @llvm.masked.urem(<8 x i8> %x, <8 x i8> %y, <8 x i1> %m)
  ret <8 x i8> %res
}
