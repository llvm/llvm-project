...
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+ndd,+enable-ndd-imm,+enable-ndd-mem -verify-machineinstrs --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,IMM,MEM
