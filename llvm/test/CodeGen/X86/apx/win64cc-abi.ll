...
; NO_APX_SSE-NEXT:    callq external_function@PLT
; NO_APX_SSE-NEXT:    #APP
...
; APX_SSE-NEXT:    callq external_function@PLT
; APX_SSE-NEXT:    #APP
; APX_SSE-NEXT:    #NO_APP
...
; NO_APX_NOSSE-NEXT:    callq external_function@PLT
...
; APX_NOSSE-NEXT:    callq external_function@PLT
; APX_NOSSE-NEXT:    #APP
