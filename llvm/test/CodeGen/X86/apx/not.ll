...
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+ndd,+enable-ndd-imm -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK,NDD
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+ndd,+enable-ndd-mem -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK,MEM
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+ndd,+enable-ndd-imm,+enable-ndd-mem -verify-machineinstrs | FileCheck %s --check-prefixes=CHECK,MEM
