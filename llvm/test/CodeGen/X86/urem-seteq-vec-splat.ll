...
; CHECK-SSE2-NEXT:    movdqa %xmm0, %xmm1
; CHECK-SSE2-NEXT:    psrld $2, %xmm1
; CHECK-SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [1374389535,1374389535,1374389535,1374389535]
; CHECK-SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[1,1,3,3]
; CHECK-SSE2-NEXT:    pmuludq %xmm2, %xmm1
...
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm3 = [1374389535,1374389535,1374389535,1374389535]
...
; CHECK-AVX1-NEXT:    vbroadcastss {{.*#+}} xmm3 = [1374389535,1374389535,1374389535,1374389535]
...
; CHECK-AVX512VL:       # %bb.0:
; CHECK-AVX512VL-NEXT:    vpsrld $2, %xmm0, %xmm1
