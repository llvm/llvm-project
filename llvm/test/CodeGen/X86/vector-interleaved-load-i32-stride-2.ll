...
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,2],xmm3[0,2]
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
...
; AVX512-SLOW:       # %bb.0:
; AVX512-SLOW-NEXT:    vmovaps (%rdi), %ymm0
; AVX512-SLOW-NEXT:    vmovaps 32(%rdi), %ymm1
; AVX512-SLOW-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX512-SLOW-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,2,1,3]
; AVX512-SLOW-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
; AVX512-SLOW-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX512-SLOW-NEXT:    vmovaps %ymm2, (%rsi)
; AVX512-SLOW-NEXT:    vmovaps %ymm0, (%rdx)
; AVX512-SLOW-NEXT:    vzeroupper
; AVX512-SLOW-NEXT:    retq
;
; AVX512-FAST-LABEL: load_i32_stride2_vf8:
; AVX512-FAST:       # %bb.0:
; AVX512-FAST-NEXT:    vmovaps {{.*#+}} ymm0 = [0,2,4,6,8,10,12,14]
; AVX512-FAST-NEXT:    vmovaps (%rdi), %ymm1
; AVX512-FAST-NEXT:    vmovaps 32(%rdi), %ymm2
; AVX512-FAST-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm0
; AVX512-FAST-NEXT:    vmovaps {{.*#+}} ymm3 = [1,3,5,7,9,11,13,15]
; AVX512-FAST-NEXT:    vpermi2ps %ymm2, %ymm1, %ymm3
; AVX512-FAST-NEXT:    vmovaps %ymm0, (%rsi)
; AVX512-FAST-NEXT:    vmovaps %ymm3, (%rdx)
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, 32(%rdi), %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm0[0,2],ymm2[0,2],ymm0[4,6],ymm2[4,6]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm1[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm1[0,2],ymm4[0,2],ymm1[4,6],ymm4[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm2[1,3],ymm0[5,7],ymm2[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[1,3],ymm4[1,3],ymm1[5,7],ymm4[5,7]
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,2,1,3]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,2,1,3]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm1[1,3],ymm0[5,7],ymm1[5,7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[1,3],ymm3[1,3],ymm2[5,7],ymm3[5,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,3],xmm13[1,3]
; SSE-NEXT:    movaps %xmm6, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,2],xmm15[0,2]
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[1,3],xmm15[1,3]
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm2[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm6[0,2],ymm2[4,6],ymm6[4,6]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%rdi), %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm9 = ymm1[0,2],ymm8[0,2],ymm1[4,6],ymm8[4,6]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm3[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 224(%rdi), %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm3[0,2],ymm10[0,2],ymm3[4,6],ymm10[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[1,3],ymm8[1,3],ymm1[5,7],ymm8[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm6[1,3],ymm2[5,7],ymm6[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[1,3],ymm10[1,3],ymm3[5,7],ymm10[5,7]
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm0[0,2],ymm1[0,2],ymm0[4,6],ymm1[4,6]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,2,1,3]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[0,2],ymm3[0,2],ymm2[4,6],ymm3[4,6]
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[1,3],ymm3[1,3],ymm2[5,7],ymm3[5,7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,1,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm9, 96(%rsi)
...
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 32(%rdi), %ymm1, %ymm9
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm9[0,2],ymm8[0,2],ymm9[4,6],ymm8[4,6]
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm2[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 160(%rdi), %ymm2, %ymm11
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm11[0,2],ymm10[0,2],ymm11[4,6],ymm10[4,6]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm4[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 288(%rdi), %ymm4, %ymm13
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm13[0,2],ymm12[0,2],ymm13[4,6],ymm12[4,6]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm5[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 416(%rdi), %ymm5, %ymm15
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm6[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 96(%rdi), %ymm6, %ymm6
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[1,3],ymm8[1,3],ymm9[5,7],ymm8[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm9 = ymm6[0,2],ymm5[0,2],ymm6[4,6],ymm5[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm6[1,3],ymm5[1,3],ymm6[5,7],ymm5[5,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm7[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 224(%rdi), %ymm7, %ymm7
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[1,3],ymm10[1,3],ymm11[5,7],ymm10[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX1-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm3[2,3],mem[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, 352(%rdi), %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm12 = ymm13[1,3],ymm12[1,3],ymm13[5,7],ymm12[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm3[0,2],ymm7[0,2],ymm3[4,6],ymm7[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[1,3],ymm7[1,3],ymm3[5,7],ymm7[5,7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm7 = ymm15[0,2],ymm14[0,2],ymm15[4,6],ymm14[4,6]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm0[0,2],ymm15[0,2],ymm0[4,6],ymm15[4,6]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm15[1,3],ymm0[5,7],ymm15[5,7]
; AVX1-ONLY-NEXT:    vmovaps %ymm1, 224(%rsi)
; AVX1-ONLY-NEXT:    vmovaps %ymm13, 160(%rsi)
; AVX1-ONLY-NEXT:    vmovaps %ymm11, 96(%rsi)
; AVX1-ONLY-NEXT:    vmovaps %ymm9, 32(%rsi)
...
; AVX1-ONLY-NEXT:    vmovaps %ymm14, 192(%rdx)
; AVX1-ONLY-NEXT:    vmovaps %ymm3, 160(%rdx)
; AVX1-ONLY-NEXT:    vmovaps %ymm12, 128(%rdx)
...
; AVX2-ONLY-NEXT:    vmovaps 288(%rdi), %ymm13
; AVX2-ONLY-NEXT:    vmovaps 256(%rdi), %ymm14
; AVX2-ONLY-NEXT:    vmovaps 160(%rdi), %ymm3
; AVX2-ONLY-NEXT:    vmovaps 128(%rdi), %ymm15
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm15[0,2],ymm3[0,2],ymm15[4,6],ymm3[4,6]
; AVX2-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm15[1,3],ymm3[1,3],ymm15[5,7],ymm3[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[0,2],ymm5[0,2],ymm8[4,6],ymm5[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[1,3],ymm5[1,3],ymm8[5,7],ymm5[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm14[0,2],ymm13[0,2],ymm14[4,6],ymm13[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm14[1,3],ymm13[1,3],ymm14[5,7],ymm13[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm10[0,2],ymm9[0,2],ymm10[4,6],ymm9[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,3],ymm9[1,3],ymm10[5,7],ymm9[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm12[0,2],ymm11[0,2],ymm12[4,6],ymm11[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[1,3],ymm11[1,3],ymm12[5,7],ymm11[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[0,2],ymm6[0,2],ymm7[4,6],ymm6[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm7[1,3],ymm6[1,3],ymm7[5,7],ymm6[5,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2],ymm4[0,2],ymm2[4,6],ymm4[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[1,3],ymm4[1,3],ymm2[5,7],ymm4[5,7]
; AVX2-ONLY-NEXT:    vmovaps 96(%rdi), %ymm4
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm14 = ymm0[0,2],ymm4[0,2],ymm0[4,6],ymm4[4,6]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[1,3],ymm4[1,3],ymm0[5,7],ymm4[5,7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,1,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 224(%rsi)
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,1,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 160(%rsi)
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm15[0,2,1,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 96(%rsi)
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm14[0,2,1,3]
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 32(%rsi)
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,1,3]
...
; AVX512-NEXT:    vpermt2d %zmm1, %zmm8, %zmm11
