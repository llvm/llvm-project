...
; GFNIAVX512VL:       # %bb.0:
; GFNIAVX512VL-NEXT:    vmovdqa {{.*#+}} xmm3 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm4 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNISSE-NEXT:    paddb %xmm0, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm5, %xmm1
; GFNISSE-NEXT:    pandn %xmm4, %xmm3
; GFNISSE-NEXT:    paddb %xmm2, %xmm2
; GFNISSE-NEXT:    movdqa %xmm2, %xmm4
; GFNISSE-NEXT:    gf2p8affineqb $0, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm4
...
; GFNIAVX2:       # %bb.0:
; GFNIAVX2-NEXT:    vmovdqa {{.*#+}} xmm3 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX-NEXT:    vpsrlw $8, %xmm3, %xmm1
; GFNIAVX-NEXT:    vpsrlw $8, %xmm0, %xmm0
; GFNIAVX-NEXT:    vpackuswb %xmm1, %xmm0, %xmm0
; GFNIAVX-NEXT:    retq
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm3 = [255,255,255,255,255,255,255,255]
; GFNISSE-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
...
; GFNIAVX1-NEXT:    vpand %xmm4, %xmm3, %xmm1
...
; GFNIAVX2-NEXT:    vmovdqa {{.*#+}} xmm4 = [255,255,255,255,255,255,255,255]
; GFNIAVX2-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; GFNIAVX2-NEXT:    vpsrlw %xmm2, %xmm0, %xmm0
; GFNIAVX2-NEXT:    vpand %xmm4, %xmm3, %xmm1
...
; GFNIAVX512VL-NEXT:    vmovdqa {{.*#+}} xmm4 = [255,255,255,255,255,255,255,255]
...
; GFNIAVX512VL-NEXT:    vpand %xmm4, %xmm3, %xmm1
...
; GFNIAVX1OR2-NEXT:    vpsrlw $8, %xmm2, %xmm1
...
; GFNIAVX512VL-NEXT:    vpsrlw $8, %xmm2, %xmm1
...
; GFNIAVX512VL:       # %bb.0:
; GFNIAVX512VL-NEXT:    vmovdqa {{.*#+}} ymm3 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm11 = [8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0]
...
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm6, %xmm3
; GFNISSE-NEXT:    movdqa %xmm3, %xmm6
; GFNISSE-NEXT:    gf2p8affineqb $0, %xmm10, %xmm6
; GFNISSE-NEXT:    paddb %xmm0, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm6, %xmm3
...
; GFNIAVX1-NEXT:    vmovaps {{.*#+}} ymm3 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX1-NEXT:    vpblendvb %xmm8, %xmm5, %xmm1, %xmm1
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm6, %xmm1, %xmm5
; GFNIAVX1-NEXT:    vpaddb %xmm8, %xmm8, %xmm6
...
; GFNIAVX1-NEXT:    vpaddb %xmm2, %xmm2, %xmm2
; GFNIAVX1-NEXT:    vpblendvb %xmm2, %xmm3, %xmm0, %xmm0
; GFNIAVX1-NEXT:    vpor %xmm4, %xmm7, %xmm2
; GFNIAVX1-NEXT:    vpor %xmm1, %xmm0, %xmm0
...
; GFNIAVX2-NEXT:    vpsrlw $8, %ymm3, %ymm1
; GFNIAVX2-NEXT:    vpsrlw $8, %ymm0, %ymm0
...
; GFNIAVX512-NEXT:    vpsrlw $8, %ymm3, %ymm1
; GFNIAVX512-NEXT:    vpsrlw $8, %ymm0, %ymm0
; GFNIAVX512-NEXT:    vpackuswb %ymm1, %ymm0, %ymm0
; GFNIAVX512-NEXT:    retq
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm5 = [255,255,255,255,255,255,255,255]
...
; GFNIAVX2-NEXT:    vpand %ymm4, %ymm3, %ymm1
; GFNIAVX2-NEXT:    vpand %ymm4, %ymm0, %ymm0
; GFNIAVX2-NEXT:    vpackuswb %ymm1, %ymm0, %ymm0
; GFNIAVX2-NEXT:    retq
;
; GFNIAVX512-LABEL: splatvar_fshr_v32i8:
; GFNIAVX512:       # %bb.0:
; GFNIAVX512-NEXT:    vpunpckhbw {{.*#+}} ymm3 = ymm1[8],ymm0[8],ymm1[9],ymm0[9],ymm1[10],ymm0[10],ymm1[11],ymm0[11],ymm1[12],ymm0[12],ymm1[13],ymm0[13],ymm1[14],ymm0[14],ymm1[15],ymm0[15],ymm1[24],ymm0[24],ymm1[25],ymm0[25],ymm1[26],ymm0[26],ymm1[27],ymm0[27],ymm1[28],ymm0[28],ymm1[29],ymm0[29],ymm1[30],ymm0[30],ymm1[31],ymm0[31]
; GFNIAVX512-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm2, %xmm2
; GFNIAVX512-NEXT:    vpsrlw %xmm2, %ymm3, %ymm3
; GFNIAVX512-NEXT:    vmovdqa {{.*#+}} ymm4 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; GFNIAVX512-NEXT:    vpunpcklbw {{.*#+}} ymm0 = ymm1[0],ymm0[0],ymm1[1],ymm0[1],ymm1[2],ymm0[2],ymm1[3],ymm0[3],ymm1[4],ymm0[4],ymm1[5],ymm0[5],ymm1[6],ymm0[6],ymm1[7],ymm0[7],ymm1[16],ymm0[16],ymm1[17],ymm0[17],ymm1[18],ymm0[18],ymm1[19],ymm0[19],ymm1[20],ymm0[20],ymm1[21],ymm0[21],ymm1[22],ymm0[22],ymm1[23],ymm0[23]
; GFNIAVX512-NEXT:    vpsrlw %xmm2, %ymm0, %ymm0
; GFNIAVX512-NEXT:    vpand %ymm4, %ymm3, %ymm1
; GFNIAVX512-NEXT:    vpand %ymm4, %ymm0, %ymm0
; GFNIAVX512-NEXT:    vpackuswb %ymm1, %ymm0, %ymm0
; GFNIAVX512-NEXT:    retq
  %splat = shufflevector <32 x i8> %amt, <32 x i8> undef, <32 x i32> zeroinitializer
...
; GFNISSE-NEXT:    movdqa %xmm2, %xmm5
; GFNISSE-NEXT:    punpckhbw {{.*#+}} xmm5 = xmm5[8],xmm0[8],xmm5[9],xmm0[9],xmm5[10],xmm0[10],xmm5[11],xmm0[11],xmm5[12],xmm0[12],xmm5[13],xmm0[13],xmm5[14],xmm0[14],xmm5[15],xmm0[15]
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm6 = [1,128,64,32,16,8,4,2]
; GFNISSE-NEXT:    pmullw %xmm6, %xmm5
; GFNISSE-NEXT:    psrlw $8, %xmm5
; GFNISSE-NEXT:    punpcklbw {{.*#+}} xmm2 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3],xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm4 = [1,2,4,8,16,32,64,128]
...
; GFNIAVX1-NEXT:    vmovdqa {{.*#+}} xmm5 = [1,128,64,32,16,8,4,2]
...
; GFNIAVX1-NEXT:    vmovdqa {{.*#+}} xmm3 = [1,2,4,8,16,32,64,128]
...
; GFNIAVX2-NEXT:    vpsrlw $8, %ymm2, %ymm1
; GFNIAVX2-NEXT:    vpsrlw $8, %ymm0, %ymm0
; GFNIAVX2-NEXT:    vpackuswb %ymm1, %ymm0, %ymm0
; GFNIAVX2-NEXT:    retq
;
...
; GFNIAVX512VL-NEXT:    vpsrlw $8, %ymm2, %ymm1
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm5 = [8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0]
...
; GFNIAVX1:       # %bb.0:
; GFNIAVX1-NEXT:    vmovaps {{.*#+}} ymm7 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX512VL-NEXT:    vmovdqa64 {{.*#+}} zmm7 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm5, %ymm4, %ymm6
; GFNIAVX512VL-NEXT:    vpsllw $5, %ymm8, %ymm7
; GFNIAVX512VL-NEXT:    vpblendvb %ymm7, %ymm6, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vpbroadcastq {{.*#+}} ymm6 = [32,16,8,4,2,1,0,0,32,16,8,4,2,1,0,0,32,16,8,4,2,1,0,0,32,16,8,4,2,1,0,0]
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm6, %ymm4, %ymm8
; GFNIAVX512VL-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX512VL-NEXT:    vpblendvb %ymm7, %ymm8, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vpaddb %ymm4, %ymm4, %ymm8
; GFNIAVX512VL-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX512VL-NEXT:    vpblendvb %ymm7, %ymm8, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm5, %ymm0, %ymm5
; GFNIAVX512VL-NEXT:    vpsllw $5, %ymm2, %ymm2
; GFNIAVX512VL-NEXT:    vpblendvb %ymm2, %ymm5, %ymm0, %ymm0
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm6, %ymm0, %ymm5
; GFNIAVX512VL-NEXT:    vpaddb %ymm2, %ymm2, %ymm2
; GFNIAVX512VL-NEXT:    vpblendvb %ymm2, %ymm5, %ymm0, %ymm0
; GFNIAVX512VL-NEXT:    vpaddb %ymm0, %ymm0, %ymm5
; GFNIAVX512VL-NEXT:    vpaddb %ymm2, %ymm2, %ymm2
; GFNIAVX512VL-NEXT:    vpblendvb %ymm2, %ymm5, %ymm0, %ymm0
...
; GFNISSE-NEXT:    movdqa %xmm7, %xmm12
...
; GFNISSE-NEXT:    psllw $5, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm12, %xmm7
; GFNISSE-NEXT:    movdqa %xmm7, %xmm13
; GFNISSE-NEXT:    gf2p8affineqb $0, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm13
; GFNISSE-NEXT:    paddb %xmm0, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm13, %xmm7
; GFNISSE-NEXT:    movdqa %xmm7, %xmm14
; GFNISSE-NEXT:    gf2p8affineqb $0, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm14
; GFNISSE-NEXT:    paddb %xmm0, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm14, %xmm7
; GFNISSE-NEXT:    paddb %xmm4, %xmm4
; GFNISSE-NEXT:    movdqa %xmm4, %xmm15
...
; GFNISSE-NEXT:    movdqa %xmm9, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm15, %xmm4
...
; GFNISSE-NEXT:    paddb %xmm1, %xmm1
; GFNISSE-NEXT:    movdqa %xmm1, %xmm8
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm15 = [8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0]
...
; GFNISSE-NEXT:    movdqa %xmm9, %xmm0
; GFNISSE-NEXT:    pblendvb %xmm0, %xmm8, %xmm3
; GFNISSE-NEXT:    por %xmm7, %xmm4
; GFNISSE-NEXT:    por %xmm5, %xmm1
; GFNISSE-NEXT:    por %xmm6, %xmm2
; GFNISSE-NEXT:    por %xmm10, %xmm3
; GFNISSE-NEXT:    movdqa %xmm4, %xmm0
; GFNISSE-NEXT:    retq
;
...
; GFNIAVX1-NEXT:    vmovaps {{.*#+}} ymm6 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX1-NEXT:    vpaddb %xmm15, %xmm15, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm14, %xmm13, %xmm13
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm7, %xmm2, %xmm14
; GFNIAVX1-NEXT:    vpsllw $5, %xmm11, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm14, %xmm2, %xmm2
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm4, %xmm2, %xmm14
; GFNIAVX1-NEXT:    vpaddb %xmm15, %xmm15, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm14, %xmm2, %xmm2
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm8, %xmm2, %xmm14
; GFNIAVX1-NEXT:    vpaddb %xmm15, %xmm15, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm14, %xmm2, %xmm14
; GFNIAVX1-NEXT:    vpaddb %xmm0, %xmm0, %xmm0
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm9, %xmm0, %xmm2
; GFNIAVX1-NEXT:    vpxor %xmm6, %xmm11, %xmm11
; GFNIAVX1-NEXT:    vpsllw $5, %xmm11, %xmm11
; GFNIAVX1-NEXT:    vpblendvb %xmm11, %xmm2, %xmm0, %xmm0
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm10, %xmm0, %xmm2
; GFNIAVX1-NEXT:    vpaddb %xmm11, %xmm11, %xmm11
; GFNIAVX1-NEXT:    vpblendvb %xmm11, %xmm2, %xmm0, %xmm0
; GFNIAVX1-NEXT:    vpaddb %xmm0, %xmm0, %xmm2
; GFNIAVX1-NEXT:    vpaddb %xmm11, %xmm11, %xmm11
; GFNIAVX1-NEXT:    vpblendvb %xmm11, %xmm2, %xmm0, %xmm0
; GFNIAVX1-NEXT:    vpor %xmm12, %xmm13, %xmm11
; GFNIAVX1-NEXT:    vextractf128 $1, %ymm3, %xmm12
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm7, %xmm12, %xmm13
; GFNIAVX1-NEXT:    vandps %ymm6, %ymm5, %ymm2
; GFNIAVX1-NEXT:    vextractf128 $1, %ymm2, %xmm5
; GFNIAVX1-NEXT:    vpsllw $5, %xmm5, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm13, %xmm12, %xmm12
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm4, %xmm12, %xmm13
; GFNIAVX1-NEXT:    vpaddb %xmm15, %xmm15, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm13, %xmm12, %xmm12
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm8, %xmm12, %xmm13
; GFNIAVX1-NEXT:    vpaddb %xmm15, %xmm15, %xmm15
; GFNIAVX1-NEXT:    vpblendvb %xmm15, %xmm13, %xmm12, %xmm12
; GFNIAVX1-NEXT:    vpor %xmm0, %xmm14, %xmm0
; GFNIAVX1-NEXT:    vextractf128 $1, %ymm1, %xmm13
; GFNIAVX1-NEXT:    vpaddb %xmm13, %xmm13, %xmm13
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm9, %xmm13, %xmm14
; GFNIAVX1-NEXT:    vpxor %xmm6, %xmm5, %xmm5
; GFNIAVX1-NEXT:    vpsllw $5, %xmm5, %xmm5
; GFNIAVX1-NEXT:    vpblendvb %xmm5, %xmm14, %xmm13, %xmm13
; GFNIAVX1-NEXT:    vgf2p8affineqb $0, %xmm10, %xmm13, %xmm14
; GFNIAVX1-NEXT:    vpaddb %xmm5, %xmm5, %xmm5
; GFNIAVX1-NEXT:    vpblendvb %xmm5, %xmm14, %xmm13, %xmm13
; GFNIAVX1-NEXT:    vpaddb %xmm13, %xmm13, %xmm14
; GFNIAVX1-NEXT:    vpaddb %xmm5, %xmm5, %xmm5
; GFNIAVX1-NEXT:    vpblendvb %xmm5, %xmm14, %xmm13, %xmm5
; GFNIAVX1-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm0
; GFNIAVX1-NEXT:    vpor %xmm5, %xmm12, %xmm5
...
; GFNIAVX2-NEXT:    vpaddb %ymm4, %ymm4, %ymm4
; GFNIAVX2-NEXT:    vpblendvb %ymm4, %ymm12, %ymm0, %ymm0
; GFNIAVX2-NEXT:    vgf2p8affineqb $0, %ymm7, %ymm3, %ymm4
; GFNIAVX2-NEXT:    vpand %ymm6, %ymm5, %ymm7
; GFNIAVX2-NEXT:    vpsllw $5, %ymm7, %ymm7
; GFNIAVX2-NEXT:    vpblendvb %ymm7, %ymm4, %ymm3, %ymm3
; GFNIAVX2-NEXT:    vgf2p8affineqb $0, %ymm8, %ymm3, %ymm4
; GFNIAVX2-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX2-NEXT:    vpblendvb %ymm7, %ymm4, %ymm3, %ymm3
; GFNIAVX2-NEXT:    vgf2p8affineqb $0, %ymm10, %ymm3, %ymm4
; GFNIAVX2-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX2-NEXT:    vpblendvb %ymm7, %ymm4, %ymm3, %ymm3
; GFNIAVX2-NEXT:    vpaddb %ymm1, %ymm1, %ymm1
; GFNIAVX2-NEXT:    vgf2p8affineqb $0, %ymm9, %ymm1, %ymm4
; GFNIAVX2-NEXT:    vpandn %ymm6, %ymm5, %ymm5
; GFNIAVX2-NEXT:    vpsllw $5, %ymm5, %ymm5
; GFNIAVX2-NEXT:    vpblendvb %ymm5, %ymm4, %ymm1, %ymm1
; GFNIAVX2-NEXT:    vgf2p8affineqb $0, %ymm11, %ymm1, %ymm4
; GFNIAVX2-NEXT:    vpaddb %ymm5, %ymm5, %ymm5
; GFNIAVX2-NEXT:    vpblendvb %ymm5, %ymm4, %ymm1, %ymm1
...
; GFNIAVX2-NEXT:    vpor %ymm3, %ymm1, %ymm1
; GFNIAVX2-NEXT:    retq
;
...
; GFNIAVX512VL-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
...
; GFNIAVX512VL-NEXT:    vpaddb %ymm4, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vpbroadcastq {{.*#+}} ymm5 = [8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0,8,4,2,1,0,0,0,0]
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm5, %ymm4, %ymm8
...
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm8, %ymm4, %ymm9
; GFNIAVX512VL-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX512VL-NEXT:    vpblendvb %ymm7, %ymm9, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vpaddb %ymm4, %ymm4, %ymm9
; GFNIAVX512VL-NEXT:    vpaddb %ymm7, %ymm7, %ymm7
; GFNIAVX512VL-NEXT:    vpblendvb %ymm7, %ymm9, %ymm4, %ymm4
; GFNIAVX512VL-NEXT:    vpaddb %ymm0, %ymm0, %ymm0
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm5, %ymm0, %ymm5
...
; GFNIAVX512VL-NEXT:    vpsllw $5, %ymm2, %ymm2
; GFNIAVX512VL-NEXT:    vpblendvb %ymm2, %ymm5, %ymm0, %ymm0
; GFNIAVX512VL-NEXT:    vgf2p8affineqb $0, %ymm8, %ymm0, %ymm5
; GFNIAVX512VL-NEXT:    vpaddb %ymm2, %ymm2, %ymm2
; GFNIAVX512VL-NEXT:    vpblendvb %ymm2, %ymm5, %ymm0, %ymm0
; GFNIAVX512VL-NEXT:    vpaddb %ymm0, %ymm0, %ymm5
; GFNIAVX512VL-NEXT:    vpaddb %ymm2, %ymm2, %ymm2
...
; GFNIAVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm5 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
...
; GFNIAVX1-NEXT:    vpsrlw $8, %xmm7, %xmm6
; GFNIAVX1-NEXT:    vpsrlw $8, %xmm5, %xmm5
...
; GFNIAVX512BW-NEXT:    vpsrlw $8, %zmm3, %zmm1
; GFNIAVX512BW-NEXT:    vpsrlw $8, %zmm0, %zmm0
...
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm8 = [255,255,255,255,255,255,255,255]
...
; GFNIAVX1-NEXT:    vpand %xmm5, %xmm8, %xmm7
; GFNIAVX1-NEXT:    vpand %xmm5, %xmm6, %xmm6
; GFNIAVX1-NEXT:    vpackuswb %xmm7, %xmm6, %xmm6
...
; GFNIAVX512VL-NEXT:    vmovdqa {{.*#+}} ymm6 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
...
; GFNIAVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm4 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; GFNIAVX512BW-NEXT:    vpunpcklbw {{.*#+}} zmm0 = zmm1[0],zmm0[0],zmm1[1],zmm0[1],zmm1[2],zmm0[2],zmm1[3],zmm0[3],zmm1[4],zmm0[4],zmm1[5],zmm0[5],zmm1[6],zmm0[6],zmm1[7],zmm0[7],zmm1[16],zmm0[16],zmm1[17],zmm0[17],zmm1[18],zmm0[18],zmm1[19],zmm0[19],zmm1[20],zmm0[20],zmm1[21],zmm0[21],zmm1[22],zmm0[22],zmm1[23],zmm0[23],zmm1[32],zmm0[32],zmm1[33],zmm0[33],zmm1[34],zmm0[34],zmm1[35],zmm0[35],zmm1[36],zmm0[36],zmm1[37],zmm0[37],zmm1[38],zmm0[38],zmm1[39],zmm0[39],zmm1[48],zmm0[48],zmm1[49],zmm0[49],zmm1[50],zmm0[50],zmm1[51],zmm0[51],zmm1[52],zmm0[52],zmm1[53],zmm0[53],zmm1[54],zmm0[54],zmm1[55],zmm0[55]
; GFNIAVX512BW-NEXT:    vpsrlw %xmm2, %zmm0, %zmm0
; GFNIAVX512BW-NEXT:    vpandq %zmm4, %zmm3, %zmm1
...
; GFNISSE-NEXT:    movdqa %xmm4, %xmm10
; GFNISSE-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm0[8],xmm10[9],xmm0[9],xmm10[10],xmm0[10],xmm10[11],xmm0[11],xmm10[12],xmm0[12],xmm10[13],xmm0[13],xmm10[14],xmm0[14],xmm10[15],xmm0[15]
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm9 = [1,128,64,32,16,8,4,2]
; GFNISSE-NEXT:    pmullw %xmm9, %xmm10
; GFNISSE-NEXT:    psrlw $8, %xmm10
; GFNISSE-NEXT:    punpcklbw {{.*#+}} xmm4 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm8 = [1,2,4,8,16,32,64,128]
...
; GFNIAVX1-NEXT:    vmovdqa {{.*#+}} xmm7 = [1,128,64,32,16,8,4,2]
...
; GFNIAVX1-NEXT:    vmovdqa {{.*#+}} xmm5 = [1,2,4,8,16,32,64,128]
; GFNIAVX1-NEXT:    vpmullw %xmm5, %xmm4, %xmm4
; GFNIAVX1-NEXT:    vpsrlw $8, %xmm4, %xmm4
; GFNIAVX1-NEXT:    vpackuswb %xmm6, %xmm4, %xmm4
; GFNIAVX1-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm2[8],xmm0[8],xmm2[9],xmm0[9],xmm2[10],xmm0[10],xmm2[11],xmm0[11],xmm2[12],xmm0[12],xmm2[13],xmm0[13],xmm2[14],xmm0[14],xmm2[15],xmm0[15]
...
; GFNIAVX512BW-NEXT:    vpunpcklbw {{.*#+}} zmm0 = zmm1[0],zmm0[0],zmm1[1],zmm0[1],zmm1[2],zmm0[2],zmm1[3],zmm0[3],zmm1[4],zmm0[4],zmm1[5],zmm0[5],zmm1[6],zmm0[6],zmm1[7],zmm0[7],zmm1[16],zmm0[16],zmm1[17],zmm0[17],zmm1[18],zmm0[18],zmm1[19],zmm0[19],zmm1[20],zmm0[20],zmm1[21],zmm0[21],zmm1[22],zmm0[22],zmm1[23],zmm0[23],zmm1[32],zmm0[32],zmm1[33],zmm0[33],zmm1[34],zmm0[34],zmm1[35],zmm0[35],zmm1[36],zmm0[36],zmm1[37],zmm0[37],zmm1[38],zmm0[38],zmm1[39],zmm0[39],zmm1[48],zmm0[48],zmm1[49],zmm0[49],zmm1[50],zmm0[50],zmm1[51],zmm0[51],zmm1[52],zmm0[52],zmm1[53],zmm0[53],zmm1[54],zmm0[54],zmm1[55],zmm0[55]
; GFNIAVX512BW-NEXT:    vpsllvw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
; GFNIAVX512BW-NEXT:    vpsrlw $8, %zmm2, %zmm1
; GFNIAVX512BW-NEXT:    vpsrlw $8, %zmm0, %zmm0
; GFNIAVX512BW-NEXT:    vpackuswb %zmm1, %zmm0, %zmm0
; GFNIAVX512BW-NEXT:    retq
...
; GFNISSE-NEXT:    gf2p8affineqb $0, %xmm8, %xmm4
; GFNISSE-NEXT:    movdqa {{.*#+}} xmm9 = [2,1,0,0,0,0,0,0,2,1,0,0,0,0,0,0]
