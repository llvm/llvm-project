...
; AVX512F-NEXT:    cmovbq %rax, %r9
; AVX512F-NEXT:    vucomiss %xmm3, %xmm2
; AVX512F-NEXT:    cmovaq %rcx, %r9
; AVX512F-NEXT:    vucomiss %xmm2, %xmm2
; AVX512F-NEXT:    cmovpq %rdx, %r9
