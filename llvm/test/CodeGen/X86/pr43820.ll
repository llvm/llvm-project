...
; CHECK-NEXT:    shrdq $24, %rbp, %rax
; CHECK-NEXT:    movq %rax, %rcx
; CHECK-NEXT:    shrdq $24, %rbx, %rbp
; CHECK-NEXT:    shrdq $24, %rsi, %rbx
; CHECK-NEXT:    leaq (%r10,%rdx,2), %r10
; CHECK-NEXT:    shrdq $24, %r10, %rsi
; CHECK-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; CHECK-NEXT:    movq %rsi, 112(%rax)
; CHECK-NEXT:    movq %rbx, 104(%rax)
; CHECK-NEXT:    movq %rbp, 96(%rax)
; CHECK-NEXT:    movq %rcx, 88(%rax)
...
; CHECK-NEXT:    shrq $56, %r10
; CHECK-NEXT:    movb %r10b, 124(%rax)
