...
; SSE2-NEXT:    addps %xmm3, %xmm9
; SSE2-NEXT:    addps %xmm4, %xmm8
...
; SSE42-NEXT:    addps %xmm2, %xmm6
; SSE42-NEXT:    addps %xmm3, %xmm7
; SSE42-NEXT:    addps %xmm4, %xmm9
; SSE42-NEXT:    movaps %xmm5, %xmm0
; SSE42-NEXT:    movaps %xmm6, %xmm1
; SSE42-NEXT:    movaps %xmm7, %xmm2
; SSE42-NEXT:    movaps %xmm9, %xmm3
; SSE42-NEXT:    retq
;
...
; SSE2-NEXT:    subps %xmm8, %xmm3
; SSE2-NEXT:    subps %xmm9, %xmm4
...
; SSE2-NEXT:    pandn %xmm5, %xmm0
; SSE2-NEXT:    subps %xmm1, %xmm0
; SSE2-NEXT:    subps %xmm2, %xmm7
; SSE2-NEXT:    subps %xmm3, %xmm8
...
; SSE2-NEXT:    mulps %xmm1, %xmm0
; SSE2-NEXT:    mulps %xmm9, %xmm7
; SSE2-NEXT:    mulps %xmm3, %xmm2
; SSE2-NEXT:    mulps %xmm4, %xmm8
; SSE2-NEXT:    movaps %xmm7, %xmm1
; SSE2-NEXT:    movaps %xmm8, %xmm3
; SSE2-NEXT:    retq
;
...
; SSE42-NEXT:    mulps %xmm2, %xmm6
; SSE42-NEXT:    mulps %xmm3, %xmm7
; SSE42-NEXT:    mulps %xmm4, %xmm9
; SSE42-NEXT:    movaps %xmm5, %xmm0
; SSE42-NEXT:    movaps %xmm6, %xmm1
; SSE42-NEXT:    movaps %xmm7, %xmm2
; SSE42-NEXT:    movaps %xmm9, %xmm3
...
; SSE2-NEXT:    divps %xmm8, %xmm3
; SSE2-NEXT:    divps %xmm9, %xmm4
; SSE2-NEXT:    movaps %xmm1, %xmm0
; SSE2-NEXT:    movaps %xmm2, %xmm1
; SSE2-NEXT:    movaps %xmm3, %xmm2
; SSE2-NEXT:    movaps %xmm4, %xmm3
...
; SSE2-NEXT:    por %xmm10, %xmm0
; SSE2-NEXT:    divps %xmm1, %xmm0
; SSE2-NEXT:    divps %xmm9, %xmm7
; SSE2-NEXT:    divps %xmm3, %xmm2
; SSE2-NEXT:    divps %xmm4, %xmm8
; SSE2-NEXT:    movaps %xmm7, %xmm1
; SSE2-NEXT:    movaps %xmm8, %xmm3
; SSE2-NEXT:    retq
;
...
; SSE42-NEXT:    divps %xmm2, %xmm6
; SSE42-NEXT:    divps %xmm3, %xmm7
; SSE42-NEXT:    divps %xmm4, %xmm9
; SSE42-NEXT:    movaps %xmm5, %xmm0
; SSE42-NEXT:    movaps %xmm6, %xmm1
; SSE42-NEXT:    movaps %xmm7, %xmm2
; SSE42-NEXT:    movaps %xmm9, %xmm3
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movd %edi, %xmm8
; SSE2-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[0,1,0,1]
; SSE2-NEXT:    movdqa {{.*#+}} xmm9 = [64,128]
; SSE2-NEXT:    movdqa %xmm8, %xmm10
; SSE2-NEXT:    pand %xmm9, %xmm10
; SSE2-NEXT:    pcmpeqd %xmm9, %xmm10
; SSE2-NEXT:    pshufd {{.*#+}} xmm9 = xmm10[1,0,3,2]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm7 = xmm9[1,0,3,2]
...
; SSE42-NEXT:    pcmpeqq %xmm5, %xmm8
; SSE42-NEXT:    pand %xmm4, %xmm8
; SSE42-NEXT:    subpd %xmm8, %xmm0
; SSE42-NEXT:    subpd %xmm7, %xmm1
; SSE42-NEXT:    subpd %xmm9, %xmm2
; SSE42-NEXT:    subpd %xmm10, %xmm3
; SSE42-NEXT:    retq
;
...
; SSE42-NEXT:    movdqa %xmm9, %xmm0
; SSE42-NEXT:    blendvpd %xmm0, %xmm4, %xmm10
; SSE42-NEXT:    divpd %xmm10, %xmm8
; SSE42-NEXT:    divpd %xmm6, %xmm1
; SSE42-NEXT:    divpd %xmm7, %xmm2
; SSE42-NEXT:    divpd %xmm11, %xmm3
...
; SSE42-NEXT:    movdqa {{.*#+}} xmm8 = [64,128]
; SSE42-NEXT:    movdqa %xmm10, %xmm0
; SSE42-NEXT:    pand %xmm8, %xmm0
; SSE42-NEXT:    pcmpeqq %xmm8, %xmm0
; SSE42-NEXT:    movapd {{.*#+}} xmm8 = [1,1]
; SSE42-NEXT:    movapd %xmm8, %xmm11
; SSE42-NEXT:    blendvpd %xmm0, %xmm7, %xmm11
; SSE42-NEXT:    movdqa {{.*#+}} xmm7 = [16,32]
; SSE42-NEXT:    movdqa %xmm10, %xmm0
; SSE42-NEXT:    pand %xmm7, %xmm0
; SSE42-NEXT:    pcmpeqq %xmm7, %xmm0
; SSE42-NEXT:    movapd %xmm8, %xmm7
; SSE42-NEXT:    blendvpd %xmm0, %xmm6, %xmm7
; SSE42-NEXT:    movdqa {{.*#+}} xmm6 = [4,8]
; SSE42-NEXT:    movdqa %xmm10, %xmm0
; SSE42-NEXT:    pand %xmm6, %xmm0
; SSE42-NEXT:    pcmpeqq %xmm6, %xmm0
; SSE42-NEXT:    movapd %xmm8, %xmm6
; SSE42-NEXT:    blendvpd %xmm0, %xmm5, %xmm6
; SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [1,2]
; SSE42-NEXT:    pand %xmm0, %xmm10
; SSE42-NEXT:    pcmpeqq %xmm0, %xmm10
; SSE42-NEXT:    movdqa %xmm10, %xmm0
; SSE42-NEXT:    blendvpd %xmm0, %xmm4, %xmm8
; SSE42-NEXT:    movdqa %xmm9, %xmm0
...
; SSE42-NEXT:    pmuludq %xmm9, %xmm8
; SSE42-NEXT:    paddq %xmm4, %xmm8
; SSE42-NEXT:    movdqa %xmm1, %xmm0
; SSE42-NEXT:    psrlq $32, %xmm0
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm7 = xmm10[1,0,3,2]
...
; SSE42-NEXT:    movdqa %xmm1, %xmm10
; SSE42-NEXT:    psrld %xmm6, %xmm10
; SSE42-NEXT:    pblendw {{.*#+}} xmm10 = xmm10[0,1,2,3],xmm7[4,5,6,7]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[0,1,1,1,4,5,6,7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm0 = xmm6[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm4
; SSE2-NEXT:    psrld %xmm0, %xmm4
; SSE2-NEXT:    pshuflw {{.*#+}} xmm0 = xmm6[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm3
...
; SSE42-NEXT:    psrld %xmm4, %xmm5
; SSE42-NEXT:    pblendw {{.*#+}} xmm5 = xmm3[0,1,2,3],xmm5[4,5,6,7]
; SSE42-NEXT:    pshuflw {{.*#+}} xmm3 = xmm6[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    movdqa %xmm1, %xmm4
; SSE42-NEXT:    psrld %xmm3, %xmm4
; SSE42-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[0,1,1,1,4,5,6,7]
; SSE42-NEXT:    psrld %xmm2, %xmm1
; SSE42-NEXT:    pblendw {{.*#+}} xmm1 = xmm4[0,1,2,3],xmm1[4,5,6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1],xmm5[2,3],xmm1[4,5],xmm5[6,7]
; SSE42-NEXT:    retq
;
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm9[2,3,2,3]
; SSE2-NEXT:    movdqa %xmm4, %xmm11
; SSE2-NEXT:    psrlq %xmm6, %xmm11
...
; SSE2-NEXT:    movdqa %xmm1, %xmm5
; SSE2-NEXT:    psrlq %xmm10, %xmm5
; SSE2-NEXT:    psrlq %xmm6, %xmm1
; SSE2-NEXT:    movsd {{.*#+}} xmm1 = xmm5[0],xmm1[1]
; SSE2-NEXT:    xorpd %xmm9, %xmm1
...
; SSE42-NEXT:    psrlq %xmm6, %xmm11
; SSE42-NEXT:    pblendw {{.*#+}} xmm11 = xmm5[0,1,2,3],xmm11[4,5,6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm5
; SSE42-NEXT:    psrlq %xmm9, %xmm5
; SSE42-NEXT:    psrlq %xmm6, %xmm0
