...
; RUN: llc < %s -mtriple=x86_64-- | FileCheck %s --check-prefixes=X64,X64-SSE2
; RUN: llc < %s -mtriple=x86_64-- -mattr=+slow-shld | FileCheck %s --check-prefixes=X64-SLOW
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx2 | FileCheck %s --check-prefixes=X64,X64-AVX2
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx512f,+avx512bw,+avx512vl | FileCheck %s --check-prefixes=X64,X64-AVX512
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx512vbmi2,+avx512vl | FileCheck %s --check-prefixes=X64,X64-VBMI2
...
; X64-SSE2-LABEL: insert_10_v2i64:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllq $54, %xmm1
; X64-SSE2-NEXT:    psllq $10, %xmm0
; X64-SSE2-NEXT:    psrlq $10, %xmm0
...
; X64-SSE2-LABEL: insert_10_v4i64:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllq $54, %xmm2
; X64-SSE2-NEXT:    psllq $10, %xmm0
; X64-SSE2-NEXT:    psrlq $10, %xmm0
; X64-SSE2-NEXT:    por %xmm2, %xmm0
; X64-SSE2-NEXT:    psllq $54, %xmm3
; X64-SSE2-NEXT:    psllq $10, %xmm1
; X64-SSE2-NEXT:    psrlq $10, %xmm1
...
; X64-SSE2-LABEL: insert_10_v8i64:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllq $54, %xmm4
; X64-SSE2-NEXT:    psllq $10, %xmm0
; X64-SSE2-NEXT:    psrlq $10, %xmm0
; X64-SSE2-NEXT:    por %xmm4, %xmm0
; X64-SSE2-NEXT:    psllq $54, %xmm5
; X64-SSE2-NEXT:    psllq $10, %xmm1
; X64-SSE2-NEXT:    psrlq $10, %xmm1
; X64-SSE2-NEXT:    por %xmm5, %xmm1
; X64-SSE2-NEXT:    psllq $54, %xmm6
; X64-SSE2-NEXT:    psllq $10, %xmm2
; X64-SSE2-NEXT:    psrlq $10, %xmm2
; X64-SSE2-NEXT:    por %xmm6, %xmm2
; X64-SSE2-NEXT:    psllq $54, %xmm7
; X64-SSE2-NEXT:    psllq $10, %xmm3
; X64-SSE2-NEXT:    psrlq $10, %xmm3
...
; X64-SSE2-LABEL: insert_5_v4i32:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    pslld $27, %xmm1
; X64-SSE2-NEXT:    pslld $5, %xmm0
; X64-SSE2-NEXT:    psrld $5, %xmm0
; X64-SSE2-NEXT:    por %xmm1, %xmm0
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE2-LABEL: insert_5_v8i32:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    pslld $27, %xmm2
; X64-SSE2-NEXT:    pslld $5, %xmm0
; X64-SSE2-NEXT:    psrld $5, %xmm0
; X64-SSE2-NEXT:    por %xmm2, %xmm0
; X64-SSE2-NEXT:    pslld $27, %xmm3
; X64-SSE2-NEXT:    pslld $5, %xmm1
; X64-SSE2-NEXT:    psrld $5, %xmm1
; X64-SSE2-NEXT:    por %xmm3, %xmm1
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE2-LABEL: insert_5_v16i32:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    pslld $27, %xmm4
; X64-SSE2-NEXT:    pslld $5, %xmm0
; X64-SSE2-NEXT:    psrld $5, %xmm0
; X64-SSE2-NEXT:    por %xmm4, %xmm0
; X64-SSE2-NEXT:    pslld $27, %xmm5
; X64-SSE2-NEXT:    pslld $5, %xmm1
; X64-SSE2-NEXT:    psrld $5, %xmm1
; X64-SSE2-NEXT:    por %xmm5, %xmm1
; X64-SSE2-NEXT:    pslld $27, %xmm6
; X64-SSE2-NEXT:    pslld $5, %xmm2
; X64-SSE2-NEXT:    psrld $5, %xmm2
; X64-SSE2-NEXT:    por %xmm6, %xmm2
; X64-SSE2-NEXT:    pslld $27, %xmm7
; X64-SSE2-NEXT:    pslld $5, %xmm3
; X64-SSE2-NEXT:    psrld $5, %xmm3
; X64-SSE2-NEXT:    por %xmm7, %xmm3
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE2-LABEL: insert_3_v8i16:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $13, %xmm1
...
; X64-SSE2-LABEL: insert_3_v16i16:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $13, %xmm2
; X64-SSE2-NEXT:    psllw $3, %xmm0
; X64-SSE2-NEXT:    psrlw $3, %xmm0
; X64-SSE2-NEXT:    por %xmm2, %xmm0
; X64-SSE2-NEXT:    psllw $13, %xmm3
; X64-SSE2-NEXT:    psllw $3, %xmm1
; X64-SSE2-NEXT:    psrlw $3, %xmm1
; X64-SSE2-NEXT:    por %xmm3, %xmm1
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE2-LABEL: insert_3_v32i16:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $13, %xmm4
; X64-SSE2-NEXT:    psllw $3, %xmm0
; X64-SSE2-NEXT:    psrlw $3, %xmm0
; X64-SSE2-NEXT:    por %xmm4, %xmm0
; X64-SSE2-NEXT:    psllw $13, %xmm5
; X64-SSE2-NEXT:    psllw $3, %xmm1
; X64-SSE2-NEXT:    psrlw $3, %xmm1
; X64-SSE2-NEXT:    por %xmm5, %xmm1
; X64-SSE2-NEXT:    psllw $13, %xmm6
; X64-SSE2-NEXT:    psllw $3, %xmm2
; X64-SSE2-NEXT:    psrlw $3, %xmm2
; X64-SSE2-NEXT:    por %xmm6, %xmm2
; X64-SSE2-NEXT:    psllw $13, %xmm7
; X64-SSE2-NEXT:    psllw $3, %xmm3
; X64-SSE2-NEXT:    psrlw $3, %xmm3
; X64-SSE2-NEXT:    por %xmm7, %xmm3
; X64-SSE2-NEXT:    retq
;
...
; X64-SSE2-LABEL: insert_2_v16i8:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $6, %xmm1
...
; X64-SSE2-LABEL: insert_2_v32i8:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $6, %xmm2
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192]
; X64-SSE2-NEXT:    pand %xmm4, %xmm2
; X64-SSE2-NEXT:    paddb %xmm0, %xmm0
; X64-SSE2-NEXT:    paddb %xmm0, %xmm0
; X64-SSE2-NEXT:    psrlw $2, %xmm0
; X64-SSE2-NEXT:    por %xmm2, %xmm0
; X64-SSE2-NEXT:    psllw $6, %xmm3
; X64-SSE2-NEXT:    pand %xmm3, %xmm4
; X64-SSE2-NEXT:    paddb %xmm1, %xmm1
; X64-SSE2-NEXT:    paddb %xmm1, %xmm1
...
; X64-SSE2-LABEL: insert_2_v64i8:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    psllw $6, %xmm4
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm8 = [192,192,192,192,192,192,192,192,192,192,192,192,192,192,192,192]
; X64-SSE2-NEXT:    pand %xmm8, %xmm4
; X64-SSE2-NEXT:    paddb %xmm0, %xmm0
; X64-SSE2-NEXT:    paddb %xmm0, %xmm0
; X64-SSE2-NEXT:    psrlw $2, %xmm0
; X64-SSE2-NEXT:    por %xmm4, %xmm0
; X64-SSE2-NEXT:    psllw $6, %xmm5
; X64-SSE2-NEXT:    pand %xmm8, %xmm5
; X64-SSE2-NEXT:    paddb %xmm1, %xmm1
; X64-SSE2-NEXT:    paddb %xmm1, %xmm1
; X64-SSE2-NEXT:    psrlw $2, %xmm1
; X64-SSE2-NEXT:    por %xmm5, %xmm1
; X64-SSE2-NEXT:    psllw $6, %xmm6
; X64-SSE2-NEXT:    pand %xmm8, %xmm6
; X64-SSE2-NEXT:    paddb %xmm2, %xmm2
; X64-SSE2-NEXT:    paddb %xmm2, %xmm2
; X64-SSE2-NEXT:    psrlw $2, %xmm2
; X64-SSE2-NEXT:    por %xmm6, %xmm2
; X64-SSE2-NEXT:    psllw $6, %xmm7
; X64-SSE2-NEXT:    pand %xmm7, %xmm8
; X64-SSE2-NEXT:    paddb %xmm3, %xmm3
; X64-SSE2-NEXT:    paddb %xmm3, %xmm3
; X64-SSE2-NEXT:    psrlw $2, %xmm3
; X64-SSE2-NEXT:    por %xmm8, %xmm3
; X64-SSE2-NEXT:    retq
;
