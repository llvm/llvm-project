...
; X64-NEXT:    testl $32768, %esi # imm = 0x8000
; X64-NEXT:    setne %sil
; X64-NEXT:    addl %edi, %edi
; X64-NEXT:    testl $16777216, %edi # imm = 0x1000000
; X64-NEXT:    setne %dil
; X64-NEXT:    xorb %sil, %dil
; X64-NEXT:    testl %edx, %edx
; X64-NEXT:    setne %dl
; X64-NEXT:    testb %dil, %dl
...
; X86-NEXT:    testl $16777216, %ecx # imm = 0x1000000
; X86-NEXT:    setne %cl
; X86-NEXT:    xorb %bl, %cl
...
; X64-NEXT:    testb $-128, %cl
; X64-NEXT:    setne %cl
; X64-NEXT:    testl $131072, %esi # imm = 0x20000
; X64-NEXT:    setne %sil
...
; X86-NEXT:    sets %cl
; X86-NEXT:    testl $131072, %esi # imm = 0x20000
; X86-NEXT:    setne %ch
; X86-NEXT:    xorb %cl, %ch
; X86-NEXT:    testl %edx, %edx
; X86-NEXT:    setne %cl
...
; X86-NEXT:    leal -1(%eax), %edi
; X86-NEXT:    testl $16384, %ecx # imm = 0x4000
; X86-NEXT:    setne %cl
...
; X64-NEXT:    sets %sil
; X64-NEXT:    testb $32, %dil
; X64-NEXT:    setne %dil
; X64-NEXT:    xorb %sil, %dil
; X64-NEXT:    testb %cl, %cl
; X64-NEXT:    setne %cl
; X64-NEXT:    testb %dil, %cl
; X64-NEXT:    cmovel %eax, %edx
; X64-NEXT:    cmpb $7, %dl
; X64-NEXT:    movl $7, %ecx
...
; X64-NEXT:    testl $32768, %esi # imm = 0x8000
; X64-NEXT:    setne %sil
; X64-NEXT:    testl $16777216, %ecx # imm = 0x1000000
; X64-NEXT:    setne %cl
...
; X86-NEXT:    testl %ecx, %ecx
; X86-NEXT:    sets %cl
; X86-NEXT:    testl $16777216, %esi # imm = 0x1000000
; X86-NEXT:    setne %ch
; X86-NEXT:    xorb %cl, %ch
; X86-NEXT:    testl %edx, %edx
; X86-NEXT:    setne %cl
