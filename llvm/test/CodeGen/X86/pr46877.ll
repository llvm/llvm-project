...
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm4 = -(xmm15 * xmm4) + xmm0
...
; CHECK-NEXT:    vmulss %xmm6, %xmm15, %xmm5
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm5 = -(xmm12 * xmm5) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm5, %xmm2
; CHECK-NEXT:    vmovss {{.*#+}} xmm5 = mem[0],zero,zero,zero
...
; CHECK-NEXT:    vmulss %xmm0, %xmm12, %xmm8
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm8, %xmm12
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm12 = -(xmm12 * mem) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm10, %xmm14
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm14 = -(xmm7 * xmm14) + xmm0
; CHECK-NEXT:    vmulss %xmm12, %xmm14, %xmm12
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm4
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm4
; CHECK-NEXT:    vmulss %xmm4, %xmm12, %xmm14
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm7 * xmm3) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm4 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss %xmm4, %xmm8, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm12 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss %xmm0, %xmm12, %xmm9
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm9, %xmm1
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm10
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm10, %xmm3
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm8, %xmm2
...
; CHECK-NEXT:    vmulss %xmm2, %xmm11, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm4, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm15 # 4-byte Folded Reload
; CHECK-NEXT:    # xmm15 = -(xmm15 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm15, %xmm4
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm2
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm2, %xmm5
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm5 = -(xmm5 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm2, %xmm7
; CHECK-NEXT:    vmulss {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm6 # 4-byte Folded Reload
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm8, %xmm2
; CHECK-NEXT:    vmulss %xmm8, %xmm13, %xmm8
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm8 = -(xmm12 * xmm8) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm9 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm9, %xmm9
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm9 = -(xmm12 * xmm9) + xmm0
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm7 = -(xmm12 * xmm7) + xmm0
...
; CHECK-NEXT:    vfmsub213ss {{.*#+}} xmm2 = (xmm13 * xmm2) - xmm0
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm1 = -(xmm1 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm4, %xmm1, %xmm0
