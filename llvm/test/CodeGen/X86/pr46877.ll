...
; CHECK-LABEL: tester:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovaps %xmm3, %xmm12
; CHECK-NEXT:    vmovaps %xmm1, %xmm15
...
; CHECK-NEXT:    vmulss %xmm2, %xmm15, %xmm2
; CHECK-NEXT:    vfmsub213ss {{.*#+}} xmm2 = (xmm3 * xmm2) - xmm0
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm5 = -(xmm1 * xmm5) + xmm0
; CHECK-NEXT:    vmulss %xmm4, %xmm5, %xmm3
; CHECK-NEXT:    vmulss %xmm2, %xmm3, %xmm2
; CHECK-NEXT:    vmulss %xmm6, %xmm1, %xmm3
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm7 * xmm3) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm3, %xmm2
; CHECK-NEXT:    vmulss %xmm0, %xmm10, %xmm3
; CHECK-NEXT:    vmovss %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-NEXT:    vmulss %xmm3, %xmm14, %xmm3
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm3 = -(xmm3 * mem) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm7, %xmm4
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm4 = -(xmm4 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm4, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm4
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm5
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm5 = -(xmm13 * xmm5) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm5, %xmm5
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm2, %xmm3
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm9, %xmm10
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm10 = -(xmm10 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm7, %xmm10, %xmm7
; CHECK-NEXT:    vmulss %xmm3, %xmm7, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm14, %xmm7
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm7 = -(xmm7 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm7, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmovss {{.*#+}} xmm7 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm7 = -(xmm15 * xmm7) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm10 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm10 = -(xmm10 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm7, %xmm10, %xmm7
; CHECK-NEXT:    vmulss %xmm3, %xmm7, %xmm3
...
; CHECK-NEXT:    vmovss %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm7 = -(xmm2 * xmm7) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm7, %xmm3
; CHECK-NEXT:    vmulss %xmm0, %xmm1, %xmm4
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm7
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm7 = -(xmm7 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm6 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm6, %xmm14
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm14 = -(xmm8 * xmm14) + xmm0
; CHECK-NEXT:    vmulss %xmm7, %xmm14, %xmm7
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm3
; CHECK-NEXT:    vmulss %xmm3, %xmm7, %xmm14
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm8 * xmm3) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm7 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss %xmm4, %xmm7, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm5
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm5, %xmm1
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm7, %xmm2
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm2 = -(xmm6 * xmm2) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm14, %xmm2
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm2, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm1, %xmm6
; CHECK-NEXT:    vmovss {{.*#+}} xmm14 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmovss {{.*#+}} xmm7 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm7, %xmm3
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm14 * xmm3) + xmm0
...
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm2 = -(xmm14 * xmm2) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm8, %xmm2
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm9 = -(xmm9 * mem) + xmm0
...
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm1
; CHECK-NEXT:    vmulss %xmm0, %xmm7, %xmm2
; CHECK-NEXT:    vmulss %xmm3, %xmm2, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm7 * xmm3) + xmm0
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm3, %xmm3
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm11 = -(xmm7 * xmm11) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm1
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm1 = -(xmm12 * xmm1) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm5 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm5 = -(xmm5 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm11, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm5, %xmm1
; CHECK-NEXT:    vfnmadd132ss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm13 # 4-byte Folded Reload
; CHECK-NEXT:    # xmm13 = -(xmm13 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm13, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm5
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm5 = -(xmm5 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm6 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm6, %xmm7
; CHECK-NEXT:    vmulss %xmm6, %xmm15, %xmm6
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm4, %xmm8
; CHECK-NEXT:    vmulss %xmm4, %xmm12, %xmm4
...
; CHECK-NEXT:    vmulss %xmm0, %xmm14, %xmm11
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm11, %xmm11
; CHECK-NEXT:    vmovss {{.*#+}} xmm13 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm11 = -(xmm13 * xmm11) + xmm0
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm10 = -(xmm13 * xmm10) + xmm0
; CHECK-NEXT:    vfmsub213ss {{.*#+}} xmm8 = (xmm12 * xmm8) - xmm0
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm4, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm9, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm7, %xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm3, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    vmulss %xmm5, %xmm6, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm11, %xmm1
