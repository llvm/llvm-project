...
; X86-SSE-NEXT:    movdqu %xmm1, 48(%ecx,%eax,4)
; X86-SSE-NEXT:    movdqu %xmm3, 32(%ecx,%eax,4)
...
; X86-SSE-NEXT:    pextrw $4, %xmm2, %edi
; X86-SSE-NEXT:    pextrw $0, %xmm2, %ebp
; X86-SSE-NEXT:    pextrw $1, %xmm2, %esi
; X86-SSE-NEXT:    pextrw $3, %xmm2, %ebx
...
; X86-SSE-NEXT:    punpckldq {{.*#+}} xmm6 = xmm6[0],xmm2[0],xmm6[1],xmm2[1]
; X86-SSE-NEXT:    movl %edi, %eax
; X86-SSE-NEXT:    xorl %edx, %edx
; X86-SSE-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-SSE-NEXT:    divl 16(%edi)
; X86-SSE-NEXT:    movd %edx, %xmm4
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[1,1,1,1]
...
; X86-SSE-NEXT:    punpcklqdq {{.*#+}} xmm4 = xmm4[0],xmm6[0]
; X86-SSE-NEXT:    movl %ebp, %eax
; X86-SSE-NEXT:    xorl %edx, %edx
; X86-SSE-NEXT:    divl (%edi)
; X86-SSE-NEXT:    movd %edx, %xmm3
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm0[1,1,1,1]
; X86-SSE-NEXT:    movd %xmm6, %ecx
; X86-SSE-NEXT:    movl %esi, %eax
; X86-SSE-NEXT:    xorl %edx, %edx
; X86-SSE-NEXT:    divl %ecx
; X86-SSE-NEXT:    movd %edx, %xmm6
; X86-SSE-NEXT:    punpckldq {{.*#+}} xmm3 = xmm3[0],xmm6[0],xmm3[1],xmm6[1]
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[3,3,3,3]
; X86-SSE-NEXT:    movd %xmm7, %ecx
; X86-SSE-NEXT:    movl %ebx, %eax
; X86-SSE-NEXT:    xorl %edx, %edx
; X86-SSE-NEXT:    divl %ecx
; X86-SSE-NEXT:    movd %edx, %xmm7
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[2,3,2,3]
...
; X86-SSE-NEXT:    divl %ecx
; X86-SSE-NEXT:    movd %edx, %xmm0
; X86-SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm7[0],xmm0[1],xmm7[1]
; X86-SSE-NEXT:    punpcklqdq {{.*#+}} xmm3 = xmm3[0],xmm0[0]
; X86-SSE-NEXT:    movl (%esp), %eax # 4-byte Reload
; X86-SSE-NEXT:    xorl %edx, %edx
; X86-SSE-NEXT:    divl 32(%edi)
; X86-SSE-NEXT:    punpcklqdq {{.*#+}} xmm6 = xmm6[0],xmm7[0]
; X86-SSE-NEXT:    movdqa {{.*#+}} xmm5 = [8199,8199,8199,8199]
; X86-SSE-NEXT:    pmuludq %xmm5, %xmm6
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[0,2,2,3]
; X86-SSE-NEXT:    pmuludq %xmm5, %xmm3
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[0,2,2,3]
; X86-SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm6[0],xmm0[1],xmm6[1]
; X86-SSE-NEXT:    pmuludq %xmm5, %xmm4
; X86-SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm4[0,2,2,3]
; X86-SSE-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm2[0]
; X86-SSE-NEXT:    pmuludq %xmm5, %xmm1
...
; X64-SSE-NEXT:    pextrw $4, %xmm2, %r8d
; X64-SSE-NEXT:    pextrw $0, %xmm2, %r10d
; X64-SSE-NEXT:    pextrw $1, %xmm2, %edi
; X64-SSE-NEXT:    pextrw $3, %xmm2, %r9d
; X64-SSE-NEXT:    movdqa %xmm2, %xmm5
; X64-SSE-NEXT:    punpcklwd {{.*#+}} xmm5 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3]
; X64-SSE-NEXT:    punpckhwd {{.*#+}} xmm3 = xmm3[4],xmm4[4],xmm3[5],xmm4[5],xmm3[6],xmm4[6],xmm3[7],xmm4[7]
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm1[3,3,3,3]
; X64-SSE-NEXT:    movd %xmm2, %r11d
; X64-SSE-NEXT:    xorl %edx, %edx
; X64-SSE-NEXT:    divl %r11d
; X64-SSE-NEXT:    movd %edx, %xmm2
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm3[2,3,2,3]
...
; X64-SSE-NEXT:    punpckldq {{.*#+}} xmm6 = xmm6[0],xmm2[0],xmm6[1],xmm2[1]
...
; X64-SSE-NEXT:    punpcklqdq {{.*#+}} xmm4 = xmm4[0],xmm6[0]
; X64-SSE-NEXT:    movl %r10d, %eax
; X64-SSE-NEXT:    xorl %edx, %edx
; X64-SSE-NEXT:    divl (%rsi)
; X64-SSE-NEXT:    movd %edx, %xmm3
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm0[1,1,1,1]
; X64-SSE-NEXT:    movd %xmm6, %r8d
; X64-SSE-NEXT:    movl %edi, %eax
; X64-SSE-NEXT:    xorl %edx, %edx
; X64-SSE-NEXT:    divl %r8d
; X64-SSE-NEXT:    movd %edx, %xmm6
; X64-SSE-NEXT:    punpckldq {{.*#+}} xmm3 = xmm3[0],xmm6[0],xmm3[1],xmm6[1]
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[3,3,3,3]
; X64-SSE-NEXT:    movd %xmm7, %edi
; X64-SSE-NEXT:    movl %r9d, %eax
; X64-SSE-NEXT:    xorl %edx, %edx
; X64-SSE-NEXT:    divl %edi
; X64-SSE-NEXT:    movd %edx, %xmm7
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[2,3,2,3]
...
; X64-SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm7[0],xmm0[1],xmm7[1]
...
; X64-SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm6[0,2,2,3]
...
; X64-SSE-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
; X64-SSE-NEXT:    imull $8199, %edx, %eax # imm = 0x2007
; X64-SSE-NEXT:    movl %eax, (%rax)
; X64-SSE-NEXT:    movdqa %xmm4, (%rax)
