...
; X86-X87-NEXT:  .LBB6_2:
; X86-X87-NEXT:    movl $-131072, %ecx # imm = 0xFFFE0000
...
; X86-X87-NEXT:    # kill: def $ah killed $ah killed $ax
; X86-X87-NEXT:    sahf
; X86-X87-NEXT:    movl $131071, %eax # imm = 0x1FFFF
