...
; X64-NEXT:    vmovd %eax, %xmm0 # encoding: [0xc5,0xf9,0x6e,0xc0]
; X64-NEXT:    vpbroadcastb %xmm0, %xmm0 # encoding: [0xc4,0xe2,0x79,0x78,0xc0]
; X64-NEXT:    vmovdqa {{.*#+}} xmm2 = [1,2,4,8,16,32,64,128]
; X64-NEXT:    # encoding: [0xc5,0xf9,0x6f,0x15,A,A,A,A]
; X64-NEXT:    # fixup A - offset: 4, value: {{\.?LCPI[0-9]+_[0-9]+}}, kind: reloc_riprel_4byte
; X64-NEXT:    vpand %xmm2, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0xdb,0xc2]
; X64-NEXT:    vxorps %xmm2, %xmm2, %xmm2 # encoding: [0xc5,0xe8,0x57,0xd2]
; X64-NEXT:    vpcmpeqw %xmm2, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0x75,0xc2]
; X64-NEXT:    vpand %xmm1, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0xdb,0xc1]
; X64-NEXT:    retq # encoding: [0xc3]
;
; X86-LABEL: select:
; X86:       # %bb.0:
...
; X86-NEXT:    vmovd %eax, %xmm0 # encoding: [0xc5,0xf9,0x6e,0xc0]
; X86-NEXT:    vpbroadcastb %xmm0, %xmm0 # encoding: [0xc4,0xe2,0x79,0x78,0xc0]
; X86-NEXT:    vmovdqa {{.*#+}} xmm2 = [1,2,4,8,16,32,64,128]
; X86-NEXT:    # encoding: [0xc5,0xf9,0x6f,0x15,A,A,A,A]
; X86-NEXT:    # fixup A - offset: 4, value: {{\.?LCPI[0-9]+_[0-9]+}}, kind: FK_Data_4
; X86-NEXT:    vpand %xmm2, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0xdb,0xc2]
; X86-NEXT:    vxorps %xmm2, %xmm2, %xmm2 # encoding: [0xc5,0xe8,0x57,0xd2]
; X86-NEXT:    vpcmpeqw %xmm2, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0x75,0xc2]
; X86-NEXT:    vpand %xmm1, %xmm0, %xmm0 # encoding: [0xc5,0xf9,0xdb,0xc1]
; X86-NEXT:    retl # encoding: [0xc3]
