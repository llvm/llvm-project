...
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -mattr=+avx512ifma,+avx512vl,+slow-pmullq | FileCheck %s --check-prefix=GENERIC
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -mattr=+avx512ifma,-avx512vl,+slow-pmullq | FileCheck %s --check-prefix=GENERIC-NOVLX
...
; GENERIC:       # %bb.0:
; GENERIC-NEXT:    vpsrlq $32, %zmm0, %zmm2
; GENERIC-NEXT:    vpmuludq %zmm1, %zmm2, %zmm2
; GENERIC-NEXT:    vpsrlq $32, %zmm1, %zmm3
; GENERIC-NEXT:    vpmuludq %zmm3, %zmm0, %zmm3
; GENERIC-NEXT:    vpaddq %zmm2, %zmm3, %zmm2
; GENERIC-NEXT:    vpsllq $32, %zmm2, %zmm2
; GENERIC-NEXT:    vpmuludq %zmm1, %zmm0, %zmm0
; GENERIC-NEXT:    vpaddq %zmm2, %zmm0, %zmm0
; GENERIC-NEXT:    retq
;
; GENERIC-NOVLX-LABEL: test_mul_full_64bit:
; GENERIC-NOVLX:       # %bb.0:
; GENERIC-NOVLX-NEXT:    vpsrlq $32, %zmm0, %zmm2
; GENERIC-NOVLX-NEXT:    vpmuludq %zmm1, %zmm2, %zmm2
; GENERIC-NOVLX-NEXT:    vpsrlq $32, %zmm1, %zmm3
; GENERIC-NOVLX-NEXT:    vpmuludq %zmm3, %zmm0, %zmm3
; GENERIC-NOVLX-NEXT:    vpaddq %zmm2, %zmm3, %zmm2
; GENERIC-NOVLX-NEXT:    vpsllq $32, %zmm2, %zmm2
; GENERIC-NOVLX-NEXT:    vpmuludq %zmm1, %zmm0, %zmm0
; GENERIC-NOVLX-NEXT:    vpaddq %zmm2, %zmm0, %zmm0
; GENERIC-NOVLX-NEXT:    retq
  %res = mul <8 x i64> %a, %b
  ret <8 x i64> %res
}
...
; GENERIC-NOVLX-NEXT:    vpsrlq $32, %ymm0, %ymm2
; GENERIC-NOVLX-NEXT:    vpbroadcastq {{.*#+}} ymm3 = [1,1,1,1]
; GENERIC-NOVLX-NEXT:    vpand %ymm3, %ymm2, %ymm2
; GENERIC-NOVLX-NEXT:    vpmuludq %ymm1, %ymm2, %ymm2
; GENERIC-NOVLX-NEXT:    vpsllq $32, %ymm2, %ymm2
; GENERIC-NOVLX-NEXT:    vpmuludq %ymm1, %ymm0, %ymm0
; GENERIC-NOVLX-NEXT:    vpaddq %ymm2, %ymm0, %ymm0
; GENERIC-NOVLX-NEXT:    retq
