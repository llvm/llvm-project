...
; RUN: llc < %s -mtriple=i386-unknown-unknown -mcpu=c86-4g-m7     2>&1 | FileCheck %s --check-prefixes=FAST,FAST-AVX256
; RUN: llc < %s -mtriple=i386-unknown-unknown -mcpu=c86-4g-m8     2>&1 | FileCheck %s --check-prefixes=FAST,FAST-AVX256
