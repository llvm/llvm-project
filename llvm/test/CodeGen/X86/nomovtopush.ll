...
; CHECK-NEXT:    retl
entry:
  %0 = load i32, ptr @g_d, align 4, !tbaa !3
  %1 = load i32, ptr @g_c, align 4, !tbaa !3
  %2 = load i32, ptr @g_b, align 4, !tbaa !3
  %3 = load i32, ptr @g_a, align 4, !tbaa !3
  %call = tail call i32 @bar(i32 %3, i32 %2, i32 %1, i32 %0) #2
  tail call void @foo(ptr byval(%struct._param_str) nonnull align 4 @g_param) #2
  ret i32 0
}

declare dso_local i32 @bar(i32, i32, i32, i32) local_unnamed_addr

declare dso_local void @foo(ptr byval(%struct._param_str) align 4) local_unnamed_addr
