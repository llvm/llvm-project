...
; O0-NEXT: verify)
; O0-NEXT: X86AsmPrinterBeginPass
...
; O0-NEXT: x86-lvi-ret
; O0-NEXT: verify
; O0-NEXT: X86AsmPrinterPass)
; O0-NEXT: free-machine-function)
; O0-NEXT: X86AsmPrinterEndPass
...
; O2-NEXT: verify)
; O2-NEXT: X86AsmPrinterBeginPass
...
; O2-NEXT: x86-lvi-ret
; O2-NEXT: verify
; O2-NEXT: X86AsmPrinterPass)
; O2-NEXT: free-machine-function)
; O2-NEXT: X86AsmPrinterEndPass
...
; O0-WINDOWS-NEXT: verify)
; O0-WINDOWS-NEXT: X86AsmPrinterBeginPass
...
; O0-WINDOWS-NEXT: verify
; O0-WINDOWS-NEXT: X86AsmPrinterPass)
; O0-WINDOWS-NEXT: free-machine-function)
; O0-WINDOWS-NEXT: X86AsmPrinterEndPass
...
; O3-WINDOWS-NEXT: verify)
; O3-WINDOWS-NEXT: X86AsmPrinterBeginPass
...
; O3-WINDOWS-NEXT: verify
; O3-WINDOWS-NEXT: X86AsmPrinterPass)
; O3-WINDOWS-NEXT: free-machine-function)
; O3-WINDOWS-NEXT: X86AsmPrinterEndPass
