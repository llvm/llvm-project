;; Check that .note.GNU-stack sections are emitted on Linux, but not on Solaris or Illumos
...
; RUN: llc < %s -mtriple=x86_64-pc-illumos | FileCheck %s -check-prefix=CHECK-NOGNUSTACK
