...
; RUN: llc < %s -mtriple=i686-apple-darwin -mattr=+sse2     | FileCheck %s --check-prefix=X86-SSE2
; RUN: llc < %s -mtriple=i686-apple-darwin -mattr=+sse4.2   | FileCheck %s --check-prefix=X86-SSE42
; RUN: llc < %s -mtriple=i686-apple-darwin -mattr=+avx      | FileCheck %s --check-prefixes=X86-AVX,X86-AVX1
...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[1,1,1,1]
...
; X64-SSE2-NEXT:    movdqa %xmm3, %xmm6
; X64-SSE2-NEXT:    pcmpgtd %xmm1, %xmm6
...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm2[0,0,2,2]
...
; X64-SSE42-NEXT:    movdqa %xmm5, %xmm1
; X64-SSE42-NEXT:    pxor %xmm4, %xmm1
...
; X86-SSE42-NEXT:    retl
;
; X86-AVX1-LABEL: test_reduce_v16i16_v8i16:
; X86-AVX1:       ## %bb.0:
; X86-AVX1-NEXT:    vphminposuw %xmm0, %xmm0
; X86-AVX1-NEXT:    vmovd %xmm0, %eax
; X86-AVX1-NEXT:    ## kill: def $ax killed $ax killed $eax
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: test_reduce_v16i16_v8i16:
; X86-AVX2:       ## %bb.0:
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; X86-AVX2-NEXT:    vpminuw %ymm1, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
...
; X86-SSE42-NEXT:    retl
;
; X86-AVX1-LABEL: test_reduce_v32i16_v8i16:
; X86-AVX1:       ## %bb.0:
; X86-AVX1-NEXT:    vphminposuw %xmm0, %xmm0
; X86-AVX1-NEXT:    vmovd %xmm0, %eax
; X86-AVX1-NEXT:    ## kill: def $ax killed $ax killed $eax
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: test_reduce_v32i16_v8i16:
; X86-AVX2:       ## %bb.0:
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; X86-AVX2-NEXT:    vpminuw %ymm1, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
...
; X86-SSE42-NEXT:    retl
;
; X86-AVX1-LABEL: test_reduce_v32i8_v16i8:
; X86-AVX1:       ## %bb.0:
; X86-AVX1-NEXT:    vpsrlw $8, %xmm0, %xmm1
; X86-AVX1-NEXT:    vpminub %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vphminposuw %xmm0, %xmm0
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: test_reduce_v32i8_v16i8:
; X86-AVX2:       ## %bb.0:
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; X86-AVX2-NEXT:    vpminub %ymm1, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
...
; X86-SSE42-NEXT:    retl
;
; X86-AVX1-LABEL: test_reduce_v64i8_v16i8:
; X86-AVX1:       ## %bb.0:
; X86-AVX1-NEXT:    vpsrlw $8, %xmm0, %xmm1
; X86-AVX1-NEXT:    vpminub %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vphminposuw %xmm0, %xmm0
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: test_reduce_v64i8_v16i8:
; X86-AVX2:       ## %bb.0:
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[2,3,2,3]
; X86-AVX2-NEXT:    vpminub %ymm1, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
