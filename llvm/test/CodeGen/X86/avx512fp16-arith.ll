...
; CHECK-NEXT:    vpternlogd {{.*#+}} xmm1 = xmm1 | (xmm0 & mem)
; CHECK-NEXT:    vaddsh %xmm1, %xmm0, %xmm0
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1]
; CHECK-NEXT:    vpternlogd {{.*#+}} xmm1 = xmm1 | (xmm0 & mem)
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vxorps {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm0, %ymm0
; CHECK-NEXT:    retq
  %a = fneg <16 x half> %x
  ret <16 x half> %a
}
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vandps {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm0, %ymm0
; CHECK-NEXT:    retq
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpbroadcastd {{.*#+}} ymm1 = [4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1]
; CHECK-NEXT:    vpternlogd {{.*#+}} ymm1 = ymm1 | (ymm0 & mem)
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vxorps {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm0, %zmm0
; CHECK-NEXT:    retq
  %a = fneg <32 x half> %x
  ret <32 x half> %a
}
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vandps {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm0, %zmm0
; CHECK-NEXT:    retq
...
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vpbroadcastd {{.*#+}} zmm1 = [4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1,4.9976E-1]
; CHECK-NEXT:    vpternlogd {{.*#+}} zmm1 = zmm1 | (zmm0 & mem)
; CHECK-NEXT:    vaddph %zmm1, %zmm0, %zmm0
