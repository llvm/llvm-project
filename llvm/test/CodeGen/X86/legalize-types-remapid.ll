...
bb1:
  ...
  store volatile i32 %t0.i0.cast.i0, ptr @c
  %t0.i0.cast.i1 = extractelement <2 x i32> %t0.i0.cast, i32 1
  store volatile i32 %t0.i0.cast.i1, ptr @c
  ret void
}

define void @PR45049() local_unnamed_addr {
so_basic:
  %a0 = load i1, ptr undef, align 1
  ...
  store i542 %a4, ptr undef, align 8
  store i488 %a55, ptr undef, align 8
  ret void
}
