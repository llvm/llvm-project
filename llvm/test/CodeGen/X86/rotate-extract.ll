...
; X86-NEXT:    andl $-897, %eax # imm = 0xFC7F
; X86-NEXT:    retl
;
; X64-LABEL: rolq_extract_shl:
; X64:       # %bb.0:
; X64-NEXT:    movq %rdi, %rax
; X64-NEXT:    rolq $10, %rax
; X64-NEXT:    andq $-897, %rax # imm = 0xFC7F
; X64-NEXT:    retq
  %lhs_mul = shl i64 %i, 3
...
; X64-NEXT:    rolw $9, %ax
; X64-NEXT:    andl $61951, %eax # imm = 0xF1FF
