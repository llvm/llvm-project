...
; RUN: llc -mtriple=x86_64-linux-gnu -mattr=+sse4.1 -global-isel -global-isel-abort=1 < %s | FileCheck %s --check-prefixes=GISEL-SSE41,GISEL
; RUN: llc -mtriple=x86_64-linux-gnu -mattr=+avx -global-isel -global-isel-abort=1 < %s | FileCheck %s --check-prefixes=GISEL-AVX,GISEL
; RUN: llc -mtriple=x86_64-linux-gnu -mattr=+sse4.1 < %s | FileCheck %s --check-prefixes=SDAG-SSE41,SDAG
; RUN: llc -mtriple=x86_64-linux-gnu -mattr=+avx < %s | FileCheck %s --check-prefixes=SDAG-AVX,SDAG
...
; GISEL-SSE41:       # %bb.0:
; GISEL-SSE41-NEXT:    insertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; GISEL-SSE41-NEXT:    insertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; GISEL-SSE41-NEXT:    insertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-SSE41-NEXT:    retq
;
; GISEL-AVX-LABEL: build_vector_v4f32:
; GISEL-AVX:       # %bb.0:
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41-NEXT:    vpinsrd $1, %esi, %xmm0, %xmm0
; GISEL-SSE41-NEXT:    vpinsrd $2, %edx, %xmm0, %xmm0
; GISEL-SSE41-NEXT:    vpinsrd $3, %ecx, %xmm0, %xmm0
; GISEL-SSE41-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    vmovd %r8d, %xmm1
...
; GISEL-SSE41:       # %bb.0:
; GISEL-SSE41-NEXT:    vmovq %rsi, %xmm0
; GISEL-SSE41-NEXT:    vmovq %rdi, %xmm1
; GISEL-SSE41-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm1[0],xmm0[0]
; GISEL-SSE41-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    vmovq %rcx, %xmm1
; GISEL-SSE41-NEXT:    vmovq %rdx, %xmm2
; GISEL-SSE41-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-SSE41-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm1[0],xmm0[0]
; GISEL-AVX-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-AVX-NEXT:    vmovq %rcx, %xmm1
; GISEL-AVX-NEXT:    vmovq %rdx, %xmm2
; GISEL-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41:       # %bb.0:
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-SSE41-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm4[0],xmm5[0],xmm4[2,3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm6[0],xmm1[3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1,2],xmm7[0]
; GISEL-SSE41-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-AVX-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm4[0],xmm5[0],xmm4[2,3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm6[0],xmm1[3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1,2],xmm7[0]
; GISEL-AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41:       # %bb.0:
; GISEL-SSE41-NEXT:    vmovlhps {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; GISEL-SSE41-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm2[0],xmm3[0]
; GISEL-SSE41-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vmovlhps {{.*#+}} xmm0 = xmm0[0],xmm1[0]
; GISEL-AVX-NEXT:    vinsertf128 $0, %xmm0, %ymm0, %ymm0
; GISEL-AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm2[0],xmm3[0]
; GISEL-AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
...
; GISEL-AVX-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
...
; GISEL-SSE41-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-SSE41-NEXT:    vinserti32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovq %r9, %xmm1
; GISEL-SSE41-NEXT:    vmovq %r8, %xmm2
; GISEL-SSE41-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-SSE41-NEXT:    vinserti32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; GISEL-SSE41-NEXT:    vmovq {{.*#+}} xmm2 = mem[0],zero
; GISEL-SSE41-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-SSE41-NEXT:    vinserti32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-AVX-NEXT:    vinserti32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovq %r9, %xmm1
; GISEL-AVX-NEXT:    vmovq %r8, %xmm2
; GISEL-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-AVX-NEXT:    vinserti32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; GISEL-AVX-NEXT:    vmovq {{.*#+}} xmm2 = mem[0],zero
; GISEL-AVX-NEXT:    vpunpcklqdq {{.*#+}} xmm1 = xmm2[0],xmm1[0]
; GISEL-AVX-NEXT:    vinserti32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-SSE41-NEXT:    vinsertf32x4 $0, %xmm0, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm4[0],xmm5[0],xmm4[2,3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm6[0],xmm1[3]
; GISEL-SSE41-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1,2],xmm7[0]
; GISEL-SSE41-NEXT:    vinsertf32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; GISEL-SSE41-NEXT:    vpinsrd $1, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vpinsrd $2, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vpinsrd $3, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vinsertf32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; GISEL-SSE41-NEXT:    vpinsrd $1, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vpinsrd $2, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vpinsrd $3, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-SSE41-NEXT:    vinsertf32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; GISEL-AVX-NEXT:    vinsertf32x4 $0, %xmm0, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm4[0],xmm5[0],xmm4[2,3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm6[0],xmm1[3]
; GISEL-AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1,2],xmm7[0]
; GISEL-AVX-NEXT:    vinsertf32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; GISEL-AVX-NEXT:    vpinsrd $1, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vpinsrd $2, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vpinsrd $3, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vinsertf32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; GISEL-AVX-NEXT:    vpinsrd $1, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vpinsrd $2, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vpinsrd $3, {{[0-9]+}}(%rsp), %xmm1, %xmm1
; GISEL-AVX-NEXT:    vinsertf32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    retq
;
...
; GISEL-SSE41-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm2[0],xmm3[0]
; GISEL-SSE41-NEXT:    vinsertf32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm4[0],xmm5[0]
; GISEL-SSE41-NEXT:    vinsertf32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm6[0],xmm7[0]
; GISEL-SSE41-NEXT:    vinsertf32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-SSE41-NEXT:    retq
;
...
; GISEL-AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm2[0],xmm3[0]
; GISEL-AVX-NEXT:    vinsertf32x4 $1, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm4[0],xmm5[0]
; GISEL-AVX-NEXT:    vinsertf32x4 $2, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    vmovlhps {{.*#+}} xmm1 = xmm6[0],xmm7[0]
; GISEL-AVX-NEXT:    vinsertf32x4 $3, %xmm1, %zmm0, %zmm0
; GISEL-AVX-NEXT:    retq
;
