...
; SSE2-NEXT:    movq %rdi, %rsi
; SSE2-NEXT:    sarq $63, %rsi
; SSE2-NEXT:    movl %esi, 96(%r14)
; SSE2-NEXT:    movabsq $2251799813685247, %rbp # imm = 0x7FFFFFFFFFFFF
; SSE2-NEXT:    andq %rsi, %rbp
; SSE2-NEXT:    shldq $62, %rdi, %rsi
; SSE2-NEXT:    movabsq $9007199254740991, %rax # imm = 0x1FFFFFFFFFFFFF
; SSE2-NEXT:    andq %rax, %r15
; SSE2-NEXT:    shldq $9, %r12, %r15
; SSE2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 8-byte Folded Reload
; SSE2-NEXT:    # xmm0 = mem[0],zero
; SSE2-NEXT:    shldq $9, %r10, %r12
; SSE2-NEXT:    movq %rsi, 88(%r14)
; SSE2-NEXT:    movq %r12, 72(%r14)
; SSE2-NEXT:    shldq $20, %r9, %r10
; SSE2-NEXT:    movq %r10, 64(%r14)
; SSE2-NEXT:    shldq $20, %r11, %r9
; SSE2-NEXT:    movq %r9, 56(%r14)
; SSE2-NEXT:    shldq $31, %r8, %r11
; SSE2-NEXT:    shldq $31, %r13, %r8
; SSE2-NEXT:    movq %r11, 48(%r14)
; SSE2-NEXT:    movq %r8, 40(%r14)
; SSE2-NEXT:    shldq $42, %rcx, %r13
; SSE2-NEXT:    movq %r13, 32(%r14)
; SSE2-NEXT:    shldq $42, %rdx, %rcx
; SSE2-NEXT:    movq %rcx, 24(%r14)
; SSE2-NEXT:    shldq $53, %rbx, %rdx
; SSE2-NEXT:    movq %rdx, 16(%r14)
; SSE2-NEXT:    movq %rbp, %rcx
; SSE2-NEXT:    shrq $48, %rcx
; SSE2-NEXT:    movb %cl, 102(%r14)
; SSE2-NEXT:    shrq $32, %rbp
; SSE2-NEXT:    movw %bp, 100(%r14)
; SSE2-NEXT:    shlq $62, %rdi
; SSE2-NEXT:    orq %r15, %rdi
; SSE2-NEXT:    movq %rdi, 80(%r14)
...
; SSE2-NEXT:    shlq $53, %rbx
; SSE2-NEXT:    orq %rcx, %rbx
; SSE2-NEXT:    movq %rbx, 8(%r14)
...
; SSE4-NEXT:    addb %r15b, %r15b
; SSE4-NEXT:    sarb %r15b
; SSE4-NEXT:    cmpb %r14b, %r15b
; SSE4-NEXT:    setl %r14b
; SSE4-NEXT:    setg %r15b
; SSE4-NEXT:    subb %r14b, %r15b
; SSE4-NEXT:    movsbq %r15b, %rax
...
; SSE4-NEXT:    movsbq %bpl, %rdx
; SSE4-NEXT:    movq %rdx, %r15
...
; SSE4-NEXT:    setl %cl
; SSE4-NEXT:    setg %bl
; SSE4-NEXT:    subb %cl, %bl
; SSE4-NEXT:    movsbq %bl, %rsi
; SSE4-NEXT:    movq %rsi, %rbx
...
; SSE4-NEXT:    setl %r8b
; SSE4-NEXT:    setg %r11b
; SSE4-NEXT:    subb %r8b, %r11b
; SSE4-NEXT:    movsbq %r11b, %r8
...
; SSE4-NEXT:    addb %bpl, %bpl
; SSE4-NEXT:    sarb %bpl
; SSE4-NEXT:    cmpb %dil, %bpl
; SSE4-NEXT:    setl %dil
; SSE4-NEXT:    setg %bpl
; SSE4-NEXT:    subb %dil, %bpl
; SSE4-NEXT:    movsbq %bpl, %rdi
; SSE4-NEXT:    movq %rdi, %rbp
; SSE4-NEXT:    sarq $63, %rbp
; SSE4-NEXT:    movl %ebp, 96(%r12)
; SSE4-NEXT:    movq %rbp, %rcx
; SSE4-NEXT:    shldq $62, %rdi, %rcx
; SSE4-NEXT:    movabsq $9007199254740991, %r13 # imm = 0x1FFFFFFFFFFFFF
; SSE4-NEXT:    andq %r13, %r14
; SSE4-NEXT:    movq %rax, %r13
; SSE4-NEXT:    shldq $9, %rax, %r14
; SSE4-NEXT:    movabsq $2251799813685247, %rax # imm = 0x7FFFFFFFFFFFF
; SSE4-NEXT:    andq %rbp, %rax
; SSE4-NEXT:    shldq $9, %r10, %r13
; SSE4-NEXT:    movq %rcx, 88(%r12)
; SSE4-NEXT:    movq %r13, 72(%r12)
; SSE4-NEXT:    shldq $20, %r9, %r10
; SSE4-NEXT:    movq %r10, 64(%r12)
; SSE4-NEXT:    shldq $20, %r11, %r9
; SSE4-NEXT:    movq %r9, 56(%r12)
; SSE4-NEXT:    shldq $31, %r8, %r11
; SSE4-NEXT:    shldq $31, %rbx, %r8
; SSE4-NEXT:    movq %r11, 48(%r12)
; SSE4-NEXT:    movq %r8, 40(%r12)
; SSE4-NEXT:    shldq $42, %rsi, %rbx
; SSE4-NEXT:    movq %rbx, 32(%r12)
; SSE4-NEXT:    shldq $42, %r15, %rsi
; SSE4-NEXT:    movq %rsi, 24(%r12)
; SSE4-NEXT:    shldq $53, %rdx, %r15
; SSE4-NEXT:    movq %r15, 16(%r12)
; SSE4-NEXT:    movq %rax, %rcx
; SSE4-NEXT:    shrq $48, %rcx
; SSE4-NEXT:    movb %cl, 102(%r12)
; SSE4-NEXT:    shrq $32, %rax
; SSE4-NEXT:    movw %ax, 100(%r12)
; SSE4-NEXT:    shlq $62, %rdi
; SSE4-NEXT:    orq %r14, %rdi
; SSE4-NEXT:    movq %rdi, 80(%r12)
; SSE4-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; SSE4-NEXT:    movabsq $9007199254740991, %rcx # imm = 0x1FFFFFFFFFFFFF
; SSE4-NEXT:    andq %rcx, %rax
; SSE4-NEXT:    shlq $53, %rdx
; SSE4-NEXT:    orq %rax, %rdx
; SSE4-NEXT:    movq %rdx, 8(%r12)
...
; AVX-NEXT:    addb %r15b, %r15b
; AVX-NEXT:    sarb %r15b
; AVX-NEXT:    cmpb %r14b, %r15b
; AVX-NEXT:    setl %r14b
; AVX-NEXT:    setg %r15b
; AVX-NEXT:    subb %r14b, %r15b
; AVX-NEXT:    movsbq %r15b, %r15
...
; AVX-NEXT:    setl %r8b
; AVX-NEXT:    setg %r11b
; AVX-NEXT:    subb %r8b, %r11b
; AVX-NEXT:    movsbq %r11b, %r8
...
; AVX-NEXT:    addb %bpl, %bpl
; AVX-NEXT:    sarb %bpl
; AVX-NEXT:    cmpb %dil, %bpl
; AVX-NEXT:    setl %dil
; AVX-NEXT:    setg %bpl
; AVX-NEXT:    subb %dil, %bpl
; AVX-NEXT:    movsbq %bpl, %rdi
; AVX-NEXT:    movq %rdi, %r13
; AVX-NEXT:    sarq $63, %r13
; AVX-NEXT:    movw %r13w, 100(%rax)
; AVX-NEXT:    movl %r13d, 96(%rax)
; AVX-NEXT:    movq %r13, %rbp
; AVX-NEXT:    shldq $62, %rdi, %rbp
; AVX-NEXT:    movq %rbp, 88(%rax)
; AVX-NEXT:    shrq $61, %r13
; AVX-NEXT:    movb %r13b, 102(%rax)
; AVX-NEXT:    movb $53, %r13b
; AVX-NEXT:    bzhiq %r13, %r12, %r12
; AVX-NEXT:    shldq $9, %r15, %r12
; AVX-NEXT:    shldq $9, %r10, %r15
; AVX-NEXT:    movq %r15, 72(%rax)
; AVX-NEXT:    shldq $20, %r9, %r10
; AVX-NEXT:    movq %r10, 64(%rax)
; AVX-NEXT:    shldq $20, %r11, %r9
; AVX-NEXT:    movq %r9, 56(%rax)
; AVX-NEXT:    shldq $31, %r8, %r11
; AVX-NEXT:    movq %r11, 48(%rax)
; AVX-NEXT:    shldq $31, %rbx, %r8
; AVX-NEXT:    movq %r8, 40(%rax)
; AVX-NEXT:    shldq $42, %rcx, %rbx
; AVX-NEXT:    movq %rbx, 32(%rax)
; AVX-NEXT:    shldq $42, %r14, %rcx
; AVX-NEXT:    movq %rcx, 24(%rax)
; AVX-NEXT:    shldq $53, %rdx, %r14
; AVX-NEXT:    movq %r14, 16(%rax)
; AVX-NEXT:    shlq $62, %rdi
; AVX-NEXT:    orq %r12, %rdi
; AVX-NEXT:    movq %rdi, 80(%rax)
; AVX-NEXT:    bzhiq %r13, %rsi, %rcx
...
; X86-NEXT:    sarl $31, %edx
; X86-NEXT:    movl %edx, 96(%ecx)
; X86-NEXT:    movl %edx, 92(%ecx)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    movl %esi, 80(%ecx)
; X86-NEXT:    movl %ebp, 68(%ecx)
; X86-NEXT:    movl %ebp, 64(%ecx)
; X86-NEXT:    movl %ebx, 52(%ecx)
; X86-NEXT:    movl %ebx, 48(%ecx)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
...
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    shldl $9, %esi, %eax
; X86-NEXT:    movl %eax, 76(%ecx)
; X86-NEXT:    shldl $9, %ebp, %esi
; X86-NEXT:    movl %esi, 72(%ecx)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    shldl $20, %eax, %ebp
; X86-NEXT:    movl %ebp, 60(%ecx)
; X86-NEXT:    shldl $20, %ebx, %eax
...
; SETZUCC-NEXT:    movsbq %r15b, %r12
; SETZUCC-NEXT:    movq %r12, %r14
; SETZUCC-NEXT:    sarq $63, %r14
...
; SETZUCC-NEXT:    movsbq %r10b, %r10
; SETZUCC-NEXT:    movq %r10, %r13
; SETZUCC-NEXT:    sarq $63, %r13
; SETZUCC-NEXT:    addb %dil, %dil
; SETZUCC-NEXT:    sarb %dil
; SETZUCC-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; SETZUCC-NEXT:    addb %r9b, %r9b
; SETZUCC-NEXT:    sarb %r9b
; SETZUCC-NEXT:    cmpb %dil, %r9b
; SETZUCC-NEXT:    setzul %dil
; SETZUCC-NEXT:    setzug %r9b
; SETZUCC-NEXT:    subb %dil, %r9b
; SETZUCC-NEXT:    movsbq %r9b, %rdi
; SETZUCC-NEXT:    movq %rdi, %r9
; SETZUCC-NEXT:    sarq $63, %r9
; SETZUCC-NEXT:    movl %r9d, 96(%rax)
; SETZUCC-NEXT:    movabsq $2251799813685247, %rbp # imm = 0x7FFFFFFFFFFFF
; SETZUCC-NEXT:    andq %r9, %rbp
; SETZUCC-NEXT:    shldq $62, %rdi, %r9
; SETZUCC-NEXT:    movq %r9, 88(%rax)
; SETZUCC-NEXT:    movabsq $9007199254740991, %r9 # imm = 0x1FFFFFFFFFFFFF
; SETZUCC-NEXT:    andq %r9, %r14
; SETZUCC-NEXT:    shldq $9, %r12, %r14
; SETZUCC-NEXT:    shldq $9, %r13, %r12
; SETZUCC-NEXT:    movq %r12, 72(%rax)
; SETZUCC-NEXT:    shldq $20, %r10, %r13
; SETZUCC-NEXT:    movq %r13, 64(%rax)
; SETZUCC-NEXT:    shldq $20, %r11, %r10
; SETZUCC-NEXT:    movq %r10, 56(%rax)
; SETZUCC-NEXT:    shldq $31, %r8, %r11
; SETZUCC-NEXT:    movq %r11, 48(%rax)
; SETZUCC-NEXT:    shldq $31, %rbx, %r8
; SETZUCC-NEXT:    movq %r8, 40(%rax)
; SETZUCC-NEXT:    shldq $42, %rcx, %rbx
; SETZUCC-NEXT:    movq %rbx, 32(%rax)
; SETZUCC-NEXT:    shldq $42, %r15, %rcx
; SETZUCC-NEXT:    movq %rcx, 24(%rax)
; SETZUCC-NEXT:    shldq $53, %rdx, %r15
; SETZUCC-NEXT:    movq %r15, 16(%rax)
; SETZUCC-NEXT:    movq %rbp, %rcx
; SETZUCC-NEXT:    shrq $48, %rcx
; SETZUCC-NEXT:    movb %cl, 102(%rax)
; SETZUCC-NEXT:    shrq $32, %rbp
; SETZUCC-NEXT:    movw %bp, 100(%rax)
; SETZUCC-NEXT:    shlq $62, %rdi
; SETZUCC-NEXT:    orq %r14, %rdi
...
; NO-SETZUCC-NEXT:    movsbq %r15b, %r12
; NO-SETZUCC-NEXT:    movq %r12, %r14
; NO-SETZUCC-NEXT:    sarq $63, %r14
...
; NO-SETZUCC-NEXT:    movsbq %r10b, %r10
; NO-SETZUCC-NEXT:    movq %r10, %r13
; NO-SETZUCC-NEXT:    sarq $63, %r13
; NO-SETZUCC-NEXT:    addb %dil, %dil
; NO-SETZUCC-NEXT:    sarb %dil
; NO-SETZUCC-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; NO-SETZUCC-NEXT:    addb %r9b, %r9b
; NO-SETZUCC-NEXT:    sarb %r9b
; NO-SETZUCC-NEXT:    cmpb %dil, %r9b
; NO-SETZUCC-NEXT:    setl %dil
; NO-SETZUCC-NEXT:    setg %r9b
; NO-SETZUCC-NEXT:    subb %dil, %r9b
; NO-SETZUCC-NEXT:    movsbq %r9b, %rdi
; NO-SETZUCC-NEXT:    movq %rdi, %r9
; NO-SETZUCC-NEXT:    sarq $63, %r9
; NO-SETZUCC-NEXT:    movl %r9d, 96(%rax)
; NO-SETZUCC-NEXT:    movabsq $2251799813685247, %rbp # imm = 0x7FFFFFFFFFFFF
; NO-SETZUCC-NEXT:    andq %r9, %rbp
; NO-SETZUCC-NEXT:    shldq $62, %rdi, %r9
; NO-SETZUCC-NEXT:    movq %r9, 88(%rax)
; NO-SETZUCC-NEXT:    movabsq $9007199254740991, %r9 # imm = 0x1FFFFFFFFFFFFF
; NO-SETZUCC-NEXT:    andq %r9, %r14
; NO-SETZUCC-NEXT:    shldq $9, %r12, %r14
; NO-SETZUCC-NEXT:    shldq $9, %r13, %r12
; NO-SETZUCC-NEXT:    movq %r12, 72(%rax)
; NO-SETZUCC-NEXT:    shldq $20, %r10, %r13
; NO-SETZUCC-NEXT:    movq %r13, 64(%rax)
; NO-SETZUCC-NEXT:    shldq $20, %r11, %r10
; NO-SETZUCC-NEXT:    movq %r10, 56(%rax)
; NO-SETZUCC-NEXT:    shldq $31, %r8, %r11
; NO-SETZUCC-NEXT:    movq %r11, 48(%rax)
; NO-SETZUCC-NEXT:    shldq $31, %rbx, %r8
; NO-SETZUCC-NEXT:    movq %r8, 40(%rax)
; NO-SETZUCC-NEXT:    shldq $42, %rcx, %rbx
; NO-SETZUCC-NEXT:    movq %rbx, 32(%rax)
; NO-SETZUCC-NEXT:    shldq $42, %r15, %rcx
; NO-SETZUCC-NEXT:    movq %rcx, 24(%rax)
; NO-SETZUCC-NEXT:    shldq $53, %rdx, %r15
; NO-SETZUCC-NEXT:    movq %r15, 16(%rax)
; NO-SETZUCC-NEXT:    movq %rbp, %rcx
; NO-SETZUCC-NEXT:    shrq $48, %rcx
; NO-SETZUCC-NEXT:    movb %cl, 102(%rax)
; NO-SETZUCC-NEXT:    shrq $32, %rbp
; NO-SETZUCC-NEXT:    movw %bp, 100(%rax)
; NO-SETZUCC-NEXT:    shlq $62, %rdi
; NO-SETZUCC-NEXT:    orq %r14, %rdi
