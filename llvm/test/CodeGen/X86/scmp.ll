...
; SSE4-NEXT:    sarb %dil
; SSE4-NEXT:    movzbl {{[0-9]+}}(%rsp), %r9d
; SSE4-NEXT:    addb %r9b, %r9b
; SSE4-NEXT:    sarb %r9b
; SSE4-NEXT:    cmpb %dil, %r9b
; SSE4-NEXT:    setl %dil
; SSE4-NEXT:    setg %r9b
; SSE4-NEXT:    subb %dil, %r9b
; SSE4-NEXT:    movsbq %r9b, %rdi
; SSE4-NEXT:    movq %rdi, %rbp
; SSE4-NEXT:    sarq $63, %rbp
; SSE4-NEXT:    movl %ebp, 96(%r13)
; SSE4-NEXT:    movq %rbp, %rax
; SSE4-NEXT:    shldq $62, %rdi, %rax
; SSE4-NEXT:    movabsq $2251799813685247, %r9 # imm = 0x7FFFFFFFFFFFF
; SSE4-NEXT:    andq %rbp, %r9
; SSE4-NEXT:    movq %rax, 88(%r13)
; SSE4-NEXT:    shldq $20, %r8, %r10
; SSE4-NEXT:    movq %r10, 64(%r13)
; SSE4-NEXT:    shldq $31, %rdx, %r11
; SSE4-NEXT:    movq %r11, 48(%r13)
; SSE4-NEXT:    shldq $42, %rcx, %rbx
; SSE4-NEXT:    movq %rbx, 32(%r13)
; SSE4-NEXT:    movabsq $9007199254738944, %rax # imm = 0x1FFFFFFFFFF800
; SSE4-NEXT:    andq %rsi, %rax
; SSE4-NEXT:    shldq $53, %r12, %rsi
; SSE4-NEXT:    movq %rsi, 16(%r13)
; SSE4-NEXT:    movq %r9, %rsi
; SSE4-NEXT:    shrq $48, %rsi
; SSE4-NEXT:    movb %sil, 102(%r13)
; SSE4-NEXT:    shrq $32, %r9
; SSE4-NEXT:    movw %r9w, 100(%r13)
; SSE4-NEXT:    movabsq $9007199254740991, %rsi # imm = 0x1FFFFFFFFFFFFF
; SSE4-NEXT:    andq %rsi, %r15
; SSE4-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r9 # 8-byte Reload
; SSE4-NEXT:    shldq $9, %r9, %r15
; SSE4-NEXT:    shlq $62, %rdi
; SSE4-NEXT:    orq %r15, %rdi
; SSE4-NEXT:    movq %rdi, 80(%r13)
; SSE4-NEXT:    andq %rsi, %r14
; SSE4-NEXT:    shlq $53, %r12
; SSE4-NEXT:    orq %r14, %r12
; SSE4-NEXT:    movq %r12, 8(%r13)
; SSE4-NEXT:    movq %rcx, %rsi
; SSE4-NEXT:    shlq $42, %rsi
; SSE4-NEXT:    shrq $11, %rax
; SSE4-NEXT:    orq %rsi, %rax
; SSE4-NEXT:    movq %rax, 24(%r13)
; SSE4-NEXT:    shlq $9, %r9
; SSE4-NEXT:    movq %r8, %rax
; SSE4-NEXT:    shrq $44, %rax
; SSE4-NEXT:    andl $511, %eax # imm = 0x1FF
; SSE4-NEXT:    orq %r9, %rax
; SSE4-NEXT:    movq %rax, 72(%r13)
; SSE4-NEXT:    shlq $20, %r8
; SSE4-NEXT:    movq %rdx, %rax
; SSE4-NEXT:    shrq $33, %rax
; SSE4-NEXT:    andl $1048575, %eax # imm = 0xFFFFF
; SSE4-NEXT:    orq %r8, %rax
; SSE4-NEXT:    movq %rax, 56(%r13)
; SSE4-NEXT:    shlq $31, %rdx
; SSE4-NEXT:    shrq $22, %rcx
; SSE4-NEXT:    andl $2147483647, %ecx # imm = 0x7FFFFFFF
; SSE4-NEXT:    orq %rdx, %rcx
; SSE4-NEXT:    movq %rcx, 40(%r13)
...
; X86-NEXT:    movl %edx, 52(%edi)
; X86-NEXT:    movl %edx, 48(%edi)
...
; X86-NEXT:    movl %ecx, %esi
; X86-NEXT:    shrl $2, %esi
; X86-NEXT:    movw %si, 100(%edi)
; X86-NEXT:    shldl $30, %ecx, %ebx
; X86-NEXT:    movl %ebx, 96(%edi)
; X86-NEXT:    movl %ebx, 92(%edi)
; X86-NEXT:    movl %ebx, 88(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Reload
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    shldl $9, %ebx, %esi
; X86-NEXT:    movl %esi, 80(%edi)
; X86-NEXT:    movl %esi, 76(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-NEXT:    shldl $20, %ecx, %eax
; X86-NEXT:    movl %eax, 68(%edi)
; X86-NEXT:    movl %eax, 60(%edi)
; X86-NEXT:    movl %edx, %eax
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    shldl $31, %esi, %eax
; X86-NEXT:    movl %eax, 44(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    shldl $10, %eax, %esi
; X86-NEXT:    movl %esi, 36(%edi)
; X86-NEXT:    movl %esi, 32(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
