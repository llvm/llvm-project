...
;
; SSE41-LABEL: bitcast_v4i32_to_v2i2:
; SSE41:       # %bb.0:
; SSE41-NEXT:    movmskps %xmm0, %eax
; SSE41-NEXT:    movl %eax, %ecx
; SSE41-NEXT:    shrb $2, %cl
; SSE41-NEXT:    andb $3, %al
...
; SSE2-SSSE3-NEXT:    retq
;
; SSE41-LABEL: bitcast_v4i64_to_v2i2:
; SSE41:       # %bb.0:
