...
; SSE2-SSSE3-NEXT:    orl %eax, %esi
; SSE2-SSSE3-NEXT:    shlq $32, %rsi
; SSE2-SSSE3-NEXT:    orq %rcx, %rsi
; SSE2-SSSE3-NEXT:    movq %rsi, %xmm0
; SSE2-SSSE3-NEXT:    movq %rdx, %xmm1
