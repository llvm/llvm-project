...
; GLIBC-AVX2:    callq _ZGVdN8v_sinf@PLT
; GLIBC-AVX2:    callq _ZGVdN8v_cosf@PLT
;
; GLIBC-AVX512-LABEL: test_sincos_v8f32:
; GLIBC-AVX512:    callq _ZGVdN8v_sinf@PLT
; GLIBC-AVX512:    callq _ZGVdN8v_cosf@PLT
...
; GLIBC-SSE:    callq sincos@PLT
; GLIBC-SSE:    callq sincos@PLT
; GLIBC-SSE:    callq sincos@PLT
; GLIBC-SSE:    callq sincos@PLT
;
; GLIBC-AVX-LABEL: test_sincos_v4f64:
; GLIBC-AVX:    callq sincos@PLT
; GLIBC-AVX:    callq sincos@PLT
; GLIBC-AVX:    callq sincos@PLT
; GLIBC-AVX:    callq sincos@PLT
;
; GLIBC-AVX2-LABEL: test_sincos_v4f64:
; GLIBC-AVX2:    callq _ZGVdN4v_sin@PLT
; GLIBC-AVX2:    callq _ZGVdN4v_cos@PLT
;
; GLIBC-AVX512-LABEL: test_sincos_v4f64:
; GLIBC-AVX512:    callq _ZGVdN4v_sin@PLT
; GLIBC-AVX512:    callq _ZGVdN4v_cos@PLT
