...
; SSE-NEXT:    unpcklps {{.*#+}} xmm9 = xmm9[0],xmm1[0],xmm9[1],xmm1[1]
...
; AVX2-ONLY-NEXT:    vinsertf128 $1, (%r10), %ymm6, %ymm6
; AVX2-ONLY-NEXT:    vbroadcastsd {{.*#+}} ymm8 = [0,4,0,4,0,4,0,4]
; AVX2-ONLY-NEXT:    vpermps %ymm6, %ymm8, %ymm9
; AVX2-ONLY-NEXT:    vpermps %ymm5, %ymm8, %ymm8
...
; AVX2-ONLY-NEXT:    vpermps %ymm6, %ymm9, %ymm10
...
; AVX2-ONLY-NEXT:    vpermps %ymm6, %ymm10, %ymm11
...
; SSE-NEXT:    unpckhps {{.*#+}} xmm6 = xmm6[2],xmm4[2],xmm6[3],xmm4[3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[2,3],xmm1[2,0]
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[3,3],xmm4[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[2,3],xmm13[0,2]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,3],xmm3[3,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[2,3],xmm9[0,2]
...
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[2,3],xmm12[0,2]
...
; AVX1-ONLY-NEXT:    vmovaps (%r10), %xmm7
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm15 = xmm15[0,1],xmm8[2,3]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm10[2],xmm9[2],xmm10[3],xmm9[3]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm9 = xmm14[0],xmm13[0],xmm14[1],xmm13[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm0, %ymm9
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm10 = xmm11[0,1,0,1]
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm9 = ymm7[0],ymm8[0],ymm7[1],ymm8[1],ymm7[4],ymm8[4],ymm7[5],ymm8[5]
; AVX2-ONLY-NEXT:    vbroadcastss 20(%r8), %ymm0
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4],ymm6[5],ymm0[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm9[6,7]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm10 = ymm1[0],ymm2[0],ymm1[1],ymm2[1],ymm1[4],ymm2[4],ymm1[5],ymm2[5]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm8 = ymm11[2],ymm8[2],ymm11[3],ymm8[3],ymm11[6],ymm8[6],ymm11[7],ymm8[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm11 = ymm5[2],ymm6[2],ymm5[3],ymm6[3],ymm5[6],ymm6[6],ymm5[7],ymm6[7]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm11[1],ymm8[1],ymm11[3],ymm8[3]
...
; AVX2-ONLY-NEXT:    vbroadcastss 24(%rax), %ymm8
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5,6],ymm8[7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm11[0,1,2,3,4,5],ymm7[6,7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm12, %xmm8
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm2 = xmm8[0,1],xmm2[2,3]
...
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm5[0],ymm9[0],ymm5[2],ymm9[2]
...
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[2,3],xmm8[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[2,3],xmm1[0,2]
...
; SSE-NEXT:    unpckhps {{.*#+}} xmm10 = xmm10[2],xmm6[2],xmm10[3],xmm6[3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,1],xmm1[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[2,3],xmm8[2,0]
; SSE-NEXT:    movaps %xmm7, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,1],xmm2[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[2,3],xmm8[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[2,3],xmm2[0,2]
; SSE-NEXT:    movaps 48(%rdx), %xmm4
...
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,3],xmm3[2,0]
; SSE-NEXT:    unpckhps {{.*#+}} xmm8 = xmm8[2],xmm12[2],xmm8[3],xmm12[3]
; SSE-NEXT:    movaps %xmm4, %xmm3
...
; AVX1-ONLY-NEXT:    vmovaps 32(%rsi), %ymm2
...
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm12[1],ymm11[1],ymm12[3],ymm11[3]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm10 = ymm0[2],ymm2[2],ymm0[3],ymm2[3],ymm0[6],ymm2[6],ymm0[7],ymm2[7]
...
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm10
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm2[3,0],ymm0[3,0],ymm2[7,4],ymm0[7,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[2,0,2,3,6,4,6,7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm13[0,1],xmm10[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0,1,2,3],ymm1[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm12[0],ymm11[0],ymm12[2],ymm11[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm10 = ymm5[0],ymm6[0],ymm5[1],ymm6[1],ymm5[4],ymm6[4],ymm5[5],ymm6[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[0,1],ymm1[2,0],ymm10[4,5],ymm1[6,4]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm1 = ymm0[0],ymm2[0],ymm0[1],ymm2[1],ymm0[4],ymm2[4],ymm0[5],ymm2[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm4[0],ymm3[0],ymm4[2],ymm3[2]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm13 = xmm1[0,1],xmm13[2,3]
...
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm3, %xmm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[1,0],ymm0[1,0],ymm2[5,4],ymm0[5,4]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm10[2],ymm11[2],ymm10[3],ymm11[3],ymm10[6],ymm11[6],ymm10[7],ymm11[7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2,0],ymm2[4,5],ymm0[6,4]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm7[2],ymm8[2],ymm7[3],ymm8[3],ymm7[6],ymm8[6],ymm7[7],ymm8[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm2, %xmm2
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm1[1],ymm9[1],ymm1[3],ymm9[3]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm11[3,0],ymm10[3,0],ymm11[7,4],ymm10[7,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[2,0],ymm0[2,3],ymm2[6,4],ymm0[6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm9[2],ymm1[2],ymm9[3],ymm1[3],ymm9[6],ymm1[6],ymm9[7],ymm1[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm2, %xmm2
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2,0],ymm2[4,5],ymm0[6,4]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm2 = ymm7[0],ymm8[0],ymm7[1],ymm8[1],ymm7[4],ymm8[4],ymm7[5],ymm8[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm2, %xmm2
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm1[0],ymm9[0],ymm1[2],ymm9[2]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm3, %xmm3
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm3[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1,2,3],ymm0[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm11[1,0],ymm10[1,0],ymm11[5,4],ymm10[5,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[2,0],ymm0[2,3],ymm2[6,4],ymm0[6,7]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm1 = ymm9[0],ymm1[0],ymm9[1],ymm1[1],ymm9[4],ymm1[4],ymm9[5],ymm1[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm1, %xmm1
...
; AVX1-ONLY-NEXT:    vmovaps %xmm3, %xmm2
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm14[0],xmm3[0],xmm14[1],xmm3[1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm4 = xmm4[0,1],xmm5[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0,1,2,3],ymm1[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm11[0],xmm2[0],xmm11[1],xmm2[1]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm7[2],xmm8[2],xmm7[3],xmm8[3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm0, %ymm10
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1,2,3,4,5],ymm0[6,7]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2,3],ymm9[4,5,6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm9 = xmm1[2],xmm10[2],xmm1[3],xmm10[3]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm1[0],xmm10[0],xmm1[1],xmm10[1]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm4[0],xmm5[0],xmm4[1],xmm5[1]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm4 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm0, %ymm4
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm2 = xmm7[1,1,1,1]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm6 = xmm2[0,1],xmm6[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1,2,3],ymm5[4,5,6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm6 = xmm14[2],xmm9[2],xmm14[3],xmm9[3]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3,4,5],ymm6[6,7]
...
; AVX2-ONLY-NEXT:    vmovaps 32(%rcx), %ymm10
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm9[2],ymm10[2],ymm9[3],ymm10[3],ymm9[6],ymm10[6],ymm9[7],ymm10[7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm15 = ymm14[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm15[2,3]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm11[2],ymm6[2],ymm11[3],ymm6[3],ymm11[6],ymm6[6],ymm11[7],ymm6[7]
...
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm9 = ymm9[0],ymm10[0],ymm9[1],ymm10[1],ymm9[4],ymm10[4],ymm9[5],ymm10[5]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm10 = ymm9[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm13[0,1],xmm10[2,3]
; AVX2-ONLY-NEXT:    vmovaps (%r10), %ymm13
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm11 = ymm11[0],ymm6[0],ymm11[1],ymm6[1],ymm11[4],ymm6[4],ymm11[5],ymm6[5]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm11[0],ymm12[0],ymm11[2],ymm12[2]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm10[0,1,2,3,4],ymm6[5],ymm10[6,7]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm13[0,1,2,3,4,5,6],ymm3[7]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm10 = ymm5[2],ymm2[2],ymm5[3],ymm2[3],ymm5[6],ymm2[6],ymm5[7],ymm2[7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm10[0,1,2,3,4,5],ymm3[6,7]
...
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm10[1],ymm6[1],ymm10[3],ymm6[3]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm9, %xmm9
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm3 = ymm13[0],ymm3[0],ymm13[1],ymm3[1],ymm13[4],ymm3[4],ymm13[5],ymm3[5]
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm12[0],xmm13[0],xmm12[1],xmm13[1]
...
; AVX2-ONLY-NEXT:    vbroadcastss %xmm15, %xmm0
; AVX2-ONLY-NEXT:    vbroadcastss %xmm14, %xmm1
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-ONLY-NEXT:    vbroadcastss %xmm13, %xmm1
; AVX2-ONLY-NEXT:    vbroadcastss %xmm12, %xmm2
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm2[0],xmm1[0],xmm2[1],xmm1[1]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm6[0],xmm5[0],xmm6[1],xmm5[1]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm2
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1,2,3,4,5],ymm1[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vmovaps 32(%rax), %xmm6
; AVX2-ONLY-NEXT:    vmovaps 32(%r10), %xmm5
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm2 = xmm6[2,2,2,2]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm8[2],xmm9[2],xmm8[3],xmm9[3]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm10
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm10[0,1,2,3,4,5],ymm0[6,7]
; AVX2-ONLY-NEXT:    vmovaps 32(%rcx), %xmm2
; AVX2-ONLY-NEXT:    vmovaps 32(%rdx), %xmm1
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm10 = xmm2[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm1[0,1,2],xmm10[3]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm0[0,1],xmm10[2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2,3],ymm11[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} xmm11 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm11[1]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} xmm11 = xmm5[2],xmm6[2],xmm5[3],xmm6[3]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm11
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[2,3,2,3]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm7, %ymm0, %ymm7
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3,4,5],ymm11[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm7 = ymm0[0,1,2,3],ymm7[4,5,6,7]
; AVX2-ONLY-NEXT:    vbroadcastss %xmm2, %xmm0
; AVX2-ONLY-NEXT:    vbroadcastss %xmm1, %xmm11
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm11[0],xmm0[0],xmm11[1],xmm0[1]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm0 = xmm11[0,1],xmm0[2,3]
; AVX2-ONLY-NEXT:    vbroadcastss %xmm6, %xmm11
; AVX2-ONLY-NEXT:    vbroadcastss %xmm5, %xmm10
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm10 = xmm10[0],xmm11[0],xmm10[1],xmm11[1]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm8[0],xmm9[0],xmm8[1],xmm9[1]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm11, %ymm0, %ymm11
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm10, %ymm0, %ymm10
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm2 = xmm3[1,1,1,1]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0],xmm4[1],xmm2[2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm5[0],xmm6[0],xmm5[1],xmm6[1]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm3 = xmm8[1,1,1,1]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm3 = xmm3[0],xmm9[1],xmm3[2,3]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm2
...
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm4 = xmm13[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm4 = xmm12[0,1,2],xmm4[3]
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm0, %ymm4
; AVX2-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm5
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1,2,3,4,5],ymm4[6,7]
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} xmm5 = xmm15[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm5 = xmm14[0,1,2],xmm5[3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm5 = xmm2[0,1],xmm5[2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1,2,3],ymm4[4,5,6,7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} xmm5 = xmm14[2],xmm15[2],xmm14[3],xmm15[3]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm2[1],xmm5[1]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} xmm5 = xmm12[2],xmm13[2],xmm12[3],xmm13[3]
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,4,20,u,u,u,u,u,u,5,21,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm12 = <4,20,u,u,u,u,u,u,5,21,u,u,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm0, %zmm12
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm12 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm12 {%k3}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,6,22,u,u,u,u,u,u,7,23>
; AVX512F-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,6,22,u,u,u,u,u,u,7,23,u,u>
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,6,22,u,u,u,u,u,u,7,23,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm13 = <6,22,u,u,u,u,u,u,7,23,u,u,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm0, %zmm13
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm13 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm13 {%k3}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,8,24,u,u,u,u,u,u,9,25>
; AVX512F-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,8,24,u,u,u,u,u,u,9,25,u,u>
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,8,24,u,u,u,u,u,u,9,25,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm14 = <8,24,u,u,u,u,u,u,9,25,u,u,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm0, %zmm14
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm14 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm14 {%k3}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,10,26,u,u,u,u,u,u,11,27>
; AVX512F-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,10,26,u,u,u,u,u,u,11,27,u,u>
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,10,26,u,u,u,u,u,u,11,27,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
...
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm15 {%k3}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,12,28,u,u,u,u,u,u,13,29>
; AVX512F-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,12,28,u,u,u,u,u,u,13,29,u,u>
; AVX512F-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,12,28,u,u,u,u,u,u,13,29,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm16 = <12,28,u,u,u,u,u,u,13,29,u,u,u,u,u,u>
; AVX512F-NEXT:    vpermi2d %zmm1, %zmm0, %zmm16
; AVX512F-NEXT:    vmovdqa64 %zmm10, %zmm16 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm11, %zmm16 {%k3}
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,14,30,u,u,u,u,u,u,15,31>
; AVX512F-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
...
; AVX512F-NEXT:    vmovdqa64 %zmm13, 192(%rax)
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,4,20,u,u,u,u,u,u,5,21,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm12 = <4,20,u,u,u,u,u,u,5,21,u,u,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm0, %zmm12
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm12 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm12 {%k3}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,6,22,u,u,u,u,u,u,7,23>
; AVX512BW-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,6,22,u,u,u,u,u,u,7,23,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,6,22,u,u,u,u,u,u,7,23,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm13 = <6,22,u,u,u,u,u,u,7,23,u,u,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm0, %zmm13
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm13 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm13 {%k3}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,8,24,u,u,u,u,u,u,9,25>
; AVX512BW-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,8,24,u,u,u,u,u,u,9,25,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,8,24,u,u,u,u,u,u,9,25,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm14 = <8,24,u,u,u,u,u,u,9,25,u,u,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm0, %zmm14
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm14 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm14 {%k3}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,10,26,u,u,u,u,u,u,11,27>
; AVX512BW-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,10,26,u,u,u,u,u,u,11,27,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,10,26,u,u,u,u,u,u,11,27,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,12,28,u,u,u,u,u,u,13,29>
; AVX512BW-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm11 = <u,u,u,u,12,28,u,u,u,u,u,u,13,29,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm6, %zmm5, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm11 {%k1}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,12,28,u,u,u,u,u,u,13,29,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm3, %zmm2, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm16 = <12,28,u,u,u,u,u,u,13,29,u,u,u,u,u,u>
; AVX512BW-NEXT:    vpermi2d %zmm1, %zmm0, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm16 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm16 {%k3}
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm10 = <u,u,u,u,u,u,14,30,u,u,u,u,u,u,15,31>
; AVX512BW-NEXT:    vpermi2d %zmm8, %zmm7, %zmm10
...
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[1,1],xmm0[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,3],xmm6[2,0]
; SSE-NEXT:    movaps %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps %xmm4, %xmm6
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[1,1],xmm2[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[2,3],xmm6[2,0]
; SSE-NEXT:    movaps %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE-NEXT:    unpcklps {{.*#+}} xmm14 = xmm14[0],xmm12[0],xmm14[1],xmm12[1]
; SSE-NEXT:    movaps %xmm14, %xmm3
...
; SSE-NEXT:    shufps {{.*#+}} xmm14 = xmm14[2,3],xmm9[2,0]
; SSE-NEXT:    movaps %xmm4, %xmm9
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,1],xmm2[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[2,3],xmm9[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[2,3],xmm0[0,2]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3],xmm4[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[2,3],xmm2[0,2]
...
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,3],xmm4[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[2,3],xmm5[0,2]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[3,3],xmm6[3,3]
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,3],xmm3[0,2]
; SSE-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; SSE-NEXT:    movaps %xmm0, 1008(%rax)
; SSE-NEXT:    movaps %xmm2, 992(%rax)
; SSE-NEXT:    movaps %xmm11, 976(%rax)
; SSE-NEXT:    movaps %xmm12, 960(%rax)
; SSE-NEXT:    movaps %xmm1, 944(%rax)
; SSE-NEXT:    movaps %xmm9, 928(%rax)
; SSE-NEXT:    movaps %xmm10, 912(%rax)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 896(%rax)
; SSE-NEXT:    movaps %xmm8, 880(%rax)
; SSE-NEXT:    movaps %xmm13, 864(%rax)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 848(%rax)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 832(%rax)
; SSE-NEXT:    movaps %xmm15, 816(%rax)
...
; AVX1-ONLY-NEXT:    vmovaps (%rcx), %ymm9
; AVX1-ONLY-NEXT:    vmovaps (%r8), %ymm10
; AVX1-ONLY-NEXT:    vmovaps (%r9), %ymm11
; AVX1-ONLY-NEXT:    vmovaps (%r10), %ymm7
; AVX1-ONLY-NEXT:    vmovaps (%rax), %ymm12
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm12[0],ymm7[0],ymm12[2],ymm7[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm6 = ymm10[0],ymm11[0],ymm10[1],ymm11[1],ymm10[4],ymm11[4],ymm10[5],ymm11[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm6[0,1],ymm4[2,0],ymm6[4,5],ymm4[6,4]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm6 = ymm3[0],ymm5[0],ymm3[1],ymm5[1],ymm3[4],ymm5[4],ymm3[5],ymm5[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm6, %xmm6
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm9[0],ymm8[0],ymm9[2],ymm8[2]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm6 = xmm6[0,1],xmm13[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0,1,2,3],ymm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm4 = ymm7[0],ymm12[0],ymm7[1],ymm12[1],ymm7[4],ymm12[4],ymm7[5],ymm12[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm11[1,0],ymm10[1,0],ymm11[5,4],ymm10[5,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm6[2,0],ymm4[2,3],ymm6[6,4],ymm4[6,7]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm6 = ymm8[0],ymm9[0],ymm8[1],ymm9[1],ymm8[4],ymm9[4],ymm8[5],ymm9[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm6, %xmm6
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm5[1,0],ymm3[1,0],ymm5[5,4],ymm3[5,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[2,0,2,3,6,4,6,7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm6 = xmm13[0,1],xmm6[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0,1,2,3],ymm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm4 = ymm12[1],ymm7[1],ymm12[3],ymm7[3]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm6 = ymm10[2],ymm11[2],ymm10[3],ymm11[3],ymm10[6],ymm11[6],ymm10[7],ymm11[7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm6[0,1],ymm4[2,0],ymm6[4,5],ymm4[6,4]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm3[2],ymm5[2],ymm3[3],ymm5[3],ymm3[6],ymm5[6],ymm3[7],ymm5[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm4
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm9[1],ymm8[1],ymm9[3],ymm8[3]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm13 = ymm13[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm13 = xmm4[0,1],xmm13[2,3]
; AVX1-ONLY-NEXT:    vmovaps 32(%rcx), %ymm4
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0,1,2,3],ymm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 32(%r8), %ymm6
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm7[2],ymm12[2],ymm7[3],ymm12[3],ymm7[6],ymm12[6],ymm7[7],ymm12[7]
; AVX1-ONLY-NEXT:    vmovaps 32(%r9), %ymm7
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm11 = ymm11[3,0],ymm10[3,0],ymm11[7,4],ymm10[7,4]
; AVX1-ONLY-NEXT:    vmovaps 32(%r10), %ymm10
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm12 = ymm11[2,0],ymm12[2,3],ymm11[6,4],ymm12[6,7]
; AVX1-ONLY-NEXT:    vmovaps 32(%rax), %ymm11
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm8 = ymm8[2],ymm9[2],ymm8[3],ymm9[3],ymm8[6],ymm9[6],ymm8[7],ymm9[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm8, %xmm8
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm5[3,0],ymm3[3,0],ymm5[7,4],ymm3[7,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[2,0,2,3,6,4,6,7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm3, %xmm3
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm3 = xmm3[0,1],xmm8[2,3]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm6[0],ymm7[0],ymm6[1],ymm7[1],ymm6[4],ymm7[4],ymm6[5],ymm7[5]
...
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
...
; AVX1-ONLY-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm3 = ymm10[0],ymm11[0],ymm10[1],ymm11[1],ymm10[4],ymm11[4],ymm10[5],ymm11[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm5 = ymm7[1,0],ymm6[1,0],ymm7[5,4],ymm6[5,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm5[2,0],ymm3[2,3],ymm5[6,4],ymm3[6,7]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm2[0],ymm4[0],ymm2[1],ymm4[1],ymm2[4],ymm4[4],ymm2[5],ymm4[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm5, %xmm5
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm5[0,1,2,3],ymm3[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm11[1],ymm10[1],ymm11[3],ymm10[3]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm5 = ymm6[2],ymm7[2],ymm6[3],ymm7[3],ymm6[6],ymm7[6],ymm6[7],ymm7[7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm5 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm5, %xmm5
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm4[1],ymm2[1],ymm4[3],ymm2[3]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm8, %xmm8
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm8[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm5[0,1,2,3],ymm3[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm8 = ymm10[2],ymm11[2],ymm10[3],ymm11[3],ymm10[6],ymm11[6],ymm10[7],ymm11[7]
; AVX1-ONLY-NEXT:    vmovaps 64(%rsi), %ymm5
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[3,0],ymm6[3,0],ymm7[7,4],ymm6[7,4]
; AVX1-ONLY-NEXT:    vmovaps 64(%r8), %ymm6
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm8 = ymm7[2,0],ymm8[2,3],ymm7[6,4],ymm8[6,7]
; AVX1-ONLY-NEXT:    vmovaps 64(%r9), %ymm7
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm2[2],ymm4[2],ymm2[3],ymm4[3],ymm2[6],ymm4[6],ymm2[7],ymm4[7]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm4 = ymm6[0],ymm7[0],ymm6[1],ymm7[1],ymm6[4],ymm7[4],ymm6[5],ymm7[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm4[0,1],ymm1[2,0],ymm4[4,5],ymm1[6,4]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm4 = ymm3[0],ymm5[0],ymm3[1],ymm5[1],ymm3[4],ymm5[4],ymm3[5],ymm5[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm4
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm7[1,0],ymm6[1,0],ymm7[5,4],ymm6[5,4]
...
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm4
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm5[1,0],ymm3[1,0],ymm5[5,4],ymm3[5,4]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm6[2],ymm7[2],ymm6[3],ymm7[3],ymm6[6],ymm7[6],ymm6[7],ymm7[7]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm4[0,1],ymm1[2,0],ymm4[4,5],ymm1[6,4]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm3[2],ymm5[2],ymm3[3],ymm5[3],ymm3[6],ymm5[6],ymm3[7],ymm5[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm4
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm7[3,0],ymm6[3,0],ymm7[7,4],ymm6[7,4]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm1[2,0],ymm0[2,3],ymm1[6,4],ymm0[6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm8[2],ymm9[2],ymm8[3],ymm9[3],ymm8[6],ymm9[6],ymm8[7],ymm9[7]
...
; AVX1-ONLY-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovaps 96(%rax), %ymm4
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
; AVX1-ONLY-NEXT:    vmovaps 96(%rdi), %ymm3
; AVX1-ONLY-NEXT:    vmovaps 96(%rsi), %ymm5
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2,3],ymm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm4[1],ymm2[1],ymm4[3],ymm2[3]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm3[2],ymm5[2],ymm3[3],ymm5[3],ymm3[6],ymm5[6],ymm3[7],ymm5[7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm7, %xmm7
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm10 = ymm9[1],ymm8[1],ymm9[3],ymm8[3]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[0,1,2,0,4,5,6,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm10
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2,3],ymm6[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm2[2],ymm4[2],ymm2[3],ymm4[3],ymm2[6],ymm4[6],ymm2[7],ymm4[7]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm5[3,0],ymm3[3,0],ymm5[7,4],ymm3[7,4]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[2,0,2,3,6,4,6,7]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm2, %xmm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm1 = xmm2[0,1],xmm1[2,3]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm1[0],xmm9[0],xmm1[1],xmm9[1]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm6 = xmm5[0,1,0,1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm0, %ymm6
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm4[0,1,2,3,4,5],ymm6[6,7]
...
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm0[0],xmm4[0],xmm0[1],xmm4[1]
; AVX1-ONLY-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm11[0],xmm8[0]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm11[0,1,2,3],ymm10[4,5,6,7]
; AVX1-ONLY-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm10 = xmm0[1,1,1,1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm10[0],xmm4[1],xmm10[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm8 = xmm10[0,1],xmm8[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm0, %ymm5
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm10 = xmm3[1,1,1,1]
...
; AVX1-ONLY-NEXT:    vmovaps 64(%r8), %xmm3
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 64(%rax), %xmm8
; AVX1-ONLY-NEXT:    vmovaps 64(%r10), %xmm7
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm6 = xmm5[0,1,0,1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm0, %ymm6
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3,4,5],ymm6[6,7]
; AVX1-ONLY-NEXT:    vmovaps 64(%rcx), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 64(%rdx), %xmm2
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm2[0],xmm9[0],xmm2[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm4 = xmm0[0,1],xmm4[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm4[0,1,2,3],ymm3[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vmovaps 96(%r8), %xmm7
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm7[0],xmm4[0],xmm7[1],xmm4[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 96(%rax), %xmm5
; AVX1-ONLY-NEXT:    vmovaps 96(%r10), %xmm3
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm8 = xmm3[0],xmm5[0],xmm3[1],xmm5[1]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm9 = xmm8[0,1,0,1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm0, %ymm9
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm0[0,1,2,3,4,5],ymm9[6,7]
; AVX1-ONLY-NEXT:    vmovaps 96(%rcx), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 96(%rdx), %xmm15
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm15[0],xmm9[0],xmm15[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm14[0,1,2,3],ymm6[4,5,6,7]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm0, %ymm8
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm14 = xmm7[1,1,1,1]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm14 = xmm14[0],xmm4[1],xmm14[2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm14, %ymm0, %ymm14
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm14[0,1,2,3,4,5],ymm8[6,7]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm8[4,5,6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm1[2],xmm0[3],xmm1[3]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm7[2],xmm4[2],xmm7[3],xmm4[3]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm4 = xmm5[2,2,2,2]
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm7 = xmm9[2,2,2,2]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm7 = xmm15[0,1,2],xmm7[3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} xmm7 = xmm0[0,1],xmm7[2,3]
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0,1,2,3],ymm4[4,5,6,7]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm15[2],xmm9[2],xmm15[3],xmm9[3]
; AVX1-ONLY-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm7[1]
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm3 = xmm3[2],xmm5[2],xmm3[3],xmm5[3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[2,3,2,3]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
...
; AVX1-ONLY-NEXT:    vmovaps %ymm4, 832(%rax)
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm13 = ymm4[0],ymm7[0],ymm4[1],ymm7[1],ymm4[4],ymm7[4],ymm4[5],ymm7[5]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm13, %xmm13
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm14 = ymm10[0],ymm11[0],ymm10[1],ymm11[1],ymm10[4],ymm11[4],ymm10[5],ymm11[5]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm15 = ymm14[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm13 = xmm13[0,1],xmm15[2,3]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm15 = ymm6[0],ymm12[0],ymm6[1],ymm12[1],ymm6[4],ymm12[4],ymm6[5],ymm12[5]
; AVX2-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm15[0],ymm5[0],ymm15[2],ymm5[2]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm14 = xmm14[0,1],xmm5[2,3]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm6[2],ymm12[2],ymm6[3],ymm12[3],ymm6[6],ymm12[6],ymm6[7],ymm12[7]
; AVX2-ONLY-NEXT:    vmovaps 32(%rax), %ymm6
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm4[2],ymm7[2],ymm4[3],ymm7[3],ymm4[6],ymm7[6],ymm4[7],ymm7[7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm7
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm10 = ymm10[2],ymm11[2],ymm10[3],ymm11[3],ymm10[6],ymm11[6],ymm10[7],ymm11[7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm11 = ymm10[2,2,2,2]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm11 = xmm7[0,1],xmm11[2,3]
...
; AVX2-ONLY-NEXT:    vbroadcastss 28(%rax), %ymm11
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm9 = ymm11[2],ymm9[2],ymm11[3],ymm9[3],ymm11[6],ymm9[6],ymm11[7],ymm9[7]
; AVX2-ONLY-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm12[1],ymm9[1],ymm12[3],ymm9[3]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm10
; AVX2-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[2,3,2,3,6,7,6,7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm4
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm4 = xmm4[0,1],xmm10[2,3]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2,3],ymm9[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm4 = ymm6[0],ymm7[0],ymm6[1],ymm7[1],ymm6[4],ymm7[4],ymm6[5],ymm7[5]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm9 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm9, %xmm9
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm11 = ymm5[0],ymm8[0],ymm5[1],ymm8[1],ymm5[4],ymm8[4],ymm5[5],ymm8[5]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1,2,3,4],ymm8[5],ymm9[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1,2,3,4,5],ymm4[6,7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm4
...
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm10
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} xmm10 = xmm10[0,1],xmm4[2,3]
; AVX2-ONLY-NEXT:    vmovaps 64(%rdi), %ymm4
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1,2,3],ymm9[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 56(%r10), %ymm9
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0,1,2,3,4,5,6],ymm9[7]
; AVX2-ONLY-NEXT:    vmovaps 64(%rsi), %ymm6
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm8 = ymm5[2],ymm8[2],ymm5[3],ymm8[3],ymm5[6],ymm8[6],ymm5[7],ymm8[7]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm8[0,1,2,3,4,5],ymm9[6,7]
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm9[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 60(%rax), %ymm3
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm3 = ymm3[2],ymm7[2],ymm3[3],ymm7[3],ymm3[6],ymm7[6],ymm3[7],ymm7[7]
...
; AVX2-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm1 = ymm4[0],ymm6[0],ymm4[1],ymm6[1],ymm4[4],ymm6[4],ymm4[5],ymm6[5]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm1, %xmm1
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm2 = ymm5[0],ymm0[0],ymm5[1],ymm0[1],ymm5[4],ymm0[4],ymm5[5],ymm0[5]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm3 = ymm2[2,2,2,2]
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm11 = ymm7[0],ymm3[0],ymm7[1],ymm3[1],ymm7[4],ymm3[4],ymm7[5],ymm3[5]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm6[1],ymm10[2,3,4],ymm6[5],ymm10[6,7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm10, %xmm10
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm2 = ymm7[2],ymm3[2],ymm7[3],ymm3[3],ymm7[6],ymm3[6],ymm7[7],ymm3[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm3 = ymm4[2],ymm6[2],ymm4[3],ymm6[3],ymm4[6],ymm6[6],ymm4[7],ymm6[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm5[2],ymm0[2],ymm5[3],ymm0[3],ymm5[6],ymm0[6],ymm5[7],ymm0[7]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm0[2],ymm9[2],ymm0[3],ymm9[3],ymm0[6],ymm9[6],ymm0[7],ymm9[7]
...
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm4[0],ymm3[0],ymm4[1],ymm3[1],ymm4[4],ymm3[4],ymm4[5],ymm3[5]
...
; AVX2-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 116(%r8), %ymm2
...
; AVX2-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 120(%r10), %ymm2
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
...
; AVX512F-NEXT:    vmovdqa64 (%r10), %zmm29
; AVX512F-NEXT:    vmovdqa64 64(%r10), %zmm19
; AVX512F-NEXT:    vmovdqa64 (%rax), %zmm1
; AVX512F-NEXT:    vmovdqa64 64(%rax), %zmm2
...
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm5
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,0,16,u,u,u,u,u,u,1,17,u,u>
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,6,22,u,u,u,u,u,u,7,23>
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm7
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm7
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,6,22,u,u,u,u,u,u,7,23,u,u>
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,4,20,u,u,u,u,u,u,5,21>
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm9
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm9
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,4,20,u,u,u,u,u,u,5,21,u,u>
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,10,26,u,u,u,u,u,u,11,27>
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm11
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm11
; AVX512F-NEXT:    vmovdqu64 %zmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm11
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,10,26,u,u,u,u,u,u,11,27,u,u>
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,8,24,u,u,u,u,u,u,9,25>
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm13
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm13
; AVX512F-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm15 = <u,u,u,u,8,24,u,u,u,u,u,u,9,25,u,u>
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,14,30,u,u,u,u,u,u,15,31>
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm16
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm16
; AVX512F-NEXT:    vmovdqu64 %zmm16, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm16
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,12,28,u,u,u,u,u,u,13,29>
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm29
; AVX512F-NEXT:    vmovdqa64 %zmm21, %zmm30
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm15, %zmm30
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm11
; AVX512F-NEXT:    vmovdqu64 %zmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm13
; AVX512F-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm2, %zmm19, %zmm16
; AVX512F-NEXT:    vmovdqu64 %zmm16, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm3, %zmm19
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm20 = <u,u,u,u,14,30,u,u,u,u,u,u,15,31,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm21, %zmm31
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm20, %zmm31
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm1 = <u,u,u,u,12,28,u,u,u,u,u,u,13,29,u,u>
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm21
; AVX512F-NEXT:    vmovdqa64 64(%r8), %zmm22
...
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm28
...
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm6
; AVX512F-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm8
; AVX512F-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm4, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
...
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm16
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm5 = <8,24,u,u,u,u,u,u,9,25,u,u,u,u,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm11
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm5, %zmm11
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm2 = <14,30,u,u,u,u,u,u,15,31,u,u,u,u,u,u>
; AVX512F-NEXT:    vmovdqa64 %zmm3, %zmm9
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm2, %zmm9
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <12,28,u,u,u,u,u,u,13,29,u,u,u,u,u,u>
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm23, %zmm3
...
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm23, %zmm1
...
; AVX512F-NEXT:    vmovdqa64 %zmm24, %zmm18 {%k2}
...
; AVX512F-NEXT:    vmovdqa64 %zmm26, %zmm16 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm23, %zmm16 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm23 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm23 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm27, %zmm15 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm23, %zmm15 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm23 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm23 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm28, %zmm14 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm23, %zmm14 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm23 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm23 {%k1}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm13 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm23, %zmm13 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm30 {%k1}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm11 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm30, %zmm11 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm31 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm25, %zmm9 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm31, %zmm9 {%k3}
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm21 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm3 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm21, %zmm3 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512F-NEXT:    vmovdqu64 (%rsp), %zmm17 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm12 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm12 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm10 {%k2}
...
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm17, %zmm6 {%k2}
...
; AVX512F-NEXT:    vmovdqa64 %zmm20, %zmm2 {%k3}
; AVX512F-NEXT:    vmovdqa64 %zmm19, %zmm22 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm1 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm22, %zmm1 {%k3}
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm5
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,0,16,u,u,u,u,u,u,1,17,u,u>
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,6,22,u,u,u,u,u,u,7,23>
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm7
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm7
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,6,22,u,u,u,u,u,u,7,23,u,u>
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,4,20,u,u,u,u,u,u,5,21>
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm9
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,4,20,u,u,u,u,u,u,5,21,u,u>
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,10,26,u,u,u,u,u,u,11,27>
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm11
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm11
; AVX512BW-NEXT:    vmovdqu64 %zmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm11
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,10,26,u,u,u,u,u,u,11,27,u,u>
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,8,24,u,u,u,u,u,u,9,25>
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm13
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm13
; AVX512BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm15 = <u,u,u,u,8,24,u,u,u,u,u,u,9,25,u,u>
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,14,30,u,u,u,u,u,u,15,31>
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm16
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm16
; AVX512BW-NEXT:    vmovdqu64 %zmm16, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm16
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,12,28,u,u,u,u,u,u,13,29>
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm29
; AVX512BW-NEXT:    vmovdqa64 %zmm21, %zmm30
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm30
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm11
; AVX512BW-NEXT:    vmovdqu64 %zmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm13
; AVX512BW-NEXT:    vmovdqu64 %zmm13, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm19, %zmm16
; AVX512BW-NEXT:    vmovdqu64 %zmm16, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm3, %zmm19
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm20 = <u,u,u,u,14,30,u,u,u,u,u,u,15,31,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm21, %zmm31
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm20, %zmm31
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm28
...
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm6
; AVX512BW-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm8
; AVX512BW-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm4, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm4
...
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm16
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm10, %zmm16
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm5 = <8,24,u,u,u,u,u,u,9,25,u,u,u,u,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm11
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm5, %zmm11
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm2 = <14,30,u,u,u,u,u,u,15,31,u,u,u,u,u,u>
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm9
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm9
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm23 = <12,28,u,u,u,u,u,u,13,29,u,u,u,u,u,u>
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm23, %zmm3
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm23, %zmm1
...
; AVX512BW-NEXT:    vmovdqa64 %zmm24, %zmm18 {%k2}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm26, %zmm16 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm16 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm23 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm23 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm27, %zmm15 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm15 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm23 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm23 {%k1}
; AVX512BW-NEXT:    vmovdqa64 %zmm28, %zmm14 {%k2}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm12 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm12 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm10 {%k2}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm0 {%k1}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm17, %zmm5 {%k2}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm1 {%k2}
...
; SSE-NEXT:    movaps 224(%rax), %xmm8
; SSE-NEXT:    movaps %xmm8, %xmm9
; SSE-NEXT:    movlhps {{.*#+}} xmm9 = xmm9[0],xmm1[0]
; SSE-NEXT:    movaps 224(%r8), %xmm10
; SSE-NEXT:    movaps 224(%r9), %xmm5
...
; SSE-NEXT:    shufps {{.*#+}} xmm15 = xmm15[2,3],xmm9[2,0]
; SSE-NEXT:    movaps %xmm8, %xmm9
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,1],xmm1[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[2,3],xmm9[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[2,3],xmm6[2,0]
...
; AVX1-ONLY-NEXT:    vmovaps 128(%r10), %ymm2
; AVX1-ONLY-NEXT:    vmovaps 128(%rax), %ymm4
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
; AVX1-ONLY-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX1-ONLY-NEXT:    vmovaps 128(%rsi), %ymm5
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm7 = ymm3[0],ymm5[0],ymm3[1],ymm5[1],ymm3[4],ymm5[4],ymm3[5],ymm5[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm7, %xmm7
...
; AVX1-ONLY-NEXT:    vmovaps 160(%r10), %ymm2
; AVX1-ONLY-NEXT:    vmovaps 160(%rax), %ymm4
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
...
; AVX1-ONLY-NEXT:    vmovaps 192(%r10), %ymm2
; AVX1-ONLY-NEXT:    vmovaps 192(%rax), %ymm4
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
...
; AVX1-ONLY-NEXT:    vmovaps 224(%r10), %ymm2
; AVX1-ONLY-NEXT:    vmovaps 224(%rax), %ymm4
; AVX1-ONLY-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm4[0],ymm2[0],ymm4[2],ymm2[2]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm0[0],ymm1[0],ymm0[1],ymm1[1],ymm0[4],ymm1[4],ymm0[5],ymm1[5]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[0,1],ymm3[2,0],ymm5[4,5],ymm3[6,4]
; AVX1-ONLY-NEXT:    vmovaps 224(%rdi), %ymm3
; AVX1-ONLY-NEXT:    vmovaps 224(%rsi), %ymm5
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} ymm7 = ymm3[0],ymm5[0],ymm3[1],ymm5[1],ymm3[4],ymm5[4],ymm3[5],ymm5[5]
; AVX1-ONLY-NEXT:    vextractf128 $1, %ymm7, %xmm7
...
; AVX1-ONLY-NEXT:    vmovaps 128(%r8), %xmm3
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm3[0],xmm2[0],xmm3[1],xmm2[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm4
...
; AVX1-ONLY-NEXT:    vmovaps 192(%r8), %xmm3
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm3[0],xmm4[0],xmm3[1],xmm4[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 192(%rax), %xmm8
; AVX1-ONLY-NEXT:    vmovaps 192(%r10), %xmm7
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm7[0],xmm8[0],xmm7[1],xmm8[1]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm6 = xmm5[0,1,0,1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm0, %ymm6
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1,2,3,4,5],ymm6[6,7]
; AVX1-ONLY-NEXT:    vmovaps 192(%rcx), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 192(%rdx), %xmm2
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm2[0],xmm9[0],xmm2[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vmovaps 224(%r8), %xmm7
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm7[0],xmm4[0],xmm7[1],xmm4[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vmovaps 224(%rax), %xmm5
; AVX1-ONLY-NEXT:    vmovaps 224(%r10), %xmm3
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm8 = xmm3[0],xmm5[0],xmm3[1],xmm5[1]
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} xmm9 = xmm8[0,1,0,1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm0, %ymm9
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm6 = ymm0[0,1,2,3,4,5],ymm9[6,7]
...
; AVX1-ONLY-NEXT:    vmovaps %ymm4, 1856(%rax)
...
; AVX2-ONLY-NEXT:    vmovaps 32(%r9), %ymm8
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm6[2],ymm12[2],ymm6[3],ymm12[3],ymm6[6],ymm12[6],ymm6[7],ymm12[7]
; AVX2-ONLY-NEXT:    vmovaps 32(%r10), %ymm6
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm4 = ymm4[2],ymm7[2],ymm4[3],ymm7[3],ymm4[6],ymm7[6],ymm4[7],ymm7[7]
; AVX2-ONLY-NEXT:    vextractf128 $1, %ymm4, %xmm7
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm10 = ymm10[2],ymm11[2],ymm10[3],ymm11[3],ymm10[6],ymm11[6],ymm10[7],ymm11[7]
; AVX2-ONLY-NEXT:    vpermpd {{.*#+}} ymm11 = ymm10[2,2,2,2]
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0,1,2,3],ymm9[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 56(%rax), %ymm9
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm6[0,1,2,3,4,5,6],ymm9[7]
; AVX2-ONLY-NEXT:    vmovaps 64(%rsi), %ymm6
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm8 = ymm5[2],ymm8[2],ymm5[3],ymm8[3],ymm5[6],ymm8[6],ymm5[7],ymm8[7]
; AVX2-ONLY-NEXT:    vmovaps 64(%rdx), %ymm5
...
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0,1,2,3],ymm2[4,5,6,7]
; AVX2-ONLY-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vbroadcastss 120(%rax), %ymm2
; AVX2-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm8[0,1,2,3,4,5,6],ymm2[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm5 = ymm6[2],ymm7[2],ymm6[3],ymm7[3],ymm6[6],ymm7[6],ymm6[7],ymm7[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm0 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
...
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512F-NEXT:    vmovdqa64 (%r10), %zmm13
; AVX512F-NEXT:    vmovdqa64 64(%r10), %zmm12
; AVX512F-NEXT:    vmovdqa64 128(%r10), %zmm4
; AVX512F-NEXT:    vmovdqa64 (%rax), %zmm0
; AVX512F-NEXT:    vmovdqa64 64(%rax), %zmm1
; AVX512F-NEXT:    vmovdqa64 128(%rax), %zmm2
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,0,16,u,u,u,u,u,u,1,17>
...
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm6, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm0
...
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm1, %zmm3, %zmm12
; AVX512F-NEXT:    vmovdqu64 %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm5, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm6, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm7, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm8, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm9, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm10, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm11, %zmm0
; AVX512F-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm2, %zmm3, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-NEXT:    vmovdqa64 64(%r8), %zmm29
; AVX512F-NEXT:    vmovdqa64 64(%r9), %zmm0
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm9
...
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm2, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm29
...
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm22
; AVX512F-NEXT:    vmovdqa64 192(%r8), %zmm25
; AVX512F-NEXT:    vmovdqa64 192(%r9), %zmm0
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm8
; AVX512F-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm7
; AVX512F-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm6
; AVX512F-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm25, %zmm2
; AVX512F-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm1, %zmm25
...
; AVX512F-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm3
; AVX512F-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm4
; AVX512F-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm5
; AVX512F-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm8
; AVX512F-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm9
; AVX512F-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm16, %zmm10
; AVX512F-NEXT:    vmovdqu64 %zmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm8, %zmm28
; AVX512F-NEXT:    vmovdqa64 %zmm12, %zmm27
; AVX512F-NEXT:    vpermt2d %zmm0, %zmm4, %zmm27
...
; AVX512F-NEXT:    vpermi2d %zmm0, %zmm2, %zmm8
...
; AVX512F-NEXT:    vmovdqa64 %zmm30, %zmm5 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 %zmm7, %zmm1 {%k3}
; AVX512F-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm7 {%k1}
...
; AVX512F-NEXT:    vmovdqa64 %zmm7, %zmm27 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm7 {%k1}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm26 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm7, %zmm26 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-NEXT:    vmovdqa64 %zmm0, %zmm29 {%k1}
; AVX512F-NEXT:    vmovdqa64 %zmm6, %zmm12 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm29, %zmm12 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 %zmm6, %zmm17 {%k3}
; AVX512F-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512F-NEXT:    vmovdqa64 %zmm16, %zmm2 {%k2}
; AVX512F-NEXT:    vmovdqa64 %zmm25, %zmm2 {%k3}
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512F-NEXT:    vmovdqa64 %zmm17, 1408(%rax)
...
; AVX512F-NEXT:    vmovdqa64 %zmm26, 896(%rax)
; AVX512F-NEXT:    vmovdqa64 %zmm27, 832(%rax)
; AVX512F-NEXT:    vmovdqa64 %zmm28, 768(%rax)
...
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512BW-NEXT:    vmovdqa64 (%r10), %zmm13
; AVX512BW-NEXT:    vmovdqa64 64(%r10), %zmm12
; AVX512BW-NEXT:    vmovdqa64 128(%r10), %zmm4
; AVX512BW-NEXT:    vmovdqa64 (%rax), %zmm0
; AVX512BW-NEXT:    vmovdqa64 64(%rax), %zmm1
; AVX512BW-NEXT:    vmovdqa64 128(%rax), %zmm2
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm3 = <u,u,u,u,u,u,0,16,u,u,u,u,u,u,1,17>
...
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm1, %zmm3, %zmm12
; AVX512BW-NEXT:    vmovdqu64 %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm5, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm6, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm7, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm8, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm9, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm10, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm11, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm3, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vmovdqa64 64(%r8), %zmm29
; AVX512BW-NEXT:    vmovdqa64 64(%r9), %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm29, %zmm9
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm2, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm29
...
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm22
; AVX512BW-NEXT:    vmovdqa64 192(%r8), %zmm25
; AVX512BW-NEXT:    vmovdqa64 192(%r9), %zmm0
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm8
; AVX512BW-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm7
; AVX512BW-NEXT:    vmovdqu64 %zmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm6
; AVX512BW-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm25, %zmm2
; AVX512BW-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm25
...
; AVX512BW-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm4
; AVX512BW-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm8
; AVX512BW-NEXT:    vmovdqu64 %zmm8, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm9
; AVX512BW-NEXT:    vmovdqu64 %zmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm16, %zmm10
; AVX512BW-NEXT:    vmovdqu64 %zmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm8, %zmm28
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm27
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm4, %zmm27
...
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm2, %zmm8
...
; AVX512BW-NEXT:    vmovdqa64 %zmm30, %zmm5 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 %zmm7, %zmm1 {%k3}
; AVX512BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm7 {%k1}
...
; AVX512BW-NEXT:    vmovdqa64 %zmm7, %zmm27 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm7 {%k1}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm26 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm7, %zmm26 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 %zmm6, %zmm17 {%k3}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-NEXT:    vmovdqa64 %zmm16, %zmm2 {%k2}
; AVX512BW-NEXT:    vmovdqa64 %zmm25, %zmm2 {%k3}
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-NEXT:    vmovdqa64 %zmm17, 1408(%rax)
...
; AVX512BW-NEXT:    vmovdqa64 %zmm26, 896(%rax)
; AVX512BW-NEXT:    vmovdqa64 %zmm27, 832(%rax)
; AVX512BW-NEXT:    vmovdqa64 %zmm28, 768(%rax)
