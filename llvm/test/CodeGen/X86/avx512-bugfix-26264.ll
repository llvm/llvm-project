...
define <32 x i64> @test_load_32i64(ptr %ptrs, <32 x i1> %mask, <32 x i64> %src0)  {
...
declare <32 x i64> @llvm.masked.load.v32i64.p0(ptr %ptrs, i32, <32 x i1> %mask, <32 x i64> %src0)
