...
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm0, %zmm4, %zmm1
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm9[0,1,2,2,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,7,5,4,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm3[1,1,2,2]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm1, %ymm5, %ymm5
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm1, %ymm4, %ymm4
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
...
; AVX512F-NEXT:    vpshufb {{.*#+}} ymm0 = zero,zero,ymm0[u,u,12,13],zero,zero,ymm0[u,u,14,15],zero,zero,ymm0[u,u,16,17],zero,zero,ymm0[u,u,18,19],zero,zero,ymm0[u,u,20,21],zero,zero
; AVX512F-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[10,11,u,u],zero,zero,ymm1[12,13,u,u],zero,zero,ymm1[14,15,u,u],zero,zero,ymm1[16,17,u,u],zero,zero,ymm1[18,19,u,u],zero,zero,ymm1[20,21]
; AVX512F-NEXT:    vpor %ymm0, %ymm1, %ymm0
; AVX512F-NEXT:    vinserti64x4 $1, %ymm0, %zmm3, %zmm0
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm1 = <u,0,0,u,1,1,u,2>
...
; AVX512F-NEXT:    vpshufb {{.*#+}} ymm3 = zero,zero,ymm2[10,11],zero,zero,zero,zero,ymm2[12,13],zero,zero,zero,zero,ymm2[14,15],zero,zero,zero,zero,ymm2[16,17],zero,zero,zero,zero,ymm2[18,19],zero,zero,zero,zero
; AVX512F-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm1
; AVX512F-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm1
; AVX512F-NEXT:    vprold $16, %xmm4, %xmm0
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm3 = xmm7[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm0 = xmm3[0,1],xmm0[2],xmm3[3,4],xmm0[5],xmm3[6,7]
...
; AVX512F-NEXT:    vpermd %ymm2, %ymm3, %ymm2
; AVX512F-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm2
; AVX512F-NEXT:    vmovdqa %ymm2, 64(%rcx)
...
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm11[2,1,3,3]
...
; AVX1-ONLY-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm13[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,4,4,4]
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm12[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm1 = xmm7[0],xmm4[1,2],xmm7[3],xmm4[4,5],xmm7[6],xmm4[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm9[0],xmm13[0],xmm9[1],xmm13[1],xmm9[2],xmm13[2],xmm9[3],xmm13[3]
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm11 = xmm12[2,2,3,3]
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm9 = xmm12[0,0,0,0]
...
; AVX2-FAST-NEXT:    vpshufb %xmm2, %xmm1, %xmm3
...
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm3[4],xmm9[5],xmm3[5],xmm9[6],xmm3[6],xmm9[7],xmm3[7]
...
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm9[2],xmm3[3,4],xmm9[5],xmm3[6,7]
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm10, %ymm3, %ymm9
; AVX2-FAST-NEXT:    vpshufb %xmm2, %xmm4, %xmm3
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm3[2],xmm10[3,4],xmm3[5],xmm10[6,7]
...
; AVX2-FAST-NEXT:    vpermd %ymm3, %ymm10, %ymm7
...
; AVX2-FAST-NEXT:    vpblendvb %ymm8, %ymm9, %ymm7, %ymm7
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
...
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm9, %ymm2, %ymm2
...
; AVX2-FAST-NEXT:    vpshufb %ymm5, %ymm9, %ymm5
...
; AVX2-FAST-NEXT:    vpblendvb %ymm9, %ymm5, %ymm3, %ymm3
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm1, %xmm3
...
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm3[4],xmm9[5],xmm3[5],xmm9[6],xmm3[6],xmm9[7],xmm3[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm9[2],xmm3[3,4],xmm9[5],xmm3[6,7]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm10, %ymm3, %ymm9
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm2, %xmm4, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm3[2],xmm10[3,4],xmm3[5],xmm10[6,7]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rdx), %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm7, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm8, %ymm4, %ymm7, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm10, %ymm7
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm8, %ymm9, %ymm7, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
...
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm9, %ymm2, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm0, %ymm10, %ymm5
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm5, %ymm9, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vpermd 32(%rdi), %ymm8, %ymm8
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm5, %ymm8, %ymm5
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm8, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm9, %ymm5, %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm3, 128(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, 32(%rcx)
...
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm5 = [128,128,128,128,12,13,128,128,128,128,14,15,128,128,128,128,16,17,128,128,128,128,18,19,128,128,128,128,20,21,128,128]
; AVX512F-NEXT:    vpshufb %ymm5, %ymm3, %ymm3
; AVX512F-NEXT:    vmovdqa 32(%rsi), %ymm6
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm8 = [10,11,0,1,128,128,12,13,2,3,128,128,14,15,4,5,128,128,16,17,28,29,128,128,18,19,18,19,128,128,20,21]
; AVX512F-NEXT:    vpshufb %ymm8, %ymm6, %ymm6
; AVX512F-NEXT:    vpor %ymm3, %ymm6, %ymm3
; AVX512F-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX512F-NEXT:    vmovdqa 48(%rsi), %xmm9
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm9[4],xmm6[4],xmm9[5],xmm6[5],xmm9[6],xmm6[6],xmm9[7],xmm6[7]
; AVX512F-NEXT:    vpshufb %xmm7, %xmm10, %xmm7
...
; AVX512F-NEXT:    vmovdqa64 %zmm4, 64(%rcx)
; AVX512F-NEXT:    vzeroupper
; AVX512F-NEXT:    retq
;
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm1[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm1[2,1,1,0,4,5,6,7]
; SSE-NEXT:    pand %xmm0, %xmm4
; SSE-NEXT:    por %xmm2, %xmm4
...
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm6[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm14[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm6[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    pshufd $250, {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Folded Reload
; SSE-NEXT:    # xmm10 = mem[2,2,3,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm8 = xmm8[2,1,1,0,4,5,6,7]
; SSE-NEXT:    pand %xmm0, %xmm8
; SSE-NEXT:    pandn %xmm10, %xmm0
; SSE-NEXT:    por %xmm8, %xmm0
; SSE-NEXT:    movdqa %xmm0, 368(%rcx)
; SSE-NEXT:    movdqa %xmm1, 320(%rcx)
; SSE-NEXT:    movdqa %xmm6, 272(%rcx)
; SSE-NEXT:    movdqa %xmm5, 224(%rcx)
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm0 = xmm6[1,1,2,2]
; AVX1-ONLY-NEXT:    vmovdqa 80(%rsi), %xmm1
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm1[2],xmm0[3,4],xmm1[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa 80(%rdx), %xmm14
...
; AVX1-ONLY-NEXT:    vmovdqa 64(%rsi), %xmm15
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm15[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm1[2],xmm0[3,4],xmm1[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa 64(%rdx), %xmm9
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm11[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,4,4,4]
...
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm4[4],xmm6[4],xmm4[5],xmm6[5],xmm4[6],xmm6[6],xmm4[7],xmm6[7]
; AVX1-ONLY-NEXT:    vpshufb {{.*#+}} xmm2 = xmm2[4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vmovdqa %xmm14, %xmm3
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm14[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm14[1],xmm2[2,3],xmm14[4],xmm2[5,6],xmm14[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovdqa %xmm15, %xmm0
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm8 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX1-ONLY-NEXT:    vpshufb %xmm8, %xmm14, %xmm14
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm9[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm14 = xmm14[0,1],xmm15[2],xmm14[3,4],xmm15[5],xmm14[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm3 = xmm14[0,1],xmm15[2],xmm14[3,4],xmm15[5],xmm14[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm2 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm14, %xmm14
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm9 = xmm9[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm14[0],xmm9[1],xmm14[2,3],xmm9[4],xmm14[5,6],xmm9[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm12[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm3 = xmm9[0,1],xmm14[2],xmm9[3,4],xmm14[5],xmm9[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm3[4],xmm15[4],xmm3[5],xmm15[5],xmm3[6],xmm15[6],xmm3[7],xmm15[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm9, %xmm9
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm7[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm4 = xmm9[0],xmm14[1],xmm9[2,3],xmm14[4],xmm9[5,6],xmm14[7]
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm12 = xmm9[0],xmm12[1],xmm9[2,3],xmm12[4],xmm9[5,6],xmm12[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm15[0],xmm3[0],xmm15[1],xmm3[1],xmm15[2],xmm3[2],xmm15[3],xmm3[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm8, %xmm9, %xmm9
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm9 = xmm9[0,1],xmm7[2],xmm9[3,4],xmm7[5],xmm9[6,7]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm13[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0,1],xmm15[2],xmm7[3,4],xmm15[5],xmm7[6,7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm11[4],xmm5[4],xmm11[5],xmm5[5],xmm11[6],xmm5[6],xmm11[7],xmm5[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm15, %xmm15
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm10[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm14 = xmm15[0],xmm14[1],xmm15[2,3],xmm14[4],xmm15[5,6],xmm14[7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm15, %xmm15
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm13 = xmm15[0],xmm13[1],xmm15[2,3],xmm13[4],xmm15[5,6],xmm13[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm5[0],xmm11[0],xmm5[1],xmm11[1],xmm5[2],xmm11[2],xmm5[3],xmm11[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm8, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm10[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm4 = xmm5[0,1],xmm4[2],xmm5[3,4],xmm4[5],xmm5[6,7]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovdqa (%rsp), %xmm10 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm0[4],xmm10[4],xmm0[5],xmm10[5],xmm0[6],xmm10[6],xmm0[7],xmm10[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm5, %xmm5
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm11 = xmm1[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm5 = xmm5[0],xmm11[1],xmm5[2,3],xmm11[4],xmm5[5,6],xmm11[7]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm8 = xmm1[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm8[2],xmm0[3,4],xmm8[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm3[4],xmm6[4],xmm3[5],xmm6[5],xmm3[6],xmm6[6],xmm3[7],xmm6[7]
; AVX1-ONLY-NEXT:    vpshufb {{.*#+}} xmm1 = xmm3[4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm2[1],xmm1[2,3],xmm2[4],xmm1[5,6],xmm2[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, 32(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, 48(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm11, (%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, 80(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm4, 288(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm13, 368(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm14, 320(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, 336(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm9, 96(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm12, 176(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm5[4],xmm2[4],xmm5[5],xmm2[5],xmm5[6],xmm2[6],xmm5[7],xmm2[7]
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} xmm7 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX2-SLOW-NEXT:    vpshufb %xmm7, %xmm6, %xmm6
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,4,4,4,4]
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm9, %ymm5, %ymm6, %ymm2
; AVX2-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm9, %ymm6, %ymm10, %ymm2
; AVX2-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-SLOW-NEXT:    vpermd %ymm4, %ymm8, %ymm8
...
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm10[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm10[2],xmm2[3,4],xmm10[5],xmm2[6,7]
...
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm10, %ymm2
; AVX2-SLOW-NEXT:    vpermd %ymm0, %ymm12, %ymm10
; AVX2-SLOW-NEXT:    vpblendvb %ymm13, %ymm2, %ymm10, %ymm10
; AVX2-SLOW-NEXT:    vmovdqa 96(%rsi), %xmm2
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm2[3,3,3,3,4,5,6,7]
...
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm15[0],xmm2[0],xmm15[1],xmm2[1],xmm15[2],xmm2[2],xmm15[3],xmm2[3]
...
; AVX2-SLOW-NEXT:    vpshufb %ymm2, %ymm15, %ymm15
...
; AVX2-SLOW-NEXT:    vmovdqa %ymm4, 32(%rcx)
...
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm1, %xmm4
; AVX2-FAST-NEXT:    vmovdqa (%rdi), %xmm5
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm7 = xmm5[1,1,2,2]
...
; AVX2-FAST-NEXT:    vpermd %ymm3, %ymm13, %ymm4
...
; AVX2-FAST-NEXT:    vmovdqa 80(%rsi), %xmm5
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm1 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
...
; AVX2-FAST-NEXT:    vpermd %ymm15, %ymm13, %ymm4
; AVX2-FAST-NEXT:    vpblendvb %ymm14, %ymm0, %ymm4, %ymm12
; AVX2-FAST-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX2-FAST-NEXT:    vmovdqa 112(%rsi), %xmm4
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
...
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm4, %ymm13
; AVX2-FAST-NEXT:    vmovdqa 16(%rsi), %xmm0
; AVX2-FAST-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm0[4],xmm4[4],xmm0[5],xmm4[5],xmm0[6],xmm4[6],xmm0[7],xmm4[7]
...
; AVX2-FAST-NEXT:    vpermd %ymm3, %ymm10, %ymm1
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm1, %ymm6
...
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = <u,3,3,u,4,4,u,5>
; AVX2-FAST-NEXT:    vpermd (%rdi), %ymm4, %ymm5
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm10 = <255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255>
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm1, %ymm5, %ymm1
; AVX2-FAST-NEXT:    vmovdqa 64(%rsi), %ymm5
; AVX2-FAST-NEXT:    vpshufb %ymm0, %ymm5, %ymm5
; AVX2-FAST-NEXT:    vpermd 64(%rdi), %ymm4, %ymm11
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm5, %ymm11, %ymm5
; AVX2-FAST-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX2-FAST-NEXT:    vpshufb %ymm0, %ymm11, %ymm11
; AVX2-FAST-NEXT:    vpermd 32(%rdi), %ymm4, %ymm14
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm11, %ymm14, %ymm11
...
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm5, %ymm2, %ymm2
; AVX2-FAST-NEXT:    vpermd %ymm9, %ymm4, %ymm3
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm11, %ymm3, %ymm3
...
; AVX2-FAST-NEXT:    vmovdqa %ymm6, 64(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm13, 352(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm8, 96(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm7, 160(%rcx)
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rsi), %xmm1
; AVX2-FAST-PERLANE-NEXT:    vpbroadcastd {{.*#+}} xmm6 = [6,7,8,9,6,7,8,9,6,7,8,9,6,7,8,9]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm13, %ymm4
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm1, %ymm4, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 80(%rdi), %xmm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 80(%rsi), %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} xmm1 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm4, %ymm5, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm15 = xmm8[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm7 = xmm15[0,1],xmm7[2],xmm15[3,4],xmm7[5],xmm15[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm8[0],xmm5[0],xmm8[1],xmm5[1],xmm8[2],xmm5[2],xmm8[3],xmm5[3]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm12, %xmm5, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm2, %ymm13, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm5, %ymm7, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rdi), %xmm7
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm8, %xmm8
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0,1],xmm8[2],xmm7[3,4],xmm8[5],xmm7[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm8[0],xmm15[1],xmm8[1],xmm15[2],xmm8[2],xmm15[3],xmm8[3]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm12, %xmm4, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm0, %ymm4, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm9, %ymm13, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm0, %ymm4, %ymm8
...
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm5 = xmm15[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm4 = xmm5[0,1],xmm4[2],xmm5[3,4],xmm4[5],xmm5[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm13, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm0, %ymm4, %ymm12
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 112(%rsi), %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm1, %xmm5, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm4, %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm10, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm4, %ymm13
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 16(%rsi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm0[4],xmm4[4],xmm0[5],xmm4[5],xmm0[6],xmm4[6],xmm0[7],xmm4[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm10, %ymm1
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm1, %ymm6
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm4 = <u,3,3,u,4,4,u,5>
; AVX2-FAST-PERLANE-NEXT:    vpermd (%rdi), %ymm4, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm10 = <255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255>
...
; AVX2-FAST-PERLANE-NEXT:    vpermd 64(%rdi), %ymm4, %ymm11
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm5, %ymm11, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm0, %ymm11, %ymm11
; AVX2-FAST-PERLANE-NEXT:    vpermd 32(%rdi), %ymm4, %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm11, %ymm14, %ymm11
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm4 = <2,u,3,3,u,4,4,u>
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm3, %ymm4, %ymm3
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm5, %ymm2, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm9, %ymm4, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm11, %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm4, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm0, %ymm4, %ymm0
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm6, 64(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm13, 352(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm8, 96(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm7, 160(%rcx)
...
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vmovdqa (%rdi), %ymm0
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm1 = [128,128,128,128,12,13,128,128,128,128,14,15,128,128,128,128,16,17,128,128,128,128,18,19,128,128,128,128,20,21,128,128]
; AVX512F-NEXT:    vpshufb %ymm1, %ymm0, %ymm0
; AVX512F-NEXT:    vmovdqa %ymm1, %ymm6
; AVX512F-NEXT:    vmovdqa (%rsi), %ymm1
...
; AVX512F-NEXT:    vprold $16, %xmm5, %xmm8
; AVX512F-NEXT:    vmovdqa (%rdi), %xmm9
; AVX512F-NEXT:    vmovdqa64 16(%rdi), %xmm24
; AVX512F-NEXT:    vmovdqa64 32(%rdi), %xmm27
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm10 = xmm9[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm8 = xmm10[0,1],xmm8[2],xmm10[3,4],xmm8[5],xmm10[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm9[0],xmm5[0],xmm9[1],xmm5[1],xmm9[2],xmm5[2],xmm9[3],xmm5[3]
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm4 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX512F-NEXT:    vpshufb %xmm4, %xmm9, %xmm9
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} ymm18 = <u,0,0,u,1,1,u,2>
; AVX512F-NEXT:    vpermd %ymm3, %ymm18, %ymm3
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} ymm16 = [65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
; AVX512F-NEXT:    vpandnq %ymm3, %ymm16, %ymm3
; AVX512F-NEXT:    vinserti64x4 $1, %ymm11, %zmm3, %zmm3
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm17 = [65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535]
; AVX512F-NEXT:    vpternlogq $248, %zmm17, %zmm10, %zmm3
; AVX512F-NEXT:    vmovdqa 96(%rsi), %xmm10
; AVX512F-NEXT:    vprold $16, %xmm10, %xmm11
; AVX512F-NEXT:    vmovdqa 96(%rdi), %xmm12
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm13 = xmm12[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm11 = xmm13[0,1],xmm11[2],xmm13[3,4],xmm11[5],xmm13[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm12[0],xmm10[0],xmm12[1],xmm10[1],xmm12[2],xmm10[2],xmm12[3],xmm10[3]
; AVX512F-NEXT:    vpshufb %xmm4, %xmm10, %xmm10
...
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm11 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm15, %xmm15
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm19 = <5,5,u,6,6,u,7,7,u,8,8,u,9,9,u,10>
; AVX512F-NEXT:    vpermd 64(%rdx), %zmm19, %zmm10
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm20 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
; AVX512F-NEXT:    vpternlogq $184, %zmm15, %zmm20, %zmm10
; AVX512F-NEXT:    vmovdqa 96(%rdi), %ymm15
; AVX512F-NEXT:    vmovdqa %ymm6, %ymm1
; AVX512F-NEXT:    vpshufb %ymm6, %ymm15, %ymm15
; AVX512F-NEXT:    vmovdqa 96(%rsi), %ymm12
; AVX512F-NEXT:    vpshufb %ymm2, %ymm12, %ymm12
; AVX512F-NEXT:    vpor %ymm15, %ymm12, %ymm12
; AVX512F-NEXT:    vmovdqa 112(%rdi), %xmm15
; AVX512F-NEXT:    vmovdqa 112(%rsi), %xmm13
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm13[4],xmm15[4],xmm13[5],xmm15[5],xmm13[6],xmm15[6],xmm13[7],xmm15[7]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm5, %xmm5
; AVX512F-NEXT:    vprold $16, %xmm13, %xmm13
...
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} ymm22 = <5,5,u,6,6,u,7,7>
; AVX512F-NEXT:    vpermd %ymm12, %ymm22, %ymm15
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} ymm21 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0]
; AVX512F-NEXT:    vpandnq %ymm15, %ymm21, %ymm15
; AVX512F-NEXT:    vpshufb %ymm9, %ymm12, %ymm12
; AVX512F-NEXT:    vinserti64x4 $1, %ymm15, %zmm12, %zmm12
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0]
; AVX512F-NEXT:    vpternlogq $248, %zmm15, %zmm5, %zmm12
; AVX512F-NEXT:    vmovdqa 64(%rdi), %ymm5
; AVX512F-NEXT:    vpshufb %ymm6, %ymm5, %ymm5
; AVX512F-NEXT:    vmovdqa 64(%rsi), %ymm6
; AVX512F-NEXT:    vpshufb %ymm2, %ymm6, %ymm6
; AVX512F-NEXT:    vpor %ymm5, %ymm6, %ymm5
; AVX512F-NEXT:    vinserti64x4 $1, %ymm5, %zmm0, %zmm5
; AVX512F-NEXT:    vmovdqa 64(%rsi), %xmm6
; AVX512F-NEXT:    vprold $16, %xmm6, %xmm0
; AVX512F-NEXT:    vmovdqa 64(%rdi), %xmm13
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm7 = xmm13[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm0 = xmm7[0,1],xmm0[2],xmm7[3,4],xmm0[5],xmm7[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm13[0],xmm6[0],xmm13[1],xmm6[1],xmm13[2],xmm6[2],xmm13[3],xmm6[3]
; AVX512F-NEXT:    vpshufb %xmm4, %xmm6, %xmm6
; AVX512F-NEXT:    vinserti128 $1, %xmm0, %ymm6, %ymm0
; AVX512F-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm5[4,5,6,7]
; AVX512F-NEXT:    vpshufb %ymm9, %ymm14, %ymm5
; AVX512F-NEXT:    vpermd %ymm14, %ymm18, %ymm6
; AVX512F-NEXT:    vpandnq %ymm6, %ymm16, %ymm6
; AVX512F-NEXT:    vinserti64x4 $1, %ymm5, %zmm6, %zmm5
; AVX512F-NEXT:    vpternlogq $248, %zmm17, %zmm0, %zmm5
...
; AVX512F-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX512F-NEXT:    vmovdqa 48(%rsi), %xmm7
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm7[4],xmm6[4],xmm7[5],xmm6[5],xmm7[6],xmm6[6],xmm7[7],xmm6[7]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm13, %xmm13
; AVX512F-NEXT:    vprold $16, %xmm7, %xmm7
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm6 = xmm6[0,1],xmm7[2],xmm6[3,4],xmm7[5],xmm6[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm13, %ymm6, %ymm6
; AVX512F-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm6
; AVX512F-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm6[4,5,6,7]
; AVX512F-NEXT:    vpermd %ymm8, %ymm22, %ymm6
; AVX512F-NEXT:    vpandnq %ymm6, %ymm21, %ymm6
; AVX512F-NEXT:    vpshufb %ymm9, %ymm8, %ymm7
; AVX512F-NEXT:    vinserti64x4 $1, %ymm6, %zmm7, %zmm6
; AVX512F-NEXT:    vpternlogq $248, %zmm15, %zmm0, %zmm6
; AVX512F-NEXT:    vmovdqa64 %xmm25, %xmm1
; AVX512F-NEXT:    vprold $16, %xmm25, %xmm0
; AVX512F-NEXT:    vmovdqa64 %xmm27, %xmm2
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm7 = xmm27[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm0 = xmm7[0,1],xmm0[2],xmm7[3,4],xmm0[5],xmm7[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
...
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm2 = xmm4[4],xmm1[4],xmm4[5],xmm1[5],xmm4[6],xmm1[6],xmm4[7],xmm1[7]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm2, %xmm2
; AVX512F-NEXT:    vprold $16, %xmm23, %xmm4
...
; AVX512F-NEXT:    vpermd (%rdx), %zmm19, %zmm1
; AVX512F-NEXT:    vpternlogq $184, %zmm0, %zmm20, %zmm1
; AVX512F-NEXT:    vmovdqa64 %zmm1, 64(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm6, 128(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm5, 192(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm12, 320(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm10, 256(%rcx)
