...
; AVX1-ONLY-NEXT:    vpshufb {{.*#+}} xmm2 = xmm2[10,11,4,5,8,9,14,15,u,u,u,u,u,u,u,u]
...
; AVX1-ONLY-NEXT:    retq
;
; AVX2-SLOW-LABEL: store_i16_stride3_vf4:
; AVX2-SLOW:       # %bb.0:
...
; AVX2-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,0,2]
; AVX2-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,u,u,2,3,10,11,u,u,4,5,12,13,u,u,22,23,30,31,u,u,u,u,u,u,u,u,u,u]
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm2 = <255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,u,u,u,u,u,u,u,u>
; AVX2-SLOW-NEXT:    vpblendvb %ymm2, %ymm0, %ymm1, %ymm0
; AVX2-SLOW-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX2-SLOW-NEXT:    vmovq %xmm1, 16(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %xmm0, (%rcx)
; AVX2-SLOW-NEXT:    vzeroupper
; AVX2-SLOW-NEXT:    retq
;
; AVX2-FAST-LABEL: store_i16_stride3_vf4:
; AVX2-FAST:       # %bb.0:
; AVX2-FAST-NEXT:    vmovq {{.*#+}} xmm0 = mem[0],zero
; AVX2-FAST-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
; AVX2-FAST-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = <0,0,0,0,1,1,u,u>
; AVX2-FAST-NEXT:    vpermd %ymm1, %ymm2, %ymm1
; AVX2-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,0,2]
; AVX2-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,u,u,2,3,10,11,u,u,4,5,12,13,u,u,22,23,30,31,u,u,u,u,u,u,u,u,u,u]
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = <255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,u,u,u,u,u,u,u,u>
; AVX2-FAST-NEXT:    vpblendvb %ymm2, %ymm0, %ymm1, %ymm0
; AVX2-FAST-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX2-FAST-NEXT:    vmovq %xmm1, 16(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %xmm0, (%rcx)
; AVX2-FAST-NEXT:    vzeroupper
; AVX2-FAST-NEXT:    retq
;
; AVX2-FAST-PERLANE-LABEL: store_i16_stride3_vf4:
...
; AVX2-FAST-PERLANE-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,0,2]
; AVX2-FAST-PERLANE-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9,u,u,2,3,10,11,u,u,4,5,12,13,u,u,22,23,30,31,u,u,u,u,u,u,u,u,u,u]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm2 = <255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,u,u,u,u,u,u,u,u>
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm2, %ymm0, %ymm1, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX2-FAST-PERLANE-NEXT:    vmovq %xmm1, 16(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %xmm0, (%rcx)
; AVX2-FAST-PERLANE-NEXT:    vzeroupper
; AVX2-FAST-PERLANE-NEXT:    retq
;
; AVX512F-SLOW-LABEL: store_i16_stride3_vf4:
; AVX512F-SLOW:       # %bb.0:
...
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,0,1,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,0,2]
; AVX512F-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9],zero,zero,ymm0[2,3,10,11],zero,zero,ymm0[4,5,12,13],zero,zero,ymm0[22,23,30,31],zero,zero,ymm0[u,u,u,u,u,u,u,u]
; AVX512F-SLOW-NEXT:    vpternlogq $244, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm0
; AVX512F-SLOW-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512F-SLOW-NEXT:    vmovq %xmm1, 16(%rcx)
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, (%rcx)
; AVX512F-SLOW-NEXT:    vzeroupper
; AVX512F-SLOW-NEXT:    retq
;
; AVX512F-FAST-LABEL: store_i16_stride3_vf4:
; AVX512F-FAST:       # %bb.0:
...
; AVX512F-FAST-NEXT:    vmovq {{.*#+}} xmm1 = mem[0],zero
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = <u,0,0,u,1,1,u,u>
; AVX512F-FAST-NEXT:    vpermd %ymm1, %ymm2, %ymm1
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,0,2]
; AVX512F-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,8,9],zero,zero,ymm0[2,3,10,11],zero,zero,ymm0[4,5,12,13],zero,zero,ymm0[22,23,30,31],zero,zero,ymm0[u,u,u,u,u,u,u,u]
; AVX512F-FAST-NEXT:    vpternlogq $244, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm0
; AVX512F-FAST-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512F-FAST-NEXT:    vmovq %xmm1, 16(%rcx)
...
; AVX512BW-NEXT:    vmovdqa {{.*#+}} ymm1 = <0,8,16,1,9,17,2,10,18,3,11,19,u,u,u,u>
...
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, (%rdx), %zmm0, %zmm3
...
; AVX512F-SLOW-NEXT:    vextracti64x4 $1, %zmm3, %ymm1
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm3 = xmm1[2,2,3,3]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm3[1],xmm0[2,3],xmm3[4],xmm0[5,6],xmm3[7]
; AVX512F-SLOW-NEXT:    vpshufb {{.*#+}} ymm3 = ymm2[0,1,u,u,u,u,2,3,u,u,u,u,4,5,u,u,u,u,u,u,22,23,u,u,u,u,24,25,u,u,u,u]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[2,3,0,1]
; AVX512F-SLOW-NEXT:    vpshufb {{.*#+}} ymm2 = ymm2[u,u,0,1,u,u,u,u,2,3,u,u,u,u,4,5,u,u,22,23,u,u,u,u,24,25,u,u,u,u,26,27]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0],ymm2[1],ymm3[2,3],ymm2[4],ymm3[5,6],ymm2[7],ymm3[8],ymm2[9],ymm3[10,11],ymm2[12],ymm3[13,14],ymm2[15]
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm3 = <u,0,0,u,1,1,u,2>
; AVX512F-SLOW-NEXT:    vpermd %ymm1, %ymm3, %ymm1
; AVX512F-SLOW-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm2, %ymm1
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm0, %zmm1, %zmm1
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, 32(%rcx)
...
; AVX512F-FAST-NEXT:    vinserti32x4 $2, (%rdx), %zmm0, %zmm0
; AVX512F-FAST-NEXT:    vextracti128 $1, %ymm0, %xmm1
; AVX512F-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm1 = xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512F-FAST-NEXT:    vpshufb {{.*#+}} xmm1 = xmm1[4,5,u,u,10,11,8,9,u,u,14,15,12,13,u,u]
...
; AVX512F-FAST-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,4,5],zero,zero,ymm0[2,3,6,7],zero,zero,ymm0[8,9,12,13],zero,zero,ymm0[18,19,22,23],zero,zero,ymm0[24,25,28,29],zero,zero,ymm0[26,27]
; AVX512F-FAST-NEXT:    vpternlogq $244, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm2, %ymm0
; AVX512F-FAST-NEXT:    vinserti32x4 $2, %xmm1, %zmm0, %zmm0
; AVX512F-FAST-NEXT:    vmovdqa %xmm1, 32(%rcx)
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm5[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm2 = xmm7[0],xmm2[1,2],xmm7[3],xmm2[4,5],xmm7[6],xmm2[7]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm1[1,1,2,2]
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm9 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX1-ONLY-NEXT:    vpshufb %xmm9, %xmm8, %xmm8
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm10 = xmm5[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm8 = xmm8[0,1],xmm10[2],xmm8[3,4],xmm10[5],xmm8[6,7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm4[4],xmm1[4],xmm4[5],xmm1[5],xmm4[6],xmm1[6],xmm4[7],xmm1[7]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm11 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vpshufb %xmm11, %xmm10, %xmm10
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm12 = xmm6[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0],xmm12[1],xmm10[2,3],xmm12[4],xmm10[5,6],xmm12[7]
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm10, 80(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm8, (%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, 64(%rcx)
...
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm4 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} xmm4 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm4[2],xmm0[3,4],xmm4[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa (%rdx), %xmm14
; AVX1-ONLY-NEXT:    vmovdqa 16(%rdx), %xmm13
; AVX1-ONLY-NEXT:    vmovdqa 32(%rdx), %xmm6
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm14[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm4[0],xmm0[1,2],xmm4[3],xmm0[4,5],xmm4[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm0 = xmm8[1,1,2,2]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm10[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm4[2],xmm0[3,4],xmm4[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm13[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm4[0],xmm0[1,2],xmm4[3],xmm0[4,5],xmm4[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm7[2],xmm0[3,4],xmm7[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm6[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm7[0],xmm0[1,2],xmm7[3],xmm0[4,5],xmm7[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm0 = xmm1[1,1,2,2]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm3[3,3,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm11 = xmm0[0,1],xmm11[2],xmm0[3,4],xmm11[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa 48(%rdx), %xmm0
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm0[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm11 = xmm15[0],xmm11[1,2],xmm15[3],xmm11[4,5],xmm15[6],xmm11[7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm9[0],xmm12[0],xmm9[1],xmm12[1],xmm9[2],xmm12[2],xmm9[3],xmm12[3]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm1 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm15, %xmm15
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm14[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm15 = xmm15[0,1],xmm4[2],xmm15[3,4],xmm4[5],xmm15[6,7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm8[0],xmm10[0],xmm8[1],xmm10[1],xmm8[2],xmm10[2],xmm8[3],xmm10[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm4, %xmm4
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm13[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm4 = xmm4[0,1],xmm7[2],xmm4[3,4],xmm7[5],xmm4[6,7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm12[4],xmm9[4],xmm12[5],xmm9[5],xmm12[6],xmm9[6],xmm12[7],xmm9[7]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm9 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vpshufb %xmm9, %xmm7, %xmm7
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm12 = xmm14[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0],xmm12[1],xmm7[2,3],xmm12[4],xmm7[5,6],xmm12[7]
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm2[0],xmm5[0],xmm2[1],xmm5[1],xmm2[2],xmm5[2],xmm2[3],xmm5[3]
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm13[0],xmm3[0],xmm13[1],xmm3[1],xmm13[2],xmm3[2],xmm13[3],xmm3[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm12, %xmm1
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm12 = xmm0[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1],xmm12[2],xmm1[3,4],xmm12[5],xmm1[6,7]
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm5[1],xmm2[2,3],xmm5[4],xmm2[5,6],xmm5[7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm3[4],xmm13[4],xmm3[5],xmm13[5],xmm3[6],xmm13[6],xmm3[7],xmm13[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm9, %xmm3, %xmm3
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm3[0],xmm0[1],xmm3[2,3],xmm0[4],xmm3[5,6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, 176(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm2, 128(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, 144(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm10, 96(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm8, 80(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, 32(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm4, 48(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm15, (%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm11, 160(%rcx)
...
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm10 = xmm7[4],xmm4[4],xmm7[5],xmm4[5],xmm7[6],xmm4[6],xmm7[7],xmm4[7]
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} xmm11 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
...
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm7 = <5,5,u,6,6,u,7,7>
; AVX2-SLOW-NEXT:    vpermd %ymm2, %ymm7, %ymm10
...
; AVX2-SLOW-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm13[4],xmm10[4],xmm13[5],xmm10[5],xmm13[6],xmm10[6],xmm13[7],xmm10[7]
; AVX2-SLOW-NEXT:    vpshufb %xmm11, %xmm14, %xmm11
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm13[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm13[2],xmm10[3,4],xmm13[5],xmm10[6,7]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm10
; AVX2-SLOW-NEXT:    vpermd %ymm1, %ymm7, %ymm7
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm10, %ymm7, %ymm7
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm10 = xmm8[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm9[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm11[2],xmm10[3,4],xmm11[5],xmm10[6,7]
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3]
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} xmm9 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX2-SLOW-NEXT:    vpshufb %xmm9, %xmm8, %xmm8
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm10, %ymm8, %ymm8
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm10 = <u,0,0,u,1,1,u,2>
; AVX2-SLOW-NEXT:    vpermd %ymm2, %ymm10, %ymm11
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm12 = [255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255]
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm8, %ymm11, %ymm8
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm11 = xmm5[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm6[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,4,4,4,4]
...
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm11, %ymm5, %ymm5
; AVX2-SLOW-NEXT:    vpermd %ymm1, %ymm10, %ymm6
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm5, %ymm6, %ymm5
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm6 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm11, %ymm3, %ymm10, %ymm3
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm3, %ymm2, %ymm2
; AVX2-SLOW-NEXT:    vpshufb %ymm6, %ymm0, %ymm0
; AVX2-SLOW-NEXT:    vpermd 32(%rdi), %ymm9, %ymm3
...
; AVX2-SLOW-NEXT:    vmovdqa %ymm5, 96(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm8, (%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm7, 160(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm4, 64(%rcx)
; AVX2-SLOW-NEXT:    vzeroupper
; AVX2-SLOW-NEXT:    retq
;
...
; AVX2-FAST-NEXT:    vmovdqa (%rdx), %ymm0
; AVX2-FAST-NEXT:    vmovdqa (%rsi), %xmm1
; AVX2-FAST-NEXT:    vmovdqa 16(%rsi), %xmm2
; AVX2-FAST-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm3 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm1, %xmm5
; AVX2-FAST-NEXT:    vmovdqa (%rdi), %xmm6
; AVX2-FAST-NEXT:    vmovdqa 16(%rdi), %xmm7
; AVX2-FAST-NEXT:    vmovdqa 32(%rdi), %xmm8
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm9 = xmm6[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm5 = xmm9[0,1],xmm5[2],xmm9[3,4],xmm5[5],xmm9[6,7]
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm6[0],xmm1[0],xmm6[1],xmm1[1],xmm6[2],xmm1[2],xmm6[3],xmm1[3]
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm6 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm9 = <u,0,0,u,1,1,u,2>
; AVX2-FAST-NEXT:    vpermd %ymm0, %ymm9, %ymm5
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm10 = [255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255]
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm1, %ymm5, %ymm1
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm2[4],xmm7[4],xmm2[5],xmm7[5],xmm2[6],xmm7[6],xmm2[7],xmm7[7]
...
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm2 = xmm7[0,1],xmm2[2],xmm7[3,4],xmm2[5],xmm7[6,7]
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm5, %ymm2, %ymm2
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm7 = <5,5,u,6,6,u,7,7>
...
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm13 = xmm8[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm13 = xmm13[0,1],xmm5[2],xmm13[3,4],xmm5[5],xmm13[6,7]
...
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm13, %ymm4, %ymm4
; AVX2-FAST-NEXT:    vpermd %ymm5, %ymm9, %ymm6
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm4, %ymm6, %ymm4
; AVX2-FAST-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX2-FAST-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX2-FAST-NEXT:    vpshufb %xmm11, %xmm9, %xmm9
; AVX2-FAST-NEXT:    vpshufb %xmm3, %xmm8, %xmm3
; AVX2-FAST-NEXT:    vmovdqa (%rsi), %ymm8
...
; AVX2-FAST-NEXT:    vpblendvb %ymm12, %ymm3, %ymm6, %ymm3
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm6 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
...
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm7, %ymm9, %ymm7
; AVX2-FAST-NEXT:    vmovdqa 32(%rsi), %ymm9
; AVX2-FAST-NEXT:    vpshufb %ymm6, %ymm9, %ymm6
; AVX2-FAST-NEXT:    vpermd 32(%rdi), %ymm8, %ymm8
; AVX2-FAST-NEXT:    vpblendvb %ymm10, %ymm6, %ymm8, %ymm6
...
; AVX2-FAST-NEXT:    vpblendvb %ymm9, %ymm7, %ymm0, %ymm0
; AVX2-FAST-NEXT:    vpermd %ymm5, %ymm8, %ymm5
; AVX2-FAST-NEXT:    vpblendvb %ymm9, %ymm6, %ymm5, %ymm5
; AVX2-FAST-NEXT:    vmovdqa %ymm5, 128(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm0, 32(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm3, 160(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm4, 96(%rcx)
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rdx), %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rsi), %xmm1
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 16(%rsi), %xmm2
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} xmm3 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm1, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa (%rdi), %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 16(%rdi), %xmm7
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rdi), %xmm8
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm9 = xmm6[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm5 = xmm9[0,1],xmm5[2],xmm9[3,4],xmm5[5],xmm9[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm9 = <u,0,0,u,1,1,u,2>
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm0, %ymm9, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm10 = [255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255]
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm1, %ymm5, %ymm1
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm2[4],xmm7[4],xmm2[5],xmm7[5],xmm2[6],xmm7[6],xmm2[7],xmm7[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm2 = xmm7[0,1],xmm2[2],xmm7[3,4],xmm2[5],xmm7[6,7]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm5, %ymm2, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm7 = <5,5,u,6,6,u,7,7>
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm0, %ymm7, %ymm5
...
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm3, %xmm4, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm13 = xmm8[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm13 = xmm13[0,1],xmm5[2],xmm13[3,4],xmm5[5],xmm13[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm13, %ymm4, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm5, %ymm9, %ymm6
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm4, %ymm6, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm9 = xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm3 = xmm6[0,1],xmm3[2],xmm6[3,4],xmm3[5],xmm6[6,7]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm9, %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm5, %ymm7, %ymm6
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm12, %ymm3, %ymm6, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm6 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm6, %ymm8, %ymm7
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm7, %ymm9, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rsi), %ymm9
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm6, %ymm9, %ymm6
; AVX2-FAST-PERLANE-NEXT:    vpermd 32(%rdi), %ymm8, %ymm8
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm10, %ymm6, %ymm8, %ymm6
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm5, %ymm8, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm9, %ymm6, %ymm5, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm5, 128(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, 32(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm3, 160(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm4, 96(%rcx)
...
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vmovdqa (%rdi), %ymm1
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm0 = [128,128,128,128,12,13,128,128,128,128,14,15,128,128,128,128,16,17,128,128,128,128,18,19,128,128,128,128,20,21,128,128]
; AVX512F-NEXT:    vpshufb %ymm0, %ymm1, %ymm2
; AVX512F-NEXT:    vmovdqa (%rsi), %ymm3
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm1 = [10,11,0,1,128,128,12,13,2,3,128,128,14,15,4,5,128,128,16,17,28,29,128,128,18,19,18,19,128,128,20,21]
; AVX512F-NEXT:    vpshufb %ymm1, %ymm3, %ymm3
; AVX512F-NEXT:    vpor %ymm2, %ymm3, %ymm2
; AVX512F-NEXT:    vmovdqa (%rsi), %xmm3
; AVX512F-NEXT:    vmovdqa 16(%rsi), %xmm4
; AVX512F-NEXT:    vmovdqa 32(%rsi), %xmm6
; AVX512F-NEXT:    vprold $16, %xmm3, %xmm7
; AVX512F-NEXT:    vmovdqa (%rdi), %xmm8
; AVX512F-NEXT:    vmovdqa 16(%rdi), %xmm5
; AVX512F-NEXT:    vmovdqa 32(%rdi), %xmm9
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm10 = xmm8[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm7 = xmm10[0,1],xmm7[2],xmm10[3,4],xmm7[5],xmm10[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm8[0],xmm3[0],xmm8[1],xmm3[1],xmm8[2],xmm3[2],xmm8[3],xmm3[3]
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm8 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX512F-NEXT:    vpshufb %xmm8, %xmm3, %xmm3
; AVX512F-NEXT:    vinserti128 $1, %xmm7, %ymm3, %ymm3
; AVX512F-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm7
; AVX512F-NEXT:    vmovdqa (%rdx), %ymm10
; AVX512F-NEXT:    vmovdqa 32(%rdx), %ymm2
...
; AVX512F-NEXT:    vpshufb %ymm3, %ymm10, %ymm11
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm12 = <u,0,0,u,1,1,u,2>
; AVX512F-NEXT:    vpermd %ymm10, %ymm12, %ymm10
; AVX512F-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm10, %ymm10
; AVX512F-NEXT:    vinserti64x4 $1, %ymm11, %zmm10, %zmm10
; AVX512F-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm7, %zmm10
; AVX512F-NEXT:    vprold $16, %xmm6, %xmm7
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm11 = xmm9[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm7 = xmm11[0,1],xmm7[2],xmm11[3,4],xmm7[5],xmm11[6,7]
...
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm8 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX512F-NEXT:    vpshufb %xmm8, %xmm7, %xmm7
; AVX512F-NEXT:    vprold $16, %xmm4, %xmm4
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm4 = xmm5[0,1],xmm4[2],xmm5[3,4],xmm4[5],xmm5[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm7, %ymm4, %ymm4
; AVX512F-NEXT:    vinserti64x4 $1, %ymm6, %zmm4, %zmm4
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm5 = <5,5,u,6,6,u,7,7,u,8,8,u,9,9,u,10>
; AVX512F-NEXT:    vpermd (%rdx), %zmm5, %zmm5
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
; AVX512F-NEXT:    vpternlogd $184, %zmm4, %zmm6, %zmm5
...
; AVX512F-NEXT:    vmovdqa 48(%rsi), %xmm4
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm7 = xmm4[4],xmm1[4],xmm4[5],xmm1[5],xmm4[6],xmm1[6],xmm4[7],xmm1[7]
; AVX512F-NEXT:    vpshufb %xmm8, %xmm7, %xmm7
; AVX512F-NEXT:    vprold $16, %xmm4, %xmm4
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1],xmm4[2],xmm1[3,4],xmm4[5],xmm1[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm7, %ymm1, %ymm1
; AVX512F-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm1 = <5,5,u,6,6,u,7,7>
; AVX512F-NEXT:    vpermd %ymm2, %ymm1, %ymm1
...
; AVX512F-NEXT:    vmovdqa64 %zmm1, 128(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm5, 64(%rcx)
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm15[3,3,3,3,4,5,6,7]
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3],xmm0[4,5],xmm1[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm0 = xmm3[1,1,2,2]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,4,4,4]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm1[2],xmm0[3,4],xmm1[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa 48(%rdx), %xmm11
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm1 = xmm11[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3],xmm0[4,5],xmm1[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa 64(%rsi), %xmm0
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0,1],xmm0[2],xmm1[3,4],xmm0[5],xmm1[6,7]
; AVX1-ONLY-NEXT:    vmovdqa 96(%rdx), %xmm1
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0],xmm0[1,2],xmm1[3],xmm0[4,5],xmm1[6],xmm0[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm7 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm0, %xmm0
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm14[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm15[2],xmm0[3,4],xmm15[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm0, %xmm0
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm10[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm15[2],xmm0[3,4],xmm15[5],xmm0[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
; AVX1-ONLY-NEXT:    vmovdqa {{.*#+}} xmm5 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX1-ONLY-NEXT:    vpshufb %xmm5, %xmm15, %xmm15
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm14[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm15[0],xmm14[1],xmm15[2,3],xmm14[4],xmm15[5,6],xmm14[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm14 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm14, %xmm14
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm3[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm1 = xmm14[0,1],xmm15[2],xmm14[3,4],xmm15[5],xmm14[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm14, %xmm14
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm11[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm10 = xmm14[0,1],xmm15[2],xmm14[3,4],xmm15[5],xmm14[6,7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm0[4],xmm4[4],xmm0[5],xmm4[5],xmm0[6],xmm4[6],xmm0[7],xmm4[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm5, %xmm14, %xmm14
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm3[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm14[0],xmm15[1],xmm14[2,3],xmm15[4],xmm14[5,6],xmm15[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm14[0],xmm11[1],xmm14[2,3],xmm11[4],xmm14[5,6],xmm11[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm11 = xmm13[0],xmm1[0],xmm13[1],xmm1[1],xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm11, %xmm11
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm15 = xmm12[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm11 = xmm11[0,1],xmm15[2],xmm11[3,4],xmm15[5],xmm11[6,7]
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm6[0],xmm9[0],xmm6[1],xmm9[1],xmm6[2],xmm9[2],xmm6[3],xmm9[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm15, %xmm15
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm14 = xmm8[0,0,0,0]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm14 = xmm15[0,1],xmm14[2],xmm15[3,4],xmm14[5],xmm15[6,7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm1[4],xmm13[4],xmm1[5],xmm13[5],xmm1[6],xmm13[6],xmm1[7],xmm13[7]
; AVX1-ONLY-NEXT:    vpshufb %xmm5, %xmm13, %xmm13
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm12 = xmm12[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm12 = xmm13[0],xmm12[1],xmm13[2,3],xmm12[4],xmm13[5,6],xmm12[7]
; AVX1-ONLY-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm9[4],xmm6[4],xmm9[5],xmm6[5],xmm9[6],xmm6[6],xmm9[7],xmm6[7]
...
; AVX1-ONLY-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm8[0],xmm0[0],xmm8[1],xmm0[1],xmm8[2],xmm0[2],xmm8[3],xmm0[3]
; AVX1-ONLY-NEXT:    vpshufb %xmm7, %xmm6, %xmm6
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm9 = xmm2[0,0,0,0]
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm9 = xmm10[0,0,0,0]
...
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm7 = xmm8[0],xmm7[1],xmm8[2,3],xmm7[4],xmm8[5,6],xmm7[7]
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm2 = xmm10[2,2,3,3]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm2[1],xmm0[2,3],xmm2[4],xmm0[5,6],xmm2[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, 368(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm7, 320(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, 336(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm6, 288(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm5, 272(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm12, 224(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm14, 240(%rcx)
; AVX1-ONLY-NEXT:    vmovdqa %xmm11, 192(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 96(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 80(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 32(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %xmm0, 48(%rcx)
; AVX1-ONLY-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm11 = <5,5,u,6,6,u,7,7>
; AVX2-SLOW-NEXT:    vpermd %ymm3, %ymm11, %ymm5
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0,255,255,255,255,0,0]
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm4, %ymm5, %ymm4
; AVX2-SLOW-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovdqa 48(%rdi), %xmm5
; AVX2-SLOW-NEXT:    vmovdqa 48(%rsi), %xmm6
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
...
; AVX2-SLOW-NEXT:    vpermd %ymm2, %ymm11, %ymm6
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm5, %ymm6, %ymm4
; AVX2-SLOW-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovdqa 80(%rdi), %xmm6
; AVX2-SLOW-NEXT:    vmovdqa 80(%rsi), %xmm13
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm13[4],xmm6[4],xmm13[5],xmm6[5],xmm13[6],xmm6[6],xmm13[7],xmm6[7]
; AVX2-SLOW-NEXT:    vpshufb %xmm7, %xmm14, %xmm14
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm13[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm6 = xmm6[0,1],xmm13[2],xmm6[3,4],xmm13[5],xmm6[6,7]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm14, %ymm6, %ymm6
; AVX2-SLOW-NEXT:    vpermd %ymm1, %ymm11, %ymm13
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm6, %ymm13, %ymm4
; AVX2-SLOW-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-SLOW-NEXT:    vmovdqa 112(%rdi), %xmm13
; AVX2-SLOW-NEXT:    vmovdqa 112(%rsi), %xmm14
; AVX2-SLOW-NEXT:    vpunpckhwd {{.*#+}} xmm15 = xmm14[4],xmm13[4],xmm14[5],xmm13[5],xmm14[6],xmm13[6],xmm14[7],xmm13[7]
; AVX2-SLOW-NEXT:    vpshufb %xmm7, %xmm15, %xmm7
; AVX2-SLOW-NEXT:    vmovdqa 32(%rsi), %xmm15
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm14[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm14[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm13 = xmm13[0,1],xmm14[2],xmm13[3,4],xmm14[5],xmm13[6,7]
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm13, %ymm7
; AVX2-SLOW-NEXT:    vpermd %ymm0, %ymm11, %ymm11
; AVX2-SLOW-NEXT:    vpblendvb %ymm12, %ymm7, %ymm11, %ymm7
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm11 = xmm8[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm10[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm12 = xmm11[0,1],xmm12[2],xmm11[3,4],xmm12[5],xmm11[6,7]
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm8 = xmm8[0],xmm10[0],xmm8[1],xmm10[1],xmm8[2],xmm10[2],xmm8[3],xmm10[3]
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm13, %ymm8, %ymm10, %ymm8
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm10 = xmm9[1,1,2,2]
; AVX2-SLOW-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm15[3,3,3,3,4,5,6,7]
; AVX2-SLOW-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm14[0,1,2,3,4,4,4,4]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm10 = xmm10[0,1],xmm14[2],xmm10[3,4],xmm14[5],xmm10[6,7]
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm9 = xmm9[0],xmm15[0],xmm9[1],xmm15[1],xmm9[2],xmm15[2],xmm9[3],xmm15[3]
; AVX2-SLOW-NEXT:    vpshufb %xmm11, %xmm9, %xmm9
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm10, %ymm9, %ymm9
; AVX2-SLOW-NEXT:    vpermd %ymm2, %ymm12, %ymm10
...
; AVX2-SLOW-NEXT:    vpshufd {{.*#+}} xmm4 = xmm10[1,1,2,2]
; AVX2-SLOW-NEXT:    vpblendw {{.*#+}} xmm4 = xmm4[0,1],xmm15[2],xmm4[3,4],xmm15[5],xmm4[6,7]
; AVX2-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm10[0],xmm14[0],xmm10[1],xmm14[1],xmm10[2],xmm14[2],xmm10[3],xmm14[3]
; AVX2-SLOW-NEXT:    vpshufb %xmm11, %xmm10, %xmm10
; AVX2-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm10, %ymm4
; AVX2-SLOW-NEXT:    vpermd %ymm1, %ymm12, %ymm10
...
; AVX2-SLOW-NEXT:    vpermd %ymm0, %ymm12, %ymm5
; AVX2-SLOW-NEXT:    vpblendvb %ymm13, %ymm4, %ymm5, %ymm11
; AVX2-SLOW-NEXT:    vmovdqa {{.*#+}} ymm4 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-SLOW-NEXT:    vpshufb %ymm4, %ymm14, %ymm5
...
; AVX2-SLOW-NEXT:    vpshufb %ymm4, %ymm13, %ymm13
; AVX2-SLOW-NEXT:    vpermd 32(%rdi), %ymm12, %ymm15
; AVX2-SLOW-NEXT:    vpblendvb %ymm14, %ymm13, %ymm15, %ymm13
; AVX2-SLOW-NEXT:    vmovdqa 64(%rsi), %ymm15
; AVX2-SLOW-NEXT:    vpshufb %ymm4, %ymm15, %ymm15
; AVX2-SLOW-NEXT:    vpermd 64(%rdi), %ymm12, %ymm6
...
; AVX2-SLOW-NEXT:    vpblendvb %ymm14, %ymm5, %ymm3, %ymm3
; AVX2-SLOW-NEXT:    vpermd %ymm2, %ymm12, %ymm2
; AVX2-SLOW-NEXT:    vpblendvb %ymm14, %ymm13, %ymm2, %ymm2
; AVX2-SLOW-NEXT:    vpermd %ymm1, %ymm12, %ymm1
; AVX2-SLOW-NEXT:    vpblendvb %ymm14, %ymm6, %ymm1, %ymm1
; AVX2-SLOW-NEXT:    vpermd %ymm0, %ymm12, %ymm0
; AVX2-SLOW-NEXT:    vpblendvb %ymm14, %ymm4, %ymm0, %ymm0
; AVX2-SLOW-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm1, 224(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm2, 128(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm3, 32(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm11, 288(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm10, 192(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm9, 96(%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm8, (%rcx)
; AVX2-SLOW-NEXT:    vmovdqa %ymm7, 352(%rcx)
...
; AVX2-FAST-NEXT:    vmovdqa 16(%rsi), %xmm3
; AVX2-FAST-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm6 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
...
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm9 = xmm7[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm5 = xmm9[0,1],xmm5[2],xmm9[3,4],xmm5[5],xmm9[6,7]
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm7[0],xmm2[0],xmm7[1],xmm2[1],xmm7[2],xmm2[2],xmm7[3],xmm2[3]
...
; AVX2-FAST-NEXT:    vpermd %ymm1, %ymm13, %ymm5
...
; AVX2-FAST-NEXT:    vpblendvb %ymm14, %ymm2, %ymm5, %ymm0
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm3[4],xmm8[4],xmm3[5],xmm8[5],xmm3[6],xmm8[6],xmm3[7],xmm8[7]
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} xmm9 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX2-FAST-NEXT:    vpshufb %xmm9, %xmm5, %xmm5
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm3, %xmm3
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm7 = xmm8[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm3 = xmm7[0,1],xmm3[2],xmm7[3,4],xmm3[5],xmm7[6,7]
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm5, %ymm3, %ymm3
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm0 = <5,5,u,6,6,u,7,7>
...
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm3, %ymm5, %ymm0
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm4, %xmm5
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm7 = xmm15[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm5 = xmm7[0,1],xmm5[2],xmm7[3,4],xmm5[5],xmm7[6,7]
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX2-FAST-NEXT:    vpshufb %xmm12, %xmm4, %xmm4
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm5, %ymm4, %ymm4
; AVX2-FAST-NEXT:    vpermd %ymm10, %ymm13, %ymm5
; AVX2-FAST-NEXT:    vpblendvb %ymm14, %ymm4, %ymm5, %ymm0
; AVX2-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-NEXT:    vmovdqa 48(%rdi), %xmm5
; AVX2-FAST-NEXT:    vmovdqa 48(%rsi), %xmm7
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm8, %ymm5, %ymm5
; AVX2-FAST-NEXT:    vpermd %ymm10, %ymm2, %ymm7
; AVX2-FAST-NEXT:    vmovdqa %ymm2, %ymm4
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm5, %ymm7, %ymm5
; AVX2-FAST-NEXT:    vmovdqa 64(%rsi), %xmm7
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm7, %xmm8
; AVX2-FAST-NEXT:    vmovdqa 64(%rdi), %xmm15
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm8[2],xmm2[3,4],xmm8[5],xmm2[6,7]
; AVX2-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm15[0],xmm7[0],xmm15[1],xmm7[1],xmm15[2],xmm7[2],xmm15[3],xmm7[3]
; AVX2-FAST-NEXT:    vmovdqa 64(%rdx), %ymm8
; AVX2-FAST-NEXT:    vpshufb %xmm12, %xmm7, %xmm7
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm7, %ymm2
; AVX2-FAST-NEXT:    vpermd %ymm8, %ymm13, %ymm7
; AVX2-FAST-NEXT:    vpblendvb %ymm14, %ymm2, %ymm7, %ymm7
; AVX2-FAST-NEXT:    vmovdqa 96(%rsi), %xmm2
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm2, %xmm15
; AVX2-FAST-NEXT:    vmovdqa 96(%rdi), %xmm0
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm3 = xmm0[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm15[2],xmm3[3,4],xmm15[5],xmm3[6,7]
...
; AVX2-FAST-NEXT:    vpermd %ymm15, %ymm13, %ymm2
; AVX2-FAST-NEXT:    vpblendvb %ymm14, %ymm0, %ymm2, %ymm12
; AVX2-FAST-NEXT:    vmovdqa 80(%rdi), %xmm0
; AVX2-FAST-NEXT:    vmovdqa 80(%rsi), %xmm2
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX2-FAST-NEXT:    vpshufb %xmm6, %xmm2, %xmm2
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-FAST-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm2[2],xmm0[3,4],xmm2[5],xmm0[6,7]
; AVX2-FAST-NEXT:    vpshufb %xmm9, %xmm3, %xmm2
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX2-FAST-NEXT:    vpermd %ymm8, %ymm4, %ymm2
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm2, %ymm13
; AVX2-FAST-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX2-FAST-NEXT:    vmovdqa 112(%rsi), %xmm2
; AVX2-FAST-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
...
; AVX2-FAST-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm0
; AVX2-FAST-NEXT:    vpermd %ymm15, %ymm4, %ymm3
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm6
...
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm3 = <u,3,3,u,4,4,u,5>
; AVX2-FAST-NEXT:    vpermd (%rdi), %ymm3, %ymm9
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm11 = <255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255,u,u,0,0,255,255>
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm2, %ymm9, %ymm2
; AVX2-FAST-NEXT:    vmovdqa 32(%rsi), %ymm9
; AVX2-FAST-NEXT:    vpshufb %ymm0, %ymm9, %ymm9
; AVX2-FAST-NEXT:    vpermd 32(%rdi), %ymm3, %ymm14
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm9, %ymm14, %ymm9
; AVX2-FAST-NEXT:    vmovdqa 64(%rsi), %ymm14
; AVX2-FAST-NEXT:    vpshufb %ymm0, %ymm14, %ymm14
; AVX2-FAST-NEXT:    vpermd 64(%rdi), %ymm3, %ymm4
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm14, %ymm4, %ymm4
; AVX2-FAST-NEXT:    vmovdqa 96(%rsi), %ymm14
; AVX2-FAST-NEXT:    vpshufb %ymm0, %ymm14, %ymm0
; AVX2-FAST-NEXT:    vpermd 96(%rdi), %ymm3, %ymm3
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm0
; AVX2-FAST-NEXT:    vmovdqa {{.*#+}} ymm3 = <2,u,3,3,u,4,4,u>
...
; AVX2-FAST-NEXT:    vpermd %ymm10, %ymm3, %ymm2
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm9, %ymm2, %ymm2
; AVX2-FAST-NEXT:    vpermd %ymm8, %ymm3, %ymm8
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm4, %ymm8, %ymm4
; AVX2-FAST-NEXT:    vpermd %ymm15, %ymm3, %ymm3
; AVX2-FAST-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm0
; AVX2-FAST-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm4, 224(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm2, 128(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm1, 32(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm6, 352(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm13, 256(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm7, 192(%rcx)
; AVX2-FAST-NEXT:    vmovdqa %ymm5, 160(%rcx)
...
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 16(%rsi), %xmm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rsi), %xmm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} xmm6 = [6,7,6,7,6,7,6,7,8,9,8,9,8,9,8,9]
...
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm9 = xmm7[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm5 = xmm9[0,1],xmm5[2],xmm9[3,4],xmm5[5],xmm9[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm7[0],xmm2[0],xmm7[1],xmm2[1],xmm7[2],xmm2[2],xmm7[3],xmm2[3]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm1, %ymm13, %ymm5
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm2, %ymm5, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm3[4],xmm8[4],xmm3[5],xmm8[5],xmm3[6],xmm8[6],xmm3[7],xmm8[7]
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} xmm9 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm9, %xmm5, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm3, %xmm3
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm7 = xmm8[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm3 = xmm7[0,1],xmm3[2],xmm7[3,4],xmm3[5],xmm7[6,7]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm5, %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm0 = <5,5,u,6,6,u,7,7>
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm1, %ymm0, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, %ymm2
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm3, %ymm5, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm4, %xmm5
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm7 = xmm15[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm5 = xmm7[0,1],xmm5[2],xmm7[3,4],xmm5[5],xmm7[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm15[0],xmm4[0],xmm15[1],xmm4[1],xmm15[2],xmm4[2],xmm15[3],xmm4[3]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm12, %xmm4, %xmm4
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm5, %ymm4, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm10, %ymm13, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm4, %ymm5, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rdi), %xmm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 48(%rsi), %xmm7
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm8 = xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm5 = xmm5[0,1],xmm7[2],xmm5[3,4],xmm7[5],xmm5[6,7]
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm8, %ymm5, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm10, %ymm2, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm2, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm5, %ymm7, %ymm5
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 64(%rsi), %xmm7
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm7, %xmm8
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 64(%rdi), %xmm15
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm2 = xmm15[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0,1],xmm8[2],xmm2[3,4],xmm8[5],xmm2[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm2, %ymm7, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm8, %ymm13, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm2, %ymm7, %ymm7
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 96(%rsi), %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm2, %xmm15
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 96(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm3 = xmm0[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0,1],xmm15[2],xmm3[3,4],xmm15[5],xmm3[6,7]
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm13, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm14, %ymm0, %ymm2, %ymm12
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 80(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 80(%rsi), %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm6, %xmm2, %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-FAST-PERLANE-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0,1],xmm2[2],xmm0[3,4],xmm2[5],xmm0[6,7]
; AVX2-FAST-PERLANE-NEXT:    vpshufb %xmm9, %xmm3, %xmm2
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm8, %ymm4, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm2, %ymm13
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 112(%rdi), %xmm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 112(%rsi), %xmm2
; AVX2-FAST-PERLANE-NEXT:    vpunpckhwd {{.*#+}} xmm3 = xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
...
; AVX2-FAST-PERLANE-NEXT:    vinserti128 $1, %xmm3, %ymm0, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm4, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm6
...
; AVX2-FAST-PERLANE-NEXT:    vpermd (%rdi), %ymm3, %ymm9
...
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm2, %ymm9, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 32(%rsi), %ymm9
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm0, %ymm9, %ymm9
; AVX2-FAST-PERLANE-NEXT:    vpermd 32(%rdi), %ymm3, %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm9, %ymm14, %ymm9
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 64(%rsi), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm0, %ymm14, %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpermd 64(%rdi), %ymm3, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm14, %ymm4, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vmovdqa 96(%rsi), %ymm14
; AVX2-FAST-PERLANE-NEXT:    vpshufb %ymm0, %ymm14, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vpermd 96(%rdi), %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa {{.*#+}} ymm3 = <2,u,3,3,u,4,4,u>
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm1, %ymm3, %ymm1
...
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm10, %ymm3, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm9, %ymm2, %ymm2
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm8, %ymm3, %ymm8
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm4, %ymm8, %ymm4
; AVX2-FAST-PERLANE-NEXT:    vpermd %ymm15, %ymm3, %ymm3
; AVX2-FAST-PERLANE-NEXT:    vpblendvb %ymm11, %ymm0, %ymm3, %ymm0
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm0, 320(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm4, 224(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm2, 128(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm1, 32(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm6, 352(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm12, 288(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm13, 256(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm7, 192(%rcx)
; AVX2-FAST-PERLANE-NEXT:    vmovdqa %ymm5, 160(%rcx)
...
; AVX512F-NEXT:    vmovdqa (%rsi), %ymm3
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm0 = [10,11,0,1,128,128,12,13,2,3,128,128,14,15,4,5,128,128,16,17,28,29,128,128,18,19,18,19,128,128,20,21]
; AVX512F-NEXT:    vpshufb %ymm0, %ymm3, %ymm3
; AVX512F-NEXT:    vpor %ymm2, %ymm3, %ymm2
; AVX512F-NEXT:    vmovdqa (%rsi), %xmm3
; AVX512F-NEXT:    vmovdqa 16(%rsi), %xmm5
; AVX512F-NEXT:    vmovdqa 32(%rsi), %xmm7
; AVX512F-NEXT:    vprold $16, %xmm3, %xmm4
; AVX512F-NEXT:    vmovdqa (%rdi), %xmm6
; AVX512F-NEXT:    vmovdqa 16(%rdi), %xmm8
; AVX512F-NEXT:    vmovdqa 32(%rdi), %xmm9
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm10 = xmm6[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm4 = xmm10[0,1],xmm4[2],xmm10[3,4],xmm4[5],xmm10[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm6[0],xmm3[0],xmm6[1],xmm3[1],xmm6[2],xmm3[2],xmm6[3],xmm3[3]
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm11 = [0,1,2,3,4,5,4,5,6,7,10,11,8,9,10,11]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm3, %xmm3
; AVX512F-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm3
; AVX512F-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm12
; AVX512F-NEXT:    vmovdqa (%rdx), %ymm2
; AVX512F-NEXT:    vmovdqa 32(%rdx), %ymm6
; AVX512F-NEXT:    vmovdqa 64(%rdx), %ymm10
; AVX512F-NEXT:    vmovdqa 96(%rdx), %ymm3
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm4 = [128,128,10,11,128,128,128,128,12,13,128,128,128,128,14,15,128,128,128,128,16,17,128,128,128,128,18,19,128,128,128,128]
; AVX512F-NEXT:    vpshufb %ymm4, %ymm2, %ymm13
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} ymm16 = <u,0,0,u,1,1,u,2>
; AVX512F-NEXT:    vpermd %ymm2, %ymm16, %ymm2
...
; AVX512F-NEXT:    vpandn %ymm2, %ymm15, %ymm2
; AVX512F-NEXT:    vinserti64x4 $1, %ymm13, %zmm2, %zmm2
; AVX512F-NEXT:    vpternlogq $248, %zmm15, %zmm12, %zmm2
; AVX512F-NEXT:    vprold $16, %xmm7, %xmm12
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm13 = xmm9[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm12 = xmm13[0,1],xmm12[2],xmm13[3,4],xmm12[5],xmm13[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm9[0],xmm7[0],xmm9[1],xmm7[1],xmm9[2],xmm7[2],xmm9[3],xmm7[3]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm7, %xmm7
; AVX512F-NEXT:    vinserti128 $1, %xmm12, %ymm7, %ymm9
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm12 = xmm5[4],xmm8[4],xmm5[5],xmm8[5],xmm5[6],xmm8[6],xmm5[7],xmm8[7]
; AVX512F-NEXT:    vmovdqa {{.*#+}} xmm7 = [4,5,10,11,10,11,8,9,8,9,14,15,12,13,14,15]
; AVX512F-NEXT:    vpshufb %xmm7, %xmm12, %xmm12
; AVX512F-NEXT:    vprold $16, %xmm5, %xmm5
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm8 = xmm8[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm5 = xmm8[0,1],xmm5[2],xmm8[3,4],xmm5[5],xmm8[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm12, %ymm5, %ymm5
; AVX512F-NEXT:    vinserti64x4 $1, %ymm9, %zmm5, %zmm12
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm17 = <5,5,u,6,6,u,7,7,u,8,8,u,9,9,u,10>
; AVX512F-NEXT:    vpermd (%rdx), %zmm17, %zmm5
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm9 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
; AVX512F-NEXT:    vpternlogd $184, %zmm12, %zmm9, %zmm5
; AVX512F-NEXT:    vmovdqa 64(%rdi), %ymm12
; AVX512F-NEXT:    vpshufb %ymm1, %ymm12, %ymm12
; AVX512F-NEXT:    vmovdqa64 %ymm1, %ymm18
; AVX512F-NEXT:    vmovdqa 64(%rsi), %ymm13
; AVX512F-NEXT:    vmovdqa %ymm0, %ymm8
; AVX512F-NEXT:    vpshufb %ymm0, %ymm13, %ymm13
; AVX512F-NEXT:    vpor %ymm12, %ymm13, %ymm12
; AVX512F-NEXT:    vmovdqa 64(%rsi), %xmm13
; AVX512F-NEXT:    vprold $16, %xmm13, %xmm0
; AVX512F-NEXT:    vmovdqa 64(%rdi), %xmm14
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm1 = xmm14[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm0 = xmm1[0,1],xmm0[2],xmm1[3,4],xmm0[5],xmm1[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm14[0],xmm13[0],xmm14[1],xmm13[1],xmm14[2],xmm13[2],xmm14[3],xmm13[3]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm1, %xmm1
; AVX512F-NEXT:    vinserti128 $1, %xmm0, %ymm1, %ymm0
; AVX512F-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm0
; AVX512F-NEXT:    vpshufb %ymm4, %ymm10, %ymm1
; AVX512F-NEXT:    vpermd %ymm10, %ymm16, %ymm10
; AVX512F-NEXT:    vpandn %ymm10, %ymm15, %ymm10
; AVX512F-NEXT:    vinserti64x4 $1, %ymm1, %zmm10, %zmm10
; AVX512F-NEXT:    vpternlogq $248, %zmm15, %zmm0, %zmm10
; AVX512F-NEXT:    vmovdqa 96(%rsi), %xmm0
; AVX512F-NEXT:    vprold $16, %xmm0, %xmm1
; AVX512F-NEXT:    vmovdqa 96(%rdi), %xmm12
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm13 = xmm12[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm1 = xmm13[0,1],xmm1[2],xmm13[3,4],xmm1[5],xmm13[6,7]
; AVX512F-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm12[0],xmm0[0],xmm12[1],xmm0[1],xmm12[2],xmm0[2],xmm12[3],xmm0[3]
; AVX512F-NEXT:    vpshufb %xmm11, %xmm0, %xmm0
; AVX512F-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
; AVX512F-NEXT:    vmovdqa 80(%rdi), %xmm1
; AVX512F-NEXT:    vmovdqa 80(%rsi), %xmm11
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm12 = xmm11[4],xmm1[4],xmm11[5],xmm1[5],xmm11[6],xmm1[6],xmm11[7],xmm1[7]
; AVX512F-NEXT:    vpshufb %xmm7, %xmm12, %xmm12
; AVX512F-NEXT:    vprold $16, %xmm11, %xmm11
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0,1],xmm11[2],xmm1[3,4],xmm11[5],xmm1[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm12, %ymm1, %ymm1
; AVX512F-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm0
; AVX512F-NEXT:    vpermd 64(%rdx), %zmm17, %zmm1
; AVX512F-NEXT:    vpternlogd $184, %zmm0, %zmm9, %zmm1
; AVX512F-NEXT:    vmovdqa 32(%rdi), %ymm0
; AVX512F-NEXT:    vmovdqa64 %ymm18, %ymm14
; AVX512F-NEXT:    vpshufb %ymm14, %ymm0, %ymm0
; AVX512F-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX512F-NEXT:    vpshufb %ymm8, %ymm11, %ymm11
; AVX512F-NEXT:    vpor %ymm0, %ymm11, %ymm0
; AVX512F-NEXT:    vmovdqa 48(%rdi), %xmm11
; AVX512F-NEXT:    vmovdqa 48(%rsi), %xmm12
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm13 = xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX512F-NEXT:    vpshufb %xmm7, %xmm13, %xmm13
; AVX512F-NEXT:    vprold $16, %xmm12, %xmm12
; AVX512F-NEXT:    vpshufd {{.*#+}} xmm11 = xmm11[1,1,2,2]
; AVX512F-NEXT:    vpblendw {{.*#+}} xmm11 = xmm11[0,1],xmm12[2],xmm11[3,4],xmm12[5],xmm11[6,7]
; AVX512F-NEXT:    vinserti128 $1, %xmm13, %ymm11, %ymm11
; AVX512F-NEXT:    vinserti64x4 $1, %ymm11, %zmm0, %zmm0
; AVX512F-NEXT:    vpermd %ymm6, %ymm17, %ymm11
; AVX512F-NEXT:    vpandn %ymm11, %ymm9, %ymm11
; AVX512F-NEXT:    vpshufb %ymm4, %ymm6, %ymm6
; AVX512F-NEXT:    vinserti64x4 $1, %ymm11, %zmm6, %zmm6
; AVX512F-NEXT:    vmovdqa64 {{.*#+}} zmm11 = [65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0]
; AVX512F-NEXT:    vpternlogq $248, %zmm11, %zmm0, %zmm6
; AVX512F-NEXT:    vmovdqa 96(%rdi), %ymm0
; AVX512F-NEXT:    vpshufb %ymm14, %ymm0, %ymm0
; AVX512F-NEXT:    vmovdqa 96(%rsi), %ymm12
; AVX512F-NEXT:    vpshufb %ymm8, %ymm12, %ymm12
; AVX512F-NEXT:    vpor %ymm0, %ymm12, %ymm0
; AVX512F-NEXT:    vmovdqa 112(%rdi), %xmm12
; AVX512F-NEXT:    vmovdqa 112(%rsi), %xmm13
; AVX512F-NEXT:    vpunpckhwd {{.*#+}} xmm14 = xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
...
; AVX512F-NEXT:    vinserti128 $1, %xmm7, %ymm12, %ymm7
; AVX512F-NEXT:    vinserti64x4 $1, %ymm7, %zmm0, %zmm0
; AVX512F-NEXT:    vpermd %ymm3, %ymm17, %ymm7
; AVX512F-NEXT:    vpandn %ymm7, %ymm9, %ymm7
; AVX512F-NEXT:    vpshufb %ymm4, %ymm3, %ymm3
; AVX512F-NEXT:    vinserti64x4 $1, %ymm7, %zmm3, %zmm3
; AVX512F-NEXT:    vpternlogq $248, %zmm11, %zmm0, %zmm3
; AVX512F-NEXT:    vmovdqa64 %zmm3, 320(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm6, 128(%rcx)
; AVX512F-NEXT:    vmovdqa64 %zmm1, 256(%rcx)
...
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm9 = <u,11,43,u,12,44,u,13,45,u,14,46,u,15,47,u,16,48,u,17,49,u,18,50,u,19,51,u,20,52,u,21>
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm10
; AVX512BW-NEXT:    vpermt2w %zmm2, %zmm9, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm11 = [42,1,2,43,4,5,44,7,8,45,10,11,46,13,14,47,16,17,48,19,20,49,22,23,50,25,26,51,28,29,52,31]
; AVX512BW-NEXT:    vpermt2w %zmm4, %zmm11, %zmm10
; AVX512BW-NEXT:    vmovdqa64 {{.*#+}} zmm12 = <21,u,54,22,u,55,23,u,56,24,u,57,25,u,58,26,u,59,27,u,60,28,u,61,29,u,62,30,u,63,31,u>
