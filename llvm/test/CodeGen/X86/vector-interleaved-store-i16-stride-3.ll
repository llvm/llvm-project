...
; AVX512BW-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,4,16,1,5,17,2,6,18,3,7,19,u,u,u,u]
...
; AVX512DQ-BW-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,4,16,1,5,17,2,6,18,3,7,19,u,u,u,u]
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,4,16,1,5,17,2,6,18,3,7,19,u,u,u,u]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [0,8,1,9,1,9,2,10]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm4 = [u,0,0,u,1,1,u,2]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [0,8,1,9,1,9,2,10]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm4 = [u,0,0,u,1,1,u,2]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm4 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm4 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm8 = [u,3,3,u,4,4,u,5]
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm11 = [2,u,3,3,u,4,4,u]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm2 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm2 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX512-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
...
; AVX512-NEXT:    vpandn %ymm4, %ymm12, %ymm4
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm6 & mem)
...
; AVX512-NEXT:    vmovdqa {{.*#+}} ymm1 = [u,0,0,u,1,1,u,2]
; AVX512-NEXT:    vpermd %ymm7, %ymm1, %ymm1
; AVX512-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm1
; AVX512-NEXT:    vpshufb %ymm11, %ymm7, %ymm2
...
; AVX512-FCP-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
...
; AVX512-FCP-NEXT:    vpandn %ymm4, %ymm12, %ymm4
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm6 & mem)
...
; AVX512DQ-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
...
; AVX512DQ-NEXT:    vpandn %ymm4, %ymm12, %ymm4
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm6 & mem)
...
; AVX512DQ-NEXT:    vmovdqa {{.*#+}} ymm1 = [u,0,0,u,1,1,u,2]
; AVX512DQ-NEXT:    vpermd %ymm7, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm1, %ymm1
; AVX512DQ-NEXT:    vpshufb %ymm11, %ymm7, %ymm2
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm1 = zmm1 | (zmm0 & mem)
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 ^ (zmm12 & (zmm5 ^ zmm3))
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 {{.*#+}} zmm12 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
...
; AVX512DQ-FCP-NEXT:    vpandn %ymm4, %ymm12, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm6 & mem)
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [u,0,0,u,1,1,u,2]
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 ^ (zmm12 & (zmm5 ^ zmm3))
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm5 = [u,3,3,u,4,4,u,5]
...
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm5 = [2,u,3,3,u,4,4,u]
...
; AVX2-FP-NEXT:    vmovdqa (%rsi), %xmm2
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} xmm7 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm3 = [u,3,3,u,4,4,u,5]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm3 = [2,u,3,3,u,4,4,u]
...
; AVX2-FCP-NEXT:    vmovdqa (%rsi), %xmm2
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} xmm7 = [u,u,u,u,6,7,u,u,u,u,8,9,u,u,u,u]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [u,3,3,u,4,4,u,5]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [2,u,3,3,u,4,4,u]
...
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm13
...
; AVX512-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[0,1,2,3]
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm22 & (zmm2 ^ zmm0))
...
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm13
...
; AVX512-FCP-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[0,1,2,3]
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm22 & (zmm2 ^ zmm0))
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm13
...
; AVX512DQ-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[0,1,2,3]
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm22 & (zmm2 ^ zmm0))
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm13
...
; AVX512DQ-FCP-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm13[0,1,2,3]
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm22 & (zmm2 ^ zmm0))
