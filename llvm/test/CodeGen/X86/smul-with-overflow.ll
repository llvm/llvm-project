...
; X86-NEXT:    movzbl (%esp), %edi # 1-byte Folded Reload
...
; X64-NEXT:    xorq %rsi, %r14
; X64-NEXT:    orq %rcx, %r14
; X64-NEXT:    xorq %rsi, %rdx
; X64-NEXT:    xorq %r11, %rsi
...
; X64-NEXT:    movb %cl, 16(%rdi)
; X64-NEXT:    setne 32(%rdi)
; X64-NEXT:    popq %rbx
; X64-NEXT:    popq %r12
; X64-NEXT:    popq %r13
; X64-NEXT:    popq %r14
