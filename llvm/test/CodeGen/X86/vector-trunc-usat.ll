...
; AVX512F-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [4294967295,0,4294967295,0]
...
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} xmm1 = [4294967295,0,4294967295,0]
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpminuq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to2}, %xmm0, %xmm0
...
; SKX-NEXT:    vpminuq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %zmm0, %zmm0
...
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
; AVX512F-NEXT:    vpmovzxwq {{.*#+}} xmm1 = [65535,65535]
; AVX512F-NEXT:    vpminuq %zmm1, %zmm0, %zmm0
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
; AVX512BW-NEXT:    vpmovzxwq {{.*#+}} xmm1 = [65535,65535]
; AVX512BW-NEXT:    vpminuq %zmm1, %zmm0, %zmm0
...
; AVX512VL:       # %bb.0:
; AVX512VL-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to4}, %xmm0, %xmm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to4}, %xmm0, %xmm0
...
; AVX512VL:       # %bb.0:
; AVX512VL-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm0, %ymm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to8}, %ymm0, %ymm0
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm0, %zmm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vmovdqa64 (%rdi), %zmm0
; SKX-NEXT:    vpminud {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to16}, %zmm0, %zmm0
...
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
; AVX512F-NEXT:    vpmovzxbq {{.*#+}} xmm1 = [255,255]
; AVX512F-NEXT:    vpminuq %zmm1, %zmm0, %zmm0
; AVX512F-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
; AVX512F-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
; AVX512BW-NEXT:    vpmovzxbq {{.*#+}} xmm1 = [255,255]
; AVX512BW-NEXT:    vpminuq %zmm1, %zmm0, %zmm0
; AVX512BW-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
; AVX512BW-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX512BW-NEXT:    vpackuswb %xmm0, %xmm0, %xmm0
; AVX512BW-NEXT:    vmovq %xmm0, (%rdi)
; AVX512BW-NEXT:    retq
;
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vmovdqa64 (%rdi), %zmm0
; SKX-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm0, %zmm0
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpbroadcastd {{.*#+}} zmm0 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512-NEXT:    vpminud 64(%rdi), %zmm0, %zmm1
; AVX512-NEXT:    vpminud (%rdi), %zmm0, %zmm0
; AVX512-NEXT:    vpmovdb %zmm0, %xmm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpbroadcastd {{.*#+}} zmm0 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; SKX-NEXT:    vpminud 64(%rdi), %zmm0, %zmm1
; SKX-NEXT:    vpminud (%rdi), %zmm0, %zmm0
; SKX-NEXT:    vpmovdb %zmm0, %xmm0
; SKX-NEXT:    vpmovdb %zmm1, %xmm1
