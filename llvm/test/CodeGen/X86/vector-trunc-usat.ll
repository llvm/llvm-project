...
; SSE2-SSSE3-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm6[0,2]
...
; SSE2-SSSE3-NEXT:    packuswb %xmm5, %xmm4
; SSE2-SSSE3-NEXT:    packuswb %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    packuswb %xmm6, %xmm6
...
; SSE41-NEXT:    packuswb %xmm8, %xmm8
; SSE41-NEXT:    movq %xmm8, (%rsi)
; SSE41-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm11
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm10
...
; SSE2-SSSE3-NEXT:    packuswb %xmm3, %xmm7
; SSE2-SSSE3-NEXT:    packuswb %xmm7, %xmm0
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm5 = [2147483648,2147483648,2147483648,2147483648]
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm6
; SSE2-SSSE3-NEXT:    pxor %xmm5, %xmm6
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm7 = [2147483903,2147483903,2147483903,2147483903]
; SSE2-SSSE3-NEXT:    movdqa %xmm7, %xmm8
...
; SSE2-SSSE3-NEXT:    packuswb %xmm6, %xmm7
; SSE2-SSSE3-NEXT:    packuswb %xmm7, %xmm0
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pandn %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm6
; SSE2-SSSE3-NEXT:    packuswb %xmm8, %xmm6
...
; SSE2-SSSE3-NEXT:    pandn %xmm4, %xmm7
; SSE2-SSSE3-NEXT:    por %xmm2, %xmm7
; SSE2-SSSE3-NEXT:    packuswb %xmm1, %xmm7
; SSE2-SSSE3-NEXT:    packuswb %xmm7, %xmm6
; SSE2-SSSE3-NEXT:    movdqa %xmm6, (%rsi)
; SSE2-SSSE3-NEXT:    retq
;
