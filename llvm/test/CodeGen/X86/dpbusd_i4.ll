...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx512bw,+avx512vnni,+avx512vl | FileCheck %s
...
; CHECK-NEXT:    vpbroadcastb {{.*#+}} xmm2 = [8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8]
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vpbroadcastb {{.*#+}} xmm2 = [15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15]
