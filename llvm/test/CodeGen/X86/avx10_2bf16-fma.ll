...
; RUN: llc < %s -verify-machineinstrs -denormal-fp-math=preserve-sign -mtriple=x86_64-unknown-unknown -mattr=+avx10.2 | FileCheck %s --check-prefixes=AVX10_2
; RUN: llc < %s -verify-machineinstrs -denormal-fp-math=preserve-sign -mtriple=x86_64-unknown-unknown -mattr=+avx512bf16,+avx512vl | FileCheck %s --check-prefixes=AVX512BF16
; RUN: llc < %s -verify-machineinstrs -denormal-fp-math=preserve-sign -mtriple=x86_64-unknown-unknown -mattr=+avxneconvert | FileCheck %s --check-prefixes=AVXNECONVERT
