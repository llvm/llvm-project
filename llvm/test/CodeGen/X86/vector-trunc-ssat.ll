...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [18446744069414584320,18446744069414584320]
...
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpmovsqd %xmm0, %xmm0
; AVX512BWVL-NEXT:    vmovq %xmm0, (%rdi)
; AVX512BWVL-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm4
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [18446744069414584320,18446744069414584320]
...
; SSE2-SSSE3-NEXT:    pandn %xmm1, %xmm6
...
; SSE2-SSSE3-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,2],xmm6[0,2]
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm6, %xmm2
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm2[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm2
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm3[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm3
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm6, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm8[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    movdqa %xmm7, %xmm1
; SSE2-SSSE3-NEXT:    pxor %xmm0, %xmm1
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm6 = [18446744069414584320,18446744069414584320]
; SSE2-SSSE3-NEXT:    movdqa %xmm1, %xmm8
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm6, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm6, %xmm1
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm7[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm6, %xmm1
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm1[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm1
; SSE2-SSSE3-NEXT:    pand %xmm1, %xmm5
; SSE2-SSSE3-NEXT:    pandn %xmm4, %xmm1
; SSE2-SSSE3-NEXT:    por %xmm5, %xmm1
; SSE2-SSSE3-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,2],xmm8[0,2]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm3[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm6, %xmm0
...
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm3
; SSE2-SSSE3-NEXT:    pxor %xmm3, %xmm1
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [18446744071562035200,18446744071562035200]
; SSE2-SSSE3-NEXT:    movdqa %xmm1, %xmm2
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm0, %xmm2
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm2[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm0, %xmm1
...
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpmovsqw %xmm0, %xmm0
; AVX512BWVL-NEXT:    vmovd %xmm0, (%rdi)
; AVX512BWVL-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm3
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [18446744071562035200,18446744071562035200]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm6
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm6[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm3
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm6[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm3
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm3[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm6[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm6[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm0
...
; SSE2-SSSE3-NEXT:    pand %xmm6, %xmm5
; SSE2-SSSE3-NEXT:    pandn %xmm0, %xmm6
; SSE2-SSSE3-NEXT:    por %xmm5, %xmm6
...
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm6, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm6, %xmm7
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm6 = [18446744071562035200,18446744071562035200]
...
; SSE2-SSSE3-NEXT:    packssdw %xmm8, %xmm0
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm5
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm5
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm7
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm6, %xmm7
...
; SSE2-SSSE3-NEXT:    pandn %xmm4, %xmm3
; SSE2-SSSE3-NEXT:    por %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    packssdw %xmm7, %xmm3
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_ssat_v4i32_v4i16_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpackssdw %xmm0, %xmm0, %xmm0
...
; AVX512VL:       # %bb.0:
; AVX512VL-NEXT:    vpmovsqb %xmm0, %xmm0
; AVX512VL-NEXT:    vpextrw $0, %xmm0, (%rdi)
; AVX512VL-NEXT:    retq
;
...
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpmovsqb %xmm0, %xmm0
; AVX512BWVL-NEXT:    vpextrw $0, %xmm0, (%rdi)
; AVX512BWVL-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm3
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [18446744071562067840,18446744071562067840]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm6
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm6[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm3
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm1
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm1[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm1
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm7[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm6[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm6
; SSE2-SSSE3-NEXT:    pand %xmm6, %xmm5
; SSE2-SSSE3-NEXT:    pandn %xmm3, %xmm6
; SSE2-SSSE3-NEXT:    por %xmm5, %xmm6
; SSE2-SSSE3-NEXT:    packssdw %xmm8, %xmm6
; SSE2-SSSE3-NEXT:    movdqa %xmm2, %xmm5
; SSE2-SSSE3-NEXT:    pxor %xmm0, %xmm5
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm7
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm7[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm5
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm5
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm5, %xmm7
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm2
; SSE2-SSSE3-NEXT:    pandn %xmm3, %xmm7
; SSE2-SSSE3-NEXT:    por %xmm2, %xmm7
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm2
...
; SSE2-SSSE3-NEXT:    pandn %xmm3, %xmm2
; SSE2-SSSE3-NEXT:    por %xmm1, %xmm2
; SSE2-SSSE3-NEXT:    packssdw %xmm7, %xmm2
; SSE2-SSSE3-NEXT:    packssdw %xmm2, %xmm6
; SSE2-SSSE3-NEXT:    packsswb %xmm6, %xmm6
; SSE2-SSSE3-NEXT:    movq %xmm6, (%rsi)
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    movdqa 16(%rdi), %xmm0
; SSE2-SSSE3-NEXT:    movdqa 32(%rdi), %xmm11
; SSE2-SSSE3-NEXT:    movdqa 48(%rdi), %xmm10
; SSE2-SSSE3-NEXT:    movdqa 80(%rdi), %xmm8
...
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm2, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm2
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm2[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm2
; SSE2-SSSE3-NEXT:    pand %xmm2, %xmm3
...
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm3
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm3, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm3
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm3[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm3
...
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm4
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm4[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm4
; SSE2-SSSE3-NEXT:    pand %xmm4, %xmm5
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm4
; SSE2-SSSE3-NEXT:    por %xmm5, %xmm4
; SSE2-SSSE3-NEXT:    movdqa %xmm8, %xmm5
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm5
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm5, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm5
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm5[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm5
; SSE2-SSSE3-NEXT:    pand %xmm5, %xmm8
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm5
; SSE2-SSSE3-NEXT:    por %xmm8, %xmm5
; SSE2-SSSE3-NEXT:    movdqa %xmm11, %xmm8
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm8
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm8, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm8
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm11
...
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm11, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm11
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm11[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm11
...
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm10, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm10[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm10
; SSE2-SSSE3-NEXT:    pand %xmm10, %xmm7
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm10
; SSE2-SSSE3-NEXT:    por %xmm7, %xmm10
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm7
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm7
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm9, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm7, %xmm9
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm0
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm9
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm9
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm6 = [18446744073709551488,18446744073709551488]
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm0
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm7 = [18446744071562067840,18446744071562067840]
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm12
; SSE2-SSSE3-NEXT:    pand %xmm12, %xmm9
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm12
; SSE2-SSSE3-NEXT:    por %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    movdqa %xmm10, %xmm0
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm9
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm9[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm0[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm14, %xmm0
; SSE2-SSSE3-NEXT:    pand %xmm0, %xmm10
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm0
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm0
; SSE2-SSSE3-NEXT:    packssdw %xmm12, %xmm0
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm12, %xmm9
...
; SSE2-SSSE3-NEXT:    movdqa %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm9
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm5
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm5[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm10, %xmm11
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm8[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm5
; SSE2-SSSE3-NEXT:    por %xmm4, %xmm5
; SSE2-SSSE3-NEXT:    packssdw %xmm9, %xmm5
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm4
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm4
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm8
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm7, %xmm4
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm4
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm4, %xmm8
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm3
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm8
; SSE2-SSSE3-NEXT:    por %xmm3, %xmm8
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm1
; SSE2-SSSE3-NEXT:    movdqa %xmm1, %xmm3
...
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm3
; SSE2-SSSE3-NEXT:    por %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    packssdw %xmm8, %xmm3
; SSE2-SSSE3-NEXT:    packssdw %xmm3, %xmm5
...
; SKX-NEXT:    vpbroadcastq {{.*#+}} xmm4 = [0,4,0,4]
; SKX-NEXT:    vpermi2d %xmm3, %xmm2, %xmm4
; SKX-NEXT:    vpmovsqb %ymm1, %xmm1
; SKX-NEXT:    vpmovsqb %ymm0, %xmm0
; SKX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; SKX-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm4[2,3]
; SKX-NEXT:    vzeroupper
; SKX-NEXT:    retq
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_ssat_v4i32_v4i8_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpackssdw %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vpacksswb %xmm0, %xmm0, %xmm0
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_ssat_v8i16_v8i8_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpacksswb %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vmovq %xmm0, (%rdi)
; AVX512-NEXT:    retq
