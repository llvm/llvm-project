...
; SSE2-NEXT:    movd {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; SSE2-NEXT:    movq {{.*#+}} xmm5 = xmm4[0],zero
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm4 = xmm4[0],xmm3[0]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm4[2,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,0],xmm1[2,0]
; SSE2-NEXT:    addps %xmm0, %xmm5
; SSE2-NEXT:    movaps %xmm5, (%rax)
...
; SSSE3-NEXT:    movd {{.*#+}} xmm4 = [NaN,0.0E+0,0.0E+0,0.0E+0]
; SSSE3-NEXT:    movq {{.*#+}} xmm5 = xmm4[0],zero
; SSSE3-NEXT:    punpcklqdq {{.*#+}} xmm4 = xmm4[0],xmm3[0]
; SSSE3-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,1],xmm4[2,0]
; SSSE3-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,0],xmm1[2,0]
; SSSE3-NEXT:    addps %xmm0, %xmm5
; SSSE3-NEXT:    movaps %xmm5, (%rax)
