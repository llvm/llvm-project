...
; SSE41-NEXT:    movzbl (%rdi), %esi
; SSE41-NEXT:    andl $15, %esi
; SSE41-NEXT:    movzbl 1(%rdi), %r8d
; SSE41-NEXT:    movzbl 2(%rdi), %r9d
; SSE41-NEXT:    movzbl 3(%rdi), %r10d
; SSE41-NEXT:    movzbl 4(%rdi), %r11d
; SSE41-NEXT:    movzbl 5(%rdi), %ebx
; SSE41-NEXT:    movzbl 6(%rdi), %r14d
; SSE41-NEXT:    movzbl 7(%rdi), %r15d
; SSE41-NEXT:    movzbl 8(%rdi), %r12d
; SSE41-NEXT:    movzbl 9(%rdi), %r13d
; SSE41-NEXT:    movzbl 10(%rdi), %ebp
; SSE41-NEXT:    movzbl 11(%rdi), %eax
; SSE41-NEXT:    movzbl 12(%rdi), %ecx
; SSE41-NEXT:    movzbl 13(%rdi), %edx
; SSE41-NEXT:    movq %rdx, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; SSE41-NEXT:    movzbl 14(%rdi), %edx
; SSE41-NEXT:    movq %rdx, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; SSE41-NEXT:    movzbl 15(%rdi), %edi
; SSE41-NEXT:    movaps %xmm0, -{{[0-9]+}}(%rsp)
; SSE41-NEXT:    movzbl -40(%rsp,%rsi), %esi
; SSE41-NEXT:    movd %esi, %xmm0
; SSE41-NEXT:    andl $15, %r8d
; SSE41-NEXT:    pinsrb $1, -40(%rsp,%r8), %xmm0
; SSE41-NEXT:    andl $15, %r9d
; SSE41-NEXT:    pinsrb $2, -40(%rsp,%r9), %xmm0
; SSE41-NEXT:    andl $15, %r10d
; SSE41-NEXT:    pinsrb $3, -40(%rsp,%r10), %xmm0
; SSE41-NEXT:    andl $15, %r11d
; SSE41-NEXT:    pinsrb $4, -40(%rsp,%r11), %xmm0
; SSE41-NEXT:    andl $15, %ebx
; SSE41-NEXT:    pinsrb $5, -40(%rsp,%rbx), %xmm0
; SSE41-NEXT:    andl $15, %r14d
; SSE41-NEXT:    pinsrb $6, -40(%rsp,%r14), %xmm0
; SSE41-NEXT:    andl $15, %r15d
; SSE41-NEXT:    pinsrb $7, -40(%rsp,%r15), %xmm0
; SSE41-NEXT:    andl $15, %r12d
; SSE41-NEXT:    pinsrb $8, -40(%rsp,%r12), %xmm0
; SSE41-NEXT:    andl $15, %r13d
; SSE41-NEXT:    pinsrb $9, -40(%rsp,%r13), %xmm0
; SSE41-NEXT:    andl $15, %ebp
; SSE41-NEXT:    pinsrb $10, -40(%rsp,%rbp), %xmm0
; SSE41-NEXT:    andl $15, %eax
; SSE41-NEXT:    pinsrb $11, -40(%rsp,%rax), %xmm0
; SSE41-NEXT:    andl $15, %ecx
; SSE41-NEXT:    pinsrb $12, -40(%rsp,%rcx), %xmm0
; SSE41-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; SSE41-NEXT:    andl $15, %eax
; SSE41-NEXT:    pinsrb $13, -40(%rsp,%rax), %xmm0
; SSE41-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; SSE41-NEXT:    andl $15, %eax
; SSE41-NEXT:    pinsrb $14, -40(%rsp,%rax), %xmm0
; SSE41-NEXT:    andl $15, %edi
; SSE41-NEXT:    pinsrb $15, -40(%rsp,%rdi), %xmm0
; SSE41-NEXT:    popq %rbx
; SSE41-NEXT:    popq %r12
; SSE41-NEXT:    popq %r13
; SSE41-NEXT:    popq %r14
...
; AVX-NEXT:    pushq %r12
; AVX-NEXT:    pushq %rbx
; AVX-NEXT:    movzbl (%rdi), %esi
; AVX-NEXT:    andl $15, %esi
; AVX-NEXT:    movzbl 1(%rdi), %r8d
; AVX-NEXT:    movzbl 2(%rdi), %r9d
; AVX-NEXT:    movzbl 3(%rdi), %r10d
; AVX-NEXT:    movzbl 4(%rdi), %r11d
; AVX-NEXT:    movzbl 5(%rdi), %ebx
; AVX-NEXT:    movzbl 6(%rdi), %r14d
; AVX-NEXT:    movzbl 7(%rdi), %r15d
; AVX-NEXT:    movzbl 8(%rdi), %r12d
; AVX-NEXT:    movzbl 9(%rdi), %r13d
; AVX-NEXT:    movzbl 10(%rdi), %ebp
; AVX-NEXT:    movzbl 11(%rdi), %eax
; AVX-NEXT:    movzbl 12(%rdi), %ecx
; AVX-NEXT:    movzbl 13(%rdi), %edx
; AVX-NEXT:    movq %rdx, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX-NEXT:    movzbl 14(%rdi), %edx
; AVX-NEXT:    movq %rdx, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX-NEXT:    movzbl 15(%rdi), %edi
; AVX-NEXT:    vmovaps %xmm0, -{{[0-9]+}}(%rsp)
; AVX-NEXT:    movzbl -40(%rsp,%rsi), %esi
; AVX-NEXT:    vmovd %esi, %xmm0
; AVX-NEXT:    andl $15, %r8d
; AVX-NEXT:    vpinsrb $1, -40(%rsp,%r8), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r9d
; AVX-NEXT:    vpinsrb $2, -40(%rsp,%r9), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r10d
; AVX-NEXT:    vpinsrb $3, -40(%rsp,%r10), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r11d
; AVX-NEXT:    vpinsrb $4, -40(%rsp,%r11), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %ebx
; AVX-NEXT:    vpinsrb $5, -40(%rsp,%rbx), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r14d
; AVX-NEXT:    vpinsrb $6, -40(%rsp,%r14), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r15d
; AVX-NEXT:    vpinsrb $7, -40(%rsp,%r15), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r12d
; AVX-NEXT:    vpinsrb $8, -40(%rsp,%r12), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %r13d
; AVX-NEXT:    vpinsrb $9, -40(%rsp,%r13), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %ebp
; AVX-NEXT:    vpinsrb $10, -40(%rsp,%rbp), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %eax
; AVX-NEXT:    vpinsrb $11, -40(%rsp,%rax), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %ecx
; AVX-NEXT:    vpinsrb $12, -40(%rsp,%rcx), %xmm0, %xmm0
; AVX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX-NEXT:    andl $15, %eax
; AVX-NEXT:    vpinsrb $13, -40(%rsp,%rax), %xmm0, %xmm0
; AVX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX-NEXT:    andl $15, %eax
; AVX-NEXT:    vpinsrb $14, -40(%rsp,%rax), %xmm0, %xmm0
; AVX-NEXT:    andl $15, %edi
; AVX-NEXT:    vpinsrb $15, -40(%rsp,%rdi), %xmm0, %xmm0
; AVX-NEXT:    popq %rbx
; AVX-NEXT:    popq %r12
; AVX-NEXT:    popq %r13
; AVX-NEXT:    popq %r14
