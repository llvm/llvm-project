...
for.body65:                                       ; preds = %for.body29
  ...
  %1 = load float, ptr null, align 4, !tbaa !1
  %vecinit7.i4304 = insertelement <8 x float> undef, float %1, i32 7
  %2 = load float, ptr undef, align 4, !tbaa !1
  %vecinit7.i4196 = insertelement <8 x float> undef, float %2, i32 7
  %3 = or i64 0, 16
  %add.ptr111.sum4096 = add i64 %3, 0
  %4 = load <8 x float>, ptr null, align 16, !tbaa !5
  %add.ptr162 = getelementptr inbounds [65536 x float], ptr null, i64 0, i64 %add.ptr111.sum4096
  %5 = load <8 x float>, ptr %add.ptr162, align 16, !tbaa !5
  %add.ptr158.sum40975066 = or i64 %add.ptr111.sum4096, 8
  %add.ptr183 = getelementptr inbounds [65536 x float], ptr null, i64 0, i64 %add.ptr158.sum40975066
  %6 = load <8 x float>, ptr %add.ptr183, align 16, !tbaa !5
  %add.ptr200.sum40995067 = or i64 undef, 8
  %add.ptr225 = getelementptr inbounds [65536 x float], ptr null, i64 0, i64 %add.ptr200.sum40995067
  %7 = load <8 x float>, ptr %add.ptr225, align 4, !tbaa !5
  %8 = load <8 x float>, ptr undef, align 16, !tbaa !5
  %add.ptr242.sum41015068 = or i64 0, 8
  %add.ptr267 = getelementptr inbounds [65536 x float], ptr null, i64 0, i64 %add.ptr242.sum41015068
  %9 = load <8 x float>, ptr %add.ptr267, align 4, !tbaa !5
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4577) #1
  %10 = load <8 x float>, ptr null, align 16, !tbaa !5
  %11 = load <8 x float>, ptr undef, align 16, !tbaa !5
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4547) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4545) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4543) #1
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4439) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4437) #1
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> zeroinitializer) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4399) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4397) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> undef) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> undef) #1
  %mul.i4330 = fmul <8 x float> %7, undef
  %add.i4329 = fadd <8 x float> undef, %mul.i4330
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4329) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> undef) #1
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4295) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4293) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4291) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4289) #1
  %12 = load <8 x float>, ptr undef, align 16, !tbaa !5
  ...
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4257) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i4253) #1
  %mul.i = fmul <8 x float> %9, %vecinit7.i4196
  %add.i = fadd <8 x float> undef, %mul.i
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> zeroinitializer) #1
  call void @llvm.x86.avx.storeu.ps.256(ptr undef, <8 x float> %add.i) #1
  unreachable
}
