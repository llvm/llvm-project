...
; SSE-32-NEXT:    ucomiss %xmm4, %xmm5
; SSE-32-NEXT:    movl $0, %esi
; SSE-32-NEXT:    cmoval %ecx, %esi
; SSE-32-NEXT:    movd %edx, %xmm5
; SSE-32-NEXT:    movd %esi, %xmm4
...
; SSE-32-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm4[0]
; SSE-32-NEXT:    pand %xmm2, %xmm0
; SSE-32-NEXT:    pandn %xmm1, %xmm2
; SSE-32-NEXT:    por %xmm2, %xmm0
; SSE-32-NEXT:    leal -4(%ebp), %esp
; SSE-32-NEXT:    popl %esi
; SSE-32-NEXT:    popl %ebp
; SSE-32-NEXT:    retl
;
...
; SSE-64-NEXT:    movaps %xmm3, %xmm4
; SSE-64-NEXT:    unpckhpd {{.*#+}} xmm4 = xmm4[1],xmm3[1]
; SSE-64-NEXT:    movaps %xmm2, %xmm5
; SSE-64-NEXT:    unpckhpd {{.*#+}} xmm5 = xmm5[1],xmm2[1]
; SSE-64-NEXT:    ucomiss %xmm4, %xmm5
; SSE-64-NEXT:    movl $0, %esi
; SSE-64-NEXT:    cmoval %ecx, %esi
; SSE-64-NEXT:    movd %edx, %xmm4
; SSE-64-NEXT:    movd %esi, %xmm5
...
; SSE-64-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm5[0]
...
; SSE-64-NEXT:    cmoval %ecx, %edx
; SSE-64-NEXT:    movaps %xmm2, %xmm4
; SSE-64-NEXT:    unpckhpd {{.*#+}} xmm4 = xmm4[1],xmm2[1]
; SSE-64-NEXT:    movaps %xmm3, %xmm5
; SSE-64-NEXT:    unpckhpd {{.*#+}} xmm5 = xmm5[1],xmm3[1]
; SSE-64-NEXT:    ucomiss %xmm4, %xmm5
; SSE-64-NEXT:    movl $0, %esi
...
; SSE-32-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm3[0]
; SSE-32-NEXT:    pand %xmm2, %xmm0
; SSE-32-NEXT:    pandn %xmm1, %xmm2
; SSE-32-NEXT:    por %xmm2, %xmm0
; SSE-32-NEXT:    movl %ebp, %esp
...
; SSE-64-NEXT:    movq %rdx, %xmm2
; SSE-64-NEXT:    movq %rax, %xmm3
; SSE-64-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm3[0]
; SSE-64-NEXT:    pand %xmm2, %xmm0
; SSE-64-NEXT:    pandn %xmm1, %xmm2
; SSE-64-NEXT:    por %xmm2, %xmm0
; SSE-64-NEXT:    retq
...
; SSE-32-NEXT:    ucomisd %xmm3, %xmm2
; SSE-32-NEXT:    cmovael %ecx, %eax
; SSE-32-NEXT:    pshufd {{.*#+}} xmm2 = xmm4[0,0,1,1]
; SSE-32-NEXT:    movd %eax, %xmm3
; SSE-32-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,0,1,1]
; SSE-32-NEXT:    punpcklqdq {{.*#+}} xmm2 = xmm2[0],xmm3[0]
; SSE-32-NEXT:    pand %xmm2, %xmm0
