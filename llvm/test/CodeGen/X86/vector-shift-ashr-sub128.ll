...
; SSE-NEXT:    retq
;
; AVX1-LABEL: splatconstant_shift_v8i8_by_one:
; AVX1:       # %bb.0:
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: splatconstant_shift_v8i8_by_one:
; AVX2:       # %bb.0:
...
; AVX512-NEXT:    retq
;
; AVX512DQVL-LABEL: splatconstant_shift_v8i8_by_one:
; AVX512DQVL:       # %bb.0:
; AVX512DQVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512DQVL-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512DQVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
; AVX512DQVL-NEXT:    vpsubb %xmm1, %xmm0, %xmm0
; AVX512DQVL-NEXT:    retq
;
; AVX512BWVL-LABEL: splatconstant_shift_v8i8_by_one:
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512BWVL-NEXT:    vpbroadcastb {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512BWVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
; AVX512BWVL-NEXT:    vpsubb %xmm1, %xmm0, %xmm0
; AVX512BWVL-NEXT:    retq
;
...
; X86-SSE-NEXT:    pand {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0
; X86-SSE-NEXT:    movdqa {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; X86-SSE-NEXT:    pxor %xmm1, %xmm0
; X86-SSE-NEXT:    psubb %xmm1, %xmm0
; X86-SSE-NEXT:    retl
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: splatconstant_shift_v4i8_by_one:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX1-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: splatconstant_shift_v4i8_by_one:
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX2-NEXT:    vpbroadcastb {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
...
; AVX512-NEXT:    retq
;
; AVX512DQVL-LABEL: splatconstant_shift_v4i8_by_one:
; AVX512DQVL:       # %bb.0:
; AVX512DQVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512DQVL-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512DQVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
...
; AVX512DQVL-NEXT:    retq
;
; AVX512BWVL-LABEL: splatconstant_shift_v4i8_by_one:
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512BWVL-NEXT:    vpbroadcastb {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512BWVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: splatconstant_shift_v2i8_by_one:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX1-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX1-NEXT:    vbroadcastss {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: splatconstant_shift_v2i8_by_one:
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX2-NEXT:    vpand {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX2-NEXT:    vpbroadcastb {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
...
; AVX512-NEXT:    retq
;
; AVX512DQVL-LABEL: splatconstant_shift_v2i8_by_one:
; AVX512DQVL:       # %bb.0:
; AVX512DQVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512DQVL-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512DQVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
...
; AVX512DQVL-NEXT:    retq
;
; AVX512BWVL-LABEL: splatconstant_shift_v2i8_by_one:
; AVX512BWVL:       # %bb.0:
; AVX512BWVL-NEXT:    vpsrlw $1, %xmm0, %xmm0
; AVX512BWVL-NEXT:    vpbroadcastb {{.*#+}} xmm1 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
; AVX512BWVL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (xmm0 & m32bcst)
