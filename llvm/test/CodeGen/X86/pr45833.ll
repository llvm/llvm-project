...
; CHECK-NEXT:    vmaskmovps %ymm3, %ymm4, 32(%rdi)
...
; CHECK-NEXT:    vpinsrb $9, %ecx, %xmm2, %xmm2
; CHECK-NEXT:    movzbl {{[0-9]+}}(%rsp), %edx
; CHECK-NEXT:    vpinsrb $10, %edx, %xmm2, %xmm2
; CHECK-NEXT:    movzbl {{[0-9]+}}(%rsp), %esi
; CHECK-NEXT:    vpinsrb $11, %esi, %xmm2, %xmm2
...
; CHECK-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; CHECK-NEXT:    vmovd %eax, %xmm4
; CHECK-NEXT:    vpinsrw $1, %ecx, %xmm4, %xmm4
; CHECK-NEXT:    vpinsrw $2, %edx, %xmm4, %xmm4
; CHECK-NEXT:    vpinsrw $3, %esi, %xmm4, %xmm4
; CHECK-NEXT:    vpmovzxwd {{.*#+}} xmm5 = xmm4[0],zero,xmm4[1],zero,xmm4[2],zero,xmm4[3],zero
; CHECK-NEXT:    vpslld $31, %xmm5, %xmm5
; CHECK-NEXT:    vpinsrw $4, %r8d, %xmm4, %xmm4
...
; CHECK-NEXT:    vpslld $31, %xmm5, %xmm5
; CHECK-NEXT:    vpinsrw $4, %r8d, %xmm4, %xmm4
; CHECK-NEXT:    vpinsrw $5, %r9d, %xmm4, %xmm4
; CHECK-NEXT:    vpunpckhwd {{.*#+}} xmm4 = xmm4[4,4,5,5,6,6,7,7]
; CHECK-NEXT:    vpslld $31, %xmm4, %xmm4
; CHECK-NEXT:    vinsertf128 $1, %xmm4, %ymm5, %ymm4
; CHECK-NEXT:    vmaskmovps %ymm3, %ymm4, 32(%rdi)
