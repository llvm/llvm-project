...
; CHECK-NEXT:    vpshufb {{.*#+}} xmm6 = xmm2[8,u,u,u],zero,xmm2[u,u,u],zero,xmm2[u,u,u],zero,xmm2[u,u,u]
; CHECK-NEXT:    vpslld $31, %xmm6, %xmm6
; CHECK-NEXT:    vmaskmovps %ymm5, %ymm6, 32(%rdi)
...
; CHECK-NEXT:    vpinsrb $4, %r9d, %xmm2, %xmm5
; CHECK-NEXT:    vpinsrb $5, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $6, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $7, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $8, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $9, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $10, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $11, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $12, {{[0-9]+}}(%rsp), %xmm5, %xmm6
; CHECK-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm5[8,8,9,9,10,10,11,11,12,12,13,13,14,14,15,15]
; CHECK-NEXT:    vpmovzxwd {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero,xmm5[2],zero,xmm5[3],zero
; CHECK-NEXT:    vpslld $31, %xmm5, %xmm5
; CHECK-NEXT:    vpsrldq {{.*#+}} xmm7 = xmm6[12,13,14,15],zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero
; CHECK-NEXT:    vpslld $31, %xmm7, %xmm7
; CHECK-NEXT:    vinsertf128 $1, %xmm7, %ymm5, %ymm5
; CHECK-NEXT:    vmaskmovps %ymm1, %ymm5, 32(%rdi)
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; CHECK-NEXT:    vinsertf128 $1, %xmm4, %ymm0, %ymm0
; CHECK-NEXT:    vpmovzxbd {{.*#+}} xmm1 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero
; CHECK-NEXT:    vpslld $31, %xmm1, %xmm1
; CHECK-NEXT:    vpshufd {{.*#+}} xmm2 = xmm6[1,1,1,1]
; CHECK-NEXT:    vpmovzxbd {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero
; CHECK-NEXT:    vpslld $31, %xmm2, %xmm2
; CHECK-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; CHECK-NEXT:    vmaskmovps %ymm0, %ymm1, (%rdi)
...
; CHECK-NEXT:    vpinsrb $4, %r9d, %xmm3, %xmm4
...
; CHECK-NEXT:    vpshufd {{.*#+}} xmm5 = xmm4[1,1,1,1]
...
; CHECK-NEXT:    vmaskmovps %ymm0, %ymm3, (%rdi)
; CHECK-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm0
; CHECK-NEXT:    vpshufb {{.*#+}} xmm1 = xmm4[8,u,9,u,10,u,11,u,12,u,13,u],zero,xmm4[u],zero,xmm4[u]
...
; CHECK-NEXT:    vmaskmovps %ymm0, %ymm1, 32(%rdi)
; CHECK-NEXT:    vzeroupper
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    vmovd %eax, %xmm9
; CHECK-NEXT:    vpslld $31, %xmm9, %xmm9
; CHECK-NEXT:    vmaskmovps %ymm8, %ymm9, 64(%rdi)
; CHECK-NEXT:    vinsertps {{.*#+}} xmm4 = xmm4[0],xmm5[0],xmm4[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm4 = xmm4[0,1],xmm6[0],xmm4[3]
; CHECK-NEXT:    vmovss {{.*#+}} xmm5 = mem[0],zero,zero,zero
...
; CHECK-NEXT:    vinsertps {{.*#+}} xmm6 = xmm6[0],mem[0],xmm6[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm6 = xmm6[0,1],mem[0],xmm6[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm1 = xmm6[0,1,2],mem[0]
; CHECK-NEXT:    vmovd {{.*#+}} xmm6 = mem[0],zero,zero,zero
; CHECK-NEXT:    vpinsrb $2, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $4, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vinsertf128 $1, %xmm1, %ymm5, %ymm1
; CHECK-NEXT:    vpinsrb $6, {{[0-9]+}}(%rsp), %xmm6, %xmm5
; CHECK-NEXT:    vpmovzxwd {{.*#+}} xmm6 = xmm5[0],zero,xmm5[1],zero,xmm5[2],zero,xmm5[3],zero
; CHECK-NEXT:    vpinsrb $8, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $10, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $12, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $14, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpslld $31, %xmm6, %xmm6
; CHECK-NEXT:    vpunpckhwd {{.*#+}} xmm5 = xmm5[4,4,5,5,6,6,7,7]
; CHECK-NEXT:    vpslld $31, %xmm5, %xmm5
; CHECK-NEXT:    vinsertf128 $1, %xmm5, %ymm6, %ymm5
; CHECK-NEXT:    vmaskmovps %ymm1, %ymm5, 32(%rdi)
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; CHECK-NEXT:    vinsertf128 $1, %xmm4, %ymm0, %ymm0
...
; CHECK-NEXT:    vinsertps {{.*#+}} xmm7 = xmm7[0],mem[0],xmm7[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm7 = xmm7[0,1],mem[0],xmm7[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm7 = xmm7[0,1,2],mem[0]
; CHECK-NEXT:    vmovss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; CHECK-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],mem[0],xmm1[2,3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm8 = xmm1[0,1],mem[0],xmm1[3]
; CHECK-NEXT:    vinsertf128 $1, %xmm6, %ymm5, %ymm1
; CHECK-NEXT:    vinsertps {{.*#+}} xmm5 = xmm8[0,1,2],mem[0]
; CHECK-NEXT:    vmovd {{.*#+}} xmm6 = mem[0],zero,zero,zero
; CHECK-NEXT:    vpinsrb $2, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $4, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vinsertf128 $1, %xmm5, %ymm7, %ymm5
; CHECK-NEXT:    vpinsrb $6, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpmovzxwd {{.*#+}} xmm7 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero
; CHECK-NEXT:    vpinsrb $8, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $10, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $12, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $14, {{[0-9]+}}(%rsp), %xmm6, %xmm6
; CHECK-NEXT:    vpslld $31, %xmm7, %xmm7
; CHECK-NEXT:    vpunpckhwd {{.*#+}} xmm6 = xmm6[4,4,5,5,6,6,7,7]
; CHECK-NEXT:    vpslld $31, %xmm6, %xmm6
; CHECK-NEXT:    vinsertf128 $1, %xmm6, %ymm7, %ymm6
; CHECK-NEXT:    vmaskmovps %ymm5, %ymm6, 32(%rdi)
; CHECK-NEXT:    movzbl {{[0-9]+}}(%rsp), %eax
; CHECK-NEXT:    vmovd %eax, %xmm5
; CHECK-NEXT:    vpinsrb $1, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $2, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $3, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpmovzxbd {{.*#+}} xmm6 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; CHECK-NEXT:    vpslld $31, %xmm6, %xmm6
; CHECK-NEXT:    vpinsrb $4, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $5, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpinsrb $6, {{[0-9]+}}(%rsp), %xmm5, %xmm5
; CHECK-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[1,1,1,1]
; CHECK-NEXT:    vpmovzxbd {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; CHECK-NEXT:    vpslld $31, %xmm5, %xmm5
; CHECK-NEXT:    vinsertf128 $1, %xmm5, %ymm6, %ymm5
; CHECK-NEXT:    vmaskmovps %ymm1, %ymm5, 64(%rdi)
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; CHECK-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm3[0]
; CHECK-NEXT:    vinsertf128 $1, %xmm4, %ymm0, %ymm0
; CHECK-NEXT:    vmovd %esi, %xmm1
