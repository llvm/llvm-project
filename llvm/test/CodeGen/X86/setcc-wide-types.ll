...
; SSE41-NEXT:    pextrq $1, %xmm7, %rsi
; SSE41-NEXT:    xorq %r10, %rsi
; SSE41-NEXT:    orq %rax, %rsi
...
; AVXANY-NEXT:    orq %rcx, %r10
; AVXANY-NEXT:    orq %r9, %r10
; AVXANY-NEXT:    xorq {{[0-9]+}}(%rsp), %rdx
; AVXANY-NEXT:    xorq {{[0-9]+}}(%rsp), %rax
; AVXANY-NEXT:    orq %rdx, %rax
