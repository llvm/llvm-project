...
; X86-NEXT:    vmovdqa 40(%ebp), %ymm2
; X86-NEXT:    vmovntdq %ymm0, (%ecx)
; X86-NEXT:    vaddpd {{\.?LCPI[0-9]+_[0-9]+}}, %ymm1, %ymm0
; X86-NEXT:    addl (%edx), %eax
; X86-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}, %ymm2, %ymm1
; X86-NEXT:    vmovntpd %ymm0, (%ecx)
; X86-NEXT:    addl (%edx), %eax
; X86-NEXT:    vmovntdq %ymm1, (%ecx)
; X86-NEXT:    vpaddw {{\.?LCPI[0-9]+_[0-9]+}}, %ymm3, %ymm0
; X86-NEXT:    addl (%edx), %eax
; X86-NEXT:    vmovdqa 104(%ebp), %ymm1
; X86-NEXT:    vmovntdq %ymm0, (%ecx)
...
; X64-NEXT:    addl (%rsi), %eax
; X64-NEXT:    vpaddd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm3, %ymm1
; X64-NEXT:    vmovntpd %ymm0, (%rdi)
; X64-NEXT:    addl (%rsi), %eax
; X64-NEXT:    vmovntdq %ymm1, (%rdi)
