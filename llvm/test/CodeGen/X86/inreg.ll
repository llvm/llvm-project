...
entry:
  ...
  call void @f(ptr inreg sret(%struct.s1) %tmp, i32 inreg 41, i32 inreg 42, i32 43)
  ret void
  ; DAG-LABEL: g1:
  ; DAG: subl $[[AMT:.*]], %esp
  ; DAG-NEXT: $43, (%esp)
...
declare void @f(ptr inreg sret(%struct.s1), i32 inreg, i32 inreg, i32)

%struct.s2 = type {}

define void @g2(ptr inreg sret(%struct.s2) %agg.result) nounwind {
entry:
  ret void
  ; DAG: g2
  ; DAG-NOT: ret $4
