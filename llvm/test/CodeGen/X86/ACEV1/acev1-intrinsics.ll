...
define void @test_bsr0init() {
; CHECK-LABEL: test_bsr0init:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrinit %bsr0 # encoding: [0xc4,0xe2,0xfb,0x49,0xc0]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.bsr0init()
  ret void
}

; Test BSRMOVF intrinsic
define void @test_bsr0movf(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_bsr0movf:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovf %zmm1, %zmm0, %bsr0 # encoding: [0x62,0xf6,0xfc,0x48,0x95,0xc1]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.bsr0movf(<64 x i8> %a, <64 x i8> %b)
  ret void
}

; Test BSRMOVF intrinsic with memory operand
define void @test_bsr0movf_mem(<64 x i8> %a, ptr %p) {
; CHECK-LABEL: test_bsr0movf_mem:
; CHECK:       # %bb.0:
...
define void @test_bsr0movf_mem_amode(<64 x i8> %a, ptr %base, i64 %idx) {
; CHECK-LABEL: test_bsr0movf_mem_amode:
; CHECK:       # %bb.0:
...
define void @test_bsr0movf_mem_unaligned(<64 x i8> %a, ptr %p) {
; CHECK-LABEL: test_bsr0movf_mem_unaligned:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovf (%rdi), %zmm0, %bsr0 # encoding: [0x62,0xf6,0xfc,0x48,0x95,0x07]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
...
define void @test_bsr0movf_mem_src1(ptr %p, <64 x i8> %b) {
; CHECK-LABEL: test_bsr0movf_mem_src1:
; CHECK:       # %bb.0:
...
define void @test_bsr0movhinsert(<64 x i8> %a) {
; CHECK-LABEL: test_bsr0movhinsert:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovh %zmm0, %bsr0 # encoding: [0x62,0xf6,0xff,0x48,0x95,0xc0]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.bsr0movhinsert(<64 x i8> %a)
  ret void
}

; Test BSRMOVH set intrinsic with memory operand
define void @test_bsr0movhinsert_mem(ptr %p) {
; CHECK-LABEL: test_bsr0movhinsert_mem:
; CHECK:       # %bb.0:
...
define <64 x i8> @test_bsr0movhextract() {
; CHECK-LABEL: test_bsr0movhextract:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovh %bsr0, %zmm0 # encoding: [0x62,0xf6,0x7f,0x48,0x95,0xc0]
; CHECK-NEXT:    retq # encoding: [0xc3]
  %result = call <64 x i8> @llvm.x86.acev1.bsr0movhextract()
  ret <64 x i8> %result
}

; Test BSRMOVH get intrinsic with memory operand
define void @test_bsr0movhextract_mem(ptr %p) {
; CHECK-LABEL: test_bsr0movhextract_mem:
; CHECK:       # %bb.0:
...
define void @test_bsr0movhextract_mem_unaligned(ptr %p) {
; CHECK-LABEL: test_bsr0movhextract_mem_unaligned:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovh %bsr0, (%rdi) # encoding: [0x62,0xf6,0x7f,0x48,0x95,0x07]
; CHECK-NEXT:    retq # encoding: [0xc3]
  %result = call <64 x i8> @llvm.x86.acev1.bsr0movhextract()
...
define void @test_bsr0movlinsert(<64 x i8> %a) {
; CHECK-LABEL: test_bsr0movlinsert:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovl %zmm0, %bsr0 # encoding: [0x62,0xf6,0xfe,0x48,0x95,0xc0]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.bsr0movlinsert(<64 x i8> %a)
  ret void
}

; Test BSRMOVL set intrinsic with memory operand
define void @test_bsr0movlinsert_mem(ptr %p) {
; CHECK-LABEL: test_bsr0movlinsert_mem:
; CHECK:       # %bb.0:
...
define <64 x i8> @test_bsr0movlextract() {
; CHECK-LABEL: test_bsr0movlextract:
; CHECK:       # %bb.0:
; CHECK-NEXT:    bsrmovl %bsr0, %zmm0 # encoding: [0x62,0xf6,0x7e,0x48,0x95,0xc0]
; CHECK-NEXT:    retq # encoding: [0xc3]
  %result = call <64 x i8> @llvm.x86.acev1.bsr0movlextract()
  ret <64 x i8> %result
}

; Test BSRMOVL get intrinsic with memory operand
define void @test_bsr0movlextract_mem(ptr %p) {
; CHECK-LABEL: test_bsr0movlextract_mem:
; CHECK:       # %bb.0:
...
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top2bf16ps(i8 0, <32 x bfloat> %a, <32 x bfloat> %b)
  ret void
}
...
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4buud(i8 0, <64 x i8> %a, <64 x i8> %b)
  ret void
}
...
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4busd(i8 0, <64 x i8> %a, <64 x i8> %b)
  ret void
}
...
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4bssd(i8 0, <64 x i8> %a, <64 x i8> %b)
  ret void
}
...
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4bsud(i8 0, <64 x i8> %a, <64 x i8> %b)
  ret void
}

; Test TOP4MXHF8PS intrinsic
define void @test_top4mxhf8ps(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_top4mxhf8ps:
; CHECK:       # %bb.0:
; CHECK-NEXT:    top4mxhf8ps $5, %zmm0, %zmm1, %tmm0 # encoding: [0x62,0xf3,0x7d,0x48,0x8d,0xc1,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4mxhf8ps(i8 0, <64 x i8> %a, <64 x i8> %b, i8 5)
  ret void
}

; Test TOP4MXBHF8PS intrinsic
define void @test_top4mxbhf8ps(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_top4mxbhf8ps:
; CHECK:       # %bb.0:
; CHECK-NEXT:    top4mxbhf8ps $5, %zmm0, %zmm1, %tmm0 # encoding: [0x62,0xf3,0x7f,0x48,0x8d,0xc1,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4mxbhf8ps(i8 0, <64 x i8> %a, <64 x i8> %b, i8 5)
  ret void
}

; Test TOP4MXHBF8PS intrinsic
define void @test_top4mxhbf8ps(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_top4mxhbf8ps:
; CHECK:       # %bb.0:
; CHECK-NEXT:    top4mxhbf8ps $5, %zmm0, %zmm1, %tmm0 # encoding: [0x62,0xf3,0x7e,0x48,0x8d,0xc1,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4mxhbf8ps(i8 0, <64 x i8> %a, <64 x i8> %b, i8 5)
  ret void
}

; Test TOP4MXBF8PS intrinsic
define void @test_top4mxbf8ps(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_top4mxbf8ps:
; CHECK:       # %bb.0:
; CHECK-NEXT:    top4mxbf8ps $5, %zmm0, %zmm1, %tmm0 # encoding: [0x62,0xf3,0x7c,0x48,0x8d,0xc1,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4mxbf8ps(i8 0, <64 x i8> %a, <64 x i8> %b, i8 5)
  ret void
}

; Test TOP4MXBSSPS intrinsic (MX INT8 SxS with BSR scaling)
define void @test_top4mxbssps(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: test_top4mxbssps:
; CHECK:       # %bb.0:
; CHECK-NEXT:    top4mxbssps $5, %zmm0, %zmm1, %tmm0 # encoding: [0x62,0xf3,0x7f,0x48,0x8f,0xc1,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.top4mxbssps(i8 0, <64 x i8> %a, <64 x i8> %b, i8 5)
  ret void
}

; Test TILEMOVCOL intrinsic (constant index - generates immediate form)
define void @test_tilemovcolinsert(<16 x i32> %src) {
; CHECK-LABEL: test_tilemovcolinsert:
; CHECK:       # %bb.0:
; CHECK-NEXT:    tilemovcol $3, %zmm0, %tmm0 # encoding: [0x62,0xf3,0xfd,0x48,0x2f,0xc0,0x03]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.tilemovcolinsert(i8 0, <16 x i32> %src, i32 3)
  ret void
}

; Test TILEMOVROW intrinsic - write to tile (ACE extension)
; Uses constant index - generates immediate form
define void @test_tilemovrowinsert_to_tile(<16 x i32> %src) {
; CHECK-LABEL: test_tilemovrowinsert_to_tile:
; CHECK:       # %bb.0:
; CHECK-NEXT:    tilemovrow $5, %zmm0, %tmm1 # encoding: [0x62,0xf3,0xfd,0x48,0x07,0xc8,0x05]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.tilemovrowinsert(i8 1, <16 x i32> %src, i32 5)
  ret void
}

; Test TILEMOVCOL with register index
define void @test_tilemovcolinsert_reg(<16 x i32> %src, i32 %idx) {
; CHECK-LABEL: test_tilemovcolinsert_reg:
; CHECK:       # %bb.0:
; CHECK-NEXT:    tilemovcol %edi, %zmm0, %tmm2 # encoding: [0x62,0xf2,0xc5,0x48,0x4b,0xd0]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.tilemovcolinsert(i8 2, <16 x i32> %src, i32 %idx)
  ret void
}

; Test TILEMOVROW with register index
define void @test_tilemovrowinsert_reg(<16 x i32> %src, i32 %idx) {
; CHECK-LABEL: test_tilemovrowinsert_reg:
; CHECK:       # %bb.0:
; CHECK-NEXT:    tilemovrow %edi, %zmm0, %tmm3 # encoding: [0x62,0xf2,0xc5,0x48,0x4a,0xd8]
; CHECK-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.acev1.tilemovrowinsert(i8 3, <16 x i32> %src, i32 %idx)
  ret void
}

; Intrinsic declarations
declare void @llvm.x86.acev1.bsr0init()
declare void @llvm.x86.acev1.bsr0movf(<64 x i8>, <64 x i8>)
declare void @llvm.x86.acev1.bsr0movhinsert(<64 x i8>)
declare <64 x i8> @llvm.x86.acev1.bsr0movhextract()
declare void @llvm.x86.acev1.bsr0movlinsert(<64 x i8>)
declare <64 x i8> @llvm.x86.acev1.bsr0movlextract()
declare void @llvm.x86.acev1.tilemovcolinsert(i8, <16 x i32>, i32)
declare void @llvm.x86.acev1.tilemovrowinsert(i8, <16 x i32>, i32)
declare void @llvm.x86.acev1.top2bf16ps(i8, <32 x bfloat>, <32 x bfloat>)
declare void @llvm.x86.acev1.top4buud(i8, <64 x i8>, <64 x i8>)
declare void @llvm.x86.acev1.top4busd(i8, <64 x i8>, <64 x i8>)
declare void @llvm.x86.acev1.top4bssd(i8, <64 x i8>, <64 x i8>)
declare void @llvm.x86.acev1.top4bsud(i8, <64 x i8>, <64 x i8>)
declare void @llvm.x86.acev1.top4mxhf8ps(i8, <64 x i8>, <64 x i8>, i8)
declare void @llvm.x86.acev1.top4mxbhf8ps(i8, <64 x i8>, <64 x i8>, i8)
declare void @llvm.x86.acev1.top4mxhbf8ps(i8, <64 x i8>, <64 x i8>, i8)
declare void @llvm.x86.acev1.top4mxbf8ps(i8, <64 x i8>, <64 x i8>, i8)
declare void @llvm.x86.acev1.top4mxbssps(i8, <64 x i8>, <64 x i8>, i8)
