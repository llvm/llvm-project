...
; X64-NEXT:    retq
  ...
  store <4 x float> %ins3, ptr %ptr, align 16
  ret void
}
...
; X64-NEXT:    retq
  ...
  store <4 x i32> %ins3, ptr %ptr, align 16
  ret void
}
...
; X64-NEXT:    retq
  ...
  store <2 x double> %ins1, ptr %ptr, align 16
  ret void
}
...
; X64-NEXT:    vzeroupper
; X64-NEXT:    retq
  %ld = load <2 x i32>, ptr %in, align 8
  ...
  store <8 x i32> %ins, ptr %out, align 32
  ret void
}
...
; X64-NEXT:    retq
  ...
  store <8 x float> %ins, ptr %out, align 32
  ret void
}
...
; X64-NEXT:    vzeroupper
; X64-NEXT:    retq
  %ld = load <2 x double>, ptr %in, align 8
  ...
  store <4 x double> %ins, ptr %out, align 32
  ret void
}
