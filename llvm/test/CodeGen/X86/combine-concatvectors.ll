...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx  -use-constant-fp-for-fixed-length-splat | FileCheck %s --check-prefixes=CHECK,CHECK-AVX1-CFP
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx2 -use-constant-fp-for-fixed-length-splat | FileCheck %s --check-prefixes=CHECK,CHECK-AVX2-CFP
...
; AVX2-NEXT:    retq
;
; CHECK-AVX1-CFP-LABEL: concat_of_broadcast_v2f64_v4f64:
; CHECK-AVX1-CFP:       # %bb.0: # %alloca_0
; CHECK-AVX1-CFP-NEXT:    movq qa_@GOTPCREL(%rip), %rax
; CHECK-AVX1-CFP-NEXT:    movl $1091567616, 30256(%rax) # imm = 0x41100000
; CHECK-AVX1-CFP-NEXT:    movabsq $4294967297, %rcx # imm = 0x100000001
; CHECK-AVX1-CFP-NEXT:    movq %rcx, 46348(%rax)
; CHECK-AVX1-CFP-NEXT:    vbroadcastss {{.*#+}} ymm0 = [1065353216,1065353216,1065353216,1065353216,1065353216,1065353216,1065353216,1065353216]
; CHECK-AVX1-CFP-NEXT:    vmovups %ymm0, 48296(%rax)
; CHECK-AVX1-CFP-NEXT:    vmovsd {{.*#+}} xmm0 = [7.812501848093234E-3,7.812501848093234E-3,7.812501848093234E-3,7.812501848093234E-3,0.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX1-CFP-NEXT:    vmovsd %xmm0, 47372(%rax)
; CHECK-AVX1-CFP-NEXT:    vzeroupper
; CHECK-AVX1-CFP-NEXT:    retq
;
; CHECK-AVX2-CFP-LABEL: concat_of_broadcast_v2f64_v4f64:
; CHECK-AVX2-CFP:       # %bb.0: # %alloca_0
; CHECK-AVX2-CFP-NEXT:    movq qa_@GOTPCREL(%rip), %rax
; CHECK-AVX2-CFP-NEXT:    movl $1091567616, 30256(%rax) # imm = 0x41100000
; CHECK-AVX2-CFP-NEXT:    movabsq $4294967297, %rcx # imm = 0x100000001
; CHECK-AVX2-CFP-NEXT:    movq %rcx, 46348(%rax)
; CHECK-AVX2-CFP-NEXT:    vbroadcastss {{.*#+}} ymm0 = [1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0,1.0E+0]
; CHECK-AVX2-CFP-NEXT:    vmovups %ymm0, 48296(%rax)
; CHECK-AVX2-CFP-NEXT:    vmovlps %xmm0, 47372(%rax)
; CHECK-AVX2-CFP-NEXT:    vzeroupper
; CHECK-AVX2-CFP-NEXT:    retq
alloca_0:
...
; AVX2-NEXT:    retq
;
; CHECK-AVX1-CFP-LABEL: concat_of_broadcast_v4f32_v8f32:
; CHECK-AVX1-CFP:       # %bb.0:
; CHECK-AVX1-CFP-NEXT:    vmovaps (%rdi), %ymm0
; CHECK-AVX1-CFP-NEXT:    vmovaps (%rsi), %ymm1
; CHECK-AVX1-CFP-NEXT:    vmovaps (%rdx), %ymm2
; CHECK-AVX1-CFP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,0,0,0]
; CHECK-AVX1-CFP-NEXT:    vinsertf128 $1, %xmm1, %ymm1, %ymm1
; CHECK-AVX1-CFP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3,4,5],ymm1[6,7]
; CHECK-AVX1-CFP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1,2,3],ymm0[4],ymm2[5,6],ymm0[7]
; CHECK-AVX1-CFP-NEXT:    vextractf128 $1, %ymm0, %xmm0
; CHECK-AVX1-CFP-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[3,0],xmm0[0,0]
; CHECK-AVX1-CFP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[2,3],xmm1[2,0]
; CHECK-AVX1-CFP-NEXT:    vzeroupper
; CHECK-AVX1-CFP-NEXT:    retq
;
; CHECK-AVX2-CFP-LABEL: concat_of_broadcast_v4f32_v8f32:
; CHECK-AVX2-CFP:       # %bb.0:
; CHECK-AVX2-CFP-NEXT:    vmovaps (%rdi), %ymm0
; CHECK-AVX2-CFP-NEXT:    vunpcklps {{.*#+}} ymm0 = ymm0[0],mem[0],ymm0[1],mem[1],ymm0[4],mem[4],ymm0[5],mem[5]
; CHECK-AVX2-CFP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,2,0]
; CHECK-AVX2-CFP-NEXT:    vmovaps {{.*#+}} xmm1 = [6,7,4,3]
; CHECK-AVX2-CFP-NEXT:    vblendps {{.*#+}} ymm0 = mem[0,1,2,3],ymm0[4],mem[5,6],ymm0[7]
; CHECK-AVX2-CFP-NEXT:    vpermps %ymm0, %ymm1, %ymm0
; CHECK-AVX2-CFP-NEXT:    # kill: def $xmm0 killed $xmm0 killed $ymm0
; CHECK-AVX2-CFP-NEXT:    vzeroupper
; CHECK-AVX2-CFP-NEXT:    retq
...
; AVX2-NEXT:    retq
;
; CHECK-AVX1-CFP-LABEL: broadcast_of_shuffle_v2i64_v4i64:
; CHECK-AVX1-CFP:       # %bb.0: # %entry
; CHECK-AVX1-CFP-NEXT:    vpsllq $56, %xmm0, %xmm0
; CHECK-AVX1-CFP-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; CHECK-AVX1-CFP-NEXT:    vinsertf128 $1, %xmm0, %ymm0, %ymm0
; CHECK-AVX1-CFP-NEXT:    retq
;
; CHECK-AVX2-CFP-LABEL: broadcast_of_shuffle_v2i64_v4i64:
; CHECK-AVX2-CFP:       # %bb.0: # %entry
; CHECK-AVX2-CFP-NEXT:    vpsllq $56, %xmm0, %xmm0
; CHECK-AVX2-CFP-NEXT:    vpbroadcastq %xmm0, %ymm0
; CHECK-AVX2-CFP-NEXT:    retq
entry:
