...
; SSE2-NEXT:    shldq $63, %rdi, %rax
; SSE2-NEXT:    movq %rax, %xmm4
; SSE2-NEXT:    movq %rcx, %xmm0
; SSE2-NEXT:    shrq %rbp
; SSE2-NEXT:    movq %rbp, %xmm5
; SSE2-NEXT:    shrq %r13
; SSE2-NEXT:    movq %r13, %xmm6
; SSE2-NEXT:    shrq %r12
; SSE2-NEXT:    movq %r12, %xmm7
; SSE2-NEXT:    shrq %r15
; SSE2-NEXT:    movq %r15, %xmm2
; SSE2-NEXT:    shrq %r14
; SSE2-NEXT:    movq %r14, %xmm8
; SSE2-NEXT:    shrq %rbx
; SSE2-NEXT:    movq %rbx, %xmm9
; SSE2-NEXT:    shrq %r11
; SSE2-NEXT:    movq %r11, %xmm10
; SSE2-NEXT:    shrq %r10
; SSE2-NEXT:    movq %r10, %xmm1
; SSE2-NEXT:    shrq %r9
; SSE2-NEXT:    movq %r9, %xmm11
; SSE2-NEXT:    shrq %r8
; SSE2-NEXT:    movq %r8, %xmm12
; SSE2-NEXT:    shrq %rsi
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [65535,0,65535,65535,65535,65535,65535,65535]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm5 = xmm9[0,0,1,1]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm15[0,1,0,1]
...
; AVX1-NEXT:    vpextrw $2, %xmm3, %r11d
; AVX1-NEXT:    vpextrw $3, %xmm3, %ebx
; AVX1-NEXT:    vpextrw $4, %xmm3, %r14d
; AVX1-NEXT:    vpextrw $5, %xmm3, %r15d
; AVX1-NEXT:    vpextrw $6, %xmm3, %r12d
; AVX1-NEXT:    vpextrw $7, %xmm3, %r13d
; AVX1-NEXT:    vpextrw $1, %xmm0, %esi
; AVX1-NEXT:    vpextrw $0, %xmm0, %ebp
; AVX1-NEXT:    vpextrw $1, %xmm1, %edi
; AVX1-NEXT:    addq %rsi, %rdi
; AVX1-NEXT:    vpextrw $0, %xmm1, %esi
; AVX1-NEXT:    addq %rbp, %rsi
; AVX1-NEXT:    vpextrw $7, %xmm2, %ebp
; AVX1-NEXT:    leaq -1(%r13,%rbp), %r13
; AVX1-NEXT:    movq %r13, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX1-NEXT:    vpextrw $6, %xmm2, %r13d
; AVX1-NEXT:    leaq -1(%r12,%r13), %rbp
; AVX1-NEXT:    vpextrw $5, %xmm2, %r12d
; AVX1-NEXT:    leaq -1(%r15,%r12), %r13
; AVX1-NEXT:    vpextrw $4, %xmm2, %r15d
; AVX1-NEXT:    leaq -1(%r14,%r15), %r12
; AVX1-NEXT:    vpextrw $3, %xmm2, %r14d
; AVX1-NEXT:    leaq -1(%rbx,%r14), %r15
; AVX1-NEXT:    vpextrw $2, %xmm2, %ebx
; AVX1-NEXT:    leaq -1(%r11,%rbx), %r14
; AVX1-NEXT:    vpextrw $1, %xmm2, %r11d
; AVX1-NEXT:    leaq -1(%r10,%r11), %rbx
; AVX1-NEXT:    vpextrw $0, %xmm2, %r10d
; AVX1-NEXT:    leaq -1(%r9,%r10), %r11
; AVX1-NEXT:    vpextrw $7, %xmm1, %r9d
; AVX1-NEXT:    leaq -1(%rax,%r9), %r10
; AVX1-NEXT:    vpextrw $6, %xmm1, %eax
; AVX1-NEXT:    leaq -1(%r8,%rax), %r9
; AVX1-NEXT:    vpextrw $5, %xmm1, %eax
; AVX1-NEXT:    leaq -1(%rdx,%rax), %r8
...
; AVX1-NEXT:    leaq -1(%rax,%rdx), %rax
; AVX1-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX1-NEXT:    vpextrw $2, %xmm0, %eax
; AVX1-NEXT:    vpextrw $2, %xmm1, %edx
; AVX1-NEXT:    leaq -1(%rax,%rdx), %rdx
...
; AVX1-NEXT:    shldq $63, %rsi, %rcx
; AVX1-NEXT:    shldq $63, %rdi, %rax
...
; AVX1-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rsi # 8-byte Reload
; AVX1-NEXT:    shrq %rsi
; AVX1-NEXT:    vmovq %rsi, %xmm11
; AVX1-NEXT:    vmovq %rax, %xmm12
; AVX1-NEXT:    vmovq %rcx, %xmm13
...
; AVX2-NEXT:    vmovq %xmm8, %rsi
; AVX2-NEXT:    vpextrq $1, %xmm8, %r8
; AVX2-NEXT:    vpextrq $1, %xmm2, %r9
; AVX2-NEXT:    vpextrq $1, %xmm7, %r10
; AVX2-NEXT:    vpextrq $1, %xmm6, %r11
...
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm7 = xmm4[0],zero,xmm4[1],zero,xmm4[2],zero,xmm4[3],zero
...
; AVX2-NEXT:    vpextrq $1, %xmm9, %r15
; AVX2-NEXT:    addq %r8, %r15
...
; AVX2-NEXT:    shldq $63, %r11, %r14
; AVX2-NEXT:    shldq $63, %rbx, %rax
; AVX2-NEXT:    shldq $63, %rbp, %r10
; AVX2-NEXT:    shldq $63, %r15, %rcx
; AVX2-NEXT:    shldq $63, %r12, %rdx
; AVX2-NEXT:    shldq $63, %r13, %rsi
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r11 # 8-byte Reload
; AVX2-NEXT:    shldq $63, %r11, %rdi
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r11 # 8-byte Reload
; AVX2-NEXT:    shldq $63, %r11, %r8
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r11 # 8-byte Reload
; AVX2-NEXT:    shldq $63, %r11, %r9
...
; AVX2-NEXT:    vmovq %rdx, %xmm8
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rdx # 8-byte Reload
; AVX2-NEXT:    shrq %rdx
; AVX2-NEXT:    vmovq %rdx, %xmm9
; AVX2-NEXT:    vmovq %rcx, %xmm10
; AVX2-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rcx # 8-byte Reload
; AVX2-NEXT:    shrq %rcx
; AVX2-NEXT:    vmovq %rcx, %xmm11
; AVX2-NEXT:    vmovq %r10, %xmm12
; AVX2-NEXT:    vmovq %rax, %xmm13
; AVX2-NEXT:    vmovq %r14, %xmm14
...
; AVX512-NEXT:    vpmovzxbw {{.*#+}} ymm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero,mem[4],zero,mem[5],zero,mem[6],zero,mem[7],zero,mem[8],zero,mem[9],zero,mem[10],zero,mem[11],zero,mem[12],zero,mem[13],zero,mem[14],zero,mem[15],zero
...
; AVX512-NEXT:    addq %rax, %rbp
; AVX512-NEXT:    vpextrq $1, %xmm7, %r8
; AVX512-NEXT:    addq %rbx, %r8
; AVX512-NEXT:    vpextrq $1, %xmm3, %rbx
; AVX512-NEXT:    addq %r13, %rbx
; AVX512-NEXT:    vpextrq $1, %xmm2, %rdi
; AVX512-NEXT:    addq %rcx, %rdi
; AVX512-NEXT:    vpextrq $1, %xmm9, %r13
; AVX512-NEXT:    leaq -1(%r12,%r13), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX512-NEXT:    vmovq %xmm9, %r12
; AVX512-NEXT:    leaq -1(%r15,%r12), %r13
; AVX512-NEXT:    vpextrq $1, %xmm5, %r15
; AVX512-NEXT:    leaq -1(%r14,%r15), %r12
; AVX512-NEXT:    vmovq %xmm5, %r14
; AVX512-NEXT:    leaq -1(%r11,%r14), %r15
; AVX512-NEXT:    vmovq %xmm8, %r11
; AVX512-NEXT:    leaq -1(%r10,%r11), %r14
; AVX512-NEXT:    vmovq %xmm7, %r10
; AVX512-NEXT:    leaq -1(%r9,%r10), %r11
; AVX512-NEXT:    vpextrq $1, %xmm6, %r9
; AVX512-NEXT:    leaq -1(%rsi,%r9), %r10
; AVX512-NEXT:    vmovq %xmm6, %rsi
; AVX512-NEXT:    leaq -1(%rdx,%rsi), %r9
; AVX512-NEXT:    vpextrq $1, %xmm4, %rdx
; AVX512-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX512-NEXT:    leaq -1(%rax,%rdx), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX512-NEXT:    vmovq %xmm4, %rcx
; AVX512-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rax # 8-byte Reload
; AVX512-NEXT:    leaq -1(%rax,%rcx), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX512-NEXT:    vmovq %xmm1, %rcx
; AVX512-NEXT:    vmovq %xmm3, %rdx
; AVX512-NEXT:    leaq -1(%rcx,%rdx), %rax
; AVX512-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
...
; AVX512-NEXT:    shldq $63, %rdi, %rsi
; AVX512-NEXT:    shldq $63, %rbx, %rcx
