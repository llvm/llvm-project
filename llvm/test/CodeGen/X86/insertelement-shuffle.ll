...
; X86_AVX256-LABEL: insert_subvector_256:
; X86_AVX256:       # %bb.0:
; X86_AVX256-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; X86_AVX256-NEXT:    vpinsrw $1, {{[0-9]+}}(%esp), %xmm1, %xmm1
; X86_AVX256-NEXT:    vpbroadcastd %xmm1, %xmm1
; X86_AVX256-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5,6,7]
...
;
; X86_AVX512-LABEL: insert_subvector_256:
; X86_AVX512:       # %bb.0:
; X86_AVX512-NEXT:    # kill: def $ymm0 killed $ymm0 def $zmm0
; X86_AVX512-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [0,16,2,3,4,5,6,7]
; X86_AVX512-NEXT:    vmovd {{.*#+}} xmm2 = mem[0],zero,zero,zero
; X86_AVX512-NEXT:    vpinsrw $1, {{[0-9]+}}(%esp), %xmm2, %xmm2
; X86_AVX512-NEXT:    vpermt2ps %zmm2, %zmm1, %zmm0
; X86_AVX512-NEXT:    # kill: def $ymm0 killed $ymm0 killed $zmm0
; X86_AVX512-NEXT:    retl
;
; X64_AVX512-LABEL: insert_subvector_256:
; X64_AVX512:       # %bb.0:
; X64_AVX512-NEXT:    # kill: def $ymm0 killed $ymm0 def $zmm0
; X64_AVX512-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [0,16,2,3,4,5,6,7]
; X64_AVX512-NEXT:    vmovd %edi, %xmm2
; X64_AVX512-NEXT:    vpinsrw $1, %esi, %xmm2, %xmm2
; X64_AVX512-NEXT:    vpermt2ps %zmm2, %zmm1, %zmm0
; X64_AVX512-NEXT:    # kill: def $ymm0 killed $ymm0 killed $zmm0
