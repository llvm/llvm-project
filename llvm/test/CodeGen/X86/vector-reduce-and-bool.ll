...
; SSE4-NEXT:    pmovmskb %xmm0, %eax
; SSE4-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; SSE4-NEXT:    sete %al
; SSE4-NEXT:    ret{{[l|q]}}
;
...
; X86-AVX1-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
...
; X86-AVX2-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
...
; X86-SSE4-NEXT:    pmovmskb %xmm0, %eax
; X86-SSE4-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; X86-SSE4-NEXT:    sete %al
; X86-SSE4-NEXT:    movl %ebp, %esp
; X86-SSE4-NEXT:    popl %ebp
; X86-SSE4-NEXT:    retl
...
; X64-SSE4-NEXT:    pmovmskb %xmm0, %eax
; X64-SSE4-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; X64-SSE4-NEXT:    sete %al
; X64-SSE4-NEXT:    retq
;
...
; X86-SSE-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
...
; X64-SSE-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
...
; SSE4-NEXT:    cmpl $15, %eax
; SSE4-NEXT:    sete %al
; SSE4-NEXT:    ret{{[l|q]}}
;
; X86-AVX1-LABEL: icmp0_v4i64_v4i1:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X86-AVX1-NEXT:    vpor %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vptest %xmm0, %xmm0
; X86-AVX1-NEXT:    sete %al
; X86-AVX1-NEXT:    vzeroupper
; X86-AVX1-NEXT:    retl
;
; X64-AVX1-LABEL: icmp0_v4i64_v4i1:
; X64-AVX1:       # %bb.0:
...
; SSE4-NEXT:    ret{{[l|q]}}
;
; X86-AVX1-LABEL: icmp1_v32i8_v32i1:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X86-AVX1-NEXT:    vpcmpeqd %xmm2, %xmm2, %xmm2
; X86-AVX1-NEXT:    vpand %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vptest %xmm2, %xmm0
; X86-AVX1-NEXT:    setb %al
; X86-AVX1-NEXT:    vzeroupper
; X86-AVX1-NEXT:    retl
;
; X64-AVX1-LABEL: icmp1_v32i8_v32i1:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm1
...
; X86-SSE4-NEXT:    andl $-16, %esp
; X86-SSE4-NEXT:    subl $16, %esp
; X86-SSE4-NEXT:    pcmpeqd %xmm3, %xmm3
; X86-SSE4-NEXT:    pcmpeqq %xmm3, %xmm1
; X86-SSE4-NEXT:    pcmpeqq %xmm3, %xmm0
; X86-SSE4-NEXT:    packssdw %xmm1, %xmm0
; X86-SSE4-NEXT:    pcmpeqq %xmm3, %xmm2
...
; X64-SSE4:       # %bb.0:
; X64-SSE4-NEXT:    pcmpeqd %xmm4, %xmm4
; X64-SSE4-NEXT:    pcmpeqq %xmm4, %xmm3
; X64-SSE4-NEXT:    pcmpeqq %xmm4, %xmm2
; X64-SSE4-NEXT:    packssdw %xmm3, %xmm2
; X64-SSE4-NEXT:    pcmpeqq %xmm4, %xmm1
...
; X86-SSE-LABEL: icmp1_v16i32_v16i1:
; X86-SSE:       # %bb.0:
; X86-SSE-NEXT:    pushl %ebp
; X86-SSE-NEXT:    movl %esp, %ebp
; X86-SSE-NEXT:    andl $-16, %esp
...
; X86-SSE-NEXT:    retl
;
; X64-SSE-LABEL: icmp1_v16i32_v16i1:
; X64-SSE:       # %bb.0:
...
; X86-SSE-LABEL: icmp1_v32i16_v32i1:
; X86-SSE:       # %bb.0:
; X86-SSE-NEXT:    pushl %ebp
; X86-SSE-NEXT:    movl %esp, %ebp
; X86-SSE-NEXT:    andl $-16, %esp
...
; X86-SSE-NEXT:    retl
;
; X64-SSE-LABEL: icmp1_v32i16_v32i1:
; X64-SSE:       # %bb.0:
; X64-SSE-NEXT:    pand %xmm2, %xmm0
; X64-SSE-NEXT:    pand %xmm3, %xmm1
...
; X86-AVX1-NEXT:    vtestps %xmm1, %xmm0
; X86-AVX1-NEXT:    setb %al
...
; X86-AVX2-NEXT:    vtestps %ymm1, %ymm0
...
; X64-AVX2-NEXT:    vtestps %ymm1, %ymm0
...
; X86-AVX1-NEXT:    vpand %xmm2, %xmm3, %xmm2
...
; X86-AVX1-NEXT:    vpand %xmm1, %xmm0, %xmm0
; X86-AVX1-NEXT:    vpand %xmm0, %xmm2, %xmm0
; X86-AVX1-NEXT:    vpmovmskb %xmm0, %eax
; X86-AVX1-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; X86-AVX1-NEXT:    sete %al
; X86-AVX1-NEXT:    movl %ebp, %esp
...
; X64-AVX1-NEXT:    vpand %xmm1, %xmm0, %xmm0
; X64-AVX1-NEXT:    vpand %xmm0, %xmm4, %xmm0
; X64-AVX1-NEXT:    vpmovmskb %xmm0, %eax
; X64-AVX1-NEXT:    cmpl $65535, %eax # imm = 0xFFFF
; X64-AVX1-NEXT:    sete %al
; X64-AVX1-NEXT:    vzeroupper
