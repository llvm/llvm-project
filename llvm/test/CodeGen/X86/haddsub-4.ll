...
; SSE-NEXT:    haddpd %xmm5, %xmm6
; SSE-NEXT:    movapd %xmm0, %xmm5
; SSE-NEXT:    haddpd %xmm4, %xmm5
...
; AVX2-NEXT:    vhaddpd %ymm2, %ymm0, %ymm2
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm1[2,3,0,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm2[2,3,0,1]
; AVX2-NEXT:    retq
