...
define  i32 @perimeter(ptr %tree, i32 %size) nounwind  {
...
bb:		; preds = %entry
	%tmp31 = tail call  i32 @perimeter( ptr null, i32 0 ) nounwind 		; <i32> [#uses=1]
	%tmp40 = tail call  i32 @perimeter( ptr null, i32 0 ) nounwind 		; <i32> [#uses=1]
