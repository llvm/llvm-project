...
; SSE-NEXT:    movaps 96(%rsi), %xmm10
; SSE-NEXT:    movaps 80(%rsi), %xmm11
...
; SSE-NEXT:    unpckhps {{.*#+}} xmm9 = xmm9[2],xmm13[2],xmm9[3],xmm13[3]
...
; SSE-NEXT:    unpcklps {{.*#+}} xmm3 = xmm3[0],xmm12[0],xmm3[1],xmm12[1]
...
; SSE-NEXT:    movaps %xmm0, %xmm8
; SSE-NEXT:    unpckhps {{.*#+}} xmm8 = xmm8[2],xmm10[2],xmm8[3],xmm10[3]
...
; SSE-NEXT:    movaps %xmm11, 208(%rdx)
; SSE-NEXT:    movaps %xmm4, 160(%rdx)
; SSE-NEXT:    movaps %xmm12, 176(%rdx)
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm9 = xmm6[2],xmm4[2],xmm6[3],xmm4[3]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm9 = xmm7[2],xmm6[2],xmm7[3],xmm6[3]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm9[2],xmm7[2],xmm9[3],xmm7[3]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm7 = xmm9[0],xmm7[0],xmm9[1],xmm7[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm7, %ymm7
; AVX1-ONLY-NEXT:    vmovaps 160(%rsi), %xmm9
; AVX1-ONLY-NEXT:    vmovaps 160(%rdi), %xmm12
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm13 = xmm12[2],xmm9[2],xmm12[3],xmm9[3]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm9 = xmm12[0],xmm9[0],xmm12[1],xmm9[1]
...
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm14 = xmm10[2],xmm8[2],xmm10[3],xmm8[3]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm8 = xmm10[0],xmm8[0],xmm10[1],xmm8[1]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm14, %ymm8, %ymm8
; AVX1-ONLY-NEXT:    vmovaps 112(%rsi), %xmm10
; AVX1-ONLY-NEXT:    vmovaps 112(%rdi), %xmm14
; AVX1-ONLY-NEXT:    vunpckhps {{.*#+}} xmm15 = xmm14[2],xmm10[2],xmm14[3],xmm10[3]
; AVX1-ONLY-NEXT:    vunpcklps {{.*#+}} xmm10 = xmm14[0],xmm10[0],xmm14[1],xmm10[1]
...
; AVX1-ONLY-NEXT:    vmovaps %ymm10, 224(%rdx)
...
; AVX1-ONLY-NEXT:    vmovaps %ymm9, 320(%rdx)
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm0[2],ymm2[2],ymm0[3],ymm2[3],ymm0[6],ymm2[6],ymm0[7],ymm2[7]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm2 = ymm0[0],ymm2[0],ymm0[1],ymm2[1],ymm0[4],ymm2[4],ymm0[5],ymm2[5]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm2[2,3],ymm15[2,3]
; AVX2-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm2[0,1],ymm15[0,1]
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm3[2],ymm5[2],ymm3[3],ymm5[3],ymm3[6],ymm5[6],ymm3[7],ymm5[7]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm5 = ymm3[0],ymm5[0],ymm3[1],ymm5[1],ymm3[4],ymm5[4],ymm3[5],ymm5[5]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm5[2,3],ymm15[2,3]
...
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm4[2],ymm10[2],ymm4[3],ymm10[3],ymm4[6],ymm10[6],ymm4[7],ymm10[7]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm4 = ymm4[0],ymm10[0],ymm4[1],ymm10[1],ymm4[4],ymm10[4],ymm4[5],ymm10[5]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm4[2,3],ymm15[2,3]
; AVX2-ONLY-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm4[0,1],ymm15[0,1]
; AVX2-ONLY-NEXT:    vmovaps 224(%rsi), %ymm15
; AVX2-ONLY-NEXT:    vunpckhps {{.*#+}} ymm0 = ymm1[2],ymm15[2],ymm1[3],ymm15[3],ymm1[6],ymm15[6],ymm1[7],ymm15[7]
; AVX2-ONLY-NEXT:    vunpcklps {{.*#+}} ymm1 = ymm1[0],ymm15[0],ymm1[1],ymm15[1],ymm1[4],ymm15[4],ymm1[5],ymm15[5]
...
; AVX2-ONLY-NEXT:    vmovaps %ymm15, 480(%rdx)
; AVX2-ONLY-NEXT:    vmovaps %ymm4, 384(%rdx)
