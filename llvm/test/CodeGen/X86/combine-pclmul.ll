...
; CHECK:       # %bb.0:
; CHECK-NEXT:    movl $1, %eax
; CHECK-NEXT:    vpinsrq $1, %rax, %xmm0, %xmm2
; CHECK-NEXT:    vpblendd {{.*#+}} ymm0 = ymm2[0,1,2,3],ymm0[4,5,6,7]
; CHECK-NEXT:    vpinsrq $1, %rax, %xmm1, %xmm2
; CHECK-NEXT:    vpblendd {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5,6,7]
; CHECK-NEXT:    vpbroadcastq {{.*#+}} ymm2 = [1,1,1,1]
...
; CHECK-NEXT:    vpinsrq $1, %rax, %xmm1, %xmm2
; CHECK-NEXT:    vpbroadcastq {{.*#+}} zmm3 = [1,1,1,1,1,1,1,1]
; CHECK-NEXT:    vinserti32x4 $0, %xmm2, %zmm1, %zmm1
; CHECK-NEXT:    vmovdqa64 {{.*#+}} zmm2 = [0,1,2,11,4,13,6,15]
; CHECK-NEXT:    vpermt2q %zmm3, %zmm2, %zmm1
; CHECK-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
