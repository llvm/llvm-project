...
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB1_4: # =>This Inner Loop Header: Depth=1
...
; AVX-NEXT:    je .LBB1_8
; AVX-NEXT:  # %bb.6: # %.preheader
; AVX-NEXT:    shlq $4, %rcx
; AVX-NEXT:    addq %rcx, %rsi
; AVX-NEXT:    shll $4, %eax
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB1_7: # =>This Inner Loop Header: Depth=1
...
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB2_4: # =>This Inner Loop Header: Depth=1
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    testl %edi, %edi
; AVX512-NEXT:    jle .LBB2_7
; AVX512-NEXT:  # %bb.1:
; AVX512-NEXT:    movl %edi, %eax
; AVX512-NEXT:    cmpl $1, %edi
; AVX512-NEXT:    jne .LBB2_3
; AVX512-NEXT:  # %bb.2:
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    jmp .LBB2_5
; AVX512-NEXT:  .LBB2_3:
...
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    .p2align 4
; AVX512-NEXT:  .LBB2_4: # =>This Inner Loop Header: Depth=1
...
; AVX512-NEXT:    jne .LBB2_4
; AVX512-NEXT:  .LBB2_5:
; AVX512-NEXT:    testb $1, %al
; AVX512-NEXT:    je .LBB2_7
; AVX512-NEXT:  # %bb.6:
; AVX512-NEXT:    shlq $4, %rcx
...
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB4_4: # =>This Inner Loop Header: Depth=1
...
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB4_7: # =>This Inner Loop Header: Depth=1
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    testl %edi, %edi
; AVX512-NEXT:    jle .LBB4_8
; AVX512-NEXT:  # %bb.1:
; AVX512-NEXT:    movl %edi, %edx
; AVX512-NEXT:    movl %edx, %eax
; AVX512-NEXT:    andl $3, %eax
; AVX512-NEXT:    cmpl $4, %edi
; AVX512-NEXT:    jae .LBB4_3
; AVX512-NEXT:  # %bb.2:
; AVX512-NEXT:    xorl %ecx, %ecx
...
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    .p2align 4
; AVX512-NEXT:  .LBB4_4: # =>This Inner Loop Header: Depth=1
...
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    .p2align 4
; AVX512-NEXT:  .LBB4_7: # =>This Inner Loop Header: Depth=1
...
; AVX-NEXT:    xorl %ecx, %ecx
; AVX-NEXT:    .p2align 4
; AVX-NEXT:  .LBB5_4: # =>This Inner Loop Header: Depth=1
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    testl %edi, %edi
; AVX512-NEXT:    jle .LBB5_7
; AVX512-NEXT:  # %bb.1:
; AVX512-NEXT:    movl %edi, %eax
; AVX512-NEXT:    cmpl $1, %edi
; AVX512-NEXT:    jne .LBB5_3
; AVX512-NEXT:  # %bb.2:
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    jmp .LBB5_5
; AVX512-NEXT:  .LBB5_3:
; AVX512-NEXT:    movl %eax, %edi
; AVX512-NEXT:    andl $-2, %edi
...
; AVX512-NEXT:    xorl %ecx, %ecx
; AVX512-NEXT:    .p2align 4
; AVX512-NEXT:  .LBB5_4: # =>This Inner Loop Header: Depth=1
...
; AVX512-NEXT:    cmpq %rcx, %rdi
; AVX512-NEXT:    jne .LBB5_4
; AVX512-NEXT:  .LBB5_5:
; AVX512-NEXT:    testb $1, %al
; AVX512-NEXT:    je .LBB5_7
; AVX512-NEXT:  # %bb.6:
; AVX512-NEXT:    shlq $5, %rcx
