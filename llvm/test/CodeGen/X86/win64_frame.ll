...
; RUN: llc < %s -mtriple=x86_64-uefi              | FileCheck --check-prefixes=CHECK,UEFI %s
; RUN: llc < %s -mtriple=x86_64-uefi -mattr=+sahf | FileCheck --check-prefixes=CHECK,UEFI %s
...
; WIN64-NEXT:    subq $336, %rsp # imm = 0x150
; WIN64-NEXT:    .seh_stackalloc 336
; WIN64-NEXT:    leaq {{[0-9]+}}(%rsp), %rbp
; WIN64-NEXT:    .seh_setframe %rbp, 128
; WIN64-NEXT:    .seh_endprologue
; WIN64-NEXT:    leaq -92(%rbp), %rcx
; WIN64-NEXT:    callq external
; WIN64-NEXT:    nop
; WIN64-NEXT:    .seh_startepilogue
; WIN64-NEXT:    addq $336, %rsp # imm = 0x150
; WIN64-NEXT:    popq %rbp
...
; UEFI:       # %bb.0:
; UEFI-NEXT:    pushq %rbp
; UEFI-NEXT:    .seh_pushreg %rbp
; UEFI-NEXT:    subq $336, %rsp # imm = 0x150
; UEFI-NEXT:    .seh_stackalloc 336
; UEFI-NEXT:    leaq {{[0-9]+}}(%rsp), %rbp
; UEFI-NEXT:    .seh_setframe %rbp, 128
; UEFI-NEXT:    .seh_endprologue
; UEFI-NEXT:    leaq -92(%rbp), %rcx
; UEFI-NEXT:    callq external
; UEFI-NEXT:    .seh_startepilogue
; UEFI-NEXT:    addq $336, %rsp # imm = 0x150
; UEFI-NEXT:    popq %rbp
; UEFI-NEXT:    .seh_endepilogue
; UEFI-NEXT:    retq
; UEFI-NEXT:    .seh_endproc
  %a = alloca [300 x i8]
