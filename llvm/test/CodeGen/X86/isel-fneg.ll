...
; GISEL-X86-NEXT:    retl
;
; FASTISEL-SSE-X86-LABEL: fneg_f32:
; FASTISEL-SSE-X86:       # %bb.0:
; FASTISEL-SSE-X86-NEXT:    pushl %eax
; FASTISEL-SSE-X86-NEXT:    movss {{.*#+}} xmm0 = mem[0],zero,zero,zero
; FASTISEL-SSE-X86-NEXT:    xorps {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0
; FASTISEL-SSE-X86-NEXT:    movss %xmm0, (%esp)
; FASTISEL-SSE-X86-NEXT:    flds (%esp)
; FASTISEL-SSE-X86-NEXT:    popl %eax
; FASTISEL-SSE-X86-NEXT:    retl
;
; SDAG-SSE-X86-LABEL: fneg_f32:
; SDAG-SSE-X86:       # %bb.0:
; SDAG-SSE-X86-NEXT:    pushl %eax
; SDAG-SSE-X86-NEXT:    movss {{.*#+}} xmm0 = mem[0],zero,zero,zero
; SDAG-SSE-X86-NEXT:    xorps {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0
; SDAG-SSE-X86-NEXT:    movss %xmm0, (%esp)
; SDAG-SSE-X86-NEXT:    flds (%esp)
; SDAG-SSE-X86-NEXT:    popl %eax
