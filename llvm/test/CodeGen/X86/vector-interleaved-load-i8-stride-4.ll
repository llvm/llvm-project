...
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm6[3,1,2,3]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm3[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm4[0,1,1,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm11[1,3,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,7,6,5,4]
...
; SSE-NEXT:    movdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm1[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm4[1,3,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,7,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm1[1,0,3,2,4,5,6,7]
...
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm10 = xmm0[3,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[3,1,2,3,4,5,6,7]
...
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm0[1,3,2,3,4,5,6,7]
; SSE-NEXT:    movdqa %xmm15, %xmm0
; SSE-NEXT:    punpcklbw {{.*#+}} xmm0 = xmm0[0],xmm2[0],xmm0[1],xmm2[1],xmm0[2],xmm2[2],xmm0[3],xmm2[3],xmm0[4],xmm2[4],xmm0[5],xmm2[5],xmm0[6],xmm2[6],xmm0[7],xmm2[7]
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE-NEXT:    punpcklbw {{.*#+}} xmm13 = xmm13[0],xmm2[0],xmm13[1],xmm2[1],xmm13[2],xmm2[2],xmm13[3],xmm2[3],xmm13[4],xmm2[4],xmm13[5],xmm2[5],xmm13[6],xmm2[6],xmm13[7],xmm2[7]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm13[0,2,2,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm7[1,0,3,2,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,7,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm4[1,0,3,2,4,5,6,7]
; SSE-NEXT:    packuswb %xmm0, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,3],xmm11[0,3]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,1,3,1,4,5,6,7]
...
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,1,3,1,4,5,6,7]
; SSE-NEXT:    pshufd $231, (%rsp), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[0,1,3,1,4,5,6,7]
; SSE-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm0[0],xmm4[1],xmm0[1]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[3,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm13[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm6[3,1,2,3,4,5,6,7]
; SSE-NEXT:    punpckldq {{.*#+}} xmm6 = xmm6[0],xmm0[0],xmm6[1],xmm0[1]
; SSE-NEXT:    packuswb %xmm4, %xmm6
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[0,3],xmm11[0,3]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; SSE-NEXT:    # xmm0 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,1,3,1,4,5,6,7]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Folded Reload
...
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm9 # 16-byte Folded Reload
; SSE-NEXT:    # xmm9 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm9[0,1,3,1,4,5,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,3],xmm11[0,3]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Folded Reload
; SSE-NEXT:    # xmm4 = mem[3,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[0,1,3,1,4,5,6,7]
; SSE-NEXT:    pshufd $231, {{[-0-9]+}}(%r{{[sb]}}p), %xmm11 # 16-byte Folded Reload
...
; AVX1-ONLY-NEXT:    vmovdqa 96(%rdi), %xmm2
; AVX1-ONLY-NEXT:    vpshufb %xmm1, %xmm2, %xmm3
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufb %xmm2, %xmm0, %xmm7
; AVX1-ONLY-NEXT:    vpunpckldq {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX1-ONLY-NEXT:    vpblendw {{.*#+}} xmm3 = xmm6[0,1,2,3],xmm3[4,5,6,7]
...
; AVX2-ONLY-NEXT:    vpbroadcastd {{.*#+}} xmm11 = [0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12]
; AVX2-ONLY-NEXT:    vpshufb %xmm11, %xmm5, %xmm8
; AVX2-ONLY-NEXT:    vpshufb %xmm11, %xmm4, %xmm9
...
; AVX2-ONLY-NEXT:    vpermd %ymm10, %ymm2, %ymm10
...
; AVX2-ONLY-NEXT:    vpshufb %xmm3, %xmm8, %xmm10
...
; AVX2-ONLY-NEXT:    vmovdqa 144(%rdi), %xmm10
; AVX2-ONLY-NEXT:    vpshufb %xmm11, %xmm10, %xmm14
; AVX2-ONLY-NEXT:    vmovdqa 128(%rdi), %xmm12
; AVX2-ONLY-NEXT:    vpshufb %xmm11, %xmm12, %xmm11
; AVX2-ONLY-NEXT:    vpunpckldq {{.*#+}} xmm14 = xmm11[0],xmm14[0],xmm11[1],xmm14[1]
...
; AVX2-ONLY-NEXT:    vpshufb %xmm15, %xmm10, %xmm3
...
; AVX2-ONLY-NEXT:    vpshufb %ymm1, %ymm11, %ymm3
...
; AVX2-ONLY-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; AVX2-ONLY-NEXT:    vpshufb %xmm3, %xmm10, %xmm1
; AVX2-ONLY-NEXT:    vpshufb %xmm3, %xmm12, %xmm3
; AVX2-ONLY-NEXT:    vpunpckldq {{.*#+}} xmm1 = xmm3[0],xmm1[0],xmm3[1],xmm1[1]
; AVX2-ONLY-NEXT:    vpblendd {{.*#+}} xmm0 = xmm1[0,1],xmm0[2,3]
; AVX2-ONLY-NEXT:    vpshufb %ymm4, %ymm11, %ymm1
; AVX2-ONLY-NEXT:    vpermd %ymm1, %ymm2, %ymm1
; AVX2-ONLY-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Reload
; AVX2-ONLY-NEXT:    vpshufb %ymm4, %ymm14, %ymm3
; AVX2-ONLY-NEXT:    vpermd %ymm3, %ymm2, %ymm3
...
; AVX2-ONLY-NEXT:    vpshufb %xmm4, %xmm10, %xmm6
; AVX2-ONLY-NEXT:    vpshufb %xmm4, %xmm12, %xmm4
; AVX2-ONLY-NEXT:    vpunpckldq {{.*#+}} xmm4 = xmm4[0],xmm6[0],xmm4[1],xmm6[1]
; AVX2-ONLY-NEXT:    vpblendd {{.*#+}} xmm0 = xmm4[0,1],xmm0[2,3]
; AVX2-ONLY-NEXT:    vpshufb %ymm5, %ymm11, %ymm4
; AVX2-ONLY-NEXT:    vpshufb %ymm5, %ymm14, %ymm5
; AVX2-ONLY-NEXT:    vpermd %ymm4, %ymm2, %ymm4
...
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} ymm6 = [0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12,0,4,8,12]
; AVX512F-NEXT:    vmovdqa 224(%rdi), %ymm0
; AVX512F-NEXT:    vpshufb %ymm6, %ymm0, %ymm2
; AVX512F-NEXT:    vmovdqa 192(%rdi), %ymm1
; AVX512F-NEXT:    vpshufb %ymm6, %ymm1, %ymm3
; AVX512F-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,4,0,4,0,4,8,12]
; AVX512F-NEXT:    vpermt2d %ymm2, %ymm7, %ymm3
; AVX512F-NEXT:    vpmovdb %zmm5, %xmm2
; AVX512F-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm3[4,5,6,7]
; AVX512F-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm8
; AVX512F-NEXT:    vmovdqa 96(%rdi), %ymm2
; AVX512F-NEXT:    vpshufb %ymm6, %ymm2, %ymm9
; AVX512F-NEXT:    vmovdqa 64(%rdi), %ymm3
; AVX512F-NEXT:    vpshufb %ymm6, %ymm3, %ymm6
; AVX512F-NEXT:    vpermt2d %ymm9, %ymm7, %ymm6
; AVX512F-NEXT:    vpmovdb %zmm4, %xmm9
; AVX512F-NEXT:    vpblendd {{.*#+}} ymm6 = ymm9[0,1,2,3],ymm6[4,5,6,7]
; AVX512F-NEXT:    vshufi64x2 {{.*#+}} zmm6 = zmm6[0,1,2,3],zmm8[4,5,6,7]
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} ymm8 = [1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13,1,5,9,13]
; AVX512F-NEXT:    vpshufb %ymm8, %ymm0, %ymm9
; AVX512F-NEXT:    vpshufb %ymm8, %ymm1, %ymm10
; AVX512F-NEXT:    vpermt2d %ymm9, %ymm7, %ymm10
; AVX512F-NEXT:    vpsrld $8, %zmm5, %zmm9
...
; AVX512F-NEXT:    vpshufb %ymm8, %ymm2, %ymm10
; AVX512F-NEXT:    vpshufb %ymm8, %ymm3, %ymm8
; AVX512F-NEXT:    vpermt2d %ymm10, %ymm7, %ymm8
; AVX512F-NEXT:    vpsrld $8, %zmm4, %zmm10
...
; AVX512F-NEXT:    vpshufb %ymm9, %ymm1, %ymm11
; AVX512F-NEXT:    vpermt2d %ymm10, %ymm7, %ymm11
; AVX512F-NEXT:    vpsrld $16, %zmm5, %zmm10
; AVX512F-NEXT:    vpmovdb %zmm10, %xmm10
; AVX512F-NEXT:    vpblendd {{.*#+}} ymm10 = ymm10[0,1,2,3],ymm11[4,5,6,7]
; AVX512F-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm10
; AVX512F-NEXT:    vpshufb %ymm9, %ymm2, %ymm11
; AVX512F-NEXT:    vpshufb %ymm9, %ymm3, %ymm9
; AVX512F-NEXT:    vpermt2d %ymm11, %ymm7, %ymm9
; AVX512F-NEXT:    vpsrld $16, %zmm4, %zmm11
...
; AVX512F-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512F-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX512F-NEXT:    vpermt2d %ymm0, %ymm7, %ymm1
; AVX512F-NEXT:    vpsrld $24, %zmm5, %zmm0
; AVX512F-NEXT:    vpmovdb %zmm0, %xmm0
; AVX512F-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm1[4,5,6,7]
; AVX512F-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm0
; AVX512F-NEXT:    vpshufb %ymm10, %ymm2, %ymm1
; AVX512F-NEXT:    vpshufb %ymm10, %ymm3, %ymm2
; AVX512F-NEXT:    vpermt2d %ymm1, %ymm7, %ymm2
; AVX512F-NEXT:    vpsrld $24, %zmm4, %zmm1
; AVX512F-NEXT:    vpmovdb %zmm1, %xmm1
