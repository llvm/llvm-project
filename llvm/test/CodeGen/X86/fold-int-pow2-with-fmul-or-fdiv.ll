...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow2_4xfloat:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1091567616,1091567616,1091567616,1091567616]
; CHECK-AVX-NEXT:    vpaddd %xmm1, %xmm0, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow2_4xfloat:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1091567616,1091567616,1091567616,1091567616]
; CHECK-AVX512F-NEXT:    vpaddd %xmm1, %xmm0, %xmm0
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow2_ldexp_4xfloat:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    subq $40, %rsp
; CHECK-AVX512F-NEXT:    .cfi_def_cfa_offset 48
; CHECK-AVX512F-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX512F-NEXT:    vextractps $1, %xmm0, %edi
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    callq ldexpf@PLT
; CHECK-AVX512F-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-AVX512F-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-AVX512F-NEXT:    vmovd %xmm0, %edi
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    callq ldexpf@PLT
; CHECK-AVX512F-NEXT:    vinsertps $16, (%rsp), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX512F-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[2,3]
; CHECK-AVX512F-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-AVX512F-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-AVX512F-NEXT:    vextractps $2, %xmm0, %edi
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    callq ldexpf@PLT
; CHECK-AVX512F-NEXT:    vmovaps (%rsp), %xmm1 # 16-byte Reload
; CHECK-AVX512F-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1],xmm0[0],xmm1[3]
; CHECK-AVX512F-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-AVX512F-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-AVX512F-NEXT:    vextractps $3, %xmm0, %edi
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    callq ldexpf@PLT
; CHECK-AVX512F-NEXT:    vmovaps (%rsp), %xmm1 # 16-byte Reload
; CHECK-AVX512F-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[0]
; CHECK-AVX512F-NEXT:    addq $40, %rsp
; CHECK-AVX512F-NEXT:    .cfi_def_cfa_offset 8
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow2_ldexp_4xfloat:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    subq $40, %rsp
; CHECK-SKX-NEXT:    .cfi_def_cfa_offset 48
; CHECK-SKX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-SKX-NEXT:    vextractps $1, %xmm0, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-SKX-NEXT:    vmovd %xmm0, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vinsertps $16, (%rsp), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[2,3]
; CHECK-SKX-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-SKX-NEXT:    vextractps $2, %xmm0, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vmovaps (%rsp), %xmm1 # 16-byte Reload
; CHECK-SKX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1],xmm0[0],xmm1[3]
; CHECK-SKX-NEXT:    vmovaps %xmm0, (%rsp) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; CHECK-SKX-NEXT:    vextractps $3, %xmm0, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vmovaps (%rsp), %xmm1 # 16-byte Reload
; CHECK-SKX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[0]
; CHECK-SKX-NEXT:    addq $40, %rsp
; CHECK-SKX-NEXT:    .cfi_def_cfa_offset 8
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow2_4xfloat:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1091567616,1091567616,1091567616,1091567616]
; CHECK-AVX512F-NEXT:    vpsubd %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow2_4xfloat:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1091567616,1091567616,1091567616,1091567616]
; CHECK-SKX-NEXT:    vpsubd %xmm0, %xmm1, %xmm0
; CHECK-SKX-NEXT:    retq
  %p2 = shl <4 x i32> <i32 1, i32 1, i32 1, i32 1>, %i
  %p2_f = uitofp <4 x i32> %p2 to <4 x float>
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow2_8xhalf:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    subq $120, %rsp
; CHECK-AVX-NEXT:    .cfi_def_cfa_offset 128
; CHECK-AVX-NEXT:    vpmovzxwd {{.*#+}} ymm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; CHECK-AVX-NEXT:    vpbroadcastd {{.*#+}} ymm1 = [1,1,1,1,1,1,1,1]
; CHECK-AVX-NEXT:    vpsllvd %ymm0, %ymm1, %ymm0
; CHECK-AVX-NEXT:    vpshufb {{.*#+}} ymm0 = ymm0[0,1,4,5,8,9,12,13,u,u,u,u,u,u,u,u,16,17,20,21,24,25,28,29,u,u,u,u,u,u,u,u]
; CHECK-AVX-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,2,2,3]
; CHECK-AVX-NEXT:    vpmovzxwd {{.*#+}} ymm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; CHECK-AVX-NEXT:    vcvtdq2ps %ymm0, %ymm0
; CHECK-AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; CHECK-AVX-NEXT:    vmovshdup {{.*#+}} xmm0 = xmm0[1,1,3,3]
; CHECK-AVX-NEXT:    vzeroupper
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; CHECK-AVX-NEXT:    # kill: def $xmm0 killed $xmm0 killed $ymm0
; CHECK-AVX-NEXT:    vzeroupper
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = mem[1,0]
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-AVX-NEXT:    vpermilps $255, {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = mem[3,3,3,3]
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; CHECK-AVX-NEXT:    vextractf128 $1, %ymm0, %xmm0
; CHECK-AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovshdup {{.*#+}} xmm0 = xmm0[1,1,3,3]
; CHECK-AVX-NEXT:    vzeroupper
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
...
; CHECK-AVX-NEXT:    # xmm0 = mem[3,3,3,3]
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
; CHECK-AVX-NEXT:    vmulss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 4-byte Reload
; CHECK-AVX-NEXT:    # xmm0 = mem[0],zero,zero,zero
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
; CHECK-AVX-NEXT:    vmulss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vpunpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; CHECK-AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 4-byte Reload
; CHECK-AVX-NEXT:    # xmm0 = mem[0],zero,zero,zero
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
; CHECK-AVX-NEXT:    vmulss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
...
; CHECK-AVX-NEXT:    vmulss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; CHECK-AVX-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3]
; CHECK-AVX-NEXT:    vpunpckldq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovss {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 4-byte Reload
; CHECK-AVX-NEXT:    # xmm0 = mem[0],zero,zero,zero
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
...
; CHECK-AVX-NEXT:    vpunpckldq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-AVX-NEXT:    vpunpcklqdq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = xmm0[0],mem[0]
; CHECK-AVX-NEXT:    addq $120, %rsp
; CHECK-AVX-NEXT:    .cfi_def_cfa_offset 8
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow2_8xhalf:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpmovzxwd {{.*#+}} ymm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} ymm1 = [1,1,1,1,1,1,1,1]
; CHECK-AVX512F-NEXT:    vpsllvd %ymm0, %ymm1, %ymm0
; CHECK-AVX512F-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; CHECK-AVX512F-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7],ymm0[8],ymm1[9],ymm0[10],ymm1[11],ymm0[12],ymm1[13],ymm0[14],ymm1[15]
; CHECK-AVX512F-NEXT:    vcvtdq2ps %ymm0, %ymm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %ymm0, %xmm0
; CHECK-AVX512F-NEXT:    vcvtph2ps %xmm0, %ymm0
; CHECK-AVX512F-NEXT:    vbroadcastss {{.*#+}} ymm1 = [8.192E+3,8.192E+3,8.192E+3,8.192E+3,8.192E+3,8.192E+3,8.192E+3,8.192E+3]
; CHECK-AVX512F-NEXT:    vmulps %ymm1, %ymm0, %ymm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %ymm0, %xmm0
...
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    subq $72, %rsp
; CHECK-AVX-NEXT:    .cfi_def_cfa_offset 80
; CHECK-AVX-NEXT:    vmovdqa %xmm0, (%rsp) # 16-byte Spill
; CHECK-AVX-NEXT:    vpextrw $7, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $6, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovd {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vpunpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-AVX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; CHECK-AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $5, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $4, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovd {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
...
; CHECK-AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $3, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $2, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovd {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
...
; CHECK-AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-AVX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-AVX-NEXT:    vpextrw $1, %xmm0, %eax
; CHECK-AVX-NEXT:    movswl %ax, %edi
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    callq ldexpf@PLT
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
...
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    subq $72, %rsp
; CHECK-SKX-NEXT:    .cfi_def_cfa_offset 80
; CHECK-SKX-NEXT:    vmovdqa %xmm0, (%rsp) # 16-byte Spill
; CHECK-SKX-NEXT:    vpextrw $7, %xmm0, %eax
; CHECK-SKX-NEXT:    movswl %ax, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
; CHECK-SKX-NEXT:    vpextrw $6, %xmm0, %eax
; CHECK-SKX-NEXT:    movswl %ax, %edi
; CHECK-SKX-NEXT:    vmovss {{.*#+}} xmm0 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-SKX-NEXT:    callq ldexpf@PLT
; CHECK-SKX-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpunpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; CHECK-SKX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
...
; CHECK-SKX-NEXT:    vpunpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3]
; CHECK-SKX-NEXT:    vpunpckldq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-SKX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-SKX-NEXT:    vmovdqa (%rsp), %xmm0 # 16-byte Reload
...
; CHECK-SKX-NEXT:    vpunpckldq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-SKX-NEXT:    vpunpcklqdq {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm0 # 16-byte Folded Reload
; CHECK-SKX-NEXT:    # xmm0 = xmm0[0],mem[0]
; CHECK-SKX-NEXT:    addq $72, %rsp
; CHECK-SKX-NEXT:    .cfi_def_cfa_offset 8
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow2_8xhalf:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpsllw $10, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastw {{.*#+}} xmm1 = [28672,28672,28672,28672,28672,28672,28672,28672]
; CHECK-AVX512F-NEXT:    vpsubw %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    shlq $52, %rax
; CHECK-AVX512F-NEXT:    movabsq $4621256167635550208, %rcx # imm = 0x4022000000000000
; CHECK-AVX512F-NEXT:    addq %rax, %rcx
; CHECK-AVX512F-NEXT:    vmovq %rcx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    shlq $52, %rax
; CHECK-SKX-NEXT:    movabsq $4621256167635550208, %rcx # imm = 0x4022000000000000
; CHECK-SKX-NEXT:    addq %rax, %rcx
; CHECK-SKX-NEXT:    vmovq %rcx, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    incl %eax
; CHECK-AVX512F-NEXT:    shlq $52, %rax
; CHECK-AVX512F-NEXT:    movabsq $-4602115869219225600, %rcx # imm = 0xC022000000000000
; CHECK-AVX512F-NEXT:    addq %rax, %rcx
; CHECK-AVX512F-NEXT:    vmovq %rcx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt2:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    incl %eax
; CHECK-SKX-NEXT:    shlq $52, %rax
; CHECK-SKX-NEXT:    movabsq $-4602115869219225600, %rcx # imm = 0xC022000000000000
; CHECK-SKX-NEXT:    addq %rax, %rcx
; CHECK-SKX-NEXT:    vmovq %rcx, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt3:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    shlq $52, %rax
; CHECK-AVX512F-NEXT:    movabsq $-4602115869219225600, %rcx # imm = 0xC022000000000000
...
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt3:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    shlq $52, %rax
; CHECK-SKX-NEXT:    movabsq $-4602115869219225600, %rcx # imm = 0xC022000000000000
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    leal 1(%rax), %ecx
; CHECK-AVX512F-NEXT:    testb $1, %sil
; CHECK-AVX512F-NEXT:    cmovnel %eax, %ecx
; CHECK-AVX512F-NEXT:    shll $23, %ecx
; CHECK-AVX512F-NEXT:    addl $1091567616, %ecx # imm = 0x41100000
; CHECK-AVX512F-NEXT:    vmovd %ecx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_select:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    leal 1(%rax), %ecx
; CHECK-SKX-NEXT:    testb $1, %sil
; CHECK-SKX-NEXT:    cmovnel %eax, %ecx
; CHECK-SKX-NEXT:    shll $23, %ecx
; CHECK-SKX-NEXT:    addl $1091567616, %ecx # imm = 0x41100000
; CHECK-SKX-NEXT:    vmovd %ecx, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_fly_pow_mul_min_pow2:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    addl $3, %eax
; CHECK-AVX512F-NEXT:    cmpl $13, %eax
; CHECK-AVX512F-NEXT:    movl $13, %ecx
; CHECK-AVX512F-NEXT:    cmovbl %eax, %ecx
; CHECK-AVX512F-NEXT:    shll $23, %ecx
; CHECK-AVX512F-NEXT:    addl $1091567616, %ecx # imm = 0x41100000
; CHECK-AVX512F-NEXT:    vmovd %ecx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_fly_pow_mul_min_pow2:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    addl $3, %eax
; CHECK-SKX-NEXT:    cmpl $13, %eax
; CHECK-SKX-NEXT:    movl $13, %ecx
; CHECK-SKX-NEXT:    cmovbl %eax, %ecx
; CHECK-SKX-NEXT:    shll $23, %ecx
; CHECK-SKX-NEXT:    addl $1091567616, %ecx # imm = 0x41100000
; CHECK-SKX-NEXT:    vmovd %ecx, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_mul_max_pow2:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    leaq 1(%rax), %rcx
; CHECK-AVX512F-NEXT:    cmpq %rcx, %rax
; CHECK-AVX512F-NEXT:    cmovaq %rax, %rcx
; CHECK-AVX512F-NEXT:    shlq $52, %rcx
; CHECK-AVX512F-NEXT:    movabsq $4613937818241073152, %rax # imm = 0x4008000000000000
; CHECK-AVX512F-NEXT:    orq %rcx, %rax
; CHECK-AVX512F-NEXT:    vmovq %rax, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_mul_max_pow2:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    leaq 1(%rax), %rcx
; CHECK-SKX-NEXT:    cmpq %rcx, %rax
; CHECK-SKX-NEXT:    cmovaq %rax, %rcx
; CHECK-SKX-NEXT:    shlq $52, %rcx
; CHECK-SKX-NEXT:    movabsq $4613937818241073152, %rax # imm = 0x4008000000000000
; CHECK-SKX-NEXT:    orq %rcx, %rax
; CHECK-SKX-NEXT:    vmovq %rax, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_fail_maybe_non_pow2:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    movq %rsi, %rcx
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX-NEXT:    shlq %cl, %rdi
; CHECK-AVX-NEXT:    vmovq %rdi, %xmm0
; CHECK-AVX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-AVX-NEXT:    vsubpd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]
; CHECK-AVX-NEXT:    vaddsd %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_fail_maybe_non_pow2:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movq %rsi, %rcx
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX512F-NEXT:    shlq %cl, %rdi
; CHECK-AVX512F-NEXT:    vcvtusi2sd %rdi, %xmm15, %xmm0
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_vec_fail_expensive_cast:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    vpmovsxbq {{.*#+}} xmm1 = [2,2]
; CHECK-AVX-NEXT:    vpsllvq %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    vpextrq $1, %xmm0, %rax
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm1
; CHECK-AVX-NEXT:    vmovq %xmm0, %rax
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],zero,zero
; CHECK-AVX-NEXT:    vbroadcastss {{.*#+}} xmm1 = [1.5E+1,1.5E+1,1.5E+1,1.5E+1]
; CHECK-AVX-NEXT:    vmulps %xmm1, %xmm0, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_fail_expensive_cast:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpmovsxbq {{.*#+}} xmm1 = [2,2]
; CHECK-AVX512F-NEXT:    vpsllvq %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    vpextrq $1, %xmm0, %rax
; CHECK-AVX512F-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm1
; CHECK-AVX512F-NEXT:    vmovq %xmm0, %rax
; CHECK-AVX512F-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0],xmm1[0],zero,zero
; CHECK-AVX512F-NEXT:    vbroadcastss {{.*#+}} xmm1 = [1.5E+1,1.5E+1,1.5E+1,1.5E+1]
; CHECK-AVX512F-NEXT:    vmulps %xmm1, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_vec:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-AVX-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_vec_preserve_fma:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1092616192,1092616192,1092616192,1092616192]
; CHECK-AVX-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
; CHECK-AVX-NEXT:    vaddps %xmm1, %xmm0, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_preserve_fma:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [2,2,2,2]
; CHECK-AVX512F-NEXT:    vpsllvd %xmm0, %xmm2, %xmm0
; CHECK-AVX512F-NEXT:    vcvtdq2ps %xmm0, %xmm2
; CHECK-AVX512F-NEXT:    vbroadcastss {{.*#+}} xmm0 = [5.0E+0,5.0E+0,5.0E+0,5.0E+0]
; CHECK-AVX512F-NEXT:    vfmadd213ps {{.*#+}} xmm0 = (xmm2 * xmm0) + xmm1
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_vec_no_fma:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1092616192,1092616192,1092616192,1092616192]
; CHECK-AVX-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_no_fma:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} xmm2 = [1092616192,1092616192,1092616192,1092616192]
; CHECK-AVX512F-NEXT:    vpaddd %xmm2, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vaddps %xmm1, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_non_splat_todo:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt_vec_non_splat_todo:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nsw nuw <2 x i64> <i64 2, i64 2>, %cnt
  %conv = uitofp <2 x i64> %shl to <2 x double>
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_non_splat2_todo:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt_vec_non_splat2_todo:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpaddq {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_vec_fail_to_large:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    subq $56, %rsp
; CHECK-AVX-NEXT:    vpmovzxwd {{.*#+}} ymm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; CHECK-AVX-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [2,2,0,0,0,0,0,0]
; CHECK-AVX-NEXT:    vpsllvd %ymm0, %ymm1, %ymm0
; CHECK-AVX-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; CHECK-AVX-NEXT:    vpextrw $2, %xmm0, %eax
; CHECK-AVX-NEXT:    vcvtsi2ss %eax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    vzeroupper
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    vmovss %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-AVX-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; CHECK-AVX-NEXT:    vpextrw $0, %xmm0, %eax
; CHECK-AVX-NEXT:    vcvtsi2ss %eax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    vzeroupper
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
...
; CHECK-AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; CHECK-AVX-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3]
; CHECK-AVX-NEXT:    addq $56, %rsp
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_vec_fail_to_large:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpmovzxwd {{.*#+}} ymm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; CHECK-AVX512F-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [2,2,0,0,0,0,0,0]
; CHECK-AVX512F-NEXT:    vpsllvd %ymm0, %ymm1, %ymm0
; CHECK-AVX512F-NEXT:    vpmovdw %zmm0, %ymm0
; CHECK-AVX512F-NEXT:    vpmovzxwd {{.*#+}} xmm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero
; CHECK-AVX512F-NEXT:    vcvtdq2ps %ymm0, %ymm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %ymm0, %xmm0
; CHECK-AVX512F-NEXT:    vcvtph2ps %xmm0, %ymm0
; CHECK-AVX512F-NEXT:    vbroadcastss {{.*#+}} ymm1 = [1.5E+1,1.5E+1,1.5E+1,1.5E+1,1.5E+1,1.5E+1,1.5E+1,1.5E+1]
; CHECK-AVX512F-NEXT:    vmulps %ymm1, %ymm0, %ymm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %ymm0, %xmm0
; CHECK-AVX512F-NEXT:    vzeroupper
; CHECK-AVX512F-NEXT:    retq
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fmul_pow_shl_cnt_fail_maybe_bad_exp:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    movq %rdi, %rcx
; CHECK-AVX-NEXT:    movl $1, %eax
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX-NEXT:    shlq %cl, %rax
; CHECK-AVX-NEXT:    vmovq %rax, %xmm0
; CHECK-AVX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; CHECK-AVX-NEXT:    vsubpd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_fail_maybe_bad_exp:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movq %rdi, %rcx
; CHECK-AVX512F-NEXT:    movl $1, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX512F-NEXT:    shlq %cl, %rax
; CHECK-AVX512F-NEXT:    vcvtusi2sd %rax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vmulsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fmul_pow_shl_cnt_safe:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    shlq $52, %rax
; CHECK-AVX512F-NEXT:    movabsq $8930638061065157010, %rcx # imm = 0x7BEFFFFFFF5F3992
; CHECK-AVX512F-NEXT:    addq %rax, %rcx
; CHECK-AVX512F-NEXT:    vmovq %rcx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fmul_pow_shl_cnt_safe:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    shlq $52, %rax
; CHECK-SKX-NEXT:    movabsq $8930638061065157010, %rcx # imm = 0x7BEFFFFFFF5F3992
; CHECK-SKX-NEXT:    addq %rax, %rcx
; CHECK-SKX-NEXT:    vmovq %rcx, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt_vec:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastq {{.*#+}} xmm1 = [4607182418800017408,4607182418800017408]
; CHECK-AVX512F-NEXT:    vpsubq %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt_vec:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    vpsllq $52, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpbroadcastq {{.*#+}} xmm1 = [4607182418800017408,4607182418800017408]
; CHECK-SKX-NEXT:    vpsubq %xmm0, %xmm1, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; CHECK-AVX512F-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1065353216,1065353216,1065353216,1065353216]
; CHECK-AVX512F-NEXT:    vpsubd %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt_vec_with_expensive_cast:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; CHECK-SKX-NEXT:    vpslld $23, %xmm0, %xmm0
; CHECK-SKX-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [1065353216,1065353216,1065353216,1065353216]
; CHECK-SKX-NEXT:    vpsubd %xmm0, %xmm1, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nuw <2 x i64> <i64 1, i64 1>, %cnt
  %conv = uitofp <2 x i64> %shl to <2 x float>
...
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX-NEXT:    shlq %cl, %rax
; CHECK-AVX-NEXT:    testq %rax, %rax
; CHECK-AVX-NEXT:    js .LBB24_1
; CHECK-AVX-NEXT:  # %bb.2:
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    jmp .LBB24_3
; CHECK-AVX-NEXT:  .LBB24_1:
; CHECK-AVX-NEXT:    shrq %rax
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    vaddss %xmm0, %xmm0, %xmm0
; CHECK-AVX-NEXT:  .LBB24_3:
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm1 = [-9.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt_fail_maybe_z:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movq %rdi, %rcx
; CHECK-AVX512F-NEXT:    movl $8, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $rcx
; CHECK-AVX512F-NEXT:    shlq %cl, %rax
; CHECK-AVX512F-NEXT:    vcvtusi2ss %rax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm1 = [-9.0E+0,0.0E+0,0.0E+0,0.0E+0]
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fdiv_pow_shl_cnt_fail_neg_int:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    movq %rdi, %rcx
; CHECK-AVX-NEXT:    movl $8, %eax
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $rcx
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt_fail_neg_int:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movq %rdi, %rcx
; CHECK-AVX512F-NEXT:    movl $8, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $rcx
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    andl $31, %edi
; CHECK-AVX512F-NEXT:    shll $23, %edi
; CHECK-AVX512F-NEXT:    movl $-1115684864, %eax # imm = 0xBD800000
; CHECK-AVX512F-NEXT:    subl %edi, %eax
; CHECK-AVX512F-NEXT:    vmovd %eax, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    andl $31, %edi
; CHECK-SKX-NEXT:    shll $23, %edi
; CHECK-SKX-NEXT:    movl $-1115684864, %eax # imm = 0xBD800000
; CHECK-SKX-NEXT:    subl %edi, %eax
; CHECK-SKX-NEXT:    vmovd %eax, %xmm0
; CHECK-SKX-NEXT:    retq
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fdiv_pow_shl_cnt_fail_out_of_bounds:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    pushq %rax
; CHECK-AVX-NEXT:    movl %edi, %ecx
; CHECK-AVX-NEXT:    movl $1, %eax
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $ecx
; CHECK-AVX-NEXT:    shll %cl, %eax
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm1 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    popq %rax
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt_fail_out_of_bounds:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movl %edi, %ecx
; CHECK-AVX512F-NEXT:    movl $1, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $ecx
; CHECK-AVX512F-NEXT:    shll %cl, %eax
; CHECK-AVX512F-NEXT:    vcvtusi2ss %eax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vcvtph2ps %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm1 = [8.192E+3,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    shll $10, %edi
; CHECK-AVX512F-NEXT:    movl $28672, %eax # imm = 0x7000
; CHECK-AVX512F-NEXT:    subl %edi, %eax
; CHECK-AVX512F-NEXT:    vpinsrw $0, %eax, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt_in_bounds:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    shll $10, %edi
; CHECK-SKX-NEXT:    movl $28672, %eax # imm = 0x7000
; CHECK-SKX-NEXT:    subl %edi, %eax
; CHECK-SKX-NEXT:    vpinsrw $0, %eax, %xmm0, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nuw i16 1, %cnt
...
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    shll $10, %edi
; CHECK-AVX512F-NEXT:    movl $18432, %eax # imm = 0x4800
; CHECK-AVX512F-NEXT:    subl %edi, %eax
; CHECK-AVX512F-NEXT:    vpinsrw $0, %eax, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt_in_bounds2:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    shll $10, %edi
; CHECK-SKX-NEXT:    movl $18432, %eax # imm = 0x4800
; CHECK-SKX-NEXT:    subl %edi, %eax
; CHECK-SKX-NEXT:    vpinsrw $0, %eax, %xmm0, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nuw i16 1, %cnt
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fdiv_pow_shl_cnt_fail_out_of_bound2:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    pushq %rax
; CHECK-AVX-NEXT:    movl %edi, %ecx
; CHECK-AVX-NEXT:    movl $1, %eax
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $ecx
; CHECK-AVX-NEXT:    shll %cl, %eax
; CHECK-AVX-NEXT:    movzwl %ax, %eax
; CHECK-AVX-NEXT:    vcvtsi2ss %eax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    callq __extendhfsf2@PLT
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm1 = [2.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    callq __truncsfhf2@PLT
; CHECK-AVX-NEXT:    popq %rax
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt_fail_out_of_bound2:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movl %edi, %ecx
; CHECK-AVX512F-NEXT:    movl $1, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $ecx
...
; CHECK-AVX512F-NEXT:    vcvtsi2ss %eax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vcvtph2ps %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm1 = [2.0E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    vcvtps2ph $4, %xmm0, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt32_to_dbl_okay:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    shlq $52, %rax
; CHECK-AVX512F-NEXT:    movabsq $3936146074321813504, %rcx # imm = 0x36A0000000000000
; CHECK-AVX512F-NEXT:    subq %rax, %rcx
; CHECK-AVX512F-NEXT:    vmovq %rcx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt32_to_dbl_okay:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    shlq $52, %rax
; CHECK-SKX-NEXT:    movabsq $3936146074321813504, %rcx # imm = 0x36A0000000000000
; CHECK-SKX-NEXT:    subq %rax, %rcx
; CHECK-SKX-NEXT:    vmovq %rcx, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nuw i32 1, %cnt
...
; CHECK-SSE-NEXT:    retq
;
; CHECK-AVX-LABEL: fdiv_pow_shl_cnt32_out_of_bounds2:
; CHECK-AVX:       # %bb.0:
; CHECK-AVX-NEXT:    movl %edi, %ecx
; CHECK-AVX-NEXT:    movl $1, %eax
; CHECK-AVX-NEXT:    # kill: def $cl killed $cl killed $ecx
; CHECK-AVX-NEXT:    shll %cl, %eax
; CHECK-AVX-NEXT:    vcvtsi2ss %rax, %xmm15, %xmm0
; CHECK-AVX-NEXT:    vmovss {{.*#+}} xmm1 = [1.00974148E-28,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt32_out_of_bounds2:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movl %edi, %ecx
; CHECK-AVX512F-NEXT:    movl $1, %eax
; CHECK-AVX512F-NEXT:    # kill: def $cl killed $cl killed $ecx
; CHECK-AVX512F-NEXT:    shll %cl, %eax
; CHECK-AVX512F-NEXT:    vcvtusi2ss %eax, %xmm15, %xmm0
; CHECK-AVX512F-NEXT:    vmovss {{.*#+}} xmm1 = [1.00974148E-28,0.0E+0,0.0E+0,0.0E+0]
; CHECK-AVX512F-NEXT:    vdivss %xmm0, %xmm1, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: fdiv_pow_shl_cnt32_okay:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    movzbl %dil, %eax
; CHECK-AVX512F-NEXT:    shll $23, %eax
; CHECK-AVX512F-NEXT:    movl $285212672, %ecx # imm = 0x11000000
; CHECK-AVX512F-NEXT:    subl %eax, %ecx
; CHECK-AVX512F-NEXT:    vmovd %ecx, %xmm0
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: fdiv_pow_shl_cnt32_okay:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    movzbl %dil, %eax
; CHECK-SKX-NEXT:    shll $23, %eax
; CHECK-SKX-NEXT:    movl $285212672, %ecx # imm = 0x11000000
; CHECK-SKX-NEXT:    subl %eax, %ecx
; CHECK-SKX-NEXT:    vmovd %ecx, %xmm0
; CHECK-SKX-NEXT:    retq
  %shl = shl nuw i32 1, %cnt
  %conv = uitofp i32 %shl to float
...
; CHECK-AVX-NEXT:    retq
;
; CHECK-AVX512F-LABEL: pr128528:
; CHECK-AVX512F:       # %bb.0:
; CHECK-AVX512F-NEXT:    testb $1, %dil
; CHECK-AVX512F-NEXT:    movl $8, %eax
; CHECK-AVX512F-NEXT:    movl $1, %ecx
; CHECK-AVX512F-NEXT:    cmovnel %eax, %ecx
; CHECK-AVX512F-NEXT:    movl %ecx, -{{[0-9]+}}(%rsp)
; CHECK-AVX512F-NEXT:    fildl -{{[0-9]+}}(%rsp)
; CHECK-AVX512F-NEXT:    fmull {{\.?LCPI[0-9]+_[0-9]+}}(%rip)
; CHECK-AVX512F-NEXT:    retq
;
; CHECK-SKX-LABEL: pr128528:
; CHECK-SKX:       # %bb.0:
; CHECK-SKX-NEXT:    testb $1, %dil
; CHECK-SKX-NEXT:    movl $8, %eax
; CHECK-SKX-NEXT:    movl $1, %ecx
; CHECK-SKX-NEXT:    cmovnel %eax, %ecx
; CHECK-SKX-NEXT:    movl %ecx, -{{[0-9]+}}(%rsp)
; CHECK-SKX-NEXT:    fildl -{{[0-9]+}}(%rsp)
; CHECK-SKX-NEXT:    fmull {{\.?LCPI[0-9]+_[0-9]+}}(%rip)
; CHECK-SKX-NEXT:    retq
