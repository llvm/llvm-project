...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [2147483647,2147483647]
...
; SSE41-NEXT:    pmovsxdq {{.*#+}} xmm1 = [2147483647,2147483647]
...
; AVX-NEXT:    vpcmpgtq %xmm2, %xmm0, %xmm2
; AVX-NEXT:    vpand %xmm0, %xmm2, %xmm0
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm4[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm2, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm7[0,0,2,2]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm2[1,1,3,3]
...
; AVX1-NEXT:    vpmovsxbd {{.*#+}} xmm3 = [4294967295,0,4294967295,0]
...
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm9[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm4
...
; SSE2-SSSE3-NEXT:    pand %xmm1, %xmm9
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm1
; SSE2-SSSE3-NEXT:    pxor %xmm0, %xmm1
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm2
...
; AVX1-NEXT:    vpand %xmm1, %xmm3, %xmm1
; AVX1-NEXT:    vpcmpgtq %xmm1, %xmm4, %xmm3
; AVX1-NEXT:    vblendvpd %xmm3, %xmm1, %xmm4, %xmm1
...
; AVX2-NEXT:    vpcmpgtq %ymm3, %ymm0, %ymm3
...
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm2
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm0, %xmm2
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [2147549183,2147549183]
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm2, %xmm1
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm4[1,1,3,3]
; SSE41-NEXT:    pcmpeqd %xmm3, %xmm0
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm1 = [2147549183,2147549183]
; SSE41-NEXT:    pcmpgtd %xmm4, %xmm1
; SSE41-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[0,0,2,2]
; SSE41-NEXT:    pand %xmm0, %xmm3
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm1[1,1,3,3]
...
; AVX2-SLOW-NEXT:    vpxor %xmm2, %xmm2, %xmm2
; AVX2-SLOW-NEXT:    vpcmpgtq %xmm2, %xmm0, %xmm2
; AVX2-SLOW-NEXT:    vpand %xmm0, %xmm2, %xmm0
...
; AVX2-FAST-NEXT:    vpcmpgtq %xmm2, %xmm0, %xmm2
; AVX2-FAST-NEXT:    vpand %xmm0, %xmm2, %xmm0
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [2147549183,2147549183]
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm7
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm3, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm7[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm5, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm7[1,1,3,3]
...
; AVX1-NEXT:    vpcmpgtq %xmm2, %xmm1, %xmm3
; AVX1-NEXT:    vpand %xmm1, %xmm3, %xmm1
; AVX1-NEXT:    vpmovzxwq {{.*#+}} xmm3 = [65535,65535]
; AVX1-NEXT:    vpcmpgtq %xmm1, %xmm3, %xmm4
; AVX1-NEXT:    vblendvpd %xmm4, %xmm1, %xmm3, %xmm1
; AVX1-NEXT:    vpcmpgtq %xmm2, %xmm0, %xmm2
; AVX1-NEXT:    vpand %xmm0, %xmm2, %xmm0
...
; SSE2-SSSE3-NEXT:    movdqa %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm1, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm9[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm1, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm10, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pand %xmm0, %xmm9
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm0
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm0[1,1,3,3]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm8
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm10
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm0, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm10[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm11
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm10[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm8[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm1, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm7
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm7, %xmm8
...
; SKX-NEXT:    vpunpcklqdq {{.*#+}} xmm0 = xmm1[0],xmm0[0]
; SKX-NEXT:    vzeroupper
; SKX-NEXT:    retq
  %a0 = load <8 x i64>, ptr %p0
...
; SSSE3-NEXT:    movdqa {{.*#+}} xmm2 = [2147483903,2147483903]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm4[1,1,3,3]
; SSE41-NEXT:    pcmpeqd %xmm3, %xmm0
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm2 = [2147483903,2147483903]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm4[1,1,3,3]
; SSE41-NEXT:    pcmpeqd %xmm3, %xmm0
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm1 = [2147483903,2147483903]
; SSE41-NEXT:    pcmpgtd %xmm4, %xmm1
; SSE41-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[0,0,2,2]
; SSE41-NEXT:    pand %xmm0, %xmm3
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm1[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    movdqa %xmm6, %xmm1
; SSE2-SSSE3-NEXT:    pxor %xmm3, %xmm1
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm1[1,1,3,3]
; SSE2-SSSE3-NEXT:    pxor %xmm5, %xmm5
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm7
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [2147483903,2147483903]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm3[1,1,3,3]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm6
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm3, %xmm4
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm4[0,0,2,2]
...
; SSE2-SSSE3-NEXT:    movdqa %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm2, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm9[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm2, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm10, %xmm8
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm8, %xmm9
...
; SKX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; SKX-NEXT:    vzeroupper
; SKX-NEXT:    retq
  %a0 = load <8 x i64>, ptr %p0
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [255,255]
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm1 = [2147483648,2147483648]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm4
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm4
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm7
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm3 = [2147483903,2147483903]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm10
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm10[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm11
...
; SSE2-SSSE3-NEXT:    por %xmm11, %xmm7
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm8
; SSE2-SSSE3-NEXT:    pandn %xmm0, %xmm7
; SSE2-SSSE3-NEXT:    por %xmm8, %xmm7
...
; SSE2-SSSE3-NEXT:    movdqa %xmm9, %xmm6
; SSE2-SSSE3-NEXT:    pxor %xmm1, %xmm6
...
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm9
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm5, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm9[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm10
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm5
; SSE2-SSSE3-NEXT:    pand %xmm5, %xmm8
; SSE2-SSSE3-NEXT:    pandn %xmm0, %xmm5
...
; SSE2-SSSE3-NEXT:    packuswb %xmm2, %xmm6
...
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm5 = [2147483903,2147483903]
...
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa 96(%rdi), %xmm2
; SSE2-SSSE3-NEXT:    movdqa 112(%rdi), %xmm6
; SSE2-SSSE3-NEXT:    movdqa 64(%rdi), %xmm7
; SSE2-SSSE3-NEXT:    movdqa 80(%rdi), %xmm8
; SSE2-SSSE3-NEXT:    movdqa (%rdi), %xmm0
; SSE2-SSSE3-NEXT:    movdqa 16(%rdi), %xmm4
; SSE2-SSSE3-NEXT:    movdqa 32(%rdi), %xmm9
...
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm3, %xmm11
...
; SSE2-SSSE3-NEXT:    pand %xmm4, %xmm12
; SSE2-SSSE3-NEXT:    movdqa %xmm12, %xmm11
; SSE2-SSSE3-NEXT:    pxor %xmm3, %xmm11
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm11[1,1,3,3]
; SSE2-SSSE3-NEXT:    pxor %xmm5, %xmm5
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm13
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [2147483903,2147483903]
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm14
...
; SSE2-SSSE3-NEXT:    por %xmm12, %xmm11
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm12
; SSE2-SSSE3-NEXT:    pxor %xmm3, %xmm12
; SSE2-SSSE3-NEXT:    movdqa %xmm12, %xmm13
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm3, %xmm13
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm13[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm3, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm14, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm13[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm12, %xmm13
...
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm14
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm0, %xmm14
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm15 = xmm14[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm12, %xmm15
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm14[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm15, %xmm0
; SSE2-SSSE3-NEXT:    pand %xmm0, %xmm13
; SSE2-SSSE3-NEXT:    pandn %xmm1, %xmm0
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm13[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm11, %xmm9
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm13[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm9, %xmm11
; SSE2-SSSE3-NEXT:    pand %xmm11, %xmm12
; SSE2-SSSE3-NEXT:    pandn %xmm1, %xmm11
; SSE2-SSSE3-NEXT:    por %xmm12, %xmm11
; SSE2-SSSE3-NEXT:    packuswb %xmm10, %xmm11
; SSE2-SSSE3-NEXT:    packuswb %xmm11, %xmm0
; SSE2-SSSE3-NEXT:    movdqa %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pxor %xmm3, %xmm9
...
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm9
; SSE2-SSSE3-NEXT:    movdqa %xmm4, %xmm11
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm8, %xmm11
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm12 = xmm11[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm11[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm12, %xmm8
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm10
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm12 = xmm11[0,0,2,2]
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm11[1,1,3,3]
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pand %xmm2, %xmm9
...
; SSE2-SSSE3-NEXT:    por %xmm9, %xmm2
; SSE2-SSSE3-NEXT:    packuswb %xmm6, %xmm2
; SSE2-SSSE3-NEXT:    packuswb %xmm2, %xmm7
; SSE2-SSSE3-NEXT:    packuswb %xmm7, %xmm0
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE41-NEXT:    blendvpd %xmm0, %xmm13, %xmm12
; SSE41-NEXT:    movdqa %xmm1, %xmm0
; SSE41-NEXT:    pxor %xmm4, %xmm0
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vpmaxsq (%rdi), %zmm0, %zmm1
; AVX512-NEXT:    vpmaxsq 64(%rdi), %zmm0, %zmm0
; AVX512-NEXT:    vpmovusqb %zmm0, %xmm0
...
; SKX-NEXT:    vpmaxsq 64(%rdi), %ymm0, %ymm3
; SKX-NEXT:    vpmaxsq 96(%rdi), %ymm0, %ymm0
; SKX-NEXT:    vpmovusqb %ymm0, %xmm0
; SKX-NEXT:    vpmovusqb %ymm3, %xmm3
; SKX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm3[0],xmm0[0],xmm3[1],xmm0[1]
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vpmaxsd 64(%rdi), %zmm0, %zmm1
; AVX512-NEXT:    vpmaxsd (%rdi), %zmm0, %zmm0
; AVX512-NEXT:    vpmovusdb %zmm0, %xmm0
