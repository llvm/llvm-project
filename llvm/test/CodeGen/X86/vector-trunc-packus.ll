...
; SKX:       # %bb.0:
; SKX-NEXT:    vpbroadcastq {{.*#+}} ymm0 = [4294967295,4294967295,4294967295,4294967295]
...
; SSE41-NEXT:    retq
;
; AVX1-LABEL: trunc_packus_v4i32_v4i16:
; AVX1:       # %bb.0:
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: trunc_packus_v4i32_v4i16:
; AVX2:       # %bb.0:
...
; SSE41-NEXT:    retq
;
; AVX1-LABEL: trunc_packus_v4i32_v4i16_store:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vpminsd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX1-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; AVX1-NEXT:    vpmaxsd %xmm1, %xmm0, %xmm0
...
; AVX1-NEXT:    retq
;
; AVX2-LABEL: trunc_packus_v4i32_v4i16_store:
; AVX2:       # %bb.0:
; AVX2-NEXT:    vpbroadcastd {{.*#+}} xmm1 = [65535,65535,65535,65535]
; AVX2-NEXT:    vpminsd %xmm1, %xmm0, %xmm0
; AVX2-NEXT:    vpxor %xmm1, %xmm1, %xmm1
...
; SSE2-SSSE3-LABEL: trunc_packus_v8i32_v8i8:
; SSE2-SSSE3:       # %bb.0:
...
; SSE2-SSSE3-LABEL: trunc_packus_v8i32_v8i8_store:
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm2 = [255,255,255,255]
; SSE2-SSSE3-NEXT:    movdqa %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm0, %xmm3
...
; SSE2-SSSE3-LABEL: trunc_packus_v16i32_v16i8:
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa (%rdi), %xmm3
; SSE2-SSSE3-NEXT:    movdqa 16(%rdi), %xmm0
; SSE2-SSSE3-NEXT:    movdqa 32(%rdi), %xmm2
; SSE2-SSSE3-NEXT:    movdqa 48(%rdi), %xmm4
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm5 = [255,255,255,255]
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm1
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm2, %xmm1
; SSE2-SSSE3-NEXT:    pand %xmm1, %xmm2
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; SKX-NEXT:    vpmaxsd 32(%rdi), %ymm0, %ymm1
...
; SSE2-SSSE3-LABEL: trunc_packus_v16i32_v16i8_store:
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa (%rdi), %xmm3
...
; SSE2-SSSE3-NEXT:    packuswb %xmm1, %xmm3
; SSE2-SSSE3-NEXT:    movdqa %xmm3, (%rsi)
; SSE2-SSSE3-NEXT:    retq
;
; SSE41-LABEL: trunc_packus_v16i32_v16i8_store:
; SSE41:       # %bb.0:
...
; SSE2-SSSE3-LABEL: trunc_packus_v16i16_v16i8:
; SSE2-SSSE3:       # %bb.0:
...
; SSE2-SSSE3-LABEL: trunc_packus_v32i16_v32i8:
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm2 = [255,255,255,255,255,255,255,255]
...
; SSE2-SSSE3-NEXT:    packuswb %xmm2, %xmm1
...
; AVX512F-NEXT:    vpackuswb %ymm0, %ymm1, %ymm0
...
; AVX512VL-NEXT:    vpackuswb %ymm0, %ymm1, %ymm0
...
; SKX:       # %bb.0:
; SKX-NEXT:    vpbroadcastd {{.*#+}} ymm0 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
...
; SSE2-SSSE3-LABEL: trunc_packus_v32i32_v32i8:
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa 80(%rdi), %xmm0
; SSE2-SSSE3-NEXT:    movdqa 64(%rdi), %xmm1
; SSE2-SSSE3-NEXT:    movdqa 112(%rdi), %xmm7
; SSE2-SSSE3-NEXT:    movdqa 96(%rdi), %xmm9
; SSE2-SSSE3-NEXT:    movdqa (%rdi), %xmm5
; SSE2-SSSE3-NEXT:    movdqa 16(%rdi), %xmm8
; SSE2-SSSE3-NEXT:    movdqa 32(%rdi), %xmm3
; SSE2-SSSE3-NEXT:    movdqa 48(%rdi), %xmm4
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm6 = [255,255,255,255]
...
; SSE2-SSSE3-NEXT:    movdqa %xmm6, %xmm8
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm9, %xmm8
; SSE2-SSSE3-NEXT:    pand %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pandn %xmm6, %xmm8
; SSE2-SSSE3-NEXT:    por %xmm9, %xmm8
; SSE2-SSSE3-NEXT:    movdqa %xmm6, %xmm9
...
; SSE2-SSSE3-NEXT:    pand %xmm7, %xmm1
; SSE2-SSSE3-NEXT:    packuswb %xmm0, %xmm1
...
; SSE2-SSSE3-NEXT:    packuswb %xmm0, %xmm7
...
; SSE2-SSSE3-NEXT:    retq
;
; SSE41-LABEL: trunc_packus_v32i32_v32i8:
; SSE41:       # %bb.0:
...
; AVX1-NEXT:    vpackusdw %xmm0, %xmm7, %xmm0
...
; SKX-NEXT:    vpmaxsd 32(%rdi), %ymm0, %ymm1
; SKX-NEXT:    vpmovusdb %ymm1, %xmm1
; SKX-NEXT:    vpmaxsd 96(%rdi), %ymm0, %ymm2
; SKX-NEXT:    vpmovusdb %ymm2, %xmm2
; SKX-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; SKX-NEXT:    vpmaxsd (%rdi), %ymm0, %ymm2
; SKX-NEXT:    vpmovusdb %ymm2, %xmm2
; SKX-NEXT:    vpmaxsd 64(%rdi), %ymm0, %ymm0
; SKX-NEXT:    vpmovusdb %ymm0, %xmm0
; SKX-NEXT:    vinserti128 $1, %xmm0, %ymm2, %ymm0
