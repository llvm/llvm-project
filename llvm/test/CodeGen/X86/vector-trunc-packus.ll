...
; SSE2-SSSE3-NEXT:    movdqa 16(%rdi), %xmm7
...
; SSE2-SSSE3:       # %bb.0:
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm3 = [65535,65535]
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm2 = [2147483648,2147483648]
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm4
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm4
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_packus_v4i32_v4i16_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpackusdw %xmm0, %xmm0, %xmm0
...
; SSE2-SSSE3-NEXT:    movdqa %xmm0, %xmm4
; SSE2-SSSE3-NEXT:    pxor %xmm2, %xmm4
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm5 = [2147483903,2147483903]
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm6
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm6
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm6[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm5, %xmm4
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[1,1,3,3]
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm2
; SSE2-SSSE3-NEXT:    pand %xmm2, %xmm7
; SSE2-SSSE3-NEXT:    pandn %xmm4, %xmm2
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm12[0,0,2,2]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm8, %xmm5
...
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm14 = xmm9[1,1,3,3]
; SSE2-SSSE3-NEXT:    pand %xmm13, %xmm14
...
; SKX-NEXT:    vpbroadcastq {{.*#+}} xmm3 = [0,4,0,4]
; SKX-NEXT:    vpermi2d %xmm1, %xmm2, %xmm3
; SKX-NEXT:    vpmaxsq 32(%rdi), %ymm0, %ymm1
; SKX-NEXT:    vpmovusqb %ymm1, %xmm1
; SKX-NEXT:    vpmaxsq (%rdi), %ymm0, %ymm0
; SKX-NEXT:    vpmovusqb %ymm0, %xmm0
; SKX-NEXT:    vpunpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; SKX-NEXT:    vpblendd {{.*#+}} xmm0 = xmm0[0,1],xmm3[2,3]
; SKX-NEXT:    vzeroupper
; SKX-NEXT:    retq
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_packus_v4i32_v4i8_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpackssdw %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vpackuswb %xmm0, %xmm0, %xmm0
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: trunc_packus_v8i16_v8i8_store:
; AVX512:       # %bb.0:
; AVX512-NEXT:    vpackuswb %xmm0, %xmm0, %xmm0
; AVX512-NEXT:    vmovq %xmm0, (%rdi)
; AVX512-NEXT:    retq
