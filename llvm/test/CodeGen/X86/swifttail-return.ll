...
entry:
  ...
  %call = call swifttailcc { i16, i8 } @gen(i32 %0)
...
declare swifttailcc { i16, i8 } @gen(i32)
...
; CHECK-O0-NEXT:    movl %edi, {{[0-9]+}}(%rsp)
; CHECK-O0-NEXT:    movl {{[0-9]+}}(%rsp), %edi
; CHECK-O0-NEXT:    leaq {{[0-9]+}}(%rsp), %rax
; CHECK-O0-NEXT:    callq gen2@PLT
; CHECK-O0-NEXT:    subq $8, %rsp
...
entry:
  ...
  store i32 %key, i32* %key.addr, align 4
  %0 = load i32, i32* %key.addr, align 4
  %call = call swifttailcc { i32, i32, i32, i32, i32 } @gen2(i32 %0)
...
define swifttailcc { i32, i32, i32, i32, i32 } @gen2(i32 %key) {
; CHECK-LABEL: gen2:
; CHECK:       # %bb.0:
...
entry:
  ...
  store i32 %key, i32* %key.addr, align 4
  %0 = load i32, i32* %key.addr, align 4
  %call = call swifttailcc { i32, i32, i32, i32 } @gen3(i32 %0)
...
declare swifttailcc { i32, i32, i32, i32 } @gen3(i32 %key)
...
entry:
  ...
  %call = call swifttailcc { float, float, float, float } @gen4(float %0)
...
declare swifttailcc { float, float, float, float } @gen4(float %key)
...
; CHECK-O0-NEXT:    .cfi_def_cfa_offset 8
; CHECK-O0-NEXT:    retq
  %call = call swifttailcc { i1, i1, i1, i1 } @produce_i1_ret()
...
declare swifttailcc { i1, i1, i1, i1 } @produce_i1_ret()

define swifttailcc void @foo(i64* sret(i64) %agg.result, i64 %val) {
; CHECK-LABEL: foo:
; CHECK:       # %bb.0:
...
define swifttailcc double @test5() #0 {
; CHECK-LABEL: test5:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    pushq %rax
; CHECK-NEXT:    .cfi_def_cfa_offset 16
...
; CHECK-O0-NEXT:    retq $8
entry:
  %call = call swifttailcc { double, double, double, double } @gen5()
...
declare swifttailcc { double, double, double, double } @gen5()


define swifttailcc { double, i64 } @test6() #0 {
; CHECK-LABEL: test6:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    pushq %rax
; CHECK-NEXT:    .cfi_def_cfa_offset 16
...
; CHECK-O0-NEXT:    retq $8
entry:
  %call = call swifttailcc { double, double, double, double, i64, i64, i64, i64 } @gen6()
...
declare swifttailcc { double, double, double, double, i64, i64, i64, i64 } @gen6()

define swifttailcc { i32, i32, i32, i32 } @gen7(i32 %key) {
; CHECK-LABEL: gen7:
; CHECK:       # %bb.0:
...
define swifttailcc { i64, i64, i64, i64 } @gen8(i64 %key) {
; CHECK-LABEL: gen8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    movq %rdi, %rax
...
define swifttailcc { i8, i8, i8, i8 } @gen9(i8 %key) {
; CHECK-LABEL: gen9:
; CHECK:       # %bb.0:
; CHECK-NEXT:    movl %edi, %eax
...
define swifttailcc { double, double, double, double, i64, i64, i64, i64 } @gen10(double %keyd, i64 %keyi) {
; CHECK-LABEL: gen10:
; CHECK:       # %bb.0:
; CHECK-NEXT:    movq %rdi, %rax
...
define swifttailcc <4 x float> @test11() #0 {
; CHECK-LABEL: test11:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    pushq %rax
; CHECK-NEXT:    .cfi_def_cfa_offset 16
...
; CHECK-O0-NEXT:    retq $8
entry:
  %call = call swifttailcc { <4 x float>, <4 x float>, <4 x float>, <4 x float> } @gen11()
...
declare swifttailcc { <4 x float>, <4 x float>, <4 x float>, <4 x float> } @gen11()

define swifttailcc { <4 x float>, float } @test12() #0 {
; CHECK-LABEL: test12:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    pushq %rax
; CHECK-NEXT:    .cfi_def_cfa_offset 16
...
; CHECK-O0-NEXT:    subq $8, %rsp
; CHECK-O0-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; CHECK-O0-NEXT:    movaps %xmm3, %xmm1
; CHECK-O0-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; CHECK-O0-NEXT:    addps %xmm3, %xmm0
; CHECK-O0-NEXT:    addps %xmm2, %xmm0
; CHECK-O0-NEXT:    addq $40, %rsp
; CHECK-O0-NEXT:    .cfi_def_cfa_offset 8
; CHECK-O0-NEXT:    retq $8
entry:
  %call = call swifttailcc { <4 x float>, <4 x float>, <4 x float>, float } @gen12()
...
declare swifttailcc { <4 x float>, <4 x float>, <4 x float>, float } @gen12()
