...
; X86-BMI2-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-BMI2-NEXT:    shrdl %cl, %edx, %esi
; X86-BMI2-NEXT:    sarxl %ecx, %edx, %edi
; X86-BMI2-NEXT:    testb $32, %cl
...
; X86-NOBMI-NEXT:    shll %cl, %esi
; X86-NOBMI-NEXT:    testb $32, %ch
; X86-NOBMI-NEXT:    jne .LBB12_3
; X86-NOBMI-NEXT:  # %bb.4:
; X86-NOBMI-NEXT:    movl (%esp), %ecx # 4-byte Reload
; X86-NOBMI-NEXT:    jmp .LBB12_5
; X86-NOBMI-NEXT:  .LBB12_3:
; X86-NOBMI-NEXT:    movl %esi, %ecx
; X86-NOBMI-NEXT:    xorl %esi, %esi
; X86-NOBMI-NEXT:  .LBB12_5:
; X86-NOBMI-NEXT:    addl $-1, %esi
; X86-NOBMI-NEXT:    adcl $-1, %ecx
; X86-NOBMI-NEXT:    andl %esi, %eax
...
; X86-BMI1-NEXT:    movl %edi, (%esp) # 4-byte Spill
; X86-BMI1-NEXT:    shll %cl, %esi
; X86-BMI1-NEXT:    testb $32, %ch
; X86-BMI1-NEXT:    jne .LBB12_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl (%esp), %ecx # 4-byte Reload
; X86-BMI1-NEXT:    jmp .LBB12_5
; X86-BMI1-NEXT:  .LBB12_3:
; X86-BMI1-NEXT:    movl %esi, %ecx
; X86-BMI1-NEXT:    xorl %esi, %esi
; X86-BMI1-NEXT:  .LBB12_5:
; X86-BMI1-NEXT:    addl $-1, %esi
; X86-BMI1-NEXT:    adcl $-1, %ecx
; X86-BMI1-NEXT:    andl %esi, %eax
; X86-BMI1-NEXT:    andl %ecx, %edx
...
; X86-BMI2-NEXT:    shlxl %ebx, %esi, %esi
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB12_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl %edi, %ecx
; X86-BMI2-NEXT:    jmp .LBB12_5
; X86-BMI2-NEXT:  .LBB12_3:
; X86-BMI2-NEXT:    movl %esi, %ecx
; X86-BMI2-NEXT:    xorl %esi, %esi
; X86-BMI2-NEXT:  .LBB12_5:
...
; X86-BMI2-NEXT:    shrxl %eax, %esi, %ebx
...
; X86-BMI2-NEXT:    shldl %cl, %ebp, %esi
; X86-BMI2-NEXT:    shlxl %edx, %ebp, %ecx
...
; X86-BMI1-NEXT:    testb $32, %al
; X86-BMI1-NEXT:    jne .LBB25_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %eax
; X86-BMI1-NEXT:    jmp .LBB25_5
; X86-BMI1-NEXT:  .LBB25_3:
; X86-BMI1-NEXT:    movl %ecx, %eax
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB25_5:
; X86-BMI1-NEXT:    andnl %edx, %eax, %edx
; X86-BMI1-NEXT:    andnl %esi, %ecx, %eax
; X86-BMI1-NEXT:    popl %esi
; X86-BMI1-NEXT:    popl %edi
; X86-BMI1-NEXT:    retl
;
...
; X86-BMI2-NEXT:    shlxl %ebx, %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB25_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl $-1, %esi
; X86-BMI2-NEXT:    jmp .LBB25_5
; X86-BMI2-NEXT:  .LBB25_3:
; X86-BMI2-NEXT:    movl %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:  .LBB25_5:
...
; X86-BMI1-NEXT:    movl %edi, %ecx
; X86-BMI1-NEXT:    testb $32, %al
; X86-BMI1-NEXT:    jne .LBB26_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %eax
; X86-BMI1-NEXT:    jmp .LBB26_5
; X86-BMI1-NEXT:  .LBB26_3:
; X86-BMI1-NEXT:    movl %ecx, %eax
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB26_5:
; X86-BMI1-NEXT:    andnl %edx, %eax, %edx
; X86-BMI1-NEXT:    andnl %esi, %ecx, %eax
; X86-BMI1-NEXT:    popl %esi
; X86-BMI1-NEXT:    popl %edi
...
; X86-BMI2-NEXT:    shlxl %ebx, %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB26_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl $-1, %esi
; X86-BMI2-NEXT:    jmp .LBB26_5
; X86-BMI2-NEXT:  .LBB26_3:
; X86-BMI2-NEXT:    movl %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:  .LBB26_5:
; X86-BMI2-NEXT:    andnl %edx, %esi, %edx
; X86-BMI2-NEXT:    andnl %eax, %ecx, %eax
; X86-BMI2-NEXT:    popl %esi
; X86-BMI2-NEXT:    popl %ebx
...
; X86-BMI1-NEXT:    movl %edi, %ecx
; X86-BMI1-NEXT:    testb $32, %al
; X86-BMI1-NEXT:    jne .LBB27_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %eax
; X86-BMI1-NEXT:    jmp .LBB27_5
; X86-BMI1-NEXT:  .LBB27_3:
; X86-BMI1-NEXT:    movl %ecx, %eax
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB27_5:
; X86-BMI1-NEXT:    andnl %edx, %eax, %edx
; X86-BMI1-NEXT:    andnl %esi, %ecx, %eax
; X86-BMI1-NEXT:    popl %esi
; X86-BMI1-NEXT:    popl %edi
...
; X86-BMI2-NEXT:    shlxl %ebx, %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB27_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl $-1, %esi
; X86-BMI2-NEXT:    jmp .LBB27_5
; X86-BMI2-NEXT:  .LBB27_3:
; X86-BMI2-NEXT:    movl %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:  .LBB27_5:
; X86-BMI2-NEXT:    andnl %edx, %esi, %edx
; X86-BMI2-NEXT:    andnl %eax, %ecx, %eax
; X86-BMI2-NEXT:    popl %esi
; X86-BMI2-NEXT:    popl %ebx
...
; X86-BMI1-NEXT:    movl %edi, %ecx
; X86-BMI1-NEXT:    testb $32, %al
; X86-BMI1-NEXT:    jne .LBB28_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %eax
; X86-BMI1-NEXT:    jmp .LBB28_5
; X86-BMI1-NEXT:  .LBB28_3:
; X86-BMI1-NEXT:    movl %ecx, %eax
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB28_5:
; X86-BMI1-NEXT:    andnl %edx, %eax, %edx
; X86-BMI1-NEXT:    andnl %esi, %ecx, %eax
; X86-BMI1-NEXT:    popl %esi
; X86-BMI1-NEXT:    popl %edi
...
; X86-BMI2-NEXT:    shlxl %ebx, %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB28_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl $-1, %esi
; X86-BMI2-NEXT:    jmp .LBB28_5
; X86-BMI2-NEXT:  .LBB28_3:
; X86-BMI2-NEXT:    movl %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:  .LBB28_5:
; X86-BMI2-NEXT:    andnl %edx, %esi, %edx
; X86-BMI2-NEXT:    andnl %eax, %ecx, %eax
; X86-BMI2-NEXT:    popl %esi
; X86-BMI2-NEXT:    popl %ebx
...
; X86-BMI1-NEXT:    movl %edi, %ecx
; X86-BMI1-NEXT:    testb $32, %al
; X86-BMI1-NEXT:    jne .LBB29_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %eax
; X86-BMI1-NEXT:    jmp .LBB29_5
; X86-BMI1-NEXT:  .LBB29_3:
; X86-BMI1-NEXT:    movl %ecx, %eax
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB29_5:
; X86-BMI1-NEXT:    andnl %edx, %eax, %edx
; X86-BMI1-NEXT:    andnl %esi, %ecx, %eax
; X86-BMI1-NEXT:    popl %esi
; X86-BMI1-NEXT:    popl %edi
...
; X86-BMI2-NEXT:    shlxl %ebx, %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %bl
; X86-BMI2-NEXT:    jne .LBB29_3
; X86-BMI2-NEXT:  # %bb.4:
; X86-BMI2-NEXT:    movl $-1, %esi
; X86-BMI2-NEXT:    jmp .LBB29_5
; X86-BMI2-NEXT:  .LBB29_3:
; X86-BMI2-NEXT:    movl %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:  .LBB29_5:
; X86-BMI2-NEXT:    andnl %edx, %esi, %edx
; X86-BMI2-NEXT:    andnl %eax, %ecx, %eax
; X86-BMI2-NEXT:    popl %esi
; X86-BMI2-NEXT:    popl %ebx
...
; X86-BMI1-NEXT:    movl %ebp, %ecx
; X86-BMI1-NEXT:    testb $32, %dl
; X86-BMI1-NEXT:    jne .LBB30_3
; X86-BMI1-NEXT:  # %bb.4:
; X86-BMI1-NEXT:    movl $-1, %edx
; X86-BMI1-NEXT:    jmp .LBB30_5
; X86-BMI1-NEXT:  .LBB30_3:
; X86-BMI1-NEXT:    movl %ecx, %edx
; X86-BMI1-NEXT:    xorl %ecx, %ecx
; X86-BMI1-NEXT:  .LBB30_5:
; X86-BMI1-NEXT:    andnl %esi, %edx, %esi
; X86-BMI1-NEXT:    andnl %edi, %ecx, %edi
; X86-BMI1-NEXT:    subl $8, %esp
; X86-BMI1-NEXT:    pushl %ebx
; X86-BMI1-NEXT:    pushl %eax
; X86-BMI1-NEXT:    calll use64@PLT
...
; X86-BMI2-NEXT:    movl $-1, %eax
; X86-BMI2-NEXT:    shrxl %edx, %eax, %ecx
; X86-BMI2-NEXT:    testb $32, %dl
...
; X86-BMI1-NEXT:    testb $32, %cl
; X86-BMI1-NEXT:    movl %edx, (%esp) # 4-byte Spill
...
; X86-BMI1-NEXT:  # %bb.5:
; X86-BMI1-NEXT:    movl (%esp), %esi # 4-byte Reload
; X86-BMI1-NEXT:    movl %eax, %edx
