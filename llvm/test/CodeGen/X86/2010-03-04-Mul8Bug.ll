...
define void @func_56(i64 %p_57, ptr %p_58) nounwind ssp {
for.end:
  ...
  %call85 = call i32 @func_35(ptr undef, i32 undef, i32 %conv58, i32 1247, i32 0) nounwind ; <i32> [#uses=0]
  ret void
}

declare i32 @func_35(ptr, i32, i32, i32, i32)
