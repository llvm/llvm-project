...
; CHECK: %[[#ALtB2:]] = OpSLessThan %[[#Bool]] %[[#A2]] %[[#B2]]
; CHECK: %[[#ResLt02:]] = OpSLessThan %[[#Bool]] %[[#Res2]] %[[#NullInt]]
; CHECK: %[[#Overflow2:]] = OpLogicalNotEqual %[[#Bool]] %[[#ALtB2]] %[[#ResLt02]]
; CHECK: OpReturn
...
; CHECK: %[[#ALtB4:]] = OpSLessThan %[[#V2Bool]] %[[#A4]] %[[#B4]]
; CHECK: %[[#ResLt04:]] = OpSLessThan %[[#V2Bool]] %[[#Res4]] %[[#NullV2Int]]
; CHECK: %[[#Overflow4:]] = OpLogicalNotEqual %[[#V2Bool]] %[[#ALtB4]] %[[#ResLt04]]
; CHECK: OpReturn
