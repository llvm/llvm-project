...
; CHECK-DAG:    %[[#szconst:]] = OpConstant %[[#i32]] 1024
...
; CHECK-32:     OpCopyMemorySized %[[#arr]] %[[#test_arr]] %[[#szconst]]

; CHECK-64:     %[[#szconstext:]] = OpUConvert %[[#i64:]] %[[#szconst:]]
; CHECK-64:     OpCopyMemorySized %[[#arr]] %[[#test_arr]] %[[#szconstext]]
