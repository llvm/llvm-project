...
; CHECK-DAG: [[PackedImageType:%[0-9]+]] = OpTypeImage [[uint]] Buffer 2 0 0 2 Rgba32i
...
; CHECK: [[H:%[0-9]+]] = OpLoad [[PackedImageType]] [[PackedVar]]
  %s_h.i = tail call target("spirv.SignedImage", i32, 5, 2, 0, 0, 2, 21) @llvm.spv.resource.handlefrombinding.tspirv.SignedImage_i32_5_2_0_0_2_21t(i32 4, i32 5, i32 1, i32 0, ptr nonnull @.str.b1)

; CHECK: [[R:%[0-9]+]] = OpImageRead [[v4int]] [[H]] [[one]] SignExtend
; CHECK: [[V:%[0-9]+]] = OpBitcast [[v2ulong]] [[R]]
  %0 = tail call noundef nonnull align 16 dereferenceable(16) ptr @llvm.spv.resource.getpointer.p0.tspirv.SignedImage_i32_5_2_0_0_2_21t(target("spirv.SignedImage", i32, 5, 2, 0, 0, 2, 21) %s_h.i, i32 1)
  %1 = load <2 x i64>, ptr %0, align 16

; CHECK: [[W:%[0-9]+]] = OpBitcast [[v4int]] [[V]]
; CHECK: OpImageWrite {{%[0-9]+}} [[zero]] [[W]] SignExtend
  %2 = tail call noundef nonnull align 16 dereferenceable(16) ptr @llvm.spv.resource.getpointer.p0.tspirv.SignedImage_i32_5_2_0_0_2_21t(target("spirv.SignedImage", i32, 5, 2, 0, 0, 2, 21) %s_h.i, i32 0)
