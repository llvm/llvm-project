...
; CHECK-DAG: [[PATH:%[0-9]+]] = OpString "{{[/\\]}}AAAAAAAAAA{{[/\\]}}BBBBBBBB{{[/\\]}}CCCCCCCCC{{[/\\]}}abs-path-decl.c"
; CHECK-DAG: [[NAME:%[0-9]+]] = OpString "abs_decl"
...
!1 = !DIFile(filename: "/AAAAAAAAAA/BBBBBBBB/CCCCCCCCC/abs-path-decl.c", directory: "", checksumkind: CSK_MD5, checksum: "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")
...
!11 = !DISubprogram(name: "abs_decl", linkageName: "abs_decl", scope: !1, file: !1, line: 10, type: !6, scopeLine: 10, flags: DIFlagPrototyped, spFlags: 0)
