...
; DebugLine for the branch is emitted before OpLoopMerge.
...
header:
  ...
  call void (...) @llvm.spv.loop.merge(ptr blockaddress(@loop, %exit), ptr blockaddress(@loop, %body), i32 0), !dbg !14
  br i1 %cmp, label %body, label %exit, !dbg !13
...
declare void @llvm.spv.loop.merge(...)

!llvm.dbg.cu = !{!0}
!llvm.module.flags = !{!2, !3}

!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "debug-line-loop-merge.c", directory: "/src")
