...
; CHECK-MIR-DAG: [[DEBUG_SOURCE:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 35, {{%[0-9]+\:[a-z0-9\(\)]+}}
; CHECK-MIR: [[DEBUG_COMPILATION_UNIT:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 1, {{%[0-9]+\:[a-z0-9\(\)]+}}, {{%[0-9]+\:[a-z0-9\(\)]+}}, [[DEBUG_SOURCE]], {{%[0-9]+\:[a-z0-9\(\)]+}}
; CHECK-MIR-DAG: [[str_76:%[0-9]+:id\(s32\)]] = OpString 7630441
; CHECK-MIR-DAG: [[DEBUG_TYPE_BASIC:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 2, [[str_76]]
; CHECK-MIR-DAG: [[STR_MEMBER1:%[0-9]+:id\(s32\)]] = OpString 120
; CHECK-MIR-DAG: [[DEBUG_MEMBER1:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 11, [[STR_MEMBER1]], [[DEBUG_TYPE_BASIC]], [[DEBUG_SOURCE]]
; CHECK-MIR-DAG: [[STR_MEMBER2:%[0-9]+:id\(s32\)]] = OpString 121
; CHECK-MIR-DAG: [[DEBUG_MEMBER2:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 11, [[STR_MEMBER2]], [[DEBUG_TYPE_BASIC]], [[DEBUG_SOURCE]]
; CHECK-MIR-DAG: [[STR_POINT:%[0-9]+:id\(s32\)]] = OpString 1852403536, 116
; CHECK-MIR-DAG: [[DEBUG_COMPOSITE_POINT:%[0-9]+:id\(s32\)]] = OpExtInst [[TYPE_VOID]], 3, 10, [[STR_POINT]], {{%[0-9]+\:[a-z0-9\(\)]+}}, [[DEBUG_SOURCE:.*]], {{%[0-9]+\:[a-z0-9\(\)]+}}, {{%[0-9]+\:[a-z0-9\(\)]+}}, [[DEBUG_COMPILATION_UNIT:.*]], {{%[0-9]+\:[a-z0-9\(\)]+}}, {{%[0-9]+\:[a-z0-9\(\)]+}}, {{%[0-9]+\:[a-z0-9\(\)]+}}, [[DEBUG_MEMBER1]], [[DEBUG_MEMBER2]]
