...
entry:
  ; CHECK: OpAtomicIIncrement %[[#Int]] %{{[0-9]+}} %[[#Scope_CrossDevice]] %[[#MemSem_SeqCst]]
  %0 = atomicrmw uinc_wrap ptr addrspace(1) @ui, i32 42 seq_cst

  ; CHECK: OpAtomicIIncrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Device]] %[[#MemSem_SeqCst]]
  %1 = atomicrmw uinc_wrap ptr addrspace(1) @ui, i32 42 syncscope("device") seq_cst

  ; CHECK: OpAtomicIIncrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Workgroup]] %[[#MemSem_SeqCst]]
  %2 = atomicrmw uinc_wrap ptr addrspace(1) @ui, i32 42 syncscope("workgroup") seq_cst

  ; CHECK: OpAtomicIIncrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Subgroup]] %[[#MemSem_SeqCst]]
  %3 = atomicrmw uinc_wrap ptr addrspace(1) @ui, i32 42 syncscope("subgroup") seq_cst

  ; CHECK: OpAtomicIIncrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Invocation]] %[[#MemSem_SeqCst]]
...
entry:
  ; CHECK: OpAtomicIDecrement %[[#Int]] %{{[0-9]+}} %[[#Scope_CrossDevice]] %[[#MemSem_SeqCst]]
  %0 = atomicrmw udec_wrap ptr addrspace(1) @ui, i32 42 seq_cst

  ; CHECK: OpAtomicIDecrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Device]] %[[#MemSem_SeqCst]]
  %1 = atomicrmw udec_wrap ptr addrspace(1) @ui, i32 42 syncscope("device") seq_cst

  ; CHECK: OpAtomicIDecrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Workgroup]] %[[#MemSem_SeqCst]]
  %2 = atomicrmw udec_wrap ptr addrspace(1) @ui, i32 42 syncscope("workgroup") seq_cst

  ; CHECK: OpAtomicIDecrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Subgroup]] %[[#MemSem_SeqCst]]
  %3 = atomicrmw udec_wrap ptr addrspace(1) @ui, i32 42 syncscope("subgroup") seq_cst

  ; CHECK: OpAtomicIDecrement %[[#Int]] %{{[0-9]+}} %[[#Scope_Invocation]] %[[#MemSem_SeqCst]]
