...
@__block_literal_global = internal addrspace(1) constant %structtype { i32 16, i32 8, ptr addrspace(4) addrspacecast (ptr null to ptr addrspace(4)) }, align 8
@__block_literal_global.1 = internal addrspace(1) constant %structtype { i32 16, i32 8, ptr addrspace(4) addrspacecast (ptr null to ptr addrspace(4)) }, align 8
@__block_literal_global.2 = internal addrspace(1) constant %structtype { i32 16, i32 8, ptr addrspace(4) addrspacecast (ptr null to ptr addrspace(4)) }, align 8
