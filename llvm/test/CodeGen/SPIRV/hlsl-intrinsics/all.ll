...
entry:
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.i1(i1 %a)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.i64(i64 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.i32(i32 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.i16(i16 %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.f64(double %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.f32(float %0)
  ret i1 %hlsl.all
}
...
entry:
  ...
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.f16(half %0)
  ret i1 %hlsl.all
}
...
entry:
  ; CHECK: %[[#]] = OpAll %[[#]] %[[#]]
  %hlsl.all = call i1 @llvm.hlsl.all.v4i1(<4 x i1> %p0)
  ret i1 %hlsl.all
}

declare i1 @llvm.hlsl.all.v4i1(<4 x i1>)
declare i1 @llvm.hlsl.all.i1(i1)
declare i1 @llvm.hlsl.all.i16(i16)
declare i1 @llvm.hlsl.all.i32(i32)
declare i1 @llvm.hlsl.all.i64(i64)
declare i1 @llvm.hlsl.all.f16(half)
declare i1 @llvm.hlsl.all.f32(float)
declare i1 @llvm.hlsl.all.f64(double)
