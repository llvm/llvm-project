...
define internal void @pow_float4x4(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ...
  ; CHECK: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow %[[#a0_f32]] %[[#b0_f32]]
  ; CHECK: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow %[[#a1_f32]] %[[#b1_f32]]
  ; CHECK: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow %[[#a2_f32]] %[[#b2_f32]]
  ; CHECK: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow %[[#a3_f32]] %[[#b3_f32]]
  ...
  %r0 = call <4 x float> @llvm.pow.v4f32(<4 x float> %va0, <4 x float> %vb0)
  %r1 = call <4 x float> @llvm.pow.v4f32(<4 x float> %va1, <4 x float> %vb1)
  %r2 = call <4 x float> @llvm.pow.v4f32(<4 x float> %va2, <4 x float> %vb2)
  %r3 = call <4 x float> @llvm.pow.v4f32(<4 x float> %va3, <4 x float> %vb3)
...
define internal void @pow_half4x4(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ...
  ; CHECK: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow %[[#a0_f16]] %[[#b0_f16]]
  ; CHECK: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow %[[#a1_f16]] %[[#b1_f16]]
  ; CHECK: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow %[[#a2_f16]] %[[#b2_f16]]
  ; CHECK: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow %[[#a3_f16]] %[[#b3_f16]]
  ...
  %r0 = call <4 x half> @llvm.pow.v4f16(<4 x half> %va0, <4 x half> %vb0)
  %r1 = call <4 x half> @llvm.pow.v4f16(<4 x half> %va1, <4 x half> %vb1)
  %r2 = call <4 x half> @llvm.pow.v4f16(<4 x half> %va2, <4 x half> %vb2)
  %r3 = call <4 x half> @llvm.pow.v4f16(<4 x half> %va3, <4 x half> %vb3)
...
define internal void @pow_float3x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ...
  ; CHECK: OpExtInst %[[#vec3_float_32]] %[[#op_ext_glsl]] Pow %[[#a3v0_f32]] %[[#b3v0_f32]]
  ; CHECK: OpExtInst %[[#vec3_float_32]] %[[#op_ext_glsl]] Pow %[[#a3v1_f32]] %[[#b3v1_f32]]
  ; CHECK: OpExtInst %[[#vec3_float_32]] %[[#op_ext_glsl]] Pow %[[#a3v2_f32]] %[[#b3v2_f32]]
  ...
  %r0 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va0, <3 x float> %vb0)
  %r1 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va1, <3 x float> %vb1)
  %r2 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va2, <3 x float> %vb2)
...
define internal void @pow_half3x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ...
  ; CHECK: OpExtInst %[[#vec3_float_16]] %[[#op_ext_glsl]] Pow %[[#a3v0_f16]] %[[#b3v0_f16]]
  ; CHECK: OpExtInst %[[#vec3_float_16]] %[[#op_ext_glsl]] Pow %[[#a3v1_f16]] %[[#b3v1_f16]]
  ; CHECK: OpExtInst %[[#vec3_float_16]] %[[#op_ext_glsl]] Pow %[[#a3v2_f16]] %[[#b3v2_f16]]
  ...
  %r0 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va0, <3 x half> %vb0)
  %r1 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va1, <3 x half> %vb1)
  %r2 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va2, <3 x half> %vb2)
...
define internal void @pow_float2x2(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec2_float_32]] %[[#op_ext_glsl]] Pow
  ...
  %r0 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va0, <2 x float> %vb0)
  %r1 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va1, <2 x float> %vb1)
...
define internal void @pow_half2x2(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec2_float_16]] %[[#op_ext_glsl]] Pow
  ...
  %r0 = call <2 x half> @llvm.pow.v2f16(<2 x half> %va0, <2 x half> %vb0)
  %r1 = call <2 x half> @llvm.pow.v2f16(<2 x half> %va1, <2 x half> %vb1)
...
define internal void @pow_float2x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec3_float_32]] %[[#op_ext_glsl]] Pow
...
define internal void @pow_half2x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec3_float_16]] %[[#op_ext_glsl]] Pow
...
define internal void @pow_float3x2(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst %[[#vec2_float_32]] %[[#op_ext_glsl]] Pow
  ...
  %r0 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va0, <2 x float> %vb0)
  %r1 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va1, <2 x float> %vb1)
  %r2 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va2, <2 x float> %vb2)
...
define internal void @pow_float2x4(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow
...
define internal void @pow_float4x2(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-4: OpExtInst %[[#vec2_float_32]] %[[#op_ext_glsl]] Pow
  ...
  %r1 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va1, <2 x float> %vb1)
  %r2 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va2, <2 x float> %vb2)
  %r3 = call <2 x float> @llvm.pow.v2f32(<2 x float> %va3, <2 x float> %vb3)
...
define internal void @pow_float3x4(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow
...
define internal void @pow_half3x4(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow
...
define internal void @pow_float4x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-4: OpExtInst %[[#vec3_float_32]] %[[#op_ext_glsl]] Pow
  ...
  %r1 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va1, <3 x float> %vb1)
  %r2 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va2, <3 x float> %vb2)
  %r3 = call <3 x float> @llvm.pow.v3f32(<3 x float> %va3, <3 x float> %vb3)
...
define internal void @pow_half4x3(ptr addrspace(10) %out, ptr addrspace(10) %a, ptr addrspace(10) %b) {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-4: OpExtInst %[[#vec3_float_16]] %[[#op_ext_glsl]] Pow
  ...
  %r1 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va1, <3 x half> %vb1)
  %r2 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va2, <3 x half> %vb2)
  %r3 = call <3 x half> @llvm.pow.v3f16(<3 x half> %va3, <3 x half> %vb3)
...
define internal void @pow_float6_from_shuffle() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK: %[[#shuffle_f32:]] = OpLoad %[[#vec4_float_32]]
  ; CHECK: OpCompositeExtract %[[#float_32]] %[[#shuffle_f32]] 0
  ; CHECK-COUNT-2: OpExtInst {{%[0-9]+}} %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <6 x float> @llvm.pow.v6f32(<6 x float> %va, <6 x float> %va)
  store <6 x float> %r, ptr addrspace(10) @wide_f32_6
  ret void
}

define internal void @pow_half6() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst {{%[0-9]+}} %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <6 x half> @llvm.pow.v6f16(<6 x half> %va, <6 x half> %vb)
  store <6 x half> %r, ptr addrspace(10) @wide_f16_6
  ret void
}

define internal void @pow_float8() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <8 x float> @llvm.pow.v8f32(<8 x float> %va, <8 x float> %vb)
  store <8 x float> %r, ptr addrspace(10) @wide_f32_8
  ret void
}

define internal void @pow_half8() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-2: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  %va = load <8 x half>, ptr addrspace(10) @wide_f16_8
  %vb = load <8 x half>, ptr addrspace(10) @wide_f16_8
  %r = call <8 x half> @llvm.pow.v8f16(<8 x half> %va, <8 x half> %vb)
  store <8 x half> %r, ptr addrspace(10) @wide_f16_8
  ret void
}

define internal void @pow_float9() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst {{%[0-9]+}} %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  %va = load <9 x float>, ptr addrspace(10) @wide_f32_9
  %vb = load <9 x float>, ptr addrspace(10) @wide_f32_9
  %r = call <9 x float> @llvm.pow.v9f32(<9 x float> %va, <9 x float> %vb)
  store <9 x float> %r, ptr addrspace(10) @wide_f32_9
  ret void
}

define internal void @pow_half9() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst {{%[0-9]+}} %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <9 x half> @llvm.pow.v9f16(<9 x half> %va, <9 x half> %vb)
  store <9 x half> %r, ptr addrspace(10) @wide_f16_9
  ret void
}

define internal void @pow_float12() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <12 x float> @llvm.pow.v12f32(<12 x float> %va, <12 x float> %vb)
  store <12 x float> %r, ptr addrspace(10) @wide_f32_12
  ret void
}

define internal void @pow_half12() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-3: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  ...
  %r = call <12 x half> @llvm.pow.v12f16(<12 x half> %va, <12 x half> %vb)
  store <12 x half> %r, ptr addrspace(10) @wide_f16_12
  ret void
}

define internal void @pow_float16() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-4: OpExtInst %[[#vec4_float_32]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  %va = load <16 x float>, ptr addrspace(10) @wide_f32_16
  %vb = load <16 x float>, ptr addrspace(10) @wide_f32_16
  %r = call <16 x float> @llvm.pow.v16f32(<16 x float> %va, <16 x float> %vb)
  store <16 x float> %r, ptr addrspace(10) @wide_f32_16
  ret void
}

define internal void @pow_half16() {
entry:
  ; CHECK: OpFunction %[[#void]] None
  ; CHECK-COUNT-4: OpExtInst %[[#vec4_float_16]] %[[#op_ext_glsl]] Pow
  ; CHECK: OpFunctionEnd
  %va = load <16 x half>, ptr addrspace(10) @wide_f16_16
  %vb = load <16 x half>, ptr addrspace(10) @wide_f16_16
  %r = call <16 x half> @llvm.pow.v16f16(<16 x half> %va, <16 x half> %vb)
...
define void @main() #0 {
entry:
  call void @pow_float4x4(ptr addrspace(10) @mat_f32_4x4, ptr addrspace(10) @mat_f32_4x4, ptr addrspace(10) @mat_f32_4x4)
  call void @pow_half4x4(ptr addrspace(10) @mat_f16_4x4, ptr addrspace(10) @mat_f16_4x4, ptr addrspace(10) @mat_f16_4x4)
  call void @pow_float3x3(ptr addrspace(10) @mat_f32_3x3, ptr addrspace(10) @mat_f32_3x3, ptr addrspace(10) @mat_f32_3x3)
  call void @pow_half3x3(ptr addrspace(10) @mat_f16_3x3, ptr addrspace(10) @mat_f16_3x3, ptr addrspace(10) @mat_f16_3x3)
  call void @pow_float2x2(ptr addrspace(10) @mat_f32_2x2, ptr addrspace(10) @mat_f32_2x2, ptr addrspace(10) @mat_f32_2x2)
  call void @pow_half2x2(ptr addrspace(10) @mat_f16_2x2, ptr addrspace(10) @mat_f16_2x2, ptr addrspace(10) @mat_f16_2x2)
  call void @pow_float2x3(ptr addrspace(10) @mat_f32_2x3, ptr addrspace(10) @mat_f32_2x3, ptr addrspace(10) @mat_f32_2x3)
  call void @pow_half2x3(ptr addrspace(10) @mat_f16_2x3, ptr addrspace(10) @mat_f16_2x3, ptr addrspace(10) @mat_f16_2x3)
  call void @pow_float3x2(ptr addrspace(10) @mat_f32_3x2, ptr addrspace(10) @mat_f32_3x2, ptr addrspace(10) @mat_f32_3x2)
  call void @pow_float2x4(ptr addrspace(10) @mat_f32_2x4, ptr addrspace(10) @mat_f32_2x4, ptr addrspace(10) @mat_f32_2x4)
  call void @pow_float4x2(ptr addrspace(10) @mat_f32_4x2, ptr addrspace(10) @mat_f32_4x2, ptr addrspace(10) @mat_f32_4x2)
  call void @pow_float3x4(ptr addrspace(10) @mat_f32_3x4, ptr addrspace(10) @mat_f32_3x4, ptr addrspace(10) @mat_f32_3x4)
  call void @pow_half3x4(ptr addrspace(10) @mat_f16_3x4, ptr addrspace(10) @mat_f16_3x4, ptr addrspace(10) @mat_f16_3x4)
  call void @pow_float4x3(ptr addrspace(10) @mat_f32_4x3, ptr addrspace(10) @mat_f32_4x3, ptr addrspace(10) @mat_f32_4x3)
  call void @pow_half4x3(ptr addrspace(10) @mat_f16_4x3, ptr addrspace(10) @mat_f16_4x3, ptr addrspace(10) @mat_f16_4x3)
  call void @pow_float6_from_shuffle()
  call void @pow_half6()
  call void @pow_float8()
  call void @pow_half8()
  call void @pow_float9()
  call void @pow_half9()
  call void @pow_float12()
  call void @pow_half12()
  call void @pow_float16()
  call void @pow_half16()
  ret void
}
...
declare <3 x half> @llvm.pow.v3f16(<3 x half>, <3 x half>)
declare <2 x float> @llvm.pow.v2f32(<2 x float>, <2 x float>)
declare <2 x half> @llvm.pow.v2f16(<2 x half>, <2 x half>)
declare <6 x float> @llvm.pow.v6f32(<6 x float>, <6 x float>)
declare <6 x half> @llvm.pow.v6f16(<6 x half>, <6 x half>)
declare <8 x float> @llvm.pow.v8f32(<8 x float>, <8 x float>)
declare <8 x half> @llvm.pow.v8f16(<8 x half>, <8 x half>)
declare <9 x float> @llvm.pow.v9f32(<9 x float>, <9 x float>)
declare <9 x half> @llvm.pow.v9f16(<9 x half>, <9 x half>)
declare <12 x float> @llvm.pow.v12f32(<12 x float>, <12 x float>)
declare <12 x half> @llvm.pow.v12f16(<12 x half>, <12 x half>)
