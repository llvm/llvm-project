...
entry:
; CHECK: %[[#R:]] = OpAtomicXor %[[#ulong]] %[[#]] %[[#scope_wg]] %[[#mem_wg]] %[[#]]
  %r = call i64 @llvm.spv.interlocked.xor.i64.p3(ptr addrspace(3) @gs_i64, i64 %v)
  ret i64 %r
}
...
entry:
; CHECK: %[[#R:]] = OpAtomicXor %[[#ulong]] %[[#]] %[[#scope_dev]] %[[#mem_uniform]] %[[#]]
  %r = call i64 @llvm.spv.interlocked.xor.i64.p11(ptr addrspace(11) @dev_i64, i64 %v)
  ret i64 %r
}

declare i64 @llvm.spv.interlocked.xor.i64.p3(ptr addrspace(3), i64)
declare i64 @llvm.spv.interlocked.xor.i64.p11(ptr addrspace(11), i64)
