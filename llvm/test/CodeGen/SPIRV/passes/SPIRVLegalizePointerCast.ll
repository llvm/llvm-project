...
@outI64 = addrspace(10) global i64 zeroinitializer

; InterlockedOr on RWByteAddressBuffer lowers to atomicrmw or through i8 ptrcast.

define void @byteBufferAtomicOrI32() {
; CHECK-LABEL: define void @byteBufferAtomicOrI32(
; CHECK-NOT: call {{.*}}@llvm.spv.ptrcast
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 42 monotonic, align 4
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 1)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 2)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 2
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 3)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
entry:
  %handle = tail call target("spirv.VulkanBuffer", [0 x i8], 12, 0) @llvm.spv.resource.handlefrombinding(i32 0, i32 0, i32 1, i32 0, ptr nonnull @.str)
  %ptr = call ptr addrspace(11) @llvm.spv.resource.getpointer(target("spirv.VulkanBuffer", [0 x i8], 12, 0) %handle, i32 0)
  %old = atomicrmw or ptr addrspace(11) %ptr, i32 42 monotonic, align 4
  store i32 %old, ptr addrspace(10) @outI32, align 4
  ret void
}

define void @byteBufferAtomicOrI64() {
; CHECK-LABEL: define void @byteBufferAtomicOrI64(
; CHECK-NOT: call {{.*}}@llvm.spv.ptrcast
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 42 monotonic, align 8
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 1)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 2)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 2
...
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 4)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 4
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 5)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 6)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 2
; CHECK: call ptr addrspace(11) @llvm.spv.resource.getpointer{{.*}} i32 7)
; CHECK: atomicrmw or ptr addrspace(11) {{.*}}, i8 0 monotonic, align 1
entry:
  %handle = tail call target("spirv.VulkanBuffer", [0 x i8], 12, 0) @llvm.spv.resource.handlefrombinding(i32 0, i32 0, i32 1, i32 0, ptr nonnull @.str)
  %ptr = call ptr addrspace(11) @llvm.spv.resource.getpointer(target("spirv.VulkanBuffer", [0 x i8], 12, 0) %handle, i32 0)
  %old = atomicrmw or ptr addrspace(11) %ptr, i64 42 monotonic, align 8
  store i64 %old, ptr addrspace(10) @outI64, align 8
  ret void
}
