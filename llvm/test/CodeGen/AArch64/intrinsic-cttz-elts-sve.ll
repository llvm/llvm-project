...
; RUN: llc -enable-subreg-liveness -mtriple=aarch64-linux-gnu -mattr=+sve2p2 < %s | FileCheck %s --check-prefixes=CHECK,NONSTREAMING,SVE2P2
; RUN: llc -enable-subreg-liveness -mtriple=aarch64-linux-gnu -mattr=+sme2p2 -force-streaming < %s | FileCheck %s --check-prefixes=CHECK,STREAMING,SME2P2
...
; STREAMING-NEXT:    ret
;
; SVE2P2-LABEL: ctz_nxv32i1:
; SVE2P2:       // %bb.0:
; SVE2P2-NEXT:    ptrue p2.b
; SVE2P2-NEXT:    rdvl x10, #1
; SVE2P2-NEXT:    brkb p1.b, p2/z, p1.b
; SVE2P2-NEXT:    brkb p0.b, p2/z, p0.b
; SVE2P2-NEXT:    cntp x8, p1, p1.b
; SVE2P2-NEXT:    cntp x9, p0, p0.b
; SVE2P2-NEXT:    incb x8
; SVE2P2-NEXT:    cmp w9, w10
; SVE2P2-NEXT:    csel w0, w9, w8, ne
; SVE2P2-NEXT:    ret
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: vscale_4096_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p0.b
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: ctz_nxv2i1_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p1.d
; SME2P2-NEXT:    firstp x0, p1, p0.d
; SME2P2-NEXT:    ret
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: ctz_nxv3i1_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p1.s
; SME2P2-NEXT:    firstp x0, p1, p0.s
; SME2P2-NEXT:    ret
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: ctz_nxv4i1_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p1.s
; SME2P2-NEXT:    firstp x0, p1, p0.s
; SME2P2-NEXT:    ret
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: ctz_nxv8i1_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p1.h
; SME2P2-NEXT:    firstp x0, p1, p0.h
; SME2P2-NEXT:    ret
...
; SVE2P2-NEXT:    ret
;
; SME2P2-LABEL: ctz_nxv16i1_poison:
; SME2P2:       // %bb.0:
; SME2P2-NEXT:    ptrue p1.b
; SME2P2-NEXT:    firstp x0, p1, p0.b
; SME2P2-NEXT:    ret
