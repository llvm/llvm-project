...
; CHECK-NEXT:   bfi	x11, x10, #20, #8
; CHECK-NEXT:  	bfi	x15, x13, #20, #8
; CHECK-NEXT:  	bfi	x11, x12, #40, #8
; CHECK-NEXT:  	bfi	x15, x16, #40, #8
; CHECK-NEXT:  	lsr	x10, x9, #4
; CHECK-NEXT:  	lsr	x12, x14, #4
; CHECK-NEXT:  	bfi	x11, x9, #60, #4
; CHECK-NEXT:  	bfi	x15, x14, #60, #4
; CHECK-NEXT:  	strh	w10, [x1, #18]
; CHECK-NEXT:  	strh	w12, [x1, #8]
; CHECK-NEXT:  	stur	x11, [x1, #10]
; CHECK-NEXT:  	str	x15, [x1], #64
...
; CHECK-BE-NEXT:  	mov	w12, v1.s[2]
; CHECK-BE-NEXT:  	fmov	w13, s1
; CHECK-BE-NEXT:  	mov	w14, v0.s[2]
; CHECK-BE-NEXT:  	fmov	w15, s0
; CHECK-BE-NEXT:  	mov	w10, v1.s[3]
; CHECK-BE-NEXT:  	lsl	x9, x9, #40
; CHECK-BE-NEXT:  	mov	w16, v0.s[3]
; CHECK-BE-NEXT:  	lsl	x11, x11, #40
; CHECK-BE-NEXT:  	bfi	x9, x13, #60, #4
; CHECK-BE-NEXT:  	bfi	x11, x15, #60, #4
; CHECK-BE-NEXT:  	bfi	x9, x12, #20, #8
; CHECK-BE-NEXT:  	bfi	x11, x14, #20, #8
; CHECK-BE-NEXT:  	lsr	w12, w13, #4
; CHECK-BE-NEXT:  	lsr	w13, w15, #4
; CHECK-BE-NEXT:  	strh	w10, [x1, #18]
; CHECK-BE-NEXT:  	extr	x9, x12, x9, #16
; CHECK-BE-NEXT:  	strh	w16, [x1, #8]
; CHECK-BE-NEXT:  	extr	x10, x13, x11, #16
...
; CHECK-NEXT:  	mov.d	x15, v2[1]
; CHECK-NEXT:  	lsl	x9, x9, #39
; CHECK-NEXT:  	fmov	x13, d0
; CHECK-NEXT:  	fmov	x14, d1
; CHECK-NEXT:  	bfi	x9, x10, #6, #16
; CHECK-NEXT:  	lsl	x10, x11, #37
; CHECK-NEXT:  	lsl	x11, x12, #35
; CHECK-NEXT:  	fmov	x12, d2
; CHECK-NEXT:  	bfi	x10, x13, #4, #16
; CHECK-NEXT:  	bfi	x11, x14, #2, #16
; CHECK-NEXT:  	bfi	x12, x15, #33, #16
; CHECK-NEXT:  	stp	x10, x9, [x1, #16]
; CHECK-NEXT:  	stp	x12, x11, [x1], #128
...
; CHECK-BE-NEXT:  	mov	x13, v2.d[1]
; CHECK-BE-NEXT:  	strb	w9, [x1, #32]
; CHECK-BE-NEXT:  	bfi	x9, x10, #33, #16
; CHECK-BE-NEXT:  	ushll	v0.2d, v1.2s, #0
; CHECK-BE-NEXT:  	lsl	x10, x11, #2
; CHECK-BE-NEXT:  	fmov	x11, d2
; CHECK-BE-NEXT:  	lsl	x13, x13, #4
; CHECK-BE-NEXT:  	extr	x9, x10, x9, #8
; CHECK-BE-NEXT:  	bfi	x10, x12, #35, #16
; CHECK-BE-NEXT:  	mov	x12, v0.d[1]
; CHECK-BE-NEXT:  	extr	x10, x13, x10, #8
; CHECK-BE-NEXT:  	bfi	x13, x11, #37, #16
; CHECK-BE-NEXT:  	fmov	x11, d0
; CHECK-BE-NEXT:  	lsl	x12, x12, #6
; CHECK-BE-NEXT:  	stp	x10, x9, [x1, #16]
; CHECK-BE-NEXT:  	extr	x13, x12, x13, #8
; CHECK-BE-NEXT:  	bfi	x12, x11, #39, #16
; CHECK-BE-NEXT:  	extr	x11, xzr, x12, #8
; CHECK-BE-NEXT:  	stp	x11, x13, [x1], #128
