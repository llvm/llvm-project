...
; RUN: llc < %s -mtriple=aarch64 | FileCheck %s --check-prefix=LE
; RUN: llc < %s -mtriple=aarch64_be | FileCheck %s --check-prefix=BE

declare void @use_i64(i64)

define void @s2v_bitcast_be(i16 %x) nounwind {
