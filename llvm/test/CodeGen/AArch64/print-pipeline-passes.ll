...
; O0: {{^}}function(ee-instrument<>),materialize-kernel-info,always-inline,coro-cond(coro-early,cgscc(coro-split),coro-cleanup,globaldce),alloc-token,lower-comment-string,function(annotation-remarks),verify,print{{$}}
