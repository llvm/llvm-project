...
; CHECK-GI-NEXT:    str q4, [sp, #32] // 16-byte Folded Spill
; CHECK-GI-NEXT:    mov s11, v4.s[1]
...
; CHECK-GI-NEXT:    str s2, [sp, #92] // 4-byte Folded Spill
...
; CHECK-GI-NEXT:    ldr s1, [sp, #92] // 4-byte Folded Reload
; CHECK-GI-NEXT:    bl powf
...
; CHECK-GI-NEXT:    // kill: def $s0 killed $s0 def $q0
; CHECK-GI-NEXT:    ldr q3, [sp, #32] // 16-byte Folded Reload
...
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    sub sp, sp, #464
; CHECK-GI-NEXT:    stp d15, d14, [sp, #384] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp d13, d12, [sp, #400] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp d11, d10, [sp, #416] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp d9, d8, [sp, #432] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp x29, x30, [sp, #448] // 16-byte Folded Spill
; CHECK-GI-NEXT:    .cfi_def_cfa_offset 464
; CHECK-GI-NEXT:    .cfi_offset w30, -8
...
; CHECK-GI-NEXT:    mov h14, v2.h[1]
; CHECK-GI-NEXT:    mov h15, v2.h[2]
; CHECK-GI-NEXT:    mov h8, v2.h[3]
; CHECK-GI-NEXT:    mov h9, v2.h[4]
; CHECK-GI-NEXT:    mov h13, v2.h[5]
; CHECK-GI-NEXT:    str h4, [sp, #176] // 2-byte Folded Spill
; CHECK-GI-NEXT:    mov h4, v0.h[5]
; CHECK-GI-NEXT:    str h4, [sp, #128] // 2-byte Folded Spill
; CHECK-GI-NEXT:    mov h4, v0.h[6]
; CHECK-GI-NEXT:    str h4, [sp, #80] // 2-byte Folded Spill
; CHECK-GI-NEXT:    mov h4, v0.h[7]
; CHECK-GI-NEXT:    fcvt s0, h0
; CHECK-GI-NEXT:    str h4, [sp, #64] // 2-byte Folded Spill
; CHECK-GI-NEXT:    mov v4.16b, v1.16b
...
; CHECK-GI-NEXT:    ldr h0, [sp, #62] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt s1, h0
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
...
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
; CHECK-GI-NEXT:    ldr h1, [sp, #208] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt h0, s0
; CHECK-GI-NEXT:    fcvt s2, h1
; CHECK-GI-NEXT:    str q0, [sp, #208] // 16-byte Folded Spill
; CHECK-GI-NEXT:    ldr h0, [sp, #158] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt s1, h0
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
...
; CHECK-GI-NEXT:    ldr h0, [sp, #206] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt s1, h0
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
; CHECK-GI-NEXT:    ldr h1, [sp, #304] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt h0, s0
; CHECK-GI-NEXT:    fcvt s2, h1
; CHECK-GI-NEXT:    str q0, [sp, #304] // 16-byte Folded Spill
; CHECK-GI-NEXT:    ldr h0, [sp, #254] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt s1, h0
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
...
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
; CHECK-GI-NEXT:    ldr h1, [sp, #368] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt h0, s0
; CHECK-GI-NEXT:    fcvt s2, h1
; CHECK-GI-NEXT:    str q0, [sp, #368] // 16-byte Folded Spill
; CHECK-GI-NEXT:    ldr h0, [sp, #350] // 2-byte Folded Reload
; CHECK-GI-NEXT:    fcvt s1, h0
; CHECK-GI-NEXT:    fmov s0, s2
; CHECK-GI-NEXT:    bl powf
; CHECK-GI-NEXT:    ldr q1, [sp, #320] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldr q2, [sp, #256] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldr q3, [sp, #112] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp x29, x30, [sp, #448] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v1.h[1], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #160] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp d9, d8, [sp, #432] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v3.h[1], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #224] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp d11, d10, [sp, #416] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v1.h[2], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #208] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp d13, d12, [sp, #400] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v3.h[2], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #176] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp d15, d14, [sp, #384] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v1.h[3], v2.h[0]
...
; CHECK-GI-NEXT:    mov v1.h[4], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #304] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v3.h[4], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #80] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v1.h[5], v2.h[0]
; CHECK-GI-NEXT:    ldr q2, [sp, #352] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v3.h[5], v2.h[0]
; CHECK-GI-NEXT:    fcvt h2, s0
; CHECK-GI-NEXT:    ldr q0, [sp, #64] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v1.h[6], v0.h[0]
; CHECK-GI-NEXT:    ldr q0, [sp, #368] // 16-byte Folded Reload
