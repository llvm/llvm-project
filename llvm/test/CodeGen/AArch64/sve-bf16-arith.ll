...
; RUN: llc -mattr=+sve,+bf16                         < %s | FileCheck %s --check-prefixes=CHECK,NONSTREAMING,NOB16B16,NOB16B16-NONSTREAMING
; RUN: llc -mattr=+sve,+bf16,+sve-b16b16             < %s | FileCheck %s --check-prefixes=CHECK,NONSTREAMING,B16B16
; RUN: llc -mattr=+sme,+sve-b16b16 -force-streaming  < %s | FileCheck %s --check-prefixes=CHECK,STREAMING,NOB16B16,NOB16B16-STREAMING
; RUN: llc -mattr=+sme2,+sve-b16b16 -force-streaming < %s | FileCheck %s --check-prefixes=CHECK,STREAMING,B16B16
...
; NOB16B16-NONSTREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip2 z4.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fadd z2.s, z4.s, z3.s
; NOB16B16-NONSTREAMING-NEXT:    fadd z0.s, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
...
; NOB16B16-STREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip2 z4.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fadd z2.s, z4.s, z3.s
; NOB16B16-STREAMING-NEXT:    fadd z0.s, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
...
; NOB16B16-NONSTREAMING-LABEL: fmax_nxv8bf16:
; NOB16B16-NONSTREAMING:       // %bb.0:
; NOB16B16-NONSTREAMING-NEXT:    movi v2.2d, #0000000000000000
; NOB16B16-NONSTREAMING-NEXT:    ptrue p0.s
; NOB16B16-NONSTREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fmax z3.s, p0/m, z3.s, z4.s
; NOB16B16-NONSTREAMING-NEXT:    fmax z0.s, p0/m, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    ret
;
...
; B16B16-NEXT:    ret
;
; NOB16B16-STREAMING-LABEL: fmax_nxv8bf16:
; NOB16B16-STREAMING:       // %bb.0:
; NOB16B16-STREAMING-NEXT:    mov z2.h, #0 // =0x0
; NOB16B16-STREAMING-NEXT:    ptrue p0.s
; NOB16B16-STREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fmax z3.s, p0/m, z3.s, z4.s
; NOB16B16-STREAMING-NEXT:    fmax z0.s, p0/m, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    ret
...
; NOB16B16-NONSTREAMING-LABEL: fmaxnm_nxv8bf16:
; NOB16B16-NONSTREAMING:       // %bb.0:
; NOB16B16-NONSTREAMING-NEXT:    movi v2.2d, #0000000000000000
; NOB16B16-NONSTREAMING-NEXT:    ptrue p0.s
; NOB16B16-NONSTREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fmaxnm z3.s, p0/m, z3.s, z4.s
; NOB16B16-NONSTREAMING-NEXT:    fmaxnm z0.s, p0/m, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    ret
...
; B16B16-NEXT:    ret
;
; NOB16B16-STREAMING-LABEL: fmaxnm_nxv8bf16:
; NOB16B16-STREAMING:       // %bb.0:
; NOB16B16-STREAMING-NEXT:    mov z2.h, #0 // =0x0
; NOB16B16-STREAMING-NEXT:    ptrue p0.s
; NOB16B16-STREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fmaxnm z3.s, p0/m, z3.s, z4.s
; NOB16B16-STREAMING-NEXT:    fmaxnm z0.s, p0/m, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    ret
...
; NOB16B16-NONSTREAMING-LABEL: fmin_nxv8bf16:
; NOB16B16-NONSTREAMING:       // %bb.0:
; NOB16B16-NONSTREAMING-NEXT:    movi v2.2d, #0000000000000000
; NOB16B16-NONSTREAMING-NEXT:    ptrue p0.s
; NOB16B16-NONSTREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fmin z3.s, p0/m, z3.s, z4.s
; NOB16B16-NONSTREAMING-NEXT:    fmin z0.s, p0/m, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    ret
...
; B16B16-NEXT:    ret
;
; NOB16B16-STREAMING-LABEL: fmin_nxv8bf16:
; NOB16B16-STREAMING:       // %bb.0:
; NOB16B16-STREAMING-NEXT:    mov z2.h, #0 // =0x0
; NOB16B16-STREAMING-NEXT:    ptrue p0.s
; NOB16B16-STREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fmin z3.s, p0/m, z3.s, z4.s
; NOB16B16-STREAMING-NEXT:    fmin z0.s, p0/m, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    ret
...
; NOB16B16-NONSTREAMING-LABEL: fminnm_nxv8bf16:
; NOB16B16-NONSTREAMING:       // %bb.0:
; NOB16B16-NONSTREAMING-NEXT:    movi v2.2d, #0000000000000000
; NOB16B16-NONSTREAMING-NEXT:    ptrue p0.s
; NOB16B16-NONSTREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fminnm z3.s, p0/m, z3.s, z4.s
; NOB16B16-NONSTREAMING-NEXT:    fminnm z0.s, p0/m, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    ret
...
; B16B16-NEXT:    ret
;
; NOB16B16-STREAMING-LABEL: fminnm_nxv8bf16:
; NOB16B16-STREAMING:       // %bb.0:
; NOB16B16-STREAMING-NEXT:    mov z2.h, #0 // =0x0
; NOB16B16-STREAMING-NEXT:    ptrue p0.s
; NOB16B16-STREAMING-NEXT:    zip2 z3.h, z2.h, z1.h
...
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fminnm z3.s, p0/m, z3.s, z4.s
; NOB16B16-STREAMING-NEXT:    fminnm z0.s, p0/m, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z3.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    ret
...
; NOB16B16-NONSTREAMING-LABEL: fmla_nxv8bf16:
; NOB16B16-NONSTREAMING:       // %bb.0:
; NOB16B16-NONSTREAMING-NEXT:    movi v3.2d, #0000000000000000
; NOB16B16-NONSTREAMING-NEXT:    uunpkhi z4.s, z1.h
; NOB16B16-NONSTREAMING-NEXT:    uunpkhi z5.s, z0.h
; NOB16B16-NONSTREAMING-NEXT:    uunpklo z1.s, z1.h
; NOB16B16-NONSTREAMING-NEXT:    uunpklo z0.s, z0.h
; NOB16B16-NONSTREAMING-NEXT:    ptrue p0.s
; NOB16B16-NONSTREAMING-NEXT:    zip2 z6.h, z3.h, z2.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z2.h, z3.h, z2.h
; NOB16B16-NONSTREAMING-NEXT:    bfmlalb z6.s, z5.h, z4.h
; NOB16B16-NONSTREAMING-NEXT:    bfmlalb z2.s, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z6.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z1.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    ret
;
...
; B16B16-NEXT:    ret
;
; NOB16B16-STREAMING-LABEL: fmla_nxv8bf16:
; NOB16B16-STREAMING:       // %bb.0:
; NOB16B16-STREAMING-NEXT:    mov z3.h, #0 // =0x0
; NOB16B16-STREAMING-NEXT:    uunpkhi z4.s, z1.h
; NOB16B16-STREAMING-NEXT:    uunpkhi z5.s, z0.h
; NOB16B16-STREAMING-NEXT:    uunpklo z1.s, z1.h
; NOB16B16-STREAMING-NEXT:    uunpklo z0.s, z0.h
; NOB16B16-STREAMING-NEXT:    ptrue p0.s
; NOB16B16-STREAMING-NEXT:    zip2 z6.h, z3.h, z2.h
; NOB16B16-STREAMING-NEXT:    zip1 z2.h, z3.h, z2.h
; NOB16B16-STREAMING-NEXT:    bfmlalb z6.s, z5.h, z4.h
; NOB16B16-STREAMING-NEXT:    bfmlalb z2.s, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z6.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z1.h, z0.h
; NOB16B16-STREAMING-NEXT:    ret
...
; NONSTREAMING-LABEL: fsqrt_nxv8bf16:
; NONSTREAMING:       // %bb.0:
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: fsqrt_nxv8bf16:
; STREAMING:       // %bb.0:
...
; NOB16B16-NONSTREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-NONSTREAMING-NEXT:    fsub z2.s, z4.s, z3.s
; NOB16B16-NONSTREAMING-NEXT:    fsub z0.s, z0.s, z1.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-NONSTREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-NONSTREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-NONSTREAMING-NEXT:    ret
...
; NOB16B16-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; NOB16B16-STREAMING-NEXT:    zip1 z0.h, z2.h, z0.h
; NOB16B16-STREAMING-NEXT:    fsub z2.s, z4.s, z3.s
; NOB16B16-STREAMING-NEXT:    fsub z0.s, z0.s, z1.s
; NOB16B16-STREAMING-NEXT:    bfcvt z1.h, p0/m, z2.s
; NOB16B16-STREAMING-NEXT:    bfcvt z0.h, p0/m, z0.s
; NOB16B16-STREAMING-NEXT:    uzp1 z0.h, z0.h, z1.h
; NOB16B16-STREAMING-NEXT:    ret
