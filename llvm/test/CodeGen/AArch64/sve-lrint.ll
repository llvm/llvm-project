...
define <vscale x 16 x iXLen> @lrint_v16iXLen_v16f16(<vscale x 16 x half> %x) {
...
define <vscale x 32 x iXLen> @lrint_v32iXLen_v32f16(<vscale x 32 x half> %x) {
...
define <vscale x 16 x iXLen> @lrint_v16iXLen_v16f32(<vscale x 16 x float> %x) {
...
define <vscale x 32 x iXLen> @lrint_v32iXLen_v32f32(<vscale x 32 x float> %x) {
