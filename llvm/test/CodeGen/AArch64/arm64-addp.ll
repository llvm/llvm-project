...
; RUN: llc < %s -mtriple=arm64-eabi -aarch64-neon-syntax=apple -mcpu=cyclone | FileCheck %s --check-prefixes=CHECK,CHECK-SD
; RUN: llc < %s -mtriple=arm64-eabi -aarch64-neon-syntax=apple -mcpu=cyclone -global-isel | FileCheck %s --check-prefixes=CHECK,CHECK-GI
...
; CHECK-SD-LABEL: foo0_or:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    addp.2d d0, v0
; CHECK-SD-NEXT:    fmov x0, d0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: foo0_or:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov.d x8, v0[1]
; CHECK-GI-NEXT:    fmov x9, d0
...
; CHECK-SD-LABEL: addp_v4i64:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    addp.2d v1, v0, v1
; CHECK-SD-NEXT:    dup.2d v0, v1[0]
; CHECK-SD-NEXT:    dup.2d v1, v1[1]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: addp_v4i64:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    ext.16b v2, v0, v0, #8
; CHECK-GI-NEXT:    ext.16b v3, v1, v1, #8
; CHECK-GI-NEXT:    add.2d v0, v2, v0
; CHECK-GI-NEXT:    add.2d v1, v3, v1
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-SD-LABEL: addp_v8i32:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    addp.4s v1, v0, v1
; CHECK-SD-NEXT:    zip1.4s v0, v1, v1
; CHECK-SD-NEXT:    zip2.4s v1, v1, v1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: addp_v8i32:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    rev64.4s v2, v0
; CHECK-GI-NEXT:    rev64.4s v3, v1
; CHECK-GI-NEXT:    add.4s v0, v2, v0
; CHECK-GI-NEXT:    add.4s v1, v3, v1
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-SD-LABEL: addp_v16i32:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    addp.4s v1, v0, v1
; CHECK-SD-NEXT:    zip1.4s v0, v1, v1
; CHECK-SD-NEXT:    zip2.4s v1, v1, v1
; CHECK-SD-NEXT:    addp.4s v3, v2, v3
; CHECK-SD-NEXT:    zip1.4s v2, v3, v3
; CHECK-SD-NEXT:    zip2.4s v3, v3, v3
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: addp_v16i32:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    rev64.4s v4, v0
; CHECK-GI-NEXT:    rev64.4s v5, v1
; CHECK-GI-NEXT:    rev64.4s v6, v2
; CHECK-GI-NEXT:    rev64.4s v7, v3
; CHECK-GI-NEXT:    add.4s v0, v4, v0
; CHECK-GI-NEXT:    add.4s v1, v5, v1
; CHECK-GI-NEXT:    add.4s v2, v6, v2
; CHECK-GI-NEXT:    add.4s v3, v7, v3
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-SD-LABEL: addp_v16i16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    addp.8h v1, v0, v1
; CHECK-SD-NEXT:    zip1.8h v0, v1, v1
; CHECK-SD-NEXT:    zip2.8h v1, v1, v1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: addp_v16i16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    rev32.8h v2, v0
; CHECK-GI-NEXT:    rev32.8h v3, v1
; CHECK-GI-NEXT:    add.8h v0, v2, v0
; CHECK-GI-NEXT:    add.8h v1, v3, v1
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-SD-LABEL: addp_v32i8:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    addp.16b v1, v0, v1
; CHECK-SD-NEXT:    zip1.16b v0, v1, v1
; CHECK-SD-NEXT:    zip2.16b v1, v1, v1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: addp_v32i8:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    rev16.16b v2, v0
; CHECK-GI-NEXT:    rev16.16b v3, v1
; CHECK-GI-NEXT:    add.16b v0, v2, v0
; CHECK-GI-NEXT:    add.16b v1, v3, v1
; CHECK-GI-NEXT:    ret
entry:
