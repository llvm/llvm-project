...
; VBITS_GE_256-NEXT:    cmpne p1.s, p0/z, z2.s, #0
; VBITS_GE_256-NEXT:    mov z1.s, p1/m, z3.s
; VBITS_GE_256-NEXT:    sdivr z1.s, p0/m, z1.s, z2.s
...
; VBITS_GE_256-NEXT:    sdiv z0.d, p0/m, z0.d, z4.d
...
; VBITS_GE_256-NEXT:    cmpne p1.s, p0/z, z2.s, #0
; VBITS_GE_256-NEXT:    mov z1.s, p1/m, z3.s
; VBITS_GE_256-NEXT:    udivr z1.s, p0/m, z1.s, z2.s
; VBITS_GE_256-NEXT:    st1w { z0.s }, p0, [x0, x8, lsl #2]
; VBITS_GE_256-NEXT:    st1w { z1.s }, p0, [x0]
; VBITS_GE_256-NEXT:    ret
;
...
; VBITS_GE_256-NEXT:    sel z4.d, p2, z4.d, z3.d
; VBITS_GE_256-NEXT:    sel z2.d, p1, z2.d, z3.d
; VBITS_GE_256-NEXT:    udiv z0.d, p0/m, z0.d, z4.d
