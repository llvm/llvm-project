...
; CHECK-GI-NEXT:    ldr q1, [sp] // 16-byte Reload
; CHECK-GI-NEXT:    fmov x8, d10
; CHECK-GI-NEXT:    fcsel d11, d0, d8, gt
; CHECK-GI-NEXT:    mov v0.d[0], x8
...
; CHECK-GI-NEXT:    fcsel d10, d3, d8, gt
; CHECK-GI-NEXT:    fmov x8, d10
; CHECK-GI-NEXT:    fcsel d11, d0, d8, gt
; CHECK-GI-NEXT:    mov v0.d[0], x8
; CHECK-GI-NEXT:    fmov x8, d11
...
; CHECK-GI-NEXT:    fcsel d10, d4, d8, gt
; CHECK-GI-NEXT:    fmov x8, d10
; CHECK-GI-NEXT:    fcsel d11, d0, d8, gt
; CHECK-GI-NEXT:    mov v0.d[0], x8
; CHECK-GI-NEXT:    fmov x8, d11
...
; CHECK-GI-NEXT:    fcsel d0, d9, d11, mi
; CHECK-GI-NEXT:    fmov d9, x8
; CHECK-GI-NEXT:    fmov x8, d0
; CHECK-GI-NEXT:    fcsel d1, d10, d9, mi
; CHECK-GI-NEXT:    mov v0.d[0], x8
...
; CHECK-GI-NEXT:    ldr q1, [sp] // 16-byte Reload
; CHECK-GI-NEXT:    fmov x8, d10
; CHECK-GI-NEXT:    fcsel d8, d0, d8, gt
; CHECK-GI-NEXT:    mov v0.d[0], x8
; CHECK-GI-NEXT:    fmov x8, d8
; CHECK-GI-NEXT:    mov v0.d[1], x8
; CHECK-GI-NEXT:    bl __lttf2
; CHECK-GI-NEXT:    cmp w0, #0
; CHECK-GI-NEXT:    fcsel d0, d10, d11, mi
; CHECK-GI-NEXT:    fcsel d1, d8, d9, mi
; CHECK-GI-NEXT:    fmov x8, d0
; CHECK-GI-NEXT:    mov v0.d[0], x8
; CHECK-GI-NEXT:    fmov x8, d1
; CHECK-GI-NEXT:    mov v0.d[1], x8
