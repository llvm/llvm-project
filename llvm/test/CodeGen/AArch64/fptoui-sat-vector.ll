...
; CHECK-GI-NEXT:    stp q2, q1, [sp, #48] // 32-byte Folded Spill
...
; CHECK-GI-NEXT:    fcsel d0, d0, d8, mi
; CHECK-GI-NEXT:    fcsel d1, d1, d9, mi
; CHECK-GI-NEXT:    mov v0.d[0], v0.d[0]
; CHECK-GI-NEXT:    mov v0.d[1], v1.d[0]
; CHECK-GI-NEXT:    bl __fixunstfsi
...
; CHECK-GI-NEXT:    str x30, [sp, #112] // 8-byte Spill
...
; CHECK-GI-NEXT:    stp q1, q0, [sp, #32] // 32-byte Folded Spill
; CHECK-GI-NEXT:    ldr q1, [x8, :lo12:.LCPI16_2]
; CHECK-GI-NEXT:    stp q1, q2, [sp, #64] // 32-byte Folded Spill
; CHECK-GI-NEXT:    bl __gttf2
; CHECK-GI-NEXT:    movi d8, #0000000000000000
...
; CHECK-GI-NEXT:    ldr d9, [x8, :lo12:.LCPI16_0]
; CHECK-GI-NEXT:    fcsel d0, d0, d8, mi
; CHECK-GI-NEXT:    fcsel d1, d1, d9, mi
; CHECK-GI-NEXT:    mov v0.d[0], v0.d[0]
; CHECK-GI-NEXT:    mov v0.d[1], v1.d[0]
...
; CHECK-GI-NEXT:    ldr x30, [sp, #112] // 8-byte Reload
...
; CHECK-GI-NEXT:    str q0, [sp, #80] // 16-byte Spill
; CHECK-GI-NEXT:    str q3, [sp, #64] // 16-byte Spill
...
; CHECK-GI-NEXT:    ldr d9, [x8, :lo12:.LCPI17_0]
; CHECK-GI-NEXT:    fcsel d0, d0, d8, mi
; CHECK-GI-NEXT:    fcsel d1, d1, d9, mi
; CHECK-GI-NEXT:    mov v0.d[0], v0.d[0]
; CHECK-GI-NEXT:    mov v0.d[1], v1.d[0]
...
; CHECK-GI-NEXT:    stp d9, d8, [sp, #96] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp x30, x19, [sp, #112] // 16-byte Folded Spill
...
; CHECK-GI-NEXT:    str q1, [sp, #32] // 16-byte Spill
; CHECK-GI-NEXT:    bl __lttf2
; CHECK-GI-NEXT:    mov x8, #281200098803712 // =0xffc000000000
; CHECK-GI-NEXT:    ldp q0, q1, [sp] // 32-byte Folded Reload
; CHECK-GI-NEXT:    movk x8, #17391, lsl #48
; CHECK-GI-NEXT:    cmp w0, #0
; CHECK-GI-NEXT:    fmov d9, x8
; CHECK-GI-NEXT:    mov x8, #-264157668573185 // =0xffff0fbfffffffff
; CHECK-GI-NEXT:    movk x8, #17360, lsl #48
; CHECK-GI-NEXT:    fmov d10, x8
; CHECK-GI-NEXT:    fcsel d0, d0, d9, mi
...
; CHECK-GI-NEXT:    ldp x30, x19, [sp, #112] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp d9, d8, [sp, #96] // 16-byte Folded Reload
