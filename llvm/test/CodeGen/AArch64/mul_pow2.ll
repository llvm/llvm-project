...
; CHECK-SD-LABEL: test11_fast_shift:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    add w8, w0, w0, lsl #2
; CHECK-SD-NEXT:    add w0, w0, w8, lsl #1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test11_fast_shift:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #11 // =0xb
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #4
; CHECK-SD-NEXT:    sub w0, w8, w0, lsl #1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test14:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #14 // =0xe
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: test25_fast_shift:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    add w8, w0, w0, lsl #2
; CHECK-SD-NEXT:    add w0, w8, w8, lsl #2
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test25_fast_shift:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: test29_fast_shift:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    sub w8, w0, w0, lsl #3
; CHECK-SD-NEXT:    sub w0, w0, w8, lsl #2
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test29_fast_shift:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: test45_fast_shift:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    add w8, w0, w0, lsl #2
; CHECK-SD-NEXT:    add w0, w8, w8, lsl #3
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test45_fast_shift:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #45 // =0x2d
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: test85_fast_shift:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    add w8, w0, w0, lsl #2
; CHECK-SD-NEXT:    add w0, w8, w8, lsl #4
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test85_fast_shift:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #85 // =0x55
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ntest2:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    neg w0, w0, lsl #1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest2:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: ntest4:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    neg w0, w0, lsl #2
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest4:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: ntest6:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #1
; CHECK-SD-NEXT:    sub w0, w8, w0, lsl #3
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest6:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #-6 // =0xfffffffa
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ntest8:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    neg w0, w0, lsl #3
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest8:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: ntest12:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #2
; CHECK-SD-NEXT:    sub w0, w8, w0, lsl #4
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest12:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #-12 // =0xfffffff4
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ntest14:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #1
; CHECK-SD-NEXT:    sub w0, w8, w0, lsl #4
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest14:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #-14 // =0xfffffff2
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ntest16:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    neg w0, w0, lsl #4
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ntest16:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: muladd_demand:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    sub w8, w1, w0, lsl #6
; CHECK-SD-NEXT:    and w0, w8, #0x1ffc0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: muladd_demand:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #131008 // =0x1ffc0
; CHECK-GI-NEXT:    madd w8, w0, w8, w1
; CHECK-GI-NEXT:    and w0, w8, #0x1ffc0
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: muladd_demand_commute:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    shl v0.4s, v0.4s, #6
; CHECK-SD-NEXT:    movi v2.4s, #1, msl #16
; CHECK-SD-NEXT:    sub v0.4s, v1.4s, v0.4s
; CHECK-SD-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: muladd_demand_commute:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    adrp x8, .LCPI56_0
; CHECK-GI-NEXT:    movi v3.4s, #1, msl #16
; CHECK-GI-NEXT:    ldr q2, [x8, :lo12:.LCPI56_0]
; CHECK-GI-NEXT:    mla v1.4s, v0.4s, v2.4s
...
; CHECK-SD-LABEL: shift_no_overflow:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #31
; CHECK-SD-NEXT:    sub w0, w8, w0, lsl #30
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shift_no_overflow:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mov w8, #1073741824 // =0x40000000
; CHECK-GI-NEXT:    mul w0, w0, w8
; CHECK-GI-NEXT:    ret
