...
; WINDOWS-NEXT:    add x8, sp, #28
; WINDOWS-NEXT:    ldr x30, [sp, #16] // 8-byte Reload
; WINDOWS-NEXT:    ld1 { v0.s }[1], [x8]
; WINDOWS-NEXT:    // kill: def $d0 killed $d0 killed $q0
...
; WINDOWS-NEXT:    ldr x30, [sp, #48] // 8-byte Reload
; WINDOWS-NEXT:    ld1 { v1.s }[1], [x8]
; WINDOWS-NEXT:    add x8, sp, #56
; WINDOWS-NEXT:    mov v0.s[3], v2.s[0]
; WINDOWS-NEXT:    ld1 { v1.s }[2], [x8]
; WINDOWS-NEXT:    add x8, sp, #60
; WINDOWS-NEXT:    ld1 { v1.s }[3], [x8]
; WINDOWS-NEXT:    add sp, sp, #64
; WINDOWS-NEXT:    ret
...
; WINDOWS-NEXT:    ld1 { v0.s }[1], [x8]
; WINDOWS-NEXT:    add x8, sp, #40
; WINDOWS-NEXT:    ld1 { v0.s }[2], [x8]
; WINDOWS-NEXT:    add x8, sp, #44
; WINDOWS-NEXT:    ld1 { v0.s }[3], [x8]
