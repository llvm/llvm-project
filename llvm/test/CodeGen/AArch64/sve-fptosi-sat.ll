...
; CHECK-NEXT:    fcmgt p7.d, p0/z, z1.d, z6.d
; CHECK-NEXT:    sel z7.d, p1, z7.d, z5.d
; CHECK-NEXT:    fcmgt p1.d, p0/z, z0.d, z6.d
; CHECK-NEXT:    sel z6.d, p2, z24.d, z5.d
; CHECK-NEXT:    sel z24.d, p3, z25.d, z5.d
; CHECK-NEXT:    mov z5.d, p4/m, z26.d
...
; CHECK-NEXT:    sel z0.d, p6, z4.d, z6.d
; CHECK-NEXT:    ldr p6, [sp, #5, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    sel z1.d, p7, z4.d, z24.d
; CHECK-NEXT:    sel z3.d, p1, z4.d, z5.d
; CHECK-NEXT:    ldr p7, [sp, #4, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    ldr p5, [sp, #6, mul vl] // 2-byte Folded Reload
...
; CHECK-NEXT:    mov w8, #31743 // =0x7bff
; CHECK-NEXT:    movprfx z2, z0
; CHECK-NEXT:    fcvtzs z2.s, p0/m, z0.h
; CHECK-NEXT:    mov z3.h, w8
; CHECK-NEXT:    fcmge p1.h, p0/z, z0.h, z1.h
; CHECK-NEXT:    mov z1.s, #0x80000000
; CHECK-NEXT:    fcmgt p2.h, p0/z, z0.h, z3.h
...
; CHECK-NEXT:    movprfx z6, z0
; CHECK-NEXT:    fcvtzs z6.s, p0/m, z0.h
...
; CHECK-NEXT:    mov z3.h, #-32768 // =0xffffffffffff8000
; CHECK-NEXT:    mov z1.h, w8
; CHECK-NEXT:    mov w8, #30719 // =0x77ff
; CHECK-NEXT:    movprfx z2, z0
; CHECK-NEXT:    fcvtzs z2.h, p0/m, z0.h
; CHECK-NEXT:    fcmge p1.h, p0/z, z0.h, z1.h
; CHECK-NEXT:    mov z1.h, w8
; CHECK-NEXT:    fcmgt p2.h, p0/z, z0.h, z1.h
; CHECK-NEXT:    mov z1.h, #32767 // =0x7fff
; CHECK-NEXT:    fcmuo p0.h, p0/z, z0.h, z0.h
; CHECK-NEXT:    sel z2.h, p1, z2.h, z3.h
