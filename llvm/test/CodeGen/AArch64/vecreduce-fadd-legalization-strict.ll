...
; CHECK-GI:       warning: Instruction selection used fallback path for test_v1f16
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f16_neutral
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f32
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f32_neutral
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f64
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f64_neutral
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f128
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test_v1f128_neutral
