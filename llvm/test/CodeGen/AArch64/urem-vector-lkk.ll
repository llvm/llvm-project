...
; CHECK:       // %bb.0:
; CHECK-NEXT:    mov w8, #44149 // =0xac75
; CHECK-NEXT:    dup v1.4h, w8
; CHECK-NEXT:    umull v1.4s, v0.4h, v1.4h
; CHECK-NEXT:    shrn v1.4h, v1.4s, #16
; CHECK-NEXT:    sub v2.4h, v0.4h, v1.4h
; CHECK-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-NEXT:    shrn v2.4h, v2.4s, #1
; CHECK-NEXT:    add v1.4h, v2.4h, v1.4h
; CHECK-NEXT:    movi v2.4h, #95
; CHECK-NEXT:    ushr v1.4h, v1.4h, #6
; CHECK-NEXT:    mls v0.4h, v1.4h, v2.4h
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    add v1.4h, v2.4h, v1.4h
; CHECK-NEXT:    movi v2.4h, #95
; CHECK-NEXT:    ushr v3.4h, v1.4h, #6
; CHECK-NEXT:    mls v0.4h, v3.4h, v2.4h
; CHECK-NEXT:    usra v0.4h, v1.4h, #6
; CHECK-NEXT:    ret
  %1 = urem <4 x i16> %x, <i16 95, i16 95, i16 95, i16 95>
