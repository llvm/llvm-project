...
define i32 @test_bittest(i16 %p) {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 114
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[ICMP1:%[0-9]+]]:_(i1) = G_ICMP intpred(eq), [[ZEXT]](i32), [[C]]
  ...
  ; CHECK-NEXT:   [[ICMP2:%[0-9]+]]:_(i1) = G_ICMP intpred(ne), [[AND]](i64), [[C7]]
...
define void @test_bittest_2_bt(i32 %p) {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 176
  ; CHECK-NEXT:   [[SUB:%[0-9]+]]:_(i32) = G_SUB [[COPY]], [[C]]
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 15
  ; CHECK-NEXT:   [[ICMP:%[0-9]+]]:_(i1) = G_ICMP intpred(ugt), [[SUB]](i32), [[C1]]
  ; CHECK-NEXT:   G_BRCOND [[ICMP]](i1), %bb.5
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[C4]], [[SUB]](i32)
  ; CHECK-NEXT:   [[C5:%[0-9]+]]:_(i32) = G_CONSTANT i32 57351
  ; CHECK-NEXT:   [[AND:%[0-9]+]]:_(i32) = G_AND [[SHL]], [[C5]]
  ; CHECK-NEXT:   [[C6:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[ICMP2:%[0-9]+]]:_(i1) = G_ICMP intpred(ne), [[AND]](i32), [[C6]]
  ...
  ; CHECK-NEXT:   [[ICMP3:%[0-9]+]]:_(i1) = G_ICMP intpred(ne), [[AND1]](i64), [[C9]]
...
define i32 @test_bittest_single_bt_only_with_fallthrough(i16 %p) {
  ...
  ; CHECK-NEXT:   [[ICMP1:%[0-9]+]]:_(i1) = G_ICMP intpred(ne), [[AND]](i64), [[C6]]
  ; CHECK-NEXT:   G_BRCOND [[ICMP1]](i1), %bb.3
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.2.sw.epilog:
  ; CHECK-NEXT:   $w0 = COPY [[C1]](i32)
...
define void @bit_test_block_incomplete_phi() {
  ...
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[SUB:%[0-9]+]]:_(i32) = G_SUB [[DEF]], [[C2]]
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.5.entry:
  ; CHECK-NEXT:   successors: %bb.3(0x51745d17), %bb.4(0x2e8ba2e9)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[C3]], [[SUB]](i32)
  ; CHECK-NEXT:   [[C4:%[0-9]+]]:_(i32) = G_CONSTANT i32 491
  ; CHECK-NEXT:   [[AND:%[0-9]+]]:_(i32) = G_AND [[SHL]], [[C4]]
  ; CHECK-NEXT:   [[C5:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[ICMP:%[0-9]+]]:_(i1) = G_ICMP intpred(ne), [[AND]](i32), [[C5]]
  ...
  ; CHECK-NEXT:   [[PHI:%[0-9]+]]:_(i1) = G_PHI [[C]](i1), %bb.3, [[C1]](i1), %bb.5
  ; CHECK-NEXT:   RET_ReallyLR
entry:
...
define i32 @test_odd_type(i328 %p) {
  ...
  ; CHECK-NEXT:   successors: %bb.3(0x40000000), %bb.2(0x40000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[ICMP1:%[0-9]+]]:_(i1) = G_ICMP intpred(eq), [[TRUNC]](i328), [[C]]
  ; CHECK-NEXT:   G_BRCOND [[ICMP1]](i1), %bb.3
  ; CHECK-NEXT:   G_BR %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.5 (%ir-block.0):
...
define i32 @test_large_pow2_type(i256 %p) {
  ...
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i64) = COPY $x2
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(i64) = COPY $x3
  ; CHECK-NEXT:   [[MV:%[0-9]+]]:_(i256) = G_MERGE_VALUES [[COPY]](i64), [[COPY1]](i64), [[COPY2]](i64), [[COPY3]](i64)
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i256) = G_CONSTANT i256 114
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 42
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ...
  ; CHECK-NEXT:   successors: %bb.3(0x40000000), %bb.2(0x40000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[ICMP1:%[0-9]+]]:_(i1) = G_ICMP intpred(eq), [[MV]](i256), [[C]]
  ; CHECK-NEXT:   G_BRCOND [[ICMP1]](i1), %bb.3
  ; CHECK-NEXT:   G_BR %bb.2
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.5 (%ir-block.0):
