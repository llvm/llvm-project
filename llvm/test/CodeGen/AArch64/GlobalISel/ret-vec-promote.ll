...
define <4 x i1> @ret_v4i1(ptr %v) {
  ...
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(<4 x i1>) = G_LOAD [[COPY]](p0) :: (load (<4 x i1>) from %ir.v)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(<4 x i16>) = G_ANYEXT [[LOAD]](<4 x i1>)
  ; CHECK-NEXT:   $d0 = COPY [[ANYEXT]](<4 x i16>)
...
define <1 x i12> @ret_v1i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
...
define <2 x i12> @ret_v2i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<2 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<2 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<2 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC1]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(<2 x i32>) = G_ANYEXT [[IVEC1]](<2 x i12>)
...
define <3 x i12> @ret_v3i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<3 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<3 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<3 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC1]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<3 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC1]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(i12), [[UV1:%[0-9]+]]:_(i12), [[UV2:%[0-9]+]]:_(i12) = G_UNMERGE_VALUES [[IVEC2]](<3 x i12>)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[UV]](i12)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(i32) = G_ANYEXT [[UV1]](i12)
  ; CHECK-NEXT:   [[ANYEXT2:%[0-9]+]]:_(i32) = G_ANYEXT [[UV2]](i12)
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT]](i32)
  ; CHECK-NEXT:   $w1 = COPY [[ANYEXT1]](i32)
  ; CHECK-NEXT:   $w2 = COPY [[ANYEXT2]](i32)
...
define <4 x i12> @ret_v4i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<4 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<4 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<4 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC1]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<4 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<4 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(<4 x i16>) = G_ANYEXT [[IVEC3]](<4 x i12>)
  ; CHECK-NEXT:   $d0 = COPY [[ANYEXT]](<4 x i16>)
  ; CHECK-NEXT:   RET_ReallyLR implicit $d0
...
define <5 x i12> @ret_v5i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<5 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ; CHECK-NEXT:   [[C4:%[0-9]+]]:_(i64) = G_CONSTANT i64 4
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<5 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC1]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<5 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<5 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<5 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[IVEC4:%[0-9]+]]:_(<5 x i12>) = G_INSERT_VECTOR_ELT [[IVEC3]], [[TRUNC1]](i12), [[C4]](i64)
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(i12), [[UV1:%[0-9]+]]:_(i12), [[UV2:%[0-9]+]]:_(i12), [[UV3:%[0-9]+]]:_(i12), [[UV4:%[0-9]+]]:_(i12) = G_UNMERGE_VALUES [[IVEC4]](<5 x i12>)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[UV]](i12)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(i32) = G_ANYEXT [[UV1]](i12)
  ; CHECK-NEXT:   [[ANYEXT2:%[0-9]+]]:_(i32) = G_ANYEXT [[UV2]](i12)
  ; CHECK-NEXT:   [[ANYEXT3:%[0-9]+]]:_(i32) = G_ANYEXT [[UV3]](i12)
  ; CHECK-NEXT:   [[ANYEXT4:%[0-9]+]]:_(i32) = G_ANYEXT [[UV4]](i12)
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT]](i32)
  ; CHECK-NEXT:   $w1 = COPY [[ANYEXT1]](i32)
  ; CHECK-NEXT:   $w2 = COPY [[ANYEXT2]](i32)
  ; CHECK-NEXT:   $w3 = COPY [[ANYEXT3]](i32)
  ; CHECK-NEXT:   $w4 = COPY [[ANYEXT4]](i32)
...
define <6 x i12> @ret_v6i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<6 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ...
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC1]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[IVEC4:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[IVEC3]], [[TRUNC1]](i12), [[C4]](i64)
  ; CHECK-NEXT:   [[IVEC5:%[0-9]+]]:_(<6 x i12>) = G_INSERT_VECTOR_ELT [[IVEC4]], [[TRUNC]](i12), [[C5]](i64)
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(i12), [[UV1:%[0-9]+]]:_(i12), [[UV2:%[0-9]+]]:_(i12), [[UV3:%[0-9]+]]:_(i12), [[UV4:%[0-9]+]]:_(i12), [[UV5:%[0-9]+]]:_(i12) = G_UNMERGE_VALUES [[IVEC5]](<6 x i12>)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[UV]](i12)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(i32) = G_ANYEXT [[UV1]](i12)
  ; CHECK-NEXT:   [[ANYEXT2:%[0-9]+]]:_(i32) = G_ANYEXT [[UV2]](i12)
  ; CHECK-NEXT:   [[ANYEXT3:%[0-9]+]]:_(i32) = G_ANYEXT [[UV3]](i12)
  ; CHECK-NEXT:   [[ANYEXT4:%[0-9]+]]:_(i32) = G_ANYEXT [[UV4]](i12)
  ; CHECK-NEXT:   [[ANYEXT5:%[0-9]+]]:_(i32) = G_ANYEXT [[UV5]](i12)
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT]](i32)
  ; CHECK-NEXT:   $w1 = COPY [[ANYEXT1]](i32)
  ; CHECK-NEXT:   $w2 = COPY [[ANYEXT2]](i32)
  ; CHECK-NEXT:   $w3 = COPY [[ANYEXT3]](i32)
  ; CHECK-NEXT:   $w4 = COPY [[ANYEXT4]](i32)
  ; CHECK-NEXT:   $w5 = COPY [[ANYEXT5]](i32)
...
define <7 x i12> @ret_v7i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<7 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ...
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC1]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[IVEC4:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC3]], [[TRUNC1]](i12), [[C4]](i64)
  ; CHECK-NEXT:   [[IVEC5:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC4]], [[TRUNC]](i12), [[C5]](i64)
  ; CHECK-NEXT:   [[IVEC6:%[0-9]+]]:_(<7 x i12>) = G_INSERT_VECTOR_ELT [[IVEC5]], [[TRUNC]](i12), [[C6]](i64)
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(i12), [[UV1:%[0-9]+]]:_(i12), [[UV2:%[0-9]+]]:_(i12), [[UV3:%[0-9]+]]:_(i12), [[UV4:%[0-9]+]]:_(i12), [[UV5:%[0-9]+]]:_(i12), [[UV6:%[0-9]+]]:_(i12) = G_UNMERGE_VALUES [[IVEC6]](<7 x i12>)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(i32) = G_ANYEXT [[UV]](i12)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(i32) = G_ANYEXT [[UV1]](i12)
  ; CHECK-NEXT:   [[ANYEXT2:%[0-9]+]]:_(i32) = G_ANYEXT [[UV2]](i12)
  ; CHECK-NEXT:   [[ANYEXT3:%[0-9]+]]:_(i32) = G_ANYEXT [[UV3]](i12)
  ; CHECK-NEXT:   [[ANYEXT4:%[0-9]+]]:_(i32) = G_ANYEXT [[UV4]](i12)
  ; CHECK-NEXT:   [[ANYEXT5:%[0-9]+]]:_(i32) = G_ANYEXT [[UV5]](i12)
  ; CHECK-NEXT:   [[ANYEXT6:%[0-9]+]]:_(i32) = G_ANYEXT [[UV6]](i12)
  ; CHECK-NEXT:   $w0 = COPY [[ANYEXT]](i32)
  ; CHECK-NEXT:   $w1 = COPY [[ANYEXT1]](i32)
  ; CHECK-NEXT:   $w2 = COPY [[ANYEXT2]](i32)
  ; CHECK-NEXT:   $w3 = COPY [[ANYEXT3]](i32)
  ; CHECK-NEXT:   $w4 = COPY [[ANYEXT4]](i32)
  ; CHECK-NEXT:   $w5 = COPY [[ANYEXT5]](i32)
  ; CHECK-NEXT:   $w6 = COPY [[ANYEXT6]](i32)
...
define <8 x i12> @ret_v8i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<8 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ...
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC1]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[IVEC4:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC3]], [[TRUNC1]](i12), [[C4]](i64)
  ; CHECK-NEXT:   [[IVEC5:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC4]], [[TRUNC]](i12), [[C5]](i64)
  ; CHECK-NEXT:   [[IVEC6:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC5]], [[TRUNC]](i12), [[C6]](i64)
  ; CHECK-NEXT:   [[IVEC7:%[0-9]+]]:_(<8 x i12>) = G_INSERT_VECTOR_ELT [[IVEC6]], [[TRUNC]](i12), [[C7]](i64)
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(<8 x i16>) = G_ANYEXT [[IVEC7]](<8 x i12>)
  ; CHECK-NEXT:   $q0 = COPY [[ANYEXT]](<8 x i16>)
...
define <12 x i12> @ret_v12i12(i12 %v1, i12 %v2) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[TRUNC:%[0-9]+]]:_(i12) = G_TRUNC [[COPY1]](i32)
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $w1
  ; CHECK-NEXT:   [[TRUNC1:%[0-9]+]]:_(i12) = G_TRUNC [[COPY2]](i32)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(<12 x i12>) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ...
  ; CHECK-NEXT:   [[C6:%[0-9]+]]:_(i64) = G_CONSTANT i64 6
  ; CHECK-NEXT:   [[C7:%[0-9]+]]:_(i64) = G_CONSTANT i64 7
  ; CHECK-NEXT:   [[C8:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
  ; CHECK-NEXT:   [[C9:%[0-9]+]]:_(i64) = G_CONSTANT i64 9
  ; CHECK-NEXT:   [[C10:%[0-9]+]]:_(i64) = G_CONSTANT i64 10
  ; CHECK-NEXT:   [[C11:%[0-9]+]]:_(i64) = G_CONSTANT i64 11
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC1]](i12), [[C]](i64)
  ; CHECK-NEXT:   [[IVEC1:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC]], [[TRUNC]](i12), [[C1]](i64)
  ; CHECK-NEXT:   [[IVEC2:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC1]], [[TRUNC]](i12), [[C2]](i64)
  ; CHECK-NEXT:   [[IVEC3:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC2]], [[TRUNC1]](i12), [[C3]](i64)
  ; CHECK-NEXT:   [[IVEC4:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC3]], [[TRUNC1]](i12), [[C4]](i64)
  ; CHECK-NEXT:   [[IVEC5:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC4]], [[TRUNC]](i12), [[C5]](i64)
  ; CHECK-NEXT:   [[IVEC6:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC5]], [[TRUNC]](i12), [[C6]](i64)
  ; CHECK-NEXT:   [[IVEC7:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC6]], [[TRUNC]](i12), [[C7]](i64)
  ; CHECK-NEXT:   [[IVEC8:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC7]], [[TRUNC]](i12), [[C8]](i64)
  ; CHECK-NEXT:   [[IVEC9:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC8]], [[TRUNC]](i12), [[C9]](i64)
  ; CHECK-NEXT:   [[IVEC10:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC9]], [[TRUNC]](i12), [[C10]](i64)
  ; CHECK-NEXT:   [[IVEC11:%[0-9]+]]:_(<12 x i12>) = G_INSERT_VECTOR_ELT [[IVEC10]], [[TRUNC]](i12), [[C11]](i64)
  ; CHECK-NEXT:   G_STORE [[IVEC11]](<12 x i12>), [[COPY]](p0) :: (store (<12 x i12>), align 32)
...
define <3 x i100> @ret_v3i100(i100 %v1, i100 %v2) {
  ...
  ; CHECK-NEXT:   $x2 = COPY [[UV2]](i64)
  ; CHECK-NEXT:   $x3 = COPY [[UV3]](i64)
  ; CHECK-NEXT:   $x4 = COPY [[UV4]](i64)
  ; CHECK-NEXT:   $x5 = COPY [[UV5]](i64)
...
define <4 x i100> @ret_v4i100(i100 %v1, i100 %v2) {
  ...
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i64) = G_CONSTANT i64 2
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(i64) = G_CONSTANT i64 3
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<4 x i100>) = G_INSERT_VECTOR_ELT [[DEF]], [[TRUNC]](i100), [[C]](i64)
  ...
  ; CHECK-NEXT:   $x4 = COPY [[UV4]](i64)
  ; CHECK-NEXT:   $x5 = COPY [[UV5]](i64)
  ; CHECK-NEXT:   $x6 = COPY [[UV6]](i64)
  ; CHECK-NEXT:   $x7 = COPY [[UV7]](i64)
