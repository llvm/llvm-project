...
; CHECK: G_STORE %1(i32), %0(p16777215) :: (store (i32) into %ir.ptr, addrspace 16777215)
...
; CHECK: %1:_(p16777215) = G_EXTRACT_VECTOR_ELT %0(<2 x p16777215>), %2(i64)
; CHECK: %1(p16777215) :: (store (i32) into %ir.elt0, addrspace 16777215)
