...
define void @test_varargs() {
  ...
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(i32) = G_ANYEXT [[C4]](i16)
  ; CHECK-NEXT:   $w0 = COPY [[C]](i32)
  ; CHECK-NEXT:   $d0 = COPY [[C1]](f64)
  ; CHECK-NEXT:   $x1 = COPY [[C2]](i64)
  ; CHECK-NEXT:   $w2 = COPY [[ANYEXT]](i32)
  ; CHECK-NEXT:   $w3 = COPY [[ANYEXT1]](i32)
  ; CHECK-NEXT:   $w4 = COPY [[C5]](i32)
  ; CHECK-NEXT:   $s1 = COPY [[C6]](f32)
  ; CHECK-NEXT:   $d2 = COPY [[C7]](f64)
  ; CHECK-NEXT:   BL @varargs, csr_aarch64_aapcs, implicit-def dead $lr, implicit $sp, implicit $w0, implicit $d0, implicit $x1, implicit $w2, implicit $w3, implicit $w4, implicit $s1, implicit $d2
...
define void @test_stack_ext_needed() {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i8) = G_CONSTANT i8 42
  ...
  ; CHECK-NEXT:   G_STORE [[C]](i8), [[PTR_ADD]](p0) :: (store (i8) into stack)
  ; CHECK-NEXT:   $x0 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x1 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x2 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x3 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x4 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x5 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x6 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   $x7 = COPY [[DEF]](i64)
  ; CHECK-NEXT:   BL @stack_ext_needed, csr_aarch64_aapcs, implicit-def dead $lr, implicit $sp, implicit $x0, implicit $x1, implicit $x2, implicit $x3, implicit $x4, implicit $x5, implicit $x6, implicit $x7
...
; Check that we can lower incoming i128 types into constituent i64 gprs.
define void @callee_s128(i128 %a, i128 %b, ptr %ptr) {
  ...
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(p0) = COPY $x4
  ; CHECK-NEXT:   G_STORE [[MV1]](i128), [[COPY4]](p0) :: (store (i128) into %ir.ptr)
  ; CHECK-NEXT:   RET_ReallyLR
  store i128 %b, ptr %ptr
  ret void
}

; Check we can lower outgoing s128 arguments into i64 gprs.
define void @caller_s128(ptr %ptr) {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $x0
  ; CHECK-NEXT:   [[LOAD:%[0-9]+]]:_(i128) = G_LOAD [[COPY]](p0) :: (load (i128) from %ir.ptr)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   [[UV:%[0-9]+]]:_(i64), [[UV1:%[0-9]+]]:_(i64) = G_UNMERGE_VALUES [[LOAD]](i128)
  ; CHECK-NEXT:   [[UV2:%[0-9]+]]:_(i64), [[UV3:%[0-9]+]]:_(i64) = G_UNMERGE_VALUES [[LOAD]](i128)
  ...
  ; CHECK-NEXT:   BL @callee_s128, csr_aarch64_aapcs, implicit-def dead $lr, implicit $sp, implicit $x0, implicit $x1, implicit $x2, implicit $x3, implicit $x4
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $sp, implicit $sp
  ; CHECK-NEXT:   RET_ReallyLR
  %v = load i128, ptr %ptr
...
define i32 @i8i16caller() nounwind readnone {
  ...
  ; CHECK-NEXT:   [[C13:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C13]](i64)
  ; CHECK-NEXT:   G_STORE [[C9]](i16), [[PTR_ADD1]](p0) :: (store (i16) into stack + 8, align 1)
  ; CHECK-NEXT:   [[C14:%[0-9]+]]:_(i64) = G_CONSTANT i64 16
  ; CHECK-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C14]](i64)
  ; CHECK-NEXT:   G_STORE [[C10]](i8), [[PTR_ADD2]](p0) :: (store (i8) into stack + 16)
  ; CHECK-NEXT:   [[C15:%[0-9]+]]:_(i64) = G_CONSTANT i64 24
  ; CHECK-NEXT:   [[PTR_ADD3:%[0-9]+]]:_(p0) = G_PTR_ADD [[COPY]], [[C15]](i64)
  ; CHECK-NEXT:   G_STORE [[C11]](i8), [[PTR_ADD3]](p0) :: (store (i8) into stack + 24)
  ...
  ; CHECK-NEXT:   BL @i8i16callee, csr_aarch64_aapcs, implicit-def dead $lr, implicit $sp, implicit $x0, implicit $x1, implicit $x2, implicit $w3, implicit $w4, implicit $x5, implicit $x6, implicit $x7, implicit-def $x0
...
define void @arg_v2i64(<2 x i64> %arg) {
  ...
  ; CHECK-NEXT:   G_STORE [[COPY]](<2 x i64>), [[DEF]](p0) :: (store (<2 x i64>) into `ptr undef`)
  ; CHECK-NEXT:   RET_ReallyLR
...
define void @arg_v8i64(<8 x i64> %arg) {
  ...
  ; CHECK-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<8 x i64>) = G_CONCAT_VECTORS [[COPY]](<2 x i64>), [[COPY1]](<2 x i64>), [[COPY2]](<2 x i64>), [[COPY3]](<2 x i64>)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p0) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   G_STORE [[CONCAT_VECTORS]](<8 x i64>), [[DEF]](p0) :: (store (<8 x i64>) into `ptr undef`)
  ; CHECK-NEXT:   RET_ReallyLR
