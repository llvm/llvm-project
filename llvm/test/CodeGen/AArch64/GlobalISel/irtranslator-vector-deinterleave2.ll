...
define void @vector_deinterleave2_v2f32(<2 x float> %a) {
  ; CHECK-LABEL: name: vector_deinterleave2_v2f32
  ...
  %res = call { <1 x float>, <1 x float> } @llvm.vector.deinterleave2.v2f32(<2 x float> %a)
  ret void
}
