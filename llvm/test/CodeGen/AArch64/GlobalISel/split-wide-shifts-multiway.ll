...
; GISEL-NEXT:    mov w15, #64 ; =0x40
; GISEL-NEXT:    sub x15, x15, x13
; GISEL-NEXT:    ldp x3, x6, [x1, #16]
; GISEL-NEXT:    lsl x10, x11, x2
; GISEL-NEXT:    cmp x9, #0
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsr x12, x11, x15
; GISEL-NEXT:    csel x13, x11, x13, eq
; GISEL-NEXT:    lsl x11, x14, x2
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x16, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x16, x11, x16
; GISEL-NEXT:    csel x16, x16, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    csel x16, x10, x16, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsr x16, x14, x15
; GISEL-NEXT:    csel x14, x14, x17, eq
; GISEL-NEXT:    lsl x17, x3, x2
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsr x4, x3, x15
; GISEL-NEXT:    csel x3, x3, x5, eq
; GISEL-NEXT:    lsl x5, x6, x2
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsr x7, x6, x15
; GISEL-NEXT:    csel x6, x6, x19, eq
; GISEL-NEXT:    lsl x19, x20, x2
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsr x22, x20, x15
; GISEL-NEXT:    csel x20, x20, x23, eq
; GISEL-NEXT:    lsl x23, x21, x2
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    csel x16, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x16, x17, x16
; GISEL-NEXT:    csel x13, x16, x15, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    and x14, x8, #0x3f
; GISEL-NEXT:    sub x24, x13, x14
; GISEL-NEXT:    str x0, [sp, #136] ; 8-byte Spill
; GISEL-NEXT:    mov x4, x2
; GISEL-NEXT:    lsl x15, x10, x2
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    lsr x17, x10, x24
; GISEL-NEXT:    lsl x28, x11, x2
; GISEL-NEXT:    lsr x3, x11, x24
; GISEL-NEXT:    mov x19, x1
; GISEL-NEXT:    csel x12, x15, xzr, eq
; GISEL-NEXT:    cmp x9, #1
...
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    mov x20, x19
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    mov x21, x5
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    str x20, [sp, #344] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    str x28, [sp, #312] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    lsl x14, x10, x2
; GISEL-NEXT:    lsr x16, x10, x24
; GISEL-NEXT:    csel x11, x11, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x26, x6
; GISEL-NEXT:    csel x13, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x13, x28, x13
; GISEL-NEXT:    csel x11, x13, x11, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    csel x11, x15, x11, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    lsr x15, x12, x24
...
; GISEL-NEXT:    lsr x2, x12, x24
; GISEL-NEXT:    lsl x27, x11, x4
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x0, [sp, #248] ; 8-byte Spill
...
; GISEL-NEXT:    csel x10, x23, x10, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    csel x10, xzr, x10, eq
...
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x3, [sp, #328] ; 8-byte Spill
...
; GISEL-NEXT:    csel x13, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    ldp x12, x10, [x19, #48]
; GISEL-NEXT:    csel x13, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    mov x19, x17
; GISEL-NEXT:    csel x13, xzr, x13, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsl x4, x12, x4
; GISEL-NEXT:    csel x11, x11, x13, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    lsl x30, x10, x5
; GISEL-NEXT:    csel x11, x11, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    str x30, [sp, #232] ; 8-byte Spill
...
; GISEL-NEXT:    str x17, [sp, #288] ; 8-byte Spill
; GISEL-NEXT:    csel x11, x13, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    ldp x11, x19, [x20, #64]
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    mov x20, x26
; GISEL-NEXT:    csel x12, x10, x12, eq
; GISEL-NEXT:    lsr x10, x10, x24
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x6, x11, x5
...
; GISEL-NEXT:    str x6, [sp, #240] ; 8-byte Spill
; GISEL-NEXT:    csel x12, x12, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x6, x13
; GISEL-NEXT:    csel x13, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    str x6, [sp, #336] ; 8-byte Spill
...
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x13, x27, x13
; GISEL-NEXT:    lsr x27, x11, x24
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    str x27, [sp, #264] ; 8-byte Spill
; GISEL-NEXT:    orr x13, x0, x13
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x15, eq
...
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    orr x13, x26, x13
; GISEL-NEXT:    mov x26, x21
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x26, [sp, #64] ; 8-byte Spill
; GISEL-NEXT:    csel x13, xzr, x1, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    lsl x1, x19, x21
; GISEL-NEXT:    orr x13, x28, x13
...
; GISEL-NEXT:    orr x12, x4, x12
; GISEL-NEXT:    mov x4, x24
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    mov x2, x20
; GISEL-NEXT:    orr x12, x17, x12
; GISEL-NEXT:    mov x17, x16
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x17, [sp, #48] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    mov x16, x15
; GISEL-NEXT:    orr x12, x0, x12
; GISEL-NEXT:    mov x0, x30
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    ldr x7, [sp, #224] ; 8-byte Reload
; GISEL-NEXT:    orr x12, x20, x12
; GISEL-NEXT:    mov x20, x23
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x20, [sp, #56] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x22, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    mov x22, x3
; GISEL-NEXT:    orr x12, x28, x12
; GISEL-NEXT:    str x22, [sp, #32] ; 8-byte Spill
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    csel x11, x23, x11, eq
; GISEL-NEXT:    cmp x9, #10
...
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x12, xzr, x11, eq
; GISEL-NEXT:    ldp x11, x6, [x15, #80]
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldr x15, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    csel x12, x19, x12, eq
; GISEL-NEXT:    lsr x19, x19, x24
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x24, x11, x26
; GISEL-NEXT:    str x12, [sp, #144] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x19, [sp, #72] ; 8-byte Spill
; GISEL-NEXT:    orr x12, x24, x12
; GISEL-NEXT:    stp x1, x24, [sp, #272] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x12, x12, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    mov x21, x14
; GISEL-NEXT:    orr x13, x30, x13
; GISEL-NEXT:    ldr x30, [sp, #248] ; 8-byte Reload
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    orr x13, x3, x13
; GISEL-NEXT:    lsr x3, x11, x4
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x13, x25, x13
; GISEL-NEXT:    mov x25, x24
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    orr x13, x14, x13
; GISEL-NEXT:    ldr x14, [sp, #16] ; 8-byte Reload
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    orr x13, x2, x13
; GISEL-NEXT:    mov x2, x6
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x5, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    orr x13, x28, x13
; GISEL-NEXT:    mov x28, x19
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    mov x13, x20
; GISEL-NEXT:    csel x12, x20, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    mov x20, x4
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    lsl x4, x6, x26
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    ldr x6, [sp, #336] ; 8-byte Reload
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    stp x4, x3, [sp, #296] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x8, #0
...
; GISEL-NEXT:    csel x12, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    ldr x19, [sp, #256] ; 8-byte Reload
; GISEL-NEXT:    orr x12, x24, x12
...
; GISEL-NEXT:    ldr x1, [sp, #288] ; 8-byte Reload
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #3
...
; GISEL-NEXT:    ldr x10, [sp, #344] ; 8-byte Reload
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x5, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    mov x5, x20
; GISEL-NEXT:    orr x12, x24, x12
; GISEL-NEXT:    str x5, [sp, #8] ; 8-byte Spill
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    csel x11, x13, x11, eq
; GISEL-NEXT:    cmp x9, #12
...
; GISEL-NEXT:    csel x12, xzr, x11, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldp x11, x14, [x10, #96]
; GISEL-NEXT:    csel x12, x2, x12, eq
; GISEL-NEXT:    str x12, [sp, #120] ; 8-byte Spill
; GISEL-NEXT:    lsr x12, x2, x20
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x2, [sp, #48] ; 8-byte Reload
; GISEL-NEXT:    mov x20, x19
; GISEL-NEXT:    lsl x13, x11, x26
; GISEL-NEXT:    csel x10, xzr, x12, eq
; GISEL-NEXT:    mov x26, x12
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    ldr x12, [sp, #304] ; 8-byte Reload
; GISEL-NEXT:    str x14, [sp, #24] ; 8-byte Spill
...
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x13, x4, x13
; GISEL-NEXT:    ldr x4, [sp, #264] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x28, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x13, x25, x13
; GISEL-NEXT:    ldr x25, [sp, #232] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x4, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x13, x27, x13
; GISEL-NEXT:    mov x27, x22
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    mov x19, x15
; GISEL-NEXT:    orr x13, x23, x13
...
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    orr x13, x30, x13
; GISEL-NEXT:    ldp x15, x16, [sp, #272] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x30, x24
; GISEL-NEXT:    csel x13, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    ldr x21, [sp, #40] ; 8-byte Reload
; GISEL-NEXT:    orr x13, x0, x13
; GISEL-NEXT:    ldr x0, [sp, #56] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #11
...
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    lsr x13, x11, x5
; GISEL-NEXT:    csel x10, x0, x10, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    ldr x5, [sp, #296] ; 8-byte Reload
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
...
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x11, x14, x7
; GISEL-NEXT:    str x10, [sp, #112] ; 8-byte Spill
; GISEL-NEXT:    csel x10, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x10, x11, x10
; GISEL-NEXT:    ldp x7, x28, [sp, #72] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [sp, #320] ; 8-byte Spill
; GISEL-NEXT:    csel x11, xzr, x26, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x11, x28, x11
; GISEL-NEXT:    ldp x13, x14, [sp, #328] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    ldr x19, [sp, #88] ; 8-byte Reload
...
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    ldr x6, [sp, #320] ; 8-byte Reload
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldp x10, x17, [x17, #112]
; GISEL-NEXT:    csel x11, x4, x11, eq
; GISEL-NEXT:    str x11, [sp, #104] ; 8-byte Spill
; GISEL-NEXT:    ldr x11, [sp, #64] ; 8-byte Reload
; GISEL-NEXT:    lsr x4, x4, x1
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x27, x10, x11
; GISEL-NEXT:    csel x1, xzr, x4, eq
; GISEL-NEXT:    str x4, [sp, #24] ; 8-byte Spill
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    ldr x4, [sp, #96] ; 8-byte Reload
...
; GISEL-NEXT:    ldp x5, x16, [sp, #256] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x30, x15, x30
; GISEL-NEXT:    ldr x15, [sp, #240] ; 8-byte Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x6, x14, [sp, #224] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    orr x30, x14, x30
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x13, eq
; GISEL-NEXT:    ldr x13, [sp, #32] ; 8-byte Reload
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #11
...
; GISEL-NEXT:    ldr x2, [sp, #8] ; 8-byte Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    csel x1, x0, x1, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    lsr x30, x10, x2
; GISEL-NEXT:    csel x1, xzr, x1, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x2, x10, x1, eq
; GISEL-NEXT:    lsl x10, x17, x11
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x1, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    ldr x11, [sp, #24] ; 8-byte Reload
...
; GISEL-NEXT:    orr x11, x15, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #336] ; 8-byte Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    orr x11, x14, x11
...
; GISEL-NEXT:    csel x9, x0, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldr x8, [sp, #104] ; 8-byte Reload
; GISEL-NEXT:    stp x8, x2, [x13, #104]
; GISEL-NEXT:    csel x8, x17, x9, eq
