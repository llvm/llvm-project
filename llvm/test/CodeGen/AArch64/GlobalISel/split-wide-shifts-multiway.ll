...
; GISEL-NEXT:    str x0, [sp, #160] ; 8-byte Folded Spill
; GISEL-NEXT:    and x14, x8, #0x3f
; GISEL-NEXT:    mov w13, #64 ; =0x40
...
; GISEL-NEXT:    lsr x7, x10, x1
; GISEL-NEXT:    lsl x23, x11, x14
; GISEL-NEXT:    and x14, x8, #0x3f
; GISEL-NEXT:    csel x12, x0, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    lsr x20, x11, x1
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    and x16, x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x12, eq
...
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    str x6, [sp, #16] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    mov x2, x1
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    str x1, [sp, #328] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    str x24, [sp, #272] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    str x25, [sp, #320] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    str x20, [sp, #128] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #248] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x11, x11, x13, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [sp, #240] ; 8-byte Folded Spill
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [sp, #232] ; 8-byte Folded Spill
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #224] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x10, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x10, x0, x10
; GISEL-NEXT:    lsr x4, x12, x1
...
; GISEL-NEXT:    stp x0, x30, [sp, #56] ; 16-byte Folded Spill
...
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [sp, #200] ; 8-byte Folded Spill
...
; GISEL-NEXT:    ldp x11, x10, [x25, #64]
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x12, [sp, #192] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    lsl x23, x11, x21
; GISEL-NEXT:    lsr x21, x11, x1
...
; GISEL-NEXT:    orr x12, x22, x12
; GISEL-NEXT:    stp x3, x5, [sp, #256] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x4, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    mov x4, x6
; GISEL-NEXT:    orr x12, x19, x12
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x17, eq
...
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    stp x19, x25, [sp, #88] ; 16-byte Folded Spill
...
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x23, x6, [sp, #296] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x13, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #3
...
; GISEL-NEXT:    csel x13, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    ldr x17, [sp, #272] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x13, x0, x13
; GISEL-NEXT:    ldr x0, [sp, #16] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    ldr x13, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x12, x17, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    lsr x13, x11, x13
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #14
...
; GISEL-NEXT:    lsl x30, x28, x11
; GISEL-NEXT:    csel x11, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x11, x30, x11
; GISEL-NEXT:    stp x4, x30, [sp, #72] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x11, x11, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    cmp x9, #1
...
; GISEL-NEXT:    orr x12, x22, x12
; GISEL-NEXT:    mov x22, x7
; GISEL-NEXT:    stp x5, x24, [sp, #40] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    ldp x10, x17, [sp, #320] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x12, xzr, x11, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x12, x28, x12, eq
; GISEL-NEXT:    lsr x0, x28, x17
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldp x11, x28, [x10, #96]
; GISEL-NEXT:    and x10, x8, #0x3f
; GISEL-NEXT:    stp x13, x0, [sp, #104] ; 16-byte Folded Spill
; GISEL-NEXT:    str x12, [sp, #152] ; 8-byte Folded Spill
; GISEL-NEXT:    mov x12, x4
; GISEL-NEXT:    lsl x15, x11, x10
; GISEL-NEXT:    csel x10, xzr, x0, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    lsl x25, x28, x25
; GISEL-NEXT:    orr x10, x15, x10
; GISEL-NEXT:    str x15, [sp, #312] ; 8-byte Folded Spill
; GISEL-NEXT:    mov x15, x13
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x13, eq
...
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x27, x2, [sp, #24] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x13, xzr, x3, eq
; GISEL-NEXT:    cmp x9, #3
...
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    ldr x6, [sp, #312] ; 8-byte Folded Reload
...
; GISEL-NEXT:    ldp x24, x21, [sp, #256] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    orr x13, x5, x13
; GISEL-NEXT:    ldp x5, x4, [sp, #56] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    orr x13, x19, x13
; GISEL-NEXT:    mov x19, x16
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    mov x7, x2
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    lsr x13, x11, x17
; GISEL-NEXT:    csel x10, x16, x10, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    str x13, [sp, #120] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #144] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x11, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    mov x15, x30
; GISEL-NEXT:    orr x11, x1, x11
; GISEL-NEXT:    ldr x1, [sp, #320] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x14, x2, [sp, #296] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x9, #4
...
; GISEL-NEXT:    ldp x12, x17, [sp, #88] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    ldr x24, [sp, #80] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x11, x12, x11
; GISEL-NEXT:    ldp x21, x23, [sp, #112] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x10, x5, [x1, #112]
; GISEL-NEXT:    str x11, [sp, #136] ; 8-byte Folded Spill
; GISEL-NEXT:    ldr x11, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    and x1, x8, #0x3f
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x11, x28, x11
; GISEL-NEXT:    lsl x28, x10, x1
...
; GISEL-NEXT:    ldr x6, [sp, #104] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldr x0, [sp, #72] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x7, x13, [sp, #40] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x14, eq
; GISEL-NEXT:    ldp x2, x14, [sp, #256] ; 16-byte Folded Reload
; GISEL-NEXT:    orr x30, x13, x30
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldr x26, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x11, x1, x11
; GISEL-NEXT:    ldr x1, [sp, #280] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    orr x11, x0, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #304] ; 8-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    orr x11, x13, x11
; GISEL-NEXT:    ldr x13, [sp, #160] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #9
...
; GISEL-NEXT:    orr x11, x12, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #248] ; 8-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [x13]
; GISEL-NEXT:    ldp x12, x11, [sp, #232] ; 16-byte Folded Reload
; GISEL-NEXT:    stp x11, x12, [x13, #8]
; GISEL-NEXT:    csel x11, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    orr x11, x3, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #224] ; 8-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [x13, #24]
; GISEL-NEXT:    ldp x12, x11, [sp, #208] ; 16-byte Folded Reload
; GISEL-NEXT:    stp x11, x12, [x13, #32]
; GISEL-NEXT:    csel x11, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    orr x11, x4, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #200] ; 8-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x11, [x13, #48]
; GISEL-NEXT:    ldp x12, x11, [sp, #184] ; 16-byte Folded Reload
; GISEL-NEXT:    stp x11, x12, [x13, #56]
; GISEL-NEXT:    ldr x11, [sp, #128] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    ldr x11, [sp, #176] ; 8-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    ldr x9, [sp, #144] ; 8-byte Folded Reload
; GISEL-NEXT:    stp x12, x9, [x13, #88]
; GISEL-NEXT:    csel x9, x16, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldr x8, [sp, #136] ; 8-byte Folded Reload
; GISEL-NEXT:    stp x8, x26, [x13, #104]
; GISEL-NEXT:    ldp x26, x25, [sp, #352] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x8, x5, x9, eq
