...
define i32 @atomicrmw_volatile(ptr %ptr) {
  ...
  ; CHECK-NEXT:   [[ATOMICRMW_ADD:%[0-9]+]]:_(i32) = G_ATOMICRMW_ADD [[COPY]](p0), [[C]] :: (volatile load store monotonic (i32) on %ir.ptr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMICRMW_ADD]](i32)
...
define i32 @atomicrmw_falkor(ptr %ptr) {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $x0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[ATOMICRMW_ADD:%[0-9]+]]:_(i32) = G_ATOMICRMW_ADD [[COPY]](p0), [[C]] :: ("aarch64-strided-access" load store monotonic (i32) on %ir.ptr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMICRMW_ADD]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
...
define i32 @atomicrmw_volatile_falkor(ptr %ptr) {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(p0) = COPY $x0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[ATOMICRMW_ADD:%[0-9]+]]:_(i32) = G_ATOMICRMW_ADD [[COPY]](p0), [[C]] :: (volatile "aarch64-strided-access" load store monotonic (i32) on %ir.ptr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMICRMW_ADD]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
...
define i32 @cmpxchg_volatile(ptr %addr) {
  ...
  ; CHECK-NEXT:   [[ATOMIC_CMPXCHG_WITH_SUCCESS:%[0-9]+]]:_(i32), [[ATOMIC_CMPXCHG_WITH_SUCCESS1:%[0-9]+]]:_(i1) = G_ATOMIC_CMPXCHG_WITH_SUCCESS [[COPY]](p0), [[C]], [[C1]] :: (volatile load store monotonic monotonic (i32) on %ir.addr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMIC_CMPXCHG_WITH_SUCCESS]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
...
define i32 @cmpxchg_falkor(ptr %addr) {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[ATOMIC_CMPXCHG_WITH_SUCCESS:%[0-9]+]]:_(i32), [[ATOMIC_CMPXCHG_WITH_SUCCESS1:%[0-9]+]]:_(i1) = G_ATOMIC_CMPXCHG_WITH_SUCCESS [[COPY]](p0), [[C]], [[C1]] :: ("aarch64-strided-access" load store monotonic monotonic (i32) on %ir.addr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMIC_CMPXCHG_WITH_SUCCESS]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
...
define i32 @cmpxchg_volatile_falkor(ptr %addr) {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[ATOMIC_CMPXCHG_WITH_SUCCESS:%[0-9]+]]:_(i32), [[ATOMIC_CMPXCHG_WITH_SUCCESS1:%[0-9]+]]:_(i1) = G_ATOMIC_CMPXCHG_WITH_SUCCESS [[COPY]](p0), [[C]], [[C1]] :: (volatile "aarch64-strided-access" load store monotonic monotonic (i32) on %ir.addr)
  ; CHECK-NEXT:   $w0 = COPY [[ATOMIC_CMPXCHG_WITH_SUCCESS]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
