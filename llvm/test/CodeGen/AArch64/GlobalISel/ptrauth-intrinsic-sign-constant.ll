...
; CHECK:       ; %bb.0:
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    adrp x0, _g@GOTPAGE
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    ldr x0, [x0, _g@GOTPAGEOFF]
; CHECK-NEXT:    mov x16, #56 ; =0x38
; CHECK-NEXT:    pacda x0, x16
; CHECK-NEXT:    ret
...
; CHECK:       ; %bb.0:
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    adrp x0, _g_weak@GOTPAGE
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    ldr x0, [x0, _g_weak@GOTPAGEOFF]
; CHECK-NEXT:    mov x16, #56 ; =0x38
; CHECK-NEXT:    pacda x0, x16
; CHECK-NEXT:    ret
...
; CHECK:       ; %bb.0:
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    adrp x0, _g_strong_def@PAGE
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    add x0, x0, _g_strong_def@PAGEOFF
...
; CHECK-NEXT: Lloh{{.*}}:
; CHECK-NEXT:    ldr x0, [x0, _g@GOTPAGEOFF]
; CHECK-NEXT:    mov x16, #78 ; =0x4e
; CHECK-NEXT:    pacib x0, x16
; CHECK-NEXT:    ret
  %tmp0 = ptrtoint i32* @g to i64
...
; CHECK-NEXT:    movk w8, #32769, lsl #16
; CHECK-NEXT: Lloh{{.*}}:
...
; CHECK-NEXT:    movk x16, #23, lsl #48
; CHECK-NEXT:    pacda x8, x16
...
; CHECK:       ; %bb.0:
; CHECK-NEXT:  Lloh{{.*}}
; CHECK-NEXT:    adrp x0, _test_intrinsic_function@PAGE
; CHECK-NEXT:  Lloh{{.*}}
; CHECK-NEXT:    add x0, x0, _test_intrinsic_function@PAGEOFF
; CHECK-NEXT:    mov x16, #56 ; =0x38
; CHECK-NEXT:    pacib x0, x16
; CHECK-NEXT:    ret
...
; CHECK:       ; %bb.0:
; CHECK-NEXT:  Lloh{{.*}}
; CHECK-NEXT:    adrp x0, _g_strong_def@PAGE+2
; CHECK-NEXT:  Lloh{{.*}}
; CHECK-NEXT:    add x0, x0, _g_strong_def@PAGEOFF+2
; CHECK-NEXT:    mov x16, #56 ; =0x38
; CHECK-NEXT:    pacda x0, x16
; CHECK-NEXT:    ret
...
; CHECK-LABEL: test_intrinsic_ptrauth_global:
; CHECK:       ; %bb.0:
