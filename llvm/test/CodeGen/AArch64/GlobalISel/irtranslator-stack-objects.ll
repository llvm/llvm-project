...
define void @stack_passed_i64(i64 %arg, i64 %arg1, i64 %arg2, i64 %arg3, i64 %arg4, i64 %arg5, i64 %arg6,
  ...
  ; CHECK:   [[LOAD:%[0-9]+]]:_(i64) = G_LOAD [[FRAME_INDEX]](p0) :: (invariant load (i64)  from %fixed-stack.2, align 16)
  ...
  ; CHECK:   [[LOAD1:%[0-9]+]]:_(i64) = G_LOAD [[COPY8]](p0) :: (load (i64) from %ir.arg9)
  ; CHECK:   [[ADD0:%[0-9]+]]:_(i64) = G_ADD [[LOAD1]], [[LOAD]]
  ; CHECK:   [[LOAD2:%[0-9]+]]:_(i64) = G_LOAD [[COPY9]](p0) :: (dereferenceable load (i64) from %ir.arg10)
  ; CHECK:   [[ADD1:%[0-9]+]]:_(i64) = G_ADD [[ADD0]], [[LOAD2]]
  ; CHECK:   G_STORE [[ADD1]](i64), [[COPY8]](p0) :: (volatile store (i64) into %ir.arg9)
