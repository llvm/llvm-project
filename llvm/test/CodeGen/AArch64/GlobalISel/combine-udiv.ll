...
; SDAG-NEXT:    ldr q1, [x8, :lo12:.LCPI1_1]
...
; GISEL-NEXT:    ldr q1, [x8, :lo12:.LCPI1_1]
...
; SDAG-NEXT:    ldr q2, [x8, :lo12:.LCPI3_1]
; SDAG-NEXT:    adrp x8, .LCPI3_2
...
; SDAG-NEXT:    ldr q1, [x8, :lo12:.LCPI3_2]
; SDAG-NEXT:    ushl v0.8h, v0.8h, v1.8h
; SDAG-NEXT:    ret
;
