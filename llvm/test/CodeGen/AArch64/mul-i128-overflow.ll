...
; CHECK-GI:       warning: Instruction selection used fallback path for test1
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test2
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test3
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for test4
