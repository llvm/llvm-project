...
; CHECK64:       // %bb.0: // %entry
; CHECK64-NEXT:    sub sp, sp, #80
; CHECK64-NEXT:    str x29, [sp, #64] // 8-byte Spill
; CHECK64-NEXT:    addvl sp, sp, #-1
...
; CHECK64-NEXT:    addvl sp, sp, #1
; CHECK64-NEXT:    ldr x29, [sp, #64] // 8-byte Reload
; CHECK64-NEXT:    add sp, sp, #80
; CHECK64-NEXT:    ret
;
...
; CHECK1024-NEXT:    str x29, [sp, #1024] // 8-byte Spill
; CHECK1024-NEXT:    str x25, [sp, #1032] // 8-byte Spill
; CHECK1024-NEXT:    str x24, [sp, #1040] // 8-byte Spill
; CHECK1024-NEXT:    str x23, [sp, #1048] // 8-byte Spill
; CHECK1024-NEXT:    str x22, [sp, #1056] // 8-byte Spill
; CHECK1024-NEXT:    str x21, [sp, #1064] // 8-byte Spill
; CHECK1024-NEXT:    str x20, [sp, #1072] // 8-byte Spill
; CHECK1024-NEXT:    str x19, [sp, #1080] // 8-byte Spill
...
; CHECK1024-NEXT:    addvl sp, sp, #8
; CHECK1024-NEXT:    ldr x19, [sp, #1080] // 8-byte Reload
; CHECK1024-NEXT:    ldr x20, [sp, #1072] // 8-byte Reload
; CHECK1024-NEXT:    ldr x21, [sp, #1064] // 8-byte Reload
; CHECK1024-NEXT:    ldr x22, [sp, #1056] // 8-byte Reload
; CHECK1024-NEXT:    ldr x23, [sp, #1048] // 8-byte Reload
; CHECK1024-NEXT:    ldr x24, [sp, #1040] // 8-byte Reload
; CHECK1024-NEXT:    ldr x25, [sp, #1032] // 8-byte Reload
; CHECK1024-NEXT:    ldr x29, [sp, #1024] // 8-byte Reload
...
; CHECK64-NEXT:    ldp x20, x19, [sp, #112] // 16-byte Folded Reload
; CHECK64-NEXT:    ldr x28, [sp, #88] // 8-byte Reload
...
; CHECK1024-NEXT:    str x29, [sp, #1024] // 8-byte Spill
; CHECK1024-NEXT:    str x30, [sp, #1032] // 8-byte Spill
; CHECK1024-NEXT:    str x9, [sp, #1040] // 8-byte Spill
; CHECK1024-NEXT:    str x28, [sp, #1048] // 8-byte Spill
; CHECK1024-NEXT:    str x27, [sp, #1056] // 8-byte Spill
; CHECK1024-NEXT:    str x26, [sp, #1064] // 8-byte Spill
; CHECK1024-NEXT:    str x20, [sp, #1072] // 8-byte Spill
; CHECK1024-NEXT:    str x19, [sp, #1080] // 8-byte Spill
; CHECK1024-NEXT:    add x29, sp, #1024
...
; CHECK1024-NEXT:    str p15, [sp, #4, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p14, [sp, #5, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p13, [sp, #6, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p12, [sp, #7, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p11, [sp, #8, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p10, [sp, #9, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p9, [sp, #10, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p8, [sp, #11, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p7, [sp, #12, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p6, [sp, #13, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p5, [sp, #14, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p4, [sp, #15, mul vl] // 2-byte Spill
...
; CHECK1024-NEXT:    ldr p15, [sp, #4, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p14, [sp, #5, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p13, [sp, #6, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p12, [sp, #7, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p11, [sp, #8, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p10, [sp, #9, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p9, [sp, #10, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p8, [sp, #11, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p7, [sp, #12, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p6, [sp, #13, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p5, [sp, #14, mul vl] // 2-byte Reload
; CHECK1024-NEXT:    ldr p4, [sp, #15, mul vl] // 2-byte Reload
...
; CHECK1024-NEXT:    ldr x19, [sp, #1080] // 8-byte Reload
; CHECK1024-NEXT:    ldr x20, [sp, #1072] // 8-byte Reload
; CHECK1024-NEXT:    ldr x26, [sp, #1064] // 8-byte Reload
; CHECK1024-NEXT:    ldr x27, [sp, #1056] // 8-byte Reload
; CHECK1024-NEXT:    ldr x28, [sp, #1048] // 8-byte Reload
; CHECK1024-NEXT:    ldr x30, [sp, #1032] // 8-byte Reload
; CHECK1024-NEXT:    ldr x29, [sp, #1024] // 8-byte Reload
; CHECK1024-NEXT:    add sp, sp, #1088
; CHECK1024-NEXT:    .cfi_def_cfa_offset 0
...
; CHECK64-NEXT:    stp x9, x28, [sp, #80] // 16-byte Folded Spill
; CHECK64-NEXT:    stp x27, x26, [sp, #96] // 16-byte Folded Spill
; CHECK64-NEXT:    str x19, [sp, #112] // 8-byte Spill
; CHECK64-NEXT:    add x29, sp, #64
; CHECK64-NEXT:    .cfi_def_cfa w29, 64
; CHECK64-NEXT:    .cfi_offset w19, -16
; CHECK64-NEXT:    .cfi_offset w26, -24
...
; CHECK1024-NEXT:    str x27, [sp, #1056] // 8-byte Spill
; CHECK1024-NEXT:    str x26, [sp, #1064] // 8-byte Spill
; CHECK1024-NEXT:    str x19, [sp, #1072] // 8-byte Spill
; CHECK1024-NEXT:    add x29, sp, #1024
; CHECK1024-NEXT:    .cfi_def_cfa w29, 64
...
; CHECK1024-NEXT:    sub sp, x29, #1024
; CHECK1024-NEXT:    .cfi_def_cfa wsp, 1088
; CHECK1024-NEXT:    ldr x19, [sp, #1072] // 8-byte Reload
; CHECK1024-NEXT:    ldr x26, [sp, #1064] // 8-byte Reload
; CHECK1024-NEXT:    ldr x27, [sp, #1056] // 8-byte Reload
; CHECK1024-NEXT:    ldr x28, [sp, #1048] // 8-byte Reload
; CHECK1024-NEXT:    ldr x30, [sp, #1032] // 8-byte Reload
...
; CHECK1024-NEXT:    str x30, [sp, #1032] // 8-byte Spill
; CHECK1024-NEXT:    str x28, [sp, #1040] // 8-byte Spill
; CHECK1024-NEXT:    str x27, [sp, #1048] // 8-byte Spill
; CHECK1024-NEXT:    str x26, [sp, #1056] // 8-byte Spill
; CHECK1024-NEXT:    str x20, [sp, #1064] // 8-byte Spill
; CHECK1024-NEXT:    str x19, [sp, #1072] // 8-byte Spill
; CHECK1024-NEXT:    addvl sp, sp, #-18
; CHECK1024-NEXT:    str p15, [sp, #4, mul vl] // 2-byte Spill
; CHECK1024-NEXT:    str p14, [sp, #5, mul vl] // 2-byte Spill
...
; CHECK1024-NEXT:    sub sp, x29, #1024
; CHECK1024-NEXT:    ldr x19, [sp, #1072] // 8-byte Reload
; CHECK1024-NEXT:    ldr x20, [sp, #1064] // 8-byte Reload
; CHECK1024-NEXT:    ldr x26, [sp, #1056] // 8-byte Reload
; CHECK1024-NEXT:    ldr x27, [sp, #1048] // 8-byte Reload
; CHECK1024-NEXT:    ldr x28, [sp, #1040] // 8-byte Reload
; CHECK1024-NEXT:    ldr x30, [sp, #1032] // 8-byte Reload
; CHECK1024-NEXT:    ldr x29, [sp, #1024] // 8-byte Reload
; CHECK1024-NEXT:    add sp, sp, #1088
