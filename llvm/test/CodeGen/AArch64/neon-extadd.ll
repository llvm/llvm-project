...
; CHECK-SD-LABEL: i12:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    ldr s2, [sp, #32]
; CHECK-SD-NEXT:    add x8, sp, #40
; CHECK-SD-NEXT:    fmov s0, w4
; CHECK-SD-NEXT:    fmov s1, w0
; CHECK-SD-NEXT:    ldr s4, [sp]
; CHECK-SD-NEXT:    add x9, sp, #8
; CHECK-SD-NEXT:    ld1 { v2.s }[1], [x8]
; CHECK-SD-NEXT:    add x8, sp, #48
; CHECK-SD-NEXT:    ldr s6, [sp, #64]
; CHECK-SD-NEXT:    ld1 { v4.s }[1], [x9]
; CHECK-SD-NEXT:    mov v0.s[1], w5
; CHECK-SD-NEXT:    add x9, sp, #16
; CHECK-SD-NEXT:    mov v1.s[1], w1
; CHECK-SD-NEXT:    ldr s5, [sp, #96]
; CHECK-SD-NEXT:    add x11, sp, #72
; CHECK-SD-NEXT:    ld1 { v2.s }[2], [x8]
; CHECK-SD-NEXT:    add x8, sp, #56
; CHECK-SD-NEXT:    ldr s7, [sp, #160]
; CHECK-SD-NEXT:    ldr s16, [sp, #128]
; CHECK-SD-NEXT:    add x10, sp, #104
; CHECK-SD-NEXT:    ld1 { v4.s }[2], [x9]
; CHECK-SD-NEXT:    ld1 { v6.s }[1], [x11]
; CHECK-SD-NEXT:    add x9, sp, #136
; CHECK-SD-NEXT:    ld1 { v5.s }[1], [x10]
; CHECK-SD-NEXT:    ld1 { v2.s }[3], [x8]
; CHECK-SD-NEXT:    add x8, sp, #168
; CHECK-SD-NEXT:    ld1 { v16.s }[1], [x9]
; CHECK-SD-NEXT:    ld1 { v7.s }[1], [x8]
; CHECK-SD-NEXT:    mov v0.s[2], w6
; CHECK-SD-NEXT:    mov v1.s[2], w2
; CHECK-SD-NEXT:    add x10, sp, #80
; CHECK-SD-NEXT:    add x9, sp, #112
; CHECK-SD-NEXT:    add x11, sp, #144
; CHECK-SD-NEXT:    ld1 { v6.s }[2], [x10]
; CHECK-SD-NEXT:    add x10, sp, #176
; CHECK-SD-NEXT:    ld1 { v5.s }[2], [x9]
; CHECK-SD-NEXT:    ld1 { v7.s }[2], [x10]
; CHECK-SD-NEXT:    ld1 { v16.s }[2], [x11]
; CHECK-SD-NEXT:    add x8, sp, #24
; CHECK-SD-NEXT:    add x9, sp, #88
; CHECK-SD-NEXT:    movi v3.4s, #15, msl #8
; CHECK-SD-NEXT:    mov v0.s[3], w7
; CHECK-SD-NEXT:    mov v1.s[3], w3
; CHECK-SD-NEXT:    ld1 { v4.s }[3], [x8]
; CHECK-SD-NEXT:    add x8, sp, #120
; CHECK-SD-NEXT:    ld1 { v6.s }[3], [x9]
; CHECK-SD-NEXT:    add x9, sp, #184
; CHECK-SD-NEXT:    add x10, sp, #152
; CHECK-SD-NEXT:    ld1 { v5.s }[3], [x8]
; CHECK-SD-NEXT:    ld1 { v7.s }[3], [x9]
; CHECK-SD-NEXT:    ld1 { v16.s }[3], [x10]
; CHECK-SD-NEXT:    and v17.16b, v0.16b, v3.16b
; CHECK-SD-NEXT:    and v0.16b, v1.16b, v3.16b
; CHECK-SD-NEXT:    and v1.16b, v2.16b, v3.16b
; CHECK-SD-NEXT:    and v2.16b, v4.16b, v3.16b
; CHECK-SD-NEXT:    and v4.16b, v6.16b, v3.16b
; CHECK-SD-NEXT:    and v5.16b, v5.16b, v3.16b
; CHECK-SD-NEXT:    and v6.16b, v7.16b, v3.16b
; CHECK-SD-NEXT:    and v3.16b, v16.16b, v3.16b
; CHECK-SD-NEXT:    add v0.4s, v0.4s, v4.4s
; CHECK-SD-NEXT:    add v2.4s, v2.4s, v3.4s
; CHECK-SD-NEXT:    add v3.4s, v1.4s, v6.4s
; CHECK-SD-NEXT:    add v1.4s, v17.4s, v5.4s
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: i12:
; CHECK-GI:       // %bb.0: // %entry
