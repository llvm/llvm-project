...
; RUN: llc -mtriple=aarch64-linux-gnu -mattr=+sve < %s | FileCheck %s --check-prefixes=CHECK,CHECK-LE
; RUN: llc -mtriple=aarch64_be-linux-gnu -mattr=+sve < %s | FileCheck %s --check-prefixes=CHECK,CHECK-BE
