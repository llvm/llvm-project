...
; CHECK-NEXT:    ldp s4, s5, [x0]
; CHECK-NEXT:    add x9, x1, #8
; CHECK-NEXT:    mov v18.16b, v3.16b
; CHECK-NEXT:    ldp s7, s16, [x2, #8]
; CHECK-NEXT:    ldr s17, [x3, #12]
; CHECK-NEXT:    mov v3.s[1], v6.s[0]
; CHECK-NEXT:    ld1 { v0.s }[1], [x3], #4
; CHECK-NEXT:    mov v18.s[1], v6.s[0]
; CHECK-NEXT:    ld1 { v4.s }[1], [x1], #4
; CHECK-NEXT:    ld1 { v2.s }[1], [x9]
; CHECK-NEXT:    ld1 { v7.s }[1], [x8]
; CHECK-NEXT:    ld1 { v1.s }[1], [x3]
; CHECK-NEXT:    ld1 { v5.s }[1], [x1]
; CHECK-NEXT:    mov v18.s[2], v16.s[0]
; CHECK-NEXT:    mov v16.s[1], v17.s[0]
; CHECK-NEXT:    uaddl v2.8h, v4.8b, v2.8b
; CHECK-NEXT:    uaddl v4.8h, v0.8b, v7.8b
; CHECK-NEXT:    uaddl v3.8h, v5.8b, v3.8b
; CHECK-NEXT:    uaddl v1.8h, v1.8b, v16.8b
; CHECK-NEXT:    mov v18.s[3], v17.s[0]
