...
; RUN: llc -mattr=+sve,+bf16            < %s | FileCheck %s --check-prefixes=CHECK,NONSTREAMING
...
; NONSTREAMING-LABEL: frintp_nxv8bf16:
; NONSTREAMING:       // %bb.0:
...
;
; STREAMING-LABEL: frintp_nxv8bf16:
; STREAMING:       // %bb.0:
...
; NONSTREAMING-LABEL: frintm_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frintm_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-LABEL: frinti_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frinti_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-LABEL: frintx_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frintx_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-LABEL: frinta_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frinta_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-LABEL: frintn_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frintn_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-LABEL: frintz_nxv8bf16:
; NONSTREAMING:       // %bb.0:
; NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; NONSTREAMING-NEXT:    ptrue p0.s
; NONSTREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
...
; NONSTREAMING-NEXT:    ret
;
; STREAMING-LABEL: frintz_nxv8bf16:
; STREAMING:       // %bb.0:
; STREAMING-NEXT:    mov z1.h, #0 // =0x0
; STREAMING-NEXT:    ptrue p0.s
; STREAMING-NEXT:    zip2 z2.h, z1.h, z0.h
