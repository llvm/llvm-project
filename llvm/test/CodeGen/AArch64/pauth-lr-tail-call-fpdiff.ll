...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp3
; COMPAT-NEXT: .Ltmp3:
; COMPAT-NEXT:   hint #27

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp3
; V83A-NEXT:   .Ltmp3:
; V83A-NEXT:     pacibsp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp3
; V9A-NEXT:    .Ltmp3:
; V9A-NEXT:      pacibsppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp4
; COMPAT-NEXT: .Ltmp4:
; COMPAT-NEXT:   hint #25

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp4
; V83A-NEXT:   .Ltmp4:
; V83A-NEXT:     paciasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp4
; V9A-NEXT:    .Ltmp4:
; V9A-NEXT:      paciasppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp5
; COMPAT-NEXT: .Ltmp5:
; COMPAT-NEXT:   hint #27

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp5
; V83A-NEXT:   .Ltmp5:
; V83A-NEXT:     pacibsp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp5
; V9A-NEXT:    .Ltmp5:
; V9A-NEXT:      pacibsppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp6
; COMPAT-NEXT: .Ltmp6:
; COMPAT-NEXT:   hint #25

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp6
; V83A-NEXT:   .Ltmp6:
; V83A-NEXT:     paciasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp6
; V9A-NEXT:    .Ltmp6:
; V9A-NEXT:      paciasppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp7
; COMPAT-NEXT: .Ltmp7:
; COMPAT-NEXT:   hint #27

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp7
; V83A-NEXT:   .Ltmp7:
; V83A-NEXT:     pacibsp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp7
; V9A-NEXT:    .Ltmp7:
; V9A-NEXT:      pacibsppc
