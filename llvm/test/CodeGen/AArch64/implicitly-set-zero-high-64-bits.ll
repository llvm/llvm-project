...
; RUN: llc -verify-machineinstrs -o - %s -mtriple=aarch64-linux-gnu | FileCheck %s --check-prefixes=CHECK,CHECK-SD
; RUN: llc -verify-machineinstrs -o - %s -mtriple=aarch64-linux-gnu -global-isel | FileCheck %s --check-prefixes=CHECK,CHECK-GI
...
; CHECK-SD-LABEL: insertzero_v1i64:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    fmov d0, d0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insertzero_v1i64:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-SD-LABEL: insertzero_v1f64:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    fmov d0, d0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: insertzero_v1f64:
; CHECK-GI:       // %bb.0: // %entry
