...
define void @test_fmlal_lane_vg2x1(i32 %slice, <vscale x 16 x i8> %zn, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlal_lane_vg2x1:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
...
define void @test_fmlal_lane_vg2x2(i32 %slice, <vscale x 16 x i8> %zn0, <vscale x 16 x i8> %zn1, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlal_lane_vg2x2:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
...
define void @test_fmlal_lane_vg2x4(i32 %slice, <vscale x 16 x i8> %zn0, <vscale x 16 x i8> %zn1, <vscale x 16 x i8> %zn2, <vscale x 16 x i8> %zn3, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlal_lane_vg2x4:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
...
define void @test_fmlall_lane_vg4x1(i32 %slice, <vscale x 16 x i8> %zn, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlall_lane_vg4x1:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
...
define void @test_fmlall_lane_vg4x2(i32 %slice, <vscale x 16 x i8> %zn0,  <vscale x 16 x i8> %zn1, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlall_lane_vg4x2:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
...
define void @test_fmlall_lane_vg4x4(i32 %slice, <vscale x 16 x i8> %zn0,  <vscale x 16 x i8> %zn1, <vscale x 16 x i8> %zn2, <vscale x 16 x i8> %zn3, <vscale x 16 x i8> %zm) {
; CHECK-LABEL: test_fmlall_lane_vg4x4:
; CHECK:  // %bb.0:
; CHECK:    mov w8, w0
