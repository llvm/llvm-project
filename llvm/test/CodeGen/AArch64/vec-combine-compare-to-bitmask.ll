...
; CHECK-GI-NEXT:    sub sp, sp, #16
; CHECK-GI-NEXT:    .cfi_def_cfa_offset 16
; CHECK-GI-NEXT:    cmtst.4s v2, v0, v0
...
; CHECK-GI-NEXT:    mov.s w11, v2[3]
; CHECK-GI-NEXT:    mov.b v2[1], w8
; CHECK-GI-NEXT:    mov.s w8, v0[2]
; CHECK-GI-NEXT:    mov.b v0[1], w9
; CHECK-GI-NEXT:    mov.b v2[2], w10
; CHECK-GI-NEXT:    mov.b v0[2], w8
; CHECK-GI-NEXT:    mov.b v2[3], w11
; CHECK-GI-NEXT:    mov.b v0[3], w12
; CHECK-GI-NEXT:    and.8b v0, v2, v0
; CHECK-GI-NEXT:    umov.b w8, v0[1]
; CHECK-GI-NEXT:    umov.b w9, v0[0]
; CHECK-GI-NEXT:    umov.b w10, v0[2]
; CHECK-GI-NEXT:    umov.b w11, v0[3]
...
; CHECK-GI-NEXT:    mov.s w12, v1[1]
; CHECK-GI-NEXT:    mov.s w14, v1[2]
; CHECK-GI-NEXT:    mov.s w11, v1[3]
; CHECK-GI-NEXT:    mov.s w10, v0[1]
; CHECK-GI-NEXT:    mov.s w13, v0[2]
; CHECK-GI-NEXT:    mov.s w9, v0[3]
; CHECK-GI-NEXT:    mov.16b v3, v2
; CHECK-GI-NEXT:    mov.16b v6, v2
; CHECK-GI-NEXT:    mov.b v2[1], w8
; CHECK-GI-NEXT:    mov.b v1[1], w12
; CHECK-GI-NEXT:    mov.b v0[1], w10
; CHECK-GI-NEXT:    mov w10, #0 ; =0x0
; CHECK-GI-NEXT:    mov.b v3[1], w8
; CHECK-GI-NEXT:    fmov s4, w10
; CHECK-GI-NEXT:    mov.b v6[1], w8
; CHECK-GI-NEXT:    mov.b v2[2], w8
; CHECK-GI-NEXT:    mov.b v1[2], w14
; CHECK-GI-NEXT:    mov.16b v5, v4
; CHECK-GI-NEXT:    mov.b v0[2], w13
; CHECK-GI-NEXT:    mov.b v4[1], w8
; CHECK-GI-NEXT:    mov.b v3[2], w10
; CHECK-GI-NEXT:    mov.b v6[2], w10
; CHECK-GI-NEXT:    mov.b v2[3], w10
; CHECK-GI-NEXT:    mov.b v5[1], w8
; CHECK-GI-NEXT:    mov.b v1[3], w11
; CHECK-GI-NEXT:    mov.b v0[3], w9
; CHECK-GI-NEXT:    mov.b v4[2], w8
; CHECK-GI-NEXT:    mov.b v3[3], w10
; CHECK-GI-NEXT:    mov.b v6[3], w8
; CHECK-GI-NEXT:    mov.b v5[2], w10
; CHECK-GI-NEXT:    and.8b v0, v0, v1
; CHECK-GI-NEXT:    mov.b v4[3], w10
; CHECK-GI-NEXT:    mov.b v5[3], w8
; CHECK-GI-NEXT:    orr.8b v0, v0, v3
; CHECK-GI-NEXT:    eor.8b v1, v0, v5
; CHECK-GI-NEXT:    eor.8b v0, v4, v0
; CHECK-GI-NEXT:    and.8b v1, v1, v6
; CHECK-GI-NEXT:    orr.8b v0, v2, v0
; CHECK-GI-NEXT:    orr.8b v0, v1, v0
; CHECK-GI-NEXT:    umov.b w8, v0[3]
; CHECK-GI-NEXT:    and w8, w8, #0x1
...
; CHECK-GI-NEXT:    .cfi_def_cfa_offset 16
; CHECK-GI-NEXT:    cmeq.4s v1, v1, #0
; CHECK-GI-NEXT:    cmtst.4h v0, v0, v0
...
; CHECK-GI-NEXT:    mov.b v1[2], w9
; CHECK-GI-NEXT:    mov.b v1[3], w10
