...
; RUN: llc < %s -mtriple aarch64-unknown-unknown -mattr=+bf16,+fullfp16 -global-isel -global-isel-abort=1 2>&1 | FileCheck %s --check-prefixes=CHECK,CHECK-BF16,CHECK-GI
...
; CHECK-CVT-LABEL: test_fadd_v2bf16:
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-SD-LABEL: test_fadd_v2bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    shll v1.4s, v1.4h, #16
; CHECK-SD-NEXT:    shll v0.4s, v0.4h, #16
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_fadd_v2bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-GI-NEXT:    shll v1.4s, v1.4h, #16
...
define <4 x bfloat> @test_fadd_v4bf16(<4 x bfloat> %a, <4 x bfloat> %b) {
; CHECK-CVT-LABEL: test_fadd_v4bf16:
; CHECK-CVT:       // %bb.0: // %entry
; CHECK-CVT-NEXT:    shll v1.4s, v1.4h, #16
; CHECK-CVT-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-CVT-NEXT:    fadd v0.4s, v0.4s, v1.4s
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-SD-LABEL: test_fadd_v4bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    shll v1.4s, v1.4h, #16
; CHECK-SD-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-SD-NEXT:    fadd v0.4s, v0.4s, v1.4s
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_fadd_v4bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-GI-NEXT:    shll v1.4s, v1.4h, #16
...
; CHECK-CVT-NEXT:    adrp x8, .LCPI31_0
; CHECK-CVT-NEXT:    movi v3.2s, #72, lsl #24
; CHECK-CVT-NEXT:    fcmp s2, s1
; CHECK-CVT-NEXT:    ldr h1, [x8, :lo12:.LCPI31_0]
...
; CHECK-SD-NEXT:    ldr h1, [x8, :lo12:.LCPI31_0]
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-SD-LABEL: test_fptosi_i64:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    // kill: def $h0 killed $h0 def $d0
; CHECK-SD-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-SD-NEXT:    fcvtzs x0, s0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_fptosi_i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $h0 killed $h0 def $d0
; CHECK-GI-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-GI-NEXT:    fcvt d0, s0
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-SD-LABEL: test_fptoui_i64:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    // kill: def $h0 killed $h0 def $d0
; CHECK-SD-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-SD-NEXT:    fcvtzu x0, s0
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_fptoui_i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $h0 killed $h0 def $d0
; CHECK-GI-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-GI-NEXT:    fcvt d0, s0
...
define <4 x bfloat> @test_sitofp_v4i32(<4 x i32> %a) {
; CHECK-CVT-LABEL: test_sitofp_v4i32:
; CHECK-CVT:       // %bb.0: // %entry
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-BF16-LABEL: test_sitofp_v4i32:
...
define <2 x bfloat> @test_fptrunc_v2f32(<2 x float> %a) {
; CHECK-CVT-LABEL: test_fptrunc_v2f32:
; CHECK-CVT:       // %bb.0: // %entry
; CHECK-CVT-NEXT:    movi v1.4s, #1
; CHECK-CVT-NEXT:    movi v2.4s, #127, msl #8
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-BF16-LABEL: test_fptrunc_v2f32:
; CHECK-BF16:       // %bb.0: // %entry
...
define <3 x bfloat> @test_fptrunc_v3f32(<3 x float> %a) {
; CHECK-CVT-LABEL: test_fptrunc_v3f32:
; CHECK-CVT:       // %bb.0: // %entry
; CHECK-CVT-NEXT:    movi v1.4s, #1
; CHECK-CVT-NEXT:    movi v2.4s, #127, msl #8
; CHECK-CVT-NEXT:    ushr v3.4s, v0.4s, #16
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-BF16-LABEL: test_fptrunc_v3f32:
; CHECK-BF16:       // %bb.0: // %entry
; CHECK-BF16-NEXT:    bfcvtn v0.4h, v0.4s
; CHECK-BF16-NEXT:    ret
entry:
...
define <4 x bfloat> @test_fptrunc_v4f64(<4 x double> %a) {
; CHECK-CVT-LABEL: test_fptrunc_v4f64:
; CHECK-CVT:       // %bb.0: // %entry
...
; CHECK-CVT-NEXT:    ret
;
; CHECK-BF16-LABEL: test_fptrunc_v4f64:
; CHECK-BF16:       // %bb.0: // %entry
...
define <4 x float> @test_fpext_v4f32(<4 x bfloat> %a) {
; CHECK-LABEL: test_fpext_v4f32:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-NEXT:    ret
entry:
...
define <4 x double> @test_fpext_v4f64(<4 x bfloat> %a) {
; CHECK-CVT-LABEL: test_fpext_v4f64:
; CHECK-CVT:       // %bb.0: // %entry
; CHECK-CVT-NEXT:    shll v0.4s, v0.4h, #16
; CHECK-CVT-NEXT:    fcvtl2 v1.2d, v0.4s
; CHECK-CVT-NEXT:    fcvtl v0.2d, v0.2s
; CHECK-CVT-NEXT:    ret
;
; CHECK-SD-LABEL: test_fpext_v4f64:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    shll v0.4s, v0.4h, #16
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_fpext_v4f64:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    shll v1.4s, v0.4h, #16
