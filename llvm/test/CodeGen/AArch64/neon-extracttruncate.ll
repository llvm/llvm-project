...
; CHECK-SD-LABEL: extract_2_v4i16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    uzp1 v0.8b, v0.8b, v1.8b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_2_v4i16:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-SD-LABEL: extract_4_v4i16:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_4_v4i16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    mov h4, v0.h[1]
; CHECK-GI-NEXT:    mov h5, v0.h[2]
; CHECK-GI-NEXT:    // kill: def $d1 killed $d1 def $q1
...
; CHECK-GI-NEXT:    mov v0.b[4], w8
; CHECK-GI-NEXT:    fmov w8, s4
; CHECK-GI-NEXT:    mov h4, v2.h[2]
; CHECK-GI-NEXT:    mov v0.b[5], w8
; CHECK-GI-NEXT:    fmov w8, s5
; CHECK-GI-NEXT:    mov v0.b[6], w8
; CHECK-GI-NEXT:    fmov w8, s1
; CHECK-GI-NEXT:    mov h1, v2.h[1]
; CHECK-GI-NEXT:    mov v0.b[7], w8
; CHECK-GI-NEXT:    fmov w8, s2
; CHECK-GI-NEXT:    mov v0.b[8], w8
; CHECK-GI-NEXT:    fmov w8, s1
; CHECK-GI-NEXT:    mov h1, v2.h[3]
; CHECK-GI-NEXT:    mov h2, v3.h[2]
...
; CHECK-SD-LABEL: extract_4_v4i32:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_4_v4i32:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-GI-NEXT:    mov v0.b[8], v2.b[0]
; CHECK-GI-NEXT:    mov v0.b[9], w8
; CHECK-GI-NEXT:    mov w8, v2.s[3]
; CHECK-GI-NEXT:    mov v0.b[10], w9
; CHECK-GI-NEXT:    mov w9, v3.s[2]
; CHECK-GI-NEXT:    mov v0.b[11], w8
; CHECK-GI-NEXT:    mov w8, v3.s[1]
; CHECK-GI-NEXT:    mov v0.b[12], v3.b[0]
; CHECK-GI-NEXT:    mov v0.b[13], w8
; CHECK-GI-NEXT:    mov w8, v3.s[3]
; CHECK-GI-NEXT:    mov v0.b[14], w9
; CHECK-GI-NEXT:    mov v0.b[15], w8
; CHECK-GI-NEXT:    ret
entry:
  %a0 = extractelement <4 x i32> %a, i32 0
...
; CHECK-SD-LABEL: extract_4_mixed:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_4_mixed:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    mov h4, v0.h[1]
; CHECK-GI-NEXT:    mov h5, v0.h[2]
...
; CHECK-GI-NEXT:    mov v0.b[1], w8
; CHECK-GI-NEXT:    fmov w8, s5
; CHECK-GI-NEXT:    mov h5, v3.h[2]
; CHECK-GI-NEXT:    mov v0.b[2], w8
; CHECK-GI-NEXT:    fmov w8, s4
; CHECK-GI-NEXT:    mov h4, v3.h[1]
; CHECK-GI-NEXT:    mov v0.b[3], w8
; CHECK-GI-NEXT:    mov w8, v1.s[1]
; CHECK-GI-NEXT:    mov v0.b[4], v1.b[0]
; CHECK-GI-NEXT:    mov v0.b[5], w8
...
; CHECK-SD-LABEL: extract_4_v4i32_badindex:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    ldr q4, [x8, :lo12:.LCPI5_0]
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_4_v4i32_badindex:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    mov w8, v0.s[1]
; CHECK-GI-NEXT:    mov w9, v0.s[2]
; CHECK-GI-NEXT:    mov w10, v0.s[3]
; CHECK-GI-NEXT:    mov v0.b[1], w8
; CHECK-GI-NEXT:    mov w8, v1.s[2]
; CHECK-GI-NEXT:    mov v0.b[2], w9
...
; CHECK-SD-LABEL: extract_4_v4i32_one:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    uzp1 v0.8h, v0.8h, v0.8h
; CHECK-SD-NEXT:    uzp1 v0.16b, v0.16b, v0.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: extract_4_v4i32_one:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    mov w8, v0.s[1]
; CHECK-GI-NEXT:    mov v1.16b, v0.16b
; CHECK-GI-NEXT:    mov w9, v0.s[2]
; CHECK-GI-NEXT:    mov w10, v1.s[3]
; CHECK-GI-NEXT:    mov v0.b[1], w8
; CHECK-GI-NEXT:    mov v0.b[2], w9
; CHECK-GI-NEXT:    mov v0.b[3], w10
; CHECK-GI-NEXT:    mov v0.b[4], v1.b[0]
; CHECK-GI-NEXT:    mov v0.b[5], w8
; CHECK-GI-NEXT:    mov v0.b[6], w9
; CHECK-GI-NEXT:    mov v0.b[7], w10
; CHECK-GI-NEXT:    mov v0.b[8], v1.b[0]
; CHECK-GI-NEXT:    mov v0.b[9], w8
; CHECK-GI-NEXT:    mov v0.b[10], w9
; CHECK-GI-NEXT:    mov v0.b[11], w10
; CHECK-GI-NEXT:    mov v0.b[12], v1.b[0]
; CHECK-GI-NEXT:    mov v0.b[13], w8
; CHECK-GI-NEXT:    mov v0.b[14], w9
; CHECK-GI-NEXT:    mov v0.b[15], w10
; CHECK-GI-NEXT:    ret
entry:
  %a0 = extractelement <4 x i32> %a, i32 0
  %a1 = extractelement <4 x i32> %a, i32 1
