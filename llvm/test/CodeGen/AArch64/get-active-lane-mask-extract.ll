...
; RUN: llc -enable-subreg-liveness -mattr=+sve -mattr=+sme2 -force-streaming < %s | FileCheck %s -check-prefix CHECK-SVE2p1-SME2
...
; CHECK-SVE2p1-SME2-NEXT:    mov z0.s, p0/z, #1 // =0x1
; CHECK-SVE2p1-SME2-NEXT:    movprfx z1, z0
; CHECK-SVE2p1-SME2-NEXT:    ext z1.b, z1.b, z0.b, #8
; CHECK-SVE2p1-SME2-NEXT:    // fake_use: $d0
; CHECK-SVE2p1-SME2-NEXT:    // fake_use: $d1
; CHECK-SVE2p1-SME2-NEXT:    ret
    %r = call <vscale x 4 x i1> @llvm.get.active.lane.mask.nxv4i1.i64(i64 %i, i64 %n)
