...
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon < %s | FileCheck %s --check-prefixes=CHECK,CHECK-SD
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon,+bf16 < %s | FileCheck %s --check-prefixes=CHECK,CHECK-SD
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon,+fullfp16,+bf16 < %s | FileCheck %s --check-prefixes=CHECK,CHECK-SD
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon < %s -global-isel | FileCheck %s --check-prefixes=CHECK,CHECK-GI
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon,+bf16 < %s -global-isel | FileCheck %s --check-prefixes=CHECK,CHECK-GI
; RUN: llc -mtriple=aarch64 -mattr=+v8.6a,+neon,+fullfp16,+bf16 < %s -global-isel | FileCheck %s --check-prefixes=CHECK,CHECK-GI
...
; CHECK-SD-LABEL: test_vmov_n_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    // kill: def $s0 killed $s0 def $q0
; CHECK-SD-NEXT:    dup v0.4h, v0.h[0]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_vmov_n_bf16:
; CHECK-GI:       // %bb.0: // %entry
...
; CHECK-SD-LABEL: test_vmovq_n_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    // kill: def $s0 killed $s0 def $q0
; CHECK-SD-NEXT:    dup v0.8h, v0.h[0]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_vmovq_n_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    fmov w8, s0
...
; CHECK-SD-LABEL: test_vdup_n_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    // kill: def $s0 killed $s0 def $q0
; CHECK-SD-NEXT:    dup v0.4h, v0.h[0]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_vdup_n_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    fmov w8, s0
; CHECK-GI-NEXT:    dup v0.4h, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: test_vdupq_n_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    // kill: def $s0 killed $s0 def $q0
; CHECK-SD-NEXT:    dup v0.8h, v0.h[0]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_vdupq_n_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    fmov w8, s0
; CHECK-GI-NEXT:    dup v0.8h, w8
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: shuffle3step0_bf16:
; CHECK-SD:       // %bb.0: // %entry
...
; CHECK-SD-NEXT:    tbl v2.16b, { v0.16b, v1.16b }, v4.16b
; CHECK-SD-NEXT:    ldr q0, [x8, :lo12:.LCPI16_1]
; CHECK-SD-NEXT:    tbl v0.16b, { v2.16b, v3.16b }, v0.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shuffle3step0_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    mov h3, v0.h[0]
; CHECK-GI-NEXT:    mov v3.h[1], v0.h[3]
; CHECK-GI-NEXT:    mov v3.h[2], v0.h[6]
; CHECK-GI-NEXT:    mov v3.h[3], v1.h[1]
; CHECK-GI-NEXT:    mov v3.h[4], v1.h[4]
; CHECK-GI-NEXT:    mov v3.h[5], v1.h[7]
; CHECK-GI-NEXT:    mov v3.h[6], v2.h[2]
; CHECK-GI-NEXT:    mov v3.h[7], v2.h[5]
...
; CHECK-SD-LABEL: shuffle3step1_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    adrp x8, .LCPI17_0
; CHECK-SD-NEXT:    // kill: def $q1 killed $q1 killed $q0_q1 def $q0_q1
; CHECK-SD-NEXT:    mov v3.16b, v2.16b
; CHECK-SD-NEXT:    ldr q4, [x8, :lo12:.LCPI17_0]
; CHECK-SD-NEXT:    // kill: def $q0 killed $q0 killed $q0_q1 def $q0_q1
; CHECK-SD-NEXT:    adrp x8, .LCPI17_1
; CHECK-SD-NEXT:    tbl v2.16b, { v0.16b, v1.16b }, v4.16b
; CHECK-SD-NEXT:    ldr q0, [x8, :lo12:.LCPI17_1]
; CHECK-SD-NEXT:    tbl v0.16b, { v2.16b, v3.16b }, v0.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shuffle3step1_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    mov h3, v0.h[1]
; CHECK-GI-NEXT:    mov v3.h[1], v0.h[4]
; CHECK-GI-NEXT:    mov v3.h[2], v0.h[7]
; CHECK-GI-NEXT:    mov v3.h[3], v1.h[2]
; CHECK-GI-NEXT:    mov v3.h[4], v1.h[5]
; CHECK-GI-NEXT:    mov v3.h[5], v2.h[0]
; CHECK-GI-NEXT:    mov v3.h[6], v2.h[3]
; CHECK-GI-NEXT:    mov v3.h[7], v2.h[6]
; CHECK-GI-NEXT:    mov v0.16b, v3.16b
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-SD-LABEL: shuffle3step2_bf16:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    adrp x8, .LCPI18_0
; CHECK-SD-NEXT:    // kill: def $q1 killed $q1 killed $q0_q1 def $q0_q1
; CHECK-SD-NEXT:    mov v3.16b, v2.16b
; CHECK-SD-NEXT:    ldr q4, [x8, :lo12:.LCPI18_0]
; CHECK-SD-NEXT:    // kill: def $q0 killed $q0 killed $q0_q1 def $q0_q1
; CHECK-SD-NEXT:    adrp x8, .LCPI18_1
; CHECK-SD-NEXT:    tbl v2.16b, { v0.16b, v1.16b }, v4.16b
; CHECK-SD-NEXT:    ldr q0, [x8, :lo12:.LCPI18_1]
; CHECK-SD-NEXT:    tbl v0.16b, { v2.16b, v3.16b }, v0.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shuffle3step2_bf16:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    mov h3, v0.h[2]
; CHECK-GI-NEXT:    mov v3.h[1], v0.h[5]
; CHECK-GI-NEXT:    mov v3.h[2], v1.h[0]
; CHECK-GI-NEXT:    mov v3.h[3], v1.h[3]
; CHECK-GI-NEXT:    mov v3.h[4], v1.h[6]
; CHECK-GI-NEXT:    mov v3.h[5], v2.h[1]
; CHECK-GI-NEXT:    mov v3.h[6], v2.h[4]
; CHECK-GI-NEXT:    mov v3.h[7], v2.h[7]
; CHECK-GI-NEXT:    mov v0.16b, v3.16b
; CHECK-GI-NEXT:    ret
entry:
