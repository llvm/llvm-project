...
; CHECK-SD-NEXT:    str q3, [sp, #48] // 16-byte Spill
; CHECK-SD-NEXT:    ldp d3, d2, [sp, #160]
; CHECK-SD-NEXT:    mov v6.d[1], v7.d[0]
; CHECK-SD-NEXT:    ld1 { v2.d }[1], [x8]
; CHECK-SD-NEXT:    stp q3, q6, [sp, #80] // 32-byte Folded Spill
...
; CHECK-SD-NEXT:    fmov d1, x8
; CHECK-SD-NEXT:    ldp q3, q2, [sp, #64] // 32-byte Folded Reload
; CHECK-SD-NEXT:    bif v2.16b, v3.16b, v1.16b
