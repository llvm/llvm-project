...
; CHECK-GI-NEXT:    str q2, [sp, #144] // 16-byte Spill
; CHECK-GI-NEXT:    ldr d2, [sp, #200]
; CHECK-GI-NEXT:    stp q2, q6, [sp, #96] // 32-byte Folded Spill
; CHECK-GI-NEXT:    ldr d2, [sp, #208]
; CHECK-GI-NEXT:    str q2, [sp, #80] // 16-byte Spill
; CHECK-GI-NEXT:    ldr d2, [sp, #216]
; CHECK-GI-NEXT:    str q2, [sp, #128] // 16-byte Spill
; CHECK-GI-NEXT:    bl __lttf2
; CHECK-GI-NEXT:    ldp q1, q0, [sp] // 32-byte Folded Reload
; CHECK-GI-NEXT:    cmp w0, #0
...
; CHECK-GI-NEXT:    bl __lttf2
; CHECK-GI-NEXT:    fmov d0, x19
; CHECK-GI-NEXT:    ldp q3, q2, [sp, #96] // 32-byte Folded Reload
; CHECK-GI-NEXT:    ldp q6, q1, [sp, #64] // 32-byte Folded Reload
; CHECK-GI-NEXT:    cmp w0, #0
; CHECK-GI-NEXT:    cset w8, mi
; CHECK-GI-NEXT:    ldr x30, [sp, #160] // 8-byte Reload
...
; CHECK-GI-NEXT:    mov v2.d[1], v6.d[0]
; CHECK-GI-NEXT:    shl v0.2d, v0.2d, #63
; CHECK-GI-NEXT:    shl v1.2d, v1.2d, #63
; CHECK-GI-NEXT:    cmlt v0.2d, v0.2d, #0
; CHECK-GI-NEXT:    cmlt v1.2d, v1.2d, #0
; CHECK-GI-NEXT:    bsl v0.16b, v2.16b, v3.16b
; CHECK-GI-NEXT:    ldp q3, q2, [sp, #128] // 32-byte Folded Reload
; CHECK-GI-NEXT:    bif v2.16b, v3.16b, v1.16b
; CHECK-GI-NEXT:    mov d1, v0.d[1]
...
; CHECK-GI-NEXT:    ldp d1, d2, [sp, #8]
; CHECK-GI-NEXT:    ldr d4, [sp, #24]
; CHECK-GI-NEXT:    cset w8, mi
; CHECK-GI-NEXT:    mov v1.d[1], v2.d[0]
; CHECK-GI-NEXT:    fmov d2, x8
; CHECK-GI-NEXT:    fcmgt v0.2d, v3.2d, v0.2d
; CHECK-GI-NEXT:    shl v2.2d, v2.2d, #63
; CHECK-GI-NEXT:    bsl v0.16b, v6.16b, v1.16b
; CHECK-GI-NEXT:    cmlt v1.2d, v2.2d, #0
; CHECK-GI-NEXT:    ldr d2, [sp]
; CHECK-GI-NEXT:    bif v2.16b, v4.16b, v1.16b
; CHECK-GI-NEXT:    mov d1, v0.d[1]
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-GI-NEXT:    // kill: def $d2 killed $d2 killed $q2
; CHECK-GI-NEXT:    ret
...
; CHECK-GI-NOFP16-NEXT:    mov v4.b[1], w8
; CHECK-GI-NOFP16-NEXT:    fcvtl v0.4s, v6.4h
; CHECK-GI-NOFP16-NEXT:    fcvtl v1.4s, v7.4h
; CHECK-GI-NOFP16-NEXT:    mov v4.b[2], w9
; CHECK-GI-NOFP16-NEXT:    fcmgt v1.4s, v1.4s, v0.4s
; CHECK-GI-NOFP16-NEXT:    mov v4.b[3], w10
; CHECK-GI-NOFP16-NEXT:    mov w8, v1.s[1]
; CHECK-GI-NOFP16-NEXT:    mov w9, v1.s[2]
; CHECK-GI-NOFP16-NEXT:    mov v4.b[4], v1.b[0]
; CHECK-GI-NOFP16-NEXT:    mov v4.b[5], w8
; CHECK-GI-NOFP16-NEXT:    mov v4.b[6], w9
; CHECK-GI-NOFP16-NEXT:    ushll v0.8h, v4.8b, #0
...
; CHECK-GI-NOFP16-NEXT:    fmov s4, w7
; CHECK-GI-NOFP16-NEXT:    ldr s5, [sp, #24]
; CHECK-GI-NOFP16-NEXT:    mov v7.s[2], w6
; CHECK-GI-NOFP16-NEXT:    mov v5.s[1], v6.s[0]
...
; CHECK-GI-NOFP16-NEXT:    mov w10, v0.s[3]
; CHECK-GI-NOFP16-NEXT:    fmov s3, w0
; CHECK-GI-NOFP16-NEXT:    mov v5.s[2], v6.s[0]
; CHECK-GI-NOFP16-NEXT:    fcmgt v1.4s, v2.4s, v1.4s
; CHECK-GI-NOFP16-NEXT:    mov v0.h[1], w8
; CHECK-GI-NOFP16-NEXT:    ldr s2, [sp]
; CHECK-GI-NOFP16-NEXT:    mov v3.s[1], w1
; CHECK-GI-NOFP16-NEXT:    mov v4.s[1], v2.s[0]
; CHECK-GI-NOFP16-NEXT:    ldr s2, [sp, #8]
; CHECK-GI-NOFP16-NEXT:    mov w8, v1.s[1]
; CHECK-GI-NOFP16-NEXT:    mov v0.h[2], w9
; CHECK-GI-NOFP16-NEXT:    mov w9, v1.s[2]
; CHECK-GI-NOFP16-NEXT:    mov v3.s[2], w2
; CHECK-GI-NOFP16-NEXT:    mov v4.s[2], v2.s[0]
; CHECK-GI-NOFP16-NEXT:    ldr s2, [sp, #16]
; CHECK-GI-NOFP16-NEXT:    mov v1.h[1], w8
; CHECK-GI-NOFP16-NEXT:    mov v0.h[3], w10
; CHECK-GI-NOFP16-NEXT:    mov v3.s[3], w3
; CHECK-GI-NOFP16-NEXT:    mov v4.s[3], v2.s[0]
...
; CHECK-GI-NOFP16-NEXT:    cmlt v0.4s, v0.4s, #0
; CHECK-GI-NOFP16-NEXT:    shl v1.4s, v1.4s, #31
; CHECK-GI-NOFP16-NEXT:    bsl v0.16b, v3.16b, v4.16b
; CHECK-GI-NOFP16-NEXT:    cmlt v1.4s, v1.4s, #0
; CHECK-GI-NOFP16-NEXT:    bsl v1.16b, v7.16b, v5.16b
...
; CHECK-GI-FP16-NEXT:    mov v1.s[1], v2.s[0]
; CHECK-GI-FP16-NEXT:    ldr s2, [sp, #8]
; CHECK-GI-FP16-NEXT:    ushll v6.4s, v0.4h, #0
; CHECK-GI-FP16-NEXT:    ushll2 v0.4s, v0.8h, #0
; CHECK-GI-FP16-NEXT:    mov v7.s[1], w5
; CHECK-GI-FP16-NEXT:    mov v4.s[1], v5.s[0]
; CHECK-GI-FP16-NEXT:    mov v3.s[2], w2
; CHECK-GI-FP16-NEXT:    shl v5.4s, v6.4s, #31
; CHECK-GI-FP16-NEXT:    ldr s6, [sp, #40]
; CHECK-GI-FP16-NEXT:    mov v1.s[2], v2.s[0]
...
; CHECK-GI-FP16-NEXT:    mov v1.s[3], v2.s[0]
; CHECK-GI-FP16-NEXT:    cmlt v2.4s, v5.4s, #0
; CHECK-GI-FP16-NEXT:    bsl v0.16b, v7.16b, v4.16b
; CHECK-GI-FP16-NEXT:    bit v1.16b, v3.16b, v2.16b
; CHECK-GI-FP16-NEXT:    mov s5, v0.s[1]
; CHECK-GI-FP16-NEXT:    mov s6, v0.s[2]
; CHECK-GI-FP16-NEXT:    fmov w4, s0
; CHECK-GI-FP16-NEXT:    mov s2, v1.s[1]
; CHECK-GI-FP16-NEXT:    mov s3, v1.s[2]
; CHECK-GI-FP16-NEXT:    mov s4, v1.s[3]
