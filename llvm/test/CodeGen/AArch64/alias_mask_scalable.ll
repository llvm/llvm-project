...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.war.mask.v16i1(ptr %a, ptr %b, i64 1)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilewr_16_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.war.mask.v16i1(ptr %a, ptr %b, i64 2)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilewr_32_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.war.mask.v16i1(ptr %a, ptr %b, i64 4)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilewr_64_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.war.mask.v16i1(ptr %a, ptr %b, i64 8)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilerw_8_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.raw.mask.v16i1(ptr %a, ptr %b, i64 1)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilerw_16_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.raw.mask.v16i1(ptr %a, ptr %b, i64 2)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilerw_32_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.raw.mask.v16i1(ptr %a, ptr %b, i64 4)
  ret <vscale x 1 x i1> %0
}

define <vscale x 1 x i1> @whilerw_64_scalarize(ptr %a, ptr %b) {
...
; CHECK-NEXT:    ret
entry:
  %0 = call <vscale x 1 x i1> @llvm.loop.dependence.raw.mask.v16i1(ptr %a, ptr %b, i64 8)
  ret <vscale x 1 x i1> %0
}
