...
; CHECK-NEXT:  ; %bb.1: ; %bb1.cond.split
; CHECK-NEXT:    cbnz w1, LBB0_3
; CHECK-NEXT:  LBB0_2:
...
; CHECK-NEXT:  ; %bb.1: ; %bb1.cond.split
; CHECK-NEXT:    cbnz w1, LBB1_3
; CHECK-NEXT:  LBB1_2:
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    ret
; CHECK-NEXT:  LBB1_3: ; %bb4
; CHECK-NEXT:    stp x29, x30, [sp, #-16]! ; 16-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w30, -8
; CHECK-NEXT:    .cfi_offset w29, -16
...
; CHECK-NEXT:  ; %bb.1: ; %bb1.cond.split
; CHECK-NEXT:    cbnz w1, LBB2_3
; CHECK-NEXT:  LBB2_2:
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    ret
; CHECK-NEXT:  LBB2_3: ; %bb4
; CHECK-NEXT:    stp x29, x30, [sp, #-16]! ; 16-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w30, -8
; CHECK-NEXT:    .cfi_offset w29, -16
...
; CHECK-NEXT:  ; %bb.1: ; %bb1.cond.split
; CHECK-NEXT:    cbnz w1, LBB3_3
; CHECK-NEXT:  LBB3_2:
; CHECK-NEXT:    mov x0, xzr
; CHECK-NEXT:    ret
; CHECK-NEXT:  LBB3_3: ; %bb4
; CHECK-NEXT:    stp x29, x30, [sp, #-16]! ; 16-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 16
; CHECK-NEXT:    .cfi_offset w30, -8
; CHECK-NEXT:    .cfi_offset w29, -16
