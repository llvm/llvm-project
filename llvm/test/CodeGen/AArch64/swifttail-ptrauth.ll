...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp0
; COMPAT-NEXT: .Ltmp0:
; COMPAT-NEXT:   hint #25

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp0
; V83A-NEXT:   .Ltmp0:
; V83A-NEXT:     paciasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp0
; V9A-NEXT:    .Ltmp0:
; V9A-NEXT:      paciasppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 0, 0
; COMPAT-NEXT:   hint #29

; V83A-NEXT:     adrp x16, .Ltmp0
; V83A-NEXT:     add x16, x16, :lo12:.Ltmp0
; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 0, 0
; V83A-NEXT:     autiasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 0, 0
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp1
; COMPAT-NEXT: .Ltmp1:
; COMPAT-NEXT:   hint #25

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp1
; V83A-NEXT:   .Ltmp1:
; V83A-NEXT:     paciasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp1
; V9A-NEXT:    .Ltmp1:
; V9A-NEXT:      paciasppc
...
; COMPAT-NEXT:   hint #39
; COMPAT-NEXT:   .cfi_llvm_set_ra_state 2, .Ltmp2
; COMPAT-NEXT: .Ltmp2:
; COMPAT-NEXT:   hint #25

; V83A-NEXT:     hint #39
; V83A-NEXT:     .cfi_llvm_set_ra_state 2, .Ltmp2
; V83A-NEXT:   .Ltmp2:
; V83A-NEXT:     paciasp

; V9A-NEXT:      .cfi_llvm_set_ra_state 2, .Ltmp2
; V9A-NEXT:    .Ltmp2:
; V9A-NEXT:      paciasppc
