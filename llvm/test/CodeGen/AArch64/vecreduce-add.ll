...
; CHECK-GI-BASE:       // %bb.0: // %entry
; CHECK-GI-BASE-NEXT:    movi d0, #0000000000000000
; CHECK-GI-BASE-NEXT:    movi d1, #0000000000000000
...
; CHECK-GI-BASE:       // %bb.0: // %entry
; CHECK-GI-BASE-NEXT:    movi d0, #0000000000000000
; CHECK-GI-BASE-NEXT:    movi d2, #0000000000000000
; CHECK-GI-BASE-NEXT:    ldr q16, [x0, #32]
; CHECK-GI-BASE-NEXT:    movi d1, #0000000000000000
; CHECK-GI-BASE-NEXT:    movi d3, #0000000000000000
