...
; FULLFP16-LABEL: max_nofpclass_v2f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_v2f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: max_nofpclass_v4f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_v4f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: max_nofpclass_v8f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.8h, v0.8h, v1.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_v8f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
; NOFULLFP16-NEXT:    mov h3, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h1
...
; FULLFP16-LABEL: max_nofpclass_v9f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; FULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; FULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_v9f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; NOFULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; NOFULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
; NOFULLFP16-NEXT:    add x9, sp, #16
; NOFULLFP16-NEXT:    // kill: def $h3 killed $h3 def $q3
; NOFULLFP16-NEXT:    // kill: def $h4 killed $h4 def $q4
; NOFULLFP16-NEXT:    // kill: def $h5 killed $h5 def $q5
; NOFULLFP16-NEXT:    // kill: def $h6 killed $h6 def $q6
; NOFULLFP16-NEXT:    // kill: def $h7 killed $h7 def $q7
; NOFULLFP16-NEXT:    mov v0.h[1], v1.h[0]
; NOFULLFP16-NEXT:    ldr h1, [sp, #8]
; NOFULLFP16-NEXT:    ld1 { v1.h }[1], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #24
; NOFULLFP16-NEXT:    mov v0.h[2], v2.h[0]
; NOFULLFP16-NEXT:    ld1 { v1.h }[2], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #32
; NOFULLFP16-NEXT:    mov v0.h[3], v3.h[0]
; NOFULLFP16-NEXT:    ld1 { v1.h }[3], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #40
; NOFULLFP16-NEXT:    ld1 { v1.h }[4], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #48
; NOFULLFP16-NEXT:    mov v0.h[4], v4.h[0]
; NOFULLFP16-NEXT:    ld1 { v1.h }[5], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #56
; NOFULLFP16-NEXT:    mov v0.h[5], v5.h[0]
; NOFULLFP16-NEXT:    ld1 { v1.h }[6], [x9]
; NOFULLFP16-NEXT:    add x9, sp, #64
; NOFULLFP16-NEXT:    mov v0.h[6], v6.h[0]
; NOFULLFP16-NEXT:    ld1 { v1.h }[7], [x9]
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h1
; NOFULLFP16-NEXT:    mov h6, v1.h[2]
; NOFULLFP16-NEXT:    mov v0.h[7], v7.h[0]
; NOFULLFP16-NEXT:    mov h16, v1.h[3]
; NOFULLFP16-NEXT:    fcvt s2, h2
; NOFULLFP16-NEXT:    mov h3, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s5, h0
; NOFULLFP16-NEXT:    mov h7, v0.h[2]
; NOFULLFP16-NEXT:    mov h17, v0.h[3]
; NOFULLFP16-NEXT:    fcvt s3, h3
; NOFULLFP16-NEXT:    fmaxnm s4, s5, s4
; NOFULLFP16-NEXT:    fcvt s5, h6
; NOFULLFP16-NEXT:    fcvt s6, h7
; NOFULLFP16-NEXT:    fcvt s7, h16
; NOFULLFP16-NEXT:    fcvt s16, h17
; NOFULLFP16-NEXT:    fmaxnm s3, s3, s2
; NOFULLFP16-NEXT:    fcvt h2, s4
; NOFULLFP16-NEXT:    mov h4, v1.h[4]
; NOFULLFP16-NEXT:    fmaxnm s5, s6, s5
; NOFULLFP16-NEXT:    mov h6, v0.h[4]
; NOFULLFP16-NEXT:    fmaxnm s7, s16, s7
; NOFULLFP16-NEXT:    mov h16, v1.h[5]
; NOFULLFP16-NEXT:    fcvt h3, s3
; NOFULLFP16-NEXT:    fcvt s4, h4
; NOFULLFP16-NEXT:    fcvt s6, h6
; NOFULLFP16-NEXT:    fcvt h5, s5
; NOFULLFP16-NEXT:    fcvt s16, h16
; NOFULLFP16-NEXT:    mov v2.h[1], v3.h[0]
; NOFULLFP16-NEXT:    mov h3, v0.h[5]
; NOFULLFP16-NEXT:    fmaxnm s4, s6, s4
; NOFULLFP16-NEXT:    fcvt h6, s7
; NOFULLFP16-NEXT:    mov h7, v0.h[6]
; NOFULLFP16-NEXT:    mov h0, v0.h[7]
; NOFULLFP16-NEXT:    fcvt s3, h3
; NOFULLFP16-NEXT:    mov v2.h[2], v5.h[0]
; NOFULLFP16-NEXT:    mov h5, v1.h[6]
; NOFULLFP16-NEXT:    mov h1, v1.h[7]
; NOFULLFP16-NEXT:    fcvt h4, s4
; NOFULLFP16-NEXT:    fcvt s0, h0
; NOFULLFP16-NEXT:    fmaxnm s3, s3, s16
; NOFULLFP16-NEXT:    mov v2.h[3], v6.h[0]
; NOFULLFP16-NEXT:    fcvt s5, h5
; NOFULLFP16-NEXT:    fcvt s6, h7
; NOFULLFP16-NEXT:    fcvt s1, h1
; NOFULLFP16-NEXT:    fcvt h3, s3
; NOFULLFP16-NEXT:    mov v2.h[4], v4.h[0]
; NOFULLFP16-NEXT:    fmaxnm s4, s6, s5
; NOFULLFP16-NEXT:    ldr h5, [sp]
; NOFULLFP16-NEXT:    ldr h6, [sp, #72]
; NOFULLFP16-NEXT:    fmaxnm s0, s0, s1
; NOFULLFP16-NEXT:    fcvt s6, h6
...
; NOFULLFP16-NEXT:    fcvt h3, s4
; NOFULLFP16-NEXT:    fcvt h0, s0
; NOFULLFP16-NEXT:    fmaxnm s1, s5, s6
; NOFULLFP16-NEXT:    mov v2.h[6], v3.h[0]
; NOFULLFP16-NEXT:    fcvt h1, s1
; NOFULLFP16-NEXT:    mov v2.h[7], v0.h[0]
; NOFULLFP16-NEXT:    str h1, [x8, #16]
; NOFULLFP16-NEXT:    str q2, [x8]
; NOFULLFP16-NEXT:    ret
entry:
  %c = call <9 x half> @llvm.maximumnum.v9f16(<9 x half> %a, <9 x half> %b)
  ret <9 x half> %c
...
; FULLFP16-LABEL: max_nofpclass_v16f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v1.8h, v1.8h, v3.8h
; FULLFP16-NEXT:    fmaxnm v0.8h, v0.8h, v2.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_v16f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h6, v2.h[1]
; NOFULLFP16-NEXT:    mov h7, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h2
...
; FULLFP16-LABEL: min_nofpclass_f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm h0, h0, h1
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    fcvt s1, h1
; NOFULLFP16-NEXT:    fcvt s0, h0
; NOFULLFP16-NEXT:    fminnm s0, s0, s1
...
; FULLFP16-LABEL: min_nofpclass_v2f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_v2f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: min_nofpclass_v4f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_v4f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: min_nofpclass_v8f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.8h, v0.8h, v1.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_v8f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
; NOFULLFP16-NEXT:    mov h3, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h1
...
; FULLFP16-LABEL: min_nofpclass_v9f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; FULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; FULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_v9f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; NOFULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; NOFULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; NOFULLFP16-NEXT:    fcvt h2, s4
; NOFULLFP16-NEXT:    mov h4, v1.h[4]
; NOFULLFP16-NEXT:    fminnm s5, s6, s5
; NOFULLFP16-NEXT:    mov h6, v0.h[4]
; NOFULLFP16-NEXT:    fminnm s7, s16, s7
; NOFULLFP16-NEXT:    mov h16, v1.h[5]
; NOFULLFP16-NEXT:    fcvt h3, s3
; NOFULLFP16-NEXT:    fcvt s4, h4
; NOFULLFP16-NEXT:    fcvt s6, h6
...
; NOFULLFP16-NEXT:    mov v2.h[1], v3.h[0]
; NOFULLFP16-NEXT:    mov h3, v0.h[5]
; NOFULLFP16-NEXT:    fminnm s4, s6, s4
; NOFULLFP16-NEXT:    fcvt h6, s7
; NOFULLFP16-NEXT:    mov h7, v0.h[6]
; NOFULLFP16-NEXT:    mov h0, v0.h[7]
; NOFULLFP16-NEXT:    fcvt s3, h3
...
; NOFULLFP16-NEXT:    fcvt h3, s3
; NOFULLFP16-NEXT:    mov v2.h[4], v4.h[0]
; NOFULLFP16-NEXT:    fminnm s4, s6, s5
; NOFULLFP16-NEXT:    ldr h5, [sp]
; NOFULLFP16-NEXT:    ldr h6, [sp, #72]
; NOFULLFP16-NEXT:    fminnm s0, s0, s1
; NOFULLFP16-NEXT:    fcvt s6, h6
...
; NOFULLFP16-NEXT:    fcvt h3, s4
; NOFULLFP16-NEXT:    fcvt h0, s0
; NOFULLFP16-NEXT:    fminnm s1, s5, s6
; NOFULLFP16-NEXT:    mov v2.h[6], v3.h[0]
; NOFULLFP16-NEXT:    fcvt h1, s1
; NOFULLFP16-NEXT:    mov v2.h[7], v0.h[0]
; NOFULLFP16-NEXT:    str h1, [x8, #16]
...
; FULLFP16-LABEL: min_nofpclass_v16f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v1.8h, v1.8h, v3.8h
; FULLFP16-NEXT:    fminnm v0.8h, v0.8h, v2.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_v16f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h6, v2.h[1]
; NOFULLFP16-NEXT:    mov h7, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h2
...
; FULLFP16-LABEL: max_nofpclass_s_v2f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_s_v2f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: max_nofpclass_s_v4f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_s_v4f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: max_nofpclass_s_v8f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v0.8h, v0.8h, v1.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_s_v8f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
; NOFULLFP16-NEXT:    mov h3, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h1
...
; FULLFP16-LABEL: max_nofpclass_s_v9f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; FULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; FULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_s_v9f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; NOFULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; NOFULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-LABEL: max_nofpclass_s_v16f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fmaxnm v1.8h, v1.8h, v3.8h
; FULLFP16-NEXT:    fmaxnm v0.8h, v0.8h, v2.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: max_nofpclass_s_v16f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h6, v2.h[1]
; NOFULLFP16-NEXT:    mov h7, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h2
...
; FULLFP16-LABEL: min_nofpclass_s_f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm h0, h0, h1
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    fcvt s1, h1
; NOFULLFP16-NEXT:    fcvt s0, h0
; NOFULLFP16-NEXT:    fminnm s0, s0, s1
...
; FULLFP16-LABEL: min_nofpclass_s_v2f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_v2f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: min_nofpclass_s_v4f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.4h, v0.4h, v1.4h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_v4f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $d1 killed $d1 def $q1
; NOFULLFP16-NEXT:    // kill: def $d0 killed $d0 def $q0
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
...
; FULLFP16-LABEL: min_nofpclass_s_v8f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v0.8h, v0.8h, v1.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_v8f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h2, v1.h[1]
; NOFULLFP16-NEXT:    mov h3, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h1
...
; FULLFP16-LABEL: min_nofpclass_s_v9f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; FULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; FULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_v9f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    // kill: def $h0 killed $h0 def $q0
; NOFULLFP16-NEXT:    // kill: def $h1 killed $h1 def $q1
; NOFULLFP16-NEXT:    // kill: def $h2 killed $h2 def $q2
...
; FULLFP16-LABEL: min_nofpclass_s_v16f16:
; FULLFP16:       // %bb.0: // %entry
; FULLFP16-NEXT:    fminnm v1.8h, v1.8h, v3.8h
; FULLFP16-NEXT:    fminnm v0.8h, v0.8h, v2.8h
; FULLFP16-NEXT:    ret
;
; NOFULLFP16-LABEL: min_nofpclass_s_v16f16:
; NOFULLFP16:       // %bb.0: // %entry
; NOFULLFP16-NEXT:    mov h6, v2.h[1]
; NOFULLFP16-NEXT:    mov h7, v0.h[1]
; NOFULLFP16-NEXT:    fcvt s4, h2
