...
; CHECK-SD-LABEL: v16i4:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    movi v2.16b, #15
; CHECK-SD-NEXT:    and v1.16b, v1.16b, v2.16b
; CHECK-SD-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-SD-NEXT:    uqsub v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: v16i4:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    movi v2.16b, #15
; CHECK-GI-NEXT:    sub v3.16b, v0.16b, v1.16b
; CHECK-GI-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-GI-NEXT:    and v1.16b, v1.16b, v2.16b
; CHECK-GI-NEXT:    cmhi v0.16b, v1.16b, v0.16b
; CHECK-GI-NEXT:    eor v0.16b, v0.16b, v2.16b
; CHECK-GI-NEXT:    and v0.16b, v3.16b, v0.16b
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: v16i1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    movi v2.16b, #1
; CHECK-SD-NEXT:    eor v1.16b, v1.16b, v2.16b
; CHECK-SD-NEXT:    and v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: v16i1:
; CHECK-GI:       // %bb.0:
