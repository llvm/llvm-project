...
; CHECK-SD-LABEL: fcmp_one_f64:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    fcmp d0, d1
; CHECK-SD-NEXT:    cset w8, mi
; CHECK-SD-NEXT:    csinc w0, w8, wzr, le
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: fcmp_one_f64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    fcmp d0, d1
; CHECK-GI-NEXT:    cset w8, mi
; CHECK-GI-NEXT:    cset w9, gt
; CHECK-GI-NEXT:    orr w0, w8, w9
; CHECK-GI-NEXT:    ret
...
; CHECK-GI-NEXT:    cset w19, ne
; CHECK-GI-NEXT:    bl __unordtf2
; CHECK-GI-NEXT:    cmp w0, #0
; CHECK-GI-NEXT:    cset w8, eq
; CHECK-GI-NEXT:    and w0, w19, w8
