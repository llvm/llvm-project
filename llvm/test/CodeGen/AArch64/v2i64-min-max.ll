...
; RUN: llc < %s -mtriple=aarch64 | FileCheck %s -check-prefix=CHECK-NEON
...
; CHECK-NEON-NEXT:    cmp x9, x8
; CHECK-NEON-NEXT:    csel x0, x9, x8, gt
; CHECK-NEON-NEXT:    ret
...
; CHECK-NEON-NEXT:    fmov x9, d0
; CHECK-NEON-NEXT:    cmp x9, x8
; CHECK-NEON-NEXT:    csel x0, x9, x8, hi
; CHECK-NEON-NEXT:    ret
  %2 = extractelement <2 x i64> %0, i64 0
  %3 = extractelement <2 x i64> %0, i64 1
...
; CHECK-NEON-NEXT:    fmov x9, d0
; CHECK-NEON-NEXT:    cmp x9, x8
; CHECK-NEON-NEXT:    csel x0, x9, x8, lt
; CHECK-NEON-NEXT:    ret
  %2 = extractelement <2 x i64> %0, i64 0
  %3 = extractelement <2 x i64> %0, i64 1
...
; CHECK-NEON-NEXT:    fmov x9, d0
; CHECK-NEON-NEXT:    cmp x9, x8
; CHECK-NEON-NEXT:    csel x0, x9, x8, lo
; CHECK-NEON-NEXT:    ret
  %2 = extractelement <2 x i64> %0, i64 0
  %3 = extractelement <2 x i64> %0, i64 1
...
; CHECK-SVE-NEXT:    ret
;
; CHECK-NEON-LABEL: umin_different_vectors:
; CHECK-NEON:       // %bb.0:
