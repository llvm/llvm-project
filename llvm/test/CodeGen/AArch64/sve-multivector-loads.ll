...
; SVE2p1-SL:       // %bb.0:
; SVE2p1-SL-NEXT:    ldr z0, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    ldr z1, [x0]
; SVE2p1-SL-NEXT:    add z0.b, z0.b, #5 // =0x5
; SVE2p1-SL-NEXT:    add z1.b, z1.b, #5 // =0x5
; SVE2p1-SL-NEXT:    str z0, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    str z1, [x0]
; SVE2p1-SL-NEXT:    ret
;
; SME2-LABEL: load_2x_vectors_i8_r:
; SME2:       // %bb.0:
; SME2-NEXT:    ldr z0, [x0, #1, mul vl]
; SME2-NEXT:    ldr z1, [x0]
; SME2-NEXT:    add z0.b, z0.b, #5 // =0x5
; SME2-NEXT:    add z1.b, z1.b, #5 // =0x5
; SME2-NEXT:    str z0, [x0, #1, mul vl]
; SME2-NEXT:    str z1, [x0]
; SME2-NEXT:    ret
...
; SVE2p1-SL-NEXT:    ldr z1, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    ldr z2, [x0]
...
; SME2-NEXT:    ldr z1, [x0, #1, mul vl]
; SME2-NEXT:    ldr z2, [x0]
; SME2-NEXT:    bfadd z1.h, z1.h, z0.h
; SME2-NEXT:    bfadd z0.h, z2.h, z0.h
...
; SVE2p1-SL:       // %bb.0:
; SVE2p1-SL-NEXT:    ldr z0, [x0, #2, mul vl]
; SVE2p1-SL-NEXT:    ldr z1, [x0, #3, mul vl]
; SVE2p1-SL-NEXT:    ldr z2, [x0]
; SVE2p1-SL-NEXT:    ldr z3, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    add z0.b, z0.b, #5 // =0x5
; SVE2p1-SL-NEXT:    add z1.b, z1.b, #5 // =0x5
; SVE2p1-SL-NEXT:    add z2.b, z2.b, #5 // =0x5
; SVE2p1-SL-NEXT:    add z3.b, z3.b, #5 // =0x5
; SVE2p1-SL-NEXT:    str z0, [x0, #2, mul vl]
; SVE2p1-SL-NEXT:    str z1, [x0, #3, mul vl]
; SVE2p1-SL-NEXT:    str z2, [x0]
; SVE2p1-SL-NEXT:    str z3, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    ret
;
; SME2-LABEL: load_4x_vectors_i8_r:
; SME2:       // %bb.0:
; SME2-NEXT:    ldr z0, [x0, #2, mul vl]
; SME2-NEXT:    ldr z1, [x0, #3, mul vl]
; SME2-NEXT:    ldr z2, [x0]
; SME2-NEXT:    ldr z3, [x0, #1, mul vl]
; SME2-NEXT:    add z0.b, z0.b, #5 // =0x5
; SME2-NEXT:    add z1.b, z1.b, #5 // =0x5
; SME2-NEXT:    add z2.b, z2.b, #5 // =0x5
; SME2-NEXT:    add z3.b, z3.b, #5 // =0x5
; SME2-NEXT:    str z0, [x0, #2, mul vl]
; SME2-NEXT:    str z1, [x0, #3, mul vl]
; SME2-NEXT:    str z2, [x0]
; SME2-NEXT:    str z3, [x0, #1, mul vl]
; SME2-NEXT:    ret
...
; SVE2p1-SL:       // %bb.0:
; SVE2p1-SL-NEXT:    fmov z0.h, #1.87500000
; SVE2p1-SL-NEXT:    ldr z1, [x0, #2, mul vl]
; SVE2p1-SL-NEXT:    ldr z2, [x0, #3, mul vl]
; SVE2p1-SL-NEXT:    ldr z3, [x0]
; SVE2p1-SL-NEXT:    ldr z4, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    bfadd z1.h, z1.h, z0.h
; SVE2p1-SL-NEXT:    bfadd z2.h, z2.h, z0.h
; SVE2p1-SL-NEXT:    str z1, [x0, #2, mul vl]
; SVE2p1-SL-NEXT:    bfadd z1.h, z3.h, z0.h
; SVE2p1-SL-NEXT:    bfadd z0.h, z4.h, z0.h
; SVE2p1-SL-NEXT:    str z2, [x0, #3, mul vl]
; SVE2p1-SL-NEXT:    str z1, [x0]
; SVE2p1-SL-NEXT:    str z0, [x0, #1, mul vl]
; SVE2p1-SL-NEXT:    ret
;
...
; SME2:       // %bb.0:
; SME2-NEXT:    fmov z0.h, #1.87500000
; SME2-NEXT:    ldr z1, [x0, #2, mul vl]
; SME2-NEXT:    ldr z2, [x0, #3, mul vl]
; SME2-NEXT:    ldr z3, [x0]
; SME2-NEXT:    ldr z4, [x0, #1, mul vl]
; SME2-NEXT:    bfadd z1.h, z1.h, z0.h
; SME2-NEXT:    bfadd z2.h, z2.h, z0.h
; SME2-NEXT:    str z1, [x0, #2, mul vl]
; SME2-NEXT:    bfadd z1.h, z3.h, z0.h
; SME2-NEXT:    bfadd z0.h, z4.h, z0.h
; SME2-NEXT:    str z2, [x0, #3, mul vl]
; SME2-NEXT:    str z1, [x0]
; SME2-NEXT:    str z0, [x0, #1, mul vl]
; SME2-NEXT:    ret
