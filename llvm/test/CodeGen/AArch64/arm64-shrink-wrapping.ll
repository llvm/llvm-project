...
; ENABLE-NEXT:    lsl w11, w1, w0
; ENABLE-NEXT:    lsr w12, w0, w1
; ENABLE-NEXT:    lsl w17, w0, w1
; ENABLE-NEXT:    lsr w14, w1, w0
; ENABLE-NEXT:    add w15, w1, w0
; ENABLE-NEXT:    sub w8, w11, w12
; ENABLE-NEXT:    subs w16, w1, w0
; ENABLE-NEXT:    add w13, w17, w11
; ENABLE-NEXT:    add w9, w12, w14
; ENABLE-NEXT:    add w10, w14, w15
...
; ENABLE-NEXT:    str w17, [x2]
; ENABLE-NEXT:    str w11, [x3]
; ENABLE-NEXT:    str w12, [x4]
; ENABLE-NEXT:    str w14, [x5]
; ENABLE-NEXT:    str w15, [x6]
; ENABLE-NEXT:    str w16, [x7]
; ENABLE-NEXT:    stp w0, w1, [x2, #4]
; ENABLE-NEXT:    stp w13, w8, [x2, #12]
; ENABLE-NEXT:    stp w9, w10, [x2, #20]
...
; DISABLE-NEXT:    lsl w11, w1, w0
; DISABLE-NEXT:    lsr w12, w0, w1
; DISABLE-NEXT:    lsl w17, w0, w1
; DISABLE-NEXT:    lsr w14, w1, w0
; DISABLE-NEXT:    add w15, w1, w0
; DISABLE-NEXT:    sub w8, w11, w12
; DISABLE-NEXT:    subs w16, w1, w0
; DISABLE-NEXT:    add w13, w17, w11
; DISABLE-NEXT:    add w9, w12, w14
; DISABLE-NEXT:    add w10, w14, w15
...
; DISABLE-NEXT:    str w17, [x2]
; DISABLE-NEXT:    str w11, [x3]
; DISABLE-NEXT:    str w12, [x4]
; DISABLE-NEXT:    str w14, [x5]
; DISABLE-NEXT:    str w15, [x6]
; DISABLE-NEXT:    str w16, [x7]
; DISABLE-NEXT:    stp w0, w1, [x2, #4]
; DISABLE-NEXT:    stp w13, w8, [x2, #12]
; DISABLE-NEXT:    stp w9, w10, [x2, #20]
