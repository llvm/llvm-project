...
; CHECK-NEXT:    add w8, w0, w8, lsr #29
; CHECK-NEXT:    asr w0, w8, #3
; CHECK-NEXT:    ret
;
; CHECK-FAST-ISEL-LABEL: sdiv_i32_pos:
; CHECK-FAST-ISEL:       // %bb.0:
; CHECK-FAST-ISEL-NEXT:    asr w8, w0, #31
; CHECK-FAST-ISEL-NEXT:    add w8, w0, w8, lsr #29
...
; CHECK-FAST-ISEL:       // %bb.0:
; CHECK-FAST-ISEL-NEXT:    asr x8, x0, #63
; CHECK-FAST-ISEL-NEXT:    add x8, x0, x8, lsr #60
