...
; CHECK-NEXT:    mov z4.s, z3.s[4]
; CHECK-NEXT:    fmov w9, s3
; CHECK-NEXT:    mov z3.s, z2.s[4]
; CHECK-NEXT:    fmov w10, s3
; CHECK-NEXT:    mov z3.s, z1.s[4]
...
; CHECK-NEXT:    mov z3.s, z0.s[4]
; CHECK-NEXT:    fmov w8, s0
; CHECK-NEXT:    fmov w10, s1
; CHECK-NEXT:    fmov w12, s2
; CHECK-NEXT:    fmov w9, s3
; CHECK-NEXT:    mov z3.s, z1.s[4]
; CHECK-NEXT:    mov z1.s, z2.s[4]
...
attributes #0 = { vscale_range(2,2) "target-cpu"="neoverse-v3" }
