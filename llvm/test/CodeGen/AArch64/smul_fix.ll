...
; CHECK-GI-NEXT:    ret
  %tmp = call <8 x i8> @llvm.smul.fix.v8i8(<8 x i8> %x, <8 x i8> %y, i32 2)
  ret <8 x i8> %tmp
}
...
; CHECK-GI-NEXT:    ret
  %tmp = call <16 x i8> @llvm.smul.fix.v16i8(<16 x i8> %x, <16 x i8> %y, i32 2)
  ret <16 x i8> %tmp
}
...
; CHECK-GI-NEXT:    ret
  %tmp = call <4 x i16> @llvm.smul.fix.v4i16(<4 x i16> %x, <4 x i16> %y, i32 10)
  ret <4 x i16> %tmp
}
...
; CHECK-GI-NEXT:    ret
  %tmp = call <8 x i16> @llvm.smul.fix.v8i16(<8 x i16> %x, <8 x i16> %y, i32 2)
  ret <8 x i16> %tmp
}
...
; CHECK-GI-NEXT:    ret
  %tmp = call <4 x i32> @llvm.smul.fix.v4i32(<4 x i32> %x, <4 x i32> %y, i32 15)
  ret <4 x i32> %tmp
}
...
; CHECK-GI-NEXT:    ret
  %tmp = call <8 x i32> @llvm.smul.fix.v8i32(<8 x i32> %x, <8 x i32> %y, i32 0)
  ret <8 x i32> %tmp
}
...
; CHECK-GI-NEXT:    extr x8, x8, x12, #15
; CHECK-GI-NEXT:    madd x9, x10, x13, x9
; CHECK-GI-NEXT:    fmov d0, x8
; CHECK-GI-NEXT:    extr x9, x9, x11, #15
; CHECK-GI-NEXT:    mov v0.d[1], x9
; CHECK-GI-NEXT:    ret
  %tmp = call <2 x i64> @llvm.smul.fix.v2i64(<2 x i64> %x, <2 x i64> %y, i32 15)
  ret <2 x i64> %tmp
}
