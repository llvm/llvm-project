...
; RUN: not llc -mtriple=aarch64 -asm-verbose=0              < %t/not-enough-regs.ll 2>&1 | FileCheck --check-prefixes=NOT-ENOUGH-REGS %s
; RUN: not llc -mtriple=aarch64 -asm-verbose=0 -mattr=v8.3a < %t/not-enough-regs.ll 2>&1 | FileCheck --check-prefixes=NOT-ENOUGH-REGS %s
