...
; CHECK-NOFP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d2, v1.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d3, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v0.2s, v0.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v2.2s, v2.2s, #24
...
; CHECK-NOFP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-NOFP16-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-NOFP16-SD-NEXT:    sshll v4.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v5.2d, v3.2s, #0
; CHECK-NOFP16-SD-NEXT:    scvtf v2.2d, v1.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v3.2d, v4.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v1.2d, v5.2d
; CHECK-NOFP16-SD-NEXT:    ret
;
...
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    mov d2, v1.d[1]
; CHECK-FP16-SD-NEXT:    mov d3, v0.d[1]
; CHECK-FP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-FP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v0.2s, v0.2s, #24
; CHECK-FP16-SD-NEXT:    shl v2.2s, v2.2s, #24
...
; CHECK-FP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-FP16-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-FP16-SD-NEXT:    sshll v4.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v5.2d, v3.2s, #0
; CHECK-FP16-SD-NEXT:    scvtf v2.2d, v1.2d
; CHECK-FP16-SD-NEXT:    scvtf v3.2d, v4.2d
; CHECK-FP16-SD-NEXT:    scvtf v1.2d, v5.2d
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d3, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d4, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    and v0.8b, v0.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v2.8b, v2.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    ushll v0.2d, v0.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v3.8b, v3.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v1.8b, v4.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    ushll v2.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.2d, v0.2d
...
; CHECK-FP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    movi d1, #0x0000ff000000ff
; CHECK-FP16-SD-NEXT:    ushll2 v2.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    mov d3, v2.d[1]
; CHECK-FP16-SD-NEXT:    mov d4, v0.d[1]
; CHECK-FP16-SD-NEXT:    and v0.8b, v0.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v2.8b, v2.8b, v1.8b
; CHECK-FP16-SD-NEXT:    ushll v0.2d, v0.2s, #0
; CHECK-FP16-SD-NEXT:    and v3.8b, v3.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v1.8b, v4.8b, v1.8b
; CHECK-FP16-SD-NEXT:    ushll v2.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    ucvtf v0.2d, v0.2d
...
; CHECK-NOFP16-SD:       // %bb.0: // %entry
; CHECK-NOFP16-SD-NEXT:    ushll v1.8h, v0.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v0.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v2.4s, v1.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v3.4s, v0.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d4, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d5, v1.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d6, v3.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d7, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v2.2s, v2.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v3.2s, v3.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v4.2s, v4.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v5.2s, v5.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v6.2s, v6.2s, #24
...
; CHECK-NOFP16-SD-NEXT:    sshll v2.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v16.2d, v0.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v18.2d, v3.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v17.2d, v4.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v19.2d, v6.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v20.2d, v7.2s, #0
; CHECK-NOFP16-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v0.2d, v1.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v4.2d, v16.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v6.2d, v18.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v3.2d, v17.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v1.2d, v5.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v7.2d, v19.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v5.2d, v20.2d
; CHECK-NOFP16-SD-NEXT:    ret
;
; CHECK-FP16-SD-LABEL: stofp_v16i8_v16f64:
; CHECK-FP16-SD:       // %bb.0: // %entry
; CHECK-FP16-SD-NEXT:    ushll v1.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v0.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v2.4s, v1.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v3.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    mov d4, v2.d[1]
; CHECK-FP16-SD-NEXT:    mov d5, v1.d[1]
; CHECK-FP16-SD-NEXT:    mov d6, v3.d[1]
; CHECK-FP16-SD-NEXT:    mov d7, v0.d[1]
; CHECK-FP16-SD-NEXT:    shl v2.2s, v2.2s, #24
; CHECK-FP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-FP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-FP16-SD-NEXT:    shl v3.2s, v3.2s, #24
; CHECK-FP16-SD-NEXT:    shl v4.2s, v4.2s, #24
; CHECK-FP16-SD-NEXT:    shl v5.2s, v5.2s, #24
; CHECK-FP16-SD-NEXT:    shl v6.2s, v6.2s, #24
...
; CHECK-FP16-SD-NEXT:    sshll v2.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v16.2d, v0.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v18.2d, v3.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v17.2d, v4.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v19.2d, v6.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v20.2d, v7.2s, #0
; CHECK-FP16-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-FP16-SD-NEXT:    scvtf v0.2d, v1.2d
; CHECK-FP16-SD-NEXT:    scvtf v4.2d, v16.2d
; CHECK-FP16-SD-NEXT:    scvtf v6.2d, v18.2d
; CHECK-FP16-SD-NEXT:    scvtf v3.2d, v17.2d
; CHECK-FP16-SD-NEXT:    scvtf v1.2d, v5.2d
; CHECK-FP16-SD-NEXT:    scvtf v7.2d, v19.2d
; CHECK-FP16-SD-NEXT:    scvtf v5.2d, v20.2d
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD-NEXT:    ushll2 v0.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    movi d1, #0x0000ff000000ff
; CHECK-NOFP16-SD-NEXT:    ushll2 v3.4s, v2.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v4.4s, v0.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d5, v3.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d6, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d7, v4.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d16, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    and v3.8b, v3.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v2.8b, v2.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v0.8b, v0.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v4.8b, v4.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v5.8b, v5.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v6.8b, v6.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v7.8b, v7.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    and v1.8b, v16.8b, v1.8b
; CHECK-NOFP16-SD-NEXT:    ushll v3.2d, v3.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v16.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v17.2d, v0.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v18.2d, v4.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v6.2d, v6.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v19.2d, v1.2s, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v2.2d, v3.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.2d, v16.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v4.2d, v17.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v3.2d, v5.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v1.2d, v6.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v6.2d, v18.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v7.2d, v7.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v5.2d, v19.2d
; CHECK-NOFP16-SD-NEXT:    ret
;
...
; CHECK-FP16-SD-NEXT:    ushll2 v0.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    movi d1, #0x0000ff000000ff
; CHECK-FP16-SD-NEXT:    ushll2 v3.4s, v2.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v4.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    mov d5, v3.d[1]
; CHECK-FP16-SD-NEXT:    mov d6, v2.d[1]
; CHECK-FP16-SD-NEXT:    mov d7, v4.d[1]
; CHECK-FP16-SD-NEXT:    mov d16, v0.d[1]
; CHECK-FP16-SD-NEXT:    and v3.8b, v3.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v2.8b, v2.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v0.8b, v0.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v4.8b, v4.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v5.8b, v5.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v6.8b, v6.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v7.8b, v7.8b, v1.8b
; CHECK-FP16-SD-NEXT:    and v1.8b, v16.8b, v1.8b
; CHECK-FP16-SD-NEXT:    ushll v3.2d, v3.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v16.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v17.2d, v0.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v18.2d, v4.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v6.2d, v6.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v19.2d, v1.2s, #0
; CHECK-FP16-SD-NEXT:    ucvtf v2.2d, v3.2d
; CHECK-FP16-SD-NEXT:    ucvtf v0.2d, v16.2d
; CHECK-FP16-SD-NEXT:    ucvtf v4.2d, v17.2d
; CHECK-FP16-SD-NEXT:    ucvtf v3.2d, v5.2d
; CHECK-FP16-SD-NEXT:    ucvtf v1.2d, v6.2d
; CHECK-FP16-SD-NEXT:    ucvtf v6.2d, v18.2d
; CHECK-FP16-SD-NEXT:    ucvtf v7.2d, v7.2d
; CHECK-FP16-SD-NEXT:    ucvtf v5.2d, v19.2d
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD:       // %bb.0: // %entry
; CHECK-NOFP16-SD-NEXT:    ushll2 v2.8h, v1.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v3.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v4.4s, v2.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v5.4s, v3.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v17.4s, v1.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v7.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v0.4s, v0.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v3.4s, v3.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d6, v4.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d16, v5.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d18, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v4.2s, v4.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v5.2s, v5.2s, #24
; CHECK-NOFP16-SD-NEXT:    mov d23, v1.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v2.2s, v2.2s, #24
; CHECK-NOFP16-SD-NEXT:    mov d21, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d22, v3.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v19.2s, v7.2s, #24
; CHECK-NOFP16-SD-NEXT:    mov d7, v7.d[1]
; CHECK-NOFP16-SD-NEXT:    shl v6.2s, v6.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v16.2s, v16.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v4.2s, v4.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v5.2s, v5.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v18.2s, v18.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v2.2s, v2.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v23.2s, v23.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v20.2s, v17.2s, #24
; CHECK-NOFP16-SD-NEXT:    mov d17, v17.d[1]
; CHECK-NOFP16-SD-NEXT:    sshr v6.2s, v6.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v16.2s, v16.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshll v4.2d, v4.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshr v18.2s, v18.2s, #24
...
; CHECK-NOFP16-SD-NEXT:    sshll v18.2d, v18.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshr v23.2s, v23.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v1.2s, v1.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-NOFP16-SD-NEXT:    scvtf v2.2d, v2.2d
...
; CHECK-NOFP16-SD-NEXT:    sshr v3.2s, v3.2s, #24
; CHECK-NOFP16-SD-NEXT:    scvtf v18.2d, v18.2d
; CHECK-NOFP16-SD-NEXT:    shl v7.2s, v7.2s, #24
; CHECK-NOFP16-SD-NEXT:    shl v17.2s, v17.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshr v0.2s, v0.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshll v3.2d, v3.2s, #0
; CHECK-NOFP16-SD-NEXT:    stp q5, q16, [x8, #96]
; CHECK-NOFP16-SD-NEXT:    sshr v5.2s, v21.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v16.2s, v20.2s, #24
; CHECK-NOFP16-SD-NEXT:    stp q2, q18, [x8, #192]
; CHECK-NOFP16-SD-NEXT:    scvtf v1.2d, v1.2d
; CHECK-NOFP16-SD-NEXT:    sshll v0.2d, v0.2s, #0
; CHECK-NOFP16-SD-NEXT:    stp q4, q6, [x8, #224]
; CHECK-NOFP16-SD-NEXT:    sshr v4.2s, v22.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshll v6.2d, v23.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshr v2.2s, v17.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v7.2s, v7.2s, #24
; CHECK-NOFP16-SD-NEXT:    sshr v17.2s, v19.2s, #24
; CHECK-NOFP16-SD-NEXT:    scvtf v3.2d, v3.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-NOFP16-SD-NEXT:    sshll v4.2d, v4.2s, #0
; CHECK-NOFP16-SD-NEXT:    scvtf v6.2d, v6.2d
...
; CHECK-NOFP16-SD-NEXT:    sshll v2.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    scvtf v4.2d, v4.2d
; CHECK-NOFP16-SD-NEXT:    stp q1, q6, [x8, #160]
; CHECK-NOFP16-SD-NEXT:    sshll v1.2d, v7.2s, #0
; CHECK-NOFP16-SD-NEXT:    sshll v6.2d, v17.2s, #0
; CHECK-NOFP16-SD-NEXT:    stp q0, q5, [x8, #32]
; CHECK-NOFP16-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-NOFP16-SD-NEXT:    stp q3, q4, [x8, #64]
; CHECK-NOFP16-SD-NEXT:    scvtf v3.2d, v16.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v1.2d, v1.2d
; CHECK-NOFP16-SD-NEXT:    scvtf v0.2d, v6.2d
; CHECK-NOFP16-SD-NEXT:    stp q3, q2, [x8, #128]
; CHECK-NOFP16-SD-NEXT:    stp q0, q1, [x8]
; CHECK-NOFP16-SD-NEXT:    ret
;
; CHECK-FP16-SD-LABEL: stofp_v32i8_v32f64:
; CHECK-FP16-SD:       // %bb.0: // %entry
; CHECK-FP16-SD-NEXT:    ushll2 v2.8h, v1.16b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v3.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-FP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v4.4s, v2.8h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v5.4s, v3.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v17.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v7.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v0.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v3.4s, v3.4h, #0
; CHECK-FP16-SD-NEXT:    mov d6, v4.d[1]
; CHECK-FP16-SD-NEXT:    mov d16, v5.d[1]
; CHECK-FP16-SD-NEXT:    mov d18, v2.d[1]
; CHECK-FP16-SD-NEXT:    shl v4.2s, v4.2s, #24
; CHECK-FP16-SD-NEXT:    shl v5.2s, v5.2s, #24
; CHECK-FP16-SD-NEXT:    mov d23, v1.d[1]
; CHECK-FP16-SD-NEXT:    shl v2.2s, v2.2s, #24
; CHECK-FP16-SD-NEXT:    mov d21, v0.d[1]
; CHECK-FP16-SD-NEXT:    mov d22, v3.d[1]
; CHECK-FP16-SD-NEXT:    shl v1.2s, v1.2s, #24
; CHECK-FP16-SD-NEXT:    shl v19.2s, v7.2s, #24
; CHECK-FP16-SD-NEXT:    mov d7, v7.d[1]
; CHECK-FP16-SD-NEXT:    shl v6.2s, v6.2s, #24
; CHECK-FP16-SD-NEXT:    shl v16.2s, v16.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v4.2s, v4.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v5.2s, v5.2s, #24
; CHECK-FP16-SD-NEXT:    shl v18.2s, v18.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v2.2s, v2.2s, #24
; CHECK-FP16-SD-NEXT:    shl v23.2s, v23.2s, #24
; CHECK-FP16-SD-NEXT:    shl v20.2s, v17.2s, #24
; CHECK-FP16-SD-NEXT:    mov d17, v17.d[1]
; CHECK-FP16-SD-NEXT:    sshr v6.2s, v6.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v16.2s, v16.2s, #24
; CHECK-FP16-SD-NEXT:    sshll v4.2d, v4.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    sshr v18.2s, v18.2s, #24
...
; CHECK-FP16-SD-NEXT:    sshll v18.2d, v18.2s, #0
; CHECK-FP16-SD-NEXT:    sshr v23.2s, v23.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v1.2s, v1.2s, #24
; CHECK-FP16-SD-NEXT:    shl v0.2s, v0.2s, #24
; CHECK-FP16-SD-NEXT:    scvtf v2.2d, v2.2d
...
; CHECK-FP16-SD-NEXT:    sshr v3.2s, v3.2s, #24
; CHECK-FP16-SD-NEXT:    scvtf v18.2d, v18.2d
; CHECK-FP16-SD-NEXT:    shl v7.2s, v7.2s, #24
; CHECK-FP16-SD-NEXT:    shl v17.2s, v17.2s, #24
; CHECK-FP16-SD-NEXT:    sshll v1.2d, v1.2s, #0
; CHECK-FP16-SD-NEXT:    sshr v0.2s, v0.2s, #24
; CHECK-FP16-SD-NEXT:    sshll v3.2d, v3.2s, #0
; CHECK-FP16-SD-NEXT:    stp q5, q16, [x8, #96]
; CHECK-FP16-SD-NEXT:    sshr v5.2s, v21.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v16.2s, v20.2s, #24
; CHECK-FP16-SD-NEXT:    stp q2, q18, [x8, #192]
; CHECK-FP16-SD-NEXT:    scvtf v1.2d, v1.2d
; CHECK-FP16-SD-NEXT:    sshll v0.2d, v0.2s, #0
; CHECK-FP16-SD-NEXT:    stp q4, q6, [x8, #224]
; CHECK-FP16-SD-NEXT:    sshr v4.2s, v22.2s, #24
; CHECK-FP16-SD-NEXT:    sshll v6.2d, v23.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    sshr v2.2s, v17.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v7.2s, v7.2s, #24
; CHECK-FP16-SD-NEXT:    sshr v17.2s, v19.2s, #24
; CHECK-FP16-SD-NEXT:    scvtf v3.2d, v3.2d
; CHECK-FP16-SD-NEXT:    scvtf v0.2d, v0.2d
; CHECK-FP16-SD-NEXT:    sshll v4.2d, v4.2s, #0
; CHECK-FP16-SD-NEXT:    scvtf v6.2d, v6.2d
...
; CHECK-FP16-SD-NEXT:    sshll v2.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    scvtf v4.2d, v4.2d
; CHECK-FP16-SD-NEXT:    stp q1, q6, [x8, #160]
; CHECK-FP16-SD-NEXT:    sshll v1.2d, v7.2s, #0
; CHECK-FP16-SD-NEXT:    sshll v6.2d, v17.2s, #0
; CHECK-FP16-SD-NEXT:    stp q0, q5, [x8, #32]
; CHECK-FP16-SD-NEXT:    scvtf v2.2d, v2.2d
; CHECK-FP16-SD-NEXT:    stp q3, q4, [x8, #64]
; CHECK-FP16-SD-NEXT:    scvtf v3.2d, v16.2d
; CHECK-FP16-SD-NEXT:    scvtf v1.2d, v1.2d
; CHECK-FP16-SD-NEXT:    scvtf v0.2d, v6.2d
; CHECK-FP16-SD-NEXT:    stp q3, q2, [x8, #128]
; CHECK-FP16-SD-NEXT:    stp q0, q1, [x8]
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD-NEXT:    ushll2 v2.8h, v1.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v3.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    movi d6, #0x0000ff000000ff
; CHECK-NOFP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v4.4s, v2.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v5.4s, v3.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v19.4s, v1.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v18.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v0.4s, v0.8h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v3.4s, v3.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-NOFP16-SD-NEXT:    mov d7, v4.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d16, v5.d[1]
; CHECK-NOFP16-SD-NEXT:    and v4.8b, v4.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    mov d17, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    and v5.8b, v5.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    and v2.8b, v2.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    mov d20, v19.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d21, v3.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d23, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    ushll v4.2d, v4.2s, #0
; CHECK-NOFP16-SD-NEXT:    mov d22, v18.d[1]
; CHECK-NOFP16-SD-NEXT:    and v3.8b, v3.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    and v7.8b, v7.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    and v16.8b, v16.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v17.8b, v17.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ushll v2.2d, v2.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v0.8b, v0.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ucvtf v4.2d, v4.2d
; CHECK-NOFP16-SD-NEXT:    and v20.8b, v20.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ushll v3.2d, v3.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
...
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.2d, v0.2d
; CHECK-NOFP16-SD-NEXT:    stp q5, q16, [x8, #96]
; CHECK-NOFP16-SD-NEXT:    ushll v16.2d, v20.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v5.8b, v23.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    stp q2, q17, [x8, #192]
; CHECK-NOFP16-SD-NEXT:    stp q4, q7, [x8, #224]
; CHECK-NOFP16-SD-NEXT:    and v7.8b, v19.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    mov d4, v1.d[1]
; CHECK-NOFP16-SD-NEXT:    and v19.8b, v21.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v1.8b, v1.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
; CHECK-NOFP16-SD-NEXT:    ushll v17.2d, v19.2s, #0
; CHECK-NOFP16-SD-NEXT:    and v2.8b, v4.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ucvtf v4.2d, v16.2d
; CHECK-NOFP16-SD-NEXT:    and v16.8b, v22.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    and v6.8b, v18.8b, v6.8b
; CHECK-NOFP16-SD-NEXT:    ucvtf v5.2d, v5.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v7.2d, v7.2d
; CHECK-NOFP16-SD-NEXT:    ushll v1.2d, v1.2s, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v17.2d, v17.2d
...
; CHECK-NOFP16-SD-NEXT:    stp q0, q5, [x8, #32]
; CHECK-NOFP16-SD-NEXT:    ucvtf v1.2d, v1.2d
; CHECK-NOFP16-SD-NEXT:    stp q7, q4, [x8, #160]
; CHECK-NOFP16-SD-NEXT:    ushll v4.2d, v16.2s, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v2.2d, v2.2d
; CHECK-NOFP16-SD-NEXT:    stp q3, q17, [x8, #64]
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.2d, v6.2d
; CHECK-NOFP16-SD-NEXT:    ucvtf v3.2d, v4.2d
; CHECK-NOFP16-SD-NEXT:    stp q1, q2, [x8, #128]
; CHECK-NOFP16-SD-NEXT:    stp q0, q3, [x8]
; CHECK-NOFP16-SD-NEXT:    ret
;
...
; CHECK-FP16-SD-NEXT:    ushll2 v2.8h, v1.16b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v3.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    movi d6, #0x0000ff000000ff
; CHECK-FP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-FP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v4.4s, v2.8h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v5.4s, v3.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v2.4s, v2.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v19.4s, v1.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v18.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    ushll2 v0.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    ushll v3.4s, v3.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    mov d7, v4.d[1]
; CHECK-FP16-SD-NEXT:    mov d16, v5.d[1]
; CHECK-FP16-SD-NEXT:    and v4.8b, v4.8b, v6.8b
; CHECK-FP16-SD-NEXT:    mov d17, v2.d[1]
; CHECK-FP16-SD-NEXT:    and v5.8b, v5.8b, v6.8b
; CHECK-FP16-SD-NEXT:    and v2.8b, v2.8b, v6.8b
; CHECK-FP16-SD-NEXT:    mov d20, v19.d[1]
; CHECK-FP16-SD-NEXT:    mov d21, v3.d[1]
; CHECK-FP16-SD-NEXT:    mov d23, v0.d[1]
; CHECK-FP16-SD-NEXT:    ushll v4.2d, v4.2s, #0
; CHECK-FP16-SD-NEXT:    mov d22, v18.d[1]
; CHECK-FP16-SD-NEXT:    and v3.8b, v3.8b, v6.8b
; CHECK-FP16-SD-NEXT:    and v7.8b, v7.8b, v6.8b
; CHECK-FP16-SD-NEXT:    and v16.8b, v16.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    and v17.8b, v17.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ushll v2.2d, v2.2s, #0
; CHECK-FP16-SD-NEXT:    and v0.8b, v0.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ucvtf v4.2d, v4.2d
; CHECK-FP16-SD-NEXT:    and v20.8b, v20.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ushll v3.2d, v3.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
...
; CHECK-FP16-SD-NEXT:    ucvtf v0.2d, v0.2d
; CHECK-FP16-SD-NEXT:    stp q5, q16, [x8, #96]
; CHECK-FP16-SD-NEXT:    ushll v16.2d, v20.2s, #0
; CHECK-FP16-SD-NEXT:    and v5.8b, v23.8b, v6.8b
; CHECK-FP16-SD-NEXT:    stp q2, q17, [x8, #192]
; CHECK-FP16-SD-NEXT:    stp q4, q7, [x8, #224]
; CHECK-FP16-SD-NEXT:    and v7.8b, v19.8b, v6.8b
; CHECK-FP16-SD-NEXT:    mov d4, v1.d[1]
; CHECK-FP16-SD-NEXT:    and v19.8b, v21.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ushll v5.2d, v5.2s, #0
; CHECK-FP16-SD-NEXT:    and v1.8b, v1.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ushll v7.2d, v7.2s, #0
; CHECK-FP16-SD-NEXT:    ushll v17.2d, v19.2s, #0
; CHECK-FP16-SD-NEXT:    and v2.8b, v4.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ucvtf v4.2d, v16.2d
; CHECK-FP16-SD-NEXT:    and v16.8b, v22.8b, v6.8b
; CHECK-FP16-SD-NEXT:    and v6.8b, v18.8b, v6.8b
; CHECK-FP16-SD-NEXT:    ucvtf v5.2d, v5.2d
; CHECK-FP16-SD-NEXT:    ucvtf v7.2d, v7.2d
; CHECK-FP16-SD-NEXT:    ushll v1.2d, v1.2s, #0
; CHECK-FP16-SD-NEXT:    ucvtf v17.2d, v17.2d
...
; CHECK-FP16-SD-NEXT:    stp q0, q5, [x8, #32]
; CHECK-FP16-SD-NEXT:    ucvtf v1.2d, v1.2d
; CHECK-FP16-SD-NEXT:    stp q7, q4, [x8, #160]
; CHECK-FP16-SD-NEXT:    ushll v4.2d, v16.2s, #0
; CHECK-FP16-SD-NEXT:    ucvtf v2.2d, v2.2d
; CHECK-FP16-SD-NEXT:    stp q3, q17, [x8, #64]
; CHECK-FP16-SD-NEXT:    ucvtf v0.2d, v6.2d
; CHECK-FP16-SD-NEXT:    ucvtf v3.2d, v4.2d
; CHECK-FP16-SD-NEXT:    stp q1, q2, [x8, #128]
; CHECK-FP16-SD-NEXT:    stp q0, q3, [x8]
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD:       // %bb.0: // %entry
; CHECK-NOFP16-SD-NEXT:    sshll v1.8h, v0.8b, #0
...
; CHECK-FP16-SD:       // %bb.0: // %entry
; CHECK-FP16-SD-NEXT:    sshll v1.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    sshll2 v0.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    sshll v2.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    sshll2 v3.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    sshll2 v1.4s, v1.8h, #0
; CHECK-FP16-SD-NEXT:    sshll v4.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    scvtf v0.4s, v2.4s
; CHECK-FP16-SD-NEXT:    scvtf v3.4s, v3.4s
; CHECK-FP16-SD-NEXT:    scvtf v1.4s, v1.4s
; CHECK-FP16-SD-NEXT:    scvtf v2.4s, v4.4s
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD-NEXT:    ushll v5.4s, v3.4h, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.4s, v0.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v2.4s, v1.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v3.4s, v4.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v1.4s, v5.4s
; CHECK-NOFP16-SD-NEXT:    ret
;
...
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v4.4s, v2.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v5.4s, v3.4h, #0
; CHECK-FP16-SD-NEXT:    ucvtf v0.4s, v0.4s
; CHECK-FP16-SD-NEXT:    ucvtf v2.4s, v1.4s
; CHECK-FP16-SD-NEXT:    ucvtf v3.4s, v4.4s
; CHECK-FP16-SD-NEXT:    ucvtf v1.4s, v5.4s
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD-NEXT:    sshll2 v0.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    sshll v3.8h, v1.8b, #0
; CHECK-NOFP16-SD-NEXT:    sshll2 v1.8h, v1.16b, #0
; CHECK-NOFP16-SD-NEXT:    sshll2 v4.4s, v2.8h, #0
; CHECK-NOFP16-SD-NEXT:    sshll v2.4s, v2.4h, #0
; CHECK-NOFP16-SD-NEXT:    sshll2 v5.4s, v0.8h, #0
; CHECK-NOFP16-SD-NEXT:    sshll v6.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    sshll v7.4s, v3.4h, #0
; CHECK-NOFP16-SD-NEXT:    sshll2 v16.4s, v1.8h, #0
; CHECK-NOFP16-SD-NEXT:    sshll2 v17.4s, v3.8h, #0
...
; CHECK-NOFP16-SD-NEXT:    scvtf v4.4s, v7.4s
; CHECK-NOFP16-SD-NEXT:    scvtf v7.4s, v16.4s
; CHECK-NOFP16-SD-NEXT:    scvtf v5.4s, v17.4s
; CHECK-NOFP16-SD-NEXT:    scvtf v6.4s, v18.4s
; CHECK-NOFP16-SD-NEXT:    ret
;
...
; CHECK-FP16-SD-NEXT:    sshll2 v0.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    sshll v3.8h, v1.8b, #0
; CHECK-FP16-SD-NEXT:    sshll2 v1.8h, v1.16b, #0
; CHECK-FP16-SD-NEXT:    sshll2 v4.4s, v2.8h, #0
; CHECK-FP16-SD-NEXT:    sshll v2.4s, v2.4h, #0
; CHECK-FP16-SD-NEXT:    sshll2 v5.4s, v0.8h, #0
; CHECK-FP16-SD-NEXT:    sshll v6.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    sshll v7.4s, v3.4h, #0
; CHECK-FP16-SD-NEXT:    sshll2 v16.4s, v1.8h, #0
; CHECK-FP16-SD-NEXT:    sshll2 v17.4s, v3.8h, #0
...
; CHECK-FP16-SD-NEXT:    scvtf v4.4s, v7.4s
; CHECK-FP16-SD-NEXT:    scvtf v7.4s, v16.4s
; CHECK-FP16-SD-NEXT:    scvtf v5.4s, v17.4s
; CHECK-FP16-SD-NEXT:    scvtf v6.4s, v18.4s
; CHECK-FP16-SD-NEXT:    ret
;
...
; CHECK-NOFP16-SD:       // %bb.0: // %entry
; CHECK-NOFP16-SD-NEXT:    ushll2 v2.8h, v0.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-NOFP16-SD-NEXT:    ushll2 v3.8h, v1.16b, #0
; CHECK-NOFP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-NOFP16-SD-NEXT:    mov d4, v2.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d5, v0.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d6, v3.d[1]
; CHECK-NOFP16-SD-NEXT:    mov d7, v1.d[1]
; CHECK-NOFP16-SD-NEXT:    // kill: def $d2 killed $d2 killed $q2
; CHECK-NOFP16-SD-NEXT:    // kill: def $d3 killed $d3 killed $q3
; CHECK-NOFP16-SD-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-NOFP16-SD-NEXT:    // kill: def $d1 killed $d1 killed $q1
; CHECK-NOFP16-SD-NEXT:    bic v2.4h, #255, lsl #8
; CHECK-NOFP16-SD-NEXT:    bic v0.4h, #255, lsl #8
...
; CHECK-NOFP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v17.4s, v3.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v16.4s, v4.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v5.4s, v5.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v18.4s, v6.4h, #0
; CHECK-NOFP16-SD-NEXT:    ushll v19.4s, v7.4h, #0
; CHECK-NOFP16-SD-NEXT:    ucvtf v2.4s, v2.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v0.4s, v0.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v4.4s, v1.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v6.4s, v17.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v3.4s, v16.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v1.4s, v5.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v7.4s, v18.4s
; CHECK-NOFP16-SD-NEXT:    ucvtf v5.4s, v19.4s
; CHECK-NOFP16-SD-NEXT:    ret
;
; CHECK-FP16-SD-LABEL: utofp_v32i8_v32f32:
; CHECK-FP16-SD:       // %bb.0: // %entry
; CHECK-FP16-SD-NEXT:    ushll2 v2.8h, v0.16b, #0
; CHECK-FP16-SD-NEXT:    ushll v0.8h, v0.8b, #0
; CHECK-FP16-SD-NEXT:    ushll2 v3.8h, v1.16b, #0
; CHECK-FP16-SD-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-FP16-SD-NEXT:    mov d4, v2.d[1]
; CHECK-FP16-SD-NEXT:    mov d5, v0.d[1]
; CHECK-FP16-SD-NEXT:    mov d6, v3.d[1]
; CHECK-FP16-SD-NEXT:    mov d7, v1.d[1]
; CHECK-FP16-SD-NEXT:    // kill: def $d2 killed $d2 killed $q2
; CHECK-FP16-SD-NEXT:    // kill: def $d3 killed $d3 killed $q3
; CHECK-FP16-SD-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-FP16-SD-NEXT:    // kill: def $d1 killed $d1 killed $q1
; CHECK-FP16-SD-NEXT:    bic v2.4h, #255, lsl #8
; CHECK-FP16-SD-NEXT:    bic v0.4h, #255, lsl #8
...
; CHECK-FP16-SD-NEXT:    ushll v0.4s, v0.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v1.4s, v1.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v17.4s, v3.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v16.4s, v4.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v5.4s, v5.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v18.4s, v6.4h, #0
; CHECK-FP16-SD-NEXT:    ushll v19.4s, v7.4h, #0
; CHECK-FP16-SD-NEXT:    ucvtf v2.4s, v2.4s
; CHECK-FP16-SD-NEXT:    ucvtf v0.4s, v0.4s
; CHECK-FP16-SD-NEXT:    ucvtf v4.4s, v1.4s
; CHECK-FP16-SD-NEXT:    ucvtf v6.4s, v17.4s
; CHECK-FP16-SD-NEXT:    ucvtf v3.4s, v16.4s
; CHECK-FP16-SD-NEXT:    ucvtf v1.4s, v5.4s
; CHECK-FP16-SD-NEXT:    ucvtf v7.4s, v18.4s
; CHECK-FP16-SD-NEXT:    ucvtf v5.4s, v19.4s
; CHECK-FP16-SD-NEXT:    ret
;
