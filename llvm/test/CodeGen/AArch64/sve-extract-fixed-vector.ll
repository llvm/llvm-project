...
define <4 x i1> @extract_v4i1_nxv32i1(<vscale x 32 x i1> %inmask) {
; CHECK-LABEL: extract_v4i1_nxv32i1:
; CHECK:       // %bb.0:
; CHECK-NEXT:    punpklo p0.h, p0.b
; CHECK-NEXT:    mov z0.h, p0/z, #1 // =0x1
; CHECK-NEXT:    // kill: def $d0 killed $d0 killed $z0
; CHECK-NEXT:    ret
  %mask = call <4 x i1> @llvm.vector.extract.v4i1.nxv32i1(<vscale x 32 x i1> %inmask, i64 0)
  ret <4 x i1> %mask
}
