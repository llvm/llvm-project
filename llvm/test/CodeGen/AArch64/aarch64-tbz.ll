...
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    tst x0, #0x4
; CHECK-SD-NEXT:    and x8, x1, #0x8
; CHECK-SD-NEXT:    ccmp x8, #0, #4, ne
; CHECK-SD-NEXT:    b.ne .LBB0_2
; CHECK-SD-NEXT:  // %bb.1: // %if.end3
; CHECK-SD-NEXT:    ret
; CHECK-SD-NEXT:  .LBB0_2: // %if.then2
; CHECK-SD-NEXT:    b foo
;
; CHECK-GI-LABEL: test1:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    tbz w1, #3, .LBB0_3
; CHECK-GI-NEXT:  // %bb.1: // %entry
; CHECK-GI-NEXT:    tbz w0, #2, .LBB0_3
; CHECK-GI-NEXT:  // %bb.2: // %if.then2
; CHECK-GI-NEXT:    b foo
; CHECK-GI-NEXT:  .LBB0_3: // %if.end3
; CHECK-GI-NEXT:    ret
;
...
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    tst x0, #0x8
; CHECK-SD-NEXT:    ccmp x1, #0, #4, ne
; CHECK-SD-NEXT:    b.ne .LBB1_2
; CHECK-SD-NEXT:  // %bb.1: // %if.end3
; CHECK-SD-NEXT:    ret
; CHECK-SD-NEXT:  .LBB1_2: // %if.then2
; CHECK-SD-NEXT:    ldr x1, [x1]
; CHECK-SD-NEXT:    b foo
;
; CHECK-GI-LABEL: test2:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    cbz x1, .LBB1_3
; CHECK-GI-NEXT:  // %bb.1: // %entry
; CHECK-GI-NEXT:    tbz w0, #3, .LBB1_3
; CHECK-GI-NEXT:  // %bb.2: // %if.then2
; CHECK-GI-NEXT:    ldr x1, [x1]
; CHECK-GI-NEXT:    b foo
; CHECK-GI-NEXT:  .LBB1_3: // %if.end3
; CHECK-GI-NEXT:    ret
;
