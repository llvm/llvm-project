...
; CHECK-GI:       warning: Instruction selection used fallback path for u128_checked_mul
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for u128_overflowing_mul
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for u128_saturating_mul
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for i128_checked_mul
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for i128_overflowing_mul
; CHECK-GI-NEXT:  warning: Instruction selection used fallback path for i128_saturating_mul
...
; CHECK-SD-LABEL: u128_saturating_add:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    adds x8, x0, x2
; CHECK-SD-NEXT:    adcs x9, x1, x3
; CHECK-SD-NEXT:    csinv x0, x8, xzr, lo
; CHECK-SD-NEXT:    csinv x1, x9, xzr, lo
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: u128_saturating_add:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    adds x8, x0, x2
; CHECK-GI-NEXT:    adcs x9, x1, x3
...
; CHECK-SD-LABEL: u128_saturating_sub:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    subs x8, x0, x2
; CHECK-SD-NEXT:    sbcs x9, x1, x3
; CHECK-SD-NEXT:    csel x0, xzr, x8, lo
; CHECK-SD-NEXT:    csel x1, xzr, x9, lo
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: u128_saturating_sub:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    subs x8, x0, x2
; CHECK-GI-NEXT:    sbcs x9, x1, x3
...
; CHECK-SD-LABEL: i128_saturating_add:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    adds x8, x0, x2
; CHECK-SD-NEXT:    adcs x9, x1, x3
...
; CHECK-SD-LABEL: i128_saturating_sub:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    subs x8, x0, x2
; CHECK-SD-NEXT:    sbcs x9, x1, x3
; CHECK-SD-NEXT:    asr x10, x9, #63
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: i128_saturating_sub:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    subs x9, x0, x2
; CHECK-GI-NEXT:    mov w8, wzr
; CHECK-GI-NEXT:    mov x13, #-9223372036854775808 // =0x8000000000000000
; CHECK-GI-NEXT:    sbcs x10, x1, x3
; CHECK-GI-NEXT:    asr x11, x10, #63
; CHECK-GI-NEXT:    cset w12, vs
; CHECK-GI-NEXT:    cmp w8, #1
; CHECK-GI-NEXT:    adc x8, x11, x13
...
; CHECK-SD-LABEL: saddo_not_1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    negs x0, x0
; CHECK-SD-NEXT:    ngcs x1, x1
; CHECK-SD-NEXT:    cset w2, vs
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: saddo_not_1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mvn x8, x0
; CHECK-GI-NEXT:    mvn x9, x1
; CHECK-GI-NEXT:    adds x0, x8, #1
; CHECK-GI-NEXT:    adcs x1, x9, xzr
; CHECK-GI-NEXT:    cset w2, vs
; CHECK-GI-NEXT:    ret
  %not = xor i128 %x, -1
...
; CHECK-SD-LABEL: saddo_carry_not_1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    mov w8, #1 // =0x1
; CHECK-SD-NEXT:    negs x0, x0
; CHECK-SD-NEXT:    sbcs x1, x8, x1
; CHECK-SD-NEXT:    cset w2, vs
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: saddo_carry_not_1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    mvn x9, x0
; CHECK-GI-NEXT:    mov w8, #1 // =0x1
; CHECK-GI-NEXT:    mvn x10, x1
; CHECK-GI-NEXT:    adds x0, x9, #1
; CHECK-GI-NEXT:    adcs x1, x10, x8
; CHECK-GI-NEXT:    cset w2, vs
; CHECK-GI-NEXT:    ret
  %not = xor i128 %x, -1
