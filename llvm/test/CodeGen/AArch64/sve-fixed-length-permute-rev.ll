...
; CHECK-NEXT:    ptrue p0.h
; CHECK-NEXT:    mov v1.h[0], v0.h[4]
; CHECK-NEXT:    mov v2.h[0], v0.h[5]
; CHECK-NEXT:    mov v3.h[0], v0.h[6]
; CHECK-NEXT:    mov v4.h[0], v0.h[7]
...
; CHECK-NEXT:    mov v2.h[0], v0.h[2]
; CHECK-NEXT:    mov v0.h[0], v0.h[3]
; CHECK-NEXT:    str h3, [sp, #26]
; CHECK-NEXT:    mov v3.h[0], v5.h[2]
; CHECK-NEXT:    str h4, [sp, #24]
; CHECK-NEXT:    str h1, [sp, #20]
; CHECK-NEXT:    mov v1.h[0], v5.h[4]
; CHECK-NEXT:    str h2, [sp, #18]
; CHECK-NEXT:    mov v2.h[0], v5.h[5]
; CHECK-NEXT:    str h0, [sp, #16]
; CHECK-NEXT:    mov v0.h[0], v5.h[6]
; CHECK-NEXT:    str h3, [sp, #2]
; CHECK-NEXT:    str h1, [sp, #14]
; CHECK-NEXT:    mov v1.h[0], v5.h[7]
; CHECK-NEXT:    str h2, [sp, #12]
; CHECK-NEXT:    mov v2.h[0], v5.h[1]
