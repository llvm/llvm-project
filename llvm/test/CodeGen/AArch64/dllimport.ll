...
; RUN: llc -mtriple aarch64-unknown-windows-msvc -O0 -aarch64-enable-global-isel-at-O=0 -filetype asm -o - %s | FileCheck %s -check-prefixes=CHECK,GLOBAL-ISEL,GLOBAL-ISEL-FALLBACK
