...
; RUN: llc -mtriple aarch64-unknown-windows-msvc -O0 -global-isel -global-isel-abort=0 -filetype asm -o - %s | FileCheck %s -check-prefixes=CHECK,GLOBAL-ISEL,GLOBAL-ISEL-FALLBACK
