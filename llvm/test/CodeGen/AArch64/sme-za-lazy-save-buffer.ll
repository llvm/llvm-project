...
; CHECK-COMMON-LABEL: multi_bb_stpidr2_save_required_stackprobe:
; CHECK-COMMON:       // %bb.0:
; CHECK-COMMON-NEXT:    stp x29, x30, [sp, #-16]! // 16-byte Folded Spill
; CHECK-COMMON-NEXT:    mov x29, sp
; CHECK-COMMON-NEXT:    ldr xzr, [sp, #-16]!
; CHECK-COMMON-NEXT:    .cfi_def_cfa w29, 16
; CHECK-COMMON-NEXT:    .cfi_offset w30, -8
; CHECK-COMMON-NEXT:    .cfi_offset w29, -16
; CHECK-COMMON-NEXT:    rdsvl x8, #1
...
; CHECK-COMMON-NEXT:    cmp sp, x9
; CHECK-COMMON-NEXT:    b.le .LBB2_3
; CHECK-COMMON-NEXT:  // %bb.2: // in Loop: Header=BB2_1 Depth=1
; CHECK-COMMON-NEXT:    ldr xzr, [sp]
; CHECK-COMMON-NEXT:    b .LBB2_1
; CHECK-COMMON-NEXT:  .LBB2_3:
; CHECK-COMMON-NEXT:    mov sp, x9
; CHECK-COMMON-NEXT:    ldr xzr, [sp]
; CHECK-COMMON-NEXT:    stp x9, x8, [x29, #-16]
; CHECK-COMMON-NEXT:    cbz w0, .LBB2_5
; CHECK-COMMON-NEXT:  // %bb.4: // %use_b
; CHECK-COMMON-NEXT:    fmov s1, #4.00000000
; CHECK-COMMON-NEXT:    fadd s0, s0, s1
; CHECK-COMMON-NEXT:    b .LBB2_8
; CHECK-COMMON-NEXT:  .LBB2_5: // %use_c
; CHECK-COMMON-NEXT:    fmov s0, s1
; CHECK-COMMON-NEXT:    sub x8, x29, #16
; CHECK-COMMON-NEXT:    msr TPIDR2_EL0, x8
; CHECK-COMMON-NEXT:    bl cosf
...
; CHECK-COMMON-NEXT:    mrs x8, TPIDR2_EL0
; CHECK-COMMON-NEXT:    sub x0, x29, #16
; CHECK-COMMON-NEXT:    cbnz x8, .LBB2_7
; CHECK-COMMON-NEXT:  // %bb.6: // %use_c
; CHECK-COMMON-NEXT:    bl __arm_tpidr2_restore
; CHECK-COMMON-NEXT:  .LBB2_7: // %use_c
; CHECK-COMMON-NEXT:    msr TPIDR2_EL0, xzr
; CHECK-COMMON-NEXT:  .LBB2_8: // %exit
; CHECK-COMMON-NEXT:    mov sp, x29
; CHECK-COMMON-NEXT:    ldp x29, x30, [sp], #16 // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ret
  %cmp = icmp ne i32 %a, 0
