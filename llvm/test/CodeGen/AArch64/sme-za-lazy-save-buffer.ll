...
; CHECK-SDAG-LABEL: multi_bb_stpidr2_save_required:
; CHECK-SDAG:       // %bb.0:
...
; CHECK-SDAG-NEXT:    cbz w0, .LBB1_2
; CHECK-SDAG-NEXT:  // %bb.1: // %use_b
; CHECK-SDAG-NEXT:    fmov s1, #4.00000000
; CHECK-SDAG-NEXT:    fadd s0, s0, s1
; CHECK-SDAG-NEXT:    b .LBB1_5
; CHECK-SDAG-NEXT:  .LBB1_2: // %use_c
...
; CHECK-SDAG-NEXT:  // %bb.3: // %use_c
; CHECK-SDAG-NEXT:    bl __arm_tpidr2_restore
; CHECK-SDAG-NEXT:  .LBB1_4: // %use_c
