...
; CHECK-NEXT:    cmp w0, #1
; CHECK-NEXT:    b.lt .LBB0_9
; CHECK-NEXT:  // %bb.1: // %for.cond1.preheader.us.preheader
; CHECK-NEXT:    mov w9, w0
; CHECK-NEXT:    ubfiz x10, x0, #2, #32
; CHECK-NEXT:    mov x8, xzr
; CHECK-NEXT:    and x11, x9, #0xfffffff0
...
; CHECK-NEXT:    ldrsh w13, [x2, x8, lsl #1]
...
; CHECK-NEXT:    stp q3, q2, [x15, #-32]
; CHECK-NEXT:    stp q6, q5, [x15], #64
; CHECK-NEXT:    b.ne .LBB0_6
; CHECK-NEXT:  // %bb.7: // %middle.block
; CHECK-NEXT:    // in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    cmp x11, x9
; CHECK-NEXT:    and x14, x9, #0xfffffff0
; CHECK-NEXT:    b.eq .LBB0_2
; CHECK-NEXT:  .LBB0_8: // %for.body4.us
; CHECK-NEXT:    // Parent Loop BB0_3 Depth=1
; CHECK-NEXT:    // => This Inner Loop Header: Depth=2
; CHECK-NEXT:    ldrsh w15, [x2, x14, lsl #1]
; CHECK-NEXT:    ldr w16, [x1, x14, lsl #2]
; CHECK-NEXT:    madd w15, w15, w13, w16
; CHECK-NEXT:    str w15, [x1, x14, lsl #2]
; CHECK-NEXT:    add x14, x14, #1
; CHECK-NEXT:    cmp x9, x14
