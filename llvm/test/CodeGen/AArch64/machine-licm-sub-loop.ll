...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.cond.cleanup3_crit_edge.us
  ...
  %1 = load i16, ptr %arrayidx.us, align 2, !tbaa !6
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %3, align 2, !tbaa !6
  %4 = getelementptr inbounds i16, ptr %3, i64 8
  %wide.load36 = load <8 x i16>, ptr %4, align 2, !tbaa !6
  ...
  %wide.load39 = load <8 x i32>, ptr %10, align 4, !tbaa !10
  %11 = getelementptr inbounds i32, ptr %10, i64 8
  %wide.load40 = load <8 x i32>, ptr %11, align 4, !tbaa !10
  %12 = add nsw <8 x i32> %7, %wide.load39
  %13 = add nsw <8 x i32> %8, %wide.load40
  store <8 x i32> %12, ptr %10, align 4, !tbaa !10
  store <8 x i32> %13, ptr %11, align 4, !tbaa !10
...
for.body4.us:                                     ; preds = %for.body4.us.preheader, %for.body4.us
  ...
  %15 = load i16, ptr %arrayidx6.us, align 2, !tbaa !6
  ...
  %17 = load i32, ptr %arrayidx10.us, align 4, !tbaa !10
  %add11.us = add nsw i32 %mul.us, %17
  store i32 %add11.us, ptr %arrayidx10.us, align 4, !tbaa !10
...
for.cond1.for.cond.cleanup3_crit_edge.us:         ; preds = %for.body4.us, %middle.block
  ...
  br i1 %exitcond35.not, label %for.cond.cleanup, label %for.cond1.preheader.us, !llvm.loop !17

for.cond.cleanup:                                 ; preds = %for.cond1.for.cond.cleanup3_crit_edge.us, %entry
  ret void
}

attributes #0 = { nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="neoverse-n1" "target-features"="+aes,+crc,+dotprod,+fp-armv8,+fullfp16,+lse,+neon,+outline-atomics,+ras,+rcpc,+rdm,+sha2,+spe,+ssbs,+v8.1a,+v8.2a,+v8a,-fmv" }
...
!5 = !{!"clang version 17.0.0 (ssh://eu-gerrit-1.euhpc.arm.com:29418/dsg-dps/mirrors/llvm 2b55808b298965d2d49727b291198d4e2551d24a)"}
!6 = !{!7, !7, i64 0}
!7 = !{!"short", !8, i64 0}
