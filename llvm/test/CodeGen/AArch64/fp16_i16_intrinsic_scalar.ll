...
; RUN: llc < %s -mtriple=aarch64 -global-isel=0 -mattr=+sme,+neon,+fullfp16,+fprcvt -force-streaming-compatible | FileCheck %s
; RUN: llc < %s -mtriple=aarch64 -global-isel=0 -mattr=+sme,+neon,+fullfp16,+fprcvt -force-streaming | FileCheck %s
