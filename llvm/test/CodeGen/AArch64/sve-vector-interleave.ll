...
define <vscale x 2 x double> @interleave2_nxv2f64(<vscale x 1 x double> %vec0, <vscale x 1 x double> %vec1) {
; SVE-LABEL: interleave2_nxv2f64:
; SVE:       // %bb.0:
...
; SVE-NEXT:    mov x8, sp
; SVE-NEXT:    str z0, [sp, #1, mul vl]
; SVE-NEXT:    inch x8
; SVE-NEXT:    str z0, [sp]
; SVE-NEXT:    ld1d { z0.d }, p0/z, [x9]
; SVE-NEXT:    st1d { z0.d }, p0, [x8]
; SVE-NEXT:    ldr z0, [sp]
; SVE-NEXT:    addvl sp, sp, #3
; SVE-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; SVE-NEXT:    ret
;
; SME2-LABEL: interleave2_nxv2f64:
; SME2:       // %bb.0:
...
; SME2-NEXT:    str z0, [sp]
; SME2-NEXT:    mov x8, sp
; SME2-NEXT:    ld1d { z0.d }, p0/z, [x9]
; SME2-NEXT:    inch x8
; SME2-NEXT:    st1d { z0.d }, p0, [x8]
; SME2-NEXT:    ldr z0, [sp]
; SME2-NEXT:    addvl sp, sp, #3
...
; SME2-NEXT:    ret
  %retval = call <vscale x 2 x double> @llvm.vector.interleave2.nxv2f64(<vscale x 1 x double> %vec0, <vscale x 1 x double> %vec1)
...
define <vscale x 2 x i64> @interleave2_nxv2i64(<vscale x 1 x i64> %vec0, <vscale x 1 x i64> %vec1) {
; SVE-LABEL: interleave2_nxv2i64:
; SVE:       // %bb.0:
; SVE-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SVE-NEXT:    addvl sp, sp, #-3
; SVE-NEXT:    .cfi_escape 0x0f, 0x08, 0x8f, 0x10, 0x92, 0x2e, 0x00, 0x48, 0x1e, 0x22 // sp + 16 + 24 * VG
...
; SVE-NEXT:    ret
;
; SME2-LABEL: interleave2_nxv2i64:
; SME2:       // %bb.0:
; SME2-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SME2-NEXT:    addvl sp, sp, #-1
; SME2-NEXT:    str p8, [sp, #7, mul vl] // 2-byte Spill
...
; SME2-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; SME2-NEXT:    ret
  %retval = call <vscale x 2 x i64> @llvm.vector.interleave2.nxv2i64(<vscale x 1 x i64> %vec0, <vscale x 1 x i64> %vec1)
