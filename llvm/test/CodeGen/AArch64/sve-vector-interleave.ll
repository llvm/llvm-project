...
; RUN: llc < %s -mattr=+sme2 -force-streaming -enable-subreg-liveness=true -aarch64-enable-sve-multivector-lowering=true | FileCheck %s -check-prefixes=CHECK,SME2,SME-ALL
; RUN: llc < %s -mattr=+sme2 -force-streaming -aarch64-sve-vector-bits-min=256 -enable-subreg-liveness=true -aarch64-enable-sve-multivector-lowering=true | FileCheck %s -check-prefixes=CHECK,SME2,SME2-256
