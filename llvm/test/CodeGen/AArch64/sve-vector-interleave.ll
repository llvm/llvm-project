...
; RUN: llc < %s -mattr=+sve -sve-use-scalar-inc-vl=true -enable-subreg-liveness=true | FileCheck %s -check-prefixes=CHECK,SVE
...
define <vscale x 2 x i8> @interleave2_nxv1i8(<vscale x 1 x i8> %vec0, <vscale x 1 x i8> %vec1) {
; SVE-LABEL: interleave2_nxv1i8:
; SVE:       // %bb.0:
; SVE-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SVE-NEXT:    addvl sp, sp, #-3
; SVE-NEXT:    .cfi_escape 0x0f, 0x08, 0x8f, 0x10, 0x92, 0x2e, 0x00, 0x48, 0x1e, 0x22 // sp + 16 + 24 * VG
; SVE-NEXT:    .cfi_offset w29, -16
; SVE-NEXT:    zip1 z2.b, z0.b, z1.b
; SVE-NEXT:    rdvl x8, #1
; SVE-NEXT:    zip2 z0.b, z0.b, z1.b
; SVE-NEXT:    lsr x8, x8, #4
; SVE-NEXT:    addvl x9, sp, #1
; SVE-NEXT:    uunpklo z3.h, z2.b
; SVE-NEXT:    whilelo p0.b, xzr, x8
; SVE-NEXT:    str z0, [sp, #2, mul vl]
; SVE-NEXT:    str z2, [sp, #1, mul vl]
; SVE-NEXT:    uunpklo z3.s, z3.h
; SVE-NEXT:    uunpklo z1.d, z3.s
; SVE-NEXT:    str z1, [sp]
; SVE-NEXT:    ld1b { z0.b }, p0/z, [x9, x8]
; SVE-NEXT:    mov x9, sp
; SVE-NEXT:    whilelo p0.d, xzr, x8
; SVE-NEXT:    inch x9
...
; SME2-NEXT:    .cfi_escape 0x0f, 0x09, 0x8f, 0x10, 0x92, 0x2e, 0x00, 0x11, 0x20, 0x1e, 0x22 // sp + 16 + 32 * VG
; SME2-NEXT:    .cfi_offset w29, -16
; SME2-NEXT:    zip { z0.b, z1.b }, z0.b, z1.b
; SME2-NEXT:    rdvl x8, #1
; SME2-NEXT:    ptrue pn8.b
; SME2-NEXT:    uunpklo z2.h, z0.b
; SME2-NEXT:    lsr x8, x8, #4
; SME2-NEXT:    addvl x9, sp, #1
; SME2-NEXT:    st1b { z0.b, z1.b }, pn8, [x9]
; SME2-NEXT:    addvl x9, sp, #1
; SME2-NEXT:    whilelo p0.b, xzr, x8
; SME2-NEXT:    uunpklo z2.s, z2.h
; SME2-NEXT:    uunpklo z2.d, z2.s
; SME2-NEXT:    str z2, [sp]
; SME2-NEXT:    ld1b { z0.b }, p0/z, [x9, x8]
; SME2-NEXT:    mov x9, sp
; SME2-NEXT:    whilelo p0.d, xzr, x8
; SME2-NEXT:    inch x9
; SME2-NEXT:    uunpklo z0.h, z0.b
; SME2-NEXT:    uunpklo z0.s, z0.h
; SME2-NEXT:    uunpklo z0.d, z0.s
; SME2-NEXT:    st1d { z0.d }, p0, [x9]
; SME2-NEXT:    ldr z0, [sp]
; SME2-NEXT:    addvl sp, sp, #3
...
define <vscale x 2 x i16> @interleave2_nxv1i16(<vscale x 1 x i16> %vec0, <vscale x 1 x i16> %vec1) {
; SVE-LABEL: interleave2_nxv1i16:
; SVE:       // %bb.0:
; SVE-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SVE-NEXT:    addvl sp, sp, #-3
; SVE-NEXT:    .cfi_escape 0x0f, 0x08, 0x8f, 0x10, 0x92, 0x2e, 0x00, 0x48, 0x1e, 0x22 // sp + 16 + 24 * VG
...
; SVE-NEXT:    zip1 z2.h, z0.h, z1.h
; SVE-NEXT:    rdvl x8, #1
; SVE-NEXT:    zip2 z0.h, z0.h, z1.h
; SVE-NEXT:    lsr x8, x8, #4
; SVE-NEXT:    addvl x9, sp, #1
; SVE-NEXT:    incd x9
; SVE-NEXT:    uunpklo z3.s, z2.h
; SVE-NEXT:    whilelo p0.h, xzr, x8
; SVE-NEXT:    str z0, [sp, #2, mul vl]
; SVE-NEXT:    str z2, [sp, #1, mul vl]
; SVE-NEXT:    uunpklo z1.d, z3.s
; SVE-NEXT:    str z1, [sp]
; SVE-NEXT:    ld1h { z0.h }, p0/z, [x9]
; SVE-NEXT:    mov x9, sp
; SVE-NEXT:    whilelo p0.d, xzr, x8
; SVE-NEXT:    inch x9
; SVE-NEXT:    uunpklo z0.s, z0.h
...
; SVE-NEXT:    ret
;
; SME2-LABEL: interleave2_nxv1i16:
; SME2:       // %bb.0:
; SME2-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SME2-NEXT:    addvl sp, sp, #-1
; SME2-NEXT:    str p8, [sp, #7, mul vl] // 2-byte Spill
...
; SME2-NEXT:    rdvl x8, #1
; SME2-NEXT:    addvl x9, sp, #1
; SME2-NEXT:    uunpklo z2.s, z0.h
; SME2-NEXT:    lsr x8, x8, #4
; SME2-NEXT:    incd x9
; SME2-NEXT:    ptrue pn8.h
; SME2-NEXT:    addvl x10, sp, #1
; SME2-NEXT:    whilelo p0.h, xzr, x8
; SME2-NEXT:    st1h { z0.h, z1.h }, pn8, [x10]
; SME2-NEXT:    uunpklo z2.d, z2.s
; SME2-NEXT:    str z2, [sp]
; SME2-NEXT:    ld1h { z0.h }, p0/z, [x9]
; SME2-NEXT:    mov x9, sp
; SME2-NEXT:    whilelo p0.d, xzr, x8
; SME2-NEXT:    inch x9
; SME2-NEXT:    uunpklo z0.s, z0.h
...
define <vscale x 2 x i32> @interleave2_nxv1i32(<vscale x 1 x i32> %vec0, <vscale x 1 x i32> %vec1) {
; SVE-LABEL: interleave2_nxv1i32:
; SVE:       // %bb.0:
; SVE-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SVE-NEXT:    addvl sp, sp, #-3
; SVE-NEXT:    .cfi_escape 0x0f, 0x08, 0x8f, 0x10, 0x92, 0x2e, 0x00, 0x48, 0x1e, 0x22 // sp + 16 + 24 * VG
...
; SVE-NEXT:    zip1 z2.s, z0.s, z1.s
; SVE-NEXT:    rdvl x8, #1
; SVE-NEXT:    zip2 z0.s, z0.s, z1.s
; SVE-NEXT:    lsr x8, x8, #4
; SVE-NEXT:    addvl x9, sp, #1
; SVE-NEXT:    incw x9
; SVE-NEXT:    uunpklo z1.d, z2.s
; SVE-NEXT:    whilelo p0.s, xzr, x8
; SVE-NEXT:    str z0, [sp, #2, mul vl]
; SVE-NEXT:    str z2, [sp, #1, mul vl]
; SVE-NEXT:    str z1, [sp]
; SVE-NEXT:    ld1w { z0.s }, p0/z, [x9]
; SVE-NEXT:    mov x9, sp
; SVE-NEXT:    whilelo p0.d, xzr, x8
; SVE-NEXT:    inch x9
; SVE-NEXT:    uunpklo z0.d, z0.s
...
; SVE-NEXT:    ret
;
; SME2-LABEL: interleave2_nxv1i32:
; SME2:       // %bb.0:
; SME2-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SME2-NEXT:    addvl sp, sp, #-1
; SME2-NEXT:    str p8, [sp, #7, mul vl] // 2-byte Spill
...
; SME2-NEXT:    rdvl x8, #1
; SME2-NEXT:    addvl x9, sp, #1
; SME2-NEXT:    uunpklo z2.d, z0.s
; SME2-NEXT:    lsr x8, x8, #4
; SME2-NEXT:    incw x9
; SME2-NEXT:    ptrue pn8.s
; SME2-NEXT:    addvl x10, sp, #1
; SME2-NEXT:    whilelo p0.s, xzr, x8
; SME2-NEXT:    st1w { z0.s, z1.s }, pn8, [x10]
; SME2-NEXT:    str z2, [sp]
; SME2-NEXT:    ld1w { z0.s }, p0/z, [x9]
; SME2-NEXT:    mov x9, sp
; SME2-NEXT:    whilelo p0.d, xzr, x8
; SME2-NEXT:    inch x9
; SME2-NEXT:    uunpklo z0.d, z0.s
