...
; CHECK-NEXT:    fcmgt p0.s, p0/z, z0.s, z3.s
...
; CHECK-NEXT:    fcvtzu z3.s, p0/m, z0.s
; CHECK-NEXT:    fcmge p1.s, p0/z, z0.s, #0.0
; CHECK-NEXT:    movprfx z5, z1
; CHECK-NEXT:    fcvtzu z5.s, p0/m, z1.s
; CHECK-NEXT:    fcmge p2.s, p0/z, z1.s, #0.0
; CHECK-NEXT:    fcmgt p3.s, p0/z, z0.s, z2.s
; CHECK-NEXT:    fcmgt p0.s, p0/z, z1.s, z2.s
; CHECK-NEXT:    sel z0.s, p1, z3.s, z4.s
; CHECK-NEXT:    sel z1.s, p2, z5.s, z4.s
...
; CHECK-NEXT:    fcvtzu z5.s, p0/m, z0.s
...
; CHECK-NEXT:    sel z0.s, p1, z3.s, z2.s
; CHECK-NEXT:    mov z2.s, p2/m, z5.s
; CHECK-NEXT:    mov z0.s, p3/m, z1.s
...
; CHECK-NEXT:    movi v4.2d, #0000000000000000
; CHECK-NEXT:    movprfx z3, z1
; CHECK-NEXT:    fcvtzu z3.d, p0/m, z1.s
; CHECK-NEXT:    fcmge p1.s, p0/z, z1.s, #0.0
; CHECK-NEXT:    movprfx z5, z0
; CHECK-NEXT:    fcvtzu z5.d, p0/m, z0.s
; CHECK-NEXT:    fcmge p2.s, p0/z, z0.s, #0.0
; CHECK-NEXT:    fcmgt p3.s, p0/z, z1.s, z2.s
; CHECK-NEXT:    fcmgt p0.s, p0/z, z0.s, z2.s
; CHECK-NEXT:    sel z0.d, p1, z3.d, z4.d
; CHECK-NEXT:    sel z1.d, p2, z5.d, z4.d
...
; CHECK-NEXT:    fcmgt p0.d, p0/z, z0.d, z3.d
; CHECK-NEXT:    mov z0.d, #0xffffffff
; CHECK-NEXT:    sel z1.d, p1, z1.d, z2.d
; CHECK-NEXT:    sel z0.d, p0, z0.d, z1.d
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    movprfx z5, z0
; CHECK-NEXT:    fcvtzu z5.d, p0/m, z0.d
...
; CHECK-NEXT:    sel z0.d, p1, z3.d, z2.d
; CHECK-NEXT:    mov z2.d, p2/m, z5.d
; CHECK-NEXT:    mov z0.d, p3/m, z1.d
...
; CHECK-NEXT:    fcvtzu z7.d, p0/m, z0.d
; CHECK-NEXT:    fcmge p2.d, p0/z, z0.d, #0.0
; CHECK-NEXT:    movprfx z24, z3
; CHECK-NEXT:    fcvtzu z24.d, p0/m, z3.d
; CHECK-NEXT:    fcmge p3.d, p0/z, z3.d, #0.0
; CHECK-NEXT:    movprfx z25, z2
; CHECK-NEXT:    fcvtzu z25.d, p0/m, z2.d
; CHECK-NEXT:    fcmge p4.d, p0/z, z2.d, #0.0
; CHECK-NEXT:    fcmgt p5.d, p0/z, z1.d, z6.d
; CHECK-NEXT:    fcmgt p6.d, p0/z, z0.d, z6.d
; CHECK-NEXT:    mov z0.d, #0xffffffff
; CHECK-NEXT:    sel z1.d, p1, z5.d, z4.d
; CHECK-NEXT:    fcmgt p1.d, p0/z, z3.d, z6.d
; CHECK-NEXT:    fcmgt p0.d, p0/z, z2.d, z6.d
; CHECK-NEXT:    sel z2.d, p2, z7.d, z4.d
; CHECK-NEXT:    sel z3.d, p3, z24.d, z4.d
; CHECK-NEXT:    mov z4.d, p4/m, z25.d
; CHECK-NEXT:    ldr p4, [sp, #7, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z1.d, p5/m, z0.d
; CHECK-NEXT:    ldr p5, [sp, #6, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z2.d, p6/m, z0.d
; CHECK-NEXT:    ldr p6, [sp, #5, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z3.d, p1/m, z0.d
; CHECK-NEXT:    mov z4.d, p0/m, z0.d
...
; CHECK-NEXT:    fcvtzu z7.d, p0/m, z2.d
; CHECK-NEXT:    fcmge p2.d, p0/z, z2.d, #0.0
; CHECK-NEXT:    movprfx z24, z1
; CHECK-NEXT:    fcvtzu z24.d, p0/m, z1.d
; CHECK-NEXT:    fcmge p3.d, p0/z, z1.d, #0.0
; CHECK-NEXT:    movprfx z25, z0
; CHECK-NEXT:    fcvtzu z25.d, p0/m, z0.d
; CHECK-NEXT:    fcmge p4.d, p0/z, z0.d, #0.0
; CHECK-NEXT:    fcmgt p5.d, p0/z, z3.d, z6.d
; CHECK-NEXT:    fcmgt p6.d, p0/z, z2.d, z6.d
; CHECK-NEXT:    mov z2.d, #65535 // =0xffff
; CHECK-NEXT:    sel z3.d, p1, z5.d, z4.d
; CHECK-NEXT:    fcmgt p1.d, p0/z, z1.d, z6.d
; CHECK-NEXT:    fcmgt p0.d, p0/z, z0.d, z6.d
; CHECK-NEXT:    sel z0.d, p2, z7.d, z4.d
; CHECK-NEXT:    sel z1.d, p3, z24.d, z4.d
; CHECK-NEXT:    mov z4.d, p4/m, z25.d
; CHECK-NEXT:    ldr p4, [sp, #7, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z3.d, p5/m, z2.d
; CHECK-NEXT:    ldr p5, [sp, #6, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z0.d, p6/m, z2.d
; CHECK-NEXT:    ldr p6, [sp, #5, mul vl] // 2-byte Folded Reload
; CHECK-NEXT:    mov z1.d, p1/m, z2.d
; CHECK-NEXT:    sel z2.d, p0, z2.d, z4.d
...
; CHECK-NEXT:    movprfx z3, z0
; CHECK-NEXT:    fcvtzu z3.d, p0/m, z0.d
; CHECK-NEXT:    fcmge p1.d, p0/z, z0.d, #0.0
; CHECK-NEXT:    movprfx z5, z1
; CHECK-NEXT:    fcvtzu z5.d, p0/m, z1.d
; CHECK-NEXT:    fcmge p2.d, p0/z, z1.d, #0.0
; CHECK-NEXT:    fcmgt p3.d, p0/z, z0.d, z2.d
; CHECK-NEXT:    fcmgt p0.d, p0/z, z1.d, z2.d
; CHECK-NEXT:    sel z0.d, p1, z3.d, z4.d
; CHECK-NEXT:    sel z1.d, p2, z5.d, z4.d
; CHECK-NEXT:    mov z0.d, p3/m, #-1 // =0xffffffffffffffff
; CHECK-NEXT:    mov z1.d, p0/m, #-1 // =0xffffffffffffffff
...
; CHECK-NEXT:    fcmgt p0.h, p0/z, z0.h, z3.h
; CHECK-NEXT:    mov z0.d, #0xffffffff
; CHECK-NEXT:    sel z1.d, p1, z1.d, z2.d
; CHECK-NEXT:    sel z0.d, p0, z0.d, z1.d
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    movi v4.2d, #0000000000000000
; CHECK-NEXT:    movprfx z3, z1
; CHECK-NEXT:    fcvtzu z3.s, p0/m, z1.h
; CHECK-NEXT:    fcmge p1.h, p0/z, z1.h, #0.0
; CHECK-NEXT:    movprfx z5, z0
; CHECK-NEXT:    fcvtzu z5.s, p0/m, z0.h
; CHECK-NEXT:    fcmge p2.h, p0/z, z0.h, #0.0
; CHECK-NEXT:    fcmgt p3.h, p0/z, z1.h, z2.h
...
; CHECK-NEXT:    mov z1.h, w8
; CHECK-NEXT:    movprfx z2, z0
; CHECK-NEXT:    fcvtzu z2.h, p0/m, z0.h
; CHECK-NEXT:    fcmge p1.h, p0/z, z0.h, #0.0
; CHECK-NEXT:    fcmgt p0.h, p0/z, z0.h, z1.h
; CHECK-NEXT:    sel z0.h, p1, z2.h, z3.h
...
; CHECK-NEXT:    movi v4.2d, #0000000000000000
; CHECK-NEXT:    movprfx z3, z1
; CHECK-NEXT:    fcvtzu z3.d, p0/m, z1.h
; CHECK-NEXT:    fcmge p1.h, p0/z, z1.h, #0.0
; CHECK-NEXT:    movprfx z5, z0
; CHECK-NEXT:    fcvtzu z5.d, p0/m, z0.h
; CHECK-NEXT:    fcmge p2.h, p0/z, z0.h, #0.0
; CHECK-NEXT:    fcmgt p3.h, p0/z, z1.h, z2.h
; CHECK-NEXT:    fcmgt p0.h, p0/z, z0.h, z2.h
; CHECK-NEXT:    sel z0.d, p1, z3.d, z4.d
