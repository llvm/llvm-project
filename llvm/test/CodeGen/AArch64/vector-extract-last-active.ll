...
; RUN: llc -mtriple=aarch64 -mattr=+sme2p2 -force-streaming -verify-machineinstrs %s -o - | FileCheck %s --check-prefixes=CHECK,SME2P2-STREAMING
...
;
; SME2P2-STREAMING-LABEL: extract_last_i8:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.b, vl16
; SME2P2-STREAMING-NEXT:    cmpne p1.b, p0/z, z1.b, #0
; SME2P2-STREAMING-NEXT:    mov z1.b, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    cmpne p1.b, p0/z, z1.b, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p0, p1.b
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.b, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb w8, p1, z0.b
; SME2P2-STREAMING-NEXT:    umaxv b0, p0, z1.b
; SME2P2-STREAMING-NEXT:    fmov w9, s0
; SME2P2-STREAMING-NEXT:    tst w9, #0x1
; SME2P2-STREAMING-NEXT:    csel w0, w8, w0, ne
; SME2P2-STREAMING-NEXT:    ret
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_i16:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.h, vl8
; SME2P2-STREAMING-NEXT:    cmpne p1.h, p0/z, z1.h, #0
; SME2P2-STREAMING-NEXT:    mov z1.h, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue p1.b, vl8
; SME2P2-STREAMING-NEXT:    uzp1 z2.b, z1.b, z1.b
; SME2P2-STREAMING-NEXT:    cmpne p2.b, p1/z, z2.b, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p1, p2.b
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.h, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb w8, p1, z0.h
; SME2P2-STREAMING-NEXT:    umaxv h0, p0, z1.h
; SME2P2-STREAMING-NEXT:    fmov w9, s0
; SME2P2-STREAMING-NEXT:    tst w9, #0x1
; SME2P2-STREAMING-NEXT:    csel w0, w8, w0, ne
; SME2P2-STREAMING-NEXT:    ret
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_i32:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl4
; SME2P2-STREAMING-NEXT:    cmpne p1.s, p0/z, z1.s, #0
; SME2P2-STREAMING-NEXT:    mov z1.s, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue p1.h, vl4
; SME2P2-STREAMING-NEXT:    uzp1 z2.h, z1.h, z1.h
; SME2P2-STREAMING-NEXT:    cmpne p2.h, p1/z, z2.h, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p1, p2.h
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.s, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb w8, p1, z0.s
; SME2P2-STREAMING-NEXT:    umaxv s0, p0, z1.s
; SME2P2-STREAMING-NEXT:    fmov w9, s0
; SME2P2-STREAMING-NEXT:    tst w9, #0x1
; SME2P2-STREAMING-NEXT:    csel w0, w8, w0, ne
; SME2P2-STREAMING-NEXT:    ret
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_i64:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.d, vl2
; SME2P2-STREAMING-NEXT:    cmpne p1.d, p0/z, z1.d, #0
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl2
; SME2P2-STREAMING-NEXT:    mov z1.d, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    uzp1 z2.s, z1.s, z1.s
; SME2P2-STREAMING-NEXT:    cmpne p1.s, p0/z, z2.s, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p0, p1.s
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p0.d, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb x8, p0, z0.d
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl4
; SME2P2-STREAMING-NEXT:    umaxv s0, p0, z1.s
; SME2P2-STREAMING-NEXT:    fmov w9, s0
; SME2P2-STREAMING-NEXT:    tst w9, #0x1
; SME2P2-STREAMING-NEXT:    csel x0, x8, x0, ne
; SME2P2-STREAMING-NEXT:    ret
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_half:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.h, vl8
; SME2P2-STREAMING-NEXT:    cmpne p1.h, p0/z, z1.h, #0
; SME2P2-STREAMING-NEXT:    mov z1.h, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue p1.b, vl8
; SME2P2-STREAMING-NEXT:    uzp1 z3.b, z1.b, z1.b
; SME2P2-STREAMING-NEXT:    umaxv h1, p0, z1.h
; SME2P2-STREAMING-NEXT:    cmpne p2.b, p1/z, z3.b, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p1, p2.b
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.h, xzr, x8
; SME2P2-STREAMING-NEXT:    fmov w8, s1
; SME2P2-STREAMING-NEXT:    lastb h0, p1, z0.h
; SME2P2-STREAMING-NEXT:    tst w8, #0x1
; SME2P2-STREAMING-NEXT:    fcsel h0, h0, h2, ne
; SME2P2-STREAMING-NEXT:    ret
  %notzero = icmp ne <8 x i16> %mask, zeroinitializer
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_bfloat:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    sub sp, sp, #16
; SME2P2-STREAMING-NEXT:    .cfi_def_cfa_offset 16
; SME2P2-STREAMING-NEXT:    ptrue p0.h, vl8
; SME2P2-STREAMING-NEXT:    mov x9, sp
; SME2P2-STREAMING-NEXT:    str q0, [sp]
; SME2P2-STREAMING-NEXT:    cmpne p1.h, p0/z, z1.h, #0
; SME2P2-STREAMING-NEXT:    mov z1.h, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue p1.b, vl8
; SME2P2-STREAMING-NEXT:    uzp1 z3.b, z1.b, z1.b
...
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    bfi x9, x8, #1, #3
; SME2P2-STREAMING-NEXT:    fmov w8, s1
; SME2P2-STREAMING-NEXT:    ldr h0, [x9]
; SME2P2-STREAMING-NEXT:    tst w8, #0x1
; SME2P2-STREAMING-NEXT:    fcsel h0, h0, h2, ne
; SME2P2-STREAMING-NEXT:    add sp, sp, #16
; SME2P2-STREAMING-NEXT:    ret
  %notzero = icmp ne <8 x i16> %mask, zeroinitializer
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_float:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl4
; SME2P2-STREAMING-NEXT:    cmpne p1.s, p0/z, z1.s, #0
; SME2P2-STREAMING-NEXT:    mov z1.s, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue p1.h, vl4
; SME2P2-STREAMING-NEXT:    uzp1 z3.h, z1.h, z1.h
; SME2P2-STREAMING-NEXT:    umaxv s1, p0, z1.s
; SME2P2-STREAMING-NEXT:    cmpne p2.h, p1/z, z3.h, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p1, p2.h
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.s, xzr, x8
; SME2P2-STREAMING-NEXT:    fmov w8, s1
; SME2P2-STREAMING-NEXT:    lastb s0, p1, z0.s
; SME2P2-STREAMING-NEXT:    tst w8, #0x1
; SME2P2-STREAMING-NEXT:    fcsel s0, s0, s2, ne
; SME2P2-STREAMING-NEXT:    ret
  %notzero = icmp ne <4 x i32> %mask, zeroinitializer
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_double:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    ptrue p0.d, vl2
; SME2P2-STREAMING-NEXT:    cmpne p1.d, p0/z, z1.d, #0
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl2
; SME2P2-STREAMING-NEXT:    mov z1.d, p1/z, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    uzp1 z3.s, z1.s, z1.s
; SME2P2-STREAMING-NEXT:    cmpne p1.s, p0/z, z3.s, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p0, p1.s
; SME2P2-STREAMING-NEXT:    ptrue p0.s, vl4
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    umaxv s1, p0, z1.s
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p0.d, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb d0, p0, z0.d
; SME2P2-STREAMING-NEXT:    fmov w8, s1
; SME2P2-STREAMING-NEXT:    tst w8, #0x1
; SME2P2-STREAMING-NEXT:    fcsel d0, d0, d2, ne
; SME2P2-STREAMING-NEXT:    ret
  %notzero = icmp ne <2 x i64> %mask, zeroinitializer
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_active_v3i32:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    fmov s1, wzr
; SME2P2-STREAMING-NEXT:    fmov s2, w2
; SME2P2-STREAMING-NEXT:    fmov s3, w1
; SME2P2-STREAMING-NEXT:    fmov s4, w0
; SME2P2-STREAMING-NEXT:    ptrue p0.h, vl4
; SME2P2-STREAMING-NEXT:    zip1 z1.h, z2.h, z1.h
; SME2P2-STREAMING-NEXT:    zip1 z2.h, z4.h, z3.h
; SME2P2-STREAMING-NEXT:    zip1 z1.s, z2.s, z1.s
; SME2P2-STREAMING-NEXT:    lsl z2.h, z1.h, #15
; SME2P2-STREAMING-NEXT:    asr z2.h, z2.h, #15
; SME2P2-STREAMING-NEXT:    cmpne p1.h, p0/z, z2.h, #0
; SME2P2-STREAMING-NEXT:    lastp x8, p0, p1.h
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    whilels p1.s, xzr, x8
; SME2P2-STREAMING-NEXT:    lastb w8, p1, z0.s
; SME2P2-STREAMING-NEXT:    orv h0, p0, z1.h
; SME2P2-STREAMING-NEXT:    fmov w9, s0
; SME2P2-STREAMING-NEXT:    tst w9, #0x1
; SME2P2-STREAMING-NEXT:    csinv w0, w8, wzr, ne
; SME2P2-STREAMING-NEXT:    ret
...
; SVE2P2-FIXED-NEXT:    ret
;
; SME2P2-STREAMING-LABEL: extract_last_active_split:
; SME2P2-STREAMING:       // %bb.0:
; SME2P2-STREAMING-NEXT:    str x29, [sp, #-16]! // 8-byte Folded Spill
; SME2P2-STREAMING-NEXT:    addvl sp, sp, #-1
; SME2P2-STREAMING-NEXT:    str p8, [sp, #7, mul vl] // 2-byte Spill
; SME2P2-STREAMING-NEXT:    addvl sp, sp, #-2
; SME2P2-STREAMING-NEXT:    ptrue p2.b
; SME2P2-STREAMING-NEXT:    mov x10, #-1 // =0xffffffffffffffff
; SME2P2-STREAMING-NEXT:    ptrue pn8.b
; SME2P2-STREAMING-NEXT:    incb x10, all, mul #2
; SME2P2-STREAMING-NEXT:    st1b { z0.b, z1.b }, pn8, [sp]
; SME2P2-STREAMING-NEXT:    lastp x8, p2, p0.b
; SME2P2-STREAMING-NEXT:    lastp x9, p2, p1.b
; SME2P2-STREAMING-NEXT:    sel p0.b, p0, p0.b, p1.b
; SME2P2-STREAMING-NEXT:    cmn x8, #1
; SME2P2-STREAMING-NEXT:    csel x8, xzr, x8, eq
; SME2P2-STREAMING-NEXT:    cmn x9, #1
; SME2P2-STREAMING-NEXT:    csel x9, xzr, x9, eq
; SME2P2-STREAMING-NEXT:    ptest p1, p1.b
; SME2P2-STREAMING-NEXT:    incb x9
; SME2P2-STREAMING-NEXT:    csel x8, x9, x8, ne
; SME2P2-STREAMING-NEXT:    mov x9, sp
; SME2P2-STREAMING-NEXT:    cmp x8, x10
; SME2P2-STREAMING-NEXT:    csel x8, x8, x10, lo
; SME2P2-STREAMING-NEXT:    ptest p0, p0.b
; SME2P2-STREAMING-NEXT:    ldrb w8, [x9, x8]
; SME2P2-STREAMING-NEXT:    csel w0, w8, w0, ne
; SME2P2-STREAMING-NEXT:    addvl sp, sp, #2
; SME2P2-STREAMING-NEXT:    ldr p8, [sp, #7, mul vl] // 2-byte Reload
; SME2P2-STREAMING-NEXT:    addvl sp, sp, #1
; SME2P2-STREAMING-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; SME2P2-STREAMING-NEXT:    ret
