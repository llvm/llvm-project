...
; RUN: llc -mattr=+sve,+bf16            < %s | FileCheck %s --check-prefixes=CHECK,BF16,BF16-NONSTREAMING
; RUN: llc -mattr=+sme -force-streaming < %s | FileCheck %s --check-prefixes=CHECK,BF16,BF16-STREAMING
...
; NOBF16-LABEL: fpext_nxv8bf16_to_nxv8f32:
; NOBF16:       // %bb.0:
; NOBF16-NEXT:    movi v1.2d, #0000000000000000
; NOBF16-NEXT:    zip1 z2.h, z1.h, z0.h
; NOBF16-NEXT:    zip2 z1.h, z1.h, z0.h
; NOBF16-NEXT:    mov z0.d, z2.d
; NOBF16-NEXT:    ret
;
; BF16-NONSTREAMING-LABEL: fpext_nxv8bf16_to_nxv8f32:
; BF16-NONSTREAMING:       // %bb.0:
; BF16-NONSTREAMING-NEXT:    movi v1.2d, #0000000000000000
; BF16-NONSTREAMING-NEXT:    zip1 z2.h, z1.h, z0.h
; BF16-NONSTREAMING-NEXT:    zip2 z1.h, z1.h, z0.h
; BF16-NONSTREAMING-NEXT:    mov z0.d, z2.d
; BF16-NONSTREAMING-NEXT:    ret
;
; BF16-STREAMING-LABEL: fpext_nxv8bf16_to_nxv8f32:
; BF16-STREAMING:       // %bb.0:
; BF16-STREAMING-NEXT:    mov z1.h, #0 // =0x0
; BF16-STREAMING-NEXT:    zip1 z2.h, z1.h, z0.h
; BF16-STREAMING-NEXT:    zip2 z1.h, z1.h, z0.h
; BF16-STREAMING-NEXT:    mov z0.d, z2.d
; BF16-STREAMING-NEXT:    ret
