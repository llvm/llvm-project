...
; CHECK-GI-NEXT:    ldr q1, [x1]
; CHECK-GI-NEXT:    ldr q22, [x0]
; CHECK-GI-NEXT:    fmov s0, wzr
; CHECK-GI-NEXT:    mov b3, v1.b[1]
; CHECK-GI-NEXT:    fmov w8, s1
; CHECK-GI-NEXT:    mov b17, v1.b[2]
; CHECK-GI-NEXT:    mov b16, v1.b[3]
; CHECK-GI-NEXT:    mov b12, v1.b[4]
; CHECK-GI-NEXT:    mov b13, v22.b[1]
; CHECK-GI-NEXT:    fmov w13, s22
; CHECK-GI-NEXT:    mov b30, v1.b[9]
; CHECK-GI-NEXT:    mov b31, v1.b[8]
; CHECK-GI-NEXT:    uxtb w8, w8
; CHECK-GI-NEXT:    mov b10, v22.b[2]
; CHECK-GI-NEXT:    mov b8, v22.b[3]
; CHECK-GI-NEXT:    fmov w9, s3
; CHECK-GI-NEXT:    fmov w12, s17
; CHECK-GI-NEXT:    mov b27, v22.b[4]
; CHECK-GI-NEXT:    fmov s6, w8
; CHECK-GI-NEXT:    uxtb w13, w13
; CHECK-GI-NEXT:    fmov w14, s13
; CHECK-GI-NEXT:    mov b26, v22.b[5]
; CHECK-GI-NEXT:    mov b21, v22.b[6]
; CHECK-GI-NEXT:    mov b17, v22.b[7]
; CHECK-GI-NEXT:    uxtb w10, w9
; CHECK-GI-NEXT:    uxtb w12, w12
; CHECK-GI-NEXT:    mov b11, v22.b[8]
; CHECK-GI-NEXT:    mov b9, v22.b[9]
; CHECK-GI-NEXT:    uxtb w14, w14
; CHECK-GI-NEXT:    mov b29, v22.b[10]
; CHECK-GI-NEXT:    mov v6.h[1], w10
; CHECK-GI-NEXT:    ldrb w10, [x1, #16]!
; CHECK-GI-NEXT:    mov b28, v22.b[11]
; CHECK-GI-NEXT:    mov b25, v22.b[12]
; CHECK-GI-NEXT:    ldrb w11, [x1, #1]
; CHECK-GI-NEXT:    uxtb w10, w10
; CHECK-GI-NEXT:    mov b20, v22.b[13]
; CHECK-GI-NEXT:    mov b18, v22.b[14]
; CHECK-GI-NEXT:    mov b24, v1.b[5]
; CHECK-GI-NEXT:    mov b23, v1.b[10]
; CHECK-GI-NEXT:    mov b7, v1.b[11]
; CHECK-GI-NEXT:    mov v6.h[2], w12
; CHECK-GI-NEXT:    ldrb w9, [x0, #16]!
; CHECK-GI-NEXT:    fmov w12, s16
; CHECK-GI-NEXT:    mov b16, v22.b[15]
; CHECK-GI-NEXT:    ldrb w8, [x0, #1]
; CHECK-GI-NEXT:    fmov s22, w10
; CHECK-GI-NEXT:    uxtb w9, w9
; CHECK-GI-NEXT:    mov b19, v1.b[6]
; CHECK-GI-NEXT:    ldrb w10, [x0, #2]
; CHECK-GI-NEXT:    mov b5, v1.b[12]
; CHECK-GI-NEXT:    mov b3, v1.b[14]
; CHECK-GI-NEXT:    uxtb w12, w12
; CHECK-GI-NEXT:    mov b2, v1.b[7]
; CHECK-GI-NEXT:    mov b4, v1.b[13]
; CHECK-GI-NEXT:    mov v22.h[1], w11
; CHECK-GI-NEXT:    fmov w11, s31
; CHECK-GI-NEXT:    mov b1, v1.b[15]
; CHECK-GI-NEXT:    mov v6.h[3], w12
; CHECK-GI-NEXT:    fmov w12, s12
; CHECK-GI-NEXT:    mov v0.s[1], wzr
; CHECK-GI-NEXT:    uxtb w11, w11
; CHECK-GI-NEXT:    uxtb w12, w12
; CHECK-GI-NEXT:    mov v0.s[2], wzr
; CHECK-GI-NEXT:    mov v6.h[4], w12
...
; CHECK-GI-NEXT:    mov v30.h[1], w14
; CHECK-GI-NEXT:    fmov w14, s10
; CHECK-GI-NEXT:    uxtb w12, w12
; CHECK-GI-NEXT:    uxtb w11, w11
; CHECK-GI-NEXT:    uxtb w13, w13
...
; CHECK-GI-NEXT:    add v3.4s, v16.4s, v17.4s
...
; CHECK-GI-NEXT:    .cfi_offset b12, -40
; CHECK-GI-NEXT:    .cfi_offset b13, -48
; CHECK-GI-NEXT:    ldr q5, [x1]
; CHECK-GI-NEXT:    ldr q12, [x0]
; CHECK-GI-NEXT:    fmov s0, wzr
; CHECK-GI-NEXT:    ldrb w10, [x0, #16]!
; CHECK-GI-NEXT:    ldrb w9, [x0, #1]
; CHECK-GI-NEXT:    mov b18, v5.b[1]
; CHECK-GI-NEXT:    fmov w8, s5
; CHECK-GI-NEXT:    mov b16, v5.b[2]
; CHECK-GI-NEXT:    mov b6, v5.b[3]
; CHECK-GI-NEXT:    mov b17, v5.b[4]
; CHECK-GI-NEXT:    mov b23, v5.b[5]
; CHECK-GI-NEXT:    mov b21, v5.b[6]
; CHECK-GI-NEXT:    mov b7, v5.b[7]
; CHECK-GI-NEXT:    mov b10, v5.b[8]
; CHECK-GI-NEXT:    sxtb w11, w8
; CHECK-GI-NEXT:    mov b9, v5.b[9]
; CHECK-GI-NEXT:    mov b26, v5.b[10]
; CHECK-GI-NEXT:    fmov w8, s18
; CHECK-GI-NEXT:    mov b20, v5.b[11]
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mov b4, v5.b[12]
; CHECK-GI-NEXT:    mov b3, v5.b[13]
; CHECK-GI-NEXT:    sxtb w9, w9
; CHECK-GI-NEXT:    mov b2, v5.b[14]
; CHECK-GI-NEXT:    mov b1, v5.b[15]
; CHECK-GI-NEXT:    fmov s5, w11
; CHECK-GI-NEXT:    sxtb w12, w8
; CHECK-GI-NEXT:    fmov w14, s16
; CHECK-GI-NEXT:    ldrb w8, [x0, #2]
; CHECK-GI-NEXT:    ldrb w11, [x1, #16]!
; CHECK-GI-NEXT:    ldrb w13, [x1, #2]
; CHECK-GI-NEXT:    mov v5.h[1], w12
; CHECK-GI-NEXT:    ldrb w12, [x1, #1]
; CHECK-GI-NEXT:    mov b11, v12.b[1]
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    sxtb w15, w11
; CHECK-GI-NEXT:    sxtb w11, w13
; CHECK-GI-NEXT:    fmov w13, s17
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov b13, v12.b[8]
; CHECK-GI-NEXT:    fmov s17, w15
; CHECK-GI-NEXT:    mov b8, v12.b[9]
; CHECK-GI-NEXT:    mov b31, v12.b[2]
; CHECK-GI-NEXT:    mov v5.h[2], w14
; CHECK-GI-NEXT:    fmov w14, s6
; CHECK-GI-NEXT:    mov b30, v12.b[10]
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov b29, v12.b[3]
; CHECK-GI-NEXT:    mov b28, v12.b[4]
; CHECK-GI-NEXT:    mov v17.h[1], w12
; CHECK-GI-NEXT:    fmov w12, s10
; CHECK-GI-NEXT:    mov b27, v12.b[11]
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    mov b24, v12.b[5]
; CHECK-GI-NEXT:    mov b25, v12.b[12]
; CHECK-GI-NEXT:    mov b19, v12.b[6]
; CHECK-GI-NEXT:    sxtb w8, w8
; CHECK-GI-NEXT:    mov b16, v12.b[7]
; CHECK-GI-NEXT:    mov v5.h[3], w14
; CHECK-GI-NEXT:    fmov w14, s12
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov v17.h[2], w11
; CHECK-GI-NEXT:    fmov w11, s11
; CHECK-GI-NEXT:    mov b22, v12.b[13]
; CHECK-GI-NEXT:    mov b18, v12.b[14]
; CHECK-GI-NEXT:    mov b6, v12.b[15]
; CHECK-GI-NEXT:    mov v0.s[1], wzr
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    ldp d11, d10, [sp, #16] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v5.h[4], w13
; CHECK-GI-NEXT:    fmov w13, s9
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    fmov s9, w14
; CHECK-GI-NEXT:    fmov w14, s23
; CHECK-GI-NEXT:    fmov s23, w12
; CHECK-GI-NEXT:    fmov w12, s26
; CHECK-GI-NEXT:    mov v0.s[2], wzr
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov v9.h[1], w11
; CHECK-GI-NEXT:    fmov w11, s20
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    mov v23.h[1], w13
; CHECK-GI-NEXT:    fmov w13, s13
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov v5.h[5], w14
; CHECK-GI-NEXT:    fmov w14, s21
; CHECK-GI-NEXT:    mov v0.s[3], wzr
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov v23.h[2], w12
; CHECK-GI-NEXT:    fmov w12, s8
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    fmov s20, w13
; CHECK-GI-NEXT:    fmov w13, s31
; CHECK-GI-NEXT:    mov v5.h[6], w14
; CHECK-GI-NEXT:    fmov w14, s7
; CHECK-GI-NEXT:    fmov s7, w10
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov v23.h[3], w11
; CHECK-GI-NEXT:    fmov w11, s30
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov v20.h[1], w12
; CHECK-GI-NEXT:    fmov w12, s29
; CHECK-GI-NEXT:    mov v7.h[1], w9
; CHECK-GI-NEXT:    mov v9.h[2], w13
...
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov v5.h[7], w14
; CHECK-GI-NEXT:    mov v20.h[2], w11
; CHECK-GI-NEXT:    fmov w11, s28
; CHECK-GI-NEXT:    mov v7.h[2], w8
; CHECK-GI-NEXT:    mov v9.h[3], w12
...
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    mov v17.h[3], w12
; CHECK-GI-NEXT:    fmov w12, s24
; CHECK-GI-NEXT:    mov v9.h[4], w10
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    ldrb w10, [x1, #4]
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    sxtb w8, w8
; CHECK-GI-NEXT:    mov v20.h[3], w11
; CHECK-GI-NEXT:    fmov w11, s4
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mov v7.h[4], w14
; CHECK-GI-NEXT:    ldrb w14, [x1, #6]
; CHECK-GI-NEXT:    mov v9.h[5], w12
; CHECK-GI-NEXT:    fmov w12, s25
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    mov v17.h[4], w10
; CHECK-GI-NEXT:    fmov w10, s3
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    mov v23.h[4], w11
; CHECK-GI-NEXT:    fmov w11, s19
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mov v7.h[5], w9
; CHECK-GI-NEXT:    ldrb w9, [x1, #7]
; CHECK-GI-NEXT:    mov v20.h[4], w12
; CHECK-GI-NEXT:    fmov w12, s22
; CHECK-GI-NEXT:    mov v17.h[5], w13
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    fmov w13, s18
; CHECK-GI-NEXT:    mov v23.h[5], w10
; CHECK-GI-NEXT:    fmov w10, s16
; CHECK-GI-NEXT:    mov v9.h[6], w11
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    ldrb w11, [x0, #7]
; CHECK-GI-NEXT:    sxtb w13, w13
...
; CHECK-GI-NEXT:    mov v23.h[6], w12
; CHECK-GI-NEXT:    fmov w12, s6
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mul v1.8h, v5.8h, v9.8h
; CHECK-GI-NEXT:    ldp d9, d8, [sp, #32] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mul v2.8h, v17.8h, v7.8h
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov v23.h[7], w10
; CHECK-GI-NEXT:    ldrsb w10, [x0, #8]
; CHECK-GI-NEXT:    smov w8, v1.h[0]
; CHECK-GI-NEXT:    mov v20.h[7], w12
; CHECK-GI-NEXT:    smov w9, v1.h[1]
; CHECK-GI-NEXT:    smov w11, v1.h[4]
; CHECK-GI-NEXT:    smov w12, v1.h[5]
; CHECK-GI-NEXT:    smov w16, v2.h[0]
; CHECK-GI-NEXT:    fmov s4, w8
; CHECK-GI-NEXT:    mul v3.8h, v23.8h, v20.8h
; CHECK-GI-NEXT:    smov w8, v1.h[2]
; CHECK-GI-NEXT:    fmov s5, w11
; CHECK-GI-NEXT:    smov w11, v2.h[4]
; CHECK-GI-NEXT:    fmov s16, w16
; CHECK-GI-NEXT:    mov v4.s[1], w9
; CHECK-GI-NEXT:    ldrsb w9, [x1, #8]
; CHECK-GI-NEXT:    smov w13, v3.h[0]
; CHECK-GI-NEXT:    smov w15, v3.h[4]
; CHECK-GI-NEXT:    smov w14, v3.h[1]
; CHECK-GI-NEXT:    mul w9, w9, w10
; CHECK-GI-NEXT:    smov w10, v3.h[5]
; CHECK-GI-NEXT:    mov v5.s[1], w12
; CHECK-GI-NEXT:    smov w12, v2.h[5]
; CHECK-GI-NEXT:    fmov s17, w11
; CHECK-GI-NEXT:    smov w11, v2.h[2]
; CHECK-GI-NEXT:    mov v4.s[2], w8
; CHECK-GI-NEXT:    smov w8, v2.h[1]
; CHECK-GI-NEXT:    sxth w9, w9
; CHECK-GI-NEXT:    fmov s6, w13
; CHECK-GI-NEXT:    fmov s7, w15
; CHECK-GI-NEXT:    smov w13, v3.h[2]
; CHECK-GI-NEXT:    fmov s18, w9
; CHECK-GI-NEXT:    mov v17.s[1], w12
; CHECK-GI-NEXT:    smov w12, v2.h[6]
; CHECK-GI-NEXT:    mov v6.s[1], w14
; CHECK-GI-NEXT:    mov v7.s[1], w10
; CHECK-GI-NEXT:    smov w10, v1.h[6]
; CHECK-GI-NEXT:    mov v16.s[1], w8
; CHECK-GI-NEXT:    smov w8, v3.h[6]
; CHECK-GI-NEXT:    smov w9, v1.h[3]
; CHECK-GI-NEXT:    mov v18.s[1], wzr
; CHECK-GI-NEXT:    mov v17.s[2], w12
; CHECK-GI-NEXT:    smov w12, v2.h[7]
; CHECK-GI-NEXT:    mov v5.s[2], w10
; CHECK-GI-NEXT:    smov w10, v1.h[7]
; CHECK-GI-NEXT:    mov v6.s[2], w13
; CHECK-GI-NEXT:    smov w13, v3.h[3]
; CHECK-GI-NEXT:    mov v7.s[2], w8
; CHECK-GI-NEXT:    smov w8, v3.h[7]
; CHECK-GI-NEXT:    mov v16.s[2], w11
