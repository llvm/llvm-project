...
; CHECK-NODOT:       // %bb.0: // %entry
; CHECK-NODOT-NEXT:    adrp x8, .LCPI16_0
; CHECK-NODOT-NEXT:    movi v2.2d, #0000000000000000
; CHECK-NODOT-NEXT:    adrp x9, .LCPI16_2
; CHECK-NODOT-NEXT:    ldr q1, [x8, :lo12:.LCPI16_0]
; CHECK-NODOT-NEXT:    adrp x8, .LCPI16_1
; CHECK-NODOT-NEXT:    adrp x10, .LCPI16_3
; CHECK-NODOT-NEXT:    ldr q3, [x8, :lo12:.LCPI16_1]
; CHECK-NODOT-NEXT:    ldr q4, [x9, :lo12:.LCPI16_2]
; CHECK-NODOT-NEXT:    ldr q5, [x10, :lo12:.LCPI16_3]
; CHECK-NODOT-NEXT:    mov x8, xzr
; CHECK-NODOT-NEXT:  .LBB16_1: // %vector.body
; CHECK-NODOT-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NODOT-NEXT:    ldr q6, [x0, x8]
; CHECK-NODOT-NEXT:    mov v0.16b, v2.16b
; CHECK-NODOT-NEXT:    add x8, x8, #16
; CHECK-NODOT-NEXT:    cmp x8, #16
; CHECK-NODOT-NEXT:    tbl v7.16b, { v6.16b }, v3.16b
; CHECK-NODOT-NEXT:    tbl v16.16b, { v6.16b }, v4.16b
; CHECK-NODOT-NEXT:    tbl v17.16b, { v6.16b }, v5.16b
; CHECK-NODOT-NEXT:    tbl v6.16b, { v6.16b }, v1.16b
; CHECK-NODOT-NEXT:    add v2.4s, v2.4s, v17.4s
; CHECK-NODOT-NEXT:    add v7.4s, v16.4s, v7.4s
; CHECK-NODOT-NEXT:    add v2.4s, v2.4s, v7.4s
; CHECK-NODOT-NEXT:    add v2.4s, v2.4s, v6.4s
...
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    adrp x8, .LCPI16_0
; CHECK-DOT-NEXT:    movi v2.2d, #0000000000000000
; CHECK-DOT-NEXT:    adrp x9, .LCPI16_2
; CHECK-DOT-NEXT:    ldr q1, [x8, :lo12:.LCPI16_0]
; CHECK-DOT-NEXT:    adrp x8, .LCPI16_1
; CHECK-DOT-NEXT:    adrp x10, .LCPI16_3
; CHECK-DOT-NEXT:    ldr q3, [x8, :lo12:.LCPI16_1]
; CHECK-DOT-NEXT:    ldr q4, [x9, :lo12:.LCPI16_2]
; CHECK-DOT-NEXT:    ldr q5, [x10, :lo12:.LCPI16_3]
; CHECK-DOT-NEXT:    mov x8, xzr
; CHECK-DOT-NEXT:  .LBB16_1: // %vector.body
; CHECK-DOT-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-DOT-NEXT:    ldr q6, [x0, x8]
; CHECK-DOT-NEXT:    mov v0.16b, v2.16b
; CHECK-DOT-NEXT:    add x8, x8, #16
; CHECK-DOT-NEXT:    cmp x8, #16
; CHECK-DOT-NEXT:    tbl v7.16b, { v6.16b }, v3.16b
; CHECK-DOT-NEXT:    tbl v16.16b, { v6.16b }, v4.16b
; CHECK-DOT-NEXT:    tbl v17.16b, { v6.16b }, v5.16b
; CHECK-DOT-NEXT:    tbl v6.16b, { v6.16b }, v1.16b
; CHECK-DOT-NEXT:    add v2.4s, v2.4s, v17.4s
; CHECK-DOT-NEXT:    add v7.4s, v16.4s, v7.4s
; CHECK-DOT-NEXT:    add v2.4s, v2.4s, v7.4s
; CHECK-DOT-NEXT:    add v2.4s, v2.4s, v6.4s
...
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    adrp x8, .LCPI16_0
; CHECK-DOT-I8MM-NEXT:    movi v2.2d, #0000000000000000
; CHECK-DOT-I8MM-NEXT:    adrp x9, .LCPI16_2
; CHECK-DOT-I8MM-NEXT:    ldr q1, [x8, :lo12:.LCPI16_0]
; CHECK-DOT-I8MM-NEXT:    adrp x8, .LCPI16_1
; CHECK-DOT-I8MM-NEXT:    adrp x10, .LCPI16_3
; CHECK-DOT-I8MM-NEXT:    ldr q3, [x8, :lo12:.LCPI16_1]
; CHECK-DOT-I8MM-NEXT:    ldr q4, [x9, :lo12:.LCPI16_2]
; CHECK-DOT-I8MM-NEXT:    ldr q5, [x10, :lo12:.LCPI16_3]
; CHECK-DOT-I8MM-NEXT:    mov x8, xzr
; CHECK-DOT-I8MM-NEXT:  .LBB16_1: // %vector.body
; CHECK-DOT-I8MM-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-DOT-I8MM-NEXT:    ldr q6, [x0, x8]
; CHECK-DOT-I8MM-NEXT:    mov v0.16b, v2.16b
; CHECK-DOT-I8MM-NEXT:    add x8, x8, #16
; CHECK-DOT-I8MM-NEXT:    cmp x8, #16
; CHECK-DOT-I8MM-NEXT:    tbl v7.16b, { v6.16b }, v3.16b
; CHECK-DOT-I8MM-NEXT:    tbl v16.16b, { v6.16b }, v4.16b
; CHECK-DOT-I8MM-NEXT:    tbl v17.16b, { v6.16b }, v5.16b
; CHECK-DOT-I8MM-NEXT:    tbl v6.16b, { v6.16b }, v1.16b
; CHECK-DOT-I8MM-NEXT:    add v2.4s, v2.4s, v17.4s
; CHECK-DOT-I8MM-NEXT:    add v7.4s, v16.4s, v7.4s
; CHECK-DOT-I8MM-NEXT:    add v2.4s, v2.4s, v7.4s
; CHECK-DOT-I8MM-NEXT:    add v2.4s, v2.4s, v6.4s
...
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: not_udot:
; CHECK-DOT:       // %bb.0:
; CHECK-DOT-NEXT:    umull v1.8h, v2.8b, v1.8b
; CHECK-DOT-NEXT:    uaddw v0.4s, v0.4s, v1.4h
; CHECK-DOT-NEXT:    uaddw2 v0.4s, v0.4s, v1.8h
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: not_udot:
; CHECK-DOT-I8MM:       // %bb.0:
; CHECK-DOT-I8MM-NEXT:    umull v1.8h, v2.8b, v1.8b
; CHECK-DOT-I8MM-NEXT:    uaddw v0.4s, v0.4s, v1.4h
; CHECK-DOT-I8MM-NEXT:    uaddw2 v0.4s, v0.4s, v1.8h
; CHECK-DOT-I8MM-NEXT:    ret
  %u.wide = zext <8 x i8> %u to <8 x i32>
  %s.wide = zext <8 x i8> %s to <8 x i32>
  %mult = mul nuw nsw <8 x i32> %s.wide, %u.wide
...
; CHECK-NODOT:       // %bb.0:
; CHECK-NODOT-NEXT:    bic v1.4h, #255, lsl #8
; CHECK-NODOT-NEXT:    bic v2.4h, #255, lsl #8
; CHECK-NODOT-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-NODOT-NEXT:    umull v3.4s, v2.4h, v1.4h
; CHECK-NODOT-NEXT:    umlal v0.4s, v2.4h, v1.4h
; CHECK-NODOT-NEXT:    ext v1.16b, v3.16b, v3.16b, #8
; CHECK-NODOT-NEXT:    add v0.2s, v1.2s, v0.2s
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: not_udot_narrow:
; CHECK-DOT:       // %bb.0:
; CHECK-DOT-NEXT:    bic v1.4h, #255, lsl #8
; CHECK-DOT-NEXT:    bic v2.4h, #255, lsl #8
; CHECK-DOT-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-DOT-NEXT:    umull v3.4s, v2.4h, v1.4h
; CHECK-DOT-NEXT:    umlal v0.4s, v2.4h, v1.4h
; CHECK-DOT-NEXT:    ext v1.16b, v3.16b, v3.16b, #8
; CHECK-DOT-NEXT:    add v0.2s, v1.2s, v0.2s
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: not_udot_narrow:
; CHECK-DOT-I8MM:       // %bb.0:
; CHECK-DOT-I8MM-NEXT:    bic v1.4h, #255, lsl #8
; CHECK-DOT-I8MM-NEXT:    bic v2.4h, #255, lsl #8
; CHECK-DOT-I8MM-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-DOT-I8MM-NEXT:    umull v3.4s, v2.4h, v1.4h
; CHECK-DOT-I8MM-NEXT:    umlal v0.4s, v2.4h, v1.4h
; CHECK-DOT-I8MM-NEXT:    ext v1.16b, v3.16b, v3.16b, #8
; CHECK-DOT-I8MM-NEXT:    add v0.2s, v1.2s, v0.2s
; CHECK-DOT-I8MM-NEXT:    ret
...
; CHECK-NODOT-NEXT:    ushll2 v2.4s, v2.8h, #0
; CHECK-NODOT-NEXT:    umlal v0.2d, v3.2s, v4.2s
; CHECK-NODOT-NEXT:    umlal2 v0.2d, v3.4s, v4.4s
; CHECK-NODOT-NEXT:    umlal v0.2d, v1.2s, v2.2s
; CHECK-NODOT-NEXT:    umlal2 v0.2d, v1.4s, v2.4s
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: udot_different_types:
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    ushll v2.8h, v2.8b, #0
; CHECK-DOT-NEXT:    ushll v3.4s, v1.4h, #0
; CHECK-DOT-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-DOT-NEXT:    ushll v4.4s, v2.4h, #0
; CHECK-DOT-NEXT:    ushll2 v2.4s, v2.8h, #0
; CHECK-DOT-NEXT:    umlal v0.2d, v3.2s, v4.2s
; CHECK-DOT-NEXT:    umlal2 v0.2d, v3.4s, v4.4s
; CHECK-DOT-NEXT:    umlal v0.2d, v1.2s, v2.2s
; CHECK-DOT-NEXT:    umlal2 v0.2d, v1.4s, v2.4s
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: udot_different_types:
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    ushll v2.8h, v2.8b, #0
; CHECK-DOT-I8MM-NEXT:    ushll v3.4s, v1.4h, #0
; CHECK-DOT-I8MM-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-DOT-I8MM-NEXT:    ushll v4.4s, v2.4h, #0
; CHECK-DOT-I8MM-NEXT:    ushll2 v2.4s, v2.8h, #0
; CHECK-DOT-I8MM-NEXT:    umlal v0.2d, v3.2s, v4.2s
; CHECK-DOT-I8MM-NEXT:    umlal2 v0.2d, v3.4s, v4.4s
; CHECK-DOT-I8MM-NEXT:    umlal v0.2d, v1.2s, v2.2s
; CHECK-DOT-I8MM-NEXT:    umlal2 v0.2d, v1.4s, v2.4s
; CHECK-DOT-I8MM-NEXT:    ret
entry:
...
; CHECK-NODOT-LABEL: sdot_different_types:
; CHECK-NODOT:       // %bb.0: // %entry
; CHECK-NODOT-NEXT:    sshll v2.8h, v2.8b, #0
...
; CHECK-NODOT-NEXT:    sshll2 v2.4s, v2.8h, #0
; CHECK-NODOT-NEXT:    smlal v0.2d, v3.2s, v4.2s
; CHECK-NODOT-NEXT:    smlal2 v0.2d, v3.4s, v4.4s
; CHECK-NODOT-NEXT:    smlal v0.2d, v1.2s, v2.2s
; CHECK-NODOT-NEXT:    smlal2 v0.2d, v1.4s, v2.4s
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: sdot_different_types:
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    sshll v2.8h, v2.8b, #0
; CHECK-DOT-NEXT:    sshll v3.4s, v1.4h, #0
; CHECK-DOT-NEXT:    sshll2 v1.4s, v1.8h, #0
; CHECK-DOT-NEXT:    sshll v4.4s, v2.4h, #0
; CHECK-DOT-NEXT:    sshll2 v2.4s, v2.8h, #0
; CHECK-DOT-NEXT:    smlal v0.2d, v3.2s, v4.2s
; CHECK-DOT-NEXT:    smlal2 v0.2d, v3.4s, v4.4s
; CHECK-DOT-NEXT:    smlal v0.2d, v1.2s, v2.2s
; CHECK-DOT-NEXT:    smlal2 v0.2d, v1.4s, v2.4s
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: sdot_different_types:
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    sshll v2.8h, v2.8b, #0
; CHECK-DOT-I8MM-NEXT:    sshll v3.4s, v1.4h, #0
; CHECK-DOT-I8MM-NEXT:    sshll2 v1.4s, v1.8h, #0
; CHECK-DOT-I8MM-NEXT:    sshll v4.4s, v2.4h, #0
; CHECK-DOT-I8MM-NEXT:    sshll2 v2.4s, v2.8h, #0
; CHECK-DOT-I8MM-NEXT:    smlal v0.2d, v3.2s, v4.2s
; CHECK-DOT-I8MM-NEXT:    smlal2 v0.2d, v3.4s, v4.4s
; CHECK-DOT-I8MM-NEXT:    smlal v0.2d, v1.2s, v2.2s
; CHECK-DOT-I8MM-NEXT:    smlal2 v0.2d, v1.4s, v2.4s
; CHECK-DOT-I8MM-NEXT:    ret
entry:
...
; CHECK-NODOT-LABEL: usdot_different_types:
; CHECK-NODOT:       // %bb.0: // %entry
; CHECK-NODOT-NEXT:    sshll v2.8h, v2.8b, #0
; CHECK-NODOT-NEXT:    ushll v3.4s, v1.4h, #0
; CHECK-NODOT-NEXT:    ushll2 v1.4s, v1.8h, #0
...
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: usdot_different_types:
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    sshll v2.8h, v2.8b, #0
; CHECK-DOT-NEXT:    ushll v3.4s, v1.4h, #0
; CHECK-DOT-NEXT:    ushll2 v1.4s, v1.8h, #0
...
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: usdot_different_types:
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    sshll v2.8h, v2.8b, #0
; CHECK-DOT-I8MM-NEXT:    ushll v3.4s, v1.4h, #0
; CHECK-DOT-I8MM-NEXT:    ushll2 v1.4s, v1.8h, #0
...
; CHECK-NODOT-LABEL: sudot_different_types:
; CHECK-NODOT:       // %bb.0: // %entry
; CHECK-NODOT-NEXT:    ushll v2.8h, v2.8b, #0
; CHECK-NODOT-NEXT:    sshll v3.4s, v1.4h, #0
; CHECK-NODOT-NEXT:    sshll2 v1.4s, v1.8h, #0
...
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: sudot_different_types:
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    ushll v2.8h, v2.8b, #0
; CHECK-DOT-NEXT:    sshll v3.4s, v1.4h, #0
; CHECK-DOT-NEXT:    sshll2 v1.4s, v1.8h, #0
...
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: sudot_different_types:
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    ushll v2.8h, v2.8b, #0
; CHECK-DOT-I8MM-NEXT:    sshll v3.4s, v1.4h, #0
; CHECK-DOT-I8MM-NEXT:    sshll2 v1.4s, v1.8h, #0
...
; CHECK-NODOT-NEXT:    ret
;
; CHECK-DOT-LABEL: udot_16to64:
; CHECK-DOT:       // %bb.0: // %entry
; CHECK-DOT-NEXT:    ushll v2.4s, v1.4h, #0
; CHECK-DOT-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-DOT-NEXT:    uaddw v0.2d, v0.2d, v2.2s
; CHECK-DOT-NEXT:    uaddw2 v0.2d, v0.2d, v2.4s
; CHECK-DOT-NEXT:    uaddw v0.2d, v0.2d, v1.2s
; CHECK-DOT-NEXT:    uaddw2 v0.2d, v0.2d, v1.4s
; CHECK-DOT-NEXT:    ret
;
; CHECK-DOT-I8MM-LABEL: udot_16to64:
; CHECK-DOT-I8MM:       // %bb.0: // %entry
; CHECK-DOT-I8MM-NEXT:    ushll v2.4s, v1.4h, #0
; CHECK-DOT-I8MM-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-DOT-I8MM-NEXT:    uaddw v0.2d, v0.2d, v2.2s
; CHECK-DOT-I8MM-NEXT:    uaddw2 v0.2d, v0.2d, v2.4s
; CHECK-DOT-I8MM-NEXT:    uaddw v0.2d, v0.2d, v1.2s
; CHECK-DOT-I8MM-NEXT:    uaddw2 v0.2d, v0.2d, v1.4s
; CHECK-DOT-I8MM-NEXT:    ret
entry:
