...
; RUN: llc -mtriple=aarch64-linux --enable-no-signed-zeros-fp-math -mattr=+sve < %s | FileCheck %s
; RUN: llc -mtriple=aarch64-linux -mattr=+sve < %s | FileCheck %s --check-prefix=SIGNED-ZEROS
