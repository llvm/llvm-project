...
; CHECK-SD-NEXT:    mov w13, #100 // =0x64
; CHECK-SD-NEXT:    msub w9, w9, w13, w12
; CHECK-SD-NEXT:    asr x12, x11, #37
; CHECK-SD-NEXT:    msub w10, w10, w13, w15
; CHECK-SD-NEXT:    fmov s0, w9
; CHECK-SD-NEXT:    add x9, x12, x11, lsr #63
; CHECK-SD-NEXT:    smov w11, v1.h[2]
; CHECK-SD-NEXT:    msub w9, w9, w13, w11
; CHECK-SD-NEXT:    mov v0.h[1], w10
; CHECK-SD-NEXT:    asr x10, x8, #37
; CHECK-SD-NEXT:    add x8, x10, x8, lsr #63
; CHECK-SD-NEXT:    smov w10, v1.h[3]
; CHECK-SD-NEXT:    mov v0.h[2], w9
; CHECK-SD-NEXT:    msub w8, w8, w13, w10
; CHECK-SD-NEXT:    mov v0.h[3], w8
; CHECK-SD-NEXT:    // kill: def $d0 killed $d0 killed $q0
; CHECK-SD-NEXT:    ret
;
