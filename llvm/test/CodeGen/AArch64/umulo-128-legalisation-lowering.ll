; NOTE: Assertions have been autogenerated by utils/update_llc_test_checks.py UTC_ARGS: --function __muloti4
...
; AARCH-NEXT:    ccmp x10, #0, #0, eq
; AARCH-NEXT:    umulh x11, x0, x2
; AARCH-NEXT:    ccmp x8, #0, #0, eq
