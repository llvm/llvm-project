...
; CHECK-SD-LABEL: signed_minmax_v4i64_to_v8i32:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    sqshrn v0.2s, v0.2d, #5
; CHECK-SD-NEXT:    sqshrn2 v0.4s, v1.2d, #5
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: signed_minmax_v4i64_to_v8i32:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    adrp x8, .LCPI27_1
; CHECK-GI-NEXT:    sshr v0.2d, v0.2d, #5
; CHECK-GI-NEXT:    sshr v1.2d, v1.2d, #5
; CHECK-GI-NEXT:    ldr q2, [x8, :lo12:.LCPI27_1]
...
; CHECK-SD-LABEL: unsigned_minmax_v4i64_to_v8i32:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    uqshrn v0.2s, v0.2d, #5
; CHECK-SD-NEXT:    uqshrn2 v0.4s, v1.2d, #5
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: unsigned_minmax_v4i64_to_v8i32:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    movi v2.2d, #0x000000ffffffff
; CHECK-GI-NEXT:    ushr v0.2d, v0.2d, #5
; CHECK-GI-NEXT:    ushr v1.2d, v1.2d, #5
...
; CHECK-SD-LABEL: unsigned_signed_minmax_v4i64_to_v8i32:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    sqshrun v0.2s, v0.2d, #5
; CHECK-SD-NEXT:    sqshrun2 v0.4s, v1.2d, #5
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: unsigned_signed_minmax_v4i64_to_v8i32:
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    sshr v0.2d, v0.2d, #5
; CHECK-GI-NEXT:    sshr v1.2d, v1.2d, #5
; CHECK-GI-NEXT:    movi v2.2d, #0x000000ffffffff
