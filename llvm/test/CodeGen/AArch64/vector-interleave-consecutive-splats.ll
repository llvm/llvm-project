...
; CHECK-NEXT:    dup v2.8h, v0.h[1]
; CHECK-NEXT:    dup v3.8h, v0.h[0]
; CHECK-NEXT:    dup v0.8h, v0.h[3]
; CHECK-NEXT:    zip2 v5.8h, v3.8h, v1.8h
; CHECK-NEXT:    zip1 v1.8h, v3.8h, v1.8h
; CHECK-NEXT:    zip2 v4.8h, v2.8h, v0.8h
; CHECK-NEXT:    zip1 v0.8h, v2.8h, v0.8h
; CHECK-NEXT:    zip1 v2.8h, v5.8h, v4.8h
; CHECK-NEXT:    zip2 v3.8h, v5.8h, v4.8h
; CHECK-NEXT:    zip1 v4.8h, v1.8h, v0.8h
; CHECK-NEXT:    zip2 v0.8h, v1.8h, v0.8h
