...
; CHECK-NEXT:    mov w10, #1267 // =0x4f3
; CHECK-NEXT:    fmov s1, #1.00000000
; CHECK-NEXT:    fmov d2, #5.00000000
; CHECK-NEXT:    ubfiz x9, x3, #2, #32
; CHECK-NEXT:    mov x8, xzr
; CHECK-NEXT:    movk w10, #16309, lsl #16
; CHECK-NEXT:    fmov s0, w10
; CHECK-NEXT:    mov w10, #16 // =0x10
; CHECK-NEXT:    .p2align 5, , 16
; CHECK-NEXT:  .LBB0_2: // %for.body
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ldr s4, [x1, x8]
; CHECK-NEXT:    ldr w11, [x0, x8]
; CHECK-NEXT:    add w11, w11, #10
; CHECK-NEXT:    scvtf d3, w11
; CHECK-NEXT:    fmadd s4, s4, s0, s1
; CHECK-NEXT:    fabs s4, s4
; CHECK-NEXT:    fcvt d4, s4
; CHECK-NEXT:    fdiv d3, d3, d4
; CHECK-NEXT:    fcmp d3, d2
; CHECK-NEXT:    csel x11, x10, xzr, lt
; CHECK-NEXT:    ldr s3, [x4, x11]
; CHECK-NEXT:    fcvtzs s3, s3
; CHECK-NEXT:    str s3, [x2, x8]
