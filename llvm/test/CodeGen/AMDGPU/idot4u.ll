...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr6_hi16 killed $sgpr0 killed $exec
...
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 8, v4
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v3.l
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v4.l
...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr5_hi16 killed $sgpr0 killed $exec
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr7_hi16 killed $sgpr0 killed $exec
...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
