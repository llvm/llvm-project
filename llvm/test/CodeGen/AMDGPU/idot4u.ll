...
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-DL-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 8, v0.l
; GFX11-DL-TRUE16-NEXT:    v_or_b16 v0.h, v0.h, v1.l
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v1
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)
