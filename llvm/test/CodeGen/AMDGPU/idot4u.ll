...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s4, v0, v1
...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v2, s0, v1, v0
...
; GFX9-DL-NEXT:    v_dot4_u32_u8 v2, s0, v0, v1
...
; GFX10-DL-NEXT:    v_dot4_u32_u8 v2, s4, s5, v2
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s1, s5, s0
; GFX10-DL-NEXT:    s_and_b32 s0, s4, s0
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s5, 0x80008
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v2, s5, s4, v2
; GFX10-DL-NEXT:    global_store_byte v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
                                                      <4 x i8> addrspace(1)* %src2,
                                                      i8 addrspace(1)* nocapture %dst) {
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x80008
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x80008
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s0, v2
; GFX10-DL-NEXT:    s_and_b32 s0, s4, s2
; GFX10-DL-NEXT:    s_and_b32 s1, s5, s2
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s0, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x80010
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x80010
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s1, s0, v2
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s10
; GFX9-NODL-NEXT:    s_bfe_u32 s6, s0, 0x80008
; GFX9-NODL-NEXT:    v_mad_u32_u24 v1, s4, v0, v1
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, s4, v0, v1
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s4, v0, v1
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v2, s0, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s0, v2, v0
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s0, v2, v0
...
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_sext_i32_i8 s0, s4
; GFX10-DL-NEXT:    s_sext_i32_i8 s1, s5
...
; GFX9-NODL-NEXT:    v_and_b32_sdwa v4, v0, s1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-NODL-NEXT:    v_lshrrev_b16_e64 v2, 8, s1
; GFX9-NODL-NEXT:    v_lshrrev_b16_e64 v1, 8, s0
; GFX9-NODL-NEXT:    v_and_b32_sdwa v0, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX9-DL-NEXT:    v_and_b32_sdwa v4, v0, s1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-DL-NEXT:    v_lshrrev_b16_e64 v2, 8, s1
; GFX9-DL-NEXT:    v_lshrrev_b16_e64 v1, 8, s0
; GFX9-DL-NEXT:    v_and_b32_sdwa v0, v0, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v4, 8, s4
; GFX10-DL-NEXT:    v_and_b32_sdwa v7, v3, s4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v5, 8, s5
; GFX10-DL-NEXT:    v_and_b32_sdwa v6, v3, s5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX10-DL-NEXT:    s_lshr_b32 s0, s5, 16
; GFX10-DL-NEXT:    s_lshr_b32 s1, s4, 16
; GFX10-DL-NEXT:    v_lshl_or_b32 v4, v4, 16, v7
; GFX10-DL-NEXT:    v_lshl_or_b32 v5, v5, 16, v6
; GFX10-DL-NEXT:    v_and_b32_sdwa v6, v3, s0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX10-DL-NEXT:    v_and_b32_sdwa v3, v3, s1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX10-DL-NEXT:    s_lshr_b32 s1, s4, 24
; GFX10-DL-NEXT:    s_lshr_b32 s0, s5, 24
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v4, v4, v5
; GFX10-DL-NEXT:    v_lshl_or_b32 v5, s0, 16, v6
; GFX10-DL-NEXT:    v_lshl_or_b32 v3, s1, 16, v3
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NODL-NEXT:    v_mul_lo_u16_e32 v0, s0, v0
; GFX9-NODL-NEXT:    v_mul_lo_u16_sdwa v1, s0, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-DL-NEXT:    v_mul_lo_u16_e32 v0, s0, v0
; GFX9-DL-NEXT:    v_mul_lo_u16_sdwa v1, s0, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v3, 8, s4
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v4, 8, s5
; GFX10-DL-NEXT:    s_lshr_b32 s0, s4, 24
; GFX10-DL-NEXT:    s_lshr_b32 s1, s5, 24
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v5, s0, s1
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v3, v3, v4
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s4, s5
; GFX10-DL-NEXT:    s_lshr_b32 s0, s4, 16
; GFX10-DL-NEXT:    s_lshr_b32 s1, s5, 16
