...
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_clz_i32_u32 s6, 0
; GFX1164-NEXT:    s_bcnt1_i32_b64 s2, s[0:1]
; GFX1164-NEXT:    s_min_u32 s6, s6, 32
; GFX1164-NEXT:    v_mov_b32_e32 v1, 0
; GFX1164-NEXT:    s_lshl_b64 s[0:1], s[2:3], s6
; GFX1164-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24
; GFX1164-NEXT:    s_min_u32 s0, s0, 1
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_or_b32 s0, s1, s0
; GFX1164-NEXT:    v_cvt_f32_u32_e32 v0, s0
; GFX1164-NEXT:    s_sub_i32 s0, 32, s6
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    v_ldexp_f32 v0, v0, s0
...
; GFX1164-DPP-NEXT:    s_clz_i32_u32 s6, 0
; GFX1164-DPP-NEXT:    s_bcnt1_i32_b64 s2, s[0:1]
; GFX1164-DPP-NEXT:    s_min_u32 s6, s6, 32
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v1, 0
; GFX1164-DPP-NEXT:    s_lshl_b64 s[0:1], s[2:3], s6
; GFX1164-DPP-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24
; GFX1164-DPP-NEXT:    s_min_u32 s0, s0, 1
; GFX1164-DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    s_or_b32 s0, s1, s0
; GFX1164-DPP-NEXT:    v_cvt_f32_u32_e32 v0, s0
; GFX1164-DPP-NEXT:    s_sub_i32 s0, 32, s6
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1164-DPP-NEXT:    v_ldexp_f32 v0, v0, s0
