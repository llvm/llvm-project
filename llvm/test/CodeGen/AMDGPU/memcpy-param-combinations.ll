...
; CHECK-NEXT:    flat_load_dwordx2 v[10:11], v[2:3] offset:16
...
; CHECK-NEXT:    flat_store_dwordx2 v[0:1], v[10:11] offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx2 v[10:11], v[2:3], off offset:16
...
; CHECK-NEXT:    global_load_dwordx2 v[10:11], v[2:3], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx2 v[0:1], v[10:11] offset:23
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[8:11] offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx2 v[0:1], v[10:11], off offset:16
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx2 v[10:11], v[2:3], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx2 v[0:1], v[10:11], off offset:23
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v[2:3], off offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[0:1], v[8:11], off offset:15
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dwordx4 v[9:12], v[1:2]
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    ds_write_b64 v0, v[5:6] offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(2)
; CHECK-NEXT:    ds_write_b64 v0, v[7:8] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(2)
; CHECK-NEXT:    ds_write2_b64 v0, v[9:10], v[11:12] offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx2 v[9:10], v[1:2], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    ds_write2_b64 v0, v[3:4], v[5:6] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    ds_write_b64 v0, v[7:8] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ds_write_b64 v0, v[9:10] offset:23
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v12, v0, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v11, v0, s[0:3], 0 offen offset:8
