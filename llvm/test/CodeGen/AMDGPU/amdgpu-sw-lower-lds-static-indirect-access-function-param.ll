...
;define void @my_function1() sanitize_address {
;
;  %lds_val = load i32, ptr addrspace(3) @lds_var, align 4
;  %new_lds_val = add i32 %lds_val, 1
;  store i32 %new_lds_val, ptr addrspace(3) @lds_var, align 4
;  ret void
;}
