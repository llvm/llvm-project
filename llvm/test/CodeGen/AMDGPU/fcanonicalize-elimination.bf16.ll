...
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 %s -o - | FileCheck -check-prefixes=GCN,FAKE16 %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 %s -o - | FileCheck -check-prefixes=GCN,REAL16 %s
