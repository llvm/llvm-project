...
; SI-NEXT:    s_andn2_b64 s[8:9], exec, s[4:5]
; SI-NEXT:    v_mov_b32_e32 v1, v2
; SI-NEXT:    s_cselect_b64 exec, s[8:9], s[4:5]
...
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX9-NEXT:    s_andn2_b64 s[6:7], exec, s[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    s_cselect_b64 exec, s[6:7], s[2:3]
