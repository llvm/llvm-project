...
; GFX8-NEXT:    s_lshr_b32 s4, s5, 24
; GFX8-NEXT:    s_lshr_b32 s5, s2, 24
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshl_b64 s[2:3], s[0:1], 8
; GFX8-NEXT:    s_add_u32 s0, s10, 13
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 15
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 14
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 8
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 11
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 10
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 4
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 6
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 1
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_add_u32 s0, s10, 3
; GFX8-NEXT:    flat_store_byte v[0:1], v2
...
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 9
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
; GFX8-NEXT:    s_addc_u32 s2, s11, 0
; GFX8-NEXT:    flat_store_byte v[0:1], v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s10, 2
; GFX8-NEXT:    v_mov_b32_e32 v1, s2
