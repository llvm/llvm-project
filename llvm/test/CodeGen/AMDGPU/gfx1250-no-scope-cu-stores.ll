...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -O3 -mcpu=gfx1251 < %s | FileCheck --check-prefixes=GCN,CU %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -O3 -mcpu=gfx1251 -mattr=-cu-stores < %s | FileCheck --check-prefixes=GCN,NOCU %s
