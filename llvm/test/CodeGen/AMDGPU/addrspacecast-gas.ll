...
; GFX1250-LABEL: use_private_to_flat_addrspacecast:
; GFX1250:       ; %bb.0:
...
; GFX1250-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_lshlrev_b32 v1, 20, v0
; GFX1250-NEXT:    s_cmp_lg_u32 s0, -1
; GFX1250-NEXT:    s_cselect_b32 vcc_lo, -1, 0
; GFX1250-NEXT:    v_add_nc_u64_e32 v[0:1], src_flat_scratch_base_lo, v[0:1]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_cndmask_b32 v1, 0, v1
...
; GFX1250-LABEL: use_private_to_flat_addrspacecast_nonnull:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_load_b32 s0, s[4:5], 0x24 nv
; GFX1250-NEXT:    v_mbcnt_lo_u32_b32 v0, -1, 0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_lshlrev_b32 v1, 20, v0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
