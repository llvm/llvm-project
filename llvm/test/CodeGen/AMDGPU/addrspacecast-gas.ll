...
; GFX1210-SDAG-NEXT:    v_mbcnt_lo_u32_b32 v0, -1, 0
; GFX1210-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_lshlrev_b32 v1, 20, v0
...
; GFX1210-SDAG-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_SYS
...
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)
...
; GFX1300-SDAG:       ; %bb.0:
; GFX1300-SDAG-NEXT:    s_load_b32 s0, s[2:3], 0x24
...
; GFX1300-GISEL:       ; %bb.0:
; GFX1300-GISEL-NEXT:    s_load_b32 s0, s[2:3], 0x24
...
; GFX1210-SDAG-LABEL: use_private_to_flat_addrspacecast_nonnull:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_load_b32 s0, s[2:3], 0x24
; GFX1210-SDAG-NEXT:    v_mbcnt_lo_u32_b32 v0, -1, 0
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_lshlrev_b32 v1, 20, v0
; GFX1210-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX1210-SDAG-NEXT:    v_add_nc_u64_e32 v[0:1], src_flat_scratch_base_lo, v[0:1]
; GFX1210-SDAG-NEXT:    flat_store_b32 v[0:1], v2 scope:SCOPE_SYS
; GFX1210-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1210-SDAG-NEXT:    s_endpgm
;
; GFX1210-GISEL-LABEL: use_private_to_flat_addrspacecast_nonnull:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_load_b32 s0, s[2:3], 0x24
; GFX1210-GISEL-NEXT:    v_mbcnt_lo_u32_b32 v2, -1, 0
; GFX1210-GISEL-NEXT:    v_mov_b64_e32 v[0:1], src_flat_scratch_base_lo
...
; GFX1210-GISEL-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v2, v1, vcc_lo
; GFX1210-GISEL-NEXT:    flat_store_b32 v[0:1], v3 scope:SCOPE_SYS
; GFX1210-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX1210-GISEL-NEXT:    s_endpgm
;
