...
define amdgpu_kernel void @gws_barrier_offset0(i32 %val) #0 {
  ...
  ; GFX6-SDAG-NEXT:   liveins: $sgpr8_9
  ; GFX6-SDAG-NEXT: {{  $}}
  ; GFX6-SDAG-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr8_9, 0, 0 :: (dereferenceable invariant load (s32) from %ir.val.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX6-GISEL-NEXT:   liveins: $sgpr8_9
  ; GFX6-GISEL-NEXT: {{  $}}
  ; GFX6-GISEL-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr8_9, 0, 0 :: (dereferenceable invariant load (i32) from %ir.val.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX9-SDAG-NEXT:   liveins: $sgpr8_9
  ; GFX9-SDAG-NEXT: {{  $}}
  ; GFX9-SDAG-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr8_9, 0, 0 :: (dereferenceable invariant load (s32) from %ir.val.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX9-GISEL-NEXT:   liveins: $sgpr8_9
  ; GFX9-GISEL-NEXT: {{  $}}
  ; GFX9-GISEL-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr8_9, 0, 0 :: (dereferenceable invariant load (i32) from %ir.val.kernarg.offset1, align 16, addrspace 4)
