...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX11-TRUE16-NEXT:    image_sample v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX11-TRUE16-NEXT:    image_sample v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_CUBE a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX11-TRUE16-NEXT:    image_sample v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX11-TRUE16-NEXT:    image_sample_cl v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v1.h, v2.l
; GFX11-TRUE16-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX11-TRUE16-NEXT:    image_sample_b_cl v[0:3], [v0, v1, v3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16:       ; %bb.0: ; %main_body
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v8, v4
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v7, v2
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v6, v0
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v5.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v7.h, v3.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v6.h, v1.l
; GFX11-TRUE16-NEXT:    image_sample_d_g16 v[0:3], v[6:8], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX12PLUS-TRUE16:       ; %bb.0: ; %main_body
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v9, v6
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v10, v8
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v8, v5
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v9.h, v7.l
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v3.h, v4.l
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX12PLUS-TRUE16-NEXT:    image_sample_d_g16 v[0:3], [v0, v2, v3, v[8:10]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D a16
; GFX12PLUS-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v3.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v0, v2, v4, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX12PLUS-TRUE16:       ; %bb.0: ; %main_body
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v8, v7
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v7, v5
...
; GFX11-TRUE16:       ; %bb.0: ; %main_body
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX11-TRUE16-NEXT:    image_sample_l v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D a16
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v10, v8
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v9, v6
; GFX12PLUS-TRUE16-NEXT:    v_mov_b32_e32 v8, v4
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v9.h, v7.l
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v5.l
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v3.l
; GFX12PLUS-TRUE16-NEXT:    image_sample_c_d_o_g16 v0, [v0, v1, v2, v[8:10]], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX12PLUS-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-TRUE16-NEXT:    ; return to shader part epilog
;
...
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v8.h, v5.l
; GFX12PLUS-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v3.l
; GFX12PLUS-TRUE16-NEXT:    image_sample_c_d_o_g16 v[0:1], [v0, v1, v2, v[8:10]], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX12PLUS-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-TRUE16-NEXT:    ; return to shader part epilog
;
