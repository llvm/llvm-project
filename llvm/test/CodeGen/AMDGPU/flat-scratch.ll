...
; RUN: llc -march=amdgcn -mcpu=gfx1200 -mattr=-promote-alloca -mattr=+enable-flat-scratch -verify-machineinstrs < %s | FileCheck --check-prefix=GFX12 %s
...
; GFX12-NEXT:    v_sub_nc_u32_e32 v1, 4, v0
; GFX12-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_add_nc_u32 v1, 0x7c, v1
; GFX12-NEXT:    scratch_store_b32 v0, v2, off offset:4 th:TH_STORE_NT_RT
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    scratch_load_b32 v0, v1, off th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_endpgm
;
...
; GFX12-PAL-NEXT:    v_sub_nc_u32_e32 v1, 4, v0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_add_nc_u32 v1, 0x7c, v1
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v2, off offset:4 th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_b32 v0, v1, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v1, 0x41200000 :: v_dual_add_nc_u32 v0, 4, v0
; GFX12-NEXT:    scratch_store_b32 v0, v1, off
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-PAL-NEXT:    s_wait_bvhcnt 0x0
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v1, 0x41200000 :: v_dual_add_nc_u32 v0, 4, v0
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v1, off
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_sub_nc_u32_e32 v1, 0x104, v0
...
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    v_sub_nc_u32_e32 v1, 0x104, v0
; GFX12-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-PAL-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_add_nc_u32 v1, 0x7c, v1
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v2, off offset:260 th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_b32 v0, v1, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX11-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
; GFX11-NEXT:    scratch_store_b32 v0, v2, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_and_b32 v1, 15, v0
; GFX12-NEXT:    s_add_co_i32 vcc_lo, s32, 0x100
; GFX12-NEXT:    scratch_load_b32 v3, off, s32 th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX12-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
; GFX12-NEXT:    scratch_store_b32 v0, v2, off th:TH_STORE_NT_RT
; GFX12-NEXT:    s_wait_storecnt 0x0
...
; GFX940-NEXT:    v_mov_b32_e32 v1, vcc_hi
; GFX940-NEXT:    v_lshl_add_u32 v1, v0, 2, v1
; GFX940-NEXT:    v_mov_b32_e32 v2, 15
; GFX940-NEXT:    v_and_b32_e32 v0, 15, v0
; GFX940-NEXT:    scratch_store_dword v1, v2, off sc0 sc1
...
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX11-PAL-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
; GFX11-PAL-NEXT:    scratch_store_b32 v0, v2, off dlc
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_and_b32 v1, 15, v0
; GFX12-PAL-NEXT:    s_add_co_i32 vcc_lo, s32, 0x100
; GFX12-PAL-NEXT:    scratch_load_b32 v3, off, s32 th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX12-PAL-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v2, off th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
...
; GFX12-NEXT:    scratch_load_b32 v3, off, off offset:4 th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_sub_nc_u32_e32 v1, 0x4004, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_add_nc_u32 v1, 0x7c, v1
...
; GFX12-PAL-NEXT:    scratch_load_b32 v3, off, off offset:4 th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    v_sub_nc_u32_e32 v1, 0x4004, v0
; GFX12-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-PAL-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_add_nc_u32 v1, 0x7c, v1
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v2, off offset:16388 th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_b32 v0, v1, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_and_b32 v1, 15, v0
; GFX12-NEXT:    s_add_co_i32 vcc_lo, s32, 0x4000
; GFX12-NEXT:    scratch_load_b32 v3, off, s32 th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX12-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
...
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_add_i32 vcc_lo, s32, 0x4004
; GFX940-NEXT:    v_mov_b32_e32 v1, vcc_lo
; GFX940-NEXT:    v_lshl_add_u32 v1, v0, 2, v1
; GFX940-NEXT:    v_mov_b32_e32 v2, 15
; GFX940-NEXT:    v_and_b32_e32 v0, 15, v0
; GFX940-NEXT:    scratch_store_dword v1, v2, off sc0 sc1
...
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v2, 15 :: v_dual_and_b32 v1, 15, v0
; GFX12-PAL-NEXT:    s_add_co_i32 vcc_lo, s32, 0x4000
; GFX12-PAL-NEXT:    scratch_load_b32 v3, off, s32 th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX12-PAL-NEXT:    v_lshlrev_b32_e32 v1, 2, v1
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_add_i32 s0, s0, vcc_lo
...
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_add_i32 s0, s0, vcc_hi
; GFX940-NEXT:    v_mov_b32_e32 v0, 15
; GFX940-NEXT:    scratch_store_dword off, v0, s0 offset:3712 sc0 sc1
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    scratch_load_dword v0, off, s0 offset:3712 sc0 sc1
...
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_add_i32 s0, s0, vcc_lo
...
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX12-NEXT:    v_mov_b32_e32 v1, 4
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_add_lshl_u32 v0, s0, v0, 2
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add3_u32 v0, v1, v0, 0x400
; GFX12-NEXT:    v_mov_b32_e32 v1, 15
; GFX12-NEXT:    scratch_store_b32 v0, v1, off th:TH_STORE_NT_RT
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    scratch_load_b32 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_endpgm
;
...
; GFX12-PAL:       ; %bb.0: ; %bb
; GFX12-PAL-NEXT:    s_load_b32 s0, s[0:1], 0x0
; GFX12-PAL-NEXT:    v_mov_b32_e32 v1, 4
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_add_lshl_u32 v0, s0, v0, 2
; GFX12-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-PAL-NEXT:    v_add3_u32 v0, v1, v0, 0x400
; GFX12-PAL-NEXT:    v_mov_b32_e32 v1, 15
; GFX12-PAL-NEXT:    scratch_store_b32 v0, v1, off th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_b32 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_add_nc_u32 v0, -1, v0
; GFX12-NEXT:    scratch_store_b8 v0, v1, off th:TH_STORE_NT_RT
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    scratch_load_u8 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-PAL-NEXT:    s_wait_bvhcnt 0x0
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_add_nc_u32 v0, -1, v0
; GFX12-PAL-NEXT:    scratch_store_b8 v0, v1, off th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_u8 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
; GFX12-PAL-NEXT:    s_setpc_b64 s[30:31]
bb:
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_add_nc_u32 v0, 0xffffef7f, v0
; GFX12-NEXT:    scratch_store_b8 v0, v1, off th:TH_STORE_NT_RT
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    scratch_load_u8 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-PAL-NEXT:    s_wait_bvhcnt 0x0
; GFX12-PAL-NEXT:    s_wait_kmcnt 0x0
; GFX12-PAL-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_add_nc_u32 v0, 0xffffef7f, v0
; GFX12-PAL-NEXT:    scratch_store_b8 v0, v1, off th:TH_STORE_NT_RT
; GFX12-PAL-NEXT:    s_wait_storecnt 0x0
; GFX12-PAL-NEXT:    scratch_load_u8 v0, v0, off th:TH_LOAD_RT_NT
; GFX12-PAL-NEXT:    s_wait_loadcnt 0x0
