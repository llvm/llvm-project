...
; GFX10-NEXT:    s_addc_u32 vcc_lo, s32, 0x100
; GFX10-NEXT:    v_mov_b32_e32 v2, 15
; GFX10-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX10-NEXT:    s_bitset0_b32 vcc_lo, 0
...
; GFX10-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x100
; GFX10-PAL-NEXT:    v_mov_b32_e32 v2, 15
; GFX10-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX10-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
...
; GFX9-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi
; GFX9-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX9-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX9-NEXT:    s_bitset0_b32 vcc_hi, 0
; GFX9-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi offset:16
; GFX9-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX9-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX9-NEXT:    s_bitset0_b32 vcc_hi, 0
...
; GFX10-NEXT:    v_mov_b32_e32 v3, s3
; GFX10-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo
; GFX10-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX10-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX10-NEXT:    s_bitset0_b32 vcc_lo, 0
; GFX10-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo offset:16
; GFX10-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
...
; GFX11-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX11-NEXT:    scratch_store_b128 off, v[0:3], vcc_lo
; GFX11-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX11-NEXT:    s_bitset0_b32 vcc_lo, 0
; GFX11-NEXT:    scratch_store_b128 off, v[0:3], vcc_lo offset:16
; GFX11-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX11-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX11-NEXT:    s_bitset0_b32 vcc_lo, 0
...
; GFX9-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi
; GFX9-PAL-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX9-PAL-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX9-PAL-NEXT:    s_bitset0_b32 vcc_hi, 0
; GFX9-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi offset:16
; GFX9-PAL-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX9-PAL-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX9-PAL-NEXT:    s_bitset0_b32 vcc_hi, 0
...
; GFX940-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi
; GFX940-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX940-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX940-NEXT:    s_bitset0_b32 vcc_hi, 0
; GFX940-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_hi offset:16
; GFX940-NEXT:    s_addc_u32 vcc_hi, s32, 0x4004
; GFX940-NEXT:    s_bitcmp1_b32 vcc_hi, 0
; GFX940-NEXT:    s_bitset0_b32 vcc_hi, 0
...
; GFX1010-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo
; GFX1010-PAL-NEXT:    s_waitcnt_depctr 0xffe3
; GFX1010-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX1010-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX1010-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
; GFX1010-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo offset:16
; GFX1010-PAL-NEXT:    s_waitcnt_depctr 0xffe3
; GFX1010-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX1010-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
...
; GFX1030-PAL-NEXT:    v_mov_b32_e32 v3, s3
; GFX1030-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo
; GFX1030-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX1030-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX1030-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
; GFX1030-PAL-NEXT:    scratch_store_dwordx4 off, v[0:3], vcc_lo offset:16
; GFX1030-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX1030-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX1030-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
...
; GFX11-PAL-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX11-PAL-NEXT:    scratch_store_b128 off, v[0:3], vcc_lo
; GFX11-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX11-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
; GFX11-PAL-NEXT:    scratch_store_b128 off, v[0:3], vcc_lo offset:16
; GFX11-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX11-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX11-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
...
; GFX10-PAL-NEXT:    v_and_b32_e32 v1, 15, v0
; GFX10-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, vcc_lo
; GFX10-PAL-NEXT:    s_addc_u32 vcc_lo, s32, 0x4004
; GFX10-PAL-NEXT:    v_mov_b32_e32 v2, 15
; GFX10-PAL-NEXT:    s_bitcmp1_b32 vcc_lo, 0
; GFX10-PAL-NEXT:    s_bitset0_b32 vcc_lo, 0
