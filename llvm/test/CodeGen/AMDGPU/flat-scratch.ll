...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -mattr=-promote-alloca -amdgpu-enable-flat-scratch -verify-machineinstrs < %s | FileCheck -check-prefix=GFX11 %s
...
; RUN: llc -mtriple=amdgcn--amdpal -mcpu=gfx1100 -mattr=-promote-alloca -amdgpu-enable-flat-scratch -verify-machineinstrs < %s | FileCheck -check-prefix=GFX11-PAL %s
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_add_u32 s0, s0, s3
; GFX11-NEXT:    s_addc_u32 s1, s1, 0
; GFX11-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s0
; GFX11-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s1
...
; GFX11-PAL:       ; %bb.0:
; GFX11-PAL-NEXT:    s_getpc_b64 s[2:3]
; GFX11-PAL-NEXT:    s_mov_b32 s2, s0
; GFX11-PAL-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX11-PAL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-PAL-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX11-PAL-NEXT:    s_add_u32 s2, s2, s1
; GFX11-PAL-NEXT:    s_addc_u32 s3, s3, 0
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s2
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s3
...
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_add_u32 s2, s2, s5
; GFX11-NEXT:    s_addc_u32 s3, s3, 0
; GFX11-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s2
; GFX11-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s3
...
; GFX11-NEXT:    s_add_u32 s0, 4, s0
; GFX11-NEXT:    s_add_u32 s1, 4, s1
; GFX11-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL:       ; %bb.0: ; %bb
; GFX11-PAL-NEXT:    s_getpc_b64 s[4:5]
; GFX11-PAL-NEXT:    s_mov_b32 s4, s0
; GFX11-PAL-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX11-PAL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-PAL-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX11-PAL-NEXT:    s_add_u32 s4, s4, s3
; GFX11-PAL-NEXT:    s_addc_u32 s5, s5, 0
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s4
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s5
; GFX11-PAL-NEXT:    s_load_b32 s0, s[0:1], 0x24
...
; GFX11-PAL-NEXT:    s_add_u32 s0, 4, s0
; GFX11-PAL-NEXT:    s_add_u32 s1, 4, s1
; GFX11-PAL-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-NEXT:    scratch_load_b32 v0, off, s0
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_add_nc_u32_e32 v2, v1, v0
; GFX11-NEXT:    v_sub_nc_u32_e32 v0, v1, v0
; GFX11-NEXT:    scratch_store_b32 v2, v3, off
; GFX11-NEXT:    scratch_load_b32 v0, v0, off offset:124
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    v_mov_b32_e32 v3, 15
; GFX11-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-PAL-NEXT:    v_add_nc_u32_e32 v2, v1, v0
; GFX11-PAL-NEXT:    v_sub_nc_u32_e32 v0, v1, v0
; GFX11-PAL-NEXT:    scratch_store_b32 v2, v3, off
; GFX11-PAL-NEXT:    scratch_load_b32 v0, v0, off offset:124
; GFX11-PAL-NEXT:    s_endpgm
bb:
  %i = alloca [32 x float], align 4, addrspace(5)
  %i1 = bitcast [32 x float] addrspace(5)* %i to i8 addrspace(5)*
...
; GFX11-NEXT:    v_mov_b32_e32 v2, s32
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-NEXT:    v_and_b32_e32 v3, v0, v1
; GFX11-NEXT:    v_lshl_add_u32 v0, v0, 2, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_lshl_add_u32 v2, v3, 2, v2
; GFX11-NEXT:    scratch_store_b32 v0, v1, off
; GFX11-NEXT:    scratch_load_b32 v0, v2, off
...
; GFX11-PAL-NEXT:    v_mov_b32_e32 v2, s32
; GFX11-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_2) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-PAL-NEXT:    v_and_b32_e32 v3, v0, v1
; GFX11-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, v2
; GFX11-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-PAL-NEXT:    v_lshl_add_u32 v2, v3, 2, v2
; GFX11-PAL-NEXT:    scratch_store_b32 v0, v1, off
; GFX11-PAL-NEXT:    scratch_load_b32 v0, v2, off
...
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s2
; GFX11-PAL-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s3
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, off offset:4
; GFX11-PAL-NEXT:    s_mov_b32 s0, 0
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_mov_b32 s1, s0
; GFX11-PAL-NEXT:    s_mov_b32 s2, s0
...
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s32
; GFX11-PAL-NEXT:    s_mov_b32 s0, 0
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_mov_b32 s1, s0
; GFX11-PAL-NEXT:    s_mov_b32 s2, s0
...
; GFX11-NEXT:    s_lshl_b32 s0, s0, 2
; GFX11-NEXT:    s_lshl_b32 s1, s1, 2
; GFX11-NEXT:    s_add_u32 s0, 0x104, s0
; GFX11-NEXT:    s_add_u32 s1, 0x104, s1
; GFX11-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    s_lshl_b32 s0, s0, 2
; GFX11-PAL-NEXT:    s_lshl_b32 s1, s1, 2
; GFX11-PAL-NEXT:    s_add_u32 s0, 0x104, s0
; GFX11-PAL-NEXT:    s_add_u32 s1, 0x104, s1
; GFX11-PAL-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-NEXT:    v_add_nc_u32_e32 v2, v1, v0
; GFX11-NEXT:    v_sub_nc_u32_e32 v0, v1, v0
; GFX11-NEXT:    scratch_load_b32 v1, off, off offset:4
; GFX11-NEXT:    scratch_store_b32 v2, v3, off
; GFX11-NEXT:    scratch_load_b32 v0, v0, off offset:124
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    v_add_nc_u32_e32 v2, v1, v0
; GFX11-PAL-NEXT:    v_sub_nc_u32_e32 v0, v1, v0
; GFX11-PAL-NEXT:    scratch_load_b32 v1, off, off offset:4
; GFX11-PAL-NEXT:    scratch_store_b32 v2, v3, off
; GFX11-PAL-NEXT:    scratch_load_b32 v0, v0, off offset:124
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mov_b32_e32 v1, 15
; GFX11-NEXT:    s_add_u32 vcc_lo, s32, 0x100
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mov_b32_e32 v2, vcc_lo
; GFX11-NEXT:    v_and_b32_e32 v3, v0, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-NEXT:    v_lshl_add_u32 v0, v0, 2, v2
; GFX11-NEXT:    v_lshl_add_u32 v2, v3, 2, v2
; GFX11-NEXT:    scratch_load_b32 v3, off, s32
; GFX11-NEXT:    scratch_store_b32 v0, v1, off
; GFX11-NEXT:    scratch_load_b32 v0, v2, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-PAL-NEXT:    v_mov_b32_e32 v1, 15
; GFX11-PAL-NEXT:    s_add_u32 vcc_lo, s32, 0x100
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-PAL-NEXT:    v_mov_b32_e32 v2, vcc_lo
; GFX11-PAL-NEXT:    v_and_b32_e32 v3, v0, v1
; GFX11-PAL-NEXT:    s_delay_alu instid0(VALU_DEP_2) instskip(NEXT) instid1(VALU_DEP_2)
; GFX11-PAL-NEXT:    v_lshl_add_u32 v0, v0, 2, v2
; GFX11-PAL-NEXT:    v_lshl_add_u32 v2, v3, 2, v2
; GFX11-PAL-NEXT:    scratch_load_b32 v3, off, s32
; GFX11-PAL-NEXT:    scratch_store_b32 v0, v1, off
; GFX11-PAL-NEXT:    scratch_load_b32 v0, v2, off
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX11-NEXT:    scratch_load_b32 v0, off, s32
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_add_u32 vcc_lo, s32, 0x4000
; GFX11-NEXT:    s_mov_b32 s1, s0
; GFX11-NEXT:    s_mov_b32 s2, s0
; GFX11-NEXT:    s_mov_b32 s3, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s32
; GFX11-PAL-NEXT:    s_mov_b32 s0, 0
; GFX11-PAL-NEXT:    s_add_u32 vcc_lo, s32, 0x4000
; GFX11-PAL-NEXT:    s_mov_b32 s1, s0
; GFX11-PAL-NEXT:    s_mov_b32 s2, s0
; GFX11-PAL-NEXT:    s_mov_b32 s3, s0
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    s_add_u32 s1, 0x4004, s1
; GFX11-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    s_lshl_b32 s0, s0, 2
; GFX11-PAL-NEXT:    s_lshl_b32 s1, s1, 2
; GFX11-PAL-NEXT:    s_add_u32 s0, 0x4004, s0
; GFX11-PAL-NEXT:    s_add_u32 s1, 0x4004, s1
; GFX11-PAL-NEXT:    scratch_store_b32 off, v0, s0
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s1
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_add_u32 s0, 4, s0
; GFX11-NEXT:    scratch_store_b32 off, v0, off offset:4
; GFX11-NEXT:    scratch_store_b32 off, v1, s0 offset:-384
; GFX11-NEXT:    scratch_load_b32 v0, off, s0 offset:-384
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_add_u32 s0, 4, s0
; GFX11-PAL-NEXT:    scratch_store_b32 off, v0, off offset:4
; GFX11-PAL-NEXT:    scratch_store_b32 off, v1, s0 offset:-384
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s0 offset:-384
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-PAL-NEXT:    s_movk_i32 s0, 0x3000
; GFX11-PAL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-PAL-NEXT:    s_add_u32 s0, s32, s0
; GFX11-PAL-NEXT:    scratch_store_b32 off, v0, s32
; GFX11-PAL-NEXT:    scratch_store_b32 off, v1, s0 offset:-384
; GFX11-PAL-NEXT:    scratch_load_b32 v0, off, s0 offset:-384
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX11-NEXT:    scratch_store_b32 v0, v1, off offset:1024
; GFX11-NEXT:    scratch_load_b32 v0, v0, off offset:1024
; GFX11-NEXT:    s_endpgm
;
...
; GFX11-PAL-NEXT:    scratch_store_b32 v0, v1, off offset:1024
; GFX11-PAL-NEXT:    scratch_load_b32 v0, v0, off offset:1024
; GFX11-PAL-NEXT:    s_endpgm
bb:
...
; GFX11-NEXT:    scratch_store_b64 v0, v[1:2], off
; GFX11-NEXT:    scratch_load_b64 v[0:1], v0, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-PAL-NEXT:    scratch_store_b64 v0, v[1:2], off
; GFX11-PAL-NEXT:    scratch_load_b64 v[0:1], v0, off
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-PAL-NEXT:    s_setpc_b64 s[30:31]
bb:
...
; GFX11-NEXT:    scratch_store_b96 v0, v[1:3], off
; GFX11-NEXT:    scratch_load_b96 v[0:2], v0, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-PAL-NEXT:    scratch_store_b96 v0, v[1:3], off
; GFX11-PAL-NEXT:    scratch_load_b96 v[0:2], v0, off
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-PAL-NEXT:    s_setpc_b64 s[30:31]
bb:
...
; GFX11-NEXT:    scratch_load_b128 v[0:3], v0, off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-PAL-NEXT:    scratch_load_b128 v[0:3], v0, off
; GFX11-PAL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PAL-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-PAL-NEXT:    s_setpc_b64 s[30:31]
bb:
