...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_lshrrev_b32_e32 v4, 31, v2
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v4, 31, v2
...
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v1, v3
...
; GFX6-NEXT:    v_lshrrev_b32_e32 v1, 31, v3
; GFX6-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX6-NEXT:    v_xor_b32_e32 v0, v1, v0
; GFX6-NEXT:    v_ashrrev_i32_e32 v2, 31, v5
; GFX6-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GFX6-NEXT:    v_xor_b32_e32 v1, 0x80000000, v2
...
; GFX8-NEXT:    v_lshrrev_b32_e32 v1, 31, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX8-NEXT:    v_xor_b32_e32 v0, v1, v0
; GFX8-NEXT:    v_ashrrev_i32_e32 v2, 31, v5
; GFX8-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GFX8-NEXT:    v_xor_b32_e32 v1, 0x80000000, v2
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v1, 31, v3
...
; GFX10-NEXT:    v_lshrrev_b32_e32 v1, 31, v3
...
; GFX11-NEXT:    v_lshrrev_b32_e32 v1, 31, v3
