...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-WGP %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=+cumode -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-CU %s
...
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    v_add_co_u32_e64 v0, s0, s0, v0
; GFX11-WGP-NEXT:    v_addc_u32_e64 v1, s0, s1, 0, s0
; GFX11-WGP-NEXT:    flat_load_b32 v2, v[0:1] slc
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, s2
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s3
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    v_add_co_u32_e64 v0, s0, s0, v0
; GFX11-CU-NEXT:    v_addc_u32_e64 v1, s0, s1, 0, s0
; GFX11-CU-NEXT:    flat_load_b32 v2, v[0:1] slc
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, s2
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s3
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s3
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-WGP-NEXT:    flat_store_b32 v[0:1], v2 slc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s3
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-CU-NEXT:    flat_store_b32 v[0:1], v2 slc
; GFX11-CU-NEXT:    s_endpgm
    i32* %in, i32* %out) {
entry:
...
; GFX11-WGP-NEXT:    v_add_co_u32_e64 v0, s0, s2, v0
; GFX11-WGP-NEXT:    flat_load_b32 v2, v[1:2]
; GFX11-WGP-NEXT:    v_addc_u32_e64 v1, s0, s3, 0, s0
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-WGP-NEXT:    flat_store_b32 v[0:1], v2 slc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    v_add_co_u32_e64 v0, s0, s2, v0
; GFX11-CU-NEXT:    flat_load_b32 v2, v[1:2]
; GFX11-CU-NEXT:    v_addc_u32_e64 v1, s0, s3, 0, s0
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-CU-NEXT:    flat_store_b32 v[0:1], v2 slc
; GFX11-CU-NEXT:    s_endpgm
    i32* %in, i32* %out) {
