...
; GFX10-32-NEXT:    v_readfirstlane_b32 s11, v4
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s7, s6, v5
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s8, s11, v4
...
; GFX10-64-NEXT:    v_add_co_ci_u32_e32 v1, vcc, s3, v1, vcc
; GFX10-64-NEXT:    s_clause 0x1
; GFX10-64-NEXT:    global_load_dwordx4 v[4:7], v[2:3], off offset:16
; GFX10-64-NEXT:    global_load_dwordx4 v[8:11], v[2:3], off
...
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, v2, v1, vcc
; GFX9-NEXT:    global_load_dwordx4 v[5:8], v[0:1], off offset:16
...
; GFX10-64-NEXT:    s_clause 0x1
; GFX10-64-NEXT:    global_load_dwordx4 v[5:8], v[0:1], off offset:16
...
; PRE-GFX10-NEXT:    v_mov_b32_e32 v41, v1
; PRE-GFX10-NEXT:    v_mov_b32_e32 v42, v0
...
; PRE-GFX10-NEXT:    v_readfirstlane_b32 s6, v41
; PRE-GFX10-NEXT:    v_cmp_eq_u32_e64 s[30:31], s6, v41
; PRE-GFX10-NEXT:    s_and_saveexec_b64 s[8:9], s[30:31]
; PRE-GFX10-NEXT:    v_mov_b32_e32 v0, v42
...
; GFX10-32-NEXT:    v_mov_b32_e32 v41, v1
; GFX10-32-NEXT:    v_writelane_b32 v40, s4, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v42, v0
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s4, v41
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s30, s4, v41
; GFX10-32-NEXT:    s_and_saveexec_b32 s7, s30
; GFX10-32-NEXT:    v_mov_b32_e32 v0, v42
...
; GFX10-64-NEXT:    v_mov_b32_e32 v41, v1
; GFX10-64-NEXT:    v_writelane_b32 v40, s4, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v42, v0
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s6, v41
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[30:31], s6, v41
; GFX10-64-NEXT:    s_and_saveexec_b64 s[8:9], s[30:31]
; GFX10-64-NEXT:    v_mov_b32_e32 v0, v42
