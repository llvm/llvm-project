...
; RUN: llc -march=amdgcn -mcpu=gfx1010 -mattr=+wavefrontsize32,-wavefrontsize64 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10GFX11,GFX10,GFX10-32 %s
; RUN: llc -march=amdgcn -mcpu=gfx1010 -mattr=-wavefrontsize32,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10GFX11,GFX10,GFX10-64 %s
; RUN: llc -march=amdgcn -mcpu=gfx1150 -mattr=-wavefrontsize32,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10GFX11,GFX1150 %s
; RUN: llc -march=amdgcn -mcpu=gfx1200 -mattr=-wavefrontsize32,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX12 %s
...
;
; GFX1150-LABEL: test_waterfall_readlane:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
...
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v1
; GFX1150-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1150-NEXT:    v_readlane_b32 s6, v0, s6
; GFX1150-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1150-NEXT:    v_mov_b32_e32 v3, s6
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX1150-NEXT:    s_cbranch_execnz .LBB0_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1150-NEXT:    global_store_b32 v2, v3, s[0:1]
; GFX1150-NEXT:    s_endpgm
;
; GFX12-LABEL: test_waterfall_readlane:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX12-NEXT:    v_mov_b32_e32 v2, 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 3, v[0:1]
...
; GFX12-NEXT:    v_readfirstlane_b32 s6, v1
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v1
; GFX12-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX12-NEXT:    v_readlane_b32 s6, v0, s6
; GFX12-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_mov_b32_e32 v3, s6
; GFX12-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX12-NEXT:    s_cbranch_execnz .LBB0_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_mov_b64 exec, s[2:3]
; GFX12-NEXT:    global_store_b32 v2, v3, s[0:1]
; GFX12-NEXT:    s_endpgm
...
;
; GFX1150-LABEL: test_waterfall_non_uniform_img:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[8:9], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v4, v1
; GFX1150-NEXT:    v_mov_b32_e32 v5, v0
; GFX1150-NEXT:    s_mov_b32 s7, s5
; GFX1150-NEXT:    s_mov_b32 s6, s4
; GFX1150-NEXT:    s_mov_b32 s5, s3
; GFX1150-NEXT:    s_mov_b32 s4, s2
; GFX1150-NEXT:    s_mov_b64 s[2:3], exec
; GFX1150-NEXT:  .LBB1_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[12:13], s10, v5
; GFX1150-NEXT:    s_and_saveexec_b64 s[20:21], s[12:13]
...
; GFX1150-NEXT:    s_cbranch_execnz .LBB1_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[2:3]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[8:9]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_non_uniform_img:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[8:9], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
...
; GFX12-NEXT:    v_readfirstlane_b32 s10, v5
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[12:13], s10, v5
; GFX12-NEXT:    s_and_saveexec_b64 s[20:21], s[12:13]
; GFX12-NEXT:    s_ashr_i32 s11, s10, 31
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_lshl_b64 s[10:11], s[10:11], 5
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_nc_u64 s[10:11], s[0:1], s[10:11]
; GFX12-NEXT:    s_load_b256 s[12:19], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v4, s[12:19], s[4:7] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    s_xor_b64 exec, exec, s[20:21]
; GFX12-NEXT:    s_cbranch_execnz .LBB1_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_mov_b64 exec, s[2:3]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b64 exec, exec, s[8:9]
; GFX12-NEXT:    s_wait_samplecnt 0x0
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_non_uniform_img_single_read:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[8:9], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v4, v0
; GFX1150-NEXT:    v_mov_b32_e32 v6, v1
; GFX1150-NEXT:    s_mov_b32 s7, s5
; GFX1150-NEXT:    s_mov_b32 s6, s4
; GFX1150-NEXT:    s_mov_b32 s5, s3
; GFX1150-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX1150-NEXT:    s_mov_b32 s4, s2
...
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:  .LBB2_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v4
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v4
; GFX1150-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s16, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s17, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s18, v13
...
; GFX1150-NEXT:    s_cbranch_execnz .LBB2_1
; GFX1150-NEXT:  ; %bb.2:
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_non_uniform_img_single_read:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[8:9], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
...
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s0, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, v1, vcc
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[11:14], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[7:10], v[0:1], off
; GFX12-NEXT:  .LBB2_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_readfirstlane_b32 s2, v4
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v4
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s12, v7
; GFX12-NEXT:    v_readfirstlane_b32 s13, v8
; GFX12-NEXT:    v_readfirstlane_b32 s14, v9
; GFX12-NEXT:    v_readfirstlane_b32 s15, v10
; GFX12-NEXT:    v_readfirstlane_b32 s16, v11
; GFX12-NEXT:    v_readfirstlane_b32 s17, v12
; GFX12-NEXT:    v_readfirstlane_b32 s18, v13
; GFX12-NEXT:    v_readfirstlane_b32 s19, v14
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    ; implicit-def: $vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12_vgpr13_vgpr14
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v6, s[12:19], s[4:7] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr6
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    s_endpgm
;
; GFX1150-LABEL: test_multiple_groups:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    v_mov_b32_e32 v3, 0
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:  .LBB3_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[6:7], s8, v0
; GFX1150-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX1150-NEXT:    v_readlane_b32 s8, v2, s8
; GFX1150-NEXT:    ; implicit-def: $vgpr0
; GFX1150-NEXT:    v_mov_b32_e32 v4, s8
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[6:7]
; GFX1150-NEXT:    s_cbranch_execnz .LBB3_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1150-NEXT:    global_store_b32 v3, v4, s[0:1]
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:  .LBB3_3: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v1
; GFX1150-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX1150-NEXT:    v_readlane_b32 s6, v2, s6
; GFX1150-NEXT:    ; implicit-def: $vgpr1
; GFX1150-NEXT:    ; implicit-def: $vgpr2
; GFX1150-NEXT:    v_mov_b32_e32 v0, s6
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX1150-NEXT:    s_cbranch_execnz .LBB3_3
; GFX1150-NEXT:  ; %bb.4:
; GFX1150-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1150-NEXT:    global_store_b32 v3, v0, s[2:3]
; GFX1150-NEXT:    s_endpgm
;
; GFX12-LABEL: test_multiple_groups:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v3, 0
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:  .LBB3_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_readfirstlane_b32 s8, v0
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[6:7], s8, v0
; GFX12-NEXT:    s_and_saveexec_b64 s[6:7], s[6:7]
; GFX12-NEXT:    v_readlane_b32 s8, v2, s8
; GFX12-NEXT:    ; implicit-def: $vgpr0
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_mov_b32_e32 v4, s8
; GFX12-NEXT:    s_xor_b64 exec, exec, s[6:7]
; GFX12-NEXT:    s_cbranch_execnz .LBB3_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_mov_b64 exec, s[4:5]
; GFX12-NEXT:    global_store_b32 v3, v4, s[0:1]
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v1
; GFX12-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX12-NEXT:    v_readlane_b32 s6, v2, s6
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_non_uniform_img_multi_rl:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
...
; GFX1150-NEXT:  .LBB4_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v6
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[10:11], s8, v6
; GFX1150-NEXT:    s_and_saveexec_b64 s[20:21], s[10:11]
; GFX1150-NEXT:    s_ashr_i32 s9, s8, 31
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v5
; GFX1150-NEXT:    s_lshl_b64 s[8:9], s[8:9], 5
; GFX1150-NEXT:    ; implicit-def: $vgpr6
; GFX1150-NEXT:    ; implicit-def: $vgpr5
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    s_add_u32 s8, s0, s8
; GFX1150-NEXT:    s_addc_u32 s9, s1, s9
; GFX1150-NEXT:    s_ashr_i32 s11, s10, 31
; GFX1150-NEXT:    s_lshl_b64 s[10:11], s[10:11], 4
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_add_u32 s16, s2, s10
...
; GFX1150-NEXT:    ; implicit-def: $vgpr4
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[20:21]
; GFX1150-NEXT:    s_cbranch_execnz .LBB4_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[6:7]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_non_uniform_img_multi_rl:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
...
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[10:11], s8, v6
; GFX12-NEXT:    s_and_saveexec_b64 s[20:21], s[10:11]
; GFX12-NEXT:    v_readfirstlane_b32 s10, v5
; GFX12-NEXT:    s_ashr_i32 s9, s8, 31
; GFX12-NEXT:    ; implicit-def: $vgpr6
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_lshl_b64 s[8:9], s[8:9], 5
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[8:9]
; GFX12-NEXT:    s_ashr_i32 s11, s10, 31
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_lshl_b64 s[10:11], s[10:11], 4
; GFX12-NEXT:    s_add_nc_u64 s[16:17], s[2:3], s[10:11]
; GFX12-NEXT:    s_load_b256 s[8:15], s[8:9], 0x0
; GFX12-NEXT:    s_load_b128 s[16:19], s[16:17], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v4, s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    s_xor_b64 exec, exec, s[20:21]
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
  %wf_token = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 %index)
  %s_idx = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 %wf_token, i32 %index)
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_non_uni_img_2_idx:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v6, v2
; GFX1150-NEXT:    v_mov_b32_e32 v5, v1
; GFX1150-NEXT:    v_mov_b32_e32 v4, v0
; GFX1150-NEXT:    s_mov_b64 s[6:7], exec
; GFX1150-NEXT:  .LBB5_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v4
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[8:9], s12, v4
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[10:11], s13, v5
; GFX1150-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
; GFX1150-NEXT:    s_ashr_i32 s9, s12, 31
; GFX1150-NEXT:    s_mov_b32 s8, s12
; GFX1150-NEXT:    s_mov_b32 s10, s13
; GFX1150-NEXT:    s_lshl_b64 s[8:9], s[8:9], 5
; GFX1150-NEXT:    ; implicit-def: $vgpr4_vgpr5
; GFX1150-NEXT:    s_add_u32 s8, s0, s8
; GFX1150-NEXT:    s_addc_u32 s9, s1, s9
; GFX1150-NEXT:    s_ashr_i32 s11, s13, 31
...
; GFX1150-NEXT:    ; implicit-def: $vgpr6
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[20:21]
; GFX1150-NEXT:    s_cbranch_execnz .LBB5_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[6:7]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_non_uni_img_2_idx:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
...
; GFX12-NEXT:    v_readfirstlane_b32 s12, v4
; GFX12-NEXT:    v_readfirstlane_b32 s13, v5
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[8:9], s12, v4
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[10:11], s13, v5
; GFX12-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
; GFX12-NEXT:    s_ashr_i32 s9, s12, 31
; GFX12-NEXT:    s_mov_b32 s8, s12
; GFX12-NEXT:    s_ashr_i32 s11, s13, 31
; GFX12-NEXT:    s_mov_b32 s10, s13
; GFX12-NEXT:    s_lshl_b64 s[8:9], s[8:9], 5
; GFX12-NEXT:    s_lshl_b64 s[10:11], s[10:11], 4
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[8:9]
; GFX12-NEXT:    s_add_nc_u64 s[16:17], s[2:3], s[10:11]
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v6, s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr6
; GFX12-NEXT:    s_xor_b64 exec, exec, s[20:21]
...
; GFX10-64-NEXT:    s_endpgm
;
; GFX1150-LABEL: test_waterfall_non_uniform_img_single_store:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    v_mov_b32_e32 v6, v1
; GFX1150-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    global_load_b128 v[7:10], v[7:8], off
; GFX1150-NEXT:  .LBB6_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[0:1], s0, v0
; GFX1150-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s0, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s1, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s3, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s4, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s5, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s7, v14
; GFX1150-NEXT:    ; implicit-def: $vgpr0
; GFX1150-NEXT:    ; implicit-def: $vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12_vgpr13_vgpr14
; GFX1150-NEXT:    image_store v[2:5], v6, s[0:7] dmask:0xf dim:SQ_RSRC_IMG_1D unorm
; GFX1150-NEXT:    ; implicit-def: $vgpr2_vgpr3_vgpr4_vgpr5
; GFX1150-NEXT:    ; implicit-def: $vgpr6
...
; GFX1150-NEXT:    s_endpgm
;
; GFX12-LABEL: test_waterfall_non_uniform_img_single_store:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v6, v1
; GFX12-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[7:8], 5, v[0:1]
; GFX12-NEXT:    v_add_co_u32 v7, vcc, s0, v7
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v8, null, s1, v8, vcc
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[11:14], v[7:8], off offset:16
; GFX12-NEXT:    global_load_b128 v[7:10], v[7:8], off
; GFX12-NEXT:  .LBB6_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-NEXT:    s_wait_alu 0xf1fe
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[0:1], s0, v0
; GFX12-NEXT:    s_and_saveexec_b64 s[8:9], s[0:1]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v7
; GFX12-NEXT:    v_readfirstlane_b32 s1, v8
; GFX12-NEXT:    v_readfirstlane_b32 s2, v9
; GFX12-NEXT:    v_readfirstlane_b32 s3, v10
; GFX12-NEXT:    v_readfirstlane_b32 s4, v11
; GFX12-NEXT:    v_readfirstlane_b32 s5, v12
; GFX12-NEXT:    v_readfirstlane_b32 s6, v13
; GFX12-NEXT:    v_readfirstlane_b32 s7, v14
; GFX12-NEXT:    ; implicit-def: $vgpr0
; GFX12-NEXT:    ; implicit-def: $vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12_vgpr13_vgpr14
; GFX12-NEXT:    image_store v[2:5], v6, s[0:7] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr2_vgpr3_vgpr4_vgpr5
; GFX12-NEXT:    ; implicit-def: $vgpr6
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_remove_waterfall_multi_rl:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[12:13], exec
; GFX12-NEXT:    s_mov_b32 s6, s5
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    s_ashr_i32 s5, s4, 31
; GFX12-NEXT:    s_ashr_i32 s7, s6, 31
; GFX12-NEXT:    s_lshl_b64 s[4:5], s[4:5], 5
; GFX12-NEXT:    s_lshl_b64 s[6:7], s[6:7], 4
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[4:5]
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[2:3], s[6:7]
; GFX12-NEXT:    s_load_b256 s[0:7], s[0:1], 0x0
; GFX12-NEXT:    s_load_b128 s[8:11], s[8:9], 0x0
; GFX12-NEXT:    s_and_b64 exec, exec, s[12:13]
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v1, s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
  %wf_token = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 %index)
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_keep_waterfall_multi_rl:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[6:7], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v4, v1
; GFX1150-NEXT:    v_mov_b32_e32 v5, v0
; GFX1150-NEXT:    s_mov_b64 s[8:9], exec
; GFX1150-NEXT:  .LBB9_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v5
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[12:13], s10, v5
...
; GFX1150-NEXT:    s_cbranch_execnz .LBB9_1
; GFX1150-NEXT:  ; %bb.2:
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_keep_waterfall_multi_rl:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[6:7], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v4, v1
...
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[12:13], s10, v5
; GFX12-NEXT:    s_and_saveexec_b64 s[24:25], s[12:13]
; GFX12-NEXT:    s_ashr_i32 s11, s10, 31
; GFX12-NEXT:    s_ashr_i32 s5, s4, 31
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_lshl_b64 s[10:11], s[10:11], 5
; GFX12-NEXT:    s_lshl_b64 s[12:13], s[4:5], 4
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_nc_u64 s[10:11], s[0:1], s[10:11]
; GFX12-NEXT:    s_add_nc_u64 s[20:21], s[2:3], s[12:13]
; GFX12-NEXT:    s_load_b256 s[12:19], s[10:11], 0x0
; GFX12-NEXT:    s_load_b128 s[20:23], s[20:21], 0x0
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], v4, s[12:19], s[20:23] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    s_xor_b64 exec, exec, s[24:25]
; GFX12-NEXT:    s_cbranch_execnz .LBB9_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_mov_b64 exec, s[8:9]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b64 exec, exec, s[6:7]
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
  %wf_token = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 %index)
  %s_idx = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 %wf_token, i32 %index)
...
; GFX1150-NEXT:    s_endpgm
;
; GFX12-LABEL: test_waterfall_sample_with_kill:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[6:7], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-NEXT:    v_readfirstlane_b32 s10, v0
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[12:13], s10, v0
; GFX12-NEXT:    s_and_saveexec_b64 s[24:25], s[12:13]
; GFX12-NEXT:    s_ashr_i32 s11, s10, 31
; GFX12-NEXT:    s_ashr_i32 s5, s4, 31
; GFX12-NEXT:    s_wait_alu 0xfffe
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[2:5], v1, s[12:19], s[20:23] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-NEXT:    ; implicit-def: $vgpr1
; GFX12-NEXT:    s_xor_b64 exec, exec, s[24:25]
...
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_cmpx_gt_f32_e32 0, v2
; GFX12-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX12-NEXT:    s_cbranch_execz .LBB10_5
; GFX12-NEXT:  ; %bb.3: ; %.kill
; GFX12-NEXT:    s_and_not1_b64 s[6:7], s[6:7], exec
; GFX12-NEXT:    s_cbranch_scc0 .LBB10_6
; GFX12-NEXT:  ; %bb.4: ; %.kill
; GFX12-NEXT:    s_mov_b64 exec, 0
; GFX12-NEXT:  .LBB10_5: ; %.exit
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    export mrt0 v0, off, off, off done
; GFX12-NEXT:    s_endpgm
; GFX12-NEXT:  .LBB10_6:
; GFX12-NEXT:    s_mov_b64 exec, 0
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v7, v2
; GFX1150-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX1150-NEXT:    v_mov_b32_e32 v6, v1
; GFX1150-NEXT:    v_mov_b32_e32 v5, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1150-NEXT:    v_ashrrev_i32_e32 v8, 31, v7
; GFX1150-NEXT:    v_lshlrev_b64 v[2:3], 4, v[3:4]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    global_load_b128 v[11:14], v[0:1], off offset:16
; GFX1150-NEXT:    global_load_b128 v[7:10], v[0:1], off
; GFX1150-NEXT:    global_load_b128 v[15:18], v[2:3], off
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:  .LBB11_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v5
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v6
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v5
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v6
; GFX1150-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1150-NEXT:    s_waitcnt vmcnt(1)
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s9, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s11, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v14
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s16, v15
; GFX1150-NEXT:    v_readfirstlane_b32 s17, v16
; GFX1150-NEXT:    v_readfirstlane_b32 s18, v17
; GFX1150-NEXT:    v_readfirstlane_b32 s19, v18
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    ; implicit-def: $vgpr5
; GFX1150-NEXT:    ; implicit-def: $vgpr6
; GFX1150-NEXT:    ; implicit-def: $vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12_vgpr13_vgpr14
; GFX1150-NEXT:    ; implicit-def: $vgpr15_vgpr16_vgpr17_vgpr18
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[2:3]
; GFX1150-NEXT:    s_cbranch_execnz .LBB11_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v7, v2
; GFX12-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX12-NEXT:    v_mov_b32_e32 v6, v1
; GFX12-NEXT:    v_mov_b32_e32 v5, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-NEXT:    v_ashrrev_i32_e32 v8, 31, v7
; GFX12-NEXT:    v_lshlrev_b64_e32 v[2:3], 4, v[3:4]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 5, v[7:8]
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s0, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, v1, vcc
; GFX12-NEXT:    v_add_co_u32 v2, vcc, s2, v2
; GFX12-NEXT:    s_wait_alu 0xfffd
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, v3, vcc
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[11:14], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[7:10], v[0:1], off
; GFX12-NEXT:    global_load_b128 v[15:18], v[2:3], off
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v5
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v6
; GFX12-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x1
; GFX12-NEXT:    v_readfirstlane_b32 s8, v7
; GFX12-NEXT:    v_readfirstlane_b32 s9, v8
; GFX12-NEXT:    v_readfirstlane_b32 s10, v9
; GFX12-NEXT:    v_readfirstlane_b32 s11, v10
; GFX12-NEXT:    v_readfirstlane_b32 s12, v11
; GFX12-NEXT:    v_readfirstlane_b32 s13, v12
; GFX12-NEXT:    v_readfirstlane_b32 s14, v13
; GFX12-NEXT:    v_readfirstlane_b32 s15, v14
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s16, v15
; GFX12-NEXT:    v_readfirstlane_b32 s17, v16
; GFX12-NEXT:    v_readfirstlane_b32 s18, v17
; GFX12-NEXT:    v_readfirstlane_b32 s19, v18
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    ; implicit-def: $vgpr6
; GFX12-NEXT:    ; implicit-def: $vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12_vgpr13_vgpr14
; GFX12-NEXT:    ; implicit-def: $vgpr15_vgpr16_vgpr17_vgpr18
; GFX12-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_full_idx_multi_begin:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[8:9], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v3, v0
; GFX1150-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
...
; GFX1150-NEXT:    global_load_b128 v[12:15], v[0:1], off
; GFX1150-NEXT:  .LBB12_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_waitcnt vmcnt(1)
; GFX1150-NEXT:    v_readfirstlane_b32 s0, v4
; GFX1150-NEXT:    v_readfirstlane_b32 s1, v5
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v6
; GFX1150-NEXT:    v_readfirstlane_b32 s3, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s4, v8
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[16:17], s0, v4
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[18:19], s1, v5
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[20:21], s2, v6
; GFX1150-NEXT:    v_readfirstlane_b32 s5, v9
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[22:23], s3, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v10
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[18:19], s4, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s7, v11
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[20:21], s5, v9
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v12
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[22:23], s6, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v13
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[18:19], s7, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v14
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[20:21], s12, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v15
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[22:23], s13, v13
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[18:19], s14, v14
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[20:21], s15, v15
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX1150-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[16:17], s[16:17]
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    ; implicit-def: $vgpr4_vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11
; GFX1150-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14_vgpr15
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[0:7], s[12:15] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[16:17]
; GFX1150-NEXT:    s_cbranch_execnz .LBB12_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[10:11]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[8:9]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_full_idx_multi_begin:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[8:9], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GFX12-NEXT:    s_mov_b64 s[10:11], exec
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 4, v[1:2]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[3:4], 5, v[3:4]
; GFX12-NEXT:    v_add_co_u32 v2, vcc, s0, v3
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, s1, v4, vcc
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s2, v0
; GFX12-NEXT:    s_wait_alu 0xfffd
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s3, v1, vcc
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[8:11], v[2:3], off offset:16
; GFX12-NEXT:    global_load_b128 v[4:7], v[2:3], off
; GFX12-NEXT:    global_load_b128 v[12:15], v[0:1], off
; GFX12-NEXT:  .LBB12_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_loadcnt 0x1
; GFX12-NEXT:    v_readfirstlane_b32 s0, v4
; GFX12-NEXT:    v_readfirstlane_b32 s1, v5
; GFX12-NEXT:    v_readfirstlane_b32 s2, v6
; GFX12-NEXT:    v_readfirstlane_b32 s3, v7
; GFX12-NEXT:    v_readfirstlane_b32 s4, v8
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[16:17], s0, v4
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[18:19], s1, v5
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[20:21], s2, v6
; GFX12-NEXT:    v_readfirstlane_b32 s5, v9
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[22:23], s3, v7
; GFX12-NEXT:    v_readfirstlane_b32 s6, v10
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[18:19], s4, v8
; GFX12-NEXT:    v_readfirstlane_b32 s7, v11
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[20:21], s5, v9
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s12, v12
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[22:23], s6, v10
; GFX12-NEXT:    v_readfirstlane_b32 s13, v13
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[18:19], s7, v11
; GFX12-NEXT:    v_readfirstlane_b32 s14, v14
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[20:21], s12, v12
; GFX12-NEXT:    v_readfirstlane_b32 s15, v15
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[22:23], s13, v13
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[18:19], s14, v14
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[20:21], s15, v15
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[22:23]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[18:19]
; GFX12-NEXT:    s_and_b64 s[16:17], s[16:17], s[20:21]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_saveexec_b64 s[16:17], s[16:17]
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    ; implicit-def: $vgpr4_vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11
; GFX12-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14_vgpr15
; GFX12-NEXT:    image_sample v[0:3], [v0, v0], s[0:7], s[12:15] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_xor_b64 exec, exec, s[16:17]
; GFX12-NEXT:    s_cbranch_execnz .LBB12_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_mov_b64 exec, s[10:11]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b64 exec, exec, s[8:9]
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX10-32-NEXT:    s_add_u32 s10, s0, s2
; GFX10-32-NEXT:    global_load_dwordx4 v[5:8], v[0:1], off
; GFX10-32-NEXT:    s_addc_u32 s11, s1, s3
; GFX10-32-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX10-32-NEXT:  .LBB13_1: ; =>This Inner Loop Header: Depth=1
; GFX10-32-NEXT:    s_mov_b32 null, 0
...
; GFX10-64-NEXT:    s_add_u32 s10, s0, s2
; GFX10-64-NEXT:    global_load_dwordx4 v[5:8], v[0:1], off
; GFX10-64-NEXT:    s_addc_u32 s11, s1, s3
; GFX10-64-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX10-64-NEXT:    s_mov_b64 s[10:11], exec
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin_uniform_idx_1:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[8:9], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GFX1150-NEXT:    v_mov_b32_e32 v4, v0
; GFX1150-NEXT:    s_mov_b32 s4, s5
...
; GFX1150-NEXT:    s_addc_u32 s1, s1, s3
; GFX1150-NEXT:    s_load_b256 s[0:7], s[0:1], 0x0
; GFX1150-NEXT:  .LBB13_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v4
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[12:13], s12, v4
; GFX1150-NEXT:    s_and_saveexec_b64 s[16:17], s[12:13]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v5
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v6
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v8
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    ; implicit-def: $vgpr4
; GFX1150-NEXT:    ; implicit-def: $vgpr5_vgpr6_vgpr7_vgpr8
; GFX1150-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[0:7], s[12:15] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[16:17]
; GFX1150-NEXT:    s_cbranch_execnz .LBB13_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[10:11]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[8:9]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin_uniform_idx_1:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[8:9], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
...
; GFX12-NEXT:    s_ashr_i32 s5, s5, 31
; GFX12-NEXT:    s_mov_b64 s[10:11], exec
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 4, v[1:2]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s2, v0
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s3, v1, vcc
; GFX12-NEXT:    s_lshl_b64 s[2:3], s[4:5], 5
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX12-NEXT:    global_load_b128 v[5:8], v[0:1], off
; GFX12-NEXT:    s_load_b256 s[0:7], s[0:1], 0x0
; GFX12-NEXT:  .LBB13_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    v_readfirstlane_b32 s12, v4
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[12:13], s12, v4
; GFX12-NEXT:    s_and_saveexec_b64 s[16:17], s[12:13]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s12, v5
; GFX12-NEXT:    v_readfirstlane_b32 s13, v6
; GFX12-NEXT:    v_readfirstlane_b32 s14, v7
; GFX12-NEXT:    v_readfirstlane_b32 s15, v8
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    ; implicit-def: $vgpr4
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin_uniform_idx_2:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[6:7], exec
; GFX1150-NEXT:    s_mov_b32 s4, s5
; GFX1150-NEXT:    s_wqm_b64 exec, exec
...
; GFX1150-NEXT:    global_load_b128 v[5:8], v[0:1], off
; GFX1150-NEXT:    s_addc_u32 s1, s3, s1
; GFX1150-NEXT:    s_load_b128 s[0:3], s[0:1], 0x0
; GFX1150-NEXT:  .LBB14_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v4
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v4
; GFX1150-NEXT:    s_and_saveexec_b64 s[16:17], s[8:9]
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v5
; GFX1150-NEXT:    v_readfirstlane_b32 s9, v6
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s11, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v12
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    ; implicit-def: $vgpr4
; GFX1150-NEXT:    ; implicit-def: $vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12
; GFX1150-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[16:17]
; GFX1150-NEXT:    s_cbranch_execnz .LBB14_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[6:7]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin_uniform_idx_2:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[6:7], exec
; GFX12-NEXT:    s_mov_b32 s4, s5
; GFX12-NEXT:    s_wqm_b64 exec, exec
...
; GFX12-NEXT:    s_ashr_i32 s5, s5, 31
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 5, v[1:2]
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s0, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, v1, vcc
; GFX12-NEXT:    s_lshl_b64 s[0:1], s[4:5], 4
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[9:12], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[5:8], v[0:1], off
...
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v4
; GFX12-NEXT:    s_and_saveexec_b64 s[16:17], s[8:9]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s8, v5
; GFX12-NEXT:    v_readfirstlane_b32 s9, v6
; GFX12-NEXT:    v_readfirstlane_b32 s10, v7
; GFX12-NEXT:    v_readfirstlane_b32 s11, v8
; GFX12-NEXT:    v_readfirstlane_b32 s12, v9
; GFX12-NEXT:    v_readfirstlane_b32 s13, v10
; GFX12-NEXT:    v_readfirstlane_b32 s14, v11
; GFX12-NEXT:    v_readfirstlane_b32 s15, v12
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    ; implicit-def: $vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_xor_b64 exec, exec, s[16:17]
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin_uniform_idx_3:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v5, v1
; GFX1150-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX1150-NEXT:    v_mov_b32_e32 v4, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1150-NEXT:    v_ashrrev_i32_e32 v6, 31, v5
; GFX1150-NEXT:    v_lshlrev_b64 v[2:3], 4, v[2:3]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    global_load_b128 v[9:12], v[0:1], off offset:16
; GFX1150-NEXT:    global_load_b128 v[5:8], v[0:1], off
; GFX1150-NEXT:    global_load_b128 v[13:16], v[2:3], off
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:  .LBB15_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v4
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v4
; GFX1150-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v12
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s16, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s17, v14
; GFX1150-NEXT:    v_readfirstlane_b32 s18, v15
; GFX1150-NEXT:    v_readfirstlane_b32 s19, v16
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    ; implicit-def: $vgpr4
; GFX1150-NEXT:    ; implicit-def: $vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12
; GFX1150-NEXT:    ; implicit-def: $vgpr13_vgpr14_vgpr15_vgpr16
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[2:3]
; GFX1150-NEXT:    s_cbranch_execnz .LBB15_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin_uniform_idx_3:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v5, v1
...
; GFX12-NEXT:    v_lshlrev_b64_e32 v[2:3], 4, v[2:3]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 5, v[5:6]
; GFX12-NEXT:    v_add_co_u32 v0, vcc, s0, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, v1, vcc
; GFX12-NEXT:    v_add_co_u32 v2, vcc, s2, v2
...
; GFX12-NEXT:    global_load_b128 v[9:12], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[5:8], v[0:1], off
; GFX12-NEXT:    global_load_b128 v[13:16], v[2:3], off
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX12-NEXT:    v_readfirstlane_b32 s15, v12
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s16, v13
; GFX12-NEXT:    v_readfirstlane_b32 s17, v14
; GFX12-NEXT:    v_readfirstlane_b32 s18, v15
; GFX12-NEXT:    v_readfirstlane_b32 s19, v16
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    ; implicit-def: $vgpr4
; GFX12-NEXT:    ; implicit-def: $vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10_vgpr11_vgpr12
; GFX12-NEXT:    ; implicit-def: $vgpr13_vgpr14_vgpr15_vgpr16
; GFX12-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin_uniform_idx_4:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v5, v1
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin_uniform_idx_4:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v5, v1
...
; VI-NEXT:    v_add_u32_e32 v0, vcc, 16, v0
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    flat_load_dwordx4 v[15:18], v[0:1]
; VI-NEXT:    flat_load_dwordx4 v[7:10], v[2:3]
...
; VI-NEXT:    v_readfirstlane_b32 s1, v5
; VI-NEXT:    v_readfirstlane_b32 s8, v6
; VI-NEXT:    v_cmp_eq_u32_e64 s[6:7], s1, v5
...
; VI-NEXT:    v_readfirstlane_b32 s12, v15
; VI-NEXT:    v_readfirstlane_b32 s13, v16
; VI-NEXT:    v_readfirstlane_b32 s14, v17
; VI-NEXT:    v_readfirstlane_b32 s15, v18
; VI-NEXT:    v_readfirstlane_b32 s16, v7
; VI-NEXT:    v_readfirstlane_b32 s17, v8
; VI-NEXT:    v_readfirstlane_b32 s18, v9
; VI-NEXT:    v_readfirstlane_b32 s19, v10
; VI-NEXT:    v_mov_b32_e32 v19, s0
; VI-NEXT:    ; implicit-def: $vgpr5
; VI-NEXT:    ; implicit-def: $vgpr6
; VI-NEXT:    s_nop 3
...
; GFX9-NEXT:    global_load_dwordx4 v[7:10], v[2:3], off
...
; GFX9-NEXT:    v_mov_b32_e32 v20, s1
; GFX9-NEXT:    v_readfirstlane_b32 s8, v15
; GFX9-NEXT:    v_readfirstlane_b32 s9, v16
; GFX9-NEXT:    v_readfirstlane_b32 s10, v17
; GFX9-NEXT:    v_readfirstlane_b32 s11, v18
; GFX9-NEXT:    v_readfirstlane_b32 s12, v11
; GFX9-NEXT:    v_readfirstlane_b32 s13, v12
; GFX9-NEXT:    v_readfirstlane_b32 s14, v13
; GFX9-NEXT:    v_readfirstlane_b32 s15, v14
; GFX9-NEXT:    v_readfirstlane_b32 s16, v7
; GFX9-NEXT:    v_readfirstlane_b32 s17, v8
; GFX9-NEXT:    v_readfirstlane_b32 s18, v9
; GFX9-NEXT:    v_readfirstlane_b32 s19, v10
; GFX9-NEXT:    v_mov_b32_e32 v19, s0
; GFX9-NEXT:    ; implicit-def: $vgpr5
; GFX9-NEXT:    ; implicit-def: $vgpr6
; GFX9-NEXT:    s_nop 3
...
; GFX10-32-NEXT:    s_clause 0x1
; GFX10-32-NEXT:    global_load_dwordx4 v[11:14], v[0:1], off offset:16
; GFX10-32-NEXT:    global_load_dwordx4 v[15:18], v[0:1], off
; GFX10-32-NEXT:    global_load_dwordx4 v[7:10], v[2:3], off
; GFX10-32-NEXT:    s_mov_b32 s0, exec_lo
; GFX10-32-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-32-NEXT:    s_and_b32 s1, s1, s2
; GFX10-32-NEXT:    s_and_saveexec_b32 s1, s1
; GFX10-32-NEXT:    v_readfirstlane_b32 s8, v15
; GFX10-32-NEXT:    v_readfirstlane_b32 s9, v16
; GFX10-32-NEXT:    v_readfirstlane_b32 s10, v17
; GFX10-32-NEXT:    v_readfirstlane_b32 s11, v18
; GFX10-32-NEXT:    v_readfirstlane_b32 s12, v11
; GFX10-32-NEXT:    v_readfirstlane_b32 s13, v12
; GFX10-32-NEXT:    v_readfirstlane_b32 s14, v13
; GFX10-32-NEXT:    v_readfirstlane_b32 s15, v14
; GFX10-32-NEXT:    v_readfirstlane_b32 s16, v7
; GFX10-32-NEXT:    v_readfirstlane_b32 s17, v8
; GFX10-32-NEXT:    v_readfirstlane_b32 s18, v9
; GFX10-32-NEXT:    v_readfirstlane_b32 s19, v10
; GFX10-32-NEXT:    v_mov_b32_e32 v4, 0
; GFX10-32-NEXT:    ; implicit-def: $vgpr5
; GFX10-32-NEXT:    ; implicit-def: $vgpr6
; GFX10-32-NEXT:    image_sample v[0:3], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-32-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-32-NEXT:    s_xor_b32 exec_lo, exec_lo, s1
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s3, v10
; GFX10-32-NEXT:    s_and_b32 exec_lo, exec_lo, s4
; GFX10-32-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-32-NEXT:    s_waitcnt vmcnt(0)
; GFX10-32-NEXT:    ; return to shader part epilog
;
...
; GFX10-64-NEXT:    s_clause 0x1
; GFX10-64-NEXT:    global_load_dwordx4 v[11:14], v[0:1], off offset:16
; GFX10-64-NEXT:    global_load_dwordx4 v[15:18], v[0:1], off
; GFX10-64-NEXT:    global_load_dwordx4 v[7:10], v[2:3], off
; GFX10-64-NEXT:    s_mov_b64 s[0:1], exec
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-64-NEXT:    ; implicit-def: $vgpr5
; GFX10-64-NEXT:    ; implicit-def: $vgpr6
; GFX10-64-NEXT:    image_sample v[0:3], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-64-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-64-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s3, v10
; GFX10-64-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX10-64-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_begin_uniform_idx_1_2loops:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v7, v2
...
; GFX1150-NEXT:    global_load_b128 v[7:10], v[2:3], off
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:  .LBB17_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v5
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v6
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v5
...
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v15
; GFX1150-NEXT:    v_readfirstlane_b32 s9, v16
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v17
; GFX1150-NEXT:    v_readfirstlane_b32 s11, v18
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v14
; GFX1150-NEXT:    v_readfirstlane_b32 s16, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s17, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s18, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s19, v10
...
; GFX1150-NEXT:    v_readfirstlane_b32 s3, v10
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX1150-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_begin_uniform_idx_1_2loops:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v7, v2
...
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[11:14], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[15:18], v[0:1], off
; GFX12-NEXT:    global_load_b128 v[7:10], v[2:3], off
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x1
; GFX12-NEXT:    v_readfirstlane_b32 s8, v15
; GFX12-NEXT:    v_readfirstlane_b32 s9, v16
; GFX12-NEXT:    v_readfirstlane_b32 s10, v17
; GFX12-NEXT:    v_readfirstlane_b32 s11, v18
; GFX12-NEXT:    v_readfirstlane_b32 s12, v11
; GFX12-NEXT:    v_readfirstlane_b32 s13, v12
; GFX12-NEXT:    v_readfirstlane_b32 s14, v13
; GFX12-NEXT:    v_readfirstlane_b32 s15, v14
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s16, v7
; GFX12-NEXT:    v_readfirstlane_b32 s17, v8
; GFX12-NEXT:    v_readfirstlane_b32 s18, v9
; GFX12-NEXT:    v_readfirstlane_b32 s19, v10
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    ; implicit-def: $vgpr6
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    image_sample v[0:3], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX12-NEXT:    v_readfirstlane_b32 s3, v10
; GFX12-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX12-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX10-64-NEXT:    s_endpgm
;
; GFX1150-LABEL: ds_write_8:
; GFX1150:       ; %bb.0: ; %.entry
; GFX1150-NEXT:    v_lshl_add_u32 v1, v1, 2, Lds@abs32@lo
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:  .LBB19_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_readfirstlane_b32 s0, v1
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[0:1], s0, v1
; GFX1150-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX1150-NEXT:    ds_store_b8 v1, v0
; GFX1150-NEXT:    ; implicit-def: $vgpr1
; GFX1150-NEXT:    ; implicit-def: $vgpr0
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[0:1]
; GFX1150-NEXT:    s_cbranch_execnz .LBB19_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_endpgm
;
; GFX12-LABEL: ds_write_8:
; GFX12:       ; %bb.0: ; %.entry
; GFX12-NEXT:    v_lshl_add_u32 v1, v1, 2, Lds@abs32@lo
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-NEXT:  .LBB19_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_readfirstlane_b32 s0, v1
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[0:1], s0, v1
; GFX12-NEXT:    s_and_saveexec_b64 s[0:1], s[0:1]
; GFX12-NEXT:    ds_store_b8 v1, v0
; GFX12-NEXT:    ; implicit-def: $vgpr1
; GFX12-NEXT:    ; implicit-def: $vgpr0
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_xor_b64 exec, exec, s[0:1]
...
; VI-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v8
; VI-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; VI-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_mov_b32_e32 v0, 0
...
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_readfirstlane_b32 s16, v18
; VI-NEXT:    v_readfirstlane_b32 s17, v19
; VI-NEXT:    v_readfirstlane_b32 s18, v20
; VI-NEXT:    v_readfirstlane_b32 s19, v21
; VI-NEXT:    v_mov_b32_e32 v1, v0
; VI-NEXT:    v_mov_b32_e32 v5, v4
; VI-NEXT:    s_nop 2
; VI-NEXT:    image_sample v[0:3], v[0:1], s[8:15], s[16:19] dmask:0xf
; VI-NEXT:    image_sample v[4:7], v[4:5], s[8:15], s[16:19] dmask:0xf
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: test_waterfall_multi_end_1loop:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b64 s[4:5], exec
; GFX9-NEXT:    s_wqm_b64 exec, exec
...
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s2, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v3, vcc
; GFX9-NEXT:    global_load_dwordx4 v[14:17], v[0:1], off offset:16
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v8
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX9-NEXT:    v_readfirstlane_b32 s18, v20
; GFX9-NEXT:    v_readfirstlane_b32 s19, v21
; GFX9-NEXT:    v_mov_b32_e32 v9, v8
; GFX9-NEXT:    v_mov_b32_e32 v10, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v11, v10
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    image_sample v[0:3], v[8:9], s[8:15], s[16:19] dmask:0xf
; GFX9-NEXT:    image_sample v[4:7], v[10:11], s[8:15], s[16:19] dmask:0xf
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10-32-LABEL: test_waterfall_multi_end_1loop:
; GFX10-32:       ; %bb.0:
; GFX10-32-NEXT:    s_mov_b32 s4, exec_lo
; GFX10-32-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX10-32-NEXT:    v_mov_b32_e32 v5, v2
; GFX10-32-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX10-32-NEXT:    v_mov_b32_e32 v8, v1
; GFX10-32-NEXT:    v_mov_b32_e32 v9, v0
; GFX10-32-NEXT:    v_ashrrev_i32_e32 v6, 31, v5
; GFX10-32-NEXT:    v_lshlrev_b64 v[2:3], 4, v[3:4]
; GFX10-32-NEXT:    v_lshlrev_b64 v[0:1], 5, v[5:6]
; GFX10-32-NEXT:    v_add_co_u32 v0, vcc_lo, s0, v0
...
; GFX10-32-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s3, v3, vcc_lo
; GFX10-32-NEXT:    s_clause 0x1
; GFX10-32-NEXT:    global_load_dwordx4 v[14:17], v[0:1], off offset:16
...
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s2, s2, v8
; GFX10-32-NEXT:    s_and_b32 s1, s1, s2
; GFX10-32-NEXT:    s_and_saveexec_b32 s1, s1
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s12, v14
; GFX10-32-NEXT:    v_readfirstlane_b32 s13, v15
; GFX10-32-NEXT:    v_readfirstlane_b32 s14, v16
; GFX10-32-NEXT:    v_readfirstlane_b32 s15, v17
; GFX10-32-NEXT:    v_readfirstlane_b32 s16, v18
; GFX10-32-NEXT:    v_readfirstlane_b32 s17, v19
; GFX10-32-NEXT:    v_readfirstlane_b32 s18, v20
; GFX10-32-NEXT:    v_readfirstlane_b32 s19, v21
; GFX10-32-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v9, 0.5
; GFX10-32-NEXT:    image_sample v[0:3], [v8, v8], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-32-NEXT:    image_sample v[4:7], [v9, v9], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-32-NEXT:    ; implicit-def: $vgpr9
; GFX10-32-NEXT:    ; implicit-def: $vgpr8
; GFX10-32-NEXT:    ; implicit-def: $vgpr10_vgpr11_vgpr12_vgpr13_vgpr14_vgpr15_vgpr16_vgpr17
...
; GFX10-32-NEXT:    ; return to shader part epilog
;
; GFX10-64-LABEL: test_waterfall_multi_end_1loop:
; GFX10-64:       ; %bb.0:
; GFX10-64-NEXT:    s_mov_b64 s[4:5], exec
; GFX10-64-NEXT:    s_wqm_b64 exec, exec
; GFX10-64-NEXT:    v_mov_b32_e32 v5, v2
; GFX10-64-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX10-64-NEXT:    v_mov_b32_e32 v8, v1
; GFX10-64-NEXT:    v_mov_b32_e32 v9, v0
; GFX10-64-NEXT:    v_ashrrev_i32_e32 v6, 31, v5
; GFX10-64-NEXT:    v_lshlrev_b64 v[2:3], 4, v[3:4]
; GFX10-64-NEXT:    v_lshlrev_b64 v[0:1], 5, v[5:6]
; GFX10-64-NEXT:    v_add_co_u32 v0, vcc, s0, v0
...
; GFX10-64-NEXT:    v_add_co_ci_u32_e32 v3, vcc, s3, v3, vcc
; GFX10-64-NEXT:    s_clause 0x1
; GFX10-64-NEXT:    global_load_dwordx4 v[14:17], v[0:1], off offset:16
...
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v8
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX10-64-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s16, v18
; GFX10-64-NEXT:    v_readfirstlane_b32 s17, v19
; GFX10-64-NEXT:    v_readfirstlane_b32 s18, v20
; GFX10-64-NEXT:    v_readfirstlane_b32 s19, v21
; GFX10-64-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v9, 0.5
; GFX10-64-NEXT:    image_sample v[0:3], [v8, v8], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-64-NEXT:    image_sample v[4:7], [v9, v9], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-64-NEXT:    ; implicit-def: $vgpr9
; GFX10-64-NEXT:    ; implicit-def: $vgpr8
; GFX10-64-NEXT:    ; implicit-def: $vgpr10_vgpr11_vgpr12_vgpr13_vgpr14_vgpr15_vgpr16_vgpr17
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_end_1loop:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v5, v2
; GFX1150-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX1150-NEXT:    v_mov_b32_e32 v8, v1
; GFX1150-NEXT:    v_mov_b32_e32 v9, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1150-NEXT:    v_ashrrev_i32_e32 v6, 31, v5
; GFX1150-NEXT:    v_lshlrev_b64 v[2:3], 4, v[3:4]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    global_load_b128 v[18:21], v[2:3], off
; GFX1150-NEXT:    s_mov_b64 s[0:1], exec
; GFX1150-NEXT:  .LBB20_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s6, v8
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v9
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v8
; GFX1150-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX1150-NEXT:    s_waitcnt vmcnt(1)
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s9, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s11, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v14
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v15
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v16
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v17
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_readfirstlane_b32 s16, v18
; GFX1150-NEXT:    v_readfirstlane_b32 s17, v19
; GFX1150-NEXT:    v_readfirstlane_b32 s18, v20
; GFX1150-NEXT:    v_readfirstlane_b32 s19, v21
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    v_mov_b32_e32 v4, 0.5
; GFX1150-NEXT:    s_clause 0x1
; GFX1150-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    ; implicit-def: $vgpr9
; GFX1150-NEXT:    ; implicit-def: $vgpr8
; GFX1150-NEXT:    ; implicit-def: $vgpr10_vgpr11_vgpr12_vgpr13_vgpr14_vgpr15_vgpr16_vgpr17
; GFX1150-NEXT:    ; implicit-def: $vgpr18_vgpr19_vgpr20_vgpr21
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[2:3]
; GFX1150-NEXT:    s_cbranch_execnz .LBB20_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_end_1loop:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v5, v2
; GFX12-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX12-NEXT:    v_mov_b32_e32 v8, v1
...
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, v3, vcc
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[14:17], v[0:1], off offset:16
; GFX12-NEXT:    global_load_b128 v[10:13], v[0:1], off
; GFX12-NEXT:    global_load_b128 v[18:21], v[2:3], off
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v9
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[6:7], s6, v8
; GFX12-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x1
...
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v4, 0.5
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    image_sample v[0:3], [v0, v0], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-NEXT:    ; implicit-def: $vgpr9
; GFX12-NEXT:    ; implicit-def: $vgpr8
; GFX12-NEXT:    ; implicit-def: $vgpr10_vgpr11_vgpr12_vgpr13_vgpr14_vgpr15_vgpr16_vgpr17
; GFX12-NEXT:    ; implicit-def: $vgpr18_vgpr19_vgpr20_vgpr21
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; VI-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; VI:       ; %bb.0:
; VI-NEXT:    s_mov_b64 s[4:5], exec
; VI-NEXT:    s_wqm_b64 exec, exec
...
; VI-NEXT:    v_cmp_eq_u32_e64 s[10:11], s10, v10
; VI-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; VI-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b64 s[4:5], exec
; GFX9-NEXT:    s_wqm_b64 exec, exec
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[10:11], s10, v10
; GFX9-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX9-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10-32-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; GFX10-32:       ; %bb.0:
; GFX10-32-NEXT:    s_mov_b32 s4, exec_lo
; GFX10-32-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX10-32-NEXT:    v_mov_b32_e32 v8, v3
; GFX10-32-NEXT:    v_mov_b32_e32 v9, v2
...
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s7, s7, v10
...
; GFX10-32-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v9, 0.5
; GFX10-32-NEXT:    ; implicit-def: $vgpr11
...
; GFX10-32-NEXT:    ; return to shader part epilog
;
; GFX10-64-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; GFX10-64:       ; %bb.0:
; GFX10-64-NEXT:    s_mov_b64 s[4:5], exec
; GFX10-64-NEXT:    s_wqm_b64 exec, exec
; GFX10-64-NEXT:    v_mov_b32_e32 v8, v3
; GFX10-64-NEXT:    v_mov_b32_e32 v9, v2
...
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[10:11], s10, v10
; GFX10-64-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX10-64-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
...
; GFX10-64-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v9, 0.5
; GFX10-64-NEXT:    ; implicit-def: $vgpr11
...
; GFX10-64-NEXT:    ; return to shader part epilog
;
; GFX1150-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_mov_b64 s[4:5], exec
; GFX1150-NEXT:    s_wqm_b64 exec, exec
; GFX1150-NEXT:    v_mov_b32_e32 v8, v3
; GFX1150-NEXT:    v_mov_b32_e32 v9, v2
; GFX1150-NEXT:    v_mov_b32_e32 v10, v1
; GFX1150-NEXT:    v_mov_b32_e32 v11, v0
; GFX1150-NEXT:    s_mov_b64 s[6:7], exec
; GFX1150-NEXT:  .LBB21_1: ; =>This Inner Loop Header: Depth=1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v11
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v10
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v11
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[10:11], s10, v10
; GFX1150-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
; GFX1150-NEXT:    v_readfirstlane_b32 s8, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v8
; GFX1150-NEXT:    s_waitcnt vmcnt(1)
; GFX1150-NEXT:    v_mov_b32_e32 v0, 0
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
; GFX1150-NEXT:    v_mov_b32_e32 v4, 0.5
...
; GFX1150-NEXT:    image_sample v[4:7], [v4, v4], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX1150-NEXT:    s_xor_b64 exec, exec, s[20:21]
; GFX1150-NEXT:    s_cbranch_execnz .LBB21_1
; GFX1150-NEXT:  ; %bb.2:
; GFX1150-NEXT:    s_mov_b64 exec, s[6:7]
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_end_1loop_rsrc_load_inside:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_mov_b64 s[4:5], exec
; GFX12-NEXT:    s_wqm_b64 exec, exec
; GFX12-NEXT:    v_mov_b32_e32 v8, v3
; GFX12-NEXT:    v_mov_b32_e32 v9, v2
; GFX12-NEXT:    v_mov_b32_e32 v10, v1
; GFX12-NEXT:    v_mov_b32_e32 v11, v0
; GFX12-NEXT:    s_mov_b64 s[6:7], exec
; GFX12-NEXT:  .LBB21_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-NEXT:    v_readfirstlane_b32 s8, v11
; GFX12-NEXT:    v_readfirstlane_b32 s10, v10
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v11
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[10:11], s10, v10
; GFX12-NEXT:    s_and_b64 s[8:9], s[8:9], s[10:11]
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_and_saveexec_b64 s[20:21], s[8:9]
; GFX12-NEXT:    v_readfirstlane_b32 s8, v9
; GFX12-NEXT:    v_readfirstlane_b32 s10, v8
; GFX12-NEXT:    s_wait_samplecnt 0x1
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    s_wait_samplecnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v4, 0.5
; GFX12-NEXT:    ; implicit-def: $vgpr11
...
; PRE-GFX10-NEXT:    v_mov_b32_e32 v1, v0
; PRE-GFX10-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX1150-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_end_struct:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v9, v4
; GFX12-NEXT:    v_mov_b32_e32 v8, v3
; GFX12-NEXT:    v_mov_b32_e32 v7, v2
; GFX12-NEXT:    v_mov_b32_e32 v6, v1
; GFX12-NEXT:    v_mov_b32_e32 v10, v0
; GFX12-NEXT:    s_mov_b64 s[0:1], exec
; GFX12-NEXT:  .LBB22_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_readfirstlane_b32 s2, v10
; GFX12-NEXT:    s_wait_alu 0xf1ff
; GFX12-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v10
; GFX12-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX12-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-NEXT:    v_mov_b32_e32 v4, v0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:4], v5, s[4:7], null idxen tfe
; GFX12-NEXT:    ; implicit-def: $vgpr10
; GFX12-NEXT:    ; implicit-def: $vgpr6_vgpr7_vgpr8_vgpr9
; GFX12-NEXT:    ; implicit-def: $vgpr5
; GFX12-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; PRE-GFX10-NEXT:    v_mov_b32_e32 v0, 0
; PRE-GFX10-NEXT:    v_mov_b32_e32 v5, v4
...
; PRE-GFX10-NEXT:    v_mov_b32_e32 v4, v0
; PRE-GFX10-NEXT:    s_nop 0
; PRE-GFX10-NEXT:    buffer_load_format_xyzw v[0:4], v5, s[0:3], 0 idxen tfe
; PRE-GFX10-NEXT:    s_waitcnt vmcnt(0)
; PRE-GFX10-NEXT:    ; return to shader part epilog
;
; GFX10GFX11-LABEL: test_waterfall_multi_end_struct_uniform:
; GFX10GFX11:       ; %bb.0:
; GFX10GFX11-NEXT:    v_mov_b32_e32 v5, v4
; GFX10GFX11-NEXT:    v_mov_b32_e32 v4, v0
; GFX10GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX10GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX10GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX10GFX11-NEXT:    v_readfirstlane_b32 s3, v3
; GFX10GFX11-NEXT:    v_readfirstlane_b32 s0, v4
; GFX10GFX11-NEXT:    v_mov_b32_e32 v1, v0
; GFX10GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX10GFX11-NEXT:    v_mov_b32_e32 v3, v0
; GFX10GFX11-NEXT:    v_mov_b32_e32 v4, v0
; GFX10GFX11-NEXT:    buffer_load_format_xyzw v[0:4], v5, s[0:3], 0 idxen tfe
; GFX10GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX10GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: test_waterfall_multi_end_struct_uniform:
; GFX12:       ; %bb.0:
...
; GFX12-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-NEXT:    v_mov_b32_e32 v4, v0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:4], v5, s[0:3], null idxen tfe
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
