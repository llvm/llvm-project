...
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[10:11], s8, v4
; GFX1150-NEXT:    v_cmp_eq_u32_e64 s[12:13], s9, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    s_and_b64 s[10:11], s[10:11], s[12:13]
; GFX1150-NEXT:    s_and_saveexec_b64 s[20:21], s[10:11]
; GFX1150-NEXT:    s_ashr_i32 s11, s8, 31
; GFX1150-NEXT:    s_mov_b32 s10, s8
; GFX1150-NEXT:    s_mov_b32 s12, s9
; GFX1150-NEXT:    s_lshl_b64 s[10:11], s[10:11], 5
; GFX1150-NEXT:    ; implicit-def: $vgpr4_vgpr5
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1150-NEXT:    s_add_u32 s10, s0, s10
; GFX1150-NEXT:    s_addc_u32 s11, s1, s11
; GFX1150-NEXT:    s_ashr_i32 s13, s9, 31
; GFX1150-NEXT:    s_lshl_b64 s[8:9], s[12:13], 4
; GFX1150-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1150-NEXT:    s_add_u32 s16, s2, s8
; GFX1150-NEXT:    s_addc_u32 s17, s3, s9
; GFX1150-NEXT:    s_load_b256 s[8:15], s[10:11], 0x0
; GFX1150-NEXT:    s_load_b128 s[16:19], s[16:17], 0x0
; GFX1150-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1150-NEXT:    global_load_b128 v[11:14], v[0:1], off
; GFX1150-NEXT:    global_load_b128 v[15:18], v[2:3], off
...
; GFX1150-NEXT:    v_readfirstlane_b32 s9, v12
; GFX1150-NEXT:    v_readfirstlane_b32 s10, v13
; GFX1150-NEXT:    v_readfirstlane_b32 s11, v14
; GFX1150-NEXT:    v_readfirstlane_b32 s12, v7
; GFX1150-NEXT:    v_readfirstlane_b32 s13, v8
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v10
...
; GFX1150-NEXT:    v_readfirstlane_b32 s14, v9
; GFX1150-NEXT:    v_readfirstlane_b32 s15, v10
; GFX1150-NEXT:    v_readfirstlane_b32 s0, v15
; GFX1150-NEXT:    v_readfirstlane_b32 s1, v16
; GFX1150-NEXT:    v_readfirstlane_b32 s2, v17
; GFX1150-NEXT:    v_readfirstlane_b32 s3, v18
; GFX1150-NEXT:    s_and_b64 exec, exec, s[4:5]
