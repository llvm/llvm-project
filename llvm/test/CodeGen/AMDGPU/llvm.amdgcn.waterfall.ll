...
; VI-NEXT:    v_cmp_eq_u32_e64 s[2:3], s4, v5
; VI-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; VI-NEXT:    s_nop 1
; VI-NEXT:    v_readlane_b32 s4, v4, s4
...
; GFX9-NEXT:    v_readfirstlane_b32 s6, v4
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v4
; GFX9-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_readlane_b32 s6, v3, s6
...
; VI-NEXT:    v_add_u32_e32 v6, vcc, s0, v3
; VI-NEXT:    v_addc_u32_e32 v7, vcc, v1, v4, vcc
; VI-NEXT:    v_add_u32_e32 v10, vcc, 16, v6
...
; GFX9-NEXT:    v_add_co_u32_e32 v14, vcc, s0, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v15, vcc, v1, v4, vcc
; GFX9-NEXT:    global_load_dwordx4 v[6:9], v[14:15], off offset:16
...
; GFX10-32-NEXT:    v_or_b32_e32 v6, v6, v4
; GFX10-32-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX10-32-NEXT:    s_cbranch_execnz BB3_3
; GFX10-32-NEXT:  ; %bb.4:
; GFX10-32-NEXT:    s_mov_b32 exec_lo, s4
; GFX10-32-NEXT:    global_store_dword v3, v6, s[2:3]
; GFX10-32-NEXT:    s_endpgm
;
...
; GFX10-64-NEXT:    v_readlane_b32 s6, v2, s6
; GFX10-64-NEXT:    v_mov_b32_e32 v4, s6
; GFX10-64-NEXT:    v_or_b32_e32 v6, v6, v4
; GFX10-64-NEXT:    s_xor_b64 exec, exec, s[0:1]
; GFX10-64-NEXT:    s_cbranch_execnz BB3_3
; GFX10-64-NEXT:  ; %bb.4:
; GFX10-64-NEXT:    s_mov_b64 exec, s[4:5]
; GFX10-64-NEXT:    global_store_dword v3, v6, s[2:3]
; GFX10-64-NEXT:    s_endpgm
...
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v10
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s6, v2
...
; GFX10-32-NEXT:    v_or_b32_e32 v4, v4, v10
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s8, v2
...
; GFX10-64-NEXT:    v_or_b32_e32 v4, v4, v10
...
; VI-NEXT:    v_cmp_eq_u32_e64 s[8:9], s12, v0
; VI-NEXT:    v_cmp_eq_u32_e64 s[10:11], s13, v1
...
; VI-NEXT:    s_load_dwordx4 s[16:19], s[16:17], 0x0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    image_sample v[7:10], v2, s[8:15], s[16:19] dmask:0xf
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[8:9], s12, v0
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[10:11], s13, v1
...
; GFX9-NEXT:    s_load_dwordx4 s[16:19], s[24:25], 0x0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    image_sample v[7:10], v2, s[8:15], s[16:19] dmask:0xf
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-32-NEXT:    s_mov_b32 s4, exec_lo
; GFX10-32-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX10-32-NEXT:    v_mov_b32_e32 v14, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v18, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v22, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v5, 0
; GFX10-32-NEXT:    s_mov_b32 s5, exec_lo
; GFX10-32-NEXT:  BB5_1: ; =>This Inner Loop Header: Depth=1
; GFX10-32-NEXT:    v_readfirstlane_b32 s6, v0
; GFX10-32-NEXT:    v_readfirstlane_b32 s9, v1
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s7, s6, v0
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s8, s9, v1
...
; GFX10-32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-32-NEXT:    image_sample v[7:10], v2, s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX10-32-NEXT:    s_waitcnt vmcnt(0)
; GFX10-32-NEXT:    v_or_b32_e32 v14, v14, v7
; GFX10-32-NEXT:    v_or_b32_e32 v18, v18, v8
; GFX10-32-NEXT:    v_or_b32_e32 v22, v22, v9
...
; GFX10-32-NEXT:    s_mov_b32 exec_lo, s5
; GFX10-32-NEXT:    s_and_b32 exec_lo, exec_lo, s4
; GFX10-32-NEXT:    v_mov_b32_e32 v0, v14
; GFX10-32-NEXT:    v_mov_b32_e32 v1, v18
; GFX10-32-NEXT:    v_mov_b32_e32 v2, v22
...
; GFX10-64-NEXT:    s_mov_b64 s[4:5], exec
; GFX10-64-NEXT:    s_wqm_b64 exec, exec
; GFX10-64-NEXT:    v_mov_b32_e32 v14, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v18, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v22, 0
; GFX10-64-NEXT:    v_mov_b32_e32 v5, 0
; GFX10-64-NEXT:    s_mov_b64 s[6:7], exec
; GFX10-64-NEXT:  BB5_1: ; =>This Inner Loop Header: Depth=1
; GFX10-64-NEXT:    v_readfirstlane_b32 s12, v0
; GFX10-64-NEXT:    v_readfirstlane_b32 s13, v1
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[8:9], s12, v0
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[10:11], s13, v1
...
; GFX10-64-NEXT:    s_load_dwordx4 s[16:19], s[24:25], 0x0
; GFX10-64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-64-NEXT:    image_sample v[7:10], v2, s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    v_or_b32_e32 v14, v14, v7
; GFX10-64-NEXT:    v_or_b32_e32 v18, v18, v8
; GFX10-64-NEXT:    v_or_b32_e32 v22, v22, v9
...
; GFX10-64-NEXT:    s_mov_b64 exec, s[6:7]
; GFX10-64-NEXT:    s_and_b64 exec, exec, s[4:5]
; GFX10-64-NEXT:    v_mov_b32_e32 v0, v14
; GFX10-64-NEXT:    v_mov_b32_e32 v1, v18
; GFX10-64-NEXT:    v_mov_b32_e32 v2, v22
...
; VI-NEXT:    v_lshlrev_b64 v[4:5], 5, v[4:5]
; VI-NEXT:    v_mov_b32_e32 v2, s1
; VI-NEXT:    v_add_u32_e32 v10, vcc, s0, v4
; VI-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; VI-NEXT:    v_addc_u32_e32 v11, vcc, v2, v5, vcc
...
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], 5, v[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v2, s1
; GFX9-NEXT:    v_add_co_u32_e32 v18, vcc, s0, v4
; GFX9-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v19, vcc, v2, v5, vcc
...
; GFX10-32-NEXT:    v_mov_b32_e32 v19, v18
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s18, v8
; GFX10-64-NEXT:    v_readfirstlane_b32 s19, v9
; GFX10-64-NEXT:    v_mov_b32_e32 v19, v18
...
; GFX10-64-NEXT:    v_mov_b32_e32 v2, v3
; GFX10-64-NEXT:    v_mov_b32_e32 v1, v4
; GFX10-64-NEXT:    v_mov_b32_e32 v3, v5
; GFX10-64-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[2:3], s8, v12
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s9, v13
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s10, v14
; GFX9-NEXT:    v_readfirstlane_b32 s11, v15
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s11, v15
; GFX9-NEXT:    v_readfirstlane_b32 s12, v8
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s12, v8
; GFX9-NEXT:    v_readfirstlane_b32 s13, v9
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s13, v9
; GFX9-NEXT:    v_readfirstlane_b32 s14, v10
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s14, v10
; GFX9-NEXT:    v_readfirstlane_b32 s15, v11
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], s15, v11
...
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s1, s8, v8
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s2, s9, v9
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s3, s10, v10
; GFX10-32-NEXT:    v_readfirstlane_b32 s13, v5
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s5, s11, v11
; GFX10-32-NEXT:    v_readfirstlane_b32 s14, v6
; GFX10-32-NEXT:    s_and_b32 s1, s1, s2
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s2, s12, v4
; GFX10-32-NEXT:    s_and_b32 s1, s1, s3
; GFX10-32-NEXT:    v_readfirstlane_b32 s15, v7
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s3, s13, v5
; GFX10-32-NEXT:    s_and_b32 s1, s1, s5
; GFX10-32-NEXT:    s_waitcnt vmcnt(0)
; GFX10-32-NEXT:    v_readfirstlane_b32 s16, v12
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s5, s14, v6
; GFX10-32-NEXT:    s_and_b32 s1, s1, s2
; GFX10-32-NEXT:    v_readfirstlane_b32 s17, v13
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s2, s15, v7
; GFX10-32-NEXT:    s_and_b32 s1, s1, s3
...
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[2:3], s8, v12
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[6:7], s9, v13
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[20:21], s10, v14
; GFX10-64-NEXT:    v_readfirstlane_b32 s13, v9
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[22:23], s11, v15
; GFX10-64-NEXT:    v_readfirstlane_b32 s14, v10
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[6:7], s12, v8
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[20:21]
; GFX10-64-NEXT:    v_readfirstlane_b32 s15, v11
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[20:21], s13, v9
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[22:23]
; GFX10-64-NEXT:    v_readfirstlane_b32 s16, v4
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[22:23], s14, v10
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[6:7]
; GFX10-64-NEXT:    v_readfirstlane_b32 s17, v5
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[6:7], s15, v11
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[20:21]
...
; VI-NEXT:    v_addc_u32_e32 v2, vcc, v3, v2, vcc
...
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v3, v2, vcc
...
; VI-NEXT:    v_mov_b32_e32 v3, s1
; VI-NEXT:    v_add_u32_e32 v5, vcc, s0, v1
; VI-NEXT:    v_addc_u32_e32 v6, vcc, v3, v2, vcc
...
; VI-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v0
...
; GFX9-NEXT:    v_add_co_u32_e32 v13, vcc, s0, v1
; GFX9-NEXT:    v_addc_co_u32_e32 v14, vcc, v3, v2, vcc
...
; GFX9-NEXT:    v_readfirstlane_b32 s8, v0
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v0
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s6, v0
; GFX10-32-NEXT:    v_cmp_eq_u32_e64 s6, s6, v0
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s8, v0
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[8:9], s8, v0
...
; VI-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; VI-NEXT:    v_lshlrev_b64 v[3:4], 5, v[3:4]
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_add_u32_e32 v9, vcc, s0, v3
; VI-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; VI-NEXT:    v_addc_u32_e32 v10, vcc, v1, v4, vcc
; VI-NEXT:    v_lshlrev_b64 v[1:2], 4, v[2:3]
; VI-NEXT:    v_mov_b32_e32 v3, s3
; VI-NEXT:    v_add_u32_e32 v1, vcc, s2, v1
; VI-NEXT:    v_addc_u32_e32 v2, vcc, v3, v2, vcc
...
; GFX9-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GFX9-NEXT:    v_lshlrev_b64 v[3:4], 5, v[3:4]
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    v_add_co_u32_e32 v17, vcc, s0, v3
; GFX9-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v18, vcc, v1, v4, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[1:2], 4, v[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v3, s3
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, s2, v1
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v3, v2, vcc
; GFX9-NEXT:    global_load_dwordx4 v[5:8], v[1:2], off
...
; GFX10-64-NEXT:    global_load_dwordx4 v[13:16], v[17:18], off
...
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    v_readfirstlane_b32 s8, v13
; GFX10-64-NEXT:    v_readfirstlane_b32 s9, v14
; GFX10-64-NEXT:    v_readfirstlane_b32 s10, v15
; GFX10-64-NEXT:    v_readfirstlane_b32 s11, v16
...
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s2, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v3, vcc
; GFX9-NEXT:    global_load_dwordx4 v[4:7], v[2:3], off
; GFX9-NEXT:    global_load_dwordx4 v[10:13], v[18:19], off offset:16
; GFX9-NEXT:    global_load_dwordx4 v[14:17], v[18:19], off
...
; GFX9-NEXT:    v_or_b32_e32 v8, v8, v22
; GFX9-NEXT:    v_or_b32_e32 v9, v9, v23
; GFX9-NEXT:    s_xor_b64 exec, exec, s[6:7]
...
; GFX10-32-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s3, v3, vcc_lo
; GFX10-32-NEXT:    s_clause 0x1
; GFX10-32-NEXT:    global_load_dwordx4 v[4:7], v[8:9], off offset:16
; GFX10-32-NEXT:    global_load_dwordx4 v[14:17], v[8:9], off
; GFX10-32-NEXT:    global_load_dwordx4 v[10:13], v[2:3], off
; GFX10-32-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-32-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX10-32-NEXT:    v_or_b32_e32 v8, v8, v22
; GFX10-32-NEXT:    v_or_b32_e32 v9, v9, v23
; GFX10-32-NEXT:    s_xor_b32 exec_lo, exec_lo, s3
...
; GFX10-32-NEXT:    v_readfirstlane_b32 s14, v6
; GFX10-32-NEXT:    v_readfirstlane_b32 s15, v7
; GFX10-32-NEXT:    v_readfirstlane_b32 s0, v10
; GFX10-32-NEXT:    v_readfirstlane_b32 s1, v11
; GFX10-32-NEXT:    v_readfirstlane_b32 s2, v12
; GFX10-32-NEXT:    v_readfirstlane_b32 s3, v13
; GFX10-32-NEXT:    s_and_b32 exec_lo, exec_lo, s4
...
; GFX10-32-NEXT:    v_mov_b32_e32 v2, v8
; GFX10-32-NEXT:    v_mov_b32_e32 v3, v9
; GFX10-32-NEXT:    s_waitcnt vmcnt(0)
; GFX10-32-NEXT:    ; return to shader part epilog
;
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s2, v0
; GFX10-64-NEXT:    v_readfirstlane_b32 s7, v1
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[2:3], s2, v0
; GFX10-64-NEXT:    v_cmp_eq_u32_e64 s[8:9], s7, v1
; GFX10-64-NEXT:    s_and_b64 s[2:3], s[2:3], s[8:9]
; GFX10-64-NEXT:    s_and_saveexec_b64 s[2:3], s[2:3]
; GFX10-64-NEXT:    s_mov_b32 s7, s6
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    v_readfirstlane_b32 s8, v14
; GFX10-64-NEXT:    v_mov_b32_e32 v19, s7
; GFX10-64-NEXT:    v_readfirstlane_b32 s9, v15
; GFX10-64-NEXT:    v_readfirstlane_b32 s10, v16
; GFX10-64-NEXT:    v_readfirstlane_b32 s11, v17
; GFX10-64-NEXT:    v_readfirstlane_b32 s12, v10
...
; GFX10-64-NEXT:    v_readfirstlane_b32 s18, v6
; GFX10-64-NEXT:    v_readfirstlane_b32 s19, v7
; GFX10-64-NEXT:    v_mov_b32_e32 v18, s6
; GFX10-64-NEXT:    image_sample v[20:23], v[18:19], s[8:15], s[16:19] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    v_or_b32_e32 v8, v8, v20
; GFX10-64-NEXT:    v_or_b32_e32 v3, v3, v21
; GFX10-64-NEXT:    v_or_b32_e32 v2, v2, v22
; GFX10-64-NEXT:    v_or_b32_e32 v9, v9, v23
; GFX10-64-NEXT:    s_xor_b64 exec, exec, s[2:3]
...
; GFX10-64-NEXT:    v_mov_b32_e32 v0, v8
; GFX10-64-NEXT:    v_mov_b32_e32 v3, v9
; GFX10-64-NEXT:    s_waitcnt vmcnt(0)
; GFX10-64-NEXT:    ; return to shader part epilog
