...
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[20:21]
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[0:15], v[38:41], v[42:45], v[16:31]
; SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
...
; HEURRC-NEXT:    v_mov_b64_e32 v[32:33], s[20:21]
; HEURRC-NEXT:    s_nop 0
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 v[0:15], v[38:41], v[42:45], v[16:31]
; HEURRC-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[32:33], s[20:21]
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[0:15], v[38:41], v[42:45], v[16:31]
; VGPRRC-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
...
; SDAG-NEXT:    v_mov_b64_e32 v[34:35], 32
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[26:27]
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[28:29]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[30:31]
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[14:15]
...
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], 32
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], s[24:25]
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], s[26:27]
; HEURRC-NEXT:    v_accvgpr_write_b32 a31, s23
; HEURRC-NEXT:    v_mov_b64_e32 v[8:9], s[28:29]
; HEURRC-NEXT:    v_mov_b64_e32 v[10:11], s[30:31]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[34:35], 32
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; VGPRRC-NEXT:    v_mov_b64_e32 v[38:39], s[26:27]
; VGPRRC-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[40:41], s[28:29]
; VGPRRC-NEXT:    v_mov_b64_e32 v[42:43], s[30:31]
; VGPRRC-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; VGPRRC-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[24:25], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[22:23], s[14:15]
...
; HEURRC-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
; HEURRC-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x64
; HEURRC-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; HEURRC-NEXT:    v_mov_b64_e32 v[38:39], s[26:27]
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; HEURRC-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; HEURRC-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
