...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_f32_16x16x32_f16 a[0:3], v[2:5], v[6:9], a[0:3]
; SDAG-NEXT:    s_nop 7
...
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], s[8:9]
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], s[10:11]
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[8:9], s[14:15]
...
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_16x16x32_f16 a[0:3], v[2:5], v[6:9], a[0:3]
; HEURRC-NEXT:    s_nop 7
...
; SDAG-NEXT:    v_accvgpr_write_b32 a3, s3
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_f32_16x16x32_f16 a[0:3], v[2:5], v[6:9], a[0:3] cbsz:3 abid:2 blgp:1
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    global_store_dwordx4 v0, a[0:3], s[6:7]
; SDAG-NEXT:    s_endpgm
;
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a3, s3
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_16x16x32_f16 a[0:3], v[2:5], v[6:9], a[0:3] cbsz:3 abid:2 blgp:1
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    global_store_dwordx4 v0, a[0:3], s[6:7]
; HEURRC-NEXT:    s_endpgm
;
...
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[26:27]
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[28:29]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[30:31]
...
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 a[0:15], v[2:5], v[6:9], a[16:31]
...
; SDAG-NEXT:    global_store_dwordx4 v0, v[10:13], s[0:1] offset:48 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; HEURRC-NEXT:    global_store_dwordx4 v0, v[10:13], s[0:1] offset:48 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    v_mov_b32_e32 v10, s20
; SDAG-NEXT:    v_mov_b32_e32 v11, s21
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 a[0:15], v[2:5], v[6:9], a[16:31] cbsz:1 abid:2 blgp:3
; SDAG-NEXT:    v_mov_b32_e32 v12, s22
; SDAG-NEXT:    v_mov_b32_e32 v13, s23
; SDAG-NEXT:    v_mov_b32_e32 v2, s16
; SDAG-NEXT:    v_mov_b32_e32 v3, s17
...
; HEURRC-NEXT:    v_mov_b32_e32 v10, s20
; HEURRC-NEXT:    v_mov_b32_e32 v11, s21
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 a[0:15], v[2:5], v[6:9], a[16:31] cbsz:1 abid:2 blgp:3
; HEURRC-NEXT:    v_mov_b32_e32 v12, s22
; HEURRC-NEXT:    v_mov_b32_e32 v13, s23
; HEURRC-NEXT:    v_mov_b32_e32 v2, s16
; HEURRC-NEXT:    v_mov_b32_e32 v3, s17
...
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_mfma_f32_16x16x32_bf16 a[0:3], v[2:5], v[6:9], a[0:3]
; GCN-NEXT:    s_nop 7
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a3, s3
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_16x16x32_bf16 a[0:3], v[2:5], v[6:9], a[0:3]
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    global_store_dwordx4 v0, a[0:3], s[6:7]
; HEURRC-NEXT:    s_endpgm
;
...
; GCN-NEXT:    v_accvgpr_write_b32 a3, s3
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_mfma_f32_16x16x32_bf16 a[0:3], v[2:5], v[6:9], a[0:3] cbsz:3 abid:2 blgp:1
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    global_store_dwordx4 v0, a[0:3], s[6:7]
; GCN-NEXT:    s_endpgm
;
...
; HEURRC-NEXT:    v_accvgpr_write_b32 a3, s3
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_16x16x32_bf16 a[0:3], v[2:5], v[6:9], a[0:3] cbsz:3 abid:2 blgp:1
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    global_store_dwordx4 v0, a[0:3], s[6:7]
; HEURRC-NEXT:    s_endpgm
;
