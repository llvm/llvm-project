...
; RUN: llc -mtriple=amdgpu9.50 -global-isel=0 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,SDAG %s
; RUN: llc -mtriple=amdgpu9.50 -global-isel=1 < %s | FileCheck -enable-var-scope --check-prefixes=GCN,GISEL %s
; RUN: llc -mtriple=amdgpu9.50 -global-isel=0 --amdgpu-mfma-vgpr-form=0 < %s | FileCheck -enable-var-scope --check-prefixes=HEURRC %s
; RUN: llc -mtriple=amdgpu9.50 -global-isel=0 --amdgpu-mfma-vgpr-form=1 < %s | FileCheck -enable-var-scope --check-prefixes=VGPRRC %s
...
; SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[18:19]
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[40:43], v[44:47], v[0:15]
; SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[54:55], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[58:59], s[10:11]
; SDAG-NEXT:    v_mov_b64_e32 v[56:57], s[8:9]
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
; SDAG-NEXT:    s_nop 2
...
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[32:33], v[52:55], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v[38:39], v[56:59], off sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; HEURRC-NEXT:    v_mov_b64_e32 v[16:17], s[16:17]
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 a[16:31], v[8:11], v[12:15], a[0:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[18:19], s[18:19]
; HEURRC-NEXT:    v_mov_b64_e32 v[20:21], s[20:21]
; HEURRC-NEXT:    v_mov_b64_e32 v[22:23], s[22:23]
...
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[0:1], v[20:23], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v[6:7], v[24:27], off sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[50:51], s[18:19]
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[40:43], v[44:47], v[0:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[48:49], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[54:55], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[52:53], s[20:21]
; VGPRRC-NEXT:    v_mov_b64_e32 v[58:59], s[10:11]
; VGPRRC-NEXT:    v_mov_b64_e32 v[56:57], s[8:9]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
; VGPRRC-NEXT:    s_nop 2
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[32:33], v[52:55], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v[38:39], v[56:59], off sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; SDAG-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[34:37], v[38:41], v[0:15]
; SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[56:57], s[10:11]
; SDAG-NEXT:    v_mov_b64_e32 v[54:55], s[8:9]
; SDAG-NEXT:    global_store_dwordx4 v32, v[42:45], s[0:1] offset:48 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v32, v[46:49], s[0:1] offset:32 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v32, v[50:53], s[0:1] offset:16 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
; SDAG-NEXT:    global_store_dwordx4 v32, v[54:57], s[0:1] sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; HEURRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; HEURRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[34:37], v[38:41], v[0:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; HEURRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; HEURRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[56:57], s[10:11]
; HEURRC-NEXT:    v_mov_b64_e32 v[54:55], s[8:9]
; HEURRC-NEXT:    global_store_dwordx4 v32, v[42:45], s[0:1] offset:48 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v32, v[46:49], s[0:1] offset:32 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v32, v[50:53], s[0:1] offset:16 sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    global_store_dwordx4 v32, v[54:57], s[0:1] sc0 sc1
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[12:13], s[20:21]
; VGPRRC-NEXT:    v_mov_b64_e32 v[14:15], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[34:37], v[38:41], v[0:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[56:57], s[10:11]
; VGPRRC-NEXT:    v_mov_b64_e32 v[54:55], s[8:9]
; VGPRRC-NEXT:    global_store_dwordx4 v32, v[42:45], s[0:1] offset:48 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v32, v[46:49], s[0:1] offset:32 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v32, v[50:53], s[0:1] offset:16 sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    global_store_dwordx4 v32, v[54:57], s[0:1] sc0 sc1
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15]
; SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
...
; HEURRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; HEURRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; HEURRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; HEURRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; VGPRRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
...
; SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; SDAG-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15] cbsz:1 abid:2 blgp:3
; SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
...
; HEURRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; HEURRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15] cbsz:1 abid:2 blgp:3
; HEURRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; HEURRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; HEURRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[44:45], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[42:43], s[20:21]
; VGPRRC-NEXT:    v_mfma_i32_32x32x32_i8 v[16:31], v[34:37], v[38:41], v[0:15] cbsz:1 abid:2 blgp:3
; VGPRRC-NEXT:    v_mov_b64_e32 v[48:49], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[46:47], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[52:53], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[50:51], s[12:13]
