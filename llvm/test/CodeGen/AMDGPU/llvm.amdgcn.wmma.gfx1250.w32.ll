...
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr32_hi16 killed $sgpr0 killed $exec
...
; GISEL-REAL16-NEXT:    ; kill: def $vgpr32_hi16 killed $sgpr0 killed $exec
...
; GFX1250-REAL16:       ; %bb.0: ; %bb
; GFX1250-REAL16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr28_hi16 killed $sgpr0 killed $exec
...
; GISEL-REAL16:       ; %bb.0: ; %bb
; GISEL-REAL16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GISEL-REAL16-NEXT:    ; kill: def $vgpr28_hi16 killed $sgpr0 killed $exec
...
; GFX1250-REAL16-NEXT:    v_dual_mov_b32 v31, v30 :: v_dual_mov_b32 v30, v29
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr28_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr29 killed $sgpr0 killed $exec
