...
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03-amd-amdhsa -enable-ipra=0 < %s | FileCheck -check-prefixes=GCN,MUBUF,SDAG %s
...
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03-amd-amdhsa -enable-ipra=0 < %s | FileCheck -check-prefixes=GCN,MUBUF,GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgpu7.01-amd-amdhsa -enable-ipra=0 < %s | FileCheck -check-prefixes=GCN,MUBUF,GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgpu9.00-amd-amdhsa -enable-ipra=0 < %s | FileCheck -check-prefixes=GCN,MUBUF,GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgpu9.00-amd-amdhsa -enable-ipra=0 -mattr=+enable-flat-scratch < %s | FileCheck -check-prefixes=GCN,FLATSCR,GISEL %s
