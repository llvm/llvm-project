...
; RUN: llc -global-isel=1 -mtriple=amdgpu11.00--amdpal < %s | FileCheck -check-prefix=GISEL-GFX11 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu10.30--amdpal < %s | FileCheck -check-prefix=GISEL-GFX10 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu11.00--amdpal < %s | FileCheck -check-prefix=DAGISEL-GFX11 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu10.30--amdpal < %s | FileCheck -check-prefix=DAGISEL-GFX10 %s
...
; DAGISEL-GFX11:       ; %bb.0:
; DAGISEL-GFX11-NEXT:    v_mov_b32_e32 v3, v0
; DAGISEL-GFX11-NEXT:    s_mov_b32 s3, s0
; DAGISEL-GFX11-NEXT:    ;;#ASMSTART
; DAGISEL-GFX11-NEXT:    s_nop
; DAGISEL-GFX11-NEXT:    ;;#ASMEND
; DAGISEL-GFX11-NEXT:    v_dual_mov_b32 v9, v1 :: v_dual_mov_b32 v10, v2
; DAGISEL-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; DAGISEL-GFX11-NEXT:    v_mov_b32_e32 v8, v3
