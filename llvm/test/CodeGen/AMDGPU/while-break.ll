...
; GCN-NEXT:    s_and_b32 s1, exec_lo, s3
; GCN-NEXT:    s_or_b32 s2, s1, s2
; GCN-NEXT:    s_andn2_b32 s1, exec_lo, s2
; GCN-NEXT:    s_cselect_b32 exec_lo, s1, s2
; GCN-NEXT:    s_cbranch_scc0 .LBB2_6
; GCN-NEXT:  .LBB2_2: ; %header
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc_lo, s0, v1
; GCN-NEXT:    v_cmp_ge_i32_e64 s4, s0, v1
; GCN-NEXT:    s_mov_b32 s3, exec_lo
; GCN-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GCN-NEXT:    s_cmov_b32 exec_lo, vcc_lo
...
; GCN-NEXT:    s_andn2_b32 s1, s4, exec_lo
