...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_v2bf16_noret:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX1210-NEXT:    flat_atomic_pk_add_bf16 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2bf16_rtn:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_atomic_fadd_v2bf16_noret:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX1210-NEXT:    global_atomic_pk_add_bf16 v0, v1, s[0:1]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: global_atomic_fadd_v2bf16_rtn:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
