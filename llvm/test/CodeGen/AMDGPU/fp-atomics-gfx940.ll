...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs | FileCheck %s -check-prefix=GFX1210
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_f32_noret:
; GFX1210:       ; %bb.0:
...
; GFX1210-NEXT:    flat_atomic_add_f32 v0, v1, s[0:1]
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_f32_noret_pat:
; GFX1210:       ; %bb.0:
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_load_b32 v1, v2, s[0:1]
; GFX1210-NEXT:  .LBB1_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    v_add_f32_e32 v0, 4.0, v1
; GFX1210-NEXT:    global_wb scope:SCOPE_SYS
; GFX1210-NEXT:    flat_atomic_cmpswap_b32 v0, v2, v[0:1], s[0:1] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_f32_noret_pat_ieee:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_load_b32 v1, v2, s[0:1]
; GFX1210-NEXT:  .LBB2_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    v_add_f32_e32 v0, 4.0, v1
; GFX1210-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB2_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_endpgm
  %ret = atomicrmw fadd ptr %ptr, float 4.0 seq_cst
  ret void
...
;
; GFX1210-LABEL: flat_atomic_fadd_f32_rtn:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f32_rtn_pat:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    v_add_f32_e32 v2, 4.0, v3
; GFX1210-NEXT:    global_wb scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    flat_atomic_cmpswap_b32 v2, v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_inv scope:SCOPE_SYS
...
; GFX1210-NEXT:    s_cbranch_execnz .LBB4_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_noret:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX1210-NEXT:    flat_atomic_pk_add_f16 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_rtn:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_atomic_fadd_v2f16_noret:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1210-NEXT:    ds_pk_add_f16 v0, v1
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_atomic_fadd_v2bf16_noret:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1210-NEXT:    ds_pk_add_bf16 v0, v1
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f32_intrinsic_ret__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f32 v0, v[0:1], v2 offset:4092 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f32_intrinsic_ret__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f32 v0, v[0:1], v2 offset:-1024 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f32_intrinsic_noret__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f32 v[0:1], v2 offset:4092
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr float, ptr %ptr, i64 1023
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f32_intrinsic_noret__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f32 v[0:1], v2 offset:-1024
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr float, ptr %ptr, i64 -256
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_intrinsic_ret__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_pk_add_f16 v0, v[0:1], v2 offset:4092 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_intrinsic_ret__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_pk_add_f16 v0, v[0:1], v2 offset:-1024 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_intrinsic_noret__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_pk_add_f16 v[0:1], v2 offset:4092
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr <2 x half>, ptr %ptr, i64 1023
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_v2f16_intrinsic_noret__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_atomic_pk_add_f16 v[0:1], v2 offset:-1024
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr <2 x half>, ptr %ptr, i64 -256
