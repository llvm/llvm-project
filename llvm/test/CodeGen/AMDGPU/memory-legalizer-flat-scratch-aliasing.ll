; RUN: llc -mtriple=amdgcn-amd-amdhsa -O3 -mcpu=gfx1250 -mattr=+globally-addressable-scratch < %s | FileCheck --check-prefixes=GFX1250,GFX1250-GAS %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -O3 -mcpu=gfx1250 -mattr=-globally-addressable-scratch < %s | FileCheck --check-prefixes=GFX1250,GFX1250-NOGAS %s
...
; GFX1250:          flat_store_b32 v{{[0-9]+}}, v{{[0-9]+}}, s[{{[0-9]}}:{{[0-9]}}] scope:SCOPE_SE
...
; GFX1250-GAS:      flat_store_b32 v{{[0-9]+}}, v{{[0-9]+}}, s[{{[0-9]}}:{{[0-9]}}] scope:SCOPE_SE
; GFX1250-NOGAS:    flat_store_b32 v{{[0-9]+}}, v{{[0-9]+}}, s[{{[0-9]}}:{{[0-9]}}]{{$}}
