...
; GFX908-NEXT:    s_load_dwordx8 s[12:19], s[8:9], 0x0
; GFX908-NEXT:    s_mov_b32 s4, 0
; GFX908-NEXT:    s_mov_b32 s7, s4
; GFX908-NEXT:    v_mov_b32_e32 v17, 0
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_cvt_f32_u32_e32 v0, s15
; GFX908-NEXT:    s_sub_i32 s0, 0, s15
; GFX908-NEXT:    v_cvt_f32_f16_e32 v18, s18
; GFX908-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX908-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX908-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX908-NEXT:    v_readfirstlane_b32 s1, v0
; GFX908-NEXT:    s_mul_i32 s0, s0, s1
; GFX908-NEXT:    s_mul_hi_u32 s0, s1, s0
; GFX908-NEXT:    s_add_i32 s1, s1, s0
; GFX908-NEXT:    s_mul_hi_u32 s0, s14, s1
; GFX908-NEXT:    s_mul_i32 s1, s0, s15
; GFX908-NEXT:    s_sub_i32 s1, s14, s1
; GFX908-NEXT:    s_add_i32 s2, s0, 1
; GFX908-NEXT:    s_sub_i32 s3, s1, s15
; GFX908-NEXT:    s_cmp_ge_u32 s1, s15
; GFX908-NEXT:    s_cselect_b32 s0, s2, s0
; GFX908-NEXT:    s_cselect_b32 s1, s3, s1
; GFX908-NEXT:    s_add_i32 s2, s0, 1
; GFX908-NEXT:    s_cmp_ge_u32 s1, s15
; GFX908-NEXT:    s_cselect_b32 s6, s2, s0
; GFX908-NEXT:    s_lshr_b32 s2, s18, 16
...
; GFX908-NEXT:    s_mul_i32 s3, s13, s2
; GFX908-NEXT:    s_mul_hi_u32 s5, s12, s2
; GFX908-NEXT:    s_mul_i32 s2, s12, s2
; GFX908-NEXT:    s_add_i32 s3, s5, s3
; GFX908-NEXT:    s_lshl_b64 s[12:13], s[2:3], 5
; GFX908-NEXT:    s_branch .LBB3_2
; GFX908-NEXT:  .LBB3_1: ; %Flow23
...
; GFX908-NEXT:    v_cmp_gt_i64_e64 s[2:3], s[16:17], -1
...
; GFX908-NEXT:    v_cmp_lt_i64_e64 s[18:19], s[16:17], 0
...
; GFX908-NEXT:    s_mul_hi_u32 s22, s8, s5
; GFX908-NEXT:    s_mul_i32 s7, s8, s7
; GFX908-NEXT:    s_mul_i32 s23, s9, s5
; GFX908-NEXT:    s_add_i32 s7, s22, s7
; GFX908-NEXT:    s_mul_i32 s5, s8, s5
; GFX908-NEXT:    s_add_i32 s7, s7, s23
...
; GFX908-NEXT:    s_add_u32 s20, s20, s12
; GFX908-NEXT:    v_cmp_lt_i64_e64 s[24:25], -1, v[2:3]
; GFX908-NEXT:    s_addc_u32 s21, s21, s13
...
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_add_u32 s16, s16, s6
; GFX908-NEXT:    s_addc_u32 s17, s17, 0
; GFX908-NEXT:    s_add_u32 s10, s10, s14
; GFX908-NEXT:    s_addc_u32 s11, s11, s15
...
; GFX90A-NEXT:    s_mul_hi_u32 s0, s14, s1
; GFX90A-NEXT:    s_mul_i32 s1, s0, s15
; GFX90A-NEXT:    s_sub_i32 s1, s14, s1
; GFX90A-NEXT:    s_add_i32 s2, s0, 1
; GFX90A-NEXT:    s_sub_i32 s3, s1, s15
; GFX90A-NEXT:    s_cmp_ge_u32 s1, s15
; GFX90A-NEXT:    s_cselect_b32 s0, s2, s0
; GFX90A-NEXT:    s_cselect_b32 s1, s3, s1
; GFX90A-NEXT:    s_add_i32 s2, s0, 1
; GFX90A-NEXT:    s_cmp_ge_u32 s1, s15
; GFX90A-NEXT:    s_cselect_b32 s6, s2, s0
; GFX90A-NEXT:    s_lshr_b32 s2, s18, 16
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v1, s2
; GFX90A-NEXT:    s_lshl_b64 s[10:11], s[16:17], 5
; GFX90A-NEXT:    s_lshl_b64 s[8:9], s[12:13], 5
...
; GFX90A-NEXT:    s_mul_i32 s3, s13, s2
; GFX90A-NEXT:    s_mul_hi_u32 s5, s12, s2
; GFX90A-NEXT:    s_mul_i32 s2, s12, s2
; GFX90A-NEXT:    s_add_i32 s3, s5, s3
; GFX90A-NEXT:    s_lshl_b64 s[12:13], s[2:3], 5
; GFX90A-NEXT:    s_branch .LBB3_2
; GFX90A-NEXT:  .LBB3_1: ; %Flow23
...
; GFX90A-NEXT:    v_cmp_gt_i64_e64 s[2:3], s[16:17], -1
...
; GFX90A-NEXT:    v_cmp_lt_i64_e64 s[18:19], s[16:17], 0
...
; GFX90A-NEXT:    v_readfirstlane_b32 s7, v5
; GFX90A-NEXT:    s_add_u32 s5, s5, 1
; GFX90A-NEXT:    s_addc_u32 s7, s7, 0
; GFX90A-NEXT:    s_mul_hi_u32 s22, s8, s5
; GFX90A-NEXT:    s_mul_i32 s7, s8, s7
; GFX90A-NEXT:    s_mul_i32 s23, s9, s5
; GFX90A-NEXT:    s_add_i32 s7, s22, s7
; GFX90A-NEXT:    s_mul_i32 s5, s8, s5
; GFX90A-NEXT:    s_add_i32 s7, s7, s23
...
; GFX90A-NEXT:    s_add_u32 s20, s20, s12
; GFX90A-NEXT:    s_addc_u32 s21, s21, s13
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_add_u32 s16, s16, s6
; GFX90A-NEXT:    s_addc_u32 s17, s17, 0
; GFX90A-NEXT:    s_add_u32 s10, s10, s14
; GFX90A-NEXT:    s_addc_u32 s11, s11, s15
