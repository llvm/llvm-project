...
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    v_cvt_f32_u32_e32 v1, s7
; GFX908-NEXT:    s_sub_i32 s1, 0, s7
; GFX908-NEXT:    v_cvt_f32_f16_e32 v13, s0
...
; GFX908-NEXT:    s_add_i32 s9, s1, 1
; GFX908-NEXT:    s_sub_i32 s8, s6, s7
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_readfirstlane_b32 s11, v0
; GFX908-NEXT:    s_and_b32 s20, s11, 0xffff
; GFX908-NEXT:    s_cmp_ge_u32 s6, s7
; GFX908-NEXT:    s_cselect_b32 s1, s9, s1
; GFX908-NEXT:    s_cselect_b32 s6, s8, s6
; GFX908-NEXT:    s_add_i32 s8, s1, 1
; GFX908-NEXT:    s_cmp_ge_u32 s6, s7
; GFX908-NEXT:    s_cselect_b32 s21, s8, s1
; GFX908-NEXT:    s_lshr_b32 s1, s0, 16
; GFX908-NEXT:    v_cvt_f32_f16_e32 v12, s1
; GFX908-NEXT:    s_and_b64 s[0:1], exec, s[0:1]
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
; GFX908-NEXT:    s_branch .LBB3_2
; GFX908-NEXT:  .LBB3_1: ; %Flow10
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GFX908-NEXT:    s_cselect_b32 s8, 1, 0
; GFX908-NEXT:    s_cmp_lg_u32 s8, 1
...
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_load_dwordx2 s[14:15], s[6:7], 0x0
; GFX908-NEXT:    s_cmp_lt_i32 s3, 0
; GFX908-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX908-NEXT:    s_cmp_gt_i32 s3, -1
; GFX908-NEXT:    s_mov_b32 s11, s10
; GFX908-NEXT:    s_cselect_b64 s[12:13], -1, 0
...
; GFX908-NEXT:  .LBB3_4: ; %Flow8
; GFX908-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX908-NEXT:    s_cselect_b32 s11, 1, 0
; GFX908-NEXT:    s_cmp_lg_u32 s11, 1
; GFX908-NEXT:    s_cbranch_scc0 .LBB3_10
; GFX908-NEXT:  .LBB3_5: ; %bb16
; GFX908-NEXT:    ; Parent Loop BB3_2 Depth=1
; GFX908-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    s_add_u32 s11, s14, 1
; GFX908-NEXT:    s_addc_u32 s16, s15, 0
; GFX908-NEXT:    s_mul_i32 s17, s11, s5
; GFX908-NEXT:    s_mul_hi_u32 s18, s11, s4
; GFX908-NEXT:    s_add_i32 s17, s18, s17
; GFX908-NEXT:    s_mul_i32 s16, s16, s4
; GFX908-NEXT:    s_add_i32 s17, s17, s16
; GFX908-NEXT:    s_mul_i32 s11, s11, s4
; GFX908-NEXT:    s_add_u32 s16, s11, s2
; GFX908-NEXT:    s_addc_u32 s17, s17, s3
; GFX908-NEXT:    s_lshl_b64 s[16:17], s[16:17], 5
; GFX908-NEXT:    global_load_dword v16, v14, s[16:17] offset:16 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v15, v14, s[16:17] offset:20 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v8, v14, s[16:17] offset:24 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v8, v14, s[16:17] offset:28 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    ds_read_b64 v[8:9], v14
; GFX908-NEXT:    ds_read_b64 v[10:11], v0
; GFX908-NEXT:    ; kill: killed $sgpr16_sgpr17
; GFX908-NEXT:    s_and_b64 s[16:17], s[12:13], exec
; GFX908-NEXT:    s_cselect_b32 s11, 1, 0
; GFX908-NEXT:    s_cmp_lg_u32 s11, 1
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX908-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    v_add_f32_e32 v17, v13, v8
; GFX908-NEXT:    v_add_f32_e32 v18, v12, v9
...
; GFX908-NEXT:    s_mov_b64 s[18:19], s[8:9]
...
; GFX908-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    s_add_u32 s14, s14, s20
; GFX908-NEXT:    s_addc_u32 s15, s15, 0
; GFX908-NEXT:    s_cmp_gt_i32 s15, -1
...
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_xor_b64 s[12:13], s[16:17], -1
; GFX908-NEXT:  .LBB3_11: ; %Flow9
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_mov_b64 s[8:9], -1
; GFX908-NEXT:    s_and_b64 vcc, exec, s[12:13]
; GFX908-NEXT:    s_cbranch_vccz .LBB3_1
; GFX908-NEXT:  ; %bb.12: ; %bb12
; GFX908-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX908-NEXT:    s_add_u32 s2, s2, s21
...
; GFX90A:       ; %bb.0: ; %bb
; GFX90A-NEXT:    global_load_ushort v0, v[0:1], off glc
...
; GFX90A-NEXT:    s_add_i32 s9, s1, 1
; GFX90A-NEXT:    s_sub_i32 s8, s6, s7
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_readfirstlane_b32 s11, v0
; GFX90A-NEXT:    s_and_b32 s20, s11, 0xffff
; GFX90A-NEXT:    s_cmp_ge_u32 s6, s7
; GFX90A-NEXT:    s_cselect_b32 s1, s9, s1
; GFX90A-NEXT:    s_cselect_b32 s6, s8, s6
; GFX90A-NEXT:    s_add_i32 s8, s1, 1
; GFX90A-NEXT:    s_cmp_ge_u32 s6, s7
; GFX90A-NEXT:    s_cselect_b32 s21, s8, s1
; GFX90A-NEXT:    s_lshr_b32 s1, s0, 16
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v1, s1
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v0, s0
; GFX90A-NEXT:    s_and_b64 s[0:1], exec, s[0:1]
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A-NEXT:    s_branch .LBB3_2
; GFX90A-NEXT:  .LBB3_1: ; %Flow10
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; GFX90A-NEXT:    s_cselect_b32 s8, 1, 0
; GFX90A-NEXT:    s_cmp_lg_u32 s8, 1
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_load_dwordx2 s[14:15], s[6:7], 0x0
...
; GFX90A-NEXT:  .LBB3_4: ; %Flow8
; GFX90A-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX90A-NEXT:    s_and_b64 s[18:19], s[18:19], exec
; GFX90A-NEXT:    s_cselect_b32 s11, 1, 0
; GFX90A-NEXT:    s_cmp_lg_u32 s11, 1
; GFX90A-NEXT:    s_cbranch_scc0 .LBB3_10
; GFX90A-NEXT:  .LBB3_5: ; %bb16
; GFX90A-NEXT:    ; Parent Loop BB3_2 Depth=1
; GFX90A-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_add_u32 s11, s14, 1
; GFX90A-NEXT:    s_addc_u32 s16, s15, 0
; GFX90A-NEXT:    s_mul_i32 s17, s11, s5
; GFX90A-NEXT:    s_mul_hi_u32 s18, s11, s4
; GFX90A-NEXT:    s_add_i32 s17, s18, s17
; GFX90A-NEXT:    s_mul_i32 s16, s16, s4
; GFX90A-NEXT:    s_add_i32 s17, s17, s16
; GFX90A-NEXT:    s_mul_i32 s11, s11, s4
; GFX90A-NEXT:    s_add_u32 s16, s11, s2
; GFX90A-NEXT:    s_addc_u32 s17, s17, s3
; GFX90A-NEXT:    s_lshl_b64 s[16:17], s[16:17], 5
; GFX90A-NEXT:    global_load_dword v16, v14, s[16:17] offset:16 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v15, v14, s[16:17] offset:20 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v10, v14, s[16:17] offset:24 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v10, v14, s[16:17] offset:28 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    ds_read_b64 v[10:11], v14
; GFX90A-NEXT:    ds_read_b64 v[12:13], v0
; GFX90A-NEXT:    ; kill: killed $sgpr16_sgpr17
; GFX90A-NEXT:    s_and_b64 s[16:17], s[12:13], exec
; GFX90A-NEXT:    s_cselect_b32 s11, 1, 0
; GFX90A-NEXT:    s_cmp_lg_u32 s11, 1
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    s_mov_b64 s[18:19], s[8:9]
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX90A-NEXT:    s_add_u32 s14, s14, s20
; GFX90A-NEXT:    s_addc_u32 s15, s15, 0
; GFX90A-NEXT:    s_cmp_gt_i32 s15, -1
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_xor_b64 s[12:13], s[16:17], -1
; GFX90A-NEXT:  .LBB3_11: ; %Flow9
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_mov_b64 s[8:9], -1
; GFX90A-NEXT:    s_and_b64 vcc, exec, s[12:13]
; GFX90A-NEXT:    s_cbranch_vccz .LBB3_1
; GFX90A-NEXT:  ; %bb.12: ; %bb12
; GFX90A-NEXT:    ; in Loop: Header=BB3_2 Depth=1
; GFX90A-NEXT:    s_add_u32 s2, s2, s21
