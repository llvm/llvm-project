...
; GLOBALNESS1-NEXT:    s_load_dword s10, s[8:9], 0x14
...
; GLOBALNESS1-NEXT:    s_load_dword s12, s[8:9], 0x20
; GLOBALNESS1-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GLOBALNESS1-NEXT:    s_mov_b64 s[38:39], s[8:9]
; GLOBALNESS1-NEXT:    s_xor_b64 s[8:9], s[6:7], -1
...
; GLOBALNESS1-NEXT:    s_xor_b64 s[10:11], s[10:11], -1
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v1, 0x40994400
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s12, 0
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e32 vcc, s[4:5], v[0:1]
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[4:5], s[4:5], 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GLOBALNESS1-NEXT:    s_xor_b64 s[12:13], s[12:13], -1
; GLOBALNESS1-NEXT:    s_mov_b32 s65, s15
; GLOBALNESS1-NEXT:    s_mov_b32 s66, s14
; GLOBALNESS1-NEXT:    s_mov_b32 s64, s16
...
; GLOBALNESS1-NEXT:    v_readfirstlane_b32 s5, v2
; GLOBALNESS1-NEXT:    s_cmp_lt_i32 s5, 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GLOBALNESS1-NEXT:    s_cmp_lt_i32 s5, 1
; GLOBALNESS1-NEXT:    s_cselect_b64 s[16:17], -1, 0
; GLOBALNESS1-NEXT:    s_cmp_eq_u32 s5, 1
; GLOBALNESS1-NEXT:    s_cselect_b64 s[18:19], -1, 0
; GLOBALNESS1-NEXT:    s_cmp_eq_u32 s5, 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[20:21], -1, 0
; GLOBALNESS1-NEXT:    s_and_b32 s33, s6, 1
; GLOBALNESS1-NEXT:    s_and_b32 s67, s14, 1
; GLOBALNESS1-NEXT:    s_and_b32 s70, s8, 1
; GLOBALNESS1-NEXT:    s_and_b32 s84, s10, 1
; GLOBALNESS1-NEXT:    s_and_b32 s85, vcc_lo, 1
; GLOBALNESS1-NEXT:    s_and_b32 s86, s4, 1
; GLOBALNESS1-NEXT:    s_and_b32 s87, s16, 1
; GLOBALNESS1-NEXT:    s_and_b32 s96, s12, 1
; GLOBALNESS1-NEXT:    s_and_b32 s97, s18, 1
; GLOBALNESS1-NEXT:    s_and_b32 s98, s20, 1
; GLOBALNESS1-NEXT:    s_branch .LBB1_4
; GLOBALNESS1-NEXT:  .LBB1_1: ; %bb70.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s98, 1
...
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s66
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s64
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s33, 1
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr68_sgpr69
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_9
; GLOBALNESS1-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_mov_b64 s[68:69], -1
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_bitcmp0_b32 s6, 0
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_9
; GLOBALNESS1-NEXT:  ; %bb.8: ; %LeafBlock
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s71, 0
; GLOBALNESS1-NEXT:    s_mov_b64 s[68:69], 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[80:81], s[50:51]
...
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_13
...
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[52:53], 0, v2
; GLOBALNESS1-NEXT:    s_and_b32 s69, vcc_lo, 1
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s96, 1
...
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s70, 1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS1-NEXT:  ; %bb.17: ; %bb46.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s84, 1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS1-NEXT:  ; %bb.18: ; %bb50.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s85, 1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_21
; GLOBALNESS1-NEXT:  ; %bb.19: ; %bb3.i.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s86, 1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_21
; GLOBALNESS1-NEXT:  ; %bb.20: ; %bb6.i.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s69, 1
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s54, s38, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s55, s39, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[82:83], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[48:49]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[54:55]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s66
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s65
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s64
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[82:83]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[48:49]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[54:55]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[34:35]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s97, 1
...
; GLOBALNESS1-NEXT:    s_bitcmp0_b32 s68, 0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS1-NEXT:    s_cbranch_scc0 .LBB1_31
...
; GLOBALNESS1-NEXT:    s_bitcmp0_b32 s4, 0
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_33
...
; GLOBALNESS0-NEXT:    s_load_dword s10, s[8:9], 0x14
...
; GLOBALNESS0-NEXT:    s_load_dword s12, s[8:9], 0x20
; GLOBALNESS0-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GLOBALNESS0-NEXT:    s_mov_b64 s[38:39], s[8:9]
; GLOBALNESS0-NEXT:    s_xor_b64 s[8:9], s[6:7], -1
...
; GLOBALNESS0-NEXT:    s_xor_b64 s[10:11], s[10:11], -1
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v1, 0x40994400
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s12, 0
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e32 vcc, s[4:5], v[0:1]
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[4:5], s[4:5], 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[12:13], s[12:13], -1
; GLOBALNESS0-NEXT:    s_mov_b32 s55, s15
; GLOBALNESS0-NEXT:    s_mov_b32 s64, s14
; GLOBALNESS0-NEXT:    s_mov_b32 s54, s16
...
; GLOBALNESS0-NEXT:    v_readfirstlane_b32 s5, v2
; GLOBALNESS0-NEXT:    s_cmp_lt_i32 s5, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[14:15], -1, 0
; GLOBALNESS0-NEXT:    s_cmp_lt_i32 s5, 1
; GLOBALNESS0-NEXT:    s_cselect_b64 s[16:17], -1, 0
; GLOBALNESS0-NEXT:    s_cmp_eq_u32 s5, 1
; GLOBALNESS0-NEXT:    s_cselect_b64 s[18:19], -1, 0
; GLOBALNESS0-NEXT:    s_cmp_eq_u32 s5, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[20:21], -1, 0
; GLOBALNESS0-NEXT:    s_and_b32 s33, s6, 1
; GLOBALNESS0-NEXT:    s_and_b32 s65, s14, 1
; GLOBALNESS0-NEXT:    s_and_b32 s70, s8, 1
; GLOBALNESS0-NEXT:    s_and_b32 s82, s10, 1
; GLOBALNESS0-NEXT:    s_and_b32 s83, vcc_lo, 1
; GLOBALNESS0-NEXT:    s_and_b32 s84, s4, 1
; GLOBALNESS0-NEXT:    s_and_b32 s85, s16, 1
; GLOBALNESS0-NEXT:    s_and_b32 s86, s12, 1
; GLOBALNESS0-NEXT:    s_and_b32 s87, s18, 1
; GLOBALNESS0-NEXT:    s_and_b32 s96, s20, 1
; GLOBALNESS0-NEXT:    s_branch .LBB1_4
; GLOBALNESS0-NEXT:  .LBB1_1: ; %bb70.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s96, 1
...
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s64
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s55
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s54
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s33, 1
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr68_sgpr69
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_9
; GLOBALNESS0-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_mov_b64 s[68:69], -1
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_bitcmp0_b32 s6, 0
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_9
; GLOBALNESS0-NEXT:  ; %bb.8: ; %LeafBlock
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s71, 0
; GLOBALNESS0-NEXT:    s_mov_b64 s[68:69], 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[80:81], s[50:51]
...
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s65, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_13
...
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[52:53], 0, v2
; GLOBALNESS0-NEXT:    s_and_b32 s69, vcc_lo, 1
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s86, 1
...
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s70, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.17: ; %bb46.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s82, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.18: ; %bb50.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s83, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_21
; GLOBALNESS0-NEXT:  ; %bb.19: ; %bb3.i.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s84, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_21
; GLOBALNESS0-NEXT:  ; %bb.20: ; %bb6.i.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s69, 1
; GLOBALNESS0-NEXT:  .LBB1_21: ; %spam.exit.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s85, 1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.22: ; %bb55.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s66, s38, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s67, s39, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[98:99], s[4:5], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[48:49]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], s[66:67]
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s64
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s55
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s54
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s87, 1
...
; GLOBALNESS0-NEXT:    s_bitcmp0_b32 s68, 0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS0-NEXT:    s_cbranch_scc0 .LBB1_31
...
; GLOBALNESS0-NEXT:    s_bitcmp0_b32 s4, 0
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_33
