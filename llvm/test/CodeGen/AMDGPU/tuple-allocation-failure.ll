...
; GLOBALNESS1-NEXT:    s_mov_b32 s53, 0
...
; GLOBALNESS1-NEXT:    s_mov_b32 s9, s53
...
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e32 vcc, s[8:9], v[0:1]
; GLOBALNESS1-NEXT:    v_cmp_ngt_f64_e64 s[8:9], s[8:9], 0
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[8:9]
; GLOBALNESS1-NEXT:    s_xor_b64 s[8:9], s[10:11], -1
...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[10:11]
; GLOBALNESS1-NEXT:    s_xor_b64 s[4:5], s[4:5], -1
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[70:71], 1, v3
; GLOBALNESS1-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[8:9]
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[64:65], 1, v3
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[50:51], s[86:87]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_or_b64 exec, exec, s[50:51]
...
; GLOBALNESS0-NEXT:    s_mov_b32 s53, 0
...
; GLOBALNESS0-NEXT:    s_mov_b32 s9, s53
...
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e32 vcc, s[8:9], v[0:1]
; GLOBALNESS0-NEXT:    v_cmp_ngt_f64_e64 s[8:9], s[8:9], 0
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[8:9]
; GLOBALNESS0-NEXT:    s_xor_b64 s[8:9], s[10:11], -1
...
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[10:11]
; GLOBALNESS0-NEXT:    s_xor_b64 s[4:5], s[4:5], -1
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[82:83], 1, v3
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[8:9]
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[64:65], 1, v3
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s52, 8
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s53, 9
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s54, 10
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s55, 11
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[68:69], 1, v3
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s82, 12
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s83, 13
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[50:51], s[86:87]
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s8, 14
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s9, 15
...
; GLOBALNESS0-NEXT:    v_readlane_b32 s7, v57, 11
; GLOBALNESS0-NEXT:    v_readlane_b32 s82, v57, 12
; GLOBALNESS0-NEXT:    v_readlane_b32 s8, v57, 14
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[0:1], 0, 0
; GLOBALNESS0-NEXT:    s_mov_b32 s55, s7
; GLOBALNESS0-NEXT:    v_readlane_b32 s83, v57, 13
; GLOBALNESS0-NEXT:    v_readlane_b32 s9, v57, 15
; GLOBALNESS0-NEXT:    v_readlane_b32 s5, v57, 9
; GLOBALNESS0-NEXT:    v_readlane_b32 s6, v57, 10
; GLOBALNESS0-NEXT:  .LBB1_26: ; %Flow26
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_or_b64 exec, exec, s[50:51]
