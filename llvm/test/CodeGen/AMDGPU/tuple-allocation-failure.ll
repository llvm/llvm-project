...
; GLOBALNESS1-NEXT:    s_load_dword s4, s[8:9], 0x14
...
; GLOBALNESS1-NEXT:    s_load_dword s6, s[8:9], 0x20
; GLOBALNESS1-NEXT:    s_cselect_b64 s[82:83], -1, 0
; GLOBALNESS1-NEXT:    s_xor_b64 s[84:85], s[82:83], -1
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s4, 0
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[70:71], s[50:51]
...
; GLOBALNESS1-NEXT:    v_cndmask_b32_e32 v0, 0, v40, vcc
...
; GLOBALNESS1-NEXT:    s_and_b64 s[4:5], s[84:85], exec
; GLOBALNESS1-NEXT:    s_cselect_b32 s4, 1, 0
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s4, 1
...
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[98:99], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
...
; GLOBALNESS0-NEXT:    s_load_dword s4, s[48:49], 0x14
...
; GLOBALNESS0-NEXT:    s_load_dword s6, s[48:49], 0x20
; GLOBALNESS0-NEXT:    s_cselect_b64 s[82:83], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[84:85], s[82:83], -1
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s4, 0
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[12:13], -1
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[12:13], 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s7, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:  .LBB1_9: ; %Flow27
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s12, 0
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s13, 1
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[70:71], s[50:51]
...
; GLOBALNESS0-NEXT:    v_cndmask_b32_e32 v0, 0, v40, vcc
...
; GLOBALNESS0-NEXT:    s_and_b64 s[4:5], s[84:85], exec
; GLOBALNESS0-NEXT:    s_cselect_b32 s4, 1, 0
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s4, 1
