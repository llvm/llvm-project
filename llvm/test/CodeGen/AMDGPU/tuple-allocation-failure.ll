...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[84:85], -1, 0
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_gt_f64_e64 s[50:51], s[4:5], v[0:1]
; GLOBALNESS1-NEXT:    v_cmp_gt_f64_e64 s[80:81], s[4:5], 0
...
; GLOBALNESS1-NEXT:    s_mov_b32 s33, s16
; GLOBALNESS1-NEXT:    s_mov_b64 s[48:49], s[8:9]
; GLOBALNESS1-NEXT:    s_mov_b32 s70, s15
; GLOBALNESS1-NEXT:    s_mov_b32 s71, s14
...
; GLOBALNESS1-NEXT:    v_cmp_lt_i32_e64 s[52:53], 0, v2
...
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s71
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s70
...
; GLOBALNESS1-NEXT:    s_and_b64 s[6:7], s[84:85], exec
; GLOBALNESS1-NEXT:    s_cselect_b32 s6, 1, 0
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s6, 1
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr6_sgpr7
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS1-NEXT:    ; kill: killed $sgpr6_sgpr7
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], -1
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_10
; GLOBALNESS1-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], -1
...
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GLOBALNESS1-NEXT:  .LBB1_9: ; %Flow18
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s10, 6
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s11, 7
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[82:83], s[54:55]
...
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS1-NEXT:    v_cmp_lt_f64_e64 s[64:65], 0, v[0:1]
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[66:67], 0, v2
; GLOBALNESS1-NEXT:    s_branch .LBB1_17
; GLOBALNESS1-NEXT:  .LBB1_15: ; %Flow14
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_17 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s68, s48, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s69, s49, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
...
; GLOBALNESS1-NEXT:    s_load_dwordx4 s[64:67], s[48:49], 0x0
...
; GLOBALNESS0-NEXT:    s_cselect_b64 s[84:85], -1, 0
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_gt_f64_e64 s[50:51], s[4:5], v[0:1]
; GLOBALNESS0-NEXT:    v_cmp_gt_f64_e64 s[80:81], s[4:5], 0
...
; GLOBALNESS0-NEXT:    s_mov_b32 s68, s15
; GLOBALNESS0-NEXT:    s_mov_b32 s69, s14
...
; GLOBALNESS0-NEXT:    v_cmp_lt_i32_e64 s[52:53], 0, v2
...
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s69
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s68
...
; GLOBALNESS0-NEXT:    s_and_b64 s[6:7], s[84:85], exec
; GLOBALNESS0-NEXT:    s_cselect_b32 s6, 1, 0
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s6, 1
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr6_sgpr7
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], -1
; GLOBALNESS0-NEXT:    ; kill: killed $sgpr6_sgpr7
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], -1
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_10
; GLOBALNESS0-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], -1
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GLOBALNESS0-NEXT:  .LBB1_9: ; %Flow18
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s10, 6
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s11, 7
...
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[82:83], s[54:55]
...
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS0-NEXT:    v_cmp_lt_f64_e64 s[64:65], 0, v[0:1]
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[66:67], 0, v2
; GLOBALNESS0-NEXT:    s_branch .LBB1_17
; GLOBALNESS0-NEXT:  .LBB1_15: ; %Flow14
...
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[64:67], s[48:49], 0x0
