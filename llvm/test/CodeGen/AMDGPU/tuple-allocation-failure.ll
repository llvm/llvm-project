...
; GLOBALNESS1-NEXT:    s_not_b32 s8, s54
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v59, s4, 0
; GLOBALNESS1-NEXT:    v_writelane_b32 v59, s5, 1
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:    s_not_b32 s6, s6
...
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:    s_not_b32 s6, s7
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
...
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr10_sgpr11
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v59, s10, 10
; GLOBALNESS1-NEXT:    v_writelane_b32 v59, s11, 11
...
; GLOBALNESS1-NEXT:    s_andn2_b64 vcc, exec, s[10:11]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], -1
...
; GLOBALNESS0-NEXT:    s_not_b32 s8, s54
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s4, 0
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s5, 1
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_not_b32 s6, s6
...
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_not_b32 s6, s7
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
...
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr10_sgpr11
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s10, 10
; GLOBALNESS0-NEXT:    v_writelane_b32 v59, s11, 11
...
; GLOBALNESS0-NEXT:    s_andn2_b64 vcc, exec, s[10:11]
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], -1
