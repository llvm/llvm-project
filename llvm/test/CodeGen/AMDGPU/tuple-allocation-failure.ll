...
; GLOBALNESS1-NEXT:    global_load_dword v0, v42, s[52:53]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s68, 0
; GLOBALNESS1-NEXT:    s_mov_b32 s69, 0x40994400
; GLOBALNESS1-NEXT:    s_xor_b64 s[86:87], s[4:5], -1
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v43, v42
; GLOBALNESS1-NEXT:    s_mov_b32 s32, 0
; GLOBALNESS1-NEXT:    ; implicit-def: $vgpr60_vgpr61
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS1-NEXT:    v_readfirstlane_b32 s33, v0
; GLOBALNESS1-NEXT:    s_branch .LBB1_4
; GLOBALNESS1-NEXT:  .LBB1_1: ; %bb70.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_cmp_lg_u32 s33, 0
; GLOBALNESS1-NEXT:    s_cbranch_scc0 .LBB1_28
...
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[60:61], v[0:1], v[0:1] op_sel:[0,1]
...
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr96_sgpr97
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_9
; GLOBALNESS1-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    s_mov_b64 s[96:97], -1
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[98:99], s[50:51]
; GLOBALNESS1-NEXT:    s_cbranch_execz .LBB1_25
; GLOBALNESS1-NEXT:  ; %bb.11: ; %bb33.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    global_load_dwordx2 v[56:57], v[44:45], off
; GLOBALNESS1-NEXT:    s_mov_b32 s67, s55
; GLOBALNESS1-NEXT:    s_cmp_gt_i32 s33, -1
...
; GLOBALNESS1-NEXT:    v_cndmask_b32_e32 v0, 0, v58, vcc
; GLOBALNESS1-NEXT:    v_cmp_eq_u32_e64 s[52:53], 0, v0
; GLOBALNESS1-NEXT:    s_waitcnt vmcnt(0)
...
; GLOBALNESS1-NEXT:    s_andn2_b64 vcc, exec, s[82:83]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_15
; GLOBALNESS1-NEXT:  ; %bb.17: ; %bb46.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_andn2_b64 vcc, exec, s[84:85]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_15
; GLOBALNESS1-NEXT:  ; %bb.18: ; %bb50.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[0:1], s[68:69], s[68:69] op_sel:[0,1]
; GLOBALNESS1-NEXT:    v_cmp_gt_f64_e32 vcc, s[80:81], v[0:1]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_21
; GLOBALNESS1-NEXT:  ; %bb.19: ; %bb3.i.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[80:81], 0
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS1-NEXT:    s_cbranch_vccnz .LBB1_21
; GLOBALNESS1-NEXT:  ; %bb.20: ; %bb6.i.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    v_cmp_lt_f64_e32 vcc, 0, v[56:57]
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, vcc
; GLOBALNESS1-NEXT:  .LBB1_21: ; %spam.exit.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_cmp_gt_i32 s33, 0
; GLOBALNESS1-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS1-NEXT:  ; %bb.22: ; %bb55.i
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s54, s48, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s55, s49, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[70:71], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[70:71]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[54:55]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[34:35]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s64
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    global_store_dwordx2 v[44:45], v[60:61], off
; GLOBALNESS1-NEXT:    ; implicit-def: $sgpr15
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[70:71]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s55, s67
...
; GLOBALNESS0-NEXT:    s_load_dword s6, s[48:49], 0x14
...
; GLOBALNESS0-NEXT:    global_load_dword v0, v42, s[8:9]
...
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[80:81], s[48:49], 0x18
; GLOBALNESS0-NEXT:    s_load_dword s7, s[48:49], 0x20
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[82:83], s[4:5], -1
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v40, 0, 1, s[4:5]
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[84:85], s[4:5], -1
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
...
; GLOBALNESS0-NEXT:    s_mov_b32 s68, 0
; GLOBALNESS0-NEXT:    s_mov_b32 s69, 0x40994400
; GLOBALNESS0-NEXT:    s_xor_b64 s[86:87], s[4:5], -1
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v43, v42
; GLOBALNESS0-NEXT:    s_mov_b32 s32, 0
; GLOBALNESS0-NEXT:    ; implicit-def: $vgpr60_vgpr61
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0)
; GLOBALNESS0-NEXT:    v_readfirstlane_b32 s33, v0
; GLOBALNESS0-NEXT:    s_branch .LBB1_4
; GLOBALNESS0-NEXT:  .LBB1_1: ; %bb70.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s33, 0
; GLOBALNESS0-NEXT:    s_cbranch_scc0 .LBB1_28
...
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[60:61], v[0:1], v[0:1] op_sel:[0,1]
...
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr96_sgpr97
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_9
; GLOBALNESS0-NEXT:  ; %bb.5: ; %NodeBlock
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[8:11], s[48:49], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[96:97], -1
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], 0
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], -1
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_cmp_lt_i32 s11, 1
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s11, 1
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[4:7], s[48:49], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[96:97], 0
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_cmp_lg_u32 s7, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
...
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[98:99], s[50:51]
; GLOBALNESS0-NEXT:    s_cbranch_execz .LBB1_25
; GLOBALNESS0-NEXT:  ; %bb.11: ; %bb33.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    global_load_dwordx2 v[56:57], v[44:45], off
; GLOBALNESS0-NEXT:    s_cmp_gt_i32 s33, -1
...
; GLOBALNESS0-NEXT:    v_cndmask_b32_e32 v0, 0, v58, vcc
; GLOBALNESS0-NEXT:    v_cmp_eq_u32_e64 s[52:53], 0, v0
; GLOBALNESS0-NEXT:    s_waitcnt vmcnt(0)
...
; GLOBALNESS0-NEXT:    s_andn2_b64 vcc, exec, s[82:83]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.17: ; %bb46.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_andn2_b64 vcc, exec, s[84:85]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.18: ; %bb50.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[0:1], s[68:69], s[68:69] op_sel:[0,1]
; GLOBALNESS0-NEXT:    v_cmp_gt_f64_e32 vcc, s[80:81], v[0:1]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_21
; GLOBALNESS0-NEXT:  ; %bb.19: ; %bb3.i.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[80:81], 0
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, s[4:5]
; GLOBALNESS0-NEXT:    s_cbranch_vccnz .LBB1_21
; GLOBALNESS0-NEXT:  ; %bb.20: ; %bb6.i.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    v_cmp_lt_f64_e32 vcc, 0, v[56:57]
; GLOBALNESS0-NEXT:    s_and_b64 vcc, exec, vcc
; GLOBALNESS0-NEXT:  .LBB1_21: ; %spam.exit.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_cmp_gt_i32 s33, 0
; GLOBALNESS0-NEXT:    s_cbranch_scc1 .LBB1_15
; GLOBALNESS0-NEXT:  ; %bb.22: ; %bb55.i
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s66, s48, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s67, s49, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[70:71], s[4:5], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[36:37]
...
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[70:71]
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], s[66:67]
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[34:35]
...
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s54
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS0-NEXT:    global_store_dwordx2 v[44:45], v[60:61], off
; GLOBALNESS0-NEXT:    ; implicit-def: $sgpr15
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[70:71]
