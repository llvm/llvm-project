...
; GLOBALNESS1-NEXT:    s_xor_b64 s[86:87], s[64:65], -1
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s4, 0
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s5, 1
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:    s_xor_b64 s[96:97], s[4:5], -1
; GLOBALNESS1-NEXT:    s_bitcmp1_b32 s7, 0
; GLOBALNESS1-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS1-NEXT:    s_xor_b64 s[98:99], s[4:5], -1
; GLOBALNESS1-NEXT:    s_mov_b32 s68, s16
; GLOBALNESS1-NEXT:    s_mov_b64 s[48:49], s[8:9]
; GLOBALNESS1-NEXT:    s_mov_b32 s69, s15
; GLOBALNESS1-NEXT:    s_mov_b32 s70, s14
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s6, 2
; GLOBALNESS1-NEXT:    s_cselect_b64 s[82:83], -1, 0
; GLOBALNESS1-NEXT:    s_cmp_eq_u32 s4, 1
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s7, 3
; GLOBALNESS1-NEXT:    s_cselect_b64 s[6:7], -1, 0
...
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s64, 8
; GLOBALNESS1-NEXT:    v_writelane_b32 v57, s65, 9
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[80:81], s[52:53]
...
; GLOBALNESS1-NEXT:    s_addc_u32 s67, s49, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[84:85], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[84:85]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[66:67]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[34:35]
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS1-NEXT:    v_readlane_b32 s64, v57, 8
; GLOBALNESS1-NEXT:    v_pk_mov_b32 v[0:1], 0, 0
; GLOBALNESS1-NEXT:    s_mov_b32 s55, s71
; GLOBALNESS1-NEXT:    v_readlane_b32 s65, v57, 9
...
; GLOBALNESS0-NEXT:    s_xor_b64 s[86:87], s[64:65], -1
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s4, 0
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s6, 0
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s5, 1
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[96:97], s[4:5], -1
; GLOBALNESS0-NEXT:    s_bitcmp1_b32 s7, 0
; GLOBALNESS0-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GLOBALNESS0-NEXT:    s_xor_b64 s[98:99], s[4:5], -1
; GLOBALNESS0-NEXT:    s_mov_b32 s66, s16
; GLOBALNESS0-NEXT:    s_mov_b64 s[48:49], s[8:9]
; GLOBALNESS0-NEXT:    s_mov_b32 s67, s15
; GLOBALNESS0-NEXT:    s_mov_b32 s68, s14
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s6, 2
; GLOBALNESS0-NEXT:    s_cselect_b64 s[82:83], -1, 0
; GLOBALNESS0-NEXT:    s_cmp_eq_u32 s4, 1
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s7, 3
; GLOBALNESS0-NEXT:    s_cselect_b64 s[6:7], -1, 0
...
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s64, 8
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s65, 9
...
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[80:81], s[52:53]
...
; GLOBALNESS0-NEXT:    s_addc_u32 s71, s49, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[84:85], s[4:5], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[36:37]
...
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS0-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS0-NEXT:    s_swappc_b64 s[30:31], s[84:85]
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[38:39]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[36:37]
; GLOBALNESS0-NEXT:    s_mov_b64 s[8:9], s[70:71]
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[34:35]
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_4 Depth=1
; GLOBALNESS0-NEXT:    v_readlane_b32 s64, v57, 8
; GLOBALNESS0-NEXT:    v_pk_mov_b32 v[0:1], 0, 0
; GLOBALNESS0-NEXT:    v_readlane_b32 s65, v57, 9
...
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[52:55], s[48:49], 0x0
