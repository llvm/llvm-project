...
; GFX11-TRUE16-NEXT:    s_cbranch_execz .LBB2_12
...
; GFX11-TRUE16-NEXT:    s_branch .LBB2_11
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s9, -1
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s24
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_mul_hi_u32 s9, s29, s28
; GFX11-TRUE16-NEXT:    s_mul_i32 s13, s29, s28
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_alignbit_b32 v0, s9, s13, 1
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s9, v0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-TRUE16-NEXT:    s_or_b32 s9, s9, 1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_lshr_b32 s9, s9, s30
; GFX11-TRUE16-NEXT:    s_mul_i32 s9, s9, s22
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_mul_i32 s9, s9, s20
; GFX11-TRUE16-NEXT:    s_or_b32 s20, s19, s9
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_lshl_b64 s[22:23], s[20:21], 1
; GFX11-TRUE16-NEXT:    global_load_u16 v2, v0, s[22:23]
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s8
...
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v4, v0, v3
; GFX11-TRUE16-NEXT:    s_cselect_b32 s9, s13, s9
; GFX11-TRUE16-NEXT:    s_bitcmp1_b32 s9, 0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX11-TRUE16-NEXT:    s_cselect_b32 s9, 0x100, 0
...
; GFX11-TRUE16-NEXT:  .LBB2_14: ; %Flow14
; GFX11-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s20
; GFX11-TRUE16-NEXT:  ; %bb.15: ; %UnifiedUnreachableBlock
; GFX11-TRUE16-NEXT:    ; divergent unreachable
; GFX11-TRUE16-NEXT:  ; %bb.16: ; %UnifiedReturnBlock
...
; GFX11-FAKE16-NEXT:    s_cbranch_execz .LBB2_12
...
; GFX11-FAKE16-NEXT:    s_not_b32 s0, s0
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s24
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s13
...
; GFX11-FAKE16-NEXT:    global_load_u16 v2, v3, s[20:21]
...
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v4, v0, v3
; GFX11-FAKE16-NEXT:    s_cselect_b32 s0, s13, s0
; GFX11-FAKE16-NEXT:    s_bitcmp1_b32 s0, 0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX11-FAKE16-NEXT:    s_cselect_b32 s0, 0x100, 0
; GFX11-FAKE16-NEXT:    s_or_b32 s1, s0, s1
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v3, v1, v3, vcc_lo
...
; GFX11-FAKE16-NEXT:  .LBB2_9: ; %bb17
; GFX11-FAKE16-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-FAKE16-NEXT:    s_and_b32 vcc_lo, exec_lo, s8
; GFX11-FAKE16-NEXT:    s_cbranch_vccz .LBB2_9
; GFX11-FAKE16-NEXT:  ; %bb.10: ; %Flow6
; GFX11-FAKE16-NEXT:    s_mov_b32 s18, -1
; GFX11-FAKE16-NEXT:  .LBB2_11: ; %Flow11
; GFX11-FAKE16-NEXT:    s_and_b32 s20, s2, exec_lo
; GFX11-FAKE16-NEXT:    s_or_not1_b32 s0, s18, exec_lo
; GFX11-FAKE16-NEXT:  .LBB2_12: ; %Flow9
...
; GFX11-FAKE16-NEXT:  .LBB2_14: ; %Flow14
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s20
; GFX11-FAKE16-NEXT:  ; %bb.15: ; %UnifiedUnreachableBlock
; GFX11-FAKE16-NEXT:    ; divergent unreachable
; GFX11-FAKE16-NEXT:  ; %bb.16: ; %UnifiedReturnBlock
