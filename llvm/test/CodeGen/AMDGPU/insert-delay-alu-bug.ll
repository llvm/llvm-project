...
; GFX11-TRUE16-NEXT:    s_cbranch_vccnz .LBB2_12
; GFX11-TRUE16-NEXT:  .LBB2_4: ; %bb16
; GFX11-TRUE16-NEXT:    s_load_b32 s2, s[16:17], 0x54
...
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_bitcmp1_b32 s2, 0
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, s30, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_mul_lo_u32 v0, v0, s22
; GFX11-TRUE16-NEXT:    v_mul_lo_u32 v0, v0, s20
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v0, s19, v0
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[0:1], 1, v[0:1]
; GFX11-TRUE16-NEXT:    global_load_u16 v1, v[0:1], off
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v4, v1, v4, s0
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc_lo
; GFX11-TRUE16-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v3, v0, v3 :: v_dual_and_b32 v4, 1, v4
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v4, 0, 0x100, vcc_lo
...
; GFX11-TRUE16-NEXT:    s_and_b32 s20, s1, exec_lo
...
; GFX11-FAKE16-NEXT:    s_load_b32 s2, s[16:17], 0x54
; GFX11-FAKE16-NEXT:    s_bitcmp1_b32 s23, 0
; GFX11-FAKE16-NEXT:    s_mov_b32 s8, -1
; GFX11-FAKE16-NEXT:    s_cselect_b32 s0, -1, 0
; GFX11-FAKE16-NEXT:    s_and_b32 s9, s23, 1
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_bitcmp1_b32 s2, 0
; GFX11-FAKE16-NEXT:    s_cselect_b32 s2, -1, 0
; GFX11-FAKE16-NEXT:    s_cmp_eq_u32 s9, 0
...
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_mul_hi_u32 s8, s29, s28
; GFX11-FAKE16-NEXT:    s_mul_i32 s9, s29, s28
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_alignbit_b32 v0, s8, s9, 1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, 1, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v0, s30, v0
; GFX11-FAKE16-NEXT:    v_mul_lo_u32 v0, v0, s22
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_mul_lo_u32 v0, v0, s20
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, s19, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[2:3], 1, v[0:1]
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s24
; GFX11-FAKE16-NEXT:    global_load_u16 v2, v[2:3], off
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v4, v2, v4, s0
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11-FAKE16-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v1, v0, v1 :: v_dual_and_b32 v4, 1, v4
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e64 v4, 0, 0x100, vcc_lo
...
; GFX11-FAKE16-NEXT:    s_and_b32 s20, s1, exec_lo
