...
; GFX11-LABEL: f2:
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_load_b32 s24, s[4:5], 0x24
...
; GFX11-NEXT:    s_load_b128 s[16:19], s[4:5], 0x2c
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_add_u32 s20, s20, f0@gotpcrel32@lo+4
; GFX11-NEXT:    s_addc_u32 s21, s21, f0@gotpcrel32@hi+12
; GFX11-NEXT:    s_mov_b32 s13, s14
; GFX11-NEXT:    s_load_b64 s[28:29], s[20:21], 0x0
; GFX11-NEXT:    s_mov_b64 s[20:21], s[4:5]
; GFX11-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX11-NEXT:    s_mov_b32 s27, s14
; GFX11-NEXT:    s_mov_b32 s14, s15
; GFX11-NEXT:    s_mov_b64 s[22:23], s[0:1]
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[28:29]
; GFX11-NEXT:    s_mov_b32 s14, s27
; GFX11-NEXT:    s_mov_b64 s[0:1], s[22:23]
; GFX11-NEXT:    s_mov_b64 s[4:5], s[20:21]
; GFX11-NEXT:    s_mov_b32 s13, -1
; GFX11-NEXT:    s_cbranch_execz .LBB2_4
; GFX11-NEXT:    s_branch .LBB2_12
; GFX11-NEXT:  .LBB2_3:
; GFX11-NEXT:    s_mov_b32 s13, 0
; GFX11-NEXT:  .LBB2_4: ; %bb16
; GFX11-NEXT:    s_load_b32 s8, s[4:5], 0x54
...
; GFX11-NEXT:    s_load_b128 s[20:23], s[4:5], 0x44
; GFX11-NEXT:    v_mov_b32_e32 v2, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_u32 s8, s21, s20
; GFX11-NEXT:    s_mul_i32 s9, s21, s20
...
; GFX11-NEXT:    s_lshr_b32 s8, s8, s22
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_i32 s8, s8, s18
; GFX11-NEXT:    s_mul_i32 s8, s8, s16
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s8, s24, s8
; GFX11-NEXT:    s_lshl_b64 s[20:21], s[8:9], 1
...
; GFX11-NEXT:    s_and_b32 vcc_lo, s19, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v1, v3, s2
...
; GFX11-NEXT:    s_and_b32 s16, s13, exec_lo
; GFX11-NEXT:    s_or_not1_b32 s2, s17, exec_lo
; GFX11-NEXT:  .LBB2_13: ; %Flow9
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX11-NEXT:    s_and_saveexec_b32 s3, s2
