...
; CHECK-LABEL: # Machine code for function test5: IsSSA, TracksLiveness
...
; EMPTY:
; CHECK: # End machine code for function test5.
; EMPTY:
; CHECK: Next-use distance of Register [[Reg7]] = 40
; CHECK-NEXT: Next-use distance of Register [[Reg6]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg5]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg4]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg2]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg1]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg8]] = 26012
; CHECK-NEXT: Next-use distance of Register [[Reg9]] = 21
; CHECK-NEXT: Next-use distance of Register [[Reg10]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg11]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg12]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg13]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg14]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 23
; CHECK-NEXT: Next-use distance of Register [[Reg21]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg24]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 11
; CHECK-NEXT: Next-use distance of Register [[Reg28]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg29]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg30]] = 5
...
; CHECK-NEXT: Next-use distance of Register [[Reg34]] = 2
...
; CHECK-NEXT: Next-use distance of Register [[Reg39]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg40]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg41]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg42]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg43]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg44]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg47]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg51]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg52]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg53]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg45]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg23]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg50]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg54]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg49]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg56]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg27]] = 10
