...
; GFX942-NEXT:    v_max_f32_e32 v8, v6, v4
...
; GFX942-NEXT:    s_mov_b64 s[8:9], exec
; GFX942-NEXT:    v_pk_max_f16 v8, v6, v4
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    v_mov_b64_e32 v[6:7], v[8:9]
...
; GFX12-TRUE16-NEXT:    s_add_co_i32 s5, s16, 0x400
...
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v5, s5
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_bfi_b32 v3, 0xffff, v0, v1
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v0, v3 :: v_dual_mov_b32 v1, v4
; GFX12-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v5, s[0:3], null offen th:TH_ATOMIC_RETURN
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX12-FAKE16-NEXT:    s_add_co_i32 s6, s16, 0x400
...
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v5, s6
...
; GFX12-FAKE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v5, s[0:3], null offen th:TH_ATOMIC_RETURN
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v5, s5
; GFX12-TRUE16-NEXT:    v_bfi_b32 v1, 0xffff, v1, v3
...
; GFX12-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    v_add_nc_u32_e32 v9, 0x400, v4
; GFX12-TRUE16-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v4, 16, v5
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v6, 16, v8
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v7, 0xffff0000, v5
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v10, 0xffff0000, v8
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    v_max_num_f32_e32 v4, v6, v4
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_max_num_f32_e32 v6, v10, v7
; GFX12-TRUE16-NEXT:    v_bfe_u32 v7, v4, 16, 1
...
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v12, 0x400000, v6
; GFX12-TRUE16-NEXT:    v_add3_u32 v7, v7, v4, 0x7fff
; GFX12-TRUE16-NEXT:    v_add3_u32 v10, v10, v6, 0x7fff
; GFX12-TRUE16-NEXT:    s_wait_alu 0xfffd
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_cndmask_b32_e32 v4, v7, v11, vcc_lo
; GFX12-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v6, v6
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v4.h
; GFX12-TRUE16-NEXT:    s_wait_alu 0xfffd
; GFX12-TRUE16-NEXT:    v_cndmask_b32_e32 v6, v10, v12, vcc_lo
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_bfi_b32 v7, 0xffff, v4, v6
...
; GFX12-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-NEXT:    v_add_nc_u32_e32 v9, 0x400, v4
; GFX12-FAKE16-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v4, 16, v5
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v6, 16, v8
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v7, 0xffff0000, v5
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v10, 0xffff0000, v8
; GFX12-FAKE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX12-FAKE16-NEXT:    s_wait_storecnt 0x0
; GFX12-FAKE16-NEXT:    v_max_num_f32_e32 v4, v6, v4
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-FAKE16-NEXT:    v_max_num_f32_e32 v6, v10, v7
; GFX12-FAKE16-NEXT:    v_bfe_u32 v7, v4, 16, 1
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v11, 0x400000, v4
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX12-FAKE16-NEXT:    v_bfe_u32 v10, v6, 16, 1
; GFX12-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v4, v4
; GFX12-FAKE16-NEXT:    v_or_b32_e32 v12, 0x400000, v6
; GFX12-FAKE16-NEXT:    v_add3_u32 v7, v7, v4, 0x7fff
; GFX12-FAKE16-NEXT:    v_add3_u32 v10, v10, v6, 0x7fff
; GFX12-FAKE16-NEXT:    s_wait_alu 0xfffd
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cndmask_b32_e32 v4, v7, v11, vcc_lo
; GFX12-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v6, v6
; GFX12-FAKE16-NEXT:    s_wait_alu 0xfffd
; GFX12-FAKE16-NEXT:    v_cndmask_b32_e32 v6, v10, v12, vcc_lo
; GFX12-FAKE16-NEXT:    v_perm_b32 v7, v6, v4, 0x7060302
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    v_max_f32_e32 v4, v6, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_max_f32_e32 v6, v10, v7
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FAKE16-NEXT:    v_max_f32_e32 v4, v6, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_max_f32_e32 v6, v10, v7
