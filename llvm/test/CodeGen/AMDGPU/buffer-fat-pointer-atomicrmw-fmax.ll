...
; GFX940-NEXT:    s_andn2_b64 s[6:7], exec, s[4:5]
; GFX940-NEXT:    s_cselect_b64 exec, s[6:7], s[4:5]
...
; GFX940-NEXT:    s_cbranch_scc1 .LBB2_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB2_3
...
; GFX90A-NEXT:    s_cbranch_scc1 .LBB2_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB2_3
...
; GFX12-NEXT:    s_cbranch_scc1 .LBB7_4
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB7_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB7_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB7_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB7_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_lshrrev_b32_e32 v4, v9, v7
; GFX940-NEXT:    v_max_f16_e32 v4, v4, v4
; GFX940-NEXT:    v_max_f16_e32 v4, v4, v11
; GFX940-NEXT:    v_lshlrev_b32_e32 v4, v9, v4
...
; GFX940-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX940-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB12_3
; GFX940-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX11-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX90A-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB12_3
; GFX90A-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB12_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB12_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX7-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB12_3
...
; GFX6-NEXT:    s_cbranch_scc1 .LBB12_4
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB12_3
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_not1_b32 s4, exec_lo, s5
; GFX12-NEXT:    s_cselect_b32 exec_lo, s4, s5
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX12-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX940-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX940-NEXT:    v_mov_b32_e32 v0, v4
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX90A-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX90A-NEXT:    v_mov_b32_e32 v0, v4
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_alignbit_b32 v6, v5, v6, 16
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX7-NEXT:    v_alignbit_b32 v7, v4, v7, 16
; GFX7-NEXT:    v_mov_b32_e32 v5, v6
; GFX7-NEXT:    s_mov_b64 s[12:13], exec
...
; GFX6-NEXT:    v_alignbit_b32 v6, v5, v6, 16
; GFX6-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX6-NEXT:    v_alignbit_b32 v7, v4, v7, 16
; GFX6-NEXT:    v_mov_b32_e32 v5, v6
; GFX6-NEXT:    s_mov_b64 s[12:13], exec
