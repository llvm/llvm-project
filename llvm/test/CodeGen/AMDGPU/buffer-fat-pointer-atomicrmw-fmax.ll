...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v1, s6 :: v_dual_max_num_f32 v2, v0, v0
; GFX12-NEXT:    s_add_co_i32 s4, s6, 0x400
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v1, s6 :: v_dual_max_f32 v2, v0, v0
; GFX11-NEXT:    s_add_i32 s4, s6, 0x400
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX7-NEXT:    buffer_load_dword v1, v1, s[8:11], 0 offen offset:1024
; GFX7-NEXT:    s_add_i32 s6, s18, 0x400
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX6-NEXT:    buffer_load_dword v1, v1, s[8:11], 0 offen offset:1024
; GFX6-NEXT:    s_add_i32 s6, s18, 0x400
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX940-NEXT:    s_addk_i32 s6, 0x800
; GFX940-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX10-NEXT:    buffer_load_dwordx2 v[2:3], v2, s[8:11], 0 offen offset:2048
; GFX10-NEXT:    s_add_i32 s4, s18, 0x800
; GFX10-NEXT:    v_mov_b32_e32 v6, s4
; GFX10-NEXT:    s_mov_b32 s4, 0
...
; GFX90A-NEXT:    buffer_load_dwordx2 v[2:3], v2, s[8:11], 0 offen offset:2048
; GFX90A-NEXT:    s_add_i32 s6, s18, 0x800
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX7-NEXT:    buffer_load_dwordx2 v[2:3], v2, s[8:11], 0 offen offset:2048
; GFX7-NEXT:    s_add_i32 s6, s18, 0x800
...
; GFX6-NEXT:    buffer_load_dwordx2 v[2:3], v2, s[8:11], 0 offen offset:2048
; GFX6-NEXT:    s_add_i32 s6, s18, 0x800
