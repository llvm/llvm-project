...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_u16 v7, v4, s[4:7], null offen offset:1024
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_u16 v6, v4, s[4:7], null offen offset:1026
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_u16 v6, v4, s[4:7], null offen offset:1024
; GFX12-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_u16 v7, v4, s[4:7], null offen offset:1026
; GFX12-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
