...
; VI-NEXT:    v_max_f16_e32 v0, s2, v0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_max_f16_e64 v0, s4, 4.0
...
; VI-NEXT:    v_max_f16_e32 v1, s3, v1
...
; VI-NEXT:    v_mov_b32_e32 v1, s0
; VI-NEXT:    v_mov_b32_e32 v2, s1
; VI-NEXT:    v_max_f16_e32 v0, s3, v0
; VI-NEXT:    v_max_f16_sdwa v1, v2, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    s_lshr_b32 s0, s8, 16
; VI-NEXT:    s_lshr_b32 s1, s2, 16
...
; VI-NEXT:    v_max_f16_e32 v0, s3, v0
; VI-NEXT:    v_max_f16_sdwa v1, v3, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    s_lshr_b32 s0, s2, 16
; VI-NEXT:    v_or_b32_e32 v1, v0, v1
; VI-NEXT:    v_max_f16_e32 v0, s2, v2
; VI-NEXT:    v_mov_b32_e32 v2, s0
