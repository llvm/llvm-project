...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 -enable-no-nans-fp-math < %s | FileCheck %s -check-prefixes=GCN,GFX11NONANS,GFX11NONANS-TRUE16
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 -enable-no-nans-fp-math < %s | FileCheck %s -check-prefixes=GCN,GFX11NONANS,GFX11NONANS-FAKE16
...
;
; GFX11NONANS-TRUE16-LABEL: test84:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_min_f16_e32 v0.l, v0.l, v1.l
; GFX11NONANS-TRUE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v0.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test84:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_min_f16_e32 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v0, v2
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test85:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_pk_min_f16 v1, v0, v1
; GFX11NONANS-TRUE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v1.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v1.h, v2.h
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test85:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_pk_min_f16 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v2
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GFX11NONANS-FAKE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v0, v2
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v3, v1
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test86:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_pk_max_f16 v1, v0, v1
; GFX11NONANS-TRUE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, v1.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, v1.h, v2.h
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test86:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_pk_max_f16 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v2
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GFX11NONANS-FAKE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, v0, v2
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, v3, v1
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %var1 = call <2 x half> @llvm.canonicalize.v2f16(<2 x half> %arg1)
  %var2 = call <2 x half> @llvm.canonicalize.v2f16(<2 x half> %arg2)
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test87:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_max_f16_e32 v0.l, v0.l, v1.l
; GFX11NONANS-TRUE16-NEXT:    v_cmp_ge_f16_e32 vcc_lo, v0.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test87:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_max_f16_e32 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_cmp_ge_f16_e32 vcc_lo, v0, v2
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %var1 = call half @llvm.canonicalize.f16(half %arg1)
  %var2 = call half @llvm.canonicalize.f16(half %arg2)
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test88:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_pk_min_f16 v1, v0, v1
; GFX11NONANS-TRUE16-NEXT:    v_cmp_gt_f16_e32 vcc_lo, v1.l, v2.l
...
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test88:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_pk_min_f16 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v2
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test89:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_min_f16_e32 v0.l, v0.l, v1.l
; GFX11NONANS-TRUE16-NEXT:    v_cmp_ge_f16_e32 vcc_lo, v0.l, v2.l
...
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test89:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_min_f16_e32 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_cmp_ge_f16_e32 vcc_lo, v0, v2
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test90:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_max_f16_e32 v0.l, v0.l, v1.l
; GFX11NONANS-TRUE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v0.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test90:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_max_f16_e32 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_cmp_le_f16_e32 vcc_lo, v0, v2
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test91:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_pk_max_f16 v1, v0, v1
; GFX11NONANS-TRUE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v1.l, v2.l
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v1.h, v2.h
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test91:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_pk_max_f16 v0, v0, v1
; GFX11NONANS-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v2
...
; GFX11NONANS-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v0, v2
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v3, v1
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %var1 = call <2 x half> @llvm.canonicalize.v2f16(<2 x half> %arg1)
  %var2 = call <2 x half> @llvm.canonicalize.v2f16(<2 x half> %arg2)
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-TRUE16-LABEL: test131:
; GFX11NONANS-TRUE16:       ; %bb.0:
; GFX11NONANS-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-TRUE16-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 10, v1
; GFX11NONANS-TRUE16-NEXT:    v_cmp_gt_u16_e64 s0, 10, v0.l
; GFX11NONANS-TRUE16-NEXT:    s_or_b32 s0, s0, vcc_lo
; GFX11NONANS-TRUE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX11NONANS-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11NONANS-FAKE16-LABEL: test131:
; GFX11NONANS-FAKE16:       ; %bb.0:
; GFX11NONANS-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11NONANS-FAKE16-NEXT:    v_cmp_gt_u16_e32 vcc_lo, 10, v0
; GFX11NONANS-FAKE16-NEXT:    v_cmp_gt_u32_e64 s0, 10, v1
; GFX11NONANS-FAKE16-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX11NONANS-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX11NONANS-FAKE16-NEXT:    s_setpc_b64 s[30:31]
