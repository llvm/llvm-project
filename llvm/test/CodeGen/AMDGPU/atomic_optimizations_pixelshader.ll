...
; RUN: llc -mtriple=amdgcn-- -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=-wavefrontsize32,+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizations=true -verify-machineinstrs -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164 %s
; RUN: llc -mtriple=amdgcn-- -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=+wavefrontsize32,-wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizations=true -verify-machineinstrs -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132 %s
...
; GFX1164-NEXT:    s_cbranch_execz BB0_4
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_mov_b64 s[12:13], exec
; GFX1164-NEXT:    ; implicit-def: $vgpr1
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s12, 0
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32_e64 v0, s13, v0
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[28:29], vcc
; GFX1164-NEXT:    s_cbranch_execz BB0_3
; GFX1164-NEXT:  ; %bb.2:
...
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_and_saveexec_b64 s[8:9], s[10:11]
; GFX1164-NEXT:    s_cbranch_execz BB1_4
; GFX1164-NEXT:  ; %bb.1:
...
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_and_saveexec_b64 s[28:29], vcc
; GFX1164-NEXT:    s_cbranch_execz BB1_3
; GFX1164-NEXT:  ; %bb.2:
...
; GFX1164-NEXT:    v_add_nc_u32_e32 v0, s4, v0
; GFX1164-NEXT:  BB1_4: ; %Flow
; GFX1164-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX1164-NEXT:    s_wqm_b64 s[4:5], -1
; GFX1164-NEXT:    s_and_not1_b64 vcc, exec, s[4:5]
; GFX1164-NEXT:    s_cbranch_vccnz BB1_6
; GFX1164-NEXT:  ; %bb.5: ; %if
; GFX1164-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
; GFX1164-NEXT:  BB1_6: ; %UnifiedReturnBlock
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_and_saveexec_b32 s8, s9
; GFX1132-NEXT:    s_cbranch_execz BB1_4
; GFX1132-NEXT:  ; %bb.1:
...
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_and_saveexec_b32 s9, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB1_3
; GFX1132-NEXT:  ; %bb.2:
...
; GFX1132-NEXT:    v_add_nc_u32_e32 v0, s4, v0
; GFX1132-NEXT:  BB1_4: ; %Flow
; GFX1132-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; GFX1132-NEXT:    s_wqm_b32 s4, -1
; GFX1132-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s4
; GFX1132-NEXT:    s_cbranch_vccnz BB1_6
; GFX1132-NEXT:  ; %bb.5: ; %if
; GFX1132-NEXT:    buffer_store_b32 v0, off, s[0:3], 0
; GFX1132-NEXT:  BB1_6: ; %UnifiedReturnBlock
; GFX1132-NEXT:    s_endpgm
entry:
  %cond1 = call i1 @llvm.amdgcn.wqm.vote(i1 true)
