...
; RUN: llc -mtriple=amdgcn-- -mcpu=gfx1300 -mattr=-wavefrontsize32,+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -verify-machineinstrs -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1364 %s
; RUN: llc -mtriple=amdgcn-- -mcpu=gfx1300 -mattr=+wavefrontsize32,-wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP -verify-machineinstrs -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -enable-var-scope -check-prefixes=GFX1332 %s
...
; GFX1364-NEXT:    v_mad_u32_u24 v0, v0, 5, s4
...
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1332-NEXT:    v_mad_u32_u24 v0, v0, 5, s4
...
; GFX1364-NEXT:  ; %bb.1:
; GFX1364-NEXT:    v_mov_b32_e32 v1, v0
; GFX1364-NEXT:    s_not_b64 exec, exec
...
; GFX1364-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1364-NEXT:    v_mov_b32_e32 v2, v1
; GFX1364-NEXT:    v_permlanex16_b32 v2, v2, -1, -1
; GFX1364-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1332-NEXT:    ; implicit-def: $vgpr3
; GFX1332-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1332-NEXT:    s_mov_b32 s9, s8
; GFX1332-NEXT:    s_and_saveexec_b32 s8, s9
; GFX1332-NEXT:    s_cbranch_execz .LBB1_4
; GFX1332-NEXT:  ; %bb.1:
; GFX1332-NEXT:    v_mov_b32_e32 v1, v0
; GFX1332-NEXT:    s_not_b32 exec_lo, exec_lo
...
; GFX1332-NEXT:    s_or_saveexec_b32 s9, -1
; GFX1332-NEXT:    v_writelane_b32 v2, 0, 0
; GFX1332-NEXT:    s_mov_b32 exec_lo, s9
...
; GFX1332-NEXT:    v_mov_b32_e32 v0, v2
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1332-NEXT:    v_add_nc_u32_e32 v3, s4, v0
