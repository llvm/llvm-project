...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10-SDAG-LABEL: test_vector_reduce_xor_v3i16:
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10-GISEL-LABEL: test_vector_reduce_xor_v3i16:
; GFX10-GISEL:       ; %bb.0: ; %entry
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX8-SDAG:       ; %bb.0: ; %entry
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v2, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v2, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v2, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v3, v2
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v3, v2
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG:       ; %bb.0: ; %entry
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v4, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v5, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v4, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v5, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v4, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v5, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v3.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v2.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v1.l, v1.l, v3.l
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v0.l, v0.l, v2.l
...
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v3, v5, v4
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v4, v7, v6
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v4, v3
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-SDAG-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v3.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v2.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v1.l, v1.l, v3.l
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v0.l, v0.l, v2.l
...
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v3, v5, v4
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v4, v7, v6
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v4, v3
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG:       ; %bb.0: ; %entry
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v8, v2, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v9, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v10, v3, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_sdwa v11, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v2, v2, v6
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v4
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v3, v3, v7
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v5
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v4, v11, v10
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v5, v9, v8
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX8-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
...
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v8, v2, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v9, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v10, v3, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_sdwa v11, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v2, v2, v6
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v4
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v3, v3, v7
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v5
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v4, v11, v10
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v5, v9, v8
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX9-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v8, v2, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v9, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v10, v3, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_sdwa v11, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v2, v2, v6
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v3, v3, v7
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v5
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v4
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v4, v11, v10
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v5, v9, v8
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX10-SDAG-NEXT:    v_xor_b32_e32 v0, v0, v1
...
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v2.h, v2.h, v6.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v4.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v3.h, v3.h, v7.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v5.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v2.l, v2.l, v6.l
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v3.l, v3.l, v7.l
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v1.l, v1.l, v5.l
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v0.l, v0.l, v4.l
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v3.h
; GFX11-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v2.h
...
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v8, v9, v8
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v9, v11, v10
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v10, v13, v12
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v2, v6
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v11, v15, v14
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v3, v3, v7
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v1, v1, v5
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v4
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v5, v9, v8
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v4, v11, v10
...
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX11-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-SDAG-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v2.h, v2.h, v6.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v4.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v3.h, v3.h, v7.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v5.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v2.l, v2.l, v6.l
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v3.l, v3.l, v7.l
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v1.l, v1.l, v5.l
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v0.l, v0.l, v4.l
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v1.h, v1.h, v3.h
; GFX12-SDAG-TRUE16-NEXT:    v_xor_b16 v0.h, v0.h, v2.h
...
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v8, v9, v8
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v9, v11, v10
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v10, v13, v12
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v2, v6
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v11, v15, v14
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v3, v3, v7
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v1, v1, v5
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v4
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v5, v9, v8
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v4, v11, v10
...
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v2, v5, v4
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX12-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-FAKE16-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX12-SDAG-FAKE16-NEXT:    s_setpc_b64 s[30:31]
