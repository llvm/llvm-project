...
; SI-SDAG-NEXT:    v_bfi_b32 v7, s28, v10, v5
...
; SI-SDAG-NEXT:    v_mul_f64 v[11:12], v[7:8], s[12:13]
; SI-SDAG-NEXT:    v_mul_f64 v[15:16], v[2:3], s[4:5]
; SI-SDAG-NEXT:    s_mov_b32 s14, 0xbbb55516
; SI-SDAG-NEXT:    s_mov_b32 s15, 0x40026bb1
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[7:8], s[14:15], v[11:12]
; SI-SDAG-NEXT:    v_bfi_b32 v7, s28, v10, v16
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v11, s18
; SI-SDAG-NEXT:    v_mov_b32_e32 v12, s19
; SI-SDAG-NEXT:    v_mul_f64 v[17:18], v[15:16], s[12:13]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], s[16:17], v[11:12]
; SI-SDAG-NEXT:    s_mov_b32 s18, 0x623fde64
; SI-SDAG-NEXT:    s_mov_b32 s19, 0x3ec71dee
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[15:16], s[14:15], v[17:18]
...
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], s[16:17], v[11:12]
...
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[26:27]
; SI-SDAG-NEXT:    s_mov_b32 s4, 0x555502a1
; SI-SDAG-NEXT:    s_mov_b32 s5, 0x3fa55555
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[24:25]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[4:5]
...
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[15:16], v[4:5], s[8:9]
...
; SI-SDAG-NEXT:    v_bfi_b32 v7, s60, v12, v9
; SI-SDAG-NEXT:    v_mov_b32_e32 v6, 0
; SI-SDAG-NEXT:    v_add_f64 v[10:11], v[8:9], v[6:7]
; SI-SDAG-NEXT:    s_mov_b32 s10, -1
; SI-SDAG-NEXT:    s_mov_b32 s11, 0x432fffff
; SI-SDAG-NEXT:    v_add_f64 v[10:11], v[10:11], -v[6:7]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 vcc, |v[8:9]|, s[10:11]
; SI-SDAG-NEXT:    s_mov_b32 s12, 0x509f79ff
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v11, v11, v9, vcc
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v10, v10, v8, vcc
; SI-SDAG-NEXT:    s_mov_b32 s13, 0xbfd34413
; SI-SDAG-NEXT:    v_fma_f64 v[7:8], v[10:11], s[12:13], v[0:1]
; SI-SDAG-NEXT:    s_mov_b32 s14, 0xa994fd21
; SI-SDAG-NEXT:    s_mov_b32 s15, 0x3c49dc1d
; SI-SDAG-NEXT:    v_fma_f64 v[7:8], v[10:11], s[14:15], v[7:8]
...
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v7, v[10:11]
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[13:14], v[15:16], 1.0
; SI-SDAG-NEXT:    s_mov_b32 s56, 0
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[13:14], v[15:16], 1.0
; SI-SDAG-NEXT:    v_mul_f64 v[13:14], v[2:3], s[8:9]
; SI-SDAG-NEXT:    v_ldexp_f64 v[10:11], v[10:11], v7
; SI-SDAG-NEXT:    v_bfi_b32 v7, s60, v12, v14
...
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v20, v19, v11, vcc
; SI-SDAG-NEXT:    v_bfi_b32 v7, s60, v12, v1
; SI-SDAG-NEXT:    v_add_f64 v[11:12], v[0:1], v[6:7]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[0:1]|, s[10:11]
; SI-SDAG-NEXT:    v_add_f64 v[6:7], v[11:12], -v[6:7]
...
; SI-SDAG-NEXT:    v_mul_f64 v[11:12], v[15:16], s[16:17]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[6:7], s[14:15], v[0:1]
; SI-SDAG-NEXT:    v_fma_f64 v[11:12], v[15:16], s[18:19], v[11:12]
; SI-SDAG-NEXT:    v_mul_f64 v[15:16], v[0:1], s[16:17]
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v13, v[13:14]
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[0:1], s[18:19], v[15:16]
; SI-SDAG-NEXT:    v_fma_f64 v[0:1], v[11:12], s[20:21], v[8:9]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], s[20:21], v[8:9]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[0:1], s[22:23]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[22:23]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[24:25]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[24:25]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[26:27]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[26:27]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[28:29]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[28:29]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[40:41]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[40:41]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[42:43]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[42:43]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[44:45]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[44:45]
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], s[46:47]
; SI-SDAG-NEXT:    s_and_b64 vcc, s[4:5], vcc
; SI-SDAG-NEXT:    v_fma_f64 v[17:18], v[11:12], v[17:18], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], s[46:47]
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v10, vcc
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[11:12], v[17:18], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[15:16], v[8:9], 1.0
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v6, v[6:7]
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, v20, s[4:5]
; SI-SDAG-NEXT:    v_ldexp_f64 v[10:11], v[10:11], v13
...
; SI-GISEL-NEXT:    v_and_b32_e32 v6, 0x80000000, v9
; SI-GISEL-NEXT:    v_or_b32_e32 v11, 0x43300000, v6
; SI-GISEL-NEXT:    v_add_f64 v[12:13], v[8:9], v[10:11]
; SI-GISEL-NEXT:    v_mul_f64 v[16:17], v[2:3], v[14:15]
; SI-GISEL-NEXT:    v_add_f64 v[12:13], v[12:13], -v[10:11]
...
; SI-GISEL-NEXT:    v_cmp_gt_f64_e64 vcc, |v[8:9]|, v[6:7]
; SI-GISEL-NEXT:    v_add_f64 v[18:19], v[18:19], -v[10:11]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v12, v12, v8, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v13, v13, v9, vcc
; SI-GISEL-NEXT:    v_cmp_gt_f64_e64 vcc, |v[16:17]|, v[6:7]
; SI-GISEL-NEXT:    v_mul_f64 v[14:15], v[4:5], v[14:15]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v8, v18, v16, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v9, v19, v17, vcc
; SI-GISEL-NEXT:    v_mov_b32_e32 v16, 0x509f79ff
; SI-GISEL-NEXT:    v_mov_b32_e32 v17, 0x3fd34413
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], -v[12:13], v[16:17], v[0:1]
; SI-GISEL-NEXT:    v_mov_b32_e32 v20, 0xa994fd21
; SI-GISEL-NEXT:    v_mov_b32_e32 v21, 0xbc49dc1d
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], -v[12:13], v[20:21], v[18:19]
...
; SI-GISEL-NEXT:    v_add_f64 v[24:25], v[14:15], v[10:11]
...
; SI-GISEL-NEXT:    v_add_f64 v[10:11], v[24:25], -v[10:11]
...
; SI-GISEL-NEXT:    v_cmp_gt_f64_e64 vcc, |v[14:15]|, v[6:7]
...
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v6, v10, v14, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v7, v11, v15, vcc
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[18:19], v[30:31], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[30:31], -v[8:9], v[16:17], v[2:3]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], -v[6:7], v[16:17], v[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[30:31], -v[8:9], v[20:21], v[30:31]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], -v[6:7], v[20:21], v[16:17]
...
; SI-GISEL-NEXT:    v_mov_b32_e32 v14, 0x7c89e6b0
; SI-GISEL-NEXT:    v_mov_b32_e32 v15, 0x3efa0199
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[18:19], v[10:11], v[14:15]
...
; SI-GISEL-NEXT:    v_fma_f64 v[26:27], v[30:31], v[26:27], v[14:15]
...
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[30:31], v[24:25], v[38:39]
...
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[30:31], v[12:13], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[16:17], v[14:15], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[18:19], v[10:11], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[30:31], v[12:13], v[20:21]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[16:17], v[14:15], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[18:19], v[10:11], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[30:31], v[12:13], v[48:49]
...
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[30:31], v[12:13], 1.0
...
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v11, v20, v9, vcc
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], v[16:17], v[14:15], 1.0
...
; SI-GISEL-NEXT:    v_or_b32_e32 v11, 0x43300000, v11
; SI-GISEL-NEXT:    v_add_f64 v[14:15], v[8:9], v[10:11]
...
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v8, v14, v8, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v9, v15, v9, vcc
; SI-GISEL-NEXT:    v_add_f64 v[14:15], v[20:21], -v[10:11]
...
; SI-GISEL-NEXT:    v_add_f64 v[24:25], v[22:23], v[10:11]
...
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[18:19], v[0:1]
; SI-GISEL-NEXT:    v_add_f64 v[10:11], v[24:25], -v[10:11]
; SI-GISEL-NEXT:    v_mov_b32_e32 v20, 0xa994fd21
; SI-GISEL-NEXT:    v_mov_b32_e32 v21, 0xbc49dc1d
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], -v[14:15], v[18:19], v[2:3]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[20:21], v[12:13]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v10, v10, v22, vcc
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v11, v11, v23, vcc
; SI-GISEL-NEXT:    v_mov_b32_e32 v22, 0x494ea3e9
; SI-GISEL-NEXT:    v_mov_b32_e32 v23, 0xbcaf48ad
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], -v[14:15], v[20:21], v[24:25]
; SI-GISEL-NEXT:    v_mul_f64 v[26:27], v[12:13], v[22:23]
; SI-GISEL-NEXT:    v_mov_b32_e32 v28, 0xbbb55516
; SI-GISEL-NEXT:    v_mov_b32_e32 v29, 0x40026bb1
; SI-GISEL-NEXT:    v_mul_f64 v[30:31], v[24:25], v[22:23]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[12:13], v[28:29], v[26:27]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[24:25], v[28:29], v[30:31]
...
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], -v[10:11], v[20:21], v[18:19]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[12:13], v[34:35], v[36:37]
; SI-GISEL-NEXT:    v_mov_b32_e32 v34, 0x7c89e6b0
; SI-GISEL-NEXT:    v_mov_b32_e32 v35, 0x3efa0199
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[12:13], v[20:21], v[34:35]
; SI-GISEL-NEXT:    v_mul_f64 v[38:39], v[26:27], v[22:23]
; SI-GISEL-NEXT:    v_mov_b32_e32 v48, 0x14761f6e
; SI-GISEL-NEXT:    v_mov_b32_e32 v49, 0x3f2a01a0
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[12:13], v[20:21], v[48:49]
...
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[12:13], v[20:21], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[18:19], v[18:19], v[28:29], v[22:23]
...
; SI-GISEL-NEXT:    v_ldexp_f64 v[8:9], v[12:13], v8
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[30:31], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[22:23]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[28:29]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], v[52:53]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], v[24:25], v[12:13], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[18:19], v[30:31], v[32:33]
...
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[26:27], v[14:15], v[22:23]
...
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[18:19], v[20:21], v[22:23]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[26:27], v[14:15], 1.0
...
; SI-GISEL-NEXT:    v_cmp_nlt_f64_e32 vcc, v[6:7], v[24:25]
...
; VI-SDAG:       ; %bb.0:
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-SDAG-NEXT:    s_mov_b32 s46, 0x979a371
; VI-SDAG-NEXT:    s_mov_b32 s47, 0x400a934f
; VI-SDAG-NEXT:    v_mul_f64 v[8:9], v[0:1], s[46:47]
...
; VI-SDAG-NEXT:    v_mul_f64 v[12:13], v[2:3], s[46:47]
...
; VI-SDAG-NEXT:    v_mul_f64 v[14:15], v[4:5], s[46:47]
...
; VI-SDAG-NEXT:    v_mul_f64 v[16:17], v[6:7], s[46:47]
...
; VI-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[16:17], s[56:57], v[6:7]
...
; GFX900-SDAG:       ; %bb.0:
; GFX900-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-SDAG-NEXT:    s_mov_b32 s46, 0x979a371
; GFX900-SDAG-NEXT:    s_mov_b32 s47, 0x400a934f
; GFX900-SDAG-NEXT:    v_mul_f64 v[8:9], v[0:1], s[46:47]
...
; GFX900-SDAG-NEXT:    v_mul_f64 v[12:13], v[2:3], s[46:47]
...
; GFX900-SDAG-NEXT:    v_mul_f64 v[14:15], v[4:5], s[46:47]
...
; GFX900-SDAG-NEXT:    v_mul_f64 v[16:17], v[6:7], s[46:47]
...
; GFX900-SDAG-NEXT:    v_cmp_ngt_f64_e64 s[16:17], s[56:57], v[6:7]
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v8, s16
; SI-SDAG-NEXT:    v_mov_b32_e32 v9, s17
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[4:5], s[12:13], v[12:13]
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[6:7], s[14:15], v[8:9]
; SI-SDAG-NEXT:    s_mov_b32 s16, 0x623fde64
; SI-SDAG-NEXT:    s_mov_b32 s17, 0x3ec71dee
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[4:5], s[14:15], v[8:9]
...
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v18, s[8:9]
