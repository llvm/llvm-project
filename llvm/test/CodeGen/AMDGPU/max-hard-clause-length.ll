...
; RUN: llc < %s -mtriple=amdgpu10.30 | FileCheck %s -check-prefixes=GFX10
; RUN: llc < %s -mtriple=amdgpu11.00 | FileCheck %s -check-prefix=GFX11
; RUN: llc < %s -mtriple=amdgpu12.00 | FileCheck %s -check-prefix=GFX12
