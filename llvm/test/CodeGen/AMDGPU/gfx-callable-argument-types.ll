...
; GFX11-NEXT:    v_writelane_b32 v40, s31, 1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b128 v[16:19], v0, s[0:1]
; GFX11-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_lshrrev_b32_e32 v1, 8, v16
; GFX11-NEXT:    v_lshrrev_b32_e32 v2, 16, v16
; GFX11-NEXT:    v_lshrrev_b32_e32 v3, 24, v16
; GFX11-NEXT:    v_lshrrev_b32_e32 v5, 8, v17
; GFX11-NEXT:    v_lshrrev_b32_e32 v6, 16, v17
; GFX11-NEXT:    v_lshrrev_b32_e32 v7, 24, v17
; GFX11-NEXT:    v_lshrrev_b32_e32 v9, 8, v18
; GFX11-NEXT:    v_lshrrev_b32_e32 v10, 16, v18
; GFX11-NEXT:    v_lshrrev_b32_e32 v11, 24, v18
; GFX11-NEXT:    v_lshrrev_b32_e32 v13, 8, v19
; GFX11-NEXT:    v_lshrrev_b32_e32 v14, 16, v19
; GFX11-NEXT:    v_lshrrev_b32_e32 v15, 24, v19
; GFX11-NEXT:    v_mov_b16_e32 v0.l, v16.l
; GFX11-NEXT:    v_mov_b16_e32 v4.l, v17.l
; GFX11-NEXT:    v_mov_b16_e32 v8.l, v18.l
; GFX11-NEXT:    v_mov_b16_e32 v12.l, v19.l
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX11-NEXT:    v_readlane_b32 s31, v40, 1
; GFX11-NEXT:    v_readlane_b32 s30, v40, 0
; GFX11-NEXT:    s_add_i32 s32, s32, -16
