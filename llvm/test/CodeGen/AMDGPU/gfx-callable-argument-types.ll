...
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-NEXT:    v_writelane_b32 v40, s33, 30
; GFX11-NEXT:    s_mov_b32 s33, s32
; GFX11-NEXT:    s_clause 0x1
...
; GFX11-NEXT:    s_mov_b64 s[4:5], s[30:31]
; GFX11-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    s_addk_i32 s32, 0xffe0
; GFX11-NEXT:    v_readlane_b32 s33, v40, 30
; GFX11-NEXT:    s_or_saveexec_b32 s0, -1
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_or_saveexec_b32 s0, -1
; GFX11-NEXT:    scratch_store_b32 off, v40, s32 offset:12 ; 4-byte Folded Spill
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-NEXT:    v_writelane_b32 v40, s33, 2
; GFX11-NEXT:    s_mov_b32 s33, s32
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    scratch_load_b64 v[32:33], off, s33 offset:4
; GFX11-NEXT:    scratch_load_b32 v31, off, s33
; GFX11-NEXT:    s_add_i32 s32, s32, 32
; GFX11-NEXT:    v_writelane_b32 v40, s30, 0
; GFX11-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    v_readlane_b32 s33, v40, 2
; GFX11-NEXT:    s_or_saveexec_b32 s0, -1
; GFX11-NEXT:    scratch_load_b32 v40, off, s32 offset:12 ; 4-byte Folded Reload
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
