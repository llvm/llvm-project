...
; GX900-NEXT:    v_lshlrev_b32_e32 v7, 16, v1
; GX900-NEXT:    s_waitcnt vmcnt(1)
; GX900-NEXT:    v_and_b32_e32 v8, 0xffff0000, v3
; GX900-NEXT:    s_waitcnt vmcnt(0)
; GX900-NEXT:    v_and_b32_e32 v9, 0xffff0000, v5
; GX900-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GX900-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GX900-NEXT:    v_lshlrev_b32_e32 v11, 16, v2
; GX900-NEXT:    v_and_b32_e32 v12, 0xffff0000, v4
; GX900-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GX900-NEXT:    v_fma_f32 v8, v7, v9, v8
; GX900-NEXT:    v_fma_f32 v3, v7, v5, v3
; GX900-NEXT:    v_fma_f32 v4, v11, v5, v4
; GX900-NEXT:    v_bfe_u32 v5, v8, 16, 1
; GX900-NEXT:    v_fma_f32 v7, v11, v9, v12
; GX900-NEXT:    v_or_b32_e32 v9, 0x400000, v8
; GX900-NEXT:    v_bfe_u32 v11, v3, 16, 1
; GX900-NEXT:    v_add3_u32 v5, v5, v8, s2
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v8, v8
; GX900-NEXT:    v_or_b32_e32 v12, 0x400000, v3
; GX900-NEXT:    v_bfe_u32 v13, v7, 16, 1
; GX900-NEXT:    v_add3_u32 v11, v11, v3, s2
; GX900-NEXT:    v_cndmask_b32_e32 v5, v5, v9, vcc
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v3, v3
; GX900-NEXT:    v_or_b32_e32 v14, 0x400000, v7
; GX900-NEXT:    v_bfe_u32 v15, v4, 16, 1
; GX900-NEXT:    v_add3_u32 v13, v13, v7, s2
; GX900-NEXT:    v_cndmask_b32_e32 v3, v11, v12, vcc
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v7, v7
; GX900-NEXT:    v_and_b32_e32 v1, 0xffff0000, v1
; GX900-NEXT:    v_lshlrev_b32_e32 v10, 16, v6
; GX900-NEXT:    v_or_b32_e32 v16, 0x400000, v4
; GX900-NEXT:    v_add3_u32 v15, v15, v4, s2
...
; GX900-NEXT:    v_cndmask_b32_e32 v4, v15, v16, vcc
; GX900-NEXT:    v_and_b32_e32 v5, 0xffff0000, v5
; GX900-NEXT:    v_fma_f32 v3, v1, v10, v3
...
; GX900-NEXT:    v_fma_f32 v1, v1, v6, v5
; GX900-NEXT:    v_bfe_u32 v5, v3, 16, 1
; GX900-NEXT:    v_fma_f32 v4, v2, v10, v4
; GX900-NEXT:    v_fma_f32 v2, v2, v6, v7
; GX900-NEXT:    v_or_b32_e32 v6, 0x400000, v3
; GX900-NEXT:    v_bfe_u32 v7, v1, 16, 1
; GX900-NEXT:    v_add3_u32 v5, v5, v3, s2
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v3, v3
; GX900-NEXT:    v_or_b32_e32 v8, 0x400000, v1
; GX900-NEXT:    v_bfe_u32 v9, v4, 16, 1
; GX900-NEXT:    v_add3_u32 v7, v7, v1, s2
; GX900-NEXT:    v_cndmask_b32_e32 v3, v5, v6, vcc
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GX900-NEXT:    v_or_b32_e32 v10, 0x400000, v4
; GX900-NEXT:    v_bfe_u32 v11, v2, 16, 1
; GX900-NEXT:    v_add3_u32 v9, v9, v4, s2
; GX900-NEXT:    v_cndmask_b32_e32 v1, v7, v8, vcc
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v4, v4
; GX900-NEXT:    v_or_b32_e32 v12, 0x400000, v2
; GX900-NEXT:    v_add3_u32 v11, v11, v2, s2
; GX900-NEXT:    v_cndmask_b32_e32 v4, v9, v10, vcc
; GX900-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; GX900-NEXT:    v_cndmask_b32_e32 v2, v11, v12, vcc
; GX900-NEXT:    v_perm_b32 v2, v2, v4, s3
; GX900-NEXT:    v_perm_b32 v1, v1, v3, s3
...
; GFX10-NEXT:    v_and_b32_e32 v12, 0xffff0000, v3
...
; GFX10-NEXT:    v_bfe_u32 v4, v8, 16, 1
...
; GFX10-NEXT:    v_cndmask_b32_e32 v3, v15, v16, vcc_lo
...
; GFX11-TRUE16-NEXT:    s_load_b128 s[8:11], s[4:5], 0x0
...
; GFX11-TRUE16-NEXT:    global_load_b64 v[0:1], v6, s[8:9]
; GFX11-TRUE16-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX11-TRUE16-NEXT:    global_load_b64 v[4:5], v6, s[10:11]
...
; GFX11-TRUE16-NEXT:    v_dual_fmac_f32 v12, v11, v9 :: v_dual_lshlrev_b32 v7, 16, v0
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v13, v13, v12, 0x7fff
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v4, 0xffff0000, v4
; GFX11-TRUE16-NEXT:    v_dual_fmac_f32 v3, v11, v4 :: v_dual_lshlrev_b32 v8, 16, v2
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v8, v7, v9
; GFX11-TRUE16-NEXT:    v_bfe_u32 v15, v3, 16, 1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v16, 0x400000, v3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v8, v8
; GFX11-TRUE16-NEXT:    v_add3_u32 v15, v15, v3, 0x7fff
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff0000, v2
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v2, v7, v4
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v3, v15, v16, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v12, v12
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v3, 0xffff0000, v3
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v7, v13, v14 :: v_dual_and_b32 v0, 0xffff0000, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_fmac_f32 v3, v1, v10 :: v_dual_fmac_f32 v4, v0, v5
...
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v7, v1, v5
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v4, v5, v8, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v7, v7
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff0000, v2
; GFX11-TRUE16-NEXT:    v_fmac_f32_e32 v2, v0, v10
...
; GFX11-FAKE16-NEXT:    global_load_b64 v[0:1], v6, s[8:9]
; GFX11-FAKE16-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX11-FAKE16-NEXT:    global_load_b64 v[4:5], v6, s[10:11]
...
; GFX11-FAKE16-NEXT:    v_dual_fmac_f32 v12, v11, v9 :: v_dual_lshlrev_b32 v7, 16, v0
...
; GFX11-FAKE16-NEXT:    v_dual_fmac_f32 v3, v11, v4 :: v_dual_and_b32 v8, 0xffff0000, v2
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v8, v7, v9
; GFX11-FAKE16-NEXT:    v_bfe_u32 v15, v3, 16, 1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v16, 0x400000, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v8, v8
; GFX11-FAKE16-NEXT:    v_add3_u32 v15, v15, v3, 0x7fff
...
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v2, v7, v4
...
; GFX11-FAKE16-NEXT:    v_add3_u32 v4, v4, v8, 0x7fff
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v2, v9, v11, vcc_lo
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v3, v15, v16 :: v_dual_and_b32 v2, 0xffff0000, v2
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v12, v12
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff0000, v3
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v7, v13, v14 :: v_dual_and_b32 v0, 0xffff0000, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v3, v1, v10
; GFX11-FAKE16-NEXT:    v_fmac_f32_e32 v2, v0, v10
