...
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr0_lo16
; GFX13-TRUE16-NEXT:    v_cmpx_ne_u32_e32 0, v1
; GFX13-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB6_2
; GFX13-TRUE16-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v2.l
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr2
; GFX13-TRUE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB6_4
; GFX13-TRUE16-NEXT:    s_branch .LBB6_3
; GFX13-TRUE16-NEXT:  .LBB6_2: ; %Flow
; GFX13-TRUE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB6_4
; GFX13-TRUE16-NEXT:  .LBB6_3: ; %cmp.true
; GFX13-TRUE16-NEXT:    v_pk_add_bf16 v0, 0x40c0, v2
; GFX13-TRUE16-NEXT:  .LBB6_4: ; %end
; GFX13-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX13-FAKE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-FAKE16-NEXT:  ; %bb.1: ; %cmp.true
; GFX13-FAKE16-NEXT:    v_pk_add_bf16 v0, 0x40c0, v0
; GFX13-FAKE16-NEXT:  ; %bb.2: ; %end
; GFX13-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
  %cmp = icmp eq i32 %b, 0
...
; GFX13-NEXT:  ; %bb.3: ; %cmp.true
; GFX13-NEXT:    v_pk_add_bf16 v0, 0x40c0, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB7_4:
; GFX13-NEXT:    v_mov_b32_e32 v0, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-TRUE16-NEXT:    v_cmpx_ne_u32_e32 0, v1
; GFX13-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB10_2
; GFX13-TRUE16-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v2.l
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr2
; GFX13-TRUE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB10_4
; GFX13-TRUE16-NEXT:    s_branch .LBB10_3
; GFX13-TRUE16-NEXT:  .LBB10_2: ; %Flow
; GFX13-TRUE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-TRUE16-NEXT:    s_cbranch_execz .LBB10_4
; GFX13-TRUE16-NEXT:  .LBB10_3: ; %cmp.true
; GFX13-TRUE16-NEXT:    v_pk_add_bf16 v0, 0x40c0, v2
; GFX13-TRUE16-NEXT:  .LBB10_4: ; %end
; GFX13-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
