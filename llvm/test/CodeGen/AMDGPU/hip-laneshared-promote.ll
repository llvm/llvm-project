...
entry:
; CHECK:      [[T1:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 0
...
; CHECK:      [[T9:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 32
...
; SETIDX-NEXT: BUNDLE implicit-def $stg_dsta, implicit $idx1
; SETIDX-NEXT: $stg_dsta = V_LOAD_IDX $idx1, 0, implicit $exec
; SETIDX-NEXT: V_STORE_IDX internal $stg_dsta, $idx1, 4, implicit $exec
; SETIDX-NEXT: }
; SETIDX-NEXT: BUNDLE implicit-def $stg_dsta, implicit $idx1
; SETIDX-NEXT: $stg_dsta = V_LOAD_IDX $idx1, 6, implicit $exec
; SETIDX-NEXT: V_STORE_IDX internal $stg_dsta, $idx1, 8, implicit $exec
; SETIDX-NEXT: }
