...
; SETIDX-NEXT: [[DAT0:%[0-9]+]]:vgpr_32 = V_LOAD_IDX $idx1, 8, 1, implicit $exec
; SETIDX-NEXT: V_STORE_IDX [[DAT0]], $idx1, 4, 1, implicit $exec
; SETIDX-NEXT: [[DAT1:%[0-9]+]]:vgpr_32 = V_LOAD_IDX $idx1, 6, 1, implicit $exec
; SETIDX-NEXT: V_STORE_IDX [[DAT1]], $idx1, 0, 1, implicit $exec
