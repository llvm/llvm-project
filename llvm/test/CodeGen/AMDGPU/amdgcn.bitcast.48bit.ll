...
;
; GFX13-LABEL: bitcast_v3bf16_to_v3f16:
; GFX13:       ; %bb.0:
...
; GFX13-NEXT:    v_cmpx_ne_u32_e32 0, v2
...
; GFX13-NEXT:    v_pk_add_bf16 v1, 0x40c0, v1
; GFX13-NEXT:    v_pk_add_bf16 v0, 0x40c0, v0 op_sel_hi:[0,1]
; GFX13-NEXT:  ; %bb.2: ; %end
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v0, v3, v7 :: v_dual_add_nc_u32 v5, v5, v2
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v5, v8 :: v_dual_and_b32 v1, 0xffff, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3bf16_to_v3f16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s2, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB1_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s2
; GFX13-NEXT:    s_cbranch_vccnz .LBB1_4
; GFX13-NEXT:  .LBB1_2: ; %cmp.true
; GFX13-NEXT:    v_pk_add_bf16 v1, 0x40c0, s1
; GFX13-NEXT:    v_pk_add_bf16 v0, 0x40c0, s0 op_sel_hi:[0,1]
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB1_3:
...
;
; GFX13-LABEL: bitcast_v3f16_to_v3bf16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:  ; %bb.1: ; %cmp.true
; GFX13-NEXT:    v_pk_add_f16 v1, 0x200, v1
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3f16_to_v3bf16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s2, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB3_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s2
; GFX13-NEXT:    s_cbranch_vccnz .LBB3_4
; GFX13-NEXT:  .LBB3_2: ; %cmp.true
; GFX13-NEXT:    v_pk_add_f16 v1, 0x200, s1
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3bf16_to_v3i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v1, 0x7fc0, 16, v1
; GFX11-TRUE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v2, v0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3bf16_to_v3i16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s2, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB5_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s2
; GFX13-NEXT:    s_cbranch_vccnz .LBB5_4
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3i16_to_v3bf16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:  ; %bb.1: ; %cmp.true
; GFX13-NEXT:    v_pk_add_u16 v1, v1, 3
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3i16_to_v3bf16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_pk_add_u16 v1, s1, 3
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3f16_to_v3i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3f16_to_v3i16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s2, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB9_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s2
; GFX13-NEXT:    s_cbranch_vccnz .LBB9_4
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3i16_to_v3f16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v3i16_to_v3f16_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
