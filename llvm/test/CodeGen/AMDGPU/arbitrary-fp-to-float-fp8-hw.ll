...
; RUN: llc < %s -mtriple=amdgpu12.00-amd-amdhsa -mattr=+real-true16 | FileCheck -check-prefix=GFX1200-TRUE16 %s
...
; GFX1200-TRUE16-LABEL: v2_from_bf8:
; GFX1200-TRUE16:       v_cvt_pk_f32_bf8_e32 v[0:1], v0.l
;
...
; GFX1200-TRUE16-LABEL: v2_from_fp8:
; GFX1200-TRUE16:       v_cvt_pk_f32_fp8_e32 v[0:1], v0.l
;
