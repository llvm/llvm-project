...
; GFX1210-LABEL: global_load_monitor_b32_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_monitor_b32 v0, v[0:1], off offset:32 th:TH_LOAD_NT
...
; GFX1210-LABEL: global_load_monitor_b32_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_monitor_b32 v2, v2, s[0:1] offset:32 th:TH_LOAD_HT scope:SCOPE_SE
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_monitor_b64_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_monitor_b64 v[0:1], v[0:1], off offset:32 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_monitor_b64_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_monitor_b64 v[2:3], v2, s[0:1] offset:32 th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_monitor_b128_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_monitor_b128 v[4:7], v[0:1], off offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_monitor_b128_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_monitor_b128 v[2:5], v2, s[0:1] offset:32 th:TH_LOAD_NT
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: flat_load_monitor_b32:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    flat_load_monitor_b32 v0, v[0:1] offset:32 th:TH_LOAD_HT scope:SCOPE_SE
...
; GFX1210-LABEL: flat_load_monitor_b64:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    flat_load_monitor_b64 v[0:1], v[0:1] offset:32 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-LABEL: flat_load_monitor_b128:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    flat_load_monitor_b128 v[4:7], v[0:1] offset:32 th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-LABEL: global_load_monitor_b32_saddr_scale_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_monitor_b32 v2, v2, s[0:1] scale_offset th:TH_LOAD_NT
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b32 v[0:1], v2, off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-LABEL: global_load_monitor_b64_saddr_scale_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_monitor_b64 v[2:3], v2, s[0:1] scale_offset th:TH_LOAD_NT
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-SDAG-LABEL: global_load_monitor_b64_saddr_no_scale_offset:
...
; GFX1210-SDAG-NEXT:    global_load_monitor_b64 v[2:3], v[2:3], off th:TH_LOAD_NT
; GFX1210-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1210-SDAG-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-SDAG-NEXT:    s_endpgm
;
; GFX1210-GISEL-LABEL: global_load_monitor_b64_saddr_no_scale_offset:
...
; GFX1210-GISEL-NEXT:    global_load_monitor_b64 v[2:3], v[2:3], off th:TH_LOAD_NT
