...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -O3 < %s | FileCheck -check-prefixes=GFX950 %s
...
define void @no_store_before_atomic(ptr addrspace(1) %atomic_ptr, ptr addrspace(1) %out) {
; GFX950-LABEL: no_store_before_atomic:
; GFX950:       ; %bb.0: ; %entry
; GFX950-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-NEXT:    v_mov_b64_e32 v[4:5], 42
; GFX950-NEXT:    buffer_wbl2 sc0 sc1
; GFX950-NEXT:    global_atomic_swap_x2 v[0:1], v[0:1], v[4:5], off sc0 sc1
; GFX950-NEXT:    s_waitcnt vmcnt(0)
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
entry:
  %old = atomicrmw xchg ptr addrspace(1) %atomic_ptr, i64 42 seq_cst
  store i64 %old, ptr addrspace(1) %out, align 8
  ret void
}
