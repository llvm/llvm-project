...
; RUN: llc -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -check-prefix=GCN %s
; RUN: llc -mtriple=amdgpu10.10-mesa-mesa3d -o - %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -mtriple=amdgpu11.00-mesa-mesa3d -amdgpu-enable-delay-alu=0 -o - %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
