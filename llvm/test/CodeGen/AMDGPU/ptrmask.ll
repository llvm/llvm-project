...
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -o - %s | FileCheck -check-prefix=GFX11 %s
...
;
; GFX11-LABEL: v_ptrmask_global_variable_i64:
; GFX11:       ; %bb.0:
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ptrmask_local_variable_i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ptrmask_local_variable_i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_and_b32_e32 v0, v0, v1
...
;
; GFX11-LABEL: s_ptrmask_global_variable_i64:
; GFX11:       ; %bb.0:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ptrmask_global_variable_i32:
; GFX11:       ; %bb.0:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ptrmask_global_variable_i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ptrmask_local_variable_i64:
; GFX11:       ; %bb.0:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ptrmask_local_variable_i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_and_b32 s0, s2, s3
; GFX11-NEXT:    ; return to shader part epilog
  %masked = call i8 addrspace(3)* @llvm.ptrmask.p3i8.i32(i8 addrspace(3)* %ptr, i32 %mask)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ptrmask_local_variable_i16:
; GFX11:       ; %bb.0:
