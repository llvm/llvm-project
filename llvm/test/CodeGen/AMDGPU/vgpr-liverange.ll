...
; SI-NEXT:    s_mov_b32 s11, 0x31c16000
...
; SI-NEXT:    s_cselect_b32 exec_lo, s0, s7
; SI-NEXT:    s_cbranch_scc1 .LBB3_1
; SI-NEXT:  ; %bb.2:
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:    ; implicit-def: $vgpr2
...
; SI-NEXT:    s_cbranch_scc0 .LBB3_6
; SI-NEXT:  .LBB3_4: ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    v_readfirstlane_b32 s4, v2
; SI-NEXT:    v_readfirstlane_b32 s5, v3
; SI-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[2:3]
; SI-NEXT:    s_and_saveexec_b32 s6, vcc_lo
; SI-NEXT:    s_mov_b64 s[0:1], s[8:9]
; SI-NEXT:    s_mov_b64 s[2:3], s[10:11]
; SI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; SI-NEXT:    v_mov_b32_e32 v1, v0
; SI-NEXT:    s_xor_b32 s0, exec_lo, s6
; SI-NEXT:    ; implicit-def: $vgpr2_vgpr3
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:    s_and_b32 s1, s0, -1
; SI-NEXT:    s_cselect_b32 exec_lo, s0, s6
...
; SI-NEXT:  .LBB4_1: ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    v_readfirstlane_b32 s4, v4
; SI-NEXT:    v_readfirstlane_b32 s5, v5
; SI-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[4:5]
; SI-NEXT:    s_and_saveexec_b32 s7, vcc_lo
...
; SI-NEXT:    s_and_b32 s0, s6, -1
; SI-NEXT:    s_cmov_b32 exec_lo, s6
; SI-NEXT:    s_cbranch_scc0 .LBB4_6
; SI-NEXT:  .LBB4_4: ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    v_readfirstlane_b32 s4, v2
; SI-NEXT:    v_readfirstlane_b32 s5, v3
; SI-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[2:3]
; SI-NEXT:    s_and_saveexec_b32 s6, vcc_lo
