...
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck %s --check-prefix=GFX9
; RUN: llc -mtriple=amdgpu12.00 -mattr=+real-true16 < %s | FileCheck %s --check-prefix=GFX12-TRUE16
...
; GFX12-TRUE16:       ; %bb.0:
; GFX12-TRUE16-NEXT:    v_bfe_u32 v0, s0, 4, 4
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
