...
; RUN: llc -mtriple=amdgpu12.00-mesa-mesa3d < %s | FileCheck -check-prefix=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.50-mesa-mesa3d < %s | FileCheck -check-prefix=GFX1250 %s
...
; GFX1200-NEXT:    ; implicit-def: $vgpr1_128
...
; GFX1250-NEXT:    ; implicit-def: $vgpr8_128
