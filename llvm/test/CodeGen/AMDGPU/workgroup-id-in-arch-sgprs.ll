...
; GFX1200-NEXT:    s_endpgm
;
; GFX1250-LABEL: workgroup_id_xy:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; GFX1250-NEXT:    s_bfe_u32 s6, ttmp6, 0x40010
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_and_b32 s4, ttmp7, 0xffff
; GFX1250-NEXT:    s_add_co_i32 s6, s6, 1
; GFX1250-NEXT:    s_bfe_u32 s7, ttmp6, 0x4000c
; GFX1250-NEXT:    s_mul_i32 s5, s4, s6
; GFX1250-NEXT:    s_bfe_u32 s6, ttmp6, 0x40004
; GFX1250-NEXT:    s_add_co_i32 s7, s7, 1
; GFX1250-NEXT:    s_add_co_i32 s6, s6, s5
; GFX1250-NEXT:    s_and_b32 s5, ttmp6, 15
; GFX1250-NEXT:    s_mul_i32 s7, ttmp9, s7
; GFX1250-NEXT:    s_getreg_b32 s8, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-NEXT:    s_add_co_i32 s5, s5, s7
; GFX1250-NEXT:    s_cmp_eq_u32 s8, 0
; GFX1250-NEXT:    s_cselect_b32 s5, ttmp9, s5
; GFX1250-NEXT:    s_cselect_b32 s4, s4, s6
...
; GFX1200-NEXT:    s_endpgm
;
; GFX1250-LABEL: workgroup_id_xyz:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    s_bfe_u32 s0, ttmp6, 0x40014
; GFX1250-NEXT:    s_lshr_b32 s8, ttmp7, 16
; GFX1250-NEXT:    s_add_co_i32 s9, s0, 1
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; GFX1250-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10 nv
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mul_i32 s4, s8, s9
; GFX1250-NEXT:    s_bfe_u32 s9, ttmp6, 0x40010
; GFX1250-NEXT:    s_bfe_u32 s5, ttmp6, 0x40008
; GFX1250-NEXT:    s_and_b32 s10, ttmp7, 0xffff
; GFX1250-NEXT:    s_add_co_i32 s9, s9, 1
; GFX1250-NEXT:    s_bfe_u32 s11, ttmp6, 0x4000c
; GFX1250-NEXT:    s_add_co_i32 s5, s5, s4
; GFX1250-NEXT:    s_mul_i32 s4, s10, s9
; GFX1250-NEXT:    s_bfe_u32 s9, ttmp6, 0x40004
; GFX1250-NEXT:    s_add_co_i32 s11, s11, 1
; GFX1250-NEXT:    s_add_co_i32 s9, s9, s4
; GFX1250-NEXT:    s_and_b32 s4, ttmp6, 15
; GFX1250-NEXT:    s_mul_i32 s11, ttmp9, s11
; GFX1250-NEXT:    s_getreg_b32 s12, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-NEXT:    s_add_co_i32 s4, s4, s11
; GFX1250-NEXT:    s_cmp_eq_u32 s12, 0
; GFX1250-NEXT:    s_cselect_b32 s4, ttmp9, s4
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s4
; GFX1250-NEXT:    s_cselect_b32 s4, s10, s9
; GFX1250-NEXT:    s_cselect_b32 s5, s8, s5
; GFX1250-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1250-NEXT:    global_store_b32 v0, v2, s[2:3]
; GFX1250-NEXT:    global_store_b32 v0, v3, s[6:7]
; GFX1250-NEXT:    s_endpgm
