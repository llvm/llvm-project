...
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_mov_b32 s4, 0xc0c0004
; GISEL-NEXT:    v_perm_b32 v20, v20, v21, s4
; GISEL-NEXT:    v_perm_b32 v21, v22, v23, s4
; GISEL-NEXT:    buffer_load_ubyte v22, off, s[0:3], s32
; GISEL-NEXT:    v_perm_b32 v12, v12, v13, s4
; GISEL-NEXT:    v_perm_b32 v13, v14, v15, s4
; GISEL-NEXT:    v_perm_b32 v8, v8, v9, s4
; GISEL-NEXT:    v_perm_b32 v9, v10, v11, s4
; GISEL-NEXT:    v_perm_b32 v4, v4, v5, s4
; GISEL-NEXT:    v_perm_b32 v5, v6, v7, s4
; GISEL-NEXT:    v_perm_b32 v10, v0, v1, s4
; GISEL-NEXT:    v_perm_b32 v3, v2, v3, s4
; GISEL-NEXT:    v_perm_b32 v24, v24, v25, s4
; GISEL-NEXT:    v_perm_b32 v25, v26, v27, s4
; GISEL-NEXT:    v_perm_b32 v23, v28, v29, s4
; GISEL-NEXT:    v_perm_b32 v16, v16, v17, s4
; GISEL-NEXT:    v_perm_b32 v17, v18, v19, s4
; GISEL-NEXT:    v_lshl_or_b32 v7, v13, 16, v12
; GISEL-NEXT:    v_lshl_or_b32 v6, v9, 16, v8
; GISEL-NEXT:    v_lshl_or_b32 v5, v5, 16, v4
; GISEL-NEXT:    v_lshl_or_b32 v4, v3, 16, v10
; GISEL-NEXT:    v_lshl_or_b32 v2, v25, 16, v24
; GISEL-NEXT:    v_lshl_or_b32 v1, v21, 16, v20
; GISEL-NEXT:    v_lshl_or_b32 v0, v17, 16, v16
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    v_perm_b32 v3, v30, v22, s4
; GISEL-NEXT:    v_lshl_or_b32 v3, v3, 16, v23
; GISEL-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0
; GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[16:19], 0 offset:16
; GISEL-NEXT:    s_waitcnt vmcnt(0)
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %p = addrspacecast ptr addrspace(8) %buf to ptr addrspace(7)
