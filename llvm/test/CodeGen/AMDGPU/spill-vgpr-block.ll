...
; RUN: llc -global-isel=1 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=+block-vgpr-csr -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn--amdpal -mcpu=gfx1200 -mattr=+block-vgpr-csr -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,DAGISEL %s
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_b32 s2, s[0:1], 0x0
; GISEL-NEXT:    ;;#ASMSTART
; GISEL-NEXT:    s_nop
; GISEL-NEXT:    ;;#ASMEND
...
; DAGISEL:       ; %bb.0:
; DAGISEL-NEXT:    s_load_b32 s2, s[0:1], 0x0
...
; DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
