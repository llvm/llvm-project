...
; RUN: llc -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -check-prefixes=SI,GCN %s
; RUN: llc -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=VI,GCN %s
...
; VI-NEXT:    v_add_f64 v[0:1], s[4:5], -|v[0:1]|
...
; VI-NEXT:    v_mov_b32_e32 v0, s2
; VI-NEXT:    v_mov_b32_e32 v1, s3
; VI-NEXT:    v_mul_f64 v[0:1], s[4:5], -|v[0:1]|
; VI-NEXT:    v_mov_b32_e32 v2, s0
; VI-NEXT:    v_mov_b32_e32 v3, s1
; VI-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; VI-NEXT:    s_endpgm
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_or_b32 s0, s3, 0x80000000
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s2
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_or_b32 s6, s15, 0x80000000
; SI-NEXT:    s_or_b32 s7, s13, 0x80000000
; SI-NEXT:    s_or_b32 s4, s11, 0x80000000
; SI-NEXT:    s_or_b32 s5, s9, 0x80000000
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_or_b32 s4, s11, 0x80000000
; VI-NEXT:    s_or_b32 s5, s9, 0x80000000
; VI-NEXT:    s_or_b32 s2, s15, 0x80000000
; VI-NEXT:    s_or_b32 s3, s13, 0x80000000
