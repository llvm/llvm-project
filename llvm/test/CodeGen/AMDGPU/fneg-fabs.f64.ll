...
; RUN: llc -mtriple=amdgcn < %s | FileCheck -check-prefixes=SI,GCN %s
...
; SI-NEXT:    s_or_b32 s5, s15, 0x80000000
; SI-NEXT:    s_or_b32 s6, s13, 0x80000000
; SI-NEXT:    s_or_b32 s7, s9, 0x80000000
