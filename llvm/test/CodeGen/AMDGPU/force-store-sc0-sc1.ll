...
; FORCESC0SC1-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
...
; NOSC0SC1:       ; %bb.0: ; %entry
; NOSC0SC1-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
...
; FORCESC0SC1:       ; %bb.0: ; %entry
; FORCESC0SC1-NEXT:    s_load_dword s0, s[4:5], 0x24
...
; NOSC0SC1:       ; %bb.0: ; %entry
; NOSC0SC1-NEXT:    s_load_dword s0, s[4:5], 0x24
