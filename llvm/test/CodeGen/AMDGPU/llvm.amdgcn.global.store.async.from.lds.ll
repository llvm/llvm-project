...
; GFX13-NEXT:    global_store_async_from_lds_b8 v[0:1], v2, off offset:16 th:TH_LOAD_NT
; GFX13-NEXT:    s_endpgm
entry:
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX13-NEXT:    global_store_async_from_lds_b32 v[0:1], v2, off offset:16 th:TH_LOAD_HT scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX13-NEXT:    global_store_async_from_lds_b64 v[0:1], v2, off offset:16 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX13-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX13-NEXT:    global_store_async_from_lds_b128 v[0:1], v2, off offset:16 th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX13-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    global_store_async_from_lds_b32 v1, v0, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX13-NEXT:    s_endpgm
entry:
...
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    global_store_async_from_lds_b64 v1, v0, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX13-NEXT:    s_endpgm
entry:
  %idxprom = sext i32 %idx to i64
...
; GFX13-SDAG-NEXT:    global_store_async_from_lds_b64 v[1:2], v0, off offset:16 th:TH_LOAD_NT
...
; GFX13-GISEL-NEXT:    global_store_async_from_lds_b64 v[1:2], v0, off offset:16 th:TH_LOAD_NT
