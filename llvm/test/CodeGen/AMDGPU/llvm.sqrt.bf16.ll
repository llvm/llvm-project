...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck -check-prefixes=GFX12-FAKE16 %s
...
; GFX12-TRUE16-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE
...
; GFX12-FAKE16-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SE
