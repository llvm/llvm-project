...
; VARIANT0:       ; %bb.0: ; %entry
; VARIANT0-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; VARIANT0-NEXT:    s_mov_b32 s1, 0
; VARIANT0-NEXT:    v_not_b32_e32 v3, v0
; VARIANT0-NEXT:    s_mov_b32 s6, s1
; VARIANT0-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; VARIANT1:       ; %bb.0: ; %entry
; VARIANT1-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; VARIANT1-NEXT:    s_mov_b32 s1, 0
; VARIANT1-NEXT:    v_not_b32_e32 v3, v0
; VARIANT1-NEXT:    s_mov_b32 s6, s1
; VARIANT1-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; VARIANT2:       ; %bb.0: ; %entry
; VARIANT2-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VARIANT2-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; VARIANT2-NEXT:    s_waitcnt lgkmcnt(0)
; VARIANT2-NEXT:    s_mov_b32 s1, 0
...
; VARIANT2-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
...
; VARIANT3:       ; %bb.0: ; %entry
; VARIANT3-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VARIANT3-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; VARIANT3-NEXT:    s_waitcnt lgkmcnt(0)
; VARIANT3-NEXT:    s_mov_b32 s1, 0
...
; VARIANT3-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
...
; VARIANT4-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
...
; VARIANT5-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
...
; VARIANT6-NEXT:    s_add_co_i32 s1, s2, -1
; VARIANT6-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; VARIANT6-NEXT:    v_sub_nc_u32_e32 v0, s1, v1
; VARIANT6-NEXT:    s_mov_b32 s1, 0
; VARIANT6-NEXT:    s_wait_alu depctr_sa_sdst(0)
