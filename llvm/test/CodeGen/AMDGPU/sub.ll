...
; RUN: llc -amdgpu-scalarize-global-loads=false -march=amdgcn -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN4 %s
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: s_sub_i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_sub_co_i32 s2, s2, s3
; GCN4-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN4-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GCN4-NEXT:    global_store_b32 v0, v1, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %result = sub i32 %a, %b
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: s_sub_imm_i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    s_load_b32 s2, s[0:1], 0x2c
; GCN4-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_sub_co_i32 s2, 0x4d2, s2
; GCN4-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN4-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GCN4-NEXT:    global_store_b32 v0, v1, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_mov_b32_e32 v2, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_b64 v[0:1], v2, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_nc_u32_e32 v0, v0, v1
; GCN4-NEXT:    global_store_b32 v2, v0, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_imm_i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_mov_b32_e32 v0, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_b32 v1, v0, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_nc_u32_e32 v1, 0x7b, v1
; GCN4-NEXT:    global_store_b32 v0, v1, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %a = load i32, ptr addrspace(1) %in
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_v2i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_mov_b32_e32 v4, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_b128 v[0:3], v4, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_nc_u32_e32 v1, v1, v3
; GCN4-NEXT:    v_sub_nc_u32_e32 v0, v0, v2
; GCN4-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_v4i32:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_mov_b32_e32 v8, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    global_load_b128 v[0:3], v8, s[2:3] offset:16
; GCN4-NEXT:    global_load_b128 v[4:7], v8, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_nc_u32_e32 v3, v7, v3
; GCN4-NEXT:    v_sub_nc_u32_e32 v2, v6, v2
; GCN4-NEXT:    v_sub_nc_u32_e32 v1, v5, v1
; GCN4-NEXT:    v_sub_nc_u32_e32 v0, v4, v0
; GCN4-NEXT:    global_store_b128 v8, v[0:3], s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_i16:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; GCN4-NEXT:    v_mov_b32_e32 v2, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_u16 v1, v0, s[2:3] scope:SCOPE_SYS
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    global_load_u16 v0, v0, s[2:3] offset:2 scope:SCOPE_SYS
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_nc_u16 v0, v1, v0
; GCN4-NEXT:    global_store_b16 v2, v0, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_v2i16:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GCN4-NEXT:    v_mov_b32_e32 v2, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_b64 v[0:1], v0, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_pk_sub_i16 v0, v0, v1
; GCN4-NEXT:    global_store_b32 v2, v0, s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: test_sub_v4i16:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GCN4-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GCN4-NEXT:    v_mov_b32_e32 v4, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    global_load_b128 v[0:3], v0, s[2:3]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_pk_sub_i16 v1, v1, v3
; GCN4-NEXT:    v_pk_sub_i16 v0, v0, v2
; GCN4-NEXT:    global_store_b64 v4, v[0:1], s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: s_sub_i64:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    s_load_b128 s[4:7], s[0:1], 0x2c
; GCN4-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_sub_nc_u64 s[2:3], s[4:5], s[6:7]
; GCN4-NEXT:    v_mov_b32_e32 v2, 0
; GCN4-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GCN4-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %result = sub i64 %a, %b
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: v_sub_i64:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    s_load_b128 s[4:7], s[0:1], 0x24
; GCN4-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
; GCN4-NEXT:    v_lshlrev_b32_e32 v2, 3, v0
; GCN4-NEXT:    v_mov_b32_e32 v4, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    global_load_b64 v[0:1], v2, s[6:7]
; GCN4-NEXT:    global_load_b64 v[2:3], v2, s[0:1]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v2
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, v1, v3, vcc_lo
; GCN4-NEXT:    global_store_b64 v4, v[0:1], s[4:5]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: v_test_sub_v2i64:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    s_load_b128 s[4:7], s[0:1], 0x24
; GCN4-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
; GCN4-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
; GCN4-NEXT:    v_mov_b32_e32 v8, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    global_load_b128 v[0:3], v4, s[6:7]
; GCN4-NEXT:    global_load_b128 v[4:7], v4, s[0:1]
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_co_u32 v2, vcc_lo, v2, v6
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v3, vcc_lo, v3, v7, vcc_lo
; GCN4-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v4
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, v1, v5, vcc_lo
; GCN4-NEXT:    global_store_b128 v8, v[0:3], s[4:5]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() readnone
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: v_test_sub_v4i64:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    s_load_b128 s[4:7], s[0:1], 0x24
; GCN4-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
; GCN4-NEXT:    v_lshlrev_b32_e32 v12, 5, v0
; GCN4-NEXT:    v_mov_b32_e32 v16, 0
; GCN4-NEXT:    s_wait_kmcnt 0x0
; GCN4-NEXT:    s_clause 0x3
; GCN4-NEXT:    global_load_b128 v[0:3], v12, s[6:7]
; GCN4-NEXT:    global_load_b128 v[4:7], v12, s[0:1]
; GCN4-NEXT:    global_load_b128 v[8:11], v12, s[6:7] offset:16
; GCN4-NEXT:    global_load_b128 v[12:15], v12, s[0:1] offset:16
; GCN4-NEXT:    s_wait_loadcnt 0x2
; GCN4-NEXT:    v_sub_co_u32 v2, vcc_lo, v2, v6
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v3, vcc_lo, v3, v7, vcc_lo
; GCN4-NEXT:    s_wait_loadcnt 0x0
; GCN4-NEXT:    v_sub_co_u32 v10, vcc_lo, v10, v14
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v11, vcc_lo, v11, v15, vcc_lo
; GCN4-NEXT:    v_sub_co_u32 v8, vcc_lo, v8, v12
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v9, vcc_lo, v9, v13, vcc_lo
; GCN4-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v4
; GCN4-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, v1, v5, vcc_lo
; GCN4-NEXT:    s_clause 0x1
; GCN4-NEXT:    global_store_b128 v16, v[8:11], s[4:5] offset:16
; GCN4-NEXT:    global_store_b128 v16, v[0:3], s[4:5]
; GCN4-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN4-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() readnone
...
; GCN3-NEXT:    s_endpgm
;
; GCN4-LABEL: sub_select_vop3:
; GCN4:       ; %bb.0:
; GCN4-NEXT:    v_subrev_nc_u32_e32 v0, s0, v0
; GCN4-NEXT:    ;;#ASMSTART
; GCN4-NEXT:    ; def vcc
; GCN4-NEXT:    ;;#ASMEND
; GCN4-NEXT:    ds_store_b32 v0, v0
; GCN4-NEXT:    ;;#ASMSTART
; GCN4-NEXT:    ; use vcc
; GCN4-NEXT:    ;;#ASMEND
; GCN4-NEXT:    s_endpgm
