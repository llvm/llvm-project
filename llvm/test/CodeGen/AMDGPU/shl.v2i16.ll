...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefix=GFX11 %s
...
; GFX11-NEXT:    v_pk_lshlrev_b16 v1, v2, v1
