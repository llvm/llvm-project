...
; GFX9-NEXT:    s_endpgm
;
; GFX10PLUS-LABEL: no_cluster_image_load:
; GFX10PLUS:       ; %bb.0: ; %entry
; GFX10PLUS-NEXT:    image_load v[2:5], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D unorm
; GFX10PLUS-NEXT:    image_load v[6:9], v[0:1], s[8:15] dmask:0xf dim:SQ_RSRC_IMG_2D unorm
; GFX10PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX10PLUS-NEXT:    v_add_f32_e32 v5, v5, v9
; GFX10PLUS-NEXT:    v_add_f32_e32 v4, v4, v8
; GFX10PLUS-NEXT:    v_add_f32_e32 v3, v3, v7
; GFX10PLUS-NEXT:    v_add_f32_e32 v2, v2, v6
; GFX10PLUS-NEXT:    image_store v[2:5], v[0:1], s[16:23] dmask:0xf dim:SQ_RSRC_IMG_2D unorm
