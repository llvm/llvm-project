; RUN: llc -mtriple=amdgpu6.00--amdpal <%s | FileCheck -enable-var-scope -check-prefixes=GCN,SICI,SI %s
; RUN: llc -mtriple=amdgpu7.00--amdpal <%s | FileCheck -enable-var-scope -check-prefixes=GCN,SICI,CI %s
