...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr4_hi16 killed $sgpr0 killed $exec
...
; GFX11-DL-TRUE16-NEXT:    v_pk_mul_lo_u16 v6, v8, v9
...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr3_hi16 killed $sgpr0 killed $exec
; GFX11-DL-TRUE16-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DL-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX11-DL-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v2.l
; GFX11-DL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v4
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v2.h
; GFX11-DL-TRUE16-NEXT:    v_bfe_i32 v6, v0, 0, 8
...
; GFX11-DL-TRUE16-NEXT:    v_and_b16 v0.l, 0xff, v4.l
...
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v2.l, v0.l, v0.h
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v5.l
; GFX11-DL-TRUE16-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
...
; GFX11-DL-TRUE16-NEXT:    v_mad_u16 v0.l, v2.l, v4.l, v0.l
