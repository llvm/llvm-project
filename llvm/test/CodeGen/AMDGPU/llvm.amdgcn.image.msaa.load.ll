...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN,GFX13,GFX13-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN,GFX13,GFX13-FAKE16 %s
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v9, 0 :: v_dual_mov_b32 v5, v3 ; encoding: [0x80,0x80,0x20,0xcf,0x03,0x01,0x00,0x00,0x09,0x00,0x00,0x05]
...
; GFX13-NEXT:    v_dual_mov_b32 v8, v0 :: v_dual_mov_b32 v10, v9 ; encoding: [0x00,0x81,0x20,0xcf,0x09,0x01,0x00,0x00,0x08,0x00,0x00,0x0a]
; GFX13-NEXT:    v_dual_mov_b32 v11, v9 :: v_dual_mov_b32 v12, v9 ; encoding: [0x09,0x01,0x10,0xca,0x09,0x01,0x0c,0x0b]
; GFX13-NEXT:    v_mov_b32_e32 v13, v9 ; encoding: [0x09,0x03,0x1a,0x7e]
; GFX13-NEXT:    v_dual_mov_b32 v0, v9 :: v_dual_mov_b32 v1, v10 ; encoding: [0x09,0x01,0x10,0xca,0x0a,0x01,0x00,0x00]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3) ; encoding: [0x93,0x01,0xae,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v2, v11 :: v_dual_mov_b32 v3, v12 ; encoding: [0x0b,0x01,0x10,0xca,0x0c,0x01,0x02,0x02]
; GFX13-NEXT:    v_mov_b32_e32 v4, v13 ; encoding: [0x0d,0x03,0x08,0x7e]
...
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    global_store_b32 v9, v4, s[8:9] scope:SCOPE_SE ; encoding: [0x08,0x00,0x07,0xee,0x00,0x00,0x04,0x02,0x09,0x00,0x00,0x00]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, 0 ; encoding: [0x00,0x01,0x10,0xca,0x80,0x00,0x06,0x06]
; GFX13-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1 ; encoding: [0x02,0x01,0x10,0xca,0x01,0x01,0x04,0x04]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1) ; encoding: [0x92,0x00,0xae,0xbf]
; GFX13-NEXT:    v_dual_mov_b32 v8, v7 :: v_dual_mov_b32 v9, v7 ; encoding: [0x07,0x01,0x10,0xca,0x07,0x01,0x08,0x08]
; GFX13-NEXT:    v_dual_mov_b32 v0, v7 :: v_dual_mov_b32 v1, v8 ; encoding: [0x07,0x01,0x10,0xca,0x08,0x01,0x00,0x00]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) ; encoding: [0x02,0x00,0xae,0xbf]
; GFX13-NEXT:    v_mov_b32_e32 v2, v9 ; encoding: [0x09,0x03,0x04,0x7e]
...
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    global_store_b32 v7, v2, s[8:9] scope:SCOPE_SE ; encoding: [0x08,0x00,0x07,0xee,0x00,0x00,0x04,0x01,0x07,0x00,0x00,0x00]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
