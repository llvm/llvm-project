...
; GFX12-NEXT:    s_cbranch_scc0 .LBB0_20
; GFX12-NEXT:  ; %bb.1: ; %bb
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_cmp_eq_u32 s0, 0
; GFX11-NEXT:    s_cbranch_scc0 .LBB1_20
; GFX11-NEXT:  ; %bb.1: ; %bb0
; GFX11-NEXT:    s_getpc_b64 s[2:3]
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_cmp_eq_u32 s0, 0
; GFX12-NEXT:    s_cbranch_scc0 .LBB1_20
; GFX12-NEXT:  ; %bb.1: ; %bb0
; GFX12-NEXT:    s_getpc_b64 s[2:3]
...
; GFX11-NEXT:    s_cbranch_vccz .LBB2_20
; GFX11-NEXT:  ; %bb.1: ; %bb0
; GFX11-NEXT:    s_getpc_b64 s[2:3]
...
; GFX12-NEXT:    s_cbranch_scc0 .LBB2_20
; GFX12-NEXT:  ; %bb.1: ; %bb0
; GFX12-NEXT:    s_getpc_b64 s[2:3]
...
; GFX11-NEXT:    s_cbranch_execnz .LBB3_20
; GFX11-NEXT:  ; %bb.1: ; %bb
; GFX11-NEXT:    s_getpc_b64 s[2:3]
...
; GFX12-NEXT:    s_cbranch_execnz .LBB3_20
; GFX12-NEXT:  ; %bb.1: ; %bb
; GFX12-NEXT:    s_getpc_b64 s[2:3]
...
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_cbranch_execnz .LBB5_6
; GFX11-NEXT:  ; %bb.5: ; %bb3
...
; GFX12-NEXT:    s_cbranch_scc0 .LBB5_20
; GFX12-NEXT:  ; %bb.1: ; %bb0
...
; GFX12-NEXT:    v_nop_e64
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_cbranch_execnz .LBB5_7
; GFX12-NEXT:  ; %bb.6: ; %bb3
; GFX12-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_cbranch_vccz .LBB6_3
; GFX11-NEXT:  ; %bb.2: ; %loop
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[0:1]
; GFX11-NEXT:  .LBB6_3: ; %DummyReturnBlock
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    v_nop_e64
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_cbranch_vccz .LBB6_3
; GFX12-NEXT:  ; %bb.2: ; %loop
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[0:1]
; GFX12-NEXT:  .LBB6_3: ; %DummyReturnBlock
; GFX12-NEXT:    s_endpgm
entry:
  br label %loop
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_not1_b64 vcc, exec, s[0:1]
; GFX11-NEXT:    s_cbranch_vccz .LBB7_40
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_vccz .LBB7_40
...
; GFX11-NEXT:    s_cbranch_execnz .LBB9_40
; GFX11-NEXT:  ; %bb.3: ; %Flow1
; GFX11-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_setpc_b64 s[0:1]
; GFX11-NEXT:  .LBB9_40: ; %loop.preheader
...
; GFX11-NEXT:  ; %bb.6: ; %loop
; GFX11-NEXT:    ; in Loop: Header=BB9_5 Depth=1
; GFX11-NEXT:    s_getpc_b64 s[0:1]
...
; GFX12-NEXT:    s_cbranch_execnz .LBB9_40
; GFX12-NEXT:  ; %bb.3: ; %Flow1
; GFX12-NEXT:    s_getpc_b64 s[0:1]
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[0:1]
; GFX12-NEXT:  .LBB9_40: ; %loop.preheader
...
; GFX12-NEXT:  ; %bb.6: ; %loop
; GFX12-NEXT:    ; in Loop: Header=BB9_5 Depth=1
; GFX12-NEXT:    s_getpc_b64 s[0:1]
...
; GCN-NEXT:    s_cbranch_scc1 .LBB10_20
; GCN-NEXT:  ; %bb.1: ; %bb
...
; GCN-NEXT:    s_cbranch_vccz .LBB10_7
; GCN-NEXT:  ; %bb.6: ; %Flow5
; GCN-NEXT:    s_getpc_b64 s[0:1]
...
; GFX11-NEXT:    s_cbranch_scc1 .LBB10_20
; GFX11-NEXT:  ; %bb.1: ; %bb
...
; GFX12-NEXT:    s_cbranch_scc0 .LBB10_20
; GFX12-NEXT:  ; %bb.1: ; %bb
