...
; GCN-NEXT:    s_add_u32 s6, s6, (.LBB10_2-.Lpost_getpc10)&4294967295
; GCN-NEXT:    s_addc_u32 s7, s7, (.LBB10_2-.Lpost_getpc10)>>32
...
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_7-.Lpost_getpc11)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_7-.Lpost_getpc11)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
...
; GCN-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0xf
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s6
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_lshl_b64 s[4:5], s[8:9], 2
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
; GFX11-NEXT:    s_add_u32 s6, s6, (.LBB10_2-.Lpost_getpc10)&4294967295
; GFX11-NEXT:    s_addc_u32 s7, s7, (.LBB10_2-.Lpost_getpc10)>>32
; GFX11-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b64 s[6:7], s[6:7], exec
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s6, s6, (.LBB10_2-.Lpost_getpc10)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_2-.Lpost_getpc10)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
