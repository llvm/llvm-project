...
; GCN-NEXT:    s_add_u32 s10, s10, (.LBB10_4-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_addc_u32 s11, s11, (.LBB10_4-.Lpost_getpc12)>>32
...
; GCN-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[8:9]
...
; GCN-NEXT:  ; %bb.12: ; %Flow5
; GCN-NEXT:    s_getpc_b64 s[0:1]
; GCN-NEXT:  .Lpost_getpc14:
; GCN-NEXT:    s_add_u32 s0, s0, (.LBB10_6-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_addc_u32 s1, s1, (.LBB10_6-.Lpost_getpc14)>>32
; GCN-NEXT:    s_setpc_b64 s[0:1]
...
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[6:7]
; GCN-NEXT:    v_and_b32_e32 v0, v1, v0
; GCN-NEXT:    v_and_b32_e32 v0, 1, v0
...
; GFX11-NEXT:  ; %bb.8: ; %bb13
; GFX11-NEXT:    s_getpc_b64 s[10:11]
; GFX11-NEXT:  .Lpost_getpc11:
; GFX11-NEXT:    s_waitcnt_depctr 0xfffe
; GFX11-NEXT:    s_add_u32 s10, s10, (.LBB10_4-.Lpost_getpc11)&4294967295
; GFX11-NEXT:    s_addc_u32 s11, s11, (.LBB10_4-.Lpost_getpc11)>>32
; GFX11-NEXT:    s_waitcnt_depctr 0xfffe
...
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[8:9]
; GFX11-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX11-NEXT:    s_waitcnt_depctr 0xfffe
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[8:9]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v0, v1, v0
; GFX11-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cmp_eq_u32_e64 s[8:9], 1, v0
; GFX11-NEXT:  .LBB10_4: ; %Flow5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    s_and_not1_b64 vcc, exec, s[8:9]
; GFX11-NEXT:    s_cbranch_vccz .LBB10_5
...
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[6:7]
; GFX11-NEXT:    v_and_b32_e32 v0, v1, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v0, 1, v0
...
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_4-.Lpost_getpc13)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_4-.Lpost_getpc13)>>32
; GFX12-NEXT:    s_wait_alu 0xfffe
...
; GFX12-NEXT:  ; %bb.12: ; %Flow
; GFX12-NEXT:    s_getpc_b64 s[8:9]
; GFX12-NEXT:  .Lpost_getpc14:
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_co_u32 s8, s8, (.LBB10_5-.Lpost_getpc14)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s9, s9, (.LBB10_5-.Lpost_getpc14)>>32
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_setpc_b64 s[8:9]
; GFX12-NEXT:  .LBB10_2: ; %Flow5
; GFX12-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_vccz .LBB10_3
; GFX12-NEXT:  ; %bb.14: ; %Flow5
; GFX12-NEXT:    s_getpc_b64 s[0:1]
; GFX12-NEXT:  .Lpost_getpc15:
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_co_u32 s0, s0, (.LBB10_6-.Lpost_getpc15)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB10_6-.Lpost_getpc15)>>32
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_setpc_b64 s[0:1]
...
; GFX12-NEXT:    s_cselect_b32 s0, -1, 0
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX12-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s6
; GFX12-NEXT:    v_and_b32_e32 v0, v1, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-NEXT:  ; %bb.16: ; %bb13
; GFX12-NEXT:    s_getpc_b64 s[8:9]
; GFX12-NEXT:  .Lpost_getpc16:
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_co_u32 s8, s8, (.LBB10_2-.Lpost_getpc16)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s9, s9, (.LBB10_2-.Lpost_getpc16)>>32
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_setpc_b64 s[8:9]
...
; GFX12-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cmp_eq_u32_e64 s0, 1, v0
; GFX12-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_vccnz .LBB10_6
; GFX12-NEXT:  ; %bb.18: ; %bb9
; GFX12-NEXT:    s_getpc_b64 s[8:9]
; GFX12-NEXT:  .Lpost_getpc17:
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_add_co_u32 s8, s8, (.LBB10_3-.Lpost_getpc17)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s9, s9, (.LBB10_3-.Lpost_getpc17)>>32
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_setpc_b64 s[8:9]
; GFX12-NEXT:  .LBB10_6:
