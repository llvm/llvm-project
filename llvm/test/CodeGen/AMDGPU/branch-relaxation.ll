...
; GCN-NEXT:    s_bitcmp0_b32 s10, 0
; GCN-NEXT:    s_cbranch_scc1 .LBB10_7
; GCN-NEXT:  ; %bb.11: ; %bb13
; GCN-NEXT:    s_getpc_b64 s[8:9]
; GCN-NEXT:  .Lpost_getpc14:
; GCN-NEXT:    s_add_u32 s8, s8, (.LBB10_3-.Lpost_getpc14)&4294967295
; GCN-NEXT:    s_addc_u32 s9, s9, (.LBB10_3-.Lpost_getpc14)>>32
; GCN-NEXT:    s_setpc_b64 s[8:9]
; GCN-NEXT:  .LBB10_7: ; %bb13
...
; GFX11-NEXT:    v_nop_e64
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_bitcmp0_b32 s10, 0
...
; GFX11-NEXT:    s_bitcmp0_b32 s10, 0
; GFX11-NEXT:    s_cbranch_scc1 .LBB10_4
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s8, s8, (.LBB10_2-.Lpost_getpc12)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s9, s9, (.LBB10_2-.Lpost_getpc12)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
