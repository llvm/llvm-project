...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s12, s12, (.LBB10_4-.Lpost_getpc16)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s13, s13, (.LBB10_4-.Lpost_getpc16)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_5-.Lpost_getpc12)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_5-.Lpost_getpc12)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-NEXT:    s_and_b32 s2, s8, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s2
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_2-.Lpost_getpc14)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_2-.Lpost_getpc14)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[10:11]
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_add_co_u32 s10, s10, (.LBB10_3-.Lpost_getpc15)&4294967295
; GFX12-NEXT:    s_add_co_ci_u32 s11, s11, (.LBB10_3-.Lpost_getpc15)>>32
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_setpc_b64 s[10:11]
; GFX12-NEXT:  .LBB10_6:
