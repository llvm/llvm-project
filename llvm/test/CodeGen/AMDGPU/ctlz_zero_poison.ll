...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX9-GISEL %s
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_lshl_b32 s0, s2, 24
; SI-NEXT:    s_flbit_i32_b32 s0, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s0
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_lshl_b32 s0, s2, 14
; SI-NEXT:    s_flbit_i32_b32 s0, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_bfe_u32 s1, s0, 0x20010
