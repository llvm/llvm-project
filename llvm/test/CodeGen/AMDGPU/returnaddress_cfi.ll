...
; CHECK-NEXT:    buffer_store_dword v39, off, s[0:3], s32 offset:196 ; 4-byte Folded Spill
; CHECK-NEXT:    .cfi_offset 2599, 12544
; CHECK-NEXT:    s_mov_b64 exec, s[16:17]

; CHECK:    v_writelane_b32 v39, s30, 32
; CHECK-NEXT:    v_writelane_b32 v39, s31, 33
; CHECK-NEXT:    .cfi_escape 0x10, 0x10, 0x0e, 0x90, 0xa7, 0x14, 0x9d, 0x20, 0x80, 0x08, 0x90, 0xa7, 0x14, 0x9d, 0x20, 0xa0, 0x08 ;
; CHECK:    ;;#ASMSTART
; CHECK-NEXT:    ; clobber nonpreserved and 32 CSR SGPRs
; CHECK-NEXT:    ;;#ASMEND

; CHECK:    ;;#ASMSTART
; CHECK-NEXT:    ; clobber all VGPRs except v39
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-DAG:    v_readlane_b32 s30, v39, 32
; CHECK-DAG:    v_readlane_b32 s31, v39, 33

; CHECK:    s_or_saveexec_b64 s[4:5], -1
; CHECK-NEXT:    buffer_load_dword v39, off, s[0:3], s32 offset:196 ; 4-byte Folded Reload
