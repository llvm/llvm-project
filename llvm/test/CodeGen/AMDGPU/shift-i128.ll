...
; GCN-NEXT:    v_sub_i32_e32 v22, vcc, 64, v12
; GCN-NEXT:    v_or_b32_e32 v21, v19, v17
; GCN-NEXT:    v_subrev_i32_e32 v17, vcc, 64, v8
; GCN-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; GCN-NEXT:    v_cmp_gt_u64_e64 s[4:5], 64, v[8:9]
; GCN-NEXT:    v_lshl_b64 v[19:20], v[0:1], v17
...
; GCN-NEXT:    v_cndmask_b32_e32 v9, v19, v16, vcc
; GCN-NEXT:    v_cndmask_b32_e32 v20, v20, v21, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v2, v9, v2, s[4:5]
; GCN-NEXT:    v_subrev_i32_e64 v9, s[6:7], 64, v12
; GCN-NEXT:    v_lshl_b64 v[16:17], v[6:7], v12
; GCN-NEXT:    v_lshr_b64 v[18:19], v[4:5], v22
; GCN-NEXT:    v_cndmask_b32_e64 v3, v20, v3, s[4:5]
...
; GCN-NEXT:    v_or_b32_e32 v11, v17, v19
...
; GCN-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; GCN-NEXT:    v_cmp_gt_u64_e64 s[4:5], 64, v[8:9]
; GCN-NEXT:    v_lshr_b64 v[19:20], v[2:3], v17
; GCN-NEXT:    v_or_b32_e32 v11, v9, v11
; GCN-NEXT:    v_or_b32_e32 v10, v8, v10
; GCN-NEXT:    v_or_b32_e32 v16, v18, v16
; GCN-NEXT:    s_and_b64 vcc, vcc, s[4:5]
...
; GCN-NEXT:    v_lshl_b64 v[18:19], v[6:7], v22
; GCN-NEXT:    v_cndmask_b32_e64 v1, v20, v1, s[4:5]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[14:15]
; GCN-NEXT:    v_cmp_gt_u64_e64 s[6:7], 64, v[12:13]
...
; GCN-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; GCN-NEXT:    v_cmp_gt_u64_e64 s[4:5], 64, v[8:9]
; GCN-NEXT:    v_ashr_i64 v[19:20], v[2:3], v17
; GCN-NEXT:    v_or_b32_e32 v11, v9, v11
; GCN-NEXT:    v_or_b32_e32 v10, v8, v10
; GCN-NEXT:    v_or_b32_e32 v16, v18, v16
; GCN-NEXT:    s_and_b64 vcc, vcc, s[4:5]
