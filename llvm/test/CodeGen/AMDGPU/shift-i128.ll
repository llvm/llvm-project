...
; GCN-NEXT:    v_and_b32_e32 v9, v16, v9
; GCN-NEXT:    v_subrev_i32_e32 v16, vcc, 64, v8
...
; GCN-NEXT:    v_subrev_i32_e64 v9, s[4:5], 64, v12
; GCN-NEXT:    v_cmp_gt_u64_e64 s[4:5], 64, v[12:13]
; GCN-NEXT:    v_or_b32_e32 v11, v17, v10
; GCN-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[4:5]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[14:15]
; GCN-NEXT:    v_lshl_b64 v[9:10], v[4:5], v9
; GCN-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[4:5]
; GCN-NEXT:    v_and_b32_e32 v17, v18, v17
...
; GCN-NEXT:    v_mov_b32_e32 v5, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_sub_i32 s20, 64, s12
; GCN-NEXT:    s_lshl_b64 s[16:17], s[6:7], s12
; GCN-NEXT:    s_lshr_b64 s[20:21], s[4:5], s20
; GCN-NEXT:    s_or_b64 s[16:17], s[16:17], s[20:21]
; GCN-NEXT:    v_cmp_lt_u64_e64 s[20:21], s[12:13], 64
; GCN-NEXT:    s_sub_i32 s18, s12, 64
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[20:21]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[20:21], s[14:15], 0
; GCN-NEXT:    s_lshl_b64 s[18:19], s[4:5], s18
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[20:21]
; GCN-NEXT:    v_readfirstlane_b32 s20, v1
; GCN-NEXT:    v_readfirstlane_b32 s21, v0
; GCN-NEXT:    s_and_b32 s20, s20, s21
; GCN-NEXT:    s_and_b32 s20, 1, s20
; GCN-NEXT:    s_lshl_b64 s[4:5], s[4:5], s12
; GCN-NEXT:    s_cmp_eq_u32 s20, 1
; GCN-NEXT:    s_cselect_b32 s20, s17, s19
; GCN-NEXT:    s_cselect_b32 s21, s16, s18
; GCN-NEXT:    s_cselect_b32 s22, s5, 0
; GCN-NEXT:    s_cselect_b32 s23, s4, 0
; GCN-NEXT:    s_sub_i32 s16, 64, s8
; GCN-NEXT:    s_lshr_b64 s[16:17], s[0:1], s16
; GCN-NEXT:    s_lshl_b64 s[18:19], s[2:3], s8
; GCN-NEXT:    s_or_b64 s[16:17], s[18:19], s[16:17]
; GCN-NEXT:    v_cmp_lt_u64_e64 s[18:19], s[8:9], 64
; GCN-NEXT:    s_sub_i32 s4, s8, 64
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[18:19]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[18:19], s[10:11], 0
; GCN-NEXT:    s_lshl_b64 s[4:5], s[0:1], s4
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[18:19]
; GCN-NEXT:    v_readfirstlane_b32 s18, v1
; GCN-NEXT:    v_readfirstlane_b32 s19, v0
; GCN-NEXT:    s_and_b32 s18, s18, s19
; GCN-NEXT:    s_and_b32 s18, 1, s18
; GCN-NEXT:    s_lshl_b64 s[0:1], s[0:1], s8
; GCN-NEXT:    s_cmp_eq_u32 s18, 1
; GCN-NEXT:    s_cselect_b32 s4, s16, s4
; GCN-NEXT:    s_cselect_b32 s5, s17, s5
; GCN-NEXT:    s_cselect_b32 s16, s1, 0
; GCN-NEXT:    s_cselect_b32 s17, s0, 0
...
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s6, s21
; GCN-NEXT:    s_cselect_b32 s1, s7, s20
; GCN-NEXT:    v_mov_b32_e32 v2, s0
; GCN-NEXT:    v_mov_b32_e32 v3, s1
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_sub_i32 s20, 64, s12
; GCN-NEXT:    s_lshr_b64 s[16:17], s[4:5], s12
; GCN-NEXT:    s_lshl_b64 s[20:21], s[6:7], s20
; GCN-NEXT:    s_or_b64 s[16:17], s[16:17], s[20:21]
; GCN-NEXT:    v_cmp_lt_u64_e64 s[20:21], s[12:13], 64
; GCN-NEXT:    s_sub_i32 s18, s12, 64
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[20:21]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[20:21], s[14:15], 0
; GCN-NEXT:    s_lshr_b64 s[18:19], s[6:7], s18
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[20:21]
; GCN-NEXT:    v_readfirstlane_b32 s20, v1
; GCN-NEXT:    v_readfirstlane_b32 s21, v0
; GCN-NEXT:    s_and_b32 s20, s20, s21
; GCN-NEXT:    s_and_b32 s20, 1, s20
; GCN-NEXT:    s_lshr_b64 s[6:7], s[6:7], s12
; GCN-NEXT:    s_cmp_eq_u32 s20, 1
; GCN-NEXT:    s_cselect_b32 s20, s17, s19
; GCN-NEXT:    s_cselect_b32 s21, s16, s18
; GCN-NEXT:    s_cselect_b32 s22, s7, 0
; GCN-NEXT:    s_cselect_b32 s23, s6, 0
; GCN-NEXT:    s_sub_i32 s16, 64, s8
; GCN-NEXT:    s_lshl_b64 s[16:17], s[2:3], s16
; GCN-NEXT:    s_lshr_b64 s[18:19], s[0:1], s8
; GCN-NEXT:    s_or_b64 s[16:17], s[18:19], s[16:17]
; GCN-NEXT:    v_cmp_lt_u64_e64 s[18:19], s[8:9], 64
; GCN-NEXT:    s_sub_i32 s6, s8, 64
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[18:19]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[18:19], s[10:11], 0
; GCN-NEXT:    s_lshr_b64 s[6:7], s[2:3], s6
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[18:19]
; GCN-NEXT:    v_readfirstlane_b32 s18, v1
; GCN-NEXT:    v_readfirstlane_b32 s19, v0
; GCN-NEXT:    s_and_b32 s18, s18, s19
...
; GCN-NEXT:    s_cmp_eq_u32 s18, 1
; GCN-NEXT:    s_cselect_b32 s6, s16, s6
; GCN-NEXT:    s_cselect_b32 s7, s17, s7
; GCN-NEXT:    s_cselect_b32 s16, s3, 0
; GCN-NEXT:    s_cselect_b32 s17, s2, 0
; GCN-NEXT:    s_or_b64 s[2:3], s[8:9], s[10:11]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[2:3], s[2:3], 0
; GCN-NEXT:    v_mov_b32_e32 v2, s23
; GCN-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GCN-NEXT:    s_cselect_b32 s2, s1, s7
; GCN-NEXT:    s_cselect_b32 s3, s0, s6
; GCN-NEXT:    s_or_b64 s[0:1], s[12:13], s[14:15]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[0:1], s[0:1], 0
; GCN-NEXT:    v_mov_b32_e32 v3, s22
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s4, s21
; GCN-NEXT:    s_cselect_b32 s1, s5, s20
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
; GCN-NEXT:    s_nop 0
...
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[20:21]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[20:21], s[14:15], 0
; GCN-NEXT:    s_ashr_i64 s[18:19], s[6:7], s18
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[20:21]
; GCN-NEXT:    v_readfirstlane_b32 s20, v1
; GCN-NEXT:    v_readfirstlane_b32 s21, v0
; GCN-NEXT:    s_and_b32 s20, s20, s21
; GCN-NEXT:    s_and_b32 s20, 1, s20
; GCN-NEXT:    s_ashr_i32 s21, s7, 31
; GCN-NEXT:    s_ashr_i64 s[6:7], s[6:7], s12
; GCN-NEXT:    s_cmp_eq_u32 s20, 1
; GCN-NEXT:    s_cselect_b32 s20, s17, s19
; GCN-NEXT:    s_cselect_b32 s22, s16, s18
; GCN-NEXT:    s_cselect_b32 s23, s7, s21
; GCN-NEXT:    s_cselect_b32 s21, s6, s21
; GCN-NEXT:    s_sub_i32 s16, 64, s8
; GCN-NEXT:    s_lshl_b64 s[16:17], s[2:3], s16
; GCN-NEXT:    s_lshr_b64 s[18:19], s[0:1], s8
; GCN-NEXT:    s_or_b64 s[16:17], s[18:19], s[16:17]
...
; GCN-NEXT:    s_and_b32 s18, s18, s19
; GCN-NEXT:    s_and_b32 s18, 1, s18
; GCN-NEXT:    s_ashr_i32 s19, s3, 31
; GCN-NEXT:    s_ashr_i64 s[2:3], s[2:3], s8
; GCN-NEXT:    s_cmp_eq_u32 s18, 1
; GCN-NEXT:    s_cselect_b32 s6, s16, s6
; GCN-NEXT:    s_cselect_b32 s7, s17, s7
; GCN-NEXT:    s_cselect_b32 s16, s3, s19
; GCN-NEXT:    s_cselect_b32 s17, s2, s19
; GCN-NEXT:    s_or_b64 s[2:3], s[8:9], s[10:11]
; GCN-NEXT:    v_cmp_eq_u64_e64 s[2:3], s[2:3], 0
...
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s4, s22
; GCN-NEXT:    s_cselect_b32 s1, s5, s20
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
