...
define float @fma_in_loop_f32(float %a, float %b, i32 %n) #0 {
...
define float @fsub_in_loop_f32(float %a, float %b, i32 %n) #0 {
...
define half @fma_in_loop_f16(half %a, half %b, i32 %n) #0 {
...
define double @fma_in_loop_f64(double %a, double %b, i32 %n) #0 {
...
define float @mad_in_loop_f32(float %a, float %b, i32 %n) #1 {
...
define float @no_sink_in_loop_no_contract(float %a, float %b, i32 %n) #0 {
...
define float @no_sink_in_loop_multi_use(float %a, float %b, i32 %n) #0 {
...
define half @mad_in_loop_f16(half %a, half %b, i32 %n) #1 {
...
define <2 x half> @no_fma_in_loop_v2f16(<2 x half> %a, <2 x half> %b, i32 %n) #1 {
...
define <2 x half> @fma_in_loop_v2f16_denormals(<2 x half> %a, <2 x half> %b, i32 %n) #0 {
...
define bfloat @fma_in_loop_bf16(bfloat %a, bfloat %b, i32 %n) #0 {
