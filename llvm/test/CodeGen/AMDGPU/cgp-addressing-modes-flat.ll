...
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgpu7.04-unknown-unknown < %s | FileCheck --check-prefixes=OPT,OPT-GFX7 %s
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgpu8.02-unknown-unknown < %s | FileCheck --check-prefixes=OPT,OPT-GFX8 %s
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgpu9.00-unknown-unknown < %s | FileCheck --check-prefixes=OPT,OPT-GFX9 %s
; RUN: opt -S -passes='require<profile-summary>,function(codegenprepare)' -mtriple=amdgpu10.30-unknown-unknown < %s | FileCheck --check-prefixes=OPT,OPT-GFX10 %s
