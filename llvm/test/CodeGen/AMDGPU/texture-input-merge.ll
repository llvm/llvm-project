...
; CHECK:       ; %bb.0:
; CHECK-NEXT:    CALL_FS
; CHECK-NEXT:    ALU 4, @12, KC0[], KC1[]
; CHECK-NEXT:    TEX 2 @6
; CHECK-NEXT:    ALU 7, @17, KC0[], KC1[]
; CHECK-NEXT:    EXPORT T0.XYZW
; CHECK-NEXT:    CF_END
; CHECK-NEXT:    Fetch clause starting at 6:
; CHECK-NEXT:     TEX_SAMPLE T1.XYZW, T0.ZX__ RID:0 SID:0 CT:UUUU
; CHECK-NEXT:     TEX_SAMPLE T2.XYZW, T0.XY__ RID:0 SID:0 CT:UUUU
; CHECK-NEXT:     TEX_SAMPLE T0.XYZW, T0.W___ RID:0 SID:0 CT:UUUU
; CHECK-NEXT:    ALU clause starting at 12:
; CHECK-NEXT:     MUL_IEEE T0.X, T0.X, literal.x,
; CHECK-NEXT:     MUL_IEEE T0.Y, T0.Y, literal.x,
; CHECK-NEXT:     MUL_IEEE T0.Z, T0.Z, literal.x,
; CHECK-NEXT:     MUL_IEEE * T0.W, T0.W, literal.x,
; CHECK-NEXT:    1077936128(3.000000e+00), 0(0.000000e+00)
; CHECK-NEXT:    ALU clause starting at 17:
; CHECK-NEXT:     ADD T1.W, T2.W, T1.W,
; CHECK-NEXT:     ADD * T2.W, T2.Z, T1.Z,
; CHECK-NEXT:     ADD * T0.W, PV.W, T0.W,
; CHECK-NEXT:     ADD T0.Z, T2.W, T0.Z,
; CHECK-NEXT:     ADD * T1.W, T2.Y, T1.Y,
; CHECK-NEXT:     ADD T0.Y, PV.W, T0.Y,
; CHECK-NEXT:     ADD * T1.W, T2.X, T1.X,
