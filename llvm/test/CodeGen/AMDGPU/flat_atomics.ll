...
; GCN3-NEXT:    v_addc_co_u32_e64 v1, s[0:1], 0, 0, vcc
; GCN3-NEXT:    v_mov_b32_e32 v2, s2
...
; GCN3-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    s_load_dword s1, s[4:5], 0x34
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    ; kill: killed $sgpr4_sgpr5
; GCN3-NEXT:    v_mov_b32_e32 v0, s0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v2, s1
...
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX11-NEXT:    flat_store_b32 v[0:1], v2
; GFX11-NEXT:    s_endpgm
entry:
  %ptr = getelementptr inbounds i32, ptr %out, i64 %index
...
; GCN1-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_load_dword s1, s[4:5], 0xd
; GCN1-NEXT:    v_mov_b32_e32 v1, 0
; GCN1-NEXT:    v_mov_b32_e32 v0, s0
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN2-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GCN2-NEXT:    s_waitcnt lgkmcnt(0)
; GCN2-NEXT:    s_load_dword s1, s[4:5], 0x34
; GCN2-NEXT:    v_mov_b32_e32 v1, 0
; GCN2-NEXT:    v_mov_b32_e32 v0, s0
; GCN2-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    s_mov_b32 s13, 0
; GCN3-NEXT:    s_lshl_b64 s[0:1], s[12:13], 2
; GCN3-NEXT:    s_add_u32 s0, s8, s0
; GCN3-NEXT:    s_addc_u32 s1, 0, s1
; GCN3-NEXT:    v_mov_b32_e32 v3, s1
; GCN3-NEXT:    v_mov_b32_e32 v0, s10
; GCN3-NEXT:    v_mov_b32_e32 v1, s14
...
; GFX11-NEXT:    s_lshl_b64 s[4:5], s[4:5], 2
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s6
; GFX11-NEXT:    s_add_u32 s0, s0, s4
; GFX11-NEXT:    s_addc_u32 s1, 0, s5
...
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
; GFX11-NEXT:    v_dual_mov_b32 v0, s10 :: v_dual_mov_b32 v1, 0
; GFX11-NEXT:    flat_store_b32 v[0:1], v2
; GFX11-NEXT:    s_endpgm
entry:
  %ptr = getelementptr inbounds i32, ptr %out, i64 %index
