...
; GCN1:       ; %bb.0: ; %entry
; GCN1-NEXT:    s_mov_b64 s[0:1], exec
; GCN1-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s0, 0
; GCN1-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, s1, v0
; GCN1-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GCN1-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GCN1-NEXT:    s_cbranch_execz .LBB0_2
; GCN1-NEXT:  ; %bb.1:
; GCN1-NEXT:    s_load_dword s2, s[4:5], 0xb
; GCN1-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x9
; GCN1-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GCN1-NEXT:    s_mov_b32 s7, 0xf000
; GCN1-NEXT:    s_mov_b32 s6, -1
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_mul_i32 s0, s2, s0
; GCN1-NEXT:    v_mov_b32_e32 v0, s0
; GCN1-NEXT:    buffer_atomic_add v0, off, s[4:7], 0 offset:16
...
; GCN2:       ; %bb.0: ; %entry
; GCN2-NEXT:    s_mov_b64 s[0:1], exec
; GCN2-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GCN2-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
; GCN2-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GCN2-NEXT:    s_and_saveexec_b64 s[2:3], vcc
...
; GCN2-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GCN2-NEXT:    s_mul_i32 s0, s4, s0
...
; GCN3:       ; %bb.0: ; %entry
; GCN3-NEXT:    s_mov_b64 s[0:1], exec
; GCN3-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GCN3-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
...
; GCN3-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    s_mul_i32 s0, s6, s0
; GCN3-NEXT:    v_mov_b32_e32 v1, s0
; GCN3-NEXT:    global_atomic_add v0, v1, s[2:3] offset:16
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s1
; GCN3-NEXT:    v_mov_b32_e32 v2, s6
; GCN3-NEXT:    flat_atomic_smax v0, v[0:1], v2 glc
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s1
; GCN3-NEXT:    v_mov_b32_e32 v2, s6
; GCN3-NEXT:    flat_atomic_umax v0, v[0:1], v2 glc
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s1
; GCN3-NEXT:    v_mov_b32_e32 v2, s6
; GCN3-NEXT:    flat_atomic_smin v0, v[0:1], v2 glc
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s1
; GCN3-NEXT:    v_mov_b32_e32 v2, s6
; GCN3-NEXT:    flat_atomic_umin v0, v[0:1], v2 glc
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN1-NEXT:    flat_atomic_cmpswap v0, v[0:1], v[2:3] glc
; GCN1-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_mov_b32 s5, s3
...
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[0:1], v[2:3] offset:16 glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s1
; GCN3-NEXT:    v_mov_b32_e32 v3, s7
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[0:1], v[2:3] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_mov_b32_e32 v1, 0
; GCN3-NEXT:    global_store_dword v1, v0, s[2:3]
...
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_mov_b32 s5, s3
; GCN1-NEXT:    s_mov_b32 s2, s6
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    buffer_load_dword v0, off, s[0:3], 0 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_dword v1, v0, s[0:1] offset:16 glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
...
; GCN1-NEXT:    buffer_load_dword v0, off, s[4:7], 0 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_mov_b32 s5, s3
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_dword v1, v0, s[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    global_store_dword v0, v1, s[2:3]
; GCN3-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_lshl_b64 s[8:9], s[8:9], 2
; GCN1-NEXT:    v_mov_b32_e32 v0, s8
; GCN1-NEXT:    s_mov_b32 s5, s3
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    v_mov_b32_e32 v1, s9
; GCN1-NEXT:    buffer_load_dword v0, v[0:1], s[0:3], 0 addr64 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    v_mov_b32_e32 v1, s9
; GCN1-NEXT:    buffer_load_dword v0, v[0:1], s[0:3], 0 addr64 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
...
; GCN3-NEXT:    global_store_dword v0, v1, s[0:1] offset:16
; GCN3-NEXT:    s_endpgm
entry:
  %gep = getelementptr i32, ptr %out, i32 4
...
; GCN1-NEXT:    s_load_dword s6, s[4:5], 0x9
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_lshl_b64 s[4:5], s[2:3], 2
; GCN1-NEXT:    v_mov_b32_e32 v0, s4
; GCN1-NEXT:    s_mov_b32 s3, 0xf000
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    v_mov_b32_e32 v2, s6
; GCN1-NEXT:    v_mov_b32_e32 v1, s5
; GCN1-NEXT:    buffer_store_dword v2, v[0:1], s[0:3], 0 addr64 offset:16
; GCN1-NEXT:    s_endpgm
;
...
; GCN1:       ; %bb.0: ; %entry
; GCN1-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xb
; GCN1-NEXT:    s_load_dword s8, s[4:5], 0x9
; GCN1-NEXT:    s_mov_b32 s7, 0xf000
; GCN1-NEXT:    s_mov_b32 s6, 0
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GCN1-NEXT:    s_lshl_b64 s[0:1], s[2:3], 2
; GCN1-NEXT:    v_mov_b32_e32 v0, s0
; GCN1-NEXT:    v_mov_b32_e32 v2, s8
; GCN1-NEXT:    v_mov_b32_e32 v1, s1
; GCN1-NEXT:    buffer_store_dword v2, v[0:1], s[4:7], 0 addr64
; GCN1-NEXT:    s_endpgm
;
...
; GCN1-NEXT:    s_mov_b32 s2, s6
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    buffer_load_ubyte v0, off, s[0:3], 0 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_byte v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
;
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_ubyte v1, v0, s[0:1] offset:16 glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    global_store_byte v0, v1, s[2:3]
; GCN3-NEXT:    s_endpgm
entry:
...
; GCN1-NEXT:    s_mov_b32 s4, s0
; GCN1-NEXT:    s_mov_b32 s5, s1
; GCN1-NEXT:    buffer_load_ubyte v0, off, s[4:7], 0 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_mov_b32 s5, s3
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_ubyte v1, v0, s[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    global_store_byte v0, v1, s[2:3]
; GCN3-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    buffer_load_ubyte v0, v[0:1], s[0:3], 0 addr64 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_byte v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    v_mov_b32_e32 v0, s6
; GCN1-NEXT:    buffer_store_byte v0, off, s[0:3], 0 offset:16
; GCN1-NEXT:    s_endpgm
;
...
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, s2
; GCN3-NEXT:    global_store_byte v0, v1, s[0:1] offset:16
; GCN3-NEXT:    s_endpgm
entry:
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    v_mov_b32_e32 v0, s6
; GCN1-NEXT:    buffer_store_byte v0, off, s[0:3], 0
; GCN1-NEXT:    s_endpgm
;
...
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, s2
; GCN3-NEXT:    global_store_byte v0, v1, s[0:1]
; GCN3-NEXT:    s_endpgm
entry:
...
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    v_mov_b32_e32 v2, s4
; GCN1-NEXT:    buffer_store_byte v2, v[0:1], s[0:3], 0 addr64 offset:16
; GCN1-NEXT:    s_endpgm
;
...
; GCN1-NEXT:    s_mov_b32 s2, s6
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    buffer_load_ushort v0, off, s[0:3], 0 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_ushort v1, v0, s[0:1] offset:16 glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    global_store_short v0, v1, s[2:3]
; GCN3-NEXT:    s_endpgm
entry:
...
; GCN1-NEXT:    s_mov_b32 s4, s0
; GCN1-NEXT:    s_mov_b32 s5, s1
; GCN1-NEXT:    buffer_load_ushort v0, off, s[4:7], 0 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_mov_b32 s5, s3
...
; GCN3-NEXT:    v_mov_b32_e32 v0, 0
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    global_load_ushort v1, v0, s[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    global_store_short v0, v1, s[2:3]
; GCN3-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_mov_b32 s4, s2
; GCN1-NEXT:    s_lshl_b64 s[8:9], s[8:9], 1
; GCN1-NEXT:    v_mov_b32_e32 v0, s8
; GCN1-NEXT:    s_mov_b32 s5, s3
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    s_mov_b32 s3, s7
; GCN1-NEXT:    v_mov_b32_e32 v1, s9
; GCN1-NEXT:    buffer_load_ushort v0, v[0:1], s[0:3], 0 addr64 offset:16 glc
; GCN1-NEXT:    s_waitcnt vmcnt(0)
; GCN1-NEXT:    buffer_wbinvl1_vol
; GCN1-NEXT:    buffer_store_short v0, off, s[4:7], 0
; GCN1-NEXT:    s_endpgm
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    v_mov_b32_e32 v0, s6
; GCN1-NEXT:    buffer_store_short v0, off, s[0:3], 0 offset:16
; GCN1-NEXT:    s_endpgm
;
...
; GCN3-NEXT:    s_waitcnt lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, s2
; GCN3-NEXT:    global_store_short v0, v1, s[0:1] offset:16
; GCN3-NEXT:    s_endpgm
entry:
...
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    v_mov_b32_e32 v0, s6
; GCN1-NEXT:    buffer_store_short v0, off, s[0:3], 0
; GCN1-NEXT:    s_endpgm
;
...
; GCN1-NEXT:    s_load_dword s6, s[4:5], 0x9
; GCN1-NEXT:    s_waitcnt lgkmcnt(0)
; GCN1-NEXT:    s_lshl_b64 s[4:5], s[2:3], 1
; GCN1-NEXT:    v_mov_b32_e32 v0, s4
; GCN1-NEXT:    s_mov_b32 s3, 0xf000
; GCN1-NEXT:    s_mov_b32 s2, 0
; GCN1-NEXT:    v_mov_b32_e32 v2, s6
; GCN1-NEXT:    v_mov_b32_e32 v1, s5
; GCN1-NEXT:    buffer_store_short v2, v[0:1], s[0:3], 0 addr64 offset:16
; GCN1-NEXT:    s_endpgm
;
