...
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa < %s | FileCheck -enable-var-scope -check-prefixes=CIVI,HAWAII %s
; RUN: llc -mtriple=amdgpu8.03-amd-amdhsa < %s | FileCheck -enable-var-scope -check-prefixes=CIVI,FIJI %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -enable-var-scope --check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck -enable-var-scope --check-prefix=GFX10 %s
...
; FIJI-NEXT:    s_and_b32 s2, s1, 0xffff
; FIJI-NEXT:    s_add_u32 s3, s8, 14
; FIJI-NEXT:    s_addc_u32 s4, s9, 0
; FIJI-NEXT:    v_mov_b32_e32 v0, s3
; FIJI-NEXT:    v_mov_b32_e32 v1, s4
...
; FIJI-NEXT:    v_or_b32_e32 v0, s2, v0
