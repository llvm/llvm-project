...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -check-prefixes=GCN,GFX_LIT64 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 < %s | FileCheck -check-prefixes=GCN,GFX12 %s
...
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    v_add_nc_u64_e32 v[0:1], v[0:1], v[2:3]
...
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    v_add_nc_u64_e32 v[0:1], s[0:1], v[0:1]
; GFX_LIT64-NEXT:    ; return to shader part epilog
  %add = add i64 %a, %b
  %ret = bitcast i64 %add to <2 x float>
  ret <2 x float> %ret
...
; GFX_LIT64:       ; %bb.0:
; GFX_LIT64-NEXT:    v_add_nc_u64_e32 v[0:1], 0x1f4, v[0:1]
; GFX_LIT64-NEXT:    ; return to shader part epilog
  %add = add i64 %a, 500
  %ret = bitcast i64 %add to <2 x float>
  ret <2 x float> %ret
