...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    v_cmp_ne_u64_e64 s[2:3], s[4:5], 0
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b64 vcc, vcc
; SI-NEXT:    s_cbranch_vccnz .LBB16_5
; SI-NEXT:  ; %bb.4: ; %if
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b32 s4, s2
...
; VI-NEXT:    s_cbranch_vccnz .LBB16_5
; VI-NEXT:  ; %bb.4: ; %if
; VI-NEXT:    s_mov_b32 s7, 0xf000
; VI-NEXT:    s_mov_b32 s6, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:  ; %bb.1: ; %else
; GFX9-NEXT:    s_mul_i32 s2, s4, s7
; GFX9-NEXT:    s_mul_hi_u32 s3, s4, s6
; GFX9-NEXT:    s_add_i32 s2, s3, s2
; GFX9-NEXT:    s_mul_i32 s3, s5, s6
; GFX9-NEXT:    s_add_i32 s5, s2, s3
...
; GFX9-NEXT:    s_cbranch_vccnz .LBB16_5
; GFX9-NEXT:  ; %bb.4: ; %if
; GFX9-NEXT:    s_mov_b32 s7, 0xf000
; GFX9-NEXT:    s_mov_b32 s6, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-NEXT:  ; %bb.1: ; %else
; GFX10-NEXT:    s_mul_i32 s2, s4, s7
; GFX10-NEXT:    s_mul_hi_u32 s3, s4, s6
; GFX10-NEXT:    s_mul_i32 s5, s5, s6
; GFX10-NEXT:    s_add_i32 s2, s3, s2
; GFX10-NEXT:    s_mul_i32 s4, s4, s6
; GFX10-NEXT:    s_add_i32 s5, s2, s5
...
; GFX10-NEXT:    s_cbranch_vccnz .LBB16_5
; GFX10-NEXT:  ; %bb.4: ; %if
; GFX10-NEXT:    s_mov_b32 s7, 0x31016000
; GFX10-NEXT:    s_mov_b32 s6, -1
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_cbranch_vccnz .LBB16_5
; GFX11-NEXT:  ; %bb.4: ; %if
; GFX11-NEXT:    s_mov_b32 s7, 0x31016000
; GFX11-NEXT:    s_mov_b32 s6, -1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-NEXT:    s_cbranch_vccnz .LBB16_5
; GFX12-NEXT:  ; %bb.4: ; %if
; GFX12-NEXT:    s_mov_b32 s7, 0x31016000
; GFX12-NEXT:    s_mov_b32 s6, -1
; GFX12-NEXT:    s_wait_kmcnt 0x0
