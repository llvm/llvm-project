...
; RUN:  llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgcn -mcpu=gfx1210 -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1210 %s
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_mul_v2i32:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    s_mov_b32 s6, -1
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s10, s6
; GFX1210-NEXT:    s_mov_b32 s11, s7
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s8, s2
; GFX1210-NEXT:    s_mov_b32 s9, s3
; GFX1210-NEXT:    s_mov_b32 s4, s0
; GFX1210-NEXT:    buffer_load_b128 v[0:3], off, s[8:11], null
; GFX1210-NEXT:    s_mov_b32 s5, s1
...
;
; GFX1300-LABEL: test_mul_v2i32:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1300-NEXT:    s_mov_b32 s6, -1
; GFX1300-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s10, s6
; GFX1300-NEXT:    s_mov_b32 s11, s7
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s8, s2
; GFX1300-NEXT:    s_mov_b32 s9, s3
; GFX1300-NEXT:    s_mov_b32 s4, s0
; GFX1300-NEXT:    buffer_load_b128 v[0:3], off, s[8:11], null
; GFX1300-NEXT:    s_mov_b32 s5, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mul_lo_u32 v1, v1, v3
; GFX1300-NEXT:    v_mul_lo_u32 v0, v0, v2
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
...
; GFX1210-NEXT:    buffer_load_b128 v[0:3], off, s[8:11], null
; GFX1210-NEXT:    buffer_load_b128 v[4:7], off, s[8:11], null offset:16
; GFX1210-NEXT:    s_mov_b32 s4, s0
; GFX1210-NEXT:    s_mov_b32 s5, s1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_mul_lo_u32 v3, v3, v7
; GFX1210-NEXT:    v_mul_lo_u32 v2, v2, v6
...
; GFX1300-NEXT:    buffer_load_b128 v[0:3], off, s[8:11], null
; GFX1300-NEXT:    buffer_load_b128 v[4:7], off, s[8:11], null offset:16
; GFX1300-NEXT:    s_mov_b32 s4, s0
; GFX1300-NEXT:    s_mov_b32 s5, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mul_lo_u32 v3, v3, v7
; GFX1300-NEXT:    v_mul_lo_u32 v2, v2, v6
; GFX1300-NEXT:    v_mul_lo_u32 v1, v1, v5
; GFX1300-NEXT:    v_mul_lo_u32 v0, v0, v4
; GFX1300-NEXT:    buffer_store_b128 v[0:3], off, s[4:7], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_trunc_i64_mul_to_i32:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_clause 0x1
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1210-NEXT:    s_mul_i32 s0, s0, s6
; GFX1210-NEXT:    s_mov_b32 s6, -1
...
; GFX1300-NEXT:    s_load_b32 s0, s[2:3], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1300-NEXT:    s_mul_i32 s0, s0, s6
; GFX1300-NEXT:    s_mov_b32 s6, -1
; GFX1300-NEXT:    v_mov_b32_e32 v0, s0
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[4:7], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_trunc_i64_mul_to_i32:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
...
; GFX1210-NEXT:    s_mov_b32 s2, s10
; GFX1210-NEXT:    s_mov_b32 s3, s11
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s12, s6
; GFX1210-NEXT:    s_mov_b32 s13, s7
; GFX1210-NEXT:    buffer_load_b32 v0, off, s[12:15], null
; GFX1210-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX1210-NEXT:    s_mov_b32 s8, s4
; GFX1210-NEXT:    s_mov_b32 s9, s5
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    s_mov_b32 s14, s10
; GFX1300-NEXT:    s_mov_b32 s15, s11
; GFX1300-NEXT:    s_mov_b32 s2, s10
; GFX1300-NEXT:    s_mov_b32 s3, s11
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s12, s6
; GFX1300-NEXT:    s_mov_b32 s13, s7
; GFX1300-NEXT:    buffer_load_b32 v0, off, s[12:15], null
; GFX1300-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX1300-NEXT:    s_mov_b32 s8, s4
; GFX1300-NEXT:    s_mov_b32 s9, s5
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mul_lo_u32 v0, v1, v0
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[8:11], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: mul64_sext_c:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_mov_b32 s9, s3
; GFX1210-NEXT:    s_mov_b32 s4, s0
; GFX1210-NEXT:    buffer_load_b32 v0, off, s[8:11], null
; GFX1210-NEXT:    s_mov_b32 s5, s1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    s_mov_b32 s9, s3
; GFX1300-NEXT:    s_mov_b32 s4, s0
; GFX1300-NEXT:    buffer_load_b32 v0, off, s[8:11], null
; GFX1300-NEXT:    s_mov_b32 s5, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_mul_u64_e32 v[0:1], 0x50, v[0:1]
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_mul64_sext_inline_imm:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    s_mov_b32 s6, -1
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: v_mul64_sext_inline_imm:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1300-NEXT:    s_mov_b32 s6, -1
; GFX1300-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX1300-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_mul_u64_e32 v[0:1], 9, v[0:1]
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mul_i32 s2, s4, s5
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_clause 0x2
; GFX1300-NEXT:    s_load_b32 s4, s[2:3], 0x4c
; GFX1300-NEXT:    s_load_b32 s5, s[2:3], 0x70
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mul_i32 s2, s4, s5
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[0:3], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i32:
...
; GFX1210-NEXT:    s_mov_b32 s9, s3
; GFX1210-NEXT:    s_mov_b32 s4, s0
; GFX1210-NEXT:    buffer_load_b64 v[0:1], off, s[8:11], null
; GFX1210-NEXT:    s_mov_b32 s5, s1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    s_mov_b32 s9, s3
; GFX1300-NEXT:    s_mov_b32 s4, s0
; GFX1300-NEXT:    buffer_load_b64 v[0:1], off, s[8:11], null
; GFX1300-NEXT:    s_mov_b32 s5, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mul_i32 s4, s4, s5
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_and_b32 s2, s4, 1
; GFX1300-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b8 v0, off, s[0:3], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i1:
...
; GFX1210-NEXT:    s_mov_b32 s9, s3
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    buffer_load_u8 v0, off, s[8:11], null
; GFX1210-NEXT:    buffer_load_u8 v1, off, s[8:11], null offset:4
; GFX1210-NEXT:    s_mov_b32 s4, s0
; GFX1210-NEXT:    s_mov_b32 s5, s1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_mul_lo_u32 v0, v0, v1
...
; GFX1300-NEXT:    s_mov_b32 s9, s3
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    buffer_load_u8 v0, off, s[8:11], null
; GFX1300-NEXT:    buffer_load_u8 v1, off, s[8:11], null offset:4
; GFX1300-NEXT:    s_mov_b32 s4, s0
; GFX1300-NEXT:    s_mov_b32 s5, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mul_lo_u32 v0, v0, v1
...
; GFX1300-NEXT:    buffer_store_b8 v0, off, s[4:7], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i1:
...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mul_u64 s[0:1], s[6:7], s[0:1]
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX1210-NEXT:    s_mov_b32 s12, s6
; GFX1210-NEXT:    s_mov_b32 s13, s7
; GFX1210-NEXT:    buffer_load_b64 v[0:1], off, s[12:15], null
; GFX1210-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null
; GFX1210-NEXT:    s_mov_b32 s8, s4
; GFX1210-NEXT:    s_mov_b32 s9, s5
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    s_mov_b32 s12, s6
; GFX1300-NEXT:    s_mov_b32 s13, s7
; GFX1300-NEXT:    buffer_load_b64 v[0:1], off, s[12:15], null
; GFX1300-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null
; GFX1300-NEXT:    s_mov_b32 s8, s4
; GFX1300-NEXT:    s_mov_b32 s9, s5
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    v_mul_u64_e32 v[0:1], v[0:1], v[2:3]
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[8:11], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i64:
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: mul32_in_branch:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1210-NEXT:    s_mov_b32 s4, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_cbranch_scc0 .LBB15_2
; GFX1210-NEXT:  ; %bb.1: ; %else
; GFX1210-NEXT:    s_mul_i32 s5, s0, s1
; GFX1210-NEXT:    s_branch .LBB15_3
; GFX1210-NEXT:  .LBB15_2:
; GFX1210-NEXT:    s_mov_b32 s4, -1
; GFX1210-NEXT:    ; implicit-def: $sgpr5
; GFX1210-NEXT:  .LBB15_3: ; %Flow
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s4
; GFX1210-NEXT:    s_cbranch_vccnz .LBB15_5
; GFX1210-NEXT:  ; %bb.4: ; %if
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s6, -1
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s4, s2
; GFX1210-NEXT:    s_mov_b32 s5, s3
; GFX1210-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX1210-NEXT:    s_branch .LBB15_6
; GFX1210-NEXT:  .LBB15_5:
; GFX1210-NEXT:    v_mov_b32_e32 v0, s5
; GFX1210-NEXT:  .LBB15_6: ; %endif
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s2, -1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: mul32_in_branch:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1300-NEXT:    s_mov_b32 s4, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_cbranch_scc0 .LBB15_2
; GFX1300-NEXT:  ; %bb.1: ; %else
; GFX1300-NEXT:    s_mul_i32 s5, s0, s1
; GFX1300-NEXT:    s_branch .LBB15_3
; GFX1300-NEXT:  .LBB15_2:
...
; GFX1300-NEXT:  ; %bb.4: ; %if
; GFX1300-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s6, -1
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s4, s2
; GFX1300-NEXT:    s_mov_b32 s5, s3
; GFX1300-NEXT:    buffer_load_b32 v0, off, s[4:7], null
; GFX1300-NEXT:    s_branch .LBB15_6
; GFX1300-NEXT:  .LBB15_5:
; GFX1300-NEXT:    v_mov_b32_e32 v0, s5
; GFX1300-NEXT:  .LBB15_6: ; %endif
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: mul64_in_branch:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX1210-NEXT:    s_cbranch_scc0 .LBB16_3
; GFX1210-NEXT:  ; %bb.1: ; %else
; GFX1210-NEXT:    s_mul_u64 s[4:5], s[4:5], s[6:7]
; GFX1210-NEXT:    s_cbranch_execnz .LBB16_4
; GFX1210-NEXT:  .LBB16_2: ; %if
; GFX1210-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s6, -1
; GFX1210-NEXT:    s_mov_b32 s4, s2
; GFX1210-NEXT:    s_mov_b32 s5, s3
; GFX1210-NEXT:    buffer_load_b64 v[0:1], off, s[4:7], null
; GFX1210-NEXT:    s_branch .LBB16_5
; GFX1210-NEXT:  .LBB16_3:
; GFX1210-NEXT:    ; implicit-def: $sgpr4_sgpr5
; GFX1210-NEXT:    s_branch .LBB16_2
; GFX1210-NEXT:  .LBB16_4:
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GFX1210-NEXT:  .LBB16_5: ; %endif
; GFX1210-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s2, -1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: mul64_in_branch:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_cmp_lg_u64 s[4:5], 0
; GFX1300-NEXT:    s_cbranch_scc0 .LBB16_3
; GFX1300-NEXT:  ; %bb.1: ; %else
; GFX1300-NEXT:    s_mul_u64 s[4:5], s[4:5], s[6:7]
; GFX1300-NEXT:    s_cbranch_execnz .LBB16_4
; GFX1300-NEXT:  .LBB16_2: ; %if
; GFX1300-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s6, -1
; GFX1300-NEXT:    s_mov_b32 s4, s2
; GFX1300-NEXT:    s_mov_b32 s5, s3
; GFX1300-NEXT:    buffer_load_b64 v[0:1], off, s[4:7], null
; GFX1300-NEXT:    s_branch .LBB16_5
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_clause 0x2
; GFX1210-NEXT:    s_load_b128 s[4:7], s[2:3], 0x7c
; GFX1210-NEXT:    s_load_b128 s[8:11], s[2:3], 0x4c
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1210-NEXT:    s_mov_b64 s[12:13], 0xffffffff
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s3, 0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mov_b32 s15, s3
; GFX1210-NEXT:    s_mov_b32 s17, s3
; GFX1210-NEXT:    s_mov_b32 s19, s3
; GFX1210-NEXT:    s_mov_b32 s20, s3
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s2, s4
; GFX1210-NEXT:    s_and_b64 s[12:13], s[8:9], s[12:13]
; GFX1210-NEXT:    s_mov_b32 s14, s9
; GFX1210-NEXT:    s_mul_u64 s[6:7], s[6:7], s[8:9]
; GFX1210-NEXT:    s_mul_u64 s[8:9], s[12:13], s[2:3]
; GFX1210-NEXT:    s_mov_b32 s16, s5
; GFX1210-NEXT:    s_mul_u64 s[4:5], s[4:5], s[10:11]
; GFX1210-NEXT:    s_mul_u64 s[10:11], s[14:15], s[2:3]
; GFX1210-NEXT:    s_mov_b32 s2, s9
; GFX1210-NEXT:    s_mul_u64 s[12:13], s[12:13], s[16:17]
; GFX1210-NEXT:    s_add_nc_u64 s[10:11], s[10:11], s[2:3]
; GFX1210-NEXT:    s_add_nc_u64 s[4:5], s[6:7], s[4:5]
; GFX1210-NEXT:    s_mov_b32 s2, s11
; GFX1210-NEXT:    s_mov_b32 s11, s3
; GFX1210-NEXT:    s_mul_u64 s[14:15], s[14:15], s[16:17]
; GFX1210-NEXT:    s_add_nc_u64 s[6:7], s[12:13], s[10:11]
; GFX1210-NEXT:    s_mov_b32 s9, s3
; GFX1210-NEXT:    s_mov_b32 s18, s7
; GFX1210-NEXT:    s_mov_b32 s21, s6
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[18:19]
; GFX1210-NEXT:    s_or_b64 s[6:7], s[8:9], s[20:21]
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[14:15], s[2:3]
; GFX1210-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v1, s7
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_clause 0x2
; GFX1300-NEXT:    s_load_b128 s[4:7], s[2:3], 0x7c
; GFX1300-NEXT:    s_load_b128 s[8:11], s[2:3], 0x4c
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1300-NEXT:    s_mov_b64 s[12:13], 0xffffffff
; GFX1300-NEXT:    s_mov_b32 s3, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mov_b32 s15, s3
; GFX1300-NEXT:    s_mov_b32 s17, s3
; GFX1300-NEXT:    s_mov_b32 s19, s3
; GFX1300-NEXT:    s_mov_b32 s20, s3
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s2, s4
; GFX1300-NEXT:    s_and_b64 s[12:13], s[8:9], s[12:13]
; GFX1300-NEXT:    s_mov_b32 s14, s9
; GFX1300-NEXT:    s_mul_u64 s[6:7], s[6:7], s[8:9]
; GFX1300-NEXT:    s_mul_u64 s[8:9], s[12:13], s[2:3]
; GFX1300-NEXT:    s_mov_b32 s16, s5
; GFX1300-NEXT:    s_mul_u64 s[4:5], s[4:5], s[10:11]
; GFX1300-NEXT:    s_mul_u64 s[10:11], s[14:15], s[2:3]
; GFX1300-NEXT:    s_mov_b32 s2, s9
; GFX1300-NEXT:    s_mul_u64 s[12:13], s[12:13], s[16:17]
; GFX1300-NEXT:    s_add_nc_u64 s[10:11], s[10:11], s[2:3]
; GFX1300-NEXT:    s_add_nc_u64 s[4:5], s[6:7], s[4:5]
; GFX1300-NEXT:    s_mov_b32 s2, s11
; GFX1300-NEXT:    s_mov_b32 s11, s3
; GFX1300-NEXT:    s_mul_u64 s[14:15], s[14:15], s[16:17]
; GFX1300-NEXT:    s_add_nc_u64 s[6:7], s[12:13], s[10:11]
; GFX1300-NEXT:    s_mov_b32 s9, s3
; GFX1300-NEXT:    s_mov_b32 s18, s7
; GFX1300-NEXT:    s_mov_b32 s21, s6
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[18:19]
; GFX1300-NEXT:    s_or_b64 s[6:7], s[8:9], s[20:21]
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[14:15], s[2:3]
...
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i128:
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x2c
; GFX1210-NEXT:    v_and_b32_e32 v16, 0x3ff, v0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_b128 v[0:3], v16, s[2:3] scale_offset
; GFX1210-NEXT:    global_load_b128 v[4:7], v16, s[0:1] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v10, v0
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_dual_mov_b32 v9, v11 :: v_dual_mov_b32 v8, v4
; GFX1210-NEXT:    v_mul_u64_e32 v[6:7], v[0:1], v[6:7]
; GFX1210-NEXT:    v_mul_u64_e32 v[8:9], v[8:9], v[10:11]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[6:7], v2, v4, v[6:7]
; GFX1210-NEXT:    v_mov_b32_e32 v10, v9
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[12:13], v5, v0, v[10:11]
; GFX1210-NEXT:    v_mad_u32 v0, v3, v4, v7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_dual_mov_b32 v10, v13 :: v_dual_mov_b32 v13, v11
; GFX1210-NEXT:    v_mad_u32 v7, v2, v5, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[12:13], v4, v1, v[12:13]
; GFX1210-NEXT:    v_dual_mov_b32 v15, v11 :: v_dual_mov_b32 v9, v12
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v14, v13
; GFX1210-NEXT:    v_add_nc_u64_e32 v[10:11], v[10:11], v[14:15]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v5, v1, v[10:11]
; GFX1210-NEXT:    v_add_nc_u64_e32 v[10:11], v[0:1], v[6:7]
; GFX1210-NEXT:    global_store_b128 v16, v[8:11], s[2:3] scale_offset
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: v_mul_i128:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x2c
; GFX1300-NEXT:    v_and_b32_e32 v16, 0x3ff, v0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    global_load_b128 v[0:3], v16, s[2:3] scale_offset
; GFX1300-NEXT:    global_load_b128 v[4:7], v16, s[0:1] scale_offset
; GFX1300-NEXT:    s_wait_loadcnt 0x1
; GFX1300-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v10, v0
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v9, v11 :: v_dual_mov_b32 v8, v4
; GFX1300-NEXT:    v_mul_u64_e32 v[6:7], v[0:1], v[6:7]
; GFX1300-NEXT:    v_mul_u64_e32 v[8:9], v[8:9], v[10:11]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[6:7], v2, v4, v[6:7]
; GFX1300-NEXT:    v_mov_b32_e32 v10, v9
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[12:13], v5, v0, v[10:11]
; GFX1300-NEXT:    v_mad_u32 v0, v3, v4, v7
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v10, v13 :: v_dual_mov_b32 v13, v11
; GFX1300-NEXT:    v_mad_u32 v7, v2, v5, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[12:13], v4, v1, v[12:13]
; GFX1300-NEXT:    v_dual_mov_b32 v15, v11 :: v_dual_mov_b32 v9, v12
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mov_b32_e32 v14, v13
; GFX1300-NEXT:    v_add_nc_u64_e32 v[10:11], v[10:11], v[14:15]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v5, v1, v[10:11]
; GFX1300-NEXT:    v_add_nc_u64_e32 v[10:11], v[0:1], v[6:7]
; GFX1300-NEXT:    global_store_b128 v16, v[8:11], s[2:3] scale_offset
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i128:
