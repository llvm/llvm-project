...
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_b32 s3, s[4:5], 0x34
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mul_i32 s2, s3, s2
...
; GFX1300-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_load_b32 s3, s[4:5], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mul_i32 s2, s3, s2
...
; GFX1300-NEXT:    s_mov_b32 s6, s10
; GFX1300-NEXT:    s_mov_b32 s7, s11
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_mov_b32 s12, s2
; GFX1300-NEXT:    s_mov_b32 s13, s3
; GFX1300-NEXT:    buffer_load_b32 v0, off, s[12:15], null
; GFX1300-NEXT:    buffer_load_b32 v1, off, s[4:7], null
; GFX1300-NEXT:    s_mov_b32 s8, s0
; GFX1300-NEXT:    s_mov_b32 s9, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b96 s[0:2], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1300-NEXT:    s_load_b32 s2, s[4:5], 0x4c
; GFX1300-NEXT:    s_load_b32 s3, s[4:5], 0x70
...
; GFX1300-NEXT:    s_mul_i32 s2, s2, s3
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_and_b32 s2, s2, 1
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-NEXT:    s_mov_b32 s2, -1
...
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mul_u64 s[4:5], s[2:3], s[4:5]
; GFX1210-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GFX1210-NEXT:    s_mov_b32 s2, -1
; GFX1210-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null
...
; GFX1210-NEXT:    buffer_load_b64 v[2:3], off, s[4:7], null
; GFX1210-NEXT:    s_mov_b32 s8, s0
; GFX1210-NEXT:    s_mov_b32 s9, s1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1300-NEXT:    buffer_load_b64 v[2:3], off, s[4:7], null
; GFX1300-NEXT:    s_mov_b32 s8, s0
; GFX1300-NEXT:    s_mov_b32 s9, s1
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX1300-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_clause 0x2
; GFX1210-NEXT:    s_load_b128 s[8:11], s[4:5], 0x7c
; GFX1210-NEXT:    s_load_b128 s[12:15], s[4:5], 0x4c
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_mov_b64 s[4:5], 0xffffffff
; GFX1210-NEXT:    s_mov_b32 s3, 0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mov_b32 s7, s3
; GFX1210-NEXT:    s_mov_b32 s17, s3
; GFX1210-NEXT:    s_mov_b32 s19, s3
; GFX1210-NEXT:    s_mov_b32 s20, s3
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s2, s8
; GFX1210-NEXT:    s_and_b64 s[4:5], s[12:13], s[4:5]
; GFX1210-NEXT:    s_mov_b32 s6, s13
; GFX1210-NEXT:    s_mul_u64 s[10:11], s[10:11], s[12:13]
; GFX1210-NEXT:    s_mul_u64 s[12:13], s[4:5], s[2:3]
; GFX1210-NEXT:    s_mov_b32 s16, s9
; GFX1210-NEXT:    s_mul_u64 s[8:9], s[8:9], s[14:15]
; GFX1210-NEXT:    s_mul_u64 s[14:15], s[6:7], s[2:3]
; GFX1210-NEXT:    s_mov_b32 s2, s13
; GFX1210-NEXT:    s_mul_u64 s[4:5], s[4:5], s[16:17]
; GFX1210-NEXT:    s_add_nc_u64 s[14:15], s[14:15], s[2:3]
; GFX1210-NEXT:    s_mul_u64 s[6:7], s[6:7], s[16:17]
; GFX1210-NEXT:    s_mov_b32 s2, s15
; GFX1210-NEXT:    s_mov_b32 s15, s3
; GFX1210-NEXT:    s_mov_b32 s13, s3
; GFX1210-NEXT:    s_add_nc_u64 s[4:5], s[4:5], s[14:15]
; GFX1210-NEXT:    s_add_nc_u64 s[8:9], s[10:11], s[8:9]
; GFX1210-NEXT:    s_mov_b32 s18, s5
; GFX1210-NEXT:    s_mov_b32 s21, s4
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[18:19]
; GFX1210-NEXT:    s_or_b64 s[4:5], s[12:13], s[20:21]
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[6:7], s[2:3]
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[8:9]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_clause 0x2
; GFX1300-NEXT:    s_load_b128 s[8:11], s[4:5], 0x7c
; GFX1300-NEXT:    s_load_b128 s[12:15], s[4:5], 0x4c
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1300-NEXT:    s_mov_b64 s[4:5], 0xffffffff
; GFX1300-NEXT:    s_mov_b32 s3, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300-NEXT:    s_mul_u64 s[12:13], s[4:5], s[2:3]
; GFX1300-NEXT:    s_mov_b32 s16, s9
; GFX1300-NEXT:    s_mul_u64 s[8:9], s[8:9], s[14:15]
; GFX1300-NEXT:    s_mul_u64 s[14:15], s[6:7], s[2:3]
; GFX1300-NEXT:    s_mov_b32 s2, s13
; GFX1300-NEXT:    s_mul_u64 s[4:5], s[4:5], s[16:17]
; GFX1300-NEXT:    s_add_nc_u64 s[14:15], s[14:15], s[2:3]
; GFX1300-NEXT:    s_mul_u64 s[6:7], s[6:7], s[16:17]
; GFX1300-NEXT:    s_mov_b32 s2, s15
; GFX1300-NEXT:    s_mov_b32 s15, s3
; GFX1300-NEXT:    s_mov_b32 s13, s3
; GFX1300-NEXT:    s_add_nc_u64 s[4:5], s[4:5], s[14:15]
; GFX1300-NEXT:    s_add_nc_u64 s[8:9], s[10:11], s[8:9]
; GFX1300-NEXT:    s_mov_b32 s18, s5
; GFX1300-NEXT:    s_mov_b32 s21, s4
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[18:19]
; GFX1300-NEXT:    s_or_b64 s[4:5], s[12:13], s[20:21]
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x2c
