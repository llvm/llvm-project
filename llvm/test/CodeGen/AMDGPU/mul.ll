...
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[4:7], null scope:SCOPE_SE
...
; GFX1300-NEXT:    buffer_store_b128 v[0:3], off, s[4:7], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[0:3], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[8:11], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
...
; GFX1300-NEXT:    buffer_store_b32 v0, off, s[4:7], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i32:
; EG:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    v_mov_b32_e32 v0, s2
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b8 v0, off, s[0:3], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i1:
; EG:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    buffer_store_b8 v0, off, s[4:7], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i1:
; EG:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    buffer_store_b64 v[0:1], off, s[8:11], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i64:
; EG:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1300-NEXT:    s_mov_b32 s2, -1
; GFX1300-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null scope:SCOPE_SE
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: s_mul_i128:
; EG:       ; %bb.0: ; %entry
...
; GFX1300-NEXT:    v_mad_co_u64_u32 v[11:12], null, v4, v2, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v14, 0 :: v_dual_mov_b32 v13, v9
; GFX1300-NEXT:    v_mad_u32 v9, v4, v3, v12
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[3:4], null, v1, v4, v[13:14]
; GFX1300-NEXT:    v_mad_u32 v12, v5, v2, v9
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_dual_mov_b32 v13, v4 :: v_dual_mov_b32 v4, v14
; GFX1300-NEXT:    v_mad_co_u64_u32 v[9:10], null, v0, v5, v[3:4]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[2:3], null, v6, v0, v[11:12]
; GFX1300-NEXT:    v_mov_b32_e32 v11, v14
; GFX1300-NEXT:    v_add_nc_u64_e32 v[10:11], v[13:14], v[10:11]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_u32 v0, v7, v0, v3
; GFX1300-NEXT:    v_mad_u32 v3, v6, v1, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
