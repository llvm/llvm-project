...
; GFX12-DEFSCHED-NEXT:    v_mul_lo_u32 v14, v5, v2
...
; GFX12-DEFSCHED-NEXT:    v_mul_lo_u32 v11, v4, v3
...
; GFX12-DEFSCHED-NEXT:    v_add3_u32 v3, v3, v11, v14
...
; GFX12-SSASCHED-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX12-SSASCHED-NEXT:    v_add3_u32 v3, v3, v15, v14
; GFX12-SSASCHED-NEXT:    v_mov_b32_e32 v9, v11
; GFX12-SSASCHED-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
