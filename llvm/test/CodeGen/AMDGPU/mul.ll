...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b96 s[0:2], s[0:1], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mul_lo_u16 v0, s2, s3
; GFX1210-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1210-NEXT:    s_mov_b32 s2, -1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    s_mul_i32 s5, s2, s3
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_cmp_lg_u32 s2, 0
; GFX1300-NEXT:    s_cbranch_scc0 .LBB15_2
; GFX1300-NEXT:  ; %bb.1: ; %else
; GFX1300-NEXT:    s_mul_i32 s5, s2, s3
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b128 s[4:7], s[0:1], 0x7c
; GFX1210-NEXT:    s_load_b128 s[8:11], s[0:1], 0x4c
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x2c
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_b128 v[2:5], v0, s[2:3] scale_offset
; GFX1210-NEXT:    global_load_b128 v[6:9], v0, s[0:1] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v12, v2
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_dual_mov_b32 v11, v13 :: v_dual_mov_b32 v10, v6
; GFX1210-NEXT:    v_mul_u64_e32 v[8:9], v[2:3], v[8:9]
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[0:1], 0x2c
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    global_load_b128 v[2:5], v0, s[2:3] scale_offset
; GFX1300-NEXT:    global_load_b128 v[6:9], v0, s[0:1] scale_offset
; GFX1300-NEXT:    s_wait_loadcnt 0x1
; GFX1300-NEXT:    v_dual_mov_b32 v13, 0 :: v_dual_mov_b32 v12, v2
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_dual_mov_b32 v11, v13 :: v_dual_mov_b32 v10, v6
; GFX1300-NEXT:    v_mul_u64_e32 v[8:9], v[2:3], v[8:9]
; GFX1300-NEXT:    v_mov_b32_e32 v17, v13
; GFX1300-NEXT:    v_mul_u64_e32 v[10:11], v[10:11], v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[8:9], v4, v6, v[8:9]
; GFX1300-NEXT:    v_mov_b32_e32 v12, v11
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[14:15], v7, v2, v[12:13]
; GFX1300-NEXT:    v_mad_u32 v1, v5, v6, v9
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_u32 v9, v4, v7, v1
; GFX1300-NEXT:    v_dual_mov_b32 v12, v15 :: v_dual_mov_b32 v15, v13
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[14:15], v6, v3, v[14:15]
; GFX1300-NEXT:    v_dual_mov_b32 v16, v15 :: v_dual_mov_b32 v11, v14
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[12:13], v[12:13], v[16:17]
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[2:3], v7, v3, v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[12:13], v[2:3], v[8:9]
; GFX1300-NEXT:    global_store_b128 v0, v[10:13], s[2:3] scale_offset
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1300-NEXT:    s_endpgm
;
; EG-LABEL: v_mul_i128:
