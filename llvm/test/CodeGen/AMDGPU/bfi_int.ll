...
; GFX7-NEXT:    s_load_dword s1, s[4:5], 0xd
; GFX7-NEXT:    s_mov_b32 s5, 0
; GFX7-NEXT:    s_mov_b32 s7, 0xf000
; GFX7-NEXT:    s_mov_b32 s6, -1
; GFX7-NEXT:    s_mov_b32 s4, s0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_xor_b32 s0, s3, s1
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_xor_b32 s3, s3, s1
; GFX10-NEXT:    s_and_b32 s2, s3, s2
; GFX10-NEXT:    s_xor_b32 s1, s2, s1
...
; GFX8-GISEL-NEXT:    s_mov_b32 s1, 0
...
; GFX10-GISEL-NEXT:    s_load_dword s1, s[4:5], 0x34
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_andn2_b32 s1, s1, s2
; GFX10-GISEL-NEXT:    s_and_b32 s2, s3, s2
; GFX10-GISEL-NEXT:    s_or_b32 s1, s1, s2
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_xor_b32 s3, s3, s1
; GFX10-GISEL-NEXT:    s_and_b32 s2, s2, s3
; GFX10-GISEL-NEXT:    s_xor_b32 s1, s1, s2
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX10-GISEL-NEXT:    s_mov_b32 s1, 0
; GFX10-GISEL-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX10-GISEL-NEXT:    s_endpgm
...
; GFX7-NEXT:    s_mov_b32 s4, s0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_and_b32 s0, s2, s1
; GFX7-NEXT:    s_or_b32 s1, s2, s1
; GFX7-NEXT:    s_and_b32 s1, s3, s1
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_or_b32 s4, s2, s1
; GFX10-NEXT:    s_and_b32 s1, s2, s1
; GFX10-NEXT:    s_and_b32 s2, s3, s4
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_or_b32 s4, s2, s1
; GFX10-GISEL-NEXT:    s_and_b32 s1, s2, s1
; GFX10-GISEL-NEXT:    s_and_b32 s2, s3, s4
; GFX10-GISEL-NEXT:    s_or_b32 s1, s1, s2
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX10-GISEL-NEXT:    s_mov_b32 s1, 0
; GFX10-GISEL-NEXT:    global_store_dword v1, v0, s[0:1]
