...
; RUN: llc -march=amdgcn -mcpu=gfx1200 -mattr=-wavefrontsize32,+wavefrontsize64 -amdgpu-atomic-optimizations=true -amdgpu-atomic-optimizer-strategy=Iterative -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12W64 %s
; RUN: llc -march=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize32,-wavefrontsize64 -amdgpu-atomic-optimizations=true -amdgpu-atomic-optimizer-strategy=Iterative -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12W32 %s
...
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W64-NEXT:    v_mbcnt_hi_u32_b32 v2, exec_hi, v1
; GFX12W64-NEXT:    ; implicit-def: $vgpr1
...
; GFX12W64-NEXT:    v_cmpx_eq_u32_e32 0, v2
...
; GFX12W32:       ; %bb.0: ; %entry
; GFX12W32-NEXT:    v_mbcnt_lo_u32_b32 v2, exec_lo, 0
; GFX12W32-NEXT:    s_mov_b32 s3, exec_lo
...
; GFX12W32-NEXT:    v_cmpx_eq_u32_e32 0, v2
