...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_mul_i32 s0, s6, s0
; GFX8-NEXT:    s_mov_b32 s9, s7
; GFX8-NEXT:    s_mov_b32 s10, s7
...
; GFX10W64-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    s_mov_b32 s9, s7
; GFX10W64-NEXT:    s_mul_i32 s2, s6, s2
; GFX10W64-NEXT:    s_mov_b32 s10, s7
; GFX10W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX10W64-NEXT:    s_mov_b32 s11, s7
; GFX10W64-NEXT:    buffer_atomic_add v1, off, s[8:11], 0 glc
...
; GFX10W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W32-NEXT:    s_mov_b32 s9, s3
; GFX10W32-NEXT:    s_mul_i32 s2, s0, s2
; GFX10W32-NEXT:    s_mov_b32 s10, s3
; GFX10W32-NEXT:    v_mov_b32_e32 v1, s2
; GFX10W32-NEXT:    s_mov_b32 s11, s3
; GFX10W32-NEXT:    buffer_atomic_add v1, off, s[8:11], 0 glc
...
; GFX11W64-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX11W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W64-NEXT:    s_mov_b32 s9, s7
; GFX11W64-NEXT:    s_mul_i32 s2, s6, s2
; GFX11W64-NEXT:    s_mov_b32 s10, s7
; GFX11W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX11W64-NEXT:    s_mov_b32 s11, s7
; GFX11W64-NEXT:    buffer_atomic_add_u32 v1, off, s[8:11], 0 glc
...
; GFX11W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W32-NEXT:    s_mov_b32 s9, s3
; GFX11W32-NEXT:    s_mul_i32 s2, s0, s2
; GFX11W32-NEXT:    s_mov_b32 s10, s3
; GFX11W32-NEXT:    v_mov_b32_e32 v1, s2
; GFX11W32-NEXT:    s_mov_b32 s11, s3
; GFX11W32-NEXT:    buffer_atomic_add_u32 v1, off, s[8:11], 0 glc
...
; GFX12W64-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    s_mov_b32 s9, s7
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    s_mul_i32 s2, s6, s2
; GFX12W64-NEXT:    s_mov_b32 s10, s7
; GFX12W64-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX12W64-NEXT:    s_mov_b32 s11, s7
; GFX12W64-NEXT:    buffer_atomic_add_u32 v1, off, s[8:11], null th:TH_ATOMIC_RETURN
...
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    s_mov_b32 s9, s3
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_mul_i32 s2, s0, s2
; GFX12W32-NEXT:    s_mov_b32 s10, s3
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    v_mov_b32_e32 v1, s2
; GFX12W32-NEXT:    s_mov_b32 s11, s3
; GFX12W32-NEXT:    buffer_atomic_add_u32 v1, off, s[8:11], null th:TH_ATOMIC_RETURN
...
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_ff1_i32_b64 s2, s[0:1]
; GFX6-NEXT:    s_mov_b32 m0, s2
; GFX6-NEXT:    v_readlane_b32 s6, v0, s2
; GFX6-NEXT:    v_writelane_b32 v1, s8, m0
; GFX6-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX6-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX6-NEXT:    v_cmp_ne_u64_e64 s[2:3], s[0:1], 0
; GFX6-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GFX6-NEXT:    s_add_i32 s8, s8, s6
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_ff1_i32_b64 s2, s[0:1]
; GFX8-NEXT:    s_mov_b32 m0, s2
; GFX8-NEXT:    v_readlane_b32 s3, v0, s2
; GFX8-NEXT:    v_writelane_b32 v1, s8, m0
; GFX8-NEXT:    s_add_i32 s8, s8, s3
; GFX8-NEXT:    s_lshl_b64 s[2:3], 1, s2
...
; GFX8-NEXT:    ; implicit-def: $vgpr0
; GFX8-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX8-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
; GFX8-NEXT:    s_cbranch_execz .LBB3_4
; GFX8-NEXT:  ; %bb.3:
; GFX8-NEXT:    s_load_dword s9, s[4:5], 0x44
...
; GFX8-NEXT:    buffer_atomic_add v0, v2, s[0:3], 0 idxen glc
; GFX8-NEXT:  .LBB3_4:
...
; GFX9-NEXT:    ; implicit-def: $vgpr0
; GFX9-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX9-NEXT:    s_xor_b64 s[6:7], exec, s[2:3]
...
; GFX9-NEXT:    buffer_atomic_add v0, v2, s[0:3], 0 idxen glc
; GFX9-NEXT:  .LBB3_4:
...
; GFX10W64-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX10W64-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX10W64-NEXT:    s_mov_b32 s1, 0
; GFX10W64-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX10W64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX10W64-NEXT:    ; implicit-def: $vgpr0
; GFX10W64-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX10W64-NEXT:    s_xor_b64 s[6:7], exec, s[6:7]
; GFX10W64-NEXT:    s_cbranch_execz .LBB3_4
; GFX10W64-NEXT:  ; %bb.3:
; GFX10W64-NEXT:    s_clause 0x1
; GFX10W64-NEXT:    s_load_dword s3, s[4:5], 0x44
; GFX10W64-NEXT:    s_load_dword s0, s[4:5], 0x34
; GFX10W64-NEXT:    v_mov_b32_e32 v0, s2
; GFX10W64-NEXT:    s_mov_b32 s2, s1
; GFX10W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W64-NEXT:    v_mov_b32_e32 v2, s3
; GFX10W64-NEXT:    s_mov_b32 s3, s1
; GFX10W64-NEXT:    buffer_atomic_add v0, v2, s[0:3], 0 idxen glc
...
; GFX10W32-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10W32-NEXT:    s_ff1_i32_b32 s1, s0
; GFX10W32-NEXT:    v_readlane_b32 s3, v0, s1
; GFX10W32-NEXT:    v_writelane_b32 v1, s2, s1
; GFX10W32-NEXT:    s_lshl_b32 s1, 1, s1
; GFX10W32-NEXT:    s_add_i32 s2, s2, s3
; GFX10W32-NEXT:    s_andn2_b32 s0, s0, s1
; GFX10W32-NEXT:    s_cbranch_scc1 .LBB3_1
; GFX10W32-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX10W32-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX10W32-NEXT:    s_mov_b32 s1, 0
; GFX10W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX10W32-NEXT:    ; implicit-def: $vgpr0
; GFX10W32-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX10W32-NEXT:    s_xor_b32 s6, exec_lo, s0
; GFX10W32-NEXT:    s_cbranch_execz .LBB3_4
; GFX10W32-NEXT:  ; %bb.3:
; GFX10W32-NEXT:    s_clause 0x1
; GFX10W32-NEXT:    s_load_dword s3, s[4:5], 0x44
; GFX10W32-NEXT:    s_load_dword s0, s[4:5], 0x34
; GFX10W32-NEXT:    v_mov_b32_e32 v0, s2
; GFX10W32-NEXT:    s_mov_b32 s2, s1
; GFX10W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10W32-NEXT:    v_mov_b32_e32 v2, s3
; GFX10W32-NEXT:    s_mov_b32 s3, s1
; GFX10W32-NEXT:    buffer_atomic_add v0, v2, s[0:3], 0 idxen glc
; GFX10W32-NEXT:  .LBB3_4:
; GFX10W32-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10W32-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX10W32-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10W32-NEXT:    s_waitcnt vmcnt(0)
; GFX10W32-NEXT:    v_readfirstlane_b32 s2, v0
; GFX10W32-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX11W64-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX11W64-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX11W64-NEXT:    s_mov_b32 s1, 0
; GFX11W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11W64-NEXT:    v_mbcnt_hi_u32_b32 v1, exec_hi, v1
; GFX11W64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v1
; GFX11W64-NEXT:    ; implicit-def: $vgpr1
; GFX11W64-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX11W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11W64-NEXT:    s_xor_b64 s[6:7], exec, s[6:7]
; GFX11W64-NEXT:    s_cbranch_execz .LBB3_4
; GFX11W64-NEXT:  ; %bb.3:
; GFX11W64-NEXT:    s_clause 0x1
; GFX11W64-NEXT:    s_load_b32 s3, s[4:5], 0x44
; GFX11W64-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GFX11W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX11W64-NEXT:    s_mov_b32 s2, s1
; GFX11W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W64-NEXT:    v_mov_b32_e32 v2, s3
; GFX11W64-NEXT:    s_mov_b32 s3, s1
; GFX11W64-NEXT:    buffer_atomic_add_u32 v1, v2, s[0:3], 0 idxen glc
...
; GFX11W32-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11W32-NEXT:    s_ctz_i32_b32 s1, s0
; GFX11W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX11W32-NEXT:    v_readlane_b32 s3, v1, s1
; GFX11W32-NEXT:    v_writelane_b32 v0, s2, s1
; GFX11W32-NEXT:    s_lshl_b32 s1, 1, s1
; GFX11W32-NEXT:    s_add_i32 s2, s2, s3
; GFX11W32-NEXT:    s_and_not1_b32 s0, s0, s1
; GFX11W32-NEXT:    s_cbranch_scc1 .LBB3_1
; GFX11W32-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX11W32-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX11W32-NEXT:    s_mov_b32 s1, 0
; GFX11W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX11W32-NEXT:    ; implicit-def: $vgpr1
; GFX11W32-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX11W32-NEXT:    s_xor_b32 s6, exec_lo, s0
; GFX11W32-NEXT:    s_cbranch_execz .LBB3_4
; GFX11W32-NEXT:  ; %bb.3:
; GFX11W32-NEXT:    s_clause 0x1
; GFX11W32-NEXT:    s_load_b32 s3, s[4:5], 0x44
; GFX11W32-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GFX11W32-NEXT:    v_mov_b32_e32 v1, s2
; GFX11W32-NEXT:    s_mov_b32 s2, s1
; GFX11W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11W32-NEXT:    v_mov_b32_e32 v2, s3
; GFX11W32-NEXT:    s_mov_b32 s3, s1
; GFX11W32-NEXT:    buffer_atomic_add_u32 v1, v2, s[0:3], 0 idxen glc
; GFX11W32-NEXT:  .LBB3_4:
; GFX11W32-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX11W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11W32-NEXT:    s_waitcnt vmcnt(0)
; GFX11W32-NEXT:    v_readfirstlane_b32 s2, v1
; GFX11W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12W64-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX12W64-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX12W64-NEXT:    s_mov_b32 s1, 0
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W64-NEXT:    v_mbcnt_hi_u32_b32 v1, exec_hi, v1
; GFX12W64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v1
; GFX12W64-NEXT:    ; implicit-def: $vgpr1
; GFX12W64-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX12W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12W64-NEXT:    s_xor_b64 s[6:7], exec, s[6:7]
; GFX12W64-NEXT:    s_cbranch_execz .LBB3_4
; GFX12W64-NEXT:  ; %bb.3:
; GFX12W64-NEXT:    s_clause 0x1
; GFX12W64-NEXT:    s_load_b32 s3, s[4:5], 0x44
; GFX12W64-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GFX12W64-NEXT:    v_mov_b32_e32 v1, s2
; GFX12W64-NEXT:    s_mov_b32 s2, s1
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    v_mov_b32_e32 v2, s3
; GFX12W64-NEXT:    s_mov_b32 s3, s1
; GFX12W64-NEXT:    buffer_atomic_add_u32 v1, v2, s[0:3], null idxen th:TH_ATOMIC_RETURN
; GFX12W64-NEXT:  .LBB3_4:
; GFX12W64-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX12W64-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12W64-NEXT:    s_wait_loadcnt 0x0
; GFX12W64-NEXT:    v_readfirstlane_b32 s2, v1
; GFX12W64-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX12W32-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_ctz_i32_b32 s1, s0
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    v_readlane_b32 s3, v1, s1
; GFX12W32-NEXT:    v_writelane_b32 v0, s2, s1
; GFX12W32-NEXT:    s_lshl_b32 s1, 1, s1
; GFX12W32-NEXT:    s_add_co_i32 s2, s2, s3
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_and_not1_b32 s0, s0, s1
; GFX12W32-NEXT:    s_cbranch_scc1 .LBB3_1
; GFX12W32-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX12W32-NEXT:    v_mbcnt_lo_u32_b32 v1, exec_lo, 0
; GFX12W32-NEXT:    s_mov_b32 s1, 0
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX12W32-NEXT:    ; implicit-def: $vgpr1
; GFX12W32-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX12W32-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12W32-NEXT:    s_xor_b32 s6, exec_lo, s0
; GFX12W32-NEXT:    s_cbranch_execz .LBB3_4
; GFX12W32-NEXT:  ; %bb.3:
; GFX12W32-NEXT:    s_clause 0x1
; GFX12W32-NEXT:    s_load_b32 s3, s[4:5], 0x44
; GFX12W32-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GFX12W32-NEXT:    v_mov_b32_e32 v1, s2
; GFX12W32-NEXT:    s_mov_b32 s2, s1
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    v_mov_b32_e32 v2, s3
; GFX12W32-NEXT:    s_mov_b32 s3, s1
; GFX12W32-NEXT:    buffer_atomic_add_u32 v1, v2, s[0:3], null idxen th:TH_ATOMIC_RETURN
; GFX12W32-NEXT:  .LBB3_4:
; GFX12W32-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX12W32-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12W32-NEXT:    s_wait_loadcnt 0x0
; GFX12W32-NEXT:    v_readfirstlane_b32 s2, v1
; GFX12W32-NEXT:    s_wait_alu depctr_va_sdst(0)
