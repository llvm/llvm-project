...
; RUN: llc -march=amdgcn -mcpu=gfx1200 -mattr=-wavefrontsize32,+wavefrontsize64 -amdgpu-atomic-optimizations=true -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX12,GFX12W64 %s
...
; GFX12W64-NEXT:    s_not_b64 exec, exec
; GFX12W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX12W64-NEXT:    s_not_b64 exec, exec
; GFX12W64-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W64-NEXT:    v_mov_b32_e32 v3, 0
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W64-NEXT:    v_mov_b32_e32 v2, v1
; GFX12W64-NEXT:    v_permlanex16_b32 v2, v2, -1, -1
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v2, v1 quad_perm:[0,1,2,3] row_mask:0xa bank_mask:0xf
; GFX12W64-NEXT:    v_readlane_b32 s4, v1, 31
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W64-NEXT:    v_mov_b32_e32 v2, s4
; GFX12W64-NEXT:    v_add_nc_u32_dpp v1, v2, v1 quad_perm:[0,1,2,3] row_mask:0xc bank_mask:0xf
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX12W64-NEXT:    v_mov_b32_dpp v3, v1 row_shr:1 row_mask:0xf bank_mask:0xf
; GFX12W64-NEXT:    v_readlane_b32 s4, v1, 15
; GFX12W64-NEXT:    v_readlane_b32 s5, v1, 31
; GFX12W64-NEXT:    v_writelane_b32 v3, s4, 16
; GFX12W64-NEXT:    s_mov_b64 exec, s[2:3]
; GFX12W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12W64-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX12W64-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX12W64-NEXT:    v_readlane_b32 s4, v1, 63
; GFX12W64-NEXT:    v_readlane_b32 s6, v1, 47
; GFX12W64-NEXT:    v_writelane_b32 v3, s5, 32
; GFX12W64-NEXT:    s_mov_b64 exec, s[2:3]
; GFX12W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12W64-NEXT:    v_mbcnt_hi_u32_b32 v4, exec_hi, v0
; GFX12W64-NEXT:    v_mov_b32_e32 v0, 0
; GFX12W64-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX12W64-NEXT:    v_writelane_b32 v3, s6, 48
; GFX12W64-NEXT:    s_mov_b64 exec, s[2:3]
; GFX12W64-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v4
; GFX12W64-NEXT:    ; implicit-def: $vgpr4
; GFX12W64-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX12W64-NEXT:    s_cbranch_execz .LBB2_2
; GFX12W64-NEXT:  ; %bb.1:
; GFX12W64-NEXT:    s_load_b128 s[8:11], s[0:1], 0x34
; GFX12W64-NEXT:    v_mov_b32_e32 v4, s4
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    buffer_atomic_add_u32 v4, off, s[8:11], null th:TH_ATOMIC_RETURN
; GFX12W64-NEXT:  .LBB2_2:
; GFX12W64-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX12W64-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W64-NEXT:    s_wait_loadcnt 0x0
; GFX12W64-NEXT:    v_readfirstlane_b32 s2, v4
; GFX12W64-NEXT:    v_mov_b32_e32 v4, v3
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W64-NEXT:    v_add_nc_u32_e32 v4, s2, v4
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    global_store_b32 v0, v4, s[0:1]
; GFX12W64-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12W64-NEXT:    s_endpgm
;
; GFX12W32-LABEL: add_i32_varying_vdata:
; GFX12W32:       ; %bb.0: ; %entry
; GFX12W32-NEXT:    v_mov_b32_e32 v1, v0
; GFX12W32-NEXT:    s_not_b32 exec_lo, exec_lo
; GFX12W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX12W32-NEXT:    s_not_b32 exec_lo, exec_lo
; GFX12W32-NEXT:    s_or_saveexec_b32 s2, -1
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12W32-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:1 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W32-NEXT:    v_mov_b32_e32 v3, 0
; GFX12W32-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:2 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W32-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:4 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W32-NEXT:    v_add_nc_u32_dpp v1, v1, v1 row_shr:8 row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W32-NEXT:    v_mov_b32_e32 v2, v1
; GFX12W32-NEXT:    v_permlanex16_b32 v2, v2, -1, -1
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12W32-NEXT:    v_add_nc_u32_dpp v1, v2, v1 quad_perm:[0,1,2,3] row_mask:0xa bank_mask:0xf
; GFX12W32-NEXT:    v_readlane_b32 s4, v1, 31
; GFX12W32-NEXT:    v_mov_b32_dpp v3, v1 row_shr:1 row_mask:0xf bank_mask:0xf
; GFX12W32-NEXT:    v_readlane_b32 s3, v1, 15
; GFX12W32-NEXT:    s_mov_b32 exec_lo, s2
; GFX12W32-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12W32-NEXT:    v_mbcnt_lo_u32_b32 v4, exec_lo, 0
; GFX12W32-NEXT:    v_mov_b32_e32 v0, 0
; GFX12W32-NEXT:    s_or_saveexec_b32 s2, -1
; GFX12W32-NEXT:    v_writelane_b32 v3, s3, 16
; GFX12W32-NEXT:    s_mov_b32 exec_lo, s2
; GFX12W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v4
; GFX12W32-NEXT:    ; implicit-def: $vgpr4
; GFX12W32-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX12W32-NEXT:    s_cbranch_execz .LBB2_2
; GFX12W32-NEXT:  ; %bb.1:
; GFX12W32-NEXT:    s_mov_b32 s3, s4
; GFX12W32-NEXT:    s_load_b128 s[4:7], s[0:1], 0x34
; GFX12W32-NEXT:    v_mov_b32_e32 v4, s3
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    buffer_atomic_add_u32 v4, off, s[4:7], null th:TH_ATOMIC_RETURN
; GFX12W32-NEXT:  .LBB2_2:
; GFX12W32-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12W32-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W32-NEXT:    s_wait_loadcnt 0x0
; GFX12W32-NEXT:    v_readfirstlane_b32 s2, v4
; GFX12W32-NEXT:    v_mov_b32_e32 v4, v3
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W32-NEXT:    v_add_nc_u32_e32 v4, s2, v4
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    global_store_b32 v0, v4, s[0:1]
; GFX12W32-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12W32-NEXT:    s_endpgm
entry:
...
; GFX12W64-NEXT:    ; implicit-def: $vgpr4
; GFX12W64-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX12W64-NEXT:    s_cbranch_execz .LBB3_2
; GFX12W64-NEXT:  ; %bb.1:
...
; GFX12W64-NEXT:    v_mov_b32_e32 v4, s4
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    v_mov_b32_e32 v5, s5
; GFX12W64-NEXT:    buffer_atomic_add_u32 v4, v5, s[8:11], null idxen th:TH_ATOMIC_RETURN
; GFX12W64-NEXT:  .LBB3_2:
; GFX12W64-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX12W64-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W64-NEXT:    s_wait_loadcnt 0x0
; GFX12W64-NEXT:    v_readfirstlane_b32 s2, v4
...
; GFX12W32-NEXT:    ; implicit-def: $vgpr4
; GFX12W32-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX12W32-NEXT:    s_cbranch_execz .LBB3_2
; GFX12W32-NEXT:  ; %bb.1:
; GFX12W32-NEXT:    s_mov_b32 s3, s4
...
; GFX12W32-NEXT:    s_load_b128 s[4:7], s[0:1], 0x34
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v5, s8
; GFX12W32-NEXT:    buffer_atomic_add_u32 v4, v5, s[4:7], null idxen th:TH_ATOMIC_RETURN
; GFX12W32-NEXT:  .LBB3_2:
; GFX12W32-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12W32-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W32-NEXT:    s_wait_loadcnt 0x0
; GFX12W32-NEXT:    v_readfirstlane_b32 s2, v4
...
; GFX12W64-NEXT:    ; implicit-def: $vgpr4
; GFX12W64-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX12W64-NEXT:    s_cbranch_execz .LBB7_2
; GFX12W64-NEXT:  ; %bb.1:
; GFX12W64-NEXT:    s_load_b128 s[8:11], s[0:1], 0x34
; GFX12W64-NEXT:    v_mov_b32_e32 v4, s4
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    buffer_atomic_sub_u32 v4, off, s[8:11], null th:TH_ATOMIC_RETURN
; GFX12W64-NEXT:  .LBB7_2:
; GFX12W64-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX12W64-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W64-NEXT:    s_wait_loadcnt 0x0
; GFX12W64-NEXT:    v_readfirstlane_b32 s2, v4
; GFX12W64-NEXT:    v_mov_b32_e32 v4, v3
; GFX12W64-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W64-NEXT:    v_sub_nc_u32_e32 v4, s2, v4
; GFX12W64-NEXT:    s_wait_kmcnt 0x0
; GFX12W64-NEXT:    global_store_b32 v0, v4, s[0:1]
; GFX12W64-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12W64-NEXT:    s_endpgm
...
; GFX12W32-NEXT:    ; implicit-def: $vgpr4
; GFX12W32-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX12W32-NEXT:    s_cbranch_execz .LBB7_2
; GFX12W32-NEXT:  ; %bb.1:
; GFX12W32-NEXT:    s_mov_b32 s3, s4
; GFX12W32-NEXT:    s_load_b128 s[4:7], s[0:1], 0x34
; GFX12W32-NEXT:    v_mov_b32_e32 v4, s3
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    buffer_atomic_sub_u32 v4, off, s[4:7], null th:TH_ATOMIC_RETURN
; GFX12W32-NEXT:  .LBB7_2:
; GFX12W32-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX12W32-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX12W32-NEXT:    s_wait_loadcnt 0x0
; GFX12W32-NEXT:    v_readfirstlane_b32 s2, v4
; GFX12W32-NEXT:    v_mov_b32_e32 v4, v3
; GFX12W32-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12W32-NEXT:    v_sub_nc_u32_e32 v4, s2, v4
; GFX12W32-NEXT:    s_wait_kmcnt 0x0
; GFX12W32-NEXT:    global_store_b32 v0, v4, s[0:1]
; GFX12W32-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12W32-NEXT:    s_endpgm
