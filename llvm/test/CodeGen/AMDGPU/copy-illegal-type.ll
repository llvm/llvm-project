...
; RUN: llc -mtriple=amdgpu8.02 -mattr=-flat-for-global -amdgpu-sdwa-peephole=0 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefix=VI %s
...
; SI-NEXT:    v_mov_b32_e32 v3, 0
; SI-NEXT:    buffer_load_dword v0, v[2:3], s[12:15], 0 addr64
