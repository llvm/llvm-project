...
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=+real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX11-PACKED,GFX11-PACKED-REAL16 %s
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=-real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX11-PACKED,GFX11-PACKED-FAKE16 %s
; RUN: llc < %s -mtriple=amdgpu12.00 -mattr=+real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX12-PACKED,GFX12-PACKED-REAL16 %s
; RUN: llc < %s -mtriple=amdgpu12.00 -mattr=-real-true16 | FileCheck -enable-var-scope -check-prefixes=GFX12-PACKED,GFX12-PACKED-FAKE16 %s
...
; GFX11-PACKED-REAL16-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-PACKED-REAL16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], v0, s[0:3], 0 format:[BUF_FMT_32_FLOAT] idxen
...
; GFX12-PACKED-REAL16-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-PACKED-REAL16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], v0, s[0:3], null format:[BUF_FMT_32_FLOAT] idxen
