...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s16, v0
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s17, v1
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s4, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s4, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s22, s4, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s16, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s16, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s16, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s5, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s5, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s30, s5
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s17, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s17, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s8, s17
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[16:17], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[36:37], s[4:5], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s29, s17, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s31, s17, 24
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s30
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s11, v3
; GCN-HSA-NEXT:    v_readfirstlane_b32 s10, v2
; GCN-HSA-NEXT:    s_ashr_i32 s4, s11, 24
; GCN-HSA-NEXT:    v_readfirstlane_b32 s12, v0
; GCN-HSA-NEXT:    v_readfirstlane_b32 s13, v1
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[10:11], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s4
; GCN-HSA-NEXT:    s_ashr_i32 s4, s11, 31
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s24
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s25
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s2, s13, 31
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s4
; GCN-HSA-NEXT:    s_ashr_i32 s4, s13, 24
; GCN-HSA-NEXT:    s_lshr_b32 s14, s10, 16
; GCN-HSA-NEXT:    s_lshr_b32 s16, s10, 24
; GCN-HSA-NEXT:    s_lshr_b32 s18, s10, 8
; GCN-HSA-NEXT:    s_lshr_b32 s20, s12, 16
...
; GCN-HSA-NEXT:    s_lshr_b32 s4, s11, 8
; GCN-HSA-NEXT:    s_mov_b32 s12, s11
; GCN-HSA-NEXT:    s_lshr_b32 s6, s13, 16
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s22, s6, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s24, s6, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s26, s6, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s22, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s23, v3
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s22, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s22, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s22, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s26, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s26, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s26, 8
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[28:29], s[22:23], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s23, 8
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s4, s27
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s25, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[36:37], s[16:17], 0x80000
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s25, 8
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s36
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s37
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s25, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s35, s27, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s42, s27, 24
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s27, s23, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s23, s23, 24
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s43, s25, 24
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s36, s25
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s5, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s5, 8
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:144
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s23
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s44, s5, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s27
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s45, s5, 24
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s38, s5
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[20:21], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v10, s43
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s45
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s44
...
; GCN-HSA-NEXT:    s_lshr_b32 s28, s16, 24
; GCN-HSA-NEXT:    s_lshr_b32 s30, s16, 8
; GCN-HSA-NEXT:    s_lshr_b32 s2, s11, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[14:15], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[46:47], s[18:19], 0x80000
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-HSA-NEXT:    s_lshr_b32 s6, s17, 16
; GCN-HSA-NEXT:    s_lshr_b32 s8, s17, 8
; GCN-HSA-NEXT:    s_mov_b32 s10, s17
; GCN-HSA-NEXT:    s_ashr_i32 s35, s17, 31
; GCN-HSA-NEXT:    s_ashr_i32 s36, s17, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[16:17], 0x80000
...
; GCN-HSA-NEXT:    s_lshr_b32 s12, s49, 8
; GCN-HSA-NEXT:    s_lshr_b32 s14, s51, 16
; GCN-HSA-NEXT:    s_lshr_b32 s28, s51, 8
; GCN-HSA-NEXT:    s_lshr_b32 s44, s50, 16
; GCN-HSA-NEXT:    s_lshr_b32 s30, s50, 24
; GCN-HSA-NEXT:    s_lshr_b32 s46, s50, 8
; GCN-HSA-NEXT:    s_mov_b32 s2, s51
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[50:51], 0x80000
; GCN-HSA-NEXT:    s_lshr_b32 s50, s48, 16
; GCN-HSA-NEXT:    s_lshr_b32 s58, s48, 24
; GCN-HSA-NEXT:    s_lshr_b32 s60, s48, 8
; GCN-HSA-NEXT:    s_mov_b32 s62, s49
; GCN-HSA-NEXT:    s_ashr_i32 s39, s11, 31
; GCN-HSA-NEXT:    s_ashr_i32 s40, s11, 24
...
; GCN-HSA-NEXT:    s_ashr_i32 s34, s51, 24
; GCN-HSA-NEXT:    s_ashr_i32 s37, s49, 31
; GCN-HSA-NEXT:    s_ashr_i32 s38, s49, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[28:29], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[14:15], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[62:63], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[46:47], 0x80000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v26, s60
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s55
; GCN-HSA-NEXT:    s_addc_u32 s55, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v27, s61
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s42
; GCN-HSA-NEXT:    s_add_u32 s42, s0, 0xd0
...
; GCN-HSA-NEXT:    s_add_u32 s42, s0, 0xc0
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[20:23]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s44
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s45
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s39
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s48, s6, 24
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v4, s41
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v5, s42
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, s43
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s7, v1
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s50, s6, 8
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[3:6], off, s[0:3], 0 offset:208
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s52, s10, 16
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s45
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s54, s10, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[34:35], s[6:7], 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s58, s12, 16
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s60, s12, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[28:29], s[10:11], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x80000
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:128
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s36, s12, 8
...
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s65, s7, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s67, s7, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:240
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s11, 16
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x80000
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s62, s11, 8
...
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s39, s11, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s63, s11, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s66, s13, 8
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s68, s13
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s33, s13, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s38, s13, 24
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[6:7], s[68:69], 0x80000
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s12
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s13
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s10
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s11
