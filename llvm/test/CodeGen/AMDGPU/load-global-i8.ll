...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s9, s3
; GCN-NOHSA-SI-NEXT:    buffer_load_ushort v0, off, s[8:11], 0
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $vgpr1
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $vgpr1
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s4, s0
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s5, s1
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_ushort v0, v[0:1]
; GCN-HSA-NEXT:    ; implicit-def: $vgpr1
; GCN-HSA-NEXT:    ; implicit-def: $vgpr1
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s1
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s9, s3
; GCN-NOHSA-VI-NEXT:    buffer_load_ushort v0, off, s[8:11], 0
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $vgpr1
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $vgpr1
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s4, s0
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s5, s1
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s9, s7
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr7
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr11
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr13
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr15
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NOHSA-SI-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s4, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s19, s4, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[8:9], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[10:11], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[12:13], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[14:15], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s19
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s18
...
; GCN-HSA-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GCN-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GCN-HSA-NEXT:    ; implicit-def: $sgpr5
; GCN-HSA-NEXT:    ; implicit-def: $sgpr7
; GCN-HSA-NEXT:    ; implicit-def: $sgpr9
; GCN-HSA-NEXT:    ; implicit-def: $sgpr11
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GCN-HSA-NEXT:    ; implicit-def: $sgpr3
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s1
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s12, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s4, v0
; GCN-HSA-NEXT:    s_lshr_b32 s2, s12, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s4, 16
; GCN-HSA-NEXT:    s_lshr_b32 s8, s4, 24
; GCN-HSA-NEXT:    s_lshr_b32 s6, s4, 8
; GCN-HSA-NEXT:    s_lshr_b32 s4, s12, 8
; GCN-HSA-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s13, s12, 31
; GCN-HSA-NEXT:    s_ashr_i32 s12, s12, 24
...
; GCN-NOHSA-VI-NEXT:    buffer_load_dwordx2 v[0:1], off, s[8:11], 0
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr7
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr11
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr13
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr15
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s18, s4, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s19, s4, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GCN-NOHSA-VI-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[16:17], s[4:5], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[4:5], s[8:9], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[8:9], s[10:11], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[10:11], s[12:13], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[12:13], s[14:15], 0x80000
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, s19
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, s18
...
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr13
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr15
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr17
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr19
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr21
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr23
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr25
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr27
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr29
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s0, s4
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s4, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s5, v3
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s30, v0
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s31, v1
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s4, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s4, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s4, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s22, s30, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s20, s30, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s30, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s5, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s5, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s6, s5
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s31, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s31, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s16, s31
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[30:31], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[18:19], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[14:15], s[20:21], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[22:23], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[20:21], s[26:27], 0x80000
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v15, s33
...
; GCN-HSA-NEXT:    ; implicit-def: $sgpr9
; GCN-HSA-NEXT:    ; implicit-def: $sgpr11
; GCN-HSA-NEXT:    ; implicit-def: $sgpr13
; GCN-HSA-NEXT:    ; implicit-def: $sgpr15
; GCN-HSA-NEXT:    ; implicit-def: $sgpr17
; GCN-HSA-NEXT:    ; implicit-def: $sgpr19
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_dwordx4 v[0:3], v[0:1]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s0
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s22, v0
; GCN-HSA-NEXT:    v_readfirstlane_b32 s23, v1
; GCN-HSA-NEXT:    v_readfirstlane_b32 s20, v2
; GCN-HSA-NEXT:    v_readfirstlane_b32 s21, v3
; GCN-HSA-NEXT:    s_lshr_b32 s18, s22, 16
; GCN-HSA-NEXT:    s_lshr_b32 s16, s22, 24
; GCN-HSA-NEXT:    s_lshr_b32 s14, s22, 8
; GCN-HSA-NEXT:    s_lshr_b32 s8, s23, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s23, 8
; GCN-HSA-NEXT:    s_mov_b32 s12, s23
; GCN-HSA-NEXT:    s_ashr_i32 s2, s23, 31
; GCN-HSA-NEXT:    s_ashr_i32 s4, s23, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[20:21], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s22
; GCN-HSA-NEXT:    s_ashr_i32 s6, s21, 31
...
; GCN-HSA-NEXT:    ; implicit-def: $sgpr23
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s4
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s2
; GCN-HSA-NEXT:    ; implicit-def: $sgpr25
; GCN-HSA-NEXT:    s_lshr_b32 s24, s20, 24
; GCN-HSA-NEXT:    s_lshr_b32 s22, s20, 8
; GCN-HSA-NEXT:    s_lshr_b32 s2, s21, 16
; GCN-HSA-NEXT:    s_lshr_b32 s4, s21, 8
; GCN-HSA-NEXT:    s_mov_b32 s6, s21
; GCN-HSA-NEXT:    s_lshr_b32 s20, s20, 16
; GCN-HSA-NEXT:    ; implicit-def: $sgpr21
...
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr15
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr17
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr19
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr21
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr23
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr25
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr27
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr29
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr11
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr13
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr7
...
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s30, v0
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s31, v1
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s28, s4, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s26, s4, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s24, s4, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s22, s30, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s20, s30, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s18, s30, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s16, s5, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s31, 8
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[14:15], s[16:17], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[16:17], s[18:19], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[18:19], s[20:21], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[20:21], s[22:23], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[22:23], s[24:25], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[24:25], s[26:27], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[26:27], s[28:29], 0x80000
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s8, s31, 16
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s6, s31
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[34:35], s[30:31], 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s30, s31, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s31, s31, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v15, s30
...
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[4:7], off, s[8:11], 0 offset:16
; GCN-NOHSA-SI-NEXT:    buffer_load_dwordx4 v[0:3], off, s[8:11], 0
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr1
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
...
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s26, v0
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s27, v1
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s22, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s0, s22, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[38:39], s[26:27], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[36:37], s[6:7], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[28:29], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[30:31], s[22:23], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[0:1], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[42:43], s[8:9], 0x80000
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr11
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr45
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr13
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr15
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr21
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr17
...
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr45
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s40
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s41
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr41
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s28, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s44, s28, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s28, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s38, s26, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s26, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s23, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s23, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s29, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s29, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s20, s29
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s4, s27, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s27, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s34, s27
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s27, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s46, s29, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s47, s29, 24
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s40, s23, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s41, s23, 24
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s48, s27, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[42:43], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[28:29], s[44:45], 0x80000
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s26, 16
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr27
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s6, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s7, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s7, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s24, s7
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[14:17], off, s[0:3], 0 offset:144
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s41
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s42, s7, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s40
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s43, s7, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s6, 16
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr41
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[36:37], s[38:39], 0x80000
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s43
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s42
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, s10
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v15, s11
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-HSA-NEXT:    ; implicit-def: $sgpr7
; GCN-HSA-NEXT:    ; implicit-def: $sgpr19
; GCN-HSA-NEXT:    ; implicit-def: $sgpr27
; GCN-HSA-NEXT:    ; implicit-def: $sgpr9
; GCN-HSA-NEXT:    ; implicit-def: $sgpr11
; GCN-HSA-NEXT:    ; implicit-def: $sgpr13
; GCN-HSA-NEXT:    ; implicit-def: $sgpr15
; GCN-HSA-NEXT:    ; implicit-def: $sgpr17
; GCN-HSA-NEXT:    ; implicit-def: $sgpr29
; GCN-HSA-NEXT:    ; implicit-def: $sgpr31
; GCN-HSA-NEXT:    ; implicit-def: $sgpr35
; GCN-HSA-NEXT:    ; implicit-def: $sgpr37
; GCN-HSA-NEXT:    ; implicit-def: $sgpr51
; GCN-HSA-NEXT:    ; implicit-def: $sgpr53
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s3
; GCN-HSA-NEXT:    flat_load_dwordx4 v[4:7], v[0:1]
...
; GCN-HSA-NEXT:    ; implicit-def: $sgpr3
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s38, v6
; GCN-HSA-NEXT:    v_readfirstlane_b32 s39, v7
; GCN-HSA-NEXT:    v_readfirstlane_b32 s40, v4
; GCN-HSA-NEXT:    v_readfirstlane_b32 s41, v5
; GCN-HSA-NEXT:    s_lshr_b32 s24, s38, 16
; GCN-HSA-NEXT:    s_lshr_b32 s22, s38, 24
; GCN-HSA-NEXT:    s_lshr_b32 s20, s38, 8
; GCN-HSA-NEXT:    s_lshr_b32 s2, s39, 16
; GCN-HSA-NEXT:    s_lshr_b32 s4, s39, 8
; GCN-HSA-NEXT:    s_mov_b32 s6, s39
; GCN-HSA-NEXT:    s_ashr_i32 s43, s39, 31
; GCN-HSA-NEXT:    s_ashr_i32 s45, s39, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s38
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s39
; GCN-HSA-NEXT:    s_lshr_b32 s26, s40, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[38:39], s[40:41], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-HSA-NEXT:    s_lshr_b32 s18, s40, 24
...
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
...
; GCN-HSA-NEXT:    s_lshr_b32 s16, s40, 8
; GCN-HSA-NEXT:    s_lshr_b32 s8, s41, 16
; GCN-HSA-NEXT:    s_lshr_b32 s10, s41, 8
; GCN-HSA-NEXT:    s_mov_b32 s12, s41
; GCN-HSA-NEXT:    s_ashr_i32 s33, s41, 31
; GCN-HSA-NEXT:    s_ashr_i32 s42, s41, 24
; GCN-HSA-NEXT:    ; implicit-def: $sgpr41
...
; GCN-HSA-NEXT:    s_lshr_b32 s14, s54, 16
; GCN-HSA-NEXT:    s_lshr_b32 s28, s54, 24
; GCN-HSA-NEXT:    s_lshr_b32 s30, s54, 8
; GCN-HSA-NEXT:    s_lshr_b32 s34, s38, 16
; GCN-HSA-NEXT:    s_lshr_b32 s36, s38, 24
; GCN-HSA-NEXT:    s_lshr_b32 s40, s38, 8
; GCN-HSA-NEXT:    s_lshr_b32 s50, s55, 16
; GCN-HSA-NEXT:    s_lshr_b32 s52, s55, 8
; GCN-HSA-NEXT:    s_mov_b32 s20, s55
; GCN-HSA-NEXT:    ; implicit-def: $sgpr7
; GCN-HSA-NEXT:    s_lshr_b32 s6, s39, 16
; GCN-HSA-NEXT:    ; implicit-def: $sgpr3
; GCN-HSA-NEXT:    s_lshr_b32 s2, s39, 8
; GCN-HSA-NEXT:    ; implicit-def: $sgpr5
; GCN-HSA-NEXT:    s_mov_b32 s4, s39
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s18
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s19
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[8:9], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[56:57], s[16:17], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s44, s39, 31
; GCN-HSA-NEXT:    s_ashr_i32 s46, s39, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s47, s55, 31
; GCN-HSA-NEXT:    s_ashr_i32 s48, s55, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[16:17], s[20:21], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[52:53], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[50:51], 0x80000
...
; GCN-HSA-NEXT:    s_add_u32 s14, s0, 0xc0
; GCN-HSA-NEXT:    s_addc_u32 s15, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v28, s50
; GCN-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[8:11]
; GCN-HSA-NEXT:    v_mov_b32_e32 v27, s15
; GCN-HSA-NEXT:    v_mov_b32_e32 v29, s51
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s34
; GCN-HSA-NEXT:    v_mov_b32_e32 v17, s35
...
; GCN-HSA-NEXT:    s_addc_u32 s15, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[16:19]
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s14
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s15
; GCN-HSA-NEXT:    s_add_u32 s14, s0, 0x60
; GCN-HSA-NEXT:    v_mov_b32_e32 v11, s1
; GCN-HSA-NEXT:    s_addc_u32 s15, s1, 0
...
; GCN-HSA-NEXT:    s_add_u32 s14, s0, 48
; GCN-HSA-NEXT:    v_mov_b32_e32 v20, s54
; GCN-HSA-NEXT:    v_mov_b32_e32 v21, s55
; GCN-HSA-NEXT:    v_mov_b32_e32 v22, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v23, s31
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s44
...
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr25
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr29
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr31
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr35
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr37
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr39
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr41
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr43
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr45
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr47
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr49
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr51
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr53
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr55
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr57
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr11
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr19
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr21
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr9
; GCN-NOHSA-VI-NEXT:    ; implicit-def: $sgpr7
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s4, v6
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s5, v7
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s58, v4
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s59, v5
; GCN-NOHSA-VI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s60, v2
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s61, v3
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s62, v0
; GCN-NOHSA-VI-NEXT:    v_readfirstlane_b32 s63, v1
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s56, s4, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s54, s4, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s52, s4, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s50, s58, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s48, s58, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s46, s58, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s44, s60, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s42, s60, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s40, s60, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s38, s62, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s36, s62, 24
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s34, s62, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s30, s5, 8
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s16, s5
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s28, s59, 8
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s22, s59
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s24, s61, 8
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s12, s61
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s14, s63, 8
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s10, s5, 16
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s8, s63, 16
; GCN-NOHSA-VI-NEXT:    s_mov_b32 s6, s63
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[26:27], s[62:63], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[66:67], s[58:59], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[68:69], s[4:5], 0x80000
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s33, s63, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s58, s63, 24
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s63, s5, 31
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s70, s5, 24
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[4:5], s[14:15], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[14:15], s[12:13], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[12:13], s[24:25], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[24:25], s[22:23], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[22:23], s[28:29], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[28:29], s[16:17], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[16:17], s[30:31], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[30:31], s[34:35], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[34:35], s[36:37], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[36:37], s[38:39], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[38:39], s[40:41], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[40:41], s[42:43], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[42:43], s[44:45], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[44:45], s[46:47], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[46:47], s[48:49], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[48:49], s[50:51], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[50:51], s[52:53], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[52:53], s[54:55], 0x80000
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[54:55], s[56:57], 0x80000
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v6, s52
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v7, s53
...
; GCN-NOHSA-VI-NEXT:    s_bfe_i64 s[64:65], s[60:61], 0x80000
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s18, s59, 16
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:64
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s62, s59, 31
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s36
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s37
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s34
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s35
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:16
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s59, s59, 24
...
; GCN-NOHSA-VI-NEXT:    s_lshr_b32 s20, s61, 16
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:224
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s60, s61, 31
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v0, s18
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v1, s19
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s59
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s62
; GCN-NOHSA-VI-NEXT:    s_ashr_i32 s61, s61, 24
...
; GCN-NOHSA-VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:96
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v9, s49
