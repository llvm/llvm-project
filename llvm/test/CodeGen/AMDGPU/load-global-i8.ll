...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s30, s7
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s27, s7, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s29, s7, 24
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[6:7], s[26:27], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
...
; GCN-HSA-NEXT:    s_lshr_b32 s26, s5, 8
; GCN-HSA-NEXT:    s_mov_b32 s28, s5
; GCN-HSA-NEXT:    s_ashr_i32 s27, s5, 31
; GCN-HSA-NEXT:    s_ashr_i32 s29, s5, 24
; GCN-HSA-NEXT:    s_ashr_i32 s7, s3, 31
; GCN-HSA-NEXT:    s_ashr_i32 s9, s3, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[30:31], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[2:3], s[28:29], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[26:27], 0x80000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s9
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s23
...
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v18, s16
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v19, s17
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v20, s20
; GCN-NOHSA-VI-NEXT:    v_mov_b32_e32 v21, s21
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s1, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(1)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s34, v2
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s35, v3
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s54, v0
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s55, v1
; GCN-NOHSA-SI-NEXT:    s_waitcnt vmcnt(0)
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s52, v6
; GCN-NOHSA-SI-NEXT:    v_readfirstlane_b32 s53, v7
...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s34, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s34, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s6, s54, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s8, s54, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s12, s54, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s14, s52, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s18, s52, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s24, s52, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s26, s20, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s20, 24
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s20, 8
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s35, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s38, s35, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s60, s35
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s55, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s44, s55, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s62, s55
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s48, s53, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s46, s53, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s64, s53
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s21, 16
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s56, s21, 8
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s4, s21
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[50:51], s[20:21], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[58:59], s[52:53], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[66:67], s[54:55], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[68:69], s[34:35], 0x80000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s7, s21, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s9, s21, 24
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[20:21], s[64:65], 0x80000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s13, s53, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s11, s53, 24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s68
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[52:53], s[62:63], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, s69
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s15, s55, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s17, s55, 24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s66
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[54:55], s[60:61], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s67
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s19, s35, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s23, s35, 24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s58
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[34:35], s[56:57], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s59
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s50
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s51
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s23
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s19
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v18, s54
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v19, s55
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v24, s52
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v25, s53
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s22
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s23
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[24:25], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v28, s16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v29, s17
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[26:29], off, s[0:3], 0 offset:208
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v28, s11
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v29, s13
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s9
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v20, s38
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v21, s39
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[18:21], off, s[0:3], 0 offset:224
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v20, s42
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v21, s43
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[20:23], off, s[0:3], 0 offset:176
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s44
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s45
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[0:3], 0 offset:160
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s48
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s49
...
; GCN-HSA-NEXT:    s_lshr_b32 s26, s2, 8
; GCN-HSA-NEXT:    s_lshr_b32 s28, s4, 16
; GCN-HSA-NEXT:    s_lshr_b32 s30, s4, 24
; GCN-HSA-NEXT:    s_lshr_b32 s34, s4, 8
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[4:5], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[2:3], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s31, s5, 31
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s14, v4
; GCN-HSA-NEXT:    v_readfirstlane_b32 s15, v5
; GCN-HSA-NEXT:    v_readfirstlane_b32 s18, v6
; GCN-HSA-NEXT:    v_readfirstlane_b32 s19, v7
; GCN-HSA-NEXT:    s_lshr_b32 s16, s3, 16
; GCN-HSA-NEXT:    s_lshr_b32 s8, s3, 8
; GCN-HSA-NEXT:    s_mov_b32 s10, s3
; GCN-HSA-NEXT:    s_lshr_b32 s6, s5, 16
; GCN-HSA-NEXT:    s_lshr_b32 s38, s5, 8
; GCN-HSA-NEXT:    s_mov_b32 s40, s5
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[30:31], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[26:27], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s20
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s12
; GCN-HSA-NEXT:    s_lshr_b32 s46, s14, 16
; GCN-HSA-NEXT:    s_lshr_b32 s48, s14, 24
; GCN-HSA-NEXT:    s_lshr_b32 s50, s14, 8
; GCN-HSA-NEXT:    s_lshr_b32 s20, s15, 16
; GCN-HSA-NEXT:    s_lshr_b32 s12, s15, 8
; GCN-HSA-NEXT:    s_mov_b32 s52, s15
; GCN-HSA-NEXT:    s_lshr_b32 s54, s18, 16
; GCN-HSA-NEXT:    s_lshr_b32 s56, s18, 24
; GCN-HSA-NEXT:    s_lshr_b32 s58, s18, 8
; GCN-HSA-NEXT:    s_lshr_b32 s60, s19, 16
; GCN-HSA-NEXT:    s_lshr_b32 s62, s19, 8
; GCN-HSA-NEXT:    s_mov_b32 s64, s19
; GCN-HSA-NEXT:    s_ashr_i32 s33, s5, 24
; GCN-HSA-NEXT:    s_ashr_i32 s36, s3, 31
; GCN-HSA-NEXT:    s_ashr_i32 s37, s3, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[40:41], 0x80000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[14:15], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s30, s15, 31
; GCN-HSA-NEXT:    s_ashr_i32 s38, s15, 24
; GCN-HSA-NEXT:    s_bfe_i64 s[66:67], s[18:19], 0x80000
; GCN-HSA-NEXT:    s_ashr_i32 s39, s19, 31
; GCN-HSA-NEXT:    s_ashr_i32 s40, s19, 24
...
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[52:53], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[20:21], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[22:23], s[64:65], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[62:63], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[60:61], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[50:51], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[48:49], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[42:43], s[46:47], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[58:59], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[46:47], s[56:57], 0x80000
; GCN-HSA-NEXT:    s_bfe_i64 s[48:49], s[54:55], 0x80000
; GCN-HSA-NEXT:    s_add_u32 s50, s0, 0x50
; GCN-HSA-NEXT:    s_addc_u32 s51, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v22, s44
; GCN-HSA-NEXT:    s_add_u32 s44, s0, 64
; GCN-HSA-NEXT:    v_mov_b32_e32 v26, s50
; GCN-HSA-NEXT:    v_mov_b32_e32 v23, s45
; GCN-HSA-NEXT:    s_addc_u32 s45, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v27, s51
; GCN-HSA-NEXT:    v_mov_b32_e32 v24, s42
; GCN-HSA-NEXT:    s_add_u32 s42, s0, 16
...
; GCN-HSA-NEXT:    s_add_u32 s16, s0, 0x90
...
; GCN-HSA-NEXT:    s_addc_u32 s17, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s17
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v20, s66
; GCN-HSA-NEXT:    v_mov_b32_e32 v21, s67
