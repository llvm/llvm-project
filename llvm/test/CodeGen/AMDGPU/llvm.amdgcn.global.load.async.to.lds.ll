...
; GFX1210-LABEL: global_load_async_to_lds_b32_saddr_scale_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_async_to_lds_b32 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-LABEL: global_load_async_to_lds_b64_saddr_scale_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_async_to_lds_b64 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1210-NEXT:    s_endpgm
entry:
  %idxprom = sext i32 %idx to i64
...
; GFX1210-SDAG-LABEL: global_load_async_to_lds_b64_saddr_no_scale_offset:
; GFX1210-SDAG:       ; %bb.0: ; %entry
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v2, v1
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX1210-SDAG-NEXT:    v_lshl_add_u64 v[2:3], v[2:3], 2, s[0:1]
; GFX1210-SDAG-NEXT:    global_load_async_to_lds_b64 v0, v[2:3], off offset:16 th:TH_LOAD_NT
; GFX1210-SDAG-NEXT:    s_endpgm
;
; GFX1210-GISEL-LABEL: global_load_async_to_lds_b64_saddr_no_scale_offset:
; GFX1210-GISEL:       ; %bb.0: ; %entry
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v2, v1
; GFX1210-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[0:1]
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX1210-GISEL-NEXT:    v_lshlrev_b64_e32 v[2:3], 2, v[2:3]
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-GISEL-NEXT:    v_add_co_u32 v2, vcc_lo, v4, v2
; GFX1210-GISEL-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v5, v3, vcc_lo
; GFX1210-GISEL-NEXT:    global_load_async_to_lds_b64 v0, v[2:3], off offset:16 th:TH_LOAD_NT
; GFX1210-GISEL-NEXT:    s_endpgm
entry:
  %idxprom = sext i32 %idx to i64
  %gep = getelementptr i32, ptr addrspace(1) %gaddr, i64 %idxprom
