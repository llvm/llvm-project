...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v4, off, s32 offset:8 glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:    scratch_load_d16_b16 v35, off, s32 offset:12
; GFX11-TRUE16-NEXT:    scratch_load_d16_b16 v33, off, s32 offset:16
; GFX11-TRUE16-NEXT:    scratch_load_d16_b16 v36, off, s32 offset:20
; GFX11-TRUE16-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-TRUE16-NEXT:    s_mov_b32 s2, -1
...
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_store_b16 v36, off, s[0:3], 0 dlc
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v48, off, s32 offset:60
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v33, off, s32 offset:56
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v49, off, s32 offset:52
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v34, off, s32 offset:48
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v50, off, s32 offset:44
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v35, off, s32 offset:40
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v51, off, s32 offset:36
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v36, off, s32 offset:32
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v52, off, s32 offset:28
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v37, off, s32 offset:24
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v53, off, s32 offset:20
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v38, off, s32 offset:16
; GFX11-TRUE16-NEXT:    scratch_load_d16_u8 v54, off, s32 offset:12
