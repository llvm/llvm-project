...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx940 -verify-machineinstrs -stop-after=finalize-isel -amdgpu-wave-transform-cf=1 -simplifycfg-require-and-preserve-domtree=1 < %s | FileCheck -check-prefixes=GFX940 %s
...
define hidden void @widget() {
  ...
  ; GFX940-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32 = V_READFIRSTLANE_B32 [[GLOBAL_LOAD_DWORD]], implicit $exec
  ...
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def dead $scc, implicit-def $sgpr32, implicit $sgpr32
  ...
  ; GFX940-NEXT:   $sgpr30_sgpr31 = SI_CALL killed [[SI_PC_ADD_REL_OFFSET]], @wibble, csr_amdgpu_gfx90ainsts, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31, implicit-def $vgpr0
  ; GFX940-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def dead $scc, implicit-def $sgpr32, implicit $sgpr32
  ; GFX940-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY $vgpr0
  ...
  ; GFX940-NEXT:   $sgpr15 = COPY [[COPY1]]
  ; GFX940-NEXT:   $vgpr31 = COPY [[COPY]]
  ; GFX940-NEXT:   $sgpr30_sgpr31 = SI_CALL killed [[SI_PC_ADD_REL_OFFSET1]], @wibble, csr_amdgpu_gfx90ainsts, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31, implicit-def $vgpr0
  ; GFX940-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def dead $scc, implicit-def $sgpr32, implicit $sgpr32
  ; GFX940-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY $vgpr0
  ; GFX940-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sgpr_32 = S_MOV_B32 0
  ; GFX940-NEXT:   [[V_CMP_GT_F32_e64_:%[0-9]+]]:sreg_64 = nsz nofpexcept V_CMP_GT_F32_e64 0, [[COPY12]], 0, killed [[S_MOV_B32_3]], 0, implicit $mode, implicit $exec
  ...
  ; GFX1200-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32 = V_READFIRSTLANE_B32 [[GLOBAL_LOAD_DWORD]], implicit $exec
...
define hidden void @blam() {
  ...
  ; GFX940-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 0, implicit $exec
  ; GFX940-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:vreg_64_align2 = REG_SEQUENCE [[V_LSHLREV_B32_e64_]], %subreg.sub0, killed [[V_MOV_B32_e32_]], %subreg.sub1
  ...
  ; GFX940-NEXT:   SCRATCH_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_1]], killed [[S_MOV_B32_8]], 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into `ptr addrspace(5) null`, align 16, addrspace 5)
  ...
  ; GFX940-NEXT:   $sgpr15 = COPY [[COPY1]]
  ; GFX940-NEXT:   $vgpr31 = COPY [[COPY]]
  ; GFX940-NEXT:   $sgpr30_sgpr31 = SI_CALL killed [[SI_PC_ADD_REL_OFFSET]], @spam, csr_amdgpu_gfx90ainsts, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31, implicit-def $vgpr0
  ; GFX940-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def dead $scc, implicit-def $sgpr32, implicit $sgpr32
  ; GFX940-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY $vgpr0
  ...
  ; GFX940-NEXT:   [[V_MOV_B32_e32_3:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 2143289344, implicit $exec
  ; GFX940-NEXT:   SCRATCH_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_3]], killed [[S_MOV_B32_12]], 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into `ptr addrspace(5) null`, addrspace 5)
  ; GFX940-NEXT:   S_BRANCH %bb.1
  ; GFX940-NEXT: {{  $}}
  ...
  ; GFX1200-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sgpr_32 = S_MOV_B32 0
  ; GFX1200-NEXT:   [[V_CMP_EQ_F32_e64_:%[0-9]+]]:sreg_32 = nsz nofpexcept V_CMP_EQ_F32_e64 0, [[FLAT_LOAD_DWORD]], 0, killed [[S_MOV_B32_3]], 0, implicit $mode, implicit $exec
  ; GFX1200-NEXT:   [[COPY10:%[0-9]+]]:vreg_1 = COPY [[V_CMP_EQ_F32_e64_]]
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT: bb.1.bb2:
  ...
  ; GFX1200-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_4]]
  ; GFX1200-NEXT:   SCRATCH_STORE_DWORD_SADDR [[COPY11]], [[S_MOV_B32_4]], 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into `ptr addrspace(5) null`, align 8, addrspace 5)
  ...
  ; GFX1200-NEXT:   [[V_CMP_EQ_F32_e64_1:%[0-9]+]]:sreg_32 = nsz nofpexcept V_CMP_EQ_F32_e64 0, [[COPY12]], 0, killed [[S_MOV_B32_9]], 0, implicit $mode, implicit $exec
  ...
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[COPY10]]
  ; GFX1200-NEXT:   SI_BRCOND [[COPY13]], %bb.8
