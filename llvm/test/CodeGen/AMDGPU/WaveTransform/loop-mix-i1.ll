...
; RUN: llc -O2 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -verify-machineinstrs -stop-after=phi-node-elimination -amdgpu-wave-transform-cf=1 < %s | FileCheck -check-prefixes=GFX1200 %s
