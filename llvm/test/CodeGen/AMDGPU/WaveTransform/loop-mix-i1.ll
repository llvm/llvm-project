...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -verify-machineinstrs -stop-after=finalize-isel -amdgpu-wave-transform-cf=1 < %s | FileCheck -check-prefixes=GISEL %s
...
define amdgpu_kernel void @loop_mix_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GFX90a-NEXT:   SI_BRCOND_UNIFORM killed [[COPY6]], %bb.2
  ...
  ; GISEL-NEXT:   SI_BRCOND [[V_CMP_LE_U32_e64_]], %bb.4
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[V_CMP_GT_I32_e64_]], %bb.3
  ...
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_:%[0-9]+]]:vgpr_32 = V_LSHLREV_B32_e64 [[COPY16]], [[V_AND_B32_e64_]], implicit $exec
  ...
  ; GISEL-NEXT:   SI_BRCOND [[S_XOR_B32_]], %bb.7
  ...
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_1:%[0-9]+]]:vgpr_32 = V_LSHLREV_B32_e64 [[COPY25]], [[V_AND_B32_e64_]], implicit $exec
