...
define amdgpu_kernel void @loop_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GFX940-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_]], %bb.1, %66, %bb.2
  ...
  ; GFX940-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_64 = V_CMP_NE_U32_e64 [[PHI1]], 0, implicit $exec
  ; GFX940-NEXT:   [[S_XOR_B64_:%[0-9]+]]:sreg_64_xexec = S_XOR_B64 [[V_CMP_NE_U32_e64_]], killed [[V_CMP_LT_I32_e64_]], implicit-def dead $scc
  ; GFX940-NEXT:   [[V_CNDMASK_B32_e64_1:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, 0, 0, -1, [[S_XOR_B64_]], implicit $exec
  ...
  ; GFX940-NEXT:   [[V_CMP_GT_I32_e64_1:%[0-9]+]]:sreg_64_xexec = V_CMP_GT_I32_e64 killed [[GLOBAL_LOAD_DWORD_SADDR]], [[S_MOV_B32_7]], implicit $exec
  ; GFX940-NEXT:   [[V_CNDMASK_B32_e64_2:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, 0, 0, -1, [[V_CMP_GT_I32_e64_1]], implicit $exec
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.4.if.end:
  ; GFX940-NEXT:   successors: %bb.5(0x40000000), %bb.6(0x40000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI3:%[0-9]+]]:vgpr_32 = PHI [[V_CNDMASK_B32_e64_2]], %bb.3, [[V_CNDMASK_B32_e64_1]], %bb.2
  ; GFX940-NEXT:   [[PHI4:%[0-9]+]]:vgpr_32 = PHI [[V_AND_B32_e64_]], %bb.3, [[V_ADD_U32_e64_]], %bb.2
  ; GFX940-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_64_xexec = V_CMP_NE_U32_e64 [[PHI3]], 0, implicit $exec
  ; GFX940-NEXT:   [[V_CNDMASK_B32_e64_3:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, 0, 0, 1, [[V_CMP_NE_U32_e64_1]], implicit $exec
  ; GFX940-NEXT:   [[S_MOV_B32_8:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; GFX940-NEXT:   [[V_CMP_NE_U32_e64_2:%[0-9]+]]:sreg_64 = V_CMP_NE_U32_e64 killed [[V_CNDMASK_B32_e64_3]], killed [[S_MOV_B32_8]], implicit $exec
  ; GFX940-NEXT:   SI_BRCOND killed [[V_CMP_NE_U32_e64_2]], %bb.6
  ...
  ; GFX940-NEXT:   [[COPY7:%[0-9]+]]:vgpr_32 = COPY killed [[COPY6]]
  ; GFX940-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY killed [[COPY5]]
  ; GFX940-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:vreg_64_align2 = REG_SEQUENCE killed [[COPY7]], %subreg.sub0, killed [[COPY8]], %subreg.sub1
  ; GFX940-NEXT:   [[V_ASHRREV_I32_e64_:%[0-9]+]]:vgpr_32 = V_ASHRREV_I32_e64 31, [[PHI4]], implicit $exec
  ; GFX940-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[V_ASHRREV_I32_e64_]]
  ; GFX940-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:vreg_64_align2 = REG_SEQUENCE [[PHI4]], %subreg.sub0, killed [[COPY9]], %subreg.sub1
  ...
  ; GISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 1, [[DEF1]], implicit-def dead $scc
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:sreg_32 = PHI [[V_CMP_NE_U32_e64_]], %bb.1, %94, %bb.6
  ; GISEL-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI [[V_AND_B32_e64_]], %bb.6, [[DEF]], %bb.1
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:sreg_32_xm0_xexec = PHI [[PHI]], %bb.2, %101, %bb.7
  ; GISEL-NEXT:   [[PHI3:%[0-9]+]]:vgpr_32 = PHI %51, %bb.7, [[PHI1]], %bb.2
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI4:%[0-9]+]]:sreg_32 = PHI [[DEF2]], %bb.3, %111, %bb.5
  ; GISEL-NEXT:   [[PHI5:%[0-9]+]]:sreg_32 = PHI [[S_MOV_B32_4]], %bb.3, %108, %bb.5
  ; GISEL-NEXT:   [[PHI6:%[0-9]+]]:sreg_32_xm0_xexec = PHI [[S_MOV_B32_3]], %bb.3, %48, %bb.5
  ; GISEL-NEXT:   [[PHI7:%[0-9]+]]:vreg_64 = PHI %47, %bb.5, [[REG_SEQUENCE1]], %bb.3
  ; GISEL-NEXT:   [[PHI8:%[0-9]+]]:vgpr_32 = PHI %43, %bb.5, [[V_AND_B32_e64_]], %bb.3
  ...
  ; GISEL-NEXT:   [[S_XOR_B32_:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[PHI5]], [[V_CMP_LT_I32_e64_]], implicit-def dead $scc
  ...
  ; GISEL-NEXT:   [[S_ANDN2_B32_1:%[0-9]+]]:sreg_32 = S_ANDN2_B32 [[V_CMP_NE_U32_e64_]], $exec_lo, implicit-def $scc
  ...
  ; GISEL-NEXT:   [[COPY26:%[0-9]+]]:sreg_32_xm0_xexec = COPY [[S_OR_B32_]]
  ; GISEL-NEXT:   SI_END_CF [[PHI10]], implicit-def $exec, implicit-def $scc, implicit $exec
  ; GISEL-NEXT:   [[S_ANDN2_B32_2:%[0-9]+]]:sreg_32_xm0_xexec = S_ANDN2_B32 [[COPY6]], $exec_lo, implicit-def $scc
  ; GISEL-NEXT:   [[S_AND_B32_3:%[0-9]+]]:sreg_32_xm0_xexec = S_AND_B32 $exec_lo, [[COPY26]], implicit-def $scc
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[SI_IF1:%[0-9]+]]:sreg_32_xm0_xexec = SI_IF [[PHI2]], %bb.10, implicit-def $exec, implicit-def $scc, implicit $exec
  ...
  ; GISEL-NEXT:   [[V_ASHRREV_I32_e64_:%[0-9]+]]:vgpr_32 = V_ASHRREV_I32_e64 [[V_MOV_B32_e32_1]], [[PHI3]], implicit $exec
  ; GISEL-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[PHI3]], %subreg.sub0, [[V_ASHRREV_I32_e64_]], %subreg.sub1
  ...
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD [[REG_SEQUENCE4]], [[PHI3]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx13, addrspace 1)
  ; GISEL-NEXT: {{  $}}
