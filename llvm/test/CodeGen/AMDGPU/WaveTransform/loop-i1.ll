...
define amdgpu_kernel void @loop_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GISEL-NEXT:   SI_BRCOND [[V_CMP_GT_I32_e64_]], %bb.3
  ...
  ; GISEL-NEXT:   SI_BRCOND [[S_XOR_B32_1]], %bb.7
  ...
  ; GISEL-NEXT:   [[V_LSHLREV_B64_pseudo_e64_:%[0-9]+]]:vreg_64 = V_LSHLREV_B64_pseudo_e64 [[COPY31]], [[REG_SEQUENCE3]], implicit $exec
