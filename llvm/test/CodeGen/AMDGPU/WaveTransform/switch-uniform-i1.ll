...
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -verify-machineinstrs -stop-after=finalize-isel -amdgpu-wave-transform-cf=1 < %s | FileCheck -check-prefixes=GISEL %s
...
define amdgpu_kernel void @switch_uniform_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce, i32 %id) {
  ...
  ; GFX90a-NEXT:   SI_BRCOND_UNIFORM killed [[COPY10]], %bb.4
  ...
  ; GFX90a-NEXT:   SI_BRCOND_UNIFORM killed [[COPY11]], %bb.6
  ...
  ; GFX90a-NEXT:   SI_BRCOND_UNIFORM killed [[COPY12]], %bb.7
  ...
  ; GFX90a-NEXT:   SI_BRCOND_UNIFORM killed [[COPY13]], %bb.8
  ...
  ; GFX90a-NEXT:   [[COPY26:%[0-9]+]]:vgpr_32 = COPY [[COPY9]]
  ...
  ; GISEL-NEXT:   [[COPY1:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub0_sub1
  ; GISEL-NEXT:   [[COPY2:%[0-9]+]]:sreg_64 = COPY [[S_LOAD_DWORDX4_IMM]].sub2_sub3
  ; GISEL-NEXT:   [[S_LOAD_DWORD_IMM:%[0-9]+]]:sreg_32_xm0_xexec = S_LOAD_DWORD_IMM [[COPY]], 16, 0 :: (dereferenceable invariant load (s32) from %ir.id.kernarg.offset, align 16, addrspace 4)
  ; GISEL-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32_xm0 = S_MOV_B32 0
  ; GISEL-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64 = REG_SEQUENCE [[S_LOAD_DWORD_IMM]], %subreg.sub0, [[S_MOV_B32_]], %subreg.sub1
  ; GISEL-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[S_LSHL_B64_:%[0-9]+]]:sreg_64 = S_LSHL_B64 [[REG_SEQUENCE]], [[S_MOV_B32_1]], implicit-def dead $scc
  ; GISEL-NEXT:   [[COPY3:%[0-9]+]]:sreg_32 = COPY [[COPY1]].sub0
  ; GISEL-NEXT:   [[COPY4:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_]].sub0
  ; GISEL-NEXT:   [[COPY5:%[0-9]+]]:sreg_32 = COPY [[COPY1]].sub1
  ; GISEL-NEXT:   [[COPY6:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_]].sub1
  ; GISEL-NEXT:   [[S_ADD_U32_:%[0-9]+]]:sreg_32 = S_ADD_U32 [[COPY3]], [[COPY4]], implicit-def $scc
  ; GISEL-NEXT:   [[S_ADDC_U32_:%[0-9]+]]:sreg_32 = S_ADDC_U32 [[COPY5]], [[COPY6]], implicit-def dead $scc, implicit $scc
  ; GISEL-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sreg_64_xexec = REG_SEQUENCE [[S_ADD_U32_]], %subreg.sub0, [[S_ADDC_U32_]], %subreg.sub1
  ; GISEL-NEXT:   [[S_LOAD_DWORD_IMM1:%[0-9]+]]:sreg_32_xm0_xexec = S_LOAD_DWORD_IMM [[REG_SEQUENCE1]], 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.arrayidx, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_2:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; GISEL-NEXT:   [[COPY7:%[0-9]+]]:vgpr_32 = COPY [[S_LOAD_DWORD_IMM]]
  ; GISEL-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_2]]
  ; GISEL-NEXT:   [[V_CMP_LT_I32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_LT_I32_e64 [[COPY7]], [[COPY8]], implicit $exec
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[V_CMP_LT_I32_e64_]], %bb.5
  ; GISEL-NEXT:   S_BRANCH %bb.3
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.3.NodeBlock:
  ; GISEL-NEXT:   successors: %bb.7(0x40000000), %bb.4(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[S_LOAD_DWORD_IMM]]
  ; GISEL-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_3]]
  ; GISEL-NEXT:   [[V_CMP_LT_I32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_LT_I32_e64 [[COPY9]], [[COPY10]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_4:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[V_CMP_LT_I32_e64_1]], %bb.7
  ; GISEL-NEXT:   S_BRANCH %bb.4
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.4.LeafBlock4:
  ; GISEL-NEXT:   successors: %bb.8(0x40000000), %bb.9(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_5:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY [[S_LOAD_DWORD_IMM]]
  ; GISEL-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_5]]
  ; GISEL-NEXT:   [[V_CMP_EQ_U32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_EQ_U32_e64 [[COPY11]], [[COPY12]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_6:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[V_CMP_EQ_U32_e64_]], %bb.8
  ; GISEL-NEXT:   S_BRANCH %bb.9
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.5.LeafBlock:
  ; GISEL-NEXT:   successors: %bb.6(0x30000000), %bb.9(0x50000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_7:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_LOAD_DWORD_IMM]]
  ; GISEL-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_7]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[COPY13]], [[COPY14]], implicit $exec
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[V_CMP_NE_U32_e64_]], %bb.9
  ; GISEL-NEXT:   S_BRANCH %bb.6
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.6.sw.bb:
  ; GISEL-NEXT:   successors: %bb.7(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_8:%[0-9]+]]:sreg_32 = S_MOV_B32 3
  ; GISEL-NEXT:   S_CMP_GT_I32 [[S_LOAD_DWORD_IMM1]], [[S_MOV_B32_8]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY15:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.7.sw.bb4:
  ; GISEL-NEXT:   successors: %bb.8(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:sreg_32 = PHI [[S_MOV_B32_4]], %bb.3, [[COPY15]], %bb.6
  ; GISEL-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 5
  ; GISEL-NEXT:   S_CMP_GT_I32 [[S_LOAD_DWORD_IMM1]], [[S_MOV_B32_9]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY16:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT:   [[S_OR_B32_:%[0-9]+]]:sreg_32 = S_OR_B32 [[COPY16]], [[PHI]], implicit-def dead $scc
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.8.sw.bb12:
  ; GISEL-NEXT:   successors: %bb.10(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI1:%[0-9]+]]:sreg_32 = PHI [[S_MOV_B32_6]], %bb.4, [[S_OR_B32_]], %bb.7
  ; GISEL-NEXT:   [[S_MOV_B32_10:%[0-9]+]]:sreg_32 = S_MOV_B32 7
  ; GISEL-NEXT:   S_CMP_GT_I32 [[S_LOAD_DWORD_IMM1]], [[S_MOV_B32_10]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY17:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT:   [[S_OR_B32_1:%[0-9]+]]:sreg_32 = S_OR_B32 [[COPY17]], [[PHI1]], implicit-def dead $scc
  ; GISEL-NEXT:   S_BRANCH %bb.10
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.9.sw.default:
  ; GISEL-NEXT:   successors: %bb.10(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[S_MOV_B32_11:%[0-9]+]]:sreg_32 = S_MOV_B32 11
  ; GISEL-NEXT:   S_CMP_GT_I32 [[S_LOAD_DWORD_IMM1]], [[S_MOV_B32_11]], implicit-def $scc
  ; GISEL-NEXT:   [[COPY18:%[0-9]+]]:sreg_32 = COPY $scc
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.10.sw.epilog:
  ; GISEL-NEXT:   successors: %bb.11(0x40000000), %bb.12(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:sreg_32 = PHI [[COPY18]], %bb.9, [[S_OR_B32_1]], %bb.8
  ; GISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 1, [[PHI2]], implicit-def dead $scc
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 0, [[S_AND_B32_]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_12:%[0-9]+]]:sreg_32_xm0_xexec = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_XOR_B32_:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[V_CMP_NE_U32_e64_1]], [[S_MOV_B32_12]], implicit-def dead $scc
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM [[S_XOR_B32_]], %bb.12
  ; GISEL-NEXT:   S_BRANCH %bb.11
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.11.if.then:
  ...
  ; GISEL-NEXT:   [[S_LSHL_B64_1:%[0-9]+]]:sreg_64 = S_LSHL_B64 [[REG_SEQUENCE]], [[S_MOV_B32_13]], implicit-def dead $scc
  ; GISEL-NEXT:   [[COPY21:%[0-9]+]]:sreg_32 = COPY [[COPY20]].sub0
  ; GISEL-NEXT:   [[COPY22:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub0
  ; GISEL-NEXT:   [[COPY23:%[0-9]+]]:sreg_32 = COPY [[COPY20]].sub1
  ; GISEL-NEXT:   [[COPY24:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub1
  ; GISEL-NEXT:   [[S_ADD_U32_1:%[0-9]+]]:sreg_32 = S_ADD_U32 [[COPY21]], [[COPY22]], implicit-def $scc
  ; GISEL-NEXT:   [[S_ADDC_U32_1:%[0-9]+]]:sreg_32 = S_ADDC_U32 [[COPY23]], [[COPY24]], implicit-def dead $scc, implicit $scc
  ; GISEL-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sreg_64_xexec_xnull = REG_SEQUENCE [[S_ADD_U32_1]], %subreg.sub0, [[S_ADDC_U32_1]], %subreg.sub1
  ; GISEL-NEXT:   [[COPY25:%[0-9]+]]:vgpr_32 = COPY [[S_LOAD_DWORD_IMM1]]
  ; GISEL-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 0, implicit $exec
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD_SADDR [[V_MOV_B32_e32_]], [[COPY25]], [[REG_SEQUENCE2]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx29, addrspace 1)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.12.if.end:
