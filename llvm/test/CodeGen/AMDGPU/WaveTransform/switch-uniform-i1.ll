...
define amdgpu_kernel void @switch_uniform_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce, i32 %id) {
  ...
  ; GFX940-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sreg_64 = REG_SEQUENCE [[S_ADD_U32_]], %subreg.sub0, [[S_ADDC_U32_]], %subreg.sub1
  ; GFX940-NEXT:   [[S_LOAD_DWORD_IMM1:%[0-9]+]]:sreg_32_xm0_xexec = S_LOAD_DWORD_IMM killed [[REG_SEQUENCE2]], 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.arrayidx, addrspace 1)
  ; GFX940-NEXT:   [[COPY9:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORD_IMM1]]
  ...
  ; GFX940-NEXT:   [[COPY10:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_]]
  ...
  ; GFX940-NEXT:   [[COPY11:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_1]]
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY11]], %bb.6
  ...
  ; GFX940-NEXT:   [[COPY12:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_2]]
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY12]], %bb.7
  ...
  ; GFX940-NEXT:   [[COPY13:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_3]]
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY13]], %bb.8
  ...
  ; GFX940-NEXT:   S_CMP_GT_I32 [[COPY9]], killed [[S_MOV_B32_6]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_4:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY14:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_4]]
  ; GFX940-NEXT:   [[COPY15:%[0-9]+]]:sreg_64 = COPY [[COPY14]]
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.6.sw.bb4:
  ; GFX940-NEXT:   successors: %bb.7(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI:%[0-9]+]]:sreg_64 = PHI [[S_MOV_B64_]], %bb.2, [[COPY15]], %bb.5
  ; GFX940-NEXT:   [[S_MOV_B32_7:%[0-9]+]]:sreg_32 = S_MOV_B32 5
  ; GFX940-NEXT:   S_CMP_GT_I32 [[COPY9]], killed [[S_MOV_B32_7]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_5:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY16:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_5]]
  ; GFX940-NEXT:   [[S_OR_B64_:%[0-9]+]]:sreg_64 = S_OR_B64 killed [[COPY16]], [[PHI]], implicit-def dead $scc
  ; GFX940-NEXT: {{  $}}
  ...
  ; GFX940-NEXT:   S_CMP_GT_I32 [[COPY9]], killed [[S_MOV_B32_8]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_6:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY17:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_6]]
  ; GFX940-NEXT:   [[S_OR_B64_1:%[0-9]+]]:sreg_64 = S_OR_B64 killed [[COPY17]], [[PHI1]], implicit-def dead $scc
  ...
  ; GFX940-NEXT:   S_CMP_GT_I32 [[COPY9]], killed [[S_MOV_B32_9]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_7:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY18:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_7]]
  ; GFX940-NEXT:   [[COPY19:%[0-9]+]]:sreg_64 = COPY [[COPY18]]
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.9.sw.epilog:
  ; GFX940-NEXT:   successors: %bb.10(0x40000000), %bb.11(0x40000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI2:%[0-9]+]]:sreg_64_xexec = PHI [[COPY19]], %bb.8, [[S_OR_B64_1]], %bb.7
  ...
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[COPY20:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub3
  ; GFX940-NEXT:   [[COPY21:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub2
  ; GFX940-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY21]], %subreg.sub0, killed [[COPY20]], %subreg.sub1
  ...
  ; GFX940-NEXT:   [[COPY22:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE3]].sub0
  ; GFX940-NEXT:   [[COPY23:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE3]].sub1
  ; GFX940-NEXT:   [[COPY24:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub0
  ; GFX940-NEXT:   [[COPY25:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub1
  ; GFX940-NEXT:   [[S_ADD_U32_1:%[0-9]+]]:sreg_32 = S_ADD_U32 [[COPY22]], [[COPY24]], implicit-def $scc
  ; GFX940-NEXT:   [[S_ADDC_U32_1:%[0-9]+]]:sreg_32 = S_ADDC_U32 [[COPY23]], [[COPY25]], implicit-def $scc, implicit $scc
  ...
  ; GFX940-NEXT:   [[COPY26:%[0-9]+]]:vgpr_32 = COPY [[COPY9]]
  ; GFX940-NEXT:   GLOBAL_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_]], [[COPY26]], killed [[REG_SEQUENCE4]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx29, addrspace 1)
  ; GFX940-NEXT: {{  $}}
  ...
  ; GFX1200-NEXT:   SI_BRCOND_UNIFORM killed [[COPY6]], %bb.4
  ...
  ; GFX1200-NEXT:   SI_BRCOND_UNIFORM killed [[COPY7]], %bb.6
  ...
  ; GFX1200-NEXT:   SI_BRCOND_UNIFORM killed [[COPY8]], %bb.7
  ...
  ; GFX1200-NEXT:   SI_BRCOND_UNIFORM killed [[COPY9]], %bb.8
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM killed [[COPY6]], %bb.4
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM killed [[COPY7]], %bb.6
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM killed [[COPY8]], %bb.7
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM killed [[COPY9]], %bb.8
