...
define amdgpu_kernel void @switch_uniform_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce, i32 %id) {
  ; GFX940-LABEL: name: switch_uniform_i1
  ; GFX940: bb.0.entry:
  ; GFX940-NEXT:   successors: %bb.1(0x80000000)
  ; GFX940-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[COPY:%[0-9]+]]:sgpr_64(p4) = COPY $sgpr4_sgpr5
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.1.NodeBlock6:
  ; GFX940-NEXT:   successors: %bb.4(0x30000000), %bb.2(0x50000000)
  ; GFX940-NEXT: {{  $}}
  ...
  ; GFX940-NEXT:   [[S_LOAD_DWORD_IMM:%[0-9]+]]:sreg_32_xm0_xexec = S_LOAD_DWORD_IMM [[COPY]](p4), 16, 0 :: (dereferenceable invariant load (s32) from %ir.id.kernarg.offset, align 16, addrspace 4)
  ; GFX940-NEXT:   [[COPY1:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub1
  ; GFX940-NEXT:   [[COPY2:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub0
  ; GFX940-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY2]], %subreg.sub0, killed [[COPY1]], %subreg.sub1
  ; GFX940-NEXT:   [[COPY3:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORD_IMM]]
  ; GFX940-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GFX940-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sreg_64_xexec = REG_SEQUENCE [[S_LOAD_DWORD_IMM]], %subreg.sub0, killed [[S_MOV_B32_]], %subreg.sub1
  ; GFX940-NEXT:   [[COPY4:%[0-9]+]]:sreg_64 = COPY [[REG_SEQUENCE1]]
  ; GFX940-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GFX940-NEXT:   [[S_LSHL_B64_:%[0-9]+]]:sreg_64 = nuw nsw S_LSHL_B64 [[REG_SEQUENCE1]], killed [[S_MOV_B32_1]], implicit-def dead $scc
  ; GFX940-NEXT:   [[COPY5:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub0
  ; GFX940-NEXT:   [[COPY6:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE]].sub1
  ; GFX940-NEXT:   [[COPY7:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_]].sub0
  ; GFX940-NEXT:   [[COPY8:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_]].sub1
  ...
  ; GFX940-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sreg_64_xexec_xnull = REG_SEQUENCE [[S_ADD_U32_]], %subreg.sub0, [[S_ADDC_U32_]], %subreg.sub1
  ; GFX940-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 0, implicit $exec
  ; GFX940-NEXT:   [[GLOBAL_LOAD_DWORD_SADDR:%[0-9]+]]:vgpr_32 = GLOBAL_LOAD_DWORD_SADDR killed [[REG_SEQUENCE2]], killed [[V_MOV_B32_e32_]], 0, 0, implicit $exec :: (load (s32) from %ir.arrayidx, addrspace 1)
  ; GFX940-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32 = V_READFIRSTLANE_B32 [[GLOBAL_LOAD_DWORD_SADDR]], implicit $exec
  ; GFX940-NEXT:   [[S_MOV_B32_2:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; GFX940-NEXT:   S_CMP_LT_I32 [[S_LOAD_DWORD_IMM]], killed [[S_MOV_B32_2]], implicit-def $scc
  ...
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY9]], %bb.4
  ; GFX940-NEXT:   S_BRANCH %bb.2
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.2.NodeBlock:
  ; GFX940-NEXT:   successors: %bb.6(0x40000000), %bb.3(0x40000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[S_MOV_B64_:%[0-9]+]]:sreg_64 = S_MOV_B64 0
  ; GFX940-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GFX940-NEXT:   S_CMP_LT_I32 [[COPY3]], killed [[S_MOV_B32_3]], implicit-def $scc
  ...
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY10]], %bb.6
  ; GFX940-NEXT:   S_BRANCH %bb.3
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.3.LeafBlock4:
  ; GFX940-NEXT:   successors: %bb.7(0x40000000), %bb.8(0x40000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[S_MOV_B64_1:%[0-9]+]]:sreg_64 = S_MOV_B64 0
  ; GFX940-NEXT:   [[S_MOV_B32_4:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GFX940-NEXT:   S_CMP_EQ_U32 [[COPY3]], killed [[S_MOV_B32_4]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_2:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY11:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_2]]
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY11]], %bb.7
  ; GFX940-NEXT:   S_BRANCH %bb.8
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.4.LeafBlock:
  ; GFX940-NEXT:   successors: %bb.5(0x30000000), %bb.8(0x50000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[S_MOV_B32_5:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GFX940-NEXT:   S_CMP_LG_U32 [[COPY3]], killed [[S_MOV_B32_5]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_3:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY12:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_3]]
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[COPY12]], %bb.8
  ; GFX940-NEXT:   S_BRANCH %bb.5
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.5.sw.bb:
  ; GFX940-NEXT:   successors: %bb.6(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[S_MOV_B32_6:%[0-9]+]]:sreg_32 = S_MOV_B32 3
  ; GFX940-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_6]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_4:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY13:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_4]]
  ; GFX940-NEXT:   [[COPY14:%[0-9]+]]:sreg_64 = COPY [[COPY13]]
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.6.sw.bb4:
  ; GFX940-NEXT:   successors: %bb.7(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI:%[0-9]+]]:sreg_64 = PHI [[S_MOV_B64_]], %bb.2, [[COPY14]], %bb.5
  ; GFX940-NEXT:   [[S_MOV_B32_7:%[0-9]+]]:sreg_32 = S_MOV_B32 5
  ; GFX940-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_7]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_5:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY15:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_5]]
  ; GFX940-NEXT:   [[S_OR_B64_:%[0-9]+]]:sreg_64 = S_OR_B64 killed [[COPY15]], [[PHI]], implicit-def dead $scc
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.7.sw.bb12:
  ; GFX940-NEXT:   successors: %bb.9(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI1:%[0-9]+]]:sreg_64 = PHI [[S_MOV_B64_1]], %bb.3, [[S_OR_B64_]], %bb.6
  ; GFX940-NEXT:   [[S_MOV_B32_8:%[0-9]+]]:sreg_32 = S_MOV_B32 7
  ; GFX940-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_8]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_6:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY16:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_6]]
  ; GFX940-NEXT:   [[S_OR_B64_1:%[0-9]+]]:sreg_64 = S_OR_B64 killed [[COPY16]], [[PHI1]], implicit-def dead $scc
  ; GFX940-NEXT:   S_BRANCH %bb.9
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.8.sw.default:
  ; GFX940-NEXT:   successors: %bb.9(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 11
  ; GFX940-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_9]], implicit-def $scc
  ; GFX940-NEXT:   [[S_CSELECT_B64_7:%[0-9]+]]:sreg_64_xexec = S_CSELECT_B64 -1, 0, implicit $scc
  ; GFX940-NEXT:   [[COPY17:%[0-9]+]]:sreg_64 = COPY [[S_CSELECT_B64_7]]
  ; GFX940-NEXT:   [[COPY18:%[0-9]+]]:sreg_64 = COPY [[COPY17]]
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.9.sw.epilog:
  ; GFX940-NEXT:   successors: %bb.10(0x40000000), %bb.11(0x40000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[PHI2:%[0-9]+]]:sreg_64_xexec = PHI [[COPY18]], %bb.8, [[S_OR_B64_1]], %bb.7
  ; GFX940-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, 0, 0, 1, [[PHI2]], implicit $exec
  ; GFX940-NEXT:   [[S_MOV_B32_10:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; GFX940-NEXT:   [[DEF:%[0-9]+]]:sreg_32 = IMPLICIT_DEF
  ; GFX940-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_64_xexec = V_CMP_NE_U32_e64 [[V_CNDMASK_B32_e64_]], killed [[S_MOV_B32_10]], implicit $exec
  ; GFX940-NEXT:   SI_BRCOND_UNIFORM killed [[V_CMP_NE_U32_e64_]], %bb.11
  ; GFX940-NEXT:   S_BRANCH %bb.10
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.10.if.then:
  ; GFX940-NEXT:   successors: %bb.11(0x80000000)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT:   [[COPY19:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub3
  ; GFX940-NEXT:   [[COPY20:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub2
  ; GFX940-NEXT:   [[REG_SEQUENCE3:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY20]], %subreg.sub0, killed [[COPY19]], %subreg.sub1
  ; GFX940-NEXT:   [[S_MOV_B32_11:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GFX940-NEXT:   [[S_LSHL_B64_1:%[0-9]+]]:sreg_64 = nuw nsw S_LSHL_B64 [[COPY4]], killed [[S_MOV_B32_11]], implicit-def dead $scc
  ; GFX940-NEXT:   [[COPY21:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE3]].sub0
  ; GFX940-NEXT:   [[COPY22:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE3]].sub1
  ; GFX940-NEXT:   [[COPY23:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub0
  ; GFX940-NEXT:   [[COPY24:%[0-9]+]]:sreg_32 = COPY [[S_LSHL_B64_1]].sub1
  ; GFX940-NEXT:   [[S_ADD_U32_1:%[0-9]+]]:sreg_32 = S_ADD_U32 [[COPY21]], [[COPY23]], implicit-def $scc
  ; GFX940-NEXT:   [[S_ADDC_U32_1:%[0-9]+]]:sreg_32 = S_ADDC_U32 [[COPY22]], [[COPY24]], implicit-def $scc, implicit $scc
  ; GFX940-NEXT:   [[REG_SEQUENCE4:%[0-9]+]]:sreg_64_xexec_xnull = REG_SEQUENCE [[S_ADD_U32_1]], %subreg.sub0, [[S_ADDC_U32_1]], %subreg.sub1
  ; GFX940-NEXT:   [[V_MOV_B32_e32_1:%[0-9]+]]:vgpr_32 = V_MOV_B32_e32 0, implicit $exec
  ; GFX940-NEXT:   [[COPY25:%[0-9]+]]:vgpr_32 = COPY [[V_READFIRSTLANE_B32_]]
  ; GFX940-NEXT:   GLOBAL_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_1]], [[COPY25]], killed [[REG_SEQUENCE4]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx29, addrspace 1)
  ; GFX940-NEXT: {{  $}}
  ; GFX940-NEXT: bb.11.if.end:
  ...
  ; GFX1200-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32 = V_READFIRSTLANE_B32 [[GLOBAL_LOAD_DWORD_SADDR]], implicit $exec
  ...
  ; GFX1200-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_8]], implicit-def $scc
  ; GFX1200-NEXT:   [[S_CSELECT_B32_4:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GFX1200-NEXT:   [[COPY9:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_4]]
  ; GFX1200-NEXT:   [[COPY10:%[0-9]+]]:sreg_32 = COPY [[COPY9]]
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT: bb.6.sw.bb4:
  ; GFX1200-NEXT:   successors: %bb.7(0x80000000)
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT:   [[PHI:%[0-9]+]]:sreg_32 = PHI [[S_MOV_B32_3]], %bb.2, [[COPY10]], %bb.5
  ; GFX1200-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 5
  ; GFX1200-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_9]], implicit-def $scc
  ; GFX1200-NEXT:   [[S_CSELECT_B32_5:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GFX1200-NEXT:   [[COPY11:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_5]]
  ; GFX1200-NEXT:   [[S_OR_B32_:%[0-9]+]]:sreg_32 = S_OR_B32 killed [[COPY11]], [[PHI]], implicit-def dead $scc
  ; GFX1200-NEXT: {{  $}}
  ...
  ; GFX1200-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_10]], implicit-def $scc
  ; GFX1200-NEXT:   [[S_CSELECT_B32_6:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GFX1200-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_6]]
  ; GFX1200-NEXT:   [[S_OR_B32_1:%[0-9]+]]:sreg_32 = S_OR_B32 killed [[COPY12]], [[PHI1]], implicit-def dead $scc
  ...
  ; GFX1200-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_11]], implicit-def $scc
  ; GFX1200-NEXT:   [[S_CSELECT_B32_7:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GFX1200-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_7]]
  ; GFX1200-NEXT:   [[COPY14:%[0-9]+]]:sreg_32 = COPY [[COPY13]]
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT: bb.9.sw.epilog:
  ; GFX1200-NEXT:   successors: %bb.10(0x40000000), %bb.11(0x40000000)
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT:   [[PHI2:%[0-9]+]]:sreg_32_xm0_xexec = PHI [[COPY14]], %bb.8, [[S_OR_B32_1]], %bb.7
  ...
  ; GFX1200-NEXT: {{  $}}
  ; GFX1200-NEXT:   [[COPY15:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub3
  ; GFX1200-NEXT:   [[COPY16:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub2
  ; GFX1200-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY16]], %subreg.sub0, killed [[COPY15]], %subreg.sub1
  ...
  ; GFX1200-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[V_READFIRSTLANE_B32_]]
  ; GFX1200-NEXT:   GLOBAL_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_1]], [[COPY17]], killed [[S_ADD_U64_1]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx29, addrspace 1)
  ; GFX1200-NEXT: {{  $}}
  ...
  ; GISEL-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32 = V_READFIRSTLANE_B32 [[GLOBAL_LOAD_DWORD_SADDR]], implicit $exec
  ...
  ; GISEL-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_8]], implicit-def $scc
  ; GISEL-NEXT:   [[S_CSELECT_B32_4:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GISEL-NEXT:   [[COPY9:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_4]]
  ; GISEL-NEXT:   [[COPY10:%[0-9]+]]:sreg_32 = COPY [[COPY9]]
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.6.sw.bb4:
  ; GISEL-NEXT:   successors: %bb.7(0x80000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:sreg_32 = PHI [[S_MOV_B32_3]], %bb.2, [[COPY10]], %bb.5
  ; GISEL-NEXT:   [[S_MOV_B32_9:%[0-9]+]]:sreg_32 = S_MOV_B32 5
  ; GISEL-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_9]], implicit-def $scc
  ; GISEL-NEXT:   [[S_CSELECT_B32_5:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GISEL-NEXT:   [[COPY11:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_5]]
  ; GISEL-NEXT:   [[S_OR_B32_:%[0-9]+]]:sreg_32 = S_OR_B32 killed [[COPY11]], [[PHI]], implicit-def dead $scc
  ; GISEL-NEXT: {{  $}}
  ...
  ; GISEL-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_10]], implicit-def $scc
  ; GISEL-NEXT:   [[S_CSELECT_B32_6:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GISEL-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_6]]
  ; GISEL-NEXT:   [[S_OR_B32_1:%[0-9]+]]:sreg_32 = S_OR_B32 killed [[COPY12]], [[PHI1]], implicit-def dead $scc
  ...
  ; GISEL-NEXT:   S_CMP_GT_I32 [[V_READFIRSTLANE_B32_]], killed [[S_MOV_B32_11]], implicit-def $scc
  ; GISEL-NEXT:   [[S_CSELECT_B32_7:%[0-9]+]]:sreg_32_xm0_xexec = S_CSELECT_B32 -1, 0, implicit $scc
  ; GISEL-NEXT:   [[COPY13:%[0-9]+]]:sreg_32 = COPY [[S_CSELECT_B32_7]]
  ; GISEL-NEXT:   [[COPY14:%[0-9]+]]:sreg_32 = COPY [[COPY13]]
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.9.sw.epilog:
  ; GISEL-NEXT:   successors: %bb.10(0x40000000), %bb.11(0x40000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:sreg_32_xm0_xexec = PHI [[COPY14]], %bb.8, [[S_OR_B32_1]], %bb.7
  ...
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[COPY15:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub3
  ; GISEL-NEXT:   [[COPY16:%[0-9]+]]:sreg_32 = COPY [[S_LOAD_DWORDX4_IMM]].sub2
  ; GISEL-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY16]], %subreg.sub0, killed [[COPY15]], %subreg.sub1
  ...
  ; GISEL-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[V_READFIRSTLANE_B32_]]
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_1]], [[COPY17]], killed [[S_ADD_U64_1]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx29, addrspace 1)
  ; GISEL-NEXT: {{  $}}
