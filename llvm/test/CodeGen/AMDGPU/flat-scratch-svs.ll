...
; GFX11-NEXT:    scratch_store_b8 v0, v1, s0 offset:1 dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    scratch_store_b8 v0, v2, s0 offset:2 dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    scratch_store_b8 v0, v3, s0 offset:4 dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX940-NEXT:    s_endpgm
;
; GFX11-LABEL: soff1_voff2:
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX11-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_mov_b32 v2, 2
; GFX11-NEXT:    v_mul_u32_u24_e32 v0, 2, v0
; GFX11-NEXT:    v_mov_b32_e32 v3, 4
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_add_i32 s0, s0, 4
; GFX11-NEXT:    scratch_store_b8 v0, v1, s0 offset:1 dlc
...
; GFX940-NEXT:    s_endpgm
;
; GFX11-LABEL: soff1_voff4:
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX11-NEXT:    v_dual_mov_b32 v1, 1 :: v_dual_mov_b32 v2, 2
; GFX11-NEXT:    v_mul_u32_u24_e32 v0, 4, v0
; GFX11-NEXT:    v_mov_b32_e32 v3, 4
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_add_i32 s0, s0, 4
; GFX11-NEXT:    scratch_store_b8 v0, v1, s0 offset:1 dlc
