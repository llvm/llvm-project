...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[6:13], v[14:21], v[0:3], v4, v5 op_sel:[1,1,0] op_sel_hi:[1,0,0] blgp:2
...
; SDAG-NEXT:    v_mov_b32_e32 v4, -2
; SDAG-NEXT:    v_mov_b32_e32 v5, 0x41
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 v[0:3], v[6:13], v[14:21], v[0:3], v5, v4 op_sel:[1,1,0] op_sel_hi:[1,0,0]
; SDAG-NEXT:    v_mov_b32_e32 v4, 0
; SDAG-NEXT:    s_nop 10
...
; SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x0
; SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x40
; SDAG-NEXT:    v_mov_b32_e32 v4, 0.15915494
; SDAG-NEXT:    v_mov_b32_e32 v5, 1.0
; SDAG-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x50
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v6, s8
