...
; SDAG-NEXT:    s_load_dwordx8 s[0:7], s[2:3], 0x64
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], s4, v17 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 2
...
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[2:3], 0x64
...
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], s24, v16 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
...
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x24
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x74
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b32_e32 v0, s4
; SDAG-NEXT:    v_mov_b32_e32 v1, s5
; SDAG-NEXT:    v_mov_b32_e32 v2, s6
; SDAG-NEXT:    v_mov_b32_e32 v3, s7
; SDAG-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x64
; SDAG-NEXT:    v_mov_b32_e32 v4, s8
; SDAG-NEXT:    v_mov_b32_e32 v5, s9
; SDAG-NEXT:    v_mov_b32_e32 v6, s10
; SDAG-NEXT:    v_mov_b32_e32 v7, s11
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], s2, -2 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 2
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x24
; GISEL-NEXT:    s_load_dwordx4 s[20:23], s[2:3], 0x64
; GISEL-NEXT:    v_mov_b32_e32 v16, 0x41
; GISEL-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x74
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
...
; GISEL-NEXT:    v_accvgpr_write_b32 a3, s23
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[0:7], v[8:15], a[0:3], v16, -2 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
; GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 1
