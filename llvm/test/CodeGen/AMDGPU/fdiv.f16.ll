...
; SI-NEXT:    buffer_load_ushort v2, v[10:11], s[4:7], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_ushort v3, v[10:11], s[8:11], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    buffer_store_short v2, v[10:11], s[0:3], 0 addr64
; SI-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, s4, v4
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ushort v1, v6, s[2:3] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_load_ushort v2, v6, s[6:7] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_lshlrev_b32_e32 v8, 1, v0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_ushort v1, v8, s[2:3] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    global_load_ushort v2, v8, s[6:7] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    global_load_d16_b16 v2, v6, s[2:3] glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    global_load_d16_b16 v3, v6, s[4:5] glc dlc
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    global_load_u16 v1, v6, s[2:3] glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    global_load_u16 v2, v6, s[4:5] glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    flat_load_ushort v0, v[4:5] glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    s_mov_b64 s[10:11], s[6:7]
; SI-NEXT:    buffer_load_ushort v2, v[4:5], s[4:7], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_ushort v3, v[4:5], s[8:11], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; SI-NEXT:    v_cvt_f32_f16_e32 v3, v3
...
; SI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; SI-NEXT:    buffer_store_short v2, v[4:5], s[0:3], 0 addr64
; SI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_load_ushort v2, v3, s[6:7] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_ushort v1, v3, s[2:3] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    global_load_ushort v2, v3, s[6:7] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    global_load_u16 v1, v3, s[2:3] glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    global_load_u16 v2, v3, s[4:5] glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_rcp_f16_e32 v2, v2
; GFX11-FAKE16-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-FAKE16-NEXT:    s_endpgm
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
