...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    buffer_load_u16 v8, v4, s[4:7], 0 offen offset:1024
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    buffer_load_u16 v6, v4, s[4:7], 0 offen offset:1026
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[6:7], v4, s[4:7], 0 offen offset:1024 glc
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-FAKE16-NEXT:    buffer_load_u16 v6, v4, s[4:7], 0 offen offset:1024
; GFX11-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-FAKE16-NEXT:    buffer_load_u16 v7, v4, s[4:7], 0 offen offset:1026
; GFX11-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    buffer_atomic_cmpswap_b32 v[6:7], v4, s[4:7], 0 offen offset:1024 glc
; GFX11-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    buffer_load_u16 v7, v4, s[4:7], 0 offen offset:1024
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
