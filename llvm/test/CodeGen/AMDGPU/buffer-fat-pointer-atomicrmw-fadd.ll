...
; GFX6-NEXT:    s_andn2_b64 s[6:7], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[6:7], s[4:5]
...
; GFX10-NEXT:    ; Child Loop BB2_3 Depth 2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:  .LBB2_3: ; Parent Loop BB2_2 Depth=1
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB2_3
; GFX10-NEXT:  ; %bb.4: ; in Loop: Header=BB2_2 Depth=1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB2_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB2_3
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB2_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB2_3
...
; GFX90A-NEXT:    s_mov_b32 s8, s6
; GFX90A-NEXT:    v_mov_b32_e32 v1, s18
; GFX90A-NEXT:    buffer_load_dword v3, v1, s[8:11], 0 offen offset:1024
; GFX90A-NEXT:    s_add_i32 s6, s18, 0x400
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX908-NEXT:    s_mov_b32 s8, s6
; GFX908-NEXT:    v_mov_b32_e32 v1, s18
; GFX908-NEXT:    buffer_load_dword v2, v1, s[8:11], 0 offen offset:1024
; GFX908-NEXT:    s_add_i32 s6, s18, 0x400
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
; GFX908-NEXT:    v_mov_b32_e32 v3, s6
...
; GFX12-NEXT:    s_and_not1_b32 s5, exec_lo, s4
; GFX12-NEXT:    s_cselect_b32 exec_lo, s5, s4
...
; GFX11-NEXT:  .LBB10_2: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Loop Header: Depth=1
; GFX11-NEXT:    ; Child Loop BB10_3 Depth 2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:  .LBB10_3: ; Parent Loop BB10_2 Depth=1
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX11-NEXT:    s_cbranch_scc1 .LBB10_3
; GFX11-NEXT:  ; %bb.4: ; in Loop: Header=BB10_2 Depth=1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:  .LBB10_2: ; %atomicrmw.start
; GFX10-NEXT:    ; =>This Loop Header: Depth=1
; GFX10-NEXT:    ; Child Loop BB10_3 Depth 2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:  .LBB10_3: ; Parent Loop BB10_2 Depth=1
; GFX10-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX10-NEXT:    v_readfirstlane_b32 s8, v9
; GFX10-NEXT:    v_readfirstlane_b32 s9, v10
; GFX10-NEXT:    v_readfirstlane_b32 s10, v7
...
; GFX10-NEXT:  ; %bb.4: ; in Loop: Header=BB10_2 Depth=1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s5
; GFX10-NEXT:    s_cbranch_scc1 .LBB10_2
; GFX10-NEXT:  ; %bb.5: ; %atomicrmw.end
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB10_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB10_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB10_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB10_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX7-NEXT:    s_cbranch_scc1 .LBB10_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB10_3
; GFX7-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX6-NEXT:    s_cbranch_scc1 .LBB10_4
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB10_3
; GFX6-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr double, ptr addrspace(7) %ptr, i32 256
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_and_or_b32 v1, v2, s5, v1
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_not1_b32 s7, exec_lo, s6
; GFX12-NEXT:    s_cselect_b32 exec_lo, s7, s6
...
; GFX940-NEXT:    s_andn2_b64 s[8:9], exec, s[4:5]
; GFX940-NEXT:    v_mov_b32_e32 v3, v4
; GFX940-NEXT:    s_cselect_b64 exec, s[8:9], s[4:5]
...
; GFX11-NEXT:    v_and_or_b32 v1, v2, s5, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_not1_b32 s7, exec_lo, s6
; GFX11-NEXT:    s_cselect_b32 exec_lo, s7, s6
...
; GFX10-NEXT:    s_andn2_b32 s7, exec_lo, s6
; GFX10-NEXT:    s_cselect_b32 exec_lo, s7, s6
...
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v3
; GFX90A-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX90A-NEXT:    s_andn2_b64 s[12:13], exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v3, v4
; GFX90A-NEXT:    s_cselect_b64 exec, s[12:13], s[4:5]
...
; GFX908-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_andn2_b64 s[12:13], exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v2, v3
; GFX908-NEXT:    s_cselect_b64 exec, s[12:13], s[4:5]
...
; GFX8-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    s_andn2_b64 s[12:13], exec, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v2, v3
; GFX8-NEXT:    s_cselect_b64 exec, s[12:13], s[4:5]
...
; GFX7-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX7-NEXT:    s_andn2_b64 s[12:13], exec, s[4:5]
; GFX7-NEXT:    v_mov_b32_e32 v1, v2
; GFX7-NEXT:    s_cselect_b64 exec, s[12:13], s[4:5]
...
; GFX6-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    s_andn2_b64 s[12:13], exec, s[4:5]
; GFX6-NEXT:    v_mov_b32_e32 v1, v2
; GFX6-NEXT:    s_cselect_b64 exec, s[12:13], s[4:5]
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX12-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    v_add_u32_e32 v6, 0x200, v4
; GFX940-NEXT:    v_and_b32_e32 v4, -4, v6
; GFX940-NEXT:    v_and_b32_e32 v6, 3, v6
; GFX940-NEXT:    v_lshlrev_b32_e32 v10, 3, v6
; GFX940-NEXT:    s_mov_b32 s0, 0xffff
; GFX940-NEXT:    v_lshlrev_b32_e64 v6, v10, s0
...
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_lshrrev_b32_e32 v6, v10, v7
; GFX940-NEXT:    v_add_f16_e32 v6, v6, v5
; GFX940-NEXT:    v_lshlrev_b32_e32 v6, v10, v6
...
; GFX940-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX940-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX940-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX940-NEXT:    v_lshrrev_b32_e32 v0, v10, v8
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    .p2align 6
; GFX11-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Loop Header: Depth=1
; GFX11-NEXT:    ; Child Loop BB15_3 Depth 2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:  .LBB15_3: ; Parent Loop BB15_2 Depth=1
; GFX11-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX11-NEXT:    v_readfirstlane_b32 s4, v0
; GFX11-NEXT:    v_readfirstlane_b32 s5, v1
; GFX11-NEXT:    v_readfirstlane_b32 s6, v2
...
; GFX11-NEXT:  ; %bb.4: ; in Loop: Header=BB15_2 Depth=1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX10-NEXT:    ; =>This Loop Header: Depth=1
; GFX10-NEXT:    ; Child Loop BB15_3 Depth 2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_mov_b32_e32 v8, v6
; GFX10-NEXT:  .LBB15_3: ; Parent Loop BB15_2 Depth=1
; GFX10-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX10-NEXT:    v_readfirstlane_b32 s8, v0
; GFX10-NEXT:    v_readfirstlane_b32 s9, v1
; GFX10-NEXT:    v_readfirstlane_b32 s10, v2
...
; GFX10-NEXT:  ; %bb.4: ; in Loop: Header=BB15_2 Depth=1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s5
; GFX10-NEXT:    s_cbranch_scc1 .LBB15_2
; GFX10-NEXT:  ; %bb.5: ; %atomicrmw.end
...
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_add_u32_e32 v6, 0x200, v4
; GFX90A-NEXT:    v_and_b32_e32 v4, -4, v6
; GFX90A-NEXT:    v_and_b32_e32 v6, 3, v6
; GFX90A-NEXT:    v_lshlrev_b32_e32 v10, 3, v6
; GFX90A-NEXT:    s_mov_b32 s4, 0xffff
; GFX90A-NEXT:    v_lshlrev_b32_e64 v6, v10, s4
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshrrev_b32_e32 v6, v10, v7
; GFX90A-NEXT:    v_add_f16_e32 v6, v6, v5
; GFX90A-NEXT:    v_lshlrev_b32_e32 v6, v10, v6
...
; GFX90A-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX90A-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v10, v8
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
; GFX908-LABEL: buffer_fat_ptr_agent_atomic_fadd_ret_f16__offset__waterfall__amdgpu_no_fine_grained_memory:
; GFX908:       ; %bb.0:
; GFX908-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_add_u32_e32 v6, 0x200, v4
; GFX908-NEXT:    v_and_b32_e32 v4, -4, v6
; GFX908-NEXT:    v_and_b32_e32 v6, 3, v6
; GFX908-NEXT:    v_lshlrev_b32_e32 v10, 3, v6
; GFX908-NEXT:    s_mov_b32 s4, 0xffff
; GFX908-NEXT:    v_lshlrev_b32_e64 v6, v10, s4
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_e32 v6, v10, v7
; GFX908-NEXT:    v_add_f16_e32 v6, v6, v5
; GFX908-NEXT:    v_lshlrev_b32_e32 v6, v10, v6
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v10, v8
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: buffer_fat_ptr_agent_atomic_fadd_ret_f16__offset__waterfall__amdgpu_no_fine_grained_memory:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 0x200, v4
; GFX8-NEXT:    v_and_b32_e32 v4, -4, v6
; GFX8-NEXT:    v_and_b32_e32 v6, 3, v6
; GFX8-NEXT:    v_lshlrev_b32_e32 v10, 3, v6
; GFX8-NEXT:    s_mov_b32 s4, 0xffff
; GFX8-NEXT:    v_lshlrev_b32_e64 v6, v10, s4
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_e32 v6, v10, v7
; GFX8-NEXT:    v_add_f16_e32 v6, v6, v5
; GFX8-NEXT:    v_lshlrev_b32_e32 v6, v10, v6
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, v10, v8
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, v8, v6
...
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX7-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX7-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    v_lshrrev_b32_e32 v4, v8, v6
...
; GFX6-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX6-NEXT:    s_cbranch_scc1 .LBB15_4
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB15_3
; GFX6-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX6-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX6-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
  %gep = getelementptr half, ptr addrspace(7) %ptr, i32 256
...
; GFX940-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX940-NEXT:    s_andn2_b64 s[10:11], exec, s[4:5]
; GFX940-NEXT:    v_mov_b32_e32 v1, v2
; GFX940-NEXT:    s_cselect_b64 exec, s[10:11], s[4:5]
...
; GFX90A-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX90A-NEXT:    s_andn2_b64 s[14:15], exec, s[4:5]
; GFX90A-NEXT:    v_mov_b32_e32 v1, v2
; GFX90A-NEXT:    s_cselect_b64 exec, s[14:15], s[4:5]
...
; GFX908-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_andn2_b64 s[14:15], exec, s[4:5]
; GFX908-NEXT:    v_mov_b32_e32 v1, v2
; GFX908-NEXT:    s_cselect_b64 exec, s[14:15], s[4:5]
...
; GFX940-NEXT:    v_lshlrev_b32_e32 v9, 3, v4
; GFX940-NEXT:    s_mov_b32 s0, 0xffff
; GFX940-NEXT:    v_lshlrev_b32_e64 v4, v9, s0
...
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    v_lshrrev_b32_sdwa v4, v9, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX940-NEXT:    s_mov_b64 s[8:9], exec
...
; GFX940-NEXT:    v_lshlrev_b32_sdwa v4, v9, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX940-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX940-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX940-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX940-NEXT:    v_lshrrev_b32_e32 v0, v9, v4
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX11-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX11-NEXT:    s_and_not1_b32 s0, exec_lo, s1
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s1
; GFX11-NEXT:    s_cbranch_scc1 .LBB18_3
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s5
; GFX10-NEXT:    s_cbranch_scc1 .LBB18_3
...
; GFX90A-NEXT:    v_lshlrev_b32_e32 v9, 3, v4
; GFX90A-NEXT:    s_mov_b32 s4, 0xffff
; GFX90A-NEXT:    v_lshlrev_b32_e64 v4, v9, s4
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshrrev_b32_sdwa v4, v9, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX90A-NEXT:    v_lshlrev_b32_sdwa v4, v9, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX90A-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX90A-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX90A-NEXT:    v_lshrrev_b32_e32 v0, v9, v4
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    v_lshlrev_b32_e32 v8, 3, v4
; GFX908-NEXT:    s_mov_b32 s4, 0xffff
; GFX908-NEXT:    v_lshlrev_b32_e64 v4, v8, s4
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshrrev_b32_sdwa v4, v8, v6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX908-NEXT:    v_lshlrev_b32_sdwa v4, v8, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_lshlrev_b32_e32 v8, 3, v4
; GFX8-NEXT:    s_mov_b32 s4, 0xffff
; GFX8-NEXT:    v_lshlrev_b32_e64 v4, v8, s4
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_lshrrev_b32_sdwa v4, v8, v6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX8-NEXT:    v_lshlrev_b32_sdwa v4, v8, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX7-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX7-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX7-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX6-NEXT:    s_cbranch_scc1 .LBB18_4
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB18_3
; GFX6-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX6-NEXT:    v_lshrrev_b32_e32 v0, v8, v4
; GFX6-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v5
...
; GFX6-NEXT:    v_cvt_f32_f16_e32 v1, v6
; GFX6-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    s_andn2_b64 s[6:7], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[6:7], s[4:5]
...
; GFX11-NEXT:    .p2align 6
; GFX11-NEXT:  .LBB21_2: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Loop Header: Depth=1
; GFX11-NEXT:    ; Child Loop BB21_3 Depth 2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_mov_b32_e32 v7, v8
; GFX11-NEXT:  .LBB21_3: ; Parent Loop BB21_2 Depth=1
; GFX11-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX11-NEXT:    v_readfirstlane_b32 s4, v0
; GFX11-NEXT:    v_readfirstlane_b32 s5, v1
; GFX11-NEXT:    v_readfirstlane_b32 s6, v2
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX11-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX11-NEXT:  ; %bb.4: ; in Loop: Header=BB21_2 Depth=1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:  .LBB21_2: ; %atomicrmw.start
; GFX10-NEXT:    ; =>This Loop Header: Depth=1
; GFX10-NEXT:    ; Child Loop BB21_3 Depth 2
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_mov_b32_e32 v6, v7
; GFX10-NEXT:    v_mov_b32_e32 v7, v8
; GFX10-NEXT:  .LBB21_3: ; Parent Loop BB21_2 Depth=1
; GFX10-NEXT:    ; => This Inner Loop Header: Depth=2
; GFX10-NEXT:    v_readfirstlane_b32 s8, v0
; GFX10-NEXT:    v_readfirstlane_b32 s9, v1
; GFX10-NEXT:    v_readfirstlane_b32 s10, v2
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX10-NEXT:  ; %bb.4: ; in Loop: Header=BB21_2 Depth=1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v6, v8
; GFX10-NEXT:    v_mov_b32_e32 v8, v6
; GFX10-NEXT:    buffer_gl1_inv
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s5
; GFX10-NEXT:    s_cbranch_scc1 .LBB21_2
; GFX10-NEXT:  ; %bb.5: ; %atomicrmw.end
; GFX10-NEXT:    v_mov_b32_e32 v0, v6
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    v_mov_b32_e32 v0, v6
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    v_mov_b32_e32 v0, v6
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX7-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX7-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX7-NEXT:    v_mov_b32_e32 v0, v4
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX6-NEXT:    s_cbranch_scc1 .LBB21_4
...
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB21_3
; GFX6-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX6-NEXT:    v_mov_b32_e32 v0, v4
; GFX6-NEXT:    v_mov_b32_e32 v1, v5
; GFX6-NEXT:    s_setpc_b64 s[30:31]
...
; GFX940-NEXT:    s_andn2_b64 s[4:5], exec, s[6:7]
; GFX940-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_not1_b32 s4, exec_lo, s5
...
; GFX940-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX940-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX940-NEXT:    buffer_inv sc1
; GFX940-NEXT:    s_cselect_b64 exec, s[0:1], s[2:3]
; GFX940-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX940-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s2
; GFX11-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX11-NEXT:    s_and_not1_b32 s0, exec_lo, s1
; GFX11-NEXT:    s_cselect_b32 exec_lo, s0, s1
; GFX11-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX11-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s6
; GFX10-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_cselect_b32 exec_lo, s4, s5
; GFX10-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX10-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX10-NEXT:    v_mov_b32_e32 v0, v4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX90A-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX90A-NEXT:  ; %bb.6: ; %atomicrmw.end
...
; GFX908-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX908-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX908-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX908-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX908-NEXT:    v_mov_b32_e32 v0, v4
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX8-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX8-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX8-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX8-NEXT:    v_mov_b32_e32 v0, v4
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX7-NEXT:    v_alignbit_b32 v7, v4, v5, 16
; GFX7-NEXT:    v_mov_b32_e32 v5, v6
; GFX7-NEXT:    s_mov_b64 s[12:13], exec
; GFX7-NEXT:    v_mov_b32_e32 v6, v7
...
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_atomic_cmpswap v[5:6], v8, s[8:11], 0 offen glc
; GFX7-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX7-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX7-NEXT:    v_mov_b32_e32 v0, v7
; GFX7-NEXT:    v_mov_b32_e32 v1, v4
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    v_alignbit_b32 v6, v7, v6, 16
; GFX6-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX6-NEXT:    v_alignbit_b32 v7, v4, v5, 16
; GFX6-NEXT:    v_mov_b32_e32 v5, v6
; GFX6-NEXT:    s_mov_b64 s[12:13], exec
; GFX6-NEXT:    v_mov_b32_e32 v6, v7
...
; GFX6-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    buffer_atomic_cmpswap v[5:6], v8, s[8:11], 0 offen glc
; GFX6-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[12:13]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_4
...
; GFX6-NEXT:    s_andn2_b64 s[4:5], exec, s[6:7]
; GFX6-NEXT:    v_lshlrev_b32_e32 v7, 16, v5
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    s_cselect_b64 exec, s[4:5], s[6:7]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_3
; GFX6-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX6-NEXT:    v_mov_b32_e32 v0, v7
; GFX6-NEXT:    v_mov_b32_e32 v1, v4
; GFX6-NEXT:    s_waitcnt expcnt(0)
