...
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_add_f32_e32 v1, v1, v2
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v2.l
...
; GFX12-TRUE16-NEXT:    v_add_f32_e32 v6, v6, v7
...
; GFX12-TRUE16-NEXT:    s_wait_alu 0xfffd
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_cndmask_b32_e32 v6, v11, v12, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_add_f32_e32 v6, v6, v7
