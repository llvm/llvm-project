...
; GFX6-NEXT:    s_not_b32 s7, s4
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
; GFX6-NEXT:    v_lshlrev_b32_e32 v5, 16, v0
...
; GFX6-NEXT:    s_not_b32 s7, s4
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
; GFX6-NEXT:    v_lshlrev_b32_e32 v3, 16, v0
...
; GFX7-NEXT:    s_mov_b64 exec, s[6:7]
; GFX7-NEXT:    s_mov_b64 s[6:7], 0
; GFX7-NEXT:    v_lshlrev_b32_e32 v10, 16, v5
...
; GFX6-NEXT:    s_mov_b64 exec, s[6:7]
; GFX6-NEXT:    s_mov_b64 s[6:7], 0
; GFX6-NEXT:    v_lshlrev_b32_e32 v10, 16, v5
...
; GFX7-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX7-NEXT:    v_add_f32_e32 v7, v2, v3
; GFX7-NEXT:    v_add_f32_e32 v5, v5, v0
; GFX7-NEXT:    v_or_b32_e32 v6, v1, v2
; GFX7-NEXT:    v_lshrrev_b32_e32 v1, 16, v7
; GFX7-NEXT:    v_alignbit_b32 v5, v1, v5, 16
; GFX7-NEXT:    v_mov_b32_e32 v1, v5
; GFX7-NEXT:    v_mov_b32_e32 v2, v6
; GFX7-NEXT:    buffer_atomic_cmpswap v[1:2], v4, s[16:19], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX6-NEXT:    v_lshlrev_b32_e32 v5, 16, v1
; GFX6-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX6-NEXT:    v_add_f32_e32 v7, v2, v3
; GFX6-NEXT:    v_add_f32_e32 v5, v5, v0
; GFX6-NEXT:    v_or_b32_e32 v6, v1, v2
; GFX6-NEXT:    v_lshrrev_b32_e32 v1, 16, v7
; GFX6-NEXT:    v_alignbit_b32 v5, v1, v5, 16
; GFX6-NEXT:    v_mov_b32_e32 v1, v5
; GFX6-NEXT:    v_mov_b32_e32 v2, v6
; GFX6-NEXT:    buffer_atomic_cmpswap v[1:2], v4, s[16:19], 0 offen glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
...
; GFX7-NEXT:    v_lshlrev_b32_e32 v9, 16, v7
...
; GFX7-NEXT:    v_add_f32_e32 v10, v8, v9
; GFX7-NEXT:    v_add_f32_e32 v7, v7, v5
; GFX7-NEXT:    v_lshrrev_b32_e32 v10, 16, v10
; GFX7-NEXT:    v_and_b32_e32 v6, 0xffff, v6
; GFX7-NEXT:    v_alignbit_b32 v7, v10, v7, 16
; GFX7-NEXT:    v_or_b32_e32 v8, v6, v8
; GFX7-NEXT:    s_mov_b64 s[12:13], exec
; GFX7-NEXT:    v_mov_b32_e32 v6, v7
; GFX7-NEXT:    v_mov_b32_e32 v7, v8
...
; GFX6-NEXT:    s_mov_b64 exec, s[6:7]
; GFX6-NEXT:    s_mov_b64 s[6:7], 0
; GFX6-NEXT:    v_lshlrev_b32_e32 v9, 16, v5
; GFX6-NEXT:    v_lshlrev_b32_e32 v10, 16, v7
...
; GFX6-NEXT:    s_waitcnt expcnt(0)
; GFX6-NEXT:    v_add_f32_e32 v7, v5, v10
; GFX6-NEXT:    v_add_f32_e32 v4, v4, v9
; GFX6-NEXT:    v_lshrrev_b32_e32 v7, 16, v7
; GFX6-NEXT:    v_and_b32_e32 v6, 0xffff, v6
; GFX6-NEXT:    v_alignbit_b32 v4, v7, v4, 16
; GFX6-NEXT:    v_or_b32_e32 v5, v6, v5
; GFX6-NEXT:    s_mov_b64 s[12:13], exec
; GFX6-NEXT:    v_mov_b32_e32 v7, v5
; GFX6-NEXT:    v_mov_b32_e32 v6, v4
