...
; GFX12-NEXT:    buffer_load_b32 v1, v3, s[0:3], null offen
...
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshrrev_b32_e32 v1, s4, v5
...
; GFX12-NEXT:    s_wait_alu 0xfffe
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_and_or_b32 v4, v5, s6, v1
...
; GFX11-NEXT:    buffer_load_b32 v1, v3, s[0:3], 0 offen
...
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v6, v9, s[4:7], null offen
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX12-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX12-NEXT:    v_lshrrev_b32_e32 v0, v4, v6
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    v_and_b32_e32 v9, -4, v6
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    buffer_load_b32 v6, v9, s[4:7], 0 offen
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-NEXT:  ; %bb.6: ; %atomicrmw.end
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, v4, v6
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_f32_e32 v1, v1, v0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_f32_e32 v1, v1, v0
...
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v4, v8, s[4:7], null offen
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    buffer_load_b32 v4, v8, s[4:7], 0 offen
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-NEXT:    s_add_i32 s4, s16, 0x400
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_lshlrev_b32 v3, 16, v0
...
; GFX11-NEXT:    v_dual_add_f32 v2, v2, v0 :: v_dual_lshlrev_b32 v1, 16, v6
...
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v5, v8, s4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_perm_b32 v5, v2, v1, 0x7060302
; GFX11-NEXT:    v_dual_mov_b32 v1, v5 :: v_dual_mov_b32 v2, v6
; GFX11-NEXT:    buffer_atomic_cmpswap_b32 v[1:2], v4, s[0:3], 0 offen glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v6
; GFX11-NEXT:    s_or_b32 s5, vcc_lo, s5
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s5
