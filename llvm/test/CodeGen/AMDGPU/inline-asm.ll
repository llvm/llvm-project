...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; first comment ; second comment
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; comment
; CHECK-NEXT:    v_nop_e64 ; inline comment
; CHECK-NEXT:  ; separate comment
; CHECK-NEXT:    v_nop_e64
; CHECK-EMPTY:
; CHECK-NEXT:    ; trailing comment
; CHECK-NEXT:    ; extra comment
; CHECK-EMPTY:
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; comment
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v1, v2 ; inline comment
; CHECK-NEXT:  ; separate comment
...
; CHECK-LABEL: i64_imm_input_phys_vgpr:
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    v_mov_b32_e32 v0, 0x1e240
...
; CHECK-NEXT:    s_mov_b32 s3, 0xf000
; CHECK-NEXT:    s_mov_b32 s2, -1
; CHECK-NEXT:    buffer_load_ubyte v0, off, s[0:3], 0 glc
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_load_ubyte v1, off, s[0:3], 0 glc
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use v0 v1
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    ; def v0
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, v0, v1
; CHECK-NEXT:    s_mov_b32 s3, 0xf000
; CHECK-NEXT:    s_mov_b32 s2, -1
...
; CHECK-LABEL: sgpr96_name_format:
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_mov_b32 s2, 12
; CHECK-NEXT:    s_mov_b32 s1, 11
; CHECK-NEXT:    s_mov_b32 s0, 10
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; sgpr96 s[0:2]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_endpgm
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v3, 0xd2511f53
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], v3, v0, v[1:2]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use v[1:2]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use v[3:4]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def v0 s[4:5]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_add_u32 s4, s4, 2
