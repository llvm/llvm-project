...
; GFX942:  .LBB16_2: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX90A:  .LBB16_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX908:  .LBB16_4: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
; GFX942:  .LBB17_4: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX90A-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A:  .LBB17_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_pk_mov_b32 v[8:9], v[0:1], v[0:1] op_sel:[0,1]
; GFX90A-NEXT:    v_add_f64 v[6:7], v[8:9], -v[2:3]
...
; GFX908-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
; GFX908:  .LBB17_4: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_mov_b32_e32 v9, v1
; GFX908-NEXT:    v_mov_b32_e32 v8, v0
...
; GFX942-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
; GFX942:  .LBB18_4: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[8:9], v[0:1]
; GFX942-NEXT:    v_add_f64 v[6:7], v[8:9], -v[2:3]
...
; GFX90A-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A:  .LBB18_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_pk_mov_b32 v[8:9], v[0:1], v[0:1] op_sel:[0,1]
; GFX90A-NEXT:    v_add_f64 v[6:7], v[8:9], -v[2:3]
...
; GFX908-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
; GFX908:  .LBB18_4: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_mov_b32_e32 v9, v1
; GFX908-NEXT:    v_mov_b32_e32 v8, v0
...
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
; GFX942:  .LBB19_4: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_add_f64 v[4:5], v[6:7], -v[2:3]
; GFX942-NEXT:    buffer_wbl2 sc1
...
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A:  .LBB19_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX942-NEXT:    flat_load_dwordx2 v[6:7], v[0:1]
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
; GFX942:  .LBB20_4: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_add_f64 v[4:5], v[6:7], -v[2:3]
; GFX942-NEXT:    buffer_wbl2 sc1
...
; GFX90A-NEXT:    flat_load_dwordx2 v[6:7], v[0:1]
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A:  .LBB20_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_add_f64 v[4:5], v[6:7], -v[2:3]
; GFX90A-NEXT:    flat_atomic_cmpswap_x2 v[4:5], v[0:1], v[4:7] glc
...
; GFX942-NEXT:    flat_load_dwordx2 v[6:7], v[0:1]
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
; GFX942:  .LBB21_4: ; %atomicrmw.start
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_add_f64 v[4:5], v[6:7], -v[2:3]
; GFX942-NEXT:    buffer_wbl2 sc1
...
; GFX90A-NEXT:    flat_load_dwordx2 v[6:7], v[0:1]
; GFX90A-NEXT:    s_mov_b64 s[6:7], 0
; GFX90A:  .LBB21_4: ; %atomicrmw.start
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_add_f64 v[4:5], v[6:7], -v[2:3]
; GFX90A-NEXT:    flat_atomic_cmpswap_x2 v[4:5], v[0:1], v[4:7] glc
