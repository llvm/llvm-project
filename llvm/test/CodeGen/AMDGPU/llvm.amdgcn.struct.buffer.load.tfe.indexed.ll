...
define amdgpu_ps void @struct_buffer_load_i8_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
; GFX13-LABEL: struct_buffer_load_i8_tfe:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    buffer_load_u8 v[4:5], v4, s0, null idxen tfe
...
define amdgpu_ps void @struct_buffer_load_i16_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
; GFX13-LABEL: struct_buffer_load_i16_tfe:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    buffer_load_u16 v[4:5], v4, s0, null idxen tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @struct_buffer_load_f16_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
...
define amdgpu_ps void @struct_buffer_load_i32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
; GFX13-LABEL: struct_buffer_load_i32_tfe:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_mov_b32_e32 v5, v4
; GFX13-NEXT:    buffer_load_b32 v[4:5], v4, s0, null idxen tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @struct_buffer_load_v2i32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
; GFX13-LABEL: struct_buffer_load_v2i32_tfe:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_mov_b32_e32 v4, 0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v6, v4
; GFX13-NEXT:    buffer_load_b64 v[4:6], v4, s0, null idxen tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @struct_buffer_load_v2f32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
...
define amdgpu_ps void @struct_buffer_load_v3i32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
...
; GFX13-NEXT:    buffer_load_b96 v[4:7], v4, s0, null idxen tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @struct_buffer_load_v3f32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
...
define amdgpu_ps void @struct_buffer_load_v4i32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
...
; GFX13-NEXT:    buffer_load_b128 v[4:8], v4, s0, null idxen tfe
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @struct_buffer_load_v4f32_tfe(i32 inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
