...
ENDLOOP:                                          ; preds = %ELSE2566, %LOOP
  ...
  %one.sub.ac.i = fmul float %one.sub.a.i, +qnan
  %fmul = fmul float +qnan, +qnan
...
ENDIF:                                            ; preds = %LOOP
  %tmp68 = fsub float %tmp2, +qnan
  %tmp69 = fsub float %tmp3, +qnan
  %tmp70 = fsub float %tmp4, +qnan
  %tmp71 = fmul float %tmp68, 0.000000e+00
  %tmp72 = fmul float %tmp69, +qnan
  %tmp73 = fmul float %tmp70, +qnan
  %tmp74 = fsub float %tmp6, +qnan
  %tmp75 = fsub float %tmp7, +qnan
  %tmp76 = fmul float %tmp74, +qnan
  ...
  %tmp81 = call float @llvm.maxnum.f32(float +qnan, float %tmp78)
  %tmp82 = call float @llvm.minnum.f32(float %tmp79, float %tmp80)
  %tmp83 = call float @llvm.minnum.f32(float %tmp82, float +qnan)
  %tmp84 = fsub float %tmp14, +qnan
  %tmp85 = fsub float %tmp15, +qnan
  %tmp86 = fsub float %tmp16, +qnan
  %tmp87 = fmul float %tmp84, +qnan
  %tmp88 = fmul float %tmp85, +qnan
  %tmp89 = fmul float %tmp86, +qnan
  %tmp90 = fsub float %tmp17, +qnan
  %tmp91 = fsub float %tmp18, +qnan
  %tmp92 = fsub float %tmp19, +qnan
  %tmp93 = fmul float %tmp90, 0.000000e+00
  %tmp94 = fmul float %tmp91, +qnan
  %tmp95 = fmul float %tmp92, +qnan
  ...
  %tmp99 = call float @llvm.maxnum.f32(float +qnan, float %tmp96)
  %tmp100 = call float @llvm.maxnum.f32(float %tmp99, float +qnan)
  %tmp101 = call float @llvm.minnum.f32(float %tmp97, float +qnan)
  %tmp102 = call float @llvm.minnum.f32(float %tmp101, float %tmp98)
  %tmp103 = fsub float %tmp30, +qnan
  %tmp104 = fsub float %tmp31, +qnan
  %tmp105 = fmul float %tmp103, 0.000000e+00
  %tmp106 = fmul float %tmp104, 0.000000e+00
  %tmp107 = call float @llvm.minnum.f32(float +qnan, float %tmp105)
  %tmp108 = call float @llvm.maxnum.f32(float +qnan, float %tmp106)
  %tmp109 = call float @llvm.maxnum.f32(float +qnan, float %tmp107)
  %tmp110 = call float @llvm.maxnum.f32(float %tmp109, float +qnan)
  %tmp111 = call float @llvm.minnum.f32(float +qnan, float %tmp108)
  %tmp112 = fsub float %tmp32, +qnan
  %tmp113 = fsub float %tmp33, +qnan
  %tmp114 = fsub float %tmp34, +qnan
  %tmp115 = fmul float %tmp112, 0.000000e+00
  %tmp116 = fmul float %tmp113, +qnan
  %tmp117 = fmul float %tmp114, +qnan
  %tmp118 = fsub float %tmp35, +qnan
  %tmp119 = fsub float %tmp36, +qnan
  %tmp120 = fsub float %tmp37, +qnan
  %tmp121 = fmul float %tmp118, +qnan
  %tmp122 = fmul float %tmp119, +qnan
  %tmp123 = fmul float %tmp120, +qnan
  ...
  %tmp129 = fsub float %tmp38, +qnan
  %tmp130 = fsub float %tmp39, +qnan
  %tmp131 = fsub float %tmp40, +qnan
  %tmp132 = fmul float %tmp129, 0.000000e+00
  %tmp133 = fmul float %tmp130, +qnan
  %tmp134 = fmul float %tmp131, +qnan
  %tmp135 = fsub float %tmp41, +qnan
  %tmp136 = fsub float %tmp42, +qnan
  %tmp137 = fsub float %tmp43, +qnan
  %tmp138 = fmul float %tmp135, +qnan
  %tmp139 = fmul float %tmp136, +qnan
  %tmp140 = fmul float %tmp137, +qnan
  ...
  %tmp146 = fsub float %tmp44, +qnan
  %tmp147 = fsub float %tmp45, +qnan
  %tmp148 = fsub float %tmp46, +qnan
  %tmp149 = fmul float %tmp146, 0.000000e+00
  %tmp150 = fmul float %tmp147, 0.000000e+00
  %tmp151 = fmul float %tmp148, +qnan
  %tmp152 = fsub float %tmp47, +qnan
  %tmp153 = fsub float %tmp48, +qnan
  %tmp154 = fsub float %tmp49, +qnan
  %tmp155 = fmul float %tmp152, +qnan
  %tmp156 = fmul float %tmp153, 0.000000e+00
  %tmp157 = fmul float %tmp154, +qnan
  ...
  %tmp163 = fsub float %tmp50, +qnan
  %tmp164 = fsub float %tmp51, +qnan
  %tmp165 = fsub float %tmp52, +qnan
  %tmp166 = fmul float %tmp163, +qnan
  %tmp167 = fmul float %tmp164, 0.000000e+00
  %tmp168 = fmul float %tmp165, 0.000000e+00
  %tmp169 = fsub float %tmp53, +qnan
  %tmp170 = fsub float %tmp54, +qnan
  %tmp171 = fsub float %tmp55, +qnan
  %tmp172 = fdiv float 1.000000e+00, %temp18.0
  %tmp173 = fmul float %tmp169, +qnan
  %tmp174 = fmul float %tmp170, +qnan
  ...
  %tmp181 = fsub float %tmp62, +qnan
  %tmp182 = fsub float %tmp63, +qnan
  %tmp183 = fsub float %tmp64, +qnan
  %tmp184 = fmul float %tmp181, 0.000000e+00
  %tmp185 = fmul float %tmp182, +qnan
  %tmp186 = fmul float %tmp183, +qnan
  %tmp187 = fsub float %tmp65, +qnan
  %tmp188 = fsub float %tmp66, +qnan
  %tmp189 = fmul float %tmp187, +qnan
  %tmp190 = fmul float %tmp188, +qnan
  %tmp191 = call float @llvm.maxnum.f32(float %tmp184, float %tmp189)
  %tmp192 = call float @llvm.maxnum.f32(float %tmp185, float %tmp190)
  %tmp193 = call float @llvm.maxnum.f32(float %tmp186, float +qnan)
  ...
  %.temp292.7 = select i1 %undef0, float %tmp162, float +qnan
  %temp292.9 = select i1 false, float %tmp180, float %.temp292.7
  %undef1 = freeze i1 poison
  %.temp292.9 = select i1 %undef1, float +qnan, float %temp292.9
  %tmp196 = fcmp ogt float +qnan, 0.000000e+00
  %tmp197 = fcmp olt float +qnan, %tmp195
  %tmp198 = and i1 %tmp196, %tmp197
  %tmp199 = fcmp olt float +qnan, %.temp292.9
  %tmp200 = and i1 %tmp198, %tmp199
  %temp292.11 = select i1 %tmp200, float +qnan, float %.temp292.9
...
IF2565:                                           ; preds = %ENDIF
  ...
  %tmp217 = fmul float %tmp216, +qnan
  %tmp218 = fadd float %tmp217, +qnan
  br label %ENDIF2564
...
ENDIF2564:                                        ; preds = %ENDIF2594, %IF2565
  ...
  %tmp202 = fsub float %tmp5, +qnan
  %tmp203 = fmul float %tmp202, +qnan
  %tmp204 = call float @llvm.maxnum.f32(float +qnan, float %tmp203)
  %tmp205 = call float @llvm.minnum.f32(float %tmp204, float +qnan)
  %tmp206 = call float @llvm.minnum.f32(float %tmp205, float +qnan)
  %tmp207 = fcmp ogt float +qnan, 0.000000e+00
  %tmp208 = fcmp olt float +qnan, 1.000000e+00
...
ENDIF2594:                                        ; preds = %ELSE2704, %ELSE2650, %ELSE2596, %ELSE2686, %ELSE2668, %ELSE2593
  ...
  %tmp225 = fmul float %temp894.2, +qnan
  br label %ENDIF2564
...
ELSE2668:                                         ; preds = %ELSE2650
  ...
  %tmp230 = fcmp olt float %tmp128, +qnan
...
ELSE2686:                                         ; preds = %ELSE2668
  ...
  %tmp233 = fcmp olt float %tmp145, +qnan
...
ELSE2704:                                         ; preds = %ELSE2686
  ...
  %tmp236 = fcmp olt float %tmp180, +qnan
...
ELSE2797:                                         ; preds = %ENDIF2564
  %tmp241 = fsub float %tmp8, +qnan
  %tmp242 = fsub float %tmp9, +qnan
  %tmp243 = fsub float %tmp10, +qnan
  %tmp244 = fmul float %tmp241, +qnan
  %tmp245 = fmul float %tmp242, +qnan
  %tmp246 = fmul float %tmp243, +qnan
  %tmp247 = fsub float %tmp11, +qnan
  %tmp248 = fsub float %tmp12, +qnan
  %tmp249 = fsub float %tmp13, +qnan
  %tmp250 = fmul float %tmp247, +qnan
  %tmp251 = fmul float %tmp248, +qnan
  %tmp252 = fmul float %tmp249, +qnan
  ...
  %tmp257 = call float @llvm.maxnum.f32(float %tmp256, float +qnan)
  %tmp258 = call float @llvm.minnum.f32(float +qnan, float %tmp255)
...
ELSE2803:                                         ; preds = %ELSE2797
  %tmp264 = fsub float %tmp20, +qnan
  %tmp265 = fsub float %tmp21, +qnan
  %tmp266 = fsub float %tmp22, +qnan
  %tmp267 = fmul float %tmp264, +qnan
  %tmp268 = fmul float %tmp265, +qnan
  %tmp269 = fmul float %tmp266, 0.000000e+00
  %tmp270 = fsub float %tmp23, +qnan
  %tmp271 = fsub float %tmp24, +qnan
  %tmp272 = fsub float %tmp25, +qnan
  %tmp273 = fmul float %tmp270, +qnan
  %tmp274 = fmul float %tmp271, +qnan
  %tmp275 = fmul float %tmp272, +qnan
  ...
  %tmp279 = call float @llvm.maxnum.f32(float %tmp276, float +qnan)
  %tmp280 = call float @llvm.maxnum.f32(float %tmp279, float +qnan)
  %tmp281 = call float @llvm.minnum.f32(float +qnan, float %tmp277)
...
ELSE2806:                                         ; preds = %ELSE2803
  %tmp288 = fsub float %tmp26, +qnan
  %tmp289 = fsub float %tmp27, +qnan
  %tmp290 = fsub float %tmp28, +qnan
  %tmp291 = fmul float %tmp288, +qnan
  %tmp292 = fmul float %tmp289, 0.000000e+00
  %tmp293 = fmul float %tmp290, +qnan
  %tmp294 = fsub float %tmp29, +qnan
  %tmp295 = fmul float %tmp294, +qnan
  %tmp296 = call float @llvm.minnum.f32(float %tmp291, float %tmp295)
  %tmp297 = call float @llvm.minnum.f32(float %tmp292, float +qnan)
  %tmp298 = call float @llvm.maxnum.f32(float %tmp293, float +qnan)
  %tmp299 = call float @llvm.maxnum.f32(float %tmp296, float %tmp297)
  %tmp300 = call float @llvm.maxnum.f32(float %tmp299, float +qnan)
  %tmp301 = call float @llvm.minnum.f32(float +qnan, float %tmp298)
...
ELSE2821:                                         ; preds = %ELSE2806
  %tmp307 = fsub float %tmp56, +qnan
  %tmp308 = fsub float %tmp57, +qnan
  %tmp309 = fsub float %tmp58, +qnan
  %tmp310 = fmul float %tmp307, +qnan
  %tmp311 = fmul float %tmp308, 0.000000e+00
  %tmp312 = fmul float %tmp309, +qnan
  %tmp313 = fsub float %tmp59, +qnan
  %tmp314 = fsub float %tmp60, +qnan
  %tmp315 = fsub float %tmp61, +qnan
  %tmp316 = fmul float %tmp313, +qnan
  %tmp317 = fmul float %tmp314, +qnan
  %tmp318 = fmul float %tmp315, +qnan
  ...
  %tmp324 = fcmp ogt float +qnan, 0.000000e+00
  %tmp325 = fcmp olt float +qnan, 1.000000e+00
  %tmp326 = and i1 %tmp324, %tmp325
  %tmp327 = fcmp olt float +qnan, %tmp323
