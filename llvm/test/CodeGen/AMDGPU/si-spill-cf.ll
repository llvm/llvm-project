...
ENDLOOP:                                          ; preds = %ELSE2566, %LOOP
  ...
  %fmul = fmul float f0x7FC00000, 0x7FF8000000000000
...
ENDIF:                                            ; preds = %LOOP
  ...
  %tmp81 = call float @llvm.maxnum.f32(float f0x7FC00000, float %tmp78)
  %tmp82 = call float @llvm.minnum.f32(float %tmp79, float %tmp80)
  %tmp83 = call float @llvm.minnum.f32(float %tmp82, float f0x7FC00000)
  ...
  %tmp99 = call float @llvm.maxnum.f32(float f0x7FC00000, float %tmp96)
  %tmp100 = call float @llvm.maxnum.f32(float %tmp99, float f0x7FC00000)
  %tmp101 = call float @llvm.minnum.f32(float %tmp97, float f0x7FC00000)
  ...
  %tmp107 = call float @llvm.minnum.f32(float f0x7FC00000, float %tmp105)
  %tmp108 = call float @llvm.maxnum.f32(float f0x7FC00000, float %tmp106)
  %tmp109 = call float @llvm.maxnum.f32(float f0x7FC00000, float %tmp107)
  %tmp110 = call float @llvm.maxnum.f32(float %tmp109, float f0x7FC00000)
  %tmp111 = call float @llvm.minnum.f32(float f0x7FC00000, float %tmp108)
  ...
  %tmp193 = call float @llvm.maxnum.f32(float %tmp186, float f0x7FC00000)
  ...
  %.temp292.7 = select i1 %undef0, float %tmp162, float f0x7FC00000
  %temp292.9 = select i1 false, float %tmp180, float %.temp292.7
  %undef1 = freeze i1 poison
  %.temp292.9 = select i1 %undef1, float f0x7FC00000, float %temp292.9
  %tmp196 = fcmp ogt float f0x7FC00000, 0.000000e+00
  %tmp197 = fcmp olt float f0x7FC00000, %tmp195
  %tmp198 = and i1 %tmp196, %tmp197
  %tmp199 = fcmp olt float f0x7FC00000, %.temp292.9
  %tmp200 = and i1 %tmp198, %tmp199
  %temp292.11 = select i1 %tmp200, float f0x7FC00000, float %.temp292.9
...
ENDIF2564:                                        ; preds = %ENDIF2594, %IF2565
  ...
  %tmp204 = call float @llvm.maxnum.f32(float f0x7FC00000, float %tmp203)
  %tmp205 = call float @llvm.minnum.f32(float %tmp204, float f0x7FC00000)
  %tmp206 = call float @llvm.minnum.f32(float %tmp205, float f0x7FC00000)
  %tmp207 = fcmp ogt float f0x7FC00000, 0.000000e+00
  %tmp208 = fcmp olt float f0x7FC00000, 1.000000e+00
...
ELSE2797:                                         ; preds = %ENDIF2564
  ...
  %tmp257 = call float @llvm.maxnum.f32(float %tmp256, float f0x7FC00000)
  %tmp258 = call float @llvm.minnum.f32(float f0x7FC00000, float %tmp255)
...
ELSE2803:                                         ; preds = %ELSE2797
  ...
  %tmp279 = call float @llvm.maxnum.f32(float %tmp276, float f0x7FC00000)
  %tmp280 = call float @llvm.maxnum.f32(float %tmp279, float f0x7FC00000)
  %tmp281 = call float @llvm.minnum.f32(float f0x7FC00000, float %tmp277)
...
ELSE2806:                                         ; preds = %ELSE2803
  ...
  %tmp297 = call float @llvm.minnum.f32(float %tmp292, float f0x7FC00000)
  %tmp298 = call float @llvm.maxnum.f32(float %tmp293, float f0x7FC00000)
  %tmp299 = call float @llvm.maxnum.f32(float %tmp296, float %tmp297)
  %tmp300 = call float @llvm.maxnum.f32(float %tmp299, float f0x7FC00000)
  %tmp301 = call float @llvm.minnum.f32(float f0x7FC00000, float %tmp298)
...
ELSE2821:                                         ; preds = %ELSE2806
  ...
  %tmp324 = fcmp ogt float f0x7FC00000, 0.000000e+00
  %tmp325 = fcmp olt float f0x7FC00000, 1.000000e+00
  %tmp326 = and i1 %tmp324, %tmp325
  %tmp327 = fcmp olt float f0x7FC00000, %tmp323
