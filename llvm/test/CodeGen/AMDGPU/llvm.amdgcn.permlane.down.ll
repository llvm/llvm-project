...
; RUN: llc -global-isel=1 -amdgpu-load-store-vectorizer=0 -mtriple=amdgcn -mcpu=gfx1310 < %s | FileCheck -check-prefixes=GFX13,GFX13-GISEL %s
...
; GFX1250-SDAG-LABEL: v_permlane_down_i16:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
...
;
; GFX1250-GISEL-LABEL: v_permlane_down_i16:
; GFX1250-GISEL:       ; %bb.0:
