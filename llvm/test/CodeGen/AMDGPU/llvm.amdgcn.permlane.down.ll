...
; GFX13-NEXT:    v_permlane_down_b32 v0, v0, s3, s4
...
; GFX13-NEXT:    v_permlane_down_b32 v0, v0, s2, 0x66
; GFX13-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX13-NEXT:    s_endpgm
...
;
; GFX13-SDAG-LABEL: v_permlane_down_b32_vvv:
; GFX13-SDAG:       ; %bb.0:
...
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v1, v1, s3, s2
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_b32_vvv:
; GFX13-GISEL:       ; %bb.0:
...
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v0, v0, s3, s4
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_f32_vvv:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b96 s[0:2], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-SDAG-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_f32_vvv:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b96 s[0:2], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-GISEL-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_i64_vss:
; GFX13-SDAG:       ; %bb.0:
...
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v1, v0, s4, s5
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v0, v2, s4, s5
; GFX13-SDAG-NEXT:    global_store_b64 v3, v[0:1], s[0:1]
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_i64_vss:
; GFX13-GISEL:       ; %bb.0:
...
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v0, v0, s4, s5
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v1, v1, s4, s5
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_i64_vii:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v0, s3
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v1, v0, 1, 2
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v0, v2, 1, 2
; GFX13-SDAG-NEXT:    global_store_b64 v3, v[0:1], s[0:1]
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_i64_vii:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v0, v0, 1, 2
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v1, v1, 1, 2
; GFX13-GISEL-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX13-GISEL-NEXT:    s_endpgm
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_i64_vll:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v0, s3
...
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v1, v0, s2, 0x66
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX13-SDAG-NEXT:    v_permlane_down_b32 v0, v2, s2, 0x66
; GFX13-SDAG-NEXT:    global_store_b64 v3, v[0:1], s[0:1]
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_i64_vll:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
...
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v0, v0, s2, 0x66
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX13-GISEL-NEXT:    v_permlane_down_b32 v1, v1, s2, 0x66
; GFX13-GISEL-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX13-GISEL-NEXT:    s_endpgm
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_i64_vvv:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-SDAG-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_i64_vvv:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-GISEL-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_f64_vss:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_clause 0x1
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34 nv
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_f64_vss:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_clause 0x1
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34 nv
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_f64_vii:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v0, s3
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_f64_vii:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_f64_vll:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v0, s3
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_f64_vll:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
...
; GFX1250-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: v_permlane_down_f64_vvv:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-SDAG-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-SDAG-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: v_permlane_down_f64_vvv:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-GISEL-NEXT:    v_and_b32_e32 v1, 0x3ff, v0
; GFX13-GISEL-NEXT:    v_bfe_u32 v0, v0, 10, 10
