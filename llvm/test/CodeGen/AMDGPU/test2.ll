...
; CHECK-LABEL: # Machine code for function test2: IsSSA, TracksLiveness
...
; EMPTY:
; CHECK: Next-use distance of Register [[Reg4]] = 21
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg2]] = 7
; CHECK-NEXT: Next-use distance of Register [[Reg1]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg5]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg6]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg7]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg8]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg9]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg12]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg20]] = 2
...
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg27]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg29]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg30]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg31]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg10]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 4
...
; CHECK-NEXT: Next-use distance of Register [[Reg33]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg38]] = 4
...
; CHECK-NEXT: Next-use distance of Register [[Reg37]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg52]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg34]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg28]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg36]] = 11
; CHECK-NEXT: Next-use distance of Register [[Reg47]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg48]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg54]] = 11
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 10
; CHECK-NEXT: Next-use distance of Register [[Reg56]] = 10
; CHECK-NEXT: Next-use distance of Register [[Reg57]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg58]] = 4
...
; CHECK-NEXT: Next-use distance of Register [[Reg62]] = 2
...
; CHECK-NEXT: Next-use distance of Register [[Reg68]] = 2
...
; CHECK-NEXT: Next-use distance of Register [[Reg72]] = 2
