...
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[10:13], v[0:1] offset:12
...
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[10:13]
...
; GFX11-SDAG-NEXT:    flat_load_b128 v[10:13], v[0:1] offset:12
...
; GFX11-SDAG-NEXT:    flat_store_b128 v[2:3], v[10:13]
...
; GFX12-SDAG-NEXT:    flat_load_b128 v[10:13], v[0:1] offset:12
...
; GFX12-SDAG-NEXT:    flat_store_b128 v[2:3], v[10:13]
...
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v10, vcc, v0, v4
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v11, vcc, v1, v5, vcc
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[4:7], v[10:11] offset:12
; GFX90A-GISEL-NEXT:    flat_load_dword v8, v[10:11] offset:28
...
; GFX10-GISEL-NEXT:    flat_store_dword v[2:3], v8 offset:16
...
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[10:11], v[4:5], 2, v[0:1]
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[4:7], v[10:11] offset:12
; GFX942-GISEL-NEXT:    flat_load_dword v8, v[10:11] offset:28
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX11-GISEL-NEXT:    flat_store_b32 v[2:3], v8 offset:16
...
; GFX12-GISEL-NEXT:    flat_store_b32 v[2:3], v8 offset:16
...
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e64 v52, s[4:5], 28, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v4, vcc, 0x8c, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e64 v53, s[4:5], 0, v1, s[4:5]
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[8:11], v[52:53] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[12:15], v[52:53] offset:48
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[16:19], v[52:53] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[20:23], v[52:53] offset:80
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[24:27], v[52:53] offset:96
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[28:31], v[52:53]
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[32:35], v[52:53] offset:16
...
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e64 v52, s[0:1], 28, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v4, vcc, 0x8c, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e64 v53, s[0:1], 0, v1, s[0:1]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[8:11], v[52:53] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[12:15], v[52:53] offset:48
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[16:19], v[52:53] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[20:23], v[52:53] offset:80
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[24:27], v[52:53] offset:96
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[28:31], v[52:53]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[32:35], v[52:53] offset:16
...
; GFX10-SDAG-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX10-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v0, 28
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v1, vcc_lo
; GFX10-SDAG-NEXT:    s_clause 0x8
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[4:7], v[48:49] offset:80
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[8:11], v[48:49] offset:96
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[12:15], v[48:49] offset:48
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[16:19], v[48:49] offset:64
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[20:23], v[48:49] offset:16
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[24:27], v[48:49] offset:32
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[28:31], v[0:1] offset:12
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[32:35], v[48:49]
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[50:53], v[48:49] offset:112
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX11-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v0, 28
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v1, vcc_lo
; GFX11-SDAG-NEXT:    s_clause 0x8
; GFX11-SDAG-NEXT:    flat_load_b128 v[4:7], v[48:49] offset:80
; GFX11-SDAG-NEXT:    flat_load_b128 v[8:11], v[48:49] offset:96
; GFX11-SDAG-NEXT:    flat_load_b128 v[12:15], v[48:49] offset:64
; GFX11-SDAG-NEXT:    flat_load_b128 v[16:19], v[48:49] offset:32
; GFX11-SDAG-NEXT:    flat_load_b128 v[20:23], v[48:49] offset:16
; GFX11-SDAG-NEXT:    flat_load_b128 v[24:27], v[48:49]
; GFX11-SDAG-NEXT:    flat_load_b128 v[28:31], v[0:1] offset:12
; GFX11-SDAG-NEXT:    flat_load_b128 v[32:35], v[48:49] offset:112
; GFX11-SDAG-NEXT:    flat_load_b128 v[50:53], v[48:49] offset:48
...
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(8) lgkmcnt(8)
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX12-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v0, 28
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v1, vcc_lo
; GFX12-SDAG-NEXT:    s_clause 0x8
; GFX12-SDAG-NEXT:    flat_load_b128 v[4:7], v[48:49] offset:80
; GFX12-SDAG-NEXT:    flat_load_b128 v[8:11], v[48:49] offset:96
; GFX12-SDAG-NEXT:    flat_load_b128 v[12:15], v[48:49] offset:64
; GFX12-SDAG-NEXT:    flat_load_b128 v[16:19], v[48:49] offset:32
; GFX12-SDAG-NEXT:    flat_load_b128 v[20:23], v[48:49] offset:16
; GFX12-SDAG-NEXT:    flat_load_b128 v[24:27], v[48:49]
; GFX12-SDAG-NEXT:    flat_load_b128 v[28:31], v[0:1] offset:12
; GFX12-SDAG-NEXT:    flat_load_b128 v[32:35], v[48:49] offset:112
; GFX12-SDAG-NEXT:    flat_load_b128 v[50:53], v[48:49] offset:48
...
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x808
...
; GFX90A-GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX90A-GISEL-NEXT:    v_lshlrev_b64 v[4:5], 2, v[4:5]
; GFX90A-GISEL-NEXT:    v_add_co_u32_e32 v48, vcc, v0, v4
; GFX90A-GISEL-NEXT:    v_addc_co_u32_e32 v49, vcc, v1, v5, vcc
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[4:7], v[48:49] offset:12
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[8:11], v[48:49] offset:28
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[12:15], v[48:49] offset:44
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[16:19], v[48:49] offset:60
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[20:23], v[48:49] offset:76
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[24:27], v[48:49] offset:92
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[28:31], v[48:49] offset:108
; GFX90A-GISEL-NEXT:    flat_load_dwordx4 v[32:35], v[48:49] offset:124
; GFX90A-GISEL-NEXT:    flat_load_dwordx3 v[36:38], v[48:49] offset:140
; GFX90A-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-GISEL-NEXT:    flat_store_dwordx4 v[2:3], v[4:7]
...
; GFX10-GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX10-GISEL-NEXT:    v_lshlrev_b64 v[4:5], 2, v[4:5]
; GFX10-GISEL-NEXT:    v_add_co_u32 v48, vcc_lo, v0, v4
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v49, null, v1, v5, vcc_lo
; GFX10-GISEL-NEXT:    s_clause 0x8
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[4:7], v[48:49] offset:12
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[8:11], v[48:49] offset:28
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[12:15], v[48:49] offset:44
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[16:19], v[48:49] offset:60
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[20:23], v[48:49] offset:76
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[24:27], v[48:49] offset:92
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[28:31], v[48:49] offset:108
; GFX10-GISEL-NEXT:    flat_load_dwordx4 v[32:35], v[48:49] offset:124
; GFX10-GISEL-NEXT:    flat_load_dwordx3 v[36:38], v[48:49] offset:140
...
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX942-GISEL-NEXT:    v_lshl_add_u64 v[48:49], v[4:5], 2, v[0:1]
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[4:7], v[48:49] offset:12
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[8:11], v[48:49] offset:28
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[12:15], v[48:49] offset:44
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[16:19], v[48:49] offset:60
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[20:23], v[48:49] offset:76
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[24:27], v[48:49] offset:92
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[28:31], v[48:49] offset:108
; GFX942-GISEL-NEXT:    flat_load_dwordx4 v[32:35], v[48:49] offset:124
; GFX942-GISEL-NEXT:    flat_load_dwordx3 v[36:38], v[48:49] offset:140
; GFX942-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-GISEL-NEXT:    flat_store_dwordx4 v[2:3], v[4:7]
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_lshlrev_b64 v[4:5], 2, v[4:5]
; GFX11-GISEL-NEXT:    v_add_co_u32 v48, vcc_lo, v0, v4
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v49, null, v1, v5, vcc_lo
; GFX11-GISEL-NEXT:    s_clause 0x8
; GFX11-GISEL-NEXT:    flat_load_b128 v[4:7], v[48:49] offset:12
; GFX11-GISEL-NEXT:    flat_load_b128 v[8:11], v[48:49] offset:28
; GFX11-GISEL-NEXT:    flat_load_b128 v[12:15], v[48:49] offset:44
; GFX11-GISEL-NEXT:    flat_load_b128 v[16:19], v[48:49] offset:60
; GFX11-GISEL-NEXT:    flat_load_b128 v[20:23], v[48:49] offset:76
; GFX11-GISEL-NEXT:    flat_load_b128 v[24:27], v[48:49] offset:92
; GFX11-GISEL-NEXT:    flat_load_b128 v[28:31], v[48:49] offset:108
; GFX11-GISEL-NEXT:    flat_load_b128 v[32:35], v[48:49] offset:124
; GFX11-GISEL-NEXT:    flat_load_b96 v[36:38], v[48:49] offset:140
...
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-GISEL-NEXT:    v_lshlrev_b64_e32 v[4:5], 2, v[4:5]
; GFX12-GISEL-NEXT:    v_add_co_u32 v48, vcc_lo, v0, v4
; GFX12-GISEL-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-GISEL-NEXT:    v_add_co_ci_u32_e64 v49, null, v1, v5, vcc_lo
; GFX12-GISEL-NEXT:    s_clause 0x8
; GFX12-GISEL-NEXT:    flat_load_b128 v[4:7], v[48:49] offset:12
; GFX12-GISEL-NEXT:    flat_load_b128 v[8:11], v[48:49] offset:28
; GFX12-GISEL-NEXT:    flat_load_b128 v[12:15], v[48:49] offset:44
; GFX12-GISEL-NEXT:    flat_load_b128 v[16:19], v[48:49] offset:60
; GFX12-GISEL-NEXT:    flat_load_b128 v[20:23], v[48:49] offset:76
; GFX12-GISEL-NEXT:    flat_load_b128 v[24:27], v[48:49] offset:92
; GFX12-GISEL-NEXT:    flat_load_b128 v[28:31], v[48:49] offset:108
; GFX12-GISEL-NEXT:    flat_load_b128 v[32:35], v[48:49] offset:124
; GFX12-GISEL-NEXT:    flat_load_b96 v[36:38], v[48:49] offset:140
