...
; GFX90A-SDAG-NEXT:    v_add_co_u32_e32 v8, vcc, 28, v0
; GFX90A-SDAG-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v1, vcc
; GFX90A-SDAG-NEXT:    flat_load_dword v10, v[8:9]
; GFX90A-SDAG-NEXT:    flat_load_dwordx4 v[4:7], v[0:1] offset:12
; GFX90A-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-NEXT:    flat_store_dword v[2:3], v10 offset:16
; GFX90A-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[4:7]
; GFX90A-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[8:9], v[0:1], 0, 28
; GFX942-SDAG-NEXT:    flat_load_dword v10, v[8:9]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[4:7], v[0:1] offset:12
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    flat_store_dword v[2:3], v10 offset:16
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[4:7]
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e64 v24, s[4:5], 28, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e64 v25, s[4:5], 0, v1, s[4:5]
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e64 v28, s[4:5], 44, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v36, vcc, 0x8c, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e64 v29, s[4:5], 0, v1, s[4:5]
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[4:7], v[28:29] offset:16
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[8:11], v[28:29] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[12:15], v[28:29] offset:48
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[16:19], v[28:29] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[20:23], v[28:29] offset:80
; GFX90A-SDAG-MUBUF-NEXT:    s_nop 0
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[24:27], v[24:25]
; GFX90A-SDAG-MUBUF-NEXT:    s_nop 0
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[28:31], v[28:29]
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v37, vcc, 0, v1, vcc
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[32:35], v[0:1] offset:12
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[48:51], v[36:37]
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v0, vcc, 48, v2
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v36, vcc, 0x88, v2
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v37, vcc, 0, v3, vcc
; GFX90A-SDAG-MUBUF-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[0:1], v[16:19] offset:48
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[0:1], v[20:23] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[8:11] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[0:1], v[12:15] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[28:31] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[24:27] offset:16
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[32:35]
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dword v[36:37], v50
...
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e64 v24, s[0:1], 28, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e64 v25, s[0:1], 0, v1, s[0:1]
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e64 v28, s[0:1], 44, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v36, vcc, 0x8c, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e64 v29, s[0:1], 0, v1, s[0:1]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[4:7], v[28:29] offset:16
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[8:11], v[28:29] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[12:15], v[28:29] offset:48
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[16:19], v[28:29] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[20:23], v[28:29] offset:80
; GFX90A-SDAG-FLATSCR-NEXT:    s_nop 0
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[24:27], v[24:25]
; GFX90A-SDAG-FLATSCR-NEXT:    s_nop 0
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[28:31], v[28:29]
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v37, vcc, 0, v1, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[32:35], v[0:1] offset:12
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[48:51], v[36:37]
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v0, vcc, 48, v2
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v36, vcc, 0x88, v2
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v37, vcc, 0, v3, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[0:1], v[16:19] offset:48
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[0:1], v[20:23] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[8:11] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[0:1], v[12:15] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[28:31] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[24:27] offset:16
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[32:35]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dword v[36:37], v50
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[30:31], v[0:1], 0, s[2:3]
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[18:19], v[0:1], 0, s[2:3]
; GFX942-SDAG-NEXT:    s_mov_b64 s[2:3], 0x6c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[24:25], v[0:1], 0, 28
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[28:29], v[0:1], 0, 60
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[26:27], v[0:1], 0, 44
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[20:21], v[0:1], 0, s[2:3]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[4:7], v[20:21]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[8:11], v[16:17]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[12:15], v[18:19]
; GFX942-SDAG-NEXT:    ; kill: killed $vgpr16_vgpr17
; GFX942-SDAG-NEXT:    ; kill: killed $vgpr18_vgpr19
; GFX942-SDAG-NEXT:    ; kill: killed $vgpr20_vgpr21
; GFX942-SDAG-NEXT:    s_nop 0
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[16:19], v[26:27]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[20:23], v[30:31]
; GFX942-SDAG-NEXT:    ; kill: killed $vgpr30_vgpr31
; GFX942-SDAG-NEXT:    ; kill: killed $vgpr26_vgpr27
; GFX942-SDAG-NEXT:    s_nop 0
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[24:27], v[24:25]
; GFX942-SDAG-NEXT:    s_nop 0
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[28:31], v[28:29]
; GFX942-SDAG-NEXT:    s_nop 0
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[32:35], v[0:1] offset:12
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x8c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[52:55], v[0:1]
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[36:37], v[2:3], 0, s[2:3]
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[38:39], v[2:3], 0, s[4:5]
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[48:49], v[2:3], 0, 48
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[50:51], v[2:3], 0, s[6:7]
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[36:37], v[12:15]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[8:11] offset:64
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[38:39], v[20:23]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[16:19] offset:32
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[48:49], v[28:31]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[32:35]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[24:27] offset:16
; GFX942-SDAG-NEXT:    flat_store_dword v[50:51], v54
; GFX942-SDAG-NEXT:    flat_store_dwordx2 v[2:3], v[52:53] offset:128
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
