...
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v4, vcc, 28, v0
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v1, vcc
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[6:9], v[4:5] offset:112
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[10:13], v[0:1] offset:12
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[14:17], v[4:5] offset:80
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[18:21], v[4:5] offset:96
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[22:25], v[4:5] offset:48
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[26:29], v[4:5] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    ; kill: killed $vgpr0 killed $vgpr1
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[30:33], v[4:5] offset:16
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[34:37], v[4:5] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_load_dwordx4 v[48:51], v[4:5]
; GFX90A-SDAG-MUBUF-NEXT:    s_movk_i32 s4, 0x88
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v0, vcc, s4, v2
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX90A-SDAG-MUBUF-NEXT:    v_add_co_u32_e32 v4, vcc, 48, v2
; GFX90A-SDAG-MUBUF-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v3, vcc
; GFX90A-SDAG-MUBUF-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dword v[0:1], v8
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[10:13]
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx2 v[2:3], v[6:7] offset:128
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[4:5], v[14:17] offset:48
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[4:5], v[18:21] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[22:25] offset:64
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[4:5], v[26:29] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[30:33] offset:32
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[4:5], v[34:37]
; GFX90A-SDAG-MUBUF-NEXT:    flat_store_dwordx4 v[2:3], v[48:51] offset:16
; GFX90A-SDAG-MUBUF-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-MUBUF-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v4, vcc, 28, v0
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v1, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[6:9], v[4:5] offset:112
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[10:13], v[0:1] offset:12
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[14:17], v[4:5] offset:80
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[18:21], v[4:5] offset:96
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[22:25], v[4:5] offset:48
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[26:29], v[4:5] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    ; kill: killed $vgpr0 killed $vgpr1
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[30:33], v[4:5] offset:16
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[34:37], v[4:5] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_load_dwordx4 v[48:51], v[4:5]
; GFX90A-SDAG-FLATSCR-NEXT:    s_movk_i32 s0, 0x88
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v2
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v3, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    v_add_co_u32_e32 v4, vcc, 48, v2
; GFX90A-SDAG-FLATSCR-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v3, vcc
; GFX90A-SDAG-FLATSCR-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dword v[0:1], v8
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[10:13]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx2 v[2:3], v[6:7] offset:128
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[4:5], v[14:17] offset:48
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[4:5], v[18:21] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[22:25] offset:64
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[4:5], v[26:29] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[30:33] offset:32
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[4:5], v[34:37]
; GFX90A-SDAG-FLATSCR-NEXT:    flat_store_dwordx4 v[2:3], v[48:51] offset:16
; GFX90A-SDAG-FLATSCR-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX10-SDAG-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX10-SDAG-NEXT:    v_add_co_u32 v35, vcc_lo, v0, 28
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v36, null, 0, v1, vcc_lo
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[4:7], v[35:36] offset:112
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    s_clause 0x7
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[7:10], v[0:1] offset:12
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[11:14], v[35:36] offset:80
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[15:18], v[35:36] offset:96
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[19:22], v[35:36] offset:48
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[23:26], v[35:36] offset:64
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[27:30], v[35:36] offset:16
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[31:34], v[35:36] offset:32
; GFX10-SDAG-NEXT:    flat_load_dwordx4 v[35:38], v[35:36]
; GFX10-SDAG-NEXT:    v_add_co_u32 v0, vcc_lo, 0x88, v2
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v3, vcc_lo
; GFX10-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v2, 48
; GFX10-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v3, vcc_lo
; GFX10-SDAG-NEXT:    flat_store_dword v[0:1], v6
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(7) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[7:10]
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(6) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[48:49], v[11:14] offset:48
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(5) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[48:49], v[15:18] offset:64
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[19:22] offset:64
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(3) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[48:49], v[23:26] offset:32
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[27:30] offset:32
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[48:49], v[31:34]
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(8)
; GFX10-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[35:38] offset:16
...
; GFX942-SDAG-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[4:5], 2, v[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x5c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[8:9], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x4c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[10:11], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x7c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[12:13], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x6c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[14:15], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x8c
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[16:17], v[0:1], 0, s[0:1]
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[4:5], v[0:1], 0, 60
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[6:7], v[0:1], 0, 44
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[18:21], v[16:17]
; GFX942-SDAG-NEXT:    flat_load_dwordx4 v[22:25], v[0:1] offset:12
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 0, 28
; GFX942-SDAG-NEXT:    flat_load_dwordx4 a[0:3], v[0:1]
; GFX942-SDAG-NEXT:    s_mov_b64 s[0:1], 0x88
; GFX942-SDAG-NEXT:    s_mov_b64 s[2:3], 0x60
; GFX942-SDAG-NEXT:    s_mov_b64 s[4:5], 0x70
...
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[8:9], v[2:3], 0, s[6:7]
; GFX942-SDAG-NEXT:    v_lshl_add_u64 v[10:11], v[2:3], 0, 48
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    flat_store_dword v[0:1], v20
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[22:25]
; GFX942-SDAG-NEXT:    flat_store_dwordx2 v[2:3], v[18:19] offset:128
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[4:5], v[12:15]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[6:7], v[26:29]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[34:37] offset:64
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[8:9], v[30:33]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], v[52:55] offset:32
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[10:11], v[48:51]
; GFX942-SDAG-NEXT:    flat_store_dwordx4 v[2:3], a[0:3] offset:16
; GFX942-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX11-SDAG-NEXT:    v_add_co_u32 v35, vcc_lo, v0, 28
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v36, null, 0, v1, vcc_lo
; GFX11-SDAG-NEXT:    flat_load_b128 v[4:7], v[35:36] offset:112
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_clause 0x7
; GFX11-SDAG-NEXT:    flat_load_b128 v[7:10], v[0:1] offset:12
; GFX11-SDAG-NEXT:    flat_load_b128 v[11:14], v[35:36] offset:80
; GFX11-SDAG-NEXT:    flat_load_b128 v[15:18], v[35:36] offset:96
; GFX11-SDAG-NEXT:    flat_load_b128 v[19:22], v[35:36] offset:64
; GFX11-SDAG-NEXT:    flat_load_b128 v[23:26], v[35:36] offset:32
; GFX11-SDAG-NEXT:    flat_load_b128 v[27:30], v[35:36] offset:16
; GFX11-SDAG-NEXT:    flat_load_b128 v[31:34], v[35:36]
; GFX11-SDAG-NEXT:    flat_load_b128 v[35:38], v[35:36] offset:48
; GFX11-SDAG-NEXT:    v_add_co_u32 v0, vcc_lo, 0x88, v2
...
; GFX11-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v2, 48
; GFX11-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v3, vcc_lo
; GFX11-SDAG-NEXT:    flat_store_b32 v[0:1], v6
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(7) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[2:3], v[7:10]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(6) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[48:49], v[11:14] offset:48
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(5) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[48:49], v[15:18] offset:64
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[48:49], v[19:22] offset:32
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(3) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[48:49], v[23:26]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[2:3], v[27:30] offset:32
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(8)
; GFX11-SDAG-NEXT:    flat_store_b128 v[2:3], v[31:34] offset:16
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v5, vcc_lo
; GFX12-SDAG-NEXT:    v_add_co_u32 v35, vcc_lo, v0, 28
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v36, null, 0, v1, vcc_lo
; GFX12-SDAG-NEXT:    flat_load_b128 v[4:7], v[35:36] offset:112
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-NEXT:    s_clause 0x7
; GFX12-SDAG-NEXT:    flat_load_b128 v[7:10], v[0:1] offset:12
; GFX12-SDAG-NEXT:    flat_load_b128 v[11:14], v[35:36] offset:80
; GFX12-SDAG-NEXT:    flat_load_b128 v[15:18], v[35:36] offset:96
; GFX12-SDAG-NEXT:    flat_load_b128 v[19:22], v[35:36] offset:64
; GFX12-SDAG-NEXT:    flat_load_b128 v[23:26], v[35:36] offset:32
; GFX12-SDAG-NEXT:    flat_load_b128 v[27:30], v[35:36] offset:16
; GFX12-SDAG-NEXT:    flat_load_b128 v[31:34], v[35:36]
; GFX12-SDAG-NEXT:    flat_load_b128 v[35:38], v[35:36] offset:48
; GFX12-SDAG-NEXT:    v_add_co_u32 v0, vcc_lo, 0x88, v2
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v3, vcc_lo
; GFX12-SDAG-NEXT:    v_add_co_u32 v48, vcc_lo, v2, 48
; GFX12-SDAG-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v49, null, 0, v3, vcc_lo
; GFX12-SDAG-NEXT:    flat_store_b32 v[0:1], v6
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x708
; GFX12-SDAG-NEXT:    flat_store_b128 v[2:3], v[7:10]
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x608
; GFX12-SDAG-NEXT:    flat_store_b128 v[48:49], v[11:14] offset:48
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x508
; GFX12-SDAG-NEXT:    flat_store_b128 v[48:49], v[15:18] offset:64
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x408
; GFX12-SDAG-NEXT:    flat_store_b128 v[48:49], v[19:22] offset:32
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x308
; GFX12-SDAG-NEXT:    flat_store_b128 v[48:49], v[23:26]
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x208
; GFX12-SDAG-NEXT:    flat_store_b128 v[2:3], v[27:30] offset:32
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x108
; GFX12-SDAG-NEXT:    flat_store_b128 v[2:3], v[31:34] offset:16
