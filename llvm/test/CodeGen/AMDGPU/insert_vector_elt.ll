...
; RUN: llc -mtriple=amdgpu7.00-amd-amdhsa -mattr=-flat-for-global,+max-private-element-size-16 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SI %s
; RUN: llc -mtriple=amdgpu8.02-amd-amdhsa -mattr=-flat-for-global -mattr=+max-private-element-size-16 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI %s
...
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx8 s[12:19], s[8:9], 0x8
; SI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; SI-NEXT:    s_load_dword s4, s[8:9], 0x10
...
; VI-NEXT:    s_load_dwordx2 s[10:11], s[8:9], 0x60
...
; VI-NEXT:    buffer_store_dwordx2 v[8:9], off, s[12:15], 0 offset:32
; VI-NEXT:    s_endpgm
...
; VI-NEXT:    s_load_dwordx8 s[0:7], s[8:9], 0x40
; VI-NEXT:    s_load_dwordx2 s[12:13], s[8:9], 0x0
; VI-NEXT:    s_load_dwordx4 s[16:19], s[8:9], 0x60
; VI-NEXT:    s_mov_b32 s15, 0x1100f000
; VI-NEXT:    s_mov_b32 s14, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
...
; VI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[12:15], 0 offset:16
; VI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0
; VI-NEXT:    buffer_store_dwordx3 v[8:10], off, s[12:15], 0 offset:32
; VI-NEXT:    s_endpgm
...
; VI-NEXT:    v_perm_b32 v0, s9, v0, v4
; VI-NEXT:    v_perm_b32 v1, s8, v1, v5
; VI-NEXT:    s_cselect_b32 s7, s7, 5
...
; VI-NEXT:    v_perm_b32 v0, s8, v0, v4
; VI-NEXT:    v_perm_b32 v1, s7, v1, v5
; VI-NEXT:    s_cselect_b32 s6, s6, 5
...
; VI-NEXT:    s_lshr_b32 s5, s4, 16
; VI-NEXT:    s_cmp_lg_u32 s10, 2
; VI-NEXT:    v_perm_b32 v0, s7, v0, v4
; VI-NEXT:    v_perm_b32 v1, s6, v1, v5
; VI-NEXT:    s_cselect_b32 s5, s5, 5
; VI-NEXT:    s_lshr_b32 s6, s4, 24
; VI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; VI-NEXT:    s_cmp_lg_u32 s10, 3
...
; VI-NEXT:    v_perm_b32 v0, s6, v0, v4
; VI-NEXT:    v_mov_b32_e32 v4, s4
; VI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; VI-NEXT:    v_perm_b32 v4, s5, v4, v5
; VI-NEXT:    s_mov_b32 s3, 0x1100f000
; VI-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    s_cselect_b32 s5, 0x40200000, s15
; SI-NEXT:    s_cselect_b32 s6, 0, s14
; SI-NEXT:    s_cmp_eq_u32 s4, 0
; SI-NEXT:    s_cselect_b32 s7, 0x40200000, s13
; SI-NEXT:    s_cselect_b32 s8, 0, s12
; SI-NEXT:    s_cmp_eq_u32 s4, 3
; SI-NEXT:    s_cselect_b32 s9, 0x40200000, s19
; SI-NEXT:    s_cselect_b32 s10, 0, s18
; SI-NEXT:    s_cmp_eq_u32 s4, 2
; SI-NEXT:    s_cselect_b32 s4, 0x40200000, s17
; SI-NEXT:    s_cselect_b32 s11, 0, s16
...
; VI-NEXT:    s_cselect_b32 s5, 0x40200000, s15
; VI-NEXT:    s_cselect_b32 s6, 0, s14
; VI-NEXT:    s_cmp_eq_u32 s4, 0
; VI-NEXT:    s_cselect_b32 s7, 0x40200000, s13
; VI-NEXT:    s_cselect_b32 s8, 0, s12
; VI-NEXT:    s_cmp_eq_u32 s4, 3
; VI-NEXT:    s_cselect_b32 s9, 0x40200000, s19
; VI-NEXT:    s_cselect_b32 s10, 0, s18
; VI-NEXT:    s_cmp_eq_u32 s4, 2
; VI-NEXT:    s_cselect_b32 s4, 0x40200000, s17
; VI-NEXT:    s_cselect_b32 s11, 0, s16
