...
; GFX11-REAL16:       ; %bb.0:
; GFX11-REAL16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-REAL16-NEXT:    v_mov_b16_e32 v1.l, v0.l
; GFX11-REAL16-NEXT:    v_perm_b32 v0, 0, v0, 0x10203
; GFX11-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-REAL16-NEXT:    v_perm_b32 v2, 0, v1, 0x10203
