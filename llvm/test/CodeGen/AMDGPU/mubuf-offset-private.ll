...
; GFX9-LABEL: store_private_offset_i8:
; GFX9:       ; %bb.0:
...
; GFX9-NEXT:    buffer_store_byte v0, off, s[12:15], 0 offset:8
...
; GFX9-LABEL: store_private_offset_i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, 5
; GFX9-NEXT:    buffer_store_short v0, off, s[12:15], 0 offset:8
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, 5
; GFX9-NEXT:    buffer_store_dword v0, off, s[12:15], 0 offset:8
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_v2i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    buffer_store_dwordx2 v[0:1], off, s[12:15], 0 offset:8
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_v4i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    buffer_store_dwordx4 v[0:3], off, s[12:15], 0 offset:8
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: load_private_offset_i8:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_ubyte v0, off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: sextload_private_offset_i8:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_sbyte v0, off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-LABEL: zextload_private_offset_i8:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-LABEL: load_private_offset_i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: sextload_private_offset_i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_sshort v0, off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_store_dword v[0:1], v0, off
; GFX9-NEXT:    s_endpgm
  %load = load volatile i16, ptr addrspace(5) inttoptr (i32 8 to ptr addrspace(5))
...
; GFX9-LABEL: zextload_private_offset_i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-LABEL: load_private_offset_i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_dword v0, off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: load_private_offset_v2i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_dwordx2 v[0:1], off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: load_private_offset_v4i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_add_u32 s12, s12, s11
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    buffer_load_dwordx4 v[0:3], off, s[12:15], 0 offset:8 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_i8_max_offset:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    s_addc_u32 s13, s13, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, 5
; GFX9-NEXT:    buffer_store_byte v0, off, s[12:15], 0 offset:4095
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_i8_max_offset_plus1:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 5
; GFX9-NEXT:    buffer_store_byte v1, v0, s[12:15], 0 offen
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_offset_i8_max_offset_plus2:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX9-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX9-NEXT:    s_mov_b32 s14, -1
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x1000
; GFX9-NEXT:    v_mov_b32_e32 v1, 5
; GFX9-NEXT:    buffer_store_byte v1, v0, s[12:15], 0 offen offset:1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
...
; GFX9-LABEL: store_private_unknown_bits_vaddr:
; GFX9:       ; %bb.0:
...
; GFX9-NEXT:    buffer_store_dword v1, v0, s[12:15], 0 offen offset:32
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_endpgm
