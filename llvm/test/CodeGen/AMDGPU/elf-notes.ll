...
; OSABI-UNK-LABEL: elf_notes:
; OSABI-UNK:       ; %bb.0:
; OSABI-UNK-NEXT:    s_endpgm
;
; OSABI-HSA-LABEL: elf_notes:
; OSABI-HSA:       ; %bb.0:
; OSABI-HSA-NEXT:    s_endpgm
;
; OSABI-PAL-LABEL: elf_notes:
; OSABI-PAL:       ; %bb.0:
; OSABI-PAL-NEXT:    s_endpgm
;
; R600-LABEL: elf_notes:
; R600:       ; %bb.0:
; R600-NEXT:    CF_END
; R600-NEXT:    PAD
  ret void
