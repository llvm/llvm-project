...
; CI-NEXT:    ; kill: def $vgpr3 killed $sgpr0 killed $exec
; CI-NEXT:    ; kill: def $vgpr4 killed $sgpr0 killed $exec
; CI-NEXT:    ; kill: def $vgpr5 killed $sgpr0 killed $exec
...
; GFX9-NEXT:    ; kill: def $vgpr4 killed $sgpr0 killed $exec
; GFX9-NEXT:    ; kill: def $vgpr5 killed $sgpr0 killed $exec
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    ds_read2_b32 v[7:8], v3 offset0:1 offset1:2
; GFX9-NEXT:    ; kill: def $vgpr3 killed $sgpr0 killed $exec
