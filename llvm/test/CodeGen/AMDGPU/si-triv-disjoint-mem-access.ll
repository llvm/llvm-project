...
; RUN: llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu7.04 -enable-amdgpu-aa=0 -enable-misched -enable-aa-sched-mi < %s | FileCheck -enable-var-scope -check-prefix=CI %s
; RUN: llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu9.00 -enable-amdgpu-aa=0 -enable-misched -enable-aa-sched-mi < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
...
; CI-NEXT:    s_mov_b32 s4, s0
; CI-NEXT:    s_load_dword s0, s[8:9], 0x1
; CI-NEXT:    s_load_dword s3, s[8:9], 0x3
; CI-NEXT:    v_mov_b32_e32 v0, 0x63
; CI-NEXT:    v_mov_b32_e32 v1, s2
; CI-NEXT:    s_mov_b32 s5, s1
; CI-NEXT:    ds_write_b32 v1, v0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_add_i32 s0, s0, s3
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; CI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_readfirstlane_b32 s4, v0
; GFX9-NEXT:    v_readfirstlane_b32 s5, v1
; GFX9-NEXT:    s_load_dword s3, s[4:5], 0x4
; GFX9-NEXT:    s_load_dword s6, s[4:5], 0xc
...
; CI-NEXT:    s_mov_b32 s4, s0
; CI-NEXT:    s_mov_b32 s5, s1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x1
; CI-NEXT:    v_mov_b32_e32 v1, s2
; CI-NEXT:    s_mov_b32 s6, -1
; CI-NEXT:    ds_write_b32 v1, v0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_load_dwordx2 s[4:5], s[6:7], 0x4
