...
; GCN-NEXT:    v_cmp_lg_f32_e64 s[0:1], s0, v0
...
; GCN-NEXT:    s_cselect_b32 s4, s13, s15
; GCN-NEXT:    s_cselect_b32 s5, s12, s14
...
; GCN-NEXT:    v_cmp_lg_f32_e64 s[0:1], s8, v1
; GCN-NEXT:    s_and_b64 s[0:1], vcc, s[0:1]
; GCN-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GCN-NEXT:    s_cselect_b32 s0, s13, s15
; GCN-NEXT:    s_cselect_b32 s1, s12, s14
; GCN-NEXT:    v_mov_b32_e32 v0, s1
