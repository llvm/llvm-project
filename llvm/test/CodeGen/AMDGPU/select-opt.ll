...
; GCN-NEXT:    s_load_dword s8, s[4:5], 0xf
...
; GCN-NEXT:    s_cmp_lg_u32 s0, s2
; GCN-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[8:9]
; GCN-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[0:1]
; GCN-NEXT:    v_and_b32_e32 v2, v2, v3
...
; GCN-NEXT:    v_cmp_lg_f32_e32 vcc, s0, v1
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN-NEXT:    v_cmp_lg_f32_e32 vcc, s0, v0
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s8, s9
; GCN-NEXT:    v_mov_b32_e32 v0, s15
; GCN-NEXT:    v_mov_b32_e32 v1, s13
; GCN-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GCN-NEXT:    s_cmp_lg_u32 s8, s10
; GCN-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[4:5]
; GCN-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[4:5]
; GCN-NEXT:    v_and_b32_e32 v2, v2, v3
; GCN-NEXT:    v_and_b32_e32 v2, 1, v2
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v2
...
; GCN-NEXT:    v_cmp_lg_f32_e32 vcc, s8, v1
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN-NEXT:    v_cmp_lg_f32_e32 vcc, s8, v0
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_cmp_neq_f32_e64 s[0:1], s0, 1.0
; GCN-NEXT:    s_and_b64 vcc, exec, s[0:1]
; GCN-NEXT:    s_cbranch_vccnz .LBB8_2
; GCN-NEXT:  ; %bb.1: ; %if0
...
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    s_mov_b32 s6, -1
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, 4.0, s[0:1]
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GCN-NEXT:    s_endpgm
entry:
