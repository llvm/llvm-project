...
; CHECK-LABEL: SU(6): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
...
; CHECK-NEXT:     SU(8): Data Latency=1 Reg=$asyncmarker
; CHECK-NEXT:     Pressure Diff
; CHECK-LABEL: SU(8): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
...
;
; CHECK-LABEL: SU(7): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
; CHECK-LABEL:   Predecessors:
; CHECK-LABEL:   Successors:
; CHECK:          SU(8): Anti Latency=0
; CHECK-LABEL: Pressure Diff
...
; CHECK-LABEL:   Successors:
; CHECK:          SU(10): Data Latency=1 Reg=$asyncmarker
; CHECK:          SU(9): Data Latency=1 Reg=$asyncmarker
...
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(9): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
; CHECK-LABEL:   Predecessors:
; CHECK:          SU(8): Data Latency=1 Reg=$asyncmarker
; CHECK-LABEL:   Successors:
; CHECK:          SU(11): Anti Latency=0
; CHECK:          SU(10): Anti Latency=0
; CHECK-LABEL: Pressure Diff
...
; CHECK-NOT:      SU(9): Ord  Latency=0 Barrier
; CHECK-LABEL:   Successors:
; CHECK:          SU(11): Data Latency=1 Reg=$asyncmarker
; CHECK:          SU(11): Anti Latency=0
...
; CHECK-NOT:      Reg=$asyncmarker
; CHECK-NOT:      Reg=$asyncmarker
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(12): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
; CHECK-LABEL:   Predecessors:
; CHECK-LABEL:   Successors:
...
; CHECK-LABEL: Pressure Diff
;
; CHECK-LABEL: SU(16): BUFFER_LOAD_DWORD_LDS_OFFSET_ASYNC{{.*}}implicit $asyncmarker
; CHECK-LABEL:   Predecessors:
; CHECK:          SU(13): Data Latency=1 Reg=$asyncmarker
; CHECK-LABEL:   Successors:
; CHECK:          SU(17): Anti Latency=0
; CHECK:          SU(17): Ord  Latency=0 Barrier
; CHECK-NOT:      Reg=$asyncmarker
