...
; GCN-NEXT:  .LBB0_1: ; %Flow5
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_mov_b32_e32 v0, v4
; GCN-NEXT:    s_setpc_b64 s[30:31]
; GCN-NEXT:  .LBB0_2: ; %itofp-if-end
...
; GCN-NEXT:  .LBB0_11: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB0_12: ; %Flow4
...
; GCN-NEXT:  .LBB1_1: ; %Flow5
; GCN-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-NEXT:    v_mov_b32_e32 v0, v4
; GCN-NEXT:    s_setpc_b64 s[30:31]
; GCN-NEXT:  .LBB1_2: ; %itofp-if-end
...
; GCN-NEXT:  .LBB1_11: ; %Flow
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:  .LBB1_12: ; %Flow4
; GCN-NEXT:    s_or_b64 exec, exec, s[8:9]
