...
; GCN-SDAG-NEXT:    global_load_b128 v[14:17], v[0:1], off offset:16
; GCN-SDAG-NEXT:    global_load_b128 v[18:21], v[0:1], off
; GCN-SDAG-NEXT:    global_load_b128 v[22:25], v[0:1], off offset:48
; GCN-SDAG-NEXT:    global_load_b128 v[6:9], v[0:1], off offset:32
; GCN-SDAG-NEXT:    global_load_b128 v[26:29], v[0:1], off offset:80
; GCN-SDAG-NEXT:    global_load_b128 v[10:13], v[0:1], off offset:64
; GCN-SDAG-NEXT:    global_load_b128 v[30:33], v[0:1], off offset:112
; GCN-SDAG-NEXT:    global_load_b128 v[0:3], v[0:1], off offset:96
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[36:37], 16
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[38:39], 0
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[64:65], 48
; GCN-SDAG-NEXT:    v_dual_mov_b32 v34, 0xc8 :: v_dual_mov_b32 v35, 0
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x7
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[48:49], v[14:15], v[14:15]
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x6
; GCN-SDAG-NEXT:    global_store_b128 v[38:39], v[18:21], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x5
; GCN-SDAG-NEXT:    global_store_b128 v[64:65], v[22:25], off
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[64:65], v[22:23], v[22:23]
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[22:23], 0x60
; GCN-SDAG-NEXT:    global_store_b128 v[36:37], v[14:17], off
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[14:15], 0x70
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[54:55], v[20:21], v[20:21]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[52:53], v[18:19], v[18:19]
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[18:19], 32
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x1
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[20:21], v[32:33], v[32:33]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[66:67], v[24:25], v[24:25]
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[24:25], v[2:3], v[2:3]
; GCN-SDAG-NEXT:    global_store_b128 v[14:15], v[30:33], off
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[32:33], 0x50
; GCN-SDAG-NEXT:    global_store_b128 v[22:23], v[0:3], off
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[2:3], 64
; GCN-SDAG-NEXT:    v_dual_mov_b32 v36, v28 :: v_dual_mov_b32 v37, v29
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[22:23], v[0:1], v[0:1]
; GCN-SDAG-NEXT:    v_dual_mov_b32 v0, v54 :: v_dual_mov_b32 v1, v55
; GCN-SDAG-NEXT:    global_store_b128 v[18:19], v[6:9], off
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[18:19], v[30:31], v[30:31]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[50:51], v[16:17], v[16:17]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[16:17], v[12:13], v[12:13]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[14:15], v[10:11], v[10:11]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[82:83], v[28:29], v[28:29]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[80:81], 0xc8, v[26:27]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[70:71], 0x64, v[8:9]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[68:69], v[6:7], v[6:7]
; GCN-SDAG-NEXT:    s_clause 0x1
; GCN-SDAG-NEXT:    global_store_b128 v[32:33], v[34:37], off
; GCN-SDAG-NEXT:    global_store_b128 v[2:3], v[10:13], off
; GCN-SDAG-NEXT:    s_clause 0x7
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[22:25], off offset:96
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:112
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[14:17], off offset:64
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[80:83], off offset:80
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[68:71], off offset:32
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[64:67], off offset:48
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[52:55], off
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[48:51], off offset:16
; GCN-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
