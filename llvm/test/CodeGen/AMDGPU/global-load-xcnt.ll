...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 -verify-machineinstrs  < %s | FileCheck -check-prefixes=GCN,GCN-SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 -verify-machineinstrs  < %s | FileCheck -check-prefixes=GCN,GCN-GISEL %s
...
; GCN-SDAG-NEXT:    global_load_b128 v[26:29], v[0:1], off offset:48
...
; GCN-SDAG-NEXT:    v_dual_mov_b32 v25, v9 :: v_dual_mov_b32 v24, v8
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[20:21], v[20:21], v[20:21]
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[18:19], v[18:19], v[18:19]
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x4
; GCN-SDAG-NEXT:    global_store_b128 v[48:49], v[26:29], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x3
; GCN-SDAG-NEXT:    global_store_b128 v[50:51], v[14:17], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x2
...
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[26:29], off offset:48
...
; GCN-GISEL-NEXT:    v_dual_mov_b32 v1, v13 :: v_dual_mov_b32 v0, v12
; GCN-GISEL-NEXT:    s_wait_alu 0xfffe
; GCN-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_clause 0x1
; GCN-SDAG-NEXT:    s_load_b128 s[4:7], s[2:3], 0x0
; GCN-SDAG-NEXT:    s_load_b64 s[0:1], s[2:3], 0x10
...
; GCN-SDAG-NEXT:    s_wait_kmcnt 0x0
; GCN-SDAG-NEXT:    global_load_b128 v[0:3], v4, s[4:5] scale_offset
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    global_load_b128 v[4:7], v4, s[6:7] scale_offset
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_clause 0x1
; GCN-GISEL-NEXT:    s_load_b128 s[4:7], s[2:3], 0x0
; GCN-GISEL-NEXT:    s_load_b64 s[0:1], s[2:3], 0x10
...
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[20:21], 12
; GCN-GISEL-NEXT:    s_wait_kmcnt 0x0
; GCN-GISEL-NEXT:    global_load_b128 v[0:3], v4, s[4:5] scale_offset
; GCN-GISEL-NEXT:    s_wait_xcnt 0x0
