...
; GCN-SDAG-NEXT:    global_load_b128 v[34:37], v[0:1], off offset:112
; GCN-SDAG-NEXT:    global_load_b128 v[30:33], v[0:1], off offset:96
...
; GCN-SDAG-NEXT:    global_load_b128 v[10:13], v[0:1], off offset:16
; GCN-SDAG-NEXT:    global_load_b128 v[6:9], v[0:1], off
...
; GCN-SDAG-NEXT:    global_store_b128 v[24:25], v[34:37], off
...
; GCN-SDAG-NEXT:    v_dual_mov_b32 v24, v28 :: v_dual_mov_b32 v25, v29
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[32:33], v[32:33], 0, v[32:33]
...
; GCN-SDAG-NEXT:    global_store_b128 v[52:53], v[18:21], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x3
; GCN-SDAG-NEXT:    global_store_b128 v[54:55], v[14:17], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x2
; GCN-SDAG-NEXT:    global_store_b128 v[40:41], v[10:13], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x1
; GCN-SDAG-NEXT:    global_store_b128 v[42:43], v[6:9], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[26:27], v[26:27], 0, 0xc8
; GCN-SDAG-NEXT:    s_wait_xcnt 0x2
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[16:17], v[16:17], 0, 0x64
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[28:29], v[28:29], 0, v[28:29]
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[20:21], v[20:21], 0, v[20:21]
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[18:19], v[18:19], 0, v[18:19]
; GCN-SDAG-NEXT:    v_lshl_add_u64 v[14:15], v[14:15], 0, v[14:15]
; GCN-SDAG-NEXT:    s_wait_xcnt 0x1
...
; GCN-SDAG-NEXT:    s_clause 0x7
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[30:33], off offset:96
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[34:37], off offset:112
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[50:53], off offset:64
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[26:29], off offset:80
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[14:17], off offset:32
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:48
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[6:9], off
; GCN-SDAG-NEXT:    global_store_b128 v[4:5], v[10:13], off offset:16
; GCN-SDAG-NEXT:    s_clause 0x3
...
; GCN-SDAG-NEXT:    v_dual_mov_b32 v0, v8 :: v_dual_mov_b32 v1, v9
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
; GCN-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
