...
; GCN-SDAG-NEXT:    global_load_b128 v[14:17], v[0:1], off offset:64
...
; GCN-SDAG-NEXT:    global_load_b128 v[30:33], v[0:1], off offset:80
...
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[50:51], 48
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[52:53], 32
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[54:55], 16
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[64:65], 0
; GCN-SDAG-NEXT:    v_mov_b64_e32 v[66:67], 0x50
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
...
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x5
; GCN-SDAG-NEXT:    global_store_b128 v[48:49], v[14:17], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x4
; GCN-SDAG-NEXT:    global_store_b128 v[50:51], v[18:21], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x3
; GCN-SDAG-NEXT:    global_store_b128 v[52:53], v[22:25], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x2
; GCN-SDAG-NEXT:    global_store_b128 v[54:55], v[26:29], off
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x1
; GCN-SDAG-NEXT:    s_wait_xcnt 0x5
; GCN-SDAG-NEXT:    v_dual_mov_b32 v2, v32 :: v_dual_mov_b32 v3, v33
; GCN-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GCN-SDAG-NEXT:    v_add_nc_u64_e32 v[30:31], 0xc8, v[30:31]
; GCN-SDAG-NEXT:    s_wait_xcnt 0x0
...
; GCN-SDAG-NEXT:    global_store_b128 v[64:65], v[34:37], off
; GCN-SDAG-NEXT:    global_store_b128 v[66:67], v[0:3], off
; GCN-SDAG-NEXT:    s_clause 0x7
