...
; RUN: llc -mtriple=amdgpu9.00--amdpal < %s | FileCheck -check-prefixes=GCN,GCN-SELDAG -enable-var-scope %s
; RUN: llc -global-isel -mtriple=amdgpu9.00--amdpal < %s | FileCheck -check-prefixes=GCN,GCN-GISEL -enable-var-scope %s
