; RUN: llc -O0 -asm-verbose=0 -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI -check-prefix=COMMON %s
; RUN: llc -O0 -asm-verbose=0 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=SI -check-prefix=COMMON %s
