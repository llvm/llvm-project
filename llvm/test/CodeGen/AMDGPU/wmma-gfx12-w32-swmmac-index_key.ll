...
define amdgpu_ps void @test_swmmac_f32_16x16x32_f16_index_key_1(<8 x half> %A, <16 x half> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
...
; GFX12-NEXT:    s_endpgm
bb:
  %IndexVec = load <2 x i16>, <2 x i16> addrspace(1)* %IndexVecPtr, align 4
...
define amdgpu_ps void @test_swmmac_f32_16x16x32_bf16_index_key_1(<8 x i16> %A, <16 x i16> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_f16_16x16x32_f16_index_key_1(<8 x half> %A, <16 x half> %B, <8 x half> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x half> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_bf16_16x16x32_bf16_index_key_1(<8 x i16> %A, <16 x i16> %B, <8 x i16> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x i16> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_i32_16x16x32_iu8_index_key_1(<2 x i32> %A, <4 x i32> %B, <8 x i32> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x i32> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_i32_16x16x32_iu4_index_key_1(i32 %A, <2 x i32> %B, <8 x i32> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x i32> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_f32_16x16x32_fp8_fp8_index_key_1(<2 x i32> %A, <4 x i32> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_f32_16x16x32_fp8_bf8_index_key_1(<2 x i32> %A, <4 x i32> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_f32_16x16x32_bf8_fp8_index_key_1(<2 x i32> %A, <4 x i32> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_swmmac_f32_16x16x32_bf8_bf8_index_key_1(<2 x i32> %A, <4 x i32> %B, <8 x float> %C, <2 x i16> addrspace(1)* %IndexVecPtr, <8 x float> addrspace(1)* %out) {
