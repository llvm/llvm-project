...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GCN-GISEL %s
...
; GFX12-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX12-GISEL-TRUE16-NEXT:    v_rcp_f16_e32 v0.l, v0.l
; GFX12-GISEL-TRUE16-NEXT:    v_mul_f16_e32 v0.l, s0, v0.l
...
; GFX12-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX12-GISEL-FAKE16-NEXT:    v_rcp_f16_e32 v0, v0
; GFX12-GISEL-FAKE16-NEXT:    v_mul_f16_e32 v0, s0, v0
