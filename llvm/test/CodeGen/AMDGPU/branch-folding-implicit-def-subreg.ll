...
define amdgpu_kernel void @f1(ptr addrspace(1) %arg, ptr addrspace(1) %arg1, i64 %arg2, i1 %arg3, i1 %arg4, i1 %arg5, i1 %arg6, ptr addrspace(3) %arg7, ptr addrspace(3) %arg8, ptr addrspace(3) %arg9, ptr addrspace(3) %arg10) {
  ...
  ; GFX90A-NEXT:   renamable $vgpr5 = PRED_COPY renamable $sgpr25, implicit $exec
  ...
  ; GFX90A-NEXT: {{  $}}
  ; GFX90A-NEXT:   renamable $vgpr21 = PRED_COPY renamable $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr20 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr23 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr22 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr25 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr24 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr27 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr26 = PRED_COPY $sgpr17, implicit $exec
  ; GFX90A-NEXT: {{  $}}
  ...
  ; GFX90A-NEXT:   renamable $vgpr5 = PRED_COPY renamable $sgpr58, implicit $exec
  ...
  ; GFX90A-NEXT: {{  $}}
  ; GFX90A-NEXT:   renamable $vgpr17 = PRED_COPY killed renamable $sgpr20, implicit $exec
  ; GFX90A-NEXT:   renamable $vgpr19 = PRED_COPY killed renamable $sgpr17, implicit $exec
  ; GFX90A-NEXT:   renamable $sgpr56_sgpr57 = S_MOV_B64 0
  ; GFX90A-NEXT:   renamable $sgpr54_sgpr55 = S_MOV_B64 0
  ; GFX90A-NEXT:   renamable $sgpr52_sgpr53 = S_MOV_B64 0
  ; GFX90A-NEXT:   renamable $sgpr50_sgpr51 = S_MOV_B64 0
  ...
  ; GFX90A-NEXT:   renamable $vgpr0 = PRED_COPY killed renamable $sgpr17, implicit $exec
  ...
  ; GFX90A-NEXT:   renamable $vgpr5 = PRED_COPY renamable $sgpr27, implicit $exec
