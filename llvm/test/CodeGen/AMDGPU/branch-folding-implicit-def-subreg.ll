...
define amdgpu_kernel void @f1(ptr addrspace(1) %arg, ptr addrspace(1) %arg1, i64 %arg2, i1 %arg3, i1 %arg4, i1 %arg5, i1 %arg6, ptr addrspace(3) %arg7, ptr addrspace(3) %arg8, ptr addrspace(3) %arg9, ptr addrspace(3) %arg10) #0 {
  ...
  ; GFX90A-NEXT:   liveins: $sgpr14, $sgpr16, $sgpr17, $vgpr31, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8, $sgpr9, $sgpr10_sgpr11, $sgpr12_sgpr13, $sgpr18_sgpr19, $sgpr28_sgpr29, $sgpr30_sgpr31, $sgpr40_sgpr41, $sgpr56, $sgpr57, $sgpr22_sgpr23, $sgpr20_sgpr21_sgpr22, $sgpr26_sgpr27, $sgpr24_sgpr25_sgpr26, $vgpr4, $vgpr5
  ; GFX90A-NEXT: {{  $}}
  ...
  ; GFX90A-NEXT:   liveins: $sgpr14, $vgpr57, $sgpr16, $sgpr17, $vgpr30, $vgpr31, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8, $sgpr9, $sgpr10_sgpr11, $sgpr12_sgpr13, $sgpr28_sgpr29, $sgpr30_sgpr31, $sgpr34_sgpr35, $sgpr36_sgpr37, $sgpr38_sgpr39, $sgpr40_sgpr41, $sgpr42_sgpr43, $sgpr44_sgpr45, $sgpr46_sgpr47, $sgpr48_sgpr49, $vgpr41, $vgpr42, $sgpr54_sgpr55, $sgpr58_sgpr59, $sgpr60_sgpr61, $vgpr62, $sgpr20_sgpr21_sgpr22, $sgpr26_sgpr27, $sgpr24_sgpr25_sgpr26, $vgpr46, $vgpr56, $vgpr2, $vgpr4, $vgpr5, $vgpr45, $vgpr47, $vgpr43, $vgpr44, $vgpr58, $vgpr60, $vgpr63, $vgpr59, $vgpr61, $vgpr40
  ; GFX90A-NEXT: {{  $}}
