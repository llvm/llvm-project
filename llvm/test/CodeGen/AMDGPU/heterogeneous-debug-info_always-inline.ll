...
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLEE_LIFETIME_I:]], metadata ptr addrspace(5) %I{{.*}})
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLEE_LIFETIME_J:]], metadata ptr addrspace(5) %J{{.*}})
...
entry:
  ...
  call void @llvm.dbg.def(metadata !19, metadata ptr addrspace(5) %I.addr)
  call void @llvm.dbg.def(metadata !21, metadata ptr addrspace(5) %J)
...
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLER0_LIFETIME_I:]], metadata ptr addrspace(5) %I{{.*}})
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLER0_LIFETIME_J:]], metadata ptr addrspace(5) %J{{.*}})
...
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLER1_LIFETIME_I:]], metadata ptr addrspace(5) %I{{.*}})
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLER1_LIFETIME_J:]], metadata ptr addrspace(5) %J{{.*}})
; Function Attrs: convergent mustprogress noinline nounwind optnone
...
; CHECK-DAG: ![[#CALLEE_LIFETIME_I]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_I:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)))
; CHECK-DAG: ![[#CALLEE_LIFETIME_J]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_J:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)), argObjects: {![[#GLOBAL_FRAGMENT]], ![[#GLOBAL_VARIABLE]], ![[#CALLEE_LOCAL_VARIABLE_I]], ![[#CALLEE_LOCAL_FRAGMENT:]]})
...
; CHECK-DAG: ![[#CALLER0_LIFETIME_I]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_I:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)))
; CHECK-DAG: ![[#CALLER0_LIFETIME_J]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_J:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)), argObjects: {![[#GLOBAL_FRAGMENT]], ![[#GLOBAL_VARIABLE]], ![[#CALLEE_LOCAL_VARIABLE_I]], ![[#CALLER0_LOCAL_FRAGMENT:]]})
...
; CHECK-DAG: ![[#CALLER1_LIFETIME_I]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_I:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)))
; CHECK-DAG: ![[#CALLER1_LIFETIME_J]] = distinct !DILifetime(object: ![[#CALLEE_LOCAL_VARIABLE_J:]], location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)), argObjects: {![[#GLOBAL_FRAGMENT]], ![[#GLOBAL_VARIABLE]], ![[#CALLEE_LOCAL_VARIABLE_I]], ![[#CALLER1_LOCAL_FRAGMENT:]]})
...
!19 = distinct !DILifetime(object: !20, location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)))
!20 = !DILocalVariable(name: "I", arg: 1, scope: !12, file: !4, line: 1, type: !15)
!21 = distinct !DILifetime(object: !22, location: !DIExpr(DIOpReferrer(ptr addrspace(5)), DIOpDeref(i32)), argObjects: {!2, !1, !20, !18})
