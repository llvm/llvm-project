...
; GFX11-GCN-REAL16-NEXT:    global_load_u16 v0, v0, s[2:3] glc dlc
; GFX11-GCN-REAL16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GCN-REAL16-NEXT:    v_add_f16_e32 v1.l, 2.0, v1.l
; GFX11-GCN-REAL16-NEXT:    v_add_f16_e32 v1.h, 2.0, v0.l
; GFX11-GCN-REAL16-NEXT:    ;;#ASMSTART
; GFX11-GCN-REAL16-NEXT:    ; use v1
...
; GFX11-GISEL-REAL16-NEXT:    global_load_u16 v0, v0, s[2:3] glc dlc
; GFX11-GISEL-REAL16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-REAL16-NEXT:    v_add_f16_e32 v1.l, 2.0, v1.l
; GFX11-GISEL-REAL16-NEXT:    v_add_f16_e32 v1.h, 2.0, v0.l
; GFX11-GISEL-REAL16-NEXT:    ;;#ASMSTART
; GFX11-GISEL-REAL16-NEXT:    ; use v1
...
; GFX11-GCN-REAL16-NEXT:    global_load_u16 v0, v0, s[2:3] glc dlc
; GFX11-GCN-REAL16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GCN-REAL16-NEXT:    v_subrev_f16_e32 v1.l, 2.0, v1.l
; GFX11-GCN-REAL16-NEXT:    v_add_f16_e32 v1.h, 2.0, v0.l
; GFX11-GCN-REAL16-NEXT:    ;;#ASMSTART
; GFX11-GCN-REAL16-NEXT:    ; use v1
; GFX11-GCN-REAL16-NEXT:    ;;#ASMEND
...
; GFX11-GISEL-REAL16-NEXT:    global_load_u16 v0, v0, s[2:3] glc dlc
; GFX11-GISEL-REAL16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-REAL16-NEXT:    v_subrev_f16_e32 v1.l, 2.0, v1.l
; GFX11-GISEL-REAL16-NEXT:    v_add_f16_e32 v1.h, 2.0, v0.l
; GFX11-GISEL-REAL16-NEXT:    ;;#ASMSTART
; GFX11-GISEL-REAL16-NEXT:    ; use v1
; GFX11-GISEL-REAL16-NEXT:    ;;#ASMEND
