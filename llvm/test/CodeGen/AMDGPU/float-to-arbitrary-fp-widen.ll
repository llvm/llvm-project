...
; GFX1200-NEXT:    v_add_nc_u16 v10.l, v10.l, -1
; GFX1200-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v5.l
; GFX1200-NEXT:    v_sub_nc_u16 v5.l, v8.l, 1 clamp
; GFX1200-NEXT:    v_and_b16 v3.h, v3.h, v11.l
...
; GFX1200-NEXT:    v_or_b16 v6.h, v12.l, v6.h
; GFX1200-NEXT:    v_frexp_exp_i16_f16_e32 v6.l, v1.l
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX1200-NEXT:    v_and_b16 v6.h, v10.l, 1
...
; GFX1200-NEXT:    v_cmp_lt_i16_e64 s2, 3, v4.h
; GFX1200-NEXT:    v_cmp_gt_i16_e64 s0, 1, v3.l
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX1200-NEXT:    v_and_b16 v5.l, v5.l, v6.h
; GFX1200-NEXT:    v_or_b16 v6.h, v4.l, v7.h
...
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cndmask_b16 v3.h, v3.h, v4.l, s0
; GFX1200-NEXT:    v_min_u16 v4.l, v5.h, 15
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b16 v6.h, 0, 4, vcc_lo
; GFX1200-NEXT:    v_lshlrev_b16 v7.h, 7, v8.l
; GFX1200-NEXT:    v_lshlrev_b16 v5.h, 2, v5.l
; GFX1200-NEXT:    v_frexp_mant_f16_e32 v8.l, v1.l
; GFX1200-NEXT:    v_sub_nc_u16 v8.h, v4.l, 1 clamp
...
; GFX1200-NEXT:    v_and_b16 v5.h, v6.h, v9.h
; GFX1200-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v10.l
; GFX1200-NEXT:    v_lshrrev_b16 v9.l, v4.l, v6.h
; GFX1200-NEXT:    v_lshrrev_b16 v8.l, 7, v8.l
; GFX1200-NEXT:    v_cmp_eq_u16_e64 s0, 30, v5.l
; GFX1200-NEXT:    v_cmp_lt_i16_e64 s1, 30, v5.l
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc_lo
; GFX1200-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v5.h
...
; GFX1200-NEXT:    v_add_nc_u16 v4.l, v7.l, v5.h
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cndmask_b16 v2.l, v3.l, v6.h, s1
; GFX1200-NEXT:    v_frexp_exp_i16_f16_e32 v3.l, v1.h
...
; GFX1200-NEXT:    v_sub_nc_u16 v5.l, -5, v3.l
; GFX1200-NEXT:    v_cndmask_b16 v2.l, v2.l, v7.h, s1
...
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc_lo
; GFX1200-NEXT:    v_or_b16 v9.h, v9.h, v4.l
; GFX1200-NEXT:    v_and_b16 v8.l, v10.h, 1
; GFX1200-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v9.l
; GFX1200-NEXT:    v_and_b16 v9.l, v8.h, 1
; GFX1200-NEXT:    v_lshrrev_b16 v7.l, v7.l, v10.l
; GFX1200-NEXT:    v_cmp_o_f16_e64 s0, v2.h, v2.h
; GFX1200-NEXT:    v_cndmask_b16 v2.l, v2.l, v6.h, s1
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc_lo
; GFX1200-NEXT:    v_or_b16 v9.l, v11.l, v9.l
; GFX1200-NEXT:    v_cmp_gt_i16_e32 vcc_lo, 1, v5.h
...
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b16 v2.h, v9.h, v4.h, vcc_lo
; GFX1200-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v5.l
; GFX1200-NEXT:    v_cmp_lt_i16_e64 s3, 30, v5.h
; GFX1200-NEXT:    v_and_b16 v4.h, v7.l, v8.l
...
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cndmask_b16 v2.h, v2.h, v4.h, s1
; GFX1200-NEXT:    v_cmp_eq_f16_e64 s1, 0, v1.l
; GFX1200-NEXT:    v_lshlrev_b16 v7.l, 7, v8.l
...
; GFX1200-NEXT:    v_frexp_mant_f16_e32 v8.l, v0.l
...
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b16 v4.l, v6.h, v4.l, vcc_lo
; GFX1200-NEXT:    v_cmp_lt_i16_e32 vcc_lo, 3, v5.l
...
; GFX1200-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s2
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cndmask_b16 v1.l, v4.l, v4.h, s0
; GFX1200-NEXT:    v_frexp_exp_i16_f16_e32 v4.l, v0.h
; GFX1200-NEXT:    v_cmp_ne_u16_e64 s0, 0, v6.h
; GFX1200-NEXT:    v_lshrrev_b16 v8.h, 8, v9.l
; GFX1200-NEXT:    v_or_b16 v5.l, v10.l, v5.l
; GFX1200-NEXT:    v_lshrrev_b16 v8.l, 7, v8.l
; GFX1200-NEXT:    v_sub_nc_u16 v9.l, -5, v4.l
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s0
; GFX1200-NEXT:    v_cmp_ne_u16_e64 s0, 0, v6.l
; GFX1200-NEXT:    v_and_b16 v5.l, v7.h, v5.l
; GFX1200-NEXT:    v_and_b16 v6.h, v8.h, 1
; GFX1200-NEXT:    v_min_u16 v6.l, v9.l, 15
; GFX1200-NEXT:    v_mov_b16_e32 v9.l, v10.l
...
; GFX1200-NEXT:    v_cmp_ne_u16_e64 s1, 0, v8.l
; GFX1200-NEXT:    v_lshrrev_b16 v8.h, 8, v9.l
; GFX1200-NEXT:    v_lshrrev_b16 v8.l, v6.l, v6.h
; GFX1200-NEXT:    v_and_b16 v7.l, v6.h, v7.l
; GFX1200-NEXT:    v_cndmask_b16 v1.l, v1.l, v4.h, s3
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
...
; GFX1200-NEXT:    v_or_b16 v9.l, v10.l, v9.l
; GFX1200-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s2
; GFX1200-NEXT:    v_lshrrev_b16 v6.h, v9.h, v6.h
; GFX1200-NEXT:    v_cndmask_b16 v3.l, v3.l, 0, s0
; GFX1200-NEXT:    v_mov_b16_e32 v7.l, v11.l
; GFX1200-NEXT:    v_cndmask_b16 v5.l, v5.l, 0, s1
; GFX1200-NEXT:    v_mov_b16_e32 v10.l, v12.l
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b16 v2.h, 0x7e, v2.h, vcc_lo
; GFX1200-NEXT:    v_lshlrev_b16 v2.l, 8, v2.l
; GFX1200-NEXT:    v_add_nc_u16 v4.h, v5.h, v7.l
; GFX1200-NEXT:    v_and_b16 v5.h, v7.h, v9.l
...
; GFX1200-NEXT:    v_or_b16 v1.h, v7.h, v3.l
...
; GFX1200-NEXT:    v_cndmask_b16 v4.h, v6.h, 0, s1
; GFX1200-NEXT:    v_lshlrev_b16 v7.h, 2, v3.l
; GFX1200-NEXT:    v_cndmask_b16 v5.h, v5.h, 0, s2
; GFX1200-NEXT:    s_and_b32 s1, s5, s4
; GFX1200-NEXT:    v_or_b16 v5.l, v7.l, v5.l
; GFX1200-NEXT:    v_cndmask_b16 v1.h, v4.l, v1.h, s3
; GFX1200-NEXT:    v_or_b16 v6.h, v7.l, v7.h
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX1200-NEXT:    v_lshlrev_b16 v1.l, 8, v1.l
; GFX1200-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0.l, v0.l
; GFX1200-NEXT:    v_cndmask_b16 v1.h, v1.h, v5.l, s0
; GFX1200-NEXT:    v_cmp_o_f16_e64 s0, v0.h, v0.h
; GFX1200-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX1200-NEXT:    v_cndmask_b16 v0.l, v3.l, v4.l, s1
; GFX1200-NEXT:    v_or_b16 v4.l, v3.h, v2.l
; GFX1200-NEXT:    v_or_b16 v2.h, v2.h, v1.l
; GFX1200-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX1200-NEXT:    v_cndmask_b16 v0.h, 0x7e, v1.h, vcc_lo
