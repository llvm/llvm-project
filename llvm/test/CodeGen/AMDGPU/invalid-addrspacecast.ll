...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsad -mcpu=gfx700 < %s | FileCheck --check-prefixes=CHECK,SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx700 < %s | FileCheck --check-prefixes=CHECK,GISEL %s
