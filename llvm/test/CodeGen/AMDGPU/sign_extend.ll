...
; RUN: llc -mtriple=amdgpu6.00-- -amdgpu-scalarize-global-loads=false < %s | FileCheck %s -allow-deprecated-dag-overlap -enable-var-scope --check-prefix=SI
; RUN: llc -mtriple=amdgpu8.02-- -amdgpu-scalarize-global-loads=false -mattr=-flat-for-global < %s | FileCheck %s -allow-deprecated-dag-overlap -enable-var-scope --check-prefix=VI
...
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_bfe_i64 s[0:1], s[2:3], 0x100000
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    v_mov_b32_e32 v1, s1
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; SI-NEXT:    s_endpgm
...
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_ashr_i32 s0, s2, 24
; SI-NEXT:    s_bfe_i32 s1, s2, 0x80010
; SI-NEXT:    s_bfe_i32 s3, s2, 0x80008
...
; VI-NEXT:    s_bfe_i32 s3, s2, 0x80008
