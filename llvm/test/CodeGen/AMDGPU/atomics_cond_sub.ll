...
; GFX12-SDAG-NEXT:    s_load_b32 s0, s[0:1], 0x2c
...
; GFX12-SDAG-NEXT:    s_load_b64 s[2:3], s[0:1], 0x24
; GFX12-SDAG-NEXT:    s_load_b32 s4, s[0:1], 0x2c
...
; GFX12-GISEL-NEXT:    s_load_b32 s4, s[0:1], 0x2c
...
; GFX12-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v1, s4
; GFX12-SDAG-NEXT:    global_atomic_cond_sub_u32 v1, v0, v1, s[2:3] offset:16 th:TH_ATOMIC_RETURN
...
; GFX12-GISEL-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s4
; GFX12-GISEL-NEXT:    global_atomic_cond_sub_u32 v0, v1, v0, s[2:3] offset:16 th:TH_ATOMIC_RETURN
