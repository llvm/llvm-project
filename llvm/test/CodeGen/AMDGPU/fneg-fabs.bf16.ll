...
; GFX11-NEXT:    v_sub_f32_e64 v0, s2, s1
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_or_b32 s1, s2, 0x8000
; GFX11-NEXT:    s_and_b32 s2, s2, 0xffff0000
; GFX11-NEXT:    s_lshl_b32 s1, s1, 16
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mul_f32_e64 v0, s2, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    v_bfe_u32 v1, v0, 16, 1
; GFX11-NEXT:    v_or_b32_e32 v2, 0x400000, v0
; GFX11-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
...
; VI-NEXT:    v_add_f32_e64 v1, s1, 1.0
...
; GFX11-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_and_b32 s1, s2, 0xffff0000
...
; GFX11-FAKE16-NEXT:    v_add_f32_e64 v1, s1, 2.0
; GFX11-FAKE16-NEXT:    s_mov_b32 s1, 0
...
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_and_b32 s0, s0, 0xffff
; CI-NEXT:    s_or_b32 s1, s3, 0x80008000
...
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_and_b32 s0, 0xffff, s3
...
; GFX11-NEXT:    s_bitset1_b32 s1, 15
...
; GFX11-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_and_b32 s1, s2, 0x7fff0000
; GFX11-TRUE16-NEXT:    s_and_b32 s2, s2, 0x7fff
; GFX11-TRUE16-NEXT:    v_mul_f32_e64 v0, s1, -4.0
; GFX11-TRUE16-NEXT:    s_lshl_b32 s1, s2, 16
; GFX11-TRUE16-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX11-TRUE16-NEXT:    v_mul_f32_e64 v1, s1, -4.0
; GFX11-TRUE16-NEXT:    s_mov_b32 s1, 0
; GFX11-TRUE16-NEXT:    v_bfe_u32 v2, v0, 16, 1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v4, 0x400000, v0
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
...
; GFX11-FAKE16-NEXT:    s_and_b32 s1, s2, 0x7fff0000
; GFX11-FAKE16-NEXT:    v_mul_f32_e64 v1, s1, -4.0
; GFX11-FAKE16-NEXT:    s_mov_b32 s1, 0
