...
; CI-NEXT:    v_sub_f32_e32 v2, s1, v2
...
; VI-NEXT:    v_sub_f32_e32 v2, s1, v2
...
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    s_lshl_b32 s0, s2, 16
; CI-NEXT:    v_mov_b32_e32 v1, s1
; CI-NEXT:    s_and_b32 s1, s2, 0xffff0000
; CI-NEXT:    v_mov_b32_e32 v2, s0
; CI-NEXT:    v_mul_f32_e64 v2, s1, -|v2|
; CI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; CI-NEXT:    flat_store_short v[0:1], v2
; CI-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_or_b32 s3, s2, 0x8000
; GFX11-NEXT:    s_and_b32 s2, s2, 0xffff0000
; GFX11-NEXT:    s_lshl_b32 s3, s3, 16
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; CIVI-LABEL: fneg_fabs_free_bf16:
; CIVI:       ; %bb.0:
...
; CI-NEXT:    v_add_f32_e64 v2, s2, 2.0
; CI-NEXT:    v_add_f32_e64 v1, s0, 1.0
; CI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
...
; VI-NEXT:    v_add_f32_e64 v1, s0, 1.0
...
; VI-NEXT:    v_add_f32_e64 v2, s0, 2.0
; VI-NEXT:    v_bfe_u32 v3, v2, 16, 1
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v2
; VI-NEXT:    v_add_u32_e32 v3, vcc, 0x7fff, v3
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v2
...
; VI-NEXT:    v_cndmask_b32_e32 v2, v3, v4, vcc
; VI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_lshrrev_b64 v[2:3], 16, v[1:2]
; VI-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX11-TRUE16-NEXT:    v_add_f32_e64 v0, s3, 2.0
; GFX11-TRUE16-NEXT:    v_add_f32_e64 v1, s2, 1.0
...
; GFX11-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_lshl_b32 s3, s2, 16
; GFX11-FAKE16-NEXT:    s_and_b32 s2, s2, 0xffff0000
; GFX11-FAKE16-NEXT:    v_add_f32_e64 v0, s3, 1.0
; GFX11-FAKE16-NEXT:    v_add_f32_e64 v1, s2, 2.0
...
; CIVI-LABEL: s_fneg_fabs_v2bf16_bc_src:
; CIVI:       ; %bb.0:
; CIVI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; CIVI-NEXT:    s_add_i32 s12, s12, s17
; CIVI-NEXT:    s_mov_b32 flat_scratch_lo, s13
...
; CI-NEXT:    v_mul_f32_e64 v1, s0, -4.0
; CI-NEXT:    v_lshr_b64 v[2:3], v[1:2], 16
; CI-NEXT:    v_mov_b32_e32 v1, s1
; CI-NEXT:    flat_store_dword v[0:1], v2
; CI-NEXT:    s_endpgm
...
; VI-NEXT:    s_and_b32 s0, s2, 0x7fff
; VI-NEXT:    s_lshl_b32 s0, s0, 16
; VI-NEXT:    v_mul_f32_e64 v1, s0, -4.0
; VI-NEXT:    v_bfe_u32 v2, v1, 16, 1
; VI-NEXT:    v_add_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_add_u32_e32 v2, vcc, 0x7fff, v2
; VI-NEXT:    v_or_b32_e32 v3, 0x400000, v1
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; VI-NEXT:    s_and_b32 s0, s2, 0x7fff0000
; VI-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; VI-NEXT:    v_mul_f32_e64 v2, s0, -4.0
; VI-NEXT:    v_bfe_u32 v3, v2, 16, 1
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v2
; VI-NEXT:    v_add_u32_e32 v3, vcc, 0x7fff, v3
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v2
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s3, s2, 0x7fff
; GFX9-NEXT:    s_and_b32 s2, s2, 0x7fff0000
; GFX9-NEXT:    v_mul_f32_e64 v1, s2, -4.0
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v2, v2, v1
; GFX9-NEXT:    v_or_b32_e32 v3, 0x400000, v1
; GFX9-NEXT:    v_add_u32_e32 v2, 0x7fff, v2
...
; GFX11-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_and_b32 s3, s2, 0x7fff0000
; GFX11-TRUE16-NEXT:    s_and_b32 s2, s2, 0x7fff
; GFX11-TRUE16-NEXT:    v_mul_f32_e64 v0, s3, -4.0
; GFX11-TRUE16-NEXT:    s_lshl_b32 s2, s2, 16
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_mul_f32_e64 v1, s2, -4.0
; GFX11-TRUE16-NEXT:    v_bfe_u32 v2, v0, 16, 1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v4, 0x400000, v0
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
...
; GFX11-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_and_b32 s3, s2, 0x7fff
; GFX11-FAKE16-NEXT:    s_and_b32 s2, s2, 0x7fff0000
; GFX11-FAKE16-NEXT:    s_lshl_b32 s3, s3, 16
; GFX11-FAKE16-NEXT:    v_mul_f32_e64 v1, s2, -4.0
; GFX11-FAKE16-NEXT:    v_mul_f32_e64 v0, s3, -4.0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_bfe_u32 v3, v1, 16, 1
; GFX11-FAKE16-NEXT:    v_bfe_u32 v2, v0, 16, 1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v4, 0x400000, v0
