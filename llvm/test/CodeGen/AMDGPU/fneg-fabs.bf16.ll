...
; GFX9-NEXT:    s_endpgm
;
; GFX11-TRUE16-LABEL: fneg_fabs_v4bf16:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_lshr_b32 s5, s3, 16
; GFX11-TRUE16-NEXT:    s_lshr_b32 s4, s2, 16
; GFX11-TRUE16-NEXT:    s_bitset1_b32 s3, 15
; GFX11-TRUE16-NEXT:    s_bitset1_b32 s5, 15
; GFX11-TRUE16-NEXT:    s_bitset1_b32 s4, 15
; GFX11-TRUE16-NEXT:    v_or_b32_e64 v0, 0x8000, s2
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s2, s3, s5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s2
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.h, s4
; GFX11-TRUE16-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX11-TRUE16-NEXT:    s_endpgm
;
; GFX11-FAKE16-LABEL: fneg_fabs_v4bf16:
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FAKE16-NEXT:    s_lshr_b32 s4, s2, 16
; GFX11-FAKE16-NEXT:    s_lshr_b32 s5, s3, 16
; GFX11-FAKE16-NEXT:    s_bitset1_b32 s3, 15
; GFX11-FAKE16-NEXT:    s_bitset1_b32 s2, 15
; GFX11-FAKE16-NEXT:    s_bitset1_b32 s4, 15
; GFX11-FAKE16-NEXT:    s_bitset1_b32 s5, 15
