...
; RUN: llc -global-isel -mtriple=amdgpu11.00 -mattr=+real-true16 < %s | FileCheck %s --check-prefixes=GFX11,GISEL-GFX11,GISEL-GFX11-TRUE16
; RUN: llc -global-isel -mtriple=amdgpu11.00 -mattr=-real-true16 < %s | FileCheck %s --check-prefixes=GFX11,GISEL-GFX11,GISEL-GFX11-FAKE16
...
;
; GISEL-GFX11-TRUE16-LABEL: test_llvm_amdgcn_fdot2_bf16_bf16:
...
; GISEL-GFX11-TRUE16-NEXT:    v_dot2_bf16_bf16 v0.l, s2, s3, v0.l
; GISEL-GFX11-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GISEL-GFX11-TRUE16-NEXT:    s_endpgm
;
; GISEL-GFX11-FAKE16-LABEL: test_llvm_amdgcn_fdot2_bf16_bf16:
...
; GISEL-GFX11-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX11-FAKE16-NEXT:    v_dot2_bf16_bf16 v1, s2, s3, v1
...
; SDAG-GFX11-FAKE16-NEXT:    s_endpgm
;
; GISEL-GFX11-TRUE16-LABEL: test_llvm_amdgcn_fdot2_bf16_bf16_dpp:
; GISEL-GFX11-TRUE16:       ; %bb.0: ; %entry
...
; GISEL-GFX11-TRUE16-NEXT:    v_dot2_bf16_bf16 v0.l, v1, v2, v0.l
; GISEL-GFX11-TRUE16-NEXT:    scratch_store_b16 off, v0, s0
; GISEL-GFX11-TRUE16-NEXT:    s_endpgm
;
; GISEL-GFX11-FAKE16-LABEL: test_llvm_amdgcn_fdot2_bf16_bf16_dpp:
; GISEL-GFX11-FAKE16:       ; %bb.0: ; %entry
...
; GISEL-GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GISEL-GFX11-FAKE16-NEXT:    v_dot2_bf16_bf16_e64_dpp v0, v0, v1, v2 quad_perm:[1,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
...
; GISEL-GFX11-TRUE16-NEXT:    s_endpgm
;
; GISEL-GFX11-FAKE16-LABEL: test_llvm_amdgcn_fdot2_bf16_bf16_sis:
; GISEL-GFX11-FAKE16:       ; %bb.0: ; %entry
; GISEL-GFX11-FAKE16-NEXT:    v_mov_b32_e32 v2, s1
; GISEL-GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-GFX11-FAKE16-NEXT:    v_dot2_bf16_bf16 v2, s0, 0x3f803f80, v2
