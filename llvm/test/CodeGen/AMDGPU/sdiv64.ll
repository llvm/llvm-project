...
; GCN-NEXT:    s_ashr_i32 s4, s11, 8
; GCN-NEXT:    s_mov_b32 s1, s9
; GCN-NEXT:    s_xor_b32 s9, s4, s5
; GCN-NEXT:    s_ashr_i32 s9, s9, 31
; GCN-NEXT:    s_flbit_i32 s10, s5
; GCN-NEXT:    s_ashr_i32 s7, s6, 31
; GCN-NEXT:    s_ashr_i32 s6, s6, 8
; GCN-NEXT:    s_add_i32 s9, s9, 32
; GCN-NEXT:    s_add_i32 s10, s10, -1
; GCN-NEXT:    s_min_u32 s9, s10, s9
; GCN-NEXT:    s_xor_b32 s10, s6, s7
; GCN-NEXT:    s_ashr_i32 s10, s10, 31
; GCN-NEXT:    s_flbit_i32 s11, s7
; GCN-NEXT:    s_add_i32 s10, s10, 32
; GCN-NEXT:    s_add_i32 s11, s11, -1
; GCN-NEXT:    s_min_u32 s10, s11, s10
; GCN-NEXT:    s_mov_b32 s0, s8
; GCN-NEXT:    s_xor_b32 s8, s4, s6
; GCN-NEXT:    s_lshl_b64 s[6:7], s[6:7], s10
; GCN-NEXT:    s_min_u32 s6, s6, 1
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    s_lshl_b64 s[4:5], s[4:5], s9
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s6
; GCN-NEXT:    s_min_u32 s4, s4, 1
; GCN-NEXT:    s_or_b32 s4, s5, s4
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GCN-NEXT:    s_sub_i32 s4, 32, s10
; GCN-NEXT:    v_ldexp_f32_e64 v0, v0, s4
; GCN-NEXT:    v_rcp_f32_e32 v2, v0
; GCN-NEXT:    s_sub_i32 s4, 32, s9
...
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i32 s5, s11, 31
; GCN-IR-NEXT:    s_ashr_i32 s4, s11, 8
; GCN-IR-NEXT:    s_mov_b32 s1, s9
; GCN-IR-NEXT:    s_xor_b32 s9, s4, s5
; GCN-IR-NEXT:    s_ashr_i32 s9, s9, 31
; GCN-IR-NEXT:    s_flbit_i32 s10, s5
; GCN-IR-NEXT:    s_ashr_i32 s7, s6, 31
; GCN-IR-NEXT:    s_ashr_i32 s6, s6, 8
; GCN-IR-NEXT:    s_add_i32 s9, s9, 32
; GCN-IR-NEXT:    s_add_i32 s10, s10, -1
; GCN-IR-NEXT:    s_min_u32 s9, s10, s9
; GCN-IR-NEXT:    s_xor_b32 s10, s6, s7
; GCN-IR-NEXT:    s_ashr_i32 s10, s10, 31
; GCN-IR-NEXT:    s_flbit_i32 s11, s7
; GCN-IR-NEXT:    s_add_i32 s10, s10, 32
; GCN-IR-NEXT:    s_add_i32 s11, s11, -1
; GCN-IR-NEXT:    s_min_u32 s10, s11, s10
; GCN-IR-NEXT:    s_mov_b32 s0, s8
; GCN-IR-NEXT:    s_xor_b32 s8, s4, s6
; GCN-IR-NEXT:    s_lshl_b64 s[6:7], s[6:7], s10
; GCN-IR-NEXT:    s_min_u32 s6, s6, 1
; GCN-IR-NEXT:    s_or_b32 s6, s7, s6
; GCN-IR-NEXT:    s_lshl_b64 s[4:5], s[4:5], s9
...
; GCN-NEXT:    v_lshl_b64 v[3:4], v[2:3], s4
; GCN-NEXT:    s_sub_i32 s4, 32, s4
; GCN-NEXT:    v_min_u32_e32 v0, 1, v3
...
; GCN-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GCN-NEXT:    v_mul_lo_u32 v3, v3, v0
...
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v2
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v4, vcc
; GCN-NEXT:    v_sub_i32_e64 v3, s[4:5], v1, v2
...
; GCN-IR-NEXT:    v_lshl_b64 v[3:4], v[2:3], s4
; GCN-IR-NEXT:    s_sub_i32 s4, 32, s4
; GCN-IR-NEXT:    v_min_u32_e32 v0, 1, v3
; GCN-IR-NEXT:    v_or_b32_e32 v0, v4, v0
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v3, vcc, 0, v2
...
; GCN-IR-NEXT:    v_mul_lo_u32 v3, v3, v0
; GCN-IR-NEXT:    v_mul_hi_u32 v3, v0, v3
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v0, v3
; GCN-IR-NEXT:    v_mul_hi_u32 v0, v1, v0
; GCN-IR-NEXT:    v_mul_u32_u24_e32 v3, v0, v2
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 1, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v1, vcc, v1, v3
; GCN-IR-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v2
; GCN-IR-NEXT:    v_cndmask_b32_e32 v0, v0, v4, vcc
; GCN-IR-NEXT:    v_sub_i32_e64 v3, s[4:5], v1, v2
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i32 s5, s11, 31
; GCN-NEXT:    s_ashr_i32 s4, s11, 9
; GCN-NEXT:    s_mov_b32 s1, s9
; GCN-NEXT:    s_xor_b32 s9, s4, s5
; GCN-NEXT:    s_ashr_i32 s9, s9, 31
; GCN-NEXT:    s_flbit_i32 s10, s5
; GCN-NEXT:    s_ashr_i32 s7, s6, 31
; GCN-NEXT:    s_ashr_i32 s6, s6, 9
; GCN-NEXT:    s_add_i32 s9, s9, 32
; GCN-NEXT:    s_add_i32 s10, s10, -1
; GCN-NEXT:    s_min_u32 s9, s10, s9
; GCN-NEXT:    s_xor_b32 s10, s6, s7
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i32 s5, s11, 31
; GCN-IR-NEXT:    s_ashr_i32 s4, s11, 9
; GCN-IR-NEXT:    s_mov_b32 s1, s9
; GCN-IR-NEXT:    s_xor_b32 s9, s4, s5
; GCN-IR-NEXT:    s_ashr_i32 s9, s9, 31
; GCN-IR-NEXT:    s_flbit_i32 s10, s5
; GCN-IR-NEXT:    s_ashr_i32 s7, s6, 31
; GCN-IR-NEXT:    s_ashr_i32 s6, s6, 9
; GCN-IR-NEXT:    s_add_i32 s9, s9, 32
; GCN-IR-NEXT:    s_add_i32 s10, s10, -1
; GCN-IR-NEXT:    s_min_u32 s9, s10, s9
; GCN-IR-NEXT:    s_xor_b32 s10, s6, s7
...
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i32 s7, s9, 31
; GCN-NEXT:    s_ashr_i32 s6, s9, 8
; GCN-NEXT:    s_ashr_i32 s5, s11, 31
; GCN-NEXT:    s_ashr_i32 s4, s11, 8
; GCN-NEXT:    s_ashr_i32 s11, s13, 31
; GCN-NEXT:    s_ashr_i32 s10, s13, 8
; GCN-NEXT:    s_xor_b32 s13, s6, s7
; GCN-NEXT:    s_ashr_i32 s13, s13, 31
; GCN-NEXT:    s_flbit_i32 s14, s7
; GCN-NEXT:    s_add_i32 s13, s13, 32
; GCN-NEXT:    s_add_i32 s14, s14, -1
; GCN-NEXT:    s_min_u32 s13, s14, s13
; GCN-NEXT:    s_xor_b32 s14, s10, s11
; GCN-NEXT:    s_ashr_i32 s9, s15, 31
; GCN-NEXT:    s_ashr_i32 s8, s15, 8
; GCN-NEXT:    s_ashr_i32 s14, s14, 31
; GCN-NEXT:    s_flbit_i32 s15, s11
; GCN-NEXT:    s_add_i32 s14, s14, 32
; GCN-NEXT:    s_add_i32 s15, s15, -1
; GCN-NEXT:    s_min_u32 s14, s15, s14
; GCN-NEXT:    s_xor_b32 s12, s6, s10
; GCN-NEXT:    s_lshl_b64 s[10:11], s[10:11], s14
; GCN-NEXT:    s_min_u32 s10, s10, 1
; GCN-NEXT:    s_or_b32 s10, s11, s10
; GCN-NEXT:    s_lshl_b64 s[6:7], s[6:7], s13
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s10
; GCN-NEXT:    s_min_u32 s6, s6, 1
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s6
; GCN-NEXT:    s_sub_i32 s6, 32, s14
; GCN-NEXT:    v_ldexp_f32_e64 v0, v0, s6
; GCN-NEXT:    v_rcp_f32_e32 v2, v0
; GCN-NEXT:    s_sub_i32 s6, 32, s13
; GCN-NEXT:    v_ldexp_f32_e64 v1, v1, s6
; GCN-NEXT:    s_ashr_i32 s12, s12, 30
; GCN-NEXT:    v_mul_f32_e32 v2, v1, v2
; GCN-NEXT:    v_trunc_f32_e32 v2, v2
; GCN-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GCN-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GCN-NEXT:    s_or_b32 s10, s12, 1
...
; GCN-NEXT:    s_xor_b32 s6, s4, s8
; GCN-NEXT:    s_ashr_i32 s10, s6, 30
; GCN-NEXT:    s_xor_b32 s6, s4, s5
; GCN-NEXT:    s_ashr_i32 s6, s6, 31
; GCN-NEXT:    s_flbit_i32 s7, s5
; GCN-NEXT:    s_add_i32 s6, s6, 32
; GCN-NEXT:    s_add_i32 s7, s7, -1
; GCN-NEXT:    s_min_u32 s11, s7, s6
; GCN-NEXT:    s_xor_b32 s6, s8, s9
; GCN-NEXT:    s_ashr_i32 s6, s6, 31
; GCN-NEXT:    s_flbit_i32 s7, s9
; GCN-NEXT:    s_add_i32 s6, s6, 32
; GCN-NEXT:    s_add_i32 s7, s7, -1
; GCN-NEXT:    s_min_u32 s12, s7, s6
; GCN-NEXT:    s_lshl_b64 s[6:7], s[8:9], s12
; GCN-NEXT:    s_min_u32 s6, s6, 1
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    s_lshl_b64 s[4:5], s[4:5], s11
; GCN-NEXT:    v_cvt_f32_i32_e32 v2, s6
; GCN-NEXT:    s_min_u32 s4, s4, 1
; GCN-NEXT:    s_or_b32 s4, s5, s4
; GCN-NEXT:    v_cvt_f32_i32_e32 v3, s4
; GCN-NEXT:    s_sub_i32 s4, 32, s12
; GCN-NEXT:    v_ldexp_f32_e64 v2, v2, s4
; GCN-NEXT:    v_rcp_f32_e32 v4, v2
; GCN-NEXT:    s_sub_i32 s4, 32, s11
; GCN-NEXT:    v_ldexp_f32_e64 v3, v3, s4
; GCN-NEXT:    s_or_b32 s6, s10, 1
...
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i32 s7, s9, 31
; GCN-IR-NEXT:    s_ashr_i32 s6, s9, 8
; GCN-IR-NEXT:    s_ashr_i32 s5, s11, 31
; GCN-IR-NEXT:    s_ashr_i32 s4, s11, 8
; GCN-IR-NEXT:    s_ashr_i32 s11, s13, 31
; GCN-IR-NEXT:    s_ashr_i32 s10, s13, 8
; GCN-IR-NEXT:    s_xor_b32 s13, s6, s7
; GCN-IR-NEXT:    s_ashr_i32 s13, s13, 31
; GCN-IR-NEXT:    s_flbit_i32 s14, s7
; GCN-IR-NEXT:    s_add_i32 s13, s13, 32
; GCN-IR-NEXT:    s_add_i32 s14, s14, -1
; GCN-IR-NEXT:    s_min_u32 s13, s14, s13
; GCN-IR-NEXT:    s_xor_b32 s14, s10, s11
; GCN-IR-NEXT:    s_ashr_i32 s9, s15, 31
; GCN-IR-NEXT:    s_ashr_i32 s8, s15, 8
; GCN-IR-NEXT:    s_ashr_i32 s14, s14, 31
; GCN-IR-NEXT:    s_flbit_i32 s15, s11
; GCN-IR-NEXT:    s_add_i32 s14, s14, 32
; GCN-IR-NEXT:    s_add_i32 s15, s15, -1
; GCN-IR-NEXT:    s_min_u32 s14, s15, s14
; GCN-IR-NEXT:    s_xor_b32 s12, s6, s10
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[10:11], s14
; GCN-IR-NEXT:    s_min_u32 s10, s10, 1
; GCN-IR-NEXT:    s_or_b32 s10, s11, s10
; GCN-IR-NEXT:    s_lshl_b64 s[6:7], s[6:7], s13
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s10
; GCN-IR-NEXT:    s_min_u32 s6, s6, 1
; GCN-IR-NEXT:    s_or_b32 s6, s7, s6
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v1, s6
; GCN-IR-NEXT:    s_sub_i32 s6, 32, s14
; GCN-IR-NEXT:    v_ldexp_f32_e64 v0, v0, s6
; GCN-IR-NEXT:    v_rcp_f32_e32 v2, v0
; GCN-IR-NEXT:    s_sub_i32 s6, 32, s13
; GCN-IR-NEXT:    v_ldexp_f32_e64 v1, v1, s6
; GCN-IR-NEXT:    s_ashr_i32 s12, s12, 30
; GCN-IR-NEXT:    v_mul_f32_e32 v2, v1, v2
; GCN-IR-NEXT:    v_trunc_f32_e32 v2, v2
; GCN-IR-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GCN-IR-NEXT:    s_or_b32 s10, s12, 1
; GCN-IR-NEXT:    v_cmp_ge_f32_e64 s[6:7], |v1|, |v0|
; GCN-IR-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GCN-IR-NEXT:    s_cselect_b32 s6, s10, 0
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, s6, v2
; GCN-IR-NEXT:    s_xor_b32 s6, s4, s8
; GCN-IR-NEXT:    s_ashr_i32 s10, s6, 30
; GCN-IR-NEXT:    s_xor_b32 s6, s4, s5
; GCN-IR-NEXT:    s_ashr_i32 s6, s6, 31
; GCN-IR-NEXT:    s_flbit_i32 s7, s5
; GCN-IR-NEXT:    s_add_i32 s6, s6, 32
; GCN-IR-NEXT:    s_add_i32 s7, s7, -1
; GCN-IR-NEXT:    s_min_u32 s11, s7, s6
; GCN-IR-NEXT:    s_xor_b32 s6, s8, s9
; GCN-IR-NEXT:    s_ashr_i32 s6, s6, 31
; GCN-IR-NEXT:    s_flbit_i32 s7, s9
; GCN-IR-NEXT:    s_add_i32 s6, s6, 32
; GCN-IR-NEXT:    s_add_i32 s7, s7, -1
; GCN-IR-NEXT:    s_min_u32 s12, s7, s6
; GCN-IR-NEXT:    s_lshl_b64 s[6:7], s[8:9], s12
; GCN-IR-NEXT:    s_min_u32 s6, s6, 1
; GCN-IR-NEXT:    s_or_b32 s6, s7, s6
; GCN-IR-NEXT:    s_lshl_b64 s[4:5], s[4:5], s11
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v2, s6
; GCN-IR-NEXT:    s_min_u32 s4, s4, 1
; GCN-IR-NEXT:    s_or_b32 s4, s5, s4
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v3, s4
; GCN-IR-NEXT:    s_sub_i32 s4, 32, s12
; GCN-IR-NEXT:    v_ldexp_f32_e64 v2, v2, s4
; GCN-IR-NEXT:    v_rcp_f32_e32 v4, v2
; GCN-IR-NEXT:    s_sub_i32 s4, 32, s11
; GCN-IR-NEXT:    v_ldexp_f32_e64 v3, v3, s4
; GCN-IR-NEXT:    s_or_b32 s6, s10, 1
...
; GCN-NEXT:    s_xor_b32 s2, s8, s9
; GCN-NEXT:    s_flbit_i32 s3, s9
; GCN-NEXT:    s_ashr_i32 s2, s2, 31
; GCN-NEXT:    s_add_i32 s3, s3, -1
; GCN-NEXT:    s_add_i32 s2, s2, 32
; GCN-NEXT:    s_min_u32 s4, s3, s2
; GCN-NEXT:    s_lshl_b64 s[2:3], s[8:9], s4
; GCN-NEXT:    s_min_u32 s2, s2, 1
; GCN-NEXT:    s_or_b32 s2, s3, s2
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GCN-NEXT:    s_sub_i32 s3, 32, s4
; GCN-NEXT:    s_mov_b32 s2, 0x41c00000
; GCN-NEXT:    s_mov_b32 s4, s0
; GCN-NEXT:    v_ldexp_f32_e64 v0, v0, s3
; GCN-NEXT:    v_rcp_f32_e32 v1, v0
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    s_or_b32 s3, s9, 1
...
; GCN-IR-NEXT:    s_xor_b32 s2, s8, s9
; GCN-IR-NEXT:    s_flbit_i32 s3, s9
; GCN-IR-NEXT:    s_ashr_i32 s2, s2, 31
; GCN-IR-NEXT:    s_add_i32 s3, s3, -1
; GCN-IR-NEXT:    s_add_i32 s2, s2, 32
; GCN-IR-NEXT:    s_min_u32 s4, s3, s2
; GCN-IR-NEXT:    s_lshl_b64 s[2:3], s[8:9], s4
; GCN-IR-NEXT:    s_min_u32 s2, s2, 1
; GCN-IR-NEXT:    s_or_b32 s2, s3, s2
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GCN-IR-NEXT:    s_sub_i32 s3, 32, s4
; GCN-IR-NEXT:    s_mov_b32 s2, 0x41c00000
; GCN-IR-NEXT:    s_mov_b32 s4, s0
; GCN-IR-NEXT:    v_ldexp_f32_e64 v0, v0, s3
; GCN-IR-NEXT:    v_rcp_f32_e32 v1, v0
; GCN-IR-NEXT:    s_mov_b32 s5, s1
; GCN-IR-NEXT:    s_or_b32 s3, s9, 1
...
; GCN-NEXT:    s_ashr_i32 s8, s3, 8
; GCN-NEXT:    s_mov_b32 s4, s0
; GCN-NEXT:    s_xor_b32 s0, s8, s9
; GCN-NEXT:    s_ashr_i32 s0, s0, 31
; GCN-NEXT:    s_flbit_i32 s2, s9
; GCN-NEXT:    s_add_i32 s0, s0, 32
; GCN-NEXT:    s_add_i32 s2, s2, -1
; GCN-NEXT:    s_min_u32 s0, s2, s0
; GCN-NEXT:    s_lshl_b64 s[2:3], s[8:9], s0
; GCN-NEXT:    s_min_u32 s2, s2, 1
; GCN-NEXT:    s_or_b32 s2, s3, s2
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GCN-NEXT:    s_sub_i32 s0, 32, s0
; GCN-NEXT:    s_mov_b32 s5, s1
; GCN-NEXT:    s_or_b32 s2, s9, 1
...
; GCN-IR-NEXT:    s_ashr_i32 s8, s3, 8
; GCN-IR-NEXT:    s_mov_b32 s4, s0
; GCN-IR-NEXT:    s_xor_b32 s0, s8, s9
; GCN-IR-NEXT:    s_ashr_i32 s0, s0, 31
; GCN-IR-NEXT:    s_flbit_i32 s2, s9
; GCN-IR-NEXT:    s_add_i32 s0, s0, 32
; GCN-IR-NEXT:    s_add_i32 s2, s2, -1
; GCN-IR-NEXT:    s_min_u32 s0, s2, s0
; GCN-IR-NEXT:    s_lshl_b64 s[2:3], s[8:9], s0
; GCN-IR-NEXT:    s_min_u32 s2, s2, 1
; GCN-IR-NEXT:    s_or_b32 s2, s3, s2
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GCN-IR-NEXT:    s_sub_i32 s0, 32, s0
; GCN-IR-NEXT:    s_mov_b32 s5, s1
; GCN-IR-NEXT:    s_or_b32 s2, s9, 1
...
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v1, v2
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GCN-IR-NEXT:    v_ffbh_i32_e32 v3, v2
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, 32, v0
; GCN-IR-NEXT:    v_add_i32_e32 v3, vcc, -1, v3
; GCN-IR-NEXT:    v_min_u32_e32 v3, v3, v0
; GCN-IR-NEXT:    v_lshl_b64 v[0:1], v[1:2], v3
...
; GCN-IR-NEXT:    v_sub_i32_e32 v1, vcc, 32, v3
; GCN-IR-NEXT:    v_or_b32_e32 v2, 1, v2
; GCN-IR-NEXT:    v_ldexp_f32_e32 v0, v0, v1
; GCN-IR-NEXT:    v_rcp_f32_e32 v1, v0
; GCN-IR-NEXT:    v_mul_f32_e32 v1, 0x41c00000, v1
; GCN-IR-NEXT:    v_trunc_f32_e32 v1, v1
; GCN-IR-NEXT:    v_mad_f32 v3, -v1, v0, s4
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v1, v1
...
; GCN-IR-NEXT:    v_or_b32_e32 v0, v1, v0
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GCN-IR-NEXT:    v_or_b32_e32 v1, 1, v2
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, 32, v3
; GCN-IR-NEXT:    v_ldexp_f32_e32 v0, v0, v2
