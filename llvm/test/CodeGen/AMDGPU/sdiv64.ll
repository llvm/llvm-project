...
; GCN-IR-NEXT:    s_min_u32 s20, s9, s14
; GCN-IR-NEXT:    s_sub_u32 s16, s8, s20
...
; GCN-IR-NEXT:    s_add_u32 s12, s12, s20
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v10, v2
...
; GCN-IR-NEXT:    v_not_b32_e32 v7, 0
; GCN-IR-NEXT:    v_mov_b32_e32 v10, 0
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, v6, v2
...
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, v16, v8
; GCN-IR-NEXT:    v_subb_u32_e32 v2, vcc, v17, v9, vcc
...
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v12, v0
; GCN-IR-NEXT:    v_xor_b32_e32 v1, v12, v1
; GCN-IR-NEXT:    v_sub_i32_e32 v2, vcc, v0, v12
; GCN-IR-NEXT:    v_subb_u32_e32 v3, vcc, v1, v12, vcc
...
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v14, v8
; GCN-IR-NEXT:    v_subb_u32_e32 v0, vcc, v15, v9, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v10, v4
...
; GCN-IR-NEXT:    v_lshr_b64 v[6:7], v[4:5], v7
; GCN-IR-NEXT:    v_add_i32_e32 v4, vcc, 0xffffffcf, v0
