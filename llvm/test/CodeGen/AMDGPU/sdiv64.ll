...
; GCN-IR-NEXT:    s_sub_u32 s10, s14, s16
...
; GCN-IR-NEXT:    s_or_b64 s[20:21], s[18:19], s[20:21]
; GCN-IR-NEXT:    s_and_b64 s[18:19], s[20:21], exec
; GCN-IR-NEXT:    s_cselect_b32 s19, 0, s13
; GCN-IR-NEXT:    s_cselect_b32 s18, 0, s12
...
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[20:21], s[18:19], 0
; GCN-IR-NEXT:    s_sub_i32 s10, 63, s10
; GCN-IR-NEXT:    s_andn2_b64 vcc, exec, s[20:21]
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[12:13], s10
; GCN-IR-NEXT:    s_cbranch_vccz .LBB0_4
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    s_lshr_b64 s[18:19], s[12:13], s18
; GCN-IR-NEXT:    s_add_u32 s17, s6, -1
...
; GCN-IR-NEXT:    s_sub_u32 s8, s17, s18
; GCN-IR-NEXT:    s_subb_u32 s8, s20, s19
...
; GCN-IR-NEXT:    s_sub_u32 s18, s18, s14
; GCN-IR-NEXT:    s_subb_u32 s19, s19, s15
...
; GCN-IR-NEXT:    s_or_b64 s[18:19], s[8:9], s[6:7]
; GCN-IR-NEXT:  .LBB0_5: ; %udiv-end
; GCN-IR-NEXT:    s_xor_b64 s[0:1], s[2:3], s[0:1]
; GCN-IR-NEXT:    s_xor_b64 s[2:3], s[18:19], s[0:1]
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v0, v4
; GCN-IR-NEXT:    v_subb_u32_e32 v9, vcc, v1, v4, vcc
...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v11, v9, 0, s[4:5]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v10, v8, 0, s[4:5]
...
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[8:9], v2
...
; GCN-IR-NEXT:    v_lshr_b64 v[14:15], v[8:9], v14
; GCN-IR-NEXT:    v_addc_u32_e32 v17, vcc, -1, v1, vcc
; GCN-IR-NEXT:    v_not_b32_e32 v8, v12
; GCN-IR-NEXT:    v_not_b32_e32 v9, 0
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, v8, v13
...
; GCN-IR-NEXT:    v_lshrrev_b32_e32 v10, 31, v3
; GCN-IR-NEXT:    v_or_b32_e32 v14, v14, v10
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v10, vcc, v16, v14
; GCN-IR-NEXT:    v_subb_u32_e32 v10, vcc, v17, v15, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v11, v11, v1
...
; GCN-IR-NEXT:    v_xor_b32_e32 v3, v10, v0
; GCN-IR-NEXT:    v_xor_b32_e32 v2, v11, v1
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    buffer_store_short v0, off, s[8:11], 0 offset:4
...
; GCN-IR-NEXT:    s_cselect_b32 s12, 0, 24
...
; GCN-IR-NEXT:    s_xor_b64 s[6:7], s[12:13], s[4:5]
