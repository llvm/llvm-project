...
; GFX9-NEXT:    v_and_b32_e32 v5, 0xffff, v6
...
; VI-NEXT:    v_lshlrev_b32_e32 v9, 1, v9
...
; CI-NEXT:    v_cndmask_b32_e32 v5, v2, v0, vcc
; CI-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; CI-NEXT:    v_lshlrev_b32_e32 v2, 1, v3
; CI-NEXT:    buffer_store_short v4, off, s[0:3], 0 offset:2
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v5, off, s[0:3], 0
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v1, off, s[8:11], 0 offset:2
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    buffer_store_short v0, off, s[8:11], 0
; CI-NEXT:    s_waitcnt vmcnt(0)
