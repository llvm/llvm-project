...
; RUN: llc -global-isel=0 -mtriple=amdgpu11.70 < %s | FileCheck -check-prefixes=GCN,GFX1170 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu11.70 < %s | FileCheck -check-prefixes=GCN,GFX1170 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GCN,GFX12 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GCN,GFX12 %s
