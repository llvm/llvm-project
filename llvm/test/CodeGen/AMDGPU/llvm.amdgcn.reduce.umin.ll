...
;
; GFX11DAGISEL-LABEL: uniform_value:
...
; GFX8DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8DAGISEL-NEXT:    s_mov_b32 s1, -1
; GFX8DAGISEL-NEXT:  .LBB2_4: ; =>This Inner Loop Header: Depth=1
; GFX8DAGISEL-NEXT:    s_ff1_i32_b64 s6, s[2:3]
; GFX8DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX8DAGISEL-NEXT:    s_bitset0_b64 s[2:3], s6
; GFX8DAGISEL-NEXT:    s_min_u32 s1, s1, s7
; GFX8DAGISEL-NEXT:    s_cmp_lg_u64 s[2:3], 0
...
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_load_dword s1, s[4:5], 0x2c
; GFX8GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mov_b32 s6, s1
...
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_ff1_i32_b64 s1, s[4:5]
; GFX8GISEL-NEXT:    v_readlane_b32 s7, v0, s1
; GFX8GISEL-NEXT:    s_bitset0_b64 s[4:5], s1
; GFX8GISEL-NEXT:    s_min_u32 s6, s6, s7
...
; GFX9DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX9DAGISEL-NEXT:    s_mov_b32 s1, -1
; GFX9DAGISEL-NEXT:  .LBB2_4: ; =>This Inner Loop Header: Depth=1
; GFX9DAGISEL-NEXT:    s_ff1_i32_b64 s6, s[2:3]
; GFX9DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX9DAGISEL-NEXT:    s_bitset0_b64 s[2:3], s6
; GFX9DAGISEL-NEXT:    s_min_u32 s1, s1, s7
; GFX9DAGISEL-NEXT:    s_cmp_lg_u64 s[2:3], 0
; GFX9DAGISEL-NEXT:    s_cbranch_scc1 .LBB2_4
; GFX9DAGISEL-NEXT:  ; %bb.5:
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_load_dword s1, s[4:5], 0x2c
; GFX9GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mov_b32 s6, s1
...
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_ff1_i32_b64 s1, s[4:5]
; GFX9GISEL-NEXT:    v_readlane_b32 s7, v0, s1
; GFX9GISEL-NEXT:    s_bitset0_b64 s[4:5], s1
; GFX9GISEL-NEXT:    s_min_u32 s6, s6, s7
...
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX1064DAGISEL-NEXT:    s_mov_b32 s1, -1
; GFX1064DAGISEL-NEXT:  .LBB2_4: ; =>This Inner Loop Header: Depth=1
; GFX1064DAGISEL-NEXT:    s_ff1_i32_b64 s6, s[2:3]
; GFX1064DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX1064DAGISEL-NEXT:    s_bitset0_b64 s[2:3], s6
; GFX1064DAGISEL-NEXT:    s_min_u32 s1, s1, s7
; GFX1064DAGISEL-NEXT:    s_cmp_lg_u64 s[2:3], 0
; GFX1064DAGISEL-NEXT:    s_cbranch_scc1 .LBB2_4
; GFX1064DAGISEL-NEXT:  ; %bb.5:
; GFX1064DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX1064DAGISEL-NEXT:  .LBB2_6: ; %endif
; GFX1064DAGISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX1064DAGISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX1064DAGISEL-NEXT:    s_mov_b32 s1, 0
...
; GFX1064GISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    s_load_dword s1, s[4:5], 0x2c
; GFX1064GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    s_mov_b32 s1, s1
...
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    s_mov_b32 s1, -1
; GFX1064GISEL-NEXT:  .LBB2_4: ; =>This Inner Loop Header: Depth=1
; GFX1064GISEL-NEXT:    s_ff1_i32_b64 s6, s[4:5]
; GFX1064GISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX1064GISEL-NEXT:    s_bitset0_b64 s[4:5], s6
; GFX1064GISEL-NEXT:    s_min_u32 s1, s1, s7
...
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX1064GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1064GISEL-NEXT:    s_mov_b32 s1, 0
; GFX1064GISEL-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX1064GISEL-NEXT:    s_endpgm
;
...
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX1032DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, s1
; GFX1032DAGISEL-NEXT:  ; %bb.1: ; %else
; GFX1032DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1032DAGISEL-NEXT:  ; %bb.2: ; %Flow
; GFX1032DAGISEL-NEXT:    s_or_saveexec_b32 s1, s1
; GFX1032DAGISEL-NEXT:    v_mov_b32_e32 v1, s2
; GFX1032DAGISEL-NEXT:    s_xor_b32 exec_lo, exec_lo, s1
...
; GFX1032DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s1
...
; GFX1032GISEL-NEXT:    s_andn2_saveexec_b32 s2, s2
...
; GFX1032GISEL-NEXT:    v_readlane_b32 s5, v0, s4
; GFX1032GISEL-NEXT:    s_bitset0_b32 s3, s4
; GFX1032GISEL-NEXT:    s_min_u32 s1, s1, s5
; GFX1032GISEL-NEXT:    s_cmp_lg_u32 s3, 0
...
; GFX1164GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1164GISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX1164GISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_load_b32 s1, s[4:5], 0x2c
; GFX1164GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_mov_b32 s1, s1
...
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_mov_b32 s1, -1
; GFX1164GISEL-NEXT:  .LBB2_4: ; =>This Inner Loop Header: Depth=1
; GFX1164GISEL-NEXT:    s_ctz_i32_b64 s6, s[4:5]
; GFX1164GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164GISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX1164GISEL-NEXT:    s_bitset0_b64 s[4:5], s6
; GFX1164GISEL-NEXT:    s_min_u32 s1, s1, s7
...
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1164GISEL-NEXT:    s_mov_b32 s1, 0
; GFX1164GISEL-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX1164GISEL-NEXT:    s_endpgm
...
; GFX1132DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, s1
...
; GFX1132DAGISEL-NEXT:    s_or_saveexec_b32 s1, s1
; GFX1132DAGISEL-NEXT:    v_mov_b32_e32 v1, s2
; GFX1132DAGISEL-NEXT:    s_xor_b32 exec_lo, exec_lo, s1
...
; GFX1132DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s1
