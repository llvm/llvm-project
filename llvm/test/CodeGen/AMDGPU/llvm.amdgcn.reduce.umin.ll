...
; GFX8DAGISEL-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8DAGISEL-NEXT:    ; implicit-def: $sgpr0
; GFX8DAGISEL-NEXT:    s_cmov_b64 exec, vcc
; GFX8DAGISEL-NEXT:    s_cbranch_scc0 .LBB4_2
; GFX8DAGISEL-NEXT:  ; %bb.1: ; %else
; GFX8DAGISEL-NEXT:    s_load_dword s0, s[2:3], 0x2c
...
; GFX8DAGISEL-NEXT:    s_xor_b64 s[0:1], s[4:5], exec
...
; GFX8GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX8GISEL-NEXT:    s_load_dword s0, s[2:3], 0x2c
; GFX8GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mov_b32 s6, s0
; GFX8GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX8GISEL-NEXT:  .LBB4_2: ; %Flow
; GFX8GISEL-NEXT:    s_xor_b64 s[0:1], s[4:5], exec
...
; GFX9GISEL-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX9GISEL-NEXT:    s_load_dword s0, s[2:3], 0x2c
; GFX9GISEL-NEXT:    ; implicit-def: $vgpr0
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mov_b32 s6, s0
; GFX9GISEL-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX9GISEL-NEXT:  .LBB4_2: ; %Flow
; GFX9GISEL-NEXT:    s_xor_b64 s[0:1], s[4:5], exec
...
; GFX1032DAGISEL-NEXT:    ; implicit-def: $sgpr0
; GFX1032DAGISEL-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1032DAGISEL-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032DAGISEL-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032DAGISEL-NEXT:    s_cbranch_scc0 .LBB4_2
; GFX1032DAGISEL-NEXT:  ; %bb.1: ; %else
; GFX1032DAGISEL-NEXT:    s_load_dword s0, s[2:3], 0x2c
; GFX1032DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1032DAGISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; GFX1032DAGISEL-NEXT:  .LBB4_2: ; %Flow
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    v_mov_b32_e32 v1, s0
; GFX1032DAGISEL-NEXT:    s_xor_b32 s0, s1, exec_lo
; GFX1032DAGISEL-NEXT:    s_cmp_lg_u32 s1, 0
; GFX1032DAGISEL-NEXT:    s_cmov_b32 exec_lo, s1
...
; GFX1032GISEL-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX1032GISEL-NEXT:    s_xor_b32 s1, s4, exec_lo
...
; GFX1164GISEL-NEXT:    s_xor_b64 s[0:1], s[4:5], exec
...
; GFX1132GISEL-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX1132GISEL-NEXT:    s_xor_b32 s1, s4, exec_lo
