...
; GFX13-NEXT:    v_dual_mov_b32 v21, 0 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
...
; GFX13-NEXT:    v_dual_mov_b32 v8, s3 :: v_dual_mov_b32 v5, s0
; GFX13-NEXT:    v_mov_b32_e32 v7, s2
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v0
; GFX13-NEXT:    v_cndmask_b32_e64 v0, 0, 0x3c003c00, vcc_lo
; GFX13-NEXT:    v_dual_mov_b32 v6, s1 :: v_dual_mov_b32 v1, v0
; GFX13-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_mov_b32 v3, v0
