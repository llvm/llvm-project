...
; CHECK-NEXT:    ; implicit-def: $vgpr43_vgpr44_vgpr45
; CHECK-NEXT:    flat_store_dwordx2 v[58:59], a[32:33]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[54:55]
; CHECK-NEXT:    flat_load_dwordx2 a[34:35], v[58:59]
; CHECK-NEXT:    v_mov_b32_e32 v60, 0
; CHECK-NEXT:    v_mov_b32_e32 v61, 0x3ff00000
; CHECK-NEXT:    s_mov_b64 s[4:5], s[48:49]
; CHECK-NEXT:    s_mov_b64 s[6:7], s[38:39]
; CHECK-NEXT:    s_mov_b64 s[8:9], s[50:51]
...
; CHECK-NEXT:    flat_store_dwordx2 v[46:47], v[60:61]
; CHECK-NEXT:    flat_store_dwordx2 v[58:59], a[32:33]
