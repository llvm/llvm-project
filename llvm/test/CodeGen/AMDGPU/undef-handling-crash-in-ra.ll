...
; CHECK-NEXT:    v_pk_mov_b32 v[60:61], s[4:5], s[4:5] op_sel:[0,1]
...
; CHECK-NEXT:    flat_load_dwordx2 v[62:63], v[56:57]
...
; CHECK-NEXT:    v_pk_mov_b32 v[0:1], s[66:67], s[66:67] op_sel:[0,1]
; CHECK-NEXT:    flat_store_dwordx2 v[56:57], v[62:63]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx2 v[56:57], v[0:1]
