...
; RUN: llc -mtriple=amdgpu6.00 -amdgpu-remove-redundant-endcf -amdgpu-codegenprepare-break-large-phis=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s

; Disabled endcf collapse at -O0.
; RUN: llc -mtriple=amdgpu6.00 -O0 -amdgpu-remove-redundant-endcf -amdgpu-codegenprepare-break-large-phis=0 < %s | FileCheck -enable-var-scope -check-prefix=GCN-O0 %s
...
; GCN-NEXT:    v_add_i32_e32 v1, vcc, s4, v2
; GCN-NEXT:    v_cmp_ne_u32_e64 s[0:1], 2, v0
; GCN-NEXT:    buffer_store_dword v3, v[2:3], s[4:7], 0 addr64
; GCN-NEXT:    s_and_b64 exec, exec, s[0:1]
; GCN-NEXT:    s_cbranch_execz .LBB0_3
; GCN-NEXT:  ; %bb.2: ; %bb.inner.then
; GCN-NEXT:    v_mov_b32_e32 v0, s5
; GCN-NEXT:    v_addc_u32_e32 v2, vcc, 0, v0, vcc
...
; GCN-O0-NEXT:    ; kill: def $sgpr4_5 killed $sgpr4_5 def $sgpr4_7
...
; GCN-O0-NEXT:    ; kill: def $sgpr0_1 killed $sgpr0_1 def $sgpr0_3
...
; GCN-NEXT:    s_mov_b32 s6, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_add_i32_e32 v3, vcc, s4, v1
; GCN-NEXT:    v_cmp_lt_u32_e64 s[0:1], 1, v0
; GCN-NEXT:    buffer_store_dword v2, v[1:2], s[4:7], 0 addr64
