...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1200 -mattr=+wavefrontsize64 -stop-after=instruction-select -o - %s | FileCheck -check-prefixes=GFX12 %s
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %vindex, i32 %voffset, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset_vindex0(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset_voffset_add4095(<4 x i32> inreg %rsrc, i32 %vindex, i32 %voffset.base, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[COPY5:%[0-9]+]]:vgpr(i32) = COPY $vgpr1
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:sgpr(i32) = COPY $sgpr6
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 4095, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[COPY5:%[0-9]+]]:vgpr(i32) = COPY $vgpr1
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:sgpr(i32) = COPY $sgpr6
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 4095, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; UNPACKED-NEXT:   [[COPY5:%[0-9]+]]:vgpr(i32) = COPY $vgpr1
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:sgpr(i32) = COPY $sgpr6
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 4095, 78, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
