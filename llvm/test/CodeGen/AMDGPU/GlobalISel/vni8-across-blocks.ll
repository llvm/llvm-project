...
; GFX906-NEXT:    s_mov_b32 s6, 0xff0000
...
; GFX906-NEXT:    v_and_or_b32 v4, v4, s6, v5
...
; GFX906-NEXT:    v_and_or_b32 v4, v0, s6, v2
...
; GFX906-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x34
; GFX906-NEXT:    v_mov_b32_e32 v0, 0
; GFX906-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(0)
; GFX906-NEXT:    global_store_dwordx4 v0, v[1:4], s[0:1]
...
; GFX906-NEXT:    v_cmp_gt_u32_e32 vcc, 15, v0
; GFX906-NEXT:    s_xor_b64 s[6:7], vcc, s[6:7]
; GFX906-NEXT:    s_waitcnt lgkmcnt(0)
; GFX906-NEXT:    global_load_dwordx2 v[1:2], v3, s[0:1]
; GFX906-NEXT:    s_and_saveexec_b64 s[0:1], vcc
...
; GFX906-NEXT:    s_andn2_b64 s[2:3], s[6:7], exec
; GFX906-NEXT:    s_and_b64 s[6:7], exec, vcc
; GFX906-NEXT:    s_or_b64 s[6:7], s[2:3], s[6:7]
; GFX906-NEXT:  .LBB8_2: ; %Flow
; GFX906-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX906-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX906-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
