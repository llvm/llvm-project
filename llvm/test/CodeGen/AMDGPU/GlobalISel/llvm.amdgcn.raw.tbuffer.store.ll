...
; RUN: llc -global-isel -mtriple=amdgpu10.10-mesa-mesa3d -stop-after=instruction-select -o - %s | FileCheck -check-prefix=GFX10_GFX11 %s
; RUN: llc -global-isel -mtriple=amdgpu11.00-mesa-mesa3d -stop-after=instruction-select -o - %s | FileCheck -check-prefix=GFX10_GFX11 %s
