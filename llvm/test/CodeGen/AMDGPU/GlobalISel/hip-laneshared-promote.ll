...
; CHECK-NEXT: [[T2:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[V1]], 2, implicit-def $scc
; CHECK-NEXT: $idx1 = S_SET_GPR_IDX_U32 [[T2]]
; CHECK-NEXT: [[T3:%[0-9]+]]:vgpr_32 = V_LOAD_IDX $idx1, 0, 1, implicit $exec
; CHECK-NEXT: [[T5:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[VX]], 2, implicit-def $scc
; CHECK-NEXT: $idx1 = S_SET_GPR_IDX_U32 [[T5]]
; CHECK-NEXT: V_STORE_IDX [[T3]], $idx1, 3, 1, implicit $exec
; CHECK-NEXT: [[T7:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[VX]], 2, implicit-def $scc
; CHECK-NEXT: $idx1 = S_SET_GPR_IDX_U32 [[T7]]
; CHECK-NEXT: [[T8:%[0-9]+]]:vgpr_32 = V_LOAD_IDX $idx1, 5, 1, implicit $exec
; CHECK-NEXT: [[V2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 0
; CHECK-NEXT: [[T10:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[V2]], 2, implicit-def $scc
