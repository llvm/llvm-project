...
; RUN: llc -global-isel -mtriple=amdgpu12.00-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX12-UNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu12.00-amd-amdpal -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX12-NOUNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu12.50-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX1250,GFX1250-UNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu12.50-amd-amdpal -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX1250,GFX1250-NOUNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-UNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdpal -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-NOUNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu7.01-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-UNALIGNED %s
; RUN: llc -global-isel -mtriple=amdgpu7.01-amd-amdpal -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-NOUNALIGNED %s
...
; GFX1250-UNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-UNALIGNED-NEXT:    v_nop
; GFX1250-UNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
...
; GFX1250-NOUNALIGNED-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-NOUNALIGNED-NEXT:    v_nop
; GFX1250-NOUNALIGNED-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-NOUNALIGNED-NEXT:    s_clause 0xb
