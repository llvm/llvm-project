...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX12-UNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX12-NOUNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX1250,GFX1250-UNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GFX12,GFX1250,GFX1250-NOUNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-UNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=gfx900 -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9-NOUNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=hawaii -mattr=+unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-UNALIGNED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-amd-amdpal -mcpu=hawaii -mattr=-unaligned-access-mode < %s | FileCheck -check-prefixes=GCN,GFX7,GFX7-NOUNALIGNED %s
...
; GFX12-UNALIGNED-NEXT:    s_wait_bvhcnt 0x0
; GFX12-UNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX12-UNALIGNED-NEXT:    global_load_b96 v[12:14], v[0:1], off
; GFX12-UNALIGNED-NEXT:    s_wait_loadcnt 0x0
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v1, 8, v12
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v3, 24, v12
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v5, 8, v13
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v7, 24, v13
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v9, 8, v14
; GFX12-UNALIGNED-NEXT:    v_lshrrev_b32_e32 v11, 24, v14
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v0.l, v12.l
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v2.l, v12.h
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v4.l, v13.l
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v6.l, v13.h
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v8.l, v14.l
; GFX12-UNALIGNED-NEXT:    v_mov_b16_e32 v10.l, v14.h
; GFX12-UNALIGNED-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NOUNALIGNED-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NOUNALIGNED-NEXT:    s_wait_kmcnt 0x0
; GFX12-NOUNALIGNED-NEXT:    global_load_b96 v[12:14], v[0:1], off
; GFX12-NOUNALIGNED-NEXT:    s_wait_loadcnt 0x0
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v1, 8, v12
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v3, 24, v12
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v5, 8, v13
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v7, 24, v13
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v9, 8, v14
; GFX12-NOUNALIGNED-NEXT:    v_lshrrev_b32_e32 v11, 24, v14
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v0.l, v12.l
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v2.l, v12.h
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v4.l, v13.l
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v6.l, v13.h
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v8.l, v14.l
; GFX12-NOUNALIGNED-NEXT:    v_mov_b16_e32 v10.l, v14.h
; GFX12-NOUNALIGNED-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_b96 v[12:14], v[0:1], off nv
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_lshrrev_b32 v1, 8, v12 :: v_dual_lshrrev_b32 v3, 24, v12
; GFX1250-NEXT:    v_dual_lshrrev_b32 v5, 8, v13 :: v_dual_lshrrev_b32 v7, 24, v13
; GFX1250-NEXT:    v_dual_lshrrev_b32 v9, 8, v14 :: v_dual_lshrrev_b32 v11, 24, v14
; GFX1250-NEXT:    v_mov_b16_e32 v0.l, v12.l
; GFX1250-NEXT:    v_mov_b16_e32 v2.l, v12.h
; GFX1250-NEXT:    v_mov_b16_e32 v4.l, v13.l
; GFX1250-NEXT:    v_mov_b16_e32 v6.l, v13.h
; GFX1250-NEXT:    v_mov_b16_e32 v8.l, v14.l
; GFX1250-NEXT:    v_mov_b16_e32 v10.l, v14.h
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_lshrrev_b32_e32 v13, 8, v0
; GFX6-NEXT:    v_lshrrev_b32_e32 v12, 16, v0
; GFX6-NEXT:    v_lshrrev_b32_e32 v3, 24, v0
...
; GFX6-NEXT:    v_mov_b32_e32 v1, v13
; GFX6-NEXT:    v_mov_b32_e32 v2, v12
; GFX6-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1250-UNALIGNED:       ; %bb.0:
; GFX1250-UNALIGNED-NEXT:    global_wb
; GFX1250-UNALIGNED-NEXT:    v_nop
...
; GFX1250-NOUNALIGNED:       ; %bb.0:
; GFX1250-NOUNALIGNED-NEXT:    global_wb
; GFX1250-NOUNALIGNED-NEXT:    v_nop
...
; GFX1250-NEXT:    ; return to shader part epilog
;
; GCN-LABEL: s_load_constant_v12i8_align8:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx4 s[12:15], s[0:1], 0x0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_lshr_b32 s1, s12, 8
; GCN-NEXT:    s_lshr_b32 s2, s12, 16
; GCN-NEXT:    s_lshr_b32 s3, s12, 24
; GCN-NEXT:    s_lshr_b32 s5, s13, 8
; GCN-NEXT:    s_lshr_b32 s6, s13, 16
; GCN-NEXT:    s_lshr_b32 s7, s13, 24
; GCN-NEXT:    s_lshr_b32 s9, s14, 8
; GCN-NEXT:    s_lshr_b32 s10, s14, 16
; GCN-NEXT:    s_lshr_b32 s11, s14, 24
; GCN-NEXT:    s_mov_b32 s0, s12
; GCN-NEXT:    s_mov_b32 s4, s13
; GCN-NEXT:    s_mov_b32 s8, s14
