...
; GFX8-NEXT:    v_mov_b32_e32 v1, 0x3fff000
; GFX8-NEXT:    buffer_load_dword v0, v1, s[0:3], 16 offen offset:4092
...
; GFX1250-NEXT:    v_mov_b32_e32 v1, 0x3800000
...
; GFX1250-NEXT:    buffer_load_b32 v0, v1, s[0:3], s4 offen offset:8388604
...
; GFX8-NEXT:    s_mov_b32 s2, s4
; GFX8-NEXT:    s_mov_b32 s3, s5
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, 0x3fff000, v0
; GFX8-NEXT:    buffer_load_dword v0, v1, s[0:3], 16 offen offset:4092
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    ; return to shader part epilog
;
...
; GFX1250-NEXT:    s_mov_b32 s2, s4
; GFX1250-NEXT:    s_mov_b32 s3, s5
; GFX1250-NEXT:    v_add_nc_u32_e32 v1, 0x3800000, v0
; GFX1250-NEXT:    s_mov_b32 s4, 16
; GFX1250-NEXT:    buffer_load_b32 v0, v1, s[0:3], s4 offen offset:8388604
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    ; return to shader part epilog
