...
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, 9, v0
...
; GFX11-NEXT:    v_sub_nc_u16_e64 v0, v0, v1 clamp
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, 8, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    v_pk_lshrrev_b16 v0, 8, v0 op_sel_hi:[0,1]
; GFX11-NEXT:    v_pk_sub_u16 v1, v3, v1 clamp
...
; GFX11-NEXT:    v_pk_sub_u16 v0, s2, s4 clamp
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_i32_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.usub.sat.i32(i32 %lhs, i32 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_i32_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.usub.sat.i32(i32 %lhs, i32 %rhs)
  %cast = bitcast i32 %result to float
  ret float %cast
...
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, s1, s4 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, s0, s4 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, s1, s5 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, s2, s6 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v5i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v5 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, v1, v6 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, v2, v7 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v3, v3, v8 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v4, v4, v9 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u16_e64 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.usub.sat.i16(i16 %lhs, i16 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u16_e64 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.usub.sat.i16(i16 %lhs, i16 %rhs)
  %cast = bitcast i16 %result to half
  ret half %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_v2i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_u16 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.usub.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: usubsat_v2i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_u16 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.usub.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
  %cast = bitcast <2 x i16> %result to float
  ret float %cast
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_sub_u16 v0, v0, v3 clamp
; GFX11-NEXT:    v_pk_sub_u16 v1, v1, v4 clamp
; GFX11-NEXT:    v_pk_sub_u16 v2, v2, v5 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_usubsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_u16 v0, s0, s3 clamp
; GFX11-NEXT:    v_pk_sub_u16 v1, s1, s4 clamp
; GFX11-NEXT:    v_pk_sub_u16 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_sub_u16 v0, v0, v4 clamp
; GFX11-NEXT:    v_pk_sub_u16 v1, v1, v5 clamp
; GFX11-NEXT:    v_pk_sub_u16 v2, v2, v6 clamp
; GFX11-NEXT:    v_pk_sub_u16 v3, v3, v7 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_usubsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_u16 v0, s0, s4 clamp
; GFX11-NEXT:    v_pk_sub_u16 v1, s1, s5 clamp
; GFX11-NEXT:    v_pk_sub_u16 v2, s2, s6 clamp
; GFX11-NEXT:    v_pk_sub_u16 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s0, s[0:1], s[2:3]
; GFX11-NEXT:    s_and_b32 s5, s5, 1
; GFX11-NEXT:    s_cmp_lg_u32 s5, 0
; GFX11-NEXT:    s_subb_u32 s1, s1, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s4, 0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s1, 0, s0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i64 @llvm.usub.sat.i64(i64 %lhs, i64 %rhs)
...
; GFX11-NEXT:    v_sub_co_u32_e64 v8, vcc_lo, v10, v4
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v9, vcc_lo, v11, v5, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[10:11], v[4:5]
; GFX11-NEXT:    v_sub_co_u32_e64 v4, s0, v0, v6
; GFX11-NEXT:    v_subb_u32_e64 v5, s0, v1, v7, s0
; GFX11-NEXT:    v_cmp_lt_u64_e64 s0, v[0:1], v[6:7]
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s1, s[0:1], s[4:5]
; GFX11-NEXT:    s_sub_u32 s0, s2, s6
; GFX11-NEXT:    s_cselect_b32 s4, 1, 0
; GFX11-NEXT:    v_cmp_lt_u64_e64 s2, s[2:3], s[6:7]
; GFX11-NEXT:    s_and_b32 s4, s4, 1
; GFX11-NEXT:    s_cmp_lg_u32 s4, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s8, 0, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s9, 0, s1
; GFX11-NEXT:    s_subb_u32 s1, s3, s7
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s0, 0, s2
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s1, 0, s2
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
...
; GFX11-NEXT:    s_subb_u32 s14, s2, s6
...
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s8, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s14, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s1, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s9, 0, vcc_lo
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[2:3], v[2:3]
...
; GFX11-NEXT:    v_sub_co_u32_e64 v0, vcc_lo, s0, v0
...
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v3, vcc_lo, s3, v3, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, 0, v4
...
; GFX11-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[0:1], v[0:1]
; GFX11-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[2:3], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v0, vcc_lo, v0, s0
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo
; GFX11-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v2, vcc_lo, s2, v2, vcc_lo
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v3, vcc_lo, s3, v3, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, 0, v4
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s0
...
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[22:23], v[8:9]
; GFX11-NEXT:    v_mov_b32_e32 v24, v6
; GFX11-NEXT:    v_mov_b32_e32 v25, v7
; GFX11-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[20:21], v[10:11]
; GFX11-NEXT:    v_cmp_eq_u64_e64 s1, v[24:25], v[14:15]
; GFX11-NEXT:    v_cndmask_b32_e64 v17, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[20:21], v[10:11]
; GFX11-NEXT:    v_cndmask_b32_e32 v16, v17, v16, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[26:27], v[12:13]
; GFX11-NEXT:    v_and_b32_e32 v16, 1, v16
; GFX11-NEXT:    v_cndmask_b32_e64 v17, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[24:25], v[14:15]
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, 0, v16
; GFX11-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v0, vcc_lo, v22, v8
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, v23, v9, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v18, v17, s1
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v2, vcc_lo, v20, v10, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s0
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v3, vcc_lo, v21, v11, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v4, vcc_lo, v26, v12
; GFX11-NEXT:    v_and_b32_e32 v8, 1, v8
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v5, vcc_lo, v27, v13, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s0
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v6, vcc_lo, v24, v14, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v2, 0, s0
; GFX11-NEXT:    v_cmp_ne_u32_e64 s1, 0, v8
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v7, vcc_lo, v25, v15, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s0
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s2, s[2:3], s[10:11]
...
; GFX11-NEXT:    s_subb_u32 s30, s6, s14
; GFX11-NEXT:    s_cselect_b32 s0, 1, 0
; GFX11-NEXT:    v_and_b32_e32 v0, 1, v0
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s1, s[6:7], s[14:15]
; GFX11-NEXT:    s_cselect_b32 s0, 1, 0
; GFX11-NEXT:    s_and_b32 s0, 1, s0
; GFX11-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s17, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s18, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v4, s19, 0, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v1
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    v_readfirstlane_b32 s2, v3
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s3, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s8, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s30, 0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s9, 0, vcc_lo
