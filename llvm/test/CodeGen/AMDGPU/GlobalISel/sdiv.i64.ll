...
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v17, v1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v1, v16, v0
; GISEL-NEXT:    v_mul_lo_u32 v5, v15, v13
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v5, v1
; GISEL-NEXT:    v_mul_hi_u32 v5, v15, v13
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v19, v7
; GISEL-NEXT:    v_mul_hi_u32 v13, v16, v13
; GISEL-NEXT:    v_mac_f32_e32 v12, 0x4f800000, v19
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v12, v12
; GISEL-NEXT:    v_mul_f32_e32 v19, 0x5f7ffffc, v12
...
; GISEL-NEXT:    v_add_i32_e32 v21, vcc, v13, v12
; GISEL-NEXT:    v_mul_f32_e32 v20, 0x2f800000, v19
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v10, v21, v[1:2]
; GISEL-NEXT:    v_trunc_f32_e32 v1, v20
; GISEL-NEXT:    v_mac_f32_e32 v19, 0xcf800000, v1
; GISEL-NEXT:    v_cvt_u32_f32_e32 v19, v19
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v4, v0, v[12:13]
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v15, v11
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v17, v19, 0
; GISEL-NEXT:    v_cvt_u32_f32_e32 v15, v1
; GISEL-NEXT:    v_sub_i32_e64 v1, s[4:5], v16, v12
; GISEL-NEXT:    v_subb_u32_e64 v20, s[4:5], v16, v12, vcc
...
; GISEL-NEXT:    v_mov_b32_e32 v1, v14
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v11, v10
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v17, v15, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v22, v15, v13
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[8:9], v12, v4
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v18, v19, v[10:11]
; GISEL-NEXT:    v_mul_hi_u32 v11, v19, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v1, v19, v10
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v20, v4
; GISEL-NEXT:    v_mul_hi_u32 v13, v15, v13
; GISEL-NEXT:    v_add_i32_e64 v1, s[6:7], v22, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v12, v16, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], 1, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v11, vcc
; GISEL-NEXT:    v_addc_u32_e64 v11, vcc, 0, v21, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v12
; GISEL-NEXT:    v_addc_u32_e32 v20, vcc, 0, v11, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v12, v16, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v11, v20, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[6:7]
; GISEL-NEXT:    v_mul_lo_u32 v16, v15, v10
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v14, v11
; GISEL-NEXT:    v_mul_hi_u32 v14, v19, v10
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v19, v11
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v15, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v17, v13, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v0, v1, vcc
; GISEL-NEXT:    v_mov_b32_e32 v0, v11
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v14, v[0:1]
; GISEL-NEXT:    v_ashrrev_i32_e32 v11, 31, v3
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v21, v12, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v13, v[0:1]
...
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v13, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v9, v8
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v12, v[3:4]
...
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v17, v0, vcc
; GISEL-NEXT:    v_mul_lo_u32 v0, v20, v1
; GISEL-NEXT:    v_mul_lo_u32 v14, v15, v13
...
; GISEL-NEXT:    v_cndmask_b32_e64 v19, 0, -1, vcc
; GISEL-NEXT:    v_add_i32_e32 v20, vcc, 1, v15
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, -1, v13, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v1, v7, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v13, -1, v19, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v15, v20, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v18, v21, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v17, v13, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, v17, v0, vcc
; CGP-NEXT:    v_mul_lo_u32 v0, v20, v1
; CGP-NEXT:    v_mul_lo_u32 v14, v15, v13
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v14
; CGP-NEXT:    v_cndmask_b32_e64 v5, -1, v13, s[4:5]
; CGP-NEXT:    v_mul_lo_u32 v1, v7, v0
; CGP-NEXT:    v_cndmask_b32_e32 v13, -1, v19, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; CGP-NEXT:    v_cndmask_b32_e32 v13, v15, v20, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v14, v18, v21, vcc
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; CGP-NEXT:    v_cndmask_b32_e32 v5, v17, v13, vcc
; CGP-NEXT:    v_xor_b32_e32 v11, v5, v8
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v9, v[1:2]
; CGP-NEXT:    v_cndmask_b32_e32 v10, v16, v14, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v17, v11
; GISEL-NEXT:    v_mul_lo_u32 v13, v14, v12
; GISEL-NEXT:    v_mul_hi_u32 v19, v14, v12
...
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v18, v19
...
; GISEL-NEXT:    v_addc_u32_e32 v10, vcc, v10, v6, vcc
; GISEL-NEXT:    v_xor_b32_e32 v9, v9, v6
; GISEL-NEXT:    v_xor_b32_e32 v10, v10, v6
; GISEL-NEXT:    v_mov_b32_e32 v1, v12
; GISEL-NEXT:    v_cvt_f32_u32_e32 v12, v9
; GISEL-NEXT:    v_cvt_f32_u32_e32 v19, v10
; GISEL-NEXT:    v_mul_hi_u32 v13, v16, v13
; GISEL-NEXT:    v_mac_f32_e32 v12, 0x4f800000, v19
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v12, v12
; GISEL-NEXT:    v_mul_f32_e32 v19, 0x5f7ffffc, v12
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v14, v17
; GISEL-NEXT:    v_sub_i32_e32 v17, vcc, 0, v9
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], v12, v18
; GISEL-NEXT:    v_subb_u32_e32 v18, vcc, 0, v10, vcc
; GISEL-NEXT:    v_add_i32_e32 v21, vcc, v13, v12
; GISEL-NEXT:    v_mul_f32_e32 v20, 0x2f800000, v19
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v8, v21, v[1:2]
; GISEL-NEXT:    v_trunc_f32_e32 v1, v20
; GISEL-NEXT:    v_mac_f32_e32 v19, 0xcf800000, v1
; GISEL-NEXT:    v_cvt_u32_f32_e32 v19, v19
...
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v11, v8
; GISEL-NEXT:    v_subbrev_u32_e32 v16, vcc, 0, v1, vcc
; GISEL-NEXT:    v_mov_b32_e32 v1, v14
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v11, v8
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v17, v15, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v22, v15, v13
; GISEL-NEXT:    v_mul_hi_u32 v8, v19, v13
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[6:7], v18, v19, v[11:12]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[8:9], v16, v5
; GISEL-NEXT:    v_mul_hi_u32 v13, v15, v13
; GISEL-NEXT:    v_mul_lo_u32 v1, v19, v11
; GISEL-NEXT:    v_add_i32_e64 v1, s[6:7], v22, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v20, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v14, v16, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v14, s[4:5], 1, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v8, vcc
; GISEL-NEXT:    v_addc_u32_e64 v8, vcc, 0, v21, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v14
; GISEL-NEXT:    v_addc_u32_e32 v20, vcc, 0, v8, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v14, v16, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s[6:7]
; GISEL-NEXT:    v_mul_lo_u32 v16, v15, v11
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v16, v0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v9, v11, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v4, v1
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v0, v1
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v9, v13, v[0:1]
; GISEL-NEXT:    v_xor_b32_e32 v8, v8, v7
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v5, v7
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v11, v[3:4]
