...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v11, v1
; CHECK-NEXT:    v_cvt_u32_f32_e32 v10, v2
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v11, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v10, v[2:3]
; CHECK-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v11, v[6:7]
; CHECK-NEXT:    v_mul_hi_u32 v3, v11, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, v10, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, v10, v1
; CHECK-NEXT:    v_mul_lo_u32 v7, v11, v2
; CHECK-NEXT:    v_mul_hi_u32 v14, v11, v2
; CHECK-NEXT:    v_mul_lo_u32 v15, v10, v2
...
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v14
...
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v11, v1
; CHECK-NEXT:    v_addc_u32_e32 v10, vcc, v10, v2, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v12, v11, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v10, v[2:3]
...
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v11, v1
; CHECK-NEXT:    v_addc_u32_e32 v2, vcc, v10, v2, vcc
; CHECK-NEXT:    v_mul_hi_u32 v3, v7, v1
; CHECK-NEXT:    v_mul_lo_u32 v5, v7, v2
; CHECK-NEXT:    v_xor_b32_e32 v10, v4, v12
; CHECK-NEXT:    v_mul_lo_u32 v4, v10, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, v10, v1
...
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v1, v3
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; CHECK-NEXT:    v_mul_hi_u32 v4, v10, v2
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v8, v11, 0
; CHECK-NEXT:    v_add_i32_e32 v13, vcc, v4, v3
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v8, v13, v[2:3]
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v7, v1
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v11, v[3:4]
; CHECK-NEXT:    v_subb_u32_e64 v2, s[4:5], v10, v5, vcc
; CHECK-NEXT:    v_sub_i32_e64 v3, s[4:5], v10, v5
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v9
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v1, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v2, v9
; CHECK-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v4, v5, s[4:5]
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, 1, v11
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, 0, v13, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v9
...
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v13, v3, vcc
...
; CHECK-NEXT:    s_add_u32 s15, s16, s18
; CHECK-NEXT:    s_addc_u32 s15, s17, 0
; CHECK-NEXT:    v_readfirstlane_b32 s16, v2
; CHECK-NEXT:    v_readfirstlane_b32 s17, v0
; CHECK-NEXT:    s_mul_i32 s18, s12, s14
; CHECK-NEXT:    s_add_u32 s16, s16, s17
; CHECK-NEXT:    v_mul_hi_u32 v0, v1, s14
; CHECK-NEXT:    s_cselect_b32 s17, 1, 0
; CHECK-NEXT:    s_add_u32 s16, s16, s18
; CHECK-NEXT:    s_addc_u32 s14, s17, 0
; CHECK-NEXT:    s_add_u32 s15, s16, s15
; CHECK-NEXT:    s_addc_u32 s14, s14, 0
; CHECK-NEXT:    v_readfirstlane_b32 s16, v0
; CHECK-NEXT:    s_add_i32 s16, s16, s14
; CHECK-NEXT:    s_add_u32 s13, s13, s15
; CHECK-NEXT:    v_mov_b32_e32 v0, s13
; CHECK-NEXT:    v_mul_hi_u32 v0, s3, v0
; CHECK-NEXT:    s_mul_i32 s14, s3, s13
; CHECK-NEXT:    s_addc_u32 s12, s12, s16
...
; CHECK-NEXT:    s_addc_u32 s5, s15, 0
...
; CHECK-NEXT:    s_cselect_b32 s15, 1, 0
; CHECK-NEXT:    s_add_u32 s3, s14, s3
; CHECK-NEXT:    s_addc_u32 s14, s15, 0
; CHECK-NEXT:    s_add_u32 s3, s3, s5
; CHECK-NEXT:    s_addc_u32 s5, s14, 0
; CHECK-NEXT:    v_readfirstlane_b32 s14, v0
...
; CHECK-NEXT:    s_add_u32 s3, s12, s14
; CHECK-NEXT:    s_addc_u32 s3, s13, 0
; CHECK-NEXT:    v_readfirstlane_b32 s12, v0
; CHECK-NEXT:    v_readfirstlane_b32 s13, v2
; CHECK-NEXT:    s_mul_i32 s5, s11, s5
; CHECK-NEXT:    s_add_u32 s12, s12, s13
; CHECK-NEXT:    s_cselect_b32 s13, 1, 0
; CHECK-NEXT:    s_add_u32 s5, s12, s5
; CHECK-NEXT:    s_addc_u32 s13, s13, 0
; CHECK-NEXT:    s_add_u32 s12, s5, s3
...
; CHECK-NEXT:    s_add_i32 s13, s5, s3
; CHECK-NEXT:    v_readfirstlane_b32 s5, v1
...
; GISEL-NEXT:    v_mul_lo_u32 v14, v5, v15
; GISEL-NEXT:    v_mul_hi_u32 v16, v5, v15
...
; GISEL-NEXT:    v_mul_hi_u32 v14, v19, v15
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v12, v0
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v15
; GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v13, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v18, vcc, v9, v11
...
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, 0, v5, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v10, v16, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GISEL-NEXT:    v_mul_lo_u32 v4, v12, v2
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, 0, v5, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_addc_u32_e32 v4, vcc, 0, v5, vcc
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v0, v3
; GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v4, vcc
; GISEL-NEXT:    v_mul_hi_u32 v4, v12, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v14, 0
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v14, v[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v16, v2
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v12, v10, vcc
; GISEL-NEXT:    v_sub_i32_e64 v4, s[4:5], v12, v10
...
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, 1, v14
...
; CGP-NEXT:    v_xor_b32_e32 v5, v1, v0
; CGP-NEXT:    v_xor_b32_e32 v14, v2, v0
; CGP-NEXT:    v_cvt_f32_u32_e32 v1, v5
; CGP-NEXT:    v_cvt_f32_u32_e32 v2, v14
; CGP-NEXT:    v_sub_i32_e32 v17, vcc, 0, v5
; CGP-NEXT:    v_subb_u32_e32 v18, vcc, 0, v14, vcc
...
; CGP-NEXT:    v_mac_f32_e32 v1, 0xcf800000, v2
; CGP-NEXT:    v_cvt_u32_f32_e32 v16, v1
; CGP-NEXT:    v_cvt_u32_f32_e32 v15, v2
; CGP-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v17, v16, 0
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v17, v15, v[2:3]
; CGP-NEXT:    v_mul_hi_u32 v2, v16, v1
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v16, v[3:4]
; CGP-NEXT:    v_mul_lo_u32 v3, v15, v1
; CGP-NEXT:    v_mul_hi_u32 v1, v15, v1
; CGP-NEXT:    v_mul_lo_u32 v4, v16, v12
...
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v19
...
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v16, v1
; CGP-NEXT:    v_addc_u32_e32 v15, vcc, v15, v2, vcc
; CGP-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v17, v16, 0
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v17, v15, v[2:3]
; CGP-NEXT:    v_ashrrev_i32_e32 v17, 31, v11
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v10, v17
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v16, v[3:4]
; CGP-NEXT:    v_mul_hi_u32 v4, v16, v1
; CGP-NEXT:    v_xor_b32_e32 v13, v2, v17
; CGP-NEXT:    v_mul_lo_u32 v2, v15, v1
; CGP-NEXT:    v_mul_lo_u32 v10, v16, v12
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v11, v17, vcc
; CGP-NEXT:    v_mul_hi_u32 v1, v15, v1
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v10
; CGP-NEXT:    v_mul_hi_u32 v11, v16, v12
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
; CGP-NEXT:    v_mul_lo_u32 v4, v15, v12
; CGP-NEXT:    v_addc_u32_e32 v2, vcc, 0, v10, vcc
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v11
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v10, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v4, v13, v1
; CGP-NEXT:    v_mul_lo_u32 v10, v13, v2
; CGP-NEXT:    v_xor_b32_e32 v12, v3, v17
; CGP-NEXT:    v_mul_lo_u32 v3, v12, v1
; CGP-NEXT:    v_mul_hi_u32 v1, v12, v1
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v10
; CGP-NEXT:    v_mul_hi_u32 v11, v13, v2
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; CGP-NEXT:    v_mul_lo_u32 v4, v12, v2
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v11
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v10, vcc
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v1, v3
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; CGP-NEXT:    v_mul_hi_u32 v4, v12, v2
; CGP-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v5, v15, 0
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v4, v3
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v16, v[2:3]
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v13, v1
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v15, v[3:4]
; CGP-NEXT:    v_subb_u32_e64 v2, s[4:5], v12, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v3, s[4:5], v12, v10
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v14
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v2, v14
; CGP-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v2, v4, v10, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v4, vcc, 1, v15
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, 0, v16, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v14
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; CGP-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v14
...
; CGP-NEXT:    v_cndmask_b32_e32 v2, v16, v3, vcc
; CGP-NEXT:    v_xor_b32_e32 v3, v17, v0
...
; CGP-NEXT:    v_xor_b32_e32 v12, v3, v2
; CGP-NEXT:    v_xor_b32_e32 v13, v4, v2
; CGP-NEXT:    v_cvt_f32_u32_e32 v3, v12
; CGP-NEXT:    v_cvt_f32_u32_e32 v4, v13
; CGP-NEXT:    v_sub_i32_e32 v15, vcc, 0, v12
; CGP-NEXT:    v_subb_u32_e32 v16, vcc, 0, v13, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v15, v7, v[4:5]
; CGP-NEXT:    v_mul_hi_u32 v4, v14, v3
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[5:6]
; CGP-NEXT:    v_mul_lo_u32 v5, v7, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v7, v3
; CGP-NEXT:    v_mul_lo_u32 v6, v14, v10
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v10
; CGP-NEXT:    v_mul_lo_u32 v17, v7, v10
...
; CGP-NEXT:    v_mul_hi_u32 v6, v7, v10
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v8, v15
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[5:6]
; CGP-NEXT:    v_mul_hi_u32 v6, v14, v3
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v9, v15, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v14, v10
; CGP-NEXT:    v_xor_b32_e32 v9, v4, v15
; CGP-NEXT:    v_mul_lo_u32 v4, v7, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v7, v3
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v10
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CGP-NEXT:    v_mul_lo_u32 v6, v7, v10
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v8, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v11
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v6
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, 0, v8, vcc
; CGP-NEXT:    v_mul_hi_u32 v8, v7, v10
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v6, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v7, v9, v4
; CGP-NEXT:    v_xor_b32_e32 v10, v5, v15
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v3, v5
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, 0, v6, vcc
; CGP-NEXT:    v_mul_hi_u32 v6, v10, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v11, 0
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v6, v5
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v12, v14, v[4:5]
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v9, v3
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v11, v[5:6]
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v10, v7, vcc
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v10, v7
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v13
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v5, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v12
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v3, v12
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v4, v13
; CGP-NEXT:    v_subbrev_u32_e32 v5, vcc, 0, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v4, v6, v7, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v6, vcc, 1, v11
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, 0, v14, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v13
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v12
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v13
; CGP-NEXT:    v_cndmask_b32_e32 v3, v8, v3, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, 1, v6
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, 0, v7, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v3, v6, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v5, v7, v8, vcc
...
; CHECK-NEXT:    v_mul_hi_u32 v4, v6, s5
...
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v11, v10
...
; GISEL-NEXT:    v_sub_i32_e32 v8, vcc, v8, v6
...
; GISEL-NEXT:    v_cndmask_b32_e32 v1, -1, v8, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v16, v8, vcc
...
; GISEL-NEXT:    v_xor_b32_e32 v12, v9, v4
...
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], 0, v11, v[9:10]
...
; CGP-NEXT:    v_mul_hi_u32 v9, v1, s5
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v5, v11, 0
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, 0, v8, vcc
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v9, v8
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v5, v12, v[7:8]
...
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v6, v5
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v2, v0
...
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v6, v4, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v12, v7
...
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v10, v6
...
; CGP-NEXT:    v_subbrev_u32_e32 v6, vcc, 0, v6, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v3, -1, v7, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v7, vcc, 1, v11
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, 0, v4, vcc
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; CGP-NEXT:    v_cndmask_b32_e32 v2, v7, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v5, v9, v6, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v2, v11, v2, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v3, v4, v5, vcc
...
; CHECK-NEXT:    v_xor_b32_e32 v9, v1, v0
; CHECK-NEXT:    v_xor_b32_e32 v10, v2, v0
; CHECK-NEXT:    v_cvt_f32_u32_e32 v1, v9
; CHECK-NEXT:    v_cvt_f32_u32_e32 v2, v10
; CHECK-NEXT:    v_sub_i32_e32 v13, vcc, 0, v9
; CHECK-NEXT:    v_subb_u32_e32 v14, vcc, 0, v10, vcc
; CHECK-NEXT:    v_mac_f32_e32 v1, 0x4f800000, v2
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; CHECK-NEXT:    v_mul_f32_e32 v1, 0x5f7ffffc, v1
; CHECK-NEXT:    v_mul_f32_e32 v2, 0x2f800000, v1
; CHECK-NEXT:    v_trunc_f32_e32 v2, v2
; CHECK-NEXT:    v_mac_f32_e32 v1, 0xcf800000, v2
; CHECK-NEXT:    v_cvt_u32_f32_e32 v12, v1
; CHECK-NEXT:    v_cvt_u32_f32_e32 v11, v2
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v13, v12, 0
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v11, v[2:3]
; CHECK-NEXT:    v_mul_hi_u32 v2, v12, v1
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v14, v12, v[5:6]
; CHECK-NEXT:    v_mul_lo_u32 v5, v11, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, v11, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, v12, v7
; CHECK-NEXT:    v_mul_hi_u32 v8, v12, v7
; CHECK-NEXT:    v_mul_lo_u32 v15, v11, v7
...
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v15
; CHECK-NEXT:    v_mul_hi_u32 v6, v11, v7
...
; CHECK-NEXT:    v_add_i32_e32 v12, vcc, v12, v1
; CHECK-NEXT:    v_addc_u32_e32 v11, vcc, v11, v2, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v13, v12, 0
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v11, v[2:3]
; CHECK-NEXT:    v_ashrrev_i32_e32 v13, 31, v4
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v3, v13
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v14, v12, v[5:6]
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v4, v13, vcc
; CHECK-NEXT:    v_mul_hi_u32 v4, v12, v1
; CHECK-NEXT:    v_mul_lo_u32 v5, v12, v7
; CHECK-NEXT:    v_xor_b32_e32 v8, v2, v13
; CHECK-NEXT:    v_mul_lo_u32 v2, v11, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, v11, v1
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; CHECK-NEXT:    v_mul_hi_u32 v6, v12, v7
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
; CHECK-NEXT:    v_mul_lo_u32 v4, v11, v7
; CHECK-NEXT:    v_addc_u32_e32 v2, vcc, 0, v5, vcc
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, 0, v5, vcc
; CHECK-NEXT:    v_mul_hi_u32 v5, v11, v7
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v2
...
; CHECK-NEXT:    v_mul_hi_u32 v4, v8, v1
; CHECK-NEXT:    v_mul_lo_u32 v5, v8, v2
; CHECK-NEXT:    v_xor_b32_e32 v7, v3, v13
; CHECK-NEXT:    v_mul_lo_u32 v3, v7, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, v7, v1
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
...
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v1, v3
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; CHECK-NEXT:    v_mul_hi_u32 v4, v7, v2
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v9, v11, 0
; CHECK-NEXT:    v_add_i32_e32 v12, vcc, v4, v3
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v9, v12, v[2:3]
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v8, v1
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v11, v[3:4]
; CHECK-NEXT:    v_subb_u32_e64 v2, s[4:5], v7, v5, vcc
; CHECK-NEXT:    v_sub_i32_e64 v3, s[4:5], v7, v5
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v10
; CHECK-NEXT:    v_subb_u32_e32 v3, vcc, v3, v10, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v9
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, v1, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v2, v10
; CHECK-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v4, v5, s[4:5]
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, 1, v11
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, 0, v12, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v10
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v6, v1, vcc
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, 1, v4
; CHECK-NEXT:    v_addc_u32_e32 v6, vcc, 0, v5, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
...
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v11, v1, vcc
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v12, v3, vcc
...
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, 0, v13, vcc
; GISEL-NEXT:    v_mul_hi_u32 v9, v16, v9
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v20, v10
...
; GISEL-NEXT:    v_mul_lo_u32 v14, v18, v15
; GISEL-NEXT:    v_lshl_b64 v[11:12], v[11:12], v6
; GISEL-NEXT:    v_ashrrev_i32_e32 v6, 31, v12
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v10, v14
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v14, v18, v15
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v13
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v15, v0
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; GISEL-NEXT:    v_mul_hi_u32 v14, v16, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_mul_lo_u32 v10, v15, v9
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v13, vcc
...
; GISEL-NEXT:    v_addc_u32_e64 v12, s[4:5], 0, v12, s[6:7]
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_mul_lo_u32 v1, v19, v13
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v17, v11, vcc
; GISEL-NEXT:    v_ashrrev_i32_e32 v15, 31, v3
...
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v15
; GISEL-NEXT:    v_mul_hi_u32 v5, v8, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v16, v8, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v5, v2
; GISEL-NEXT:    v_mul_lo_u32 v5, v13, v4
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, 0, v11, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v16
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v5
; GISEL-NEXT:    v_mul_hi_u32 v4, v13, v4
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, 0, v11, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, 0, v5, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
...
; GISEL-NEXT:    v_xor_b32_e32 v11, v3, v15
; GISEL-NEXT:    v_mul_lo_u32 v3, v11, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v11, v0
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GISEL-NEXT:    v_mul_hi_u32 v8, v12, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
...
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v11, v7, vcc
; GISEL-NEXT:    v_sub_i32_e64 v4, s[4:5], v11, v7
...
; CGP-NEXT:    v_sub_i32_e32 v18, vcc, 0, v1
; CGP-NEXT:    v_subb_u32_e32 v19, vcc, 0, v4, vcc
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; CGP-NEXT:    v_mul_hi_u32 v13, v15, v10
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
; CGP-NEXT:    v_mul_lo_u32 v11, v14, v10
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, 0, v12, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v16, 0
; CGP-NEXT:    v_addc_u32_e32 v11, vcc, 0, v11, vcc
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v10, v11
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v17, v[9:10]
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v15, v8
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v4, v16, v[10:11]
...
; CGP-NEXT:    v_subb_u32_e32 v10, vcc, v10, v4, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v10, v4
...
; CGP-NEXT:    v_mac_f32_e32 v3, 0xcf800000, v4
; CGP-NEXT:    v_cvt_u32_f32_e32 v14, v3
; CGP-NEXT:    v_cvt_u32_f32_e32 v6, v4
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v6, v[4:5]
; CGP-NEXT:    v_mul_hi_u32 v4, v14, v3
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[8:9]
; CGP-NEXT:    v_mul_lo_u32 v8, v6, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v6, v3
; CGP-NEXT:    v_mul_lo_u32 v9, v14, v10
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v10
; CGP-NEXT:    v_mul_lo_u32 v17, v6, v10
...
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v17
; CGP-NEXT:    v_mul_hi_u32 v9, v6, v10
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, 0, v8, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v8, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v9, v4
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v3
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v6, v4, vcc
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v6, v[4:5]
; CGP-NEXT:    v_ashrrev_i32_e32 v15, 31, v7
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v5, v15
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[8:9]
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v7, v15, vcc
; CGP-NEXT:    v_mul_hi_u32 v7, v14, v3
; CGP-NEXT:    v_mul_lo_u32 v8, v14, v10
; CGP-NEXT:    v_xor_b32_e32 v9, v4, v15
...
; GISEL-NEXT:    v_mul_hi_u32 v6, v12, v4
...
; GISEL-NEXT:    v_mul_hi_u32 v17, v11, v1
