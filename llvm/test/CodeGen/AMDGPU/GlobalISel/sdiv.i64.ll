...
; GISEL-NEXT:    v_mul_lo_u32 v5, v17, v0
...
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v0, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v11, v0
; GISEL-NEXT:    v_mul_hi_u32 v11, v17, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v15, 0
; GISEL-NEXT:    v_add_i32_e32 v18, vcc, v11, v5
...
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v17, v13
...
; GISEL-NEXT:    v_cndmask_b32_e64 v14, v11, v12, s[4:5]
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v7, v5, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v19, v16, 0
; GISEL-NEXT:    v_subb_u32_e32 v20, vcc, 0, v6, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v13, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v11, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v19, v17, v[1:2]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, 1, v15
; GISEL-NEXT:    v_addc_u32_e32 v21, vcc, 0, v18, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v20, v16, v[10:11]
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, 1, v1
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, 0, v21, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v10, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v21, v11, vcc
; GISEL-NEXT:    v_mul_lo_u32 v10, v17, v0
; GISEL-NEXT:    v_mul_lo_u32 v11, v16, v12
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v15, v1, vcc
...
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v10, v1
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v11, v1
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], v16, v0
...
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v18, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v19, v14, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v13, v15
...
; GISEL-NEXT:    v_xor_b32_e32 v16, v3, v13
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v4, v15
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v7, v12, v[3:4]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v15
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v4, v15, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v10, v[8:9]
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v13, v5
...
; GISEL-NEXT:    s_mov_b32 s6, 1
; GISEL-NEXT:    v_add_i32_e32 v19, vcc, v14, v13
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v6, v19, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v18, v0
; GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], 0, v17, v[13:14]
; GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; GISEL-NEXT:    s_subb_u32 s6, 0, 0
; GISEL-NEXT:    v_subb_u32_e64 v1, s[4:5], v20, v15, vcc
; GISEL-NEXT:    v_sub_i32_e64 v13, s[4:5], v20, v15
...
; GISEL-NEXT:    v_addc_u32_e32 v18, vcc, 0, v19, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v17, v14, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v19, v16, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v5, v[3:4]
...
; GISEL-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v3, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v4, -1, v7, s[4:5]
...
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v0, v13
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v14, v0
; CGP-NEXT:    v_mul_hi_u32 v14, v16, v1
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v17, 0
; CGP-NEXT:    v_add_i32_e32 v18, vcc, v14, v13
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v4, v18, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v15, v0
; CGP-NEXT:    v_subb_u32_e64 v1, s[4:5], v16, v13, vcc
; CGP-NEXT:    v_sub_i32_e64 v13, s[4:5], v16, v13
...
; CGP-NEXT:    v_add_i32_e32 v16, vcc, 1, v17
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, 1, v16
...
; CGP-NEXT:    v_cndmask_b32_e32 v0, v16, v5, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v5, v19, v21, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
; CGP-NEXT:    v_cndmask_b32_e32 v14, v17, v0, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v18, v5, vcc
...
; GISEL-NEXT:    v_sub_i32_e32 v18, vcc, 0, v8
; GISEL-NEXT:    v_subb_u32_e32 v19, vcc, 0, v5, vcc
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v17, v9
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v18, v7, 0
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v18, v17, v[10:11]
; GISEL-NEXT:    v_mul_lo_u32 v10, v17, v9
; GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v19, v7, v[13:14]
; GISEL-NEXT:    v_mul_lo_u32 v13, v7, v15
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; GISEL-NEXT:    v_mul_hi_u32 v13, v7, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v9, v17, v9
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; GISEL-NEXT:    v_mul_lo_u32 v13, v17, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v14, v10
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v13, v9
; GISEL-NEXT:    v_mul_hi_u32 v13, v7, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v9, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; GISEL-NEXT:    v_mul_hi_u32 v14, v17, v15
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v13, v10
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v14, v10
; GISEL-NEXT:    v_add_i32_e32 v20, vcc, v7, v9
; GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v17, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v18, v20, 0
; GISEL-NEXT:    v_ashrrev_i32_e32 v7, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v7
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v18, v17, v[10:11]
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v1, v7, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v19, v20, v[13:14]
; GISEL-NEXT:    v_xor_b32_e32 v16, v0, v7
; GISEL-NEXT:    v_mul_lo_u32 v0, v17, v9
; GISEL-NEXT:    v_mul_lo_u32 v10, v20, v15
; GISEL-NEXT:    v_xor_b32_e32 v18, v1, v7
; GISEL-NEXT:    v_mul_hi_u32 v1, v20, v9
; GISEL-NEXT:    v_mul_hi_u32 v9, v17, v9
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v1, v17, v15
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v10, v0
; GISEL-NEXT:    v_mul_hi_u32 v10, v20, v15
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; GISEL-NEXT:    v_mul_hi_u32 v10, v17, v15
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v20, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v10, v18, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v15, 0
; GISEL-NEXT:    v_ashrrev_i32_e32 v6, 31, v12
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v10, v9
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v8, v17, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v16, v0
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v5, v15, v[9:10]
; GISEL-NEXT:    v_subb_u32_e64 v16, s[4:5], v18, v13, vcc
; GISEL-NEXT:    v_sub_i32_e64 v1, s[4:5], v18, v13
...
; GISEL-NEXT:    v_subbrev_u32_e32 v18, vcc, 0, v1, vcc
...
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[8:9], v18, v5
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v14, v18, s[4:5]
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v17, vcc
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v11
; GISEL-NEXT:    v_addc_u32_e32 v18, vcc, 0, v14, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v11, v16, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v14, v18, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; GISEL-NEXT:    v_mul_lo_u32 v5, v19, v13
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v15, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[6:7]
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v12, v1
; GISEL-NEXT:    v_add_i32_e64 v0, s[4:5], v5, v0
; GISEL-NEXT:    v_mul_hi_u32 v5, v8, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[4:5]
; GISEL-NEXT:    v_xor_b32_e32 v15, v7, v4
...
; GISEL-NEXT:    v_add_i32_e64 v0, s[4:5], v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v5, v1
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v12, v1
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], v8, v0
; GISEL-NEXT:    v_addc_u32_e64 v13, s[4:5], v19, v1, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v20, v12, 0
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v20, v13, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v14, v15
; GISEL-NEXT:    v_ashrrev_i32_e32 v14, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v21, v12, v[4:5]
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v14
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v3, v14, vcc
; GISEL-NEXT:    v_xor_b32_e32 v16, v2, v14
; GISEL-NEXT:    v_mul_lo_u32 v2, v13, v0
; GISEL-NEXT:    v_mul_lo_u32 v4, v12, v7
; GISEL-NEXT:    v_xor_b32_e32 v17, v3, v14
; GISEL-NEXT:    v_mul_hi_u32 v3, v12, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v17, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v11, v15
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v4, v17, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v11, 0
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v4, v0
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v12, v[3:4]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v15
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v7, v15, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v9, v11, v[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v16, v2
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v17, v7, vcc
; GISEL-NEXT:    v_sub_i32_e64 v4, s[4:5], v17, v7
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v14, v6
; GISEL-NEXT:    v_xor_b32_e32 v2, v2, v4
; GISEL-NEXT:    v_xor_b32_e32 v3, v3, v4
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v2, v4
; GISEL-NEXT:    v_subb_u32_e32 v3, vcc, v3, v4, vcc
