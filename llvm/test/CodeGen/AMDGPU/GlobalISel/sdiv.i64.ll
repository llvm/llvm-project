...
; GISEL-NEXT:    v_mul_lo_u32 v13, v1, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v1, v0
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v13, v17, v5
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; GISEL-NEXT:    v_add_i32_e32 v18, vcc, v5, v13
...
; GISEL-NEXT:    v_addc_u32_e64 v12, s[4:5], v7, v5, s[4:5]
...
; GISEL-NEXT:    v_mul_lo_u32 v12, v19, v10
...
; GISEL-NEXT:    v_xor_b32_e32 v11, v12, v15
; GISEL-NEXT:    v_ashrrev_i32_e32 v12, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v21, v13, v[0:1]
...
; GISEL-NEXT:    v_xor_b32_e32 v16, v0, v12
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v2, v14, v10
...
; GISEL-NEXT:    v_xor_b32_e32 v10, v1, v12
; GISEL-NEXT:    v_mul_lo_u32 v1, v10, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v3, v16, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v1, v10, v2
...
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v4, v15
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v11, v15, vcc
...
; CGP-NEXT:    s_cselect_b32 s16, 1, 0
; CGP-NEXT:    v_mul_hi_u32 v6, s5, v7
...
; GISEL-NEXT:    v_mac_f32_e32 v9, 0xcf800000, v13
; GISEL-NEXT:    v_cvt_u32_f32_e32 v9, v9
; GISEL-NEXT:    v_cvt_u32_f32_e32 v16, v13
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v15, v9, 0
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v15, v16, v[12:13]
; GISEL-NEXT:    v_mul_hi_u32 v18, v9, v11
; GISEL-NEXT:    v_mul_lo_u32 v19, v16, v11
; GISEL-NEXT:    v_mul_hi_u32 v20, v16, v11
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v17, v9, v[13:14]
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v11
; GISEL-NEXT:    v_mul_hi_u32 v14, v9, v11
...
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v15, v19, v[12:13]
; GISEL-NEXT:    v_mul_hi_u32 v9, v18, v11
; GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v17, v18, v[13:14]
; GISEL-NEXT:    v_mul_lo_u32 v13, v19, v11
; GISEL-NEXT:    v_mul_hi_u32 v11, v19, v11
...
; GISEL-NEXT:    v_xor_b32_e32 v1, v1, v9
; GISEL-NEXT:    v_mul_lo_u32 v14, v1, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v1, v0
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v12, v14
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v14, v17, v11
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
...
; GISEL-NEXT:    v_mul_lo_u32 v0, v14, v10
; GISEL-NEXT:    v_mul_hi_u32 v5, v13, v4
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GISEL-NEXT:    v_xor_b32_e32 v13, v1, v15
...
; GISEL-NEXT:    v_mul_lo_u32 v4, v13, v2
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v3, v4
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v13, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v14, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v4, v0
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v1, v0
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v8, v17, v[3:4]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v11, v9
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v12, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v7, v14, v[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v16, v2
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v13, v9, vcc
; GISEL-NEXT:    v_sub_i32_e64 v4, s[4:5], v13, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v4, v11, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v11, v[7:8]
; GISEL-NEXT:    v_mul_lo_u32 v7, v14, v3
...
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v8, v4
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v11, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v12, v10, 0
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v14, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v12, v11, v[8:9]
; GISEL-NEXT:    v_and_b32_e32 v12, 0xffffff, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v10, v7
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v13, v10, v[3:4]
; GISEL-NEXT:    v_and_b32_e32 v3, 0xffffff, v6
; GISEL-NEXT:    v_mul_lo_u32 v6, v11, v7
...
; GISEL-NEXT:    v_addc_u32_e32 v4, vcc, v11, v4, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v12, v4
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v6, v7
...
; GISEL-NEXT:    v_mul_f32_e32 v2, 0x5f7ffffc, v5
...
; GISEL-NEXT:    v_mac_f32_e32 v2, 0xcf800000, v5
; GISEL-NEXT:    v_cvt_u32_f32_e32 v2, v2
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v14, v2, 0
; GISEL-NEXT:    v_subb_u32_e64 v15, s[4:5], 0, 0, vcc
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v12, v6
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v14, v11, v[8:9]
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v2, v[5:6]
; GISEL-NEXT:    v_mul_hi_u32 v5, v2, v7
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v16
; GISEL-NEXT:    v_mul_lo_u32 v16, v11, v7
; GISEL-NEXT:    v_mul_lo_u32 v6, v2, v8
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_mul_hi_u32 v16, v2, v8
...
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v2, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v9, -1, v17, s[4:5]
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v11, v6, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v14, v16, 0
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v12, v1
; GISEL-NEXT:    v_subbrev_u32_e32 v10, vcc, 0, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v14, v11, v[6:7]
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v0
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v4, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v1
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v15, v16, v[7:8]
; GISEL-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v10
; GISEL-NEXT:    v_cndmask_b32_e32 v2, -1, v6, vcc
; GISEL-NEXT:    v_mul_hi_u32 v6, v16, v5
; GISEL-NEXT:    v_mul_lo_u32 v7, v16, v1
...
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v11, v1, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v15, 0, v1
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, v6, v7
...
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v14, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v3, v15, v[6:7]
