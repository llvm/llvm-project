...
; CGP-NEXT:    v_mul_f32_e32 v3, 0x5f7ffffc, v3
; CGP-NEXT:    v_mul_f32_e32 v4, 0x2f800000, v3
; CGP-NEXT:    v_trunc_f32_e32 v6, v4
; CGP-NEXT:    v_mac_f32_e32 v3, 0xcf800000, v6
; CGP-NEXT:    v_cvt_u32_f32_e32 v14, v3
; CGP-NEXT:    v_cvt_u32_f32_e32 v6, v6
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v6, v[4:5]
; CGP-NEXT:    v_mul_lo_u32 v4, v6, v3
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v14, v[12:13]
; CGP-NEXT:    v_mul_hi_u32 v13, v14, v3
...
; CGP-NEXT:    v_mul_hi_u32 v13, v14, v12
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v12, v6, v12
...
; CGP-NEXT:    v_xor_b32_e32 v13, v4, v15
; CGP-NEXT:    v_mul_lo_u32 v4, v6, v3
; CGP-NEXT:    v_mul_lo_u32 v9, v14, v12
; CGP-NEXT:    v_xor_b32_e32 v16, v8, v15
; CGP-NEXT:    v_mul_hi_u32 v8, v14, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v6, v3
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v6, v12
...
; CGP-NEXT:    v_mul_lo_u32 v6, v16, v3
; CGP-NEXT:    v_mul_lo_u32 v8, v13, v4
; CGP-NEXT:    v_mul_hi_u32 v9, v13, v3
; CGP-NEXT:    v_mul_hi_u32 v3, v16, v3
; CGP-NEXT:    v_mul_hi_u32 v12, v16, v4
...
; CGP-NEXT:    v_mul_hi_u32 v8, v13, v4
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v9, v3
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v8
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v3, v6
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v2, v6, 0
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v12, v8
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v2, v12, v[4:5]
; CGP-NEXT:    v_sub_i32_e32 v3, vcc, v13, v3
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v6, v[8:9]
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v16, v8, vcc
; CGP-NEXT:    v_sub_i32_e64 v8, s[4:5], v16, v8
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, v9, v13, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v9, vcc, 1, v6
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, 0, v12, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, 0, v13, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
...
; CGP-NEXT:    v_mov_b32_e32 v3, 0
; CGP-NEXT:    v_mul_lo_u32 v4, v2, v10
...
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v4, v10
; CGP-NEXT:    v_cndmask_b32_e32 v4, v4, v5, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, 1, v2
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v10
; CGP-NEXT:    v_cndmask_b32_e32 v2, v2, v5, vcc
