...
; GISEL-NEXT:    v_add_i32_e32 v20, vcc, v0, v6
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v14, v0
; GISEL-NEXT:    v_add_i32_e32 v21, vcc, v1, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v20, 0
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v4, v21, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v18, v0
; GISEL-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], 0, v20, v[14:15]
; GISEL-NEXT:    v_subb_u32_e64 v1, s[4:5], v19, v16, vcc
; GISEL-NEXT:    v_sub_i32_e64 v6, s[4:5], v19, v16
...
; GISEL-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, 1, v20
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, 0, v21, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v14, -1, v14, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v17, -1, v0, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v20, v15, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v21, v16, vcc
...
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v0, v6
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v14, v0
; CGP-NEXT:    v_add_i32_e32 v17, vcc, v1, v0
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v16, 0
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v4, v17, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v18, v0
; CGP-NEXT:    v_subb_u32_e64 v1, s[4:5], v19, v14, vcc
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v19, v14
...
; CGP-NEXT:    v_cndmask_b32_e32 v8, v17, v6, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v6, v14, v2
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v7, 0
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v6, v5
...
; CGP-NEXT:    v_cndmask_b32_e32 v3, v9, v4, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v17, v15, v11
; GISEL-NEXT:    v_mul_hi_u32 v19, v5, v11
; GISEL-NEXT:    v_mul_hi_u32 v20, v15, v11
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v18, v5, v[13:14]
...
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v5, 0
; GISEL-NEXT:    v_addc_u32_e32 v19, vcc, v15, v11, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v16, v19, v[13:14]
...
; GISEL-NEXT:    v_mul_lo_u32 v13, v5, v16
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v12, v0
; GISEL-NEXT:    v_mul_hi_u32 v12, v18, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v10, v16, 0
; GISEL-NEXT:    v_add_i32_e32 v19, vcc, v12, v5
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v10, v19, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v17, v0
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v9, v16, v[12:13]
; GISEL-NEXT:    v_subb_u32_e64 v1, s[4:5], v18, v14, vcc
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v18, v14
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[4:5]
...
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, 0, v19, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v9
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v9
; GISEL-NEXT:    v_mac_f32_e32 v15, 0x4f800000, v17
...
; GISEL-NEXT:    v_sub_i32_e64 v18, s[4:5], 0, v7
; GISEL-NEXT:    v_cvt_u32_f32_e32 v17, v1
; GISEL-NEXT:    v_subb_u32_e64 v20, s[4:5], 0, v6, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v15, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v8, v9, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v13, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v18, v17, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v21, v17, v0
; GISEL-NEXT:    v_mul_hi_u32 v22, v15, v0
; GISEL-NEXT:    v_mul_hi_u32 v23, v17, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v20, v15, v[8:9]
...
; GISEL-NEXT:    v_add_i32_e64 v9, s[4:5], v9, v23
...
; GISEL-NEXT:    v_add_i32_e64 v13, s[4:5], v15, v1
; GISEL-NEXT:    v_addc_u32_e64 v14, s[4:5], v17, v0, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v13, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v15, v19, v10, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v20, v13, v[8:9]
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v12
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v3, v12, vcc
; GISEL-NEXT:    v_xor_b32_e32 v11, v2, v12
; GISEL-NEXT:    v_mul_lo_u32 v2, v14, v0
; GISEL-NEXT:    v_mul_lo_u32 v8, v13, v10
; GISEL-NEXT:    v_xor_b32_e32 v16, v3, v12
...
; GISEL-NEXT:    v_xor_b32_e32 v10, v15, v4
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v9, v16, v2
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v8, v3
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v8, v0
; GISEL-NEXT:    v_mul_hi_u32 v8, v16, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v13, 0
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v8, v0
...
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v13, v[8:9]
...
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, 1, v13
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v12, v5
...
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v13, v12, 0
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v11, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v4, v11, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v12, v[7:8]
; GISEL-NEXT:    v_mul_hi_u32 v7, v12, v3
; GISEL-NEXT:    v_mul_hi_u32 v3, v11, v3
; GISEL-NEXT:    v_mul_lo_u32 v8, v12, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v11, v9
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v11, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v4, v11, v3
; GISEL-NEXT:    v_and_b32_e32 v13, 0xffffff, v0
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v12, v[7:8]
; GISEL-NEXT:    v_mul_hi_u32 v0, v12, v3
; GISEL-NEXT:    v_mul_hi_u32 v3, v11, v3
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v1, v4, v[8:9]
; GISEL-NEXT:    v_mul_f32_e32 v5, 0x5f7ffffc, v5
; GISEL-NEXT:    v_mul_f32_e32 v6, 0x2f800000, v5
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], 0, v0, v[9:10]
; GISEL-NEXT:    v_trunc_f32_e32 v6, v6
; GISEL-NEXT:    v_mac_f32_e32 v5, 0xcf800000, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v14, v5
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v13, v7
; GISEL-NEXT:    v_subb_u32_e64 v13, s[4:5], 0, v11, vcc
; GISEL-NEXT:    v_sub_i32_e64 v16, s[4:5], 0, v3
; GISEL-NEXT:    v_cvt_u32_f32_e32 v15, v6
; GISEL-NEXT:    v_subb_u32_e64 v17, s[4:5], 0, 0, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v16, v14, 0
; GISEL-NEXT:    v_sub_i32_e64 v11, s[4:5], 0, v11
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v16, v15, v[6:7]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v12, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v14, v[7:8]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v13, -1, v6, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v6, v15, v5
; GISEL-NEXT:    v_mul_lo_u32 v7, v14, v9
; GISEL-NEXT:    v_mul_hi_u32 v10, v14, v5
; GISEL-NEXT:    v_subbrev_u32_e32 v8, vcc, 0, v11, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v14, v5
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v15, v6, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v16, v11, 0
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v12, v1
; GISEL-NEXT:    v_subbrev_u32_e32 v15, vcc, 0, v8, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v16, v14, v[6:7]
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v0
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v11, v[7:8]
...
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, 1, v16
...
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v16, v9, vcc
