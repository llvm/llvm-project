...
; GFX11-NEXT:    v_pk_lshrrev_b16 v0, 8, v0 op_sel_hi:[0,1]
; GFX11-NEXT:    v_pk_add_u16 v1, v3, v1 clamp
...
; GFX11-NEXT:    v_pk_add_u16 v0, s2, s4 clamp
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_i24:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_lshl_b32 s0, s0, 8
; GFX11-NEXT:    s_lshl_b32 s1, s1, 8
; GFX11-NEXT:    v_add_nc_u32_e64 v0, s0, s1 clamp
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, 8, v0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i24 @llvm.uadd.sat.i24(i24 %lhs, i24 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i32_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e64 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.uadd.sat.i32(i32 %lhs, i32 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i32_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e64 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.uadd.sat.i32(i32 %lhs, i32 %rhs)
  %cast = bitcast i32 %result to float
  ret float %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e64 v0, s0, s2 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v1, s1, s3 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_v3i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e64 v0, s0, s3 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v1, s1, s4 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e64 v0, s0, s4 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v1, s1, s5 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v2, s2, s6 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_uaddsat_v5i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_add_nc_u32_e64 v0, v0, v5 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v1, v1, v6 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v2, v2, v7 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v3, v3, v8 clamp
; GFX11-NEXT:    v_add_nc_u32_e64 v4, v4, v9 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u16_e64 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.uadd.sat.i16(i16 %lhs, i16 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u16_e64 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.uadd.sat.i16(i16 %lhs, i16 %rhs)
  %cast = bitcast i16 %result to half
  ret half %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_v2i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_add_u16 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.uadd.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_v2i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_add_u16 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.uadd.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
  %cast = bitcast <2 x i16> %result to float
  ret float %cast
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_uaddsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_add_u16 v0, v0, v3 clamp
; GFX11-NEXT:    v_pk_add_u16 v1, v1, v4 clamp
; GFX11-NEXT:    v_pk_add_u16 v2, v2, v5 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_add_u16 v0, s0, s3 clamp
; GFX11-NEXT:    v_pk_add_u16 v1, s1, s4 clamp
; GFX11-NEXT:    v_pk_add_u16 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_uaddsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_add_u16 v0, v0, v4 clamp
; GFX11-NEXT:    v_pk_add_u16 v1, v1, v5 clamp
; GFX11-NEXT:    v_pk_add_u16 v2, v2, v6 clamp
; GFX11-NEXT:    v_pk_add_u16 v3, v3, v7 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_uaddsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_add_u16 v0, s0, s4 clamp
; GFX11-NEXT:    v_pk_add_u16 v1, s1, s5 clamp
; GFX11-NEXT:    v_pk_add_u16 v2, s2, s6 clamp
; GFX11-NEXT:    v_pk_add_u16 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s2, s[0:1], s[2:3]
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s0, -1, s2
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s1, -1, s2
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i64 @llvm.uadd.sat.i64(i64 %lhs, i64 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i64_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc_lo, v0, s0
...
; GFX11-NEXT:    v_mov_b32_e32 v11, v5
; GFX11-NEXT:    v_mov_b32_e32 v15, v6
; GFX11-NEXT:    v_mov_b32_e32 v16, v7
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc_lo, v0, v10
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v11, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v5, vcc_lo, v2, v15
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v3, v16, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[0:1], v[10:11]
; GFX11-NEXT:    v_cmp_lt_u64_e64 s0, v[5:6], v[15:16]
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v0, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v1, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v5, -1, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v6, -1, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    s_and_b32 s8, s8, 1
; GFX11-NEXT:    s_cmp_lg_u32 s8, 0
; GFX11-NEXT:    s_addc_u32 s3, s3, s7
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s0, -1, s4
; GFX11-NEXT:    v_cmp_lt_u64_e64 s5, s[2:3], s[6:7]
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s1, -1, s4
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s2, -1, s5
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s3, -1, s5
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_and_b32 s8, s8, 1
; GFX11-NEXT:    s_cmp_lg_u32 s8, 0
; GFX11-NEXT:    s_addc_u32 s2, s2, s6
; GFX11-NEXT:    s_cselect_b32 s8, 1, 0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i128_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v10, vcc_lo, s0, v0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v11, vcc_lo, s1, v1, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v4, vcc_lo, s2, v2, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, s3, v3, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[10:11], v[0:1]
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[4:5], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[4:5], v[2:3]
; GFX11-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc_lo
; GFX11-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v10, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v11, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v4, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v5, -1, vcc_lo
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i128 @llvm.uadd.sat.i128(i128 %lhs, i128 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: uaddsat_i128_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc_lo, v0, s0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, s2, v2, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s3, v3, vcc_lo
; GFX11-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[0:1], v[0:1]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mov_b32_e32 v18, v8
; GFX11-NEXT:    v_mov_b32_e32 v19, v9
; GFX11-NEXT:    v_mov_b32_e32 v16, v10
; GFX11-NEXT:    v_mov_b32_e32 v17, v11
; GFX11-NEXT:    v_mov_b32_e32 v10, v12
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc_lo, v0, v18
; GFX11-NEXT:    v_mov_b32_e32 v11, v13
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v19, vcc_lo
; GFX11-NEXT:    v_mov_b32_e32 v20, v14
; GFX11-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, v2, v16, vcc_lo
; GFX11-NEXT:    v_mov_b32_e32 v21, v15
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v3, v17, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[0:1], v[18:19]
; GFX11-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v4, vcc_lo, v4, v10
; GFX11-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, v5, v11, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v6, v20, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, v7, v21, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[2:3], v[16:17]
; GFX11-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[4:5], v[10:11]
; GFX11-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e32 vcc_lo, v[6:7], v[20:21]
; GFX11-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[2:3], v[16:17]
; GFX11-NEXT:    v_cndmask_b32_e32 v8, v9, v8, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[6:7], v[20:21]
...
; GFX11-NEXT:    v_cmp_lt_u64_e64 s10, s[2:3], s[10:11]
; GFX11-NEXT:    s_cselect_b32 s16, 1, 0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s0, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s1, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s2, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v4, s3, -1, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v1
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    v_readfirstlane_b32 s2, v3
; GFX11-NEXT:    v_readfirstlane_b32 s3, v4
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s4, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s5, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, s6, -1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, s7, -1, vcc_lo
