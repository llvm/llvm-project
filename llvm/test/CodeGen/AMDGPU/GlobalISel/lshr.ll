...
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, v1, v0
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, 7, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, v0, s0
; GFX11-NEXT:    ; return to shader part epilog
  %result = lshr i16 %value, %amount
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_lshrrev_b16_e64 v0, s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = lshr i16 %value, %amount
  %cast = bitcast i16 %result to half
  ret half %cast
...
; GFX11-NEXT:    v_lshrrev_b64 v[0:1], v4, v[10:11]
; GFX11-NEXT:    v_lshrrev_b64 v[2:3], v6, v[7:8]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
