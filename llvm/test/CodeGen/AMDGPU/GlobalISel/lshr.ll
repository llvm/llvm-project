...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i24:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_and_b32 s0, s0, 0xffffff
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s1
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i24 %value, %amount
  ret i24 %result
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i24_7:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_bfe_u32 s0, s0, 0x110007
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i24 %value, 7
  ret i24 %result
}
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i32_31:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, 31
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i32 %value, 31
  ret i32 %result
}
...
;
; GFX10PLUS-LABEL: lshr_i32_sv:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_lshrrev_b32_e64 v0, v0, s0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i32 %value, %amount
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: lshr_i32_vs:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_lshrrev_b32_e32 v0, s0, v0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i32 %value, %amount
  %cast = bitcast i32 %result to float
  ret float %cast
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v2i32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s2
; GFX10PLUS-NEXT:    s_lshr_b32 s1, s1, s3
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <2 x i32> %value, %amount
  ret <2 x i32> %result
}
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v3i32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s3
; GFX10PLUS-NEXT:    s_lshr_b32 s1, s1, s4
...
; GFX10PLUS-NEXT:    v_lshrrev_b32_e32 v3, v7, v3
; GFX10PLUS-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v4i32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s4
; GFX10PLUS-NEXT:    s_lshr_b32 s1, s1, s5
; GFX10PLUS-NEXT:    s_lshr_b32 s2, s2, s6
; GFX10PLUS-NEXT:    s_lshr_b32 s3, s3, s7
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <4 x i32> %value, %amount
  ret <4 x i32> %result
}
...
; GFX10PLUS-NEXT:    v_lshrrev_b32_e32 v3, v8, v3
; GFX10PLUS-NEXT:    v_lshrrev_b32_e32 v4, v9, v4
; GFX10PLUS-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v5i32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s5
; GFX10PLUS-NEXT:    s_lshr_b32 s1, s1, s6
; GFX10PLUS-NEXT:    s_lshr_b32 s2, s2, s7
; GFX10PLUS-NEXT:    s_lshr_b32 s3, s3, s8
; GFX10PLUS-NEXT:    s_lshr_b32 s4, s4, s9
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <5 x i32> %value, %amount
  ret <5 x i32> %result
}
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v16i32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s0, s16
; GFX10PLUS-NEXT:    s_lshr_b32 s1, s1, s17
; GFX10PLUS-NEXT:    s_lshr_b32 s2, s2, s18
; GFX10PLUS-NEXT:    s_lshr_b32 s3, s3, s19
; GFX10PLUS-NEXT:    s_lshr_b32 s4, s4, s20
; GFX10PLUS-NEXT:    s_lshr_b32 s5, s5, s21
; GFX10PLUS-NEXT:    s_lshr_b32 s6, s6, s22
; GFX10PLUS-NEXT:    s_lshr_b32 s7, s7, s23
; GFX10PLUS-NEXT:    s_lshr_b32 s8, s8, s24
; GFX10PLUS-NEXT:    s_lshr_b32 s9, s9, s25
; GFX10PLUS-NEXT:    s_lshr_b32 s10, s10, s26
; GFX10PLUS-NEXT:    s_lshr_b32 s11, s11, s27
; GFX10PLUS-NEXT:    s_lshr_b32 s12, s12, s28
; GFX10PLUS-NEXT:    s_lshr_b32 s13, s13, s29
; GFX10PLUS-NEXT:    s_lshr_b32 s14, s14, s30
; GFX10PLUS-NEXT:    s_lshr_b32 s15, s15, s31
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <16 x i32> %value, %amount
  ret <16 x i32> %result
}
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: lshr_v2i16_sv:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_pk_lshrrev_b16 v0, v0, s0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <2 x i16> %value, %amount
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: lshr_v2i16_vs:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_pk_lshrrev_b16 v0, s0, v0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <2 x i16> %value, %amount
  %cast = bitcast <2 x i16> %result to float
  ret float %cast
...
; GFX10PLUS-NEXT:    v_pk_lshrrev_b16 v3, v7, v3
; GFX10PLUS-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i64:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b64 s[0:1], s[0:1], s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i64 %value, %amount
  ret i64 %result
}
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i64_63:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b32 s0, s1, 31
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i64_32:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_mov_b32 s0, s1
; GFX10PLUS-NEXT:    s_mov_b32 s1, 0
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i64 %value, 32
  ret i64 %result
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i64_31:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b64 s[0:1], s[0:1], 31
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i64 %value, 31
  ret i64 %result
}
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: lshr_i64_sv:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_lshrrev_b64 v[0:1], v0, s[0:1]
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i64 %value, %amount
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: lshr_i64_vs:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_lshrrev_b64 v[0:1], s0, v[0:1]
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr i64 %value, %amount
  %cast = bitcast i64 %result to <2 x float>
  ret <2 x float> %cast
...
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_v2i64:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshr_b64 s[0:1], s[0:1], s4
; GFX10PLUS-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = lshr <2 x i64> %value, %amount
  ret <2 x i64> %result
}
...
; GFX6-NEXT:    v_lshr_b64 v[4:5], 0, v3
; GFX6-NEXT:    v_lshr_b64 v[5:6], v[0:1], v3
; GFX6-NEXT:    v_lshr_b64 v[7:8], 0, v2
; GFX6-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GFX6-NEXT:    v_cndmask_b32_e32 v2, v7, v5, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v5, v8, v6, vcc
...
; GFX8-NEXT:    v_lshrrev_b64 v[4:5], v3, 0
; GFX8-NEXT:    v_lshrrev_b64 v[5:6], v3, v[0:1]
; GFX8-NEXT:    v_lshrrev_b64 v[7:8], v2, 0
; GFX8-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v7, v5, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v8, v6, vcc
...
; GFX9-NEXT:    v_lshrrev_b64 v[4:5], v3, 0
; GFX9-NEXT:    v_lshrrev_b64 v[5:6], v3, v[0:1]
; GFX9-NEXT:    v_lshrrev_b64 v[7:8], v2, 0
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v7, v5, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v8, v6, vcc
...
; GFX10-NEXT:    v_lshrrev_b64 v[8:9], v3, 0
; GFX10-NEXT:    v_cmp_eq_u32_e64 s4, 0, v3
; GFX10-NEXT:    v_lshrrev_b64 v[6:7], v2, 0
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v6, v4, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v7, v5, vcc_lo
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_subrev_nc_u32_e32 v2, 64, v3
; GFX11-NEXT:    v_lshrrev_b64 v[4:5], v3, v[0:1]
; GFX11-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 64, v3
; GFX11-NEXT:    v_lshrrev_b64 v[8:9], v3, 0
; GFX11-NEXT:    v_cmp_eq_u32_e64 s0, 0, v3
; GFX11-NEXT:    v_lshrrev_b64 v[6:7], v2, 0
; GFX11-NEXT:    v_cndmask_b32_e32 v2, v6, v4, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e32 v4, v7, v5, vcc_lo
...
; GCN-NEXT:    s_cmp_lg_u32 s8, 0
; GCN-NEXT:    s_cselect_b32 s2, s4, 0
; GCN-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: s_lshr_i65:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_sub_i32 s6, s3, 64
...
; GFX10PLUS-NEXT:    s_lshr_b64 s[4:5], 0, s3
; GFX10PLUS-NEXT:    s_lshr_b64 s[2:3], s[0:1], s3
; GFX10PLUS-NEXT:    s_lshr_b64 s[6:7], 0, s6
; GFX10PLUS-NEXT:    s_cmp_lg_u32 s8, 0
; GFX10PLUS-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[6:7]
