...
; RUN: llc -global-isel -mtriple=amdgpu6.00 -mem-intrinsic-expand-size=3 %s -o - | FileCheck -check-prefix=GCN %s
; RUN: llc -global-isel -mtriple=amdgpu6.00 -mem-intrinsic-expand-size=5 %s -o - | FileCheck -check-prefix=GCN %s
...
; GCN-NEXT:    buffer_load_ubyte v6, v[2:3], s[0:3], 0 addr64 offset:3
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    buffer_store_byte v6, v[0:1], s[0:3], 0 addr64 offset:3
; GCN-NEXT:    s_endpgm
