...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx810 -stop-after=instruction-select -o - %s | FileCheck -check-prefixes=PACKED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 -mattr=+wavefrontsize64 -stop-after=instruction-select -o - %s | FileCheck -check-prefixes=PACKED %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -mattr=+wavefrontsize64 -stop-after=instruction-select -o - %s | FileCheck -check-prefixes=PACKED %s
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset(ptr addrspace(8) inreg %rsrc, i32 %vindex, i32 %voffset, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 0, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 0, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
...
define amdgpu_ps <2 x half> @struct_tbuffer_load_v2f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset(ptr addrspace(8) inreg %rsrc, i32 %vindex, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[UV:%[0-9]+]]:vgpr(s32), [[UV1:%[0-9]+]]:vgpr(s32) = G_UNMERGE_VALUES [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](<2 x f32>)
...
define amdgpu_ps <4 x half> @struct_tbuffer_load_v4f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset(ptr addrspace(8) inreg %rsrc, i32 %vindex, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[UV:%[0-9]+]]:vgpr(s32), [[UV1:%[0-9]+]]:vgpr(s32), [[UV2:%[0-9]+]]:vgpr(s32), [[UV3:%[0-9]+]]:vgpr(s32) = G_UNMERGE_VALUES [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](<4 x f32>)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 65535
  ; UNPACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AND:%[0-9]+]]:vgpr(s32) = G_AND [[UV]], [[COPY7]]
  ; UNPACKED-NEXT:   [[COPY8:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset_vindex0(ptr addrspace(8) inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps <4 x half> @struct_tbuffer_load_v4f16__vgpr_rsrc__sgpr_vindex__sgpr_voffset__vgpr_soffset(ptr addrspace(8) %rsrc, i32 inreg %vindex, i32 inreg %voffset, i32 %soffset) {
  ...
  ; UNPACKED-NEXT: {{  $}}
  ; UNPACKED-NEXT: bb.5:
  ; UNPACKED-NEXT:   [[UV4:%[0-9]+]]:vgpr(s32), [[UV5:%[0-9]+]]:vgpr(s32), [[UV6:%[0-9]+]]:vgpr(s32), [[UV7:%[0-9]+]]:vgpr(s32) = G_UNMERGE_VALUES [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](<4 x f32>)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 65535
  ...
  ; UNPACKED-NEXT:   [[OR:%[0-9]+]]:vgpr(s32) = G_OR [[AND2]], [[SHL]]
  ; UNPACKED-NEXT:   [[BITCAST:%[0-9]+]]:vgpr_32(<2 x f16>) = G_BITCAST [[OR]](s32)
  ; UNPACKED-NEXT:   [[COPY12:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AND4:%[0-9]+]]:vgpr(s32) = G_AND [[UV6]], [[COPY12]]
  ...
  ; UNPACKED-NEXT:   [[SHL1:%[0-9]+]]:vgpr(s32) = G_SHL [[AND5]], [[COPY14]](s32)
  ; UNPACKED-NEXT:   [[OR1:%[0-9]+]]:vgpr_32(s32) = G_OR [[AND4]], [[SHL1]]
  ; UNPACKED-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32(<2 x f16>) = COPY [[OR1]](s32)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[BITCAST]](<2 x f16>)
...
define amdgpu_ps half @struct_tbuffer_load_f16__sgpr_rsrc__vgpr_vindex__vgpr_voffset__sgpr_soffset_voffset_add4095(ptr addrspace(8) inreg %rsrc, i32 %vindex, i32 %voffset.base, i32 inreg %soffset) {
  ...
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:sgpr(i32) = COPY $sgpr6
  ; PACKED-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:sgpr(<4 x s32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 4095, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:sgpr(i32) = COPY $sgpr6
  ; UNPACKED-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:sgpr(<4 x s32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x s32>), [[COPY4]](i32), [[COPY5]], [[COPY6]], 4095, 78, 0, -1 :: (dereferenceable load (f16) from %ir.rsrc, align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
