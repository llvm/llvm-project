...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i8_7:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GFX11-NEXT:    v_ashrrev_i16 v0, 7, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i8_7:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sext_i32_i8 s0, s0
; GFX11-NEXT:    s_ashr_i32 s0, s0, 7
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i8 %value, 7
  ret i8 %result
}
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i24:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_and_b32_e32 v1, 0xffffff, v1
; GFX11-NEXT:    v_bfe_i32 v0, v0, 0, 24
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, v1, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i24_7:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_bfe_i32 v0, v0, 0, 24
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 7, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i24:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_bfe_i32 s0, s0, 0x180000
; GFX11-NEXT:    s_ashr_i32 s0, s0, s1
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i24 %value, %amount
  ret i24 %result
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i32_31:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i32_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i32_e64 v0, v0, s0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i32 %value, %amount
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i32_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i32 %value, %amount
  %cast = bitcast i32 %result to float
  ret float %cast
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, v2, v0
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, v3, v1
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s0, s2
; GFX11-NEXT:    s_ashr_i32 s1, s1, s3
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <2 x i32> %value, %amount
  ret <2 x i32> %result
}
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v3i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, v3, v0
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, v4, v1
; GFX11-NEXT:    v_ashrrev_i32_e32 v2, v5, v2
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v3i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s0, s3
; GFX11-NEXT:    s_ashr_i32 s1, s1, s4
; GFX11-NEXT:    s_ashr_i32 s2, s2, s5
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <3 x i32> %value, %amount
  ret <3 x i32> %result
}
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, v4, v0
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, v5, v1
; GFX11-NEXT:    v_ashrrev_i32_e32 v2, v6, v2
; GFX11-NEXT:    v_ashrrev_i32_e32 v3, v7, v3
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s0, s4
; GFX11-NEXT:    s_ashr_i32 s1, s1, s5
; GFX11-NEXT:    s_ashr_i32 s2, s2, s6
; GFX11-NEXT:    s_ashr_i32 s3, s3, s7
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <4 x i32> %value, %amount
  ret <4 x i32> %result
}
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v5i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, v5, v0
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, v6, v1
; GFX11-NEXT:    v_ashrrev_i32_e32 v2, v7, v2
; GFX11-NEXT:    v_ashrrev_i32_e32 v3, v8, v3
; GFX11-NEXT:    v_ashrrev_i32_e32 v4, v9, v4
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v5i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s0, s5
; GFX11-NEXT:    s_ashr_i32 s1, s1, s6
; GFX11-NEXT:    s_ashr_i32 s2, s2, s7
; GFX11-NEXT:    s_ashr_i32 s3, s3, s8
; GFX11-NEXT:    s_ashr_i32 s4, s4, s9
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <5 x i32> %value, %amount
  ret <5 x i32> %result
}
...
; GFX11-NEXT:    v_ashrrev_i32_e32 v3, v19, v3
; GFX11-NEXT:    v_ashrrev_i32_e32 v4, v20, v4
; GFX11-NEXT:    v_ashrrev_i32_e32 v5, v21, v5
; GFX11-NEXT:    v_ashrrev_i32_e32 v6, v22, v6
; GFX11-NEXT:    v_ashrrev_i32_e32 v7, v23, v7
; GFX11-NEXT:    v_ashrrev_i32_e32 v8, v24, v8
; GFX11-NEXT:    v_ashrrev_i32_e32 v9, v25, v9
; GFX11-NEXT:    v_ashrrev_i32_e32 v10, v26, v10
; GFX11-NEXT:    v_ashrrev_i32_e32 v11, v27, v11
; GFX11-NEXT:    v_ashrrev_i32_e32 v12, v28, v12
; GFX11-NEXT:    v_ashrrev_i32_e32 v13, v29, v13
; GFX11-NEXT:    v_ashrrev_i32_e32 v14, v30, v14
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_ashrrev_i32_e32 v15, v31, v15
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v16i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s0, s16
; GFX11-NEXT:    s_ashr_i32 s1, s1, s17
; GFX11-NEXT:    s_ashr_i32 s2, s2, s18
; GFX11-NEXT:    s_ashr_i32 s3, s3, s19
; GFX11-NEXT:    s_ashr_i32 s4, s4, s20
; GFX11-NEXT:    s_ashr_i32 s5, s5, s21
; GFX11-NEXT:    s_ashr_i32 s6, s6, s22
; GFX11-NEXT:    s_ashr_i32 s7, s7, s23
; GFX11-NEXT:    s_ashr_i32 s8, s8, s24
; GFX11-NEXT:    s_ashr_i32 s9, s9, s25
; GFX11-NEXT:    s_ashr_i32 s10, s10, s26
; GFX11-NEXT:    s_ashr_i32 s11, s11, s27
; GFX11-NEXT:    s_ashr_i32 s12, s12, s28
; GFX11-NEXT:    s_ashr_i32 s13, s13, s29
; GFX11-NEXT:    s_ashr_i32 s14, s14, s30
; GFX11-NEXT:    s_ashr_i32 s15, s15, s31
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <16 x i32> %value, %amount
  ret <16 x i32> %result
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i16_15:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sext_i32_i16 s0, s0
; GFX11-NEXT:    s_ashr_i32 s0, s0, 15
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i16 v0, v0, s0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i16 %value, %amount
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i16 v0, s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i16 %value, %amount
  %cast = bitcast i16 %result to half
  ret half %cast
...
; GFX11-NEXT:    s_sext_i32_i16 s3, s1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_v2i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_ashrrev_i16 v0, v0, s0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <2 x i16> %value, %amount
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_v2i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_ashrrev_i16 v0, s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <2 x i16> %value, %amount
  %cast = bitcast <2 x i16> %result to float
  ret float %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v4i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sext_i32_i16 s4, s0
; GFX11-NEXT:    s_ashr_i32 s0, s0, 16
; GFX11-NEXT:    s_sext_i32_i16 s5, s2
; GFX11-NEXT:    s_ashr_i32 s2, s2, 16
; GFX11-NEXT:    s_ashr_i32 s4, s4, s5
; GFX11-NEXT:    s_ashr_i32 s0, s0, s2
; GFX11-NEXT:    s_sext_i32_i16 s2, s1
; GFX11-NEXT:    s_ashr_i32 s1, s1, 16
; GFX11-NEXT:    s_sext_i32_i16 s5, s3
; GFX11-NEXT:    s_ashr_i32 s3, s3, 16
; GFX11-NEXT:    s_ashr_i32 s2, s2, s5
; GFX11-NEXT:    s_ashr_i32 s1, s1, s3
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_ashrrev_i16 v0, v4, v0
; GFX11-NEXT:    v_pk_ashrrev_i16 v1, v5, v1
; GFX11-NEXT:    v_pk_ashrrev_i16 v2, v6, v2
; GFX11-NEXT:    v_pk_ashrrev_i16 v3, v7, v3
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sext_i32_i16 s8, s0
; GFX11-NEXT:    s_ashr_i32 s0, s0, 16
; GFX11-NEXT:    s_sext_i32_i16 s9, s4
; GFX11-NEXT:    s_ashr_i32 s4, s4, 16
; GFX11-NEXT:    s_ashr_i32 s8, s8, s9
; GFX11-NEXT:    s_ashr_i32 s0, s0, s4
; GFX11-NEXT:    s_sext_i32_i16 s4, s1
; GFX11-NEXT:    s_ashr_i32 s1, s1, 16
; GFX11-NEXT:    s_sext_i32_i16 s9, s5
; GFX11-NEXT:    s_ashr_i32 s5, s5, 16
; GFX11-NEXT:    s_ashr_i32 s4, s4, s9
; GFX11-NEXT:    s_ashr_i32 s1, s1, s5
; GFX11-NEXT:    s_sext_i32_i16 s5, s6
; GFX11-NEXT:    s_pack_ll_b32_b16 s1, s4, s1
; GFX11-NEXT:    s_sext_i32_i16 s4, s2
; GFX11-NEXT:    s_ashr_i32 s2, s2, 16
; GFX11-NEXT:    s_ashr_i32 s6, s6, 16
; GFX11-NEXT:    s_ashr_i32 s4, s4, s5
; GFX11-NEXT:    s_ashr_i32 s2, s2, s6
; GFX11-NEXT:    s_sext_i32_i16 s5, s3
; GFX11-NEXT:    s_ashr_i32 s3, s3, 16
; GFX11-NEXT:    s_sext_i32_i16 s6, s7
; GFX11-NEXT:    s_ashr_i32 s7, s7, 16
; GFX11-NEXT:    s_ashr_i32 s5, s5, s6
; GFX11-NEXT:    s_ashr_i32 s3, s3, s7
; GFX11-NEXT:    s_pack_ll_b32_b16 s0, s8, s0
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i64_63:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 31, v1
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i64_33:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 1, v1
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, 31, v1
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_i64_31:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], 31, v[0:1]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i64 s[0:1], s[0:1], s2
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i64 %value, %amount
  ret i64 %result
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i64_63:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i32 s0, s1, 31
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i64_31:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i64 s[0:1], s[0:1], 31
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i64 %value, 31
  ret i64 %result
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i64_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], v0, s[0:1]
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i64 %value, %amount
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ashr_i64_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], s0, v[0:1]
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i64 %value, %amount
  %cast = bitcast i64 %result to <2 x float>
  ret <2 x float> %cast
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v2i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], v4, v[0:1]
; GFX11-NEXT:    v_ashrrev_i64 v[2:3], v6, v[2:3]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ashr_v2i64_31:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], 31, v[0:1]
; GFX11-NEXT:    v_ashrrev_i64 v[2:3], 31, v[2:3]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_v2i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_ashr_i64 s[0:1], s[0:1], s4
; GFX11-NEXT:    s_ashr_i64 s[2:3], s[2:3], s6
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr <2 x i64> %value, %amount
  ret <2 x i64> %result
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i65:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_bfe_i64 s[4:5], s[2:3], 0x10000
; GFX11-NEXT:    s_sub_i32 s12, s3, 64
; GFX11-NEXT:    s_sub_i32 s8, 64, s3
...
; GFX11-NEXT:    s_ashr_i64 s[6:7], s[4:5], s3
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[0:1], s3
; GFX11-NEXT:    s_lshl_b64 s[8:9], s[4:5], s8
; GFX11-NEXT:    s_ashr_i32 s10, s5, 31
; GFX11-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
; GFX11-NEXT:    s_ashr_i64 s[4:5], s[4:5], s12
...
; GFX11-NEXT:    s_cmp_lg_u32 s13, 0
; GFX11-NEXT:    s_cselect_b64 s[2:3], s[6:7], s[10:11]
; GFX11-NEXT:    ; return to shader part epilog
  %result = ashr i65 %value, %amount
  ret i65 %result
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ashr_i65_33:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX11-NEXT:    s_lshr_b32 s0, s1, 1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    s_lshl_b64 s[4:5], s[2:3], 31
; GFX11-NEXT:    s_ashr_i32 s2, s3, 1
