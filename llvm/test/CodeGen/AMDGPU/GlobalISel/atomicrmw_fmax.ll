...
; GFX942-NEXT:    buffer_load_dword v0, v3, s[0:3], 0 offen
...
; GFX90A-NEXT:    buffer_load_dword v0, v3, s[16:19], 0 offen
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:    buffer_load_dword v0, v3, s[16:19], 0 offen
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
; GFX908-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    buffer_load_dword v0, v3, s[16:19], 0 offen
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_readfirstlane_b32 s6, v2
...
; GFX11-NEXT:    buffer_load_b64 v[0:1], v10, s[0:3], 0 offen
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:    buffer_load_dwordx2 v[0:1], v10, s[16:19], 0 offen
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_readfirstlane_b32 s6, v0
...
; GFX8-NEXT:    buffer_load_dwordx2 v[0:1], v10, s[16:19], 0 offen
; GFX8-NEXT:    s_mov_b64 s[4:5], 0
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_readfirstlane_b32 s6, v0
