...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX6-IEEE,GFX6-IEEE-FASTFMA %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX6-FLUSH,GFX6-FLUSH-FASTFMA %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=pitcairn < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX6-IEEE,GFX6-IEEE-SLOWFMA %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=pitcairn < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX6-FLUSH,GFX6-FLUSH-SLOWFMA %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=fiji < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX89-IEEE %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=fiji < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX89-FLUSH %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 < %t.ieee | FileCheck -check-prefixes=GCN,GCN-IEEE,GFX89-IEEE %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 < %t.preservesign | FileCheck -check-prefixes=GCN,GCN-FLUSH,GFX89-FLUSH %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1010 < %t.ieee | FileCheck -check-prefixes=GFX10,GFX10-IEEE %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1010 < %t.preservesign | FileCheck -check-prefixes=GFX10,GFX10-FLUSH %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 < %t.ieee | FileCheck -check-prefixes=GFX11,GFX11-IEEE %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 < %t.preservesign | FileCheck -check-prefixes=GFX11,GFX11-FLUSH %s
...
; GCN-FLUSH-NEXT:    v_cmp_gt_f32_e64 vcc, |v1|, s4
; GCN-FLUSH-NEXT:    v_cndmask_b32_e32 v2, 1.0, v2, vcc
...
; GFX10-IEEE-NEXT:    v_div_scale_f32 v3, vcc_lo, 1.0, v0, 1.0
...
; GFX11-IEEE-NEXT:    v_div_scale_f32 v3, vcc_lo, 1.0, v0, 1.0
; GFX11-IEEE-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v6, -v4, v5, 1.0
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v5, v6, v5, v5
...
; GFX6-IEEE-FASTFMA-NEXT:    v_div_scale_f32 v4, vcc, v1, v3, v1
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v2, -v6, v8, 1.0
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v2, v2, v8, v8
; GFX6-IEEE-FASTFMA-NEXT:    v_mul_f32_e32 v5, v4, v2
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v7, -v6, v5, v4
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v5, v7, v2, v5
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v4, -v6, v5, v4
; GFX6-IEEE-FASTFMA-NEXT:    v_div_fmas_f32 v2, v4, v2, v5
...
; GFX6-IEEE-FASTFMA-NEXT:    v_div_scale_f32 v3, vcc, 1.0, v1, 1.0
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v2, -v5, v4, 1.0
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v2, v2, v4, v4
; GFX6-IEEE-FASTFMA-NEXT:    v_mul_f32_e32 v4, v3, v2
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v6, -v5, v4, v3
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v4, v6, v2, v4
; GFX6-IEEE-FASTFMA-NEXT:    v_fma_f32 v3, -v5, v4, v3
; GFX6-IEEE-FASTFMA-NEXT:    v_div_fmas_f32 v2, v3, v2, v4
