...
; OLD_RBS-NEXT:    v_readfirstlane_b32 s0, v2
; OLD_RBS-NEXT:    s_add_i32 s0, s0, s1
...
; OLD_RBS-NEXT:    v_readfirstlane_b32 s0, v2
; OLD_RBS-NEXT:    s_add_i32 s0, s0, s2
; OLD_RBS-NEXT:    v_mov_b32_e32 v2, s0
; OLD_RBS-NEXT:    global_store_dword v[0:1], v2, off
; OLD_RBS-NEXT:    s_endpgm
;
...
; OLD_RBS-NEXT:    v_readfirstlane_b32 s0, v3
; OLD_RBS-NEXT:    s_add_i32 s0, s0, 1
; OLD_RBS-NEXT:    v_mov_b32_e32 v2, s0
; OLD_RBS-NEXT:    global_store_dword v[0:1], v2, off
; OLD_RBS-NEXT:    s_endpgm
;
...
; OLD_RBS-NEXT:    s_cmp_lg_u32 s0, 0
; OLD_RBS-NEXT:    s_cselect_b32 s0, 1, 0
; OLD_RBS-NEXT:    s_and_b32 s0, s0, 1
; OLD_RBS-NEXT:    s_cmp_lg_u32 s0, 0
; OLD_RBS-NEXT:    s_cselect_b32 s0, s1, s2
; OLD_RBS-NEXT:    v_mov_b32_e32 v2, s0
; OLD_RBS-NEXT:    global_store_dword v[0:1], v2, off
; OLD_RBS-NEXT:    s_endpgm
;
...
; OLD_RBS-NEXT:    s_cselect_b32 vcc_lo, exec_lo, 0
...
; OLD_RBS-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; OLD_RBS-NEXT:  ; %bb.1: ; %B
; OLD_RBS-NEXT:    s_mov_b32 s1, 1
; OLD_RBS-NEXT:    v_mov_b32_e32 v0, s1
...
; OLD_RBS-NEXT:    s_add_i32 s1, s1, 1
; OLD_RBS-NEXT:    v_cvt_f32_u32_e32 v3, s1
; OLD_RBS-NEXT:    v_cmp_gt_f32_e32 vcc_lo, v3, v0
; OLD_RBS-NEXT:    v_mov_b32_e32 v3, s1
...
; OLD_RBS:       ; %bb.0: ; %entry
; OLD_RBS-NEXT:    s_mov_b32 s0, 0
; OLD_RBS-NEXT:    s_mov_b32 s4, 0
; OLD_RBS-NEXT:    ; implicit-def: $sgpr5
...
; OLD_RBS-NEXT:    s_or_b32 exec_lo, exec_lo, s7
; OLD_RBS-NEXT:    s_andn2_b32 s2, s5, exec_lo
; OLD_RBS-NEXT:    s_and_b32 s3, exec_lo, s6
; OLD_RBS-NEXT:    s_or_b32 s5, s2, s3
; OLD_RBS-NEXT:  .LBB16_2: ; %Flow
; OLD_RBS-NEXT:    ; in Loop: Header=BB16_3 Depth=1
; OLD_RBS-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; OLD_RBS-NEXT:    s_and_b32 s1, exec_lo, s5
; OLD_RBS-NEXT:    s_or_b32 s4, s1, s4
; OLD_RBS-NEXT:    s_andn2_b32 exec_lo, exec_lo, s4
; OLD_RBS-NEXT:    s_cbranch_execz .LBB16_6
; OLD_RBS-NEXT:  .LBB16_3: ; %A
; OLD_RBS-NEXT:    ; =>This Inner Loop Header: Depth=1
; OLD_RBS-NEXT:    s_ashr_i32 s1, s0, 31
; OLD_RBS-NEXT:    s_lshl_b64 s[2:3], s[0:1], 2
; OLD_RBS-NEXT:    s_andn2_b32 s1, s5, exec_lo
; OLD_RBS-NEXT:    v_mov_b32_e32 v7, s3
; OLD_RBS-NEXT:    v_mov_b32_e32 v6, s2
; OLD_RBS-NEXT:    s_and_b32 s5, exec_lo, exec_lo
; OLD_RBS-NEXT:    s_or_b32 s5, s1, s5
; OLD_RBS-NEXT:    v_add_co_u32 v6, vcc_lo, v2, v6
; OLD_RBS-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, v3, v7, vcc_lo
; OLD_RBS-NEXT:    global_load_dword v6, v[6:7], off
; OLD_RBS-NEXT:    s_waitcnt vmcnt(0)
; OLD_RBS-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
...
; OLD_RBS-NEXT:    v_mov_b32_e32 v7, s3
; OLD_RBS-NEXT:    v_mov_b32_e32 v6, s2
; OLD_RBS-NEXT:    s_mov_b32 s6, exec_lo
; OLD_RBS-NEXT:    v_add_co_u32 v6, vcc_lo, v4, v6
; OLD_RBS-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, v5, v7, vcc_lo
; OLD_RBS-NEXT:    global_load_dword v6, v[6:7], off
; OLD_RBS-NEXT:    s_waitcnt vmcnt(0)
; OLD_RBS-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
; OLD_RBS-NEXT:    s_and_saveexec_b32 s7, vcc_lo
; OLD_RBS-NEXT:    s_cbranch_execz .LBB16_1
; OLD_RBS-NEXT:  ; %bb.5: ; %loop.body
; OLD_RBS-NEXT:    ; in Loop: Header=BB16_3 Depth=1
; OLD_RBS-NEXT:    v_mov_b32_e32 v7, s3
; OLD_RBS-NEXT:    v_mov_b32_e32 v6, s2
; OLD_RBS-NEXT:    s_add_i32 s2, s0, 1
; OLD_RBS-NEXT:    s_cmpk_lt_u32 s0, 0x64
; OLD_RBS-NEXT:    s_cselect_b32 s0, exec_lo, 0
; OLD_RBS-NEXT:    v_add_co_u32 v6, vcc_lo, v0, v6
; OLD_RBS-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, v1, v7, vcc_lo
; OLD_RBS-NEXT:    s_andn2_b32 s3, s6, exec_lo
; OLD_RBS-NEXT:    s_and_b32 s0, exec_lo, s0
; OLD_RBS-NEXT:    s_or_b32 s6, s3, s0
; OLD_RBS-NEXT:    global_load_dword v8, v[6:7], off
; OLD_RBS-NEXT:    s_mov_b32 s0, s2
; OLD_RBS-NEXT:    s_waitcnt vmcnt(0)
; OLD_RBS-NEXT:    v_add_nc_u32_e32 v8, 1, v8
; OLD_RBS-NEXT:    global_store_dword v[6:7], v8, off
