...
; RUN: llc -global-isel -global-isel-abort=2 -amdgpu-codegenprepare-disable-idiv-expansion=0 -mtriple=amdgcn-amd-amdpal -mcpu=gfx600 < %s | FileCheck -check-prefixes=CHECK,CGP %s
...
; GISEL-NEXT:    s_sub_i32 s2, s0, s1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GISEL-NEXT:    s_cmp_ge_u32 s0, s1
; GISEL-NEXT:    s_cselect_b64 vcc, -1, 0
; GISEL-NEXT:    s_cselect_b32 s0, s2, s0
...
; GISEL-NEXT:    v_add_i32_e64 v2, s[4:5], 1, v5
...
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, 12, v1
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, 12, v2
; GISEL-NEXT:    v_lshrrev_b32_e32 v0, v2, v0
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, 12, v3
; GISEL-NEXT:    v_lshrrev_b32_e32 v1, v2, v1
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GISEL-NEXT:    v_rcp_f32_e32 v2, v1
; GISEL-NEXT:    v_mul_f32_e32 v2, v0, v2
; GISEL-NEXT:    v_trunc_f32_e32 v2, v2
; GISEL-NEXT:    v_mad_f32 v0, -v2, v1, v0
; GISEL-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v0|, v1
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v2, v2
; GISEL-NEXT:    v_and_b32_e32 v0, 0xffffff, v0
; GISEL-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GISEL-NEXT:    v_and_b32_e32 v3, 0xffffff, v3
; GISEL-NEXT:    v_rcp_f32_e32 v4, v2
; GISEL-NEXT:    v_cvt_f32_u32_e32 v3, v3
; GISEL-NEXT:    v_and_b32_e32 v1, 0xffffff, v1
; GISEL-NEXT:    v_cvt_f32_u32_e32 v1, v1
; GISEL-NEXT:    v_mul_f32_e32 v4, v0, v4
; GISEL-NEXT:    v_trunc_f32_e32 v4, v4
; GISEL-NEXT:    v_mad_f32 v0, -v4, v2, v0
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v0|, v2
; GISEL-NEXT:    v_cvt_u32_f32_e32 v2, v4
; GISEL-NEXT:    v_rcp_f32_e32 v4, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v2, v0
; GISEL-NEXT:    v_mul_f32_e32 v2, v1, v4
; GISEL-NEXT:    v_trunc_f32_e32 v2, v2
; GISEL-NEXT:    v_mad_f32 v1, -v2, v3, v1
; GISEL-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v1|, v3
