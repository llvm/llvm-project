...
define amdgpu_kernel void @test_call_external_void_func_sret_struct_i8_i32_byval_struct_i8_i32(i32) #0 {
  ...
  ; GCN-NEXT:   %18:_(p5) = nuw nusw G_PTR_ADD [[FRAME_INDEX]], [[C2]](i32)
  ; GCN-NEXT:   G_STORE [[C]](i8), [[FRAME_INDEX]](p5) :: (store (i8) into %ir.in.val, addrspace 5)
  ; GCN-NEXT:   G_STORE [[C1]](i32), %18(p5) :: (store (i32) into %ir.in.gep1, addrspace 5)
  ...
  ; GCN-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY12]], [[C3]](i64)
  ...
  ; GCN-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p5) = G_PTR_ADD [[AMDGPU_WAVE_ADDRESS]], [[C6]](i32)
  ; GCN-NEXT:   [[C7:%[0-9]+]]:_(i32) = G_CONSTANT i32 8
  ; GCN-NEXT:   G_MEMCPY [[PTR_ADD1]](p5), [[FRAME_INDEX]](p5), [[C7]](i32), 0 :: (dereferenceable store (i64) into stack, align 4, addrspace 5), (dereferenceable load (i64) from %ir.in.val, align 4, addrspace 5)
  ...
  ; GCN-NEXT:   %46:_(p5) = nuw nusw G_PTR_ADD [[FRAME_INDEX1]], [[C2]](i32)
  ; GCN-NEXT:   [[LOAD:%[0-9]+]]:_(i8) = G_LOAD [[FRAME_INDEX1]](p5) :: (dereferenceable load (i8) from %ir.out.val, addrspace 5)
  ; GCN-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD %46(p5) :: (dereferenceable load (i32) from %ir.out.gep1, addrspace 5)
  ; GCN-NEXT:   G_STORE [[LOAD]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
