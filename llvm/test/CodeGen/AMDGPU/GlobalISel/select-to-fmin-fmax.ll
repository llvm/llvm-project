...
; GCN-NEXT:    v_cndmask_b32_e64 v0, v3, 0, s[4:5]
; GCN-NEXT:    v_cmp_gt_f16_e32 vcc, 0, v1
; GCN-NEXT:    v_cmp_lt_f16_sdwa s[4:5], v1, v4 src0_sel:WORD_1 src1_sel:DWORD
; GCN-NEXT:    v_cndmask_b32_e64 v3, v1, 0, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v1, v2, 0, s[4:5]
; GCN-NEXT:    s_mov_b32 s4, 0x5040100
; GCN-NEXT:    v_perm_b32 v0, v0, v5, s4
; GCN-NEXT:    v_perm_b32 v1, v1, v3, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; GCN-NEXT:    v_cndmask_b32_e64 v0, v5, 0, s[4:5]
; GCN-NEXT:    v_cmp_gt_f16_e32 vcc, 0, v1
; GCN-NEXT:    v_cmp_lt_f16_sdwa s[4:5], v1, v8 src0_sel:WORD_1 src1_sel:DWORD
; GCN-NEXT:    v_lshrrev_b32_e32 v7, 16, v2
; GCN-NEXT:    v_cndmask_b32_e64 v5, v1, 0, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v1, v4, 0, s[4:5]
...
; GCN-NEXT:    v_cndmask_b32_e64 v2, v7, 0, s[4:5]
; GCN-NEXT:    v_cmp_gt_f16_e32 vcc, 0, v3
; GCN-NEXT:    v_cmp_lt_f16_sdwa s[4:5], v3, v8 src0_sel:WORD_1 src1_sel:DWORD
; GCN-NEXT:    v_cndmask_b32_e64 v7, v3, 0, vcc
; GCN-NEXT:    v_cndmask_b32_e64 v3, v6, 0, s[4:5]
; GCN-NEXT:    s_mov_b32 s4, 0x5040100
; GCN-NEXT:    v_perm_b32 v0, v0, v9, s4
; GCN-NEXT:    v_perm_b32 v1, v1, v5, s4
; GCN-NEXT:    v_perm_b32 v2, v2, v4, s4
; GCN-NEXT:    v_perm_b32 v3, v3, v7, s4
; GCN-NEXT:    s_setpc_b64 s[30:31]
entry:
