...
define amdgpu_kernel void @test_call_external_void_func_i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY12]], [[C1]](i64)
  ; GFX900-NEXT:   [[COPY13:%[0-9]+]]:_(i64) = COPY [[COPY6]]
  ; GFX900-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY5]]
  ; GFX900-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX900-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX900-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ...
  ; GFX900-NEXT:   [[COPY20:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY20]](<4 x i32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = COPY [[COPY10]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = COPY [[COPY11]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; GFX900-NEXT:   $sgpr10_sgpr11 = COPY [[COPY13]](i64)
  ; GFX900-NEXT:   $sgpr12 = COPY [[COPY14]](i32)
  ; GFX900-NEXT:   $sgpr13 = COPY [[COPY15]](i32)
  ; GFX900-NEXT:   $sgpr14 = COPY [[COPY16]](i32)
  ; GFX900-NEXT:   $sgpr15 = COPY [[DEF]](i32)
  ...
  ; GFX908-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY12]], [[C1]](i64)
  ; GFX908-NEXT:   [[COPY13:%[0-9]+]]:_(i64) = COPY [[COPY6]]
  ; GFX908-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY5]]
  ; GFX908-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX908-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX908-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ...
  ; GFX908-NEXT:   [[COPY20:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY20]](<4 x i32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = COPY [[COPY10]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = COPY [[COPY11]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; GFX908-NEXT:   $sgpr10_sgpr11 = COPY [[COPY13]](i64)
  ; GFX908-NEXT:   $sgpr12 = COPY [[COPY14]](i32)
  ; GFX908-NEXT:   $sgpr13 = COPY [[COPY15]](i32)
  ; GFX908-NEXT:   $sgpr14 = COPY [[COPY16]](i32)
  ; GFX908-NEXT:   $sgpr15 = COPY [[DEF]](i32)
...
define void @test_func_call_external_void_func_i32() #0 {
  ...
  ; GFX900-NEXT:   [[COPY12:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX900-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX900-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX900-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX900-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; GFX900-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; GFX900-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX900-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x i32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = COPY [[COPY9]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = COPY [[COPY10]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = COPY [[COPY11]](p4)
  ; GFX900-NEXT:   $sgpr10_sgpr11 = COPY [[COPY12]](i64)
  ; GFX900-NEXT:   $sgpr12 = COPY [[COPY13]](i32)
  ; GFX900-NEXT:   $sgpr13 = COPY [[COPY14]](i32)
  ; GFX900-NEXT:   $sgpr14 = COPY [[COPY15]](i32)
  ; GFX900-NEXT:   $sgpr15 = COPY [[COPY16]](i32)
  ...
  ; GFX908-NEXT:   [[COPY12:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX908-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX908-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX908-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX908-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; GFX908-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; GFX908-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX908-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x i32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = COPY [[COPY9]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = COPY [[COPY10]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = COPY [[COPY11]](p4)
  ; GFX908-NEXT:   $sgpr10_sgpr11 = COPY [[COPY12]](i64)
  ; GFX908-NEXT:   $sgpr12 = COPY [[COPY13]](i32)
  ; GFX908-NEXT:   $sgpr13 = COPY [[COPY14]](i32)
  ; GFX908-NEXT:   $sgpr14 = COPY [[COPY15]](i32)
  ; GFX908-NEXT:   $sgpr15 = COPY [[COPY16]](i32)
...
define void @test_func_call_external_void_func_v32i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   [[COPY29:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX900-NEXT:   [[COPY30:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX900-NEXT:   [[COPY31:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX900-NEXT:   [[COPY32:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX900-NEXT:   [[COPY33:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ...
  ; GFX900-NEXT:   $vgpr29 = COPY [[UV29]](i32)
  ; GFX900-NEXT:   $vgpr30 = COPY [[UV30]](i32)
  ; GFX900-NEXT:   [[COPY35:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY35]](<4 x i32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = COPY [[COPY26]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = COPY [[COPY27]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = COPY [[COPY28]](p4)
  ; GFX900-NEXT:   $sgpr10_sgpr11 = COPY [[COPY29]](i64)
  ; GFX900-NEXT:   $sgpr12 = COPY [[COPY30]](i32)
  ; GFX900-NEXT:   $sgpr13 = COPY [[COPY31]](i32)
  ; GFX900-NEXT:   $sgpr14 = COPY [[COPY32]](i32)
  ; GFX900-NEXT:   $sgpr15 = COPY [[COPY33]](i32)
  ...
  ; GFX908-NEXT:   [[COPY29:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX908-NEXT:   [[COPY30:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX908-NEXT:   [[COPY31:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX908-NEXT:   [[COPY32:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX908-NEXT:   [[COPY33:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ...
  ; GFX908-NEXT:   $vgpr29 = COPY [[UV29]](i32)
  ; GFX908-NEXT:   $vgpr30 = COPY [[UV30]](i32)
  ; GFX908-NEXT:   [[COPY35:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY35]](<4 x i32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = COPY [[COPY26]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = COPY [[COPY27]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = COPY [[COPY28]](p4)
  ; GFX908-NEXT:   $sgpr10_sgpr11 = COPY [[COPY29]](i64)
  ; GFX908-NEXT:   $sgpr12 = COPY [[COPY30]](i32)
  ; GFX908-NEXT:   $sgpr13 = COPY [[COPY31]](i32)
  ; GFX908-NEXT:   $sgpr14 = COPY [[COPY32]](i32)
  ; GFX908-NEXT:   $sgpr15 = COPY [[COPY33]](i32)
...
define amdgpu_kernel void @test_only_workitem_id_x() #0 !reqd_work_group_size !0 {
  ...
  ; GFX900-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY10]], [[C1]](i64)
  ; GFX900-NEXT:   [[COPY11:%[0-9]+]]:_(i64) = COPY [[COPY4]]
  ; GFX900-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX900-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX900-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; GFX900-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ; GFX900-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; GFX900-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX900-NEXT:   [[COPY16:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY16]](<4 x i32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = COPY [[COPY8]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = COPY [[COPY9]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; GFX900-NEXT:   $sgpr10_sgpr11 = COPY [[COPY11]](i64)
  ; GFX900-NEXT:   $sgpr12 = COPY [[COPY12]](i32)
  ; GFX900-NEXT:   $sgpr13 = COPY [[COPY13]](i32)
  ; GFX900-NEXT:   $sgpr14 = COPY [[COPY14]](i32)
  ; GFX900-NEXT:   $sgpr15 = COPY [[DEF]](i32)
  ...
  ; GFX908-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY10]], [[C1]](i64)
  ; GFX908-NEXT:   [[COPY11:%[0-9]+]]:_(i64) = COPY [[COPY4]]
  ; GFX908-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX908-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; GFX908-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; GFX908-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ; GFX908-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; GFX908-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX908-NEXT:   [[COPY16:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY16]](<4 x i32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = COPY [[COPY8]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = COPY [[COPY9]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; GFX908-NEXT:   $sgpr10_sgpr11 = COPY [[COPY11]](i64)
  ; GFX908-NEXT:   $sgpr12 = COPY [[COPY12]](i32)
  ; GFX908-NEXT:   $sgpr13 = COPY [[COPY13]](i32)
  ; GFX908-NEXT:   $sgpr14 = COPY [[COPY14]](i32)
  ; GFX908-NEXT:   $sgpr15 = COPY [[DEF]](i32)
...
define amdgpu_kernel void @test_only_workitem_id_xy() #0 !reqd_work_group_size !3 {
  ...
  ; GFX900-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; GFX900-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY11]], [[C1]](i64)
  ; GFX900-NEXT:   [[COPY12:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX900-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX900-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX900-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ...
  ; GFX900-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX900-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX900-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x i32>)
  ; GFX900-NEXT:   $sgpr4_sgpr5 = COPY [[COPY9]](p4)
  ; GFX900-NEXT:   $sgpr6_sgpr7 = COPY [[COPY10]](p4)
  ; GFX900-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ...
  ; GFX908-NEXT:   [[C1:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; GFX908-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY11]], [[C1]](i64)
  ; GFX908-NEXT:   [[COPY12:%[0-9]+]]:_(i64) = COPY [[COPY5]]
  ; GFX908-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GFX908-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; GFX908-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ...
  ; GFX908-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX908-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; GFX908-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY18]](<4 x i32>)
  ; GFX908-NEXT:   $sgpr4_sgpr5 = COPY [[COPY9]](p4)
  ; GFX908-NEXT:   $sgpr6_sgpr7 = COPY [[COPY10]](p4)
  ; GFX908-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
