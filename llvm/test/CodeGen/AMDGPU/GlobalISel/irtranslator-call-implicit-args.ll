...
define amdgpu_kernel void @test_call_external_void_func_i32([17 x i8]) #0 {
  ...
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr1, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ...
  ; GFX900-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX900-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX900-NEXT:   [[COPY8:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX900-NEXT:   [[COPY9:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ...
  ; GFX900-NEXT:   $sgpr0_3 = COPY [[COPY20]](<4 x s32>)
  ; GFX900-NEXT:   $sgpr4_5 = COPY [[COPY10]](p4)
  ; GFX900-NEXT:   $sgpr6_7 = COPY [[COPY11]](p4)
  ; GFX900-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; GFX900-NEXT:   $sgpr10_11 = COPY [[COPY13]](s64)
  ...
  ; GFX900-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @external_void_func_i32, csr_amdgpu, implicit $vgpr0, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
  ...
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr1, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ...
  ; GFX908-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX908-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX908-NEXT:   [[COPY8:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX908-NEXT:   [[COPY9:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ...
  ; GFX908-NEXT:   $sgpr0_3 = COPY [[COPY20]](<4 x s32>)
  ; GFX908-NEXT:   $sgpr4_5 = COPY [[COPY10]](p4)
  ; GFX908-NEXT:   $sgpr6_7 = COPY [[COPY11]](p4)
  ; GFX908-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; GFX908-NEXT:   $sgpr10_11 = COPY [[COPY13]](s64)
  ...
  ; GFX908-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @external_void_func_i32, csr_amdgpu, implicit $vgpr0, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
...
define void @test_func_call_external_void_func_i32() #0 {
  ...
  ; GFX900-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ...
  ; GFX900-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX900-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr8_9
  ; GFX900-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX900-NEXT:   [[COPY8:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ...
  ; GFX900-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX900-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; GFX900-NEXT:   $sgpr0_3 = COPY [[COPY18]](<4 x s32>)
  ; GFX900-NEXT:   $sgpr4_5 = COPY [[COPY9]](p4)
  ; GFX900-NEXT:   $sgpr6_7 = COPY [[COPY10]](p4)
  ; GFX900-NEXT:   $sgpr8_9 = COPY [[COPY11]](p4)
  ; GFX900-NEXT:   $sgpr10_11 = COPY [[COPY12]](s64)
  ...
  ; GFX908-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ...
  ; GFX908-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX908-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr8_9
  ; GFX908-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX908-NEXT:   [[COPY8:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ...
  ; GFX908-NEXT:   $vgpr0 = COPY [[C]](i32)
  ; GFX908-NEXT:   [[COPY18:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; GFX908-NEXT:   $sgpr0_3 = COPY [[COPY18]](<4 x s32>)
  ; GFX908-NEXT:   $sgpr4_5 = COPY [[COPY9]](p4)
  ; GFX908-NEXT:   $sgpr6_7 = COPY [[COPY10]](p4)
  ; GFX908-NEXT:   $sgpr8_9 = COPY [[COPY11]](p4)
  ; GFX908-NEXT:   $sgpr10_11 = COPY [[COPY12]](s64)
...
define amdgpu_kernel void @test_call_external_void_func_v32i32([17 x i8]) #0 {
  ...
  ; GFX908-NEXT:   $sgpr15 = COPY [[DEF]](s32)
  ; GFX908-NEXT:   $vgpr31 = COPY [[OR1]](i32)
  ; GFX908-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @external_void_func_v32i32, csr_amdgpu, implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3, implicit $vgpr4, implicit $vgpr5, implicit $vgpr6, implicit $vgpr7, implicit $vgpr8, implicit $vgpr9, implicit $vgpr10, implicit $vgpr11, implicit $vgpr12, implicit $vgpr13, implicit $vgpr14, implicit $vgpr15, implicit $vgpr16, implicit $vgpr17, implicit $vgpr18, implicit $vgpr19, implicit $vgpr20, implicit $vgpr21, implicit $vgpr22, implicit $vgpr23, implicit $vgpr24, implicit $vgpr25, implicit $vgpr26, implicit $vgpr27, implicit $vgpr28, implicit $vgpr29, implicit $vgpr30, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
...
define void @test_func_call_external_void_func_v32i32([17 x i8]) #0 {
  ...
  ; GFX900: bb.1 (%ir-block.1):
  ; GFX900-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr0, $vgpr1, $vgpr2, $vgpr3, $vgpr4, $vgpr5, $vgpr6, $vgpr7, $vgpr8, $vgpr9, $vgpr10, $vgpr11, $vgpr12, $vgpr13, $vgpr14, $vgpr15, $vgpr16, $vgpr31, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ; GFX900-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr31
  ; GFX900-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ; GFX900-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr14
  ...
  ; GFX900-NEXT:   $vgpr29 = COPY [[UV29]](i32)
  ; GFX900-NEXT:   $vgpr30 = COPY [[UV30]](i32)
  ; GFX900-NEXT:   [[COPY35:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; GFX900-NEXT:   $sgpr0_3 = COPY [[COPY35]](<4 x s32>)
  ; GFX900-NEXT:   $sgpr4_5 = COPY [[COPY26]](p4)
  ; GFX900-NEXT:   $sgpr6_7 = COPY [[COPY27]](p4)
  ; GFX900-NEXT:   $sgpr8_9 = COPY [[COPY28]](p4)
  ; GFX900-NEXT:   $sgpr10_11 = COPY [[COPY29]](s64)
  ...
  ; GFX908: bb.1 (%ir-block.1):
  ; GFX908-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr0, $vgpr1, $vgpr2, $vgpr3, $vgpr4, $vgpr5, $vgpr6, $vgpr7, $vgpr8, $vgpr9, $vgpr10, $vgpr11, $vgpr12, $vgpr13, $vgpr14, $vgpr15, $vgpr16, $vgpr31, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr31
  ; GFX908-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ; GFX908-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr14
  ...
  ; GFX908-NEXT:   $vgpr29 = COPY [[UV29]](i32)
  ; GFX908-NEXT:   $vgpr30 = COPY [[UV30]](i32)
  ; GFX908-NEXT:   [[COPY35:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; GFX908-NEXT:   $sgpr0_3 = COPY [[COPY35]](<4 x s32>)
  ; GFX908-NEXT:   $sgpr4_5 = COPY [[COPY26]](p4)
  ; GFX908-NEXT:   $sgpr6_7 = COPY [[COPY27]](p4)
  ; GFX908-NEXT:   $sgpr8_9 = COPY [[COPY28]](p4)
  ; GFX908-NEXT:   $sgpr10_11 = COPY [[COPY29]](s64)
...
define amdgpu_kernel void @test_only_workitem_id_x() #0 !reqd_work_group_size !0 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ...
  ; GFX900-NEXT:   [[COPY4:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX900-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX900-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX900-NEXT:   [[COPY7:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ; GFX900-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 42
  ; GFX900-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX900-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ...
  ; GFX900-NEXT:   $sgpr0_3 = COPY [[COPY16]](<4 x s32>)
  ; GFX900-NEXT:   $sgpr4_5 = COPY [[COPY8]](p4)
  ; GFX900-NEXT:   $sgpr6_7 = COPY [[COPY9]](p4)
  ; GFX900-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; GFX900-NEXT:   $sgpr10_11 = COPY [[COPY11]](s64)
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ...
  ; GFX908-NEXT:   [[COPY4:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX908-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX908-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX908-NEXT:   [[COPY7:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ; GFX908-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 42
  ; GFX908-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX908-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ...
  ; GFX908-NEXT:   $sgpr0_3 = COPY [[COPY16]](<4 x s32>)
  ; GFX908-NEXT:   $sgpr4_5 = COPY [[COPY8]](p4)
  ; GFX908-NEXT:   $sgpr6_7 = COPY [[COPY9]](p4)
  ; GFX908-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; GFX908-NEXT:   $sgpr10_11 = COPY [[COPY11]](s64)
...
define amdgpu_kernel void @test_only_workitem_id_y() #0 !reqd_work_group_size !1 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr1, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr1, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
...
define amdgpu_kernel void @test_only_workitem_id_z() #0 !reqd_work_group_size !2 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ; GFX900-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX900-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr16
  ; GFX900-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX908-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr16
  ; GFX908-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr15
...
define amdgpu_kernel void @test_only_workitem_id_xy() #0 !reqd_work_group_size !3 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr1, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ; GFX900-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr1
  ...
  ; GFX900-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX900-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX900-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX900-NEXT:   [[COPY8:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ; GFX900-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 42
  ; GFX900-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX900-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr1, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr1
  ...
  ; GFX908-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; GFX908-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; GFX908-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; GFX908-NEXT:   [[COPY8:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ; GFX908-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 42
  ; GFX908-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; GFX908-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_i32
...
define amdgpu_kernel void @test_only_workitem_id_yz() #0 !reqd_work_group_size !4 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr1, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ; GFX900-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX900-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr1
  ; GFX900-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr16
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr1, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX908-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr1
  ; GFX908-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr16
...
define amdgpu_kernel void @test_only_workitem_id_xz() #0 !reqd_work_group_size !5 {
  ...
  ; GFX900: bb.1 (%ir-block.0):
  ; GFX900-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX900-NEXT: {{  $}}
  ; GFX900-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX900-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr0
  ; GFX900-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr16
  ...
  ; GFX908: bb.1 (%ir-block.0):
  ; GFX908-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; GFX908-NEXT: {{  $}}
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; GFX908-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr0
  ; GFX908-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr16
