...
define amdgpu_ps void @s_fabs_f16_salu_use(half inreg %in, i32 inreg %val) {
...
; GFX12-NEXT:    s_endpgm
  ...
  call void asm sideeffect "; use $0", "s"(half %sel)
  ret void
}
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_and_b32_e64 v0, 0x7fffffff, s0
; GFX11-NEXT:    s_cmp_eq_u32 s1, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    s_cselect_b32 s0, s0, 0
...
; GFX12-NEXT:    s_endpgm
  ...
  call void asm sideeffect "; use $0", "s"(float %sel)
  ret void
}
...
; GCN-NEXT:    s_endpgm
  ...
  call void asm sideeffect "; use $0", "s"(double %sel)
  ret void
}
...
; GCN-NEXT:    s_endpgm
  ...
  call void asm sideeffect "; use $0", "s"(<2 x half> %sel)
  ret void
}
...
define amdgpu_ps void @s_fabs_v2f32_salu_use(<2 x float> inreg %in, i32 inreg %val) {
; GFX11-LABEL: s_fabs_v2f32_salu_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_and_b32_e64 v0, 0x7fffffff, s0
; GFX11-NEXT:    v_and_b32_e64 v1, 0x7fffffff, s1
...
; GFX12-NEXT:    s_endpgm
  ...
  call void asm sideeffect "; use $0", "s"(<2 x float> %sel)
  ret void
}
