...
define amdgpu_ps float @softwqm_f32(float %val) {
  ...
  ; GCN-NEXT:   [[SOFT_WQM:%[0-9]+]]:vgpr_32 = SOFT_WQM [[PRED_COPY]], implicit $exec
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[SOFT_WQM]]
...
define amdgpu_ps <2 x float> @softwqm_f64(double %val) {
  ...
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:vgpr_32 = PRED_COPY [[SOFT_WQM]].sub0
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:vgpr_32 = PRED_COPY [[SOFT_WQM]].sub1
...
define amdgpu_ps <3 x float> @softwqm_v3f32(<3 x float> %val) {
  ...
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:vgpr_32 = PRED_COPY [[SOFT_WQM]].sub0
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:vgpr_32 = PRED_COPY [[SOFT_WQM]].sub1
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:vgpr_32 = PRED_COPY [[SOFT_WQM]].sub2
