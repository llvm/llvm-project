...
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
...
; GFX89-LABEL: test_min_K1max_ValK0__i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89-LABEL: test_min_K1max_K0Val__i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89-LABEL: test_max_min_ValK1_K0_i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89-LABEL: test_max_min_K1Val_K0_i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89-LABEL: test_max_K0min_ValK1__i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89-LABEL: test_max_K0min_K1Val__i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, 17
; GFX89-NEXT:    s_setpc_b64 s[30:31]
...
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_max_i32 s0, s2, -12
; GFX89-NEXT:    s_min_i32 s0, s0, 17
...
; GFX89-LABEL: test_non_inline_constant_i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX89-NEXT:    v_mov_b32_e32 v1, 0x41
; GFX89-NEXT:    v_med3_i32 v0, v0, -12, v1
; GFX89-NEXT:    s_setpc_b64 s[30:31]
;
