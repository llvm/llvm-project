...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11_W32 %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 < %s | FileCheck --check-prefixes=GFX11_W64 %s
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    s_and_b32 s1, 1, s3
; GFX8-NEXT:    v_mov_b32_e32 v0, s2
; GFX8-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s1
...
; GFX10_W32-NEXT:    s_load_dword s7, s[4:5], 0x10
; GFX10_W32-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX10_W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX10_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W32-NEXT:    s_and_b32 s1, 1, s6
; GFX10_W32-NEXT:    v_mov_b32_e32 v0, s7
; GFX10_W32-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s1
; GFX10_W32-NEXT:    s_mov_b32 s1, 0
...
; GFX10_W64-NEXT:    s_load_dword s7, s[4:5], 0x10
; GFX10_W64-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX10_W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX10_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W64-NEXT:    s_and_b32 s1, 1, s6
; GFX10_W64-NEXT:    v_mov_b32_e32 v0, s7
; GFX10_W64-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s1
; GFX10_W64-NEXT:    s_mov_b32 s1, 0
...
; GFX11_W32:       ; %bb.0:
; GFX11_W32-NEXT:    s_clause 0x2
; GFX11_W32-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX11_W32-NEXT:    s_load_b32 s7, s[4:5], 0x10
; GFX11_W32-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11_W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX11_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W32-NEXT:    s_and_b32 s1, 1, s6
; GFX11_W32-NEXT:    v_mov_b32_e32 v0, s7
; GFX11_W32-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s1
; GFX11_W32-NEXT:    s_mov_b32 s1, 0
...
; GFX11_W64:       ; %bb.0:
; GFX11_W64-NEXT:    s_clause 0x2
; GFX11_W64-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX11_W64-NEXT:    s_load_b32 s7, s[4:5], 0x10
; GFX11_W64-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11_W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX11_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W64-NEXT:    s_and_b32 s1, 1, s6
; GFX11_W64-NEXT:    v_mov_b32_e32 v0, s7
; GFX11_W64-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s1
; GFX11_W64-NEXT:    s_mov_b32 s1, 0
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_mov_b32 s9, 0
; GFX7-NEXT:    s_mov_b32 s11, s9
; GFX7-NEXT:    s_mov_b32 s13, s9
; GFX7-NEXT:    s_mov_b32 s15, s9
...
; GFX10_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W32-NEXT:    s_mov_b32 s9, 0
; GFX10_W32-NEXT:    s_mov_b32 s13, s9
; GFX10_W32-NEXT:    s_mov_b32 s15, s9
; GFX10_W32-NEXT:    s_mov_b32 s11, s9
...
; GFX10_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W64-NEXT:    s_mov_b32 s9, 0
; GFX10_W64-NEXT:    s_mov_b32 s13, s9
; GFX10_W64-NEXT:    s_mov_b32 s15, s9
; GFX10_W64-NEXT:    s_mov_b32 s11, s9
...
; GFX11_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W32-NEXT:    s_mov_b32 s1, 0
; GFX11_W32-NEXT:    s_mov_b32 s5, s1
; GFX11_W32-NEXT:    s_mov_b32 s7, s1
; GFX11_W32-NEXT:    s_and_b32 s3, 1, s8
; GFX11_W32-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX11_W32-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s3
; GFX11_W32-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, s7
; GFX11_W32-NEXT:    s_mov_b32 s3, s1
...
; GFX11_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W64-NEXT:    s_mov_b32 s1, 0
; GFX11_W64-NEXT:    s_mov_b32 s5, s1
; GFX11_W64-NEXT:    s_mov_b32 s7, s1
; GFX11_W64-NEXT:    s_and_b32 s3, 1, s8
...
; GFX11_W64-NEXT:    s_mov_b32 s3, s1
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x4
; GFX7-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_mov_b32 s1, 0
...
; GFX10_W32:       ; %bb.0:
; GFX10_W32-NEXT:    s_clause 0x1
; GFX10_W32-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x10
; GFX10_W32-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX10_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W32-NEXT:    s_cmp_eq_u32 s7, 0
; GFX10_W32-NEXT:    v_mov_b32_e32 v0, s3
; GFX10_W32-NEXT:    s_cselect_b32 s1, 1, 0
; GFX10_W32-NEXT:    v_mov_b32_e32 v1, s6
; GFX10_W32-NEXT:    s_and_b32 s1, 1, s1
; GFX10_W32-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s1
; GFX10_W32-NEXT:    s_mov_b32 s1, 0
; GFX10_W32-NEXT:    v_div_fmas_f32 v0, s2, v0, v1
; GFX10_W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX10_W32-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX10_W32-NEXT:    s_endpgm
;
...
; GFX10_W64:       ; %bb.0:
; GFX10_W64-NEXT:    s_clause 0x1
; GFX10_W64-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x10
; GFX10_W64-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX10_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10_W64-NEXT:    s_cmp_eq_u32 s7, 0
; GFX10_W64-NEXT:    v_mov_b32_e32 v0, s3
; GFX10_W64-NEXT:    s_cselect_b32 s1, 1, 0
; GFX10_W64-NEXT:    v_mov_b32_e32 v1, s6
; GFX10_W64-NEXT:    s_and_b32 s1, 1, s1
; GFX10_W64-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s1
; GFX10_W64-NEXT:    s_mov_b32 s1, 0
; GFX10_W64-NEXT:    v_div_fmas_f32 v0, s2, v0, v1
; GFX10_W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX10_W64-NEXT:    global_store_dword v1, v0, s[0:1]
; GFX10_W64-NEXT:    s_endpgm
;
...
; GFX11_W32:       ; %bb.0:
; GFX11_W32-NEXT:    s_clause 0x1
; GFX11_W32-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX11_W32-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11_W32-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W32-NEXT:    s_cmp_eq_u32 s7, 0
; GFX11_W32-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v1, s6
; GFX11_W32-NEXT:    s_cselect_b32 s1, 1, 0
; GFX11_W32-NEXT:    s_and_b32 s1, 1, s1
; GFX11_W32-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s1
; GFX11_W32-NEXT:    s_mov_b32 s1, 0
; GFX11_W32-NEXT:    v_div_fmas_f32 v0, s2, v0, v1
; GFX11_W32-NEXT:    v_mov_b32_e32 v1, 0
; GFX11_W32-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX11_W32-NEXT:    s_endpgm
;
...
; GFX11_W64:       ; %bb.0:
; GFX11_W64-NEXT:    s_clause 0x1
; GFX11_W64-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX11_W64-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11_W64-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11_W64-NEXT:    s_cmp_eq_u32 s7, 0
; GFX11_W64-NEXT:    v_mov_b32_e32 v0, s3
; GFX11_W64-NEXT:    s_cselect_b32 s1, 1, 0
; GFX11_W64-NEXT:    v_mov_b32_e32 v1, s6
; GFX11_W64-NEXT:    s_and_b32 s1, 1, s1
; GFX11_W64-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s1
; GFX11_W64-NEXT:    s_mov_b32 s1, 0
; GFX11_W64-NEXT:    v_div_fmas_f32 v0, s2, v0, v1
; GFX11_W64-NEXT:    v_mov_b32_e32 v1, 0
; GFX11_W64-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX11_W64-NEXT:    s_endpgm
  %cmp = icmp eq i32 %i, 0
