...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, v0, v2, 0 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v3, v0, v2, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -v1, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, v0, 1, v4 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v5, v0, v3, 0 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    v_fma_mix_f32 v3, v0, v2, 0 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, v0, v2, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v6, -v1, v5, v0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v5, v6, v2
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v7, v0, v4, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, v0, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, v0, v4, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v8, -v1, v6, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, v0, 1, v7 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v8, v0, 1, v8 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v9, v0, v5, 0 op_sel_hi:[1,0,0]
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v11, v0, v6, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v5, v0, v3, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v6, v0, v4, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v4, 1.0, v1, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v0, v4, 1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v4, v5, v1
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v6, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v7, -v0, v4, 1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v0, v6, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mul_f32_e32 v1, v7, v1
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v6, v5, v3
; GFX9-FLUSH-NEXT:    v_and_b32_e32 v1, 0xff800000, v1
; GFX9-FLUSH-NEXT:    v_add_f32_e32 v1, v1, v4
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v4, -v0, v6, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
...
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v2, v2
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v3, v3
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, 1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v0, v4, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v0, v5, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, 1.0, 1, v6 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, 1.0, 1, v7 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_rcp_f32_e32 v5, v3
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v7, 1.0, v4, 0 op_sel_hi:[1,0,0]
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v8, 1.0, v5, 0 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    v_rcp_f32_e32 v3, v3
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v4, 1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v6, -v0, v4, 1.0 op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_fma_mix_f32 v7, -v0, v5, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_dual_fmac_f32 v4, v6, v2 :: v_dual_fmac_f32 v5, v7, v3
; GFX11-NEXT:    v_fma_mix_f32 v6, -v0, v4, 1.0 op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_fma_mix_f32 v7, -v0, v5, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_dual_mul_f32 v2, v6, v2 :: v_dual_mul_f32 v3, v7, v3
; GFX11-NEXT:    v_and_b32_e32 v3, 0xff800000, v3
; GFX11-NEXT:    v_dual_add_f32 v3, v3, v5 :: v_dual_and_b32 v2, 0xff800000, v2
...
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v2, v2
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v4, v4
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, 1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v6, -v1, v5, 1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v7, 1.0, v4, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v5, v6, v2
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v6, -|v0|, v7, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v7, v6, v4
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v8, -v1, v5, 1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v0, -|v0|, v7, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mul_f32_e32 v2, v8, v2
...
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v4, v4
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, 1.0, v4, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v8, -|v0|, v6, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, 1.0, 1, v7 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v8, 1.0, 1, v8 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v7, v7, v3
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v8, v8, v4
; GFX10-IEEE-NEXT:    v_add_f32_e32 v5, v7, v5
; GFX10-IEEE-NEXT:    v_add_f32_e32 v6, v8, v6
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v0, -|v0|, v6, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, 1.0, 1, v7 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v0, 1.0, 1, v0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v3, v7, v3
...
; GFX11-NEXT:    v_rcp_f32_e32 v4, v4
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v6, 1.0, v4, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v8, -|v0|, v6, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_fmac_f32_e32 v6, v8, v4
; GFX11-NEXT:    v_fma_mix_f32 v0, -|v0|, v6, 1.0 op_sel:[1,0,0] op_sel_hi:[1,0,1]
...
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v7, -v1, v5, 1.0 op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_fmac_f32_e32 v5, v7, v3
; GFX11-NEXT:    v_fma_mix_f32 v7, -v1, v5, 1.0 op_sel_hi:[1,0,1]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v2, s0, v0, 0 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v1, s0, v0, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v2, -s1, v1, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v2, s0, 1, v2 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v3, s0, v1, 0 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v1, s0, v0, 0 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v1, v1
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, s0, v0, 0 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v4, s3, v1, 0 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v2, s0, v0, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v3, s3, v1, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -s1, v2, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, -s2, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, s0, 1, v4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, s3, 1, v5 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v5, s0, v2, 0 op_sel_hi:[1,0,0]
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v7, s3, v3, 0 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_mix_f32 v2, s0, v0, 0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v3, s3, v1, 0 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v2, v2
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v3, v3
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v4, -1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v0, v4, -1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v6, -1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v4, v5, v2
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v1, v6, -1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v6, v5, v3
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v7, -v0, v4, -1.0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v1, v6, -1.0 op_sel_hi:[1,0,1]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, -1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v0, v4, -1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, -1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fmac_f32_e32 v4, v6, v2
; GFX10-IEEE-NEXT:    v_fmac_f32_e32 v5, v7, v3
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v0, v4, -1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, -1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v2, v6, v2
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v3, v7, v3
...
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v3, v3
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v4, 1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, 1.0, v2, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, 1.0, v3, 0 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v1, v4, 1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v0, v5, 1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fmac_f32_e32 v4, v6, v2
; GFX10-IEEE-NEXT:    v_fmac_f32_e32 v5, v7, v3
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v1, v4, 1.0 op_sel_hi:[1,0,1]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v0, v5, 1.0 op_sel_hi:[1,0,1]
