...
; GFX9-FLUSH-NEXT:    s_mov_b32 s4, 0x8000
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v2, v2
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, v0, v2, s4 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    s_mov_b32 s4, 0x8000
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v2, v2
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v3, v0, v2, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -v1, v3, s4 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s4, 0x8000
; GFX10-FLUSH-NEXT:    v_cvt_f32_f16_e32 v4, v0
; GFX10-FLUSH-NEXT:    v_rcp_f32_e32 v3, v2
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v5, v0, v3, s4 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, v0, v2, s4 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v7, v0, v4, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_and_b32_e32 v2, 0xff800000, v2
; GFX9-FLUSH-NEXT:    v_add_f32_e32 v2, v2, v5
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v1, v7, v0 op_sel:[1,0,1] op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v7, v5, v4
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v1, v7, v0 op_sel:[1,0,1] op_sel_hi:[1,0,1]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, v0, v3, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, v0, v4, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v8, -v1, v6, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v9, v0, v5, s4 op_sel_hi:[1,0,0]
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v11, v0, v6, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-NEXT:    v_fma_mix_f32 v5, v0, v3, s0 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v6, v0, v4, s0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v2, v2
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v3, v3
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -v0, v2, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, -v0, v3, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -v0, v4, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v0, v5, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v3, v3
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v4, v4
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, -v1, v3, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v6, -|v0|, v4, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_add_f32_e32 v5, 1.0, v5
; GFX10-IEEE-NEXT:    v_add_f32_e32 v6, 1.0, v6
; GFX10-IEEE-NEXT:    v_mul_f32_e32 v5, v5, v3
...
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v7, -v1, v5, s4 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v0, -|v0|, v6, s4 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_add_f32_e32 v7, 1.0, v7
...
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v2, s1
; GFX9-FLUSH-NEXT:    s_mov_b32 s1, 0x8000
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v0, v0
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v1, v1, v0, s1 op_sel_hi:[1,0,0]
...
; GFX10-IEEE-NEXT:    s_mov_b32 s2, 0x8000
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v0, v0
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v1, s0, v0, s2 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v2, -s1, v1, s2 op_sel_hi:[1,0,0]
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s2, 0x8000
; GFX10-FLUSH-NEXT:    v_cvt_f32_f16_e32 v2, s0
; GFX10-FLUSH-NEXT:    v_rcp_f32_e32 v1, v0
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v3, s0, v1, s2 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_mov_b32 s2, 0x8000
; GFX11-NEXT:    v_rcp_f32_e32 v0, v0
; GFX11-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-NEXT:    v_fma_mix_f32 v1, s0, v0, s2 op_sel_hi:[1,0,0]
...
; GFX9-FLUSH:       ; %bb.0:
; GFX9-FLUSH-NEXT:    v_cvt_f32_f16_e32 v0, s1
; GFX9-FLUSH-NEXT:    s_mov_b32 s2, 0x8000
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v2, s1
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v0, v0
; GFX9-FLUSH-NEXT:    s_lshr_b32 s4, s1, 16
; GFX9-FLUSH-NEXT:    v_cvt_f32_f16_e32 v4, s4
; GFX9-FLUSH-NEXT:    s_lshr_b32 s3, s0, 16
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v1, v1, v0, s2 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, -v2, v1, s0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v1, v3, v0
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, -v2, v1, s0 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mul_f32_e32 v0, v3, v0
; GFX9-FLUSH-NEXT:    v_and_b32_e32 v0, 0xff800000, v0
; GFX9-FLUSH-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX9-FLUSH-NEXT:    v_rcp_f32_e32 v1, v4
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v3, s3
; GFX9-FLUSH-NEXT:    v_mov_b32_e32 v4, s4
; GFX9-FLUSH-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v3, v3, v1, s2 op_sel_hi:[1,0,0]
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v4, v3, s3 op_sel_hi:[1,0,1]
; GFX9-FLUSH-NEXT:    v_mac_f32_e32 v3, v5, v1
; GFX9-FLUSH-NEXT:    v_mad_mix_f32 v5, -v4, v3, s3 op_sel_hi:[1,0,1]
...
; GFX9-FLUSH-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX9-FLUSH-NEXT:    v_div_fixup_f16 v0, v0, v2, s0
; GFX9-FLUSH-NEXT:    v_div_fixup_f16 v1, v1, v4, s3
; GFX9-FLUSH-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX9-FLUSH-NEXT:    v_readfirstlane_b32 s0, v0
; GFX9-FLUSH-NEXT:    ; return to shader part epilog
;
...
; GFX10-IEEE-NEXT:    s_mov_b32 s3, 0x8000
; GFX10-IEEE-NEXT:    s_lshr_b32 s4, s0, 16
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v0, v0
; GFX10-IEEE-NEXT:    v_rcp_f32_e32 v1, v1
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v2, s0, v0, s3 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v3, s4, v1, s3 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, -s1, v2, s3 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, -s2, v3, s3 op_sel_hi:[1,0,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v4, s0, 1.0, v4 op_sel_hi:[1,1,0]
; GFX10-IEEE-NEXT:    v_fma_mix_f32 v5, s4, 1.0, v5 op_sel_hi:[1,1,0]
...
; GFX10-IEEE-NEXT:    v_div_fixup_f16 v0, v0, s1, s0
; GFX10-IEEE-NEXT:    v_div_fixup_f16 v1, v1, s2, s4
; GFX10-IEEE-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX10-IEEE-NEXT:    v_readfirstlane_b32 s0, v0
; GFX10-IEEE-NEXT:    ; return to shader part epilog
;
...
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v5, s0, v2, s4 op_sel_hi:[1,0,0]
; GFX10-FLUSH-NEXT:    v_fma_mix_f32 v7, s3, v3, s4 op_sel_hi:[1,0,0]
...
; GFX11-NEXT:    s_mov_b32 s3, 0x8000
; GFX11-NEXT:    s_lshr_b32 s4, s0, 16
; GFX11-NEXT:    v_rcp_f32_e32 v0, v0
; GFX11-NEXT:    v_rcp_f32_e32 v1, v1
; GFX11-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-NEXT:    v_fma_mix_f32 v2, s0, v0, s3 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v3, s4, v1, s3 op_sel_hi:[1,0,0]
; GFX11-NEXT:    v_fma_mix_f32 v4, -s1, v2, s0 op_sel_hi:[1,0,1]
; GFX11-NEXT:    v_fma_mix_f32 v5, -s2, v3, s4 op_sel_hi:[1,0,1]
...
; GFX11-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX11-NEXT:    v_div_fixup_f16 v1, v1, s2, s4
; GFX11-NEXT:    v_div_fixup_f16 v0, v0, s1, s0
; GFX11-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    ; return to shader part epilog
