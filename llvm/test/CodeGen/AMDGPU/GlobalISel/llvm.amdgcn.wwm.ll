...
define amdgpu_ps float @wwm_f32(float %val) {
  ...
  ; GCN-NEXT:   [[STRICT_WWM:%[0-9]+]]:vgpr_32 = STRICT_WWM [[PRED_COPY]], implicit $exec
  ; GCN-NEXT:   $vgpr0 = PRED_COPY [[STRICT_WWM]]
...
define amdgpu_ps <2 x float> @wwm_f64(double %val) {
  ...
  ; GCN-NEXT:   [[PRED_COPY2:%[0-9]+]]:vgpr_32 = PRED_COPY [[STRICT_WWM]].sub0
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:vgpr_32 = PRED_COPY [[STRICT_WWM]].sub1
...
define amdgpu_ps <3 x float> @wwm_v3f32(<3 x float> %val) {
  ...
  ; GCN-NEXT:   [[PRED_COPY3:%[0-9]+]]:vgpr_32 = PRED_COPY [[STRICT_WWM]].sub0
  ; GCN-NEXT:   [[PRED_COPY4:%[0-9]+]]:vgpr_32 = PRED_COPY [[STRICT_WWM]].sub1
  ; GCN-NEXT:   [[PRED_COPY5:%[0-9]+]]:vgpr_32 = PRED_COPY [[STRICT_WWM]].sub2
