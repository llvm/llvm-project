...
; RUN: llc -global-isel -mtriple=amdgpu6.00-amd-amdhsa < %s | FileCheck --check-prefixes=GCN,GFX678 %s
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck --check-prefixes=GCN,GFX9 %s
; RUN: llc -global-isel -mtriple=amdgpu10.10 < %s | FileCheck --check-prefixes=GCN,GFX10 %s
