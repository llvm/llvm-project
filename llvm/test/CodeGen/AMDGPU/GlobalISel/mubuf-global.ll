...
; RUN: llc -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX6 %s
; RUN: llc -global-isel -mtriple=amdgpu7.01-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX7 %s
; RUN: llc -global-isel -mtriple=amdgpu12.00-mesa-mesa3d -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GFX12 %s
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v1, 0
; GFX12-NEXT:    global_load_b32 v0, v1, s[2:3] offset:16380 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v1, 0
; GFX12-NEXT:    global_load_b32 v0, v1, s[2:3] offset:16384 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_co_u32 v2, vcc_lo, v0, 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, 4, v1, vcc_lo
; GFX12-NEXT:    global_load_b32 v0, v[2:3], off scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr float, ptr addrspace(1) %ptr, i64 4294967296
  %val = load volatile float, ptr addrspace(1) %gep
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_co_u32 v2, vcc_lo, v0, 4
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, null, 4, v1, vcc_lo
; GFX12-NEXT:    global_load_b32 v0, v[2:3], off scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    s_add_co_u32 s0, s2, s0
; GFX12-NEXT:    s_add_co_ci_u32 s1, s3, s1
; GFX12-NEXT:    global_load_b32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX12-NEXT:    global_load_b32 v0, v[4:5], off scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr float, ptr addrspace(1) %ptr, i32 %soffset
  %val = load volatile float, ptr addrspace(1) %gep
...
; GFX12-NEXT:    v_add_co_u32 v4, vcc_lo, v0, v2
; GFX12-NEXT:    v_add_co_ci_u32_e64 v5, null, v1, v3, vcc_lo
; GFX12-NEXT:    global_load_b32 v0, v[4:5], off offset:1024 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX6-NEXT:    s_mov_b32 s2, 0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    buffer_load_dword v0, v[2:3], s[0:3], 0 addr64 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    ; return to shader part epilog
;
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 2, v[0:1]
; GFX12-NEXT:    v_add_co_u32 v4, vcc_lo, v2, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v5, null, v3, v1, vcc_lo
; GFX12-NEXT:    global_load_b32 v0, v[4:5], off scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_movk_i32 s4, 0x3ffc
; GFX6-NEXT:    buffer_load_dword v0, v[2:3], s[0:3], s4 addr64 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    ; return to shader part epilog
;
...
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    s_movk_i32 s4, 0x3ffc
; GFX7-NEXT:    buffer_load_dword v0, v[2:3], s[0:3], s4 addr64 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    ; return to shader part epilog
;
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v5, null, v3, v1, vcc_lo
; GFX12-NEXT:    global_load_b32 v0, v[4:5], off offset:16380 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_dual_mov_b32 v2, 2 :: v_dual_mov_b32 v1, 0
; GFX12-NEXT:    global_atomic_add_u32 v0, v1, v2, s[2:3] offset:16380 th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_co_u32 v4, vcc_lo, v0, 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v5, null, 4, v1, vcc_lo
; GFX12-NEXT:    v_mov_b32_e32 v2, 2
; GFX12-NEXT:    global_atomic_add_u32 v0, v[4:5], v2, off th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr i32, ptr addrspace(1) %ptr, i64 4294967296
...
; GFX12-NEXT:    global_atomic_cmpswap_b32 v0, v3, v[1:2], s[2:3] offset:16380 th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr i32, ptr addrspace(1) %ptr, i64 4095
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_co_u32 v6, vcc_lo, v0, 0
; GFX12-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-NEXT:    v_add_co_ci_u32_e64 v7, null, 4, v1, vcc_lo
; GFX12-NEXT:    global_atomic_cmpswap_b32 v0, v[6:7], v[3:4], off th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr i32, ptr addrspace(1) %ptr, i64 4294967296
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 2, v[0:1]
; GFX12-NEXT:    v_add_co_u32 v6, vcc_lo, v4, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v7, null, v5, v1, vcc_lo
; GFX12-NEXT:    global_atomic_cmpswap_b32 v0, v[6:7], v[2:3], off th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    ; return to shader part epilog
  %gep = getelementptr i32, ptr addrspace(1) %ptr, i32 %voffset
