...
; CHECK-NEXT:    v_mul_hi_u32 v7, v1, v2
; CHECK-NEXT:    v_mul_lo_u32 v2, v1, v2
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v6
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v5, v4, vcc
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, 0, v7, vcc
...
; CHECK-NEXT:    v_mul_hi_u32 v3, s0, v0
; CHECK-NEXT:    v_mul_hi_u32 v4, s0, v1
; CHECK-NEXT:    v_mul_hi_u32 v5, s1, v1
; CHECK-NEXT:    v_mul_lo_u32 v1, s1, v1
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, 0, v4, vcc
; CHECK-NEXT:    v_mul_lo_u32 v4, s1, v0
; CHECK-NEXT:    v_mul_hi_u32 v0, s1, v0
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v4
; CHECK-NEXT:    v_addc_u32_e32 v0, vcc, v3, v0, vcc
; CHECK-NEXT:    v_addc_u32_e32 v2, vcc, 0, v5, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CHECK-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
; CHECK-NEXT:    v_mul_lo_u32 v1, s2, v1
; CHECK-NEXT:    v_mul_hi_u32 v2, s2, v0
; CHECK-NEXT:    v_mul_lo_u32 v3, s3, v0
; CHECK-NEXT:    v_mov_b32_e32 v4, s3
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v2
; CHECK-NEXT:    v_mul_lo_u32 v2, s2, v0
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; CHECK-NEXT:    v_sub_i32_e32 v3, vcc, s1, v1
; CHECK-NEXT:    v_sub_i32_e32 v2, vcc, s0, v2
; CHECK-NEXT:    v_subb_u32_e64 v3, s[4:5], v3, v4, vcc
; CHECK-NEXT:    v_subrev_i32_e64 v4, s[4:5], s2, v2
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], s3, v3
; CHECK-NEXT:    v_cndmask_b32_e64 v3, v5, v4, s[4:5]
; CHECK-NEXT:    v_add_i32_e64 v4, s[4:5], 1, v0
; CHECK-NEXT:    v_add_i32_e64 v5, s[4:5], 2, v0
...
; CHECK-NEXT:    v_cmp_le_u32_e32 vcc, s2, v2
...
; CHECK-NEXT:    s_and_b64 s[4:5], s[6:7], exec
...
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v8, v9
...
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v12
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v1, v10
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v11
; GISEL-NEXT:    v_subb_u32_e64 v11, s[4:5], v12, v5, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v11, v13, v12, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], 2, v9
; GISEL-NEXT:    v_addc_u32_e64 v13, s[4:5], 0, v8, s[4:5]
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v1, v10, vcc
; GISEL-NEXT:    v_rcp_f32_e32 v10, v16
; GISEL-NEXT:    v_add_i32_e64 v14, s[4:5], 1, v9
; GISEL-NEXT:    v_addc_u32_e64 v15, s[4:5], 0, v8, s[4:5]
; GISEL-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v11
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v11, v14, v12, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; GISEL-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v10
...
; GISEL-NEXT:    v_mul_hi_u32 v17, v14, v4
; GISEL-NEXT:    v_mul_lo_u32 v18, v14, v10
; GISEL-NEXT:    v_subb_u32_e32 v16, vcc, 0, v7, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GISEL-NEXT:    v_mul_lo_u32 v1, v16, v4
; GISEL-NEXT:    v_add_i32_e64 v5, s[6:7], v17, v18
; GISEL-NEXT:    v_mul_lo_u32 v17, v14, v4
; GISEL-NEXT:    v_add_i32_e64 v1, s[6:7], v5, v1
; GISEL-NEXT:    v_mul_lo_u32 v5, v4, v1
; GISEL-NEXT:    v_mul_hi_u32 v18, v4, v17
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v12, v0, vcc
; GISEL-NEXT:    v_mul_hi_u32 v12, v4, v1
; GISEL-NEXT:    v_mul_hi_u32 v19, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v18, v5
; GISEL-NEXT:    v_mul_lo_u32 v18, v10, v17
; GISEL-NEXT:    v_mul_hi_u32 v17, v10, v17
; GISEL-NEXT:    v_addc_u32_e32 v12, vcc, 0, v12, vcc
; GISEL-NEXT:    v_mul_lo_u32 v1, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v18
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v12, v17, vcc
...
; GISEL-NEXT:    v_addc_u32_e32 v4, vcc, v10, v5, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v9, v11, vcc
; GISEL-NEXT:    v_mul_lo_u32 v9, v14, v4
; GISEL-NEXT:    v_mul_hi_u32 v10, v14, v1
; GISEL-NEXT:    v_mul_lo_u32 v12, v16, v1
; GISEL-NEXT:    v_mul_lo_u32 v5, v14, v1
; GISEL-NEXT:    v_add_i32_e64 v9, s[6:7], v10, v9
; GISEL-NEXT:    v_add_i32_e64 v9, s[6:7], v9, v12
; GISEL-NEXT:    v_mul_lo_u32 v10, v1, v9
; GISEL-NEXT:    v_mul_hi_u32 v12, v1, v5
; GISEL-NEXT:    v_mul_hi_u32 v14, v1, v9
; GISEL-NEXT:    v_mul_hi_u32 v11, v4, v5
; GISEL-NEXT:    v_mul_lo_u32 v5, v4, v5
; GISEL-NEXT:    v_add_i32_e64 v10, s[6:7], v12, v10
; GISEL-NEXT:    v_addc_u32_e64 v12, s[6:7], 0, v14, s[6:7]
; GISEL-NEXT:    v_mul_hi_u32 v14, v4, v9
; GISEL-NEXT:    v_mul_lo_u32 v9, v4, v9
; GISEL-NEXT:    v_add_i32_e64 v5, s[6:7], v10, v5
; GISEL-NEXT:    v_addc_u32_e64 v5, s[6:7], v12, v11, s[6:7]
; GISEL-NEXT:    v_addc_u32_e64 v10, s[6:7], 0, v14, s[6:7]
; GISEL-NEXT:    v_add_i32_e64 v5, s[6:7], v5, v9
; GISEL-NEXT:    v_addc_u32_e64 v9, s[6:7], 0, v10, s[6:7]
; GISEL-NEXT:    v_add_i32_e64 v1, s[6:7], v1, v5
; GISEL-NEXT:    v_addc_u32_e64 v4, s[6:7], v4, v9, s[6:7]
; GISEL-NEXT:    v_mul_lo_u32 v5, v2, v4
; GISEL-NEXT:    v_mul_hi_u32 v9, v2, v1
; GISEL-NEXT:    v_mul_hi_u32 v11, v2, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v15, v13, s[4:5]
; GISEL-NEXT:    v_mul_hi_u32 v12, v3, v4
; GISEL-NEXT:    v_add_i32_e64 v5, s[4:5], v9, v5
; GISEL-NEXT:    v_addc_u32_e64 v9, s[4:5], 0, v11, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v11, v3, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v3, v1
; GISEL-NEXT:    v_mul_lo_u32 v4, v3, v4
; GISEL-NEXT:    v_add_i32_e64 v5, s[4:5], v5, v11
; GISEL-NEXT:    v_addc_u32_e64 v1, s[4:5], v9, v1, s[4:5]
; GISEL-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v12, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v4, s[4:5], v1, v4
; GISEL-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v5, s[4:5]
...
; GISEL-NEXT:    v_sub_i32_e32 v10, vcc, v3, v8
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v2, v9
; GISEL-NEXT:    v_subb_u32_e64 v9, s[4:5], v10, v7, vcc
; GISEL-NEXT:    v_sub_i32_e64 v10, s[4:5], v2, v6
; GISEL-NEXT:    v_subbrev_u32_e64 v9, s[4:5], 0, v9, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, v11, v10, s[4:5]
...
; GISEL-NEXT:    v_addc_u32_e64 v13, s[4:5], 0, v5, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, v12, v10, s[4:5]
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v13, v11, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v4, v9, vcc
...
; CHECK-NEXT:    v_mul_hi_u32 v7, v4, v2
...
; CHECK-NEXT:    v_sub_i32_e32 v8, vcc, v1, v6
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v0, v7
; CHECK-NEXT:    v_subb_u32_e64 v7, s[4:5], v8, v5, vcc
; CHECK-NEXT:    v_sub_i32_e64 v8, s[4:5], v0, v4
; CHECK-NEXT:    v_subbrev_u32_e64 v7, s[4:5], 0, v7, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v8, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v7, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v7, v9, v8, s[4:5]
; CHECK-NEXT:    v_add_i32_e64 v8, s[4:5], 2, v2
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v1, v6, vcc
; CHECK-NEXT:    v_addc_u32_e64 v9, s[4:5], 0, v3, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; CHECK-NEXT:    v_add_i32_e64 v10, s[4:5], 1, v2
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; CHECK-NEXT:    v_addc_u32_e64 v11, s[4:5], 0, v3, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, 12, v4
; GISEL-NEXT:    v_lshr_b64 v[0:1], v[0:1], v4
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, 12, v6
; GISEL-NEXT:    v_lshr_b64 v[2:3], v[2:3], v4
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; CGP-NEXT:    v_mul_lo_u32 v4, v11, v1
; CGP-NEXT:    v_mul_hi_u32 v6, v11, v0
; CGP-NEXT:    v_mul_lo_u32 v8, v12, v0
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CGP-NEXT:    v_mul_lo_u32 v6, v11, v0
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v5, v4
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v7, v6
; CGP-NEXT:    v_subb_u32_e64 v7, s[4:5], v8, v12, vcc
; CGP-NEXT:    v_sub_i32_e64 v8, s[4:5], v6, v11
; CGP-NEXT:    v_subbrev_u32_e64 v7, s[4:5], 0, v7, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v12
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v8, v11
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v7, v12
; CGP-NEXT:    v_cndmask_b32_e64 v7, v13, v8, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v8, s[4:5], 2, v0
; CGP-NEXT:    v_subb_u32_e32 v4, vcc, v5, v4, vcc
; CGP-NEXT:    v_addc_u32_e64 v13, s[4:5], 0, v1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v12
; CGP-NEXT:    v_add_i32_e64 v14, s[4:5], 1, v0
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v6, v11
; CGP-NEXT:    v_addc_u32_e64 v15, s[4:5], 0, v1, s[4:5]
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v4, v12
; CGP-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v7
; CGP-NEXT:    v_cndmask_b32_e32 v4, v5, v6, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v7, v15, v13, s[4:5]
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CGP-NEXT:    v_cndmask_b32_e64 v4, v14, v8, s[4:5]
...
; CGP-NEXT:    v_mul_hi_u32 v7, v9, v4
...
; CGP-NEXT:    v_subb_u32_e64 v7, s[4:5], v8, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v8, s[4:5], v2, v9
; CGP-NEXT:    v_subbrev_u32_e64 v7, s[4:5], 0, v7, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v10
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v8, v9
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v7, v10
; CGP-NEXT:    v_cndmask_b32_e64 v7, v11, v8, s[4:5]
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, v13, v11, s[4:5]
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; CGP-NEXT:    v_cndmask_b32_e64 v2, v12, v8, s[4:5]
