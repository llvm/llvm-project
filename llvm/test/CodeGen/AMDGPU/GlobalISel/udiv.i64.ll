...
; GISEL-NEXT:    v_mul_hi_u32 v13, v3, v6
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
...
; GISEL-NEXT:    v_mul_lo_u32 v18, v1, v5
; GISEL-NEXT:    v_add_i32_e64 v19, s[4:5], 1, v7
; GISEL-NEXT:    v_addc_u32_e64 v20, s[4:5], 0, v5, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v21, s[4:5], 1, v19
; GISEL-NEXT:    v_add_i32_e64 v8, s[6:7], v12, v8
; GISEL-NEXT:    v_addc_u32_e32 v12, vcc, 0, v16, vcc
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v8, v13
; GISEL-NEXT:    v_addc_u32_e64 v13, vcc, 0, v20, s[4:5]
...
; GISEL-NEXT:    v_subb_u32_e64 v11, s[6:7], 0, v14, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v2, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[6:7]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v9
; GISEL-NEXT:    v_sub_i32_e64 v8, s[8:9], 0, v8
; GISEL-NEXT:    v_sub_i32_e64 v9, s[8:9], 0, v14
; GISEL-NEXT:    v_cndmask_b32_e64 v14, -1, v18, s[6:7]
...
; GISEL-NEXT:    v_subbrev_u32_e32 v3, vcc, 0, v9, vcc
...
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v10, v17, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, v19, v21, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v16, v12, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v6, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v20, v13, s[4:5]
