...
define i32 @asm_vgpr_early_clobber() {
  ...
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %7
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY %8
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %7
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s64) = PRED_COPY %8
...
define float @test_input_vgpr(i32 %src) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"v_add_f32 $0, 1.0, $1", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %8, 1769481 /* reguse:VGPR_32 */, [[PRED_COPY1]]
  ; CHECK-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY %8
...
define i32 @test_memory_constraint(ptr addrspace(3) %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"ds_read_b32 $0, $1", 8 /* mayload attdialect */, 1769482 /* regdef:VGPR_32 */, def %8, 262158 /* mem:m */, [[PRED_COPY]](p3)
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(s32) = PRED_COPY %8
...
define i32 @test_vgpr_matching_constraint(i32 %a) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &";", 1 /* sideeffect attdialect */, 1769482 /* regdef:VGPR_32 */, def %10, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY1]](tied-def 3)
...
define i32 @test_sgpr_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_add_u32 $0, $1, $2", 0 /* attdialect */, 1900554 /* regdef:SReg_32 */, def %11, 1900553 /* reguse:SReg_32 */, [[PRED_COPY2]], 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY3]](tied-def 3)
  ; CHECK-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY %11
...
define void @test_many_matching_constraints(i32 %a, i32 %b, i32 %c) nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"; ", 1 /* sideeffect attdialect */, 1769482 /* regdef:VGPR_32 */, def %10, 1769482 /* regdef:VGPR_32 */, def %11, 1769482 /* regdef:VGPR_32 */, def %12, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY3]](tied-def 3), 2147614729 /* reguse tiedto:$2 */, [[PRED_COPY4]](tied-def 7), 2147549193 /* reguse tiedto:$1 */, [[PRED_COPY5]](tied-def 5)
  ; CHECK-NEXT:   [[PRED_COPY6:%[0-9]+]]:_(s32) = PRED_COPY %10
  ; CHECK-NEXT:   [[PRED_COPY7:%[0-9]+]]:_(s32) = PRED_COPY %11
  ; CHECK-NEXT:   [[PRED_COPY8:%[0-9]+]]:_(s32) = PRED_COPY %12
...
define i32 @test_sgpr_to_vgpr_move_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY %7
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:vgpr_32 = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, $1", 0 /* attdialect */, 1769482 /* regdef:VGPR_32 */, def %9, 2147483657 /* reguse tiedto:$0 */, [[PRED_COPY1]](tied-def 3)
