...
define i32 @asm_vgpr_early_clobber() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 7; v_mov_b32 $1, 7", 1 /* sideeffect attdialect */, 2031627 /* regdef-ec:VGPR_32 */, def early-clobber %8, 2031627 /* regdef-ec:VGPR_32 */, def early-clobber %9, !0
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_add_f64 $1, 0, 0", 0 /* attdialect */, 2031626 /* regdef:VGPR_32 */, def %8, 3473418 /* regdef:VReg_64 */, def %9
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %8
