...
define i32 @test_single_sgpr_output_s32() nounwind {
  ...
  ; CHECK: bb.1.entry:
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 2949130 /* regdef:SReg_32 */, def %7
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %7
  ; CHECK-NEXT:   $vgpr0 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   SI_RETURN implicit $vgpr0
entry:
...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   INLINEASM &"v_mov_b32 $0, 0; v_add_f64 $1, 0, 0", 0 /* attdialect */, 2228234 /* regdef:VGPR_32 */, def %7, 4259850 /* regdef:VReg_64 */, def %8
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %7
...
define amdgpu_kernel void @test_input_sgpr_imm() {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 s0, $0", 1 /* sideeffect attdialect */, 2949129 /* reguse:SReg_32 */, [[COPY1]]
  ; CHECK-NEXT:   S_ENDPGM 0
...
define i32 @test_sgpr_matching_constraint() nounwind {
  ...
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 7", 0 /* attdialect */, 2949130 /* regdef:SReg_32 */, def %7
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(s32) = COPY %7
  ; CHECK-NEXT:   INLINEASM &"s_mov_b32 $0, 8", 0 /* attdialect */, 2949130 /* regdef:SReg_32 */, def %9
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(s32) = COPY %9
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sreg_32 = COPY [[COPY]](s32)
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:sreg_32 = COPY [[COPY1]](s32)
  ; CHECK-NEXT:   INLINEASM &"s_add_u32 $0, $1, $2", 0 /* attdialect */, 2949130 /* regdef:SReg_32 */, def %11, 2949129 /* reguse:SReg_32 */, [[COPY2]], 2147483657 /* reguse tiedto:$0 */, [[COPY3]](tied-def 3)
