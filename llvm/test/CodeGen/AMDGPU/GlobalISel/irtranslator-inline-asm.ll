...
define double @test_multiple_register_outputs_mixed() #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST:%[0-9]+]]:_(i64) = G_BITCAST [[COPY1]](f64)
...
define void @test_many_matching_constraints(i32 %a, i32 %b, i32 %c) nounwind {
  ...
  ; CHECK-NEXT:   G_STORE [[COPY6]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[COPY7]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[COPY8]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) undef`, addrspace 1)
