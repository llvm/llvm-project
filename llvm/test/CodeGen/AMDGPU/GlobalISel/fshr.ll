...
; GFX11-NEXT:    s_and_b32 s14, s15, s8
...
; GFX11-NEXT:    v_mul_hi_u32 v1, s13, v1
...
; GFX11-NEXT:    s_and_b32 s3, s11, s8
...
; GFX11-NEXT:    v_and_b32_e32 v1, s4, v1
; GFX11-NEXT:    s_or_b32 s0, s6, s0
; GFX11-NEXT:    s_bfe_u32 s1, s1, 0x100000
; GFX11-NEXT:    v_and_b32_e32 v2, s4, v2
; GFX11-NEXT:    v_subrev_nc_u32_e32 v3, 24, v0
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, 24, v0
; GFX11-NEXT:    v_lshrrev_b32_e64 v1, v1, s5
...
; GFX11-NEXT:    v_and_b32_e32 v4, s8, v0
; GFX11-NEXT:    v_and_or_b32 v1, v1, s8, v2
...
; GFX6-NEXT:    v_lshrrev_b32_e32 v2, 1, v2
; GFX6-NEXT:    s_bfe_u32 s5, 3, 0x100000
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX9-NEXT:    v_mul_lo_u32 v4, -16, v2
; GFX9-NEXT:    v_mul_lo_u32 v5, -16, v3
...
; GFX10-NEXT:    s_mov_b32 s4, 0x4f7ffffe
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; GFX10-NEXT:    v_mul_f32_e32 v2, s4, v2
; GFX10-NEXT:    v_mul_f32_e32 v3, s4, v3
; GFX10-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX10-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX10-NEXT:    v_mul_lo_u32 v4, -16, v2
; GFX10-NEXT:    v_mul_lo_u32 v5, -16, v3
...
; GFX11-NEXT:    s_mov_b32 s0, 0x4f7ffffe
; GFX11-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; GFX11-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; GFX11-NEXT:    v_mul_f32_e32 v2, s0, v2
; GFX11-NEXT:    v_mul_f32_e32 v3, s0, v3
; GFX11-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX11-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX11-NEXT:    v_mul_lo_u32 v4, -16, v2
; GFX11-NEXT:    v_mul_lo_u32 v5, -16, v3
...
; GFX11-NEXT:    v_and_b32_e32 v18, s0, v9
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], 1, v[0:1]
; GFX11-NEXT:    v_or_b32_e32 v2, v10, v2
; GFX11-NEXT:    v_sub_nc_u32_e32 v16, 64, v19
; GFX11-NEXT:    v_sub_nc_u32_e32 v10, 64, v18
; GFX11-NEXT:    v_subrev_nc_u32_e32 v21, 64, v18
; GFX11-NEXT:    v_subrev_nc_u32_e32 v20, 64, v19
...
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], v21, v[0:1]
...
; GFX11-NEXT:    v_lshrrev_b64 v[8:9], v20, v[6:7]
...
; GFX11-NEXT:    s_or_b64 s[6:7], s[18:19], s[6:7]
...
; GFX11-NEXT:    v_lshlrev_b64 v[2:3], 1, v[2:3]
; GFX11-NEXT:    v_and_b32_e32 v26, s1, v16
; GFX11-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX11-NEXT:    v_and_b32_e32 v25, s1, v17
...
; GFX11-NEXT:    v_and_b32_e32 v25, s1, v16
...
; GFX11-NEXT:    v_and_b32_e32 v23, s1, v20
; GFX11-NEXT:    v_cndmask_b32_e64 v2, 0, v2, s0
