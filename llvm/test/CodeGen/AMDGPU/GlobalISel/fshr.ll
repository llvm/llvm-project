...
; GFX6-NEXT:    v_readfirstlane_b32 s3, v0
; GFX6-NEXT:    s_mul_i32 s3, s3, -7
; GFX6-NEXT:    s_add_i32 s2, s2, s3
; GFX6-NEXT:    s_cmp_ge_u32 s2, 7
; GFX6-NEXT:    s_cselect_b32 s3, 1, 0
; GFX6-NEXT:    s_add_i32 s4, s2, -7
...
; GFX6-NEXT:    s_mul_i32 s5, s4, -7
; GFX6-NEXT:    v_mul_hi_u32 v3, v3, s5
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0xff, v1
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, 4, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v1, 4, v1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %result = call i8 @llvm.fshr.i8(i8 %lhs, i8 %rhs, i8 4)
  ret i8 %result
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v1, 0xff, v1
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, 3, v0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v1, 5, v1
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %result = call i8 @llvm.fshr.i8(i8 %lhs, i8 %rhs, i8 5)
  ret i8 %result
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_readfirstlane_b32 s3, v0
; GFX9-NEXT:    s_mul_i32 s4, s3, 0xffffffe8
; GFX9-NEXT:    s_mul_hi_u32 s4, s3, s4
; GFX9-NEXT:    s_add_i32 s3, s3, s4
; GFX9-NEXT:    s_mul_hi_u32 s3, s2, s3
; GFX9-NEXT:    s_mulk_i32 s3, 0xffe8
; GFX9-NEXT:    s_add_i32 s2, s2, s3
; GFX9-NEXT:    s_cmp_ge_u32 s2, 24
; GFX9-NEXT:    s_cselect_b32 s3, 1, 0
; GFX9-NEXT:    s_sub_i32 s4, s2, 24
; GFX9-NEXT:    s_cmp_lg_u32 s3, 0
; GFX9-NEXT:    s_cselect_b32 s2, s4, s2
; GFX9-NEXT:    s_cmp_ge_u32 s2, 24
; GFX9-NEXT:    s_cselect_b32 s3, 1, 0
...
; GFX10-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX10-NEXT:    v_readfirstlane_b32 s3, v0
; GFX10-NEXT:    s_mul_i32 s4, s3, 0xffffffe8
; GFX10-NEXT:    s_mul_hi_u32 s4, s3, s4
; GFX10-NEXT:    s_add_i32 s3, s3, s4
; GFX10-NEXT:    s_mul_hi_u32 s3, s2, s3
; GFX10-NEXT:    s_mulk_i32 s3, 0xffe8
; GFX10-NEXT:    s_add_i32 s2, s2, s3
; GFX10-NEXT:    s_cmp_ge_u32 s2, 24
; GFX10-NEXT:    s_cselect_b32 s3, 1, 0
; GFX10-NEXT:    s_sub_i32 s4, s2, 24
; GFX10-NEXT:    s_cmp_lg_u32 s3, 0
; GFX10-NEXT:    s_cselect_b32 s2, s4, s2
; GFX10-NEXT:    s_cmp_ge_u32 s2, 24
; GFX10-NEXT:    s_cselect_b32 s3, 1, 0
...
; GFX6-NEXT:    s_mul_i32 s5, s4, 0xffffffe8
; GFX6-NEXT:    v_mul_hi_u32 v6, v6, s5
; GFX6-NEXT:    v_and_b32_e32 v3, 0xffffff, v3
; GFX6-NEXT:    v_readfirstlane_b32 s5, v6
; GFX6-NEXT:    s_add_i32 s4, s4, s5
; GFX6-NEXT:    v_mul_hi_u32 v6, v4, s4
; GFX6-NEXT:    v_mul_hi_u32 v8, v5, s4
; GFX6-NEXT:    v_mul_lo_u32 v6, v6, v7
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; GFX6-NEXT:    v_add_i32_e32 v6, vcc, v4, v7
...
; GFX8-NEXT:    v_mul_hi_u32 v8, v5, s4
; GFX8-NEXT:    v_mul_lo_u32 v6, v6, v7
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v4, v6
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v4, v7
...
; GFX10-NEXT:    v_add_nc_u32_e32 v7, 0xffffffe8, v4
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, 24, v4
; GFX10-NEXT:    v_add_nc_u32_e32 v6, 0xffffffe8, v5
...
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v3, 15, v3
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v1, v2, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, v3, v0
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, 12, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v1, 4, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v0, 11, v0
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v1, 5, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-FAKE16-NEXT:    v_lshrrev_b16 v0, s2, v0
; GFX11-FAKE16-NEXT:    s_lshl_b32 s0, s0, 1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_lshl_b32 s0, s0, s1
...
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; GFX6-NEXT:    v_bfi_b32 v23, v16, 0, v19
...
; GFX6-NEXT:    v_not_b32_e32 v24, 63
; GFX6-NEXT:    v_or_b32_e32 v21, v17, v21
; GFX6-NEXT:    v_add_i32_e32 v17, vcc, v23, v24
; GFX6-NEXT:    v_or_b32_e32 v22, v18, v22
; GFX6-NEXT:    v_lshl_b64 v[17:18], v[0:1], v17
; GFX6-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v23
; GFX6-NEXT:    v_cndmask_b32_e32 v17, v17, v21, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v18, v18, v22, vcc
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v23
; GFX6-NEXT:    v_and_b32_e32 v22, 0x7f, v16
; GFX6-NEXT:    v_cndmask_b32_e64 v21, v17, v2, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v18, v18, v3, s[4:5]
; GFX6-NEXT:    v_sub_i32_e64 v2, s[4:5], 64, v22
; GFX6-NEXT:    v_lshl_b64 v[2:3], v[10:11], v2
; GFX6-NEXT:    v_lshr_b64 v[16:17], v[8:9], v22
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[0:1], v23
; GFX6-NEXT:    v_or_b32_e32 v16, v16, v2
; GFX6-NEXT:    v_add_i32_e64 v2, s[4:5], v22, v24
; GFX6-NEXT:    v_or_b32_e32 v17, v17, v3
; GFX6-NEXT:    v_lshr_b64 v[2:3], v[10:11], v2
; GFX6-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v22
; GFX6-NEXT:    v_cndmask_b32_e64 v16, v2, v16, s[4:5]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v22
; GFX6-NEXT:    v_cndmask_b32_e64 v8, v16, v8, s[6:7]
; GFX6-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX6-NEXT:    v_lshl_b64 v[6:7], v[6:7], 1
; GFX6-NEXT:    v_cndmask_b32_e64 v17, v3, v17, s[4:5]
; GFX6-NEXT:    v_or_b32_e32 v0, v0, v8
; GFX6-NEXT:    v_lshrrev_b32_e32 v8, 31, v5
; GFX6-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GFX6-NEXT:    v_bfi_b32 v16, v20, 0, v19
; GFX6-NEXT:    v_cndmask_b32_e64 v9, v17, v9, s[6:7]
; GFX6-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX6-NEXT:    v_or_b32_e32 v6, v6, v8
; GFX6-NEXT:    v_sub_i32_e32 v8, vcc, 64, v16
; GFX6-NEXT:    v_lshr_b64 v[2:3], v[10:11], v22
...
; GFX6-NEXT:    v_add_i32_e32 v8, vcc, v16, v24
...
; GFX6-NEXT:    v_cndmask_b32_e32 v17, v9, v11, vcc
; GFX6-NEXT:    v_lshl_b64 v[4:5], v[4:5], v16
; GFX6-NEXT:    v_cndmask_b32_e64 v16, v8, v6, s[4:5]
; GFX6-NEXT:    v_sub_i32_e64 v6, s[6:7], 64, v18
; GFX6-NEXT:    v_lshl_b64 v[8:9], v[14:15], v6
; GFX6-NEXT:    v_lshr_b64 v[10:11], v[12:13], v18
; GFX6-NEXT:    v_cndmask_b32_e64 v17, v17, v7, s[4:5]
; GFX6-NEXT:    v_add_i32_e64 v6, s[4:5], v18, v24
; GFX6-NEXT:    v_lshr_b64 v[6:7], v[14:15], v6
; GFX6-NEXT:    v_or_b32_e32 v8, v10, v8
; GFX6-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v18
; GFX6-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[4:5]
; GFX6-NEXT:    v_lshr_b64 v[14:15], v[14:15], v18
; GFX6-NEXT:    v_or_b32_e32 v8, v11, v9
; GFX6-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v7, v7, v8, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v18
; GFX6-NEXT:    v_cndmask_b32_e32 v6, v6, v12, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v7, v7, v13, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v8, 0, v14, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v9, 0, v15, s[4:5]
; GFX6-NEXT:    v_or_b32_e32 v2, v21, v2
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX6-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX6-NEXT:    v_or_b32_e32 v6, v16, v8
; GFX6-NEXT:    v_or_b32_e32 v7, v17, v9
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_lshlrev_b64 v[0:1], 1, v[0:1]
; GFX8-NEXT:    v_bfi_b32 v23, v16, 0, v19
...
; GFX8-NEXT:    v_not_b32_e32 v24, 63
; GFX8-NEXT:    v_or_b32_e32 v21, v17, v21
; GFX8-NEXT:    v_add_u32_e32 v17, vcc, v23, v24
; GFX8-NEXT:    v_or_b32_e32 v22, v18, v22
; GFX8-NEXT:    v_lshlrev_b64 v[17:18], v17, v[0:1]
; GFX8-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v23
; GFX8-NEXT:    v_cndmask_b32_e32 v17, v17, v21, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v18, v18, v22, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v23
; GFX8-NEXT:    v_and_b32_e32 v22, 0x7f, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v21, v17, v2, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v18, v18, v3, s[4:5]
; GFX8-NEXT:    v_sub_u32_e64 v2, s[4:5], 64, v22
; GFX8-NEXT:    v_lshlrev_b64 v[2:3], v2, v[10:11]
; GFX8-NEXT:    v_lshrrev_b64 v[16:17], v22, v[8:9]
; GFX8-NEXT:    v_lshlrev_b64 v[0:1], v23, v[0:1]
; GFX8-NEXT:    v_or_b32_e32 v16, v16, v2
; GFX8-NEXT:    v_add_u32_e64 v2, s[4:5], v22, v24
; GFX8-NEXT:    v_or_b32_e32 v17, v17, v3
; GFX8-NEXT:    v_lshrrev_b64 v[2:3], v2, v[10:11]
; GFX8-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v22
; GFX8-NEXT:    v_cndmask_b32_e64 v16, v2, v16, s[4:5]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v22
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v16, v8, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX8-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v17, v3, v17, s[4:5]
; GFX8-NEXT:    v_or_b32_e32 v0, v0, v8
; GFX8-NEXT:    v_lshrrev_b32_e32 v8, 31, v5
; GFX8-NEXT:    v_lshlrev_b64 v[4:5], 1, v[4:5]
; GFX8-NEXT:    v_bfi_b32 v16, v20, 0, v19
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v17, v9, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX8-NEXT:    v_or_b32_e32 v6, v6, v8
; GFX8-NEXT:    v_sub_u32_e32 v8, vcc, 64, v16
; GFX8-NEXT:    v_lshrrev_b64 v[2:3], v22, v[10:11]
...
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v16, v24
...
; GFX8-NEXT:    v_cndmask_b32_e32 v17, v9, v11, vcc
; GFX8-NEXT:    v_lshlrev_b64 v[4:5], v16, v[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v16, v8, v6, s[4:5]
; GFX8-NEXT:    v_sub_u32_e64 v6, s[6:7], 64, v18
; GFX8-NEXT:    v_lshlrev_b64 v[8:9], v6, v[14:15]
; GFX8-NEXT:    v_lshrrev_b64 v[10:11], v18, v[12:13]
; GFX8-NEXT:    v_cndmask_b32_e64 v17, v17, v7, s[4:5]
; GFX8-NEXT:    v_add_u32_e64 v6, s[4:5], v18, v24
; GFX8-NEXT:    v_lshrrev_b64 v[6:7], v6, v[14:15]
; GFX8-NEXT:    v_or_b32_e32 v8, v10, v8
; GFX8-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v18
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[4:5]
; GFX8-NEXT:    v_lshrrev_b64 v[14:15], v18, v[14:15]
; GFX8-NEXT:    v_or_b32_e32 v8, v11, v9
; GFX8-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v8, s[4:5]
...
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, v14, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, v15, s[4:5]
; GFX8-NEXT:    v_or_b32_e32 v2, v21, v2
; GFX8-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX8-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX8-NEXT:    v_or_b32_e32 v6, v16, v8
; GFX8-NEXT:    v_or_b32_e32 v7, v17, v9
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_add_u32_e32 v17, 0xffffffc0, v23
; GFX9-NEXT:    v_or_b32_e32 v22, v18, v22
; GFX9-NEXT:    v_lshlrev_b64 v[17:18], v17, v[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v23
; GFX9-NEXT:    v_cndmask_b32_e32 v17, v17, v21, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v18, v18, v22, vcc
; GFX9-NEXT:    v_and_b32_e32 v22, 0x7f, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v21, v17, v2, s[4:5]
; GFX9-NEXT:    v_sub_u32_e32 v2, 64, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v18, v18, v3, s[4:5]
; GFX9-NEXT:    v_lshlrev_b64 v[2:3], v2, v[10:11]
; GFX9-NEXT:    v_lshrrev_b64 v[16:17], v22, v[8:9]
; GFX9-NEXT:    v_lshlrev_b64 v[0:1], v23, v[0:1]
; GFX9-NEXT:    v_or_b32_e32 v16, v16, v2
; GFX9-NEXT:    v_add_u32_e32 v2, 0xffffffc0, v22
; GFX9-NEXT:    v_or_b32_e32 v17, v17, v3
; GFX9-NEXT:    v_lshrrev_b64 v[2:3], v2, v[10:11]
; GFX9-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v2, v16, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v22
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v16, v8, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v17, v3, v17, s[4:5]
; GFX9-NEXT:    v_or_b32_e32 v0, v0, v8
; GFX9-NEXT:    v_lshrrev_b32_e32 v8, 31, v5
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], 1, v[4:5]
; GFX9-NEXT:    v_bfi_b32 v16, v20, 0, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v17, v9, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX9-NEXT:    v_or_b32_e32 v6, v6, v8
; GFX9-NEXT:    v_sub_u32_e32 v8, 64, v16
; GFX9-NEXT:    v_lshrrev_b64 v[2:3], v22, v[10:11]
...
; GFX9-NEXT:    v_add_u32_e32 v8, 0xffffffc0, v16
...
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v8, v6, s[4:5]
; GFX9-NEXT:    v_sub_u32_e32 v6, 64, v18
; GFX9-NEXT:    v_cndmask_b32_e32 v17, v9, v11, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], v6, v[14:15]
; GFX9-NEXT:    v_lshrrev_b64 v[10:11], v18, v[12:13]
; GFX9-NEXT:    v_add_u32_e32 v6, 0xffffffc0, v18
; GFX9-NEXT:    v_cndmask_b32_e64 v17, v17, v7, s[4:5]
; GFX9-NEXT:    v_lshrrev_b64 v[6:7], v6, v[14:15]
; GFX9-NEXT:    v_or_b32_e32 v8, v10, v8
; GFX9-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v18
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v8, s[4:5]
; GFX9-NEXT:    v_lshrrev_b64 v[14:15], v18, v[14:15]
; GFX9-NEXT:    v_or_b32_e32 v8, v11, v9
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v18
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v8, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v6, v12, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v7, v13, s[6:7]
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX9-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, v14, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, v15, s[4:5]
; GFX9-NEXT:    v_or_b32_e32 v2, v21, v2
; GFX9-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX9-NEXT:    v_or_b32_e32 v6, v16, v6
; GFX9-NEXT:    v_or_b32_e32 v7, v17, v8
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
