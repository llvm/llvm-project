...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -o - %s | FileCheck -check-prefixes=GFX11 %s
...
; GFX11-NEXT:    v_dual_mov_b32 v4, 0xffffff :: v_dual_add_nc_u32 v1, v1, v2
