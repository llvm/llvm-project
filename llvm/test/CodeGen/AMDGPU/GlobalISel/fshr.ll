...
; GFX11-NEXT:    v_lshlrev_b16 v0, v4, v0
...
; GFX11-NEXT:    v_lshrrev_b16 v6, v8, v6
...
; GFX11-NEXT:    v_lshlrev_b16 v4, 1, v4
; GFX11-NEXT:    v_lshlrev_b16 v3, v13, v3
...
; GFX11-NEXT:    v_lshrrev_b16 v6, v11, v7
; GFX11-NEXT:    v_and_b32_e32 v2, 7, v2
; GFX11-NEXT:    v_and_b32_e32 v1, s0, v1
; GFX11-NEXT:    v_and_b32_e32 v10, 7, v10
; GFX11-NEXT:    v_lshlrev_b16 v0, 1, v0
; GFX11-NEXT:    v_lshlrev_b16 v4, v13, v4
; GFX11-NEXT:    v_lshlrev_b16 v5, v8, v5
; GFX11-NEXT:    v_lshrrev_b16 v7, v12, v9
; GFX11-NEXT:    v_lshrrev_b16 v1, v2, v1
...
; GFX6-NEXT:    v_cmp_le_u32_e32 vcc, 24, v0
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX6-NEXT:    v_mul_lo_u32 v2, s11, v1
...
; GFX10-NEXT:    v_mul_lo_u32 v3, s13, v1
; GFX10-NEXT:    s_and_b32 s13, s14, s10
; GFX10-NEXT:    s_and_b32 s1, s1, s10
...
; GFX10-NEXT:    s_and_b32 s8, s8, s10
; GFX10-NEXT:    s_and_b32 s0, s0, s10
; GFX10-NEXT:    s_lshl_b32 s6, s6, s11
; GFX10-NEXT:    v_add_nc_u32_e32 v1, v1, v2
; GFX10-NEXT:    s_or_b32 s0, s0, s6
; GFX10-NEXT:    s_and_b32 s6, s7, s10
; GFX10-NEXT:    s_and_b32 s7, s9, s10
; GFX10-NEXT:    v_mul_lo_u32 v0, v0, 24
...
; GFX10-NEXT:    s_and_b32 s8, s9, s10
...
; GFX10-NEXT:    v_and_b32_e32 v3, s10, v1
; GFX10-NEXT:    v_bfe_u32 v4, v1, 8, 8
; GFX10-NEXT:    v_bfe_u32 v1, v1, 16, 8
; GFX10-NEXT:    v_and_or_b32 v2, v0, s10, v2
...
; GFX11-NEXT:    s_sub_i32 s12, 0, 24
; GFX11-NEXT:    s_movk_i32 s9, 0xff
...
; GFX11-NEXT:    s_and_b32 s14, s14, s9
; GFX11-NEXT:    s_and_b32 s16, s4, s9
; GFX11-NEXT:    s_lshl_b32 s14, s14, s10
; GFX11-NEXT:    s_and_b32 s15, s15, s9
; GFX11-NEXT:    s_or_b32 s14, s16, s14
...
; GFX11-NEXT:    s_and_b32 s1, s1, s9
; GFX11-NEXT:    s_and_b32 s6, s6, s9
; GFX11-NEXT:    s_lshr_b32 s8, s0, 24
; GFX11-NEXT:    v_mul_lo_u32 v2, s12, v0
; GFX11-NEXT:    v_mul_lo_u32 v3, s12, v1
; GFX11-NEXT:    s_bfe_u32 s12, s15, 0x100000
; GFX11-NEXT:    s_lshr_b32 s15, s5, 8
; GFX11-NEXT:    s_lshl_b32 s12, s12, 16
; GFX11-NEXT:    s_and_b32 s5, s5, s9
; GFX11-NEXT:    s_or_b32 s12, s14, s12
; GFX11-NEXT:    s_lshl_b32 s5, s5, s10
; GFX11-NEXT:    v_mul_hi_u32 v2, v0, v2
; GFX11-NEXT:    s_and_b32 s14, s15, s9
; GFX11-NEXT:    s_or_b32 s4, s4, s5
; GFX11-NEXT:    s_bfe_u32 s5, s14, 0x100000
; GFX11-NEXT:    s_bfe_u32 s4, s4, 0x100000
...
; GFX11-NEXT:    v_mul_hi_u32 v0, s12, v0
; GFX11-NEXT:    s_and_b32 s0, s0, s9
; GFX11-NEXT:    s_lshl_b32 s6, s6, s10
; GFX11-NEXT:    s_and_b32 s8, s8, s9
; GFX11-NEXT:    v_add_nc_u32_e32 v1, v1, v2
; GFX11-NEXT:    s_or_b32 s0, s0, s6
; GFX11-NEXT:    s_and_b32 s6, s7, s9
; GFX11-NEXT:    s_and_b32 s7, s11, s9
; GFX11-NEXT:    v_mul_lo_u32 v0, v0, 24
; GFX11-NEXT:    v_mul_hi_u32 v1, s4, v1
; GFX11-NEXT:    s_lshr_b32 s11, s2, 16
; GFX11-NEXT:    s_and_b32 s13, s2, s9
; GFX11-NEXT:    s_lshl_b32 s5, s8, s10
; GFX11-NEXT:    s_and_b32 s8, s11, s9
; GFX11-NEXT:    s_lshr_b32 s11, s3, 8
; GFX11-NEXT:    s_and_b32 s3, s3, s9
; GFX11-NEXT:    v_sub_nc_u32_e32 v0, s12, v0
...
; GFX11-NEXT:    s_mov_b32 s4, 0xffffff
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v2, 24, v0
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, 24, v0
; GFX11-NEXT:    s_and_b32 s3, s11, s9
; GFX11-NEXT:    s_or_b32 s5, s5, s8
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v3, 24, v1
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, 24, v1
; GFX11-NEXT:    v_lshrrev_b32_e64 v0, v0, s5
...
; GFX11-NEXT:    v_and_b32_e32 v4, s9, v1
; GFX11-NEXT:    v_and_or_b32 v0, v0, s9, v2
