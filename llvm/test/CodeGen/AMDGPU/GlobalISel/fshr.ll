...
; GFX6-NEXT:    v_and_b32_e32 v25, 0x7f, v0
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, 64, v25
; GFX6-NEXT:    v_lshr_b64 v[0:1], v[18:19], v0
; GFX6-NEXT:    v_lshl_b64 v[21:22], v[2:3], v25
...
; GFX6-NEXT:    v_lshr_b64 v[0:1], v[8:9], v16
; GFX6-NEXT:    v_add_i32_e32 v26, vcc, v25, v17
; GFX6-NEXT:    v_or_b32_e32 v23, v0, v23
; GFX6-NEXT:    v_or_b32_e32 v24, v1, v24
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[18:19], v26
; GFX6-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v25
; GFX6-NEXT:    v_lshl_b64 v[18:19], v[18:19], v25
; GFX6-NEXT:    v_cndmask_b32_e32 v21, v0, v21, vcc
; GFX6-NEXT:    v_add_i32_e64 v0, s[4:5], v16, v17
; GFX6-NEXT:    v_cndmask_b32_e32 v22, v1, v22, vcc
; GFX6-NEXT:    v_lshr_b64 v[0:1], v[10:11], v0
; GFX6-NEXT:    v_cndmask_b32_e32 v18, 0, v18, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v19, 0, v19, vcc
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v25
; GFX6-NEXT:    v_lshr_b64 v[10:11], v[10:11], v16
; GFX6-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v16
; GFX6-NEXT:    v_cndmask_b32_e32 v2, v21, v2, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v0, v0, v23, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v22, v3, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v1, v24, s[4:5]
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v1, v1, v9, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v8, 0, v10, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v9, 0, v11, s[4:5]
; GFX6-NEXT:    v_lshl_b64 v[6:7], v[6:7], 1
; GFX6-NEXT:    v_or_b32_e32 v2, v2, v8
; GFX6-NEXT:    v_or_b32_e32 v3, v3, v9
...
; GFX6-NEXT:    v_lshl_b64 v[18:19], v[8:9], v16
...
; GFX6-NEXT:    v_cndmask_b32_e32 v4, 0, v18, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v5, 0, v19, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v8, v8, v10, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v9, v9, v11, vcc
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX6-NEXT:    v_and_b32_e32 v19, 0x7f, v20
; GFX6-NEXT:    v_cndmask_b32_e32 v16, v8, v6, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v18, v9, v7, vcc
; GFX6-NEXT:    v_sub_i32_e32 v8, vcc, 64, v19
; GFX6-NEXT:    v_lshr_b64 v[6:7], v[12:13], v19
; GFX6-NEXT:    v_lshl_b64 v[8:9], v[14:15], v8
; GFX6-NEXT:    v_add_i32_e32 v17, vcc, v19, v17
; GFX6-NEXT:    v_or_b32_e32 v8, v6, v8
; GFX6-NEXT:    v_or_b32_e32 v9, v7, v9
; GFX6-NEXT:    v_lshr_b64 v[6:7], v[14:15], v17
; GFX6-NEXT:    v_lshr_b64 v[10:11], v[14:15], v19
...
; GFX6-NEXT:    v_cndmask_b32_e32 v8, 0, v10, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v9, 0, v11, vcc
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX6-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX6-NEXT:    v_or_b32_e32 v6, v16, v8
; GFX6-NEXT:    v_or_b32_e32 v7, v18, v9
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_and_b32_e32 v25, 0x7f, v0
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, 64, v25
; GFX8-NEXT:    v_lshrrev_b64 v[0:1], v0, v[18:19]
; GFX8-NEXT:    v_lshlrev_b64 v[21:22], v25, v[2:3]
...
; GFX8-NEXT:    v_lshrrev_b64 v[0:1], v16, v[8:9]
; GFX8-NEXT:    v_add_u32_e32 v26, vcc, v25, v17
; GFX8-NEXT:    v_or_b32_e32 v23, v0, v23
; GFX8-NEXT:    v_or_b32_e32 v24, v1, v24
; GFX8-NEXT:    v_lshlrev_b64 v[0:1], v26, v[18:19]
; GFX8-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v25
; GFX8-NEXT:    v_lshlrev_b64 v[18:19], v25, v[18:19]
; GFX8-NEXT:    v_cndmask_b32_e32 v21, v0, v21, vcc
; GFX8-NEXT:    v_add_u32_e64 v0, s[4:5], v16, v17
; GFX8-NEXT:    v_cndmask_b32_e32 v22, v1, v22, vcc
; GFX8-NEXT:    v_lshrrev_b64 v[0:1], v0, v[10:11]
; GFX8-NEXT:    v_cndmask_b32_e32 v18, 0, v18, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v19, 0, v19, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v25
; GFX8-NEXT:    v_lshrrev_b64 v[10:11], v16, v[10:11]
; GFX8-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v16
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v21, v2, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v0, v23, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v22, v3, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v24, s[4:5]
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v1, v9, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, v10, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, v11, s[4:5]
...
; GFX8-NEXT:    v_lshlrev_b64 v[18:19], v16, v[8:9]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v4, 0, v18, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v5, 0, v19, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v8, v8, v10, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v9, v9, v11, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX8-NEXT:    v_and_b32_e32 v19, 0x7f, v20
; GFX8-NEXT:    v_cndmask_b32_e32 v16, v8, v6, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v18, v9, v7, vcc
; GFX8-NEXT:    v_sub_u32_e32 v8, vcc, 64, v19
; GFX8-NEXT:    v_lshrrev_b64 v[6:7], v19, v[12:13]
; GFX8-NEXT:    v_lshlrev_b64 v[8:9], v8, v[14:15]
; GFX8-NEXT:    v_add_u32_e32 v17, vcc, v19, v17
; GFX8-NEXT:    v_or_b32_e32 v8, v6, v8
; GFX8-NEXT:    v_or_b32_e32 v9, v7, v9
; GFX8-NEXT:    v_lshrrev_b64 v[6:7], v17, v[14:15]
; GFX8-NEXT:    v_lshrrev_b64 v[10:11], v19, v[14:15]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v8, 0, v10, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v9, 0, v11, vcc
; GFX8-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX8-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX8-NEXT:    v_or_b32_e32 v6, v16, v8
; GFX8-NEXT:    v_or_b32_e32 v7, v18, v9
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_and_b32_e32 v25, 0x7f, v0
; GFX9-NEXT:    v_sub_u32_e32 v19, 64, v25
; GFX9-NEXT:    v_lshlrev_b64 v[0:1], v25, v[17:18]
; GFX9-NEXT:    v_lshrrev_b64 v[21:22], v19, v[17:18]
; GFX9-NEXT:    v_lshlrev_b64 v[23:24], v25, v[2:3]
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v25
; GFX9-NEXT:    v_add_u32_e32 v19, 0xffffffc0, v25
; GFX9-NEXT:    v_or_b32_e32 v21, v21, v23
; GFX9-NEXT:    v_cndmask_b32_e32 v23, 0, v0, vcc
; GFX9-NEXT:    v_or_b32_e32 v0, v22, v24
; GFX9-NEXT:    v_and_b32_e32 v22, 0x7f, v16
; GFX9-NEXT:    v_lshlrev_b64 v[16:17], v19, v[17:18]
; GFX9-NEXT:    v_sub_u32_e32 v24, 64, v22
; GFX9-NEXT:    v_cndmask_b32_e32 v21, v16, v21, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[18:19], v22, v[8:9]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v17, v0, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[16:17], v24, v[10:11]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v25
; GFX9-NEXT:    v_cndmask_b32_e64 v21, v21, v2, s[4:5]
; GFX9-NEXT:    v_add_u32_e32 v2, 0xffffffc0, v22
; GFX9-NEXT:    v_or_b32_e32 v16, v18, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v18, v0, v3, s[4:5]
; GFX9-NEXT:    v_lshrrev_b64 v[2:3], v2, v[10:11]
; GFX9-NEXT:    v_cndmask_b32_e32 v24, 0, v1, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[0:1], v22, v[10:11]
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v22
; GFX9-NEXT:    v_or_b32_e32 v10, v19, v17
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v16, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v9, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, 0, v0, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v9, 0, v1, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX9-NEXT:    v_or_b32_e32 v0, v23, v2
; GFX9-NEXT:    v_or_b32_e32 v1, v24, v3
; GFX9-NEXT:    v_or_b32_e32 v2, v21, v8
; GFX9-NEXT:    v_or_b32_e32 v3, v18, v9
...
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], v19, v[8:9]
...
; GFX9-NEXT:    v_cndmask_b32_e32 v5, 0, v17, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e32 v16, v8, v6, vcc
; GFX9-NEXT:    v_sub_u32_e32 v8, 64, v18
; GFX9-NEXT:    v_cndmask_b32_e32 v17, v9, v7, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[6:7], v18, v[12:13]
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], v8, v[14:15]
; GFX9-NEXT:    v_add_u32_e32 v19, 0xffffffc0, v18
; GFX9-NEXT:    v_or_b32_e32 v8, v6, v8
; GFX9-NEXT:    v_or_b32_e32 v9, v7, v9
; GFX9-NEXT:    v_lshrrev_b64 v[6:7], v19, v[14:15]
; GFX9-NEXT:    v_lshrrev_b64 v[10:11], v18, v[14:15]
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v18
...
; GFX9-NEXT:    v_cndmask_b32_e32 v8, 0, v10, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v9, 0, v11, vcc
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v6
; GFX9-NEXT:    v_or_b32_e32 v5, v5, v7
; GFX9-NEXT:    v_or_b32_e32 v6, v16, v8
; GFX9-NEXT:    v_or_b32_e32 v7, v17, v9
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
