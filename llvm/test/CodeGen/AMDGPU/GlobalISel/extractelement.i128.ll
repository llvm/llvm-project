...
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v4, v14, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v5, v15, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e64 v12, v8, v10, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v9, v11, s[4:5]
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_cndmask_b32_e32 v10, v12, v4, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v13, v5, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e32 v18, v10, v6, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v19, v11, v7, vcc
...
; GFX7-NEXT:    buffer_load_dwordx4 v[8:11], v[0:1], s[8:11], 0 addr64
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], v[0:1], s[8:11], 0 addr64 offset:16
; GFX7-NEXT:    v_lshlrev_b32_e32 v2, 1, v2
; GFX7-NEXT:    v_add_i32_e32 v3, vcc, 1, v2
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v3
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v2
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_cndmask_b32_e64 v12, v8, v10, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v13, v9, v11, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e32 v8, v8, v10, vcc
; GFX7-NEXT:    v_cndmask_b32_e32 v9, v9, v11, vcc
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 2, v2
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_cndmask_b32_e32 v10, v12, v4, vcc
; GFX7-NEXT:    v_cndmask_b32_e32 v11, v13, v5, vcc
...
; GFX7-NEXT:    v_cndmask_b32_e32 v16, v10, v6, vcc
; GFX7-NEXT:    v_cndmask_b32_e32 v17, v11, v7, vcc
...
; GFX7-NEXT:    v_cndmask_b32_e32 v5, v5, v11, vcc
...
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v4, v14, vcc
; GFX7-NEXT:    v_cndmask_b32_e32 v3, v5, v15, vcc
