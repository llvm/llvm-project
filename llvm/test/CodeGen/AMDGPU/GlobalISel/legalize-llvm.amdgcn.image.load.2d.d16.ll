...
define amdgpu_ps <3 x half> @image_load_v3f16_dmask_0000(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; UNPACKED-NEXT:   [[BITCAST:%[0-9]+]]:_(f16) = G_BITCAST %35(i16)
  ; UNPACKED-NEXT:   [[DEF1:%[0-9]+]]:_(f16) = G_IMPLICIT_DEF
  ; UNPACKED-NEXT:   [[BITCAST1:%[0-9]+]]:_(<2 x i16>) = G_BITCAST [[UV1]](<2 x f16>)
  ; UNPACKED-NEXT:   [[BITCAST2:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST1]](<2 x i16>)
  ; UNPACKED-NEXT:   [[TRUNC:%[0-9]+]]:_(i16) = G_TRUNC [[BITCAST2]](i32)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 16
  ; UNPACKED-NEXT:   [[BITCAST3:%[0-9]+]]:_(i16) = G_BITCAST [[BITCAST]](f16)
  ; UNPACKED-NEXT:   [[BITCAST4:%[0-9]+]]:_(i16) = G_BITCAST [[DEF1]](f16)
  ; UNPACKED-NEXT:   [[ZEXT:%[0-9]+]]:_(i32) = G_ZEXT [[BITCAST3]](i16)
  ; UNPACKED-NEXT:   [[ZEXT1:%[0-9]+]]:_(i32) = G_ZEXT [[BITCAST4]](i16)
  ; UNPACKED-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[ZEXT1]], [[C]](i32)
  ; UNPACKED-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[ZEXT]], [[SHL]]
  ...
  ; UNPACKED-NEXT:   $vgpr1 = COPY [[BITCAST5]](<2 x f16>)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1
  ;
  ...
  ; PACKED-NEXT:   [[BITCAST:%[0-9]+]]:_(f16) = G_BITCAST %35(i16)
  ; PACKED-NEXT:   [[DEF1:%[0-9]+]]:_(f16) = G_IMPLICIT_DEF
  ; PACKED-NEXT:   [[BITCAST1:%[0-9]+]]:_(<2 x i16>) = G_BITCAST [[UV1]](<2 x f16>)
  ; PACKED-NEXT:   [[BITCAST2:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST1]](<2 x i16>)
  ; PACKED-NEXT:   [[TRUNC:%[0-9]+]]:_(i16) = G_TRUNC [[BITCAST2]](i32)
  ; PACKED-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 16
  ; PACKED-NEXT:   [[BITCAST3:%[0-9]+]]:_(i16) = G_BITCAST [[BITCAST]](f16)
  ; PACKED-NEXT:   [[BITCAST4:%[0-9]+]]:_(i16) = G_BITCAST [[DEF1]](f16)
  ; PACKED-NEXT:   [[ZEXT:%[0-9]+]]:_(i32) = G_ZEXT [[BITCAST3]](i16)
  ; PACKED-NEXT:   [[ZEXT1:%[0-9]+]]:_(i32) = G_ZEXT [[BITCAST4]](i16)
  ; PACKED-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[ZEXT1]], [[C]](i32)
  ; PACKED-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[ZEXT]], [[SHL]]
  ; PACKED-NEXT:   [[BITCAST5:%[0-9]+]]:_(<2 x f16>) = G_BITCAST [[OR]](i32)
  ; PACKED-NEXT:   $vgpr0 = COPY [[UV]](<2 x f16>)
  ; PACKED-NEXT:   $vgpr1 = COPY [[BITCAST5]](<2 x f16>)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0, implicit $vgpr1
...
define amdgpu_ps <4 x half> @image_load_v4f16_dmask_1100(<8 x i32> inreg %rsrc, i32 %s, i32 %t) {
  ...
  ; PACKED-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x f16>) = G_BITCAST [[AMDGPU_INTRIN_IMAGE_LOAD_D16_]](<2 x i16>)
  ; PACKED-NEXT:   [[BITCAST1:%[0-9]+]]:_(<2 x f16>) = G_BITCAST [[DEF]](<2 x i16>)
  ; PACKED-NEXT:   $vgpr0 = COPY [[BITCAST]](<2 x f16>)
