...
; RUN: llc -global-isel -mtriple=amdgpu7.04-mesa-mesa3d < %s | FileCheck -check-prefix=GFX78 %s
; RUN: llc -global-isel -mtriple=amdgpu8.03-mesa-mesa3d < %s | FileCheck -check-prefix=GFX78 %s
