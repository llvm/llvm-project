...
define amdgpu_ps void @raw_buffer_load_f16_tfe(<4 x i32> inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
  ...
  ; GFX11-TRUE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:vgpr(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX11-FAKE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:_(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[C]](i32), [[C]], [[C]], 0, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX12-TRUE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:vgpr(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX12-FAKE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:_(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[C]](i32), [[C]], [[C]], 0, 0, -1 :: (dereferenceable load (f16), align 1, addrspace 8)
