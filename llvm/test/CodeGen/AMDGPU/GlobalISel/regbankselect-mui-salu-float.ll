...
; OLD_RBS_GFX12-NEXT:    s_nop 0
; OLD_RBS_GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; NEW_RBS_GFX12-NEXT:    s_nop 0
; NEW_RBS_GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
