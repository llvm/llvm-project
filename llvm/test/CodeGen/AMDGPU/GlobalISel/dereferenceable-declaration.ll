...
define i64 @load_deref_declaration_only() {
  ...
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @declared_with_ret_deref, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
...
define i64 @load_deref_unknown_decl() {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @unknown_decl, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; CHECK-NEXT:   [[MV:%[0-9]+]]:_(p0) = G_MERGE_VALUES [[COPY1]](i32), [[COPY2]](i32)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define i64 @load_deref_maxmimum_callsite_declaration_only() {
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY3]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV1]](p0), @declared_with_ret_deref4, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
...
define i64 @load_deref_or_null_declaration_only() {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @declared_with_ret_deref_or_null, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; CHECK-NEXT:   [[MV:%[0-9]+]]:_(p0) = G_MERGE_VALUES [[COPY1]](i32), [[COPY2]](i32)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define i64 @load_deref_or_null_nonnull_decl() {
  ...
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @nonnull_decl, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; CHECK-NEXT:   [[MV:%[0-9]+]]:_(p0) = G_MERGE_VALUES [[COPY1]](i32), [[COPY2]](i32)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define i64 @load_deref_or_null_maxmimum_callsite_declaration_only() {
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY3]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV1]](p0), @declared_with_ret_deref_or_null4, csr_amdgpu, implicit $sgpr0_3, implicit-def $vgpr0, implicit-def $vgpr1
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; CHECK-NEXT:   [[MV1:%[0-9]+]]:_(p0) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
