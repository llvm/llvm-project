...
; GFX1210-NEXT:    s_cbranch_execz .LBB36_2
; GFX1210-NEXT:  ; %bb.1:
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB37_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB38_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB51_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB52_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB53_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bcnt1_i32_b32 s0, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
