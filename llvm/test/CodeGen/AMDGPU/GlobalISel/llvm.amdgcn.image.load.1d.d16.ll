...
; GFX8-PACKED:       ; %bb.0:
; GFX8-PACKED-NEXT:    s_mov_b32 s11, s9
; GFX8-PACKED-NEXT:    s_mov_b32 s10, s8
; GFX8-PACKED-NEXT:    s_mov_b32 s9, s7
; GFX8-PACKED-NEXT:    s_mov_b32 s8, s6
; GFX8-PACKED-NEXT:    s_mov_b32 s7, s5
; GFX8-PACKED-NEXT:    s_mov_b32 s6, s4
; GFX8-PACKED-NEXT:    s_mov_b32 s5, s3
; GFX8-PACKED-NEXT:    s_mov_b32 s4, s2
; GFX8-PACKED-NEXT:    image_load v[0:1], v0, s[4:11] dmask:0x7 unorm d16
; GFX8-PACKED-NEXT:    s_waitcnt vmcnt(0)
; GFX8-PACKED-NEXT:    ; return to shader part epilog
;
