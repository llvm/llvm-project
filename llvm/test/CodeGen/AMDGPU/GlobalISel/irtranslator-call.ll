...
define amdgpu_kernel void @test_call_external_void_func_void() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY3:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr16
  ; CHECK-NEXT:   [[PRED_COPY4:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr15
  ; CHECK-NEXT:   [[PRED_COPY5:%[0-9]+]]:sgpr_32 = PRED_COPY $sgpr14
  ; CHECK-NEXT:   [[PRED_COPY6:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr10_sgpr11
  ; CHECK-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; CHECK-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; CHECK-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p4) = PRED_COPY $sgpr8_sgpr9
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_void_func_void
  ; CHECK-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; CHECK-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]](s32)
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 10
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C1]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C2]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
  ; CHECK-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY14]](s32)
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
...
define amdgpu_gfx void @test_gfx_call_external_void_func_void() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY]](<4 x s32>)
...
define amdgpu_kernel void @test_call_external_void_func_empty_struct() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C1]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C2]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C3]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_i1_signext(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[SEXT]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_i8_imm(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT1]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_i8_signext(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[SEXT1]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_i8_zeroext(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ZEXT1]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_gfx void @test_gfx_call_external_void_func_i32_imm(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY1]](<4 x s32>)
...
define amdgpu_gfx void @test_gfx_call_external_void_func_i32_imm_inreg(i32 inreg) #0 {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(s32) = PRED_COPY $sgpr4
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 42
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @external_gfx_void_func_i32_inreg
  ; CHECK-NEXT:   $sgpr4 = PRED_COPY [[C]](s32)
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY1]](<4 x s32>)
...
define amdgpu_kernel void @test_call_external_void_func_v2i64_imm() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C2]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C3]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C4]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
...
define amdgpu_kernel void @test_call_external_void_func_v4i64() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C3]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C4]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C5:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C5]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
...
define amdgpu_kernel void @test_call_external_void_func_v5f32_imm() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C5]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C6]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C7:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C7]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
...
define amdgpu_kernel void @test_call_external_void_func_v2i16() #0 {
  ...
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C2]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[LOAD]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v3i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV3]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV4]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v4i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV1]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v4i16_imm() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C4]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C5]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C6:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C6]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
...
define amdgpu_kernel void @test_call_external_void_func_v5i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV5]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV6]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV7]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v7i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV7]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV8]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV9]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[UV10]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v63i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV63]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV64]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV65]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[UV66]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr4 = PRED_COPY [[UV67]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr5 = PRED_COPY [[UV68]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr6 = PRED_COPY [[UV69]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr7 = PRED_COPY [[UV70]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr8 = PRED_COPY [[UV71]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr9 = PRED_COPY [[UV72]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr10 = PRED_COPY [[UV73]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr11 = PRED_COPY [[UV74]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr12 = PRED_COPY [[UV75]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr13 = PRED_COPY [[UV76]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr14 = PRED_COPY [[UV77]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr15 = PRED_COPY [[UV78]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr16 = PRED_COPY [[UV79]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr17 = PRED_COPY [[UV80]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr18 = PRED_COPY [[UV81]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr19 = PRED_COPY [[UV82]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr20 = PRED_COPY [[UV83]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr21 = PRED_COPY [[UV84]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr22 = PRED_COPY [[UV85]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr23 = PRED_COPY [[UV86]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr24 = PRED_COPY [[UV87]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr25 = PRED_COPY [[UV88]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr26 = PRED_COPY [[UV89]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr27 = PRED_COPY [[UV90]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr28 = PRED_COPY [[UV91]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr29 = PRED_COPY [[UV92]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr30 = PRED_COPY [[UV93]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v65i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV65]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV66]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV67]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[UV68]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr4 = PRED_COPY [[UV69]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr5 = PRED_COPY [[UV70]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr6 = PRED_COPY [[UV71]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr7 = PRED_COPY [[UV72]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr8 = PRED_COPY [[UV73]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr9 = PRED_COPY [[UV74]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr10 = PRED_COPY [[UV75]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr11 = PRED_COPY [[UV76]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr12 = PRED_COPY [[UV77]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr13 = PRED_COPY [[UV78]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr14 = PRED_COPY [[UV79]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr15 = PRED_COPY [[UV80]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr16 = PRED_COPY [[UV81]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr17 = PRED_COPY [[UV82]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr18 = PRED_COPY [[UV83]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr19 = PRED_COPY [[UV84]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr20 = PRED_COPY [[UV85]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr21 = PRED_COPY [[UV86]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr22 = PRED_COPY [[UV87]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr23 = PRED_COPY [[UV88]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr24 = PRED_COPY [[UV89]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr25 = PRED_COPY [[UV90]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr26 = PRED_COPY [[UV91]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr27 = PRED_COPY [[UV92]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr28 = PRED_COPY [[UV93]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr29 = PRED_COPY [[UV94]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr30 = PRED_COPY [[UV95]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v66i16() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[UV]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV1]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV2]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[UV3]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr4 = PRED_COPY [[UV4]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr5 = PRED_COPY [[UV5]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr6 = PRED_COPY [[UV6]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr7 = PRED_COPY [[UV7]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr8 = PRED_COPY [[UV8]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr9 = PRED_COPY [[UV9]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr10 = PRED_COPY [[UV10]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr11 = PRED_COPY [[UV11]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr12 = PRED_COPY [[UV12]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr13 = PRED_COPY [[UV13]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr14 = PRED_COPY [[UV14]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr15 = PRED_COPY [[UV15]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr16 = PRED_COPY [[UV16]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr17 = PRED_COPY [[UV17]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr18 = PRED_COPY [[UV18]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr19 = PRED_COPY [[UV19]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr20 = PRED_COPY [[UV20]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr21 = PRED_COPY [[UV21]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr22 = PRED_COPY [[UV22]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr23 = PRED_COPY [[UV23]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr24 = PRED_COPY [[UV24]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr25 = PRED_COPY [[UV25]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr26 = PRED_COPY [[UV26]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr27 = PRED_COPY [[UV27]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr28 = PRED_COPY [[UV28]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr29 = PRED_COPY [[UV29]](<2 x s16>)
  ; CHECK-NEXT:   $vgpr30 = PRED_COPY [[UV30]](<2 x s16>)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v3i32_i32(i32) #0 {
  ...
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[UV1]](s32)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[UV2]](s32)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[C3]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v8i32_imm() #0 {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C8]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C9]](s32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(s32) = G_OR [[PRED_COPY17]], [[SHL]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[C10:%[0-9]+]]:_(s32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY19]], [[C10]](s32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(s32) = G_OR [[OR]], [[SHL1]]
...
define amdgpu_kernel void @test_call_external_void_func_v32i32() #0 {
  ...
  ; CHECK-NEXT:   $vgpr14 = PRED_COPY [[UV14]](s32)
  ; CHECK-NEXT:   $vgpr15 = PRED_COPY [[UV15]](s32)
  ; CHECK-NEXT:   $vgpr16 = PRED_COPY [[UV16]](s32)
  ; CHECK-NEXT:   $vgpr17 = PRED_COPY [[UV17]](s32)
  ; CHECK-NEXT:   $vgpr18 = PRED_COPY [[UV18]](s32)
  ; CHECK-NEXT:   $vgpr19 = PRED_COPY [[UV19]](s32)
  ; CHECK-NEXT:   $vgpr20 = PRED_COPY [[UV20]](s32)
  ; CHECK-NEXT:   $vgpr21 = PRED_COPY [[UV21]](s32)
  ; CHECK-NEXT:   $vgpr22 = PRED_COPY [[UV22]](s32)
  ; CHECK-NEXT:   $vgpr23 = PRED_COPY [[UV23]](s32)
  ; CHECK-NEXT:   $vgpr24 = PRED_COPY [[UV24]](s32)
  ; CHECK-NEXT:   $vgpr25 = PRED_COPY [[UV25]](s32)
  ; CHECK-NEXT:   $vgpr26 = PRED_COPY [[UV26]](s32)
  ; CHECK-NEXT:   $vgpr27 = PRED_COPY [[UV27]](s32)
  ; CHECK-NEXT:   $vgpr28 = PRED_COPY [[UV28]](s32)
  ; CHECK-NEXT:   $vgpr29 = PRED_COPY [[UV29]](s32)
  ; CHECK-NEXT:   $vgpr30 = PRED_COPY [[UV30]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v32i32_i32(i32) #0 {
  ...
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
  ; CHECK-NEXT:   $sgpr15 = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   $vgpr31 = PRED_COPY [[OR1]](s32)
...
define amdgpu_kernel void @test_call_external_void_func_v32i32_i8_i8_i16() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(s16) = PRED_COPY [[ANYEXT]](s16)
  ; CHECK-NEXT:   [[C5:%[0-9]+]]:_(s32) = G_CONSTANT i32 8
  ; CHECK-NEXT:   [[PTR_ADD3:%[0-9]+]]:_(p5) = G_PTR_ADD [[AMDGPU_WAVE_ADDRESS]], [[C5]](s32)
  ; CHECK-NEXT:   G_STORE [[PRED_COPY20]](s16), [[PTR_ADD3]](p5) :: (store (s16) into stack + 8, align 8, addrspace 5)
  ...
  ; CHECK-NEXT:   $vgpr29 = PRED_COPY [[UV29]](s32)
  ; CHECK-NEXT:   $vgpr30 = PRED_COPY [[UV30]](s32)
  ; CHECK-NEXT:   [[PRED_COPY21:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY21]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
...
define amdgpu_kernel void @test_call_external_void_func_struct_i8_i32() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C1]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ...
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT]](s16)
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT1]](s32)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[LOAD2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PTR_ADD1]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
  ; CHECK-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY14]](s32)
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
...
define amdgpu_gfx void @test_gfx_call_external_void_func_struct_i8_i32_inreg() #0 {
  ...
  ; CHECK-NEXT:   [[ANYEXT:%[0-9]+]]:_(s16) = G_ANYEXT [[LOAD1]](s8)
  ; CHECK-NEXT:   [[ANYEXT1:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT]](s16)
  ; CHECK-NEXT:   $sgpr4 = PRED_COPY [[ANYEXT1]](s32)
  ; CHECK-NEXT:   $sgpr5 = PRED_COPY [[LOAD2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY]](<4 x s32>)
...
define amdgpu_kernel void @test_call_external_void_func_byval_struct_i8_i32() #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY9]](p4)
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY12]], [[C3]](s64)
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
...
define void @call_byval_3ai32_byval_i8_align32(ptr addrspace(5) %incoming0, ptr addrspace(5) align 32 %incoming1) #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr6_sgpr7
  ; CHECK-NEXT:   [[PRED_COPY8:%[0-9]+]]:sgpr_64 = PRED_COPY $sgpr4_sgpr5
  ; CHECK-NEXT:   [[PRED_COPY9:%[0-9]+]]:_(p5) = PRED_COPY $vgpr0
  ; CHECK-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p5) = PRED_COPY $vgpr1
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 999
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @void_func_byval_a3i32_byval_i8_align32
  ; CHECK-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; CHECK-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; CHECK-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]]
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ...
  ; CHECK-NEXT:   G_MEMCPY [[PTR_ADD]](p5), [[PRED_COPY9]](p5), [[C2]](s32), 0 :: (dereferenceable store (s96) into stack, align 4, addrspace 5), (dereferenceable load (s96) from %ir.incoming0, align 4, addrspace 5)
  ; CHECK-NEXT:   [[C3:%[0-9]+]]:_(s32) = G_CONSTANT i32 32
  ; CHECK-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p5) = G_PTR_ADD [[AMDGPU_WAVE_ADDRESS]], [[C3]](s32)
  ; CHECK-NEXT:   [[C4:%[0-9]+]]:_(s32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   G_MEMCPY [[PTR_ADD1]](p5), [[PRED_COPY10]](p5), [[C4]](s32), 0 :: (dereferenceable store (s8) into stack + 32, align 32, addrspace 5), (dereferenceable load (s8) from %ir.incoming1, align 32, addrspace 5)
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[C]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY11]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY12]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY13]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY14]](s64)
  ; CHECK-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY15]](s32)
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY16]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY17]](s32)
  ; CHECK-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY18]](s32)
  ; CHECK-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY19]](s32)
...
define void @call_byval_a4i64_align4_higher_source_align(ptr addrspace(5) align 256 %incoming_high_align) #0 {
  ...
  ; CHECK-NEXT:   [[PRED_COPY10:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY8]]
  ; CHECK-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]]
  ; CHECK-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY6]]
  ; CHECK-NEXT:   [[PRED_COPY13:%[0-9]+]]:_(s64) = PRED_COPY [[PRED_COPY5]]
  ; CHECK-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY4]]
  ; CHECK-NEXT:   [[PRED_COPY15:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY3]]
  ; CHECK-NEXT:   [[PRED_COPY16:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY2]]
  ; CHECK-NEXT:   [[PRED_COPY17:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY1]]
  ; CHECK-NEXT:   [[PRED_COPY18:%[0-9]+]]:_(s32) = PRED_COPY [[PRED_COPY]](s32)
  ; CHECK-NEXT:   [[AMDGPU_WAVE_ADDRESS:%[0-9]+]]:_(p5) = G_AMDGPU_WAVE_ADDRESS $sgpr32
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 0
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p5) = G_PTR_ADD [[AMDGPU_WAVE_ADDRESS]], [[C]](s32)
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(s32) = G_CONSTANT i32 32
  ; CHECK-NEXT:   G_MEMCPY [[PTR_ADD]](p5), [[PRED_COPY9]](p5), [[C1]](s32), 0 :: (dereferenceable store (s256) into stack, align 4, addrspace 5), (dereferenceable load (s256) from %ir.incoming_high_align, align 256, addrspace 5)
  ; CHECK-NEXT:   [[PRED_COPY19:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY19]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY12]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[PRED_COPY13]](s64)
  ; CHECK-NEXT:   $sgpr12 = PRED_COPY [[PRED_COPY14]](s32)
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY15]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY16]](s32)
  ; CHECK-NEXT:   $sgpr15 = PRED_COPY [[PRED_COPY17]](s32)
  ; CHECK-NEXT:   $vgpr31 = PRED_COPY [[PRED_COPY18]](s32)
...
define amdgpu_kernel void @test_call_external_void_func_v2i8() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT2]](s32)
  ; CHECK-NEXT:   [[ANYEXT3:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT1]](s16)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[ANYEXT3]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v3i8() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT3]](s32)
  ; CHECK-NEXT:   [[ANYEXT4:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT1]](s16)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[ANYEXT4]](s32)
  ; CHECK-NEXT:   [[ANYEXT5:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT2]](s16)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[ANYEXT5]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_kernel void @test_call_external_void_func_v4i8() #0 {
  ...
  ; CHECK-NEXT:   $vgpr0 = PRED_COPY [[ANYEXT4]](s32)
  ; CHECK-NEXT:   [[ANYEXT5:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT1]](s16)
  ; CHECK-NEXT:   $vgpr1 = PRED_COPY [[ANYEXT5]](s32)
  ; CHECK-NEXT:   [[ANYEXT6:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT2]](s16)
  ; CHECK-NEXT:   $vgpr2 = PRED_COPY [[ANYEXT6]](s32)
  ; CHECK-NEXT:   [[ANYEXT7:%[0-9]+]]:_(s32) = G_ANYEXT [[ANYEXT3]](s16)
  ; CHECK-NEXT:   $vgpr3 = PRED_COPY [[ANYEXT7]](s32)
  ; CHECK-NEXT:   [[PRED_COPY20:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY20]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[PRED_COPY10]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY11]](p4)
...
define amdgpu_ps void @amdgpu_ps_call_default_cc() {
  ...
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p4) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[PRED_COPY:%[0-9]+]]:_(p4) = PRED_COPY [[DEF]](p4)
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(p4) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p4) = PRED_COPY [[C1]](p4)
  ; CHECK-NEXT:   [[DEF1:%[0-9]+]]:_(s64) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[DEF2:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(s32) = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(s32) = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY4:%[0-9]+]]:_(s32) = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY5:%[0-9]+]]:_(s32) = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   [[PRED_COPY6:%[0-9]+]]:_(<4 x s32>) = PRED_COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = PRED_COPY [[PRED_COPY6]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = PRED_COPY [[DEF]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = PRED_COPY [[PRED_COPY]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = PRED_COPY [[PRED_COPY1]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = PRED_COPY [[DEF1]](s64)
  ; CHECK-NEXT:   $sgpr12 = PRED_COPY [[DEF2]](s32)
  ; CHECK-NEXT:   $sgpr13 = PRED_COPY [[PRED_COPY2]](s32)
  ; CHECK-NEXT:   $sgpr14 = PRED_COPY [[PRED_COPY3]](s32)
