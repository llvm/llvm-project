...
; GFX11-NEXT:    s_or_b32 s0, s0, s6
; GFX11-NEXT:    s_and_b32 s6, s11, s9
...
; GFX11-NEXT:    s_bfe_u32 s7, s8, 0x100000
...
; GFX11-NEXT:    s_or_b32 s4, s4, s7
; GFX11-NEXT:    s_and_b32 s7, s12, s9
...
; GFX11-NEXT:    v_sub_nc_u32_e32 v4, 23, v0
...
; GFX11-NEXT:    v_and_b32_e32 v4, s9, v0
; GFX11-NEXT:    v_and_or_b32 v1, v1, s9, v2
...
; GFX11-NEXT:    v_lshrrev_b64 v[6:7], 1, v[6:7]
; GFX11-NEXT:    v_sub_nc_u32_e32 v9, 64, v18
...
; GFX11-NEXT:    v_lshrrev_b64 v[8:9], v9, v[0:1]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_movk_i32 s9, 0x7f
; GFX11-NEXT:    v_xor_b32_e32 v4, -1, v0
; GFX11-NEXT:    v_and_b32_e32 v12, s9, v0
; GFX11-NEXT:    s_mov_b32 s8, 0
; GFX11-NEXT:    s_lshr_b64 s[4:5], s[4:5], 1
; GFX11-NEXT:    v_and_b32_e32 v13, s9, v4
...
; GFX11-NEXT:    s_cmp_lt_u32 s8, 64
; GFX11-NEXT:    v_lshlrev_b32_e32 v4, 31, v2
...
; GFX11-NEXT:    s_mov_b64 s[6:7], 0x7f
; GFX11-NEXT:    s_and_b64 s[8:9], s[4:5], s[6:7]
; GFX11-NEXT:    s_and_not1_b64 s[10:11], s[6:7], s[4:5]
...
; GFX11-NEXT:    s_lshl_b32 s5, s2, 31
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[0:1], 1
...
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX11-NEXT:    s_sub_i32 s7, 64, s10
...
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[2:3], s10
; GFX11-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[2:3], s11
; GFX11-NEXT:    s_cmp_lg_u32 s12, 0
...
; GFX11-NEXT:    v_and_b32_e32 v28, s3, v16
...
; GFX11-NEXT:    v_xor_b32_e32 v10, -1, v20
...
; GFX11-NEXT:    v_sub_nc_u32_e32 v3, 64, v23
; GFX11-NEXT:    v_and_b32_e32 v25, s3, v10
; GFX11-NEXT:    v_lshlrev_b32_e32 v16, 31, v14
...
; GFX11-NEXT:    v_or_b32_e32 v3, v22, v24
