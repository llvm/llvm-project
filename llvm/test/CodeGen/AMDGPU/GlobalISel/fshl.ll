...
; GFX6-NEXT:    v_sub_i32_e32 v18, vcc, 64, v23
; GFX6-NEXT:    v_lshr_b64 v[18:19], v[0:1], v18
...
; GFX6-NEXT:    v_cndmask_b32_e32 v18, v18, v25, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v25, 0, v1, vcc
; GFX6-NEXT:    v_lshr_b64 v[0:1], v[10:11], v0
; GFX6-NEXT:    v_cndmask_b32_e32 v19, v19, v26, vcc
...
; GFX6-NEXT:    v_cndmask_b32_e64 v0, v0, v21, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v19, v3, vcc
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v1, v22, s[4:5]
...
; GFX6-NEXT:    v_lshl_b64 v[8:9], v[4:5], v21
...
; GFX6-NEXT:    v_not_b32_e32 v12, v20
; GFX6-NEXT:    v_or_b32_e32 v9, v9, v10
; GFX6-NEXT:    v_lshr_b64 v[10:11], v[14:15], 1
; GFX6-NEXT:    v_and_b32_e32 v18, 0x7f, v12
; GFX6-NEXT:    v_sub_i32_e32 v14, vcc, 64, v18
; GFX6-NEXT:    v_add_i32_e32 v19, vcc, v18, v17
; GFX6-NEXT:    v_lshr_b64 v[12:13], v[8:9], v18
; GFX6-NEXT:    v_lshl_b64 v[14:15], v[10:11], v14
; GFX6-NEXT:    v_lshr_b64 v[16:17], v[10:11], v18
; GFX6-NEXT:    v_lshr_b64 v[10:11], v[10:11], v19
; GFX6-NEXT:    v_or_b32_e32 v12, v12, v14
; GFX6-NEXT:    v_or_b32_e32 v13, v13, v15
; GFX6-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v18
; GFX6-NEXT:    v_cndmask_b32_e32 v10, v10, v12, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v11, v11, v13, vcc
...
; GFX6-NEXT:    v_cndmask_b32_e32 v10, 0, v16, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v11, 0, v17, vcc
...
; GFX8-NEXT:    v_sub_u32_e32 v18, vcc, 64, v23
; GFX8-NEXT:    v_lshrrev_b64 v[18:19], v18, v[0:1]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v18, v18, v25, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v25, 0, v1, vcc
; GFX8-NEXT:    v_lshrrev_b64 v[0:1], v0, v[10:11]
; GFX8-NEXT:    v_cndmask_b32_e32 v19, v19, v26, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v0, v21, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v19, v3, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v1, v22, s[4:5]
...
; GFX8-NEXT:    v_lshlrev_b64 v[8:9], v21, v[4:5]
...
; GFX8-NEXT:    v_not_b32_e32 v12, v20
; GFX8-NEXT:    v_or_b32_e32 v9, v9, v10
; GFX8-NEXT:    v_lshrrev_b64 v[10:11], 1, v[14:15]
; GFX8-NEXT:    v_and_b32_e32 v18, 0x7f, v12
; GFX8-NEXT:    v_sub_u32_e32 v14, vcc, 64, v18
; GFX8-NEXT:    v_add_u32_e32 v19, vcc, v18, v17
; GFX8-NEXT:    v_lshrrev_b64 v[12:13], v18, v[8:9]
; GFX8-NEXT:    v_lshlrev_b64 v[14:15], v14, v[10:11]
; GFX8-NEXT:    v_lshrrev_b64 v[16:17], v18, v[10:11]
; GFX8-NEXT:    v_lshrrev_b64 v[10:11], v19, v[10:11]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v10, 0, v16, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v11, 0, v17, vcc
...
; GFX9-NEXT:    v_sub_u32_e32 v21, 64, v19
; GFX9-NEXT:    v_lshrrev_b64 v[21:22], v21, v[0:1]
; GFX9-NEXT:    v_lshlrev_b64 v[23:24], v19, v[2:3]
; GFX9-NEXT:    v_add_u32_e32 v25, 0xffffffc0, v19
; GFX9-NEXT:    v_lshlrev_b64 v[17:18], v19, v[0:1]
...
; GFX9-NEXT:    v_lshrrev_b64 v[0:1], 1, v[10:11]
; GFX9-NEXT:    v_sub_u32_e32 v26, 64, v24
; GFX9-NEXT:    v_lshl_or_b32 v9, v10, 31, v9
; GFX9-NEXT:    v_cndmask_b32_e32 v23, 0, v17, vcc
; GFX9-NEXT:    v_lshrrev_b64 v[16:17], v24, v[8:9]
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], v26, v[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v19, v21, v2, s[4:5]
; GFX9-NEXT:    v_add_u32_e32 v2, 0xffffffc0, v24
; GFX9-NEXT:    v_or_b32_e32 v10, v16, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v22, v3, s[4:5]
; GFX9-NEXT:    v_lshrrev_b64 v[2:3], v2, v[0:1]
; GFX9-NEXT:    v_cndmask_b32_e32 v18, 0, v18, vcc
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v24
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v10, vcc
; GFX9-NEXT:    v_or_b32_e32 v10, v17, v11
; GFX9-NEXT:    v_lshrrev_b64 v[0:1], v24, v[0:1]
...
; GFX9-NEXT:    v_or_b32_e32 v2, v19, v8
...
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], v19, v[4:5]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v11, v9, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v10, 0, v16, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v11, 0, v17, vcc
; GFX9-NEXT:    v_or_b32_e32 v4, v4, v8
; GFX9-NEXT:    v_or_b32_e32 v5, v5, v9
; GFX9-NEXT:    v_or_b32_e32 v6, v6, v10
; GFX9-NEXT:    v_or_b32_e32 v7, v7, v11
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
