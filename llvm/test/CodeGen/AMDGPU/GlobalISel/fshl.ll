...
; GFX11-NEXT:    s_lshl_b64 s[4:5], s[6:7], s9
; GFX11-NEXT:    s_lshr_b64 s[6:7], s[6:7], 1
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
...
; GFX11-NEXT:    s_or_b64 s[4:5], s[4:5], s[10:11]
...
; GFX11-NEXT:    v_lshlrev_b64 v[8:9], v18, v[0:1]
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v10, 64, v19
...
; GFX11-NEXT:    v_lshlrev_b64 v[8:9], v0, s[6:7]
...
; GFX11-NEXT:    v_lshlrev_b64 v[4:5], s0, v[2:3]
; GFX11-NEXT:    v_lshrrev_b64 v[2:3], 1, v[2:3]
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s7
; GFX11-NEXT:    s_cselect_b32 s12, 1, 0
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sub_i32 s2, 0x41, 64
; GFX11-NEXT:    s_sub_i32 s4, 64, 63
; GFX11-NEXT:    s_mov_b32 s9, 0
; GFX11-NEXT:    s_lshl_b64 s[2:3], s[0:1], s2
; GFX11-NEXT:    s_lshr_b32 s0, s5, 31
; GFX11-NEXT:    s_lshr_b32 s8, s7, 31
; GFX11-NEXT:    s_mov_b32 s1, s9
; GFX11-NEXT:    s_lshl_b64 s[4:5], s[6:7], s4
...
; GFX11-NEXT:    v_lshlrev_b64 v[2:3], s0, v[0:1]
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], s1, v[6:7]
...
; GFX11-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[0:1]
; GFX11-NEXT:    s_sub_i32 s26, 64, 1
; GFX11-NEXT:    s_lshr_b64 s[0:1], s[8:9], 1
; GFX11-NEXT:    s_lshl_b64 s[8:9], s[10:11], s26
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[10:11], 1
; GFX11-NEXT:    s_or_b64 s[0:1], s[0:1], s[8:9]
; GFX11-NEXT:    s_sub_i32 s27, s16, 64
; GFX11-NEXT:    s_sub_i32 s17, 64, s16
; GFX11-NEXT:    s_cmp_lt_u32 s16, 64
; GFX11-NEXT:    s_cselect_b32 s28, 1, 0
; GFX11-NEXT:    s_cmp_eq_u32 s16, 0
; GFX11-NEXT:    s_cselect_b32 s29, 1, 0
; GFX11-NEXT:    s_lshr_b64 s[8:9], s[0:1], s16
; GFX11-NEXT:    s_lshl_b64 s[24:25], s[10:11], s17
; GFX11-NEXT:    s_lshr_b64 s[16:17], s[10:11], s16
; GFX11-NEXT:    s_or_b64 s[8:9], s[8:9], s[24:25]
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[10:11], s27
; GFX11-NEXT:    s_cmp_lg_u32 s28, 0
...
; GFX11-NEXT:    s_lshl_b64 s[12:13], s[14:15], s26
...
; GFX11-NEXT:    s_cselect_b32 s20, 1, 0
; GFX11-NEXT:    s_lshr_b64 s[12:13], s[4:5], s10
; GFX11-NEXT:    s_lshl_b64 s[16:17], s[14:15], s11
; GFX11-NEXT:    s_lshr_b64 s[10:11], s[14:15], s10
; GFX11-NEXT:    s_or_b64 s[12:13], s[12:13], s[16:17]
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_movk_i32 s3, 0x7f
; GFX11-NEXT:    v_xor_b32_e32 v18, -1, v16
; GFX11-NEXT:    v_and_b32_e32 v27, s3, v16
; GFX11-NEXT:    s_sub_i32 s4, 64, 1
; GFX11-NEXT:    v_lshrrev_b64 v[8:9], 1, v[8:9]
; GFX11-NEXT:    v_lshlrev_b64 v[16:17], s4, v[10:11]
; GFX11-NEXT:    v_and_b32_e32 v28, s3, v18
; GFX11-NEXT:    v_sub_nc_u32_e32 v19, 64, v27
...
; GFX11-NEXT:    v_lshrrev_b64 v[18:19], v19, v[0:1]
...
; GFX11-NEXT:    v_cndmask_b32_e64 v18, v18, v23, s0
; GFX11-NEXT:    v_lshrrev_b64 v[0:1], v28, v[10:11]
; GFX11-NEXT:    v_cndmask_b32_e64 v10, v19, v24, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v22, v22, v3, s2
; GFX11-NEXT:    v_cndmask_b32_e32 v16, 0, v16, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v18, v8, s1
; GFX11-NEXT:    v_cndmask_b32_e32 v11, 0, v17, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v10, v9, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v9, 0, v0, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v21, v2, s2
; GFX11-NEXT:    v_and_b32_e32 v24, s3, v20
; GFX11-NEXT:    v_or_b32_e32 v0, v16, v3
...
; GFX11-NEXT:    v_sub_nc_u32_e32 v16, 64, v24
; GFX11-NEXT:    v_and_b32_e32 v25, s3, v3
...
; GFX11-NEXT:    v_lshrrev_b64 v[12:13], v16, v[4:5]
; GFX11-NEXT:    v_lshlrev_b64 v[16:17], v24, v[6:7]
; GFX11-NEXT:    v_sub_nc_u32_e32 v20, 64, v25
; GFX11-NEXT:    v_or_b32_e32 v8, v8, v10
; GFX11-NEXT:    v_or_b32_e32 v9, v9, v11
; GFX11-NEXT:    v_lshlrev_b64 v[10:11], v24, v[4:5]
; GFX11-NEXT:    v_lshlrev_b64 v[3:4], v3, v[4:5]
; GFX11-NEXT:    v_or_b32_e32 v16, v12, v16
; GFX11-NEXT:    v_subrev_nc_u32_e32 v12, 64, v25
...
; GFX11-NEXT:    v_lshrrev_b64 v[12:13], v12, v[14:15]
; GFX11-NEXT:    v_cndmask_b32_e32 v16, v3, v16, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u32_e64 s2, 0, v24
; GFX11-NEXT:    v_or_b32_e32 v17, v18, v20
...
; GFX11-NEXT:    v_cndmask_b32_e64 v12, v12, v17, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v13, v13, v18, s0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v12, v8, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v12, 0, v4, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v8, v13, v9, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v9, 0, v3, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v16, v6, s2
; GFX11-NEXT:    v_or_b32_e32 v4, v10, v5
; GFX11-NEXT:    v_or_b32_e32 v3, v22, v23
; GFX11-NEXT:    v_or_b32_e32 v5, v11, v8
