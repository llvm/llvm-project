...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, 32, v2
; GFX6-NEXT:    v_alignbit_b32 v0, v1, v0, v2
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
; GFX8-LABEL: v_fshl_i32:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, 32, v2
; GFX8-NEXT:    v_alignbit_b32 v0, v1, v0, v2
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_alignbit_b32 v0, v1, v0, v2
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10-LABEL: v_fshl_i32:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_sub_nc_u32_e32 v2, 32, v2
; GFX10-NEXT:    v_alignbit_b32 v0, v1, v0, v2
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_fshl_i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_sub_nc_u32_e32 v2, 32, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_alignbit_b32 v0, v1, v0, v2
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %result = call i32 @llvm.fshl.i32(i32 %lhs, i32 %rhs, i32 %amt)
  ret i32 %result
}
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_alignbit_b32 v0, v1, v0, 27
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %result = call i32 @llvm.fshl.i32(i32 %lhs, i32 %rhs, i32 5)
  ret i32 %result
}
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_alignbit_b32 v0, v1, v0, 24
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_fshl_i32_8:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_alignbit_b32 v0, v1, v0, 24
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %result = call i32 @llvm.fshl.i32(i32 %lhs, i32 %rhs, i32 8)
  ret i32 %result
}
...
; GFX6-NEXT:    v_alignbit_b32 v0, s1, v1, v0
; GFX6-NEXT:    ; return to shader part epilog
;
; GFX8-LABEL: v_fshl_i32_ssv:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, 32, v0
; GFX8-NEXT:    v_mov_b32_e32 v1, s0
; GFX8-NEXT:    v_alignbit_b32 v0, s1, v1, v0
; GFX8-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: v_fshl_i32_ssv:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_sub_u32_e32 v0, 32, v0
; GFX9-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-NEXT:    v_alignbit_b32 v0, s1, v1, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10-LABEL: v_fshl_i32_ssv:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    v_sub_nc_u32_e32 v0, 32, v0
; GFX10-NEXT:    v_alignbit_b32 v0, s1, s0, v0
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: v_fshl_i32_ssv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_u32_e32 v0, 32, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_alignbit_b32 v0, s1, s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.fshl.i32(i32 %lhs, i32 %rhs, i32 %amt)
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_sub_i32 s1, 32, s1
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    v_alignbit_b32 v0, v0, s0, v1
; GFX8-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: v_fshl_i32_svs:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_sub_i32 s1, 32, s1
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    v_alignbit_b32 v0, v0, s0, v1
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10-LABEL: v_fshl_i32_svs:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_sub_i32 s1, 32, s1
; GFX10-NEXT:    v_alignbit_b32 v0, v0, s0, s1
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: v_fshl_i32_svs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_sub_i32 s1, 32, s1
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_alignbit_b32 v0, v0, s0, s1
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.fshl.i32(i32 %lhs, i32 %rhs, i32 %amt)
  %cast.result = bitcast i32 %result to float
  ret float %cast.result
