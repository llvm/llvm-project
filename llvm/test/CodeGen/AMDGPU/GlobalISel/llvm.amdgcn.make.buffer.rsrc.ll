...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 -stop-after=instruction-select < %s | FileCheck %s
...
define amdgpu_ps ptr addrspace(8) @variable_top_half(ptr inreg %p, i64 inreg %numVals, i32 inreg %flags) {
  ...
  ; CHECK45-NEXT:   [[MV1:%[0-9]+]]:sgpr(i64) = G_MERGE_VALUES [[COPY2]](s32), [[COPY3]](s32)
  ; CHECK45-NEXT:   [[COPY4:%[0-9]+]]:sgpr(i32) = COPY $sgpr4
  ; CHECK45-NEXT:   [[C:%[0-9]+]]:sreg_32(s32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[PTRTOINT:%[0-9]+]]:sgpr(s64) = G_PTRTOINT [[MV]](p0)
  ; CHECK45-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 25
  ; CHECK45-NEXT:   [[SHL:%[0-9]+]]:sgpr(s32) = G_SHL [[COPY2]], [[C1]](s32)
  ; CHECK45-NEXT:   [[C2:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[MV2:%[0-9]+]]:sgpr(s64) = G_MERGE_VALUES [[C2]](s32), [[SHL]](s32)
  ; CHECK45-NEXT:   [[OR:%[0-9]+]]:sreg_64(s64) = G_OR [[PTRTOINT]], [[MV2]]
  ; CHECK45-NEXT:   [[C3:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 7
  ; CHECK45-NEXT:   [[LSHR:%[0-9]+]]:sreg_64(s64) = G_LSHR [[MV1]], [[C3]](s32)
  ; CHECK45-NEXT:   [[C4:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 16384
  ; CHECK45-NEXT:   [[MV3:%[0-9]+]]:sreg_64(s64) = G_MERGE_VALUES [[C]](s32), [[C4]](s32)
  ; CHECK45-NEXT:   [[C5:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 28
  ; CHECK45-NEXT:   [[SHL1:%[0-9]+]]:sreg_32(s32) = G_SHL [[COPY4]], [[C5]](s32)
  ; CHECK45-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64(s64) = REG_SEQUENCE [[C]](s32), %subreg.sub0, [[SHL1]](s32), %subreg.sub1
  ; CHECK45-NEXT:   [[S_OR_B64_:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[LSHR]](s64), [[MV3]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[S_OR_B64_1:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[S_OR_B64_]](s64), [[REG_SEQUENCE]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[COPY5:%[0-9]+]]:sreg_32(i32) = COPY [[OR]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY6:%[0-9]+]]:sreg_32(i32) = COPY [[OR]].sub1(s64)
  ; CHECK45-NEXT:   [[COPY7:%[0-9]+]]:sreg_32(i32) = COPY [[S_OR_B64_1]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY8:%[0-9]+]]:sreg_32(i32) = COPY [[S_OR_B64_1]].sub1(s64)
...
define amdgpu_ps ptr addrspace(8) @general_case(ptr inreg %p, i16 inreg %stride, i64 inreg %numVals, i32 inreg %flags) {
  ...
  ; CHECK-NEXT:   [[AND:%[0-9]+]]:sreg_32(s32) = G_AND [[COPY1]], [[C]]
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 16
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:sreg_32(s32) = G_SHL [[COPY2]], [[C1]](s32)
  ; CHECK-NEXT:   [[S_OR_B32_:%[0-9]+]]:sreg_32(s32) = S_OR_B32 [[AND]](s32), [[SHL]](s32), implicit-def dead $scc
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:vgpr_32(i32) = COPY [[COPY]](i32)
  ; CHECK-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32_xm0(i32) = V_READFIRSTLANE_B32 [[COPY5]](i32), implicit $exec
  ; CHECK-NEXT:   $sgpr0 = COPY [[V_READFIRSTLANE_B32_]](i32)
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:vgpr_32(s32) = COPY [[S_OR_B32_]](s32)
  ; CHECK-NEXT:   [[V_READFIRSTLANE_B32_1:%[0-9]+]]:sreg_32_xm0(i32) = V_READFIRSTLANE_B32 [[COPY6]](s32), implicit $exec
  ; CHECK-NEXT:   $sgpr1 = COPY [[V_READFIRSTLANE_B32_1]](i32)
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:vgpr_32(i32) = COPY [[COPY3]](i32)
  ; CHECK-NEXT:   [[V_READFIRSTLANE_B32_2:%[0-9]+]]:sreg_32_xm0(i32) = V_READFIRSTLANE_B32 [[COPY7]](i32), implicit $exec
  ; CHECK-NEXT:   $sgpr2 = COPY [[V_READFIRSTLANE_B32_2]](i32)
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32(i32) = COPY [[COPY4]](i32)
  ; CHECK-NEXT:   [[V_READFIRSTLANE_B32_3:%[0-9]+]]:sreg_32_xm0(i32) = V_READFIRSTLANE_B32 [[COPY8]](i32), implicit $exec
  ; CHECK-NEXT:   $sgpr3 = COPY [[V_READFIRSTLANE_B32_3]](i32)
  ; CHECK-NEXT:   SI_RETURN_TO_EPILOG implicit $sgpr0, implicit $sgpr1, implicit $sgpr2, implicit $sgpr3
  ;
  ...
  ; CHECK45-NEXT:   [[COPY5:%[0-9]+]]:sgpr(i32) = COPY $sgpr5
  ; CHECK45-NEXT:   [[C:%[0-9]+]]:sreg_32(s32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[PTRTOINT:%[0-9]+]]:sgpr(s64) = G_PTRTOINT [[MV]](p0)
  ; CHECK45-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 25
  ; CHECK45-NEXT:   [[SHL:%[0-9]+]]:sgpr(s32) = G_SHL [[COPY3]], [[C1]](s32)
  ; CHECK45-NEXT:   [[C2:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[MV2:%[0-9]+]]:sgpr(s64) = G_MERGE_VALUES [[C2]](s32), [[SHL]](s32)
  ; CHECK45-NEXT:   [[OR:%[0-9]+]]:sreg_64(s64) = G_OR [[PTRTOINT]], [[MV2]]
  ; CHECK45-NEXT:   [[C3:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 7
  ; CHECK45-NEXT:   [[LSHR:%[0-9]+]]:sreg_64(s64) = G_LSHR [[MV1]], [[C3]](s32)
  ; CHECK45-NEXT:   [[C4:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 12
  ; CHECK45-NEXT:   [[SHL1:%[0-9]+]]:sgpr(s32) = G_SHL [[COPY2]], [[C4]](s32)
  ; CHECK45-NEXT:   [[MV3:%[0-9]+]]:sreg_64(s64) = G_MERGE_VALUES [[C]](s32), [[SHL1]](s32)
  ; CHECK45-NEXT:   [[C5:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 28
  ; CHECK45-NEXT:   [[SHL2:%[0-9]+]]:sreg_32(s32) = G_SHL [[COPY5]], [[C5]](s32)
  ; CHECK45-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64(s64) = REG_SEQUENCE [[C]](s32), %subreg.sub0, [[SHL2]](s32), %subreg.sub1
  ; CHECK45-NEXT:   [[S_OR_B64_:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[LSHR]](s64), [[MV3]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[S_OR_B64_1:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[S_OR_B64_]](s64), [[REG_SEQUENCE]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[COPY6:%[0-9]+]]:sreg_32(i32) = COPY [[OR]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY7:%[0-9]+]]:sreg_32(i32) = COPY [[OR]].sub1(s64)
  ; CHECK45-NEXT:   [[COPY8:%[0-9]+]]:sreg_32(i32) = COPY [[S_OR_B64_1]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY9:%[0-9]+]]:sreg_32(i32) = COPY [[S_OR_B64_1]].sub1(s64)
  ; CHECK45-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(i32) = COPY [[COPY6]](i32)
...
define amdgpu_ps float @general_case_load(ptr inreg %p, i16 inreg %stride, i64 inreg %numVals, i32 inreg %flags) {
  ...
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:sreg_32(s32) = G_SHL [[COPY2]], [[C1]](s32)
  ; CHECK-NEXT:   [[S_OR_B32_:%[0-9]+]]:sreg_32(s32) = S_OR_B32 [[AND]](s32), [[SHL]](s32), implicit-def dead $scc
  ; CHECK-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32(i32) = S_MOV_B32 0
  ; CHECK-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sgpr_128(<4 x s32>) = REG_SEQUENCE [[COPY]](i32), %subreg.sub0, [[S_OR_B32_]](s32), %subreg.sub1, [[COPY3]](i32), %subreg.sub2, [[COPY4]](i32), %subreg.sub3
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:vgpr_32(i32) = COPY [[S_MOV_B32_]](i32)
  ; CHECK-NEXT:   [[BUFFER_LOAD_DWORD_IDXEN:%[0-9]+]]:vgpr_32(f32) = BUFFER_LOAD_DWORD_IDXEN [[COPY5]](i32), [[REG_SEQUENCE]](<4 x s32>), [[S_MOV_B32_]](i32), 0, 0, 0, implicit $exec :: (dereferenceable load (f32) from %ir.rsrc, align 1, addrspace 8)
  ...
  ; CHECK45-NEXT:   [[S_OR_B64_:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[LSHR]](s64), [[MV3]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[S_OR_B64_1:%[0-9]+]]:sreg_64(s64) = S_OR_B64 [[S_OR_B64_]](s64), [[REG_SEQUENCE]](s64), implicit-def dead $scc
  ; CHECK45-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32(i32) = S_MOV_B32 0
  ; CHECK45-NEXT:   [[COPY6:%[0-9]+]]:sreg_32(s32) = COPY [[OR]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY7:%[0-9]+]]:sreg_32(s32) = COPY [[OR]].sub1(s64)
  ; CHECK45-NEXT:   [[COPY8:%[0-9]+]]:sreg_32(s32) = COPY [[S_OR_B64_1]].sub0(s64)
  ; CHECK45-NEXT:   [[COPY9:%[0-9]+]]:sreg_32(s32) = COPY [[S_OR_B64_1]].sub1(s64)
  ; CHECK45-NEXT:   [[REG_SEQUENCE1:%[0-9]+]]:sgpr_128(<4 x s32>) = REG_SEQUENCE [[COPY6]](s32), %subreg.sub0, [[COPY7]](s32), %subreg.sub1, [[COPY8]](s32), %subreg.sub2, [[COPY9]](s32), %subreg.sub3
  ; CHECK45-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(i32) = COPY [[S_MOV_B32_]](i32)
  ; CHECK45-NEXT:   [[BUFFER_LOAD_DWORD_VBUFFER_IDXEN:%[0-9]+]]:vgpr_32(f32) = BUFFER_LOAD_DWORD_VBUFFER_IDXEN [[COPY10]](i32), [[REG_SEQUENCE1]](<4 x s32>), $sgpr_null, 0, 0, 0, implicit $exec :: (dereferenceable load (f32) from %ir.rsrc, align 1, addrspace 8)
...
define amdgpu_ps float @general_case_load_with_waterfall(ptr %p, i16 %stride, i64 %numVals, i32 %flags) {
  ...
  ; CHECK-NEXT:   [[AND:%[0-9]+]]:vgpr(s32) = G_AND [[COPY1]], [[COPY5]]
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 16
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:vgpr(s32) = G_SHL [[COPY2]], [[COPY6]](s32)
  ...
  ; CHECK45-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[PTRTOINT:%[0-9]+]]:vgpr(s64) = G_PTRTOINT [[MV]](p0)
  ; CHECK45-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 25
  ; CHECK45-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; CHECK45-NEXT:   [[SHL:%[0-9]+]]:vgpr(s32) = G_SHL [[COPY3]], [[COPY6]](s32)
  ; CHECK45-NEXT:   [[UV:%[0-9]+]]:vgpr(s32), [[UV1:%[0-9]+]]:vgpr(s32) = G_UNMERGE_VALUES [[PTRTOINT]](s64)
  ; CHECK45-NEXT:   [[OR:%[0-9]+]]:vgpr(s32) = G_OR [[UV1]], [[SHL]]
  ; CHECK45-NEXT:   [[C2:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 7
  ; CHECK45-NEXT:   [[COPY7:%[0-9]+]]:vgpr(s32) = COPY [[C2]](s32)
  ; CHECK45-NEXT:   [[LSHR:%[0-9]+]]:vgpr(s64) = G_LSHR [[MV1]], [[COPY7]](s32)
  ; CHECK45-NEXT:   [[C3:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 12
  ; CHECK45-NEXT:   [[COPY8:%[0-9]+]]:vgpr(s32) = COPY [[C3]](s32)
  ; CHECK45-NEXT:   [[SHL1:%[0-9]+]]:vgpr(s32) = G_SHL [[COPY2]], [[COPY8]](s32)
  ; CHECK45-NEXT:   [[C4:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 28
  ; CHECK45-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C4]](s32)
  ; CHECK45-NEXT:   [[SHL2:%[0-9]+]]:vgpr(s32) = G_SHL [[COPY5]], [[COPY9]](s32)
  ; CHECK45-NEXT:   [[UV2:%[0-9]+]]:vgpr(s32), [[UV3:%[0-9]+]]:vgpr(s32) = G_UNMERGE_VALUES [[LSHR]](s64)
  ; CHECK45-NEXT:   [[OR1:%[0-9]+]]:vgpr(s32) = G_OR [[UV3]], [[SHL1]]
  ; CHECK45-NEXT:   [[OR2:%[0-9]+]]:vgpr(s32) = G_OR [[OR1]], [[SHL2]]
  ; CHECK45-NEXT:   [[C5:%[0-9]+]]:sgpr(i32) = G_CONSTANT i32 0
  ; CHECK45-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:vreg_128_align2(<4 x s32>) = G_BUILD_VECTOR [[UV]](s32), [[OR]](s32), [[UV2]](s32), [[OR2]](s32)
  ; CHECK45-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(i32) = COPY [[C5]](i32)
  ; CHECK45-NEXT:   [[COPY11:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
