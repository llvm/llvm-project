...
; CHECK-NEXT:    v_mul_hi_u32 v4, s4, v3
; CHECK-NEXT:    s_add_u32 s7, s8, s7
; CHECK-NEXT:    s_mul_i32 s8, s4, -1
; CHECK-NEXT:    s_add_u32 s7, s8, s7
...
; CHECK-NEXT:    v_mul_hi_u32 v5, s4, v4
...
; CHECK-NEXT:    s_cselect_b32 s7, 1, 0
; CHECK-NEXT:    v_mul_hi_u32 v3, s5, v4
...
; CGP-NEXT:    v_readfirstlane_b32 s7, v5
...
; CGP-NEXT:    v_mul_hi_u32 v5, v4, s4
...
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v5, v10, 0
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v11
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v12, v9
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v5, v11, v[8:9]
...
; CGP-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CGP-NEXT:    s_cselect_b32 s4, 1, 0
; CGP-NEXT:    v_sub_i32_e32 v9, vcc, v0, v5
...
; CGP-NEXT:    v_mul_hi_u32 v6, s4, v4
...
; GISEL-NEXT:    v_addc_u32_e32 v10, vcc, v5, v9, vcc
; GISEL-NEXT:    v_xor_b32_e32 v5, v4, v9
; GISEL-NEXT:    v_xor_b32_e32 v9, v10, v9
; GISEL-NEXT:    v_cvt_f32_u32_e32 v4, v5
; GISEL-NEXT:    v_cvt_f32_u32_e32 v10, v9
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v17, v4, 0
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v17, v16, v[11:12]
; GISEL-NEXT:    v_mul_hi_u32 v11, v4, v10
...
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v13, v11
; GISEL-NEXT:    v_add_i32_e32 v19, vcc, v4, v10
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, v16, v11, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v17, v19, 0
; GISEL-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v17, v16, v[11:12]
...
; GISEL-NEXT:    v_mul_lo_u32 v12, v15, v10
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v10, v11
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v5, v12, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v9, v16, v[10:11]
; GISEL-NEXT:    v_sub_i32_e32 v10, vcc, v15, v0
; GISEL-NEXT:    v_subb_u32_e64 v11, s[4:5], v14, v12, vcc
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v14, v12
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v11, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v10, v5
; GISEL-NEXT:    v_subb_u32_e32 v0, vcc, v0, v9, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v11, v9
; GISEL-NEXT:    v_sub_i32_e32 v13, vcc, v10, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v12, v1, v8, s[4:5]
; GISEL-NEXT:    v_subbrev_u32_e64 v14, s[4:5], 0, v0, vcc
; GISEL-NEXT:    v_ashrrev_i32_e32 v1, 31, v7
; GISEL-NEXT:    v_add_i32_e64 v6, s[4:5], v6, v1
; GISEL-NEXT:    v_addc_u32_e64 v7, s[4:5], v7, v1, s[4:5]
...
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v14, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v13, v5
; GISEL-NEXT:    v_mac_f32_e32 v1, 0x4f800000, v8
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v14, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v15, v15, v16, s[4:5]
; GISEL-NEXT:    v_subb_u32_e32 v16, vcc, v0, v9, vcc
; GISEL-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v1
; GISEL-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GISEL-NEXT:    v_trunc_f32_e32 v8, v1
; GISEL-NEXT:    v_mac_f32_e32 v0, 0xcf800000, v8
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v3, v7
...
; GISEL-NEXT:    v_mul_hi_u32 v12, v3, v11
...
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v10, v8
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v3, v7
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v5, v8, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v13, v15, 0
; GISEL-NEXT:    v_and_b32_e32 v3, 0xffffff, v6
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v5, v[8:9]
; GISEL-NEXT:    v_mul_hi_u32 v8, v15, v7
; GISEL-NEXT:    v_mul_lo_u32 v6, v5, v7
; GISEL-NEXT:    v_mul_hi_u32 v7, v5, v7
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v15, v[9:10]
...
; GISEL-NEXT:    v_mul_lo_u32 v9, v5, v11
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v7, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; GISEL-NEXT:    v_mul_hi_u32 v9, v5, v11
...
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v6, v7
...
; GISEL-NEXT:    v_mul_lo_u32 v10, v14, v6
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v16, v13, v[8:9]
; GISEL-NEXT:    v_mul_hi_u32 v5, v13, v6
...
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[4:5]
; GISEL-NEXT:    v_mul_hi_u32 v10, v13, v4
; GISEL-NEXT:    v_add_i32_e64 v5, s[4:5], v8, v5
; GISEL-NEXT:    v_mul_lo_u32 v8, v14, v4
; GISEL-NEXT:    v_add_i32_e64 v6, s[4:5], v6, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v11, v9, vcc
