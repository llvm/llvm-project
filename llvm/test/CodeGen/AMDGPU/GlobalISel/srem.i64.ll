...
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v1, v14
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, v19, v12, s[6:7]
...
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, v9, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v19, v19, v21, s[6:7]
; GISEL-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v19
; GISEL-NEXT:    v_mul_lo_u32 v19, v11, v0
...
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v14, v1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v20, v8
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v19, v10
...
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v11, v0, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v16, v11, v[1:2]
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v14, v0
; GISEL-NEXT:    v_xor_b32_e32 v10, v12, v4
...
; GISEL-NEXT:    v_mul_hi_u32 v18, v16, v13
...
; GISEL-NEXT:    v_xor_b32_e32 v20, v1, v9
; GISEL-NEXT:    v_mul_hi_u32 v1, v17, v14
; GISEL-NEXT:    v_xor_b32_e32 v15, v0, v9
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v18, v19
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v13
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v16, v4
; GISEL-NEXT:    v_addc_u32_e32 v0, vcc, v17, v0, vcc
; GISEL-NEXT:    v_mul_lo_u32 v13, v20, v1
; GISEL-NEXT:    v_mul_lo_u32 v14, v15, v0
; GISEL-NEXT:    v_mul_hi_u32 v16, v15, v1
; GISEL-NEXT:    v_mul_hi_u32 v1, v20, v1
; GISEL-NEXT:    v_mov_b32_e32 v4, 0x1000
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; GISEL-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v13, v16
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v16, v20, v0
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
...
; GISEL-NEXT:    v_mul_hi_u32 v16, v20, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v1, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
...
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v20, v13
; GISEL-NEXT:    v_subb_u32_e64 v15, s[4:5], v20, v13, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e32 v18, -1, v18, vcc
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v7, v4
; CGP-NEXT:    v_cvt_u32_f32_e32 v9, v8
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v6, v7, 0
; CGP-NEXT:    v_mov_b32_e32 v8, v5
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v6, v9, v[8:9]
...
; CGP-NEXT:    v_mul_hi_u32 v19, v16, v14
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v15
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v18
; CGP-NEXT:    v_mul_lo_u32 v18, v17, v14
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v18, v13
; CGP-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v19
...
; CGP-NEXT:    v_xor_b32_e32 v20, v1, v8
; CGP-NEXT:    v_mul_hi_u32 v1, v17, v14
; CGP-NEXT:    v_xor_b32_e32 v15, v0, v8
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v18, v19
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v13
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v16, v4
; CGP-NEXT:    v_addc_u32_e32 v0, vcc, v17, v0, vcc
; CGP-NEXT:    v_mul_lo_u32 v13, v20, v1
; CGP-NEXT:    v_mul_lo_u32 v14, v15, v0
; CGP-NEXT:    v_mul_hi_u32 v16, v15, v1
; CGP-NEXT:    v_mul_hi_u32 v1, v20, v1
; CGP-NEXT:    v_mov_b32_e32 v4, 0x1000
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v14
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v16
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v16, v20, v0
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
; CGP-NEXT:    v_mul_hi_u32 v14, v15, v0
...
; CGP-NEXT:    v_mul_hi_u32 v16, v20, v0
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v1, 0
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v14, v13
...
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v20, v13
; CGP-NEXT:    v_subb_u32_e64 v15, s[4:5], v20, v13, vcc
...
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v15
...
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v11, v8
...
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v18, v7
...
; GISEL-NEXT:    v_mul_hi_u32 v15, v14, v10
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v9, v5
...
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v1, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v1, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[6:7]
...
; GISEL-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v19
; GISEL-NEXT:    v_mul_lo_u32 v19, v13, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e32 v15, v15, v0, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v20, v7
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v19, v10
; GISEL-NEXT:    v_mul_hi_u32 v10, v13, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v7, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v14, v0
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v13, v1, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v16, v7, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v12
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v9, v5, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v16, v11, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v5, v4
; GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v7, v[9:10]
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v18, v15, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v5
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v3, v5, vcc
; GISEL-NEXT:    v_xor_b32_e32 v13, v2, v5
; GISEL-NEXT:    v_mul_lo_u32 v2, v11, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v10, v7, v9
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
...
; GISEL-NEXT:    v_mul_hi_u32 v9, v13, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v14, v0
; GISEL-NEXT:    v_xor_b32_e32 v11, v12, v4
...
; GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v6, v7, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v4
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v11, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v8, v12, v[9:10]
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v13, v2
; GISEL-NEXT:    v_subb_u32_e64 v4, s[4:5], v14, v3, vcc
; GISEL-NEXT:    v_sub_i32_e64 v3, s[4:5], v14, v3
