...
; GISEL-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v7, v6, v[15:16]
; GISEL-NEXT:    v_mul_lo_u32 v10, v6, v14
; GISEL-NEXT:    v_mul_hi_u32 v18, v4, v14
; GISEL-NEXT:    v_mul_hi_u32 v19, v6, v14
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v6, 0
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v4, v16, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], 0, v6, v[14:15]
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v18, v0
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v19, v16
; GISEL-NEXT:    v_subb_u32_e64 v15, s[4:5], v19, v16, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v16, -1, v1, s[4:5]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v17, v17, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v18, v18, v1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v11, v6
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v6, v9, v5
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_mul_hi_u32 v1, v8, v5
...
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v8, v0
; GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v9, v1, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v7, v11, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v16
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v14, v17, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v7, v9, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v8, v10
; GISEL-NEXT:    v_ashrrev_i32_e32 v13, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], s6, v11, v[5:6]
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v15, v18, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v3, v9, v7
...
; GISEL-NEXT:    v_mul_hi_u32 v5, v9, v7
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v5, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v15, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v12, v10
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
...
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v10
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v7, v10, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v7, v6, v[14:15]
; CGP-NEXT:    v_mul_lo_u32 v17, v6, v13
; CGP-NEXT:    v_mul_hi_u32 v18, v4, v13
; CGP-NEXT:    v_mul_hi_u32 v19, v6, v13
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], -1, v4, v[15:16]
...
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v15, v14
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v0, v6
...
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v15, v14
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v4, v6, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v15, vcc, v18, v0
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v19, v14
; CGP-NEXT:    v_subb_u32_e64 v16, s[4:5], v19, v14, vcc
; CGP-NEXT:    v_subbrev_u32_e32 v0, vcc, 0, v0, vcc
; CGP-NEXT:    v_sub_i32_e32 v17, vcc, v15, v4
...
; CGP-NEXT:    v_cndmask_b32_e64 v14, -1, v1, s[4:5]
...
; CGP-NEXT:    v_mul_lo_u32 v10, v9, v5
; CGP-NEXT:    v_add_i32_e64 v0, s[4:5], v1, v0
; CGP-NEXT:    v_mul_hi_u32 v1, v8, v5
...
; CGP-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v1, s[4:5], v10, v1
; CGP-NEXT:    v_add_i32_e64 v1, s[4:5], v5, v1
; CGP-NEXT:    v_add_i32_e64 v10, s[4:5], v8, v0
; CGP-NEXT:    v_addc_u32_e64 v9, s[4:5], v9, v1, s[4:5]
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v7, v10, 0
; CGP-NEXT:    v_cndmask_b32_e32 v8, v16, v6, vcc
; CGP-NEXT:    v_ashrrev_i32_e32 v12, 31, v3
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v7, v9, v[1:2]
; CGP-NEXT:    v_xor_b32_e32 v1, v8, v13
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v12
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], -1, v10, v[5:6]
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v3, v12, vcc
; CGP-NEXT:    v_xor_b32_e32 v8, v2, v12
; CGP-NEXT:    v_mul_lo_u32 v2, v9, v0
; CGP-NEXT:    v_mul_lo_u32 v5, v10, v7
; CGP-NEXT:    v_xor_b32_e32 v11, v14, v13
; CGP-NEXT:    v_xor_b32_e32 v14, v3, v12
; CGP-NEXT:    v_mul_hi_u32 v3, v10, v0
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v5
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v3, v9, v7
; CGP-NEXT:    v_mul_hi_u32 v0, v9, v0
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v5, v2
; CGP-NEXT:    v_mul_hi_u32 v5, v10, v7
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v5
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; CGP-NEXT:    v_mul_hi_u32 v5, v9, v7
...
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v11, v13
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v13, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v6
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v7, v14, v2
...
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v7, v14, v2
...
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v8, v2
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v14, v5, vcc
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v14, v5
