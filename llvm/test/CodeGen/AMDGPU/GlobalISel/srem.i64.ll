...
; RUN: llc -global-isel -global-isel-abort=2 -amdgpu-codegenprepare-disable-idiv-expansion=1 -mtriple=amdgcn-mesa-mesa3d -mcpu=hawaii -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=CHECK,GISEL %s
; RUN: llc -global-isel -global-isel-abort=2 -amdgpu-codegenprepare-disable-idiv-expansion=0 -mtriple=amdgcn-mesa-mesa3d -mcpu=hawaii -denormal-fp-math-f32=preserve-sign < %s | FileCheck -check-prefixes=CHECK,CGP %s
...
; CHECK-NEXT:    s_add_u32 s4, s4, s0
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    s_addc_u32 s5, s5, s0
; CHECK-NEXT:    s_xor_b64 s[0:1], s[4:5], s[0:1]
; CHECK-NEXT:    v_cvt_f32_u32_e32 v0, s0
; CHECK-NEXT:    v_cvt_f32_u32_e32 v1, s1
; CHECK-NEXT:    s_sub_u32 s6, 0, s0
; CHECK-NEXT:    s_subb_u32 s7, 0, s1
...
; CHECK-NEXT:    v_mul_lo_u32 v2, s6, v7
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], s6, v8, 0
; CHECK-NEXT:    v_mul_lo_u32 v3, s7, v8
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v1, v2
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v1, v3
; CHECK-NEXT:    v_mul_hi_u32 v9, v8, v0
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v8, v5, 0
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v0, 0
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v7, v5, 0
...
; CHECK-NEXT:    v_mul_lo_u32 v2, s6, v6
; CHECK-NEXT:    v_mul_lo_u32 v3, s7, v5
; CHECK-NEXT:    v_mul_hi_u32 v8, v5, v0
; CHECK-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, v3, v1
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v5, v7, 0
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v0, 0
...
; CHECK-NEXT:    s_ashr_i32 s4, s3, 31
; CHECK-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; CHECK-NEXT:    s_xor_b64 s[2:3], s[2:3], s[4:5]
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], s2, v3, 0
; CHECK-NEXT:    v_mul_hi_u32 v4, s2, v2
; CHECK-NEXT:    v_readfirstlane_b32 s8, v1
; CHECK-NEXT:    v_readfirstlane_b32 s9, v0
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], s3, v2, 0
; CHECK-NEXT:    v_readfirstlane_b32 s6, v4
; CHECK-NEXT:    s_add_u32 s9, s6, s9
; CHECK-NEXT:    s_addc_u32 s8, 0, s8
; CHECK-NEXT:    v_readfirstlane_b32 s10, v1
; CHECK-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], s3, v3, 0
; CHECK-NEXT:    v_readfirstlane_b32 s6, v0
; CHECK-NEXT:    s_add_u32 s6, s9, s6
; CHECK-NEXT:    s_addc_u32 s6, s8, s10
; CHECK-NEXT:    v_readfirstlane_b32 s7, v2
; CHECK-NEXT:    s_addc_u32 s8, s7, 0
; CHECK-NEXT:    v_readfirstlane_b32 s7, v1
; CHECK-NEXT:    s_add_u32 s9, s6, s7
; CHECK-NEXT:    v_mov_b32_e32 v0, s9
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], s0, v0, 0
; CHECK-NEXT:    s_addc_u32 s6, 0, s8
; CHECK-NEXT:    s_mul_i32 s6, s0, s6
; CHECK-NEXT:    v_readfirstlane_b32 s7, v1
; CHECK-NEXT:    s_add_i32 s6, s7, s6
; CHECK-NEXT:    s_mul_i32 s7, s1, s9
; CHECK-NEXT:    s_add_i32 s10, s6, s7
; CHECK-NEXT:    s_sub_i32 s8, s3, s10
; CHECK-NEXT:    v_readfirstlane_b32 s6, v0
; CHECK-NEXT:    s_sub_u32 s2, s2, s6
; CHECK-NEXT:    s_cselect_b64 s[6:7], -1, 0
; CHECK-NEXT:    s_subb_u32 s11, s8, s1
; CHECK-NEXT:    s_sub_u32 s12, s2, s0
; CHECK-NEXT:    s_cselect_b64 s[8:9], -1, 0
; CHECK-NEXT:    s_subb_u32 s13, s11, 0
; CHECK-NEXT:    s_cmp_ge_u32 s13, s1
; CHECK-NEXT:    s_cselect_b32 s14, -1, 0
; CHECK-NEXT:    s_cmp_ge_u32 s12, s0
; CHECK-NEXT:    s_cselect_b32 s15, -1, 0
; CHECK-NEXT:    s_cmp_eq_u32 s13, s1
; CHECK-NEXT:    s_cselect_b32 s14, s15, s14
; CHECK-NEXT:    s_or_b32 s8, s8, s9
; CHECK-NEXT:    s_subb_u32 s8, s11, s1
; CHECK-NEXT:    s_sub_u32 s9, s12, s0
; CHECK-NEXT:    s_subb_u32 s8, s8, 0
; CHECK-NEXT:    s_cmp_lg_u32 s14, 0
; CHECK-NEXT:    s_cselect_b32 s9, s9, s12
; CHECK-NEXT:    s_cselect_b32 s8, s8, s13
; CHECK-NEXT:    s_or_b32 s6, s6, s7
; CHECK-NEXT:    s_subb_u32 s3, s3, s10
; CHECK-NEXT:    s_cmp_ge_u32 s3, s1
; CHECK-NEXT:    s_cselect_b32 s6, -1, 0
; CHECK-NEXT:    s_cmp_ge_u32 s2, s0
; CHECK-NEXT:    s_cselect_b32 s0, -1, 0
; CHECK-NEXT:    s_cmp_eq_u32 s3, s1
; CHECK-NEXT:    s_cselect_b32 s0, s0, s6
; CHECK-NEXT:    s_cmp_lg_u32 s0, 0
; CHECK-NEXT:    s_cselect_b32 s1, s8, s3
; CHECK-NEXT:    s_cselect_b32 s0, s9, s2
; CHECK-NEXT:    s_xor_b64 s[0:1], s[0:1], s[4:5]
