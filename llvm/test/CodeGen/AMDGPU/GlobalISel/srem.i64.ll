...
; CHECK-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
...
; CHECK-NEXT:    s_addc_u32 s3, s5, s6
; CHECK-NEXT:    s_xor_b64 s[2:3], s[2:3], s[6:7]
; CHECK-NEXT:    v_cvt_f32_u32_e32 v0, s2
; CHECK-NEXT:    v_cvt_f32_u32_e32 v1, s3
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    s_xor_b64 s[4:5], s[8:9], s[0:1]
...
; CHECK-NEXT:    v_mul_hi_u32 v2, v0, s11
; CHECK-NEXT:    s_mul_i32 s10, s6, s8
; CHECK-NEXT:    s_add_u32 s10, s10, s12
; CHECK-NEXT:    s_mul_i32 s12, s7, s9
; CHECK-NEXT:    s_add_u32 s10, s12, s10
; CHECK-NEXT:    v_readfirstlane_b32 s12, v2
; CHECK-NEXT:    s_mul_i32 s13, s9, s10
; CHECK-NEXT:    v_mul_hi_u32 v2, v1, s11
; CHECK-NEXT:    v_mul_hi_u32 v0, v0, s10
; CHECK-NEXT:    s_mul_i32 s14, s8, s11
...
; CHECK-NEXT:    s_mul_i32 s8, s2, s8
; CHECK-NEXT:    s_mul_i32 s7, s2, s6
; CHECK-NEXT:    s_add_u32 s8, s8, s9
; CHECK-NEXT:    s_mul_i32 s6, s3, s6
; CHECK-NEXT:    s_add_u32 s8, s6, s8
; CHECK-NEXT:    s_sub_u32 s6, s4, s7
; CHECK-NEXT:    s_cselect_b32 s9, 1, 0
; CHECK-NEXT:    s_subb_u32 s7, s5, s8
...
; CHECK-NEXT:    s_cselect_b32 s8, s8, s4
; CHECK-NEXT:    s_sub_u32 s4, s6, s2
; CHECK-NEXT:    s_cselect_b32 s10, 1, 0
; CHECK-NEXT:    s_cmp_lg_u32 s9, 0
; CHECK-NEXT:    s_subb_u32 s9, s5, s3
; CHECK-NEXT:    s_cmp_lg_u32 s10, 0
; CHECK-NEXT:    s_subb_u32 s5, s9, 0
; CHECK-NEXT:    s_cmp_ge_u32 s5, s3
; CHECK-NEXT:    s_cselect_b32 s11, -1, 0
; CHECK-NEXT:    s_cmp_ge_u32 s4, s2
; CHECK-NEXT:    s_cselect_b32 s12, -1, 0
; CHECK-NEXT:    s_cmp_eq_u32 s5, s3
; CHECK-NEXT:    s_cselect_b32 s11, s12, s11
; CHECK-NEXT:    s_sub_u32 s2, s4, s2
; CHECK-NEXT:    s_cselect_b32 s12, 1, 0
; CHECK-NEXT:    s_cmp_lg_u32 s10, 0
; CHECK-NEXT:    s_subb_u32 s3, s9, s3
; CHECK-NEXT:    s_cmp_lg_u32 s12, 0
; CHECK-NEXT:    s_subb_u32 s3, s3, 0
; CHECK-NEXT:    s_cmp_lg_u32 s11, 0
; CHECK-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[4:5]
; CHECK-NEXT:    s_cmp_lg_u32 s8, 0
; CHECK-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[6:7]
; CHECK-NEXT:    s_xor_b64 s[2:3], s[2:3], s[0:1]
; CHECK-NEXT:    s_sub_u32 s0, s2, s0
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    s_branch .LBB1_3
; CHECK-NEXT:  .LBB1_2:
; CHECK-NEXT:    v_cvt_f32_u32_e32 v0, s4
; CHECK-NEXT:    s_sub_i32 s1, 0, s4
; CHECK-NEXT:    s_mov_b32 s7, s0
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; CHECK-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; CHECK-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; CHECK-NEXT:    v_readfirstlane_b32 s1, v0
; CHECK-NEXT:    s_mul_i32 s1, s1, s4
; CHECK-NEXT:    s_sub_i32 s1, s2, s1
; CHECK-NEXT:    s_cmp_ge_u32 s1, s4
; CHECK-NEXT:    s_cselect_b32 s2, 1, 0
; CHECK-NEXT:    s_sub_i32 s5, s1, s4
; CHECK-NEXT:    s_cmp_lg_u32 s2, 0
; CHECK-NEXT:    s_cselect_b32 s6, s5, s1
; CHECK-NEXT:    s_cmp_ge_u32 s6, s4
; CHECK-NEXT:    s_cselect_b32 s1, 1, 0
; CHECK-NEXT:    s_sub_i32 s2, s6, s4
; CHECK-NEXT:    s_cmp_lg_u32 s1, 0
; CHECK-NEXT:    s_cselect_b64 s[0:1], s[2:3], s[6:7]
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    s_branch .LBB1_3
; CHECK-NEXT:  .LBB1_3:
  %result = srem i64 %num, %den
