...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v15, v[5:6]
; GISEL-NEXT:    v_mul_lo_u32 v5, v15, v4
; GISEL-NEXT:    v_mul_hi_u32 v16, v12, v4
...
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v16, v4
...
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v12, v4
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v16, 0
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v15, v5, vcc
; GISEL-NEXT:    v_mov_b32_e32 v4, v11
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v5, v[4:5]
...
; GISEL-NEXT:    v_mul_lo_u32 v0, v5, v10
...
; GISEL-NEXT:    v_mul_lo_u32 v1, v5, v11
...
; GISEL-NEXT:    v_mul_lo_u32 v5, v14, v0
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v8, v5, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v13, v10
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v8, v10, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v9, v5, v[10:11]
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v12, v0
; GISEL-NEXT:    v_subb_u32_e64 v12, s[4:5], v14, v10, vcc
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v14, v10
...
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v12, v9
; GISEL-NEXT:    v_subb_u32_e32 v10, vcc, v0, v9, vcc
; GISEL-NEXT:    v_ashrrev_i32_e32 v0, 31, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v13, v1, v5, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v6, v0
; GISEL-NEXT:    v_addc_u32_e32 v6, vcc, v7, v0, vcc
; GISEL-NEXT:    v_xor_b32_e32 v5, v1, v0
; GISEL-NEXT:    v_xor_b32_e32 v6, v6, v0
; GISEL-NEXT:    v_cvt_f32_u32_e32 v0, v5
; GISEL-NEXT:    v_cvt_f32_u32_e32 v1, v6
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, v11, v8
...
; GISEL-NEXT:    v_mul_hi_u32 v7, v20, v7
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v7, v1
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v17, v0
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v20, v1, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v18, v14, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v11, v4
; GISEL-NEXT:    v_ashrrev_i32_e32 v11, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v19, v9, v[7:8]
...
; GISEL-NEXT:    v_mul_lo_u32 v3, v14, v7
...
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v5, v7, v[0:1]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v4
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v9, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v6, v10, v[7:8]
...
; GISEL-NEXT:    v_mac_f32_e32 v4, 0x4f800000, v7
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v4, v4
; GISEL-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[6:7], v13, v7, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v4, v7, v9
; GISEL-NEXT:    v_mul_hi_u32 v15, v12, v9
...
; GISEL-NEXT:    v_mul_lo_u32 v9, v11, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v0, v7
; GISEL-NEXT:    v_mul_hi_u32 v10, v14, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v5, v12, 0
; GISEL-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v9, v7
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, v10, v7
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[6:7], v5, v7, v[1:2]
