...
; GISEL-NEXT:    v_subbrev_u32_e64 v17, s[4:5], 0, v9, vcc
; GISEL-NEXT:    v_mac_f32_e32 v0, 0x4f800000, v1
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v17, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v16, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v17, v7
; GISEL-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v18, v10, v1, s[4:5]
; GISEL-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GISEL-NEXT:    v_trunc_f32_e32 v1, v1
; GISEL-NEXT:    v_mac_f32_e32 v0, 0xcf800000, v1
; GISEL-NEXT:    v_cvt_u32_f32_e32 v19, v0
; GISEL-NEXT:    v_sub_i32_e64 v21, s[4:5], 0, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v20, v1
; GISEL-NEXT:    v_subb_u32_e64 v22, s[4:5], 0, v8, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v21, v19, 0
; GISEL-NEXT:    v_subb_u32_e32 v7, vcc, v9, v7, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v21, v20, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v16, v5
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v22, v19, v[9:10]
; GISEL-NEXT:    v_subbrev_u32_e32 v5, vcc, 0, v7, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; GISEL-NEXT:    v_cndmask_b32_e32 v7, v16, v1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v1, v20, v0
; GISEL-NEXT:    v_mul_lo_u32 v9, v19, v11
; GISEL-NEXT:    v_mul_hi_u32 v10, v19, v0
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v10, v20, v11
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_mul_hi_u32 v9, v19, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v10, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; GISEL-NEXT:    v_mul_hi_u32 v10, v20, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v19, v0
; GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v20, v1, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v21, v16, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v7, v13, v7, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v21, v17, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v7, v4
; GISEL-NEXT:    v_ashrrev_i32_e32 v7, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v22, v16, v[9:10]
...
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v3, v17, v11
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v9
; GISEL-NEXT:    v_mul_hi_u32 v9, v17, v11
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v9, v2
