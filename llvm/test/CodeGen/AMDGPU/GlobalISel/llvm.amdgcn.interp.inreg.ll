...
; GFX11-FAKE16-NEXT:    lds_param_load v0, attr0.x wait_vdst:15
...
; GFX11-FAKE16-NEXT:    v_interp_p10_f16_f32 v3, v0, v1, v0 wait_exp:0
; GFX11-FAKE16-NEXT:    v_interp_p10_f16_f32 v1, v0, v1, v0 op_sel:[1,0,1,0] wait_exp:7
; GFX11-FAKE16-NEXT:    v_interp_p2_f16_f32 v3, v0, v2, v3 wait_exp:7
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_interp_p2_f16_f32 v0, v0, v2, v1 op_sel:[1,0,0,0] wait_exp:7
...
; GFX12-FAKE16-NEXT:    ds_param_load v0, attr0.x wait_va_vdst:15 wait_vm_vsrc:1
; GFX12-FAKE16-NEXT:    s_mov_b32 exec_lo, s3
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v2, s1
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-FAKE16-NEXT:    v_interp_p10_f16_f32 v3, v0, v1, v0 wait_exp:0
; GFX12-FAKE16-NEXT:    v_interp_p10_f16_f32 v1, v0, v1, v0 op_sel:[1,0,1,0] wait_exp:7
; GFX12-FAKE16-NEXT:    v_interp_p2_f16_f32 v3, v0, v2, v3 wait_exp:7
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_interp_p2_f16_f32 v0, v0, v2, v1 op_sel:[1,0,0,0] wait_exp:7
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v2, s1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_interp_p10_rtz_f16_f32 v3, v0, v1, v0 wait_exp:0
; GFX11-FAKE16-NEXT:    v_interp_p10_rtz_f16_f32 v1, v0, v1, v0 op_sel:[1,0,1,0] wait_exp:7
; GFX11-FAKE16-NEXT:    v_interp_p2_rtz_f16_f32 v3, v0, v2, v3 wait_exp:7
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_interp_p2_rtz_f16_f32 v0, v0, v2, v1 op_sel:[1,0,0,0] wait_exp:7
; GFX11-FAKE16-NEXT:    v_add_f16_e32 v0, v3, v0
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v2, s1
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-FAKE16-NEXT:    v_interp_p10_rtz_f16_f32 v3, v0, v1, v0 wait_exp:0
; GFX12-FAKE16-NEXT:    v_interp_p10_rtz_f16_f32 v1, v0, v1, v0 op_sel:[1,0,1,0] wait_exp:7
; GFX12-FAKE16-NEXT:    v_interp_p2_rtz_f16_f32 v3, v0, v2, v3 wait_exp:7
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_interp_p2_rtz_f16_f32 v0, v0, v2, v1 op_sel:[1,0,0,0] wait_exp:7
; GFX12-FAKE16-NEXT:    v_add_f16_e32 v0, v3, v0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
  %p0 = call float @llvm.amdgcn.lds.param.load(i32 0, i32 0, i32 %m0)
