...
; RUN: llc -global-isel -mtriple=amdgpu8.03-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -global-isel -mtriple=amdgpu10.10-amd-amdpal -o - < %s | FileCheck --check-prefixes=GCN %s
