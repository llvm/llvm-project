...
; GPRIDX-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GPRIDX-NEXT:    s_mov_b32 s6, 0
; GPRIDX-NEXT:    s_mov_b32 s7, 0x40080000
; GPRIDX-NEXT:    s_mov_b32 s4, 0
; GPRIDX-NEXT:    s_mov_b32 s5, 0x40140000
; GPRIDX-NEXT:    s_waitcnt lgkmcnt(0)
; GPRIDX-NEXT:    s_cmp_eq_u32 s2, 1
; GPRIDX-NEXT:    s_cselect_b64 s[8:9], 2.0, 1.0
; GPRIDX-NEXT:    s_cmp_eq_u32 s2, 2
; GPRIDX-NEXT:    s_cselect_b64 s[6:7], s[6:7], s[8:9]
; GPRIDX-NEXT:    s_cmp_eq_u32 s2, 3
; GPRIDX-NEXT:    s_cselect_b64 s[6:7], 4.0, s[6:7]
; GPRIDX-NEXT:    s_cmp_eq_u32 s2, 4
; GPRIDX-NEXT:    s_cselect_b64 s[2:3], s[4:5], s[6:7]
; GPRIDX-NEXT:    v_mov_b32_e32 v0, s2
; GPRIDX-NEXT:    s_mov_b32 s1, 0
...
; MOVREL-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; MOVREL-NEXT:    s_add_i32 s12, s12, s17
; MOVREL-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; MOVREL-NEXT:    s_mov_b32 s6, 0
; MOVREL-NEXT:    s_mov_b32 s7, 0x40080000
; MOVREL-NEXT:    s_waitcnt lgkmcnt(0)
; MOVREL-NEXT:    s_cmp_eq_u32 s2, 1
; MOVREL-NEXT:    s_cselect_b64 s[8:9], 2.0, 1.0
; MOVREL-NEXT:    s_cmp_eq_u32 s2, 2
; MOVREL-NEXT:    s_mov_b32 s4, 0
; MOVREL-NEXT:    s_cselect_b64 s[6:7], s[6:7], s[8:9]
; MOVREL-NEXT:    s_cmp_eq_u32 s2, 3
; MOVREL-NEXT:    s_mov_b32 s5, 0x40140000
; MOVREL-NEXT:    s_cselect_b64 s[6:7], 4.0, s[6:7]
; MOVREL-NEXT:    s_cmp_eq_u32 s2, 4
; MOVREL-NEXT:    s_mov_b32 s1, 0
; MOVREL-NEXT:    s_cselect_b64 s[2:3], s[4:5], s[6:7]
...
; GFX10-NEXT:    s_mov_b32 s7, 0x40140000
; GFX10-NEXT:    s_cselect_b64 s[4:5], 4.0, s[4:5]
; GFX10-NEXT:    s_cmp_eq_u32 s2, 4
; GFX10-NEXT:    s_cselect_b64 s[2:3], s[6:7], s[4:5]
...
; GFX11-NEXT:     wavefront_sgpr_count = 8
...
; GFX11-NEXT:    s_mov_b32 s7, 0x40140000
; GFX11-NEXT:    s_cselect_b64 s[4:5], 4.0, s[4:5]
; GFX11-NEXT:    s_cmp_eq_u32 s2, 4
; GFX11-NEXT:    s_cselect_b64 s[2:3], s[6:7], s[4:5]
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_cmp_eq_u32 s2, 1
; GFX10-NEXT:    s_cselect_b32 s1, 2.0, 1.0
; GFX10-NEXT:    s_cmp_eq_u32 s2, 2
; GFX10-NEXT:    s_cselect_b32 s1, 0x40400000, s1
; GFX10-NEXT:    s_cmp_eq_u32 s2, 3
; GFX10-NEXT:    s_cselect_b32 s1, 4.0, s1
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_cmp_eq_u32 s2, 1
; GFX11-NEXT:    s_cselect_b32 s1, 2.0, 1.0
; GFX11-NEXT:    s_cmp_eq_u32 s2, 2
; GFX11-NEXT:    s_cselect_b32 s1, 0x40400000, s1
; GFX11-NEXT:    s_cmp_eq_u32 s2, 3
; GFX11-NEXT:    s_cselect_b32 s1, 4.0, s1
...
; GPRIDX-NEXT:    s_cmp_eq_u32 s2, 3
; GPRIDX-NEXT:    s_cselect_b64 s[2:3], 4.0, s[4:5]
; GPRIDX-NEXT:    v_mov_b32_e32 v0, s2
; GPRIDX-NEXT:    v_mov_b32_e32 v1, s3
; GPRIDX-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GPRIDX-NEXT:    s_endpgm
...
; MOVREL-NEXT:    s_cmp_eq_u32 s2, 3
; MOVREL-NEXT:    s_mov_b32 s1, 0
; MOVREL-NEXT:    s_cselect_b64 s[2:3], 4.0, s[4:5]
; MOVREL-NEXT:    v_mov_b32_e32 v0, s2
; MOVREL-NEXT:    v_mov_b32_e32 v3, s1
; MOVREL-NEXT:    s_mov_b32 flat_scratch_lo, s13
; MOVREL-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX10-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[6:7]
; GFX10-NEXT:    s_cmp_eq_u32 s2, 3
; GFX10-NEXT:    s_cselect_b64 s[2:3], 4.0, s[4:5]
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-NEXT:    global_store_dwordx2 v2, v[0:1], s[0:1]
; GFX10-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[6:7]
; GFX11-NEXT:    s_cmp_eq_u32 s2, 3
; GFX11-NEXT:    s_cselect_b64 s[2:3], 4.0, s[4:5]
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX11-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX11-NEXT:    s_endpgm
entry:
