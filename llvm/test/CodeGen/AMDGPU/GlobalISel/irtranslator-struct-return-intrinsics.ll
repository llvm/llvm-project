...
define amdgpu_ps void @test_div_scale(float %arg0, float %arg1) {
  ...
  ; CHECK-NEXT:   G_STORE [[INT]](f32), [[DEF]](p1) :: (store (f32) into `ptr addrspace(1) undef`, addrspace 1)
  ; CHECK-NEXT:   G_STORE [[SEXT]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) undef`, addrspace 1)
