...
; RUN: llc -global-isel -O0 -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck -check-prefix=WAVE64 %s
; RUN: llc -global-isel -O0 -mtriple=amdgpu10.31-amd-amdhsa < %s | FileCheck -check-prefix=WAVE32 %s
