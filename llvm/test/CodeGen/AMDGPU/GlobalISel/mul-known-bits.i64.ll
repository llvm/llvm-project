...
; RUN:  llc -mtriple=amdgpu10.10 -global-isel=1 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX10 %s
; RUN:  llc -mtriple=amdgpu11.00 -global-isel=1 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX11 %s
...
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v7, s[0:1]
; GFX10-NEXT:    global_load_dwordx2 v[4:5], v7, s[2:3]
...
; GFX11-NEXT:    global_load_b64 v[2:3], v9, s[0:1]
; GFX11-NEXT:    global_load_b64 v[4:5], v9, s[2:3]
...
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dword v4, v1, s[2:3]
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v1, s[6:7]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s2, v4, v2, 0
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s2, v4, v3, v[1:2]
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b32 v6, v1, s[2:3]
; GFX11-NEXT:    global_load_b64 v[2:3], v1, s[4:5]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], null, v6, v2, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mad_u64_u32 v[4:5], null, v6, v3, v[1:2]
