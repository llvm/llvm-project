...
; GFX10-NEXT:    global_load_dword v5, v3, s[6:7]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s2, v0, v5, 0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s2, v1, v5, v[3:4]
...
; GFX11-NEXT:    global_load_b32 v7, v2, s[4:5]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    ; implicit-def: $vgpr4
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_dword v5, v2, s[2:3]
; GFX10-NEXT:    global_load_dwordx2 v[0:1], v3, s[6:7]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s2, v5, v0, 0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s2, v5, v1, v[3:4]
; GFX10-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    global_store_dwordx2 v0, v[2:3], s[0:1]
; GFX10-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b32 v7, v1, s[2:3]
...
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s2, v0, v3, v[5:6]
