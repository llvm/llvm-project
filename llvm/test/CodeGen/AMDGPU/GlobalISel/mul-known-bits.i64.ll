...
; RUN:  llc -mtriple=amdgcn -mcpu=gfx1010 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX10 %s
; RUN:  llc -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -allow-deprecated-dag-overlap -check-prefixes=GFX11 %s
...
; GFX10-NEXT:    v_mul_lo_u32 v5, v1, v2
; GFX10-NEXT:    v_mul_lo_u32 v3, v0, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s0, v0, v2, 0
; GFX10-NEXT:    v_add3_u32 v1, v1, v3, v5
...
; GFX11-NEXT:    global_load_b64 v[0:1], v5, s[0:1]
; GFX11-NEXT:    global_load_b64 v[2:3], v5, s[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mul_lo_u32 v1, v1, v2
; GFX11-NEXT:    v_mul_lo_u32 v6, v0, v3
; GFX11-NEXT:    v_mad_u64_u32 v[3:4], null, v0, v2, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add3_u32 v4, v4, v6, v1
; GFX11-NEXT:    global_store_b64 v5, v[3:4], s[2:3]
; GFX11-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dword v1, v0, s[2:3] offset:4
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b32 v1, v0, s[2:3] offset:4
...
; GFX10-NEXT:    global_load_dword v2, v0, s[6:7] offset:4
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    global_load_b32 v0, v0, s[4:5] offset:4
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_mul_lo_u32 v3, v0, v3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s2, v0, v2, 0
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX11-NEXT:    v_and_b32_e32 v1, 0xf00f, v1
...
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_cmpx_eq_u64_e32 0, v[2:3]
