...
; RUN: llc -global-isel -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GCN,WAVE64 %s
; RUN: llc -global-isel -mtriple=amdgpu10.31 < %s | FileCheck -check-prefixes=GCN,WAVE32 %s
