...
; GFX11-NEXT:    v_cmp_lt_i64_e64 s1, s[4:5], s[0:1]
; GFX11-NEXT:    s_ashr_i32 s0, s5, 31
; GFX11-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX11-NEXT:    s_xor_b32 s2, s2, s1
; GFX11-NEXT:    s_cmp_lg_u32 s3, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v0, s0, s2
; GFX11-NEXT:    s_addc_u32 s1, s0, 0x80000000
...
; GFX11-NEXT:    v_cmp_lt_i64_e64 s1, s[8:9], s[0:1]
; GFX11-NEXT:    s_ashr_i32 s0, s9, 31
; GFX11-NEXT:    s_xor_b32 s8, s4, s1
; GFX11-NEXT:    s_cmp_lg_u32 s11, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v0, s0, s8
; GFX11-NEXT:    s_addc_u32 s1, s0, s10
...
; GFX11-NEXT:    s_cmp_lg_u32 s3, 0
; GFX11-NEXT:    s_addc_u32 s3, s0, 0x80000000
...
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, 0, v3, vcc_lo
; GFX11-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, 0, v2
; GFX11-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, 0, v3, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0x80000000, v3, vcc_lo
...
; GFX11-NEXT:    v_ashrrev_i32_e32 v1, 31, v7
; GFX11-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, 0, v0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, 0x80000000, v1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v4, v1, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v5, v2, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v6, v3, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v7, v8, s0
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i128 @llvm.sadd.sat.i128(i128 %lhs, i128 %rhs)
  %cast = bitcast i128 %result to <4 x float>
  ret <4 x float> %cast
...
; GFX11-NEXT:    s_ashr_i32 s0, s17, 31
; GFX11-NEXT:    s_cmp_lg_u32 s1, 0
; GFX11-NEXT:    s_addc_u32 s1, s0, 0
; GFX11-NEXT:    v_xor_b32_e32 v0, v1, v0
...
; GFX11-NEXT:    s_and_b32 s3, s3, 1
; GFX11-NEXT:    s_cmp_lg_u32 s3, 0
; GFX11-NEXT:    s_addc_u32 s3, s0, s10
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v1, s0, vcc_lo
...
; GFX11-NEXT:    s_cselect_b32 s8, 1, 0
; GFX11-NEXT:    v_cmp_lt_u64_e64 s3, s[0:1], s[4:5]
; GFX11-NEXT:    s_and_b32 s8, s8, 1
; GFX11-NEXT:    v_cmp_lt_i64_e64 s4, s[14:15], 0
; GFX11-NEXT:    s_cmp_lg_u32 s8, 0
; GFX11-NEXT:    s_addc_u32 s8, s6, s14
; GFX11-NEXT:    s_cselect_b32 s9, 1, 0
; GFX11-NEXT:    v_dual_mov_b32 v2, s16 :: v_dual_mov_b32 v7, s8
; GFX11-NEXT:    s_and_b32 s9, s9, 1
; GFX11-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s3
; GFX11-NEXT:    s_cmp_lg_u32 s9, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v2, s2, vcc_lo
; GFX11-NEXT:    s_addc_u32 s9, s7, s15
; GFX11-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s4
; GFX11-NEXT:    s_cmp_eq_u64 s[8:9], s[6:7]
; GFX11-NEXT:    v_cmp_lt_i64_e64 s3, s[8:9], s[6:7]
; GFX11-NEXT:    s_cselect_b32 s2, 1, 0
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 s2, 0, s3
; GFX11-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc_lo
; GFX11-NEXT:    s_mov_b32 s3, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v6, 0, s2
; GFX11-NEXT:    s_ashr_i32 s2, s9, 31
; GFX11-NEXT:    s_cmp_lg_u32 s3, 0
; GFX11-NEXT:    v_mov_b32_e32 v6, s1
; GFX11-NEXT:    s_addc_u32 s3, s2, 0
...
; GFX11-NEXT:    s_addc_u32 s4, s2, 0
; GFX11-NEXT:    s_cselect_b32 s5, 1, 0
; GFX11-NEXT:    s_and_b32 s5, s5, 1
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v4
; GFX11-NEXT:    s_cmp_lg_u32 s5, 0
; GFX11-NEXT:    s_addc_u32 s1, s2, s10
