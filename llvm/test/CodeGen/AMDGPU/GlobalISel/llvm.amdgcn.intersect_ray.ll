...
; GFX10-LABEL: image_bvh_intersect_ray_vgpr_descr:
; GFX10:       ; %bb.0:
...
; GFX10-NEXT:    v_mov_b32_e32 v19, v4
; GFX10-NEXT:    v_mov_b32_e32 v20, v5
; GFX10-NEXT:    v_mov_b32_e32 v21, v6
; GFX10-NEXT:    v_mov_b32_e32 v22, v7
; GFX10-NEXT:    v_mov_b32_e32 v23, v8
; GFX10-NEXT:    v_mov_b32_e32 v24, v9
; GFX10-NEXT:    v_mov_b32_e32 v25, v10
; GFX10-NEXT:    s_mov_b32 s1, exec_lo
; GFX10-NEXT:  .LBB6_1: ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    v_readfirstlane_b32 s4, v11
; GFX10-NEXT:    v_readfirstlane_b32 s5, v12
; GFX10-NEXT:    v_readfirstlane_b32 s6, v13
; GFX10-NEXT:    v_readfirstlane_b32 s7, v14
; GFX10-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[11:12]
; GFX10-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[13:14]
; GFX10-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX10-NEXT:    s_and_saveexec_b32 s0, s0
; GFX10-NEXT:    image_bvh_intersect_ray v[0:3], v[15:25], s[4:7]
; GFX10-NEXT:    ; implicit-def: $vgpr11
; GFX10-NEXT:    ; implicit-def: $vgpr15
; GFX10-NEXT:    ; implicit-def: $vgpr16
; GFX10-NEXT:    ; implicit-def: $vgpr17
; GFX10-NEXT:    ; implicit-def: $vgpr18
; GFX10-NEXT:    ; implicit-def: $vgpr19
; GFX10-NEXT:    ; implicit-def: $vgpr20
; GFX10-NEXT:    ; implicit-def: $vgpr21
; GFX10-NEXT:    ; implicit-def: $vgpr22
; GFX10-NEXT:    ; implicit-def: $vgpr23
; GFX10-NEXT:    ; implicit-def: $vgpr24
; GFX10-NEXT:    ; implicit-def: $vgpr25
; GFX10-NEXT:    ; implicit-def: $vgpr13_vgpr14
...
; GFX10-LABEL: image_bvh_intersect_ray_a16_vgpr_descr:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    v_mov_b32_e32 v18, v5
; GFX10-NEXT:    v_mov_b32_e32 v17, v4
; GFX10-NEXT:    v_mov_b32_e32 v16, v3
; GFX10-NEXT:    v_mov_b32_e32 v15, v2
; GFX10-NEXT:    v_mov_b32_e32 v14, v1
; GFX10-NEXT:    v_mov_b32_e32 v13, v0
; GFX10-NEXT:    v_perm_b32 v19, v7, v6, 0x5040100
; GFX10-NEXT:    v_alignbit_b32 v20, v8, v7, 16
; GFX10-NEXT:    s_mov_b32 s4, exec_lo
; GFX10-NEXT:    s_mov_b32 s5, s4
; GFX10-NEXT:  .LBB7_1: ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    v_readfirstlane_b32 s0, v9
; GFX10-NEXT:    v_readfirstlane_b32 s1, v10
; GFX10-NEXT:    v_readfirstlane_b32 s2, v11
; GFX10-NEXT:    v_readfirstlane_b32 s3, v12
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[0:1], v[9:10]
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[2:3], v[11:12]
; GFX10-NEXT:    image_bvh_intersect_ray v[0:3], v[13:20], s[0:3] a16
; GFX10-NEXT:    s_andn2_wrexec_b32 s5, s5
; GFX10-NEXT:    ; implicit-def: $vgpr9_vgpr10_vgpr11_vgpr12
; GFX10-NEXT:    ; implicit-def: $vgpr13
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-LABEL: image_bvh_intersect_ray_a16_vgpr_descr:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v19, v5 :: v_dual_mov_b32 v20, v8
...
; GFX11-TRUE16-NEXT:  .LBB7_1: ; =>This Inner Loop Header: Depth=1
...
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr13_vgpr14_vgpr15
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr18_vgpr19_vgpr20
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr11_vgpr12
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_cbranch_execnz .LBB7_1
...
; GFX10-LABEL: image_bvh64_intersect_ray_vgpr_descr:
; GFX10:       ; %bb.0:
...
; GFX10-NEXT:    v_mov_b32_e32 v22, v6
; GFX10-NEXT:    v_mov_b32_e32 v23, v7
; GFX10-NEXT:    v_mov_b32_e32 v24, v8
; GFX10-NEXT:    v_mov_b32_e32 v25, v9
; GFX10-NEXT:    v_mov_b32_e32 v26, v10
; GFX10-NEXT:    v_mov_b32_e32 v27, v11
; GFX10-NEXT:    s_mov_b32 s1, exec_lo
; GFX10-NEXT:  .LBB8_1: ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    v_readfirstlane_b32 s4, v12
; GFX10-NEXT:    v_readfirstlane_b32 s5, v13
; GFX10-NEXT:    v_readfirstlane_b32 s6, v14
; GFX10-NEXT:    v_readfirstlane_b32 s7, v15
; GFX10-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[12:13]
; GFX10-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[14:15]
; GFX10-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX10-NEXT:    s_and_saveexec_b32 s0, s0
; GFX10-NEXT:    image_bvh64_intersect_ray v[0:3], v[16:27], s[4:7]
...
; GFX10-NEXT:    ; implicit-def: $vgpr24
; GFX10-NEXT:    ; implicit-def: $vgpr25
; GFX10-NEXT:    ; implicit-def: $vgpr26
; GFX10-NEXT:    ; implicit-def: $vgpr27
...
; GFX10-LABEL: image_bvh64_intersect_ray_a16_vgpr_descr:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    v_mov_b32_e32 v20, v6
; GFX10-NEXT:    v_mov_b32_e32 v19, v5
; GFX10-NEXT:    v_mov_b32_e32 v18, v4
; GFX10-NEXT:    v_mov_b32_e32 v17, v3
; GFX10-NEXT:    v_mov_b32_e32 v16, v2
; GFX10-NEXT:    v_mov_b32_e32 v15, v1
; GFX10-NEXT:    v_mov_b32_e32 v14, v0
; GFX10-NEXT:    v_perm_b32 v21, v8, v7, 0x5040100
; GFX10-NEXT:    v_alignbit_b32 v22, v9, v8, 16
; GFX10-NEXT:    s_mov_b32 s4, exec_lo
; GFX10-NEXT:    s_mov_b32 s5, s4
; GFX10-NEXT:  .LBB9_1: ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    v_readfirstlane_b32 s0, v10
; GFX10-NEXT:    v_readfirstlane_b32 s1, v11
; GFX10-NEXT:    v_readfirstlane_b32 s2, v12
; GFX10-NEXT:    v_readfirstlane_b32 s3, v13
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[0:1], v[10:11]
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[2:3], v[12:13]
; GFX10-NEXT:    image_bvh64_intersect_ray v[0:3], v[14:22], s[0:3] a16
; GFX10-NEXT:    s_andn2_wrexec_b32 s5, s5
; GFX10-NEXT:    ; implicit-def: $vgpr10_vgpr11_vgpr12_vgpr13
; GFX10-NEXT:    ; implicit-def: $vgpr14
; GFX10-NEXT:    ; implicit-def: $vgpr15
; GFX10-NEXT:    ; implicit-def: $vgpr16
; GFX10-NEXT:    ; implicit-def: $vgpr17
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-LABEL: image_bvh64_intersect_ray_a16_vgpr_descr:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v15, v4 :: v_dual_mov_b32 v16, v5
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s1, exec_lo
; GFX11-TRUE16-NEXT:  .LBB9_1: ; =>This Inner Loop Header: Depth=1
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s4, v10
...
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr17_vgpr18
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr19
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr14_vgpr15_vgpr16
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr4_vgpr5_vgpr6
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr12_vgpr13
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX10-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX10-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX10-NEXT:    v_mov_b32_e32 v5, 0x40400000
; GFX10-NEXT:    v_mov_b32_e32 v6, 4.0
; GFX10-NEXT:    v_mov_b32_e32 v7, 0x40a00000
; GFX10-NEXT:    v_mov_b32_e32 v8, 0x40c00000
; GFX10-NEXT:    v_mov_b32_e32 v9, 0x40e00000
; GFX10-NEXT:    v_mov_b32_e32 v10, 0x41000000
...
; GFX10-NEXT:    flat_load_dword v1, v[2:3]
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX10-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX10-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[4:7]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-LABEL: image_bvh_intersect_ray_a16_nsa_reassign:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; GFX10-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX10-NEXT:    v_mov_b32_e32 v7, 0x48004700
; GFX10-NEXT:    v_mov_b32_e32 v6, 0x46004500
; GFX10-NEXT:    v_mov_b32_e32 v5, 0x44004200
; GFX10-NEXT:    v_mov_b32_e32 v4, 2.0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v0, s0, s0, v2
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, null, s1, 0, s0
; GFX10-NEXT:    v_add_co_u32 v2, s0, s2, v2
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, null, s3, 0, s0
; GFX10-NEXT:    flat_load_dword v0, v[0:1]
; GFX10-NEXT:    flat_load_dword v1, v[2:3]
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-NEXT:    v_mov_b32_e32 v3, 1.0
; GFX10-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-NEXT:    image_bvh_intersect_ray v[0:3], v[0:7], s[4:7] a16
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX10-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_mov_b32_e32 v4, 1.0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v0, s4, s6, v0
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, null, s7, 0, s4
; GFX10-NEXT:    flat_load_dword v2, v[0:1]
; GFX10-NEXT:    v_bfrev_b32_e32 v1, 4.0
