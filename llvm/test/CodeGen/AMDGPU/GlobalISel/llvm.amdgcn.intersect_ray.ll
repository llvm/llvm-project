...
; GFX1013-NEXT:    s_mov_b32 s0, 0
; GFX1013-NEXT:    v_lshlrev_b32_e32 v6, 2, v0
; GFX1013-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-NEXT:    s_mov_b32 s9, s0
; GFX1013-NEXT:    s_mov_b32 s11, s0
...
; GFX11-NEXT:    s_mov_b32 s10, 2.0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s1, s8
; GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-NEXT:    s_mov_b32 s3, s8
; GFX11-NEXT:    s_mov_b32 s9, 1.0
...
; GFX11-NEXT:    s_mov_b32 s1, 4.0
; GFX11-NEXT:    s_mov_b32 s0, 0x40400000
...
; GFX11-NEXT:    s_mov_b32 s2, 0x40a00000
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v5, s2
...
; GFX11-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX11-NEXT:    s_mov_b32 s0, 0x42004600
; GFX11-NEXT:    s_mov_b32 s1, 0x44004700
; GFX11-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
...
; GFX11-NEXT:    s_mov_b32 s2, 0x45004800
; GFX11-NEXT:    v_dual_mov_b32 v0, s8 :: v_dual_mov_b32 v5, s2
; GFX11-NEXT:    v_dual_mov_b32 v1, s9 :: v_dual_mov_b32 v2, s10
; GFX11-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v3, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
