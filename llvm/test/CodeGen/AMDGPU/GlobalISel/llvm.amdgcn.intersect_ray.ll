...
; GFX1013-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX1013-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX1013-NEXT:    s_movk_i32 s5, 0x4400
; GFX1013-NEXT:    s_movk_i32 s9, 0x4600
; GFX1013-NEXT:    s_bfe_u32 s5, s5, 0x100000
; GFX1013-NEXT:    s_movk_i32 s4, 0x4500
; GFX1013-NEXT:    s_lshl_b32 s5, s5, 16
...
; GFX1013-NEXT:    v_mov_b32_e32 v0, s6
; GFX1013-NEXT:    v_mov_b32_e32 v1, s7
; GFX1013-NEXT:    s_movk_i32 s6, 0x4200
; GFX1013-NEXT:    s_movk_i32 s7, 0x4800
; GFX1013-NEXT:    s_bfe_u32 s6, s6, 0x100000
; GFX1013-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX1013-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX1013-NEXT:    s_or_b32 s5, s6, s5
; GFX1013-NEXT:    s_bfe_u32 s6, s9, 0x100000
; GFX1013-NEXT:    s_bfe_u32 s7, s7, 0x100000
; GFX1013-NEXT:    flat_load_dword v2, v[0:1]
; GFX1013-NEXT:    s_lshl_b32 s6, s6, 16
; GFX1013-NEXT:    s_lshl_b32 s7, s7, 16
; GFX1013-NEXT:    s_or_b32 s4, s4, s6
; GFX1013-NEXT:    s_or_b32 s6, s8, s7
; GFX1013-NEXT:    v_mov_b32_e32 v0, 0xb36211c6
; GFX1013-NEXT:    v_bfrev_b32_e32 v1, 4.0
; GFX1013-NEXT:    v_mov_b32_e32 v6, s5
; GFX1013-NEXT:    v_mov_b32_e32 v7, s4
; GFX1013-NEXT:    v_mov_b32_e32 v8, s6
; GFX1013-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
