...
; GFX1030-NEXT:    global_load_dword v2, v0, s[2:3]
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-NEXT:    image_bvh_intersect_ray v[0:3], v[1:11], s[4:7]
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1013-NEXT:    global_load_dword v0, v2, s[8:9]
; GFX1013-NEXT:    global_load_dword v1, v2, s[10:11]
...
; GFX11-NEXT:    v_dual_mov_b32 v3, s8 :: v_dual_lshlrev_b32 v0, 2, v0
...
; GFX11-NEXT:    global_load_b32 v9, v0, s[0:1]
; GFX11-NEXT:    global_load_b32 v10, v0, s[2:3]
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_mov_b32 s2, 2.0
; GFX11-NEXT:    s_mov_b32 s1, 1.0
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v5, s10
...
; GFX1030-NEXT:    global_load_dword v2, v0, s[2:3]
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-NEXT:    image_bvh_intersect_ray v[0:3], v[1:8], s[4:7] a16
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-NEXT:    flat_store_dwordx4 v[0:1], v[0:3]
; GFX1030-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b32 v6, v0, s[0:1]
; GFX11-NEXT:    global_load_b32 v7, v0, s[2:3]
; GFX11-NEXT:    s_mov_b32 s0, 0
; GFX11-NEXT:    s_mov_b32 s2, 2.0
; GFX11-NEXT:    s_mov_b32 s1, 1.0
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v5, s10
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b32 v11, v0, s[6:7]
...
; GFX11-NEXT:    v_mov_b32_e32 v4, s9
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b32 v8, v0, s[6:7]
; GFX11-NEXT:    s_mov_b32 s6, 2.0
; GFX11-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX11-NEXT:    v_mov_b32_e32 v2, s6
; GFX11-NEXT:    s_waitcnt vmcnt(0)
