...
; RUN: llc -global-isel -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -global-isel -mtriple=amdgpu10.10 -show-mc-encoding < %s | FileCheck -check-prefix=GFX10 %s
; RUN: llc -global-isel -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 -show-mc-encoding < %s | FileCheck -check-prefix=GFX11 %s
...
; GFX10-NEXT:    s_load_dword s2, s[4:5], 0x2c ; encoding: [0x82,0x00,0x00,0xf4,0x2c,0x00,0x00,0xfa]
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24 ; encoding: [0x02,0x00,0x04,0xf4,0x24,0x00,0x00,0xfa]
...
; GFX11-NEXT:    s_load_b32 s2, s[4:5], 0x2c ; encoding: [0x82,0x00,0x00,0xf4,0x2c,0x00,0x00,0xf8]
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24 ; encoding: [0x02,0x00,0x04,0xf4,0x24,0x00,0x00,0xf8]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 ; encoding: [0x02,0x00,0x08,0xf4,0x24,0x00,0x00,0xf8]
