...
; CI:       ; %bb.0:
; CI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; CI-NEXT:    v_mov_b32_e32 v2, 0xffffffd6
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; CI-NEXT:    v_subrev_i32_e32 v3, vcc, 1, v4
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; VI-NEXT:    v_mov_b32_e32 v2, 0xffffffd6
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0xffffffd6
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_subrev_u32_e32 v2, 1, v3
...
; GFX10-NEXT:    v_subrev_nc_u32_e32 v3, 1, v2
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v3, 1, v2
...
; CI:       ; %bb.0:
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; CI-NEXT:    v_mov_b32_e32 v4, 0xffffffd6
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; VI-NEXT:    v_mov_b32_e32 v4, 0xffffffd6
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v2, 0xffffffd6
...
; GFX10-NEXT:    v_subrev_nc_u32_e32 v3, 1, v1
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v3, 1, v1
...
; GFX9-NEXT:    v_subrev_u32_e32 v3, 1, v4
...
; GFX10-NEXT:    v_subrev_nc_u32_e32 v4, 1, v3
...
; GFX11-NEXT:    v_subrev_nc_u32_e32 v4, 1, v3
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX9-NEXT:    v_mov_b32_e32 v4, 0xffffffd6
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    flat_load_dword v3, v[0:1] offset:16
...
; CI:       ; %bb.0:
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; CI-NEXT:    v_mov_b32_e32 v6, 0xffffffd6
...
; CI-NEXT:    ; =>This Inner Loop Header: Depth=1
; CI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CI-NEXT:    v_subrev_i32_e32 v8, vcc, 1, v2
; CI-NEXT:    v_subbrev_u32_e32 v9, vcc, 0, v3, vcc
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; VI-NEXT:    v_mov_b32_e32 v6, 0xffffffd6
...
; VI-NEXT:    ; =>This Inner Loop Header: Depth=1
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    v_subrev_u32_e32 v8, vcc, 1, v2
; VI-NEXT:    v_subbrev_u32_e32 v9, vcc, 0, v3, vcc
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX9-NEXT:    v_mov_b32_e32 v6, 0xffffffd6
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_subrev_co_u32_e32 v8, vcc, 1, v2
; GFX9-NEXT:    v_subbrev_co_u32_e32 v9, vcc, 0, v3, vcc
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX10-NEXT:    v_mov_b32_e32 v6, 0xffffffd6
...
; GFX10-NEXT:    v_sub_co_u32 v8, vcc_lo, v2, 1
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v9, vcc_lo, 0, v3, vcc_lo
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x0
; GFX11-NEXT:    v_mov_b32_e32 v6, 0xffffffd6
...
; GFX11-NEXT:    v_sub_co_u32 v8, vcc_lo, v2, 1
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v9, vcc_lo, 0, v3, vcc_lo
...
; CI:       ; %bb.0:
; CI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; CI-NEXT:    v_mov_b32_e32 v0, 0xffffffd6
...
; CI-NEXT:    v_subrev_i32_e32 v8, vcc, 1, v6
; CI-NEXT:    v_subbrev_u32_e32 v9, vcc, 0, v7, vcc
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; VI-NEXT:    v_mov_b32_e32 v0, 0xffffffd6
...
; VI-NEXT:    v_subrev_u32_e32 v8, vcc, 1, v6
; VI-NEXT:    v_subbrev_u32_e32 v9, vcc, 0, v7, vcc
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v5, vcc, 1, v7
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX10-NEXT:    v_mov_b32_e32 v0, 0xffffffd6
...
; GFX10-NEXT:    v_sub_co_u32 v5, vcc_lo, v7, 1
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc_lo, 0, v8, vcc_lo
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0xffffffd6
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v1, -1 :: v_dual_mov_b32 v2, s4
...
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, -1, v8, vcc_lo
; GFX11-NEXT:    v_sub_co_u32 v5, vcc_lo, v7, 1
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc_lo, 0, v8, vcc_lo
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_subrev_co_u32_e32 v7, vcc, 1, v2
; GFX9-NEXT:    v_subbrev_co_u32_e32 v8, vcc, 0, v3, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0xffffffd5, v2
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, -1, v3, vcc
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX10-NEXT:    v_mov_b32_e32 v4, 0xffffffd6
...
; GFX10-NEXT:    v_add_co_u32 v0, vcc_lo, 0xffffffd5, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, -1, v3, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v7, vcc_lo, v2, 1
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v8, vcc_lo, 0, v3, vcc_lo
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0xffffffd6
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v5, -1 :: v_dual_mov_b32 v2, s2
; GFX11-NEXT:    v_mov_b32_e32 v3, s3
; GFX11-NEXT:    s_mov_b32 s2, 0
; GFX11-NEXT:    .p2align 6
...
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, 0xffffffd5, v2
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, -1, v3, vcc_lo
; GFX11-NEXT:    v_sub_co_u32 v7, vcc_lo, v2, 1
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v8, vcc_lo, 0, v3, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
