...
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs -o - < %s | FileCheck %s --check-prefixes=GFX,GFX1210
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_sgpr_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_ashr_i32 s2, s1, 31
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mov_b32 s3, s2
; GFX1210-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_xor_b64 s[0:1], s[0:1], s[2:3]
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_sub_nc_u16 v1, 0, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_max_i16 v0, v0, v1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_sub_nc_u32_e32 v1, 0, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_max_i32_e32 v0, v0, v1
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    ; return to shader part epilog
  %res = call i32 @llvm.abs.i32(i32 %arg, i1 false)
  ret i32 %res
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1210-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX1210-NEXT:    v_xor_b32_e32 v1, v1, v2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1210-NEXT:    ; return to shader part epilog
  %res = call i64 @llvm.abs.i64(i64 %arg, i1 false)
  ret i64 %res
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_v4i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_dual_sub_nc_u32 v4, 0, v0 :: v_dual_sub_nc_u32 v5, 0, v1
; GFX1210-NEXT:    v_dual_sub_nc_u32 v6, 0, v2 :: v_dual_sub_nc_u32 v7, 0, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_max_i32_e32 v0, v0, v4
; GFX1210-NEXT:    v_max_i32_e32 v1, v1, v5
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_max_i32_e32 v2, v2, v6
; GFX1210-NEXT:    v_max_i32_e32 v3, v3, v7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1210-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1210-NEXT:    ; return to shader part epilog
  %res = call <4 x i32> @llvm.abs.v4i32(<4 x i32> %arg, i1 false)
  ret <4 x i32> %res
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_sgpr_v2i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_sext_i32_i8 s0, s0
; GFX1210-NEXT:    s_sext_i32_i8 s1, s1
; GFX1210-NEXT:    s_sext_i32_i16 s0, s0
; GFX1210-NEXT:    s_sext_i32_i16 s1, s1
; GFX1210-NEXT:    s_abs_i32 s0, s0
; GFX1210-NEXT:    s_abs_i32 s1, s1
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_v2i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GFX1210-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_sub_nc_u16 v2, 0, v0
; GFX1210-NEXT:    v_sub_nc_u16 v3, 0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_max_i16 v0, v0, v2
; GFX1210-NEXT:    v_max_i16 v1, v1, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s1, v1
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_v3i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GFX1210-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX1210-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_sub_nc_u16 v3, 0, v0
; GFX1210-NEXT:    v_sub_nc_u16 v4, 0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_sub_nc_u16 v5, 0, v2
; GFX1210-NEXT:    v_max_i16 v0, v0, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_max_i16 v1, v1, v4
; GFX1210-NEXT:    v_max_i16 v2, v2, v5
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_sgpr_v2i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_sext_i32_i16 s1, s0
; GFX1210-NEXT:    s_ashr_i32 s0, s0, 16
; GFX1210-NEXT:    s_abs_i32 s1, s1
; GFX1210-NEXT:    s_abs_i32 s0, s0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_pack_ll_b32_b16 s0, s1, s0
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_v2i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_pk_sub_i16 v1, 0, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_pk_max_i16 v0, v0, v1
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    ; return to shader part epilog
  %res = call <2 x i16> @llvm.abs.v2i16(<2 x i16> %arg, i1 false)
  ret <2 x i16> %res
...
; GFX1210-NEXT:    s_abs_i32 s0, s0
; GFX1210-NEXT:    s_sext_i32_i16 s1, s1
; GFX1210-NEXT:    s_pack_ll_b32_b16 s0, s2, s0
; GFX1210-NEXT:    s_abs_i32 s1, s1
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: abs_vgpr_v3i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_pk_sub_i16 v2, 0, v0
; GFX1210-NEXT:    v_sub_nc_u16 v3, 0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_pk_max_i16 v0, v0, v2
; GFX1210-NEXT:    v_max_i16 v1, v1, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s1, v1
