...
define amdgpu_ps <4 x float> @sample_1d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %s) {
  ...
  ; GFX11-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY12]](i32)
  ...
  ; GFX12-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY12]](i32)
...
define amdgpu_ps <4 x float> @sample_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %s, half %t) {
  ...
  ; GFX11-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
  ...
  ; GFX12-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
...
define amdgpu_ps <4 x float> @sample_3d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %s, half %t, half %r) {
  ...
  ; GFX11-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX11-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ...
  ; GFX12-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
...
define amdgpu_ps <4 x float> @sample_c_1d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, float %zcompare, half %s) {
  ...
  ; GFX11-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; GFX11-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
  ...
  ; GFX12-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; GFX12-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
...
define amdgpu_ps <4 x float> @sample_c_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, float %zcompare, half %s, half %t) {
  ...
  ; GFX11-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
  ; GFX11-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX11-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX11-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY13]](i32)
  ; GFX12-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX12-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX12-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
...
define amdgpu_ps <4 x float> @sample_c_cl_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, float %zcompare, half %s, half %t, half %clamp) {
  ...
  ; GFX11-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX11-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX11-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[DEF]](s16)
  ...
  ; GFX12-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX12-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[DEF]](s16)
...
define amdgpu_ps <4 x float> @sample_b_cl_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %bias, half %s, half %t, half %clamp) {
  ...
  ; GFX11-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX11-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX11-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX11-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[DEF]](s16)
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC1]](f16), [[TRUNC2]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX12-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX12-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[DEF]](s16)
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC1]](f16), [[TRUNC2]](f16)
...
define amdgpu_ps <4 x float> @sample_c_b_cl_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %bias, float %zcompare, half %s, half %t, half %clamp) {
  ...
  ; GFX11-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX11-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[DEF]](s16)
  ; GFX11-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY13]](f32)
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC1]](f16), [[TRUNC2]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[DEF]](s16)
  ; GFX12-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY13]](f32)
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC1]](f16), [[TRUNC2]](f16)
...
define amdgpu_ps <4 x float> @sample_d_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %dsdh, half %dtdh, half %dsdv, half %dtdv, half %s, half %t) {
  ...
  ; GFX11-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX11-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY $vgpr4
  ; GFX11-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX11-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX11-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX12-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY $vgpr4
  ; GFX12-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX12-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX12-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
...
define amdgpu_ps <4 x float> @sample_d_3d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, half %dsdh, half %dtdh, half %drdh, half %dsdv, half %dtdv, half %drdv, half %s, half %t, half %r) {
  ...
  ; GFX11-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX11-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX11-NEXT:   [[TRUNC7:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX11-NEXT:   [[COPY20:%[0-9]+]]:_(i32) = COPY $vgpr8
  ; GFX11-NEXT:   [[TRUNC8:%[0-9]+]]:_(f16) = G_TRUNC [[COPY20]](i32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX11-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[DEF]](s16)
  ...
  ; GFX12-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX12-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX12-NEXT:   [[TRUNC7:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX12-NEXT:   [[COPY20:%[0-9]+]]:_(i32) = COPY $vgpr8
  ; GFX12-NEXT:   [[TRUNC8:%[0-9]+]]:_(f16) = G_TRUNC [[COPY20]](i32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(s16) = G_IMPLICIT_DEF
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[DEF]](s16)
...
define amdgpu_ps <4 x float> @sample_c_d_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, float %zcompare, half %dsdh, half %dtdh, half %dsdv, half %dtdv, half %s, half %t) {
  ...
  ; GFX11-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX11-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX11-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX11-NEXT:   [[COPY18:%[0-9]+]]:_(i32) = COPY $vgpr6
  ; GFX11-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX11-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[TRUNC3]](f16)
  ; GFX11-NEXT:   [[BUILD_VECTOR4:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC4]](f16), [[TRUNC5]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX12-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX12-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX12-NEXT:   [[COPY18:%[0-9]+]]:_(i32) = COPY $vgpr6
  ; GFX12-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX12-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[TRUNC3]](f16)
  ; GFX12-NEXT:   [[BUILD_VECTOR4:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC4]](f16), [[TRUNC5]](f16)
...
define amdgpu_ps <4 x float> @sample_c_d_cl_2d(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, float %zcompare, half %dsdh, half %dtdh, half %dsdv, half %dtdv, half %s, half %t, half %clamp) {
  ...
  ; GFX11-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX11-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX11-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX11-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX11-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX11-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[TRUNC3]](f16)
  ; GFX11-NEXT:   [[BUILD_VECTOR4:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC4]](f16), [[TRUNC5]](f16)
  ...
  ; GFX12-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX12-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX12-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX12-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[COPY12]](f32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC]](f16), [[TRUNC1]](f16)
  ; GFX12-NEXT:   [[BUILD_VECTOR3:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC2]](f16), [[TRUNC3]](f16)
  ; GFX12-NEXT:   [[BUILD_VECTOR4:%[0-9]+]]:_(<2 x s16>) = G_BUILD_VECTOR [[TRUNC4]](f16), [[TRUNC5]](f16)
...
define amdgpu_ps float @sample_c_d_o_2darray_V1(<8 x i32> inreg %rsrc, <4 x i32> inreg %samp, i32 %offset, float %zcompare, half %dsdh, half %dtdh, half %dsdv, half %dtdv, half %s, half %t, half %slice) {
  ...
  ; GFX11-NEXT:   [[COPY13:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; GFX11-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX11-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX11-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX11-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX11-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY $vgpr4
  ; GFX11-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX11-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX11-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX11-NEXT:   [[COPY18:%[0-9]+]]:_(i32) = COPY $vgpr6
  ; GFX11-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX11-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX11-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX11-NEXT:   [[COPY20:%[0-9]+]]:_(i32) = COPY $vgpr8
  ; GFX11-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY20]](i32)
  ...
  ; GFX12-NEXT:   [[COPY13:%[0-9]+]]:_(f32) = COPY $vgpr1
  ; GFX12-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX12-NEXT:   [[TRUNC:%[0-9]+]]:_(f16) = G_TRUNC [[COPY14]](i32)
  ; GFX12-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX12-NEXT:   [[TRUNC1:%[0-9]+]]:_(f16) = G_TRUNC [[COPY15]](i32)
  ; GFX12-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY $vgpr4
  ; GFX12-NEXT:   [[TRUNC2:%[0-9]+]]:_(f16) = G_TRUNC [[COPY16]](i32)
  ; GFX12-NEXT:   [[COPY17:%[0-9]+]]:_(i32) = COPY $vgpr5
  ; GFX12-NEXT:   [[TRUNC3:%[0-9]+]]:_(f16) = G_TRUNC [[COPY17]](i32)
  ; GFX12-NEXT:   [[COPY18:%[0-9]+]]:_(i32) = COPY $vgpr6
  ; GFX12-NEXT:   [[TRUNC4:%[0-9]+]]:_(f16) = G_TRUNC [[COPY18]](i32)
  ; GFX12-NEXT:   [[COPY19:%[0-9]+]]:_(i32) = COPY $vgpr7
  ; GFX12-NEXT:   [[TRUNC5:%[0-9]+]]:_(f16) = G_TRUNC [[COPY19]](i32)
  ; GFX12-NEXT:   [[COPY20:%[0-9]+]]:_(i32) = COPY $vgpr8
  ; GFX12-NEXT:   [[TRUNC6:%[0-9]+]]:_(f16) = G_TRUNC [[COPY20]](i32)
