...
; RUN: llc -mtriple=amdgcn -global-isel -mcpu=gfx1010 -O2 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX1010 %s
; RUN: llc -mtriple=amdgcn -global-isel -mcpu=gfx1250 -O2 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX1250 %s
; RUN: llc -mtriple=amdgcn -global-isel -mcpu=gfx908 -O2 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX908 %s
...
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v5
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
...
; GFX908-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX908-NEXT:    v_xor_b32_e32 v3, 0x80000000, v3
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GFX908-NEXT:    v_cndmask_b32_e32 v2, 0, v2, vcc
; GFX908-NEXT:    v_cndmask_b32_e32 v3, 0, v3, vcc
; GFX908-NEXT:    v_add_f64 v[0:1], v[0:1], v[2:3]
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX90A-NEXT:    v_and_b32_e32 v4, 1, v4
; GFX90A-NEXT:    v_xor_b32_e32 v3, 0x80000000, v3
; GFX90A-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GFX90A-NEXT:    v_cndmask_b32_e32 v2, 0, v2, vcc
; GFX90A-NEXT:    v_cndmask_b32_e32 v3, 0, v3, vcc
; GFX90A-NEXT:    v_add_f64 v[0:1], v[0:1], v[2:3]
...
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GFX908-NEXT:    v_cndmask_b32_e32 v2, 0, v2, vcc
; GFX908-NEXT:    v_cndmask_b32_e32 v3, 0, v3, vcc
; GFX908-NEXT:    v_add_f64 v[0:1], v[0:1], -v[2:3]
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v3, 0, v3, vcc
; GFX90A-NEXT:    v_add_f64 v[0:1], v[0:1], -v[2:3]
; GFX90A-NEXT:    v_and_b32_e32 v2, 1, v7
...
; GFX1010-NEXT:    v_and_b32_e32 v6, 1, v6
; GFX1010-NEXT:    v_mov_b32_e32 v8, 0
; GFX1010-NEXT:    v_mov_b32_e32 v10, s4
; GFX1010-NEXT:  .LBB6_1: ; %loop
; GFX1010-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1010-NEXT:    v_ashrrev_i32_e32 v11, 31, v10
; GFX1010-NEXT:    v_lshlrev_b64 v[11:12], 3, v[10:11]
; GFX1010-NEXT:    v_add_nc_u32_e32 v10, 1, v10
; GFX1010-NEXT:    v_add_co_u32 v11, vcc_lo, v0, v11
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v12, vcc_lo, v1, v12, vcc_lo
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
; GFX1010-NEXT:    flat_load_dwordx2 v[11:12], v[11:12]
; GFX1010-NEXT:    v_cndmask_b32_e64 v9, 0, 0xbff00000, vcc_lo
; GFX1010-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v7, v10
; GFX1010-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1010-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1010-NEXT:    v_fma_f64 v[4:5], v[8:9], v[11:12], v[4:5]
; GFX1010-NEXT:    s_andn2_b32 exec_lo, exec_lo, s4
...
; GFX1250-NEXT:    v_lshl_add_u64 v[12:13], v[10:11], 3, v[0:1]
; GFX1250-NEXT:    v_cndmask_b32_e64 v9, 0, 0xbff00000, vcc_lo
; GFX1250-NEXT:    v_add_nc_u32_e32 v10, 1, v10
; GFX1250-NEXT:    flat_load_b64 v[12:13], v[12:13]
; GFX1250-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v7, v10
; GFX1250-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_fmac_f64_e32 v[4:5], v[8:9], v[12:13]
...
; GFX908-NEXT:    v_mov_b32_e32 v12, 0xbff00000
; GFX908-NEXT:    v_mov_b32_e32 v10, s6
; GFX908-NEXT:  .LBB6_1: ; %loop
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_ashrrev_i32_e32 v11, 31, v10
; GFX908-NEXT:    v_lshlrev_b64 v[13:14], 3, v[10:11]
; GFX908-NEXT:    v_add_u32_e32 v10, 1, v10
; GFX908-NEXT:    v_add_co_u32_e32 v13, vcc, v0, v13
; GFX908-NEXT:    v_addc_co_u32_e32 v14, vcc, v1, v14, vcc
; GFX908-NEXT:    flat_load_dwordx2 v[13:14], v[13:14]
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GFX908-NEXT:    v_cndmask_b32_e32 v9, 0, v12, vcc
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, v7, v10
; GFX908-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_fma_f64 v[4:5], v[8:9], v[13:14], v[4:5]
; GFX908-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX1010-NEXT:    v_mov_b32_e32 v11, s4
; GFX1010-NEXT:  .LBB7_1: ; %loop
; GFX1010-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1010-NEXT:    v_ashrrev_i32_e32 v10, 31, v11
; GFX1010-NEXT:    v_add_co_u32 v12, vcc_lo, v0, v11
; GFX1010-NEXT:    v_add_nc_u32_e32 v11, 1, v11
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v13, vcc_lo, v1, v10, vcc_lo
; GFX1010-NEXT:    flat_load_ubyte v10, v[12:13]
; GFX1010-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1010-NEXT:    v_and_b32_e32 v10, 1, v10
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v10
; GFX1010-NEXT:    v_cndmask_b32_e64 v10, 0, 0xbff00000, vcc_lo
; GFX1010-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v8, v11
...
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v9, s0
...
; GFX908-NEXT:    v_mov_b32_e32 v12, s6
; GFX908-NEXT:  .LBB7_1: ; %loop
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_ashrrev_i32_e32 v10, 31, v12
; GFX908-NEXT:    v_add_co_u32_e32 v13, vcc, v0, v12
; GFX908-NEXT:    v_addc_co_u32_e32 v14, vcc, v1, v10, vcc
; GFX908-NEXT:    flat_load_ubyte v10, v[13:14]
; GFX908-NEXT:    v_add_u32_e32 v12, 1, v12
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_and_b32_e32 v10, 1, v10
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; GFX908-NEXT:    v_cndmask_b32_e32 v10, 0, v11, vcc
; GFX908-NEXT:    v_fma_f64 v[4:5], v[9:10], v[6:7], v[4:5]
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v12
; GFX908-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX1010-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1010-NEXT:    v_ashrrev_i32_e32 v12, 31, v11
; GFX1010-NEXT:    v_add_co_u32 v13, vcc_lo, v0, v11
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v14, vcc_lo, v1, v12, vcc_lo
; GFX1010-NEXT:    v_lshlrev_b64 v[15:16], 3, v[11:12]
; GFX1010-NEXT:    v_add_nc_u32_e32 v11, 1, v11
; GFX1010-NEXT:    flat_load_ubyte v10, v[13:14]
; GFX1010-NEXT:    v_add_co_u32 v12, vcc_lo, v2, v15
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v13, vcc_lo, v3, v16, vcc_lo
; GFX1010-NEXT:    flat_load_dwordx2 v[12:13], v[12:13]
...
; GFX1010-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v8, v11
; GFX1010-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1010-NEXT:    v_fma_f64 v[6:7], v[9:10], v[12:13], v[6:7]
; GFX1010-NEXT:    s_or_b32 s4, vcc_lo, s4
; GFX1010-NEXT:    s_andn2_b32 exec_lo, exec_lo, s4
...
; GFX1250-NEXT:    s_mov_b32 s0, 0
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v12, s0
; GFX1250-NEXT:  .LBB8_1: ; %loop
; GFX1250-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_ashrrev_i32_e32 v13, 31, v12
; GFX1250-NEXT:    v_add_co_u32 v14, vcc_lo, v0, v12
; GFX1250-NEXT:    v_add_co_ci_u32_e64 v15, null, v1, v13, vcc_lo
; GFX1250-NEXT:    flat_load_u8 v9, v[14:15]
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v9, 1, v9
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_lshl_add_u64 v[14:15], v[12:13], 3, v[2:3]
; GFX1250-NEXT:    v_add_nc_u32_e32 v12, 1, v12
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1250-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v9
; GFX1250-NEXT:    flat_load_b64 v[14:15], v[14:15]
; GFX1250-NEXT:    v_cndmask_b32_e64 v11, 0, 0xbff00000, vcc_lo
; GFX1250-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v8, v12
; GFX1250-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-NEXT:    v_fmac_f64_e32 v[6:7], v[10:11], v[14:15]
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s0
...
; GFX908-NEXT:    s_mov_b64 s[4:5], 0
; GFX908-NEXT:    v_mov_b32_e32 v9, 0
; GFX908-NEXT:    v_mov_b32_e32 v13, 0xbff00000
; GFX908-NEXT:    v_mov_b32_e32 v11, s6
; GFX908-NEXT:  .LBB8_1: ; %loop
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_ashrrev_i32_e32 v12, 31, v11
; GFX908-NEXT:    v_add_co_u32_e32 v14, vcc, v0, v11
; GFX908-NEXT:    v_addc_co_u32_e32 v15, vcc, v1, v12, vcc
; GFX908-NEXT:    flat_load_ubyte v10, v[14:15]
; GFX908-NEXT:    v_lshlrev_b64 v[14:15], 3, v[11:12]
; GFX908-NEXT:    v_add_u32_e32 v11, 1, v11
; GFX908-NEXT:    v_add_co_u32_e32 v14, vcc, v2, v14
; GFX908-NEXT:    v_addc_co_u32_e32 v15, vcc, v3, v15, vcc
; GFX908-NEXT:    flat_load_dwordx2 v[14:15], v[14:15]
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_and_b32_e32 v10, 1, v10
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; GFX908-NEXT:    v_cndmask_b32_e32 v10, 0, v13, vcc
; GFX908-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v11
; GFX908-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    v_fma_f64 v[6:7], v[9:10], v[14:15], v[6:7]
; GFX908-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v8
; GFX1010-NEXT:    v_cmp_ne_u32_e64 s4, 0, v9
; GFX1010-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc_lo
; GFX1010-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc_lo
...
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
; GFX908-NEXT:    v_and_b32_e32 v8, 1, v9
; GFX908-NEXT:    v_cndmask_b32_e32 v4, 0, v4, vcc
; GFX908-NEXT:    v_cndmask_b32_e32 v5, 0, v5, vcc
; GFX908-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
