...
define amdgpu_ps void @raw_buffer_load_f16_tfe(<4 x i32> inreg %rsrc, ptr addrspace(1) %data_addr, ptr addrspace(1) %tfe_addr) {
  ...
  ; GFX11-TRUE16-NEXT:   liveins: $sgpr0, $sgpr1, $sgpr2, $sgpr3, $vgpr0, $vgpr1, $vgpr2, $vgpr3
  ; GFX11-TRUE16-NEXT: {{  $}}
  ; GFX11-TRUE16-NEXT:   [[COPY:%[0-9]+]]:sgpr(i32) = COPY $sgpr0
  ; GFX11-TRUE16-NEXT:   [[COPY1:%[0-9]+]]:sgpr(i32) = COPY $sgpr1
  ; GFX11-TRUE16-NEXT:   [[COPY2:%[0-9]+]]:sgpr(i32) = COPY $sgpr2
  ; GFX11-TRUE16-NEXT:   [[COPY3:%[0-9]+]]:sgpr(i32) = COPY $sgpr3
  ; GFX11-TRUE16-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:sgpr(<4 x i32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; GFX11-TRUE16-NEXT:   [[COPY4:%[0-9]+]]:vgpr(i32) = COPY $vgpr0
  ; GFX11-TRUE16-NEXT:   [[COPY5:%[0-9]+]]:vgpr(i32) = COPY $vgpr1
  ; GFX11-TRUE16-NEXT:   [[MV:%[0-9]+]]:vgpr(p1) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; GFX11-TRUE16-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY $vgpr2
  ; GFX11-TRUE16-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY $vgpr3
  ; GFX11-TRUE16-NEXT:   [[MV1:%[0-9]+]]:vgpr(p1) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; GFX11-TRUE16-NEXT:   [[C:%[0-9]+]]:sgpr(i32) = G_CONSTANT i32 0
  ; GFX11-TRUE16-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX11-TRUE16-NEXT:   [[COPY9:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX11-TRUE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:vgpr(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX11-TRUE16-NEXT:   [[UV:%[0-9]+]]:vgpr(i32), [[UV1:%[0-9]+]]:vgpr(i32) = G_UNMERGE_VALUES [[AMDGPU_BUFFER_LOAD_USHORT_TFE]](<2 x i32>)
  ; GFX11-TRUE16-NEXT:   [[AMDGPU_READANYLANE:%[0-9]+]]:sgpr(i32) = G_AMDGPU_READANYLANE [[UV]]
  ; GFX11-TRUE16-NEXT:   [[AMDGPU_READANYLANE1:%[0-9]+]]:sgpr(i32) = G_AMDGPU_READANYLANE [[UV1]]
  ; GFX11-TRUE16-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:sgpr(<2 x i32>) = G_BUILD_VECTOR [[AMDGPU_READANYLANE]](i32), [[AMDGPU_READANYLANE1]](i32)
  ; GFX11-TRUE16-NEXT:   [[UV2:%[0-9]+]]:sgpr(i32), [[UV3:%[0-9]+]]:sgpr(i32) = G_UNMERGE_VALUES [[BUILD_VECTOR1]](<2 x i32>)
  ; GFX11-TRUE16-NEXT:   [[TRUNC:%[0-9]+]]:sgpr(i16) = G_TRUNC [[UV2]](i32)
  ; GFX11-TRUE16-NEXT:   [[BITCAST:%[0-9]+]]:sgpr(f16) = G_BITCAST [[TRUNC]](i16)
  ; GFX11-TRUE16-NEXT:   G_STORE [[BITCAST]](f16), [[MV]](p1) :: (store (f16) into %ir.data_addr, addrspace 1)
  ; GFX11-TRUE16-NEXT:   G_STORE [[UV3]](i32), [[MV1]](p1) :: (store (i32) into %ir.tfe_addr, addrspace 1)
  ; GFX11-TRUE16-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX11-FAKE16-NEXT:   liveins: $sgpr0, $sgpr1, $sgpr2, $sgpr3, $vgpr0, $vgpr1, $vgpr2, $vgpr3
  ; GFX11-FAKE16-NEXT: {{  $}}
  ; GFX11-FAKE16-NEXT:   [[COPY:%[0-9]+]]:_(i32) = COPY $sgpr0
  ; GFX11-FAKE16-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $sgpr1
  ; GFX11-FAKE16-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $sgpr2
  ; GFX11-FAKE16-NEXT:   [[COPY3:%[0-9]+]]:_(i32) = COPY $sgpr3
  ; GFX11-FAKE16-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<4 x i32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; GFX11-FAKE16-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; GFX11-FAKE16-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; GFX11-FAKE16-NEXT:   [[MV:%[0-9]+]]:_(p1) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; GFX11-FAKE16-NEXT:   [[COPY6:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX11-FAKE16-NEXT:   [[COPY7:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX11-FAKE16-NEXT:   [[MV1:%[0-9]+]]:_(p1) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; GFX11-FAKE16-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; GFX11-FAKE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:_(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[C]](i32), [[C]], [[C]], 0, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX11-FAKE16-NEXT:   [[UV:%[0-9]+]]:_(i32), [[UV1:%[0-9]+]]:_(i32) = G_UNMERGE_VALUES [[AMDGPU_BUFFER_LOAD_USHORT_TFE]](<2 x i32>)
  ; GFX11-FAKE16-NEXT:   [[TRUNC:%[0-9]+]]:_(i16) = G_TRUNC [[UV]](i32)
  ; GFX11-FAKE16-NEXT:   [[BITCAST:%[0-9]+]]:_(f16) = G_BITCAST [[TRUNC]](i16)
  ; GFX11-FAKE16-NEXT:   [[ANYEXT:%[0-9]+]]:_(f32) = G_ANYEXT [[BITCAST]](f16)
  ; GFX11-FAKE16-NEXT:   G_STORE [[ANYEXT]](f32), [[MV]](p1) :: (store (f16) into %ir.data_addr, addrspace 1)
  ; GFX11-FAKE16-NEXT:   G_STORE [[UV1]](i32), [[MV1]](p1) :: (store (i32) into %ir.tfe_addr, addrspace 1)
  ; GFX11-FAKE16-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-TRUE16-NEXT:   liveins: $sgpr0, $sgpr1, $sgpr2, $sgpr3, $vgpr0, $vgpr1, $vgpr2, $vgpr3
  ; GFX12-TRUE16-NEXT: {{  $}}
  ; GFX12-TRUE16-NEXT:   [[COPY:%[0-9]+]]:sgpr(i32) = COPY $sgpr0
  ; GFX12-TRUE16-NEXT:   [[COPY1:%[0-9]+]]:sgpr(i32) = COPY $sgpr1
  ; GFX12-TRUE16-NEXT:   [[COPY2:%[0-9]+]]:sgpr(i32) = COPY $sgpr2
  ; GFX12-TRUE16-NEXT:   [[COPY3:%[0-9]+]]:sgpr(i32) = COPY $sgpr3
  ; GFX12-TRUE16-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:sgpr(<4 x i32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; GFX12-TRUE16-NEXT:   [[COPY4:%[0-9]+]]:vgpr(i32) = COPY $vgpr0
  ; GFX12-TRUE16-NEXT:   [[COPY5:%[0-9]+]]:vgpr(i32) = COPY $vgpr1
  ; GFX12-TRUE16-NEXT:   [[MV:%[0-9]+]]:vgpr(p1) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; GFX12-TRUE16-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY $vgpr2
  ; GFX12-TRUE16-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY $vgpr3
  ; GFX12-TRUE16-NEXT:   [[MV1:%[0-9]+]]:vgpr(p1) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; GFX12-TRUE16-NEXT:   [[C:%[0-9]+]]:sgpr(i32) = G_CONSTANT i32 0
  ; GFX12-TRUE16-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-TRUE16-NEXT:   [[COPY9:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-TRUE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:vgpr(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-TRUE16-NEXT:   [[UV:%[0-9]+]]:vgpr(i32), [[UV1:%[0-9]+]]:vgpr(i32) = G_UNMERGE_VALUES [[AMDGPU_BUFFER_LOAD_USHORT_TFE]](<2 x i32>)
  ; GFX12-TRUE16-NEXT:   [[AMDGPU_READANYLANE:%[0-9]+]]:sgpr(i32) = G_AMDGPU_READANYLANE [[UV]]
  ; GFX12-TRUE16-NEXT:   [[AMDGPU_READANYLANE1:%[0-9]+]]:sgpr(i32) = G_AMDGPU_READANYLANE [[UV1]]
  ; GFX12-TRUE16-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:sgpr(<2 x i32>) = G_BUILD_VECTOR [[AMDGPU_READANYLANE]](i32), [[AMDGPU_READANYLANE1]](i32)
  ; GFX12-TRUE16-NEXT:   [[UV2:%[0-9]+]]:sgpr(i32), [[UV3:%[0-9]+]]:sgpr(i32) = G_UNMERGE_VALUES [[BUILD_VECTOR1]](<2 x i32>)
  ; GFX12-TRUE16-NEXT:   [[TRUNC:%[0-9]+]]:sgpr(i16) = G_TRUNC [[UV2]](i32)
  ; GFX12-TRUE16-NEXT:   [[BITCAST:%[0-9]+]]:sgpr(f16) = G_BITCAST [[TRUNC]](i16)
  ; GFX12-TRUE16-NEXT:   G_STORE [[BITCAST]](f16), [[MV]](p1) :: (store (f16) into %ir.data_addr, addrspace 1)
  ; GFX12-TRUE16-NEXT:   G_STORE [[UV3]](i32), [[MV1]](p1) :: (store (i32) into %ir.tfe_addr, addrspace 1)
  ; GFX12-TRUE16-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-FAKE16-NEXT:   liveins: $sgpr0, $sgpr1, $sgpr2, $sgpr3, $vgpr0, $vgpr1, $vgpr2, $vgpr3
  ; GFX12-FAKE16-NEXT: {{  $}}
  ; GFX12-FAKE16-NEXT:   [[COPY:%[0-9]+]]:_(i32) = COPY $sgpr0
  ; GFX12-FAKE16-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $sgpr1
  ; GFX12-FAKE16-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $sgpr2
  ; GFX12-FAKE16-NEXT:   [[COPY3:%[0-9]+]]:_(i32) = COPY $sgpr3
  ; GFX12-FAKE16-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<4 x i32>) = G_BUILD_VECTOR [[COPY]](i32), [[COPY1]](i32), [[COPY2]](i32), [[COPY3]](i32)
  ; GFX12-FAKE16-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; GFX12-FAKE16-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; GFX12-FAKE16-NEXT:   [[MV:%[0-9]+]]:_(p1) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; GFX12-FAKE16-NEXT:   [[COPY6:%[0-9]+]]:_(i32) = COPY $vgpr2
  ; GFX12-FAKE16-NEXT:   [[COPY7:%[0-9]+]]:_(i32) = COPY $vgpr3
  ; GFX12-FAKE16-NEXT:   [[MV1:%[0-9]+]]:_(p1) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; GFX12-FAKE16-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 0
  ; GFX12-FAKE16-NEXT:   [[AMDGPU_BUFFER_LOAD_USHORT_TFE:%[0-9]+]]:_(<2 x i32>) = G_AMDGPU_BUFFER_LOAD_USHORT_TFE [[BUILD_VECTOR]](<4 x i32>), [[C]](i32), [[C]], [[C]], 0, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-FAKE16-NEXT:   [[UV:%[0-9]+]]:_(i32), [[UV1:%[0-9]+]]:_(i32) = G_UNMERGE_VALUES [[AMDGPU_BUFFER_LOAD_USHORT_TFE]](<2 x i32>)
  ; GFX12-FAKE16-NEXT:   [[TRUNC:%[0-9]+]]:_(i16) = G_TRUNC [[UV]](i32)
  ; GFX12-FAKE16-NEXT:   [[BITCAST:%[0-9]+]]:_(f16) = G_BITCAST [[TRUNC]](i16)
  ; GFX12-FAKE16-NEXT:   [[ANYEXT:%[0-9]+]]:_(f32) = G_ANYEXT [[BITCAST]](f16)
  ; GFX12-FAKE16-NEXT:   G_STORE [[ANYEXT]](f32), [[MV]](p1) :: (store (f16) into %ir.data_addr, addrspace 1)
  ; GFX12-FAKE16-NEXT:   G_STORE [[UV1]](i32), [[MV1]](p1) :: (store (i32) into %ir.tfe_addr, addrspace 1)
  ; GFX12-FAKE16-NEXT:   S_ENDPGM 0
  ;
