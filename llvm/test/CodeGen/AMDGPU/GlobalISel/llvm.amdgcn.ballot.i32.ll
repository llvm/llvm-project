...
; GFX11-NEXT:    s_endpgm
; PREGFX11-LABEL: non_cst_non_compare_input:
; PREGFX11:       ; %bb.0: ; %entry
; PREGFX11-NEXT:    s_and_b32 s0, s0, 1
; PREGFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; PREGFX11-NEXT:    s_cmp_lg_u32 s0, 0
; PREGFX11-NEXT:    s_cselect_b32 s0, exec_lo, 0
; PREGFX11-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; PREGFX11-NEXT:    s_xor_b32 s1, exec_lo, s1
; PREGFX11-NEXT:  ; %bb.1: ; %B
; PREGFX11-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 2, v2
; PREGFX11-NEXT:    s_andn2_b32 s0, s0, exec_lo
; PREGFX11-NEXT:    ; implicit-def: $vgpr2
; PREGFX11-NEXT:    s_and_b32 s2, exec_lo, vcc_lo
; PREGFX11-NEXT:    s_or_b32 s0, s0, s2
; PREGFX11-NEXT:  ; %bb.2: ; %Flow
; PREGFX11-NEXT:    s_andn2_saveexec_b32 s1, s1
; PREGFX11-NEXT:  ; %bb.3: ; %A
; PREGFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, 1, v2
; PREGFX11-NEXT:    s_andn2_b32 s0, s0, exec_lo
; PREGFX11-NEXT:    s_and_b32 s2, exec_lo, vcc_lo
; PREGFX11-NEXT:    s_or_b32 s0, s0, s2
; PREGFX11-NEXT:  ; %bb.4: ; %exit
; PREGFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s1
; PREGFX11-NEXT:    s_and_b32 s0, s0, exec_lo
; PREGFX11-NEXT:    v_mov_b32_e32 v2, s0
; PREGFX11-NEXT:    global_store_dword v[0:1], v2, off
; PREGFX11-NEXT:    s_endpgm
entry:
