...
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; GFX11-NEXT:    v_fma_f64 v[10:11], v[6:7], v[4:5], v[4:5]
; GFX11-NEXT:    v_mul_f64 v[6:7], v[0:1], v[10:11]
; GFX11-NEXT:    v_fma_f64 v[0:1], -v[2:3], v[6:7], v[0:1]
; GFX11-NEXT:    v_fma_f64 v[0:1], v[0:1], v[10:11], v[6:7]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[2:3], s0, v[0:1], v[0:1], 1.0
...
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[0:1], v[2:3], 1.0
; GFX11-NEXT:    v_fma_f64 v[2:3], v[4:5], v[2:3], v[2:3]
; GFX11-NEXT:    v_mul_f64 v[6:7], 1.0, v[2:3]
; GFX11-NEXT:    v_fma_f64 v[0:1], -v[0:1], v[6:7], 1.0
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mov_b32_e32 v30, v4
; GFX11-NEXT:    v_mov_b32_e32 v31, v5
; GFX11-NEXT:    v_mov_b32_e32 v4, v6
; GFX11-NEXT:    v_mov_b32_e32 v5, v7
; GFX11-NEXT:    v_div_scale_f64 v[26:27], s0, v[30:31], v[30:31], v[0:1]
; GFX11-NEXT:    v_div_scale_f64 v[20:21], vcc_lo, v[0:1], v[30:31], v[0:1]
; GFX11-NEXT:    v_div_scale_f64 v[24:25], s0, v[4:5], v[4:5], v[2:3]
; GFX11-NEXT:    v_div_scale_f64 v[16:17], s0, v[2:3], v[4:5], v[2:3]
; GFX11-NEXT:    v_rcp_f64_e32 v[12:13], v[26:27]
; GFX11-NEXT:    v_rcp_f64_e32 v[14:15], v[24:25]
; GFX11-NEXT:    v_fma_f64 v[10:11], -v[26:27], v[12:13], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[24:25], v[14:15], 1.0
; GFX11-NEXT:    v_fma_f64 v[12:13], v[12:13], v[10:11], v[12:13]
; GFX11-NEXT:    v_fma_f64 v[14:15], v[14:15], v[8:9], v[14:15]
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[26:27], v[12:13], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[24:25], v[14:15], 1.0
; GFX11-NEXT:    v_fma_f64 v[6:7], v[12:13], v[6:7], v[12:13]
; GFX11-NEXT:    v_fma_f64 v[14:15], v[14:15], v[8:9], v[14:15]
; GFX11-NEXT:    v_mul_f64 v[18:19], v[20:21], v[6:7]
; GFX11-NEXT:    v_mul_f64 v[22:23], v[16:17], v[14:15]
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[26:27], v[18:19], v[20:21]
; GFX11-NEXT:    v_fma_f64 v[16:17], -v[24:25], v[22:23], v[16:17]
; GFX11-NEXT:    v_div_fmas_f64 v[18:19], v[8:9], v[6:7], v[18:19]
; GFX11-NEXT:    s_mov_b32 vcc_lo, s0
; GFX11-NEXT:    v_div_fmas_f64 v[8:9], v[16:17], v[14:15], v[22:23]
; GFX11-NEXT:    v_div_fixup_f64 v[0:1], v[18:19], v[30:31], v[0:1]
...
; GFX11-NEXT:    v_rcp_f64_e32 v[8:9], v[18:19]
; GFX11-NEXT:    v_mov_b32_e32 v0, v2
; GFX11-NEXT:    v_rcp_f64_e32 v[10:11], v[4:5]
; GFX11-NEXT:    v_mov_b32_e32 v1, v3
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[18:19], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[12:13], -v[4:5], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], v[6:7], v[8:9], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[10:11], v[12:13], v[10:11], v[10:11]
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[18:19], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[12:13], -v[4:5], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], v[6:7], v[8:9], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[10:11], v[12:13], v[10:11], v[10:11]
; GFX11-NEXT:    v_mul_f64 v[12:13], v[22:23], v[8:9]
; GFX11-NEXT:    v_mul_f64 v[14:15], v[0:1], v[10:11]
; GFX11-NEXT:    v_fma_f64 v[18:19], -v[18:19], v[12:13], v[22:23]
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[14:15], v[0:1]
; GFX11-NEXT:    v_fma_f64 v[0:1], v[18:19], v[8:9], v[12:13]
; GFX11-NEXT:    v_fma_f64 v[2:3], v[4:5], v[10:11], v[14:15]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[22:23], s0, v[0:1], v[0:1], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[20:21], s0, v[2:3], v[2:3], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[16:17], vcc_lo, 1.0, v[0:1], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[12:13], s0, 1.0, v[2:3], 1.0
; GFX11-NEXT:    v_rcp_f64_e32 v[8:9], v[22:23]
; GFX11-NEXT:    v_rcp_f64_e32 v[10:11], v[20:21]
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[22:23], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[20:21], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], v[8:9], v[6:7], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[10:11], v[10:11], v[4:5], v[10:11]
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[22:23], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[20:21], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[6:7], v[8:9], v[6:7], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[10:11], v[10:11], v[4:5], v[10:11]
; GFX11-NEXT:    v_mul_f64 v[14:15], v[16:17], v[6:7]
; GFX11-NEXT:    v_mul_f64 v[18:19], v[12:13], v[10:11]
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[22:23], v[14:15], v[16:17]
; GFX11-NEXT:    v_fma_f64 v[12:13], -v[20:21], v[18:19], v[12:13]
; GFX11-NEXT:    v_div_fmas_f64 v[6:7], v[4:5], v[6:7], v[14:15]
; GFX11-NEXT:    s_mov_b32 vcc_lo, s0
; GFX11-NEXT:    v_div_fmas_f64 v[8:9], v[12:13], v[10:11], v[18:19]
; GFX11-NEXT:    v_div_fixup_f64 v[0:1], v[6:7], v[0:1], 1.0
; GFX11-NEXT:    v_div_fixup_f64 v[2:3], v[8:9], v[2:3], 1.0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    v_mov_b32_e32 v0, v2
; GFX11-NEXT:    v_mov_b32_e32 v1, v3
; GFX11-NEXT:    v_rcp_f64_e32 v[4:5], v[14:15]
; GFX11-NEXT:    v_rcp_f64_e32 v[6:7], v[0:1]
; GFX11-NEXT:    v_fma_f64 v[2:3], -v[14:15], v[4:5], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[0:1], v[6:7], 1.0
; GFX11-NEXT:    v_fma_f64 v[4:5], v[2:3], v[4:5], v[4:5]
; GFX11-NEXT:    v_fma_f64 v[6:7], v[8:9], v[6:7], v[6:7]
; GFX11-NEXT:    v_fma_f64 v[2:3], -v[14:15], v[4:5], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[0:1], v[6:7], 1.0
; GFX11-NEXT:    v_fma_f64 v[4:5], v[2:3], v[4:5], v[4:5]
; GFX11-NEXT:    v_fma_f64 v[6:7], v[8:9], v[6:7], v[6:7]
...
; GFX11-NEXT:    v_fma_f64 v[14:15], -v[14:15], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[12:13], -v[0:1], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[0:1], v[14:15], v[4:5], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[2:3], v[12:13], v[6:7], v[10:11]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
