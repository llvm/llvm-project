...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX6 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=tahiti -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX6 %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=fiji -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX8 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=fiji -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX8 %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GCN,GFX9 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GCN,GFX9 %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1010 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1010 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX10 %s

; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=GFX11 %s
...
; GFX6-NEXT:    v_div_scale_f64 v[8:9], s[4:5], v[0:1], v[2:3], v[0:1]
; GFX6-NEXT:    v_fma_f64 v[10:11], -v[4:5], v[6:7], 1.0
; GFX6-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, v9
; GFX6-NEXT:    v_mul_f64 v[10:11], v[8:9], v[6:7]
; GFX6-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; GFX6-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[10:11], v[8:9]
; GFX6-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[10:11]
...
; GFX6-NEXT:    v_div_scale_f64 v[6:7], s[4:5], 1.0, v[0:1], 1.0
; GFX6-NEXT:    v_fma_f64 v[8:9], -v[2:3], v[4:5], 1.0
; GFX6-NEXT:    v_fma_f64 v[4:5], v[4:5], v[8:9], v[4:5]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v7
; GFX6-NEXT:    v_mul_f64 v[8:9], v[6:7], v[4:5]
; GFX6-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; GFX6-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[8:9], v[6:7]
; GFX6-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[4:5], v[8:9]
...
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v9
...
; GFX6-NEXT:    v_fma_f64 v[18:19], -v[12:13], v[14:15], 1.0
; GFX6-NEXT:    v_fma_f64 v[14:15], v[14:15], v[18:19], v[14:15]
; GFX6-NEXT:    v_mul_f64 v[18:19], v[16:17], v[10:11]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, v17
; GFX6-NEXT:    v_fma_f64 v[8:9], -v[8:9], v[18:19], v[16:17]
; GFX6-NEXT:    v_fma_f64 v[16:17], -v[12:13], v[14:15], 1.0
; GFX6-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; GFX6-NEXT:    v_fma_f64 v[14:15], v[14:15], v[16:17], v[14:15]
; GFX6-NEXT:    v_div_scale_f64 v[16:17], s[6:7], v[2:3], v[6:7], v[2:3]
; GFX6-NEXT:    v_div_fmas_f64 v[8:9], v[8:9], v[10:11], v[18:19]
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v7, v13
; GFX6-NEXT:    v_mul_f64 v[10:11], v[16:17], v[14:15]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], v3, v17
; GFX6-NEXT:    v_fma_f64 v[18:19], -v[12:13], v[10:11], v[16:17]
; GFX6-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; GFX6-NEXT:    v_div_fmas_f64 v[10:11], v[18:19], v[14:15], v[10:11]
...
; GFX6-NEXT:    v_fma_f64 v[4:5], -v[4:5], v[14:15], v[10:11]
; GFX6-NEXT:    v_fma_f64 v[10:11], v[12:13], v[16:17], v[12:13]
; GFX6-NEXT:    v_div_fmas_f64 v[4:5], v[4:5], v[6:7], v[14:15]
; GFX6-NEXT:    v_mul_f64 v[12:13], v[18:19], v[10:11]
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v9
; GFX6-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[12:13], v[18:19]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v19
; GFX6-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; GFX6-NEXT:    v_div_fixup_f64 v[0:1], v[4:5], v[0:1], 1.0
; GFX6-NEXT:    v_div_fmas_f64 v[6:7], v[6:7], v[10:11], v[12:13]
