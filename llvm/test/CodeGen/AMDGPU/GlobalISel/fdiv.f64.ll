...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[8:9], s0, v[4:5], v[4:5], v[0:1]
; GFX11-NEXT:    v_div_scale_f64 v[10:11], s0, v[6:7], v[6:7], v[2:3]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_div_scale_f64 v[4:5], s0, v[0:1], v[0:1], 1.0
; GFX11-NEXT:    v_div_scale_f64 v[6:7], s0, v[2:3], v[2:3], 1.0
