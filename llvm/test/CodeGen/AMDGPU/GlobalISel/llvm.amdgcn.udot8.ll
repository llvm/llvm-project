...
; RUN: llc -global-isel -mtriple=amdgpu10.11 < %s | FileCheck --check-prefix=GFX10PLUS %s
; RUN: llc -global-isel -mtriple=amdgpu10.12 < %s | FileCheck --check-prefix=GFX10PLUS %s
; RUN: llc -global-isel -mtriple=amdgpu11.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefix=GFX10PLUS %s
