...
; GFX908-NEXT:    v_min_f32_e32 v4, v5, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, v4
; GFX908-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX8-NEXT:    v_min_f32_e32 v4, v5, v2
; GFX8-NEXT:    v_mov_b32_e32 v0, v4
; GFX8-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    v_min_f32_e32 v2, v3, v0
...
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    v_min_f32_e32 v2, v3, v0
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_min_f32_e32 v1, v2, v0
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_min_f32_e32 v1, v2, v0
...
; GFX11-NEXT:    v_min_f64 v[6:7], v[8:9], v[4:5]
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_min_f64 v[6:7], v[8:9], v[4:5]
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_min_f64 v[6:7], v[8:9], v[4:5]
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_min_f64 v[2:3], v[4:5], v[0:1]
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_min_f64 v[2:3], v[4:5], v[0:1]
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    v_min_f64 v[2:3], v[4:5], v[0:1]
