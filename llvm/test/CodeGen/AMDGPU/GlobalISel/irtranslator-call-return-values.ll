...
define amdgpu_kernel void @test_call_external_i48_func_void() #0 {
  ...
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(s64) = G_MERGE_VALUES [[COPY21]](i32), [[COPY22]](i32)
  ; GCN-NEXT:   [[TRUNC:%[0-9]+]]:_(i48) = G_TRUNC [[MV]](s64)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define amdgpu_kernel void @test_call_external_v33i32_func_v33i32_i32(ptr addrspace(1) %p, i32 %idx) #0 {
  ...
  ; GCN-NEXT:   [[COPY8:%[0-9]+]]:sgpr_64 = COPY $sgpr4_sgpr5
  ; GCN-NEXT:   [[COPY9:%[0-9]+]]:_(p4) = COPY $sgpr8_sgpr9
  ; GCN-NEXT:   [[DEF:%[0-9]+]]:_(<3 x i32>) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 2
  ; GCN-NEXT:   [[DEF1:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; GCN-NEXT:   [[INT:%[0-9]+]]:_(p4) = G_INTRINSIC intrinsic(@llvm.amdgcn.kernarg.segment.ptr)
  ; GCN-NEXT:   [[LOAD:%[0-9]+]]:_(<3 x i32>) = G_LOAD [[INT]](p4) :: (dereferenceable invariant load (<3 x i32>) from %ir.p.kernarg.offset1, align 16, addrspace 4)
  ; GCN-NEXT:   [[SHUF:%[0-9]+]]:_(<2 x i32>) = G_SHUFFLE_VECTOR [[LOAD]](<3 x i32>), [[DEF]], shufflemask(0, 1)
  ; GCN-NEXT:   [[BITCAST:%[0-9]+]]:_(p1) = G_BITCAST [[SHUF]](<2 x i32>)
  ; GCN-NEXT:   [[EVEC:%[0-9]+]]:_(i32) = G_EXTRACT_VECTOR_ELT [[LOAD]](<3 x i32>), [[C]](i32)
  ; GCN-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p5) = G_FRAME_INDEX %stack.0
  ; GCN-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ...
  ; GCN-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY19]], [[C3]](i32)
  ; GCN-NEXT:   [[OR1:%[0-9]+]]:_(i32) = G_OR [[OR]], [[SHL1]]
  ; GCN-NEXT:   [[UV:%[0-9]+]]:_(i32), [[UV1:%[0-9]+]]:_(i32) = G_UNMERGE_VALUES [[BITCAST]](p1)
  ; GCN-NEXT:   $vgpr0 = COPY [[FRAME_INDEX]](p5)
  ; GCN-NEXT:   $vgpr1 = COPY [[UV]](i32)
  ; GCN-NEXT:   $vgpr2 = COPY [[UV1]](i32)
  ; GCN-NEXT:   $vgpr3 = COPY [[EVEC]](i32)
  ; GCN-NEXT:   [[COPY20:%[0-9]+]]:_(<4 x s32>) = COPY $private_rsrc_reg
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY20]](<4 x s32>)
  ; GCN-NEXT:   $sgpr4_sgpr5 = COPY [[COPY10]](p4)
  ; GCN-NEXT:   $sgpr6_sgpr7 = COPY [[COPY11]](p4)
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   [[LOAD1:%[0-9]+]]:_(<33 x i32>) = G_LOAD [[FRAME_INDEX]](p5) :: (load (<33 x i32>) from %stack.0, align 256, addrspace 5)
  ; GCN-NEXT:   G_STORE [[LOAD1]](<33 x i32>), [[DEF1]](p1) :: (volatile store (<33 x i32>) into `ptr addrspace(1) poison`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
