...
define amdgpu_kernel void @test_call_external_i32_func_i32_imm(ptr addrspace(1) %out) #0 {
  ...
  ; GCN-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY12]], [[C1]](i64)
  ; GCN-NEXT:   [[COPY13:%[0-9]+]]:_(i64) = COPY [[COPY6]]
  ; GCN-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY5]]
  ; GCN-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GCN-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ...
  ; GCN-NEXT:   [[COPY20:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
...
define amdgpu_kernel void @test_call_external_i1_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY12]], [[C]](i64)
  ; GCN-NEXT:   [[COPY13:%[0-9]+]]:_(i64) = COPY [[COPY6]]
  ; GCN-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY5]]
  ; GCN-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY4]]
  ; GCN-NEXT:   [[COPY16:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC]](i1), [[DEF]](p1) :: (volatile store (i1) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_gfx void @test_gfx_call_external_i1_func_void() #0 {
  ...
  ; GCN-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY]](<4 x i32>)
...
define amdgpu_kernel void @test_call_external_i1_zeroext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[ZEXT]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i1_signext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[SEXT]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i8_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC1]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i16_func_void() #0 {
  ...
  ; GCN-NEXT:   [[TRUNC:%[0-9]+]]:_(i16) = G_TRUNC [[COPY21]](i32)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC]](i16), [[DEF]](p1) :: (volatile store (i16) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[COPY21:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY21]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_gfx void @test_gfx_call_external_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[COPY1:%[0-9]+]]:_(i32) = COPY $vgpr0
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY1]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   SI_RETURN
...
define amdgpu_kernel void @test_call_external_i48_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC]](i48), [[DEF]](p1) :: (volatile store (i48) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i48_zeroext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[ZEXT]](i64), [[DEF]](p1) :: (volatile store (i64) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i48_signext_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[SEXT]](i64), [[DEF]](p1) :: (volatile store (i64) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i64_func_void() #0 {
  ...
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY21]](i32), [[COPY22]](i32)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[MV]](i64), [[DEF]](p1) :: (volatile store (i64) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_f16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BITCAST]](f16), [[DEF]](p1) :: (volatile store (f16) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_f32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY21]](f32), [[DEF]](p1) :: (volatile store (f32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_f64_func_void() #0 {
  ...
  ; GCN-NEXT:   [[COPY22:%[0-9]+]]:_(i32) = COPY $vgpr1
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY21]](i32), [[COPY22]](i32)
  ; GCN-NEXT:   [[BITCAST:%[0-9]+]]:_(f64) = G_BITCAST [[MV]](i64)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BITCAST]](f64), [[DEF]](p1) :: (volatile store (f64) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2f64_func_void() #0 {
  ...
  ; GCN-NEXT:   [[MV:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY21]](i32), [[COPY22]](i32)
  ; GCN-NEXT:   [[BITCAST:%[0-9]+]]:_(f64) = G_BITCAST [[MV]](i64)
  ; GCN-NEXT:   [[MV1:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY23]](i32), [[COPY24]](i32)
  ; GCN-NEXT:   [[BITCAST1:%[0-9]+]]:_(f64) = G_BITCAST [[MV1]](i64)
  ; GCN-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<2 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<2 x f64>), [[DEF]](p1) :: (volatile store (<2 x f64>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<2 x i32>), [[DEF]](p1) :: (volatile store (<2 x i32>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v3i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<3 x i32>), [[DEF]](p1) :: (volatile store (<3 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v4i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<4 x i32>), [[DEF]](p1) :: (volatile store (<4 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v5i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<5 x i32>), [[DEF]](p1) :: (volatile store (<5 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v8i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<8 x i32>), [[DEF]](p1) :: (volatile store (<8 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v16i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<16 x i32>), [[DEF]](p1) :: (volatile store (<16 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v32i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<32 x i32>), [[DEF]](p1) :: (volatile store (<32 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2i16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY21]](<2 x i16>), [[DEF]](p1) :: (volatile store (<2 x i16>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v3i16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<3 x i16>), [[DEF]](p1) :: (volatile store (<3 x i16>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v4i16_func_void() #0 {
  ...
  ; GCN-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<4 x i16>) = G_CONCAT_VECTORS [[COPY21]](<2 x i16>), [[COPY22]](<2 x i16>)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[CONCAT_VECTORS]](<4 x i16>), [[DEF]](p1) :: (volatile store (<4 x i16>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v2f16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY21]](<2 x f16>), [[DEF]](p1) :: (volatile store (<2 x f16>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v3f16_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<3 x f16>), [[DEF]](p1) :: (volatile store (<3 x f16>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v4f16_func_void() #0 {
  ...
  ; GCN-NEXT:   [[CONCAT_VECTORS:%[0-9]+]]:_(<4 x f16>) = G_CONCAT_VECTORS [[COPY21]](<2 x f16>), [[COPY22]](<2 x f16>)
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[CONCAT_VECTORS]](<4 x f16>), [[DEF]](p1) :: (volatile store (<4 x f16>) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v3f32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<3 x f32>), [[DEF]](p1) :: (volatile store (<3 x f32>) into `ptr addrspace(1) undef`, align 16, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v5f32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[BUILD_VECTOR]](<5 x f32>), [[DEF]](p1) :: (volatile store (<5 x f32>) into `ptr addrspace(1) undef`, align 32, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_a2i32_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[COPY21]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[COPY22]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_a5i8_func_void() #0 {
  ...
  ; GCN-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; GCN-NEXT:   G_STORE [[TRUNC1]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC3]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC5]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC7]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[TRUNC9]](i8), [[DEF]](p1) :: (volatile store (i8) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v32i32_i32_func_void() #0 {
  ...
  ; GCN-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p5) = G_PTR_ADD [[FRAME_INDEX]], [[C3]](i32)
  ; GCN-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD [[PTR_ADD1]](p5) :: (load (i32) from %stack.0, align 128, addrspace 5)
  ; GCN-NEXT:   G_STORE [[LOAD]](<32 x i32>), [[DEF]](p1) :: (volatile store (<32 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   G_STORE [[LOAD1]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_i32_v32i32_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[LOAD]](i32), [[DEF]](p1) :: (volatile store (i32) into `ptr addrspace(1) undef`, addrspace 1)
  ; GCN-NEXT:   G_STORE [[LOAD1]](<32 x i32>), [[DEF]](p1) :: (volatile store (<32 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v33i32_func_void() #0 {
  ...
  ; GCN-NEXT:   G_STORE [[LOAD]](<33 x i32>), [[DEF]](p1) :: (volatile store (<33 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @test_call_external_v33i32_func_v33i32_i32(ptr addrspace(1) %p, i32 %idx) #0 {
  ...
  ; GCN-NEXT:   %18:_(p4) = nuw nusw G_PTR_ADD [[INT]], [[C]](i64)
  ; GCN-NEXT:   [[LOAD1:%[0-9]+]]:_(i32) = G_LOAD %18(p4) :: (dereferenceable invariant load (i32) from %ir.idx.kernarg.offset, align 8, addrspace 4)
  ; GCN-NEXT:   [[FRAME_INDEX:%[0-9]+]]:_(p5) = G_FRAME_INDEX %stack.0
  ; GCN-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ...
  ; GCN-NEXT:   G_STORE [[LOAD2]](<33 x i32>), [[DEF]](p1) :: (volatile store (<33 x i32>) into `ptr addrspace(1) undef`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
