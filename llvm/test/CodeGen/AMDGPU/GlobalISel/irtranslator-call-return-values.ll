...
define amdgpu_kernel void @test_call_external_v33i32_func_v33i32_i32(ptr addrspace(1) %p, i32 %idx) #0 {
  ...
  ; GCN-NEXT:   [[C:%[0-9]+]]:_(s32) = G_CONSTANT i32 2
  ...
  ; GCN-NEXT:   G_STORE [[LOAD1]](<33 x s32>), [[DEF1]](p1) :: (volatile store (<33 x s32>) into `ptr addrspace(1) poison`, align 8, addrspace 1)
  ; GCN-NEXT:   S_ENDPGM 0
