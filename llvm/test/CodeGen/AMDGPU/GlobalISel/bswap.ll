...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -o - %s | FileCheck -check-prefix=GFX11 %s
...
;
; GFX11-LABEL: v_bswap_i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_perm_b32 v0, 0, v0, 0x10203
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_bswap_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s2, 0x10203
; GFX11-NEXT:    v_perm_b32 v0, 0, s0, s2
; GFX11-NEXT:    v_perm_b32 v1, 0, s1, s2
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_bswap_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b32 s0, 0x10203
; GFX11-NEXT:    v_perm_b32 v0, 0, v0, s0
; GFX11-NEXT:    v_perm_b32 v1, 0, v1, s0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %bswap = call <2 x i32> @llvm.bswap.v2i32(<2 x i32> %src)
  ret <2 x i32> %bswap
}
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_bswap_i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s2, 0x10203
; GFX11-NEXT:    v_perm_b32 v0, 0, s1, s2
; GFX11-NEXT:    v_perm_b32 v1, 0, s0, s2
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_bswap_i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b32 s0, 0x10203
; GFX11-NEXT:    v_perm_b32 v2, 0, v1, s0
; GFX11-NEXT:    v_perm_b32 v1, 0, v0, s0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_bswap_v2i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s4, 0x10203
; GFX11-NEXT:    v_perm_b32 v0, 0, s1, s4
; GFX11-NEXT:    v_perm_b32 v1, 0, s0, s4
; GFX11-NEXT:    v_perm_b32 v2, 0, s3, s4
; GFX11-NEXT:    v_perm_b32 v3, 0, s2, s4
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_bswap_v2i64:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b32 s0, 0x10203
; GFX11-NEXT:    v_perm_b32 v4, 0, v1, s0
; GFX11-NEXT:    v_perm_b32 v5, 0, v3, s0
; GFX11-NEXT:    v_perm_b32 v1, 0, v0, s0
; GFX11-NEXT:    v_perm_b32 v3, 0, v2, s0
; GFX11-NEXT:    v_mov_b32_e32 v0, v4
; GFX11-NEXT:    v_mov_b32_e32 v2, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %bswap = call <2 x i64> @llvm.bswap.v2i64(<2 x i64> %src)
  ret <2 x i64> %bswap
}
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_perm_b32 v0, 0, s0, 0xc0c0001
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_bswap_v2i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_perm_b32 v0, 0, s0, 0x2030001
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_mov_b32 s0, 0x10203
; GFX11-NEXT:    v_perm_b32 v1, 0, v1, s0
; GFX11-NEXT:    v_perm_b32 v2, 0, v0, s0
; GFX11-NEXT:    v_lshrrev_b64 v[0:1], 16, v[1:2]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
