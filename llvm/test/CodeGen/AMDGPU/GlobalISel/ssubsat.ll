...
; GFX11-NEXT:    v_pk_ashrrev_i16 v0, 8, v0 op_sel_hi:[0,1]
; GFX11-NEXT:    v_pk_sub_i16 v1, v3, v1 clamp
...
; GFX11-NEXT:    v_pk_sub_i16 v0, s2, s4 clamp
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_i24:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_lshl_b32 s0, s0, 8
; GFX11-NEXT:    s_lshl_b32 s1, s1, 8
; GFX11-NEXT:    v_sub_nc_i32 v0, s0, s1 clamp
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 8, v0
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i24 @llvm.ssub.sat.i24(i24 %lhs, i24 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_i32_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i32 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.ssub.sat.i32(i32 %lhs, i32 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_i32_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i32 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i32 @llvm.ssub.sat.i32(i32 %lhs, i32 %rhs)
  %cast = bitcast i32 %result to float
  ret float %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i32 v0, s0, s2 clamp
; GFX11-NEXT:    v_sub_nc_i32 v1, s1, s3 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v3i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i32 v0, s0, s3 clamp
; GFX11-NEXT:    v_sub_nc_i32 v1, s1, s4 clamp
; GFX11-NEXT:    v_sub_nc_i32 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i32 v0, s0, s4 clamp
; GFX11-NEXT:    v_sub_nc_i32 v1, s1, s5 clamp
; GFX11-NEXT:    v_sub_nc_i32 v2, s2, s6 clamp
; GFX11-NEXT:    v_sub_nc_i32 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ssubsat_v5i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_i32 v0, v0, v5 clamp
; GFX11-NEXT:    v_sub_nc_i32 v1, v1, v6 clamp
; GFX11-NEXT:    v_sub_nc_i32 v2, v2, v7 clamp
; GFX11-NEXT:    v_sub_nc_i32 v3, v3, v8 clamp
; GFX11-NEXT:    v_sub_nc_i32 v4, v4, v9 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i16 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.ssub.sat.i16(i16 %lhs, i16 %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_nc_i16 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call i16 @llvm.ssub.sat.i16(i16 %lhs, i16 %rhs)
  %cast = bitcast i16 %result to half
  ret half %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_v2i16_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_i16 v0, s0, v0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.ssub.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: ssubsat_v2i16_vs:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_i16 v0, v0, s0 clamp
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <2 x i16> @llvm.ssub.sat.v2i16(<2 x i16> %lhs, <2 x i16> %rhs)
  %cast = bitcast <2 x i16> %result to float
  ret float %cast
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v4i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_i16 v0, s0, s2 clamp
; GFX11-NEXT:    v_pk_sub_i16 v1, s1, s3 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    ; return to shader part epilog
  %result = call <4 x i16> @llvm.ssub.sat.v4i16(<4 x i16> %lhs, <4 x i16> %rhs)
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ssubsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_sub_i16 v0, v0, v3 clamp
; GFX11-NEXT:    v_pk_sub_i16 v1, v1, v4 clamp
; GFX11-NEXT:    v_pk_sub_i16 v2, v2, v5 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v6i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_i16 v0, s0, s3 clamp
; GFX11-NEXT:    v_pk_sub_i16 v1, s1, s4 clamp
; GFX11-NEXT:    v_pk_sub_i16 v2, s2, s5 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_ssubsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_sub_i16 v0, v0, v4 clamp
; GFX11-NEXT:    v_pk_sub_i16 v1, v1, v5 clamp
; GFX11-NEXT:    v_pk_sub_i16 v2, v2, v6 clamp
; GFX11-NEXT:    v_pk_sub_i16 v3, v3, v7 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_ssubsat_v8i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_pk_sub_i16 v0, s0, s4 clamp
; GFX11-NEXT:    v_pk_sub_i16 v1, s1, s5 clamp
; GFX11-NEXT:    v_pk_sub_i16 v2, s2, s6 clamp
; GFX11-NEXT:    v_pk_sub_i16 v3, s3, s7 clamp
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_co_u32_e64 v2, vcc_lo, s0, v0
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v3, vcc_lo, s1, v1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_i64_e32 vcc_lo, 0, v[0:1]
...
; GFX11-NEXT:    v_cmp_gt_i64_e64 s1, s[0:1], 0
; GFX11-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
...
; GFX6-NEXT:    s_ashr_i64 s[0:1], s[10:11], s0
...
; GFX8-NEXT:    s_ashr_i64 s[0:1], s[10:11], s0
...
; GFX9-NEXT:    s_ashr_i64 s[0:1], s[10:11], s0
...
; GFX10-NEXT:    s_ashr_i64 s[0:1], s[10:11], s0
...
; GFX6-NEXT:    v_xor_b32_e32 v2, v0, v8
...
; GFX8-NEXT:    v_xor_b32_e32 v2, v0, v8
...
; GFX9-NEXT:    v_xor_b32_e32 v2, v0, v8
...
; GFX10-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc_lo
; GFX10-NEXT:    v_xor_b32_e32 v2, v0, v8
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_co_u32_e64 v4, vcc_lo, s0, v0
...
; GFX11-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc_lo
; GFX11-NEXT:    v_xor_b32_e32 v2, v0, v8
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_sub_co_u32_e64 v4, vcc_lo, v0, s0
...
; GFX6-NEXT:    v_ashrrev_i32_e32 v3, 31, v19
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
...
; GFX6-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc
; GFX6-NEXT:    v_xor_b32_e32 v2, v1, v0
; GFX6-NEXT:    v_ashr_i64 v[0:1], v[18:19], s4
; GFX6-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, 0, v0
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX8-NEXT:    v_ashrrev_i32_e32 v3, 31, v19
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc
; GFX8-NEXT:    v_xor_b32_e32 v2, v1, v0
; GFX8-NEXT:    v_ashrrev_i64 v[0:1], s4, v[18:19]
; GFX8-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, 0, v0
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX9-NEXT:    v_ashrrev_i32_e32 v3, 31, v19
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc
; GFX9-NEXT:    v_xor_b32_e32 v2, v1, v0
; GFX9-NEXT:    v_ashrrev_i64 v[0:1], s4, v[18:19]
; GFX9-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
...
; GFX10-NEXT:    v_ashrrev_i64 v[0:1], s6, v[18:19]
; GFX10-NEXT:    v_and_b32_e32 v2, 1, v2
...
; GFX10-NEXT:    v_ashrrev_i64 v[3:4], s6, v[10:11]
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v18, v5, s4
; GFX10-NEXT:    v_ashrrev_i32_e32 v5, 31, v11
; GFX10-NEXT:    v_and_b32_e32 v7, 1, v7
; GFX10-NEXT:    v_add_co_u32 v12, vcc_lo, v3, 0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v8, v12, s5
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v10, v7, s5
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v9, v13, s5
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_co_u32_e64 v16, vcc_lo, v0, v8
...
; GFX11-NEXT:    v_cndmask_b32_e32 v1, v9, v8, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v8, vcc_lo, v4, v12
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v9, vcc_lo, v5, v13, vcc_lo
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v10, vcc_lo, v6, v14, vcc_lo
; GFX11-NEXT:    v_xor_b32_e32 v2, v1, v0
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v11, vcc_lo, v7, v15, vcc_lo
; GFX11-NEXT:    v_cmp_lt_u64_e64 s0, v[8:9], v[4:5]
; GFX11-NEXT:    v_ashrrev_i64 v[0:1], s2, v[18:19]
; GFX11-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX11-NEXT:    v_cmp_eq_u64_e64 s1, v[10:11], v[6:7]
; GFX11-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s0
; GFX11-NEXT:    v_cmp_lt_i64_e64 s0, v[10:11], v[6:7]
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc_lo, v0, 0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s0
; GFX11-NEXT:    v_cmp_lt_u64_e64 s0, 0, v[12:13]
; GFX11-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s0
; GFX11-NEXT:    v_cmp_lt_i64_e64 s0, 0, v[14:15]
...
; GFX11-NEXT:    v_cndmask_b32_e64 v4, v13, v12, s1
; GFX11-NEXT:    v_xor_b32_e32 v7, v4, v2
; GFX11-NEXT:    v_ashrrev_i64 v[3:4], s2, v[10:11]
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v18, v5, s0
; GFX11-NEXT:    v_ashrrev_i32_e32 v5, 31, v11
; GFX11-NEXT:    v_and_b32_e32 v7, 1, v7
; GFX11-NEXT:    v_add_co_u32_e64 v12, vcc_lo, v3, 0
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v19, v6, s0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v13, vcc_lo, 0, v4, vcc_lo
...
; GFX11-NEXT:    v_cndmask_b32_e64 v4, v8, v12, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v6, v10, v7, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v9, v13, s1
; GFX11-NEXT:    v_cndmask_b32_e64 v7, v11, v14, s1
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_sub_i32 s8, 0x7f, 64
; GFX6-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
...
; GFX6-NEXT:    s_ashr_i64 s[0:1], s[18:19], s8
; GFX6-NEXT:    s_add_u32 s0, s0, 0
; GFX6-NEXT:    s_cselect_b32 s2, 1, 0
; GFX6-NEXT:    s_and_b32 s2, s2, 1
; GFX6-NEXT:    s_cmp_lg_u32 s2, 0
...
; GFX6-NEXT:    s_ashr_i64 s[4:5], s[2:3], s8
...
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; GFX8-NEXT:    s_and_b32 s0, 1, s2
; GFX8-NEXT:    s_sub_i32 s8, 0x7f, 64
; GFX8-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s0
; GFX8-NEXT:    s_ashr_i32 s3, s19, 31
; GFX8-NEXT:    s_ashr_i64 s[0:1], s[18:19], s8
; GFX8-NEXT:    s_add_u32 s0, s0, 0
; GFX8-NEXT:    s_cselect_b32 s2, 1, 0
; GFX8-NEXT:    s_and_b32 s2, s2, 1
; GFX8-NEXT:    s_cmp_lg_u32 s2, 0
...
; GFX8-NEXT:    s_ashr_i64 s[4:5], s[2:3], s8
...
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; GFX9-NEXT:    s_and_b32 s0, 1, s2
; GFX9-NEXT:    s_sub_i32 s8, 0x7f, 64
; GFX9-NEXT:    v_cmp_ne_u32_e64 vcc, 0, s0
; GFX9-NEXT:    s_ashr_i32 s3, s19, 31
; GFX9-NEXT:    s_ashr_i64 s[0:1], s[18:19], s8
; GFX9-NEXT:    s_add_u32 s0, s0, 0
; GFX9-NEXT:    s_cselect_b32 s2, 1, 0
; GFX9-NEXT:    s_and_b32 s2, s2, 1
; GFX9-NEXT:    s_cmp_lg_u32 s2, 0
...
; GFX9-NEXT:    s_ashr_i64 s[4:5], s[2:3], s8
...
; GFX10-NEXT:    s_ashr_i64 s[0:1], s[18:19], s10
; GFX10-NEXT:    s_add_u32 s0, s0, 0
; GFX10-NEXT:    s_cselect_b32 s2, 1, 0
; GFX10-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc_lo
; GFX10-NEXT:    s_and_b32 s2, s2, 1
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s0
; GFX11-NEXT:    s_cselect_b32 s0, 1, 0
; GFX11-NEXT:    s_ashr_i32 s3, s19, 31
; GFX11-NEXT:    s_and_b32 s0, 1, s0
; GFX11-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
...
; GFX11-NEXT:    s_ashr_i64 s[0:1], s[18:19], s10
; GFX11-NEXT:    s_add_u32 s0, s0, 0
; GFX11-NEXT:    s_cselect_b32 s2, 1, 0
; GFX11-NEXT:    v_cndmask_b32_e32 v1, v2, v1, vcc_lo
; GFX11-NEXT:    s_and_b32 s2, s2, 1
...
; GFX11-NEXT:    s_cmp_lg_u32 s8, 0
; GFX11-NEXT:    v_cmp_gt_u64_e64 s3, s[12:13], 0
...
; GFX11-NEXT:    s_cmp_lg_u32 s9, 0
; GFX11-NEXT:    s_subb_u32 s9, s7, s15
...
; GFX11-NEXT:    v_cmp_gt_i64_e64 s3, s[14:15], 0
