...
; GCN-NEXT:    v_and_or_b32 v7, v0, v6, v1
; GCN-NEXT:    v_and_or_b32 v2, v2, v6, v3
; GCN-NEXT:    image_sample_d_g16 v[0:3], [v7, v2, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_and_or_b32 v11, v1, v7, v2
; GCN-NEXT:    v_and_or_b32 v2, v3, v7, v4
; GCN-NEXT:    image_sample_c_d_g16 v[0:3], [v0, v11, v2, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_mov_b32_e32 v7, 0xffff
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v0, v0, v7, s12
; GCN-NEXT:    v_and_or_b32 v1, v1, v7, s12
...
; GCN-NEXT:    v_and_or_b32 v11, v0, v7, v1
; GCN-NEXT:    v_and_or_b32 v1, v2, v7, v9
; GCN-NEXT:    image_sample_d_cl_g16 v[0:3], [v11, v1, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v1, v1, v7, s12
; GCN-NEXT:    v_and_or_b32 v2, v2, v7, s12
...
; GFX11-NEXT:    v_and_or_b32 v4, v9, v10, v4
; GFX11-NEXT:    v_and_or_b32 v3, v1, v10, v3
