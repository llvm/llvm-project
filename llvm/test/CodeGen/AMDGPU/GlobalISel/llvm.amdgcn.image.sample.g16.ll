...
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -check-prefixes=GCN %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GCN %s
...
; GCN-NEXT:    v_and_or_b32 v0, v0, v6, v1
; GCN-NEXT:    v_and_or_b32 v1, v2, v6, v3
; GCN-NEXT:    image_sample_d_g16 v[0:3], [v0, v1, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_mov_b32_e32 v11, 0xffff
; GCN-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v3, v9, v11, s12
; GCN-NEXT:    v_and_or_b32 v4, v10, v11, v4
; GCN-NEXT:    v_and_or_b32 v2, v0, v11, v1
; GCN-NEXT:    v_and_or_b32 v5, v5, v11, s12
; GCN-NEXT:    image_sample_d_g16 v[0:3], v[2:8], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GCN-NEXT:    v_and_or_b32 v1, v1, v7, v2
; GCN-NEXT:    v_and_or_b32 v2, v3, v7, v4
; GCN-NEXT:    image_sample_c_d_g16 v[0:3], [v0, v1, v2, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_and_or_b32 v4, v9, v0, v4
; GCN-NEXT:    v_and_or_b32 v3, v1, v0, v3
; GCN-NEXT:    image_sample_c_d_cl_g16 v[0:3], v[2:7], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_and_or_b32 v5, v11, v0, v5
; GCN-NEXT:    v_and_or_b32 v4, v10, v0, v1
; GCN-NEXT:    image_sample_c_d_o_g16 v0, v[2:8], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_and_or_b32 v5, v11, v0, v5
; GCN-NEXT:    v_and_or_b32 v4, v10, v0, v1
; GCN-NEXT:    image_sample_c_d_o_g16 v[0:1], v[2:8], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
