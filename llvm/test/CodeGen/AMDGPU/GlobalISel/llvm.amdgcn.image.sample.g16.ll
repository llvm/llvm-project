...
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v0, v0, v3, s12
; GCN-NEXT:    v_and_or_b32 v1, v1, v3, s12
; GCN-NEXT:    image_sample_d_g16 v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX11-NEXT:    v_and_or_b32 v0, v0, v3, s12
; GFX11-NEXT:    v_and_or_b32 v1, v1, v3, s12
...
; GFX11:       ; %bb.0: ; %main_body
; GFX11-NEXT:    v_dual_mov_b32 v6, 0xffff :: v_dual_lshlrev_b32 v1, 16, v1
; GFX11-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX11-NEXT:    v_and_or_b32 v0, v0, v6, v1
; GFX11-NEXT:    v_and_or_b32 v1, v2, v6, v3
...
; GFX11:       ; %bb.0: ; %main_body
; GFX11-NEXT:    v_dual_mov_b32 v9, v2 :: v_dual_lshlrev_b32 v4, 16, v4
; GFX11-NEXT:    v_dual_mov_b32 v10, v3 :: v_dual_lshlrev_b32 v1, 16, v1
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    v_mov_b32_e32 v4, 0xffff
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v1, v1, v4, s12
; GCN-NEXT:    v_and_or_b32 v2, v2, v4, s12
; GCN-NEXT:    image_sample_c_d_g16 v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_lshl_b32 s12, s0, 16
; GFX11-NEXT:    v_and_or_b32 v1, v1, v4, s12
; GFX11-NEXT:    v_and_or_b32 v2, v2, v4, s12
...
; GFX11:       ; %bb.0: ; %main_body
; GFX11-NEXT:    v_dual_mov_b32 v7, 0xffff :: v_dual_lshlrev_b32 v4, 16, v4
; GFX11-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX11-NEXT:    v_and_or_b32 v1, v1, v7, v2
; GFX11-NEXT:    v_and_or_b32 v2, v3, v7, v4
...
; GCN-NEXT:    v_mov_b32_e32 v4, 0xffff
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v0, v0, v4, s12
; GCN-NEXT:    v_and_or_b32 v1, v1, v4, s12
; GCN-NEXT:    image_sample_d_cl_g16 v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0xffff
; GFX11-NEXT:    s_lshl_b32 s12, s0, 16
; GFX11-NEXT:    v_and_or_b32 v0, v0, v4, s12
; GFX11-NEXT:    v_and_or_b32 v1, v1, v4, s12
...
; GCN-NEXT:    v_and_or_b32 v0, v0, v7, v1
; GCN-NEXT:    v_and_or_b32 v1, v2, v7, v3
; GCN-NEXT:    image_sample_d_cl_g16 v[0:3], [v0, v1, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX11-NEXT:    v_and_or_b32 v0, v0, v7, v1
; GFX11-NEXT:    v_and_or_b32 v1, v2, v7, v3
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    v_mov_b32_e32 v5, 0xffff
; GCN-NEXT:    s_lshl_b32 s12, s0, 16
; GCN-NEXT:    v_and_or_b32 v1, v1, v5, s12
; GCN-NEXT:    v_and_or_b32 v2, v2, v5, s12
; GCN-NEXT:    image_sample_c_d_cl_g16 v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    s_lshl_b32 s12, s0, 16
; GFX11-NEXT:    v_and_or_b32 v1, v1, v5, s12
; GFX11-NEXT:    v_and_or_b32 v2, v2, v5, s12
...
; GFX11-NEXT:    v_dual_mov_b32 v9, v3 :: v_dual_lshlrev_b32 v4, 16, v4
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    v_dual_mov_b32 v0, 0xffff :: v_dual_lshlrev_b32 v3, 16, v8
; GFX11-NEXT:    v_and_or_b32 v4, v9, v0, v4
; GFX11-NEXT:    v_and_or_b32 v3, v1, v0, v3
; GFX11-NEXT:    image_sample_c_d_cl_g16 v[0:3], v[2:7], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    v_mov_b32_e32 v11, v4
; GFX11-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_lshlrev_b32 v5, 16, v5
; GFX11-NEXT:    v_mov_b32_e32 v3, v1
; GFX11-NEXT:    v_dual_mov_b32 v0, 0xffff :: v_dual_lshlrev_b32 v1, 16, v9
; GFX11-NEXT:    v_and_or_b32 v5, v11, v0, v5
; GFX11-NEXT:    v_and_or_b32 v4, v10, v0, v1
; GFX11-NEXT:    image_sample_c_d_o_g16 v0, v[2:8], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    v_and_or_b32 v5, v11, v0, v5
; GFX11-NEXT:    v_and_or_b32 v4, v10, v0, v1
; GFX11-NEXT:    image_sample_c_d_o_g16 v[0:1], v[2:8], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
main_body:
