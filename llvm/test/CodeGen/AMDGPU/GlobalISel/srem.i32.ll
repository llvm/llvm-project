...
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, 0, v1
; GISEL-NEXT:    v_max_i32_e32 v1, v2, v1
; GISEL-NEXT:    v_cvt_f32_u32_e32 v2, v1
; GISEL-NEXT:    v_sub_i32_e32 v3, vcc, 0, v1
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, 0, v0
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; GISEL-NEXT:    v_max_i32_e32 v4, v4, v0
...
; GISEL-NEXT:    v_mul_hi_u32 v2, v4, v2
; GISEL-NEXT:    v_mul_lo_u32 v2, v2, v1
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v4, v2
; GISEL-NEXT:    v_sub_i32_e32 v3, vcc, v2, v1
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GISEL-NEXT:    v_sub_i32_e32 v3, vcc, v2, v1
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; GISEL-NEXT:    v_xor_b32_e32 v1, v1, v0
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v0
...
; GISEL-NEXT:    s_abs_i32 s2, s0
; GISEL-NEXT:    v_mul_hi_u32 v1, v0, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v0, s2, v0
; GISEL-NEXT:    v_readfirstlane_b32 s3, v0
; GISEL-NEXT:    s_mul_i32 s3, s3, s1
; GISEL-NEXT:    s_sub_i32 s2, s2, s3
; GISEL-NEXT:    s_sub_i32 s3, s2, s1
; GISEL-NEXT:    s_cmp_ge_u32 s2, s1
; GISEL-NEXT:    s_cselect_b32 s2, s3, s2
; GISEL-NEXT:    s_sub_i32 s3, s2, s1
; GISEL-NEXT:    s_cmp_ge_u32 s2, s1
; GISEL-NEXT:    s_cselect_b32 s1, s3, s2
; GISEL-NEXT:    s_ashr_i32 s0, s0, 31
; GISEL-NEXT:    s_xor_b32 s1, s1, s0
; GISEL-NEXT:    s_sub_i32 s0, s1, s0
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, 0, v2
; GISEL-NEXT:    v_max_i32_e32 v2, v4, v2
; GISEL-NEXT:    v_cvt_f32_u32_e32 v4, v2
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, 0, v3
; GISEL-NEXT:    v_max_i32_e32 v3, v5, v3
...
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, 0, v0
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v6, v6
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v4
; GISEL-NEXT:    v_max_i32_e32 v7, v7, v0
; GISEL-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GISEL-NEXT:    v_mul_hi_u32 v5, v4, v5
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GISEL-NEXT:    v_mul_f32_e32 v5, 0x4f7ffffe, v6
...
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, v4, v2
...
; GISEL-NEXT:    v_max_i32_e32 v6, v6, v1
; GISEL-NEXT:    v_mul_hi_u32 v5, v6, v5
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, v4, v2
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v2
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v4, v7, vcc
; GISEL-NEXT:    v_mul_lo_u32 v4, v5, v3
; GISEL-NEXT:    v_xor_b32_e32 v2, v2, v0
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v2, v0
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v6, v4
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, v2, v3
...
; GISEL-NEXT:    v_xor_b32_e32 v2, v2, v1
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v2, v1
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_mov_b32 s4, 0xd9528441
; GISEL-NEXT:    v_mul_hi_i32 v2, v0, s4
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v0
; GISEL-NEXT:    v_lshrrev_b32_e32 v3, 31, v2
; GISEL-NEXT:    v_ashrrev_i32_e32 v2, 20, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_mul_hi_i32 v3, v1, s4
; GISEL-NEXT:    v_mul_i32_i24_e32 v2, 0x12d8fb, v2
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v3, v1
; GISEL-NEXT:    v_lshrrev_b32_e32 v3, 31, v2
; GISEL-NEXT:    v_ashrrev_i32_e32 v2, 20, v2
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_mul_i32_i24_e32 v2, 0x12d8fb, v2
...
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, 0, v0
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; CHECK-NEXT:    v_max_i32_e32 v4, v4, v0
...
; CHECK-NEXT:    v_sub_i32_e32 v3, vcc, v2, v1
...
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v4, v4
; GISEL-NEXT:    v_sub_i32_e32 v6, vcc, 0, v3
; GISEL-NEXT:    v_max_i32_e32 v3, v6, v3
; GISEL-NEXT:    v_mul_f32_e32 v4, 0x4f7ffffe, v4
; GISEL-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GISEL-NEXT:    v_cvt_f32_u32_e32 v6, v3
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, 0, v0
...
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GISEL-NEXT:    v_max_i32_e32 v5, v7, v0
; GISEL-NEXT:    v_mul_hi_u32 v4, v5, v4
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, 0, v3
; GISEL-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GISEL-NEXT:    v_mul_lo_u32 v4, v4, v2
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, v5, v4
; GISEL-NEXT:    v_mul_lo_u32 v5, v7, v6
; GISEL-NEXT:    v_sub_i32_e32 v7, vcc, v4, v2
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v4, v2
; GISEL-NEXT:    v_mul_hi_u32 v5, v6, v5
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v4, v7, vcc
...
; GISEL-NEXT:    v_mad_f32 v3, -v4, v2, v3
; GISEL-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v3|, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v4, v2
; GISEL-NEXT:    v_mul_lo_u32 v1, v2, v1
...
; GISEL-NEXT:    v_rcp_f32_e32 v6, v4
; GISEL-NEXT:    v_cvt_f32_u32_e32 v7, v3
; GISEL-NEXT:    v_and_b32_e32 v1, 0xffffff, v1
; GISEL-NEXT:    v_mul_f32_e32 v6, v5, v6
; GISEL-NEXT:    v_trunc_f32_e32 v6, v6
; GISEL-NEXT:    v_mad_f32 v5, -v6, v4, v5
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v5|, v4
; GISEL-NEXT:    v_cvt_u32_f32_e32 v5, v6
; GISEL-NEXT:    v_cvt_f32_u32_e32 v6, v1
; GISEL-NEXT:    v_rcp_f32_e32 v8, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; GISEL-NEXT:    v_mul_lo_u32 v2, v4, v2
; GISEL-NEXT:    v_mul_f32_e32 v4, v6, v8
; GISEL-NEXT:    v_trunc_f32_e32 v4, v4
; GISEL-NEXT:    v_mad_f32 v5, -v4, v7, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v5|, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GISEL-NEXT:    v_mul_lo_u32 v3, v4, v3
; GISEL-NEXT:    v_and_b32_e32 v0, 0xffffff, v0
