...
; RUN: llc -global-isel -mtriple=amdgpu12.00-amd-amdpal -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX12 %s
...
; GFX11-NEXT:    global_load_i8 v3, v4, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_u8 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-NEXT:    global_load_i8 v3, v4, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_u8 v2, v4, s[2:3] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    global_load_i8 v3, v4, s[0:1]
; GFX11-NEXT:    global_load_i8 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    s_add_i32 s0, s0, s1
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_u8 v3, v4, s[0:1]
; GFX11-NEXT:    global_load_u8 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_i16 v3, v4, s[0:1]
; GFX11-NEXT:    global_load_i16 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    s_add_i32 s0, s0, s1
...
; GFX12-NEXT:    global_load_i16 v3, v4, s[0:1]
; GFX12-NEXT:    global_load_i16 v2, v4, s[2:3] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v3
; GFX12-NEXT:    v_readfirstlane_b32 s1, v2
; GFX12-NEXT:    s_add_co_i32 s0, s0, s1
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_u16 v3, v4, s[0:1]
; GFX11-NEXT:    global_load_u16 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    s_add_i32 s0, s0, s1
...
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_u16 v3, v4, s[0:1]
; GFX12-NEXT:    global_load_u16 v2, v4, s[2:3] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v3
; GFX12-NEXT:    v_readfirstlane_b32 s1, v2
; GFX12-NEXT:    s_add_co_i32 s0, s0, s1
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-NEXT:    global_load_d16_i8 v3, v4, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_d16_u8 v2, v4, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v3
; GFX11-NEXT:    v_readfirstlane_b32 s1, v2
; GFX11-NEXT:    s_add_i32 s0, s0, s1
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    global_load_d16_i8 v3, v4, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_d16_u8 v2, v4, s[2:3] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v3
; GFX12-NEXT:    v_readfirstlane_b32 s1, v2
; GFX12-NEXT:    s_add_co_i32 s0, s0, s1
...
; GFX11-NEXT:    global_store_b16 v[0:1], v2, off
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_d16_i8 v2, v4, s[0:1]
; GFX11-NEXT:    global_load_d16_u8 v3, v4, s[2:3]
...
; GFX12-NEXT:    global_store_b16 v[0:1], v2, off
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_d16_i8 v2, v4, s[0:1]
; GFX12-NEXT:    global_load_d16_u8 v3, v4, s[2:3]
