...
; RUN: llc -global-isel -mtriple=amdgpu9.0a-amd-amdhsa -stop-after=amdgpu-reg-bank-legalize -regbankselect-fast -o - %s | FileCheck %s
; RUN: llc -global-isel -mtriple=amdgpu9.0a-amd-amdhsa -stop-after=amdgpu-reg-bank-legalize -regbankselect-greedy -o - %s | FileCheck %s
...
define amdgpu_ps void @test_uniform_indirect_call_p0(ptr inreg %fptr) {
  ...
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY2]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[MV]](p0), 0, csr_amdgpu_si_gfx_gfx90ainsts, implicit $sgpr0_3
...
define amdgpu_ps void @test_divergent_indirect_call_p0(ptr %fptr) {
  ...
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sgpr(<4 x s32>) = COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY2]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[MV1]](p0), 0, csr_amdgpu_si_gfx_gfx90ainsts, implicit $sgpr0_3
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define amdgpu_ps i32 @test_divergent_indirect_call_p0_with_args(ptr %fptr, i32 %arg) {
  ...
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY3]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[MV1]](p0), 0, csr_amdgpu_si_gfx_gfx90ainsts, implicit $vgpr0, implicit $sgpr0_3, implicit-def $vgpr0
...
define amdgpu_kernel void @test_uniform_indirect_call_from_kernel(ptr %fptr) {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $vgpr0, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:sgpr(p4) = COPY $sgpr8_9
  ...
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[LOAD]](p0), 0, csr_amdgpu_gfx90ainsts, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; CHECK-NEXT:   S_ENDPGM 0
  call void %fptr()
  ret void
