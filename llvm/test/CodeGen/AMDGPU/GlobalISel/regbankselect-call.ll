...
; RUN: llc -global-isel -mtriple=amdgpu9.0a-amd-amdhsa -stop-after=amdgpu-regbanklegalize -regbankselect-fast -o - %s | FileCheck %s
; RUN: llc -global-isel -mtriple=amdgpu9.0a-amd-amdhsa -stop-after=amdgpu-regbanklegalize -regbankselect-greedy -o - %s | FileCheck %s
