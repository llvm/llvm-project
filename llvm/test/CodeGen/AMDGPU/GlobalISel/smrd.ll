; RUN: llc < %s -mtriple=amdgpu6.00 -show-mc-encoding -global-isel | FileCheck --check-prefixes=SI,GCN %s
; RUN: llc < %s -mtriple=amdgpu7.04 -show-mc-encoding -global-isel | FileCheck --check-prefixes=CI,GCN,SICIVI %s
; RUN: llc < %s -mtriple=amdgpu8.02 -show-mc-encoding -global-isel | FileCheck --check-prefixes=VI,GCN,SICIVI %s
; RUN: llc -mtriple=amdgpu9.00 -show-mc-encoding -global-isel < %s | FileCheck --check-prefixes=GFX9_10,GCN,VIGFX9_10,SIVIGFX9_10  %s
; RUN: llc -mtriple=amdgpu10.10 -show-mc-encoding -global-isel < %s | FileCheck --check-prefixes=GFX9_10,GCN,VIGFX9_10,SIVIGFX9_10  %s
