...
; GFX6-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: gather4_2d_tfe:
; GFX10PLUS:       ; %bb.0: ; %main_body
; GFX10PLUS-NEXT:    s_mov_b32 s14, exec_lo
...
; GFX10PLUS-NEXT:    v_mov_b32_e32 v6, v1
...
; GFX10PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10PLUS-NEXT:    image_gather4 v[0:4], v[5:6], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D tfe
