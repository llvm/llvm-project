...
; GFX11NSA-NEXT:    s_mov_b32 s28, exec_lo
...
; GFX11NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s28
...
; GFX11NSA-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s28
; GFX11NSA-NEXT:    image_gather4_c_b_cl v[0:3], v[0:7], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
