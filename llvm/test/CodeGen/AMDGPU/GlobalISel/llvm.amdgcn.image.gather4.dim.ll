...
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 -o - %s | FileCheck -check-prefixes=GFX10PLUS,GFX10NSA %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -o - %s | FileCheck -check-prefixes=GFX10PLUS,GFX11NSA %s
...
;
; GFX11NSA-LABEL: gather4_2d:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX11NSA-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s1
; GFX11NSA-NEXT:    s_mov_b32 s1, s3
; GFX11NSA-NEXT:    s_mov_b32 s2, s4
; GFX11NSA-NEXT:    s_mov_b32 s3, s5
; GFX11NSA-NEXT:    s_mov_b32 s4, s6
; GFX11NSA-NEXT:    s_mov_b32 s5, s7
; GFX11NSA-NEXT:    s_mov_b32 s6, s8
; GFX11NSA-NEXT:    s_mov_b32 s7, s9
; GFX11NSA-NEXT:    s_mov_b32 s8, s10
; GFX11NSA-NEXT:    s_mov_b32 s9, s11
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_2d_tfe:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s14, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX11NSA-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v6, v1
; GFX11NSA-NEXT:    v_mov_b32_e32 v0, 0
; GFX11NSA-NEXT:    s_mov_b32 s1, s3
; GFX11NSA-NEXT:    s_mov_b32 s2, s4
; GFX11NSA-NEXT:    s_mov_b32 s3, s5
; GFX11NSA-NEXT:    s_mov_b32 s4, s6
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    v_mov_b32_e32 v1, v0
; GFX11NSA-NEXT:    v_mov_b32_e32 v2, v0
; GFX11NSA-NEXT:    v_mov_b32_e32 v3, v0
; GFX11NSA-NEXT:    v_mov_b32_e32 v4, v0
; GFX11NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11NSA-NEXT:    image_gather4 v[0:4], v[5:6], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D tfe
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_2darray:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_c v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_cl v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_c_cl_2d:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_c_cl v[0:3], v[0:3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_b v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_c_b v[0:3], v[0:3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_b_cl_2d:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_b_cl v[0:3], v[0:3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_c_b_cl_2d:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4_c_b_cl v[0:3], v[0:4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10PLUS-NEXT:    image_gather4_l v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
...
; GFX6-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: gather4_c_l_2d:
; GFX10PLUS:       ; %bb.0: ; %main_body
; GFX10PLUS-NEXT:    s_mov_b32 s0, s2
; GFX10PLUS-NEXT:    s_mov_b32 s1, s3
; GFX10PLUS-NEXT:    s_mov_b32 s2, s4
...
; GFX10PLUS-NEXT:    s_mov_b32 s10, s12
; GFX10PLUS-NEXT:    s_mov_b32 s11, s13
; GFX10PLUS-NEXT:    image_gather4_c_l v[0:3], v[0:3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX10PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX10PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10PLUS-NEXT:    s_mov_b32 s10, s12
; GFX10PLUS-NEXT:    s_mov_b32 s11, s13
; GFX10PLUS-NEXT:    image_gather4_lz v[0:3], v[0:1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX10PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX10PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX6-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: gather4_c_lz_2d:
; GFX10PLUS:       ; %bb.0: ; %main_body
; GFX10PLUS-NEXT:    s_mov_b32 s0, s2
; GFX10PLUS-NEXT:    s_mov_b32 s1, s3
; GFX10PLUS-NEXT:    s_mov_b32 s2, s4
...
; GFX10PLUS-NEXT:    s_mov_b32 s10, s12
; GFX10PLUS-NEXT:    s_mov_b32 s11, s13
; GFX10PLUS-NEXT:    image_gather4_c_lz v[0:3], v[0:2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX10PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX10PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_2d_dmask_2:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:1], s[0:7], s[8:11] dmask:0x2 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_2d_dmask_4:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:1], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    ; return to shader part epilog
;
; GFX11NSA-LABEL: gather4_2d_dmask_8:
; GFX11NSA:       ; %bb.0: ; %main_body
; GFX11NSA-NEXT:    s_mov_b32 s1, exec_lo
; GFX11NSA-NEXT:    s_mov_b32 s0, s2
; GFX11NSA-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX11NSA-NEXT:    s_mov_b32 s10, s12
; GFX11NSA-NEXT:    s_mov_b32 s11, s13
; GFX11NSA-NEXT:    image_gather4 v[0:3], v[0:1], s[0:7], s[8:11] dmask:0x8 dim:SQ_RSRC_IMG_2D
; GFX11NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX11NSA-NEXT:    ; return to shader part epilog
main_body:
