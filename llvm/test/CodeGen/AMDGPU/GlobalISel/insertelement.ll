...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 -verify-machineinstrs < %s | FileCheck -check-prefix=GPRIDX %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX10PLUS,GFX11 %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-mesa-mesa3d -mcpu=fiji -verify-machineinstrs < %s | FileCheck -check-prefix=GFX8 %s
...
; GFX11-NEXT:    v_cndmask_b32_e32 v7, 0x41000000, v0, vcc_lo
; GFX11-NEXT:    v_dual_mov_b32 v1, v9 :: v_dual_mov_b32 v0, v8
...
; GFX11-NEXT:    v_dual_cndmask_b32 v8, s10, v0 :: v_dual_mov_b32 v1, v9
...
; GFX11-NEXT:    v_dual_mov_b32 v1, v11 :: v_dual_mov_b32 v0, v10
; GFX11-NEXT:    ; return to shader part epilog
;
...
; GFX11-NEXT:    v_dual_cndmask_b32 v10, s12, v0 :: v_dual_mov_b32 v1, v11
...
; GFX11-NEXT:    v_cndmask_b32_e32 v11, s13, v0, vcc_lo
; GFX11-NEXT:    v_dual_mov_b32 v1, v13 :: v_dual_mov_b32 v0, v12
; GFX11-NEXT:    ; return to shader part epilog
;
...
; GFX11-NEXT:    v_cndmask_b32_e32 v5, s7, v0, vcc_lo
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 6, v1
; GFX11-NEXT:    v_dual_cndmask_b32 v6, s8, v0 :: v_dual_mov_b32 v1, v7
; GFX11-NEXT:    v_mov_b32_e32 v0, v8
; GFX11-NEXT:    ; return to shader part epilog
;
...
; GPRIDX:       ; %bb.0: ; %bb
; GPRIDX-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GPRIDX-NEXT:    v_and_b32_e32 v0, 2, v0
...
; GFX10:       ; %bb.0: ; %bb
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_and_b32_e32 v0, 2, v0
...
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_and_b16 v0.l, v0.l, 2
...
; GFX8:       ; %bb.0: ; %bb
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_and_b32_e32 v0, 2, v0
