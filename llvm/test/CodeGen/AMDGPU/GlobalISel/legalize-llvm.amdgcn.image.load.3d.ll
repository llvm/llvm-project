...
; RUN: llc -global-isel -mtriple=amdgpu6.00-mesa-mesa3d -stop-after=legalizer -o - %s | FileCheck -check-prefix=GFX6 %s
...
; RUN: llc -global-isel -mtriple=amdgpu12.00-mesa-mesa3d -stop-after=legalizer -o - %s | FileCheck -check-prefix=GFX10NSA %s
...
define amdgpu_ps float @image_load_3d_f32(<8 x i32> inreg %rsrc, i32 %s, i32 %t, i32 %r) {
  ...
  ; GFX6-NEXT:   [[AMDGPU_INTRIN_IMAGE_LOAD:%[0-9]+]]:_(f32) = G_AMDGPU_INTRIN_IMAGE_LOAD intrinsic(@llvm.amdgcn.image.load.3d), 1, [[BUILD_VECTOR1]](<3 x i32>), $noreg, $noreg, [[BUILD_VECTOR]](<8 x i32>), 0, 0, 0 :: (dereferenceable load (f32), addrspace 8)
...
define amdgpu_ps float @image_load_3d_tfe_f32(<8 x i32> inreg %rsrc, i32 %s, i32 %t, i32 %r) {
  ...
  ; GFX6-NEXT:   [[COPY11:%[0-9]+]]:_(i32) = COPY [[UV1]](i32)
  ; GFX6-NEXT:   G_STORE [[COPY11]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) poison`, addrspace 1)
  ...
  ; GFX10NSA-NEXT:   [[COPY11:%[0-9]+]]:_(i32) = COPY [[UV1]](i32)
  ; GFX10NSA-NEXT:   G_STORE [[COPY11]](i32), [[DEF]](p1) :: (store (i32) into `ptr addrspace(1) poison`, addrspace 1)
