...
; GFX1150-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_and_b32 v1, 0x3ff, v0
; GFX1150-NEXT:    v_mov_b16_e32 v0.h, 0
; GFX1150-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v6, 0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1150-NEXT:    v_lshrrev_b16 v0.l, 8, v1.l
; GFX1150-NEXT:    v_and_b16 v4.l, 0xff, v1.l
...
; GFX1150-NEXT:    v_lshlrev_b16 v0.l, 8, v0.l
; GFX1150-NEXT:    v_or_b16 v0.l, v4.l, v0.l
; GFX1150-NEXT:    s_waitcnt lgkmcnt(0)
