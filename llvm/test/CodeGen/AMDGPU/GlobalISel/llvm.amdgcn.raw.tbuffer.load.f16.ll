...
define amdgpu_ps <2 x half> @raw_tbuffer_load_v2f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<2 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<2 x f16>), align 1, addrspace 8)
...
define amdgpu_ps <4 x half> @raw_tbuffer_load_v4f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(i32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<4 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<4 x f16>), align 1, addrspace 8)
...
define amdgpu_ps <2 x half> @raw_tbuffer_load_v2f16__sgpr_rsrc__sgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 inreg %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<2 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<2 x f16>), align 1, addrspace 8)
...
define amdgpu_ps <4 x half> @raw_tbuffer_load_v4f16__sgpr_rsrc__sgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 inreg %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; UNPACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<4 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](i32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<4 x f16>), align 1, addrspace 8)
