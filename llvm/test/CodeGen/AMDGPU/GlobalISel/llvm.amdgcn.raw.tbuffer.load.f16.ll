...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
...
define amdgpu_ps <2 x half> @raw_tbuffer_load_v2f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<2 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<2 x f16>), align 1, addrspace 8)
...
define amdgpu_ps <4 x half> @raw_tbuffer_load_v4f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<4 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<4 x f16>), align 1, addrspace 8)
...
define amdgpu_ps half @raw_tbuffer_load_f16__vgpr_rsrc__sgpr_voffset__vgpr_soffset(<4 x i32> %rsrc, i32 inreg %voffset, i32 %soffset) {
  ...
  ; UNPACKED-NEXT: {{  $}}
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR1]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[INTRINSIC_CONVERGENT4]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; PACKED-NEXT: {{  $}}
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR1]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[INTRINSIC_CONVERGENT4]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ...
  ; GFX12-NEXT: {{  $}}
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR1]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[INTRINSIC_CONVERGENT4]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset_glc(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 1, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; PACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 1, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 1, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset_slc(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 2, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; PACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 2, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 2, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset_slc_glc(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 3, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; PACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 3, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 3, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__vgpr_voffset__sgpr_soffset_dlc(<4 x i32> inreg %rsrc, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 4, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; PACKED-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 4, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[C:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY4]], [[COPY5]], 0, 78, 4, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
...
define amdgpu_ps half @raw_tbuffer_load_f16__sgpr_rsrc__sgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 inreg %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; UNPACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; PACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; PACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; PACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; PACKED-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; PACKED-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  ;
  ...
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; GFX12-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; GFX12-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr_32(s32) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (f16), align 1, addrspace 8)
  ; GFX12-NEXT:   $vgpr0 = COPY [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](s32)
  ; GFX12-NEXT:   SI_RETURN_TO_EPILOG implicit $vgpr0
  %val = call half @llvm.amdgcn.raw.tbuffer.load.f16(<4 x i32> %rsrc, i32 %voffset, i32 %soffset, i32 78, i32 0)
  ret half %val
...
define amdgpu_ps <2 x half> @raw_tbuffer_load_v2f16__sgpr_rsrc__sgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 inreg %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<2 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   [[UV:%[0-9]+]]:vgpr(f32), [[UV1:%[0-9]+]]:vgpr(f32) = G_UNMERGE_VALUES [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](<2 x f32>)
...
define amdgpu_ps <4 x half> @raw_tbuffer_load_v4f16__sgpr_rsrc__sgpr_voffset__sgpr_soffset(<4 x i32> inreg %rsrc, i32 inreg %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[COPY6:%[0-9]+]]:vgpr(s32) = COPY [[C]](s32)
  ; UNPACKED-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY [[COPY4]](i32)
  ; UNPACKED-NEXT:   [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_:%[0-9]+]]:vgpr(<4 x f32>) = G_AMDGPU_TBUFFER_LOAD_FORMAT_D16 [[BUILD_VECTOR]](<4 x i32>), [[COPY6]](s32), [[COPY7]], [[COPY5]], 0, 78, 0, 0 :: (dereferenceable load (<4 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   [[UV:%[0-9]+]]:vgpr(f32), [[UV1:%[0-9]+]]:vgpr(f32), [[UV2:%[0-9]+]]:vgpr(f32), [[UV3:%[0-9]+]]:vgpr(f32) = G_UNMERGE_VALUES [[AMDGPU_TBUFFER_LOAD_FORMAT_D16_]](<4 x f32>)
  ; UNPACKED-NEXT:   [[AMDGPU_READANYLANE:%[0-9]+]]:sgpr(s32) = G_AMDGPU_READANYLANE [[UV]]
  ; UNPACKED-NEXT:   [[AMDGPU_READANYLANE1:%[0-9]+]]:sgpr(s32) = G_AMDGPU_READANYLANE [[UV1]]
