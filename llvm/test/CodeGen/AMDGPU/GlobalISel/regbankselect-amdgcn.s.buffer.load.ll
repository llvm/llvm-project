...
; RUN: llc -amdgpu-global-isel-new-legality -global-isel -mtriple=amdgpu7.01-mesa-mesa3d -simplify-mir -stop-after=amdgpu-reg-bank-legalize -o - %s | FileCheck %s -check-prefix=GFX7
; RUN: llc -amdgpu-global-isel-new-legality -global-isel -mtriple=amdgpu12.00-mesa-mesa3d -simplify-mir -stop-after=amdgpu-reg-bank-legalize -o - %s | FileCheck %s -check-prefixes=GFX1200_1250,GFX1200
; RUN: llc -amdgpu-global-isel-new-legality -global-isel -mtriple=amdgpu12.50-mesa-mesa3d -simplify-mir -stop-after=amdgpu-reg-bank-legalize -o - %s | FileCheck %s -check-prefixes=GFX1200_1250,GFX1250
