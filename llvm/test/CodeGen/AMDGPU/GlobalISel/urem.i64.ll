...
; CHECK-NEXT:    v_mul_lo_u32 v8, s5, v1
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v7, v5
; CHECK-NEXT:    v_mul_hi_u32 v7, v1, v6
...
; CHECK-NEXT:    v_mul_lo_u32 v11, v4, v5
...
; CHECK-NEXT:    v_mul_hi_u32 v6, s4, v1
...
; CHECK-NEXT:    v_mul_hi_u32 v8, v1, v6
...
; CHECK-NEXT:    v_mul_hi_u32 v5, s0, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, s1, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, s1, v1
; CHECK-NEXT:    v_mul_lo_u32 v7, s0, v4
; CHECK-NEXT:    v_mul_hi_u32 v8, s0, v4
; CHECK-NEXT:    v_mul_lo_u32 v9, s1, v4
...
; CHECK-NEXT:    v_mul_lo_u32 v1, s3, v1
