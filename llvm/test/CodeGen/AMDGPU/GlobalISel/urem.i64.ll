...
; CHECK-NEXT:    v_readfirstlane_b32 s11, v2
; CHECK-NEXT:    s_mul_i32 s9, s5, s7
; CHECK-NEXT:    s_mul_i32 s10, s4, s7
; CHECK-NEXT:    s_add_i32 s8, s11, s8
; CHECK-NEXT:    v_mul_hi_u32 v3, v0, s10
; CHECK-NEXT:    s_add_i32 s8, s8, s9
; CHECK-NEXT:    v_mul_hi_u32 v0, v0, s8
; CHECK-NEXT:    v_mul_hi_u32 v4, v1, s10
; CHECK-NEXT:    v_readfirstlane_b32 s9, v3
; CHECK-NEXT:    s_mul_i32 s11, s7, s8
...
; CHECK-NEXT:    s_addc_u32 s11, 0, s11
; CHECK-NEXT:    v_readfirstlane_b32 s12, v4
; CHECK-NEXT:    s_add_u32 s9, s9, s10
; CHECK-NEXT:    s_addc_u32 s9, s11, s12
; CHECK-NEXT:    v_readfirstlane_b32 s10, v0
; CHECK-NEXT:    s_addc_u32 s10, s10, 0
; CHECK-NEXT:    s_mul_i32 s8, s6, s8
; CHECK-NEXT:    s_add_u32 s8, s9, s8
; CHECK-NEXT:    s_addc_u32 s9, 0, s10
...
; CHECK-NEXT:    v_mul_hi_u32 v2, s6, v0
...
; CHECK-NEXT:    s_add_u32 s9, s11, s9
; CHECK-NEXT:    s_addc_u32 s10, 0, s10
; CHECK-NEXT:    v_readfirstlane_b32 s5, v2
; CHECK-NEXT:    s_add_u32 s8, s9, s8
; CHECK-NEXT:    s_addc_u32 s5, s10, s5
...
; CHECK-NEXT:    s_addc_u32 s5, 0, s8
; CHECK-NEXT:    s_add_u32 s4, s7, s4
; CHECK-NEXT:    s_addc_u32 s5, s6, s5
; CHECK-NEXT:    v_mov_b32_e32 v0, s5
; CHECK-NEXT:    v_mul_hi_u32 v1, s0, v0
; CHECK-NEXT:    v_mov_b32_e32 v2, s4
; CHECK-NEXT:    v_mul_hi_u32 v3, s0, v2
; CHECK-NEXT:    s_mul_i32 s6, s0, s5
...
; CHECK-NEXT:    s_addc_u32 s4, s7, s8
; CHECK-NEXT:    v_readfirstlane_b32 s6, v0
; CHECK-NEXT:    s_addc_u32 s8, s6, 0
...
; CHECK-NEXT:    s_add_i32 s8, s5, s8
; CHECK-NEXT:    s_sub_i32 s9, s1, s8
; CHECK-NEXT:    s_mul_i32 s4, s2, s4
; CHECK-NEXT:    s_sub_u32 s10, s0, s4
; CHECK-NEXT:    s_cselect_b64 s[4:5], -1, 0
; CHECK-NEXT:    s_subb_u32 s9, s9, s3
; CHECK-NEXT:    s_sub_u32 s11, s10, s2
; CHECK-NEXT:    s_subb_u32 s9, s9, 0
; CHECK-NEXT:    s_cmp_ge_u32 s9, s3
; CHECK-NEXT:    s_cselect_b32 s12, -1, 0
; CHECK-NEXT:    s_cmp_ge_u32 s11, s2
; CHECK-NEXT:    s_cselect_b32 s13, -1, 0
; CHECK-NEXT:    s_cmp_eq_u32 s9, s3
; CHECK-NEXT:    s_cselect_b32 s9, s13, s12
; CHECK-NEXT:    s_sub_u32 s12, s11, s2
; CHECK-NEXT:    s_cmp_lg_u32 s9, 0
; CHECK-NEXT:    s_cselect_b32 s9, s12, s11
; CHECK-NEXT:    s_or_b32 s4, s4, s5
; CHECK-NEXT:    s_subb_u32 s1, s1, s8
; CHECK-NEXT:    s_cmp_ge_u32 s1, s3
; CHECK-NEXT:    s_cselect_b32 s4, -1, 0
; CHECK-NEXT:    s_cmp_ge_u32 s10, s2
; CHECK-NEXT:    s_cselect_b32 s5, -1, 0
; CHECK-NEXT:    s_cmp_eq_u32 s1, s3
; CHECK-NEXT:    s_cselect_b32 s1, s5, s4
; CHECK-NEXT:    s_cmp_lg_u32 s1, 0
; CHECK-NEXT:    s_cselect_b32 s4, s9, s10
...
; CHECK-NEXT:    s_sub_i32 s1, s0, s2
; CHECK-NEXT:    s_cmp_ge_u32 s0, s2
; CHECK-NEXT:    s_cselect_b32 s0, s1, s0
; CHECK-NEXT:    s_sub_i32 s1, s0, s2
; CHECK-NEXT:    s_cmp_ge_u32 s0, s2
; CHECK-NEXT:    s_cselect_b32 s4, s1, s0
...
; GISEL-NEXT:    v_mul_hi_u32 v17, v9, v12
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v12
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v15, v14
; GISEL-NEXT:    v_addc_u32_e32 v15, vcc, 0, v16, vcc
; GISEL-NEXT:    v_mul_lo_u32 v16, v9, v13
; GISEL-NEXT:    v_mul_hi_u32 v13, v9, v13
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v14, v16
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v15, v13, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v11, v8, v10
...
; GISEL-NEXT:    v_mul_hi_u32 v15, v9, v10
; GISEL-NEXT:    v_mul_lo_u32 v10, v9, v10
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v12
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, v13, v14, vcc
...
; GISEL-NEXT:    v_mul_lo_u32 v10, v0, v9
; GISEL-NEXT:    v_mul_hi_u32 v11, v0, v8
; GISEL-NEXT:    v_mul_hi_u32 v12, v0, v9
; GISEL-NEXT:    v_mul_hi_u32 v13, v1, v9
; GISEL-NEXT:    v_mul_lo_u32 v9, v1, v9
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
; GISEL-NEXT:    v_addc_u32_e32 v11, vcc, 0, v12, vcc
...
; GISEL-NEXT:    v_addc_u32_e32 v10, vcc, 0, v13, vcc
...
; GISEL-NEXT:    v_sub_i32_e32 v10, vcc, v1, v9
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
; GISEL-NEXT:    v_subb_u32_e64 v8, s[4:5], v10, v5, vcc
; GISEL-NEXT:    v_sub_i32_e64 v10, s[4:5], v0, v4
; GISEL-NEXT:    v_subbrev_u32_e64 v11, s[6:7], 0, v8, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v11, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[6:7]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v10, v4
...
; GISEL-NEXT:    v_subb_u32_e64 v8, s[4:5], v8, v5, s[4:5]
; GISEL-NEXT:    v_sub_i32_e64 v15, s[4:5], v10, v4
; GISEL-NEXT:    v_subbrev_u32_e64 v8, s[4:5], 0, v8, s[4:5]
; GISEL-NEXT:    v_mac_f32_e32 v13, 0x4f800000, v14
; GISEL-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v12
; GISEL-NEXT:    v_rcp_f32_e32 v12, v13
...
; GISEL-NEXT:    v_mul_f32_e32 v13, 0x2f800000, v12
; GISEL-NEXT:    v_trunc_f32_e32 v13, v13
; GISEL-NEXT:    v_mac_f32_e32 v12, 0xcf800000, v13
; GISEL-NEXT:    v_cvt_u32_f32_e32 v12, v12
; GISEL-NEXT:    v_cvt_u32_f32_e32 v13, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, 0, v6
; GISEL-NEXT:    v_mul_hi_u32 v16, v14, v12
; GISEL-NEXT:    v_mul_lo_u32 v17, v14, v13
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v10, v15, s[4:5]
; GISEL-NEXT:    v_subb_u32_e32 v15, vcc, 0, v7, vcc
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; GISEL-NEXT:    v_mul_lo_u32 v18, v15, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, -1, vcc
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v16, v17
; GISEL-NEXT:    v_mul_lo_u32 v17, v14, v12
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v16, v18
; GISEL-NEXT:    v_mul_lo_u32 v18, v12, v16
; GISEL-NEXT:    v_mul_hi_u32 v19, v12, v17
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GISEL-NEXT:    v_mul_hi_u32 v5, v12, v16
; GISEL-NEXT:    v_cndmask_b32_e32 v4, v9, v4, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v19, v18
; GISEL-NEXT:    v_mul_lo_u32 v18, v13, v17
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, 0, v5, vcc
; GISEL-NEXT:    v_mul_hi_u32 v17, v13, v17
; GISEL-NEXT:    v_mul_hi_u32 v19, v13, v16
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v9, v18
; GISEL-NEXT:    v_mul_lo_u32 v9, v13, v16
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v5, v17, vcc
; GISEL-NEXT:    v_addc_u32_e32 v16, vcc, 0, v19, vcc
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v9
; GISEL-NEXT:    v_addc_u32_e32 v9, vcc, 0, v16, vcc
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v12, v5
; GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v13, v9, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v0, v10, vcc
; GISEL-NEXT:    v_mul_lo_u32 v4, v14, v9
; GISEL-NEXT:    v_mul_hi_u32 v10, v14, v5
; GISEL-NEXT:    v_mul_lo_u32 v12, v14, v5
; GISEL-NEXT:    v_mul_lo_u32 v14, v15, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v8, v11, v8, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v4, s[6:7], v10, v4
; GISEL-NEXT:    v_add_i32_e64 v4, s[6:7], v4, v14
; GISEL-NEXT:    v_mul_lo_u32 v10, v5, v4
; GISEL-NEXT:    v_mul_hi_u32 v14, v5, v12
; GISEL-NEXT:    v_mul_hi_u32 v15, v5, v4
; GISEL-NEXT:    v_mul_hi_u32 v13, v9, v12
; GISEL-NEXT:    v_mul_lo_u32 v12, v9, v12
; GISEL-NEXT:    v_add_i32_e64 v10, s[6:7], v14, v10
; GISEL-NEXT:    v_addc_u32_e64 v14, s[6:7], 0, v15, s[6:7]
; GISEL-NEXT:    v_mul_hi_u32 v15, v9, v4
; GISEL-NEXT:    v_mul_lo_u32 v4, v9, v4
; GISEL-NEXT:    v_add_i32_e64 v10, s[6:7], v10, v12
; GISEL-NEXT:    v_addc_u32_e64 v10, s[6:7], v14, v13, s[6:7]
; GISEL-NEXT:    v_addc_u32_e64 v12, s[6:7], 0, v15, s[6:7]
; GISEL-NEXT:    v_add_i32_e64 v4, s[6:7], v10, v4
; GISEL-NEXT:    v_addc_u32_e64 v10, s[6:7], 0, v12, s[6:7]
; GISEL-NEXT:    v_add_i32_e64 v4, s[6:7], v5, v4
; GISEL-NEXT:    v_addc_u32_e64 v5, s[6:7], v9, v10, s[6:7]
; GISEL-NEXT:    v_mul_lo_u32 v9, v2, v5
; GISEL-NEXT:    v_mul_hi_u32 v10, v2, v4
; GISEL-NEXT:    v_mul_hi_u32 v11, v2, v5
; GISEL-NEXT:    v_mul_hi_u32 v12, v3, v5
; GISEL-NEXT:    v_mul_lo_u32 v5, v3, v5
; GISEL-NEXT:    v_add_i32_e64 v9, s[4:5], v10, v9
; GISEL-NEXT:    v_addc_u32_e64 v10, s[4:5], 0, v11, s[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v11, v3, v4
; GISEL-NEXT:    v_mul_hi_u32 v4, v3, v4
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v8, vcc
; GISEL-NEXT:    v_add_i32_e64 v9, s[4:5], v9, v11
; GISEL-NEXT:    v_addc_u32_e64 v4, s[4:5], v10, v4, s[4:5]
; GISEL-NEXT:    v_addc_u32_e64 v9, s[4:5], 0, v12, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v4, s[4:5], v4, v5
; GISEL-NEXT:    v_addc_u32_e64 v5, s[4:5], 0, v9, s[4:5]
...
; GISEL-NEXT:    v_sub_i32_e32 v8, vcc, v3, v5
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v2, v4
; GISEL-NEXT:    v_subb_u32_e64 v4, s[4:5], v8, v7, vcc
; GISEL-NEXT:    v_sub_i32_e64 v8, s[4:5], v2, v6
; GISEL-NEXT:    v_subbrev_u32_e64 v9, s[6:7], 0, v4, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v9, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[6:7]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[6:7], v8, v6
; GISEL-NEXT:    v_subb_u32_e32 v3, vcc, v3, v5, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[6:7]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], v9, v7
; GISEL-NEXT:    v_subb_u32_e64 v4, s[4:5], v4, v7, s[4:5]
; GISEL-NEXT:    v_cmp_ge_u32_e32 vcc, v3, v7
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[6:7]
; GISEL-NEXT:    v_sub_i32_e64 v11, s[4:5], v8, v6
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v8, v8, v11, s[4:5]
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v9, v4, s[4:5]
...
; CHECK-NEXT:    v_mul_lo_u32 v10, v6, v2
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v8, v11
; CHECK-NEXT:    v_mul_hi_u32 v9, v2, v10
...
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v11
; CHECK-NEXT:    v_addc_u32_e32 v11, vcc, 0, v12, vcc
; CHECK-NEXT:    v_mul_lo_u32 v12, v3, v10
; CHECK-NEXT:    v_mul_hi_u32 v10, v3, v10
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v12
; CHECK-NEXT:    v_addc_u32_e32 v9, vcc, v11, v10, vcc
; CHECK-NEXT:    v_addc_u32_e32 v10, vcc, 0, v13, vcc
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
...
; CHECK-NEXT:    v_mul_hi_u32 v9, v1, v3
; CHECK-NEXT:    v_mul_lo_u32 v3, v1, v3
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; CHECK-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; CHECK-NEXT:    v_mul_lo_u32 v8, v1, v2
; CHECK-NEXT:    v_mul_hi_u32 v2, v1, v2
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CHECK-NEXT:    v_addc_u32_e32 v2, vcc, v7, v2, vcc
; CHECK-NEXT:    v_addc_u32_e32 v6, vcc, 0, v9, vcc
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, 0, v6, vcc
; CHECK-NEXT:    v_mul_lo_u32 v3, v4, v3
; CHECK-NEXT:    v_mul_hi_u32 v6, v4, v2
; CHECK-NEXT:    v_mul_lo_u32 v7, v5, v2
; CHECK-NEXT:    v_mul_lo_u32 v2, v4, v2
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v6, v3
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v7
; CHECK-NEXT:    v_sub_i32_e32 v6, vcc, v1, v3
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v0, v2
; CHECK-NEXT:    v_subb_u32_e64 v2, s[4:5], v6, v5, vcc
; CHECK-NEXT:    v_sub_i32_e64 v6, s[4:5], v0, v4
; CHECK-NEXT:    v_subbrev_u32_e64 v7, s[6:7], 0, v2, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[6:7], v7, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[6:7]
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[6:7], v6, v4
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v1, v3, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[6:7]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[6:7], v7, v5
; CHECK-NEXT:    v_subb_u32_e64 v2, s[4:5], v2, v5, s[4:5]
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v8, v8, v9, s[6:7]
; CHECK-NEXT:    v_sub_i32_e64 v9, s[4:5], v6, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v7, v2, s[4:5]
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CHECK-NEXT:    v_cndmask_b32_e32 v3, v1, v2, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v1, v6, v9, s[4:5]
...
; GISEL-NEXT:    v_lshl_b64 v[5:6], s[4:5], v6
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, -1, v7
; GISEL-NEXT:    v_addc_u32_e32 v7, vcc, -1, v8, vcc
; GISEL-NEXT:    v_and_b32_e32 v0, v0, v4
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, -1, v5
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, -1, v6, vcc
; GISEL-NEXT:    v_and_b32_e32 v1, v1, v7
...
; CGP-NEXT:    v_cvt_f32_u32_e32 v1, v12
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, 0, v11
; CGP-NEXT:    v_subb_u32_e32 v6, vcc, 0, v12, vcc
; CGP-NEXT:    v_madmk_f32 v0, v1, 0x4f800000, v0
; CGP-NEXT:    v_rcp_f32_e32 v0, v0
; CGP-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; CGP-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v1, v1
; CGP-NEXT:    v_cvt_u32_f32_e32 v0, v0
; CGP-NEXT:    v_mul_lo_u32 v8, v4, v1
; CGP-NEXT:    v_mul_hi_u32 v13, v4, v0
; CGP-NEXT:    v_mul_lo_u32 v15, v6, v0
; CGP-NEXT:    v_mul_lo_u32 v14, v4, v0
...
; CGP-NEXT:    v_mul_hi_u32 v17, v1, v8
...
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, 0, v15, vcc
; CGP-NEXT:    v_mul_hi_u32 v15, v1, v4
; CGP-NEXT:    v_mul_lo_u32 v4, v1, v4
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v13, v14, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v4, v7, v1
; CGP-NEXT:    v_mul_hi_u32 v6, v7, v0
; CGP-NEXT:    v_mul_hi_u32 v8, v7, v1
; CGP-NEXT:    v_mul_hi_u32 v13, v5, v1
; CGP-NEXT:    v_mul_lo_u32 v1, v5, v1
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, 0, v8, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v5, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v5, v0
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_addc_u32_e32 v0, vcc, v6, v0, vcc
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, 0, v13, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_addc_u32_e32 v1, vcc, 0, v4, vcc
; CGP-NEXT:    v_mul_lo_u32 v1, v11, v1
; CGP-NEXT:    v_mul_hi_u32 v4, v11, v0
; CGP-NEXT:    v_mul_lo_u32 v6, v12, v0
; CGP-NEXT:    v_mul_lo_u32 v0, v11, v0
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v4, v1
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v6
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v5, v1
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v7, v0
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v4, v12, vcc
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v0, v11
; CGP-NEXT:    v_subbrev_u32_e64 v7, s[6:7], 0, v4, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[6:7], v7, v12
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[6:7]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[6:7], v6, v11
; CGP-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[6:7]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[6:7], v7, v12
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v4, v12, s[4:5]
; CGP-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s[6:7]
; CGP-NEXT:    v_sub_i32_e64 v13, s[4:5], v6, v11
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v5, v1, vcc
; CGP-NEXT:    v_subbrev_u32_e64 v4, s[4:5], 0, v4, s[4:5]
...
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v12
; CGP-NEXT:    v_cndmask_b32_e32 v5, v5, v7, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; CGP-NEXT:    v_cndmask_b32_e32 v1, v1, v4, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v4, v6, v13, s[4:5]
; CGP-NEXT:    v_cndmask_b32_e32 v0, v0, v4, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, 0, v9
; CGP-NEXT:    v_subb_u32_e32 v7, vcc, 0, v10, vcc
; CGP-NEXT:    v_madmk_f32 v4, v5, 0x4f800000, v4
; CGP-NEXT:    v_rcp_f32_e32 v4, v4
; CGP-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; CGP-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v4
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v5, v11, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v6, v4
; CGP-NEXT:    v_mul_lo_u32 v11, v6, v5
; CGP-NEXT:    v_mul_hi_u32 v6, v6, v4
; CGP-NEXT:    v_mul_lo_u32 v7, v7, v4
; CGP-NEXT:    v_mul_hi_u32 v12, v5, v8
...
; CGP-NEXT:    v_mul_hi_u32 v13, v4, v6
; CGP-NEXT:    v_mul_lo_u32 v8, v5, v8
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v11, v7
; CGP-NEXT:    v_addc_u32_e32 v11, vcc, 0, v13, vcc
; CGP-NEXT:    v_mul_hi_u32 v13, v5, v6
; CGP-NEXT:    v_mul_lo_u32 v6, v5, v6
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, v11, v12, vcc
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, 0, v13, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v5, v7, vcc
; CGP-NEXT:    v_mul_lo_u32 v6, v2, v5
...
; CGP-NEXT:    v_mul_hi_u32 v4, v3, v4
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, v7, v4, vcc
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, 0, v11, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, 0, v6, vcc
; CGP-NEXT:    v_mul_lo_u32 v5, v9, v5
; CGP-NEXT:    v_mul_hi_u32 v6, v9, v4
; CGP-NEXT:    v_mul_lo_u32 v7, v10, v4
; CGP-NEXT:    v_mul_lo_u32 v4, v9, v4
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v3, v5
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v2, v4
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v6, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v2, v9
; CGP-NEXT:    v_subbrev_u32_e64 v7, s[6:7], 0, v4, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[6:7], v7, v10
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[6:7]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[6:7], v6, v9
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[6:7]
; CGP-NEXT:    v_cmp_eq_u32_e64 s[6:7], v7, v10
; CGP-NEXT:    v_subb_u32_e64 v4, s[4:5], v4, v10, s[4:5]
; CGP-NEXT:    v_cndmask_b32_e64 v8, v8, v11, s[6:7]
; CGP-NEXT:    v_sub_i32_e64 v11, s[4:5], v6, v9
; CGP-NEXT:    v_subb_u32_e32 v3, vcc, v3, v5, vcc
; CGP-NEXT:    v_subbrev_u32_e64 v4, s[4:5], 0, v4, s[4:5]
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; CGP-NEXT:    v_cndmask_b32_e32 v5, v3, v4, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v3, v6, v11, s[4:5]
; CGP-NEXT:    v_cndmask_b32_e32 v4, v2, v3, vcc
...
; GISEL-NEXT:    v_cvt_f32_u32_e32 v1, v1
; GISEL-NEXT:    v_and_b32_e32 v3, 0xffffff, v0
; GISEL-NEXT:    v_cvt_f32_u32_e32 v3, v3
; GISEL-NEXT:    v_rcp_f32_e32 v4, v1
; GISEL-NEXT:    v_mul_f32_e32 v4, v3, v4
; GISEL-NEXT:    v_trunc_f32_e32 v4, v4
; GISEL-NEXT:    v_mad_f32 v3, -v4, v1, v3
; GISEL-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v3|, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v4, v1
; GISEL-NEXT:    v_mul_lo_u32 v1, v1, v2
...
; GISEL-NEXT:    v_rcp_f32_e32 v5, v1
; GISEL-NEXT:    v_cvt_f32_u32_e32 v8, v8
; GISEL-NEXT:    v_and_b32_e32 v7, 0xffffff, v2
; GISEL-NEXT:    v_mul_f32_e32 v5, v3, v5
; GISEL-NEXT:    v_trunc_f32_e32 v5, v5
; GISEL-NEXT:    v_mad_f32 v3, -v5, v1, v3
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v3|, v1
; GISEL-NEXT:    v_cvt_u32_f32_e32 v3, v5
; GISEL-NEXT:    v_cvt_f32_u32_e32 v5, v7
; GISEL-NEXT:    v_rcp_f32_e32 v7, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GISEL-NEXT:    v_mul_f32_e32 v3, v5, v7
; GISEL-NEXT:    v_trunc_f32_e32 v3, v3
; GISEL-NEXT:    v_mul_lo_u32 v1, v1, v4
; GISEL-NEXT:    v_mad_f32 v4, -v3, v8, v5
; GISEL-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GISEL-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v4|, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[4:5]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; GISEL-NEXT:    v_mul_lo_u32 v3, v3, v6
; GISEL-NEXT:    v_and_b32_e32 v0, 0xffffff, v0
; GISEL-NEXT:    v_sub_i32_e32 v1, vcc, v2, v3
; GISEL-NEXT:    v_and_b32_e32 v2, 0xffffff, v1
; GISEL-NEXT:    v_mov_b32_e32 v1, 0
