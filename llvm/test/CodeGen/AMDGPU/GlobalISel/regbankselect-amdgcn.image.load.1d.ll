...
; RUN: llc -global-isel -mtriple=amdgpu8.03-mesa-mesa3d -stop-after=amdgpu-reg-bank-legalize -regbankselect-fast -o - %s | FileCheck -check-prefix=FAST %s
; RUN: llc -global-isel -mtriple=amdgpu8.03-mesa-mesa3d -stop-after=amdgpu-reg-bank-legalize -regbankselect-greedy -o - %s | FileCheck -check-prefix=GREEDY %s
