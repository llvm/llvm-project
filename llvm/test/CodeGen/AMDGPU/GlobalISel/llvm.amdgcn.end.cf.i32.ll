...
; RUN: llc -global-isel -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=+wavefrontsize32,-wavefrontsize64 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX11 %s
...
; GFX11-NEXT:    s_cbranch_scc1 BB0_2
; GFX11-NEXT:  ; %bb.1: ; %mid
