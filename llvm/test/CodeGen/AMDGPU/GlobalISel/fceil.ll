...
; RUN: llc -mtriple=amdgcn -mcpu=fiji -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=FIJI %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefix=GFX12 %s
