...
; RUN: llc -global-isel -mtriple=amdgpu6.00-- -mem-intrinsic-expand-size=3 %s -o - | FileCheck -check-prefix=LOOP %s
; RUN: llc -global-isel -mtriple=amdgpu6.00-- -mem-intrinsic-expand-size=5 %s -o - | FileCheck -check-prefix=UNROLL %s
...
; UNROLL-NEXT:    buffer_load_ubyte v8, v[2:3], s[0:3], 0 addr64 offset:3
...
; UNROLL-NEXT:    s_waitcnt vmcnt(3)
; UNROLL-NEXT:    buffer_store_byte v8, v[0:1], s[0:3], 0 addr64 offset:3
