...
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1030 -verify-machineinstrs < %S/../readcyclecounter.ll | FileCheck -enable-var-scope -check-prefixes=GFX1030,GFX1030-GISEL -check-prefix=GCN %S/../readcyclecounter.ll
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1100 -verify-machineinstrs < %S/../readcyclecounter.ll | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-GISEL -check-prefix=GCN %S/../readcyclecounter.ll
