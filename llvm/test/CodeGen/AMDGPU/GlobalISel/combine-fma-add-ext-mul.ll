...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx900 --denormal-fp-math=preserve-sign < %s | FileCheck -check-prefix=GFX9-FAST-DENORM %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1010 --denormal-fp-math=preserve-sign < %s | FileCheck -check-prefix=GFX10-FAST-DENORM %s
...
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v0, v1, 1.0, s6 op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v1, v1, 1.0, s7 op_sel:[1,0,0] op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v2, v3, 1.0, s8 op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v3, v3, 1.0, s9 op_sel:[1,0,0] op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v4, v4, 1.0, s10 op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    ; return to shader part epilog
;
...
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v2, v3, 1.0, s8 op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v3, v3, 1.0, s9 op_sel:[1,0,0] op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v4, v5, 1.0, s10 op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    v_mad_mix_f32 v5, v5, 1.0, s11 op_sel:[1,0,0] op_sel_hi:[1,1,0]
; GFX9-FAST-DENORM-NEXT:    ; return to shader part epilog
;
