...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v2f16(<4 x i32> inreg %rsrc, <2 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<2 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](s32), [[COPY5]], [[COPY6]], 0, 0, 0 :: (dereferenceable store (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v4f16(<4 x i32> inreg %rsrc, <4 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<4 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY10]](s32), [[COPY6]], [[COPY7]], 0, 0, 0 :: (dereferenceable store (<4 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__vgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v4f16(<4 x i32> %rsrc, <4 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:sgpr(<4 x i32>) = G_BUILD_VECTOR [[INTRINSIC_CONVERGENT]](i32), [[INTRINSIC_CONVERGENT1]](i32), [[INTRINSIC_CONVERGENT2]](i32), [[INTRINSIC_CONVERGENT3]](i32)
  ; UNPACKED-NEXT:   [[UV:%[0-9]+]]:vgpr(s64), [[UV1:%[0-9]+]]:vgpr(s64) = G_UNMERGE_VALUES [[BUILD_VECTOR]](<4 x i32>)
  ; UNPACKED-NEXT:   [[UV2:%[0-9]+]]:sgpr(s64), [[UV3:%[0-9]+]]:sgpr(s64) = G_UNMERGE_VALUES [[BUILD_VECTOR2]](<4 x i32>)
  ...
  ; UNPACKED-NEXT: {{  $}}
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<4 x s32>), [[BUILD_VECTOR2]](<4 x i32>), [[COPY10]](s32), [[COPY6]], [[COPY7]], 0, 0, 0 :: (dereferenceable store (<4 x f16>), align 1, addrspace 8)
...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v2f16_soffset4095(<4 x i32> inreg %rsrc, <2 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<2 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY7]](s32), [[COPY5]], [[C]], 0, 0, 0 :: (dereferenceable store (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v2f16_voffset_add_16(<4 x i32> inreg %rsrc, <2 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY8:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<2 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](s32), [[COPY5]], [[COPY6]], 16, 0, 0 :: (dereferenceable store (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v2f16_voffset_add_4095(<4 x i32> inreg %rsrc, <2 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; UNPACKED-NEXT:   [[COPY8:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<2 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](s32), [[COPY5]], [[COPY6]], 4095, 0, 0 :: (dereferenceable store (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__sgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v2f16_voffset_add_4096(<4 x i32> inreg %rsrc, <2 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<2 x s32>), [[BUILD_VECTOR]](<4 x i32>), [[COPY9]](s32), [[ADD]], [[COPY6]], 0, 0, 0 :: (dereferenceable store (<2 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @raw_buffer_store_format__vgpr_rsrc__vgpr_val__vgpr_voffset__sgpr_soffset_v4f16_add_4096(<4 x i32> %rsrc, <4 x half> %val, i32 %voffset, i32 inreg %soffset) {
  ...
  ; UNPACKED-NEXT:   successors: %bb.4(0x40000000), %bb.2(0x40000000)
  ; UNPACKED-NEXT: {{  $}}
  ; UNPACKED-NEXT:   G_AMDGPU_BUFFER_STORE_FORMAT_D16 [[BUILD_VECTOR1]](<4 x s32>), [[BUILD_VECTOR2]](<4 x i32>), [[COPY11]](s32), [[ADD]], [[COPY7]], 0, 0, 0 :: (dereferenceable store (<4 x f16>), align 1, addrspace 8)
  ; UNPACKED-NEXT:   $exec = S_XOR_B64_term $exec, [[S_AND_SAVEEXEC_B64_]], implicit-def $scc
  ; UNPACKED-NEXT:   SI_WATERFALL_LOOP %bb.2, implicit $exec
  ; UNPACKED-NEXT: {{  $}}
  ; UNPACKED-NEXT: bb.4:
