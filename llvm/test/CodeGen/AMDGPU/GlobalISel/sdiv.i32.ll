...
; GISEL-NEXT:    v_max_i32_e32 v2, v2, v1
; GISEL-NEXT:    v_cvt_f32_u32_e32 v3, v2
; GISEL-NEXT:    v_sub_i32_e32 v4, vcc, 0, v2
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, 0, v0
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; GISEL-NEXT:    v_max_i32_e32 v5, v5, v0
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_abs_i32 s2, s1
; GISEL-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GISEL-NEXT:    s_sub_i32 s3, 0, s2
...
; GISEL-NEXT:    s_abs_i32 s3, s0
; GISEL-NEXT:    v_mul_hi_u32 v1, v0, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_mul_hi_u32 v0, s3, v0
; GISEL-NEXT:    v_readfirstlane_b32 s4, v0
; GISEL-NEXT:    s_mul_i32 s4, s4, s2
; GISEL-NEXT:    s_sub_i32 s3, s3, s4
; GISEL-NEXT:    s_sub_i32 s4, s3, s2
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GISEL-NEXT:    s_cmp_ge_u32 s3, s2
; GISEL-NEXT:    s_cselect_b64 vcc, -1, 0
; GISEL-NEXT:    s_cselect_b32 s3, s4, s3
...
; GISEL-NEXT:    v_lshrrev_b32_e32 v2, 31, v0
; GISEL-NEXT:    v_ashrrev_i32_e32 v0, 20, v0
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v2
; GISEL-NEXT:    v_lshrrev_b32_e32 v2, 31, v1
; GISEL-NEXT:    v_ashrrev_i32_e32 v1, 20, v1
...
; CHECK-NEXT:    v_mul_lo_u32 v1, v3, v2
