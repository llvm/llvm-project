...
; GFX10-NEXT:    v_readfirstlane_b32 s0, v0
; GFX10-NEXT:    v_readfirstlane_b32 s1, v1
; GFX10-NEXT:    v_cvt_u32_f32_e32 v7, s0
; GFX10-NEXT:    s_sub_u32 s0, 0, s12
; GFX10-NEXT:    v_cvt_u32_f32_e32 v8, s1
; GFX10-NEXT:    s_subb_u32 s2, 0, s13
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s1, s0, v7, 0
; GFX10-NEXT:    s_sub_u32 s1, 0, s14
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s3, s1, v8, 0
; GFX10-NEXT:    v_mul_hi_u32 v11, v9, v0
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s3, s0, v9, v[1:2]
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s3, s1, v10, v[3:4]
; GFX10-NEXT:    v_mul_lo_u32 v6, v9, v0
; GFX10-NEXT:    s_subb_u32 s3, 0, s15
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s6, s2, v7, v[4:5]
...
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s6, s1, v8, 0
; GFX10-NEXT:    s_load_dwordx8 s[4:11], s[4:5], 0x0
; GFX10-NEXT:    v_mul_hi_u32 v11, v9, v0
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s0, s0, v9, v[1:2]
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s0, s1, v10, v[3:4]
; GFX10-NEXT:    v_mul_lo_u32 v6, v9, v0
...
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s0, s12, v8, 0
...
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s0, s12, v11, v[1:2]
; GFX10-NEXT:    v_add3_u32 v7, v7, v6, v14
; GFX10-NEXT:    v_add_co_u32 v1, vcc_lo, v12, 1
...
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s0, s15, v10, v[5:6]
; GFX10-NEXT:    v_sub_co_u32 v5, vcc_lo, s8, v0
; GFX10-NEXT:    v_sub_co_u32 v14, s0, s10, v2
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v2, s1, s9, v3, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e64 s1, s12, v5
; GFX10-NEXT:    v_sub_nc_u32_e32 v0, s9, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s1
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v15, s1, s11, v4, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s1, s14, v14
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v0, vcc_lo, s13, v0, vcc_lo
; GFX10-NEXT:    v_sub_nc_u32_e32 v4, s11, v4
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, s15, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s1
; GFX10-NEXT:    v_cmp_le_u32_e64 s1, s13, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v18, 0, -1, vcc_lo
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v19, vcc_lo, s15, v4, s0
; GFX10-NEXT:    v_sub_co_u32 v4, vcc_lo, v5, s12
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v20, s0, 0, v0, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s1
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, s13, v2
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v0, vcc_lo, s13, v0, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s15, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v17, v3, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s12, v4
; GFX10-NEXT:    v_cndmask_b32_e32 v16, v18, v16, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s13, v20
; GFX10-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s13, v20
; GFX10-NEXT:    v_cndmask_b32_e64 v21, 0, -1, s0
; GFX10-NEXT:    v_cndmask_b32_e32 v17, v21, v17, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v18, vcc_lo, v14, s14
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v21, s0, 0, v19, vcc_lo
; GFX10-NEXT:    v_cmp_ne_u32_e64 s0, 0, v17
; GFX10-NEXT:    v_sub_co_u32 v17, s1, v4, s12
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v22, s1, 0, v0, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v0, v12, v1, s0
; GFX10-NEXT:    v_cmp_ne_u32_e64 s1, 0, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v1, v13, v6, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v4, v17, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s2, s15, v21
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v13, vcc_lo, s15, v19, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v0, v8, v0, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v20, v22, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s14, v18
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v5, v3, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v1, v11, v1, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s2
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s0
; GFX10-NEXT:    v_add_co_u32 v5, s0, v10, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v11, s0, 0, v7, s0
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, s15, v21
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v6, v3, s0
; GFX10-NEXT:    v_add_co_u32 v6, s0, v5, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v12, s0, 0, v11, s0
; GFX10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v3
; GFX10-NEXT:    v_sub_co_u32 v3, s0, v18, s14
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v13, s0, 0, v13, s0
; GFX10-NEXT:    v_cndmask_b32_e32 v6, v5, v6, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v11, v11, v12, vcc_lo
; GFX10-NEXT:    v_cmp_ne_u32_e64 s0, 0, v16
; GFX10-NEXT:    v_cndmask_b32_e32 v12, v18, v3, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v13, v21, v13, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v2, v8, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v10, v6, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v7, v11, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v14, v12, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v15, v13, s0
