...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_add_i32 s12, s12, s17
; GFX8-NEXT:    s_load_dwordx4 s[16:19], s[8:9], 0x20
; GFX8-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX8-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX8-NEXT:    s_load_dwordx8 s[8:15], s[8:9], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v5, v2
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v2
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v3, v0
; GFX8-NEXT:    v_addc_u32_e32 v4, vcc, v4, v1, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s2, v5, 0
; GFX8-NEXT:    v_mov_b32_e32 v0, v2
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s2, v4, v[0:1]
; GFX8-NEXT:    v_mul_hi_u32 v7, v5, v1
; GFX8-NEXT:    s_sub_u32 s2, 0, s18
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s3, v5, v[2:3]
; GFX8-NEXT:    v_mul_lo_u32 v3, v4, v1
; GFX8-NEXT:    v_mul_hi_u32 v1, v4, v1
; GFX8-NEXT:    v_mul_lo_u32 v6, v5, v2
...
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v7, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v6, v3
; GFX8-NEXT:    v_mul_hi_u32 v6, v5, v2
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v7, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v7, v6
; GFX8-NEXT:    v_mul_hi_u32 v2, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v6, v3
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v3
...
; GFX8-NEXT:    v_mul_lo_u32 v3, s13, v1
; GFX8-NEXT:    v_mul_lo_u32 v4, s12, v2
; GFX8-NEXT:    v_mul_hi_u32 v5, s12, v1
; GFX8-NEXT:    v_mul_hi_u32 v1, s13, v1
; GFX8-NEXT:    v_cvt_f32_u32_e32 v6, s19
...
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v4, v3
; GFX8-NEXT:    v_mul_hi_u32 v4, s12, v2
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v5, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v5, v4
; GFX8-NEXT:    v_cvt_f32_u32_e32 v5, s18
; GFX8-NEXT:    v_mul_f32_e32 v6, 0x4f800000, v6
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v3
; GFX8-NEXT:    v_add_f32_e32 v5, v6, v5
; GFX8-NEXT:    v_rcp_iflag_f32_e32 v5, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v4, v3
; GFX8-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v5
; GFX8-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v4
; GFX8-NEXT:    v_trunc_f32_e32 v5, v5
; GFX8-NEXT:    v_mul_f32_e32 v6, 0xcf800000, v5
; GFX8-NEXT:    v_add_f32_e32 v4, v6, v4
; GFX8-NEXT:    v_mul_hi_u32 v2, s13, v2
; GFX8-NEXT:    v_cvt_u32_f32_e32 v9, v4
; GFX8-NEXT:    v_cvt_u32_f32_e32 v11, v5
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s16, v1, 0
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v3
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s2, v9, 0
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s2, v11, v[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v4, v6
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s3, v9, v[7:8]
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s16, v2, v[4:5]
; GFX8-NEXT:    v_mul_lo_u32 v4, v11, v3
; GFX8-NEXT:    v_mul_lo_u32 v12, v9, v6
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s17, v1, v[7:8]
...
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v8, v11, v6
; GFX8-NEXT:    v_mul_hi_u32 v3, v11, v3
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v12, v4
; GFX8-NEXT:    v_mul_hi_u32 v12, v9, v6
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v8, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v3, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v12
; GFX8-NEXT:    v_mul_hi_u32 v6, v11, v6
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v3, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v8, v4
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v6, v4
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v9, v3
; GFX8-NEXT:    v_mad_u64_u32 v[8:9], s[0:1], s2, v6, 0
; GFX8-NEXT:    v_addc_u32_e32 v11, vcc, v11, v4, vcc
; GFX8-NEXT:    v_mov_b32_e32 v4, v9
; GFX8-NEXT:    v_sub_u32_e32 v12, vcc, s12, v5
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v11, v[4:5]
; GFX8-NEXT:    v_subb_u32_e64 v3, s[0:1], v10, v7, vcc
; GFX8-NEXT:    v_sub_u32_e64 v7, s[0:1], s13, v7
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s17, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s3, v6, v[4:5]
; GFX8-NEXT:    v_mul_lo_u32 v5, v11, v8
; GFX8-NEXT:    v_mul_hi_u32 v14, v6, v8
; GFX8-NEXT:    v_mul_lo_u32 v13, v6, v4
; GFX8-NEXT:    v_subb_u32_e32 v7, vcc, v7, v0, vcc
; GFX8-NEXT:    v_mul_hi_u32 v8, v11, v8
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v5, v13
; GFX8-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v5, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v14, v11, v4
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v13, v5
; GFX8-NEXT:    v_mul_hi_u32 v13, v6, v4
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v14, v8
; GFX8-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v13
; GFX8-NEXT:    v_cndmask_b32_e64 v13, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, v14, v13
...
; GFX8-NEXT:    v_mul_lo_u32 v4, s15, v5
; GFX8-NEXT:    v_mul_lo_u32 v8, s14, v6
; GFX8-NEXT:    v_mul_hi_u32 v14, s14, v5
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v12
; GFX8-NEXT:    v_subrev_u32_e32 v11, vcc, s16, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[0:1]
; GFX8-NEXT:    v_subbrev_u32_e64 v13, s[0:1], 0, v7, vcc
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v4, v8
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v4, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[0:1]
; GFX8-NEXT:    v_mul_lo_u32 v14, s15, v6
; GFX8-NEXT:    v_mul_hi_u32 v5, s15, v5
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v8, v4
; GFX8-NEXT:    v_mul_hi_u32 v8, s14, v6
; GFX8-NEXT:    v_add_u32_e64 v5, s[0:1], v14, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v5, s[0:1], v5, v8
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v15, s[0:1], v5, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s18, v15, 0
; GFX8-NEXT:    v_cmp_le_u32_e64 s[2:3], s17, v13
; GFX8-NEXT:    v_add_u32_e64 v17, s[0:1], 1, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v18, 0, -1, s[2:3]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[2:3], s17, v3
; GFX8-NEXT:    v_cmp_le_u32_e64 s[4:5], s16, v11
; GFX8-NEXT:    v_mul_hi_u32 v6, s15, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v19, 0, -1, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v9, v10, s[2:3]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[2:3], s17, v13
; GFX8-NEXT:    v_addc_u32_e64 v10, s[0:1], 0, v2, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v18, v18, v19, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v19, s[0:1], 1, v17
; GFX8-NEXT:    v_subb_u32_e32 v7, vcc, v7, v0, vcc
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v14, v8
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, 0, v10, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v8, s[0:1], v8, v16
; GFX8-NEXT:    v_add_u32_e64 v8, s[0:1], v6, v8
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s18, v8, v[5:6]
; GFX8-NEXT:    v_mov_b32_e32 v16, s19
; GFX8-NEXT:    v_subrev_u32_e32 v14, vcc, s16, v11
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s19, v15, v[5:6]
; GFX8-NEXT:    v_sub_u32_e64 v20, s[0:1], s14, v4
; GFX8-NEXT:    v_mov_b32_e32 v6, s15
; GFX8-NEXT:    v_cmp_le_u32_e64 s[4:5], s18, v20
; GFX8-NEXT:    v_subb_u32_e64 v21, s[2:3], v6, v5, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[4:5]
; GFX8-NEXT:    v_sub_u32_e64 v5, s[4:5], s15, v5
; GFX8-NEXT:    v_cmp_le_u32_e64 s[2:3], s19, v21
; GFX8-NEXT:    v_subb_u32_e64 v5, s[0:1], v5, v16, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[2:3]
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[2:3], 0, v18
; GFX8-NEXT:    v_subrev_u32_e64 v18, s[0:1], s18, v20
; GFX8-NEXT:    v_cndmask_b32_e64 v17, v17, v19, s[2:3]
; GFX8-NEXT:    v_subbrev_u32_e64 v19, s[4:5], 0, v5, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v10, v10, v0, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v22, s[4:5], 1, v15
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v1, v17, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v2, v10, s[6:7]
; GFX8-NEXT:    v_subbrev_u32_e32 v2, vcc, 0, v7, vcc
; GFX8-NEXT:    v_addc_u32_e64 v7, vcc, 0, v8, s[4:5]
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s19, v19
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v11, v14, s[2:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, -1, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v13, v2, s[2:3]
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s19, v21
; GFX8-NEXT:    v_cmp_le_u32_e64 s[2:3], s18, v18
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[2:3]
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v4, v6, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s19, v19
; GFX8-NEXT:    v_add_u32_e64 v13, s[2:3], 1, v22
; GFX8-NEXT:    v_cndmask_b32_e32 v10, v10, v11, vcc
; GFX8-NEXT:    v_addc_u32_e64 v11, vcc, 0, v7, s[2:3]
; GFX8-NEXT:    v_subb_u32_e64 v5, vcc, v5, v16, s[0:1]
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; GFX8-NEXT:    v_subrev_u32_e64 v10, s[0:1], s18, v18
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v7, v11, vcc
; GFX8-NEXT:    v_subbrev_u32_e64 v11, s[0:1], 0, v5, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v12, v9, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e32 v9, v22, v13, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v3, v2, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v15, v9, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v8, v7, s[0:1]
; GFX8-NEXT:    v_mov_b32_e32 v8, s8
; GFX8-NEXT:    v_mov_b32_e32 v9, s9
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v18, v10, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v19, v11, vcc
; GFX8-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v20, v6, s[0:1]
; GFX8-NEXT:    v_mov_b32_e32 v0, s10
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v21, v7, s[0:1]
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx4 s[20:23], s[8:9], 0x20
; GFX9-NEXT:    s_load_dwordx8 s[12:19], s[8:9], 0x0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, s21
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, s20
; GFX9-NEXT:    s_sub_u32 s2, 0, s20
; GFX9-NEXT:    s_subb_u32 s3, 0, s21
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f800000, v0
; GFX9-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v0, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v1, v5, v2, v1
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v3, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s2, v5, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, v2
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s2, v4, v[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v7, v5, v1
; GFX9-NEXT:    s_sub_u32 s2, 0, s22
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s3, v5, v[2:3]
; GFX9-NEXT:    v_mul_lo_u32 v3, v4, v1
; GFX9-NEXT:    v_mul_hi_u32 v1, v4, v1
; GFX9-NEXT:    v_mul_lo_u32 v6, v5, v2
; GFX9-NEXT:    s_subb_u32 s3, 0, s23
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v2, v6, v3, v2
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v5, v1
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v2, vcc
; GFX9-NEXT:    v_mul_lo_u32 v2, s17, v1
; GFX9-NEXT:    v_mul_lo_u32 v4, s16, v3
; GFX9-NEXT:    v_mul_hi_u32 v5, s16, v1
; GFX9-NEXT:    v_mul_hi_u32 v1, s17, v1
; GFX9-NEXT:    v_cvt_f32_u32_e32 v6, s23
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v5, s17, v3
; GFX9-NEXT:    v_add_u32_e32 v2, v4, v2
; GFX9-NEXT:    v_mul_hi_u32 v4, s16, v3
...
; GFX9-NEXT:    v_cvt_f32_u32_e32 v5, s22
; GFX9-NEXT:    v_mul_hi_u32 v3, s17, v3
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v1, v2
; GFX9-NEXT:    v_add_f32_e32 v5, v6, v5
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v6, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v3, v4, v1, v3
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s20, v2, 0
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x5f7ffffc, v6
; GFX9-NEXT:    v_mul_f32_e32 v6, 0x2f800000, v1
; GFX9-NEXT:    v_trunc_f32_e32 v7, v6
; GFX9-NEXT:    v_mul_f32_e32 v6, 0xcf800000, v7
; GFX9-NEXT:    v_add_f32_e32 v1, v6, v1
; GFX9-NEXT:    v_cvt_u32_f32_e32 v12, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v5
; GFX9-NEXT:    v_cvt_u32_f32_e32 v13, v7
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s20, v3, v[1:2]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v12, 0
; GFX9-NEXT:    v_sub_co_u32_e32 v4, vcc, s16, v4
; GFX9-NEXT:    v_mov_b32_e32 v1, v6
; GFX9-NEXT:    v_mad_u64_u32 v[9:10], s[0:1], s2, v13, v[1:2]
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s21, v2, v[7:8]
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s3, v12, v[9:10]
; GFX9-NEXT:    v_subb_co_u32_e64 v1, s[0:1], v11, v6, vcc
; GFX9-NEXT:    v_sub_u32_e32 v8, s17, v6
; GFX9-NEXT:    v_mul_lo_u32 v6, v13, v5
; GFX9-NEXT:    v_mul_lo_u32 v9, v12, v7
; GFX9-NEXT:    v_mul_hi_u32 v11, v12, v5
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s21, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v6, s[0:1], v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v6, s[0:1], v6, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v11, v13, v7
; GFX9-NEXT:    v_mul_hi_u32 v5, v13, v5
; GFX9-NEXT:    v_add_u32_e32 v6, v9, v6
; GFX9-NEXT:    v_mul_hi_u32 v9, v12, v7
...
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[0:1]
; GFX9-NEXT:    v_add3_u32 v6, v9, v6, v7
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[0:1], v12, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v11, s[0:1], v13, v6, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s2, v9, 0
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s20, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s2, v11, v[6:7]
; GFX9-NEXT:    v_subb_co_u32_e32 v8, vcc, v8, v0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s3, v9, v[6:7]
; GFX9-NEXT:    v_subrev_co_u32_e32 v13, vcc, s20, v4
; GFX9-NEXT:    v_subbrev_co_u32_e64 v14, s[0:1], 0, v8, vcc
; GFX9-NEXT:    v_mul_lo_u32 v7, v11, v5
; GFX9-NEXT:    v_mul_lo_u32 v17, v9, v6
; GFX9-NEXT:    v_add_co_u32_e64 v15, s[0:1], 1, v2
; GFX9-NEXT:    v_mul_hi_u32 v19, v9, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v16, s[0:1], 0, v3, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s21, v14
; GFX9-NEXT:    v_cndmask_b32_e64 v18, 0, -1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v7, s[0:1], v7, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v7, s[0:1], v7, v19
; GFX9-NEXT:    v_mul_lo_u32 v19, v11, v6
; GFX9-NEXT:    v_mul_hi_u32 v5, v11, v5
; GFX9-NEXT:    v_mul_hi_u32 v20, v9, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v6, v11, v6
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v19, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v19, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v5, v20
; GFX9-NEXT:    v_add_u32_e32 v7, v17, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v5, v7
; GFX9-NEXT:    v_add_u32_e32 v17, v19, v20
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX9-NEXT:    v_add3_u32 v6, v17, v7, v6
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v9, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v7, s[0:1], v11, v6, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v6, s19, v5
; GFX9-NEXT:    v_mul_lo_u32 v9, s18, v7
; GFX9-NEXT:    v_mul_hi_u32 v17, s18, v5
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s20, v13
; GFX9-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v6, s[0:1], v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v6, s[0:1], v6, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v17, s19, v7
; GFX9-NEXT:    v_mul_hi_u32 v5, s19, v5
; GFX9-NEXT:    v_add_u32_e32 v6, v9, v6
; GFX9-NEXT:    v_mul_hi_u32 v9, s18, v7
; GFX9-NEXT:    v_mul_hi_u32 v7, s19, v7
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v17, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v5, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v19, s[0:1], v5, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s22, v19, 0
; GFX9-NEXT:    v_add_u32_e32 v9, v17, v9
; GFX9-NEXT:    v_add3_u32 v9, v9, v20, v7
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[2:3], s22, v9, v[6:7]
; GFX9-NEXT:    v_subb_co_u32_e32 v0, vcc, v8, v0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[2:3], s23, v19, v[6:7]
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, s21, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v10, v12, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, s21, v14
; GFX9-NEXT:    v_cndmask_b32_e32 v11, v18, v11, vcc
; GFX9-NEXT:    v_mov_b32_e32 v7, s19
; GFX9-NEXT:    v_sub_co_u32_e32 v18, vcc, s18, v5
; GFX9-NEXT:    v_mov_b32_e32 v12, s23
; GFX9-NEXT:    v_subb_co_u32_e64 v20, s[2:3], v7, v6, vcc
; GFX9-NEXT:    v_sub_u32_e32 v6, s19, v6
; GFX9-NEXT:    v_cmp_le_u32_e64 s[2:3], s23, v20
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, v6, v12, vcc
; GFX9-NEXT:    v_add_co_u32_e64 v21, s[0:1], 1, v15
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[2:3]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[2:3], 0, v11
; GFX9-NEXT:    v_cmp_le_u32_e64 s[4:5], s22, v18
; GFX9-NEXT:    v_subrev_co_u32_e32 v11, vcc, s22, v18
; GFX9-NEXT:    v_addc_co_u32_e64 v17, s[0:1], 0, v16, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v15, v15, v21, s[2:3]
; GFX9-NEXT:    v_subbrev_co_u32_e64 v21, s[4:5], 0, v6, vcc
; GFX9-NEXT:    v_subrev_co_u32_e64 v8, s[0:1], s20, v13
; GFX9-NEXT:    v_cndmask_b32_e64 v16, v16, v17, s[2:3]
; GFX9-NEXT:    v_add_co_u32_e64 v17, s[4:5], 1, v19
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v10
; GFX9-NEXT:    v_subbrev_co_u32_e64 v0, s[0:1], 0, v0, s[0:1]
; GFX9-NEXT:    v_addc_co_u32_e64 v10, s[0:1], 0, v9, s[4:5]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s23, v21
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v13, v8, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v0, v14, v0, s[2:3]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s23, v20
; GFX9-NEXT:    v_cmp_le_u32_e64 s[2:3], s22, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v7, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s23, v21
; GFX9-NEXT:    v_add_co_u32_e64 v7, s[2:3], 1, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v14, s[0:1]
; GFX9-NEXT:    v_subb_co_u32_e32 v12, vcc, v6, v12, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v14, s[0:1], 0, v10, s[2:3]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v4, v8, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v10, v14, vcc
; GFX9-NEXT:    v_subrev_co_u32_e64 v10, s[0:1], s22, v11
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v17, v7, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[2:3], 0, v5
; GFX9-NEXT:    v_subbrev_co_u32_e64 v12, s[0:1], 0, v12, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v15, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v3, v16, s[6:7]
; GFX9-NEXT:    v_mov_b32_e32 v13, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v1, v0, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v19, v4, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v9, v8, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v11, v10, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v21, v12, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v18, v0, s[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v20, v1, s[2:3]
