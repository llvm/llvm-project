...
; CHECK-NEXT: [[MATA:%[0-9]+]]:vreg_128 = SCRATCH_LOAD_DWORDX4_SADDR [[SADDR1]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: [[SADDR2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 16
; CHECK-NEXT: [[MATB:%[0-9]+]]:vreg_128 = SCRATCH_LOAD_DWORDX4_SADDR [[SADDR2]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: early-clobber [[MATD:%[0-9]+]]:vreg_256 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, [[MATA]], 8, [[MATB]], 8, 0, 0, 0, implicit $exec
...
; VIDX-NEXT: early-clobber [[MATD:%[0-9]+]]:vreg_256 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, [[MATA]], 8, [[MATB]], 8, 0, 0, 0, implicit $exec
