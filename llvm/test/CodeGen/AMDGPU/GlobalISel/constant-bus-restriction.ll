...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: fma_s_s_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v0, s4
; GFX11-NEXT:    v_fma_f32 v0, s3, s2, v0
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-LABEL: fma_sss:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_fma_f32 v0, s2, s2, s2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: fma_ss_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_fma_f32 v0, s2, s2, s3
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: fma_s_ss:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_fma_f32 v0, s2, s3, s3
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: fma_ss_s_same_outer:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_fma_f32 v0, s2, s3, s2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: fcmp_s_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_cmp_eq_f32_e64 s0, s2, s3
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: select_vcc_s_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v2, s3
; GFX11-NEXT:    v_cmp_eq_f32_e32 vcc_lo, v0, v1
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v2, s2, vcc_lo
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: select_vcc_fneg_s_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v2, s2
; GFX11-NEXT:    v_cmp_eq_f32_e32 vcc_lo, v0, v1
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s3, -v2, vcc_lo
; GFX11-NEXT:    ; return to shader part epilog
  %cmp = fcmp oeq float %cmp0, %cmp1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: amdgcn_div_fmas_sss:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_div_fmas_f32 v0, s2, s2, s2
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: class_s_s:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_cmp_class_f32_e64 s0, s2, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s0
; GFX11-NEXT:    ; return to shader part epilog
