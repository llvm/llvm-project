...
; RUN: llc -amdgpu-global-isel-new-legality -global-isel -mtriple=amdgpu7.00-mesa-mesa3d -simplify-mir -stop-after=amdgpu-reg-bank-legalize -o - %s | FileCheck %s -check-prefix=GFX7
