...
define amdgpu_ps void @s_fneg_f16_salu_use(half inreg %in, i32 inreg %val) {
; GFX11-LABEL: s_fneg_f16_salu_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor_b32_e64 v0, 0x8000, s0
...
define amdgpu_ps void @s_fneg_f32_salu_use(float inreg %in, i32 inreg %val) {
; GFX11-LABEL: s_fneg_f32_salu_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor_b32_e64 v0, 0x80000000, s0
; GFX11-NEXT:    s_cmp_eq_u32 s1, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    s_cselect_b32 s0, s0, 0
...
define amdgpu_ps void @s_fneg_f64_salu_use(double inreg %in, i32 inreg %val) {
; GCN-LABEL: s_fneg_f64_salu_use:
; GCN:       ; %bb.0:
...
define amdgpu_ps void @s_fneg_v2f32_salu_use(<2 x float> inreg %in, i32 inreg %val) {
; GFX11-LABEL: s_fneg_v2f32_salu_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor_b32_e64 v0, 0x80000000, s0
; GFX11-NEXT:    v_xor_b32_e64 v1, 0x80000000, s1
