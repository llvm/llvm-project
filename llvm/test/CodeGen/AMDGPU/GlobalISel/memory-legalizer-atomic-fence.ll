...
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -verify-machineinstrs < %s | FileCheck -check-prefixes=FUNC,GCN,GFX10PLUS,GFX10PLUSWGP %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -mattr=+cumode -verify-machineinstrs < %s | FileCheck -check-prefixes=FUNC,GCN,GFX10PLUS,GFX10PLUSCU %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -verify-machineinstrs < %s | FileCheck -check-prefixes=FUNC,GCN,GFX10PLUS,GFX10PLUSWGP %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -mattr=+cumode -verify-machineinstrs < %s | FileCheck -check-prefixes=FUNC,GCN,GFX10PLUS,GFX10PLUSCU %s
...
; GFX10PLUS:      s_waitcnt vmcnt(0){{$}}
; GFX10PLUS-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUS-NEXT: buffer_gl0_inv{{$}}
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_one_as_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_one_as_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_one_as_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_one_as_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_one_as_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_one_as_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_one_as_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_one_as_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_one_as_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_one_as_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_one_as_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_one_as_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUSWGP:      s_waitcnt vmcnt(0){{$}}
; GFX10PLUSWGP-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUSCU-NOT:   s_waitcnt vmcnt(0){{$}}
; GFX10PLUSCU-NOT:   s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUSWGP-NEXT: buffer_gl0_inv{{$}}
; GFX10PLUSCU-NOT:   buffer_gl0_inv{{$}}
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_one_as_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUSCU-NOT:   s_waitcnt vmcnt(0){{$}}
; GFX10PLUSCU-NOT:   s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUS-NOT:     buffer_gl0_inv
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_one_as_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_one_as_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_one_as_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_one_as_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_one_as_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_one_as_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_one_as_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel system_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel singlethread_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GFX10PLUS-NEXT: buffer_gl1_inv{{$}}
; GCN:            s_endpgm
; GFX10PLUS:         .amdhsa_kernel agent_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN:               %bb.0
; GFX68-NOT:         s_waitcnt vmcnt(0){{$}}
; GFX10PLUSWGP:      s_waitcnt vmcnt(0) lgkmcnt(0){{$}}
; GFX10PLUSWGP-NEXT: s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUSCU-NOT:   s_waitcnt vmcnt(0){{$}}
; GFX10PLUSCU-NOT:   s_waitcnt_vscnt null, 0x0{{$}}
; GFX10PLUSWGP-NEXT: buffer_gl0_inv{{$}}
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:           ATOMIC_FENCE
; GCN:               s_endpgm
; GFX10PLUS:         .amdhsa_kernel workgroup_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_acquire
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_release
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_acq_rel
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
...
; GCN-NOT:    ATOMIC_FENCE
; GCN:        s_endpgm
; GFX10PLUS:         .amdhsa_kernel wavefront_seq_cst
; GFX10PLUSWGP-NOT:  .amdhsa_workgroup_processor_mode 0
; GFX10PLUSCU:       .amdhsa_workgroup_processor_mode 0
; GFX10PLUS-NOT:     .amdhsa_memory_ordered 0
