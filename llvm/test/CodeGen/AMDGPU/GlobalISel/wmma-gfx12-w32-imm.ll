...
define amdgpu_ps void @test_wmma_f32_16x16x16_f16_imm(<8 x half> %A, <8 x half> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f32_16x16x16_bf16_imm(<8 x i16> %A, <8 x i16> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f16_16x16x16_f16_imm(<8 x half> %A, <8 x half> %B, <8 x half> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_bf16_16x16x16_bf16_imm(<8 x i16> %A, <8 x i16> %B, <8 x i16> addrspace(1)* %out) {
...
bb:
  ...
  store <8 x i16> %res, <8 x i16> addrspace(1)* %out
  ret void
}

define amdgpu_ps void @test_wmma_i32_16x16x16_iu8_imm(<2 x i32> %A, <2 x i32> %B, <8 x i32> addrspace(1)* %out) {
...
bb:
  ...
  store <8 x i32> %res, <8 x i32> addrspace(1)* %out
  ret void
}

define amdgpu_ps void @test_wmma_i32_16x16x16_iu4_imm(i32 %A, i32 %B, <8 x i32> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f32_16x16x16_fp8_fp8_imm(<2 x i32> %A, <2 x i32> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f32_16x16x16_bf8_fp8_imm(<2 x i32> %A, <2 x i32> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f32_16x16x16_fp8_bf8_imm(<2 x i32> %A, <2 x i32> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_f32_16x16x16_bf8_bf8_imm(<2 x i32> %A, <2 x i32> %B, <8 x float> addrspace(1)* %out) {
...
define amdgpu_ps void @test_wmma_i32_16x16x32_iu4_imm(<2 x i32> %A, <2 x i32> %B, <8 x i32> addrspace(1)* %out) {
