...
; GFX8-NEXT:    s_xor_b64 s[16:17], s[0:1], s[6:7]
...
; GFX8-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX8-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX8-NEXT:    s_sub_u32 s18, 0, s16
; GFX8-NEXT:    s_subb_u32 s19, 0, s17
; GFX8-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GFX8-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GFX8-NEXT:    v_trunc_f32_e32 v2, v1
; GFX8-NEXT:    v_mul_f32_e32 v1, 0xcf800000, v2
...
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v3, v2
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v5, v2
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s16, v3, v[1:2]
...
; GFX8-NEXT:    v_addc_u32_e64 v10, s[0:1], 0, v3, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s17, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v8
; GFX8-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s17, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v11, v11, v12, s[0:1]
...
; GFX8-NEXT:    v_subrev_u32_e32 v15, vcc, s16, v8
...
; GFX8-NEXT:    s_xor_b64 s[14:15], s[0:1], s[6:7]
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[16:17], s20, v13, v[1:2]
...
; GFX9-NEXT:    s_xor_b64 s[16:17], s[0:1], s[6:7]
...
; GFX9-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX9-NEXT:    s_sub_u32 s18, 0, s16
; GFX9-NEXT:    s_subb_u32 s19, 0, s17
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v0
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GFX9-NEXT:    v_trunc_f32_e32 v2, v1
; GFX9-NEXT:    v_mul_f32_e32 v1, 0xcf800000, v2
...
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v0, v2
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s16, v5, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX9-NEXT:    v_add3_u32 v4, v3, v0, v6
; GFX9-NEXT:    v_mov_b32_e32 v0, v2
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s16, v4, v[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v6, s13
; GFX9-NEXT:    v_sub_co_u32_e32 v8, vcc, s12, v1
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s17, v5, v[2:3]
...
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v8
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v7, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s17, v6
; GFX9-NEXT:    v_subrev_co_u32_e32 v9, vcc, s16, v8
...
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s17, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s17, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v12, v13, s[0:1]
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v16, vcc, s16, v9
...
; GFX9-NEXT:    s_xor_b64 s[14:15], s[0:1], s[6:7]
...
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s16, v14, v[2:3]
...
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s16, v11, v[1:2]
...
; GFX9-NEXT:    v_mul_hi_u32 v12, s15, v4
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
...
; GFX9-NEXT:    v_add_u32_e32 v7, v8, v7
; GFX9-NEXT:    v_mul_hi_u32 v8, s14, v4
...
; GFX10-NEXT:    s_load_dwordx4 s[20:23], s[4:5], 0x20
; GFX10-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_ashr_i32 s4, s21, 31
; GFX10-NEXT:    s_ashr_i32 s2, s13, 31
; GFX10-NEXT:    s_mov_b32 s5, s4
; GFX10-NEXT:    s_add_u32 s0, s12, s2
; GFX10-NEXT:    s_addc_u32 s1, s13, s2
; GFX10-NEXT:    s_add_u32 s6, s20, s4
; GFX10-NEXT:    s_addc_u32 s7, s21, s4
; GFX10-NEXT:    s_mov_b32 s3, s2
; GFX10-NEXT:    s_xor_b64 s[18:19], s[6:7], s[4:5]
; GFX10-NEXT:    s_xor_b64 s[0:1], s[0:1], s[2:3]
; GFX10-NEXT:    v_cvt_f32_u32_e32 v1, s19
; GFX10-NEXT:    s_sub_u32 s20, 0, s18
; GFX10-NEXT:    s_subb_u32 s21, 0, s19
; GFX10-NEXT:    s_xor_b64 s[16:17], s[2:3], s[4:5]
; GFX10-NEXT:    s_ashr_i32 s4, s15, 31
; GFX10-NEXT:    v_cvt_f32_u32_e32 v0, s18
; GFX10-NEXT:    s_ashr_i32 s6, s23, 31
; GFX10-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v1
; GFX10-NEXT:    s_add_u32 s14, s14, s4
; GFX10-NEXT:    s_addc_u32 s15, s15, s4
; GFX10-NEXT:    s_add_u32 s12, s22, s6
; GFX10-NEXT:    s_mov_b32 s7, s6
; GFX10-NEXT:    s_addc_u32 s13, s23, s6
; GFX10-NEXT:    v_add_f32_e32 v0, v1, v0
; GFX10-NEXT:    s_xor_b64 s[12:13], s[12:13], s[6:7]
; GFX10-NEXT:    s_mov_b32 s5, s4
; GFX10-NEXT:    v_cvt_f32_u32_e32 v1, s13
; GFX10-NEXT:    v_cvt_f32_u32_e32 v2, s12
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX10-NEXT:    s_xor_b64 s[14:15], s[14:15], s[4:5]
; GFX10-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v1
...
; GFX10-NEXT:    s_sub_u32 s3, 0, s12
; GFX10-NEXT:    s_subb_u32 s22, 0, s13
...
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s23, s3, v4, 0
...
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s3, s18, v9, 0
; GFX10-NEXT:    v_mul_lo_u32 v6, s19, v9
; GFX10-NEXT:    v_mul_lo_u32 v7, s18, v5
...
; GFX10-NEXT:    v_sub_co_u32 v8, s0, v12, s18
...
; GFX10-NEXT:    v_mul_lo_u32 v7, s12, v2
...
; GFX10-NEXT:    v_sub_co_u32 v7, s0, v12, s12
...
; GFX10-NEXT:    s_xor_b64 s[0:1], s[4:5], s[6:7]
...
; GFX10-NEXT:    v_xor_b32_e32 v8, s4, v8
...
; GFX10-NEXT:    v_sub_co_u32 v6, vcc_lo, v8, s4
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v7, vcc_lo, s4, v7, vcc_lo
