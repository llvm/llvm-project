...
; GFX8-NEXT:    v_addc_u32_e64 v13, s[0:1], 0, v10, s[0:1]
; GFX8-NEXT:    s_add_u32 s0, s18, s8
; GFX8-NEXT:    s_addc_u32 s1, s19, s8
; GFX8-NEXT:    s_add_u32 s2, s2, s10
; GFX8-NEXT:    s_mov_b32 s11, s10
; GFX8-NEXT:    s_addc_u32 s3, s3, s10
; GFX8-NEXT:    s_xor_b64 s[16:17], s[2:3], s[10:11]
; GFX8-NEXT:    v_cvt_f32_u32_e32 v14, s17
; GFX8-NEXT:    v_subb_u32_e32 v0, vcc, v0, v5, vcc
; GFX8-NEXT:    v_cvt_f32_u32_e32 v5, s16
...
; GFX8-NEXT:    s_subb_u32 s18, 0, s17
; GFX8-NEXT:    v_cndmask_b32_e32 v8, v8, v15, vcc
...
; GFX8-NEXT:    v_cndmask_b32_e32 v10, v10, v13, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v3, v10, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s5, v5, v[1:2]
; GFX8-NEXT:    v_mul_lo_u32 v8, v5, v0
; GFX8-NEXT:    v_xor_b32_e32 v4, s20, v4
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s18, v12, v[1:2]
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s5, v8, 0
; GFX8-NEXT:    v_xor_b32_e32 v9, s21, v3
; GFX8-NEXT:    v_mov_b32_e32 v11, s4
; GFX8-NEXT:    v_mov_b32_e32 v0, v2
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s5, v5, v[0:1]
; GFX8-NEXT:    v_subrev_u32_e32 v0, vcc, s20, v4
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s18, v8, v[2:3]
; GFX8-NEXT:    v_xor_b32_e32 v3, s4, v7
; GFX8-NEXT:    v_mul_lo_u32 v4, v5, v1
; GFX8-NEXT:    v_mul_lo_u32 v7, v8, v2
; GFX8-NEXT:    v_mul_hi_u32 v12, v8, v1
; GFX8-NEXT:    v_mul_hi_u32 v1, v5, v1
; GFX8-NEXT:    v_mov_b32_e32 v10, s21
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v4, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v4, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[0:1]
; GFX8-NEXT:    v_mul_lo_u32 v12, v5, v2
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v7, v4
; GFX8-NEXT:    v_mul_hi_u32 v7, v8, v2
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v12, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v1, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v7, s[0:1], v12, v7
; GFX8-NEXT:    v_mul_hi_u32 v2, v5, v2
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v1, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v7, v4
; GFX8-NEXT:    v_add_u32_e64 v2, s[0:1], v2, v4
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v8, v1
; GFX8-NEXT:    v_addc_u32_e64 v2, s[0:1], v5, v2, s[0:1]
; GFX8-NEXT:    v_mul_lo_u32 v5, s7, v1
; GFX8-NEXT:    v_mul_lo_u32 v7, s6, v2
; GFX8-NEXT:    v_subrev_u32_e64 v4, s[0:1], s4, v3
; GFX8-NEXT:    v_mul_hi_u32 v3, s6, v1
; GFX8-NEXT:    v_add_u32_e64 v5, s[2:3], v5, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v5, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[2:3]
; GFX8-NEXT:    v_mul_lo_u32 v5, s7, v2
; GFX8-NEXT:    v_mul_hi_u32 v1, s7, v1
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v7, v3
; GFX8-NEXT:    v_mul_hi_u32 v7, s6, v2
; GFX8-NEXT:    v_add_u32_e64 v1, s[2:3], v5, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v1, s[2:3], v1, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[2:3]
; GFX8-NEXT:    v_add_u32_e64 v5, s[2:3], v5, v7
; GFX8-NEXT:    v_add_u32_e64 v7, s[2:3], v1, v3
; GFX8-NEXT:    v_mul_hi_u32 v8, s7, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[2:3]
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s16, v7, 0
; GFX8-NEXT:    v_add_u32_e64 v3, s[2:3], v5, v3
; GFX8-NEXT:    v_add_u32_e64 v8, s[2:3], v8, v3
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s16, v8, v[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v5, s17
; GFX8-NEXT:    v_mov_b32_e32 v12, s7
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s17, v7, v[2:3]
; GFX8-NEXT:    v_sub_u32_e64 v3, s[2:3], s6, v1
; GFX8-NEXT:    v_sub_u32_e64 v1, s[4:5], s7, v2
; GFX8-NEXT:    v_subb_u32_e64 v12, s[4:5], v12, v2, s[2:3]
; GFX8-NEXT:    v_subb_u32_e64 v13, s[2:3], v1, v5, s[2:3]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[4:5], s17, v12
; GFX8-NEXT:    v_subrev_u32_e64 v14, s[2:3], s16, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[4:5]
; GFX8-NEXT:    v_subbrev_u32_e64 v15, s[4:5], 0, v13, s[2:3]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[4:5], s17, v15
; GFX8-NEXT:    v_cmp_le_u32_e64 s[6:7], s16, v3
; GFX8-NEXT:    v_subb_u32_e32 v1, vcc, v9, v10, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[6:7]
; GFX8-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s[4:5]
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s17, v12
; GFX8-NEXT:    v_cmp_le_u32_e64 s[4:5], s16, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v2, v16, vcc
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, s17, v15
; GFX8-NEXT:    v_add_u32_e64 v10, s[4:5], 1, v7
; GFX8-NEXT:    v_cndmask_b32_e32 v9, v17, v9, vcc
; GFX8-NEXT:    v_addc_u32_e64 v16, vcc, 0, v8, s[4:5]
; GFX8-NEXT:    v_subb_u32_e64 v5, vcc, v13, v5, s[2:3]
; GFX8-NEXT:    v_add_u32_e32 v13, vcc, 1, v10
; GFX8-NEXT:    v_addc_u32_e32 v17, vcc, 0, v16, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GFX8-NEXT:    v_cndmask_b32_e32 v9, v10, v13, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v10, s[2:3], s16, v14
; GFX8-NEXT:    v_cndmask_b32_e32 v13, v16, v17, vcc
; GFX8-NEXT:    v_subbrev_u32_e64 v16, s[2:3], 0, v5, s[2:3]
; GFX8-NEXT:    v_subb_u32_e64 v5, s[0:1], v6, v11, s[0:1]
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v7, v9, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v8, v13, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v14, v10, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v8, v15, v16, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v3, v7, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v12, v8, s[0:1]
...
; GFX8-NEXT:    v_xor_b32_e32 v6, s8, v7
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v9, vcc, s6, v7
...
; GFX9-NEXT:    v_addc_co_u32_e64 v14, s[0:1], 0, v11, s[0:1]
; GFX9-NEXT:    s_add_u32 s0, s18, s8
; GFX9-NEXT:    s_addc_u32 s1, s19, s8
; GFX9-NEXT:    s_add_u32 s2, s2, s10
; GFX9-NEXT:    s_mov_b32 s11, s10
; GFX9-NEXT:    s_addc_u32 s3, s3, s10
; GFX9-NEXT:    s_xor_b64 s[16:17], s[2:3], s[10:11]
; GFX9-NEXT:    v_cvt_f32_u32_e32 v1, s17
; GFX9-NEXT:    v_cvt_f32_u32_e32 v15, s16
; GFX9-NEXT:    v_subb_co_u32_e32 v0, vcc, v0, v4, vcc
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v1
; GFX9-NEXT:    v_add_f32_e32 v1, v1, v15
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; GFX9-NEXT:    v_subrev_co_u32_e32 v4, vcc, s6, v9
...
; GFX9-NEXT:    s_subb_u32 s18, 0, s17
; GFX9-NEXT:    v_cndmask_b32_e32 v11, v11, v14, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s18, v17, v[1:2]
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v9, v4, vcc
; GFX9-NEXT:    v_mul_lo_u32 v2, v13, v0
; GFX9-NEXT:    v_mul_lo_u32 v4, v17, v1
...
; GFX9-NEXT:    v_mul_hi_u32 v4, v17, v1
...
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v17, v0
; GFX9-NEXT:    v_addc_co_u32_e32 v10, vcc, v13, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s5, v4, 0
...
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s5, v10, v[0:1]
; GFX9-NEXT:    v_xor_b32_e32 v5, s20, v5
; GFX9-NEXT:    v_subrev_co_u32_e32 v0, vcc, s20, v5
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s18, v4, v[2:3]
; GFX9-NEXT:    v_xor_b32_e32 v3, s4, v7
; GFX9-NEXT:    v_mul_lo_u32 v5, v10, v1
; GFX9-NEXT:    v_mul_lo_u32 v7, v4, v2
; GFX9-NEXT:    v_mul_hi_u32 v11, v4, v1
; GFX9-NEXT:    v_mul_hi_u32 v1, v10, v1
; GFX9-NEXT:    v_xor_b32_e32 v6, s4, v6
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v5, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], v5, v11
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v11, v10, v2
; GFX9-NEXT:    v_add_u32_e32 v5, v7, v5
; GFX9-NEXT:    v_mul_hi_u32 v7, v4, v2
; GFX9-NEXT:    v_mul_hi_u32 v2, v10, v2
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v11, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v1, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v1, v5
; GFX9-NEXT:    v_add_u32_e32 v7, v11, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX9-NEXT:    v_add3_u32 v2, v7, v5, v2
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v4, v1
; GFX9-NEXT:    v_addc_co_u32_e64 v2, s[0:1], v10, v2, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v4, s7, v1
; GFX9-NEXT:    v_mul_lo_u32 v5, s6, v2
; GFX9-NEXT:    v_mul_hi_u32 v10, s6, v1
; GFX9-NEXT:    v_mul_hi_u32 v1, s7, v1
; GFX9-NEXT:    v_mul_hi_u32 v13, s7, v2
; GFX9-NEXT:    v_add_co_u32_e64 v4, s[0:1], v4, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v4, s[0:1], v4, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v10, s7, v2
; GFX9-NEXT:    v_add_u32_e32 v4, v5, v4
; GFX9-NEXT:    v_mul_hi_u32 v5, s6, v2
; GFX9-NEXT:    v_mov_b32_e32 v7, s4
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v10, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[0:1], v1, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v11, s[0:1], v1, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s16, v11, 0
; GFX9-NEXT:    v_subrev_co_u32_e64 v4, s[0:1], s4, v3
; GFX9-NEXT:    v_add_u32_e32 v3, v10, v5
; GFX9-NEXT:    v_add3_u32 v10, v3, v12, v13
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s16, v10, v[2:3]
; GFX9-NEXT:    v_mov_b32_e32 v5, s17
; GFX9-NEXT:    v_mov_b32_e32 v12, s7
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s17, v11, v[2:3]
; GFX9-NEXT:    v_sub_co_u32_e64 v3, s[2:3], s6, v1
; GFX9-NEXT:    v_sub_u32_e32 v1, s7, v2
; GFX9-NEXT:    v_subb_co_u32_e64 v12, s[4:5], v12, v2, s[2:3]
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[2:3], v1, v5, s[2:3]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[4:5], s17, v12
; GFX9-NEXT:    v_subrev_co_u32_e64 v14, s[2:3], s16, v3
; GFX9-NEXT:    v_xor_b32_e32 v8, s21, v8
; GFX9-NEXT:    v_mov_b32_e32 v9, s21
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[4:5]
; GFX9-NEXT:    v_subbrev_co_u32_e64 v15, s[4:5], 0, v13, s[2:3]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[4:5], s17, v15
; GFX9-NEXT:    v_cmp_le_u32_e64 s[6:7], s16, v3
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v8, v9, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s[4:5]
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, s17, v12
; GFX9-NEXT:    v_cmp_le_u32_e64 s[4:5], s16, v14
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v16, vcc
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, s17, v15
; GFX9-NEXT:    v_add_co_u32_e64 v9, s[4:5], 1, v11
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v17, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v16, vcc, 0, v10, s[4:5]
; GFX9-NEXT:    v_subb_co_u32_e64 v5, vcc, v13, v5, s[2:3]
; GFX9-NEXT:    v_add_co_u32_e32 v13, vcc, 1, v9
; GFX9-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v16, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v9, v13, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v16, v17, vcc
; GFX9-NEXT:    v_subrev_co_u32_e64 v16, s[2:3], s16, v14
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], 0, v2
; GFX9-NEXT:    v_subbrev_co_u32_e64 v2, s[2:3], 0, v5, s[2:3]
; GFX9-NEXT:    v_subb_co_u32_e64 v5, s[0:1], v6, v7, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v11, v8, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v15, v2, vcc
; GFX9-NEXT:    s_xor_b64 s[0:1], s[8:9], s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v10, v13, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v14, v16, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v12, v2, s[4:5]
; GFX9-NEXT:    v_xor_b32_e32 v2, s0, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v3, v8, s[4:5]
...
; GFX9-NEXT:    v_xor_b32_e32 v6, s8, v8
; GFX9-NEXT:    v_mov_b32_e32 v9, 0
; GFX9-NEXT:    v_xor_b32_e32 v7, s8, v10
; GFX9-NEXT:    v_mov_b32_e32 v8, s8
; GFX9-NEXT:    v_subrev_co_u32_e32 v6, vcc, s8, v6
; GFX9-NEXT:    v_subb_co_u32_e32 v7, vcc, v7, v8, vcc
; GFX9-NEXT:    global_store_dwordx4 v9, v[0:3], s[12:13]
; GFX9-NEXT:    global_store_dwordx4 v9, v[4:7], s[14:15]
; GFX9-NEXT:    s_endpgm
;
