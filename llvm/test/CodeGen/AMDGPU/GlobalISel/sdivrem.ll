...
; GFX10-NEXT:    s_add_u32 s22, s14, s12
; GFX10-NEXT:    s_addc_u32 s23, s15, s12
...
; GFX10-NEXT:    s_mov_b32 s13, s12
; GFX10-NEXT:    s_xor_b64 s[14:15], s[2:3], s[16:17]
; GFX10-NEXT:    v_add_f32_e32 v0, v1, v0
; GFX10-NEXT:    v_cvt_f32_u32_e32 v1, s15
; GFX10-NEXT:    v_cvt_f32_u32_e32 v2, s14
; GFX10-NEXT:    v_readfirstlane_b32 s2, v0
; GFX10-NEXT:    v_mul_f32_e32 v0, 0x4f800000, v1
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v1, s2
; GFX10-NEXT:    v_add_f32_e32 v0, v0, v2
; GFX10-NEXT:    v_readfirstlane_b32 s2, v0
; GFX10-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v1
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v1, s2
...
; GFX10-NEXT:    v_readfirstlane_b32 s2, v0
; GFX10-NEXT:    v_mul_f32_e32 v0, 0xcf800000, v6
; GFX10-NEXT:    v_cvt_u32_f32_e32 v7, s2
; GFX10-NEXT:    v_add_f32_e32 v3, v0, v1
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s2, s21, v7, 0
; GFX10-NEXT:    v_readfirstlane_b32 s5, v3
; GFX10-NEXT:    s_xor_b64 s[2:3], s[22:23], s[12:13]
; GFX10-NEXT:    v_cvt_u32_f32_e32 v8, s5
; GFX10-NEXT:    s_sub_u32 s5, 0, s14
...
; GFX10-NEXT:    v_mul_lo_u32 v0, s3, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v3, s5, v12, v3
; GFX10-NEXT:    v_mul_lo_u32 v12, s2, v8
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v6, s5, v6, v7
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s5
; GFX10-NEXT:    v_mul_hi_u32 v5, s1, v1
; GFX10-NEXT:    v_mul_hi_u32 v1, s2, v2
; GFX10-NEXT:    v_add_co_u32 v3, s5, v3, v4
; GFX10-NEXT:    v_mul_hi_u32 v2, s3, v2
; GFX10-NEXT:    v_mul_lo_u32 v7, s3, v8
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v0, s5, v0, v12
; GFX10-NEXT:    v_add_nc_u32_e32 v6, v9, v6
; GFX10-NEXT:    v_mul_hi_u32 v13, s2, v8
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v0, s20, v0, v1
; GFX10-NEXT:    v_add_co_u32 v6, s5, v3, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s20
; GFX10-NEXT:    v_add_co_u32 v2, s20, v7, v2
; GFX10-NEXT:    v_add_nc_u32_e32 v4, v11, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s5
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s6, v6, 0
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v9, v3
; GFX10-NEXT:    v_add_co_u32 v2, s5, v2, v13
; GFX10-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s20
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_add3_u32 v11, v4, v11, v5
; GFX10-NEXT:    v_add_co_u32 v12, s5, v2, v3
; GFX10-NEXT:    v_mul_hi_u32 v8, s3, v8
; GFX10-NEXT:    v_add_nc_u32_e32 v7, v7, v9
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s5, s14, v12, 0
; GFX10-NEXT:    v_add3_u32 v7, v7, v9, v8
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s5, s6, v11, v[1:2]
; GFX10-NEXT:    v_add_co_u32 v5, vcc_lo, v6, 1
; GFX10-NEXT:    v_add_co_ci_u32_e32 v13, vcc_lo, 0, v11, vcc_lo
; GFX10-NEXT:    v_mov_b32_e32 v1, v3
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s5, s7, v6, v[4:5]
; GFX10-NEXT:    v_add_co_u32 v4, vcc_lo, v5, 1
; GFX10-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, 0, v13, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v9, vcc_lo, s0, v0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s0, s14, v7, v[1:2]
; GFX10-NEXT:    v_sub_nc_u32_e32 v1, s1, v3
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v3, s0, s1, v3, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s6, v9
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v15, vcc_lo, s7, v1, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s0
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s0, s15, v12, v[0:1]
; GFX10-NEXT:    v_sub_co_u32 v1, vcc_lo, v9, s6
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v16, s0, 0, v15, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s7, v3
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v15, vcc_lo, s7, v15, vcc_lo
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s7, v16
; GFX10-NEXT:    v_cndmask_b32_e64 v17, 0, -1, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s6, v1
; GFX10-NEXT:    v_cndmask_b32_e64 v18, 0, -1, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s7, v16
; GFX10-NEXT:    v_cndmask_b32_e64 v19, 0, -1, s0
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, s7, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v14, v17, v14, s0
; GFX10-NEXT:    v_cndmask_b32_e32 v17, v19, v18, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v2, vcc_lo, s2, v2
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v18, s0, s3, v0, vcc_lo
; GFX10-NEXT:    v_cmp_ne_u32_e64 s0, 0, v17
; GFX10-NEXT:    v_sub_co_u32 v17, s1, v1, s6
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v15, s1, 0, v15, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v5, v4, s0
; GFX10-NEXT:    v_cmp_ne_u32_e64 s1, 0, v14
; GFX10-NEXT:    v_sub_nc_u32_e32 v0, s3, v0
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v13, v8, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s2, s15, v18
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v6, v4, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v16, v15, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v5, v11, v5, s1
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v11, vcc_lo, s15, v0, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, s14, v2
; GFX10-NEXT:    v_xor_b32_e32 v0, s18, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v9, v9, v1, s1
; GFX10-NEXT:    v_xor_b32_e32 v1, s19, v5
; GFX10-NEXT:    v_cndmask_b32_e64 v3, v3, v6, s1
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, -1, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v5, vcc_lo, v2, s14
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v6, s0, 0, v11, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v0, s0, v0, s18
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v1, s0, s19, v1, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s2
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, s15, v18
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v11, vcc_lo, s15, v11, vcc_lo
; GFX10-NEXT:    v_xor_b32_e32 v9, s4, v9
; GFX10-NEXT:    v_xor_b32_e32 v3, s4, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v4, v8, v4, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s15, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s0
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s14, v5
; GFX10-NEXT:    v_cndmask_b32_e64 v13, 0, -1, s0
; GFX10-NEXT:    v_add_co_u32 v14, s0, v12, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v15, s0, 0, v7, s0
; GFX10-NEXT:    v_cmp_eq_u32_e64 s0, s15, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v8, v13, s0
...
; GFX10-NEXT:    v_sub_co_u32 v8, s0, v5, s14
...
; GFX10-NEXT:    v_cndmask_b32_e32 v4, v5, v8, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v5, v6, v11, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v12, v13, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v7, v14, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v2, v4, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v8, v18, v5, s0
; GFX10-NEXT:    s_xor_b64 s[0:1], s[12:13], s[16:17]
; GFX10-NEXT:    v_sub_co_u32 v4, vcc_lo, v9, s4
