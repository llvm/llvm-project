...
; GFX9-NEXT:    s_add_i32 s0, s8, s12
; GFX9-NEXT:    s_xor_b32 s8, s0, s12
...
; GFX9-NEXT:    s_sub_i32 s15, 0, s8
; GFX9-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x0
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_ashr_i32 s14, s4, 31
; GFX9-NEXT:    v_mul_lo_u32 v2, s15, v0
; GFX9-NEXT:    v_mul_f32_e32 v1, 0x4f7ffffe, v1
; GFX9-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX9-NEXT:    s_add_i32 s4, s4, s14
; GFX9-NEXT:    v_mul_hi_u32 v2, v0, v2
; GFX9-NEXT:    s_xor_b32 s4, s4, s14
; GFX9-NEXT:    s_sub_i32 s15, 0, s9
; GFX9-NEXT:    v_mul_lo_u32 v3, s15, v1
; GFX9-NEXT:    v_add_u32_e32 v0, v0, v2
; GFX9-NEXT:    v_mul_hi_u32 v0, s4, v0
; GFX9-NEXT:    s_ashr_i32 s15, s5, 31
; GFX9-NEXT:    v_mul_hi_u32 v2, v1, v3
; GFX9-NEXT:    s_add_i32 s5, s5, s15
...
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v2, s8, v3
; GFX9-NEXT:    v_mul_hi_u32 v1, s5, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v3, v2, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, 1, v0
; GFX9-NEXT:    v_cmp_le_u32_e32 vcc, s8, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v3, s8, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GFX9-NEXT:    v_mul_lo_u32 v3, v1, s9
; GFX9-NEXT:    s_xor_b32 s4, s14, s12
; GFX9-NEXT:    v_xor_b32_e32 v0, s4, v0
; GFX9-NEXT:    v_subrev_u32_e32 v0, s4, v0
...
; GFX9-NEXT:    s_xor_b32 s8, s15, s13
; GFX9-NEXT:    v_xor_b32_e32 v1, s8, v1
; GFX9-NEXT:    v_subrev_u32_e32 v1, s8, v1
; GFX9-NEXT:    s_ashr_i32 s8, s11, 31
; GFX9-NEXT:    s_add_i32 s10, s11, s8
...
; GFX10-NEXT:    s_xor_b32 s16, s0, s4
; GFX10-NEXT:    s_xor_b32 s17, s1, s5
; GFX10-NEXT:    s_xor_b32 s18, s2, s6
; GFX10-NEXT:    v_cvt_f32_u32_e32 v0, s16
; GFX10-NEXT:    s_xor_b32 s3, s3, s7
; GFX10-NEXT:    v_cvt_f32_u32_e32 v1, s17
; GFX10-NEXT:    v_cvt_f32_u32_e32 v2, s18
; GFX10-NEXT:    v_cvt_f32_u32_e32 v3, s3
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX10-NEXT:    s_sub_i32 s0, 0, s16
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v1, v1
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; GFX10-NEXT:    v_rcp_iflag_f32_e32 v3, v3
; GFX10-NEXT:    s_sub_i32 s1, 0, s17
; GFX10-NEXT:    s_sub_i32 s2, 0, s18
; GFX10-NEXT:    s_ashr_i32 s19, s12, 31
; GFX10-NEXT:    s_ashr_i32 s20, s13, 31
; GFX10-NEXT:    s_ashr_i32 s21, s14, 31
; GFX10-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX10-NEXT:    s_ashr_i32 s22, s15, 31
; GFX10-NEXT:    v_mul_f32_e32 v1, 0x4f7ffffe, v1
; GFX10-NEXT:    v_mul_f32_e32 v2, 0x4f7ffffe, v2
; GFX10-NEXT:    v_mul_f32_e32 v3, 0x4f7ffffe, v3
; GFX10-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX10-NEXT:    s_xor_b32 s4, s19, s4
; GFX10-NEXT:    v_cvt_u32_f32_e32 v1, v1
...
; GFX10-NEXT:    v_mul_hi_u32 v3, s12, v3
; GFX10-NEXT:    s_xor_b32 s6, s21, s6
; GFX10-NEXT:    v_mul_lo_u32 v4, v0, s16
...
; GFX10-NEXT:    v_sub_nc_u32_e32 v7, s12, v7
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, s16, v4
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s17, v5
; GFX10-NEXT:    v_cmp_le_u32_e64 s1, s18, v6
; GFX10-NEXT:    v_cmp_le_u32_e64 s2, s3, v7
; GFX10-NEXT:    v_cndmask_b32_e32 v0, v0, v8, vcc_lo
; GFX10-NEXT:    v_subrev_nc_u32_e32 v8, s16, v4
; GFX10-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s0
; GFX10-NEXT:    v_subrev_nc_u32_e32 v9, s17, v5
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v2, v10, s1
; GFX10-NEXT:    v_subrev_nc_u32_e32 v10, s18, v6
...
; GFX10-NEXT:    v_subrev_nc_u32_e32 v4, s19, v4
