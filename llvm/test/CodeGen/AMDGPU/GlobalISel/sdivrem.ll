...
; GFX8-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX8-NEXT:    ; implicit-def: $vgpr2
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s14, v5, 0
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s14, v6, v[1:2]
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s15, v5, v[3:4]
; GFX8-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX8-NEXT:    v_mul_hi_u32 v3, v5, v0
; GFX8-NEXT:    v_mul_lo_u32 v4, v5, v1
; GFX8-NEXT:    v_mul_hi_u32 v0, v6, v0
; GFX8-NEXT:    v_mul_lo_u32 v7, v6, v1
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s15, v5, v[3:4]
; GFX8-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX8-NEXT:    v_mul_hi_u32 v4, v5, v0
...
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v4, v6, v1
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v3, v2
; GFX8-NEXT:    v_mul_hi_u32 v3, v5, v1
...
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s8, v5, 0
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v3, v2
; GFX8-NEXT:    ; implicit-def: $vgpr2
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s8, v6, v[1:2]
; GFX8-NEXT:    v_sub_u32_e32 v0, vcc, s10, v0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s9, v5, v[3:4]
; GFX8-NEXT:    v_subb_u32_e64 v2, s[0:1], v8, v1, vcc
...
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s8, v0
; GFX8-NEXT:    v_subbrev_u32_e64 v8, s[0:1], 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e64 v9, s[0:1], 1, v5
; GFX8-NEXT:    v_addc_u32_e64 v10, s[0:1], 0, v6, s[0:1]
...
; GFX8-NEXT:    v_subrev_u32_e32 v7, vcc, s8, v4
...
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v5, v9, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v6, v10, s[0:1]
...
; GFX8-NEXT:    v_xor_b32_e32 v3, s2, v4
...
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s10, v6, v[1:2]
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s11, v5, v[3:4]
; GFX9-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX9-NEXT:    v_mul_hi_u32 v3, v5, v0
; GFX9-NEXT:    v_mul_lo_u32 v4, v5, v1
; GFX9-NEXT:    v_mul_hi_u32 v0, v6, v0
; GFX9-NEXT:    v_mul_lo_u32 v7, v6, v1
; GFX9-NEXT:    v_mul_hi_u32 v8, v5, v1
...
; GFX9-NEXT:    v_mul_hi_u32 v1, v6, v1
; GFX9-NEXT:    v_add_u32_e32 v2, v4, v2
...
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v6, v1, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s10, v5, 0
; GFX9-NEXT:    ; implicit-def: $vgpr2
...
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s11, v5, v[3:4]
; GFX9-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX9-NEXT:    v_mul_hi_u32 v4, v5, v0
; GFX9-NEXT:    v_mul_lo_u32 v3, v5, v1
; GFX9-NEXT:    v_mul_hi_u32 v0, v6, v0
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v4
...
; GFX9-NEXT:    v_mul_hi_u32 v3, v5, v1
; GFX9-NEXT:    v_mul_hi_u32 v1, v6, v1
...
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, v6, v1, vcc
...
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX9-NEXT:    v_add3_u32 v7, v3, v2, v7
; GFX9-NEXT:    ; implicit-def: $vgpr2
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s6, v7, v[1:2]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s8, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s7, v6, v[3:4]
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[0:1], v9, v1, vcc
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v5, vcc, s6, v4
...
; GFX8-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX8-NEXT:    ; implicit-def: $vgpr2
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s16, v5, 0
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s16, v6, v[1:2]
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s17, v5, v[3:4]
; GFX8-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX8-NEXT:    v_mul_hi_u32 v3, v5, v0
; GFX8-NEXT:    v_mul_lo_u32 v4, v5, v1
; GFX8-NEXT:    v_mul_hi_u32 v0, v6, v0
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s9, v5, v[3:4]
; GFX8-NEXT:    v_subb_u32_e64 v8, s[0:1], v8, v1, vcc
...
; GFX8-NEXT:    v_addc_u32_e64 v13, s[0:1], 0, v4, s[0:1]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v2, v7, vcc
; GFX8-NEXT:    ; implicit-def: $vgpr2
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[18:19], s5, v12, v[1:2]
; GFX8-NEXT:    s_subb_u32 s20, 0, s3
; GFX8-NEXT:    v_cndmask_b32_e32 v10, v10, v14, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[18:19], s20, v11, v[3:4]
; GFX8-NEXT:    v_mul_lo_u32 v2, v12, v0
; GFX8-NEXT:    v_mul_hi_u32 v4, v11, v0
; GFX8-NEXT:    v_mul_lo_u32 v3, v11, v1
; GFX8-NEXT:    v_mul_hi_u32 v0, v12, v0
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v8, v10, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v9, v7, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v4, v12, v1
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v3, v2
; GFX8-NEXT:    v_mul_hi_u32 v3, v11, v1
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v4, v0
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v3
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, v4, v3
; GFX8-NEXT:    v_mul_hi_u32 v1, v12, v1
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v3, v2
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v2
...
; GFX8-NEXT:    v_xor_b32_e32 v9, s16, v5
; GFX8-NEXT:    v_xor_b32_e32 v1, s17, v6
; GFX8-NEXT:    ; implicit-def: $vgpr4
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s5, v11, v[3:4]
; GFX8-NEXT:    v_subrev_u32_e32 v0, vcc, s16, v9
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s20, v10, v[5:6]
; GFX8-NEXT:    v_xor_b32_e32 v4, s4, v7
; GFX8-NEXT:    v_mul_lo_u32 v6, v11, v2
; GFX8-NEXT:    v_mul_lo_u32 v7, v10, v3
; GFX8-NEXT:    v_mul_hi_u32 v9, v10, v2
; GFX8-NEXT:    v_mov_b32_e32 v12, s17
; GFX8-NEXT:    v_subb_u32_e32 v1, vcc, v1, v12, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v9, v11, v3
; GFX8-NEXT:    v_mul_hi_u32 v2, v11, v2
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v7, v6
; GFX8-NEXT:    v_mul_hi_u32 v7, v10, v3
...
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v2, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_mul_hi_u32 v3, s11, v3
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v7, v2
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s2, v9, 0
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v3, v2
; GFX8-NEXT:    ; implicit-def: $vgpr8
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s2, v10, v[7:8]
; GFX8-NEXT:    v_mov_b32_e32 v12, s11
; GFX8-NEXT:    v_mov_b32_e32 v11, s3
; GFX8-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s3, v9, v[2:3]
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s10, v6
; GFX8-NEXT:    v_subb_u32_e64 v3, s[0:1], v12, v7, vcc
; GFX8-NEXT:    v_sub_u32_e64 v6, s[0:1], s11, v7
...
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s3, v3
; GFX8-NEXT:    v_subb_u32_e32 v6, vcc, v6, v11, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v8, s[0:1]
; GFX8-NEXT:    v_subrev_u32_e32 v8, vcc, s2, v2
...
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s2, v8
...
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, 1, v14
; GFX8-NEXT:    v_addc_u32_e32 v16, vcc, 0, v15, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX8-NEXT:    v_subrev_u32_e64 v13, s[0:1], s2, v8
...
; GFX8-NEXT:    v_cndmask_b32_e32 v8, v8, v13, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v12, v6, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v9, v11, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v10, v14, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v8, v2, v8, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v3, v6, s[0:1]
...
; GFX8-NEXT:    v_xor_b32_e32 v7, s6, v8
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX9-NEXT:    ; implicit-def: $vgpr2
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s16, v5, 0
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s16, v6, v[1:2]
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s17, v5, v[3:4]
; GFX9-NEXT:    v_mul_lo_u32 v2, v6, v0
; GFX9-NEXT:    v_mul_hi_u32 v3, v5, v0
; GFX9-NEXT:    v_mul_lo_u32 v4, v5, v1
; GFX9-NEXT:    v_mul_hi_u32 v0, v6, v0
...
; GFX9-NEXT:    ; implicit-def: $vgpr2
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s8, v6, v[1:2]
; GFX9-NEXT:    v_sub_co_u32_e32 v9, vcc, s10, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s9, v5, v[3:4]
; GFX9-NEXT:    v_subb_co_u32_e64 v8, s[0:1], v8, v1, vcc
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v2, vcc, s8, v9
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v7, vcc, s8, v2
...
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v5, v3, s[0:1]
...
; GFX9-NEXT:    ; implicit-def: $vgpr2
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[18:19], s5, v12, v[1:2]
; GFX9-NEXT:    s_subb_u32 s20, 0, s3
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v10, v14, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[18:19], s20, v11, v[3:4]
; GFX9-NEXT:    v_mul_lo_u32 v2, v12, v0
; GFX9-NEXT:    v_mul_hi_u32 v4, v11, v0
; GFX9-NEXT:    v_mul_lo_u32 v3, v11, v1
; GFX9-NEXT:    v_mul_hi_u32 v0, v12, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v8, v10, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v9, v7, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v4, v12, v1
; GFX9-NEXT:    v_add_u32_e32 v2, v3, v2
; GFX9-NEXT:    v_mul_hi_u32 v3, v11, v1
...
; GFX9-NEXT:    v_xor_b32_e32 v9, s16, v5
; GFX9-NEXT:    v_xor_b32_e32 v1, s17, v6
; GFX9-NEXT:    ; implicit-def: $vgpr4
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s5, v11, v[3:4]
; GFX9-NEXT:    v_subrev_co_u32_e32 v0, vcc, s16, v9
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s20, v10, v[5:6]
; GFX9-NEXT:    v_xor_b32_e32 v4, s4, v7
; GFX9-NEXT:    v_mul_lo_u32 v6, v11, v2
; GFX9-NEXT:    v_mul_lo_u32 v7, v10, v3
; GFX9-NEXT:    v_mul_hi_u32 v9, v10, v2
; GFX9-NEXT:    v_mov_b32_e32 v12, s17
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v12, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v9, v11, v3
...
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, v2, v6
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s2, v10, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v8, v8, v9
; GFX9-NEXT:    v_add3_u32 v9, v8, v2, v3
; GFX9-NEXT:    ; implicit-def: $vgpr8
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s2, v9, v[7:8]
; GFX9-NEXT:    v_mov_b32_e32 v12, s11
; GFX9-NEXT:    v_mov_b32_e32 v11, s3
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s3, v10, v[2:3]
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, s10, v6
; GFX9-NEXT:    v_subb_co_u32_e64 v3, s[0:1], v12, v7, vcc
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s3, v3
; GFX9-NEXT:    v_sub_u32_e32 v6, s11, v7
...
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, 1, v14
...
; GFX9-NEXT:    v_subrev_co_u32_e64 v15, s[0:1], s2, v8
...
; GFX10-NEXT:    v_mul_f32_e32 v1, 0xcf800000, v2
; GFX10-NEXT:    v_cvt_u32_f32_e32 v8, v2
; GFX10-NEXT:    ; implicit-def: $vgpr2
...
; GFX10-NEXT:    v_add_f32_e32 v4, v4, v3
; GFX10-NEXT:    ; implicit-def: $vgpr3
; GFX10-NEXT:    v_cvt_u32_f32_e32 v9, v4
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s5, s21, v8, v[1:2]
; GFX10-NEXT:    s_sub_u32 s5, 0, s2
; GFX10-NEXT:    ; implicit-def: $vgpr5
; GFX10-NEXT:    s_subb_u32 s22, 0, s3
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s23, s5, v9, 0
; GFX10-NEXT:    v_mul_hi_u32 v11, v8, v0
; GFX10-NEXT:    v_mul_hi_u32 v6, v7, v0
; GFX10-NEXT:    v_mad_u64_u32 v[4:5], s23, s20, v7, v[4:5]
; GFX10-NEXT:    v_mul_lo_u32 v5, v8, v0
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s23, s5, v10, v[2:3]
; GFX10-NEXT:    v_mul_lo_u32 v12, v10, v1
; GFX10-NEXT:    v_mul_hi_u32 v13, v9, v1
; GFX10-NEXT:    v_mul_lo_u32 v14, v7, v4
; GFX10-NEXT:    v_mul_lo_u32 v16, v8, v4
; GFX10-NEXT:    v_mul_hi_u32 v15, v10, v1
; GFX10-NEXT:    ; implicit-def: $vgpr3
; GFX10-NEXT:    v_mul_hi_u32 v17, v7, v4
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s23, s22, v9, v[2:3]
; GFX10-NEXT:    v_mul_hi_u32 v1, v8, v4
; GFX10-NEXT:    v_add_co_u32 v2, s23, v5, v14
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v4, s23, v16, v11
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s23
; GFX10-NEXT:    v_mul_lo_u32 v11, v9, v0
; GFX10-NEXT:    v_add_co_u32 v2, s23, v2, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s23
; GFX10-NEXT:    v_mul_lo_u32 v14, v10, v0
; GFX10-NEXT:    v_add_co_u32 v4, s23, v4, v17
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s23
; GFX10-NEXT:    v_mul_hi_u32 v16, v9, v0
; GFX10-NEXT:    v_mul_hi_u32 v17, v10, v0
; GFX10-NEXT:    v_add_nc_u32_e32 v0, v3, v2
; GFX10-NEXT:    v_add_co_u32 v3, s23, v12, v11
; GFX10-NEXT:    v_add_nc_u32_e32 v2, v5, v6
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v6, s23, v14, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v0, s23, v4, v0
; GFX10-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v3, s23, v3, v13
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s23
; GFX10-NEXT:    v_add_co_u32 v7, vcc_lo, v7, v0
; GFX10-NEXT:    v_add3_u32 v1, v2, v4, v1
; GFX10-NEXT:    v_add_co_u32 v6, s23, v6, v16
; GFX10-NEXT:    v_add_nc_u32_e32 v2, v5, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s23
; GFX10-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, v8, v1, vcc_lo
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s23, s21, v7, 0
; GFX10-NEXT:    v_add_co_u32 v4, s23, v6, v2
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v11, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s23
; GFX10-NEXT:    ; implicit-def: $vgpr2
; GFX10-NEXT:    v_add_co_u32 v9, vcc_lo, v9, v4
; GFX10-NEXT:    v_mul_hi_u32 v12, v8, v0
; GFX10-NEXT:    v_add3_u32 v3, v3, v5, v17
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s21, s21, v8, v[1:2]
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s21, s5, v9, 0
; GFX10-NEXT:    ; implicit-def: $vgpr6
; GFX10-NEXT:    v_add_co_ci_u32_e32 v10, vcc_lo, v10, v3, vcc_lo
; GFX10-NEXT:    ; implicit-def: $vgpr3
; GFX10-NEXT:    v_mul_hi_u32 v11, v7, v0
; GFX10-NEXT:    ; implicit-def: $vgpr4
; GFX10-NEXT:    v_mad_u64_u32 v[5:6], s20, s20, v7, v[5:6]
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s5, s5, v10, v[2:3]
; GFX10-NEXT:    v_mul_lo_u32 v6, v8, v0
; GFX10-NEXT:    v_mul_lo_u32 v13, v10, v1
; GFX10-NEXT:    v_mul_hi_u32 v14, v9, v1
; GFX10-NEXT:    v_mul_hi_u32 v16, v10, v1
; GFX10-NEXT:    v_mul_lo_u32 v15, v7, v5
; GFX10-NEXT:    v_mul_lo_u32 v17, v8, v5
; GFX10-NEXT:    ; implicit-def: $vgpr3
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s22, v9, v[2:3]
; GFX10-NEXT:    v_mul_hi_u32 v18, v7, v5
; GFX10-NEXT:    v_mul_hi_u32 v1, v8, v5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v6, v15
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v5, s5, v17, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v2, v11
; GFX10-NEXT:    v_mul_lo_u32 v12, v9, v0
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v5, s5, v5, v18
...
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v6, v11
; GFX10-NEXT:    v_add_co_u32 v6, s5, v13, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v12, s5, v15, v16
; GFX10-NEXT:    v_cndmask_b32_e64 v13, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v5, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v6, s5, v6, v14
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v12, s5, v12, v17
; GFX10-NEXT:    v_add3_u32 v1, v3, v5, v1
; GFX10-NEXT:    v_cndmask_b32_e64 v14, 0, 1, s5
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v11, v6
; GFX10-NEXT:    v_add_co_u32 v2, vcc_lo, v7, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v8, v1, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v3, s5, v12, v3
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v13, v14
; GFX10-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s5
; GFX10-NEXT:    v_mul_lo_u32 v6, s1, v2
; GFX10-NEXT:    v_mul_lo_u32 v11, s0, v1
; GFX10-NEXT:    v_mul_hi_u32 v8, s0, v2
; GFX10-NEXT:    v_mul_hi_u32 v2, s1, v2
; GFX10-NEXT:    v_mul_lo_u32 v12, s1, v1
; GFX10-NEXT:    v_add3_u32 v0, v5, v7, v0
; GFX10-NEXT:    v_add_co_u32 v3, vcc_lo, v9, v3
; GFX10-NEXT:    v_mul_hi_u32 v5, s0, v1
; GFX10-NEXT:    v_mul_hi_u32 v1, s1, v1
; GFX10-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, v10, v0, vcc_lo
; GFX10-NEXT:    v_mul_lo_u32 v0, s19, v3
; GFX10-NEXT:    v_mul_hi_u32 v9, s18, v3
; GFX10-NEXT:    v_mul_hi_u32 v10, s19, v3
; GFX10-NEXT:    v_add_co_u32 v3, s5, v6, v11
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v12, v2
; GFX10-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v3, s5, v3, v8
; GFX10-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v2, s5, v2, v5
; GFX10-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s5
; GFX10-NEXT:    v_mul_lo_u32 v8, s18, v7
; GFX10-NEXT:    v_add_nc_u32_e32 v3, v6, v3
; GFX10-NEXT:    v_mul_lo_u32 v6, s19, v7
; GFX10-NEXT:    v_mul_hi_u32 v12, s18, v7
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v11, v5
; GFX10-NEXT:    v_add_co_u32 v11, s5, v2, v3
; GFX10-NEXT:    v_cndmask_b32_e64 v13, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v0, s20, v0, v8
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s5, s6, v11, 0
; GFX10-NEXT:    v_add3_u32 v5, v5, v13, v1
; GFX10-NEXT:    v_add_co_u32 v6, s5, v6, v10
; GFX10-NEXT:    v_cndmask_b32_e64 v10, 0, 1, s5
; GFX10-NEXT:    v_add_co_u32 v0, s5, v0, v9
; GFX10-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s5
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s6, v5, v[3:4]
; GFX10-NEXT:    v_add_co_u32 v3, s5, v6, v12
; GFX10-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s5
; GFX10-NEXT:    v_mul_hi_u32 v4, s19, v7
; GFX10-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s20
; GFX10-NEXT:    v_mov_b32_e32 v12, 0
; GFX10-NEXT:    v_add_nc_u32_e32 v7, v10, v1
; GFX10-NEXT:    ; implicit-def: $vgpr1
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s5, s7, v11, v[0:1]
; GFX10-NEXT:    v_add_nc_u32_e32 v6, v8, v9
; GFX10-NEXT:    v_add_co_u32 v8, vcc_lo, v11, 1
; GFX10-NEXT:    v_add_co_ci_u32_e32 v9, vcc_lo, 0, v5, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v10, vcc_lo, s0, v2
; GFX10-NEXT:    v_sub_nc_u32_e32 v1, s1, v0
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v13, s0, s1, v0, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v3, s5, v3, v6
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v2, vcc_lo, s7, v1, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, s6, v10
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s5
; GFX10-NEXT:    v_cndmask_b32_e64 v14, 0, -1, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v15, vcc_lo, v10, s6
; GFX10-NEXT:    v_subrev_co_ci_u32_e64 v16, s0, 0, v2, vcc_lo
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s7, v13
; GFX10-NEXT:    v_add3_u32 v4, v7, v6, v4
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc_lo, s7, v2, vcc_lo
; GFX10-NEXT:    ; implicit-def: $vgpr2
...
; GFX10-NEXT:    v_add_co_u32 v18, s0, v8, 1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v19, s0, 0, v9, s0
...
; GFX10-NEXT:    v_cndmask_b32_e32 v7, v8, v18, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v8, v9, v19, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v9, v15, v2, vcc_lo
; GFX10-NEXT:    ; implicit-def: $vgpr2
...
; GFX10-NEXT:    v_cndmask_b32_e64 v2, v11, v7, s0
; GFX10-NEXT:    v_cndmask_b32_e64 v7, v10, v9, s0
; GFX10-NEXT:    v_sub_co_ci_u32_e64 v9, s1, s19, v1, vcc_lo
; GFX10-NEXT:    v_sub_nc_u32_e32 v1, s19, v1
; GFX10-NEXT:    v_cndmask_b32_e64 v6, v13, v6, s0
; GFX10-NEXT:    v_xor_b32_e32 v0, s16, v2
; GFX10-NEXT:    v_cmp_le_u32_e64 s0, s3, v9
; GFX10-NEXT:    v_xor_b32_e32 v2, s17, v5
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v10, vcc_lo, s3, v1, vcc_lo
...
; GFX10-NEXT:    v_cndmask_b32_e32 v5, v13, v7, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v7, v14, v10, vcc_lo
...
; GFX10-NEXT:    v_xor_b32_e32 v3, s1, v10
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v5, vcc_lo, s4, v6, vcc_lo
; GFX10-NEXT:    v_xor_b32_e32 v6, s8, v8
; GFX10-NEXT:    v_xor_b32_e32 v7, s8, v7
; GFX10-NEXT:    v_sub_co_u32 v2, vcc_lo, v2, s0
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v3, vcc_lo, s1, v3, vcc_lo
; GFX10-NEXT:    v_sub_co_u32 v6, vcc_lo, v6, s8
; GFX10-NEXT:    v_subrev_co_ci_u32_e32 v7, vcc_lo, s8, v7, vcc_lo
