...
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, 4, v0
...
; GFX8-NEXT:    v_add_u32_e32 v22, vcc, 8, v0
...
; GFX8-NEXT:    flat_load_ushort v16, v[22:23]
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v16, vcc, 16, v0
...
; GFX8-NEXT:    flat_load_ushort v0, v[18:19]
; GFX8-NEXT:    s_waitcnt vmcnt(2)
...
; GFX8-NEXT:    v_add_u32_e32 v18, vcc, 16, v2
; GFX8-NEXT:    v_addc_u32_e32 v19, vcc, 0, v3, vcc
; GFX8-NEXT:    flat_load_dword v14, v[16:17]
; GFX8-NEXT:    flat_load_dword v15, v[18:19]
; GFX8-NEXT:    s_waitcnt vmcnt(2)
...
; GFX8-NEXT:    v_addc_u32_e32 v17, vcc, 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v22, vcc, 20, v2
...
; GFX8-NEXT:    v_addc_u32_e32 v17, vcc, 0, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v18, vcc, 16, v0
; GFX8-NEXT:    v_addc_u32_e32 v19, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[14:15], v[16:17]
; GFX8-NEXT:    s_waitcnt vmcnt(1)
