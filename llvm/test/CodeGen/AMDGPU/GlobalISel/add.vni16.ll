...
; GFX8-NEXT:    v_addc_u32_e64 v7, vcc, 0, v3, s[4:5]
; GFX8-NEXT:    v_addc_u32_e64 v9, vcc, 0, v3, s[6:7]
; GFX8-NEXT:    v_addc_u32_e64 v11, vcc, 0, v3, s[8:9]
; GFX8-NEXT:    flat_load_ushort v3, v[6:7]
; GFX8-NEXT:    flat_load_ushort v6, v[8:9]
; GFX8-NEXT:    flat_load_ushort v7, v[10:11]
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, 2, v4
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v5, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(6)
; GFX8-NEXT:    v_add_u16_e32 v8, v20, v14
; GFX8-NEXT:    s_waitcnt vmcnt(5)
; GFX8-NEXT:    v_add_u16_e32 v9, v22, v15
; GFX8-NEXT:    s_waitcnt vmcnt(4)
; GFX8-NEXT:    v_add_u16_e32 v2, v21, v2
...
; GFX8-NEXT:    v_add_u32_e64 v0, s[4:5], 16, v0
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; GFX8-NEXT:    v_addc_u32_e64 v1, s[4:5], 0, v1, s[4:5]
; GFX8-NEXT:    flat_load_ushort v2, v[2:3]
...
; GFX8-NEXT:    v_or_b32_e32 v6, v3, v6
; GFX8-NEXT:    v_add_u16_e32 v3, v8, v12
; GFX8-NEXT:    v_add_u16_sdwa v1, v8, v12 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_or_b32_e32 v7, v10, v7
; GFX8-NEXT:    v_or_b32_e32 v8, v3, v1
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u16_e32 v0, v0, v2
; GFX8-NEXT:    v_add_u16_e32 v2, v9, v13
; GFX8-NEXT:    v_add_u16_sdwa v9, v9, v13 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_or_b32_e32 v9, v2, v9
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[6:9]
; GFX8-NEXT:    flat_store_short v[14:15], v0
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    flat_load_dwordx4 v[6:9], v[0:1]
; GFX8-NEXT:    flat_load_dwordx4 v[10:13], v[2:3]
; GFX8-NEXT:    v_add_u32_e64 v15, s[4:5], 18, v2
; GFX8-NEXT:    v_add_u32_e64 v18, s[8:9], 16, v2
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, 18, v0
; GFX8-NEXT:    v_add_u32_e64 v17, s[6:7], 20, v2
; GFX8-NEXT:    v_addc_u32_e64 v19, s[8:9], 0, v3, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v16, s[4:5], 0, v3, s[4:5]
; GFX8-NEXT:    flat_load_ushort v20, v[18:19]
; GFX8-NEXT:    v_addc_u32_e64 v18, s[4:5], 0, v3, s[6:7]
; GFX8-NEXT:    flat_load_ushort v3, v[15:16]
; GFX8-NEXT:    flat_load_ushort v21, v[17:18]
; GFX8-NEXT:    v_addc_u32_e32 v15, vcc, 0, v1, vcc
; GFX8-NEXT:    v_add_u32_e64 v16, s[4:5], 16, v0
; GFX8-NEXT:    v_add_u32_e32 v18, vcc, 20, v0
; GFX8-NEXT:    v_addc_u32_e64 v17, s[4:5], 0, v1, s[4:5]
; GFX8-NEXT:    v_addc_u32_e32 v19, vcc, 0, v1, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u16_e32 v2, v6, v10
; GFX8-NEXT:    v_add_u16_sdwa v6, v6, v10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_add_u16_e32 v1, v7, v11
; GFX8-NEXT:    v_add_u16_sdwa v7, v7, v11 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_or_b32_e32 v0, v2, v6
; GFX8-NEXT:    v_or_b32_e32 v1, v1, v7
; GFX8-NEXT:    v_add_u16_e32 v2, v8, v12
; GFX8-NEXT:    v_add_u16_sdwa v6, v8, v12 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    flat_load_ushort v7, v[16:17]
; GFX8-NEXT:    flat_load_ushort v8, v[14:15]
; GFX8-NEXT:    flat_load_ushort v11, v[18:19]
; GFX8-NEXT:    v_or_b32_e32 v2, v2, v6
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 16, v4
; GFX8-NEXT:    v_add_u32_e64 v10, s[4:5], 18, v4
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u16_e32 v12, v7, v20
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u16_e32 v8, v8, v3
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u16_e32 v16, v11, v21
; GFX8-NEXT:    v_addc_u32_e32 v7, vcc, 0, v5, vcc
; GFX8-NEXT:    v_addc_u32_e64 v11, vcc, 0, v5, s[4:5]
; GFX8-NEXT:    v_add_u16_e32 v3, v9, v13
; GFX8-NEXT:    v_add_u16_sdwa v9, v9, v13 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, 20, v4
; GFX8-NEXT:    v_or_b32_e32 v3, v3, v9
; GFX8-NEXT:    v_addc_u32_e32 v15, vcc, 0, v5, vcc
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    flat_store_short v[6:7], v12
; GFX8-NEXT:    flat_store_short v[10:11], v8
; GFX8-NEXT:    flat_store_short v[14:15], v16
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u16_e32 v16, v6, v10
; GFX8-NEXT:    v_add_u16_sdwa v6, v6, v10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_add_u16_e32 v10, v7, v11
; GFX8-NEXT:    v_add_u16_sdwa v7, v7, v11 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_or_b32_e32 v0, v16, v6
