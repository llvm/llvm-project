...
; RUN: llc -global-isel -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX900 %s
; RUN: llc -global-isel -mtriple=amdgpu9.42-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX942 %s
...
; GFX942-NEXT:    v_pk_fma_f32 v[4:5], s[2:3], v[4:5], v[6:7]
