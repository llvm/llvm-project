...
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    v_mul_f32_e32 v5, v2, v4
; VI-NEXT:    v_mad_f32 v6, -v3, v5, v2
; VI-NEXT:    v_mac_f32_e32 v5, v6, v4
; VI-NEXT:    v_mad_f32 v2, -v3, v5, v2
...
; VI-NEXT:    v_div_fixup_f16 v2, v2, s3, v0
; VI-NEXT:    v_trunc_f16_e32 v2, v2
; VI-NEXT:    v_fma_f16 v0, -v2, s3, v0
...
; VI-NEXT:    v_add_f32_e32 v2, v2, v5
; VI-NEXT:    v_cvt_f16_f32_e32 v2, v2
; VI-NEXT:    v_div_fixup_f16 v2, v2, s4, v1
; VI-NEXT:    v_trunc_f16_e32 v2, v2
; VI-NEXT:    v_fma_f16 v1, -v2, s4, v1
...
; CI-NEXT:    v_trunc_f32_e32 v2, v2
; CI-NEXT:    v_fma_f32 v0, -v2, v1, v0
; CI-NEXT:    v_cvt_f32_f16_e32 v1, s9
; CI-NEXT:    v_cvt_f32_f16_e32 v2, s11
; CI-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; CI-NEXT:    v_cvt_f16_f32_e32 v0, v0
...
; CI-NEXT:    v_cvt_f32_f16_e32 v3, s8
...
; VI-NEXT:    v_mul_f32_e32 v7, v4, v6
; VI-NEXT:    v_mad_f32 v8, -v5, v7, v4
; VI-NEXT:    v_mac_f32_e32 v7, v8, v6
; VI-NEXT:    v_mad_f32 v4, -v5, v7, v4
; VI-NEXT:    v_mul_f32_e32 v4, v4, v6
; VI-NEXT:    v_and_b32_e32 v4, 0xff800000, v4
...
; VI-NEXT:    v_div_fixup_f16 v4, v4, v2, s2
; VI-NEXT:    v_trunc_f16_e32 v4, v4
; VI-NEXT:    v_fma_f16 v2, -v4, v2, s2
; VI-NEXT:    v_cvt_f32_f16_e32 v4, s7
; VI-NEXT:    v_rcp_f32_e32 v6, v5
; VI-NEXT:    v_mul_f32_e32 v7, v4, v6
; VI-NEXT:    v_mad_f32 v8, -v5, v7, v4
; VI-NEXT:    v_mac_f32_e32 v7, v8, v6
...
; VI-NEXT:    v_add_f32_e32 v4, v4, v7
; VI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; VI-NEXT:    v_cvt_f32_f16_e32 v5, s5
; VI-NEXT:    v_div_fixup_f16 v4, v4, v3, s7
; VI-NEXT:    v_trunc_f16_e32 v4, v4
; VI-NEXT:    v_fma_f16 v3, -v4, v3, s7
...
; VI-NEXT:    v_add_f32_e32 v4, v4, v7
; VI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; VI-NEXT:    v_cvt_f32_f16_e32 v5, s8
; VI-NEXT:    v_div_fixup_f16 v4, v4, v0, s3
; VI-NEXT:    v_trunc_f16_e32 v4, v4
; VI-NEXT:    v_fma_f16 v4, -v4, v0, s3
; VI-NEXT:    v_cvt_f32_f16_e32 v0, s6
; VI-NEXT:    v_rcp_f32_e32 v6, v5
; VI-NEXT:    v_mul_f32_e32 v7, v0, v6
; VI-NEXT:    v_mad_f32 v8, -v5, v7, v0
; VI-NEXT:    v_mac_f32_e32 v7, v8, v6
; VI-NEXT:    v_mad_f32 v0, -v5, v7, v0
; VI-NEXT:    v_mul_f32_e32 v0, v0, v6
; VI-NEXT:    v_and_b32_e32 v0, 0xff800000, v0
; VI-NEXT:    v_add_f32_e32 v0, v0, v7
; VI-NEXT:    v_cvt_f16_f32_e32 v0, v0
; VI-NEXT:    v_div_fixup_f16 v0, v0, v1, s6
; VI-NEXT:    v_trunc_f16_e32 v0, v0
; VI-NEXT:    v_fma_f16 v1, -v0, v1, s6
