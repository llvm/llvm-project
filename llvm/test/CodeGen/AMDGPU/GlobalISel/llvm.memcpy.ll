...
; LOOP-NEXT:    buffer_load_ubyte v28, v[6:7], s[0:3], 0 addr64
; LOOP-NEXT:    buffer_load_ubyte v35, v[6:7], s[0:3], 0 addr64 offset:1
; LOOP-NEXT:    buffer_load_ubyte v36, v[6:7], s[0:3], 0 addr64 offset:2
; LOOP-NEXT:    buffer_load_ubyte v37, v[6:7], s[0:3], 0 addr64 offset:3
; LOOP-NEXT:    buffer_load_ubyte v38, v[6:7], s[0:3], 0 addr64 offset:4
; LOOP-NEXT:    buffer_load_ubyte v39, v[6:7], s[0:3], 0 addr64 offset:5
; LOOP-NEXT:    buffer_load_ubyte v10, v[6:7], s[0:3], 0 addr64 offset:6
; LOOP-NEXT:    buffer_load_ubyte v12, v[6:7], s[0:3], 0 addr64 offset:7
; LOOP-NEXT:    buffer_load_ubyte v8, v[6:7], s[0:3], 0 addr64 offset:8
; LOOP-NEXT:    s_waitcnt expcnt(3)
; LOOP-NEXT:    buffer_load_ubyte v13, v[6:7], s[0:3], 0 addr64 offset:9
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    buffer_load_ubyte v14, v[6:7], s[0:3], 0 addr64 offset:10
; LOOP-NEXT:    buffer_load_ubyte v15, v[6:7], s[0:3], 0 addr64 offset:11
; LOOP-NEXT:    buffer_load_ubyte v9, v[6:7], s[0:3], 0 addr64 offset:12
; LOOP-NEXT:    buffer_load_ubyte v17, v[6:7], s[0:3], 0 addr64 offset:13
; LOOP-NEXT:    buffer_load_ubyte v18, v[6:7], s[0:3], 0 addr64 offset:14
; LOOP-NEXT:    buffer_load_ubyte v19, v[6:7], s[0:3], 0 addr64 offset:15
; LOOP-NEXT:    buffer_load_ubyte v11, v[6:7], s[0:3], 0 addr64 offset:16
; LOOP-NEXT:    buffer_load_ubyte v21, v[6:7], s[0:3], 0 addr64 offset:17
; LOOP-NEXT:    buffer_load_ubyte v22, v[6:7], s[0:3], 0 addr64 offset:18
; LOOP-NEXT:    buffer_load_ubyte v23, v[6:7], s[0:3], 0 addr64 offset:19
; LOOP-NEXT:    buffer_load_ubyte v16, v[6:7], s[0:3], 0 addr64 offset:20
; LOOP-NEXT:    buffer_load_ubyte v25, v[6:7], s[0:3], 0 addr64 offset:21
; LOOP-NEXT:    buffer_load_ubyte v26, v[6:7], s[0:3], 0 addr64 offset:22
; LOOP-NEXT:    buffer_load_ubyte v27, v[6:7], s[0:3], 0 addr64 offset:23
; LOOP-NEXT:    buffer_load_ubyte v20, v[6:7], s[0:3], 0 addr64 offset:24
; LOOP-NEXT:    buffer_load_ubyte v29, v[6:7], s[0:3], 0 addr64 offset:25
; LOOP-NEXT:    buffer_load_ubyte v30, v[6:7], s[0:3], 0 addr64 offset:26
; LOOP-NEXT:    buffer_load_ubyte v31, v[6:7], s[0:3], 0 addr64 offset:27
; LOOP-NEXT:    buffer_load_ubyte v24, v[6:7], s[0:3], 0 addr64 offset:28
; LOOP-NEXT:    buffer_load_ubyte v32, v[6:7], s[0:3], 0 addr64 offset:29
; LOOP-NEXT:    buffer_load_ubyte v33, v[6:7], s[0:3], 0 addr64 offset:30
; LOOP-NEXT:    buffer_load_ubyte v34, v[6:7], s[0:3], 0 addr64 offset:31
; LOOP-NEXT:    s_waitcnt vmcnt(14)
; LOOP-NEXT:    v_lshlrev_b32_e32 v6, 8, v35
; LOOP-NEXT:    v_or_b32_e32 v28, v6, v28
; LOOP-NEXT:    v_lshlrev_b32_e32 v7, 24, v37
; LOOP-NEXT:    v_lshlrev_b32_e32 v35, 16, v36
; LOOP-NEXT:    v_add_i32_e32 v6, vcc, v0, v4
; LOOP-NEXT:    v_or_b32_e32 v35, v7, v35
; LOOP-NEXT:    v_lshlrev_b32_e32 v7, 8, v39
; LOOP-NEXT:    v_or_b32_e32 v36, v7, v38
...
; LOOP-NEXT:    v_lshlrev_b32_e32 v27, 24, v27
; LOOP-NEXT:    v_lshlrev_b32_e32 v26, 16, v26
; LOOP-NEXT:    s_waitcnt vmcnt(6)
; LOOP-NEXT:    v_lshlrev_b32_e32 v29, 8, v29
; LOOP-NEXT:    s_waitcnt vmcnt(4)
; LOOP-NEXT:    v_lshlrev_b32_e32 v31, 24, v31
; LOOP-NEXT:    v_lshlrev_b32_e32 v30, 16, v30
; LOOP-NEXT:    s_waitcnt vmcnt(2)
; LOOP-NEXT:    v_lshlrev_b32_e32 v32, 8, v32
; LOOP-NEXT:    s_waitcnt vmcnt(0)
; LOOP-NEXT:    v_lshlrev_b32_e32 v34, 24, v34
; LOOP-NEXT:    v_lshlrev_b32_e32 v33, 16, v33
; LOOP-NEXT:    v_or_b32_e32 v10, v12, v10
; LOOP-NEXT:    v_or_b32_e32 v8, v13, v8
; LOOP-NEXT:    v_or_b32_e32 v12, v15, v14
; LOOP-NEXT:    v_or_b32_e32 v9, v17, v9
; LOOP-NEXT:    v_or_b32_e32 v13, v19, v18
; LOOP-NEXT:    v_or_b32_e32 v11, v21, v11
; LOOP-NEXT:    v_or_b32_e32 v14, v23, v22
; LOOP-NEXT:    v_or_b32_e32 v15, v25, v16
; LOOP-NEXT:    v_or_b32_e32 v16, v27, v26
; LOOP-NEXT:    v_or_b32_e32 v17, v29, v20
; LOOP-NEXT:    v_or_b32_e32 v18, v31, v30
; LOOP-NEXT:    v_or_b32_e32 v19, v32, v24
; LOOP-NEXT:    v_or_b32_e32 v20, v34, v33
; LOOP-NEXT:    v_or_b32_e32 v21, v35, v28
; LOOP-NEXT:    v_or_b32_e32 v10, v10, v36
; LOOP-NEXT:    v_or_b32_e32 v8, v12, v8
; LOOP-NEXT:    v_or_b32_e32 v9, v13, v9
; LOOP-NEXT:    v_or_b32_e32 v11, v14, v11
; LOOP-NEXT:    v_or_b32_e32 v12, v16, v15
; LOOP-NEXT:    v_or_b32_e32 v13, v18, v17
; LOOP-NEXT:    v_or_b32_e32 v14, v20, v19
; LOOP-NEXT:    v_lshrrev_b32_e32 v15, 16, v21
; LOOP-NEXT:    v_bfe_u32 v16, v21, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v17, 16, v10
; LOOP-NEXT:    v_bfe_u32 v18, v10, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v19, 16, v8
; LOOP-NEXT:    v_bfe_u32 v20, v8, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v22, 16, v9
; LOOP-NEXT:    v_bfe_u32 v23, v9, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v24, 16, v11
; LOOP-NEXT:    v_bfe_u32 v25, v11, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v26, 16, v12
; LOOP-NEXT:    v_bfe_u32 v27, v12, 8, 8
; LOOP-NEXT:    buffer_store_byte v21, v[6:7], s[0:3], 0 addr64
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v21, 24, v21
; LOOP-NEXT:    v_lshrrev_b32_e32 v28, 16, v13
; LOOP-NEXT:    v_bfe_u32 v29, v13, 8, 8
; LOOP-NEXT:    v_lshrrev_b32_e32 v30, 16, v14
; LOOP-NEXT:    buffer_store_byte v10, v[6:7], s[0:3], 0 addr64 offset:4
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v10, 24, v10
; LOOP-NEXT:    v_bfe_u32 v31, v14, 8, 8
...
; LOOP-NEXT:    buffer_store_byte v11, v[6:7], s[0:3], 0 addr64 offset:16
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v11, 24, v11
; LOOP-NEXT:    buffer_store_byte v12, v[6:7], s[0:3], 0 addr64 offset:20
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v12, 24, v12
; LOOP-NEXT:    buffer_store_byte v13, v[6:7], s[0:3], 0 addr64 offset:24
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v13, 24, v13
; LOOP-NEXT:    buffer_store_byte v14, v[6:7], s[0:3], 0 addr64 offset:28
; LOOP-NEXT:    s_waitcnt expcnt(0)
; LOOP-NEXT:    v_lshrrev_b32_e32 v14, 24, v14
; LOOP-NEXT:    buffer_store_byte v16, v[6:7], s[0:3], 0 addr64 offset:1
; LOOP-NEXT:    buffer_store_byte v15, v[6:7], s[0:3], 0 addr64 offset:2
; LOOP-NEXT:    buffer_store_byte v21, v[6:7], s[0:3], 0 addr64 offset:3
...
; LOOP-NEXT:    buffer_store_byte v20, v[6:7], s[0:3], 0 addr64 offset:9
; LOOP-NEXT:    buffer_store_byte v19, v[6:7], s[0:3], 0 addr64 offset:10
...
; LOOP-NEXT:    buffer_store_byte v11, v[6:7], s[0:3], 0 addr64 offset:19
...
; LOOP-NEXT:    buffer_store_byte v12, v[6:7], s[0:3], 0 addr64 offset:23
...
; LOOP-NEXT:    buffer_store_byte v13, v[6:7], s[0:3], 0 addr64 offset:27
...
; LOOP-NEXT:    buffer_store_byte v14, v[6:7], s[0:3], 0 addr64 offset:31
