...
; RUN: llc -global-isel -mtriple=amdgpu9.0a -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX90A_GFX942 %s
; RUN: llc -global-isel -mtriple=amdgpu9.42 -stop-after=instruction-select < %s | FileCheck -check-prefix=GFX90A_GFX942 %s
