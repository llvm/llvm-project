...
; RUN: llc -global-isel -mtriple=amdgcn-amd-mesa3d -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX11 %s
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_lshl_u32 v0, v0, 3, 9
; GFX11-NEXT:    ; return to shader part epilog
  %x = add i32 %a, 3
  %result = shl i32 %x, 9
  %bc = bitcast i32 %result to float
