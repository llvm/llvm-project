...
define amdgpu_ps <4 x float> @load_3d(<8 x i32> inreg %rsrc, <2 x i16> %coords_lo, <2 x i16> %coords_hi) {
  ...
  ; GFX10NSA-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST]], [[C1]](i32)
  ; GFX10NSA-NEXT:   [[TRUNC1:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR1]](i32)
  ; GFX10NSA-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[COPY9]](<2 x i16>)
  ; GFX10NSA-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ...
  ; GFX12-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST]], [[C1]](i32)
  ; GFX12-NEXT:   [[TRUNC1:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR1]](i32)
  ; GFX12-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[COPY9]](<2 x i16>)
  ; GFX12-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
...
define amdgpu_ps <4 x float> @load_2darraymsaa(<8 x i32> inreg %rsrc, <2 x i16> %coords_lo, <2 x i16> %coords_hi) {
  ...
  ; GFX10NSA-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; GFX10NSA-NEXT:   [[TRUNC2:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR2]](i32)
  ; GFX10NSA-NEXT:   [[LSHR3:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C1]](i32)
...
define amdgpu_ps void @store_3d(<8 x i32> inreg %rsrc, <4 x float> %vdata, <2 x i16> %coords_lo, <2 x i16> %coords_hi) {
  ...
  ; GFX9-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST]], [[C1]](i32)
  ; GFX9-NEXT:   [[TRUNC1:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR1]](i32)
  ; GFX9-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[COPY13]](<2 x i16>)
  ; GFX9-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; GFX9-NEXT:   [[TRUNC2:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR2]](i32)
  ; GFX9-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x i16>) = G_BUILD_VECTOR [[TRUNC]](i16), [[TRUNC1]](i16)
  ; GFX9-NEXT:   [[DEF:%[0-9]+]]:_(i16) = G_IMPLICIT_DEF
  ...
  ; GFX10NSA-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST]], [[C1]](i32)
  ; GFX10NSA-NEXT:   [[TRUNC1:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR1]](i32)
  ; GFX10NSA-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[COPY13]](<2 x i16>)
  ; GFX10NSA-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; GFX10NSA-NEXT:   [[TRUNC2:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR2]](i32)
  ; GFX10NSA-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x i16>) = G_BUILD_VECTOR [[TRUNC]](i16), [[TRUNC1]](i16)
  ; GFX10NSA-NEXT:   [[DEF:%[0-9]+]]:_(i16) = G_IMPLICIT_DEF
  ...
  ; GFX12-NEXT:   [[LSHR1:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST]], [[C1]](i32)
  ; GFX12-NEXT:   [[TRUNC1:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR1]](i32)
  ; GFX12-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[COPY13]](<2 x i16>)
  ; GFX12-NEXT:   [[LSHR2:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; GFX12-NEXT:   [[TRUNC2:%[0-9]+]]:_(i16) = G_TRUNC [[LSHR2]](i32)
  ; GFX12-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x i16>) = G_BUILD_VECTOR [[TRUNC]](i16), [[TRUNC1]](i16)
  ; GFX12-NEXT:   [[DEF:%[0-9]+]]:_(i16) = G_IMPLICIT_DEF
