...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: v_orn2_i64_sv:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor_b32_e32 v0, -1, v0
; GFX11-NEXT:    v_xor_b32_e32 v1, -1, v1
; GFX11-NEXT:    v_or_b32_e32 v0, s2, v0
; GFX11-NEXT:    v_or_b32_e32 v1, s3, v1
; GFX11-NEXT:    ; return to shader part epilog
  %not.src1 = xor i64 %src1, -1
  %or = or i64 %src0, %not.src1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v4i16_commute:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s0, -1
; GFX11-NEXT:    s_mov_b32 s1, s0
; GFX11-NEXT:    s_xor_b64 s[0:1], s[4:5], s[0:1]
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v4i16_multi_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s0, -1
; GFX11-NEXT:    s_mov_b32 s1, s0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: s_orn2_v4i16_multi_foldable_use:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mov_b32 s0, -1
; GFX11-NEXT:    s_mov_b32 s1, s0
; GFX11-NEXT:    s_xor_b64 s[6:7], s[6:7], s[0:1]
; GFX11-NEXT:    s_or_b64 s[0:1], s[2:3], s[6:7]
; GFX11-NEXT:    s_or_b64 s[2:3], s[4:5], s[6:7]
; GFX11-NEXT:    ; return to shader part epilog
