...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10PLUS-LABEL: v_shl_i65:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10PLUS-NEXT:    v_sub_nc_u32_e32 v6, 64, v3
; GFX10PLUS-NEXT:    v_lshlrev_b64 v[4:5], v3, v[2:3]
; GFX10PLUS-NEXT:    v_add_nc_u32_e32 v8, 0xffffffc0, v3
; GFX10PLUS-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 64, v3
; GFX10PLUS-NEXT:    v_lshrrev_b64 v[5:6], v6, v[0:1]
; GFX10PLUS-NEXT:    v_lshlrev_b64 v[6:7], v3, v[0:1]
; GFX10PLUS-NEXT:    v_lshlrev_b64 v[8:9], v8, v[0:1]
; GFX10PLUS-NEXT:    v_or_b32_e32 v1, v5, v4
; GFX10PLUS-NEXT:    v_cndmask_b32_e32 v0, 0, v6, vcc_lo
; GFX10PLUS-NEXT:    v_cndmask_b32_e32 v4, v8, v1, vcc_lo
; GFX10PLUS-NEXT:    v_cndmask_b32_e32 v1, 0, v7, vcc_lo
; GFX10PLUS-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v3
; GFX10PLUS-NEXT:    v_cndmask_b32_e32 v2, v4, v2, vcc_lo
; GFX10PLUS-NEXT:    s_setpc_b64 s[30:31]
