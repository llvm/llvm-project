...
; GFX6-NEXT:    v_lshr_b64 v[6:7], v[0:1], v6
; GFX6-NEXT:    v_lshl_b64 v[4:5], v[0:1], v3
; GFX6-NEXT:    v_lshl_b64 v[7:8], v[0:1], v2
; GFX6-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GFX6-NEXT:    v_cndmask_b32_e32 v0, 0, v4, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v1, 0, v5, vcc
; GFX6-NEXT:    v_cndmask_b32_e32 v2, v7, v6, vcc
...
; GFX8-NEXT:    v_lshrrev_b64 v[6:7], v6, v[0:1]
; GFX8-NEXT:    v_lshlrev_b64 v[4:5], v3, v[0:1]
; GFX8-NEXT:    v_lshlrev_b64 v[7:8], v2, v[0:1]
...
; GFX9-NEXT:    v_lshrrev_b64 v[6:7], v6, v[0:1]
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], v3, v[0:1]
; GFX9-NEXT:    v_lshlrev_b64 v[7:8], v2, v[0:1]
; GFX9-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v0, 0, v4, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v1, 0, v5, vcc
...
; GFX10-NEXT:    v_lshlrev_b64 v[4:5], v3, v[0:1]
; GFX10-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 64, v3
; GFX10-NEXT:    v_lshrrev_b64 v[6:7], v2, v[0:1]
; GFX10-NEXT:    v_lshlrev_b64 v[1:2], v8, v[0:1]
; GFX10-NEXT:    v_cndmask_b32_e32 v0, 0, v4, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v2, v1, v6, vcc_lo
; GFX10-NEXT:    v_cndmask_b32_e32 v1, 0, v5, vcc_lo
...
; GFX11-NEXT:    v_lshlrev_b64 v[4:5], v3, v[0:1]
; GFX11-NEXT:    v_cmp_gt_u32_e32 vcc_lo, 64, v3
; GFX11-NEXT:    v_lshrrev_b64 v[6:7], v2, v[0:1]
; GFX11-NEXT:    v_lshlrev_b64 v[1:2], v8, v[0:1]
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0, v4, vcc_lo
; GFX11-NEXT:    v_dual_cndmask_b32 v2, v1, v6 :: v_dual_cndmask_b32 v1, 0, v5
...
; GFX10PLUS-NEXT:    s_lshl_b64 s[2:3], s[0:1], s3
; GFX10PLUS-NEXT:    s_lshr_b64 s[4:5], s[0:1], s4
; GFX10PLUS-NEXT:    s_lshl_b64 s[6:7], s[0:1], s6
; GFX10PLUS-NEXT:    s_cmp_lg_u32 s8, 0
; GFX10PLUS-NEXT:    s_cselect_b64 s[0:1], s[2:3], 0
; GFX10PLUS-NEXT:    s_cselect_b32 s2, s4, s6
...
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    s_lshl_b32 s4, s0, 1
; GFX10PLUS-NEXT:    s_lshr_b64 s[2:3], s[0:1], 31
; GFX10PLUS-NEXT:    s_mov_b32 s0, 0
; GFX10PLUS-NEXT:    s_mov_b32 s1, s4
; GFX10PLUS-NEXT:    ; return to shader part epilog
  %result = shl i65 %value, 33
  ret i65 %result
}
