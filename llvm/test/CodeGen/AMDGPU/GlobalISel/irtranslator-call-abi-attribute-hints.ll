...
define amdgpu_kernel void @kernel_call_no_workitem_ids() {
  ...
  ; CHECK-NEXT:   liveins: $sgpr14, $sgpr15, $sgpr16, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:sgpr_32 = COPY $sgpr16
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sgpr_32 = COPY $sgpr14
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ...
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY14]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_5 = COPY [[COPY7]](p4)
  ; CHECK-NEXT:   $sgpr6_7 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr10_11 = COPY [[COPY10]](s64)
  ...
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @extern, csr_amdgpu, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15
...
define amdgpu_kernel void @kernel_call_no_workgroup_ids() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $vgpr0, $vgpr1, $vgpr2, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:_(s64) = COPY [[COPY3]]
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:_(i32) = COPY [[COPY2]](i32)
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[COPY1]](i32)
  ...
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ...
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @extern, csr_amdgpu, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr15, implicit $vgpr31
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; CHECK-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @kernel_call_no_other_sgprs() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $vgpr0, $vgpr1, $vgpr2, $sgpr8_9
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr2
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr1
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr0
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(p4) = COPY $sgpr8_9
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @extern
  ...
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(s32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY [[COPY2]](i32)
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:_(i32) = COPY [[COPY1]](i32)
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 10
  ; CHECK-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY6]], [[C1]](i32)
  ; CHECK-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[COPY5]], [[SHL]]
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; CHECK-NEXT:   [[C2:%[0-9]+]]:_(i32) = G_CONSTANT i32 20
  ; CHECK-NEXT:   [[SHL1:%[0-9]+]]:_(i32) = G_SHL [[COPY7]], [[C2]](i32)
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(i32) = G_OR [[OR]], [[SHL1]]
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:_(<4 x s32>) = COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY8]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr15 = COPY [[DEF]](s32)
  ; CHECK-NEXT:   $vgpr31 = COPY [[OR1]](i32)
  ; CHECK-NEXT:   $sgpr30_31 = noconvergent G_SI_CALL [[GV]](p0), @extern, csr_amdgpu, implicit $sgpr0_3, implicit $sgpr8_9, implicit $sgpr15, implicit $vgpr31
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
  ; CHECK-NEXT:   S_ENDPGM 0
...
define void @func_call_no_workitem_ids() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr8_9
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @extern
  ...
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY16]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_5 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr6_7 = COPY [[COPY9]](p4)
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[COPY10]](p4)
  ; CHECK-NEXT:   $sgpr10_11 = COPY [[COPY11]](s64)
...
define void @func_call_no_workgroup_ids() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $sgpr15, $vgpr31, $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr31
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sgpr_64 = COPY $sgpr10_11
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:sgpr_64 = COPY $sgpr8_9
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:sgpr_64 = COPY $sgpr6_7
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:sgpr_64 = COPY $sgpr4_5
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @extern
  ...
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY12]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr4_5 = COPY [[COPY6]](p4)
  ; CHECK-NEXT:   $sgpr6_7 = COPY [[COPY7]](p4)
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr10_11 = COPY [[COPY9]](s64)
...
define void @func_call_no_other_sgprs() {
  ...
  ; CHECK: bb.1 (%ir-block.0):
  ; CHECK-NEXT:   liveins: $sgpr15, $vgpr31, $sgpr8_9
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY:%[0-9]+]]:vgpr_32(i32) = COPY $vgpr31
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:sgpr_32 = COPY $sgpr15
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sgpr_64 = COPY $sgpr8_9
  ; CHECK-NEXT:   ADJCALLSTACKUP 0, 0, implicit-def $scc
  ; CHECK-NEXT:   [[GV:%[0-9]+]]:_(p0) = G_GLOBAL_VALUE @extern
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(p4) = COPY [[COPY2]]
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(s32) = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:_(<4 x s32>) = COPY $sgpr0_3
  ; CHECK-NEXT:   $sgpr0_3 = COPY [[COPY6]](<4 x s32>)
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[COPY3]](p4)
