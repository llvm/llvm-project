...
define amdgpu_kernel void @kernel_call_no_workitem_ids() {
  ...
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY9]], [[C]](i64)
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:_(i64) = COPY [[COPY3]]
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY]]
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY14]](<4 x i32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = COPY [[COPY7]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = COPY [[COPY10]](i64)
  ; CHECK-NEXT:   $sgpr12 = COPY [[COPY11]](i32)
  ; CHECK-NEXT:   $sgpr13 = COPY [[COPY12]](i32)
  ; CHECK-NEXT:   $sgpr14 = COPY [[COPY13]](i32)
...
define amdgpu_kernel void @kernel_call_no_other_sgprs() {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[COPY4]], [[C]](i64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
  ...
  ; CHECK-NEXT:   [[OR1:%[0-9]+]]:_(i32) = G_OR [[OR]], [[SHL1]]
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:_(<4 x i32>) = COPY $private_rsrc_reg
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY8]](<4 x i32>)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = COPY [[PTR_ADD]](p4)
  ; CHECK-NEXT:   $sgpr15 = COPY [[DEF]](i32)
  ; CHECK-NEXT:   $vgpr31 = COPY [[OR1]](i32)
...
define void @func_call_no_workitem_ids() {
  ...
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:_(i64) = COPY [[COPY4]]
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[COPY3]]
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[COPY2]]
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:_(i32) = COPY [[COPY]]
  ; CHECK-NEXT:   [[COPY16:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY16]](<4 x i32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = COPY [[COPY9]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = COPY [[COPY10]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = COPY [[COPY11]](i64)
  ; CHECK-NEXT:   $sgpr12 = COPY [[COPY12]](i32)
  ; CHECK-NEXT:   $sgpr13 = COPY [[COPY13]](i32)
  ; CHECK-NEXT:   $sgpr14 = COPY [[COPY14]](i32)
  ; CHECK-NEXT:   $sgpr15 = COPY [[COPY15]](i32)
  ; CHECK-NEXT:   $sgpr30_sgpr31 = noconvergent G_SI_CALL [[GV]](p0), @extern, csr_amdgpu, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit $sgpr4_sgpr5, implicit $sgpr6_sgpr7, implicit $sgpr8_sgpr9, implicit $sgpr10_sgpr11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15
  ; CHECK-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def $scc
...
define void @func_call_no_workgroup_ids() {
  ...
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:_(i64) = COPY [[COPY2]]
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
  ; CHECK-NEXT:   $sgpr0_sgpr1_sgpr2_sgpr3 = COPY [[COPY12]](<4 x i32>)
  ; CHECK-NEXT:   $sgpr4_sgpr5 = COPY [[COPY6]](p4)
  ; CHECK-NEXT:   $sgpr6_sgpr7 = COPY [[COPY7]](p4)
  ; CHECK-NEXT:   $sgpr8_sgpr9 = COPY [[COPY8]](p4)
  ; CHECK-NEXT:   $sgpr10_sgpr11 = COPY [[COPY9]](i64)
  ; CHECK-NEXT:   $sgpr15 = COPY [[COPY10]](i32)
...
define void @func_call_no_other_sgprs() {
  ...
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY [[COPY1]]
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:_(i32) = COPY [[COPY]](i32)
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:_(<4 x i32>) = COPY $sgpr0_sgpr1_sgpr2_sgpr3
