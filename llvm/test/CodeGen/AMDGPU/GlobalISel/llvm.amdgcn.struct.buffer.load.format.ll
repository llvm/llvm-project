...
define amdgpu_cs void @struct_buffer_load_format_v4i32_tfe(<4 x i32> inreg %rsrc, ptr addrspace(1) %value, ptr addrspace(1) %status) {
  ...
  ; GFX8-NEXT: {{  $}}
  ; GFX8-NEXT:   [[COPY:%[0-9]+]]:sgpr(i32) = COPY $sgpr2
  ; GFX8-NEXT:   [[COPY1:%[0-9]+]]:sgpr(i32) = COPY $sgpr3
  ; GFX8-NEXT:   [[COPY2:%[0-9]+]]:sgpr(i32) = COPY $sgpr4
  ; GFX8-NEXT:   [[COPY3:%[0-9]+]]:sgpr(i32) = COPY $sgpr5
  ...
  ; GFX8-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_160(<5 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (<4 x i32>), align 1, addrspace 8)
  ; GFX8-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<5 x s32>)
  ; GFX8-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<5 x s32>)
  ; GFX8-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub2(<5 x s32>)
  ; GFX8-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub3(<5 x s32>)
  ; GFX8-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub4(<5 x s32>)
  ...
  ; GFX8-NEXT:   FLAT_STORE_DWORDX4 [[MV]](p1), [[COPY15]](<4 x i32>), 0, 0, implicit $exec, implicit $flat_scr :: (store (<4 x i32>) into %ir.value, addrspace 1)
  ; GFX8-NEXT:   FLAT_STORE_DWORD [[MV1]](p1), [[COPY14]](s32), 0, 0, implicit $exec, implicit $flat_scr :: (store (i32) into %ir.status, addrspace 1)
  ...
  ; GFX12-NEXT:   [[MV:%[0-9]+]]:vreg_64(p1) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; GFX12-NEXT:   [[COPY6:%[0-9]+]]:vgpr(i32) = COPY $vgpr2
  ; GFX12-NEXT:   [[COPY7:%[0-9]+]]:vgpr(i32) = COPY $vgpr3
  ; GFX12-NEXT:   [[MV1:%[0-9]+]]:vreg_64(p1) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; GFX12-NEXT:   [[C:%[0-9]+]]:sgpr(i32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[C1:%[0-9]+]]:sgpr(s32) = G_CONSTANT i32 0
  ; GFX12-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; GFX12-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_160(<5 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (<4 x i32>), align 1, addrspace 8)
  ; GFX12-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<5 x s32>)
  ; GFX12-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<5 x s32>)
  ; GFX12-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub2(<5 x s32>)
  ; GFX12-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub3(<5 x s32>)
  ; GFX12-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub4(<5 x s32>)
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY10]](s32), implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_1:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY11]](s32), implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_2:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY12]](s32), implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_3:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY13]](s32), implicit $exec
  ; GFX12-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sgpr_128(<4 x i32>) = REG_SEQUENCE [[V_READFIRSTLANE_B32_]](s32), %subreg.sub0, [[V_READFIRSTLANE_B32_1]](s32), %subreg.sub1, [[V_READFIRSTLANE_B32_2]](s32), %subreg.sub2, [[V_READFIRSTLANE_B32_3]](s32), %subreg.sub3
  ; GFX12-NEXT:   [[COPY15:%[0-9]+]]:vreg_128(<4 x i32>) = COPY [[REG_SEQUENCE]](<4 x i32>)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORDX4 [[MV]](p1), [[COPY15]](<4 x i32>), 0, 0, implicit $exec :: (store (<4 x i32>) into %ir.value, addrspace 1)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORD [[MV1]](p1), [[COPY14]](s32), 0, 0, implicit $exec :: (store (i32) into %ir.status, addrspace 1)
...
define amdgpu_cs void @struct_buffer_load_format_v3i32_tfe(<4 x i32> inreg %rsrc, ptr addrspace(1) %value, ptr addrspace(1) %status) {
  ...
  ; GFX8-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX8-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; GFX8-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_128(<4 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (<3 x i32>), align 1, addrspace 8)
  ; GFX8-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<4 x s32>)
  ; GFX8-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<4 x s32>)
  ; GFX8-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub2(<4 x s32>)
  ; GFX8-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub3(<4 x s32>)
  ; GFX8-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY10]](s32), implicit $exec
  ; GFX8-NEXT:   [[V_READFIRSTLANE_B32_1:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY11]](s32), implicit $exec
  ; GFX8-NEXT:   [[V_READFIRSTLANE_B32_2:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY12]](s32), implicit $exec
  ...
  ; GFX8-NEXT:   FLAT_STORE_DWORDX3 [[MV]](p1), [[COPY14]](<3 x i32>), 0, 0, implicit $exec, implicit $flat_scr :: (store (<3 x i32>) into %ir.value, align 16, addrspace 1)
  ; GFX8-NEXT:   FLAT_STORE_DWORD [[MV1]](p1), [[COPY13]](s32), 0, 0, implicit $exec, implicit $flat_scr :: (store (i32) into %ir.status, addrspace 1)
  ; GFX8-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; GFX12-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_128(<4 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (<3 x i32>), align 1, addrspace 8)
  ; GFX12-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<4 x s32>)
  ; GFX12-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<4 x s32>)
  ; GFX12-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub2(<4 x s32>)
  ; GFX12-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub3(<4 x s32>)
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY10]](s32), implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_1:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY11]](s32), implicit $exec
  ; GFX12-NEXT:   [[V_READFIRSTLANE_B32_2:%[0-9]+]]:sreg_32_xm0(s32) = V_READFIRSTLANE_B32 [[COPY12]](s32), implicit $exec
  ; GFX12-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sgpr_96(<3 x i32>) = REG_SEQUENCE [[V_READFIRSTLANE_B32_]](s32), %subreg.sub0, [[V_READFIRSTLANE_B32_1]](s32), %subreg.sub1, [[V_READFIRSTLANE_B32_2]](s32), %subreg.sub2
  ; GFX12-NEXT:   [[COPY14:%[0-9]+]]:vreg_96(<3 x i32>) = COPY [[REG_SEQUENCE]](<3 x i32>)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORDX3 [[MV]](p1), [[COPY14]](<3 x i32>), 0, 0, implicit $exec :: (store (<3 x i32>) into %ir.value, align 16, addrspace 1)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORD [[MV1]](p1), [[COPY13]](s32), 0, 0, implicit $exec :: (store (i32) into %ir.status, addrspace 1)
  ; GFX12-NEXT:   S_ENDPGM 0
...
define amdgpu_cs void @struct_buffer_load_format_i32_tfe(<4 x i32> inreg %rsrc, ptr addrspace(1) %value, ptr addrspace(1) %status) {
  ...
  ; GFX8-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX8-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; GFX8-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_64(<2 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (i32), align 1, addrspace 8)
  ; GFX8-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<2 x s32>)
  ; GFX8-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<2 x s32>)
  ; GFX8-NEXT:   FLAT_STORE_DWORD [[MV]](p1), [[COPY10]](s32), 0, 0, implicit $exec, implicit $flat_scr :: (store (i32) into %ir.value, addrspace 1)
  ; GFX8-NEXT:   FLAT_STORE_DWORD [[MV1]](p1), [[COPY11]](s32), 0, 0, implicit $exec, implicit $flat_scr :: (store (i32) into %ir.status, addrspace 1)
  ; GFX8-NEXT:   S_ENDPGM 0
  ;
  ...
  ; GFX12-NEXT:   [[COPY8:%[0-9]+]]:vgpr(i32) = COPY [[C]](i32)
  ; GFX12-NEXT:   [[COPY9:%[0-9]+]]:vgpr(s32) = COPY [[C1]](s32)
  ; GFX12-NEXT:   [[AMDGPU_BUFFER_LOAD_FORMAT_TFE:%[0-9]+]]:vreg_64(<2 x s32>) = G_AMDGPU_BUFFER_LOAD_FORMAT_TFE [[BUILD_VECTOR]](<4 x i32>), [[COPY8]](i32), [[COPY9]], [[C]], 0, 0, -1 :: (dereferenceable load (i32), align 1, addrspace 8)
  ; GFX12-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub0(<2 x s32>)
  ; GFX12-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32(s32) = COPY [[AMDGPU_BUFFER_LOAD_FORMAT_TFE]].sub1(<2 x s32>)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORD [[MV]](p1), [[COPY10]](s32), 0, 0, implicit $exec :: (store (i32) into %ir.value, addrspace 1)
  ; GFX12-NEXT:   GLOBAL_STORE_DWORD [[MV1]](p1), [[COPY11]](s32), 0, 0, implicit $exec :: (store (i32) into %ir.status, addrspace 1)
  ; GFX12-NEXT:   S_ENDPGM 0
