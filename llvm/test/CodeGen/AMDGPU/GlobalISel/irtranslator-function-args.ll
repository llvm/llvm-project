...
define void @void_func_f64(double %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   G_STORE [[BITCAST]](f64), [[DEF]](p1) :: (store (f64) into `ptr addrspace(1) undef`, addrspace 1)
  ; CHECK-NEXT:   SI_RETURN
...
define void @void_func_v2f64(<2 x double> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST:%[0-9]+]]:_(f64) = G_BITCAST [[MV]](i64)
  ; CHECK-NEXT:   [[MV1:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY2]](i32), [[COPY3]](i32)
  ; CHECK-NEXT:   [[BITCAST1:%[0-9]+]]:_(f64) = G_BITCAST [[MV1]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<2 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
...
define void @void_func_v3f64(<3 x double> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST1:%[0-9]+]]:_(f64) = G_BITCAST [[MV1]](i64)
  ; CHECK-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY4]](i32), [[COPY5]](i32)
  ; CHECK-NEXT:   [[BITCAST2:%[0-9]+]]:_(f64) = G_BITCAST [[MV2]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<3 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64), [[BITCAST2]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
...
define void @void_func_v4f64(<4 x double> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST2:%[0-9]+]]:_(f64) = G_BITCAST [[MV2]](i64)
  ; CHECK-NEXT:   [[MV3:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY6]](i32), [[COPY7]](i32)
  ; CHECK-NEXT:   [[BITCAST3:%[0-9]+]]:_(f64) = G_BITCAST [[MV3]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<4 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64), [[BITCAST2]](f64), [[BITCAST3]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
...
define void @void_func_v8f64(<8 x double> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST3:%[0-9]+]]:_(f64) = G_BITCAST [[MV3]](i64)
  ; CHECK-NEXT:   [[MV4:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY8]](i32), [[COPY9]](i32)
  ; CHECK-NEXT:   [[BITCAST4:%[0-9]+]]:_(f64) = G_BITCAST [[MV4]](i64)
  ; CHECK-NEXT:   [[MV5:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY10]](i32), [[COPY11]](i32)
  ; CHECK-NEXT:   [[BITCAST5:%[0-9]+]]:_(f64) = G_BITCAST [[MV5]](i64)
  ; CHECK-NEXT:   [[MV6:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY12]](i32), [[COPY13]](i32)
  ; CHECK-NEXT:   [[BITCAST6:%[0-9]+]]:_(f64) = G_BITCAST [[MV6]](i64)
  ; CHECK-NEXT:   [[MV7:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY14]](i32), [[COPY15]](i32)
  ; CHECK-NEXT:   [[BITCAST7:%[0-9]+]]:_(f64) = G_BITCAST [[MV7]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<8 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64), [[BITCAST2]](f64), [[BITCAST3]](f64), [[BITCAST4]](f64), [[BITCAST5]](f64), [[BITCAST6]](f64), [[BITCAST7]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
...
define void @void_func_v16f64(<16 x double> %arg0) #0 {
  ...
  ; CHECK-NEXT:   [[BITCAST7:%[0-9]+]]:_(f64) = G_BITCAST [[MV7]](i64)
  ; CHECK-NEXT:   [[MV8:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY16]](i32), [[COPY17]](i32)
  ; CHECK-NEXT:   [[BITCAST8:%[0-9]+]]:_(f64) = G_BITCAST [[MV8]](i64)
  ; CHECK-NEXT:   [[MV9:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY18]](i32), [[COPY19]](i32)
  ; CHECK-NEXT:   [[BITCAST9:%[0-9]+]]:_(f64) = G_BITCAST [[MV9]](i64)
  ; CHECK-NEXT:   [[MV10:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY20]](i32), [[COPY21]](i32)
  ; CHECK-NEXT:   [[BITCAST10:%[0-9]+]]:_(f64) = G_BITCAST [[MV10]](i64)
  ; CHECK-NEXT:   [[MV11:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY22]](i32), [[COPY23]](i32)
  ; CHECK-NEXT:   [[BITCAST11:%[0-9]+]]:_(f64) = G_BITCAST [[MV11]](i64)
  ; CHECK-NEXT:   [[MV12:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY24]](i32), [[COPY25]](i32)
  ; CHECK-NEXT:   [[BITCAST12:%[0-9]+]]:_(f64) = G_BITCAST [[MV12]](i64)
  ; CHECK-NEXT:   [[MV13:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY26]](i32), [[COPY27]](i32)
  ; CHECK-NEXT:   [[BITCAST13:%[0-9]+]]:_(f64) = G_BITCAST [[MV13]](i64)
  ; CHECK-NEXT:   [[MV14:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY28]](i32), [[COPY29]](i32)
  ; CHECK-NEXT:   [[BITCAST14:%[0-9]+]]:_(f64) = G_BITCAST [[MV14]](i64)
  ; CHECK-NEXT:   [[MV15:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[COPY30]](i32), [[LOAD]](i32)
  ; CHECK-NEXT:   [[BITCAST15:%[0-9]+]]:_(f64) = G_BITCAST [[MV15]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR:%[0-9]+]]:_(<16 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64), [[BITCAST2]](f64), [[BITCAST3]](f64), [[BITCAST4]](f64), [[BITCAST5]](f64), [[BITCAST6]](f64), [[BITCAST7]](f64), [[BITCAST8]](f64), [[BITCAST9]](f64), [[BITCAST10]](f64), [[BITCAST11]](f64), [[BITCAST12]](f64), [[BITCAST13]](f64), [[BITCAST14]](f64), [[BITCAST15]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
...
define void @void_func_v32i32_v2i64_v2f64(<32 x i32> %arg0, <2 x i64> %arg1, <2 x double> %arg2) #0 {
  ...
  ; CHECK-NEXT:   [[MV2:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD5]](i32), [[LOAD6]](i32)
  ; CHECK-NEXT:   [[BITCAST:%[0-9]+]]:_(f64) = G_BITCAST [[MV2]](i64)
  ; CHECK-NEXT:   [[MV3:%[0-9]+]]:_(i64) = G_MERGE_VALUES [[LOAD7]](i32), [[LOAD8]](i32)
  ; CHECK-NEXT:   [[BITCAST1:%[0-9]+]]:_(f64) = G_BITCAST [[MV3]](i64)
  ; CHECK-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x f64>) = G_BUILD_VECTOR [[BITCAST]](f64), [[BITCAST1]](f64)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:_(p1) = G_IMPLICIT_DEF
  ; CHECK-NEXT:   G_STORE [[BUILD_VECTOR]](<32 x i32>), [[DEF]](p1) :: (volatile store (<32 x i32>) into `ptr addrspace(1) undef`, addrspace 1)
