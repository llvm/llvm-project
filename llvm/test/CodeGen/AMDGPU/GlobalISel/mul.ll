...
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s4, v4, v5, 0
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s4, v4, v3, v[1:2]
; GFX10-NEXT:    ; implicit-def: $vgpr2
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s4, v6, v5, v[1:2]
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    ; implicit-def: $vgpr10
...
; GFX10-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v3, v6, vcc_lo
...
; GFX12-NEXT:    v_add_co_ci_u32_e64 v6, null, v3, v6, vcc_lo
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX10-NEXT:    v_add_co_ci_u32_e32 v9, vcc_lo, v7, v27, vcc_lo
; GFX10-NEXT:    v_mad_u64_u32 v[7:8], s4, v22, v8, v[9:10]
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v9, null, v7, v27, vcc_lo
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[7:8], null, v22, v8, v[9:10]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v7, 0
; GFX7-NEXT:    v_ashrrev_i32_e32 v8, 31, v4
; GFX7-NEXT:    ; implicit-def: $vgpr4
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v7, v[3:4]
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v4, v7, 0
; GFX8-NEXT:    v_ashrrev_i32_e32 v8, 31, v4
; GFX8-NEXT:    ; implicit-def: $vgpr4
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], v8, v7, v[3:4]
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v4, v7, 0
; GFX9-NEXT:    v_ashrrev_i32_e32 v8, 31, v4
; GFX9-NEXT:    ; implicit-def: $vgpr4
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], v8, v7, v[3:4]
...
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], s0, 0x50, v5, v[3:4]
; GFX10-NEXT:    global_store_dwordx2 v[0:1], v[2:3], off
; GFX10-NEXT:    s_endpgm
;
