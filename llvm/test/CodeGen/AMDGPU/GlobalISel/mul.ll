...
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1210 %s
...
; GFX1210-NEXT:    v_mul_lo_u32 v2, v2, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mul_lo_u32 v5, v6, v5
; GFX1210-NEXT:    v_mul_lo_u32 v8, v7, v4
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v6, v3, 0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_add3_u32 v9, v5, v8, v2
; GFX1210-NEXT:    v_mov_b32_e32 v8, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[4:5], null, v6, v4, v[8:9]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[2:3], null, v7, v3, v[4:5]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    v_mul_lo_u32 v3, v3, v4
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v8, v6, 0
; GFX1210-NEXT:    v_mad_co_u64_u32 v[10:11], null, v9, v5, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v8, v4, 0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[10:11], null, v2, v4, v[10:11]
; GFX1210-NEXT:    v_mov_b32_e32 v12, v1
; GFX1210-NEXT:    v_mul_lo_u32 v1, v9, v6
; GFX1210-NEXT:    v_mul_lo_u32 v2, v2, v5
...
; GFX1210-NEXT:    v_add3_u32 v3, v1, v2, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1210-NEXT:    v_dual_mov_b32 v1, v6 :: v_dual_mov_b32 v2, v7
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
  %result = mul i128 %num, %den
  ret i128 %result
}
...
; GFX1210-NEXT:    v_mul_lo_u32 v28, v5, v10
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v16, v14, 0
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], null, v16, v12, 0
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v17, v13, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v2, v12, v[0:1]
...
; GFX1210-NEXT:    v_mad_co_u64_u32 v[20:21], null, v16, v10, 0
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v3, v11, v[0:1]
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v4, v10, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v4, v8, v[18:19]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v27, vcc_lo, 0, v24, vcc_lo
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v5, v9, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[22:23], null, v6, v8, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v9, v[20:21]
; GFX1210-NEXT:    v_mov_b32_e32 v20, v19
; GFX1210-NEXT:    v_cndmask_b32_e64 v26, 0, 1, s0
; GFX1210-NEXT:    v_mov_b32_e32 v21, v22
; GFX1210-NEXT:    v_mul_lo_u32 v22, v6, v9
; GFX1210-NEXT:    v_mad_co_u64_u32 v[24:25], vcc_lo, v2, v8, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, 0, v26, vcc_lo
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v16, v13, v[20:21]
; GFX1210-NEXT:    v_mov_b32_e32 v21, v18
; GFX1210-NEXT:    v_mul_lo_u32 v26, v17, v14
; GFX1210-NEXT:    v_mov_b32_e32 v20, v25
; GFX1210-NEXT:    v_mul_lo_u32 v25, v16, v15
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v17, v12, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[14:15], s2, v16, v11, v[20:21]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], null, v16, v8, 0
; GFX1210-NEXT:    v_mul_lo_u32 v21, v2, v13
...
; GFX1210-NEXT:    v_mul_lo_u32 v20, v4, v11
; GFX1210-NEXT:    v_dual_mov_b32 v14, v1 :: v_dual_mov_b32 v15, v24
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
...
; GFX1210-NEXT:    v_mul_lo_u32 v2, v7, v8
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v5, s5, v1, v10, s5
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v6, s5, v27, v11, s5
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s5, v23, v25, s5
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s4, v1, v26, s4
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v21, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v29, s3
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s1, v1, v20, s1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v28, vcc_lo
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, vcc_lo, v1, v22, s0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_add_nc_u32 v7, v1, v2 :: v_dual_mov_b32 v1, v14
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    global_load_b32 v6, v[2:3], off
; GFX12-NEXT:    s_mov_b64 s[0:1], 0x50
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v5, s1
; GFX12-NEXT:    v_dual_mov_b32 v4, s0 :: v_dual_mov_b32 v3, v2
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[2:3], null, v6, v4, v[2:3]
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    global_load_b32 v6, v[2:3], off
; GFX1210-NEXT:    s_mov_b64 s[0:1], 0x50
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_mov_b64 v[4:5], s[0:1] :: v_dual_mov_b32 v2, 0
; GFX1210-NEXT:    v_mov_b32_e32 v3, v2
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[2:3], null, v6, v4, v[2:3]
...
; GFX1210-NEXT:    s_movk_i32 s4, 0x50
...
; GFX1210-NEXT:    s_mov_b32 s5, s3
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_mul_u64 s[2:3], s[2:3], s[4:5]
...
; GFX8-NEXT:    s_movk_i32 s2, 0x50
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v4, s2, 0
; GFX8-NEXT:    v_ashrrev_i32_e32 v4, 31, v4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v4, s2, v[3:4]
; GFX8-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v4, s2, 0
; GFX9-NEXT:    v_ashrrev_i32_e32 v4, 31, v4
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v4, s2, v[3:4]
; GFX9-NEXT:    global_store_dwordx2 v[0:1], v[2:3], off
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], s0, v2, 0x50, 0
; GFX10-NEXT:    v_mul_lo_u32 v4, v4, 0x50
...
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, v2, 0x50, 0
; GFX11-NEXT:    v_mul_lo_u32 v4, v4, 0x50
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_i64_i32 v[2:3], null, v6, v4, v[2:3]
; GFX12-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX12-NEXT:    s_nop 0
; GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-NEXT:    s_endpgm
...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_co_i64_i32 v[2:3], null, v6, v4, v[2:3]
; GFX1210-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-NEXT:    s_nop 0
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1210-NEXT:    s_mov_b64 s[4:5], 0x50
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
