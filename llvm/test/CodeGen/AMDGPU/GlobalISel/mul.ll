...
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v0, v10, 0
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v1, v11, v[16:17]
...
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v0, v14, 0
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], vcc, v4, v8, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v1, v13, v[20:21]
; GFX7-NEXT:    v_addc_u32_e32 v25, vcc, 0, v22, vcc
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v2, v12, v[20:21]
; GFX7-NEXT:    v_mov_b32_e32 v22, v16
; GFX7-NEXT:    v_mov_b32_e32 v16, v17
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v3, v11, v[20:21]
; GFX7-NEXT:    v_mul_lo_u32 v27, v5, v10
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v4, v10, v[20:21]
; GFX7-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v5, v9, v[20:21]
; GFX7-NEXT:    v_mad_u64_u32 v[23:24], s[4:5], v6, v8, v[20:21]
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v1, v9, v[18:19]
; GFX7-NEXT:    v_mov_b32_e32 v17, v23
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], vcc, v0, v13, v[16:17]
; GFX7-NEXT:    v_mul_lo_u32 v23, v6, v9
; GFX7-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v2, v8, v[18:19]
; GFX7-NEXT:    v_addc_u32_e64 v26, s[4:5], 0, v6, s[4:5]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v1, v12, v[16:17]
; GFX7-NEXT:    v_mov_b32_e32 v21, v19
; GFX7-NEXT:    v_mad_u64_u32 v[19:20], s[10:11], v0, v11, v[21:22]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v2, v11, v[16:17]
; GFX7-NEXT:    v_mul_lo_u32 v21, v3, v12
; GFX7-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[10:11]
; GFX7-NEXT:    v_mad_u64_u32 v[11:12], s[8:9], v3, v10, v[16:17]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v1, v10, v[19:20]
; GFX7-NEXT:    v_mul_lo_u32 v20, v2, v13
; GFX7-NEXT:    v_mad_u64_u32 v[12:13], s[12:13], v4, v9, v[11:12]
; GFX7-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v0, v8, 0
; GFX7-NEXT:    v_addc_u32_e64 v6, s[10:11], 0, v6, s[10:11]
; GFX7-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v9, v[16:17]
; GFX7-NEXT:    v_mov_b32_e32 v19, v18
; GFX7-NEXT:    v_mov_b32_e32 v18, v11
; GFX7-NEXT:    v_mad_u64_u32 v[18:19], s[14:15], v0, v9, v[18:19]
; GFX7-NEXT:    v_addc_u32_e64 v2, s[10:11], 0, v6, s[10:11]
; GFX7-NEXT:    v_mad_u64_u32 v[3:4], s[10:11], v3, v8, v[16:17]
...
; GFX7-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v1, v8, v[18:19]
; GFX7-NEXT:    v_addc_u32_e64 v3, s[10:11], v6, v3, s[10:11]
; GFX7-NEXT:    v_mad_u64_u32 v[5:6], s[14:15], v5, v8, v[12:13]
; GFX7-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX7-NEXT:    v_addc_u32_e64 v4, s[10:11], v26, v4, s[10:11]
; GFX7-NEXT:    v_addc_u32_e64 v5, s[10:11], v11, v5, s[10:11]
; GFX7-NEXT:    v_addc_u32_e64 v6, s[10:11], v25, v6, s[10:11]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[10:11], v24, v0, s[10:11]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[10:11], v0, v9, s[14:15]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[10:11], v0, v20, s[12:13]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[8:9], v0, v21, s[8:9]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[6:7], v0, v28, s[6:7]
; GFX7-NEXT:    v_addc_u32_e64 v0, s[4:5], v0, v27, s[4:5]
; GFX7-NEXT:    v_addc_u32_e32 v0, vcc, v0, v23, vcc
...
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v0, v10, 0
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v1, v11, v[16:17]
...
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v0, v14, 0
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], vcc, v4, v8, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v1, v13, v[20:21]
; GFX8-NEXT:    v_addc_u32_e32 v25, vcc, 0, v22, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v2, v12, v[20:21]
; GFX8-NEXT:    v_mov_b32_e32 v22, v16
; GFX8-NEXT:    v_mov_b32_e32 v16, v17
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v3, v11, v[20:21]
; GFX8-NEXT:    v_mul_lo_u32 v27, v5, v10
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v4, v10, v[20:21]
; GFX8-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v5, v9, v[20:21]
; GFX8-NEXT:    v_mad_u64_u32 v[23:24], s[4:5], v6, v8, v[20:21]
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v1, v9, v[18:19]
; GFX8-NEXT:    v_mov_b32_e32 v17, v23
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], vcc, v0, v13, v[16:17]
; GFX8-NEXT:    v_mul_lo_u32 v23, v6, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v2, v8, v[18:19]
; GFX8-NEXT:    v_addc_u32_e64 v26, s[4:5], 0, v6, s[4:5]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v1, v12, v[16:17]
; GFX8-NEXT:    v_mov_b32_e32 v21, v19
; GFX8-NEXT:    v_mad_u64_u32 v[19:20], s[10:11], v0, v11, v[21:22]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v2, v11, v[16:17]
; GFX8-NEXT:    v_mul_lo_u32 v21, v3, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[10:11]
; GFX8-NEXT:    v_mad_u64_u32 v[11:12], s[8:9], v3, v10, v[16:17]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v1, v10, v[19:20]
; GFX8-NEXT:    v_mul_lo_u32 v20, v2, v13
; GFX8-NEXT:    v_mad_u64_u32 v[12:13], s[12:13], v4, v9, v[11:12]
; GFX8-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v0, v8, 0
; GFX8-NEXT:    v_addc_u32_e64 v6, s[10:11], 0, v6, s[10:11]
; GFX8-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v9, v[16:17]
; GFX8-NEXT:    v_mov_b32_e32 v19, v18
; GFX8-NEXT:    v_mov_b32_e32 v18, v11
; GFX8-NEXT:    v_mad_u64_u32 v[18:19], s[14:15], v0, v9, v[18:19]
; GFX8-NEXT:    v_addc_u32_e64 v2, s[10:11], 0, v6, s[10:11]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[10:11], v3, v8, v[16:17]
...
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v1, v8, v[18:19]
; GFX8-NEXT:    v_addc_u32_e64 v3, s[10:11], v6, v3, s[10:11]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[14:15], v5, v8, v[12:13]
; GFX8-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX8-NEXT:    v_addc_u32_e64 v4, s[10:11], v26, v4, s[10:11]
; GFX8-NEXT:    v_addc_u32_e64 v5, s[10:11], v11, v5, s[10:11]
; GFX8-NEXT:    v_addc_u32_e64 v6, s[10:11], v25, v6, s[10:11]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[10:11], v24, v0, s[10:11]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[10:11], v0, v9, s[14:15]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[10:11], v0, v20, s[12:13]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[8:9], v0, v21, s[8:9]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[6:7], v0, v28, s[6:7]
; GFX8-NEXT:    v_addc_u32_e64 v0, s[4:5], v0, v27, s[4:5]
; GFX8-NEXT:    v_addc_u32_e32 v0, vcc, v0, v23, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[6:7], v0, v10, 0
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[4:5], v1, v11, v[16:17]
...
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v0, v14, 0
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], vcc, v4, v8, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v1, v13, v[20:21]
; GFX9-NEXT:    v_addc_co_u32_e32 v25, vcc, 0, v22, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v2, v12, v[20:21]
; GFX9-NEXT:    v_mov_b32_e32 v22, v16
; GFX9-NEXT:    v_mov_b32_e32 v16, v17
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v3, v11, v[20:21]
; GFX9-NEXT:    v_mul_lo_u32 v27, v5, v10
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v4, v10, v[20:21]
; GFX9-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v5, v9, v[20:21]
; GFX9-NEXT:    v_mad_u64_u32 v[23:24], s[4:5], v6, v8, v[20:21]
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v1, v9, v[18:19]
; GFX9-NEXT:    v_mov_b32_e32 v17, v23
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], vcc, v0, v13, v[16:17]
; GFX9-NEXT:    v_mul_lo_u32 v23, v6, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[4:5]
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[4:5], v2, v8, v[18:19]
...
; GFX9-NEXT:    v_mad_u64_u32 v[19:20], s[10:11], v0, v11, v[21:22]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[6:7], v2, v11, v[16:17]
; GFX9-NEXT:    v_mul_lo_u32 v21, v3, v12
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[10:11]
; GFX9-NEXT:    v_mad_u64_u32 v[11:12], s[8:9], v3, v10, v[16:17]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v1, v10, v[19:20]
; GFX9-NEXT:    v_mul_lo_u32 v20, v2, v13
; GFX9-NEXT:    v_mad_u64_u32 v[12:13], s[12:13], v4, v9, v[11:12]
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v0, v8, 0
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[10:11], 0, v6, s[10:11]
; GFX9-NEXT:    v_mad_u64_u32 v[16:17], s[10:11], v2, v9, v[16:17]
; GFX9-NEXT:    v_mov_b32_e32 v19, v18
; GFX9-NEXT:    v_mov_b32_e32 v18, v11
; GFX9-NEXT:    v_mad_u64_u32 v[18:19], s[14:15], v0, v9, v[18:19]
; GFX9-NEXT:    v_addc_co_u32_e64 v2, s[10:11], 0, v6, s[10:11]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[10:11], v3, v8, v[16:17]
...
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v1, v8, v[18:19]
; GFX9-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v6, v3, s[10:11]
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[14:15], v5, v8, v[12:13]
; GFX9-NEXT:    v_mul_lo_u32 v0, v0, v15
; GFX9-NEXT:    v_addc_co_u32_e64 v4, s[10:11], v26, v4, s[10:11]
; GFX9-NEXT:    v_addc_co_u32_e64 v5, s[10:11], v11, v5, s[10:11]
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[10:11], v25, v6, s[10:11]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[10:11], v24, v0, s[10:11]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[10:11], v0, v9, s[14:15]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[10:11], v0, v20, s[12:13]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[8:9], v0, v21, s[8:9]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[6:7], v0, v28, s[6:7]
; GFX9-NEXT:    v_addc_co_u32_e64 v0, s[4:5], v0, v27, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v0, v23, vcc
