...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mul_i32 s3, s2, 0x50
; GFX9-NEXT:    s_mul_hi_u32 s2, s2, 0x50
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mul_hi_u32 v0, s3, v0
; GFX7-NEXT:    s_ashr_i32 s4, s3, 31
; GFX7-NEXT:    s_mulk_i32 s4, 0x50
; GFX7-NEXT:    s_mulk_i32 s3, 0x50
; GFX7-NEXT:    v_readfirstlane_b32 s5, v0
; GFX7-NEXT:    s_add_u32 s4, s4, s5
; GFX7-NEXT:    v_mov_b32_e32 v0, s3
; GFX7-NEXT:    v_mov_b32_e32 v1, s4
; GFX7-NEXT:    s_mov_b32 s3, 0xf000
; GFX7-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
...
; GFX9-NEXT:    s_mul_i32 s4, s2, 0x50
; GFX9-NEXT:    s_mul_hi_u32 s2, s2, 0x50
; GFX9-NEXT:    s_mulk_i32 s3, 0x50
