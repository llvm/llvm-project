...
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1210 %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1300 %s
...
;
; GFX1210-LABEL: s_mul_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_i32 s0, s0, s1
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i16:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1300-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_i32 s0, s0, s1
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i16_zeroext:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
...
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i16_zeroext:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1300-NEXT:    s_and_b32 s1, s1, 0xffff
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i16_signext:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_i32 s0, s0, s1
; GFX1210-NEXT:    s_sext_i32_i16 s0, s0
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i16_signext:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1300-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_i32 s0, s0, s1
; GFX1300-NEXT:    s_sext_i32_i16 s0, s0
; GFX1300-NEXT:    ; return to shader part epilog
  %result = mul i16 %num, %den
  ret i16 %result
}
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s0, s0, s1
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i32:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_i32 s0, s0, s1
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_v2i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s0, s0, s2
; GFX1210-NEXT:    s_mul_i32 s1, s1, s3
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_v2i32:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_i32 s0, s0, s2
; GFX1300-NEXT:    s_mul_i32 s1, s1, s3
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i33:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_u64 s[0:1], s[0:1], s[2:3]
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i33:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_u64 s[0:1], s[0:1], s[2:3]
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i96:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s6, s0, s5
; GFX1210-NEXT:    s_mul_i32 s7, s1, s4
; GFX1210-NEXT:    s_mul_i32 s2, s2, s3
; GFX1210-NEXT:    s_add_co_i32 s6, s6, s7
; GFX1210-NEXT:    s_mul_hi_u32 s7, s0, s3
; GFX1210-NEXT:    s_add_co_i32 s6, s6, s2
; GFX1210-NEXT:    s_mul_i32 s2, s0, s4
; GFX1210-NEXT:    s_mul_i32 s5, s0, s3
; GFX1210-NEXT:    s_mul_hi_u32 s0, s0, s4
; GFX1210-NEXT:    s_add_co_u32 s2, s2, s7
; GFX1210-NEXT:    s_mul_i32 s4, s1, s3
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s0, s6
; GFX1210-NEXT:    s_mul_hi_u32 s3, s1, s3
; GFX1210-NEXT:    s_add_co_u32 s1, s4, s2
; GFX1210-NEXT:    s_add_co_ci_u32 s2, s3, s0
; GFX1210-NEXT:    s_mov_b32 s0, s5
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i96:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_i32 s6, s0, s5
; GFX1300-NEXT:    s_mul_i32 s7, s1, s4
; GFX1300-NEXT:    s_mul_i32 s2, s2, s3
; GFX1300-NEXT:    s_add_co_i32 s6, s6, s7
; GFX1300-NEXT:    s_mul_hi_u32 s7, s0, s3
; GFX1300-NEXT:    s_add_co_i32 s6, s6, s2
; GFX1300-NEXT:    s_mul_i32 s2, s0, s4
; GFX1300-NEXT:    s_mul_i32 s5, s0, s3
; GFX1300-NEXT:    s_mul_hi_u32 s0, s0, s4
; GFX1300-NEXT:    s_add_co_u32 s2, s2, s7
; GFX1300-NEXT:    s_mul_i32 s4, s1, s3
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s0, s6
; GFX1300-NEXT:    s_mul_hi_u32 s3, s1, s3
; GFX1300-NEXT:    s_add_co_u32 s1, s4, s2
; GFX1300-NEXT:    s_add_co_ci_u32 s2, s3, s0
; GFX1300-NEXT:    s_mov_b32 s0, s5
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mul_lo_u32 v0, v7, v4
; GFX1210-NEXT:    v_mad_u32 v5, v6, v5, v0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v6, v3, 0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_u32 v9, v2, v3, v5
; GFX1210-NEXT:    v_mov_b32_e32 v8, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[4:5], v6, v4, v[8:9]
...
; GFX1300-NEXT:    v_mul_lo_u32 v0, v7, v4
; GFX1300-NEXT:    v_mad_u32 v5, v6, v5, v0
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v6, v3, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_u32 v9, v2, v3, v5
; GFX1300-NEXT:    v_mov_b32_e32 v8, v1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[4:5], v6, v4, v[8:9]
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[2:3], v7, v3, v[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_dual_mov_b32 v1, v2 :: v_dual_mov_b32 v2, v3
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i96 %num, %den
  ret i96 %result
}
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i128:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s9, s0, s6
; GFX1210-NEXT:    s_mul_i32 s11, s1, s5
; GFX1210-NEXT:    s_mul_hi_u32 s10, s0, s6
; GFX1210-NEXT:    s_mul_hi_u32 s12, s1, s5
; GFX1210-NEXT:    s_add_co_u32 s9, s11, s9
; GFX1210-NEXT:    s_mul_i32 s11, s2, s4
; GFX1210-NEXT:    s_add_co_ci_u32 s10, s12, s10
; GFX1210-NEXT:    s_mul_hi_u32 s12, s2, s4
; GFX1210-NEXT:    s_mul_hi_u32 s8, s0, s4
; GFX1210-NEXT:    s_add_co_u32 s9, s11, s9
; GFX1210-NEXT:    s_mul_i32 s11, s0, s5
; GFX1210-NEXT:    s_add_co_ci_u32 s10, s12, s10
; GFX1210-NEXT:    s_mul_hi_u32 s12, s0, s5
; GFX1210-NEXT:    s_add_co_u32 s8, s11, s8
; GFX1210-NEXT:    s_add_co_ci_u32 s9, s12, s9
; GFX1210-NEXT:    s_mul_i32 s12, s1, s4
; GFX1210-NEXT:    s_mul_hi_u32 s13, s1, s4
; GFX1210-NEXT:    s_cselect_b32 s11, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s8, s12, s8
; GFX1210-NEXT:    s_mul_i32 s12, s0, s7
; GFX1210-NEXT:    s_add_co_ci_u32 s7, s13, s9
; GFX1210-NEXT:    s_add_co_ci_u32 s9, s10, s12
; GFX1210-NEXT:    s_mul_i32 s1, s1, s6
; GFX1210-NEXT:    s_cmp_lg_u32 s11, 0
; GFX1210-NEXT:    s_mul_i32 s2, s2, s5
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s9, s1
; GFX1210-NEXT:    s_mul_i32 s3, s3, s4
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s2
; GFX1210-NEXT:    s_mul_i32 s0, s0, s4
; GFX1210-NEXT:    s_add_co_i32 s3, s1, s3
; GFX1210-NEXT:    s_mov_b32 s1, s8
; GFX1210-NEXT:    s_mov_b32 s2, s7
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i128:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_i32 s9, s0, s6
; GFX1300-NEXT:    s_mul_i32 s11, s1, s5
; GFX1300-NEXT:    s_mul_hi_u32 s10, s0, s6
; GFX1300-NEXT:    s_mul_hi_u32 s12, s1, s5
; GFX1300-NEXT:    s_add_co_u32 s9, s11, s9
; GFX1300-NEXT:    s_mul_i32 s11, s2, s4
; GFX1300-NEXT:    s_add_co_ci_u32 s10, s12, s10
; GFX1300-NEXT:    s_mul_hi_u32 s12, s2, s4
; GFX1300-NEXT:    s_mul_hi_u32 s8, s0, s4
; GFX1300-NEXT:    s_add_co_u32 s9, s11, s9
; GFX1300-NEXT:    s_mul_i32 s11, s0, s5
; GFX1300-NEXT:    s_add_co_ci_u32 s10, s12, s10
; GFX1300-NEXT:    s_mul_hi_u32 s12, s0, s5
; GFX1300-NEXT:    s_add_co_u32 s8, s11, s8
; GFX1300-NEXT:    s_add_co_ci_u32 s9, s12, s9
; GFX1300-NEXT:    s_mul_i32 s12, s1, s4
; GFX1300-NEXT:    s_mul_hi_u32 s13, s1, s4
; GFX1300-NEXT:    s_cselect_b32 s11, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s8, s12, s8
; GFX1300-NEXT:    s_mul_i32 s12, s0, s7
; GFX1300-NEXT:    s_add_co_ci_u32 s7, s13, s9
; GFX1300-NEXT:    s_add_co_ci_u32 s9, s10, s12
; GFX1300-NEXT:    s_mul_i32 s1, s1, s6
; GFX1300-NEXT:    s_cmp_lg_u32 s11, 0
; GFX1300-NEXT:    s_mul_i32 s2, s2, s5
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s9, s1
; GFX1300-NEXT:    s_mul_i32 s3, s3, s4
; GFX1300-NEXT:    s_add_co_i32 s1, s1, s2
; GFX1300-NEXT:    s_mul_i32 s0, s0, s4
; GFX1300-NEXT:    s_add_co_i32 s3, s1, s3
; GFX1300-NEXT:    s_mov_b32 s1, s8
; GFX1300-NEXT:    s_mov_b32 s2, s7
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v8, v0 :: v_dual_mov_b32 v9, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v8, v6, 0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[10:11], v9, v5, v[0:1]
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v8, v4, 0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[10:11], v2, v4, v[10:11]
; GFX1210-NEXT:    v_mov_b32_e32 v12, v1
; GFX1210-NEXT:    v_mul_lo_u32 v1, v9, v6
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v13, v10
; GFX1210-NEXT:    v_mad_co_u64_u32 v[12:13], vcc_lo, v8, v5, v[12:13]
; GFX1210-NEXT:    v_mul_lo_u32 v8, v8, v7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[6:7], s0, v9, v4, v[12:13]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v8, s0, v11, v8, s0
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v8, v1, vcc_lo
; GFX1210-NEXT:    v_mad_u32 v1, v2, v5, v1
...
; GFX1210-NEXT:    s_wait_alu 0xf1fd
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[10:11], v9, v5, v[0:1]
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v8, v4, 0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[10:11], v2, v4, v[10:11]
; GFX1300-NEXT:    v_mov_b32_e32 v12, v1
; GFX1300-NEXT:    v_mul_lo_u32 v1, v9, v6
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mov_b32_e32 v13, v10
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], vcc_lo, v8, v5, v[12:13]
; GFX1300-NEXT:    v_mul_lo_u32 v8, v8, v7
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[6:7], s0, v9, v4, v[12:13]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v8, s0, v11, v8, s0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v8, v1, vcc_lo
; GFX1300-NEXT:    v_mad_u32 v1, v2, v5, v1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mov_b32_e32 v2, v7
; GFX1300-NEXT:    v_mad_u32 v3, v3, v4, v1
; GFX1300-NEXT:    v_mov_b32_e32 v1, v6
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i128 %num, %den
  ret i128 %result
}
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: s_mul_i256:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s17, s0, s10
; GFX1210-NEXT:    s_mul_i32 s19, s1, s9
; GFX1210-NEXT:    s_mul_hi_u32 s18, s0, s10
; GFX1210-NEXT:    s_mul_hi_u32 s20, s1, s9
; GFX1210-NEXT:    s_add_co_u32 s17, s19, s17
; GFX1210-NEXT:    s_add_co_ci_u32 s18, s20, s18
; GFX1210-NEXT:    s_mul_i32 s20, s2, s8
; GFX1210-NEXT:    s_mul_hi_u32 s21, s2, s8
; GFX1210-NEXT:    s_cselect_b32 s19, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s17, s20, s17
; GFX1210-NEXT:    s_mul_hi_u32 s16, s0, s8
; GFX1210-NEXT:    s_add_co_ci_u32 s18, s21, s18
; GFX1210-NEXT:    s_mul_i32 s21, s0, s9
; GFX1210-NEXT:    s_mul_hi_u32 s22, s0, s9
; GFX1210-NEXT:    s_cselect_b32 s20, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s16, s21, s16
; GFX1210-NEXT:    s_add_co_ci_u32 s17, s22, s17
; GFX1210-NEXT:    s_mul_i32 s22, s1, s8
; GFX1210-NEXT:    s_mul_hi_u32 s23, s1, s8
; GFX1210-NEXT:    s_cselect_b32 s21, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s16, s22, s16
; GFX1210-NEXT:    s_add_co_ci_u32 s17, s23, s17
; GFX1210-NEXT:    s_mul_i32 s23, s0, s12
; GFX1210-NEXT:    s_mul_i32 s25, s1, s11
; GFX1210-NEXT:    s_mul_hi_u32 s24, s0, s12
; GFX1210-NEXT:    s_mul_hi_u32 s26, s1, s11
; GFX1210-NEXT:    s_cselect_b32 s22, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s25, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s24, s26, s24
; GFX1210-NEXT:    s_mul_i32 s26, s2, s10
; GFX1210-NEXT:    s_mul_hi_u32 s27, s2, s10
; GFX1210-NEXT:    s_cselect_b32 s25, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s26, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s24, s27, s24
; GFX1210-NEXT:    s_mul_i32 s27, s3, s9
; GFX1210-NEXT:    s_mul_hi_u32 s28, s3, s9
; GFX1210-NEXT:    s_cselect_b32 s26, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s27, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s24, s28, s24
; GFX1210-NEXT:    s_mul_i32 s28, s4, s8
; GFX1210-NEXT:    s_mul_hi_u32 s29, s4, s8
; GFX1210-NEXT:    s_cselect_b32 s27, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s28, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s24, s29, s24
; GFX1210-NEXT:    s_mul_i32 s29, s0, s11
; GFX1210-NEXT:    s_mul_hi_u32 s30, s0, s11
; GFX1210-NEXT:    s_cselect_b32 s28, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s18, s29, s18
; GFX1210-NEXT:    s_add_co_ci_u32 s23, s30, s23
; GFX1210-NEXT:    s_mul_i32 s30, s1, s10
; GFX1210-NEXT:    s_mul_hi_u32 s31, s1, s10
; GFX1210-NEXT:    s_cselect_b32 s29, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s18, s30, s18
; GFX1210-NEXT:    s_add_co_ci_u32 s23, s31, s23
; GFX1210-NEXT:    s_mul_i32 s31, s2, s9
; GFX1210-NEXT:    s_mul_hi_u32 s33, s2, s9
; GFX1210-NEXT:    s_cselect_b32 s30, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s18, s31, s18
; GFX1210-NEXT:    s_add_co_ci_u32 s23, s33, s23
; GFX1210-NEXT:    s_mul_i32 s33, s3, s8
; GFX1210-NEXT:    s_mul_hi_u32 s34, s3, s8
; GFX1210-NEXT:    s_cselect_b32 s31, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s18, s33, s18
; GFX1210-NEXT:    s_add_co_ci_u32 s23, s34, s23
; GFX1210-NEXT:    s_cselect_b32 s33, 1, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s22, 0
; GFX1210-NEXT:    s_mul_hi_u32 s22, s0, s14
; GFX1210-NEXT:    s_add_co_ci_u32 s18, s21, s18
; GFX1210-NEXT:    s_cselect_b32 s21, 1, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s20, 0
; GFX1210-NEXT:    s_mul_hi_u32 s34, s1, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s19, s19, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s21, 0
; GFX1210-NEXT:    s_mul_i32 s21, s0, s14
; GFX1210-NEXT:    s_add_co_ci_u32 s19, s19, s23
; GFX1210-NEXT:    s_mul_i32 s23, s1, s13
; GFX1210-NEXT:    s_cselect_b32 s20, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s2, s12
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s2, s12
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s3, s11
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s3, s11
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s4, s10
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s4, s10
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s5, s9
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s5, s9
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s6, s8
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s6, s8
; GFX1210-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1210-NEXT:    s_mul_i32 s23, s0, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1210-NEXT:    s_mul_hi_u32 s34, s0, s13
; GFX1210-NEXT:    s_add_co_u32 s23, s23, s24
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s34, s21
; GFX1210-NEXT:    s_mul_i32 s34, s1, s12
; GFX1210-NEXT:    s_mul_hi_u32 s35, s1, s12
; GFX1210-NEXT:    s_cselect_b32 s24, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s34, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s35, s21
; GFX1210-NEXT:    s_mul_i32 s35, s2, s11
; GFX1210-NEXT:    s_mul_hi_u32 s36, s2, s11
; GFX1210-NEXT:    s_cselect_b32 s34, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s35, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s36, s21
; GFX1210-NEXT:    s_mul_i32 s36, s3, s10
; GFX1210-NEXT:    s_mul_hi_u32 s37, s3, s10
; GFX1210-NEXT:    s_cselect_b32 s35, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s36, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s37, s21
; GFX1210-NEXT:    s_mul_i32 s37, s4, s9
; GFX1210-NEXT:    s_mul_hi_u32 s38, s4, s9
; GFX1210-NEXT:    s_cselect_b32 s36, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s37, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s38, s21
; GFX1210-NEXT:    s_mul_i32 s38, s5, s8
; GFX1210-NEXT:    s_mul_hi_u32 s39, s5, s8
; GFX1210-NEXT:    s_cselect_b32 s37, 1, 0
; GFX1210-NEXT:    s_add_co_u32 s23, s38, s23
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s39, s21
; GFX1210-NEXT:    s_cselect_b32 s38, 1, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s30, 0
; GFX1210-NEXT:    s_mul_i32 s1, s1, s14
; GFX1210-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s31, 0
; GFX1210-NEXT:    s_mul_i32 s2, s2, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s33, 0
; GFX1210-NEXT:    s_mul_i32 s3, s3, s12
; GFX1210-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s20, 0
; GFX1210-NEXT:    s_mul_i32 s4, s4, s11
; GFX1210-NEXT:    s_add_co_ci_u32 s20, s29, s23
; GFX1210-NEXT:    s_cselect_b32 s23, 1, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s26, 0
; GFX1210-NEXT:    s_mul_i32 s26, s0, s15
; GFX1210-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s27, 0
; GFX1210-NEXT:    s_mul_i32 s5, s5, s10
; GFX1210-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s28, 0
; GFX1210-NEXT:    s_mul_i32 s6, s6, s9
; GFX1210-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s23, 0
; GFX1210-NEXT:    s_mul_i32 s7, s7, s8
; GFX1210-NEXT:    s_add_co_ci_u32 s15, s25, s21
; GFX1210-NEXT:    s_add_co_ci_u32 s21, s22, s26
; GFX1210-NEXT:    s_cmp_lg_u32 s38, 0
; GFX1210-NEXT:    s_mul_i32 s0, s0, s8
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s21, s1
; GFX1210-NEXT:    s_cmp_lg_u32 s37, 0
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s1, s2
; GFX1210-NEXT:    s_cmp_lg_u32 s36, 0
; GFX1210-NEXT:    s_mov_b32 s2, s17
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s1, s3
; GFX1210-NEXT:    s_cmp_lg_u32 s35, 0
; GFX1210-NEXT:    s_mov_b32 s3, s18
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s1, s4
; GFX1210-NEXT:    s_cmp_lg_u32 s34, 0
; GFX1210-NEXT:    s_mov_b32 s4, s19
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s1, s5
; GFX1210-NEXT:    s_cmp_lg_u32 s24, 0
; GFX1210-NEXT:    s_mov_b32 s5, s20
; GFX1210-NEXT:    s_add_co_ci_u32 s1, s1, s6
; GFX1210-NEXT:    s_mov_b32 s6, s15
; GFX1210-NEXT:    s_add_co_i32 s7, s1, s7
; GFX1210-NEXT:    s_mov_b32 s1, s16
; GFX1210-NEXT:    ; return to shader part epilog
;
; GFX1300-LABEL: s_mul_i256:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_mul_i32 s17, s0, s10
; GFX1300-NEXT:    s_mul_i32 s19, s1, s9
; GFX1300-NEXT:    s_mul_hi_u32 s18, s0, s10
; GFX1300-NEXT:    s_mul_hi_u32 s20, s1, s9
; GFX1300-NEXT:    s_add_co_u32 s17, s19, s17
; GFX1300-NEXT:    s_add_co_ci_u32 s18, s20, s18
; GFX1300-NEXT:    s_mul_i32 s20, s2, s8
; GFX1300-NEXT:    s_mul_hi_u32 s21, s2, s8
; GFX1300-NEXT:    s_cselect_b32 s19, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s17, s20, s17
; GFX1300-NEXT:    s_mul_hi_u32 s16, s0, s8
; GFX1300-NEXT:    s_add_co_ci_u32 s18, s21, s18
; GFX1300-NEXT:    s_mul_i32 s21, s0, s9
; GFX1300-NEXT:    s_mul_hi_u32 s22, s0, s9
; GFX1300-NEXT:    s_cselect_b32 s20, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s16, s21, s16
; GFX1300-NEXT:    s_add_co_ci_u32 s17, s22, s17
; GFX1300-NEXT:    s_mul_i32 s22, s1, s8
; GFX1300-NEXT:    s_mul_hi_u32 s23, s1, s8
; GFX1300-NEXT:    s_cselect_b32 s21, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s16, s22, s16
; GFX1300-NEXT:    s_add_co_ci_u32 s17, s23, s17
; GFX1300-NEXT:    s_mul_i32 s23, s0, s12
; GFX1300-NEXT:    s_mul_i32 s25, s1, s11
; GFX1300-NEXT:    s_mul_hi_u32 s24, s0, s12
; GFX1300-NEXT:    s_mul_hi_u32 s26, s1, s11
; GFX1300-NEXT:    s_cselect_b32 s22, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s25, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s24, s26, s24
; GFX1300-NEXT:    s_mul_i32 s26, s2, s10
; GFX1300-NEXT:    s_mul_hi_u32 s27, s2, s10
; GFX1300-NEXT:    s_cselect_b32 s25, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s26, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s24, s27, s24
; GFX1300-NEXT:    s_mul_i32 s27, s3, s9
; GFX1300-NEXT:    s_mul_hi_u32 s28, s3, s9
; GFX1300-NEXT:    s_cselect_b32 s26, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s27, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s24, s28, s24
; GFX1300-NEXT:    s_mul_i32 s28, s4, s8
; GFX1300-NEXT:    s_mul_hi_u32 s29, s4, s8
; GFX1300-NEXT:    s_cselect_b32 s27, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s28, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s24, s29, s24
; GFX1300-NEXT:    s_mul_i32 s29, s0, s11
; GFX1300-NEXT:    s_mul_hi_u32 s30, s0, s11
; GFX1300-NEXT:    s_cselect_b32 s28, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s18, s29, s18
; GFX1300-NEXT:    s_add_co_ci_u32 s23, s30, s23
; GFX1300-NEXT:    s_mul_i32 s30, s1, s10
; GFX1300-NEXT:    s_mul_hi_u32 s31, s1, s10
; GFX1300-NEXT:    s_cselect_b32 s29, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s18, s30, s18
; GFX1300-NEXT:    s_add_co_ci_u32 s23, s31, s23
; GFX1300-NEXT:    s_mul_i32 s31, s2, s9
; GFX1300-NEXT:    s_mul_hi_u32 s33, s2, s9
; GFX1300-NEXT:    s_cselect_b32 s30, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s18, s31, s18
; GFX1300-NEXT:    s_add_co_ci_u32 s23, s33, s23
; GFX1300-NEXT:    s_mul_i32 s33, s3, s8
; GFX1300-NEXT:    s_mul_hi_u32 s34, s3, s8
; GFX1300-NEXT:    s_cselect_b32 s31, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s18, s33, s18
; GFX1300-NEXT:    s_add_co_ci_u32 s23, s34, s23
; GFX1300-NEXT:    s_cselect_b32 s33, 1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s22, 0
; GFX1300-NEXT:    s_mul_hi_u32 s22, s0, s14
; GFX1300-NEXT:    s_add_co_ci_u32 s18, s21, s18
; GFX1300-NEXT:    s_cselect_b32 s21, 1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s20, 0
; GFX1300-NEXT:    s_mul_hi_u32 s34, s1, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s19, s19, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s21, 0
; GFX1300-NEXT:    s_mul_i32 s21, s0, s14
; GFX1300-NEXT:    s_add_co_ci_u32 s19, s19, s23
; GFX1300-NEXT:    s_mul_i32 s23, s1, s13
; GFX1300-NEXT:    s_cselect_b32 s20, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s2, s12
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s2, s12
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s3, s11
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s3, s11
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s4, s10
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s4, s10
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s5, s9
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s5, s9
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s6, s8
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s6, s8
; GFX1300-NEXT:    s_add_co_u32 s21, s23, s21
; GFX1300-NEXT:    s_mul_i32 s23, s0, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s22, s34, s22
; GFX1300-NEXT:    s_mul_hi_u32 s34, s0, s13
; GFX1300-NEXT:    s_add_co_u32 s23, s23, s24
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s34, s21
; GFX1300-NEXT:    s_mul_i32 s34, s1, s12
; GFX1300-NEXT:    s_mul_hi_u32 s35, s1, s12
; GFX1300-NEXT:    s_cselect_b32 s24, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s34, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s35, s21
; GFX1300-NEXT:    s_mul_i32 s35, s2, s11
; GFX1300-NEXT:    s_mul_hi_u32 s36, s2, s11
; GFX1300-NEXT:    s_cselect_b32 s34, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s35, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s36, s21
; GFX1300-NEXT:    s_mul_i32 s36, s3, s10
; GFX1300-NEXT:    s_mul_hi_u32 s37, s3, s10
; GFX1300-NEXT:    s_cselect_b32 s35, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s36, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s37, s21
; GFX1300-NEXT:    s_mul_i32 s37, s4, s9
; GFX1300-NEXT:    s_mul_hi_u32 s38, s4, s9
; GFX1300-NEXT:    s_cselect_b32 s36, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s37, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s38, s21
; GFX1300-NEXT:    s_mul_i32 s38, s5, s8
; GFX1300-NEXT:    s_mul_hi_u32 s39, s5, s8
; GFX1300-NEXT:    s_cselect_b32 s37, 1, 0
; GFX1300-NEXT:    s_add_co_u32 s23, s38, s23
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s39, s21
; GFX1300-NEXT:    s_cselect_b32 s38, 1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s30, 0
; GFX1300-NEXT:    s_mul_i32 s1, s1, s14
; GFX1300-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s31, 0
; GFX1300-NEXT:    s_mul_i32 s2, s2, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s33, 0
; GFX1300-NEXT:    s_mul_i32 s3, s3, s12
; GFX1300-NEXT:    s_add_co_ci_u32 s29, s29, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s20, 0
; GFX1300-NEXT:    s_mul_i32 s4, s4, s11
; GFX1300-NEXT:    s_add_co_ci_u32 s20, s29, s23
; GFX1300-NEXT:    s_cselect_b32 s23, 1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s26, 0
; GFX1300-NEXT:    s_mul_i32 s26, s0, s15
; GFX1300-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s27, 0
; GFX1300-NEXT:    s_mul_i32 s5, s5, s10
; GFX1300-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s28, 0
; GFX1300-NEXT:    s_mul_i32 s6, s6, s9
; GFX1300-NEXT:    s_add_co_ci_u32 s25, s25, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s23, 0
; GFX1300-NEXT:    s_mul_i32 s7, s7, s8
; GFX1300-NEXT:    s_add_co_ci_u32 s15, s25, s21
; GFX1300-NEXT:    s_add_co_ci_u32 s21, s22, s26
; GFX1300-NEXT:    s_cmp_lg_u32 s38, 0
; GFX1300-NEXT:    s_mul_i32 s0, s0, s8
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s21, s1
; GFX1300-NEXT:    s_cmp_lg_u32 s37, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s1, s2
; GFX1300-NEXT:    s_cmp_lg_u32 s36, 0
; GFX1300-NEXT:    s_mov_b32 s2, s17
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s1, s3
; GFX1300-NEXT:    s_cmp_lg_u32 s35, 0
; GFX1300-NEXT:    s_mov_b32 s3, s18
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s1, s4
; GFX1300-NEXT:    s_cmp_lg_u32 s34, 0
; GFX1300-NEXT:    s_mov_b32 s4, s19
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s1, s5
; GFX1300-NEXT:    s_cmp_lg_u32 s24, 0
; GFX1300-NEXT:    s_mov_b32 s5, s20
; GFX1300-NEXT:    s_add_co_ci_u32 s1, s1, s6
; GFX1300-NEXT:    s_mov_b32 s6, s15
; GFX1300-NEXT:    s_add_co_i32 s7, s1, s7
; GFX1300-NEXT:    s_mov_b32 s1, s16
; GFX1300-NEXT:    ; return to shader part epilog
...
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v16, v0 :: v_dual_mov_b32 v17, v1
; GFX1210-NEXT:    v_mul_lo_u32 v27, v5, v10
; GFX1210-NEXT:    v_mul_lo_u32 v29, v3, v12
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v16, v14, 0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[18:19], v16, v12, 0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v17, v13, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], s0, v17, v11, v[18:19]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v2, v12, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v2, v10, v[18:19]
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v22, vcc_lo, 0, v20, vcc_lo
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[20:21], v16, v10, 0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v3, v11, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v3, v9, v[18:19]
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v24, vcc_lo, 0, v22, vcc_lo
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v4, v10, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v4, v8, v[18:19]
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v26, vcc_lo, 0, v24, vcc_lo
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v5, v9, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[22:23], v6, v8, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v9, v[20:21]
; GFX1210-NEXT:    v_dual_mov_b32 v20, v19 :: v_dual_mov_b32 v21, v22
; GFX1210-NEXT:    v_mul_lo_u32 v22, v6, v9
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[24:25], s0, v2, v8, v[0:1]
; GFX1210-NEXT:    v_mad_co_u64_u32 v[20:21], vcc_lo, v16, v13, v[20:21]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v6, s0, 0, v6, s0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v12, v[20:21]
; GFX1210-NEXT:    v_dual_mov_b32 v20, v25 :: v_dual_mov_b32 v21, v18
; GFX1210-NEXT:    v_mul_lo_u32 v25, v4, v11
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], s2, v16, v11, v[20:21]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v28, 0, 1, s2
; GFX1210-NEXT:    v_mad_co_u64_u32 v[20:21], s1, v2, v11, v[0:1]
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[0:1], v16, v8, 0
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], s2, v17, v10, v[18:19]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[10:11], s3, v3, v10, v[20:21]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v21, s2, 0, v28, s2
; GFX1210-NEXT:    v_mul_lo_u32 v20, v2, v13
; GFX1210-NEXT:    v_mad_co_u64_u32 v[12:13], s2, v2, v9, v[18:19]
; GFX1210-NEXT:    v_dual_mov_b32 v18, v1 :: v_dual_mov_b32 v19, v24
; GFX1210-NEXT:    v_mad_co_u64_u32 v[10:11], s4, v4, v9, v[10:11]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, 0, v21, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1210-NEXT:    v_mad_co_u64_u32 v[18:19], s6, v16, v9, v[18:19]
; GFX1210-NEXT:    v_mul_lo_u32 v2, v16, v15
; GFX1210-NEXT:    v_mad_co_u64_u32 v[12:13], s2, v3, v8, v[12:13]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s6
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, 0, v1, s2
; GFX1210-NEXT:    v_mad_co_u64_u32 v[10:11], s5, v5, v8, v[10:11]
; GFX1210-NEXT:    v_mul_lo_u32 v9, v17, v14
; GFX1210-NEXT:    v_mad_co_u64_u32 v[14:15], s2, v17, v8, v[18:19]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v3, s2, v3, v12, s2
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v4, s2, v6, v13, s2
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v5, s2, v1, v10, s2
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v6, s2, v26, v11, s2
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v23, v2, s2
; GFX1210-NEXT:    v_mov_b32_e32 v2, v15
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v9, s5
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v20, s4
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v29, s3
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s1, v1, v25, s1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_ci_u32_e64 v1, s0, v1, v27, s0
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v22, vcc_lo
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1300-NEXT:    v_mul_lo_u32 v29, v3, v12
; GFX1300-NEXT:    v_mul_lo_u32 v28, v5, v10
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v16, v14, 0
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[18:19], v16, v12, 0
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v17, v13, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], s0, v17, v11, v[18:19]
; GFX1300-NEXT:    v_cndmask_b32_e64 v20, 0, 1, s0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v2, v12, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v2, v10, v[18:19]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v22, vcc_lo, 0, v20, vcc_lo
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[20:21], v16, v10, 0
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v3, v11, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v3, v9, v[18:19]
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v24, vcc_lo, 0, v22, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v4, v10, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v4, v8, v[18:19]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v27, vcc_lo, 0, v24, vcc_lo
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v5, v9, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[22:23], v6, v8, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v17, v9, v[20:21]
; GFX1300-NEXT:    v_mov_b32_e32 v20, v19
; GFX1300-NEXT:    v_cndmask_b32_e64 v26, 0, 1, s0
; GFX1300-NEXT:    v_mov_b32_e32 v21, v22
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[24:25], vcc_lo, v2, v8, v[0:1]
; GFX1300-NEXT:    v_mul_lo_u32 v22, v6, v9
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, 0, v26, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[0:1], s0, v16, v13, v[20:21]
; GFX1300-NEXT:    v_dual_mov_b32 v21, v18 :: v_dual_mov_b32 v20, v25
; GFX1300-NEXT:    v_mul_lo_u32 v25, v16, v15
; GFX1300-NEXT:    v_mul_lo_u32 v26, v17, v14
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], vcc_lo, v17, v12, v[0:1]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s2, v16, v11, v[20:21]
; GFX1300-NEXT:    v_mad_nc_u64_u32 v[0:1], v16, v8, 0
; GFX1300-NEXT:    v_mul_lo_u32 v21, v2, v13
; GFX1300-NEXT:    v_cndmask_b32_e64 v30, 0, 1, s2
; GFX1300-NEXT:    v_mul_lo_u32 v20, v4, v11
; GFX1300-NEXT:    v_mad_co_u64_u32 v[18:19], s1, v2, v11, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], s2, v17, v10, v[14:15]
; GFX1300-NEXT:    v_dual_mov_b32 v14, v1 :: v_dual_mov_b32 v15, v24
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s2, 0, v30, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_mad_co_u64_u32 v[10:11], s3, v3, v10, v[18:19]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], s2, v2, v9, v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s2, 0, v1, s2
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s4, v16, v9, v[14:15]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[10:11], s2, v4, v9, v[10:11]
; GFX1300-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[12:13], s4, v3, v8, v[12:13]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s4, 0, v1, s4
; GFX1300-NEXT:    v_mad_co_u64_u32 v[14:15], s5, v17, v8, v[14:15]
; GFX1300-NEXT:    v_mad_co_u64_u32 v[10:11], s4, v5, v8, v[10:11]
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v3, s5, v2, v12, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v4, s5, v6, v13, s5
; GFX1300-NEXT:    v_mov_b32_e32 v2, v15
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v5, s5, v1, v10, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v6, s5, v27, v11, s5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s5, v23, v25, s5
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s4, v1, v26, s4
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v21, s2
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s2, v1, v29, s3
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, s1, v1, v20, s1
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v28, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e64 v1, vcc_lo, v1, v22, s0
; GFX1300-NEXT:    v_mad_u32 v7, v7, v8, v1
; GFX1300-NEXT:    v_mov_b32_e32 v1, v14
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i256 %num, %den
  ret i256 %result
}
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_mul_u64_zext_with_vregs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    global_load_b32 v2, v[2:3], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_mad_nc_u64_u32 v[2:3], 0x50, v2, 0
; GFX1210-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: s_mul_u64_zext_with_vregs:
; GFX1300:       ; %bb.0:
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_mul_u64_zext_with_sregs:
; GFX1210:       ; %bb.0:
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: s_mul_u64_zext_with_sregs:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_mul_u64_sext_with_vregs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    global_load_b32 v2, v[2:3], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_mad_nc_i64_i32 v[2:3], 0x50, v2, 0
; GFX1210-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: s_mul_u64_sext_with_vregs:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    global_load_b32 v2, v[2:3], off
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_mul_u64_sext_with_sregs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1300-LABEL: s_mul_u64_sext_with_sregs:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
