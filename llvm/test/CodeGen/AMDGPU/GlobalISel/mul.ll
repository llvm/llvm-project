...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mul_i32 s6, s0, s5
; GFX11-NEXT:    s_mul_i32 s7, s1, s4
; GFX11-NEXT:    s_mul_i32 s2, s2, s3
; GFX11-NEXT:    s_add_i32 s6, s6, s7
; GFX11-NEXT:    s_mul_hi_u32 s7, s0, s3
; GFX11-NEXT:    s_add_i32 s6, s6, s2
; GFX11-NEXT:    s_mul_i32 s2, s0, s4
; GFX11-NEXT:    s_mul_i32 s5, s0, s3
; GFX11-NEXT:    s_mul_hi_u32 s0, s0, s4
; GFX11-NEXT:    s_add_u32 s2, s2, s7
; GFX11-NEXT:    s_mul_i32 s4, s1, s3
; GFX11-NEXT:    s_addc_u32 s0, s0, s6
; GFX11-NEXT:    s_mul_hi_u32 s3, s1, s3
; GFX11-NEXT:    s_add_u32 s1, s4, s2
; GFX11-NEXT:    s_addc_u32 s2, s3, s0
; GFX11-NEXT:    s_mov_b32 s0, s5
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s0, v6, v3, 0
; GFX11-NEXT:    v_add3_u32 v2, v5, v8, v2
; GFX11-NEXT:    v_mad_u64_u32 v[1:2], s0, v6, v4, v[1:2]
; GFX11-NEXT:    v_mad_u64_u32 v[1:2], s0, v7, v3, v[1:2]
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %result = mul i96 %num, %den
  ret i96 %result
}
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_mul_i32 s9, s0, s6
; GFX11-NEXT:    s_mul_i32 s11, s1, s5
; GFX11-NEXT:    s_mul_hi_u32 s10, s0, s6
; GFX11-NEXT:    s_mul_hi_u32 s12, s1, s5
; GFX11-NEXT:    s_add_u32 s9, s11, s9
; GFX11-NEXT:    s_mul_i32 s11, s2, s4
; GFX11-NEXT:    s_addc_u32 s10, s12, s10
; GFX11-NEXT:    s_mul_hi_u32 s12, s2, s4
; GFX11-NEXT:    s_mul_hi_u32 s8, s0, s4
; GFX11-NEXT:    s_add_u32 s9, s11, s9
; GFX11-NEXT:    s_mul_i32 s11, s0, s5
; GFX11-NEXT:    s_addc_u32 s10, s12, s10
; GFX11-NEXT:    s_mul_hi_u32 s12, s0, s5
; GFX11-NEXT:    s_add_u32 s8, s11, s8
; GFX11-NEXT:    s_addc_u32 s9, s12, s9
; GFX11-NEXT:    s_mul_i32 s12, s1, s4
; GFX11-NEXT:    s_mul_hi_u32 s13, s1, s4
; GFX11-NEXT:    s_cselect_b32 s11, 1, 0
; GFX11-NEXT:    s_add_u32 s8, s12, s8
; GFX11-NEXT:    s_mul_i32 s12, s0, s7
; GFX11-NEXT:    s_addc_u32 s7, s13, s9
; GFX11-NEXT:    s_addc_u32 s9, s10, s12
; GFX11-NEXT:    s_mul_i32 s1, s1, s6
; GFX11-NEXT:    s_cmp_lg_u32 s11, 0
; GFX11-NEXT:    s_mul_i32 s2, s2, s5
; GFX11-NEXT:    s_addc_u32 s1, s9, s1
; GFX11-NEXT:    s_mul_i32 s3, s3, s4
; GFX11-NEXT:    s_add_i32 s1, s1, s2
; GFX11-NEXT:    s_mul_i32 s0, s0, s4
; GFX11-NEXT:    s_add_i32 s3, s1, s3
; GFX11-NEXT:    s_mov_b32 s1, s8
; GFX11-NEXT:    s_mov_b32 s2, s7
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s0, v8, v6, 0
; GFX11-NEXT:    v_mul_lo_u32 v7, v8, v7
; GFX11-NEXT:    v_mul_lo_u32 v6, v9, v6
; GFX11-NEXT:    v_mad_u64_u32 v[11:12], s0, v9, v5, v[0:1]
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s0, v8, v4, 0
; GFX11-NEXT:    v_mad_u64_u32 v[11:12], s0, v10, v4, v[11:12]
...
; GFX11-NEXT:    s_addc_u32 s19, s19, s23
...
; GFX11-NEXT:    s_addc_u32 s20, s29, s23
; GFX11-NEXT:    s_cselect_b32 s23, 1, 0
; GFX11-NEXT:    s_cmp_lg_u32 s26, 0
; GFX11-NEXT:    s_mul_i32 s26, s0, s15
...
; GFX11-NEXT:    s_addc_u32 s15, s25, s21
; GFX11-NEXT:    s_addc_u32 s21, s22, s26
; GFX11-NEXT:    s_cmp_lg_u32 s38, 0
; GFX11-NEXT:    s_mul_i32 s0, s0, s8
; GFX11-NEXT:    s_addc_u32 s1, s21, s1
...
; GFX11-NEXT:    v_mad_u64_u32 v[0:1], s1, v16, v8, 0
