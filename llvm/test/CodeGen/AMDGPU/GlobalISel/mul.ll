...
; GFX8-NEXT:    v_mul_lo_u16_e32 v0, s0, v0
...
; GFX1250-NEXT:    v_mul_lo_u16 v0, s0, s1
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-LABEL: s_mul_i16_zeroext:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, s0, s1
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX11-FAKE16-LABEL: s_mul_i16_zeroext:
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v0, s0, s1
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-LABEL: s_mul_i16_signext:
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, s0, s1
; GFX11-TRUE16-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX11-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX11-FAKE16-LABEL: s_mul_i16_signext:
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v0, s0, s1
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s0, v0
...
; GFX8-NEXT:    v_mul_lo_u16_e32 v0, s2, v0
...
; GFX9-NEXT:    v_pk_mul_lo_u16 v0, v0, s1
; GFX9-NEXT:    v_readfirstlane_b32 s0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX7-NEXT:    v_mul_u32_u24_e32 v1, v1, v2
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
