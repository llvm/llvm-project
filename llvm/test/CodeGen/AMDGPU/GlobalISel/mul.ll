...
; GFX13-NEXT:    v_add_co_ci_u32_e64 v6, null, v3, v6, vcc_lo
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_mad_co_u64_u32 v[5:6], null, v10, v5, v[6:7]
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v9, null, v7, v27, vcc_lo
; GFX13-NEXT:    v_mad_co_u64_u32 v[7:8], null, v22, v8, v[9:10]
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
  %result = mul i256 %num, %den
  ret i256 %result
}
