...
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-- -mcpu=tahiti < %s | FileCheck -check-prefixes=GCN,SI %s
; RUN: llc -global-isel -global-isel-abort=2 -mtriple=amdgcn-- -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,VI %s
