...
; RUN: llc -global-isel -mtriple=amdgpu9.0a-amd-amdpal -o - %s | FileCheck --check-prefix=GFX90A %s
; RUN: llc -global-isel -mtriple=amdgpu11.00-amd-amdpal -o - %s | FileCheck --check-prefix=GFX11 %s
