...
; GFX6-SDAG-NEXT:    v_mov_b32_e32 v15, 0xffffff80
...
; GFX6-SDAG-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[2:3]
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v14, vcc
; GFX6-SDAG-NEXT:    v_ldexp_f64 v[2:3], v[2:3], v6
; GFX6-SDAG-NEXT:    v_rsq_f64_e32 v[6:7], v[2:3]
; GFX6-SDAG-NEXT:    v_mul_f64 v[8:9], v[2:3], v[6:7]
; GFX6-SDAG-NEXT:    v_mul_f64 v[6:7], v[6:7], 0.5
; GFX6-SDAG-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 0.5
; GFX6-SDAG-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; GFX6-SDAG-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX6-SDAG-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[8:9], v[2:3]
; GFX6-SDAG-NEXT:    v_fma_f64 v[8:9], v[12:13], v[6:7], v[8:9]
; GFX6-SDAG-NEXT:    v_fma_f64 v[10:11], -v[8:9], v[8:9], v[2:3]
; GFX6-SDAG-NEXT:    v_fma_f64 v[6:7], v[10:11], v[6:7], v[8:9]
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v8, 0, v15, vcc
; GFX6-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, v[2:3], v16
; GFX6-SDAG-NEXT:    v_ldexp_f64 v[6:7], v[6:7], v8
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v2, v6, v2, vcc
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v3, v7, v3, vcc
; GFX6-SDAG-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[4:5]
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v14, vcc
; GFX6-SDAG-NEXT:    v_ldexp_f64 v[4:5], v[4:5], v6
; GFX6-SDAG-NEXT:    v_rsq_f64_e32 v[6:7], v[4:5]
; GFX6-SDAG-NEXT:    v_mul_f64 v[8:9], v[4:5], v[6:7]
; GFX6-SDAG-NEXT:    v_mul_f64 v[6:7], v[6:7], 0.5
; GFX6-SDAG-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 0.5
; GFX6-SDAG-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; GFX6-SDAG-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX6-SDAG-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[8:9], v[4:5]
; GFX6-SDAG-NEXT:    v_fma_f64 v[8:9], v[12:13], v[6:7], v[8:9]
; GFX6-SDAG-NEXT:    v_fma_f64 v[10:11], -v[8:9], v[8:9], v[4:5]
; GFX6-SDAG-NEXT:    v_fma_f64 v[6:7], v[10:11], v[6:7], v[8:9]
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v8, 0, v15, vcc
; GFX6-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, v[4:5], v16
; GFX6-SDAG-NEXT:    v_ldexp_f64 v[6:7], v[6:7], v8
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v4, v6, v4, vcc
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v5, v7, v5, vcc
; GFX6-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG-NEXT:    v_mov_b32_e32 v15, 0xffffff80
...
; GFX8-SDAG-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[2:3]
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v14, vcc
; GFX8-SDAG-NEXT:    v_ldexp_f64 v[2:3], v[2:3], v6
; GFX8-SDAG-NEXT:    v_rsq_f64_e32 v[6:7], v[2:3]
; GFX8-SDAG-NEXT:    v_mul_f64 v[8:9], v[2:3], v[6:7]
; GFX8-SDAG-NEXT:    v_mul_f64 v[6:7], v[6:7], 0.5
; GFX8-SDAG-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 0.5
; GFX8-SDAG-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; GFX8-SDAG-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX8-SDAG-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[8:9], v[2:3]
; GFX8-SDAG-NEXT:    v_fma_f64 v[8:9], v[12:13], v[6:7], v[8:9]
; GFX8-SDAG-NEXT:    v_fma_f64 v[10:11], -v[8:9], v[8:9], v[2:3]
; GFX8-SDAG-NEXT:    v_fma_f64 v[6:7], v[10:11], v[6:7], v[8:9]
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v8, 0, v15, vcc
; GFX8-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, v[2:3], v16
; GFX8-SDAG-NEXT:    v_ldexp_f64 v[6:7], v[6:7], v8
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v2, v6, v2, vcc
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v3, v7, v3, vcc
; GFX8-SDAG-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[4:5]
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v14, vcc
; GFX8-SDAG-NEXT:    v_ldexp_f64 v[4:5], v[4:5], v6
; GFX8-SDAG-NEXT:    v_rsq_f64_e32 v[6:7], v[4:5]
; GFX8-SDAG-NEXT:    v_mul_f64 v[8:9], v[4:5], v[6:7]
; GFX8-SDAG-NEXT:    v_mul_f64 v[6:7], v[6:7], 0.5
; GFX8-SDAG-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 0.5
; GFX8-SDAG-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; GFX8-SDAG-NEXT:    v_fma_f64 v[6:7], v[6:7], v[10:11], v[6:7]
; GFX8-SDAG-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[8:9], v[4:5]
; GFX8-SDAG-NEXT:    v_fma_f64 v[8:9], v[12:13], v[6:7], v[8:9]
; GFX8-SDAG-NEXT:    v_fma_f64 v[10:11], -v[8:9], v[8:9], v[4:5]
; GFX8-SDAG-NEXT:    v_fma_f64 v[6:7], v[10:11], v[6:7], v[8:9]
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v8, 0, v15, vcc
; GFX8-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, v[4:5], v16
; GFX8-SDAG-NEXT:    v_ldexp_f64 v[6:7], v[6:7], v8
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v4, v6, v4, vcc
; GFX8-SDAG-NEXT:    v_cndmask_b32_e32 v5, v7, v5, vcc
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
