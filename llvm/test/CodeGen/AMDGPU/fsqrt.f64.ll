...
; RUN: llc -global-isel=0 -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=GFX6,GFX6-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GFX8,GFX8-SDAG %s

; RUN: llc -global-isel=1 -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=GFX6,GFX6-GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=GFX8,GFX8-GISEL %s
