...
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50--amdpal < %s | FileCheck %s --check-prefix=GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50--amdpal < %s | FileCheck %s --check-prefix=DAGISEL
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50--amdpal < %s | FileCheck %s --check-prefix=NRBS
