; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 -verify-machineinstrs %s -o - | FileCheck %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 -global-isel -verify-machineinstrs %s -o - | FileCheck %s
