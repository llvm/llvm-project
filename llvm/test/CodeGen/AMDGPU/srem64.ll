...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v3, v7, v3, vcc
...
; GCN-IR-NEXT:    v_cndmask_b32_e32 v12, v8, v7, vcc
...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v11, v1, 0, s[6:7]
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[8:9], s[4:5]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v10, v0, 0, s[6:7]
...
; GCN-IR-NEXT:    v_lshr_b64 v[16:17], v[0:1], v14
; GCN-IR-NEXT:    v_add_i32_e32 v14, vcc, -1, v5
; GCN-IR-NEXT:    v_addc_u32_e32 v15, vcc, -1, v6, vcc
; GCN-IR-NEXT:    v_not_b32_e32 v3, v3
; GCN-IR-NEXT:    v_mov_b32_e32 v18, 0
; GCN-IR-NEXT:    v_not_b32_e32 v9, v9
; GCN-IR-NEXT:    v_add_i32_e32 v12, vcc, v3, v12
; GCN-IR-NEXT:    v_addc_u32_e32 v13, vcc, v9, v13, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v3, v16, v3
; GCN-IR-NEXT:    v_lshl_b64 v[7:8], v[7:8], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v9, vcc, v14, v3
; GCN-IR-NEXT:    v_subb_u32_e32 v9, vcc, v15, v17, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v7, v18, v7
; GCN-IR-NEXT:    v_add_i32_e32 v18, vcc, 1, v12
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v9, 31, v9
...
; GCN-IR-NEXT:    v_mov_b32_e32 v11, 0
; GCN-IR-NEXT:    v_and_b32_e32 v10, 1, v9
; GCN-IR-NEXT:    v_and_b32_e32 v20, v9, v6
; GCN-IR-NEXT:    v_and_b32_e32 v9, v9, v5
; GCN-IR-NEXT:    v_sub_i32_e64 v16, s[4:5], v3, v9
...
; GCN-IR-NEXT:    v_lshl_b64 v[7:8], v[7:8], 1
; GCN-IR-NEXT:    v_or_b32_e32 v11, v11, v8
; GCN-IR-NEXT:    v_or_b32_e32 v10, v10, v7
; GCN-IR-NEXT:  BB1_6: ; %Flow4
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_mul_lo_u32 v3, v5, v11
; GCN-IR-NEXT:    v_mul_hi_u32 v7, v5, v10
; GCN-IR-NEXT:    v_mul_lo_u32 v6, v6, v10
; GCN-IR-NEXT:    v_mul_lo_u32 v5, v5, v10
...
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v1
; GCN-IR-NEXT:    v_cndmask_b32_e32 v6, v3, v2, vcc
...
; GCN-IR-NEXT:    v_mov_b32_e32 v5, v8
; GCN-IR-NEXT:    s_and_b64 s[4:5], s[4:5], vcc
; GCN-IR-NEXT:    s_and_saveexec_b64 s[6:7], s[4:5]
; GCN-IR-NEXT:    s_cbranch_execz BB11_6
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    v_add_i32_e32 v9, vcc, 1, v2
; GCN-IR-NEXT:    v_addc_u32_e32 v10, vcc, 0, v3, vcc
; GCN-IR-NEXT:    v_cmp_ge_u64_e32 vcc, v[9:10], v[2:3]
...
; GCN-IR-NEXT:    v_lshr_b64 v[12:13], 24, v9
; GCN-IR-NEXT:    v_addc_u32_e32 v9, vcc, -1, v1, vcc
; GCN-IR-NEXT:    v_sub_i32_e32 v10, vcc, 58, v6
; GCN-IR-NEXT:    v_mov_b32_e32 v14, 0
; GCN-IR-NEXT:    v_subb_u32_e32 v11, vcc, 0, v8, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v6, v12, v4
; GCN-IR-NEXT:    v_lshl_b64 v[2:3], v[2:3], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v4, vcc, v7, v6
; GCN-IR-NEXT:    v_subb_u32_e32 v4, vcc, v9, v13, vcc
...
; GCN-IR-NEXT:    v_and_b32_e32 v16, v8, v1
; GCN-IR-NEXT:    v_and_b32_e32 v8, v8, v0
; GCN-IR-NEXT:    v_sub_i32_e64 v12, s[4:5], v6, v8
; GCN-IR-NEXT:    v_mov_b32_e32 v11, v15
; GCN-IR-NEXT:    v_mov_b32_e32 v15, v5
; GCN-IR-NEXT:    v_subb_u32_e64 v13, s[4:5], v13, v16, s[4:5]
; GCN-IR-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
; GCN-IR-NEXT:    v_mov_b32_e32 v14, v4
; GCN-IR-NEXT:    s_andn2_b64 exec, exec, s[8:9]
