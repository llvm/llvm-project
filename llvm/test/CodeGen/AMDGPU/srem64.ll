...
; GCN-NEXT:    s_ashr_i32 s12, s8, 30
; GCN-NEXT:    s_xor_b32 s8, s4, s5
; GCN-NEXT:    s_mov_b32 s1, s9
; GCN-NEXT:    s_ashr_i32 s8, s8, 31
; GCN-NEXT:    s_flbit_i32 s9, s5
; GCN-NEXT:    s_add_i32 s8, s8, 32
; GCN-NEXT:    s_add_i32 s9, s9, -1
; GCN-NEXT:    s_min_u32 s13, s9, s8
; GCN-NEXT:    s_lshl_b64 s[8:9], s[4:5], s13
; GCN-NEXT:    s_min_u32 s5, s8, 1
; GCN-NEXT:    s_xor_b32 s8, s6, s7
; GCN-NEXT:    s_ashr_i32 s8, s8, 31
; GCN-NEXT:    s_flbit_i32 s10, s7
; GCN-NEXT:    s_add_i32 s8, s8, 32
; GCN-NEXT:    s_add_i32 s10, s10, -1
; GCN-NEXT:    s_min_u32 s8, s10, s8
; GCN-NEXT:    s_lshl_b64 s[10:11], s[6:7], s8
; GCN-NEXT:    s_min_u32 s7, s10, 1
; GCN-NEXT:    s_or_b32 s7, s11, s7
; GCN-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GCN-NEXT:    s_or_b32 s5, s9, s5
; GCN-NEXT:    v_cvt_f32_i32_e32 v1, s5
; GCN-NEXT:    s_sub_i32 s5, 32, s8
; GCN-NEXT:    v_ldexp_f32_e64 v0, v0, s5
; GCN-NEXT:    v_rcp_f32_e32 v2, v0
; GCN-NEXT:    s_sub_i32 s7, 32, s13
; GCN-NEXT:    v_ldexp_f32_e64 v1, v1, s7
; GCN-NEXT:    s_or_b32 s5, s12, 1
...
; GCN-IR-NEXT:    s_ashr_i32 s12, s8, 30
; GCN-IR-NEXT:    s_xor_b32 s8, s4, s5
; GCN-IR-NEXT:    s_mov_b32 s1, s9
; GCN-IR-NEXT:    s_ashr_i32 s8, s8, 31
; GCN-IR-NEXT:    s_flbit_i32 s9, s5
; GCN-IR-NEXT:    s_add_i32 s8, s8, 32
; GCN-IR-NEXT:    s_add_i32 s9, s9, -1
; GCN-IR-NEXT:    s_min_u32 s13, s9, s8
; GCN-IR-NEXT:    s_lshl_b64 s[8:9], s[4:5], s13
; GCN-IR-NEXT:    s_min_u32 s5, s8, 1
; GCN-IR-NEXT:    s_xor_b32 s8, s6, s7
; GCN-IR-NEXT:    s_ashr_i32 s8, s8, 31
; GCN-IR-NEXT:    s_flbit_i32 s10, s7
; GCN-IR-NEXT:    s_add_i32 s8, s8, 32
; GCN-IR-NEXT:    s_add_i32 s10, s10, -1
; GCN-IR-NEXT:    s_min_u32 s8, s10, s8
; GCN-IR-NEXT:    s_lshl_b64 s[10:11], s[6:7], s8
; GCN-IR-NEXT:    s_min_u32 s7, s10, 1
; GCN-IR-NEXT:    s_or_b32 s7, s11, s7
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GCN-IR-NEXT:    s_or_b32 s5, s9, s5
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v1, s5
; GCN-IR-NEXT:    s_sub_i32 s5, 32, s8
; GCN-IR-NEXT:    v_ldexp_f32_e64 v0, v0, s5
; GCN-IR-NEXT:    v_rcp_f32_e32 v2, v0
; GCN-IR-NEXT:    s_sub_i32 s7, 32, s13
; GCN-IR-NEXT:    v_ldexp_f32_e64 v1, v1, s7
; GCN-IR-NEXT:    s_or_b32 s5, s12, 1
...
; GCN-IR-NEXT:    v_readfirstlane_b32 s7, v2
; GCN-IR-NEXT:    s_add_i32 s5, s7, s5
...
; GCN-NEXT:    v_xor_b32_e32 v5, v1, v2
; GCN-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GCN-NEXT:    v_ffbh_i32_e32 v6, v2
; GCN-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-NEXT:    v_add_i32_e32 v6, vcc, -1, v6
; GCN-NEXT:    v_min_u32_e32 v7, v6, v5
; GCN-NEXT:    v_lshl_b64 v[5:6], v[1:2], v7
; GCN-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GCN-NEXT:    v_ashrrev_i32_e32 v3, 8, v3
; GCN-NEXT:    v_min_u32_e32 v2, 1, v5
; GCN-NEXT:    v_xor_b32_e32 v5, v3, v4
; GCN-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GCN-NEXT:    v_ffbh_i32_e32 v8, v4
; GCN-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-NEXT:    v_add_i32_e32 v8, vcc, -1, v8
; GCN-NEXT:    v_min_u32_e32 v8, v8, v5
; GCN-NEXT:    v_lshl_b64 v[4:5], v[3:4], v8
; GCN-NEXT:    v_or_b32_e32 v2, v6, v2
; GCN-NEXT:    v_min_u32_e32 v4, 1, v4
; GCN-NEXT:    v_or_b32_e32 v4, v5, v4
; GCN-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, 32, v8
; GCN-NEXT:    v_cvt_f32_i32_e32 v2, v2
; GCN-NEXT:    v_ldexp_f32_e32 v4, v4, v5
; GCN-NEXT:    v_rcp_f32_e32 v5, v4
; GCN-NEXT:    v_sub_i32_e32 v6, vcc, 32, v7
; GCN-NEXT:    v_ldexp_f32_e32 v2, v2, v6
; GCN-NEXT:    v_mul_f32_e32 v5, v2, v5
; GCN-NEXT:    v_trunc_f32_e32 v5, v5
; GCN-NEXT:    v_xor_b32_e32 v0, v1, v3
; GCN-NEXT:    v_mad_f32 v2, -v5, v4, v2
...
; GCN-NEXT:    v_mul_lo_u32 v0, v0, v3
...
; GCN-IR-NEXT:    v_xor_b32_e32 v5, v1, v2
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GCN-IR-NEXT:    v_ffbh_i32_e32 v6, v2
; GCN-IR-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-IR-NEXT:    v_add_i32_e32 v6, vcc, -1, v6
; GCN-IR-NEXT:    v_min_u32_e32 v7, v6, v5
; GCN-IR-NEXT:    v_lshl_b64 v[5:6], v[1:2], v7
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v4, 31, v3
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v3, 8, v3
; GCN-IR-NEXT:    v_min_u32_e32 v2, 1, v5
; GCN-IR-NEXT:    v_xor_b32_e32 v5, v3, v4
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; GCN-IR-NEXT:    v_ffbh_i32_e32 v8, v4
; GCN-IR-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-IR-NEXT:    v_add_i32_e32 v8, vcc, -1, v8
; GCN-IR-NEXT:    v_min_u32_e32 v8, v8, v5
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[3:4], v8
; GCN-IR-NEXT:    v_or_b32_e32 v2, v6, v2
; GCN-IR-NEXT:    v_min_u32_e32 v4, 1, v4
; GCN-IR-NEXT:    v_or_b32_e32 v4, v5, v4
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v4, v4
; GCN-IR-NEXT:    v_sub_i32_e32 v5, vcc, 32, v8
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v2, v2
; GCN-IR-NEXT:    v_ldexp_f32_e32 v4, v4, v5
; GCN-IR-NEXT:    v_rcp_f32_e32 v5, v4
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, 32, v7
; GCN-IR-NEXT:    v_ldexp_f32_e32 v2, v2, v6
; GCN-IR-NEXT:    v_mul_f32_e32 v5, v2, v5
; GCN-IR-NEXT:    v_trunc_f32_e32 v5, v5
; GCN-IR-NEXT:    v_xor_b32_e32 v0, v1, v3
; GCN-IR-NEXT:    v_mad_f32 v2, -v5, v4, v2
...
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v5, v0
...
; GCN-IR:       ; %bb.0:
; GCN-IR-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x9
; GCN-IR-NEXT:    s_mov_b32 s3, 0xf000
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i32 s9, s7, 31
; GCN-IR-NEXT:    s_ashr_i32 s8, s7, 8
; GCN-IR-NEXT:    s_xor_b32 s0, s8, s9
; GCN-IR-NEXT:    s_flbit_i32 s1, s9
; GCN-IR-NEXT:    s_ashr_i32 s0, s0, 31
; GCN-IR-NEXT:    s_add_i32 s1, s1, -1
; GCN-IR-NEXT:    s_add_i32 s0, s0, 32
; GCN-IR-NEXT:    s_min_u32 s6, s1, s0
; GCN-IR-NEXT:    s_lshl_b64 s[0:1], s[8:9], s6
; GCN-IR-NEXT:    s_min_u32 s0, s0, 1
; GCN-IR-NEXT:    s_or_b32 s0, s1, s0
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GCN-IR-NEXT:    s_sub_i32 s0, 32, s6
...
; GCN-IR-NEXT:    v_readfirstlane_b32 s5, v1
; GCN-IR-NEXT:    s_add_i32 s4, s5, s4
; GCN-IR-NEXT:    s_mul_i32 s4, s4, s8
; GCN-IR-NEXT:    s_sub_i32 s4, 24, s4
; GCN-IR-NEXT:    s_bfe_i32 s4, s4, 0x180000
; GCN-IR-NEXT:    s_ashr_i32 s5, s4, 31
; GCN-IR-NEXT:    v_mov_b32_e32 v0, s4
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s5
...
; GCN-NEXT:    v_min_u32_e32 v0, v3, v0
; GCN-NEXT:    v_lshl_b64 v[3:4], v[1:2], v0
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, 32, v0
; GCN-NEXT:    v_min_u32_e32 v3, 1, v3
...
; GCN-NEXT:    v_ldexp_f32_e32 v0, v3, v0
; GCN-NEXT:    v_rcp_f32_e32 v3, v0
; GCN-NEXT:    v_mul_f32_e32 v3, 0x41c00000, v3
; GCN-NEXT:    v_trunc_f32_e32 v3, v3
; GCN-NEXT:    v_mad_f32 v4, -v3, v0, s4
...
; GCN-IR-NEXT:    v_min_u32_e32 v0, v3, v0
; GCN-IR-NEXT:    v_lshl_b64 v[3:4], v[1:2], v0
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 32, v0
; GCN-IR-NEXT:    v_min_u32_e32 v3, 1, v3
; GCN-IR-NEXT:    v_or_b32_e32 v3, v4, v3
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v3, v3
; GCN-IR-NEXT:    s_mov_b32 s4, 0x41c00000
; GCN-IR-NEXT:    v_or_b32_e32 v2, 1, v2
; GCN-IR-NEXT:    v_ldexp_f32_e32 v0, v3, v0
; GCN-IR-NEXT:    v_rcp_f32_e32 v3, v0
; GCN-IR-NEXT:    v_mul_f32_e32 v3, 0x41c00000, v3
; GCN-IR-NEXT:    v_trunc_f32_e32 v3, v3
; GCN-IR-NEXT:    v_mad_f32 v4, -v3, v0, s4
...
; GCN-IR-NEXT:    v_mul_lo_u32 v0, v0, v1
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, 24, v0
; GCN-IR-NEXT:    v_bfe_i32 v0, v0, 0, 24
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-IR-NEXT:    v_or_b32_e32 v2, 1, v2
; GCN-IR-NEXT:    v_ldexp_f32_e32 v0, v3, v0
; GCN-IR-NEXT:    v_mul_f32_e32 v3, 0x38000000, v0
; GCN-IR-NEXT:    v_trunc_f32_e32 v3, v3
; GCN-IR-NEXT:    v_mad_f32 v0, -v3, s4, v0
; GCN-IR-NEXT:    v_cvt_i32_f32_e32 v3, v3
; GCN-IR-NEXT:    v_cmp_ge_f32_e64 vcc, |v0|, s4
; GCN-IR-NEXT:    v_cndmask_b32_e32 v0, 0, v2, vcc
; GCN-IR-NEXT:    v_add_i32_e32 v0, vcc, v3, v0
; GCN-IR-NEXT:    v_lshlrev_b32_e32 v0, 15, v0
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, v1, v0
; GCN-IR-NEXT:    v_bfe_i32 v0, v0, 0, 24
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GCN-IR-NEXT:    s_setpc_b64 s[30:31]
