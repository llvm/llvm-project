...
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    s_mov_b32 s4, 0xfe00
...
; GFX11-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX11-SDAG-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-FAKE16-NEXT:    s_mov_b32 s0, 0xfe00
...
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_max_f16_e32 v0, v0, v1
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_max_f16_e32 v0, v0, v3
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_max_f16_e32 v0, v0, v5
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_max_f16_e32 v0, v0, v6
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    v_max_f16_e32 v0, v0, v7
; GFX8-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG:       ; %bb.0: ; %entry
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v8, 16, v1
; GFX10-SDAG-NEXT:    v_max_f16_sdwa v0, v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v9, 16, v2
; GFX10-SDAG-NEXT:    v_max3_f16 v0, v0, v1, v8
; GFX10-SDAG-NEXT:    v_lshrrev_b32_e32 v1, 16, v3
; GFX10-SDAG-NEXT:    v_max3_f16 v0, v0, v2, v9
...
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[10:11]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[10:11]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[10:11]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[10:11]
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[16:17]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[18:19]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[20:21]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[22:23]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[24:25]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[26:27]
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[28:29]
; GFX7-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX7-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[30:31]
; GFX7-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[16:17]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[18:19]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[20:21]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[22:23]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[24:25]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[26:27]
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[28:29]
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX8-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[30:31]
; GFX8-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[30:31]
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[12:13]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[16:17]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[18:19]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[20:21]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[22:23]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[24:25]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[26:27]
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[28:29]
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[30:31]
; GFX10-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[14:15]
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[16:17]
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[18:19]
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[20:21]
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[22:23]
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[24:25]
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[26:27]
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[28:29]
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_max_f64 v[0:1], v[0:1], v[30:31]
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
