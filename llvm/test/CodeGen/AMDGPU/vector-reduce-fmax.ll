...
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
...
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    s_mov_b32 s4, 0xfe00
...
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    s_mov_b32 s0, 0xfe00
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-GISEL-FAKE16-NEXT:    v_perm_b32 v1, s0, v1, 0x5040100
...
; GFX1170-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX1170-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-GISEL-FAKE16-NEXT:    s_mov_b32 s0, 0xfe00
; GFX1170-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1170-GISEL-FAKE16-NEXT:    v_perm_b32 v1, s0, v1, 0x5040100
...
; GFX12-GISEL-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-FAKE16-NEXT:    s_mov_b32 s0, 0xfe00
; GFX12-GISEL-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GISEL-FAKE16-NEXT:    v_perm_b32 v1, s0, v1, 0x5040100
...
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v1
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v3
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v5
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v6
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v0, v0, v7
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_max3_f16 v0, v0, v1, v8
; GFX10-NEXT:    v_lshrrev_b32_e32 v1, 16, v3
; GFX10-NEXT:    v_max3_f16 v0, v0, v2, v9
...
; GFX7-GISEL-NEXT:    v_max_f32_e32 v2, v2, v3
; GFX7-GISEL-NEXT:    v_max_f32_e32 v3, v6, v7
; GFX7-GISEL-NEXT:    v_max_f32_e32 v6, v10, v11
; GFX7-GISEL-NEXT:    v_max_f32_e32 v7, v14, v15
; GFX7-GISEL-NEXT:    v_max3_f32 v0, v0, v1, v2
; GFX7-GISEL-NEXT:    v_max3_f32 v1, v4, v5, v3
...
; GFX8-GISEL-NEXT:    v_max_f32_e32 v2, v2, v3
; GFX8-GISEL-NEXT:    v_max_f32_e32 v3, v6, v7
; GFX8-GISEL-NEXT:    v_max_f32_e32 v6, v10, v11
; GFX8-GISEL-NEXT:    v_max_f32_e32 v7, v14, v15
; GFX8-GISEL-NEXT:    v_max3_f32 v0, v0, v1, v2
; GFX8-GISEL-NEXT:    v_max3_f32 v1, v4, v5, v3
...
; GFX9-GISEL-NEXT:    v_max_f32_e32 v2, v2, v3
; GFX9-GISEL-NEXT:    v_max_f32_e32 v3, v6, v7
; GFX9-GISEL-NEXT:    v_max_f32_e32 v6, v10, v11
; GFX9-GISEL-NEXT:    v_max_f32_e32 v7, v14, v15
; GFX9-GISEL-NEXT:    v_max3_f32 v0, v0, v1, v2
; GFX9-GISEL-NEXT:    v_max3_f32 v1, v4, v5, v3
...
; GFX9-GISEL-NEXT:    v_max_f64 v[2:3], v[28:29], v[30:31]
