...
; GFX10-NEXT:    v_mul_lo_u16 v2, 0.5, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf0,0x04,0x02,0x02]
...
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v2.l, 0.5, v2.l ; encoding: [0x02,0x00,0x05,0xd7,0xf0,0x04,0x02,0x02]
...
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v2, 0.5, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf0,0x04,0x02,0x02]
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x8c,0xbf]
; GFX10-NEXT:    v_mul_lo_u16 v2, 1.0, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf2,0x04,0x02,0x02]
; GFX10-NEXT:    global_store_short v[0:1], v2, off ; encoding: [0x00,0x80,0x68,0xdc,0x00,0x02,0x7d,0x00]
; GFX10-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x20,0x80,0xbe]
;
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v2.l, 1.0, v2.l ; encoding: [0x02,0x00,0x05,0xd7,0xf2,0x04,0x02,0x02]
; GFX11-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v2, 1.0, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf2,0x04,0x02,0x02]
; GFX11-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x8c,0xbf]
; GFX10-NEXT:    v_mul_lo_u16 v2, 4.0, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf6,0x04,0x02,0x02]
; GFX10-NEXT:    global_store_short v[0:1], v2, off ; encoding: [0x00,0x80,0x68,0xdc,0x00,0x02,0x7d,0x00]
; GFX10-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x20,0x80,0xbe]
;
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v2.l, 4.0, v2.l ; encoding: [0x02,0x00,0x05,0xd7,0xf6,0x04,0x02,0x02]
; GFX11-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v2, 4.0, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf6,0x04,0x02,0x02]
; GFX11-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x8c,0xbf]
; GFX10-NEXT:    v_mul_lo_u16 v2, 0.15915494, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf8,0x04,0x02,0x02]
; GFX10-NEXT:    global_store_short v[0:1], v2, off ; encoding: [0x00,0x80,0x68,0xdc,0x00,0x02,0x7d,0x00]
; GFX10-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x20,0x80,0xbe]
;
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v2.l, 0.15915494, v2.l ; encoding: [0x02,0x00,0x05,0xd7,0xf8,0x04,0x02,0x02]
; GFX11-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-FAKE16-NEXT:    v_mul_lo_u16 v2, 0.15915494, v2 ; encoding: [0x02,0x00,0x05,0xd7,0xf8,0x04,0x02,0x02]
; GFX11-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off ; encoding: [0x00,0x00,0x66,0xdc,0x00,0x02,0x7c,0x00]
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
