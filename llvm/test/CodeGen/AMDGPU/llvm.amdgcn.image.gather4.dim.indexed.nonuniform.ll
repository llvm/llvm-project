...
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x4b,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
...
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:4], [v6, v5], v7, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D tfe ; encoding: [0x09,0xc0,0x4b,0xe4,0x00,0x0e,0x02,0x00,0x06,0x05,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_CUBE ; encoding: [0x03,0xc0,0x4b,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY ; encoding: [0x05,0xc0,0x4b,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x4c,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_cl v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x58,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_cl v[0:3], [v1, v2, v3, v4], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x58,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_b v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x4c,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_b v[0:3], [v1, v2, v3, v4], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x59,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_b_cl v[0:3], [v1, v2, v3, v4], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x58,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4_c_b_cl v[0:3], [v1, v2, v3, v[4:5]], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0x59,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_l v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x4c,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_c_l v[0:3], [v1, v2, v3, v4], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x58,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_lz v[0:3], [v1, v2], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x4c,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_gather4_c_lz v[0:3], [v1, v2, v3], v0, s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x4d,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2], v0, s[0:3] dmask:0x2 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x8b,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2], v0, s[0:3] dmask:0x4 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x0b,0xe5,0x00,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) ; encoding: [0x09,0x00,0xae,0xbf]
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s4 ; encoding: [0x7e,0x04,0x7e,0x87]
; GFX13-NEXT:    image_gather4 v[0:3], [v1, v2], v0, s[0:3] dmask:0x8 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x0b,0xe6,0x00,0x00,0x02,0x00,0x01,0x02,0x00,0x00]
; GFX13-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-NEXT:    ; return to shader part epilog
main_body:
