...
; SDAG-TRUE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v1, s4, v0 bitop3:0x40
; SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
...
; SDAG-TRUE16-NEXT:    global_store_b16 v2, v0, s[0:1]
; SDAG-TRUE16-NEXT:    s_endpgm
;
...
; SDAG-FAKE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v0, s4, v0 bitop3:0x40
; SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-NEXT:    global_load_u16 v0, v0, s[2:3] scale_offset
; SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; SDAG-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v0
; SDAG-FAKE16-NEXT:    global_store_b16 v2, v1, s[0:1]
; SDAG-FAKE16-NEXT:    s_endpgm
;
...
; GI-TRUE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v1, s4, v0 bitop3:0x40
; GI-TRUE16-NEXT:    s_wait_kmcnt 0x0
...
; GI-TRUE16-NEXT:    global_store_b16 v2, v0, s[0:1]
; GI-TRUE16-NEXT:    s_endpgm
;
...
; GI-FAKE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v0, s4, v0 bitop3:0x40
; GI-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GI-FAKE16-NEXT:    global_load_u16 v0, v0, s[2:3] scale_offset
; GI-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GI-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v0
; GI-FAKE16-NEXT:    global_store_b16 v2, v1, s[0:1]
; GI-FAKE16-NEXT:    s_endpgm
;
...
; GFX13-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v1, s4, v0 bitop3:0x40
; GFX13-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
...
; GFX13-SDAG-TRUE16-NEXT:    global_store_b16 v2, v0, s[0:1]
; GFX13-SDAG-TRUE16-NEXT:    s_endpgm
;
...
; GFX13-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_bitop2_b32 v0, s4, v0 bitop3:0x40
; GFX13-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-FAKE16-NEXT:    global_load_u16 v0, v0, s[2:3] scale_offset
; GFX13-SDAG-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v0
; GFX13-SDAG-FAKE16-NEXT:    global_store_b16 v2, v1, s[0:1]
; GFX13-SDAG-FAKE16-NEXT:    s_endpgm
