...
define void @rcp_bf16_v(ptr addrspace(1) %out, bfloat %src) #1 {
; SDAG-TRUE16-LABEL: rcp_bf16_v:
; SDAG-TRUE16:       ; %bb.0:
; SDAG-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; SDAG-TRUE16-NEXT:    v_rcp_bf16_e32 v2.l, v2.l
; SDAG-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; SDAG-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; SDAG-FAKE16-LABEL: rcp_bf16_v:
; SDAG-FAKE16:       ; %bb.0:
; SDAG-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; SDAG-FAKE16-NEXT:    v_rcp_bf16_e32 v2, v2
; SDAG-FAKE16-NEXT:    global_store_b16 v[0:1], v2, off
; SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GI-TRUE16-LABEL: rcp_bf16_v:
; GI-TRUE16:       ; %bb.0:
; GI-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GI-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GI-TRUE16-NEXT:    v_rcp_bf16_e32 v2.l, v2.l
; GI-TRUE16-NEXT:    global_store_b16 v[0:1], v2, off
; GI-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GI-FAKE16-LABEL: rcp_bf16_v:
; GI-FAKE16:       ; %bb.0:
; GI-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GI-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GI-FAKE16-NEXT:    v_rcp_bf16_e32 v2, v2
