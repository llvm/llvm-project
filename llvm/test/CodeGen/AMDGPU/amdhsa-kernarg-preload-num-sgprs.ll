...
; ASM-LABEL: amdhsa_kernarg_preload_4_implicit_6:
; ASM:       ; %bb.1:
; ASM-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x0
...
; ASM-NEXT:    s_endpgm
;
; GFX1250-ASM-LABEL: amdhsa_kernarg_preload_4_implicit_6:
; GFX1250-ASM:       ; %bb.0:
; GFX1250-ASM-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-ASM-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-ASM-NEXT:    v_nop
; GFX1250-ASM-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-ASM-NEXT:    s_endpgm
