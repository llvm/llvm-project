...
; GFX6-NEXT:    s_load_dwordx8 s[12:19], s[0:1], 0x19
...
; GFX8:       ; %bb.0: ; %entry
; GFX8-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x44
; GFX8-NEXT:    s_load_dwordx8 s[12:19], s[0:1], 0x64
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x44
; GFX9-NEXT:    s_load_dwordx8 s[12:19], s[0:1], 0x64
; GFX9-NEXT:    v_mov_b32_e32 v4, 0
...
; GFX10-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x44
; GFX10-NEXT:    s_load_dwordx8 s[12:19], s[0:1], 0x64
...
; GFX11-NEXT:    s_load_b256 s[12:19], s[0:1], 0x64
...
; GFX12-NEXT:    s_load_b256 s[4:11], s[0:1], 0x44
; GFX12-NEXT:    s_load_b256 s[12:19], s[0:1], 0x64
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_cmp_ne_u64_e64 s[2:3], s[4:5], 0
...
; GFX6-NEXT:    s_cbranch_vccnz .LBB9_5
; GFX6-NEXT:  ; %bb.4: ; %if
; GFX6-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x0
...
; GFX8-NEXT:    s_cbranch_vccnz .LBB9_5
; GFX8-NEXT:  ; %bb.4: ; %if
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-NEXT:    s_cbranch_vccnz .LBB9_5
; GFX10-NEXT:  ; %bb.4: ; %if
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
