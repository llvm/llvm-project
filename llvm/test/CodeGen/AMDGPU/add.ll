...
; GFX8-NEXT:  ; %bb.1: ; %else
; GFX8-NEXT:    s_add_u32 s2, s4, s6
; GFX8-NEXT:    s_addc_u32 s3, s5, s7
...
; GFX11-NEXT:    s_add_u32 s2, s4, s6
; GFX11-NEXT:    s_addc_u32 s3, s5, s7
...
; GFX12-NEXT:    s_add_nc_u64 s[2:3], s[4:5], s[6:7]
