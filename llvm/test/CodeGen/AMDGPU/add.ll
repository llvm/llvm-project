...
; RUN: llc -march=amdgcn -mcpu=gfx1010 -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,FUNC %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,FUNC %s
...
; GFX10PLUS: v_add_nc_u32_e32 v{{[0-9]+}}, [[A]], [[B]]
...
; GFX10PLUS: v_add_nc_u32_e32 v{{[0-9]+}}, 0x7b, [[A]]
...
; GFX10PLUS: v_add_nc_u32_e32 v0, s0, v0
