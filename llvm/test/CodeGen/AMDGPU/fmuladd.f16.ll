...
; RUN: llc -mtriple=amdgpu8.03 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=VI-FLUSH %s

; RUN: llc -mtriple=amdgpu8.03 -denormal-fp-math=ieee -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=VI-DENORM %s

; RUN: llc -mtriple=amdgpu10.10 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX10-FLUSH %s
; RUN: llc -mtriple=amdgpu10.10 -denormal-fp-math=ieee -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX10-DENORM %s

; RUN: llc -mtriple=amdgpu11.00 -mattr=+real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX11-FLUSH-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=-real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX11-FLUSH-FAKE16 %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=+real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX11-DENORM-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=-real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=ieee < %s | FileCheck -check-prefixes=GFX11-DENORM-FAKE16 %s
...
; GFX11-DENORM-FAKE16-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    s_clause 0x2
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v1, v4, s[2:3]
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v2, v4, s[4:5]
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v3, v4, s[6:7]
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_fmac_f16_e32 v3, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v3, s[0:1]
...
; VI-DENORM-NEXT:    v_mul_f16_e32 v2, v6, v2
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[8:9]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
                         ptr addrspace(1) %in2, ptr addrspace(1) %in3) #0 {
  %r0 = load half, ptr addrspace(1) %in1
  %r1 = load half, ptr addrspace(1) %in2
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_2.0_a_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
...
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-TRUE16-NEXT:    v_fmac_f16_e32 v0.h, 2.0, v0.l
; GFX11-DENORM-TRUE16-NEXT:    global_store_d16_hi_b16 v1, v0, s[0:1]
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_2.0_a_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v1, v3, s[0:1] glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v2, v3, s[0:1] offset:2 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_fmac_f16_e32 v2, 2.0, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v2, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_a_2.0_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_a_2.0_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fadd_a_a_b_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: fadd_a_a_b_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    global_load_ushort v2, v3, s[0:1] offset:2 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v1, v2
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fadd_a_a_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v2, v3, s[0:1] offset:2 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
                            ptr addrspace(1) %in1,
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fadd_b_a_a_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: fadd_b_a_a_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v2, v1
; GFX10-DENORM-NEXT:    global_store_short v3, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fadd_b_a_a_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v2, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
                            ptr addrspace(1) %in1,
                            ptr addrspace(1) %in2) #0 {
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_neg_2.0_a_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_neg_2.0_a_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_neg_2.0_neg_a_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_neg_2.0_neg_a_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_2.0_neg_a_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_2.0_neg_a_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fmuladd_2.0_a_neg_b_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-TRUE16-NEXT:    global_load_d16_hi_b16 v0, v1, s[0:1] offset:2 glc dlc
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-TRUE16-NEXT:    v_fma_f16 v0.l, v0.l, 2.0, -v0.h
; GFX11-DENORM-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX11-DENORM-TRUE16-NEXT:    s_endpgm
;
; GFX11-DENORM-FAKE16-LABEL: fmuladd_2.0_a_neg_b_f16:
; GFX11-DENORM-FAKE16:       ; %bb.0:
; GFX11-DENORM-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v2, v3, s[0:1] offset:2 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_fma_f16 v1, v1, 2.0, -v2
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %gep.0 = getelementptr half, ptr addrspace(1) %out, i32 %tid
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: mad_sub_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, s3
...
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, s1
; VI-DENORM-NEXT:    v_add_u32_e32 v0, vcc, s0, v6
; VI-DENORM-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-DENORM-NEXT:    v_mul_f16_e32 v2, v7, v2
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: mad_sub_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DENORM-NEXT:    global_load_ushort v1, v4, s[2:3] glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    global_load_ushort v2, v4, s[2:3] offset:2 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    global_load_ushort v3, v4, s[2:3] offset:4 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    v_sub_f16_e32 v1, v1, v3
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: mad_sub_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
...
; GFX11-DENORM-FAKE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v1, v4, s[2:3] glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v2, v4, s[2:3] offset:2 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v3, v4, s[2:3] offset:4 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e32 v1, v1, v3
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: mad_sub_inv_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: mad_sub_inv_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    v_sub_f16_e32 v1, v3, v1
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: mad_sub_inv_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e32 v1, v3, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = tail call i32 @llvm.amdgcn.workitem.id.x() #0
  %tid.ext = sext i32 %tid to i64
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: mad_sub_fabs_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-DENORM-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-DENORM-NEXT:    v_mul_f16_e32 v2, v7, v2
; VI-DENORM-NEXT:    v_sub_f16_e64 v2, v2, |v3|
; VI-DENORM-NEXT:    flat_store_short v[0:1], v2
; VI-DENORM-NEXT:    s_endpgm
;
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: mad_sub_fabs_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    v_sub_f16_e64 v1, v1, |v3|
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: mad_sub_fabs_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e64 v1, v1, |v3|
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = tail call i32 @llvm.amdgcn.workitem.id.x() #0
  %tid.ext = sext i32 %tid to i64
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: mad_sub_fabs_inv_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-DENORM-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-DENORM-NEXT:    v_mul_f16_e32 v2, v7, v2
; VI-DENORM-NEXT:    v_sub_f16_e64 v2, |v3|, v2
; VI-DENORM-NEXT:    flat_store_short v[0:1], v2
; VI-DENORM-NEXT:    s_endpgm
;
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: mad_sub_fabs_inv_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    v_sub_f16_e64 v1, |v3|, v1
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: mad_sub_fabs_inv_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e64 v1, |v3|, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = tail call i32 @llvm.amdgcn.workitem.id.x() #0
  %tid.ext = sext i32 %tid to i64
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: neg_neg_mad_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: neg_neg_mad_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v3, v1
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: neg_neg_mad_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v3, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = tail call i32 @llvm.amdgcn.workitem.id.x() #0
  %tid.ext = sext i32 %tid to i64
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: mad_fabs_sub_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v6, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-DENORM-NEXT:    v_add_u32_e32 v0, vcc, s0, v6
; VI-DENORM-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-DENORM-NEXT:    v_mul_f16_e64 v2, v7, |v2|
; VI-DENORM-NEXT:    v_sub_f16_e32 v2, v2, v3
; VI-DENORM-NEXT:    flat_store_short v[0:1], v2
; VI-DENORM-NEXT:    s_endpgm
;
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: mad_fabs_sub_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v4, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    global_load_ushort v3, v4, s[2:3] offset:4 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_mul_f16_e64 v1, v1, |v2|
; GFX10-DENORM-NEXT:    v_sub_f16_e32 v1, v1, v3
; GFX10-DENORM-NEXT:    global_store_short v4, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: mad_fabs_sub_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    global_load_u16 v3, v4, s[2:3] offset:4 glc dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-FAKE16-NEXT:    v_mul_f16_e64 v1, v1, |v2|
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e32 v1, v1, v3
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v4, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fsub_c_fadd_a_a_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: fsub_c_fadd_a_a_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX10-DENORM-NEXT:    v_sub_f16_e32 v1, v2, v1
; GFX10-DENORM-NEXT:    global_store_short v3, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fsub_c_fadd_a_a_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e32 v1, v2, v1
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %gep.0 = getelementptr half, ptr addrspace(1) %out, i32 %tid
...
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fsub_fadd_a_a_c_f16:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-DENORM-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-FLUSH-NEXT:    s_endpgm
;
; GFX10-DENORM-LABEL: fsub_fadd_a_a_c_f16:
; GFX10-DENORM:       ; %bb.0:
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-DENORM-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX10-DENORM-NEXT:    v_sub_f16_e32 v1, v1, v2
; GFX10-DENORM-NEXT:    global_store_short v3, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_endpgm
;
...
; GFX11-FLUSH-FAKE16-NEXT:    s_endpgm
;
; GFX11-DENORM-TRUE16-LABEL: fsub_fadd_a_a_c_f16:
; GFX11-DENORM-TRUE16:       ; %bb.0:
; GFX11-DENORM-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-DENORM-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e32 v1, v1, v1
; GFX11-DENORM-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-DENORM-FAKE16-NEXT:    v_sub_f16_e32 v1, v1, v2
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v3, v1, s[0:1]
; GFX11-DENORM-FAKE16-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %gep.0 = getelementptr half, ptr addrspace(1) %out, i32 %tid
