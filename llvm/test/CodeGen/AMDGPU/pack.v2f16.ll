...
; RUN: llc -mtriple=amdgpu9.00--amdhsa -mattr=-flat-for-global -denormal-fp-math=preserve-sign < %s | FileCheck --check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu8.03--amdhsa -mattr=-flat-for-global < %s | FileCheck -check-prefix=GFX8 %s
; RUN: llc -mtriple=amdgpu7.00--amdhsa -mattr=-flat-for-global < %s | FileCheck -check-prefix=GFX7 %s
...
; GFX8-NEXT:    flat_load_dword v0, v[4:5] glc
