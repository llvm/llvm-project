...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-ISEL-LABEL: test_signed_v2f64_v2i1:
; GFX12-ISEL:       ; %bb.0:
...
; GFX12-ISEL-NEXT:    v_cvt_i32_f64_e32 v1, v[2:3]
; GFX12-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-GI-LABEL: test_signed_v2f64_v2i1:
; GFX12-GI:       ; %bb.0:
...
; GFX12-GI-NEXT:    v_med3_i32 v1, v1, -1, 0
...
; GFX11-TRUE16-NEXT:    v_cvt_i32_f64_e32 v1, v[0:1]
...
; GFX12-TRUE16-NEXT:    v_cvt_i32_f64_e32 v1, v[0:1]
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v4, v0 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; GFX9-NEXT:    v_cvt_i32_f32_e32 v3, v3
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v1, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v0, v2, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v2, v3, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v7, v4
; GFX9-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX9-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX9-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GFX9-NEXT:    v_cvt_f32_f16_e32 v4, v2
; GFX9-NEXT:    v_cvt_i32_f32_e32 v9, v6
...
; GFX11-FAKE16-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v7, v4
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v8, v6
...
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v0, v0
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v1, v9
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v2, v4
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v6, v3
; GFX11-FAKE16-NEXT:    v_cvt_i32_f32_e32 v4, v10
...
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v0, v9
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v1, v4
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v2, v6
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v6, v3
; GFX11-TRUE16-NEXT:    v_cvt_i32_f32_e32 v4, v10
...
; GFX12-FAKE16-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v7, v4
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v8, v6
...
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v0, v0
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v1, v9
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v2, v4
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v6, v3
; GFX12-FAKE16-NEXT:    v_cvt_i32_f32_e32 v4, v10
...
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v0, v9
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v1, v4
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v2, v6
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v6, v3
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v4, v10
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v5, v5
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v3, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD
...
; GFX9-NEXT:    v_cvt_f32_f16_sdwa v1, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX9-NEXT:    v_or_b32_sdwa v6, v5, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_cvt_f32_f16_e32 v3, v0
; GFX9-NEXT:    v_cvt_f32_f16_sdwa v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX9-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v1, v1 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; GFX9-NEXT:    v_cvt_i32_f32_e32 v9, v3
; GFX9-NEXT:    v_cvt_i32_f32_sdwa v10, v0 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD
...
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v4, v2.h
; GFX11-TRUE16-NEXT:    v_and_b16 v2.l, 0xff, v6.l
...
; GFX11-TRUE16-NEXT:    v_or_b16 v8.h, v2.l, v0.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 8, v3.l
; GFX11-TRUE16-NEXT:    v_or_b16 v9.h, v1.l, v1.h
; GFX11-TRUE16-NEXT:    v_and_b16 v1.l, 0xff, v4.l
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 8, v5.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v8.h
; GFX11-TRUE16-NEXT:    v_or_b16 v9.l, v0.h, v0.l
...
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v4, v2.h
; GFX12-TRUE16-NEXT:    v_and_b16 v2.l, 0xff, v6.l
...
; GFX12-TRUE16-NEXT:    v_and_b16 v0.h, 0xff, v5.l
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v4, v6
; GFX12-TRUE16-NEXT:    v_cvt_i32_f32_e32 v5, v7
; GFX12-TRUE16-NEXT:    v_or_b16 v8.h, v2.l, v0.l
; GFX12-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 8, v3.l
; GFX12-TRUE16-NEXT:    v_or_b16 v9.h, v1.l, v1.h
; GFX12-TRUE16-NEXT:    v_and_b16 v1.l, 0xff, v4.l
; GFX12-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 8, v5.l
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v8.h
; GFX12-TRUE16-NEXT:    v_or_b16 v9.l, v0.h, v0.l
