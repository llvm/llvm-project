...
; GFX7-NEXT:    v_max_f64 v[0:1], s[6:7], v[4:5]
; GFX7-NEXT:    v_cmp_u_f64_e64 s[4:5], s[6:7], v[4:5]
...
; GFX8-NEXT:    v_max_f64 v[0:1], s[6:7], v[4:5]
; GFX8-NEXT:    v_cmp_u_f64_e64 s[4:5], s[6:7], v[4:5]
...
; GFX9-NEXT:    v_max_f64 v[0:1], s[6:7], v[4:5]
; GFX9-NEXT:    v_cmp_u_f64_e64 s[4:5], s[6:7], v[4:5]
...
; GFX10-NEXT:    v_max_f64 v[4:5], s[6:7], s[18:19]
; GFX10-NEXT:    v_cmp_u_f64_e64 s5, s[6:7], s[18:19]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_max_f64 v[0:1], s[2:3], s[16:17]
; GFX11-NEXT:    v_cmp_u_f64_e64 s2, s[2:3], s[16:17]
; GFX11-NEXT:    v_max_f64 v[4:5], s[0:1], s[6:7]
; GFX11-NEXT:    v_cmp_u_f64_e64 s0, s[0:1], s[6:7]
...
; GFX7-NEXT:    v_writelane_b32 v34, s34, 0
; GFX7-NEXT:    v_writelane_b32 v34, s35, 1
; GFX7-NEXT:    v_writelane_b32 v34, s30, 2
; GFX7-NEXT:    v_writelane_b32 v34, s31, 3
...
; GFX7-NEXT:    v_readlane_b32 s30, v34, 2
...
; GFX7-NEXT:    v_readlane_b32 s31, v34, 3
; GFX7-NEXT:    v_readlane_b32 s35, v34, 1
; GFX7-NEXT:    v_readlane_b32 s34, v34, 0
; GFX7-NEXT:    s_xor_saveexec_b64 s[4:5], -1
...
; GFX8-NEXT:    v_writelane_b32 v34, s30, 2
; GFX8-NEXT:    v_writelane_b32 v34, s31, 3
...
; GFX8-NEXT:    v_readlane_b32 s30, v34, 2
...
; GFX8-NEXT:    v_readlane_b32 s31, v34, 3
...
; GFX9-NEXT:    v_writelane_b32 v34, s34, 0
; GFX9-NEXT:    v_writelane_b32 v34, s35, 1
...
; GFX9-NEXT:    v_readlane_b32 s30, v34, 2
...
; GFX9-NEXT:    v_readlane_b32 s31, v34, 3
; GFX9-NEXT:    v_readlane_b32 s35, v34, 1
; GFX9-NEXT:    v_readlane_b32 s34, v34, 0
; GFX9-NEXT:    s_xor_saveexec_b64 s[4:5], -1
