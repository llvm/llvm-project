...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s --check-prefixes=CHECK,SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu9.00 < %s | FileCheck %s --check-prefixes=CHECK,GISEL
