...
; GFX1210-NEXT:    v_cvt_f16_bf8_e32 v0, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
...
; GFX1210-LABEL: test_cvt_f16_bf8_byte1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_bf8_e64 v0, v0 op_sel:[0,1,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_bf8_byte2:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_bf8_e64 v0, v0 op_sel:[1,0,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_bf8_byte3:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_bf8_e64 v0, v0 op_sel:[1,1,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_fp8_byte0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_fp8_e32 v0, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_fp8_byte1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_fp8_e64 v0, v0 op_sel:[0,1,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_fp8_byte2:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_fp8_e64 v0, v0 op_sel:[1,0,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-LABEL: test_cvt_f16_fp8_byte3:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_f16_fp8_e64 v0, v0 op_sel:[1,1,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
