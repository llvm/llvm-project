...
; GFX7-NEXT:    s_load_dword s21, s[4:5], 0x0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_ashr_i32 s2, s0, 28
; GFX7-NEXT:    s_ashr_i32 s14, s1, 28
; GFX7-NEXT:    s_bfe_i32 s15, s1, 0x40018
; GFX7-NEXT:    s_bfe_i32 s16, s1, 0x40014
; GFX7-NEXT:    s_bfe_i32 s17, s1, 0x40010
; GFX7-NEXT:    s_bfe_i32 s18, s1, 0x4000c
; GFX7-NEXT:    s_bfe_i32 s19, s1, 0x40008
; GFX7-NEXT:    s_bfe_i32 s20, s1, 0x40004
; GFX7-NEXT:    s_bfe_i32 s1, s1, 0x40000
; GFX7-NEXT:    s_bfe_i32 s8, s0, 0x40018
; GFX7-NEXT:    s_bfe_i32 s9, s0, 0x40014
; GFX7-NEXT:    s_bfe_i32 s10, s0, 0x40010
; GFX7-NEXT:    s_bfe_i32 s11, s0, 0x4000c
; GFX7-NEXT:    s_bfe_i32 s12, s0, 0x40008
; GFX7-NEXT:    s_bfe_i32 s13, s0, 0x40004
; GFX7-NEXT:    s_bfe_i32 s0, s0, 0x40000
...
; GFX8-NEXT:    s_load_dword s19, s[0:1], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_ashr_i32 s5, s2, 28
; GFX8-NEXT:    s_ashr_i32 s12, s4, 28
; GFX8-NEXT:    s_bfe_i32 s13, s4, 0x40018
; GFX8-NEXT:    s_bfe_i32 s14, s4, 0x40014
; GFX8-NEXT:    s_bfe_i32 s15, s4, 0x40010
; GFX8-NEXT:    s_bfe_i32 s16, s4, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s17, s4, 0x40008
; GFX8-NEXT:    s_bfe_i32 s18, s4, 0x40004
; GFX8-NEXT:    s_bfe_i32 s4, s4, 0x40000
; GFX8-NEXT:    s_bfe_i32 s6, s2, 0x40018
; GFX8-NEXT:    s_bfe_i32 s7, s2, 0x40014
; GFX8-NEXT:    s_bfe_i32 s8, s2, 0x40010
; GFX8-NEXT:    s_bfe_i32 s9, s2, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s10, s2, 0x40008
; GFX8-NEXT:    s_bfe_i32 s11, s2, 0x40004
...
; GFX9-NEXT:    s_load_dword s19, s[0:1], 0x0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_ashr_i32 s5, s2, 28
; GFX9-NEXT:    s_ashr_i32 s12, s4, 28
; GFX9-NEXT:    s_bfe_i32 s13, s4, 0x40018
; GFX9-NEXT:    s_bfe_i32 s14, s4, 0x40014
; GFX9-NEXT:    s_bfe_i32 s15, s4, 0x40010
; GFX9-NEXT:    s_bfe_i32 s16, s4, 0x4000c
; GFX9-NEXT:    s_bfe_i32 s17, s4, 0x40008
; GFX9-NEXT:    s_bfe_i32 s18, s4, 0x40004
; GFX9-NEXT:    s_bfe_i32 s4, s4, 0x40000
; GFX9-NEXT:    s_bfe_i32 s6, s2, 0x40018
; GFX9-NEXT:    s_bfe_i32 s7, s2, 0x40014
; GFX9-NEXT:    s_bfe_i32 s8, s2, 0x40010
; GFX9-NEXT:    s_bfe_i32 s9, s2, 0x4000c
; GFX9-NEXT:    s_bfe_i32 s10, s2, 0x40008
; GFX9-NEXT:    s_bfe_i32 s11, s2, 0x40004
...
; GFX9-NEXT:    v_mov_b32_e32 v1, s12
; GFX9-NEXT:    v_mad_i32_i24 v2, s5, v1, v0
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NEXT:    s_endpgm
...
; GFX8-NEXT:    s_load_dword s1, s[6:7], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_i32 s9, s0, 0x40000
; GFX8-NEXT:    s_bfe_i32 s16, s1, 0x40000
; GFX8-NEXT:    s_bfe_i32 s11, s1, 0x40018
; GFX8-NEXT:    s_bfe_i32 s12, s1, 0x40014
; GFX8-NEXT:    s_bfe_i32 s13, s1, 0x40010
; GFX8-NEXT:    s_bfe_i32 s14, s1, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s15, s1, 0x40004
; GFX8-NEXT:    s_ashr_i32 s10, s1, 28
; GFX8-NEXT:    s_bfe_i32 s1, s1, 0x40008
; GFX8-NEXT:    v_mov_b32_e32 v4, s16
; GFX8-NEXT:    s_ashr_i32 s2, s0, 28
; GFX8-NEXT:    s_bfe_i32 s4, s0, 0x40018
; GFX8-NEXT:    s_bfe_i32 s5, s0, 0x40014
; GFX8-NEXT:    s_bfe_i32 s6, s0, 0x40010
; GFX8-NEXT:    s_bfe_i32 s7, s0, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s8, s0, 0x40004
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_i32_i24 v2, s9, v4, v2
; GFX8-NEXT:    v_mad_i32_i24 v2, s8, v5, v2
; GFX8-NEXT:    v_add_u32_sdwa v2, vcc, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:WORD_0
; GFX8-NEXT:    v_mad_i32_i24 v2, s7, v6, v2
; GFX8-NEXT:    v_mad_i32_i24 v2, s6, v7, v2
; GFX8-NEXT:    v_mad_i32_i24 v2, s5, v8, v2
; GFX8-NEXT:    v_mad_i32_i24 v2, s4, v9, v2
; GFX8-NEXT:    v_mov_b32_e32 v3, s10
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_bfe_i32 s8, s1, 0x40004
; GFX8-NEXT:    s_bfe_i32 s10, s1, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s15, s2, 0x40004
; GFX8-NEXT:    s_bfe_i32 s16, s2, 0x40000
; GFX8-NEXT:    s_bfe_i32 s17, s2, 0x4000c
; GFX8-NEXT:    s_bfe_i32 s4, s1, 0x40014
; GFX8-NEXT:    s_ashr_i32 s6, s1, 28
; GFX8-NEXT:    s_bfe_i32 s11, s2, 0x40014
; GFX8-NEXT:    s_bfe_i32 s12, s2, 0x40010
; GFX8-NEXT:    s_ashr_i32 s13, s2, 28
; GFX8-NEXT:    s_bfe_i32 s14, s2, 0x40018
; GFX8-NEXT:    s_bfe_i32 s2, s2, 0x40008
; GFX8-NEXT:    s_bfe_i32 s9, s1, 0x40000
