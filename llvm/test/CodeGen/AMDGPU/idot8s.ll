...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_lshr_b32 s0, s6, 12
; GFX10-DL-NEXT:    s_lshr_b32 s1, s7, 12
; GFX10-DL-NEXT:    s_bfe_i32 s2, s6, 0x40000
; GFX10-DL-NEXT:    s_bfe_i32 s3, s7, 0x40000
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v2, 12, s0
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v3, 12, s1
; GFX10-DL-NEXT:    s_bfe_i32 s8, s6, 0x40004
; GFX10-DL-NEXT:    s_bfe_i32 s9, s6, 0x40008
; GFX10-DL-NEXT:    s_bfe_i32 s10, s7, 0x40008
; GFX10-DL-NEXT:    s_bfe_i32 s0, s7, 0x40004
...
; GFX10-DL-NEXT:    s_bfe_i32 s1, s7, 0x40010
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s2, s3, v1
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s8, s0, v1
...
; GFX10-DL-NEXT:    s_bfe_i32 s0, s6, 0x40010
; GFX10-DL-NEXT:    v_mad_u32_u24 v1, v2, v3, v1
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s0, s1, v1
; GFX10-DL-NEXT:    s_bfe_i32 s0, s6, 0x40014
; GFX10-DL-NEXT:    s_bfe_i32 s1, s7, 0x40014
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s0, s1, v1
; GFX10-DL-NEXT:    s_bfe_i32 s0, s6, 0x40018
; GFX10-DL-NEXT:    s_bfe_i32 s1, s7, 0x40018
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s0, s1, v1
; GFX10-DL-NEXT:    s_ashr_i32 s0, s6, 28
; GFX10-DL-NEXT:    s_ashr_i32 s1, s7, 28
; GFX10-DL-NEXT:    v_mad_i32_i24 v1, s0, s1, v1
...
; GFX10-DL-NEXT:    s_bfe_u32 s2, s6, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s3, s6, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s8, s6, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s9, s6, 0x4000c
; GFX10-DL-NEXT:    s_and_b32 s10, s6, 15
; GFX10-DL-NEXT:    s_bfe_u32 s6, s6, 0x40004
; GFX10-DL-NEXT:    s_and_b32 s11, s7, 15
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s6, s10, s6
; GFX10-DL-NEXT:    s_bfe_u32 s10, s7, 0x40004
; GFX10-DL-NEXT:    v_pk_lshlrev_b16 v2, 12, s6 op_sel_hi:[0,1]
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s6, s11, s10
; GFX10-DL-NEXT:    s_bfe_u32 s11, s7, 0x4000c
; GFX10-DL-NEXT:    v_pk_lshlrev_b16 v3, 12, s6 op_sel_hi:[0,1]
; GFX10-DL-NEXT:    s_bfe_u32 s6, s7, 0x40008
; GFX10-DL-NEXT:    v_pk_ashrrev_i16 v2, 12, v2 op_sel_hi:[0,1]
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s8, s8, s9
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s6, s6, s11
...
; GFX10-DL-NEXT:    s_bfe_u32 s8, s7, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s6, s7, 0x40014
...
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s3, s8, s6
; GFX10-DL-NEXT:    v_pk_lshlrev_b16 v5, 12, s2 op_sel_hi:[0,1]
; GFX10-DL-NEXT:    v_pk_lshlrev_b16 v6, 12, s3 op_sel_hi:[0,1]
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v3, v3, v4
; GFX10-DL-NEXT:    s_bfe_u32 s10, s7, 0x40018
...
; GFX10-DL-NEXT:    s_mov_b32 s0, 0xffff
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_lshr_b32 s9, s6, 4
; GFX10-DL-NEXT:    s_lshr_b32 s16, s7, 4
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v6, 12, s9
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v12, 12, s16
; GFX10-DL-NEXT:    s_lshr_b32 s10, s6, 12
; GFX10-DL-NEXT:    s_lshr_b32 s17, s7, 12
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v2, 12, s6
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v3, 12, s7
...
; GFX10-DL-NEXT:    s_lshr_b32 s11, s6, 8
; GFX10-DL-NEXT:    s_lshr_b32 s18, s7, 8
...
; GFX10-DL-NEXT:    s_lshr_b32 s1, s6, 20
; GFX10-DL-NEXT:    s_lshr_b32 s2, s6, 16
; GFX10-DL-NEXT:    s_lshr_b32 s3, s6, 28
; GFX10-DL-NEXT:    s_lshr_b32 s8, s6, 24
; GFX10-DL-NEXT:    s_lshr_b32 s12, s7, 20
...
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v8, 12, s3
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v9, 12, s2
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v10, 12, s1
...
; GFX10-DL-NEXT:    s_lshr_b32 s13, s7, 16
; GFX10-DL-NEXT:    s_lshr_b32 s14, s7, 28
...
; GFX10-DL-NEXT:    s_lshr_b32 s15, s7, 24
; GFX10-DL-NEXT:    v_ashrrev_i16_e64 v6, 12, v6
