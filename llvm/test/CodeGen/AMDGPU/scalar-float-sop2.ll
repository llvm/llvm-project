...
; RUN: llc -mtriple=amdgpu11.50 < %s | FileCheck -check-prefixes=CHECK,GFX1150,GFX1150-SDAG %s
; RUN: llc -mtriple=amdgpu11.50 -global-isel < %s | FileCheck -check-prefixes=CHECK,GFX1150,GFX1150-GISEL %s
; RUN: llc -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=CHECK,GFX12,GFX12-SDAG %s
; RUN: llc -mtriple=amdgpu12.00 -global-isel < %s | FileCheck -check-prefixes=CHECK,GFX12,GFX12-GISEL %s
...
; GFX1150-SDAG-LABEL: fadd_f16:
; GFX1150-SDAG:       ; %bb.0:
; GFX1150-SDAG-NEXT:    s_add_f16 s0, s0, s1
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1150-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1150-GISEL-LABEL: fadd_f16:
; GFX1150-GISEL:       ; %bb.0:
; GFX1150-GISEL-NEXT:    s_add_f16 s0, s0, s1
...
; GFX1150-SDAG-LABEL: fsub_f16:
; GFX1150-SDAG:       ; %bb.0:
; GFX1150-SDAG-NEXT:    s_sub_f16 s0, s0, s1
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1150-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1150-GISEL-LABEL: fsub_f16:
; GFX1150-GISEL:       ; %bb.0:
; GFX1150-GISEL-NEXT:    s_sub_f16 s0, s0, s1
; GFX1150-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1150-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: fsub_f16:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_sub_f16 s0, s0, s1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: fsub_f16:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_sub_f16 s0, s0, s1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
   %sub = fsub half %a, %b
...
; GFX1150-SDAG-LABEL: fmul_f16:
; GFX1150-SDAG:       ; %bb.0:
; GFX1150-SDAG-NEXT:    s_mul_f16 s0, s0, s1
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1150-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1150-GISEL-LABEL: fmul_f16:
; GFX1150-GISEL:       ; %bb.0:
; GFX1150-GISEL-NEXT:    s_mul_f16 s0, s0, s1
; GFX1150-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1150-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: fmul_f16:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_mul_f16 s0, s0, s1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: fmul_f16:
; GFX12-GISEL:       ; %bb.0:
...
; GFX1150-SDAG-LABEL: fmac_f16:
; GFX1150-SDAG:       ; %bb.0:
; GFX1150-SDAG-NEXT:    s_fmac_f16 s0, s1, s2
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1150-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1150-GISEL-LABEL: fmac_f16:
; GFX1150-GISEL:       ; %bb.0:
; GFX1150-GISEL-NEXT:    s_fmac_f16 s0, s1, s2
; GFX1150-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1150-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: fmac_f16:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_fmac_f16 s0, s1, s2
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: fmac_f16:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_fmac_f16 s0, s1, s2
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
...
; GFX1150-SDAG-LABEL: fmac_f16_with_mov:
; GFX1150-SDAG:       ; %bb.0:
; GFX1150-SDAG-NEXT:    s_mov_b32 s3, s2
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    s_fmac_f16 s3, s0, s1
; GFX1150-SDAG-NEXT:    s_add_f16 s0, s3, s2
; GFX1150-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1150-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1150-GISEL-LABEL: fmac_f16_with_mov:
; GFX1150-GISEL:       ; %bb.0:
; GFX1150-GISEL-NEXT:    s_mov_b32 s3, s2
; GFX1150-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX1150-GISEL-NEXT:    s_fmac_f16 s3, s0, s1
; GFX1150-GISEL-NEXT:    s_add_f16 s0, s3, s2
; GFX1150-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX1150-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1150-GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: fmac_f16_with_mov:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_mov_b32 s3, s2
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX12-SDAG-NEXT:    s_fmac_f16 s3, s0, s1
; GFX12-SDAG-NEXT:    s_add_f16 s0, s3, s2
; GFX12-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: fmac_f16_with_mov:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_mov_b32 s3, s2
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX12-GISEL-NEXT:    s_fmac_f16 s3, s0, s1
; GFX12-GISEL-NEXT:    s_add_f16 s0, s3, s2
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
