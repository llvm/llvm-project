...
; RUN:  llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu8.02 -mattr=-flat-for-global -denormal-fp-math-f32=preserve-sign < %s | FileCheck %s -check-prefixes=VI
; RUN:  llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu8.03--amdhsa -denormal-fp-math-f32=ieee < %s | FileCheck %s -check-prefixes=GCN
; RUN:  llc -amdgpu-scalarize-global-loads=false  -mtriple=amdgpu10.30--amdhsa -denormal-fp-math-f32=ieee < %s | FileCheck %s -check-prefixes=GFX1030
...
; GFX1030:       ; %bb.0:
; GFX1030-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GFX1030-NEXT:    v_mov_b32_e32 v9, 0
; GFX1030-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-NEXT:    s_clause 0x1
; GFX1030-NEXT:    global_load_dwordx4 v[0:3], v9, s[2:3] offset:16
; GFX1030-NEXT:    global_load_dwordx4 v[4:7], v9, s[2:3]
...
; GFX1030-NEXT:    global_store_dwordx4 v9, v[0:3], s[0:1]
; GFX1030-NEXT:    s_endpgm
;
; EG-LABEL: udiv_v4i32:
; EG:       ; %bb.0:
...
; GFX1030-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-NEXT:    global_load_sbyte v2, v4, s[0:1]
