; RUN: opt -S -mtriple=amdgpu-unknown-unknown -passes=amdgpu-printf-runtime-binding < %s 2>&1 | FileCheck %s
...
entry:
  ...
  %call2 = call <2 x i64> (ptr, i32, i64, i64, i64, i64, i64, i64, i64, i64) @__ockl_hostcall_internal(ptr poison, i32 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9)
  ret void
}
