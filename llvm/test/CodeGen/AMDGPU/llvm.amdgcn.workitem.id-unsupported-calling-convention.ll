...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.42 -o - %s | FileCheck -check-prefixes=CHECK,SDAG %s
; RUN: llc -global-isel -mtriple=amdgpu9.42 -o - %s | FileCheck  -check-prefixes=CHECK,GISEL %s
