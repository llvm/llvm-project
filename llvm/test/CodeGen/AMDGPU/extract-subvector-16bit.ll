...
; RUN: llc -mtriple=amdgpu6.00-- -o - %s | FileCheck -check-prefix=SI %s
; RUN: llc -mtriple=amdgpu9.00-- -o - %s | FileCheck -check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu11.00-- -mattr=+real-true16 -o - %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00-- -mattr=-real-true16 -o - %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v1.l, 0x3d00
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s0, 0.5, v2.h
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s1, 0.5, v2.l
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s2, 0.5, v3.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.h, v1.l, 0x3900, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x3900, v1.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x3900, v1.l, s1
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.l, 0x3900, v1.l, s2
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_u16_e32 vcc_lo, 0x3800, v7.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, 0x3d00
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s0, 0x3801, v6.h
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s1, 0x3801, v7.l
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s2, 0x3801, v4.l
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s3, 0x3801, v5.l
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v3.h, v3.l, 0x3900, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v2.h, 0x3900, v3.l, s0
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e32 vcc_lo, 0x3801, v5.h
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s0, 0x3801, v4.h
; GFX11-TRUE16-NEXT:    v_cmp_gt_u16_e64 s34, 0x3801, v6.l
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x3900, v3.l, s2
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.l, 0x3900, v3.l, s3
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.h, 0x3900, v3.l, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x3900, v3.l, s0
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v2.l, 0x3900, v3.l, s34
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v3.l, 0x3900, v3.l, s1
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cmp_nge_f16_e32 vcc_lo, 0.5, v7.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, 0x3d00
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s0, 0.5, v6.h
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s1, 0.5, v7.l
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s2, 0.5, v4.l
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s3, 0.5, v5.l
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v3.h, v3.l, 0x3900, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v2.h, 0x3900, v3.l, s0
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e32 vcc_lo, 0.5, v5.h
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s0, 0.5, v4.h
