...
; GFX9-NEXT:    v_pack_b32_f16 v1, v3, v6
; GFX9-NEXT:    s_setpc_b64 s[30:31]
; GFX9-NEXT:  .LBB2_4:
; GFX9-NEXT:    ; implicit-def: $vgpr2_vgpr3_vgpr4_vgpr5
...
; GFX11-TRUE16-NEXT:    v_cmp_ge_f16_e64 s1, 0.5, v2.h
; GFX11-TRUE16-NEXT:    v_cmp_nge_f16_e64 s2, 0.5, v3.l
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.h, v0.l, 0x3d00, s1
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v2.l, 0x3d00, v0.l, s2
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v5, 0x3900
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v1, 0x3d00
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v3, v3, 0x5040100
...
; GFX11-FAKE16-NEXT:    v_cndmask_b32_e32 v4, 0x3d00, v5, vcc_lo
