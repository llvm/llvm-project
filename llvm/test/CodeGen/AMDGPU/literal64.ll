...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GCN-SDAG,GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GCN-GISEL,GFX1210,GFX1210-GISEL %s
...
; GFX1210-LABEL: v_mov_b64_double:
; GFX1210:       ; %bb.0:
...
; GFX1300-NEXT:    s_wait_bvhcnt 0x0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_mov_b64_e32 v[2:3], 0x4063233333333333
...
; GFX1300-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX1300-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1300-SDAG-NEXT:    s_mov_b32 s2, 1
; GFX1300-SDAG-NEXT:    s_mov_b64 s[0:1], 0x4063233333333333
...
; GFX1300-GISEL-NEXT:    s_wait_bvhcnt 0x0
; GFX1300-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1300-GISEL-NEXT:    s_mov_b32 s2, 1
; GFX1300-GISEL-NEXT:    s_mov_b64 s[0:1], 0x4063233333333333
; GFX1300-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
...
; GFX1300-NEXT:    s_wait_bvhcnt 0x0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_rsq_f64_e32 v[0:1], 0x4063233333333333
; GFX1300-NEXT:    s_set_pc_i64 s[30:31]
...
; GCN-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: v_add_neg_f64:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b64_e32 v[2:3], 0x4069033333333333
; GFX1210-GISEL-NEXT:    v_max_num_f64_e32 v[0:1], v[0:1], v[0:1]
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_add_f64_e64 v[0:1], -v[0:1], v[2:3]
...
; GFX1300-GISEL-NEXT:    v_mov_b64_e32 v[2:3], 0x4069033333333333
...
; GFX1210-SDAG-LABEL: v_cndmask:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v2, 0x40632000
; GFX1210-SDAG-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX1210-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1210-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0x40690333, v2, vcc_lo
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: v_cndmask:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v2, 0x40690333
; GFX1210-GISEL-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX1210-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1210-GISEL-NEXT:    v_cndmask_b32_e64 v1, v2, 0x40632000, vcc_lo
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1300-SDAG-LABEL: v_cndmask:
; GFX1300-SDAG:       ; %bb.0:
; GFX1300-SDAG-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX1300-SDAG-NEXT:    v_mov_b32_e32 v1, 0x40632000
; GFX1300-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1300-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1300-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0x40690333, v1, vcc_lo
; GFX1300-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1300-GISEL-LABEL: v_cndmask:
; GFX1300-GISEL:       ; %bb.0:
; GFX1300-GISEL-NEXT:    v_cmp_eq_f64_e32 vcc_lo, 0, v[0:1]
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v1, 0x40690333
; GFX1300-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0x33333333, 0, vcc_lo
; GFX1300-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1300-GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, 0x40632000, vcc_lo
; GFX1300-GISEL-NEXT:    ; return to shader part epilog
