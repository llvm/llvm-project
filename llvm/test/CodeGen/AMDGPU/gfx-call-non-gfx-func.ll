...
; RUN: llc -mtriple=amdgpu9.00--amdpal < %s | FileCheck -check-prefix=SDAG -enable-var-scope %s
; RUN: llc -global-isel -mtriple=amdgpu9.00--amdpal < %s | FileCheck -check-prefix=GISEL -enable-var-scope %s
