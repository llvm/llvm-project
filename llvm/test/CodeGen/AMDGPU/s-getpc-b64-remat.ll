...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -stress-regalloc=2 < %s | FileCheck %s -check-prefix=GFX9
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -stress-regalloc=2 < %s | FileCheck %s -check-prefix=GFX11
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -stress-regalloc=2 < %s | FileCheck %s -check-prefix=GFX12
