; RUN: not --crash llc -mtriple=amdgpu6.01 -filetype=null %s 2>&1 | FileCheck %s
; RUN: not --crash llc -mtriple=amdgpu8.02 -filetype=null %s 2>&1 | FileCheck %s
; RUN: not --crash llc -mtriple=amdgpu9.00 -filetype=null %s 2>&1 | FileCheck %s
