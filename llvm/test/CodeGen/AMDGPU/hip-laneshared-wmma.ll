...
; CHECK-NEXT: [[MATA:%[0-9]+]]:vreg_128_align2 = SCRATCH_LOAD_DWORDX4_SADDR killed [[SADDR1]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: [[SADDR2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 32
; CHECK-NEXT: [[MATB:%[0-9]+]]:vreg_128_align2 = SCRATCH_LOAD_DWORDX4_SADDR killed [[SADDR2]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: early-clobber [[MATD:%[0-9]+]]:vreg_256_align2 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, killed [[MATA]], 8, killed [[MATB]], 8, 0, 0, 0, implicit $exec
...
; VIDX-NEXT: [[SFR1:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[OFF1]], 2, implicit-def $scc
; VIDX-NEXT: $idx1 = S_SET_GPR_IDX_U32 [[SFR1]]
; VIDX-NEXT: [[MATA:%[0-9]+]]:vreg_128_align2 = V_LOAD_IDX $idx1, 0, 1, implicit $exec
; VIDX-NEXT: [[OFF2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 32
; VIDX-NEXT: [[SFR2:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[OFF2]], 2, implicit-def $scc
; VIDX-NEXT: $idx1 = S_SET_GPR_IDX_U32 [[SFR2]]
; VIDX-NEXT: [[MATB:%[0-9]+]]:vreg_128_align2 = V_LOAD_IDX $idx1, 0, 1, implicit $exec
; VIDX-NEXT: early-clobber [[MATD:%[0-9]+]]:vreg_256_align2 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, killed [[MATA]], 8, killed [[MATB]], 8, 0, 0, 0, implicit $exec
