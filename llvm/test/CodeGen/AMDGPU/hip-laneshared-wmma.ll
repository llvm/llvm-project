...
; CHECK: [[SADDR1:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 0
; CHECK-NEXT: [[MATA:%[0-9]+]]:vreg_128 = SCRATCH_LOAD_DWORDX4_SADDR killed [[SADDR1]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: [[SADDR2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 16
; CHECK-NEXT: [[MATB:%[0-9]+]]:vreg_128 = SCRATCH_LOAD_DWORDX4_SADDR killed [[SADDR2]], 0, 0, implicit $exec, implicit $flat_scr
; CHECK: early-clobber [[MATD:%[0-9]+]]:vreg_256 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, killed [[MATA]], 8, killed [[MATB]], 8, 0, 0, 0, implicit $exec
...
; CHECK: SCRATCH_STORE_DWORDX4_SADDR
; VIDX: [[OFF1:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 0
; VIDX-NEXT: [[SFR1:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[OFF1]], 2, implicit-def dead $scc
; VIDX-NEXT: [[MATA:%[0-9]+]]:vreg_128 = V_LOAD_IDX [[SFR1]], 0, implicit $exec
; VIDX-NEXT: [[OFF2:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 16
; VIDX-NEXT: [[SFR2:%[0-9]+]]:sreg_32_xexec_hi = S_LSHR_B32 [[OFF2]], 2, implicit-def dead $scc
; VIDX-NEXT: [[MATB:%[0-9]+]]:vreg_128 = V_LOAD_IDX [[SFR2]], 0, implicit $exec
; VIDX-NEXT: early-clobber [[MATD:%[0-9]+]]:vreg_256 = contract V_WMMA_F32_16X16X16_F16_w32_threeaddr 8, killed [[MATA]], 8, killed [[MATB]], 8, 0, 0, 0, implicit $exec
; VIDX-NEXT: [[OFF3:%[0-9]+]]:sreg_32_xexec_hi = S_MOV_B32 32
