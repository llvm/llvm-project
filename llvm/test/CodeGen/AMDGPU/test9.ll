...
; CHECK-LABEL: # Machine code for function test9: IsSSA, TracksLiveness
...
; EMPTY:
; CHECK: # End machine code for function test9.
; EMPTY:
; CHECK: Next-use distance of Register [[Reg12]] = 22051
; CHECK-NEXT: Next-use distance of Register [[Reg11]] = 63
...
; CHECK-NEXT: Next-use distance of Register [[Reg4]] = 7
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg2]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg1]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg13]] = 46
; CHECK-NEXT: Next-use distance of Register [[Reg14]] = 27
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 36
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 17
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg20]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg21]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg22]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg23]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg24]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg25]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 70008
; CHECK-NEXT: Next-use distance of Register [[Reg28]] = 70005
; CHECK-NEXT: Next-use distance of Register [[Reg30]] = 22022
; CHECK-NEXT: Next-use distance of Register [[Reg32]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg33]] = 22023
; CHECK-NEXT: Next-use distance of Register [[Reg35]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg37]] = 129004
; CHECK-NEXT: Next-use distance of Register [[Reg39]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg40]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg41]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg42]] = 2
...
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg50]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg52]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg53]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg54]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg56]] = 4
...
; CHECK-NEXT: Next-use distance of Register [[Reg65]] = 22002
; CHECK-NEXT: Next-use distance of Register [[Reg66]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg38]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg36]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg67]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg69]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg70]] = 4
