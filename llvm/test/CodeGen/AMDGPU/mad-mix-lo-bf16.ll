...
; GFX1210-LABEL: mixlo_simple:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2
...
; GFX1210-LABEL: mixlo_simpl_no_flush:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2
...
; GFX1210-LABEL: v_mad_mixlo_bf16_bf16lo_bf16lo_bf16lo:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1210-LABEL: v_mad_mixlo_bf16_bf16lo_bf16lo_bf16lo_no_flush:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,1]
...
; GFX1210-LABEL: v_mad_mixlo_bf16_bf16lo_bf16lo_f32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0]
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
...
; GFX1210-LABEL: v_mad_mixlo_bf16_bf16lo_bf16lo_f32_clamp_post_cvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0] clamp
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
  %result = tail call float @llvm.fmuladd.f32(float %src0.ext, float %src1.ext, float %src2)
...
; GFX1210-LABEL: v_mad_mixlo_bf16_bf16lo_bf16lo_f32_clamp_pre_cvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v2 op_sel_hi:[1,1,0] clamp
...
; GFX1210-LABEL: v_mad_mix_v3f32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v6, v0, v2, v4 op_sel_hi:[1,1,1]
...
; GFX1210-NEXT:    v_fma_mixhi_bf16 v6, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1]
...
; GFX1210-LABEL: v_mad_mix_v4f32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v7, 0xffff0000, v1
; GFX1210-NEXT:    v_lshlrev_b32_e32 v6, 16, v1
; GFX1210-NEXT:    v_and_b32_e32 v1, 0xffff0000, v0
; GFX1210-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX1210-NEXT:    v_and_b32_e32 v9, 0xffff0000, v3
; GFX1210-NEXT:    v_lshlrev_b32_e32 v8, 16, v3
; GFX1210-NEXT:    v_and_b32_e32 v3, 0xffff0000, v2
; GFX1210-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX1210-NEXT:    v_and_b32_e32 v11, 0xffff0000, v5
; GFX1210-NEXT:    v_and_b32_e32 v13, 0xffff0000, v4
; GFX1210-NEXT:    v_dual_lshlrev_b32 v12, 16, v4 :: v_dual_lshlrev_b32 v10, 16, v5
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], v[2:3], v[12:13]
; GFX1210-NEXT:    v_pk_fma_f32 v[2:3], v[6:7], v[8:9], v[10:11]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v1
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v1, v2, v3
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1210-LABEL: v_mad_mix_v2f32_clamp_postcvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v5, 0xffff0000, v0
...
; GFX1210-LABEL: v_mad_mix_v3f32_clamp_postcvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-LABEL: v_mad_mix_v4f32_clamp_postcvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v7, 0xffff0000, v0
; GFX1210-NEXT:    v_dual_lshlrev_b32 v6, 16, v0 :: v_dual_lshlrev_b32 v8, 16, v1
; GFX1210-NEXT:    v_and_b32_e32 v9, 0xffff0000, v1
; GFX1210-NEXT:    v_and_b32_e32 v1, 0xffff0000, v2
...
; GFX1210-LABEL: v_mad_mix_v2f32_clamp_postcvt_lo:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v5, 0xffff0000, v0
...
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_pk_max_num_bf16 v1, v0, v0 clamp
; GFX1210-NEXT:    v_bfi_b32 v0, 0xffff, v1, v0
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <2 x bfloat> %src0 to <2 x float>
  %src1.ext = fpext <2 x bfloat> %src1 to <2 x float>
  %src2.ext = fpext <2 x bfloat> %src2 to <2 x float>
...
; GFX1210-LABEL: v_mad_mix_v2f32_clamp_postcvt_hi:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v5, 0xffff0000, v0
...
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GFX1210-NEXT:    v_pk_max_num_bf16 v1, v1, v1 clamp
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1210-LABEL: v_mad_mix_v2f32_clamp_precvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v5, 0xffff0000, v0
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_pk_fma_f32 v[0:1], v[4:5], v[6:7], v[0:1]
; GFX1210-NEXT:    v_max_num_f32_e64 v1, v1, v1 clamp
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_max_num_f32_e64 v0, v0, v0 clamp
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v1
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <2 x bfloat> %src0 to <2 x float>
  %src1.ext = fpext <2 x bfloat> %src1 to <2 x float>
...
; GFX1210-LABEL: v_mad_mix_v3f32_clamp_precvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mix_f32_bf16 v6, v0, v2, v4 op_sel_hi:[1,1,1] clamp
; GFX1210-NEXT:    v_fma_mix_f32_bf16 v0, v0, v2, v4 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; GFX1210-NEXT:    v_fma_mix_f32_bf16 v1, v1, v3, v5 op_sel_hi:[1,1,1] clamp
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v6, v0
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v1, v1, s0
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <3 x bfloat> %src0 to <3 x float>
  %src1.ext = fpext <3 x bfloat> %src1 to <3 x float>
...
; GFX1210-LABEL: v_mad_mix_v4f32_clamp_precvt:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v7, 0xffff0000, v0
...
; GFX1210-NEXT:    v_pk_fma_f32 v[0:1], v[6:7], v[0:1], v[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_max_num_f32_e64 v2, v5, v5 clamp
; GFX1210-NEXT:    v_max_num_f32_e64 v1, v1, v1 clamp
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_max_num_f32_e64 v0, v0, v0 clamp
; GFX1210-NEXT:    v_max_num_f32_e64 v3, v4, v4 clamp
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v1, v3, v2
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext <4 x bfloat> %src0 to <4 x float>
  %src1.ext = fpext <4 x bfloat> %src1 to <4 x float>
  %src2.ext = fpext <4 x bfloat> %src2 to <4 x float>
...
; GFX1210-LABEL: mixlo_fptrunc:
; GFX1210:       ; %bb.0: ; %.entry
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, 0
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
.entry:
  %mul = fmul float %a, %b
...
; GFX1210-LABEL: mixlo_fptrunc_no_flush:
; GFX1210:       ; %bb.0: ; %.entry
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, 0
...
; GFX1210-LABEL: mixlo_fptrunc_abs_src_mod:
; GFX1210:       ; %bb.0: ; %.entry
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, |v0|, v1, 0
...
; GFX1210-LABEL: mixlo_fptrunc_neg_src_mod:
; GFX1210:       ; %bb.0: ; %.entry
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_fma_mixlo_bf16 v0, -v0, v1, 0
