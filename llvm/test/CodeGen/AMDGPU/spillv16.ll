...
; GCN-TRUE16-NEXT:    scratch_load_u16 v1, off, s32 offset:2 ; 2-byte Folded Reload
; GCN-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GCN-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v1.l
...
; GCN-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GCN-TRUE16-NEXT:    scratch_load_u16 v1, off, s32 offset:6 ; 2-byte Folded Reload
; GCN-TRUE16-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
; GCN-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GCN-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
...
; GFX1250-FAKE16-NEXT:    s_wait_storecnt 0x0
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
; GFX12-TRUE16-LABEL: spill_i16_alu_two_vals:
; GFX12-TRUE16:       ; %bb.0: ; %entry
; GFX12-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_expcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
; GFX12-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 offset:6 ; 2-byte Folded Spill
; GFX12-TRUE16-NEXT:    ;;#ASMSTART
; GFX12-TRUE16-NEXT:    ;;#ASMEND
; GFX12-TRUE16-NEXT:    scratch_load_d16_b16 v0, off, s32 offset:4 scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    scratch_load_d16_hi_b16 v0, off, s32 offset:6 th:TH_LOAD_LU ; 2-byte Folded Reload
; GFX12-TRUE16-NEXT:    v_add_nc_u16 v0.l, 0x7b, v0.l
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    scratch_store_d16_hi_b16 off, v0, s32 scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    scratch_store_b16 off, v0, s32 offset:4 scope:SCOPE_SYS
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
entry:
  %alloca = alloca i16, i32 1, align 4, addrspace(5)
