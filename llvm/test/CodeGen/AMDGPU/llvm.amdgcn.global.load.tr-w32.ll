...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1200 -verify-machineinstrs -mattr=+wavefrontsize32,-wavefrontsize64 < %s | FileCheck -check-prefix=GFX1200 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1200 -verify-machineinstrs -mattr=+wavefrontsize32,-wavefrontsize64 < %s | FileCheck -check-prefix=GFX1200 %s
...
; GFX1200-LABEL: global_load_tr_b64:
; GFX1200:       ; %bb.0: ; %entry
; GFX1200-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1200-NEXT:    v_mov_b32_e32 v2, 0
; GFX1200-NEXT:    s_wait_kmcnt 0x0
; GFX1200-NEXT:    global_load_tr_b64 v[0:1], v2, s[0:1] offset:32
...
; GFX1200-LABEL: global_load_tr_b128_i16:
; GFX1200:       ; %bb.0: ; %entry
; GFX1200-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1200-NEXT:    v_mov_b32_e32 v4, 0
; GFX1200-NEXT:    s_wait_kmcnt 0x0
; GFX1200-NEXT:    global_load_tr_b128 v[0:3], v4, s[0:1] offset:32
; GFX1200-NEXT:    s_wait_loadcnt 0x0
; GFX1200-NEXT:    global_store_b128 v4, v[0:3], s[2:3]
; GFX1200-NEXT:    s_nop 0
; GFX1200-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1200-NEXT:    s_endpgm
entry:
