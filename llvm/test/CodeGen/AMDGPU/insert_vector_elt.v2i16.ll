...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_perm_b32 v2, v1, v2, 0x5040302
; GFX11-TRUE16-NEXT:    global_store_b32 v0, v2, s[0:1]
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v0, v3, s4, 0x5040100
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v1, v3, s4, 0x5040100
; GFX11-TRUE16-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v3, v5, s4, 0x5040100
; GFX11-TRUE16-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_perm_b32 v3, v9, s4, 0x5040100
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    s_clause 0x1
