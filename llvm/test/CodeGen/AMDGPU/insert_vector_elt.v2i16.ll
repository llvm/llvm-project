...
; GFX11-NEXT:    v_lshl_or_b32 v0, v8, 16, v0
; GFX11-NEXT:    global_store_b128 v4, v[0:3], s[4:5]
; GFX11-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
...
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v14, v9, vcc
; GFX9-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GFX9-NEXT:    v_lshl_or_b32 v3, v10, 16, v3
...
; GFX9-NEXT:    v_lshl_or_b32 v7, v13, 16, v7
...
; GFX11-NEXT:    v_cndmask_b32_e64 v9, v9, s0, s2
; GFX11-NEXT:    s_cselect_b32 s2, -1, 0
; GFX11-NEXT:    s_cmp_eq_u32 s1, 3
...
; GFX11-NEXT:    v_cndmask_b32_e64 v5, v5, s0, s3
; GFX11-NEXT:    s_cselect_b32 s1, -1, 0
...
; GFX11-NEXT:    v_cndmask_b32_e64 v14, v16, s0, s6
; GFX11-NEXT:    v_and_b32_e32 v5, 0xffff, v5
; GFX11-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; GFX11-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX11-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX11-NEXT:    v_lshl_or_b32 v7, v10, 16, v7
; GFX11-NEXT:    v_lshl_or_b32 v6, v12, 16, v6
; GFX11-NEXT:    v_lshl_or_b32 v5, v13, 16, v5
; GFX11-NEXT:    v_lshl_or_b32 v4, v14, 16, v4
