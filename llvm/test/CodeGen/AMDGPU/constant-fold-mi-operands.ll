; RUN: llc -mtriple=amdgpu6.01--amdpal < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -mtriple=amdgpu8.02--amdpal -mattr=-flat-for-global < %s | FileCheck -check-prefix=GCN %s
