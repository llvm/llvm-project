...
; GCN-LABEL: bitcast_v9i32_to_v9f32_inreg:
; GCN:       ; %bb.0:
...
;
; VI-LABEL: bitcast_v9i32_to_v9f32_inreg:
; VI:       ; %bb.0:
...
;
; GFX9-LABEL: bitcast_v9i32_to_v9f32_inreg:
; GFX9:       ; %bb.0:
...
;
; GFX11-LABEL: bitcast_v9i32_to_v9f32_inreg:
; GFX11:       ; %bb.0:
...
; GCN-LABEL: bitcast_v9f32_to_v9i32_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s25, 0
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; VI-LABEL: bitcast_v9f32_to_v9i32_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v9f32_to_v9i32_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v9f32_to_v9i32_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GCN-LABEL: bitcast_v9i32_to_v18i16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s25, 0
...
; GCN-NEXT:    v_alignbit_b32 v17, s4, v0, 16
...
;
; VI-LABEL: bitcast_v9i32_to_v18i16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX9-LABEL: bitcast_v9i32_to_v18i16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX11-LABEL: bitcast_v9i32_to_v18i16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_cmp_lg_u32 s21, 0
; GFX11-NEXT:    s_mov_b32 s4, 0
...
; GCN-LABEL: bitcast_v18i16_to_v9i32_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff, v10
...
; GCN-NEXT:    v_or_b32_e32 v7, v0, v12
; GCN-NEXT:    v_or_b32_e32 v8, v1, v11
...
; GCN-NEXT:    v_or_b32_e32 v0, v11, v1
...
;
; VI-LABEL: bitcast_v18i16_to_v9i32_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX9-LABEL: bitcast_v18i16_to_v9i32_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18i16_to_v9i32_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v9i32_to_v18f16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s25, 0
...
; GCN-NEXT:    s_lshr_b32 s5, s23, 16
; GCN-NEXT:    s_lshr_b32 s6, s22, 16
; GCN-NEXT:    s_lshr_b32 s7, s21, 16
; GCN-NEXT:    s_lshr_b32 s8, s20, 16
; GCN-NEXT:    s_lshr_b32 s9, s19, 16
; GCN-NEXT:    s_lshr_b32 s10, s18, 16
; GCN-NEXT:    s_lshr_b32 s11, s17, 16
; GCN-NEXT:    s_lshr_b32 s12, s16, 16
...
; GCN-NEXT:    v_cvt_f32_f16_e32 v13, s6
; GCN-NEXT:    v_cvt_f32_f16_e32 v11, s7
; GCN-NEXT:    v_cvt_f32_f16_e32 v9, s8
; GCN-NEXT:    v_cvt_f32_f16_e32 v7, s9
; GCN-NEXT:    v_cvt_f32_f16_e32 v5, s10
; GCN-NEXT:    v_cvt_f32_f16_e32 v3, s11
; GCN-NEXT:    v_cvt_f32_f16_e32 v1, s12
; GCN-NEXT:    s_mov_b64 vcc, exec
...
;
; VI-LABEL: bitcast_v9i32_to_v18f16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX9-LABEL: bitcast_v9i32_to_v18f16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX11-LABEL: bitcast_v9i32_to_v18f16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_cmp_lg_u32 s21, 0
; GFX11-NEXT:    s_mov_b32 s4, 0
...
; GCN-LABEL: bitcast_v18f16_to_v9i32_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GCN-NEXT:    v_cvt_f16_f32_e32 v26, s17
; GCN-NEXT:    v_cvt_f16_f32_e32 v25, s16
; GCN-NEXT:    v_cvt_f16_f32_e32 v24, s19
; GCN-NEXT:    v_cvt_f16_f32_e32 v23, s18
; GCN-NEXT:    v_cvt_f16_f32_e32 v22, s21
; GCN-NEXT:    v_cvt_f16_f32_e32 v21, s20
; GCN-NEXT:    v_cvt_f16_f32_e32 v20, s23
; GCN-NEXT:    v_cvt_f16_f32_e32 v19, s22
; GCN-NEXT:    v_cvt_f16_f32_e32 v18, s25
; GCN-NEXT:    v_cvt_f16_f32_e32 v17, s24
; GCN-NEXT:    v_cvt_f16_f32_e32 v16, s27
; GCN-NEXT:    v_cvt_f16_f32_e32 v15, s26
; GCN-NEXT:    v_cvt_f16_f32_e32 v14, s29
; GCN-NEXT:    v_cvt_f16_f32_e32 v13, s28
; GCN-NEXT:    v_cvt_f16_f32_e32 v12, v1
; GCN-NEXT:    v_cvt_f16_f32_e32 v11, v0
; GCN-NEXT:    s_and_b64 s[4:5], vcc, exec
; GCN-NEXT:    v_cvt_f16_f32_e32 v10, v3
...
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 16, v12
...
;
; VI-LABEL: bitcast_v18f16_to_v9i32_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v18f16_to_v9i32_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18f16_to_v9i32_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v9f32_to_v18i16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s25, 0
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; VI-LABEL: bitcast_v9f32_to_v18i16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v9f32_to_v18i16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v9f32_to_v18i16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v18i16_to_v9f32_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v9, v2
; GCN-NEXT:    v_mov_b32_e32 v10, v0
...
;
; VI-LABEL: bitcast_v18i16_to_v9f32_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX9-LABEL: bitcast_v18i16_to_v9f32_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18i16_to_v9f32_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v9f32_to_v18f16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; VI-LABEL: bitcast_v9f32_to_v18f16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v9f32_to_v18f16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v9f32_to_v18f16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v18f16_to_v9f32_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; GCN-NEXT:    v_cvt_f16_f32_e32 v26, s17
...
;
; VI-LABEL: bitcast_v18f16_to_v9f32_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v18f16_to_v9f32_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18f16_to_v9f32_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v18i16_to_v18f16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GCN-NEXT:    v_add_i32_e32 v14, vcc, 3, v19
...
;
; VI-LABEL: bitcast_v18i16_to_v18f16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
;
; GFX9-LABEL: bitcast_v18i16_to_v18f16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18i16_to_v18f16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
...
; GCN-LABEL: bitcast_v18f16_to_v18i16_inreg:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
;
; VI-LABEL: bitcast_v18f16_to_v18i16_inreg:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_cmp_lg_u32 s25, 0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: bitcast_v18f16_to_v18i16_inreg:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_cmp_lg_u32 s25, 0
...
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: bitcast_v18f16_to_v18i16_inreg:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s15, s3
; GFX11-NEXT:    s_mov_b32 s14, s2
