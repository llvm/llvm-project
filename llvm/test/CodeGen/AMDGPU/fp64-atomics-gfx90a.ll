...
; GFX1210-NEXT:    s_load_b96 s[4:6], s[0:1], 0x34
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b64 v[0:1], s[4:5] :: v_dual_mov_b32 v2, s6
...
; GFX1210-NEXT:    s_load_b96 s[8:10], s[0:1], 0x34
; GFX1210-NEXT:    s_load_b128 s[4:7], s[0:1], 0x24
; GFX1210-NEXT:    s_mov_b32 s2, 4
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x44
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b64 v[0:1], s[8:9] :: v_dual_mov_b32 v2, s10
; GFX1210-NEXT:    buffer_atomic_add_f64 v[0:1], v2, s[4:7], s2 offen th:TH_ATOMIC_NT_RETURN
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b64 v[0:1], s[8:9] :: v_dual_mov_b32 v2, s10
; GFX1210-NEXT:    buffer_atomic_min_num_f64 v[0:1], v2, s[4:7], s2 offen th:TH_ATOMIC_NT_RETURN
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b64 v[0:1], s[8:9] :: v_dual_mov_b32 v2, s10
; GFX1210-NEXT:    buffer_atomic_max_num_f64 v[0:1], v2, s[4:7], s2 offen th:TH_ATOMIC_NT_RETURN
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX940-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_atomic_fadd_f64_noret:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1210-NEXT:    v_mov_b32_e32 v1, s3
; GFX1210-NEXT:    global_atomic_min_num_f64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
main_body:
...
; GFX1210-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1210-NEXT:    v_mov_b32_e32 v1, s3
; GFX1210-NEXT:    global_atomic_max_num_f64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
main_body:
...
; GFX1210-NEXT:    v_mbcnt_lo_u32_b32 v0, s3, 0
; GFX1210-NEXT:    s_mov_b32 s4, exec_lo
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_add_f64_e32 v[0:1], v[2:3], v[4:5]
; GFX1210-NEXT:    global_atomic_cmpswap_b64 v[0:1], v6, v[0:3], s[0:1] th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-NEXT:    s_cbranch_execnz .LBB39_2
; GFX1210-NEXT:  .LBB39_3:
; GFX1210-NEXT:    s_endpgm
main_body:
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB41_2
; GFX1210-NEXT:  .LBB41_3:
; GFX1210-NEXT:    s_endpgm
main_body:
...
;
; GFX1210-LABEL: global_atomic_fadd_f64_rtn:
; GFX1210:       ; %bb.0: ; %main_body
...
; GFX1210-NEXT:  .LBB44_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-NEXT:    s_cbranch_execnz .LBB44_1
...
; GFX1210-NEXT:    global_load_b64 v[2:3], v[0:1], off
; GFX1210-NEXT:    s_mov_b32 s0, 0
; GFX1210-NEXT:  .LBB46_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_mov_b64_e32 v[4:5], v[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    s_cbranch_execnz .LBB46_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    global_atomic_max_num_f64 v[0:1], v[0:1], v[2:3], off th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    global_atomic_min_num_f64 v[0:1], v[0:1], v[2:3], off th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB49_2
; GFX1210-NEXT:  .LBB49_3:
; GFX1210-NEXT:    s_endpgm
main_body:
  %ret = atomicrmw fadd ptr addrspace(1) %ptr, double 4.0 syncscope("agent") seq_cst
  ret void
...
; GFX1210-NEXT:    s_mov_b32 s2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    flat_load_b64 v[2:3], v4, s[0:1]
; GFX1210-NEXT:  .LBB50_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    v_add_f64_e32 v[0:1], 4.0, v[2:3]
; GFX1210-NEXT:    flat_atomic_cmpswap_b64 v[0:1], v4, v[0:3], s[0:1] th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_inv scope:SCOPE_SYS
; GFX1210-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[0:1], v[2:3]
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB50_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_endpgm
main_body:
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB52_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_endpgm
main_body:
...
; GFX1210-NEXT:    s_mov_b32 s0, 0
; GFX1210-NEXT:  .LBB53_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    v_mov_b64_e32 v[4:5], v[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    s_cbranch_execnz .LBB53_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX1210-NEXT:    flat_load_b64 v[2:3], v[0:1]
; GFX1210-NEXT:    s_mov_b32 s0, 0
; GFX1210-NEXT:  .LBB55_1: ; %atomicrmw.start
; GFX1210-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    v_mov_b64_e32 v[4:5], v[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    s_cbranch_execnz .LBB55_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX1210-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX940-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_atomic_fadd_f64_noret:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f64_rtn:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
; GFX1210-NEXT:    s_cbranch_execnz .LBB58_1
; GFX1210-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX1210-NEXT:    s_endpgm
main_body:
  %ret = atomicrmw fadd ptr %ptr, double 4.0 syncscope("agent") seq_cst
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_min_num_f64 v[0:1], v[0:1], v[2:3] th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_max_num_f64 v[0:1], v[0:1], v[2:3] th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cvt_f64_u32_e32 v[0:1], s2
; GFX1210-NEXT:    s_load_b64 s[2:3], s[0:1], 0x2c
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_mul_f64 v[0:1], s[2:3], v[0:1] :: v_dual_mov_b32 v2, s0
...
; GFX940-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_atomic_fadd_f64_noret_from_flat_intrinsic:
; GFX1210:       ; %bb.0: ; %main_body
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: local_atomic_fadd_f64_rtn_from_flat_intrinsic:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB68_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_bcnt1_i32_b32 s2, s2
; GFX1210-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cmpx_eq_u32_e32 0, v0
; GFX1210-NEXT:    s_cbranch_execz .LBB69_2
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_bcnt1_i32_b32 s2, s2
; GFX1210-NEXT:    s_load_b32 s0, s[0:1], 0x24
; GFX1210-NEXT:    s_wait_alu 0xfffe
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f64_intrinsic_rtn__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f64_intrinsic_rtn__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f64 v[0:1], v[0:1], v[2:3] offset:-4088 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f64_intrinsic_noret__posoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: flat_atomic_fadd_f64_intrinsic_noret__negoffset:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f64 v[0:1], v[2:3] offset:-4088
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_min_num_f64 v[0:1], v[0:1], v[2:3] offset:-4088 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_min_num_f64 v[0:1], v[2:3] offset:-4088
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_max_num_f64 v[0:1], v[0:1], v[2:3] offset:-4088 th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    flat_atomic_max_num_f64 v[0:1], v[2:3] offset:-4088
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
