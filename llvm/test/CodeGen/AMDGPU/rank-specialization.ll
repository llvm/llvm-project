...
; RUN: opt -mtriple=amdgcn-amd-amdhsa -verify-each -passes=amdgpu-rank-specialization,instcombine,simplifycfg -S -o - %s > %t
; RUN: FileCheck --check-prefixes=CHECK %s < %t
; RUN: FileCheck --check-prefixes=ATTRMD %s < %t
...
;
;
; CHECK-LABEL: define internal void @test_kernel_1.rank_0_2_3_4_5_6_7(
...
;
;
; CHECK-LABEL: define internal void @test_kernel_1.rank_1(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_2.rank_2_3_4_5_7(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_2.rank_6(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_2.rank_1(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_2.rank_0(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_3.rank_2_4_5_7(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_3.rank_3(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_3.rank_6(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_3.rank_1(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_3.rank_0(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_COND:.*]]
; CHECK:       [[FOR_COND]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_4.rank_2_3_4_5(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_BODY:.*]]
; CHECK:       [[FOR_COND_CLEANUP:.*]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_4.rank_0_1_6_7(
; CHECK-SAME: ) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    br label %[[FOR_BODY:.*]]
; CHECK:       [[FOR_COND_CLEANUP:.*]]:
...
;
;
; CHECK-LABEL: define internal void @test_kernel_7.rank_0_1(
...
;
;
; CHECK-LABEL: define internal void @test_kernel_7.rank_2_3_4_5_6_7(
; CHECK-SAME: ptr [[BASE:%.*]]) #[[ATTR3]] {
; CHECK-NEXT:  [[ENTRY:.*:]]
...
; CHECK-NEXT:    ret void
;
; ATTRMD: declare !callback !0 void @llvm.amdgcn.wavegroup.rank.p0(i32 immarg, ptr) #4
; ATTRMD: !0 = !{!1}
; ATTRMD: !1 = !{i64 1, i1 false}
