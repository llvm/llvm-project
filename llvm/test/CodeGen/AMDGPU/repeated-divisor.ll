...
; GFX6-NEXT:    v_div_fixup_f32 v4, v6, v4, 1.0
; GFX6-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GFX6-NEXT:    v_mul_f32_e32 v5, v5, v4
; GFX6-NEXT:    v_fma_f32 v6, -v7, v8, 1.0
; GFX6-NEXT:    v_fma_f32 v6, v6, v8, v8
; GFX6-NEXT:    v_div_scale_f32 v8, vcc, 1.0, v2, 1.0
; GFX6-NEXT:    v_mul_f32_e32 v9, v8, v6
; GFX6-NEXT:    v_fma_f32 v10, -v7, v9, v8
; GFX6-NEXT:    v_fma_f32 v9, v10, v6, v9
; GFX6-NEXT:    v_fma_f32 v7, -v7, v9, v8
; GFX6-NEXT:    v_div_fmas_f32 v6, v7, v6, v9
; GFX6-NEXT:    v_div_fixup_f32 v2, v6, v2, 1.0
...
; GFX6-NEXT:    v_div_scale_f32 v9, s[4:5], v4, v4, 1.0
...
; GFX6-NEXT:    v_div_scale_f32 v11, vcc, 1.0, v4, 1.0
...
; GFX6-NEXT:    v_div_fixup_f32 v4, v9, v4, 1.0
...
; GFX6-NEXT:    v_div_scale_f32 v11, s[4:5], v5, v5, 1.0
; GFX6-NEXT:    v_rcp_f32_e32 v13, v11
; GFX6-NEXT:    v_div_fmas_f32 v9, v10, v9, v12
; GFX6-NEXT:    v_div_fixup_f32 v8, v9, v8, 1.0
; GFX6-NEXT:    v_div_scale_f32 v10, vcc, 1.0, v5, 1.0
; GFX6-NEXT:    v_fma_f32 v9, -v11, v13, 1.0
; GFX6-NEXT:    v_fma_f32 v9, v9, v13, v13
; GFX6-NEXT:    v_mul_f32_e32 v12, v10, v9
; GFX6-NEXT:    v_fma_f32 v13, -v11, v12, v10
...
; GFX6-NEXT:    v_fma_f32 v10, -v11, v12, v10
; GFX6-NEXT:    v_div_fmas_f32 v9, v10, v9, v12
; GFX6-NEXT:    v_div_fixup_f32 v5, v9, v5, 1.0
; GFX6-NEXT:    v_mul_f32_e32 v2, v2, v4
; GFX6-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX6-NEXT:    v_mul_f32_e32 v1, v1, v5
; GFX6-NEXT:    v_cvt_f16_f32_e32 v2, v2
...
; GFX6-NEXT:    v_mul_f32_e32 v0, v0, v4
; GFX6-NEXT:    v_mul_f32_e32 v7, v7, v8
; GFX6-NEXT:    v_mul_f32_e32 v4, v6, v8
; GFX6-NEXT:    v_or_b32_e32 v1, v1, v2
; GFX6-NEXT:    v_cvt_f16_f32_e32 v2, v3
; GFX6-NEXT:    v_cvt_f16_f32_e32 v3, v4
; GFX6-NEXT:    v_cvt_f16_f32_e32 v4, v7
; GFX6-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
