...
; GFX942-NEXT:    global_store_dwordx3 v6, v[2:4], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
  %vec1 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
...
; GFX942-NEXT:    global_store_dwordx3 v8, v[0:2], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
  %vec1 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
...
; GFX942-NEXT:    global_store_dwordx3 v8, v[4:6], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
  %vec1 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
...
; GFX942-NEXT:    v_mov_b32_e32 v4, v0
; GFX942-NEXT:    global_store_dwordx3 v8, v[2:4], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
  %vec1 = call <4 x ptr addrspace(3)> asm "; def $0", "=v"()
