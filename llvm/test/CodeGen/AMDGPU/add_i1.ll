...
; GFX9-NEXT:    ; implicit-def: $sgpr6_sgpr7
...
; GFX9-NEXT:    s_or_saveexec_b64 s[8:9], s[0:1]
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
...
; GFX9-NEXT:    s_or_b64 s[6:7], s[2:3], s[4:5]
; GFX9-NEXT:  .LBB2_4: ; %endif
; GFX9-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_xor_b64 s[2:3], s[6:7], -1
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[2:3]
; GFX9-NEXT:    global_store_byte v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
...
; GFX10-NEXT:    s_or_saveexec_b32 s7, s0
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-NEXT:    s_xor_b32 exec_lo, exec_lo, s7
...
; GFX11-NEXT:    s_or_saveexec_b32 s7, s0
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s7
