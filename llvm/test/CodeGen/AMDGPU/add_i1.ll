...
; GFX9-NEXT:    global_load_ubyte v1, v3, s[2:3] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_load_ubyte v2, v3, s[6:7] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_xor_b32_e32 v1, v1, v2
; GFX9-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX9-NEXT:    global_store_byte v3, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    global_load_ubyte v1, v3, s[2:3] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    global_load_ubyte v2, v3, s[6:7] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_xor_b32_e32 v1, v1, v2
; GFX10-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX10-NEXT:    global_store_byte v3, v1, s[0:1]
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    global_load_u8 v1, v3, s[2:3] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_u8 v2, v3, s[4:5] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_xor_b32_e32 v1, v1, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v1, 1, v1
; GFX11-NEXT:    global_store_b8 v3, v1, s[0:1]
; GFX11-NEXT:    s_endpgm
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v0, v1, s[8:9] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v0, v1, s[2:3] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_ubyte v0, v1, s[6:7] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    global_load_ubyte v0, v1, s[2:3] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_u8 v0, v1, s[4:5] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
