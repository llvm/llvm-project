...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v1 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v3i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_pk_sub_u16 v0, v0, v2 clamp
; GFX11-NEXT:    v_pk_sub_u16 v1, v1, v3 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v2i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v2 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, v1, v3 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v3i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v3 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, v1, v4 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, v2, v5 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v4 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, v1, v5 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, v2, v6 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v3, v3, v7 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: v_usubsat_v8i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_nc_u32_e64 v0, v0, v8 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v1, v1, v9 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v2, v2, v10 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v3, v3, v11 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v4, v4, v12 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v5, v5, v13 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v6, v6, v14 clamp
; GFX11-NEXT:    v_sub_nc_u32_e64 v7, v7, v15 clamp
; GFX11-NEXT:    s_setpc_b64 s[30:31]
