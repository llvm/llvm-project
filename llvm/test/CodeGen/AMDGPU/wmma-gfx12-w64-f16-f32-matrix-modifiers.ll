...
; GFX1170-TRUE16-LABEL: test_swmmac_f32_16x16x32_f16_negA:
; GFX1170-TRUE16:       ; %bb.0: ; %bb
; GFX1170-TRUE16-NEXT:    ; kill: def $vgpr10_hi16 killed $sgpr0 killed $exec
; GFX1170-TRUE16-NEXT:    v_swmmac_f32_16x16x32_f16 v[6:9], v[0:1], v[2:5], v10 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GFX1170-TRUE16-NEXT:    global_store_b128 v[11:12], v[6:9], off
; GFX1170-TRUE16-NEXT:    s_endpgm
;
; GFX1170-FAKE16-LABEL: test_swmmac_f32_16x16x32_f16_negA:
; GFX1170-FAKE16:       ; %bb.0: ; %bb
; GFX1170-FAKE16-NEXT:    v_swmmac_f32_16x16x32_f16 v[6:9], v[0:1], v[2:5], v10 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GFX1170-FAKE16-NEXT:    global_store_b128 v[11:12], v[6:9], off
; GFX1170-FAKE16-NEXT:    s_endpgm
;
; GFX12-TRUE16-LABEL: test_swmmac_f32_16x16x32_f16_negA:
; GFX12-TRUE16:       ; %bb.0: ; %bb
; GFX12-TRUE16-NEXT:    ; kill: def $vgpr10_hi16 killed $sgpr0 killed $exec
...
; GFX1170-TRUE16-LABEL: test_swmmac_f32_16x16x32_f16_negB:
; GFX1170-TRUE16:       ; %bb.0: ; %bb
; GFX1170-TRUE16-NEXT:    ; kill: def $vgpr10_hi16 killed $sgpr0 killed $exec
; GFX1170-TRUE16-NEXT:    v_swmmac_f32_16x16x32_f16 v[6:9], v[0:1], v[2:5], v10 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GFX1170-TRUE16-NEXT:    global_store_b128 v[11:12], v[6:9], off
; GFX1170-TRUE16-NEXT:    s_endpgm
;
; GFX1170-FAKE16-LABEL: test_swmmac_f32_16x16x32_f16_negB:
; GFX1170-FAKE16:       ; %bb.0: ; %bb
; GFX1170-FAKE16-NEXT:    v_swmmac_f32_16x16x32_f16 v[6:9], v[0:1], v[2:5], v10 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GFX1170-FAKE16-NEXT:    global_store_b128 v[11:12], v[6:9], off
; GFX1170-FAKE16-NEXT:    s_endpgm
;
...
; GFX1170-TRUE16-LABEL: test_swmmac_f16_16x16x32_f16_negA:
; GFX1170-TRUE16:       ; %bb.0: ; %bb
; GFX1170-TRUE16-NEXT:    ; kill: def $vgpr8_hi16 killed $sgpr0 killed $exec
; GFX1170-TRUE16-NEXT:    v_swmmac_f16_16x16x32_f16 v[6:7], v[0:1], v[2:5], v8 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GFX1170-TRUE16-NEXT:    global_store_b64 v[9:10], v[6:7], off
; GFX1170-TRUE16-NEXT:    s_endpgm
;
; GFX1170-FAKE16-LABEL: test_swmmac_f16_16x16x32_f16_negA:
; GFX1170-FAKE16:       ; %bb.0: ; %bb
; GFX1170-FAKE16-NEXT:    v_swmmac_f16_16x16x32_f16 v[6:7], v[0:1], v[2:5], v8 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GFX1170-FAKE16-NEXT:    global_store_b64 v[9:10], v[6:7], off
; GFX1170-FAKE16-NEXT:    s_endpgm
;
; GFX12-TRUE16-LABEL: test_swmmac_f16_16x16x32_f16_negA:
; GFX12-TRUE16:       ; %bb.0: ; %bb
; GFX12-TRUE16-NEXT:    ; kill: def $vgpr8_hi16 killed $sgpr0 killed $exec
...
; GFX1170-TRUE16-LABEL: test_swmmac_f16_16x16x32_f16_negB:
; GFX1170-TRUE16:       ; %bb.0: ; %bb
; GFX1170-TRUE16-NEXT:    ; kill: def $vgpr8_hi16 killed $sgpr0 killed $exec
; GFX1170-TRUE16-NEXT:    v_swmmac_f16_16x16x32_f16 v[6:7], v[0:1], v[2:5], v8 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GFX1170-TRUE16-NEXT:    global_store_b64 v[9:10], v[6:7], off
; GFX1170-TRUE16-NEXT:    s_endpgm
;
; GFX1170-FAKE16-LABEL: test_swmmac_f16_16x16x32_f16_negB:
; GFX1170-FAKE16:       ; %bb.0: ; %bb
; GFX1170-FAKE16-NEXT:    v_swmmac_f16_16x16x32_f16 v[6:7], v[0:1], v[2:5], v8 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GFX1170-FAKE16-NEXT:    global_store_b64 v[9:10], v[6:7], off
; GFX1170-FAKE16-NEXT:    s_endpgm
;
