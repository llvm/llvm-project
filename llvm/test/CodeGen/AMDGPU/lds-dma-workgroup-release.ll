...
; GFX1010-NEXT:    v_mov_b32_e32 v1, 0x800
; GFX1010-NEXT:    v_mov_b32_e32 v2, 1
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    s_mov_b32 m0, s6
; GFX1010-NEXT:    buffer_load_dword v1, s[0:3], 0 offen lds
; GFX1010-NEXT:    s_waitcnt vmcnt(0)
; GFX1010-NEXT:    global_store_dword v0, v2, s[8:9]
; GFX1010-NEXT:    global_load_dword v1, v0, s[8:9] glc
; GFX1010-NEXT:    s_waitcnt vmcnt(0)
; GFX1010-NEXT:    buffer_gl0_inv
; GFX1010-NEXT:    v_mov_b32_e32 v1, s7
; GFX1010-NEXT:    ds_read_b32 v1, v1
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    global_store_dword v0, v1, s[10:11]
; GFX1010-NEXT:    s_endpgm
                                       ptr addrspace(3) inreg %lds1,
                                       ptr addrspace(3) inreg %lds2,
                                       ptr addrspace(1) %flag,
