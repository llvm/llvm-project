...
; RUN: llc -mtriple=amdgpu6.01 < %s | FileCheck -enable-var-scope -check-prefix=SI %s
; RUN: llc -mtriple=amdgpu12.50 --amdgpu-enable-vopd=0 < %s | FileCheck -enable-var-scope -check-prefix=GFX1250 %s
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_max_i32_e32 v2, s2, v0
...
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_max_u32_e32 v2, s2, v0
; GFX1250-NEXT:    global_store_b32 v1, v2, s[0:1]
; GFX1250-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_max_u32_e32 v2, s6, v0
