...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_max_i32 s1, s2, s3
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_max_i32 s1, s2, 9
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b32_e32 v1, s1
; GFX1250-NEXT:    s_mov_b32 s1, 0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_max_i32 s1, s2, 9
; GFX1250-NEXT:    s_max_i32 s2, s3, 9
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_max_u32 s1, s2, s3
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b32_e32 v1, s1
; GFX1250-NEXT:    s_mov_b32 s1, 0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_max_u32 s1, s2, 15
; GFX1250-NEXT:    s_max_u32 s2, s3, 23
; GFX1250-NEXT:    v_mov_b32_e32 v0, s1
; GFX1250-NEXT:    v_mov_b32_e32 v1, s2
; GFX1250-NEXT:    s_mov_b32 s1, 0
; GFX1250-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
