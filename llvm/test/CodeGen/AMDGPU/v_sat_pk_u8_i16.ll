...
; RUN: llc -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=SDAG-VI %s
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=SDAG-GFX9 %s
; RUN: llc -mtriple=amdgpu11.01 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,SDAG-GFX11,SDAG-GFX11-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.01 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,SDAG-GFX11,SDAG-GFX11-FAKE16 %s
...
; GISEL-GFX9-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GISEL-GFX9-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
; SDAG-GFX9-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; SDAG-GFX9-NEXT:    v_or_b32_sdwa v1, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
