...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1200 | FileCheck -check-prefixes=GCN,GFX12,GFX12PLUS %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 | FileCheck -check-prefixes=GCN,GFX13,GFX12PLUS %s
