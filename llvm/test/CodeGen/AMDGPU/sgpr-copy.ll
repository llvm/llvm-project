...
; CHECK-NEXT:    s_buffer_load_dwordx4 s[0:3], s[0:3], 0x0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cvt_i32_f32_e32 v0, s3
; CHECK-NEXT:    s_mov_b32 s3, 0
; CHECK-NEXT:    s_branch .LBB2_2
; CHECK-NEXT:  .LBB2_1: ; %Flow
