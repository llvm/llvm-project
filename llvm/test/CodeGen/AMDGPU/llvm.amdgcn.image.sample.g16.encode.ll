...
; GFX11-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, 0xffff ; encoding: [0x02,0x01,0x10,0xca,0xff,0x00,0x02,0x03,0xff,0xff,0x00,0x00]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2) ; encoding: [0x21,0x01,0x87,0xbf]
...
; GFX11-NEXT:    v_mov_b32_e32 v2, v0 ; encoding: [0x00,0x03,0x04,0x7e]
; GFX11-NEXT:    v_dual_mov_b32 v0, 0xffff :: v_dual_mov_b32 v3, v1 ; encoding: [0xff,0x00,0x10,0xca,0x01,0x01,0x02,0x00,0xff,0xff,0x00,0x00]
