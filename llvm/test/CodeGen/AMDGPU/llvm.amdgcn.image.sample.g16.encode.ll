...
; RUN: llc -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX12-TRUE16 %s
; RUN: llc -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX12-FAKE16 %s
; RUN: llc -mtriple=amdgpu13.10 -mattr=+real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX13-TRUE16 %s
; RUN: llc -mtriple=amdgpu13.10 -mattr=-real-true16 -amdgpu-enable-vopd=0 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX13-FAKE16 %s
...
; GFX10-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x0b,0x0f,0x88,0xf0,0x06,0x00,0x40,0x00,0x07,0x04,0x05,0x00]
; GFX10-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x3f,0x8c,0xbf]
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v7, v3, v2, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd6,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX11-FAKE16-NEXT:    v_perm_b32 v6, v1, v0, 0x5040100 ; encoding: [0x06,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX11-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x05,0x0f,0xe4,0xf0,0x06,0x00,0x00,0x08,0x07,0x04,0x05,0x00]
...
; GFX12-FAKE16:       ; %bb.0: ; %main_body
; GFX12-FAKE16-NEXT:    v_perm_b32 v7, v3, v2, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd6,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX12-FAKE16-NEXT:    v_perm_b32 v6, v1, v0, 0x5040100 ; encoding: [0x06,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX12-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x40,0xce,0xe7,0x00,0x00,0x00,0x04,0x06,0x07,0x04,0x05]
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16:       ; %bb.0: ; %main_body
; GFX13-FAKE16-NEXT:    v_perm_b32 v7, v3, v2, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd7,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    v_perm_b32 v6, v1, v0, 0x5040100 ; encoding: [0x06,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0xe8,0xe7,0x00,0x00,0x00,0x04,0x06,0x07,0x04,0x05]
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v4, v1, v0, 0x5040100 ; encoding: [0x04,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX11-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v4, v2, v3, v5, v[6:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D ; encoding: [0x09,0x0f,0xe4,0xf0,0x04,0x00,0x00,0x08,0x02,0x03,0x05,0x06]
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_perm_b32 v4, v1, v0, 0x5040100 ; encoding: [0x04,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX12-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v4, v2, v3, v[5:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D ; encoding: [0x02,0x40,0xce,0xe7,0x00,0x00,0x00,0x04,0x04,0x02,0x03,0x05]
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16-NEXT:    v_perm_b32 v4, v1, v0, 0x5040100 ; encoding: [0x04,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v4, v2, v3, v[5:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D ; encoding: [0x02,0x80,0xe8,0xe7,0x00,0x00,0x00,0x04,0x04,0x02,0x03,0x05]
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x0b,0x0f,0x8c,0xf0,0x07,0x00,0x40,0x00,0x08,0x04,0x05,0x06]
; GFX10-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x3f,0x8c,0xbf]
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16:       ; %bb.0: ; %main_body
; GFX11-FAKE16-NEXT:    v_perm_b32 v8, v3, v2, 0x5040100 ; encoding: [0x08,0x00,0x44,0xd6,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX11-FAKE16-NEXT:    v_perm_b32 v7, v1, v0, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX11-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x05,0x0f,0x7c,0xf1,0x07,0x00,0x00,0x08,0x08,0x04,0x05,0x06]
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16:       ; %bb.0: ; %main_body
; GFX12-FAKE16-NEXT:    v_perm_b32 v8, v3, v2, 0x5040100 ; encoding: [0x08,0x00,0x44,0xd6,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX12-FAKE16-NEXT:    v_perm_b32 v7, v1, v0, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd6,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX12-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0xd7,0xe7,0x00,0x00,0x00,0x04,0x07,0x08,0x04,0x05]
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX13-FAKE16:       ; %bb.0: ; %main_body
; GFX13-FAKE16-NEXT:    v_perm_b32 v8, v3, v2, 0x5040100 ; encoding: [0x08,0x00,0x44,0xd7,0x03,0x05,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    v_perm_b32 v7, v1, v0, 0x5040100 ; encoding: [0x07,0x00,0x44,0xd7,0x01,0x01,0xfe,0x03,0x00,0x01,0x04,0x05]
; GFX13-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0xe8,0xe7,0x00,0x00,0x00,0x04,0x07,0x08,0x04,0x05]
; GFX13-FAKE16-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX13-FAKE16-NEXT:    ; return to shader part epilog
main_body:
