...
; GFX11:       ; %bb.0: ; %main_body
; GFX11-NEXT:    v_dual_mov_b32 v9, v3 :: v_dual_and_b32 v0, 0xffff, v0 ; encoding: [0x03,0x01,0x24,0xca,0xff,0x00,0x00,0x09,0xff,0xff,0x00,0x00]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; encoding: [0x91,0x00,0x87,0xbf]
; GFX11-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_and_b32 v2, 0xffff, v9 ; encoding: [0x02,0x01,0x24,0xca,0xff,0x12,0x02,0x03,0xff,0xff,0x00,0x00]
...
; GFX11:       ; %bb.0: ; %main_body
; GFX11-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_and_b32 v1, 0xffff, v1 ; encoding: [0x02,0x01,0x24,0xca,0xff,0x02,0x00,0x08,0xff,0xff,0x00,0x00]
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2) ; encoding: [0x13,0x01,0x87,0xbf]
