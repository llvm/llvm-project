...
; RUN: llc -mtriple=amdgpu11.00 -show-mc-encoding < %s | FileCheck %s --check-prefixes=GFX11
...
; RUN: not llc -global-isel=1 -global-isel-abort=0 -mtriple=amdgpu10.10 -filetype=null < %s 2>&1 | FileCheck -check-prefix=ERR %s
