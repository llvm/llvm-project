...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -amdgpu-sdwa-peephole=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,NOSDWA %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -amdgpu-sdwa-peephole < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SDWA,GFX89 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00 -amdgpu-sdwa-peephole < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SDWA,GFX9_10,GFX9 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.10 -amdgpu-sdwa-peephole < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SDWA,GFX9_10,GFX10 %s
...
; NOSDWA-NEXT:    v_add_u32_e32 v6, vcc, s4, v2
; NOSDWA-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; NOSDWA-NEXT:    flat_load_dword v4, v[0:1]
; NOSDWA-NEXT:    flat_load_dword v2, v[6:7]
; NOSDWA-NEXT:    v_mov_b32_e32 v0, s0
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX89-NEXT:    v_add_u32_e32 v6, vcc, s4, v2
; GFX89-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; GFX89-NEXT:    flat_load_dword v4, v[0:1]
; GFX89-NEXT:    flat_load_dword v2, v[6:7]
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    s_waitcnt vmcnt(0)
...
; NOSDWA-NEXT:    flat_load_ushort v2, v[6:7]
; NOSDWA-NEXT:    v_mov_b32_e32 v0, s0
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s1
; NOSDWA-NEXT:    s_waitcnt vmcnt(0)
...
; GFX89-NEXT:    flat_load_ushort v2, v[6:7]
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX10-NEXT:    v_lshlrev_b32_e32 v3, 1, v0
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_ushort v1, v3, s[2:3]
...
; NOSDWA-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; NOSDWA-NEXT:    v_mov_b32_e32 v3, s5
; NOSDWA-NEXT:    v_add_u32_e32 v6, vcc, s4, v2
; NOSDWA-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; NOSDWA-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; NOSDWA-NEXT:    flat_load_dwordx2 v[2:3], v[6:7]
...
; GFX89-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; GFX89-NEXT:    v_mov_b32_e32 v3, s5
; GFX89-NEXT:    v_add_u32_e32 v6, vcc, s4, v2
; GFX89-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; GFX89-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
; GFX89-NEXT:    flat_load_dwordx2 v[2:3], v[6:7]
...
; NOSDWA-NEXT:    s_waitcnt lgkmcnt(0)
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s3
; NOSDWA-NEXT:    v_add_u32_e32 v8, vcc, s2, v2
; NOSDWA-NEXT:    v_addc_u32_e32 v9, vcc, 0, v1, vcc
; NOSDWA-NEXT:    v_mov_b32_e32 v3, s5
; NOSDWA-NEXT:    v_add_u32_e32 v10, vcc, s4, v2
; NOSDWA-NEXT:    v_addc_u32_e32 v11, vcc, 0, v3, vcc
; NOSDWA-NEXT:    flat_load_dwordx4 v[0:3], v[8:9]
; NOSDWA-NEXT:    flat_load_dwordx4 v[4:7], v[10:11]
...
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    v_mov_b32_e32 v1, s3
; GFX89-NEXT:    v_add_u32_e32 v8, vcc, s2, v2
; GFX89-NEXT:    v_addc_u32_e32 v9, vcc, 0, v1, vcc
; GFX89-NEXT:    v_mov_b32_e32 v3, s5
; GFX89-NEXT:    v_add_u32_e32 v10, vcc, s4, v2
; GFX89-NEXT:    v_addc_u32_e32 v11, vcc, 0, v3, vcc
; GFX89-NEXT:    flat_load_dwordx4 v[0:3], v[8:9]
; GFX89-NEXT:    flat_load_dwordx4 v[4:7], v[10:11]
...
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x34
; GFX10-NEXT:    v_lshlrev_b32_e32 v9, 4, v0
; GFX10-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dwordx4 v[0:3], v9, s[2:3]
; GFX10-NEXT:    global_load_dwordx4 v[4:7], v9, s[6:7]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-NEXT:    global_store_dwordx4 v9, v[0:3], s[0:1]
; GFX10-NEXT:    s_endpgm
entry:
...
; NOSDWA-NEXT:    v_add_u32_e32 v5, vcc, s2, v0
; NOSDWA-NEXT:    v_addc_u32_e32 v6, vcc, 0, v2, vcc
; NOSDWA-NEXT:    v_mov_b32_e32 v4, s5
; NOSDWA-NEXT:    v_add_u32_e32 v0, vcc, s4, v0
; NOSDWA-NEXT:    v_addc_u32_e32 v1, vcc, 0, v4, vcc
; NOSDWA-NEXT:    flat_load_ubyte v2, v[5:6]
; NOSDWA-NEXT:    flat_load_ubyte v3, v[0:1]
; NOSDWA-NEXT:    v_mov_b32_e32 v0, s0
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s1
; NOSDWA-NEXT:    s_waitcnt vmcnt(0)
...
; GFX89-NEXT:    v_add_u32_e32 v5, vcc, s2, v0
; GFX89-NEXT:    v_addc_u32_e32 v6, vcc, 0, v2, vcc
; GFX89-NEXT:    v_mov_b32_e32 v4, s5
; GFX89-NEXT:    v_add_u32_e32 v0, vcc, s4, v0
; GFX89-NEXT:    v_addc_u32_e32 v1, vcc, 0, v4, vcc
; GFX89-NEXT:    flat_load_ubyte v2, v[5:6]
; GFX89-NEXT:    flat_load_ubyte v3, v[0:1]
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    global_load_dword v2, v3, s[6:7]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mul_lo_u16_sdwa v3, v1, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:BYTE_3
; GFX9-NEXT:    v_mul_lo_u16_sdwa v4, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_mul_lo_u16_e32 v5, v1, v2
; GFX9-NEXT:    v_mul_lo_u16_sdwa v1, v1, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
...
; GFX9-NEXT:    global_load_dwordx2 v[2:3], v5, s[6:7]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mul_lo_u16_e32 v5, v0, v2
; GFX9-NEXT:    v_mul_lo_u16_sdwa v6, v0, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX9-NEXT:    v_mul_lo_u16_sdwa v7, v0, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:BYTE_3
; GFX9-NEXT:    v_mul_lo_u16_sdwa v0, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_mul_lo_u16_sdwa v2, v1, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:BYTE_3
; GFX9-NEXT:    v_mul_lo_u16_sdwa v8, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_mul_lo_u16_e32 v9, v1, v3
; GFX9-NEXT:    v_mul_lo_u16_sdwa v1, v1, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:BYTE_1
; GFX9-NEXT:    v_or_b32_sdwa v3, v5, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v0, v0, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v2, v8, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v1, v9, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_sdwa v0, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    global_store_dwordx2 v4, v[0:1], s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_cvt_f16_i16_sdwa v1, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; NOSDWA-NEXT:    flat_load_dword v2, v[4:5]
; NOSDWA-NEXT:    flat_load_dword v3, v[0:1]
; NOSDWA-NEXT:    v_mov_b32_e32 v0, s0
; NOSDWA-NEXT:    v_mov_b32_e32 v1, s1
; NOSDWA-NEXT:    s_waitcnt vmcnt(1)
...
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_dword v1, v3, s[6:7]
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dword v1, v3, s[6:7]
; GFX10-NEXT:    global_load_dword v2, v3, s[2:3]
; GFX10-NEXT:    s_waitcnt vmcnt(1)
