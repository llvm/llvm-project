...
; RUN: llc -mtriple=amdgpu12.50 < %s | FileCheck %s --check-prefix=GFX1250
...
; GFX1250-NEXT:    ; implicit-def: $sgpr2_sgpr3
; GFX1250-NEXT:    ; implicit-def: $vgpr1
; GFX1250-NEXT:    global_load_async_to_lds_b32 v0, v2, s[0:1]
; GFX1250-NEXT:    ; asyncmark
; GFX1250-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX1250-NEXT:  ; %bb.1: ; %prefetch
; GFX1250-NEXT:    v_add_nc_u32_e32 v1, 0x100, v0
; GFX1250-NEXT:    s_add_nc_u64 s[2:3], s[0:1], 0x100
; GFX1250-NEXT:  ; %bb.2: ; %join
; GFX1250-NEXT:    global_load_async_to_lds_b32 v1, v2, s[2:3]
; GFX1250-NEXT:    s_or_b32 exec_lo, exec_lo, s4
...
; GFX1250-NEXT:    v_add_nc_u32_e32 v1, 4, v3
; GFX1250-NEXT:  .LBB1_2: ; %join
; GFX1250-NEXT:    global_load_async_to_lds_b128 v3, v0, s[0:1]
