...
; TODO: Add a test with a loop.
; We currently crash in SIInsertWaitcnts.cpp on attempts to use
; non-constant GEPs with promoted private objects:
; unhandled v_load/store_idx on private vgpr
