...
; GFX10:       argumentInfo:
; GFX10-NEXT:    privateSegmentBuffer: { reg: '$sgpr0_3' }
; GFX10-NEXT:    dispatchPtr:     { reg: '$sgpr4_5' }
; GFX10-NEXT:    queuePtr:        { reg: '$sgpr6_7' }
; GFX10-NEXT:    dispatchID:      { reg: '$sgpr10_11' }
; GFX10-NEXT:    workGroupIDX:    { reg: '$sgpr12' }
;
; GFX10: name:            without_global_to_flat_addrspacecast_cc_kernel
; GFX10:       argumentInfo:
; GFX10-NEXT:    privateSegmentBuffer: { reg: '$sgpr0_3' }
; GFX10-NEXT:    kernargSegmentPtr: { reg: '$sgpr4_5' }
...
; GFX10-NEXT:    privateSegmentBuffer: { reg: '$sgpr0_3' }
; GFX10-NEXT:    kernargSegmentPtr: { reg: '$sgpr4_5' }
; GFX10-NEXT:    flatScratchInit: { reg: '$sgpr6_7' }
...
; GFX10-NEXT:    dispatchPtr:     { reg: '$sgpr4_5' }
; GFX10-NEXT:    queuePtr:        { reg: '$sgpr6_7' }
; GFX10-NEXT:    kernargSegmentPtr: { reg: '$sgpr8_9' }
; GFX10-NEXT:    dispatchID:      { reg: '$sgpr10_11' }
; GFX10-NEXT:    flatScratchInit: { reg: '$sgpr12_13' }
