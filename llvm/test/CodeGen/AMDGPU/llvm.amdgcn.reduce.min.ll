...
; GFX1132GISEL-NEXT:    s_endpgm
entry:
  %result = call float @llvm.amdgcn.wave.reduce.min.float(float %in, i32 1)
...
; GFX1032GISEL-NEXT:    s_brev_b32 s4, -2
...
; GFX1032GISEL-NEXT:    s_min_i32 s4, s4, s7
...
; GFX1164GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX1164GISEL-NEXT:    s_brev_b32 s2, -2
...
; GFX8GISEL-NEXT:  ; %bb.1: ; %else
; GFX8GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX8GISEL-NEXT:    s_brev_b32 s8, -2
...
; GFX8GISEL-NEXT:    s_min_i32 s8, s8, s10
; GFX8GISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
...
; GFX9GISEL-NEXT:  ; %bb.1: ; %else
; GFX9GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX9GISEL-NEXT:    s_brev_b32 s8, -2
...
; GFX9GISEL-NEXT:    s_min_i32 s8, s8, s10
; GFX9GISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
...
; GFX1064GISEL-NEXT:  ; %bb.1: ; %else
; GFX1064GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1064GISEL-NEXT:    s_brev_b32 s8, -2
...
; GFX1064GISEL-NEXT:    s_min_i32 s8, s8, s10
; GFX1064GISEL-NEXT:    s_cmp_lg_u64 s[6:7], 0
...
; GFX1032GISEL-NEXT:    v_readlane_b32 s8, v2, s7
; GFX1032GISEL-NEXT:    s_bitset0_b32 s6, s7
; GFX1032GISEL-NEXT:    s_min_i32 s4, s4, s8
; GFX1032GISEL-NEXT:    s_cmp_lg_u32 s6, 0
...
; GFX1132GISEL-NEXT:    v_readlane_b32 s4, v2, s3
; GFX1132GISEL-NEXT:    s_bitset0_b32 s2, s3
; GFX1132GISEL-NEXT:    s_min_i32 s0, s0, s4
; GFX1132GISEL-NEXT:    s_cmp_lg_u32 s2, 0
...
if:
  %reducedValTid = call float @llvm.amdgcn.wave.reduce.min.float(float %in2, i32 1)
  br label %endif

else:
  %reducedValIn = call float @llvm.amdgcn.wave.reduce.min.float(float %in, i32 1)
  br label %endif
