...
; GCN-HSA-NEXT:    v_mov_b32_e32 v25, s3
; GCN-HSA-NEXT:    s_add_u32 s3, s0, 0xc0
; GCN-HSA-NEXT:    s_addc_u32 s5, s1, 0
...
; GCN-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[32:35]
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(7)
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v35, 16, v9
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v8
; GCN-HSA-NEXT:    v_and_b32_e32 v34, 0xffff, v9
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v8
; GCN-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[32:35]
; GCN-HSA-NEXT:    v_mov_b32_e32 v8, s10
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v35, 16, v11
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v10
; GCN-HSA-NEXT:    v_and_b32_e32 v34, 0xffff, v11
; GCN-HSA-NEXT:    v_and_b32_e32 v32, 0xffff, v10
; GCN-HSA-NEXT:    v_mov_b32_e32 v9, s11
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s2
; GCN-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[32:35]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s4
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v35, 16, v7
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v33, 16, v6
; GCN-HSA-NEXT:    v_and_b32_e32 v34, 0xffff, v7
...
; GCN-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[32:35]
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v29, 16, v31
; GCN-HSA-NEXT:    v_lshrrev_b32_e32 v27, 16, v30
; GCN-HSA-NEXT:    v_and_b32_e32 v28, 0xffff, v31
; GCN-HSA-NEXT:    v_and_b32_e32 v26, 0xffff, v30
; GCN-HSA-NEXT:    flat_store_dwordx4 v[24:25], v[7:10]
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GCN-HSA-NEXT:    s_addc_u32 s5, s3, 0
; GCN-HSA-NEXT:    flat_load_dwordx4 v[14:17], v[4:5]
; GCN-HSA-NEXT:    s_add_u32 s2, s2, 16
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s4
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GCN-HSA-NEXT:    s_addc_u32 s3, s3, 0
; GCN-HSA-NEXT:    flat_load_dwordx4 v[10:13], v[4:5]
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s2
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s3
; GCN-HSA-NEXT:    flat_load_dwordx4 v[6:9], v[4:5]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(3)
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(2)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s19, v17
...
; GCN-HSA-NEXT:    s_ashr_i32 s48, s9, 31
; GCN-HSA-NEXT:    s_ashr_i32 s49, s9, 16
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v14
; GCN-HSA-NEXT:    v_readfirstlane_b32 s9, v15
; GCN-HSA-NEXT:    v_readfirstlane_b32 s18, v16
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
...
; GCN-HSA-NEXT:    s_waitcnt vmcnt(1)
; GCN-HSA-NEXT:    v_readfirstlane_b32 s8, v10
; GCN-HSA-NEXT:    v_readfirstlane_b32 s9, v11
; GCN-HSA-NEXT:    v_readfirstlane_b32 s12, v12
; GCN-HSA-NEXT:    v_readfirstlane_b32 s13, v13
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[20:21], 0x100000
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s10
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s11
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[28:29], 0x100000
...
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[8:9], 0x100000
...
; GCN-HSA-NEXT:    v_readfirstlane_b32 s18, v8
; GCN-HSA-NEXT:    v_readfirstlane_b32 s19, v9
; GCN-HSA-NEXT:    s_bfe_i64 s[40:41], s[36:37], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[20:21], 0x100000
; GCN-HSA-NEXT:    s_mov_b32 s36, s13
; GCN-HSA-NEXT:    s_lshr_b32 s20, s12, 16
; GCN-HSA-NEXT:    s_mov_b32 s38, s19
; GCN-HSA-NEXT:    s_lshr_b32 s46, s18, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s54, s9, 31
...
; GCN-HSA-NEXT:    s_ashr_i32 s58, s13, 31
; GCN-HSA-NEXT:    s_ashr_i32 s59, s13, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[12:13], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s60, s19, 31
; GCN-HSA-NEXT:    s_ashr_i32 s61, s19, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[20:21], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[20:21], s[46:47], 0x100000
...
; GCN-HSA-NEXT:    s_addc_u32 s62, s1, 0
...
; GCN-HSA-NEXT:    s_add_u32 s33, s0, 0x90
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s49
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s48
; GCN-HSA-NEXT:    v_mov_b32_e32 v22, s40
; GCN-HSA-NEXT:    s_addc_u32 s40, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v27, s46
; GCN-HSA-NEXT:    v_mov_b32_e32 v28, s62
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s47
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s53
; GCN-HSA-NEXT:    v_mov_b32_e32 v13, s52
; GCN-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s44
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s33
; GCN-HSA-NEXT:    s_add_u32 s33, s0, 0x70
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s45
; GCN-HSA-NEXT:    v_mov_b32_e32 v31, s42
; GCN-HSA-NEXT:    v_mov_b32_e32 v32, s43
; GCN-HSA-NEXT:    v_mov_b32_e32 v16, s51
...
; GCN-HSA-NEXT:    s_addc_u32 s38, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s39
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s61
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s60
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s33
; GCN-HSA-NEXT:    v_mov_b32_e32 v5, s38
; GCN-HSA-NEXT:    s_add_u32 s33, s0, 0x50
; GCN-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, s33
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s36
; GCN-HSA-NEXT:    s_addc_u32 s36, s1, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s37
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s59
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s58
