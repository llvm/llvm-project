...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e32 vcc_lo, v0.l, v4.l
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s0, v0.h, v4.h
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s1, v1.l, v5.l
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s2, v3.h, v7.h
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s3, v2.h, v6.h
; GFX11-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s4, v1.h, v5.h
