...
; GFX7-NEXT:    v_min_f32_e32 v2, v6, v3
...
; GFX6-NEXT:    v_min_f32_e32 v2, v6, v3
...
; GFX6-NEXT:    v_mul_f32_e32 v5, 1.0, v5
; GFX6-NEXT:    v_or_b32_e32 v4, v3, v4
; GFX6-NEXT:    v_min_f32_e32 v3, v7, v2
; GFX6-NEXT:    v_min_f32_e32 v5, v5, v1
; GFX6-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_min_f32 v4, v4, v2 :: v_dual_and_b32 v5, 0xffff0000, v3
; GFX11-FAKE16-NEXT:    v_min_f32_e32 v5, v5, v1
...
; GFX7-NEXT:    v_mul_f32_e32 v5, 1.0, v5
; GFX7-NEXT:    v_or_b32_e32 v4, v3, v4
; GFX7-NEXT:    v_min_f32_e32 v3, v6, v2
; GFX7-NEXT:    v_min_f32_e32 v5, v5, v1
; GFX7-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
...
; GFX6-NEXT:    v_mul_f32_e32 v5, 1.0, v5
; GFX6-NEXT:    v_or_b32_e32 v4, v3, v4
; GFX6-NEXT:    v_min_f32_e32 v3, v6, v2
; GFX6-NEXT:    v_min_f32_e32 v5, v5, v1
; GFX6-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
; GFX6-NEXT:    v_alignbit_b32 v3, v3, v5, 16
; GFX6-NEXT:    ds_cmpst_rtn_b32 v3, v0, v4, v3
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
  %result = atomicrmw fmin ptr addrspace(3) %ptr, float 4.0 seq_cst, !atomic.ignore.denormal.mode !0
  ret float %result
}
