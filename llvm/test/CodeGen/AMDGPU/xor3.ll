...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_vgpr_b:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor3_b32 v0, s2, v0, s3
; GFX11-NEXT:    ; return to shader part epilog
  %x = xor i32 %a, %b
  %result = xor i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_vgpr_all2:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor3_b32 v0, v1, v2, v0
; GFX11-NEXT:    ; return to shader part epilog
  %x = xor i32 %b, %c
  %result = xor i32 %a, %x
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_vgpr_bc:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor3_b32 v0, s2, v0, v1
; GFX11-NEXT:    ; return to shader part epilog
  %x = xor i32 %a, %b
  %result = xor i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_vgpr_const:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor3_b32 v0, v0, v1, 16
; GFX11-NEXT:    ; return to shader part epilog
  %x = xor i32 %a, %b
  %result = xor i32 %x, 16
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_multiuse_outer:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor3_b32 v0, v0, v1, v2
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_multiuse_inner:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_xor_b32_e32 v0, v0, v1
; GFX11-NEXT:    v_xor_b32_e32 v1, v0, v2
; GFX11-NEXT:    ; return to shader part epilog
  %inner = xor i32 %a, %b
  %outer = xor i32 %inner, %c
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: xor3_uniform_vgpr:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_f32_e64 v0, s2, 1.0
; GFX11-NEXT:    v_add_f32_e64 v1, s3, 2.0
; GFX11-NEXT:    v_add_f32_e64 v2, 0x40400000, s4
; GFX11-NEXT:    v_xor_b32_e32 v0, v0, v1
