...
; RUN: llc -global-isel -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GFX12-GISEL %s
...
; GFX11-NEXT:    v_mov_b32_e32 v5, 0xbc00bc00
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    buffer_load_b32 v1, off, s[20:23], 0
; GFX11-NEXT:    buffer_load_b32 v2, off, s[16:19], 0
; GFX11-NEXT:    image_sample_lz v3, v5, s[8:15], s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-NEXT:    buffer_load_b32 v4, off, s[40:43], 0
; GFX11-NEXT:    image_sample_lz v0, v5, s[44:51], s[36:39] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX12-NEXT:    v_mov_b32_e32 v5, 0xbc00bc00
...
; GFX12-NEXT:    image_sample_lz v3, v5, s[8:15], s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-NEXT:    buffer_load_b32 v4, off, s[40:43], null
; GFX12-NEXT:    image_sample_lz v0, v5, s[44:51], s[36:39] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v5, 0xbc00bc00
...
; GFX12-GISEL-NEXT:    image_sample_lz v1, v5, s[24:31], s[16:19] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-GISEL-NEXT:    image_sample_lz v0, v5, s[4:11], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
