...
; GFX11-NEXT:    image_bvh64_intersect_ray v[12:15], v[0:11], s[16:19]
...
; GFX11-NEXT:    s_waitcnt vmcnt(3)
; GFX11-NEXT:    v_cmp_eq_f32_e64 s1, 1.0, v13
; GFX11-NEXT:    s_waitcnt vmcnt(2)
...
; GFX11-NEXT:    s_and_b32 s0, s0, vcc_lo
; GFX11-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v13
; GFX11-NEXT:    s_and_b32 s0, s0, s1
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s0, s0, s2
; GFX11-NEXT:    s_and_b32 s0, s0, vcc_lo
...
; GFX12-NEXT:    image_bvh64_intersect_ray v[12:15], [v[0:1], v2, v[3:5], v[6:8], v[9:11]], s[16:19]
...
; GFX12-NEXT:    ; implicit-def: $vgpr14_vgpr15
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    v_cmp_eq_f32_e64 s1, 1.0, v13
; GFX12-NEXT:    s_wait_loadcnt 0x2
...
; GFX12-NEXT:    s_and_b32 s0, s0, vcc_lo
; GFX12-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v13
; GFX12-NEXT:    s_and_b32 s0, s0, s1
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_and_b32 s0, s0, s2
; GFX12-NEXT:    s_and_b32 s0, s0, vcc_lo
