...
; GFX9-NEXT:    v_or_b32_sdwa v4, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    s_and_b64 exec, exec, s[14:15]
; GFX9-NEXT:    image_gather4 v[0:3], v4, s[0:7], s[8:11] dmask:0x1 a16
...
; GFX10NSA-NEXT:    v_or_b32_sdwa v4, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4 v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX11-FAKE16-NEXT:    image_gather4 v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX12-FAKE16-NEXT:    image_gather4 v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    v_or_b32_sdwa v4, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v5, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4 v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4 v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4 v[0:3], [v4, v5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    v_or_b32_sdwa v5, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4 v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v2
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4 v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v2
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4 v[0:3], [v4, v5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    v_or_b32_sdwa v5, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4_cl v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v2
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4_cl v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v2
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4_cl v[0:3], [v4, v5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX9-NEXT:    s_mov_b32 s10, s12
; GFX9-NEXT:    s_mov_b32 s11, s13
; GFX9-NEXT:    v_or_b32_sdwa v4, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    v_or_b32_sdwa v5, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    s_and_b64 exec, exec, s[14:15]
; GFX9-NEXT:    image_gather4_b v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 a16
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    v_or_b32_sdwa v4, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v5, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4_b v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX11-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, v2, 16, v1
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4_b v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX12-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, v2, 16, v1
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4_b v[0:3], [v4, v5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    v_or_b32_sdwa v4, v4, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v2, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4_c_b v[0:3], [v4, v1, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4_c_b v[0:3], [v4, v1, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4_c_b v[0:3], [v4, v1, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    v_or_b32_sdwa v5, v4, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v6, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v4, v4, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4_b_cl v[0:3], [v5, v6, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, v2, 16, v1
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v6, s0, 16, v3
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4_b_cl v[0:3], v[4:6], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, v2, 16, v1
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v6, s0, 16, v3
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4_b_cl v[0:3], [v4, v5, v6], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    v_or_b32_sdwa v6, v5, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v2, v3, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    v_or_b32_sdwa v3, v5, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX10NSA-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX10NSA-NEXT:    image_gather4_c_b_cl v[0:3], [v6, v1, v2, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX11-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v2, v3, 16, v2
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v3, s0, 16, v4
; GFX11-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX11-FAKE16-NEXT:    image_gather4_c_b_cl v[0:3], [v5, v1, v2, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX12-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v2, v3, 16, v2
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v3, s0, 16, v4
; GFX12-FAKE16-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12-FAKE16-NEXT:    image_gather4_c_b_cl v[0:3], [v5, v1, v2, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    image_gather4_l v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX11-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX11-FAKE16-NEXT:    image_gather4_l v[0:3], v[4:5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX12-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX12-FAKE16-NEXT:    image_gather4_l v[0:3], [v4, v5], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX9-NEXT:    s_mov_b32 s11, s13
; GFX9-NEXT:    v_or_b32_sdwa v4, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX9-NEXT:    image_gather4_lz v[0:3], v4, s[0:7], s[8:11] dmask:0x1 a16
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    ; return to shader part epilog
;
...
; GFX10NSA-NEXT:    s_mov_b32 s10, s12
; GFX10NSA-NEXT:    s_mov_b32 s11, s13
; GFX10NSA-NEXT:    image_gather4_lz v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX10NSA-NEXT:    s_waitcnt vmcnt(0)
; GFX10NSA-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX11-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX11-FAKE16-NEXT:    image_gather4_lz v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s10, s12
; GFX12-FAKE16-NEXT:    s_mov_b32 s11, s13
; GFX12-FAKE16-NEXT:    image_gather4_lz v[0:3], v4, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
