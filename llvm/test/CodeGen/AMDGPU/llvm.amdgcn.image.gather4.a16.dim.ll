...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX12PLUS %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX12PLUS %s
...
; GFX12PLUS-NEXT:    image_gather4 v[0:3], v0, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_cube:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4 v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_CUBE a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_2darray:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4 v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D_ARRAY a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_c v[0:3], [v0, v1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_cl_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_cl v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_cl_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_c_cl v[0:3], [v0, v1, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_b_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_b v[0:3], [v0, v1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_b_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v2, v3, v2, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_c_b v[0:3], [v0, v1, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_b_cl_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_b_cl v[0:3], [v0, v1, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_b_cl_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s12, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_perm_b32 v2, v3, v2, 0x5040100
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX12PLUS-NEXT:    image_gather4_c_b_cl v[0:3], [v0, v1, v2, v4], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_l_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12PLUS-NEXT:    image_gather4_l v[0:3], [v0, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_l_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    image_gather4_c_l v[0:3], [v0, v1, v3], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_lz_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX12PLUS-NEXT:    image_gather4_lz v[0:3], v0, s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: gather4_c_lz_2d:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX12PLUS-NEXT:    image_gather4_c_lz v[0:3], [v0, v1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D a16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
