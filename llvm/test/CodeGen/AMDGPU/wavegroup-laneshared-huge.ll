...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_getreg_b32 s1, hwreg(HW_REG_WAVE_GROUP_INFO, 16, 4)
; CHECK-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; CHECK-NEXT:    s_mul_i32 s2, s1, 1
; CHECK-NEXT:    s_mul_i32 s33, s1, s0
; CHECK-NEXT:    s_set_gpr_idx_u32 idx0, s2
...
; KERNEL-NEXT:         .amdhsa_user_sgpr_count 1
