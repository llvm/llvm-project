...
; GFX12-NEXT:    v_add_nc_u32_e32 v4, 64, v0
; GFX12-NEXT:    v_add_nc_u32_e32 v6, 0x80, v0
; GFX12-NEXT:    v_add_nc_u32_e32 v2, 0xc0, v0
...
; GFX12-NEXT:    v_lshlrev_b64_e32 v[10:11], 4, v[4:5]
...
; GFX12-NEXT:    v_lshlrev_b64_e32 v[12:13], 4, v[2:3]
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX12-NEXT:    v_add_co_u32 v10, vcc_lo, s0, v6
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v11, null, s1, v7, vcc_lo
; GFX12-NEXT:    v_add_co_u32 v14, vcc_lo, s0, v12
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v15, null, s1, v13, vcc_lo
; GFX12-NEXT:    s_clause 0x2
; GFX12-NEXT:    global_load_b128 v[6:9], v[8:9], off
