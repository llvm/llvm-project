...
; GCN-NEXT:    s_add_co_u32 s6, s6, (.LBB10_2-.Lpost_getpc11)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s7, s7, (.LBB10_2-.Lpost_getpc11)>>32
...
; GCN-NEXT:    s_cselect_b32 s7, -1, 0
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN-NEXT:    s_and_b32 s6, s7, s6
; GCN-NEXT:  .LBB10_5: ; %Flow5
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GCN-NEXT:    s_and_b32 s6, s6, exec_lo
; GCN-NEXT:    s_cselect_b32 s6, 1, 0
...
; GCN-NEXT:    s_add_co_u32 s0, s0, (.LBB10_7-.Lpost_getpc12)&4294967295
; GCN-NEXT:    s_add_co_ci_u32 s1, s1, (.LBB10_7-.Lpost_getpc12)>>32
; GCN-NEXT:    s_set_pc_i64 s[0:1]
...
; GCN-ADD-PC64-NEXT:    s_sleep 0
; GCN-ADD-PC64-NEXT:    s_sleep 0
; GCN-ADD-PC64-NEXT:    s_branch .LBB10_3
; GCN-ADD-PC64-NEXT:  .LBB10_2:
; GCN-ADD-PC64-NEXT:    s_mov_b32 s7, -1
; GCN-ADD-PC64-NEXT:    s_mov_b32 s6, 0
; GCN-ADD-PC64-NEXT:  .LBB10_3: ; %Flow
...
; GCN-ADD-PC64-NEXT:  ; %bb.4: ; %bb9
; GCN-ADD-PC64-NEXT:    s_cmp_lt_i32 s3, 11
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s6, -1, 0
; GCN-ADD-PC64-NEXT:    s_cmp_ge_i32 s2, s3
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s7, -1, 0
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    s_and_b32 s6, s7, s6
; GCN-ADD-PC64-NEXT:  .LBB10_5: ; %Flow5
; GCN-ADD-PC64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GCN-ADD-PC64-NEXT:    s_and_b32 s6, s6, exec_lo
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s6, 1, 0
; GCN-ADD-PC64-NEXT:    s_cmp_lg_u32 s6, 1
; GCN-ADD-PC64-NEXT:    ; implicit-def: $sgpr6
; GCN-ADD-PC64-NEXT:    s_cbranch_scc0 .LBB10_6
; GCN-ADD-PC64-NEXT:  ; %bb.10: ; %Flow5
; GCN-ADD-PC64-NEXT:    s_add_pc_i64 .LBB10_7-.Lpost_addpc12
; GCN-ADD-PC64-NEXT:  .Lpost_addpc12:
; GCN-ADD-PC64-NEXT:  .LBB10_6: ; %bb14
; GCN-ADD-PC64-NEXT:    s_cmp_eq_u32 s0, 0
; GCN-ADD-PC64-NEXT:    s_cselect_b32 s0, -1, 0
