...
; RUN:  llc -global-isel=0 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=GFX8 %s
; RUN:  llc -global-isel=1 -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=GFX8 %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu12.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX12PLUS %s
; RUN:  llc -global-isel=1 -mtriple=amdgpu12.00 -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefix=GFX12PLUS %s
