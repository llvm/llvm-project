...
; RUN: llc -mtriple=amdgpu7.04 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -enable-new-pm -mtriple=amdgpu7.04 -stop-after=amdgpu-remove-incompatible-functions\
; RUN:   -pass-remarks=amdgpu-remove-incompatible-functions < %s 2>%t | FileCheck -check-prefixes=GFX7,IR %s
; RUN: FileCheck --check-prefix=WARN-GFX7 %s < %t

; RUN: llc -mtriple=amdgpu8.03 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu8.03 < %s

; RUN: llc -enable-new-pm -mtriple=amdgpu8.03 -stop-after=amdgpu-remove-incompatible-functions\
; RUN:   -pass-remarks=amdgpu-remove-incompatible-functions < %s 2>%t | FileCheck -check-prefixes=GFX8,IR %s
; RUN: FileCheck --check-prefix=WARN-GFX8 %s < %t

; RUN: llc -mtriple=amdgpu9.06 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu10.11 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu10.11 < %s

; RUN: llc -mtriple=amdgpu11.00 -stop-after=amdgpu-remove-incompatible-functions\
