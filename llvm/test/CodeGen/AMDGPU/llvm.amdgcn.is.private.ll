...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-SDAG %s
...
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-GISEL %s
...
; GFX9-NEXT:    s_endpgm
;
; GFX1210-LABEL: is_private_vgpr:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_load_b32 s0, s[4:5], 0x4
...
; GFX1210-SDAG-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; GFX1210-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1210-SDAG-NEXT:  .LBB1_2: ; %bb1
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-GISEL-LABEL: is_private_sgpr:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
...
; GFX1210-GISEL-NEXT:    global_store_b32 v[0:1], v0, off scope:SCOPE_SYS
; GFX1210-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX1210-GISEL-NEXT:  .LBB1_2: ; %bb1
