...
; RUN: llc -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck %s -check-prefixes=GCN,GCN-TRUE16
; RUN: llc -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck %s -check-prefixes=GCN,GCN-FAKE16
...
; GCN-NEXT:    v_max_f32_e32 v1, v2, v3
; GCN-NEXT:    v_min_f32_e32 v2, v4, v5
; GCN-NEXT:    v_max_f32_e32 v3, v6, v7
; GCN-NEXT:    v_min_f32_e32 v0, v0, v9
