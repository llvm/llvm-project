...
; GFX6-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_64
; GFX6-NEXT:    s_mov_b32 s13, s10
; GFX6-NEXT:    ; kill: def $sgpr8_64 killed $sgpr8_64 def $sgpr8_128
; GFX6-NEXT:    s_mov_b64 s[10:11], s[12:13]
; GFX6-NEXT:    v_ashrrev_i32_e64 v2, 31, v0
; GFX6-NEXT:    ; kill: def $vgpr0 killed $vgpr0 def $vgpr0_64 killed $exec
; GFX6-NEXT:    v_mov_b32_e32 v1, v2
; GFX6-NEXT:    s_mov_b32 s12, 2
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[0:1], s12
...
; GFX10-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; GFX10-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; SKIP-CACHE-INV-NEXT:    v_lshl_b64 v[0:1], v[0:1], s8
...
; GFX90A-NOTTGSPLIT-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_64 killed $exec
...
; GFX90A-NOTTGSPLIT-NEXT:    ; kill: def $vgpr3 killed $vgpr3 killed $vgpr2_64 killed $exec
...
; GFX90A-TGSPLIT-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_64 killed $exec
...
; GFX90A-TGSPLIT-NEXT:    ; kill: def $vgpr3 killed $vgpr3 killed $vgpr2_64 killed $exec
...
; GFX942-NOTTGSPLIT-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_64 killed $exec
...
; GFX942-TGSPLIT-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_64 killed $exec
...
; GFX11-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; GFX11-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; GFX12-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; GFX12-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_64 killed $exec
...
; GFX6-NEXT:    ; kill: def $sgpr10 killed $sgpr10 def $sgpr10_64
...
; GFX6-NEXT:    v_lshl_b64 v[1:2], v[0:1], s9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v0, s8
...
; GFX7-NEXT:    v_lshl_b64 v[1:2], v[0:1], s5
; GFX7-NEXT:    s_mov_b32 s6, s8
; GFX7-NEXT:    v_mov_b32_e32 v0, v1
...
; SKIP-CACHE-INV-NEXT:    v_lshl_b64 v[1:2], v[0:1], s5
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX6-NEXT:    ; kill: def $sgpr8 killed $sgpr8 killed $sgpr8_64
; GFX6-NEXT:    s_mov_b32 s12, 0x100f000
; GFX6-NEXT:    s_mov_b32 s13, -1
; GFX6-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_128
