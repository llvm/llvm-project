...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b32 v1, v1, s[2:3] scale_offset th:TH_LOAD_NT
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] th:TH_STORE_NT
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_and_b32_e64 v0, v0, s3
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset th:TH_STORE_NT
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x8
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b32 v1, v0, s[2:3] th:TH_LOAD_NT scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
