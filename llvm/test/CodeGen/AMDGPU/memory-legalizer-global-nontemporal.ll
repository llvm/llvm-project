...
; GFX6-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
; GFX6-NEXT:    s_mov_b32 s10, 0x100f000
; GFX6-NEXT:    s_mov_b32 s11, -1
; GFX6-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_7
...
; GFX6-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_13
; GFX6-NEXT:    s_mov_b32 s13, s10
; GFX6-NEXT:    ; kill: def $sgpr8_9 killed $sgpr8_9 def $sgpr8_11
...
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_9
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s9, s6
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr4_5 killed $sgpr4_5 def $sgpr4_7
...
; GFX6-NEXT:    ; kill: def $sgpr10 killed $sgpr10 def $sgpr10_11
; GFX6-NEXT:    s_mov_b32 s11, s6
; GFX6-NEXT:    ; kill: def $sgpr4_5 killed $sgpr4_5 def $sgpr4_7
...
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr6 killed $sgpr6 def $sgpr6_7
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s7, s2
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr0_1 killed $sgpr0_1 def $sgpr0_3
...
; GFX6-NEXT:    ; kill: def $sgpr8 killed $sgpr8 killed $sgpr8_9
; GFX6-NEXT:    s_mov_b32 s12, 0x100f000
; GFX6-NEXT:    s_mov_b32 s13, -1
; GFX6-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_11
...
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s8, 0xf000
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s9, -1
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_7
