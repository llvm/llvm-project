...
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck --check-prefixes=DEFAULT %s
; RUN: llc -mtriple=amdgpu11.00 -amdgpu-waitcnt-load-forcezero < %s | FileCheck --check-prefixes=LDZERO %s
