...
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s0, null scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b128 v[4:7], off, s0, null th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b128 v[8:11], off, s0, null th:TH_STORE_HT scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s0, null offset:42 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b128 v[0:3], v4, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[0:3], v6, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.store.v4f32.i32(<4 x float> %arg1, i32 %arg, i32 %arg2, i32 0, i32 0)
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b32 v0, v1, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b64 v[0:1], v2, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b32 v1, v7, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v2, v8, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v3, v9, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v4, v10, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v5, v11, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, v0, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
bb:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
...
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b128 v[1:4], v0, s0, null offen offset:4 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[5:6], v0, s0, null offen offset:28 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
bb:
  %a = shl i32 %inp, 6
  %a1 = add i32 %a, 4
...
; GFX13-NEXT:    buffer_store_b32 v1, v7, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v2, v8, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v3, v9, s0, null offen th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v4, v10, s0, null offen th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v5, v11, s0, null offen th:TH_STORE_WB scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, v0, s0, null offen th:TH_STORE_WB scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
bb:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
...
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b64 v[1:2], v5, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[3:4], v0, s0, null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
bb:
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 12
...
; GFX13-NEXT:    s_clause 0x2
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s0, null scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[4:5], off, s0, null th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, off, s0, null th:TH_STORE_HT scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b8 v0, off, s0, null scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX13-NEXT:    buffer_store_b16 v0, off, s0, null scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
  %v2 = fptoui float %v1 to i32
