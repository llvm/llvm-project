...
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX1100,GISEL-GFX1100,GISEL-GFX1100-TRUE16 %s
...
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v1.l
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v2.l
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v1.h, 0
; GISEL-GFX1100-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixlo_f16 v0, v3, v4, v5 op_sel_hi:[1,1,1]
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixlo_f16 v1, v3, v4, v5 op_sel_hi:[1,1,1] clamp
; GISEL-GFX1100-TRUE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v0, v1
; GISEL-GFX1100-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-GFX1100-FAKE16-NEXT:    v_and_b32_e32 v0, 0xffff, v3
...
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v1.l
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v2.l
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v6.h, 0
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixlo_f16 v6, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1] clamp
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; GISEL-GFX1100-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GISEL-GFX1100-TRUE16-NEXT:    v_fma_mixlo_f16 v0, v3, v4, v5 op_sel_hi:[1,1,1]
; GISEL-GFX1100-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, 16, v6
; GISEL-GFX1100-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-GFX1100-TRUE16-NEXT:    v_and_or_b32 v0, 0xffff, v0, v1
; GISEL-GFX1100-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-GFX1100-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GISEL-GFX1100-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GISEL-GFX1100-FAKE16-NEXT:    v_fma_mixhi_f16 v4, v0, v1, v2 op_sel:[1,1,1] op_sel_hi:[1,1,1]
; GISEL-GFX1100-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GISEL-GFX1100-TRUE16-NEXT:    v_mov_b16_e32 v0.h, 0
; GISEL-GFX1100-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
