...
; CHECK-NEXT:    .cfi_escape 0x10, 0xa8, 0x14, 0x0d, 0x90, 0xa8, 0x14, 0x16, 0xe4, 0x00, 0xe6, 0x11, 0x94, 0x08, 0xec, 0x20, 0x40 ;
; CHECK-NEXT:    ; implicit-def: $vgpr41
; CHECK-NEXT:    v_writelane_b32 v41, s34, 0
; CHECK-NEXT:    .cfi_escape 0x10, 0x42, 0x03, 0x4f, 0xe4, 0x00 ;
; CHECK-NEXT:    v_writelane_b32 v41, s35, 1
; CHECK-NEXT:    .cfi_escape 0x10, 0x43, 0x03, 0x4f, 0xe4, 0x04 ;
; CHECK-NEXT:    v_writelane_b32 v41, s36, 2
; CHECK-NEXT:    .cfi_escape 0x10, 0x44, 0x03, 0x4f, 0xe4, 0x08 ;
; CHECK-NEXT:    v_writelane_b32 v41, s37, 3
; CHECK-NEXT:    .cfi_escape 0x10, 0x45, 0x03, 0x4f, 0xe4, 0x0c ;
; CHECK-NEXT:    v_writelane_b32 v41, s38, 4
; CHECK-NEXT:    .cfi_escape 0x10, 0x46, 0x03, 0x4f, 0xe4, 0x10 ;
; CHECK-NEXT:    v_writelane_b32 v41, s39, 5
; CHECK-NEXT:    .cfi_escape 0x10, 0x47, 0x03, 0x4f, 0xe4, 0x14 ;
; CHECK-NEXT:    v_writelane_b32 v41, s40, 6
; CHECK-NEXT:    .cfi_escape 0x10, 0x48, 0x03, 0x4f, 0xe4, 0x18 ;
; CHECK-NEXT:    v_writelane_b32 v41, s41, 7
; CHECK-NEXT:    .cfi_escape 0x10, 0x49, 0x03, 0x4f, 0xe4, 0x1c ;
; CHECK-NEXT:    v_writelane_b32 v41, s42, 8
; CHECK-NEXT:    .cfi_escape 0x10, 0x4a, 0x03, 0x4f, 0xe4, 0x20 ;
; CHECK-NEXT:    v_writelane_b32 v41, s43, 9
; CHECK-NEXT:    .cfi_escape 0x10, 0x4b, 0x03, 0x4f, 0xe4, 0x24 ;
; CHECK-NEXT:    v_writelane_b32 v41, s44, 10
; CHECK-NEXT:    .cfi_escape 0x10, 0x4c, 0x03, 0x4f, 0xe4, 0x28 ;
; CHECK-NEXT:    v_writelane_b32 v41, s45, 11
; CHECK-NEXT:    .cfi_escape 0x10, 0x4d, 0x03, 0x4f, 0xe4, 0x2c ;
; CHECK-NEXT:    v_writelane_b32 v41, s46, 12
; CHECK-NEXT:    .cfi_escape 0x10, 0x4e, 0x03, 0x4f, 0xe4, 0x30 ;
; CHECK-NEXT:    v_writelane_b32 v41, s47, 13
; CHECK-NEXT:    .cfi_escape 0x10, 0x4f, 0x03, 0x4f, 0xe4, 0x34 ;
; CHECK-NEXT:    v_writelane_b32 v41, s30, 14
; CHECK-NEXT:    v_writelane_b32 v41, s31, 15
; CHECK-NEXT:    .cfi_escape 0x10, 0x10, 0x0a, 0x4f, 0x9d, 0x20, 0xc0, 0x03, 0x4f, 0x9d, 0x20, 0xe0, 0x03 ;
