...
; VI-NEXT:    s_ff1_i32_b64 s1, s[4:5]
; VI-NEXT:    s_lshl_b64 s[6:7], 1, s1
; VI-NEXT:    v_readfirstlane_b32 s8, v1
; VI-NEXT:    v_readlane_b32 s9, v2, s1
...
; GFX9-NEXT:    s_ff1_i32_b64 s1, s[4:5]
; GFX9-NEXT:    s_lshl_b64 s[6:7], 1, s1
; GFX9-NEXT:    v_readfirstlane_b32 s8, v1
; GFX9-NEXT:    v_readlane_b32 s9, v2, s1
...
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0xb
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0xb
...
; GFX8-NEXT:    v_cvt_f32_ubyte0_e32 v2, s1
...
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
