...
; RUN: llc < %s -mtriple=amdgpu8.03-- -mattr=-flat-for-global | FileCheck %s --check-prefix=VI
; RUN: llc < %s -mtriple=amdgpu11.00-- -mattr=+real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11,GFX11-TRUE16
; RUN: llc < %s -mtriple=amdgpu11.00-- -mattr=-real-true16 -mattr=-flat-for-global | FileCheck %s --check-prefixes=GFX11,GFX11-FAKE16
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s4, s10
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    buffer_load_u16 v2, off, s[4:7], 0 glc dlc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, s8
; GFX11-FAKE16-NEXT:    s_mov_b32 s1, s9
; GFX11-FAKE16-NEXT:    s_mov_b32 s4, s10
; GFX11-FAKE16-NEXT:    s_mov_b32 s5, s11
