...
; GFX6-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_9
...
; GFX6-NEXT:    ; kill: def $sgpr6 killed $sgpr6 def $sgpr6_7
; GFX6-NEXT:    s_mov_b32 s7, s2
; GFX6-NEXT:    ; kill: def $sgpr0_1 killed $sgpr0_1 def $sgpr0_3
