...
;
; GFX1210-LABEL: global_volatile_load_0:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    global_load_b32 v1, v0, s[2:3] scope:SCOPE_SYS
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_volatile_load_1:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b32 v1, v1, s[2:3] scale_offset scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_volatile_store_0:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_volatile_store_1:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_volatile_workgroup_acquire_load:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: global_volatile_workgroup_release_store:
; GFX1210:       ; %bb.0: ; %entry
