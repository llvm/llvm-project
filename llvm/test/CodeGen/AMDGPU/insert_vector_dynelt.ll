...
; GCN-O0-NEXT:    v_mov_b32_e32 v0, 1.0
; GCN-O0-NEXT:    ; implicit-def: $sgpr4_7
; GCN-O0-NEXT:    v_mov_b32_e32 v2, s4
; GCN-O0-NEXT:    v_mov_b32_e32 v3, s5
; GCN-O0-NEXT:    v_mov_b32_e32 v4, s6
; GCN-O0-NEXT:    v_mov_b32_e32 v5, s7
...
; GCN-O0-NEXT:    ; kill: def $sgpr2 killed $sgpr2 def $sgpr2_3
...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_5
...
; GCN-O0-NEXT:    ; kill: def $sgpr36 killed $sgpr36 killed $sgpr36_51
...
; GCN-O0-NEXT:    ; kill: def $sgpr10 killed $sgpr10 def $sgpr10_11
...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_7
; GCN-O0-NEXT:    v_mov_b32_e32 v0, s4
...
; GCN-O0-NEXT:    ; kill: def $sgpr0 killed $sgpr0 def $sgpr0_1
...
; GCN-O0-NEXT:    s_addc_u32 s0, s0, s1
; GCN-O0-NEXT:    ; kill: def $sgpr18 killed $sgpr18 def $sgpr18_19
...
; GCN-O0-NEXT:    ; kill: def $sgpr14 killed $sgpr14 def $sgpr14_15
...
; GCN-O0-NEXT:    s_addc_u32 s1, s1, s3
; GCN-O0-NEXT:    ; kill: def $sgpr6 killed $sgpr6 def $sgpr6_7
...
; GCN-O0-NEXT:    ; kill: def $sgpr16 killed $sgpr16 def $sgpr16_17
...
; GCN-O0-NEXT:    ; kill: def $sgpr20 killed $sgpr20 def $sgpr20_21
...
; GCN-O0-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_13
; GCN-O0-NEXT:    s_mov_b32 s13, s14
...
; GCN-O0-NEXT:    s_mov_b32 s15, s0
; GCN-O0-NEXT:    ; implicit-def: $sgpr0_1
; GCN-O0-NEXT:    s_mov_b32 s0, s1
; GCN-O0-NEXT:    ; implicit-def: $sgpr16_17
; GCN-O0-NEXT:    s_mov_b32 s1, s16
; GCN-O0-NEXT:    v_mov_b32_e32 v1, s15
...
; GCN-O0-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_9
...
; GCN-O0-NEXT:    s_mov_b32 s20, s7
; GCN-O0-NEXT:    s_mov_b32 s21, s6
; GCN-O0-NEXT:    ; implicit-def: $sgpr6_7
; GCN-O0-NEXT:    s_mov_b32 s6, s7
; GCN-O0-NEXT:    ; implicit-def: $sgpr22_23
...
; GCN-O0-NEXT:    ; implicit-def: $sgpr6_7
; GCN-O0-NEXT:    s_mov_b32 s6, s7
; GCN-O0-NEXT:    ; implicit-def: $sgpr42_43
...
; GCN-O0-NEXT:    s_addc_u32 s0, s0, s1
; GCN-O0-NEXT:    ; kill: def $sgpr78 killed $sgpr78 def $sgpr78_79
...
; GCN-O0-NEXT:    ; kill: def $sgpr38 killed $sgpr38 def $sgpr38_39
...
; GCN-O0-NEXT:    ; kill: def $sgpr22 killed $sgpr22 def $sgpr22_23
...
; GCN-O0-NEXT:    ; kill: def $sgpr44 killed $sgpr44 def $sgpr44_45
...
; GCN-O0-NEXT:    ; kill: def $sgpr1 killed $sgpr1 killed $sgpr0_1
...
; GCN-O0-NEXT:    ; kill: def $sgpr62 killed $sgpr62 def $sgpr62_63
...
; GCN-O0-NEXT:    ; kill: def $sgpr24 killed $sgpr24 def $sgpr24_25
...
; GCN-O0-NEXT:    ; implicit-def: $sgpr4_5
...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_6
...
; GCN-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:24 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s4, s16
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_8
; GCN-O0-NEXT:    s_mov_b32 s5, s17
; GCN-O0-NEXT:    s_mov_b32 s6, s18
...
; GCN-O0-NEXT:    s_mov_b32 s4, s16
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_9
; GCN-O0-NEXT:    s_mov_b32 s5, s17
; GCN-O0-NEXT:    s_mov_b32 s6, s18
; GCN-O0-NEXT:    s_mov_b32 s7, s19
; GCN-O0-NEXT:    s_mov_b32 s8, s20
...
; GCN-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:32 ; 4-byte Folded Spill
; GCN-O0-NEXT:    s_mov_b32 s4, s16
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_10
; GCN-O0-NEXT:    s_mov_b32 s5, s17
; GCN-O0-NEXT:    s_mov_b32 s6, s18
; GCN-O0-NEXT:    s_mov_b32 s7, s19
; GCN-O0-NEXT:    s_mov_b32 s8, s20
