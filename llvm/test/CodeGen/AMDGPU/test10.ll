...
; EMPTY:
; CHECK: Next-use distance of Register [[Reg12]] = 99
; CHECK-NEXT: Next-use distance of Register [[Reg11]] = 78
; CHECK-NEXT: Next-use distance of Register [[Reg10]] = 10
; CHECK-NEXT: Next-use distance of Register [[Reg9]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg8]] = 9
; CHECK-NEXT: Next-use distance of Register [[Reg7]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg6]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg5]] = 7
; CHECK-NEXT: Next-use distance of Register [[Reg4]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 57
; CHECK-NEXT: Next-use distance of Register [[Reg2]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg1]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg13]] = 88
; CHECK-NEXT: Next-use distance of Register [[Reg14]] = 32
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 47
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg20]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg21]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg22]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg23]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg24]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg25]] = 10
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg27]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg28]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg29]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg30]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg31]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg32]] = 47
; CHECK-NEXT: Next-use distance of Register [[Reg33]] = 64
; CHECK-NEXT: Next-use distance of Register [[Reg34]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg35]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg36]] = 44
; CHECK-NEXT: Next-use distance of Register [[Reg37]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg38]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg39]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg40]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg41]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg42]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg43]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg44]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg45]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg47]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg48]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg49]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg50]] = 32
; CHECK-NEXT: Next-use distance of Register [[Reg51]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg52]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg53]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg54]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg56]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg57]] = 24
; CHECK-NEXT: Next-use distance of Register [[Reg58]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg59]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg60]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg61]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg62]] = 17
; CHECK-NEXT: Next-use distance of Register [[Reg63]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg64]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg65]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg66]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg67]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg68]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg69]] = 40
; CHECK-NEXT: Next-use distance of Register [[Reg70]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg71]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg72]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg73]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg77]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg78]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg79]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg80]] = 15
; CHECK-NEXT: Next-use distance of Register [[Reg81]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg82]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg83]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg84]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg85]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg86]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg88]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg89]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg90]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg91]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg92]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg93]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg94]] = 16
; CHECK-NEXT: Next-use distance of Register [[Reg95]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg96]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg97]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg98]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg99]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg100]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg101]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg102]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg103]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg104]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg105]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg106]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg107]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg108]] = 17
...
; CHECK-NEXT: Next-use distance of Register [[Reg112]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg113]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg117]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg121]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg122]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg123]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg124]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg126]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg127]] = 1
entry:
