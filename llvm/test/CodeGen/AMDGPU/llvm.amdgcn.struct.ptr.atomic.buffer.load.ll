...
; GFX12-NEXT:    s_wait_xcnt 0x0
; GFX12-NEXT:    s_mov_b32 s5, 0
; GFX12-NEXT:    s_mov_b32 s6, 4
; GFX12-NEXT:  .LBB3_1: ; %bb1
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v1, s4
; GFX12-NEXT:    buffer_load_b32 v1, v1, s[0:3], s6 idxen offset:4 th:TH_LOAD_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v1, v0
; GFX12-NEXT:    s_or_b32 s5, vcc_lo, s5
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX12-NEXT:    buffer_load_b64 v[2:3], v2, s[0:3], null idxen offset:4 th:TH_LOAD_NT
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-FAKE16-NEXT:    buffer_load_b64 v[1:2], v1, s[0:3], 0 idxen offset:4 glc
...
; GFX12-FAKE16-NEXT:    s_load_b32 s4, s[4:5], 0x34
...
; GFX12-GISEL-TRUE16-NEXT:    s_load_b32 s4, s[4:5], 0x34
; GFX12-GISEL-TRUE16-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX12-GISEL-TRUE16-NEXT:    s_wait_xcnt 0x0
; GFX12-GISEL-TRUE16-NEXT:    s_mov_b32 s5, 0
...
; GFX12-GISEL-TRUE16-NEXT:    v_mov_b32_e32 v1, s4
...
; GFX12-GISEL-TRUE16-NEXT:    s_or_b32 s5, vcc_lo, s5
; GFX12-GISEL-TRUE16-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s5
