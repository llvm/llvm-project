...
; RUN: llc -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -mtriple=amdgpu9.0a -early-live-intervals < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -global-isel -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GCN,GISEL %s
