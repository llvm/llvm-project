...
attributes #2 = { nounwind denormal_fpenv(ieee,ieee) }
attributes #3 = { nounwind denormal_fpenv(float:ieee,ieee) }
attributes #4 = { nounwind denormal_fpenv(ieee,ieee) }
attributes #5 = { nounwind denormal_fpenv(preservesign,preservesign) }
attributes #6 = { nounwind denormal_fpenv(ieee,ieee) }
attributes #7 = { nounwind denormal_fpenv(preservesign,preservesign float:ieee,ieee) }
attributes #8 = { nounwind denormal_fpenv(ieee,ieee) }
...
attributes #12 = { nounwind denormal_fpenv(ieee,ieee float:ieee,preservesign) }
attributes #13 = { nounwind denormal_fpenv(ieee,ieee float:preservesign,ieee) }
attributes #14 = { nounwind denormal_fpenv(ieee,preservesign float:ieee,ieee) }
attributes #15 = { nounwind denormal_fpenv(preservesign,ieee float:ieee,ieee) }
