...
; CHECK-NEXT:    s_orn2_b64 s[10:11], s[0:1], exec
; CHECK-NEXT:    s_branch .LBB1_2
; CHECK-NEXT:  .LBB1_7: ; %loop.exit.guard
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    s_or_b64 exec, exec, s[4:5]
; CHECK-NEXT:    s_and_b64 vcc, exec, s[8:9]
; CHECK-NEXT:    s_cbranch_vccnz .LBB1_9
; CHECK-NEXT:  ; %bb.8: ; %bb10
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    s_or_b32 s14, s14, 1
; CHECK-NEXT:    s_branch .LBB1_1
; CHECK-NEXT:  .LBB1_9: ; %DummyReturnBlock
; CHECK-NEXT:    s_endpgm
bb:
  br label %bb1
