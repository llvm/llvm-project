...
; GFX13-NEXT:    s_load_b32 s2, s[4:5], 0x4c
; GFX13-NEXT:    s_load_b32 s3, s[4:5], 0x28
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX13-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX13-LABEL: s_test_imin_sle_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_clause 0x2
...
; GFX13-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_sext_i32_i16 s5, s2
; GFX13-NEXT:    s_sext_i32_i16 s7, s3
; GFX13-NEXT:    s_ashr_i32 s4, s2, 24
; GFX13-NEXT:    s_ashr_i32 s6, s3, 24
; GFX13-NEXT:    s_sext_i32_i8 s8, s3
; GFX13-NEXT:    s_sext_i32_i8 s9, s2
; GFX13-NEXT:    s_bfe_i32 s3, s3, 0x80010
; GFX13-NEXT:    s_bfe_i32 s2, s2, 0x80010
; GFX13-NEXT:    s_ashr_i32 s7, s7, 8
; GFX13-NEXT:    s_ashr_i32 s5, s5, 8
; GFX13-NEXT:    s_min_i32 s8, s9, s8
; GFX13-NEXT:    s_min_i32 s4, s4, s6
; GFX13-NEXT:    s_min_i32 s2, s2, s3
; GFX13-NEXT:    s_min_i32 s3, s5, s7
; GFX13-NEXT:    s_and_b32 s5, s8, 0xff
; GFX13-NEXT:    s_lshl_b32 s4, s4, 8
; GFX13-NEXT:    s_lshl_b32 s3, s3, 8
...
; GFX1250-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: v_test_umin_ult_i16_multi_use:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_load_b256 s[0:7], s[4:5], 0x0
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_clause 0x1
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v1, v0, s[6:7]
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v2, v0, s[4:5]
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x1
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v3, 0xffff, v1
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v4, 0xffff, v2
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_cmp_lt_u32_e32 vcc_lo, v4, v3
; GFX13-TRUE16-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc_lo
; GFX13-TRUE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX13-TRUE16-NEXT:    s_clause 0x1
; GFX13-TRUE16-NEXT:    global_store_b16 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-TRUE16-NEXT:    global_store_b8 v0, v2, s[2:3] scope:SCOPE_SE
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: v_test_umin_ult_i16_multi_use:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_load_b256 s[0:7], s[4:5], 0x0
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_clause 0x1
; GFX13-FAKE16-NEXT:    global_load_u16 v1, v0, s[6:7]
; GFX13-FAKE16-NEXT:    global_load_u16 v2, v0, s[4:5]
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x1
; GFX13-FAKE16-NEXT:    v_and_b32_e32 v3, 0xffff, v1
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-FAKE16-NEXT:    v_and_b32_e32 v4, 0xffff, v2
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_cmp_lt_u32_e32 vcc_lo, v4, v3
; GFX13-FAKE16-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc_lo
; GFX13-FAKE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX13-FAKE16-NEXT:    s_clause 0x1
; GFX13-FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-FAKE16-NEXT:    global_store_b8 v0, v2, s[2:3] scope:SCOPE_SE
; GFX13-FAKE16-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_ashr_i32 s3, s2, 16
; GFX13-NEXT:    s_sext_i32_i16 s2, s2
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13-NEXT:    s_min_i32 s2, s2, s3
; GFX13-NEXT:    v_mov_b32_e32 v1, s2
