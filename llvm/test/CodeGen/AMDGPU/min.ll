...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX1210 %s
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_imin_sle_i32:
; GFX1210:       ; %bb.0:
...
; GFX1210-NEXT:    global_load_b32 v2, v0, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_min_i32_e32 v1, v1, v2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_i32 s2, s2, s3
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_v1i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_v4i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b256 s[8:15], s[4:5], 0x10
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v4, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_i32 s2, s11, s15
; GFX1210-NEXT:    s_min_i32 s3, s10, s14
; GFX1210-NEXT:    s_min_i32 s4, s8, s12
; GFX1210-NEXT:    s_min_i32 s5, s9, s13
; GFX1210-NEXT:    v_mov_b32_e32 v0, s4
; GFX1210-NEXT:    v_mov_b32_e32 v1, s5
; GFX1210-NEXT:    v_mov_b32_e32 v2, s3
; GFX1210-NEXT:    v_mov_b32_e32 v3, s2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x2
; GFX1210-NEXT:    s_load_b32 s2, s[4:5], 0x28
; GFX1210-NEXT:    s_load_b32 s3, s[4:5], 0x4c
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sext_i32_i8 s2, s2
; GFX1210-NEXT:    s_sext_i32_i8 s3, s3
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_v4i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b32 s0, s[4:5], 0x28
; GFX1210-NEXT:    s_load_b32 s1, s[4:5], 0x4c
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sext_i32_i16 s2, s0
; GFX1210-NEXT:    s_lshr_b32 s3, s0, 16
; GFX1210-NEXT:    s_sext_i32_i16 s7, s1
; GFX1210-NEXT:    s_lshr_b32 s8, s1, 16
; GFX1210-NEXT:    s_ashr_i32 s6, s0, 24
; GFX1210-NEXT:    s_bfe_i32 s0, s0, 0x80000
; GFX1210-NEXT:    s_ashr_i32 s9, s1, 24
; GFX1210-NEXT:    s_bfe_i32 s1, s1, 0x80000
; GFX1210-NEXT:    s_lshr_b32 s2, s2, 8
; GFX1210-NEXT:    s_bfe_i32 s3, s3, 0x80000
; GFX1210-NEXT:    s_lshr_b32 s7, s7, 8
; GFX1210-NEXT:    s_bfe_i32 s8, s8, 0x80000
; GFX1210-NEXT:    v_min_i16 v0, s6, s9
; GFX1210-NEXT:    v_min_i16 v1, s0, s1
; GFX1210-NEXT:    v_min_i16 v2, s3, s8
; GFX1210-NEXT:    v_min_i16 v3, s2, s7
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1210-NEXT:    v_lshlrev_b32_e32 v0, 8, v0
; GFX1210-NEXT:    v_and_b32_e32 v1, 0xff, v1
; GFX1210-NEXT:    v_and_b32_e32 v2, 0xff, v2
; GFX1210-NEXT:    v_lshlrev_b32_e32 v3, 8, v3
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_or_b32_e32 v0, v2, v0
; GFX1210-NEXT:    v_or_b32_e32 v1, v1, v3
...
; GFX1210-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_v2i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_pk_min_i16 v1, s2, s3
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_v4i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x8
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_pk_min_i16 v1, s1, s3
; GFX1210-NEXT:    v_pk_min_i16 v0, s0, s2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_imin_slt_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_imin_slt_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_u16 v1, v0, s[2:3] scale_offset
; GFX1210-NEXT:    global_load_u16 v2, v0, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_min_i16 v1, v1, v2
; GFX1210-NEXT:    global_store_b16 v0, v1, s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_slt_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_slt_v2i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x8
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_i32 s0, s0, s2
; GFX1210-NEXT:    s_min_i32 s1, s1, s3
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_slt_imm_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_i32 s2, s2, 8
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_imm_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ule_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX1210-NEXT:    global_load_b32 v2, v0, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_min_u32_e32 v1, v1, v2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %a.gep = getelementptr inbounds i32, ptr addrspace(1) %a.ptr, i32 %tid
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ule_v3i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
; GFX1210-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_lshlrev_b32_e32 v3, 4, v0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_b96 v[0:2], v3, s[2:3]
; GFX1210-NEXT:    global_load_b96 v[4:6], v3, s[4:5]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_min_u32_e32 v2, v2, v6
; GFX1210-NEXT:    v_min_u32_e32 v1, v1, v5
; GFX1210-NEXT:    v_min_u32_e32 v0, v0, v4
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ule_v3i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
; GFX1210-NEXT:    v_and_b32_e32 v4, 0x3ff, v0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_b64 v[0:1], v4, s[2:3] scale_offset
; GFX1210-NEXT:    global_load_b64 v[2:3], v4, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_lshlrev_b32_e32 v4, 3, v4
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_pk_min_u16 v1, v1, v3
; GFX1210-NEXT:    v_pk_min_u16 v0, v0, v2
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b16 v4, v1, s[0:1] offset:4
; GFX1210-NEXT:    global_store_b32 v4, v0, s[0:1]
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_umin_ule_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_u32 s2, s2, s3
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ult_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ult_i8:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX1210-NEXT:    global_load_u8 v2, v0, s[4:5]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_min_u16 v1, v1, v2
; GFX1210-NEXT:    global_store_b8 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_umin_ult_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ult_i32_multi_use:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b256 s[0:7], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_b32 s4, s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b32 s5, s[6:7], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_cmp_lt_u32 s4, s5
; GFX1210-NEXT:    s_cselect_b32 s6, -1, 0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s6
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_b32 s6, s6, exec_lo
; GFX1210-NEXT:    s_cselect_b32 s4, s4, s5
; GFX1210-NEXT:    v_mov_b32_e32 v2, s4
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b32 v1, v2, s[0:1]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_umin_ult_i16_multi_use:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b256 s[0:7], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_u16 s4, s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_u16 s5, s[6:7], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_cmp_lt_u32 s4, s5
; GFX1210-NEXT:    s_cselect_b32 s6, -1, 0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)
...
; GFX1210-NEXT:    v_mov_b32_e32 v2, s4
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b16 v1, v2, s[0:1]
; GFX1210-NEXT:    global_store_b8 v1, v0, s[2:3]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_umin_ult_v1i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_umin_ult_v8i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b512 s[8:23], s[4:5], 0x20
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v8, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_min_u32 s4, s9, s17
; GFX1210-NEXT:    s_min_u32 s5, s8, s16
; GFX1210-NEXT:    s_min_u32 s6, s15, s23
; GFX1210-NEXT:    s_min_u32 s7, s14, s22
; GFX1210-NEXT:    s_min_u32 s8, s12, s20
; GFX1210-NEXT:    s_min_u32 s9, s13, s21
; GFX1210-NEXT:    s_min_u32 s2, s11, s19
; GFX1210-NEXT:    s_min_u32 s3, s10, s18
; GFX1210-NEXT:    v_mov_b32_e32 v0, s8
; GFX1210-NEXT:    v_mov_b32_e32 v1, s9
; GFX1210-NEXT:    v_mov_b32_e32 v2, s7
; GFX1210-NEXT:    v_mov_b32_e32 v3, s6
; GFX1210-NEXT:    v_mov_b32_e32 v4, s5
; GFX1210-NEXT:    v_mov_b32_e32 v5, s4
; GFX1210-NEXT:    v_mov_b32_e32 v6, s3
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_umin_ult_v8i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b256 s[8:15], s[4:5], 0x10
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v4, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_pk_min_u16 v3, s11, s15
; GFX1210-NEXT:    v_pk_min_u16 v2, s10, s14
; GFX1210-NEXT:    v_pk_min_u16 v1, s9, s13
; GFX1210-NEXT:    v_pk_min_u16 v0, s8, s12
; GFX1210-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: simplify_demanded_bits_test_umin_ult_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x2
; GFX1210-NEXT:    s_load_b32 s2, s[4:5], 0x28
; GFX1210-NEXT:    s_load_b32 s3, s[4:5], 0x4c
...
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_min_u32 s2, s2, s3
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: simplify_demanded_bits_test_min_slt_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x2
; GFX1210-NEXT:    s_load_b32 s2, s[4:5], 0x28
; GFX1210-NEXT:    s_load_b32 s3, s[4:5], 0x4c
...
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sext_i32_i16 s2, s2
; GFX1210-NEXT:    s_sext_i32_i16 s3, s3
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_min_i32 s2, s2, s3
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: s_test_imin_sle_i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[4:5], 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sext_i32_i16 s3, s2
; GFX1210-NEXT:    s_ashr_i32 s2, s2, 16
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_min_i32 s2, s3, s2
; GFX1210-NEXT:    v_mov_b32_e32 v1, s2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_umin_ult_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_min_u64 v[0:1], s[2:3], s[4:5]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_umin_ule_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_imin_slt_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_min_i64 v[0:1], s[2:3], s[4:5]
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_imin_sle_i64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_imin_sle_v2i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX1210-NEXT:    global_load_b32 v2, v0, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_pk_min_i16 v1, v1, v2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_test_imin_ule_v2i16:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX1210-NEXT:    global_load_b32 v2, v0, s[4:5] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_pk_min_u16 v1, v1, v2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %a.gep = getelementptr inbounds <2 x i16>, ptr addrspace(1) %a.ptr, i32 %tid
