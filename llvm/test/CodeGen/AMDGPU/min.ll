...
; CI-NEXT:    s_and_b64 s[2:3], s[0:1], exec
; CI-NEXT:    s_cselect_b32 s1, s4, s5
...
; VI-NEXT:    s_cselect_b32 s1, s4, s5
...
; GFX10-NEXT:    s_cselect_b32 s5, s8, s9
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s7, s6, exec_lo
; GFX11-NEXT:    s_cselect_b32 s4, s4, s5
; GFX11-NEXT:    s_and_b32 s5, s6, 1
...
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    s_and_b32 s3, s2, exec_lo
; GFX1250-NEXT:    s_cselect_b32 s0, s0, s1
; GFX1250-NEXT:    s_and_b32 s1, s2, 1
...
; GFX11-TRUE16-NEXT:    s_and_b32 s4, vcc_lo, 1
...
; GFX11-FAKE16-NEXT:    s_and_b32 s4, vcc_lo, 1
...
; GFX1250-NEXT:    s_and_b32 s0, vcc_lo, 1
