...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_min_i32 s1, s2, s3
...
; CI-NEXT:    s_ashr_i32 s4, s3, 16
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    s_sext_i32_i16 s0, s3
; CI-NEXT:    s_min_i32 s1, s1, s4
; CI-NEXT:    s_min_i32 s0, s2, s0
...
; CI-NEXT:    s_and_b32 s0, s0, 0xffff
; CI-NEXT:    s_ashr_i32 s1, s2, 16
; CI-NEXT:    s_ashr_i32 s6, s3, 16
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    s_sext_i32_i16 s0, s2
; CI-NEXT:    s_sext_i32_i16 s2, s3
; CI-NEXT:    s_ashr_i32 s3, s4, 16
; CI-NEXT:    s_ashr_i32 s7, s5, 16
; CI-NEXT:    s_sext_i32_i16 s4, s4
; CI-NEXT:    s_sext_i32_i16 s5, s5
; CI-NEXT:    s_min_i32 s6, s6, s7
; CI-NEXT:    s_min_i32 s2, s2, s5
...
; GFX9-NEXT:    v_pk_min_i16 v0, s2, v0
...
; GFX10-NEXT:    v_mov_b32_e32 v2, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_min_i32 s1, s2, s4
; GFX10-NEXT:    s_min_i32 s2, s3, s5
...
; GFX11-NEXT:    v_mov_b32_e32 v2, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_min_i32 s1, s2, s4
; GFX11-NEXT:    s_min_i32 s2, s3, s5
...
; GFX1250-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_min_i32 s1, s2, s6
; GFX1250-NEXT:    s_min_i32 s2, s3, s7
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_min_i32 s1, s2, 8
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b32_e32 v1, s1
; GFX1250-NEXT:    s_mov_b32 s1, 0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_min_u32 s1, s2, s3
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-NEXT:    v_mov_b32_e32 v1, s1
; GFX1250-NEXT:    s_mov_b32 s1, 0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_ashr_i32 s0, s2, 16
; VI-NEXT:    s_sext_i32_i16 s1, s2
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_ashr_i32 s1, s2, 16
; GFX10-NEXT:    s_sext_i32_i16 s2, s2
; GFX10-NEXT:    s_min_i32 s1, s2, s1
; GFX10-NEXT:    v_mov_b32_e32 v1, s1
; GFX10-NEXT:    s_mov_b32 s1, 0
; GFX10-NEXT:    global_store_short v0, v1, s[0:1]
; GFX10-NEXT:    s_endpgm
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_ashr_i32 s1, s2, 16
; GFX11-NEXT:    s_sext_i32_i16 s2, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_min_i32 s1, s2, s1
; GFX11-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_ashr_i32 s1, s2, 16
; GFX1250-NEXT:    s_sext_i32_i16 s2, s2
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-NEXT:    s_min_i32 s1, s2, s1
; GFX1250-NEXT:    v_mov_b32_e32 v1, s1
; GFX1250-NEXT:    s_mov_b32 s1, 0
