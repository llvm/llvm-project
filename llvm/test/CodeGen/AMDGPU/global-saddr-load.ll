...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    global_load_u8 v0, v0, s[2:3] offset:0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
  %gep0 = getelementptr inbounds i8, i8 addrspace(1)* %sbase, i64 -4096
  %load = load i8, i8 addrspace(1)* %gep0
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, s[0:1], 0xfffff000, s2
; GFX11-NEXT:    v_addc_u32_e64 v1, s[0:1], -1, s3, s[0:1]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    global_load_u8 v0, v0, s[2:3] offset:-2046
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, s[0:1], 0, s2
; GFX11-NEXT:    v_addc_u32_e64 v1, s[0:1], 1, s3, s[0:1]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, s[0:1], 0x1000, s2
; GFX11-NEXT:    v_addc_u32_e64 v1, s[0:1], 1, s3, s[0:1]
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, s[0:1], s2, v0
; GFX11-NEXT:    v_addc_u32_e64 v1, s[0:1], s3, 0, s[0:1]
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc, 0x1000, v0
...
; GFX11-NEXT:    v_add_co_u32_e64 v0, s[0:1], s2, v0
; GFX11-NEXT:    v_addc_u32_e64 v1, s[0:1], s3, 0, s[0:1]
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc, 0xfffff000, v0
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc, v0, s2
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc, 0, v1, vcc
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    v_add_co_u32_e64 v0, vcc, s2, v0
