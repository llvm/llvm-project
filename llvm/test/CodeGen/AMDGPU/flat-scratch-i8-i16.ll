...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_mov_b16_e32 v3.h, v0.l
...
; GFX11-NEXT:    v_mov_b16_e32 v3.h, -1
; GFX11-NEXT:    scratch_load_u8 v2, off, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mov_b16_e32 v3.l, v2.l
...
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    scratch_load_u8 v2, off, s0 offset:1
; GFX12-NEXT:    v_mov_b16_e32 v3.h, -1
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    scratch_load_u8 v2, off, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mov_b16_e32 v3.h, v2.l
; GFX11-NEXT:    flat_store_b32 v[0:1], v3
; GFX11-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    v_mov_b16_e32 v3.l, -1
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_mov_b16_e32 v3.h, v2.l
; GFX12-NEXT:    flat_store_b32 v[0:1], v3
; GFX12-NEXT:    s_endpgm
bb:
  %gep = getelementptr i8, ptr addrspace(5) %in, i64 1
