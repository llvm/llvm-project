...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX11-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX11-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX1210-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GCN,GFX1210-GISEL %s

define i32 @test_minmax_i32(i32 %a, i32 %b, i32 %c) {
; GCN-LABEL: test_minmax_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_maxmin_i32 v0, v0, v1, v2
...
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_max_i32 s0, s0, s1
; GFX1210-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1210-SDAG-NEXT:    s_min_i32 s0, s0, s2
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_max_i32 s0, s0, s1
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_min_i32 s0, s0, s2
...
; GCN-LABEL: test_minmax_commuted_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_maxmin_i32 v0, v0, v1, v2
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_maxmin_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_minmax_i32 v0, v0, v1, v2
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_maxmin_commuted_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_minmax_i32 v0, v0, v1, v2
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_smed3_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_med3_i32 v2, v2, v3, v4
...
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_max_u32 s0, s0, s1
; GFX1210-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1210-SDAG-NEXT:    s_min_u32 s0, s0, s2
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1210-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1210-SDAG-NEXT:    global_store_b32 v0, v1, s[4:5]
; GFX1210-SDAG-NEXT:    s_nop 0
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_max_u32 s0, s0, s1
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_min_u32 s0, s0, s2
; GFX1210-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1210-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GFX1210-GISEL-NEXT:    global_store_b32 v1, v0, s[6:7]
; GFX1210-GISEL-NEXT:    s_nop 0
...
; GCN-LABEL: test_minmax_commuted_u32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_maxmin_u32 v0, v0, v1, v2
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_maxmin_commuted_u32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_minmax_u32 v0, v0, v1, v2
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_umed3_i32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_med3_u32 v2, v2, v3, v4
; GCN-NEXT:    global_store_b32 v[0:1], v2, off
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
;
; GFX1210-SDAG-LABEL: test_minmax_f32_ieee_true:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-SDAG-NEXT:    v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v0, v0, v0
; GFX1210-SDAG-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX1210-SDAG-NEXT:    v_maxmin_f32 v0, v0, v1, v2
; GFX1210-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-GISEL-LABEL: test_minmax_f32_ieee_true:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-GISEL-NEXT:    v_dual_max_f32 v0, v0, v0 :: v_dual_max_f32 v1, v1, v1
; GFX1210-GISEL-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX1210-GISEL-NEXT:    v_maxmin_f32 v0, v0, v1, v2
...
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX1210-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1210-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1210-SDAG-NEXT:    v_maxmin_f32 v0, s0, s1, v0
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1210-GISEL-NEXT:    v_maxmin_f32 v0, s0, s1, v0
; GFX1210-GISEL-NEXT:    global_store_b32 v1, v0, s[6:7]
; GFX1210-GISEL-NEXT:    s_nop 0
; GFX1210-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-GISEL-NEXT:    s_endpgm
...
; GCN-LABEL: test_minmax_commuted_f32_ieee_false:
; GCN:       ; %bb.0:
...
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-SDAG-LABEL: test_maxmin_f32_ieee_true:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-SDAG-NEXT:    v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v0, v0, v0
; GFX1210-SDAG-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX1210-SDAG-NEXT:    v_minmax_f32 v0, v0, v1, v2
; GFX1210-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1210-GISEL-NEXT:    v_dual_max_f32 v0, v0, v0 :: v_dual_max_f32 v1, v1, v1
; GFX1210-GISEL-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX1210-GISEL-NEXT:    v_minmax_f32 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_maxmin_commuted_f32_ieee_false:
; GCN:       ; %bb.0:
...
; GCN-LABEL: test_med3_f32:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_med3_f32 v2, v2, v3, v4
; GCN-NEXT:    global_store_b32 v[0:1], v2, off
; GCN-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-LABEL: test_minmax_f16_ieee_false:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_maxmin_f16 v0, v0, v1, v2
; GCN-NEXT:    ; return to shader part epilog
...
; GFX1210-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1210-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1210-SDAG-NEXT:    v_maxmin_f16 v0, s0, s1, v0
...
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1210-GISEL-NEXT:    v_maxmin_f16 v0, s0, s1, v0
...
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-SDAG-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX1210-SDAG-NEXT:    v_maxmin_f16 v0, v0, v1, v2
; GFX1210-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-GISEL-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-GISEL-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX1210-GISEL-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX1210-GISEL-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX1210-GISEL-NEXT:    v_maxmin_f16 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    s_setpc_b64 s[30:31]
  %max = call half @llvm.maxnum.f16(half %a, half %b)
...
; GCN-LABEL: test_maxmin_f16_ieee_false:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_minmax_f16 v0, v0, v1, v2
; GCN-NEXT:    ; return to shader part epilog
...
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-SDAG-LABEL: test_maxmin_commuted_f16_ieee_true:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX1210-SDAG-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX1210-SDAG-NEXT:    v_minmax_f16 v0, v0, v1, v2
; GFX1210-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1210-GISEL-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX1210-GISEL-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX1210-GISEL-NEXT:    v_minmax_f16 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    s_setpc_b64 s[30:31]
  %min = call half @llvm.minnum.f16(half %a, half %b)
...
; GCN-LABEL: test_med3_f16:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_med3_f16 v2, v2, v3, v4
