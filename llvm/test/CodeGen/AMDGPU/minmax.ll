...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,SDAG,SDAG-GFX1250,SDAG-GFX1250-TRUE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,SDAG,SDAG-GFX1250,SDAG-GFX1250-FAKE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GISEL,GISEL-GFX1250,GISEL-GFX1250-TRUE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=-real-true16 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GISEL,GISEL-GFX1250,GISEL-GFX1250-FAKE16 %s
...
; SDAG-GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; SDAG-GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v1.l, v2.l
...
; SDAG-GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v2.l
; SDAG-GFX1250-TRUE16-NEXT:    v_max_num_f16_e32 v1.l, v1.l, v1.l
; SDAG-GFX1250-TRUE16-NEXT:    v_max_num_f16_e32 v0.l, v0.l, v0.l
; SDAG-GFX1250-TRUE16-NEXT:    v_max_num_f16_e32 v0.h, v0.h, v0.h
; SDAG-GFX1250-TRUE16-NEXT:    v_maxmin_num_f16 v0.l, v0.l, v1.l, v0.h
...
; SDAG-GFX1250-TRUE16-NEXT:    v_max_num_f16_e32 v0.l, v0.l, v0.l
; SDAG-GFX1250-TRUE16-NEXT:    v_max_num_f16_e32 v0.h, v0.h, v0.h
; SDAG-GFX1250-TRUE16-NEXT:    v_minmax_num_f16 v0.l, v0.l, v1.l, v0.h
; SDAG-GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; SDAG-GFX1250-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; SDAG-GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; SDAG-GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v2.h, v3.l
; SDAG-GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v4.l
; SDAG-GFX1250-TRUE16-NEXT:    v_med3_num_f16 v2.l, v2.l, v2.h, v3.l
