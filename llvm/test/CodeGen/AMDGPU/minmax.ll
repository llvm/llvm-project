...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11,GFX11-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11,GFX11-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
...
;
; GFX11-SDAG-LABEL: s_test_minmax_i32:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_max_i32 s0, s0, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX11-SDAG-NEXT:    s_min_i32 s0, s0, s2
...
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_max_i32 s0, s0, s1
; GFX11-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX11-GISEL-NEXT:    s_min_i32 s0, s0, s2
...
;
; GFX1250-SDAG-LABEL: s_test_minmax_i32:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_max_i32 s0, s0, s1
; GFX1250-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1250-SDAG-NEXT:    s_min_i32 s0, s0, s2
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1250-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1250-SDAG-NEXT:    global_store_b32 v0, v1, s[4:5]
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: s_test_minmax_i32:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_max_i32 s0, s0, s1
; GFX1250-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1250-GISEL-NEXT:    s_min_i32 s0, s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
...
;
; GFX11-SDAG-LABEL: s_test_minmax_u32:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_max_u32 s0, s0, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX11-SDAG-NEXT:    s_min_u32 s0, s0, s2
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX11-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX11-SDAG-NEXT:    global_store_b32 v0, v1, s[4:5]
; GFX11-SDAG-NEXT:    s_endpgm
...
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_max_u32 s0, s0, s1
; GFX11-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX11-GISEL-NEXT:    s_min_u32 s0, s0, s2
; GFX11-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GFX11-GISEL-NEXT:    global_store_b32 v1, v0, s[6:7]
; GFX11-GISEL-NEXT:    s_endpgm
;
; GFX1250-SDAG-LABEL: s_test_minmax_u32:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_max_u32 s0, s0, s1
; GFX1250-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1250-SDAG-NEXT:    s_min_u32 s0, s0, s2
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1250-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1250-SDAG-NEXT:    global_store_b32 v0, v1, s[4:5]
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: s_test_minmax_u32:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_max_u32 s0, s0, s1
; GFX1250-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1250-GISEL-NEXT:    s_min_u32 s0, s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, 0
; GFX1250-GISEL-NEXT:    global_store_b32 v1, v0, s[6:7]
; GFX1250-GISEL-NEXT:    s_endpgm
...
;
; GFX11-SDAG-LABEL: test_minmax_f32_ieee_true:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v0, v0, v0
; GFX11-SDAG-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX11-SDAG-NEXT:    v_maxmin_f32 v0, v0, v1, v2
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-GISEL-LABEL: test_minmax_f32_ieee_true:
; GFX11-GISEL:       ; %bb.0:
...
;
; GFX1250-SDAG-LABEL: test_minmax_f32_ieee_true:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_max_num_f32 v1, v1, v1 :: v_dual_max_num_f32 v0, v0, v0
; GFX1250-SDAG-NEXT:    v_max_num_f32_e32 v2, v2, v2
; GFX1250-SDAG-NEXT:    v_maxmin_num_f32 v0, v0, v1, v2
; GFX1250-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-GISEL-LABEL: test_minmax_f32_ieee_true:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    v_dual_max_num_f32 v0, v0, v0 :: v_dual_max_num_f32 v1, v1, v1
; GFX1250-GISEL-NEXT:    v_max_num_f32_e32 v2, v2, v2
; GFX1250-GISEL-NEXT:    v_maxmin_num_f32 v0, v0, v1, v2
...
;
; GFX11-SDAG-LABEL: s_test_minmax_f32_ieee_false:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX11-SDAG-NEXT:    s_mov_b32 s4, s3
...
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX11-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX11-GISEL-NEXT:    s_mov_b32 s7, s4
...
; GFX11-GISEL-NEXT:    s_endpgm
;
; GFX1250-SDAG-LABEL: s_test_minmax_f32_ieee_false:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX1250-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1250-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1250-SDAG-NEXT:    v_maxmin_num_f32 v0, s0, s1, v0
; GFX1250-SDAG-NEXT:    global_store_b32 v1, v0, s[4:5]
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: s_test_minmax_f32_ieee_false:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_max_num_f32 s0, s0, s1
; GFX1250-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1250-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-GISEL-NEXT:    s_min_num_f32 s0, s0, s2
...
;
; GFX11-SDAG-LABEL: test_maxmin_f32_ieee_true:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_dual_max_f32 v1, v1, v1 :: v_dual_max_f32 v0, v0, v0
; GFX11-SDAG-NEXT:    v_max_f32_e32 v2, v2, v2
; GFX11-SDAG-NEXT:    v_minmax_f32 v0, v0, v1, v2
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-GISEL-LABEL: test_maxmin_f32_ieee_true:
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_dual_max_f32 v0, v0, v0 :: v_dual_max_f32 v1, v1, v1
; GFX11-GISEL-NEXT:    v_max_f32_e32 v2, v2, v2
...
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1250-SDAG-LABEL: test_maxmin_f32_ieee_true:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_max_num_f32 v1, v1, v1 :: v_dual_max_num_f32 v0, v0, v0
; GFX1250-SDAG-NEXT:    v_max_num_f32_e32 v2, v2, v2
; GFX1250-SDAG-NEXT:    v_minmax_num_f32 v0, v0, v1, v2
; GFX1250-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-GISEL-LABEL: test_maxmin_f32_ieee_true:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    v_dual_max_num_f32 v0, v0, v0 :: v_dual_max_num_f32 v1, v1, v1
; GFX1250-GISEL-NEXT:    v_max_num_f32_e32 v2, v2, v2
; GFX1250-GISEL-NEXT:    v_minmax_num_f32 v0, v0, v1, v2
; GFX1250-GISEL-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1250-LABEL: test_minmax_f16_ieee_false:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; GFX1250-NEXT:    ; return to shader part epilog
...
;
; GFX11-SDAG-LABEL: s_test_minmax_f16_ieee_false:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX11-SDAG-NEXT:    s_mov_b32 s4, s3
...
; GFX11-GISEL-NEXT:    s_endpgm
;
; GFX1250-SDAG-LABEL: s_test_minmax_f16_ieee_false:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX1250-SDAG-NEXT:    s_mov_b32 s5, s4
; GFX1250-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX1250-SDAG-NEXT:    v_maxmin_num_f16 v0, s0, s1, v0
; GFX1250-SDAG-NEXT:    global_store_b16 v1, v0, s[4:5]
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: s_test_minmax_f16_ieee_false:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_max_num_f16 s0, s0, s1
; GFX1250-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1250-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-GISEL-NEXT:    s_min_num_f16 s0, s0, s2
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v0, s0
...
;
; GFX11-SDAG-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX11-SDAG-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX11-SDAG-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX11-SDAG-NEXT:    v_maxmin_f16 v0, v0, v1, v2
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-GISEL-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX11-GISEL-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX11-GISEL-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX11-GISEL-NEXT:    v_maxmin_f16 v0, v0, v1, v2
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1250-SDAG-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GFX1250-SDAG-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; GFX1250-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-GISEL-LABEL: test_minmax_commuted_f16_ieee_true:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GFX1250-GISEL-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; GFX1250-GISEL-NEXT:    s_set_pc_i64 s[30:31]
  %max = call half @llvm.maxnum.f16(half %a, half %b)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1250-LABEL: test_maxmin_f16_ieee_false:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; GFX1250-NEXT:    ; return to shader part epilog
...
;
; GFX11-SDAG-LABEL: test_maxmin_commuted_f16_ieee_true:
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SDAG-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX11-SDAG-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX11-SDAG-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX11-SDAG-NEXT:    v_minmax_f16 v0, v0, v1, v2
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-GISEL-LABEL: test_maxmin_commuted_f16_ieee_true:
; GFX11-GISEL:       ; %bb.0:
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_max_f16_e32 v0, v0, v0
; GFX11-GISEL-NEXT:    v_max_f16_e32 v1, v1, v1
; GFX11-GISEL-NEXT:    v_max_f16_e32 v2, v2, v2
; GFX11-GISEL-NEXT:    v_minmax_f16 v0, v0, v1, v2
; GFX11-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1250-SDAG-LABEL: test_maxmin_commuted_f16_ieee_true:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GFX1250-SDAG-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GFX1250-SDAG-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; GFX1250-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-GISEL-LABEL: test_maxmin_commuted_f16_ieee_true:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GFX1250-GISEL-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GFX1250-GISEL-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; GFX1250-GISEL-NEXT:    s_set_pc_i64 s[30:31]
  %min = call half @llvm.minnum.f16(half %a, half %b)
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1250-LABEL: test_med3_f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_med3_num_f16 v2, v2, v3, v4
