...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,SDAG,SDAG-GFX1250 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1250,GISEL,GISEL-GFX1250 %s
...
; GISEL-GFX12-NEXT:    s_endpgm
;
; SDAG-GFX1250-LABEL: s_test_minmax_f16_ieee_false:
; SDAG-GFX1250:       ; %bb.0:
; SDAG-GFX1250-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; SDAG-GFX1250-NEXT:    s_mov_b32 s5, s4
; SDAG-GFX1250-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX1250-NEXT:    v_maxmin_num_f16 v0, s0, s1, v0
; SDAG-GFX1250-NEXT:    global_store_b16 v1, v0, s[4:5]
; SDAG-GFX1250-NEXT:    s_endpgm
;
...
; GISEL-GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX1250-LABEL: test_minmax_commuted_f16_ieee_true:
; SDAG-GFX1250:       ; %bb.0:
; SDAG-GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; SDAG-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v1, v1, v1
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v0, v0, v0
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v2, v2, v2
; SDAG-GFX1250-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; SDAG-GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GISEL-GFX1250-LABEL: test_minmax_commuted_f16_ieee_true:
; GISEL-GFX1250:       ; %bb.0:
; GISEL-GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GISEL-GFX1250-NEXT:    s_wait_kmcnt 0x0
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GISEL-GFX1250-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; GISEL-GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %max = call half @llvm.maxnum.f16(half %a, half %b)
...
; GISEL-GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX1250-LABEL: test_maxmin_commuted_f16_ieee_true:
; SDAG-GFX1250:       ; %bb.0:
; SDAG-GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; SDAG-GFX1250-NEXT:    s_wait_kmcnt 0x0
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v1, v1, v1
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v0, v0, v0
; SDAG-GFX1250-NEXT:    v_max_num_f16_e32 v2, v2, v2
; SDAG-GFX1250-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; SDAG-GFX1250-NEXT:    s_set_pc_i64 s[30:31]
;
; GISEL-GFX1250-LABEL: test_maxmin_commuted_f16_ieee_true:
; GISEL-GFX1250:       ; %bb.0:
; GISEL-GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GISEL-GFX1250-NEXT:    s_wait_kmcnt 0x0
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v0, v0, v0
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v1, v1, v1
; GISEL-GFX1250-NEXT:    v_max_num_f16_e32 v2, v2, v2
; GISEL-GFX1250-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; GISEL-GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %min = call half @llvm.minnum.f16(half %a, half %b)
