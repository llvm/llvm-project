...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-insert-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11 %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-insert-delay-alu=0 < %s | FileCheck -check-prefixes=GFX11 %s
