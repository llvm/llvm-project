...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs -amdgpu-enable-delay-alu=0 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-GISEL %s
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_minmax_commuted_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_maxmin_i32 v0, v0, v1, v2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_maxmin_commuted_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_minmax_i32 v0, v0, v1, v2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_minmax_commuted_u32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_maxmin_u32 v0, v0, v1, v2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_maxmin_commuted_u32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_minmax_u32 v0, v0, v1, v2
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_max_num_f32 s0, s0, s1
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_mov_b32 s7, s4
...
;
; GFX1210-LABEL: test_minmax_commuted_f32_ieee_false:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_maxmin_num_f32 v0, v0, v1, v2
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_maxmin_commuted_f32_ieee_false:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_minmax_num_f32 v0, v0, v1, v2
; GFX1210-NEXT:    ; return to shader part epilog
  %min = call float @llvm.minnum.f32(float %a, float %b)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_minmax_f16_ieee_false:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_maxmin_num_f16 v0, v0, v1, v2
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_max_num_f16 s0, s0, s1
; GFX1210-GISEL-NEXT:    s_mov_b32 s6, s3
; GFX1210-GISEL-NEXT:    s_mov_b32 s7, s4
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_maxmin_f16_ieee_false:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_minmax_num_f16 v0, v0, v1, v2
; GFX1210-NEXT:    ; return to shader part epilog
