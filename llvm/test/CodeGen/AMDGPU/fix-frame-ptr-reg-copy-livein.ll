...
define i32 @fp_save_restore_in_temp_sgpr(ptr addrspace(5) nocapture readonly byval(%struct.Data) align 4 %arg) #0 {
  ...
  ; GCN: bb.0.begin:
  ; GCN:   liveins: $sgpr14
  ; GCN:   $sgpr14 = frame-setup COPY $sgpr33
  ; GCN:   $sgpr33 = frame-setup COPY $sgpr32
  ; GCN: bb.1.lp_end:
  ; GCN:   liveins: $sgpr10, $sgpr11, $sgpr14, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8_sgpr9
  ; GCN: bb.2.lp_begin:
  ; GCN:   liveins: $sgpr10, $sgpr11, $sgpr14, $sgpr4_sgpr5, $sgpr6_sgpr7
  ; GCN: bb.3.Flow:
  ; GCN:   liveins: $sgpr10, $sgpr11, $sgpr14, $vgpr0, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8_sgpr9
  ; GCN: bb.4.end:
  ; GCN:   liveins: $sgpr14, $vgpr0, $sgpr4_sgpr5
  ; GCN:   $sgpr33 = frame-destroy COPY $sgpr14
begin:
  br label %lp_begin
