...
;
; GFX1210-LABEL: local_nontemporal_load_0:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_nontemporal_load_1:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_nontemporal_store_0:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_nontemporal_store_1:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_nontemporal_volatile_load:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
; GFX1210-NEXT:    s_load_b32 s2, s[0:1], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
