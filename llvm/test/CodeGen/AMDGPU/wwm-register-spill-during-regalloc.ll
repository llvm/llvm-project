...
; WWM-SPILL-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8_sgpr9, $sgpr10_sgpr11, $sgpr30_sgpr31
; WWM-SPILL-NEXT: {{  $}}
; WWM-SPILL-NEXT:   renamable $vgpr0 = IMPLICIT_DEF
; WWM-SPILL-NEXT:   renamable $vgpr0 = V_WRITELANE_B32 $sgpr30, 0, killed $vgpr0, implicit-def $sgpr30_sgpr31, implicit $sgpr30_sgpr31
; WWM-SPILL-NEXT:   renamable $vgpr0 = V_WRITELANE_B32 killed $sgpr31, 1, killed $vgpr0, implicit killed $sgpr30_sgpr31
; WWM-SPILL-NEXT:   SI_SPILL_WWM_V32_SAVE killed $vgpr0, %stack.1, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.1, addrspace 5)
; WWM-SPILL-NEXT:   frame-setup CFI_INSTRUCTION escape 0x10, 0x10, 0x08, 0x4f, 0x9d, 0x20, 0x00, 0x4f, 0x9d, 0x20, 0x20
...
; WWM-SPILL-NEXT:   renamable $vgpr0 = SI_SPILL_WWM_V32_RESTORE %stack.1, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.1, addrspace 5)
; WWM-SPILL-NEXT:   $sgpr30 = V_READLANE_B32 $vgpr0, 0, implicit-def $sgpr30_sgpr31
; WWM-SPILL-NEXT:   $sgpr31 = V_READLANE_B32 killed $vgpr0, 1
; WWM-SPILL-NEXT:   SI_RETURN
;
; WWM-SPILL-O0-LABEL: name: test
; WWM-SPILL-O0: bb.0 (%ir-block.0):
; WWM-SPILL-O0-NEXT:   liveins: $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr8_sgpr9, $sgpr10_sgpr11, $sgpr30_sgpr31
; WWM-SPILL-O0-NEXT: {{  $}}
; WWM-SPILL-O0-NEXT:   renamable $vgpr0 = IMPLICIT_DEF
; WWM-SPILL-O0-NEXT:   renamable $vgpr0 = V_WRITELANE_B32 killed $sgpr30, 0, $vgpr0, implicit-def $sgpr30_sgpr31, implicit $sgpr30_sgpr31
; WWM-SPILL-O0-NEXT:   renamable $vgpr0 = V_WRITELANE_B32 killed $sgpr31, 1, $vgpr0, implicit killed $sgpr30_sgpr31
; WWM-SPILL-O0-NEXT:   SI_SPILL_WWM_V32_SAVE $vgpr0, %stack.1, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.1, addrspace 5)
; WWM-SPILL-O0-NEXT:   frame-setup CFI_INSTRUCTION escape 0x10, 0x10, 0x08, 0x4f, 0x9d, 0x20, 0x00, 0x4f, 0x9d, 0x20, 0x20
...
; WWM-SPILL-O0-NEXT:   $vgpr0 = SI_SPILL_WWM_V32_RESTORE %stack.1, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.1, addrspace 5)
; WWM-SPILL-O0-NEXT:   ADJCALLSTACKDOWN 0, 0, implicit-def dead $scc, implicit-def $sgpr32, implicit $sgpr32
; WWM-SPILL-O0-NEXT:   dead $sgpr30 = V_READLANE_B32 $vgpr0, 0, implicit-def $sgpr30_sgpr31
; WWM-SPILL-O0-NEXT:   dead $sgpr31 = V_READLANE_B32 killed $vgpr0, 1
