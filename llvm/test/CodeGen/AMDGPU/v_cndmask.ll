...
; RUN: llc -march=amdgcn -mcpu=gfx1010 -mattr=-flat-for-global,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -mattr=-flat-for-global,+wavefrontsize64 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS %s
...
; never be moved.
; However on GFX10PLUS constant bus is limited to 2 scalar operands, not one.

; GCN-LABEL: {{^}}v_cnd_nan:
; SIVI:  s_cmp_eq_u32 s{{[0-9]+}}, 0
; SIVI:  s_cselect_b64 vcc, -1, 0
; SIVI:  v_cndmask_b32_e32 v{{[0-9]+}}, -1, v{{[0-9]+}}, vcc
; GFX10PLUS: s_cmp_eq_u32 s{{[0-9]+}}, 0
; GFX10PLUS: s_cselect_b64 [[CC:s\[[0-9:]+\]]],
; GFX10PLUS: v_cndmask_b32_e64 v{{[0-9]+}}, -1, s{{[0-9]+}}, [[CC]]
; GCN-DAG: v{{[0-9]}}
; All nan values are converted to 0xffffffff
; GCN: s_endpgm
...
; GFX10PLUS-DAG: v_cmp_nlg_f32_e64 [[CC:s\[[0-9:]+\]]], s[[X]], 0
; SIVI-DAG:      v_mov_b32_e32 [[VZ:v[0-9]+]], s[[Z]]
; SIVI:          v_cndmask_b32_e32 v{{[0-9]+}}, 1.0, [[VZ]], [[CC]]
; GFX10PLUS:     v_cndmask_b32_e64 v{{[0-9]+}}, 1.0, s[[Z]], [[CC]]
...
; GFX10PLUS-DAG: v_cmp_nlg_f32_e64 [[CC:s\[[0-9:]+\]]], [[X]], 0
; SIVI-DAG:      v_mov_b32_e32 [[VX:v[0-9]+]], [[X]]
; SIVI:          v_cndmask_b32_e32 v{{[0-9]+}}, 1.0, [[VX]], [[CC]]
; GFX10PLUS:     v_cndmask_b32_e64 v{{[0-9]+}}, 1.0, [[X]], [[CC]]
...
; GFX10PLUS:     v_cndmask_b32_e64 v{{[0-9]+}}, 0, s[[Z]], [[CC]]
...
; GFX10PLUS:     v_cndmask_b32_e64 v{{[0-9]+}}, 0, [[X]], [[CC]]
...
; GFX10PLUS:    v_cndmask_b32_e64 v{{[0-9]+}}, 1.0, [[Z]], vcc
...
; GCN: {{buffer|flat|global}}_load_{{dword|b32}} [[X:v[0-9]+]]
; GCN: {{buffer|flat|global}}_load_{{dwordx4|b128}}
...
; GFX10PLUS-DAG: v_cndmask_b32_e32 v{{[0-9]+}}, 0x3ff00000, v{{[0-9]+}}, vcc
