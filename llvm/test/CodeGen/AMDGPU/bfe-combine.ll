...
; RUN: llc -mtriple=amdgpu8.03 -amdgpu-sdwa-peephole=0 < %s | FileCheck %s --check-prefixes=VI
; RUN: llc -mtriple=amdgpu8.03 < %s | FileCheck %s --check-prefixes=VI-SDWA
; RUN: llc -mtriple=amdgpu7.04 < %s | FileCheck %s --check-prefixes=CI
...
; VI-SDWA-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
