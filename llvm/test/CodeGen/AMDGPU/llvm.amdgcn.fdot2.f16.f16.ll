...
; GISEL-GFX11-TRUE16-NEXT:    global_load_u16 v0, v1, s[6:7]
...
; GISEL-GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX11-TRUE16-NEXT:    scratch_load_b32 v0, off, s1
; GISEL-GFX11-TRUE16-NEXT:    scratch_load_b32 v1, off, s2
; GISEL-GFX11-TRUE16-NEXT:    scratch_load_u16 v2, off, s3
; GISEL-GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(2)
; GISEL-GFX11-TRUE16-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[1,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GISEL-GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GISEL-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-GFX11-TRUE16-NEXT:    v_dot2_f16_f16 v0.l, v0, v1, v2.l
