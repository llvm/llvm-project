...
; RUN: llc < %s -mtriple=amdgpu12.00-- -amdgpu-expert-scheduling-mode=0 | FileCheck %s --check-prefix=GFX12
; RUN: llc < %s -mtriple=amdgpu12.00-- -amdgpu-expert-scheduling-mode=1 | FileCheck %s --check-prefix=GFX12-ESM
