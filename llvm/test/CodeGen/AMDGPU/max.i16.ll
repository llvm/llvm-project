...
; RUN: llc -mtriple=amdgpu8.03-- -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=VI
; RUN: llc -mtriple=amdgpu9.00-- -mattr=-flat-for-global < %s | FileCheck %s --check-prefix=GFX9
...
; GFX9-NEXT:    ; kill: killed $sgpr2_64
; GFX9-NEXT:    s_nop 0
