...
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, 3, v[5:6]
...
; GFX1030-NEXT:    v_lshrrev_b32_e32 v5, 1, v3
; GFX1030-NEXT:    ; implicit-def: $vgpr3
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, v5, 3, v[2:3]
...
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v2, 6, v[5:6]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v4
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v2, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1030-NEXT:    v_mov_b32_e32 v2, v5
; GFX1030-NEXT:    v_lshrrev_b32_e32 v5, 2, v3
; GFX1030-NEXT:    ; implicit-def: $vgpr3
; GFX1030-NEXT:    v_sub_co_u32 v0, vcc_lo, v0, v4
; GFX1030-NEXT:    v_mad_u64_u32 v[2:3], null, v5, 6, v[2:3]
; GFX1030-NEXT:    v_sub_co_ci_u32_e64 v1, null, v1, v2, vcc_lo
; GFX1030-NEXT:    s_setpc_b64 s[30:31]
entry:
  %rem = urem i64 %i, 6
