...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -o - %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu9.42-amd-amdhsa -o - %s | FileCheck -check-prefixes=GFX942 %s
; RUN: llc -mtriple=amdgpu9.4-amd-amdhsa --amdhsa-code-object-version=6 -o - %s | FileCheck -check-prefixes=GFX942 %s
; RUN: llc -mtriple=amdgpu10.30-amd-amdhsa -o - %s | FileCheck -check-prefixes=GFX1030 %s
