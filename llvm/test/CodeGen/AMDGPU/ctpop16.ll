...
; SI-NEXT:  .LBB14_2: ; %if
; SI-NEXT:    s_and_b32 s1, s8, 0xffff
; SI-NEXT:    s_bcnt1_i32_b32 s1, s1
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; VI-NEXT:  .LBB14_2: ; %if
; VI-NEXT:    s_and_b32 s1, s8, 0xffff
; VI-NEXT:    s_bcnt1_i32_b32 s1, s1
; VI-NEXT:    s_waitcnt vmcnt(0)
