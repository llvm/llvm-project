...
; GCN-NEXT:    v_alignbyte_b32 v0, s2, v0, v1
...
; GFX9-NEXT:    v_alignbyte_b32 v1, s2, v1, v2
...
; GFX10-NEXT:    v_alignbyte_b32 v0, s2, s3, v0
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, s6
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_alignbyte_b32 v0, s2, s3, v0.l
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s6
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_alignbyte_b32 v0, s2, s3, v0
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s3, s9
; GCN-NEXT:    s_mov_b32 s5, s9
; GCN-NEXT:    s_mov_b32 s14, s9
...
; GCN-NEXT:    buffer_load_dword v0, v[0:1], s[16:19], 0 addr64 glc
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_mov_b32 s10, -1
; GCN-NEXT:    s_mov_b32 s8, s0
; GCN-NEXT:    v_alignbyte_b32 v0, v2, v0, s6
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    v_alignbyte_b32 v1, v1, v2, s14
...
; GFX10-NEXT:    global_load_dword v0, v0, s[4:5] glc dlc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_alignbyte_b32 v0, v1, v0, s6
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_alignbyte_b32 v0, v1, v0, s6
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_alignbyte_b32 v0, v1, v0, s6
