...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_cvt_f32_bf8_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_cvt_pk_bf8_f32_word0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, v3
; GFX1210-NEXT:    v_cvt_pk_bf8_f32_e64_dpp v2, v0, v1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1210-NEXT:    global_store_b32 v[4:5], v2, off
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_cvt_pk_fp8_f32_word1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1210-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, v3
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_cvt_sr_bf8_f32_byte0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, v3
; GFX1210-NEXT:    v_cvt_sr_bf8_f32_e64_dpp v2, v0, v1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1210-NEXT:    global_store_b32 v[4:5], v2, off
; GFX1210-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_cvt_sr_fp8_f32_byte1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, v3
; GFX1210-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1210-NEXT:    global_store_b32 v[4:5], v2, off
; GFX1210-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX12-NEXT:    s_endpgm
;
; GFX1210-LABEL: test_cvt_sr_fp8_f32_byte2:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v4, v3
; GFX1210-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:2 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1210-NEXT:    global_store_b32 v[4:5], v2, off
; GFX1210-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
