...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1170PLUS,GFX1250 %s
...
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_cvt_pk_bf8_f32_e64_dpp v2, v0, v1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
...
; GFX1170-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1]
; GFX1170-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170-NEXT:    s_endpgm
;
