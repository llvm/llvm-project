...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1170 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1170PLUS,GFX1170 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1170PLUS,GFX12 %s

define amdgpu_cs float @test_cvt_f32_bf8_byte0(i32 %a) {
; GFX1170PLUS-LABEL: test_cvt_f32_bf8_byte0:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_f32_bf8_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    ; return to shader part epilog
...
; GFX1170PLUS-LABEL: test_cvt_f32_bf8_byte1:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_f32_bf8_e64_dpp v0, v0 byte_sel:1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    ; return to shader part epilog
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
...
; GFX1170PLUS-LABEL: test_cvt_f32_bf8_byte2:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_f32_bf8_e64_dpp v0, v0 byte_sel:2 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    ; return to shader part epilog
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
...
; GFX1170PLUS-LABEL: test_cvt_f32_fp8_byte3:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_f32_fp8_e64_dpp v0, v0 byte_sel:3 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    ; return to shader part epilog
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
...
; GFX1170PLUS-LABEL: test_cvt_pk_bf8_f32_word0:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_pk_bf8_f32_e64_dpp v2, v0, v1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170PLUS-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
...
; GFX1170PLUS-LABEL: test_cvt_pk_fp8_f32_word1:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_mov_b32_dpp v0, v0 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170PLUS-NEXT:    v_cvt_pk_fp8_f32 v2, v0, v1 op_sel:[0,0,1]
; GFX1170PLUS-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170PLUS-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX1170PLUS-LABEL: test_cvt_sr_bf8_f32_byte0:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_sr_bf8_f32_e64_dpp v2, v0, v1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170PLUS-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX1170PLUS-LABEL: test_cvt_sr_fp8_f32_byte1:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:1 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170PLUS-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
...
; GFX1170PLUS-LABEL: test_cvt_sr_fp8_f32_byte2:
; GFX1170PLUS:       ; %bb.0:
; GFX1170PLUS-NEXT:    v_cvt_sr_fp8_f32_e64_dpp v2, v0, v1 byte_sel:2 quad_perm:[0,1,2,3] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX1170PLUS-NEXT:    global_store_b32 v[3:4], v2, off
; GFX1170PLUS-NEXT:    s_endpgm
  %tmp0 = call i32 @llvm.amdgcn.mov.dpp.i32(i32 %a, i32 228, i32 15, i32 15, i1 1)
  %tmp1 = bitcast i32 %tmp0 to float
