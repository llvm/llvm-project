...
; GFX7-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_add_u32 s6, s8, 32
; GFX7-NEXT:    s_addc_u32 s7, s9, 0
; GFX7-NEXT:    v_mov_b32_e32 v0, s6
; GFX7-NEXT:    v_mov_b32_e32 v1, s7
; GFX7-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
...
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX7-NEXT:    v_cmp_lt_u64_e64 s[0:1], s[4:5], v[2:3]
; GFX7-NEXT:    v_add_i32_e64 v7, s[2:3], -1, v2
; GFX7-NEXT:    v_mov_b32_e32 v0, s5
; GFX7-NEXT:    v_mov_b32_e32 v6, s4
...
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_add_u32 s6, s8, 32
; GFX8-NEXT:    s_addc_u32 s7, s9, 0
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mov_b32_e32 v1, s7
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
...
; GFX8-NEXT:    v_mov_b32_e32 v2, v0
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX8-NEXT:    v_cmp_lt_u64_e64 s[0:1], s[4:5], v[2:3]
; GFX8-NEXT:    v_add_u32_e64 v7, s[2:3], -1, v2
; GFX8-NEXT:    v_mov_b32_e32 v0, s5
; GFX8-NEXT:    v_mov_b32_e32 v6, s4
...
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX7-NEXT:    v_cmp_lt_u64_e64 s[0:1], s[8:9], v[2:3]
; GFX7-NEXT:    v_add_i32_e64 v7, s[2:3], -1, v2
...
; GFX8-NEXT:    v_mov_b32_e32 v2, v0
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GFX8-NEXT:    v_cmp_lt_u64_e64 s[0:1], s[8:9], v[2:3]
; GFX8-NEXT:    v_add_u32_e64 v7, s[2:3], -1, v2
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshl_b64 s[0:1], s[10:11], 3
; GFX8-NEXT:    s_add_u32 s4, s4, s0
; GFX8-NEXT:    s_addc_u32 s5, s5, s1
; GFX8-NEXT:    v_mov_b32_e32 v0, s4
; GFX8-NEXT:    v_mov_b32_e32 v1, s5
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GFX8-NEXT:    s_mov_b64 s[10:11], 0
