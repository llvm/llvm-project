...
; SI-NEXT:    v_mov_b32_e32 v6, v14
; SI-NEXT:    ; implicit-def: $vgpr14
; SI-NEXT:    s_andn2_saveexec_b64 s[4:5], s[4:5]
; SI-NEXT:    s_cbranch_execz .LBB0_2
; SI-NEXT:  .LBB0_4: ; %cmp.true
; SI-NEXT:    v_add_i32_e32 v6, vcc, 3, v14
; SI-NEXT:    v_add_i32_e32 v5, vcc, 3, v13
; SI-NEXT:    v_add_i32_e32 v4, vcc, 3, v12
...
; VI-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3_vgpr4_vgpr5_vgpr6
...
; VI-NEXT:    v_add_u32_e32 v6, vcc, 3, v14
...
; GFX9-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3_vgpr4_vgpr5_vgpr6
...
; GFX9-NEXT:    v_add_u32_e32 v6, 3, v14
...
; GFX11-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3_vgpr4_vgpr5_vgpr6
...
; GFX11-NEXT:    v_mov_b32_e32 v6, v14
...
; SI-NEXT:    v_add_f32_e32 v6, 1.0, v14
; SI-NEXT:    v_add_f32_e32 v5, 1.0, v13
; SI-NEXT:    v_add_f32_e32 v4, 1.0, v12
...
; VI-NEXT:    v_add_f32_e32 v6, 1.0, v14
...
; GFX9-NEXT:    v_add_f32_e32 v6, 1.0, v14
...
; GFX11-NEXT:    v_dual_add_f32 v6, 1.0, v14 :: v_dual_add_f32 v5, 1.0, v13
...
; GFX11-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v9, v1
; GFX11-NEXT:    v_mov_b32_e32 v8, v0
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v7
...
; SI-NEXT:    s_add_i32 s24, s22, 3
; SI-NEXT:    s_add_i32 s7, s17, 3
; SI-NEXT:    s_add_i32 s6, s16, 3
; SI-NEXT:    s_add_i32 s10, s18, 3
; SI-NEXT:    s_add_i32 s15, s21, 3
; SI-NEXT:    s_add_i32 s14, s20, 3
; SI-NEXT:    s_lshr_b32 s25, s11, 16
...
; SI-NEXT:    v_or_b32_e32 v4, v4, v16
...
; VI-NEXT:    v_add_u16_sdwa v1, v14, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v6, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v13
; VI-NEXT:    v_add_u16_sdwa v1, v13, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v5, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v12
; VI-NEXT:    v_add_u16_sdwa v1, v12, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v4, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v11
; VI-NEXT:    v_add_u16_sdwa v1, v11, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v3, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v10
; VI-NEXT:    v_add_u16_sdwa v1, v10, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v2, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v9
; VI-NEXT:    v_add_u16_sdwa v1, v9, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v1, v0, v1
; VI-NEXT:    v_add_u16_e32 v0, 3, v8
; VI-NEXT:    v_add_u16_sdwa v7, v8, v7 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX9-NEXT:    v_pk_add_u16 v6, v14, 3 op_sel_hi:[1,0]
...
; GFX11-NEXT:    v_pk_add_u16 v6, v14, 3 op_sel_hi:[1,0]
...
; SI-NEXT:    v_cvt_f32_f16_e32 v5, v16
...
; VI-NEXT:    v_add_f16_sdwa v1, v14, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v2, 0x200, v14
; VI-NEXT:    v_or_b32_e32 v6, v2, v1
; VI-NEXT:    v_add_f16_sdwa v1, v13, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v2, 0x200, v13
...
; VI-NEXT:    v_add_f16_sdwa v0, v8, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v7, 0x200, v8
...
; GFX9-NEXT:    v_pk_add_f16 v6, v14, s6 op_sel_hi:[1,0]
...
; GFX11-NEXT:    v_pk_add_f16 v6, 0x200, v14 op_sel_hi:[0,1]
...
; SI-NEXT:    v_add_f32_e64 v1, s17, 1.0
; SI-NEXT:    v_add_f32_e64 v0, s16, 1.0
; SI-NEXT:    v_lshr_b64 v[10:11], v[2:3], 16
...
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v15, v1, v23
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v3
; SI-NEXT:    v_or_b32_e32 v16, v0, v22
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
; SI-NEXT:    v_or_b32_e32 v13, v1, v25
...
; SI-NEXT:    v_alignbit_b32 v19, v7, v11, 16
...
; VI-NEXT:    v_add_u16_sdwa v2, v14, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_u16_e32 v3, 3, v14
; VI-NEXT:    v_add_u16_sdwa v1, v13, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v6, v3, v2
; VI-NEXT:    v_add_u16_e32 v2, 3, v13
; VI-NEXT:    v_or_b32_e32 v5, v2, v1
...
; VI-NEXT:    v_add_u16_sdwa v7, v8, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v3, v2, v1
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_lshr_b32 s26, s22, 16
; SI-NEXT:    s_lshr_b32 s29, s21, 16
...
; SI-NEXT:    v_cvt_f32_f16_e32 v7, v14
...
; SI-NEXT:    v_or_b32_e32 v2, v2, v13
; SI-NEXT:    v_or_b32_e32 v4, v4, v12
; SI-NEXT:    v_alignbit_b32 v14, v1, v7, 16
; SI-NEXT:    v_alignbit_b32 v13, v3, v13, 16
; SI-NEXT:    v_alignbit_b32 v12, v5, v12, 16
; SI-NEXT:  .LBB22_2: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_lshlrev_b32_e32 v7, 16, v14
; SI-NEXT:    v_or_b32_e32 v0, v0, v7
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
...
; VI-NEXT:    ; kill: def $vgpr7 killed $sgpr4 killed $exec
...
; VI-NEXT:    v_add_f16_sdwa v13, v5, v8 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_f16_sdwa v8, v6, v8 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v5, 0x200, v5
; VI-NEXT:    v_add_f16_e32 v6, 0x200, v6
; VI-NEXT:    v_or_b32_e32 v14, v6, v8
; VI-NEXT:    v_or_b32_e32 v13, v5, v13
; VI-NEXT:    v_or_b32_e32 v12, v12, v4
; VI-NEXT:    v_or_b32_e32 v11, v11, v3
; VI-NEXT:    v_or_b32_e32 v10, v10, v2
; VI-NEXT:    v_or_b32_e32 v9, v9, v1
; VI-NEXT:    v_or_b32_e32 v8, v7, v0
; VI-NEXT:  .LBB22_4: ; %end
; VI-NEXT:    s_or_b64 exec, exec, s[4:5]
; VI-NEXT:    v_mov_b32_e32 v0, v8
; VI-NEXT:    v_mov_b32_e32 v1, v9
...
; SI-NEXT:    v_add_f32_e32 v5, 0x38000000, v5
; SI-NEXT:    v_cvt_f16_f32_e32 v15, v5
...
; SI-NEXT:    v_add_f32_e32 v1, 0x38000000, v6
; SI-NEXT:    v_cvt_f16_f32_e32 v1, v1
