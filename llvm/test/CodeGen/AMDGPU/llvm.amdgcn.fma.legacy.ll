...
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GCN,GFX10,SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GCN,GFX10,GISEL %s
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GCN,GFX11,SDAG-GFX11 %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GCN,GFX11,GISEL-GFX11 %s
...
; GFX10-NEXT:    v_fmac_legacy_f32_e64 v2, v0, v1
...
; GFX11-NEXT:    v_fmac_legacy_f32_e64 v2, v0, v1
...
;
; SDAG-GFX11-LABEL: main:
; SDAG-GFX11:       ; %bb.0:
; SDAG-GFX11-NEXT:    s_mov_b32 s16, exec_lo
; SDAG-GFX11-NEXT:    v_mov_b32_e32 v14, v2
; SDAG-GFX11-NEXT:    s_wqm_b32 exec_lo, exec_lo
; SDAG-GFX11-NEXT:    s_mov_b32 s0, s5
; SDAG-GFX11-NEXT:    s_mov_b32 s1, 0
; SDAG-GFX11-NEXT:    s_mov_b32 m0, s7
; SDAG-GFX11-NEXT:    s_clause 0x1
; SDAG-GFX11-NEXT:    s_load_b256 s[8:15], s[0:1], 0x400
; SDAG-GFX11-NEXT:    s_load_b128 s[0:3], s[0:1], 0x430
; SDAG-GFX11-NEXT:    v_interp_p1_f32_e32 v2, v0, attr0.x
; SDAG-GFX11-NEXT:    v_interp_p1_f32_e32 v3, v0, attr0.y
; SDAG-GFX11-NEXT:    s_mov_b32 s4, s6
; SDAG-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) instskip(NEXT) instid1(VALU_DEP_2)
; SDAG-GFX11-NEXT:    v_interp_p2_f32_e32 v2, v1, attr0.x
; SDAG-GFX11-NEXT:    v_interp_p2_f32_e32 v3, v1, attr0.y
; SDAG-GFX11-NEXT:    s_and_b32 exec_lo, exec_lo, s16
; SDAG-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX11-NEXT:    image_sample v[0:3], v[2:3], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; SDAG-GFX11-NEXT:    s_waitcnt vmcnt(0)
; SDAG-GFX11-NEXT:    v_fma_legacy_f32 v0, v0, 2.0, -1.0
; SDAG-GFX11-NEXT:    v_fma_legacy_f32 v1, v1, 2.0, -1.0
; SDAG-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-GFX11-NEXT:    ; return to shader part epilog
;
; GISEL-GFX11-LABEL: main:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    s_mov_b32 s16, exec_lo
; GISEL-GFX11-NEXT:    s_mov_b32 s4, s6
; GISEL-GFX11-NEXT:    s_mov_b32 m0, s7
; GISEL-GFX11-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GISEL-GFX11-NEXT:    s_add_u32 s0, s5, 0x400
; GISEL-GFX11-NEXT:    s_mov_b32 s1, 0
; GISEL-GFX11-NEXT:    v_interp_p1_f32_e32 v3, v0, attr0.y
; GISEL-GFX11-NEXT:    s_load_b256 s[8:15], s[0:1], 0x0
; GISEL-GFX11-NEXT:    s_add_u32 s0, s5, 0x430
; GISEL-GFX11-NEXT:    v_mov_b32_e32 v14, v2
; GISEL-GFX11-NEXT:    s_load_b128 s[0:3], s[0:1], 0x0
; GISEL-GFX11-NEXT:    v_interp_p1_f32_e32 v2, v0, attr0.x
; GISEL-GFX11-NEXT:    v_interp_p2_f32_e32 v3, v1, attr0.y
; GISEL-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GISEL-GFX11-NEXT:    v_interp_p2_f32_e32 v2, v1, attr0.x
; GISEL-GFX11-NEXT:    s_and_b32 exec_lo, exec_lo, s16
; GISEL-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX11-NEXT:    image_sample v[0:3], v[2:3], s[8:15], s[0:3] dmask:0xf dim:SQ_RSRC_IMG_2D
; GISEL-GFX11-NEXT:    s_waitcnt vmcnt(0)
; GISEL-GFX11-NEXT:    v_fma_legacy_f32 v0, v0, 2.0, -1.0
; GISEL-GFX11-NEXT:    v_fma_legacy_f32 v1, v1, 2.0, -1.0
