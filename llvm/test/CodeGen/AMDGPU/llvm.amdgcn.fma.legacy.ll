...
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX10,SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1030 < %s | FileCheck -check-prefixes=GFX10,GISEL %s
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GFX11,SDAG-GFX11 %s
; RUN: llc -global-isel -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 < %s | FileCheck -check-prefixes=GFX11,GISEL-GFX11 %s
...
; GFX11-NEXT:    v_fmac_dx9_zero_f32_e64 v2, v0, v1
...
; SDAG-GFX11-NEXT:    v_fma_dx9_zero_f32 v0, v0, 2.0, -1.0
; SDAG-GFX11-NEXT:    v_fma_dx9_zero_f32 v1, v1, 2.0, -1.0
...
; GISEL-GFX11-NEXT:    v_fma_dx9_zero_f32 v0, v0, 2.0, -1.0
; GISEL-GFX11-NEXT:    v_fma_dx9_zero_f32 v1, v1, 2.0, -1.0
