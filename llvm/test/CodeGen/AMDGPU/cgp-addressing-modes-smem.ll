...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefixes=GFX6789,GFX678,GFX689,GFX67,GFX6
; RUN: llc -mtriple=amdgpu7.00 < %s | FileCheck %s -check-prefixes=GFX6789,GFX678,GFX67,GFX7
; RUN: llc -mtriple=amdgpu8.01 < %s | FileCheck %s -check-prefixes=GFX6789,GFX678,GFX689,GFX89
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck %s -check-prefixes=GFX6789,GFX689,GFX89,GFX9
