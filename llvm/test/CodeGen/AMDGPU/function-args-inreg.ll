...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    global_store_dwordx4 v[0:1], v[12:15], off
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_store_short v[0:1], v18, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_store_short v[0:1], v19, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b8 v[0:1], v13, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b16 v[0:1], v14, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b16 v[0:1], v15, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    global_store_b128 v[0:1], v[16:19], off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b128 v[0:1], v[20:23], off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v16, s21
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v16, s22
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v16, s23
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v16, s24
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v16, s25
; GFX9-NEXT:    global_store_dword v[0:1], v16, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_dual_mov_b32 v12, s0 :: v_dual_mov_b32 v13, s1
; GFX11-NEXT:    v_dual_mov_b32 v14, s2 :: v_dual_mov_b32 v15, s3
; GFX11-NEXT:    v_mov_b32_e32 v16, s6
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_dual_mov_b32 v13, s16 :: v_dual_mov_b32 v12, s7
; GFX11-NEXT:    v_dual_mov_b32 v15, s18 :: v_dual_mov_b32 v14, s17
; GFX11-NEXT:    v_mov_b32_e32 v16, s19
; GFX11-NEXT:    global_store_b32 v[0:1], v12, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b32 v[0:1], v13, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX11-NEXT:    global_store_b32 v[0:1], v16, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_dual_mov_b32 v15, s23 :: v_dual_mov_b32 v12, s20
; GFX11-NEXT:    v_dual_mov_b32 v13, s21 :: v_dual_mov_b32 v14, s22
; GFX11-NEXT:    v_mov_b32_e32 v16, s24
; GFX11-NEXT:    global_store_b32 v[0:1], v12, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b32 v[0:1], v13, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX11-NEXT:    global_store_b32 v[0:1], v16, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_dual_mov_b32 v15, s28 :: v_dual_mov_b32 v12, s25
; GFX11-NEXT:    v_dual_mov_b32 v13, s26 :: v_dual_mov_b32 v14, s27
; GFX11-NEXT:    v_mov_b32_e32 v16, s29
; GFX11-NEXT:    global_store_b32 v[0:1], v12, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_store_b32 v[0:1], v13, off dlc
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX9-NEXT:    s_add_u32 s18, s18, caller_void_func_i32_v2float_inreg@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s19, s19, caller_void_func_i32_v2float_inreg@gotpcrel32@hi+12
; GFX9-NEXT:    s_load_dwordx2 s[18:19], s[18:19], 0x0
