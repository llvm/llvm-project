...
; VI-NEXT:    s_and_b64 s[0:1], s[4:5], exec
; VI-NEXT:    s_cselect_b32 s0, 1, 0
...
; GFX9-NEXT:    s_and_b64 s[0:1], s[4:5], exec
; GFX9-NEXT:    s_cselect_b32 s0, 1, 0
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_sub_co_u32 v0, s5, s6, s7
; GFX10-NEXT:    s_cmp_eq_u32 s6, s7
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_sub_co_u32 v0, s5, s6, s7
; GFX11-NEXT:    s_cmp_eq_u32 s6, s7
...
; GFX11-NEXT:    v_sub_co_u32 v1, s1, v1, v2
...
; GFX9-NEXT:    s_cselect_b32 s2, 1, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-NEXT:    v_sub_co_u32_e32 v1, vcc, s4, v1
; GFX9-NEXT:    s_and_b64 s[2:3], vcc, exec
; GFX9-NEXT:    s_cselect_b32 s2, 1, 0
...
; GFX10-NEXT:    s_and_b32 s3, s4, exec_lo
; GFX10-NEXT:    s_cselect_b32 s3, 1, 0
; GFX10-NEXT:    v_sub_co_u32 v1, s2, s2, s3
...
; GFX11-NEXT:    s_and_b32 s3, s4, exec_lo
; GFX11-NEXT:    s_cselect_b32 s3, 1, 0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_sub_co_u32 v1, s2, s2, s3
; GFX11-NEXT:    s_and_b32 s2, s2, exec_lo
; GFX11-NEXT:    s_cselect_b32 s2, 1, 0
; GFX11-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v2, s2
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_sub_u32 s0, s8, s9
; SI-NEXT:    s_subb_u32 s0, s2, s3
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; SI-NEXT:    s_endpgm
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_sub_u32 s0, s4, s5
; VI-NEXT:    s_subb_u32 s0, s2, s3
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_sub_u32 s4, s6, s7
; GFX9-NEXT:    s_subb_u32 s2, s2, s3
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_sub_u32 s4, s6, s7
; GFX10-NEXT:    s_subb_u32 s2, s2, s3
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_sub_u32 s4, s6, s7
; GFX11-NEXT:    s_subb_u32 s2, s2, s3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
