...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 < %s | FileCheck -check-prefix=GFX1210 %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1210 < %s | FileCheck -check-prefix=GFX1210 %s
...
;
; GFX1210-LABEL: v_permlane16_swap_b32_vv:
; GFX1210:       ; %bb.0:
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vi:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vl:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0xc1d1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_permlane16_swap_b32_e32 v0, v1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_ss:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vv_fi:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vv_bc:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: v_permlane16_swap_b32_vv_fi_bc:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
