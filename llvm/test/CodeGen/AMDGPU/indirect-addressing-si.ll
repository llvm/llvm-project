...
; GENERIC-NEXT:    ; implicit-def: $vgpr2
; GENERIC-NEXT:    ; implicit-def: $vgpr3
; GENERIC-NEXT:    ; implicit-def: $vgpr4
; GENERIC-NEXT:    ; implicit-def: $vgpr5
; GENERIC-NEXT:    ; implicit-def: $vgpr6
; GENERIC-NEXT:    ; implicit-def: $vgpr7
; GENERIC-NEXT:    ; implicit-def: $vgpr8
; GENERIC-NEXT:    v_mov_b32_e32 v9, 0x41b0cccd
; GENERIC-NEXT:    ; implicit-def: $vgpr10
; GENERIC-NEXT:    ; implicit-def: $vgpr11
; GENERIC-NEXT:    ; implicit-def: $vgpr12
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
