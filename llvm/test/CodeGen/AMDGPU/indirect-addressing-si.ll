...
; NOOPT-NEXT:    ; kill: def $sgpr0 killed $sgpr0 killed $sgpr0_1
; NOOPT-NEXT:    s_mov_b32 s5, 0xf000
; NOOPT-NEXT:    s_mov_b32 s6, -1
; NOOPT-NEXT:    ; kill: def $sgpr0 killed $sgpr0 def $sgpr0_3
...
; NOOPT-NEXT:    ; implicit-def: $sgpr0_1
...
; NOOPT-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
; NOOPT-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_7
...
; NOOPT-NEXT:    ; implicit-def: $sgpr4_7
; NOOPT-NEXT:    s_waitcnt lgkmcnt(0)
; NOOPT-NEXT:    v_mov_b32_e32 v0, s4
...
; NOOPT-NEXT:    ; kill: def $sgpr8 killed $sgpr8 def $sgpr8_9
; NOOPT-NEXT:    s_mov_b32 s9, s6
; NOOPT-NEXT:    ; kill: def $sgpr4_5 killed $sgpr4_5 def $sgpr4_7
...
; NOOPT-NEXT:    s_mov_b32 s6, 0xf000
; NOOPT-NEXT:    s_mov_b32 s8, -1
; NOOPT-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_15
...
; NOOPT-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_5
; NOOPT-NEXT:    s_mov_b32 s5, s2
; NOOPT-NEXT:    ; kill: def $sgpr0_1 killed $sgpr0_1 def $sgpr0_3
; NOOPT-NEXT:    s_mov_b64 s[2:3], s[4:5]
; NOOPT-NEXT:    s_waitcnt lgkmcnt(0)
...
; NOOPT-NEXT:    s_mov_b32 s19, -1
; NOOPT-NEXT:    ; kill: def $sgpr20 killed $sgpr20 def $sgpr20_23
...
; NOOPT-NEXT:    ; kill: def $sgpr20 killed $sgpr20 def $sgpr20_21
; NOOPT-NEXT:    s_mov_b32 s21, s18
; NOOPT-NEXT:    v_writelane_b32 v32, s20, 7
; NOOPT-NEXT:    v_writelane_b32 v32, s21, 8
; NOOPT-NEXT:    ; kill: def $sgpr16_17 killed $sgpr16_17 def $sgpr16_19
...
; NOOPT-NEXT:    ; kill: def $sgpr8_9 killed $sgpr8_9 def $sgpr8_11
...
; NOOPT-NEXT:    ; kill: def $sgpr10 killed $sgpr10 def $sgpr10_11
...
; NOOPT-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_13
...
; NOOPT-NEXT:    v_mov_b32_e32 v2, v23
; NOOPT-NEXT:    v_mov_b32_e32 v3, v6
; NOOPT-NEXT:    ; kill: def $sgpr12_13 killed $sgpr12_13 def $sgpr12_15
...
; NOOPT-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 glc
; NOOPT-NEXT:    s_waitcnt vmcnt(0)
; NOOPT-NEXT:    ; implicit-def: $sgpr0_3
...
; NOOPT-NEXT:    ; kill: def $sgpr6 killed $sgpr6 def $sgpr6_7
...
; NOOPT-NEXT:    ; implicit-def: $sgpr2_3
; NOOPT-NEXT:    ; kill: def $sgpr3 killed $sgpr3 killed $sgpr2_3
; NOOPT-NEXT:    ; implicit-def: $sgpr4_5
; NOOPT-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
...
; NOOPT-NEXT:    ; implicit-def: $sgpr4_19
; NOOPT-NEXT:    s_waitcnt expcnt(0)
; NOOPT-NEXT:    v_mov_b32_e32 v0, s4
; NOOPT-NEXT:    v_mov_b32_e32 v1, s5
; NOOPT-NEXT:    v_mov_b32_e32 v2, s6
