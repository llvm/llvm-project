...
define amdgpu_kernel void @test_small_positive_constant(ptr addrspace(1) %output) {
; CHECK-LABEL: test_small_positive_constant:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen offset:100
; CHECK-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v1, v0, s[0:1]
...
define amdgpu_kernel void @test_negative_constant(ptr addrspace(1) %output) {
; CHECK-LABEL: test_negative_constant:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    buffer_load_dword v0, v0, s[0:3], -16 offen
; CHECK-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v1, v0, s[0:1]
...
define amdgpu_kernel void @test_large_constant(ptr addrspace(1) %output) {
; CHECK-LABEL: test_large_constant:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_movk_i32 s6, 0x1388
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    buffer_load_dword v0, v0, s[0:3], s6 offen
; CHECK-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
