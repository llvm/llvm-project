...
; RUN: llc -mtriple=amdgpu6.00-amd-amdhsa -O0 < %s | FileCheck --check-prefixes=GFX6 %s
...
; RUN: llc -mtriple=amdgpu9.0a-amd-amdhsa -O0 < %s | FileCheck -check-prefixes=GFX90A-NOTTGSPLIT %s
...
; RUN: llc -mtriple=amdgpu9.42-amd-amdhsa -O0 < %s | FileCheck -check-prefixes=GFX942-NOTTGSPLIT %s
; RUN: sed 's/attributes #0 = { nounwind }/attributes #0 = { nounwind "amdgpu-tg-split" }/' %s | llc -mtriple=amdgpu9.42-amd-amdhsa -O0 | FileCheck -check-prefixes=GFX942-TGSPLIT %s
