...
; RUN: llc < %s -mtriple=amdgpu6.00 | FileCheck %s -enable-var-scope -check-prefixes=GCN,SI
; RUN: llc < %s -mtriple=amdgpu8.03 | FileCheck %s -enable-var-scope -check-prefixes=GCN,VI
