...
define amdgpu_cs void @atomic_store_f32x2_seq_cst_agent_align4(<2 x float> %in, ptr addrspace(0) %out) {
; GFX9-LABEL: atomic_store_f32x2_seq_cst_agent_align4:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX9-NEXT:    s_endpgm
;
; GFX10-LABEL: atomic_store_f32x2_seq_cst_agent_align4:
; GFX10:       ; %bb.0:
; GFX10-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX10-NEXT:    s_endpgm
;
; GFX11-LABEL: atomic_store_f32x2_seq_cst_agent_align4:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: atomic_store_f32x2_seq_cst_agent_align4:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    flat_store_b64 v[2:3], v[0:1] scope:SCOPE_DEV
; GFX12-NEXT:    s_endpgm
  store atomic <2 x float> %in, ptr addrspace(0) %out syncscope("agent") seq_cst, align 4
  ret void
}
