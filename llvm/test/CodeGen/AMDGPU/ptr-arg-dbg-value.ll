...
; CHECK-NEXT:    ;DEBUG_VALUE: ptr_arg_split_subregs:a <- [DW_OP_deref, DW_OP_LLVM_fragment 32 32] $vgpr1
; CHECK-NEXT:    ;DEBUG_VALUE: ptr_arg_split_subregs:a <- [DW_OP_deref, DW_OP_LLVM_fragment 0 32] $vgpr0
