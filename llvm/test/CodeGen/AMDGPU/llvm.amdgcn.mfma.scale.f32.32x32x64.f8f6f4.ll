...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x24
...
; SDAG-NEXT:    s_load_dwordx16 s[36:51], s[2:3], 0x64
; SDAG-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0xa4
...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], s4, v16 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
...
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[36:51], s[2:3], 0x64
; GISEL-NEXT:    s_load_dwordx4 s[20:23], s[2:3], 0xa4
...
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], s20, v16 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
...
; SDAG-NEXT:    v_accvgpr_write_b32 a15, s51
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], s2, -2 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 1
...
; GISEL-NEXT:    v_accvgpr_write_b32 a15, s51
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_scale_f32_32x32x64_f8f6f4 a[0:15], v[0:7], v[8:15], a[0:15], v16, -2 op_sel_hi:[0,0,0] cbsz:3 abid:2 blgp:1
; GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 1
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx16 s[8:23], s[2:3], 0x24
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SDAG-NEXT:    v_mov_b32_e32 v10, s14
; SDAG-NEXT:    v_mov_b32_e32 v11, s15
; SDAG-NEXT:    s_load_dwordx16 s[0:15], s[2:3], 0x64
; SDAG-NEXT:    v_mov_b32_e32 v12, s16
; SDAG-NEXT:    v_mov_b32_e32 v13, s17
; SDAG-NEXT:    v_mov_b32_e32 v14, s18
; SDAG-NEXT:    v_mov_b32_e32 v15, s19
