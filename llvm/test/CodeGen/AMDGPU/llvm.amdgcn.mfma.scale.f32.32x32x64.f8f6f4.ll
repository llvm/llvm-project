...
; RUN: llc -mtriple=amdgpu9.50-amd-amdhsa -global-isel=1 < %s | FileCheck -check-prefixes=GCN,GISEL %s
; RUN: llc -mtriple=amdgpu9.50-amd-amdhsa -global-isel=0 --amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=AGPR,AGPR-SDAG %s
; RUN: llc -mtriple=amdgpu9.50-amd-amdhsa -global-isel=1 --amdgpu-mfma-vgpr-form=0 < %s | FileCheck -check-prefixes=AGPR,AGPR-GISEL %s
...
; SDAG-NEXT:    s_nop 15
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], v[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], v[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], v[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], v[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], v[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[10:11], v[26:27]
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], v[28:29]
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], v[30:31]
...
; GISEL-NEXT:    s_nop 15
; GISEL-NEXT:    s_nop 3
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], v[16:17]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], v[18:19]
; GISEL-NEXT:    v_mov_b64_e32 v[4:5], v[20:21]
; GISEL-NEXT:    v_mov_b64_e32 v[6:7], v[22:23]
; GISEL-NEXT:    v_mov_b64_e32 v[8:9], v[24:25]
; GISEL-NEXT:    v_mov_b64_e32 v[10:11], v[26:27]
; GISEL-NEXT:    v_mov_b64_e32 v[12:13], v[28:29]
; GISEL-NEXT:    v_mov_b64_e32 v[14:15], v[30:31]
...
; GCN-NEXT:    s_nop 15
; GCN-NEXT:    s_nop 3
; GCN-NEXT:    v_mov_b64_e32 v[0:1], v[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], v[18:19]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], v[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[6:7], v[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[8:9], v[24:25]
; GCN-NEXT:    v_mov_b64_e32 v[10:11], v[26:27]
; GCN-NEXT:    v_mov_b64_e32 v[12:13], v[28:29]
; GCN-NEXT:    v_mov_b64_e32 v[14:15], v[30:31]
...
; GCN-NEXT:    s_nop 15
; GCN-NEXT:    s_nop 3
; GCN-NEXT:    v_mov_b64_e32 v[0:1], v[14:15]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], v[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], v[18:19]
; GCN-NEXT:    v_mov_b64_e32 v[6:7], v[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[8:9], v[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[10:11], v[24:25]
; GCN-NEXT:    v_mov_b64_e32 v[12:13], v[26:27]
; GCN-NEXT:    v_mov_b64_e32 v[14:15], v[28:29]
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-NEXT:    s_nop 15
; GCN-NEXT:    s_nop 3
; GCN-NEXT:    v_mov_b64_e32 v[0:1], v[12:13]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], v[14:15]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], v[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[6:7], v[18:19]
; GCN-NEXT:    v_mov_b64_e32 v[8:9], v[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[10:11], v[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[12:13], v[24:25]
; GCN-NEXT:    v_mov_b64_e32 v[14:15], v[26:27]
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-NEXT:    s_nop 11
; GCN-NEXT:    v_mov_b64_e32 v[0:1], v[10:11]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], v[12:13]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], v[14:15]
; GCN-NEXT:    v_mov_b64_e32 v[6:7], v[16:17]
; GCN-NEXT:    v_mov_b64_e32 v[8:9], v[18:19]
; GCN-NEXT:    v_mov_b64_e32 v[10:11], v[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[12:13], v[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[14:15], v[24:25]
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    scratch_load_dword v31, off, s32
; GCN-NEXT:    v_mov_b64_e32 v[32:33], s[0:1]
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    s_nop 0
...
; AGPR-NEXT:    v_accvgpr_write_b32 a13, v29
; AGPR-NEXT:    v_accvgpr_write_b32 a14, v30
; AGPR-NEXT:    v_mov_b64_e32 v[16:17], s[0:1]
; AGPR-NEXT:    s_waitcnt vmcnt(0)
; AGPR-NEXT:    s_nop 0
...
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[18:19]
...
; SDAG-NEXT:    v_pk_mov_b32 v[16:17], v[14:15], v[14:15] op_sel:[1,0]
...
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[26:27]
; SDAG-NEXT:    s_nop 1
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[24:25]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[26:27]
...
; SDAG-NEXT:    s_nop 15
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], v[8:9]
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], v[10:11]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], v[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], v[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], v[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[10:11], v[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], v[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], v[22:23]
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-NEXT:    s_nop 15
; GISEL-NEXT:    s_nop 3
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], v[8:9]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], v[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[4:5], v[12:13]
; GISEL-NEXT:    v_mov_b64_e32 v[6:7], v[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[8:9], v[16:17]
; GISEL-NEXT:    v_mov_b64_e32 v[10:11], v[18:19]
; GISEL-NEXT:    v_mov_b64_e32 v[12:13], v[20:21]
; GISEL-NEXT:    v_mov_b64_e32 v[14:15], v[22:23]
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; AGPR-SDAG-LABEL: test_mfma_scale_f32_32x32x64_f8f6f4_0_0_sgpr_vgpr_vgpr__sgpr_vgpr:
; AGPR-SDAG:       ; %bb.0:
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[0:1]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[2:3]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[18:19]
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], v[6:7]
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], v[4:5]
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], v[2:3]
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], v[0:1]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], v[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], v[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[20:21], v[10:11]
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], v[8:9]
; SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[22:23]
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[26:27]
...
; GISEL-NEXT:    v_mov_b64_e32 v[24:25], v[6:7]
; GISEL-NEXT:    s_mov_b32 s12, s0
; GISEL-NEXT:    s_mov_b32 s13, s1
; GISEL-NEXT:    s_mov_b32 s14, s2
; GISEL-NEXT:    s_mov_b32 s15, s3
; GISEL-NEXT:    v_mov_b64_e32 v[26:27], v[8:9]
; GISEL-NEXT:    v_mov_b64_e32 v[28:29], v[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[30:31], v[12:13]
; GISEL-NEXT:    v_mov_b64_e32 v[32:33], v[14:15]
...
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], v[6:7]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], v[4:5]
; SDAG-NEXT:    v_mov_b64_e32 v[20:21], v[2:3]
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], v[0:1]
...
; SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[28:29]
; SDAG-NEXT:    v_mov_b32_e32 v10, s9
; SDAG-NEXT:    v_mov_b32_e32 v11, s8
; SDAG-NEXT:    v_mov_b32_e32 v12, s7
; SDAG-NEXT:    v_mov_b32_e32 v13, s6
...
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[22:23]
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[8:9]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[10:11]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[12:13]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[14:15]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[22:23]
...
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[32:33], s[0:1]
; AGPR-GISEL-NEXT:    s_nop 1
...
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[12:13]
; SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[14:15]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[22:23]
; SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[26:27]
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-NEXT:    v_mov_b64_e32 v[36:37], s[0:1]
...
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[12:13]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[14:15]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[22:23]
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[24:25]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[16:17], s[26:27]
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[22:23]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[0:1], 48
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[0:1], v[2:5], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], 32
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[2:3], v[4:7], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[14:15]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[12:13]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], 16
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[4:5], v[6:9], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[10:11]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[8:9]
...
; AGPR-GISEL-NEXT:    v_mov_b64_e32 v[20:21], s[0:1]
...
; SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[16:17]
; SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[18:19]
; SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[20:21]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[22:23]
; SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[24:25]
; SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[26:27]
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[22:23]
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[24:25]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[26:27]
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[22:23]
...
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[10:11]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[8:9]
...
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[12:13]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[14:15]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[22:23]
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[24:25]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[26:27]
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
