...
; SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[36:37]
; SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[38:39]
; SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[40:41]
; SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[42:43]
; SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[44:45]
; SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[46:47]
; SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[48:49]
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[50:51]
...
; AGPR-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x80
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[36:37]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], s[38:39]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], s[40:41]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[42:43]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[44:45]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[46:47]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[48:49]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[16:17], s[50:51]
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[10:11]
...
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[8:9], s[20:21]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[10:11], s[22:23]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[2:3], 32
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[4:5], 16
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[6:7], 0
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[12:13], s[16:17]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[14:15], s[18:19]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[8:9]
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[0:1], v[8:11], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[2:3], v[12:15], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[4:5], v[16:19], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    global_store_dwordx4 v[6:7], v[20:23], off sc0 sc1
; AGPR-SDAG-NEXT:    s_waitcnt vmcnt(0)
; AGPR-SDAG-NEXT:    s_nop 1
...
; SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[36:37]
; SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[38:39]
; SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[40:41]
; SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[42:43]
; SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[44:45]
; SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[46:47]
; SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[48:49]
; SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[50:51]
...
; AGPR-SDAG-NEXT:    s_load_dwordx16 s[8:23], s[4:5], 0x40
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[36:37]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[38:39]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[40:41]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[42:43]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[44:45]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[46:47]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[48:49]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[50:51]
...
; AGPR-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[18:19], s[36:37]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[20:21], s[38:39]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[22:23], s[40:41]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[24:25], s[42:43]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[26:27], s[44:45]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[28:29], s[46:47]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[30:31], s[48:49]
; AGPR-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[50:51]
