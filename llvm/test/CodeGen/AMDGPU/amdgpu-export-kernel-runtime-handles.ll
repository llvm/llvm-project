...
; RUN: opt -S -mtriple=amdgpu-amd-amdhsa -amdgpu-export-kernel-runtime-handles < %s | FileCheck %s
; RUN: opt -S -mtriple=amdgpu-amd-amdhsa -passes=amdgpu-export-kernel-runtime-handles < %s | FileCheck %s
