...
; CHECK-NEXT:    v_add_co_u32_e32 v4, vcc, s4, v6
; CHECK-NEXT:    s_add_u32 s4, s4, 16
; CHECK-NEXT:    s_addc_u32 s5, s5, 0
; CHECK-NEXT:    v_cmp_lt_u64_e64 s[6:7], s[4:5], 32
; CHECK-NEXT:    v_addc_co_u32_e32 v5, vcc, v7, v5, vcc
...
; CHECK-NEXT:  .LBB0_7: ; %dynamic-memcpy-post-expansion
...
; CHECK-NEXT:  ; %bb.11: ; %dynamic-memcpy-expansion-main-body2.preheader
; CHECK-NEXT:    ; in Loop: Header=BB0_10 Depth=1
; CHECK-NEXT:    s_mov_b64 s[10:11], 0
; CHECK-NEXT:    s_mov_b64 s[12:13], 0
; CHECK-NEXT:  .LBB0_12: ; %dynamic-memcpy-expansion-main-body2
...
; CHECK-NEXT:  ; %bb.14: ; %dynamic-memcpy-expansion-residual-cond5
; CHECK-NEXT:    ; in Loop: Header=BB0_10 Depth=1
; CHECK-NEXT:    s_and_saveexec_b64 s[10:11], s[6:7]
; CHECK-NEXT:    s_cbranch_execz .LBB0_8
; CHECK-NEXT:  ; %bb.15: ; %dynamic-memcpy-expansion-residual-body4.preheader
; CHECK-NEXT:    ; in Loop: Header=BB0_10 Depth=1
; CHECK-NEXT:    s_mov_b64 s[12:13], 0
; CHECK-NEXT:    s_mov_b64 s[14:15], 0
; CHECK-NEXT:  .LBB0_16: ; %dynamic-memcpy-expansion-residual-body4
; CHECK-NEXT:    ; Parent Loop BB0_10 Depth=1
; CHECK-NEXT:    ; => This Inner Loop Header: Depth=2
