...
; CHECK-NEXT:    v_mul_f32_e32 v18, 0x3e800000, v3
...
; CHECK-NEXT:    s_delay_alu instid0(TRANS32_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
...
; CHECK-NEXT:    v_dual_mul_f32 v19, v13, v11 :: v_dual_mul_f32 v20, v10, v12
; CHECK-NEXT:    v_div_scale_f32 v25, s1, v1, 0x40400000, v1
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; CHECK-NEXT:    v_rcp_f32_e32 v22, v16
; CHECK-NEXT:    v_fmac_f32_e32 v3, -4.0, v18
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
...
; CHECK-NEXT:    v_dual_fmac_f32 v19, v14, v11 :: v_dual_fmac_f32 v20, v23, v12
...
; CHECK-NEXT:    v_mul_f32_e32 v12, v13, v22
; CHECK-NEXT:    v_dual_mul_f32 v21, 0x3e800000, v4 :: v_dual_mul_f32 v10, v25, v15
...
; CHECK-NEXT:    v_fmac_f32_e32 v10, v11, v15
; CHECK-NEXT:    v_dual_fmac_f32 v2, 0xc0400000, v8 :: v_dual_fmac_f32 v5, 0xc0400000, v9
...
; CHECK-NEXT:    v_sub_f32_e32 v7, v7, v9
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; CHECK-NEXT:    v_dual_fmac_f32 v0, -4.0, v9 :: v_dual_fmac_f32 v1, 0xc0400000, v8
