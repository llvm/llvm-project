...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s1, 0x40a00000
; GFX9-NEXT:    s_bitcmp1_b32 s2, 0
; GFX9-NEXT:    s_cselect_b64 s[2:3], -1, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, v0, -4.0, s[2:3]
; GFX9-NEXT:    v_cmp_nlt_f32_e64 s[2:3], |v1|, s1
...
; GFX9-NEXT:    v_cmp_eq_f32_e64 s[2:3], |v1|, s1
...
; GFX942-NEXT:    v_cmp_eq_f32_e64 s[2:3], |v1|, s1
; GFX942-NEXT:    s_nop 1
