; NOTE: Assertions have been autogenerated by utils/update_llc_test_checks.py UTC_ARGS: --tool ./build/hpe-sjc2-37-Release-X86-AMDGPU/llc --version 5
...
; GCN-NEXT:    v_cndmask_b32_e64 v1, v0, -4.0, s[0:1]
; GCN-NEXT:    s_mov_b32 s0, 0x40a00000
; GCN-NEXT:    v_cmp_nlt_f32_e64 s[2:3], |v1|, s0
; GCN-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GCN-NEXT:    s_cbranch_vccz .LBB26_2
; GCN-NEXT:  ; %bb.1: ; %frem.else
; GCN-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; GCN-NEXT:    v_cmp_eq_f32_e64 s[0:1], |v1|, s0
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s[0:1]
; GCN-NEXT:    s_cbranch_execz .LBB26_3
; GCN-NEXT:    s_branch .LBB26_7
; GCN-NEXT:  .LBB26_2:
; GCN-NEXT:    ; implicit-def: $vgpr0
; GCN-NEXT:  .LBB26_3: ; %frem.compute
; GCN-NEXT:    v_frexp_mant_f32_e64 v0, |v1|
; GCN-NEXT:    v_ldexp_f32 v0, v0, 1
; GCN-NEXT:    v_div_scale_f32 v2, s[0:1], v0, v0, 1.0
...
; GCN-NEXT:    v_div_fmas_f32 v3, v2, v4, v5
; GCN-NEXT:    v_frexp_exp_i32_f32_e32 v2, v1
; GCN-NEXT:    v_sub_u32_e32 v1, 3, v2
; GCN-NEXT:    v_cmp_gt_i32_e32 vcc, 13, v1
; GCN-NEXT:    v_mov_b32_e32 v4, 0x45200000
; GCN-NEXT:    v_div_fixup_f32 v3, v3, v0, 1.0
; GCN-NEXT:    s_cbranch_vccnz .LBB26_6
; GCN-NEXT:  ; %bb.4: ; %frem.loop_body.preheader
; GCN-NEXT:    v_sub_u32_e32 v1, 15, v2
; GCN-NEXT:    v_mov_b32_e32 v5, 0x45200000
; GCN-NEXT:  .LBB26_5: ; %frem.loop_body
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    v_mov_b32_e32 v4, v5
; GCN-NEXT:    v_mul_f32_e32 v5, v4, v3
; GCN-NEXT:    v_rndne_f32_e32 v5, v5
; GCN-NEXT:    v_fma_f32 v5, -v5, v0, v4
; GCN-NEXT:    v_add_f32_e32 v6, v5, v0
; GCN-NEXT:    v_cmp_gt_f32_e32 vcc, 0, v5
; GCN-NEXT:    v_add_u32_e32 v1, -12, v1
; GCN-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 12, v1
; GCN-NEXT:    v_ldexp_f32 v5, v5, 12
; GCN-NEXT:    s_cbranch_vccnz .LBB26_5
; GCN-NEXT:  .LBB26_6: ; %Flow12
; GCN-NEXT:    v_add_u32_e32 v1, -11, v1
; GCN-NEXT:    v_ldexp_f32 v1, v4, v1
; GCN-NEXT:    v_mul_f32_e32 v3, v1, v3
; GCN-NEXT:    v_rndne_f32_e32 v3, v3
; GCN-NEXT:    v_fma_f32 v1, -v3, v0, v1
; GCN-NEXT:    v_add_f32_e32 v0, v1, v0
; GCN-NEXT:    v_cmp_gt_f32_e32 vcc, 0, v1
; GCN-NEXT:    v_add_u32_e32 v2, -1, v2
; GCN-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GCN-NEXT:    v_ldexp_f32 v0, v0, v2
; GCN-NEXT:    v_and_b32_e32 v0, 0x7fffffff, v0
; GCN-NEXT:  .LBB26_7: ; %Flow14
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
