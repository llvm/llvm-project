...
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -mattr=-architected-sgprs -global-isel=0 < %s | FileCheck -check-prefixes=GFX9-SDAG %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -mattr=-architected-sgprs -global-isel=1 < %s | FileCheck -check-prefixes=GFX9-GISEL %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs -global-isel=0 < %s | FileCheck -check-prefixes=GFX9ARCH-SDAG %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -mattr=+architected-sgprs -global-isel=1 < %s | FileCheck -check-prefixes=GFX9ARCH-GISEL %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdpal -global-isel=0 < %s | FileCheck -check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdpal -global-isel=1 < %s | FileCheck -check-prefixes=GFX12,GFX12-GISEL %s
