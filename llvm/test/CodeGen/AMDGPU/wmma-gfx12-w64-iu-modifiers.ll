...
; RUN: llc -mtriple=amdgpu11.70 -mattr=+wavefrontsize64 < %s | FileCheck %s --check-prefixes=GCN,GFX1170
; RUN: llc -mtriple=amdgpu12.00 -mattr=+wavefrontsize64 < %s | FileCheck %s --check-prefixes=GCN,GFX12
