...
; xUN: llc -mtriple=amdgpu9.0a-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX9,GFX90A %s
; xUN: llc -mtriple=amdgpu9.42-mesa-mesa3d < %s | FileCheck -check-prefixes=GFX9,GFX942 %s
...
; GFX6-NEXT:    ; implicit-def: $vgpr2_128
; GFX6-NEXT:    ; implicit-def: $vgpr6_64
...
; GFX7-NEXT:    ; implicit-def: $vgpr2_128
; GFX7-NEXT:    ; implicit-def: $vgpr6_64
