...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm ; encoding: [0x06,0x20,0x46,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
...
; GCN-NEXT:    image_msaa_load v[0:4], [v7, v6, v5], v8 dmask:0x2 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe lwe ; encoding: [0x0e,0x20,0x86,0xe4,0x00,0x11,0x02,0x00,0x07,0x06,0x05,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v2, v3, v4], v0 dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm ; encoding: [0x07,0x20,0x06,0xe5,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_dual_mov_b32 v2, v12 :: v_dual_mov_b32 v3, v13 ; encoding: [0x0c,0x01,0x10,0xca,0x0d,0x01,0x02,0x02]
; GCN-NEXT:    v_mov_b32_e32 v4, v14 ; encoding: [0x0e,0x03,0x08,0x7e]
; GCN-NEXT:    image_msaa_load v[0:4], [v8, v7, v6, v5], v9 dmask:0x8 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe ; encoding: [0x0f,0x20,0x06,0xe6,0x00,0x12,0x02,0x00,0x08,0x07,0x06,0x05]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    global_store_b32 v10, v4, s[0:1] ; encoding: [0x00,0x00,0x07,0xee,0x00,0x00,0x00,0x02,0x0a,0x00,0x00,0x00]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_NT ; encoding: [0x06,0x20,0x46,0xe4,0x00,0x00,0x12,0x00,0x01,0x02,0x03,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_HT ; encoding: [0x06,0x20,0x46,0xe4,0x00,0x00,0x22,0x00,0x01,0x02,0x03,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm th:TH_LOAD_LU ; encoding: [0x06,0x20,0x46,0xe4,0x00,0x00,0x32,0x00,0x01,0x02,0x03,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:1], [v1, v2, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm d16 ; encoding: [0x26,0x20,0x46,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    image_msaa_load v[0:2], [v5, v4, v3], v6 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe d16 ; encoding: [0x2e,0x20,0x46,0xe4,0x00,0x0c,0x02,0x00,0x05,0x04,0x03,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
...
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_msaa_load v[0:1], [v1, v2, v3, v4], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm d16 ; encoding: [0x27,0x20,0x46,0xe4,0x00,0x00,0x02,0x00,0x01,0x02,0x03,0x04]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_2) ; encoding: [0x02,0x00,0xae,0xbf]
; GCN-NEXT:    v_mov_b32_e32 v2, v10 ; encoding: [0x0a,0x03,0x04,0x7e]
; GCN-NEXT:    image_msaa_load v[0:2], [v6, v5, v3, v4], v7 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe d16 ; encoding: [0x2f,0x20,0x46,0xe4,0x00,0x0e,0x02,0x00,0x06,0x05,0x03,0x04]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    global_store_b32 v8, v2, s[0:1] ; encoding: [0x00,0x00,0x07,0xee,0x00,0x00,0x00,0x01,0x08,0x00,0x00,0x00]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v3], v0 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm a16 ; encoding: [0x46,0x20,0x46,0xe4,0x00,0x00,0x02,0x00,0x01,0x03,0x00,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100 ; encoding: [0x01,0x00,0x44,0xd7,0x02,0x03,0xfe,0x03,0x00,0x01,0x04,0x05]
; GCN-NEXT:    image_msaa_load v[0:3], [v1, v3], v0 dmask:0x4 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 ; encoding: [0x47,0x20,0x06,0xe5,0x00,0x00,0x02,0x00,0x01,0x03,0x00,0x00]
; GCN-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GCN-NEXT:    ; return to shader part epilog
main_body:
