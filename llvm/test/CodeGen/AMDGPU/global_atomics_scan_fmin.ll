...
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS:  .LBB6_2: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX1164:  .LBB6_2: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1132:  .LBB6_2: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP:  .LBB6_2: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
...
; GFX7LESS:  .LBB7_4: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
...
; GFX1164:  .LBB7_4: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
...
; GFX1132:  .LBB7_4: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX7LESS-DPP:  .LBB7_1: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-DPP-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s7
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS:  .LBB8_2: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
...
; GFX1164-NEXT:    v_mov_b32_e32 v3, s3
; GFX1164-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164:  .LBB8_2: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1164-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1132:  .LBB8_2: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1132-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
...
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v3, s7
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP:  .LBB8_2: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-DPP-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
; GFX7LESS-DPP-NEXT:    s_waitcnt expcnt(0)
...
; GFX7LESS-NEXT:    s_mov_b64 s[4:5], 0
; GFX7LESS-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX7LESS:  .LBB9_4: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-NEXT:    v_min_f64 v[0:1], v[0:1], v[4:5]
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX1164:  .LBB9_4: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX1132:  .LBB9_4: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[0:1], 0
; GFX7LESS-DPP-NEXT:    v_max_f64 v[4:5], v[0:1], v[0:1]
; GFX7LESS-DPP:  .LBB9_1: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-DPP-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-DPP-NEXT:    v_min_f64 v[0:1], v[0:1], v[4:5]
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s7
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS:  .LBB10_2: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
...
; GFX1164-NEXT:    v_mov_b32_e32 v3, s3
; GFX1164-NEXT:    s_mov_b64 s[2:3], 0
; GFX1164:  .LBB10_2: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1164-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1132:  .LBB10_2: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1132-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
...
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v3, s7
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP:  .LBB10_2: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-DPP-NEXT:    v_min_f64 v[0:1], v[0:1], 4.0
; GFX7LESS-DPP-NEXT:    s_waitcnt expcnt(0)
...
; GFX7LESS-NEXT:    s_mov_b64 s[4:5], 0
; GFX7LESS-NEXT:    v_max_f64 v[4:5], v[4:5], v[4:5]
; GFX7LESS:  .LBB11_4: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-NEXT:    v_min_f64 v[0:1], v[0:1], v[4:5]
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX1164:  .LBB11_4: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    global_load_b64 v[2:3], v6, s[0:1]
; GFX1132:  .LBB11_4: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX7LESS-DPP-NEXT:    s_mov_b64 s[0:1], 0
; GFX7LESS-DPP-NEXT:    v_max_f64 v[4:5], v[0:1], v[0:1]
; GFX7LESS-DPP:  .LBB11_1: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-DPP-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX7LESS-DPP-NEXT:    v_min_f64 v[0:1], v[0:1], v[4:5]
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, s2
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS:  .LBB12_2: ; %atomicrmw.start
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    v_mul_f32_e32 v0, 1.0, v1
; GFX7LESS-NEXT:    v_min_f32_e32 v0, 4.0, v0
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
...
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v1, s2
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP:  .LBB12_2: ; %atomicrmw.start
; GFX7LESS-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-DPP-NEXT:    v_mul_f32_e32 v0, 1.0, v1
; GFX7LESS-DPP-NEXT:    v_min_f32_e32 v0, 4.0, v0
; GFX7LESS-DPP-NEXT:    s_waitcnt expcnt(0)
