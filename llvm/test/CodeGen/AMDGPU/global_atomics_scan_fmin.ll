...
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 4.0
...
; GFX9-NEXT:    v_min_f32_e32 v0, 4.0, v1
...
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB0_2
...
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v0, 4.0
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmin v0, off, s[0:3], 0
; GFX7LESS-DPP-NEXT:  .LBB0_2:
...
; GFX9-DPP-NEXT:    v_min_f32_e32 v0, 4.0, v1
...
; GFX7LESS-NEXT:    v_min_f32_e32 v1, s4, v1
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_min_f32_e32 v0, v1, v2
...
; GFX1064-NEXT:    v_min_f32_e32 v1, s3, v1
...
; GFX1032-NEXT:    v_min_f32_e32 v1, s2, v1
...
; GFX1164-NEXT:    v_min_f32_e32 v1, s3, v1
...
; GFX1132-NEXT:    v_min_f32_e32 v1, s2, v1
...
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmin v0, off, s[36:39], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_min_f32_e32 v0, s4, v1
; GFX9-DPP-NEXT:    global_atomic_cmpswap v0, v2, v[0:1], s[0:1] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-DPP-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1064-DPP-NEXT:    v_min_f32_e32 v3, v3, v5
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
...
; GFX1064-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1064-DPP-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX1064-DPP-NEXT:    v_min_f32_e64 v3, s2, s3
; GFX1064-DPP-NEXT:    s_mov_b64 exec, s[0:1]
...
; GFX1032-DPP-NEXT:    v_min_f32_e32 v3, v3, v5
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
...
; GFX1164-DPP-NEXT:    v_min_f32_e32 v1, v1, v3
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1132-DPP-NEXT:    v_dual_min_f32 v1, v2, v1 :: v_dual_mov_b32 v2, 0x7fc00000
...
; GFX1132-DPP-NEXT:    v_min_f32_e32 v1, v1, v3
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_cbranch_execz .LBB2_2
; GFX7LESS-NEXT:  ; %bb.1:
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB2_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB4_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, 0x40100000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_atomic_fmin_x2 v[0:1], off, s[0:3], 0
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX1164-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB6_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v1, 0x40100000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmin_x2 v[0:1], off, s[0:3], 0
; GFX7LESS-DPP-NEXT:  .LBB6_2:
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX1164-DPP-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-DPP-NEXT:    v_min_f64 v[0:1], v[2:3], 4.0
...
; GFX7LESS-NEXT:    v_min_f64 v[2:3], v[2:3], s[2:3]
...
; GFX9-NEXT:    v_min_f64 v[4:5], v[4:5], s[2:3]
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_min_f64 v[0:1], v[2:3], v[4:5]
...
; GFX1064-NEXT:    v_min_f64 v[2:3], v[2:3], s[2:3]
...
; GFX1032-NEXT:    s_lshl_b32 s1, 1, s1
; GFX1032-NEXT:    s_andn2_b32 s0, s0, s1
; GFX1032-NEXT:    v_min_f64 v[2:3], v[2:3], s[2:3]
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    v_min_f64 v[4:5], v[4:5], s[2:3]
...
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_min_f64 v[0:1], v[2:3], v[4:5]
...
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_and_not1_b32 s0, s0, s1
; GFX1132-NEXT:    v_min_f64 v[4:5], v[4:5], s[2:3]
...
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    v_min_f64 v[0:1], v[2:3], v[4:5]
...
; GFX7LESS-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-DPP-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX7LESS-DPP-NEXT:    buffer_atomic_fmin_x2 v[0:1], off, s[36:39], 0
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_min_f64 v[9:10], v[11:12], s[0:1]
...
; GFX1064-DPP-NEXT:    v_min_f64 v[3:4], s[2:3], s[4:5]
; GFX1064-DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1064-DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1164-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_min_f64 v[6:7], v[8:9], v[0:1]
...
; GFX1132-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    v_min_f64 v[6:7], v[8:9], v[0:1]
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB8_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB10_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB12_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
...
; GFX7LESS-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-DPP-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-DPP-NEXT:    s_cbranch_execz .LBB13_2
; GFX7LESS-DPP-NEXT:  ; %bb.1:
; GFX7LESS-DPP-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX7LESS-DPP-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-DPP-NEXT:    s_mov_b32 s2, -1
