...
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_max_f32_e32 v2, v1, v1
; GFX9-DPP-NEXT:    v_mov_b32_e32 v6, 0
; GFX9-DPP-NEXT:    v_min_f32_e32 v0, v2, v0
; GFX9-DPP-NEXT:    global_atomic_cmpswap v0, v6, v[0:1], s[0:1] glc
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GFX9-DPP-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX9-DPP-NEXT:    v_mov_b32_e32 v1, v0
...
; GFX1064-DPP-NEXT:    v_max_f32_e32 v5, v5, v5
; GFX1064-DPP-NEXT:    v_min_f32_e32 v4, v4, v5
; GFX1064-DPP-NEXT:    v_mov_b32_dpp v6, v4 row_xmask:2 row_mask:0xf bank_mask:0xf
; GFX1064-DPP-NEXT:    v_max_f32_e32 v5, v6, v6
; GFX1064-DPP-NEXT:    v_mov_b32_e32 v6, v3
; GFX1064-DPP-NEXT:    v_min_f32_e32 v4, v4, v5
...
; GFX1032-DPP-NEXT:    v_max_f32_e32 v5, v5, v5
; GFX1032-DPP-NEXT:    v_min_f32_e32 v4, v4, v5
; GFX1032-DPP-NEXT:    v_mov_b32_dpp v6, v4 row_xmask:2 row_mask:0xf bank_mask:0xf
; GFX1032-DPP-NEXT:    v_max_f32_e32 v5, v6, v6
; GFX1032-DPP-NEXT:    v_mov_b32_e32 v6, v3
; GFX1032-DPP-NEXT:    v_min_f32_e32 v4, v4, v5
...
; GFX1164-DPP-NEXT:    v_max_f32_e32 v3, v3, v3
; GFX1164-DPP-NEXT:    v_min_f32_e32 v2, v2, v3
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-DPP-NEXT:    v_mov_b32_dpp v4, v2 row_xmask:2 row_mask:0xf bank_mask:0xf
; GFX1164-DPP-NEXT:    v_max_f32_e32 v3, v4, v4
; GFX1164-DPP-NEXT:    v_mov_b32_e32 v4, v1
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-DPP-NEXT:    v_min_f32_e32 v2, v2, v3
...
; GFX1164-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-DPP-NEXT:    global_atomic_min_f32 v5, v0, s[0:1]
...
; GFX1132-DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-DPP-NEXT:    global_atomic_min_f32 v5, v0, s[0:1]
...
; GFX9-DPP-NEXT:    v_lshlrev_b32_e32 v0, 20, v40
; GFX9-DPP-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-DPP-NEXT:    v_min_f64 v[2:3], v[5:6], v[3:4]
; GFX9-DPP-NEXT:    v_lshlrev_b32_e32 v4, 10, v41
; GFX9-DPP-NEXT:    s_mov_b64 s[0:1], s[52:53]
; GFX9-DPP-NEXT:    v_or3_b32 v31, v42, v4, v0
; GFX9-DPP-NEXT:    s_mov_b64 s[4:5], s[40:41]
; GFX9-DPP-NEXT:    s_mov_b64 s[6:7], s[38:39]
; GFX9-DPP-NEXT:    s_mov_b64 s[10:11], s[34:35]
; GFX9-DPP-NEXT:    buffer_store_dword v3, off, s[52:55], 0 offset:12
; GFX9-DPP-NEXT:    buffer_store_dword v2, off, s[52:55], 0 offset:8
; GFX9-DPP-NEXT:    s_mov_b32 s12, s43
; GFX9-DPP-NEXT:    s_mov_b32 s13, s42
; GFX9-DPP-NEXT:    s_mov_b32 s14, s33
; GFX9-DPP-NEXT:    s_mov_b64 s[2:3], s[54:55]
...
; GFX1064-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1064-DPP-NEXT:    v_max_f64 v[3:4], v[43:44], v[43:44]
; GFX1064-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1032-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1032-DPP-NEXT:    v_max_f64 v[3:4], v[43:44], v[43:44]
; GFX1032-DPP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1164-DPP-NEXT:    s_mov_b32 s13, s42
; GFX1164-DPP-NEXT:    s_mov_b32 s14, s33
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_3)
...
; GFX1132-DPP-NEXT:    s_mov_b32 s13, s42
; GFX1132-DPP-NEXT:    s_mov_b32 s14, s33
; GFX1132-DPP-NEXT:    v_mov_b32_e32 v0, 8
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_1)
...
; GFX9-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-DPP-NEXT:    v_max_f64 v[0:1], s[0:1], s[0:1]
; GFX9-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DPP-NEXT:    v_max_f64 v[9:10], v[11:12], v[11:12]
; GFX9-DPP-NEXT:    v_min_f64 v[9:10], v[9:10], v[0:1]
; GFX9-DPP-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX1164-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-DPP-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX1164-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-DPP-NEXT:    v_max_f64 v[12:13], v[10:11], v[10:11]
; GFX1164-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164-DPP-NEXT:    v_min_f64 v[8:9], v[12:13], v[8:9]
...
; GFX1132-DPP-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-DPP-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX1132-DPP-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-DPP-NEXT:    v_max_f64 v[12:13], v[10:11], v[10:11]
; GFX1132-DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-DPP-NEXT:    v_min_f64 v[8:9], v[12:13], v[8:9]
