...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck %s -check-prefix=MUBUF
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=+enable-flat-scratch < %s | FileCheck %s -check-prefix=FLATSCR
