...
; RUN: llc < %s -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs | FileCheck -check-prefix=GFX13 %s
; RUN: llc < %s -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs | FileCheck -check-prefix=GFX13 %s

define amdgpu_ps void @raw_buffer_discard(<4 x i32> inreg) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.discard.b32(<4 x i32> %0, i32 0, i32 0, i32 1)
  call void @llvm.amdgcn.raw.buffer.discard.b128(<4 x i32> %0, i32 0, i32 0, i32 8)
  call void @llvm.amdgcn.raw.buffer.discard.b1024(<4 x i32> %0, i32 0, i32 0, i32 3)
  ret void
}

define amdgpu_ps void @raw_buffer_discard_imm(<4 x i32> inreg) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.discard.b32(<4 x i32> %0, i32 2, i32 0, i32 16)
  call void @llvm.amdgcn.raw.buffer.discard.b128(<4 x i32> %0, i32 23124, i32 0, i32 4)
  call void @llvm.amdgcn.raw.buffer.discard.b1024(<4 x i32> %0, i32 8388607, i32 0, i32 0)
  ret void
}

define amdgpu_ps void @raw_buffer_discard_offen(<4 x i32> inreg, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.discard.b32(<4 x i32> %0, i32 %1, i32 0, i32 0)
  call void @llvm.amdgcn.raw.buffer.discard.b128(<4 x i32> %0, i32 %1, i32 0, i32 6)
  call void @llvm.amdgcn.raw.buffer.discard.b1024(<4 x i32> %0, i32 %1, i32 0, i32 24)
  ret void
}

define amdgpu_ps void @struct_buffer_discard(<4 x i32> inreg, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0)
  call void @llvm.amdgcn.struct.buffer.discard.b128(<4 x i32> %0, i32 0, i32 0, i32 0, i32 5)
  call void @llvm.amdgcn.struct.buffer.discard.b1024(<4 x i32> %0, i32 0, i32 0, i32 0, i32 0)
  ret void
}

define amdgpu_ps void @struct_buffer_discard_immoffs(<4 x i32> inreg, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %0, i32 0, i32 42, i32 0, i32 16)
  call void @llvm.amdgcn.struct.buffer.discard.b128(<4 x i32> %0, i32 0, i32 8388607, i32 0, i32 24)
  call void @llvm.amdgcn.struct.buffer.discard.b1024(<4 x i32> %0, i32 0, i32 84, i32 0, i32 8)
  ret void
}

define amdgpu_ps void @struct_buffer_discard_idx(<4 x i32> inreg, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %0, i32 %1, i32 0, i32 0, i32 7)
  call void @llvm.amdgcn.struct.buffer.discard.b128(<4 x i32> %0, i32 %1, i32 0, i32 0, i32 8)
  call void @llvm.amdgcn.struct.buffer.discard.b1024(<4 x i32> %0, i32 %1, i32 0, i32 0, i32 9)
  ret void
}

define amdgpu_ps void @struct_buffer_discard_offen(<4 x i32> inreg, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %0, i32 0, i32 %1, i32 0, i32 4)
  call void @llvm.amdgcn.struct.buffer.discard.b128(<4 x i32> %0, i32 0, i32 %1, i32 0, i32 5)
  call void @llvm.amdgcn.struct.buffer.discard.b1024(<4 x i32> %0, i32 0, i32 %1, i32 0, i32 6)
  ret void
}

define amdgpu_ps void @struct_buffer_discard_both(<4 x i32> inreg, i32, i32) {
...
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %0, i32 %1, i32 %2, i32 0, i32 1)
  call void @llvm.amdgcn.struct.buffer.discard.b128(<4 x i32> %0, i32 %1, i32 %2, i32 0, i32 2)
  call void @llvm.amdgcn.struct.buffer.discard.b1024(<4 x i32> %0, i32 %1, i32 %2, i32 0, i32 3)
  ret void
}

define amdgpu_ps void @struct_buffer_discard_waterfall_rsrc_vgpr(<4 x i32> %rsrc) {
; GFX13-SDAG-LABEL: struct_buffer_discard_waterfall_rsrc_vgpr:
...
main_body:
  call void @llvm.amdgcn.struct.buffer.discard.b32(<4 x i32> %rsrc, i32 0, i32 0, i32 0, i32 0)
  ret void
}

define amdgpu_ps void @raw_buffer_discard_waterfall_rsrc_vgpr(<4 x i32> %rsrc) {
; GFX13-SDAG-LABEL: raw_buffer_discard_waterfall_rsrc_vgpr:
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    s_mov_b32 s0, exec_lo
...
; GFX13-GISEL-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.discard.b32(<4 x i32> %rsrc, i32 0, i32 0, i32 0)
  ret void
}
