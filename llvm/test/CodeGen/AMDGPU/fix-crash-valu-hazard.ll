...
; RUN: llc -mtriple=amdgpu9.0a -O0 < %s | FileCheck -check-prefix=GFX90A %s
...
; GFX90A-NEXT:    ; kill: def $sgpr2 killed $sgpr2 def $sgpr2_64
...
; GFX90A-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_64 killed $exec
