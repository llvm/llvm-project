...
; RUN: llc -mtriple=amdgpu9.08 -O3 -misched=gcn-iterative-max-occupancy-experimental < %s | FileCheck %s
; RUN: llc -mtriple=amdgpu9.08 -O3 -misched=gcn-iterative-ilp < %s | FileCheck %s
