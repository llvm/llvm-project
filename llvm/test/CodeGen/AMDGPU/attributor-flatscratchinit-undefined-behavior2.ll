...
; GFX8-NEXT:    s_add_u32 s18, s18, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX8-NEXT:    s_addc_u32 s19, s19, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX8-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX8-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX9-NEXT:    s_add_u32 s18, s18, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s19, s19, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX9-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX9-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX942-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX942-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX10-NEXT:    s_add_u32 s18, s18, with_private_to_flat_addrspacecast@gotpcrel32@lo+4
; GFX10-NEXT:    s_addc_u32 s19, s19, with_private_to_flat_addrspacecast@gotpcrel32@hi+12
...
; GFX8-NEXT:    s_addc_u32 s17, s9, 0
; GFX8-NEXT:    s_getpc_b64 s[18:19]
; GFX8-NEXT:    s_add_u32 s18, s18, calls_intrin_ascast@gotpcrel32@lo+4
; GFX8-NEXT:    s_addc_u32 s19, s19, calls_intrin_ascast@gotpcrel32@hi+12
; GFX8-NEXT:    s_load_dword s15, s[8:9], 0x0
; GFX8-NEXT:    s_load_dwordx2 s[18:19], s[18:19], 0x0
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
; GFX8-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
...
; GFX8-ARCH-FLAT-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX8-ARCH-FLAT-NEXT:    s_getpc_b64 s[6:7]
; GFX8-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, calls_intrin_ascast@gotpcrel32@lo+4
; GFX8-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, calls_intrin_ascast@gotpcrel32@hi+12
; GFX8-ARCH-FLAT-NEXT:    s_load_dword s15, s[4:5], 0x0
; GFX8-ARCH-FLAT-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x0
; GFX8-ARCH-FLAT-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
; GFX8-ARCH-FLAT-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
...
; GFX9-NEXT:    s_addc_u32 s17, s9, 0
; GFX9-NEXT:    s_getpc_b64 s[18:19]
; GFX9-NEXT:    s_add_u32 s18, s18, calls_intrin_ascast@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s19, s19, calls_intrin_ascast@gotpcrel32@hi+12
; GFX9-NEXT:    s_load_dword s15, s[8:9], 0x0
; GFX9-NEXT:    s_load_dwordx2 s[20:21], s[18:19], 0x0
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
; GFX9-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
...
; GFX9-ARCH-FLAT-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX9-ARCH-FLAT-NEXT:    s_getpc_b64 s[6:7]
; GFX9-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, calls_intrin_ascast@gotpcrel32@lo+4
; GFX9-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, calls_intrin_ascast@gotpcrel32@hi+12
; GFX9-ARCH-FLAT-NEXT:    s_load_dword s15, s[4:5], 0x0
; GFX9-ARCH-FLAT-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x0
; GFX9-ARCH-FLAT-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
; GFX9-ARCH-FLAT-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
...
; GFX942-ARCH-FLAT-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX942-ARCH-FLAT-NEXT:    s_getpc_b64 s[6:7]
; GFX942-ARCH-FLAT-NEXT:    s_add_u32 s6, s6, calls_intrin_ascast@gotpcrel32@lo+4
; GFX942-ARCH-FLAT-NEXT:    s_addc_u32 s7, s7, calls_intrin_ascast@gotpcrel32@hi+12
; GFX942-ARCH-FLAT-NEXT:    s_load_dword s15, s[4:5], 0x0
; GFX942-ARCH-FLAT-NEXT:    s_load_dwordx2 s[16:17], s[6:7], 0x0
; GFX942-ARCH-FLAT-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX942-ARCH-FLAT-NEXT:    s_mov_b64 s[6:7], s[2:3]
...
; GFX10-NEXT:    s_addc_u32 s17, s9, 0
; GFX10-NEXT:    s_getpc_b64 s[18:19]
; GFX10-NEXT:    s_add_u32 s18, s18, calls_intrin_ascast@gotpcrel32@lo+4
; GFX10-NEXT:    s_addc_u32 s19, s19, calls_intrin_ascast@gotpcrel32@hi+12
; GFX10-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    s_load_dword s15, s[8:9], 0x0
; GFX10-NEXT:    s_load_dwordx2 s[20:21], s[18:19], 0x0
