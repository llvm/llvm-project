...
; VI-NEXT:    v_mov_b32_e32 v2, 0x204
...
; GFX11-NEXT:    v_cmp_class_f32_e64 s1, s2, 0x204
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    v_cmp_nlg_f32_e64 s[0:1], |s2|, v0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_cmp_nlg_f32_e64 s[0:1], |s2|, v2
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_nlg_f32_e64 s1, 0x7f800000, |s2|
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_class_f32_e64 s1, s2, 0x1f8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_cmp_o_f32_e64 s[0:1], s2, s2
; VI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_o_f32_e64 s1, s2, s2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_cmp_o_f32_e64 s[0:1], s2, s2
; VI-NEXT:    v_cmp_neq_f32_e64 s[2:3], |s3|, v2
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_o_f32_e64 s1, s2, s2
; GFX11-NEXT:    v_cmp_neq_f32_e64 s2, 0x7f800000, |s3|
; GFX11-NEXT:    s_and_b32 s1, s1, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_cmp_u_f32_e64 s[0:1], s2, s2
; VI-NEXT:    v_cmp_neq_f32_e64 s[2:3], |s2|, v2
; VI-NEXT:    s_and_b64 s[0:1], s[0:1], s[2:3]
; VI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_u_f32_e64 s1, s2, s2
; GFX11-NEXT:    v_cmp_neq_f32_e64 s2, 0x7f800000, |s2|
; GFX11-NEXT:    s_and_b32 s1, s1, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
...
; SI-NEXT:    v_cmp_o_f32_e32 vcc, s2, v1
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], s2, v0
...
; VI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dword s1, s[4:5], 0x50
; VI-NEXT:    v_mov_b32_e32 v2, 0x1f8
; VI-NEXT:    v_mov_b32_e32 v1, 0
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v3, s1
; VI-NEXT:    v_cmp_o_f32_e32 vcc, s2, v3
; VI-NEXT:    v_cmp_class_f32_e64 s[0:1], s2, v2
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_load_b32 s1, s[4:5], 0x50
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_o_f32_e64 s1, s2, s1
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_class_f16_e64 s1, s2, 0x204
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_class_f16_e64 s1, s2, 0x1f8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
; GFX11-NEXT:    global_store_b32 v0, v1, s[0:1]
