...
; GFX11-NEXT:    v_dual_cndmask_b32 v1, 0x7fc00000, v17 :: v_dual_min_f32 v16, v4, v12
...
; GFX11-NEXT:    v_dual_min_f32 v13, v3, v11 :: v_dual_cndmask_b32 v6, 0x7fc00000, v9
...
; GFX11-NEXT:    v_dual_min_f32 v10, v2, v6 :: v_dual_min_f32 v9, v0, v8
...
; GFX7-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX8-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX10-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX11-NEXT:    v_min_f64 v[10:11], v[0:1], v[4:5]
...
; GFX7-NEXT:    v_cndmask_b32_e64 v0, v6, 0, vcc
; GFX7-NEXT:    v_min_f64 v[10:11], v[2:3], v[4:5]
; GFX7-NEXT:    v_min_f64 v[6:7], v[0:1], v[12:13]
...
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v6, 0, vcc
; GFX8-NEXT:    v_min_f64 v[10:11], v[2:3], v[4:5]
; GFX8-NEXT:    v_min_f64 v[6:7], v[0:1], v[12:13]
...
; GFX10-NEXT:    v_min_f64 v[18:19], v[6:7], v[14:15]
; GFX10-NEXT:    v_min_f64 v[20:21], v[2:3], v[10:11]
; GFX10-NEXT:    v_min_f64 v[22:23], v[0:1], v[8:9]
...
; GFX11-NEXT:    v_min_f64 v[18:19], v[6:7], v[14:15]
; GFX11-NEXT:    v_min_f64 v[20:21], v[2:3], v[10:11]
; GFX11-NEXT:    v_min_f64 v[22:23], v[0:1], v[8:9]
...
; GFX7-NEXT:    v_min_f64 v[26:27], v[6:7], v[22:23]
...
; GFX7-NEXT:    v_min_f64 v[12:13], v[4:5], v[2:3]
...
; GFX7-NEXT:    v_min_f64 v[18:19], v[20:21], v[10:11]
; GFX7-NEXT:    v_cndmask_b32_e32 v3, v13, v34, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v2, v12, 0, vcc
; GFX7-NEXT:    v_min_f64 v[22:23], v[0:1], v[8:9]
...
; GFX7-NEXT:    v_min_f64 v[12:13], v[6:7], v[4:5]
...
; GFX7-NEXT:    v_min_f64 v[8:9], v[0:1], v[10:11]
...
; GFX8-NEXT:    v_min_f64 v[26:27], v[6:7], v[22:23]
...
; GFX8-NEXT:    v_min_f64 v[12:13], v[4:5], v[2:3]
...
; GFX8-NEXT:    v_min_f64 v[18:19], v[20:21], v[10:11]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v13, v34, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v12, 0, vcc
; GFX8-NEXT:    v_min_f64 v[22:23], v[0:1], v[8:9]
...
; GFX8-NEXT:    v_min_f64 v[12:13], v[6:7], v[4:5]
...
; GFX8-NEXT:    v_min_f64 v[8:9], v[0:1], v[10:11]
...
; GFX10-NEXT:    v_min_f64 v[34:35], v[0:1], v[16:17]
; GFX10-NEXT:    v_min_f64 v[36:37], v[12:13], v[28:29]
; GFX10-NEXT:    v_min_f64 v[48:49], v[10:11], v[26:27]
; GFX10-NEXT:    v_min_f64 v[50:51], v[2:3], v[18:19]
; GFX10-NEXT:    v_min_f64 v[38:39], v[4:5], v[20:21]
; GFX10-NEXT:    v_cmp_u_f64_e32 vcc_lo, v[8:9], v[24:25]
; GFX10-NEXT:    v_min_f64 v[8:9], v[6:7], v[22:23]
...
; GFX10-NEXT:    v_min_f64 v[7:8], v[16:17], v[10:11]
; GFX10-NEXT:    v_min_f64 v[18:19], v[3:4], v[12:13]
; GFX10-NEXT:    v_min_f64 v[20:21], v[0:1], v[24:25]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_min_f64 v[32:33], v[14:15], v[30:31]
...
; GFX10-NEXT:    v_min_f64 v[22:23], v[5:6], v[14:15]
...
; GFX11-NEXT:    v_min_f64 v[34:35], v[0:1], v[16:17]
; GFX11-NEXT:    v_min_f64 v[36:37], v[12:13], v[28:29]
; GFX11-NEXT:    v_min_f64 v[48:49], v[10:11], v[26:27]
; GFX11-NEXT:    v_min_f64 v[50:51], v[2:3], v[18:19]
; GFX11-NEXT:    v_min_f64 v[38:39], v[4:5], v[20:21]
; GFX11-NEXT:    v_min_f64 v[52:53], v[6:7], v[22:23]
...
; GFX11-NEXT:    v_min_f64 v[18:19], v[16:17], v[10:11]
; GFX11-NEXT:    v_min_f64 v[20:21], v[3:4], v[12:13]
; GFX11-NEXT:    v_min_f64 v[22:23], v[0:1], v[8:9]
...
; GFX11-NEXT:    v_min_f64 v[24:25], v[5:6], v[14:15]
; GFX11-NEXT:    v_cndmask_b32_e64 v3, v21, 0x7ff80000, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v2, v20, 0, vcc_lo
; GFX11-NEXT:    v_cmp_u_f64_e32 vcc_lo, v[0:1], v[8:9]
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v23, 0x7ff80000, vcc_lo
...
; GFX11-NEXT:    v_cmp_u_f64_e32 vcc_lo, v[0:1], v[2:3]
; GFX11-NEXT:    v_min_f64 v[8:9], v[10:11], v[4:5]
; GFX11-NEXT:    v_cndmask_b32_e64 v1, v7, 0x7ff80000, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v0, v6, 0, vcc_lo
