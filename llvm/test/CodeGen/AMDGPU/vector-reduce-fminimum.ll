...
; GFX11-NEXT:    v_min_f16_e32 v5, v0, v2
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_min_f16_e32 v3, v0, v6
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_pk_min_f16 v8, v2, v6
...
; GFX11-NEXT:    v_pk_min_f16 v10, v3, v7
; GFX11-NEXT:    v_pk_min_f16 v12, v1, v5
...
; GFX11-NEXT:    v_pk_min_f16 v6, v8, v6
...
; GFX11-NEXT:    v_pk_min_f16 v4, v6, v4
; GFX11-NEXT:    v_min_f16_e32 v7, v0, v2
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
