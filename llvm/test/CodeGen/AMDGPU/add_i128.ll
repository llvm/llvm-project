...
; GCN-NEXT:    s_addc_u32 s4, s10, s6
; GCN-NEXT:    v_mov_b32_e32 v1, s5
; GCN-NEXT:    s_addc_u32 s5, s11, s7
...
; GCN-NEXT:    v_mov_b32_e32 v0, s4
; GCN-NEXT:    s_addc_u32 s4, s6, s10
; GCN-NEXT:    v_mov_b32_e32 v1, s5
; GCN-NEXT:    s_addc_u32 s5, s7, s11
; GCN-NEXT:    v_mov_b32_e32 v2, s4
; GCN-NEXT:    v_mov_b32_e32 v3, s5
; GCN-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x11
; GCN-NEXT:    s_mov_b32 s3, 0xf000
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_add_u32 s6, s10, s14
; GCN-NEXT:    s_addc_u32 s7, s11, s15
; GCN-NEXT:    s_addc_u32 s4, s12, s4
; GCN-NEXT:    s_addc_u32 s5, s13, s5
