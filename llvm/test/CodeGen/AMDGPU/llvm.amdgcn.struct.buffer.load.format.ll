...
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v12, s[0:3], null idxen
; GFX12-NEXT:    buffer_load_format_xyzw v[4:7], v12, s[0:3], null idxen th:TH_LOAD_NT
; GFX12-NEXT:    buffer_load_format_xyzw v[8:11], v12, s[0:3], null idxen th:TH_LOAD_HT
...
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v4, s[0:3], null idxen offset:42
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[0:3], v12, s[0:3], s4 idxen offset:4092
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[4:7], v12, s[0:3], s5 idxen offset:4092
; GFX12-SDAG-NEXT:    s_mov_b32 s4, 0x8ffc
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[8:11], v12, s[0:3], s4 idxen offset:4
...
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[0:3], v12, s[0:3], s4 idxen offset:4092
; GFX12-GISEL-NEXT:    s_movk_i32 s4, 0x7ffc
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[4:7], v12, s[0:3], s4 idxen offset:4092
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0x8ffc
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[8:11], v12, s[0:3], s4 idxen offset:4
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v4, s[0:3], null idxen offset:4092
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v4, s[0:3], null idxen offset:8188
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v4, s[0:3], null idxen offset:65532
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v4, 0
; GFX12-NEXT:    buffer_load_format_xyzw v[0:3], v4, s[0:3], null idxen offset:8388604
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[0:3], v[4:5], s[0:3], null idxen offen offset:8388604
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[0:3], v[4:5], s[0:3], null idxen offen offset:8388604
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    buffer_load_format_x v0, v1, s[0:3], null idxen
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    buffer_load_format_xy v[0:1], v2, s[0:3], null idxen
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
