...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -global-isel=1 -mtriple=amdgpu9.00-mesa-mesa3d < %s | FileCheck -check-prefix=GCN %s
...
;
; GFX10PLUS-LABEL: s_constained_fsub_f32_fpexcept_strict:
; GFX10PLUS:       ; %bb.0:
