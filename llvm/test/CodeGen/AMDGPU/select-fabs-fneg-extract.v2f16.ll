...
; RUN: llc -mtriple=amdgpu9.06 < %s | FileCheck -check-prefixes=GFX9 %s
...
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v2.h, v1.h, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v2.h, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, v2.l, v1.l, s0
; GFX11-TRUE16-NEXT:    v_pk_add_f16 v1, v1, v4
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0xbc00, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0xbc00, v1.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0xe400, v2.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0xe400, v2.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_pk_add_f16 v0, v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x3c00, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x3c00, v1.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_pk_add_f16 v0, v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v1, 0x80008000, v2
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v2, 0x7fff7fff, v3
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, v2.h, v1.h, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4400, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4400, v1.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4400, v2.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4400, v2.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_pk_mul_f16 v0, v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0xc400, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0xc400, v1.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_pk_mul_f16 v0, v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0xc400, v2.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0xc400, v2.l, s0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_pk_mul_f16 v0, v0, v3
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v1, 0x80008000, v2
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4000, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4000, v1.l, s0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX11-TRUE16-NEXT:    v_pk_add_f16 v1, v2, -4.0 op_sel_hi:[1,0] neg_lo:[1,0] neg_hi:[1,0]
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4000, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4000, v1.l, s0
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX11-TRUE16-NEXT:    v_pk_mul_f16 v1, v2, -4.0 op_sel_hi:[1,0]
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4000, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4000, v1.l, s0
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v1
; GFX11-TRUE16-NEXT:    v_pk_fma_f16 v1, v2, -4.0, v3 op_sel_hi:[1,0,1] neg_lo:[0,0,1] neg_hi:[0,0,1]
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e64 s0, 0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x4000, v1.h, vcc_lo
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x4000, v1.l, s0
