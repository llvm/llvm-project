...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, s0, s35, 0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[12:13], v[8:9], off offset:0
...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s0, s35, 0, s0
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[14:15], v[8:9], off offset:0
; GFX11-NEXT:    global_load_b64 v[10:11], v[10:11], off offset:-2048
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[20:21], v[16:17], off offset:0
; GFX11-NEXT:    global_load_b64 v[8:9], v[8:9], off
...
; GFX11-NEXT:    global_load_b64 v[24:25], v[6:7], off offset:0
...
; GFX11-NEXT:    global_load_b32 v11, v[0:1], off offset:-1024
; GFX11-NEXT:    global_load_b32 v12, v[6:7], off offset:0
; GFX11-NEXT:    global_load_b32 v13, v[4:5], off offset:1024
; GFX11-NEXT:    global_load_b32 v14, v[4:5], off offset:-2048
; GFX11-NEXT:    global_load_b32 v4, v[4:5], off offset:-1024
...
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    s_clause 0x2
; GFX11-NEXT:    global_load_b64 v[8:9], v[6:7], off offset:0
...
; GFX11-NEXT:    s_movk_i32 s0, 0x2000
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v2, 0xffff8000, v0
; GFX11-NEXT:    v_add_co_u32 v0, s1, s36, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s1, s37, 0, s1
; GFX11-NEXT:    v_add_co_u32 v10, s1, s38, v2
...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v11, s1, s39, 0, s1
; GFX11-NEXT:    v_add_co_u32 v4, vcc_lo, v0, s0
; GFX11-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v6, vcc_lo, s0, v10
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0, v11, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v10, vcc_lo, 0x3000, v10
; GFX11-NEXT:    global_load_b64 v[8:9], v[4:5], off offset:0
