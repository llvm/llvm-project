...
; GFX8-NEXT:    v_add_u32_e32 v21, vcc, 0xffffe800, v3
; GFX8-NEXT:    flat_load_dwordx2 v[19:20], v[19:20]
; GFX8-NEXT:    v_addc_u32_e32 v22, vcc, -1, v4, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[21:22], v[21:22]
; GFX8-NEXT:    v_add_u32_e32 v23, vcc, 0xfffff000, v3
; GFX8-NEXT:    v_addc_u32_e32 v24, vcc, -1, v4, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[23:24], v[23:24]
; GFX8-NEXT:    v_add_u32_e32 v25, vcc, 0xfffff800, v3
; GFX8-NEXT:    v_addc_u32_e32 v26, vcc, -1, v4, vcc
; GFX8-NEXT:    flat_load_dwordx2 v[25:26], v[25:26]
; GFX8-NEXT:    flat_load_dwordx2 v[27:28], v[3:4]
...
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v13, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v14, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(6)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v15, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v16, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(5)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v17, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v18, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(4)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v19, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v20, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(3)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v21, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v22, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(2)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v23, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v24, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v25, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v26, v6, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v27, v5
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v28, v6, vcc
...
; GFX900-NEXT:    v_add_co_u32_e32 v21, vcc, s3, v3
; GFX900-NEXT:    v_addc_co_u32_e32 v22, vcc, -1, v4, vcc
; GFX900-NEXT:    global_load_dwordx2 v[19:20], v[21:22], off offset:-2048
; GFX900-NEXT:    global_load_dwordx2 v[29:30], v[3:4], off
...
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v17, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v18, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(5)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v13, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v14, v6, vcc
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v15, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v16, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(4)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v23, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v24, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(3)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v25, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v26, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(2)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v27, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v28, v6, vcc
; GFX900-NEXT:    s_waitcnt vmcnt(1)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v19, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v20, v6, vcc
...
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    v_add_co_u32_e32 v5, vcc, v29, v5
; GFX900-NEXT:    v_addc_co_u32_e32 v6, vcc, v30, v6, vcc
...
; GFX10-NEXT:    v_add_co_u32 v7, vcc_lo, v3, 0xffffb800
; GFX10-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, -1, v4, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v9, vcc_lo, v3, 0xffffc800
; GFX10-NEXT:    v_add_co_ci_u32_e32 v10, vcc_lo, -1, v4, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v13, vcc_lo, v3, 0xffffd800
; GFX10-NEXT:    v_add_co_ci_u32_e32 v14, vcc_lo, -1, v4, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v17, vcc_lo, v3, 0xffffe800
...
; GFX10-NEXT:    v_add_co_ci_u32_e32 v18, vcc_lo, -1, v4, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v21, vcc_lo, 0xfffff000, v3
; GFX10-NEXT:    v_add_co_ci_u32_e32 v22, vcc_lo, -1, v4, vcc_lo
...
; GFX10-NEXT:    global_load_dwordx2 v[29:30], v[3:4], off offset:-2048
; GFX10-NEXT:    global_load_dwordx2 v[31:32], v[3:4], off
...
; GFX10-NEXT:    v_add_co_u32 v5, s0, v11, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v12, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(6)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v7, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v8, v6, s0
; GFX10-NEXT:    v_add_co_u32 v5, s0, v15, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v16, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(5)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v9, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v10, v6, s0
; GFX10-NEXT:    v_add_co_u32 v5, s0, v19, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v20, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(4)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v13, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v14, v6, s0
; GFX10-NEXT:    v_add_co_u32 v5, s0, v23, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v24, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(3)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v25, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v26, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(2)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v27, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v28, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_add_co_u32 v5, s0, v29, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s0, v30, v6, s0
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v5, vcc_lo, v31, v5
; GFX10-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v32, v6, vcc_lo
...
; GFX10-NEXT:    global_store_dwordx2 v[0:1], v[5:6], off
; GFX10-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_add_co_u32_e32 v8, vcc, 0xffffb000, v4
...
; GFX90A-NEXT:    v_add_co_u32_e32 v14, vcc, 0xffffc000, v4
; GFX90A-NEXT:    global_load_dwordx2 v[8:9], v[8:9], off
; GFX90A-NEXT:    v_addc_co_u32_e32 v15, vcc, -1, v5, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[18:19], v[14:15], off offset:-2048
; GFX90A-NEXT:    v_add_co_u32_e32 v16, vcc, s0, v4
; GFX90A-NEXT:    v_addc_co_u32_e32 v17, vcc, -1, v5, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[16:17], v[16:17], off offset:-2048
; GFX90A-NEXT:    v_add_co_u32_e32 v20, vcc, s1, v4
; GFX90A-NEXT:    global_load_dwordx2 v[14:15], v[14:15], off
; GFX90A-NEXT:    v_addc_co_u32_e32 v21, vcc, -1, v5, vcc
...
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v8, v6
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v9, v7, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(7)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v18, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v19, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(5)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v14, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v15, v6, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v16, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v17, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(4)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v24, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v25, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(3)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v26, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v27, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(2)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v28, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v29, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(1)
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v20, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v21, v6, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v10, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v6, vcc, v11, v6, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v1, vcc, v12, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, v13, v6, vcc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_add_co_u32_e32 v6, vcc, v30, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v7, vcc, v31, v7, vcc
...
; GFX90A-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX90A-NEXT:    global_store_dwordx2 v[0:1], v[6:7], off
; GFX90A-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_lshlrev_b32 v0, 17, v0
...
; GFX11-NEXT:    v_add_co_u32 v7, vcc_lo, v3, 0xffffc000
; GFX11-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, -1, v4, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v9, vcc_lo, 0xffffc000, v3
; GFX11-NEXT:    v_add_co_ci_u32_e32 v10, vcc_lo, -1, v4, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v11, vcc_lo, 0xffffd000, v3
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[13:14], v[7:8], off offset:-4096
; GFX11-NEXT:    global_load_b64 v[9:10], v[9:10], off offset:-2048
; GFX11-NEXT:    v_add_co_ci_u32_e32 v12, vcc_lo, -1, v4, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v15, vcc_lo, v3, 0xffffe000
; GFX11-NEXT:    v_add_co_ci_u32_e32 v16, vcc_lo, -1, v4, vcc_lo
; GFX11-NEXT:    global_load_b64 v[11:12], v[11:12], off offset:-2048
; GFX11-NEXT:    v_add_co_u32 v17, vcc_lo, 0xffffe000, v3
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[19:20], v[15:16], off offset:-4096
; GFX11-NEXT:    global_load_b64 v[7:8], v[7:8], off
; GFX11-NEXT:    v_add_co_ci_u32_e32 v18, vcc_lo, -1, v4, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v21, vcc_lo, 0xfffff000, v3
; GFX11-NEXT:    v_add_co_ci_u32_e32 v22, vcc_lo, -1, v4, vcc_lo
...
; GFX11-NEXT:    global_load_b64 v[23:24], v[3:4], off offset:-4096
; GFX11-NEXT:    global_load_b64 v[25:26], v[3:4], off offset:-2048
; GFX11-NEXT:    global_load_b64 v[27:28], v[3:4], off
...
; GFX11-NEXT:    v_add_co_u32 v5, s0, v13, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v14, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(9)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v9, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v10, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(6)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v7, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v8, v6, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v11, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v12, v6, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v19, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v20, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(5)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v17, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v18, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(4)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v15, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v16, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(3)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v21, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v22, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v23, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v24, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v5, s0, v25, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s0, v26, v6, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_co_u32 v5, vcc_lo, v27, v5
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v28, v6, vcc_lo
...
; GFX11-NEXT:    global_store_b64 v[0:1], v[5:6], off
; GFX11-NEXT:    s_nop 0
; GFX11-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-NEXT:    s_endpgm
entry:
