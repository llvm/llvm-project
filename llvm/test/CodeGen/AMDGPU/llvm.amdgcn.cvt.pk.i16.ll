...
; RUN: llc -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefixes=SI-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck %s -check-prefixes=SI-GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefixes=SI-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu7.04 < %s | FileCheck %s -check-prefixes=SI-GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefixes=VI,VI-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck %s -check-prefixes=VI,VI-GISEL
...
; SI-SDAG-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    v_mov_b32_e32 v5, 0
; SI-SDAG-NEXT:    s_mov_b64 s[10:11], s[6:7]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[4:5], s[4:7], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    buffer_load_dword v3, v[4:5], s[8:11], 0 addr64 glc
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-SDAG-NEXT:    v_cvt_pk_i16_i32_e32 v2, v2, v3
; SI-SDAG-NEXT:    buffer_store_dword v2, v[4:5], s[0:3], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-GISEL-NEXT:    buffer_load_dword v3, v[4:5], s[4:7], 0 addr64 glc
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; SI-GISEL-NEXT:    s_mov_b64 s[2:3], s[10:11]
; SI-GISEL-NEXT:    v_cvt_pk_i16_i32_e32 v2, v2, v3
; SI-GISEL-NEXT:    buffer_store_dword v2, v[4:5], s[0:3], 0 addr64
; SI-GISEL-NEXT:    s_endpgm
;
...
; VI-SDAG-NEXT:    v_add_u32_e32 v6, vcc, s4, v4
; VI-SDAG-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; VI-SDAG-NEXT:    flat_load_dword v5, v[0:1] glc
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; VI-SDAG-NEXT:    flat_load_dword v2, v[6:7] glc
; VI-SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; VI-GISEL-NEXT:    v_add_u32_e32 v6, vcc, v2, v4
; VI-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v3, vcc
; VI-GISEL-NEXT:    flat_load_dword v5, v[0:1] glc
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    flat_load_dword v2, v[6:7] glc
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
