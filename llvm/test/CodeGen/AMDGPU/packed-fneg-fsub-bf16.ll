...
; GFX1310-NEXT:    s_wait_bvhcnt 0x0
; GFX1310-NEXT:    s_wait_kmcnt 0x0
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v1 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v0
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1310-NEXT:    v_pk_min_num_bf16 v0, v0, v1
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <2 x bfloat> %b
...
; GFX1310-NEXT:    s_wait_bvhcnt 0x0
; GFX1310-NEXT:    s_wait_kmcnt 0x0
; GFX1310-NEXT:    v_pk_max_num_bf16 v2, v2, v2 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v0
; GFX1310-NEXT:    v_pk_max_num_bf16 v3, v3, v3 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v1
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1310-NEXT:    v_pk_min_num_bf16 v0, v0, v2
; GFX1310-NEXT:    v_pk_min_num_bf16 v1, v1, v3
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <4 x bfloat> %b
...
; GFX1310-NEXT:    s_wait_bvhcnt 0x0
; GFX1310-NEXT:    s_wait_kmcnt 0x0
; GFX1310-NEXT:    v_pk_max_num_bf16 v4, v4, v4 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v0
; GFX1310-NEXT:    v_pk_max_num_bf16 v5, v5, v5 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v1
; GFX1310-NEXT:    v_pk_max_num_bf16 v6, v6, v6 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v2, v2, v2
; GFX1310-NEXT:    v_pk_max_num_bf16 v7, v7, v7 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v3, v3, v3
; GFX1310-NEXT:    v_pk_min_num_bf16 v0, v0, v4
; GFX1310-NEXT:    v_pk_min_num_bf16 v1, v1, v5
; GFX1310-NEXT:    v_pk_min_num_bf16 v2, v2, v6
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1310-NEXT:    v_pk_min_num_bf16 v3, v3, v7
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <8 x bfloat> %b
...
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v0
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v1
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <2 x bfloat> %b
...
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v1
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v2
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v3
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <4 x bfloat> %b
...
; GFX1310-NEXT:    v_pk_max_num_bf16 v7, v7, v7 neg_lo:[1,1] neg_hi:[1,1]
; GFX1310-NEXT:    v_pk_max_num_bf16 v3, v3, v3
; GFX1310-NEXT:    v_pk_max_num_bf16 v0, v0, v4
; GFX1310-NEXT:    v_pk_max_num_bf16 v1, v1, v5
; GFX1310-NEXT:    v_pk_max_num_bf16 v2, v2, v6
; GFX1310-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1310-NEXT:    v_pk_max_num_bf16 v3, v3, v7
; GFX1310-NEXT:    s_set_pc_i64 s[30:31]
  %neg = fneg <8 x bfloat> %b
