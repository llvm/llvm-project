...
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_lshl_or_b32 v0, v13, 16, v12
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_lshl_or_b32 v1, v14, 16, v10
; GFX10-NEXT:    global_store_dword v[4:5], v0, off
; GFX10-NEXT:    global_store_dword v[6:7], v1, off
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NEXT:    v_lshl_or_b32 v0, v13, 16, v12
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_lshl_or_b32 v1, v14, 16, v10
; GFX9-NEXT:    global_store_dword v[4:5], v0, off
; GFX9-NEXT:    global_store_dword v[6:7], v1, off
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
  ...
  %z0 = trunc i64 %el00 to i32
  %z1 = trunc i64 %el1 to i32
  %s1 = shl nuw i32 %z1, 16
  %o0 = or i32 %s1, %z0
  %z2 = trunc i64 %el2 to i32
