...
; GFX13-NEXT:    flat_store_b32 v[4:5], v0 scope:SCOPE_SE
...
; GFX13-NEXT:    scratch_store_b32 v2, v0, off scope:SCOPE_SE
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX13-NEXT:    v_lshrrev_b16 v0, 8, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_lshlrev_b32_e32 v4, 2, v4
; GFX13-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
...
; GFX13-NEXT:    v_add_co_u32 v2, vcc_lo, v2, v4
...
; GFX13-NEXT:    v_add_co_u32 v0, vcc_lo, v2, v4
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v3, vcc_lo
; GFX13-NEXT:    global_load_b32 v0, v[0:1], off
; GFX13-NEXT:    s_wait_loadcnt 0x1
; GFX13-NEXT:    v_bfe_i32 v1, v9, 0, 8
; GFX13-NEXT:    v_dual_ashrrev_i32 v2, 26, v9 :: v_dual_ashrrev_i32 v3, 25, v9
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_lshlrev_b16 v1, 7, v1
; GFX13-NEXT:    v_lshlrev_b16 v2, 8, v2
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_ashrrev_i16 v4, 10, v0
; GFX13-NEXT:    v_perm_b32 v0, v9, v0, 0x4010707
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_lshlrev_b32_e32 v9, 2, v9
; GFX13-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v9
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX13-NEXT:    v_add_co_u32 v2, vcc_lo, v2, v9
; GFX13-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, vcc_lo
; GFX13-NEXT:    global_load_b32 v0, v[0:1], off
; GFX13-NEXT:    global_load_b32 v1, v[2:3], off
; GFX13-NEXT:    v_lshlrev_b16 v3, 8, v4
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
...
; GFX13-NEXT:    v_dual_lshlrev_b32 v3, 16, v4 :: v_dual_bitop2_b32 v1, v3, v1 bitop3:0x54
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX13-NEXT:    v_or_b32_e32 v1, v1, v3
; GFX13-NEXT:    global_store_b32 v[5:6], v1, off scope:SCOPE_SE
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_lshrrev_b32_e32 v3, 24, v1
...
; GFX13-NEXT:    v_ashrrev_i32_e32 v4, 24, v0
...
; GFX13-NEXT:    v_dual_ashrrev_i32 v11, 24, v2 :: v_dual_bitop2_b32 v12, v3, v1 bitop3:0x14
...
; GFX13-NEXT:    v_dual_ashrrev_i32 v12, 30, v12 :: v_dual_bitop2_b32 v3, v3, v10 bitop3:0x14
...
; GFX13-NEXT:    v_dual_mul_f32 v16, v14, v16 :: v_dual_bitop2_b32 v15, 1, v15 bitop3:0x54
; GFX13-NEXT:    v_dual_ashrrev_i32 v3, 30, v3 :: v_dual_ashrrev_i32 v1, 30, v1
; GFX13-NEXT:    s_delay_alu instid0(TRANS32_DEP_3) | instskip(SKIP_1) | instid1(TRANS32_DEP_2)
; GFX13-NEXT:    v_mul_f32_e32 v17, v4, v17
; GFX13-NEXT:    v_perm_b32 v0, v0, v2, 0x60706
; GFX13-NEXT:    v_mul_f32_e32 v18, v14, v18
; GFX13-NEXT:    v_trunc_f32_e32 v16, v16
; GFX13-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_dual_mul_f32 v19, v13, v19 :: v_dual_bitop2_b32 v1, 1, v1 bitop3:0x54
; GFX13-NEXT:    v_trunc_f32_e32 v17, v17
; GFX13-NEXT:    v_trunc_f32_e32 v18, v18
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_dual_fma_f32 v20, -v16, v13, v14 :: v_dual_bitop2_b32 v3, 1, v3 bitop3:0x54
; GFX13-NEXT:    v_trunc_f32_e32 v19, v19
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_dual_fma_f32 v4, -v17, v9, v4 :: v_dual_fma_f32 v14, -v18, v10, v14
...
; GFX13-NEXT:    v_cndmask_b32_e32 v4, 0, v15, vcc_lo
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_dual_add_nc_u32 v4, v17, v4 :: v_dual_add_nc_u32 v9, v16, v9
; GFX13-NEXT:    v_dual_cndmask_b32 v3, 0, v3, vcc_lo :: v_dual_add_nc_u32 v1, v19, v1
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_lshlrev_b16 v4, 8, v4
...
; GFX13-NEXT:    v_cvt_f32_i32_e32 v1, v10
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX13-NEXT:    global_load_b32 v1, v[2:3], off
; GFX13-NEXT:    s_wait_loadcnt 0x1
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_ashrrev_i32 v10, 24, v0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_bfe_i32 v11, v1, 8, 8
; GFX13-NEXT:    v_bfe_i32 v3, v1, 0, 8
; GFX13-NEXT:    v_bfe_i32 v4, v1, 16, 8
; GFX13-NEXT:    v_dual_ashrrev_i32 v12, 24, v1 :: v_dual_lshrrev_b32 v13, 24, v1
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
...
; GFX13-NEXT:    v_cvt_f32_i32_e32 v10, v10
; GFX13-NEXT:    v_dual_ashrrev_i32 v4, 30, v4 :: v_dual_ashrrev_i32 v17, 30, v17
; GFX13-NEXT:    v_rcp_iflag_f32_e32 v19, v3
; GFX13-NEXT:    v_rcp_iflag_f32_e32 v22, v18
; GFX13-NEXT:    v_xor_b32_e32 v12, v14, v12
; GFX13-NEXT:    v_cvt_f32_i32_e32 v14, v14
; GFX13-NEXT:    v_dual_ashrrev_i32 v15, 30, v15 :: v_dual_bitop2_b32 v17, 1, v17 bitop3:0x54
...
; GFX13-NEXT:    v_dual_mul_f32 v19, v16, v19 :: v_dual_ashrrev_i32 v12, 30, v12
; GFX13-NEXT:    v_mul_f32_e32 v22, v14, v22
; GFX13-NEXT:    v_trunc_f32_e32 v20, v20
; GFX13-NEXT:    v_lshrrev_b32_e32 v9, 8, v1
; GFX13-NEXT:    v_trunc_f32_e32 v19, v19
; GFX13-NEXT:    v_or_b32_e32 v12, 1, v12
; GFX13-NEXT:    v_trunc_f32_e32 v22, v22
; GFX13-NEXT:    v_dual_fma_f32 v10, -v20, v11, v10 :: v_dual_mul_f32 v21, v18, v21
...
; GFX13-NEXT:    v_dual_cndmask_b32 v4, 0, v4, vcc_lo :: v_dual_lshrrev_b32 v12, 16, v1
; GFX13-NEXT:    v_add_nc_u32_e32 v3, v19, v3
; GFX13-NEXT:    v_perm_b32 v0, v1, v0, 0x2070306
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_dual_sub_nc_u32 v2, v2, v10 :: v_dual_add_nc_u32 v4, v21, v4
; GFX13-NEXT:    v_sub_nc_u32_e32 v9, v11, v9
...
; GFX13-NEXT:    v_dual_sub_nc_u32 v3, v12, v3 :: v_dual_sub_nc_u32 v4, v13, v4
...
; GFX13-NEXT:    v_lshrrev_b32_e32 v4, 24, v2
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX13-NEXT:    s_delay_alu instid0(TRANS32_DEP_2) | instid1(VALU_DEP_3)
...
; GFX13-NEXT:    v_mul_f32_e32 v14, v1, v14
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_trunc_f32_e32 v12, v12
; GFX13-NEXT:    v_trunc_f32_e32 v13, v13
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_fma_f32 v11, -v10, v1, v11
; GFX13-NEXT:    v_trunc_f32_e32 v14, v14
; GFX13-NEXT:    v_cvt_u32_f32_e32 v10, v10
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_dual_fma_f32 v16, -v12, v3, v4 :: v_dual_fma_f32 v15, -v13, v4, v15
...
; GFX13-NEXT:    global_load_b32 v2, v[2:3], off
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_lshrrev_b32_e32 v14, 16, v2
; GFX13-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
; GFX13-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v1, vcc_lo
; GFX13-NEXT:    v_cvt_f32_ubyte1_e32 v3, v2
; GFX13-NEXT:    v_cvt_f32_ubyte3_e32 v9, v2
...
; GFX13-NEXT:    v_rcp_iflag_f32_e32 v10, v1
; GFX13-NEXT:    v_dual_lshrrev_b32 v17, 24, v2 :: v_dual_mul_f32 v11, v3, v11
; GFX13-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_dual_mul_f32 v12, v3, v12 :: v_dual_mul_f32 v10, v3, v10
...
; GFX13-NEXT:    global_load_b32 v1, v[2:3], off
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_lshrrev_b32 v4, 24, v1
; GFX13-NEXT:    v_lshrrev_b32_e32 v3, 16, v1
