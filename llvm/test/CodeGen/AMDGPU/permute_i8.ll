...
; GFX9-NEXT:    v_add_u16_sdwa v4, v16, v10 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_add_u16_e32 v3, v17, v3
; GFX9-NEXT:    v_add_u16_sdwa v2, v18, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v18, v13
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v19, v2
...
; GFX9-NEXT:    v_trunc_f32_e32 v18, v18
; GFX9-NEXT:    v_mad_f32 v12, -v18, v13, v12
; GFX9-NEXT:    v_cmp_ge_f32_e64 vcc, |v12|, |v13|
; GFX9-NEXT:    v_mul_f32_e32 v13, v3, v19
; GFX9-NEXT:    v_trunc_f32_e32 v13, v13
; GFX9-NEXT:    v_mad_f32 v19, -v13, v2, v3
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v18, v18
; GFX9-NEXT:    v_mad_f32 v19, -v12, v3, v15
; GFX9-NEXT:    v_cvt_i32_f32_e32 v12, v12
; GFX9-NEXT:    v_mad_f32 v17, -v2, v15, v17
...
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v14, 0, v16, vcc
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 8, v4
; GFX9-NEXT:    v_add_u16_e32 v1, v13, v1
; GFX9-NEXT:    v_add_u16_e32 v11, v18, v11
; GFX9-NEXT:    v_add_u16_e32 v3, v12, v3
; GFX9-NEXT:    v_add_u16_e32 v2, v2, v14
; GFX9-NEXT:    v_mul_lo_u16_e32 v1, v1, v4
; GFX9-NEXT:    v_mul_lo_u16_e32 v10, v11, v10
; GFX9-NEXT:    v_mul_lo_u16_sdwa v3, v3, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX9-NEXT:    v_mul_lo_u16_sdwa v2, v2, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_3
; GFX9-NEXT:    v_sub_u16_sdwa v1, v4, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_sub_u16_sdwa v10, v9, v10 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:DWORD
; GFX9-NEXT:    v_sub_u16_sdwa v3, v4, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_3 src1_sel:DWORD
; GFX9-NEXT:    v_sub_u16_sdwa v2, v9, v2 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
