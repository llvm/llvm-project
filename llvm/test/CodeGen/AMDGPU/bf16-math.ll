...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GCN-NEXT:    v_pk_mul_bf16 v0, 0x3f003f00, v0
; GCN-NEXT:    global_store_b32 v[2:3], v0, off
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GCN-NEXT:    v_pk_min_num_bf16 v0, 0x3f003f00, v0
; GCN-NEXT:    global_store_b32 v[2:3], v0, off
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GCN-NEXT:    v_pk_max_num_bf16 v0, 0x3f003f00, v0
; GCN-NEXT:    global_store_b32 v[2:3], v0, off
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GCN-NEXT:    v_pk_fma_bf16 v0, v0, s0, 0x3f003f00
; GCN-NEXT:    global_store_b32 v[2:3], v0, off
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
