...
; RUN: llc -mtriple=amdgpu12.50 -mattr=+real-true16 < %s | FileCheck --check-prefixes=GCN,TRUE16 %s
; RUN: llc -mtriple=amdgpu12.50 -mattr=-real-true16 < %s | FileCheck --check-prefixes=GCN,FAKE16 %s
...
; TRUE16-NEXT:    v_nop
; TRUE16-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; TRUE16-NEXT:    v_pk_max_num_bf16 v0, s0, s0 op_sel_hi:[0,0] clamp
; TRUE16-NEXT:    ; return to shader part epilog
;
