...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs %t.bc -o - | FileCheck --check-prefixes=GFX13,GFX13-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs %t.bc -o - | FileCheck --check-prefixes=GFX13,GFX13-GISEL %s
...
;
; GFX13-LABEL: test_cluster_id_x:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX13-NEXT:    v_dual_mov_b32 v0, ttmp9 :: v_dual_mov_b32 v1, 0
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_cluster_id_y:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, ttmp7 :: v_dual_mov_b32 v1, 0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_cluster_id_y:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v0, ttmp7 :: v_dual_mov_b32 v1, 0
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_cluster_id_z:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX13-SDAG-NEXT:    s_lshr_b32 s2, ttmp7, 16
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_cluster_id_z:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX13-GISEL-NEXT:    s_lshr_b32 s2, ttmp7, 16
