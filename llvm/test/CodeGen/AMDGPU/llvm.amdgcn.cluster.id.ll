...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs %s -o - | FileCheck --check-prefixes=CHECK-UNKNOWN %s
...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs %s -o - | FileCheck --check-prefixes=GFX13,GFX13-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs %s -o - | FileCheck --check-prefixes=GFX13,GFX13-GISEL %s
...
; CHECK-UNKNOWN:       ; %bb.0:
; CHECK-UNKNOWN-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; CHECK-UNKNOWN-NEXT:    s_and_b32 s2, ttmp7, 0xffff
...
; CHECK-MESA3D-NEXT:  ; %bb.0:
; CHECK-MESA3D-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; CHECK-MESA3D-NEXT:    s_and_b32 s2, ttmp7, 0xffff
...
; CHECK-G-UNKNOWN:       ; %bb.0:
; CHECK-G-UNKNOWN-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; CHECK-G-UNKNOWN-NEXT:    s_and_b32 s2, ttmp7, 0xffff
...
; CHECK-G-MESA3D-NEXT:  ; %bb.0:
; CHECK-G-MESA3D-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; CHECK-G-MESA3D-NEXT:    s_and_b32 s2, ttmp7, 0xffff
...
; GFX13-SDAG-NEXT:    s_and_b32 s2, ttmp7, 0xffff
...
; GFX13-GISEL-NEXT:    s_and_b32 s2, ttmp7, 0xffff
