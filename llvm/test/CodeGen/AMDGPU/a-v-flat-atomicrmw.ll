...
; GFX90A-NEXT:    s_waitcnt vmcnt(1)
; GFX90A-NEXT:    v_add_co_u32_e32 v4, vcc, -1, v2
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, -1, v3, vcc
; GFX90A-NEXT:    v_cmp_gt_u64_e32 vcc, v[2:3], v[0:1]
; GFX90A-NEXT:    v_cmp_gt_u64_e64 s[4:5], v[4:5], v[2:3]
; GFX90A-NEXT:    s_or_b64 vcc, s[4:5], vcc
; GFX90A-NEXT:    v_accvgpr_write_b32 a0, v2
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v5, v1, vcc
; GFX90A-NEXT:    v_accvgpr_write_b32 a1, v3
...
; GFX950-NEXT:    v_cmp_gt_u64_e32 vcc, v[2:3], v[0:1]
; GFX950-NEXT:    v_cmp_gt_u64_e64 s[0:1], v[4:5], v[2:3]
; GFX950-NEXT:    s_or_b64 vcc, s[0:1], vcc
; GFX950-NEXT:    v_accvgpr_write_b32 a0, v2
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_add_co_u32_e32 v4, vcc, -1, v0
; GFX90A-NEXT:    v_addc_co_u32_e32 v5, vcc, -1, v1, vcc
; GFX90A-NEXT:    v_cmp_gt_u64_e32 vcc, v[0:1], v[2:3]
; GFX90A-NEXT:    v_cmp_gt_u64_e64 s[4:5], v[4:5], v[0:1]
; GFX90A-NEXT:    s_or_b64 vcc, s[4:5], vcc
...
; GFX950-NEXT:    v_lshl_add_u64 v[4:5], v[0:1], 0, -1
; GFX950-NEXT:    v_cmp_gt_u64_e32 vcc, v[0:1], v[2:3]
; GFX950-NEXT:    v_cmp_gt_u64_e64 s[0:1], v[4:5], v[0:1]
; GFX950-NEXT:    s_or_b64 vcc, s[0:1], vcc
