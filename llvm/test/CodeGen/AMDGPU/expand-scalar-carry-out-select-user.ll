...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 < %s | FileCheck -check-prefix=GFX11 %s
...
; GFX11-NEXT:    v_add_co_u32_e64 v0, s1, s0, s0
...
; GFX11-NEXT:    v_cmp_lt_u32_e64 s1, s1, s0
