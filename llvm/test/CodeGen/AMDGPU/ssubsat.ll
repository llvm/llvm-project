...
; GFX6-NEXT:    v_xor_b32_e32 v2, 0x80000000, v17
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX6-NEXT:    v_sub_i32_e64 v17, s[4:5], v3, v19
...
; GFX6-NEXT:    v_sub_i32_e64 v18, s[4:5], v4, v20
; GFX6-NEXT:    v_ashrrev_i32_e32 v16, 31, v17
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[4:5], v17, v3
; GFX6-NEXT:    v_ashrrev_i32_e32 v3, 31, v18
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v20
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v4
; GFX6-NEXT:    v_xor_b32_e32 v4, 0x80000000, v16
; GFX6-NEXT:    v_xor_b32_e32 v16, 0x80000000, v3
; GFX6-NEXT:    s_xor_b64 s[6:7], s[6:7], s[8:9]
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e32 v3, v17, v4, vcc
; GFX6-NEXT:    v_cndmask_b32_e64 v4, v18, v16, s[6:7]
...
; GFX6-NEXT:    v_sub_i32_e64 v17, s[8:9], v12, v28
; GFX6-NEXT:    v_ashrrev_i32_e32 v11, 31, v16
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v28
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[8:9], v17, v12
...
; GFX6-NEXT:    s_xor_b64 vcc, s[6:7], s[8:9]
...
; GFX6-NEXT:    v_xor_b32_e32 v13, 0x80000000, v17
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
...
; GFX6-NEXT:    v_sub_i32_e64 v18, s[8:9], v15, v19
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v19
; GFX6-NEXT:    v_ashrrev_i32_e32 v14, 31, v18
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v15
; GFX6-NEXT:    v_xor_b32_e32 v15, 0x80000000, v17
; GFX6-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX6-NEXT:    v_xor_b32_e32 v17, 0x80000000, v14
; GFX6-NEXT:    v_cndmask_b32_e32 v14, v16, v15, vcc
; GFX6-NEXT:    s_xor_b64 vcc, s[6:7], s[8:9]
; GFX6-NEXT:    v_cndmask_b32_e32 v15, v18, v17, vcc
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_xor_b32_e32 v2, 0x80000000, v17
; GFX8-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX8-NEXT:    v_sub_u32_e64 v17, s[4:5], v3, v19
...
; GFX8-NEXT:    v_sub_u32_e64 v18, s[4:5], v4, v20
; GFX8-NEXT:    v_ashrrev_i32_e32 v16, 31, v17
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[4:5], v17, v3
; GFX8-NEXT:    v_ashrrev_i32_e32 v3, 31, v18
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v20
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v4
; GFX8-NEXT:    v_xor_b32_e32 v4, 0x80000000, v16
; GFX8-NEXT:    v_xor_b32_e32 v16, 0x80000000, v3
; GFX8-NEXT:    s_xor_b64 s[6:7], s[6:7], s[8:9]
; GFX8-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v17, v4, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v18, v16, s[6:7]
...
; GFX8-NEXT:    v_sub_u32_e64 v17, s[8:9], v12, v28
; GFX8-NEXT:    v_ashrrev_i32_e32 v11, 31, v16
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v28
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[8:9], v17, v12
...
; GFX8-NEXT:    v_xor_b32_e32 v13, 0x80000000, v17
; GFX8-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
...
; GFX8-NEXT:    v_sub_u32_e64 v18, s[8:9], v15, v19
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v19
; GFX8-NEXT:    v_ashrrev_i32_e32 v14, 31, v18
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v15
; GFX8-NEXT:    v_xor_b32_e32 v15, 0x80000000, v17
; GFX8-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; GFX8-NEXT:    v_xor_b32_e32 v17, 0x80000000, v14
; GFX8-NEXT:    v_cndmask_b32_e32 v14, v16, v15, vcc
; GFX8-NEXT:    s_xor_b64 vcc, s[6:7], s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e32 v15, v18, v17, vcc
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
