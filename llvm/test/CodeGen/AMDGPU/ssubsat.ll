...
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v5, v16, -v5, s[4:5]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v6, v16, -v6, s[4:5]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v7, v16, -v7, s[4:5]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v8, v16, -v8, s[4:5]
...
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_cndmask_b32_e64 v13, v16, -v13, s[4:5]
...
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v18
; GFX6-NEXT:    v_sub_i32_e64 v18, s[8:9], v15, v18
; GFX6-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX6-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v15
; GFX6-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    v_ashrrev_i32_e32 v19, 31, v18
; GFX6-NEXT:    v_cndmask_b32_e64 v14, v16, -v17, s[4:5]
; GFX6-NEXT:    s_xor_b64 s[4:5], s[6:7], s[8:9]
; GFX6-NEXT:    v_cndmask_b32_e64 v15, v18, -v19, s[4:5]
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v16, -v5, s[4:5]
...
; GFX8-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v16, -v6, s[4:5]
...
; GFX8-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v16, -v7, s[4:5]
...
; GFX8-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    v_cndmask_b32_e64 v13, v16, -v13, s[4:5]
...
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[6:7], 0, v18
; GFX8-NEXT:    v_sub_u32_e64 v18, s[8:9], v15, v18
; GFX8-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX8-NEXT:    v_cmp_lt_i32_e64 s[8:9], v18, v15
; GFX8-NEXT:    s_xor_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    v_ashrrev_i32_e32 v19, 31, v18
; GFX8-NEXT:    v_cndmask_b32_e64 v14, v16, -v17, s[4:5]
; GFX8-NEXT:    s_xor_b64 s[4:5], s[6:7], s[8:9]
; GFX8-NEXT:    v_cndmask_b32_e64 v15, v18, -v19, s[4:5]
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
