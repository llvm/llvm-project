...
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_sub_co_u32_e64 v10, vcc_lo, v0, v2
; GFX11-NEXT:    v_bfrev_b32_e32 v6, -2
; GFX11-NEXT:    v_sub_co_ci_u32_e32 v11, vcc_lo, v1, v3, vcc_lo
; GFX11-NEXT:    v_cmp_lt_i64_e64 s0, 0, v[2:3]
; GFX11-NEXT:    v_cmp_gt_i64_e64 s1, 0, v[10:11]
; GFX11-NEXT:    v_cmp_lt_i64_e32 vcc_lo, v[10:11], v[0:1]
; GFX11-NEXT:    v_ashrrev_i32_e32 v0, 31, v11
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0x80000000, v6, s1
