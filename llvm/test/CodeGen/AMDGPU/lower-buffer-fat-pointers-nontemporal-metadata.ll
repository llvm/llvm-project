...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX9,GFX9-SDAG %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX9,GFX9-GISEL %s
; RUN: llc -mtriple=amdgpu9.42-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX942,GFX942-SDAG %s
; RUN: llc -mtriple=amdgpu9.42-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX942,GFX942-GISEL %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX10,GFX10-SDAG %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX10,GFX10-GISEL %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX11,GFX11-SDAG %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX11,GFX11-GISEL %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -global-isel=0 < %s | FileCheck --check-prefixes=GFX12,GFX12-SDAG %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -global-isel=1 < %s | FileCheck --check-prefixes=GFX12,GFX12-GISEL %s
...
; GFX942-SDAG-NEXT:    s_load_dword s7, s[4:5], 0x10
; GFX942-SDAG-NEXT:    s_mov_b32 s6, 0
; GFX942-SDAG-NEXT:    s_mov_b32 s11, s6
; GFX942-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_mov_b32 s10, s3
; GFX942-SDAG-NEXT:    s_mov_b32 s8, s1
; GFX942-SDAG-NEXT:    s_or_b64 s[10:11], s[10:11], s[6:7]
...
; GFX942-SDAG-NEXT:    s_mov_b32 s5, s6
; GFX942-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-SDAG-NEXT:    s_mov_b32 s4, s3
; GFX942-SDAG-NEXT:    s_or_b64 s[6:7], s[4:5], s[6:7]
