...
; RUN: not llc -mtriple=amdgcn -mcpu=gfx12-1-generic --amdhsa-code-object-version=5 -o - %s 2>&1 | FileCheck --check-prefix=GFX121-V5 %s
...
; RUN: llc -mtriple=amdgcn -mcpu=gfx12-1-generic --amdhsa-code-object-version=6 -o - %s
...
; GFX121-V5: gfx12-1-generic is only available on code object version 6 or better
