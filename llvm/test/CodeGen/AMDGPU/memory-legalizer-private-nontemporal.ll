...
; GFX11-WGP-NEXT:    scratch_store_b32 off, v0, s0 slc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    scratch_store_b32 off, v0, s0 slc
; GFX11-CU-NEXT:    s_endpgm
...
; GFX11-WGP-NEXT:    scratch_store_b32 v0, v1, s0 slc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    scratch_store_b32 v0, v1, s0 slc
; GFX11-CU-NEXT:    s_endpgm
    i32 addrspace(1)* %in, i32 addrspace(5)* %out) {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
