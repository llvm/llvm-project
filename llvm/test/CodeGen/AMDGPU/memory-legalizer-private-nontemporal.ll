...
;
; GFX1210-LABEL: private_nontemporal_load_0:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    scratch_load_b32 v1, off, s2 th:TH_LOAD_NT
...
; GFX940-NOTTGSPLIT-NEXT:    s_load_dword s3, s[4:5], 0x0
; GFX940-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x8
; GFX940-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX940-TGSPLIT-NEXT:    s_load_dword s3, s[4:5], 0x0
; GFX940-TGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x8
; GFX940-TGSPLIT-NEXT:    v_mov_b32_e32 v0, 0
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: private_nontemporal_load_1:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    scratch_load_b32 v1, v1, s2 scale_offset th:TH_LOAD_NT
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(5) %in, ptr addrspace(1) %out) {
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: private_nontemporal_store_0:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    scratch_store_b32 off, v0, s0 th:TH_STORE_NT
; GFX1210-NEXT:    s_endpgm
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: private_nontemporal_store_1:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1210-NEXT:    s_load_b32 s0, s[4:5], 0x8
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v0, s1
; GFX1210-NEXT:    scratch_store_b32 v1, v0, s0 scale_offset th:TH_STORE_NT
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(5) %out) {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: private_nontemporal_volatile_load:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b32 s2, s[4:5], 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    scratch_load_b32 v1, off, s2 th:TH_LOAD_NT scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
    ptr addrspace(5) %in, ptr addrspace(1) %out) {
