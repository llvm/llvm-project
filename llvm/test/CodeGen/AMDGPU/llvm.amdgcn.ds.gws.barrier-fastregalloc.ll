...
define amdgpu_kernel void @gws_barrier_offset0(i32 %val) #0 {
  ...
  ; MIR: bb.0 (%ir-block.0):
  ; MIR-NEXT:   liveins: $sgpr8_64
  ; MIR-NEXT: {{  $}}
  ; MIR-NEXT:   dead renamable $sgpr4 = S_LOAD_DWORD_IMM renamable $sgpr8_64, 0, 0 :: (dereferenceable invariant load (s32) from constant-pool, align 16, addrspace 4)
  ; MIR-NEXT:   renamable $sgpr4 = S_LOAD_DWORD_IMM killed renamable $sgpr8_64, 0, 0 :: (dereferenceable invariant load (s32) from %ir.val.kernarg.offset, align 16, addrspace 4)
