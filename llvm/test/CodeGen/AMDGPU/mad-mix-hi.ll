...
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v2.l
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v0.l
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr3_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v2, v1, v3 op_sel_hi:[1,1,1]
...
; SDAG-GFX11-TRUE16:       ; %bb.0:
; SDAG-GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v2.l
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v0.l
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr4_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v3.l
; SDAG-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v2, v1, v4 op_sel_hi:[1,1,1]
; SDAG-GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr3_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixlo_f16 v0, v0, v1, v3 op_sel_hi:[1,1,1]
...
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v2, v1, v3 op_sel_hi:[1,1,1] clamp
; SDAG-GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v2.l
; SDAG-GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v1.l
...
; SDAG-GFX11-TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; SDAG-GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixlo_f16 v1, v4, v2, v3 op_sel_hi:[1,1,1]
; SDAG-GFX11-TRUE16-NEXT:    v_fma_mixhi_f16 v0, v4, v2, v3 op_sel_hi:[1,1,1] clamp
