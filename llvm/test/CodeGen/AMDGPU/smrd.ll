...
; SI-NEXT:    s_mov_b32 s2, -1 ; encoding: [0xc1,0x03,0x82,0xbe]
; SI-NEXT:    s_waitcnt lgkmcnt(0) ; encoding: [0x7f,0x00,0x8c,0xbf]
; SI-NEXT:    s_add_i32 s1, s1, 4 ; encoding: [0x01,0x84,0x01,0x81]
...
; CI-NEXT:    s_mov_b32 s2, -1 ; encoding: [0xc1,0x03,0x82,0xbe]
; CI-NEXT:    s_waitcnt lgkmcnt(0) ; encoding: [0x7f,0x00,0x8c,0xbf]
; CI-NEXT:    s_add_i32 s1, s1, 4 ; encoding: [0x01,0x84,0x01,0x81]
...
; VI-NEXT:    s_waitcnt lgkmcnt(0) ; encoding: [0x7f,0x00,0x8c,0xbf]
; VI-NEXT:    s_add_i32 s1, s1, 4 ; encoding: [0x01,0x84,0x01,0x81]
...
; GFX10-NEXT:    v_mov_b32_e32 v0, 0 ; encoding: [0x80,0x02,0x00,0x7e]
; GFX10-NEXT:    s_waitcnt lgkmcnt(0) ; encoding: [0x7f,0xc0,0x8c,0xbf]
; GFX10-NEXT:    s_add_i32 s1, s1, 4 ; encoding: [0x01,0x84,0x01,0x81]
...
; SI:       ; %bb.0: ; %main_body
; SI-NEXT:    v_add_i32_e32 v1, vcc, 0x1000, v0 ; encoding: [0xff,0x00,0x02,0x4a,0x00,0x10,0x00,0x00]
; SI-NEXT:    buffer_load_dword v0, v1, s[0:3], 0 offen ; encoding: [0x00,0x10,0x30,0xe0,0x01,0x00,0x00,0x80]
; SI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; SI-NEXT:    ; return to shader part epilog
;
; CI-LABEL: smrd_vgpr_offset_imm_too_large:
; CI:       ; %bb.0: ; %main_body
; CI-NEXT:    v_add_i32_e32 v1, vcc, 0x1000, v0 ; encoding: [0xff,0x00,0x02,0x4a,0x00,0x10,0x00,0x00]
; CI-NEXT:    buffer_load_dword v0, v1, s[0:3], 0 offen ; encoding: [0x00,0x10,0x30,0xe0,0x01,0x00,0x00,0x80]
; CI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; CI-NEXT:    ; return to shader part epilog
;
...
; GFX10-NEXT:    s_and_b32 s2, exec_lo, s4 ; encoding: [0x7e,0x04,0x02,0x87]
; GFX10-NEXT:    s_or_b32 s3, s2, s3 ; encoding: [0x02,0x03,0x03,0x88]
...
; GFX10-NEXT:    v_mov_b32_e32 v2, s6 ; encoding: [0x06,0x02,0x04,0x7e]
; GFX10-NEXT:    v_mov_b32_e32 v3, s7 ; encoding: [0x07,0x02,0x06,0x7e]
; GFX10-NEXT:    s_or_b32 s8, s12, s8 ; encoding: [0x0c,0x08,0x08,0x88]
...
; GFX10-NEXT:    ; in Loop: Header=BB27_2 Depth=1
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s8 ; encoding: [0x7e,0x08,0x7e,0x88]
; GFX10-NEXT:    s_mov_b32 s4, -1 ; encoding: [0xc1,0x03,0x84,0xbe]
; GFX10-NEXT:    s_and_saveexec_b32 s5, s2 ; encoding: [0x02,0x3c,0x85,0xbe]
; GFX10-NEXT:    s_xor_b32 s8, exec_lo, s5 ; encoding: [0x7e,0x05,0x08,0x89]
...
; GFX10-NEXT:    s_mov_b32 s2, exec_lo ; encoding: [0x7e,0x03,0x82,0xbe]
; GFX10-NEXT:    s_mov_b32 s9, s2 ; encoding: [0x02,0x03,0x89,0xbe]
...
; GFX10-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0) ; encoding: [0x1e,0xff,0xa3,0xbf]
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[4:5], v[0:1] ; encoding: [0x04,0x00,0xe4,0x7d]
; GFX10-NEXT:    v_cmpx_eq_u64_e32 s[6:7], v[2:3] ; encoding: [0x06,0x04,0xe4,0x7d]
; GFX10-NEXT:    buffer_load_dword v5, v4, s[4:7], 0 offen ; encoding: [0x00,0x10,0x30,0xe0,0x04,0x05,0x01,0x80]
; GFX10-NEXT:    s_andn2_wrexec_b32 s9, s9 ; encoding: [0x09,0x47,0x89,0xbe]
...
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0) ; encoding: [0x03,0xff,0xa3,0xbf]
; GFX10-NEXT:    s_mov_b32 exec_lo, s2 ; encoding: [0x02,0x03,0xfe,0xbe]
; GFX10-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x3f,0x8c,0xbf]
; GFX10-NEXT:    v_cmp_lg_f32_e64 s2, 0, v5 ; encoding: [0x02,0x00,0x05,0xd4,0x80,0x0a,0x02,0x02]
; GFX10-NEXT:    s_orn2_b32 s4, s2, exec_lo ; encoding: [0x02,0x7e,0x04,0x8b]
...
; SI-NEXT:    buffer_load_dwordx4 v[6:9], v2, s[4:7], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x02,0x06,0x01,0x80]
; SI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; SI-NEXT:    exp mrt0, v4, v4, v4, v7 done vm ; encoding: [0x0f,0x18,0x00,0xf8,0x04,0x04,0x04,0x07]
; SI-NEXT:    s_endpgm ; encoding: [0x00,0x00,0x81,0xbf]
;
...
; CI-NEXT:    buffer_load_dwordx4 v[6:9], v2, s[4:7], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x02,0x06,0x01,0x80]
; CI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; CI-NEXT:    exp mrt0, v4, v4, v4, v7 done vm ; encoding: [0x0f,0x18,0x00,0xf8,0x04,0x04,0x04,0x07]
; CI-NEXT:    s_endpgm ; encoding: [0x00,0x00,0x81,0xbf]
;
...
; VI-NEXT:    buffer_load_dwordx4 v[6:9], v2, s[4:7], 0 offen ; encoding: [0x00,0x10,0x5c,0xe0,0x02,0x06,0x01,0x80]
; VI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; VI-NEXT:    exp mrt0, v4, v4, v4, v7 done vm ; encoding: [0x0f,0x18,0x00,0xc4,0x04,0x04,0x04,0x07]
; VI-NEXT:    s_endpgm ; encoding: [0x00,0x00,0x81,0xbf]
;
...
; SI:       ; %bb.0: ; %main_body
; SI-NEXT:    v_add_i32_e32 v16, vcc, 0xff8, v0 ; encoding: [0xff,0x00,0x20,0x4a,0xf8,0x0f,0x00,0x00]
; SI-NEXT:    buffer_load_dwordx4 v[0:3], v16, s[0:3], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x10,0x00,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[4:7], v16, s[0:3], 0 offen offset:16 ; encoding: [0x10,0x10,0x38,0xe0,0x10,0x04,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[8:11], v16, s[0:3], 0 offen offset:32 ; encoding: [0x20,0x10,0x38,0xe0,0x10,0x08,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[12:15], v16, s[0:3], 0 offen offset:48 ; encoding: [0x30,0x10,0x38,0xe0,0x10,0x0c,0x00,0x80]
; SI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; SI-NEXT:    ; return to shader part epilog
;
; CI-LABEL: smrd_load_nonconst4:
; CI:       ; %bb.0: ; %main_body
; CI-NEXT:    v_add_i32_e32 v16, vcc, 0xff8, v0 ; encoding: [0xff,0x00,0x20,0x4a,0xf8,0x0f,0x00,0x00]
; CI-NEXT:    buffer_load_dwordx4 v[0:3], v16, s[0:3], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x10,0x00,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[4:7], v16, s[0:3], 0 offen offset:16 ; encoding: [0x10,0x10,0x38,0xe0,0x10,0x04,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[8:11], v16, s[0:3], 0 offen offset:32 ; encoding: [0x20,0x10,0x38,0xe0,0x10,0x08,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[12:15], v16, s[0:3], 0 offen offset:48 ; encoding: [0x30,0x10,0x38,0xe0,0x10,0x0c,0x00,0x80]
; CI-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; CI-NEXT:    ; return to shader part epilog
;
...
; SI:       ; %bb.0: ; %main_body
; SI-NEXT:    v_add_i32_e32 v16, vcc, 0x1004, v0 ; encoding: [0xff,0x00,0x20,0x4a,0x04,0x10,0x00,0x00]
; SI-NEXT:    buffer_load_dwordx4 v[0:3], v16, s[0:3], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x10,0x00,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[4:7], v16, s[0:3], 0 offen offset:16 ; encoding: [0x10,0x10,0x38,0xe0,0x10,0x04,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[8:11], v16, s[0:3], 0 offen offset:32 ; encoding: [0x20,0x10,0x38,0xe0,0x10,0x08,0x00,0x80]
; SI-NEXT:    buffer_load_dwordx4 v[12:15], v16, s[0:3], 0 offen offset:48 ; encoding: [0x30,0x10,0x38,0xe0,0x10,0x0c,0x00,0x80]
...
; CI:       ; %bb.0: ; %main_body
; CI-NEXT:    v_add_i32_e32 v16, vcc, 0x1004, v0 ; encoding: [0xff,0x00,0x20,0x4a,0x04,0x10,0x00,0x00]
; CI-NEXT:    buffer_load_dwordx4 v[0:3], v16, s[0:3], 0 offen ; encoding: [0x00,0x10,0x38,0xe0,0x10,0x00,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[4:7], v16, s[0:3], 0 offen offset:16 ; encoding: [0x10,0x10,0x38,0xe0,0x10,0x04,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[8:11], v16, s[0:3], 0 offen offset:32 ; encoding: [0x20,0x10,0x38,0xe0,0x10,0x08,0x00,0x80]
; CI-NEXT:    buffer_load_dwordx4 v[12:15], v16, s[0:3], 0 offen offset:48 ; encoding: [0x30,0x10,0x38,0xe0,0x10,0x0c,0x00,0x80]
...
; SI:       ; %bb.0: ; %main_body
; SI-NEXT:    s_cmp_eq_u32 s0, 0 ; encoding: [0x00,0x80,0x06,0xbf]
...
; CI:       ; %bb.0: ; %main_body
; CI-NEXT:    s_cmp_eq_u32 s0, 0 ; encoding: [0x00,0x80,0x06,0xbf]
...
; VI:       ; %bb.0: ; %main_body
; VI-NEXT:    s_cmp_eq_u32 s0, 0 ; encoding: [0x00,0x80,0x06,0xbf]
...
; GFX10:       ; %bb.0: ; %main_body
; GFX10-NEXT:    s_cmp_eq_u32 s0, 0 ; encoding: [0x00,0x80,0x06,0xbf]
