...
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck --check-prefixes=GFX10-WGP %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa < %s | FileCheck --check-prefixes=GFX11-WGP %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa < %s | FileCheck --check-prefixes=GFX12-WGP %s
; RUN: llc -mtriple=amdgpu12.50-amd-amdhsa < %s | FileCheck --check-prefixes=GFX1250 %s
