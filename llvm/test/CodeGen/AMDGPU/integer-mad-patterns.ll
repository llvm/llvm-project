...
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v16, v7, v[3:4]
; GFX10-GISEL-NEXT:    v_add_co_u32 v3, vcc_lo, v2, v16
; GFX10-GISEL-NEXT:    v_add_co_u32 v1, s4, v0, v15
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[12:13], null, v17, v4, v[8:9]
...
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v15, null, v12, v17, s4
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v16, null, v13, v18, vcc_lo
...
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v13, vcc_lo
...
; GFX10-GISEL-NEXT:    v_add_co_u32 v12, s4, v8, 1
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v10, v9, v[14:15]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v13, v15, 0
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v8, null, 0, v4, s4
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v11, v12, 0
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX10-GISEL-NEXT:    v_add_co_ci_u32_e64 v14, null, 0, v5, vcc_lo
...
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr8
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v13, v14, v[3:4]
; GFX10-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v6, v12, v[7:8]
; GFX10-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v4, v15, v[9:10]
...
; GFX11-GISEL-NEXT:    v_add_co_u32 v16, s0, v2, 1
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v18, null, 0, v3, s0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v16, v6, 0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v15, v5, v[1:2]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[10:11], null, v16, v7, v[3:4]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr11
; GFX11-GISEL-NEXT:    v_add_co_u32 v3, s0, v0, v15
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[12:13], null, v17, v4, v[8:9]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[13:14], null, v18, v6, v[10:11]
; GFX11-GISEL-NEXT:    v_add_co_u32 v14, vcc_lo, v2, v16
...
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v17, null, v12, v17, s0
; GFX11-GISEL-NEXT:    v_add_co_u32 v20, s0, v0, 1
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v18, null, v13, v18, vcc_lo
; GFX11-GISEL-NEXT:    v_add_co_u32 v19, vcc_lo, v2, 1
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v5, v[9:10]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v14, v7, v[11:12]
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v13, vcc_lo
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4)
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[15:16], null, v17, v4, v[0:1]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr3
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[4:5], null, v18, v6, v[2:3]
; GFX11-GISEL-NEXT:    v_add_co_u32 v18, vcc_lo, v10, 1
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v8, v21, v[12:13]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[16:17], null, v10, v7, v[14:15]
; GFX11-GISEL-NEXT:    v_add_co_u32 v14, s0, v8, 1
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[2:3], null, v13, v18, 0
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v12, null, 0, v15, s0
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[0:1], null, v11, v14, 0
...
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[8:9], null, v4, v19, v[16:17]
; GFX11-GISEL-NEXT:    v_add_co_ci_u32_e64 v21, null, 0, v4, vcc_lo
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[9:10], null, v11, v12, v[1:2]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[11:12], null, v13, v21, v[3:4]
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr10
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[5:6], null, v7, v14, v[9:10]
; GFX11-GISEL-NEXT:    v_mad_u64_u32 v[3:4], null, v8, v18, v[11:12]
