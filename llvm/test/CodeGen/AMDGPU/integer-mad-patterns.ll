...
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[4:5]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v1, vcc, v0, v8
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v9, v2, v[6:7]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v1, v2, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v10, vcc, v4, v9, vcc
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v3, v[6:7]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v2, v[8:9]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v9, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v9, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v4, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v10, vcc, 1, v5
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[0:1]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v10, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v11, vcc, 0, v6, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v9, v[3:4]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v3, v1
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v11, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v7, v10, v[5:6]
...
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[4:5]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v1, vcc, v0, v8
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v9, v2, v[6:7]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v1, v2, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v10, vcc, v4, v9, vcc
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v3, v[6:7]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v2, v[8:9]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v9, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v9, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v4, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v10, vcc, 1, v5
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[0:1]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v10, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v11, vcc, 0, v6, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v9, v[3:4]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v3, v1
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v11, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v7, v10, v[5:6]
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v8, v3, v[4:5]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v1, vcc, v0, v8
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v9, v2, v[6:7]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v1, v2, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v10, vcc, v4, v9, vcc
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr7
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v3, v[6:7]
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v2, v[8:9]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v9, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v9, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v4, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v10, vcc, 1, v5
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v0, v3
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v5, v7, v[0:1]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v10, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v6, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v9, v[3:4]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v3, v1
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v2, v11, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v7, v10, v[5:6]
; GFX900-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v5, v[8:9]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v8, v3
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v7, v[8:9]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v4, v[10:11]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v6, v[12:13]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v1, vcc, v0, v14
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v4, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v8, v15, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v19, vcc, v2, v16
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v1, v5, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v19, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v20, vcc, v9, v17, vcc
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v15, v12
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr16
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[17:18], s[4:5], v19, v7, v[15:16]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v3, v4, v[13:14]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v20, v6, v[17:18]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v12, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v2, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v0, v5
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v7, v[0:1]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v2, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v13, vcc, 0, v9, vcc
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v0, v8
; GFX7-GISEL-NEXT:    v_add_i32_e32 v16, vcc, 1, v10
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v12, v[5:6]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v13, v[0:1]
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v15, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v16, 0
; GFX7-GISEL-NEXT:    v_add_i32_e32 v17, vcc, 1, v11
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v18, vcc, 0, v3, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v3, v2, v[5:6]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v17, 0
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v5, v1
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v4, v14, v[5:6]
; GFX7-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v7, v18, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v16, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v17, v[13:14]
...
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v5, v[8:9]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v8, v3
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v7, v[8:9]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v4, v[10:11]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v6, v[12:13]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v1, vcc, v0, v14
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v4, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v8, v15, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v19, vcc, v2, v16
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v1, v5, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v19, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v20, vcc, v9, v17, vcc
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v15, v12
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr16
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[17:18], s[4:5], v19, v7, v[15:16]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v3, v4, v[13:14]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v20, v6, v[17:18]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v12, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v12, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v7, vcc, 0, v8, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v2, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, v5
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v7, v[0:1]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v2, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v13, vcc, 0, v9, vcc
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, v8
; GFX8-GISEL-NEXT:    v_add_u32_e32 v16, vcc, 1, v10
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v12, v[5:6]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v13, v[0:1]
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v15, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v16, 0
; GFX8-GISEL-NEXT:    v_add_u32_e32 v17, vcc, 1, v11
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v18, vcc, 0, v3, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v3, v2, v[5:6]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v17, 0
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v5, v1
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v4, v14, v[5:6]
; GFX8-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v7, v18, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v16, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v17, v[13:14]
...
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v5, v[8:9]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v8, v3
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr9
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v7, v[8:9]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v4, v[10:11]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v6, v[12:13]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v1, vcc, v0, v14
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v4, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v3, vcc, v8, v15, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v19, vcc, v2, v16
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr12
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v1, v5, v[11:12]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v19, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v20, vcc, v9, v17, vcc
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v15, v12
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr16
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[17:18], s[4:5], v19, v7, v[15:16]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v3, v4, v[13:14]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v20, v6, v[17:18]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v12, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v7, vcc, 0, v8, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v2, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v0, v5
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v7, v[0:1]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v2, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v13, vcc, 0, v9, vcc
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v0, v8
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v16, vcc, 1, v10
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v12, v[5:6]
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr1
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v13, v[0:1]
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v14, vcc, 0, v15, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v16, 0
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v17, vcc, 1, v11
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v18, vcc, 0, v3, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v3, v2, v[5:6]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v17, 0
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v5, v1
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr6
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v4, v14, v[5:6]
; GFX900-GISEL-NEXT:    ; implicit-def: $vgpr4
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v7, v18, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v9, v16, v[11:12]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v17, v[13:14]
