...
; GFX7-GISEL-NEXT:    v_add_i32_e32 v16, vcc, v0, v12
...
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v8, v13, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v4, 0
; GFX7-GISEL-NEXT:    v_add_i32_e32 v18, vcc, v2, v14
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v6, 0
...
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v3, v13
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v10, v11, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v16, v5, v[1:2]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v5, v14
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v20, vcc, 0, v8, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v17, v4, v[0:1]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v15, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_add_i32_e64 v16, s[4:5], 1, v10
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, 0, v9, vcc
; GFX7-GISEL-NEXT:    v_addc_u32_e64 v21, vcc, 0, v14, s[4:5]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v20, v[5:6]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v15, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v18, v7, v[3:4]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v7, v9
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v16, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v6, v[2:3]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v17, v[7:8]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v12
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v12, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v11, v[4:5]
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, 0, v9, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v9, v15, v[6:7]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v21, v[1:2]
; GFX7-GISEL-NEXT:    v_mov_b32_e32 v1, v3
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v8, v17, v[1:2]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v16, v[5:6]
...
; GFX8-GISEL-NEXT:    v_add_u32_e32 v16, vcc, v0, v12
...
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v8, v13, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v4, 0
; GFX8-GISEL-NEXT:    v_add_u32_e32 v18, vcc, v2, v14
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v6, 0
...
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v3, v13
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v10, v11, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v16, v5, v[1:2]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v5, v14
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v20, vcc, 0, v8, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v17, v4, v[0:1]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v15, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_add_u32_e64 v16, s[4:5], 1, v10
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, 0, v9, vcc
; GFX8-GISEL-NEXT:    v_addc_u32_e64 v21, vcc, 0, v14, s[4:5]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v20, v[5:6]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v15, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v18, v7, v[3:4]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v7, v9
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v16, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v6, v[2:3]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v17, v[7:8]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v12, vcc, 1, v12
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v12, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v11, v[4:5]
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v17, vcc, 0, v9, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v9, v15, v[6:7]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v21, v[1:2]
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v1, v3
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v8, v17, v[1:2]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v16, v[5:6]
...
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v16, vcc, v0, v12
...
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v17, vcc, v8, v13, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v4, 0
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v18, vcc, v2, v14
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v6, 0
...
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v3, v13
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v10, v11, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v16, v5, v[1:2]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v5, v14
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v20, vcc, 0, v8, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v17, v4, v[0:1]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v15, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_add_co_u32_e64 v16, s[4:5], 1, v10
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v9, vcc
; GFX900-GISEL-NEXT:    v_addc_co_u32_e64 v21, vcc, 0, v14, s[4:5]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v10, v20, v[5:6]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v15, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v18, v7, v[3:4]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v7, v9
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v16, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v19, v6, v[2:3]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v17, v[7:8]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v12, vcc, 1, v12
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v12, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v11, v[4:5]
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v9, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v9, v15, v[6:7]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v21, v[1:2]
; GFX900-GISEL-NEXT:    v_mov_b32_e32 v1, v3
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v8, v17, v[1:2]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v16, v[5:6]
