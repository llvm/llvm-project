...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=+wavefrontsize64 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX11-12,GFX12,GFX12-GISEL %s
...
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB24_1
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB24_1:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
...
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[0:1], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_and_not1_b64 s[2:3], exec, s[0:1]
; GFX12-GISEL-NEXT:    s_cbranch_scc0 .LBB24_1
; GFX12-GISEL-NEXT:    s_endpgm
; GFX12-GISEL-NEXT:  .LBB24_1:
; GFX12-GISEL-NEXT:    s_mov_b64 exec, 0
; GFX12-GISEL-NEXT:    export mrt0, off, off, off, off done
; GFX12-GISEL-NEXT:    s_endpgm
...
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB25_4
; GFX12-SDAG-NEXT:  ; %bb.2: ; %loop3
; GFX12-SDAG-NEXT:    ; in Loop: Header=BB25_1 Depth=1
...
; GFX12-SDAG-NEXT:    s_cbranch_scc1 .LBB25_1
; GFX12-SDAG-NEXT:  ; %bb.3: ; %endloop15
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB25_4:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
...
; GFX12-GISEL-NEXT:  .LBB25_1: ; %loop3
...
; GFX12-SDAG-NEXT:    s_cbranch_vccnz .LBB26_5
...
; GFX12-SDAG-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX12-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
; GFX12-SDAG-NEXT:    v_cmp_ne_u32_e64 s[0:1], 1, v0
; GFX12-SDAG-NEXT:  .LBB26_2: ; %bb
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_add_f32 s4, s4, 0x3e800000
; GFX12-SDAG-NEXT:    s_and_b64 vcc, exec, s[0:1]
; GFX12-SDAG-NEXT:    s_cbranch_vccnz .LBB26_2
; GFX12-SDAG-NEXT:  ; %bb.3: ; %bb33
; GFX12-SDAG-NEXT:    s_and_not1_b64 s[2:3], s[2:3], exec
; GFX12-SDAG-NEXT:    s_cbranch_scc0 .LBB26_6
; GFX12-SDAG-NEXT:  ; %bb.4: ; %bb33
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:  .LBB26_5: ; %bb35
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, s4
; GFX12-SDAG-NEXT:    export mrt0, v0, v0, v0, v0 done
; GFX12-SDAG-NEXT:    s_endpgm
; GFX12-SDAG-NEXT:  .LBB26_6:
; GFX12-SDAG-NEXT:    s_mov_b64 exec, 0
; GFX12-SDAG-NEXT:    export mrt0, off, off, off, off done
; GFX12-SDAG-NEXT:    s_endpgm
;
