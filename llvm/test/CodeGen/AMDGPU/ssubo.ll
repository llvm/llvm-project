...
; VI-NEXT:    v_cmp_lt_i64_e32 vcc, s[0:1], v[3:4]
; VI-NEXT:    v_cmp_gt_i64_e64 s[4:5], s[6:7], 0
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    v_mov_b32_e32 v3, s3
; VI-NEXT:    s_xor_b64 s[2:3], s[4:5], vcc
...
; GFX11-NEXT:    v_cmp_gt_i64_e64 s5, s[6:7], 0
...
; GFX10-NEXT:    v_cmp_lt_i64_e64 s0, 0, v[2:3]
...
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v6, s[14:15]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_sub_nc_u32_e32 v5, v1, v3
; GFX10-NEXT:    v_sub_nc_u32_e32 v4, v0, v2
; GFX10-NEXT:    v_sub_nc_i32 v0, v0, v2 clamp
; GFX10-NEXT:    v_sub_nc_i32 v1, v1, v3 clamp
; GFX10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v4, v0
...
; GFX11-NEXT:    global_load_b64 v[2:3], v6, s[10:11]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_sub_nc_u32_e32 v5, v1, v3
; GFX11-NEXT:    v_sub_nc_u32_e32 v4, v0, v2
...
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, v5, v1
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b64 v6, v[4:5], s[4:5]
; GFX11-NEXT:    global_store_b64 v6, v[0:1], s[6:7]
; GFX11-NEXT:    s_endpgm
