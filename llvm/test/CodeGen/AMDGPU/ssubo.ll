...
; SI-NEXT:    v_cmp_lt_i64_e64 s[8:9], s[2:3], 0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_xor_b64 s[0:1], vcc, s[8:9]
...
; VI-NEXT:    s_subb_u32 s5, s3, s5
; VI-NEXT:    v_cmp_lt_i64_e32 vcc, s[2:3], v[1:2]
; VI-NEXT:    v_cmp_lt_i64_e64 s[2:3], s[4:5], 0
...
; GFX10-NEXT:    v_cmp_lt_i64_e64 s2, s[2:3], s[6:7]
; GFX10-NEXT:    v_cmp_lt_i64_e64 s3, s[4:5], 0
...
; GFX11-NEXT:    v_cmp_lt_i64_e64 s2, s[2:3], s[4:5]
...
; SI-NEXT:    v_cmp_lt_i64_e64 s[6:7], s[4:5], 0
...
; GFX10-NEXT:    v_cmp_lt_i64_e64 s3, s[0:1], 0
...
; GFX11-NEXT:    v_cmp_lt_i64_e64 s4, s[4:5], s[6:7]
; GFX11-NEXT:    v_cmp_lt_i64_e64 s5, s[8:9], 0
...
; SI-NEXT:    v_cmp_gt_i64_e64 s[0:1], 0, v[0:1]
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[8:11], 0
; SI-NEXT:    s_xor_b64 s[0:1], vcc, s[0:1]
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
...
; VI-NEXT:    v_cmp_gt_i64_e64 s[0:1], 0, v[0:1]
...
; GFX10-NEXT:    v_cmp_gt_i64_e64 s0, 0, v[4:5]
