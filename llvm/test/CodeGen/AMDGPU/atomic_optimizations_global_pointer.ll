...
; GFX1164-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc, 0, v8, vcc
...
; GFX1132-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc_lo, 0, v8, vcc_lo
...
; GFX7LESS-NEXT:    s_mov_b32 s7, 0xf000
; GFX7LESS-NEXT:    s_mul_i32 s15, s9, s6
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, s6
; GFX7LESS-NEXT:    v_mul_hi_u32 v0, s8, v0
; GFX7LESS-NEXT:    s_mul_i32 s14, s8, s6
; GFX7LESS-NEXT:    v_add_i32_e32 v5, vcc, s15, v0
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc, s15, v8, vcc
; GFX1164-NEXT:    v_mov_b32_e32 v0, v5
; GFX1164-NEXT:    v_mov_b32_e32 v2, v7
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1164-NEXT:    v_mov_b32_e32 v1, v6
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1132-NEXT:    v_subrev_co_ci_u32_e32 v6, vcc_lo, s13, v8, vcc_lo
; GFX1132-NEXT:    v_mov_b32_e32 v0, v5
; GFX1132-NEXT:    v_dual_mov_b32 v2, v7 :: v_dual_mov_b32 v3, v8
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1132-NEXT:    v_mov_b32_e32 v1, v6
...
; GFX1164_ITERATIVE-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164_ITERATIVE-NEXT:    v_subrev_co_ci_u32_e32 v7, vcc, s9, v9, vcc
...
; GFX1164_ITERATIVE-NEXT:    v_sub_co_ci_u32_e32 v1, vcc, s3, v5, vcc
; GFX1164_ITERATIVE-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1164_ITERATIVE-NEXT:    s_mov_b32 s2, -1
; GFX1164_ITERATIVE-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX1164_ITERATIVE-NEXT:    s_endpgm
...
; GFX1132_ITERATIVE-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1132_ITERATIVE-NEXT:    v_subrev_co_ci_u32_e32 v7, vcc_lo, s9, v9, vcc_lo
...
; GFX1132_ITERATIVE-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, s3, v5, vcc_lo
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s2, -1
; GFX1132_ITERATIVE-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX1132_ITERATIVE-NEXT:    s_endpgm
...
; GFX1164_DPP-NEXT:    v_subrev_co_ci_u32_e32 v9, vcc, s9, v11, vcc
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1132_DPP-NEXT:    v_subrev_co_ci_u32_e32 v11, vcc_lo, s9, v13, vcc_lo
...
; GFX1164-NEXT:    s_cbranch_execz .LBB12_4
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    s_and_b32 s4, s10, -4
; GFX1164-NEXT:    s_mov_b32 s5, s11
; GFX1164-NEXT:    s_and_b32 s1, s10, 3
; GFX1164-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1164-NEXT:    s_lshl_b32 s13, s1, 3
; GFX1164-NEXT:    s_and_b32 s1, s12, 0xff
; GFX1164-NEXT:    s_mov_b64 s[10:11], 0
; GFX1164-NEXT:    s_lshl_b32 s14, s1, s13
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    v_or_b32_e32 v0, s14, v1
...
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    v_cmp_eq_u32_e64 s[0:1], v2, v1
; GFX1164-NEXT:    v_mov_b32_e32 v1, v2
; GFX1164-NEXT:    s_or_b64 s[10:11], s[0:1], s[10:11]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_and_not1_b64 exec, exec, s[10:11]
; GFX1164-NEXT:    s_cbranch_execnz .LBB12_2
; GFX1164-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1164-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX1164-NEXT:    v_lshrrev_b32_e32 v0, s13, v2
; GFX1164-NEXT:  .LBB12_4: ; %Flow
...
; GFX1164-NEXT:    v_cndmask_b32_e64 v0, s12, 0, vcc
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1164-NEXT:    buffer_store_b8 v0, off, s[8:11], 0
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:    s_cbranch_execz .LBB12_4
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    s_and_b32 s4, s10, -4
; GFX1132-NEXT:    s_mov_b32 s5, s11
; GFX1132-NEXT:    s_and_b32 s6, s10, 3
; GFX1132-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1132-NEXT:    s_lshl_b32 s10, s6, 3
; GFX1132-NEXT:    s_and_b32 s6, s1, 0xff
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_lshl_b32 s11, s6, s10
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    v_lshrrev_b32_e32 v0, s10, v2
; GFX1132-NEXT:  .LBB12_4: ; %Flow
...
; GFX1132-NEXT:    v_cndmask_b32_e64 v0, s1, 0, vcc_lo
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1132-NEXT:    buffer_store_b8 v0, off, s[8:11], 0
; GFX1132-NEXT:    s_endpgm
;
...
; GFX1264-NEXT:    s_load_b32 s12, s[4:5], 0x34
...
; GFX1264-NEXT:    s_cbranch_execz .LBB12_4
; GFX1264-NEXT:  ; %bb.1:
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    s_and_b32 s4, s10, -4
; GFX1264-NEXT:    s_mov_b32 s5, s11
; GFX1264-NEXT:    s_and_b32 s1, s10, 3
; GFX1264-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1264-NEXT:    s_lshl_b32 s13, s1, 3
; GFX1264-NEXT:    s_and_b32 s1, s12, 0xff
; GFX1264-NEXT:    s_mov_b64 s[10:11], 0
; GFX1264-NEXT:    s_lshl_b32 s14, s1, s13
; GFX1264-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1264-NEXT:    s_mov_b32 s6, -1
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    v_mov_b32_e32 v1, s0
; GFX1264-NEXT:  .LBB12_2: ; %atomicrmw.start
...
; GFX1264-NEXT:    v_or_b32_e32 v0, s14, v1
...
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    v_cmp_eq_u32_e64 s[0:1], v2, v1
; GFX1264-NEXT:    v_mov_b32_e32 v1, v2
; GFX1264-NEXT:    s_or_b64 s[10:11], s[0:1], s[10:11]
; GFX1264-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1264-NEXT:    s_and_not1_b64 exec, exec, s[10:11]
; GFX1264-NEXT:    s_cbranch_execnz .LBB12_2
; GFX1264-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1264-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX1264-NEXT:    v_lshrrev_b32_e32 v0, s13, v2
; GFX1264-NEXT:  .LBB12_4: ; %Flow
...
; GFX1264-NEXT:    v_cndmask_b32_e64 v0, s12, 0, vcc
; GFX1264-NEXT:    s_wait_alu 0xf1ff
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1264-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1264-NEXT:    buffer_store_b8 v0, off, s[8:11], null
; GFX1264-NEXT:    s_endpgm
;
...
; GFX1232-NEXT:    s_cbranch_execz .LBB12_4
; GFX1232-NEXT:  ; %bb.1:
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    s_and_b32 s4, s10, -4
; GFX1232-NEXT:    s_mov_b32 s5, s11
; GFX1232-NEXT:    s_and_b32 s6, s10, 3
; GFX1232-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1232-NEXT:    s_lshl_b32 s10, s6, 3
; GFX1232-NEXT:    s_and_b32 s6, s1, 0xff
; GFX1232-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1232-NEXT:    s_lshl_b32 s11, s6, s10
; GFX1232-NEXT:    s_mov_b32 s6, -1
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    v_mov_b32_e32 v1, s0
; GFX1232-NEXT:  .LBB12_2: ; %atomicrmw.start
; GFX1232-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1232-NEXT:    v_or_b32_e32 v0, s11, v1
...
; GFX1232-NEXT:    v_cndmask_b32_e64 v0, s1, 0, vcc_lo
; GFX1232-NEXT:    s_wait_alu 0xf1ff
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1232-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1232-NEXT:    buffer_store_b8 v0, off, s[8:11], null
; GFX1232-NEXT:    s_endpgm
...
; GFX1164-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1164-NEXT:    s_lshl_b32 s13, s1, 3
; GFX1164-NEXT:    s_and_b32 s1, 0xffff, s12
; GFX1164-NEXT:    s_mov_b64 s[10:11], 0
; GFX1164-NEXT:    s_lshl_b32 s14, s1, s13
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_mov_b32_e32 v1, s0
; GFX1164-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_or_b32_e32 v0, s14, v1
; GFX1164-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_and_not1_b64 exec, exec, s[10:11]
; GFX1164-NEXT:    s_cbranch_execnz .LBB15_2
; GFX1164-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1164-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX1164-NEXT:    v_lshrrev_b32_e32 v0, s13, v2
; GFX1164-NEXT:  .LBB15_4: ; %Flow
; GFX1164-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1164-NEXT:    buffer_store_b16 v0, off, s[8:11], 0
; GFX1164-NEXT:    s_endpgm
;
...
; GFX1132-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1132-NEXT:    s_lshl_b32 s10, s6, 3
; GFX1132-NEXT:    s_and_b32 s6, 0xffff, s1
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_lshl_b32 s11, s6, s10
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_mov_b32_e32 v1, s0
; GFX1132-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132-NEXT:    v_or_b32_e32 v0, s11, v1
; GFX1132-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, v0
...
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s3
; GFX1132-NEXT:    s_cbranch_execnz .LBB15_2
; GFX1132-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1132-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX1132-NEXT:    v_lshrrev_b32_e32 v0, s10, v2
; GFX1132-NEXT:  .LBB15_4: ; %Flow
; GFX1132-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1132-NEXT:    buffer_store_b16 v0, off, s[8:11], 0
; GFX1132-NEXT:    s_endpgm
;
...
; GFX1264-NEXT:    ; implicit-def: $vgpr0
; GFX1264-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX1264-NEXT:    s_cbranch_execz .LBB15_4
; GFX1264-NEXT:  ; %bb.1:
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    s_and_b32 s4, s10, -4
; GFX1264-NEXT:    s_mov_b32 s5, s11
...
; GFX1264-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1264-NEXT:    s_lshl_b32 s13, s1, 3
; GFX1264-NEXT:    s_and_b32 s1, 0xffff, s12
; GFX1264-NEXT:    s_mov_b64 s[10:11], 0
; GFX1264-NEXT:    s_lshl_b32 s14, s1, s13
; GFX1264-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1264-NEXT:    s_mov_b32 s6, -1
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    v_mov_b32_e32 v1, s0
; GFX1264-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX1264-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1264-NEXT:    v_or_b32_e32 v0, s14, v1
; GFX1264-NEXT:    v_mov_b32_e32 v3, v1
...
; GFX1264-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1264-NEXT:    s_and_not1_b64 exec, exec, s[10:11]
; GFX1264-NEXT:    s_cbranch_execnz .LBB15_2
; GFX1264-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1264-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX1264-NEXT:    v_lshrrev_b32_e32 v0, s13, v2
; GFX1264-NEXT:  .LBB15_4: ; %Flow
; GFX1264-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1264-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1264-NEXT:    buffer_store_b16 v0, off, s[8:11], null
; GFX1264-NEXT:    s_endpgm
;
...
; GFX1232-NEXT:    ; implicit-def: $vgpr0
; GFX1232-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX1232-NEXT:    s_cbranch_execz .LBB15_4
; GFX1232-NEXT:  ; %bb.1:
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    s_and_b32 s4, s10, -4
; GFX1232-NEXT:    s_mov_b32 s5, s11
...
; GFX1232-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1232-NEXT:    s_lshl_b32 s10, s6, 3
; GFX1232-NEXT:    s_and_b32 s6, 0xffff, s1
; GFX1232-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1232-NEXT:    s_lshl_b32 s11, s6, s10
; GFX1232-NEXT:    s_mov_b32 s6, -1
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    v_mov_b32_e32 v1, s0
; GFX1232-NEXT:  .LBB15_2: ; %atomicrmw.start
; GFX1232-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1232-NEXT:    v_or_b32_e32 v0, s11, v1
; GFX1232-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, v0
...
; GFX1232-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1232-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s3
; GFX1232-NEXT:    s_cbranch_execnz .LBB15_2
; GFX1232-NEXT:  ; %bb.3: ; %atomicrmw.end
; GFX1232-NEXT:    s_or_b32 exec_lo, exec_lo, s3
; GFX1232-NEXT:    v_lshrrev_b32_e32 v0, s10, v2
; GFX1232-NEXT:  .LBB15_4: ; %Flow
; GFX1232-NEXT:    s_or_b32 exec_lo, exec_lo, s2
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1232-NEXT:    v_or_b32_e32 v0, s0, v0
; GFX1232-NEXT:    buffer_store_b16 v0, off, s[8:11], null
; GFX1232-NEXT:    s_endpgm
