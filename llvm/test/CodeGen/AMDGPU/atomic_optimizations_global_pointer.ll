...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=-wavefrontsize32,+wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizations=true -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX1164 %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -mattr=+wavefrontsize32,-wavefrontsize64 -mattr=-flat-for-global -amdgpu-atomic-optimizations=true -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX1132 %s
...
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s6, 0
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32_e64 v0, s7, v0
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1164-NEXT:    s_cbranch_execz BB0_2
; GFX1164-NEXT:  ; %bb.1:
...
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s5, 0
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB0_2
; GFX1132-NEXT:  ; %bb.1:
...
; GFX1164-NEXT:    ; implicit-def: $vgpr1
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s2, 0
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32_e64 v0, s3, v0
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX1164-NEXT:    s_cbranch_execz BB1_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
...
; GFX1132-NEXT:    ; implicit-def: $vgpr1
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s2, 0
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB1_2
; GFX1132-NEXT:  ; %bb.1:
...
; GFX1164-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32_e64 v0, exec_hi, v0
...
; GFX1164-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX1164-NEXT:    s_cbranch_execz BB2_2
; GFX1164-NEXT:  ; %bb.1:
...
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX1132-NEXT:    s_or_saveexec_b32 s4, -1
...
; GFX1132-NEXT:    s_cbranch_execz BB2_2
; GFX1132-NEXT:  ; %bb.1:
...
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1164-NEXT:    s_cbranch_execz BB3_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
...
; GFX1164-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1164-NEXT:    buffer_atomic_add_u64 v[1:2], off, s[8:11], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:  BB3_2:
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_readfirstlane_b32 s2, v1
; GFX1164-NEXT:    v_readfirstlane_b32 s3, v2
; GFX1164-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], v0, 5, s[2:3]
; GFX1164-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s2, -1
...
; GFX1132-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1132-NEXT:    buffer_atomic_add_u64 v[1:2], off, s[8:11], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:  BB3_2:
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_readfirstlane_b32 s2, v1
; GFX1132-NEXT:    v_readfirstlane_b32 s3, v2
; GFX1132-NEXT:    v_mad_u64_u32 v[0:1], s2, v0, 5, s[2:3]
; GFX1132-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1132-NEXT:    s_mov_b32 s2, -1
...
; GFX1164-NEXT:    ; implicit-def: $vgpr1_vgpr2
; GFX1164-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s8, 0
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32_e64 v0, s9, v0
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX1164-NEXT:    s_cbranch_execz BB4_2
; GFX1164-NEXT:  ; %bb.1:
...
; GFX1164-NEXT:    v_mov_b32_e32 v2, s10
; GFX1164-NEXT:    s_mov_b32 s10, -1
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_mul_lo_u32 v3, s1, v0
; GFX1164-NEXT:    v_mul_hi_u32 v4, s0, v0
; GFX1164-NEXT:    v_mul_lo_u32 v0, s0, v0
; GFX1164-NEXT:    v_readfirstlane_b32 s0, v1
; GFX1164-NEXT:    v_readfirstlane_b32 s1, v2
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    v_add_nc_u32_e32 v1, v4, v3
; GFX1164-NEXT:    v_add_co_u32_e64 v0, vcc, s0, v0
; GFX1164-NEXT:    v_add_co_ci_u32_e32 v1, vcc, s1, v1, vcc
...
; GFX1132-NEXT:    ; implicit-def: $vgpr1_vgpr2
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, s3, 0
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB4_2
; GFX1132-NEXT:  ; %bb.1:
...
; GFX1132-NEXT:    v_mov_b32_e32 v2, s9
; GFX1132-NEXT:    s_mov_b32 s10, -1
; GFX1132-NEXT:    s_mov_b32 s8, s6
; GFX1132-NEXT:    s_mov_b32 s9, s7
; GFX1132-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_mul_lo_u32 v3, s1, v0
; GFX1132-NEXT:    v_mul_hi_u32 v4, s0, v0
; GFX1132-NEXT:    v_mul_lo_u32 v0, s0, v0
; GFX1132-NEXT:    v_readfirstlane_b32 s0, v1
; GFX1132-NEXT:    v_readfirstlane_b32 s1, v2
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    v_add_nc_u32_e32 v1, v4, v3
; GFX1132-NEXT:    v_add_co_u32_e64 v0, vcc_lo, s0, v0
; GFX1132-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo
...
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1164-NEXT:    s_cbranch_execz BB6_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX1164-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1164-NEXT:    s_mul_i32 s6, s6, 5
...
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB6_2
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1132-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1132-NEXT:    s_mul_i32 s5, s5, 5
...
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX1164-NEXT:    s_cbranch_execz BB7_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
; GFX1164-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB7_2
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    s_bcnt1_i32_b32 s2, s2
; GFX1132-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_and_saveexec_b64 s[8:9], vcc
; GFX1164-NEXT:    s_cbranch_execz BB8_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    v_mov_b32_e32 v0, s4
; GFX1164-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_and_saveexec_b32 s8, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB8_2
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    v_mov_b32_e32 v0, s4
; GFX1132-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX1164-NEXT:    s_cbranch_execz BB9_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s6, s[6:7]
; GFX1164-NEXT:    v_mov_b32_e32 v2, 0
; GFX1164-NEXT:    s_mul_i32 s6, s6, 5
...
; GFX1164-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1164-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1164-NEXT:    buffer_atomic_sub_u64 v[1:2], off, s[8:11], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:  BB9_2:
...
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    v_readfirstlane_b32 s2, v1
; GFX1164-NEXT:    v_mul_u32_u24_e32 v1, 5, v0
; GFX1164-NEXT:    v_readfirstlane_b32 s3, v2
; GFX1164-NEXT:    v_mul_hi_u32_u24_e32 v2, 5, v0
; GFX1164-NEXT:    v_sub_co_u32_e64 v0, vcc, s2, v1
; GFX1164-NEXT:    s_mov_b32 s2, -1
...
; GFX1132-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1132-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1132-NEXT:    buffer_atomic_sub_u64 v[1:2], off, s[8:11], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:  BB9_2:
...
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    v_readfirstlane_b32 s2, v1
; GFX1132-NEXT:    v_mul_u32_u24_e32 v1, 5, v0
; GFX1132-NEXT:    v_readfirstlane_b32 s3, v2
; GFX1132-NEXT:    v_mul_hi_u32_u24_e32 v2, 5, v0
; GFX1132-NEXT:    v_sub_co_u32_e64 v0, vcc_lo, s2, v1
; GFX1132-NEXT:    s_mov_b32 s2, -1
...
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX1164-NEXT:    s_cbranch_execz BB10_2
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s8, s[8:9]
; GFX1164-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    s_mov_b32 s6, -1
; GFX1164-NEXT:    v_add_nc_u32_e32 v1, v4, v3
; GFX1164-NEXT:    v_sub_co_u32_e64 v0, vcc, s0, v0
...
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX1132-NEXT:    s_cbranch_execz BB10_2
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    s_bcnt1_i32_b32 s3, s3
; GFX1132-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132-NEXT:    s_mov_b32 s6, -1
; GFX1132-NEXT:    v_add_nc_u32_e32 v1, v4, v3
; GFX1132-NEXT:    v_sub_co_u32_e64 v0, vcc_lo, s0, v0
