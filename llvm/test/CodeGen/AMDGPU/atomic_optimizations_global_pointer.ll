...
; GFX1064-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX1032-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX1164-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX1132-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX1264-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX1232-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX8-NEXT:    s_load_dword s2, s[2:3], 0x34
...
; GFX8-NEXT:  ; %bb.1:
; GFX8-NEXT:    s_bcnt1_i32_b64 s3, s[8:9]
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_mov_b64 s[8:9], exec
; GFX9-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX9-NEXT:    s_load_dword s10, s[2:3], 0x34
; GFX9-NEXT:    v_mbcnt_lo_u32_b32 v0, s8, 0
; GFX9-NEXT:    v_mbcnt_hi_u32_b32 v0, s9, v0
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX9-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX7LESS_ITERATIVE-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 s[8:9], vcc, -1
; GFX7LESS_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX7LESS_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX7LESS_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX8_ITERATIVE-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX8_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX8_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX8_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX9_ITERATIVE-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX9_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX9_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX9_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX9_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1064_ITERATIVE-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX1064_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1032_ITERATIVE-NEXT:    s_xor_b32 s1, vcc_lo, exec_lo
; GFX1032_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1164_ITERATIVE-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX1164_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1132_ITERATIVE-NEXT:    s_xor_b32 s5, vcc_lo, exec_lo
; GFX1132_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1264_ITERATIVE-NEXT:    s_xor_b64 s[4:5], vcc, exec
; GFX1264_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX1232_ITERATIVE-NEXT:    s_xor_b32 s5, vcc_lo, exec_lo
; GFX1232_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB2_4
...
; GFX8_DPP-NEXT:    s_mov_b64 s[4:5], exec
; GFX8_DPP-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GFX8_DPP-NEXT:    v_mov_b32_e32 v1, 0
; GFX8_DPP-NEXT:    s_mov_b64 exec, s[6:7]
...
; GFX8_DPP-NEXT:    v_readlane_b32 s8, v2, 63
...
; GFX8_DPP-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX8_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX8_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
; GFX8_DPP-NEXT:  ; %bb.1:
; GFX8_DPP-NEXT:    s_mov_b32 s6, s8
...
; GFX9_DPP-NEXT:    s_mov_b64 s[0:1], exec
...
; GFX9_DPP-NEXT:    v_readlane_b32 s8, v2, 63
...
; GFX9_DPP-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX9_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX9_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX9_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
; GFX9_DPP-NEXT:  ; %bb.1:
; GFX9_DPP-NEXT:    s_mov_b32 s2, s8
...
; GFX1064_DPP-NEXT:    s_mov_b64 s[8:9], exec
...
; GFX1064_DPP-NEXT:    v_readlane_b32 s10, v1, 15
...
; GFX1064_DPP-NEXT:    v_writelane_b32 v3, s10, 16
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
...
; GFX1064_DPP-NEXT:    v_readlane_b32 s3, v1, 47
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1064_DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1064_DPP-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX1064_DPP-NEXT:    v_writelane_b32 v3, s3, 48
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1064_DPP-NEXT:    s_mov_b32 s0, s2
; GFX1064_DPP-NEXT:    s_mov_b32 s2, -1
; GFX1064_DPP-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1064_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
...
; GFX1032_DPP-NEXT:    s_mov_b32 s8, exec_lo
...
; GFX1032_DPP-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1032_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
...
; GFX1164_DPP-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1164_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
...
; GFX1132_DPP-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1132_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
...
; GFX1264_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1264_DPP-NEXT:    v_readlane_b32 s6, v1, 47
...
; GFX1264_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1264_DPP-NEXT:    v_writelane_b32 v3, s6, 48
; GFX1264_DPP-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1264_DPP-NEXT:    s_mov_b32 s6, -1
; GFX1264_DPP-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1264_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
; GFX1264_DPP-NEXT:  ; %bb.1:
; GFX1264_DPP-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX1232_DPP-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1232_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_DPP-NEXT:    s_cbranch_scc0 .LBB2_2
...
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, s11, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
...
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v2, s11, v0
; GFX8-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX8-NEXT:    s_mov_b64 s[8:9], exec
; GFX8-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8-NEXT:    ; implicit-def: $vgpr0_vgpr1
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_mov_b32 s12, s6
; GFX8-NEXT:    s_bcnt1_i32_b64 s6, s[10:11]
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], s0, v0, 0
; GFX8-NEXT:    s_mul_i32 s2, s1, s6
; GFX8-NEXT:    s_mov_b32 s15, 0xf000
; GFX8-NEXT:    s_mov_b32 s14, -1
; GFX8-NEXT:    s_mov_b32 s13, s7
...
; GFX9-NEXT:  ; %bb.1:
; GFX9-NEXT:    s_bcnt1_i32_b64 s2, s[10:11]
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s12, s6
; GFX9-NEXT:    s_mul_i32 s3, s1, s2
; GFX9-NEXT:    s_mul_hi_u32 s6, s0, s2
...
; GFX1064-NEXT:  ; %bb.1:
; GFX1064-NEXT:    s_bcnt1_i32_b64 s2, s[10:11]
; GFX1064-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1064-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064-NEXT:    s_mul_i32 s3, s1, s2
; GFX1064-NEXT:    s_mul_hi_u32 s10, s0, s2
; GFX1064-NEXT:    s_mul_i32 s2, s0, s2
; GFX1064-NEXT:    s_add_i32 s10, s10, s3
; GFX1064-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1032-NEXT:  ; %bb.1:
; GFX1032-NEXT:    s_bcnt1_i32_b32 s2, s9
; GFX1032-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1032-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032-NEXT:    s_mul_i32 s3, s1, s2
; GFX1032-NEXT:    s_mul_hi_u32 s9, s0, s2
; GFX1032-NEXT:    s_mul_i32 s2, s0, s2
; GFX1032-NEXT:    s_add_i32 s9, s9, s3
...
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164-NEXT:    v_mbcnt_hi_u32_b32 v2, s11, v0
; GFX1164-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1164-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX1164-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164-NEXT:    s_cmov_b64 exec, vcc
...
; GFX1164-NEXT:  ; %bb.1:
; GFX1164-NEXT:    s_bcnt1_i32_b64 s2, s[10:11]
; GFX1164-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    s_mul_i32 s3, s1, s2
; GFX1164-NEXT:    s_mul_hi_u32 s10, s0, s2
; GFX1164-NEXT:    s_mul_i32 s2, s0, s2
; GFX1164-NEXT:    s_add_i32 s10, s10, s3
...
; GFX1164-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[12:15], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:    buffer_gl0_inv
...
; GFX1132-NEXT:    s_mov_b32 s8, exec_lo
; GFX1132-NEXT:    v_mbcnt_lo_u32_b32 v2, s9, 0
; GFX1132-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v2
; GFX1132-NEXT:    s_cmp_lg_u32 vcc_lo, 0
...
; GFX1132-NEXT:  ; %bb.1:
; GFX1132-NEXT:    s_bcnt1_i32_b32 s2, s9
; GFX1132-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    s_mul_i32 s3, s1, s2
; GFX1132-NEXT:    s_mul_hi_u32 s9, s0, s2
; GFX1132-NEXT:    s_mul_i32 s2, s0, s2
; GFX1132-NEXT:    s_add_i32 s9, s9, s3
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s9
; GFX1132-NEXT:    s_mov_b32 s14, -1
; GFX1132-NEXT:    s_mov_b32 s12, s6
; GFX1132-NEXT:    s_mov_b32 s13, s7
; GFX1132-NEXT:    buffer_atomic_add_u64 v[0:1], off, s[12:15], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:    buffer_gl0_inv
...
; GFX1264-NEXT:    s_mov_b64 s[10:11], exec
; GFX1264-NEXT:    s_mov_b64 s[8:9], exec
; GFX1264-NEXT:    v_mbcnt_lo_u32_b32 v0, s10, 0
; GFX1264-NEXT:    s_mov_b32 s3, 0
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1264-NEXT:    v_mbcnt_hi_u32_b32 v2, s11, v0
; GFX1264-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1264-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX1264-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264-NEXT:    s_cmov_b64 exec, vcc
...
; GFX1264-NEXT:  ; %bb.1:
; GFX1264-NEXT:    s_bcnt1_i32_b64 s2, s[10:11]
; GFX1264-NEXT:    s_mov_b32 s15, 0x31016000
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    s_mul_u64 s[2:3], s[0:1], s[2:3]
...
; GFX7LESS_ITERATIVE-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS_ITERATIVE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX7LESS_ITERATIVE-NEXT:    s_and_b64 s[8:9], vcc, -1
; GFX7LESS_ITERATIVE-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX7LESS_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX7LESS_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX7LESS_ITERATIVE-NEXT:  ; %bb.3:
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s10, -1
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_ITERATIVE-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX8_ITERATIVE-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX8_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX8_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX8_ITERATIVE-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX8_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX8_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX8_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX9_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX9_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX9_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1064_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1064_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1032_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1032_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1164_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX1164_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1164_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1132_ITERATIVE-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX1132_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1132_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1264_ITERATIVE-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX1264_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1264_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX1232_ITERATIVE-NEXT:    s_xor_b32 s6, vcc_lo, exec_lo
; GFX1232_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB5_4
; GFX1232_ITERATIVE-NEXT:  ; %bb.3:
...
; GFX8_DPP-NEXT:    v_addc_u32_e32 v4, vcc, v4, v6, vcc
; GFX8_DPP-NEXT:    v_readlane_b32 s9, v4, 63
; GFX8_DPP-NEXT:    v_readlane_b32 s8, v3, 63
...
; GFX8_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX8_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX8_DPP-NEXT:  ; %bb.1:
; GFX8_DPP-NEXT:    s_mov_b64 s[6:7], s[8:9]
...
; GFX9_DPP-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v6, vcc
; GFX9_DPP-NEXT:    v_readlane_b32 s9, v4, 63
; GFX9_DPP-NEXT:    v_readlane_b32 s8, v3, 63
...
; GFX9_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX9_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX9_DPP-NEXT:  ; %bb.1:
; GFX9_DPP-NEXT:    s_mov_b64 s[2:3], s[8:9]
...
; GFX1064_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1064_DPP-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX1064_DPP-NEXT:    v_readlane_b32 s10, v4, 31
; GFX1064_DPP-NEXT:    v_readlane_b32 s11, v3, 31
...
; GFX1064_DPP-NEXT:    v_readlane_b32 s12, v3, 47
; GFX1064_DPP-NEXT:    v_readlane_b32 s13, v4, 47
; GFX1064_DPP-NEXT:    v_readlane_b32 s3, v4, 63
; GFX1064_DPP-NEXT:    v_writelane_b32 v2, s10, 32
; GFX1064_DPP-NEXT:    v_writelane_b32 v1, s11, 32
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1064_DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1064_DPP-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX1064_DPP-NEXT:    v_writelane_b32 v2, s13, 48
; GFX1064_DPP-NEXT:    v_writelane_b32 v1, s12, 48
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
...
; GFX1064_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1064_DPP-NEXT:  ; %bb.1:
...
; GFX1032_DPP-NEXT:    v_readlane_b32 s9, v4, 15
; GFX1032_DPP-NEXT:    s_mov_b32 exec_lo, s2
; GFX1032_DPP-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1032_DPP-NEXT:    s_or_saveexec_b32 s2, -1
; GFX1032_DPP-NEXT:    v_writelane_b32 v2, s9, 16
...
; GFX1032_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1032_DPP-NEXT:  ; %bb.1:
...
; GFX1164_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1164_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1164_DPP-NEXT:    v_readlane_b32 s10, v4, 31
; GFX1164_DPP-NEXT:    v_writelane_b32 v1, s6, 16
; GFX1164_DPP-NEXT:    v_readlane_b32 s11, v3, 31
; GFX1164_DPP-NEXT:    v_writelane_b32 v2, s7, 16
; GFX1164_DPP-NEXT:    v_readlane_b32 s6, v4, 63
; GFX1164_DPP-NEXT:    v_readlane_b32 s12, v4, 47
; GFX1164_DPP-NEXT:    v_readlane_b32 s13, v3, 47
; GFX1164_DPP-NEXT:    v_writelane_b32 v1, s10, 32
; GFX1164_DPP-NEXT:    v_writelane_b32 v2, s11, 32
; GFX1164_DPP-NEXT:    v_readlane_b32 s7, v3, 63
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1164_DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1164_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1164_DPP-NEXT:    v_writelane_b32 v1, s12, 48
; GFX1164_DPP-NEXT:    v_writelane_b32 v2, s13, 48
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX1164_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1164_DPP-NEXT:  ; %bb.1:
...
; GFX1132_DPP-NEXT:    v_readlane_b32 s9, v3, 15
; GFX1132_DPP-NEXT:    s_mov_b32 exec_lo, s6
; GFX1132_DPP-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1132_DPP-NEXT:    v_writelane_b32 v1, s7, 16
; GFX1132_DPP-NEXT:    v_writelane_b32 v2, s9, 16
; GFX1132_DPP-NEXT:    s_mov_b32 exec_lo, s6
; GFX1132_DPP-NEXT:    s_mov_b32 s6, -1
; GFX1132_DPP-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1132_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1132_DPP-NEXT:  ; %bb.1:
...
; GFX1264_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1264_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1264_DPP-NEXT:    v_readlane_b32 s10, v4, 31
; GFX1264_DPP-NEXT:    v_writelane_b32 v1, s6, 16
; GFX1264_DPP-NEXT:    v_readlane_b32 s11, v3, 31
; GFX1264_DPP-NEXT:    v_writelane_b32 v2, s7, 16
; GFX1264_DPP-NEXT:    v_readlane_b32 s6, v4, 63
; GFX1264_DPP-NEXT:    v_readlane_b32 s12, v4, 47
; GFX1264_DPP-NEXT:    v_readlane_b32 s13, v3, 47
; GFX1264_DPP-NEXT:    v_writelane_b32 v1, s10, 32
; GFX1264_DPP-NEXT:    v_writelane_b32 v2, s11, 32
; GFX1264_DPP-NEXT:    v_readlane_b32 s7, v3, 63
; GFX1264_DPP-NEXT:    s_mov_b64 exec, s[4:5]
; GFX1264_DPP-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX1264_DPP-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX1264_DPP-NEXT:    v_writelane_b32 v1, s12, 48
; GFX1264_DPP-NEXT:    v_writelane_b32 v2, s13, 48
; GFX1264_DPP-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX1264_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1264_DPP-NEXT:  ; %bb.1:
...
; GFX1232_DPP-NEXT:    v_readlane_b32 s9, v3, 15
; GFX1232_DPP-NEXT:    s_mov_b32 exec_lo, s6
; GFX1232_DPP-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1232_DPP-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1232_DPP-NEXT:    v_writelane_b32 v1, s7, 16
; GFX1232_DPP-NEXT:    v_writelane_b32 v2, s9, 16
; GFX1232_DPP-NEXT:    s_mov_b32 exec_lo, s6
; GFX1232_DPP-NEXT:    s_mov_b32 s6, -1
; GFX1232_DPP-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1232_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_DPP-NEXT:    s_cbranch_scc0 .LBB5_2
; GFX1232_DPP-NEXT:  ; %bb.1:
...
; GFX7LESS_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX7LESS_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX7LESS_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX7LESS_ITERATIVE-NEXT:  ; %bb.3:
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s10, -1
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX8_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX8_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX8_ITERATIVE-NEXT:  ; %bb.3:
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s10, -1
; GFX8_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_ITERATIVE-NEXT:    ; implicit-def: $vgpr0
; GFX9_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX9_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX9_ITERATIVE-NEXT:  ; %bb.3:
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s15, 0xf000
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s14, -1
; GFX9_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1064_ITERATIVE-NEXT:  ; %bb.3:
; GFX1064_ITERATIVE-NEXT:    v_mov_b32_e32 v0, s8
; GFX1064_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1064_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1032_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1032_ITERATIVE-NEXT:  ; %bb.3:
; GFX1032_ITERATIVE-NEXT:    v_mov_b32_e32 v0, s0
; GFX1032_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1032_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1164_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1164_ITERATIVE-NEXT:  ; %bb.3:
; GFX1164_ITERATIVE-NEXT:    v_mov_b32_e32 v1, s6
; GFX1164_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1164_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1132_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1132_ITERATIVE-NEXT:  ; %bb.3:
; GFX1132_ITERATIVE-NEXT:    v_mov_b32_e32 v1, s4
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1264_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1264_ITERATIVE-NEXT:  ; %bb.3:
; GFX1264_ITERATIVE-NEXT:    v_mov_b32_e32 v1, s6
; GFX1264_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1264_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1232_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB8_4
; GFX1232_ITERATIVE-NEXT:  ; %bb.3:
; GFX1232_ITERATIVE-NEXT:    v_mov_b32_e32 v1, s4
; GFX1232_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1232_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX8_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX8_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX8_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX8_DPP-NEXT:  ; %bb.1:
; GFX8_DPP-NEXT:    s_mov_b32 s6, s8
; GFX8_DPP-NEXT:    s_mov_b32 s11, 0xf000
; GFX8_DPP-NEXT:    s_mov_b32 s10, -1
...
; GFX9_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX9_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX9_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX9_DPP-NEXT:  ; %bb.1:
; GFX9_DPP-NEXT:    s_mov_b32 s2, s8
; GFX9_DPP-NEXT:    s_mov_b32 s11, 0xf000
; GFX9_DPP-NEXT:    s_mov_b32 s10, -1
...
; GFX1064_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1064_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1064_DPP-NEXT:  ; %bb.1:
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v0, s0
; GFX1064_DPP-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1032_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1032_DPP-NEXT:  ; %bb.1:
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v0, s0
; GFX1032_DPP-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1032_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1164_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1164_DPP-NEXT:  ; %bb.1:
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v0, s7
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1132_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1132_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1132_DPP-NEXT:  ; %bb.1:
; GFX1132_DPP-NEXT:    v_mov_b32_e32 v0, s4
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1264_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1264_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1264_DPP-NEXT:  ; %bb.1:
; GFX1264_DPP-NEXT:    v_mov_b32_e32 v0, s7
; GFX1264_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1264_DPP-NEXT:    s_wait_kmcnt 0x0
...
; GFX1232_DPP-NEXT:    ; implicit-def: $vgpr0
; GFX1232_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_DPP-NEXT:    s_cbranch_scc0 .LBB8_2
; GFX1232_DPP-NEXT:  ; %bb.1:
; GFX1232_DPP-NEXT:    v_mov_b32_e32 v0, s4
; GFX1232_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1232_DPP-NEXT:    s_wait_kmcnt 0x0
...
; GFX1164-NEXT:    s_mov_b32 s12, s6
; GFX1164-NEXT:    s_mov_b32 s13, s7
; GFX1164-NEXT:    buffer_atomic_sub_u64 v[0:1], off, s[12:15], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:    s_or_b64 exec, exec, s[8:9]
...
; GFX1132-NEXT:    s_mov_b32 s12, s6
; GFX1132-NEXT:    s_mov_b32 s13, s7
; GFX1132-NEXT:    buffer_atomic_sub_u64 v[0:1], off, s[12:15], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:    s_or_b32 exec_lo, exec_lo, s8
...
; GFX7LESS_ITERATIVE-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX7LESS_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX7LESS_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX7LESS_ITERATIVE-NEXT:  ; %bb.3:
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX7LESS_ITERATIVE-NEXT:    s_mov_b32 s10, -1
; GFX7LESS_ITERATIVE-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_ITERATIVE-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX8_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX8_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX8_ITERATIVE-NEXT:  ; %bb.3:
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s4
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX8_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX9_ITERATIVE-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX9_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX9_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX9_ITERATIVE-NEXT:  ; %bb.3:
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s1
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s11, 0xf000
; GFX9_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1064_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1064_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1064_ITERATIVE-NEXT:  ; %bb.3:
; GFX1064_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s1
; GFX1064_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s0
; GFX1064_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1032_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1032_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1032_ITERATIVE-NEXT:  ; %bb.3:
; GFX1032_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s1
; GFX1032_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s0
; GFX1032_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1164_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1164_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1164_ITERATIVE-NEXT:  ; %bb.3:
; GFX1164_ITERATIVE-NEXT:    v_mov_b32_e32 v2, s4
; GFX1164_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s5
; GFX1164_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1132_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1132_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1132_ITERATIVE-NEXT:  ; %bb.3:
; GFX1132_ITERATIVE-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1132_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX1264_ITERATIVE-NEXT:    s_cmp_lg_u64 vcc, 0
; GFX1264_ITERATIVE-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1264_ITERATIVE-NEXT:  ; %bb.3:
; GFX1264_ITERATIVE-NEXT:    v_mov_b32_e32 v2, s4
; GFX1264_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s5
; GFX1264_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1232_ITERATIVE-NEXT:    s_cmp_lg_u32 vcc_lo, 0
; GFX1232_ITERATIVE-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_ITERATIVE-NEXT:    s_cbranch_scc0 .LBB11_4
; GFX1232_ITERATIVE-NEXT:  ; %bb.3:
; GFX1232_ITERATIVE-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1232_ITERATIVE-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1232_ITERATIVE-NEXT:    s_mov_b32 s10, -1
...
; GFX8_DPP-NEXT:    ; implicit-def: $vgpr7_vgpr8
; GFX8_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX8_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX8_DPP-NEXT:  ; %bb.1:
; GFX8_DPP-NEXT:    s_mov_b64 s[6:7], s[8:9]
; GFX8_DPP-NEXT:    v_mov_b32_e32 v8, s7
; GFX8_DPP-NEXT:    s_mov_b32 s11, 0xf000
...
; GFX9_DPP-NEXT:    ; implicit-def: $vgpr7_vgpr8
; GFX9_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX9_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX9_DPP-NEXT:  ; %bb.1:
; GFX9_DPP-NEXT:    s_mov_b64 s[2:3], s[8:9]
; GFX9_DPP-NEXT:    v_mov_b32_e32 v8, s3
; GFX9_DPP-NEXT:    s_mov_b32 s11, 0xf000
...
; GFX1064_DPP-NEXT:    ; implicit-def: $vgpr9_vgpr10
; GFX1064_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1064_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1064_DPP-NEXT:  ; %bb.1:
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v10, s1
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v9, s0
; GFX1064_DPP-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1032_DPP-NEXT:    ; implicit-def: $vgpr9_vgpr10
; GFX1032_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1032_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1032_DPP-NEXT:  ; %bb.1:
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v10, s1
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v9, s0
; GFX1032_DPP-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1164_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1164_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1164_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1164_DPP-NEXT:  ; %bb.1:
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v9, s5
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v8, s4
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX1132_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1132_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1132_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1132_DPP-NEXT:  ; %bb.1:
; GFX1132_DPP-NEXT:    v_dual_mov_b32 v9, s5 :: v_dual_mov_b32 v8, s4
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1264_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1264_DPP-NEXT:    s_cmov_b64 exec, vcc
; GFX1264_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1264_DPP-NEXT:  ; %bb.1:
; GFX1264_DPP-NEXT:    v_mov_b32_e32 v9, s5
; GFX1264_DPP-NEXT:    v_mov_b32_e32 v8, s4
; GFX1264_DPP-NEXT:    s_mov_b32 s7, 0x31016000
...
; GFX1232_DPP-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX1232_DPP-NEXT:    s_cmov_b32 exec_lo, vcc_lo
; GFX1232_DPP-NEXT:    s_cbranch_scc0 .LBB11_2
; GFX1232_DPP-NEXT:  ; %bb.1:
; GFX1232_DPP-NEXT:    v_dual_mov_b32 v9, s5 :: v_dual_mov_b32 v8, s4
; GFX1232_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1232_DPP-NEXT:    s_wait_kmcnt 0x0
