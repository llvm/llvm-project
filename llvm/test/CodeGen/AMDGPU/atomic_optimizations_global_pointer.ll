...
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1
; GFX7LESS-NEXT:  .LBB2_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s4, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s4
; GFX7LESS-NEXT:    v_readlane_b32 s7, v0, s4
; GFX7LESS-NEXT:    v_writelane_b32 v1, s6, m0
...
; GFX7LESS-NEXT:    s_add_i32 s6, s6, s7
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB2_1
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB2_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    s_mov_b32 s11, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s10, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    v_add_i32_e32 v0, vcc, s4, v1
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX1064-NEXT:    s_ff1_i32_b64 s6, s[0:1]
...
; GFX7LESS-NEXT:    s_mov_b32 m0, s6
; GFX7LESS-NEXT:    v_readlane_b32 s7, v3, s6
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s6
; GFX7LESS-NEXT:    v_writelane_b32 v2, s5, m0
; GFX7LESS-NEXT:    v_writelane_b32 v1, s4, m0
; GFX7LESS-NEXT:    s_add_u32 s4, s4, s8
; GFX7LESS-NEXT:    s_addc_u32 s5, s5, s7
...
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7LESS-NEXT:    ; implicit-def: $vgpr3_vgpr4
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[6:7], exec, s[6:7]
...
; GFX7LESS-NEXT:    buffer_atomic_add_x2 v[3:4], off, s[8:11], 0 glc
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-NEXT:    buffer_wbinvl1
...
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v4
; GFX7LESS-NEXT:    v_readfirstlane_b32 s5, v3
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s4
; GFX7LESS-NEXT:    v_add_i32_e32 v0, vcc, s5, v1
; GFX7LESS-NEXT:    v_addc_u32_e32 v1, vcc, v3, v2, vcc
; GFX7LESS-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_ff1_i32_b64 s6, s[0:1]
...
; GFX9-NEXT:    v_writelane_b32 v1, s0, m0
; GFX9-NEXT:    s_add_u32 s0, s0, s8
; GFX9-NEXT:    v_writelane_b32 v2, s1, m0
...
; GFX9-NEXT:    v_mov_b32_e32 v3, s0
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, s1, v1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s7, 0xf000
; GFX9-NEXT:    s_mov_b32 s6, -1
...
; GFX1064-NEXT:    v_writelane_b32 v1, s0, s6
; GFX1064-NEXT:    v_writelane_b32 v2, s1, s6
; GFX1064-NEXT:    s_add_u32 s0, s0, s7
; GFX1064-NEXT:    s_addc_u32 s1, s1, s8
...
; GFX1064-NEXT:  ; %bb.3:
; GFX1064-NEXT:    v_mov_b32_e32 v4, s1
...
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    v_add_co_u32 v0, vcc, s0, v1
; GFX1064-NEXT:    v_add_co_ci_u32_e32 v1, vcc, s1, v2, vcc
; GFX1064-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX1032-NEXT:    v_writelane_b32 v1, s0, s5
; GFX1032-NEXT:    v_writelane_b32 v2, s1, s5
; GFX1032-NEXT:    s_add_u32 s0, s0, s6
; GFX1032-NEXT:    s_addc_u32 s1, s1, s7
...
; GFX1032-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX1032-NEXT:    s_and_saveexec_b32 s2, vcc_lo
; GFX1032-NEXT:    s_xor_b32 s2, exec_lo, s2
; GFX1032-NEXT:    s_cbranch_execz .LBB5_4
; GFX1032-NEXT:  ; %bb.3:
; GFX1032-NEXT:    v_mov_b32_e32 v4, s1
...
; GFX1032-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032-NEXT:    s_mov_b32 s6, -1
; GFX1032-NEXT:    v_add_co_u32 v0, vcc_lo, s0, v1
; GFX1032-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s1, v2, vcc_lo
; GFX1032-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX1032-NEXT:    s_endpgm
;
; GFX1164-LABEL: add_i64_varying:
; GFX1164:       ; %bb.0: ; %entry
; GFX1164-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
...
; GFX1164-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1164-NEXT:    s_ctz_i32_b64 s6, s[0:1]
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1164-NEXT:    v_readlane_b32 s7, v2, s6
; GFX1164-NEXT:    v_readlane_b32 s8, v3, s6
; GFX1164-NEXT:    v_writelane_b32 v0, s4, s6
; GFX1164-NEXT:    v_writelane_b32 v1, s5, s6
...
; GFX1164-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX1164-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1164-NEXT:    s_mov_b32 s8, s2
; GFX1164-NEXT:    s_mov_b32 s9, s3
; GFX1164-NEXT:    buffer_atomic_add_u64 v[2:3], off, s[8:11], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:  .LBB5_4:
...
; GFX1164-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_add_co_u32 v0, vcc, s2, v0
; GFX1164-NEXT:    v_add_co_ci_u32_e32 v1, vcc, s3, v1, vcc
; GFX1164-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1164-NEXT:    s_mov_b32 s2, -1
; GFX1164-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX1164-NEXT:    s_nop 0
...
; GFX1132:       ; %bb.0: ; %entry
; GFX1132-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v2, 0x3ff, v0
; GFX1132-NEXT:    s_mov_b32 s0, exec_lo
...
; GFX1132-NEXT:    s_ctz_i32_b32 s1, s0
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    v_readlane_b32 s6, v2, s1
; GFX1132-NEXT:    v_readlane_b32 s7, v3, s1
; GFX1132-NEXT:    v_writelane_b32 v0, s4, s1
; GFX1132-NEXT:    v_writelane_b32 v1, s5, s1
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX1132-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX1132-NEXT:    s_and_saveexec_b32 s6, vcc_lo
...
; GFX1132-NEXT:    s_mov_b32 s8, s2
; GFX1132-NEXT:    s_mov_b32 s9, s3
; GFX1132-NEXT:    buffer_atomic_add_u64 v[2:3], off, s[8:11], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:  .LBB5_4:
...
; GFX1132-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1132-NEXT:    v_add_co_u32 v0, vcc_lo, s2, v0
; GFX1132-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s3, v1, vcc_lo
; GFX1132-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1132-NEXT:    s_mov_b32 s2, -1
; GFX1132-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], 0
; GFX1132-NEXT:    s_nop 0
...
; GFX1264:       ; %bb.0: ; %entry
; GFX1264-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
...
; GFX1264-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1264-NEXT:    s_ctz_i32_b64 s10, s[0:1]
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1264-NEXT:    v_readlane_b32 s7, v3, s10
; GFX1264-NEXT:    v_readlane_b32 s6, v2, s10
; GFX1264-NEXT:    s_lshl_b64 s[8:9], 1, s10
; GFX1264-NEXT:    v_writelane_b32 v1, s5, s10
; GFX1264-NEXT:    v_writelane_b32 v0, s4, s10
; GFX1264-NEXT:    s_and_not1_b64 s[0:1], s[0:1], s[8:9]
; GFX1264-NEXT:    s_add_nc_u64 s[4:5], s[4:5], s[6:7]
; GFX1264-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1264-NEXT:    s_cbranch_scc1 .LBB5_1
; GFX1264-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX1264-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1264-NEXT:    v_mbcnt_lo_u32_b32 v2, exec_lo, 0
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1264-NEXT:    v_mbcnt_hi_u32_b32 v2, exec_hi, v2
; GFX1264-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; GFX1264-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX1264-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GFX1264-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1264-NEXT:    s_xor_b64 s[6:7], exec, s[6:7]
; GFX1264-NEXT:    s_cbranch_execz .LBB5_4
; GFX1264-NEXT:  ; %bb.3:
; GFX1264-NEXT:    v_mov_b32_e32 v2, s4
; GFX1264-NEXT:    v_mov_b32_e32 v3, s5
; GFX1264-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1264-NEXT:    s_mov_b32 s10, -1
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    s_mov_b32 s8, s2
; GFX1264-NEXT:    s_mov_b32 s9, s3
; GFX1264-NEXT:    global_wb scope:SCOPE_DEV
; GFX1264-NEXT:    buffer_atomic_add_u64 v[2:3], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    global_inv scope:SCOPE_DEV
; GFX1264-NEXT:  .LBB5_4:
; GFX1264-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX1264-NEXT:    s_wait_kmcnt 0x0
; GFX1264-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1264-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1264-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1264-NEXT:    v_add_co_u32 v0, vcc, s2, v0
; GFX1264-NEXT:    v_add_co_ci_u32_e32 v1, vcc, s3, v1, vcc
; GFX1264-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1264-NEXT:    s_mov_b32 s2, -1
; GFX1264-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null
; GFX1264-NEXT:    s_nop 0
...
; GFX1232:       ; %bb.0: ; %entry
; GFX1232-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v2, 0x3ff, v0
; GFX1232-NEXT:    s_mov_b32 s0, exec_lo
...
; GFX1232-NEXT:    s_ctz_i32_b32 s1, s0
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1232-NEXT:    v_readlane_b32 s7, v3, s1
; GFX1232-NEXT:    v_readlane_b32 s6, v2, s1
; GFX1232-NEXT:    s_lshl_b32 s8, 1, s1
; GFX1232-NEXT:    v_writelane_b32 v1, s5, s1
; GFX1232-NEXT:    v_writelane_b32 v0, s4, s1
; GFX1232-NEXT:    s_and_not1_b32 s0, s0, s8
...
; GFX1232-NEXT:    ; implicit-def: $vgpr2_vgpr3
; GFX1232-NEXT:    s_and_saveexec_b32 s6, vcc_lo
; GFX1232-NEXT:    s_xor_b32 s6, exec_lo, s6
; GFX1232-NEXT:    s_cbranch_execz .LBB5_4
; GFX1232-NEXT:  ; %bb.3:
; GFX1232-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1232-NEXT:    s_mov_b32 s11, 0x31016000
; GFX1232-NEXT:    s_mov_b32 s10, -1
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    s_mov_b32 s8, s2
; GFX1232-NEXT:    s_mov_b32 s9, s3
; GFX1232-NEXT:    global_wb scope:SCOPE_DEV
; GFX1232-NEXT:    buffer_atomic_add_u64 v[2:3], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1232-NEXT:    s_wait_loadcnt 0x0
; GFX1232-NEXT:    global_inv scope:SCOPE_DEV
; GFX1232-NEXT:  .LBB5_4:
; GFX1232-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; GFX1232-NEXT:    s_wait_kmcnt 0x0
; GFX1232-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1232-NEXT:    v_readfirstlane_b32 s3, v3
; GFX1232-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1232-NEXT:    v_add_co_u32 v0, vcc_lo, s2, v0
; GFX1232-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s3, v1, vcc_lo
; GFX1232-NEXT:    s_mov_b32 s3, 0x31016000
; GFX1232-NEXT:    s_mov_b32 s2, -1
; GFX1232-NEXT:    buffer_store_b64 v[0:1], off, s[0:3], null
; GFX1232-NEXT:    s_nop 0
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB8_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    s_mov_b32 s11, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s10, -1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s4
; GFX7LESS-NEXT:    v_mov_b32_e32 v4, s5
; GFX7LESS-NEXT:    buffer_atomic_sub_x2 v[3:4], off, s[8:11], 0 glc
; GFX7LESS-NEXT:    s_waitcnt vmcnt(0)
; GFX7LESS-NEXT:    buffer_wbinvl1
...
; GFX7LESS-NEXT:    s_waitcnt expcnt(0)
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s4
; GFX7LESS-NEXT:    v_sub_i32_e32 v0, vcc, s5, v1
; GFX7LESS-NEXT:    v_subb_u32_e32 v1, vcc, v3, v2, vcc
; GFX7LESS-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_readfirstlane_b32 s1, v3
; GFX9-NEXT:    v_mov_b32_e32 v3, s0
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s1, v1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s7, 0xf000
; GFX9-NEXT:    s_mov_b32 s6, -1
...
; GFX1064-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064-NEXT:    s_mov_b32 s6, -1
; GFX1064-NEXT:    v_sub_co_u32 v0, vcc, s0, v1
; GFX1064-NEXT:    v_sub_co_ci_u32_e32 v1, vcc, s1, v2, vcc
; GFX1064-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX1064-NEXT:    s_endpgm
;
...
; GFX1032-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032-NEXT:    s_mov_b32 s6, -1
; GFX1032-NEXT:    v_sub_co_u32 v0, vcc_lo, s0, v1
; GFX1032-NEXT:    v_sub_co_ci_u32_e32 v1, vcc_lo, s1, v2, vcc_lo
; GFX1032-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX1032-NEXT:    s_endpgm
;
...
; GFX1164-NEXT:    s_mov_b32 s8, s2
; GFX1164-NEXT:    s_mov_b32 s9, s3
; GFX1164-NEXT:    buffer_atomic_sub_u64 v[2:3], off, s[8:11], 0 glc
; GFX1164-NEXT:    s_waitcnt vmcnt(0)
; GFX1164-NEXT:    buffer_gl1_inv
; GFX1164-NEXT:    buffer_gl0_inv
...
; GFX1132-NEXT:    s_mov_b32 s8, s2
; GFX1132-NEXT:    s_mov_b32 s9, s3
; GFX1132-NEXT:    buffer_atomic_sub_u64 v[2:3], off, s[8:11], 0 glc
; GFX1132-NEXT:    s_waitcnt vmcnt(0)
; GFX1132-NEXT:    buffer_gl1_inv
; GFX1132-NEXT:    buffer_gl0_inv
...
; GFX1264-NEXT:    s_mov_b32 s9, s3
; GFX1264-NEXT:    global_wb scope:SCOPE_DEV
; GFX1264-NEXT:    buffer_atomic_sub_u64 v[2:3], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1264-NEXT:    s_wait_loadcnt 0x0
; GFX1264-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX1232-NEXT:    s_mov_b32 s9, s3
; GFX1232-NEXT:    global_wb scope:SCOPE_DEV
; GFX1232-NEXT:    buffer_atomic_sub_u64 v[2:3], off, s[8:11], null th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1232-NEXT:    s_wait_loadcnt 0x0
; GFX1232-NEXT:    global_inv scope:SCOPE_DEV
