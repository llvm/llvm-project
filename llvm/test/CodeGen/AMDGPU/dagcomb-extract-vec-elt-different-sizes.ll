...
; RUN: llc -mtriple=amdgpu9.0a-amd-amdhsa < %s | FileCheck -enable-var-scope %s
;
...
; CHECK-NEXT:    v_and_b32_e32 v4, 0xff, v8
; CHECK-NEXT:    v_bfe_u32 v5, v8, 8, 8
; CHECK-NEXT:    v_bfe_u32 v6, v8, 16, 8
; CHECK-NEXT:    v_lshrrev_b32_e32 v7, 24, v8
; CHECK-NEXT:    v_and_b32_e32 v0, 0xff, v9
; CHECK-NEXT:    v_bfe_u32 v1, v9, 8, 8
; CHECK-NEXT:    v_bfe_u32 v3, v9, 16, 8
; CHECK-NEXT:    v_lshrrev_b32_e32 v2, 24, v9
...
; CHECK-NEXT:    flat_store_byte v[8:9], v4
; CHECK-NEXT:    flat_store_byte v[10:11], v5
; CHECK-NEXT:    flat_store_byte v[12:13], v6
; CHECK-NEXT:    flat_store_byte v[14:15], v7
; CHECK-NEXT:    flat_store_byte v[16:17], v0
; CHECK-NEXT:    flat_store_byte v[18:19], v1
