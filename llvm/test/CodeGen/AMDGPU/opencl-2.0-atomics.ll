...
; CHECK: %[[CMPXCHG1:[0-9]+]] = cmpxchg i32 addrspace(4)* null, i32 %[[EXPECTED1:[0-9]+]], i32 0 syncscope(2) seq_cst seq_cst
...
; CHECK: %[[CMPXCHG2:[0-9]+]] = cmpxchg i32 addrspace(4)* null, i32 %[[EXPECTED2:[0-9]+]], i32 0 syncscope(4) release acquire
