...
define amdgpu_ps void @test_swmmac_f32_16x16x64_bf16(<16 x i16> %A, <32 x i16> %B, <8 x float> %C, ptr addrspace(1) %IndexVecPtr, ptr addrspace(1) %out) {
...
define amdgpu_ps void @test_swmmac_bf16_16x16x64_bf16(<16 x i16> %A, <32 x i16> %B, <8 x i16> %C, ptr addrspace(1) %IndexVecPtr, ptr addrspace(1) %out) {
...
define amdgpu_ps void @test_swmmac_bf16f32_16x16x64_bf16(<16 x i16> %A, <32 x i16> %B, <8 x float> %C, ptr addrspace(1) %IndexVecPtr, ptr addrspace(1) %out) {
