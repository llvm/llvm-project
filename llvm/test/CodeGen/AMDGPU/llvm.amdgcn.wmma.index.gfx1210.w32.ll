...
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x64_f16 v[24:31], v[0:7], v[8:23], v32 index_key:1
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x64_bf16 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
bb:
  ...
  %IndexVec = bitcast i32 %IndexVecPacked to <2 x i16>
  %Index = extractelement <2 x i16> %IndexVec, i32 1
  %res = call <8 x float> @llvm.amdgcn.swmmac.f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.v8f32.i16(i1 0, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f16_16x16x64_f16 v[24:27], v[0:7], v[8:23], v28 index_key:1
...
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_bf16_16x16x64_bf16 v[24:27], v[0:7], v[8:23], v28 index_key:1
; GFX1210-NEXT:    global_store_b128 v[30:31], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
bb:
  ...
  %IndexVec = bitcast i32 %IndexVecPacked to <2 x i16>
  %Index = extractelement <2 x i16> %IndexVec, i32 1
  %res = call <8 x bfloat> @llvm.amdgcn.swmmac.bf16.16x16x64.bf16.v8bf16.v16bf16.v32bf16.v8bf16.i16(i1 0, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x bfloat> %C, i16 %Index)
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_bf16f32_16x16x64_bf16 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
bb:
  ...
  %IndexVec = bitcast i32 %IndexVecPacked to <2 x i16>
  %Index = extractelement <2 x i16> %IndexVec, i32 1
  %res = call <8 x float> @llvm.amdgcn.swmmac.bf16f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.v8f32.i16(i1 0, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x128_fp8_fp8 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x128_fp8_bf8 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x128_bf8_fp8 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f32_16x16x128_bf8_bf8 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f16_16x16x128_fp8_fp8 v[24:27], v[0:7], v[8:23], v28 index_key:1
; GFX1210-NEXT:    global_store_b128 v[30:31], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f16_16x16x128_fp8_bf8 v[24:27], v[0:7], v[8:23], v28 index_key:1
; GFX1210-NEXT:    global_store_b128 v[30:31], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f16_16x16x128_bf8_fp8 v[24:27], v[0:7], v[8:23], v28 index_key:1
; GFX1210-NEXT:    global_store_b128 v[30:31], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_f16_16x16x128_bf8_bf8 v[24:27], v[0:7], v[8:23], v28 index_key:1
; GFX1210-NEXT:    global_store_b128 v[30:31], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_i32_16x16x128_iu8 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_swmmac_i32_16x16x256_iu4 v[24:31], v[0:7], v[8:23], v32 index_key:1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[34:35], v[28:31], off offset:16
; GFX1210-NEXT:    global_store_b128 v[34:35], v[24:27], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
