...
; GFX11-NEXT:    s_clz_i32_u32 s3, s2
; GFX11-NEXT:    s_cmp_lg_u32 s2, 0
; GFX11-NEXT:    s_cselect_b32 s2, s3, 32
...
; GFX11-NEXT:    v_clz_i32_u32_e32 v1, v0
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 32, v1, vcc_lo
...
; GFX11-NEXT:    v_clz_i32_u32_e32 v3, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 32, v2, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 32, v3, vcc_lo
...
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    v_ffbh_u32_e32 v4, v0
; GFX10-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX10-GISEL-NEXT:    v_ffbh_u32_e32 v5, v1
; GFX10-GISEL-NEXT:    v_ffbh_u32_e32 v6, v2
; GFX10-GISEL-NEXT:    v_ffbh_u32_e32 v7, v3
...
; GFX11-NEXT:    v_clz_i32_u32_e32 v6, v2
; GFX11-NEXT:    v_clz_i32_u32_e32 v7, v1
; GFX11-NEXT:    v_clz_i32_u32_e32 v8, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v3, 32, v5, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; GFX11-NEXT:    v_cndmask_b32_e32 v2, 32, v6, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v1
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 32, v7, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 32, v8, vcc_lo
...
; GFX10-NEXT:    s_flbit_i32_b32 s1, s3
...
; GFX10-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX10-NEXT:    v_cndmask_b32_e32 v0, 64, v1, vcc_lo
; GFX10-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 64, v1, vcc_lo
; GFX11-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX10-GISEL-NEXT:    v_and_b32_e32 v1, s2, v1
; GFX10-GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, s2, vcc_lo
...
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 32, v2, vcc_lo
; GFX11-NEXT:    v_add_nc_u32_e32 v1, -16, v1
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 0xffff, v1, vcc_lo
