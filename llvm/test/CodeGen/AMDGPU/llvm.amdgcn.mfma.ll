...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_4x4x1f32 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 4
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 3
...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_16x16x4f32 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x4_f32 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 9
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_4x4x4f16 v[4:7], v[4:5], v[6:7], v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 4
; GFX90A-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x4_16b_f16 v[4:7], v[4:5], v[6:7], v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 4
...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[10:11], s[10:11] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_16x16x16f16 v[4:7], v[4:5], v[6:7], v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 10
; GFX90A-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[10:11]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[4:5], v[6:7], v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 6
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_i32_4x4x4i8 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 4
; GFX90A-NEXT:    global_store_dwordx4 v8, v[4:7], s[6:7]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_i32_4x4x4_16b_i8 v[4:7], v4, v5, v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 4
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_mfma_f32_4x4x1f32 v[4:7], v4, v5, v[0:3]
; GFX90A-NEXT:    s_nop 4
; GFX90A-NEXT:    global_store_dwordx4 v8, v[4:7], s[6:7]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[4:7], v4, v5, v[0:3]
; GFX942-NEXT:    s_nop 3
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_mov_b32_e32 v8, 0
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_4x4x1f32 v[4:7], v0, v1, v[0:3]
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_nop 3
; GFX90A-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX90A-NEXT:    s_endpgm
...
; GFX942-NEXT:    v_mov_b32_e32 v8, 0
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[4:7], v0, v1, v[0:3]
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_nop 2
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX942-NEXT:    s_endpgm
...
; GFX90A-NEXT:    v_pk_mov_b32 v[62:63], v[30:31], v[30:31] op_sel:[0,1]
; GFX90A-NEXT:    v_mov_b32_e32 v64, 2.0
; GFX90A-NEXT:    v_pk_mov_b32 v[60:61], v[28:29], v[28:29] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[58:59], v[26:27], v[26:27] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[56:57], v[24:25], v[24:25] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[54:55], v[22:23], v[22:23] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[52:53], v[20:21], v[20:21] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[50:51], v[18:19], v[18:19] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[48:49], v[16:17], v[16:17] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[46:47], v[14:15], v[14:15] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[44:45], v[12:13], v[12:13] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[42:43], v[10:11], v[10:11] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[40:41], v[8:9], v[8:9] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[38:39], v[6:7], v[6:7] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[36:37], v[4:5], v[4:5] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[34:35], v[2:3], v[2:3] op_sel:[0,1]
; GFX90A-NEXT:    v_pk_mov_b32 v[32:33], v[0:1], v[0:1] op_sel:[0,1]
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_nop 0
; GFX90A-NEXT:    v_mfma_f32_32x32x1f32 v[32:63], v0, v64, v[32:63]
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_nop 15
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    global_store_dwordx4 v1, v[60:63], s[0:1] offset:112
; GFX90A-NEXT:    global_store_dwordx4 v1, v[56:59], s[0:1] offset:96
; GFX90A-NEXT:    global_store_dwordx4 v1, v[52:55], s[0:1] offset:80
; GFX90A-NEXT:    global_store_dwordx4 v1, v[48:51], s[0:1] offset:64
; GFX90A-NEXT:    global_store_dwordx4 v1, v[44:47], s[0:1] offset:48
; GFX90A-NEXT:    global_store_dwordx4 v1, v[40:43], s[0:1] offset:32
; GFX90A-NEXT:    global_store_dwordx4 v1, v[36:39], s[0:1] offset:16
; GFX90A-NEXT:    global_store_dwordx4 v1, v[32:35], s[0:1]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    v_mov_b64_e32 v[62:63], v[30:31]
; GFX942-NEXT:    v_mov_b32_e32 v64, 2.0
; GFX942-NEXT:    v_mov_b64_e32 v[60:61], v[28:29]
; GFX942-NEXT:    v_mov_b64_e32 v[58:59], v[26:27]
; GFX942-NEXT:    v_mov_b64_e32 v[56:57], v[24:25]
; GFX942-NEXT:    v_mov_b64_e32 v[54:55], v[22:23]
; GFX942-NEXT:    v_mov_b64_e32 v[52:53], v[20:21]
; GFX942-NEXT:    v_mov_b64_e32 v[50:51], v[18:19]
; GFX942-NEXT:    v_mov_b64_e32 v[48:49], v[16:17]
; GFX942-NEXT:    v_mov_b64_e32 v[46:47], v[14:15]
; GFX942-NEXT:    v_mov_b64_e32 v[44:45], v[12:13]
; GFX942-NEXT:    v_mov_b64_e32 v[42:43], v[10:11]
; GFX942-NEXT:    v_mov_b64_e32 v[40:41], v[8:9]
; GFX942-NEXT:    v_mov_b64_e32 v[38:39], v[6:7]
; GFX942-NEXT:    v_mov_b64_e32 v[36:37], v[4:5]
; GFX942-NEXT:    v_mov_b64_e32 v[34:35], v[2:3]
; GFX942-NEXT:    v_mov_b64_e32 v[32:33], v[0:1]
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[32:63], v0, v64, v[32:63]
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_nop 15
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    global_store_dwordx4 v1, v[60:63], s[0:1] offset:112
; GFX942-NEXT:    global_store_dwordx4 v1, v[56:59], s[0:1] offset:96
; GFX942-NEXT:    global_store_dwordx4 v1, v[52:55], s[0:1] offset:80
; GFX942-NEXT:    global_store_dwordx4 v1, v[48:51], s[0:1] offset:64
; GFX942-NEXT:    global_store_dwordx4 v1, v[44:47], s[0:1] offset:48
; GFX942-NEXT:    global_store_dwordx4 v1, v[40:43], s[0:1] offset:32
; GFX942-NEXT:    global_store_dwordx4 v1, v[36:39], s[0:1] offset:16
; GFX942-NEXT:    global_store_dwordx4 v1, v[32:35], s[0:1]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_lshlrev_b32_e32 v8, 4, v0
...
; GFX942-NEXT:    v_lshlrev_b32_e32 v8, 4, v0
