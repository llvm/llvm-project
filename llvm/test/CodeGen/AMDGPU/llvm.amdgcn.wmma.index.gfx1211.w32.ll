...
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    global_load_b32 v32, v[32:33], off
; GFX1211-NEXT:    s_wait_loadcnt 0x0
; GFX1211-NEXT:    v_swmmac_f32_16x16x64_f16 v[24:31], v[0:7], v[8:23], v32 index_key:1
...
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    global_load_b32 v28, v[28:29], off
; GFX1211-NEXT:    s_wait_loadcnt 0x0
; GFX1211-NEXT:    v_swmmac_f16_16x16x64_f16 v[24:27], v[0:7], v[8:23], v28 index_key:1
