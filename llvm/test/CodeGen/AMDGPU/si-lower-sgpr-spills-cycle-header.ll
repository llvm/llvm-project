...
define amdgpu_kernel void @loop_sgpr_spill_implicit_def_in_preheader(
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   dead renamable $sgpr4_64 = S_LOAD_DWORDX2_IMM renamable $sgpr8_64, 0, 0 :: (dereferenceable invariant load (s64) from constant-pool, align 16, addrspace 4)
  ; CHECK-NEXT:   renamable $sgpr4_64 = S_LOAD_DWORDX2_IMM killed renamable $sgpr8_64, 0, 0 :: (dereferenceable invariant load (s64) from %ir.out.kernarg.offset, align 16, addrspace 4)
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:vgpr_32 = IMPLICIT_DEF
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:vgpr_32 = SI_SPILL_S32_TO_VGPR $sgpr4, 0, [[DEF]], implicit-def $sgpr4_64, implicit $sgpr4_64
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:vgpr_32 = SI_SPILL_S32_TO_VGPR killed $sgpr5, 1, [[DEF]], implicit killed $sgpr4_64
  ; CHECK-NEXT:   renamable $sgpr4_64 = IMPLICIT_DEF
  ; CHECK-NEXT:   renamable $sgpr4 = S_LOAD_DWORD_IMM killed renamable $sgpr4_64, 0, 0 :: (load (s32) from `ptr addrspace(4) poison`, addrspace 4)
  ...
  ; CHECK-NEXT:   renamable $sgpr4_64 = S_MOV_B64 -1
  ; CHECK-NEXT:   renamable $sgpr7 = S_MOV_B32 0
  ; CHECK-NEXT:   S_CMP_EQ_U32 renamable $sgpr6, killed renamable $sgpr7, implicit-def $scc
  ; CHECK-NEXT:   renamable $sgpr6_64 = S_CSELECT_B64 -1, 0, implicit killed $scc
  ; CHECK-NEXT:   renamable $sgpr6_64 = S_XOR_B64 killed renamable $sgpr6_64, renamable $sgpr4_64, implicit-def dead $scc
  ; CHECK-NEXT:   renamable $vcc = S_AND_B64 $exec, killed renamable $sgpr6_64, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   renamable $sgpr6 = IMPLICIT_DEF
  ; CHECK-NEXT:   renamable $sgpr6 = IMPLICIT_DEF
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:vgpr_32 = SI_SPILL_S32_TO_VGPR $sgpr4, 21, [[DEF]], implicit-def $sgpr4_64, implicit $sgpr4_64
  ; CHECK-NEXT:   [[DEF:%[0-9]+]]:vgpr_32 = SI_SPILL_S32_TO_VGPR killed $sgpr5, 22, [[DEF]], implicit killed $sgpr4_64
  ...
  ; CHECK-NEXT:   renamable $sgpr4_64 = S_MOV_B64 0
  ...
  ; CHECK-NEXT:   renamable $sgpr4_64 = S_MOV_B64 -1
  ; CHECK-NEXT:   renamable $vcc = S_XOR_B64 killed renamable $vcc, killed renamable $sgpr4_64, implicit-def dead $scc
  ...
  ; CHECK-NEXT:   $sgpr4 = SI_RESTORE_S32_FROM_VGPR [[DEF]], 0, implicit-def $sgpr4_64
  ...
  ; CHECK-NEXT:   GLOBAL_STORE_DWORD_SADDR [[V_MOV_B32_e32_]], [[COPY]], killed renamable $sgpr4_64, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 1)
