...
; RUN: llc -march=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GFX9,GFX9_1210 %s
; RUN: llc -march=amdgcn -mcpu=gfx1210 < %s | FileCheck -check-prefixes=GCN,GFX1210,GFX9_1210 %s
