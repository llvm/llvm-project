...
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; GFX950-SDAG-NEXT:    flat_load_dword v5, v[2:3] offset:40
; GFX950-SDAG-NEXT:    s_mov_b64 s[2:3], 0
; GFX950-SDAG-NEXT:  .LBB118_1: ; %atomicrmw.start
; GFX950-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_max_f32_e32 v4, v5, v0
; GFX950-SDAG-NEXT:    flat_atomic_cmpswap v1, v[2:3], v[4:5] offset:40 sc0
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GFX950-SDAG-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v5, v1
...
; GFX950-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_min_f32_e32 v4, v5, v0
; GFX950-SDAG-NEXT:    flat_atomic_cmpswap v1, v[2:3], v[4:5] offset:40 sc0
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GFX950-SDAG-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-SDAG-NEXT:    v_pk_max_num_f16 v4, v5, v0
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
...
; GFX950-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_pk_max_f16 v4, v5, v0
; GFX950-SDAG-NEXT:    flat_atomic_cmpswap v1, v[2:3], v[4:5] offset:40 sc0
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GFX950-SDAG-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1250-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_max_num_f16 v2, v3, v0
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
...
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v5, v1
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-SDAG-NEXT:    v_pk_min_num_f16 v4, v5, v0
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    flat_atomic_cmpswap_b32 v1, v2, v[4:5], s[0:1] offset:40 th:TH_ATOMIC_RETURN
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX950-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_pk_min_f16 v4, v5, v0
; GFX950-SDAG-NEXT:    flat_atomic_cmpswap v1, v[2:3], v[4:5] offset:40 sc0
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v5
; GFX950-SDAG-NEXT:    s_or_b64 s[2:3], vcc, s[2:3]
...
; GFX1250-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_min_num_f16 v2, v3, v0
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    flat_atomic_cmpswap_b32 v2, v1, v[2:3], s[0:1] offset:40 th:TH_ATOMIC_RETURN
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
