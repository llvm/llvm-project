...
; GFX1250-SDAG-NEXT:    ; implicit-def: $vgpr0_64
...
; GFX1250-SDAG-NEXT:    global_inv scope:SCOPE_DEV
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    ; implicit-def: $vgpr4_64
; GFX1250-SDAG-NEXT:    ; implicit-def: $vgpr2_64
; GFX1250-SDAG-NEXT:    s_and_not1_saveexec_b32 s0, s0
...
; GFX1250-GISEL-NEXT:    ; implicit-def: $vgpr0_64
...
; GFX1250-GISEL-NEXT:    ; implicit-def: $vgpr4_64
; GFX1250-GISEL-NEXT:    s_and_not1_saveexec_b32 s0, s0
...
; GFX950-SDAG-NEXT:    ; implicit-def: $vgpr0_64
...
; GFX950-SDAG-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-SDAG-NEXT:    buffer_inv sc1
; GFX950-SDAG-NEXT:    ; implicit-def: $vgpr4_64
; GFX950-SDAG-NEXT:    ; implicit-def: $vgpr2_64
; GFX950-SDAG-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
...
; GFX950-GISEL-NEXT:    ; implicit-def: $vgpr0_64
...
; GFX950-GISEL-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX950-GISEL-NEXT:    buffer_inv sc1
; GFX950-GISEL-NEXT:    ; implicit-def: $vgpr2_64
; GFX950-GISEL-NEXT:    ; implicit-def: $vgpr4_64
; GFX950-GISEL-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
...
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    ; implicit-def: $vgpr2_64
; GFX1250-SDAG-NEXT:    ; implicit-def: $vgpr6_64
; GFX1250-SDAG-NEXT:    s_and_not1_saveexec_b32 s0, s0
...
; GFX1250-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX1250-GISEL-NEXT:    ; implicit-def: $vgpr2
; GFX1250-GISEL-NEXT:    ; implicit-def: $vgpr8_64
; GFX1250-GISEL-NEXT:    s_and_not1_saveexec_b32 s0, s0
...
; GFX950-SDAG-NEXT:    buffer_inv sc0 sc1
; GFX950-SDAG-NEXT:    ; implicit-def: $vgpr2_64
; GFX950-SDAG-NEXT:    ; implicit-def: $vgpr6_64
; GFX950-SDAG-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
...
; GFX950-GISEL-NEXT:    buffer_inv sc0 sc1
; GFX950-GISEL-NEXT:    ; implicit-def: $vgpr2_64
; GFX950-GISEL-NEXT:    ; implicit-def: $vgpr8_64
; GFX950-GISEL-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
...
; GFX1250-GISEL-NEXT:    ; implicit-def: $vgpr2_64
