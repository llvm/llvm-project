...
; RUN: llc -mtriple=amdgpu12.00 -misched-cluster=0 < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -mtriple=amdgpu12.00 -misched-cluster=0 -amdgpu-igrouplp-exact-solver-max-branches=250000 < %s | FileCheck -check-prefix=EXACTCUTOFF %s
; RUN: llc -mtriple=amdgpu12.50 -amdgpu-sched-strategy=coexec -enable-post-misched=0 < %s | FileCheck -check-prefix=COEXEC %s
...
; COEXEC-NEXT:    s_wait_kmcnt 0x0
; COEXEC-NEXT:    v_dual_mov_b32 v17, s1 :: v_dual_bitop2_b32 v0, s2, v0 bitop3:0x40
