...
; RUN: llc -mtriple=amdgpu6.00-amd- -O0 < %s | FileCheck --check-prefixes=GFX6 %s
; RUN: llc -mtriple=amdgpu7.00-amd-amdhsa -O0 < %s | FileCheck --check-prefixes=GFX7 %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -O0 < %s | FileCheck --check-prefixes=GFX10-WGP %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -O0 -mattr=+cumode < %s | FileCheck --check-prefixes=GFX10-CU %s
; RUN: llc -mtriple=amdgpu7.00-amd-amdpal -O0 -amdgcn-skip-cache-invalidations < %s | FileCheck --check-prefixes=SKIP-CACHE-INV %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -O0 < %s | FileCheck --check-prefixes=GFX11-WGP %s
...
; GFX6-NEXT:    ; kill: def $sgpr0 killed $sgpr0 killed $sgpr0_1
; GFX6-NEXT:    s_mov_b32 s5, 0xf000
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    ; kill: def $sgpr0 killed $sgpr0 def $sgpr0_3
...
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr0 killed $sgpr0 killed $sgpr0_1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s5, 0xf000
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s6, -1
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr0 killed $sgpr0 def $sgpr0_3
