...
define amdgpu_kernel void @private_volatile_load_0(
  ; GFX6-LABEL: name: private_volatile_load_0
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1, $sgpr3
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   $sgpr4 = S_MOV_B32 &SCRATCH_RSRC_DWORD0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr5 = S_MOV_B32 &SCRATCH_RSRC_DWORD1, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset, addrspace 4)
  ...
  ; GFX6-NEXT:   $sgpr6 = S_MOV_B32 4294967295, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr7 = S_MOV_B32 15265792, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr4 = S_ADD_U32 killed $sgpr4, killed $sgpr3, implicit-def $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr5 = S_ADDC_U32 killed $sgpr5, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX6-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX7-LABEL: name: private_volatile_load_0
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX7-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ...
  ; GFX7-NEXT:   $sgpr8 = S_ADD_U32 killed $sgpr8, killed $sgpr7, implicit-def $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX7-NEXT:   $sgpr9 = S_ADDC_U32 killed $sgpr9, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX7-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr2, implicit $exec, implicit $exec
  ; GFX7-NEXT:   renamable $vgpr2 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX10-WGP-LABEL: name: private_volatile_load_0
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-WGP-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ...
  ; GFX10-WGP-NEXT:   $sgpr8 = S_ADD_U32 killed $sgpr8, killed $sgpr7, implicit-def $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-WGP-NEXT:   $sgpr9 = S_ADDC_U32 killed $sgpr9, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-WGP-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 5, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX10-CU-LABEL: name: private_volatile_load_0
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-CU-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ...
  ; GFX10-CU-NEXT:   $sgpr8 = S_ADD_U32 killed $sgpr8, killed $sgpr7, implicit-def $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-CU-NEXT:   $sgpr9 = S_ADDC_U32 killed $sgpr9, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-CU-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 5, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; SKIP-CACHE-INV-LABEL: name: private_volatile_load_0
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $sgpr0_sgpr1, $sgpr3, $sgpr0
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5 = S_GETPC_B64
  ; SKIP-CACHE-INV-NEXT:   $sgpr4 = S_MOV_B32 $sgpr0
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5_sgpr6_sgpr7 = S_LOAD_DWORDX4_IMM killed $sgpr4_sgpr5, 0, 0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7 :: (dereferenceable invariant load (s128), align 4, addrspace 4)
  ...
  ; SKIP-CACHE-INV-NEXT:   $sgpr4 = S_ADD_U32 killed $sgpr4, killed $sgpr3, implicit-def $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; SKIP-CACHE-INV-NEXT:   $sgpr5 = S_ADDC_U32 killed $sgpr5, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; SKIP-CACHE-INV-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX11-WGP-LABEL: name: private_volatile_load_0
  ...
  ; GFX11-WGP-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SADDR killed renamable $sgpr2, 0, 5, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX11-CU-LABEL: name: private_volatile_load_0
  ; GFX11-CU: bb.0.entry:
  ...
  ; GFX11-CU-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SADDR killed renamable $sgpr2, 0, 5, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX12-WGP-LABEL: name: private_volatile_load_0
  ...
  ; GFX12-WGP-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SADDR killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.in.load, addrspace 5)
  ...
  ;
  ; GFX12-CU-LABEL: name: private_volatile_load_0
  ; GFX12-CU: bb.0.entry:
  ...
  ; GFX12-CU-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SADDR killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.in.load, addrspace 5)
...
define amdgpu_kernel void @private_volatile_load_1(
  ; GFX6-LABEL: name: private_volatile_load_1
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1, $sgpr3
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   $sgpr4 = S_MOV_B32 &SCRATCH_RSRC_DWORD0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr5 = S_MOV_B32 &SCRATCH_RSRC_DWORD1, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset, addrspace 4)
  ...
  ; GFX6-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX6-NEXT:   S_WAITCNT_soft 3952
  ; GFX6-NEXT:   renamable $sgpr3 = S_MOV_B32 61440
  ; GFX6-NEXT:   renamable $sgpr2 = S_MOV_B32 -1
  ; GFX6-NEXT:   BUFFER_STORE_DWORD_OFFSET killed renamable $vgpr0, killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, 0, 0, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: private_volatile_load_1
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX7-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX7-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX7-NEXT:   renamable $vgpr2 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX7-NEXT:   S_WAITCNT_soft 3952
  ; GFX7-NEXT:   $vgpr0 = V_MOV_B32_e32 $sgpr0, implicit $exec, implicit-def $vgpr0_vgpr1, implicit $sgpr0_sgpr1
  ; GFX7-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $sgpr0_sgpr1, implicit $exec
  ; GFX7-NEXT:   FLAT_STORE_DWORD killed renamable $vgpr0_vgpr1, killed renamable $vgpr2, 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: private_volatile_load_1
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-WGP-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX10-WGP-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-WGP-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 5, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX10-WGP-NEXT:   S_WAITCNT_soft 16240
  ; GFX10-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: private_volatile_load_1
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ; GFX10-CU-NEXT:   $sgpr8_sgpr9 = S_MOV_B64 killed $sgpr0_sgpr1, implicit $sgpr0_sgpr1_sgpr2_sgpr3
  ; GFX10-CU-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-CU-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 5, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX10-CU-NEXT:   S_WAITCNT_soft 16240
  ; GFX10-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: private_volatile_load_1
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1, $sgpr3, $sgpr0
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5 = S_GETPC_B64
  ; SKIP-CACHE-INV-NEXT:   $sgpr4 = S_MOV_B32 $sgpr0
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5_sgpr6_sgpr7 = S_LOAD_DWORDX4_IMM killed $sgpr4_sgpr5, 0, 0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7 :: (dereferenceable invariant load (s128), align 4, addrspace 4)
  ...
  ; SKIP-CACHE-INV-NEXT:   $sgpr4 = S_ADD_U32 killed $sgpr4, killed $sgpr3, implicit-def $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; SKIP-CACHE-INV-NEXT:   $sgpr5 = S_ADDC_U32 killed $sgpr5, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; SKIP-CACHE-INV-NEXT:   renamable $vgpr0 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 1, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; SKIP-CACHE-INV-NEXT:   S_WAITCNT_soft 3952
  ; SKIP-CACHE-INV-NEXT:   renamable $sgpr3 = S_MOV_B32 61440
  ; SKIP-CACHE-INV-NEXT:   renamable $sgpr2 = S_MOV_B32 -1
  ; SKIP-CACHE-INV-NEXT:   BUFFER_STORE_DWORD_OFFSET killed renamable $vgpr0, killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, 0, 0, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: private_volatile_load_1
  ; GFX11-WGP: bb.0.entry:
  ...
  ; GFX11-WGP-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD killed renamable $vgpr0, 0, 5, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX11-WGP-NEXT:   S_WAITCNT_soft 1015
  ; GFX11-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: private_volatile_load_1
  ; GFX11-CU: bb.0.entry:
  ...
  ; GFX11-CU-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD killed renamable $vgpr0, 0, 5, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX11-CU-NEXT:   S_WAITCNT_soft 1015
  ; GFX11-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: private_volatile_load_1
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ; GFX12-WGP-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ; GFX12-WGP-NEXT:   renamable $vgpr1, renamable $vgpr0 = V_DUAL_MOV_B32_e32_X_LSHLREV_B32_e32_gfx12 0, 2, killed $vgpr0, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-WGP-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 8, 0 :: (dereferenceable invariant load (s64) from %ir.out.kernarg.offset, addrspace 4)
  ; GFX12-WGP-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SVS killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX12-WGP-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: private_volatile_load_1
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ; GFX12-CU-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s32) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ; GFX12-CU-NEXT:   renamable $vgpr1, renamable $vgpr0 = V_DUAL_MOV_B32_e32_X_LSHLREV_B32_e32_gfx12 0, 2, killed $vgpr0, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-CU-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 8, 0 :: (dereferenceable invariant load (s64) from %ir.out.kernarg.offset, addrspace 4)
  ; GFX12-CU-NEXT:   renamable $vgpr0 = SCRATCH_LOAD_DWORD_SVS killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile load (s32) from %ir.val.gep, addrspace 5)
  ; GFX12-CU-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
...
define amdgpu_kernel void @private_volatile_store_0(
  ; GFX6-LABEL: name: private_volatile_store_0
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1, $sgpr3
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   $sgpr4 = S_MOV_B32 &SCRATCH_RSRC_DWORD0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ...
  ; GFX6-NEXT:   $sgpr7 = S_MOV_B32 15265792, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   $sgpr4 = S_ADD_U32 killed $sgpr4, killed $sgpr3, implicit-def $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset, align 4, addrspace 4)
  ; GFX6-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 11, 0 :: (dereferenceable invariant load (s32) from %ir.out.kernarg.offset, addrspace 4)
  ; GFX6-NEXT:   $sgpr5 = S_ADDC_U32 killed $sgpr5, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr2_sgpr3, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ...
  ; GFX6-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr0, killed renamable $vgpr1, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX6-NEXT:   S_WAITCNT_soft 3952
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: private_volatile_store_0
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX7-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr0, killed renamable $vgpr1, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX7-NEXT:   S_WAITCNT_soft 3952
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: private_volatile_store_0
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-WGP-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr0, killed renamable $vgpr1, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX10-WGP-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: private_volatile_store_0
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-CU-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr0, killed renamable $vgpr1, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX10-CU-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: private_volatile_store_0
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $sgpr0_sgpr1, $sgpr3, $sgpr0
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5 = S_GETPC_B64
  ...
  ; SKIP-CACHE-INV-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr0, killed renamable $vgpr1, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; SKIP-CACHE-INV-NEXT:   S_WAITCNT_soft 3952
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: private_volatile_store_0
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ...
  ; GFX11-WGP-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX11-WGP-NEXT:   SCRATCH_STORE_DWORD_SADDR killed renamable $vgpr0, killed renamable $sgpr0, 0, 4, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX11-WGP-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: private_volatile_store_0
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ...
  ; GFX11-CU-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX11-CU-NEXT:   SCRATCH_STORE_DWORD_SADDR killed renamable $vgpr0, killed renamable $sgpr0, 0, 4, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX11-CU-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: private_volatile_store_0
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ...
  ; GFX12-WGP-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX12-WGP-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   SCRATCH_STORE_DWORD_SADDR killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: private_volatile_store_0
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ...
  ; GFX12-CU-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX12-CU-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-CU-NEXT:   SCRATCH_STORE_DWORD_SADDR killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.load, addrspace 5)
  ; GFX12-CU-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-CU-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @private_volatile_store_1(
  ; GFX6-LABEL: name: private_volatile_store_1
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1, $sgpr3
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   $sgpr4 = S_MOV_B32 &SCRATCH_RSRC_DWORD0, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ...
  ; GFX6-NEXT:   $sgpr5 = S_ADDC_U32 killed $sgpr5, 0, implicit-def dead $scc, implicit killed $scc, implicit-def $sgpr4_sgpr5_sgpr6_sgpr7
  ; GFX6-NEXT:   renamable $sgpr1 = S_LOAD_DWORD_IMM killed renamable $sgpr2_sgpr3, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ; GFX6-NEXT:   renamable $vgpr0 = V_ADD_CO_U32_e32 killed $sgpr0, killed $vgpr0, implicit-def dead $vcc, implicit $exec
  ; GFX6-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX6-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr1, killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX6-NEXT:   S_WAITCNT_soft 3952
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: private_volatile_store_1
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX7-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr1, killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX7-NEXT:   S_WAITCNT_soft 3952
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: private_volatile_store_1
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-WGP-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr1, killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX10-WGP-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: private_volatile_store_1
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5, $sgpr0_sgpr1_sgpr2_sgpr3, $sgpr7
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   $sgpr10_sgpr11 = S_MOV_B64 $sgpr2_sgpr3, implicit $sgpr0_sgpr1_sgpr2_sgpr3, implicit-def $sgpr8_sgpr9_sgpr10_sgpr11
  ...
  ; GFX10-CU-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr1, killed renamable $vgpr0, killed $sgpr8_sgpr9_sgpr10_sgpr11, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX10-CU-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: private_volatile_store_1
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1, $sgpr3, $sgpr0
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   $sgpr4_sgpr5 = S_GETPC_B64
  ...
  ; SKIP-CACHE-INV-NEXT:   BUFFER_STORE_DWORD_OFFEN killed renamable $vgpr1, killed renamable $vgpr0, killed $sgpr4_sgpr5_sgpr6_sgpr7, 0, 0, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; SKIP-CACHE-INV-NEXT:   S_WAITCNT_soft 3952
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: private_volatile_store_1
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ; GFX11-WGP-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-WGP-NEXT:   SCRATCH_STORE_DWORD killed renamable $vgpr1, killed renamable $vgpr0, 0, 4, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX11-WGP-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: private_volatile_store_1
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ; GFX11-CU-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-CU-NEXT:   SCRATCH_STORE_DWORD killed renamable $vgpr1, killed renamable $vgpr0, 0, 4, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX11-CU-NEXT:   S_WAITCNT_VSCNT_soft undef $sgpr_null, 0
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: private_volatile_store_1
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ; GFX12-WGP-NEXT:   renamable $sgpr0_sgpr1_sgpr2 = S_LOAD_DWORDX3_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s96) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ; GFX12-WGP-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ; GFX12-WGP-NEXT:   $vgpr1, renamable $vgpr0 = V_DUAL_MOV_B32_e32_X_LSHLREV_B32_e32_gfx12 killed $sgpr0, 2, killed $vgpr0, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-WGP-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   SCRATCH_STORE_DWORD_SVS killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: private_volatile_store_1
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ; GFX12-CU-NEXT:   renamable $sgpr0_sgpr1_sgpr2 = S_LOAD_DWORDX3_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s96) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ; GFX12-CU-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ; GFX12-CU-NEXT:   $vgpr1, renamable $vgpr0 = V_DUAL_MOV_B32_e32_X_LSHLREV_B32_e32_gfx12 killed $sgpr0, 2, killed $vgpr0, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX12-CU-NEXT:   S_WAIT_LOADCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_SAMPLECNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_BVHCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-CU-NEXT:   SCRATCH_STORE_DWORD_SVS killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr2, 0, 24, implicit $exec, implicit $flat_scr :: (volatile store (s32) into %ir.out.gep, addrspace 5)
  ; GFX12-CU-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-CU-NEXT:   S_ENDPGM 0
    ptr addrspace(1) %in, ptr addrspace(5) %out) {
entry:
