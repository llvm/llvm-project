...
; GFX7:       ; %bb.0: ; %entry
; GFX7-NEXT:    s_mov_b64 s[18:19], s[2:3]
; GFX7-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX7-NEXT:    s_load_dword s2, s[6:7], 0x0
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x2
; GFX7-NEXT:    s_add_u32 s16, s16, s13
; GFX7-NEXT:    s_addc_u32 s17, s17, 0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v0, s2
; GFX7-NEXT:    buffer_load_dword v2, v0, s[16:19], 0 offen glc
...
; GFX10-WGP-NEXT:    s_mov_b64 s[18:19], s[2:3]
; GFX10-WGP-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX10-WGP-NEXT:    s_clause 0x1
; GFX10-WGP-NEXT:    s_load_dword s2, s[6:7], 0x0
; GFX10-WGP-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x8
; GFX10-WGP-NEXT:    s_add_u32 s16, s16, s13
; GFX10-WGP-NEXT:    s_addc_u32 s17, s17, 0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-WGP-NEXT:    buffer_load_dword v0, v0, s[16:19], 0 offen glc dlc
...
; GFX10-CU:       ; %bb.0: ; %entry
; GFX10-CU-NEXT:    s_mov_b64 s[18:19], s[2:3]
; GFX10-CU-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX10-CU-NEXT:    s_clause 0x1
; GFX10-CU-NEXT:    s_load_dword s2, s[6:7], 0x0
; GFX10-CU-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x8
; GFX10-CU-NEXT:    s_add_u32 s16, s16, s13
; GFX10-CU-NEXT:    s_addc_u32 s17, s17, 0
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-CU-NEXT:    buffer_load_dword v0, v0, s[16:19], 0 offen glc dlc
...
; GFX11-WGP-NEXT:    s_load_b32 s4, s[2:3], 0x0
; GFX11-WGP-NEXT:    s_load_b64 s[0:1], s[2:3], 0x8
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    scratch_load_b32 v0, off, s4 glc dlc
...
; GFX11-CU-NEXT:    s_load_b32 s4, s[2:3], 0x0
; GFX11-CU-NEXT:    s_load_b64 s[0:1], s[2:3], 0x8
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    scratch_load_b32 v0, off, s4 glc dlc
...
; GFX12-WGP-NEXT:    scratch_load_b32 v0, off, s4 scope:SCOPE_SYS
...
; GFX12-CU-NEXT:    scratch_load_b32 v0, off, s4 scope:SCOPE_SYS
...
; GFX11-WGP-NEXT:    s_load_b32 s4, s[2:3], 0x0
; GFX11-WGP-NEXT:    s_load_b64 s[0:1], s[2:3], 0x8
; GFX11-WGP-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-WGP-NEXT:    v_lshl_add_u32 v0, v0, 2, s4
...
; GFX11-CU-NEXT:    s_load_b32 s4, s[2:3], 0x0
; GFX11-CU-NEXT:    s_load_b64 s[0:1], s[2:3], 0x8
; GFX11-CU-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-CU-NEXT:    v_lshl_add_u32 v0, v0, 2, s4
...
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    scratch_load_b32 v0, v0, s4 scope:SCOPE_SYS
; GFX12-WGP-NEXT:    s_wait_loadcnt 0x0
; GFX12-WGP-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX12-WGP-NEXT:    s_nop 0
; GFX12-WGP-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    scratch_load_b32 v0, v0, s4 scope:SCOPE_SYS
; GFX12-CU-NEXT:    s_wait_loadcnt 0x0
; GFX12-CU-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX12-CU-NEXT:    s_nop 0
; GFX12-CU-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX6-NEXT:    s_load_dword s2, s[2:3], 0xb
; GFX6-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; GFX6-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; GFX6-NEXT:    s_mov_b32 s14, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_mov_b64 s[18:19], s[2:3]
; GFX7-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
; GFX7-NEXT:    s_load_dword s2, s[6:7], 0x2
; GFX7-NEXT:    s_add_u32 s16, s16, s13
; GFX7-NEXT:    s_addc_u32 s17, s17, 0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-NEXT:    buffer_store_dword v0, v1, s[16:19], 0 offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX10-WGP-NEXT:    s_clause 0x1
; GFX10-WGP-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
; GFX10-WGP-NEXT:    s_load_dword s2, s[6:7], 0x8
; GFX10-WGP-NEXT:    s_add_u32 s16, s16, s13
; GFX10-WGP-NEXT:    s_addc_u32 s17, s17, 0
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-WGP-NEXT:    buffer_store_dword v0, v1, s[16:19], 0 offen
...
; GFX10-CU-NEXT:    s_mov_b64 s[16:17], s[0:1]
; GFX10-CU-NEXT:    s_clause 0x1
; GFX10-CU-NEXT:    s_load_dwordx2 s[0:1], s[6:7], 0x0
; GFX10-CU-NEXT:    s_load_dword s2, s[6:7], 0x8
; GFX10-CU-NEXT:    s_add_u32 s16, s16, s13
; GFX10-CU-NEXT:    s_addc_u32 s17, s17, 0
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-CU-NEXT:    buffer_store_dword v0, v1, s[16:19], 0 offen
...
; GFX11-WGP-NEXT:    scratch_store_b32 off, v0, s2 dlc
...
; GFX11-CU-NEXT:    scratch_store_b32 off, v0, s2 dlc
; GFX11-CU-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-CU-NEXT:    s_endpgm
;
; GFX12-WGP-LABEL: private_volatile_store_0:
; GFX12-WGP:       ; %bb.0: ; %entry
; GFX12-WGP-NEXT:    s_load_b96 s[0:2], s[2:3], 0x0
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-CU:       ; %bb.0: ; %entry
; GFX12-CU-NEXT:    s_load_b96 s[0:2], s[2:3], 0x0
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
...
; GFX6-NEXT:    buffer_store_dword v1, v0, s[12:15], 0 offen
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    buffer_store_dword v1, v0, s[16:19], 0 offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    buffer_store_dword v1, v0, s[16:19], 0 offen
; GFX10-WGP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    buffer_store_dword v1, v0, s[16:19], 0 offen
; GFX10-CU-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v1, v0, s[12:15], 0 offen
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX11-WGP-NEXT:    s_load_b32 s0, s[0:1], 0x0
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-WGP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-CU-NEXT:    s_load_b32 s0, s[0:1], 0x0
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-CU-NEXT:    s_delay_alu instid0(VALU_DEP_1)
