...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-gfx1250-b0-specific=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG,GFX1250-A0 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-gfx1250-b0-specific=1 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG,GFX1250-B0 %s
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b8_vaddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b8 v2, v[0:1], off offset:16 th:TH_LOAD_NT
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b8_vaddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b8_vaddr_imm_mask:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b8 v2, v[0:1], off offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b8_vaddr_imm_mask:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b8_saddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b8 v0, v1, s[0:1] offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b8_saddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b8 v0, v1, s[0:1] offset:16
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b32_vaddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b32 v2, v[0:1], off offset:16 th:TH_LOAD_HT scope:SCOPE_SE
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b32_vaddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b32_vaddr_imm_mask:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b32 v2, v[0:1], off offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b32_vaddr_imm_mask:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-B0-NEXT:    s_mov_b32 m0, 15
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b32_saddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b32 v0, v1, s[0:1] offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b32_saddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b32 v0, v1, s[0:1] offset:16
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b64_vaddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b64 v2, v[0:1], off offset:16 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b64_vaddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b64_vaddr_imm_mask:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b64 v2, v[0:1], off offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b64_vaddr_imm_mask:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b64_saddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b64 v0, v1, s[0:1] offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b64_saddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b64 v0, v1, s[0:1] offset:16
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b128_vaddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b128 v2, v[0:1], off offset:16 th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b128_vaddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b128_vaddr_imm_mask:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b128 v2, v[0:1], off offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b128_vaddr_imm_mask:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1250-B0-NEXT:    s_movk_i32 m0, 0x7f
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b128_saddr:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b128 v0, v1, s[0:1] offset:16
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b128_saddr:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_mov_b32_e32 v1, 32
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b128 v0, v1, s[0:1] offset:16
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b32_saddr_scale_offset:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b32 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b32_saddr_scale_offset:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b32 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b64_saddr_scale_offset:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b64 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b64_saddr_scale_offset:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b64 v0, v1, s[0:1] offset:16 scale_offset th:TH_LOAD_NT
; GFX1250-B0-NEXT:    s_endpgm
;
...
; GFX1250-A0-LABEL: cluster_load_async_to_lds_b64_saddr_no_scale_offset:
; GFX1250-A0:       ; %bb.0: ; %entry
; GFX1250-A0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-A0-NEXT:    v_mov_b32_e32 v2, v1
; GFX1250-A0-NEXT:    s_mov_b32 m0, 0
; GFX1250-A0-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-A0-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX1250-A0-NEXT:    v_lshl_add_u64 v[2:3], v[2:3], 2, s[0:1]
; GFX1250-A0-NEXT:    cluster_load_async_to_lds_b64 v0, v[2:3], off offset:16 th:TH_LOAD_NT
; GFX1250-A0-NEXT:    s_endpgm
;
; GFX1250-B0-LABEL: cluster_load_async_to_lds_b64_saddr_no_scale_offset:
; GFX1250-B0:       ; %bb.0: ; %entry
; GFX1250-B0-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1
; GFX1250-B0-NEXT:    v_mov_b32_e32 v2, v1
; GFX1250-B0-NEXT:    s_mov_b32 m0, s2
; GFX1250-B0-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-B0-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX1250-B0-NEXT:    v_lshl_add_u64 v[2:3], v[2:3], 2, s[0:1]
; GFX1250-B0-NEXT:    cluster_load_async_to_lds_b64 v0, v[2:3], off offset:16 th:TH_LOAD_NT
; GFX1250-B0-NEXT:    s_endpgm
;
