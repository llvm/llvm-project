...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1250 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1250 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1300 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1300,GFX1300-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1300 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1300,GFX1300-GISEL %s
...
; GFX1250-GISEL-NEXT:    v_readfirstlane_b32 m0, v3
...
; GFX1300-SDAG-NEXT:    v_add_nc_u64_e32 v[0:1], 32, v[0:1]
; GFX1300-SDAG-NEXT:    v_readfirstlane_b32 s0, v3
; GFX1300-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-SDAG-NEXT:    s_mov_b32 m0, s0
...
; GFX1300-GISEL-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX1300-GISEL-NEXT:    v_readfirstlane_b32 m0, v3
...
; GFX1300-SDAG-NEXT:    s_endpgm
;
; GFX1300-GISEL-LABEL: cluster_load_async_to_lds_b8_saddr:
; GFX1300-GISEL:       ; %bb.0: ; %entry
; GFX1300-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v1, 32
; GFX1300-GISEL-NEXT:    global_load_async_mcast_to_lds_b8 v0, v1, s[0:1] offset:16
; GFX1300-GISEL-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1300-SDAG-NEXT:    s_endpgm
;
; GFX1300-GISEL-LABEL: cluster_load_async_to_lds_b32_saddr:
; GFX1300-GISEL:       ; %bb.0: ; %entry
; GFX1300-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v1, 32
; GFX1300-GISEL-NEXT:    global_load_async_mcast_to_lds_b32 v0, v1, s[0:1] offset:16
; GFX1300-GISEL-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1300-SDAG-NEXT:    s_endpgm
;
; GFX1300-GISEL-LABEL: cluster_load_async_to_lds_b64_saddr:
; GFX1300-GISEL:       ; %bb.0: ; %entry
; GFX1300-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v1, 32
; GFX1300-GISEL-NEXT:    global_load_async_mcast_to_lds_b64 v0, v1, s[0:1] offset:16
; GFX1300-GISEL-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1300-SDAG-NEXT:    s_endpgm
;
; GFX1300-GISEL-LABEL: cluster_load_async_to_lds_b128_saddr:
; GFX1300-GISEL:       ; %bb.0: ; %entry
; GFX1300-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX1300-GISEL-NEXT:    v_mov_b32_e32 v1, 32
; GFX1300-GISEL-NEXT:    global_load_async_mcast_to_lds_b128 v0, v1, s[0:1] offset:16
; GFX1300-GISEL-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1300-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-GISEL-NEXT:    v_add_co_u32 v2, vcc_lo, v4, v2
; GFX1300-GISEL-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v5, v3, vcc_lo
