...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -enable-misched=0 -enable-post-misched=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -enable-misched=0 -enable-post-misched=0 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
