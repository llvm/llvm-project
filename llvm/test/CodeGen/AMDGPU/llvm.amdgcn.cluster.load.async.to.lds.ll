...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG,GFX1250-A0 %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -amdgpu-gfx1250-b0-specific < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG,GFX1250-B0 %s
