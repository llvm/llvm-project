...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1300 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1300 -enable-misched=0 -enable-post-misched=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
