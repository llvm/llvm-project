...
; GFX1210-NEXT:    cluster_load_async_to_lds_b8 v0, v1, s[0:1] offset:16
...
; GFX1210-NEXT:    v_mov_b32_e32 v1, 32
; GFX1210-NEXT:    s_mov_b32 m0, s2
; GFX1210-NEXT:    cluster_load_async_to_lds_b32 v0, v1, s[0:1] offset:16
; GFX1210-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1210-NEXT:    v_mov_b32_e32 v1, 32
; GFX1210-NEXT:    s_mov_b32 m0, s2
; GFX1210-NEXT:    cluster_load_async_to_lds_b64 v0, v1, s[0:1] offset:16
; GFX1210-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
...
; GFX1210-NEXT:    v_mov_b32_e32 v1, 32
; GFX1210-NEXT:    s_mov_b32 m0, s2
; GFX1210-NEXT:    cluster_load_async_to_lds_b128 v0, v1, s[0:1] offset:16
; GFX1210-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %gaddr, i32 4
