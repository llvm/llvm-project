...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -O0 -mcpu=gfx1210 < %s | FileCheck --check-prefixes=GFX1210-CU %s
...
; GFX1210-CU-NEXT:    s_load_b32 s1, s[2:3], 0x0
; GFX1210-CU-NEXT:    s_load_b32 s0, s[2:3], 0x4
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s1
; GFX1210-CU-NEXT:    ds_load_b32 v1, v0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s1
; GFX1210-CU-NEXT:    s_wait_storecnt 0x0
; GFX1210-CU-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-CU-NEXT:    ds_load_b32 v1, v0
; GFX1210-CU-NEXT:    s_wait_dscnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX1210-CU-NEXT:    ds_store_b32 v0, v1
...
; GFX1210-CU:       ; %bb.0: ; %entry
; GFX1210-CU-NEXT:    s_load_b32 s0, s[2:3], 0x0
; GFX1210-CU-NEXT:    s_load_b32 s1, s[2:3], 0x4
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s1
; GFX1210-CU-NEXT:    v_mov_b32_e32 v1, s0
; GFX1210-CU-NEXT:    ds_store_b32 v0, v1
; GFX1210-CU-NEXT:    s_endpgm
...
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX1210-CU:       ; %bb.0: ; %entry
; GFX1210-CU-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX1210-CU-NEXT:    s_wait_alu 0xfffe
; GFX1210-CU-NEXT:    s_load_b32 s2, s[4:5], 0x0
; GFX1210-CU-NEXT:    s_load_b32 s1, s[4:5], 0x4
; GFX1210-CU-NEXT:    s_load_b32 s0, s[4:5], 0x8
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-CU-NEXT:    v_mov_b32_e32 v1, s1
; GFX1210-CU-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX1210-CU-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX1210-CU-NEXT:    s_wait_alu 0xfffe
; GFX1210-CU-NEXT:    s_load_b32 s0, s[4:5], 0x0
; GFX1210-CU-NEXT:    s_load_b32 s2, s[4:5], 0x4
; GFX1210-CU-NEXT:    s_load_b32 s1, s[4:5], 0x8
; GFX1210-CU-NEXT:    s_wait_kmcnt 0x0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX1210-CU-NEXT:    v_mov_b32_e32 v1, s2
; GFX1210-CU-NEXT:    v_mov_b32_e32 v2, s1
