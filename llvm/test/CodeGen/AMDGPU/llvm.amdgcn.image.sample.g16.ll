...
; GFX12PLUS-NEXT:    image_sample_d_g16 v[0:3], [v0, v2, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_mov_b32_e32 v9, v8
; GFX13-NEXT:    v_mov_b32_e32 v8, v7
; GFX13-NEXT:    v_mov_b32_e32 v7, v6
; GFX13-NEXT:    v_mov_b32_e32 v6, v5
; GFX13-NEXT:    v_perm_b32 v3, v4, v3, 0x5040100
; GFX13-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX13-NEXT:    image_sample_d_g16 v[0:3], [v0, v2, v3, v[6:9]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
...
; GFX13-NEXT:    image_sample_c_d_g16 v[0:3], [v0, v1, v3, v[6:7]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_perm_b32 v0, v1, v0, 0x5040100
; GFX13-NEXT:    image_sample_d_cl_g16 v[0:3], [v0, v2, v4, v[6:7]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_perm_b32 v3, v4, v3, 0x5040100
; GFX13-NEXT:    v_perm_b32 v1, v2, v1, 0x5040100
; GFX13-NEXT:    image_sample_c_d_cl_g16 v[0:3], [v0, v1, v3, v[6:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_mov_b32_e32 v8, v7
; GFX13-NEXT:    v_mov_b32_e32 v7, v6
; GFX13-NEXT:    v_perm_b32 v6, v5, v4, 0x5040100
; GFX13-NEXT:    v_perm_b32 v2, v3, v2, 0x5040100
; GFX13-NEXT:    image_sample_c_d_o_g16 v0, [v0, v1, v2, v[6:9]], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    v_perm_b32 v6, v5, v4, 0x5040100
; GFX13-NEXT:    v_perm_b32 v2, v3, v2, 0x5040100
; GFX13-NEXT:    image_sample_c_d_o_g16 v[0:1], [v0, v1, v2, v[6:9]], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
