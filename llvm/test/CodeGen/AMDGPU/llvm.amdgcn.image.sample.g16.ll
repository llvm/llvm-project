...
; GFX10-NEXT:    image_sample_d_g16 v[0:3], [v4, v5, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v1
; GFX11-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v4, v5, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v1
; GFX12-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v4, v5, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
...
; GFX10-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v6, v1, 16, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v7, v3, 16, v2
; GFX11-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v6, v1, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v7, v3, 16, v2
; GFX12-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v6, v7, v4, v5], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v10, s0, 16, v2
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, v4, 16, v3
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v5
; GFX11-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v9, v10, v4, v5, v[6:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v9, v1, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v10, s0, 16, v2
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v4, v4, 16, v3
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v5
; GFX12-FAKE16-NEXT:    image_sample_d_g16 v[0:3], [v9, v10, v4, v[5:8]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_3D
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    image_sample_d_cl_g16 v[0:3], [v5, v4, v2, v3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v1
; GFX11-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v4, v5, v2, v3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v4, s0, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v5, s0, 16, v1
; GFX12-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v4, v5, v2, v3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_1D
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
...
; GFX10-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX11-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v5, v6], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
...
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX12-FAKE16-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v7, v1, 16, v0
; GFX12-FAKE16-NEXT:    v_lshl_or_b32 v8, v3, 16, v2
; GFX12-FAKE16-NEXT:    image_sample_d_cl_g16 v[0:3], [v7, v8, v4, v[5:6]], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    ; return to shader part epilog
main_body:
