...
; GFX11-SDAG-NEXT:    v_cmp_gt_f16_e32 vcc_lo, 0, v2
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_cmp_gt_f16_e64 s0, 0, v1
...
; GFX11-SDAG-NEXT:    v_cmp_gt_f16_e64 s0, 0, v0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-SDAG-NEXT:    v_cmp_gt_f16_e64 s1, 0, v2
; GFX11-SDAG-NEXT:    v_cmp_gt_f16_e64 s2, 0, v3
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b32 s0, vcc_lo, s0
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b32 s0, s1, s2
; GFX11-SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s0
; GFX11-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
