...
; GCN-NEXT:    v_add_u32_e32 v0, s6, v1
...
; GCN-NEXT:    v_add_u32_e32 v1, s7, v1
...
; GCN-NEXT:    v_mul_f32_e32 v1, s1, v2
; GCN-NEXT:    v_rndne_f32_e32 v3, v1
; GCN-NEXT:    v_sub_f32_e32 v9, v1, v3
; GCN-NEXT:    v_fma_f32 v1, s1, v2, -v1
; GCN-NEXT:    v_fmac_f32_e32 v1, s1, v6
; GCN-NEXT:    v_add_f32_e32 v1, v9, v1
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v5, v1, a[0:31]
...
; GCN-NEXT:    v_ldexp_f32 v0, v2, v3
; GCN-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GCN-NEXT:    v_cmp_ngt_f32_e32 vcc, s0, v7
; GCN-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_nop 0
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v5, v0, a[0:31]
; GCN-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; GCN-NEXT:    s_nop 15
; GCN-NEXT:    s_nop 2
...
; EXACTCUTOFF-NEXT:    v_ldexp_f32 v0, v2, v3
