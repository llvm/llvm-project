...
; GCN-NEXT:    v_sub_i32_e32 v8, vcc, 0, v0
; GCN-NEXT:    v_max_i32_e32 v8, v0, v8
; GCN-NEXT:    v_cvt_f32_u32_e32 v9, v8
; GCN-NEXT:    v_sub_i32_e32 v14, vcc, 0, v8
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_sub_i32_e32 v10, vcc, 0, v4
; GCN-NEXT:    v_rcp_iflag_f32_e32 v9, v9
; GCN-NEXT:    v_xor_b32_e32 v0, v4, v0
...
; GCN-NEXT:    v_xor_b32_e32 v11, v5, v1
; GCN-NEXT:    v_max_i32_e32 v1, v1, v13
; GCN-NEXT:    v_cvt_f32_u32_e32 v13, v1
; GCN-NEXT:    v_mul_lo_u32 v14, v14, v9
; GCN-NEXT:    v_sub_i32_e32 v17, vcc, 0, v2
; GCN-NEXT:    v_xor_b32_e32 v15, v6, v2
; GCN-NEXT:    v_mul_hi_u32 v14, v9, v14
; GCN-NEXT:    v_max_i32_e32 v2, v2, v17
; GCN-NEXT:    v_cvt_f32_u32_e32 v17, v2
; GCN-NEXT:    v_sub_i32_e32 v12, vcc, 0, v5
; GCN-NEXT:    v_add_i32_e32 v9, vcc, v9, v14
; GCN-NEXT:    v_mul_hi_u32 v9, v4, v9
; GCN-NEXT:    v_max_i32_e32 v5, v5, v12
; GCN-NEXT:    v_sub_i32_e32 v16, vcc, 0, v6
; GCN-NEXT:    v_mul_lo_u32 v14, v9, v8
; GCN-NEXT:    v_add_i32_e32 v18, vcc, 1, v9
; GCN-NEXT:    v_max_i32_e32 v6, v6, v16
; GCN-NEXT:    v_sub_i32_e32 v4, vcc, v4, v14
; GCN-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v8
; GCN-NEXT:    v_cndmask_b32_e64 v9, v9, v18, s[0:1]
; GCN-NEXT:    v_sub_i32_e32 v18, vcc, v4, v8
; GCN-NEXT:    v_cndmask_b32_e64 v4, v4, v18, s[0:1]
; GCN-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v8
; GCN-NEXT:    v_rcp_iflag_f32_e32 v4, v13
; GCN-NEXT:    v_sub_i32_e32 v14, vcc, 0, v1
; GCN-NEXT:    v_sub_i32_e32 v13, vcc, 0, v2
; GCN-NEXT:    v_mul_f32_e32 v4, 0x4f7ffffe, v4
; GCN-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GCN-NEXT:    v_sub_i32_e32 v10, vcc, 0, v3
; GCN-NEXT:    v_max_i32_e32 v10, v3, v10
; GCN-NEXT:    v_mul_lo_u32 v8, v14, v4
; GCN-NEXT:    v_add_i32_e32 v18, vcc, 1, v9
; GCN-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GCN-NEXT:    v_mul_hi_u32 v8, v4, v8
; GCN-NEXT:    v_ashrrev_i32_e32 v11, 31, v11
; GCN-NEXT:    v_xor_b32_e32 v3, v7, v3
; GCN-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; GCN-NEXT:    v_rcp_iflag_f32_e32 v8, v17
; GCN-NEXT:    v_mul_hi_u32 v4, v5, v4
; GCN-NEXT:    v_mul_f32_e32 v8, 0x4f7ffffe, v8
; GCN-NEXT:    v_cvt_u32_f32_e32 v8, v8
; GCN-NEXT:    v_mul_lo_u32 v13, v13, v8
; GCN-NEXT:    v_mul_hi_u32 v12, v8, v13
; GCN-NEXT:    v_mul_lo_u32 v13, v4, v1
; GCN-NEXT:    v_add_i32_e32 v8, vcc, v8, v12
; GCN-NEXT:    v_mul_hi_u32 v8, v6, v8
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, v5, v13
; GCN-NEXT:    v_add_i32_e32 v12, vcc, 1, v4
; GCN-NEXT:    v_cmp_ge_u32_e64 s[2:3], v5, v1
; GCN-NEXT:    v_cndmask_b32_e64 v4, v4, v12, s[2:3]
; GCN-NEXT:    v_sub_i32_e32 v12, vcc, v5, v1
; GCN-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[2:3]
; GCN-NEXT:    v_mul_lo_u32 v12, v8, v2
; GCN-NEXT:    v_cvt_f32_u32_e32 v13, v10
; GCN-NEXT:    v_cmp_ge_u32_e64 s[2:3], v5, v1
; GCN-NEXT:    v_add_i32_e32 v14, vcc, 1, v4
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, v6, v12
; GCN-NEXT:    v_add_i32_e32 v1, vcc, 1, v8
; GCN-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v2
; GCN-NEXT:    v_cndmask_b32_e64 v8, v8, v1, s[4:5]
; GCN-NEXT:    v_cndmask_b32_e64 v1, v9, v18, s[0:1]
; GCN-NEXT:    v_cndmask_b32_e64 v4, v4, v14, s[2:3]
; GCN-NEXT:    v_xor_b32_e32 v1, v1, v0
; GCN-NEXT:    v_xor_b32_e32 v4, v4, v11
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, v1, v0
; GCN-NEXT:    v_sub_i32_e32 v1, vcc, v4, v11
; GCN-NEXT:    v_rcp_iflag_f32_e32 v4, v13
; GCN-NEXT:    v_sub_i32_e32 v6, vcc, 0, v10
; GCN-NEXT:    v_sub_i32_e32 v12, vcc, v5, v2
; GCN-NEXT:    v_mul_f32_e32 v4, 0x4f7ffffe, v4
; GCN-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GCN-NEXT:    v_add_i32_e32 v9, vcc, 1, v8
; GCN-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[4:5]
; GCN-NEXT:    v_mul_lo_u32 v6, v6, v4
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v2
; GCN-NEXT:    v_cndmask_b32_e32 v2, v8, v9, vcc
; GCN-NEXT:    v_ashrrev_i32_e32 v11, 31, v15
; GCN-NEXT:    v_mul_hi_u32 v5, v4, v6
; GCN-NEXT:    v_sub_i32_e32 v6, vcc, 0, v7
; GCN-NEXT:    v_max_i32_e32 v6, v7, v6
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; GCN-NEXT:    v_mul_hi_u32 v4, v6, v4
; GCN-NEXT:    v_xor_b32_e32 v2, v2, v11
; GCN-NEXT:    v_sub_i32_e32 v2, vcc, v2, v11
; GCN-NEXT:    v_mul_lo_u32 v5, v4, v10
; GCN-NEXT:    v_sub_i32_e32 v5, vcc, v6, v5
; GCN-NEXT:    v_add_i32_e32 v6, vcc, 1, v4
; GCN-NEXT:    v_sub_i32_e32 v7, vcc, v5, v10
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v10
...
; TONGA:       ; %bb.0:
; TONGA-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x24
...
; TONGA-NEXT:    v_sub_u32_e32 v8, vcc, 0, v0
; TONGA-NEXT:    v_max_i32_e32 v8, v0, v8
; TONGA-NEXT:    v_cvt_f32_u32_e32 v9, v8
; TONGA-NEXT:    v_sub_u32_e32 v14, vcc, 0, v8
; TONGA-NEXT:    s_waitcnt vmcnt(0)
; TONGA-NEXT:    v_sub_u32_e32 v10, vcc, 0, v4
; TONGA-NEXT:    v_rcp_iflag_f32_e32 v9, v9
; TONGA-NEXT:    v_xor_b32_e32 v0, v4, v0
...
; TONGA-NEXT:    v_xor_b32_e32 v11, v5, v1
; TONGA-NEXT:    v_max_i32_e32 v1, v1, v13
; TONGA-NEXT:    v_cvt_f32_u32_e32 v13, v1
; TONGA-NEXT:    v_mul_lo_u32 v14, v14, v9
; TONGA-NEXT:    v_sub_u32_e32 v17, vcc, 0, v2
; TONGA-NEXT:    v_xor_b32_e32 v15, v6, v2
; TONGA-NEXT:    v_mul_hi_u32 v14, v9, v14
; TONGA-NEXT:    v_max_i32_e32 v2, v2, v17
; TONGA-NEXT:    v_cvt_f32_u32_e32 v17, v2
; TONGA-NEXT:    v_sub_u32_e32 v12, vcc, 0, v5
; TONGA-NEXT:    v_add_u32_e32 v9, vcc, v9, v14
; TONGA-NEXT:    v_mul_hi_u32 v9, v4, v9
; TONGA-NEXT:    v_max_i32_e32 v5, v5, v12
; TONGA-NEXT:    v_sub_u32_e32 v16, vcc, 0, v6
; TONGA-NEXT:    v_mul_lo_u32 v14, v9, v8
; TONGA-NEXT:    v_add_u32_e32 v18, vcc, 1, v9
; TONGA-NEXT:    v_max_i32_e32 v6, v6, v16
; TONGA-NEXT:    v_sub_u32_e32 v4, vcc, v4, v14
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v8
; TONGA-NEXT:    v_cndmask_b32_e64 v9, v9, v18, s[0:1]
; TONGA-NEXT:    v_sub_u32_e32 v18, vcc, v4, v8
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v18, s[0:1]
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[0:1], v4, v8
; TONGA-NEXT:    v_rcp_iflag_f32_e32 v4, v13
; TONGA-NEXT:    v_sub_u32_e32 v14, vcc, 0, v1
; TONGA-NEXT:    v_sub_u32_e32 v13, vcc, 0, v2
; TONGA-NEXT:    v_mul_f32_e32 v4, 0x4f7ffffe, v4
; TONGA-NEXT:    v_cvt_u32_f32_e32 v4, v4
; TONGA-NEXT:    v_sub_u32_e32 v10, vcc, 0, v3
; TONGA-NEXT:    v_max_i32_e32 v10, v3, v10
; TONGA-NEXT:    v_mul_lo_u32 v8, v14, v4
; TONGA-NEXT:    v_add_u32_e32 v18, vcc, 1, v9
; TONGA-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; TONGA-NEXT:    v_mul_hi_u32 v8, v4, v8
; TONGA-NEXT:    v_ashrrev_i32_e32 v11, 31, v11
; TONGA-NEXT:    v_xor_b32_e32 v3, v7, v3
; TONGA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; TONGA-NEXT:    v_add_u32_e32 v4, vcc, v4, v8
; TONGA-NEXT:    v_rcp_iflag_f32_e32 v8, v17
; TONGA-NEXT:    v_mul_hi_u32 v4, v5, v4
; TONGA-NEXT:    v_mul_f32_e32 v8, 0x4f7ffffe, v8
; TONGA-NEXT:    v_cvt_u32_f32_e32 v8, v8
; TONGA-NEXT:    v_mul_lo_u32 v13, v13, v8
; TONGA-NEXT:    v_mul_hi_u32 v12, v8, v13
; TONGA-NEXT:    v_mul_lo_u32 v13, v4, v1
; TONGA-NEXT:    v_add_u32_e32 v8, vcc, v8, v12
; TONGA-NEXT:    v_mul_hi_u32 v8, v6, v8
; TONGA-NEXT:    v_sub_u32_e32 v5, vcc, v5, v13
; TONGA-NEXT:    v_add_u32_e32 v12, vcc, 1, v4
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[2:3], v5, v1
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v12, s[2:3]
; TONGA-NEXT:    v_sub_u32_e32 v12, vcc, v5, v1
; TONGA-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[2:3]
; TONGA-NEXT:    v_mul_lo_u32 v12, v8, v2
; TONGA-NEXT:    v_cvt_f32_u32_e32 v13, v10
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[2:3], v5, v1
; TONGA-NEXT:    v_add_u32_e32 v14, vcc, 1, v4
; TONGA-NEXT:    v_sub_u32_e32 v5, vcc, v6, v12
; TONGA-NEXT:    v_add_u32_e32 v1, vcc, 1, v8
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v2
; TONGA-NEXT:    v_cndmask_b32_e64 v8, v8, v1, s[4:5]
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v9, v18, s[0:1]
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v14, s[2:3]
; TONGA-NEXT:    v_xor_b32_e32 v1, v1, v0
; TONGA-NEXT:    v_xor_b32_e32 v4, v4, v11
; TONGA-NEXT:    v_sub_u32_e32 v0, vcc, v1, v0
; TONGA-NEXT:    v_sub_u32_e32 v1, vcc, v4, v11
; TONGA-NEXT:    v_rcp_iflag_f32_e32 v4, v13
; TONGA-NEXT:    v_sub_u32_e32 v6, vcc, 0, v10
; TONGA-NEXT:    v_sub_u32_e32 v12, vcc, v5, v2
; TONGA-NEXT:    v_mul_f32_e32 v4, 0x4f7ffffe, v4
; TONGA-NEXT:    v_cvt_u32_f32_e32 v4, v4
; TONGA-NEXT:    v_add_u32_e32 v9, vcc, 1, v8
; TONGA-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[4:5]
; TONGA-NEXT:    v_mul_lo_u32 v6, v6, v4
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v2
; TONGA-NEXT:    v_cndmask_b32_e32 v2, v8, v9, vcc
; TONGA-NEXT:    v_ashrrev_i32_e32 v11, 31, v15
; TONGA-NEXT:    v_mul_hi_u32 v5, v4, v6
; TONGA-NEXT:    v_sub_u32_e32 v6, vcc, 0, v7
; TONGA-NEXT:    v_max_i32_e32 v6, v7, v6
; TONGA-NEXT:    v_add_u32_e32 v4, vcc, v4, v5
; TONGA-NEXT:    v_mul_hi_u32 v4, v6, v4
; TONGA-NEXT:    v_xor_b32_e32 v2, v2, v11
; TONGA-NEXT:    v_sub_u32_e32 v2, vcc, v2, v11
; TONGA-NEXT:    v_mul_lo_u32 v5, v4, v10
; TONGA-NEXT:    v_sub_u32_e32 v5, vcc, v6, v5
; TONGA-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; TONGA-NEXT:    v_sub_u32_e32 v7, vcc, v5, v10
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v10
