...
; RUN: llc < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 | FileCheck %s --check-prefix=GCN
; RUN: llc < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck %s --check-prefix=TONGA
; RUN: llc < %s -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00 -mattr=-flat-for-global | FileCheck %s --check-prefix=GFX9
...
define amdgpu_kernel void @s_test_sdiv22_32(ptr addrspace(1) %out, i32 %x, i32 %y) {
; GCN-LABEL: s_test_sdiv22_32:
; GCN:       ; %bb.0:
...
; GCN-NEXT:    v_sub_i32_e32 v16, vcc, v0, v4
; GCN-NEXT:    v_cndmask_b32_e64 v13, v13, v17, s[2:3]
; GCN-NEXT:    v_sub_i32_e32 v17, vcc, v1, v5
; GCN-NEXT:    v_cndmask_b32_e64 v14, v14, v15, s[4:5]
; GCN-NEXT:    v_sub_i32_e32 v15, vcc, v2, v6
; GCN-NEXT:    v_mul_lo_u32 v19, v19, v18
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v16, s[0:1]
; GCN-NEXT:    v_add_i32_e32 v16, vcc, 1, v12
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s[2:3]
; GCN-NEXT:    v_add_i32_e32 v17, vcc, 1, v13
; GCN-NEXT:    v_cndmask_b32_e64 v2, v2, v15, s[4:5]
; GCN-NEXT:    v_add_i32_e32 v15, vcc, 1, v14
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; GCN-NEXT:    v_cndmask_b32_e32 v0, v12, v16, vcc
; GCN-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v5
; GCN-NEXT:    v_ashrrev_i32_e32 v8, 31, v8
; GCN-NEXT:    v_cndmask_b32_e32 v1, v13, v17, vcc
...
; GCN-NEXT:    v_cndmask_b32_e32 v2, v14, v15, vcc
...
; TONGA-NEXT:    v_rcp_f32_e32 v14, v14
; TONGA-NEXT:    v_rcp_f32_e32 v16, v16
...
; TONGA-NEXT:    v_sub_u32_e32 v16, vcc, v0, v4
; TONGA-NEXT:    v_cndmask_b32_e64 v13, v13, v17, s[2:3]
; TONGA-NEXT:    v_sub_u32_e32 v17, vcc, v1, v5
; TONGA-NEXT:    v_cndmask_b32_e64 v14, v14, v15, s[4:5]
; TONGA-NEXT:    v_sub_u32_e32 v15, vcc, v2, v6
; TONGA-NEXT:    v_mul_lo_u32 v19, v19, v18
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v0, v16, s[0:1]
; TONGA-NEXT:    v_add_u32_e32 v16, vcc, 1, v12
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v1, v17, s[2:3]
; TONGA-NEXT:    v_add_u32_e32 v17, vcc, 1, v13
; TONGA-NEXT:    v_cndmask_b32_e64 v2, v2, v15, s[4:5]
; TONGA-NEXT:    v_add_u32_e32 v15, vcc, 1, v14
; TONGA-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; TONGA-NEXT:    v_cndmask_b32_e32 v0, v12, v16, vcc
