...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; REGALLOC-GFX908-NEXT:   liveins: $sgpr4_5
  ...
  ; REGALLOC-GFX908-NEXT:   renamable $sgpr0_3 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_5, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; REGALLOC-GFX908-NEXT:   [[COPY2:%[0-9]+]]:areg_128 = COPY killed renamable $sgpr0_3
  ...
  ; PEI-GFX908-NEXT:   liveins: $agpr4, $sgpr4_5, $sgpr0_3, $sgpr9
  ; PEI-GFX908-NEXT: {{  $}}
  ; PEI-GFX908-NEXT:   $sgpr12_15 = COPY killed $sgpr0_3
  ; PEI-GFX908-NEXT:   $sgpr12 = S_ADD_U32 $sgpr12, $sgpr9, implicit-def $scc, implicit-def $sgpr12_15
  ; PEI-GFX908-NEXT:   $sgpr13 = S_ADDC_U32 $sgpr13, 0, implicit-def dead $scc, implicit $scc, implicit-def $sgpr12_15
  ...
  ; PEI-GFX908-NEXT:   BUFFER_STORE_DWORD_OFFSET killed $vgpr0, $sgpr12_15, 0, 0, 0, 0, implicit $exec, implicit-def $vgpr0_vgpr1, implicit $vgpr0_vgpr1 :: ("amdgpu-thread-private" store (s32) into %stack.0, addrspace 5)
  ...
  ; PEI-GFX908-NEXT:   renamable $sgpr0_3 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_5, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $sgpr0_3, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   $vgpr0 = BUFFER_LOAD_DWORD_OFFSET $sgpr12_15, 0, 0, 0, 0, implicit $exec, implicit-def $vgpr0_vgpr1 :: ("amdgpu-thread-private" load (s32) from %stack.0, addrspace 5)
  ...
  ; REGALLOC-GFX90A-NEXT:   liveins: $sgpr4_5
  ...
  ; REGALLOC-GFX90A-NEXT:   renamable $sgpr0_3 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_5, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; REGALLOC-GFX90A-NEXT:   [[COPY2:%[0-9]+]]:areg_128_align2 = COPY killed renamable $sgpr0_3
  ...
  ; PEI-GFX90A-NEXT:   liveins: $sgpr4_5
  ; PEI-GFX90A-NEXT: {{  $}}
  ...
  ; PEI-GFX90A-NEXT:   renamable $sgpr0_3 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_5, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $sgpr0_3, implicit $exec
