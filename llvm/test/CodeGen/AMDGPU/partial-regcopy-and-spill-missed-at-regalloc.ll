...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = lr-split COPY killed renamable $vgpr0_128, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $vgpr0_128 = lr-split COPY killed renamable $agpr0_agpr1_agpr2_agpr3, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $sgpr0_128, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $vgpr0_128 = COPY killed renamable $agpr0_agpr1_agpr2_agpr3, implicit $exec
  ; PEI-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $vgpr0_128, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
  ...
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = lr-split COPY killed renamable $vgpr0_128, implicit $exec
  ; PEI-GFX90A-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VReg_64_Align2, def renamable $vgpr2_64
  ; PEI-GFX90A-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $agpr0_agpr1_agpr2_agpr3, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
  ...
  ; PEI-GFX90A-NEXT:   renamable $agpr0_agpr1_agpr2_agpr3 = COPY killed renamable $sgpr0_128, implicit $exec
