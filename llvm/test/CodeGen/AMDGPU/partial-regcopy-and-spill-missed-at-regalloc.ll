...
define amdgpu_kernel void @partial_copy(<4 x i32> %arg) #0 {
  ...
  ; REGALLOC-GFX908-NEXT:   liveins: $sgpr4_64
  ...
  ; REGALLOC-GFX908-NEXT:   renamable $sgpr0_128 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_64, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; REGALLOC-GFX908-NEXT:   [[COPY2:%[0-9]+]]:areg_128 = COPY killed renamable $sgpr0_128
  ...
  ; PEI-GFX908-NEXT:   liveins: $agpr4, $sgpr4_64, $sgpr0_128, $sgpr9
  ; PEI-GFX908-NEXT: {{  $}}
  ; PEI-GFX908-NEXT:   $sgpr12_128 = COPY killed $sgpr0_128
  ; PEI-GFX908-NEXT:   $sgpr12 = S_ADD_U32 $sgpr12, $sgpr9, implicit-def $scc, implicit-def $sgpr12_128
  ; PEI-GFX908-NEXT:   $sgpr13 = S_ADDC_U32 $sgpr13, 0, implicit-def dead $scc, implicit $scc, implicit-def $sgpr12_128
  ; PEI-GFX908-NEXT:   INLINEASM &"; use $0", sideeffect attdialect, reguse:AGPR_32, undef renamable $agpr0
  ; PEI-GFX908-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VReg_128, def renamable $vgpr0_128
  ; PEI-GFX908-NEXT:   renamable $agpr0_128 = lr-split COPY killed renamable $vgpr0_128, implicit $exec
  ; PEI-GFX908-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VReg_64, def renamable $vgpr0_64
  ; PEI-GFX908-NEXT:   BUFFER_STORE_DWORD_OFFSET killed $vgpr0, $sgpr12_128, 0, 0, 0, 0, implicit $exec, implicit-def $vgpr0_64, implicit $vgpr0_64 :: ("amdgpu-thread-private" store (s32) into %stack.0, addrspace 5)
  ; PEI-GFX908-NEXT:   $agpr4 = V_ACCVGPR_WRITE_B32_e64 killed $vgpr1, implicit $exec, implicit killed $vgpr0_64
  ; PEI-GFX908-NEXT:   renamable $vgpr0_128 = lr-split COPY killed renamable $agpr0_128, implicit $exec
  ; PEI-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $vgpr0_128, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
  ; PEI-GFX908-NEXT:   renamable $sgpr0_128 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_64, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; PEI-GFX908-NEXT:   renamable $agpr0_128 = COPY killed renamable $sgpr0_128, implicit $exec
  ...
  ; PEI-GFX908-NEXT:   renamable $agpr0_128 = V_MFMA_I32_4X4X4I8_e64 killed $vgpr0, killed $vgpr1, killed $agpr0_128, 0, 0, 0, implicit $mode, implicit $exec
  ; PEI-GFX908-NEXT:   $vgpr0 = BUFFER_LOAD_DWORD_OFFSET $sgpr12_128, 0, 0, 0, 0, implicit $exec, implicit-def $vgpr0_64 :: ("amdgpu-thread-private" load (s32) from %stack.0, addrspace 5)
  ; PEI-GFX908-NEXT:   $vgpr1 = V_ACCVGPR_READ_B32_e64 $agpr4, implicit $exec, implicit $vgpr0_64
  ; PEI-GFX908-NEXT:   GLOBAL_STORE_DWORDX2 undef renamable $vgpr0_64, killed renamable $vgpr0_64, 0, 0, implicit $exec :: (volatile store (s64) into `ptr addrspace(1) poison`, addrspace 1)
  ; PEI-GFX908-NEXT:   renamable $vgpr0_128 = COPY killed renamable $agpr0_128, implicit $exec
  ; PEI-GFX908-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $vgpr0_128, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
  ; PEI-GFX908-NEXT:   S_ENDPGM 0
  ;
  ; REGALLOC-GFX90A-LABEL: name: partial_copy
  ; REGALLOC-GFX90A: bb.0 (%ir-block.0):
  ; REGALLOC-GFX90A-NEXT:   liveins: $sgpr4_64
  ...
  ; REGALLOC-GFX90A-NEXT:   renamable $sgpr0_128 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_64, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; REGALLOC-GFX90A-NEXT:   [[COPY2:%[0-9]+]]:areg_128_align2 = COPY killed renamable $sgpr0_128
  ...
  ; PEI-GFX90A-NEXT:   liveins: $sgpr4_64
  ; PEI-GFX90A-NEXT: {{  $}}
  ; PEI-GFX90A-NEXT:   INLINEASM &"; use $0", sideeffect attdialect, reguse:AGPR_32, undef renamable $agpr0
  ; PEI-GFX90A-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VReg_128_Align2, def renamable $vgpr0_128
  ; PEI-GFX90A-NEXT:   renamable $agpr0_128 = lr-split COPY killed renamable $vgpr0_128, implicit $exec
  ; PEI-GFX90A-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VReg_64_Align2, def renamable $vgpr2_64
  ; PEI-GFX90A-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $agpr0_128, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
  ; PEI-GFX90A-NEXT:   renamable $sgpr0_128 = S_LOAD_DWORDX4_IMM killed renamable $sgpr4_64, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; PEI-GFX90A-NEXT:   renamable $agpr0_128 = COPY killed renamable $sgpr0_128, implicit $exec
  ...
  ; PEI-GFX90A-NEXT:   renamable $agpr0_128 = V_MFMA_I32_4X4X4I8_e64 killed $vgpr0, killed $vgpr1, killed $agpr0_128, 0, 0, 0, implicit $mode, implicit $exec
  ; PEI-GFX90A-NEXT:   GLOBAL_STORE_DWORDX2 undef renamable $vgpr0_64, killed renamable $vgpr2_64, 0, 0, implicit $exec :: (volatile store (s64) into `ptr addrspace(1) poison`, addrspace 1)
  ; PEI-GFX90A-NEXT:   GLOBAL_STORE_DWORDX4 undef renamable $vgpr0_64, killed renamable $agpr0_128, 0, 0, implicit $exec :: (volatile store (s128) into `ptr addrspace(1) poison`, addrspace 1)
