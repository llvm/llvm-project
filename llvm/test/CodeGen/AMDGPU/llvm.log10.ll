...
; SI-NEXT:    v_log_f32_e32 v0, v0
; SI-NEXT:    v_mov_b32_e32 v1, 0xc11a209b
; SI-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; SI-NEXT:    s_mov_b32 s4, 0x3e9a209b
; SI-NEXT:    v_fma_f32 v0, v0, s4, v1
; SI-NEXT:    s_setpc_b64 s[30:31]
;
; VI-LABEL: v_log10_f32_fast:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s4, 0x800000
; VI-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
...
; GFX900-NEXT:    v_log_f32_e32 v0, v0
; GFX900-NEXT:    v_mov_b32_e32 v1, 0xc11a209b
; GFX900-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX900-NEXT:    s_mov_b32 s4, 0x3e9a209b
...
; GFX1100-NEXT:    v_cndmask_b32_e64 v1, 0, 0xc11a209b, vcc_lo
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1100-NEXT:    v_ldexp_f32 v0, v0, v2
; GFX1100-NEXT:    v_log_f32_e32 v0, v0
; GFX1100-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX1100-NEXT:    v_fmamk_f32 v0, v0, 0x3e9a209b, v1
; GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; SI-LABEL: v_log10_f32_afn_dynamic:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0x800000
; SI-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
...
; SI-NEXT:    s_setpc_b64 s[30:31]
;
; VI-LABEL: v_log10_f32_afn_dynamic:
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s4, 0x800000
; VI-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_log10_f32_afn_dynamic:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    s_mov_b32 s4, 0x800000
; GFX900-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_fabs_log10_f32_afn:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    s_mov_b32 s4, 0x800000
; GFX900-NEXT:    v_cmp_lt_f32_e64 vcc, |v0|, s4
...
; GFX1100-NEXT:    v_cndmask_b32_e64 v1, 0, 0xc11a209b, s0
; GFX1100-NEXT:    v_ldexp_f32 v0, |v0|, v2
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1100-NEXT:    v_log_f32_e32 v0, v0
; GFX1100-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_log10_f32_nnan_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_log_f32_e32 v0, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3e9a209a
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_log10_f32_ninf_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_log_f32_e32 v0, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3e9a209a
...
; SI-LABEL: v_log10_f32_nnan_ninf_daz:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    v_log_f32_e32 v0, v0
; SI-NEXT:    s_mov_b32 s4, 0x3e9a209a
...
; VI-NEXT:    s_setpc_b64 s[30:31]
;
; GFX900-LABEL: v_log10_f32_nnan_ninf_daz:
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_log_f32_e32 v0, v0
; GFX900-NEXT:    s_mov_b32 s4, 0x3e9a209a
