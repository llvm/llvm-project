...
; GFX11-LABEL: test_fill:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .fill 256, 4, 0
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_fill:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .fill 256, 4, 0
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_space:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .space 1024
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_space:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .space 1024
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_comments:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ; comment 1
; GFX11-NEXT:  ; comment 2
; GFX11-NEXT:  ; comment 3
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_comments:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    ; comment 1
; GFX12-NEXT:  ; comment 2
; GFX12-NEXT:  ; comment 3
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_empty_asm:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_empty_asm:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_multiple_asm:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .fill 128, 4, 0
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .space 512
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_multiple_asm:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .fill 128, 4, 0
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .space 512
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_clamping:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .fill 2048, 4, 0
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_clamping:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .fill 2048, 4, 0
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
...
; GFX11-LABEL: test_clamping_both:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    .fill 8192, 4, 0
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: test_clamping_both:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    ;;#ASMSTART
; GFX12-NEXT:    .fill 8192, 4, 0
; GFX12-NEXT:    ;;#ASMEND
; GFX12-NEXT:    s_endpgm
