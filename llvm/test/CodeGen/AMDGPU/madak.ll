...
; GFX942-FMA-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX942-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-FMA-NEXT:    global_load_dword v1, v3, s[2:3]
; GFX942-FMA-NEXT:    global_load_dword v2, v3, s[6:7]
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    v_fmaak_f32 v1, v1, v2, 0x41200000
; GFX942-FMA-NEXT:    global_store_dword v3, v1, s[0:1]
...
; GFX10-FMA-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX10-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-FMA-NEXT:    s_clause 0x1
; GFX10-FMA-NEXT:    global_load_dword v1, v3, s[2:3]
; GFX10-FMA-NEXT:    global_load_dword v2, v3, s[6:7]
; GFX10-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FMA-NEXT:    v_fmaak_f32 v1, v1, v2, 0x41200000
; GFX10-FMA-NEXT:    global_store_dword v3, v1, s[0:1]
...
; GFX11-FMA-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX11-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FMA-NEXT:    s_clause 0x1
; GFX11-FMA-NEXT:    global_load_b32 v1, v3, s[2:3]
; GFX11-FMA-NEXT:    global_load_b32 v2, v3, s[4:5]
; GFX11-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FMA-NEXT:    v_fmaak_f32 v1, v1, v2, 0x41200000
; GFX11-FMA-NEXT:    global_store_b32 v3, v1, s[0:1]
...
; GFX942-FMA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX942-FMA-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX942-FMA-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; GFX942-FMA-NEXT:    v_mov_b32_e32 v4, 0x41200000
; GFX942-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-FMA-NEXT:    global_load_dword v1, v5, s[2:3] sc0 sc1
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    global_load_dword v2, v5, s[2:3] offset:4 sc0 sc1
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    global_load_dword v3, v5, s[2:3] offset:8 sc0 sc1
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    v_fmaak_f32 v2, v1, v2, 0x41200000
; GFX942-FMA-NEXT:    v_fmac_f32_e32 v4, v1, v3
; GFX942-FMA-NEXT:    global_store_dword v5, v2, s[0:1] sc0 sc1
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    global_store_dword v5, v4, s[2:3] offset:4 sc0 sc1
; GFX942-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX942-FMA-NEXT:    s_endpgm
;
...
; GFX10-FMA:       ; %bb.0:
; GFX10-FMA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-FMA-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX10-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-FMA-NEXT:    global_load_dword v1, v4, s[2:3] glc dlc
; GFX10-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FMA-NEXT:    global_load_dword v2, v4, s[2:3] offset:4 glc dlc
; GFX10-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FMA-NEXT:    global_load_dword v3, v4, s[2:3] offset:8 glc dlc
; GFX10-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FMA-NEXT:    v_fmaak_f32 v2, v1, v2, 0x41200000
; GFX10-FMA-NEXT:    v_fmaak_f32 v1, v1, v3, 0x41200000
; GFX10-FMA-NEXT:    global_store_dword v4, v2, s[0:1]
; GFX10-FMA-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-FMA-NEXT:    global_store_dword v4, v1, s[2:3] offset:4
; GFX10-FMA-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-FMA-NEXT:    s_endpgm
;
...
; GFX11-FMA-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-FMA-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-FMA-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX11-FMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-FMA-NEXT:    global_load_b32 v1, v4, s[2:3] glc dlc
; GFX11-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FMA-NEXT:    global_load_b32 v2, v4, s[2:3] offset:4 glc dlc
; GFX11-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FMA-NEXT:    global_load_b32 v3, v4, s[2:3] offset:8 glc dlc
; GFX11-FMA-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FMA-NEXT:    v_fmaak_f32 v2, v1, v2, 0x41200000
; GFX11-FMA-NEXT:    v_fmaak_f32 v1, v1, v3, 0x41200000
; GFX11-FMA-NEXT:    global_store_b32 v4, v2, s[0:1] dlc
; GFX11-FMA-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FMA-NEXT:    global_store_b32 v4, v1, s[2:3] offset:4 dlc
; GFX11-FMA-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FMA-NEXT:    s_endpgm
  %tid = tail call i32 @llvm.amdgcn.workitem.id.x() nounwind readnone
