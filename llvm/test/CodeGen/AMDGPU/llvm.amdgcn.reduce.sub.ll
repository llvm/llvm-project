...
; GFX12DAGISEL-NEXT:    s_xor_b32 s4, exec_lo, s4
...
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
...
; GFX12DAGISEL-NEXT:    s_mov_b32 s4, exec_lo
; GFX12DAGISEL-NEXT:    s_mov_b32 s3, 0
; GFX12DAGISEL-NEXT:  .LBB6_4: ; =>This Inner Loop Header: Depth=1
; GFX12DAGISEL-NEXT:    s_ctz_i32_b32 s5, s4
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    v_readlane_b32 s6, v0, s5
; GFX12DAGISEL-NEXT:    s_bitset0_b32 s4, s5
; GFX12DAGISEL-NEXT:    s_sub_co_i32 s3, s3, s6
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    s_cmp_lg_u32 s4, 0
