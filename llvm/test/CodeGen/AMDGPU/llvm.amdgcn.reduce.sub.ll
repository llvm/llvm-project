...
; GFX6DAGISEL-NEXT:    s_sext_i32_i16 s2, s2
; GFX6DAGISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX6DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX6DAGISEL-NEXT:    s_sub_i32 s1, 0, s2
; GFX6DAGISEL-NEXT:    s_mul_i32 s0, s1, s0
...
; GFX7DAGISEL-NEXT:    s_sext_i32_i16 s2, s2
; GFX7DAGISEL-NEXT:    s_mov_b64 s[0:1], exec
; GFX7DAGISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; GFX7DAGISEL-NEXT:    s_sub_i32 s1, 0, s2
; GFX7DAGISEL-NEXT:    s_mul_i32 s0, s1, s0
...
; GFX8DAGISEL-NEXT:    s_sub_i32 s0, 0, s0
...
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[4:5]
; GFX1064DAGISEL-NEXT:    s_sext_i32_i16 s2, s2
; GFX1064DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1064DAGISEL-NEXT:    s_mul_i32 s2, s2, s3
...
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[4:5]
...
; GFX1164DAGISEL-NEXT:    s_mul_i32 s2, s2, s3
...
; GFX8DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[4:5]
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:    s_sub_i32 s0, 0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s0, s0, s3
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX6DAGISEL-NEXT:    ; implicit-def: $sgpr6
...
; GFX6DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX6DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX6DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
; GFX6DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX6DAGISEL-NEXT:  .LBB8_2: ; %Flow
; GFX6DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6DAGISEL-NEXT:    s_or_saveexec_b64 s[2:3], s[4:5]
...
; GFX7DAGISEL-NEXT:    ; implicit-def: $sgpr6
...
; GFX7DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX7DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX7DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
; GFX7DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX7DAGISEL-NEXT:  .LBB8_2: ; %Flow
; GFX7DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7DAGISEL-NEXT:    s_or_saveexec_b64 s[2:3], s[4:5]
...
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX8DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
...
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_sub_i32 s5, 0, s6
...
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX9DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX9DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
...
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_sub_i32 s5, 0, s6
...
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX1064DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1064DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
...
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    s_sub_i32 s5, 0, s6
...
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
...
; GFX1032DAGISEL-NEXT:    s_sub_i32 s3, s3, s6
...
; GFX1032GISEL-NEXT:    s_sub_i32 s3, s3, s6
...
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[6:7]
; GFX1164DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164DAGISEL-NEXT:    s_mul_i32 s6, s2, s3
...
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_sub_i32 s5, 0, s6
...
; GFX1132DAGISEL-NEXT:    s_xor_b32 s4, exec_lo, s4
...
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
...
; GFX1132DAGISEL-NEXT:    s_sub_i32 s3, s3, s6
...
; GFX1132GISEL-NEXT:    s_sub_i32 s3, s3, s6
