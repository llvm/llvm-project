...
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[4:5]
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:    s_sub_i32 s0, 0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s0, s0, s1
...
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s3, s[4:5]
; GFX9DAGISEL-NEXT:    s_mov_b32 s1, 0
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX9DAGISEL-NEXT:    s_mul_i32 s2, s2, s3
...
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[4:5]
; GFX1064DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1064DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1064GISEL-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
; GFX1064GISEL-NEXT:    s_sub_i32 s2, 0, s6
; GFX1064GISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1032DAGISEL-NEXT:    s_bcnt1_i32_b32 s1, s1
; GFX1032DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1032DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1032GISEL-NEXT:    s_bcnt1_i32_b32 s1, s1
; GFX1032GISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1032GISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s1, s[4:5]
...
; GFX1164DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1164GISEL-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
; GFX1164GISEL-NEXT:    s_sub_i32 s2, 0, s6
; GFX1164GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1164GISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX1132DAGISEL-NEXT:    s_bcnt1_i32_b32 s1, s1
; GFX1132DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX1132DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s1
...
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX12DAGISEL-NEXT:    s_bcnt1_i32_b32 s1, s1
; GFX12DAGISEL-NEXT:    s_sub_co_i32 s2, 0, s2
; GFX12DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12DAGISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s1
...
; GFX8DAGISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX8DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
; GFX8DAGISEL-NEXT:    ; implicit-def: $vgpr0
; GFX8DAGISEL-NEXT:  .LBB2_2: ; %Flow
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_or_saveexec_b64 s[2:3], s[4:5]
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX8DAGISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX8GISEL-NEXT:    s_mul_i32 s6, s1, s4
...
; GFX8GISEL-NEXT:    s_sub_i32 s6, s6, s7
...
; GFX9DAGISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX9DAGISEL-NEXT:    s_sub_i32 s2, 0, s2
; GFX9DAGISEL-NEXT:    s_mul_i32 s1, s2, s1
...
; GFX9DAGISEL-NEXT:    s_ff1_i32_b64 s6, s[4:5]
; GFX9DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX9DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s6
; GFX9DAGISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX9GISEL-NEXT:    s_mul_i32 s6, s1, s4
...
; GFX9GISEL-NEXT:    s_sub_i32 s6, s6, s7
...
; GFX1064DAGISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX1064DAGISEL-NEXT:    s_ff1_i32_b64 s6, s[4:5]
; GFX1064DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX1064DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s6
; GFX1064DAGISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX1064GISEL-NEXT:    s_mul_i32 s1, s1, s4
...
; GFX1064GISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX1032DAGISEL-NEXT:    s_mul_i32 s3, s2, s3
...
; GFX1032GISEL-NEXT:    s_mul_i32 s1, s1, s3
...
; GFX1032GISEL-NEXT:    v_readlane_b32 s5, v0, s4
; GFX1032GISEL-NEXT:    s_bitset0_b32 s3, s4
; GFX1032GISEL-NEXT:    s_sub_i32 s1, s1, s5
; GFX1032GISEL-NEXT:    s_cmp_lg_u32 s3, 0
...
; GFX1164DAGISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX1164DAGISEL-NEXT:    ; implicit-def: $sgpr1
...
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_or_saveexec_b64 s[2:3], s[4:5]
; GFX1164DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX1164DAGISEL-NEXT:    s_ctz_i32_b64 s6, s[4:5]
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164DAGISEL-NEXT:    v_readlane_b32 s7, v0, s6
; GFX1164DAGISEL-NEXT:    s_bitset0_b64 s[4:5], s6
; GFX1164DAGISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX1164GISEL-NEXT:    s_mul_i32 s1, s1, s4
...
; GFX1164GISEL-NEXT:    s_sub_i32 s1, s1, s7
...
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132DAGISEL-NEXT:    s_mul_i32 s3, s2, s3
...
; GFX1132GISEL-NEXT:    s_mul_i32 s1, s1, s3
...
; GFX1132GISEL-NEXT:    v_readlane_b32 s5, v0, s4
; GFX1132GISEL-NEXT:    s_bitset0_b32 s3, s4
; GFX1132GISEL-NEXT:    s_sub_i32 s1, s1, s5
; GFX1132GISEL-NEXT:    s_cmp_lg_u32 s3, 0
...
; GFX12DAGISEL-NEXT:    s_xor_b32 s1, exec_lo, s1
...
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12DAGISEL-NEXT:    s_mul_i32 s3, s2, s3
; GFX12DAGISEL-NEXT:  ; %bb.2: ; %Flow
; GFX12DAGISEL-NEXT:    s_or_saveexec_b32 s1, s1
; GFX12DAGISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX12DAGISEL-NEXT:    s_xor_b32 exec_lo, exec_lo, s1
; GFX12DAGISEL-NEXT:    s_cbranch_execz .LBB2_6
...
; GFX12DAGISEL-NEXT:  .LBB2_6: ; %endif
