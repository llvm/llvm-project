...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 < %s | FileCheck -check-prefixes=CHECK,GFX11-GISEL %s
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v4.l, s1
...
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(SALU_CYCLE_2)
...
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v2.l, s0
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v3.l, s1
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v4.l, s3
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 2
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v5.l, s3
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s0, v2
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 1
; GFX12-GISEL-NEXT:    v_cvt_f16_f32_e64 v2.l, s2
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v3
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 2
...
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s4, v3
; GFX12-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 3, 1), 0
; GFX12-GISEL-NEXT:    s_add_f16 s1, s1, s3
; GFX12-GISEL-NEXT:    s_add_f16 s0, s0, s2
; GFX12-GISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GISEL-NEXT:    s_add_f16 s1, s5, s1
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX12-GISEL-NEXT:    s_add_f16 s0, s4, s0
; GFX12-GISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
