...
; RUN: llc -global-isel=1 -mtriple=amdgpu10.30 < %s | FileCheck -check-prefixes=CHECK,GISEL %s
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v0, v0, v0
; GFX11-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v0, v0, v0
; GFX12-NEXT:    ; return to shader part epilog
...
; GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: v_fptrunc_round_poison_to_v2f16_towardzero:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v0, v0, v0
; GFX12-NEXT:    ; return to shader part epilog
  %lo = call half @llvm.fptrunc.round.f16.f32(float %a, metadata !"round.towardzero")
...
; GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: v_fptrunc_round_constant_to_v2f16_towardzero:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v0, v0, v0
; GFX12-NEXT:    v_mov_b16_e32 v0.h, 0x3c00
; GFX12-NEXT:    ; return to shader part epilog
  %lo = call half @llvm.fptrunc.round.f16.f32(float %a, metadata !"round.towardzero")
  %tmp = insertelement <2 x half> poison, half %lo, i32 0
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v4, v0, v0
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v5, v1, v0
; GFX11-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 1), 1
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v4, v0, v0
; GFX12-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v5, v1, v0
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-NEXT:    v_cvt_f16_f32_e64 v0.l, v1
; GFX12-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 2), 0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_f16_e32 v0.h, v4.l, v5.l
; GFX12-NEXT:    v_add_f16_e32 v0.l, v0.l, v0.h
; GFX12-NEXT:    global_store_b16 v[2:3], v0, off
; GFX12-NEXT:    s_endpgm
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v0, s0, v0
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX11-SDAG-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-SDAG-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    v_mov_b16_e32 v2.l, s0
...
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v1, s1, v0
; GFX11-SDAG-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX11-SDAG-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-NEXT:    v_readfirstlane_b32 s0, v0
