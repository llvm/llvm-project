...
;
; GFX12-SDAG-LABEL: v_fptrunc_round_f32_to_f16_tonearest:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e64 v0.l, v0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: v_fptrunc_round_f32_to_f16_tonearest:
; GFX12-GISEL:       ; %bb.0:
...
; GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: v_fptrunc_round_f32_to_f16_upward:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 2, 1), 1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e64 v0.l, v0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: v_fptrunc_round_f32_to_f16_upward:
; GFX12-GISEL:       ; %bb.0:
...
; GISEL-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: v_fptrunc_round_f32_to_f16_downward:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 3, 1), 1
; GFX12-SDAG-NEXT:    v_cvt_f16_f32_e64 v0.l, v0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: v_fptrunc_round_f32_to_f16_downward:
; GFX12-GISEL:       ; %bb.0:
...
; GFX11-SDAG:       ; %bb.0:
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e64 v0, v0, s0
; GFX11-SDAG-NEXT:    ; implicit-def: $vgpr0_hi16
; GFX11-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX11-SDAG-NEXT:    ; implicit-def: $vgpr1_hi16
; GFX11-SDAG-NEXT:    ; implicit-def: $vgpr0_hi16
...
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr4_hi16
; GFX11-GISEL-NEXT:    ; implicit-def: $vgpr5_hi16
