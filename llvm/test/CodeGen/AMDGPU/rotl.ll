...
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_sub_i32 s6, 32, s8
; SI-NEXT:    s_sub_i32 s8, 32, s9
; SI-NEXT:    s_mov_b32 s4, s3
; SI-NEXT:    s_mov_b32 s5, s3
; SI-NEXT:    s_mov_b32 s3, s2
; SI-NEXT:    s_and_b32 s8, s8, 31
; SI-NEXT:    s_and_b32 s6, s6, 31
; SI-NEXT:    s_lshr_b64 s[8:9], s[4:5], s8
; SI-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_sub_i32 s6, 32, s6
; GFX10-NEXT:    s_sub_i32 s7, 32, s7
; GFX10-NEXT:    s_mov_b32 s4, s3
; GFX10-NEXT:    s_mov_b32 s5, s3
; GFX10-NEXT:    s_mov_b32 s3, s2
; GFX10-NEXT:    s_and_b32 s6, s6, 31
; GFX10-NEXT:    s_and_b32 s7, s7, 31
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_sub_i32 s6, 32, s6
; GFX11-NEXT:    s_sub_i32 s7, 32, s7
