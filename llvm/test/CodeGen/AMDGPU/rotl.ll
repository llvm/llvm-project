...
; GFX8-NEXT:    s_sub_i32 s0, 32, s3
; GFX8-NEXT:    s_and_b32 s0, s0, 31
; GFX8-NEXT:    s_mov_b32 s3, s2
; GFX8-NEXT:    s_lshr_b64 s[0:1], s[2:3], s0
...
; GFX10-NEXT:    s_sub_i32 s1, 32, s3
; GFX10-NEXT:    s_mov_b32 s3, s2
; GFX10-NEXT:    s_and_b32 s1, s1, 31
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[2:3], s1
...
; SI-NEXT:    s_sub_i32 s4, 32, s9
; SI-NEXT:    s_mov_b32 s8, s3
; SI-NEXT:    s_mov_b32 s9, s3
; SI-NEXT:    s_mov_b32 s3, s2
; SI-NEXT:    s_and_b32 s4, s4, 31
; SI-NEXT:    s_and_b32 s1, s1, 31
; SI-NEXT:    s_lshr_b64 s[8:9], s[8:9], s4
; SI-NEXT:    s_lshr_b64 s[2:3], s[2:3], s1
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_sub_i32 s0, 32, s5
; GFX8-NEXT:    s_and_b32 s5, s0, 31
; GFX8-NEXT:    s_mov_b32 s0, s3
; GFX8-NEXT:    s_mov_b32 s1, s3
; GFX8-NEXT:    s_sub_i32 s4, 32, s4
; GFX8-NEXT:    s_lshr_b64 s[0:1], s[0:1], s5
; GFX8-NEXT:    s_and_b32 s1, s4, 31
; GFX8-NEXT:    s_mov_b32 s3, s2
