...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_and_b32 s2, s4, 0xff
; GFX9-GISEL-NEXT:    s_flbit_i32_b32 s2, s2
; GFX9-GISEL-NEXT:    s_sub_i32 s2, s2, 24
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_and_b32 s2, s4, 0xffff
; GFX9-GISEL-NEXT:    s_flbit_i32_b32 s2, s2
; GFX9-GISEL-NEXT:    s_sub_i32 s2, s2, 16
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_and_b32 s2, s4, 0x3ffff
; SI-NEXT:    s_flbit_i32_b32 s2, s2
...
; VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_and_b32 s2, s4, 0x3ffff
; VI-NEXT:    s_flbit_i32_b32 s2, s2
; VI-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_and_b32 s2, s4, 0x3ffff
; GFX9-GISEL-NEXT:    s_flbit_i32_b32 s2, s2
; GFX9-GISEL-NEXT:    s_sub_i32 s2, s2, 14
