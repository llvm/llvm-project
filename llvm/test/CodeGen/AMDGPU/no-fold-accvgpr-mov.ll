...
; RUN: llc -mtriple=amdgpu9.42--amdhsa %s -o - | FileCheck %s --check-prefixes=GFX942
; RUN: llc -mtriple=amdgpu9.08--amdhsa %s -o - | FileCheck %s --check-prefixes=GFX908
...
; GFX942-NEXT:    s_and_b32 s1, s1, s4
