...
; Check that in strict OOB mode for buffers ("amdgpu.buffer.oob.relaxed" module flag not set) the underaligned loads and stores get split.
...
; Check that in strict OOB mode for buffers ("amdgpu.buffer.oob.relaxed" module flag not set) the naturally aligned loads and stores do not get split.
