...
; ISA-NEXT:    s_setpc_b64 s[30:31]
  ...
  ; MIR-NEXT: {{  $}}
  ; MIR-NEXT:   [[PRED_COPY:%[0-9]+]]:vgpr_32 = PRED_COPY $vgpr2
  ; MIR-NEXT:   [[PRED_COPY1:%[0-9]+]]:vgpr_32 = PRED_COPY $vgpr1
  ; MIR-NEXT:   [[PRED_COPY2:%[0-9]+]]:vgpr_32 = PRED_COPY $vgpr0
  ...
  ; MIR-NEXT:   [[PRED_COPY3:%[0-9]+]]:sreg_32 = PRED_COPY [[S_LOAD_DWORDX2_IMM]].sub1
  ; MIR-NEXT:   [[PRED_COPY4:%[0-9]+]]:sreg_32 = PRED_COPY [[S_LOAD_DWORDX2_IMM]].sub0
  ; MIR-NEXT:   [[S_MOV_B32_:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; MIR-NEXT:   S_CMP_LG_U32 [[PRED_COPY4]], [[S_MOV_B32_]], implicit-def $scc
  ; MIR-NEXT:   [[PRED_COPY5:%[0-9]+]]:sreg_32_xm0_xexec = PRED_COPY $scc
  ; MIR-NEXT:   $scc = PRED_COPY [[PRED_COPY5]]
  ; MIR-NEXT:   [[S_CSELECT_B32_:%[0-9]+]]:sreg_32 = S_CSELECT_B32 [[PRED_COPY3]], [[S_MOV_B32_]], implicit $scc
  ; MIR-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; MIR-NEXT:   [[S_LSHR_B32_:%[0-9]+]]:sreg_32 = S_LSHR_B32 [[S_MOV_B32_1]], [[PRED_COPY4]], implicit-def dead $scc
  ; MIR-NEXT:   S_CMP_LG_U32 [[PRED_COPY4]], [[S_MOV_B32_]], implicit-def $scc
  ; MIR-NEXT:   [[PRED_COPY6:%[0-9]+]]:sreg_32_xm0_xexec = PRED_COPY $scc
  ; MIR-NEXT:   $scc = PRED_COPY [[PRED_COPY6]]
  ; MIR-NEXT:   [[S_CSELECT_B32_1:%[0-9]+]]:sreg_32 = S_CSELECT_B32 killed [[S_LSHR_B32_]], [[S_MOV_B32_]], implicit $scc
  ; MIR-NEXT:   [[S_LSHR_B32_1:%[0-9]+]]:sreg_32 = S_LSHR_B32 [[PRED_COPY3]], [[S_MOV_B32_1]], implicit-def dead $scc
  ; MIR-NEXT:   S_CMP_LG_U32 [[PRED_COPY4]], [[S_MOV_B32_]], implicit-def $scc
  ; MIR-NEXT:   [[PRED_COPY7:%[0-9]+]]:sreg_32_xm0_xexec = PRED_COPY $scc
  ; MIR-NEXT:   [[REG_SEQUENCE:%[0-9]+]]:sreg_64 = REG_SEQUENCE [[PRED_COPY1]], %subreg.sub0, [[PRED_COPY]], %subreg.sub1
  ; MIR-NEXT:   [[PRED_COPY8:%[0-9]+]]:vreg_64 = PRED_COPY [[REG_SEQUENCE]]
  ; MIR-NEXT:   $scc = PRED_COPY [[PRED_COPY7]]
  ...
  ; MIR-NEXT:   [[PRED_COPY9:%[0-9]+]]:sreg_32 = PRED_COPY [[V_CVT_F32_I32_e64_]]
  ; MIR-NEXT:   [[S_AND_B32_:%[0-9]+]]:sgpr_32 = S_AND_B32 killed [[PRED_COPY9]], killed [[S_MOV_B32_2]], implicit-def dead $scc
  ; MIR-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sgpr_32 = S_MOV_B32 1065353216
  ; MIR-NEXT:   [[S_MOV_B32_4:%[0-9]+]]:sgpr_32 = S_MOV_B32 0
  ; MIR-NEXT:   [[PRED_COPY10:%[0-9]+]]:vgpr_32 = PRED_COPY killed [[S_MOV_B32_3]]
  ; MIR-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[S_MOV_B32_4]], 0, [[PRED_COPY10]], [[PRED_COPY7]], implicit $exec
  ; MIR-NEXT:   [[PRED_COPY11:%[0-9]+]]:sgpr_32 = PRED_COPY [[V_CNDMASK_B32_e64_]]
  ; MIR-NEXT:   [[V_CVT_F32_UBYTE0_e64_:%[0-9]+]]:vgpr_32 = V_CVT_F32_UBYTE0_e64 killed [[S_CSELECT_B32_1]], 0, 0, implicit $exec
  ; MIR-NEXT:   [[PRED_COPY12:%[0-9]+]]:sgpr_32 = PRED_COPY [[V_CVT_F32_UBYTE0_e64_]]
  ; MIR-NEXT:   [[V_CVT_F32_I32_e64_1:%[0-9]+]]:vgpr_32 = V_CVT_F32_I32_e64 killed [[S_CSELECT_B32_]], 0, 0, implicit $mode, implicit $exec
  ; MIR-NEXT:   [[PRED_COPY13:%[0-9]+]]:sgpr_32 = PRED_COPY [[V_CVT_F32_I32_e64_1]]
  ; MIR-NEXT:   [[V_CMP_LT_I32_e64_:%[0-9]+]]:sreg_32 = V_CMP_LT_I32_e64 [[PRED_COPY2]], [[S_MOV_B32_1]], implicit $exec
  ; MIR-NEXT:   [[PRED_COPY14:%[0-9]+]]:vreg_1 = PRED_COPY [[V_CMP_LT_I32_e64_]]
  ; MIR-NEXT: {{  $}}
  ; MIR-NEXT: bb.1.bb14:
  ...
  ; MIR-NEXT:   [[PRED_COPY15:%[0-9]+]]:sreg_32 = PRED_COPY [[PRED_COPY14]]
  ; MIR-NEXT:   [[SI_IF_BREAK:%[0-9]+]]:sreg_32 = SI_IF_BREAK [[PRED_COPY15]], [[PHI]], implicit-def dead $scc
  ; MIR-NEXT:   [[V_ADD_F32_e64_:%[0-9]+]]:vgpr_32 = nofpexcept V_ADD_F32_e64 0, [[PHI1]], 0, [[PRED_COPY11]], 0, 0, implicit $mode, implicit $exec
  ...
  ; MIR-NEXT:   [[V_ADD_F32_e64_2:%[0-9]+]]:vgpr_32 = nofpexcept V_ADD_F32_e64 0, killed [[V_ADD_F32_e64_1]], 0, [[PRED_COPY12]], 0, 0, implicit $mode, implicit $exec
  ; MIR-NEXT:   [[V_ADD_F32_e64_3:%[0-9]+]]:vgpr_32 = nofpexcept V_ADD_F32_e64 0, killed [[V_ADD_F32_e64_2]], 0, [[PRED_COPY13]], 0, 0, implicit $mode, implicit $exec
  ; MIR-NEXT:   [[PRED_COPY16:%[0-9]+]]:sgpr_32 = PRED_COPY [[V_ADD_F32_e64_3]]
  ...
  ; MIR-NEXT:   FLAT_STORE_DWORD [[PRED_COPY8]], [[PHI2]], 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into %ir.ptr)
  ; MIR-NEXT:   SI_RETURN
bb:
