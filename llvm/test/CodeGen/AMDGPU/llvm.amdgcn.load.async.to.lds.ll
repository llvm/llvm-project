...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s --check-prefix=GFX90A
; RUN: llc -global-isel=0 -mtriple=amdgpu9.0a < %s | FileCheck %s --check-prefix=GFX90A
; RUN: llc -global-isel=0 -mtriple=amdgpu9.42 < %s | FileCheck %s --check-prefix=GFX942
; RUN: llc -global-isel=0 -mtriple=amdgpu10.10 < %s | FileCheck %s --check-prefix=GFX10
; RUN: llc -global-isel=1 -mtriple=amdgpu9.42 < %s | FileCheck %s --check-prefix=GFX942-GISEL
