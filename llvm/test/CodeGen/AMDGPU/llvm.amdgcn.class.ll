...
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 1
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
...
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 2
; SI-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[0:1]
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 1
; SI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; SI-NEXT:    v_or_b32_e32 v1, v2, v1
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 4
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
...
; SI-NEXT:    buffer_load_dword v0, v[0:1], s[8:11], 0 addr64
; SI-NEXT:    s_movk_i32 s6, 0x80
; SI-NEXT:    s_movk_i32 s7, 0x100
; SI-NEXT:    s_movk_i32 s8, 0x200
; SI-NEXT:    s_mov_b32 s0, s4
; SI-NEXT:    s_mov_b32 s1, s5
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 2
; SI-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 1
; SI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 4
; SI-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 8
; SI-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 16
; SI-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 32
; SI-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 64
; SI-NEXT:    v_cndmask_b32_e64 v7, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, s6
; SI-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[4:5]
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, s7
...
; SI-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, s8
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; SI-NEXT:    v_or_b32_e32 v0, v1, v0
; SI-NEXT:    v_bfe_i32 v0, v0, 0, 1
; SI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 8
; SI-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[0:1]
; SI-NEXT:    v_cmp_class_f32_e64 s[0:1], v0, 4
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[0:1]
; SI-NEXT:    v_or_b32_e32 v0, v0, v1
