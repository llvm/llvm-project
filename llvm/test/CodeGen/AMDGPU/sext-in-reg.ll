...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_i1_i32:
; GFX89:       ; %bb.0:
...
; GFX89-NEXT:    s_bfe_i32 s4, s6, 0x10000
...
; GFX9-NEXT:    s_bfe_i32 s4, s6, 0x10000
...
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX89-NEXT:    s_add_i32 s4, s4, s5
; GFX89-NEXT:    s_sext_i32_i8 s4, s4
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_i1_to_i64:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX89-NEXT:    s_load_dword s8, s[4:5], 0x34
; GFX89-NEXT:    s_mov_b32 s7, 0xf000
; GFX89-NEXT:    s_mov_b32 s6, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_mov_b32 s4, s0
; GFX89-NEXT:    s_mov_b32 s5, s1
; GFX89-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX89-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x10000
...
; GFX9-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_i8_to_i64:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX89-NEXT:    s_load_dword s8, s[4:5], 0x34
; GFX89-NEXT:    s_mov_b32 s7, 0xf000
...
; GFX89-NEXT:    s_mov_b32 s5, s1
; GFX89-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX89-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x80000
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX89-NEXT:    s_endpgm
...
; GFX9-NEXT:    s_mov_b32 s5, s1
; GFX9-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX9-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x80000
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX9-NEXT:    s_endpgm
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_i16_to_i64:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX89-NEXT:    s_load_dword s8, s[4:5], 0x34
; GFX89-NEXT:    s_mov_b32 s7, 0xf000
...
; GFX89-NEXT:    s_mov_b32 s5, s1
; GFX89-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX89-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x100000
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX89-NEXT:    s_endpgm
...
; GFX9-NEXT:    s_mov_b32 s5, s1
; GFX9-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX9-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x100000
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX9-NEXT:    s_endpgm
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_i32_to_i64:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX89-NEXT:    s_load_dword s8, s[4:5], 0x34
; GFX89-NEXT:    s_mov_b32 s7, 0xf000
...
; GFX89-NEXT:    s_mov_b32 s5, s1
; GFX89-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX89-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x200000
; GFX89-NEXT:    v_mov_b32_e32 v0, s0
; GFX89-NEXT:    v_mov_b32_e32 v1, s1
; GFX89-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX89-NEXT:    s_endpgm
...
; GFX9-NEXT:    s_mov_b32 s5, s1
; GFX9-NEXT:    s_lshl_b64 s[0:1], s[2:3], s8
; GFX9-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x200000
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    buffer_store_dwordx2 v[0:1], off, s[4:7], 0
; GFX9-NEXT:    s_endpgm
...
; GFX89-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX89-NEXT:    s_add_i32 s4, s4, s5
; GFX89-NEXT:    s_bfe_i32 s4, s4, 0x190001
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; GFX9-NEXT:    s_mov_b64 s[4:5], s[2:3]
; GFX9-NEXT:    s_add_i32 s4, s4, s5
; GFX9-NEXT:    s_bfe_i32 s4, s4, 0x190001
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_add_i32 s4, s8, s12
; SI-NEXT:    s_add_i32 s5, s9, s13
; SI-NEXT:    s_add_i32 s6, s10, s14
; SI-NEXT:    s_add_i32 s7, s11, s15
; SI-NEXT:    s_bfe_i32 s7, s7, 0x10000
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_v4i1_to_v4i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x34
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_add_i32 s4, s8, s12
; GFX89-NEXT:    s_add_i32 s5, s9, s13
; GFX89-NEXT:    s_add_i32 s6, s10, s14
; GFX89-NEXT:    s_add_i32 s7, s11, s15
; GFX89-NEXT:    s_bfe_i32 s7, s7, 0x10000
; GFX89-NEXT:    s_bfe_i32 s6, s6, 0x10000
; GFX89-NEXT:    s_bfe_i32 s5, s5, 0x10000
; GFX89-NEXT:    s_bfe_i32 s4, s4, 0x10000
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_add_i32 s4, s8, s12
; GFX9-NEXT:    s_add_i32 s5, s9, s13
; GFX9-NEXT:    s_add_i32 s6, s10, s14
; GFX9-NEXT:    s_add_i32 s7, s11, s15
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: sext_in_reg_v4i8_to_v4i32:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x34
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX89-NEXT:    s_add_i32 s6, s10, s14
; GFX89-NEXT:    s_add_i32 s7, s11, s15
; GFX89-NEXT:    s_sext_i32_i8 s7, s7
; GFX89-NEXT:    s_sext_i32_i8 s6, s6
; GFX89-NEXT:    s_sext_i32_i8 s5, s5
; GFX89-NEXT:    s_sext_i32_i8 s4, s4
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    v_mov_b32_e32 v1, s5
; GFX89-NEXT:    v_mov_b32_e32 v2, s6
...
; SI-NEXT:    s_bfe_i32 s5, s6, 0x10000
; SI-NEXT:    s_max_i32 s4, s4, 0
; SI-NEXT:    s_and_b32 s5, s5, s6
; SI-NEXT:    s_xor_b32 s4, s4, s5
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_byte v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: testcase:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dword s6, s[4:5], 0x2c
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_bfe_i32 s4, s6, 0x10000
; GFX89-NEXT:    s_sext_i32_i8 s5, s6
; GFX89-NEXT:    s_max_i32 s5, s5, 0
; GFX89-NEXT:    s_and_b32 s4, s4, s6
; GFX89-NEXT:    s_xor_b32 s4, s5, s4
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_byte v0, off, s[0:3], 0
; GFX89-NEXT:    s_endpgm
;
; GFX9-LABEL: testcase:
; GFX9:       ; %bb.0:
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s4, s6, 0x10000
; GFX9-NEXT:    s_sext_i32_i8 s5, s6
; GFX9-NEXT:    s_max_i32 s5, s5, 0
...
; SI-NEXT:    v_add_i32_e32 v3, vcc, v7, v3
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_i32 s4, s4, 0x20000
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_short v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    buffer_load_ushort v1, v[2:3], s[0:3], 0 addr64
...
; SI-NEXT:    buffer_load_ushort v2, v[4:5], s[8:11], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    buffer_load_ushort v1, v[4:5], s[0:3], 0 addr64 glc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    s_load_dword s0, s[4:5], 0x9
; SI-NEXT:    s_mov_b32 m0, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ushort v1, v0, s[0:1] glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_i32 s4, s6, 0x20000
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_short v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: s_sext_in_reg_i2_i16_arg:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dword s6, s[4:5], 0x2c
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_lshl_b32 s4, s6, 14
; GFX89-NEXT:    s_sext_i32_i16 s4, s4
; GFX89-NEXT:    s_lshr_b32 s4, s4, 14
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_short v0, off, s[0:3], 0
...
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: s_sext_in_reg_i8_i16_arg:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dword s6, s[4:5], 0x2c
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_bfe_i32 s4, s6, 0x80000
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_short v0, off, s[0:3], 0
; GFX89-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s4, s6, 0x80000
; GFX9-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-NEXT:    buffer_store_short v0, off, s[0:3], 0
; GFX9-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_i32 s4, s6, 0xf0000
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    buffer_store_short v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
; GFX89-LABEL: s_sext_in_reg_i15_i16_arg:
; GFX89:       ; %bb.0:
; GFX89-NEXT:    s_load_dword s6, s[4:5], 0x2c
; GFX89-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX89-NEXT:    s_mov_b32 s3, 0xf000
; GFX89-NEXT:    s_mov_b32 s2, -1
; GFX89-NEXT:    s_waitcnt lgkmcnt(0)
; GFX89-NEXT:    s_lshl_b32 s4, s6, 1
; GFX89-NEXT:    s_sext_i32_i16 s4, s4
; GFX89-NEXT:    s_lshr_b32 s4, s4, 1
; GFX89-NEXT:    v_mov_b32_e32 v0, s4
; GFX89-NEXT:    buffer_store_short v0, off, s[0:3], 0
; GFX89-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_pk_add_u16 v0, s1, v0
; GFX9-NEXT:    v_pk_add_u16 v1, s0, v1
; GFX9-NEXT:    v_pk_lshlrev_b16 v0, 15, v0 op_sel_hi:[0,1]
...
; SI-NEXT:    s_add_i32 s4, s4, s5
; SI-NEXT:    s_add_i32 s6, s6, s7
; SI-NEXT:    s_bfe_i32 s5, s6, 0x20000
; SI-NEXT:    s_bfe_i32 s4, s4, 0x20000
; SI-NEXT:    s_lshl_b32 s5, s5, 16
; SI-NEXT:    s_and_b32 s4, s4, 0xffff
; SI-NEXT:    s_or_b32 s4, s4, s5
