...
; Two independent runtime terms in one address (@buf + %i + %j). The pointer is
; treated structurally as a single runtime byte offset, so both terms are summed
; into one dynamic index rather than rejected.
define amdgpu_kernel void @dyn_two_terms(ptr addrspace(1) %out, i32 %i, i32 %j, i32 %v) {
; GFX942-LABEL: dyn_two_terms:
; GFX942:       ; %bb.0:
...
; GFX942-NEXT:    s_lshl2_add_u32 s0, s1, s0
; GFX942-NEXT:    s_lshr_b32 s0, s0, 2
; GFX942-NEXT:    v_mov_b32_e32 v18, s2
; GFX942-NEXT:    s_min_u32 s0, s0, 15
; GFX942-NEXT:    v_mov_b32_e32 v1, s2
; GFX942-NEXT:    s_set_gpr_idx_on s0, gpr_idx(DST)
; GFX942-NEXT:    v_mov_b32_e32 v2, v1
; GFX942-NEXT:    s_set_gpr_idx_off
; GFX942-NEXT:    global_store_dword v0, v18, s[6:7]
; GFX942-NEXT:    s_endpgm
;
; GFX11-LABEL: dyn_two_terms:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
...
; GFX11-NEXT:    s_lshl2_add_u32 s0, s1, s0
; GFX11-NEXT:    s_lshr_b32 s0, s0, 2
; GFX11-NEXT:    global_store_b32 v0, v1, s[4:5]
; GFX11-NEXT:    s_min_u32 m0, s0, 15
; GFX11-NEXT:    v_movreld_b32_e32 v2, s2
; GFX11-NEXT:    s_endpgm
  %p1 = getelementptr [16 x i32], ptr addrspace(13) @buf, i32 0, i32 %i
  %p2 = getelementptr i32, ptr addrspace(13) %p1, i32 %j
  store i32 %v, ptr addrspace(13) %p2
  %l = load i32, ptr addrspace(13) %p2
  store i32 %l, ptr addrspace(1) %out
  ret void
}
