...
; RUN: llc -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -march=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN %s
