...
; RUN: llc -march=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefix=GCN %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefix=GCN %s
