; RUN: llc -march=amdgcn -mcpu=gfx1010 -verify-machineinstrs -amdgpu-s-branch-bits=4 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS %s
...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -verify-machineinstrs -amdgpu-s-branch-bits=4 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS %s
...
; GFX10PLUS-NEXT: s_cbranch_scc0
; GFX10PLUS: s_getpc_b64
; GFX10PLUS: s_add_u32
; GFX10PLUS: s_addc_u32
; GFX10PLUS: s_setpc_b64
