...
; RUN: llc < %s -mtriple=amdgpu6.01 | FileCheck -check-prefixes=GFX68,VERDE %s
; RUN: llc < %s -mtriple=amdgpu8.02 | FileCheck -check-prefixes=GFX68,GFX8 %s
; RUN: llc < %s -mtriple=amdgpu11.00 | FileCheck -check-prefixes=GFX11 %s
; RUN: llc < %s -mtriple=amdgpu12.00 | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc < %s -mtriple=amdgpu12.50 | FileCheck -check-prefixes=GFX1250 %s
...
; GFX1250-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null offen
; GFX1250-NEXT:    buffer_load_b128 v[8:11], v5, s[0:3], null offen
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_store_b128 v[8:11], v6, s[0:3], null offen
; GFX1250-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> %1, <4 x i32> %0, i32 %2, i32 0, i32 0)
