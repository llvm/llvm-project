...
; GFX12-NEXT:    buffer_store_b128 v[4:7], off, s[0:3], null th:TH_STORE_NT
; GFX12-NEXT:    buffer_store_b128 v[8:11], off, s[0:3], null th:TH_STORE_HT
; GFX12-NEXT:    s_endpgm
;
; GFX13-LABEL: buffer_store:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    s_clause 0x2
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b128 v[4:7], off, s[0:3], null th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b128 v[8:11], off, s[0:3], null th:TH_STORE_HT scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:42
; GFX12-NEXT:    s_endpgm
;
; GFX13-LABEL: buffer_store_immoffs:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:42 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b128 v[0:3], v4, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_load_b128 v[0:3], v5, s[0:3], null offen
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    buffer_store_b128 v[0:3], v6, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
  call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> %1, <4 x i32> %0, i32 %2, i32 0, i32 0)
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b32 v0, v1, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13-NEXT:    buffer_store_b32 v1, v7, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v2, v8, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v3, v9, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v4, v10, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v5, v11, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, v0, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
  %a3 = add i32 %a, 12
...
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b128 v[1:4], v0, s[0:3], null offen offset:4 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[5:6], v0, s[0:3], null offen offset:28 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
  %a = shl i32 %inp, 6
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
...
; GFX13-NEXT:    buffer_store_b32 v1, v7, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v2, v8, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v3, v9, s[0:3], null offen th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v4, v10, s[0:3], null offen th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v5, v11, s[0:3], null offen th:TH_STORE_WB scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, v0, s[0:3], null offen th:TH_STORE_WB scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 8
  %a3 = add i32 %a, 12
...
; GFX13:       ; %bb.0:
; GFX13-NEXT:    v_dual_add_nc_u32 v5, 4, v0 :: v_dual_add_nc_u32 v0, 12, v0
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b64 v[1:2], v5, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[3:4], v0, s[0:3], null offen scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
  %a1 = add i32 %a, 4
  %a2 = add i32 %a, 12
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_x1_offset_merged:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4
; GFX12-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null offset:28
; GFX12-NEXT:    s_endpgm
;
; GFX13-LABEL: buffer_store_x1_offset_merged:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null offset:28 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_x2_offset_merged:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4
; GFX12-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_clause 0x2
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null
; GFX12-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null th:TH_STORE_NT
; GFX12-NEXT:    buffer_store_b32 v6, off, s[0:3], null th:TH_STORE_HT
; GFX12-NEXT:    s_endpgm
;
...
; GFX13-NEXT:    s_clause 0x2
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null th:TH_STORE_NT scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v6, off, s[0:3], null th:TH_STORE_HT scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_byte:
; GFX12:       ; %bb.0: ; %main_body
...
; GFX13-NEXT:    buffer_store_b8 v0, off, s[0:3], null scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_short:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX13-NEXT:    buffer_store_b16 v0, off, s[0:3], null scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
main_body:
  %v2 = fptoui float %v1 to i32
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_f16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b16 v0, off, s[0:3], null
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_v2f16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b32 v0, v1, s[0:3], null offen
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_v4f16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null offen
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_i16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b16 v0, off, s[0:3], null
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_v2i16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b32 v0, v1, s[0:3], null offen
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: buffer_store_v4i16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    buffer_store_b64 v[0:1], v2, s[0:3], null offen
; GFX12-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_x1_offset_merged:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4
; GFX12-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null offset:28
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: raw_buffer_store_x1_offset_swizzled_not_merged_pregfx12:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX12-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null offset:28 scope:SCOPE_SE
; GFX12-NEXT:    s_endpgm
;
; GFX13-LABEL: raw_buffer_store_x1_offset_swizzled_not_merged_pregfx12:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    buffer_store_b128 v[0:3], off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b64 v[4:5], off, s[0:3], null offset:28 scope:SCOPE_SE
...
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_clause 0x5
; GFX13-NEXT:    buffer_store_b32 v0, off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v1, off, s[0:3], null offset:8 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v2, off, s[0:3], null offset:12 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v3, off, s[0:3], null offset:16 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v4, off, s[0:3], null offset:28 scope:SCOPE_SE
; GFX13-NEXT:    buffer_store_b32 v5, off, s[0:3], null offset:32 scope:SCOPE_SE
; GFX13-NEXT:    s_endpgm
