...
; HSA-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; HSA-NEXT:    v_cmp_ne_u64_e64 s[4:5], 0, v[6:7]
; HSA-NEXT:    v_cndmask_b32_e32 v0, -1, v0, vcc
; HSA-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; HSA-NEXT:    v_cndmask_b32_e64 v3, -1, v6, s[4:5]
; HSA-NEXT:    v_cndmask_b32_e32 v1, -1, v2, vcc
; HSA-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[4:5]
; HSA-NEXT:    v_cndmask_b32_e32 v2, -1, v4, vcc
; HSA-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
...
; CI-NEXT:    s_load_dword s4, s[6:7], 0x11
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v0
; CI-NEXT:    v_cmp_ne_u32_e64 s[6:7], -1, v2
; CI-NEXT:    v_cmp_ne_u32_e64 s[8:9], -1, v3
; CI-NEXT:    v_cmp_ne_u32_e64 s[10:11], -1, v4
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_mov_b32_e32 v31, s4
; CI-NEXT:    v_cmp_ne_u32_e64 s[4:5], -1, v1
; CI-NEXT:    v_cndmask_b32_e32 v34, 0, v31, vcc
; CI-NEXT:    v_cndmask_b32_e64 v36, 0, v31, s[4:5]
; CI-NEXT:    v_cndmask_b32_e64 v50, 0, v31, s[6:7]
; CI-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; CI-NEXT:    v_cndmask_b32_e64 v38, 0, v1, s[4:5]
; CI-NEXT:    v_cndmask_b32_e64 v51, 0, v2, s[6:7]
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v5
; CI-NEXT:    v_cmp_ne_u32_e64 s[4:5], -1, v6
; CI-NEXT:    v_cmp_ne_u32_e64 s[6:7], -1, v7
; CI-NEXT:    v_cndmask_b32_e64 v37, 0, v31, s[8:9]
; CI-NEXT:    v_cndmask_b32_e64 v35, 0, v31, s[10:11]
; CI-NEXT:    v_cndmask_b32_e64 v39, 0, v3, s[8:9]
; CI-NEXT:    v_cndmask_b32_e64 v32, 0, v4, s[10:11]
; CI-NEXT:    v_cndmask_b32_e32 v48, 0, v5, vcc
; CI-NEXT:    v_cndmask_b32_e64 v33, 0, v6, s[4:5]
; CI-NEXT:    v_cndmask_b32_e64 v49, 0, v7, s[6:7]
; CI-NEXT:    v_cmp_ne_u32_e64 s[8:9], -1, v8
; CI-NEXT:    v_cmp_ne_u32_e64 s[10:11], -1, v9
; CI-NEXT:    v_cmp_ne_u32_e64 s[12:13], -1, v10
; CI-NEXT:    v_cmp_ne_u32_e64 s[14:15], -1, v11
; CI-NEXT:    v_cmp_ne_u32_e64 s[16:17], -1, v12
; CI-NEXT:    v_cmp_ne_u32_e64 s[18:19], -1, v13
; CI-NEXT:    v_cmp_ne_u32_e64 s[20:21], -1, v14
; CI-NEXT:    v_cmp_ne_u32_e64 s[22:23], -1, v15
; CI-NEXT:    v_cndmask_b32_e64 v16, 0, v8, s[8:9]
; CI-NEXT:    v_cndmask_b32_e64 v18, 0, v9, s[10:11]
; CI-NEXT:    v_cndmask_b32_e64 v20, 0, v10, s[12:13]
; CI-NEXT:    v_cndmask_b32_e64 v22, 0, v11, s[14:15]
; CI-NEXT:    v_cndmask_b32_e64 v24, 0, v12, s[16:17]
; CI-NEXT:    v_cndmask_b32_e64 v26, 0, v13, s[18:19]
; CI-NEXT:    v_cndmask_b32_e64 v28, 0, v14, s[20:21]
; CI-NEXT:    v_cndmask_b32_e64 v30, 0, v15, s[22:23]
; CI-NEXT:    v_cndmask_b32_e32 v11, 0, v31, vcc
; CI-NEXT:    v_cndmask_b32_e64 v13, 0, v31, s[4:5]
; CI-NEXT:    v_cndmask_b32_e64 v15, 0, v31, s[6:7]
; CI-NEXT:    v_cndmask_b32_e64 v17, 0, v31, s[8:9]
; CI-NEXT:    v_cndmask_b32_e64 v19, 0, v31, s[10:11]
; CI-NEXT:    v_cndmask_b32_e64 v21, 0, v31, s[12:13]
; CI-NEXT:    v_cndmask_b32_e64 v23, 0, v31, s[14:15]
; CI-NEXT:    v_cndmask_b32_e64 v25, 0, v31, s[16:17]
; CI-NEXT:    v_cndmask_b32_e64 v27, 0, v31, s[18:19]
; CI-NEXT:    v_cndmask_b32_e64 v29, 0, v31, s[20:21]
; CI-NEXT:    v_cndmask_b32_e64 v31, 0, v31, s[22:23]
; CI-NEXT:    v_mov_b32_e32 v1, v34
; CI-NEXT:    v_mov_b32_e32 v2, v38
; CI-NEXT:    v_mov_b32_e32 v3, v36
; CI-NEXT:    v_mov_b32_e32 v4, v51
; CI-NEXT:    v_mov_b32_e32 v5, v50
; CI-NEXT:    v_mov_b32_e32 v6, v39
; CI-NEXT:    v_mov_b32_e32 v7, v37
; CI-NEXT:    v_mov_b32_e32 v8, v32
; CI-NEXT:    v_mov_b32_e32 v9, v35
; CI-NEXT:    v_mov_b32_e32 v10, v48
; CI-NEXT:    v_mov_b32_e32 v12, v33
; CI-NEXT:    v_mov_b32_e32 v14, v49
; CI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v0
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], -1, v1
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], -1, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v34, 0, v31, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v36, 0, v31, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v50, 0, v31, s[6:7]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[8:9], -1, v3
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[10:11], -1, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v38, 0, v1, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v51, 0, v2, s[6:7]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v5
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[4:5], -1, v6
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[6:7], -1, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v37, 0, v31, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v35, 0, v31, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v39, 0, v3, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v32, 0, v4, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e32 v48, 0, v5, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v33, 0, v6, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v49, 0, v7, s[6:7]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[8:9], -1, v8
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[10:11], -1, v9
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[12:13], -1, v10
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[14:15], -1, v11
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[16:17], -1, v12
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[18:19], -1, v13
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[20:21], -1, v14
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[22:23], -1, v15
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, v8, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v18, 0, v9, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v20, 0, v10, s[12:13]
; GFX9-NEXT:    v_cndmask_b32_e64 v22, 0, v11, s[14:15]
; GFX9-NEXT:    v_cndmask_b32_e64 v24, 0, v12, s[16:17]
; GFX9-NEXT:    v_cndmask_b32_e64 v26, 0, v13, s[18:19]
; GFX9-NEXT:    v_cndmask_b32_e64 v28, 0, v14, s[20:21]
; GFX9-NEXT:    v_cndmask_b32_e64 v30, 0, v15, s[22:23]
; GFX9-NEXT:    v_cndmask_b32_e32 v11, 0, v31, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v13, 0, v31, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v15, 0, v31, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, v31, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v19, 0, v31, s[10:11]
; GFX9-NEXT:    v_cndmask_b32_e64 v21, 0, v31, s[12:13]
; GFX9-NEXT:    v_cndmask_b32_e64 v23, 0, v31, s[14:15]
; GFX9-NEXT:    v_cndmask_b32_e64 v25, 0, v31, s[16:17]
; GFX9-NEXT:    v_cndmask_b32_e64 v27, 0, v31, s[18:19]
; GFX9-NEXT:    v_cndmask_b32_e64 v29, 0, v31, s[20:21]
; GFX9-NEXT:    v_cndmask_b32_e64 v31, 0, v31, s[22:23]
; GFX9-NEXT:    v_mov_b32_e32 v1, v34
; GFX9-NEXT:    v_mov_b32_e32 v2, v38
; GFX9-NEXT:    v_mov_b32_e32 v3, v36
; GFX9-NEXT:    v_mov_b32_e32 v4, v51
; GFX9-NEXT:    v_mov_b32_e32 v5, v50
; GFX9-NEXT:    v_mov_b32_e32 v6, v39
; GFX9-NEXT:    v_mov_b32_e32 v7, v37
; GFX9-NEXT:    v_mov_b32_e32 v8, v32
; GFX9-NEXT:    v_mov_b32_e32 v9, v35
; GFX9-NEXT:    v_mov_b32_e32 v10, v48
; GFX9-NEXT:    v_mov_b32_e32 v12, v33
; GFX9-NEXT:    v_mov_b32_e32 v14, v49
; GFX9-NEXT:    s_setpc_b64 s[30:31]
