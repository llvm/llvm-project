...
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_fma_mixhi_bf16 v0, v2, v1, v3 op_sel_hi:[1,1,1]
...
; GFX1250-REAL16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-REAL16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-REAL16-NEXT:    v_mov_b16_e32 v4.l, v2.l
; GFX1250-REAL16-NEXT:    v_mov_b16_e32 v2.l, v0.l
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr4_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    v_mov_b16_e32 v0.l, v3.l
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-REAL16-NEXT:    v_fma_mixhi_bf16 v0, v2, v1, v4 op_sel_hi:[1,1,1]
; GFX1250-REAL16-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
  %src2.ext = fpext bfloat %src2 to float
...
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_fma_mix_f32_bf16 v0, v0, v1, v3 op_sel_hi:[1,1,1] clamp
...
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_fma_mixhi_bf16 v0, v2, v1, v3 op_sel_hi:[1,1,1] clamp
; GFX1250-REAL16-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
  %src2.ext = fpext bfloat %src2 to float
...
; GFX1250-REAL16-NEXT:    v_mov_b16_e32 v4.l, v0.l
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr3_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr4_hi16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_fma_mixlo_bf16 v1, v4, v2, v3 op_sel_hi:[1,1,1]
; GFX1250-REAL16-NEXT:    v_fma_mixhi_bf16 v0, v4, v2, v3 op_sel_hi:[1,1,1] clamp
