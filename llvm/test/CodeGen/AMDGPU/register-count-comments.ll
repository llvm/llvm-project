; RUN: llc -mtriple=amdgpu6.00 -asm-verbose < %s | FileCheck -check-prefix=SI %s
; RUN: llc -mtriple=amdgpu7.00-unknown-amdhsa -asm-verbose -mattr=-flat-for-global < %s | FileCheck -check-prefix=SI %s
