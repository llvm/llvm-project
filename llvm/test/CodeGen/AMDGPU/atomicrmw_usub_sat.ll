...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00-amd-amdhsa < %s | FileCheck %s -check-prefix=GFX12-SDAG
...
; GFX9-GISEL-NEXT:    v_sub_u32_e64 v2, v3, s2 clamp
; GFX9-GISEL-NEXT:    global_atomic_cmpswap v0, v1, v[2:3], s[0:1] glc
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-GISEL-NEXT:    buffer_wbinvl1_vol
...
; GFX9-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_mov_b32 s3, 0xffff0000
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v0, v3, s2 clamp
; GFX9-GISEL-NEXT:    v_and_or_b32 v2, v3, s3, v0
...
; GFX9-GISEL-NEXT:    v_and_or_b32 v0, v1, s3, v0
...
; GFX9-GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_movk_i32 s3, 0xff00
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-GISEL-NEXT:    v_sub_u16_sdwa v0, v3, s2 clamp dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-GISEL-NEXT:    v_and_or_b32 v2, v3, s3, v0
...
; GFX10-GISEL-NEXT:    s_and_b32 s2, s2, 0xff
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-GISEL-NEXT:    s_mov_b32 s3, 0
...
; GFX10-GISEL-NEXT:    v_sub_nc_u16 v1, v1, s2 clamp
; GFX10-GISEL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
...
; GFX11-GISEL-NEXT:    s_and_b32 s2, s2, 0xff
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX11-GISEL-NEXT:    s_mov_b32 s3, 0
...
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    v_sub_u16_sdwa v0, v1, s2 clamp dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-GISEL-NEXT:    v_and_or_b32 v0, v1, s3, v0
