...
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x10
...
; GFX11-GISEL-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX11-GISEL-NEXT:    global_store_b32 v1, v0, s[4:5]
...
; GFX9-SDAG-NEXT:    s_load_dword s3, s[0:1], 0x1000
; GFX9-SDAG-NEXT:    s_add_u32 s0, s0, 0x1000
; GFX9-SDAG-NEXT:    s_addc_u32 s1, 0, 0
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-SDAG-NEXT:  .LBB4_1: ; %atomicrmw.start
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-SDAG-NEXT:    v_sub_u32_e64 v2, v3, s2 clamp
; GFX9-SDAG-NEXT:    global_atomic_cmpswap v0, v1, v[2:3], s[0:1] glc
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX9-SDAG-NEXT:    buffer_wbinvl1_vol
...
; GFX10-SDAG-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x10
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v0, 0x1000
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    s_mov_b32 s1, 0
...
; GFX11-SDAG-NEXT:    s_load_b64 s[4:5], s[4:5], 0x10
...
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    v_sub_u32_e64 v0, v1, s2 clamp
...
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_sub_u32_e64 v0, v1, s2 clamp
...
; GFX9-SDAG-NEXT:    s_mov_b32 s1, 0
; GFX9-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-SDAG-NEXT:    s_mov_b32 s3, 0xffff0000
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-SDAG-NEXT:    v_sub_u16_e64 v0, v3, s2 clamp
; GFX9-SDAG-NEXT:    v_and_or_b32 v2, v3, s3, v0
...
; GFX10-SDAG-NEXT:    s_add_u32 s4, s0, 0x800
; GFX10-SDAG-NEXT:    s_addc_u32 s5, 0, 0
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-SDAG-NEXT:    global_atomic_cmpswap v1, v0, v[1:2], s[4:5] glc
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    buffer_gl1_inv
; GFX10-SDAG-NEXT:    buffer_gl0_inv
; GFX10-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v2
; GFX10-SDAG-NEXT:    s_or_b32 s1, vcc_lo, s1
; GFX10-SDAG-NEXT:    s_andn2_b32 exec_lo, exec_lo, s1
...
; GFX12-SDAG-NEXT:    s_mov_b32 s3, s1
...
; GFX9-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v0, v1, s2 clamp
...
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_sub_u16_e64 v0, v1, s2 clamp
; GFX9-SDAG-NEXT:    v_and_or_b32 v0, v1, s3, v0
...
; GFX10-SDAG-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX10-SDAG-NEXT:    v_and_or_b32 v0, 0xffff0000, v1, v0
; GFX10-SDAG-NEXT:    global_atomic_cmpswap v0, v2, v[0:1], s[4:5] glc
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    buffer_gl1_inv
; GFX10-SDAG-NEXT:    buffer_gl0_inv
; GFX10-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
...
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v3, v3, s2 clamp
...
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v3, v2
; GFX10-GISEL-NEXT:    v_lshlrev_b16 v2, 8, v3
; GFX10-GISEL-NEXT:    v_sub_nc_u16 v2, v2, s2 clamp
...
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_sub_nc_u16 v1.l, v1.l, s2 clamp
...
; GFX9-SDAG-NEXT:    s_mov_b32 s1, 0
; GFX9-SDAG-NEXT:    s_mov_b64 s[4:5], 0
; GFX9-SDAG-NEXT:    s_movk_i32 s3, 0xff00
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-SDAG-NEXT:    s_load_dword s6, s[0:1], 0x400
; GFX9-SDAG-NEXT:    s_and_b32 s2, s2, 0xff
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-SDAG-NEXT:  .LBB16_1: ; %atomicrmw.start
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v3, v0
; GFX9-SDAG-NEXT:    v_sub_u16_sdwa v0, v3, s2 clamp dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-SDAG-NEXT:    v_and_or_b32 v2, v3, s3, v0
...
; GFX12-SDAG-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_sub_nc_u16 v1, v1, s3 clamp
; GFX12-SDAG-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-SDAG-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v1, v2
; GFX12-SDAG-NEXT:    s_or_b32 s2, vcc_lo, s2
; GFX12-SDAG-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-SDAG-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s2
...
; GFX9-GISEL-NEXT:    v_sub_u16_e64 v0, v0, s2 clamp
...
; GFX9-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-SDAG-NEXT:    v_sub_u16_sdwa v0, v1, s2 clamp dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX9-SDAG-NEXT:    v_and_or_b32 v0, v1, s3, v0
...
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-SDAG-NEXT:    s_mov_b32 s3, s1
