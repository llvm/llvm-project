...
; GCN-NEXT:    global_load_dword v1, v3, s[4:5]
; GCN-NEXT:    global_load_dword v2, v3, s[2:3]
; GCN-NEXT:    s_mov_b32 s2, 0xffff
; GCN-NEXT:    s_waitcnt vmcnt(1)
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 4, v1
; GCN-NEXT:    v_lshlrev_b32_e64 v1, v1, s2
; GCN-NEXT:    s_mov_b32 s2, 0x3e703e7
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_bfi_b32 v1, v1, s2, v2
