...
; CI-LABEL: simple_read2_v4f32_superreg_align4:
; CI:       ; %bb.0:
; CI-NEXT:    v_lshlrev_b32_e32 v3, 4, v0
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    ds_read2_b32 v[1:2], v3 offset0:2 offset1:3
; CI-NEXT:    ds_read2_b32 v[3:4], v3 offset1:1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
...
; CI-NEXT:    ds_read_b32 v3, v3 offset:8
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    ds_read2_b64 v[0:3], v4 offset1:1
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_mov_b32_e32 v5, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    buffer_store_dwordx4 v[0:3], v[4:5], s[0:3], 0 addr64
; CI-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
  %arrayidx0 = getelementptr inbounds [512 x <4 x float>], ptr addrspace(3) @lds.v4, i32 0, i32 %x.i
...
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    ds_read2_b64 v[0:3], v8 offset0:2 offset1:3
; CI-NEXT:    ds_read2_b64 v[4:7], v8 offset1:1
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_mov_b32_e32 v9, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    buffer_store_dwordx4 v[0:3], v[8:9], s[0:3], 0 addr64 offset:16
; CI-NEXT:    buffer_store_dwordx4 v[4:7], v[8:9], s[0:3], 0 addr64
; CI-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; CI-LABEL: simple_read2_v16f32_superreg:
; CI:       ; %bb.0:
; CI-NEXT:    v_lshlrev_b32_e32 v16, 6, v0
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    ds_read2_b64 v[0:3], v16 offset0:4 offset1:5
; CI-NEXT:    ds_read2_b64 v[4:7], v16 offset0:6 offset1:7
; CI-NEXT:    ds_read2_b64 v[8:11], v16 offset1:1
; CI-NEXT:    ds_read2_b64 v[12:15], v16 offset0:2 offset1:3
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_mov_b32_e32 v17, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    buffer_store_dwordx4 v[4:7], v[16:17], s[0:3], 0 addr64 offset:48
; CI-NEXT:    buffer_store_dwordx4 v[0:3], v[16:17], s[0:3], 0 addr64 offset:32
; CI-NEXT:    buffer_store_dwordx4 v[12:15], v[16:17], s[0:3], 0 addr64 offset:16
; CI-NEXT:    buffer_store_dwordx4 v[8:11], v[16:17], s[0:3], 0 addr64
; CI-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    ds_read2_b32 v[1:2], v1 offset1:1
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_lshlrev_b32_e32 v3, 3, v0
; CI-NEXT:    v_mov_b32_e32 v4, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    buffer_store_dwordx2 v[1:2], v[3:4], s[0:3], 0 addr64
; CI-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    ds_read2_b32 v[1:2], v3 offset1:1
; CI-NEXT:    ds_read2_b32 v[3:4], v3 offset0:2 offset1:3
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, 0
; CI-NEXT:    v_lshlrev_b32_e32 v5, 4, v0
; CI-NEXT:    v_mov_b32_e32 v6, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    buffer_store_dwordx4 v[1:4], v[5:6], s[0:3], 0 addr64
; CI-NEXT:    s_endpgm
  %x.i = tail call i32 @llvm.amdgcn.workitem.id.x() #1
  %arrayidx0 = getelementptr inbounds [512 x float], ptr addrspace(3) @lds, i32 0, i32 %x.i
  %arrayidx1 = getelementptr inbounds float, ptr addrspace(3) %arrayidx0, i32 1
