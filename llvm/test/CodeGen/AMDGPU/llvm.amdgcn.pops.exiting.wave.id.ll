...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s -check-prefixes=GFX9,SDAG,GFX9-SDAG
...
; GFX10-SDAG-NEXT:    s_add_u32 s0, s0, foo@gotpcrel32@lo+4
; GFX10-SDAG-NEXT:    s_addc_u32 s1, s1, foo@gotpcrel32@hi+12
...
; GFX10-GISEL-NEXT:    s_add_u32 s0, s0, foo@gotpcrel32@lo+4
; GFX10-GISEL-NEXT:    s_addc_u32 s1, s1, foo@gotpcrel32@hi+12
