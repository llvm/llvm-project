...
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx4 v[4:7], v8, s[38:39]
; GFX942-NEXT:    global_load_dwordx4 v[0:3], v8, s[38:39] offset:16
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_cndmask_b32_e64 v14, v3, v9, s[14:15]
...
; GFX942-NEXT:    v_cndmask_b32_e64 v15, v2, v9, s[18:19]
...
; GFX942-NEXT:    v_cndmask_b32_e64 v16, v1, v9, s[22:23]
...
; GFX942-NEXT:    v_cndmask_b32_e64 v17, v0, v9, s[26:27]
; GFX942-NEXT:    v_cndmask_b32_sdwa v0, v0, v9, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX942-NEXT:    v_perm_b32 v3, v3, v14, s30
; GFX942-NEXT:    v_perm_b32 v2, v2, v15, s30
; GFX942-NEXT:    v_perm_b32 v1, v1, v16, s30
; GFX942-NEXT:    v_perm_b32 v0, v0, v17, s30
; GFX942-NEXT:    v_perm_b32 v7, v7, v10, s30
; GFX942-NEXT:    v_perm_b32 v6, v6, v11, s30
; GFX942-NEXT:    v_perm_b32 v5, v5, v12, s30
; GFX942-NEXT:    v_perm_b32 v4, v4, v13, s30
; GFX942-NEXT:    global_store_dwordx4 v8, v[0:3], s[36:37] offset:16
; GFX942-NEXT:    global_store_dwordx4 v8, v[4:7], s[36:37]
; GFX942-NEXT:    s_endpgm
;
