...
; GFX1210-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX1210-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b32 s4, s[4:5], 0x30
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b64 v[0:1], v2, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_bfi_b32 v0, 0xffff, s4, v0
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    v_and_b32_e32 v2, 0x3ff, v0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b32 s4, s[4:5], 0x10
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b64 v[0:1], v2, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_perm_b32 v0, s4, v0, 0x5040100
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    global_load_b64 v[0:1], v2, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_bfi_b32 v1, 0xffff, s4, v1
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    global_load_b64 v[0:1], v2, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_perm_b32 v1, s4, v1, 0x5040100
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    global_load_b64 v[0:1], v2, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_lshl_b32 s2, s5, 4
; GFX1210-NEXT:    s_pack_ll_b32_b16 s4, s4, s4
; GFX1210-NEXT:    s_lshl_b64 s[2:3], 0xffff, s2
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_bfi_b32 v1, s3, s4, v1
; GFX1210-NEXT:    v_bfi_b32 v0, s2, s4, v0
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    s_load_b32 s4, s[4:5], 0x10
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b128 v[0:3], v4, s[2:3] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_perm_b32 v1, s4, v1, 0x5040100
; GFX1210-NEXT:    global_store_b128 v4, v[0:3], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_b128 v[0:3], v4, s[2:3] scale_offset
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 6
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 7
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_cndmask_b32_e64 v5, v3, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 4
; GFX1210-NEXT:    v_dual_lshrrev_b32 v3, 16, v3 :: v_dual_lshrrev_b32 v6, 16, v2
; GFX1210-NEXT:    s_cselect_b32 s3, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 5
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v2, v2, s4, s3
; GFX1210-NEXT:    s_cselect_b32 s3, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 2
; GFX1210-NEXT:    v_dual_lshrrev_b32 v7, 16, v1 :: v_dual_lshrrev_b32 v8, 16, v0
; GFX1210-NEXT:    v_cndmask_b32_e64 v3, v3, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 3
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v1, v1, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v7, v7, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, v0, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    v_cndmask_b32_e64 v6, v6, s4, s3
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v8, v8, s4, s2
; GFX1210-NEXT:    v_perm_b32 v3, v3, v5, 0x5040100
; GFX1210-NEXT:    v_perm_b32 v1, v7, v1, 0x5040100
; GFX1210-NEXT:    v_perm_b32 v2, v6, v2, 0x5040100
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1210-NEXT:    v_perm_b32 v0, v8, v0, 0x5040100
; GFX1210-NEXT:    global_store_b128 v4, v[0:3], s[0:1] scale_offset
; GFX1210-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_load_b128 v[0:3], v8, s[2:3]
; GFX1210-NEXT:    global_load_b128 v[4:7], v8, s[2:3] offset:16
; GFX1210-NEXT:    s_wait_loadcnt 0x1
; GFX1210-NEXT:    v_perm_b32 v1, s4, v1, 0x5040100
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_clause 0x1
...
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 7
; GFX1210-NEXT:    s_wait_loadcnt 0x1
; GFX1210-NEXT:    v_cndmask_b32_e64 v9, v3, s4, s2
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v11, v11, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, v0, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 14
; GFX1210-NEXT:    v_cndmask_b32_e64 v10, v10, s4, s3
; GFX1210-NEXT:    v_perm_b32 v3, v3, v9, 0x5040100
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v9, v12, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 15
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v7, v7, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 12
; GFX1210-NEXT:    v_dual_lshrrev_b32 v14, 16, v6 :: v_dual_lshrrev_b32 v15, 16, v5
; GFX1210-NEXT:    v_perm_b32 v2, v10, v2, 0x5040100
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v10, v13, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 13
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v6, v6, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 10
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v12, v14, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 11
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v5, v5, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 8
; GFX1210-NEXT:    v_lshrrev_b32_e32 v16, 16, v4
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v13, v15, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s5, 9
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v4, v4, s4, s2
; GFX1210-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1210-NEXT:    v_perm_b32 v7, v10, v7, 0x5040100
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v14, v16, s4, s2
