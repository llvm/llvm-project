...
; GFX8DAGISEL-NEXT:    s_sext_i32_i16 s2, s2
...
; GFX1164DAGISEL-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
...
; GFX1132DAGISEL-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
