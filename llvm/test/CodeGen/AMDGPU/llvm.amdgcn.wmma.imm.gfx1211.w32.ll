...
; RUN: llc -march=amdgcn -mcpu=gfx1211 -verify-machineinstrs < %s | FileCheck %s --check-prefix=GFX1211
; RUN: llc -march=amdgcn -mcpu=gfx1211 -global-isel -verify-machineinstrs < %s | FileCheck %s --check-prefix=GISEL

define amdgpu_ps void @test_wmma_f64_16x16x4_f64(<2 x double> %A, <2 x double> %B, ptr addrspace(1) %out) {
; GFX1211-LABEL: test_wmma_f64_16x16x4_f64:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_wmma_f64_16x16x4_f64 v[10:25], v[0:3], v[4:7], 1.0
; GFX1211-NEXT:    s_clause 0x3
; GFX1211-NEXT:    global_store_b128 v[8:9], v[22:25], off offset:48
; GFX1211-NEXT:    global_store_b128 v[8:9], v[18:21], off offset:32
; GFX1211-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
; GFX1211-NEXT:    global_store_b128 v[8:9], v[10:13], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1211-NEXT:    s_endpgm
;
...
; GFX1211-NEXT:    v_dual_mov_b32 v18, v10 :: v_dual_mov_b32 v19, v11
; GFX1211-NEXT:    v_dual_mov_b32 v20, v10 :: v_dual_mov_b32 v21, v11
; GFX1211-NEXT:    v_dual_mov_b32 v22, v10 :: v_dual_mov_b32 v23, v11
; GFX1211-NEXT:    v_dual_mov_b32 v24, v10 :: v_dual_mov_b32 v25, v11
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1211-NEXT:    v_wmma_f64_16x16x4_f64 v[10:25], v[0:3], v[4:7], v[10:25]
; GFX1211-NEXT:    s_clause 0x3
; GFX1211-NEXT:    global_store_b128 v[8:9], v[22:25], off offset:48
; GFX1211-NEXT:    global_store_b128 v[8:9], v[18:21], off offset:32
; GFX1211-NEXT:    global_store_b128 v[8:9], v[14:17], off offset:16
...
; GFX1211-LABEL: test_wmma_f64_16x16x4_f64_non_inlineable:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_dual_mov_b32 v10, 0 :: v_dual_mov_b32 v11, 0x40080000
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v12, v10 :: v_dual_mov_b32 v13, v11
; GFX1211-NEXT:    v_dual_mov_b32 v14, v10 :: v_dual_mov_b32 v15, v11
; GFX1211-NEXT:    v_dual_mov_b32 v16, v10 :: v_dual_mov_b32 v17, v11
; GFX1211-NEXT:    v_dual_mov_b32 v18, v10 :: v_dual_mov_b32 v19, v11
; GFX1211-NEXT:    v_dual_mov_b32 v20, v10 :: v_dual_mov_b32 v21, v11
; GFX1211-NEXT:    v_dual_mov_b32 v22, v10 :: v_dual_mov_b32 v23, v11
...
; GFX1211-LABEL: test_wmma_f64_16x16x8_f64:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_wmma_f64_16x16x8_f64 v[18:33], v[0:7], v[8:15], 1.0
; GFX1211-NEXT:    s_clause 0x3
; GFX1211-NEXT:    global_store_b128 v[16:17], v[30:33], off offset:48
; GFX1211-NEXT:    global_store_b128 v[16:17], v[26:29], off offset:32
; GFX1211-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1211-NEXT:    s_endpgm
;
...
; GFX1211-NEXT:    v_dual_mov_b32 v26, v18 :: v_dual_mov_b32 v27, v19
; GFX1211-NEXT:    v_dual_mov_b32 v28, v18 :: v_dual_mov_b32 v29, v19
; GFX1211-NEXT:    v_dual_mov_b32 v30, v18 :: v_dual_mov_b32 v31, v19
; GFX1211-NEXT:    v_dual_mov_b32 v32, v18 :: v_dual_mov_b32 v33, v19
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1211-NEXT:    v_wmma_f64_16x16x8_f64 v[18:33], v[0:7], v[8:15], v[18:33]
; GFX1211-NEXT:    s_clause 0x3
; GFX1211-NEXT:    global_store_b128 v[16:17], v[30:33], off offset:48
; GFX1211-NEXT:    global_store_b128 v[16:17], v[26:29], off offset:32
; GFX1211-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
...
; GFX1211-LABEL: test_wmma_f64_16x16x8_f64_non_inlineable:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_dual_mov_b32 v18, 0 :: v_dual_mov_b32 v19, 0x40080000
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v20, v18 :: v_dual_mov_b32 v21, v19
; GFX1211-NEXT:    v_dual_mov_b32 v22, v18 :: v_dual_mov_b32 v23, v19
; GFX1211-NEXT:    v_dual_mov_b32 v24, v18 :: v_dual_mov_b32 v25, v19
; GFX1211-NEXT:    v_dual_mov_b32 v26, v18 :: v_dual_mov_b32 v27, v19
; GFX1211-NEXT:    v_dual_mov_b32 v28, v18 :: v_dual_mov_b32 v29, v19
; GFX1211-NEXT:    v_dual_mov_b32 v30, v18 :: v_dual_mov_b32 v31, v19
...
; GFX1211-LABEL: test_wmma_f32_16x16x32_f16:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], 1.0
; GFX1211-NEXT:    s_clause 0x1
; GFX1211-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1211-NEXT:    s_endpgm
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x float> <float 1.0, float 1.0, float 1.0, float 1.0, float 1.0, float 1.0, float 1.0, float 1.0>)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f32_16x16x32_f16_non_splat(<16 x half> %A, <16 x half> %B, ptr addrspace(1) %out) {
; GFX1211-LABEL: test_wmma_f32_16x16x32_f16_non_splat:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_dual_mov_b32 v18, 1.0 :: v_dual_mov_b32 v20, 2.0
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v21, v18
; GFX1211-NEXT:    v_dual_mov_b32 v22, v18 :: v_dual_mov_b32 v23, v18
; GFX1211-NEXT:    v_dual_mov_b32 v24, v18 :: v_dual_mov_b32 v25, v18
; GFX1211-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], v[18:25]
; GFX1211-NEXT:    s_clause 0x1
; GFX1211-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x float> <float 1.0, float 1.0, float 2.0, float 1.0, float 1.0, float 1.0, float 1.0, float 1.0>)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f32_16x16x32_f16_non_inlineable(<16 x half> %A, <16 x half> %B, ptr addrspace(1) %out) {
; GFX1211-LABEL: test_wmma_f32_16x16x32_f16_non_inlineable:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_mov_b32_e32 v18, 0x40400000
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v20, v18
; GFX1211-NEXT:    v_dual_mov_b32 v21, v18 :: v_dual_mov_b32 v22, v18
; GFX1211-NEXT:    v_dual_mov_b32 v23, v18 :: v_dual_mov_b32 v24, v18
; GFX1211-NEXT:    v_mov_b32_e32 v25, v18
; GFX1211-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], v[18:25]
; GFX1211-NEXT:    s_clause 0x1
; GFX1211-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x float> <float 3.0, float 3.0, float 3.0, float 3.0, float 3.0, float 3.0, float 3.0, float 3.0>)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f16_16x16x32_f16(<16 x half> %A, <16 x half> %B, ptr addrspace(1) %out) {
; GFX1211-LABEL: test_wmma_f16_16x16x32_f16:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], 1.0
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1211-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x half> <half 1.0, half 1.0, half 1.0, half 1.0, half 1.0, half 1.0, half 1.0, half 1.0>)
...
; GFX1211-LABEL: test_wmma_f16_16x16x32_f16_non_splat:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_mov_b32_e32 v18, 0x3c003c00
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v19, 0x3c004000 :: v_dual_mov_b32 v20, v18
; GFX1211-NEXT:    v_mov_b32_e32 v21, v18
; GFX1211-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], v[18:21]
; GFX1211-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1211-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1211-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x half> <half 1.0, half 1.0, half 2.0, half 1.0, half 1.0, half 1.0, half 1.0, half 1.0>)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f16_16x16x32_f16_non_inlineable(<16 x half> %A, <16 x half> %B, ptr addrspace(1) %out) {
; GFX1211-LABEL: test_wmma_f16_16x16x32_f16_non_inlineable:
; GFX1211:       ; %bb.0: ; %bb
; GFX1211-NEXT:    v_mov_b32_e32 v18, 0x42004200
; GFX1211-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1211-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v20, v18
; GFX1211-NEXT:    v_mov_b32_e32 v21, v18
; GFX1211-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], v[18:21]
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x half> <half 3.0, half 3.0, half 3.0, half 3.0, half 3.0, half 3.0, half 3.0, half 3.0>)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
