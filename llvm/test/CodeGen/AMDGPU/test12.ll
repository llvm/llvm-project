...
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 38.0
; CHECK-NEXT: Next-use distance of Register [[Reg25]] = 27040035070.0
; CHECK-NEXT: Next-use distance of Register [[Reg24]] = 27015105.0
; CHECK-NEXT: Next-use distance of Register [[Reg23]] = 106.0
; CHECK-NEXT: Next-use distance of Register [[Reg22]] = 27088.0
; CHECK-NEXT: Next-use distance of Register [[Reg21]] = 27040086.0
; CHECK-NEXT: Next-use distance of Register [[Reg20]] = 35.0
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 34.0
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 34.0
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 33.0
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 33.0
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 32.0
; CHECK-NEXT: Next-use distance of Register [[Reg14]] = 32.0
; CHECK-NEXT: Next-use distance of Register [[Reg13]] = 31.0
; CHECK-NEXT: Next-use distance of Register [[Reg12]] = 31.0
; CHECK-NEXT: Next-use distance of Register [[Reg11]] = 30.0
; CHECK-NEXT: Next-use distance of Register [[Reg10]] = 30.0
; CHECK-NEXT: Next-use distance of Register [[Reg9]] = 29.0
; CHECK-NEXT: Next-use distance of Register [[Reg8]] = 29.0
; CHECK-NEXT: Next-use distance of Register [[Reg7]] = 28.0
; CHECK-NEXT: Next-use distance of Register [[Reg6]] = 28.0
; CHECK-NEXT: Next-use distance of Register [[Reg5]] = 27.0
; CHECK-NEXT: Next-use distance of Register [[Reg4]] = 27.0
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 26.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg34]] = 4.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg38]] = 3.0
; CHECK-NEXT: Next-use distance of Register [[Reg39]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg40]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg41]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg42]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg43]] = 27047.0
; CHECK-NEXT: Next-use distance of Register [[Reg44]] = 62.0
; CHECK-NEXT: Next-use distance of Register [[Reg45]] = 60.0
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 58.0
; CHECK-NEXT: Next-use distance of Register [[Reg47]] = 27040035020.0
; CHECK-NEXT: Next-use distance of Register [[Reg48]] = 27040042.0
; CHECK-NEXT: Next-use distance of Register [[Reg49]] = 27015052.0
; CHECK-NEXT: Next-use distance of Register [[Reg50]] = 27015046.0
; CHECK-NEXT: Next-use distance of Register [[Reg51]] = 40.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg56]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg57]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg58]] = 27040035005.0
; CHECK-NEXT: Next-use distance of Register [[Reg59]] = 4.0
; CHECK-NEXT: Next-use distance of Register [[Reg60]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg61]] = 4.0
; CHECK-NEXT: Next-use distance of Register [[Reg62]] = 27040032.0
; CHECK-NEXT: Next-use distance of Register [[Reg64]] = 19.0
; CHECK-NEXT: Next-use distance of Register [[Reg66]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg68]] = 27015026.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg79]] = 4.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg83]] = 4.0
; CHECK-NEXT: Next-use distance of Register [[Reg84]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg85]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg86]] = 27012.0
; CHECK-NEXT: Next-use distance of Register [[Reg88]] = 17.0
; CHECK-NEXT: Next-use distance of Register [[Reg90]] = 5.0
; CHECK-NEXT: Next-use distance of Register [[Reg92]] = 27015016.0
; CHECK-NEXT: Next-use distance of Register [[Reg94]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg95]] = 24.0
; CHECK-NEXT: Next-use distance of Register [[Reg97]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg99]] = 8.0
; CHECK-NEXT: Next-use distance of Register [[Reg100]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg101]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg102]] = 4.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg106]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg107]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg108]] = 5.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg69]] = 6.0
; CHECK-NEXT: Next-use distance of Register [[Reg112]] = 5.0
; CHECK-NEXT: Next-use distance of Register [[Reg93]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg113]] = 27015010.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg117]] = 27015011.0
; CHECK-NEXT: Next-use distance of Register [[Reg118]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg89]] = 6.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg123]] = 3.0
; CHECK-NEXT: Next-use distance of Register [[Reg124]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg125]] = 22.0
; CHECK-NEXT: Next-use distance of Register [[Reg127]] = 8.0
; CHECK-NEXT: Next-use distance of Register [[Reg129]] = 12.0
; CHECK-NEXT: Next-use distance of Register [[Reg131]] = 3.0
; CHECK-NEXT: Next-use distance of Register [[Reg132]] = 7.0
; CHECK-NEXT: Next-use distance of Register [[Reg134]] = 2.0
; CHECK-NEXT: Next-use distance of Register [[Reg136]] = 11.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg141]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg130]] = 7.0
; CHECK-NEXT: Next-use distance of Register [[Reg142]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg133]] = 13.0
; CHECK-NEXT: Next-use distance of Register [[Reg143]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg144]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg135]] = 11.0
; CHECK-NEXT: Next-use distance of Register [[Reg128]] = 6.0
; CHECK-NEXT: Next-use distance of Register [[Reg145]] = 1.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg150]] = 3.0
; CHECK-NEXT: Next-use distance of Register [[Reg151]] = 4.0
; CHECK-NEXT: Next-use distance of Register [[Reg152]] = 1.0
; CHECK-NEXT: Next-use distance of Register [[Reg153]] = 4.0
...
; CHECK-NEXT: Next-use distance of Register [[Reg158]] = 2.0
