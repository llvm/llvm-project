...
; HSA-TRAP-LABEL: hsa_trap:
; HSA-TRAP:       ; %bb.0:
; HSA-TRAP-NEXT:    s_load_dwordx2 s[2:3], s[8:9], 0x0
; HSA-TRAP-NEXT:    s_add_i32 s12, s12, s17
; HSA-TRAP-NEXT:    s_mov_b32 flat_scratch_lo, s13
; HSA-TRAP-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; HSA-TRAP-NEXT:    v_mov_b32_e32 v2, 1
; HSA-TRAP-NEXT:    s_waitcnt lgkmcnt(0)
; HSA-TRAP-NEXT:    v_mov_b32_e32 v0, s2
; HSA-TRAP-NEXT:    v_mov_b32_e32 v1, s3
; HSA-TRAP-NEXT:    s_mov_b64 s[0:1], s[6:7]
; HSA-TRAP-NEXT:    flat_store_dword v[0:1], v2
; HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-NEXT:    s_trap 2
;
; NO-HSA-TRAP-LABEL: hsa_trap:
; NO-HSA-TRAP:       ; %bb.0:
; NO-HSA-TRAP-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; NO-HSA-TRAP-NEXT:    s_add_i32 s12, s12, s17
; NO-HSA-TRAP-NEXT:    s_mov_b32 flat_scratch_lo, s13
; NO-HSA-TRAP-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v2, 1
; NO-HSA-TRAP-NEXT:    s_waitcnt lgkmcnt(0)
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v0, s0
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v1, s1
; NO-HSA-TRAP-NEXT:    flat_store_dword v[0:1], v2
; NO-HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; NO-HSA-TRAP-NEXT:    s_endpgm
...
; HSA-TRAP-LABEL: hsa_debugtrap:
; HSA-TRAP:       ; %bb.0:
; HSA-TRAP-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; HSA-TRAP-NEXT:    s_add_i32 s12, s12, s17
; HSA-TRAP-NEXT:    s_mov_b32 flat_scratch_lo, s13
; HSA-TRAP-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; HSA-TRAP-NEXT:    v_mov_b32_e32 v2, 1
; HSA-TRAP-NEXT:    v_mov_b32_e32 v3, 2
; HSA-TRAP-NEXT:    s_waitcnt lgkmcnt(0)
; HSA-TRAP-NEXT:    v_mov_b32_e32 v0, s0
; HSA-TRAP-NEXT:    v_mov_b32_e32 v1, s1
; HSA-TRAP-NEXT:    flat_store_dword v[0:1], v2
; HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-NEXT:    s_trap 3
; HSA-TRAP-NEXT:    flat_store_dword v[0:1], v3
; HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-NEXT:    s_endpgm
;
; NO-HSA-TRAP-LABEL: hsa_debugtrap:
; NO-HSA-TRAP:       ; %bb.0:
; NO-HSA-TRAP-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; NO-HSA-TRAP-NEXT:    s_add_i32 s12, s12, s17
; NO-HSA-TRAP-NEXT:    s_mov_b32 flat_scratch_lo, s13
...
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v0, s0
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v1, s1
; NO-HSA-TRAP-NEXT:    v_mov_b32_e32 v3, 2
; NO-HSA-TRAP-NEXT:    flat_store_dword v[0:1], v2
; NO-HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; NO-HSA-TRAP-NEXT:    flat_store_dword v[0:1], v3
; NO-HSA-TRAP-NEXT:    s_waitcnt vmcnt(0)
; NO-HSA-TRAP-NEXT:    s_endpgm
  store volatile i32 1, ptr addrspace(1) %arg0
