...
; MUBUF-NEXT:    buffer_load_dword v3, v1, s[0:3], 0 offen offset:4
; MUBUF-NEXT:    buffer_load_dword v4, v0, s[0:3], 0 offen
; MUBUF-NEXT:    buffer_load_dword v5, v0, s[0:3], 0 offen offset:4
...
; MUBUF-NEXT:    buffer_load_dword v5, v3, s[0:3], 0 offen offset:4
; MUBUF-NEXT:    buffer_load_dword v6, v2, s[0:3], 0 offen
; MUBUF-NEXT:    buffer_load_dword v7, v2, s[0:3], 0 offen offset:4
