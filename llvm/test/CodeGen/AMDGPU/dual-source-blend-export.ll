...
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck %s -check-prefix=GCN
...
; GCN-NEXT:    v_mbcnt_lo_u32_b32 v9, -1, 0
; GCN-NEXT:    v_interp_p10_f32 v8, v5, v3, v5 wait_exp:2
...
; GCN-NEXT:    v_interp_p2_f32 v5, v5, v2, v8 wait_exp:7
...
; GCN-NEXT:    v_and_b32_e32 v8, 1, v9
