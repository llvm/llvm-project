...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_sub_f32_e32 v0, v1, v0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
  %src0.ext.neg = fneg float %src0.ext
...
; GFX1250-NEXT:    v_dual_lshlrev_b32 v0, 16, v0 :: v_dual_lshlrev_b32 v1, 16, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_sub_f32_e64 v0, v1, |v0|
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %src0.ext = fpext bfloat %src0 to float
  %src1.ext = fpext bfloat %src1 to float
  %src0.ext.abs = call float @llvm.fabs.f32(float %src0.ext)
...
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    v_and_b32_e32 v0, 0x7fff, v0
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_dual_lshlrev_b32 v1, 16, v1 :: v_dual_lshlrev_b32 v0, 16, v0
; GFX1250-FAKE16-NEXT:    v_sub_f32_e32 v0, v1, v0
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX1250-REAL16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-REAL16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-REAL16-NEXT:    v_and_b16 v0.l, 0x7fff, v0.l
; GFX1250-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-REAL16-NEXT:    v_dual_lshlrev_b32 v1, 16, v1 :: v_dual_lshlrev_b32 v0, 16, v0
; GFX1250-REAL16-NEXT:    v_sub_f32_e32 v0, v1, v0
; GFX1250-REAL16-NEXT:    s_set_pc_i64 s[30:31]
  %src0.arg.bc = bitcast i32 %src0.arg to <2 x bfloat>
  %src0 = extractelement <2 x bfloat> %src0.arg.bc, i32 0
  %src0.fabs = call bfloat @llvm.fabs.bf16(bfloat %src0)
