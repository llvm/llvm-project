...
; RUN: llc < %s -mtriple=amdgpu8.02  | FileCheck %s --check-prefix=VI
; RUN: llc < %s -mtriple=amdgpu9.00 | FileCheck %s --check-prefix=GFX9
...
; SI-NEXT:    s_lshr_b32 s9, s2, 1
; SI-NEXT:    s_lshr_b64 s[0:1], s[0:1], 1
; SI-NEXT:    s_not_b32 s2, s8
...
; GFX9-NEXT:    s_lshr_b32 s7, s2, 1
; GFX9-NEXT:    s_lshr_b64 s[2:3], s[4:5], 1
; GFX9-NEXT:    s_not_b32 s4, s6
; GFX9-NEXT:    s_mov_b32 s3, s7
; GFX9-NEXT:    s_and_b32 s4, s4, 31
...
; GFX10-NEXT:    s_lshr_b32 s7, s2, 1
; GFX10-NEXT:    s_not_b32 s6, s6
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], 1
; GFX10-NEXT:    s_mov_b32 s3, s7
; GFX10-NEXT:    s_and_b32 s4, s6, 31
...
; GFX11-NEXT:    s_lshr_b32 s7, s2, 1
; GFX11-NEXT:    s_not_b32 s6, s6
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[4:5], 1
; GFX11-NEXT:    s_mov_b32 s3, s7
; GFX11-NEXT:    s_and_b32 s4, s6, 31
...
; VI-NEXT:    s_mov_b32 s0, s3
; VI-NEXT:    s_mov_b32 s1, s2
; VI-NEXT:    s_lshr_b64 s[0:1], s[0:1], 25
; VI-NEXT:    v_mov_b32_e32 v2, s0
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
;
...
; SI-NEXT:    s_cselect_b32 s0, s3, s2
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s0
; SI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; SI-NEXT:    s_endpgm
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_lshl_b32 s0, s2, 7
; VI-NEXT:    s_or_b32 s0, s3, s0
; VI-NEXT:    s_cselect_b32 s0, s3, s2
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mov_b32_e32 v2, s0
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
