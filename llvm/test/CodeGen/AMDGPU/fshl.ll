...
; RUN: llc < %s -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefix=GFX11
...
; GFX11-NEXT:    s_load_b64 s[6:7], s[0:1], 0x3c
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
