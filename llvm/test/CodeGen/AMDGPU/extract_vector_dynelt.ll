...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_11
...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_19
...
; GCN-O0-NEXT:    ; kill: def $sgpr0 killed $sgpr0 killed $sgpr0_1
...
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_5
; GCN-O0-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_7
...
; GCN-O0-NEXT:    ; kill: def $sgpr36 killed $sgpr36 killed $sgpr36_37
; GCN-O0-NEXT:    ; implicit-def: $sgpr4
; GCN-O0-NEXT:    ; implicit-def: $sgpr3
; GCN-O0-NEXT:    ; implicit-def: $sgpr3
; GCN-O0-NEXT:    ; implicit-def: $sgpr35
; GCN-O0-NEXT:    ; kill: def $sgpr36 killed $sgpr36 def $sgpr36_67
...
; GCN-O0-NEXT:    ; kill: def $sgpr42 killed $sgpr42 def $sgpr42_43
...
; GCN-O0-NEXT:    ; kill: def $sgpr40 killed $sgpr40 def $sgpr40_41
