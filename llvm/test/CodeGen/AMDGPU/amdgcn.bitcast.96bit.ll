...
; GCN-NEXT:    v_lshlrev_b32_e32 v15, 24, v3
; GCN-NEXT:    v_lshlrev_b32_e32 v12, 8, v5
...
; GCN-NEXT:    v_and_b32_e32 v2, 0xff, v2
; GCN-NEXT:    v_add_i32_e32 v4, vcc, 3, v10
...
; GCN-NEXT:    v_alignbit_b32 v0, v0, v9, 16
; GCN-NEXT:    v_alignbit_b32 v1, v1, v7, 16
...
; GCN-NEXT:    v_lshlrev_b32_e32 v12, 16, v2
; GCN-NEXT:    v_and_b32_e32 v2, 0xff, v6
; GCN-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GCN-NEXT:    v_or_b32_e32 v3, v7, v2
; GCN-NEXT:    v_and_b32_e32 v2, 0xff, v8
; GCN-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
...
; GCN-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GCN-NEXT:    v_or_b32_e32 v1, v15, v1
; GCN-NEXT:    v_or_b32_e32 v5, v16, v2
; GCN-NEXT:    ; implicit-def: $vgpr13
; GCN-NEXT:    ; implicit-def: $vgpr14
; GCN-NEXT:    ; implicit-def: $vgpr2
; GCN-NEXT:    ; implicit-def: $vgpr4
...
; GCN-NEXT:    v_or_b32_e32 v0, v1, v0
; GCN-NEXT:    s_mov_b32 s7, 0x3000000
; GCN-NEXT:    v_add_i32_e32 v8, vcc, s7, v0
...
; GCN-NEXT:    v_add_i32_e32 v0, vcc, 3, v13
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 8, v14
; GCN-NEXT:    v_or_b32_e32 v0, v1, v0
...
; GCN-NEXT:    v_lshlrev_b32_e32 v11, 16, v8
...
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GCN-NEXT:    v_mul_f32_e32 v16, 1.0, v1
; GCN-NEXT:    v_mul_f32_e32 v17, 1.0, v0
; GCN-NEXT:    v_mul_f32_e32 v14, 1.0, v3
; GCN-NEXT:    v_mul_f32_e32 v15, 1.0, v2
...
; GCN-NEXT:    v_lshlrev_b32_e32 v15, 8, v3
...
; GCN-NEXT:    v_or_b32_e32 v1, v1, v15
...
; GCN-NEXT:    v_add_i32_e32 v5, vcc, 0x300, v0
; GCN-NEXT:    v_add_i32_e32 v0, vcc, 3, v8
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GCN-NEXT:    s_movk_i32 s6, 0x300
; GCN-NEXT:    v_or_b32_e32 v0, v17, v0
...
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v12
; GCN-NEXT:    v_lshlrev_b32_e32 v16, 8, v5
; GCN-NEXT:    v_lshlrev_b32_e32 v12, 24, v7
...
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GCN-NEXT:    v_or_b32_e32 v3, v12, v1
; GCN-NEXT:    v_or_b32_e32 v2, v0, v3
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v15
; GCN-NEXT:    v_and_b32_e32 v4, 0xff, v13
; GCN-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
...
; GCN-NEXT:    v_lshlrev_b32_e32 v17, 16, v15
; GCN-NEXT:    ; implicit-def: $vgpr0
; GCN-NEXT:    ; implicit-def: $vgpr1
; GCN-NEXT:    ; implicit-def: $vgpr2
; GCN-NEXT:    ; implicit-def: $vgpr3
...
; GCN-NEXT:    v_or_b32_e32 v8, v6, v17
; GCN-NEXT:    v_alignbit_b32 v3, v4, v0, 24
; GCN-NEXT:    v_alignbit_b32 v2, v4, v0, 16
; GCN-NEXT:    v_alignbit_b32 v1, v4, v0, 8
; GCN-NEXT:    v_lshrrev_b32_e32 v5, 8, v4
...
; GCN-NEXT:    v_cvt_f16_f32_e32 v11, v4
; GCN-NEXT:    v_cvt_f16_f32_e32 v12, v5
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v6
; GCN-NEXT:    ; implicit-def: $vgpr0
; GCN-NEXT:    ; implicit-def: $vgpr1
; GCN-NEXT:    ; implicit-def: $vgpr2
...
; GCN-NEXT:    v_lshlrev_b32_e32 v5, 16, v12
; GCN-NEXT:    ; implicit-def: $vgpr12
; GCN-NEXT:    ; implicit-def: $vgpr11
; GCN-NEXT:    ; implicit-def: $vgpr10
; GCN-NEXT:    ; implicit-def: $vgpr9
...
; GCN-NEXT:    v_cvt_f32_f16_e32 v2, v8
; GCN-NEXT:    v_cvt_f32_f16_e32 v3, v7
; GCN-NEXT:    v_add_f32_e32 v0, 0x38000000, v0
; GCN-NEXT:    v_add_f32_e32 v1, 0x38000000, v1
