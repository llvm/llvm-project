...
; GFX11-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s15
...
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s14
; GFX11-NEXT:    v_dual_mov_b32 v2, s13 :: v_dual_mov_b32 v3, s4
; GFX11-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, s12
; GFX11-NEXT:    v_dual_mov_b32 v6, s11 :: v_dual_mov_b32 v7, s10
; GFX11-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, s9
; GFX11-NEXT:    v_dual_mov_b32 v10, s8 :: v_dual_mov_b32 v11, s6
; GFX11-NEXT:    s_setpc_b64 s[30:31]
; GFX11-NEXT:  .LBB5_4:
...
; GFX11-FAKE16-NEXT:    v_add_f32_e32 v13, 1.0, v13
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr14
...
; GFX9-NEXT:  ; %bb.1: ; %cmp.false
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 16, v15
; GFX9-NEXT:    v_lshrrev_b32_e32 v9, 8, v15
...
; GFX9-NEXT:    ; implicit-def: $vgpr16
; GFX9-NEXT:    v_lshrrev_b64 v[11:12], 24, v[15:16]
...
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v4, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v5, v6, vcc
; GFX9-NEXT:    v_and_b32_e32 v5, 0xffff0000, v15
...
; GFX9-NEXT:    v_lshlrev_b32_e32 v6, 16, v15
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v15, v2 :: v_dual_mov_b32 v14, v1
...
; GFX11-FAKE16-NEXT:  ; %bb.1: ; %cmp.false
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v10, 16, v15
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v9, 8, v15
...
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr16
; GFX11-FAKE16-NEXT:    v_lshrrev_b64 v[11:12], 24, v[15:16]
...
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v4, 0xffff0000, v15
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v5, 16, v15
...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, s13
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s11
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v6, s15 :: v_dual_mov_b32 v7, s9
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v10, s14 :: v_dual_mov_b32 v5, s10
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, s12 :: v_dual_mov_b32 v11, s6
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, s13
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s11
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v6, s15 :: v_dual_mov_b32 v7, s9
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v10, s14 :: v_dual_mov_b32 v5, s10
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v2, s12 :: v_dual_mov_b32 v11, s6
...
; VI-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; VI-NEXT:  ; %bb.1: ; %cmp.false
; VI-NEXT:    v_lshrrev_b32_e32 v9, 8, v15
; VI-NEXT:    v_lshrrev_b32_e32 v7, 24, v14
; VI-NEXT:    v_lshrrev_b32_e32 v5, 8, v14
; VI-NEXT:    ; implicit-def: $vgpr16
; VI-NEXT:    v_lshrrev_b64 v[11:12], 24, v[15:16]
...
; VI-NEXT:    v_add_f16_sdwa v10, v15, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; VI-NEXT:    v_or_b32_e32 v7, v15, v3
; VI-NEXT:    v_mov_b32_e32 v8, 0x7e007e00
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v4, v1, v7, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v6, v6
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v3, v10, v0, 0x7fff
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v11, v11
; GFX11-TRUE16-NEXT:    v_bfe_u32 v10, v6, 16, 1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_add3_u32 v5, v5, v11, 0x7fff
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v9, 0x400000, v6
; GFX11-TRUE16-NEXT:    v_add3_u32 v8, v10, v6, 0x7fff
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v10, v5, v12, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr0
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v5, v3, v7, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v6, v6
