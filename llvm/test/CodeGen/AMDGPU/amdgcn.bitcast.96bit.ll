...
; GFX9-NEXT:    s_mov_b32 s7, 0x7060302
; GFX9-NEXT:    v_perm_b32 v1, v0, v2, s7
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v1, v11, v9 :: v_dual_add_f32 v2, 0x40c00000, v2
...
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v5, v5
; GFX11-TRUE16-NEXT:    v_add3_u32 v6, v10, v2, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_bfi_b32 v13, 0xffff, v9, v1
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[14:15], 24, v[12:13]
; GFX11-TRUE16-NEXT:    v_bfi_b32 v10, 0xffff, v6, v3
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v12
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[16:17], 24, v[10:11]
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v9, 8, v10
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_add3_u32 v6, v6, v0, 0x7fff
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v1, 0x40c00000, v1 :: v_dual_cndmask_b32 v0, v6, v8
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v1, 0x40c00000, v4 :: v_dual_cndmask_b32 v6, v7, v9
...
; GFX11-FAKE16-NEXT:    v_dual_add_f32 v2, 0x40c00000, v2 :: v_dual_add_f32 v3, 0x40c00000, v3
...
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-FAKE16-NEXT:    v_add3_u32 v4, v10, v2, 0x7fff
...
; GFX11-FAKE16-NEXT:    v_add3_u32 v7, v8, v3, 0x7fff
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v8, 0x400000, v3
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
...
; GFX11-FAKE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v1, v1
; GFX11-FAKE16-NEXT:    v_add3_u32 v4, v4, v5, 0x7fff
; GFX11-FAKE16-NEXT:    v_perm_b32 v1, v0, v6, 0x7060302
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v11, v7, v4, 0x7060302
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xffff, v13
; GFX9-NEXT:    s_pack_lh_b32_b16 s4, 0, s16
...
; GFX11-NEXT:    v_cndmask_b32_e32 v7, v0, v11, vcc_lo
; GFX11-NEXT:    v_cmp_u_f32_e32 vcc_lo, v4, v4
...
; GFX11-NEXT:    v_lshl_or_b32 v2, v9, 16, v3
; GFX11-NEXT:    v_lshl_or_b32 v1, v4, 16, v5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_lshl_or_b32 v11, v6, 16, v7
...
; GFX11-NEXT:  .LBB39_4:
; GFX11-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, s13
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s11
; GFX11-NEXT:    v_dual_mov_b32 v10, s14 :: v_dual_mov_b32 v7, s10
; GFX11-NEXT:    v_dual_mov_b32 v2, s12 :: v_dual_mov_b32 v5, s8
; GFX11-NEXT:    v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v11, s6
