...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: mad_no_add3:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mad_u32_u24 v0, v0, v1, v4
; GFX11-NEXT:    v_mad_u32_u24 v0, v2, v3, v0
; GFX11-NEXT:    ; return to shader part epilog
  %a0 = shl i32 %a, 8
  %a1 = lshr i32 %a0, 8
  %b0 = shl i32 %b, 8
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_vgpr_b:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add3_u32 v0, s3, s2, v0
; GFX11-NEXT:    ; return to shader part epilog
  %x = add i32 %a, %b
  %result = add i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_vgpr_all2:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add3_u32 v0, v1, v2, v0
; GFX11-NEXT:    ; return to shader part epilog
  %x = add i32 %b, %c
  %result = add i32 %a, %x
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_vgpr_bc:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add3_u32 v0, s2, v0, v1
; GFX11-NEXT:    ; return to shader part epilog
  %x = add i32 %a, %b
  %result = add i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_vgpr_const:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add3_u32 v0, v0, v1, 16
; GFX11-NEXT:    ; return to shader part epilog
  %x = add i32 %a, %b
  %result = add i32 %x, 16
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_multiuse_outer:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add3_u32 v0, v0, v1, v2
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: add3_multiuse_inner:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX11-NEXT:    v_add_nc_u32_e32 v1, v0, v2
; GFX11-NEXT:    ; return to shader part epilog
  %inner = add i32 %a, %b
  %outer = add i32 %inner, %c
