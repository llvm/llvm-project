...
; GFX1250-SDAG-NEXT:    v_lshlrev_b32_e32 v46, 7, v0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v46, s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v46, s[34:35] offset:96
; GFX1250-SDAG-NEXT:    global_load_b128 v[20:23], v46, s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_load_b128 v[16:19], v46, s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_load_b128 v[12:15], v46, s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_load_b128 v[8:11], v46, s[34:35] offset:32
; GFX1250-SDAG-NEXT:    global_load_b128 v[4:7], v46, s[34:35] offset:16
; GFX1250-SDAG-NEXT:    global_load_b128 v[0:3], v46, s[34:35]
; GFX1250-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0xe4
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0xa4
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v33, s27 :: v_dual_mov_b32 v38, s24
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v39, s25 :: v_dual_mov_b32 v34, s22
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v36, s30 :: v_dual_mov_b32 v37, s31
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v42, s28 :: v_dual_mov_b32 v43, s29
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v32, s26 :: v_dual_mov_b32 v41, s21
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v44, s18 :: v_dual_mov_b32 v45, s19
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v48, s16 :: v_dual_mov_b32 v49, s17
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v50, s14 :: v_dual_mov_b32 v35, s23
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v40, s20 :: v_dual_mov_b32 v53, s13
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v54, s10 :: v_dual_mov_b32 v55, s11
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v56, s8 :: v_dual_mov_b32 v57, s9
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v51, s15 :: v_dual_mov_b32 v52, s12
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[30:31], v[30:31], v[36:37]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[24:25], v[24:25], v[38:39]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[0:1]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[28:29], v[28:29], v[42:43]
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v36, s6 :: v_dual_mov_b32 v37, s7
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v42, s4 :: v_dual_mov_b32 v43, s5
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[26:27], v[26:27], v[32:33]
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v32, s2 :: v_dual_mov_b32 v33, s3
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[18:19], v[18:19], v[44:45]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[16:17], v[16:17], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[22:23], v[22:23], v[34:35]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[20:21], v[20:21], v[40:41]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[10:11], v[10:11], v[54:55]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[8:9], v[8:9], v[56:57]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[14:15], v[14:15], v[50:51]
...
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[4:5], v[4:5], v[42:43]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[2:3], v[2:3], v[32:33]
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[0:1], v[0:1], v[38:39]
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[24:27], s[34:35] offset:96
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[28:31], s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[16:19], s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[20:23], s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[8:11], s[34:35] offset:32
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[12:15], s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[0:3], s[34:35]
; GFX1250-SDAG-NEXT:    global_store_b128 v46, v[4:7], s[34:35] offset:16
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v51, s15 :: v_dual_mov_b32 v52, s12
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[30:31], v[30:31], v[36:37]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[24:25], v[24:25], v[38:39]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[38:39], s[0:1]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[28:29], v[28:29], v[42:43]
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v36, s6 :: v_dual_mov_b32 v37, s7
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v42, s4 :: v_dual_mov_b32 v43, s5
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[26:27], v[26:27], v[32:33]
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v32, s2 :: v_dual_mov_b32 v33, s3
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[18:19], v[18:19], v[44:45]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[16:17], v[16:17], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[22:23], v[22:23], v[34:35]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[20:21], v[20:21], v[40:41]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[10:11], v[10:11], v[54:55]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[8:9], v[8:9], v[56:57]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[14:15], v[14:15], v[50:51]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[12:13], v[12:13], v[52:53]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[6:7], v[6:7], v[36:37]
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[4:5], v[4:5], v[42:43]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-SDAG-NEXT:    v_lshlrev_b32_e32 v38, 7, v0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_load_b128 v[28:31], v38, s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_load_b128 v[24:27], v38, s[34:35] offset:96
; GFX1250-SDAG-NEXT:    global_load_b128 v[20:23], v38, s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_load_b128 v[16:19], v38, s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_load_b128 v[12:15], v38, s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_load_b128 v[8:11], v38, s[34:35] offset:32
; GFX1250-SDAG-NEXT:    global_load_b128 v[4:7], v38, s[34:35] offset:16
; GFX1250-SDAG-NEXT:    global_load_b128 v[0:3], v38, s[34:35]
; GFX1250-SDAG-NEXT:    s_load_b512 s[16:31], s[4:5], 0xe4
; GFX1250-SDAG-NEXT:    s_wait_xcnt 0x0
; GFX1250-SDAG-NEXT:    s_load_b512 s[0:15], s[4:5], 0xa4
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[30:31]
...
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[46:47], s[18:19]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[48:49], s[16:17]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[36:37], s[22:23]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[44:45], s[20:21]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[54:55], s[10:11]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[56:57], s[8:9]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[50:51], s[14:15]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[52:53], s[12:13]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x7
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[30:31], v[30:31], v[34:35], v[34:35]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[28:29], v[28:29], v[40:41], v[40:41]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[34:35], s[6:7]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[40:41], s[4:5]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x6
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[26:27], v[26:27], v[32:33], v[32:33]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[24:25], v[24:25], v[42:43], v[42:43]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[32:33], s[2:3]
; GFX1250-SDAG-NEXT:    v_mov_b64_e32 v[42:43], s[0:1]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x4
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[18:19], v[18:19], v[46:47], v[46:47]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[16:17], v[16:17], v[48:49], v[48:49]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[22:23], v[22:23], v[36:37], v[36:37]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[20:21], v[20:21], v[44:45], v[44:45]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[10:11], v[10:11], v[54:55], v[54:55]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[8:9], v[8:9], v[56:57], v[56:57]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[14:15], v[14:15], v[50:51], v[50:51]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[12:13], v[12:13], v[52:53], v[52:53]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x1
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[6:7], v[6:7], v[34:35], v[34:35]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[4:5], v[4:5], v[40:41], v[40:41]
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], v[32:33], v[32:33]
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], v[42:43], v[42:43]
; GFX1250-SDAG-NEXT:    s_clause 0x7
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[24:27], s[34:35] offset:96
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[28:31], s[34:35] offset:112
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[16:19], s[34:35] offset:64
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[20:23], s[34:35] offset:80
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[8:11], s[34:35] offset:32
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[12:15], s[34:35] offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[0:3], s[34:35]
; GFX1250-SDAG-NEXT:    global_store_b128 v38, v[4:7], s[34:35] offset:16
; GFX1250-SDAG-NEXT:    s_endpgm
;
