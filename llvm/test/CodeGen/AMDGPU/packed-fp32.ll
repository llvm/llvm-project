...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx90a -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-SDAG,GFX90A,GFX90A-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx90a -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-GISEL,GFX90A,GFX90A-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx942 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-SDAG,GFX942,GFX942-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx942 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=PACKED,PACKED-GISEL,GFX942,GFX942-GISEL %s
...
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v33, s21 :: v_dual_mov_b32 v32, s20
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v35, s23 :: v_dual_mov_b32 v34, s22
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v37, s19 :: v_dual_mov_b32 v38, s28
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v41, s31 :: v_dual_mov_b32 v40, s30
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v43, s25 :: v_dual_mov_b32 v36, s18
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v39, s29 :: v_dual_mov_b32 v54, s14
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v50, s2 :: v_dual_mov_b32 v53, s13
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v52, s12 :: v_dual_mov_b32 v55, s15
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v48, s6 :: v_dual_mov_b32 v51, s3
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v44, s26 :: v_dual_mov_b32 v47, s5
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v46, s4 :: v_dual_mov_b32 v49, s7
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v42, s24 :: v_dual_mov_b32 v45, s27
...
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v32, s8 :: v_dual_mov_b32 v35, s11
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v33, s9 :: v_dual_mov_b32 v34, s10
...
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1]
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1] neg_lo:[1,0] neg_hi:[1,0]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1] neg_lo:[1,0]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1] neg_hi:[1,0]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_mul_f32 v[0:1], s[2:3], v[0:1] op_sel_hi:[0,1] neg_lo:[1,0] neg_hi:[1,0]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[0:1], s[4:5], v[0:1], s[2:3] op_sel_hi:[0,1,0]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG-NEXT:    global_load_b64 v[0:1], v2, s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX1250-SDAG-NEXT:    v_pk_fma_f32 v[0:1], s[2:3], v[0:1], s[2:3] op_sel_hi:[0,1,0] neg_lo:[1,0,1] neg_hi:[1,0,1]
; GFX1250-SDAG-NEXT:    global_store_b64 v2, v[0:1], s[0:1] scale_offset
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-SDAG:       ; %bb.0: ; %bb
; GFX1250-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v6, 0
; GFX1250-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v5, s3
...
; GFX1250-GISEL-NEXT:    v_xor_b32_e32 v4, 0x80000000, v4
; GFX1250-GISEL-NEXT:    v_xor_b32_e32 v5, 0x80000000, v5
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-GISEL-NEXT:    v_pk_fma_f32 v[0:1], v[0:1], v[2:3], v[4:5]
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-GISEL-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1250-SDAG-NEXT:    v_pk_add_f32 v[2:3], s[2:3], v[0:1] op_sel_hi:[0,1]
...
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s3
...
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    s_xor_b32 s2, s2, 0x80000000
; GFX1250-GISEL-NEXT:    s_xor_b32 s3, s3, 0x80000000
