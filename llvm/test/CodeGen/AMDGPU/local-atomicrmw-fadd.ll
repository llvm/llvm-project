...
; GFX12-NEXT:    s_mov_b32 s6, exec_lo
; GFX12-NEXT:    v_cmp_eq_u32_e64 s0, 0, v2
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX940-NEXT:    v_mbcnt_lo_u32_b32 v2, s8, 0
; GFX940-NEXT:    v_mbcnt_hi_u32_b32 v2, s9, v2
; GFX940-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v2
; GFX940-NEXT:    s_mov_b64 s[6:7], exec
; GFX940-NEXT:    v_readfirstlane_b32 s10, v1
; GFX940-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX940-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GFX940-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX940-NEXT:    s_cmp_lg_u64 vcc, 0
...
; GFX90A-NEXT:    v_mbcnt_lo_u32_b32 v2, s8, 0
; GFX90A-NEXT:    v_mbcnt_hi_u32_b32 v2, s9, v2
; GFX90A-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v2
; GFX90A-NEXT:    s_mov_b64 s[6:7], exec
; GFX90A-NEXT:    v_readfirstlane_b32 s10, v1
; GFX90A-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX90A-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GFX908-NEXT:    v_mbcnt_lo_u32_b32 v2, s8, 0
; GFX908-NEXT:    v_mbcnt_hi_u32_b32 v2, s9, v2
; GFX908-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v2
; GFX908-NEXT:    s_mov_b64 s[6:7], exec
; GFX908-NEXT:    v_readfirstlane_b32 s10, v1
; GFX908-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX908-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GFX8-NEXT:    v_mbcnt_lo_u32_b32 v2, s8, 0
; GFX8-NEXT:    v_mbcnt_hi_u32_b32 v2, s9, v2
...
; GFX7-NEXT:    s_andn2_b64 s[0:1], exec, s[8:9]
; GFX7-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_2
; GFX7-NEXT:  ; %bb.3: ; %Flow23
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:  .LBB28_4:
; GFX7-NEXT:    s_mov_b64 s[8:9], exec
; GFX7-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, s8, 0
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, s9, v2
; GFX7-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v2
; GFX7-NEXT:    s_and_b64 s[10:11], s[0:1], -1
; GFX7-NEXT:    s_mov_b64 s[6:7], exec
; GFX7-NEXT:    v_readfirstlane_b32 s10, v1
; GFX7-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GFX7-NEXT:    s_cbranch_vccnz .LBB28_9
...
; GFX7-NEXT:    s_and_b64 s[0:1], vcc, -1
; GFX7-NEXT:    ; implicit-def: $vgpr2
; GFX7-NEXT:    s_cmov_b64 exec, vcc
; GFX7-NEXT:    s_cbranch_scc0 .LBB28_14
; GFX7-NEXT:  ; %bb.11:
; GFX7-NEXT:    v_mov_b32_e32 v3, s4
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    ds_read_b32 v2, v3
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
; GFX7-NEXT:  .LBB28_12: ; %atomicrmw.start8
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    s_andn2_b64 s[0:1], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[0:1], s[4:5]
; GFX7-NEXT:    s_cbranch_scc1 .LBB28_12
...
; GFX6-NEXT:    s_andn2_b64 s[0:1], exec, s[8:9]
; GFX6-NEXT:    s_cselect_b64 exec, s[0:1], s[8:9]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_2
; GFX6-NEXT:  ; %bb.3: ; %Flow21
; GFX6-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX6-NEXT:  .LBB28_4:
; GFX6-NEXT:    s_mov_b64 s[8:9], exec
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, s8, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, s9, v2
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v2
; GFX6-NEXT:    s_and_b64 s[10:11], s[0:1], -1
; GFX6-NEXT:    s_mov_b64 s[6:7], exec
; GFX6-NEXT:    v_readfirstlane_b32 s10, v1
; GFX6-NEXT:    s_cmov_b64 exec, s[0:1]
...
; GFX6-NEXT:    s_cbranch_vccnz .LBB28_9
; GFX6-NEXT:  ; %bb.10: ; %ComputeEnd
...
; GFX6-NEXT:    s_and_b64 s[0:1], vcc, -1
; GFX6-NEXT:    ; implicit-def: $vgpr2
; GFX6-NEXT:    s_cmov_b64 exec, vcc
; GFX6-NEXT:    s_cbranch_scc0 .LBB28_14
; GFX6-NEXT:  ; %bb.11:
; GFX6-NEXT:    v_mov_b32_e32 v3, s4
; GFX6-NEXT:    s_mov_b32 m0, -1
; GFX6-NEXT:    ds_read_b32 v2, v3
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
; GFX6-NEXT:  .LBB28_12: ; %atomicrmw.start8
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NEXT:    s_andn2_b64 s[0:1], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[0:1], s[4:5]
; GFX6-NEXT:    s_cbranch_scc1 .LBB28_12
; GFX6-NEXT:  ; %bb.13: ; %Flow
; GFX6-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX6-NEXT:  .LBB28_14:
...
; GFX7-NEXT:    v_add_f32_e32 v1, s9, v1
; GFX7-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7-NEXT:    s_cbranch_vccnz .LBB29_9
; GFX7-NEXT:  ; %bb.10: ; %ComputeEnd
; GFX7-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, exec_lo, 0
; GFX7-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, exec_hi, v2
; GFX7-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
...
; GFX7-NEXT:    ; implicit-def: $vgpr2
; GFX7-NEXT:    s_cmov_b64 exec, vcc
; GFX7-NEXT:    s_cbranch_scc0 .LBB29_14
; GFX7-NEXT:  ; %bb.11:
; GFX7-NEXT:    v_mov_b32_e32 v3, s4
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    ds_read_b32 v2, v3
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
; GFX7-NEXT:  .LBB29_12: ; %atomicrmw.start8
; GFX7-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v4, v2
; GFX7-NEXT:    v_add_f32_e32 v2, v4, v1
...
; GFX7-NEXT:    s_andn2_b64 s[0:1], exec, s[4:5]
; GFX7-NEXT:    s_cselect_b64 exec, s[0:1], s[4:5]
; GFX7-NEXT:    s_cbranch_scc1 .LBB29_12
; GFX7-NEXT:  ; %bb.13: ; %Flow
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:  .LBB29_14:
; GFX7-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x0
...
; GFX6-NEXT:    v_add_f32_e32 v1, s9, v1
; GFX6-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX6-NEXT:    s_cbranch_vccnz .LBB29_9
; GFX6-NEXT:  ; %bb.10: ; %ComputeEnd
; GFX6-NEXT:    v_mbcnt_lo_u32_b32_e64 v2, exec_lo, 0
; GFX6-NEXT:    v_mbcnt_hi_u32_b32_e32 v2, exec_hi, v2
; GFX6-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
...
; GFX6-NEXT:    ; implicit-def: $vgpr2
; GFX6-NEXT:    s_cmov_b64 exec, vcc
; GFX6-NEXT:    s_cbranch_scc0 .LBB29_14
; GFX6-NEXT:  ; %bb.11:
; GFX6-NEXT:    v_mov_b32_e32 v3, s4
; GFX6-NEXT:    s_mov_b32 m0, -1
; GFX6-NEXT:    ds_read_b32 v2, v3
; GFX6-NEXT:    s_mov_b64 s[4:5], 0
; GFX6-NEXT:  .LBB29_12: ; %atomicrmw.start8
; GFX6-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v4, v2
; GFX6-NEXT:    v_add_f32_e32 v2, v4, v1
...
; GFX6-NEXT:    s_andn2_b64 s[0:1], exec, s[4:5]
; GFX6-NEXT:    s_cselect_b64 exec, s[0:1], s[4:5]
; GFX6-NEXT:    s_cbranch_scc1 .LBB29_12
; GFX6-NEXT:  ; %bb.13: ; %Flow
; GFX6-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX6-NEXT:  .LBB29_14:
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x0
