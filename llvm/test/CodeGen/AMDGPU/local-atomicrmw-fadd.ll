...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_load_b32 s1, s[4:5], 0xc
...
; GFX12-NEXT:  ; %bb.7:
; GFX12-NEXT:    s_load_b32 s2, s[4:5], 0x8
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v1, s2
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_load_dword s8, s[4:5], 0xc
...
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
; GFX942-NEXT:    s_lshl_b32 s0, s8, 4
; GFX942-NEXT:    v_mul_f32_e32 v1, 0x42280000, v1
...
; GFX942-NEXT:    v_add_f32_e32 v0, s9, v0
...
; GFX942-NEXT:    v_readlane_b32 s6, v2, s2
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b32 s1, s[4:5], 0xc
...
; GFX11-NEXT:  ; %bb.7:
; GFX11-NEXT:    s_load_b32 s1, s[4:5], 0x8
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-NEXT:  ; %bb.7:
; GFX10-NEXT:    s_load_dword s1, s[4:5], 0x8
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    s_lshl_b32 s6, s8, 3
...
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
; GFX90A-NEXT:    s_lshl_b32 s0, s8, 4
; GFX90A-NEXT:    v_mul_f32_e32 v1, 0x42280000, v1
...
; GFX90A-NEXT:    v_add_f32_e32 v0, s9, v0
...
; GFX90A-NEXT:    v_readlane_b32 s6, v2, s2
...
; GFX908:       ; %bb.0:
; GFX908-NEXT:    s_load_dword s8, s[4:5], 0xc
...
; GFX908-NEXT:    s_lshl_b32 s6, s8, 3
...
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
; GFX908-NEXT:    s_lshl_b32 s0, s8, 4
; GFX908-NEXT:    v_mul_f32_e32 v1, 0x42280000, v1
...
; GFX908-NEXT:    v_add_f32_e32 v0, s9, v0
...
; GFX908-NEXT:    v_readlane_b32 s6, v2, s2
...
; GFX8-NEXT:    v_add_f32_e32 v0, s9, v0
...
; GFX8-NEXT:    v_readlane_b32 s6, v2, s2
...
; GFX7-NEXT:  ; %bb.3: ; %Flow20
; GFX7-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX7-NEXT:  .LBB28_4: ; %Flow21
...
; GFX7-NEXT:    ds_read_b32 v3, v1
; GFX7-NEXT:    s_bcnt1_i32_b64 s0, s[6:7]
...
; GFX7-NEXT:  ; %bb.10:
; GFX7-NEXT:    s_load_dword s0, s[4:5], 0x2
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    s_mov_b64 s[6:7], 0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
