...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_load_b128 s[4:7], s[4:5], 0x0
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_add_co_i32 s1, s7, 4
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v0, s2, vcc_lo
...
; GFX12-NEXT:    v_writelane_b32 v0, s0, s2
; GFX12-NEXT:    s_lshl_b32 s2, 1, s2
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_not1_b32 s1, s1, s2
...
; GFX12-NEXT:  ; %bb.7:
; GFX12-NEXT:    v_dual_mov_b32 v1, s6 :: v_dual_mov_b32 v2, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_f32 v0, s0, v0
; GFX12-NEXT:    v_cndmask_b32_e64 v0, v0, s0, vcc_lo
; GFX12-NEXT:    global_store_b32 v1, v0, s[4:5]
; GFX12-NEXT:    s_endpgm
;
; GFX942-LABEL: local_ds_fadd:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x0
...
; GFX942-NEXT:    v_cvt_f32_ubyte0_e32 v1, s0
; GFX942-NEXT:    s_lshl_b32 s0, s5, 4
; GFX942-NEXT:    v_mul_f32_e32 v1, 0x42280000, v1
...
; GFX942-NEXT:    v_add_f32_e32 v0, s7, v0
...
; GFX942-NEXT:    v_readlane_b32 s5, v2, s2
; GFX942-NEXT:    v_writelane_b32 v0, s3, m0
; GFX942-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX942-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX942-NEXT:    v_add_f32_e32 v1, s5, v1
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_add_f32_e32 v0, s0, v0
; GFX942-NEXT:    v_mov_b32_e32 v2, s0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX942-NEXT:    global_store_dword v1, v0, s[4:5]
...
; GFX11-NEXT:    v_readlane_b32 s3, v2, s1
; GFX11-NEXT:    v_writelane_b32 v0, s2, s1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_add_f32_e32 v1, s3, v1
...
; GFX10-NEXT:    v_readfirstlane_b32 s2, v1
; GFX10-NEXT:    v_readlane_b32 s3, v2, s1
; GFX10-NEXT:    v_writelane_b32 v0, s2, s1
; GFX10-NEXT:    v_add_f32_e32 v1, s3, v1
...
; GFX90A-NEXT:    s_lshl_b32 s7, s5, 3
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[2:3], s[0:1]
...
; GFX90A-NEXT:    v_add_f32_e32 v0, s7, v0
...
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_ff1_i32_b64 s2, s[0:1]
; GFX90A-NEXT:    v_readfirstlane_b32 s3, v1
; GFX90A-NEXT:    s_mov_b32 m0, s2
; GFX90A-NEXT:    v_readlane_b32 s5, v2, s2
; GFX90A-NEXT:    v_writelane_b32 v0, s3, m0
; GFX90A-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX90A-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX90A-NEXT:    v_add_f32_e32 v1, s5, v1
...
; GFX908:       ; %bb.0:
; GFX908-NEXT:    s_load_dwordx4 s[4:7], s[4:5], 0x0
...
; GFX908-NEXT:    s_lshl_b32 s7, s5, 3
...
; GFX908-NEXT:    s_and_saveexec_b64 s[2:3], s[0:1]
...
; GFX908-NEXT:    v_add_f32_e32 v0, s7, v0
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_ff1_i32_b64 s2, s[0:1]
; GFX908-NEXT:    v_readfirstlane_b32 s3, v1
; GFX908-NEXT:    s_mov_b32 m0, s2
; GFX908-NEXT:    v_readlane_b32 s5, v2, s2
; GFX908-NEXT:    v_writelane_b32 v0, s3, m0
; GFX908-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX908-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX908-NEXT:    v_add_f32_e32 v1, s5, v1
...
; GFX8-NEXT:    v_add_f32_e32 v0, s7, v0
...
; GFX8-NEXT:    v_readlane_b32 s5, v2, s2
; GFX8-NEXT:    v_writelane_b32 v0, s3, m0
; GFX8-NEXT:    s_lshl_b64 s[2:3], 1, s2
; GFX8-NEXT:    s_andn2_b64 s[0:1], s[0:1], s[2:3]
; GFX8-NEXT:    v_add_f32_e32 v1, s5, v1
...
; GFX7-NEXT:    v_add_f32_e32 v0, s7, v0
...
; GFX7-NEXT:    s_xor_b64 s[2:3], exec, s[0:1]
...
; GFX7-NEXT:    v_add_f32_e32 v0, s0, v0
; GFX7-NEXT:    v_mov_b32_e32 v1, s0
