...
; RUN: llc -global-isel=1 -global-isel-abort=2 -O2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck --check-prefix=GISEL12 %s
; RUN: llc -global-isel=0 -O2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -O2 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck --check-prefix=GISEL10 %s
...
; GISEL12-NEXT:    s_wait_kmcnt 0x0
; GISEL12-NEXT:    s_or_saveexec_b32 s8, -1
; GISEL12-NEXT:    v_dual_mov_b32 v11, v13 :: v_dual_mov_b32 v10, v12
; GISEL12-NEXT:    s_mov_b32 s7, s4
; GISEL12-NEXT:    s_mov_b32 s6, s3
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_saveexec_b32 s3, s8
...
; GISEL12-NEXT:    v_mov_b32_e32 v8, 44
...
; GISEL10-NEXT:    v_mov_b32_e32 v8, 44
...
; GISEL12-NEXT:    s_wait_bvhcnt 0x0
; GISEL12-NEXT:    s_wait_kmcnt 0x0
; GISEL12-NEXT:    s_or_saveexec_b32 s11, -1
; GISEL12-NEXT:    s_or_saveexec_b32 s6, -1
; GISEL12-NEXT:    v_dual_mov_b32 v39, v23 :: v_dual_mov_b32 v38, v22
; GISEL12-NEXT:    v_dual_mov_b32 v37, v21 :: v_dual_mov_b32 v36, v20
; GISEL12-NEXT:    v_dual_mov_b32 v35, v19 :: v_dual_mov_b32 v34, v18
; GISEL12-NEXT:    v_dual_mov_b32 v33, v17 :: v_dual_mov_b32 v32, v16
; GISEL12-NEXT:    v_dual_mov_b32 v31, v15 :: v_dual_mov_b32 v30, v14
; GISEL12-NEXT:    v_dual_mov_b32 v29, v13 :: v_dual_mov_b32 v28, v12
; GISEL12-NEXT:    v_dual_mov_b32 v27, v11 :: v_dual_mov_b32 v26, v10
; GISEL12-NEXT:    v_dual_mov_b32 v25, v9 :: v_dual_mov_b32 v24, v8
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_mov_b32 exec_lo, s6
; GISEL12-NEXT:    s_mov_b32 s9, s4
; GISEL12-NEXT:    s_mov_b32 s8, s3
; GISEL12-NEXT:    s_mov_b32 s4, s2
; GISEL12-NEXT:    s_mov_b32 s6, s1
; GISEL12-NEXT:    s_mov_b32 s7, s0
; GISEL12-NEXT:    s_and_saveexec_b32 s10, s11
...
; GISEL12-NEXT:    s_mov_b32 exec_lo, s11
...
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s10
...
; GISEL12-NEXT:    s_mov_b32 s0, s7
; GISEL12-NEXT:    s_mov_b32 s1, s6
; GISEL12-NEXT:    s_mov_b32 s2, s4
; GISEL12-NEXT:    s_mov_b32 exec_lo, s5
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GISEL10:       ; %bb.0: ; %entry
; GISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10-NEXT:    s_or_saveexec_b32 s11, -1
...
; GISEL10-NEXT:    s_mov_b32 exec_lo, s6
; GISEL10-NEXT:    s_mov_b32 s9, s4
; GISEL10-NEXT:    s_mov_b32 s8, s3
; GISEL10-NEXT:    s_mov_b32 s4, s2
; GISEL10-NEXT:    s_mov_b32 s6, s1
; GISEL10-NEXT:    s_mov_b32 s7, s0
; GISEL10-NEXT:    s_and_saveexec_b32 s10, s11
...
; GISEL10-NEXT:    s_mov_b32 exec_lo, s11
...
; GISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s10
...
; GISEL10-NEXT:    s_mov_b32 s0, s7
; GISEL10-NEXT:    s_mov_b32 s1, s6
; GISEL10-NEXT:    s_mov_b32 s2, s4
; GISEL10-NEXT:    s_mov_b32 exec_lo, s5
...
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_and_saveexec_b32 s0, s6
...
; GISEL12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GISEL12-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GISEL10-NEXT:    s_and_saveexec_b32 s0, s6
...
; GISEL10-NEXT:    s_or_b32 exec_lo, exec_lo, s0
