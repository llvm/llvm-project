...
; RUN: llc -amdgpu-disable-all-loop-alignment=true -global-isel=1 -O2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck --check-prefix=GISEL12 %s
; RUN: llc -amdgpu-disable-all-loop-alignment=true -global-isel=0 -O2 -mtriple=amdgcn -mcpu=gfx1200 < %s | FileCheck --check-prefix=DAGISEL12 %s
; RUN: llc -amdgpu-disable-all-loop-alignment=true -global-isel=1 -O2 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck --check-prefix=GISEL10 %s
; RUN: llc -amdgpu-disable-all-loop-alignment=true -global-isel=0 -O2 -mtriple=amdgcn -mcpu=gfx1030 < %s | FileCheck --check-prefix=DAGISEL10 %s
