...
define void @tail_call_i64_inreg_uniform_in_vgpr_convergence_tokens() #0 {
  ...
  ; CHECK-NEXT:   liveins: $sgpr4_5, $sgpr6_7, $sgpr8_9, $sgpr10_11, $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   $sgpr4_5 = COPY [[COPY8]]
  ; CHECK-NEXT:   $sgpr6_7 = COPY [[COPY7]]
  ; CHECK-NEXT:   $sgpr8_9 = COPY [[COPY6]]
  ; CHECK-NEXT:   $sgpr10_11 = COPY [[COPY5]]
  ...
  ; CHECK-NEXT:   CONVERGENCECTRL_GLUE [[CONVERGENCECTRL_ENTRY]]
  ; CHECK-NEXT:   SI_TCRETURN killed [[S_LOAD_DWORDX2_IMM]], @void_func_i64_inreg, 0, csr_amdgpu, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31, implicit $sgpr16, implicit $sgpr17, implicit [[CONVERGENCECTRL_ENTRY]]
