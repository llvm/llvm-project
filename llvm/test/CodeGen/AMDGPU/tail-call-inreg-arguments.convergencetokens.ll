...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -stop-after=si-fix-sgpr-copies < %s | FileCheck %s
...
define void @tail_call_i64_inreg_uniform_in_vgpr_convergence_tokens() #0 {
  ...
  ; CHECK-NEXT:   liveins: $sgpr4_64, $sgpr6_64, $sgpr8_64, $sgpr10_64, $sgpr12, $sgpr13, $sgpr14, $sgpr15, $vgpr31
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   $sgpr4_64 = COPY [[COPY8]]
  ; CHECK-NEXT:   $sgpr6_64 = COPY [[COPY7]]
  ; CHECK-NEXT:   $sgpr8_64 = COPY [[COPY6]]
  ; CHECK-NEXT:   $sgpr10_64 = COPY [[COPY5]]
  ...
  ; CHECK-NEXT:   CONVERGENCECTRL_GLUE [[CONVERGENCECTRL_ENTRY]]
  ; CHECK-NEXT:   SI_TCRETURN killed [[S_LOAD_DWORDX2_IMM]], @void_func_i64_inreg, 0, csr_amdgpu, implicit $sgpr4_64, implicit $sgpr6_64, implicit $sgpr8_64, implicit $sgpr10_64, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31, implicit $sgpr16, implicit $sgpr17, implicit [[CONVERGENCECTRL_ENTRY]]
