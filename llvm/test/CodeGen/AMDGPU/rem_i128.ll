...
; GFX9-O0-NEXT:    v_ashrrev_i64 v[11:12], s4, v[5:6]
...
; GFX9-O0-NEXT:    v_xor_b32_e64 v0, v0, v9
; GFX9-O0-NEXT:    v_mov_b32_e32 v10, v13
; GFX9-O0-NEXT:    v_xor_b32_e64 v12, v10, v11
...
; GFX9-O0-NEXT:    v_xor_b32_e64 v14, v3, v11
...
; GFX9-O0-NEXT:    v_xor_b32_e64 v6, v4, v5
...
; GFX9-O0-NEXT:    v_xor_b32_e64 v1, v1, v5
; GFX9-O0-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
...
; GFX9-O0-NEXT:    v_subb_co_u32_e32 v4, vcc, v4, v9, vcc
; GFX9-O0-NEXT:    ; implicit-def: $sgpr4
; GFX9-O0-NEXT:    ; implicit-def: $sgpr4
; GFX9-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 def $vgpr12_vgpr13 killed $exec
...
; GFX9-O0-NEXT:    v_subb_co_u32_e32 v1, vcc, v1, v3, vcc
; GFX9-O0-NEXT:    ; implicit-def: $sgpr4
; GFX9-O0-NEXT:    ; implicit-def: $sgpr4
...
; GFX9-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 offset:92 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:76 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v11, off, s[0:3], s32 offset:72 ; 4-byte Folded Spill
...
; GFX9-O0-NEXT:    v_cmp_ne_u64_e64 s[12:13], v[10:11], s[6:7]
...
; GFX9-O0-NEXT:    v_cmp_ne_u64_e64 s[8:9], v[12:13], s[6:7]
