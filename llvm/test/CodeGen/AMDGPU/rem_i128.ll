...
; GFX9-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v22, v11, 0
; GFX9-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-NEXT:    v_mul_lo_u32 v9, v10, v4
; GFX9-NEXT:    v_mul_lo_u32 v16, v11, v5
; GFX9-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v21, v11, v[7:8]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v4, 0
; GFX9-NEXT:    v_mul_lo_u32 v11, v12, v21
; GFX9-NEXT:    v_mul_lo_u32 v13, v13, v22
; GFX9-NEXT:    v_mov_b32_e32 v7, v14
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v22, v10, v[7:8]
; GFX9-NEXT:    v_add3_u32 v5, v5, v16, v9
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v22, v[4:5]
...
; GFX9-NEXT:    v_add3_u32 v5, v13, v5, v11
