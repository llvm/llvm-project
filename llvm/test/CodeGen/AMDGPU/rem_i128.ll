...
; GFX9-NEXT:    v_lshrrev_b32_e32 v33, 31, v13
...
; GFX9-NEXT:    v_sub_co_u32_e32 v12, vcc, v28, v10
; GFX9-NEXT:    v_or_b32_e32 v14, v14, v33
; GFX9-NEXT:    v_subb_co_u32_e32 v12, vcc, v29, v13, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], 1, v[8:9]
; GFX9-NEXT:    v_subb_co_u32_e32 v12, vcc, v30, v14, vcc
; GFX9-NEXT:    v_lshrrev_b32_e32 v32, 31, v7
; GFX9-NEXT:    v_subb_co_u32_e32 v12, vcc, v31, v15, vcc
; GFX9-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX9-NEXT:    v_or3_b32 v8, v8, v32, v16
; GFX9-NEXT:    v_ashrrev_i32_e32 v32, 31, v12
; GFX9-NEXT:    v_and_b32_e32 v12, v32, v23
; GFX9-NEXT:    v_or_b32_e32 v6, v18, v6
; GFX9-NEXT:    v_and_b32_e32 v18, v32, v22
; GFX9-NEXT:    v_sub_co_u32_e32 v12, vcc, v10, v12
; GFX9-NEXT:    v_or_b32_e32 v7, v19, v7
; GFX9-NEXT:    v_and_b32_e32 v19, v32, v4
; GFX9-NEXT:    v_subb_co_u32_e32 v13, vcc, v13, v18, vcc
; GFX9-NEXT:    v_and_b32_e32 v33, v32, v5
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v14, v19, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v15, vcc, v15, v33, vcc
...
; GFX9-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v23, v13, 0
; GFX9-NEXT:    v_mov_b32_e32 v16, 0
; GFX9-NEXT:    v_mul_lo_u32 v17, v13, v5
; GFX9-NEXT:    v_mul_lo_u32 v7, v12, v4
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v22, v13, v[15:16]
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v4, 0
; GFX9-NEXT:    v_mul_lo_u32 v13, v8, v22
; GFX9-NEXT:    v_mul_lo_u32 v9, v9, v23
; GFX9-NEXT:    v_mov_b32_e32 v15, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v23, v12, v[15:16]
; GFX9-NEXT:    v_add3_u32 v11, v11, v17, v7
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v8, v23, v[10:11]
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v6, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v6, s[4:5], 0, 0, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v22, v12, v[5:6]
; GFX9-NEXT:    v_add3_u32 v8, v9, v8, v13
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v7
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v6, v8, vcc
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, v0, v14
...
; GFX9-NEXT:    v_cndmask_b32_e32 v17, 0, v13, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v16, 0, v12, vcc
...
; GFX9-NEXT:    v_lshlrev_b64 v[8:9], 1, v[8:9]
; GFX9-NEXT:    v_lshrrev_b32_e32 v30, 31, v11
; GFX9-NEXT:    v_or3_b32 v8, v8, v30, v20
; GFX9-NEXT:    v_lshrrev_b32_e32 v20, 31, v15
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], 1, v[14:15]
; GFX9-NEXT:    v_lshlrev_b64 v[16:17], 1, v[16:17]
; GFX9-NEXT:    v_or_b32_e32 v12, v14, v12
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, v26, v12
; GFX9-NEXT:    v_or_b32_e32 v16, v16, v20
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v27, v15, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v28, v16, vcc
...
; GFX9-NEXT:    v_and_b32_e32 v14, v30, v4
; GFX9-NEXT:    v_or_b32_e32 v10, v18, v10
; GFX9-NEXT:    v_and_b32_e32 v18, v30, v5
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, v12, v14
; GFX9-NEXT:    v_subb_co_u32_e32 v15, vcc, v15, v18, vcc
; GFX9-NEXT:    v_and_b32_e32 v12, v30, v6
; GFX9-NEXT:    v_and_b32_e32 v18, v30, v7
; GFX9-NEXT:    v_subb_co_u32_e32 v16, vcc, v16, v12, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v17, vcc, v17, v18, vcc
...
; GFX9-NEXT:    v_or_b32_e32 v18, v22, v24
; GFX9-NEXT:    v_or_b32_e32 v19, v23, v25
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[18:19]
; GFX9-NEXT:    v_and_b32_e32 v12, 1, v30
; GFX9-NEXT:    v_mov_b32_e32 v19, v13
; GFX9-NEXT:    v_or3_b32 v9, v9, 0, v21
; GFX9-NEXT:    v_mov_b32_e32 v20, 0
; GFX9-NEXT:    v_mov_b32_e32 v21, 0
; GFX9-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v18, v12
; GFX9-NEXT:    s_andn2_b64 exec, exec, s[4:5]
