...
; RUN: llc -mtriple=amdgcn -mcpu=tahiti -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefix=SI-GISEL %s
; RUN: llc -mtriple=amdgcn -mcpu=tonga -mattr=-flat-for-global -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefix=VI-GISEL %s
...
; VI-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: v_ctpop_i64_user:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0xd
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; SI-GISEL-NEXT:    s_mov_b32 s6, 0
; SI-GISEL-NEXT:    s_mov_b32 s7, 0xf000
...
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e64 v1, v1, 0
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v0, v0, v1
; SI-GISEL-NEXT:    v_or_b32_e32 v1, s8, v0
; SI-GISEL-NEXT:    buffer_store_dwordx2 v[1:2], off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: v_ctpop_i64_user:
; VI-GISEL:       ; %bb.0:
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
...
; VI-GISEL-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-GISEL-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; VI-GISEL-NEXT:    v_mov_b32_e32 v2, s5
; VI-GISEL-NEXT:    s_mov_b32 s2, -1
; VI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v1, v1, 0
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v0, v0, v1
; VI-GISEL-NEXT:    v_or_b32_e32 v1, s4, v0
; VI-GISEL-NEXT:    buffer_store_dwordx2 v[1:2], off, s[0:3], 0
; VI-GISEL-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %in.gep = getelementptr i64, ptr addrspace(1) %in, i32 %tid
  %val = load i64, ptr addrspace(1) %in.gep, align 8
...
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
...
; VI-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: s_ctpop_v4i64:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x11
; SI-GISEL-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-GISEL-NEXT:    s_mov_b32 s2, -1
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s4, s[8:9]
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s5, s[10:11]
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s6, s[12:13]
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s7, s[14:15]
...
; VI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s4, s[8:9]
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s5, s[10:11]
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s6, s[12:13]
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s7, s[14:15]
...
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v0, v0, v1
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v1, v2, v3
; SI-GISEL-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: v_ctpop_v2i64:
; VI-GISEL:       ; %bb.0:
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
...
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v0, v0, v1
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v1, v2, v3
...
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v0, v0, v1
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v1, v2, v3
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v2, v4, v5
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v3, v6, v7
; SI-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: v_ctpop_v4i64:
; VI-GISEL:       ; %bb.0:
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
...
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v1, v2, v3
; VI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v2, v5, 0
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v3, v7, 0
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v2, v4, v2
; VI-GISEL-NEXT:    v_bcnt_u32_b32 v3, v6, v3
; VI-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; VI-GISEL-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
;
; SI-GISEL-LABEL: ctpop_i64_in_br:
; SI-GISEL:       ; %bb.0: ; %entry
; SI-GISEL-NEXT:    s_load_dword s6, s[4:5], 0xf
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; SI-GISEL-NEXT:    s_mov_b32 s6, 1
; SI-GISEL-NEXT:    s_cbranch_scc0 .LBB7_2
; SI-GISEL-NEXT:  ; %bb.1: ; %else
; SI-GISEL-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x2
; SI-GISEL-NEXT:    s_mov_b32 s6, 0
; SI-GISEL-NEXT:    s_branch .LBB7_3
; SI-GISEL-NEXT:  .LBB7_2:
; SI-GISEL-NEXT:    ; implicit-def: $sgpr2_sgpr3
; SI-GISEL-NEXT:  .LBB7_3: ; %Flow
; SI-GISEL-NEXT:    s_xor_b32 s6, s6, 1
; SI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; SI-GISEL-NEXT:    s_cbranch_scc1 .LBB7_5
; SI-GISEL-NEXT:  ; %bb.4: ; %if
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xd
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; SI-GISEL-NEXT:    s_mov_b32 s3, 0
; SI-GISEL-NEXT:  .LBB7_5: ; %endif
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: ctpop_i64_in_br:
; VI-GISEL:       ; %bb.0: ; %entry
; VI-GISEL-NEXT:    s_load_dword s6, s[4:5], 0x3c
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; VI-GISEL-NEXT:    s_mov_b32 s6, 1
; VI-GISEL-NEXT:    s_cbranch_scc0 .LBB7_2
; VI-GISEL-NEXT:  ; %bb.1: ; %else
; VI-GISEL-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x8
; VI-GISEL-NEXT:    s_mov_b32 s6, 0
; VI-GISEL-NEXT:    s_branch .LBB7_3
; VI-GISEL-NEXT:  .LBB7_2:
; VI-GISEL-NEXT:    ; implicit-def: $sgpr2_sgpr3
; VI-GISEL-NEXT:  .LBB7_3: ; %Flow
; VI-GISEL-NEXT:    s_xor_b32 s6, s6, 1
; VI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; VI-GISEL-NEXT:    s_cbranch_scc1 .LBB7_5
; VI-GISEL-NEXT:  ; %bb.4: ; %if
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x34
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; VI-GISEL-NEXT:    s_mov_b32 s3, 0
; VI-GISEL-NEXT:  .LBB7_5: ; %endif
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    v_mov_b32_e32 v0, s2
; VI-GISEL-NEXT:    v_mov_b32_e32 v1, s3
; VI-GISEL-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; SI-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
...
; VI-NEXT:    s_mov_b32 s6, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; VI-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
...
; VI-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: s_ctpop_i128:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xb
; SI-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x9
; SI-GISEL-NEXT:    s_mov_b32 s6, -1
; SI-GISEL-NEXT:    s_mov_b32 s7, 0xf000
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; SI-GISEL-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
; SI-GISEL-NEXT:    s_add_i32 s0, s1, s0
; SI-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: s_ctpop_i128:
; VI-GISEL:       ; %bb.0:
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x2c
; VI-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x24
; VI-GISEL-NEXT:    s_mov_b32 s6, -1
; VI-GISEL-NEXT:    s_mov_b32 s7, 0xf000
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
; VI-GISEL-NEXT:    s_bcnt1_i32_b64 s1, s[2:3]
; VI-GISEL-NEXT:    s_add_i32 s0, s1, s0
; VI-GISEL-NEXT:    v_mov_b32_e32 v0, s0
...
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v0, v0, v1
; SI-GISEL-NEXT:    v_bcnt_u32_b32_e32 v1, v2, v3
; SI-GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
;
; VI-GISEL-LABEL: v_ctpop_i128:
; VI-GISEL:       ; %bb.0:
; VI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-GISEL-NEXT:    v_lshlrev_b32_e32 v2, 4, v0
; VI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
