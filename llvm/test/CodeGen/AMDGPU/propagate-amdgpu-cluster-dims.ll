...
; RUN: opt -S -mtriple=amdgpu12.50-amd-amdhsa -passes=amdgpu-attributor %s -o - | FileCheck %s
...
;.
; CHECK: attributes #[[ATTR0]] = { "amdgpu-cluster-dims"="2,2,2" }
; CHECK: attributes #[[ATTR1]] = { "amdgpu-cluster-dims"="0,0,0" }
; CHECK: attributes #[[ATTR2]] = { "amdgpu-cluster-dims"="1024,1024,1024" }
; CHECK: attributes #[[ATTR3]] = { "amdgpu-cluster-dims"="1,2,1" }
;.
