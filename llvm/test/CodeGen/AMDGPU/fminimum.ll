...
;
; GFX12-GISEL-LABEL: test_fminimum_v2f16_ss:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    s_lshr_b32 s2, s0, 16
; GFX12-GISEL-NEXT:    s_lshr_b32 s3, s1, 16
; GFX12-GISEL-NEXT:    s_minimum_f16 s0, s0, s1
; GFX12-GISEL-NEXT:    s_minimum_f16 s1, s2, s3
...
; GFX12-SDAG-LABEL: test_fminimum_v4f16:
; GFX12-SDAG:       ; %bb.0:
...
; GFX12-SDAG-NEXT:    v_minimum_f16 v1, v1, v3
; GFX12-SDAG-NEXT:    v_minimum_f16 v0, v0, v2
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX12-SDAG-NEXT:    v_minimum_f16 v2, v6, v5
; GFX12-SDAG-NEXT:    v_minimum_f16 v3, v7, v4
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-SDAG-NEXT:    v_perm_b32 v0, v2, v0, 0x5040100
; GFX12-SDAG-NEXT:    v_perm_b32 v1, v3, v1, 0x5040100
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: test_fminimum_v4f16:
; GFX12-GISEL:       ; %bb.0:
...
; GFX12-GISEL-NEXT:    v_minimum_f16 v2, v4, v6
; GFX12-GISEL-NEXT:    v_minimum_f16 v3, v5, v7
...
; GFX12-SDAG-LABEL: test_fminimum_v4f16_ss:
; GFX12-SDAG:       ; %bb.0:
...
; GFX12-SDAG-NEXT:    s_minimum_f16 s4, s5, s4
; GFX12-SDAG-NEXT:    s_minimum_f16 s5, s7, s6
; GFX12-SDAG-NEXT:    s_minimum_f16 s0, s0, s2
; GFX12-SDAG-NEXT:    s_minimum_f16 s1, s1, s3
...
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: test_fminimum_v4f16_ss:
; GFX12-GISEL:       ; %bb.0:
...
; GFX12-GISEL-NEXT:    s_minimum_f16 s2, s4, s6
; GFX12-GISEL-NEXT:    s_minimum_f16 s1, s1, s3
; GFX12-GISEL-NEXT:    s_minimum_f16 s3, s5, s7
