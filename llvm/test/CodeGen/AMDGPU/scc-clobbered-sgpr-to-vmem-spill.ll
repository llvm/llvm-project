...
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_writelane_b32 v22, s0, 56
; CHECK-NEXT:    v_writelane_b32 v22, s1, 57
; CHECK-NEXT:    v_writelane_b32 v22, s2, 58
; CHECK-NEXT:    v_writelane_b32 v22, s3, 59
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def s[0:7]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    ; implicit-def: $vgpr23 : SGPR spill to VGPR lane
; CHECK-NEXT:    v_writelane_b32 v22, s0, 60
; CHECK-NEXT:    v_writelane_b32 v23, s4, 0
; CHECK-NEXT:    v_writelane_b32 v22, s1, 61
; CHECK-NEXT:    v_writelane_b32 v23, s5, 1
; CHECK-NEXT:    v_writelane_b32 v22, s2, 62
; CHECK-NEXT:    v_writelane_b32 v23, s6, 2
; CHECK-NEXT:    v_writelane_b32 v22, s3, 63
; CHECK-NEXT:    v_writelane_b32 v23, s7, 3
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def s[0:15]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_writelane_b32 v23, s0, 4
; CHECK-NEXT:    v_writelane_b32 v23, s1, 5
; CHECK-NEXT:    v_writelane_b32 v23, s2, 6
; CHECK-NEXT:    v_writelane_b32 v23, s3, 7
; CHECK-NEXT:    v_writelane_b32 v23, s4, 8
; CHECK-NEXT:    v_writelane_b32 v23, s5, 9
; CHECK-NEXT:    v_writelane_b32 v23, s6, 10
; CHECK-NEXT:    v_writelane_b32 v23, s7, 11
; CHECK-NEXT:    v_writelane_b32 v23, s8, 12
; CHECK-NEXT:    v_writelane_b32 v23, s9, 13
; CHECK-NEXT:    v_writelane_b32 v23, s10, 14
; CHECK-NEXT:    v_writelane_b32 v23, s11, 15
; CHECK-NEXT:    v_writelane_b32 v23, s12, 16
; CHECK-NEXT:    v_writelane_b32 v23, s13, 17
; CHECK-NEXT:    v_writelane_b32 v23, s14, 18
; CHECK-NEXT:    v_writelane_b32 v23, s15, 19
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def s[0:1]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    v_writelane_b32 v23, s2, 24
; CHECK-NEXT:    v_writelane_b32 v23, s3, 25
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def s[0:7]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_writelane_b32 v23, s0, 26
; CHECK-NEXT:    v_writelane_b32 v23, s1, 27
; CHECK-NEXT:    v_writelane_b32 v23, s2, 28
; CHECK-NEXT:    v_writelane_b32 v23, s3, 29
...
; CHECK-NEXT:    v_writelane_b32 v23, s8, 42
; CHECK-NEXT:    v_writelane_b32 v23, s9, 43
; CHECK-NEXT:    v_writelane_b32 v23, s10, 44
; CHECK-NEXT:    v_writelane_b32 v23, s11, 45
; CHECK-NEXT:    v_writelane_b32 v23, s12, 46
; CHECK-NEXT:    v_writelane_b32 v23, s13, 47
; CHECK-NEXT:    v_writelane_b32 v23, s14, 48
; CHECK-NEXT:    v_writelane_b32 v23, s15, 49
...
; CHECK-NEXT:    ; use s[0:1]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_readlane_b32 s0, v22, 56
; CHECK-NEXT:    v_readlane_b32 s1, v22, 57
; CHECK-NEXT:    v_readlane_b32 s2, v22, 58
; CHECK-NEXT:    v_readlane_b32 s3, v22, 59
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use s[0:3]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    ; use s[0:7]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_readlane_b32 s0, v23, 4
; CHECK-NEXT:    v_readlane_b32 s1, v23, 5
; CHECK-NEXT:    v_readlane_b32 s2, v23, 6
; CHECK-NEXT:    v_readlane_b32 s3, v23, 7
; CHECK-NEXT:    v_readlane_b32 s4, v23, 8
; CHECK-NEXT:    v_readlane_b32 s5, v23, 9
; CHECK-NEXT:    v_readlane_b32 s6, v23, 10
; CHECK-NEXT:    v_readlane_b32 s7, v23, 11
; CHECK-NEXT:    v_readlane_b32 s8, v23, 12
; CHECK-NEXT:    v_readlane_b32 s9, v23, 13
; CHECK-NEXT:    v_readlane_b32 s10, v23, 14
; CHECK-NEXT:    v_readlane_b32 s11, v23, 15
; CHECK-NEXT:    v_readlane_b32 s12, v23, 16
; CHECK-NEXT:    v_readlane_b32 s13, v23, 17
; CHECK-NEXT:    v_readlane_b32 s14, v23, 18
; CHECK-NEXT:    v_readlane_b32 s15, v23, 19
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use s[0:15]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    v_readlane_b32 s2, v23, 24
; CHECK-NEXT:    v_readlane_b32 s3, v23, 25
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use s[0:3]
; CHECK-NEXT:    ;;#ASMEND
...
; CHECK-NEXT:    v_readlane_b32 s8, v23, 42
; CHECK-NEXT:    v_readlane_b32 s9, v23, 43
; CHECK-NEXT:    v_readlane_b32 s10, v23, 44
; CHECK-NEXT:    v_readlane_b32 s11, v23, 45
; CHECK-NEXT:    v_readlane_b32 s12, v23, 46
; CHECK-NEXT:    v_readlane_b32 s13, v23, 47
; CHECK-NEXT:    v_readlane_b32 s14, v23, 48
; CHECK-NEXT:    v_readlane_b32 s15, v23, 49
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; use s[0:15]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    s_endpgm
