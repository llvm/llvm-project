...
; GCN-LABEL: copy_flat_divergent:
; GCN:       ; %bb.0: ; %entry
; GCN-NEXT:    s_load_b32 s0, s[2:3], 0x34
; GCN-NEXT:    s_wait_kmcnt 0x0
...
; GCN-NEXT:    s_wait_kmcnt 0x0
; GCN-NEXT:    v_add_co_u32 v2, s1, s6, v0
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GCN-NEXT:    v_add_co_ci_u32_e64 v3, null, s7, 0, s1
; GCN-NEXT:    v_add_co_u32 v0, s1, s4, v0
; GCN-NEXT:    v_add_co_u32 v2, vcc_lo, 0xb0, v2
; GCN-NEXT:    v_add_co_ci_u32_e64 v1, null, s5, 0, s1
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GCN-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v3, vcc_lo
; GCN-NEXT:  .LBB4_2: ; %for.body
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    flat_load_b128 v[4:7], v[2:3] offset:-176
; GCN-NEXT:    v_add_co_u32 v2, vcc_lo, v2, 16
; GCN-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v3, vcc_lo
; GCN-NEXT:    s_wait_alu 0xfffe
...
; GCN-NEXT:    s_wait_loadcnt_dscnt 0x0
; GCN-NEXT:    flat_store_b128 v[0:1], v[4:7]
; GCN-NEXT:    v_add_co_u32 v0, vcc_lo, v0, 16
; GCN-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GCN-NEXT:    s_cbranch_scc1 .LBB4_2
; GCN-NEXT:  .LBB4_3: ; %for.end
; GCN-NEXT:    s_endpgm
;
...
; GCN-LABEL: copy_global_divergent:
; GCN:       ; %bb.0: ; %entry
; GCN-NEXT:    s_load_b32 s0, s[2:3], 0x34
; GCN-NEXT:    s_wait_kmcnt 0x0
; GCN-NEXT:    s_cmp_eq_u32 s0, 0
...
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GCN-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v3, vcc_lo
; GCN-NEXT:  .LBB5_2: ; %for.body
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    global_load_b128 v[4:7], v[2:3], off offset:-176
; GCN-NEXT:    v_add_co_u32 v2, vcc_lo, v2, 16
; GCN-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v3, vcc_lo
; GCN-NEXT:    s_wait_alu 0xfffe
; GCN-NEXT:    s_add_co_i32 s0, s0, -1
...
; GCN-NEXT:    s_cmp_lg_u32 s0, 0
; GCN-NEXT:    s_wait_loadcnt 0x0
; GCN-NEXT:    global_store_b128 v[0:1], v[4:7], off
; GCN-NEXT:    v_add_co_u32 v0, vcc_lo, v0, 16
; GCN-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GCN-NEXT:    s_cbranch_scc1 .LBB5_2
; GCN-NEXT:  .LBB5_3: ; %for.end
; GCN-NEXT:    s_nop 0
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
;
