...
; RUN: llc -march=amdgcn -mcpu=gfx1200 -amdgpu-loop-prefetch < %s | FileCheck --check-prefixes=GCN,GCNES0 %s
; RUN: llc -march=amdgcn -mcpu=gfx1200 -amdgpu-loop-prefetch -amdgpu-software-hazard-mode < %s | FileCheck --check-prefixes=GCN,GCNES2 %s
...
; GCN-NEXT:    s_load_b32 s6, s[0:1], 0x34
...
; GCN-NEXT:    s_movk_i32 s4, 0xb0
; GCN-NEXT:    s_wait_kmcnt 0x0
; GCN-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[4:5]
