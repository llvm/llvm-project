...
; RUN: llc -mtriple=amdgpu9.08 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu9.00 < %s

; RUN: llc -mtriple=amdgpu9.0a -stop-after=amdgpu-remove-incompatible-functions\
