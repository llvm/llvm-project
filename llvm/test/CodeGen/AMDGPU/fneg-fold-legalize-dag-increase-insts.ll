...
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa < %s | FileCheck %s --check-prefix=GFX9
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa < %s | FileCheck %s --check-prefix=GFX10
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -amdgpu-enable-delay-alu=0 < %s | FileCheck %s --check-prefix=GFX10
