...
; RUN: opt -S -mtriple=amdgcn-- -passes=amdgpu-attributor-cgscc,amdgpu-lower-module-lds < %s --amdgpu-lower-module-lds-strategy=table | FileCheck -check-prefixes=CHECK,TABLE %s
