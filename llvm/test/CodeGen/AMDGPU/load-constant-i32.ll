...
; GFX6-NOHSA-NEXT:    s_mov_b32 s19, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s18, -1
; GFX6-NOHSA-NEXT:    s_ashr_i32 s20, s13, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s21, s15, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s14, s14, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s12, s12, 31
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v5, s12
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s20
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s0
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:96
; GFX6-NOHSA-NEXT:    s_ashr_i32 s12, s1, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s0, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s13, s3, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s2, s2, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s14, s5, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s4, s4, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s15, s7, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s20, s9, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s8, s8, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s21, s11, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s10, s10, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s6, s6, 31
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s1
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v9, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s21
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v13, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s20
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s6
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v19, s15
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[16:19], 0 offset:48
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s4
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v27, s13
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s33
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s30
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[0:3]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[14:15], v[8:11]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s6
; GFX7-HSA-NEXT:    s_add_u32 s6, s16, 48
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[3:6]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s7
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s17
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[6:9]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    s_endpgm
;
...
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[16:19], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x10
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s12
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v8, s10
...
; GFX6-NOHSA-NEXT:    s_load_dwordx16 s[16:31], s[18:19], 0x0
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s12, s9, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s13, s11, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s10, s10, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s8, s8, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v10, s11
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v9, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s13
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0) lgkmcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s30
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[36:39], 0 offset:208
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v14, s9
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v13, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s12
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v8, s28
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v24, s20
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[36:39], 0 offset:128
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s29, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s1, s31, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s2, s30, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s3, s28, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v5, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s1
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s0, s17, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s1, s16, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s2, s19, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s3, s18, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s4, s21, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s5, s20, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s6, s23, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s7, s25, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s8, s24, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s9, s27, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s10, s26, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s11, s22, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v14, s27
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s25
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v22, s23
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v26, s21
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s19
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s17
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v13, s10
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s9
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s8
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v25, s5
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v27, s4
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s0
...
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s6
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s4
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s2
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s0
; GFX7-HSA-NEXT:    s_ashr_i32 s24, s1, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s25, s0, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s29, s3, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s30, s2, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s31, s5, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s4, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s36, s7, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s37, s6, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s38, s9, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s39, s8, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s40, s11, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s41, s10, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s42, s13, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s43, s12, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s44, s15, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s45, s14, 31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s15
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s9
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s7
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s5
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s3
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s1
; GFX7-HSA-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s45
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s44
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s43
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s41
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0xe0
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v30, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v31, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v32, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v33, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0xc0
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v34, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v35, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0xb0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[24:27]
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0xa0
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s42
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0x90
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[30:31], v[21:24]
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v30, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v31, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0x80
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s40
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0x70
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[32:33], v[18:21]
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0x60
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v32, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v33, s35
; GFX7-HSA-NEXT:    s_add_u32 s34, s16, 0x50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s37
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s36
; GFX7-HSA-NEXT:    s_addc_u32 s35, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s39
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s38
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[26:27], v[7:10]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s33
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s30
; GFX7-HSA-NEXT:    s_add_u32 s30, s16, 64
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[34:35], v[0:3]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[4:7]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s29
; GFX7-HSA-NEXT:    s_addc_u32 s31, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s49
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s52
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s46
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[30:31], v[11:14]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s51
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s15
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s13
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[22:23], v[15:18]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[19:20], v[24:27]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[32:33], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s9
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s8
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s28
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s6
; GFX7-HSA-NEXT:    s_add_u32 s6, s16, 48
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[3:6]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s7
; GFX7-HSA-NEXT:    s_addc_u32 s7, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s6
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s27
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s17
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[34:35], v[7:10]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    s_endpgm
;
