...
;
; VOPD is disabled to use common checks for both gfx12 targets
; RUN: llc -march=amdgcn -mcpu=gfx1200 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX12 %s
; RUN: llc -march=amdgcn -mcpu=gfx1210 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX12 %s
...
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v9, s12
; GFX12-NEXT:    v_mov_b32_e32 v0, s4
; GFX12-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-NEXT:    v_mov_b32_e32 v2, s6
; GFX12-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v8, s12
; GFX12-NEXT:    v_mov_b32_e32 v9, s13
; GFX12-NEXT:    v_mov_b32_e32 v10, s14
; GFX12-NEXT:    v_mov_b32_e32 v0, s4
; GFX12-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-NEXT:    v_mov_b32_e32 v2, s6
; GFX12-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX12-NEXT:    v_mov_b32_e32 v1, s13
; GFX12-NEXT:    v_mov_b32_e32 v2, s14
; GFX12-NEXT:    v_mov_b32_e32 v3, s15
; GFX12-NEXT:    v_mov_b32_e32 v4, s8
; GFX12-NEXT:    v_mov_b32_e32 v5, s9
; GFX12-NEXT:    v_mov_b32_e32 v6, s10
; GFX12-NEXT:    v_mov_b32_e32 v7, s11
; GFX12-NEXT:    v_mov_b32_e32 v8, s4
; GFX12-NEXT:    v_mov_b32_e32 v9, s5
; GFX12-NEXT:    v_mov_b32_e32 v10, s6
; GFX12-NEXT:    v_mov_b32_e32 v11, s7
; GFX12-NEXT:    v_mov_b32_e32 v12, s0
; GFX12-NEXT:    v_mov_b32_e32 v13, s1
; GFX12-NEXT:    v_mov_b32_e32 v14, s2
; GFX12-NEXT:    v_mov_b32_e32 v15, s3
...
; GFX12-NEXT:    v_mov_b32_e32 v0, s6
; GFX12-NEXT:    v_mov_b32_e32 v2, s7
; GFX12-NEXT:    v_mov_b32_e32 v1, s9
; GFX12-NEXT:    v_mov_b32_e32 v3, s8
; GFX12-NEXT:    v_mov_b32_e32 v4, s4
; GFX12-NEXT:    v_mov_b32_e32 v6, s5
; GFX12-NEXT:    v_mov_b32_e32 v5, s3
; GFX12-NEXT:    v_mov_b32_e32 v7, s2
; GFX12-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    v_mov_b32_e32 v1, s17
; GFX12-NEXT:    v_mov_b32_e32 v3, s16
; GFX12-NEXT:    s_ashr_i32 s2, s5, 31
; GFX12-NEXT:    s_ashr_i32 s3, s4, 31
; GFX12-NEXT:    v_mov_b32_e32 v4, s8
; GFX12-NEXT:    v_mov_b32_e32 v6, s9
; GFX12-NEXT:    v_mov_b32_e32 v5, s15
; GFX12-NEXT:    v_mov_b32_e32 v7, s14
; GFX12-NEXT:    v_mov_b32_e32 v8, s6
; GFX12-NEXT:    v_mov_b32_e32 v10, s7
; GFX12-NEXT:    v_mov_b32_e32 v9, s13
; GFX12-NEXT:    v_mov_b32_e32 v11, s12
; GFX12-NEXT:    v_mov_b32_e32 v12, s4
; GFX12-NEXT:    v_mov_b32_e32 v14, s5
; GFX12-NEXT:    v_mov_b32_e32 v13, s3
...
; GFX12-NEXT:    v_mov_b32_e32 v8, s10
; GFX12-NEXT:    v_mov_b32_e32 v10, s11
; GFX12-NEXT:    v_mov_b32_e32 v1, s34
; GFX12-NEXT:    v_mov_b32_e32 v3, s33
; GFX12-NEXT:    v_mov_b32_e32 v9, s29
; GFX12-NEXT:    v_mov_b32_e32 v11, s28
; GFX12-NEXT:    s_ashr_i32 s22, s5, 31
; GFX12-NEXT:    s_ashr_i32 s23, s4, 31
; GFX12-NEXT:    v_mov_b32_e32 v4, s12
; GFX12-NEXT:    v_mov_b32_e32 v6, s13
; GFX12-NEXT:    v_mov_b32_e32 v12, s8
; GFX12-NEXT:    v_mov_b32_e32 v14, s9
; GFX12-NEXT:    v_mov_b32_e32 v5, s31
; GFX12-NEXT:    v_mov_b32_e32 v7, s30
; GFX12-NEXT:    v_mov_b32_e32 v13, s27
; GFX12-NEXT:    v_mov_b32_e32 v15, s26
; GFX12-NEXT:    s_ashr_i32 s20, s3, 31
; GFX12-NEXT:    s_ashr_i32 s21, s2, 31
; GFX12-NEXT:    v_mov_b32_e32 v16, s6
; GFX12-NEXT:    v_mov_b32_e32 v18, s7
; GFX12-NEXT:    v_mov_b32_e32 v17, s25
; GFX12-NEXT:    v_mov_b32_e32 v19, s24
; GFX12-NEXT:    s_ashr_i32 s18, s1, 31
; GFX12-NEXT:    s_ashr_i32 s19, s0, 31
; GFX12-NEXT:    v_mov_b32_e32 v20, s4
; GFX12-NEXT:    v_mov_b32_e32 v22, s5
; GFX12-NEXT:    v_mov_b32_e32 v21, s23
; GFX12-NEXT:    v_mov_b32_e32 v23, s22
; GFX12-NEXT:    v_mov_b32_e32 v24, s2
; GFX12-NEXT:    v_mov_b32_e32 v26, s3
; GFX12-NEXT:    v_mov_b32_e32 v25, s21
; GFX12-NEXT:    v_mov_b32_e32 v27, s20
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v28, v[0:3], s[16:17] offset:112
; GFX12-NEXT:    global_store_b128 v28, v[4:7], s[16:17] offset:96
; GFX12-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-NEXT:    v_mov_b32_e32 v1, s19
; GFX12-NEXT:    v_mov_b32_e32 v2, s1
; GFX12-NEXT:    v_mov_b32_e32 v3, s18
...
; GFX12-NEXT:    v_mov_b32_e32 v24, 0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    v_mov_b32_e32 v0, s30
; GFX12-NEXT:    v_mov_b32_e32 v2, s31
; GFX12-NEXT:    v_mov_b32_e32 v1, s65
; GFX12-NEXT:    v_mov_b32_e32 v3, s64
; GFX12-NEXT:    s_ashr_i32 s58, s25, 31
; GFX12-NEXT:    s_ashr_i32 s59, s24, 31
; GFX12-NEXT:    v_mov_b32_e32 v4, s28
; GFX12-NEXT:    v_mov_b32_e32 v6, s29
; GFX12-NEXT:    v_mov_b32_e32 v5, s63
; GFX12-NEXT:    v_mov_b32_e32 v7, s62
; GFX12-NEXT:    v_mov_b32_e32 v8, s26
; GFX12-NEXT:    v_mov_b32_e32 v9, s61
; GFX12-NEXT:    v_mov_b32_e32 v10, s27
; GFX12-NEXT:    v_mov_b32_e32 v11, s60
; GFX12-NEXT:    s_ashr_i32 s57, s23, 31
; GFX12-NEXT:    v_mov_b32_e32 v12, s24
; GFX12-NEXT:    v_mov_b32_e32 v13, s59
; GFX12-NEXT:    v_mov_b32_e32 v14, s25
; GFX12-NEXT:    v_mov_b32_e32 v15, s58
...
; GFX12-NEXT:    v_mov_b32_e32 v1, s24
; GFX12-NEXT:    v_mov_b32_e32 v2, s23
; GFX12-NEXT:    v_mov_b32_e32 v3, s57
...
; GFX12-NEXT:    v_mov_b32_e32 v7, s55
; GFX12-NEXT:    s_ashr_i32 s50, s14, 31
; GFX12-NEXT:    v_mov_b32_e32 v8, s18
; GFX12-NEXT:    v_mov_b32_e32 v9, s54
; GFX12-NEXT:    v_mov_b32_e32 v10, s19
; GFX12-NEXT:    v_mov_b32_e32 v11, s53
...
; GFX12-NEXT:    v_mov_b32_e32 v12, s16
; GFX12-NEXT:    v_mov_b32_e32 v13, s52
; GFX12-NEXT:    v_mov_b32_e32 v14, s17
; GFX12-NEXT:    v_mov_b32_e32 v15, s51
...
; GFX12-NEXT:    v_mov_b32_e32 v18, s15
; GFX12-NEXT:    v_mov_b32_e32 v19, s49
; GFX12-NEXT:    s_ashr_i32 s41, s7, 31
; GFX12-NEXT:    s_ashr_i32 s42, s6, 31
; GFX12-NEXT:    v_mov_b32_e32 v20, s12
; GFX12-NEXT:    v_mov_b32_e32 v21, s48
; GFX12-NEXT:    v_mov_b32_e32 v22, s13
; GFX12-NEXT:    v_mov_b32_e32 v23, s47
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    v_mov_b32_e32 v0, s10
; GFX12-NEXT:    v_mov_b32_e32 v1, s46
; GFX12-NEXT:    v_mov_b32_e32 v2, s11
; GFX12-NEXT:    v_mov_b32_e32 v3, s45
; GFX12-NEXT:    s_ashr_i32 s39, s5, 31
; GFX12-NEXT:    s_ashr_i32 s40, s4, 31
; GFX12-NEXT:    v_mov_b32_e32 v4, s8
; GFX12-NEXT:    v_mov_b32_e32 v5, s44
; GFX12-NEXT:    v_mov_b32_e32 v6, s9
; GFX12-NEXT:    v_mov_b32_e32 v7, s43
; GFX12-NEXT:    s_ashr_i32 s35, s3, 31
; GFX12-NEXT:    s_ashr_i32 s38, s2, 31
; GFX12-NEXT:    v_mov_b32_e32 v8, s6
; GFX12-NEXT:    v_mov_b32_e32 v9, s42
; GFX12-NEXT:    v_mov_b32_e32 v10, s7
; GFX12-NEXT:    v_mov_b32_e32 v11, s41
; GFX12-NEXT:    s_ashr_i32 s33, s1, 31
; GFX12-NEXT:    s_ashr_i32 s34, s0, 31
; GFX12-NEXT:    v_mov_b32_e32 v12, s4
; GFX12-NEXT:    v_mov_b32_e32 v13, s40
; GFX12-NEXT:    v_mov_b32_e32 v14, s5
; GFX12-NEXT:    v_mov_b32_e32 v15, s39
; GFX12-NEXT:    v_mov_b32_e32 v16, s2
; GFX12-NEXT:    v_mov_b32_e32 v17, s38
; GFX12-NEXT:    v_mov_b32_e32 v18, s3
; GFX12-NEXT:    v_mov_b32_e32 v19, s35
; GFX12-NEXT:    v_mov_b32_e32 v20, s0
; GFX12-NEXT:    v_mov_b32_e32 v21, s34
; GFX12-NEXT:    v_mov_b32_e32 v22, s1
; GFX12-NEXT:    v_mov_b32_e32 v23, s33
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mov_b32_e32 v0, s28
; GFX12-NEXT:    v_mov_b32_e32 v1, s29
; GFX12-NEXT:    v_mov_b32_e32 v2, s30
; GFX12-NEXT:    v_mov_b32_e32 v3, s31
; GFX12-NEXT:    v_mov_b32_e32 v4, s24
; GFX12-NEXT:    v_mov_b32_e32 v5, s25
; GFX12-NEXT:    v_mov_b32_e32 v6, s26
; GFX12-NEXT:    v_mov_b32_e32 v7, s27
; GFX12-NEXT:    v_mov_b32_e32 v8, s20
; GFX12-NEXT:    v_mov_b32_e32 v9, s21
; GFX12-NEXT:    v_mov_b32_e32 v10, s22
; GFX12-NEXT:    v_mov_b32_e32 v11, s23
; GFX12-NEXT:    v_mov_b32_e32 v12, s16
; GFX12-NEXT:    v_mov_b32_e32 v13, s17
; GFX12-NEXT:    v_mov_b32_e32 v14, s18
; GFX12-NEXT:    v_mov_b32_e32 v15, s19
; GFX12-NEXT:    v_mov_b32_e32 v16, s12
; GFX12-NEXT:    v_mov_b32_e32 v17, s13
; GFX12-NEXT:    v_mov_b32_e32 v18, s14
; GFX12-NEXT:    v_mov_b32_e32 v19, s15
; GFX12-NEXT:    v_mov_b32_e32 v20, s8
; GFX12-NEXT:    v_mov_b32_e32 v21, s9
; GFX12-NEXT:    v_mov_b32_e32 v22, s10
; GFX12-NEXT:    v_mov_b32_e32 v23, s11
; GFX12-NEXT:    v_mov_b32_e32 v24, s4
; GFX12-NEXT:    v_mov_b32_e32 v25, s5
; GFX12-NEXT:    v_mov_b32_e32 v26, s6
; GFX12-NEXT:    v_mov_b32_e32 v27, s7
; GFX12-NEXT:    v_mov_b32_e32 v28, s0
; GFX12-NEXT:    v_mov_b32_e32 v29, s1
; GFX12-NEXT:    v_mov_b32_e32 v30, s2
; GFX12-NEXT:    v_mov_b32_e32 v31, s3
