...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v28, s0
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v30, s1
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v29, s21
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v31, s20
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[16:19], 0
; GFX6-NOHSA-NEXT:    s_endpgm
;
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s30, s30, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s31, s31, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s30
; GFX6-NOHSA-NEXT:    s_ashr_i32 s30, s9, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s31, s8, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s28
; GFX6-NOHSA-NEXT:    s_ashr_i32 s28, s28, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s29
; GFX6-NOHSA-NEXT:    s_ashr_i32 s29, s29, 31
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s18
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v23, s22
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s24, s24, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v28, s27
; GFX6-NOHSA-NEXT:    s_ashr_i32 s27, s27, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v26, s26
; GFX6-NOHSA-NEXT:    s_ashr_i32 s26, s26, 31
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v27, s26
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v29, s27
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[26:29], off, s[36:39], 0 offset:208
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v27, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v29, s9
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v26, s23
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[23:26], off, s[36:39], 0 offset:176
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v24, s4
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v26, s5
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s20
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v23, s21
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[20:23], off, s[36:39], 0 offset:160
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v23, s3
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s18
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v20, s19
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[17:20], off, s[36:39], 0 offset:144
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s0
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v20, s1
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s16
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s17
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[14:17], off, s[36:39], 0 offset:128
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v12, s14
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v14, s15
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[11:14], off, s[36:39], 0 offset:112
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v9, s12
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s28
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[36:39], 0 offset:80
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v28, s31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v30, s30
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[27:30], off, s[36:39], 0 offset:64
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v24, s35
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[21:24], off, s[36:39], 0 offset:16
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v19, s34
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s33
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[18:21], off, s[36:39], 0
; GFX6-NOHSA-NEXT:    s_endpgm
;
...
; GFX7-HSA-NEXT:    s_ashr_i32 s34, s0, 31
...
; GFX7-HSA-NEXT:    s_ashr_i32 s38, s13, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s39, s12, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s49, s15, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s52, s14, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s53, s17, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s54, s16, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s55, s19, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s56, s18, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s57, s21, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s58, s20, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s59, s23, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s60, s22, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s61, s25, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s62, s24, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s63, s27, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s64, s26, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s65, s29, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s66, s28, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s67, s31, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s68, s30, 31
; GFX7-HSA-NEXT:    s_add_u32 s50, s36, 0xf0
; GFX7-HSA-NEXT:    s_addc_u32 s51, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s51
; GFX7-HSA-NEXT:    s_add_u32 s50, s36, 0xe0
; GFX7-HSA-NEXT:    s_addc_u32 s51, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s20
; GFX7-HSA-NEXT:    s_add_u32 s20, s36, 0xd0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s21
; GFX7-HSA-NEXT:    s_addc_u32 s21, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v30, s21
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s20
; GFX7-HSA-NEXT:    s_add_u32 s20, s36, 0xc0
; GFX7-HSA-NEXT:    s_addc_u32 s21, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s68
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s67
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s18
; GFX7-HSA-NEXT:    s_add_u32 s18, s36, 0xb0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[25:26], v[0:3]
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s27
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s63
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s21
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s16
; GFX7-HSA-NEXT:    s_add_u32 s16, s36, 0xa0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s62
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s61
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[29:30], v[8:11]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[1:2], v[12:15]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s17
; GFX7-HSA-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s16
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s51
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s28
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s66
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s29
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s65
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s17
; GFX7-HSA-NEXT:    s_add_u32 s16, s36, 0x90
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[27:28], v[4:7]
; GFX7-HSA-NEXT:    s_addc_u32 s17, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s18
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s22
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s60
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s23
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s59
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s19
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s14
; GFX7-HSA-NEXT:    s_add_u32 s14, s36, 0x80
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[5:6], v[16:19]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s15
; GFX7-HSA-NEXT:    s_addc_u32 s15, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s15
; GFX7-HSA-NEXT:    s_add_u32 s14, s36, 0x70
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s58
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s57
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s16
; GFX7-HSA-NEXT:    s_addc_u32 s15, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s56
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s55
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s54
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s17
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[20:23]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s14
; GFX7-HSA-NEXT:    s_add_u32 s12, s36, 0x60
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s53
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s52
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s49
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s15
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[10:11], v[24:27]
...
; GFX9-HSA-NEXT:    s_ashr_i32 s30, s30, 31
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s31
; GFX9-HSA-NEXT:    s_ashr_i32 s31, s31, 31
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s30
; GFX9-HSA-NEXT:    s_ashr_i32 s30, s27, 31
; GFX9-HSA-NEXT:    v_mov_b32_e32 v4, s31
; GFX9-HSA-NEXT:    s_ashr_i32 s31, s26, 31
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v4, s30
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v5, s28
; GFX9-HSA-NEXT:    s_ashr_i32 s28, s28, 31
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v6, s28
; GFX9-HSA-NEXT:    s_ashr_i32 s28, s29, 31
; GFX9-HSA-NEXT:    global_store_dwordx4 v0, v[1:4], s[36:37] offset:32
; GFX9-HSA-NEXT:    v_mov_b32_e32 v7, s29
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s38
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s3
; GFX9-HSA-NEXT:    v_mov_b32_e32 v4, s35
; GFX9-HSA-NEXT:    v_mov_b32_e32 v8, s28
; GFX9-HSA-NEXT:    global_store_dwordx4 v0, v[1:4], s[36:37] offset:16
; GFX9-HSA-NEXT:    global_store_dwordx4 v0, v[5:8], s[36:37] offset:224
...
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dwordx16 s[16:31], s[38:39], 0x10
; GFX7-HSA-NEXT:    s_add_u32 s0, s36, 0x70
; GFX7-HSA-NEXT:    s_addc_u32 s1, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s1
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s0
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
