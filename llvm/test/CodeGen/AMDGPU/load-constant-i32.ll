...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=GFX6-NOHSA %s
; RUN: llc -mtriple=amdgpu7.00--amdhsa < %s | FileCheck -check-prefix=GFX7-HSA %s
; RUN: llc -mtriple=amdgpu8.02 < %s | FileCheck -check-prefix=GFX8-NOHSA %s
; RUN: llc -mtriple=r600 -mcpu=redwood < %s | FileCheck -check-prefix=EG %s
; RUN: llc -mtriple=amdgpu9.00--amdhsa < %s | FileCheck -check-prefix=GFX9-HSA %s
; RUN: llc -mtriple=amdgpu9.08--amdhsa < %s | FileCheck -check-prefix=GFX9-HSA %s
...
; GFX6-NOHSA:       ; %bb.0: ; %entry
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dword s16, s[14:15], 0x8
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[14:15], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s12
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s13
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA-NEXT:    buffer_store_dword v3, off, s[0:3], 0 offset:32
...
; GFX7-HSA-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dword s12, s[2:3], 0x8
; GFX7-HSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
...
; GFX8-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_load_dword s12, s[2:3], 0x20
; GFX8-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    s_load_dword s12, s[2:3], 0x20
...
; GFX9-HSA-NEXT:    global_store_dword v8, v5, s[0:1] offset:32
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    s_load_b32 s12, s[10:11], 0x20 nv
; GFX1250-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx2 s[16:17], s[14:15], 0x8
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[14:15], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s12
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s13
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s9
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s10
; GFX6-NOHSA-NEXT:    buffer_store_dwordx2 v[3:4], off, s[0:3], 0 offset:32
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s11
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:16
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX7-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x8
; GFX7-HSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
; GFX7-HSA-NEXT:    s_add_u32 s2, s0, 32
; GFX7-HSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s3
...
; GFX8-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NOHSA-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x20
; GFX8-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 32
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
; GFX8-NOHSA-NEXT:    v_mov_b32_e32 v5, s3
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v8, 0
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0x20
; GFX9-HSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    v_mov_b32_e32 v5, s12
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s11
; GFX9-HSA-NEXT:    v_mov_b32_e32 v4, s4
; GFX9-HSA-NEXT:    global_store_dwordx2 v8, v[5:6], s[0:1] offset:32
; GFX9-HSA-NEXT:    global_store_dwordx4 v8, v[0:3], s[0:1] offset:16
; GFX9-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX9-HSA-NEXT:    v_mov_b32_e32 v6, s6
; GFX9-HSA-NEXT:    v_mov_b32_e32 v7, s7
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    s_load_b64 s[12:13], s[10:11], 0x20 nv
; GFX1250-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0 nv
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[12:15], s[6:7], 0x8
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s4
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s5
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[6:7], 0x0
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s12
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s13
; GFX6-NOHSA-NEXT:    buffer_store_dword v2, off, s[0:3], 0 offset:40
; GFX6-NOHSA-NEXT:    buffer_store_dwordx2 v[0:1], off, s[0:3], 0 offset:32
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s9
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s10
...
; GFX8-NOHSA-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x20
; GFX8-NOHSA-NEXT:    s_add_u32 s2, s0, 16
; GFX8-NOHSA-NEXT:    s_addc_u32 s3, s1, 0
...
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    s_load_dwordx8 s[4:11], s[2:3], 0x0
; GFX9-HSA-NEXT:    s_load_dwordx4 s[12:15], s[2:3], 0x20
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s9
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s10
...
; GFX9-HSA-NEXT:    global_store_dwordx4 v8, v[4:7], s[0:1]
; GFX9-HSA-NEXT:    global_store_dwordx3 v8, v[0:2], s[0:1] offset:32
; GFX9-HSA-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_load_b96 s[12:14], s[2:3], 0x20
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v0, s8
; GFX12-NEXT:    v_dual_mov_b32 v1, s9 :: v_dual_mov_b32 v2, s10
; GFX12-NEXT:    v_dual_mov_b32 v3, s11 :: v_dual_mov_b32 v4, s4
; GFX12-NEXT:    v_dual_mov_b32 v5, s5 :: v_dual_mov_b32 v6, s6
; GFX12-NEXT:    v_dual_mov_b32 v7, s7 :: v_dual_mov_b32 v8, s12
; GFX12-NEXT:    v_dual_mov_b32 v9, s13 :: v_dual_mov_b32 v10, s14
; GFX12-NEXT:    s_clause 0x2
; GFX12-NEXT:    global_store_b128 v11, v[0:3], s[0:1] offset:16
; GFX12-NEXT:    global_store_b128 v11, v[4:7], s[0:1]
; GFX12-NEXT:    global_store_b96 v11, v[8:10], s[0:1] offset:32
; GFX12-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_load_b96 s[12:14], s[2:3], 0x20 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_mov_b32 v0, s8
...
; GFX1250-NEXT:    v_dual_mov_b32 v7, s7 :: v_dual_mov_b32 v8, s12
; GFX1250-NEXT:    v_dual_mov_b32 v9, s13 :: v_dual_mov_b32 v10, s14
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    global_store_b128 v11, v[0:3], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v11, v[4:7], s[0:1]
; GFX1250-NEXT:    global_store_b96 v11, v[8:10], s[0:1] offset:32
; GFX1250-NEXT:    s_endpgm
entry:
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s2, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[16:19], s[14:15], 0x8
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[4:11], s[14:15], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s0, s12
; GFX6-NOHSA-NEXT:    s_mov_b32 s1, s13
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-HSA-NEXT:    v_mov_b32_e32 v8, s4
; GFX9-HSA-NEXT:    v_mov_b32_e32 v9, s5
; GFX9-HSA-NEXT:    v_mov_b32_e32 v10, s6
; GFX9-HSA-NEXT:    v_mov_b32_e32 v11, s7
...
; GFX9-HSA-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1] offset:32
; GFX9-HSA-NEXT:    global_store_dwordx4 v12, v[4:7], s[0:1] offset:16
; GFX9-HSA-NEXT:    global_store_dwordx4 v12, v[8:11], s[0:1]
; GFX9-HSA-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    s_load_b128 s[12:15], s[10:11], 0x20 nv
; GFX1250-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0 nv
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[0:7], s[14:15], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s8, s12
...
; GFX7-HSA-NEXT:    s_add_u32 s10, s8, 48
...
; GFX9-HSA-NEXT:    global_store_dwordx4 v1, v[0:3], s[0:1] offset:48
; GFX9-HSA-NEXT:    s_nop 0
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s8
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s9
; GFX9-HSA-NEXT:    global_store_dwordx4 v1, v[0:3], s[0:1] offset:32
; GFX9-HSA-NEXT:    s_nop 0
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s7
; GFX9-HSA-NEXT:    global_store_dwordx4 v1, v[0:3], s[0:1] offset:16
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, s11
...
; GFX1250-NEXT:    s_load_b256 s[4:11], s[2:3], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s10
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, s11
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s10, -1
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_ashr_i32 s18, s7, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s19, s6, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s16, s5, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s17, s4, 31
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s6
...
; GFX9-HSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX9-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-HSA-NEXT:    s_ashr_i32 s16, s7, 31
; GFX9-HSA-NEXT:    s_ashr_i32 s17, s6, 31
; GFX9-HSA-NEXT:    s_ashr_i32 s14, s5, 31
; GFX9-HSA-NEXT:    s_ashr_i32 s15, s4, 31
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s17
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s7
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s16
; GFX9-HSA-NEXT:    s_ashr_i32 s12, s3, 31
; GFX9-HSA-NEXT:    s_ashr_i32 s13, s2, 31
; GFX9-HSA-NEXT:    global_store_dwordx4 v4, v[0:3], s[8:9] offset:48
; GFX9-HSA-NEXT:    s_ashr_i32 s10, s1, 31
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s4
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s15
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s5
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s14
; GFX9-HSA-NEXT:    s_ashr_i32 s11, s0, 31
; GFX9-HSA-NEXT:    global_store_dwordx4 v4, v[0:3], s[8:9] offset:32
; GFX9-HSA-NEXT:    s_nop 0
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s13
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s3
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s12
; GFX9-HSA-NEXT:    global_store_dwordx4 v4, v[0:3], s[8:9] offset:16
; GFX9-HSA-NEXT:    s_nop 0
; GFX9-HSA-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-HSA-NEXT:    v_mov_b32_e32 v1, s11
; GFX9-HSA-NEXT:    v_mov_b32_e32 v2, s1
; GFX9-HSA-NEXT:    v_mov_b32_e32 v3, s10
; GFX9-HSA-NEXT:    global_store_dwordx4 v4, v[0:3], s[8:9]
; GFX9-HSA-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_ashr_i32 s16, s7, 31
; GFX12-NEXT:    s_ashr_i32 s17, s6, 31
; GFX12-NEXT:    s_ashr_i32 s14, s5, 31
; GFX12-NEXT:    s_ashr_i32 s15, s4, 31
; GFX12-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s17
; GFX12-NEXT:    s_ashr_i32 s12, s3, 31
; GFX12-NEXT:    s_ashr_i32 s13, s2, 31
; GFX12-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v3, s16
; GFX12-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v5, s15
; GFX12-NEXT:    s_ashr_i32 s10, s1, 31
; GFX12-NEXT:    s_ashr_i32 s11, s0, 31
; GFX12-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v7, s14
; GFX12-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v9, s13
; GFX12-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v11, s12
; GFX12-NEXT:    v_dual_mov_b32 v10, s3 :: v_dual_mov_b32 v13, s11
; GFX12-NEXT:    v_dual_mov_b32 v12, s0 :: v_dual_mov_b32 v15, s10
...
; GFX1250-NEXT:    s_ashr_i32 s16, s7, 31
; GFX1250-NEXT:    s_ashr_i32 s17, s6, 31
; GFX1250-NEXT:    s_ashr_i32 s14, s5, 31
; GFX1250-NEXT:    s_ashr_i32 s15, s4, 31
; GFX1250-NEXT:    s_ashr_i32 s12, s3, 31
; GFX1250-NEXT:    s_ashr_i32 s13, s2, 31
; GFX1250-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v4, s4
; GFX1250-NEXT:    v_dual_mov_b32 v14, s1 :: v_dual_mov_b32 v1, s17
; GFX1250-NEXT:    v_dual_mov_b32 v3, s16 :: v_dual_mov_b32 v5, s15
; GFX1250-NEXT:    s_ashr_i32 s10, s1, 31
; GFX1250-NEXT:    s_ashr_i32 s11, s0, 31
; GFX1250-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v8, s2
; GFX1250-NEXT:    v_dual_mov_b32 v7, s14 :: v_dual_mov_b32 v9, s13
; GFX1250-NEXT:    v_dual_mov_b32 v10, s3 :: v_dual_mov_b32 v12, s0
; GFX1250-NEXT:    v_dual_mov_b32 v11, s12 :: v_dual_mov_b32 v13, s11
; GFX1250-NEXT:    v_mov_b32_e32 v15, s10
; GFX1250-NEXT:    s_clause 0x3
...
; GFX7-HSA-NEXT:    s_ashr_i32 s19, s3, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s24, s2, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s20, s5, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s22, s4, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s23, s7, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s28, s6, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s25, s9, 31
...
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 0x70
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 0x60
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 0x50
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 64
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 48
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s36
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s35
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s15
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 32
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s34
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[4:7]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s33
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s13
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s31
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[2:3], v[7:10]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s27
; GFX7-HSA-NEXT:    s_add_u32 s26, s16, 16
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s29
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[11:12], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s8
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s9
; GFX7-HSA-NEXT:    s_addc_u32 s27, s17, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s28
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[13:14], v[3:6]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s7
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s6
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s23
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s22
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s5
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s20
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s27
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s21
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[15:16], v[6:9]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s19
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[17:18], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s2
...
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[3:6]
; GFX7-HSA-NEXT:    s_endpgm
;
...
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s17, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s34, s16, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s35, s19, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s40, s18, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s41, s21, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s42, s20, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s43, s23, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s44, s22, 31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s28
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s22
; GFX7-HSA-NEXT:    s_ashr_i32 s45, s25, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s46, s24, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s47, s27, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s48, s26, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s49, s29, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s50, s28, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s51, s31, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s30, s30, 31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s29
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s27
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s23
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s20
; GFX7-HSA-NEXT:    v_mov_b32_e32 v13, s21
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s18
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s19
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s16
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s17
; GFX7-HSA-NEXT:    s_ashr_i32 s16, s1, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s17, s0, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s18, s3, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s19, s2, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s20, s5, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s21, s4, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s22, s7, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s23, s6, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s24, s9, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s25, s8, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s26, s11, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s27, s10, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s28, s13, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s29, s12, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s38, s15, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s39, s14, 31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s30
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xf0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s31
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xe0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s51
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[27:28], v[17:20]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xc0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s49
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[14:17]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xb0
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0xa0
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v18, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0x90
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s47
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[27:28], v[7:10]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s46
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0x80
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0x70
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v30, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v31, s31
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0x60
; GFX7-HSA-NEXT:    s_addc_u32 s31, s37, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s45
; GFX7-HSA-NEXT:    v_mov_b32_e32 v33, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v32, s30
; GFX7-HSA-NEXT:    s_add_u32 s30, s36, 0x50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s44
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s41
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[16:17], v[4:7]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[30:31], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s29
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s28
; GFX7-HSA-NEXT:    s_add_u32 s14, s36, 64
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s12
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s13
; GFX7-HSA-NEXT:    v_mov_b32_e32 v35, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v34, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s40
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s35
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[18:19], v[11:14]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[24:27]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s27
; GFX7-HSA-NEXT:    v_mov_b32_e32 v9, s26
; GFX7-HSA-NEXT:    s_addc_u32 s15, s37, 0
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[32:33], v[3:6]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v8, s11
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v12, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s14
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s15
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[34:35], v[6:9]
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s7
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s34
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s5
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s33
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[28:29], v[21:24]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-HSA-NEXT:    s_endpgm
;
