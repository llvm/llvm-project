...
; GFX942-NEXT:    v_lshrrev_b32_e32 v6, v3, v7
; GFX942-NEXT:    v_max_f16_e32 v5, v2, v2
; GFX942-NEXT:    v_max_f16_e32 v6, v6, v6
; GFX942-NEXT:    v_max_f16_e32 v5, v6, v5
...
; GFX942-NEXT:    v_max_f16_e32 v3, v3, v4
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_pk_max_f16 v4, v3, v4
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    global_atomic_cmpswap v3, v[0:1], v[4:5], off sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
...
; GFX942-NEXT:    v_max_f32_e32 v4, v6, v4
; GFX942-NEXT:    v_max_f32_e32 v3, v7, v3
