...
; FLAT-NEXT:    s_andn2_b64 s[4:5], exec, s[0:1]
; FLAT-NEXT:    s_cselect_b64 exec, s[4:5], s[0:1]
...
; SI-NEXT:    s_cselect_b64 exec, s[2:3], s[0:1]
...
; FLAT-NEXT:    s_andn2_b64 s[2:3], exec, s[0:1]
; FLAT-NEXT:    s_cselect_b64 exec, s[2:3], s[0:1]
