...
; SI-LABEL: ds_append_lds_max_offset:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dword s2, s[4:5], 0x9
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0xb
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 m0, s2
; SI-NEXT:    ds_append v0 offset:65532
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
...
; SI-LABEL: ds_append_no_fold_offset_si:
; SI:       ; %bb.0:
...
; SI-LABEL: ds_append_lds_over_max_offset:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dword s2, s[4:5], 0x9
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0xb
; SI-NEXT:    s_mov_b32 s3, 0xf000
...
; SI-LABEL: ds_append_lds_vgpr_addr:
; SI:       ; %bb.0:
...
; SI-LABEL: ds_append_gds_max_offset:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dword s2, s[4:5], 0x9
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0xb
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 m0, s2
; SI-NEXT:    ds_append v0 offset:65532 gds
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-NEXT:    s_endpgm
...
; SI-LABEL: ds_append_gds_over_max_offset:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dword s2, s[4:5], 0x9
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0xb
; SI-NEXT:    s_mov_b32 s3, 0xf000
...
; SI-LABEL: ds_append_lds_m0_restore:
; SI:       ; %bb.0:
