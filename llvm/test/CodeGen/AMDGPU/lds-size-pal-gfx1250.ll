...
; PAL-LABEL: test_lds_i8:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v1, 0
; PAL-NEXT:    ds_store_b8 v1, v0
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
  store i8 %val, ptr addrspace(3) @lds.i8
  ret void
}

define amdgpu_gfx void @test_lds_i16(i16 %val) {
; PAL-LABEL: test_lds_i16:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v1, 0
; PAL-NEXT:    ds_store_b16 v1, v0
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
...
; PAL-LABEL: test_lds_i32:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v1, 0
; PAL-NEXT:    ds_store_b32 v1, v0
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
...
; PAL-LABEL: test_lds_array_i8:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v0, 0
; PAL-NEXT:    ds_load_u8 v1, v0 offset:6
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    ds_store_b8 v0, v1
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
...
; PAL-LABEL: test_lds_array_i16:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v0, 0
; PAL-NEXT:    ds_load_u16 v1, v0 offset:22
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    ds_store_b16 v0, v1
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
...
; PAL-LABEL: test_lds_array_i32:
; PAL:       ; %bb.0:
; PAL-NEXT:    s_wait_loadcnt_dscnt 0x0
; PAL-NEXT:    s_wait_kmcnt 0x0
; PAL-NEXT:    v_mov_b32_e32 v0, 0
; PAL-NEXT:    ds_load_b32 v1, v0 offset:84
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    ds_store_b32 v0, v1
; PAL-NEXT:    s_wait_dscnt 0x0
; PAL-NEXT:    s_set_pc_i64 s[30:31]
