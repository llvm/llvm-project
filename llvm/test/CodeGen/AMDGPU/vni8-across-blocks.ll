...
; GFX942-NEXT:    s_mov_b32 s6, 0xff0000
...
; GFX942-NEXT:    v_and_or_b32 v3, v3, s6, v5
...
; GFX942-NEXT:    v_and_or_b32 v3, v1, s6, v2
; GFX942-NEXT:  .LBB0_2: ; %bb.2
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x34
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_store_byte_d16_hi v0, v3, s[0:1] offset:2
; GFX942-NEXT:    global_store_short v0, v3, s[0:1]
...
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x34
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_store_byte v2, v1, s[0:1] offset:4
...
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x34
; GFX942-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(0)
...
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x34
; GFX942-NEXT:    s_waitcnt vmcnt(7) lgkmcnt(0)
; GFX942-NEXT:    global_store_dwordx4 v0, a[0:3], s[0:1] offset:112
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[58:61], s[0:1] offset:96
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[54:57], s[0:1] offset:80
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[50:53], s[0:1] offset:64
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[46:49], s[0:1] offset:48
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[42:45], s[0:1] offset:32
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[38:41], s[0:1] offset:16
; GFX942-NEXT:    s_waitcnt vmcnt(7)
; GFX942-NEXT:    global_store_dwordx4 v0, v[34:37], s[0:1]
; GFX942-NEXT:    global_store_dwordx4 v0, v[30:33], s[0:1] offset:240
; GFX942-NEXT:    global_store_dwordx4 v0, v[26:29], s[0:1] offset:224
; GFX942-NEXT:    global_store_dwordx4 v0, v[22:25], s[0:1] offset:208
; GFX942-NEXT:    global_store_dwordx4 v0, v[18:21], s[0:1] offset:192
; GFX942-NEXT:    global_store_dwordx4 v0, v[14:17], s[0:1] offset:176
; GFX942-NEXT:    global_store_dwordx4 v0, v[10:13], s[0:1] offset:160
; GFX942-NEXT:    global_store_dwordx4 v0, v[6:9], s[0:1] offset:144
; GFX942-NEXT:    global_store_dwordx4 v0, v[2:5], s[0:1] offset:128
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
...
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[6:7], 14, v0
...
; GFX942-NEXT:    s_andn2_b64 s[2:3], s[6:7], exec
; GFX942-NEXT:    s_and_b64 s[6:7], vcc, exec
; GFX942-NEXT:    s_or_b64 s[6:7], s[2:3], s[6:7]
; GFX942-NEXT:  .LBB8_2: ; %Flow
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x34
; GFX942-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
...
; GFX942-NEXT:  ; %bb.1: ; %bb.1
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v1, s[2:3]
; GFX942-NEXT:    v_cmp_gt_u32_e32 vcc, 7, v0
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_mov_b32_e32 v2, 0
; GFX942-NEXT:    s_andn2_b64 s[2:3], s[6:7], exec
...
; GFX942-NEXT:    v_mov_b32_e32 v0, 0
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_store_dwordx2 v0, v[4:5], s[2:3]
; GFX942-NEXT:    s_endpgm
entry:
  %idx = call i32 @llvm.amdgcn.workitem.id.x()
  %gep1 = getelementptr <8 x i8>, ptr addrspace(1) %src1, i32 %idx
...
; GFX942-NEXT:    v_cmp_lt_u32_e64 s[6:7], 14, v16
...
; GFX942-NEXT:  ; %bb.1: ; %bb.1
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v3, s[2:3]
...
; GFX942-NEXT:  ; %bb.3: ; %bb.2
; GFX942-NEXT:    s_mov_b32 s6, 0xc0c0004
; GFX942-NEXT:    v_perm_b32 v2, v0, v9, s6
; GFX942-NEXT:    v_perm_b32 v3, v8, v7, s6
; GFX942-NEXT:    v_lshl_or_b32 v2, v3, 16, v2
; GFX942-NEXT:    v_perm_b32 v3, v1, v6, s6
; GFX942-NEXT:    v_perm_b32 v11, v5, v4, s6
...
; GFX942-NEXT:    s_mov_b32 s0, 0xc0c0001
; GFX942-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX942-NEXT:    v_perm_b32 v6, 0, v0, s0
; GFX942-NEXT:    s_mov_b32 s1, 0xffff0000
; GFX942-NEXT:    v_perm_b32 v1, 0, v1, s0
; GFX942-NEXT:    v_and_or_b32 v7, v0, s1, v6
...
; GFX942-NEXT:    v_cmp_gt_u32_e32 vcc, 15, v1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[34:35], v0, s[0:1]
; GFX942-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX942-NEXT:    s_cbranch_execz .LBB15_2
; GFX942-NEXT:  ; %bb.1: ; %bb.1
; GFX942-NEXT:    global_load_dwordx2 v[34:35], v0, s[2:3]
; GFX942-NEXT:  .LBB15_2: ; %bb.2
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_load_dwordx4 s[36:39], s[4:5], 0x34
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    s_load_dwordx16 s[16:31], s[38:39], 0x0
; GFX942-NEXT:    s_load_dwordx16 s[0:15], s[38:39], 0x40
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
