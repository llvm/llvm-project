...
; CHECK-NEXT:    v_and_b32_e64 v2, v2, s4
; CHECK-NEXT:    v_cvt_f32_f16_e64 v2, v2
; CHECK-NEXT:    s_mov_b32 s7, 0xf000
; CHECK-NEXT:    s_mov_b32 s6, 0
; CHECK-NEXT:    s_mov_b32 s4, s6
; CHECK-NEXT:    s_mov_b32 s5, s6
; CHECK-NEXT:    v_cvt_f16_f32_e64 v3, s4
; CHECK-NEXT:    buffer_store_short v3, v[0:1], s[4:7], 0 addr64
; CHECK-NEXT:    v_cvt_f16_f32_e64 v2, v2
...
; CHECK-NEXT:    s_mov_b32 s4, s6
; CHECK-NEXT:    s_mov_b32 s5, s6
; CHECK-NEXT:    v_cvt_f16_f32_e64 v1, s4
; CHECK-NEXT:    buffer_store_short v1, v[2:3], s[4:7], 0 addr64
; CHECK-NEXT:    v_cvt_f16_f32_e64 v0, v0
