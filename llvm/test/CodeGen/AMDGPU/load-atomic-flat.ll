...
define amdgpu_cs void @atomic_load_f32x2_seq_cst_agent_align4(ptr addrspace(0) %p, ptr addrspace(0) %out) {
...
; GFX12-NEXT:    flat_store_b32 v[2:3], v0
; GFX12-NEXT:    s_endpgm
  %a0 = load atomic <2 x float>, ptr addrspace(0) %p syncscope("agent") seq_cst, align 4
  %num1 = extractelement <2 x float> %a0, i32 0
  %num2 = extractelement <2 x float> %a0, i32 1
  %res = fadd float %num1, %num2
  store float %res, ptr addrspace(0) %out, align 4
