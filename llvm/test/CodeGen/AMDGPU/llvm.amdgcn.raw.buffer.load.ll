...
;RUN: llc < %s -march=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12,GFX12-SDAG
;RUN: llc < %s -global-isel -march=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12,GFX12-GISEL
...
; GFX12-SDAG-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], null th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], null th:TH_LOAD_HT
...
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4
; GFX12-GISEL-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], s4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], s4 th:TH_LOAD_HT
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_dlc:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x2
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null th:TH_LOAD_NT_RT
; GFX12-SDAG-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], null th:TH_LOAD_RT_NT
; GFX12-SDAG-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], null th:TH_LOAD_NT_HT
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_dlc:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x2
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 th:TH_LOAD_NT_RT
; GFX12-GISEL-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], s4 th:TH_LOAD_RT_NT
; GFX12-GISEL-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], s4 th:TH_LOAD_NT_HT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:40
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:40
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen offset:60
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], s4 offen offset:60
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
  %ofs = add i32 %1, 60
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4092
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:4092
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:8188
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:8188
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:65532
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:65532
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:8388604
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:8388604
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen offset:8388604
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], s4 offen offset:8388604
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_x1:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_x1:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, v0, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_x2:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_x2:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_negative_offset:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    v_add_nc_u32_e32 v0, -16, v0
; GFX12-SDAG-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_negative_offset:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    v_add_nc_u32_e32 v0, -16, v0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_mmo:
; GFX12-SDAG:       ; %bb.0: ; %entry
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v2, 0
; GFX12-SDAG-NEXT:    ds_store_2addr_b32 v0, v2, v2 offset1:4
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-SDAG-NEXT:    s_wait_dscnt 0x0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_mmo:
; GFX12-GISEL:       ; %bb.0: ; %entry
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s4
; GFX12-GISEL-NEXT:    ds_store_2addr_b32 v0, v2, v2 offset1:4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x1_offen_merged_and:
; GFX12-SDAG:       ; %bb.0: ; %main_body
...
;
; GFX12-GISEL-LABEL: buffer_load_x1_offen_merged_and:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, v0, s[0:3], s4 offen offset:4
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, v0, s[0:3], s4 offen offset:8
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, v0, s[0:3], s4 offen offset:12
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, v0, s[0:3], s4 offen offset:16
; GFX12-GISEL-NEXT:    buffer_load_b32 v5, v0, s[0:3], s4 offen offset:28
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, v0, s[0:3], s4 offen offset:32
...
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, v1, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, v2, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, v3, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, v4, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    buffer_load_b32 v5, v5, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, v0, s[0:3], s4 offen
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x2
; GFX12-GISEL-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x1_offen_merged_glc_slc:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x5
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, v0, s[0:3], null offen offset:4
; GFX12-SDAG-NEXT:    buffer_load_b32 v2, v0, s[0:3], null offen offset:8
; GFX12-SDAG-NEXT:    buffer_load_b32 v3, v0, s[0:3], null offen offset:12 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    buffer_load_b32 v4, v0, s[0:3], null offen offset:16 th:TH_LOAD_NT
; GFX12-SDAG-NEXT:    buffer_load_b32 v5, v0, s[0:3], null offen offset:28 th:TH_LOAD_LU
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen offset:32 th:TH_LOAD_LU
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX12-SDAG-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    export mrt0 v5, v0, v0, v0 done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: buffer_load_x1_offen_merged_glc_slc:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, v0, s[0:3], s4 offen offset:4
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, v0, s[0:3], s4 offen offset:8
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, v0, s[0:3], s4 offen offset:12 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, v0, s[0:3], s4 offen offset:16 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    buffer_load_b32 v5, v0, s[0:3], s4 offen offset:28 th:TH_LOAD_LU
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, v0, s[0:3], s4 offen offset:32 th:TH_LOAD_LU
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x2
; GFX12-GISEL-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v5, v0, v0, v0 done
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x2_offen_merged_and:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    buffer_load_b64 v[1:2], v0, s[0:3], null offen offset:4
; GFX12-SDAG-NEXT:    buffer_load_b64 v[3:4], v0, s[0:3], null offen offset:12
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: buffer_load_x2_offen_merged_and:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x1
; GFX12-GISEL-NEXT:    buffer_load_b64 v[1:2], v0, s[0:3], s4 offen offset:4
; GFX12-GISEL-NEXT:    buffer_load_b64 v[3:4], v0, s[0:3], s4 offen offset:12
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x2_offen_merged_or:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    v_lshlrev_b32_e32 v2, 4, v0
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    buffer_load_b64 v[0:1], v2, s[0:3], null offen offset:4
; GFX12-SDAG-NEXT:    buffer_load_b64 v[2:3], v2, s[0:3], null offen offset:12
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: buffer_load_x2_offen_merged_or:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    v_lshlrev_b32_e32 v2, 4, v0
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x1
; GFX12-GISEL-NEXT:    buffer_load_b64 v[0:1], v2, s[0:3], s4 offen offset:4
; GFX12-GISEL-NEXT:    buffer_load_b64 v[2:3], v2, s[0:3], s4 offen offset:12
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
  %a = shl i32 %inp, 4
  %a1 = add i32 %a, 4
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x1_offset_merged:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x5
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, off, s[0:3], null offset:4
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:8
; GFX12-SDAG-NEXT:    buffer_load_b32 v2, off, s[0:3], null offset:12
; GFX12-SDAG-NEXT:    buffer_load_b32 v3, off, s[0:3], null offset:16
; GFX12-SDAG-NEXT:    buffer_load_b32 v4, off, s[0:3], null offset:28
; GFX12-SDAG-NEXT:    buffer_load_b32 v5, off, s[0:3], null offset:32
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX12-SDAG-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: buffer_load_x1_offset_merged:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, off, s[0:3], s4 offset:4
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:8
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, off, s[0:3], s4 offset:12
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, off, s[0:3], s4 offset:16
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, off, s[0:3], s4 offset:28
; GFX12-GISEL-NEXT:    buffer_load_b32 v5, off, s[0:3], s4 offset:32
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x2
; GFX12-GISEL-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v4, v5, v0, v0 done
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: buffer_load_x2_offset_merged:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    buffer_load_b64 v[0:1], off, s[0:3], null offset:4
; GFX12-SDAG-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], null offset:12
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: buffer_load_x2_offset_merged:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x1
; GFX12-GISEL-NEXT:    buffer_load_b64 v[0:1], off, s[0:3], s4 offset:4
; GFX12-GISEL-NEXT:    buffer_load_b64 v[2:3], off, s[0:3], s4 offset:12
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX12-GISEL-NEXT:    s_clause 0x2
; GFX12-GISEL-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4
; GFX12-GISEL-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], s4 th:TH_LOAD_NT
; GFX12-GISEL-NEXT:    buffer_load_b32 v6, off, s[0:3], s4 th:TH_LOAD_HT
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: raw_buffer_load_ubyte:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_u8 v0, off, s[0:3], null
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: raw_buffer_load_ubyte:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_u8 v0, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_u16 v0, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_i8 v0, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
  %tmp = call i8 @llvm.amdgcn.raw.buffer.load.i8(<4 x i32> %rsrc, i32 0, i32 0, i32 0)
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_i16 v0, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX12-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_u16 v1, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_v2f16:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ds_store_b32 v0, v1
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_v2f16:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ds_store_b32 v0, v1
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_v4f16:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], null
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ds_store_b64 v0, v[1:2]
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_v4f16:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    ds_store_b64 v0, v[1:2]
; GFX12-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_v2i16:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ds_store_b32 v0, v1
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_v2i16:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_v4i16:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], null
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    ds_store_b64 v0, v[1:2]
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_v4i16:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    buffer_load_b64 v[1:2], off, s[0:3], s4
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_x1_offset_merged:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x5
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, off, s[0:3], null offset:4
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:8
...
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_x1_offset_merged:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, off, s[0:3], s4 offset:4
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-SDAG-LABEL: raw_buffer_load_x1_offset_swizzled_not_merged:
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_clause 0x5
; GFX12-SDAG-NEXT:    buffer_load_b32 v0, off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:8 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    buffer_load_b32 v2, off, s[0:3], null offset:12 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    buffer_load_b32 v3, off, s[0:3], null offset:16 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    buffer_load_b32 v4, off, s[0:3], null offset:28 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    buffer_load_b32 v5, off, s[0:3], null offset:32 scope:SCOPE_SE
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x2
; GFX12-SDAG-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    export mrt0 v4, v5, v0, v0 done
; GFX12-SDAG-NEXT:    s_endpgm
;
; GFX12-GISEL-LABEL: raw_buffer_load_x1_offset_swizzled_not_merged:
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0
; GFX12-GISEL-NEXT:    s_clause 0x5
; GFX12-GISEL-NEXT:    buffer_load_b32 v0, off, s[0:3], s4 offset:4 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    buffer_load_b32 v1, off, s[0:3], s4 offset:8 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    buffer_load_b32 v2, off, s[0:3], s4 offset:12 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    buffer_load_b32 v3, off, s[0:3], s4 offset:16 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    buffer_load_b32 v4, off, s[0:3], s4 offset:28 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    buffer_load_b32 v5, off, s[0:3], s4 offset:32 scope:SCOPE_SE
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x2
; GFX12-GISEL-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    export mrt0 v4, v5, v0, v0 done
