...
;RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12PLUS,GFX12,GFX12-SDAG
;RUN: llc < %s -global-isel -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12PLUS,GFX12,GFX12-GISEL
;RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12PLUS,GFX13,GFX13-SDAG
;RUN: llc < %s -global-isel -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 | FileCheck %s --check-prefixes=GFX12PLUS,GFX13,GFX13-GISEL
