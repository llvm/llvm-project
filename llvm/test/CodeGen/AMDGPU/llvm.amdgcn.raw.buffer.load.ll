...
;RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12PLUS,GFX12,GFX12-SDAG
;RUN: llc < %s -global-isel -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12PLUS,GFX12,GFX12-GISEL
;RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12PLUS,GFX13,GFX13-SDAG
;RUN: llc < %s -global-isel -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefixes=GFX12PLUS,GFX13,GFX13-GISEL
...
;
; GFX12PLUS-LABEL: buffer_load:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x2
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null
; GFX12PLUS-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], null th:TH_LOAD_NT
; GFX12PLUS-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], null th:TH_LOAD_HT
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_dlc:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x2
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null th:TH_LOAD_NT_RT
; GFX12PLUS-NEXT:    buffer_load_b128 v[4:7], off, s[0:3], null th:TH_LOAD_RT_NT
; GFX12PLUS-NEXT:    buffer_load_b128 v[8:11], off, s[0:3], null th:TH_LOAD_NT_HT
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_immoffs:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:40
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_immoffs_large:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_movk_i32 s4, 0x1ffc
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], s4 offset:4
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_ofs:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX13-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_voffset_large_12bit:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4092
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_voffset_large_13bit:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:8188
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_voffset_large_16bit:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:65532
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_voffset_large_23bit:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:8388604
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_voffset_large_24bit:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_mov_b32_e32 v0, 0x800000
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen offset:8388604
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_x1:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_x2:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b64 v[0:1], v0, s[0:3], null offen
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_negative_offset:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    v_add_nc_u32_e32 v0, -16, v0
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_mmo:
; GFX12PLUS:       ; %bb.0: ; %entry
; GFX12PLUS-NEXT:    buffer_load_b32 v1, off, s[0:3], null
...
; GFX13-NEXT:    buffer_load_b32 v2, v2, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b32 v3, v3, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b32 v4, v4, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b32 v5, v5, s[0:3], null offen
...
; GFX13-SDAG-NEXT:    buffer_load_b128 v[0:3], v4, s[0:3], null offen offset:4
; GFX13-SDAG-NEXT:    buffer_load_b64 v[4:5], v4, s[0:3], null offen offset:28
...
; GFX13-GISEL-NEXT:    buffer_load_b32 v1, v1, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b32 v2, v2, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b32 v3, v3, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b32 v4, v4, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b32 v5, v5, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen
...
; GFX13-NEXT:    buffer_load_b32 v1, v1, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b32 v2, v2, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b32 v3, v3, s[0:3], null offen th:TH_LOAD_NT
; GFX13-NEXT:    buffer_load_b32 v4, v4, s[0:3], null offen th:TH_LOAD_NT
; GFX13-NEXT:    buffer_load_b32 v5, v5, s[0:3], null offen th:TH_LOAD_LU
; GFX13-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen th:TH_LOAD_LU
; GFX13-NEXT:    s_wait_loadcnt 0x2
; GFX13-NEXT:    export mrt0 v1, v2, v3, v4 done
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    export mrt0 v5, v0, v0, v0 done
...
; GFX13-NEXT:    buffer_load_b64 v[0:1], v1, s[0:3], null offen
; GFX13-NEXT:    buffer_load_b64 v[2:3], v2, s[0:3], null offen
; GFX13-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-SDAG-NEXT:    buffer_load_b128 v[0:3], v0, s[0:3], null offen offset:4
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX13-SDAG-NEXT:    s_endpgm
;
...
; GFX13-GISEL-NEXT:    buffer_load_b64 v[0:1], v1, s[0:3], null offen
; GFX13-GISEL-NEXT:    buffer_load_b64 v[2:3], v2, s[0:3], null offen
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: buffer_load_x1_offset_merged:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x1
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4
; GFX12PLUS-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], null offset:28
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x1
; GFX12PLUS-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    export mrt0 v4, v5, v0, v0 done
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: buffer_load_x2_offset_merged:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    export mrt0 v0, v1, v2, v3 done
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: buffer_load_int:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x2
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null
; GFX12PLUS-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], null th:TH_LOAD_NT
; GFX12PLUS-NEXT:    buffer_load_b32 v6, off, s[0:3], null th:TH_LOAD_HT
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: raw_buffer_load_ubyte:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_u8 v0, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: raw_buffer_load_i16:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_u16 v0, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: raw_buffer_load_sbyte:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_i8 v0, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
  %tmp = call i8 @llvm.amdgcn.raw.buffer.load.i8(<4 x i32> %rsrc, i32 0, i32 0, i32 0)
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12PLUS-LABEL: raw_buffer_load_sshort:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_i16 v0, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    v_cvt_f32_i32_e32 v0, v0
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_f16:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_u16 v1, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ds_store_b16 v0, v1
; GFX12PLUS-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_v2f16:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ds_store_b32 v0, v1
; GFX12PLUS-NEXT:    s_endpgm
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_v2i16:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    buffer_load_b32 v1, off, s[0:3], null
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    ds_store_b32 v0, v1
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_x1_offset_merged:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x1
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4
; GFX12PLUS-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], null offset:28
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_x1_offset_swizzled_not_merged_pregfx12:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x1
; GFX12PLUS-NEXT:    buffer_load_b128 v[0:3], off, s[0:3], null offset:4 scope:SCOPE_SE
; GFX12PLUS-NEXT:    buffer_load_b64 v[4:5], off, s[0:3], null offset:28 scope:SCOPE_SE
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x1
; GFX12PLUS-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    export mrt0 v4, v5, v0, v0 done
...
; GFX11-NEXT:    s_endpgm
;
; GFX12PLUS-LABEL: raw_buffer_load_x1_offset_swizzled_not_merged:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_clause 0x5
; GFX12PLUS-NEXT:    buffer_load_b32 v0, off, s[0:3], null offset:4
; GFX12PLUS-NEXT:    buffer_load_b32 v1, off, s[0:3], null offset:8
; GFX12PLUS-NEXT:    buffer_load_b32 v2, off, s[0:3], null offset:12
; GFX12PLUS-NEXT:    buffer_load_b32 v3, off, s[0:3], null offset:16
; GFX12PLUS-NEXT:    buffer_load_b32 v4, off, s[0:3], null offset:28
; GFX12PLUS-NEXT:    buffer_load_b32 v5, off, s[0:3], null offset:32
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x2
; GFX12PLUS-NEXT:    export mrt0 v0, v1, v2, v3 done
; GFX12PLUS-NEXT:    s_wait_loadcnt 0x0
; GFX12PLUS-NEXT:    export mrt0 v4, v5, v0, v0 done
; GFX12PLUS-NEXT:    s_endpgm
