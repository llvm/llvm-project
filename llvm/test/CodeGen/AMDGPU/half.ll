...
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_cvt_f32_f16_e32 v15, v6
; CI-NEXT:    v_lshrrev_b32_e32 v0, 16, v7
; CI-NEXT:    v_lshrrev_b32_e32 v6, 16, v6
; CI-NEXT:    v_cvt_f32_f16_e32 v17, v7
; CI-NEXT:    v_cvt_f32_f16_e32 v18, v0
...
; CI-NEXT:    v_cvt_f32_f16_e32 v6, v1
; CI-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; CI-NEXT:    v_cvt_f32_f16_e32 v18, v2
...
; CI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v12
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v6
; CI-NEXT:    flat_store_dwordx4 v[8:9], v[2:5]
; CI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v18
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v0
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v19
; CI-NEXT:    v_mov_b32_e32 v5, s1
; CI-NEXT:    v_mov_b32_e32 v4, s0
; CI-NEXT:    flat_store_dwordx4 v[16:17], v[10:13]
; CI-NEXT:    flat_store_dwordx4 v[4:5], v[6:9]
...
; VI-NEXT:    v_cvt_f32_f16_sdwa v18, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v1
; VI-NEXT:    v_cvt_f32_f16_sdwa v19, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v4
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v5
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v7
; VI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v10
; VI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v12
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v6
; VI-NEXT:    flat_store_dwordx4 v[8:9], v[2:5]
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v19
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v18
; VI-NEXT:    v_mov_b32_e32 v5, s1
; VI-NEXT:    v_mov_b32_e32 v4, s0
; VI-NEXT:    flat_store_dwordx4 v[16:17], v[10:13]
; VI-NEXT:    flat_store_dwordx4 v[4:5], v[6:9]
...
; CI-NEXT:    v_mov_b32_e32 v15, s3
; CI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v1
; CI-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; CI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v2
; CI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; CI-NEXT:    v_cvt_f32_f16_e32 v2, v1
; CI-NEXT:    s_waitcnt vmcnt(2)
; CI-NEXT:    v_lshrrev_b32_e32 v1, 16, v7
; CI-NEXT:    flat_store_dwordx4 v[18:19], v[8:11]
...
; CI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v9
; CI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v8
; CI-NEXT:    s_add_u32 s0, s0, 64
; CI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v18
; CI-NEXT:    s_addc_u32 s1, s1, 0
; CI-NEXT:    flat_store_dwordx4 v[14:15], v[2:5]
; CI-NEXT:    v_mov_b32_e32 v17, s3
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v19
; CI-NEXT:    v_mov_b32_e32 v5, s1
; CI-NEXT:    v_mov_b32_e32 v16, s2
...
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_cvt_f32_f16_e32 v13, v1
...
; VI-NEXT:    v_cvt_f32_f16_e32 v9, v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v4, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[5:6], v6
; VI-NEXT:    v_cvt_f64_f32_e32 v[7:8], v7
...
; VI-NEXT:    flat_store_dwordx4 v[17:18], v[5:8]
...
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v9, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v6
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v7
; VI-NEXT:    flat_store_dwordx4 v[11:12], v[2:5]
; VI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v10
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v13
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v17
; VI-NEXT:    v_cvt_f64_f32_e32 v[12:13], v9
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v8
; VI-NEXT:    flat_store_dwordx4 v[19:20], v[2:5]
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v16
; VI-NEXT:    v_mov_b32_e32 v5, s1
; VI-NEXT:    v_mov_b32_e32 v4, s0
; VI-NEXT:    flat_store_dwordx4 v[21:22], v[10:13]
; VI-NEXT:    flat_store_dwordx4 v[14:15], v[6:9]
; VI-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; VI-NEXT:    s_endpgm
;
