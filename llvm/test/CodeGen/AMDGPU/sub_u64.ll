...
;
; GFX1210-LABEL: test_sub_u64_vv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_sub_nc_u64_e32 v[0:1], v[0:1], v[2:3]
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_sub_u64_inline_lit_v:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_sub_nc_u64_e32 v[0:1], 5, v[0:1]
; GFX1210-NEXT:    ; return to shader part epilog
  %sub = sub i64 5, %a
  %ret = bitcast i64 %sub to <2 x float>
  ret <2 x float> %ret
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_sub_u64_v_inline_lit:
; GFX1210:       ; %bb.0:
