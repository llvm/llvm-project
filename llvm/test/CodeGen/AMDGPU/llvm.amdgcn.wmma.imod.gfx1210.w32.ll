...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x4.f64.v8f64.v2f64(i1 1, <2 x double> %A, i1 0, <2 x double> %B, i16 0, <8 x double> %C)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x4.f64.v8f64.v2f64(i1 0, <2 x double> %A, i1 1, <2 x double> %B, i16 0, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x4.f64.v8f64.v2f64(i1 0, <2 x double> %A, i1 0, <2 x double> %B, i16 1, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x4.f64.v8f64.v2f64(i1 0, <2 x double> %A, i1 0, <2 x double> %B, i16 3, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x4.f64.v8f64.v2f64(i1 0, <2 x double> %A, i1 0, <2 x double> %B, i16 4, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x8.f64.v8f64.v4f64(i1 1, <4 x double> %A, i1 0, <4 x double> %B, i16 0, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x8.f64.v8f64.v4f64(i1 0, <4 x double> %A, i1 1, <4 x double> %B, i16 0, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x8.f64.v8f64.v4f64(i1 0, <4 x double> %A, i1 0, <4 x double> %B, i16 1, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x8.f64.v8f64.v4f64(i1 0, <4 x double> %A, i1 0, <4 x double> %B, i16 3, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x double> @llvm.amdgcn.wmma.f64.16x16x8.f64.v8f64.v4f64(i1 0, <4 x double> %A, i1 0, <4 x double> %B, i16 4, <8 x double> %C)
  store <8 x double> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x4.f32.v8f32.v2f32(i1 1, <2 x float> %A, i1 0, <2 x float> %B, i16 0, <8 x float> %C)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x4.f32.v8f32.v2f32(i1 0, <2 x float> %A, i1 1, <2 x float> %B, i16 0, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x4.f32.v8f32.v2f32(i1 0, <2 x float> %A, i1 0, <2 x float> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x4.f32.v8f32.v2f32(i1 0, <2 x float> %A, i1 0, <2 x float> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x4.f32.v8f32.v2f32(i1 0, <2 x float> %A, i1 0, <2 x float> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 1, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 0, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 0, <16 x bfloat> %A, i1 1, <16 x bfloat> %B, i16 0, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.bf16.v8f32.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 1, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 1, <16 x half> %B, i16 0, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x32.f16.v8f32.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 1, <16 x half> %A, i1 0, <16 x half> %B, i16 0, <8 x half> %C)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 1, <16 x half> %B, i16 0, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 1, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 3, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x32.f16.v8f16.v16f16(i1 0, <16 x half> %A, i1 0, <16 x half> %B, i16 4, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x32.bf16.v8bf16.v16bf16(i1 1, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 0, <8 x bfloat> %C)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 1, <16 x bfloat> %B, i16 0, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 1, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 3, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 4, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16f32.16x16x32.bf16.v8bf16.v16bf16(i1 1, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 0, <8 x float> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16f32.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 1, <16 x bfloat> %B, i16 0, <8 x float> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16f32.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 1, <8 x float> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16f32.16x16x32.bf16.v8bf16.v16bf16(i1 0, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 3, <8 x float> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16f32.16x16x32.bf16.v8bf16.v16bf16(i1 1, <16 x bfloat> %A, i1 0, <16 x bfloat> %B, i16 4, <8 x float> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.fp8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.fp8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x64.bf8.bf8.v8f32.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.fp8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.fp8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 1, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 3, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.wmma.f16.16x16x64.bf8.bf8.v8f16.v8i32(<8 x i32> %A, <8 x i32> %B, i16 4, <8 x half> %C)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.wmma.i32.16x16x64.iu8.v8i32.v8i32(i1 1, <8 x i32> %A, i1 0, <8 x i32> %B, <8 x i32> %C)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.wmma.i32.16x16x64.iu8.v8i32.v8i32(i1 0, <8 x i32> %A, i1 1, <8 x i32> %B, <8 x i32> %C)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.wmma.i32.16x16x128.iu4.v8i32.v8i32(i1 1, <8 x i32> %A, i1 0, <8 x i32> %B, <8 x i32> %C)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.wmma.i32.16x16x128.iu4.v8i32.v8i32(i1 0, <8 x i32> %A, i1 1, <8 x i32> %B, <8 x i32> %C)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f32_16x16x128_f8f6f4_negC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_f32_16x16x128_f8f6f4_negC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39] neg_lo:[0,0,1]
; GFX1210-NEXT:    s_clause 0x1
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 1, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f32_16x16x128_f8f6f4_neg_absC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_f32_16x16x128_f8f6f4_neg_absC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39] neg_lo:[0,0,1] neg_hi:[0,0,1]
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 3, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_f32_16x16x128_f8f6f4_ignoreC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_f32_16x16x128_f8f6f4_ignoreC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39]
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 4, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_bf16_16x16x128_f8f6f4_negC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_bf16_16x16x128_f8f6f4_negC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] neg_lo:[0,0,1]
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_bf16_16x16x128_f8f6f4_negC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GISEL-NEXT:    v_dual_lshlrev_b32 v38, 16, v38 :: v_dual_lshlrev_b32 v39, 16, v39
; GISEL-NEXT:    v_and_b32_e32 v33, 0xffff, v33
; GISEL-NEXT:    v_dual_lshlrev_b32 v40, 16, v40 :: v_dual_lshlrev_b32 v41, 16, v41
; GISEL-NEXT:    v_and_b32_e32 v34, 0xffff, v34
; GISEL-NEXT:    v_and_b32_e32 v35, 0xffff, v35
; GISEL-NEXT:    v_or_b32_e32 v32, v38, v32
; GISEL-NEXT:    v_or_b32_e32 v33, v39, v33
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GISEL-NEXT:    v_or_b32_e32 v34, v40, v34
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] neg_lo:[0,0,1]
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 1, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_bf16_16x16x128_f8f6f4_neg_absC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_bf16_16x16x128_f8f6f4_neg_absC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] neg_lo:[0,0,1] neg_hi:[0,0,1]
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_bf16_16x16x128_f8f6f4_neg_absC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] neg_lo:[0,0,1] neg_hi:[0,0,1]
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 3, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_bf16_16x16x128_f8f6f4_ignoreC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_bf16_16x16x128_f8f6f4_ignoreC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35]
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_bf16_16x16x128_f8f6f4_ignoreC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35]
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 4, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_f32_16x16x128_f8f6f4_negC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_f32_16x16x128_f8f6f4_negC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1]
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1]
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GISEL-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 1, <8 x float> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_f32_16x16x128_f8f6f4_neg_absC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_f32_16x16x128_f8f6f4_neg_absC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1] neg_hi:[0,0,1]
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1] neg_hi:[0,0,1]
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GISEL-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 3, <8 x float> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_f32_16x16x128_f8f6f4_ignoreC(<16 x i32> %A, <16 x i32> %B, <8 x float> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_f32_16x16x128_f8f6f4_ignoreC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GISEL-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 4, <8 x float> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4_negC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_negC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1]
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_negC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1]
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 1, <8 x bfloat> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4_neg_absC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_neg_absC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1] neg_hi:[0,0,1]
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_neg_absC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 neg_lo:[0,0,1] neg_hi:[0,0,1]
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 3, <8 x bfloat> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4_ignoreC(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ignoreC:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ignoreC:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], 2, 4 matrix_a_scale:MATRIX_SCALE_ROW1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8f32.v16i32(i32 0, <16 x i32> %A, i32 0, <16 x i32> %B, i16 4, <8 x bfloat> %C, i32 1, i32 2, i32 3, i32 4)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.f32.16x16x64.f16.v8f32.v16f16.v32f16.i16(i1 1, <16 x half> %A, i1 0, <32 x half> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.f32.16x16x64.f16.v8f32.v16f16.v32f16.i16(i1 0, <16 x half> %A, i1 1, <32 x half> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    v_swmmac_f32_16x16x64_bf16 v[24:31], v[34:41], v[0:15], v32 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GISEL-NEXT:    s_clause 0x1
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.i16(i1 1, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GISEL-NEXT:    v_or_b32_e32 v15, v21, v22
; GISEL-NEXT:    v_swmmac_f32_16x16x64_bf16 v[24:31], v[34:41], v[0:15], v32 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[42:43], v[24:27], off
; GISEL-NEXT:    global_store_b128 v[42:43], v[28:31], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.i16(i1 0, <16 x bfloat> %A, i1 1, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.swmmac.f16.16x16x64.f16.v8f16.v16f16.v32f16.i16(i1 1, <16 x half> %A, i1 0, <32 x half> %B, <8 x half> %C, i16 %Index)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x half> @llvm.amdgcn.swmmac.f16.16x16x64.f16.v8f16.v16f16.v32f16.i16(i1 0, <16 x half> %A, i1 1, <32 x half> %B, <8 x half> %C, i16 %Index)
  store <8 x half> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    v_swmmac_bf16_16x16x64_bf16 v[16:19], v[30:37], v[0:15], v28 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GISEL-NEXT:    global_store_b128 v[38:39], v[16:19], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.swmmac.bf16.16x16x64.bf16.v8bf16.v16bf16.v32bf16.i16(i1 1, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x bfloat> %C, i16 %Index)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GISEL-NEXT:    v_or_b32_e32 v19, v20, v24
; GISEL-NEXT:    v_swmmac_bf16_16x16x64_bf16 v[16:19], v[30:37], v[0:15], v28 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GISEL-NEXT:    global_store_b128 v[38:39], v[16:19], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.swmmac.bf16.16x16x64.bf16.v8bf16.v16bf16.v32bf16.i16(i1 0, <16 x bfloat> %A, i1 1, <32 x bfloat> %B, <8 x bfloat> %C, i16 %Index)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GISEL-NEXT:    v_or_b32_e32 v15, v21, v22
; GISEL-NEXT:    v_swmmac_bf16f32_16x16x64_bf16 v[24:31], v[34:41], v[0:15], v32 neg_lo:[1,0,0] neg_hi:[1,0,0]
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[42:43], v[24:27], off
; GISEL-NEXT:    global_store_b128 v[42:43], v[28:31], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.bf16f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.i16(i1 1, <16 x bfloat> %A, i1 0, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GISEL-NEXT:    v_or_b32_e32 v15, v21, v22
; GISEL-NEXT:    v_swmmac_bf16f32_16x16x64_bf16 v[24:31], v[34:41], v[0:15], v32 neg_lo:[0,1,0] neg_hi:[0,1,0]
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[42:43], v[24:27], off
; GISEL-NEXT:    global_store_b128 v[42:43], v[28:31], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.swmmac.bf16f32.16x16x64.bf16.v8f32.v16bf16.v32bf16.i16(i1 0, <16 x bfloat> %A, i1 1, <32 x bfloat> %B, <8 x float> %C, i16 %Index)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.swmmac.i32.16x16x128.iu8.v8i32.v8i32.v16i32.i16(i1 1, <8 x i32> %A, i1 0, <16 x i32> %B, <8 x i32> %C, i16 %Index)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.swmmac.i32.16x16x128.iu8.v8i32.v8i32.v16i32.i16(i1 0, <8 x i32> %A, i1 1, <16 x i32> %B, <8 x i32> %C, i16 %Index)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.swmmac.i32.16x16x256.iu4.v8i32.v8i32.v16i32.i16(i1 1, <8 x i32> %A, i1 0, <16 x i32> %B, <8 x i32> %C, i16 %Index)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x i32> @llvm.amdgcn.swmmac.i32.16x16x256.iu4.v8i32.v8i32.v16i32.i16(i1 0, <8 x i32> %A, i1 1, <16 x i32> %B, <8 x i32> %C, i16 %Index)
  store <8 x i32> %res, ptr addrspace(1) %out
  ret void
}
...
declare <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.xf32.v8f32.v8f32(<8 x float>, <8 x float>, <8 x float>)
...
declare <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32, <16 x i32>, i32, <16 x i32>, i16, <8 x float>, i32, i32, i32, i32)
declare <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32, <16 x i32>, i32, <16 x i32>, i16, <8 x bfloat>, i32, i32, i32, i32)
