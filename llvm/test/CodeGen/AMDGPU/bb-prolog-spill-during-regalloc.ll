...
define i32 @prolog_spill(i32 %arg0, i32 %arg1, i32 %arg2) {
  ...
  ; REGALLOC-NEXT:   renamable $sgpr4_5 = V_CMP_GE_I32_e64 killed $vgpr0, killed $sgpr4, implicit $exec
  ; REGALLOC-NEXT:   renamable $vgpr0 = IMPLICIT_DEF
  ; REGALLOC-NEXT:   renamable $sgpr6_7 = COPY $exec, implicit-def $exec
  ; REGALLOC-NEXT:   renamable $sgpr4_5 = S_AND_B64 renamable $sgpr6_7, killed renamable $sgpr4_5, implicit-def dead $scc
  ; REGALLOC-NEXT:   renamable $sgpr6_7 = S_XOR_B64 renamable $sgpr4_5, killed renamable $sgpr6_7, implicit-def dead $scc
  ; REGALLOC-NEXT:   $vgpr63 = IMPLICIT_DEF
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR killed $sgpr6, 0, $vgpr63, implicit-def $sgpr6_7, implicit $sgpr6_7
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR killed $sgpr7, 1, $vgpr63, implicit killed $sgpr6_7
  ; REGALLOC-NEXT:   SI_SPILL_WWM_V32_SAVE killed $vgpr63, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
  ; REGALLOC-NEXT:   $exec = S_MOV_B64_term killed renamable $sgpr4_5
  ...
  ; REGALLOC-NEXT:   $sgpr4 = SI_RESTORE_S32_FROM_VGPR $vgpr63, 0, implicit-def $sgpr4_5
  ; REGALLOC-NEXT:   $sgpr5 = SI_RESTORE_S32_FROM_VGPR $vgpr63, 1
  ; REGALLOC-NEXT:   renamable $sgpr4_5 = S_OR_SAVEEXEC_B64 killed renamable $sgpr4_5, implicit-def $exec, implicit-def dead $scc, implicit $exec
  ...
  ; REGALLOC-NEXT:   renamable $sgpr4_5 = S_AND_B64 $exec, killed renamable $sgpr4_5, implicit-def dead $scc
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR killed $sgpr4, 2, $vgpr63, implicit-def $sgpr4_5, implicit $sgpr4_5
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR $sgpr5, 3, $vgpr63, implicit $sgpr4_5
  ; REGALLOC-NEXT:   SI_SPILL_WWM_V32_SAVE killed $vgpr63, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
  ; REGALLOC-NEXT:   $exec = S_XOR_B64_term $exec, killed renamable $sgpr4_5, implicit-def dead $scc
  ...
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_WWM_V32_RESTORE %stack.2, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.2, addrspace 5)
  ; REGALLOC-NEXT:   $sgpr4 = SI_RESTORE_S32_FROM_VGPR $vgpr63, 2, implicit-def $sgpr4_5
  ; REGALLOC-NEXT:   $sgpr5 = SI_RESTORE_S32_FROM_VGPR killed $vgpr63, 3
  ; REGALLOC-NEXT:   $exec = S_OR_B64 $exec, killed renamable $sgpr4_5, implicit-def dead $scc
