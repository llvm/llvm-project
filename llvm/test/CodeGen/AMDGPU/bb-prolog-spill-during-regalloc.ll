...
define i32 @prolog_spill(i32 %arg0, i32 %arg1, i32 %arg2) {
  ...
  ; REGALLOC-NEXT: {{  $}}
  ; REGALLOC-NEXT:   $vgpr63 = bb-prolog SI_SPILL_WWM_V32_RESTORE %stack.2, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.2, addrspace 5)
  ; REGALLOC-NEXT:   $sgpr4 = bb-prolog SI_RESTORE_S32_FROM_VGPR $vgpr63, 0, implicit-def $sgpr4_sgpr5
  ; REGALLOC-NEXT:   $sgpr5 = bb-prolog SI_RESTORE_S32_FROM_VGPR $vgpr63, 1
  ; REGALLOC-NEXT:   renamable $sgpr4_sgpr5 = bb-prolog S_OR_SAVEEXEC_B64 killed renamable $sgpr4_sgpr5, implicit-def $exec, implicit-def dead $scc, implicit $exec
  ...
  ; REGALLOC-NEXT:   $vgpr63 = bb-prolog SI_SPILL_WWM_V32_RESTORE %stack.2, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.2, addrspace 5)
  ; REGALLOC-NEXT:   $sgpr4 = bb-prolog SI_RESTORE_S32_FROM_VGPR $vgpr63, 2, implicit-def $sgpr4_sgpr5
  ; REGALLOC-NEXT:   $sgpr5 = bb-prolog SI_RESTORE_S32_FROM_VGPR killed $vgpr63, 3
  ; REGALLOC-NEXT:   $exec = bb-prolog S_OR_B64 $exec, killed renamable $sgpr4_sgpr5, implicit-def dead $scc
