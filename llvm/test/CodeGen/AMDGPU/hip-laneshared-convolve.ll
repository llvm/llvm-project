...
define dso_local amdgpu_kernel void @_Z36test_amdgcn_convolve_f16_fp8_3x3_4x4v() local_unnamed_addr {
  ...
  ; CHECK-NEXT:   [[V_CONVOLVE_F16_FP8_3x3_4x4_:%[0-9]+]]:vreg_128_align2 = contract V_CONVOLVE_F16_FP8_3x3_4x4 killed [[REG_SEQUENCE1]], killed [[COPY12]], killed [[SCRATCH_LOAD_DWORDX3_SADDR]], killed [[SCRATCH_LOAD_DWORDX3_SADDR1]], killed [[SCRATCH_LOAD_DWORDX3_SADDR2]], 42, -1, implicit $exec
  ...
  ; VIDX-NEXT:   [[V_CONVOLVE_F16_FP8_3x3_4x4_:%[0-9]+]]:vreg_128_align2 = contract V_CONVOLVE_F16_FP8_3x3_4x4 killed [[REG_SEQUENCE]], killed [[V_LOAD_IDX3]], killed [[V_LOAD_IDX]], killed [[V_LOAD_IDX1]], killed [[V_LOAD_IDX2]], 42, -1, implicit $exec
