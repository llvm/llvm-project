...
; GFX1064_DPP-NEXT:    v_writelane_b32 v8, s4, 16
; GFX1064_DPP-NEXT:    v_writelane_b32 v7, s5, 16
...
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v3, 0, 0, s4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v4, 0
...
; GFX1164_DPP-NEXT:    v_writelane_b32 v5, s4, 16
; GFX1164_DPP-NEXT:    v_readlane_b32 s4, v2, 63
; GFX1164_DPP-NEXT:    v_writelane_b32 v6, s5, 16
...
; GFX1164_DPP-NEXT:    s_load_b64 s[4:5], s[2:3], 0x24
; GFX1164_DPP-NEXT:    v_readfirstlane_b32 s0, v7
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v9, v5
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v10, v6
; GFX1164_DPP-NEXT:    v_readfirstlane_b32 s1, v8
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164_DPP-NEXT:    v_add_co_u32 v7, vcc, s0, v9
; GFX1164_DPP-NEXT:    v_add_co_ci_u32_e32 v8, vcc, s1, v10, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1164_DPP-NEXT:    v_sub_co_u32 v7, vcc, s0, v9
; GFX1164_DPP-NEXT:    v_sub_co_ci_u32_e32 v8, vcc, s1, v10, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
; GFX1164_DPP-NEXT:    s_endpgm
;
...
; GFX8_DPP-NEXT:    v_readlane_b32 s5, v3, 63
...
; GFX9_DPP-NEXT:    v_readlane_b32 s5, v3, 63
...
; GFX1064_DPP-NEXT:    v_bfrev_b32_e32 v4, 1
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064_DPP-NEXT:    v_readlane_b32 s4, v2, 31
; GFX1064_DPP-NEXT:    v_readlane_b32 s5, v1, 31
...
; GFX1064_DPP-NEXT:    v_readlane_b32 s6, v2, 31
; GFX1064_DPP-NEXT:    v_readlane_b32 s7, v1, 31
; GFX1064_DPP-NEXT:    v_writelane_b32 v5, s4, 16
; GFX1064_DPP-NEXT:    v_readlane_b32 s4, v1, 63
; GFX1064_DPP-NEXT:    v_writelane_b32 v4, s5, 16
; GFX1064_DPP-NEXT:    v_readlane_b32 s5, v2, 63
...
; GFX1064_DPP-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX1064_DPP-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x24
; GFX1064_DPP-NEXT:    v_readfirstlane_b32 s1, v8
; GFX1064_DPP-NEXT:    v_readfirstlane_b32 s0, v7
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v7, v4
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1064_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064_DPP-NEXT:    v_cmp_gt_i64_e32 vcc, s[0:1], v[7:8]
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1032_DPP:       ; %bb.0: ; %entry
; GFX1032_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v2, 0x80000000, 0, s4
; GFX1032_DPP-NEXT:    v_bfrev_b32_e32 v4, 1
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s4
...
; GFX1032_DPP-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX1032_DPP-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x24
; GFX1032_DPP-NEXT:    v_readfirstlane_b32 s1, v8
; GFX1032_DPP-NEXT:    v_readfirstlane_b32 s0, v7
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v7, v4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1032_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032_DPP-NEXT:    v_cmp_gt_i64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1032_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v6, s5
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX1164_DPP-NEXT:    v_writelane_b32 v5, s4, 16
; GFX1164_DPP-NEXT:    v_readlane_b32 s4, v1, 63
; GFX1164_DPP-NEXT:    v_writelane_b32 v4, s5, 16
...
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164_DPP-NEXT:    v_cmp_gt_i64_e32 vcc, s[0:1], v[7:8]
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
; GFX1164_DPP-NEXT:    s_endpgm
;
...
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1132_DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v2, 0x80000000, 0, s4
; GFX1132_DPP-NEXT:    v_bfrev_b32_e32 v4, 1
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s4
...
; GFX1132_DPP-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX1132_DPP-NEXT:    s_load_b64 s[4:5], s[2:3], 0x24
; GFX1132_DPP-NEXT:    v_readfirstlane_b32 s1, v8
; GFX1132_DPP-NEXT:    v_readfirstlane_b32 s0, v7
; GFX1132_DPP-NEXT:    v_mov_b32_e32 v7, v4
; GFX1132_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132_DPP-NEXT:    v_cmp_gt_i64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1064_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064_DPP-NEXT:    v_cmp_lt_i64_e32 vcc, s[0:1], v[7:8]
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1032_DPP:       ; %bb.0: ; %entry
; GFX1032_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v2, 0x7fffffff, 0, s4
; GFX1032_DPP-NEXT:    v_bfrev_b32_e32 v4, -2
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v3, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v1, -1, v0, s4
...
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1032_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032_DPP-NEXT:    v_cmp_lt_i64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1032_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164_DPP-NEXT:    v_cmp_lt_i64_e32 vcc, s[0:1], v[7:8]
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
...
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1132_DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v2, 0x7fffffff, 0, s4
; GFX1132_DPP-NEXT:    v_bfrev_b32_e32 v4, -2
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v1, -1, v0, s4
...
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132_DPP-NEXT:    v_cmp_lt_i64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1064_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064_DPP-NEXT:    v_cmp_gt_u64_e32 vcc, s[0:1], v[7:8]
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1032_DPP:       ; %bb.0: ; %entry
; GFX1032_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v2, 0, 0, s4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v4, 0
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v6, 0
...
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1032_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032_DPP-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1032_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164_DPP-NEXT:    v_cmp_gt_u64_e32 vcc, s[0:1], v[7:8]
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
...
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1132_DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v2, 0, 0, s4
...
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132_DPP-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1064_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1064_DPP-NEXT:    v_cmp_lt_u64_e32 vcc, s[0:1], v[7:8]
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1064_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1032_DPP:       ; %bb.0: ; %entry
; GFX1032_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v2, -1, 0, s4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v4, -1
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v3, -1
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v1, -1, v0, s4
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v6, -1
...
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v8, v5
; GFX1032_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1032_DPP-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1032_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1032_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032_DPP-NEXT:    buffer_store_dwordx2 v[7:8], off, s[4:7], 0
...
; GFX1164_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164_DPP-NEXT:    v_cmp_lt_u64_e32 vcc, s[0:1], v[7:8]
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc
; GFX1164_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
...
; GFX1132_DPP-NEXT:    s_or_saveexec_b32 s4, -1
; GFX1132_DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v2, -1, 0, s4
...
; GFX1132_DPP-NEXT:    s_mov_b32 s7, 0x31016000
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132_DPP-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[0:1], v[7:8]
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v8, v8, s1, vcc_lo
; GFX1132_DPP-NEXT:    v_cndmask_b32_e64 v7, v7, s0, vcc_lo
; GFX1132_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132_DPP-NEXT:    buffer_store_b64 v[7:8], off, s[4:7], 0
