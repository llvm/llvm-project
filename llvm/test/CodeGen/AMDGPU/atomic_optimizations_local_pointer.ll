...
; GFX1064_DPP-NEXT:    v_writelane_b32 v7, s6, 32
; GFX1064_DPP-NEXT:    v_writelane_b32 v6, s7, 32
; GFX1064_DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1064_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
; GFX1064_DPP-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GFX1064_DPP-NEXT:    s_mov_b64 s[0:1], s[2:3]
; GFX1064_DPP-NEXT:    v_writelane_b32 v7, s9, 48
...
; GFX1164_DPP-NEXT:    ds_add_rtn_u64 v[6:7], v0, v[6:7]
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_gl0_inv
; GFX1164_DPP-NEXT:  .LBB6_2:
; GFX1164_DPP-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX1164_DPP-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1164_DPP-NEXT:    v_readfirstlane_b32 s3, v6
...
; GFX1164_DPP-NEXT:    v_add_co_u32 v6, vcc, s3, v8
; GFX1164_DPP-NEXT:    s_waitcnt_depctr depctr_va_vcc(0)
; GFX1164_DPP-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1064_DPP-NEXT:    v_add_co_u32 v1, vcc, v1, v4
; GFX1064_DPP-NEXT:    v_add_co_ci_u32_e32 v2, vcc, v2, v3, vcc
; GFX1064_DPP-NEXT:    v_mov_b32_dpp v5, v1 row_xmask:8 row_mask:0xf bank_mask:0xf
; GFX1064_DPP-NEXT:    v_mov_b32_dpp v6, v2 row_xmask:8 row_mask:0xf bank_mask:0xf
; GFX1064_DPP-NEXT:    v_add_co_u32 v1, vcc, v1, v5
; GFX1064_DPP-NEXT:    v_add_co_ci_u32_e32 v2, vcc, v2, v6, vcc
...
; GFX1032_DPP-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v4
; GFX1032_DPP-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, v2, v3, vcc_lo
; GFX1032_DPP-NEXT:    v_mov_b32_dpp v5, v1 row_xmask:8 row_mask:0xf bank_mask:0xf
; GFX1032_DPP-NEXT:    v_mov_b32_dpp v6, v2 row_xmask:8 row_mask:0xf bank_mask:0xf
; GFX1032_DPP-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v5
; GFX1032_DPP-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, v2, v6, vcc_lo
...
; GFX1164_DPP-NEXT:    s_mov_b64 exec, s[0:1]
; GFX1164_DPP-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX1164_DPP-NEXT:    v_mbcnt_hi_u32_b32 v0, exec_hi, v0
...
; GFX1132_DPP-NEXT:    v_mbcnt_lo_u32_b32 v0, exec_lo, 0
; GFX1132_DPP-NEXT:    v_dual_mov_b32 v5, v2 :: v_dual_mov_b32 v6, v3
; GFX1132_DPP-NEXT:    s_mov_b32 s0, exec_lo
; GFX1132_DPP-NEXT:    v_cmpx_eq_u32_e32 0, v0
...
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v6, s0
; GFX1164_DPP-NEXT:    ds_sub_rtn_u64 v[6:7], v0, v[6:7]
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_gl0_inv
...
; GFX1164_DPP-NEXT:    v_readfirstlane_b32 s4, v7
; GFX1164_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1164_DPP-NEXT:    v_sub_co_u32 v6, vcc, s3, v8
; GFX1164_DPP-NEXT:    s_waitcnt_depctr depctr_va_vcc(0)
; GFX1164_DPP-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX1132_DPP-NEXT:  ; %bb.1:
; GFX1132_DPP-NEXT:    v_mov_b32_e32 v8, s1
; GFX1132_DPP-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v7, s0
