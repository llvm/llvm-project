...
; GFX7LESS-NEXT:    s_ff1_i32_b64 s5, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s5
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s5
; GFX7LESS-NEXT:    v_writelane_b32 v1, s4, m0
; GFX7LESS-NEXT:    s_lshl_b64 s[6:7], 1, s5
...
; GFX7LESS-NEXT:    s_add_i32 s4, s4, s8
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_add_rtn_u32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS:       ; %bb.0: ; %entry
; GFX7LESS-NEXT:    s_mov_b64 s[0:1], exec
; GFX7LESS-NEXT:    s_mov_b32 s2, 0
; GFX7LESS-NEXT:  .LBB3_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s3, s[0:1]
; GFX7LESS-NEXT:    v_readlane_b32 s6, v0, s3
; GFX7LESS-NEXT:    s_lshl_b64 s[4:5], 1, s3
...
; GFX7LESS-NEXT:    s_add_i32 s2, s2, s6
...
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_add_u32 v0, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s6, s[4:5]
; GFX7LESS-NEXT:    s_mov_b32 m0, s6
; GFX7LESS-NEXT:    v_readlane_b32 s7, v3, s6
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s6
; GFX7LESS-NEXT:    v_writelane_b32 v2, s1, m0
; GFX7LESS-NEXT:    v_writelane_b32 v1, s0, m0
; GFX7LESS-NEXT:    s_add_u32 s0, s0, s8
; GFX7LESS-NEXT:    s_addc_u32 s1, s1, s7
; GFX7LESS-NEXT:    s_lshl_b64 s[6:7], 1, s6
; GFX7LESS-NEXT:    s_andn2_b64 s[4:5], s[4:5], s[6:7]
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[4:5], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s0
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_add_rtn_u64 v[3:4], v0, v[3:4]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB6_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
...
; GFX8-NEXT:    v_writelane_b32 v2, s1, m0
...
; GFX1164-NEXT:    v_writelane_b32 v0, s0, s6
; GFX1164-NEXT:    v_writelane_b32 v1, s1, s6
; GFX1164-NEXT:    s_add_u32 s0, s0, s7
; GFX1164-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1164-NEXT:    s_addc_u32 s1, s1, s8
...
; GFX1164-NEXT:    ds_add_rtn_u64 v[2:3], v4, v[2:3]
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    buffer_gl0_inv
; GFX1164-NEXT:  .LBB6_4:
; GFX1164-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; GFX1132-NEXT:    s_mov_b32 s4, exec_lo
; GFX1132-NEXT:    s_mov_b64 s[0:1], 0
; GFX1132-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1132-NEXT:  .LBB6_1: ; %ComputeLoop
; GFX1132-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1132-NEXT:    s_ctz_i32_b32 s5, s4
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1132-NEXT:    v_readlane_b32 s6, v2, s5
; GFX1132-NEXT:    v_readlane_b32 s7, v3, s5
; GFX1132-NEXT:    v_writelane_b32 v0, s0, s5
; GFX1132-NEXT:    v_writelane_b32 v1, s1, s5
; GFX1132-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1132-NEXT:    s_add_u32 s0, s0, s6
; GFX1132-NEXT:    s_addc_u32 s1, s1, s7
...
; GFX1132-NEXT:  ; %bb.3:
; GFX1132-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v3, s1
; GFX1132-NEXT:    v_mov_b32_e32 v2, s0
; GFX1132-NEXT:    ds_add_rtn_u64 v[2:3], v4, v[2:3]
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    buffer_gl0_inv
; GFX1132-NEXT:  .LBB6_4:
; GFX1132-NEXT:    s_or_b32 exec_lo, exec_lo, s4
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_sub_rtn_u32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v1, s2
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_sub_u32 v0, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB10_4:
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    s_mov_b64 s[0:1], 0
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1_vgpr2
; GFX7LESS-NEXT:  .LBB13_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s6, s[4:5]
; GFX7LESS-NEXT:    s_mov_b32 m0, s6
; GFX7LESS-NEXT:    v_readlane_b32 s7, v3, s6
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[4:5], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB13_1
; GFX7LESS-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v3, s0
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_sub_rtn_u64 v[3:4], v0, v[3:4]
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1164-NEXT:    v_mov_b32_e32 v4, 0
; GFX1164-NEXT:    v_mov_b32_e32 v2, s0
; GFX1164-NEXT:    ds_sub_rtn_u64 v[2:3], v4, v[2:3]
; GFX1164-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164-NEXT:    buffer_gl0_inv
...
; GFX1132-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v3, s1
; GFX1132-NEXT:    v_mov_b32_e32 v2, s0
; GFX1132-NEXT:    ds_sub_rtn_u64 v[2:3], v4, v[2:3]
; GFX1132-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132-NEXT:    buffer_gl0_inv
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_and_b32 s4, s4, s8
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB14_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_and_rtn_b32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB14_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_and_b32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_or_b32 s4, s4, s8
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_or_rtn_b32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_or_b32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    s_mov_b32 s4, 0
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1
; GFX7LESS-NEXT:  .LBB16_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s5, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s5
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s5
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_xor_b32 s4, s4, s8
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB16_1
; GFX7LESS-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_xor_rtn_b32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_xor_b32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_max_i32 s4, s4, s8
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB17_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_max_rtn_i32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB17_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_max_i32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS:       ; %bb.0: ; %entry
; GFX7LESS-NEXT:    s_mov_b64 s[0:1], exec
; GFX7LESS-NEXT:    s_brev_b32 s4, -2
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1
; GFX7LESS-NEXT:  .LBB19_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s5, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s5
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s5
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_min_i32 s4, s4, s8
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB19_1
; GFX7LESS-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB19_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_min_rtn_i32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB19_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_min_i32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    s_mov_b32 s4, 0
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1
; GFX7LESS-NEXT:  .LBB21_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s5, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s5
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s5
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_max_u32 s4, s4, s8
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB21_1
; GFX7LESS-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB21_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_max_rtn_u32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB21_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_max_u32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
...
; GFX7LESS-NEXT:    s_mov_b32 s4, -1
; GFX7LESS-NEXT:    ; implicit-def: $vgpr1
; GFX7LESS-NEXT:  .LBB23_1: ; %ComputeLoop
; GFX7LESS-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX7LESS-NEXT:    s_ff1_i32_b64 s5, s[0:1]
; GFX7LESS-NEXT:    s_mov_b32 m0, s5
; GFX7LESS-NEXT:    v_readlane_b32 s8, v0, s5
...
; GFX7LESS-NEXT:    v_cmp_ne_u64_e64 s[6:7], s[0:1], 0
; GFX7LESS-NEXT:    s_and_b64 vcc, exec, s[6:7]
; GFX7LESS-NEXT:    s_min_u32 s4, s4, s8
; GFX7LESS-NEXT:    s_cbranch_vccnz .LBB23_1
; GFX7LESS-NEXT:  ; %bb.2: ; %ComputeEnd
; GFX7LESS-NEXT:    v_mbcnt_lo_u32_b32_e64 v0, exec_lo, 0
; GFX7LESS-NEXT:    v_mbcnt_hi_u32_b32_e32 v0, exec_hi, v0
; GFX7LESS-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GFX7LESS-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX7LESS-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX7LESS-NEXT:    s_cbranch_execz .LBB23_4
; GFX7LESS-NEXT:  ; %bb.3:
; GFX7LESS-NEXT:    v_mov_b32_e32 v0, 0
; GFX7LESS-NEXT:    v_mov_b32_e32 v2, s4
; GFX7LESS-NEXT:    s_mov_b32 m0, -1
; GFX7LESS-NEXT:    ds_min_rtn_u32 v0, v0, v2
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:  .LBB23_4:
; GFX7LESS-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX7LESS-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; GFX7LESS-NEXT:    s_mov_b32 s3, 0xf000
; GFX7LESS-NEXT:    s_mov_b32 s2, -1
; GFX7LESS-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7LESS-NEXT:    v_min_u32_e32 v0, s4, v1
; GFX7LESS-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7LESS-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX7LESS-NEXT:    s_endpgm
;
