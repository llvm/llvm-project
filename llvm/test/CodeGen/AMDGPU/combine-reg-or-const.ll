...
; CHECK-NEXT:    s_cmp_lg_u32 s2, 3
; CHECK-NEXT:    s_cbranch_scc1 .LBB0_2
; CHECK-NEXT:  ; %bb.1: ; %if.then
; CHECK-NEXT:    s_and_b32 s4, s2, 0xffff
; CHECK-NEXT:    s_mov_b32 s3, 0
; CHECK-NEXT:    s_mul_i32 s6, s4, 0xaaab
; CHECK-NEXT:    s_lshl_b64 s[4:5], s[2:3], 2
; CHECK-NEXT:    s_lshr_b32 s3, s6, 19
; CHECK-NEXT:    s_mul_i32 s3, s3, 12
; CHECK-NEXT:    s_sub_i32 s2, s2, s3
; CHECK-NEXT:    s_and_b32 s3, s2, 0xffff
; CHECK-NEXT:    s_add_u32 s0, s0, s4
; CHECK-NEXT:    s_addc_u32 s1, s1, s5
; CHECK-NEXT:    s_bfe_u32 s2, s2, 0xd0003
