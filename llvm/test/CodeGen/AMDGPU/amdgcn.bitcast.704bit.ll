...
; SI-NEXT:    v_alignbit_b32 v23, v22, v21, 16
; SI-NEXT:    v_alignbit_b32 v24, v20, v19, 16
; SI-NEXT:    v_alignbit_b32 v25, v18, v17, 16
; SI-NEXT:    v_alignbit_b32 v26, v16, v15, 16
; SI-NEXT:    v_alignbit_b32 v28, v14, v13, 16
; SI-NEXT:    v_alignbit_b32 v30, v12, v11, 16
; SI-NEXT:    v_alignbit_b32 v32, v10, v9, 16
; SI-NEXT:    v_alignbit_b32 v34, v8, v7, 16
; SI-NEXT:    v_alignbit_b32 v37, v6, v5, 16
; SI-NEXT:    v_alignbit_b32 v39, v4, v3, 16
; SI-NEXT:    v_alignbit_b32 v49, v2, v1, 16
...
; SI-NEXT:    buffer_store_dword v63, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
...
; SI-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:52
; SI-NEXT:    buffer_load_dword v10, off, s[0:3], s32 offset:48
; SI-NEXT:    buffer_load_dword v12, off, s[0:3], s32 offset:44
...
; SI-NEXT:    v_lshlrev_b32_e32 v36, 16, v9
; SI-NEXT:    v_lshlrev_b32_e32 v42, 16, v11
; SI-NEXT:    v_lshlrev_b32_e32 v35, 16, v13
; SI-NEXT:    v_lshlrev_b32_e32 v41, 16, v15
...
; SI-NEXT:    buffer_load_dword v14, off, s[0:3], s32 offset:36
; SI-NEXT:    s_waitcnt vmcnt(1)
; SI-NEXT:    v_lshlrev_b32_e32 v47, 16, v12
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    buffer_load_dword v16, off, s[0:3], s32 offset:12
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    v_or_b32_e32 v5, v5, v42
; SI-NEXT:    v_or_b32_e32 v6, v6, v35
; SI-NEXT:    v_or_b32_e32 v7, v7, v41
; SI-NEXT:    v_or_b32_e32 v8, v8, v34
; SI-NEXT:    v_or_b32_e32 v16, v16, v59
...
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_add_i32_e32 v16, vcc, 3, v45
...
; SI-NEXT:    v_or_b32_e32 v15, v60, v15
; SI-NEXT:    v_or_b32_e32 v17, v58, v17
; SI-NEXT:    v_or_b32_e32 v18, v57, v18
; SI-NEXT:    v_or_b32_e32 v19, v56, v19
; SI-NEXT:    v_or_b32_e32 v20, v47, v20
; SI-NEXT:    v_or_b32_e32 v21, v46, v21
...
; SI-NEXT:  .LBB7_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    buffer_load_dword v63, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
...
; SI-NEXT:    v_lshrrev_b32_e32 v23, 16, v19
...
; SI-NEXT:    v_cvt_f32_f16_e32 v38, v23
; SI-NEXT:    v_lshrrev_b32_e32 v23, 16, v13
; SI-NEXT:    v_cvt_f32_f16_e32 v48, v23
; SI-NEXT:    v_lshrrev_b32_e32 v23, 16, v12
; SI-NEXT:    v_cvt_f32_f16_e32 v50, v23
...
; SI-NEXT:    v_cvt_f32_f16_e32 v62, v23
...
; SI-NEXT:    v_cvt_f32_f16_e32 v39, v15
; SI-NEXT:    v_cvt_f32_f16_e32 v49, v14
; SI-NEXT:    v_cvt_f32_f16_e32 v51, v13
; SI-NEXT:    v_cvt_f32_f16_e32 v52, v12
; SI-NEXT:    v_cvt_f32_f16_e32 v54, v11
; SI-NEXT:    v_cvt_f32_f16_e32 v40, v10
; SI-NEXT:    v_cvt_f32_f16_e32 v42, v9
; SI-NEXT:    v_cvt_f32_f16_e32 v44, v8
; SI-NEXT:    v_cvt_f32_f16_e32 v46, v7
; SI-NEXT:    v_cvt_f32_f16_e32 v56, v6
; SI-NEXT:    v_cvt_f32_f16_e32 v58, v5
; SI-NEXT:    v_cvt_f32_f16_e32 v59, v4
; SI-NEXT:    v_cvt_f32_f16_e32 v61, v3
; SI-NEXT:    s_waitcnt expcnt(3)
...
; SI-NEXT:    buffer_load_dword v53, off, s[0:3], s32 offset:4
; SI-NEXT:    buffer_load_dword v54, off, s[0:3], s32 offset:16
; SI-NEXT:    buffer_load_dword v55, off, s[0:3], s32 offset:12
; SI-NEXT:    buffer_load_dword v40, off, s[0:3], s32 offset:24
; SI-NEXT:    buffer_load_dword v41, off, s[0:3], s32 offset:20
; SI-NEXT:    buffer_load_dword v42, off, s[0:3], s32 offset:32
; SI-NEXT:    buffer_load_dword v43, off, s[0:3], s32 offset:28
; SI-NEXT:    buffer_load_dword v44, off, s[0:3], s32 offset:40
; SI-NEXT:    buffer_load_dword v45, off, s[0:3], s32 offset:36
; SI-NEXT:    buffer_load_dword v46, off, s[0:3], s32 offset:48
; SI-NEXT:    buffer_load_dword v47, off, s[0:3], s32 offset:44
; SI-NEXT:    buffer_load_dword v56, off, s[0:3], s32 offset:52
; SI-NEXT:    v_cvt_f16_f32_e32 v50, v0
...
; SI-NEXT:    v_cvt_f16_f32_e32 v36, v6
; SI-NEXT:    v_cvt_f16_f32_e32 v35, v9
; SI-NEXT:    v_cvt_f16_f32_e32 v34, v8
...
; SI-NEXT:    v_cvt_f16_f32_e32 v63, v13
...
; SI-NEXT:    v_cvt_f16_f32_e32 v57, v19
...
; SI-NEXT:    v_cvt_f16_f32_e32 v53, v46
...
; SI-NEXT:    v_or_b32_e32 v21, v52, v21
; SI-NEXT:    ; implicit-def: $vgpr51
; SI-NEXT:    ; implicit-def: $vgpr50
; SI-NEXT:    ; implicit-def: $vgpr49
; SI-NEXT:    ; implicit-def: $vgpr48
...
; SI-NEXT:    buffer_load_dword v11, off, s[0:3], s32 offset:180 ; 4-byte Folded Reload
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    v_or_b32_e32 v19, v40, v19
; SI-NEXT:    ; implicit-def: $vgpr41
; SI-NEXT:    ; implicit-def: $vgpr40
; SI-NEXT:  .LBB9_2: ; %Flow
; SI-NEXT:    s_andn2_saveexec_b64 s[4:5], s[4:5]
...
; SI-NEXT:    v_cvt_f32_f16_e32 v8, v59
...
; SI-NEXT:    v_cvt_f32_f16_e32 v19, v41
...
; SI-NEXT:    v_alignbit_b32 v25, v18, v17, 16
; SI-NEXT:    v_alignbit_b32 v26, v16, v15, 16
; SI-NEXT:    v_alignbit_b32 v27, v14, v13, 16
; SI-NEXT:    v_alignbit_b32 v29, v12, v11, 16
; SI-NEXT:    v_alignbit_b32 v32, v10, v9, 16
; SI-NEXT:    v_alignbit_b32 v34, v8, v7, 16
; SI-NEXT:    v_alignbit_b32 v36, v6, v5, 16
; SI-NEXT:    v_alignbit_b32 v39, v4, v3, 16
; SI-NEXT:    v_alignbit_b32 v49, v2, v1, 16
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    buffer_store_dword v40, off, s[0:3], s32 offset:120 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v41, off, s[0:3], s32 offset:116 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v42, off, s[0:3], s32 offset:112 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v43, off, s[0:3], s32 offset:108 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v44, off, s[0:3], s32 offset:104 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v45, off, s[0:3], s32 offset:100 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v46, off, s[0:3], s32 offset:96 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v47, off, s[0:3], s32 offset:92 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v56, off, s[0:3], s32 offset:88 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v57, off, s[0:3], s32 offset:84 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v58, off, s[0:3], s32 offset:80 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v59, off, s[0:3], s32 offset:76 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v60, off, s[0:3], s32 offset:72 ; 4-byte Folded Spill
...
; SI-NEXT:    v_cvt_f32_f16_e32 v48, v2
; SI-NEXT:    v_cvt_f32_f16_e32 v38, v3
; SI-NEXT:    v_cvt_f32_f16_e32 v49, v4
; SI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:216 ; 4-byte Folded Spill
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_cvt_f32_f16_e32 v1, v19
; SI-NEXT:    v_cvt_f32_f16_e32 v34, v5
; SI-NEXT:    v_cvt_f32_f16_e32 v39, v6
; SI-NEXT:    v_cvt_f32_f16_e32 v32, v7
...
; SI-NEXT:    v_cvt_f32_f16_e32 v57, v15
...
; SI-NEXT:    v_cvt_f32_f16_e32 v60, v18
; SI-NEXT:    v_cvt_f32_f16_e32 v58, v20
; SI-NEXT:    s_waitcnt vmcnt(5)
; SI-NEXT:    v_cvt_f32_f16_e32 v56, v40
...
; SI-NEXT:    v_cvt_f32_f16_e32 v27, v31
; SI-NEXT:    v_cvt_f32_f16_e32 v28, v40
; SI-NEXT:    v_cvt_f32_f16_e32 v29, v50
; SI-NEXT:    v_add_f32_e32 v26, 0x38000000, v26
; SI-NEXT:    v_cvt_f16_f32_e32 v32, v26
...
; SI-NEXT:    v_or_b32_e32 v31, v26, v27
...
; SI-NEXT:    v_or_b32_e32 v39, v30, v28
; SI-NEXT:    v_cvt_f32_f16_e32 v30, v36
...
; SI-NEXT:    v_lshlrev_b32_e32 v27, 16, v38
; SI-NEXT:    v_or_b32_e32 v26, v26, v27
; SI-NEXT:    v_add_i32_e32 v27, vcc, 12, v0
; SI-NEXT:    buffer_store_dword v26, v27, s[0:3], 0 offen
; SI-NEXT:    s_waitcnt expcnt(0)
...
; SI-NEXT:    buffer_store_dword v26, v27, s[0:3], 0 offen
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_and_b32_e32 v26, 0xffff, v34
; SI-NEXT:    v_lshlrev_b32_e32 v27, 16, v35
; SI-NEXT:    v_or_b32_e32 v26, v26, v27
; SI-NEXT:    v_add_i32_e32 v27, vcc, 20, v0
; SI-NEXT:    buffer_store_dword v26, v27, s[0:3], 0 offen
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_and_b32_e32 v26, 0xffff, v36
; SI-NEXT:    v_lshlrev_b32_e32 v27, 16, v54
; SI-NEXT:    v_or_b32_e32 v26, v26, v27
; SI-NEXT:    v_add_i32_e32 v27, vcc, 24, v0
; SI-NEXT:    buffer_store_dword v26, v27, s[0:3], 0 offen
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_and_b32_e32 v26, 0xffff, v31
; SI-NEXT:    v_lshlrev_b32_e32 v27, 16, v32
; SI-NEXT:    v_or_b32_e32 v26, v26, v27
...
; SI-NEXT:    v_lshlrev_b32_e32 v20, 16, v20
; SI-NEXT:    v_or_b32_e32 v26, v26, v27
; SI-NEXT:    v_add_i32_e32 v27, vcc, 32, v0
