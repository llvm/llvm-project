...
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLEE_LOCAL_BOUNDED_LIFETIME_I:]], metadata i32 addrspace(5)* %I{{.*}})
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CALLEE_LOCAL_BOUNDED_LIFETIME_J:]], metadata i32 addrspace(5)* %J{{.*}})
...
entry:
  ...
  call void @llvm.dbg.def(metadata !20, metadata i32 addrspace(5)* %I.addr)
  call void @llvm.dbg.def(metadata !22, metadata i32 addrspace(5)* %J)
...
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CLONE_LOCAL_BOUNDED_LIFETIME_I:]], metadata i32 addrspace(5)* %I{{.*}})
; CHECK-DAG: call void @llvm.dbg.def(metadata ![[#CLONE_LOCAL_BOUNDED_LIFETIME_J:]], metadata i32 addrspace(5)* %J{{.*}})
...
!20 = distinct !DILifetime(object: !21, location: !DIExpr(DIOpReferrer(i32 addrspace(5)*), DIOpDeref(i32)))
!21 = !DILocalVariable(name: "I", arg: 1, scope: !12, file: !4, line: 1, type: !15)
!22 = distinct !DILifetime(object: !23, location: !DIExpr(DIOpReferrer(i32 addrspace(5)*), DIOpDeref(i32)), argObjects: {!21, !19})
