...
; GFX9-NEXT:    v_max_f32_e32 v0, v0, v7
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_max_f32_e32 v0, v0, v6
; GFX9-NEXT:    v_max_f32_e32 v1, v1, v7
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_pk_max_f16 v1, v2, v3
; GFX9-NEXT:    v_pk_max_f16 v0, v0, v1
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_pk_max_f16 v0, v0, v1
; GFX9-NEXT:    v_pk_max_f16 v1, v3, v4
; GFX9-NEXT:    v_pk_max_f16 v0, v0, v2
; GFX9-NEXT:    v_pk_max_f16 v1, v1, v5
; GFX9-NEXT:    v_pk_max_f16 v2, v6, v7
