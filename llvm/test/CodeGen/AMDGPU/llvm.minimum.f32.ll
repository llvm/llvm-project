...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v0, v0, v1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f32__nnan_src0:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f32__nnan_src1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v4, v0, v2
; GFX942-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v0, v0, v2
; GFX942-NEXT:    v_min_f32_e32 v1, v1, v3
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v6, v0, v3
; GFX942-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v0, v0, v3
; GFX942-NEXT:    v_min_f32_e32 v1, v1, v4
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v8, v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v9, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v4
; GFX942-NEXT:    v_min_f32_e32 v4, v1, v5
; GFX942-NEXT:    s_nop 0
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v8, v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v9, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v0, v0, v4
; GFX942-NEXT:    v_min_f32_e32 v1, v1, v5
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v8f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f32_e32 v16, v0, v8
; GFX942-NEXT:    v_mov_b32_e32 v17, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v8
; GFX942-NEXT:    v_min_f32_e32 v8, v1, v9
; GFX942-NEXT:    s_nop 0
