...
; SDAG-VGPR-NEXT:    global_load_dwordx4 v[0:3], v0, s[6:7]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[2:3]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[14:15], s[0:1]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[6:7], s[8:9]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[8:9], s[10:11]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[10:11], s[12:13]
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[12:13], s[14:15]
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v5, s16
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v4, 0
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-VGPR-NEXT:    v_smfmac_f32_16x16x64_f16 v[0:3], v[14:17], v[6:13], v5 cbsz:1 abid:2
; SDAG-VGPR-NEXT:    s_nop 7
; SDAG-VGPR-NEXT:    global_store_dwordx4 v4, v[0:3], s[6:7]
...
; GCN-VGPR-NEXT:    global_load_dwordx4 v[0:3], v0, s[6:7]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[2:3]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[14:15], s[0:1]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[6:7], s[8:9]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[8:9], s[10:11]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[10:11], s[12:13]
; GCN-VGPR-NEXT:    v_mov_b64_e32 v[12:13], s[14:15]
; GCN-VGPR-NEXT:    v_mov_b32_e32 v5, s16
; GCN-VGPR-NEXT:    v_mov_b32_e32 v4, 0
; GCN-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GCN-VGPR-NEXT:    v_smfmac_f32_16x16x64_bf16 v[0:3], v[14:17], v[6:13], v5 cbsz:1 abid:2
; GCN-VGPR-NEXT:    s_nop 7
; GCN-VGPR-NEXT:    global_store_dwordx4 v4, v[0:3], s[6:7]
