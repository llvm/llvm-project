...
; NEGATIVE: llc: for the --amdgpu-vgpr-threshold-percent option: '-20' value invalid for uint argument!
; OVER100: llc: for the --amdgpu-vgpr-threshold-percent option: '140' value must be in the range [0, 100]!
