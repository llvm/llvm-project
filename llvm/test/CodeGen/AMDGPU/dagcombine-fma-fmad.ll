...
; GFX11-NEXT:    v_mul_f32_e32 v8, s18, v2
...
; GFX11-NEXT:    v_dual_sub_f32 v0, v1, v5 :: v_dual_fmac_f32 v7, v3, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fmac_f32_e32 v5, v0, v6
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_f32_e32 v4, v4, v10
; GFX11-NEXT:    v_mul_f32_e32 v3, v4, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_fmaak_f32 v4, s0, v5, 0x3ca3d70a :: v_dual_mul_f32 v1, v8, v6
