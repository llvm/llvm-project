...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -O3 < %s | FileCheck -check-prefixes=GFX1300,GFX1300-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -O3 < %s | FileCheck -check-prefixes=GFX1300,GFX1300-GISEL %s
