...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1250 -O3 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1250 -O3 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1300 -O3 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1300,GFX1300-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1300 -O3 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1300,GFX1300-GISEL %s
...
;
; GFX1300-LABEL: cluster_load_b32_vaddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_readfirstlane_b32 s0, v4
; GFX1300-NEXT:    s_mov_b32 m0, s0
; GFX1300-NEXT:    global_load_mcast_b32 v0, v[0:1], off offset:32 th:TH_LOAD_NT
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b32 v[2:3], v0, off
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b32_vaddr_imm_mask:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_mov_b32 m0, 7
; GFX1300-NEXT:    global_load_mcast_b32 v0, v[0:1], off offset:32 th:TH_LOAD_HT scope:SCOPE_SE
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b32 v[2:3], v0, off
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b32_saddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_mov_b32 m0, s2
; GFX1300-NEXT:    global_load_mcast_b32 v2, v2, s[0:1] offset:32 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b32 v[0:1], v2, off
; GFX1300-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %addr, i32 4
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_monitor_b32_saddr_scale_offset:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_mov_b32 m0, s2
; GFX1300-NEXT:    global_load_mcast_b32 v2, v2, s[0:1] scale_offset th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b32 v[0:1], v2, off
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b64_vaddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_readfirstlane_b32 s0, v4
; GFX1300-NEXT:    s_mov_b32 m0, s0
; GFX1300-NEXT:    global_load_mcast_b64 v[0:1], v[0:1], off offset:32 th:TH_LOAD_NT
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1300-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %addr, i32 4
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b64_vaddr_imm_mask:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_mov_b32 m0, 0x10007
; GFX1300-NEXT:    global_load_mcast_b64 v[0:1], v[0:1], off offset:32 th:TH_LOAD_HT scope:SCOPE_SE
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b64_saddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_mov_b32 m0, s2
; GFX1300-NEXT:    global_load_mcast_b64 v[2:3], v2, s[0:1] offset:32 th:TH_LOAD_NT_HT scope:SCOPE_DEV
; GFX1300-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_monitor_b64_saddr_scale_offset:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_mov_b32 m0, s2
; GFX1300-NEXT:    global_load_mcast_b64 v[2:3], v2, s[0:1] scale_offset th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b128_vaddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_readfirstlane_b32 s0, v4
; GFX1300-NEXT:    s_mov_b32 m0, s0
; GFX1300-NEXT:    global_load_mcast_b128 v[4:7], v[0:1], off offset:32 th:TH_LOAD_NT
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX1300-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %addr, i32 4
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b128_vaddr_imm_mask:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_mov_b32 m0, 15
; GFX1300-NEXT:    global_load_mcast_b128 v[4:7], v[0:1], off offset:32 th:TH_LOAD_HT scope:SCOPE_SE
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b128 v[2:3], v[4:7], off
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: cluster_load_b128_saddr:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_mov_b32 m0, s2
; GFX1300-NEXT:    global_load_mcast_b128 v[2:5], v2, s[0:1] offset:32 th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1300-NEXT:    s_wait_loadcnt 0x0
; GFX1300-NEXT:    global_store_b128 v[0:1], v[2:5], off
; GFX1300-NEXT:    s_endpgm
entry:
  %gep = getelementptr i64, ptr addrspace(1) %addr, i32 4
