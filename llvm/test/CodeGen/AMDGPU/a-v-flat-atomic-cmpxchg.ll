...
; CHECK-NEXT:    v_cndmask_b32_e32 v7, -1, v6, vcc
; CHECK-NEXT:    buffer_load_dword v4, v7, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v5, v7, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_store_dword v0, v7, s[0:3], 0 offen
; CHECK-NEXT:    buffer_store_dword v1, v7, s[0:3], 0 offen offset:4
...
; CHECK-NEXT:    v_cndmask_b32_e32 v7, -1, v4, vcc
; CHECK-NEXT:    buffer_load_dword v4, v7, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v5, v7, s[0:3], 0 offen offset:4
...
; CHECK-NEXT:    v_cndmask_b32_e32 v7, -1, v0, vcc
; CHECK-NEXT:    buffer_load_dword v0, v7, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v1, v7, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    v_accvgpr_write_b32 a0, v0
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_store_dword v3, v7, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v0, v7, s[0:3], 0 offen
...
; CHECK-NEXT:  ; %bb.3: ; %atomicrmw.private
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; CHECK-NEXT:    v_cndmask_b32_e32 v8, -1, v0, vcc
; CHECK-NEXT:    buffer_load_dword v2, v8, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v3, v8, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_store_dword v4, v8, s[0:3], 0 offen
...
; CHECK-NEXT:  ; %bb.3: ; %atomicrmw.private
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v5, -1, v4, vcc
; CHECK-NEXT:    buffer_load_dword v0, v5, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v1, v5, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_store_dword v2, v5, s[0:3], 0 offen offset:4
...
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v5, -1, v4, vcc
; CHECK-NEXT:    buffer_load_dword v2, v5, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v3, v5, s[0:3], 0 offen offset:4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    buffer_store_dword v0, v5, s[0:3], 0 offen
