...
; RUN: opt -S -mtriple=amdgpu-amd-amdhsa -amdgpu-lower-module-lds %s -o - | FileCheck %s
; RUN: opt -S -mtriple=amdgpu-amd-amdhsa -passes=amdgpu-lower-module-lds %s -o - | FileCheck %s
