...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-SDAG %s
...
; RUN: llc < %s -global-isel -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-GISEL %s
...
; PREGFX10-UNPACKED-NEXT:    s_load_dword s4, s[2:3], 0x34
; PREGFX10-UNPACKED-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
...
; PREGFX10-PACKED-NEXT:    s_load_dword s0, s[2:3], 0x34
...
; GFX10-PACKED-NEXT:    s_load_dword s0, s[2:3], 0x34
; GFX10-PACKED-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX10-PACKED-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-PACKED-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX11-PACKED-NEXT:    s_load_b32 s4, s[2:3], 0x34
; GFX11-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; GFX12-PACKED-NEXT:    s_load_b32 s4, s[2:3], 0x34
; GFX12-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; GFX13-PACKED-NEXT:    s_load_b32 s4, s[2:3], 0x34
; GFX13-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX13-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-PACKED-NEXT:    tbuffer_store_d16_format_x v0, off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
...
; GFX13-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-PACKED-NEXT:    tbuffer_store_d16_format_xy v0, off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
; GFX13-PACKED-NEXT:    s_endpgm
main_body:
...
; PREGFX10-UNPACKED:       ; %bb.0: ; %main_body
; PREGFX10-UNPACKED-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x34
; PREGFX10-UNPACKED-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; PREGFX10-UNPACKED-NEXT:    s_waitcnt lgkmcnt(0)
...
; PREGFX10-PACKED:       ; %bb.0: ; %main_body
; PREGFX10-PACKED-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; PREGFX10-PACKED-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; PREGFX10-PACKED-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-PACKED:       ; %bb.0: ; %main_body
; GFX10-PACKED-NEXT:    s_clause 0x1
; GFX10-PACKED-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX10-PACKED-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX10-PACKED-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-PACKED-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX10-PACKED-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-PACKED-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX11-PACKED:       ; %bb.0: ; %main_body
; GFX11-PACKED-NEXT:    s_clause 0x1
; GFX11-PACKED-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX11-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX11-PACKED-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-PACKED-SDAG-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX12-PACKED-SDAG-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; GFX13-PACKED-SDAG-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX13-PACKED-SDAG-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX13-PACKED-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], 0xffffffffffff
; GFX13-PACKED-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-PACKED-SDAG-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GFX13-PACKED-SDAG-NEXT:    tbuffer_store_d16_format_xyz v[0:1], off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
...
; GFX12-PACKED-GISEL-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX12-PACKED-GISEL-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; GFX13-PACKED-GISEL-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX13-PACKED-GISEL-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX13-PACKED-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-GISEL-NEXT:    s_pack_lh_b32_b16 s4, s4, s4
; GFX13-PACKED-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-PACKED-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GFX13-PACKED-GISEL-NEXT:    tbuffer_store_d16_format_xyzw v[0:1], off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
...
; GFX12-PACKED:       ; %bb.0: ; %main_body
; GFX12-PACKED-NEXT:    s_clause 0x1
; GFX12-PACKED-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX12-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX12-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    s_clause 0x1
; GFX13-PACKED-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX13-PACKED-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX13-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; GFX13-PACKED-NEXT:    tbuffer_store_d16_format_xyzw v[0:1], off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
; GFX13-PACKED-NEXT:    s_endpgm
main_body:
