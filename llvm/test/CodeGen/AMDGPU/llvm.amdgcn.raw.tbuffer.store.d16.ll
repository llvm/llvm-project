...
; RUN: llc < %s -mtriple=amdgpu8.02 | FileCheck -check-prefixes=PREGFX10-UNPACKED %s
; RUN: llc < %s -mtriple=amdgpu8.10 | FileCheck -check-prefixes=PREGFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu9.00 | FileCheck -check-prefixes=PREGFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu10.10 | FileCheck -check-prefixes=GFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-vopd=0 | FileCheck -check-prefixes=GFX11-PACKED,GFX11-PACKED-TRUE16 %s
