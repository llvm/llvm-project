...
;
; GFX13-PACKED-SDAG-TRUE16-LABEL: tbuffer_store_d16_x:
; GFX13-PACKED-SDAG-TRUE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_clause 0x1
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v0.l, s6
; GFX13-PACKED-SDAG-TRUE16-NEXT:    tbuffer_store_d16_format_x v0, off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_endpgm
;
; GFX13-PACKED-SDAG-FAKE16-LABEL: tbuffer_store_d16_x:
; GFX13-PACKED-SDAG-FAKE16:       ; %bb.0: ; %main_body
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_clause 0x1
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_load_b32 s6, s[4:5], 0x34
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v0, s6
; GFX13-PACKED-SDAG-FAKE16-NEXT:    tbuffer_store_d16_format_x v0, off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_endpgm
;
; GFX13-PACKED-GISEL-LABEL: tbuffer_store_d16_x:
; GFX13-PACKED-GISEL:       ; %bb.0: ; %main_body
; GFX13-PACKED-GISEL-NEXT:    s_clause 0x1
; GFX13-PACKED-GISEL-NEXT:    s_load_b32 s6, s[4:5], 0x34
...
; GFX13-PACKED-GISEL-NEXT:    tbuffer_store_d16_format_x v0, off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
...
; GFX13-PACKED-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-PACKED-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-GISEL-NEXT:    s_pack_lh_b32_b16 s6, s6, s6
