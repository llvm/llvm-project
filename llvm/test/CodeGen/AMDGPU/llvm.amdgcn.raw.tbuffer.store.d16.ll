...
; RUN: llc < %s -march=amdgcn -mcpu=gfx1200 -amdgpu-enable-vopd=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX12-PACKED %s
...
; GFX12-PACKED-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
; GFX12-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v0, s4
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-PACKED-NEXT:    tbuffer_store_d16_format_xyz v[0:1], off, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM]
; GFX12-PACKED-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-PACKED-NEXT:    s_endpgm
main_body:
