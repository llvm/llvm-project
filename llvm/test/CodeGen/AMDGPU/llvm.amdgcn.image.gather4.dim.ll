...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN,GFX12PLUS,GFX12 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -show-mc-encoding < %s | FileCheck -check-prefixes=GCN,GFX12PLUS %s
