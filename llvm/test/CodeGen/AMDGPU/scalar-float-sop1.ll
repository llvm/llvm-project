...
; RUN: llc -global-isel=0 -mtriple=amdgpu11.50 < %s | FileCheck %s --check-prefixes=CHECK,SDAG,SDAG-GFX11
; RUN: llc -global-isel=1 -mtriple=amdgpu11.50 < %s | FileCheck %s --check-prefixes=CHECK,GISEL-GFX11
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00 < %s | FileCheck %s --check-prefixes=CHECK,SDAG,SDAG-GFX12
...
; SDAG-GFX11-LABEL: fptosi_f32_to_i16:
; SDAG-GFX11:       ; %bb.0:
; SDAG-GFX11-NEXT:    s_cvt_i32_f32 s0, s0
; SDAG-GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; SDAG-GFX11-NEXT:    v_mov_b32_e32 v0, s0
; SDAG-GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; SDAG-GFX11-NEXT:    ; return to shader part epilog
;
; GISEL-GFX11-LABEL: fptosi_f32_to_i16:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    s_cvt_i32_f32 s0, s0
; GISEL-GFX11-NEXT:    ; return to shader part epilog
;
; SDAG-GFX12-LABEL: fptosi_f32_to_i16:
; SDAG-GFX12:       ; %bb.0:
; SDAG-GFX12-NEXT:    s_cvt_i32_f32 s0, s0
; SDAG-GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; SDAG-GFX12-NEXT:    v_mov_b32_e32 v0, s0
...
;
; GISEL-GFX12-LABEL: fptosi_f32_to_i16:
; GISEL-GFX12:       ; %bb.0:
; GISEL-GFX12-NEXT:    s_cvt_i32_f32 s0, s0
...
; SDAG-GFX11-LABEL: fptoui_f32_to_u16:
; SDAG-GFX11:       ; %bb.0:
; SDAG-GFX11-NEXT:    s_cvt_u32_f32 s0, s0
; SDAG-GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; SDAG-GFX11-NEXT:    v_mov_b32_e32 v0, s0
; SDAG-GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; SDAG-GFX11-NEXT:    ; return to shader part epilog
;
; GISEL-GFX11-LABEL: fptoui_f32_to_u16:
; GISEL-GFX11:       ; %bb.0:
; GISEL-GFX11-NEXT:    s_cvt_u32_f32 s0, s0
; GISEL-GFX11-NEXT:    ; return to shader part epilog
;
; SDAG-GFX12-LABEL: fptoui_f32_to_u16:
; SDAG-GFX12:       ; %bb.0:
; SDAG-GFX12-NEXT:    s_cvt_u32_f32 s0, s0
; SDAG-GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; SDAG-GFX12-NEXT:    v_mov_b32_e32 v0, s0
; SDAG-GFX12-NEXT:    v_readfirstlane_b32 s0, v0
; SDAG-GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; SDAG-GFX12-NEXT:    ; return to shader part epilog
;
; GISEL-GFX12-LABEL: fptoui_f32_to_u16:
; GISEL-GFX12:       ; %bb.0:
; GISEL-GFX12-NEXT:    s_cvt_u32_f32 s0, s0
; GISEL-GFX12-NEXT:    ; return to shader part epilog
...
; SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
; SDAG-NEXT:    v_mov_b16_e32 v0.l, s0
; SDAG-NEXT:    ; return to shader part epilog
;
