...
; RUN: llc -mtriple=amdgpu7.04 < %s | FileCheck -check-prefixes=GFX7 %s
; RUN: llc -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu11.00 -amdgpu-enable-vopd=0 < %s | FileCheck -check-prefixes=GFX11 %s
...
; GFX7-NEXT:    s_mov_b32 m0, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_sub_i32 s4, s6, s7
; GFX7-NEXT:    v_mov_b32_e32 v1, s3
; GFX7-NEXT:    s_lshl_b32 s3, s4, 2
...
; GFX8-NEXT:    s_mov_b32 m0, -1
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_sub_i32 s4, s6, s7
; GFX8-NEXT:    v_mov_b32_e32 v1, s3
; GFX8-NEXT:    s_lshl_b32 s3, s4, 2
...
; GFX9-NEXT:    s_lshl2_add_u32 s2, s4, s2
; GFX9-NEXT:    v_mov_b32_e32 v1, s2
; GFX9-NEXT:    v_mov_b32_e32 v2, s3
; GFX9-NEXT:    ds_cmpst_rtn_b32 v0, v1, v0, v2 offset:16
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_lshl2_add_u32 s2, s4, s2
