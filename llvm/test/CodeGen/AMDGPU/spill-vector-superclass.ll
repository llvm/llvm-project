...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 2752522 /* regdef:VGPR_32 */, def undef %22.sub0
  ...
  ; GCN-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 3932169 /* reguse:VReg_64 */, %23
  ; GCN-NEXT:   S_ENDPGM 0
