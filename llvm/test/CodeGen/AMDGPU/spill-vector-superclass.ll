...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", sideeffect attdialect, regdef:VGPR_32, def undef %16.sub0
  ...
  ; GCN-NEXT:   [[COPY2:%[0-9]+]].sub1:vreg_64 = COPY undef renamable $sgpr0
  ; GCN-NEXT:   INLINEASM &"; use $0", sideeffect attdialect, reguse:VReg_64, [[COPY2]]
  ; GCN-NEXT:   S_ENDPGM 0
