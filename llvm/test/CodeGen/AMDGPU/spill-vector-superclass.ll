...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 1835018 /* regdef:VGPR_32 */, def undef %27.sub0
  ...
  ; GCN-NEXT:   [[DEF:%[0-9]+]].sub1:vreg_64 = IMPLICIT_DEF
  ; GCN-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 3407881 /* reguse:VReg_64 */, [[DEF]]
  ; GCN-NEXT:   S_ENDPGM 0
