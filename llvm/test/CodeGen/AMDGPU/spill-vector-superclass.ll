...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN: bb.0 (%ir-block.0):
  ; GCN-NEXT:   liveins: $sgpr8_9
  ; GCN-NEXT: {{  $}}
  ; GCN-NEXT:   renamable $sgpr0_3 = S_LOAD_DWORDX4_IMM killed renamable $sgpr8_9, 0, 0 :: (dereferenceable invariant load (s128) from %ir.arg.kernarg.offset1, addrspace 4)
  ; GCN-NEXT:   [[COPY:%[0-9]+]]:areg_128 = COPY killed renamable $sgpr0_3
