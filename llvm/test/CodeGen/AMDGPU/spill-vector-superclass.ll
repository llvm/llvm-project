...
define amdgpu_kernel void @test_spill_av_class(<4 x i32> %arg) #0 {
  ...
  ; GCN-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 1572874 /* regdef:VGPR_32 */, def undef %24.sub0
  ...
  ; GCN-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 3014665 /* reguse:VReg_64 */, [[SI_SPILL_V64_RESTORE]]
  ; GCN-NEXT:   S_ENDPGM 0
