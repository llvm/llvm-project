...
; CHECK-NEXT:    s_xor_b64 s[10:11], s[8:9], -1
...
; CHECK-NEXT:    s_xor_b64 s[14:15], s[12:13], -1
...
; CHECK-NEXT:    s_andn2_b64 vcc, exec, s[12:13]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    v_cmp_nlg_f64_e64 s[0:1], 0, v[28:29]
; CHECK-NEXT:    v_cndmask_b32_e64 v23, v23, 0, s[8:9]
; CHECK-NEXT:    v_cndmask_b32_e64 v22, v22, 0, s[8:9]
; CHECK-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s[0:1]
; CHECK-NEXT:    v_mov_b32_e32 v17, v16
; CHECK-NEXT:    s_and_b64 s[0:1], exec, s[8:9]
; CHECK-NEXT:    global_store_dwordx2 v20, v[16:17], s[4:5]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 s[18:19], 0
; CHECK-NEXT:    global_store_dwordx2 v20, v[20:21], s[4:5]
