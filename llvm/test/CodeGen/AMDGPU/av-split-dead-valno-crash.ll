...
; CHECK-NEXT:    s_cselect_b64 s[24:25], -1, 0
; CHECK-NEXT:    s_xor_b64 s[16:17], s[24:25], -1
; CHECK-NEXT:    s_bitcmp1_b32 s0, 8
; CHECK-NEXT:    s_cselect_b64 s[0:1], -1, 0
; CHECK-NEXT:    s_xor_b64 s[18:19], s[0:1], -1
; CHECK-NEXT:    s_and_b32 s14, s0, 1
...
; CHECK-NEXT:    s_and_b64 s[2:3], exec, s[24:25]
...
; CHECK-NEXT:    s_bitcmp0_b32 s22, 0
...
; CHECK-NEXT:    v_cndmask_b32_e64 v23, v23, 0, s[24:25]
; CHECK-NEXT:    v_cndmask_b32_e64 v22, v22, 0, s[24:25]
; CHECK-NEXT:    v_cndmask_b32_e64 v26, 0, 1, s[6:7]
; CHECK-NEXT:    v_mov_b32_e32 v27, v26
; CHECK-NEXT:    s_and_b64 s[6:7], exec, s[24:25]
; CHECK-NEXT:    global_store_dwordx2 v20, v[26:27], s[8:9]
; CHECK-NEXT:    s_cselect_b32 s21, s21, 0
; CHECK-NEXT:    s_cselect_b32 s20, s20, 0
; CHECK-NEXT:    s_mov_b64 s[6:7], -1
; CHECK-NEXT:    s_branch .LBB0_16
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 s[22:23], 0
; CHECK-NEXT:    global_store_dwordx2 v20, v[20:21], s[8:9]
