...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_load_dwordx8 s[12:19], s[4:5], 0x0
...
; CHECK-NEXT:    s_bitcmp1_b32 s14, 0
; CHECK-NEXT:    s_cselect_b64 s[10:11], -1, 0
; CHECK-NEXT:    s_xor_b64 s[20:21], s[10:11], -1
; CHECK-NEXT:    s_bitcmp1_b32 s14, 8
; CHECK-NEXT:    s_cselect_b64 s[0:1], -1, 0
; CHECK-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[0:1]
; CHECK-NEXT:    s_xor_b64 s[14:15], s[0:1], -1
...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[2:3], 1, v12
...
; CHECK-NEXT:    s_and_b64 s[4:5], exec, s[10:11]
; CHECK-NEXT:    v_mov_b32_e32 v21, v20
; CHECK-NEXT:    s_and_b64 s[6:7], exec, s[20:21]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    v_mov_b64_e32 v[24:25], s[18:19]
...
; CHECK-NEXT:    s_mov_b64 s[22:23], 0
; CHECK-NEXT:    s_mov_b64 s[8:9], s[14:15]
...
; CHECK-NEXT:    s_and_b64 s[8:9], exec, s[10:11]
; CHECK-NEXT:    global_store_dwordx2 v20, v[26:27], s[16:17]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 s[24:25], 0
; CHECK-NEXT:    global_store_dwordx2 v20, v[20:21], s[16:17]
