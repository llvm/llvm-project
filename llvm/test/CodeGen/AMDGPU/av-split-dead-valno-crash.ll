...
; CHECK-NEXT:    v_mov_b32_e32 v2, 0x9037ab78
; CHECK-NEXT:    v_mov_b32_e32 v3, 0x3e21eeb6
...
; CHECK-NEXT:    v_mov_b32_e32 v4, 0xa17f65f6
; CHECK-NEXT:    v_mov_b32_e32 v5, 0xbe927e4f
; CHECK-NEXT:    v_mov_b32_e32 v6, 0x19f4ec90
; CHECK-NEXT:    v_mov_b32_e32 v7, 0x3efa01a0
; CHECK-NEXT:    v_mov_b32_e32 v8, 0x16c16967
; CHECK-NEXT:    v_mov_b32_e32 v9, 0xbf56c16c
; CHECK-NEXT:    v_mov_b32_e32 v10, 0x69efb384
; CHECK-NEXT:    v_mov_b32_e32 v11, 0x3f4b2bb0
; CHECK-NEXT:    v_mov_b32_e32 v12, 0xa57d9582
; CHECK-NEXT:    v_mov_b32_e32 v13, 0xbf8c6ea4
; CHECK-NEXT:    v_mov_b32_e32 v14, 0xe82d3ff0
; CHECK-NEXT:    s_mov_b64 s[22:23], 0
; CHECK-NEXT:    s_and_b64 s[4:5], exec, s[16:17]
; CHECK-NEXT:    s_and_b64 s[6:7], exec, s[18:19]
; CHECK-NEXT:    v_mov_b32_e32 v15, 0xbfa59976
; CHECK-NEXT:    v_mov_b32_e32 v16, 0x8427b883
; CHECK-NEXT:    v_mov_b32_e32 v17, 0x3fae1bb4
; CHECK-NEXT:    v_mov_b32_e32 v18, 0x57b87036
; CHECK-NEXT:    v_mov_b32_e32 v19, 0x3fb3b136
; CHECK-NEXT:    v_mov_b32_e32 v20, 0x55555523
; CHECK-NEXT:    v_mov_b32_e32 v21, 0xbfd55555
...
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[4:5]
...
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[8:9]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[26:27]
; CHECK-NEXT:    v_mov_b64_e32 v[26:27], v[10:11]
; CHECK-NEXT:    v_fmac_f64_e32 v[26:27], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[12:13]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[26:27]
; CHECK-NEXT:    v_mov_b64_e32 v[26:27], v[14:15]
; CHECK-NEXT:    v_fmac_f64_e32 v[26:27], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[16:17]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[26:27]
; CHECK-NEXT:    v_mov_b64_e32 v[26:27], v[18:19]
; CHECK-NEXT:    v_fmac_f64_e32 v[26:27], 0, v[28:29]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], v[20:21]
; CHECK-NEXT:    v_fmac_f64_e32 v[28:29], 0, v[26:27]
...
; CHECK-NEXT:  .LBB0_17: ; %Flow6
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 s[24:25], -1
; CHECK-NEXT:    s_and_b64 vcc, exec, s[8:9]
; CHECK-NEXT:    s_cbranch_vccz .LBB0_1
; CHECK-NEXT:  ; %bb.18: ; %._crit_edge2105.i.i.i2330
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 s[24:25], 0
; CHECK-NEXT:    global_store_dwordx2 v0, v[0:1], s[12:13]
