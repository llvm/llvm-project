...
; GFX13-SDAG-REAL16-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX13-SDAG-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-SDAG-REAL16-NEXT:    v_cvt_sr_bf8_f16 v2, v0.l, v1
...
; GFX13-GISEL-REAL16-NEXT:    v_cvt_sr_bf8_f16 v2, v0.h, v1
...
; GFX13-SDAG-REAL16-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX13-SDAG-REAL16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-SDAG-REAL16-NEXT:    v_cvt_sr_fp8_f16 v2, v0.l, v1
; GFX13-SDAG-REAL16-NEXT:    global_store_b32 v[3:4], v2, off
; GFX13-SDAG-REAL16-NEXT:    s_endpgm
;
...
; GFX13-GISEL-REAL16:       ; %bb.0:
; GFX13-GISEL-REAL16-NEXT:    v_cvt_sr_fp8_f16 v2, v0.h, v1
; GFX13-GISEL-REAL16-NEXT:    global_store_b32 v[3:4], v2, off
; GFX13-GISEL-REAL16-NEXT:    s_endpgm
  %a.1 = extractelement <2 x half> %a, i32 1
