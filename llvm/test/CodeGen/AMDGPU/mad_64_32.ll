...
; CI:       ; %bb.0:
; CI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xb
...
; CI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s0, v2, v[0:1]
...
; GFX9-NEXT:    s_mul_hi_u32 s4, s0, s1
; GFX9-NEXT:    s_mul_i32 s0, s0, s1
; GFX9-NEXT:    s_add_u32 s0, s0, s2
; GFX9-NEXT:    s_addc_u32 s1, s4, s3
; GFX9-NEXT:    v_pk_mov_b32 v[2:3], s[0:1], s[0:1] op_sel:[0,1]
; GFX9-NEXT:    global_store_dwordx2 v0, v[2:3], s[6:7]
; GFX9-NEXT:    s_endpgm
;
