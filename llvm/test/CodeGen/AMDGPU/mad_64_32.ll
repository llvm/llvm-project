...
; GFX1100:       ; %bb.0:
; GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v4, v0
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100-NEXT:    v_mad_u64_u32 v[0:1], null, v4, v5, v[2:3]
; GFX1100-NEXT:    v_ashrrev_i32_e32 v6, 31, v4
; GFX1100-NEXT:    ; implicit-def: $vgpr2
; GFX1100-NEXT:    v_mad_u64_u32 v[3:4], null, v6, v5, v[1:2]
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1150-NEXT:    v_ashrrev_i32_e32 v3, 31, v5
; GFX1150-NEXT:    ; implicit-def: $vgpr2
; GFX1150-NEXT:    v_mad_u64_u32 v[1:2], null, v3, v4, v[1:2]
; GFX1150-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    v_ashrrev_i32_e32 v3, 31, v5
; GFX12-NEXT:    ; implicit-def: $vgpr2
; GFX12-NEXT:    v_mad_co_u64_u32 v[1:2], null, v3, v4, v[1:2]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1100:       ; %bb.0:
; GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    v_dual_mov_b32 v6, v2 :: v_dual_mov_b32 v3, v1
; GFX1100-NEXT:    v_mov_b32_e32 v2, v0
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1100-NEXT:    v_mad_u64_u32 v[0:1], null, v2, v6, v[4:5]
; GFX1100-NEXT:    v_and_b32_e32 v5, 1, v3
; GFX1100-NEXT:    ; implicit-def: $vgpr2
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1100-NEXT:    v_mad_u64_u32 v[3:4], null, v5, v6, v[1:2]
; GFX1100-NEXT:    v_mov_b32_e32 v1, v3
; GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1150-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_mad_u64_u32 v[0:1], null, v0, v3, v[4:5]
; GFX1150-NEXT:    v_and_b32_e32 v4, 1, v2
; GFX1150-NEXT:    ; implicit-def: $vgpr2
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_mad_u64_u32 v[1:2], null, v4, v3, v[1:2]
; GFX1150-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v0, v3, v[4:5]
; GFX12-NEXT:    v_and_b32_e32 v4, 1, v2
; GFX12-NEXT:    ; implicit-def: $vgpr2
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[1:2], null, v4, v3, v[1:2]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1150-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_and_b32 v3, 1, v3
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_mad_u64_u32 v[0:1], null, v6, v2, v[4:5]
; GFX1150-NEXT:    ; implicit-def: $vgpr2
; GFX1150-NEXT:    v_mad_u64_u32 v[1:2], null, v6, v3, v[1:2]
; GFX1150-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_and_b32 v3, 1, v3
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v6, v2, v[4:5]
; GFX12-NEXT:    ; implicit-def: $vgpr2
; GFX12-NEXT:    v_mad_co_u64_u32 v[1:2], null, v6, v3, v[1:2]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1100-NEXT:    ; implicit-def: $vgpr5
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1100-NEXT:    v_mad_u64_u32 v[6:7], null, v2, v0, v[4:5]
; GFX1100-NEXT:    v_mov_b32_e32 v4, 0
; GFX1100-NEXT:    v_mad_u64_u32 v[0:1], null, 0xfffffc88, v6, v[3:4]
; GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1150:       ; %bb.0:
; GFX1150-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1150-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_mad_u64_u32 v[0:1], null, v3, v2, v[2:3]
; GFX1150-NEXT:    ; implicit-def: $vgpr2
; GFX1150-NEXT:    v_mad_u64_u32 v[1:2], null, v3, v3, v[1:2]
; GFX1150-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v3, v2, v[2:3]
; GFX12-NEXT:    ; implicit-def: $vgpr2
; GFX12-NEXT:    v_mad_co_u64_u32 v[1:2], null, v3, v3, v[1:2]
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
