...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_ashrrev_i32_e32 v4, 31, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mul_lo_u32 v6, v4, v1
; GFX11-NEXT:    v_mad_u64_u32 v[4:5], s0, v0, v1, 0
; GFX11-NEXT:    v_add_nc_u32_e32 v1, v5, v6
...
; GFX11-NEXT:    v_mad_u64_u32 v[6:7], s0, v0, v2, 0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mul_lo_u32 v1, v1, v2
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, v6, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_nc_u32_e32 v1, v7, v1
...
; GFX11-NEXT:    s_load_b64 s[4:5], s[0:1], 0x2c
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], s2, s4, s5, v[0:1]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mad_i64_i32 v[8:9], s0, v0, v1, v[2:3]
; GFX11-NEXT:    v_mad_i64_i32 v[2:3], s0, v0, v1, v[4:5]
; GFX11-NEXT:    v_mad_i64_i32 v[4:5], s0, v0, v1, v[6:7]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_xor_b32_e32 v0, v8, v2
; GFX11-NEXT:    v_xor_b32_e32 v1, v9, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    v_mad_i64_i32 v[6:7], s0, v0, v1, v[2:3]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_xor_b32_e32 v0, v6, v4
; GFX11-NEXT:    v_xor_b32_e32 v1, v7, v5
; GFX11-NEXT:    s_setpc_b64 s[30:31]
  %sext0 = sext i32 %arg0 to i64
  %sext1 = sext i32 %arg1 to i64
  %mul = mul i64 %sext0, %sext1
