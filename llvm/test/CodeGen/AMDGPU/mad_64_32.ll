...
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck -check-prefixes=GFX11,GFX1100 %s
; RUN: llc -mtriple=amdgpu11.50 < %s | FileCheck -check-prefixes=GFX11,GFX1150 %s
...
; RUN: llc -mtriple=amdgpu11 --amdhsa-code-object-version=6 < %s | FileCheck -check-prefixes=GFX11,GFX1100 %s
...
; GFX11-NEXT:    s_mul_hi_u32 s2, s2, s3
; GFX11-NEXT:    s_add_u32 s3, s6, s4
; GFX11-NEXT:    s_addc_u32 s2, s2, s5
