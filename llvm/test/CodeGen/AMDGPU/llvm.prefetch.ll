...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
...
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
