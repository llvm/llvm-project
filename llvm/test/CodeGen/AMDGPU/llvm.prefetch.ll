...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX12-SPREFETCH,GFX13-SPREFETCH,GFX13-SPREFETCH-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX13-SPREFETCH-SDAG %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX12-SPREFETCH,GFX13-SPREFETCH,GFX13-SPREFETCH-GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,GL2-ONLY %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1250-SPREFETCH,GFX1250-SPREFETCH-GISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1250 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1250,SAFE-CU %s
...
; GFX13-SPREFETCH-SDAG-NEXT:    s_endpgm
;
...
;
; GFX13-SPREFETCH-GISEL-LABEL: prefetch_data_sgpr_min_offset:
; GFX13-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0xff800000
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, -1
; GFX13-SPREFETCH-GISEL-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX13-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; NOSPREFETCH-NEXT:    s_endpgm
;
; GFX13-SPREFETCH-SDAG-LABEL: prefetch_data_sgpr_too_large_offset:
; GFX13-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x800000
; GFX13-SPREFETCH-SDAG-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX13-SPREFETCH-SDAG-NEXT:    s_endpgm
;
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX13-SPREFETCH-GISEL-LABEL: prefetch_data_sgpr_too_large_offset:
; GFX13-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0x800000
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, 0
; GFX13-SPREFETCH-GISEL-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX13-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX13-SPREFETCH-GISEL-LABEL: prefetch_inst_sgpr_min_offset:
; GFX13-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0xff800000
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, -1
; GFX13-SPREFETCH-GISEL-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
; GFX13-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; NOSPREFETCH-NEXT:    s_endpgm
;
; GFX13-SPREFETCH-SDAG-LABEL: prefetch_inst_sgpr_too_large_offset:
; GFX13-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x800000
; GFX13-SPREFETCH-SDAG-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
; GFX13-SPREFETCH-SDAG-NEXT:    s_endpgm
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX13-SPREFETCH-GISEL-LABEL: prefetch_inst_sgpr_too_large_offset:
; GFX13-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0x800000
; GFX13-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, 0
; GFX13-SPREFETCH-GISEL-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
