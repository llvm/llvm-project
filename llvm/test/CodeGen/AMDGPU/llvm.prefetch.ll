...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GL2-ONLY %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1210-SPREFETCH,GFX1210-SPREFETCH-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GL2-ONLY %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1210-SPREFETCH,GFX1210-SPREFETCH-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,SAFE-CU %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX12-SPREFETCH,SPREFETCH-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1300 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GL2-ONLY %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1300 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1210-SPREFETCH,GFX1210-SPREFETCH-GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GL2-ONLY %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX1210-SPREFETCH,GFX1210-SPREFETCH-GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -mattr=+safe-cu-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,SAFE-CU %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1200 -mattr=+safe-smem-prefetch -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SPREFETCH,GFX12-SPREFETCH,SPREFETCH-GISEL %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,NOSPREFETCH %s
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    global_prefetch_b8 v0, s[0:1] offset:512 scope:SCOPE_SYS
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    global_prefetch_b8 v0, s[0:1] offset:8388607 scope:SCOPE_SYS
; GFX1210-NEXT:    s_endpgm
;
...
; GFX1210-LABEL: prefetch_data_sgpr_min_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    global_prefetch_b8 v0, s[0:1] offset:-8388608 scope:SCOPE_SYS
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-SDAG-LABEL: prefetch_data_sgpr_min_offset:
; GFX1210-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-SDAG-NEXT:    s_mov_b64 s[2:3], 0xffffffffff800000
; GFX1210-SPREFETCH-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX1210-SPREFETCH-SDAG-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-SDAG-NEXT:    s_endpgm
;
...
;
; GFX1210-SPREFETCH-GISEL-LABEL: prefetch_data_sgpr_min_offset:
; GFX1210-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0xff800000
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, -1
; GFX1210-SPREFETCH-GISEL-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; GFX1210-LABEL: prefetch_data_sgpr_too_large_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0x800000
; GFX1210-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SYS
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-SDAG-LABEL: prefetch_data_sgpr_too_large_offset:
; GFX1210-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x800000
; GFX1210-SPREFETCH-SDAG-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-SDAG-NEXT:    s_endpgm
;
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-GISEL-LABEL: prefetch_data_sgpr_too_large_offset:
; GFX1210-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0x800000
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, 0
; GFX1210-SPREFETCH-GISEL-NEXT:    s_prefetch_data s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_global:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v[0:1], off scope:SCOPE_SYS
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_flat:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    flat_prefetch_b8 v[0:1] scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_sgpr_vgpr_offset_global:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_sgpr_vgpr_offset_flat:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    flat_prefetch_b8 v0, s[0:1] offset:128 scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-LABEL: prefetch_inst_sgpr_min_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-SDAG-LABEL: prefetch_inst_sgpr_min_offset:
; GFX1210-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-SDAG-NEXT:    s_mov_b64 s[2:3], 0xffffffffff800000
; GFX1210-SPREFETCH-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX1210-SPREFETCH-SDAG-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-SDAG-NEXT:    s_endpgm
;
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-GISEL-LABEL: prefetch_inst_sgpr_min_offset:
; GFX1210-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0xff800000
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, -1
; GFX1210-SPREFETCH-GISEL-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-GISEL-NEXT:    s_endpgm
;
...
; GFX1210-LABEL: prefetch_inst_sgpr_too_large_offset:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-SDAG-LABEL: prefetch_inst_sgpr_too_large_offset:
; GFX1210-SPREFETCH-SDAG:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-SDAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], 0x800000
; GFX1210-SPREFETCH-SDAG-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
; GFX1210-SPREFETCH-SDAG-NEXT:    s_endpgm
...
; SPREFETCH-SDAG-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-GISEL-LABEL: prefetch_inst_sgpr_too_large_offset:
; GFX1210-SPREFETCH-GISEL:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_u32 s0, s0, 0x800000
; GFX1210-SPREFETCH-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, 0
; GFX1210-SPREFETCH-GISEL-NEXT:    s_prefetch_inst s[0:1], 0x0, null, 0
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_flat_dev:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    flat_prefetch_b8 v[0:1] scope:SCOPE_DEV
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_flat_se:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_flat_offset:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    flat_prefetch_b8 v[0:1] offset:512 scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_global_offset:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v[0:1], off offset:512 scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_global_saddr:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_vgpr_global_saddr_offset:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[0:1] offset:128 scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_sgpr_flat_force_vector:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-SPREFETCH-NEXT:    flat_prefetch_b8 v0, s[0:1] scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_sgpr_global_force_vector:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[0:1] scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
...
; GFX1210-NEXT:    s_endpgm
;
; GFX1210-SPREFETCH-LABEL: prefetch_data_sgpr_global_saddr_force_vector:
; GFX1210-SPREFETCH:       ; %bb.0: ; %entry
; GFX1210-SPREFETCH-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-SPREFETCH-NEXT:    global_prefetch_b8 v0, s[0:1] offset:1024 scope:SCOPE_SYS
; GFX1210-SPREFETCH-NEXT:    s_endpgm
;
