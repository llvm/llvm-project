...
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], 1.0
...
; GFX1251-LABEL: test_wmma_f32_16x16x32_f16_non_splat:
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_dual_mov_b32 v18, 1.0 :: v_dual_mov_b32 v20, 2.0
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v21, v18
; GFX1251-NEXT:    v_dual_mov_b32 v22, v18 :: v_dual_mov_b32 v23, v18
; GFX1251-NEXT:    v_dual_mov_b32 v24, v18 :: v_dual_mov_b32 v25, v18
; GFX1251-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], v[18:25]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1251-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1251-NEXT:    s_endpgm
...
; GFX1251-LABEL: test_wmma_f32_16x16x32_f16_non_inlineable:
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_mov_b32_e32 v18, 0x40400000
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v20, v18
; GFX1251-NEXT:    v_dual_mov_b32 v21, v18 :: v_dual_mov_b32 v22, v18
; GFX1251-NEXT:    v_dual_mov_b32 v23, v18 :: v_dual_mov_b32 v24, v18
; GFX1251-NEXT:    v_mov_b32_e32 v25, v18
; GFX1251-NEXT:    v_wmma_f32_16x16x32_f16 v[18:25], v[0:7], v[8:15], v[18:25]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_store_b128 v[16:17], v[22:25], off offset:16
; GFX1251-NEXT:    global_store_b128 v[16:17], v[18:21], off
...
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], 1.0
; GFX1251-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1251-NEXT:    s_endpgm
;
...
; GFX1251-LABEL: test_wmma_f16_16x16x32_f16_non_splat:
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_mov_b32_e32 v18, 0x3c003c00
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v19, 0x3c004000 :: v_dual_mov_b32 v20, v18
; GFX1251-NEXT:    v_mov_b32_e32 v21, v18
; GFX1251-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], v[18:21]
; GFX1251-NEXT:    global_store_b128 v[16:17], v[18:21], off
; GFX1251-NEXT:    s_endpgm
;
...
; GFX1251-LABEL: test_wmma_f16_16x16x32_f16_non_inlineable:
; GFX1251:       ; %bb.0: ; %bb
; GFX1251-NEXT:    v_mov_b32_e32 v18, 0x42004200
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1251-NEXT:    v_dual_mov_b32 v19, v18 :: v_dual_mov_b32 v20, v18
; GFX1251-NEXT:    v_mov_b32_e32 v21, v18
; GFX1251-NEXT:    v_wmma_f16_16x16x32_f16 v[18:21], v[0:7], v[8:15], v[18:21]
