...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GCN,GFX11,GFX11-GISEL-TRUE16 %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GCN,GFX11,GFX11-GISEL-FAKE16 %s
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v2f16_v2i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
...
; GFX9-NEXT:    v_ldexp_f16_sdwa v2, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v1
...
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v1, v1, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v2, v3, v2
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v0, v1
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v2
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v2f16_v2i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_ldexp_f16_sdwa v2, v0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v1
; GFX9-NEXT:    v_pack_b32_f16 v0, v0, v2
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v3f16_v3i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v5, 0x7fff
; GFX9-NEXT:    v_med3_i32 v3, v3, s4, v5
; GFX9-NEXT:    v_med3_i32 v2, v2, s4, v5
; GFX9-NEXT:    v_med3_i32 v4, v4, s4, v5
; GFX9-NEXT:    v_ldexp_f16_sdwa v3, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v2
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v1, v4
...
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v0
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v3, v5, v3
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v0, v2
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v2, v4, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v3
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v1, v1, v2
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v3f16_v3i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_ldexp_f16_sdwa v4, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v2
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v1, v3
...
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v2, v5, v4
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v2
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v4f16_v4i32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_movk_i32 s4, 0x8000
; GFX9-NEXT:    v_mov_b32_e32 v6, 0x7fff
; GFX9-NEXT:    v_med3_i32 v5, v5, s4, v6
; GFX9-NEXT:    v_med3_i32 v4, v4, s4, v6
; GFX9-NEXT:    v_med3_i32 v3, v3, s4, v6
; GFX9-NEXT:    v_med3_i32 v2, v2, s4, v6
; GFX9-NEXT:    v_ldexp_f16_sdwa v5, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v1, v4
; GFX9-NEXT:    v_ldexp_f16_sdwa v3, v0, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v2
; GFX9-NEXT:    v_pack_b32_f16 v0, v0, v3
; GFX9-NEXT:    v_pack_b32_f16 v1, v1, v5
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    s_movk_i32 s0, 0x8000
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v5, v5, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v3, v3, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v0
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v2, v2, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_med3_i32 v4, v4, s0, 0x7fff
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v5, v6, v5
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v3, v7, v3
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v0, v2
...
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v1, v1, v5
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_ldexp_v4f16_v4i16:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_ldexp_f16_sdwa v4, v1, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_ldexp_f16_sdwa v5, v0, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX9-NEXT:    v_ldexp_f16_e32 v1, v1, v3
; GFX9-NEXT:    v_ldexp_f16_e32 v0, v0, v2
...
; GFX11-GISEL-FAKE16:       ; %bb.0:
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v3
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v2
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v0
; GFX11-GISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v1, v1, v3
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v0, v0, v2
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v2, v6, v5
; GFX11-GISEL-FAKE16-NEXT:    v_ldexp_f16_e32 v3, v7, v4
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v2
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v1, v1, v3
; GFX11-GISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
