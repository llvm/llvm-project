...
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_opsel_hi_a_clamp:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_lshlrev_b32_e32 v3, 16, v0
; GFX950-GISEL:    v_or_b32_sdwa v0, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_opsel_hi_b_clamp:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x5040100
; GFX950-SDAG:    v_perm_b32 v1, v1, v1, s0
; GFX950-SDAG:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_opsel_hi_b_clamp:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_lshlrev_b32_e32 v3, 16, v1
; GFX950-GISEL:    v_or_b32_sdwa v1, v3, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_inline_literal_a_clamp:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x40004000
; GFX950-SDAG:    v_dot2_f32_bf16 v0, s0, v0, v1 clamp
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_inline_literal_a_clamp:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_mov_b32_e32 v2, 0x40004000
; GFX950-GISEL:    v_dot2_f32_bf16 v0, v2, v0, v1 clamp
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_inline_literal_b_clamp:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x40004000
; GFX950-SDAG:    v_dot2_f32_bf16 v0, v0, s0, v1 clamp
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_inline_literal_b_clamp:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_mov_b32_e32 v2, 0x40004000
; GFX950-GISEL:    v_dot2_f32_bf16 v0, v0, v2, v1 clamp
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_neg_a_lo_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    v_xor_b32_e32 v6, 0x8000, v0
; GFX950-SDAG:    s_mov_b32 s0, 0xffff
; GFX950-SDAG:    v_bfi_b32 v0, s0, v6, v0
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_neg_a_lo_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_xor_b32_e32 v6, 0x8000, v0
; GFX950-GISEL:    v_bfe_u32 v6, v6, 0, 16
; GFX950-GISEL:    v_mov_b32_e32 v7, 0xffff0000
; GFX950-GISEL:    v_and_or_b32 v0, v0, v7, v6
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-GISEL:    v_add_f32_e32 v0, v2, v5
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_neg_a_hi_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x8000
; GFX950-SDAG:    v_xor_b32_sdwa v6, s0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX950-SDAG:    s_mov_b32 s0, 0x5040100
; GFX950-SDAG:    v_perm_b32 v0, v6, v0, s0
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_neg_a_hi_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    s_mov_b32 s0, 0x8000
; GFX950-GISEL:    v_xor_b32_sdwa v6, s0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX950-GISEL:    v_mov_b32_e32 v7, 16
; GFX950-GISEL:    v_lshlrev_b32_sdwa v6, v7, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_mov_b32_e32 v7, 0xffff
; GFX950-GISEL:    v_and_or_b32 v0, v0, v7, v6
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-GISEL:    v_add_f32_e32 v0, v2, v5
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_neg_b_lo_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    v_xor_b32_e32 v6, 0x8000, v1
; GFX950-SDAG:    s_mov_b32 s0, 0xffff
; GFX950-SDAG:    v_bfi_b32 v1, s0, v6, v1
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_neg_b_lo_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_xor_b32_e32 v6, 0x8000, v1
; GFX950-GISEL:    v_bfe_u32 v6, v6, 0, 16
; GFX950-GISEL:    v_mov_b32_e32 v7, 0xffff0000
; GFX950-GISEL:    v_and_or_b32 v1, v1, v7, v6
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-GISEL:    v_add_f32_e32 v0, v2, v5
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_neg_b_hi_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x8000
; GFX950-SDAG:    v_xor_b32_sdwa v6, s0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX950-SDAG:    s_mov_b32 s0, 0x5040100
; GFX950-SDAG:    v_perm_b32 v1, v6, v1, s0
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_neg_b_hi_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    s_mov_b32 s0, 0x8000
; GFX950-GISEL:    v_xor_b32_sdwa v6, s0, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX950-GISEL:    v_mov_b32_e32 v7, 16
; GFX950-GISEL:    v_lshlrev_b32_sdwa v6, v7, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_mov_b32_e32 v7, 0xffff
; GFX950-GISEL:    v_and_or_b32 v1, v1, v7, v6
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_opsel_hi_a_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x5040100
; GFX950-SDAG:    v_perm_b32 v0, v0, v0, s0
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
...
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_opsel_hi_a_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_lshlrev_b32_e32 v6, 16, v0
; GFX950-GISEL:    v_or_b32_sdwa v0, v6, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-GISEL:    v_add_f32_e32 v0, v2, v5
;
...
; GFX950-SDAG-LABEL: v_fdot2_f32_bf16_opsel_hi_b_dual:
; GFX950-SDAG:  ; %bb.0:
; GFX950-SDAG:    s_mov_b32 s0, 0x5040100
; GFX950-SDAG:    v_perm_b32 v1, v1, v1, s0
; GFX950-SDAG:    v_dot2c_f32_bf16_e32 v2, v0, v1
...
; GFX950-SDAG:    v_add_f32_e32 v0, v2, v5
;
; GFX950-GISEL-LABEL: v_fdot2_f32_bf16_opsel_hi_b_dual:
; GFX950-GISEL:  ; %bb.0:
; GFX950-GISEL:    v_lshlrev_b32_e32 v6, 16, v1
; GFX950-GISEL:    v_or_b32_sdwa v1, v6, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950-GISEL:    v_dot2c_f32_bf16_e32 v5, v3, v4
; GFX950-GISEL:    v_add_f32_e32 v0, v2, v5
;
