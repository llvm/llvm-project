...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.00--amdpal -stop-after=finalize-isel < %s | FileCheck --check-prefix=DAGISEL %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.00--amdpal -stop-after=finalize-isel < %s | FileCheck --check-prefix=GISEL %s
...
define amdgpu_cs void @call(<8 x i32> %x, ptr %p) {
  ...
  ; DAGISEL-NEXT:   $sgpr30_31 = SI_CALL killed [[REG_SEQUENCE1]], @callee, csr_amdgpu_si_gfx, implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3, implicit $vgpr4, implicit $vgpr5, implicit $vgpr6, implicit $vgpr7, implicit-def $vgpr0
  ...
  ; GISEL-NEXT:   $sgpr30_31 = SI_CALL [[REG_SEQUENCE1]], @callee, csr_amdgpu_si_gfx, implicit $vgpr0, implicit $vgpr1, implicit $vgpr2, implicit $vgpr3, implicit $vgpr4, implicit $vgpr5, implicit $vgpr6, implicit $vgpr7, implicit-def $vgpr0
