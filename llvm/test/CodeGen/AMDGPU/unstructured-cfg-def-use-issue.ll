...
; SI-OPT-NEXT:    br i1 [[TMP1]], label [[BB6:%.*]], label [[BB12]]
; SI-OPT:       bb12:
...
; SI-OPT-NEXT:    br i1 [[TMP4]], label [[BB10:%.*]], label [[BB1]]
; SI-OPT:       bb10:
...
;.
; SI-OPT: attributes #[[ATTR0:[0-9]+]] = { nocallback nofree nosync nounwind speculatable willreturn memory(none) }
; SI-OPT: attributes #[[ATTR1:[0-9]+]] = { nocallback nofree nounwind willreturn }
; SI-OPT: attributes #[[ATTR2:[0-9]+]] = { nocallback nofree nounwind willreturn memory(none) }
; SI-OPT: attributes #[[ATTR3:[0-9]+]] = { convergent nocallback nofree nounwind willreturn }
;.
; SI-OPT: [[META0:![0-9]+]] = !{i32 1, !"amdhsa_code_object_version", i32 500}
;.
