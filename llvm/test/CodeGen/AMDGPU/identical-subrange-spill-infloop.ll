...
; CHECK-NEXT:    s_load_dwordx4 s[52:55], s[4:5], 0x0
; CHECK-NEXT:    s_load_dwordx8 s[24:31], s[20:21], 0x30
; CHECK-NEXT:    s_load_dwordx16 s[36:51], s[20:21], 0xf0
; CHECK-NEXT:    ; kill: killed $sgpr4_sgpr5
; CHECK-NEXT:    s_load_dwordx16 s[56:71], s[20:21], 0x130
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    s_load_dwordx16 s[4:19], s[20:21], 0x1f0
...
; CHECK-NEXT:    s_load_dwordx16 s[4:19], s[20:21], 0x2f0
...
; CHECK-NEXT:    image_sample_lz v4, v[2:3], s[56:63], s[20:23] dmask:0x1
; CHECK-NEXT:    s_mov_b64 s[58:59], s[22:23]
; CHECK-NEXT:    s_mov_b64 s[56:57], s[20:21]
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[20:21], 1, v5
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_mul_f32_e32 v0, v4, v1
; CHECK-NEXT:    s_and_saveexec_b64 s[22:23], s[20:21]
; CHECK-NEXT:    s_xor_b64 s[22:23], exec, s[22:23]
; CHECK-NEXT:    s_cbranch_execz .LBB0_3
; CHECK-NEXT:  ; %bb.1: ; %bb48
; CHECK-NEXT:    image_sample_lz v3, v[2:3], s[44:51], s[56:59] dmask:0x1
; CHECK-NEXT:    v_mov_b32_e32 v1, v2
; CHECK-NEXT:    s_and_b64 vcc, exec, -1
; CHECK-NEXT:  .LBB0_2: ; %bb50
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    s_mov_b64 s[62:63], s[58:59]
; CHECK-NEXT:    s_mov_b64 s[60:61], s[56:57]
...
; CHECK-NEXT:    image_sample_lz v4, v[1:2], s[52:59], s[28:31] dmask:0x1
; CHECK-NEXT:    s_mov_b64 s[56:57], s[60:61]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    image_sample_lz v1, v[1:2], s[12:19], s[60:63] dmask:0x1
; CHECK-NEXT:    s_mov_b64 s[58:59], s[62:63]
...
; CHECK-NEXT:    s_andn2_saveexec_b64 s[28:29], s[22:23]
; CHECK-NEXT:    s_cbranch_execz .LBB0_10
; CHECK-NEXT:  ; %bb.4: ; %bb32
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_and_saveexec_b64 s[12:13], s[20:21]
...
; CHECK-NEXT:    image_sample_lz v1, v[2:3], s[36:43], s[16:19] dmask:0x1
; CHECK-NEXT:    image_sample_lz v0, v[2:3], s[64:71], s[24:27] dmask:0x1
; CHECK-NEXT:    v_mov_b32_e32 v2, 0
; CHECK-NEXT:    v_mov_b32_e32 v3, v2
...
; CHECK-NEXT:    s_or_saveexec_b64 s[40:41], s[12:13]
; CHECK-NEXT:    v_readlane_b32 s12, v7, 0
; CHECK-NEXT:    v_readlane_b32 s13, v7, 1
; CHECK-NEXT:    v_readlane_b32 s14, v7, 2
; CHECK-NEXT:    v_readlane_b32 s15, v7, 3
; CHECK-NEXT:    v_readlane_b32 s16, v7, 4
; CHECK-NEXT:    v_readlane_b32 s17, v7, 5
; CHECK-NEXT:    v_readlane_b32 s18, v7, 6
; CHECK-NEXT:    v_readlane_b32 s19, v7, 7
; CHECK-NEXT:    v_readlane_b32 s20, v7, 8
; CHECK-NEXT:    v_readlane_b32 s21, v7, 9
; CHECK-NEXT:    v_readlane_b32 s22, v7, 10
; CHECK-NEXT:    v_readlane_b32 s23, v7, 11
; CHECK-NEXT:    v_readlane_b32 s24, v7, 12
; CHECK-NEXT:    v_readlane_b32 s25, v7, 13
; CHECK-NEXT:    v_readlane_b32 s26, v7, 14
; CHECK-NEXT:    v_readlane_b32 s27, v7, 15
; CHECK-NEXT:    s_xor_b64 exec, exec, s[40:41]
; CHECK-NEXT:    s_cbranch_execz .LBB0_9
; CHECK-NEXT:  ; %bb.7: ; %bb33.preheader
; CHECK-NEXT:    s_mov_b32 s20, 0
; CHECK-NEXT:    s_mov_b32 s24, s20
; CHECK-NEXT:    s_mov_b32 s25, s20
