...
; CHECK-NEXT:    v_writelane_b32 v6, s40, 8
; CHECK-NEXT:    v_writelane_b32 v6, s41, 9
; CHECK-NEXT:    v_writelane_b32 v6, s42, 10
; CHECK-NEXT:    v_writelane_b32 v6, s43, 11
; CHECK-NEXT:    v_writelane_b32 v6, s44, 12
; CHECK-NEXT:    v_writelane_b32 v6, s45, 13
; CHECK-NEXT:    v_writelane_b32 v6, s46, 14
; CHECK-NEXT:    v_writelane_b32 v6, s47, 15
; CHECK-NEXT:    v_writelane_b32 v6, s48, 16
; CHECK-NEXT:    v_writelane_b32 v6, s49, 17
; CHECK-NEXT:    v_writelane_b32 v6, s50, 18
; CHECK-NEXT:    s_getpc_b64 s[8:9]
; CHECK-NEXT:    s_mov_b64 s[12:13], 0
; CHECK-NEXT:    v_writelane_b32 v6, s51, 19
...
; CHECK-NEXT:    v_writelane_b32 v6, s52, 20
; CHECK-NEXT:    v_writelane_b32 v6, s53, 21
; CHECK-NEXT:    v_writelane_b32 v6, s54, 22
; CHECK-NEXT:    v_writelane_b32 v6, s55, 23
; CHECK-NEXT:    ; implicit-def: $vgpr7 : SGPR spill to VGPR lane
; CHECK-NEXT:    v_writelane_b32 v6, s56, 24
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v7, s36, 0
; CHECK-NEXT:    v_writelane_b32 v6, s57, 25
; CHECK-NEXT:    v_writelane_b32 v7, s37, 1
; CHECK-NEXT:    v_writelane_b32 v6, s58, 26
; CHECK-NEXT:    v_writelane_b32 v7, s38, 2
; CHECK-NEXT:    v_writelane_b32 v6, s59, 27
; CHECK-NEXT:    v_writelane_b32 v7, s39, 3
; CHECK-NEXT:    v_writelane_b32 v6, s60, 28
; CHECK-NEXT:    v_writelane_b32 v7, s40, 4
; CHECK-NEXT:    v_writelane_b32 v6, s61, 29
; CHECK-NEXT:    v_writelane_b32 v7, s41, 5
; CHECK-NEXT:    v_writelane_b32 v6, s62, 30
; CHECK-NEXT:    v_writelane_b32 v7, s42, 6
; CHECK-NEXT:    v_writelane_b32 v6, s63, 31
; CHECK-NEXT:    v_writelane_b32 v7, s43, 7
; CHECK-NEXT:    v_writelane_b32 v6, s64, 32
; CHECK-NEXT:    v_writelane_b32 v7, s44, 8
; CHECK-NEXT:    v_writelane_b32 v6, s65, 33
; CHECK-NEXT:    v_writelane_b32 v7, s45, 9
; CHECK-NEXT:    v_writelane_b32 v6, s66, 34
; CHECK-NEXT:    s_movk_i32 s6, 0x130
; CHECK-NEXT:    s_mov_b32 s7, s8
; CHECK-NEXT:    v_writelane_b32 v7, s46, 10
; CHECK-NEXT:    v_writelane_b32 v6, s67, 35
...
; CHECK-NEXT:    v_writelane_b32 v6, s68, 36
; CHECK-NEXT:    v_writelane_b32 v7, s65, 29
; CHECK-NEXT:    v_writelane_b32 v6, s69, 37
...
; CHECK-NEXT:    v_writelane_b32 v6, s70, 38
; CHECK-NEXT:    s_xor_b64 s[34:35], vcc, -1
; CHECK-NEXT:    v_writelane_b32 v6, s71, 39
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_andn2_saveexec_b64 s[24:25], s[68:69]
...
; CHECK-NEXT:    v_readlane_b32 s18, v7, 14
; CHECK-NEXT:    v_readlane_b32 s19, v7, 15
; CHECK-NEXT:    image_sample_lz v2, v[0:1], s[4:11], s[28:31] dmask:0x1
...
; CHECK-NEXT:    buffer_store_dwordx3 v[2:4], off, s[28:31], 0
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    buffer_store_dwordx4 v[0:3], off, s[28:31], 0
...
; CHECK-NEXT:    v_readlane_b32 s71, v6, 39
; CHECK-NEXT:    v_readlane_b32 s70, v6, 38
; CHECK-NEXT:    v_readlane_b32 s69, v6, 37
; CHECK-NEXT:    v_readlane_b32 s68, v6, 36
; CHECK-NEXT:    v_readlane_b32 s67, v6, 35
; CHECK-NEXT:    v_readlane_b32 s66, v6, 34
; CHECK-NEXT:    v_readlane_b32 s65, v6, 33
; CHECK-NEXT:    v_readlane_b32 s64, v6, 32
; CHECK-NEXT:    v_readlane_b32 s63, v6, 31
; CHECK-NEXT:    v_readlane_b32 s62, v6, 30
; CHECK-NEXT:    v_readlane_b32 s61, v6, 29
; CHECK-NEXT:    v_readlane_b32 s60, v6, 28
; CHECK-NEXT:    v_readlane_b32 s59, v6, 27
; CHECK-NEXT:    v_readlane_b32 s58, v6, 26
; CHECK-NEXT:    v_readlane_b32 s57, v6, 25
; CHECK-NEXT:    v_readlane_b32 s56, v6, 24
; CHECK-NEXT:    v_readlane_b32 s55, v6, 23
; CHECK-NEXT:    v_readlane_b32 s54, v6, 22
; CHECK-NEXT:    v_readlane_b32 s53, v6, 21
; CHECK-NEXT:    v_readlane_b32 s52, v6, 20
; CHECK-NEXT:    v_readlane_b32 s51, v6, 19
; CHECK-NEXT:    v_readlane_b32 s50, v6, 18
; CHECK-NEXT:    v_readlane_b32 s49, v6, 17
; CHECK-NEXT:    v_readlane_b32 s48, v6, 16
; CHECK-NEXT:    v_readlane_b32 s47, v6, 15
; CHECK-NEXT:    v_readlane_b32 s46, v6, 14
; CHECK-NEXT:    v_readlane_b32 s45, v6, 13
; CHECK-NEXT:    v_readlane_b32 s44, v6, 12
; CHECK-NEXT:    v_readlane_b32 s43, v6, 11
; CHECK-NEXT:    v_readlane_b32 s42, v6, 10
; CHECK-NEXT:    v_readlane_b32 s41, v6, 9
; CHECK-NEXT:    v_readlane_b32 s40, v6, 8
