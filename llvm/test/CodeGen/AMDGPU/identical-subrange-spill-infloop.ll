...
; CHECK-NEXT:    v_writelane_b32 v1, s36, 0
; CHECK-NEXT:    ; implicit-def: $vgpr4 : SGPR spill to VGPR lane
; CHECK-NEXT:    ; implicit-def: $vgpr5 : SGPR spill to VGPR lane
; CHECK-NEXT:    v_writelane_b32 v1, s37, 1
; CHECK-NEXT:    v_writelane_b32 v1, s38, 2
; CHECK-NEXT:    v_writelane_b32 v1, s39, 3
; CHECK-NEXT:    v_writelane_b32 v1, s40, 4
; CHECK-NEXT:    v_writelane_b32 v1, s41, 5
; CHECK-NEXT:    v_writelane_b32 v1, s42, 6
; CHECK-NEXT:    v_writelane_b32 v1, s43, 7
; CHECK-NEXT:    v_writelane_b32 v1, s44, 8
; CHECK-NEXT:    v_writelane_b32 v1, s45, 9
; CHECK-NEXT:    v_writelane_b32 v1, s46, 10
; CHECK-NEXT:    v_writelane_b32 v1, s47, 11
; CHECK-NEXT:    v_writelane_b32 v1, s48, 12
; CHECK-NEXT:    v_writelane_b32 v1, s49, 13
; CHECK-NEXT:    v_writelane_b32 v1, s50, 14
; CHECK-NEXT:    v_writelane_b32 v1, s51, 15
; CHECK-NEXT:    v_writelane_b32 v1, s52, 16
; CHECK-NEXT:    v_writelane_b32 v1, s53, 17
; CHECK-NEXT:    v_writelane_b32 v1, s54, 18
; CHECK-NEXT:    v_writelane_b32 v1, s55, 19
; CHECK-NEXT:    v_writelane_b32 v1, s56, 20
; CHECK-NEXT:    v_writelane_b32 v1, s57, 21
; CHECK-NEXT:    v_writelane_b32 v1, s58, 22
; CHECK-NEXT:    v_writelane_b32 v1, s59, 23
; CHECK-NEXT:    v_writelane_b32 v1, s60, 24
; CHECK-NEXT:    v_writelane_b32 v1, s61, 25
; CHECK-NEXT:    v_writelane_b32 v1, s62, 26
; CHECK-NEXT:    v_writelane_b32 v1, s63, 27
; CHECK-NEXT:    v_writelane_b32 v1, s64, 28
; CHECK-NEXT:    v_writelane_b32 v1, s65, 29
; CHECK-NEXT:    v_writelane_b32 v1, s66, 30
; CHECK-NEXT:    v_writelane_b32 v1, s67, 31
; CHECK-NEXT:    v_writelane_b32 v1, s30, 32
; CHECK-NEXT:    v_writelane_b32 v1, s31, 33
...
; CHECK-NEXT:    v_readlane_b32 s30, v1, 32
; CHECK-NEXT:    v_readlane_b32 s31, v1, 33
; CHECK-NEXT:    v_readlane_b32 s67, v1, 31
; CHECK-NEXT:    v_readlane_b32 s66, v1, 30
; CHECK-NEXT:    v_readlane_b32 s65, v1, 29
; CHECK-NEXT:    v_readlane_b32 s64, v1, 28
; CHECK-NEXT:    v_readlane_b32 s63, v1, 27
; CHECK-NEXT:    v_readlane_b32 s62, v1, 26
; CHECK-NEXT:    v_readlane_b32 s61, v1, 25
; CHECK-NEXT:    v_readlane_b32 s60, v1, 24
; CHECK-NEXT:    v_readlane_b32 s59, v1, 23
; CHECK-NEXT:    v_readlane_b32 s58, v1, 22
; CHECK-NEXT:    v_readlane_b32 s57, v1, 21
; CHECK-NEXT:    v_readlane_b32 s56, v1, 20
; CHECK-NEXT:    v_readlane_b32 s55, v1, 19
; CHECK-NEXT:    v_readlane_b32 s54, v1, 18
; CHECK-NEXT:    v_readlane_b32 s53, v1, 17
; CHECK-NEXT:    v_readlane_b32 s52, v1, 16
; CHECK-NEXT:    v_readlane_b32 s51, v1, 15
; CHECK-NEXT:    v_readlane_b32 s50, v1, 14
; CHECK-NEXT:    v_readlane_b32 s49, v1, 13
; CHECK-NEXT:    v_readlane_b32 s48, v1, 12
; CHECK-NEXT:    v_readlane_b32 s47, v1, 11
; CHECK-NEXT:    v_readlane_b32 s46, v1, 10
; CHECK-NEXT:    v_readlane_b32 s45, v1, 9
; CHECK-NEXT:    v_readlane_b32 s44, v1, 8
; CHECK-NEXT:    v_readlane_b32 s43, v1, 7
; CHECK-NEXT:    v_readlane_b32 s42, v1, 6
; CHECK-NEXT:    v_readlane_b32 s41, v1, 5
; CHECK-NEXT:    v_readlane_b32 s40, v1, 4
; CHECK-NEXT:    v_readlane_b32 s39, v1, 3
; CHECK-NEXT:    v_readlane_b32 s38, v1, 2
; CHECK-NEXT:    v_readlane_b32 s37, v1, 1
; CHECK-NEXT:    v_readlane_b32 s36, v1, 0
