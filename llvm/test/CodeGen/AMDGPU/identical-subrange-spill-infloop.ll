...
; CHECK-NEXT:    v_writelane_b32 v8, s40, 4
; CHECK-NEXT:    v_writelane_b32 v8, s41, 5
; CHECK-NEXT:    v_writelane_b32 v8, s42, 6
; CHECK-NEXT:    v_writelane_b32 v8, s43, 7
; CHECK-NEXT:    v_writelane_b32 v8, s44, 8
; CHECK-NEXT:    v_writelane_b32 v8, s45, 9
; CHECK-NEXT:    v_writelane_b32 v8, s46, 10
; CHECK-NEXT:    v_writelane_b32 v8, s47, 11
; CHECK-NEXT:    v_writelane_b32 v8, s48, 12
; CHECK-NEXT:    v_writelane_b32 v8, s49, 13
...
; CHECK-NEXT:    v_readlane_b32 s30, v8, 32
; CHECK-NEXT:    v_readlane_b32 s31, v8, 33
...
; CHECK-NEXT:    v_readlane_b32 s51, v8, 15
; CHECK-NEXT:    v_readlane_b32 s50, v8, 14
; CHECK-NEXT:    v_readlane_b32 s49, v8, 13
; CHECK-NEXT:    v_readlane_b32 s48, v8, 12
; CHECK-NEXT:    v_readlane_b32 s47, v8, 11
; CHECK-NEXT:    v_readlane_b32 s46, v8, 10
; CHECK-NEXT:    v_readlane_b32 s45, v8, 9
; CHECK-NEXT:    v_readlane_b32 s44, v8, 8
; CHECK-NEXT:    v_readlane_b32 s43, v8, 7
; CHECK-NEXT:    v_readlane_b32 s42, v8, 6
; CHECK-NEXT:    v_readlane_b32 s41, v8, 5
; CHECK-NEXT:    v_readlane_b32 s40, v8, 4
