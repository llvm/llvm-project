...
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1210 < %s | FileCheck -check-prefix=GFX1210-PAL %s
; RUN: llc -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1210 < %s | FileCheck -check-prefix=GFX1210-MESA %s
...
; GFX1210-PAL: '0x2c0b (SPI_SHADER_PGM_RSRC2_PS)': 0x200

; GFX1210-MESA: .long 45100
; GFX1210-MESA-NEXT: .long 512
