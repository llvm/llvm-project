...
; GFX9-O0-NEXT:    ; implicit-def: $sgpr40_41
...
; GFX9-O0-NEXT:    ; implicit-def: $sgpr36_37
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    ; implicit-def: $sgpr34_35
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
...
; GFX9-O0-NEXT:    ; implicit-def: $sgpr42_43
...
; GFX9-O0-NEXT:    ; kill: def $sgpr34 killed $sgpr34 killed $sgpr34_35
; GFX9-O0-NEXT:    ; kill: def $sgpr36 killed $sgpr36 killed $sgpr36_37
; GFX9-O0-NEXT:    ; implicit-def: $sgpr38_39
; GFX9-O0-NEXT:    v_mov_b32_e32 v0, s34
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
...
; GFX9-O0-NEXT:    ; kill: def $sgpr44 killed $sgpr44 def $sgpr44_45
; GFX9-O0-NEXT:    s_mov_b32 s45, s35
; GFX9-O0-NEXT:    s_mov_b32 s42, s45
; GFX9-O0-NEXT:    ; implicit-def: $sgpr46_47
...
; GFX9-O0-NEXT:    ; implicit-def: $sgpr44_45
