...
; GFX9-O0-NEXT:    s_mov_b32 s43, s39
...
; GFX9-O0-NEXT:    ; kill: def $sgpr38_sgpr39 killed $sgpr34_sgpr35
; GFX9-O0-NEXT:    s_mov_b32 s40, s35
; GFX9-O0-NEXT:    s_mov_b64 s[38:39], 0
; GFX9-O0-NEXT:    s_mov_b32 s41, s39
...
; GFX9-O3-NEXT:    s_mov_b64 exec, -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, -1, v7, s[34:35]
; GFX9-O3-NEXT:    v_bfrev_b32_e32 v4, -2
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v4, v10
; GFX9-O3-NEXT:    s_mov_b64 exec, -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v3, -1, v9, s[34:35]
; GFX9-O3-NEXT:    v_bfrev_b32_e32 v6, -2
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O3-NEXT:    v_mov_b32_e32 v6, v12
; GFX9-O3-NEXT:    s_mov_b64 exec, -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v5, -1, v11, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    v_mov_b32_e32 v32, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, -1
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    v_mov_b32_e32 v33, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, -1
