...
@ls0 = external addrspace(10) global i32, align 4
@ls1 = external addrspace(10) global i32, align 4
...
; CHECK-NEXT:    s_mul_i32 s4, s3, 4
; CHECK-NEXT:    s_mul_i32 s33, s3, s2
; CHECK-NEXT:    s_add_co_u32 s4, s4, 2
...
; CHECK-NEXT:    s_lshl_b32 s5, ttmp9, 7
...
; KERNEL-NEXT:         .amdhsa_next_free_vgpr 10
