...
; GFX1251-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1251-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1251-NEXT:    v_lshlrev_b32_e32 v20, 7, v0
; GFX1251-NEXT:    s_wait_kmcnt 0x0
; GFX1251-NEXT:    s_clause 0xd
; GFX1251-NEXT:    global_load_b128 v[8:11], v20, s[2:3] offset:240
; GFX1251-NEXT:    global_load_b128 v[16:19], v20, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[22:25], v20, s[2:3] offset:96
; GFX1251-NEXT:    global_load_b128 v[26:29], v20, s[2:3] offset:224
; GFX1251-NEXT:    global_load_b128 v[30:33], v20, s[2:3] offset:80
; GFX1251-NEXT:    global_load_b128 v[34:37], v20, s[2:3] offset:208
; GFX1251-NEXT:    global_load_b128 v[38:41], v20, s[2:3] offset:48
; GFX1251-NEXT:    global_load_b128 v[12:15], v20, s[2:3] offset:32
; GFX1251-NEXT:    global_load_b128 v[4:7], v20, s[2:3] offset:16
; GFX1251-NEXT:    global_load_b128 v[0:3], v20, s[2:3]
; GFX1251-NEXT:    global_load_b128 v[42:45], v20, s[2:3] offset:64
; GFX1251-NEXT:    global_load_b128 v[46:49], v20, s[2:3] offset:192
; GFX1251-NEXT:    global_load_b128 v[50:53], v20, s[2:3] offset:176
; GFX1251-NEXT:    global_load_b128 v[54:57], v20, s[2:3] offset:160
; GFX1251-NEXT:    s_wait_loadcnt 0xc
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[10:11], v10, v[18:19]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[8:9], v8, v[16:17]
; GFX1251-NEXT:    s_wait_loadcnt 0xa
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[18:19], v28, v[24:25]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[16:17], v26, v[22:23]
; GFX1251-NEXT:    global_load_b128 v[22:25], v20, s[2:3] offset:144
; GFX1251-NEXT:    s_wait_loadcnt 0x9
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[28:29], v36, v[32:33]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[26:27], v34, v[30:31]
; GFX1251-NEXT:    global_load_b128 v[30:33], v20, s[2:3] offset:128
; GFX1251-NEXT:    s_wait_loadcnt 0x3
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[40:41], v52, v[40:41]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[36:37], v48, v[44:45]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[34:35], v46, v[42:43]
; GFX1251-NEXT:    s_wait_loadcnt 0x2
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[14:15], v56, v[14:15]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[12:13], v54, v[12:13]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[38:39], v50, v[38:39]
; GFX1251-NEXT:    s_wait_loadcnt 0x1
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[6:7], v24, v[6:7]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[4:5], v22, v[4:5]
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[2:3], v32, v[2:3]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[0:1], v30, v[0:1]
; GFX1251-NEXT:    s_clause 0x7
; GFX1251-NEXT:    global_store_b128 v20, v[16:19], s[0:1] offset:96
; GFX1251-NEXT:    global_store_b128 v20, v[8:11], s[0:1] offset:112
; GFX1251-NEXT:    global_store_b128 v20, v[34:37], s[0:1] offset:64
; GFX1251-NEXT:    global_store_b128 v20, v[26:29], s[0:1] offset:80
; GFX1251-NEXT:    global_store_b128 v20, v[12:15], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v20, v[38:41], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v20, v[0:3], s[0:1]
; GFX1251-NEXT:    global_store_b128 v20, v[4:7], s[0:1] offset:16
; GFX1251-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_clause 0x14
; GFX1250-NEXT:    global_load_b128 v[0:3], v32, s[2:3] offset:496
; GFX1250-NEXT:    global_load_b128 v[4:7], v32, s[2:3] offset:240
; GFX1250-NEXT:    global_load_b128 v[8:11], v32, s[2:3] offset:224
; GFX1250-NEXT:    global_load_b128 v[12:15], v32, s[2:3] offset:480
; GFX1250-NEXT:    global_load_b128 v[16:19], v32, s[2:3] offset:464
; GFX1250-NEXT:    global_load_b128 v[20:23], v32, s[2:3] offset:208
; GFX1250-NEXT:    global_load_b128 v[24:27], v32, s[2:3] offset:192
; GFX1250-NEXT:    global_load_b128 v[28:31], v32, s[2:3] offset:448
; GFX1250-NEXT:    global_load_b128 v[34:37], v32, s[2:3] offset:432
; GFX1250-NEXT:    global_load_b128 v[38:41], v32, s[2:3] offset:176
; GFX1250-NEXT:    global_load_b128 v[42:45], v32, s[2:3] offset:160
; GFX1250-NEXT:    global_load_b128 v[46:49], v32, s[2:3] offset:416
; GFX1250-NEXT:    global_load_b128 v[50:53], v32, s[2:3] offset:128
; GFX1250-NEXT:    global_load_b128 v[54:57], v32, s[2:3] offset:144
; GFX1250-NEXT:    global_load_b128 v[58:61], v32, s[2:3] offset:400
; GFX1250-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:384
; GFX1250-NEXT:    global_load_b128 v[66:69], v32, s[2:3] offset:112
; GFX1250-NEXT:    global_load_b128 v[70:73], v32, s[2:3] offset:96
; GFX1250-NEXT:    global_load_b128 v[74:77], v32, s[2:3] offset:368
...
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[14:15], v14, v[10:11]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[12:13], v12, v[8:9]
; GFX1250-NEXT:    s_wait_loadcnt 0xf
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[6:7], v18, v[22:23]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[4:5], v16, v[20:21]
; GFX1250-NEXT:    s_wait_loadcnt 0xd
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[18:19], v30, v[26:27]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[16:17], v28, v[24:25]
; GFX1250-NEXT:    s_wait_loadcnt 0xb
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[10:11], v36, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[8:9], v34, v[38:39]
; GFX1250-NEXT:    s_wait_loadcnt 0x9
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[26:27], v48, v[44:45]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[24:25], v46, v[42:43]
; GFX1250-NEXT:    global_load_b128 v[38:41], v32, s[2:3] offset:64
; GFX1250-NEXT:    s_wait_loadcnt 0x7
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[22:23], v60, v[56:57]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[20:21], v58, v[54:55]
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_load_b128 v[42:45], v32, s[2:3] offset:320
; GFX1250-NEXT:    global_load_b128 v[46:49], v32, s[2:3] offset:304
; GFX1250-NEXT:    s_wait_loadcnt 0x8
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[30:31], v64, v[52:53]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[28:29], v62, v[50:51]
; GFX1250-NEXT:    s_wait_loadcnt 0x5
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[52:53], v76, v[68:69]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[50:51], v74, v[66:67]
; GFX1250-NEXT:    s_clause 0x3
; GFX1250-NEXT:    global_load_b128 v[58:61], v32, s[2:3] offset:48
; GFX1250-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:32
; GFX1250-NEXT:    global_load_b128 v[66:69], v32, s[2:3] offset:288
; GFX1250-NEXT:    global_load_b128 v[34:37], v32, s[2:3] offset:336
; GFX1250-NEXT:    s_wait_loadcnt 0x8
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[56:57], v80, v[72:73]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[54:55], v78, v[70:71]
; GFX1250-NEXT:    s_wait_loadcnt 0x5
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[40:41], v44, v[40:41]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[38:39], v42, v[38:39]
; GFX1250-NEXT:    global_load_b128 v[42:45], v32, s[2:3] offset:272
; GFX1250-NEXT:    s_wait_loadcnt 0x4
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[48:49], v48, v[60:61]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[46:47], v46, v[58:59]
; GFX1250-NEXT:    s_wait_loadcnt 0x2
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[60:61], v68, v[64:65]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[58:59], v66, v[62:63]
; GFX1250-NEXT:    s_clause 0x2
; GFX1250-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:16
; GFX1250-NEXT:    global_load_b128 v[66:69], v32, s[2:3]
; GFX1250-NEXT:    global_load_b128 v[70:73], v32, s[2:3] offset:256
; GFX1250-NEXT:    s_wait_loadcnt 0x4
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[36:37], v36, v[84:85]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[34:35], v34, v[82:83]
; GFX1250-NEXT:    s_wait_loadcnt 0x2
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[44:45], v44, v[64:65]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[42:43], v42, v[62:63]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[64:65], v72, v[68:69]
; GFX1250-NEXT:    v_lshlrev_b64_e32 v[62:63], v70, v[66:67]
; GFX1250-NEXT:    s_clause 0xf
; GFX1250-NEXT:    global_store_b128 v32, v[54:57], s[0:1] offset:96
; GFX1250-NEXT:    global_store_b128 v32, v[50:53], s[0:1] offset:112
; GFX1250-NEXT:    global_store_b128 v32, v[38:41], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v32, v[34:37], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v32, v[58:61], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v32, v[46:49], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v32, v[62:65], s[0:1]
; GFX1250-NEXT:    global_store_b128 v32, v[42:45], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v32, v[12:15], s[0:1] offset:224
; GFX1250-NEXT:    global_store_b128 v32, v[0:3], s[0:1] offset:240
; GFX1250-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:192
; GFX1250-NEXT:    global_store_b128 v32, v[4:7], s[0:1] offset:208
; GFX1250-NEXT:    global_store_b128 v32, v[24:27], s[0:1] offset:160
; GFX1250-NEXT:    global_store_b128 v32, v[8:11], s[0:1] offset:176
; GFX1250-NEXT:    global_store_b128 v32, v[28:31], s[0:1] offset:128
; GFX1250-NEXT:    global_store_b128 v32, v[20:23], s[0:1] offset:144
...
; GFX1251-NEXT:    s_wait_kmcnt 0x0
; GFX1251-NEXT:    s_clause 0x11
; GFX1251-NEXT:    global_load_b128 v[0:3], v32, s[2:3] offset:496
; GFX1251-NEXT:    global_load_b128 v[4:7], v32, s[2:3] offset:240
; GFX1251-NEXT:    global_load_b128 v[8:11], v32, s[2:3] offset:224
; GFX1251-NEXT:    global_load_b128 v[12:15], v32, s[2:3] offset:480
; GFX1251-NEXT:    global_load_b128 v[16:19], v32, s[2:3] offset:464
; GFX1251-NEXT:    global_load_b128 v[34:37], v32, s[2:3] offset:208
; GFX1251-NEXT:    global_load_b128 v[38:41], v32, s[2:3] offset:192
; GFX1251-NEXT:    global_load_b128 v[42:45], v32, s[2:3] offset:448
; GFX1251-NEXT:    global_load_b128 v[46:49], v32, s[2:3] offset:432
; GFX1251-NEXT:    global_load_b128 v[50:53], v32, s[2:3] offset:176
; GFX1251-NEXT:    global_load_b128 v[20:23], v32, s[2:3] offset:160
; GFX1251-NEXT:    global_load_b128 v[24:27], v32, s[2:3] offset:416
; GFX1251-NEXT:    global_load_b128 v[28:31], v32, s[2:3] offset:128
; GFX1251-NEXT:    global_load_b128 v[54:57], v32, s[2:3] offset:144
; GFX1251-NEXT:    global_load_b128 v[58:61], v32, s[2:3] offset:400
; GFX1251-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:384
; GFX1251-NEXT:    global_load_b128 v[66:69], v32, s[2:3] offset:112
; GFX1251-NEXT:    global_load_b128 v[70:73], v32, s[2:3] offset:96
...
; GFX1251-NEXT:    s_wait_loadcnt 0xc
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[6:7], v18, v[36:37]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[4:5], v16, v[34:35]
; GFX1251-NEXT:    s_wait_loadcnt 0xa
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[18:19], v44, v[40:41]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[16:17], v42, v[38:39]
; GFX1251-NEXT:    s_clause 0x3
; GFX1251-NEXT:    global_load_b128 v[38:41], v32, s[2:3] offset:80
; GFX1251-NEXT:    global_load_b128 v[42:45], v32, s[2:3] offset:336
; GFX1251-NEXT:    global_load_b128 v[34:37], v32, s[2:3] offset:368
; GFX1251-NEXT:    global_load_b128 v[74:77], v32, s[2:3] offset:352
; GFX1251-NEXT:    s_wait_loadcnt 0xc
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[14:15], v48, v[52:53]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[12:13], v46, v[50:51]
; GFX1251-NEXT:    s_wait_loadcnt 0xa
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[26:27], v26, v[22:23]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[24:25], v24, v[20:21]
; GFX1251-NEXT:    global_load_b128 v[46:49], v32, s[2:3] offset:64
; GFX1251-NEXT:    s_wait_loadcnt 0x8
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[22:23], v60, v[56:57]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[20:21], v58, v[54:55]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[50:53], v32, s[2:3] offset:320
; GFX1251-NEXT:    global_load_b128 v[54:57], v32, s[2:3] offset:304
; GFX1251-NEXT:    s_wait_loadcnt 0x9
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[30:31], v64, v[30:31]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[28:29], v62, v[28:29]
; GFX1251-NEXT:    s_wait_loadcnt 0x4
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[36:37], v36, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[34:35], v34, v[66:67]
; GFX1251-NEXT:    s_clause 0x1
; GFX1251-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:48
; GFX1251-NEXT:    global_load_b128 v[66:69], v32, s[2:3] offset:32
...
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[60:61], v76, v[72:73]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[58:59], v74, v[70:71]
; GFX1251-NEXT:    s_wait_loadcnt 0x4
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[48:49], v52, v[48:49]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[46:47], v50, v[46:47]
; GFX1251-NEXT:    global_load_b128 v[50:53], v32, s[2:3] offset:272
; GFX1251-NEXT:    s_wait_loadcnt 0x3
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[56:57], v56, v[64:65]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[54:55], v54, v[62:63]
; GFX1251-NEXT:    s_wait_loadcnt 0x1
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[44:45], v44, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[42:43], v42, v[66:67]
; GFX1251-NEXT:    s_clause 0x2
; GFX1251-NEXT:    global_load_b128 v[62:65], v32, s[2:3] offset:16
; GFX1251-NEXT:    global_load_b128 v[66:69], v32, s[2:3]
; GFX1251-NEXT:    global_load_b128 v[70:73], v32, s[2:3] offset:256
; GFX1251-NEXT:    s_wait_loadcnt 0x2
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[52:53], v52, v[64:65]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[50:51], v50, v[62:63]
; GFX1251-NEXT:    s_wait_loadcnt 0x0
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[64:65], v72, v[68:69]
; GFX1251-NEXT:    v_lshlrev_b64_e32 v[62:63], v70, v[66:67]
; GFX1251-NEXT:    s_clause 0xf
; GFX1251-NEXT:    global_store_b128 v32, v[58:61], s[0:1] offset:96
; GFX1251-NEXT:    global_store_b128 v32, v[34:37], s[0:1] offset:112
; GFX1251-NEXT:    global_store_b128 v32, v[46:49], s[0:1] offset:64
; GFX1251-NEXT:    global_store_b128 v32, v[38:41], s[0:1] offset:80
; GFX1251-NEXT:    global_store_b128 v32, v[42:45], s[0:1] offset:32
; GFX1251-NEXT:    global_store_b128 v32, v[54:57], s[0:1] offset:48
; GFX1251-NEXT:    global_store_b128 v32, v[62:65], s[0:1]
; GFX1251-NEXT:    global_store_b128 v32, v[50:53], s[0:1] offset:16
; GFX1251-NEXT:    global_store_b128 v32, v[8:11], s[0:1] offset:224
; GFX1251-NEXT:    global_store_b128 v32, v[0:3], s[0:1] offset:240
; GFX1251-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:192
; GFX1251-NEXT:    global_store_b128 v32, v[4:7], s[0:1] offset:208
; GFX1251-NEXT:    global_store_b128 v32, v[24:27], s[0:1] offset:160
; GFX1251-NEXT:    global_store_b128 v32, v[12:15], s[0:1] offset:176
; GFX1251-NEXT:    global_store_b128 v32, v[28:31], s[0:1] offset:128
; GFX1251-NEXT:    global_store_b128 v32, v[20:23], s[0:1] offset:144
