...
; SI-SDAG-LABEL: v_qsad_pk_u16_u8:
; SI-SDAG:       ; %bb.0:
...
; SI-SDAG-NEXT:    ;;#ASMEND
; SI-SDAG-NEXT:    v_qsad_pk_u16_u8 v[0:1], v[4:5], s4, v[2:3]
...
;
; SI-GISEL-LABEL: v_qsad_pk_u16_u8:
; SI-GISEL:       ; %bb.0:
...
; SI-GISEL-NEXT:    v_qsad_pk_u16_u8 v[0:1], v[4:5], v6, v[2:3]
...
; SI-SDAG-LABEL: v_qsad_pk_u16_u8_non_immediate:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0xd
; SI-SDAG-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xf
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s2
; SI-SDAG-NEXT:    v_mov_b32_e32 v1, s3
...
; SI-SDAG-NEXT:    ;;#ASMEND
; SI-SDAG-NEXT:    v_qsad_pk_u16_u8 v[0:1], v[2:3], v4, v[6:7]
; SI-SDAG-NEXT:    s_mov_b32 s6, -1
; SI-SDAG-NEXT:    s_mov_b32 s4, s0
; SI-SDAG-NEXT:    s_mov_b32 s5, s1
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: v_qsad_pk_u16_u8_non_immediate:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; SI-GISEL-NEXT:    ;;#ASMEND
; SI-GISEL-NEXT:    v_qsad_pk_u16_u8 v[0:1], v[2:3], v4, v[6:7]
; SI-GISEL-NEXT:    s_mov_b32 s2, -1
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
