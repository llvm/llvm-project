...
; RUN: llc -march=amdgcn -mcpu=gfx1210 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-GISEL %s
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_bitop3_b32 v3, v0, v2, v0 bitop3:0xc
; GFX1210-GISEL-NEXT:    v_bitop3_b32 v0, v0, v2, v0 bitop3:3
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bitop3_b32 v0, v3, v1, v0 bitop3:0xc8
...
; GFX950-LABEL: test_100_src_overflow:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    v_bitop3_b32 v3, v1, v2, v0 bitop3:0x10
; GFX950-NEXT:    v_bitop3_b32 v4, v0, v2, v1 bitop3:0x40
; GFX950-NEXT:    v_bitop3_b32 v0, v1, v2, v0 bitop3:0x20
; GFX950-NEXT:    v_or3_b32 v0, v3, v4, v0
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: test_100_src_overflow:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bitop3_b32 v3, v1, v2, v0 bitop3:0x10
; GFX1210-NEXT:    v_bitop3_b32 v4, v0, v2, v1 bitop3:0x40
; GFX1210-NEXT:    v_bitop3_b32 v0, v1, v2, v0 bitop3:0x20
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_or3_b32 v0, v3, v4, v0
...
; GFX950-LABEL: uniform_4_op:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    v_mov_b32_e32 v0, s1
; GFX950-NEXT:    v_mov_b32_e32 v1, s2
; GFX950-NEXT:    v_bitop3_b32 v0, s0, v0, v1 bitop3:2
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: uniform_4_op:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:2
; GFX1210-NEXT:    ; return to shader part epilog
  %nota = xor i32 %a, -1
  %notb = xor i32 %b, -1
  %and1 = and i32 %nota, %c
