...
; RUN: llc -global-isel=0 -mtriple=amdgcn-- -mcpu=gfx1210 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn-- -mcpu=gfx1210 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-GISEL %s
...
;
; GFX1210-SDAG-LABEL: not_and_and_and:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v2 bitop3:8
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: not_and_and_and:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v0, v0
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v2
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: and_not_and_and:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v2 bitop3:0x20
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: and_not_and_and:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v1, v1
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v2
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: and_and_not_and:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v2 bitop3:0x40
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: and_and_not_and:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v2, v2
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v2
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v1
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: and_and_and:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v2 bitop3:0x80
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: and_and_and:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v2
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_12:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v0 bitop3:0xc
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_12:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v0, v0
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_63:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v0 bitop3:0x3f
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_63:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v0, v0
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v1, v1
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %nota = xor i32 %a, -1
  %notb = xor i32 %b, -1
  %or = or i32 %nota, %notb
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_126:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v2, v1 bitop3:0x7e
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_126:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_xor_b32_e32 v1, v0, v1
; GFX1210-GISEL-NEXT:    v_xor_b32_e32 v0, v0, v2
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %xor1 = xor i32 %a, %b
  %xor2 = xor i32 %a, %c
  %or = or i32 %xor1, %xor2
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_12_src_overflow:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, v1, v0 bitop3:0xc
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_12_src_overflow:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v0, v0
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bfi_b32 v0, v2, v0, v0
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v1
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %nota = xor i32 %a, -1
  %notc = xor i32 %c, -1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_100_src_overflow:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v3, v1, v2, v0 bitop3:0x10
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v4, v0, v2, v1 bitop3:0x40
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v1, v2, v0 bitop3:0x20
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_or3_b32 v0, v3, v4, v0
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_100_src_overflow:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_or_b32_e32 v3, v2, v0
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v4, v1
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v5, v1, v0
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v3, v3
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v4
; GFX1210-GISEL-NEXT:    v_not_b32_e32 v4, v2
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v1, v1, v3
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v0, v0, v2
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_and_b32_e32 v2, v5, v4
; GFX1210-GISEL-NEXT:    v_or3_b32 v0, v1, v0, v2
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %or1 = or i32 %c, %a
  %not1 = xor i32 %or1, -1
  %and1 = and i32 %b, %not1
...
;
; GFX1210-LABEL: test_xor3:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_xor3_b32 v0, v0, v1, v2
...
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: uniform_3_op:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_not1_b32 s0, s2, s0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_and_b32 s0, s0, s1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: uniform_4_op:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:2
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: uniform_4_op:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_and_not1_b32 s0, s2, s0
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-GISEL-NEXT:    s_and_not1_b32 s0, s0, s1
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_xor3_b16:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b16 v0, v0, v2, v1 bitop3:0x96
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_xor3_b16:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_xor3_b32 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %xor1 = xor i16 %a, %b
  %xor2 = xor i16 %xor1, %c
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_or3_b16:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b16 v0, v0, v2, v1 bitop3:0xfe
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_or3_b16:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_or3_b32 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %or1 = or i16 %a, %b
  %or2 = or i16 %or1, %c
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: test_and_or_b16:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_bitop3_b16 v0, v0, v2, v1 bitop3:0xec
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: test_and_or_b16:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_and_or_b32 v0, v0, v1, v2
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
  %and1 = and i16 %a, %b
  %or1 = or i16 %and1, %c
