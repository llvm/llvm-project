...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_add_co_u32 v0, s5, s6, s7
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_add_co_u32 v0, s5, s6, s7
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_and_b32 s1, s8, 1
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_add_i32 s0, s2, s3
...
; GFX10-NEXT:    s_and_b32 s3, s6, 1
; GFX10-NEXT:    v_add_co_u32 v0, s2, s2, s3
...
; GFX11-NEXT:    s_and_b32 s3, s4, 1
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_add_co_u32 v0, s2, s2, s3
