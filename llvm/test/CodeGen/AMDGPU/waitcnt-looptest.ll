...
; GCN-NEXT:    s_add_u32 s0, s0, data_generic@gotpcrel32@lo+4
; GCN-NEXT:    s_addc_u32 s1, s1, data_generic@gotpcrel32@hi+12
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GCN-NEXT:    s_getpc_b64 s[10:11]
; GCN-NEXT:    s_add_u32 s10, s10, data_reference@gotpcrel32@lo+4
; GCN-NEXT:    s_addc_u32 s11, s11, data_reference@gotpcrel32@hi+12
; GCN-NEXT:    s_load_dwordx2 s[16:17], s[10:11], 0x0
...
; GCN-NEXT:    buffer_store_dwordx2 v[1:2], off, s[0:3], 0 offset:16
; GCN-NEXT:    s_mov_b32 s18, s2
; GCN-NEXT:    s_mov_b32 s19, s3
; GCN-NEXT:    s_mov_b64 s[6:7], -1
; GCN-NEXT:    s_mov_b32 s15, 0
; GCN-NEXT:    s_mov_b64 s[2:3], 0
; GCN-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GCN-NEXT:    buffer_store_dwordx2 v[1:2], off, s[16:19], 0 offset:16
; GCN-NEXT:  .LBB0_1: ; %bb18
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    s_add_u32 s10, s0, s2
; GCN-NEXT:    s_addc_u32 s11, s1, s3
; GCN-NEXT:    s_add_u32 s12, s16, s2
; GCN-NEXT:    v_mov_b32_e32 v1, s10
; GCN-NEXT:    s_addc_u32 s13, s17, s3
; GCN-NEXT:    s_or_b32 s18, s15, 1
; GCN-NEXT:    v_mov_b32_e32 v2, s11
; GCN-NEXT:    s_ashr_i32 s19, s18, 31
; GCN-NEXT:    flat_load_dword v1, v[1:2]
; GCN-NEXT:    v_mov_b32_e32 v2, s12
; GCN-NEXT:    s_lshl_b64 s[18:19], s[18:19], 2
; GCN-NEXT:    v_mov_b32_e32 v3, s13
; GCN-NEXT:    s_add_u32 s20, s0, s18
; GCN-NEXT:    flat_load_dword v4, v[2:3]
; GCN-NEXT:    s_addc_u32 s21, s1, s19
; GCN-NEXT:    v_mov_b32_e32 v2, s20
; GCN-NEXT:    v_mov_b32_e32 v3, s21
; GCN-NEXT:    s_add_u32 s18, s16, s18
; GCN-NEXT:    flat_load_dword v5, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s17, s19
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s10, 8
; GCN-NEXT:    flat_load_dword v6, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s11, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s12, 8
; GCN-NEXT:    flat_load_dword v7, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s13, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s10, 12
; GCN-NEXT:    flat_load_dword v8, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s11, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s12, 12
; GCN-NEXT:    flat_load_dword v9, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s13, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s10, 16
; GCN-NEXT:    flat_load_dword v10, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s11, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s12, 16
; GCN-NEXT:    flat_load_dword v11, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s13, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s10, 20
; GCN-NEXT:    flat_load_dword v12, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s11, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    s_add_u32 s18, s12, 20
; GCN-NEXT:    flat_load_dword v13, v[2:3]
; GCN-NEXT:    s_addc_u32 s19, s13, 0
; GCN-NEXT:    v_mov_b32_e32 v2, s18
; GCN-NEXT:    v_mov_b32_e32 v3, s19
; GCN-NEXT:    flat_load_dword v2, v[2:3]
; GCN-NEXT:    s_load_dwordx4 s[20:23], s[10:11], 0x18
; GCN-NEXT:    s_load_dwordx4 s[24:27], s[12:13], 0x18
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[6:7]
; GCN-NEXT:    s_add_i32 s15, s15, 10
; GCN-NEXT:    s_add_u32 s2, s2, 40
; GCN-NEXT:    s_addc_u32 s3, s3, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v14, s24
; GCN-NEXT:    v_mov_b32_e32 v15, s25
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, s20, v14
; GCN-NEXT:    v_mov_b32_e32 v16, s26
; GCN-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, s21, v15
; GCN-NEXT:    v_mov_b32_e32 v17, s27
; GCN-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, s22, v16
; GCN-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, s23, v17
; GCN-NEXT:    v_cndmask_b32_e64 v17, 0, 1, vcc
; GCN-NEXT:    s_cmpk_eq_i32 s2, 0x190
; GCN-NEXT:    s_waitcnt vmcnt(10)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v1, v4
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v3, v1
; GCN-NEXT:    s_waitcnt vmcnt(8)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v5, v6
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v1, v3
; GCN-NEXT:    s_waitcnt vmcnt(6)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v7, v8
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v1, v3
; GCN-NEXT:    s_waitcnt vmcnt(4)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v9, v10
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v1, v3
; GCN-NEXT:    s_waitcnt vmcnt(2)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v11, v12
; GCN-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v1, v3
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_cmp_eq_f32_e32 vcc, v13, v2
; GCN-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GCN-NEXT:    v_and_b32_e32 v1, v1, v2
; GCN-NEXT:    v_and_b32_e32 v1, v1, v14
; GCN-NEXT:    v_and_b32_e32 v1, v1, v15
; GCN-NEXT:    v_and_b32_e32 v1, v1, v16
...
; GCN-NEXT:    s_load_dword s3, s[8:9], 0x8
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[8:9], 0x0
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[6:7]
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_and_b32 s2, s2, 0xffff
; GCN-NEXT:    s_mul_i32 s14, s14, s2
; GCN-NEXT:    s_add_i32 s3, s3, s14
; GCN-NEXT:    v_add_u32_e32 v0, vcc, s3, v0
