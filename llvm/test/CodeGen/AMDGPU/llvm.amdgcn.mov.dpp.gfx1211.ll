...
; RUN: llc -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -check-prefixes=GCN,GFX12 %s
; RUN: llc -march=amdgcn -mcpu=gfx1211 -verify-machineinstrs < %s | FileCheck -check-prefixes=GCN,GFX1211 %s
...
; GFX1211: v_mov_b64_dpp v[{{[0-9:]+}}], v[{{[0-9:]+}}] row_share:1 row_mask:0x1 bank_mask:0x1
