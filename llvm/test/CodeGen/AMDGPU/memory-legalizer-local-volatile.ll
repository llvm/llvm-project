...
define amdgpu_kernel void @local_volatile_load_0(
  ; GFX6-LABEL: name: local_volatile_load_0
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   renamable $sgpr2 = S_LOAD_DWORD_IMM renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s32), addrspace 4)
  ...
  ; GFX6-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.in, addrspace 3)
  ...
  ;
  ; GFX7-LABEL: name: local_volatile_load_0
  ; GFX7: bb.0.entry:
  ...
  ; GFX7-NEXT:   renamable $vgpr2 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_load_0
  ...
  ; GFX10-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX10-CU-LABEL: name: local_volatile_load_0
  ; GFX10-CU: bb.0.entry:
  ...
  ; GFX10-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_load_0
  ...
  ; SKIP-CACHE-INV-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_load_0
  ...
  ; GFX11-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX11-CU-LABEL: name: local_volatile_load_0
  ; GFX11-CU: bb.0.entry:
  ...
  ; GFX11-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_load_0
  ...
  ; GFX12-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
  ...
  ;
  ; GFX12-CU-LABEL: name: local_volatile_load_0
  ; GFX12-CU: bb.0.entry:
  ...
  ; GFX12-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.in.load, addrspace 3)
...
define amdgpu_kernel void @local_volatile_load_1(
  ; GFX6-LABEL: name: local_volatile_load_1
  ; GFX6: bb.0.entry:
  ...
  ; GFX6-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX6-NEXT:   renamable $sgpr2 = S_MOV_B32 -1
  ; GFX6-NEXT:   BUFFER_STORE_DWORD_OFFSET killed renamable $vgpr0, killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, 0, 0, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: local_volatile_load_1
  ; GFX7: bb.0.entry:
  ...
  ; GFX7-NEXT:   renamable $vgpr2 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX7-NEXT:   $vgpr0 = V_MOV_B32_e32 $sgpr0, implicit $exec, implicit-def $vgpr0_vgpr1, implicit $sgpr0_sgpr1
  ; GFX7-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $sgpr0_sgpr1, implicit $exec
  ; GFX7-NEXT:   FLAT_STORE_DWORD killed renamable $vgpr0_vgpr1, killed renamable $vgpr2, 0, 0, implicit $exec, implicit $flat_scr :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_load_1
  ; GFX10-WGP: bb.0.entry:
  ...
  ; GFX10-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX10-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: local_volatile_load_1
  ; GFX10-CU: bb.0.entry:
  ...
  ; GFX10-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX10-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_load_1
  ; SKIP-CACHE-INV: bb.0.entry:
  ...
  ; SKIP-CACHE-INV-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; SKIP-CACHE-INV-NEXT:   renamable $sgpr2 = S_MOV_B32 -1
  ; SKIP-CACHE-INV-NEXT:   BUFFER_STORE_DWORD_OFFSET killed renamable $vgpr0, killed renamable $sgpr0_sgpr1_sgpr2_sgpr3, 0, 0, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_load_1
  ; GFX11-WGP: bb.0.entry:
  ...
  ; GFX11-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX11-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: local_volatile_load_1
  ; GFX11-CU: bb.0.entry:
  ...
  ; GFX11-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX11-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_load_1
  ; GFX12-WGP: bb.0.entry:
  ...
  ; GFX12-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX12-WGP-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: local_volatile_load_1
  ; GFX12-CU: bb.0.entry:
  ...
  ; GFX12-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load (s32) from %ir.val.gep, addrspace 3)
  ; GFX12-CU-NEXT:   GLOBAL_STORE_DWORD_SADDR killed renamable $vgpr1, killed renamable $vgpr0, killed renamable $sgpr0_sgpr1, 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
  ; GFX12-CU-NEXT:   S_ENDPGM 0
    ptr addrspace(3) %in, ptr addrspace(1) %out) {
entry:
...
define amdgpu_kernel void @local_volatile_store_0(
  ; GFX6-LABEL: name: local_volatile_store_0
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX6-NEXT: {{  $}}
  ...
  ; GFX6-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 11, 0 :: (dereferenceable invariant load (s32), addrspace 4)
  ; GFX6-NEXT:   $m0 = S_MOV_B32 -1
  ...
  ; GFX6-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out, addrspace 3)
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: local_volatile_store_0
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX7-NEXT: {{  $}}
  ...
  ; GFX7-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_store_0
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-WGP-NEXT: {{  $}}
  ...
  ; GFX10-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: local_volatile_store_0
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-CU-NEXT: {{  $}}
  ...
  ; GFX10-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_store_0
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $sgpr0_sgpr1
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ...
  ; SKIP-CACHE-INV-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_store_0
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ...
  ; GFX11-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: local_volatile_store_0
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ...
  ; GFX11-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_store_0
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ...
  ; GFX12-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: local_volatile_store_0
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ...
  ; GFX12-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.load, addrspace 3)
  ; GFX12-CU-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @local_volatile_store_1(
  ; GFX6-LABEL: name: local_volatile_store_1
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset, align 4, addrspace 4)
  ...
  ; GFX6-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; GFX6-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: local_volatile_store_1
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX7-NEXT:   renamable $vgpr0 = V_ADD_CO_U32_e32 killed $sgpr2, killed $vgpr0, implicit-def dead $vcc, implicit $exec
  ; GFX7-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX7-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_store_1
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-WGP-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ; GFX10-WGP-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX10-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: local_volatile_store_1
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $vgpr0, $sgpr4_sgpr5
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-CU-NEXT:   renamable $sgpr0 = S_LOAD_DWORD_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: ("amdgpu-noclobber" load (s32) from %ir.in.load, addrspace 1)
  ; GFX10-CU-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX10-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_store_1
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; SKIP-CACHE-INV-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr1, implicit $exec, implicit $exec
  ; SKIP-CACHE-INV-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_store_1
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ; GFX11-WGP-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: local_volatile_store_1
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ; GFX11-CU-NEXT:   renamable $sgpr2_sgpr3 = S_LOAD_DWORDX2_IMM renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_store_1
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ; GFX12-WGP-NEXT:   renamable $sgpr0_sgpr1_sgpr2 = S_LOAD_DWORDX3_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s96) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX12-WGP-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: local_volatile_store_1
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $vgpr0, $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ; GFX12-CU-NEXT:   renamable $sgpr0_sgpr1_sgpr2 = S_LOAD_DWORDX3_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s96) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX12-CU-NEXT:   S_WAIT_KMCNT_soft 0
  ; GFX12-CU-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store (s32) into %ir.out.gep, addrspace 3)
  ; GFX12-CU-NEXT:   S_ENDPGM 0
    ptr addrspace(1) %in, ptr addrspace(3) %out) {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
define amdgpu_kernel void @local_volatile_workgroup_acquire_load(
  ; GFX6-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s64), align 4, addrspace 4)
  ; GFX6-NEXT:   $m0 = S_MOV_B32 -1
  ; GFX6-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX6-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.in, addrspace 3)
  ...
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX7-NEXT: {{  $}}
  ...
  ; GFX7-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-WGP-NEXT: {{  $}}
  ...
  ; GFX10-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-CU-NEXT: {{  $}}
  ...
  ; GFX10-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_workgroup_acquire_load
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $sgpr0_sgpr1
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ...
  ; SKIP-CACHE-INV-NEXT:   $m0 = S_MOV_B32 -1
  ; SKIP-CACHE-INV-NEXT:   $vgpr0 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; SKIP-CACHE-INV-NEXT:   renamable $vgpr0 = DS_READ_B32 killed renamable $vgpr0, 0, 0, implicit $m0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ...
  ; GFX11-WGP-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx11 killed $sgpr0, killed $sgpr1, implicit $exec, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX11-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ...
  ; GFX11-CU-NEXT:   $vgpr0, $vgpr1 = V_DUAL_MOV_B32_e32_X_MOV_B32_e32_gfx11 killed $sgpr0, killed $sgpr1, implicit $exec, implicit $exec, implicit $exec, implicit $exec, implicit $exec
  ; GFX11-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ...
  ; GFX12-WGP-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
  ...
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: local_volatile_workgroup_acquire_load
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ...
  ; GFX12-CU-NEXT:   renamable $vgpr0 = DS_READ_B32_gfx9 killed renamable $vgpr0, 0, 0, implicit $exec :: (volatile load syncscope("workgroup") acquire (s32) from %ir.1, addrspace 3)
...
define amdgpu_kernel void @local_volatile_workgroup_release_store(
  ; GFX6-LABEL: name: local_volatile_workgroup_release_store
  ; GFX6: bb.0.entry:
  ; GFX6-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX6-NEXT: {{  $}}
  ; GFX6-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 9, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset, align 4, addrspace 4)
  ; GFX6-NEXT:   $m0 = S_MOV_B32 -1
  ...
  ; GFX6-NEXT:   S_WAITCNT_soft 127
  ; GFX6-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.out, addrspace 3)
  ; GFX6-NEXT:   S_ENDPGM 0
  ;
  ; GFX7-LABEL: name: local_volatile_workgroup_release_store
  ; GFX7: bb.0.entry:
  ; GFX7-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX7-NEXT: {{  $}}
  ; GFX7-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX7-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX7-NEXT:   S_WAITCNT_soft 127
  ; GFX7-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX7-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-WGP-LABEL: name: local_volatile_workgroup_release_store
  ; GFX10-WGP: bb.0.entry:
  ; GFX10-WGP-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-WGP-NEXT: {{  $}}
  ; GFX10-WGP-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX10-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX10-CU-LABEL: name: local_volatile_workgroup_release_store
  ; GFX10-CU: bb.0.entry:
  ; GFX10-CU-NEXT:   liveins: $sgpr4_sgpr5
  ; GFX10-CU-NEXT: {{  $}}
  ; GFX10-CU-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr4_sgpr5, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX10-CU-NEXT:   $vgpr1 = V_MOV_B32_e32 killed $sgpr0, implicit $exec, implicit $exec
  ; GFX10-CU-NEXT:   S_WAITCNT_soft 49279
  ; GFX10-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX10-CU-NEXT:   S_ENDPGM 0
  ;
  ; SKIP-CACHE-INV-LABEL: name: local_volatile_workgroup_release_store
  ; SKIP-CACHE-INV: bb.0.entry:
  ; SKIP-CACHE-INV-NEXT:   liveins: $sgpr0_sgpr1
  ; SKIP-CACHE-INV-NEXT: {{  $}}
  ; SKIP-CACHE-INV-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; SKIP-CACHE-INV-NEXT:   S_WAITCNT_soft 127
  ; SKIP-CACHE-INV-NEXT:   DS_WRITE_B32 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $m0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; SKIP-CACHE-INV-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-WGP-LABEL: name: local_volatile_workgroup_release_store
  ; GFX11-WGP: bb.0.entry:
  ; GFX11-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-WGP-NEXT: {{  $}}
  ; GFX11-WGP-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX11-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX11-CU-LABEL: name: local_volatile_workgroup_release_store
  ; GFX11-CU: bb.0.entry:
  ; GFX11-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX11-CU-NEXT: {{  $}}
  ; GFX11-CU-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX11-CU-NEXT:   S_WAITCNT_soft 64519
  ; GFX11-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX11-CU-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-WGP-LABEL: name: local_volatile_workgroup_release_store
  ; GFX12-WGP: bb.0.entry:
  ; GFX12-WGP-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-WGP-NEXT: {{  $}}
  ; GFX12-WGP-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX12-WGP-NEXT:   S_WAIT_STORECNT_soft 0
  ; GFX12-WGP-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-WGP-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX12-WGP-NEXT:   S_ENDPGM 0
  ;
  ; GFX12-CU-LABEL: name: local_volatile_workgroup_release_store
  ; GFX12-CU: bb.0.entry:
  ; GFX12-CU-NEXT:   liveins: $sgpr0_sgpr1
  ; GFX12-CU-NEXT: {{  $}}
  ; GFX12-CU-NEXT:   renamable $sgpr0_sgpr1 = S_LOAD_DWORDX2_IMM killed renamable $sgpr0_sgpr1, 0, 0 :: (dereferenceable invariant load (s64) from %ir.in.kernarg.offset1, align 16, addrspace 4)
  ...
  ; GFX12-CU-NEXT:   S_WAIT_DSCNT_soft 0
  ; GFX12-CU-NEXT:   DS_WRITE_B32_gfx9 killed renamable $vgpr0, killed renamable $vgpr1, 0, 0, implicit $exec :: (volatile store syncscope("workgroup") release (s32) into %ir.1, addrspace 3)
  ; GFX12-CU-NEXT:   S_ENDPGM 0
