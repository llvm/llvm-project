...
;
; GFX1210-LABEL: local_volatile_load_0:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    ds_load_b32 v1, v1
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_volatile_load_1:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
; GFX1210-NEXT:    v_mov_b32_e32 v1, v0
; GFX1210-NEXT:    s_load_b32 s3, s[0:1], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x8
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_mov_b32 s2, 0x3ff
; GFX1210-NEXT:    v_and_b32_e64 v1, v1, s2
; GFX1210-NEXT:    s_mov_b32 s2, 2
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_lshl_add_u32 v1, v1, s2, s3
; GFX1210-NEXT:    ds_load_b32 v1, v1
; GFX1210-NEXT:    s_wait_dscnt 0x0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_volatile_store_0:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
; GFX1210-NEXT:    s_load_b64 s[2:3], s[0:1], 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b32 s1, s[0:1], 0x8
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_volatile_store_1:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_mov_b32 s1, 0x3ff
; GFX1210-NEXT:    v_and_b32_e64 v0, v0, s1
; GFX1210-NEXT:    s_mov_b32 s1, 2
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_lshl_add_u32 v0, v0, s1, s2
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_mov_b32_e32 v1, s0
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_volatile_workgroup_acquire_load:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: local_volatile_workgroup_release_store:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b32 s0, s[2:3], 0x0
