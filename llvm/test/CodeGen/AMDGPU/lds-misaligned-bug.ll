...
; SPLIT-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; SPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; SPLIT-NEXT:    global_load_dwordx2 v[0:1], v3, s[0:1]
; SPLIT-NEXT:    s_waitcnt vmcnt(0)
; SPLIT-NEXT:    v_mov_b32_e32 v2, v0
; SPLIT-NEXT:    global_store_dwordx2 v3, v[1:2], s[0:1]
; SPLIT-NEXT:    s_endpgm
;
; ALIGNED-GFX10-LABEL: test_flat_misaligned_v2:
; ALIGNED-GFX10:       ; %bb.0: ; %bb
; ALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; ALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; ALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX10-NEXT:    global_load_dwordx2 v[0:1], v3, s[0:1]
; ALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v2, v0
; ALIGNED-GFX10-NEXT:    global_store_dwordx2 v3, v[1:2], s[0:1]
; ALIGNED-GFX10-NEXT:    s_endpgm
;
; UNALIGNED-GFX10-LABEL: test_flat_misaligned_v2:
; UNALIGNED-GFX10:       ; %bb.0: ; %bb
; UNALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; UNALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; UNALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX10-NEXT:    global_load_dwordx2 v[0:1], v3, s[0:1]
; UNALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v2, v0
; UNALIGNED-GFX10-NEXT:    global_store_dwordx2 v3, v[1:2], s[0:1]
; UNALIGNED-GFX10-NEXT:    s_endpgm
;
...
; ALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; ALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; ALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; ALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX11-NEXT:    global_load_b64 v[0:1], v3, s[0:1]
; ALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX11-NEXT:    v_mov_b32_e32 v2, v0
; ALIGNED-GFX11-NEXT:    global_store_b64 v3, v[1:2], s[0:1]
; ALIGNED-GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; UNALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; UNALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; UNALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX11-NEXT:    global_load_b64 v[0:1], v3, s[0:1]
; UNALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX11-NEXT:    v_mov_b32_e32 v2, v0
; UNALIGNED-GFX11-NEXT:    global_store_b64 v3, v[1:2], s[0:1]
; UNALIGNED-GFX11-NEXT:    s_endpgm
bb:
  %lid = tail call i32 @llvm.amdgcn.workitem.id.x()
...
; SPLIT:       ; %bb.0: ; %bb
; SPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; SPLIT-NEXT:    v_lshlrev_b32_e32 v7, 2, v0
; SPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; SPLIT-NEXT:    global_load_dwordx4 v[0:3], v7, s[0:1]
; SPLIT-NEXT:    s_waitcnt vmcnt(0)
; SPLIT-NEXT:    v_mov_b32_e32 v4, v2
; SPLIT-NEXT:    v_mov_b32_e32 v5, v1
; SPLIT-NEXT:    v_mov_b32_e32 v6, v0
; SPLIT-NEXT:    global_store_dwordx4 v7, v[3:6], s[0:1]
; SPLIT-NEXT:    s_endpgm
;
; ALIGNED-GFX10-LABEL: test_flat_misaligned_v4:
; ALIGNED-GFX10:       ; %bb.0: ; %bb
; ALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; ALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v7, 2, v0
; ALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX10-NEXT:    global_load_dwordx4 v[0:3], v7, s[0:1]
; ALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v4, v2
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v5, v1
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v6, v0
; ALIGNED-GFX10-NEXT:    global_store_dwordx4 v7, v[3:6], s[0:1]
; ALIGNED-GFX10-NEXT:    s_endpgm
;
; UNALIGNED-GFX10-LABEL: test_flat_misaligned_v4:
; UNALIGNED-GFX10:       ; %bb.0: ; %bb
; UNALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; UNALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v7, 2, v0
; UNALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX10-NEXT:    global_load_dwordx4 v[0:3], v7, s[0:1]
; UNALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v4, v2
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v5, v1
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v6, v0
; UNALIGNED-GFX10-NEXT:    global_store_dwordx4 v7, v[3:6], s[0:1]
; UNALIGNED-GFX10-NEXT:    s_endpgm
;
...
; ALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; ALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; ALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v7, 2, v0
; ALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX11-NEXT:    global_load_b128 v[0:3], v7, s[0:1]
; ALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX11-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1
; ALIGNED-GFX11-NEXT:    v_mov_b32_e32 v6, v0
; ALIGNED-GFX11-NEXT:    global_store_b128 v7, v[3:6], s[0:1]
; ALIGNED-GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; UNALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; UNALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v7, 2, v0
; UNALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX11-NEXT:    global_load_b128 v[0:3], v7, s[0:1]
; UNALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX11-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v1
; UNALIGNED-GFX11-NEXT:    v_mov_b32_e32 v6, v0
; UNALIGNED-GFX11-NEXT:    global_store_b128 v7, v[3:6], s[0:1]
; UNALIGNED-GFX11-NEXT:    s_endpgm
bb:
  %lid = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds i32, ptr %arg, i32 %lid
...
; SPLIT:       ; %bb.0: ; %bb
; SPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; SPLIT-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; SPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; SPLIT-NEXT:    global_load_dwordx3 v[0:2], v5, s[0:1]
; SPLIT-NEXT:    s_waitcnt vmcnt(0)
; SPLIT-NEXT:    v_mov_b32_e32 v3, v0
; SPLIT-NEXT:    v_mov_b32_e32 v4, v1
; SPLIT-NEXT:    global_store_dwordx3 v5, v[2:4], s[0:1]
; SPLIT-NEXT:    s_endpgm
;
; ALIGNED-GFX10-LABEL: test_flat_misaligned_v3:
; ALIGNED-GFX10:       ; %bb.0: ; %bb
; ALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; ALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; ALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX10-NEXT:    global_load_dwordx3 v[0:2], v5, s[0:1]
; ALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v3, v0
; ALIGNED-GFX10-NEXT:    v_mov_b32_e32 v4, v1
; ALIGNED-GFX10-NEXT:    global_store_dwordx3 v5, v[2:4], s[0:1]
; ALIGNED-GFX10-NEXT:    s_endpgm
;
; UNALIGNED-GFX10-LABEL: test_flat_misaligned_v3:
; UNALIGNED-GFX10:       ; %bb.0: ; %bb
; UNALIGNED-GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; UNALIGNED-GFX10-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; UNALIGNED-GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX10-NEXT:    global_load_dwordx3 v[0:2], v5, s[0:1]
; UNALIGNED-GFX10-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v3, v0
; UNALIGNED-GFX10-NEXT:    v_mov_b32_e32 v4, v1
; UNALIGNED-GFX10-NEXT:    global_store_dwordx3 v5, v[2:4], s[0:1]
; UNALIGNED-GFX10-NEXT:    s_endpgm
;
...
; ALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; ALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; ALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; ALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; ALIGNED-GFX11-NEXT:    global_load_b96 v[0:2], v5, s[0:1]
; ALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; ALIGNED-GFX11-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0
; ALIGNED-GFX11-NEXT:    global_store_b96 v5, v[2:4], s[0:1]
; ALIGNED-GFX11-NEXT:    s_endpgm
;
...
; UNALIGNED-GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; UNALIGNED-GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; UNALIGNED-GFX11-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; UNALIGNED-GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; UNALIGNED-GFX11-NEXT:    global_load_b96 v[0:2], v5, s[0:1]
; UNALIGNED-GFX11-NEXT:    s_waitcnt vmcnt(0)
; UNALIGNED-GFX11-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0
; UNALIGNED-GFX11-NEXT:    global_store_b96 v5, v[2:4], s[0:1]
; UNALIGNED-GFX11-NEXT:    s_endpgm
bb:
  %lid = tail call i32 @llvm.amdgcn.workitem.id.x()
  %gep = getelementptr inbounds i32, ptr %arg, i32 %lid
