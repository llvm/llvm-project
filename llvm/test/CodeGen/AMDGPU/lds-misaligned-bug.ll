...
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -check-prefix=SPLIT %s
; RUN: llc -mtriple=amdgpu10.11 < %s | FileCheck -check-prefix=SPLIT %s
; RUN: llc -mtriple=amdgpu10.12 < %s | FileCheck -check-prefix=SPLIT %s
; RUN: llc -mtriple=amdgpu10.10 -mattr=+cumode < %s | FileCheck -check-prefix=ALIGNED-GFX10 %s
