...
; RUN: llc < %s -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs | FileCheck %s -check-prefixes=GFX11
...
; GFX11-NEXT:    s_load_b64 s[6:7], s[0:1], 0x34
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_clause 0x3
; GFX11-NEXT:    s_load_b128 s[4:7], s[0:1], 0x54
; GFX11-NEXT:    s_load_b128 s[8:11], s[0:1], 0x44
; GFX11-NEXT:    s_load_b128 s[12:15], s[0:1], 0x34
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
...
; GFX11-NEXT:    v_alignbit_b32 v3, s15, s11, v0
; GFX11-NEXT:    v_alignbit_b32 v2, s14, s10, v1
; GFX11-NEXT:    v_alignbit_b32 v1, s13, s9, v4
; GFX11-NEXT:    v_alignbit_b32 v0, s12, s8, v5
...
; GFX11-NEXT:    v_xor_b32_e32 v8, -1, v4
; GFX11-NEXT:    v_lshrrev_b32_e32 v10, 16, v0
; GFX11-NEXT:    v_lshlrev_b16_e64 v0, 1, v0
; GFX11-NEXT:    v_and_b32_e32 v4, 15, v4
; GFX11-NEXT:    v_and_b32_e32 v9, 15, v6
; GFX11-NEXT:    v_xor_b32_e32 v6, -1, v6
; GFX11-NEXT:    v_and_b32_e32 v15, 15, v8
; GFX11-NEXT:    v_lshrrev_b32_e32 v7, 16, v2
; GFX11-NEXT:    v_lshrrev_b16_e64 v2, v4, v2
; GFX11-NEXT:    v_lshlrev_b16_e64 v10, 1, v10
; GFX11-NEXT:    v_and_b32_e32 v19, 15, v6
; GFX11-NEXT:    v_lshlrev_b16_e64 v0, v15, v0
; GFX11-NEXT:    v_xor_b32_e32 v11, -1, v5
; GFX11-NEXT:    v_lshrrev_b16_e64 v4, v9, v7
; GFX11-NEXT:    v_lshlrev_b16_e64 v1, 1, v1
; GFX11-NEXT:    v_lshlrev_b16_e64 v6, v19, v10
; GFX11-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX11-NEXT:    v_and_b32_e32 v7, 15, v11
; GFX11-NEXT:    v_and_b32_e32 v2, 15, v5
; GFX11-NEXT:    v_or_b32_e32 v11, v6, v4
; GFX11-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX11-NEXT:    v_lshlrev_b16_e64 v1, v7, v1
; GFX11-NEXT:    v_lshrrev_b16_e64 v2, v2, v3
; GFX11-NEXT:    v_lshl_or_b32 v0, v11, 16, v0
...
; GFX11-NEXT:    v_xor_b32_e32 v9, -1, v6
; GFX11-NEXT:    v_and_b32_e32 v6, 15, v6
; GFX11-NEXT:    v_lshlrev_b16_e64 v8, 1, v8
; GFX11-NEXT:    v_and_b32_e32 v13, 15, v10
; GFX11-NEXT:    v_lshlrev_b16_e64 v1, 1, v1
; GFX11-NEXT:    v_and_b32_e32 v9, 15, v9
; GFX11-NEXT:    v_lshrrev_b16_e64 v6, v6, v7
; GFX11-NEXT:    v_lshlrev_b16_e64 v0, 1, v0
; GFX11-NEXT:    v_lshrrev_b32_e32 v12, 16, v2
; GFX11-NEXT:    v_lshlrev_b16_e64 v11, 1, v11
; GFX11-NEXT:    v_lshlrev_b16_e64 v7, v9, v8
; GFX11-NEXT:    v_xor_b32_e32 v9, -1, v10
; GFX11-NEXT:    v_xor_b32_e32 v10, -1, v5
; GFX11-NEXT:    v_xor_b32_e32 v8, -1, v4
; GFX11-NEXT:    v_and_b32_e32 v4, 15, v4
; GFX11-NEXT:    v_and_b32_e32 v5, 15, v5
; GFX11-NEXT:    v_and_b32_e32 v9, 15, v9
; GFX11-NEXT:    v_and_b32_e32 v10, 15, v10
; GFX11-NEXT:    v_and_b32_e32 v15, 15, v8
; GFX11-NEXT:    v_lshrrev_b16_e64 v2, v4, v2
; GFX11-NEXT:    v_lshrrev_b16_e64 v3, v5, v3
; GFX11-NEXT:    v_lshrrev_b16_e64 v4, v13, v12
; GFX11-NEXT:    v_lshlrev_b16_e64 v1, v10, v1
; GFX11-NEXT:    v_lshlrev_b16_e64 v0, v15, v0
; GFX11-NEXT:    v_lshlrev_b16_e64 v5, v9, v11
; GFX11-NEXT:    v_or_b32_e32 v1, v1, v3
; GFX11-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX11-NEXT:    v_mov_b32_e32 v2, 0xffff
; GFX11-NEXT:    v_or_b32_e32 v3, v7, v6
; GFX11-NEXT:    v_or_b32_e32 v7, v5, v4
...
; GFX11-NEXT:    v_and_b32_e32 v15, 63, v8
; GFX11-NEXT:    v_and_b32_e32 v19, 63, v9
; GFX11-NEXT:    v_and_b32_e32 v9, 63, v10
; GFX11-NEXT:    v_and_b32_e32 v13, 63, v11
; GFX11-NEXT:    v_lshrrev_b64 v[4:5], v15, v[4:5]
; GFX11-NEXT:    v_lshlrev_b64 v[11:12], v19, v[0:1]
; GFX11-NEXT:    v_lshrrev_b64 v[6:7], v9, v[6:7]
; GFX11-NEXT:    v_lshlrev_b64 v[15:16], v13, v[2:3]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mul_hi_u32 v3, 0xaaaaaaab, v2
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b32 s0, 0xaaaaaaab
...
; GFX11-NEXT:    v_add_nc_u32_e32 v7, 8, v4
; GFX11-NEXT:    v_add_nc_u32_e32 v6, 8, v5
; GFX11-NEXT:    v_alignbit_b32 v0, v0, v2, v7
; GFX11-NEXT:    v_alignbit_b32 v1, v1, v3, v6
; GFX11-NEXT:    s_setpc_b64 s[30:31]
