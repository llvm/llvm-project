...
; VI-NEXT:    s_mov_b32 s1, s2
; VI-NEXT:    s_and_b32 s2, s4, 31
...
; GFX10-NEXT:    s_load_dword s1, s[4:5], 0x34
...
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[4:5], s1
...
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[4:5], s1
...
; GFX12-NEXT:    s_load_b32 s1, s[4:5], 0x34
; GFX12-NEXT:    s_mov_b32 s4, s3
; GFX12-NEXT:    s_mov_b32 s5, s2
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_and_b32 s1, s1, 31
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[4:5], s1
...
; VI-NEXT:    s_mov_b32 s0, s3
; VI-NEXT:    s_mov_b32 s1, s2
; VI-NEXT:    s_lshr_b64 s[0:1], s[0:1], 7
; VI-NEXT:    v_mov_b32_e32 v2, s0
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_lshr_b64 s[2:3], s[6:7], 7
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
...
; SI-NEXT:    s_and_b32 s1, s4, 31
; SI-NEXT:    s_lshr_b64 s[2:3], s[6:7], s1
; SI-NEXT:    s_mov_b32 s10, -1
; SI-NEXT:    v_mov_b32_e32 v0, s2
; SI-NEXT:    v_mov_b32_e32 v1, s0
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[8:11], 0
...
; GFX10-NEXT:    s_and_b32 s1, s6, 31
; GFX10-NEXT:    s_and_b32 s6, s7, 31
; GFX10-NEXT:    s_lshr_b64 s[2:3], s[8:9], s1
...
; GFX11-NEXT:    s_and_b32 s1, s4, 31
; GFX11-NEXT:    s_and_b32 s4, s5, 31
; GFX11-NEXT:    s_lshr_b64 s[2:3], s[8:9], s1
...
; GFX12-NEXT:    s_and_b32 s1, s4, 31
; GFX12-NEXT:    s_and_b32 s4, s5, 31
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[8:9], s1
