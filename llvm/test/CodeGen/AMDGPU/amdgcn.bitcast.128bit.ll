...
; GCN-NEXT:    v_cvt_f32_f16_e32 v6, v8
...
; GCN-NEXT:    v_cvt_f16_f32_e32 v13, v0
; GCN-NEXT:    v_cvt_f16_f32_e32 v12, v3
...
; GCN-NEXT:    v_lshlrev_b32_e32 v0, 16, v14
...
; GCN-NEXT:    v_add_f32_e32 v3, 0x38000000, v6
; GCN-NEXT:    v_cvt_f16_f32_e32 v3, v3
; GCN-NEXT:    v_add_f32_e32 v2, 0x38000000, v2
...
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
; GCN-NEXT:    v_mul_f32_e32 v12, 1.0, v1
; GCN-NEXT:    v_mul_f32_e32 v13, 1.0, v0
; GCN-NEXT:    v_mul_f32_e32 v10, 1.0, v3
; GCN-NEXT:    v_mul_f32_e32 v11, 1.0, v2
...
; GCN-NEXT:    v_alignbit_b32 v0, v0, v13, 16
; GCN-NEXT:    v_alignbit_b32 v1, v1, v11, 16
; GCN-NEXT:    v_alignbit_b32 v2, v2, v9, 16
...
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v12
...
; GCN-NEXT:    v_and_b32_e32 v2, 0xffff0000, v10
...
; GCN-NEXT:    v_lshlrev_b32_e32 v21, 24, v3
...
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 8, v13
; GCN-NEXT:    v_lshlrev_b32_e32 v5, 24, v15
; GCN-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; GCN-NEXT:    v_add_f32_e32 v0, 1.0, v11
; GCN-NEXT:    v_add_f32_e32 v2, 1.0, v10
; GCN-NEXT:    v_add_f32_e32 v4, 1.0, v9
; GCN-NEXT:    v_add_f32_e32 v6, 1.0, v8
; GCN-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v3, 16, v2
; GCN-NEXT:    v_lshrrev_b32_e32 v5, 16, v4
; GCN-NEXT:    v_lshrrev_b32_e32 v7, 16, v6
...
; GCN-NEXT:    v_and_b32_e32 v5, 0xffff, v17
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff, v19
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff, v18
; GCN-NEXT:    v_or_b32_e32 v8, v5, v24
; GCN-NEXT:    v_and_b32_e32 v5, 0xffff, v16
; GCN-NEXT:    v_or_b32_e32 v0, v0, v25
; GCN-NEXT:    v_or_b32_e32 v4, v1, v23
; GCN-NEXT:    v_or_b32_e32 v12, v5, v22
...
; GCN-NEXT:    v_lshlrev_b32_e32 v21, 24, v3
; GCN-NEXT:    v_lshlrev_b32_e32 v22, 8, v13
; GCN-NEXT:    v_lshlrev_b32_e32 v15, 24, v15
; GCN-NEXT:    v_lshlrev_b32_e32 v23, 24, v11
...
; GCN-NEXT:    v_and_b32_e32 v2, 0xff, v17
; GCN-NEXT:    v_or_b32_e32 v1, v1, v20
; GCN-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GCN-NEXT:    v_or_b32_e32 v3, v16, v2
; GCN-NEXT:    v_or_b32_e32 v2, v1, v3
; GCN-NEXT:    v_and_b32_e32 v1, 0xff, v18
; GCN-NEXT:    v_and_b32_e32 v5, 0xff, v12
...
; GCN-NEXT:    v_or_b32_e32 v4, v21, v1
; GCN-NEXT:    v_and_b32_e32 v5, 0xffff, v5
; GCN-NEXT:    v_or_b32_e32 v7, v15, v6
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GCN-NEXT:    v_or_b32_e32 v6, v5, v7
; GCN-NEXT:    v_and_b32_e32 v5, 0xff, v10
; GCN-NEXT:    v_or_b32_e32 v13, v0, v4
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v8
; GCN-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GCN-NEXT:    v_or_b32_e32 v0, v0, v9
; GCN-NEXT:    v_or_b32_e32 v10, v23, v5
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GCN-NEXT:    v_alignbit_b32 v1, v2, v4, 16
; GCN-NEXT:    v_alignbit_b32 v5, v6, v10, 16
; GCN-NEXT:    v_or_b32_e32 v4, v0, v10
; GCN-NEXT:    v_lshrrev_b32_e32 v3, 16, v3
...
; GCN-NEXT:    v_or_b32_e32 v1, v2, v1
; GCN-NEXT:    s_mov_b32 s7, 0x3000000
; GCN-NEXT:    v_add_i32_e32 v4, vcc, s7, v1
...
; GCN-NEXT:    v_alignbit_b32 v1, v2, v13, 16
; GCN-NEXT:    v_alignbit_b32 v5, v6, v4, 16
; GCN-NEXT:    v_lshrrev_b32_e32 v3, 16, v2
; GCN-NEXT:    v_lshrrev_b32_e32 v7, 16, v6
; GCN-NEXT:  .LBB49_4: ; %end
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v0, v13
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-NEXT:    v_lshlrev_b32_e32 v4, 16, v13
...
; GCN-NEXT:    v_cvt_f16_f32_e32 v19, v9
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
; GCN-NEXT:    ; implicit-def: $vgpr0
; GCN-NEXT:    ; implicit-def: $vgpr1
; GCN-NEXT:    ; implicit-def: $vgpr2
...
; GCN-NEXT:    v_lshlrev_b32_e32 v20, 8, v5
; GCN-NEXT:    v_lshlrev_b32_e32 v21, 8, v7
; GCN-NEXT:    v_lshlrev_b32_e32 v22, 8, v9
...
; GCN-NEXT:    v_or_b32_e32 v4, v4, v22
...
; GCN-NEXT:    v_or_b32_e32 v4, v4, v23
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v17
; GCN-NEXT:    v_and_b32_e32 v1, 0xff, v18
; GCN-NEXT:    v_and_b32_e32 v3, 0xff, v6
; GCN-NEXT:    v_cvt_f32_f16_e32 v13, v4
; GCN-NEXT:    v_and_b32_e32 v4, 0xff, v14
...
; GCN-NEXT:    v_or_b32_e32 v4, v4, v15
; GCN-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GCN-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GCN-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GCN-NEXT:    v_cvt_f32_f16_e32 v3, v3
...
; GCN-NEXT:    v_add_i32_e32 v7, vcc, 0x300, v0
; GCN-NEXT:    v_add_i32_e32 v0, vcc, 3, v12
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GCN-NEXT:    s_movk_i32 s6, 0x300
...
; GCN-NEXT:    v_cvt_f32_f16_e32 v5, v5
; GCN-NEXT:    v_cvt_f32_f16_e32 v13, v12
; GCN-NEXT:    v_cvt_f32_f16_e32 v7, v7
...
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v8
; GCN-NEXT:    v_mul_f32_e32 v19, 1.0, v1
...
; GCN-NEXT:    v_mul_f32_e32 v17, 1.0, v7
...
; GCN-NEXT:    v_lshrrev_b32_e32 v14, 16, v17
; GCN-NEXT:    v_alignbit_b32 v0, v0, v20, 16
; GCN-NEXT:    v_alignbit_b32 v4, v6, v18, 16
...
; GCN-NEXT:    v_mov_b32_e32 v17, v0
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v16
; GCN-NEXT:    v_lshlrev_b32_e32 v19, 24, v3
; GCN-NEXT:    v_lshlrev_b32_e32 v22, 8, v5
; GCN-NEXT:    v_lshlrev_b32_e32 v20, 24, v7
; GCN-NEXT:    v_lshlrev_b32_e32 v21, 24, v11
; GCN-NEXT:    v_lshlrev_b32_e32 v23, 8, v13
...
; GCN-NEXT:    v_add_i32_e32 v0, vcc, 3, v17
; GCN-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GCN-NEXT:    v_lshlrev_b32_e32 v1, 8, v18
; GCN-NEXT:    v_or_b32_e32 v0, v1, v0
...
; GCN-NEXT:    v_lshlrev_b32_e32 v16, 16, v12
; GCN-NEXT:  .LBB55_4: ; %end
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:    v_mov_b32_e32 v2, v15
; GCN-NEXT:    v_mov_b32_e32 v4, v11
