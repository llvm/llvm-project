...
; GFX13-NEXT:    v_dual_lshrrev_b32 v7, 24, v19 :: v_dual_lshrrev_b32 v2, 16, v18
; GFX13-NEXT:    v_lshrrev_b32_e32 v5, 8, v19
...
; GFX13-NEXT:    v_dual_add_nc_u32 v19, 3, v19 :: v_dual_add_nc_u32 v16, 3, v16
; GFX13-NEXT:    v_dual_add_nc_u32 v17, 3, v17 :: v_dual_add_nc_u32 v18, 3, v18
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_dual_lshrrev_b32 v7, 24, v19 :: v_dual_lshrrev_b32 v10, 16, v16
; GFX13-NEXT:    v_lshrrev_b64 v[20:21], 24, v[16:17]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX13-NEXT:    v_lshrrev_b32_e32 v2, 16, v18
; GFX13-NEXT:    v_lshrrev_b64 v[22:23], 24, v[18:19]
; GFX13-NEXT:    v_dual_lshrrev_b32 v15, 24, v17 :: v_dual_lshrrev_b32 v14, 16, v17
; GFX13-NEXT:    v_lshrrev_b32_e32 v13, 8, v17
; GFX13-NEXT:    v_dual_lshrrev_b32 v9, 8, v16 :: v_dual_lshrrev_b32 v6, 16, v19
; GFX13-NEXT:    v_lshrrev_b32_e32 v5, 8, v19
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v18
...
; GFX13-NEXT:    v_dual_mov_b32 v4, v19 :: v_dual_mov_b32 v11, v20
; GFX13-NEXT:    v_mov_b32_e32 v8, v16
; GFX13-NEXT:    v_mov_b32_e32 v12, v17
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
  %cmp = icmp eq i32 %b, 0
  br i1 %cmp, label %cmp.true, label %cmp.false
...
; GFX13-NEXT:    v_dual_lshlrev_b32 v1, 16, v1 :: v_dual_lshlrev_b32 v6, 16, v6
...
; GFX13-NEXT:    v_dual_lshrrev_b32 v1, 8, v18 :: v_dual_lshrrev_b32 v14, 16, v17
; GFX13-NEXT:    v_dual_lshrrev_b32 v15, 24, v17 :: v_dual_lshrrev_b32 v10, 16, v16
; GFX13-NEXT:    v_lshrrev_b32_e32 v13, 8, v17
; GFX13-NEXT:    v_lshrrev_b32_e32 v9, 8, v16
...
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_lshrrev_b32_e32 v7, 24, v19
; GFX13-NEXT:    v_dual_lshrrev_b32 v15, 24, v17 :: v_dual_lshrrev_b32 v14, 16, v17
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_lshrrev_b64 v[20:21], 24, v[16:17]
; GFX13-NEXT:    v_lshrrev_b64 v[22:23], 24, v[18:19]
...
; GFX13-NEXT:    v_add_f32_e32 v9, 0x40c00000, v2
; GFX13-NEXT:    v_add_f32_e32 v2, 0x40c00000, v6
; GFX13-NEXT:    v_dual_add_f32 v10, 0x40c00000, v3 :: v_dual_lshlrev_b32 v1, 16, v18
; GFX13-NEXT:    v_lshlrev_b32_e32 v7, 16, v16
; GFX13-NEXT:    v_cvt_pk_bf16_f32 v6, v4, s0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX13-NEXT:    v_add_f32_e32 v8, 0x40c00000, v1
...
; GFX13-NEXT:    v_lshrrev_b32_e32 v15, 24, v3
...
; GFX13-NEXT:    v_lshrrev_b32_e32 v10, 16, v2
