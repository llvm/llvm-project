...
; GCN-NEXT:    image_sample_o v[0:3], v[0:1], s[0:7], s[8:11] dmask:0xf
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_o v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_o v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_cl_o v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_cl_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_cl_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_cl_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_b_o v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_b_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_b_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_b_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_b_cl_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_b_cl_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_b_cl_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-NEXT:    s_wqm_b64 exec, exec
; GCN-NEXT:    s_and_b64 exec, exec, s[12:13]
; GCN-NEXT:    image_sample_c_b_cl_o v[0:3], v[0:5], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_d_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_d_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_d_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_d_o v[0:3], v[0:6], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_d_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_d_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_d_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_d_o v[0:3], v[0:7], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_d_cl_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_d_cl_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_d_cl_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_d_cl_o v[0:3], v[0:7], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_d_cl_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_d_cl_o v[0:3], v[0:5], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_d_cl_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_d_cl_o v[0:3], v[0:8], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_cd_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_cd_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_cd_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_cd_o v[0:3], v[0:6], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_cd_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_cd_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_cd_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_cd_o v[0:3], v[0:7], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_cd_cl_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_cd_cl_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_cd_cl_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_cd_cl_o v[0:3], v[0:7], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_cd_cl_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_cd_cl_o v[0:3], v[0:5], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_cd_cl_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_cd_cl_o v[0:3], v[0:8], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_l_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_l_o v[0:3], v[0:2], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_l_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_l_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_l_o_1d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_l_o v[0:3], v[0:3], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
...
; GCN-LABEL: sample_c_l_o_2d:
; GCN:       ; %bb.0: ; %main_body
; GCN-NEXT:    image_sample_c_l_o v[0:3], v[0:4], s[0:7], s[8:11] dmask:0xf
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    ; return to shader part epilog
main_body:
