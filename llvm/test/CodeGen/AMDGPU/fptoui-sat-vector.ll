...
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v6, v4
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v2, v0
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v0, v3
...
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s5, v0
; GFX7-GI-NEXT:    s_ashr_i32 s4, s5, 31
; GFX7-GI-NEXT:    v_readfirstlane_b32 s5, v2
; GFX7-GI-NEXT:    v_readfirstlane_b32 s6, v4
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v6
; GFX7-GI-NEXT:    s_ashr_i32 s5, s5, 31
; GFX7-GI-NEXT:    s_ashr_i32 s6, s6, 31
; GFX7-GI-NEXT:    s_ashr_i32 s7, s7, 31
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, s5
; GFX7-GI-NEXT:    v_mov_b32_e32 v5, s6
; GFX7-GI-NEXT:    v_mov_b32_e32 v7, s7
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v3
; GFX9-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GFX9-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX9-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX9-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
...
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_ashr_i32 s4, s2, 31
; GFX12-GI-NEXT:    s_ashr_i32 s5, s0, 31
; GFX12-GI-NEXT:    s_ashr_i32 s6, s3, 31
; GFX12-GI-NEXT:    s_ashr_i32 s7, s1, 31
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s4
; GFX12-GI-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s5
; GFX12-GI-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v5, s6
; GFX12-GI-NEXT:    v_dual_mov_b32 v6, s1 :: v_dual_mov_b32 v7, s7
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
    %x = call <4 x i64> @llvm.fptoui.sat.v4f16.v4i64(<4 x half> %f)
    ret <4 x i64> %x
}
...
; GFX7-ISEL-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GFX7-ISEL-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v16, v7
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v6, v6
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v10, v5
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v4, v1
...
; GFX7-GI-NEXT:    v_lshrrev_b32_e32 v4, 16, v0
; GFX7-GI-NEXT:    v_lshrrev_b32_e32 v5, 16, v1
; GFX7-GI-NEXT:    v_lshrrev_b32_e32 v8, 16, v2
; GFX7-GI-NEXT:    v_lshrrev_b32_e32 v9, 16, v3
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v4, v4
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v5, v5
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v10, v8
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v9, v9
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v17, v4
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v6, v5
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v8, v2
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v10, v10
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v12, v3
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v14, v9
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v16, 31, v17
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v9, 31, v8
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v11, 31, v10
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v13, 31, v12
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v15, 31, v14
; GFX7-GI-NEXT:    v_mov_b32_e32 v2, v17
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, v16
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v14, v8
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v4, v1
...
; GFX11-FAKE16-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GFX11-FAKE16-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v16, v4
; GFX11-FAKE16-NEXT:    v_cvt_f32_f16_e32 v4, v7
; GFX11-FAKE16-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v6, v5
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v10, v8
; GFX11-FAKE16-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX11-FAKE16-NEXT:    v_cvt_u32_f32_e32 v8, v2
...
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v1, v1.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v2, v2.l
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v16, v4
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v4, v7.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v3, v3.l
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v5
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v10, v8
; GFX11-TRUE16-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v2
...
; GFX12-FAKE16-NEXT:    v_cvt_f32_f16_e32 v1, v1
; GFX12-FAKE16-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v16, v4
; GFX12-FAKE16-NEXT:    v_cvt_f32_f16_e32 v4, v7
; GFX12-FAKE16-NEXT:    v_cvt_f32_f16_e32 v3, v3
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v6, v5
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v10, v8
; GFX12-FAKE16-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX12-FAKE16-NEXT:    v_cvt_u32_f32_e32 v8, v2
...
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v1, v1.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v2, v2.l
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v16, v4
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v4, v7.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v3, v3.l
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v5
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v10, v8
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v17, 31, v16
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v2
...
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v6, v1.l
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v7, v1.h
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v8, v2.l
; GFX12-GI-NEXT:    v_cvt_u32_f32_e32 v17, v5
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v2, v2.h
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v9, v3.l
; GFX12-GI-NEXT:    v_cvt_f32_f16_e32 v3, v3.h
; GFX12-GI-NEXT:    v_cvt_u32_f32_e32 v0, v4
; GFX12-GI-NEXT:    v_cvt_u32_f32_e32 v4, v6
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v16, 31, v17
; GFX12-GI-NEXT:    v_cvt_u32_f32_e32 v6, v7
; GFX12-GI-NEXT:    v_cvt_u32_f32_e32 v8, v8
...
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v5, 31, v4
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v9, 31, v8
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v11, 31, v10
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v13, 31, v12
; GFX12-GI-NEXT:    v_ashrrev_i32_e32 v15, 31, v14
; GFX12-GI-NEXT:    v_dual_mov_b32 v2, v17 :: v_dual_mov_b32 v3, v16
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v10, v3
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v4, v1
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v8, v5
; GFX7-ISEL-NEXT:    v_cvt_u32_f32_e32 v12, v9
; GFX7-ISEL-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX7-ISEL-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
; GFX7-ISEL-NEXT:    v_ashrrev_i32_e32 v11, 31, v10
; GFX7-ISEL-NEXT:    v_ashrrev_i32_e32 v15, 31, v14
...
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v3, s19
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v6
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v8, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v1, s4
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v12, v3
; GFX7-GI-NEXT:    v_readfirstlane_b32 s8, v2
; GFX7-GI-NEXT:    s_ashr_i32 s4, s9, 31
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v10, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v1, s6
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v8
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v0
; GFX7-GI-NEXT:    s_ashr_i32 s5, s8, 31
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v14, v1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s8, v4
; GFX7-GI-NEXT:    s_ashr_i32 s6, s9, 31
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v10
; GFX7-GI-NEXT:    v_readfirstlane_b32 s10, v12
; GFX7-GI-NEXT:    v_readfirstlane_b32 s11, v14
; GFX7-GI-NEXT:    s_ashr_i32 s7, s7, 31
; GFX7-GI-NEXT:    s_ashr_i32 s8, s8, 31
; GFX7-GI-NEXT:    s_ashr_i32 s9, s9, 31
; GFX7-GI-NEXT:    s_ashr_i32 s10, s10, 31
; GFX7-GI-NEXT:    s_ashr_i32 s11, s11, 31
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s7
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, s5
; GFX7-GI-NEXT:    v_mov_b32_e32 v5, s8
; GFX7-GI-NEXT:    v_mov_b32_e32 v7, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v9, s6
; GFX7-GI-NEXT:    v_mov_b32_e32 v11, s9
; GFX7-GI-NEXT:    v_mov_b32_e32 v13, s10
; GFX7-GI-NEXT:    v_mov_b32_e32 v15, s11
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v14, v4
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v4, v1
...
; GFX11-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX11-NEXT:    v_cvt_f32_f16_e32 v0, s4
; GFX11-NEXT:    v_cvt_f32_f16_e32 v1, s0
; GFX11-NEXT:    v_cvt_f32_f16_e32 v5, s2
; GFX11-NEXT:    v_cvt_f32_f16_e32 v9, s3
; GFX11-NEXT:    v_cvt_u32_f32_e32 v10, v3
; GFX11-NEXT:    v_cvt_u32_f32_e32 v14, v0
; GFX11-NEXT:    v_cvt_u32_f32_e32 v0, v1
; GFX11-NEXT:    v_cvt_u32_f32_e32 v4, v4
; GFX11-NEXT:    v_cvt_u32_f32_e32 v8, v5
; GFX11-NEXT:    v_cvt_u32_f32_e32 v12, v9
; GFX11-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX11-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
...
; GFX12-GI-NEXT:    s_cvt_hi_f32_f16 s1, s1
; GFX12-GI-NEXT:    s_cvt_f32_f16 s10, s2
; GFX12-GI-NEXT:    s_cvt_hi_f32_f16 s2, s2
; GFX12-GI-NEXT:    s_cvt_f32_f16 s11, s3
...
; GFX12-GI-NEXT:    s_cvt_u32_f32 s1, s1
; GFX12-GI-NEXT:    s_cvt_u32_f32 s10, s10
; GFX12-GI-NEXT:    s_cvt_u32_f32 s2, s2
; GFX12-GI-NEXT:    s_cvt_u32_f32 s11, s11
; GFX12-GI-NEXT:    s_cvt_u32_f32 s3, s3
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_ashr_i32 s6, s4, 31
; GFX12-GI-NEXT:    s_ashr_i32 s7, s0, 31
; GFX12-GI-NEXT:    s_ashr_i32 s8, s5, 31
; GFX12-GI-NEXT:    s_ashr_i32 s9, s1, 31
; GFX12-GI-NEXT:    s_ashr_i32 s12, s10, 31
; GFX12-GI-NEXT:    s_ashr_i32 s13, s2, 31
; GFX12-GI-NEXT:    s_ashr_i32 s14, s11, 31
; GFX12-GI-NEXT:    s_ashr_i32 s15, s3, 31
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s6
; GFX12-GI-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s7
; GFX12-GI-NEXT:    v_dual_mov_b32 v4, s5 :: v_dual_mov_b32 v5, s8
; GFX12-GI-NEXT:    v_dual_mov_b32 v6, s1 :: v_dual_mov_b32 v7, s9
; GFX12-GI-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v9, s12
; GFX12-GI-NEXT:    v_dual_mov_b32 v10, s2 :: v_dual_mov_b32 v11, s13
; GFX12-GI-NEXT:    v_dual_mov_b32 v12, s11 :: v_dual_mov_b32 v13, s14
; GFX12-GI-NEXT:    v_dual_mov_b32 v14, s3 :: v_dual_mov_b32 v15, s15
; GFX12-GI-NEXT:    s_setpc_b64 s[30:31]
    %x = call <8 x i64> @llvm.fptoui.sat.v8f16.v8i64(<8 x half> %f)
    ret <8 x i64> %x
}
