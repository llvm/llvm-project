...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-FAKE16-LABEL: test_s_unsigned_v4f16_v4i64:
; GFX12-FAKE16:       ; %bb.0:
; GFX12-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_expcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s2, s0
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s0, s0
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s3, s1
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s1, s1
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v6, s3 :: v_dual_mov_b32 v7, 0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-TRUE16-LABEL: test_s_unsigned_v4f16_v4i64:
; GFX12-TRUE16:       ; %bb.0:
; GFX12-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_expcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s2, s0
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s0, s0
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s3, s1
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s1, s1
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v5, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v6, s1 :: v_dual_mov_b32 v7, 0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_min_u16 v4.l, 0xff, v2.l
; GFX11-TRUE16-NEXT:    v_min_u16 v2.l, 0xff, v2.h
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v2.h, 8, v3.h
; GFX11-TRUE16-NEXT:    v_min_u16 v1.l, 0xff, v1.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v0.h
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v1.h
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 8, v2.l
; GFX11-TRUE16-NEXT:    v_or_b16 v6.h, v3.l, v2.h
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX11-TRUE16-NEXT:    v_min_u16 v0.h, 0xff, v0.h
; GFX11-TRUE16-NEXT:    v_or_b16 v2.l, v1.l, v1.h
; GFX11-TRUE16-NEXT:    v_or_b16 v6.l, v4.l, v3.h
...
; GFX12-TRUE16-NEXT:    v_min_u16 v4.l, 0xff, v2.l
; GFX12-TRUE16-NEXT:    v_min_u16 v2.l, 0xff, v2.h
; GFX12-TRUE16-NEXT:    v_lshlrev_b16 v2.h, 8, v3.h
; GFX12-TRUE16-NEXT:    v_min_u16 v1.l, 0xff, v1.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v0.h
; GFX12-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v1.h
; GFX12-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 8, v2.l
; GFX12-TRUE16-NEXT:    v_or_b16 v6.h, v3.l, v2.h
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX12-TRUE16-NEXT:    v_min_u16 v0.h, 0xff, v0.h
; GFX12-TRUE16-NEXT:    v_or_b16 v2.l, v1.l, v1.h
; GFX12-TRUE16-NEXT:    v_or_b16 v6.l, v4.l, v3.h
...
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v9, v4
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v5
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v5, v1.h
...
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v7
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v1, v0
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v3, v5
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v5, v2
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v7, v10
...
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v9, v4
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v5
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v5, v1.h
...
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v7
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v1, v0
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v3, v5
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v5, v2
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v7, v10
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v8, v3, v11
; GFX11-TRUE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v5, v1, v7
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[9:10], 24, v[7:8]
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v0, v0, v1
...
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v8, v3, v11
; GFX12-TRUE16-NEXT:    v_min_u32_e32 v0, 0xff, v0
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v5, v1, v7
; GFX12-TRUE16-NEXT:    v_lshrrev_b64 v[9:10], 24, v[7:8]
; GFX12-TRUE16-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v5
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v8
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v11
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v9.l
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-FAKE16-LABEL: test_s_unsigned_v8f16_v8i64:
; GFX12-FAKE16:       ; %bb.0:
; GFX12-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_expcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s4, s0
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s5, s1
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s6, s2
; GFX12-FAKE16-NEXT:    s_cvt_hi_f32_f16 s7, s3
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s0, s0
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s1, s1
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s2, s2
; GFX12-FAKE16-NEXT:    s_cvt_f32_f16 s3, s3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s4, s4
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s5, s5
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s6, s6
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s7, s7
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s0, s0
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s1, s1
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s2, s2
; GFX12-FAKE16-NEXT:    s_cvt_u32_f32 s3, s3
...
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v7, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v9, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v10, s6 :: v_dual_mov_b32 v11, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v12, s3 :: v_dual_mov_b32 v13, 0
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v14, s7 :: v_dual_mov_b32 v15, 0
; GFX12-FAKE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-TRUE16-LABEL: test_s_unsigned_v8f16_v8i64:
; GFX12-TRUE16:       ; %bb.0:
; GFX12-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_expcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_samplecnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s4, s0
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s0, s0
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s5, s1
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s1, s1
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s6, s2
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s2, s2
; GFX12-TRUE16-NEXT:    s_cvt_f32_f16 s7, s3
; GFX12-TRUE16-NEXT:    s_cvt_hi_f32_f16 s3, s3
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s4, s4
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s0, s0
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s5, s5
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s1, s1
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s6, s6
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s2, s2
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s7, s7
; GFX12-TRUE16-NEXT:    s_cvt_u32_f32 s3, s3
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, s5 :: v_dual_mov_b32 v5, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v6, s1 :: v_dual_mov_b32 v7, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v9, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v10, s2 :: v_dual_mov_b32 v11, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v12, s7 :: v_dual_mov_b32 v13, 0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v14, s3 :: v_dual_mov_b32 v15, 0
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v3.l, s1
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
