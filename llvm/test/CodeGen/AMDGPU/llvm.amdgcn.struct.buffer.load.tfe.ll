...
; RUN: llc -mtriple=amdgpu6.00-- < %s | FileCheck %s -check-prefixes=GFX67,GFX6
; RUN: llc -mtriple=amdgpu7.01-- < %s | FileCheck %s -check-prefixes=GFX67,GFX7
; RUN: llc -mtriple=amdgpu8.03-- < %s | FileCheck %s -check-prefix=GFX8
; RUN: llc -mtriple=amdgpu9.00-- < %s | FileCheck %s -check-prefixes=GFX910,GFX9
; RUN: llc -mtriple=amdgpu10.10-- < %s | FileCheck %s -check-prefixes=GFX910,GFX10
; RUN: llc -mtriple=amdgpu11.00-- < %s | FileCheck %s -check-prefix=GFX11
; RUN: llc -mtriple=amdgpu12.00-- < %s | FileCheck %s -check-prefix=GFX1200
