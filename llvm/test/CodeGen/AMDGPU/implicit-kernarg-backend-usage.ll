...
; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V4 %s
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/600/g' %s | llc -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=GFX8V5 %s

; RUN: sed 's/CODE_OBJECT_VERSION/400/g' %s | llc -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V4 %s
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V5 %s
; RUN: sed 's/CODE_OBJECT_VERSION/600/g' %s | llc -mtriple=amdgpu9.06-amd-amdhsa | FileCheck --check-prefixes=GFX9V5 %s
...
; GFX9V4-NEXT:    ; kill: killed $sgpr6_64
; GFX9V4-NEXT:    ; kill: killed $sgpr4_64
; GFX9V4-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9V5-NEXT:    global_load_ubyte v0, v2, s[6:7] glc
; GFX9V5-NEXT:    global_load_ubyte v0, v2, s[8:9] offset:8 glc
...
; GFX9V5-NEXT:    ; kill: killed $sgpr6_64
; GFX9V5-NEXT:    ; kill: killed $sgpr4_64
; GFX9V5-NEXT:    s_waitcnt lgkmcnt(0)
