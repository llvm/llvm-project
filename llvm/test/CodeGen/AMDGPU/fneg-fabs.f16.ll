...
; RUN: llc -mtriple=amdgpu7.00--amdhsa < %s | FileCheck --check-prefixes=CIVI,CI %s
; RUN: llc -mtriple=amdgpu8.02--amdhsa < %s | FileCheck --check-prefixes=CIVI,VI %s
; RUN: llc -mtriple=amdgpu9.00--amdhsa < %s | FileCheck --check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu11.00--amdhsa -mattr=+real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00--amdhsa -mattr=-real-true16 < %s | FileCheck --check-prefixes=GFX11,GFX11-FAKE16 %s
...
; VI-NEXT:    v_sub_f16_e64 v2, s0, |v2|
...
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mul_f16_e64 v2, s0, -|v2|
; VI-NEXT:    flat_store_short v[0:1], v2
; VI-NEXT:    s_endpgm
;
...
; CIVI-NEXT:    s_or_b32 s0, s2, 0x8000
...
; CI-NEXT:    v_cvt_f16_f32_e32 v2, v0
; CI-NEXT:    v_add_f32_e32 v0, 1.0, v1
...
; VI-NEXT:    v_add_f16_e64 v3, s2, 1.0
...
; CIVI-LABEL: s_fneg_fabs_v2f16_bc_src:
; CIVI:       ; %bb.0:
; CIVI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; CIVI-NEXT:    s_add_i32 s12, s12, s17
; CIVI-NEXT:    s_mov_b32 flat_scratch_lo, s13
...
; CIVI-NEXT:    s_waitcnt lgkmcnt(0)
; CIVI-NEXT:    v_mov_b32_e32 v0, s0
; CIVI-NEXT:    s_or_b32 s0, s2, 0x80008000
; CIVI-NEXT:    v_mov_b32_e32 v1, s1
; CIVI-NEXT:    v_mov_b32_e32 v2, s0
...
; CI-NEXT:    v_cvt_f16_f32_e32 v2, v0
; CI-NEXT:    v_mul_f32_e32 v0, -4.0, v1
; CI-NEXT:    v_cvt_f16_f32_e32 v3, v0
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; CI-NEXT:    v_mov_b32_e32 v1, s1
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    s_bfe_u32 s1, s2, 0xf0010
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_and_b32 s0, s2, 0x7fff7fff
; VI-NEXT:    v_mov_b32_e32 v3, s1
; VI-NEXT:    v_mul_f16_sdwa v2, v3, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_mul_f16_e64 v3, s0, -4.0
; VI-NEXT:    v_or_b32_e32 v2, v3, v2
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_endpgm
;
