...
; GCN-NEXT:    v_mul_f32_e32 v6, 0x3fb8aa3b, v5
; GCN-NEXT:    v_fma_f32 v7, v5, s0, -v6
; GCN-NEXT:    v_rndne_f32_e32 v9, v6
; GCN-NEXT:    v_fmac_f32_e32 v7, 0x32a5705f, v5
; GCN-NEXT:    v_sub_f32_e32 v6, v6, v9
; GCN-NEXT:    v_add_f32_e32 v6, v6, v7
; GCN-NEXT:    v_exp_f32_e32 v6, v6
; GCN-NEXT:    v_cvt_i32_f32_e32 v7, v9
; GCN-NEXT:    v_cmp_ngt_f32_e32 vcc, s6, v5
; GCN-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v4, v4, v[0:3]
; GCN-NEXT:    v_ldexp_f32 v6, v6, v7
...
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s7, v5
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_cndmask_b32_e32 v9, v8, v6, vcc
; GCN-NEXT:    v_mul_f32_e32 v5, 0x3fb8aa3b, v9
; GCN-NEXT:    v_fma_f32 v6, v9, s0, -v5
; GCN-NEXT:    v_rndne_f32_e32 v7, v5
; GCN-NEXT:    v_fmac_f32_e32 v6, 0x32a5705f, v9
; GCN-NEXT:    v_sub_f32_e32 v5, v5, v7
; GCN-NEXT:    v_add_f32_e32 v5, v5, v6
; GCN-NEXT:    v_exp_f32_e32 v10, v5
; GCN-NEXT:    v_cvt_i32_f32_e32 v11, v7
; GCN-NEXT:    v_cmp_ngt_f32_e32 vcc, s6, v9
; GCN-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[4:7], v4, v4, v[0:3]
; GCN-NEXT:    v_ldexp_f32 v10, v10, v11
; GCN-NEXT:    v_cndmask_b32_e32 v10, 0, v10, vcc
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s7, v9
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_cndmask_b32_e32 v9, v8, v10, vcc
; GCN-NEXT:    v_mul_f32_e32 v10, 0x3fb8aa3b, v9
; GCN-NEXT:    v_fma_f32 v11, v9, s0, -v10
; GCN-NEXT:    v_rndne_f32_e32 v12, v10
; GCN-NEXT:    v_fmac_f32_e32 v11, 0x32a5705f, v9
; GCN-NEXT:    v_sub_f32_e32 v10, v10, v12
; GCN-NEXT:    v_add_f32_e32 v10, v10, v11
; GCN-NEXT:    v_exp_f32_e32 v10, v10
; GCN-NEXT:    v_cvt_i32_f32_e32 v11, v12
...
; GCN-NEXT:    v_cmp_nlt_f32_e32 vcc, s7, v9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    global_store_dwordx4 v12, v[4:7], s[0:1]
; GCN-NEXT:    v_cndmask_b32_e32 v8, v8, v10, vcc
; GCN-NEXT:    global_store_dword v12, v8, s[2:3]
; GCN-NEXT:    s_endpgm
