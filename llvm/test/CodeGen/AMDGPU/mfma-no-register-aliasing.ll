...
; RUN: llc -mtriple=amdgcn -mcpu=gfx90a -sgpr-regalloc=fast -vgpr-regalloc=fast -verify-machineinstrs < %s | FileCheck -enable-var-scope --check-prefixes=FAST %s
...
;
; FAST-LABEL: test_mfma_f32_32x32x1f32:
; FAST:       ; %bb.0: ; %bb
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; FAST-NEXT:    v_mov_b32_e32 v1, 1.0
; FAST-NEXT:    v_mov_b32_e32 v2, 2.0
; FAST-NEXT:    v_mov_b32_e32 v0, 0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    s_load_dwordx16 s[36:51], s[0:1], 0x0
; FAST-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x40
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a32, s36
; FAST-NEXT:    v_accvgpr_write_b32 a33, s37
; FAST-NEXT:    v_accvgpr_write_b32 a34, s38
; FAST-NEXT:    v_accvgpr_write_b32 a35, s39
; FAST-NEXT:    v_accvgpr_write_b32 a36, s40
; FAST-NEXT:    v_accvgpr_write_b32 a37, s41
; FAST-NEXT:    v_accvgpr_write_b32 a38, s42
; FAST-NEXT:    v_accvgpr_write_b32 a39, s43
; FAST-NEXT:    v_accvgpr_write_b32 a40, s44
; FAST-NEXT:    v_accvgpr_write_b32 a41, s45
; FAST-NEXT:    v_accvgpr_write_b32 a42, s46
; FAST-NEXT:    v_accvgpr_write_b32 a43, s47
; FAST-NEXT:    v_accvgpr_write_b32 a44, s48
; FAST-NEXT:    v_accvgpr_write_b32 a45, s49
; FAST-NEXT:    v_accvgpr_write_b32 a46, s50
; FAST-NEXT:    v_accvgpr_write_b32 a47, s51
; FAST-NEXT:    v_accvgpr_write_b32 a48, s4
; FAST-NEXT:    v_accvgpr_write_b32 a49, s5
; FAST-NEXT:    v_accvgpr_write_b32 a50, s6
; FAST-NEXT:    v_accvgpr_write_b32 a51, s7
; FAST-NEXT:    v_accvgpr_write_b32 a52, s8
; FAST-NEXT:    v_accvgpr_write_b32 a53, s9
; FAST-NEXT:    v_accvgpr_write_b32 a54, s10
; FAST-NEXT:    v_accvgpr_write_b32 a55, s11
; FAST-NEXT:    v_accvgpr_write_b32 a56, s12
; FAST-NEXT:    v_accvgpr_write_b32 a57, s13
; FAST-NEXT:    v_accvgpr_write_b32 a58, s14
; FAST-NEXT:    v_accvgpr_write_b32 a59, s15
; FAST-NEXT:    v_accvgpr_write_b32 a60, s16
; FAST-NEXT:    v_accvgpr_write_b32 a61, s17
; FAST-NEXT:    v_accvgpr_write_b32 a62, s18
; FAST-NEXT:    v_accvgpr_write_b32 a63, s19
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v1, v2, a[32:63]
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v1, v2, a[32:63]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
; FAST-NEXT:    v_accvgpr_read_b32 v3, a29
; FAST-NEXT:    v_accvgpr_read_b32 v4, a28
; FAST-NEXT:    v_accvgpr_read_b32 v5, a27
; FAST-NEXT:    v_accvgpr_read_b32 v6, a26
; FAST-NEXT:    v_accvgpr_read_b32 v7, a25
; FAST-NEXT:    v_accvgpr_read_b32 v8, a24
; FAST-NEXT:    v_accvgpr_read_b32 v9, a23
; FAST-NEXT:    v_accvgpr_read_b32 v10, a22
; FAST-NEXT:    v_accvgpr_read_b32 v11, a21
; FAST-NEXT:    v_accvgpr_read_b32 v12, a20
; FAST-NEXT:    v_accvgpr_read_b32 v13, a19
; FAST-NEXT:    v_accvgpr_read_b32 v14, a18
; FAST-NEXT:    v_accvgpr_read_b32 v15, a17
; FAST-NEXT:    v_accvgpr_read_b32 v16, a16
; FAST-NEXT:    v_accvgpr_read_b32 v17, a15
; FAST-NEXT:    v_accvgpr_read_b32 v18, a14
; FAST-NEXT:    v_accvgpr_read_b32 v19, a13
; FAST-NEXT:    v_accvgpr_read_b32 v20, a12
; FAST-NEXT:    v_accvgpr_read_b32 v21, a11
; FAST-NEXT:    v_accvgpr_read_b32 v22, a10
; FAST-NEXT:    v_accvgpr_read_b32 v23, a9
; FAST-NEXT:    v_accvgpr_read_b32 v24, a8
; FAST-NEXT:    v_accvgpr_read_b32 v25, a7
; FAST-NEXT:    v_accvgpr_read_b32 v26, a6
; FAST-NEXT:    v_accvgpr_read_b32 v27, a5
; FAST-NEXT:    v_accvgpr_read_b32 v28, a4
; FAST-NEXT:    v_accvgpr_read_b32 v29, a3
; FAST-NEXT:    v_accvgpr_read_b32 v30, a2
; FAST-NEXT:    v_accvgpr_read_b32 v31, a1
; FAST-NEXT:    v_accvgpr_read_b32 v32, a0
; FAST-NEXT:    v_accvgpr_mov_b32 a0, a32
; FAST-NEXT:    v_accvgpr_mov_b32 a1, a33
; FAST-NEXT:    v_accvgpr_write_b32 a2, v32
; FAST-NEXT:    v_accvgpr_write_b32 a3, v31
; FAST-NEXT:    v_accvgpr_write_b32 a4, v30
; FAST-NEXT:    v_accvgpr_write_b32 a5, v29
; FAST-NEXT:    v_accvgpr_write_b32 a6, v28
; FAST-NEXT:    v_accvgpr_write_b32 a7, v27
; FAST-NEXT:    v_accvgpr_write_b32 a8, v26
; FAST-NEXT:    v_accvgpr_write_b32 a9, v25
; FAST-NEXT:    v_accvgpr_write_b32 a10, v24
; FAST-NEXT:    v_accvgpr_write_b32 a11, v23
; FAST-NEXT:    v_accvgpr_write_b32 a12, v22
; FAST-NEXT:    v_accvgpr_write_b32 a13, v21
; FAST-NEXT:    v_accvgpr_write_b32 a14, v20
; FAST-NEXT:    v_accvgpr_write_b32 a15, v19
; FAST-NEXT:    v_accvgpr_write_b32 a16, v18
; FAST-NEXT:    v_accvgpr_write_b32 a17, v17
; FAST-NEXT:    v_accvgpr_write_b32 a18, v16
; FAST-NEXT:    v_accvgpr_write_b32 a19, v15
; FAST-NEXT:    v_accvgpr_write_b32 a20, v14
; FAST-NEXT:    v_accvgpr_write_b32 a21, v13
; FAST-NEXT:    v_accvgpr_write_b32 a22, v12
; FAST-NEXT:    v_accvgpr_write_b32 a23, v11
; FAST-NEXT:    v_accvgpr_write_b32 a24, v10
; FAST-NEXT:    v_accvgpr_write_b32 a25, v9
; FAST-NEXT:    v_accvgpr_write_b32 a26, v8
; FAST-NEXT:    v_accvgpr_write_b32 a27, v7
; FAST-NEXT:    v_accvgpr_write_b32 a28, v6
; FAST-NEXT:    v_accvgpr_write_b32 a29, v5
; FAST-NEXT:    v_accvgpr_write_b32 a30, v4
; FAST-NEXT:    v_accvgpr_write_b32 a31, v3
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v1, v2, a[0:31]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
; FAST-NEXT:    global_store_dwordx4 v0, a[24:27], s[0:1] offset:96
; FAST-NEXT:    global_store_dwordx4 v0, a[28:31], s[0:1] offset:112
; FAST-NEXT:    global_store_dwordx4 v0, a[16:19], s[0:1] offset:64
; FAST-NEXT:    global_store_dwordx4 v0, a[20:23], s[0:1] offset:80
; FAST-NEXT:    global_store_dwordx4 v0, a[8:11], s[0:1] offset:32
; FAST-NEXT:    global_store_dwordx4 v0, a[12:15], s[0:1] offset:48
; FAST-NEXT:    global_store_dwordx4 v0, a[0:3], s[0:1]
; FAST-NEXT:    global_store_dwordx4 v0, a[4:7], s[0:1] offset:16
; FAST-NEXT:    s_endpgm
bb:
...
; GREEDY90A-GISEL-NEXT:    s_endpgm
;
; FAST-LABEL: test_mfma_f32_16x16x1f32:
; FAST:       ; %bb.0: ; %bb
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; FAST-NEXT:    v_mov_b32_e32 v1, 1.0
; FAST-NEXT:    v_mov_b32_e32 v2, 2.0
; FAST-NEXT:    v_mov_b32_e32 v0, 0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a0, s4
; FAST-NEXT:    v_accvgpr_write_b32 a1, s5
; FAST-NEXT:    v_accvgpr_write_b32 a2, s6
; FAST-NEXT:    v_accvgpr_write_b32 a3, s7
; FAST-NEXT:    v_accvgpr_write_b32 a4, s8
; FAST-NEXT:    v_accvgpr_write_b32 a5, s9
; FAST-NEXT:    v_accvgpr_write_b32 a6, s10
; FAST-NEXT:    v_accvgpr_write_b32 a7, s11
; FAST-NEXT:    v_accvgpr_write_b32 a8, s12
; FAST-NEXT:    v_accvgpr_write_b32 a9, s13
; FAST-NEXT:    v_accvgpr_write_b32 a10, s14
; FAST-NEXT:    v_accvgpr_write_b32 a11, s15
; FAST-NEXT:    v_accvgpr_write_b32 a12, s16
; FAST-NEXT:    v_accvgpr_write_b32 a13, s17
; FAST-NEXT:    v_accvgpr_write_b32 a14, s18
; FAST-NEXT:    v_accvgpr_write_b32 a15, s19
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[0:15], v1, v2, a[0:15]
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[16:31], v1, v2, a[0:15]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
; FAST-NEXT:    v_accvgpr_mov_b32 a2, a16
; FAST-NEXT:    v_accvgpr_mov_b32 a3, a17
; FAST-NEXT:    v_accvgpr_mov_b32 a4, a18
; FAST-NEXT:    v_accvgpr_mov_b32 a5, a19
; FAST-NEXT:    v_accvgpr_mov_b32 a6, a20
; FAST-NEXT:    v_accvgpr_mov_b32 a7, a21
; FAST-NEXT:    v_accvgpr_mov_b32 a8, a22
; FAST-NEXT:    v_accvgpr_mov_b32 a9, a23
; FAST-NEXT:    v_accvgpr_mov_b32 a10, a24
; FAST-NEXT:    v_accvgpr_mov_b32 a11, a25
; FAST-NEXT:    v_accvgpr_mov_b32 a12, a26
; FAST-NEXT:    v_accvgpr_mov_b32 a13, a27
; FAST-NEXT:    v_accvgpr_mov_b32 a14, a28
; FAST-NEXT:    v_accvgpr_mov_b32 a15, a29
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[0:15], v1, v2, a[0:15]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
...
; GREEDY90A-GISEL-NEXT:    s_endpgm
;
; FAST-LABEL: test_mfma_f32_4x4x1f32:
; FAST:       ; %bb.0: ; %bb
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; FAST-NEXT:    v_mov_b32_e32 v1, 1.0
; FAST-NEXT:    v_mov_b32_e32 v2, 2.0
; FAST-NEXT:    v_mov_b32_e32 v0, 0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    s_load_dwordx4 s[4:7], s[0:1], 0x0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a0, s4
; FAST-NEXT:    v_accvgpr_write_b32 a1, s5
; FAST-NEXT:    v_accvgpr_write_b32 a2, s6
; FAST-NEXT:    v_accvgpr_write_b32 a3, s7
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v1, v2, a[0:3]
; FAST-NEXT:    v_mfma_f32_4x4x1f32 a[4:7], v1, v2, a[0:3]
; FAST-NEXT:    s_nop 4
; FAST-NEXT:    v_accvgpr_mov_b32 a2, a4
; FAST-NEXT:    v_accvgpr_mov_b32 a3, a5
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_4x4x1f32 a[0:3], v1, v2, a[0:3]
; FAST-NEXT:    s_nop 4
; FAST-NEXT:    global_store_dwordx4 v0, a[0:3], s[0:1]
