...
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
; FAST-NEXT:    v_accvgpr_write_b32 a0, s36
; FAST-NEXT:    v_accvgpr_write_b32 a1, s37
; FAST-NEXT:    v_accvgpr_write_b32 a2, s38
; FAST-NEXT:    v_accvgpr_write_b32 a3, s39
; FAST-NEXT:    v_accvgpr_write_b32 a4, s40
; FAST-NEXT:    v_accvgpr_write_b32 a5, s41
; FAST-NEXT:    v_accvgpr_write_b32 a6, s42
; FAST-NEXT:    v_accvgpr_write_b32 a7, s43
; FAST-NEXT:    v_accvgpr_write_b32 a8, s44
; FAST-NEXT:    v_accvgpr_write_b32 a9, s45
; FAST-NEXT:    v_accvgpr_write_b32 a10, s46
; FAST-NEXT:    v_accvgpr_write_b32 a11, s47
; FAST-NEXT:    v_accvgpr_write_b32 a12, s48
; FAST-NEXT:    v_accvgpr_write_b32 a13, s49
; FAST-NEXT:    v_accvgpr_write_b32 a14, s50
; FAST-NEXT:    v_accvgpr_write_b32 a15, s51
; FAST-NEXT:    v_accvgpr_write_b32 a16, s4
; FAST-NEXT:    v_accvgpr_write_b32 a17, s5
; FAST-NEXT:    v_accvgpr_write_b32 a18, s6
; FAST-NEXT:    v_accvgpr_write_b32 a19, s7
; FAST-NEXT:    v_accvgpr_write_b32 a20, s8
; FAST-NEXT:    v_accvgpr_write_b32 a21, s9
; FAST-NEXT:    v_accvgpr_write_b32 a22, s10
; FAST-NEXT:    v_accvgpr_write_b32 a23, s11
; FAST-NEXT:    v_accvgpr_write_b32 a24, s12
; FAST-NEXT:    v_accvgpr_write_b32 a25, s13
; FAST-NEXT:    v_accvgpr_write_b32 a26, s14
; FAST-NEXT:    v_accvgpr_write_b32 a27, s15
; FAST-NEXT:    v_accvgpr_write_b32 a28, s16
; FAST-NEXT:    v_accvgpr_write_b32 a29, s17
; FAST-NEXT:    v_accvgpr_write_b32 a30, s18
; FAST-NEXT:    v_accvgpr_write_b32 a31, s19
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v1, v2, a[0:31]
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v1, v2, a[0:31]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
; FAST-NEXT:    v_accvgpr_mov_b32 a2, a32
; FAST-NEXT:    v_accvgpr_mov_b32 a3, a33
; FAST-NEXT:    v_accvgpr_mov_b32 a4, a34
; FAST-NEXT:    v_accvgpr_mov_b32 a5, a35
; FAST-NEXT:    v_accvgpr_mov_b32 a6, a36
; FAST-NEXT:    v_accvgpr_mov_b32 a7, a37
; FAST-NEXT:    v_accvgpr_mov_b32 a8, a38
; FAST-NEXT:    v_accvgpr_mov_b32 a9, a39
; FAST-NEXT:    v_accvgpr_mov_b32 a10, a40
; FAST-NEXT:    v_accvgpr_mov_b32 a11, a41
; FAST-NEXT:    v_accvgpr_mov_b32 a12, a42
; FAST-NEXT:    v_accvgpr_mov_b32 a13, a43
; FAST-NEXT:    v_accvgpr_mov_b32 a14, a44
; FAST-NEXT:    v_accvgpr_mov_b32 a15, a45
; FAST-NEXT:    v_accvgpr_mov_b32 a16, a46
; FAST-NEXT:    v_accvgpr_mov_b32 a17, a47
; FAST-NEXT:    v_accvgpr_mov_b32 a18, a48
; FAST-NEXT:    v_accvgpr_mov_b32 a19, a49
; FAST-NEXT:    v_accvgpr_mov_b32 a20, a50
; FAST-NEXT:    v_accvgpr_mov_b32 a21, a51
; FAST-NEXT:    v_accvgpr_mov_b32 a22, a52
; FAST-NEXT:    v_accvgpr_mov_b32 a23, a53
; FAST-NEXT:    v_accvgpr_mov_b32 a24, a54
; FAST-NEXT:    v_accvgpr_mov_b32 a25, a55
; FAST-NEXT:    v_accvgpr_mov_b32 a26, a56
; FAST-NEXT:    v_accvgpr_mov_b32 a27, a57
; FAST-NEXT:    v_accvgpr_mov_b32 a28, a58
; FAST-NEXT:    v_accvgpr_mov_b32 a29, a59
; FAST-NEXT:    v_accvgpr_mov_b32 a30, a60
; FAST-NEXT:    v_accvgpr_mov_b32 a31, a61
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v1, v2, a[0:31]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 7
...
; FAST:       ; %bb.0: ; %bb
; FAST-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; FAST-NEXT:    v_mov_b32_e32 v0, 1.0
; FAST-NEXT:    v_mov_b32_e32 v1, 2.0
; FAST-NEXT:    s_waitcnt lgkmcnt(0)
...
; FAST-NEXT:    s_nop 1
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[0:15], v0, v1, a[0:15]
; FAST-NEXT:    v_mfma_f32_16x16x1f32 a[16:31], v0, v1, a[0:15]
; FAST-NEXT:    s_nop 7
; FAST-NEXT:    s_nop 2
