...
; GFX8DAGISEL-NEXT:    v_sub_f32_e32 v3, s2, v3
...
; GFX8GISEL-NEXT:    v_sub_f32_e32 v3, s2, v3
...
; GFX8DAGISEL-NEXT:    v_cvt_f32_i32_e32 v2, s3
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX8DAGISEL-NEXT:    v_mul_f32_e64 v2, -s2, v2
; GFX8DAGISEL-NEXT:    v_readfirstlane_b32 s0, v2
...
; GFX9DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s3
...
; GFX8DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX8DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX8DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
...
; GFX8GISEL-NEXT:    s_or_saveexec_b64 s[4:5], s[4:5]
; GFX8GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX8GISEL-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX8GISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX8GISEL-NEXT:  ; %bb.3: ; %if
; GFX8GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX8GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX8GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX8GISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX9DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX9DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX9DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX9DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX9GISEL-NEXT:    s_or_saveexec_b64 s[4:5], s[4:5]
; GFX9GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX9GISEL-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX9GISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX9GISEL-NEXT:  ; %bb.3: ; %if
; GFX9GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX9GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX9GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX9GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX9GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1064DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1064DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX1064DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1064DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX1064DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX1064GISEL-NEXT:    s_or_saveexec_b64 s[4:5], s[4:5]
; GFX1064GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX1064GISEL-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX1064GISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1064GISEL-NEXT:  ; %bb.3: ; %if
; GFX1064GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1064GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX1064GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1064GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX1064GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1064GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1032DAGISEL-NEXT:    ; implicit-def: $sgpr5
...
; GFX1032DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    v_mul_f32_e64 v0, -s2, v0
; GFX1032DAGISEL-NEXT:    v_readfirstlane_b32 s5, v0
; GFX1032DAGISEL-NEXT:  .LBB6_2: ; %Flow
; GFX1032DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
; GFX1032DAGISEL-NEXT:    v_mov_b32_e32 v0, s5
...
; GFX1032DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s4
; GFX1032DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
...
; GFX1032GISEL-NEXT:    ; implicit-def: $sgpr5
...
; GFX1032GISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1032GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX1032GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032GISEL-NEXT:    v_mul_f32_e64 v0, -s2, v0
; GFX1032GISEL-NEXT:    v_readfirstlane_b32 s5, v0
; GFX1032GISEL-NEXT:  .LBB6_2: ; %Flow
; GFX1032GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1032GISEL-NEXT:    s_or_saveexec_b32 s2, s4
; GFX1032GISEL-NEXT:    v_mov_b32_e32 v0, s5
...
; GFX1032GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s4
; GFX1032GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
...
; GFX1164DAGISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1164DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1164DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX1164DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164DAGISEL-NEXT:    v_readfirstlane_b32 s2, v0
...
; GFX1164GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; GFX1164GISEL-NEXT:    s_or_saveexec_b64 s[4:5], s[4:5]
; GFX1164GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX1164GISEL-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX1164GISEL-NEXT:    s_cbranch_execz .LBB6_4
; GFX1164GISEL-NEXT:  ; %bb.3: ; %if
; GFX1164GISEL-NEXT:    s_mov_b64 s[6:7], exec
; GFX1164GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[6:7]
; GFX1164GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX1164GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
; GFX1164GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1164GISEL-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1164GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX1132DAGISEL-NEXT:    ; implicit-def: $sgpr5
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1132DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mul_f32_e64 v0, -s2, v0
; GFX1132DAGISEL-NEXT:    v_readfirstlane_b32 s5, v0
; GFX1132DAGISEL-NEXT:  .LBB6_2: ; %Flow
; GFX1132DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mov_b32_e32 v0, s5
...
; GFX1132DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s4
; GFX1132DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
...
; GFX1132GISEL-NEXT:    ; implicit-def: $sgpr5
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_cmpx_le_u32_e32 16, v0
; GFX1132GISEL-NEXT:    s_xor_b32 s4, exec_lo, s4
...
; GFX1132GISEL-NEXT:    s_bcnt1_i32_b32 s5, s5
; GFX1132GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX1132GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_mul_f32_e64 v0, -s2, v0
; GFX1132GISEL-NEXT:    v_readfirstlane_b32 s5, v0
; GFX1132GISEL-NEXT:  .LBB6_2: ; %Flow
; GFX1132GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1132GISEL-NEXT:    s_or_saveexec_b32 s2, s4
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_mov_b32_e32 v0, s5
...
; GFX1132GISEL-NEXT:    v_cvt_f32_i32_e32 v0, s4
; GFX1132GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1132GISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
...
; GFX12DAGISEL-NEXT:    ; implicit-def: $sgpr5
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mul_f32_e64 v0, -s2, v0
; GFX12DAGISEL-NEXT:    v_readfirstlane_b32 s5, v0
; GFX12DAGISEL-NEXT:  .LBB6_2: ; %Flow
; GFX12DAGISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12DAGISEL-NEXT:    s_or_saveexec_b32 s2, s4
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mov_b32_e32 v0, s5
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12DAGISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12DAGISEL-NEXT:    v_cvt_f32_i32_e32 v0, s4
; GFX12DAGISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12DAGISEL-NEXT:    v_mul_f32_e64 v0, -s3, v0
