...
; GFX13-SDAG-NEXT:    v_mul_u32_u24_e32 v1, v0, v0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
...
; GFX13-GISEL-NEXT:    v_mul_lo_u32 v1, v0, v0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
...
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX13-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-GISEL-NEXT:    s_mov_b32 m0, 1
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-GISEL-NEXT:    v_mul_lo_u32 v1, v0, v0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
...
;
; GFX13-SDAG-LABEL: test2_s_barrier_signal_var:
; GFX13-SDAG:       ; %bb.0:
...
;
; GFX13-GISEL-LABEL: test2_s_barrier_signal_var:
; GFX13-GISEL:       ; %bb.0:
...
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_readfirstlane_b32 m0, v0
; GFX13-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX13-GISEL-NEXT:    s_barrier_signal m0
...
; GFX13-SDAG:       ; %bb.0: ; %entry
; GFX13-SDAG-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[6:7] scale_offset
; GFX13-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX13-SDAG-NEXT:    s_barrier_signal_isfirst -1
; GFX13-SDAG-NEXT:    s_cselect_b32 s3, s3, s5
; GFX13-SDAG-NEXT:    s_cselect_b32 s2, s2, s4
; GFX13-SDAG-NEXT:    s_clause 0x1
; GFX13-SDAG-NEXT:    global_load_b32 v2, v1, s[0:1]
; GFX13-SDAG-NEXT:    global_load_b32 v1, v1, s[2:3]
...
; GFX13-GISEL:       ; %bb.0: ; %entry
; GFX13-GISEL-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
...
; GFX13-GISEL-NEXT:    s_cselect_b32 s8, 1, 0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    s_and_b32 s8, s8, 1
; GFX13-GISEL-NEXT:    s_cmp_lg_u32 s8, 0
; GFX13-GISEL-NEXT:    s_cselect_b64 s[2:3], s[2:3], s[4:5]
; GFX13-GISEL-NEXT:    s_clause 0x1
; GFX13-GISEL-NEXT:    global_load_b32 v2, v1, s[0:1]
; GFX13-GISEL-NEXT:    global_load_b32 v1, v1, s[2:3]
...
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[6:7] scale_offset
; GFX13-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX13-SDAG-NEXT:    s_barrier_signal_isfirst m0
; GFX13-SDAG-NEXT:    s_cselect_b32 s3, s3, s5
; GFX13-SDAG-NEXT:    s_cselect_b32 s2, s2, s4
; GFX13-SDAG-NEXT:    s_clause 0x1
; GFX13-SDAG-NEXT:    global_load_b32 v2, v1, s[0:1]
...
; GFX13-GISEL-NEXT:    global_store_b32 v0, v1, s[6:7] scale_offset
; GFX13-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX13-GISEL-NEXT:    s_barrier_signal_isfirst m0
; GFX13-GISEL-NEXT:    s_cselect_b32 s8, 1, 0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    s_and_b32 s8, s8, 1
; GFX13-GISEL-NEXT:    s_cmp_lg_u32 s8, 0
...
; GFX12-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-SDAG-LABEL: test2_s_barrier_signal_isfirst_var:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_expcnt 0x0
; GFX13-SDAG-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-SDAG-NEXT:    v_and_b32_e32 v7, 0x3ff, v31
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v11, 0
; GFX13-SDAG-NEXT:    v_readfirstlane_b32 s0, v6
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-SDAG-NEXT:    v_lshlrev_b32_e32 v10, 2, v7
; GFX13-SDAG-NEXT:    s_mov_b32 m0, s0
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-SDAG-NEXT:    v_add_nc_u64_e32 v[8:9], v[8:9], v[10:11]
; GFX13-SDAG-NEXT:    global_store_b32 v[8:9], v11, off
; GFX13-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX13-SDAG-NEXT:    s_barrier_signal_isfirst m0
; GFX13-SDAG-NEXT:    s_cselect_b32 vcc_lo, -1, 0
; GFX13-SDAG-NEXT:    v_dual_cndmask_b32 v3, v5, v3 :: v_dual_cndmask_b32 v2, v4, v2
; GFX13-SDAG-NEXT:    global_load_b32 v0, v[0:1], off
; GFX13-SDAG-NEXT:    global_load_b32 v1, v[2:3], off
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mul_lo_u32 v0, v1, v0
; GFX13-SDAG-NEXT:    global_store_b32 v[8:9], v0, off
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-GISEL-LABEL: test2_s_barrier_signal_isfirst_var:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_expcnt 0x0
; GFX13-GISEL-NEXT:    s_wait_samplecnt 0x0
; GFX13-GISEL-NEXT:    s_wait_rtscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_and_b32_e32 v9, 0x3ff, v31
; GFX13-GISEL-NEXT:    v_readfirstlane_b32 m0, v6
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-GISEL-NEXT:    v_lshlrev_b32_e32 v9, 2, v9
; GFX13-GISEL-NEXT:    v_add_co_u32 v10, vcc_lo, v7, v9
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v7, 0
; GFX13-GISEL-NEXT:    v_add_co_ci_u32_e32 v11, vcc_lo, 0, v8, vcc_lo
; GFX13-GISEL-NEXT:    global_store_b32 v[10:11], v7, off
; GFX13-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX13-GISEL-NEXT:    s_barrier_signal_isfirst m0
; GFX13-GISEL-NEXT:    s_cselect_b32 s0, 1, 0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    s_and_b32 s0, 1, s0
; GFX13-GISEL-NEXT:    v_cmp_ne_u32_e64 vcc_lo, 0, s0
; GFX13-GISEL-NEXT:    v_dual_cndmask_b32 v2, v4, v2 :: v_dual_cndmask_b32 v3, v5, v3
; GFX13-GISEL-NEXT:    global_load_b32 v0, v[0:1], off
; GFX13-GISEL-NEXT:    global_load_b32 v1, v[2:3], off
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mul_lo_u32 v0, v1, v0
; GFX13-GISEL-NEXT:    global_store_b32 v[10:11], v0, off
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_set_pc_i64 s[30:31]
  %tmp = call i32 @llvm.amdgcn.workitem.id.x()
  %tmp1 = getelementptr i32, ptr addrspace(1) %out, i32 %tmp
...
; GFX13-SDAG:       ; %bb.0: ; %entry
; GFX13-SDAG-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX13-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-SDAG-NEXT:    v_mul_u32_u24_e32 v1, v0, v0
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    s_lshl_b32 s2, s2, 12
; GFX13-SDAG-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
; GFX13-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX13-SDAG-NEXT:    s_barrier_init -1
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX13-SDAG-NEXT:    s_endpgm
;
...
; GFX13-GISEL:       ; %bb.0: ; %entry
; GFX13-GISEL-NEXT:    s_load_b96 s[0:2], s[2:3], 0x24
; GFX13-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-GISEL-NEXT:    v_mul_lo_u32 v1, v0, v0
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_lshl_b32 m0, 12, s2
; GFX13-GISEL-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
; GFX13-GISEL-NEXT:    s_barrier_init -1
; GFX13-GISEL-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX13-GISEL-NEXT:    s_endpgm
entry:
...
; GFX13-SDAG-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
; GFX13-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX13-SDAG-NEXT:    s_barrier_init 0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX13-SDAG-NEXT:    s_endpgm
;
...
; GFX13-GISEL-NEXT:    s_lshl_b32 m0, 12, s2
; GFX13-GISEL-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
; GFX13-GISEL-NEXT:    s_barrier_init 0
; GFX13-GISEL-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX13-GISEL-NEXT:    s_endpgm
entry:
...
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    s_lshl_b32 s3, s3, 12
; GFX13-SDAG-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
; GFX13-SDAG-NEXT:    s_or_b32 s2, s2, s3
...
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_lshl_b32 s3, 12, s3
; GFX13-GISEL-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
...
; GFX12-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-SDAG-LABEL: test5_s_barrier_init_m0:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_expcnt 0x0
; GFX13-SDAG-NEXT:    s_wait_samplecnt 0x0
; GFX13-SDAG-NEXT:    s_wait_rtscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_lshlrev_b32_e32 v1, 12, v1
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-SDAG-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX13-SDAG-NEXT:    v_readfirstlane_b32 s0, v0
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-SDAG-NEXT:    s_mov_b32 m0, s0
; GFX13-SDAG-NEXT:    s_barrier_init m0
...
; GFX13-GISEL-NEXT:    s_wait_rtscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    v_readfirstlane_b32 s0, v1
; GFX13-GISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX13-GISEL-NEXT:    s_lshl_b32 s0, 12, s0
...
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_sub_nc_u32 v1, v1, v0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX13-GISEL-NEXT:    global_store_b32 v0, v2, s[0:1] scale_offset
...
; GFX12-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-SDAG-LABEL: test5_s_barrier_join_m0:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_expcnt 0x0
; GFX13-SDAG-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-GISEL-LABEL: test5_s_barrier_join_m0:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_expcnt 0x0
; GFX13-GISEL-NEXT:    s_wait_samplecnt 0x0
...
;
; GFX13-LABEL: test6_s_barrier_join_0:
; GFX13:       ; %bb.0:
...
; GFX12-GISEL-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test1_s_barrier_leave:
; GFX13-SDAG:       ; %bb.0: ; %entry
; GFX13-SDAG-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-SDAG-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[6:7] scale_offset
; GFX13-SDAG-NEXT:    s_barrier_leave
; GFX13-SDAG-NEXT:    s_cselect_b32 s3, s3, s5
; GFX13-SDAG-NEXT:    s_cselect_b32 s2, s2, s4
; GFX13-SDAG-NEXT:    s_clause 0x1
; GFX13-SDAG-NEXT:    global_load_b32 v2, v1, s[0:1]
...
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test1_s_barrier_leave:
; GFX13-GISEL:       ; %bb.0: ; %entry
; GFX13-GISEL-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-GISEL-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v0, v1, s[6:7] scale_offset
; GFX13-GISEL-NEXT:    s_barrier_leave
; GFX13-GISEL-NEXT:    s_cselect_b32 s8, 1, 0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    s_and_b32 s8, s8, 1
; GFX13-GISEL-NEXT:    s_cmp_lg_u32 s8, 0
...
; GFX12-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-SDAG-LABEL: test5_s_wakeup_barrier_m0:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_expcnt 0x0
; GFX13-SDAG-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-GISEL-LABEL: test5_s_wakeup_barrier_m0:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_expcnt 0x0
; GFX13-GISEL-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_get_barrier_state s2, -1
; GFX13-NEXT:    s_wait_kmcnt 0x0
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-NEXT:    s_get_barrier_state s2, 0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_2)
; GFX13-NEXT:    v_mov_b32_e32 v1, s2
; GFX13-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
...
; GFX13-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_mov_b32 m0, s2
; GFX13-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
; GFX13-NEXT:    s_get_barrier_state s2, m0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_2)
; GFX13-NEXT:    v_mov_b32_e32 v1, s2
; GFX13-NEXT:    global_store_b32 v0, v1, s[0:1] scale_offset
...
; GFX12-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-SDAG-LABEL: test5_s_get_barrier_state_m0:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-SDAG-NEXT:    s_wait_expcnt 0x0
; GFX13-SDAG-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_readfirstlane_b32 s0, v0
; GFX13-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_2)
; GFX13-SDAG-NEXT:    s_mov_b32 m0, s0
; GFX13-SDAG-NEXT:    s_get_barrier_state s0, m0
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX13-SDAG-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX13-GISEL-LABEL: test5_s_get_barrier_state_m0:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-GISEL-NEXT:    s_wait_expcnt 0x0
; GFX13-GISEL-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_2)
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: test6_s_get_barrier_state_0:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_get_barrier_state s0, 0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_2)
