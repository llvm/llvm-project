...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 4, i32 %scale_src0, i32 1, i32 %scale_src1, i1 false, i1 false)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], s0, s1 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_ROW1_BYTE1 matrix_b_scale:MATRIX_SCALE_WORD1 matrix_a_reuse
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], s0, s1 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_ROW1_BYTE1 matrix_b_scale:MATRIX_SCALE_WORD1 matrix_a_reuse
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 5, i32 %scale_src0, i32 2, i32 %scale_src1, i1 true, i1 false)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v38, 4 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_WORD1_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 matrix_b_reuse
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v38, 4 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_WORD1_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1 matrix_b_reuse
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 6, i32 100, i32 3, i32 4, i1 false, i1 true)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
