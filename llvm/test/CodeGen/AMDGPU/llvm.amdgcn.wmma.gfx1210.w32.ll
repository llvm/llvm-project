...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.f32.16x16x16.xf32.v8f32.v8f32(<8 x float> %A, <8 x float> %B, <8 x float> %C)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39] matrix_a_fmt:MATRIX_FMT_BF8 matrix_b_fmt:MATRIX_FMT_FP6
; GFX1210-NEXT:    s_clause 0x1
...
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 1, <16 x i32> %A, i32 2, <16 x i32> %B, i16 0, <8 x float> %C, i32 1, i32 %scale_src0, i32 7, i32 %scale_src1)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], s0, s1 matrix_a_fmt:MATRIX_FMT_BF8 matrix_b_fmt:MATRIX_FMT_FP6 matrix_a_scale:MATRIX_SCALE_WORD1 matrix_b_scale:MATRIX_SCALE_WORD1_BYTE1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], s0, s1 matrix_a_fmt:MATRIX_FMT_BF8 matrix_b_fmt:MATRIX_FMT_FP6 matrix_a_scale:MATRIX_SCALE_WORD1 matrix_b_scale:MATRIX_SCALE_WORD1_BYTE1
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GISEL-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 1, <16 x i32> %A, i32 2, <16 x i32> %B, i16 0, <8 x float> %C, i32 2, i32 %scale_src0, i32 6, i32 %scale_src1)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}
...
; GFX1210-LABEL: test_wmma_scale_f32_16x16x128_f8f6f4_si_scale:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_mov_b32_e32 v42, 0x64
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], s0, v42 matrix_a_fmt:MATRIX_FMT_BF8 matrix_b_fmt:MATRIX_FMT_FP6 matrix_a_scale:MATRIX_SCALE_ROW1_WORD1 matrix_b_scale:MATRIX_SCALE_ROW1_BYTE1
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GFX1210-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GISEL-NEXT:    v_wmma_scale_f32_16x16x128_f8f6f4 v[32:39], v[0:15], v[16:31], v[32:39], s0, v42 matrix_a_fmt:MATRIX_FMT_BF8 matrix_b_fmt:MATRIX_FMT_FP6 matrix_a_scale:MATRIX_SCALE_ROW1_WORD1 matrix_b_scale:MATRIX_SCALE_ROW1_BYTE1
; GISEL-NEXT:    s_clause 0x1
; GISEL-NEXT:    global_store_b128 v[40:41], v[32:35], off
; GISEL-NEXT:    global_store_b128 v[40:41], v[36:39], off offset:16
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x float> @llvm.amdgcn.wmma.scale.f32.16x16x128.f8f6f4.v8f32.v16i32(i32 1, <16 x i32> %A, i32 2, <16 x i32> %B, i16 0, <8 x float> %C, i32 3, i32 %scale_src0, i32 5, i32 100)
  store <8 x float> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_bf16_16x16x128_f8f6f4(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_bf16_16x16x128_f8f6f4:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35] matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, i32 %scale_src0, i32 %scale_src1, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v36, v37 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1
; GFX1210-NEXT:    global_store_b128 v[38:39], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v32 :: v_dual_lshrrev_b32 v41, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v42, 16, v34 :: v_dual_lshrrev_b32 v43, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GISEL-NEXT:    v_dual_lshlrev_b32 v40, 16, v40 :: v_dual_lshlrev_b32 v41, 16, v41
; GISEL-NEXT:    v_and_b32_e32 v33, 0xffff, v33
; GISEL-NEXT:    v_dual_lshlrev_b32 v42, 16, v42 :: v_dual_lshlrev_b32 v43, 16, v43
; GISEL-NEXT:    v_and_b32_e32 v34, 0xffff, v34
; GISEL-NEXT:    v_and_b32_e32 v35, 0xffff, v35
; GISEL-NEXT:    v_or_b32_e32 v32, v40, v32
; GISEL-NEXT:    v_or_b32_e32 v33, v41, v33
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GISEL-NEXT:    v_or_b32_e32 v34, v42, v34
; GISEL-NEXT:    v_or_b32_e32 v35, v43, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v36, v37 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1
; GISEL-NEXT:    global_store_b128 v[38:39], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 4, i32 %scale_src0, i32 1, i32 %scale_src1)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4_ss(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, i32 inreg %scale_src0, i32 inreg %scale_src1, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ss:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], s0, s1 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_ROW1_BYTE1 matrix_b_scale:MATRIX_SCALE_WORD1
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ss:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], s0, s1 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_ROW1_BYTE1 matrix_b_scale:MATRIX_SCALE_WORD1
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 5, i32 %scale_src0, i32 2, i32 %scale_src1)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}

define amdgpu_ps void @test_wmma_scale_bf16_16x16x128_f8f6f4_ii(<16 x i32> %A, <16 x i32> %B, <8 x bfloat> %C, ptr addrspace(1) %out) {
; GFX1210-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ii:
; GFX1210:       ; %bb.0: ; %bb
; GFX1210-NEXT:    v_mov_b32_e32 v38, 0x64
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v38, 4 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_WORD1_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GFX1210-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
;
; GISEL-LABEL: test_wmma_scale_bf16_16x16x128_f8f6f4_ii:
; GISEL:       ; %bb.0: ; %bb
; GISEL-NEXT:    v_dual_lshrrev_b32 v38, 16, v32 :: v_dual_lshrrev_b32 v39, 16, v33
; GISEL-NEXT:    v_dual_lshrrev_b32 v40, 16, v34 :: v_dual_lshrrev_b32 v41, 16, v35
; GISEL-NEXT:    v_and_b32_e32 v32, 0xffff, v32
...
; GISEL-NEXT:    v_or_b32_e32 v35, v41, v35
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_wmma_scale_bf16_16x16x128_f8f6f4 v[32:35], v[0:15], v[16:31], v[32:35], v38, 4 matrix_a_fmt:MATRIX_FMT_BF6 matrix_b_fmt:MATRIX_FMT_FP4 matrix_a_scale:MATRIX_SCALE_WORD1_BYTE1 matrix_b_scale:MATRIX_SCALE_ROW1_WORD1
; GISEL-NEXT:    global_store_b128 v[36:37], v[32:35], off
; GISEL-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GISEL-NEXT:    s_endpgm
bb:
  %res = call <8 x bfloat> @llvm.amdgcn.wmma.scale.bf16.16x16x128.f8f6f4.v8bf16.v16i32(i32 3, <16 x i32> %A, i32 4, <16 x i32> %B, i16 0, <8 x bfloat> %C, i32 6, i32 100, i32 3, i32 4)
  store <8 x bfloat> %res, ptr addrspace(1) %out
  ret void
}
