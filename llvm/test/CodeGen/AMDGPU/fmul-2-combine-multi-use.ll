...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_fma_f32 v2, s2, 2.0, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_load_dword s1, s[8:9], 0x10
; GFX10-NEXT:    v_mov_b32_e32 v0, 0
; GFX10-NEXT:    ; kill: killed $sgpr8_sgpr9
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_load_b32 s1, s[4:5], 0x10
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
...
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, 0
...
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX11-DENORM-TRUE16-NEXT:    s_lshr_b32 s1, s2, 16
...
; GFX11-DENORM-TRUE16-NEXT:    v_cmp_gt_f16_e64 s1, |v0.l|, |v0.h|
; GFX11-DENORM-TRUE16-NEXT:    v_cndmask_b16 v0.l, v0.h, v0.l, s1
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s1, 0
; GFX11-DENORM-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-FLUSH-TRUE16-NEXT:    s_lshr_b32 s1, s2, 16
...
; GFX11-FLUSH-TRUE16-NEXT:    v_cmp_gt_f16_e64 s1, |v0.l|, |v0.h|
; GFX11-FLUSH-TRUE16-NEXT:    v_cndmask_b16 v0.l, v0.h, v0.l, s1
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s1, 0
; GFX11-FLUSH-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; VI-DENORM-NEXT:    s_addc_u32 s5, 0, 0
; VI-DENORM-NEXT:    flat_store_short v[0:1], v2
...
; VI-FLUSH-NEXT:    s_addc_u32 s5, 0, 0
; VI-FLUSH-NEXT:    flat_store_short v[0:1], v2
...
; GFX10-DENORM-NEXT:    v_fma_f16 v2, s2, 2.0, s1
; GFX10-DENORM-NEXT:    s_mov_b32 s1, 0
...
; GFX10-FLUSH-NEXT:    s_lshr_b32 s1, s2, 16
; GFX10-FLUSH-NEXT:    v_add_f16_e32 v2, s1, v0
; GFX10-FLUSH-NEXT:    s_mov_b32 s1, 0
; GFX10-FLUSH-NEXT:    global_store_short v1, v0, s[0:1]
...
; GFX11-DENORM-TRUE16-NEXT:    v_fma_f16 v0.h, s2, 2.0, s1
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s1, 0
...
; GFX11-DENORM-FAKE16-NEXT:    v_fma_f16 v2, s2, 2.0, s1
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s1, 0
...
; GFX11-FLUSH-FAKE16-NEXT:    v_add_f16_e32 v2, s1, v0
; GFX11-FLUSH-FAKE16-NEXT:    s_mov_b32 s1, 0
...
; VI-DENORM-NEXT:    v_mov_b32_e32 v0, s3
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, s5
; VI-DENORM-NEXT:    v_fma_f16 v2, |s2|, 2.0, v1
; VI-DENORM-NEXT:    v_fma_f16 v3, |s2|, 2.0, v0
; VI-DENORM-NEXT:    v_mov_b32_e32 v0, s0
; VI-DENORM-NEXT:    s_add_u32 s4, s0, 2
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, s1
...
; VI-FLUSH-NEXT:    v_mov_b32_e32 v0, s3
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, s5
; VI-FLUSH-NEXT:    v_mad_f16 v2, |s2|, 2.0, v1
; VI-FLUSH-NEXT:    v_mad_f16 v3, |s2|, 2.0, v0
; VI-FLUSH-NEXT:    v_mov_b32_e32 v0, s0
; VI-FLUSH-NEXT:    s_add_u32 s4, s0, 2
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX10-DENORM-NEXT:    v_fma_f16 v1, |s2|, 2.0, s1
; GFX10-DENORM-NEXT:    s_mov_b32 s1, 0
; GFX10-DENORM-NEXT:    global_store_short v0, v1, s[0:1]
; GFX10-DENORM-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-DENORM-NEXT:    global_store_short v0, v2, s[0:1] offset:2
...
; GFX11-DENORM-TRUE16-NEXT:    v_fma_f16 v0.l, |s2|, 2.0, s1
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s1, 0
; GFX11-DENORM-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1] dlc
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-DENORM-TRUE16-NEXT:    global_store_d16_hi_b16 v1, v0, s[0:1] offset:2 dlc
...
; GFX11-DENORM-FAKE16-NEXT:    v_fma_f16 v1, |s2|, 2.0, s1
; GFX11-DENORM-FAKE16-NEXT:    s_mov_b32 s1, 0
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v0, v1, s[0:1] dlc
; GFX11-DENORM-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-DENORM-FAKE16-NEXT:    global_store_b16 v0, v2, s[0:1] offset:2 dlc
