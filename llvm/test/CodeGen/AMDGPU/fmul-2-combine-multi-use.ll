...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,GFX8_10_11,GFX10PLUS-DENORM,GFX10,GFX10-DENORM %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1010 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,GFX8_10_11,GFX10PLUS-FLUSH,GFX10,GFX10-FLUSH %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,GFX8_10_11,GFX10PLUS-DENORM,GFX11,GFX11-DENORM %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX10PLUS,GFX8_10_11,GFX10PLUS-FLUSH,GFX11,GFX11-FLUSH %s
XFAIL:*
...
; GFX8_10_11: v_add_f32_e64 v{{[0-9]+}}, s{{[0-9]+}}, -1.0
; GFX8_10_11: v_add_f32_e64 v{{[0-9]+}}, s{{[0-9]+}}, -1.0
; GFX8_10_11: v_cmp_gt_f32_e64 {{vcc|vcc_lo}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; GFX8_10_11: v_cndmask_b32_e32
; GFX8_10_11: v_add_f32_e64 v{{[0-9]+}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; GFX8_10_11: v_mul_f32_e32 v{{[0-9]+}}, v{{[0-9]+}}, v{{[0-9]+}}
; VI:         v_mad_f32 v{{[0-9]+}}, -v{{[0-9]+}}, v{{[0-9]+}}, 1.0
; GFX10PLUS:  v_fma_f32 v{{[0-9]+}}, -v{{[0-9]+}}, v{{[0-9]+}}, 1.0
...
; GFX10PLUS-DAG: v_fma_f32 [[MAD:v[0-9]+]], [[X]], 2.0, s{{[0-9]+}}
...
; GFX10PLUS: v_fma_f32 {{v[0-9]+}}, |[[X:s[0-9]+]]|, 2.0, {{s[0-9]+}}
; GFX10PLUS: v_fma_f32 {{v[0-9]+}}, |[[X]]|, 2.0, {{s[0-9]+}}
...
; GFX10PLUS: v_mul_f32_e64 [[TMP0:v[0-9]+]], 0xc0c00000, [[X:s[0-9]+]]
; GCN:       v_mul_f32_e32 [[RESULT:v[0-9]+]], [[X]], [[TMP0]]
; GCN:       buffer_store_{{dword|b32}} [[RESULT]]
...
; VI:       v_add_f16_e64 v{{[0-9]+}}, s{{[0-9]+}}, -1.0
; VI:       v_cmp_gt_f16_e64 {{vcc|vcc_lo}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; VI:       v_cndmask_b32_e32
; VI:       v_add_f16_e64 v{{[0-9]+}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; VI:       v_mul_f16_e32 v{{[0-9]+}}, v{{[0-9]+}}, v{{[0-9]+}}

; GFX10:       v_add_f16_e64 v{{[0-9]+}}, s{{[0-9]+}}, -1.0
; GFX10:       v_add_f16_e64 v{{[0-9]+}}, s{{[0-9]+}}, -1.0
; GFX10:       v_cmp_gt_f16_e64 {{vcc|vcc_lo}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; GFX10:       v_cndmask_b32_e32
; GFX10:       v_add_f16_e64 v{{[0-9]+}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; GFX10:       v_mul_f16_e32 v{{[0-9]+}}, v{{[0-9]+}}, v{{[0-9]+}}

; GFX11:       v_add_f16_e32 v{{[0-9]+\.[lh]}}, s{{[0-9]+}}, v{{[0-9]+\.[lh]}}
; GFX11:       v_add_f16_e32 v{{[0-9]+\.[lh]}}, s{{[0-9]+}}, v{{[0-9]+\.[lh]}}
; GFX11:       v_cmp_gt_f16_e64 {{vcc|vcc_lo}}, |v{{[0-9]+}}|, |v{{[0-9]+}}|
; GFX11:       v_cndmask_b32_e32
; GFX11:       v_add_f16_e64 v{{[0-9]+\.[lh]}}, |v{{[0-9]+\.[lh]}}|, |v{{[0-9]+\.[lh]}}|
; GFX11:       v_mul_f16_e32 v{{[0-9]+}}, v{{[0-9]+}}, v{{[0-9]+}}

; VI-FLUSH:         v_mad_f16 v{{[0-9]+}}, -v{{[0-9]+}}, v{{[0-9]+}}, 1.0
; VI-DENORM:        v_fma_f16 v{{[0-9]+}}, -v{{[0-9]+}}, v{{[0-9]+}}, 1.0
; GFX10PLUS-DENORM: v_fma_f16 v{{[0-9]+}}, -v{{[0-9]+}}, v{{[0-9]+}}, 1.0
; GFX10PLUS-FLUSH:  v_sub_f16_e32 v{{[0-9]+}}, 1.0, v{{[0-9]+}}
...
; VI-DAG:    v_add_f16_e64 [[MUL2:v[0-9]+]], [[X:s[0-9]+]], s{{[0-9]+}}
; GFX10-DAG: v_add_f16_e64 [[MUL2:v[0-9]+]], [[X:s[0-9]+]], s{{[0-9]+}}
; GFX11-DAG: v_add_f16_e64 [[MUL2:v[0-9]+\.[lh]]], [[X:s[0-9]+]], s{{[0-9]+}}
...
; GFX11-FLUSH-DAG:       v_add_f16_e32 [[MAD:v[0-9]+\.[lh]]], s{{[0-9]+}}, [[MUL2]]
; GFX11-DENORM-DAG:        v_fma_f16 [[MAD:v[0-9]+]], [[X]], 2.0, s{{[0-9]+}}

; VI-DAG: buffer_store_{{short|b16}} [[MUL2]]
; GFX10-DAG: buffer_store_{{short|b16}} [[MUL2]]
; GFX11-DAG: buffer_store_{{short|b16}} {{v[0-9]+}}

; GCN-DAG: buffer_store_{{short|b16}} {{v[0-9]+}}
; GCN: s_endpgm
...
; GFX10-FLUSH-DAG:  v_add_f16_e32 [[MAD:v[0-9]+]], s{{[0-9]+}}, [[MUL2]]
; GFX11-FLUSH-DAG:  v_add_f16_e32 [[MAD:v[0-9]+\.[lh]]], s{{[0-9]+}}, [[MUL2]]
; GFX10PLUS-DENORM-DAG: v_fma_f16 [[MAD:v[0-9]+]], |[[X]]|, 2.0, s{{[0-9]+}}
...
; GFX10-FLUSH:  v_add_f16_e32 {{v[0-9]+}}, {{s[0-9]+}}, [[MUL2]]
; GFX11-FLUSH:  v_add_f16_e64 [[MUL2:v[0-9]+\.[lh]]], |[[X:s[0-9]+]]|, |{{s[0-9]+}}|
; GFX11-FLUSH:  v_add_f16_e32 {{v[0-9]+\.[lh]}}, {{s[0-9]+}}, [[MUL2]]
; GFX11-FLUSH:  v_add_f16_e32 {{v[0-9]+\.[lh]}}, {{s[0-9]+}}, [[MUL2]]

; GFX10PLUS-DENORM: v_fma_f16 {{v[0-9]+}}, |[[X:s[0-9]+]]|, 2.0, s{{[0-9]+}}
; GFX10PLUS-DENORM: v_fma_f16 {{v[0-9]+}}, |[[X]]|, 2.0, s{{[0-9]+}}
...
; GFX10PLUS: v_mul_f16_e64 [[TMP0:v[0-9]+]], 0xc600, [[X:s[0-9]+]]
; GCN:       v_mul_f16_e32 [[RESULT:v[0-9]+]], [[X]], [[TMP0]]
; GCN:       buffer_store_{{short|b16}} [[RESULT]]
