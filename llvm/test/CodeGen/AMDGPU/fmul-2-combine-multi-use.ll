...
; RUN: llc -mtriple=amdgpu8.02-amd-amdhsa -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=VI,VI-DENORM %s
; RUN: llc -mtriple=amdgpu8.02-amd-amdhsa -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=VI,VI-FLUSH %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX10,GFX10-DENORM %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX10,GFX10-FLUSH %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -mattr=+real-true16 -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11-DENORM,GFX11-DENORM-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -mattr=-real-true16 -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16,GFX11-DENORM,GFX11-DENORM-FAKE16 %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -mattr=+real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11-FLUSH,GFX11-FLUSH-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -mattr=-real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign  < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16,GFX11-FLUSH,GFX11-FLUSH-FAKE16 %s
...
; VI-NEXT:    v_add_f32_e64 v2, s3, -1.0
; VI-NEXT:    v_add_f32_e64 v3, s2, -1.0
; VI-NEXT:    v_cmp_gt_f32_e64 vcc, |v2|, |v3|
; VI-NEXT:    v_cndmask_b32_e32 v2, v3, v2, vcc
; VI-NEXT:    v_add_f32_e64 v2, |v2|, |v2|
; VI-NEXT:    v_mul_f32_e32 v3, v2, v2
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mad_f32 v2, -v3, v2, 1.0
...
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mac_f32_e64 v3, s2, 2.0
; VI-NEXT:    flat_store_dword v[0:1], v2
...
; GFX10-NEXT:    ; kill: killed $sgpr8_sgpr9
...
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mul_f32_e32 v2, s2, v2
; VI-NEXT:    flat_store_dword v[0:1], v2
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    s_endpgm
;
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; VI-NEXT:    v_mov_b32_e32 v2, 0xc0c00000
; VI-NEXT:    s_add_i32 s12, s12, s17
; VI-NEXT:    s_mov_b32 flat_scratch_lo, s13
; VI-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-DENORM-NEXT:    s_lshr_b32 s0, s2, 16
; VI-DENORM-NEXT:    v_add_f16_e64 v2, s2, -1.0
; VI-DENORM-NEXT:    v_add_f16_e64 v3, s0, -1.0
; VI-DENORM-NEXT:    v_cmp_gt_f16_e64 vcc, |v3|, |v2|
; VI-DENORM-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; VI-DENORM-NEXT:    v_add_f16_e64 v2, |v2|, |v2|
; VI-DENORM-NEXT:    v_mul_f16_e32 v3, v2, v2
; VI-DENORM-NEXT:    v_mov_b32_e32 v1, s1
; VI-DENORM-NEXT:    v_fma_f16 v2, -v3, v2, 1.0
...
; VI-FLUSH-NEXT:    s_lshr_b32 s0, s2, 16
; VI-FLUSH-NEXT:    v_add_f16_e64 v2, s2, -1.0
; VI-FLUSH-NEXT:    v_add_f16_e64 v3, s0, -1.0
; VI-FLUSH-NEXT:    v_cmp_gt_f16_e64 vcc, |v3|, |v2|
; VI-FLUSH-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; VI-FLUSH-NEXT:    v_add_f16_e64 v2, |v2|, |v2|
; VI-FLUSH-NEXT:    v_mul_f16_e32 v3, v2, v2
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, s1
; VI-FLUSH-NEXT:    v_mad_f16 v2, -v3, v2, 1.0
...
; GFX10-DENORM-NEXT:    v_add_f16_e64 v0, s2, -1.0
; GFX10-DENORM-NEXT:    v_add_f16_e64 v1, s3, -1.0
...
; GFX10-FLUSH-NEXT:    s_lshr_b32 s3, s2, 16
; GFX10-FLUSH-NEXT:    v_add_f16_e64 v0, s2, -1.0
; GFX10-FLUSH-NEXT:    v_add_f16_e64 v1, s3, -1.0
...
; GFX11-DENORM-TRUE16-NEXT:    v_add_f16_e64 v0.h, s2, -1.0
; GFX11-DENORM-TRUE16-NEXT:    v_add_f16_e64 v0.l, s3, -1.0
...
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e64 v0, s2, -1.0
; GFX11-DENORM-FAKE16-NEXT:    v_add_f16_e64 v1, s3, -1.0
...
; GFX11-FLUSH-TRUE16-NEXT:    s_lshr_b32 s3, s2, 16
; GFX11-FLUSH-TRUE16-NEXT:    v_add_f16_e64 v0.h, s2, -1.0
; GFX11-FLUSH-TRUE16-NEXT:    v_add_f16_e64 v0.l, s3, -1.0
; GFX11-FLUSH-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FLUSH-TRUE16-NEXT:    v_cmp_gt_f16_e64 s2, |v0.l|, |v0.h|
; GFX11-FLUSH-TRUE16-NEXT:    v_cndmask_b16 v0.l, v0.h, v0.l, s2
; GFX11-FLUSH-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-FLUSH-FAKE16-NEXT:    s_lshr_b32 s3, s2, 16
; GFX11-FLUSH-FAKE16-NEXT:    v_add_f16_e64 v0, s2, -1.0
; GFX11-FLUSH-FAKE16-NEXT:    v_add_f16_e64 v1, s3, -1.0
...
; VI-DENORM-NEXT:    v_add_f16_e64 v2, s2, s2
; VI-DENORM-NEXT:    v_mov_b32_e32 v3, s3
; VI-DENORM-NEXT:    s_addc_u32 s1, s1, 0
; VI-DENORM-NEXT:    v_fma_f16 v3, s2, 2.0, v3
; VI-DENORM-NEXT:    flat_store_short v[0:1], v2
...
; VI-FLUSH-NEXT:    v_add_f16_e64 v2, s2, s2
; VI-FLUSH-NEXT:    v_mov_b32_e32 v3, s3
; VI-FLUSH-NEXT:    s_addc_u32 s1, s1, 0
; VI-FLUSH-NEXT:    v_mac_f16_e64 v3, s2, 2.0
; VI-FLUSH-NEXT:    flat_store_short v[0:1], v2
...
; VI-FLUSH-NEXT:    v_mov_b32_e32 v3, s3
; VI-FLUSH-NEXT:    s_addc_u32 s1, s1, 0
; VI-FLUSH-NEXT:    v_mad_f16 v3, |s2|, 2.0, v3
; VI-FLUSH-NEXT:    flat_store_short v[0:1], v2
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    v_mov_b32_e32 v0, s0
; VI-FLUSH-NEXT:    v_mov_b32_e32 v1, s1
...
; VI-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mul_f16_e64 v2, s2, -4.0
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    v_mov_b32_e32 v1, s1
; VI-NEXT:    v_mul_f16_e32 v2, s2, v2
...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; VI-NEXT:    v_mov_b32_e32 v2, 0xc600
; VI-NEXT:    s_add_i32 s12, s12, s17
; VI-NEXT:    s_mov_b32 flat_scratch_lo, s13
; VI-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; VI-NEXT:    s_waitcnt lgkmcnt(0)
