...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_f32__nnan_src0:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e32 v0, 1.0, v0
; GFX942-NEXT:    v_max_f32_e32 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v1
; GFX942-NEXT:    s_nop 1
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_f32__nnan_src1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_add_f32_e32 v1, 1.0, v1
; GFX942-NEXT:    v_max_f32_e32 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v1
; GFX942-NEXT:    s_nop 1
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v2f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v2f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v4, v0, v2
; GFX942-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v2f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v2
; GFX942-NEXT:    v_max_f32_e32 v1, v1, v3
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: s_maximum_v2f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v0, s3
; GFX942-NEXT:    v_max_f32_e32 v1, s1, v0
; GFX942-NEXT:    v_mov_b32_e32 v2, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, s1, v0
; GFX942-NEXT:    v_mov_b32_e32 v0, s2
; GFX942-NEXT:    v_max_f32_e32 v3, s0, v0
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v3f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v3f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v6, v0, v3
; GFX942-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v3f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v3
; GFX942-NEXT:    v_max_f32_e32 v1, v1, v4
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v4f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v8, v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v9, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v4
; GFX942-NEXT:    v_max_f32_e32 v4, v1, v5
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v9, v8, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v1, v5
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v9, v4, vcc
; GFX942-NEXT:    v_max_f32_e32 v4, v2, v6
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v6
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v9, v4, vcc
; GFX942-NEXT:    v_max_f32_e32 v4, v3, v7
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v3, v7
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v9, v4, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v4f32__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v4
; GFX942-NEXT:    v_max_f32_e32 v1, v1, v5
; GFX942-NEXT:    v_max_f32_e32 v2, v2, v6
; GFX942-NEXT:    v_max_f32_e32 v3, v3, v7
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v4f32__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v8, v0, v4
; GFX942-NEXT:    v_mov_b32_e32 v9, 0x7fc00000
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v4f32__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v4
; GFX942-NEXT:    v_max_f32_e32 v1, v1, v5
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v8f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v16, v0, v8
; GFX942-NEXT:    v_mov_b32_e32 v17, 0x7fc00000
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v8
; GFX942-NEXT:    v_max_f32_e32 v8, v1, v9
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v17, v16, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v1, v9
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v2, v10
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v10
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v3, v11
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v3, v11
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v4, v12
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v4, v12
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v4, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v5, v13
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v5, v13
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v5, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v6, v14
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v6, v14
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v6, v17, v8, vcc
; GFX942-NEXT:    v_max_f32_e32 v8, v7, v15
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v7, v15
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v7, v17, v8, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_maximum_v16f32:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    scratch_load_dword v31, off, s32
; GFX942-NEXT:    v_mov_b32_e32 v32, 0x7fc00000
; GFX942-NEXT:    v_max_f32_e32 v33, v0, v16
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v0, v16
; GFX942-NEXT:    v_max_f32_e32 v34, v1, v17
; GFX942-NEXT:    v_max_f32_e32 v35, v2, v18
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v32, v33, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v1, v17
; GFX942-NEXT:    v_max_f32_e32 v36, v3, v19
; GFX942-NEXT:    v_max_f32_e32 v37, v4, v20
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v32, v34, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v2, v18
; GFX942-NEXT:    v_max_f32_e32 v38, v5, v21
; GFX942-NEXT:    v_max_f32_e32 v39, v6, v22
; GFX942-NEXT:    v_cndmask_b32_e32 v2, v32, v35, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v3, v19
; GFX942-NEXT:    v_max_f32_e32 v48, v7, v23
; GFX942-NEXT:    v_max_f32_e32 v49, v8, v24
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v32, v36, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v4, v20
; GFX942-NEXT:    v_max_f32_e32 v50, v9, v25
; GFX942-NEXT:    v_max_f32_e32 v51, v10, v26
; GFX942-NEXT:    v_cndmask_b32_e32 v4, v32, v37, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v5, v21
; GFX942-NEXT:    v_max_f32_e32 v52, v11, v27
; GFX942-NEXT:    v_max_f32_e32 v53, v12, v28
; GFX942-NEXT:    v_cndmask_b32_e32 v5, v32, v38, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v6, v22
; GFX942-NEXT:    v_max_f32_e32 v54, v13, v29
; GFX942-NEXT:    v_max_f32_e32 v55, v14, v30
; GFX942-NEXT:    v_cndmask_b32_e32 v6, v32, v39, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v7, v23
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v16, v15, v31
; GFX942-NEXT:    v_cndmask_b32_e32 v7, v32, v48, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v8, v24
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v8, v32, v49, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v9, v25
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v9, v32, v50, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v10, v26
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v10, v32, v51, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v11, v27
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v11, v32, v52, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v12, v28
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v12, v32, v53, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v13, v29
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v13, v32, v54, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v14, v30
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v14, v32, v55, vcc
; GFX942-NEXT:    v_cmp_o_f32_e32 vcc, v15, v31
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v15, v32, v16, vcc
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
