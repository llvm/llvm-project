...
; GFX11-NEXT:    v_max_f16_e32 v5, v0, v2
; GFX11-NEXT:    v_cndmask_b32_e32 v6, 0x7e00, v4, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_max_f16_e32 v3, v0, v6
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v6
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v3, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v2
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_pk_max_f16 v8, v2, v6
...
; GFX11-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v8, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_perm_b32 v6, v2, v9, 0x5040100
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v10, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v12, v11
; GFX11-NEXT:    v_pk_max_f16 v10, v3, v7
; GFX11-NEXT:    v_pk_max_f16 v12, v1, v5
; GFX11-NEXT:    v_cndmask_b32_e32 v4, 0x7e00, v13, vcc_lo
...
; GFX11-NEXT:    v_perm_b32 v8, v4, v0, 0x5040100
; GFX11-NEXT:    v_lshrrev_b32_e32 v15, 16, v12
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_pk_max_f16 v6, v8, v6
; GFX11-NEXT:    v_cndmask_b32_e32 v8, 0x7e00, v10, vcc_lo
; GFX11-NEXT:    v_lshrrev_b32_e32 v10, 16, v10
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v3, v7
; GFX11-NEXT:    v_lshrrev_b32_e32 v11, 16, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-NEXT:    v_cndmask_b32_e32 v3, 0x7e00, v10, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v5
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v12, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v14, v13
; GFX11-NEXT:    v_cndmask_b32_e32 v5, 0x7e00, v15, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v9
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v6, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4, v2
; GFX11-NEXT:    v_perm_b32 v4, v3, v8, 0x5040100
; GFX11-NEXT:    v_perm_b32 v6, v5, v1, 0x5040100
; GFX11-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v11, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_pk_max_f16 v4, v6, v4
; GFX11-NEXT:    v_max_f16_e32 v7, v0, v2
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v2
...
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v1, v8
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v4, vcc_lo
; GFX11-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; GFX11-NEXT:    v_max_f16_e32 v2, v0, v1
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v1
...
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v2, vcc_lo
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v5, v3
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v4, vcc_lo
; GFX11-NEXT:    v_max_f16_e32 v2, v0, v1
; GFX11-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
