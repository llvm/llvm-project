...
; GFX11-SDAG-TRUE16-NEXT:    v_pk_max_f16 v6, v0, v2
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0.l, v2.l
...
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x7e00, v6.l, vcc_lo
...
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s0, v0.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    v_max_f16_e32 v0.l, v0.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x7e00, v1.l, vcc_lo
...
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s0, v9.l, v8.l
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 16, v2
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s1, v0.l, v4.l
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s2, v10.l, v6.l
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v11
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v2.l, 0x7e00, v2.l, vcc_lo
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v2.h, 0x7e00, v8.l, s0
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v4.l, 0x7e00, v11.l, s1
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s0, v3.l, v7.l
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v4.h, 0x7e00, v0.l, s2
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 16, v1
; GFX11-SDAG-TRUE16-NEXT:    v_pk_max_f16 v9, v1, v5
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4.l, v2.l
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s2, v1.l, v5.l
; GFX11-SDAG-TRUE16-NEXT:    v_pk_max_f16 v6, v4, v2
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v9
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x7e00, v6.l, vcc_lo
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v4.h, v2.h
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v7
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v3
; GFX11-SDAG-TRUE16-NEXT:    v_pk_max_f16 v3, v3, v7
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v5
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v6
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s1, v4.l, v2.l
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v3
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s3, v8.l, v7.l
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v0.h, 0x7e00, v6.l, vcc_lo
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v3.l, 0x7e00, v3.l, s0
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4)
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v3.h, 0x7e00, v2.l, s1
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v2.l, 0x7e00, v9.l, s2
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v2.h, 0x7e00, v1.l, s3
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e32 vcc_lo, v0.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    v_max_f16_e32 v0.l, v0.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s0, v2.l, v3.l
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-SDAG-TRUE16-NEXT:    v_pk_max_f16 v1, v2, v3
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0x7e00, v0.l, vcc_lo
...
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_o_f16_e64 s0, v2.h, v3.h
