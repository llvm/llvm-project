...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 %s -o - | FileCheck -check-prefixes=GFX-TRUE16,GFX-SDAG-TRUE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 %s -o - | FileCheck -check-prefixes=GFX-FAKE16,GFX-SDAG-FAKE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 %s -o - | FileCheck -check-prefixes=GFX-TRUE16,GFX-GISEL-TRUE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 %s -o - | FileCheck -check-prefixes=GFX-FAKE16,GFX-GISEL-FAKE16 %s

define bfloat @v_log2_bf16(bfloat %in) {
; GFX-TRUE16-LABEL: v_log2_bf16:
; GFX-TRUE16:       ; %bb.0:
...
;
; GFX-FAKE16-LABEL: v_log2_bf16:
; GFX-FAKE16:       ; %bb.0:
; GFX-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-FAKE16-NEXT:    v_log_bf16_e32 v0, v0
; GFX-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
  %result = call bfloat @llvm.log2.bf16(bfloat %in)
  ret bfloat %result
}

define bfloat @v_log2_fabs_bf16(bfloat %in) {
; GFX-TRUE16-LABEL: v_log2_fabs_bf16:
; GFX-TRUE16:       ; %bb.0:
; GFX-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-TRUE16-NEXT:    v_log_bf16_e64 v0.l, |v0.l|
; GFX-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-FAKE16-LABEL: v_log2_fabs_bf16:
; GFX-FAKE16:       ; %bb.0:
; GFX-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-FAKE16-NEXT:    v_log_bf16_e64 v0, |v0|
; GFX-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX-TRUE16-LABEL: v_log2_fneg_fabs_bf16:
; GFX-TRUE16:       ; %bb.0:
; GFX-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-TRUE16-NEXT:    v_log_bf16_e64 v0.l, -|v0.l|
; GFX-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-FAKE16-LABEL: v_log2_fneg_fabs_bf16:
; GFX-FAKE16:       ; %bb.0:
; GFX-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-FAKE16-NEXT:    v_log_bf16_e64 v0, -|v0|
...
; GFX-TRUE16-LABEL: v_log2_fneg_bf16:
; GFX-TRUE16:       ; %bb.0:
; GFX-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-TRUE16-NEXT:    v_log_bf16_e64 v0.l, -v0.l
; GFX-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-FAKE16-LABEL: v_log2_fneg_bf16:
; GFX-FAKE16:       ; %bb.0:
; GFX-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-FAKE16-NEXT:    v_log_bf16_e64 v0, -v0
...
; GFX-TRUE16-LABEL: v_log2_bf16_fast:
; GFX-TRUE16:       ; %bb.0:
; GFX-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-TRUE16-NEXT:    v_log_bf16_e32 v0.l, v0.l
; GFX-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-FAKE16-LABEL: v_log2_bf16_fast:
; GFX-FAKE16:       ; %bb.0:
; GFX-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-FAKE16-NEXT:    v_log_bf16_e32 v0, v0
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fabs_v2bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_and_b32_e32 v0, 0x7fff7fff, v0
; GFX-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.l, v0.l
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.h, v0.h
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fabs_v2bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fneg_fabs_v2bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_or_b32_e32 v0, 0x80008000, v0
; GFX-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.l, v0.l
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.h, v0.h
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fneg_fabs_v2bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fneg_v2bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_xor_b32_e32 v0, 0x80008000, v0
; GFX-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.l, v0.l
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.h, v0.h
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fneg_v2bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
