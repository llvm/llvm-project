...
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 %s -o - | FileCheck -check-prefix=GFX-SDAG-TRUE16 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 %s -o - | FileCheck -check-prefix=GFX-SDAG-FAKE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=+real-true16 %s -o - | FileCheck -check-prefix=GFX-GISEL-TRUE16 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu12.50-amd-amdhsa -mattr=-real-true16 %s -o - | FileCheck -check-prefix=GFX-GISEL-FAKE16 %s
...
;
; GFX-GISEL-TRUE16-LABEL: v_log2_bf16:
...
;
; GFX-GISEL-FAKE16-LABEL: v_log2_bf16:
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fabs_bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e64 v0.l, |v0.l|
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fabs_bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-FAKE16-NEXT:    v_log_bf16_e64 v0, |v0|
; GFX-GISEL-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fneg_fabs_bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e64 v0.l, -|v0.l|
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fneg_fabs_bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-FAKE16-NEXT:    v_log_bf16_e64 v0, -|v0|
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_fneg_bf16:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e64 v0.l, -v0.l
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_fneg_bf16:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-FAKE16-NEXT:    v_log_bf16_e64 v0, -v0
...
; GFX-SDAG-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-TRUE16-LABEL: v_log2_bf16_fast:
; GFX-GISEL-TRUE16:       ; %bb.0:
; GFX-GISEL-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-TRUE16-NEXT:    v_log_bf16_e32 v0.l, v0.l
; GFX-GISEL-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX-GISEL-FAKE16-LABEL: v_log2_bf16_fast:
; GFX-GISEL-FAKE16:       ; %bb.0:
; GFX-GISEL-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX-GISEL-FAKE16-NEXT:    v_log_bf16_e32 v0, v0
