...
; GFX12-PACKED-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX12-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-NEXT:    s_and_b32 s4, s7, 0xffff
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v0, s6
...
; GFX12-PACKED-SDAG-NEXT:    s_and_b32 s4, s10, 0xffff
; GFX12-PACKED-SDAG-NEXT:    s_and_b32 s5, s9, 0xffff
; GFX12-PACKED-SDAG-NEXT:    v_mov_b32_e32 v0, s8
; GFX12-PACKED-SDAG-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-PACKED-SDAG-NEXT:    v_mov_b32_e32 v2, s4
...
; GFX12-PACKED-GISEL-NEXT:    s_and_b32 s4, s10, 0xffff
; GFX12-PACKED-GISEL-NEXT:    v_mov_b32_e32 v0, s8
; GFX12-PACKED-GISEL-NEXT:    v_mov_b32_e32 v1, s9
; GFX12-PACKED-GISEL-NEXT:    v_mov_b32_e32 v2, s4
...
; GFX12-PACKED-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX12-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-NEXT:    s_and_b32 s4, s10, 0xffff
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v0, s8
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v1, s9
; GFX12-PACKED-NEXT:    v_mov_b32_e32 v2, s4
