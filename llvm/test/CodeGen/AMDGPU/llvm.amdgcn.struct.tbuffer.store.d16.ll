...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-SDAG,GFX13-PACKED-SDAG-TRUE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=-real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-SDAG,GFX13-PACKED-SDAG-FAKE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-SDAG,GFX13-PACKED-SDAG-TRUE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=-real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-SDAG,GFX13-PACKED-SDAG-FAKE16 %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-GISEL,GFX13-PACKED-GISEL-TRUE16 %s
; RUN: llc -global-isel -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=-real-true16 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13-PACKED,GFX13-PACKED-GISEL,GFX13-PACKED-GISEL-FAKE16 %s
...
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-SDAG-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-TRUE16-NEXT:    v_mov_b16_e32 v0.l, s6
; GFX13-PACKED-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v1, s7
; GFX13-PACKED-SDAG-TRUE16-NEXT:    tbuffer_store_d16_format_x v0, v1, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
...
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-SDAG-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v0, s6
; GFX13-PACKED-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v1, s7
; GFX13-PACKED-SDAG-FAKE16-NEXT:    tbuffer_store_d16_format_x v0, v1, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
...
; GFX13-PACKED-GISEL-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX13-PACKED-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
...
; GFX13-PACKED-GISEL-NEXT:    tbuffer_store_d16_format_x v0, v1, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
...
; GFX13-PACKED-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10
; GFX13-PACKED-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, s6
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v1, s7
; GFX13-PACKED-NEXT:    tbuffer_store_d16_format_xy v0, v1, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
...
; GFX13-PACKED-SDAG-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10
; GFX13-PACKED-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-SDAG-NEXT:    s_and_b64 s[4:5], s[8:9], lit64(0xffffffffffff)
; GFX13-PACKED-SDAG-NEXT:    v_mov_b32_e32 v2, s10
; GFX13-PACKED-SDAG-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-PACKED-SDAG-NEXT:    v_mov_b32_e32 v1, s5
; GFX13-PACKED-SDAG-NEXT:    tbuffer_store_d16_format_xyz v[0:1], v2, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
; GFX13-PACKED-SDAG-NEXT:    s_endpgm
;
; GFX13-PACKED-GISEL-LABEL: tbuffer_store_d16_xyz:
; GFX13-PACKED-GISEL:       ; %bb.0: ; %main_body
; GFX13-PACKED-GISEL-NEXT:    s_clause 0x1
; GFX13-PACKED-GISEL-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10
; GFX13-PACKED-GISEL-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-GISEL-NEXT:    s_pack_lh_b32_b16 s8, s8, s8
; GFX13-PACKED-GISEL-NEXT:    v_mov_b32_e32 v2, s10
; GFX13-PACKED-GISEL-NEXT:    v_mov_b32_e32 v0, s8
; GFX13-PACKED-GISEL-NEXT:    v_mov_b32_e32 v1, s9
; GFX13-PACKED-GISEL-NEXT:    tbuffer_store_d16_format_xyzw v[0:1], v2, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
; GFX13-PACKED-GISEL-NEXT:    s_endpgm
main_body:
...
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    s_clause 0x1
; GFX13-PACKED-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10
; GFX13-PACKED-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX13-PACKED-NEXT:    s_wait_kmcnt 0x0
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, s8
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v1, s9
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v2, s10
; GFX13-PACKED-NEXT:    tbuffer_store_d16_format_xyzw v[0:1], v2, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
; GFX13-PACKED-NEXT:    s_endpgm
main_body:
