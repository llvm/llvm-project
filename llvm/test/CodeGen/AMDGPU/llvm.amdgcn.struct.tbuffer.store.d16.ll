...
;
; GFX12-PACKED-GISEL-TRUE16-LABEL: tbuffer_store_d16_xyz:
; GFX12-PACKED-GISEL-TRUE16:       ; %bb.0: ; %main_body
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_clause 0x1
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_lshr_b32 s4, s8, 16
; GFX12-PACKED-GISEL-TRUE16-NEXT:    v_mov_b32_e32 v2, s10
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_pack_ll_b32_b16 s8, s8, s4
; GFX12-PACKED-GISEL-TRUE16-NEXT:    v_mov_b32_e32 v1, s9
; GFX12-PACKED-GISEL-TRUE16-NEXT:    v_mov_b32_e32 v0, s8
; GFX12-PACKED-GISEL-TRUE16-NEXT:    tbuffer_store_d16_format_xyz v[0:1], v2, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
; GFX12-PACKED-GISEL-TRUE16-NEXT:    s_endpgm
;
; GFX12-PACKED-GISEL-FAKE16-LABEL: tbuffer_store_d16_xyz:
; GFX12-PACKED-GISEL-FAKE16:       ; %bb.0: ; %main_body
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_clause 0x1
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_load_b96 s[8:10], s[4:5], 0x10
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_pack_lh_b32_b16 s8, s8, s8
; GFX12-PACKED-GISEL-FAKE16-NEXT:    v_mov_b32_e32 v1, s9
; GFX12-PACKED-GISEL-FAKE16-NEXT:    v_mov_b32_e32 v0, s8
; GFX12-PACKED-GISEL-FAKE16-NEXT:    v_mov_b32_e32 v2, s10
; GFX12-PACKED-GISEL-FAKE16-NEXT:    tbuffer_store_d16_format_xyz v[0:1], v2, s[0:3], null format:[BUF_FMT_10_10_10_2_SNORM] idxen
; GFX12-PACKED-GISEL-FAKE16-NEXT:    s_endpgm
main_body:
