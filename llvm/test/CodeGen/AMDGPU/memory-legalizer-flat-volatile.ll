...
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    flat_store_b32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    s_endpgm
    ptr %in, ptr %out) {
entry:
...
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    flat_store_b32 v0, v1, s[0:1] scale_offset scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    s_endpgm
    ptr %in, ptr %out) {
entry:
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_volatile_workgroup_acquire_load:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_load_b64 s[2:3], s[0:1], 0x0
...
; GFX12-CU-NEXT:    s_endpgm
;
; GFX1210-LABEL: flat_volatile_workgroup_release_store:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_mov_b64 s[0:1], s[2:3]
