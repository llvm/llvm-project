...
; RUN: llc -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GFX10,GFX1010 %s
; RUN: llc -mtriple=amdgpu10.30 < %s | FileCheck -check-prefixes=GFX10,GFX1030 %s
