...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -global-isel -global-isel-abort=2 %s -o - | FileCheck -check-prefix=GFX1250-GISEL %s
...
; GFX1250-GISEL-NEXT:    s_bfe_u32 s0, ttmp6, 0x40004
...
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    s_mul_i32 s1, s1, s0
; GFX1250-GISEL-NEXT:    s_bfe_u32 s0, ttmp6, 0x40008
; GFX1250-GISEL-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, s0
; GFX1250-GISEL-NEXT:    global_store_b32 v[0:1], v2, off
...
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1250-GISEL-NEXT:    s_lshr_b32 s0, ttmp7, 15
; GFX1250-GISEL-NEXT:    s_bfe_u32 s1, ttmp6, 0x40008
; GFX1250-GISEL-NEXT:    s_and_b32 s0, s0, 0x1fffe
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    s_add_co_i32 s0, s1, s0
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, s0
; GFX1250-GISEL-NEXT:    global_store_b32 v[0:1], v2, off
