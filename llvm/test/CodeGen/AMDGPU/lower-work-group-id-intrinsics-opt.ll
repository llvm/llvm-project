...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 --verify-machineinstrs %s -o - | FileCheck -check-prefix=GFX1250-SDAG %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 -global-isel --verify-machineinstrs %s -o - | FileCheck -check-prefix=GFX1250-GISEL %s
