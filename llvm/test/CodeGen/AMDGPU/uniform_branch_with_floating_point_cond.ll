...
; RUN: llc -mtriple=amdgpu12.00 -stop-after=amdgpu-isel < %s | FileCheck %s
...
define void @test() {
  ...
  ; CHECK-NEXT:   [[S_MOV_B32_2:%[0-9]+]]:sgpr_32 = S_MOV_B32 1092616192
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[PHI:%[0-9]+]]:vgpr_32 = PHI [[S_MOV_B32_2]], %bb.1, [[S_MOV_B32_3]], %bb.2
  ...
  ; CHECK-NEXT:   [[V_CMP_EQ_F32_e64_:%[0-9]+]]:sreg_32 = nofpexcept V_CMP_EQ_F32_e64 0, [[PHI]], 0, killed [[S_MOV_B32_4]], 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   GLOBAL_STORE_DWORD_SADDR killed [[V_MOV_B32_e32_]], killed [[V_MOV_B32_e32_1]], killed [[S_LOAD_DWORDX2_IMM3]], 0, 0, implicit $exec :: (store (s32) into @external_constant2, addrspace 1)
  ; CHECK-NEXT: {{  $}}
