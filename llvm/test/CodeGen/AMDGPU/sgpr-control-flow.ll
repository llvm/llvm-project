...
; SI-NEXT:  .LBB0_2: ; %if
; SI-NEXT:    s_sub_i32 s5, s3, s4
; SI-NEXT:  .LBB0_3: ; %endif
; SI-NEXT:    s_mov_b32 s8, s0
; SI-NEXT:    s_add_i32 s0, s5, s2
...
; SI-NEXT:    s_xor_b64 s[8:9], exec, s[0:1]
...
; SI-NEXT:    v_cmp_gt_i32_e64 s[6:7], 0, v0
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:  .LBB3_2: ; %Flow
; SI-NEXT:    s_or_saveexec_b64 s[8:9], s[8:9]
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-NEXT:    s_xor_b64 exec, exec, s[8:9]
...
; SI-NEXT:    s_andn2_b64 s[2:3], s[6:7], exec
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; SI-NEXT:    s_and_b64 s[4:5], vcc, exec
; SI-NEXT:    s_or_b64 s[6:7], s[2:3], s[4:5]
