; RUN: opt -mtriple=amdgpu7.00-amd-amdhsa -passes=amdgpu-attributor -o %t.gfx7.bc %s
; RUN: opt -mtriple=amdgpu8.03-amd-amdhsa -passes=amdgpu-attributor -o %t.gfx8.bc %s
; RUN: opt -mtriple=amdgpu9.00-amd-amdhsa -passes=amdgpu-attributor -o %t.gfx9.bc %s
; xUN: llc -mtriple=amdgpu7.00-amd-amdhsa -filetype=obj < %t.gfx7.bc | llvm-readelf --notes - | FileCheck --check-prefixes=CHECK,PRE-GFX9  %s
; xUN: llc -mtriple=amdgpu8.03-amd-amdhsa -filetype=obj < %t.gfx8.bc | llvm-readelf --notes - | FileCheck --check-prefixes=CHECK,PRE-GFX9  %s
; xUN: llc -mtriple=amdgpu9.00-amd-amdhsa -filetype=obj < %t.gfx9.bc | llvm-readelf --notes - | FileCheck --check-prefixes=CHECK,GFX9  %s
; xUN: llc -mtriple=amdgpu7.00-amd-amdhsa < %t.gfx7.bc | FileCheck --check-prefixes=CHECK,PRE-GFX9 %s
; RUN: llc -mtriple=amdgpu8.03-amd-amdhsa < %t.gfx8.bc | FileCheck --check-prefixes=CHECK,PRE-GFX9 %s
; xUN: llc -mtriple=amdgpu9.00-amd-amdhsa < %t.gfx9.bc | FileCheck --check-prefixes=CHECK,GFX9 %s
