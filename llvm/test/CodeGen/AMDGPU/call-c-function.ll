...
; RUN: llc -global-isel=1 -stop-after=finalize-isel -mtriple=amdgpu9.00-mesa-mesa3d -o - %s | FileCheck -check-prefix=GISEL -enable-var-scope %s
...
define amdgpu_ps void @amdgpu_ps_call_default_cc() {
  ...
  ; GISEL-NEXT:   [[COPY:%[0-9]+]]:sgpr_128 = COPY $sgpr96_99
  ; GISEL-NEXT:   $sgpr0_3 = COPY [[COPY]]
  ; GISEL-NEXT:   $sgpr4_5 = COPY [[DEF]]
  ; GISEL-NEXT:   $sgpr6_7 = COPY [[DEF]]
  ; GISEL-NEXT:   [[S_MOV_B:%[0-9]+]]:sreg_64 = S_MOV_B64_IMM_PSEUDO 0
  ; GISEL-NEXT:   $sgpr8_9 = COPY [[S_MOV_B]]
  ; GISEL-NEXT:   $sgpr10_11 = COPY [[DEF1]]
  ...
  ; GISEL-NEXT:   $sgpr30_31 = noconvergent SI_CALL [[S_MOV_B1]], 0, csr_amdgpu, implicit $sgpr0_3, implicit $sgpr4_5, implicit $sgpr6_7, implicit $sgpr8_9, implicit $sgpr10_11, implicit $sgpr12, implicit $sgpr13, implicit $sgpr14, implicit $sgpr15, implicit $vgpr31
