...
; CI-NEXT:    v_bfi_b32 v9, s6, v9, v14
...
; CI-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; CI-NEXT:    v_mov_b32_e32 v9, s2
; CI-NEXT:    v_mov_b32_e32 v18, s23
; CI-NEXT:    s_cselect_b32 s0, 0x3ff00000, 0
; CI-NEXT:    v_bfi_b32 v9, s6, v9, v18
; CI-NEXT:    v_mov_b32_e32 v18, s0
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    v_mov_b32_e32 v19, s21
; CI-NEXT:    v_add_f64 v[16:17], v[16:17], v[8:9]
; CI-NEXT:    v_bfi_b32 v9, s6, v18, v19
; CI-NEXT:    v_add_f64 v[14:15], v[14:15], v[8:9]
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, -1
; CI-NEXT:    s_waitcnt lgkmcnt(0)
