...
; SI-NEXT:    s_cmp_gt_i32 s3, 51
; SI-NEXT:    s_cselect_b32 s6, s4, s6
; SI-NEXT:    v_bfi_b32 v5, s26, v0, v1
; SI-NEXT:    s_cselect_b32 s7, s5, s7
; SI-NEXT:    v_mov_b32_e32 v0, s6
; SI-NEXT:    v_mov_b32_e32 v1, s7
; SI-NEXT:    v_add_f64 v[0:1], s[4:5], -v[0:1]
...
; SI-NEXT:    v_mov_b32_e32 v1, s5
; SI-NEXT:    v_add_f64 v[0:1], s[10:11], -v[0:1]
; SI-NEXT:    v_bfi_b32 v5, s26, v5, v6
...
; SI-NEXT:    v_mov_b32_e32 v9, s11
; SI-NEXT:    v_cmp_ge_f64_e64 s[10:11], |v[6:7]|, 0.5
; SI-NEXT:    v_bfi_b32 v5, s26, v8, v9
; SI-NEXT:    v_add_f64 v[8:9], s[4:5], v[4:5]
; SI-NEXT:    s_and_b64 s[4:5], s[10:11], exec
; SI-NEXT:    s_cselect_b32 s3, 0x3ff00000, 0
...
; SI-NEXT:    v_add_f64 v[6:7], s[14:15], -v[5:6]
; SI-NEXT:    v_mov_b32_e32 v11, s9
; SI-NEXT:    v_cmp_ge_f64_e64 s[8:9], |v[6:7]|, 0.5
; SI-NEXT:    v_bfi_b32 v5, s26, v10, v11
...
; SI-NEXT:    v_bfi_b32 v5, s26, v5, v12
; SI-NEXT:    v_add_f64 v[12:13], s[4:5], v[4:5]
...
; SI-NEXT:    v_add_f64 v[10:11], s[18:19], -v[10:11]
; SI-NEXT:    v_mov_b32_e32 v14, s13
; SI-NEXT:    v_cmp_ge_f64_e64 s[8:9], |v[10:11]|, 0.5
; SI-NEXT:    v_bfi_b32 v5, s26, v5, v14
; SI-NEXT:    v_add_f64 v[10:11], s[6:7], v[4:5]
; SI-NEXT:    s_and_b64 s[6:7], s[8:9], exec
; SI-NEXT:    s_cselect_b32 s3, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v5, s3
...
; SI-NEXT:    v_bfi_b32 v5, s26, v5, v16
; SI-NEXT:    v_add_f64 v[16:17], s[4:5], v[4:5]
; SI-NEXT:    s_and_b64 s[4:5], s[8:9], exec
; SI-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x9
; SI-NEXT:    s_cselect_b32 s3, 0x3ff00000, 0
; SI-NEXT:    v_mov_b32_e32 v5, s3
...
; SI-NEXT:    v_bfi_b32 v5, s26, v5, v14
; SI-NEXT:    v_add_f64 v[14:15], s[6:7], v[4:5]
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
