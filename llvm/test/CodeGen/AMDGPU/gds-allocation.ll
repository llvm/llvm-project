...
; RUN: llc -mtriple=amdgpu9.00-amd-amdpal -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -mtriple=amdgpu9-amd-amdpal --amdhsa-code-object-version=6 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -check-prefix=GCN %s
