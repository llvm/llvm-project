...
;RUN: llc < %s -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck --check-prefixes=VI %s
...
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_load_dwordx4 s[12:15], s[10:11], 0x0
...
; VI-NEXT:    s_cselect_b32 s6, s6, s14
; VI-NEXT:    s_cmp_gt_i32 s13, s17
; VI-NEXT:    s_cselect_b32 s5, s5, s13
; VI-NEXT:    s_cmp_gt_i32 s15, s19
; VI-NEXT:    s_cselect_b32 s7, s7, s15
; VI-NEXT:    s_cmp_gt_i32 s12, s16
; VI-NEXT:    s_cselect_b32 s4, s4, s12
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    v_mov_b32_e32 v1, s5
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_load_dwordx4 s[8:11], s[0:1], 0x0
; SI-NEXT:    s_mov_b32 s0, s4
; SI-NEXT:    s_mov_b32 s1, s5
; SI-NEXT:    s_load_dwordx4 s[4:7], s[6:7], 0x0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
