; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -check-prefix=PAL %s

; GFX1210 supports upto 320 KB configurable LDS memory.
