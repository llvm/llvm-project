...
define float @buffer_atomic_cond_sub(<4 x i32> inreg %rsrc, i32 inreg %data) #0 {
; GFX12-LABEL: buffer_atomic_cond_sub:
...
main_body:
  %orig = call i32 @llvm.amdgcn.buffer.atomic.cond.sub.u32.i32(i32 %data, <4 x i32> %rsrc, i32 0, i32 0, i1 0)
...
declare i32 @llvm.amdgcn.buffer.atomic.cond.sub.u32.i32(i32, <4 x i32>, i32, i32, i1) #0
