...
; GFX7-LABEL: test_s_signed_i64_f32:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_trunc_f32_e32 v0, s16
; GFX7-NEXT:    s_mov_b32 s4, 0x2f800000
...
; GFX7-NEXT:    s_ashr_i32 s6, s6, 31
; GFX7-NEXT:    v_readfirstlane_b32 s4, v2
; GFX7-NEXT:    v_readfirstlane_b32 s5, v1
; GFX7-NEXT:    s_mov_b32 s7, s6
; GFX7-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
; GFX7-NEXT:    s_sub_u32 s7, s4, s6
; GFX7-NEXT:    v_mov_b32_e32 v0, 0xdf000000
; GFX7-NEXT:    s_subb_u32 s10, s5, s6
; GFX7-NEXT:    v_cmp_nge_f32_e32 vcc, s16, v0
; GFX7-NEXT:    s_and_b64 s[4:5], vcc, exec
; GFX7-NEXT:    v_mov_b32_e32 v0, 0x5effffff
; GFX7-NEXT:    v_cmp_gt_f32_e64 s[4:5], s16, v0
; GFX7-NEXT:    s_cselect_b32 s8, 0, s7
; GFX7-NEXT:    s_and_b64 s[6:7], s[4:5], exec
; GFX7-NEXT:    v_cmp_u_f32_e64 s[6:7], s16, s16
; GFX7-NEXT:    s_cselect_b32 s11, -1, s8
; GFX7-NEXT:    s_and_b64 s[8:9], s[6:7], exec
; GFX7-NEXT:    s_cselect_b32 s11, 0, s11
; GFX7-NEXT:    s_and_b64 s[8:9], vcc, exec
; GFX7-NEXT:    s_cselect_b32 s8, 0x80000000, s10
; GFX7-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX7-NEXT:    s_cselect_b32 s8, 0x7fffffff, s8
; GFX7-NEXT:    s_and_b64 s[4:5], s[6:7], exec
; GFX7-NEXT:    s_cselect_b32 s4, 0, s8
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-LABEL: test_s_signed_i64_f32:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    s_wait_expcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_b32 s3, s1, 0x7fffffff
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_mul_f32 s2, s3, 0x2f800000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_floor_f32 s4, s2
; GFX12-NEXT:    s_ashr_i32 s2, s1, 31
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_fmac_f32 s3, s4, 0xcf800000
; GFX12-NEXT:    s_cvt_u32_f32 s5, s4
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_cvt_u32_f32 s4, s3
; GFX12-NEXT:    s_mov_b32 s3, s2
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_xor_b64 s[4:5], s[4:5], s[2:3]
; GFX12-NEXT:    s_cmp_nge_f32 s0, 0xdf000000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_sub_nc_u64 s[2:3], s[4:5], s[2:3]
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_cselect_b32 s1, 0, s2
; GFX12-NEXT:    s_cselect_b32 s2, 0x80000000, s3
; GFX12-NEXT:    s_cmp_gt_f32 s0, 0x5effffff
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_cselect_b32 s2, 0x7fffffff, s2
; GFX12-NEXT:    s_cselect_b32 s1, -1, s1
...
; GFX7-LABEL: test_s_signed_i64_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-NEXT:    v_mov_b32_e32 v5, 0xc3e00000
; GFX7-NEXT:    v_mov_b32_e32 v6, -1
; GFX7-NEXT:    v_mov_b32_e32 v7, 0x43dfffff
; GFX7-NEXT:    v_cmp_nge_f64_e32 vcc, s[16:17], v[4:5]
; GFX7-NEXT:    v_ldexp_f64 v[2:3], v[0:1], s4
; GFX7-NEXT:    s_mov_b32 s4, 0
; GFX7-NEXT:    v_cmp_u_f64_e64 s[6:7], s[16:17], s[16:17]
; GFX7-NEXT:    v_bfrev_b32_e32 v8, 1
; GFX7-NEXT:    v_floor_f64_e32 v[2:3], v[2:3]
; GFX7-NEXT:    v_fma_f64 v[0:1], v[2:3], s[4:5], v[0:1]
; GFX7-NEXT:    v_cmp_gt_f64_e64 s[4:5], s[16:17], v[6:7]
; GFX7-NEXT:    v_cvt_i32_f64_e32 v9, v[2:3]
; GFX7-NEXT:    v_bfrev_b32_e32 v2, -2
; GFX7-NEXT:    v_cndmask_b32_e32 v3, v9, v8, vcc
; GFX7-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-NEXT:    v_cndmask_b32_e64 v2, v3, v2, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v1, v2, 0, s[6:7]
; GFX7-NEXT:    v_cndmask_b32_e64 v0, v0, 0, vcc
; GFX7-NEXT:    v_cndmask_b32_e64 v0, v0, -1, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s[6:7]
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-LABEL: test_s_signed_i64_f64:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    s_wait_expcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-NEXT:    v_cmp_nle_f64_e64 s4, 0xc3e00000, s[0:1]
; GFX12-NEXT:    s_mov_b32 s2, -1
; GFX12-NEXT:    s_mov_b32 s3, 0x43dfffff
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cmp_gt_f64_e64 s2, s[0:1], s[2:3]
; GFX12-NEXT:    v_cmp_u_f64_e64 s0, s[0:1], s[0:1]
; GFX12-NEXT:    v_ldexp_f64 v[2:3], v[0:1], 0xffffffe0
; GFX12-NEXT:    v_floor_f64_e32 v[2:3], v[2:3]
; GFX12-NEXT:    v_fma_f64 v[0:1], 0xc1f00000, v[2:3], v[0:1]
; GFX12-NEXT:    v_cvt_i32_f64_e32 v2, v[2:3]
; GFX12-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v2, 0x80000000, s4
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v1, 0x7fffffff, s2
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v1, 0, s0
; GFX12-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s4
; GFX12-NEXT:    v_cndmask_b32_e64 v0, v0, -1, s2
