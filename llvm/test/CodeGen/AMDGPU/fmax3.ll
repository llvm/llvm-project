...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250 %s
...
; GFX12-NEXT:    s_endpgm
;
; GFX1250-LABEL: test_fmax3_olt_0_f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1250-NEXT:    s_mov_b32 s10, -1
; GFX1250-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1250-NEXT:    s_mov_b32 s20, s6
; GFX1250-NEXT:    s_mov_b32 s21, s7
; GFX1250-NEXT:    buffer_load_u16 v0, off, s[12:15], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_load_u16 v1, off, s[16:19], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    buffer_load_u16 v2, off, s[20:23], null scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s8, s0
; GFX1250-NEXT:    s_mov_b32 s9, s1
; GFX1250-NEXT:    v_max3_num_f16 v0, v0, v1, v2
; GFX1250-NEXT:    buffer_store_b16 v0, off, s[8:11], null
; GFX1250-NEXT:    s_endpgm
...
; GFX12-NEXT:    s_endpgm
;
; GFX1250-LABEL: test_fmax3_olt_1_f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1250-NEXT:    s_mov_b32 s10, -1
; GFX1250-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1250-NEXT:    s_mov_b32 s8, s0
; GFX1250-NEXT:    s_mov_b32 s9, s1
; GFX1250-NEXT:    v_max3_num_f16 v0, v2, v0, v1
; GFX1250-NEXT:    buffer_store_b16 v0, off, s[8:11], null
; GFX1250-NEXT:    s_endpgm
  %a = load volatile half, ptr addrspace(1) %aptr, align 2
  %b = load volatile half, ptr addrspace(1) %bptr, align 2
