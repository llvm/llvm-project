...
; GFX11-NEXT:    s_endpgm
;
; GFX1210_Plus-LABEL: test_fmax3_olt_0_f32:
; GFX1210_Plus:       ; %bb.0:
; GFX1210_Plus-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
...
; GFX1210_Plus-NEXT:    v_max3_num_f32 v0, v0, v1, v2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210_Plus-LABEL: test_fmax3_olt_1_f32:
; GFX1210_Plus:       ; %bb.0:
; GFX1210_Plus-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1210_Plus-NEXT:    s_mov_b32 s10, -1
; GFX1210_Plus-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1210_Plus-NEXT:    s_mov_b32 s8, s0
; GFX1210_Plus-NEXT:    s_mov_b32 s9, s1
; GFX1210_Plus-NEXT:    v_max3_num_f32 v0, v2, v0, v1
; GFX1210_Plus-NEXT:    buffer_store_b32 v0, off, s[8:11], null
; GFX1210_Plus-NEXT:    s_endpgm
  %a = load volatile float, ptr addrspace(1) %aptr, align 4
  %b = load volatile float, ptr addrspace(1) %bptr, align 4
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210_Plus-LABEL: test_fmax3_olt_0_f16:
; GFX1210_Plus:       ; %bb.0:
; GFX1210_Plus-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1210_Plus-NEXT:    s_mov_b32 s10, -1
; GFX1210_Plus-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1210_Plus-NEXT:    s_mov_b32 s8, s0
; GFX1210_Plus-NEXT:    s_mov_b32 s9, s1
; GFX1210_Plus-NEXT:    v_max3_num_f16 v0, v0, v1, v2
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210_Plus-LABEL: test_fmax3_olt_1_f16:
; GFX1210_Plus:       ; %bb.0:
; GFX1210_Plus-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1210_Plus-NEXT:    s_mov_b32 s10, -1
; GFX1210_Plus-NEXT:    s_mov_b32 s11, 0x31016000
...
; GFX1210_Plus-NEXT:    s_mov_b32 s8, s0
; GFX1210_Plus-NEXT:    s_mov_b32 s9, s1
; GFX1210_Plus-NEXT:    v_max3_num_f16 v0, v2, v0, v1
; GFX1210_Plus-NEXT:    buffer_store_b16 v0, off, s[8:11], null
; GFX1210_Plus-NEXT:    s_endpgm
  %a = load volatile half, ptr addrspace(1) %aptr, align 2
  %b = load volatile half, ptr addrspace(1) %bptr, align 2
