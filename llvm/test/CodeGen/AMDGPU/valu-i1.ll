...
; SI-LABEL: multi_vcond_loop:
; SI:       ; %bb.0: ; %bb
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0xf
; SI-NEXT:    s_mov_b32 s2, 0
; SI-NEXT:    v_mov_b32_e32 v7, 0
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    v_lshlrev_b32_e32 v6, 2, v0
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    buffer_load_dword v0, v[6:7], s[0:3], 0 addr64
; SI-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NEXT:    v_add_i32_e32 v2, vcc, s8, v6
; SI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
; SI-NEXT:    v_mov_b32_e32 v5, s13
; SI-NEXT:    v_add_i32_e32 v4, vcc, s12, v6
...
; SI-NEXT:    ; =>This Inner Loop Header: Depth=1
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    buffer_load_dword v8, v[4:5], s[0:3], 0 addr64
; SI-NEXT:    buffer_load_dword v9, v[6:7], s[0:3], 0 addr64
; SI-NEXT:    s_waitcnt vmcnt(1)
; SI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v8
; SI-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_ne_u32_e32 vcc, -1, v9
; SI-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; SI-NEXT:    v_and_b32_e32 v10, v11, v10
...
; SI-NEXT:    s_and_b64 s[10:11], exec, s[6:7]
; SI-NEXT:    s_or_b64 s[4:5], s[10:11], s[4:5]
