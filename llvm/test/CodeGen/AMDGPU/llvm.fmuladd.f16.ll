...
; VI-FLUSH:       ; %bb.0:
; VI-FLUSH-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; VI-FLUSH-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; VI-FLUSH-NEXT:    s_mov_b32 s11, 0xf000
; VI-FLUSH-NEXT:    s_mov_b32 s10, -1
; VI-FLUSH-NEXT:    s_mov_b32 s14, s10
; VI-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-FLUSH-NEXT:    s_mov_b32 s15, s11
; VI-FLUSH-NEXT:    s_mov_b32 s2, s10
; VI-FLUSH-NEXT:    s_mov_b32 s3, s11
; VI-FLUSH-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 glc
; VI-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; VI-FLUSH-NEXT:    s_mov_b32 s8, s4
; VI-FLUSH-NEXT:    s_mov_b32 s9, s5
; VI-FLUSH-NEXT:    v_madmk_f16 v0, v0, 0x4200, v1
; VI-FLUSH-NEXT:    buffer_store_short v0, off, s[8:11], 0
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fmuladd_f16_imm_a:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; VI-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; VI-DENORM-NEXT:    s_mov_b32 s11, 0xf000
; VI-DENORM-NEXT:    s_mov_b32 s10, -1
; VI-DENORM-NEXT:    s_mov_b32 s14, s10
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-DENORM-NEXT:    s_mov_b32 s15, s11
; VI-DENORM-NEXT:    s_mov_b32 s2, s10
; VI-DENORM-NEXT:    s_mov_b32 s3, s11
; VI-DENORM-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    s_movk_i32 s0, 0x4200
; VI-DENORM-NEXT:    s_mov_b32 s8, s4
; VI-DENORM-NEXT:    s_mov_b32 s9, s5
...
; GFX10-FLUSH-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s2, s10
; GFX10-FLUSH-NEXT:    s_mov_b32 s3, s11
; GFX10-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s12, s6
; GFX10-FLUSH-NEXT:    s_mov_b32 s13, s7
; GFX10-FLUSH-NEXT:    s_mov_b32 s8, s4
; GFX10-FLUSH-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s9, s5
...
; GFX10-DENORM-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX10-DENORM-NEXT:    s_mov_b32 s2, s10
; GFX10-DENORM-NEXT:    s_mov_b32 s3, s11
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DENORM-NEXT:    s_mov_b32 s12, s6
; GFX10-DENORM-NEXT:    s_mov_b32 s13, s7
; GFX10-DENORM-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    buffer_load_ushort v1, off, s[0:3], 0 glc dlc
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    s_mov_b32 s8, s4
; GFX10-DENORM-NEXT:    s_mov_b32 s9, s5
; GFX10-DENORM-NEXT:    v_fmamk_f16 v0, v0, 0x4200, v1
; GFX10-DENORM-NEXT:    buffer_store_short v0, off, s[8:11], 0
; GFX10-DENORM-NEXT:    s_endpgm
;
; GFX11-FLUSH-LABEL: fmuladd_f16_imm_a:
; GFX11-FLUSH:       ; %bb.0:
; GFX11-FLUSH-NEXT:    s_clause 0x1
; GFX11-FLUSH-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX11-FLUSH-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX11-FLUSH-NEXT:    s_mov_b32 s10, -1
; GFX11-FLUSH-NEXT:    s_mov_b32 s11, 0x31016000
; GFX11-FLUSH-NEXT:    s_mov_b32 s14, s10
; GFX11-FLUSH-NEXT:    s_mov_b32 s15, s11
...
; GFX11-DENORM-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX11-DENORM-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX11-DENORM-NEXT:    s_mov_b32 s10, -1
; GFX11-DENORM-NEXT:    s_mov_b32 s11, 0x31016000
; GFX11-DENORM-NEXT:    s_mov_b32 s14, s10
; GFX11-DENORM-NEXT:    s_mov_b32 s15, s11
