...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign < %s | FileCheck --check-prefixes=SI %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=VI-FLUSH %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign < %s | FileCheck --check-prefixes=SI %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=VI-DENORM %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.10 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX10-FLUSH %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu10.10 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX10-DENORM %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=+real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=-real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-FAKE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=+real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -mattr=-real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-FAKE16 %s
...
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[12:15], 0
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[16:19], 0
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s4, s6
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s5, s7
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s6, s10
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s7, s11
; GFX11-FLUSH-TRUE16-NEXT:    s_mov_b32 s8, s0
; GFX11-FLUSH-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[4:7], 0
...
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[12:15], 0
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[16:19], 0
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v1, off, s[20:23], 0
...
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s12, s2
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s13, s3
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_b16 v0, off, s[12:15], 0 glc dlc
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-TRUE16-NEXT:    buffer_load_d16_hi_b16 v0, off, s[4:7], 0 glc dlc
; GFX11-DENORM-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s8, s0
; GFX11-DENORM-TRUE16-NEXT:    s_mov_b32 s9, s1
