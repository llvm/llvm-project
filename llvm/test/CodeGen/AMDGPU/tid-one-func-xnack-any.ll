...
; RUN: sed 's/CODE_OBJECT_VERSION/500/g' %s | llc -mtriple=amdgpu9.00-amd-amdhsa | FileCheck --check-prefixes=ASM,ASM5 %s
...
; ASM: .amdgcn_target "amdgpu9.00-amd-amdhsa-unknown-gfx900"
; ASM:  amdhsa.target: amdgpu9.00-amd-amdhsa-unknown-gfx900
; ASM:  amdhsa.version:
; ASM:    - 1
; ASM4:   - 1
; ASM5:   - 2
