...
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 31, v12
; GFX9-NEXT:    v_lshlrev_b64 v[11:12], 1, v[11:12]
; GFX9-NEXT:    v_or_b32_e32 v6, v13, v6
; GFX9-NEXT:    v_lshrrev_b32_e32 v13, 31, v3
; GFX9-NEXT:    v_lshlrev_b64 v[2:3], 1, v[2:3]
; GFX9-NEXT:    v_or_b32_e32 v11, v11, v13
; GFX9-NEXT:    v_lshrrev_b32_e32 v13, 31, v5
; GFX9-NEXT:    v_or3_b32 v2, v2, v13, v8
; GFX9-NEXT:    v_sub_co_u32_e64 v13, s[4:5], v10, v11
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v27, v12, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e32 v23, vcc, -1, v23
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], 1, v[4:5]
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v28, v6, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v24, vcc, -1, v24, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v29, v14, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v25, vcc, -1, v25, vcc
; GFX9-NEXT:    v_or_b32_e32 v4, v15, v4
; GFX9-NEXT:    v_ashrrev_i32_e32 v15, 31, v13
; GFX9-NEXT:    v_addc_co_u32_e32 v26, vcc, -1, v26, vcc
; GFX9-NEXT:    v_and_b32_e32 v13, v15, v21
; GFX9-NEXT:    v_or_b32_e32 v30, v23, v25
; GFX9-NEXT:    v_or_b32_e32 v31, v24, v26
; GFX9-NEXT:    v_or_b32_e32 v5, v16, v5
; GFX9-NEXT:    v_and_b32_e32 v16, v15, v22
; GFX9-NEXT:    v_sub_co_u32_e64 v11, s[4:5], v11, v13
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[30:31]
; GFX9-NEXT:    v_subb_co_u32_e64 v12, s[4:5], v12, v16, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v13, v15, v0
; GFX9-NEXT:    v_and_b32_e32 v16, v15, v1
; GFX9-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v6, v13, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v6, 1, v15
; GFX9-NEXT:    v_subb_co_u32_e64 v14, s[4:5], v14, v16, s[4:5]
...
; GFX9-NEXT:    v_or3_b32 v8, v8, v14, v0
; GFX9-NEXT:    v_sub_co_u32_e64 v14, s[4:5], v22, v12
; GFX9-NEXT:    v_subb_co_u32_e64 v14, s[4:5], v23, v15, s[4:5]
; GFX9-NEXT:    v_add_co_u32_e32 v18, vcc, -1, v18
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], 1, v[10:11]
; GFX9-NEXT:    v_subb_co_u32_e64 v14, s[4:5], v24, v2, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v19, vcc, -1, v19, vcc
; GFX9-NEXT:    v_subb_co_u32_e64 v14, s[4:5], v25, v3, s[4:5]
; GFX9-NEXT:    v_addc_co_u32_e32 v20, vcc, -1, v20, vcc
; GFX9-NEXT:    v_or_b32_e32 v10, v16, v10
; GFX9-NEXT:    v_ashrrev_i32_e32 v16, 31, v14
; GFX9-NEXT:    v_addc_co_u32_e32 v21, vcc, -1, v21, vcc
; GFX9-NEXT:    v_and_b32_e32 v14, v16, v4
; GFX9-NEXT:    v_or_b32_e32 v26, v18, v20
; GFX9-NEXT:    v_or_b32_e32 v27, v19, v21
; GFX9-NEXT:    v_or_b32_e32 v11, v17, v11
; GFX9-NEXT:    v_and_b32_e32 v17, v16, v5
; GFX9-NEXT:    v_sub_co_u32_e64 v14, s[4:5], v12, v14
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[26:27]
; GFX9-NEXT:    v_subb_co_u32_e64 v15, s[4:5], v15, v17, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v12, v16, v6
; GFX9-NEXT:    v_and_b32_e32 v17, v16, v7
; GFX9-NEXT:    v_subb_co_u32_e64 v2, s[4:5], v2, v12, s[4:5]
; GFX9-NEXT:    v_and_b32_e32 v12, 1, v16
; GFX9-NEXT:    v_subb_co_u32_e64 v3, s[4:5], v3, v17, s[4:5]
