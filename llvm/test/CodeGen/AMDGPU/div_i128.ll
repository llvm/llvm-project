...
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v6, v10, vcc
; GFX9-NEXT:    v_or_b32_e32 v5, v20, v1
; GFX9-NEXT:    v_or_b32_e32 v4, v21, v0
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[4:5]
; GFX9-NEXT:    v_or_b32_e32 v5, v9, v3
; GFX9-NEXT:    v_or_b32_e32 v4, v8, v2
; GFX9-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[4:5]
; GFX9-NEXT:    v_ffbh_u32_e32 v4, v0
; GFX9-NEXT:    v_add_u32_e32 v4, 32, v4
; GFX9-NEXT:    v_ffbh_u32_e32 v5, v1
; GFX9-NEXT:    v_min_u32_e32 v4, v4, v5
; GFX9-NEXT:    v_ffbh_u32_e32 v5, v21
; GFX9-NEXT:    v_add_u32_e32 v5, 32, v5
; GFX9-NEXT:    v_ffbh_u32_e32 v6, v20
...
; GFX9-NEXT:    v_ffbh_u32_e32 v10, v8
; GFX9-NEXT:    v_add_u32_e32 v10, 32, v10
; GFX9-NEXT:    v_ffbh_u32_e32 v11, v9
...
; GFX9-NEXT:    v_subb_co_u32_e32 v5, vcc, v6, v11, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, 0, v7, vcc
...
; GFX9-NEXT:    v_xor_b32_e32 v10, 0x7f, v4
; GFX9-NEXT:    v_or_b32_e32 v11, v5, v7
...
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v9, 0, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v8, 0, s[4:5]
...
; GFX9-NEXT:    v_addc_co_u32_e32 v23, vcc, 0, v5, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v24, vcc, 0, v6, vcc
; GFX9-NEXT:    v_sub_u32_e32 v14, 0x7f, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v25, vcc, 0, v7, vcc
; GFX9-NEXT:    v_sub_u32_e32 v7, 64, v14
; GFX9-NEXT:    v_or_b32_e32 v6, v23, v25
; GFX9-NEXT:    v_or_b32_e32 v5, v22, v24
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], v14, v[2:3]
; GFX9-NEXT:    v_lshrrev_b64 v[12:13], v7, v[8:9]
; GFX9-NEXT:    v_sub_u32_e32 v4, 63, v4
; GFX9-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[5:6]
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], v4, v[8:9]
; GFX9-NEXT:    v_or_b32_e32 v6, v11, v13
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v5, v3, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v4, v10, s[4:5]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v12, v9, v8, s[4:5]
...
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 31, v13
; GFX9-NEXT:    v_lshlrev_b64 v[12:13], 1, v[12:13]
; GFX9-NEXT:    v_or_b32_e32 v10, v14, v10
; GFX9-NEXT:    v_lshrrev_b32_e32 v14, 31, v7
; GFX9-NEXT:    v_or_b32_e32 v12, v12, v14
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, v26, v12
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v27, v13, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v28, v10, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v29, v15, vcc
; GFX9-NEXT:    v_ashrrev_i32_e32 v32, 31, v14
; GFX9-NEXT:    v_and_b32_e32 v14, v32, v21
; GFX9-NEXT:    v_sub_co_u32_e32 v12, vcc, v12, v14
; GFX9-NEXT:    v_and_b32_e32 v14, v32, v20
; GFX9-NEXT:    v_subb_co_u32_e32 v13, vcc, v13, v14, vcc
; GFX9-NEXT:    v_and_b32_e32 v14, v32, v0
; GFX9-NEXT:    v_subb_co_u32_e32 v14, vcc, v10, v14, vcc
; GFX9-NEXT:    v_and_b32_e32 v10, v32, v1
; GFX9-NEXT:    v_subb_co_u32_e32 v15, vcc, v15, v10, vcc
...
; GFX9-NEXT:    v_or_b32_e32 v11, v11, v1
...
; GFX9-NEXT:    v_xor_b32_e32 v0, v10, v2
; GFX9-NEXT:    v_xor_b32_e32 v1, v11, v3
...
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v12, 31, v7
; GFX9-G-NEXT:    v_lshlrev_b64 v[6:7], 1, v[6:7]
; GFX9-G-NEXT:    v_lshlrev_b64 v[8:9], 1, v[8:9]
; GFX9-G-NEXT:    v_or_b32_e32 v6, v0, v6
; GFX9-G-NEXT:    v_sub_co_u32_e64 v0, s[4:5], v24, v10
; GFX9-G-NEXT:    v_subb_co_u32_e64 v0, s[4:5], v25, v13, s[4:5]
; GFX9-G-NEXT:    v_subb_co_u32_e64 v0, s[4:5], v26, v2, s[4:5]
; GFX9-G-NEXT:    v_subb_co_u32_e64 v0, s[4:5], v27, v3, s[4:5]
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GFX9-G-NEXT:    v_or_b32_e32 v7, v1, v7
; GFX9-G-NEXT:    v_and_b32_e32 v1, v0, v18
; GFX9-G-NEXT:    v_or_b32_e32 v8, v8, v12
; GFX9-G-NEXT:    v_and_b32_e32 v14, v0, v19
; GFX9-G-NEXT:    v_sub_co_u32_e64 v12, s[4:5], v10, v1
; GFX9-G-NEXT:    v_subb_co_u32_e64 v13, s[4:5], v13, v14, s[4:5]
; GFX9-G-NEXT:    v_and_b32_e32 v1, v0, v4
; GFX9-G-NEXT:    v_and_b32_e32 v10, v0, v5
; GFX9-G-NEXT:    v_subb_co_u32_e64 v14, s[4:5], v2, v1, s[4:5]
; GFX9-G-NEXT:    v_subb_co_u32_e64 v15, s[4:5], v3, v10, s[4:5]
; GFX9-G-NEXT:    v_and_b32_e32 v10, 1, v0
...
; GFX9-NEXT:    v_cndmask_b32_e32 v17, 0, v2, vcc
...
; GFX9-NEXT:    v_lshlrev_b64 v[14:15], 1, v[14:15]
; GFX9-NEXT:    v_or_b32_e32 v12, v16, v12
...
; GFX9-NEXT:    v_subb_co_u32_e32 v16, vcc, v24, v12, vcc
; GFX9-NEXT:    v_subb_co_u32_e32 v16, vcc, v25, v17, vcc
; GFX9-NEXT:    v_ashrrev_i32_e32 v28, 31, v16
; GFX9-NEXT:    v_and_b32_e32 v16, v28, v4
; GFX9-NEXT:    v_sub_co_u32_e32 v14, vcc, v14, v16
; GFX9-NEXT:    v_and_b32_e32 v16, v28, v5
; GFX9-NEXT:    v_subb_co_u32_e32 v15, vcc, v15, v16, vcc
; GFX9-NEXT:    v_and_b32_e32 v16, v28, v6
; GFX9-NEXT:    v_subb_co_u32_e32 v16, vcc, v12, v16, vcc
; GFX9-NEXT:    v_and_b32_e32 v12, v28, v7
; GFX9-NEXT:    v_subb_co_u32_e32 v17, vcc, v17, v12, vcc
...
; GFX9-NEXT:    v_or_b32_e32 v26, v18, v20
; GFX9-NEXT:    v_or_b32_e32 v27, v19, v21
; GFX9-NEXT:    v_lshrrev_b32_e32 v12, 31, v11
; GFX9-NEXT:    v_lshlrev_b64 v[10:11], 1, v[10:11]
; GFX9-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[26:27]
; GFX9-NEXT:    v_or3_b32 v8, v8, v12, v0
; GFX9-NEXT:    v_and_b32_e32 v12, 1, v28
...
; GFX9-G-NEXT:    v_addc_co_u32_e32 v21, vcc, -1, v21, vcc
; GFX9-G-NEXT:    v_or_b32_e32 v12, v18, v20
; GFX9-G-NEXT:    v_or_b32_e32 v13, v19, v21
; GFX9-G-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[12:13]
; GFX9-G-NEXT:    v_lshlrev_b64 v[12:13], 1, v[16:17]
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v0, 31, v3
; GFX9-G-NEXT:    v_lshlrev_b64 v[2:3], 1, v[2:3]
; GFX9-G-NEXT:    v_or_b32_e32 v0, v12, v0
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v12, 31, v9
; GFX9-G-NEXT:    v_or_b32_e32 v2, v2, v12
; GFX9-G-NEXT:    v_lshrrev_b32_e32 v12, 31, v15
; GFX9-G-NEXT:    v_lshlrev_b64 v[14:15], 1, v[14:15]
; GFX9-G-NEXT:    v_lshlrev_b64 v[8:9], 1, v[8:9]
; GFX9-G-NEXT:    v_or_b32_e32 v14, v10, v14
; GFX9-G-NEXT:    v_sub_co_u32_e64 v10, s[4:5], v22, v2
; GFX9-G-NEXT:    v_subb_co_u32_e64 v10, s[4:5], v23, v3, s[4:5]
; GFX9-G-NEXT:    v_subb_co_u32_e64 v10, s[4:5], v24, v0, s[4:5]
; GFX9-G-NEXT:    v_subb_co_u32_e64 v10, s[4:5], v25, v13, s[4:5]
; GFX9-G-NEXT:    v_ashrrev_i32_e32 v10, 31, v10
; GFX9-G-NEXT:    v_or_b32_e32 v15, v11, v15
; GFX9-G-NEXT:    v_and_b32_e32 v11, v10, v4
; GFX9-G-NEXT:    v_or_b32_e32 v8, v8, v12
; GFX9-G-NEXT:    v_and_b32_e32 v12, v10, v5
; GFX9-G-NEXT:    v_sub_co_u32_e64 v2, s[4:5], v2, v11
; GFX9-G-NEXT:    v_subb_co_u32_e64 v3, s[4:5], v3, v12, s[4:5]
; GFX9-G-NEXT:    v_and_b32_e32 v11, v10, v6
; GFX9-G-NEXT:    v_and_b32_e32 v12, v10, v7
; GFX9-G-NEXT:    v_subb_co_u32_e64 v16, s[4:5], v0, v11, s[4:5]
; GFX9-G-NEXT:    v_and_b32_e32 v0, 1, v10
; GFX9-G-NEXT:    v_mov_b32_e32 v11, v1
; GFX9-G-NEXT:    v_subb_co_u32_e64 v17, s[4:5], v13, v12, s[4:5]
; GFX9-G-NEXT:    s_or_b64 s[8:9], vcc, s[8:9]
