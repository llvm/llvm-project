...
; CIVI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; CIVI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[4:5]
; CIVI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_stack_object@gotpcrel32@lo+4
; CIVI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_stack_object@gotpcrel32@hi+12
; CIVI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; CIVI-NEXT:    v_mov_b32_e32 v2, 9
; CIVI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; CIVI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; CIVI-NEXT:    s_add_u32 s6, s6, i32_fastcc_i32_i32@gotpcrel32@lo+4
; CIVI-NEXT:    s_addc_u32 s7, s7, i32_fastcc_i32_i32@gotpcrel32@hi+12
...
; GCN-NEXT:    s_add_u32 s6, s6, i32_fastcc_i32_i32@gotpcrel32@lo+4
; GCN-NEXT:    s_addc_u32 s7, s7, i32_fastcc_i32_i32@gotpcrel32@hi+12
...
; CIVI-NEXT:    s_getpc_b64 s[4:5]
; CIVI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; CIVI-NEXT:    s_waitcnt vmcnt(0)
...
; CIVI-NEXT:    s_getpc_b64 s[4:5]
; CIVI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
; CIVI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; CIVI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
...
; CIVI-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; CIVI-NEXT:    s_getpc_b64 s[4:5]
; CIVI-NEXT:    s_add_u32 s4, s4, sibling_call_i32_fastcc_i32_i32@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s5, s5, sibling_call_i32_fastcc_i32_i32@rel32@hi+12
...
; CIVI-NEXT:    s_add_u32 s16, s16, func_ptr_gv@gotpcrel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, func_ptr_gv@gotpcrel32@hi+12
...
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, void_fastcc_multi_byval@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, void_fastcc_multi_byval@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    v_mov_b32_e32 v30, 0
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, void_fastcc_byval_and_stack_passed@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, void_fastcc_byval_and_stack_passed@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, i64_fastcc_i64@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, i64_fastcc_i64@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, p1i8_fastcc_p1i8@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, p1i8_fastcc_p1i8@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, i16_fastcc_i16@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, i16_fastcc_i16@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, f16_fastcc_f16@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, f16_fastcc_f16@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, v3i16_fastcc_v3i16@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, v3i16_fastcc_v3i16@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, v4i16_fastcc_v4i16@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, v4i16_fastcc_v4i16@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
...
; CIVI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CIVI-NEXT:    s_getpc_b64 s[16:17]
; CIVI-NEXT:    s_add_u32 s16, s16, v2i64_fastcc_v2i64@rel32@lo+4
; CIVI-NEXT:    s_addc_u32 s17, s17, v2i64_fastcc_v2i64@rel32@hi+12
; CIVI-NEXT:    s_setpc_b64 s[16:17]
;
