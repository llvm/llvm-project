...
; RUN: llc -mtriple=amdgpu8.03-amd-amdhsa -mattr=-flat-for-global -enable-ipra=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,FIJI %s
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa -enable-ipra=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,HAWAII %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=-flat-for-global -enable-ipra=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX9 %s
...
; FIJI-NEXT:    ; implicit-def: $vgpr0_64
...
; HAWAII-NEXT:    ; implicit-def: $vgpr0_64
