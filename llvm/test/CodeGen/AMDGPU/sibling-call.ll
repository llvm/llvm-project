...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=fiji -mattr=-flat-for-global -enable-ipra=0 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=FIJI %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=hawaii -enable-ipra=0 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=HAWAII %s
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
; HAWAII-NEXT:    s_setpc_b64 s[4:5]
;
; GFX9-LABEL: sibling_call_i32_fastcc_i32_i32:
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[4:5]
; GFX9-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_stack_object:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_stack_object:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
...
; HAWAII-NEXT:    v_mov_b32_e32 v2, 9
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; HAWAII-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_setpc_b64 s[4:5]
;
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_callee_stack_object:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_stack_object@gotpcrel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_stack_object@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    v_mov_b32_e32 v2, 9
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; FIJI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_callee_stack_object:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_stack_object@gotpcrel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_stack_object@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    v_mov_b32_e32 v2, 9
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; HAWAII-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[4:5]
; GFX9-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_stack_object@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_stack_object@gotpcrel32@hi+12
; GFX9-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; GFX9-NEXT:    v_mov_b32_e32 v2, 9
; GFX9-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; GFX9-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_unused_result:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_unused_result:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_byval_i32_byval_parent:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_mov_b32 s4, s33
; FIJI-NEXT:    s_mov_b32 s33, s32
; FIJI-NEXT:    s_or_saveexec_b64 s[6:7], -1
; FIJI-NEXT:    buffer_store_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; FIJI-NEXT:    s_mov_b64 exec, s[6:7]
; FIJI-NEXT:    buffer_load_dword v1, off, s[0:3], s33
; FIJI-NEXT:    v_writelane_b32 v40, s4, 2
; FIJI-NEXT:    s_addk_i32 s32, 0x400
; FIJI-NEXT:    v_writelane_b32 v40, s30, 0
; FIJI-NEXT:    v_writelane_b32 v40, s31, 1
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; FIJI-NEXT:    s_waitcnt vmcnt(0)
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32
; FIJI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
...
; FIJI-NEXT:    s_or_saveexec_b64 s[6:7], -1
; FIJI-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; FIJI-NEXT:    s_mov_b64 exec, s[6:7]
; FIJI-NEXT:    s_mov_b32 s33, s4
; FIJI-NEXT:    s_waitcnt vmcnt(0)
; FIJI-NEXT:    s_setpc_b64 s[30:31]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_byval_i32_byval_parent:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_mov_b32 s4, s33
; HAWAII-NEXT:    s_mov_b32 s33, s32
; HAWAII-NEXT:    s_or_saveexec_b64 s[6:7], -1
; HAWAII-NEXT:    buffer_store_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; HAWAII-NEXT:    s_mov_b64 exec, s[6:7]
; HAWAII-NEXT:    buffer_load_dword v1, off, s[0:3], s33
; HAWAII-NEXT:    v_writelane_b32 v40, s4, 2
; HAWAII-NEXT:    s_addk_i32 s32, 0x400
; HAWAII-NEXT:    v_writelane_b32 v40, s30, 0
; HAWAII-NEXT:    v_writelane_b32 v40, s31, 1
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; HAWAII-NEXT:    s_waitcnt vmcnt(0)
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32
; HAWAII-NEXT:    s_swappc_b64 s[30:31], s[4:5]
...
; HAWAII-NEXT:    s_or_saveexec_b64 s[6:7], -1
; HAWAII-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; HAWAII-NEXT:    s_mov_b64 exec, s[6:7]
...
; GFX9-NEXT:    s_getpc_b64 s[4:5]
; GFX9-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_byval_i32:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    buffer_load_dword v1, off, s[0:3], 0 offset:16
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; FIJI-NEXT:    s_waitcnt vmcnt(0)
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_byval_i32:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    buffer_load_dword v1, off, s[0:3], 0 offset:16
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_byval_i32@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_byval_i32@rel32@hi+12
; HAWAII-NEXT:    s_waitcnt vmcnt(0)
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_a32i32:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; FIJI-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
; FIJI-NEXT:    buffer_load_dword v33, off, s[0:3], s32 offset:8
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    s_waitcnt vmcnt(2)
; FIJI-NEXT:    buffer_store_dword v31, off, s[0:3], s32
; FIJI-NEXT:    s_waitcnt vmcnt(2)
; FIJI-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:4
; FIJI-NEXT:    s_waitcnt vmcnt(2)
; FIJI-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:8
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_a32i32:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; HAWAII-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
; HAWAII-NEXT:    buffer_load_dword v33, off, s[0:3], s32 offset:8
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    s_waitcnt vmcnt(2)
; HAWAII-NEXT:    buffer_store_dword v31, off, s[0:3], s32
; HAWAII-NEXT:    s_waitcnt vmcnt(2)
; HAWAII-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:4
; HAWAII-NEXT:    s_waitcnt vmcnt(2)
; HAWAII-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:8
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
; HAWAII-NEXT:    s_setpc_b64 s[4:5]
;
...
; GFX9-NEXT:    s_getpc_b64 s[4:5]
; GFX9-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; GFX9-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_a32i32_stack_object:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; FIJI-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
...
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    v_mov_b32_e32 v34, 9
; FIJI-NEXT:    buffer_store_dword v34, off, s[0:3], s32 offset:32
; FIJI-NEXT:    s_waitcnt vmcnt(0)
; FIJI-NEXT:    buffer_store_dword v31, off, s[0:3], s32
; FIJI-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:4
; FIJI-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:8
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_a32i32_stack_object:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; HAWAII-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
...
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    v_mov_b32_e32 v34, 9
; HAWAII-NEXT:    buffer_store_dword v34, off, s[0:3], s32 offset:32
; HAWAII-NEXT:    s_waitcnt vmcnt(0)
; HAWAII-NEXT:    buffer_store_dword v31, off, s[0:3], s32
; HAWAII-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:4
; HAWAII-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:8
...
; FIJI-LABEL: no_sibling_call_callee_more_stack_space:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_mov_b32 s4, s33
; FIJI-NEXT:    s_mov_b32 s33, s32
...
; FIJI-NEXT:    v_writelane_b32 v40, s30, 0
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:4
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:8
; FIJI-NEXT:    v_mov_b32_e32 v2, 0
; FIJI-NEXT:    v_mov_b32_e32 v3, 0
; FIJI-NEXT:    v_mov_b32_e32 v4, 0
; FIJI-NEXT:    v_mov_b32_e32 v5, 0
; FIJI-NEXT:    v_mov_b32_e32 v6, 0
; FIJI-NEXT:    v_mov_b32_e32 v7, 0
; FIJI-NEXT:    v_mov_b32_e32 v8, 0
; FIJI-NEXT:    v_mov_b32_e32 v9, 0
; FIJI-NEXT:    v_mov_b32_e32 v10, 0
; FIJI-NEXT:    v_mov_b32_e32 v11, 0
; FIJI-NEXT:    v_mov_b32_e32 v12, 0
; FIJI-NEXT:    v_mov_b32_e32 v13, 0
; FIJI-NEXT:    v_mov_b32_e32 v14, 0
; FIJI-NEXT:    v_mov_b32_e32 v15, 0
; FIJI-NEXT:    v_mov_b32_e32 v16, 0
; FIJI-NEXT:    v_mov_b32_e32 v17, 0
; FIJI-NEXT:    v_mov_b32_e32 v18, 0
; FIJI-NEXT:    v_mov_b32_e32 v19, 0
; FIJI-NEXT:    v_mov_b32_e32 v20, 0
; FIJI-NEXT:    v_mov_b32_e32 v21, 0
; FIJI-NEXT:    v_mov_b32_e32 v22, 0
; FIJI-NEXT:    v_mov_b32_e32 v23, 0
; FIJI-NEXT:    v_mov_b32_e32 v24, 0
; FIJI-NEXT:    v_mov_b32_e32 v25, 0
; FIJI-NEXT:    v_mov_b32_e32 v26, 0
; FIJI-NEXT:    v_mov_b32_e32 v27, 0
; FIJI-NEXT:    v_mov_b32_e32 v28, 0
; FIJI-NEXT:    v_mov_b32_e32 v29, 0
; FIJI-NEXT:    v_mov_b32_e32 v30, 0
; FIJI-NEXT:    v_writelane_b32 v40, s31, 1
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; FIJI-NEXT:    v_readlane_b32 s31, v40, 1
...
; FIJI-NEXT:    s_setpc_b64 s[30:31]
;
; HAWAII-LABEL: no_sibling_call_callee_more_stack_space:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_mov_b32 s4, s33
; HAWAII-NEXT:    s_mov_b32 s33, s32
...
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32_a32i32@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    v_mov_b32_e32 v2, 0
; HAWAII-NEXT:    v_writelane_b32 v40, s30, 0
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:4
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:8
; HAWAII-NEXT:    v_mov_b32_e32 v2, 0
; HAWAII-NEXT:    v_mov_b32_e32 v3, 0
; HAWAII-NEXT:    v_mov_b32_e32 v4, 0
; HAWAII-NEXT:    v_mov_b32_e32 v5, 0
; HAWAII-NEXT:    v_mov_b32_e32 v6, 0
; HAWAII-NEXT:    v_mov_b32_e32 v7, 0
; HAWAII-NEXT:    v_mov_b32_e32 v8, 0
; HAWAII-NEXT:    v_mov_b32_e32 v9, 0
; HAWAII-NEXT:    v_mov_b32_e32 v10, 0
; HAWAII-NEXT:    v_mov_b32_e32 v11, 0
; HAWAII-NEXT:    v_mov_b32_e32 v12, 0
; HAWAII-NEXT:    v_mov_b32_e32 v13, 0
; HAWAII-NEXT:    v_mov_b32_e32 v14, 0
; HAWAII-NEXT:    v_mov_b32_e32 v15, 0
; HAWAII-NEXT:    v_mov_b32_e32 v16, 0
; HAWAII-NEXT:    v_mov_b32_e32 v17, 0
; HAWAII-NEXT:    v_mov_b32_e32 v18, 0
; HAWAII-NEXT:    v_mov_b32_e32 v19, 0
; HAWAII-NEXT:    v_mov_b32_e32 v20, 0
; HAWAII-NEXT:    v_mov_b32_e32 v21, 0
; HAWAII-NEXT:    v_mov_b32_e32 v22, 0
; HAWAII-NEXT:    v_mov_b32_e32 v23, 0
; HAWAII-NEXT:    v_mov_b32_e32 v24, 0
; HAWAII-NEXT:    v_mov_b32_e32 v25, 0
; HAWAII-NEXT:    v_mov_b32_e32 v26, 0
; HAWAII-NEXT:    v_mov_b32_e32 v27, 0
; HAWAII-NEXT:    v_mov_b32_e32 v28, 0
; HAWAII-NEXT:    v_mov_b32_e32 v29, 0
; HAWAII-NEXT:    v_mov_b32_e32 v30, 0
; HAWAII-NEXT:    v_writelane_b32 v40, s31, 1
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
; HAWAII-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; HAWAII-NEXT:    v_readlane_b32 s31, v40, 1
...
; FIJI-LABEL: sibling_call_i32_fastcc_i32_i32_other_call:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_mov_b32 s4, s33
; FIJI-NEXT:    s_mov_b32 s33, s32
; FIJI-NEXT:    s_or_saveexec_b64 s[6:7], -1
; FIJI-NEXT:    buffer_store_dword v42, off, s[0:3], s33 offset:8 ; 4-byte Folded Spill
; FIJI-NEXT:    s_mov_b64 exec, s[6:7]
; FIJI-NEXT:    s_addk_i32 s32, 0x400
; FIJI-NEXT:    v_writelane_b32 v42, s4, 2
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    v_writelane_b32 v42, s30, 0
; FIJI-NEXT:    buffer_store_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; FIJI-NEXT:    buffer_store_dword v41, off, s[0:3], s33 ; 4-byte Folded Spill
; FIJI-NEXT:    v_writelane_b32 v42, s31, 1
; FIJI-NEXT:    v_mov_b32_e32 v40, v1
; FIJI-NEXT:    v_mov_b32_e32 v41, v0
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; FIJI-NEXT:    v_mov_b32_e32 v2, v0
; FIJI-NEXT:    v_mov_b32_e32 v0, v41
; FIJI-NEXT:    v_mov_b32_e32 v1, v40
; FIJI-NEXT:    buffer_load_dword v41, off, s[0:3], s33 ; 4-byte Folded Reload
; FIJI-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, sibling_call_i32_fastcc_i32_i32@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s5, s5, sibling_call_i32_fastcc_i32_i32@rel32@hi+12
; FIJI-NEXT:    v_readlane_b32 s31, v42, 1
; FIJI-NEXT:    v_readlane_b32 s30, v42, 0
; FIJI-NEXT:    s_mov_b32 s32, s33
; FIJI-NEXT:    v_readlane_b32 s6, v42, 2
; FIJI-NEXT:    s_or_saveexec_b64 s[8:9], -1
; FIJI-NEXT:    buffer_load_dword v42, off, s[0:3], s33 offset:8 ; 4-byte Folded Reload
; FIJI-NEXT:    s_mov_b64 exec, s[8:9]
; FIJI-NEXT:    s_mov_b32 s33, s6
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_i32_fastcc_i32_i32_other_call:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_mov_b32 s4, s33
; HAWAII-NEXT:    s_mov_b32 s33, s32
; HAWAII-NEXT:    s_or_saveexec_b64 s[6:7], -1
; HAWAII-NEXT:    buffer_store_dword v42, off, s[0:3], s33 offset:8 ; 4-byte Folded Spill
; HAWAII-NEXT:    s_mov_b64 exec, s[6:7]
; HAWAII-NEXT:    s_addk_i32 s32, 0x400
; HAWAII-NEXT:    v_writelane_b32 v42, s4, 2
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32@gotpcrel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, i32_fastcc_i32_i32@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    v_writelane_b32 v42, s30, 0
; HAWAII-NEXT:    buffer_store_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Spill
; HAWAII-NEXT:    buffer_store_dword v41, off, s[0:3], s33 ; 4-byte Folded Spill
; HAWAII-NEXT:    v_writelane_b32 v42, s31, 1
; HAWAII-NEXT:    v_mov_b32_e32 v40, v1
; HAWAII-NEXT:    v_mov_b32_e32 v41, v0
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
; HAWAII-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; HAWAII-NEXT:    v_mov_b32_e32 v2, v0
; HAWAII-NEXT:    v_mov_b32_e32 v0, v41
; HAWAII-NEXT:    v_mov_b32_e32 v1, v40
; HAWAII-NEXT:    buffer_load_dword v41, off, s[0:3], s33 ; 4-byte Folded Reload
; HAWAII-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, sibling_call_i32_fastcc_i32_i32@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s5, s5, sibling_call_i32_fastcc_i32_i32@rel32@hi+12
; HAWAII-NEXT:    v_readlane_b32 s31, v42, 1
; HAWAII-NEXT:    v_readlane_b32 s30, v42, 0
; HAWAII-NEXT:    s_mov_b32 s32, s33
; HAWAII-NEXT:    v_readlane_b32 s6, v42, 2
; HAWAII-NEXT:    s_or_saveexec_b64 s[8:9], -1
; HAWAII-NEXT:    buffer_load_dword v42, off, s[0:3], s33 offset:8 ; 4-byte Folded Reload
; HAWAII-NEXT:    s_mov_b64 exec, s[8:9]
; HAWAII-NEXT:    s_mov_b32 s33, s6
; HAWAII-NEXT:    s_setpc_b64 s[4:5]
;
...
; GFX9-NEXT:    buffer_load_dword v40, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; GFX9-NEXT:    s_getpc_b64 s[4:5]
; GFX9-NEXT:    s_add_u32 s4, s4, sibling_call_i32_fastcc_i32_i32@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s5, s5, sibling_call_i32_fastcc_i32_i32@rel32@hi+12
...
; FIJI-LABEL: sibling_call_stack_objecti32_fastcc_i32_i32_a32i32:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; FIJI-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_stack_objecti32_fastcc_i32_i32_a32i32:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; HAWAII-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:4
...
; FIJI-LABEL: sibling_call_stack_objecti32_fastcc_i32_i32_a32i32_larger_arg_area:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[4:5]
; FIJI-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
...
; FIJI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; FIJI-NEXT:    v_mov_b32_e32 v2, 9
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:48
; FIJI-NEXT:    s_waitcnt vmcnt(0)
; FIJI-NEXT:    v_mov_b32_e32 v2, 0
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:4
...
; FIJI-NEXT:    s_setpc_b64 s[4:5]
;
; HAWAII-LABEL: sibling_call_stack_objecti32_fastcc_i32_i32_a32i32_larger_arg_area:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[4:5]
; HAWAII-NEXT:    s_add_u32 s4, s4, i32_fastcc_i32_i32_a32i32@gotpcrel32@lo+4
...
; HAWAII-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x0
; HAWAII-NEXT:    v_mov_b32_e32 v2, 9
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:48
; HAWAII-NEXT:    s_waitcnt vmcnt(0)
; HAWAII-NEXT:    v_mov_b32_e32 v2, 0
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:4
...
; FIJI-LABEL: indirect_uniform_sibling_call_i32_fastcc_i32_i32:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, func_ptr_gv@gotpcrel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, func_ptr_gv@gotpcrel32@hi+12
; FIJI-NEXT:    s_load_dwordx2 s[16:17], s[16:17], 0x0
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_load_dwordx2 s[16:17], s[16:17], 0x0
; FIJI-NEXT:    s_waitcnt lgkmcnt(0)
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: indirect_uniform_sibling_call_i32_fastcc_i32_i32:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, func_ptr_gv@gotpcrel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, func_ptr_gv@gotpcrel32@hi+12
; HAWAII-NEXT:    s_load_dwordx2 s[16:17], s[16:17], 0x0
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
; HAWAII-NEXT:    s_load_dwordx2 s[16:17], s[16:17], 0x0
; HAWAII-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_add_u32 s16, s16, func_ptr_gv@gotpcrel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, func_ptr_gv@gotpcrel32@hi+12
...
; FIJI-LABEL: sibling_call_fastcc_multi_byval:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    v_mov_b32_e32 v1, 9
; FIJI-NEXT:    v_mov_b32_e32 v2, 0
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:148
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:144
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:152
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:172
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:168
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:164
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:160
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:4
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:28
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:24
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; FIJI-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:16
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:8
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, void_fastcc_multi_byval@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, void_fastcc_multi_byval@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_fastcc_multi_byval:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    v_mov_b32_e32 v1, 9
; HAWAII-NEXT:    v_mov_b32_e32 v2, 0
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:148
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:144
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:152
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:172
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:168
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:164
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:160
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:4
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:28
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:24
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:20
; HAWAII-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:16
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:8
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, void_fastcc_multi_byval@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, void_fastcc_multi_byval@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, void_fastcc_multi_byval@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, void_fastcc_multi_byval@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_byval_and_stack_passed:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    v_mov_b32_e32 v1, 9
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:148
...
; FIJI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:12
; FIJI-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:16
...
; FIJI-NEXT:    v_mov_b32_e32 v30, 0
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, void_fastcc_byval_and_stack_passed@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, void_fastcc_byval_and_stack_passed@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_byval_and_stack_passed:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    v_mov_b32_e32 v1, 9
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:148
...
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:8
; HAWAII-NEXT:    v_mov_b32_e32 v1, 0
; HAWAII-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:12
; HAWAII-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:16
; HAWAII-NEXT:    v_mov_b32_e32 v0, 0
; HAWAII-NEXT:    v_mov_b32_e32 v1, 0
; HAWAII-NEXT:    v_mov_b32_e32 v2, 0
; HAWAII-NEXT:    v_mov_b32_e32 v3, 0
; HAWAII-NEXT:    v_mov_b32_e32 v4, 0
...
; HAWAII-NEXT:    v_mov_b32_e32 v30, 0
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, void_fastcc_byval_and_stack_passed@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, void_fastcc_byval_and_stack_passed@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    v_mov_b32_e32 v30, 0
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, void_fastcc_byval_and_stack_passed@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, void_fastcc_byval_and_stack_passed@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_i64_fastcc_i64:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, i64_fastcc_i64@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, i64_fastcc_i64@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_i64_fastcc_i64:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, i64_fastcc_i64@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, i64_fastcc_i64@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, i64_fastcc_i64@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, i64_fastcc_i64@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_p1i8_fastcc_p1i8:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, p1i8_fastcc_p1i8@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, p1i8_fastcc_p1i8@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_p1i8_fastcc_p1i8:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, p1i8_fastcc_p1i8@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, p1i8_fastcc_p1i8@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, p1i8_fastcc_p1i8@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, p1i8_fastcc_p1i8@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_i16_fastcc_i16:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, i16_fastcc_i16@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, i16_fastcc_i16@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_i16_fastcc_i16:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, i16_fastcc_i16@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, i16_fastcc_i16@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, i16_fastcc_i16@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, i16_fastcc_i16@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_f16_fastcc_f16:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, f16_fastcc_f16@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, f16_fastcc_f16@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_f16_fastcc_f16:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, f16_fastcc_f16@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, f16_fastcc_f16@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, f16_fastcc_f16@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, f16_fastcc_f16@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_v4i16_fastcc_v4i16:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, v4i16_fastcc_v4i16@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, v4i16_fastcc_v4i16@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_v4i16_fastcc_v4i16:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, v4i16_fastcc_v4i16@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, v4i16_fastcc_v4i16@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, v4i16_fastcc_v4i16@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, v4i16_fastcc_v4i16@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
...
; FIJI-LABEL: sibling_call_v2i64_fastcc_v2i64:
; FIJI:       ; %bb.0: ; %entry
; FIJI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; FIJI-NEXT:    s_getpc_b64 s[16:17]
; FIJI-NEXT:    s_add_u32 s16, s16, v2i64_fastcc_v2i64@rel32@lo+4
; FIJI-NEXT:    s_addc_u32 s17, s17, v2i64_fastcc_v2i64@rel32@hi+12
; FIJI-NEXT:    s_setpc_b64 s[16:17]
;
; HAWAII-LABEL: sibling_call_v2i64_fastcc_v2i64:
; HAWAII:       ; %bb.0: ; %entry
; HAWAII-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HAWAII-NEXT:    s_getpc_b64 s[16:17]
; HAWAII-NEXT:    s_add_u32 s16, s16, v2i64_fastcc_v2i64@rel32@lo+4
; HAWAII-NEXT:    s_addc_u32 s17, s17, v2i64_fastcc_v2i64@rel32@hi+12
; HAWAII-NEXT:    s_setpc_b64 s[16:17]
;
...
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_getpc_b64 s[16:17]
; GFX9-NEXT:    s_add_u32 s16, s16, v2i64_fastcc_v2i64@rel32@lo+4
; GFX9-NEXT:    s_addc_u32 s17, s17, v2i64_fastcc_v2i64@rel32@hi+12
; GFX9-NEXT:    s_setpc_b64 s[16:17]
entry:
