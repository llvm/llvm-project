...
; GFX6-NOHSA:       ; %bb.0:
; GFX6-NOHSA-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x9
; GFX6-NOHSA-NEXT:    s_mov_b32 s41, 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s27, s41
; GFX6-NOHSA-NEXT:    s_mov_b32 s19, s41
; GFX6-NOHSA-NEXT:    s_mov_b32 s13, s41
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s25, s41
; GFX6-NOHSA-NEXT:    s_mov_b32 s29, s41
; GFX6-NOHSA-NEXT:    s_mov_b32 s45, s41
; GFX6-NOHSA-NEXT:    s_mov_b32 s49, s41
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA-NEXT:    s_lshr_b32 s24, s3, 16
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s39
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s33
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s31
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[30:31], s[38:39], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[44:45], 0x80000
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0 offset:80
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s15
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s52, s5, 8
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_mov_b32 s43, s37
; GFX12-NEXT:    s_mov_b32 s27, s37
; GFX12-NEXT:    s_mov_b32 s23, s37
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_lshr_b32 s40, s3, 8
; GFX12-NEXT:    s_mov_b32 s38, s3
; GFX12-NEXT:    s_lshr_b32 s30, s2, 16
; GFX12-NEXT:    s_lshr_b32 s28, s2, 24
; GFX12-NEXT:    s_lshr_b32 s24, s2, 8
; GFX12-NEXT:    s_lshr_b32 s22, s1, 16
; GFX12-NEXT:    s_lshr_b32 s18, s1, 8
; GFX12-NEXT:    s_mov_b32 s20, s1
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s36 :: v_dual_mov_b32 v3, s52
...
; GFX12-NEXT:    v_dual_mov_b32 v18, s63 :: v_dual_mov_b32 v21, s39
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v20, s38 :: v_dual_mov_b32 v23, s41
...
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v4, s16 :: v_dual_mov_b32 v7, s25
; GFX12-NEXT:    v_dual_mov_b32 v6, s24 :: v_dual_mov_b32 v9, s23
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v8, s22 :: v_dual_mov_b32 v11, s6
; GFX12-NEXT:    v_dual_mov_b32 v10, s33 :: v_dual_mov_b32 v13, s21
; GFX12-NEXT:    v_dual_mov_b32 v12, s20 :: v_dual_mov_b32 v15, s19
; GFX12-NEXT:    v_dual_mov_b32 v14, s18 :: v_dual_mov_b32 v17, s15
