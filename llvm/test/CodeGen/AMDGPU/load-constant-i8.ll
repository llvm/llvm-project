...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[10:11], s[2:3], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_ashr_i32 s7, s1, 24
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[14:15], s[6:7], 0x80000
; GFX6-NOHSA-NEXT:    s_ashr_i32 s6, s3, 24
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s6
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s14
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; GFX6-NOHSA-NEXT:    s_lshr_b32 s6, s3, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s2, 16
; GFX6-NOHSA-NEXT:    s_ashr_i32 s10, s3, 31
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[16:17], s[8:9], 0x80000
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:112
; GFX6-NOHSA-NEXT:    s_lshr_b32 s8, s3, 8
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s30, s1, 31
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[10:11], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[28:29], s[8:9], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x80000
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v5, s15
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v9, s11
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v13, s30
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v22, s26
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v23, s27
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:96
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[20:23], off, s[4:7], 0 offset:80
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v10, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s3
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[4:7], 0 offset:64
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v10, s24
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s25
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[10:13], off, s[4:7], 0 offset:48
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v16, s22
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s23
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[14:17], off, s[4:7], 0 offset:32
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v20, s0
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s1
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[18:21], off, s[4:7], 0
; GFX6-NOHSA-NEXT:    s_endpgm
;
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s12
; GFX6-NOHSA-NEXT:    s_mov_b32 s11, 0xf000
; GFX6-NOHSA-NEXT:    s_lshr_b32 s10, s7, 16
; GFX6-NOHSA-NEXT:    s_ashr_i32 s12, s3, 24
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[1:4], off, s[8:11], 0 offset:240
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s7, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s14, s6, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s16, s6, 24
; GFX6-NOHSA-NEXT:    s_mov_b32 s18, s3
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[16:17], 0x80000
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v9, s21
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v10, s24
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s25
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v19, s22
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[8:11], 0 offset:224
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v20, s23
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s26
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v22, s27
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(1)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s18
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[19:22], off, s[8:11], 0 offset:208
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s6, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s14, s5, 16
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[6:7], s[2:3], 0x80000
; GFX6-NOHSA-NEXT:    s_ashr_i32 s16, s1, 24
; GFX6-NOHSA-NEXT:    s_ashr_i32 s18, s5, 31
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[14:17], off, s[8:11], 0 offset:176
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v14, s20
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[18:21], off, s[8:11], 0 offset:160
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s21
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v16, s24
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s25
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s16
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[14:17], off, s[8:11], 0 offset:144
; GFX6-NOHSA-NEXT:    s_lshr_b32 s4, s4, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s6, s3, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s2, 16
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[14:15], s[0:1], 0x80000
; GFX6-NOHSA-NEXT:    s_ashr_i32 s16, s3, 31
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[20:21], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[6:7], 0x80000
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s13
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s20
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[5:8], off, s[8:11], 0 offset:112
; GFX6-NOHSA-NEXT:    s_lshr_b32 s4, s3, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s6, s2, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s2, s2, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s12, s1, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s14, s1, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s16, s0, 16
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[0:1], s[0:1], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[18:19], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[16:17], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[8:11], 0 offset:80
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s2
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v12, s3
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[9:12], off, s[8:11], 0 offset:64
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s12
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v12, s13
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[11:14], off, s[8:11], 0 offset:48
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v20, s26
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v21, s27
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[18:21], off, s[8:11], 0 offset:32
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[15:18], off, s[8:11], 0
; GFX6-NOHSA-NEXT:    s_endpgm
;
...
; GFX7-HSA-NEXT:    s_lshr_b32 s52, s7, 8
; GFX7-HSA-NEXT:    s_mov_b32 s54, s7
; GFX7-HSA-NEXT:    s_lshr_b32 s56, s6, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s50, s6, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s53, s1, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s55, s3, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s57, s3, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s48, s6, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s44, s5, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s40, s5, 8
; GFX7-HSA-NEXT:    s_mov_b32 s42, s5
...
; GFX7-HSA-NEXT:    s_lshr_b32 s26, s3, 8
; GFX7-HSA-NEXT:    s_mov_b32 s28, s3
...
; GFX7-HSA-NEXT:    s_ashr_i32 s58, s5, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s59, s5, 24
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v36, s60
; GFX7-HSA-NEXT:    v_mov_b32_e32 v22, s44
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[23:24], v[14:17]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v20, s48
; GFX7-HSA-NEXT:    v_mov_b32_e32 v21, s49
; GFX7-HSA-NEXT:    v_mov_b32_e32 v38, s46
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s45
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s59
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s58
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s25
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s34
; GFX7-HSA-NEXT:    s_addc_u32 s25, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v37, s61
; GFX7-HSA-NEXT:    v_mov_b32_e32 v26, s42
; GFX7-HSA-NEXT:    v_mov_b32_e32 v30, s38
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s30
; GFX7-HSA-NEXT:    v_mov_b32_e32 v39, s47
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[10:11], v[18:21]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v27, s43
; GFX7-HSA-NEXT:    v_mov_b32_e32 v28, s40
; GFX7-HSA-NEXT:    v_mov_b32_e32 v29, s41
; GFX7-HSA-NEXT:    v_mov_b32_e32 v31, s39
; GFX7-HSA-NEXT:    v_mov_b32_e32 v32, s36
; GFX7-HSA-NEXT:    v_mov_b32_e32 v33, s37
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s35
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s31
; GFX7-HSA-NEXT:    v_mov_b32_e32 v6, s57
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s24
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[8:9], v[22:25]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[12:13], v[26:29]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[34:35], v[30:33]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[36:37], v[0:3]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s55
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s20
; GFX7-HSA-NEXT:    s_add_u32 s20, s8, 0x50
; GFX7-HSA-NEXT:    v_mov_b32_e32 v14, s28
; GFX7-HSA-NEXT:    v_mov_b32_e32 v15, s29
; GFX7-HSA-NEXT:    v_mov_b32_e32 v16, s26
; GFX7-HSA-NEXT:    v_mov_b32_e32 v17, s27
; GFX7-HSA-NEXT:    v_mov_b32_e32 v11, s25
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[38:39], v[4:7]
; GFX7-HSA-NEXT:    flat_store_dwordx4 v[10:11], v[14:17]
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s21
