...
; GFX12-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, v5
...
; GFX12-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_mov_b32 v0, s2
; GFX12-NEXT:    v_mov_b32_e32 v2, v4
; GFX12-NEXT:    v_and_b32_e32 v4, 0xffff, v6
; GFX12-NEXT:    s_and_b32 s2, s3, 0xff
; GFX12-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX12-NEXT:    v_dual_mov_b32 v3, v5 :: v_dual_mov_b32 v0, s2
; GFX12-NEXT:    v_mov_b32_e32 v2, v4
...
; GFX12-NEXT:    v_lshrrev_b16 v6, 8, s7
...
; GFX12-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_and_b32 v5, 0xffff, v6
; GFX12-NEXT:    v_lshrrev_b16 v6, 8, s5
; GFX12-NEXT:    s_and_b32 s2, s7, 0xff
; GFX12-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:64
; GFX12-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v4
; GFX12-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_and_b32 v5, 0xffff, v6
; GFX12-NEXT:    v_lshrrev_b16 v6, 8, s4
; GFX12-NEXT:    s_and_b32 s2, s5, 0xff
; GFX12-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:96
; GFX12-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v4
; GFX12-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_and_b32 v4, 0xffff, v6
...
; GFX12-NEXT:    s_lshr_b32 s16, s4, 24
...
; GFX12-NEXT:    s_lshr_b32 s14, s4, 16
; GFX12-NEXT:    s_mov_b32 s20, s5
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[4:5], 0x80000
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v13, s9
; GFX12-NEXT:    v_dual_mov_b32 v12, s8 :: v_dual_mov_b32 v15, s11
; GFX12-NEXT:    v_dual_mov_b32 v14, s10 :: v_dual_mov_b32 v5, s13
...
; GFX12-NEXT:    v_dual_mov_b32 v20, s18 :: v_dual_mov_b32 v27, s21
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v4, s12 :: v_dual_mov_b32 v17, s15
; GFX12-NEXT:    v_ashrrev_i32_e32 v29, 31, v28
; GFX12-NEXT:    v_mov_b32_e32 v26, s20
...
; GFX12-NEXT:    v_lshrrev_b16 v6, 8, s6
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v3, v5
; GFX12-NEXT:    v_mov_b32_e32 v2, v4
...
; GFX12-NEXT:    v_dual_mov_b32 v56, 0 :: v_dual_mov_b32 v33, s21
...
; GFX12-NEXT:    v_dual_mov_b32 v54, s38 :: v_dual_mov_b32 v29, s47
; GFX12-NEXT:    v_mov_b32_e32 v28, s46
...
; GFX12-NEXT:    global_store_b128 v56, v[32:35], s[8:9] offset:240
; GFX12-NEXT:    v_mov_b32_e32 v33, s41
; GFX12-NEXT:    global_store_b128 v56, v[28:31], s[8:9] offset:224
; GFX12-NEXT:    v_dual_mov_b32 v34, s18 :: v_dual_mov_b32 v25, s17
; GFX12-NEXT:    v_dual_mov_b32 v24, s16 :: v_dual_mov_b32 v31, s45
; GFX12-NEXT:    v_dual_mov_b32 v30, s44 :: v_dual_mov_b32 v21, s5
...
; GFX12-NEXT:    v_dual_mov_b32 v32, s40 :: v_dual_mov_b32 v35, s19
; GFX12-NEXT:    v_ashrrev_i32_e32 v7, 31, v6
...
; GFX12-NEXT:    v_dual_mov_b32 v28, s42 :: v_dual_mov_b32 v29, s43
; GFX12-NEXT:    v_ashrrev_i32_e32 v3, 31, v2
; GFX12-NEXT:    v_ashrrev_i32_e32 v15, 31, v14
; GFX12-NEXT:    s_clause 0x7
; GFX12-NEXT:    global_store_b128 v56, v[36:39], s[8:9] offset:208
; GFX12-NEXT:    global_store_b128 v56, v[24:27], s[8:9] offset:192
; GFX12-NEXT:    global_store_b128 v56, v[40:43], s[8:9] offset:176
; GFX12-NEXT:    global_store_b128 v56, v[20:23], s[8:9] offset:160
; GFX12-NEXT:    global_store_b128 v56, v[44:47], s[8:9] offset:144
; GFX12-NEXT:    global_store_b128 v56, v[16:19], s[8:9] offset:128
; GFX12-NEXT:    global_store_b128 v56, v[48:51], s[8:9] offset:112
; GFX12-NEXT:    global_store_b128 v56, v[12:15], s[8:9] offset:96
; GFX12-NEXT:    v_mov_b32_e32 v0, s10
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v56, v[52:55], s[8:9] offset:80
; GFX12-NEXT:    global_store_b128 v56, v[8:11], s[8:9] offset:64
; GFX12-NEXT:    global_store_b128 v56, v[32:35], s[8:9] offset:48
; GFX12-NEXT:    global_store_b128 v56, v[4:7], s[8:9] offset:32
; GFX12-NEXT:    global_store_b128 v56, v[28:31], s[8:9] offset:16
; GFX12-NEXT:    global_store_b128 v56, v[0:3], s[8:9]
; GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-NEXT:    s_endpgm
  %load = load <32 x i8>, ptr addrspace(4) %in
