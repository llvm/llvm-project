...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[16:17], s[26:27], 0x80000
...
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s5, 24
; GFX7-HSA-NEXT:    s_ashr_i32 s34, s7, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s35, s7, 24
...
; GFX12-NEXT:    v_dual_mov_b32 v26, 0 :: v_dual_mov_b32 v1, s35
; GFX12-NEXT:    s_lshr_b32 s18, s4, 24
; GFX12-NEXT:    v_dual_mov_b32 v4, s30 :: v_dual_mov_b32 v7, s11
; GFX12-NEXT:    v_dual_mov_b32 v6, s10 :: v_dual_mov_b32 v9, s13
; GFX12-NEXT:    v_dual_mov_b32 v8, s12 :: v_dual_mov_b32 v3, s15
...
; GFX12-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v11, s17
; GFX12-NEXT:    s_lshr_b32 s2, s7, 16
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x80000
; GFX12-NEXT:    s_lshr_b32 s22, s7, 8
...
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v26, v[6:9], s[0:1] offset:80
; GFX12-NEXT:    global_store_b128 v26, v[0:3], s[0:1] offset:64
; GFX12-NEXT:    v_dual_mov_b32 v6, s20 :: v_dual_mov_b32 v1, s3
; GFX12-NEXT:    v_mov_b32_e32 v7, s21
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, s33
; GFX12-NEXT:    v_dual_mov_b32 v2, s36 :: v_dual_mov_b32 v15, s25
...
; GFX12-NEXT:    v_dual_mov_b32 v16, s22 :: v_dual_mov_b32 v19, s9
; GFX12-NEXT:    v_dual_mov_b32 v18, s8 :: v_dual_mov_b32 v21, s27
; GFX12-NEXT:    v_dual_mov_b32 v20, s29 :: v_dual_mov_b32 v23, s5
; GFX12-NEXT:    v_dual_mov_b32 v22, s4 :: v_dual_mov_b32 v25, s7
; GFX12-NEXT:    v_mov_b32_e32 v24, s6
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v26, v[10:13], s[0:1] offset:16
; GFX12-NEXT:    global_store_b128 v26, v[4:7], s[0:1]
; GFX12-NEXT:    global_store_b128 v26, v[0:3], s[0:1] offset:112
; GFX12-NEXT:    global_store_b128 v26, v[14:17], s[0:1] offset:96
; GFX12-NEXT:    global_store_b128 v26, v[18:21], s[0:1] offset:48
; GFX12-NEXT:    global_store_b128 v26, v[22:25], s[0:1] offset:32
; GFX12-NEXT:    s_endpgm
  %load = load <16 x i8>, ptr addrspace(4) %in
...
; GFX6-NOHSA-NEXT:    s_ashr_i32 s19, s5, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s21, s5, 24
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[46:47], s[34:35], 0x80000
; GFX6-NOHSA-NEXT:    s_ashr_i32 s23, s7, 31
; GFX6-NOHSA-NEXT:    s_ashr_i32 s25, s7, 24
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[8:9], s[22:23], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[20:21], 0x80000
; GFX6-NOHSA-NEXT:    s_mov_b32 s31, 0
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s35, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s37, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s39, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s41, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s43, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s49, s31
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s31
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[6:7], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[50:51], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[44:45], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[44:45], s[16:17], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[46:47], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[48:49], s[12:13], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[50:51], s[10:11], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s42
...
; GFX7-HSA-NEXT:    s_mov_b32 s19, s27
...
; GFX7-HSA-NEXT:    s_ashr_i32 s31, s1, 31
; GFX7-HSA-NEXT:    s_ashr_i32 s33, s1, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s40, s0, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s36, s0, 24
...
; GFX7-HSA-NEXT:    s_bfe_i64 s[20:21], s[0:1], 0x80000
...
; GFX7-HSA-NEXT:    s_bfe_i64 s[62:63], s[30:31], 0x80000
...
; GFX7-HSA-NEXT:    s_add_u32 s38, s8, 64
...
; GFX7-HSA-NEXT:    s_add_u32 s20, s8, 16
...
; GFX7-HSA-NEXT:    s_add_u32 s20, s8, 0xf0
...
; GFX7-HSA-NEXT:    v_mov_b32_e32 v19, s21
...
; GFX12-NEXT:    s_ashr_i32 s62, s5, 24
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[24:25], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[58:59], 0x80000
...
; GFX12-NEXT:    v_dual_mov_b32 v1, s5 :: v_dual_mov_b32 v2, s62
; GFX12-NEXT:    v_mov_b32_e32 v5, s19
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v4, s18 :: v_dual_mov_b32 v7, s21
; GFX12-NEXT:    v_dual_mov_b32 v6, s20 :: v_dual_mov_b32 v9, s17
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x80000
