...
; GFX6-NOHSA-NEXT:    s_mov_b32 s5, s13
...
; GFX6-NOHSA-NEXT:    s_lshr_b32 s22, s10, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s24, s10, 24
; GFX6-NOHSA-NEXT:    s_lshr_b32 s26, s10, 8
; GFX6-NOHSA-NEXT:    s_lshr_b32 s16, s9, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s18, s9, 8
; GFX6-NOHSA-NEXT:    s_mov_b32 s20, s9
...
; GFX7-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dwordx4 s[8:11], s[2:3], 0x0
; GFX7-HSA-NEXT:    s_mov_b32 s13, s5
; GFX7-HSA-NEXT:    s_mov_b32 s15, s5
; GFX7-HSA-NEXT:    s_mov_b32 s23, s5
; GFX7-HSA-NEXT:    s_mov_b32 s25, s5
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_lshr_b32 s4, s11, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s12, s11, 8
; GFX7-HSA-NEXT:    s_mov_b32 s14, s11
; GFX7-HSA-NEXT:    s_lshr_b32 s16, s10, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s18, s10, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s20, s10, 8
; GFX7-HSA-NEXT:    s_lshr_b32 s22, s9, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s24, s9, 8
; GFX7-HSA-NEXT:    s_mov_b32 s26, s9
; GFX7-HSA-NEXT:    s_lshr_b32 s28, s8, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s30, s8, 24
; GFX7-HSA-NEXT:    s_lshr_b32 s34, s8, 8
; GFX7-HSA-NEXT:    s_bfe_i64 s[2:3], s[8:9], 0x80000
; GFX7-HSA-NEXT:    s_ashr_i64 s[6:7], s[8:9], 56
; GFX7-HSA-NEXT:    s_bfe_i64 s[8:9], s[10:11], 0x80000
; GFX7-HSA-NEXT:    s_ashr_i64 s[10:11], s[10:11], 56
; GFX7-HSA-NEXT:    s_mov_b32 s27, s5
; GFX7-HSA-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x80000
; GFX7-HSA-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-HSA-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-HSA-NEXT:    v_mov_b32_e32 v2, s10
; GFX7-HSA-NEXT:    v_mov_b32_e32 v3, s11
; GFX7-HSA-NEXT:    s_bfe_i64 s[4:5], s[34:35], 0x80000
; GFX7-HSA-NEXT:    s_bfe_i64 s[10:11], s[30:31], 0x80000
...
; GFX7-HSA-NEXT:    s_add_u32 s12, s0, 0x60
...
; GFX8-NOHSA-NEXT:    s_mov_b32 s13, s11
...
; GFX8-NOHSA-NEXT:    s_lshr_b32 s14, s7, 8
; GFX8-NOHSA-NEXT:    s_mov_b32 s12, s7
...
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v26, 0 :: v_dual_mov_b32 v3, s7
...
; GFX12-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v9, s15
...
; GFX12-NEXT:    v_mov_b32_e32 v1, s11
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v0, s10 :: v_dual_mov_b32 v3, s5
; GFX12-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v15, s13
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v14, s12 :: v_dual_mov_b32 v17, s23
; GFX12-NEXT:    v_dual_mov_b32 v16, s22 :: v_dual_mov_b32 v19, s25
; GFX12-NEXT:    v_dual_mov_b32 v18, s24 :: v_dual_mov_b32 v21, s27
; GFX12-NEXT:    v_dual_mov_b32 v20, s26 :: v_dual_mov_b32 v23, s31
; GFX12-NEXT:    v_dual_mov_b32 v22, s30 :: v_dual_mov_b32 v25, s29
; GFX12-NEXT:    v_mov_b32_e32 v24, s28
; GFX12-NEXT:    s_clause 0x5
...
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NOHSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX6-NOHSA-NEXT:    s_mov_b32 s47, 0
; GFX6-NOHSA-NEXT:    s_mov_b32 s11, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s31, s47
; GFX6-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[62:63], s[30:31], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[64:65], s[10:11], 0x80000
; GFX6-NOHSA-NEXT:    s_lshr_b32 s34, s3, 16
; GFX6-NOHSA-NEXT:    s_lshr_b32 s36, s3, 8
; GFX6-NOHSA-NEXT:    s_mov_b32 s54, s3
...
; GFX6-NOHSA-NEXT:    s_mov_b32 s58, s1
...
; GFX6-NOHSA-NEXT:    s_ashr_i64 s[30:31], s[0:1], 56
; GFX6-NOHSA-NEXT:    s_ashr_i64 s[60:61], s[2:3], 56
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v16, s70
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v17, s71
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v10, s68
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v11, s69
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s62
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s63
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v0, s66
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v1, s67
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s60
; GFX6-NOHSA-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NOHSA-NEXT:    s_mov_b32 s15, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s17, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s21, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s35, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s37, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s55, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s45, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s49, s47
; GFX6-NOHSA-NEXT:    s_mov_b32 s59, s47
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[18:21], off, s[0:3], 0 offset:240
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[46:47], s[58:59], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[58:59], s[14:15], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[60:61], s[18:19], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[62:63], s[20:21], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[64:65], s[16:17], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[66:67], s[24:25], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[68:69], s[22:23], 0x80000
...
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[16:17], s[48:49], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[18:19], s[44:45], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[20:21], s[42:43], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[22:23], s[40:41], 0x80000
; GFX6-NOHSA-NEXT:    s_bfe_i64 s[24:25], s[38:39], 0x80000
...
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v15, s59
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:224
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v12, s54
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v13, s55
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v18, s26
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v19, s27
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[0:3], 0 offset:192
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:160
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(0)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v6, s66
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v7, s67
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v8, s68
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[0:3], 0 offset:96
; GFX6-NOHSA-NEXT:    s_waitcnt expcnt(1)
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s24
...
; GFX6-NOHSA-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:32
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v2, s14
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v3, s15
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v4, s8
; GFX6-NOHSA-NEXT:    v_mov_b32_e32 v5, s9
...
; GFX7-HSA-NEXT:    s_add_i32 s12, s12, s17
; GFX7-HSA-NEXT:    s_mov_b32 s15, 0
; GFX7-HSA-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX7-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_load_dwordx8 s[0:7], s[10:11], 0x0
; GFX7-HSA-NEXT:    s_mov_b32 s47, s15
; GFX7-HSA-NEXT:    s_mov_b32 s49, s15
; GFX7-HSA-NEXT:    s_mov_b32 s59, s15
; GFX7-HSA-NEXT:    s_mov_b32 s61, s15
; GFX7-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-HSA-NEXT:    s_lshr_b32 s14, s7, 16
; GFX7-HSA-NEXT:    s_lshr_b32 s46, s7, 8
; GFX7-HSA-NEXT:    s_mov_b32 s48, s7
...
; GFX7-HSA-NEXT:    s_ashr_i64 s[40:41], s[4:5], 56
; GFX7-HSA-NEXT:    s_ashr_i64 s[2:3], s[6:7], 56
; GFX7-HSA-NEXT:    s_mov_b32 s63, s15
; GFX7-HSA-NEXT:    s_mov_b32 s37, s15
; GFX7-HSA-NEXT:    s_mov_b32 s31, s15
; GFX7-HSA-NEXT:    s_mov_b32 s35, s15
; GFX7-HSA-NEXT:    s_mov_b32 s21, s15
; GFX7-HSA-NEXT:    s_mov_b32 s65, s15
; GFX7-HSA-NEXT:    s_mov_b32 s17, s15
...
; GFX7-HSA-NEXT:    s_add_u32 s46, s8, 0xe0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v7, s47
; GFX7-HSA-NEXT:    s_addc_u32 s47, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s46
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s47
; GFX7-HSA-NEXT:    s_add_u32 s46, s8, 0xd0
; GFX7-HSA-NEXT:    s_addc_u32 s47, s9, 0
...
; GFX7-HSA-NEXT:    s_add_u32 s40, s8, 0xa0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v23, s65
; GFX7-HSA-NEXT:    v_mov_b32_e32 v4, s48
...
; GFX7-HSA-NEXT:    s_add_u32 s24, s8, 0x90
; GFX7-HSA-NEXT:    v_mov_b32_e32 v5, s25
; GFX7-HSA-NEXT:    s_addc_u32 s25, s9, 0
; GFX7-HSA-NEXT:    v_mov_b32_e32 v24, s24
; GFX7-HSA-NEXT:    v_mov_b32_e32 v10, s40
; GFX7-HSA-NEXT:    v_mov_b32_e32 v25, s25
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_mov_b32 s41, s39
; GFX12-NEXT:    s_mov_b32 s25, s39
; GFX12-NEXT:    s_mov_b32 s43, s39
; GFX12-NEXT:    s_mov_b32 s45, s39
; GFX12-NEXT:    s_mov_b32 s35, s39
; GFX12-NEXT:    s_mov_b32 s19, s39
; GFX12-NEXT:    s_mov_b32 s15, s39
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_lshr_b32 s38, s7, 16
; GFX12-NEXT:    s_lshr_b32 s46, s7, 8
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s38 :: v_dual_mov_b32 v3, s75
...
; GFX12-NEXT:    v_dual_mov_b32 v4, s40 :: v_dual_mov_b32 v7, s47
; GFX12-NEXT:    v_dual_mov_b32 v6, s46 :: v_dual_mov_b32 v9, s49
; GFX12-NEXT:    s_lshr_b32 s54, s5, 8
; GFX12-NEXT:    s_mov_b32 s42, s5
; GFX12-NEXT:    v_dual_mov_b32 v8, s48 :: v_dual_mov_b32 v11, s51
; GFX12-NEXT:    v_dual_mov_b32 v10, s50 :: v_dual_mov_b32 v13, s73
; GFX12-NEXT:    s_lshr_b32 s56, s4, 16
; GFX12-NEXT:    s_lshr_b32 s58, s4, 24
; GFX12-NEXT:    s_ashr_i64 s[70:71], s[4:5], 56
; GFX12-NEXT:    v_dual_mov_b32 v12, s72 :: v_dual_mov_b32 v15, s53
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x80000
...
; GFX12-NEXT:    s_lshr_b32 s44, s3, 16
...
; GFX12-NEXT:    v_dual_mov_b32 v14, s60 :: v_dual_mov_b32 v17, s45
; GFX12-NEXT:    s_lshr_b32 s62, s1, 8
; GFX12-NEXT:    s_mov_b32 s14, s1
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[2:3], 0x80000
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x80000
; GFX12-NEXT:    v_dual_mov_b32 v16, s44 :: v_dual_mov_b32 v19, s29
; GFX12-NEXT:    v_dual_mov_b32 v18, s28 :: v_dual_mov_b32 v21, s35
...
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[62:63], 0x80000
