...
; GFX10-NEXT:    s_and_saveexec_b32 s4, vcc_lo
; GFX10-NEXT:    s_xor_b32 s4, exec_lo, s4
; GFX10-NEXT:    s_cbranch_execnz .LBB24_3
; GFX10-NEXT:  ; %bb.1: ; %Flow2
; GFX10-NEXT:    s_andn2_saveexec_b32 s4, s4
; GFX10-NEXT:    s_cbranch_execnz .LBB24_6
; GFX10-NEXT:  .LBB24_2: ; %atomicrmw.phi
; GFX10-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; GFX10-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    v_max_f64 v[6:7], v[8:9], v[8:9]
; GFX10-NEXT:    v_min_f64 v[6:7], v[6:7], v[0:1]
; GFX10-NEXT:    s_waitcnt_vscnt null, 0x0
...
; GFX10-NEXT:  .LBB24_6: ; %atomicrmw.private
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[4:5]
; GFX10-NEXT:    v_max_f64 v[2:3], v[2:3], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e32 v6, -1, v4, vcc_lo
; GFX10-NEXT:    s_clause 0x1
...
; GFX90A-NEXT:    v_min_f64 v[6:7], v[0:1], v[6:7]
...
; GFX942-NEXT:    v_min_f16_e32 v5, v6, v5
...
; GFX942-NEXT:    v_min_f16_e32 v3, v3, v4
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_pk_min_f16 v4, v3, v4
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    flat_atomic_cmpswap v3, v[0:1], v[4:5] sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
...
; GFX942-NEXT:    v_min_f32_e32 v4, v6, v4
; GFX942-NEXT:    v_min_f32_e32 v3, v7, v3
...
; GFX942-NEXT:    v_lshlrev_b32_e32 v6, 16, v1
; GFX942-NEXT:    v_and_b32_e32 v7, 0xffff0000, v1
; GFX942-NEXT:    v_min_f32_e32 v3, v6, v3
; GFX942-NEXT:    v_min_f32_e32 v0, v7, v0
; GFX942-NEXT:    v_bfe_u32 v6, v3, 16, 1
; GFX942-NEXT:    v_bfe_u32 v8, v0, 16, 1
; GFX942-NEXT:    v_or_b32_e32 v7, 0x400000, v3
; GFX942-NEXT:    v_or_b32_e32 v9, 0x400000, v0
; GFX942-NEXT:    v_add3_u32 v6, v6, v3, s4
; GFX942-NEXT:    v_add3_u32 v8, v8, v0, s4
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX942-NEXT:    v_cmp_u_f32_e64 s[0:1], v3, v3
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v3, v8, v9, vcc
; GFX942-NEXT:    v_cndmask_b32_e64 v0, v6, v7, s[0:1]
; GFX942-NEXT:    v_perm_b32 v0, v3, v0, s5
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    flat_atomic_cmpswap v0, v[4:5], v[0:1] sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
