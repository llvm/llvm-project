...
define amdgpu_kernel void @s_input_output_i128() {
  ...
  ; GFX908-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 43515914 /* regdef:SGPR_128 */, def %12
  ; GFX908-NEXT:   [[COPY:%[0-9]+]]:sgpr_128 = COPY %12
  ; GFX908-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 43515913 /* reguse:SGPR_128 */, [[COPY]]
  ; GFX908-NEXT:   S_ENDPGM 0
  ;
  ; GFX90A-LABEL: name: s_input_output_i128
  ; GFX90A: bb.0 (%ir-block.0):
  ; GFX90A-NEXT:   INLINEASM &"; def $0", 1 /* sideeffect attdialect */, 43515914 /* regdef:SGPR_128 */, def %10
  ; GFX90A-NEXT:   [[COPY:%[0-9]+]]:sgpr_128 = COPY %10
  ; GFX90A-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 43515913 /* reguse:SGPR_128 */, [[COPY]]
