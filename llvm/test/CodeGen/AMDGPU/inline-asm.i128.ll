...
; RUN: llc -mtriple=amdgpu9.08-amd-amdhsa -stop-after=finalize-isel -o - %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -mtriple=amdgpu9.0a-amd-amdhsa -stop-after=finalize-isel -o - %s | FileCheck -check-prefix=GFX90A %s
