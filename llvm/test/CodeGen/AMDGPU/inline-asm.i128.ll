...
define amdgpu_kernel void @s_input_output_i128() {
  ...
  ; GFX908-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 7143433 /* reguse:SGPR_128 */, [[PRED_COPY]]
  ...
  ; GFX90A-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 7143433 /* reguse:SGPR_128 */, [[PRED_COPY]]
...
define amdgpu_kernel void @v_input_output_i128() {
  ...
  ; GFX908-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 6094857 /* reguse:VReg_128 */, [[PRED_COPY]]
  ; GFX908-NEXT:   S_ENDPGM 0
  ...
  ; GFX90A-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 6422537 /* reguse:VReg_128_Align2 */, [[PRED_COPY]]
  ; GFX90A-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @a_input_output_i128() {
  ...
  ; GFX908-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 6029321 /* reguse:AReg_128 */, [[PRED_COPY]]
  ; GFX908-NEXT:   S_ENDPGM 0
  ...
  ; GFX90A-NEXT:   INLINEASM &"; use $0", 1 /* sideeffect attdialect */, 6291465 /* reguse:AReg_128_Align2 */, [[PRED_COPY]]
  ; GFX90A-NEXT:   S_ENDPGM 0
