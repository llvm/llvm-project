...
; GCN-LABEL: v_exp10_f32_fast:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s4, 0xc217b818
; GCN-NEXT:    v_add_f32_e32 v1, 0x42000000, v0
...
; GCN-NEXT:    v_mul_f32_e32 v1, 0xa4fb11f, v0
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp10_f32_fast:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xc217b818
; SI-NEXT:    v_add_f32_e32 v1, 0x42000000, v0
...
; SI-NEXT:    v_mul_f32_e32 v1, 0xa4fb11f, v0
; SI-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; SI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-LABEL: v_exp10_f32_afn_dynamic:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s4, 0xc217b818
; GCN-NEXT:    v_add_f32_e32 v1, 0x42000000, v0
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_exp10_f32_afn_dynamic:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xc217b818
; SI-NEXT:    v_add_f32_e32 v1, 0x42000000, v0
...
; GCN-LABEL: v_fabs_exp10_f32_afn:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s4, 0xc217b818
; GCN-NEXT:    s_mov_b32 s5, 0x42000000
; GCN-NEXT:    v_add_f32_e64 v1, |v0|, s5
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_fabs_exp10_f32_afn:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xc217b818
; SI-NEXT:    s_mov_b32 s5, 0x42000000
; SI-NEXT:    v_add_f32_e64 v1, |v0|, s5
