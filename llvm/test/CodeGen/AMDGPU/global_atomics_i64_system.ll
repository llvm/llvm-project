...
; RUN: llc -mtriple=amdgpu6.00 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=SI %s
; RUN: llc -mtriple=amdgpu8.02 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=VI %s
; RUN: llc -mtriple=amdgpu9.00 -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=GFX9 %s
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_gt_u64_e32 vcc, v[6:7], v[2:3]
; SI-NEXT:    v_subrev_i32_e64 v4, s[4:5], 1, v6
; SI-NEXT:    v_subbrev_u32_e64 v5, s[4:5], 0, v7, s[4:5]
...
; SI-NEXT:    v_cmp_gt_u64_e32 vcc, v[10:11], v[4:5]
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_subrev_i32_e64 v0, s[4:5], 1, v10
; SI-NEXT:    v_subbrev_u32_e64 v1, s[4:5], 0, v11, s[4:5]
; SI-NEXT:    s_or_b64 vcc, s[4:5], vcc
