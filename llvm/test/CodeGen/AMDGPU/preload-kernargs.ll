...
; RUN: llc -mtriple=amdgpu12.50--amdhsa < %s | FileCheck -check-prefixes=GFX1250,GFX1250-SDAG %s
; RUN: llc -global-isel -mtriple=amdgpu12.50--amdhsa < %s | FileCheck -check-prefixes=GFX1250,GFX1250-GISEL %s
...
; GFX942-GISEL-NEXT:    s_lshr_b32 s0, s4, 8
; GFX942-GISEL-NEXT:    s_and_b32 s0, s0, 0xff
; GFX942-GISEL-NEXT:    s_and_b32 s1, s4, 0xff
; GFX942-GISEL-NEXT:    s_lshl_b32 s0, s0, 8
; GFX942-GISEL-NEXT:    s_or_b32 s0, s1, s0
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX90a-GISEL-NEXT:    s_lshr_b32 s0, s10, 8
; GFX90a-GISEL-NEXT:    s_and_b32 s0, s0, 0xff
; GFX90a-GISEL-NEXT:    s_and_b32 s1, s10, 0xff
; GFX90a-GISEL-NEXT:    s_lshl_b32 s0, s0, 8
; GFX90a-GISEL-NEXT:    s_or_b32 s0, s1, s0
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; GFX1250-GISEL-NEXT:    v_nop
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    s_lshr_b32 s0, s4, 8
; GFX1250-GISEL-NEXT:    s_and_b32 s1, s4, 0xff
; GFX1250-GISEL-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-GISEL-NEXT:    s_lshl_b32 s0, s0, 8
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    s_or_b32 s0, s1, s0
...
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-GISEL-NEXT:    s_lshr_b32 s1, s4, 16
...
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s10
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX90a-GISEL-NEXT:    s_lshr_b32 s1, s10, 16
...
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, 0
; GFX1250-GISEL-NEXT:    s_lshr_b32 s6, s4, 24
...
; GFX942-GISEL-NEXT:    s_bfe_u32 s7, s4, 0x80008
; GFX942-GISEL-NEXT:    s_lshr_b32 s0, s4, 24
; GFX942-GISEL-NEXT:    s_and_b32 s6, s4, 0xff
; GFX942-GISEL-NEXT:    s_lshl_b32 s7, s7, 8
; GFX942-GISEL-NEXT:    s_bfe_u32 s4, s4, 0x80010
; GFX942-GISEL-NEXT:    s_or_b32 s6, s6, s7
; GFX942-GISEL-NEXT:    s_lshl_b32 s4, s4, 16
; GFX942-GISEL-NEXT:    s_or_b32 s4, s6, s4
; GFX942-GISEL-NEXT:    s_lshl_b32 s0, s0, 24
; GFX942-GISEL-NEXT:    s_bfe_u32 s6, s5, 0x80008
; GFX942-GISEL-NEXT:    s_lshr_b32 s1, s5, 24
; GFX942-GISEL-NEXT:    s_or_b32 s0, s4, s0
; GFX942-GISEL-NEXT:    s_and_b32 s4, s5, 0xff
; GFX942-GISEL-NEXT:    s_lshl_b32 s6, s6, 8
; GFX942-GISEL-NEXT:    s_bfe_u32 s5, s5, 0x80010
; GFX942-GISEL-NEXT:    s_or_b32 s4, s4, s6
; GFX942-GISEL-NEXT:    s_lshl_b32 s5, s5, 16
; GFX942-GISEL-NEXT:    s_or_b32 s4, s4, s5
; GFX942-GISEL-NEXT:    s_lshl_b32 s1, s1, 24
; GFX942-GISEL-NEXT:    s_or_b32 s1, s4, s1
; GFX942-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
...
; GFX90a-GISEL-NEXT:    s_bfe_u32 s3, s10, 0x80008
; GFX90a-GISEL-NEXT:    s_and_b32 s2, s10, 0xff
; GFX90a-GISEL-NEXT:    s_lshl_b32 s3, s3, 8
; GFX90a-GISEL-NEXT:    s_or_b32 s2, s2, s3
; GFX90a-GISEL-NEXT:    s_bfe_u32 s3, s10, 0x80010
; GFX90a-GISEL-NEXT:    s_lshr_b32 s0, s10, 24
; GFX90a-GISEL-NEXT:    s_lshl_b32 s3, s3, 16
; GFX90a-GISEL-NEXT:    s_or_b32 s2, s2, s3
; GFX90a-GISEL-NEXT:    s_lshl_b32 s0, s0, 24
; GFX90a-GISEL-NEXT:    s_bfe_u32 s3, s11, 0x80008
; GFX90a-GISEL-NEXT:    s_or_b32 s0, s2, s0
; GFX90a-GISEL-NEXT:    s_and_b32 s2, s11, 0xff
; GFX90a-GISEL-NEXT:    s_lshl_b32 s3, s3, 8
; GFX90a-GISEL-NEXT:    s_or_b32 s2, s2, s3
; GFX90a-GISEL-NEXT:    s_bfe_u32 s3, s11, 0x80010
; GFX90a-GISEL-NEXT:    s_lshr_b32 s1, s11, 24
; GFX90a-GISEL-NEXT:    s_lshl_b32 s3, s3, 16
; GFX90a-GISEL-NEXT:    s_or_b32 s2, s2, s3
; GFX90a-GISEL-NEXT:    s_lshl_b32 s1, s1, 24
; GFX90a-GISEL-NEXT:    s_or_b32 s1, s2, s1
; GFX90a-GISEL-NEXT:    v_pk_mov_b32 v[0:1], s[0:1], s[0:1] op_sel:[0,1]
...
; GFX1250-GISEL-NEXT:    v_nop
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    s_bfe_u32 s1, s4, 0x80008
; GFX1250-GISEL-NEXT:    s_lshr_b32 s0, s4, 24
; GFX1250-GISEL-NEXT:    s_and_b32 s6, s4, 0xff
; GFX1250-GISEL-NEXT:    s_lshl_b32 s1, s1, 8
; GFX1250-GISEL-NEXT:    s_bfe_u32 s4, s4, 0x80010
; GFX1250-GISEL-NEXT:    s_or_b32 s1, s6, s1
; GFX1250-GISEL-NEXT:    s_lshl_b32 s4, s4, 16
; GFX1250-GISEL-NEXT:    s_lshr_b32 s6, s5, 24
; GFX1250-GISEL-NEXT:    s_or_b32 s1, s1, s4
; GFX1250-GISEL-NEXT:    s_bfe_u32 s4, s5, 0x80008
; GFX1250-GISEL-NEXT:    s_and_b32 s7, s5, 0xff
; GFX1250-GISEL-NEXT:    s_lshl_b32 s4, s4, 8
; GFX1250-GISEL-NEXT:    s_bfe_u32 s5, s5, 0x80010
; GFX1250-GISEL-NEXT:    s_or_b32 s4, s7, s4
; GFX1250-GISEL-NEXT:    s_lshl_b32 s5, s5, 16
; GFX1250-GISEL-NEXT:    s_lshl_b32 s0, s0, 24
; GFX1250-GISEL-NEXT:    s_or_b32 s4, s4, s5
; GFX1250-GISEL-NEXT:    s_lshl_b32 s5, s6, 24
; GFX1250-GISEL-NEXT:    s_or_b32 s0, s1, s0
; GFX1250-GISEL-NEXT:    s_or_b32 s1, s4, s5
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX942-GISEL-NEXT:    s_pack_lh_b32_b16 s0, s4, s4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-GISEL-NEXT:    global_store_dword v1, v0, s[2:3]
; GFX942-GISEL-NEXT:    s_endpgm
...
; GFX90a-GISEL-NEXT:    s_pack_lh_b32_b16 s0, s10, s10
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX90a-GISEL-NEXT:    global_store_dword v1, v0, s[8:9]
; GFX90a-GISEL-NEXT:    s_endpgm
...
; GFX1250-GISEL-NEXT:    s_lshr_b32 s0, s4, 16
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-GISEL-NEXT:    s_pack_ll_b32_b16 s0, s4, s0
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX1250-GISEL-NEXT:    global_store_b32 v1, v0, s[2:3]
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX942-GISEL-NEXT:    s_pack_lh_b32_b16 s4, s6, s6
; GFX942-GISEL-NEXT:    s_pack_lh_b32_b16 s5, s7, s7
; GFX942-GISEL-NEXT:    s_pack_lh_b32_b16 s6, s8, s8
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v1, s5
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v2, s6
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX90a-GISEL-NEXT:    s_pack_lh_b32_b16 s0, s12, s12
; GFX90a-GISEL-NEXT:    s_pack_lh_b32_b16 s1, s13, s13
; GFX90a-GISEL-NEXT:    s_pack_lh_b32_b16 s2, s14, s14
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX1250-GISEL-NEXT:    s_lshr_b32 s9, s8, 16
; GFX1250-GISEL-NEXT:    s_pack_ll_b32_b16 s4, s6, s0
; GFX1250-GISEL-NEXT:    s_pack_ll_b32_b16 s5, s7, s1
; GFX1250-GISEL-NEXT:    s_pack_ll_b32_b16 s6, s8, s9
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, 0
; GFX1250-GISEL-NEXT:    global_store_b96 v3, v[0:2], s[2:3]
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX942-GISEL-NEXT:    global_store_byte v1, v0, s[2:3] offset:2
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s6
; GFX942-GISEL-NEXT:    s_lshr_b32 s7, s5, 8
; GFX942-GISEL-NEXT:    global_store_byte v1, v0, s[2:3] offset:3
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s5
; GFX942-GISEL-NEXT:    s_lshr_b32 s8, s5, 16
; GFX942-GISEL-NEXT:    global_store_byte v1, v0, s[2:3] offset:4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s7
...
; GFX90a-GISEL-NEXT:    global_store_byte v1, v0, s[8:9] offset:2
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX90a-GISEL-NEXT:    s_lshr_b32 s3, s11, 8
; GFX90a-GISEL-NEXT:    global_store_byte v1, v0, s[8:9] offset:3
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s11
; GFX90a-GISEL-NEXT:    s_lshr_b32 s4, s11, 16
; GFX90a-GISEL-NEXT:    global_store_byte v1, v0, s[8:9] offset:4
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s3
...
; GFX1250-GISEL-NEXT:    s_lshr_b32 s6, s4, 24
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s1
; GFX1250-GISEL-NEXT:    s_lshr_b32 s7, s5, 8
; GFX1250-GISEL-NEXT:    s_lshr_b32 s8, s5, 16
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s5
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v6, s7 :: v_dual_mov_b32 v7, s8
; GFX1250-GISEL-NEXT:    s_clause 0x6
; GFX1250-GISEL-NEXT:    global_store_b8 v1, v0, s[2:3]
; GFX1250-GISEL-NEXT:    global_store_b8 v1, v2, s[2:3] offset:1
; GFX1250-GISEL-NEXT:    global_store_b8 v1, v3, s[2:3] offset:2
...
; GFX942-GISEL-NEXT:    s_lshr_b32 s1, s4, 16
; GFX942-GISEL-NEXT:    s_lshr_b32 s0, s4, 24
; GFX942-GISEL-NEXT:    s_and_b32 s1, s1, 0xff
; GFX942-GISEL-NEXT:    s_lshl_b32 s0, s0, 8
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v0, s4
; GFX942-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX942-GISEL-NEXT:    s_or_b32 s0, s1, s0
...
; GFX90a-GISEL-NEXT:    s_lshr_b32 s1, s10, 16
; GFX90a-GISEL-NEXT:    s_lshr_b32 s0, s10, 24
; GFX90a-GISEL-NEXT:    s_and_b32 s1, s1, 0xff
; GFX90a-GISEL-NEXT:    s_lshl_b32 s0, s0, 8
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v0, s10
; GFX90a-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX90a-GISEL-NEXT:    s_or_b32 s0, s1, s0
...
; GFX1250-GISEL-NEXT:    s_lshr_b32 s1, s4, 16
; GFX1250-GISEL-NEXT:    s_lshr_b32 s4, s4, 24
; GFX1250-GISEL-NEXT:    s_and_b32 s1, s1, 0xff
; GFX1250-GISEL-NEXT:    s_lshl_b32 s4, s4, 8
; GFX1250-GISEL-NEXT:    v_mov_b16_e32 v0.l, s0
; GFX1250-GISEL-NEXT:    s_or_b32 s0, s1, s4
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-GISEL-NEXT:    v_mov_b16_e32 v0.h, s0
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b16 v1, v0, s[2:3]
