...
; SDAG-NEXT:    v_cndmask_b32_e64 v13, 0, v0, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v12, 0, v1, s[4:5]
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v13, v8, 0
; SDAG-NEXT:    v_mul_lo_u32 v14, v9, v2
; SDAG-NEXT:    v_mul_lo_u32 v15, v8, v3
; SDAG-NEXT:    v_mov_b32_e32 v6, v1
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v8, v[6:7]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v6, v5
; SDAG-NEXT:    v_mov_b32_e32 v5, v7
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v13, v9, v[4:5]
; SDAG-NEXT:    v_add3_u32 v3, v3, v15, v14
...
; GISEL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GISEL-NEXT:    v_lshlrev_b32_e32 v2, 16, v0
; GISEL-NEXT:    v_lshl_or_b32 v11, v0, 16, v0
; GISEL-NEXT:    v_or3_b32 v9, v1, v2, 1
; GISEL-NEXT:    v_or3_b32 v10, v0, v2, 0
