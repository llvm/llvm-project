...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, -1, v[2:3]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v11, 0, v1, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v12, v10, 0
; SDAG-NEXT:    v_mov_b32_e32 v3, 0
; SDAG-NEXT:    v_mul_lo_u32 v13, v8, v2
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[6:7], v10, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v2, v1
; SDAG-NEXT:    v_mul_lo_u32 v14, v10, v6
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[6:7], v11, v10, v[2:3]
; SDAG-NEXT:    ; implicit-def: $vgpr10
; SDAG-NEXT:    v_add3_u32 v5, v5, v14, v13
; SDAG-NEXT:    v_mov_b32_e32 v2, v6
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], v12, v8, v[2:3]
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[6:7], v9, v12, v[4:5]
...
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], v11, v8, v[2:3]
; SDAG-NEXT:    ; implicit-def: $vgpr8
; SDAG-NEXT:    v_add3_u32 v5, v9, v5, v6
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v4
...
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[6:7], v11, v10, v[6:7]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], v10, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v6, v4
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[6:7], v12, v8, v[6:7]
; SDAG-NEXT:    v_add3_u32 v3, v3, v14, v13
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], v9, v12, v[2:3]
; SDAG-NEXT:    v_add_co_u32_e32 v3, vcc, v5, v7
; SDAG-NEXT:    v_addc_co_u32_e64 v4, s[6:7], 0, 0, vcc
; SDAG-NEXT:    v_mul_lo_u32 v10, v9, v11
; SDAG-NEXT:    v_mul_lo_u32 v9, v9, v12
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v11, v8, v[3:4]
; SDAG-NEXT:    ; implicit-def: $vgpr8
; SDAG-NEXT:    v_add3_u32 v5, v9, v2, v10
; SDAG-NEXT:    v_add_co_u32_e32 v2, vcc, v3, v1
; SDAG-NEXT:    v_addc_co_u32_e32 v3, vcc, v4, v5, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e64 v8, -1, 1, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v12, 0, v0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v11, 0, v1, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v12, v8, 0
; SDAG-NEXT:    v_mul_lo_u32 v13, v9, v2
; SDAG-NEXT:    v_mul_lo_u32 v14, v8, v3
; SDAG-NEXT:    v_mov_b32_e32 v6, v1
; SDAG-NEXT:    v_mad_u64_u32 v[4:5], s[6:7], v11, v8, v[6:7]
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], v8, v2, 0
; SDAG-NEXT:    v_mov_b32_e32 v6, v4
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[6:7], v12, v9, v[6:7]
; SDAG-NEXT:    v_add3_u32 v3, v3, v14, v13
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], v10, v12, v[2:3]
; SDAG-NEXT:    v_add_co_u32_e32 v3, vcc, v5, v7
; SDAG-NEXT:    v_addc_co_u32_e64 v4, s[6:7], 0, 0, vcc
; SDAG-NEXT:    v_mul_lo_u32 v8, v10, v11
; SDAG-NEXT:    v_mul_lo_u32 v10, v10, v12
; SDAG-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v11, v9, v[3:4]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v2
; SDAG-NEXT:    v_cndmask_b32_e32 v0, v0, v6, vcc
