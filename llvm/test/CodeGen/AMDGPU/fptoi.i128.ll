...
; GISEL-NEXT:    s_xor_b64 s[10:11], exec, s[6:7]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GISEL-NEXT:    v_lshlrev_b16_e32 v3, 2, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v4, 3, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v5, 4, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v6, 5, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v7, 6, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v8, 7, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v9, 8, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v10, 9, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v11, 10, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v12, 11, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v13, 12, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v14, 13, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v15, 14, v0
; GISEL-NEXT:    v_lshlrev_b16_e32 v16, 15, v0
; GISEL-NEXT:    v_or_b32_e32 v0, v0, v2
; GISEL-NEXT:    v_or_b32_e32 v1, v1, v2
; GISEL-NEXT:    v_or_b32_e32 v0, v0, v3
; GISEL-NEXT:    v_or_b32_e32 v1, v1, v3
; GISEL-NEXT:    v_or_b32_e32 v0, v0, v4
; GISEL-NEXT:    v_or_b32_e32 v1, v1, v4
; GISEL-NEXT:    v_or_b32_e32 v0, v0, v5
; GISEL-NEXT:    v_or_b32_e32 v1, v1, v5
...
; GISEL-NEXT:    v_or_b32_e32 v0, v0, v16
; GISEL-NEXT:    v_or_b32_e32 v1, v1, v16
; GISEL-NEXT:    v_and_b32_e32 v6, 0xffff, v0
; GISEL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GISEL-NEXT:    v_lshlrev_b32_e32 v0, 16, v6
; GISEL-NEXT:    v_or3_b32 v4, v1, v0, 1
; GISEL-NEXT:    v_or3_b32 v5, v6, v0, 0
; GISEL-NEXT:    s_mov_b64 s[4:5], 0
; GISEL-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3
; GISEL-NEXT:    s_and_saveexec_b64 s[6:7], s[4:5]
...
; GISEL-NEXT:  ; %bb.3: ; %fp-to-i-if-else
; GISEL-NEXT:    v_lshl_or_b32 v0, v6, 16, v6
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], 0, v0, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], 0, v5, v[0:1]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], 0, v4, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], s4, v4, v[2:3]
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], 0, v5, v[1:2]
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[6:7], 0, v4, v[1:2]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[6:7], 0, v3, s[6:7]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[4:5], 0, v3, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], s4, v5, v[3:4]
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], s4, v4, v[5:6]
...
; GISEL-NEXT:  ; %bb.5: ; %fp-to-i-if-then12
; GISEL-NEXT:    s_sub_u32 s6, 0x86, 0
; GISEL-NEXT:    s_sub_i32 s12, s6, 64
; GISEL-NEXT:    s_cmp_lt_u32 s6, 64
; GISEL-NEXT:    s_cselect_b32 s14, 1, 0
; GISEL-NEXT:    s_cmp_eq_u32 s6, 0
; GISEL-NEXT:    s_cselect_b32 s15, 1, 0
; GISEL-NEXT:    s_lshr_b64 s[6:7], 0x80, s6
; GISEL-NEXT:    s_lshr_b64 s[12:13], 0, s12
; GISEL-NEXT:    s_cmp_lg_u32 s14, 0
; GISEL-NEXT:    s_cselect_b32 s6, s6, s12
; GISEL-NEXT:    s_cmp_lg_u32 s15, 0
; GISEL-NEXT:    s_cselect_b32 s6, 0x80, s6
; GISEL-NEXT:    v_mul_hi_i32_i24_e32 v1, s6, v4
; GISEL-NEXT:    v_ashrrev_i32_e32 v2, 31, v1
; GISEL-NEXT:    v_mul_i32_i24_e32 v0, s6, v4
