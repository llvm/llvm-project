...
; DAG-NEXT:    s_wait_kmcnt 0x0
; DAG-NEXT:    s_add_nc_u64 s[2:3], s[2:3], -4
...
; GISEL-NEXT:    s_add_co_ci_u32 s3, s3, -1
...
; DAG-NEXT:    s_mov_b32 s3, 0
; DAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; DAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; DAG-NEXT:    s_movk_i32 s2, 0xffe8
; DAG-NEXT:    s_mov_b32 s3, -1
; DAG-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
...
; GISEL-NEXT:    s_add_co_u32 s0, s0, 0xffffffe8
; GISEL-NEXT:    s_add_co_ci_u32 s1, s1, -1
