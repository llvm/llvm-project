...
; RUN: llc -mtriple=amdgpu12.00 < %s | FileCheck -check-prefixes=GCN,DAG %s
; RUN: llc -mtriple=amdgpu12.00 -global-isel=1 < %s | FileCheck -check-prefixes=GCN,GISEL %s
...
; GISEL-NEXT:    v_add_co_u32 v8, vcc_lo, v5, v0
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_add_co_ci_u32_e64 v9, null, v6, v1, vcc_lo
; GISEL-NEXT:    global_load_i16 v0, v[8:9], off offset:32
...
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_add_co_ci_u32_e64 v9, null, v6, v1, vcc_lo
; GISEL-NEXT:    global_load_u16 v0, v[8:9], off offset:32
; GISEL-NEXT:    s_wait_loadcnt 0x0
; GISEL-NEXT:    global_store_b32 v[3:4], v0, off
; GISEL-NEXT:    s_endpgm
  %gep1 = getelementptr i16, ptr addrspace(4) %in, i64 16
