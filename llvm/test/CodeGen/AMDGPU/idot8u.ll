...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshr_b32 s6, s2, 28
; GFX8-NEXT:    s_lshr_b32 s13, s4, 28
; GFX8-NEXT:    s_bfe_u32 s14, s4, 0x40018
; GFX8-NEXT:    s_bfe_u32 s15, s4, 0x40014
; GFX8-NEXT:    s_bfe_u32 s16, s4, 0x40010
; GFX8-NEXT:    s_bfe_u32 s17, s4, 0x4000c
; GFX8-NEXT:    s_bfe_u32 s18, s4, 0x40008
; GFX8-NEXT:    s_bfe_u32 s19, s4, 0x40004
; GFX8-NEXT:    s_and_b32 s4, s4, 15
; GFX8-NEXT:    s_bfe_u32 s7, s2, 0x40018
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshr_b32 s6, s2, 28
; GFX9-NEXT:    s_lshr_b32 s13, s4, 28
; GFX9-NEXT:    s_bfe_u32 s14, s4, 0x40018
; GFX9-NEXT:    s_bfe_u32 s15, s4, 0x40014
; GFX9-NEXT:    s_bfe_u32 s16, s4, 0x40010
; GFX9-NEXT:    s_bfe_u32 s17, s4, 0x4000c
; GFX9-NEXT:    s_bfe_u32 s18, s4, 0x40008
; GFX9-NEXT:    s_bfe_u32 s19, s4, 0x40004
; GFX9-NEXT:    s_and_b32 s4, s4, 15
; GFX9-NEXT:    s_bfe_u32 s7, s2, 0x40018
...
; GFX9-NEXT:    v_mad_u32_u24 v2, s6, v1, v0
...
; GFX9-DL-NEXT:    v_dot8_u32_u4 v2, s2, v0, v1
...
; GFX9-NEXT:    v_mad_u32_u24 v1, s6, v2, v1
...
; GFX9-DL-NEXT:    s_load_dword s5, s[0:1], 0x0
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    s_lshr_b32 s6, s2, 28
; GFX9-DL-NEXT:    s_bfe_u32 s19, s4, 0x40004
; GFX9-DL-NEXT:    s_lshr_b32 s13, s4, 28
; GFX9-DL-NEXT:    s_bfe_u32 s14, s4, 0x40018
; GFX9-DL-NEXT:    s_bfe_u32 s15, s4, 0x40014
; GFX9-DL-NEXT:    s_bfe_u32 s16, s4, 0x40010
; GFX9-DL-NEXT:    s_bfe_u32 s17, s4, 0x4000c
; GFX9-DL-NEXT:    s_bfe_u32 s18, s4, 0x40008
; GFX9-DL-NEXT:    s_and_b32 s4, s4, 15
; GFX9-DL-NEXT:    s_bfe_u32 s7, s2, 0x40018
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, s19
...
; GFX9-NEXT:    v_pk_mul_lo_u16 v2, s5, v0
; GFX9-NEXT:    s_pack_ll_b32_b16 s5, s14, s15
; GFX9-NEXT:    s_bfe_u32 s7, s2, 0x40010
; GFX9-NEXT:    s_bfe_u32 s8, s2, 0x40014
; GFX9-NEXT:    s_bfe_u32 s16, s4, 0x40008
; GFX9-NEXT:    s_bfe_u32 s17, s4, 0x4000c
; GFX9-NEXT:    s_and_b32 s18, s4, 15
; GFX9-NEXT:    s_bfe_u32 s4, s4, 0x40004
; GFX9-NEXT:    v_mov_b32_e32 v0, s5
; GFX9-NEXT:    s_pack_ll_b32_b16 s6, s7, s8
; GFX9-NEXT:    s_bfe_u32 s9, s2, 0x40008
; GFX9-NEXT:    s_bfe_u32 s10, s2, 0x4000c
; GFX9-NEXT:    s_pack_ll_b32_b16 s5, s16, s17
; GFX9-NEXT:    v_pk_mul_lo_u16 v3, s6, v0
; GFX9-NEXT:    s_and_b32 s11, s2, 15
; GFX9-NEXT:    s_bfe_u32 s2, s2, 0x40004
; GFX9-NEXT:    s_pack_ll_b32_b16 s6, s9, s10
; GFX9-NEXT:    v_mov_b32_e32 v0, s5
; GFX9-NEXT:    s_pack_ll_b32_b16 s4, s18, s4
; GFX9-NEXT:    v_pk_mul_lo_u16 v4, s6, v0
...
; GFX9-DL-NEXT:    s_lshr_b32 s13, s4, 28
; GFX9-DL-NEXT:    s_lshr_b32 s6, s2, 28
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s12, s12, s13
; GFX9-DL-NEXT:    s_bfe_u32 s14, s4, 0x40010
; GFX9-DL-NEXT:    s_bfe_u32 s15, s4, 0x40014
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s5, s5, s6
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s12
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v2, s5, v0
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s5, s14, s15
; GFX9-DL-NEXT:    s_bfe_u32 s7, s2, 0x40010
; GFX9-DL-NEXT:    s_bfe_u32 s8, s2, 0x40014
; GFX9-DL-NEXT:    s_bfe_u32 s16, s4, 0x40008
; GFX9-DL-NEXT:    s_bfe_u32 s17, s4, 0x4000c
; GFX9-DL-NEXT:    s_and_b32 s18, s4, 15
; GFX9-DL-NEXT:    s_bfe_u32 s4, s4, 0x40004
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s5
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s6, s7, s8
; GFX9-DL-NEXT:    s_bfe_u32 s9, s2, 0x40008
; GFX9-DL-NEXT:    s_bfe_u32 s10, s2, 0x4000c
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s5, s16, s17
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v3, s6, v0
; GFX9-DL-NEXT:    s_and_b32 s11, s2, 15
; GFX9-DL-NEXT:    s_bfe_u32 s2, s2, 0x40004
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s6, s9, s10
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s5
; GFX9-DL-NEXT:    s_pack_ll_b32_b16 s4, s18, s4
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v4, s6, v0
...
; GFX10-DL-NEXT:    s_bfe_u32 s8, s1, 0x4000c
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s2, s4
; GFX10-DL-NEXT:    s_bfe_u32 s2, s0, 0x40008
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v5, s5, s7
; GFX10-DL-NEXT:    s_bfe_u32 s4, s1, 0x40008
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s6, s8
; GFX10-DL-NEXT:    v_and_b32_sdwa v4, v4, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-DL-NEXT:    s_mov_b32 s5, 0xffff
; GFX10-DL-NEXT:    s_bfe_u32 s7, s1, 0x40014
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v7, s2, s4
; GFX10-DL-NEXT:    v_and_b32_sdwa v6, v6, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX10-DL-NEXT:    v_and_b32_e32 v4, s5, v4
; GFX10-DL-NEXT:    s_bfe_u32 s8, s1, 0x40010
; GFX10-DL-NEXT:    s_lshr_b32 s9, s1, 28
; GFX10-DL-NEXT:    s_lshr_b32 s0, s0, 28
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s4, s7
; GFX10-DL-NEXT:    v_or_b32_e32 v5, v4, v5
; GFX10-DL-NEXT:    s_bfe_u32 s1, s1, 0x40018
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v7, s2, s8
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v8, s0, s9
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v9, 8, v5
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v4, v2
; GFX10-DL-NEXT:    v_and_b32_sdwa v4, v6, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s6, s1
; GFX10-DL-NEXT:    v_and_b32_sdwa v3, v8, v3 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v2, v9
; GFX10-DL-NEXT:    v_or_b32_sdwa v4, v7, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:WORD_0
; GFX10-DL-NEXT:    v_or_b32_sdwa v3, v6, v3 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:WORD_0
; GFX10-DL-NEXT:    v_add_nc_u32_sdwa v2, v2, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:BYTE_2
; GFX10-DL-NEXT:    v_and_b32_e32 v4, s5, v4
; GFX10-DL-NEXT:    v_add_nc_u32_sdwa v2, v2, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_3
...
; GFX8-NEXT:    s_and_b32 s6, s3, 15
; GFX8-NEXT:    s_bfe_u32 s7, s2, 0x40004
; GFX8-NEXT:    s_bfe_u32 s9, s2, 0x40008
; GFX8-NEXT:    s_bfe_u32 s11, s2, 0x4000c
; GFX8-NEXT:    s_bfe_u32 s13, s2, 0x40010
; GFX8-NEXT:    s_bfe_u32 s15, s2, 0x40014
; GFX8-NEXT:    s_bfe_u32 s17, s2, 0x40018
; GFX8-NEXT:    s_lshr_b32 s2, s2, 28
; GFX8-NEXT:    v_mov_b32_e32 v0, s5
; GFX8-NEXT:    v_mov_b32_e32 v1, s4
; GFX8-NEXT:    v_mad_u32_u24 v0, s6, v0, v1
; GFX8-NEXT:    s_bfe_u32 s8, s3, 0x40004
; GFX8-NEXT:    s_bfe_u32 s10, s3, 0x40008
; GFX8-NEXT:    s_bfe_u32 s12, s3, 0x4000c
; GFX8-NEXT:    s_bfe_u32 s14, s3, 0x40010
; GFX8-NEXT:    s_bfe_u32 s16, s3, 0x40014
; GFX8-NEXT:    s_bfe_u32 s18, s3, 0x40018
...
; GFX8-NEXT:    v_mad_u32_u24 v0, s12, v1, v0
; GFX8-NEXT:    v_mov_b32_e32 v1, s13
; GFX8-NEXT:    v_mad_u32_u24 v0, s14, v1, v0
; GFX8-NEXT:    v_mov_b32_e32 v1, s15
; GFX8-NEXT:    v_mad_u32_u24 v0, s16, v1, v0
; GFX8-NEXT:    v_mov_b32_e32 v1, s17
; GFX8-NEXT:    v_mad_u32_u24 v2, s18, v1, v0
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    flat_store_dword v[0:1], v2
; GFX8-NEXT:    s_endpgm
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_and_b32 s5, s2, 15
; GFX9-NEXT:    s_and_b32 s6, s3, 15
; GFX9-NEXT:    s_bfe_u32 s7, s2, 0x40004
; GFX9-NEXT:    s_bfe_u32 s9, s2, 0x40008
; GFX9-NEXT:    s_bfe_u32 s11, s2, 0x4000c
; GFX9-NEXT:    s_bfe_u32 s13, s2, 0x40010
; GFX9-NEXT:    s_bfe_u32 s15, s2, 0x40014
; GFX9-NEXT:    s_bfe_u32 s17, s2, 0x40018
; GFX9-NEXT:    s_lshr_b32 s2, s2, 28
; GFX9-NEXT:    v_mov_b32_e32 v0, s5
; GFX9-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NEXT:    v_mad_u32_u24 v0, s6, v0, v1
; GFX9-NEXT:    s_bfe_u32 s8, s3, 0x40004
; GFX9-NEXT:    s_bfe_u32 s10, s3, 0x40008
; GFX9-NEXT:    s_bfe_u32 s12, s3, 0x4000c
; GFX9-NEXT:    s_bfe_u32 s14, s3, 0x40010
; GFX9-NEXT:    s_bfe_u32 s16, s3, 0x40014
; GFX9-NEXT:    s_bfe_u32 s18, s3, 0x40018
...
; GFX9-NEXT:    v_mad_u32_u24 v0, s12, v1, v0
; GFX9-NEXT:    v_mov_b32_e32 v1, s13
; GFX9-NEXT:    v_mad_u32_u24 v0, s14, v1, v0
; GFX9-NEXT:    v_mov_b32_e32 v1, s15
; GFX9-NEXT:    v_mad_u32_u24 v0, s16, v1, v0
; GFX9-NEXT:    v_mov_b32_e32 v1, s17
; GFX9-NEXT:    v_mad_u32_u24 v2, s18, v1, v0
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_dot8_u32_u4 v2, s3, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
