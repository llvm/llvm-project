...
; GFX9-DL-NEXT:    v_bfe_u32 v2, v2, 12, 4
; GFX9-DL-NEXT:    v_perm_b32 v4, v5, v4, s0
; GFX9-DL-NEXT:    v_perm_b32 v5, v7, v6, s0
; GFX9-DL-NEXT:    v_perm_b32 v6, v9, v8, s0
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v10, s0
; GFX9-DL-NEXT:    v_perm_b32 v9, v16, v15, s0
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v17, s0
; GFX9-DL-NEXT:    v_perm_b32 v2, v2, v9, s1
; GFX9-DL-NEXT:    v_perm_b32 v1, v1, v6, s1
; GFX9-DL-NEXT:    v_perm_b32 v7, v12, v11, s0
; GFX9-DL-NEXT:    v_perm_b32 v8, v14, v13, s0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v1, v2, v3
; GFX9-DL-NEXT:    v_perm_b32 v6, v8, v7, s1
; GFX9-DL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX9-DL-NEXT:    v_perm_b32 v2, v5, v4, s1
; GFX9-DL-NEXT:    v_dot4_u32_u8 v1, v2, v6, v1
; GFX9-DL-NEXT:    v_and_b32_e32 v1, 15, v1
; GFX9-DL-NEXT:    global_store_byte v0, v1, s[6:7]
; GFX9-DL-NEXT:    s_endpgm
;
...
; GFX10-DL-NEXT:    v_bfe_u32 v8, v1, 4, 4
; GFX10-DL-NEXT:    v_bfe_u32 v9, v1, 8, 4
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_and_b32_e32 v10, 15, v2
; GFX10-DL-NEXT:    v_bfe_u32 v11, v2, 4, 4
; GFX10-DL-NEXT:    v_bfe_u32 v12, v2, 8, 4
; GFX10-DL-NEXT:    v_bfe_u32 v13, v2, 12, 4
; GFX10-DL-NEXT:    v_bfe_u32 v14, v1, 12, 4
; GFX10-DL-NEXT:    v_perm_b32 v7, v8, v7, 0x5040100
; GFX10-DL-NEXT:    v_perm_b32 v8, v11, v10, 0x5040100
; GFX10-DL-NEXT:    v_bfe_u32 v4, v1, 16, 4
; GFX10-DL-NEXT:    v_perm_b32 v10, v13, v12, 0x5040100
; GFX10-DL-NEXT:    v_perm_b32 v9, v14, v9, 0x5040100
; GFX10-DL-NEXT:    v_bfe_u32 v5, v1, 20, 4
; GFX10-DL-NEXT:    v_bfe_u32 v6, v1, 24, 4
; GFX10-DL-NEXT:    v_bfe_u32 v15, v2, 16, 4
; GFX10-DL-NEXT:    v_bfe_u32 v11, v2, 20, 4
; GFX10-DL-NEXT:    v_bfe_u32 v12, v2, 24, 4
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v2, 28, v2
; GFX10-DL-NEXT:    v_perm_b32 v8, v10, v8, 0x6040200
; GFX10-DL-NEXT:    v_perm_b32 v7, v9, v7, 0x6040200
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v1, 28, v1
; GFX10-DL-NEXT:    v_perm_b32 v4, v5, v4, 0x5040100
; GFX10-DL-NEXT:    v_perm_b32 v5, v11, v15, 0x5040100
; GFX10-DL-NEXT:    v_perm_b32 v2, v2, v12, 0x5040100
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_dot4_u32_u8 v3, v7, v8, v3
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v6, 0x5040100
; GFX10-DL-NEXT:    v_perm_b32 v2, v2, v5, 0x6040200
; GFX10-DL-NEXT:    v_and_b32_e32 v3, 0xffff, v3
; GFX10-DL-NEXT:    v_perm_b32 v1, v1, v4, 0x6040200
