...
; GFX9-NEXT:    v_mad_u32_u24 v0, s0, v0, v1
...
; GFX9-NEXT:    v_mad_u32_u24 v2, s1, v1, v0
...
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s8
; GFX9-DL-NEXT:    v_dot8_u32_u4 v2, s0, v0, v1
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    s_and_b32 s1, s5, 15
...
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x4000c
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40010
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40014
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40018
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40018
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_lshr_b32 s0, s4, 28
; GFX10-DL-NEXT:    s_lshr_b32 s1, s5, 28
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
...
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    s_and_b32 s1, s5, 15
; GFX10-DL-NEXT:    s_bfe_u32 s2, s5, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s3, s5, 0x4000c
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40004
...
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s1, s3
...
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    s_and_b32 s1, s5, 15
; GFX10-DL-NEXT:    s_bfe_u32 s2, s4, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s3, s5, 0x40008
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s1, v2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x40004
...
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s1, s5, 0x4000c
; GFX10-DL-NEXT:    v_mul_u32_u24_e64 v3, s0, s1
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-NEXT:    v_mov_b32_e32 v1, s18
; GFX9-NEXT:    v_mad_u32_u24 v1, s0, v0, v1
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, s0, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, s17
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s0, v0, v1
...
; GFX9-NEXT:    v_pk_mul_lo_u16 v2, s1, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-NEXT:    v_pk_mul_lo_u16 v5, s0, v0
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v2, s1, v0
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s1
; GFX9-DL-NEXT:    v_pk_mul_lo_u16 v5, s0, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    s_bfe_u32 s3, s4, 0x40004
; GFX10-DL-NEXT:    s_and_b32 s1, s5, 15
; GFX10-DL-NEXT:    s_bfe_u32 s2, s5, 0x40004
...
; GFX10-DL-NEXT:    v_pk_mul_lo_u16 v4, s0, s2
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s2, s5, 0x40010
; GFX10-DL-NEXT:    s_bfe_u32 s3, s5, 0x40014
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s2, s2, s3
; GFX10-DL-NEXT:    s_lshr_b32 s1, s4, 28
; GFX10-DL-NEXT:    s_lshr_b32 s3, s5, 28
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v3, v2
...
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40018
; GFX10-DL-NEXT:    s_bfe_u32 s2, s5, 0x40018
; GFX10-DL-NEXT:    s_pack_ll_b32_b16 s0, s0, s1
...
; GFX10-DL-NEXT:    s_load_dword s5, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    s_bfe_u32 s1, s4, 0x40004
; GFX10-DL-NEXT:    s_bfe_u32 s3, s5, 0x40004
; GFX10-DL-NEXT:    s_and_b32 s0, s4, 15
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v3, s1, s3
; GFX10-DL-NEXT:    s_and_b32 s1, s5, 15
; GFX10-DL-NEXT:    s_bfe_u32 s6, s4, 0x4000c
; GFX10-DL-NEXT:    s_bfe_u32 s3, s5, 0x4000c
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v4, s0, s1
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v5, s6, s3
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v3, 8, v3
; GFX10-DL-NEXT:    s_bfe_u32 s2, s4, 0x40008
; GFX10-DL-NEXT:    s_bfe_u32 s0, s5, 0x40008
; GFX10-DL-NEXT:    s_mov_b32 s1, 0xffff
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s2, s0
; GFX10-DL-NEXT:    v_or_b32_e32 v3, v4, v3
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v5, 8, v5
; GFX10-DL-NEXT:    s_bfe_u32 s2, s4, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s6, s5, 0x40014
; GFX10-DL-NEXT:    s_bfe_u32 s0, s4, 0x40010
...
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v5, s2, s6
; GFX10-DL-NEXT:    s_bfe_u32 s3, s4, 0x40018
; GFX10-DL-NEXT:    s_bfe_u32 s7, s5, 0x40010
; GFX10-DL-NEXT:    s_lshr_b32 s4, s4, 28
; GFX10-DL-NEXT:    v_or_b32_e32 v4, v3, v4
; GFX10-DL-NEXT:    s_lshr_b32 s2, s5, 28
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v6, s0, s7
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v7, s4, s2
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v5, 8, v5
; GFX10-DL-NEXT:    v_lshrrev_b32_e32 v8, 8, v4
; GFX10-DL-NEXT:    s_bfe_u32 s0, s5, 0x40018
; GFX10-DL-NEXT:    v_mul_lo_u16_e64 v10, s3, s0
; GFX10-DL-NEXT:    v_or_b32_e32 v5, v6, v5
; GFX10-DL-NEXT:    v_lshlrev_b16_e64 v7, 8, v7
; GFX10-DL-NEXT:    v_and_b32_e32 v5, s1, v5
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, v3, v2
...
; GFX9-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s8
; GFX9-DL-NEXT:    v_dot8_u32_u4 v2, s1, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
