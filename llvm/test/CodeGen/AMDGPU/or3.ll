...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: or3_vgpr_a:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_or3_b32 v0, v0, s2, s3
; GFX11-NEXT:    ; return to shader part epilog
  %x = or i32 %a, %b
  %result = or i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: or3_vgpr_bc:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_or3_b32 v0, s2, v0, v1
; GFX11-NEXT:    ; return to shader part epilog
  %x = or i32 %a, %b
  %result = or i32 %x, %c
  %bc = bitcast i32 %result to float
...
; GFX10-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: or3_vgpr_const:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_or3_b32 v0, v1, v0, 64
; GFX11-NEXT:    ; return to shader part epilog
  %x = or i32 64, %b
  %result = or i32 %x, %a
  %bc = bitcast i32 %result to float
