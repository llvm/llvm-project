...
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 a[16:31], v[0:3], v[4:7], a[0:15]
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16:
; GISEL:       ; %bb.0:
...
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 a[16:31], v[0:3], v[4:7], a[0:15]
...
; GCN:       ; %bb.0:
; GCN-NEXT:    s_load_dwordx8 s[20:27], s[2:3], 0x24
...
; SDAG-LABEL: test_mfma_f32_32x32x16_bf16__flags:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; SDAG-NEXT:    v_mov_b64_e32 v[12:13], 48
...
; SDAG-NEXT:    v_mov_b64_e32 v[18:19], 0
; SDAG-NEXT:    v_mov_b32_e32 v8, s12
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 a[16:31], v[0:3], v[4:7], a[0:15] cbsz:2 abid:3 blgp:1
; SDAG-NEXT:    v_mov_b32_e32 v0, s16
; SDAG-NEXT:    v_mov_b32_e32 v1, s17
; SDAG-NEXT:    v_mov_b32_e32 v2, s18
; SDAG-NEXT:    v_mov_b32_e32 v3, s19
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16__flags:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GISEL-NEXT:    v_mov_b64_e32 v[20:21], 0
...
; GISEL-NEXT:    v_mov_b64_e32 v[10:11], s[6:7]
; GISEL-NEXT:    v_mov_b64_e32 v[14:15], s[10:11]
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 a[16:31], v[0:3], v[4:7], a[0:15] cbsz:2 abid:3 blgp:1
; GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[16:17]
; GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[18:19]
; GISEL-NEXT:    v_mov_b64_e32 v[24:25], 32
...
; SDAG-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
...
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31]
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
...
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 v[16:31], v[32:35], v[36:39], v[0:15]
...
; GCN-NEXT:    s_load_dwordx8 s[20:27], s[2:3], 0x24
; GCN-NEXT:    s_load_dwordx16 s[4:19], s[2:3], 0x64
; GCN-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0xa4
; GCN-NEXT:    v_mov_b32_e32 v12, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; GCN-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; GCN-NEXT:    v_mov_b64_e32 v[4:5], s[24:25]
; GCN-NEXT:    v_accvgpr_write_b32 a31, s19
; GCN-NEXT:    v_mov_b64_e32 v[6:7], s[26:27]
; GCN-NEXT:    v_accvgpr_write_b32 a30, s18
; GCN-NEXT:    v_accvgpr_write_b32 a29, s17
; GCN-NEXT:    v_accvgpr_write_b32 a28, s16
; GCN-NEXT:    v_accvgpr_write_b32 a27, s15
; GCN-NEXT:    v_accvgpr_write_b32 a26, s14
; GCN-NEXT:    v_accvgpr_write_b32 a25, s13
; GCN-NEXT:    v_accvgpr_write_b32 a24, s12
; GCN-NEXT:    v_accvgpr_write_b32 a23, s11
; GCN-NEXT:    v_accvgpr_write_b32 a22, s10
; GCN-NEXT:    v_accvgpr_write_b32 a21, s9
; GCN-NEXT:    v_accvgpr_write_b32 a20, s8
; GCN-NEXT:    v_accvgpr_write_b32 a19, s7
; GCN-NEXT:    v_accvgpr_write_b32 a18, s6
; GCN-NEXT:    v_accvgpr_write_b32 a17, s5
; GCN-NEXT:    v_accvgpr_write_b32 a16, s4
...
; SDAG-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd__flags:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; SDAG-NEXT:    v_mov_b32_e32 v44, 0
...
; SDAG-NEXT:    v_mov_b32_e32 v40, s16
; SDAG-NEXT:    v_mov_b32_e32 v41, s17
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31] cbsz:1 abid:2 blgp:3
; SDAG-NEXT:    v_mov_b32_e32 v42, s18
; SDAG-NEXT:    v_mov_b32_e32 v43, s19
; SDAG-NEXT:    global_store_dwordx4 v44, v[40:43], s[0:1] offset:48 sc0 sc1
; SDAG-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd__flags:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GISEL-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0xa4
...
; GISEL-NEXT:    v_mov_b64_e32 v[42:43], s[6:7]
; GISEL-NEXT:    v_mov_b64_e32 v[40:41], s[4:5]
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 v[16:31], v[32:35], v[36:39], v[0:15] cbsz:1 abid:2 blgp:3
; GISEL-NEXT:    v_mov_b64_e32 v[46:47], s[10:11]
; GISEL-NEXT:    v_mov_b64_e32 v[50:51], s[14:15]
; GISEL-NEXT:    v_mov_b64_e32 v[54:55], s[18:19]
; GISEL-NEXT:    v_mov_b64_e32 v[44:45], s[8:9]
...
; SDAG-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd_mac:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SDAG-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[16:19], v[20:23], v[0:15]
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd_mac:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[16:19], v[20:23], v[0:15]
...
; SDAG-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd_mac_flags:
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; SDAG-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; SDAG-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[16:19], v[20:23], v[0:15] cbsz:3 abid:2 blgp:1
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 0
...
; SDAG-NEXT:    s_endpgm
;
; GISEL-LABEL: test_mfma_f32_32x32x16_bf16__vgprcd_mac_flags:
; GISEL:       ; %bb.0:
; GISEL-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; GISEL-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[16:19], v[20:23], v[0:15] cbsz:3 abid:2 blgp:1
; GISEL-NEXT:    v_mov_b32_e32 v16, 0
; GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-NEXT:    s_nop 7
; GISEL-NEXT:    s_nop 0
