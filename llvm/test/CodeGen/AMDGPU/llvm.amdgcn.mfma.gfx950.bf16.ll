...
; RUN: llc -mtriple=amdgpu9.50 -amdgpu-mfma-vgpr-form=0 < %s | FileCheck -enable-var-scope --check-prefix=AGPR %s
; RUN: llc -mtriple=amdgpu9.50 < %s | FileCheck -enable-var-scope --check-prefix=VGPR %s
