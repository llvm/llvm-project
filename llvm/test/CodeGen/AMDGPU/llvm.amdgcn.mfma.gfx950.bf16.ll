...
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[2:3], s[24:25]
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[4:5], s[26:27]
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[6:7], s[28:29]
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[8:9], s[30:31]
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a31, s23
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a30, s22
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a29, s21
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a28, s20
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a27, s19
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a26, s18
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a25, s17
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a24, s16
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a23, s15
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a22, s14
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a21, s13
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a20, s12
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a19, s11
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a18, s10
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a17, s9
; SDAG-AGPR-NEXT:    v_accvgpr_write_b32 a16, s8
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v10, s18
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v11, s19
; SDAG-AGPR-NEXT:    v_mfma_f32_32x32x16_bf16 a[0:15], v[2:5], v[6:9], a[16:31]
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v8, s16
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v9, s17
...
; SDAG-AGPR-NEXT:    global_store_dwordx4 v[0:1], a[12:15], off sc0 sc1
; SDAG-AGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-AGPR-NEXT:    global_store_dwordx4 v[2:3], a[8:11], off sc0 sc1
; SDAG-AGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-AGPR-NEXT:    global_store_dwordx4 v[4:5], a[4:7], off sc0 sc1
; SDAG-AGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-AGPR-NEXT:    global_store_dwordx4 v[6:7], a[0:3], off sc0 sc1
; SDAG-AGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-AGPR-NEXT:    global_store_dwordx4 v[2:3], v[8:11], off sc0 sc1
; SDAG-AGPR-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-VGPR-NEXT:    s_nop 6
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[16:17], 32
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[18:19], 16
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[20:21], 0
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v22, s16
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v23, s17
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v24, s18
; SDAG-VGPR-NEXT:    v_mov_b32_e32 v25, s19
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[32:33], v[12:15], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[16:17], v[8:11], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[18:19], v[4:7], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[20:21], v[0:3], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[16:17], v[22:25], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-VGPR-NEXT:    global_store_dwordx4 v[18:19], v[0:3], off sc0 sc1
; SDAG-VGPR-NEXT:    s_waitcnt vmcnt(0)
...
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[40:41], 0
...
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[30:31], s[22:23]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[28:29], s[20:21]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[26:27], s[18:19]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[24:25], s[16:17]
...
; GISEL-VGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31]
; GISEL-VGPR-NEXT:    s_nop 6
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[20:21], 16
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[22:23], 32
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[24:25], 48
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[18:19], s[10:11]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[40:41], v[0:3], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[20:21], v[4:7], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[22:23], v[8:11], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[24:25], v[12:15], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[40:41], v[16:19], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[0:1], s[12:13]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[14:15]
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[20:21], v[0:3], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    s_nop 0
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[0:1], s[16:17]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[18:19]
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[22:23], v[0:3], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    s_nop 0
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; GISEL-VGPR-NEXT:    global_store_dwordx4 v[24:25], v[0:3], off sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
...
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v10, s18
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v11, s19
; SDAG-AGPR-NEXT:    v_mfma_f32_32x32x16_bf16 a[0:15], v[2:5], v[6:9], a[16:31] cbsz:2 abid:3 blgp:1
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v8, s16
; SDAG-AGPR-NEXT:    v_mov_b32_e32 v9, s17
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[2:3], 32
; SDAG-AGPR-NEXT:    v_mov_b64_e32 v[4:5], 16
...
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; SDAG-VGPR-NEXT:    s_nop 1
; SDAG-VGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[34:37], v[38:41], v[16:31] cbsz:2 abid:3 blgp:1
; SDAG-VGPR-NEXT:    s_nop 6
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[16:17], 32
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[18:19], 16
; SDAG-VGPR-NEXT:    v_mov_b64_e32 v[20:21], 0
...
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[8:9]
; GISEL-VGPR-NEXT:    s_nop 1
; GISEL-VGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31] cbsz:2 abid:3 blgp:1
; GISEL-VGPR-NEXT:    s_nop 6
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[20:21], 16
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[22:23], 32
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[24:25], 48
...
; GISEL-AGPR-NEXT:    v_mov_b32_e32 v44, 0
; GISEL-AGPR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-AGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31]
; GISEL-AGPR-NEXT:    s_nop 6
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[22:23], s[18:19]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[20:21], s[16:17]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[26:27], s[22:23]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[24:25], s[20:21]
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[40:43], s[0:1] sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[16:19], s[0:1] offset:16 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[20:23], s[0:1] offset:32 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[24:27], s[0:1] offset:48 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[0:3], s[0:1] sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[4:7], s[0:1] offset:16 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[8:11], s[0:1] offset:32 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    global_store_dwordx4 v44, v[12:15], s[0:1] offset:48 sc0 sc1
; GISEL-AGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-AGPR-NEXT:    s_endpgm
;
...
; GISEL-VGPR-NEXT:    v_mov_b32_e32 v44, 0
; GISEL-VGPR-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[34:35], s[26:27]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[32:33], s[24:25]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[38:39], s[30:31]
...
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[26:27], s[22:23]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[24:25], s[20:21]
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[40:43], s[0:1] sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[16:19], s[0:1] offset:16 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[20:23], s[0:1] offset:32 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[24:27], s[0:1] offset:48 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[0:3], s[0:1] sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[4:7], s[0:1] offset:16 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[8:11], s[0:1] offset:32 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    global_store_dwordx4 v44, v[12:15], s[0:1] offset:48 sc0 sc1
; GISEL-VGPR-NEXT:    s_waitcnt vmcnt(0)
; GISEL-VGPR-NEXT:    s_endpgm
  %result = call <16 x float> @llvm.amdgcn.mfma.f32.32x32x16.bf16(<8 x bfloat> %arg0, <8 x bfloat> %arg1, <16 x float> %arg2, i32 0, i32 0, i32 0)
...
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[42:43], s[10:11]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[40:41], s[8:9]
; GISEL-AGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31] cbsz:1 abid:2 blgp:3
; GISEL-AGPR-NEXT:    s_nop 6
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-AGPR-NEXT:    v_mov_b64_e32 v[22:23], s[18:19]
...
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[42:43], s[10:11]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[40:41], s[8:9]
; GISEL-VGPR-NEXT:    v_mfma_f32_32x32x16_bf16 v[0:15], v[32:35], v[36:39], v[16:31] cbsz:1 abid:2 blgp:3
; GISEL-VGPR-NEXT:    s_nop 6
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[18:19], s[14:15]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[16:17], s[12:13]
; GISEL-VGPR-NEXT:    v_mov_b64_e32 v[22:23], s[18:19]
