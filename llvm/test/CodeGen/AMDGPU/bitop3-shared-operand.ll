...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.50-- < %s | FileCheck -check-prefixes=GCN,SDAG %s
; RUN: llc -global-isel -mtriple=amdgpu9.50-- < %s | FileCheck -check-prefixes=GCN,GISEL %s
; RUN: llc -O0 -mtriple=amdgpu9.50-- < %s | FileCheck -check-prefix=O0 %s
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_xnor_b32_e32 v0, v1, v0
; GCN-NEXT:    ; return to shader part epilog
;
