...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1210 -amdgpu-atomic-optimizer-strategy=None | FileCheck %s -check-prefix=GFX1210
...
; GFX1210-NEXT:    global_wb scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f64 v[0:1], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_inv scope:SCOPE_SYS
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
main_body:
...
; GFX1210-NEXT:    global_wb scope:SCOPE_DEV
; GFX1210-NEXT:    s_wait_storecnt 0x0
; GFX1210-NEXT:    flat_atomic_add_f64 v[0:1], v[0:1], v[2:3] th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    global_inv scope:SCOPE_DEV
; GFX1210-NEXT:    s_set_pc_i64 s[30:31]
main_body:
...
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b32 s4, s[2:3], 0x24
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x2c
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: local_atomic_fadd_f64_rtn:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
; GFX1210-NEXT:    s_wait_storecnt 0x0
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: local_atomic_fadd_f64_rtn_ieee_unsafe:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
...
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: local_atomic_fadd_f64_rtn_ieee_safe:
; GFX1210:       ; %bb.0: ; %main_body
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
