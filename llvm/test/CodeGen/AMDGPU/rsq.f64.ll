...
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v6, 0, v16, vcc
...
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], -v[8:9], v[6:7], 1.0
; SI-SDAG-NEXT:    v_div_scale_f64 v[14:15], s[4:5], 1.0, v[0:1], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[6:7], v[4:5], v[6:7]
; SI-SDAG-NEXT:    v_rcp_f64_e32 v[12:13], v[10:11]
; SI-SDAG-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[4:5], 1.0
; SI-SDAG-NEXT:    v_div_scale_f64 v[20:21], s[4:5], 1.0, v[2:3], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[6:7], -v[10:11], v[12:13], 1.0
; SI-SDAG-NEXT:    v_mul_f64 v[16:17], v[14:15], v[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[6:7], v[12:13], v[6:7], v[12:13]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[16:17], v[14:15]
; SI-SDAG-NEXT:    v_fma_f64 v[18:19], -v[10:11], v[6:7], 1.0
...
; SI-SDAG-NEXT:    v_mul_f64 v[8:9], v[20:21], v[6:7]
; SI-SDAG-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; SI-SDAG-NEXT:    v_div_fmas_f64 v[4:5], v[12:13], v[4:5], v[16:17]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], -v[10:11], v[8:9], v[20:21]
; SI-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v11
; SI-SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], s6, v21
; SI-SDAG-NEXT:    s_xor_b64 vcc, s[4:5], vcc
...
; SI-GISEL-NEXT:    v_mov_b32_e32 v22, 0x3ff00000
...
; SI-GISEL-NEXT:    v_div_scale_f64 v[6:7], s[4:5], v[0:1], v[0:1], 1.0
; SI-GISEL-NEXT:    v_ldexp_f64 v[4:5], v[4:5], v8
; SI-GISEL-NEXT:    v_div_scale_f64 v[14:15], s[4:5], 1.0, v[0:1], 1.0
; SI-GISEL-NEXT:    v_rcp_f64_e32 v[8:9], v[6:7]
...
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 1.0
; SI-GISEL-NEXT:    v_div_scale_f64 v[18:19], s[4:5], 1.0, v[2:3], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; SI-GISEL-NEXT:    v_rcp_f64_e32 v[10:11], v[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], -v[6:7], v[8:9], 1.0
; SI-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v15, v22
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], v[8:9], v[12:13], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], -v[4:5], v[10:11], 1.0
; SI-GISEL-NEXT:    v_mul_f64 v[12:13], v[14:15], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[10:11], v[16:17], v[10:11]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], -v[6:7], v[12:13], v[14:15]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], -v[4:5], v[10:11], 1.0
; SI-GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, v7
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[10:11], v[16:17], v[10:11]
; SI-GISEL-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; SI-GISEL-NEXT:    v_mul_f64 v[16:17], v[18:19], v[10:11]
; SI-GISEL-NEXT:    v_div_fmas_f64 v[6:7], v[14:15], v[8:9], v[12:13]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], -v[4:5], v[16:17], v[18:19]
; SI-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v19, v22
; SI-GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v3, v5
; SI-GISEL-NEXT:    s_xor_b64 vcc, vcc, s[4:5]
; SI-GISEL-NEXT:    v_div_fixup_f64 v[0:1], v[6:7], v[0:1], 1.0
; SI-GISEL-NEXT:    s_nop 0
; SI-GISEL-NEXT:    v_div_fmas_f64 v[4:5], v[20:21], v[10:11], v[16:17]
...
; SI-GISEL-NEXT:    v_mul_f64 v[6:7], v[4:5], 0.5
; SI-GISEL-NEXT:    v_mul_f64 v[4:5], v[0:1], v[4:5]
; SI-GISEL-NEXT:    v_mov_b32_e32 v22, 0xbff00000
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], -v[6:7], v[4:5], 0.5
; SI-GISEL-NEXT:    v_fma_f64 v[4:5], v[4:5], v[8:9], v[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[6:7], v[6:7], v[8:9], v[6:7]
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], -v[4:5], v[4:5], v[0:1]
...
; SI-GISEL-NEXT:    v_rcp_f64_e32 v[12:13], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[6:7], -v[10:11], v[4:5], 1.0
; SI-GISEL-NEXT:    v_div_scale_f64 v[18:19], s[4:5], s[4:5], v[2:3], s[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[4:5], v[4:5], v[6:7], v[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[12:13], 1.0
; SI-GISEL-NEXT:    v_mul_f64 v[16:17], v[14:15], v[4:5]
...
; SI-GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v15, v20
; SI-GISEL-NEXT:    v_mul_f64 v[12:13], v[18:19], v[6:7]
; SI-GISEL-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; SI-GISEL-NEXT:    v_div_fmas_f64 v[4:5], v[10:11], v[4:5], v[16:17]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], -v[8:9], v[12:13], v[18:19]
...
; SI-GISEL-NEXT:    s_nop 0
; SI-GISEL-NEXT:    v_div_fmas_f64 v[6:7], v[10:11], v[6:7], v[12:13]
...
; SI-SDAG-NEXT:    v_fma_f64 v[6:7], v[6:7], v[18:19], v[6:7]
; SI-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v9
; SI-SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], s4, v15
; SI-SDAG-NEXT:    v_mul_f64 v[8:9], v[20:21], v[6:7]
; SI-SDAG-NEXT:    s_xor_b64 vcc, s[4:5], vcc
...
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], -v[10:11], v[8:9], v[20:21]
; SI-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v11
; SI-SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], s4, v21
; SI-SDAG-NEXT:    s_xor_b64 vcc, s[4:5], vcc
; SI-SDAG-NEXT:    v_div_fixup_f64 v[0:1], v[4:5], v[0:1], -1.0
; SI-SDAG-NEXT:    s_nop 0
; SI-SDAG-NEXT:    v_div_fmas_f64 v[6:7], v[12:13], v[6:7], v[8:9]
...
; SI-GISEL-NEXT:    v_rcp_f64_e32 v[10:11], v[4:5]
; SI-GISEL-NEXT:    v_fma_f64 v[12:13], -v[6:7], v[8:9], 1.0
; SI-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, v15, v20
; SI-GISEL-NEXT:    v_fma_f64 v[8:9], v[8:9], v[12:13], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], -v[4:5], v[10:11], 1.0
; SI-GISEL-NEXT:    v_mul_f64 v[12:13], v[14:15], v[8:9]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[10:11], v[16:17], v[10:11]
