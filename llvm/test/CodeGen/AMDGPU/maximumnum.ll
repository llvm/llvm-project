...
; GFX1170-TRUE16:       ; %bb.0:
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-TRUE16-NEXT:    s_max_f16 s0, s0, s1
...
; GFX1170-FAKE16:       ; %bb.0:
; GFX1170-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-FAKE16-NEXT:    s_max_f16 s0, s0, s1
...
; GFX12-TRUE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    s_max_num_f16 s0, s0, s1
...
; GFX12-FAKE16-NEXT:    s_wait_bvhcnt 0x0
; GFX12-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-FAKE16-NEXT:    s_max_num_f16 s0, s0, s1
...
; GFX1251-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-TRUE16-NEXT:    s_max_num_f16 s0, s0, s1
...
; GFX1251-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1251-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1251-FAKE16-NEXT:    s_max_num_f16 s0, s0, s1
