...
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v0
...
; R600-NEXT:    TEX 1 @6
; R600-NEXT:    ALU 7, @14, KC0[CB0:0-32], KC1[]
...
; R600-NEXT:     SETE_INT * T1.X, T2.Z, T1.Z,
...
; GCN-NEXT:    v_lshlrev_b32_e32 v10, 2, v0
; GCN-NEXT:    v_mov_b32_e32 v11, 0
; GCN-NEXT:    s_mov_b64 s[2:3], s[10:11]
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b64 s[8:9], s[6:7]
; GCN-NEXT:    buffer_load_dword v2, v[10:11], s[0:3], 0 addr64
; GCN-NEXT:    buffer_load_dword v3, v[10:11], s[8:11], 0 addr64
; GCN-NEXT:    v_mov_b32_e32 v4, 0xff
; GCN-NEXT:    s_mov_b64 s[6:7], s[10:11]
; GCN-NEXT:    s_waitcnt vmcnt(1)
; GCN-NEXT:    v_and_b32_e32 v5, 0xff, v2
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v3
; GCN-NEXT:    v_bfe_u32 v6, v2, 8, 8
; GCN-NEXT:    v_bfe_u32 v8, v3, 8, 8
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v7, v5
; GCN-NEXT:    v_bfe_u32 v2, v2, 16, 8
; GCN-NEXT:    v_bfe_u32 v3, v3, 16, 8
; GCN-NEXT:    v_cndmask_b32_e32 v5, 0, v4, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v8, v6
; GCN-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v3, v2
; GCN-NEXT:    v_cndmask_b32_e32 v2, 0, v4, vcc
; GCN-NEXT:    v_lshlrev_b32_e32 v3, 8, v6
; GCN-NEXT:    v_or_b32_e32 v3, v5, v3
; GCN-NEXT:    buffer_store_byte v2, v[10:11], s[4:7], 0 addr64 offset:2
; GCN-NEXT:    buffer_store_short v3, v[10:11], s[4:7], 0 addr64
; GCN-NEXT:    s_endpgm
;
; R600-LABEL: v3i8_eq:
; R600:       ; %bb.0:
...
; GCN-NEXT:    s_lshl_b32 s15, s15, 31
; GCN-NEXT:    s_lshl_b32 s14, s14, 31
; GCN-NEXT:    s_lshl_b32 s13, s13, 31
; GCN-NEXT:    s_lshl_b32 s12, s12, 31
; GCN-NEXT:    s_xor_b32 s4, s12, s4
; GCN-NEXT:    s_xor_b32 s5, s13, s5
; GCN-NEXT:    s_xor_b32 s6, s14, s6
; GCN-NEXT:    s_xor_b32 s7, s15, s7
