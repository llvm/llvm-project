...
; GFX11-SDAG-TRUE16-NEXT:    v_trunc_f16_e32 v0.l, v1.l
; GFX11-SDAG-TRUE16-NEXT:    v_sub_f16_e32 v0.h, v1.l, v0.l
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_cmp_ge_f16_e64 s0, |v0.h|, 0.5
; GFX11-SDAG-TRUE16-NEXT:    v_cndmask_b16 v2.l, 0, 0x3c00, s0
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
