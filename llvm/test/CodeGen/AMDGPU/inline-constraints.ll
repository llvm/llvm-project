; RUN: not llc < %s -mtriple=amdgpu7.04 | FileCheck --check-prefix=GCN %s
; RUN: not llc < %s -mtriple=amdgpu8.02 | FileCheck --check-prefix=GCN --check-prefix=VI %s

; RUN: not llc < %s -mtriple=amdgpu7.04 2>&1 | FileCheck --check-prefix=NOGCN --check-prefix=NOSI %s
; RUN: not llc < %s -mtriple=amdgpu8.02 2>&1 | FileCheck --check-prefix=NOGCN %s
