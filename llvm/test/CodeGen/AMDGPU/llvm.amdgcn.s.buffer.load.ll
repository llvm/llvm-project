...
; GFX12-NEXT:    buffer_load_b32 v1, v0, s[0:3], null offen offset:8
; GFX12-NEXT:    buffer_load_b32 v0, v0, s[0:3], null offen offset:12
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    export mrt0 v1, v0, v0, v0 done
; GFX12-NEXT:    s_endpgm
main_body:
  %tmp = shl i32 %index, 4
  br label %bb1
