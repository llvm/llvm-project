...
; SI-NEXT:    v_mul_f64 v[0:1], v[0:1], v[2:3]
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_add_f64 v[0:1], v[0:1], v[4:5]
; SI-NEXT:    buffer_store_dwordx2 v[0:1], off, s[8:11], 0
; SI-NEXT:    s_endpgm
;
; VI-LABEL: fmul_fadd_f64:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x24
; VI-NEXT:    s_mov_b32 s11, 0xf000
; VI-NEXT:    s_mov_b32 s10, -1
...
; VI-NEXT:    v_mul_f64 v[0:1], v[0:1], v[2:3]
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; VI-NEXT:    flat_load_dwordx2 v[0:1], v[10:11] glc
; VI-NEXT:    s_waitcnt vmcnt(0)
...
;
;
; SI-LABEL: fadd_a_a_b_f64_fast_add0:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, 0
...
; SI-NEXT:    s_endpgm
;
; VI-LABEL: fadd_a_a_b_f64_fast_add0:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
...
;
;
; SI-LABEL: fadd_a_a_b_f64_fast_add1:
; SI:       ; %bb.0:
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, 0
...
; SI-NEXT:    s_endpgm
;
; VI-LABEL: fadd_a_a_b_f64_fast_add1:
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
