...
; GCN-NEXT:    v_mul_f32_e64 v10, 1.0, s29
; GCN-NEXT:    v_mul_f32_e64 v11, 1.0, s28
; GCN-NEXT:    v_mul_f32_e32 v8, 1.0, v1
; GCN-NEXT:    v_mul_f32_e32 v9, 1.0, v0
...
; GCN-NEXT:    v_and_b32_e32 v3, 0xffff0000, v18
...
; GCN-NEXT:    v_and_b32_e32 v4, 0xffff0000, v16
...
; GCN-NEXT:    v_and_b32_e32 v4, 0xffff0000, v15
; GCN-NEXT:    v_add_f32_e32 v5, 0x40c00000, v5
; GCN-NEXT:    v_add_f32_e32 v4, 0x40c00000, v4
; GCN-NEXT:    v_lshrrev_b32_e32 v5, 16, v5
; GCN-NEXT:    v_and_b32_e32 v6, 0xffff0000, v12
...
; GCN-NEXT:    s_and_b64 s[4:5], vcc, exec
; GCN-NEXT:    v_lshlrev_b32_e32 v27, 24, v1
; GCN-NEXT:    v_lshlrev_b32_e32 v26, 8, v3
; GCN-NEXT:    v_lshlrev_b32_e32 v25, 24, v5
; GCN-NEXT:    v_lshlrev_b32_e32 v24, 8, v7
; GCN-NEXT:    v_lshlrev_b32_e32 v23, 24, v9
; GCN-NEXT:    v_lshlrev_b32_e32 v18, 8, v11
; GCN-NEXT:    v_lshlrev_b32_e32 v13, 24, v13
; GCN-NEXT:    v_lshlrev_b32_e32 v11, 8, v15
; GCN-NEXT:    v_lshlrev_b32_e32 v9, 24, v17
...
; GCN-NEXT:    s_add_u32 s4, s16, 3
; GCN-NEXT:    s_addc_u32 s5, s17, 0
; GCN-NEXT:    s_add_u32 s16, s18, 3
; GCN-NEXT:    s_addc_u32 s15, s19, 0
; GCN-NEXT:    s_add_u32 s13, s20, 3
; GCN-NEXT:    s_addc_u32 s11, s21, 0
; GCN-NEXT:    s_add_u32 s9, s22, 3
; GCN-NEXT:    s_addc_u32 s7, s23, 0
...
; GCN-NEXT:    s_and_b32 s12, s13, 0xffff0000
; GCN-NEXT:    s_lshl_b32 s13, s13, 16
; GCN-NEXT:    s_and_b32 s14, s15, 0xffff0000
; GCN-NEXT:    s_lshl_b32 s15, s15, 16
; GCN-NEXT:    s_and_b32 s24, s16, 0xffff0000
; GCN-NEXT:    s_lshl_b32 s25, s16, 16
...
; GCN-NEXT:    v_add_f64 v[0:1], s[16:17], 1.0
; GCN-NEXT:    v_add_f64 v[2:3], s[18:19], 1.0
; GCN-NEXT:    v_add_f64 v[4:5], s[22:23], 1.0
; GCN-NEXT:    v_add_f64 v[6:7], s[20:21], 1.0
...
; GCN-NEXT:    v_and_b32_e32 v9, 0xffff0000, v6
...
; GCN-NEXT:    s_add_i32 s26, s26, 3
; GCN-NEXT:    s_or_b32 s4, s5, s4
; GCN-NEXT:    s_and_b32 s5, s26, 0xffff
; GCN-NEXT:    s_lshl_b32 s6, s27, 16
; GCN-NEXT:    s_add_i32 s24, s24, 3
; GCN-NEXT:    s_or_b32 s5, s6, s5
; GCN-NEXT:    s_and_b32 s6, s24, 0xffff
; GCN-NEXT:    s_lshl_b32 s7, s25, 16
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    s_add_i32 s22, s22, 3
; GCN-NEXT:    s_add_i32 s14, s6, 0x30000
; GCN-NEXT:    s_and_b32 s6, s22, 0xffff
; GCN-NEXT:    s_lshl_b32 s7, s23, 16
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    s_add_i32 s20, s20, 3
; GCN-NEXT:    s_add_i32 s12, s6, 0x30000
; GCN-NEXT:    s_and_b32 s6, s20, 0xffff
; GCN-NEXT:    s_lshl_b32 s7, s21, 16
; GCN-NEXT:    s_or_b32 s6, s7, s6
; GCN-NEXT:    s_add_i32 s18, s18, 3
...
; GCN-NEXT:    s_lshl_b32 s8, s8, 16
; GCN-NEXT:    s_and_b32 s11, s10, 0xffff0000
...
; GCN-NEXT:    v_alignbit_b32 v11, s9, v6, 24
; GCN-NEXT:    v_alignbit_b32 v10, s9, v6, 16
; GCN-NEXT:    v_alignbit_b32 v9, s9, v6, 8
; GCN-NEXT:    s_or_b32 s10, s4, s5
; GCN-NEXT:    v_mov_b32_e32 v6, s7
; GCN-NEXT:    v_alignbit_b32 v19, s10, v6, 24
; GCN-NEXT:    v_alignbit_b32 v18, s10, v6, 16
; GCN-NEXT:    v_alignbit_b32 v17, s10, v6, 8
; GCN-NEXT:    s_and_b32 s4, s28, 0xffff
; GCN-NEXT:    s_lshl_b32 s5, s29, 16
; GCN-NEXT:    v_and_b32_e32 v6, 0xffff, v0
; GCN-NEXT:    v_mov_b32_e32 v1, s11
; GCN-NEXT:    s_or_b32 s8, s4, s5
; GCN-NEXT:    v_or_b32_e32 v28, v6, v5
; GCN-NEXT:    v_alignbit_b32 v3, s12, v1, 24
; GCN-NEXT:    v_alignbit_b32 v2, s12, v1, 16
; GCN-NEXT:    v_alignbit_b32 v1, s12, v1, 8
; GCN-NEXT:    v_alignbit_b32 v27, v28, s8, 24
; GCN-NEXT:    v_alignbit_b32 v26, v28, s8, 16
; GCN-NEXT:    v_alignbit_b32 v25, v28, s8, 8
; GCN-NEXT:    s_lshr_b32 s44, s12, 8
; GCN-NEXT:    s_lshr_b32 s14, s9, 8
; GCN-NEXT:    s_lshr_b32 s41, s10, 8
; GCN-NEXT:    v_lshrrev_b32_e32 v29, 8, v28
; GCN-NEXT:    s_and_b32 s45, s19, 0xffff
; GCN-NEXT:    s_and_b32 s15, s23, 0xffff
; GCN-NEXT:    s_and_b32 s42, s27, 0xffff
; GCN-NEXT:    v_and_b32_e32 v30, 0xffff, v4
; GCN-NEXT:    s_bfe_u32 s13, s19, 0x80008
; GCN-NEXT:    s_bfe_u32 s40, s23, 0x80008
; GCN-NEXT:    s_bfe_u32 s43, s27, 0x80008
; GCN-NEXT:    v_bfe_u32 v31, v4, 8, 8
...
; GCN-NEXT:    v_alignbit_b32 v3, s12, v0, 24
; GCN-NEXT:    v_alignbit_b32 v2, s12, v0, 16
; GCN-NEXT:    v_alignbit_b32 v1, s12, v0, 8
; GCN-NEXT:    v_mov_b32_e32 v0, s6
...
; GCN-NEXT:    v_alignbit_b32 v26, v28, s8, 16
; GCN-NEXT:    v_alignbit_b32 v25, v28, s8, 8
; GCN-NEXT:    s_lshr_b32 s13, s12, 24
; GCN-NEXT:    s_lshr_b32 s45, s12, 16
; GCN-NEXT:    s_lshr_b32 s44, s12, 8
; GCN-NEXT:    s_lshr_b32 s40, s9, 24
; GCN-NEXT:    s_lshr_b32 s15, s9, 16
; GCN-NEXT:    s_lshr_b32 s14, s9, 8
; GCN-NEXT:    s_lshr_b32 s43, s10, 24
; GCN-NEXT:    s_lshr_b32 s42, s10, 16
; GCN-NEXT:    s_lshr_b32 s41, s10, 8
; GCN-NEXT:    v_lshrrev_b32_e32 v31, 24, v28
; GCN-NEXT:    v_lshrrev_b32_e32 v30, 16, v28
; GCN-NEXT:    v_lshrrev_b32_e32 v29, 8, v28
...
; GCN-NEXT:    v_mov_b32_e32 v5, s44
; GCN-NEXT:    v_mov_b32_e32 v6, s45
; GCN-NEXT:    v_mov_b32_e32 v7, s13
; GCN-NEXT:    v_mov_b32_e32 v8, s6
; GCN-NEXT:    v_mov_b32_e32 v12, s9
; GCN-NEXT:    v_mov_b32_e32 v13, s14
; GCN-NEXT:    v_mov_b32_e32 v14, s15
; GCN-NEXT:    v_mov_b32_e32 v15, s40
...
; GCN-NEXT:    v_mov_b32_e32 v20, v12
; GCN-NEXT:    v_readfirstlane_b32 s13, v11
; GCN-NEXT:    v_readfirstlane_b32 s14, v10
...
; GCN-NEXT:    v_lshlrev_b32_e32 v17, 24, v13
...
; GCN-NEXT:    v_add_i32_e32 v12, vcc, 0x3000000, v1
...
; GCN-NEXT:    v_add_i32_e32 v14, vcc, 0x3000000, v1
; GCN-NEXT:    s_and_b32 s4, s10, 0xff
...
; GCN-NEXT:    s_or_b32 s4, s5, s4
; GCN-NEXT:    s_add_i32 s28, s28, 3
; GCN-NEXT:    s_add_i32 s12, s4, 0x3000000
; GCN-NEXT:    s_and_b32 s4, s28, 0xff
; GCN-NEXT:    s_lshl_b32 s5, s29, 8
...
; GCN-NEXT:    v_alignbit_b32 v5, s8, v0, 16
; GCN-NEXT:    v_alignbit_b32 v9, v10, v18, 16
; GCN-NEXT:    v_alignbit_b32 v13, v14, v12, 16
; GCN-NEXT:    s_lshr_b32 s40, s11, 16
; GCN-NEXT:    s_lshr_b32 s41, s8, 16
; GCN-NEXT:    v_lshrrev_b32_e32 v11, 16, v10
; GCN-NEXT:    v_lshrrev_b32_e32 v15, 16, v14
...
; GCN-NEXT:    s_lshl_b32 s15, s23, 8
; GCN-NEXT:    s_add_i32 s20, s20, 3
; GCN-NEXT:    s_add_i32 s18, s18, 3
; GCN-NEXT:    s_add_i32 s16, s16, 3
; GCN-NEXT:    s_or_b32 s4, s5, s4
; GCN-NEXT:    s_and_b32 s5, s45, 0xff
...
; GCN-NEXT:    v_mul_f32_e64 v54, 1.0, s29
...
; GCN-NEXT:  ; %bb.1: ; %cmp.false
; GCN-NEXT:    v_lshrrev_b32_e32 v5, 16, v38
; GCN-NEXT:    v_alignbit_b32 v8, v5, v39, 16
; GCN-NEXT:    v_lshrrev_b32_e32 v5, 16, v50
; GCN-NEXT:    v_lshrrev_b32_e32 v0, 16, v34
; GCN-NEXT:    v_lshrrev_b32_e32 v6, 16, v32
; GCN-NEXT:    v_lshrrev_b32_e32 v14, 16, v36
; GCN-NEXT:    v_alignbit_b32 v16, v5, v51, 16
...
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v52
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v53
; GCN-NEXT:    v_add_f32_e32 v31, 0x40c00000, v1
; GCN-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v30, 16, v31
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v50
; GCN-NEXT:    v_alignbit_b32 v28, v30, v0, 16
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v51
; GCN-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GCN-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GCN-NEXT:    v_alignbit_b32 v16, v1, v0, 16
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v48
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v49
; GCN-NEXT:    v_add_f32_e32 v23, 0x40c00000, v1
; GCN-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v22, 16, v23
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v38
; GCN-NEXT:    v_alignbit_b32 v20, v22, v0, 16
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v39
; GCN-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GCN-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GCN-NEXT:    v_alignbit_b32 v8, v1, v0, 16
; GCN-NEXT:    v_and_b32_e32 v1, 0xffff0000, v36
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v37
...
; GCN-NEXT:    v_and_b32_e32 v0, 0xffff0000, v35
; GCN-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; GCN-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
; GCN-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
...
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; GCN-NEXT:    v_readfirstlane_b32 s42, v15
; GCN-NEXT:    v_readfirstlane_b32 s43, v14
; GCN-NEXT:    v_readfirstlane_b32 s40, v7
; GCN-NEXT:    v_readfirstlane_b32 s41, v6
...
; GCN-NEXT:    s_and_b32 s4, s28, 0xff
; GCN-NEXT:    s_lshl_b32 s5, s29, 8
; GCN-NEXT:    v_or_b32_e32 v9, v0, v7
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v8
; GCN-NEXT:    s_or_b32 s4, s4, s5
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 16, v7
; GCN-NEXT:    s_lshl_b32 s14, s4, 16
; GCN-NEXT:    s_and_b32 s4, s9, 0xff
; GCN-NEXT:    v_or_b32_e32 v19, v1, v7
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v10
; GCN-NEXT:    s_lshl_b32 s4, s4, 16
; GCN-NEXT:    s_lshl_b32 s5, s10, 24
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 16, v7
; GCN-NEXT:    v_lshlrev_b32_e32 v13, 24, v11
; GCN-NEXT:    s_or_b32 s15, s5, s4
; GCN-NEXT:    s_and_b32 s4, s41, 0xff
; GCN-NEXT:    s_lshl_b32 s5, s40, 8
; GCN-NEXT:    v_or_b32_e32 v18, v13, v7
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v12
; GCN-NEXT:    s_or_b32 s4, s4, s5
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 16, v7
; GCN-NEXT:    s_lshl_b32 s44, s4, 16
; GCN-NEXT:    v_or_b32_e32 v13, v5, v7
; GCN-NEXT:    s_and_b32 s4, s43, 0xff
; GCN-NEXT:    s_lshl_b32 s5, s42, 8
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v16
; GCN-NEXT:    s_or_b32 s4, s4, s5
; GCN-NEXT:    v_lshlrev_b32_e32 v7, 16, v7
; GCN-NEXT:    s_lshl_b32 s45, s4, 16
; GCN-NEXT:    v_or_b32_e32 v15, v6, v7
...
; GCN-NEXT:    s_add_i32 s43, s43, 3
; GCN-NEXT:    v_and_b32_e32 v7, 0xff, v7
; GCN-NEXT:    v_lshlrev_b32_e32 v9, 8, v11
; GCN-NEXT:    s_and_b32 s4, s43, 0xff
; GCN-NEXT:    s_lshl_b32 s5, s42, 8
...
; GCN-NEXT:    v_add_i32_e32 v5, vcc, 0x3000000, v5
...
; GCN-NEXT:    s_and_b32 s7, s6, 0xffff0000
; GCN-NEXT:    s_lshl_b32 s6, s6, 16
; GCN-NEXT:    s_and_b32 s11, s8, 0xffff0000
; GCN-NEXT:    s_lshl_b32 s8, s8, 16
...
; GCN-NEXT:    v_and_b32_e32 v13, 0xffff0000, v5
; GCN-NEXT:    v_lshlrev_b32_e32 v18, 16, v5
; GCN-NEXT:    v_and_b32_e32 v15, 0xffff0000, v6
