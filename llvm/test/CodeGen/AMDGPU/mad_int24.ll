...
; RUN: llc < %s -mtriple=amdgpu6.00 | FileCheck %s --check-prefixes=GCN
; RUN: llc < %s -mtriple=amdgpu8.02 -mattr=-flat-for-global | FileCheck %s --check-prefixes=VI
...
; GCN-NEXT:    s_bfe_i32 s0, s2, 0x180000
; GCN-NEXT:    s_bfe_i32 s1, s3, 0x180000
