...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1210 < %s | FileCheck --check-prefix=GCN %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1210 < %s | FileCheck --check-prefix=GCN %s
