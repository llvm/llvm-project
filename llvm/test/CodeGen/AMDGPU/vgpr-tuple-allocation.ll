...
; GFX11: image_gather4_c_b_cl v[41:44], v[32:36], s[0:7], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D
...
; GFX11: scratch_load_b32 v40, off, s32 offset:16 ; 4-byte Folded Reload
...
; GFX11: scratch_load_b32 v45, off, s33
...
; GFX11: scratch_load_b32 v40, off, s32 offset:20
; GFX11: s_setpc_b64 s[0:1]
main_body:
  %v = call <4 x float> @llvm.amdgcn.image.gather4.c.b.cl.2d.v4f32.f32.f32(i32 1, float %bias, float %zcompare, float %s, float %t, float %clamp, <8 x i32> undef, <4 x i32> undef, i1 false, i32 0, i32 0)
