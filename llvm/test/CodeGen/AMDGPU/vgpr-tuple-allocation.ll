...
; GFX11: scratch_store_b32 off, v44, s32 offset:16 ; 4-byte Folded Spill
; GFX11: scratch_store_b32 off, v40, s33 offset:12 ; 4-byte Folded Spill
; GFX11-NEXT: scratch_store_b32 off, v41, s33 offset:8 ; 4-byte Folded Spill
; GFX11-NEXT: scratch_store_b32 off, v42, s33 offset:4 ; 4-byte Folded Spill
; GFX11-NEXT: scratch_store_b32 off, v43, s33         ; 4-byte Folded Spill
...
; GFX11: image_gather4_c_b_cl v[40:43], v[32:39], s[0:7], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D
...
; GFX11: scratch_load_b32 v43, off, s33
...
; GFX11: scratch_load_b32 v44, off, s32 offset:16 ; 4-byte Folded Reload
; GFX11: s_setpc_b64 s[0:1]
main_body:
...
; GFX11:      scratch_store_b32 off, v45, s32 offset:20 ; 4-byte Folded Spill
; GFX11:      scratch_store_b32 off, v40, s33 offset:16 ; 4-byte Folded Spill
; GFX11-NEXT: scratch_store_b32 off, v41, s33 offset:12 ; 4-byte Folded Spill
...
; GFX11-NEXT: v_writelane_b32 v45, s31, 9
; GFX11: image_gather4_c_b_cl v[0:3], v[12:19], s[36:43], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D
; GFX11-NEXT: s_getpc_b64 s[0:1]
; GFX11-NEXT: s_add_u32 s0, s0, extern_func@gotpcrel32@lo+4
; GFX11-NEXT: s_addc_u32 s1, s1, extern_func@gotpcrel32@hi+12
; GFX11-NEXT: v_mov_b32_e32 v40, v16
; GFX11: s_load_b64 s[0:1], s[0:1], 0x0
; GFX11-NEXT: v_mov_b32_e32 v41, v15
; GFX11-NEXT: v_mov_b32_e32 v42, v14
; GFX11-NEXT: v_mov_b32_e32 v43, v13
; GFX11-NEXT: v_mov_b32_e32 v44, v12
; GFX11-NEXT: s_waitcnt vmcnt(0)
; GFX11-NEXT: global_store_b128 v[0:1], v[0:3], off
; GFX11-NEXT: s_waitcnt lgkmcnt(0)
; GFX11-NEXT: s_swappc_b64 s[30:31], s[0:1]
; GFX11-NEXT: image_gather4_c_b_cl v[0:3], [v44, v43, v42, v41, v40], s[36:43], s[0:3] dmask:0x1 dim:SQ_RSRC_IMG_2D

; GFX11: scratch_load_b32 v44, off, s33
...
; GFX11: scratch_load_b32 v45, off, s32 offset:20
; GFX11: s_setpc_b64 s[0:1]
main_body:
  %v = call <4 x float> @llvm.amdgcn.image.gather4.c.b.cl.2d.v4f32.f32.f32(i32 1, float %bias, float %zcompare, float %s, float %t, float %clamp, <8 x i32> undef, <4 x i32> undef, i1 false, i32 0, i32 0)
