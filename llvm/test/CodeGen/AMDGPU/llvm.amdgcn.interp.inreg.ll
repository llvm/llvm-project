...
; RUN: llc -global-isel=1 -mtriple=amdgpu12.00 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16,GFX12-FAKE16-GISEL %s
...
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v0.l, 0
; GFX11-TRUE16-SDAG-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v2, 0
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b32_e32 v3, s1
; GFX11-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-SDAG-NEXT:    v_interp_p10_f16_f32 v1, v0.l, v1, v0.l wait_exp:7
; GFX11-TRUE16-SDAG-NEXT:    v_interp_p2_f16_f32 v0.l, v0.l, v3, v2 wait_exp:7
; GFX11-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-SDAG-NEXT:    v_cvt_f16_f32_e32 v0.h, v1
...
; GFX12-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v0.l, 0
; GFX12-TRUE16-SDAG-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_mov_b32 v2, 0
; GFX12-TRUE16-SDAG-NEXT:    v_mov_b32_e32 v3, s1
; GFX12-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-SDAG-NEXT:    v_interp_p10_f16_f32 v1, v0.l, v1, v0.l wait_exp:7
; GFX12-TRUE16-SDAG-NEXT:    v_interp_p2_f16_f32 v0.l, v0.l, v3, v2 wait_exp:7
; GFX12-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-SDAG-NEXT:    v_cvt_f16_f32_e32 v0.h, v1
