...
; CHECK-NEXT:    s_add_u32 s4, s4, dst_array@gotpcrel32@lo+4
; CHECK-NEXT:    s_addc_u32 s5, s5, dst_array@gotpcrel32@hi+12
...
; CHECK-NEXT:    v_pk_mov_b32 v[0:1], s[6:7], s[6:7] op_sel:[0,1]
; CHECK-NEXT:    v_cmp_lt_u64_e64 s[6:7], s[0:1], 16
; CHECK-NEXT:    s_and_b64 vcc, exec, s[6:7]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[2:5]
; CHECK-NEXT:    s_cbranch_vccnz .LBB0_2
; CHECK-NEXT:  ; %bb.3: ; %dynamic-memcpy-expansion-residual-cond
