...
define void @main(float %arg) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:sreg_32 = COPY [[PHI2]]
  ; CHECK-NEXT:   [[S_AND_B32_1:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY1]], 1, implicit-def dead $scc
  ; CHECK-NEXT:   [[S_MOV_B32_3:%[0-9]+]]:sreg_32 = S_MOV_B32 1
  ; CHECK-NEXT:   S_CMP_LG_U32 killed [[S_AND_B32_1]], killed [[S_MOV_B32_3]], implicit-def $scc
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:sreg_32 = COPY $scc
  ; CHECK-NEXT:   [[S_AND_B32_2:%[0-9]+]]:sreg_32 = S_AND_B32 $exec_lo, killed [[COPY2]], implicit-def dead $scc
