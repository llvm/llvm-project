...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX1210 %s
...
;
; GFX1210-LABEL: v_ashr_pk_i8_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_and_b32 s2, s2, 31
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    v_ashr_pk_i8_i32 v0, s0, s1, v0
; GFX1210-NEXT:    global_store_b16 v1, v0, s[4:5]
...
; GFX950-NEXT:    s_endpgm
;
; GFX1210-LABEL: v_ashr_pk_u8_i32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b96 s[0:2], s[4:5], 0x2c
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
...
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    v_ashr_pk_u8_i32 v0, s0, s1, v0
; GFX1210-NEXT:    global_store_b16 v1, v0, s[4:5]
; GFX1210-NEXT:    s_endpgm
  %insert.0 = insertelement <2 x i32> poison, i32 %src0, i64 0
  %build_vector = insertelement <2 x i32> %insert.0, i32 %src1, i64 1
