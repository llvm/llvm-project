...
; GFX950-NEXT:    v_ashr_pk_i8_i32 v1, s2, v1, v2
...
; GFX1250-TRUE16-NEXT:    v_ashr_pk_i8_i32 v0.l, s2, s3, v0
...
; GFX1250-FAKE16-NEXT:    v_ashr_pk_i8_i32 v0, s2, s3, v0
...
; GFX1300-TRUE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX1300-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1300-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX1300-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1300-TRUE16-NEXT:    s_and_b32 s4, s6, 31
; GFX1300-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-TRUE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1300-TRUE16-NEXT:    v_ashr_pk_i8_i32 v0.l, s2, s3, v0
; GFX1300-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX1300-TRUE16-NEXT:    s_endpgm
;
; GFX1300-FAKE16-LABEL: v_ashr_pk_i8_i32:
; GFX1300-FAKE16:       ; %bb.0:
; GFX1300-FAKE16-NEXT:    s_clause 0x1
; GFX1300-FAKE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX1300-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1300-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX1300-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1300-FAKE16-NEXT:    s_and_b32 s4, s6, 31
; GFX1300-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-FAKE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1300-FAKE16-NEXT:    v_ashr_pk_i8_i32 v0, s2, s3, v0
; GFX1300-FAKE16-NEXT:    global_store_b16 v1, v0, s[0:1]
...
; GFX1300-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-TRUE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1300-TRUE16-NEXT:    v_ashr_pk_u8_i32 v0.l, s2, s3, v0
; GFX1300-TRUE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX1300-TRUE16-NEXT:    s_endpgm
;
...
; GFX1300-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-FAKE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1300-FAKE16-NEXT:    v_ashr_pk_u8_i32 v0, s2, s3, v0
; GFX1300-FAKE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX1300-FAKE16-NEXT:    s_endpgm
  %insert.0 = insertelement <2 x i32> poison, i32 %src0, i64 0
  %build_vector = insertelement <2 x i32> %insert.0, i32 %src1, i64 1
