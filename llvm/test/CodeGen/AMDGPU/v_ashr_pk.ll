...
; GFX950-NEXT:    s_load_dword s6, s[4:5], 0x34
; GFX950-NEXT:    v_mov_b32_e32 v1, 0xffffff80
; GFX950-NEXT:    v_mov_b32_e32 v2, 0x7f
; GFX950-NEXT:    v_mov_b32_e32 v0, 0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_ashr_i32 s3, s3, s6
; GFX950-NEXT:    s_ashr_i32 s2, s2, s6
; GFX950-NEXT:    v_med3_i32 v3, s2, v1, v2
; GFX950-NEXT:    v_med3_i32 v1, s3, v1, v2
; GFX950-NEXT:    s_mov_b32 s2, 0x6050400
; GFX950-NEXT:    v_perm_b32 v1, v1, v3, s2
...
; GFX1250-TRUE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v0, 0x7f
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    s_ashr_i32 s2, s2, s6
; GFX1250-TRUE16-NEXT:    s_ashr_i32 s3, s3, s6
; GFX1250-TRUE16-NEXT:    v_med3_i32 v1, 0xffffff80, s2, v0
; GFX1250-TRUE16-NEXT:    v_med3_i32 v0, 0xffffff80, s3, v0
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-TRUE16-NEXT:    v_perm_b32 v0, v0, v1, 0x6050400
; GFX1250-TRUE16-NEXT:    global_store_b16 v2, v0, s[0:1]
...
; GFX1250-FAKE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v0, 0x7f
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v2, 0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    s_ashr_i32 s2, s2, s6
; GFX1250-FAKE16-NEXT:    s_ashr_i32 s3, s3, s6
; GFX1250-FAKE16-NEXT:    v_med3_i32 v1, 0xffffff80, s2, v0
; GFX1250-FAKE16-NEXT:    v_med3_i32 v0, 0xffffff80, s3, v0
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_perm_b32 v0, v0, v1, 0x6050400
; GFX1250-FAKE16-NEXT:    global_store_b16 v2, v0, s[0:1]
...
; GFX13-TRUE16-NEXT:    s_load_b32 s4, s[4:5], 0x34 nv
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v0, 0x7f
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_ashr_i32 s2, s2, s4
; GFX13-TRUE16-NEXT:    s_ashr_i32 s3, s3, s4
; GFX13-TRUE16-NEXT:    v_med3_i32 v1, 0xffffff80, s2, v0
; GFX13-TRUE16-NEXT:    v_med3_i32 v0, 0xffffff80, s3, v0
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_perm_b32 v0, v0, v1, 0x6050400
; GFX13-TRUE16-NEXT:    global_store_b16 v2, v0, s[0:1]
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: v_ashr_pk_i8_i32:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_clause 0x1
; GFX13-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-FAKE16-NEXT:    s_load_b32 s4, s[4:5], 0x34 nv
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v0, 0x7f
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v2, 0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_ashr_i32 s2, s2, s4
; GFX13-FAKE16-NEXT:    s_ashr_i32 s3, s3, s4
; GFX13-FAKE16-NEXT:    v_med3_i32 v1, 0xffffff80, s2, v0
; GFX13-FAKE16-NEXT:    v_med3_i32 v0, 0xffffff80, s3, v0
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_perm_b32 v0, v0, v1, 0x6050400
; GFX13-FAKE16-NEXT:    global_store_b16 v2, v0, s[0:1]
...
; GFX950-NEXT:    v_ashr_pk_u8_i32 v1, s2, v1, v2
; GFX950-NEXT:    global_store_short v0, v1, s[0:1]
; GFX950-NEXT:    s_endpgm
;
...
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    s_and_b32 s4, s6, 31
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1250-TRUE16-NEXT:    v_ashr_pk_u8_i32 v0.l, s2, s3, v0
...
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    s_and_b32 s4, s6, 31
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX1250-FAKE16-NEXT:    v_ashr_pk_u8_i32 v0, s2, s3, v0
; GFX1250-FAKE16-NEXT:    global_store_b16 v1, v0, s[0:1]
; GFX1250-FAKE16-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: v_ashr_pk_u8_i32:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_clause 0x1
; GFX13-TRUE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX13-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_and_b32 s4, s6, 31
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-TRUE16-NEXT:    v_ashr_pk_u8_i32 v0.l, s2, s3, v0
...
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_clause 0x1
; GFX13-FAKE16-NEXT:    s_load_b32 s6, s[4:5], 0x34 nv
; GFX13-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_and_b32 s4, s6, 31
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v0, s4
; GFX13-FAKE16-NEXT:    v_ashr_pk_u8_i32 v0, s2, s3, v0
