; RUN: opt -S -mtriple=amdgpu6.00-unknown-unknown -passes=amdgpu-promote-alloca -disable-promote-alloca-to-vector < %s | FileCheck %s
...
entry:
  %stack = alloca [9 x i32], align 4, addrspace(5)
  %0 = load i32, ptr addrspace(1) %in, align 4
  %arrayidx1 = getelementptr inbounds [9 x i32], ptr addrspace(5) %stack, i32 0, i32 %0
  ...
  %arrayidx3 = getelementptr inbounds [9 x i32], ptr addrspace(5) %stack, i32 0, i32 %1
  ...
  %arrayidx12 = getelementptr inbounds [9 x i32], ptr addrspace(5) %stack, i32 0, i32 1
