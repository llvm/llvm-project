...
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 -amdgpu-enable-promote-alloca=0 < %s | FileCheck -check-prefixes=GFX900 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx906 -amdgpu-enable-promote-alloca=0 < %s | FileCheck -check-prefixes=GFX906 %s
; RUN: llc -mtriple=amdgcn -mcpu=fiji -amdgpu-enable-promote-alloca=0 < %s | FileCheck -check-prefixes=GFX803 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 -amdgpu-enable-promote-alloca=0 -mattr=+enable-flat-scratch < %s | FileCheck -check-prefixes=GFX900-FLATSCR %s
