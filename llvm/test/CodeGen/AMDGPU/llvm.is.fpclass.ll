...
; GFX7SELDAG-NEXT:    v_cmp_class_f32_e64 s[0:1], s2, 3
...
; GFX10SELDAG-NEXT:    v_cmp_class_f32_e64 s1, s2, 3
...
; GFX11SELDAG-NEXT:    v_cmp_class_f32_e64 s1, s2, 3
; GFX11SELDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11SELDAG-NEXT:    v_cndmask_b32_e64 v1, 0, -1, s1
; GFX11SELDAG-NEXT:    s_mov_b32 s1, 0
...
; GFX11GLISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11GLISEL-NEXT:    s_cselect_b32 s1, 1, 0
; GFX11GLISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11GLISEL-NEXT:    s_and_b32 s1, s1, 1
; GFX11GLISEL-NEXT:    s_cmp_lg_u32 s1, 0
; GFX11GLISEL-NEXT:    s_cselect_b32 s1, -1, 0
; GFX11GLISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11GLISEL-NEXT:    v_mov_b32_e32 v0, s1
; GFX11GLISEL-NEXT:    s_mov_b32 s1, 0
