...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GFX67,GFX6 %s
; RUN: llc -mtriple=amdgpu7.04 < %s | FileCheck -check-prefixes=GFX67,GFX7 %s
; RUN: llc -mtriple=amdgpu8.02 < %s | FileCheck -check-prefixes=GFX89,GFX8 %s
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GFX89,GFX9 %s
