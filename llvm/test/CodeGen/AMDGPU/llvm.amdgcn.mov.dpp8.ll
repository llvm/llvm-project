...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX10PLUS %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX10PLUS %s
...
; GFX10PLUS-DAG: global_store_{{dwordx3|b96}} v[{{[0-9]+}}:{{[0-9]+}}], v[0:2], off
...
; GFX10PLUS-DAG: v_mov_b32_dpp v0, v0 dpp8:[1,0,0,0,0,0,0,0]
; GFX10PLUS-DAG: global_store_{{dword|b32}} v[{{[0-9]+}}:{{[0-9]+}}], v0, off
...
; GFX10PLUS-DAG: v_mov_b32_dpp v0, v0 dpp8:[1,0,0,0,0,0,0,0]
; GFX10PLUS-DAG: global_store_{{short|b16}} v[{{[0-9]+}}:{{[0-9]+}}], v0, off
