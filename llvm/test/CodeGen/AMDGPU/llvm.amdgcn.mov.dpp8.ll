...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 < %s | FileCheck -check-prefix=GFX10PLUS %s
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-vopd=0 < %s | FileCheck -check-prefix=GFX10PLUS %s
