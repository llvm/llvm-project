...
; GFX11:  v_dot2_f32_f16 v{{[0-9]+}}, s{{[0-9]+}}, s{{[0-9]+}}, v{{[0-9]+}} clamp{{$}}
...
; GFX11:  v_dual_dot2acc_f32_f16 v{{[0-9]+}}, s{{[0-9]+}}, v{{[0-9]+}}{{$}}
...
; GFX10: v_mov_b32_e32 [[LITERAL:v[0-9]+]], 1.0
; GFX10:     v_dot2c_f32_f16_e32 [[LITERAL]], v{{[0-9]+}}, v{{[0-9]+}}
; GFX11: v_mov_b32_e32 [[LITERAL:v[0-9]+]], 1.0
