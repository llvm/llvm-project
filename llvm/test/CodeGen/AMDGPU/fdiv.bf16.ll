...
define bfloat @v_fdiv_f16_afn(bfloat %x, bfloat %y) {
; GFX1250-TRUE16-LABEL: v_fdiv_f16_afn:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    v_rcp_bf16_e32 v1.l, v1.l
; GFX1250-TRUE16-NEXT:    v_nop
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1)
; GFX1250-TRUE16-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, 0 op_sel_hi:[1,1,0]
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-FAKE16-LABEL: v_fdiv_f16_afn:
; GFX1250-FAKE16:       ; %bb.0:
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v1
; GFX1250-FAKE16-NEXT:    v_nop
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(TRANS32_DEP_1)
; GFX1250-FAKE16-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, 0 op_sel_hi:[1,1,0]
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
  %fdiv = fdiv afn bfloat %x, %y
  ret bfloat %fdiv
}

define bfloat @v_fdiv_bf16_unsafe(bfloat %x, bfloat %y) "unsafe-fp-math"="true" {
; GFX1250-TRUE16-LABEL: v_fdiv_bf16_unsafe:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    v_rcp_bf16_e32 v1.l, v1.l
...
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-FAKE16-LABEL: v_fdiv_bf16_unsafe:
; GFX1250-FAKE16:       ; %bb.0:
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v1
...
define bfloat @v_fdiv_bf16_arcp(bfloat %x, bfloat %y) {
; GFX1250-TRUE16-LABEL: v_fdiv_bf16_arcp:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    v_rcp_bf16_e32 v1.l, v1.l
...
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-FAKE16-LABEL: v_fdiv_bf16_arcp:
; GFX1250-FAKE16:       ; %bb.0:
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v1
...
; GFX1250-FAKE16-NEXT:    v_fma_mixlo_bf16 v0, v0, v1, 0 op_sel_hi:[1,1,0]
; GFX1250-FAKE16-NEXT:    s_set_pc_i64 s[30:31]
  %fdiv = fdiv arcp bfloat %x, %y
  ret bfloat %fdiv
}

define bfloat @v_fdiv_bf16_afn_nsz(bfloat %x, bfloat %y) {
; GFX1250-TRUE16-LABEL: v_fdiv_bf16_afn_nsz:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    v_rcp_bf16_e32 v1.l, v1.l
...
; GFX1250-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
; GFX1250-FAKE16-LABEL: v_fdiv_bf16_afn_nsz:
; GFX1250-FAKE16:       ; %bb.0:
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-FAKE16-NEXT:    v_rcp_bf16_e32 v1, v1
