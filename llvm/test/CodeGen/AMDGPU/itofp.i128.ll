...
; SDAG-NEXT:    v_lshlrev_b32_e32 v3, 30, v2
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; SDAG-NEXT:    v_lshrrev_b32_e32 v5, 2, v1
; SDAG-NEXT:    v_or_b32_e32 v9, v5, v3
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:  ; %bb.11: ; %itofp-if-then20
; SDAG-NEXT:    v_lshrrev_b64 v[4:5], 3, v[0:1]
; SDAG-NEXT:    v_lshlrev_b32_e32 v0, 29, v2
; SDAG-NEXT:    v_lshrrev_b32_e32 v1, 3, v1
; SDAG-NEXT:    v_or_b32_e32 v9, v1, v0
