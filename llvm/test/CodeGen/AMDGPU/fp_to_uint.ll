...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_f32_to_i32:
; GFX11:       ; %bb.0:
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_v2f32_to_v2i32:
; GFX11:       ; %bb.0:
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_v4f32_to_v4i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cvt_u32_f32_e32 v3, s7
; GFX11-NEXT:    v_cvt_u32_f32_e32 v2, s6
; GFX11-NEXT:    v_cvt_u32_f32_e32 v1, s5
; GFX11-NEXT:    v_cvt_u32_f32_e32 v0, s4
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_f32_to_i1:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b32 s2, s[4:5], 0x2c
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_eq_f32_e64 s2, 1.0, s2
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_fabs_f32_to_i1:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b32 s2, s[4:5], 0x2c
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_v2f32_to_v2i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_uint_f32_to_v2i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
