...
; GCN-NEXT:    ds_read2_b32 v[0:1], v2 offset0:7 offset1:8
; GCN-NEXT:    ds_write2_b32 v2, v3, v4 offset0:26 offset1:27
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NEXT:    ds_read2_b32 v[0:1], v2 offset0:7 offset1:27
; GCN-NEXT:    ds_write2_b32 v2, v3, v4 offset0:26 offset1:27
; GCN-NEXT:    s_waitcnt lgkmcnt(1)
; GCN-NEXT:    v_add_f32_e32 v2, v1, v0
; GCN-NEXT:    v_mov_b32_e32 v0, s0
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NEXT:    ds_write2_b32 v2, v0, v1 offset0:26 offset1:27
; GCN-NEXT:    ds_read_b32 v0, v2 offset:32
; GCN-NEXT:    ds_read_b32 v1, v2 offset:104
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_add_f32_e32 v2, v0, v1
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    flat_store_dword v[0:1], v2
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NEXT:    ds_read_b32 v3, v2 offset:108
; GCN-NEXT:    ds_write2_b32 v2, v0, v1 offset0:26 offset1:27
; GCN-NEXT:    ds_read_b32 v0, v2 offset:104
; GCN-NEXT:    v_mov_b32_e32 v1, s1
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_add_f32_e32 v2, v3, v0
; GCN-NEXT:    v_mov_b32_e32 v0, s0
; GCN-NEXT:    flat_store_dword v[0:1], v2
; GCN-NEXT:    s_endpgm
  %addr0 = getelementptr i8, ptr addrspace(3) %inptr, i32 100
