...
; EG-NEXT:     LSHR * T1.X, KC0[3].W, literal.y,
...
; EG-NEXT:    ALU clause starting at 4:
; EG-NEXT:     MOV T0.X, literal.x,
; EG-NEXT:     LSHR * T1.X, KC0[5].Y, literal.y,
; EG-NEXT:    0(0.000000e+00), 2(2.802597e-45)
...
; EG-NEXT:    ALU clause starting at 4:
; EG-NEXT:     MOV T0.X, literal.x,
; EG-NEXT:     LSHR * T1.X, KC0[6].W, literal.x,
...
; EG-NEXT:    ALU clause starting at 4:
; EG-NEXT:     MOV T0.X, literal.x,
; EG-NEXT:     LSHR * T1.X, KC0[6].W, literal.y,
; EG-NEXT:    1(1.401298e-45), 2(2.802597e-45)
                             ptr addrspace(1) %in2, ; read_only
                             ptr addrspace(1) %in3, ; read_only
                             ptr addrspace(1) %out) {
