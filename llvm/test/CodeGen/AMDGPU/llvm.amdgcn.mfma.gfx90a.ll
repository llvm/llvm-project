...
; GFX90A-NEXT:    v_mov_b32_e32 v8, 2
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_4x4x4bf16_1k v[4:7], v[4:5], v[8:9], v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 4
; GFX90A-NEXT:    global_store_dwordx4 v9, v[4:7], s[6:7]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    v_mov_b32_e32 v8, 2
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_4x4x4_16b_bf16 v[4:7], v[4:5], v[8:9], v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 4
; GFX942-NEXT:    global_store_dwordx4 v9, v[4:7], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    v_pk_mov_b32 v[2:3], s[2:3], s[2:3] op_sel:[0,1]
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f32_16x16x16bf16_1k v[4:7], v[4:5], v[8:9], v[0:3] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 10
; GFX90A-NEXT:    global_store_dwordx4 v9, v[4:7], s[6:7]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f32_16x16x16_bf16 v[4:7], v[4:5], v[8:9], v[0:3] cbsz:1 abid:2 blgp:3
; GFX942-NEXT:    s_nop 6
; GFX942-NEXT:    global_store_dwordx4 v9, v[4:7], s[6:7]
; GFX942-NEXT:    s_endpgm
;
...
; GFX90A-NEXT:    s_nop 3
; GFX90A-NEXT:    v_mfma_f64_4x4x4f64 v[2:3], v[2:3], v[4:5], v[0:1] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    v_mov_b32_e32 v4, 0
; GFX90A-NEXT:    s_nop 7
; GFX90A-NEXT:    global_store_dwordx2 v4, v[2:3], s[0:1]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_nop 3
; GFX942-NEXT:    v_mfma_f64_4x4x4_4b_f64 v[2:3], v[2:3], v[4:5], v[0:1] cbsz:1 abid:2 neg:[1,1,0]
...
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    v_mfma_f64_16x16x4f64 v[8:15], v[16:17], v[18:19], v[8:15]
; GFX90A-NEXT:    v_mfma_f64_16x16x4f64 v[8:15], v[16:17], v[18:19], v[8:15] cbsz:1 abid:2 blgp:3
; GFX90A-NEXT:    s_nop 15
; GFX90A-NEXT:    s_nop 1
; GFX90A-NEXT:    global_store_dwordx4 v0, v[12:15], s[0:1] offset:16
; GFX90A-NEXT:    global_store_dwordx4 v0, v[8:11], s[0:1]
; GFX90A-NEXT:    s_endpgm
;
...
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[16:17], s[2:3]
...
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_mfma_f64_16x16x4_f64 v[8:15], v[16:17], v[18:19], v[8:15]
; GFX942-NEXT:    v_mfma_f64_16x16x4_f64 v[8:15], v[16:17], v[18:19], v[8:15] cbsz:1 abid:2 neg:[1,1,0]
; GFX942-NEXT:    s_nop 15
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    global_store_dwordx4 v0, v[12:15], s[0:1] offset:16
...
; GFX90A-NEXT:    v_mov_b32_e32 v17, s3
; GFX90A-NEXT:    v_mov_b32_e32 v1, v0
; GFX90A-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NEXT:    v_mov_b32_e32 v3, v0
; GFX90A-NEXT:    v_mov_b32_e32 v4, v0
...
; GFX942-NEXT:    v_mov_b32_e32 v17, s3
; GFX942-NEXT:    v_mov_b32_e32 v1, v0
; GFX942-NEXT:    v_mov_b32_e32 v2, v0
; GFX942-NEXT:    v_mov_b32_e32 v3, v0
; GFX942-NEXT:    v_mov_b32_e32 v4, v0
