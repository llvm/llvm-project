...
; GFX900-NEXT:  ; %bb.1:
; GFX900-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX900-NEXT:    global_atomic_cmpswap v1, v3, v[4:5], s[2:3] glc
...
; GFX908-NEXT:  ; %bb.1:
; GFX908-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX908-NEXT:    global_atomic_cmpswap v1, v3, v[4:5], s[2:3] glc
...
; GFX90A-NEXT:    global_atomic_cmpswap v1, v3, v[4:5], s[2:3] glc
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mul_f32 v2, 4.0, v1 :: v_dual_mov_b32 v1, s2
...
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    global_atomic_add_f32 v1, v1, v2, s[2:3] glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1_vol
; GFX90A-NEXT:  .LBB1_2:
; GFX90A-NEXT:    s_or_b64 exec, exec, s[0:1]
...
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v1, s1
; GFX11-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mul_f32 v1, 4.0, v1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_atomic_add_f32 v1, v2, v1, s[2:3] glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
; GFX11-NEXT:  .LBB1_2:
...
; GFX900-NEXT:  ; %bb.1:
; GFX900-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; GFX900-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX900-NEXT:    v_cvt_f32_ubyte0_e32 v0, s4
...
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, s0
; GFX11-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mul_f32 v0, 4.0, v0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_atomic_add_f32 v1, v0, s[2:3]
...
; GFX11-NEXT:  ; %bb.1:
; GFX11-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_load_dword s6, s[2:3], 0x0
; GFX11-NEXT:    v_mov_b32_e32 v3, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    v_mov_b32_e32 v5, v1
; GFX11-NEXT:    v_add_f32_e32 v4, v5, v2
; GFX11-NEXT:    global_atomic_cmpswap v1, v3, v[4:5], s[2:3] glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_mbcnt_lo_u32_b32 v0, s0, 0
; GFX11-NEXT:    v_mbcnt_hi_u32_b32 v0, s1, v0
; GFX11-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX11-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX11-NEXT:    s_cbranch_execz .LBB7_2
; GFX11-NEXT:  ; %bb.1:
; GFX11-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
; GFX11-NEXT:    s_bcnt1_i32_b64 s0, s[0:1]
...
; GFX908-NEXT:  ; %bb.1:
; GFX908-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; GFX908-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX908-NEXT:    v_cvt_f32_ubyte0_e32 v0, s4
...
; GFX90A-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX90A-NEXT:    v_cvt_f32_ubyte0_e32 v0, s4
...
; GFX11-NEXT:  ; %bb.1:
; GFX11-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX11-NEXT:    s_bcnt1_i32_b32 s3, s5
; GFX11-NEXT:    v_mov_b32_e32 v3, 0
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, s3
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_load_b32 s2, s[0:1], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mul_f32 v2, 4.0, v0 :: v_dual_mov_b32 v1, s2
...
; GFX900-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX900-NEXT:    s_mov_b64 s[2:3], 0
; GFX900-NEXT:    v_cvt_f32_ubyte0_e32 v2, s4
; GFX900-NEXT:    v_mov_b32_e32 v3, 0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX900:       ; %bb.0:
; GFX900-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x24
...
; GFX908:       ; %bb.0:
; GFX908-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x24
...
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[6:7], s[2:3], 0x24
