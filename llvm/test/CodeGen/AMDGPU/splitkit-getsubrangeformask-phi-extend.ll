...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[10:11], 1, v22
...
; CHECK-NEXT:    buffer_load_dword v22, off, s[0:3], s32 offset:788
; CHECK-NEXT:    buffer_load_dword v49, off, s[0:3], s32 offset:392
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[38:39], 3, v22
...
; CHECK-NEXT:    s_mov_b64 s[62:63], s[60:61]
; CHECK-NEXT:    s_mov_b64 s[60:61], s[58:59]
; CHECK-NEXT:    s_mov_b64 s[58:59], s[56:57]
; CHECK-NEXT:    s_mov_b64 s[56:57], s[46:47]
...
; CHECK-NEXT:    flat_store_short v[8:9], v21
; CHECK-NEXT:    v_add_co_u32_e64 v8, s[38:39], s38, v34
; CHECK-NEXT:    v_alignbit_b32 v7, v7, v13, 15
; CHECK-NEXT:    v_addc_co_u32_e64 v9, s[38:39], 0, v35, s[38:39]
...
; CHECK-NEXT:    v_and_b32_e32 v9, 0x7fffffff, v21
...
; CHECK-NEXT:    s_mov_b64 s[44:45], s[46:47]
; CHECK-NEXT:    s_mov_b64 s[46:47], s[56:57]
; CHECK-NEXT:    s_mov_b64 s[56:57], s[58:59]
; CHECK-NEXT:    s_mov_b64 s[58:59], s[60:61]
; CHECK-NEXT:    s_mov_b64 s[60:61], s[62:63]
...
; CHECK-NEXT:    flat_load_dwordx2 v[2:3], v[0:1] offset:24
...
; CHECK-NEXT:    flat_load_dwordx2 v[4:5], v[0:1] offset:40
...
; CHECK-NEXT:    flat_load_dwordx2 v[46:47], v[0:1] offset:112
...
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 21, v14
; CHECK-NEXT:    v_lshrrev_b64 v[8:9], 10, v[28:29]
; CHECK-NEXT:    v_or_b32_e32 v9, v9, v6
; CHECK-NEXT:    v_lshlrev_b32_e32 v14, 22, v28
...
; CHECK-NEXT:    v_lshlrev_b32_e32 v8, 24, v26
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], 7, v[10:11]
; CHECK-NEXT:    v_or_b32_e32 v7, v7, v8
; CHECK-NEXT:    flat_store_dwordx2 v[0:1], v[6:7] offset:32
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 25, v10
; CHECK-NEXT:    v_lshrrev_b64 v[8:9], 6, v[36:37]
; CHECK-NEXT:    v_or_b32_e32 v9, v9, v6
; CHECK-NEXT:    v_lshlrev_b32_e32 v10, 26, v36
...
; CHECK-NEXT:    v_lshrrev_b64 v[4:5], 4, v[32:33]
...
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, 0x7c, v34
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v35, vcc
; CHECK-NEXT:    v_lshrrev_b32_e32 v5, 15, v30
...
; CHECK-NEXT:    v_lshrrev_b64 v[8:9], 14, v[2:3]
; CHECK-NEXT:    v_and_b32_e32 v33, 0x7fffffff, v26
; CHECK-NEXT:    v_or_b32_e32 v9, v9, v0
; CHECK-NEXT:    v_add_co_u32_e32 v0, vcc, 24, v34
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 18, v2
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], 13, v[32:33]
; CHECK-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v35, vcc
; CHECK-NEXT:    v_or_b32_e32 v7, v7, v2
; CHECK-NEXT:    v_mov_b32_e32 v3, v55
; CHECK-NEXT:    v_and_b32_e32 v55, 0x7fffffff, v24
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:80
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 19, v32
; CHECK-NEXT:    v_lshrrev_b64 v[8:9], 12, v[54:55]
; CHECK-NEXT:    v_mov_b32_e32 v55, v3
; CHECK-NEXT:    v_mov_b32_e32 v3, v53
; CHECK-NEXT:    v_and_b32_e32 v53, 0x7fffffff, v22
; CHECK-NEXT:    v_or_b32_e32 v9, v9, v2
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 20, v54
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], 11, v[52:53]
; CHECK-NEXT:    v_mov_b32_e32 v53, v3
; CHECK-NEXT:    v_or_b32_e32 v7, v7, v2
; CHECK-NEXT:    v_mov_b32_e32 v3, v51
; CHECK-NEXT:    v_and_b32_e32 v51, 0x7fffffff, v20
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:64
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 21, v52
; CHECK-NEXT:    v_lshrrev_b64 v[8:9], 10, v[50:51]
; CHECK-NEXT:    v_mov_b32_e32 v51, v3
; CHECK-NEXT:    v_mov_b32_e32 v3, v49
; CHECK-NEXT:    v_and_b32_e32 v49, 0x7fffffff, v18
; CHECK-NEXT:    v_or_b32_e32 v9, v9, v2
...
; CHECK-NEXT:    flat_store_dwordx4 v[0:1], v[6:9] offset:16
; CHECK-NEXT:    s_nop 0
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 27, v14
; CHECK-NEXT:    v_and_b32_e32 v7, 0x7fffffff, v4
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v8, v2
; CHECK-NEXT:    v_and_b32_e32 v9, 0x7fffffff, v8
; CHECK-NEXT:    v_lshrrev_b64 v[2:3], 4, v[8:9]
; CHECK-NEXT:    v_or_b32_e32 v3, v3, v6
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 28, v8
; CHECK-NEXT:    v_accvgpr_read_b32 v8, a4
; CHECK-NEXT:    v_and_b32_e32 v9, 0x7fffffff, v6
; CHECK-NEXT:    flat_store_dwordx2 v[34:35], v[2:3] offset:32
; CHECK-NEXT:    v_lshrrev_b64 v[2:3], 3, v[8:9]
; CHECK-NEXT:    v_or_b32_e32 v3, v3, v6
; CHECK-NEXT:    v_accvgpr_read_b32 v6, a2
; CHECK-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 29, v8
; CHECK-NEXT:    v_lshrrev_b64 v[0:1], 2, v[6:7]
; CHECK-NEXT:    v_or_b32_e32 v1, v1, v2
; CHECK-NEXT:    v_and_b32_e32 v11, 0x7fffffff, v2
; CHECK-NEXT:    flat_store_dwordx2 v[34:35], v[0:1] offset:16
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 30, v6
; CHECK-NEXT:    v_lshrrev_b64 v[6:7], 1, v[10:11]
