...
; RUN: llc < %s -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 | FileCheck %s --check-prefix=GFX11
...
; GFX11-NEXT:    s_cbranch_execnz BB0_2
; GFX11-NEXT:  ; %bb.3: ; in Loop: Header=BB0_1 Depth=1
; GFX11-NEXT:    s_mov_b32 exec_lo, s1
; GFX11-NEXT:    s_branch BB0_1
entry:
  br label %bb0
