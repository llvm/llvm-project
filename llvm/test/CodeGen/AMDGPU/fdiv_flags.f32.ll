...
; RUN: llc -global-isel=1 -global-isel-abort=2 -amdgpu-codegenprepare-disable-fdiv-expansion=0 -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=CHECK,IEEE,CODEGEN-IEEE-GISEL %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -amdgpu-codegenprepare-disable-fdiv-expansion=1 -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math=ieee < %s | FileCheck -check-prefixes=CHECK,IEEE,IR-IEEE,IR-IEEE-GISEL %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -amdgpu-codegenprepare-disable-fdiv-expansion=0 -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=CHECK,DAZ,CODEGEN-DAZ,CODEGEN-DAZ-GISEL %s
...
; RUN: llc -global-isel=1 -global-isel-abort=2 -amdgpu-codegenprepare-disable-fdiv-expansion=1 -mtriple=amdgcn -mcpu=hawaii -denormal-fp-math=preserve-sign < %s | FileCheck -check-prefixes=CHECK,DAZ,IR-DAZ,IR-DAZ-GISEL %s
...
; IEEE:       ; %bb.0:
; IEEE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; IEEE-NEXT:    s_mov_b32 s4, 0xf800000
; IEEE-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v0
; IEEE-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; IEEE-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; IEEE-NEXT:    v_sqrt_f32_e32 v1, v0
; IEEE-NEXT:    v_add_i32_e64 v2, s[4:5], -1, v1
; IEEE-NEXT:    v_fma_f32 v3, -v2, v1, v0
; IEEE-NEXT:    v_cmp_ge_f32_e64 s[4:5], 0, v3
; IEEE-NEXT:    v_cndmask_b32_e64 v2, v1, v2, s[4:5]
; IEEE-NEXT:    v_add_i32_e64 v3, s[4:5], 1, v1
; IEEE-NEXT:    v_fma_f32 v1, -v3, v1, v0
; IEEE-NEXT:    v_cmp_lt_f32_e64 s[4:5], 0, v1
; IEEE-NEXT:    v_cndmask_b32_e64 v1, v2, v3, s[4:5]
; IEEE-NEXT:    v_mul_f32_e32 v2, 0x37800000, v1
; IEEE-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; IEEE-NEXT:    v_mov_b32_e32 v2, 0x260
; IEEE-NEXT:    v_cmp_class_f32_e32 vcc, v0, v2
; IEEE-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; IEEE-NEXT:    v_div_scale_f32 v1, s[4:5], v0, v0, 1.0
; IEEE-NEXT:    v_rcp_f32_e32 v2, v1
; IEEE-NEXT:    v_fma_f32 v3, -v1, v2, 1.0
; IEEE-NEXT:    v_fma_f32 v2, v3, v2, v2
; IEEE-NEXT:    v_div_scale_f32 v3, vcc, 1.0, v0, 1.0
; IEEE-NEXT:    v_mul_f32_e32 v4, v3, v2
; IEEE-NEXT:    v_fma_f32 v5, -v1, v4, v3
; IEEE-NEXT:    v_fma_f32 v4, v5, v2, v4
...
; DAZ:       ; %bb.0:
; DAZ-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAZ-NEXT:    s_mov_b32 s4, 0xf800000
; DAZ-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v0
; DAZ-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; DAZ-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; DAZ-NEXT:    v_rsq_f32_e32 v1, v0
; DAZ-NEXT:    v_mul_f32_e32 v2, v0, v1
; DAZ-NEXT:    v_mul_f32_e32 v1, 0.5, v1
; DAZ-NEXT:    v_fma_f32 v3, -v1, v2, 0.5
; DAZ-NEXT:    v_fma_f32 v2, v2, v3, v2
; DAZ-NEXT:    v_fma_f32 v4, -v2, v2, v0
; DAZ-NEXT:    v_fma_f32 v1, v1, v3, v1
; DAZ-NEXT:    v_fma_f32 v1, v4, v1, v2
; DAZ-NEXT:    v_mul_f32_e32 v2, 0x37800000, v1
; DAZ-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; DAZ-NEXT:    v_mov_b32_e32 v2, 0x260
; DAZ-NEXT:    v_cmp_class_f32_e32 vcc, v0, v2
; DAZ-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; DAZ-NEXT:    v_div_scale_f32 v1, s[4:5], v0, v0, 1.0
; DAZ-NEXT:    v_rcp_f32_e32 v2, v1
; DAZ-NEXT:    v_div_scale_f32 v3, vcc, 1.0, v0, 1.0
; DAZ-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 4, 2), 3
...
; CHECK-LABEL: v_fdiv_recip_sqrt_f32_arcp:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; CHECK-LABEL: v_fdiv_recip_sqrt_f32_arcp_fdiv_only:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_rsq_f32_e32 v0, v0
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; IEEE-LABEL: v_fdiv_recip_sqrt_f32_afn_fdiv_only:
; IEEE:       ; %bb.0:
; IEEE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; IEEE-NEXT:    s_mov_b32 s4, 0xf800000
; IEEE-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v0
...
; IEEE-NEXT:    v_cmp_class_f32_e32 vcc, v0, v2
; IEEE-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; IEEE-NEXT:    v_rcp_f32_e32 v0, v0
; IEEE-NEXT:    s_setpc_b64 s[30:31]
;
; DAZ-LABEL: v_fdiv_recip_sqrt_f32_afn_fdiv_only:
; DAZ:       ; %bb.0:
; DAZ-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAZ-NEXT:    s_mov_b32 s4, 0xf800000
; DAZ-NEXT:    v_mul_f32_e32 v1, 0x4f800000, v0
...
;
; CODEGEN-DAZ-LABEL: v_fdiv_f32_ulp25:
; CODEGEN-DAZ:       ; %bb.0:
; CODEGEN-DAZ-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CODEGEN-DAZ-NEXT:    s_mov_b32 s4, 0x6f800000
; CODEGEN-DAZ-NEXT:    v_mov_b32_e32 v2, 0x2f800000
; CODEGEN-DAZ-NEXT:    v_cmp_gt_f32_e64 vcc, |v1|, s4
; CODEGEN-DAZ-NEXT:    v_cndmask_b32_e32 v2, 1.0, v2, vcc
; CODEGEN-DAZ-NEXT:    v_mul_f32_e32 v1, v1, v2
; CODEGEN-DAZ-NEXT:    v_rcp_f32_e32 v1, v1
; CODEGEN-DAZ-NEXT:    v_mul_f32_e32 v0, v0, v1
; CODEGEN-DAZ-NEXT:    v_mul_f32_e32 v0, v2, v0
...
; IR-IEEE:       ; %bb.0:
; IR-IEEE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; IR-IEEE-NEXT:    s_mov_b32 s4, 0x800000
; IR-IEEE-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; IR-IEEE-NEXT:    v_cndmask_b32_e64 v1, 0, 32, vcc
; IR-IEEE-NEXT:    v_ldexp_f32_e32 v0, v0, v1
; IR-IEEE-NEXT:    v_sqrt_f32_e32 v0, v0
; IR-IEEE-NEXT:    v_cndmask_b32_e64 v1, 0, -16, vcc
; IR-IEEE-NEXT:    v_ldexp_f32_e32 v0, v0, v1
; IR-IEEE-NEXT:    v_div_scale_f32 v1, s[4:5], v0, v0, 1.0
; IR-IEEE-NEXT:    v_rcp_f32_e32 v2, v1
; IR-IEEE-NEXT:    v_div_scale_f32 v3, vcc, 1.0, v0, 1.0
