...
; GFX908:       ; %bb.0: ; %bb
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x40400000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x40c00000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x40e00000
; GFX908-NEXT:    v_accvgpr_write_b32 a2, v0
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x40a00000
; GFX908-NEXT:    v_accvgpr_write_b32 a5, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a6, v2
; GFX908-NEXT:    v_accvgpr_write_b32 a4, v0
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41000000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41100000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41200000
; GFX908-NEXT:    v_accvgpr_write_b32 a7, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a8, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a9, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41300000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41400000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41500000
; GFX908-NEXT:    v_accvgpr_write_b32 a10, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a11, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a12, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41600000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41700000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41800000
; GFX908-NEXT:    v_accvgpr_write_b32 a13, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a14, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a15, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41880000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41900000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41980000
; GFX908-NEXT:    v_accvgpr_write_b32 a16, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a17, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a18, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41a00000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41a80000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41b00000
; GFX908-NEXT:    v_accvgpr_write_b32 a19, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a20, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a21, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41b80000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41c00000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41c80000
; GFX908-NEXT:    v_accvgpr_write_b32 a22, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a23, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a24, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41d00000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41d80000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41e00000
; GFX908-NEXT:    v_accvgpr_write_b32 a25, v0
; GFX908-NEXT:    v_accvgpr_write_b32 a26, v1
; GFX908-NEXT:    v_accvgpr_write_b32 a27, v2
; GFX908-NEXT:    v_mov_b32_e32 v0, 0x41e80000
; GFX908-NEXT:    v_mov_b32_e32 v1, 0x41f00000
; GFX908-NEXT:    v_mov_b32_e32 v2, 0x41f80000
...
; GFX908-NEXT:    v_mfma_f32_32x32x1f32 a[0:31], v3, v3, a[0:31]
...
; GFX908-NEXT:    ;;#ASMEND
; GFX908-NEXT:    s_waitcnt lgkmcnt(0)
; GFX908-NEXT:    global_store_dword v1, v0, s[2:3]
; GFX908-NEXT:    s_endpgm
;
