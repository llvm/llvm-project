...
; SI-NEXT:    s_bfe_i32 s0, s2, 0x180000
; SI-NEXT:    s_bfe_i32 s1, s3, 0x180000
...
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_bfe_i32 s0, s2, 0x180000
; SI-NEXT:    v_mul_hi_i32_i24_e64 v1, s0, s0
; SI-NEXT:    s_mul_i32 s0, s0, s0
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX9-NEXT:    s_mov_b32 s2, -1
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s4, s8, 0x180000
