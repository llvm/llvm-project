...
; FLAT_SCR_OPT-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s8
; FLAT_SCR_OPT-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s9
; FLAT_SCR_OPT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
...
; FLAT_SCR_OPT-NEXT:    s_load_dword vcc_lo, s[4:5], 0x8
; FLAT_SCR_OPT-NEXT:    ; kill: killed $sgpr4_sgpr5
...
; FLAT_SCR_ARCH:       ; %bb.0:
; FLAT_SCR_ARCH-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
...
; FLAT_SCR_ARCH-NEXT:    s_load_dword vcc_lo, s[4:5], 0x8
; FLAT_SCR_ARCH-NEXT:    ; kill: killed $sgpr4_sgpr5
