...
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa --mattr=+enable-flat-scratch < %s | FileCheck -check-prefixes=GCN,FLAT_SCR_OPT %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa --mattr=+architected-flat-scratch < %s | FileCheck -check-prefixes=GCN,FLAT_SCR_ARCH %s
...
; GCN-NEXT:    v_writelane_b32 v0, s2, 2
; GCN-NEXT:    v_writelane_b32 v0, s3, 3
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ;;#ASMEND
