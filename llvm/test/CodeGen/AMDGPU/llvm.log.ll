...
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s2
; GFX1100-SDAG-NEXT:    s_waitcnt_depctr 0xfff
; GFX1100-SDAG-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mul_f32 v0, 0x3f317218, v0
...
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v0, s2
...
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s3
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v2, s2
...
; GFX1100-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v0, s2
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v1, s3
; GFX1100-GISEL-NEXT:    s_waitcnt_depctr 0xfff
...
; GFX1100-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s6
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, s5
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v3, s4
; GFX1100-SDAG-NEXT:    v_mov_b32_e32 v4, 0
; GFX1100-SDAG-NEXT:    s_waitcnt_depctr 0xfff
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v2, 0x3f317218, v0 :: v_dual_mul_f32 v1, 0x3f317218, v1
; GFX1100-SDAG-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v3
...
; GFX1100-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v0, s4
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v1, s5
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v2, s6
; GFX1100-GISEL-NEXT:    s_waitcnt_depctr 0xfff
; GFX1100-GISEL-NEXT:    v_dual_mul_f32 v0, 0x3f317218, v0 :: v_dual_mul_f32 v1, 0x3f317218, v1
...
; GFX1100-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s7
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, s6
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v4, s5
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v5, s4
...
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v1, s5
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v2, s6
; GFX1100-GISEL-NEXT:    v_log_f32_e32 v3, s7
...
; GFX689-LABEL: v_log_fneg_fabs_f32:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e64 v0, -|v0|
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689-LABEL: v_log_f32_nnan_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689-LABEL: v_log_f32_ninf_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689-LABEL: v_log_f32_nnan_ninf:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689-LABEL: v_log_f32_nnan_ninf_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689-LABEL: v_log_f32_dynamic_mode:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
...
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, s4
; GFX689-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1100-NEXT:    v_log_f32_e32 v0, s0
; GFX1100-NEXT:    s_waitcnt_depctr 0xfff
; GFX1100-NEXT:    v_mul_f32_e32 v0, 0x3f317218, v0
; GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX689-GISEL-NEXT:    v_mov_b32_e32 v0, 0x3f317218
; GFX689-GISEL-NEXT:    v_mul_f32_e32 v0, 0xff800000, v0
...
; GFX1100-GISEL-NEXT:    v_mov_b32_e32 v0, 0x3f317218
; GFX1100-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1100-GISEL-NEXT:    v_mul_f32_e32 v0, 0xff800000, v0
