...
;===----------------------------------------------------------------------===;
; S_LOAD from literal address
;===----------------------------------------------------------------------===;

define amdgpu_kernel void @s_load_u8_from_literal(ptr addrspace(1) %out) {
; CHECK-LABEL: s_load_u8_from_literal:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; CHECK-NEXT:    s_mov_b64 s[64:65], 0
; CHECK-NEXT:    v_nop
...
define amdgpu_kernel void @s_load_u16_from_literal(ptr addrspace(1) %out) {
; CHECK-LABEL: s_load_u16_from_literal:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; CHECK-NEXT:    s_mov_b64 s[64:65], 0
; CHECK-NEXT:    v_nop
...
define amdgpu_kernel void @s_load_i8_from_literal(ptr addrspace(1) %out) {
; CHECK-LABEL: s_load_i8_from_literal:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; CHECK-NEXT:    s_mov_b64 s[64:65], 0
; CHECK-NEXT:    v_nop
...
define amdgpu_kernel void @s_load_i16_from_literal(ptr addrspace(1) %out) {
; CHECK-LABEL: s_load_i16_from_literal:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; CHECK-NEXT:    s_mov_b64 s[64:65], 0
; CHECK-NEXT:    v_nop
