; RUN: not llc -mtriple=amdgpu9.00 -filetype=null %s 2>&1 | FileCheck %s --check-prefixes=CHECK,SDAG
; RUN: not llc -global-isel=1 -mtriple=amdgpu9.00 -filetype=null %s 2>&1 | FileCheck %s --check-prefixes=CHECK,GISEL
; RUN: not llc -mtriple=amdgpu11.00 -filetype=null %s 2>&1 | FileCheck %s --check-prefixes=CHECK,SDAG
; RUN: not llc -global-isel=1 -mtriple=amdgpu11.00 -filetype=null %s 2>&1 | FileCheck %s --check-prefixes=CHECK,GISEL
