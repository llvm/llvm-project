...
define amdgpu_ps half @tbuffer_load_d16_x(i32 inreg %rsrc) {
; GFX13-PACKED-LABEL: tbuffer_load_d16_x:
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-PACKED-NEXT:    tbuffer_load_d16_format_x v0, v0, s0, null format:[BUF_FMT_32_FLOAT] idxen
...
define amdgpu_ps half @tbuffer_load_d16_xy(i32 inreg %rsrc) {
; GFX13-PACKED-LABEL: tbuffer_load_d16_xy:
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-PACKED-NEXT:    tbuffer_load_d16_format_xy v0, v0, s0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps half @tbuffer_load_d16_xyz(i32 inreg %rsrc) {
; GFX13-PACKED-LABEL: tbuffer_load_d16_xyz:
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-PACKED-NEXT:    tbuffer_load_d16_format_xyz v[0:1], v0, s0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps half @tbuffer_load_d16_xyzw(i32 inreg %rsrc) {
; GFX13-PACKED-LABEL: tbuffer_load_d16_xyzw:
; GFX13-PACKED:       ; %bb.0: ; %main_body
; GFX13-PACKED-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-PACKED-NEXT:    tbuffer_load_d16_format_xyzw v[0:1], v0, s0, null format:[BUF_FMT_32_FLOAT] idxen
; GFX13-PACKED-NEXT:    s_wait_loadcnt 0x0
