...
; GFX1300-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1300-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: sadd64ri:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[2:3], lit64(0x123456789876)
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1300-NEXT:    v_mov_b32_e32 v1, s3
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], s[2:3], v[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: vadd64ri:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v1, 0
; GFX1300-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], lit64(0x123456789876), v[0:1]
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x34
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1300-NEXT:    global_store_b32 v0, v1, s[2:3]
; GFX1300-NEXT:    s_endpgm
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b64 s[6:7], s[4:5], 0x34
; GFX1300-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_add_co_u32 v1, s4, s6, s7
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: suaddo64:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[6:7], s[4:5], s[6:7]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s6
; GFX1300-NEXT:    v_cmp_lt_u64_e64 s4, s[6:7], s[4:5]
; GFX1300-NEXT:    v_mov_b32_e32 v1, s7
...
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], s[6:7], v[0:1]
; GFX1300-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[6:7], v[2:3]
...
; GFX1300-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_nc_u64 s[2:3], s[2:3], s[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1300-NEXT:    v_mov_b32_e32 v1, s3
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: ssub64ri:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_nc_u64 s[2:3], lit64(0x123456789876), s[2:3]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s2
; GFX1300-NEXT:    v_mov_b32_e32 v1, s3
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_sub_nc_u64_e32 v[2:3], s[2:3], v[0:1]
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    s_endpgm
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: vsub64ri:
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v1, 0
; GFX1300-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_sub_nc_u64_e32 v[2:3], lit64(0x123456789876), v[0:1]
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_co_i32 s0, s0, s1
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1300-NEXT:    global_store_b32 v0, v1, s[2:3]
; GFX1300-NEXT:    s_endpgm
...
; GFX1300-NEXT:    v_mov_b32_e32 v0, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    v_sub_co_u32 v1, s4, s6, s7
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s4
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1250-NEXT:    s_endpgm
;
; GFX1300-LABEL: susubo64:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b256 s[0:7], s[4:5], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_nc_u64 s[6:7], s[4:5], s[6:7]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s6
...
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_sub_nc_u64_e32 v[2:3], s[6:7], v[0:1]
; GFX1300-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[6:7], v[2:3]
; GFX1300-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    global_store_b8 v1, v0, s[2:3]
...
; CISI-NEXT:    v_mul_lo_u32 v1, v0, s2
; CISI-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; CISI-NEXT:    v_sub_i32_e32 v1, vcc, s10, v1
; CISI-NEXT:    v_subrev_i32_e32 v3, vcc, s2, v1
; CISI-NEXT:    v_cmp_le_u32_e32 vcc, s2, v1
; CISI-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; CISI-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; CISI-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; CISI-NEXT:    v_cmp_le_u32_e32 vcc, s2, v1
; CISI-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
...
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s11, v2, 0
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s11, v3, 0
; VI-NEXT:    v_add_u32_e32 v0, vcc, v4, v0
; VI-NEXT:    v_addc_u32_e32 v0, vcc, v5, v1, vcc
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v3, vcc
; VI-NEXT:    v_add_u32_e32 v2, vcc, v0, v2
; VI-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
; VI-NEXT:    v_mul_lo_u32 v4, s2, v3
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s2, v2, 0
; VI-NEXT:    v_mul_lo_u32 v5, s3, v2
; VI-NEXT:    v_add_u32_e32 v1, vcc, v4, v1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v5, v1
; VI-NEXT:    v_sub_u32_e32 v4, vcc, s11, v1
; VI-NEXT:    v_mov_b32_e32 v5, s3
; VI-NEXT:    v_sub_u32_e32 v0, vcc, s10, v0
; VI-NEXT:    v_subb_u32_e64 v4, s[0:1], v4, v5, vcc
; VI-NEXT:    v_subrev_u32_e64 v5, s[0:1], s2, v0
; VI-NEXT:    v_subbrev_u32_e64 v4, s[0:1], 0, v4, s[0:1]
; VI-NEXT:    v_cmp_le_u32_e64 s[0:1], s3, v4
; VI-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; VI-NEXT:    v_cmp_le_u32_e64 s[0:1], s2, v5
; VI-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[0:1]
; VI-NEXT:    v_cmp_eq_u32_e64 s[0:1], s3, v4
; VI-NEXT:    v_cndmask_b32_e64 v4, v6, v5, s[0:1]
; VI-NEXT:    v_add_u32_e64 v5, s[0:1], 1, v2
; VI-NEXT:    v_addc_u32_e64 v6, s[0:1], 0, v3, s[0:1]
; VI-NEXT:    v_add_u32_e64 v7, s[0:1], 2, v2
; VI-NEXT:    v_addc_u32_e64 v8, s[0:1], 0, v3, s[0:1]
; VI-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v4
; VI-NEXT:    v_cndmask_b32_e64 v4, v5, v7, s[0:1]
; VI-NEXT:    v_cndmask_b32_e64 v5, v6, v8, s[0:1]
; VI-NEXT:    v_mov_b32_e32 v6, s11
; VI-NEXT:    v_subb_u32_e32 v1, vcc, v6, v1, vcc
; VI-NEXT:    v_cmp_le_u32_e32 vcc, s3, v1
; VI-NEXT:    v_cndmask_b32_e64 v6, 0, -1, vcc
; VI-NEXT:    v_cmp_le_u32_e32 vcc, s2, v0
; VI-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
; VI-NEXT:    v_cmp_eq_u32_e32 vcc, s3, v1
...
; VI-NEXT:    v_mul_lo_u32 v1, v0, s2
; VI-NEXT:    v_add_u32_e32 v2, vcc, 1, v0
; VI-NEXT:    v_sub_u32_e32 v1, vcc, s10, v1
; VI-NEXT:    v_subrev_u32_e32 v3, vcc, s2, v1
; VI-NEXT:    v_cmp_le_u32_e32 vcc, s2, v1
...
; GFX9-NEXT:    v_subrev_co_u32_e64 v5, s[0:1], s2, v3
; GFX9-NEXT:    v_subbrev_co_u32_e64 v4, s[0:1], 0, v4, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s3, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s2, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s3, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v6, v5, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v5, s[0:1], 1, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v5, v7, s[0:1]
...
; GFX9-NEXT:    v_cmp_eq_u32_e32 vcc, s3, v2
...
; GFX9-NEXT:    v_sub_u32_e32 v1, s10, v1
...
; GFX1010-NEXT:    s_sub_u32 s0, 0, s2
; GFX1010-NEXT:    s_subb_u32 s1, 0, s3
...
; GFX1010-NEXT:    v_mul_lo_u32 v2, s0, v1
; GFX1010-NEXT:    v_mul_hi_u32 v3, s0, v0
; GFX1010-NEXT:    v_mul_lo_u32 v4, s1, v0
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v3, v2
; GFX1010-NEXT:    v_mul_lo_u32 v3, s0, v0
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1010-NEXT:    v_mul_hi_u32 v4, v0, v3
; GFX1010-NEXT:    v_mul_lo_u32 v5, v0, v2
; GFX1010-NEXT:    v_mul_hi_u32 v6, v0, v2
; GFX1010-NEXT:    v_mul_hi_u32 v7, v1, v3
; GFX1010-NEXT:    v_mul_lo_u32 v3, v1, v3
; GFX1010-NEXT:    v_mul_hi_u32 v8, v1, v2
; GFX1010-NEXT:    v_mul_lo_u32 v2, v1, v2
; GFX1010-NEXT:    v_add_co_u32 v4, vcc_lo, v4, v5
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, 0, v6, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v3, vcc_lo, v4, v3
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v5, v7, vcc_lo
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v4, vcc_lo, 0, v8, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v2, vcc_lo, v3, v2
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v4, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v3, vcc_lo
; GFX1010-NEXT:    v_mul_hi_u32 v2, s0, v0
; GFX1010-NEXT:    v_mul_lo_u32 v4, s1, v0
; GFX1010-NEXT:    v_mul_lo_u32 v3, s0, v1
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v2, v3
; GFX1010-NEXT:    v_mul_lo_u32 v3, s0, v0
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1010-NEXT:    v_mul_hi_u32 v4, v0, v3
; GFX1010-NEXT:    v_mul_lo_u32 v5, v0, v2
...
; GFX1010-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v3, vcc_lo
; GFX1010-NEXT:    v_mul_hi_u32 v2, s10, v0
; GFX1010-NEXT:    v_mul_hi_u32 v5, s11, v0
; GFX1010-NEXT:    v_mul_lo_u32 v3, s10, v1
; GFX1010-NEXT:    v_mul_hi_u32 v4, s10, v1
; GFX1010-NEXT:    v_mul_lo_u32 v0, s11, v0
; GFX1010-NEXT:    v_mul_hi_u32 v6, s11, v1
; GFX1010-NEXT:    v_mul_lo_u32 v1, s11, v1
; GFX1010-NEXT:    v_add_co_u32 v2, vcc_lo, v2, v3
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v4, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v0, vcc_lo, v2, v0
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v0, vcc_lo, v3, v5, vcc_lo
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, 0, v6, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v1
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v2, vcc_lo
; GFX1010-NEXT:    v_mul_hi_u32 v2, s2, v0
; GFX1010-NEXT:    v_mul_lo_u32 v4, s3, v0
; GFX1010-NEXT:    v_mul_lo_u32 v3, s2, v1
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v2, v3
; GFX1010-NEXT:    v_mul_lo_u32 v3, s2, v0
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1010-NEXT:    v_sub_co_u32 v3, vcc_lo, s10, v3
; GFX1010-NEXT:    v_sub_nc_u32_e32 v4, s11, v2
; GFX1010-NEXT:    v_subrev_co_ci_u32_e64 v4, s0, s3, v4, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v5, s0, v0, 1
; GFX1010-NEXT:    v_add_co_ci_u32_e64 v6, s0, 0, v1, s0
; GFX1010-NEXT:    v_sub_co_u32 v7, s0, v3, s2
; GFX1010-NEXT:    v_sub_co_ci_u32_e32 v2, vcc_lo, s11, v2, vcc_lo
; GFX1010-NEXT:    v_subrev_co_ci_u32_e64 v4, s0, 0, v4, s0
; GFX1010-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v7
; GFX1010-NEXT:    v_cmp_eq_u32_e64 s0, s3, v2
; GFX1010-NEXT:    v_cndmask_b32_e64 v7, 0, -1, vcc_lo
; GFX1010-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v4
; GFX1010-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc_lo
; GFX1010-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v3
; GFX1010-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc_lo
; GFX1010-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v2
; GFX1010-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc_lo
; GFX1010-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s3, v4
; GFX1010-NEXT:    v_cndmask_b32_e64 v2, v9, v3, s0
; GFX1010-NEXT:    v_cndmask_b32_e32 v4, v8, v7, vcc_lo
; GFX1010-NEXT:    v_add_co_u32 v7, vcc_lo, v0, 2
; GFX1010-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, 0, v1, vcc_lo
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v4
; GFX1010-NEXT:    v_cndmask_b32_e32 v3, v5, v7, vcc_lo
; GFX1010-NEXT:    v_cndmask_b32_e32 v4, v6, v8, vcc_lo
; GFX1010-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; GFX1010-NEXT:    v_cndmask_b32_e32 v1, v1, v4, vcc_lo
...
; GFX1010-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1010-NEXT:    s_sub_i32 s0, 0, s2
; GFX1010-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX1010-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX1010-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1010-NEXT:    v_mul_lo_u32 v1, s0, v0
; GFX1010-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX1010-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1010-NEXT:    v_mul_hi_u32 v0, s10, v0
; GFX1010-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX1010-NEXT:    v_add_nc_u32_e32 v2, 1, v0
; GFX1010-NEXT:    v_sub_nc_u32_e32 v1, s10, v1
; GFX1010-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
...
; GFX1030W32-NEXT:    s_sub_u32 s0, 0, s2
; GFX1030W32-NEXT:    s_subb_u32 s1, 0, s3
...
; GFX1030W32-NEXT:    v_mul_lo_u32 v2, s0, v1
; GFX1030W32-NEXT:    v_mul_hi_u32 v3, s0, v0
; GFX1030W32-NEXT:    v_mul_lo_u32 v4, s1, v0
; GFX1030W32-NEXT:    v_add_nc_u32_e32 v2, v3, v2
; GFX1030W32-NEXT:    v_mul_lo_u32 v3, s0, v0
; GFX1030W32-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1030W32-NEXT:    v_mul_hi_u32 v4, v0, v3
; GFX1030W32-NEXT:    v_mul_lo_u32 v5, v0, v2
; GFX1030W32-NEXT:    v_mul_hi_u32 v6, v0, v2
; GFX1030W32-NEXT:    v_mul_hi_u32 v7, v1, v3
; GFX1030W32-NEXT:    v_mul_lo_u32 v3, v1, v3
...
; GFX1030W32-NEXT:    v_mul_hi_u32 v4, s10, v1
; GFX1030W32-NEXT:    v_mul_lo_u32 v0, s11, v0
...
; GFX1030W32-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc_lo
; GFX1030W32-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v3
; GFX1030W32-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc_lo
; GFX1030W32-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v2
; GFX1030W32-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc_lo
; GFX1030W32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s3, v4
...
; GFX1030W32-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v2
; GFX1030W32-NEXT:    v_cndmask_b32_e32 v1, v1, v4, vcc_lo
; GFX1030W32-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc_lo
; GFX1030W32-NEXT:    s_andn2_b32 vcc_lo, exec_lo, s4
; GFX1030W32-NEXT:    s_cbranch_vccnz .LBB16_3
; GFX1030W32-NEXT:  .LBB16_2:
; GFX1030W32-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1030W32-NEXT:    s_sub_i32 s0, 0, s2
; GFX1030W32-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX1030W32-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX1030W32-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1030W32-NEXT:    v_mul_lo_u32 v1, s0, v0
; GFX1030W32-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX1030W32-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1030W32-NEXT:    v_mul_hi_u32 v0, s10, v0
; GFX1030W32-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX1030W32-NEXT:    v_add_nc_u32_e32 v2, 1, v0
; GFX1030W32-NEXT:    v_sub_nc_u32_e32 v1, s10, v1
; GFX1030W32-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
; GFX1030W32-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1030W32-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc_lo
; GFX1030W32-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc_lo
; GFX1030W32-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1030W32-NEXT:    v_add_nc_u32_e32 v2, 1, v0
...
; GFX1030W64-NEXT:    s_sub_u32 s0, 0, s2
; GFX1030W64-NEXT:    s_subb_u32 s1, 0, s3
...
; GFX1030W64-NEXT:    v_mul_lo_u32 v2, s0, v1
; GFX1030W64-NEXT:    v_mul_hi_u32 v3, s0, v0
; GFX1030W64-NEXT:    v_mul_lo_u32 v4, s1, v0
; GFX1030W64-NEXT:    v_add_nc_u32_e32 v2, v3, v2
; GFX1030W64-NEXT:    v_mul_lo_u32 v3, s0, v0
; GFX1030W64-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1030W64-NEXT:    v_mul_hi_u32 v4, v0, v3
; GFX1030W64-NEXT:    v_mul_lo_u32 v5, v0, v2
; GFX1030W64-NEXT:    v_mul_hi_u32 v6, v0, v2
; GFX1030W64-NEXT:    v_mul_hi_u32 v7, v1, v3
; GFX1030W64-NEXT:    v_mul_lo_u32 v3, v1, v3
...
; GFX1030W64-NEXT:    v_mul_hi_u32 v4, s10, v1
; GFX1030W64-NEXT:    v_mul_lo_u32 v0, s11, v0
...
; GFX1030W64-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; GFX1030W64-NEXT:    v_cmp_le_u32_e32 vcc, s2, v3
; GFX1030W64-NEXT:    v_cndmask_b32_e64 v3, 0, -1, vcc
; GFX1030W64-NEXT:    v_cmp_le_u32_e32 vcc, s3, v2
; GFX1030W64-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc
; GFX1030W64-NEXT:    v_cmp_eq_u32_e32 vcc, s3, v4
...
; GFX1030W64-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GFX1030W64-NEXT:    v_cndmask_b32_e32 v1, v1, v4, vcc
; GFX1030W64-NEXT:    v_cndmask_b32_e32 v0, v0, v3, vcc
; GFX1030W64-NEXT:    s_cbranch_execnz .LBB16_3
; GFX1030W64-NEXT:  .LBB16_2:
; GFX1030W64-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1030W64-NEXT:    s_sub_i32 s0, 0, s2
; GFX1030W64-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX1030W64-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX1030W64-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1030W64-NEXT:    v_mul_lo_u32 v1, s0, v0
; GFX1030W64-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX1030W64-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1030W64-NEXT:    v_mul_hi_u32 v0, s10, v0
; GFX1030W64-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX1030W64-NEXT:    v_add_nc_u32_e32 v2, 1, v0
; GFX1030W64-NEXT:    v_sub_nc_u32_e32 v1, s10, v1
; GFX1030W64-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
; GFX1030W64-NEXT:    v_cmp_le_u32_e32 vcc, s2, v1
; GFX1030W64-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GFX1030W64-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX1030W64-NEXT:    v_cmp_le_u32_e32 vcc, s2, v1
; GFX1030W64-NEXT:    v_add_nc_u32_e32 v2, 1, v0
...
; GFX11-NEXT:    s_sub_u32 s0, 0, s2
; GFX11-NEXT:    s_subb_u32 s1, 0, s3
...
; GFX11-NEXT:    v_mul_lo_u32 v2, s0, v1
; GFX11-NEXT:    v_mul_hi_u32 v3, s0, v0
...
; GFX11-NEXT:    v_mul_lo_u32 v3, v1, v3
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX11-NEXT:    v_add_nc_u32_e32 v2, 1, v0
; GFX11-NEXT:    v_sub_nc_u32_e32 v1, s10, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX11-NEXT:    v_dual_cndmask_b32 v1, v1, v3 :: v_dual_cndmask_b32 v0, v0, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX11-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v2, 1, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:    v_mov_b32_e32 v7, 0
...
; GFX1250-NEXT:    s_add_co_ci_u32 s0, s5, s13
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_mov_b32_e32 v1, s0
; GFX1250-NEXT:    v_mul_u64_e32 v[2:3], s[6:7], v[0:1]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_mul_hi_u32 v5, v0, v3
; GFX1250-NEXT:    v_mul_lo_u32 v4, v0, v3
; GFX1250-NEXT:    v_mul_hi_u32 v6, v0, v2
; GFX1250-NEXT:    v_mul_lo_u32 v1, s0, v2
; GFX1250-NEXT:    v_mul_hi_u32 v8, s0, v2
; GFX1250-NEXT:    v_mul_hi_u32 v9, s0, v3
; GFX1250-NEXT:    v_mul_lo_u32 v2, s0, v3
; GFX1250-NEXT:    v_add_nc_u64_e32 v[4:5], v[6:7], v[4:5]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_add_co_u32 v1, vcc_lo, v1, v4
; GFX1250-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v5, v8, vcc_lo
; GFX1250-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v9, vcc_lo
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_add_nc_u64_e32 v[2:3], v[6:7], v[2:3]
; GFX1250-NEXT:    v_add_co_u32 v2, vcc_lo, v0, v2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s0, v3, vcc_lo
; GFX1250-NEXT:    v_mul_hi_u32 v6, s10, v2
; GFX1250-NEXT:    v_mul_lo_u32 v4, s11, v2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_4) | instid1(VALU_DEP_4)
; GFX1250-NEXT:    v_mul_hi_u32 v1, s10, v3
; GFX1250-NEXT:    v_mul_lo_u32 v0, s10, v3
; GFX1250-NEXT:    v_mul_hi_u32 v5, s11, v2
; GFX1250-NEXT:    v_mul_hi_u32 v8, s11, v3
; GFX1250-NEXT:    v_mul_lo_u32 v2, s11, v3
; GFX1250-NEXT:    v_add_nc_u64_e32 v[0:1], v[6:7], v[0:1]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v4
; GFX1250-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v1, v5, vcc_lo
; GFX1250-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v8, vcc_lo
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_add_nc_u64_e32 v[0:1], v[6:7], v[2:3]
; GFX1250-NEXT:    v_mul_u64_e32 v[2:3], s[2:3], v[0:1]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_sub_nc_u32_e32 v4, s11, v3
; GFX1250-NEXT:    v_sub_co_u32 v2, vcc_lo, s10, v2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_subrev_co_ci_u32_e64 v4, s0, s3, v4, vcc_lo
; GFX1250-NEXT:    v_sub_co_u32 v6, s0, v2, s2
; GFX1250-NEXT:    v_sub_co_ci_u32_e32 v9, vcc_lo, s11, v3, vcc_lo
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_subrev_co_ci_u32_e64 v7, s0, 0, v4, s0
; GFX1250-NEXT:    v_cmp_le_u32_e64 s0, s2, v6
; GFX1250-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v2
; GFX1250-NEXT:    v_add_nc_u64_e32 v[4:5], 1, v[0:1]
; GFX1250-NEXT:    v_add_nc_u64_e32 v[2:3], 2, v[0:1]
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s0
; GFX1250-NEXT:    v_cmp_le_u32_e64 s0, s3, v7
; GFX1250-NEXT:    v_cndmask_b32_e64 v10, 0, -1, vcc_lo
; GFX1250-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s3, v7
; GFX1250-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s0
; GFX1250-NEXT:    v_cmp_eq_u32_e64 s0, s3, v9
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_cndmask_b32_e32 v6, v8, v6, vcc_lo
; GFX1250-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v9
...
; GFX1250-NEXT:    v_dual_cndmask_b32 v6, v7, v10, s0 :: v_dual_cndmask_b32 v3, v5, v3, vcc_lo
; GFX1250-NEXT:    v_cndmask_b32_e32 v2, v4, v2, vcc_lo
; GFX1250-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-NEXT:    v_dual_cndmask_b32 v1, v1, v3 :: v_dual_cndmask_b32 v0, v0, v2
; GFX1250-NEXT:    s_cbranch_execnz .LBB16_3
; GFX1250-NEXT:  .LBB16_2:
; GFX1250-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1250-NEXT:    s_sub_co_i32 s0, 0, s2
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX1250-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_mul_hi_u32 v0, s10, v0
; GFX1250-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_add_nc_u32 v2, 1, v0 :: v_dual_sub_nc_u32 v1, s10, v1
; GFX1250-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
; GFX1250-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_cndmask_b32 v1, v1, v3 :: v_dual_cndmask_b32 v0, v0, v2
; GFX1250-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v2, 1, v0
; GFX1250-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc_lo
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b128 s[8:11], s[4:5], 0x24
; GFX1300-NEXT:    s_load_b64 s[2:3], s[4:5], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_or_b64 s[0:1], s[10:11], s[2:3]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_and_b64 s[0:1], s[0:1], lit64(0xffffffff00000000)
; GFX1300-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1300-NEXT:    s_cbranch_scc0 .LBB16_4
; GFX1300-NEXT:  ; %bb.1:
; GFX1300-NEXT:    s_cvt_f32_u32 s0, s2
...
; GFX1300-NEXT:    s_cvt_u32_f32 s4, s0
; GFX1300-NEXT:    s_mul_u64 s[12:13], s[6:7], s[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_hi_u32 s15, s4, s13
; GFX1300-NEXT:    s_mul_i32 s14, s4, s13
; GFX1300-NEXT:    s_mul_hi_u32 s0, s4, s12
; GFX1300-NEXT:    s_mul_i32 s17, s5, s12
; GFX1300-NEXT:    s_add_nc_u64 s[14:15], s[0:1], s[14:15]
; GFX1300-NEXT:    s_mul_hi_u32 s16, s5, s12
; GFX1300-NEXT:    s_mul_hi_u32 s18, s5, s13
; GFX1300-NEXT:    s_add_co_u32 s0, s14, s17
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s15, s16
; GFX1300-NEXT:    s_mul_i32 s12, s5, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s13, s18, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1300-NEXT:    v_add_co_u32 v6, s0, s4, s12
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s5, s13
; GFX1300-NEXT:    v_mul_lo_u32 v0, v6, s7
; GFX1300-NEXT:    v_mul_lo_u32 v1, s0, s6
; GFX1300-NEXT:    v_mul_hi_u32 v2, v6, s6
; GFX1300-NEXT:    v_mul_lo_u32 v4, v6, s6
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v0, v0, v1
; GFX1300-NEXT:    v_mul_lo_u32 v7, s0, v4
; GFX1300-NEXT:    v_mul_hi_u32 v8, s0, v4
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_add_nc_u32_e32 v5, v0, v2
; GFX1300-NEXT:    v_mul_hi_u32 v0, v6, v4
; GFX1300-NEXT:    v_mul_hi_u32 v3, v6, v5
; GFX1300-NEXT:    v_mul_lo_u32 v2, v6, v5
; GFX1300-NEXT:    v_mul_hi_u32 v9, s0, v5
; GFX1300-NEXT:    v_mul_lo_u32 v4, s0, v5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], v[0:1], v[2:3]
; GFX1300-NEXT:    v_add_co_u32 v0, vcc_lo, v7, v2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v0, vcc_lo, v3, v8, vcc_lo
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, 0, v9, vcc_lo
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], v[0:1], v[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_add_co_u32 v4, vcc_lo, v6, v2
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, s0, v3, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_mul_hi_u32 v0, s10, v4
; GFX1300-NEXT:    v_mul_lo_u32 v6, s11, v4
; GFX1300-NEXT:    v_mul_hi_u32 v3, s10, v5
; GFX1300-NEXT:    v_mul_lo_u32 v2, s10, v5
; GFX1300-NEXT:    v_mul_hi_u32 v7, s11, v4
; GFX1300-NEXT:    v_mul_hi_u32 v8, s11, v5
; GFX1300-NEXT:    v_mul_lo_u32 v4, s11, v5
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], v[0:1], v[2:3]
; GFX1300-NEXT:    v_add_co_u32 v0, vcc_lo, v2, v6
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v0, vcc_lo, v3, v7, vcc_lo
; GFX1300-NEXT:    v_add_co_ci_u32_e32 v5, vcc_lo, 0, v8, vcc_lo
; GFX1300-NEXT:    v_add_nc_u64_e32 v[0:1], v[0:1], v[4:5]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_mul_lo_u32 v2, v0, s3
; GFX1300-NEXT:    v_mul_lo_u32 v3, v1, s2
; GFX1300-NEXT:    v_mul_hi_u32 v4, v0, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_add_nc_u32_e32 v2, v2, v3
; GFX1300-NEXT:    v_mul_lo_u32 v3, v0, s2
; GFX1300-NEXT:    v_add_nc_u32_e32 v2, v2, v4
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_sub_co_u32 v3, vcc_lo, s10, v3
; GFX1300-NEXT:    v_sub_nc_u32_e32 v4, s11, v2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_subrev_co_ci_u32_e64 v4, s0, s3, v4, vcc_lo
; GFX1300-NEXT:    v_sub_co_u32 v5, s0, v3, s2
; GFX1300-NEXT:    v_sub_co_ci_u32_e32 v7, vcc_lo, s11, v2, vcc_lo
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_subrev_co_ci_u32_e64 v4, s0, 0, v4, s0
; GFX1300-NEXT:    v_cmp_le_u32_e64 s0, s2, v5
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v3
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], 1, v[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s0
; GFX1300-NEXT:    v_cmp_le_u32_e64 s0, s3, v4
; GFX1300-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc_lo
; GFX1300-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s3, v4
; GFX1300-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s0
; GFX1300-NEXT:    v_cmp_eq_u32_e64 s0, s3, v7
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_cndmask_b32_e32 v6, v6, v5, vcc_lo
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v7
; GFX1300-NEXT:    v_add_nc_u64_e32 v[4:5], 2, v[0:1]
; GFX1300-NEXT:    v_cndmask_b32_e64 v9, 0, -1, vcc_lo
; GFX1300-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_dual_cndmask_b32 v3, v3, v5 :: v_dual_cndmask_b32 v2, v2, v4
; GFX1300-NEXT:    v_cndmask_b32_e64 v6, v9, v8, s0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v6
; GFX1300-NEXT:    v_dual_cndmask_b32 v1, v1, v3 :: v_dual_cndmask_b32 v0, v0, v2
; GFX1300-NEXT:    s_cbranch_execnz .LBB16_3
; GFX1300-NEXT:  .LBB16_2:
; GFX1300-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1300-NEXT:    s_sub_co_i32 s0, 0, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1300-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX1300-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1300-NEXT:    v_mul_lo_u32 v1, s0, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX1300-NEXT:    v_add_nc_u32_e32 v0, v0, v1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_mul_hi_u32 v0, s10, v0
; GFX1300-NEXT:    v_mul_lo_u32 v1, v0, s2
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_dual_add_nc_u32 v2, 1, v0 :: v_dual_sub_nc_u32 v1, s10, v1
; GFX1300-NEXT:    v_subrev_nc_u32_e32 v3, s2, v1
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_dual_cndmask_b32 v1, v1, v3 :: v_dual_cndmask_b32 v0, v0, v2
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v2, 1, v0
; GFX1300-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc_lo
; GFX1300-NEXT:  .LBB16_3:
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[8:9]
; GFX1300-NEXT:    s_endpgm
; GFX1300-NEXT:  .LBB16_4:
; GFX1300-NEXT:    ; implicit-def: $vgpr0_vgpr1
