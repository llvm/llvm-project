...
; GFX1210-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[4:5]
...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x34
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b64 s[6:7], s[4:5], 0x34
; GFX1210-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_add_co_u32 v1, s4, s6, s7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1210-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[6:7], v[2:3]
...
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_nc_u64 s[2:3], s[2:3], s[4:5]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_sub_co_u32 v1, s4, s6, s7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s4
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_sub_nc_u64_e32 v[2:3], s[6:7], v[0:1]
; GFX1210-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[6:7], v[2:3]
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1210-NEXT:    global_store_b8 v1, v0, s[2:3]
...
; GFX1210-NEXT:    s_load_b64 s[2:3], s[4:5], 0x34
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_or_b64 s[0:1], s[10:11], s[2:3]
...
; GFX1210-NEXT:    s_sub_nc_u64 s[6:7], 0, s[2:3]
...
; GFX1210-NEXT:    s_cvt_u32_f32 s5, s1
; GFX1210-NEXT:    s_mov_b32 s1, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cvt_u32_f32 s4, s0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_u64 s[12:13], s[6:7], s[4:5]
; GFX1210-NEXT:    s_mul_hi_u32 s15, s4, s13
; GFX1210-NEXT:    s_mul_i32 s14, s4, s13
; GFX1210-NEXT:    s_mul_hi_u32 s0, s4, s12
; GFX1210-NEXT:    s_mul_i32 s17, s5, s12
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[14:15], s[0:1], s[14:15]
; GFX1210-NEXT:    s_mul_hi_u32 s16, s5, s12
; GFX1210-NEXT:    s_mul_hi_u32 s18, s5, s13
; GFX1210-NEXT:    s_add_co_u32 s0, s14, s17
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s15, s16
; GFX1210-NEXT:    s_mul_i32 s12, s5, s13
...
; GFX1210-NEXT:    v_add_co_u32 v0, s0, s4, s12
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_add_co_ci_u32 s5, s5, s13
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_readfirstlane_b32 s4, v0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_u64 s[6:7], s[6:7], s[4:5]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_hi_u32 s13, s4, s7
; GFX1210-NEXT:    s_mul_i32 s12, s4, s7
; GFX1210-NEXT:    s_mul_hi_u32 s0, s4, s6
; GFX1210-NEXT:    s_mul_i32 s15, s5, s6
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1210-NEXT:    s_mul_hi_u32 s14, s5, s6
; GFX1210-NEXT:    s_mul_hi_u32 s4, s5, s7
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_co_u32 s0, s12, s15
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s13, s14
; GFX1210-NEXT:    s_mul_i32 s6, s5, s7
; GFX1210-NEXT:    s_add_co_ci_u32 s7, s4, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[6:7], s[0:1], s[6:7]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_u32 v0, s0, v0, s6
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s5, s7
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_readfirstlane_b32 s7, v0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_hi_u32 s5, s10, s0
; GFX1210-NEXT:    s_mul_i32 s4, s10, s0
; GFX1210-NEXT:    s_mul_hi_u32 s12, s11, s0
; GFX1210-NEXT:    s_mul_i32 s6, s11, s0
; GFX1210-NEXT:    s_mul_hi_u32 s0, s10, s7
; GFX1210-NEXT:    s_mul_i32 s13, s11, s7
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[4:5], s[0:1], s[4:5]
; GFX1210-NEXT:    s_mul_hi_u32 s0, s11, s7
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_co_u32 s4, s4, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s5, s0
; GFX1210-NEXT:    s_add_co_ci_u32 s7, s12, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[4:5], s[0:1], s[6:7]
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_b64 s[6:7], s[4:5], 0xffffffff00000000
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_or_b32 s6, s6, s4
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_u64 s[4:5], s[2:3], s[6:7]
; GFX1210-NEXT:    s_add_nc_u64 s[14:15], s[6:7], 2
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_sub_co_u32 v0, s0, s10, s4
; GFX1210-NEXT:    s_sub_co_i32 s4, s11, s5
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_ci_u32 s4, s4, s3
; GFX1210-NEXT:    s_cmp_lg_u32 s12, 0
; GFX1210-NEXT:    s_add_nc_u64 s[12:13], s[6:7], 1
; GFX1210-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_ci_u32 s4, s4, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cmp_ge_u32 s4, s3
; GFX1210-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX1210-NEXT:    s_cselect_b32 s14, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s4, s3
...
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_cndmask_b32_e32 v1, s7, v1, vcc_lo
; GFX1210-NEXT:    v_cndmask_b32_e32 v0, s6, v2, vcc_lo
...
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_hi_u32 s0, s10, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_i32 s1, s0, s2
; GFX1210-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_i32 s1, s10, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_i32 s4, s1, s2
; GFX1210-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1210-NEXT:    s_cselect_b32 s0, s3, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cselect_b32 s1, s4, s1
; GFX1210-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1210-NEXT:    s_mov_b32 s1, 0
...
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[8:9]
; GFX1210-NEXT:    s_endpgm
...
; GFX1300-NEXT:    v_add_co_u32 v0, s0, s4, s12
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s5, s5, s13
; GFX1300-NEXT:    v_readfirstlane_b32 s4, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_u64 s[6:7], s[6:7], s[4:5]
; GFX1300-NEXT:    s_mul_hi_u32 s13, s4, s7
; GFX1300-NEXT:    s_mul_i32 s12, s4, s7
; GFX1300-NEXT:    s_mul_hi_u32 s0, s4, s6
; GFX1300-NEXT:    s_mul_i32 s15, s5, s6
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1300-NEXT:    s_mul_hi_u32 s14, s5, s6
; GFX1300-NEXT:    s_mul_hi_u32 s4, s5, s7
; GFX1300-NEXT:    s_add_co_u32 s0, s12, s15
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s13, s14
; GFX1300-NEXT:    s_mul_i32 s6, s5, s7
; GFX1300-NEXT:    s_add_co_ci_u32 s7, s4, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[6:7], s[0:1], s[6:7]
; GFX1300-NEXT:    v_add_co_u32 v0, s0, v0, s6
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s5, s7
; GFX1300-NEXT:    v_readfirstlane_b32 s7, v0
; GFX1300-NEXT:    s_mul_hi_u32 s5, s10, s0
; GFX1300-NEXT:    s_mul_i32 s4, s10, s0
; GFX1300-NEXT:    s_mul_hi_u32 s12, s11, s0
; GFX1300-NEXT:    s_mul_i32 s6, s11, s0
; GFX1300-NEXT:    s_mul_hi_u32 s0, s10, s7
; GFX1300-NEXT:    s_mul_i32 s13, s11, s7
; GFX1300-NEXT:    s_add_nc_u64 s[4:5], s[0:1], s[4:5]
; GFX1300-NEXT:    s_mul_hi_u32 s0, s11, s7
; GFX1300-NEXT:    s_add_co_u32 s4, s4, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s5, s0
; GFX1300-NEXT:    s_add_co_ci_u32 s7, s12, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[4:5], s[0:1], s[6:7]
; GFX1300-NEXT:    s_and_b64 s[6:7], s[4:5], 0xffffffff00000000
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_or_b32 s6, s6, s4
; GFX1300-NEXT:    s_mul_u64 s[4:5], s[2:3], s[6:7]
; GFX1300-NEXT:    s_add_nc_u64 s[14:15], s[6:7], 2
; GFX1300-NEXT:    v_sub_co_u32 v0, s0, s10, s4
; GFX1300-NEXT:    s_sub_co_i32 s4, s11, s5
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
...
; GFX1300-NEXT:    s_sub_co_ci_u32 s4, s4, s3
; GFX1300-NEXT:    s_cmp_lg_u32 s12, 0
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[6:7], 1
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1300-NEXT:    s_sub_co_ci_u32 s4, s4, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_cmp_ge_u32 s4, s3
; GFX1300-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX1300-NEXT:    s_cselect_b32 s14, -1, 0
; GFX1300-NEXT:    s_cmp_eq_u32 s4, s3
...
; GFX1300-NEXT:    s_sub_co_ci_u32 s0, s11, s5
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_cmp_ge_u32 s0, s3
; GFX1300-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
; GFX1300-NEXT:    s_cselect_b32 s4, -1, 0
...
; GFX1300-NEXT:    v_cndmask_b32_e64 v0, s4, v0, s0
...
; GFX1300-NEXT:    v_cndmask_b32_e32 v1, s7, v1, vcc_lo
; GFX1300-NEXT:    v_cndmask_b32_e32 v0, s6, v2, vcc_lo
...
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1300-NEXT:    s_mul_hi_u32 s0, s10, s0
...
; GFX1300-NEXT:    s_sub_co_i32 s1, s10, s1
; GFX1300-NEXT:    s_sub_co_i32 s4, s1, s2
; GFX1300-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1300-NEXT:    s_cselect_b32 s0, s3, s0
; GFX1300-NEXT:    s_cselect_b32 s1, s4, s1
; GFX1300-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1300-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1300-NEXT:    s_mov_b32 s1, 0
; GFX1300-NEXT:    s_cselect_b32 s0, s3, s0
