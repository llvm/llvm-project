...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x34
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b64 s[2:3], s[0:1], 0x34
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s3
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_co_i32 s2, s2, s3
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    s_load_b64 s[4:5], s[0:1], 0x34
; GFX1210-NEXT:    s_load_b128 s[0:3], s[0:1], 0x24
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b256 s[0:7], s[0:1], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_co_i32 s2, s2, s3
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1300-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_co_i32 s2, s2, s3
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX1300-NEXT:    global_store_b32 v0, v1, s[0:1]
; GFX1300-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; GFX1210-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX1210-NEXT:    s_mul_f32 s0, s0, 0x5f7ffffc
; GFX1210-NEXT:    s_mul_f32 s1, s0, 0x2f800000
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(SALU_CYCLE_3)
...
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
...
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
...
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
