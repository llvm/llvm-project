...
; GCN-ISEL-NEXT:   [[S_CSELECT_B32_:%[0-9]+]]:sreg_32 = S_CSELECT_B32 1, 0, implicit $scc
; GCN-ISEL-NEXT:   [[COPY14:%[0-9]+]]:vgpr_32 = COPY [[S_CSELECT_B32_]]
; GCN-ISEL-NEXT:   BUFFER_STORE_BYTE_OFFSET killed [[COPY14]], killed [[REG_SEQUENCE3]], 0, 0, 0, 0, implicit $exec :: (store (s8) into %ir.3, addrspace 1)
; GCN-ISEL-NEXT:   S_ENDPGM 0
...
; GCN-ISEL-NEXT:   [[COPY31:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U]].sub1
...
; GCN-ISEL-NEXT:   [[S_ADD_U32_:%[0-9]+]]:sreg_32 = S_ADD_U32 killed [[COPY30]], killed [[COPY33]], implicit-def $scc
; GCN-ISEL-NEXT:   [[S_ADDC_U32_:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY31]], killed [[COPY34]], implicit-def $scc, implicit $scc
; GCN-ISEL-NEXT:   [[COPY35:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_5]]
; GCN-ISEL-NEXT:   [[S_ADDC_U32_1:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY35]], [[S_MOV_B32_10]], implicit-def dead $scc, implicit $scc
...
; GCN-ISEL-NEXT:   [[S_UADDO:%[0-9]+]]:sreg_32, [[S_UADDO1:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO [[COPY39]], killed [[COPY38]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY40:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U1]].sub1
; GCN-ISEL-NEXT:   [[COPY41:%[0-9]+]]:sreg_32 = COPY [[V_CVT_U32_F32_e64_1]]
; GCN-ISEL-NEXT:   [[S_ADD_C:%[0-9]+]]:sreg_32, [[S_ADD_C1:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO [[COPY41]], killed [[COPY40]], killed [[S_UADDO1]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_8:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY25]], [[S_ADD_C]]
; GCN-ISEL-NEXT:   [[COPY42:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_7:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY25]], [[COPY42]], implicit $exec
; GCN-ISEL-NEXT:   [[COPY43:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_7]]
; GCN-ISEL-NEXT:   [[S_ADD_I32_5:%[0-9]+]]:sreg_32 = S_ADD_I32 killed [[COPY43]], killed [[S_MUL_I32_8]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_9:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY23]], [[S_UADDO]]
; GCN-ISEL-NEXT:   [[S_ADD_I32_6:%[0-9]+]]:sreg_32 = S_ADD_I32 killed [[S_ADD_I32_5]], killed [[S_MUL_I32_9]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY44:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_I32_6]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_8:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_ADD_C]], [[COPY44]], implicit $exec
; GCN-ISEL-NEXT:   [[S_MUL_I32_10:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY25]], [[S_UADDO]]
; GCN-ISEL-NEXT:   [[COPY45:%[0-9]+]]:vgpr_32 = COPY [[S_MUL_I32_10]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_9:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_ADD_C]], [[COPY45]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY46:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE10]].sub0
; GCN-ISEL-NEXT:   [[COPY47:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE10]].sub1
; GCN-ISEL-NEXT:   [[COPY48:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_I32_6]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_10:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_UADDO]], [[COPY48]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY49:%[0-9]+]]:vgpr_32 = COPY [[S_MUL_I32_10]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_11:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_UADDO]], [[COPY49]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY50:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U2]].sub0
; GCN-ISEL-NEXT:   [[COPY51:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U2]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_U32_1:%[0-9]+]]:sreg_32 = S_ADD_U32 killed [[COPY50]], killed [[COPY46]], implicit-def $scc
; GCN-ISEL-NEXT:   [[S_ADDC_U32_2:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY51]], killed [[COPY47]], implicit-def $scc, implicit $scc
; GCN-ISEL-NEXT:   [[COPY52:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_8]]
; GCN-ISEL-NEXT:   [[S_ADDC_U32_3:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY52]], [[S_MOV_B32_10]], implicit-def dead $scc, implicit $scc
...
; GCN-ISEL-NEXT:   [[COPY53:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE14]].sub1
; GCN-ISEL-NEXT:   [[REG_SEQUENCE15:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY53]], %subreg.sub0, [[S_MOV_B32_10]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[S_UADDO2:%[0-9]+]]:sreg_32, [[S_UADDO3:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO [[S_UADDO]], killed [[COPY54]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY55:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U3]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_C2:%[0-9]+]]:sreg_32, [[S_ADD_C3:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO [[S_ADD_C]], killed [[COPY55]], killed [[S_UADDO3]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY56:%[0-9]+]]:sreg_32 = COPY [[COPY8]].sub0
; GCN-ISEL-NEXT:   [[COPY57:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_C2]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_12:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY56]], [[COPY57]], implicit $exec
; GCN-ISEL-NEXT:   [[S_MUL_I32_14:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY56]], [[S_ADD_C2]]
...
; GCN-ISEL-NEXT:   [[COPY58:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO2]]
...
; GCN-ISEL-NEXT:   [[COPY60:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U4]].sub1
; GCN-ISEL-NEXT:   [[COPY61:%[0-9]+]]:sreg_32 = COPY [[COPY8]].sub1
; GCN-ISEL-NEXT:   [[COPY62:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_C2]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_14:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY61]], [[COPY62]], implicit $exec
; GCN-ISEL-NEXT:   [[COPY63:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO2]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_15:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY61]], [[COPY63]], implicit $exec
; GCN-ISEL-NEXT:   [[S_MUL_I32_15:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY61]], [[S_UADDO2]]
...
; GCN-ISEL-NEXT:   [[COPY64:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE18]].sub0
; GCN-ISEL-NEXT:   [[COPY65:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE18]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_U32_2:%[0-9]+]]:sreg_32 = S_ADD_U32 killed [[COPY59]], killed [[COPY64]], implicit-def $scc
; GCN-ISEL-NEXT:   [[S_ADDC_U32_4:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY60]], killed [[COPY65]], implicit-def $scc, implicit $scc
; GCN-ISEL-NEXT:   [[COPY66:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_14]]
; GCN-ISEL-NEXT:   [[S_ADDC_U32_5:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY66]], [[S_MOV_B32_10]], implicit-def dead $scc, implicit $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_16:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY61]], [[S_ADD_C2]]
