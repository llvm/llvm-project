...
; CISI-NEXT:    s_and_b32 s4, vcc_lo, 1
...
; GFX9-NEXT:    s_and_b32 s0, vcc_lo, 1
; GFX9-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX1010-NEXT:    s_and_b32 s4, s4, 1
...
; GFX1030W32-NEXT:    s_and_b32 s4, s4, 1
...
; GFX1030W64-NEXT:    s_and_b32 s4, s4, 1
...
; GCN-ISEL-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[V_ADD_CO_U32_e64_1]].sub0
; GCN-ISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY12]], 1, implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_AND_B32_]]
; GCN-ISEL-NEXT:   BUFFER_STORE_BYTE_OFFSET killed [[COPY13]], killed [[REG_SEQUENCE3]], 0, 0, 0, 0, implicit $exec :: (store (s8) into %ir.3, addrspace 1)
; GCN-ISEL-NEXT:   S_ENDPGM 0
  %uadd = call { i32, i1 } @llvm.uadd.with.overflow.i32(i32 %a, i32 %b)
  %val = extractvalue { i32, i1 } %uadd, 0
  %carry = extractvalue { i32, i1 } %uadd, 1
...
; GFX1010-NEXT:    s_and_b32 s0, s2, 1
...
; GFX1030W32-NEXT:    s_and_b32 s4, s6, 1
...
; GFX1250-NEXT:    s_and_b32 s0, s2, 1
; GFX1250-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GCN-ISEL-NEXT:   [[COPY14:%[0-9]+]]:sreg_32 = COPY [[S_ADD_C1]].sub0
; GCN-ISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY14]], 1, implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[S_AND_B32_]]
; GCN-ISEL-NEXT:   BUFFER_STORE_BYTE_OFFSET killed [[COPY15]], killed [[REG_SEQUENCE3]], 0, 0, 0, 0, implicit $exec :: (store (s8) into %ir.3, addrspace 1)
; GCN-ISEL-NEXT:   S_ENDPGM 0
...
; GCN-ISEL-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[V_SUB_CO_U32_e64_1]].sub0
; GCN-ISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY12]], 1, implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_AND_B32_]]
; GCN-ISEL-NEXT:   BUFFER_STORE_BYTE_OFFSET killed [[COPY13]], killed [[REG_SEQUENCE3]], 0, 0, 0, 0, implicit $exec :: (store (s8) into %ir.3, addrspace 1)
; GCN-ISEL-NEXT:   S_ENDPGM 0
...
; GCN-ISEL-NEXT:   [[COPY13:%[0-9]+]]:vreg_64 = COPY [[REG_SEQUENCE4]]
; GCN-ISEL-NEXT:   BUFFER_STORE_DWORDX2_OFFSET killed [[COPY13]], killed [[REG_SEQUENCE1]], 0, 0, 0, 0, implicit $exec :: (store (s64) into %ir.2, addrspace 1)
; GCN-ISEL-NEXT:   [[COPY14:%[0-9]+]]:sreg_32 = COPY [[S_SUB_C1]].sub0
; GCN-ISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY14]], 1, implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY15:%[0-9]+]]:vgpr_32 = COPY [[S_AND_B32_]]
; GCN-ISEL-NEXT:   BUFFER_STORE_BYTE_OFFSET killed [[COPY15]], killed [[REG_SEQUENCE3]], 0, 0, 0, 0, implicit $exec :: (store (s8) into %ir.3, addrspace 1)
; GCN-ISEL-NEXT:   S_ENDPGM 0
...
; CISI-NEXT:    s_bitcmp0_b32 s4, 0
; CISI-NEXT:    s_cbranch_scc1 .LBB16_3
; CISI-NEXT:  .LBB16_2:
; CISI-NEXT:    v_cvt_f32_u32_e32 v0, s2
...
; VI-NEXT:    s_addc_u32 s7, 0, s8
; VI-NEXT:    s_mul_i32 s8, s4, s7
; VI-NEXT:    v_readfirstlane_b32 s9, v1
; VI-NEXT:    s_add_i32 s8, s9, s8
; VI-NEXT:    s_mul_i32 s9, s5, s10
; VI-NEXT:    s_add_i32 s11, s8, s9
; VI-NEXT:    s_sub_i32 s12, s3, s11
; VI-NEXT:    v_readfirstlane_b32 s8, v0
; VI-NEXT:    s_sub_u32 s13, s2, s8
; VI-NEXT:    s_cselect_b64 s[8:9], -1, 0
; VI-NEXT:    s_subb_u32 s12, s12, s5
; VI-NEXT:    s_sub_u32 s14, s13, s4
; VI-NEXT:    s_subb_u32 s12, s12, 0
; VI-NEXT:    s_cmp_ge_u32 s12, s5
; VI-NEXT:    s_cselect_b32 s15, -1, 0
; VI-NEXT:    s_cmp_ge_u32 s14, s4
; VI-NEXT:    s_cselect_b32 s14, -1, 0
; VI-NEXT:    s_cmp_eq_u32 s12, s5
; VI-NEXT:    s_cselect_b32 s12, s14, s15
; VI-NEXT:    s_add_u32 s14, s10, 1
; VI-NEXT:    s_addc_u32 s15, s7, 0
; VI-NEXT:    s_add_u32 s16, s10, 2
; VI-NEXT:    s_addc_u32 s17, s7, 0
; VI-NEXT:    s_cmp_lg_u32 s12, 0
; VI-NEXT:    s_cselect_b32 s12, s16, s14
; VI-NEXT:    s_cselect_b32 s14, s17, s15
; VI-NEXT:    s_cmp_lg_u64 s[8:9], 0
; VI-NEXT:    s_subb_u32 s3, s3, s11
; VI-NEXT:    s_cmp_ge_u32 s3, s5
; VI-NEXT:    s_cselect_b32 s8, -1, 0
; VI-NEXT:    s_cmp_ge_u32 s13, s4
; VI-NEXT:    s_cselect_b32 s9, -1, 0
; VI-NEXT:    s_cmp_eq_u32 s3, s5
; VI-NEXT:    s_cselect_b32 s3, s9, s8
; VI-NEXT:    s_cmp_lg_u32 s3, 0
; VI-NEXT:    s_cselect_b32 s9, s14, s7
; VI-NEXT:    s_cselect_b32 s8, s12, s10
; VI-NEXT:    s_bitcmp0_b32 s6, 0
; VI-NEXT:    s_cbranch_scc1 .LBB16_4
; VI-NEXT:  .LBB16_2:
; VI-NEXT:    v_cvt_f32_u32_e32 v0, s4
...
; GFX9-NEXT:    s_sub_u32 s5, 0, s6
; GFX9-NEXT:    s_subb_u32 s8, 0, s7
...
; GFX9-NEXT:    s_mul_hi_u32 s13, s5, s10
; GFX9-NEXT:    s_mul_i32 s12, s8, s10
; GFX9-NEXT:    s_add_i32 s11, s13, s11
; GFX9-NEXT:    s_add_i32 s11, s11, s12
; GFX9-NEXT:    s_mul_i32 s14, s5, s10
; GFX9-NEXT:    s_mul_i32 s13, s10, s11
; GFX9-NEXT:    s_mul_hi_u32 s15, s10, s14
; GFX9-NEXT:    s_mul_hi_u32 s12, s10, s11
...
; GFX9-NEXT:    s_mul_hi_u32 s15, s9, s11
; GFX9-NEXT:    s_addc_u32 s12, s12, s16
; GFX9-NEXT:    s_addc_u32 s13, s15, 0
; GFX9-NEXT:    s_mul_i32 s11, s9, s11
...
; GFX9-NEXT:    s_mul_hi_u32 s9, s6, s5
; GFX9-NEXT:    s_add_i32 s8, s9, s8
; GFX9-NEXT:    s_mul_i32 s9, s7, s5
; GFX9-NEXT:    s_add_i32 s11, s8, s9
; GFX9-NEXT:    s_sub_i32 s12, s3, s11
; GFX9-NEXT:    s_mul_i32 s8, s6, s5
; GFX9-NEXT:    s_sub_u32 s13, s2, s8
; GFX9-NEXT:    s_cselect_b64 s[8:9], -1, 0
; GFX9-NEXT:    s_subb_u32 s12, s12, s7
; GFX9-NEXT:    s_sub_u32 s14, s13, s6
; GFX9-NEXT:    s_subb_u32 s12, s12, 0
...
; GFX9-NEXT:    s_cselect_b32 s12, s14, s15
; GFX9-NEXT:    s_add_u32 s14, s5, 1
; GFX9-NEXT:    s_addc_u32 s15, s10, 0
; GFX9-NEXT:    s_add_u32 s16, s5, 2
; GFX9-NEXT:    s_addc_u32 s17, s10, 0
; GFX9-NEXT:    s_cmp_lg_u32 s12, 0
; GFX9-NEXT:    s_cselect_b32 s12, s16, s14
; GFX9-NEXT:    s_cselect_b32 s14, s17, s15
...
; GFX9-NEXT:    s_cselect_b32 s9, s14, s10
; GFX9-NEXT:    s_cselect_b32 s8, s12, s5
; GFX9-NEXT:    s_bitcmp0_b32 s4, 0
; GFX9-NEXT:    s_cbranch_scc1 .LBB16_3
; GFX9-NEXT:  .LBB16_2:
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, s6
...
; GFX1010-NEXT:    s_bitcmp0_b32 s4, 0
; GFX1010-NEXT:    s_cbranch_scc1 .LBB16_3
...
; GFX1030W32-NEXT:    s_bitcmp0_b32 s6, 0
; GFX1030W32-NEXT:    s_cbranch_scc1 .LBB16_3
...
; GFX1030W32-NEXT:    s_mov_b32 s6, -1
...
; GFX1030W64-NEXT:    s_bitcmp0_b32 s8, 0
; GFX1030W64-NEXT:    s_cbranch_scc1 .LBB16_3
...
; GFX11-NEXT:    s_cbranch_scc1 .LBB16_3
; GFX11-NEXT:  .LBB16_2:
; GFX11-NEXT:    v_cvt_f32_u32_e32 v0, s4
...
; GFX1250-NEXT:    s_bitcmp0_b32 s5, 0
; GFX1250-NEXT:    s_cbranch_scc1 .LBB16_3
...
; GCN-ISEL-NEXT:   [[PHI1:%[0-9]+]]:sreg_64 = PHI [[S_MOV_B64_1]], %bb.0, %40, %bb.3
; GCN-ISEL-NEXT:   [[COPY12:%[0-9]+]]:sreg_32 = COPY [[PHI1]].sub0
; GCN-ISEL-NEXT:   [[S_AND_B32_:%[0-9]+]]:sreg_32 = S_AND_B32 killed [[COPY12]], 1, implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MOV_B32_1:%[0-9]+]]:sreg_32 = S_MOV_B32 1
; GCN-ISEL-NEXT:   S_CMP_LG_U32 killed [[S_AND_B32_]], killed [[S_MOV_B32_1]], implicit-def $scc
