...
; GFX13-NEXT:    s_cselect_b64 s[12:13], s[14:15], s[12:13]
; GFX13-NEXT:    s_cmp_lg_u32 s8, 0
...
; GCN-ISEL-NEXT:   [[COPY32:%[0-9]+]]:sreg_32 = COPY [[V_CVT_U32_F32_e64_1]]
; GCN-ISEL-NEXT:   [[S_MUL_I32_6:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY32]], [[S_MUL_I32_5]]
...
; GCN-ISEL-NEXT:   [[COPY33:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE6]].sub0
; GCN-ISEL-NEXT:   [[S_UADDO:%[0-9]+]]:sreg_32, [[S_UADDO1:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO killed [[COPY31]], killed [[COPY33]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY34:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U]].sub1
; GCN-ISEL-NEXT:   [[COPY35:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE6]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_C:%[0-9]+]]:sreg_32, [[S_ADD_C1:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY34]], killed [[COPY35]], killed [[S_UADDO1]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[COPY36:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_6]]
; GCN-ISEL-NEXT:   [[S_ADD_C2:%[0-9]+]]:sreg_32, [[S_ADD_C3:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY36]], [[S_MOV_B32_10]], killed [[S_ADD_C1]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_UADDO2:%[0-9]+]]:sreg_32, [[S_UADDO3:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO [[COPY40]], killed [[COPY39]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY41:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U1]].sub1
; GCN-ISEL-NEXT:   [[COPY42:%[0-9]+]]:sreg_32 = COPY [[V_CVT_U32_F32_e64_1]]
; GCN-ISEL-NEXT:   [[S_ADD_C4:%[0-9]+]]:sreg_32, [[S_ADD_C5:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO [[COPY42]], killed [[COPY41]], killed [[S_UADDO3]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_8:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY26]], [[S_UADDO2]]
; GCN-ISEL-NEXT:   [[COPY43:%[0-9]+]]:vgpr_32 = COPY [[S_MUL_I32_8]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_7:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_ADD_C4]], [[COPY43]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY44:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE10]].sub0
; GCN-ISEL-NEXT:   [[S_MUL_I32_10:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY26]], [[S_ADD_C4]]
; GCN-ISEL-NEXT:   [[COPY45:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO2]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_8:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY26]], [[COPY45]], implicit $exec
; GCN-ISEL-NEXT:   [[COPY46:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_8]]
; GCN-ISEL-NEXT:   [[S_ADD_I32_5:%[0-9]+]]:sreg_32 = S_ADD_I32 killed [[COPY46]], killed [[S_MUL_I32_10]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_11:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY24]], [[S_UADDO2]]
; GCN-ISEL-NEXT:   [[S_ADD_I32_6:%[0-9]+]]:sreg_32 = S_ADD_I32 killed [[S_ADD_I32_5]], killed [[S_MUL_I32_11]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY47:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_I32_6]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_9:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_UADDO2]], [[COPY47]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY48:%[0-9]+]]:vgpr_32 = COPY [[S_MUL_I32_8]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_10:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_UADDO2]], [[COPY48]], implicit $exec
...
; GCN-ISEL-NEXT:   [[COPY49:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U2]].sub0
; GCN-ISEL-NEXT:   [[S_UADDO4:%[0-9]+]]:sreg_32, [[S_UADDO5:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO killed [[COPY49]], killed [[COPY44]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY50:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE10]].sub1
; GCN-ISEL-NEXT:   [[COPY51:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U2]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_C6:%[0-9]+]]:sreg_32, [[S_ADD_C7:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY51]], killed [[COPY50]], killed [[S_UADDO5]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[REG_SEQUENCE13:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[S_UADDO4]], %subreg.sub0, killed [[S_ADD_C6]], %subreg.sub1
; GCN-ISEL-NEXT:   [[COPY52:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE13]].sub1
; GCN-ISEL-NEXT:   [[REG_SEQUENCE14:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY52]], %subreg.sub0, [[S_MOV_B32_10]], %subreg.sub1
; GCN-ISEL-NEXT:   [[COPY53:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_I32_6]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_11:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[S_ADD_C4]], [[COPY53]], implicit $exec
; GCN-ISEL-NEXT:   [[COPY54:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_11]]
; GCN-ISEL-NEXT:   [[S_ADD_C8:%[0-9]+]]:sreg_32, [[S_ADD_C9:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY54]], [[S_MOV_B32_10]], killed [[S_ADD_C7]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_UADDO6:%[0-9]+]]:sreg_32, [[S_UADDO7:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO [[S_UADDO2]], killed [[COPY55]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY56:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U3]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_C10:%[0-9]+]]:sreg_32, [[S_ADD_C11:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO [[S_ADD_C4]], killed [[COPY56]], killed [[S_UADDO7]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY57:%[0-9]+]]:sreg_32 = COPY [[COPY8]].sub0
; GCN-ISEL-NEXT:   [[COPY58:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_C10]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_12:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY57]], [[COPY58]], implicit $exec
; GCN-ISEL-NEXT:   [[S_MUL_I32_14:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY57]], [[S_ADD_C10]]
...
; GCN-ISEL-NEXT:   [[COPY59:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO6]]
...
; GCN-ISEL-NEXT:   [[COPY61:%[0-9]+]]:sreg_32 = COPY [[COPY8]].sub1
; GCN-ISEL-NEXT:   [[COPY62:%[0-9]+]]:vgpr_32 = COPY [[S_UADDO6]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_14:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY61]], [[COPY62]], implicit $exec
; GCN-ISEL-NEXT:   [[S_MUL_I32_15:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY61]], [[S_UADDO6]]
...
; GCN-ISEL-NEXT:   [[COPY63:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE18]].sub0
; GCN-ISEL-NEXT:   [[S_UADDO8:%[0-9]+]]:sreg_32, [[S_UADDO9:%[0-9]+]]:sreg_64_xexec = S_UADDO_PSEUDO killed [[COPY60]], killed [[COPY63]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY64:%[0-9]+]]:sreg_32 = COPY [[S_ADD_U4]].sub1
; GCN-ISEL-NEXT:   [[COPY65:%[0-9]+]]:sreg_32 = COPY [[REG_SEQUENCE18]].sub1
; GCN-ISEL-NEXT:   [[S_ADD_C12:%[0-9]+]]:sreg_32, [[S_ADD_C13:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY64]], killed [[COPY65]], killed [[S_UADDO9]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[COPY66:%[0-9]+]]:vgpr_32 = COPY [[S_ADD_C10]]
; GCN-ISEL-NEXT:   [[V_MUL_HI_U32_e64_15:%[0-9]+]]:vgpr_32 = V_MUL_HI_U32_e64 [[COPY61]], [[COPY66]], implicit $exec
; GCN-ISEL-NEXT:   [[COPY67:%[0-9]+]]:sreg_32 = COPY [[V_MUL_HI_U32_e64_15]]
; GCN-ISEL-NEXT:   [[S_ADD_C14:%[0-9]+]]:sreg_32, [[S_ADD_C15:%[0-9]+]]:sreg_64_xexec = S_ADD_CO_PSEUDO killed [[COPY67]], [[S_MOV_B32_10]], killed [[S_ADD_C13]], implicit-def dead $scc
; GCN-ISEL-NEXT:   [[S_MUL_I32_16:%[0-9]+]]:sreg_32 = S_MUL_I32 [[COPY61]], [[S_ADD_C10]]
...
; GCN-ISEL-NEXT:   [[S_SUB_I32_3:%[0-9]+]]:sreg_32 = S_SUB_I32 [[COPY61]], [[S_ADD_I32_8]], implicit-def dead $scc
...
; GCN-ISEL-NEXT:   [[S_SUB_C4:%[0-9]+]]:sreg_32, [[S_SUB_C5:%[0-9]+]]:sreg_64_xexec = S_SUB_CO_PSEUDO [[COPY61]], [[S_ADD_I32_8]], [[S_USUBO1]], implicit-def dead $scc
