...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GFX1210 %s
...
; CISI-LABEL: sadd64rr:
; CISI:       ; %bb.0: ; %entry
; CISI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x9
; CISI-NEXT:    s_load_dwordx2 s[8:9], s[2:3], 0xd
...
; GFX1010-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX1010-NEXT:    v_mov_b32_e32 v2, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    s_add_u32 s0, s6, s0
; GFX1010-NEXT:    s_addc_u32 s1, s7, s1
...
; GFX1030W32-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX1030W32-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX1030W64-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX1030W64-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
...
; GFX1300-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[0:1], s[6:7], s[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[4:5]
...
; CISI-LABEL: sadd64ri:
; CISI:       ; %bb.0: ; %entry
; CISI-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x9
...
; GFX1030W32:       ; %bb.0: ; %entry
; GFX1030W32-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; GFX1030W32-NEXT:    v_mov_b32_e32 v2, 0
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1030W64:       ; %bb.0: ; %entry
; GFX1030W64-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; GFX1030W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: sadd64ri:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 0x123456789876
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[2:3], s[2:3], 0x123456789876
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; CISI-LABEL: vadd64ri:
; CISI:       ; %bb.0: ; %entry
; CISI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
...
; GFX1010:       ; %bb.0: ; %entry
; GFX1010-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; GFX1030W32:       ; %bb.0: ; %entry
; GFX1030W32-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; GFX1030W64:       ; %bb.0: ; %entry
; GFX1030W64-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; GFX1300:       ; %bb.0: ; %entry
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v1, 0
; GFX1300-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_add_nc_u64_e32 v[2:3], 0x123456789876, v[0:1]
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    s_endpgm
entry:
...
; CISI-LABEL: suaddo32:
; CISI:       ; %bb.0:
; CISI-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0xd
; CISI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
; CISI-NEXT:    s_mov_b32 s3, 0xf000
; CISI-NEXT:    s_mov_b32 s2, -1
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1010-NEXT:    s_clause 0x1
; GFX1010-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX1010-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x24
...
; GFX1030W32-NEXT:    s_clause 0x1
; GFX1030W32-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX1030W32-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX1030W64-NEXT:    s_clause 0x1
; GFX1030W64-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x34
; GFX1030W64-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x24
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: suaddo32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1300-NEXT:    s_load_b64 s[2:3], s[2:3], 0x24
; GFX1300-NEXT:    s_wait_kmcnt 0x0
...
; CISI:       ; %bb.0:
; CISI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x9
; CISI-NEXT:    s_load_dwordx2 s[12:13], s[2:3], 0xd
; CISI-NEXT:    s_mov_b32 s11, 0xf000
; CISI-NEXT:    s_mov_b32 s10, -1
; CISI-NEXT:    s_mov_b32 s2, s10
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
; CISI-NEXT:    s_mov_b32 s8, s4
; CISI-NEXT:    v_mov_b32_e32 v0, s13
; CISI-NEXT:    s_mov_b32 s9, s5
; CISI-NEXT:    v_add_i32_e32 v0, vcc, s12, v0
; CISI-NEXT:    s_mov_b32 s0, s6
; CISI-NEXT:    s_mov_b32 s1, s7
; CISI-NEXT:    s_mov_b32 s3, s11
; CISI-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; CISI-NEXT:    buffer_store_dword v0, off, s[8:11], 0
...
; GFX1010-NEXT:    v_mov_b32_e32 v0, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_add_co_u32 v1, s0, s0, s1
...
; GFX1030W32:       ; %bb.0:
; GFX1030W32-NEXT:    s_clause 0x1
; GFX1030W32-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x34
; GFX1030W32-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; GFX1030W32-NEXT:    v_mov_b32_e32 v0, 0
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1030W64:       ; %bb.0:
; GFX1030W64-NEXT:    s_clause 0x1
; GFX1030W64-NEXT:    s_load_dwordx2 s[4:5], s[2:3], 0x34
; GFX1030W64-NEXT:    s_load_dwordx4 s[0:3], s[2:3], 0x24
; GFX1030W64-NEXT:    v_mov_b32_e32 v0, 0
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: uaddo32_vcc_user:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_add_co_u32 v1, s4, s4, s5
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX1300-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
...
; CISI-LABEL: suaddo64:
; CISI:       ; %bb.0:
; CISI-NEXT:    s_load_dwordx8 s[0:7], s[2:3], 0x9
; CISI-NEXT:    s_mov_b32 s11, 0xf000
; CISI-NEXT:    s_mov_b32 s10, -1
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1030W32:       ; %bb.0:
; GFX1030W32-NEXT:    s_load_dwordx8 s[0:7], s[2:3], 0x24
; GFX1030W32-NEXT:    v_mov_b32_e32 v2, 0
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1030W64:       ; %bb.0:
; GFX1030W64-NEXT:    s_load_dwordx8 s[0:7], s[2:3], 0x24
; GFX1030W64-NEXT:    v_mov_b32_e32 v2, 0
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: suaddo64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_nc_u64 s[6:7], s[4:5], s[6:7]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_cmp_lt_u64_e64 s4, s[6:7], s[4:5]
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[6:7]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s4
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
...
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_add_nc_u64 s[6:7], s[4:5], s[6:7]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1300-NEXT:    v_cmp_lt_u64_e64 s4, s[6:7], s[4:5]
; GFX1300-NEXT:    v_mov_b64_e32 v[0:1], s[6:7]
...
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
; CISI-NEXT:    s_mov_b32 s8, s4
; CISI-NEXT:    v_mov_b32_e32 v1, s13
; CISI-NEXT:    v_add_i32_e32 v0, vcc, s12, v0
; CISI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; CISI-NEXT:    v_cmp_gt_u64_e32 vcc, s[12:13], v[0:1]
; CISI-NEXT:    s_mov_b32 s9, s5
; CISI-NEXT:    s_mov_b32 s0, s6
; CISI-NEXT:    s_mov_b32 s1, s7
; CISI-NEXT:    s_mov_b32 s3, s11
...
; GFX1010-NEXT:    v_mov_b32_e32 v2, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_add_co_u32 v0, s2, s0, v0
; GFX1010-NEXT:    v_add_co_ci_u32_e64 v1, s2, s1, 0, s2
; GFX1010-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[0:1], v[0:1]
...
; GFX1210-NEXT:    v_add_nc_u64_e32 v[2:3], s[4:5], v[0:1]
; GFX1210-NEXT:    v_cmp_gt_u64_e32 vcc_lo, s[4:5], v[2:3]
...
; GFX1010-NEXT:    v_mov_b32_e32 v2, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    s_sub_u32 s0, s6, s0
; GFX1010-NEXT:    s_subb_u32 s1, s7, s1
; GFX1010-NEXT:    v_mov_b32_e32 v0, s0
; GFX1010-NEXT:    v_mov_b32_e32 v1, s1
; GFX1010-NEXT:    global_store_dwordx2 v2, v[0:1], s[4:5]
; GFX1010-NEXT:    s_endpgm
...
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_nc_u64 s[0:1], s[6:7], s[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[4:5]
; GFX1210-NEXT:    s_endpgm
...
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_nc_u64 s[0:1], s[6:7], s[0:1]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[4:5]
; GFX1300-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: ssub64ri:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_nc_u64 s[2:3], 0x123456789876, s[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX1300-NEXT:    v_mov_b32_e32 v2, 0
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_sub_nc_u64 s[2:3], 0x123456789876, s[2:3]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX1300-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1300-NEXT:    s_endpgm
...
; GFX1300-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1300-NEXT:    v_sub_nc_u64_e32 v[2:3], 0x123456789876, v[0:1]
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1300-NEXT:    s_endpgm
entry:
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: susubo32:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[0:1], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_co_i32 s0, s0, s1
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX1210-NEXT:    global_store_b32 v0, v1, s[2:3]
; GFX1210-NEXT:    s_endpgm
...
; CISI-NEXT:    v_mov_b32_e32 v0, s13
; CISI-NEXT:    s_mov_b32 s9, s5
; CISI-NEXT:    v_sub_i32_e32 v0, vcc, s12, v0
; CISI-NEXT:    s_mov_b32 s0, s6
; CISI-NEXT:    s_mov_b32 s1, s7
; CISI-NEXT:    s_mov_b32 s3, s11
; CISI-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
...
; GFX1010-NEXT:    v_mov_b32_e32 v0, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_sub_co_u32 v1, s0, s0, s1
; GFX1010-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s0
; GFX1010-NEXT:    global_store_dword v0, v1, s[4:5]
; GFX1010-NEXT:    global_store_byte v0, v2, s[6:7]
; GFX1010-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: usubo32_vcc_user:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b64 s[4:5], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v0, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_sub_co_u32 v1, s4, s4, s5
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s4
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b32 v0, v1, s[0:1]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1210-LABEL: susubo64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b256 s[0:7], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_sub_nc_u64 s[6:7], s[4:5], s[6:7]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_cmp_gt_u64_e64 s4, s[6:7], s[4:5]
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], s[6:7]
; GFX1210-NEXT:    s_wait_alu 0xf1ff
; GFX1210-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s4
; GFX1210-NEXT:    s_clause 0x1
...
; CISI-NEXT:    v_sub_i32_e32 v0, vcc, s12, v0
; CISI-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CISI-NEXT:    v_cmp_lt_u64_e32 vcc, s[12:13], v[0:1]
; CISI-NEXT:    s_mov_b32 s9, s5
; CISI-NEXT:    s_mov_b32 s0, s6
; CISI-NEXT:    s_mov_b32 s1, s7
; CISI-NEXT:    s_mov_b32 s3, s11
...
; GFX1010-NEXT:    v_mov_b32_e32 v2, 0
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    v_sub_co_u32 v0, s2, s0, v0
; GFX1010-NEXT:    v_sub_co_ci_u32_e64 v1, s2, s1, 0, s2
; GFX1010-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[0:1], v[0:1]
; GFX1010-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc_lo
; GFX1010-NEXT:    global_store_dwordx2 v2, v[0:1], s[4:5]
; GFX1010-NEXT:    global_store_byte v2, v3, s[6:7]
; GFX1010-NEXT:    s_endpgm
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_sub_nc_u64_e32 v[2:3], s[4:5], v[0:1]
; GFX1210-NEXT:    v_cmp_lt_u64_e32 vcc_lo, s[4:5], v[2:3]
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b64 v1, v[2:3], s[0:1]
; GFX1210-NEXT:    global_store_b8 v1, v0, s[2:3]
...
; CISI:       ; %bb.0:
; CISI-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x9
; CISI-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0xd
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_or_b64 s[0:1], s[6:7], s[8:9]
...
; GFX9-NEXT:    s_mul_hi_u32 s0, s2, s0
; GFX9-NEXT:    s_add_i32 s2, s2, s0
; GFX9-NEXT:    s_mul_hi_u32 s0, s6, s2
; GFX9-NEXT:    s_mul_i32 s3, s0, s8
...
; GFX1010-NEXT:    s_clause 0x1
; GFX1010-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX1010-NEXT:    s_load_dwordx2 s[8:9], s[2:3], 0x34
; GFX1010-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1010-NEXT:    s_or_b64 s[2:3], s[6:7], s[8:9]
; GFX1010-NEXT:    s_mov_b32 s2, 0
; GFX1010-NEXT:    s_cmp_lg_u64 s[2:3], 0
; GFX1010-NEXT:    s_cbranch_scc0 .LBB16_4
; GFX1010-NEXT:  ; %bb.1:
; GFX1010-NEXT:    v_cvt_f32_u32_e32 v0, s8
; GFX1010-NEXT:    v_cvt_f32_u32_e32 v1, s9
; GFX1010-NEXT:    s_sub_u32 s3, 0, s8
; GFX1010-NEXT:    s_subb_u32 s10, 0, s9
...
; GFX1010-NEXT:    s_mul_i32 s11, s3, s0
; GFX1010-NEXT:    s_mul_hi_u32 s13, s3, s1
; GFX1010-NEXT:    s_mul_i32 s12, s10, s1
; GFX1010-NEXT:    s_add_i32 s11, s13, s11
; GFX1010-NEXT:    s_mul_i32 s14, s3, s1
...
; GFX1010-NEXT:    v_readfirstlane_b32 s1, v0
; GFX1010-NEXT:    s_mul_i32 s11, s3, s0
; GFX1010-NEXT:    s_mul_hi_u32 s12, s3, s1
; GFX1010-NEXT:    s_mul_i32 s10, s10, s1
; GFX1010-NEXT:    s_add_i32 s11, s12, s11
; GFX1010-NEXT:    s_mul_i32 s3, s3, s1
; GFX1010-NEXT:    s_add_i32 s11, s11, s10
; GFX1010-NEXT:    s_mul_hi_u32 s12, s0, s3
; GFX1010-NEXT:    s_mul_i32 s13, s0, s3
; GFX1010-NEXT:    s_mul_hi_u32 s3, s1, s3
; GFX1010-NEXT:    s_mul_hi_u32 s14, s1, s11
; GFX1010-NEXT:    s_mul_i32 s1, s1, s11
; GFX1010-NEXT:    s_mul_hi_u32 s10, s0, s11
; GFX1010-NEXT:    s_add_u32 s1, s3, s1
; GFX1010-NEXT:    s_addc_u32 s3, 0, s14
; GFX1010-NEXT:    s_add_u32 s1, s1, s13
; GFX1010-NEXT:    s_mul_i32 s11, s0, s11
; GFX1010-NEXT:    s_addc_u32 s1, s3, s12
; GFX1010-NEXT:    s_addc_u32 s3, s10, 0
; GFX1010-NEXT:    s_add_u32 s1, s1, s11
; GFX1010-NEXT:    s_addc_u32 s3, 0, s3
; GFX1010-NEXT:    v_add_co_u32 v0, s1, v0, s1
; GFX1010-NEXT:    s_cmp_lg_u32 s1, 0
; GFX1010-NEXT:    s_addc_u32 s0, s0, s3
; GFX1010-NEXT:    v_readfirstlane_b32 s1, v0
; GFX1010-NEXT:    s_mul_i32 s10, s6, s0
; GFX1010-NEXT:    s_mul_hi_u32 s3, s6, s0
...
; GFX1010-NEXT:    v_cndmask_b32_e32 v1, s3, v1, vcc_lo
; GFX1010-NEXT:    v_cndmask_b32_e32 v0, s1, v2, vcc_lo
; GFX1010-NEXT:    s_andn2_b32 vcc_lo, exec_lo, s2
; GFX1010-NEXT:    s_cbranch_vccnz .LBB16_3
; GFX1010-NEXT:  .LBB16_2:
; GFX1010-NEXT:    v_cvt_f32_u32_e32 v0, s8
; GFX1010-NEXT:    s_sub_i32 s1, 0, s8
...
; GFX1010-NEXT:    s_mul_i32 s1, s0, s8
; GFX1010-NEXT:    s_add_i32 s2, s0, 1
; GFX1010-NEXT:    s_sub_i32 s1, s6, s1
; GFX1010-NEXT:    s_sub_i32 s3, s1, s8
; GFX1010-NEXT:    s_cmp_ge_u32 s1, s8
; GFX1010-NEXT:    s_cselect_b32 s0, s2, s0
; GFX1010-NEXT:    s_cselect_b32 s1, s3, s1
; GFX1010-NEXT:    s_add_i32 s2, s0, 1
; GFX1010-NEXT:    s_cmp_ge_u32 s1, s8
...
; GFX1030W32-NEXT:    s_clause 0x1
; GFX1030W32-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX1030W32-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x34
; GFX1030W32-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1030W64-NEXT:    s_clause 0x1
; GFX1030W64-NEXT:    s_load_dwordx4 s[4:7], s[2:3], 0x24
; GFX1030W64-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x34
; GFX1030W64-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX11-NEXT:    s_load_b64 s[2:3], s[2:3], 0x34
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
;
; GFX1210-LABEL: sudiv64:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x34
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_or_b64 s[0:1], s[6:7], s[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_and_b64 s[0:1], s[0:1], 0xffffffff00000000
; GFX1210-NEXT:    s_cmp_lg_u64 s[0:1], 0
; GFX1210-NEXT:    s_cbranch_scc0 .LBB16_4
; GFX1210-NEXT:  ; %bb.1:
; GFX1210-NEXT:    s_cvt_f32_u32 s0, s2
; GFX1210-NEXT:    s_cvt_f32_u32 s1, s3
; GFX1210-NEXT:    s_sub_nc_u64 s[10:11], 0, s[2:3]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_2) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX1210-NEXT:    s_fmamk_f32 s0, s1, 0x4f800000, s0
; GFX1210-NEXT:    v_s_rcp_f32 s0, s0
; GFX1210-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX1210-NEXT:    s_mul_f32 s0, s0, 0x5f7ffffc
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_f32 s1, s0, 0x2f800000
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_2) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX1210-NEXT:    s_trunc_f32 s1, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_fmamk_f32 s0, s1, 0xcf800000, s0
; GFX1210-NEXT:    s_cvt_u32_f32 s9, s1
; GFX1210-NEXT:    s_mov_b32 s1, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cvt_u32_f32 s8, s0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_3) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_u64 s[12:13], s[10:11], s[8:9]
; GFX1210-NEXT:    s_mul_hi_u32 s15, s8, s13
; GFX1210-NEXT:    s_mul_i32 s14, s8, s13
; GFX1210-NEXT:    s_mul_hi_u32 s0, s8, s12
; GFX1210-NEXT:    s_mul_i32 s17, s9, s12
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[14:15], s[0:1], s[14:15]
; GFX1210-NEXT:    s_mul_hi_u32 s16, s9, s12
; GFX1210-NEXT:    s_mul_hi_u32 s18, s9, s13
; GFX1210-NEXT:    s_add_co_u32 s0, s14, s17
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s15, s16
; GFX1210-NEXT:    s_mul_i32 s12, s9, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s13, s18, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_u32 v0, s0, s8, s12
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_add_co_ci_u32 s9, s9, s13
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_u64 s[10:11], s[10:11], s[8:9]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    s_mul_hi_u32 s13, s8, s11
; GFX1210-NEXT:    s_mul_i32 s12, s8, s11
; GFX1210-NEXT:    s_mul_hi_u32 s0, s8, s10
; GFX1210-NEXT:    s_mul_i32 s15, s9, s10
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1210-NEXT:    s_mul_hi_u32 s14, s9, s10
; GFX1210-NEXT:    s_mul_hi_u32 s8, s9, s11
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_co_u32 s0, s12, s15
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s13, s14
; GFX1210-NEXT:    s_mul_i32 s10, s9, s11
; GFX1210-NEXT:    s_add_co_ci_u32 s11, s8, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[10:11], s[0:1], s[10:11]
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_add_co_u32 v0, s0, v0, s10
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s9, s11
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_readfirstlane_b32 s11, v0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_hi_u32 s9, s6, s0
; GFX1210-NEXT:    s_mul_i32 s8, s6, s0
; GFX1210-NEXT:    s_mul_hi_u32 s12, s7, s0
; GFX1210-NEXT:    s_mul_i32 s10, s7, s0
; GFX1210-NEXT:    s_mul_hi_u32 s0, s6, s11
; GFX1210-NEXT:    s_mul_i32 s13, s7, s11
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[8:9]
; GFX1210-NEXT:    s_mul_hi_u32 s0, s7, s11
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_co_u32 s8, s8, s13
; GFX1210-NEXT:    s_add_co_ci_u32 s0, s9, s0
; GFX1210-NEXT:    s_add_co_ci_u32 s11, s12, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[10:11]
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_b64 s[10:11], s[8:9], 0xffffffff00000000
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_or_b32 s10, s10, s8
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_u64 s[8:9], s[2:3], s[10:11]
; GFX1210-NEXT:    s_add_nc_u64 s[14:15], s[10:11], 2
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_sub_co_u32 v0, s0, s6, s8
; GFX1210-NEXT:    s_sub_co_i32 s8, s7, s9
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v3, s15
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1210-NEXT:    v_sub_co_u32 v1, s12, v0, s2
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_ci_u32 s8, s8, s3
; GFX1210-NEXT:    s_cmp_lg_u32 s12, 0
; GFX1210-NEXT:    s_add_nc_u64 s[12:13], s[10:11], 1
; GFX1210-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_ci_u32 s8, s8, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cmp_ge_u32 s8, s3
; GFX1210-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX1210-NEXT:    s_cselect_b32 s14, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s8, s3
; GFX1210-NEXT:    s_cselect_b32 vcc_lo, -1, 0
; GFX1210-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1210-NEXT:    s_wait_alu 0xfffc
; GFX1210-NEXT:    v_cndmask_b32_e32 v1, s14, v1, vcc_lo
; GFX1210-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v0
; GFX1210-NEXT:    s_sub_co_ci_u32 s0, s7, s9
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cmp_ge_u32 s0, s3
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
; GFX1210-NEXT:    s_cselect_b32 s7, -1, 0
; GFX1210-NEXT:    s_cmp_eq_u32 s0, s3
; GFX1210-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v1
; GFX1210-NEXT:    s_cselect_b32 s0, -1, 0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_cndmask_b32_e64 v0, s7, v0, s0
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_cndmask_b32_e32 v2, s12, v2, vcc_lo
; GFX1210-NEXT:    v_cndmask_b32_e32 v1, s13, v3, vcc_lo
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1210-NEXT:    s_wait_alu 0xfffd
; GFX1210-NEXT:    v_cndmask_b32_e32 v1, s11, v1, vcc_lo
; GFX1210-NEXT:    v_cndmask_b32_e32 v0, s10, v2, vcc_lo
; GFX1210-NEXT:    s_cbranch_execnz .LBB16_3
; GFX1210-NEXT:  .LBB16_2:
; GFX1210-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1210-NEXT:    s_sub_co_i32 s1, 0, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1210-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX1210-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX1210-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    s_mul_i32 s1, s1, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_hi_u32 s1, s0, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_hi_u32 s0, s6, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_mul_i32 s1, s0, s2
; GFX1210-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_i32 s1, s6, s1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_sub_co_i32 s6, s1, s2
; GFX1210-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1210-NEXT:    s_cselect_b32 s0, s3, s0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cselect_b32 s1, s6, s1
; GFX1210-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1210-NEXT:    s_mov_b32 s1, 0
...
; GFX1210-NEXT:    s_branch .LBB16_2
;
; GFX1300-LABEL: sudiv64:
; GFX1300:       ; %bb.0:
; GFX1300-NEXT:    s_clause 0x1
; GFX1300-NEXT:    s_load_b128 s[4:7], s[2:3], 0x24
; GFX1300-NEXT:    s_load_b64 s[2:3], s[2:3], 0x34
; GFX1300-NEXT:    s_wait_kmcnt 0x0
; GFX1300-NEXT:    s_or_b64 s[0:1], s[6:7], s[2:3]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_and_b64 s[0:1], s[0:1], 0xffffffff00000000
...
; GFX1300-NEXT:    s_sub_nc_u64 s[10:11], 0, s[2:3]
...
; GFX1300-NEXT:    s_cvt_u32_f32 s9, s1
; GFX1300-NEXT:    s_mov_b32 s1, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_3)
; GFX1300-NEXT:    s_cvt_u32_f32 s8, s0
; GFX1300-NEXT:    s_mul_u64 s[12:13], s[10:11], s[8:9]
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_hi_u32 s15, s8, s13
; GFX1300-NEXT:    s_mul_i32 s14, s8, s13
; GFX1300-NEXT:    s_mul_hi_u32 s0, s8, s12
; GFX1300-NEXT:    s_mul_i32 s17, s9, s12
; GFX1300-NEXT:    s_add_nc_u64 s[14:15], s[0:1], s[14:15]
; GFX1300-NEXT:    s_mul_hi_u32 s16, s9, s12
; GFX1300-NEXT:    s_mul_hi_u32 s18, s9, s13
; GFX1300-NEXT:    s_add_co_u32 s0, s14, s17
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s15, s16
; GFX1300-NEXT:    s_mul_i32 s12, s9, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s13, s18, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1300-NEXT:    v_add_co_u32 v0, s0, s8, s12
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s9, s9, s13
; GFX1300-NEXT:    v_readfirstlane_b32 s8, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_u64 s[10:11], s[10:11], s[8:9]
; GFX1300-NEXT:    s_mul_hi_u32 s13, s8, s11
; GFX1300-NEXT:    s_mul_i32 s12, s8, s11
; GFX1300-NEXT:    s_mul_hi_u32 s0, s8, s10
; GFX1300-NEXT:    s_mul_i32 s15, s9, s10
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[0:1], s[12:13]
; GFX1300-NEXT:    s_mul_hi_u32 s14, s9, s10
; GFX1300-NEXT:    s_mul_hi_u32 s8, s9, s11
; GFX1300-NEXT:    s_add_co_u32 s0, s12, s15
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s13, s14
; GFX1300-NEXT:    s_mul_i32 s10, s9, s11
; GFX1300-NEXT:    s_add_co_ci_u32 s11, s8, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[10:11], s[0:1], s[10:11]
; GFX1300-NEXT:    v_add_co_u32 v0, s0, v0, s10
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s9, s11
; GFX1300-NEXT:    v_readfirstlane_b32 s11, v0
; GFX1300-NEXT:    s_mul_hi_u32 s9, s6, s0
; GFX1300-NEXT:    s_mul_i32 s8, s6, s0
; GFX1300-NEXT:    s_mul_hi_u32 s12, s7, s0
; GFX1300-NEXT:    s_mul_i32 s10, s7, s0
; GFX1300-NEXT:    s_mul_hi_u32 s0, s6, s11
; GFX1300-NEXT:    s_mul_i32 s13, s7, s11
; GFX1300-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[8:9]
; GFX1300-NEXT:    s_mul_hi_u32 s0, s7, s11
; GFX1300-NEXT:    s_add_co_u32 s8, s8, s13
; GFX1300-NEXT:    s_add_co_ci_u32 s0, s9, s0
; GFX1300-NEXT:    s_add_co_ci_u32 s11, s12, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_nc_u64 s[8:9], s[0:1], s[10:11]
; GFX1300-NEXT:    s_and_b64 s[10:11], s[8:9], 0xffffffff00000000
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_or_b32 s10, s10, s8
; GFX1300-NEXT:    s_mul_u64 s[8:9], s[2:3], s[10:11]
; GFX1300-NEXT:    s_add_nc_u64 s[14:15], s[10:11], 2
; GFX1300-NEXT:    v_sub_co_u32 v0, s0, s6, s8
; GFX1300-NEXT:    s_sub_co_i32 s8, s7, s9
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v3, s15
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1300-NEXT:    v_sub_co_u32 v1, s12, v0, s2
; GFX1300-NEXT:    s_sub_co_ci_u32 s8, s8, s3
; GFX1300-NEXT:    s_cmp_lg_u32 s12, 0
; GFX1300-NEXT:    s_add_nc_u64 s[12:13], s[10:11], 1
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v1
; GFX1300-NEXT:    s_sub_co_ci_u32 s8, s8, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_cmp_ge_u32 s8, s3
; GFX1300-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc_lo
; GFX1300-NEXT:    s_cselect_b32 s14, -1, 0
; GFX1300-NEXT:    s_cmp_eq_u32 s8, s3
; GFX1300-NEXT:    s_cselect_b32 vcc_lo, -1, 0
; GFX1300-NEXT:    s_cmp_lg_u32 s0, 0
; GFX1300-NEXT:    v_cndmask_b32_e32 v1, s14, v1, vcc_lo
; GFX1300-NEXT:    v_cmp_le_u32_e32 vcc_lo, s2, v0
; GFX1300-NEXT:    s_sub_co_ci_u32 s0, s7, s9
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1300-NEXT:    s_cmp_ge_u32 s0, s3
; GFX1300-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc_lo
; GFX1300-NEXT:    s_cselect_b32 s7, -1, 0
; GFX1300-NEXT:    s_cmp_eq_u32 s0, s3
; GFX1300-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v1
; GFX1300-NEXT:    s_cselect_b32 s0, -1, 0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1300-NEXT:    v_cndmask_b32_e64 v0, s7, v0, s0
; GFX1300-NEXT:    v_cndmask_b32_e32 v2, s12, v2, vcc_lo
; GFX1300-NEXT:    v_cndmask_b32_e32 v1, s13, v3, vcc_lo
; GFX1300-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1300-NEXT:    v_cndmask_b32_e32 v1, s11, v1, vcc_lo
; GFX1300-NEXT:    v_cndmask_b32_e32 v0, s10, v2, vcc_lo
; GFX1300-NEXT:    s_cbranch_execnz .LBB16_3
; GFX1300-NEXT:  .LBB16_2:
; GFX1300-NEXT:    v_cvt_f32_u32_e32 v0, s2
; GFX1300-NEXT:    s_sub_co_i32 s1, 0, s2
...
; GFX1300-NEXT:    v_readfirstlane_b32 s0, v0
; GFX1300-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_i32 s1, s1, s0
; GFX1300-NEXT:    s_mul_hi_u32 s1, s0, s1
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_add_co_i32 s0, s0, s1
; GFX1300-NEXT:    s_mul_hi_u32 s0, s6, s0
; GFX1300-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX1300-NEXT:    s_mul_i32 s1, s0, s2
; GFX1300-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1300-NEXT:    s_sub_co_i32 s1, s6, s1
; GFX1300-NEXT:    s_sub_co_i32 s6, s1, s2
; GFX1300-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1300-NEXT:    s_cselect_b32 s0, s3, s0
; GFX1300-NEXT:    s_cselect_b32 s1, s6, s1
; GFX1300-NEXT:    s_add_co_i32 s3, s0, 1
; GFX1300-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1300-NEXT:    s_mov_b32 s1, 0
; GFX1300-NEXT:    s_cselect_b32 s0, s3, s0
