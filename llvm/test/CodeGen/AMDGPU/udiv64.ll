...
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[6:7], s[8:9]
...
; GCN-IR-NEXT:    s_or_b64 s[16:17], s[14:15], s[16:17]
; GCN-IR-NEXT:    s_and_b64 s[14:15], s[16:17], exec
; GCN-IR-NEXT:    s_cselect_b32 s15, 0, s3
; GCN-IR-NEXT:    s_cselect_b32 s14, 0, s2
...
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[16:17], s[14:15], 0
...
; GCN-IR-NEXT:    s_add_u32 s13, s4, -1
...
; GCN-IR-NEXT:    s_sub_u32 s6, s13, s14
; GCN-IR-NEXT:    s_subb_u32 s6, s16, s15
...
; GCN-IR-NEXT:    s_sub_u32 s14, s14, s10
; GCN-IR-NEXT:    s_subb_u32 s15, s15, s11
...
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[6:7], s[2:3]
...
; GCN-IR-NEXT:    s_min_u32 s12, s4, s5
; GCN-IR-NEXT:    s_sub_u32 s6, s10, s12
; GCN-IR-NEXT:    s_subb_u32 s7, 0, 0
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[16:17], s[6:7], 63
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[18:19], s[6:7], 63
; GCN-IR-NEXT:    s_or_b64 s[16:17], s[14:15], s[16:17]
; GCN-IR-NEXT:    s_and_b64 s[14:15], s[16:17], exec
; GCN-IR-NEXT:    s_cselect_b32 s15, 0, s9
; GCN-IR-NEXT:    s_cselect_b32 s14, 0, s8
; GCN-IR-NEXT:    s_or_b64 s[16:17], s[16:17], s[18:19]
...
; GCN-IR-NEXT:    s_addc_u32 s15, s7, 0
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[16:17], s[14:15], 0
...
; GCN-IR-NEXT:  ; %bb.2: ; %udiv-preheader
; GCN-IR-NEXT:    s_lshr_b64 s[14:15], s[8:9], s14
; GCN-IR-NEXT:    s_add_u32 s13, s2, -1
; GCN-IR-NEXT:    s_addc_u32 s16, s3, -1
; GCN-IR-NEXT:    s_not_b64 s[4:5], s[10:11]
; GCN-IR-NEXT:    s_add_u32 s8, s4, s12
...
; GCN-IR-NEXT:    s_sub_u32 s4, s13, s14
; GCN-IR-NEXT:    s_subb_u32 s4, s16, s15
...
; GCN-IR-NEXT:    s_or_b64 s[14:15], s[4:5], s[2:3]
...
; GCN-IR-NEXT:    s_lshl_b64 s[2:3], s[6:7], 1
; GCN-IR-NEXT:    s_or_b64 s[10:11], s[4:5], s[2:3]
