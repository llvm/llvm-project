...
; GCN-IR-NEXT:    s_min_u32 s16, s7, s10
; GCN-IR-NEXT:    s_sub_u32 s12, s6, s16
...
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v10, v6
; GCN-IR-NEXT:    v_subb_u32_e64 v9, s[8:9], 0, 0, vcc
...
; GCN-IR-NEXT:    v_lshr_b64 v[8:9], v[0:1], v9
...
; GCN-IR-NEXT:    s_min_u32 s16, s5, s10
; GCN-IR-NEXT:    s_sub_u32 s12, s4, s16
; GCN-IR-NEXT:    s_subb_u32 s13, 0, 0
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[14:15], s[12:13], 63
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[18:19], s[12:13], 63
...
; GCN-IR-NEXT:    s_add_u32 s8, s8, s16
...
; GCN-IR-NEXT:    s_sub_u32 s6, 59, s12
...
; GCN-IR-NEXT:  ; %bb.1: ; %udiv-bb1
; GCN-IR-NEXT:    s_add_i32 s10, s6, 1
; GCN-IR-NEXT:    s_sub_i32 s6, 63, s6
; GCN-IR-NEXT:    s_lshl_b64 s[8:9], s[2:3], s6
