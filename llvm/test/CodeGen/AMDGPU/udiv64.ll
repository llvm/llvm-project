...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[8:9]
...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[12:13]
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[12:13], s[8:9], 63
; GCN-IR-NEXT:    v_or_b32_e32 v0, v0, v1
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[12:13]
; GCN-IR-NEXT:    v_or_b32_e32 v1, v0, v1
; GCN-IR-NEXT:    v_and_b32_e32 v1, 1, v1
...
; GCN-IR-NEXT:  .LBB0_5:
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v0
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s3
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GCN-IR-NEXT:    v_mov_b32_e32 v0, s2
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, v1, 0, vcc
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, v0, 0, vcc
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v6, v3
; GCN-IR-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[2:3]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v5, v4
; GCN-IR-NEXT:    v_ffbh_u32_e32 v5, v2
; GCN-IR-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-IR-NEXT:    v_min_u32_e32 v14, v5, v6
; GCN-IR-NEXT:    v_ffbh_u32_e32 v5, v0
; GCN-IR-NEXT:    v_add_i32_e32 v5, vcc, 32, v5
; GCN-IR-NEXT:    v_ffbh_u32_e32 v6, v1
; GCN-IR-NEXT:    v_min_u32_e32 v15, v5, v6
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v14, v15
; GCN-IR-NEXT:    v_subb_u32_e64 v9, s[4:5], 0, 0, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[8:9]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v4, v5
; GCN-IR-NEXT:    v_xor_b32_e32 v6, 1, v4
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v4
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v4
; GCN-IR-NEXT:    v_cndmask_b32_e64 v4, v1, 0, vcc
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, v0, 0, vcc
; GCN-IR-NEXT:    v_cmp_ne_u64_e32 vcc, 63, v[8:9]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GCN-IR-NEXT:    v_and_b32_e32 v6, v6, v7
; GCN-IR-NEXT:    v_and_b32_e32 v6, 1, v6
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v6
; GCN-IR-NEXT:    s_and_saveexec_b64 s[6:7], vcc
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_lshr_b32 s2, s6, 8
...
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[4:5], s[6:7], 63
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[6:7], 63
; GCN-IR-NEXT:    v_or_b32_e32 v0, v0, v1
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[4:5]
; GCN-IR-NEXT:    v_or_b32_e32 v1, v0, v1
; GCN-IR-NEXT:    v_and_b32_e32 v1, 1, v1
...
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GCN-IR-NEXT:    v_mov_b32_e32 v1, 0
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, 24, 0, vcc
...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[0:1]
; GCN-IR-NEXT:    v_mov_b32_e32 v2, 0
; GCN-IR-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v3, v4, v3
; GCN-IR-NEXT:    v_xor_b32_e32 v4, 1, v3
; GCN-IR-NEXT:    v_and_b32_e32 v3, 1, v3
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v3
; GCN-IR-NEXT:    v_cndmask_b32_e64 v3, v5, 0, vcc
; GCN-IR-NEXT:    v_cmp_ne_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GCN-IR-NEXT:    v_and_b32_e32 v4, v4, v5
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v4
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v4
; GCN-IR-NEXT:    s_and_saveexec_b64 s[6:7], vcc
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v3, v1
; GCN-IR-NEXT:    v_min_u32_e32 v10, v2, v3
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, 48, v10
; GCN-IR-NEXT:    v_subb_u32_e64 v7, s[4:5], 0, 0, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[0:1]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v2, v3, v2
; GCN-IR-NEXT:    v_xor_b32_e32 v4, 1, v2
; GCN-IR-NEXT:    v_and_b32_e32 v2, 1, v2
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v2
; GCN-IR-NEXT:    v_cndmask_b32_e64 v2, v1, 0, vcc
; GCN-IR-NEXT:    v_cndmask_b32_e64 v3, v0, 0, vcc
; GCN-IR-NEXT:    v_cmp_ne_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GCN-IR-NEXT:    v_and_b32_e32 v4, v4, v5
; GCN-IR-NEXT:    v_and_b32_e32 v4, 1, v4
...
; GCN-IR-NEXT:    v_ffbh_u32_e32 v3, v1
; GCN-IR-NEXT:    v_min_u32_e32 v10, v2, v3
; GCN-IR-NEXT:    v_sub_i32_e32 v6, vcc, 59, v10
; GCN-IR-NEXT:    v_subb_u32_e64 v7, s[4:5], 0, 0, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, 63, v[6:7]
; GCN-IR-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GCN-IR-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[0:1]
