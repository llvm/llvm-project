...
; CHECK-NEXT:    ; kill: def $sgpr12 killed $sgpr12 def $sgpr12_13
...
; CHECK-NEXT:    ; kill: def $sgpr10 killed $sgpr10 def $sgpr10_11
...
; CHECK-NEXT:    ; kill: def $sgpr16 killed $sgpr16 def $sgpr16_17
; CHECK-NEXT:    s_mov_b32 s17, s14
; CHECK-NEXT:    ; kill: def $sgpr12_13 killed $sgpr12_13 def $sgpr12_15
; CHECK-NEXT:    s_mov_b64 s[14:15], s[10:11]
; CHECK-NEXT:    ; kill: def $sgpr8_9 killed $sgpr8_9 def $sgpr8_11
