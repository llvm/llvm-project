...
define amdgpu_kernel void @widget(ptr addrspace(1) %arg, i1 %arg1) {
  ...
  ; CHECK-NEXT:   renamable $sgpr1 = S_MOV_B32 0
  ...
  ; CHECK-NEXT:   liveins: $vgpr0, $vgpr4, $sgpr2_sgpr3, $sgpr4_sgpr5, $sgpr6_sgpr7, $sgpr0_sgpr1_sgpr2_sgpr3:0x000000000000000F, $vgpr0_vgpr1:0x000000000000000C, $vgpr2_vgpr3, $sgpr20_sgpr21_sgpr22_sgpr23
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   liveins: $vgpr0, $vgpr4, $sgpr2_sgpr3, $sgpr0_sgpr1_sgpr2_sgpr3:0x000000000000000F, $vgpr0_vgpr1:0x000000000000000C, $vgpr2_vgpr3, $sgpr20_sgpr21_sgpr22_sgpr23
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   S_WAITCNT 3952
  ...
  ; CHECK-NEXT:   liveins: $vgpr0, $vgpr4, $sgpr2_sgpr3, $sgpr6_sgpr7, $sgpr0_sgpr1_sgpr2_sgpr3:0x000000000000000F, $vgpr0_vgpr1:0x000000000000000C, $vgpr2_vgpr3, $sgpr20_sgpr21_sgpr22_sgpr23
  ; CHECK-NEXT: {{  $}}
