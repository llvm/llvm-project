...
define amdgpu_kernel void @widget(ptr addrspace(1) %arg, i1 %arg1) #0 {
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   $exec = bb-prolog S_OR_B64 $exec, killed renamable $sgpr8_sgpr9, implicit-def dead $scc
  ...
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   $exec = bb-prolog S_OR_B64 $exec, killed renamable $sgpr4_sgpr5, implicit-def dead $scc
