...
; GFX900-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX900-NEXT:    v_add_u32_e32 v6, 20, v3
; GFX900-NEXT:    v_cmp_lt_i32_e32 vcc, s8, v6
...
; GFX900-NEXT:    v_cmp_ne_u32_e32 vcc, 1, v5
; GFX900-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX900-NEXT:    s_mov_b64 s[4:5], 0
; GFX900-NEXT:    s_cbranch_vccnz .LBB2_4
; GFX900-NEXT:  ; %bb.3: ; %if
; GFX900-NEXT:    ; in Loop: Header=BB2_2 Depth=1
; GFX900-NEXT:    v_cmp_gt_i32_e32 vcc, 11, v6
; GFX900-NEXT:    s_andn2_b64 s[6:7], s[2:3], exec
; GFX900-NEXT:    s_and_b64 s[10:11], vcc, exec
; GFX900-NEXT:    s_mov_b64 s[4:5], -1
; GFX900-NEXT:    s_or_b64 s[6:7], s[6:7], s[10:11]
; GFX900-NEXT:  .LBB2_4: ; %Flow
; GFX900-NEXT:    ; in Loop: Header=BB2_2 Depth=1
; GFX900-NEXT:    s_and_saveexec_b64 s[10:11], s[6:7]
; GFX900-NEXT:    s_xor_b64 s[6:7], exec, s[10:11]
