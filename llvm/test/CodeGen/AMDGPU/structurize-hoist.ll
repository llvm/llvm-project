...
; GFX900-NEXT:    s_bitcmp1_b32 s0, 0
; GFX900-NEXT:    s_cselect_b64 s[0:1], -1, 0
; GFX900-NEXT:    v_mov_b32_e32 v1, s6
; GFX900-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX900-NEXT:    s_xor_b64 s[0:1], s[0:1], -1
