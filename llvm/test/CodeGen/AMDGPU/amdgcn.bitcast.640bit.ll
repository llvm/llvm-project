...
; SI-NEXT:    buffer_load_dword v10, off, s[0:3], s32 offset:28
...
; SI-NEXT:    v_lshlrev_b32_e32 v36, 16, v3
; SI-NEXT:    v_lshlrev_b32_e32 v41, 16, v5
...
; SI-NEXT:    s_waitcnt vmcnt(1)
; SI-NEXT:    v_lshlrev_b32_e32 v45, 16, v10
...
; SI-NEXT:    buffer_store_dword v43, off, s[0:3], s32 offset:92 ; 4-byte Folded Spill
...
; SI-NEXT:    buffer_store_dword v46, off, s[0:3], s32 offset:80 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v47, off, s[0:3], s32 offset:76 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v56, off, s[0:3], s32 offset:72 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v57, off, s[0:3], s32 offset:68 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v58, off, s[0:3], s32 offset:64 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v59, off, s[0:3], s32 offset:60 ; 4-byte Folded Spill
; SI-NEXT:    buffer_store_dword v60, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
...
; SI-NEXT:    v_cvt_f32_f16_e32 v34, v3
...
; SI-NEXT:    v_cvt_f32_f16_e32 v63, v5
...
; SI-NEXT:    v_cvt_f32_f16_e32 v59, v9
...
; SI-NEXT:    v_cvt_f32_f16_e32 v57, v11
; SI-NEXT:    v_cvt_f32_f16_e32 v62, v12
; SI-NEXT:    v_cvt_f32_f16_e32 v47, v13
...
; SI-NEXT:    v_cvt_f32_f16_e32 v45, v15
; SI-NEXT:    v_cvt_f32_f16_e32 v58, v16
...
; SI-NEXT:    v_cvt_f32_f16_e32 v56, v18
; SI-NEXT:    v_cvt_f32_f16_e32 v41, v19
; SI-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:164 ; 4-byte Folded Spill
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_cvt_f32_f16_e32 v1, v29
; SI-NEXT:    v_cvt_f32_f16_e32 v46, v20
; SI-NEXT:    v_cvt_f32_f16_e32 v44, v22
; SI-NEXT:    v_cvt_f32_f16_e32 v42, v24
...
; SI-NEXT:    buffer_load_dword v41, off, s[0:3], s32
...
; SI-NEXT:    v_cvt_f16_f32_e32 v38, v4
...
; SI-NEXT:    v_cvt_f16_f32_e32 v54, v10
...
; SI-NEXT:    v_cvt_f16_f32_e32 v14, v27
; SI-NEXT:    v_cvt_f16_f32_e32 v7, v28
; SI-NEXT:    v_cvt_f16_f32_e32 v11, v29
; SI-NEXT:    v_cvt_f16_f32_e32 v21, v30
; SI-NEXT:    s_waitcnt vmcnt(10)
; SI-NEXT:    v_cvt_f16_f32_e32 v9, v41
; SI-NEXT:    s_waitcnt vmcnt(9)
; SI-NEXT:    v_cvt_f16_f32_e32 v8, v42
; SI-NEXT:    s_waitcnt vmcnt(8)
; SI-NEXT:    v_cvt_f16_f32_e32 v6, v43
; SI-NEXT:    s_waitcnt vmcnt(7)
; SI-NEXT:    v_cvt_f16_f32_e32 v20, v44
; SI-NEXT:    s_waitcnt vmcnt(6)
...
; SI-NEXT:    s_waitcnt vmcnt(3)
; SI-NEXT:    v_cvt_f16_f32_e32 v19, v56
; SI-NEXT:    s_waitcnt vmcnt(2)
; SI-NEXT:    v_cvt_f16_f32_e32 v5, v57
; SI-NEXT:    s_waitcnt vmcnt(1)
; SI-NEXT:    v_cvt_f16_f32_e32 v1, v58
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v59
; SI-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SI-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; SI-NEXT:    s_andn2_saveexec_b64 s[4:5], s[4:5]
; SI-NEXT:    s_cbranch_execz .LBB29_2
; SI-NEXT:  ; %bb.1: ; %cmp.true
; SI-NEXT:    v_cvt_f32_f16_e32 v23, v40
...
; SI-NEXT:    v_or_b32_e32 v50, v24, v23
; SI-NEXT:    v_lshlrev_b32_e32 v24, 16, v25
; SI-NEXT:    v_cvt_f32_f16_e32 v25, v54
...
; SI-NEXT:    v_or_b32_e32 v49, v26, v24
; SI-NEXT:    v_cvt_f32_f16_e32 v26, v53
; SI-NEXT:    v_lshlrev_b32_e32 v25, 16, v25
; SI-NEXT:    v_or_b32_e32 v36, v27, v25
; SI-NEXT:    v_cvt_f32_f16_e32 v27, v34
; SI-NEXT:    v_cvt_f32_f16_e32 v28, v52
; SI-NEXT:    v_add_f32_e32 v26, 0x38000000, v26
; SI-NEXT:    v_cvt_f16_f32_e32 v26, v26
; SI-NEXT:    v_add_f32_e32 v27, 0x38000000, v27
...
; SI-NEXT:    v_or_b32_e32 v34, v27, v26
...
; SI-NEXT:    v_lshlrev_b32_e32 v19, 16, v20
; SI-NEXT:    v_add_f32_e32 v20, 0x38000000, v29
; SI-NEXT:    v_add_f32_e32 v1, 0x38000000, v1
; SI-NEXT:    v_cvt_f32_f16_e32 v14, v14
...
; SI-NEXT:    v_add_f32_e32 v9, 0x38000000, v9
; SI-NEXT:    v_add_f32_e32 v7, 0x38000000, v7
; SI-NEXT:    v_cvt_f32_f16_e32 v30, v35
; SI-NEXT:    v_cvt_f16_f32_e32 v9, v9
; SI-NEXT:    v_cvt_f16_f32_e32 v7, v7
; SI-NEXT:    v_add_f32_e32 v14, 0x38000000, v14
; SI-NEXT:    v_add_f32_e32 v10, 0x38000000, v10
...
; SI-NEXT:    v_or_b32_e32 v35, v30, v20
...
; SI-NEXT:    v_cvt_f32_f16_e32 v30, v48
...
; SI-NEXT:    v_add_f32_e32 v20, 0x38000000, v20
; SI-NEXT:    v_cvt_f16_f32_e32 v30, v30
; SI-NEXT:    v_cvt_f16_f32_e32 v38, v20
; SI-NEXT:    v_add_f32_e32 v20, 0x38000000, v39
; SI-NEXT:    v_add_f32_e32 v15, 0x38000000, v15
; SI-NEXT:    v_add_f32_e32 v13, 0x38000000, v13
; SI-NEXT:    v_add_f32_e32 v11, 0x38000000, v11
; SI-NEXT:    v_add_f32_e32 v6, 0x38000000, v6
...
; SI-NEXT:    v_cvt_f16_f32_e32 v6, v6
; SI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; SI-NEXT:    v_lshlrev_b32_e32 v39, 16, v37
; SI-NEXT:    v_or_b32_e32 v48, v30, v39
; SI-NEXT:    v_lshlrev_b32_e32 v30, 16, v38
; SI-NEXT:    v_or_b32_e32 v39, v20, v30
...
; SI-NEXT:    v_alignbit_b32 v40, v39, v23, 16
; SI-NEXT:    v_alignbit_b32 v55, v48, v24, 16
; SI-NEXT:    v_alignbit_b32 v54, v33, v25, 16
; SI-NEXT:    v_alignbit_b32 v53, v35, v26, 16
; SI-NEXT:    v_alignbit_b32 v52, v18, v27, 16
; SI-NEXT:    v_alignbit_b32 v51, v12, v22, 16
; SI-NEXT:    v_alignbit_b32 v22, v14, v21, 16
; SI-NEXT:    v_alignbit_b32 v21, v9, v28, 16
; SI-NEXT:    v_alignbit_b32 v20, v3, v19, 16
...
; SI-NEXT:    buffer_store_dword v16, v23, s[0:3], 0 offen
; SI-NEXT:    s_waitcnt expcnt(0)
; SI-NEXT:    v_and_b32_e32 v16, 0xffff, v32
...
; SI-NEXT:    v_add_i32_e32 v17, vcc, 36, v0
...
; SI-NEXT:    v_add_i32_e32 v8, vcc, 60, v0
