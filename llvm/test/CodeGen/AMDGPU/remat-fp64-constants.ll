; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa --stress-regalloc=10 < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -global-isel -mtriple=amdgpu9.00-amd-amdhsa --stress-regalloc=10 < %s | FileCheck -check-prefix=GCN %s
