...
; RUN: llc -mtriple=amdgpu9.00--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -mtriple=amdgpu11.00--amdpal -enable-ipra=0 < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX9-NEXT:    s_mov_b32 s35, void_func_void_clobber_s33@abs32@hi
; GFX9-NEXT:    s_mov_b32 s34, void_func_void_clobber_s33@abs32@lo
; GFX9-NEXT:    s_swappc_b64 s[30:31], s[34:35]
...
; GFX10-NEXT:    s_mov_b32 s35, void_func_void_clobber_s33@abs32@hi
; GFX10-NEXT:    s_mov_b32 s34, void_func_void_clobber_s33@abs32@lo
; GFX10-NEXT:    s_swappc_b64 s[30:31], s[34:35]
...
; GFX11-NEXT:    s_mov_b32 s1, void_func_void_clobber_s33@abs32@hi
; GFX11-NEXT:    s_mov_b32 s0, void_func_void_clobber_s33@abs32@lo
...
; GFX9-NEXT:    s_addk_i32 s32, 0x400
; GFX9-NEXT:    v_writelane_b32 v40, s31, 1
; GFX9-NEXT:    s_mov_b32 s35, void_func_void_clobber_s34@abs32@hi
; GFX9-NEXT:    s_mov_b32 s34, void_func_void_clobber_s34@abs32@lo
; GFX9-NEXT:    s_swappc_b64 s[30:31], s[34:35]
; GFX9-NEXT:    v_readlane_b32 s30, v40, 0
; GFX9-NEXT:    v_readlane_b32 s31, v40, 1
; GFX9-NEXT:    s_mov_b32 s32, s33
...
; GFX10-NEXT:    v_writelane_b32 v40, s30, 0
; GFX10-NEXT:    v_writelane_b32 v40, s31, 1
; GFX10-NEXT:    s_mov_b32 s35, void_func_void_clobber_s34@abs32@hi
; GFX10-NEXT:    s_mov_b32 s34, void_func_void_clobber_s34@abs32@lo
; GFX10-NEXT:    s_swappc_b64 s[30:31], s[34:35]
; GFX10-NEXT:    v_readlane_b32 s30, v40, 0
; GFX10-NEXT:    v_readlane_b32 s31, v40, 1
; GFX10-NEXT:    s_mov_b32 s32, s33
...
; GFX11-NEXT:    v_writelane_b32 v40, s30, 0
; GFX11-NEXT:    v_writelane_b32 v40, s31, 1
; GFX11-NEXT:    s_mov_b32 s1, void_func_void_clobber_s34@abs32@hi
; GFX11-NEXT:    s_mov_b32 s0, void_func_void_clobber_s34@abs32@lo
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX11-NEXT:    v_readlane_b32 s30, v40, 0
; GFX11-NEXT:    v_readlane_b32 s31, v40, 1
