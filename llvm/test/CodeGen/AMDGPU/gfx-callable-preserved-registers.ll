...
; RUN: llc -mtriple=amdgcn--amdpal -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -enable-ipra=0 -verify-machineinstrs < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    s_add_u32 s32, s32, 16
; GFX11-NEXT:    v_writelane_b32 v40, s34, 0
; GFX11-NEXT:    v_writelane_b32 v40, s35, 1
; GFX11-NEXT:    s_getpc_b64 s[34:35]
; GFX11-NEXT:    s_add_u32 s34, s34, external_void_func_void@rel32@lo+4
; GFX11-NEXT:    s_addc_u32 s35, s35, external_void_func_void@rel32@hi+12
...
; GFX11-NEXT:    v_readlane_b32 s1, v40, 3
...
; GFX10-NEXT:    s_setpc_b64 s[4:5]
;
; GFX11-LABEL: void_func_void_clobber_s30_s31:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_mov_b64 s[0:1], s[30:31]
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ; clobber
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_setpc_b64 s[0:1]
...
; GFX11-NEXT:    ; def s31
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    s_mov_b32 s34, s31
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX11-NEXT:    v_readlane_b32 s0, v40, 1
; GFX11-NEXT:    s_mov_b32 s31, s34
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ; use s31
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    v_readlane_b32 s1, v40, 2
; GFX11-NEXT:    v_readlane_b32 s34, v40, 0
; GFX11-NEXT:    s_sub_u32 s32, s32, 16
...
; GFX11-NEXT:    s_add_u32 s0, s0, external_void_func_void@rel32@lo+4
; GFX11-NEXT:    s_addc_u32 s1, s1, external_void_func_void@rel32@hi+12
; GFX11-NEXT:    v_writelane_b32 v40, s33, 0
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ; def s33
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    v_writelane_b32 v40, s30, 1
...
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    v_readlane_b32 s0, v40, 1
; GFX11-NEXT:    v_readlane_b32 s33, v40, 0
; GFX11-NEXT:    v_readlane_b32 s1, v40, 2
; GFX11-NEXT:    s_sub_u32 s32, s32, 16
; GFX11-NEXT:    v_readlane_b32 s33, v40, 3
; GFX11-NEXT:    s_or_saveexec_b32 s2, -1
...
; GFX11-NEXT:    s_add_u32 s0, s0, external_void_func_void@rel32@lo+4
; GFX11-NEXT:    s_addc_u32 s1, s1, external_void_func_void@rel32@hi+12
; GFX11-NEXT:    v_writelane_b32 v40, s40, 0
; GFX11-NEXT:    ;;#ASMSTART
; GFX11-NEXT:    ; def s40
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    v_writelane_b32 v40, s30, 1
...
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    v_readlane_b32 s1, v40, 2
; GFX11-NEXT:    v_readlane_b32 s40, v40, 0
; GFX11-NEXT:    s_sub_u32 s32, s32, 16
; GFX11-NEXT:    v_readlane_b32 s33, v40, 3
; GFX11-NEXT:    s_or_saveexec_b32 s2, -1
; GFX11-NEXT:    scratch_load_b32 v40, off, s32 ; 4-byte Folded Reload
...
; GFX11-NEXT:    scratch_store_b32 off, v41, s32 offset:4 ; 4-byte Folded Spill
; GFX11-NEXT:    s_mov_b32 exec_lo, s0
; GFX11-NEXT:    v_writelane_b32 v41, s33, 3
; GFX11-NEXT:    s_mov_b32 s33, s32
; GFX11-NEXT:    s_add_u32 s32, s32, 16
; GFX11-NEXT:    s_getpc_b64 s[0:1]
; GFX11-NEXT:    s_add_u32 s0, s0, external_void_func_void@rel32@lo+4
...
; GFX11-NEXT:    ;;#ASMEND
; GFX11-NEXT:    scratch_load_b32 v40, off, s33 ; 4-byte Folded Reload
; GFX11-NEXT:    v_readlane_b32 s0, v41, 1
; GFX11-NEXT:    v_readlane_b32 s1, v41, 2
; GFX11-NEXT:    v_readlane_b32 s40, v41, 0
; GFX11-NEXT:    s_sub_u32 s32, s32, 16
; GFX11-NEXT:    v_readlane_b32 s33, v41, 3
; GFX11-NEXT:    s_or_saveexec_b32 s2, -1
; GFX11-NEXT:    scratch_load_b32 v41, off, s32 offset:4 ; 4-byte Folded Reload
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
