...
;
; GFX11-TRUE16-SDAG-LABEL: undef_lo_v2i16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
...
;
; GFX11-TRUE16-GISEL-LABEL: undef_lo_v2i16:
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_lo_v2f16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v1.h, v0.l
...
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_lo_v2f16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    v_mov_b16_e32 v0.h, v0.l
; GFX11-TRUE16-GISEL-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_lo_op_v2f16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v1.h, v0.l
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_lo_op_v2f16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    v_mov_b16_e32 v0.h, v0.l
...
; GFX8-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX8-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr4 killed $exec
; GFX8-SDAG-NEXT:    ;;#ASMSTART
...
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX9-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr4 killed $exec
; GFX9-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX11-FAKE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-FAKE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_lo3_v4i16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v1.h, v0.l
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr2 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMSTART
; GFX11-TRUE16-SDAG-NEXT:    ; use v[1:2]
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMEND
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_lo3_v4i16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    v_mov_b16_e32 v0.h, v0.l
; GFX11-TRUE16-GISEL-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_lo3_v4f16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v1.h, v0.l
...
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_lo3_v4f16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    v_mov_b16_e32 v0.h, v0.l
; GFX11-TRUE16-GISEL-NEXT:    ;;#ASMSTART
...
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-SDAG-LABEL: undef_lo2_v4i16:
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-SDAG-NEXT:    v_perm_b32 v0, v0, v0, s4
; GFX9-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr4 killed $exec
; GFX9-SDAG-NEXT:    ;;#ASMSTART
; GFX9-SDAG-NEXT:    ; use v[0:1]
; GFX9-SDAG-NEXT:    ;;#ASMEND
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-GISEL-LABEL: undef_lo2_v4i16:
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-GISEL-NEXT:    v_perm_b32 v0, v0, v0, s4
; GFX9-GISEL-NEXT:    ;;#ASMSTART
; GFX9-GISEL-NEXT:    ; use v[0:1]
; GFX9-GISEL-NEXT:    ;;#ASMEND
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-SDAG-LABEL: undef_lo2_v4i16:
; GFX11-FAKE16-SDAG:       ; %bb.0:
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-SDAG-NEXT:    v_perm_b32 v0, v0, v0, 0x7060302
; GFX11-FAKE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-FAKE16-SDAG-NEXT:    ;;#ASMSTART
; GFX11-FAKE16-SDAG-NEXT:    ; use v[0:1]
; GFX11-FAKE16-SDAG-NEXT:    ;;#ASMEND
; GFX11-FAKE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-GISEL-LABEL: undef_lo2_v4i16:
; GFX11-FAKE16-GISEL:       ; %bb.0:
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    v_perm_b32 v0, v0, v0, 0x7060302
; GFX11-FAKE16-GISEL-NEXT:    ;;#ASMSTART
; GFX11-FAKE16-GISEL-NEXT:    ; use v[0:1]
; GFX11-FAKE16-GISEL-NEXT:    ;;#ASMEND
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-SDAG-LABEL: undef_lo2_v4f16:
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-SDAG-NEXT:    v_perm_b32 v0, v0, v0, s4
...
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-GISEL-LABEL: undef_lo2_v4f16:
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    s_mov_b32 s4, 0x7060302
; GFX9-GISEL-NEXT:    v_perm_b32 v0, v0, v0, s4
...
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-SDAG-LABEL: undef_lo2_v4f16:
; GFX11-FAKE16-SDAG:       ; %bb.0:
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-SDAG-NEXT:    v_perm_b32 v0, v0, v0, 0x7060302
; GFX11-FAKE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
...
; GFX11-FAKE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-GISEL-LABEL: undef_lo2_v4f16:
; GFX11-FAKE16-GISEL:       ; %bb.0:
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    v_perm_b32 v0, v0, v0, 0x7060302
; GFX11-FAKE16-GISEL-NEXT:    ;;#ASMSTART
...
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMSTART
; GFX11-TRUE16-SDAG-NEXT:    ; use v0
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMEND
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-SDAG-LABEL: undef_hi2_v4i16:
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr4 killed $exec
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    ;;#ASMSTART
...
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-GISEL-LABEL: undef_hi2_v4i16:
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    ;;#ASMSTART
; GFX9-GISEL-NEXT:    ; use v[0:1]
...
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-SDAG-LABEL: undef_hi2_v4i16:
; GFX11-FAKE16-SDAG:       ; %bb.0:
; GFX11-FAKE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-GISEL-LABEL: undef_hi2_v4i16:
; GFX11-FAKE16-GISEL:       ; %bb.0:
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    ;;#ASMSTART
; GFX11-FAKE16-GISEL-NEXT:    ; use v[0:1]
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_hi2_v4i16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_hi2_v4i16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    ;;#ASMSTART
; GFX11-TRUE16-GISEL-NEXT:    ; use v[0:1]
...
; GFX8-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-SDAG-LABEL: undef_hi2_v4f16:
; GFX9-SDAG:       ; %bb.0:
; GFX9-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr4 killed $exec
; GFX9-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG-NEXT:    ;;#ASMSTART
...
; GFX9-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-GISEL-LABEL: undef_hi2_v4f16:
; GFX9-GISEL:       ; %bb.0:
; GFX9-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-GISEL-NEXT:    ;;#ASMSTART
; GFX9-GISEL-NEXT:    ; use v[0:1]
...
; GFX9-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-SDAG-LABEL: undef_hi2_v4f16:
; GFX11-FAKE16-SDAG:       ; %bb.0:
; GFX11-FAKE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-FAKE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-FAKE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-FAKE16-GISEL-LABEL: undef_hi2_v4f16:
; GFX11-FAKE16-GISEL:       ; %bb.0:
; GFX11-FAKE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-GISEL-NEXT:    ;;#ASMSTART
; GFX11-FAKE16-GISEL-NEXT:    ; use v[0:1]
...
; GFX11-FAKE16-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-SDAG-LABEL: undef_hi2_v4f16:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
; GFX11-TRUE16-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-SDAG-NEXT:    ;;#ASMSTART
...
; GFX11-TRUE16-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-TRUE16-GISEL-LABEL: undef_hi2_v4f16:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-GISEL-NEXT:    ;;#ASMSTART
; GFX11-TRUE16-GISEL-NEXT:    ; use v[0:1]
