...
; RUN: llc < %s -mtriple=amdgcn--amdhsa -mcpu=gfx1010 -mattr=+wavefrontsize32,-wavefrontsize64 | FileCheck --check-prefix=GFX10PLUS --check-prefix=GFX10PLUS-W32 %s
; RUN: llc < %s -mtriple=amdgcn--amdhsa -mcpu=gfx1010 -mattr=-wavefrontsize32,+wavefrontsize64 | FileCheck --check-prefix=GFX10PLUS --check-prefix=GFX10PLUS-W64 %s
; RUN: llc < %s -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -mattr=+wavefrontsize32,-wavefrontsize64 | FileCheck --check-prefix=GFX10PLUS --check-prefix=GFX10PLUS-W32 %s
; RUN: llc < %s -mtriple=amdgcn--amdhsa -mcpu=gfx1100 -mattr=-wavefrontsize32,+wavefrontsize64 | FileCheck --check-prefix=GFX10PLUS --check-prefix=GFX10PLUS-W64 %s
...
; PRE-GFX10PLUS: enable_wavefront_size32 = 0
; GFX10PLUS-W32: .amdhsa_wavefront_size32 1
; GFX10PLUS-W64: .amdhsa_wavefront_size32 0

; PRE-GFX10PLUS: wavefront_size = 6
...
; PRE-GFX10PLUS: flat_store_dword v{{\[[0-9]+:[0-9]+\]}}, v{{[0-9]+}}
; GFX10PLUS: global_store_{{dword|b32}} v{{\[[0-9]+:[0-9]+\]}}, v{{[0-9]+}}, off
