...
define amdgpu_kernel void @test_spill_cost_reset(
  ...
  ; CHECK-NEXT:   early-clobber %1843:sgpr_256 = S_LOAD_DWORDX8_IMM_ec [[COPY]](p4), 16, 0 :: (dereferenceable invariant load (s256) from %ir.a0.kernarg.offset, align 16, addrspace 4)
  ; CHECK-NEXT:   early-clobber %1844:sgpr_256 = S_LOAD_DWORDX8_IMM_ec [[COPY]](p4), 48, 0 :: (dereferenceable invariant load (s256) from %ir.b0.kernarg.offset, align 16, addrspace 4)
  ; CHECK-NEXT:   undef [[V_MOV_B32_e32_:%[0-9]+]].sub0:vreg_128_align2 = V_MOV_B32_e32 0, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:av_128_align2 = COPY %1843.sub0_sub1_sub2_sub3
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:av_128_align2 = COPY %1844.sub0_sub1_sub2_sub3
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:av_128_align2 = COPY %1843.sub4_sub5_sub6_sub7
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:av_128_align2 = COPY %1844.sub4_sub5_sub6_sub7
  ; CHECK-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY5:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY6:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY7:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY8:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY9:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY10:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY11:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY12:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY13:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY14:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY15:%[0-9]+]].sub0:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]].sub1:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]].sub2:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]].sub3:vreg_128_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ...
  ; CHECK-NEXT:   undef [[COPY133:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY133:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY134:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY134:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY135:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY135:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY136:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY136:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY137:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY137:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY138:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY138:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY139:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY139:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY140:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY140:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY141:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY141:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY142:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY142:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY143:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY143:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.1.loop:
  ; CHECK-NEXT:   successors: %bb.2(0x04000000), %bb.1(0x7c000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[COPY15:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY15]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY143:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY143]], 8, [[COPY143]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY142:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY142]], 8, [[COPY142]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY141:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY141]], 8, [[COPY141]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY140:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY140]], 8, [[COPY140]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY139:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY139]], 8, [[COPY139]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY14:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY14]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY138:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY138]], 8, [[COPY138]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY137:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY137]], 8, [[COPY137]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY136:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY136]], 8, [[COPY136]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY13:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY13]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY135:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY135]], 8, [[COPY135]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY134:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY134]], 8, [[COPY134]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY133:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY133]], 8, [[COPY133]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY12:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY12]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY11:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY11]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY10:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY10]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY9:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY9]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY8:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY8]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY7:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY7]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY6:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY6]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY5:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[COPY5]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY1]], [[COPY2]], [[V_MOV_B32_e32_]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY3]], [[COPY4]], [[COPY15]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   GLOBAL_STORE_DWORD_SADDR [[V_MOV_B32_e32_1]], [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_2]].sub0, [[S_LOAD_DWORDX2_IMM]], 0, 0, implicit $exec :: (store (s32) into %ir.out.load, addrspace 1)
