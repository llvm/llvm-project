...
define amdgpu_kernel void @test_spill_cost_reset(
  ...
  ; CHECK-NEXT:   undef [[COPY1:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY2:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY3:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   undef [[COPY4:%[0-9]+]].sub0:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ...
  ; CHECK-NEXT:   [[COPY103:%[0-9]+]]:av_128_align2 = COPY %1892.sub0_sub1_sub2_sub3
  ; CHECK-NEXT:   [[COPY102:%[0-9]+]].sub1:vreg_64_align2 = COPY [[V_MOV_B32_e32_]].sub0
  ; CHECK-NEXT:   [[COPY104:%[0-9]+]]:av_128_align2 = COPY %1891.sub0_sub1_sub2_sub3
  ...
  ; CHECK-NEXT:   [[COPY130:%[0-9]+]]:av_128_align2 = COPY %1891.sub4_sub5_sub6_sub7
  ; CHECK-NEXT:   [[COPY131:%[0-9]+]]:av_128_align2 = COPY %1892.sub4_sub5_sub6_sub7
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT: bb.1.loop:
  ; CHECK-NEXT:   successors: %bb.2(0x04000000), %bb.1(0x7c000000)
  ; CHECK-NEXT: {{  $}}
  ; CHECK-NEXT:   [[V_MOV_B32_e32_12:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_12]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY130]], [[COPY131]], [[V_MOV_B32_e32_12]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_1:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_]], 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_2:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY130]], [[COPY131]], [[V_MFMA_F32_16X16X32_F16_vgprcd_e64_1]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_11:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_11]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_10:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_10]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_9:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_9]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_8:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_8]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_7:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_7]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_6:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_6]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_5:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_5]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_4:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_4]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_3:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_3]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_2:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_2]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[V_MOV_B32_e32_1:%[0-9]+]]:vreg_128_align2 = V_MFMA_F32_16X16X32_F16_vgprcd_e64 [[COPY104]], [[COPY103]], [[V_MOV_B32_e32_1]], 0, 0, 0, implicit $mode, implicit $exec
  ...
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY4]], 8, [[COPY4]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY3]], 8, [[COPY3]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY2]], 8, [[COPY2]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:vreg_64_align2 = nofpexcept V_PK_ADD_F32 8, [[COPY1]], 8, [[COPY1]], 0, 0, 0, 0, 0, implicit $mode, implicit $exec
