...
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa -global-isel=0 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,SDAG %s
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa -global-isel=1 < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GISEL %s
