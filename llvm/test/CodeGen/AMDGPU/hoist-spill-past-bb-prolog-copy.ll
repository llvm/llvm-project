...
;
; Test that hoistSpillInsideBB does not place a spill save of a source register
; past a live-range-split copy that kills it. On AMDGPU, WWM_COPY instructions
; used for live-range splitting are considered basic block prologue instructions,
; so SkipPHIsLabelsAndDebug may advance past them. The spill must be inserted
; before the copy to stay within the source register's live range.
;
; See https://github.com/llvm/llvm-project/issues/176538
...
; CHECK-NEXT:    scratch_load_u16 v120, off, s34 offset:144
; CHECK-NEXT:    scratch_load_u16 v121, off, s34 offset:140
; CHECK-NEXT:    scratch_load_u16 v111, off, s34 offset:136
; CHECK-NEXT:    scratch_load_u16 v122, off, s34 offset:132
...
; CHECK-NEXT:    v_perm_b32 v0, v110, v109, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v1, v108, v107, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v2, v106, v105, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v3, v104, v95, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v4, v94, v93, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v5, v92, v91, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v6, v90, v89, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v7, v88, v79, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v8, v78, v77, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v9, v76, v75, 0xc0c0004
; CHECK-NEXT:    v_lshl_or_b32 v75, v1, 16, v0
; CHECK-NEXT:    v_lshl_or_b32 v76, v3, 16, v2
; CHECK-NEXT:    v_lshl_or_b32 v77, v5, 16, v4
; CHECK-NEXT:    v_lshl_or_b32 v78, v7, 16, v6
; CHECK-NEXT:    v_lshl_or_b32 v88, v9, 16, v8
; CHECK-NEXT:    v_perm_b32 v0, v74, v73, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v1, v72, v63, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v2, v62, v61, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v3, v60, v187, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v4, v186, v185, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v5, v184, v175, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v6, v174, v173, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v7, v172, v171, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v8, v170, v169, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v9, v168, v159, 0xc0c0004
; CHECK-NEXT:    v_lshl_or_b32 v89, v1, 16, v0
; CHECK-NEXT:    v_lshl_or_b32 v90, v3, 16, v2
; CHECK-NEXT:    v_lshl_or_b32 v91, v5, 16, v4
; CHECK-NEXT:    v_lshl_or_b32 v60, v7, 16, v6
; CHECK-NEXT:    v_lshl_or_b32 v61, v9, 16, v8
; CHECK-NEXT:    v_perm_b32 v0, v158, v157, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v1, v156, v155, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v2, v154, v153, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v3, v152, v143, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v4, v142, v141, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v5, v140, v139, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v6, v138, v137, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v7, v136, v127, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v8, v126, v125, 0xc0c0004
; CHECK-NEXT:    v_perm_b32 v9, v124, v123, 0xc0c0004
; CHECK-NEXT:    v_lshl_or_b32 v62, v1, 16, v0
; CHECK-NEXT:    v_lshl_or_b32 v63, v3, 16, v2
; CHECK-NEXT:    v_lshl_or_b32 v92, v5, 16, v4
; CHECK-NEXT:    v_lshl_or_b32 v93, v7, 16, v6
; CHECK-NEXT:    v_lshl_or_b32 v94, v9, 16, v8
; CHECK-NEXT:    v_perm_b32 v72, v121, v120, 0xc0c0004
; CHECK-NEXT:    v_and_b32_e32 v73, 0xff, v122
; CHECK-NEXT:    v_and_b32_e32 v74, 0xff, v111
...
; CHECK-NEXT:    scratch_store_b128 v59, v[75:78], off
; CHECK-NEXT:    scratch_store_b128 v59, v[88:91], off offset:16
; CHECK-NEXT:    s_wait_kmcnt 0x0
; CHECK-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; CHECK-NEXT:    s_wait_alu depctr_sa_sdst(0)
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[68:69]
; CHECK-NEXT:    v_cmp_ne_u16_e32 vcc_lo, 0, v74
...
; CHECK-NEXT:    v_or_b32_e32 v0, v73, v0
; CHECK-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; CHECK-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; CHECK-NEXT:    v_lshl_or_b32 v95, v72, 16, v0
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    scratch_store_b128 off, v[92:95], s66
; CHECK-NEXT:    scratch_store_b128 off, v[60:63], s65
; CHECK-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; CHECK-NEXT:  ; %bb.2: ; %for.body3.preheader
...
; CHECK-NEXT:  .LBB1_5: ; %Flow1
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    v_readlane_b32 s0, v57, 4
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; CHECK-NEXT:  ; %bb.6: ; %for.cond.loopexit
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
