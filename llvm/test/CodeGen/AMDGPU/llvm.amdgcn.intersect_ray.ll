...
; GFX11-NEXT:    v_dual_mov_b32 v1, 0x40e00000 :: v_dual_lshlrev_b32 v0, 2, v0
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, 0x40e00000 :: v_dual_lshlrev_b32 v0, 2, v0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_mov_b32 v6, 0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v8, 2.0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    global_load_b32 v9, v0, s[0:1]
; GFX12-SDAG-NEXT:    global_load_b32 v10, v0, s[2:3]
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v3, s8 :: v_dual_lshlrev_b32 v0, 2, v0
...
; GFX12-GISEL-NEXT:    global_load_b32 v9, v0, s[0:1]
; GFX12-GISEL-NEXT:    global_load_b32 v10, v0, s[2:3]
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:    s_mov_b32 s2, 2.0
; GFX12-GISEL-NEXT:    s_mov_b32 s1, 1.0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v5, s10
...
; GFX11-NEXT:    v_dual_mov_b32 v4, 1.0 :: v_dual_mov_b32 v1, 0x47004400
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
...
; GFX11-NEXT:    v_dual_mov_b32 v0, 0x46004200 :: v_dual_mov_b32 v5, 2.0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v4, 1.0 :: v_dual_mov_b32 v1, 0x47004400
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX12-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    s_clause 0x1
; GFX12-SDAG-NEXT:    global_load_b32 v6, v0, s[0:1]
; GFX12-SDAG-NEXT:    global_load_b32 v7, v0, s[2:3]
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v0, 0x46004200 :: v_dual_mov_b32 v5, 2.0
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    s_clause 0x1
; GFX12-GISEL-NEXT:    global_load_b32 v6, v0, s[0:1]
; GFX12-GISEL-NEXT:    global_load_b32 v7, v0, s[2:3]
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:    s_mov_b32 s2, 2.0
; GFX12-GISEL-NEXT:    s_mov_b32 s1, 1.0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v5, s10
...
; GFX1013-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1013-NEXT:    global_load_dword v2, v0, s[6:7]
...
; GFX1030-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1030-NEXT:    global_load_dword v2, v0, s[6:7]
...
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    global_load_b32 v11, v0, s[6:7]
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    global_load_b32 v11, v0, s[6:7]
...
; GFX11-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-NEXT:    v_mov_b32_e32 v2, 0x48004500
; GFX11-NEXT:    v_dual_mov_b32 v1, 0x47004400 :: v_dual_mov_b32 v4, 1.0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v2, 0x48004500
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, 0x47004400 :: v_dual_mov_b32 v4, 1.0
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX12-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    global_load_b32 v8, v0, s[6:7]
...
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v4, s9
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    global_load_b32 v8, v0, s[6:7]
; GFX12-GISEL-NEXT:    s_mov_b32 s6, 2.0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v1, s5
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v2, s6
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
