...
; GFX12-NEXT:    image_bvh_intersect_ray v[0:3], v[0:10], s[0:3]
...
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    image_bvh64_intersect_ray v[0:3], v[0:11], s[0:3]
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: image_bvh_intersect_ray_nsa_reassign:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    s_load_b256 s[0:7], s[0:1], 0x24
; GFX12-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_lshlrev_b32 v2, 2, v0
; GFX12-NEXT:    v_mov_b32_e32 v6, 0
; GFX12-NEXT:    v_mov_b32_e32 v8, 2.0
; GFX12-NEXT:    v_dual_mov_b32 v4, 4.0 :: v_dual_mov_b32 v7, 1.0
...
; GFX12-NEXT:    flat_load_b32 v9, v[0:1]
; GFX12-NEXT:    flat_load_b32 v10, v[2:3]
; GFX12-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX12-NEXT:    v_mov_b32_e32 v1, 0x40e00000
; GFX12-NEXT:    v_mov_b32_e32 v2, 0x41000000
; GFX12-NEXT:    v_mov_b32_e32 v3, 0x40400000
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    image_bvh_intersect_ray v[0:3], [v9, v10, v[6:8], v[3:5], v[0:2]], s[4:7]
; GFX12-NEXT:    s_wait_bvhcnt 0x0
...
; GFX12-NEXT:    v_dual_mov_b32 v0, 0x46004200 :: v_dual_mov_b32 v3, 0
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: image_bvh64_intersect_ray_nsa_reassign:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    s_load_b64 s[4:5], s[0:1], 0x24
; GFX12-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX12-NEXT:    s_load_b128 s[0:3], s[0:1], 0x34
; GFX12-NEXT:    v_mov_b32_e32 v2, 0x41000000
; GFX12-NEXT:    v_dual_mov_b32 v3, 0x40400000 :: v_dual_mov_b32 v4, 4.0
; GFX12-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_mov_b32 v6, 0
; GFX12-NEXT:    v_dual_mov_b32 v8, 2.0 :: v_dual_mov_b32 v9, 0xb36211c7
; GFX12-NEXT:    v_dual_mov_b32 v10, 0x102 :: v_dual_mov_b32 v7, 1.0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s5, 0, s4
; GFX12-NEXT:    flat_load_b32 v11, v[0:1]
; GFX12-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX12-NEXT:    v_mov_b32_e32 v1, 0x40e00000
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    image_bvh64_intersect_ray v[0:3], [v[9:10], v11, v[6:8], v[3:5], v[0:2]], s[0:3]
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    flat_store_b128 v[0:1], v[0:3]
; GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-NEXT:    s_endpgm
...
; GFX12-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX12-NEXT:    s_load_b128 s[0:3], s[0:1], 0x34
; GFX12-NEXT:    v_dual_mov_b32 v2, 0x48004500 :: v_dual_mov_b32 v5, 2.0
; GFX12-NEXT:    v_dual_mov_b32 v4, 1.0 :: v_dual_mov_b32 v7, 0x102
; GFX12-NEXT:    v_dual_mov_b32 v6, 0xb36211c6 :: v_dual_mov_b32 v3, 0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, s5, 0, s4
