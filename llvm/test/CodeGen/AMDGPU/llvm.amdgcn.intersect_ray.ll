...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_load_b64 s[4:5], s[2:3], 0x24
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v7, 1.0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[2:3], 0x34
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v2, 0x41000000
...
; GFX12-GISEL-NEXT:    s_mov_b32 s13, 0x40e00000
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v10, s17 :: v_dual_mov_b32 v3, s8
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v6, s12
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v4, s9
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v5, s10
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-GISEL-NEXT:    s_mov_b32 s10, 0x45004800
; GFX12-GISEL-NEXT:    s_wait_alu 0xfffe
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v6, s12 :: v_dual_mov_b32 v3, s8
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v7, s13
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[2:3], 0x34
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v5, s10
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
