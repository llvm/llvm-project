...
; RUN: llc -march=amdgcn -mcpu=gfx1013 -verify-machineinstrs < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX1013 %s
; RUN: llc -march=amdgcn -mcpu=gfx1030 -verify-machineinstrs < %s | FileCheck -check-prefixes=PRE-GFX12,GFX10,GFX1030 %s
; RUN: not --crash llc -march=amdgcn -mcpu=gfx1012 -verify-machineinstrs < %s 2>&1 | FileCheck -check-prefix=ERR %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -verify-machineinstrs < %s | FileCheck -check-prefixes=PRE-GFX12,GFX11 %s
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_mov_b32 s21, s2
; GFX12-GISEL-NEXT:    s_mov_b32 s22, s3
; GFX12-GISEL-NEXT:    s_mov_b32 s23, s4
; GFX12-GISEL-NEXT:    s_pack_ll_b32_b16 s3, s7, s5
; GFX12-GISEL-NEXT:    s_pack_hh_b32_b16 s4, s7, s5
; GFX12-GISEL-NEXT:    s_pack_ll_b32_b16 s5, s8, s6
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s21 :: v_dual_mov_b32 v1, s22
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v2, s23 :: v_dual_mov_b32 v3, s3
...
; GFX12-GISEL-NEXT:    s_pack_ll_b32_b16 s12, s8, s6
; GFX12-GISEL-NEXT:    s_mov_b32 s19, s13
; GFX12-GISEL-NEXT:    s_pack_hh_b32_b16 s13, s8, s6
; GFX12-GISEL-NEXT:    s_pack_ll_b32_b16 s14, s9, s7
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v3, s12
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v7, s1 :: v_dual_mov_b32 v6, s0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v1, s4
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v5, s14
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v4, s13
...
; GFX12-SDAG:       ; %bb.0: ; %main_body
; GFX12-SDAG-NEXT:    s_load_b256 s[0:7], s[0:1], 0x24
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v5, 0x40a00000 :: v_dual_lshlrev_b32 v2, 2, v0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v6, 0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v8, 2.0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v4, 4.0 :: v_dual_mov_b32 v7, 1.0
...
; GFX12-GISEL:       ; %bb.0: ; %main_body
; GFX12-GISEL-NEXT:    s_load_b256 s[0:7], s[0:1], 0x24
; GFX12-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX12-GISEL-NEXT:    s_mov_b32 s9, 0x40400000
; GFX12-GISEL-NEXT:    s_mov_b32 s12, 0x40c00000
; GFX12-GISEL-NEXT:    s_mov_b32 s11, 0x40a00000
; GFX12-GISEL-NEXT:    s_mov_b32 s10, 4.0
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v3, s9
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s2
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v5, s11 :: v_dual_mov_b32 v4, s10
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v0, 0x46004200 :: v_dual_mov_b32 v3, 0
...
; GFX12-GISEL-NEXT:    s_load_b256 s[0:7], s[0:1], 0x24
; GFX12-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 2, v0
; GFX12-GISEL-NEXT:    s_mov_b32 s9, 0x42004600
; GFX12-GISEL-NEXT:    s_mov_b32 s10, 0x44004700
; GFX12-GISEL-NEXT:    s_mov_b32 s11, 0x45004800
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX12-GISEL-NEXT:    s_mov_b32 s1, 1.0
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
...
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[0:1], 0x34
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v2, 0x41000000
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v10, 0x102 :: v_dual_mov_b32 v7, 1.0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, s5, 0, s4
...
; GFX12-GISEL-NEXT:    s_load_b128 s[0:3], s[0:1], 0x34
; GFX12-GISEL-NEXT:    v_lshlrev_b32_e32 v2, 2, v0
; GFX12-GISEL-NEXT:    s_mov_b32 s8, 2.0
; GFX12-GISEL-NEXT:    s_mov_b32 s7, 1.0
; GFX12-GISEL-NEXT:    s_mov_b32 s6, 0
; GFX12-GISEL-NEXT:    s_mov_b32 s9, 0x40400000
; GFX12-GISEL-NEXT:    s_mov_b32 s12, 0x40c00000
; GFX12-GISEL-NEXT:    s_mov_b32 s11, 0x40a00000
; GFX12-GISEL-NEXT:    s_mov_b32 s10, 4.0
...
; GFX12-GISEL-NEXT:    s_mov_b32 s13, 0x40e00000
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v6, s12
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v3, s9
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v4, s10 :: v_dual_mov_b32 v7, s13
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v5, s11 :: v_dual_mov_b32 v0, s4
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0xb36211c7
; GFX12-GISEL-NEXT:    s_movk_i32 s5, 0x102
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v10, s5 :: v_dual_mov_b32 v9, s4
...
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v2, s8
; GFX12-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX12-SDAG-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; GFX12-SDAG-NEXT:    s_load_b128 s[0:3], s[0:1], 0x34
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v2, 0x48004500 :: v_dual_mov_b32 v5, 2.0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v4, 1.0 :: v_dual_mov_b32 v7, 0x102
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v6, 0xb36211c6 :: v_dual_mov_b32 v3, 0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_add_co_ci_u32_e64 v1, null, s5, 0, s4
...
; GFX12-GISEL-NEXT:    s_mov_b32 s10, 0x44004700
; GFX12-GISEL-NEXT:    s_mov_b32 s11, 0x45004800
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v3, s9 :: v_dual_mov_b32 v4, s10
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v5, s11 :: v_dual_mov_b32 v0, s4
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v1, s5
; GFX12-GISEL-NEXT:    s_mov_b32 s4, 0xb36211c6
; GFX12-GISEL-NEXT:    s_movk_i32 s5, 0x102
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v7, s5
; GFX12-GISEL-NEXT:    v_add_co_u32 v0, vcc_lo, v0, v2
; GFX12-GISEL-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v1, vcc_lo
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v6, s4
