...
; RUN: llc -global-isel=0 -mtriple=amdgpu7.01 < %s | FileCheck -check-prefixes=CHECK,GFX7 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu7.01 < %s | FileCheck -check-prefixes=CHECK,GFX7 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=CHECK,GFX8 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck -check-prefixes=CHECK,GFX8 %s
