...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx950 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GCN-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx950 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GCN-GISEL %s
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_f16_fp6_sl:
; GCN-SDAG:       ; %bb.0:
...
; GCN-SDAG-NEXT:    v_mov_b32_e32 v3, s3
; GCN-SDAG-NEXT:    v_mov_b32_e32 v4, s4
; GCN-SDAG-NEXT:    v_mov_b32_e32 v5, s5
; GCN-SDAG-NEXT:    s_mov_b32 s0, 0x42c80000
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_f16_fp6 v[0:15], v[0:5], s0
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_f16_fp6_sl:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[4:5]
; GCN-GISEL-NEXT:    v_mov_b32_e32 v6, 0x42c80000
; GCN-GISEL-NEXT:    v_cvt_scalef32_pk32_f16_fp6 v[0:15], v[0:5], v6
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_bf16_fp6_vv:
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_bf16_fp6 v[0:15], v[0:5], v6
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_bf16_fp6_vv:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_cvt_scalef32_pk32_bf16_fp6 v[16:31], v[0:5], v6
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v1, 16, v16
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v17
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v5, 16, v18
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v7, 16, v19
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v9, 16, v20
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v11, 16, v21
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v13, 16, v22
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v15, 16, v23
; GCN-GISEL-NEXT:    v_mov_b32_e32 v0, v16
; GCN-GISEL-NEXT:    v_mov_b32_e32 v2, v17
; GCN-GISEL-NEXT:    v_mov_b32_e32 v4, v18
; GCN-GISEL-NEXT:    v_mov_b32_e32 v6, v19
; GCN-GISEL-NEXT:    v_mov_b32_e32 v8, v20
; GCN-GISEL-NEXT:    v_mov_b32_e32 v10, v21
; GCN-GISEL-NEXT:    v_mov_b32_e32 v12, v22
; GCN-GISEL-NEXT:    v_mov_b32_e32 v14, v23
; GCN-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_bf16_fp6_sl:
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v1, s1
...
; GCN-SDAG-NEXT:    v_mov_b32_e32 v5, s5
; GCN-SDAG-NEXT:    s_mov_b32 s0, 0x42c80000
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_bf16_fp6 v[0:15], v[0:5], s0
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_bf16_fp6_sl:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_f16_bf6_sl:
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v1, s1
...
; GCN-SDAG-NEXT:    v_mov_b32_e32 v5, s5
; GCN-SDAG-NEXT:    s_mov_b32 s0, 0x42c80000
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_f16_bf6 v[0:15], v[0:5], s0
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_f16_bf6_sl:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[4:5]
; GCN-GISEL-NEXT:    v_mov_b32_e32 v6, 0x42c80000
; GCN-GISEL-NEXT:    v_cvt_scalef32_pk32_f16_bf6 v[0:15], v[0:5], v6
; GCN-GISEL-NEXT:    s_setpc_b64 s[30:31]
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_bf16_bf6_vv:
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_bf16_bf6 v[0:15], v[0:5], v6
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_bf16_bf6_vv:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_cvt_scalef32_pk32_bf16_bf6 v[16:31], v[0:5], v6
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v1, 16, v16
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v17
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v5, 16, v18
; GCN-GISEL-NEXT:    v_lshrrev_b32_e32 v7, 16, v19
...
; GCN-SDAG-LABEL: test_cvt_scalef32_pk32_bf16_bf6_sl:
; GCN-SDAG:       ; %bb.0:
; GCN-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GCN-SDAG-NEXT:    v_mov_b32_e32 v1, s1
...
; GCN-SDAG-NEXT:    v_mov_b32_e32 v5, s5
; GCN-SDAG-NEXT:    s_mov_b32 s0, 0x42c80000
; GCN-SDAG-NEXT:    v_cvt_scalef32_pk32_bf16_bf6 v[0:15], v[0:5], s0
; GCN-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; GCN-GISEL-LABEL: test_cvt_scalef32_pk32_bf16_bf6_sl:
; GCN-GISEL:       ; %bb.0:
; GCN-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GCN-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
