...
; GFX908-NEXT:    buffer_atomic_add_f32 v0, v1, s[8:11], s18 offen
...
; GFX90A-NEXT:    buffer_atomic_add_f32 v0, v1, s[8:11], s18 offen scc
...
; GFX940-NEXT:    buffer_atomic_add_f32 v0, v1, s[0:3], s6 offen sc1
...
; GFX908-NEXT:    s_mov_b32 s9, s7
; GFX908-NEXT:    s_mov_b32 s8, s6
; GFX908-NEXT:    buffer_atomic_add_f32 v0, off, s[8:11], s18
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s9, s7
; GFX90A-NEXT:    s_mov_b32 s8, s6
; GFX90A-NEXT:    buffer_atomic_add_f32 v0, off, s[8:11], s18
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    buffer_atomic_add_f32 v0, off, s[0:3], s6
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_mov_b32 s9, s7
; GFX908-NEXT:    s_mov_b32 s8, s6
; GFX908-NEXT:    buffer_atomic_pk_add_f16 v0, v1, s[8:11], s18 offen
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s9, s7
; GFX90A-NEXT:    s_mov_b32 s8, s6
; GFX90A-NEXT:    buffer_atomic_pk_add_f16 v0, v1, s[8:11], s18 offen
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    buffer_atomic_pk_add_f16 v0, v1, s[0:3], s6 offen
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_mov_b32 s9, s7
; GFX908-NEXT:    s_mov_b32 s8, s6
; GFX908-NEXT:    buffer_atomic_pk_add_f16 v0, off, s[8:11], s18 offset:92
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s9, s7
; GFX90A-NEXT:    s_mov_b32 s8, s6
; GFX90A-NEXT:    buffer_atomic_pk_add_f16 v0, off, s[8:11], s18 offset:92
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    buffer_atomic_pk_add_f16 v0, off, s[0:3], s6 offset:92
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    s_mov_b32 s9, s7
; GFX908-NEXT:    s_mov_b32 s8, s6
; GFX908-NEXT:    buffer_atomic_add_f32 v0, v1, s[8:11], s18 offen slc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s9, s7
; GFX90A-NEXT:    s_mov_b32 s8, s6
; GFX90A-NEXT:    buffer_atomic_add_f32 v0, v1, s[8:11], s18 offen slc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    buffer_atomic_add_f32 v0, v1, s[0:3], s6 offen nt
; GFX940-NEXT:    s_waitcnt vmcnt(0)
; GFX940-NEXT:    s_setpc_b64 s[30:31]
;
