...
; GCN-NEXT:    exp mrt0, off, off, off, off compr
; GCN-NEXT:    exp mrt0, off, off, off, off done compr
; GCN-NEXT:    s_endpgm
...
; GCN-LABEL: test_export_compr_mrt7_v2f16:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_mov_b32_e32 v0, 0x38003800
; GCN-NEXT:    exp mrt7, v0, v0, v0, v0 compr
; GCN-NEXT:    exp mrt7, v0, v0, v0, v0 done compr
; GCN-NEXT:    s_endpgm
...
; GCN-LABEL: test_export_compr_mrt7_v2i16:
; GCN:       ; %bb.0:
; GCN-NEXT:    v_mov_b32_e32 v0, 0x50005
; GCN-NEXT:    exp mrt7, v0, v0, v0, v0 compr
; GCN-NEXT:    exp mrt7, v0, v0, v0, v0 done compr
; GCN-NEXT:    s_endpgm
