...
; GFX1100-NEXT:    s_load_b32 s2, s[0:1], 0x2c
; GFX1100-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX1100-NEXT:    v_mov_b32_e32 v1, 0
; GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-NEXT:    v_log_f32_e32 v0, s2
...
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, s3
...
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v2, s6
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, s5
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s4
; GFX1100-SDAG-NEXT:    global_store_b96 v3, v[0:2], s[0:1]
; GFX1100-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1100-SDAG-NEXT:    s_endpgm
;
...
; GFX1100-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v3, s7
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v2, s6
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, s5
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, s4
; GFX1100-SDAG-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX1100-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1100-SDAG-NEXT:    s_endpgm
;
...
; GFX689-LABEL: v_log2_fneg_fabs_f32:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e64 v0, -|v0|
; GFX689-NEXT:    s_setpc_b64 s[30:31]
...
; GFX689-LABEL: v_log2_f32_nnan_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
...
; GFX689-LABEL: v_log2_f32_ninf_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
...
; GFX689-LABEL: v_log2_f32_nnan_ninf:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
...
; GFX689-LABEL: v_log2_f32_nnan_ninf_dynamic:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
...
; GFX689-LABEL: v_log2_f32_dynamic_mode:
; GFX689:       ; %bb.0:
; GFX689-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX689-NEXT:    v_log_f32_e32 v0, v0
; GFX689-NEXT:    s_setpc_b64 s[30:31]
