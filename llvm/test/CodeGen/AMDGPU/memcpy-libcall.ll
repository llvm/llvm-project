...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v27, s[0:1] offset:112
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v27, s[0:1] offset:96
; CHECK-NEXT:    global_load_dwordx4 v[8:11], v27, s[0:1] offset:80
; CHECK-NEXT:    global_load_dwordx4 v[12:15], v27, s[0:1] offset:64
; CHECK-NEXT:    global_load_dwordx4 v[16:19], v27, s[0:1] offset:48
; CHECK-NEXT:    global_load_dwordx4 v[20:23], v27, s[0:1] offset:32
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v27, s[0:1] offset:16
...
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v27, s[0:1]
