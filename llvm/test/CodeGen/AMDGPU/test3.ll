...
; EMPTY:
; CHECK: Next-use distance of Register [[Reg5]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg4]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg3]] = 25
; CHECK-NEXT: Next-use distance of Register [[Reg2]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg1]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg6]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg7]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg8]] = 16
; CHECK-NEXT: Next-use distance of Register [[Reg9]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg10]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg11]] = 24
; CHECK-NEXT: Next-use distance of Register [[Reg12]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg13]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg14]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg15]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg16]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg17]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg18]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg19]] = 20
; CHECK-NEXT: Next-use distance of Register [[Reg20]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg21]] = 19
; CHECK-NEXT: Next-use distance of Register [[Reg22]] = 18
; CHECK-NEXT: Next-use distance of Register [[Reg23]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg24]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg25]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg26]] = 12
; CHECK-NEXT: Next-use distance of Register [[Reg27]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg28]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg29]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg30]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg31]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg32]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg33]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg34]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg35]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg38]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg40]] = 6
; CHECK-NEXT: Next-use distance of Register [[Reg41]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg42]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg43]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg44]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg37]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg45]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg46]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg47]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg48]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg49]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg50]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg51]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg52]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg55]] = 8
; CHECK-NEXT: Next-use distance of Register [[Reg57]] = 7
; CHECK-NEXT: Next-use distance of Register [[Reg59]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg60]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg61]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg62]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg63]] = 5
; CHECK-NEXT: Next-use distance of Register [[Reg66]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg68]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg70]] = 3
; CHECK-NEXT: Next-use distance of Register [[Reg71]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg65]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg72]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg73]] = 9
...
; CHECK-NEXT: Next-use distance of Register [[Reg80]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg81]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg82]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg83]] = 1
...
; CHECK-NEXT: Next-use distance of Register [[Reg87]] = 4
; CHECK-NEXT: Next-use distance of Register [[Reg88]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg89]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg90]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg91]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg92]] = 1
; CHECK-NEXT: Next-use distance of Register [[Reg54]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg93]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg94]] = 2
; CHECK-NEXT: Next-use distance of Register [[Reg95]] = 1
