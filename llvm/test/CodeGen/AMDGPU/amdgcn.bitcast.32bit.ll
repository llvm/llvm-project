...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_i32_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB10_4
; GFX13-NEXT:  .LBB10_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB10_3: ; %cmp.false
; GFX13-NEXT:    v_dual_lshrrev_b32 v3, 24, v0 :: v_dual_lshrrev_b32 v2, 16, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execz .LBB10_2
; GFX13-NEXT:  .LBB10_4: ; %cmp.true
; GFX13-NEXT:    v_add_nc_u32_e32 v0, 3, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_i32:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB11_4
; GFX13-NEXT:  .LBB11_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB11_3: ; %cmp.false
; GFX13-NEXT:    v_bitop3_b16 v0, v5, v1, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
...
; GFX13-NEXT:  .LBB11_4: ; %cmp.true
; GFX13-NEXT:    v_add_nc_u16 v0, v5, 3
; GFX13-NEXT:    v_add_nc_u16 v2, v2, 3
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_bitop3_b16 v0, v1, v0, 0xff bitop3:0xf8
; GFX13-NEXT:    v_bitop3_b16 v1, v3, v2, 0xff bitop3:0xf8
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_f32_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB20_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB20_4
; GFX13-NEXT:  .LBB20_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB20_3: ; %cmp.false
; GFX13-NEXT:    v_dual_lshrrev_b32 v3, 24, v0 :: v_dual_lshrrev_b32 v2, 16, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execz .LBB20_2
; GFX13-NEXT:  .LBB20_4: ; %cmp.true
; GFX13-NEXT:    v_add_f32_e32 v0, 1.0, v0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_lshrrev_b32 v3, 24, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_f32:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_cmpx_ne_u32_e32 0, v4
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB21_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB21_4
; GFX13-NEXT:  .LBB21_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB21_3: ; %cmp.false
; GFX13-NEXT:    v_bitop3_b16 v0, v5, v1, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
; GFX13-NEXT:    ; implicit-def: $vgpr5
; GFX13-NEXT:    ; implicit-def: $vgpr2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v2i16_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB28_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB28_4
; GFX13-NEXT:  .LBB28_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB28_3: ; %cmp.false
; GFX13-NEXT:    v_dual_lshrrev_b32 v3, 24, v0 :: v_dual_lshrrev_b32 v2, 16, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execz .LBB28_2
; GFX13-NEXT:  .LBB28_4: ; %cmp.true
; GFX13-NEXT:    v_pk_add_u16 v0, v0, 3 op_sel_hi:[1,0]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_lshrrev_b32 v3, 24, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_v2i16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_cmpx_ne_u32_e32 0, v4
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB29_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB29_4
; GFX13-NEXT:  .LBB29_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB29_3: ; %cmp.false
; GFX13-NEXT:    v_bitop3_b16 v0, v5, v1, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
; GFX13-NEXT:    ; implicit-def: $vgpr5
; GFX13-NEXT:    ; implicit-def: $vgpr2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v2f16_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB34_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB34_4
; GFX13-NEXT:  .LBB34_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB34_3: ; %cmp.false
; GFX13-NEXT:    v_dual_lshrrev_b32 v3, 24, v0 :: v_dual_lshrrev_b32 v2, 16, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execz .LBB34_2
; GFX13-NEXT:  .LBB34_4: ; %cmp.true
; GFX13-NEXT:    v_pk_add_f16 v0, 0x200, v0 op_sel_hi:[0,1]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_lshrrev_b32 v3, 24, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_v2f16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v2bf16_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_v2bf16:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_cmpx_ne_u32_e32 0, v4
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB39_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB39_4
; GFX13-NEXT:  .LBB39_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB39_3: ; %cmp.false
; GFX13-NEXT:    v_bitop3_b16 v0, v5, v1, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
; GFX13-NEXT:    ; implicit-def: $vgpr5
; GFX13-NEXT:    ; implicit-def: $vgpr2
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v1i32_to_v4i8:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB40_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB40_4
; GFX13-NEXT:  .LBB40_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB40_3: ; %cmp.false
; GFX13-NEXT:    v_dual_lshrrev_b32 v3, 24, v0 :: v_dual_lshrrev_b32 v2, 16, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execz .LBB40_2
; GFX13-NEXT:  .LBB40_4: ; %cmp.true
; GFX13-NEXT:    v_add_nc_u32_e32 v0, 3, v0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_dual_lshrrev_b32 v2, 16, v0 :: v_dual_lshrrev_b32 v3, 24, v0
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i8_to_v1i32:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_cmpx_ne_u32_e32 0, v4
; GFX13-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB41_3
; GFX13-NEXT:  ; %bb.1: ; %Flow
; GFX13-NEXT:    s_and_not1_saveexec_b32 s0, s0
; GFX13-NEXT:    s_cbranch_execnz .LBB41_4
; GFX13-NEXT:  .LBB41_2: ; %end
; GFX13-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB41_3: ; %cmp.false
; GFX13-NEXT:    v_bitop3_b16 v0, v5, v1, 0xff bitop3:0xec
; GFX13-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
; GFX13-NEXT:    ; implicit-def: $vgpr5
; GFX13-NEXT:    ; implicit-def: $vgpr2
