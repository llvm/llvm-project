...
; GFX900-NEXT:    v_mov_b32_e32 v6, s5
; GFX900-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX900-NEXT:    v_mul_lo_u32 v1, v3, v1
; GFX900-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v1, v4, v[1:2]
; GFX900-NEXT:    v_add_co_u32_e32 v3, vcc, s4, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v4, vcc, 0, v6, vcc
...
; GFX10-NEXT:    ; implicit-def: $vgpr1
; GFX10-NEXT:    v_mul_lo_u32 v5, v2, v3
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
