...
; GFX67:       ; %bb.0: ; %bb
; GFX67-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x0
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_mov_b32 s7, 0xf000
; GFX67-NEXT:    s_add_i32 s1, s6, 1
; GFX67-NEXT:    v_mul_lo_u32 v1, s1, v0
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, s1, v1
; GFX67-NEXT:    v_mul_lo_u32 v2, v2, v0
; GFX67-NEXT:    v_add_i32_e32 v1, vcc, 1, v1
; GFX67-NEXT:    s_mov_b32 s1, 0
; GFX67-NEXT:    v_mul_lo_u32 v3, v2, v1
; GFX67-NEXT:    s_mov_b32 s3, s1
; GFX67-NEXT:    s_load_dword s6, s[2:3], 0x1
; GFX67-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x0
; GFX67-NEXT:    s_mov_b32 s5, s1
; GFX67-NEXT:    v_add_i32_e32 v1, vcc, v3, v1
; GFX67-NEXT:    v_mul_lo_u32 v1, v1, v2
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, 1, v3
; GFX67-NEXT:    s_waitcnt lgkmcnt(0)
; GFX67-NEXT:    s_and_b32 s0, s6, 0xffff
; GFX67-NEXT:    v_mul_lo_u32 v3, v1, v2
; GFX67-NEXT:    s_mul_i32 s8, s8, s0
; GFX67-NEXT:    v_add_i32_e32 v0, vcc, s8, v0
; GFX67-NEXT:    v_add_i32_e32 v2, vcc, v3, v2
; GFX67-NEXT:    v_mul_lo_u32 v1, v2, v1
; GFX67-NEXT:    v_mov_b32_e32 v2, s3
; GFX67-NEXT:    s_mov_b32 s6, s1
; GFX67-NEXT:    v_mul_lo_u32 v3, v1, v3
...
; GFX8:       ; %bb.0: ; %bb
; GFX8-NEXT:    s_load_dwordx8 s[0:7], s[4:5], 0x0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_add_i32 s1, s6, 1
; GFX8-NEXT:    v_mul_lo_u32 v1, s1, v0
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, s1, v1
...
; GFX900:       ; %bb.0: ; %bb
; GFX900-NEXT:    s_load_dwordx8 s[12:19], s[4:5], 0x0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-NEXT:    s_mov_b32 s13, 0
; GFX900-NEXT:    s_mov_b32 s15, s13
; GFX900-NEXT:    s_add_i32 s0, s18, 1
...
; GFX900-NEXT:    s_load_dword s2, s[14:15], 0x4
; GFX900-NEXT:    s_load_dwordx2 s[0:1], s[12:13], 0x0
...
; GFX900-NEXT:    v_add_co_u32_e32 v1, vcc, s16, v3
; GFX900-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v4, vcc
; GFX900-NEXT:    global_store_dword v[1:2], v0, off
; GFX900-NEXT:    s_endpgm
;
; GFX90A-LABEL: compute_mad:
; GFX90A:       ; %bb.0: ; %bb
; GFX90A-NEXT:    s_load_dwordx8 s[12:19], s[4:5], 0x0
; GFX90A-NEXT:    v_and_b32_e32 v4, 0x3ff, v0
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_mov_b32 s13, 0
; GFX90A-NEXT:    s_mov_b32 s15, s13
; GFX90A-NEXT:    s_add_i32 s0, s18, 1
; GFX90A-NEXT:    v_mul_lo_u32 v0, s0, v4
; GFX90A-NEXT:    v_add_u32_e32 v1, s0, v0
...
; GFX90A-NEXT:    s_load_dword s4, s[14:15], 0x4
; GFX90A-NEXT:    v_mul_lo_u32 v0, v1, v0
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v0, v2, v[0:1]
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[12:13], 0x0
...
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, s16, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
...
; GFX10-NEXT:    s_add_i32 s1, s6, 1
; GFX10-NEXT:    v_mul_lo_u32 v1, s1, v0
; GFX10-NEXT:    v_add_nc_u32_e32 v2, s1, v1
; GFX10-NEXT:    v_add_nc_u32_e32 v1, 1, v1
...
; GFX10-NEXT:    v_add_co_ci_u32_e64 v2, null, 0, v3, vcc_lo
...
; GFX1250-NEXT:    s_add_co_i32 s1, s2, 1
; GFX1250-NEXT:    s_load_b64 s[2:3], s[4:5], 0x0
; GFX1250-NEXT:    v_mul_lo_u32 v1, s1, v0
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_and_b32 s4, ttmp6, 15
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_add_nc_u32 v2, s1, v1 :: v_dual_add_nc_u32 v1, 1, v1
; GFX1250-NEXT:    s_load_b32 s1, s[6:7], 0x4
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_bfe_u32 s6, ttmp6, 0x4000c
...
; GFX1250-NEXT:    s_mul_i32 s6, ttmp9, s6
...
; GFX1250-NEXT:    v_mad_u32 v0, s4, s1, v0
