...
; GCN-NEXT:    s_mov_b32 s4, 0xc2aeac50
; GCN-NEXT:    v_add_f32_e32 v1, 0x42800000, v0
; GCN-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-NEXT:    v_mul_f32_e32 v0, 0x3fb8aa3b, v0
; GCN-NEXT:    v_exp_f32_e32 v0, v0
; GCN-NEXT:    v_mul_f32_e32 v1, 0x114b4ea4, v0
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xc2aeac50
; SI-NEXT:    v_add_f32_e32 v1, 0x42800000, v0
; SI-NEXT:    v_cmp_gt_f32_e32 vcc, s4, v0
; SI-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; SI-NEXT:    v_mul_f32_e32 v0, 0x3fb8aa3b, v0
; SI-NEXT:    v_exp_f32_e32 v0, v0
; SI-NEXT:    v_mul_f32_e32 v1, 0x114b4ea4, v0
; SI-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; SI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GCN-LABEL: v_fabs_exp_f32_afn:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s4, 0xc2aeac50
; GCN-NEXT:    s_mov_b32 s5, 0x42800000
...
; GCN-NEXT:    s_setpc_b64 s[30:31]
;
; SI-LABEL: v_fabs_exp_f32_afn:
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s4, 0xc2aeac50
; SI-NEXT:    s_mov_b32 s5, 0x42800000
