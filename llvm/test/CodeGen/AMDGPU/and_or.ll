...
; Each v2i32 fragment selects two instructions, so two of them clear the bar.
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_mov_b32 s0, 0xf000f
; GFX9-NEXT:    v_mov_b32_e32 v4, 0x64006400
; GFX9-NEXT:    v_and_or_b32 v1, v1, s0, v4
; GFX9-NEXT:    v_and_or_b32 v0, v0, s0, v4
; GFX9-NEXT:    v_and_or_b32 v3, v3, s0, v4
; GFX9-NEXT:    v_and_or_b32 v2, v2, s0, v4
; GFX9-NEXT:    ; return to shader part epilog
;
