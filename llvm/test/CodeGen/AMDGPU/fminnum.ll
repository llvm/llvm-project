...
; GFX8-SDAG-NEXT:    v_min_f32_e32 v0, s2, v0
...
; GFX8-GISEL-NEXT:    v_min_f32_e32 v0, s2, v0
...
; GFX9-SDAG-NEXT:    v_min_f32_e32 v0, s2, v0
...
; GFX9-GISEL-NEXT:    v_min_f32_e32 v0, s2, v0
...
; GFX8-SDAG-NEXT:    v_min_f32_e32 v1, s1, v0
; GFX8-SDAG-NEXT:    v_min_f32_e32 v0, s0, v2
...
; GFX8-GISEL-NEXT:    v_min_f32_e32 v0, s0, v0
; GFX8-GISEL-NEXT:    v_min_f32_e32 v1, s1, v1
...
; GFX9-SDAG-NEXT:    v_min_f32_e32 v1, s1, v0
; GFX9-SDAG-NEXT:    v_min_f32_e32 v0, s0, v2
...
; GFX9-GISEL-NEXT:    v_min_f32_e32 v0, s0, v0
; GFX9-GISEL-NEXT:    v_min_f32_e32 v1, s1, v1
...
; GFX8-SDAG-NEXT:    v_min_f32_e32 v3, s11, v0
; GFX8-SDAG-NEXT:    v_mov_b32_e32 v0, s13
; GFX8-SDAG-NEXT:    v_min_f32_e32 v2, s10, v1
; GFX8-SDAG-NEXT:    v_min_f32_e32 v1, s9, v0
; GFX8-SDAG-NEXT:    v_mov_b32_e32 v0, s12
; GFX8-SDAG-NEXT:    v_min_f32_e32 v0, s8, v0
...
; GFX8-GISEL-NEXT:    v_min_f32_e32 v0, s8, v0
; GFX8-GISEL-NEXT:    v_min_f32_e32 v1, s9, v1
; GFX8-GISEL-NEXT:    v_min_f32_e32 v2, s10, v2
; GFX8-GISEL-NEXT:    v_min_f32_e32 v3, s11, v3
...
; GFX9-SDAG-NEXT:    v_min_f32_e32 v3, s11, v0
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v0, s13
; GFX9-SDAG-NEXT:    v_min_f32_e32 v2, s10, v1
; GFX9-SDAG-NEXT:    v_min_f32_e32 v1, s9, v0
; GFX9-SDAG-NEXT:    v_mov_b32_e32 v0, s12
; GFX9-SDAG-NEXT:    v_min_f32_e32 v0, s8, v0
...
; GFX9-GISEL-NEXT:    v_min_f32_e32 v0, s8, v0
; GFX9-GISEL-NEXT:    v_min_f32_e32 v1, s9, v1
; GFX9-GISEL-NEXT:    v_min_f32_e32 v2, s10, v2
; GFX9-GISEL-NEXT:    v_min_f32_e32 v3, s11, v3
...
; GFX8-GISEL-NEXT:    v_min_f32_e32 v4, s12, v4
; GFX8-GISEL-NEXT:    v_min_f32_e32 v5, s13, v5
; GFX8-GISEL-NEXT:    v_min_f32_e32 v6, s14, v6
; GFX8-GISEL-NEXT:    v_min_f32_e32 v7, s15, v7
; GFX8-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
...
; GFX9-GISEL-NEXT:    v_min_f32_e32 v4, s12, v4
; GFX9-GISEL-NEXT:    v_min_f32_e32 v5, s13, v5
; GFX9-GISEL-NEXT:    v_min_f32_e32 v6, s14, v6
; GFX9-GISEL-NEXT:    v_min_f32_e32 v7, s15, v7
; GFX9-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
...
; GFX8-GISEL-NEXT:    v_min_f32_e32 v6, s14, v6
; GFX8-GISEL-NEXT:    v_min_f32_e32 v7, s15, v7
; GFX8-GISEL-NEXT:    v_min_f32_e32 v8, s16, v8
; GFX8-GISEL-NEXT:    v_min_f32_e32 v9, s17, v9
; GFX8-GISEL-NEXT:    v_min_f32_e32 v10, s18, v10
; GFX8-GISEL-NEXT:    v_min_f32_e32 v11, s19, v11
; GFX8-GISEL-NEXT:    v_min_f32_e32 v12, s20, v12
; GFX8-GISEL-NEXT:    v_min_f32_e32 v13, s21, v13
; GFX8-GISEL-NEXT:    v_min_f32_e32 v14, s22, v14
; GFX8-GISEL-NEXT:    v_min_f32_e32 v15, s23, v15
; GFX8-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GFX8-GISEL-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:16
...
; GFX9-GISEL-NEXT:    v_min_f32_e32 v6, s14, v6
; GFX9-GISEL-NEXT:    v_min_f32_e32 v7, s15, v7
; GFX9-GISEL-NEXT:    v_min_f32_e32 v8, s16, v8
; GFX9-GISEL-NEXT:    v_min_f32_e32 v9, s17, v9
; GFX9-GISEL-NEXT:    v_min_f32_e32 v10, s18, v10
; GFX9-GISEL-NEXT:    v_min_f32_e32 v11, s19, v11
; GFX9-GISEL-NEXT:    v_min_f32_e32 v12, s20, v12
; GFX9-GISEL-NEXT:    v_min_f32_e32 v13, s21, v13
; GFX9-GISEL-NEXT:    v_min_f32_e32 v14, s22, v14
; GFX9-GISEL-NEXT:    v_min_f32_e32 v15, s23, v15
; GFX9-GISEL-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GFX9-GISEL-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:16
...
; GFX8-LABEL: test_func_fmin_v3f32:
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX8-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9-LABEL: test_func_fmin_v3f32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX8-NEXT:    v_min_f16_e32 v0, s6, v0
...
; GFX9-NEXT:    v_min_f16_e32 v0, s6, v0
...
; GFX8-SDAG-NEXT:    v_min_f16_e32 v0, s6, v0
...
; GFX9-SDAG-NEXT:    v_min_f16_e32 v0, s6, v0
...
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    v_min_f16_e32 v0, s2, v0
...
; GFX8-NEXT:    v_min_f16_e32 v1, s2, v1
...
; GFX9-SDAG-NEXT:    s_mov_b32 s4, s0
; GFX9-SDAG-NEXT:    s_mov_b32 s5, s1
; GFX9-SDAG-NEXT:    v_pk_min_f16 v0, s2, v0
; GFX9-SDAG-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GFX9-SDAG-NEXT:    s_endpgm
;
...
; GFX9-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-GISEL-NEXT:    v_mov_b32_e32 v0, s3
; GFX9-GISEL-NEXT:    v_pk_min_f16 v0, s2, v0
; GFX9-GISEL-NEXT:    s_mov_b32 s2, -1
; GFX9-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; GFX9-GISEL-NEXT:    s_endpgm
...
; GFX8-SDAG-NEXT:    v_min_f64 v[0:1], s[2:3], v[0:1]
; GFX8-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX8-SDAG-NEXT:    s_mov_b32 s2, -1
...
; GFX8-GISEL-NEXT:    v_min_f64 v[0:1], s[2:3], v[0:1]
; GFX8-GISEL-NEXT:    s_mov_b32 s2, -1
; GFX8-GISEL-NEXT:    s_mov_b32 s3, 0xf000
...
; GFX9-SDAG-NEXT:    v_min_f64 v[0:1], s[2:3], v[0:1]
; GFX9-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-SDAG-NEXT:    s_mov_b32 s2, -1
...
; GFX9-GISEL-NEXT:    v_min_f64 v[0:1], s[2:3], v[0:1]
; GFX9-GISEL-NEXT:    s_mov_b32 s2, -1
; GFX9-GISEL-NEXT:    s_mov_b32 s3, 0xf000
