; RUN: not llc -mtriple=amdgpu11.00-amd-amdhsa -stress-regalloc=1 -amdgpu-enable-rewrite-partial-reg-uses=0 -filetype=null -verify-machineinstrs %s 2>&1 | FileCheck %s
