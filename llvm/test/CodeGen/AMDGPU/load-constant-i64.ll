...
; RUN: llc -mtriple=amdgpu7.00--amdhsa < %s | FileCheck --check-prefix=GFX7 %s
...
; GFX7-NEXT:    v_mov_b32_e32 v10, s10
; GFX7-NEXT:    v_mov_b32_e32 v11, s11
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-NEXT:    v_mov_b32_e32 v2, s6
; GFX7-NEXT:    v_mov_b32_e32 v3, s7
; GFX7-NEXT:    v_mov_b32_e32 v8, s8
; GFX7-NEXT:    v_mov_b32_e32 v9, s9
; GFX7-NEXT:    v_mov_b32_e32 v7, s3
; GFX7-NEXT:    v_mov_b32_e32 v6, s2
; GFX7-NEXT:    v_mov_b32_e32 v5, s1
; GFX7-NEXT:    v_mov_b32_e32 v4, s0
; GFX7-NEXT:    flat_store_dwordx4 v[10:11], v[0:3]
; GFX7-NEXT:    flat_store_dwordx4 v[8:9], v[4:7]
; GFX7-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v3, s7
; GFX12-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v7, s3
; GFX12-NEXT:    v_dual_mov_b32 v6, s2 :: v_dual_mov_b32 v5, s1
...
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[16:19], 0 offset:16
...
; GFX7-NEXT:    v_mov_b32_e32 v8, s18
; GFX7-NEXT:    v_mov_b32_e32 v9, s19
; GFX7-NEXT:    s_add_u32 s18, s16, 32
; GFX7-NEXT:    s_addc_u32 s19, s17, 0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    v_mov_b32_e32 v10, s18
; GFX7-NEXT:    v_mov_b32_e32 v11, s19
; GFX7-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; GFX7-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
; GFX7-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-NEXT:    v_mov_b32_e32 v4, s8
; GFX7-NEXT:    v_mov_b32_e32 v5, s9
; GFX7-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX8-NEXT:    s_add_u32 s18, s16, 32
; GFX8-NEXT:    s_addc_u32 s19, s17, 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    v_mov_b32_e32 v10, s18
; GFX8-NEXT:    v_mov_b32_e32 v11, s19
...
; GFX12-NEXT:    v_dual_mov_b32 v6, s10 :: v_dual_mov_b32 v11, s7
; GFX12-NEXT:    v_dual_mov_b32 v10, s6 :: v_dual_mov_b32 v9, s5
; GFX12-NEXT:    v_dual_mov_b32 v8, s4 :: v_dual_mov_b32 v15, s3
; GFX12-NEXT:    v_dual_mov_b32 v14, s2 :: v_dual_mov_b32 v13, s1
...
; GFX6-NEXT:    v_mov_b32_e32 v6, s26
; GFX6-NEXT:    v_mov_b32_e32 v7, s27
...
; GFX6-NEXT:    buffer_store_dwordx4 v[4:7], off, s[36:39], 0 offset:96
; GFX6-NEXT:    buffer_store_dwordx4 v[8:11], off, s[36:39], 0 offset:64
; GFX6-NEXT:    s_waitcnt expcnt(2)
; GFX6-NEXT:    v_mov_b32_e32 v0, s12
; GFX6-NEXT:    v_mov_b32_e32 v1, s13
; GFX6-NEXT:    v_mov_b32_e32 v2, s14
...
; GFX7-NEXT:    v_mov_b32_e32 v6, s10
; GFX7-NEXT:    v_mov_b32_e32 v7, s11
; GFX7-NEXT:    v_mov_b32_e32 v11, s3
; GFX7-NEXT:    v_mov_b32_e32 v10, s2
; GFX7-NEXT:    v_mov_b32_e32 v9, s1
; GFX7-NEXT:    v_mov_b32_e32 v8, s0
; GFX7-NEXT:    v_mov_b32_e32 v12, s4
; GFX7-NEXT:    v_mov_b32_e32 v13, s5
; GFX7-NEXT:    v_mov_b32_e32 v14, s6
; GFX7-NEXT:    v_mov_b32_e32 v15, s7
; GFX7-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s14
; GFX7-NEXT:    v_mov_b32_e32 v3, s15
; GFX7-NEXT:    s_add_u32 s12, s16, 32
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s2
; GFX7-NEXT:    v_mov_b32_e32 v3, s3
; GFX7-NEXT:    s_add_u32 s0, s16, 0x50
; GFX7-NEXT:    v_mov_b32_e32 v5, s17
; GFX7-NEXT:    s_addc_u32 s1, s17, 0
; GFX7-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX7-NEXT:    s_nop 0
; GFX7-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-NEXT:    v_mov_b32_e32 v1, s1
; GFX7-NEXT:    s_add_u32 s0, s16, 16
; GFX7-NEXT:    s_addc_u32 s1, s17, 0
...
; GFX8-NEXT:    v_mov_b32_e32 v8, s34
; GFX8-NEXT:    v_mov_b32_e32 v9, s35
; GFX8-NEXT:    s_add_u32 s34, s36, 0x60
; GFX8-NEXT:    s_addc_u32 s35, s37, 0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8-NEXT:    s_add_u32 s24, s36, 64
...
; GFX8-NEXT:    v_mov_b32_e32 v10, s34
; GFX8-NEXT:    v_mov_b32_e32 v11, s35
; GFX8-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; GFX8-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
...
; GFX8-NEXT:    s_add_u32 s16, s36, 48
; GFX8-NEXT:    v_mov_b32_e32 v4, s24
; GFX8-NEXT:    v_mov_b32_e32 v5, s25
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s14
; GFX8-NEXT:    v_mov_b32_e32 v3, s15
; GFX8-NEXT:    s_add_u32 s12, s36, 32
; GFX8-NEXT:    v_mov_b32_e32 v5, s17
...
; GFX8-NEXT:    v_mov_b32_e32 v2, s2
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    s_add_u32 s0, s36, 0x50
; GFX8-NEXT:    v_mov_b32_e32 v5, s37
; GFX8-NEXT:    s_addc_u32 s1, s37, 0
; GFX8-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GFX8-NEXT:    v_mov_b32_e32 v5, s1
; GFX8-NEXT:    v_mov_b32_e32 v4, s0
; GFX8-NEXT:    s_add_u32 s0, s36, 16
...
; GFX12-NEXT:    v_dual_mov_b32 v6, s26 :: v_dual_mov_b32 v9, s17
; GFX12-NEXT:    v_dual_mov_b32 v10, s18 :: v_dual_mov_b32 v13, s13
; GFX12-NEXT:    v_dual_mov_b32 v12, s12 :: v_dual_mov_b32 v15, s15
; GFX12-NEXT:    v_dual_mov_b32 v14, s14 :: v_dual_mov_b32 v19, s11
; GFX12-NEXT:    v_dual_mov_b32 v18, s10 :: v_dual_mov_b32 v17, s9
; GFX12-NEXT:    v_dual_mov_b32 v16, s8 :: v_dual_mov_b32 v23, s3
; GFX12-NEXT:    v_dual_mov_b32 v8, s16 :: v_dual_mov_b32 v11, s19
; GFX12-NEXT:    v_dual_mov_b32 v22, s2 :: v_dual_mov_b32 v21, s1
; GFX12-NEXT:    v_dual_mov_b32 v20, s0 :: v_dual_mov_b32 v25, s21
; GFX12-NEXT:    v_dual_mov_b32 v24, s20 :: v_dual_mov_b32 v27, s23
; GFX12-NEXT:    v_dual_mov_b32 v26, s22 :: v_dual_mov_b32 v29, s5
; GFX12-NEXT:    v_dual_mov_b32 v28, s4 :: v_dual_mov_b32 v31, s7
; GFX12-NEXT:    v_mov_b32_e32 v30, s6
...
; GFX12-NEXT:    global_store_b128 v32, v[12:15], s[36:37] offset:48
; GFX12-NEXT:    global_store_b128 v32, v[16:19], s[36:37] offset:32
; GFX12-NEXT:    global_store_b128 v32, v[8:11], s[36:37] offset:64
; GFX12-NEXT:    global_store_b128 v32, v[24:27], s[36:37] offset:80
; GFX12-NEXT:    global_store_b128 v32, v[20:23], s[36:37]
; GFX12-NEXT:    global_store_b128 v32, v[28:31], s[36:37] offset:16
; GFX12-NEXT:    s_endpgm
entry:
