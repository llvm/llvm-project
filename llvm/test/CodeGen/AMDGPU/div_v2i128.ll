...
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v18, 0, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v21, v3, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v20, v2, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v3, 0, v23, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, v22, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v34
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v8, v19, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v20, v18, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
...
; SDAG-NEXT:    v_subrev_i32_e32 v21, vcc, 64, v30
; SDAG-NEXT:    v_lshr_b64 v[22:23], v[18:19], v30
; SDAG-NEXT:    v_add_i32_e32 v34, vcc, -1, v29
; SDAG-NEXT:    v_lshl_b64 v[35:36], v[18:19], v20
; SDAG-NEXT:    v_lshr_b64 v[18:19], v[18:19], v21
; SDAG-NEXT:    v_or_b32_e32 v36, v11, v36
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mov_b32_e32 v21, 0
...
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v19, v36, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v19, v17, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v37, vcc, -1, v1, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v10, v16, s[4:5]
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v22, 31, v9
; SDAG-NEXT:    v_or_b32_e32 v18, v18, v22
; SDAG-NEXT:    v_sub_i32_e32 v22, vcc, v34, v18
; SDAG-NEXT:    v_subb_u32_e32 v22, vcc, v35, v19, vcc
...
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, v18, v22
...
; SDAG-NEXT:    v_or_b32_e32 v20, v20, v0
...
; SDAG-NEXT:    v_subrev_i32_e32 v13, vcc, 64, v30
; SDAG-NEXT:    v_lshr_b64 v[14:15], v[4:5], v30
; SDAG-NEXT:    v_add_i32_e32 v34, vcc, -1, v29
; SDAG-NEXT:    v_lshl_b64 v[35:36], v[4:5], v12
; SDAG-NEXT:    v_lshr_b64 v[4:5], v[4:5], v13
; SDAG-NEXT:    v_or_b32_e32 v36, v11, v36
; SDAG-NEXT:    v_mov_b32_e32 v12, 0
; SDAG-NEXT:    v_mov_b32_e32 v13, 0
; SDAG-NEXT:    s_mov_b64 s[10:11], 0
...
; SDAG-NEXT:    v_mov_b32_e32 v11, 0
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v30
; SDAG-NEXT:    v_cndmask_b32_e64 v5, v5, v36, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v35, vcc, -1, v28, vcc
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v10, 31, v5
...
; SDAG-NEXT:    v_sub_i32_e32 v14, vcc, v34, v4
; SDAG-NEXT:    v_subb_u32_e32 v14, vcc, v35, v5, vcc
...
; SDAG-NEXT:    v_or_b32_e32 v7, v3, v7
; SDAG-NEXT:    v_or_b32_e32 v6, v2, v6
...
; SDAG-NEXT:    v_xor_b32_e32 v5, v20, v2
...
; SDAG-NEXT:    v_subrev_i32_e32 v23, vcc, 64, v26
; SDAG-NEXT:    v_lshr_b64 v[24:25], v[2:3], v26
; SDAG-NEXT:    v_add_i32_e32 v30, vcc, -1, v8
; SDAG-NEXT:    v_lshl_b64 v[31:32], v[2:3], v22
; SDAG-NEXT:    v_lshr_b64 v[2:3], v[2:3], v23
; SDAG-NEXT:    v_or_b32_e32 v32, v21, v32
; SDAG-NEXT:    v_mov_b32_e32 v22, 0
; SDAG-NEXT:    v_mov_b32_e32 v23, 0
; SDAG-NEXT:    s_mov_b64 s[10:11], 0
...
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v3, v32, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v31, vcc, -1, v9, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v2, v20, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v3, v1, s[4:5]
...
; SDAG-NEXT:    v_sub_i32_e32 v24, vcc, v30, v2
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, v31, v3, vcc
...
; SDAG-NEXT:    v_sub_i32_e32 v2, vcc, v2, v24
...
; SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, v21, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, v20, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v26
...
; SDAG-NEXT:    v_cndmask_b32_e32 v7, v2, v5, vcc
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v2, 31, v7
; SDAG-NEXT:    v_lshl_b64 v[6:7], v[6:7], 1
...
; SDAG-NEXT:    v_or_b32_e32 v2, v8, v31
; SDAG-NEXT:    v_or_b32_e32 v9, v21, v9
; SDAG-NEXT:    v_or_b32_e32 v1, v5, v1
; SDAG-NEXT:    v_or_b32_e32 v8, v20, v2
; SDAG-NEXT:    v_sub_i32_e32 v2, vcc, v26, v6
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v27, v7, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v28, v10, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v29, v11, vcc
; SDAG-NEXT:    v_ashrrev_i32_e32 v5, 31, v2
; SDAG-NEXT:    v_and_b32_e32 v2, 1, v5
...
; SDAG-NEXT:    v_subb_u32_e32 v10, vcc, v10, v31, vcc
; SDAG-NEXT:    v_subb_u32_e32 v11, vcc, v11, v30, vcc
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v6, 31, v1
; SDAG-NEXT:    v_lshl_b64 v[0:1], v[0:1], 1
; SDAG-NEXT:    v_or_b32_e32 v4, v4, v6
; SDAG-NEXT:    v_or_b32_e32 v8, v21, v5
; SDAG-NEXT:    v_or_b32_e32 v10, v3, v1
; SDAG-NEXT:    v_or_b32_e32 v9, v20, v4
; SDAG-NEXT:    v_or_b32_e32 v11, v2, v0
...
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, v9, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v20, v8, v3, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v21, v9, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v20, v8, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v18, v1, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v20, v0, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mov_b32_e32 v21, 0
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
...
; SDAG-NEXT:    v_lshl_b64 v[24:25], v[24:25], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v48, 31, v19
; SDAG-NEXT:    v_lshl_b64 v[18:19], v[18:19], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v49, 31, v9
; SDAG-NEXT:    v_lshl_b64 v[8:9], v[8:9], 1
; SDAG-NEXT:    v_or_b32_e32 v10, v26, v10
; SDAG-NEXT:    v_or_b32_e32 v24, v24, v48
; SDAG-NEXT:    v_or_b32_e32 v18, v18, v49
...
; SDAG-NEXT:    v_subb_u32_e32 v22, vcc, v38, v10, vcc
...
; SDAG-NEXT:    v_subb_u32_e32 v26, vcc, v10, v26, vcc
...
; SDAG-NEXT:    v_lshl_b64 v[8:9], v[8:9], 1
; SDAG-NEXT:    v_or_b32_e32 v18, v18, v22
; SDAG-NEXT:    v_or_b32_e32 v34, v21, v19
; SDAG-NEXT:    v_or_b32_e32 v27, v11, v9
; SDAG-NEXT:    v_or_b32_e32 v32, v20, v18
; SDAG-NEXT:    v_or_b32_e32 v33, v10, v8
...
; SDAG-NEXT:    v_or_b32_e32 v12, v24, v12
; SDAG-NEXT:    v_lshl_b64 v[22:23], v[22:23], 1
...
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, v52, v12, vcc
...
; SDAG-NEXT:    v_and_b32_e32 v24, v40, v6
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, v12, v24, vcc
; SDAG-NEXT:    v_and_b32_e32 v12, v40, v7
; SDAG-NEXT:    v_subb_u32_e32 v25, vcc, v25, v12, vcc
...
; SDAG-NEXT:    v_and_b32_e32 v12, 1, v40
; SDAG-NEXT:    s_or_b64 s[10:11], vcc, s[10:11]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v23, v22, s[4:5]
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v26
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v23, v17, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, v22, v16, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v17, 0, v25, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, 0, v24, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v26
; SDAG-NEXT:    v_cndmask_b32_e64 v21, v20, v3, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v22, v2, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v22, 0
; SDAG-NEXT:    v_mov_b32_e32 v23, 0
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
...
; SDAG-NEXT:    v_or_b32_e32 v20, v20, v39
...
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, v36, v18, vcc
...
; SDAG-NEXT:    v_subb_u32_e32 v28, vcc, v18, v28, vcc
...
; SDAG-NEXT:    v_lshl_b64 v[16:17], v[16:17], 1
; SDAG-NEXT:    v_or_b32_e32 v20, v20, v24
; SDAG-NEXT:    v_or_b32_e32 v33, v23, v21
; SDAG-NEXT:    v_or_b32_e32 v30, v19, v17
; SDAG-NEXT:    v_or_b32_e32 v31, v22, v20
...
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, 64, v34
...
; SDAG-NEXT:    s_mov_b64 s[10:11], 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    v_lshl_b64 v[28:29], v[6:7], v18
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v34
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v50, v18, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v27, v18, v5, vcc
...
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, v48, v18, vcc
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[24:25]
; SDAG-NEXT:    v_and_b32_e32 v18, 1, v50
; SDAG-NEXT:    s_or_b64 s[10:11], vcc, s[10:11]
; SDAG-NEXT:    v_or_b32_e32 v20, v22, v20
; SDAG-NEXT:    v_mov_b32_e32 v25, v19
; SDAG-NEXT:    v_mov_b32_e32 v24, v18
...
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v13, v18, v[25:26]
; SDAG-NEXT:    v_add_i32_e64 v17, s[4:5], v28, v17
; SDAG-NEXT:    v_add_i32_e64 v18, s[4:5], v34, v11
; SDAG-NEXT:    v_mov_b32_e32 v25, v14
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v12, v19, v[25:26]
