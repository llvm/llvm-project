...
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, 0, v7, vcc
; SDAG-NEXT:    v_cmp_gt_i64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e32 v7, v7, v3, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v6, v6, v2, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v3, v5, v1, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v2, v4, v0, vcc
; SDAG-NEXT:    v_sub_i32_e32 v4, vcc, 0, v12
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, 0, v13, vcc
; SDAG-NEXT:    v_or_b32_e32 v1, v3, v7
; SDAG-NEXT:    v_or_b32_e32 v0, v2, v6
; SDAG-NEXT:    v_ffbh_u32_e32 v9, v6
; SDAG-NEXT:    v_ffbh_u32_e32 v10, v7
; SDAG-NEXT:    v_ffbh_u32_e32 v11, v2
; SDAG-NEXT:    v_ffbh_u32_e32 v28, v3
; SDAG-NEXT:    v_subb_u32_e32 v29, vcc, 0, v14, vcc
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[0:1]
; SDAG-NEXT:    v_add_i32_e64 v0, s[6:7], 32, v9
; SDAG-NEXT:    v_add_i32_e64 v1, s[6:7], 32, v11
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, 0, v15, vcc
; SDAG-NEXT:    v_min_u32_e32 v10, v0, v10
; SDAG-NEXT:    v_min_u32_e32 v11, v1, v28
; SDAG-NEXT:    v_cmp_gt_i64_e32 vcc, 0, v[14:15]
; SDAG-NEXT:    v_cndmask_b32_e32 v1, v15, v9, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v0, v14, v29, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v28, v13, v5, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v29, v12, v4, vcc
; SDAG-NEXT:    v_add_i32_e32 v9, vcc, 64, v11
; SDAG-NEXT:    v_addc_u32_e64 v11, s[6:7], 0, 0, vcc
...
; SDAG-NEXT:    v_ffbh_u32_e32 v14, v29
; SDAG-NEXT:    v_ffbh_u32_e32 v15, v28
...
; SDAG-NEXT:    v_add_i32_e64 v4, s[6:7], 32, v12
; SDAG-NEXT:    v_add_i32_e64 v5, s[6:7], 32, v14
; SDAG-NEXT:    s_or_b64 s[6:7], vcc, s[4:5]
; SDAG-NEXT:    v_min_u32_e32 v4, v4, v13
; SDAG-NEXT:    v_min_u32_e32 v5, v5, v15
...
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v10, v11, vcc
; SDAG-NEXT:    v_xor_b32_e32 v9, 0x7f, v4
; SDAG-NEXT:    v_subb_u32_e32 v10, vcc, 0, v8, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[8:9], v[4:5]
...
; SDAG-NEXT:    v_subb_u32_e32 v17, vcc, 0, v6, vcc
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, 0, v7, vcc
; SDAG-NEXT:    v_cmp_gt_i64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e32 v7, v7, v18, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v6, v6, v17, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v5, v5, v9, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v4, v4, v8, vcc
; SDAG-NEXT:    v_sub_i32_e32 v17, vcc, 0, v12
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, 0, v13, vcc
...
; SDAG-NEXT:    v_subb_u32_e32 v23, vcc, 0, v14, vcc
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[8:9]
; SDAG-NEXT:    v_add_i32_e64 v8, s[6:7], 32, v19
; SDAG-NEXT:    v_add_i32_e64 v9, s[6:7], 32, v21
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, 0, v15, vcc
; SDAG-NEXT:    v_min_u32_e32 v20, v8, v20
; SDAG-NEXT:    v_min_u32_e32 v21, v9, v22
; SDAG-NEXT:    v_cmp_gt_i64_e32 vcc, 0, v[14:15]
; SDAG-NEXT:    v_cndmask_b32_e32 v9, v15, v19, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v8, v14, v23, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v36, v13, v18, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v37, v12, v17, vcc
; SDAG-NEXT:    v_add_i32_e32 v14, vcc, 64, v21
; SDAG-NEXT:    v_addc_u32_e64 v15, s[6:7], 0, 0, vcc
; SDAG-NEXT:    v_or_b32_e32 v13, v36, v9
; SDAG-NEXT:    v_or_b32_e32 v12, v37, v8
; SDAG-NEXT:    v_ffbh_u32_e32 v17, v8
; SDAG-NEXT:    v_ffbh_u32_e32 v18, v9
; SDAG-NEXT:    v_ffbh_u32_e32 v19, v37
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v36
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v15, v15, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v14, v14, v20, vcc
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[12:13]
; SDAG-NEXT:    v_add_i32_e64 v12, s[6:7], 32, v17
; SDAG-NEXT:    v_add_i32_e64 v13, s[6:7], 32, v19
; SDAG-NEXT:    s_or_b64 s[6:7], vcc, s[4:5]
; SDAG-NEXT:    v_min_u32_e32 v12, v12, v18
; SDAG-NEXT:    v_min_u32_e32 v13, v13, v21
; SDAG-NEXT:    v_add_i32_e32 v13, vcc, 64, v13
; SDAG-NEXT:    v_addc_u32_e64 v17, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v17, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v12, v13, v12, vcc
; SDAG-NEXT:    v_sub_i32_e32 v12, vcc, v12, v14
; SDAG-NEXT:    v_subb_u32_e32 v13, vcc, v17, v15, vcc
; SDAG-NEXT:    v_xor_b32_e32 v17, 0x7f, v12
; SDAG-NEXT:    v_subb_u32_e32 v14, vcc, 0, v16, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[8:9], v[12:13]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v15, vcc, 0, v16, vcc
; SDAG-NEXT:    v_or_b32_e32 v16, v17, v14
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[14:15]
; SDAG-NEXT:    v_cndmask_b32_e64 v19, 0, 1, vcc
...
; SDAG-NEXT:    v_lshl_b64 v[20:21], v[6:7], v15
; SDAG-NEXT:    v_sub_i32_e32 v12, vcc, 64, v15
; SDAG-NEXT:    v_lshl_b64 v[22:23], v[4:5], v15
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[13:14]
; SDAG-NEXT:    v_lshr_b64 v[12:13], v[4:5], v12
...
; SDAG-NEXT:    v_cndmask_b32_e64 v15, v14, v7, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v18, v6, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v18, 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
...
; SDAG-NEXT:    v_lshr_b64 v[53:54], v[6:7], v51
; SDAG-NEXT:    v_addc_u32_e32 v51, vcc, -1, v36, vcc
; SDAG-NEXT:    v_or_b32_e32 v17, v17, v25
; SDAG-NEXT:    v_or_b32_e32 v16, v16, v24
; SDAG-NEXT:    v_addc_u32_e32 v52, vcc, -1, v8, vcc
...
; SDAG-NEXT:    v_addc_u32_e32 v53, vcc, -1, v9, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v38
; SDAG-NEXT:    v_cndmask_b32_e32 v23, v17, v5, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v22, v16, v4, vcc
; SDAG-NEXT:    v_mov_b32_e32 v17, 0
...
; SDAG-NEXT:    v_and_b32_e32 v54, v21, v9
; SDAG-NEXT:    v_and_b32_e32 v55, v21, v8
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v15, v33, v11
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v33, v10, 0
; SDAG-NEXT:    v_mul_lo_u32 v24, v27, v10
; SDAG-NEXT:    v_mul_lo_u32 v25, v34, v31
; SDAG-NEXT:    v_mul_lo_u32 v34, v32, v30
; SDAG-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v31, v33, 0
; SDAG-NEXT:    v_mov_b32_e32 v10, 0
; SDAG-NEXT:    v_mul_lo_u32 v38, v16, v9
; SDAG-NEXT:    v_mad_u64_u32 v[20:21], s[4:5], v16, v8, 0
; SDAG-NEXT:    v_mul_lo_u32 v39, v17, v8
; SDAG-NEXT:    v_mul_lo_u32 v19, v19, v37
; SDAG-NEXT:    v_mul_lo_u32 v48, v18, v36
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v37, v16, 0
; SDAG-NEXT:    v_add_i32_e32 v8, vcc, v12, v15
; SDAG-NEXT:    v_mov_b32_e32 v9, v14
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v30, v33, v[9:10]
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v0, v13
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v21, v38
; SDAG-NEXT:    v_add_i32_e64 v12, s[4:5], v8, v24
; SDAG-NEXT:    v_mov_b32_e32 v9, v14
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v31, v27, v[9:10]
; SDAG-NEXT:    v_xor_b32_e32 v24, v0, v28
; SDAG-NEXT:    v_add_i32_e64 v21, s[4:5], v13, v39
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v32, v31, v[11:12]
; SDAG-NEXT:    v_add_i32_e64 v13, s[4:5], v15, v9
; SDAG-NEXT:    v_addc_u32_e64 v14, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v8, vcc, v1, v8, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v37, v[20:21]
; SDAG-NEXT:    v_mov_b32_e32 v9, v23
; SDAG-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v36, v16, v[9:10]
; SDAG-NEXT:    v_add_i32_e64 v18, s[4:5], v25, v12
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v30, v27, v[13:14]
; SDAG-NEXT:    v_xor_b32_e32 v14, v8, v29
; SDAG-NEXT:    v_add_i32_e64 v1, s[4:5], v19, v1
; SDAG-NEXT:    v_mov_b32_e32 v9, v15
; SDAG-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v37, v17, v[9:10]
; SDAG-NEXT:    v_add_i32_e64 v15, s[4:5], v34, v18
; SDAG-NEXT:    v_add_i32_e64 v18, s[4:5], v48, v1
; SDAG-NEXT:    v_add_i32_e64 v9, s[4:5], v16, v9
; SDAG-NEXT:    v_addc_u32_e64 v10, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_add_i32_e64 v1, s[4:5], v12, v11
; SDAG-NEXT:    v_addc_u32_e64 v11, s[4:5], v13, v15, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v12, vcc, v2, v1, vcc
; SDAG-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v36, v17, v[9:10]
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v3, v11, vcc
; SDAG-NEXT:    v_xor_b32_e32 v9, v12, v28
; SDAG-NEXT:    v_add_i32_e32 v10, vcc, v1, v0
; SDAG-NEXT:    v_addc_u32_e32 v11, vcc, v2, v18, vcc
; SDAG-NEXT:    v_xor_b32_e32 v3, v3, v29
; SDAG-NEXT:    v_sub_i32_e32 v0, vcc, v24, v28
; SDAG-NEXT:    v_subb_u32_e32 v1, vcc, v14, v29, vcc
; SDAG-NEXT:    v_subb_u32_e32 v2, vcc, v9, v28, vcc
...
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v6, v10, vcc
