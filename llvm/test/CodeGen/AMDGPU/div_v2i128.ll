...
; SDAG-NEXT:    v_cndmask_b32_e32 v9, v2, v3, vcc
...
; SDAG-NEXT:    v_add_i32_e32 v11, vcc, 32, v3
; SDAG-NEXT:    v_ffbh_u32_e32 v22, v0
; SDAG-NEXT:    v_or_b32_e32 v3, v28, v1
; SDAG-NEXT:    v_min_u32_e32 v10, v11, v10
; SDAG-NEXT:    v_add_i32_e32 v11, vcc, 32, v22
; SDAG-NEXT:    v_ffbh_u32_e32 v22, v1
; SDAG-NEXT:    v_min_u32_e32 v11, v11, v22
; SDAG-NEXT:    v_add_i32_e32 v10, vcc, 64, v10
...
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v22, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v10, v11, vcc
; SDAG-NEXT:    v_or_b32_e32 v19, v2, v19
; SDAG-NEXT:    v_sub_i32_e32 v2, vcc, v10, v9
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, v3, v8, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e32 v18, v18, v22, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v9, v19, v18
; SDAG-NEXT:    v_xor_b32_e32 v18, 1, v9
; SDAG-NEXT:    v_and_b32_e32 v9, 1, v9
; SDAG-NEXT:    v_and_b32_e32 v8, v18, v8
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v9
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v17, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v8, 1, v8
; SDAG-NEXT:    v_cndmask_b32_e64 v22, v16, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v21, 0, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v8
; SDAG-NEXT:    v_cndmask_b32_e64 v23, v20, 0, vcc
...
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[0:1]
; SDAG-NEXT:    v_cndmask_b32_e64 v11, 0, 1, s[6:7]
; SDAG-NEXT:    v_min_u32_e32 v1, v9, v30
; SDAG-NEXT:    v_add_i32_e64 v6, s[6:7], 64, v6
; SDAG-NEXT:    v_addc_u32_e64 v7, s[6:7], 0, 0, s[6:7]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v14, v6, v1, vcc
...
; SDAG-NEXT:    v_ffbh_u32_e32 v15, v1
; SDAG-NEXT:    v_min_u32_e32 v10, v10, v12
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; SDAG-NEXT:    v_min_u32_e32 v7, v9, v15
; SDAG-NEXT:    v_add_i32_e32 v9, vcc, 64, v10
; SDAG-NEXT:    v_addc_u32_e64 v10, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_or_b32_e32 v12, v6, v11
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, v10, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v6, v9, v7, vcc
...
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[8:9], v[6:7]
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; SDAG-NEXT:    v_cndmask_b32_e32 v13, v14, v13, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v9, v12, v13
; SDAG-NEXT:    v_xor_b32_e32 v12, 1, v9
; SDAG-NEXT:    v_and_b32_e32 v9, 1, v9
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v9
; SDAG-NEXT:    v_cndmask_b32_e64 v13, v5, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v14, v12, v8
; SDAG-NEXT:    v_cndmask_b32_e64 v12, v4, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v3, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v2, 0, vcc
...
; SDAG-NEXT:    v_or_b32_e32 v9, v9, v3
; SDAG-NEXT:    v_or_b32_e32 v12, v12, v0
...
; SDAG-NEXT:    v_xor_b32_e32 v11, v12, v6
; SDAG-NEXT:    v_xor_b32_e32 v9, v9, v7
...
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v9, v7, vcc
...
; SDAG-NEXT:    s_mov_b64 s[4:5], 0x7f
; SDAG-NEXT:    v_add_i32_e32 v20, vcc, 32, v20
; SDAG-NEXT:    v_add_i32_e32 v22, vcc, 32, v22
; SDAG-NEXT:    v_add_i32_e32 v24, vcc, 32, v24
; SDAG-NEXT:    v_add_i32_e32 v26, vcc, 32, v26
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[18:19]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; SDAG-NEXT:    v_min_u32_e32 v17, v20, v21
; SDAG-NEXT:    v_min_u32_e32 v19, v22, v23
; SDAG-NEXT:    v_min_u32_e32 v20, v24, v25
; SDAG-NEXT:    v_min_u32_e32 v21, v26, v27
; SDAG-NEXT:    v_or_b32_e32 v18, v16, v18
; SDAG-NEXT:    v_add_i32_e32 v16, vcc, 64, v19
; SDAG-NEXT:    v_addc_u32_e64 v19, s[6:7], 0, 0, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v22, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v20, v21, v20, vcc
; SDAG-NEXT:    v_sub_i32_e32 v22, vcc, v16, v20
; SDAG-NEXT:    v_subb_u32_e32 v23, vcc, v19, v17, vcc
; SDAG-NEXT:    v_xor_b32_e32 v16, 0x7f, v22
; SDAG-NEXT:    v_subb_u32_e32 v24, vcc, 0, v28, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[4:5], v[22:23]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v19, v20, v19, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v17, v18, v19
; SDAG-NEXT:    v_xor_b32_e32 v18, 1, v17
; SDAG-NEXT:    v_and_b32_e32 v17, 1, v17
; SDAG-NEXT:    v_and_b32_e32 v18, v18, v16
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v17
; SDAG-NEXT:    v_cndmask_b32_e64 v16, v3, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v19, 1, v18
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v2, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v1, 0, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v19
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v0, 0, vcc
; SDAG-NEXT:    s_and_saveexec_b64 s[6:7], s[4:5]
...
; SDAG-NEXT:    v_add_i32_e32 v1, vcc, 32, v8
; SDAG-NEXT:    v_add_i32_e32 v3, vcc, 32, v10
; SDAG-NEXT:    v_add_i32_e32 v8, vcc, 32, v20
; SDAG-NEXT:    v_add_i32_e32 v10, vcc, 32, v22
; SDAG-NEXT:    v_or_b32_e32 v22, v0, v2
; SDAG-NEXT:    v_min_u32_e32 v0, v1, v9
; SDAG-NEXT:    v_min_u32_e32 v1, v3, v11
; SDAG-NEXT:    v_min_u32_e32 v2, v8, v21
; SDAG-NEXT:    v_min_u32_e32 v3, v10, v23
...
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v3, v22, v8
; SDAG-NEXT:    v_xor_b32_e32 v9, 1, v3
; SDAG-NEXT:    v_and_b32_e32 v3, 1, v3
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v3
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v7, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v2, v9, v2
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v6, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v10, v5, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v11, v4, 0, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e64 v21, 0, 1, s[6:7]
; SDAG-NEXT:    v_subb_u32_e32 v3, vcc, 0, v11, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v10, v9, s[4:5]
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v20, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v18, v8, vcc
; SDAG-NEXT:    v_ffbh_u32_e32 v9, v31
; SDAG-NEXT:    v_ffbh_u32_e32 v18, v30
...
; SDAG-NEXT:    v_min_u32_e32 v11, v11, v18
; SDAG-NEXT:    v_add_i32_e32 v18, vcc, 32, v22
...
; SDAG-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v22, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v11, v11, v18, vcc
; SDAG-NEXT:    v_or_b32_e32 v21, v8, v21
; SDAG-NEXT:    v_sub_i32_e32 v10, vcc, v11, v10
; SDAG-NEXT:    v_subb_u32_e32 v11, vcc, v9, v20, vcc
; SDAG-NEXT:    v_xor_b32_e32 v8, 0x7f, v10
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, 0, v19, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[8:9], v[10:11]
...
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v9, v21, v20
; SDAG-NEXT:    v_xor_b32_e32 v20, 1, v9
; SDAG-NEXT:    v_and_b32_e32 v9, 1, v9
; SDAG-NEXT:    v_and_b32_e32 v8, v20, v8
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v9
; SDAG-NEXT:    v_cndmask_b32_e64 v34, v1, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v8, 1, v8
; SDAG-NEXT:    v_cndmask_b32_e64 v32, v0, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v27, v17, 0, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v8
; SDAG-NEXT:    v_cndmask_b32_e64 v33, v16, 0, vcc
; SDAG-NEXT:    s_and_saveexec_b64 s[6:7], s[4:5]
...
; SDAG-NEXT:    v_addc_u32_e64 v13, s[6:7], 0, 0, s[6:7]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v20, v10, v7, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v7, v15, v19, s[4:5]
; SDAG-NEXT:    v_or_b32_e32 v10, v37, v6
; SDAG-NEXT:    v_ffbh_u32_e32 v15, v6
; SDAG-NEXT:    v_add_i32_e32 v19, vcc, 32, v11
; SDAG-NEXT:    v_or_b32_e32 v11, v36, v7
; SDAG-NEXT:    v_add_i32_e32 v15, vcc, 32, v15
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v7
; SDAG-NEXT:    v_min_u32_e32 v14, v19, v14
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[10:11]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; SDAG-NEXT:    v_min_u32_e32 v11, v15, v21
; SDAG-NEXT:    v_add_i32_e32 v14, vcc, 64, v14
; SDAG-NEXT:    v_addc_u32_e64 v15, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_or_b32_e32 v19, v10, v12
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[6:7]
; SDAG-NEXT:    v_cndmask_b32_e64 v12, v15, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v14, v11, vcc
; SDAG-NEXT:    v_sub_i32_e32 v10, vcc, v10, v20
; SDAG-NEXT:    v_subb_u32_e32 v11, vcc, v12, v13, vcc
...
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[14:15]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v15, v19, v18
; SDAG-NEXT:    v_xor_b32_e32 v18, 1, v15
; SDAG-NEXT:    v_and_b32_e32 v15, 1, v15
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v15
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v5, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v20, v18, v14
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v4, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v15, v9, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v8, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v20, 1, v20
...
; SDAG-NEXT:    v_min_u32_e32 v20, v24, v25
; SDAG-NEXT:    v_min_u32_e32 v21, v26, v27
; SDAG-NEXT:    v_or_b32_e32 v22, v16, v18
; SDAG-NEXT:    v_add_i32_e32 v16, vcc, 64, v19
; SDAG-NEXT:    v_addc_u32_e64 v18, s[6:7], 0, 0, vcc
; SDAG-NEXT:    v_add_i32_e32 v19, vcc, 64, v21
; SDAG-NEXT:    v_addc_u32_e64 v21, s[6:7], 0, 0, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[10:11]
; SDAG-NEXT:    v_cndmask_b32_e64 v23, v18, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v16, v16, v17, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v21, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v18, v19, v20, vcc
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, v16, v18
; SDAG-NEXT:    v_subb_u32_e32 v19, vcc, v23, v17, vcc
; SDAG-NEXT:    v_xor_b32_e32 v16, 0x7f, v18
; SDAG-NEXT:    v_subb_u32_e32 v20, vcc, 0, v28, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[4:5], v[18:19]
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[20:21]
; SDAG-NEXT:    v_cndmask_b32_e32 v23, v24, v23, vcc
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v17, v22, v23
; SDAG-NEXT:    v_xor_b32_e32 v22, 1, v17
; SDAG-NEXT:    v_and_b32_e32 v17, 1, v17
; SDAG-NEXT:    v_and_b32_e32 v16, v22, v16
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v17
; SDAG-NEXT:    v_cndmask_b32_e64 v33, v3, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v16, 1, v16
; SDAG-NEXT:    v_cndmask_b32_e64 v31, v2, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v30, v1, 0, vcc
...
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; SDAG-NEXT:    v_add_i32_e32 v17, vcc, 32, v20
; SDAG-NEXT:    v_add_i32_e32 v19, vcc, 32, v22
; SDAG-NEXT:    v_add_i32_e32 v20, vcc, 32, v24
; SDAG-NEXT:    v_add_i32_e32 v22, vcc, 32, v26
; SDAG-NEXT:    v_or_b32_e32 v24, v16, v18
; SDAG-NEXT:    v_min_u32_e32 v16, v17, v21
; SDAG-NEXT:    v_min_u32_e32 v17, v19, v23
...
; SDAG-NEXT:    v_subb_u32_e32 v20, vcc, 0, v28, vcc
; SDAG-NEXT:    v_cmp_lt_u64_e64 s[4:5], s[4:5], v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, 0, 1, s[4:5]
; SDAG-NEXT:    v_subb_u32_e32 v21, vcc, 0, v28, vcc
...
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[18:19]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, 0, 1, vcc
; SDAG-NEXT:    v_or_b32_e32 v19, v24, v22
; SDAG-NEXT:    v_xor_b32_e32 v22, 1, v19
; SDAG-NEXT:    v_and_b32_e32 v19, 1, v19
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v19
; SDAG-NEXT:    v_cndmask_b32_e64 v23, v7, 0, vcc
; SDAG-NEXT:    v_and_b32_e32 v24, v22, v18
; SDAG-NEXT:    v_cndmask_b32_e64 v22, v6, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v5, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v4, 0, vcc
