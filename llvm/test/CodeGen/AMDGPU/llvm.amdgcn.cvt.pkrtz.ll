...
; RUN: llc -global-isel=0 -mtriple=amdgpu6.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=SI-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu6.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=SI-GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03 < %s | FileCheck %s -enable-var-scope -check-prefixes=VI,VI-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03 < %s | FileCheck %s -enable-var-scope -check-prefixes=VI,VI-GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu9.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX9,GFX9-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu9.00 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX9,GFX9-GISEL
; RUN: llc -global-isel=0 -mtriple=amdgpu10.10 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX10,GFX10-SDAG
; RUN: llc -global-isel=1 -mtriple=amdgpu10.10 < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX10,GFX10-GISEL
...
; GFX9-SDAG-NEXT:    global_store_dword v3, v1, s[0:1]
; GFX9-SDAG-NEXT:    s_endpgm
;
...
; GFX9-GISEL-NEXT:    global_store_dword v3, v1, s[0:1]
; GFX9-GISEL-NEXT:    s_endpgm
;
...
; GFX10-SDAG-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    global_load_dword v1, v3, s[2:3] glc dlc
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    global_load_dword v2, v3, s[6:7] glc dlc
; GFX10-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX10-SDAG-NEXT:    v_cvt_pkrtz_f16_f32_e64 v1, -v1, v2
; GFX10-SDAG-NEXT:    global_store_dword v3, v1, s[0:1]
; GFX10-SDAG-NEXT:    s_endpgm
;
...
; GFX10-GISEL-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    global_load_dword v1, v3, s[2:3] glc dlc
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    global_load_dword v2, v3, s[6:7] glc dlc
; GFX10-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-GISEL-NEXT:    v_max_f32_e64 v1, -v1, -v1
; GFX10-GISEL-NEXT:    v_cvt_pkrtz_f16_f32_e32 v1, v1, v2
; GFX10-GISEL-NEXT:    global_store_dword v3, v1, s[0:1]
; GFX10-GISEL-NEXT:    s_endpgm
;
...
; GFX11-SDAG-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    global_load_b32 v1, v3, s[2:3] glc dlc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    global_load_b32 v2, v3, s[4:5] glc dlc
; GFX11-SDAG-NEXT:    s_waitcnt vmcnt(0)
; GFX11-SDAG-NEXT:    v_cvt_pk_rtz_f16_f32_e64 v1, -v1, v2
; GFX11-SDAG-NEXT:    global_store_b32 v3, v1, s[0:1]
; GFX11-SDAG-NEXT:    s_endpgm
;
...
; GFX11-GISEL-NEXT:    v_lshlrev_b32_e32 v3, 2, v0
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    global_load_b32 v1, v3, s[2:3] glc dlc
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    global_load_b32 v2, v3, s[4:5] glc dlc
; GFX11-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX11-GISEL-NEXT:    v_max_f32_e64 v1, -v1, -v1
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-NEXT:    v_cvt_pk_rtz_f16_f32_e32 v1, v1, v2
; GFX11-GISEL-NEXT:    global_store_b32 v3, v1, s[0:1]
; GFX11-GISEL-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
  %a.gep = getelementptr inbounds float, ptr addrspace(1) %a.ptr, i64 %tid.ext
