...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck %s -enable-var-scope -check-prefixes=GFX11
...
; GFX11-NEXT:    global_load_b32 v2, v0, s[0:1] glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
