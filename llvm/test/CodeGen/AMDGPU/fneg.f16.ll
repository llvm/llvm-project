...
; CIVI-NEXT:    s_xor_b32 s1, s2, 0x80008000
; CIVI-NEXT:    v_mov_b32_e32 v0, s0
...
; CIVI-NEXT:    s_waitcnt lgkmcnt(0)
; CIVI-NEXT:    v_mov_b32_e32 v0, s0
; CIVI-NEXT:    s_xor_b32 s0, s2, 0x80008000
; CIVI-NEXT:    v_mov_b32_e32 v2, s0
; CIVI-NEXT:    flat_store_dword v[0:1], v2
; CIVI-NEXT:    s_endpgm
;
