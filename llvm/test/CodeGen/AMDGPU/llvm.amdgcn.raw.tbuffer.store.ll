...
;RUN: llc < %s -mtriple=amdgpu6.01 | FileCheck -check-prefix=PREGFX10,SI %s
;RUN: llc < %s -mtriple=amdgpu8.02 | FileCheck -check-prefix=PREGFX10,VI %s
...
;RUN: llc < %s -global-isel -mtriple=amdgpu12.00 | FileCheck -check-prefix=GFX12 %s
