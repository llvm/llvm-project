...
; RUN: llc -global-isel=0 -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GFX90A,GFX90A-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgpu9.0a < %s | FileCheck -check-prefixes=GFX90A,GFX90A-GISEL %s
