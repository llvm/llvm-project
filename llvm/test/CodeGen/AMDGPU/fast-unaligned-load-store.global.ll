...
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa -mattr=-unaligned-access-mode < %s | FileCheck --check-prefix=GFX7-ALIGNED %s
; RUN: llc -mtriple=amdgpu7.01-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX7-UNALIGNED %s
; RUN: llc -mtriple=amdgpu9.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX10 %s
; RUN: llc -mtriple=amdgpu11.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX11 %s
; RUN: llc -mtriple=amdgpu12.00-amd-amdhsa -mattr=+unaligned-access-mode < %s | FileCheck --check-prefix=GFX12 %s
...
; GFX7-ALIGNED-NEXT:    v_add_i32_e32 v4, vcc, 2, v0
; GFX7-ALIGNED-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; GFX7-ALIGNED-NEXT:    flat_load_ushort v2, v[4:5]
...
; GFX7-ALIGNED:       ; %bb.0:
; GFX7-ALIGNED-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-ALIGNED-NEXT:    v_add_i32_e32 v10, vcc, 2, v0
; GFX7-ALIGNED-NEXT:    v_addc_u32_e32 v11, vcc, 0, v1, vcc
...
; GFX7-ALIGNED-NEXT:    flat_load_ubyte v2, v[10:11]
