...
; GFX1250-NEXT:    ; kill: killed $vgpr2_vgpr3
; GFX1250-NEXT:    v_add_nc_u64_e32 v[4:5], s[0:1], v[4:5]
; GFX1250-NEXT:    global_load_async_to_lds_b128 v1, v[2:3], off
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_load_async_to_lds_b128 v0, v[4:5], off offset:512
...
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_store_async_from_lds_b128 v[4:5], v0, off offset:512
; GFX1250-NEXT:    global_store_async_from_lds_b128 v[4:5], v1, off
; GFX1250-NEXT:    s_endpgm
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %gep.offset = shl i32 %tid, 0
