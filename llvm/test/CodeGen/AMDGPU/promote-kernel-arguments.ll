...
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa < %s -amdgpu-promote-kernel-arguments -infer-address-spaces | FileCheck %s
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa < %s -passes=amdgpu-promote-kernel-arguments,infer-address-spaces | FileCheck %s
; RUN: opt -S -mtriple=amdgpu9.00-amd-amdhsa < %s -amdgpu-promote-kernel-arguments -infer-address-spaces | llc | FileCheck -check-prefix=GCN %s
