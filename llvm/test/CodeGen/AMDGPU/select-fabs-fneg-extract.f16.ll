...
; GFX11-SAFE-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SAFE-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0xbc00, 0xc000, vcc_lo
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-SAFE-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SAFE-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 1.0, 2.0, vcc_lo
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-SAFE-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SAFE-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 1.0, v1.l, vcc_lo
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-SAFE-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-SAFE-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0, v0
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 0.15915494, v1.l, vcc_lo
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SAFE-TRUE16-NEXT:    v_sub_f16_e32 v0.l, v2.l, v0.l
; GFX11-SAFE-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-SAFE-TRUE16-NEXT:    v_or_b16 v0.l, 0x8000, v1.l
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 4.0, v0.l, vcc_lo
...
; GFX11-SAFE-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SAFE-TRUE16-NEXT:    v_xor_b16 v0.l, 0x8000, v1.l
; GFX11-SAFE-TRUE16-NEXT:    v_cndmask_b16 v0.l, 2.0, v0.l, vcc_lo
; GFX11-SAFE-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; CI-NEXT:    s_movk_i32 s4, 0x3f1
; CI-NEXT:    v_cvt_f64_f32_e32 v[1:2], v2
...
; CI-NEXT:    v_or_b32_e32 v1, v3, v1
; CI-NEXT:    v_sub_i32_e32 v5, vcc, s4, v4
; CI-NEXT:    v_or_b32_e32 v3, 0x1000, v1
; CI-NEXT:    v_med3_i32 v5, v5, 0, 13
; CI-NEXT:    v_lshrrev_b32_e32 v6, v5, v3
; CI-NEXT:    v_lshlrev_b32_e32 v5, v5, v6
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, v5, v3
; CI-NEXT:    s_movk_i32 s4, 0xfc10
; CI-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; CI-NEXT:    v_add_i32_e32 v4, vcc, s4, v4
; CI-NEXT:    v_lshlrev_b32_e32 v5, 12, v4
; CI-NEXT:    v_or_b32_e32 v3, v6, v3
; CI-NEXT:    v_or_b32_e32 v5, v1, v5
; CI-NEXT:    v_cmp_gt_i32_e32 vcc, 1, v4
; CI-NEXT:    v_cndmask_b32_e32 v3, v5, v3, vcc
; CI-NEXT:    v_and_b32_e32 v5, 7, v3
; CI-NEXT:    v_cmp_lt_i32_e32 vcc, 5, v5
; CI-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CI-NEXT:    v_cmp_eq_u32_e32 vcc, 3, v5
; CI-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CI-NEXT:    v_or_b32_e32 v5, v5, v6
; CI-NEXT:    v_lshrrev_b32_e32 v3, 2, v3
; CI-NEXT:    v_add_i32_e32 v3, vcc, v3, v5
; CI-NEXT:    v_mov_b32_e32 v5, 0x7c00
; CI-NEXT:    v_cmp_gt_i32_e32 vcc, 31, v4
; CI-NEXT:    v_cndmask_b32_e32 v3, v5, v3, vcc
; CI-NEXT:    v_mov_b32_e32 v6, 0x7e00
; CI-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CI-NEXT:    s_movk_i32 s4, 0x40f
; CI-NEXT:    v_cndmask_b32_e32 v1, v5, v6, vcc
; CI-NEXT:    v_cmp_eq_u32_e32 vcc, s4, v4
; CI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; CI-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; CI-NEXT:    v_and_b32_e32 v2, 0x8000, v2
