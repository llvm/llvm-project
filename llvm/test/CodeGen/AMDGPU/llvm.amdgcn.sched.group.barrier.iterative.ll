...
; GCN-MINREG-NEXT:    v_add_u32_e32 v0, 0x6000, v35
; GCN-MINREG-NEXT:    v_accvgpr_write_b32 a2, v0
...
; GCN-MINREG-NEXT:    v_mov_b32_e32 v1, v35
...
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[56:59] offset:8288
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[60:63] offset:8304
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[48:51] offset:8256
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[52:55] offset:8272
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[40:43] offset:8224
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[44:47] offset:8240
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[32:35] offset:8192
; GCN-MINREG-NEXT:    ds_write_b128 v0, v[36:39] offset:8208
; GCN-MINREG-NEXT:    v_mov_b32_e32 v32, v1
; GCN-MINREG-NEXT:    ds_read_b128 v[28:31], v1 offset:24688
; GCN-MINREG-NEXT:    ds_read_b128 v[24:27], v1 offset:24672
; GCN-MINREG-NEXT:    ds_read_b128 v[20:23], v1 offset:24656
; GCN-MINREG-NEXT:    ds_read_b128 v[16:19], v1 offset:24640
; GCN-MINREG-NEXT:    ds_read_b128 v[12:15], v1 offset:24624
; GCN-MINREG-NEXT:    ds_read_b128 v[8:11], v1 offset:24608
; GCN-MINREG-NEXT:    ds_read_b128 v[4:7], v1 offset:24592
; GCN-MINREG-NEXT:    ds_read_b128 v[0:3], v1 offset:24576
; GCN-MINREG-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-MINREG-NEXT:    v_accvgpr_read_b32 v12, a2
...
; GCN-ILP-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-ILP-NEXT:    v_mfma_f32_32x32x1f32 v[0:31], a0, a1, v[0:31]
; GCN-ILP-NEXT:    v_mov_b32_e32 v32, s1
; GCN-ILP-NEXT:    s_nop 15
; GCN-ILP-NEXT:    s_nop 1
; GCN-ILP-NEXT:    ds_write_b128 v32, v[24:27] offset:8288
; GCN-ILP-NEXT:    v_mov_b32_e32 v24, s1
; GCN-ILP-NEXT:    ds_write_b128 v24, v[28:31] offset:8304
; GCN-ILP-NEXT:    v_mov_b32_e32 v28, v35
; GCN-ILP-NEXT:    ds_write_b128 v24, v[4:7] offset:8208
; GCN-ILP-NEXT:    ds_read_b128 v[4:7], v28 offset:49168
; GCN-ILP-NEXT:    ds_write_b128 v24, v[0:3] offset:8192
; GCN-ILP-NEXT:    ds_read_b128 v[0:3], v28 offset:49152
; GCN-ILP-NEXT:    ds_write_b128 v24, v[12:15] offset:8240
; GCN-ILP-NEXT:    ds_read_b128 v[12:15], v28 offset:49200
; GCN-ILP-NEXT:    ds_write_b128 v24, v[8:11] offset:8224
; GCN-ILP-NEXT:    ds_read_b128 v[8:11], v28 offset:49184
; GCN-ILP-NEXT:    ds_write_b128 v24, v[20:23] offset:8272
; GCN-ILP-NEXT:    ds_read_b128 v[20:23], v28 offset:49232
; GCN-ILP-NEXT:    ds_write_b128 v24, v[16:19] offset:8256
; GCN-ILP-NEXT:    ds_read_b128 v[16:19], v28 offset:49216
; GCN-ILP-NEXT:    ds_read_b128 v[32:35], v35 offset:24576
; GCN-ILP-NEXT:    ds_read_b128 v[36:39], v28 offset:24592
; GCN-ILP-NEXT:    ds_read_b128 v[40:43], v28 offset:24608
; GCN-ILP-NEXT:    ds_read_b128 v[44:47], v28 offset:24624
; GCN-ILP-NEXT:    ds_read_b128 v[48:51], v28 offset:24640
; GCN-ILP-NEXT:    ds_read_b128 v[52:55], v28 offset:24656
; GCN-ILP-NEXT:    ds_read_b128 v[56:59], v28 offset:24672
; GCN-ILP-NEXT:    ds_read_b128 v[60:63], v28 offset:24688
; GCN-ILP-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-ILP-NEXT:    v_mfma_f32_32x32x1f32 v[32:63], a0, a1, v[32:63]
; GCN-ILP-NEXT:    s_nop 15
; GCN-ILP-NEXT:    s_nop 2
; GCN-ILP-NEXT:    ds_write_b128 v24, v[56:59] offset:16480
; GCN-ILP-NEXT:    ds_write_b128 v24, v[60:63] offset:16496
; GCN-ILP-NEXT:    ds_write_b128 v24, v[48:51] offset:16448
; GCN-ILP-NEXT:    ds_write_b128 v24, v[52:55] offset:16464
; GCN-ILP-NEXT:    ds_write_b128 v24, v[40:43] offset:16416
; GCN-ILP-NEXT:    ds_write_b128 v24, v[44:47] offset:16432
; GCN-ILP-NEXT:    ds_write_b128 v24, v[32:35] offset:16384
; GCN-ILP-NEXT:    ds_write_b128 v24, v[36:39] offset:16400
; GCN-ILP-NEXT:    ds_read_b128 v[24:27], v28 offset:49248
; GCN-ILP-NEXT:    v_mov_b32_e32 v32, v28
; GCN-ILP-NEXT:    ds_read_b128 v[28:31], v28 offset:49264
; GCN-ILP-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-ILP-NEXT:    v_mfma_f32_32x32x1f32 v[0:31], a0, a1, v[0:31]
...
; GCN-MINREG-NEXT:    ds_read_b128 v[60:63], v35 offset:24688
; GCN-MINREG-NEXT:    ds_read_b128 v[56:59], v35 offset:24672
; GCN-MINREG-NEXT:    ds_read_b128 v[52:55], v35 offset:24656
; GCN-MINREG-NEXT:    ds_read_b128 v[48:51], v35 offset:24640
; GCN-MINREG-NEXT:    ds_read_b128 v[32:35], v35 offset:24576
; GCN-MINREG-NEXT:    ds_read_b128 v[36:39], v0 offset:24592
; GCN-MINREG-NEXT:    ds_read_b128 v[40:43], v0 offset:24608
; GCN-MINREG-NEXT:    ds_read_b128 v[44:47], v0 offset:24624
; GCN-MINREG-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-MINREG-NEXT:    v_mfma_f32_32x32x1f32 v[32:63], a1, a0, v[32:63]
; GCN-MINREG-NEXT:    v_add_u32_e32 v1, 0x6000, v0
; GCN-MINREG-NEXT:    v_accvgpr_write_b32 a2, v1
; GCN-MINREG-NEXT:    v_mov_b32_e32 v1, s1
; GCN-MINREG-NEXT:    ; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
; GCN-MINREG-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; GCN-MINREG-NEXT:    s_nop 15
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[60:63] offset:16496
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[56:59] offset:16480
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[52:55] offset:16464
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[48:51] offset:16448
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[44:47] offset:16432
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[40:43] offset:16416
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[36:39] offset:16400
; GCN-MINREG-NEXT:    ds_write_b128 v1, v[32:35] offset:16384
; GCN-MINREG-NEXT:    ds_read_b128 v[28:31], v0 offset:49264
; GCN-MINREG-NEXT:    ds_read_b128 v[24:27], v0 offset:49248
; GCN-MINREG-NEXT:    ds_read_b128 v[20:23], v0 offset:49232
; GCN-MINREG-NEXT:    ds_read_b128 v[16:19], v0 offset:49216
; GCN-MINREG-NEXT:    ds_read_b128 v[12:15], v0 offset:49200
; GCN-MINREG-NEXT:    ds_read_b128 v[8:11], v0 offset:49184
; GCN-MINREG-NEXT:    ds_read_b128 v[4:7], v0 offset:49168
; GCN-MINREG-NEXT:    ds_read_b128 v[0:3], v0 offset:49152
; GCN-MINREG-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-MINREG-NEXT:    v_mfma_f32_32x32x1f32 v[0:31], a1, a0, v[0:31]
; GCN-MINREG-NEXT:    v_mov_b32_e32 v32, s1
; GCN-MINREG-NEXT:    ; sched_group_barrier mask(0x00000200) size(8) SyncID(0)
...
; GCN-MAXOCC-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-MAXOCC-NEXT:    v_add_u32_e32 v35, s0, v32
; GCN-MAXOCC-NEXT:    ds_read_b128 v[28:31], v35 offset:112
; GCN-MAXOCC-NEXT:    ds_read_b128 v[24:27], v35 offset:96
; GCN-MAXOCC-NEXT:    ds_read_b128 v[20:23], v35 offset:80
; GCN-MAXOCC-NEXT:    ds_read_b128 v[16:19], v35 offset:64
; GCN-MAXOCC-NEXT:    ds_read_b128 v[0:3], v35
; GCN-MAXOCC-NEXT:    ds_read_b128 v[4:7], v35 offset:16
; GCN-MAXOCC-NEXT:    ds_read_b128 v[8:11], v35 offset:32
; GCN-MAXOCC-NEXT:    ds_read_b128 v[12:15], v35 offset:48
; GCN-MAXOCC-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-MAXOCC-NEXT:    ds_write_b128 v32, v[4:7] offset:16
; GCN-MAXOCC-NEXT:    ds_write_b128 v32, v[0:3]
; GCN-MAXOCC-NEXT:    v_mov_b32_e32 v1, v35
; GCN-MAXOCC-NEXT:    ds_read_b128 v[60:63], v35 offset:8304
; GCN-MAXOCC-NEXT:    ds_read_b128 v[56:59], v35 offset:8288
; GCN-MAXOCC-NEXT:    ds_read_b128 v[52:55], v35 offset:8272
; GCN-MAXOCC-NEXT:    ds_read_b128 v[48:51], v35 offset:8256
; GCN-MAXOCC-NEXT:    ds_read_b128 v[44:47], v35 offset:8240
; GCN-MAXOCC-NEXT:    ds_read_b128 v[40:43], v35 offset:8224
; GCN-MAXOCC-NEXT:    ds_read_b128 v[36:39], v35 offset:8208
; GCN-MAXOCC-NEXT:    ds_read_b128 v[32:35], v35 offset:8192
; GCN-MAXOCC-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-MAXOCC-NEXT:    v_mfma_f32_32x32x1f32 v[32:63], a0, a1, v[32:63]
...
; GCN-MAXOCC-NEXT:    s_nop 15
; GCN-MAXOCC-NEXT:    s_nop 1
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[56:59] offset:8288
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[60:63] offset:8304
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[48:51] offset:8256
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[52:55] offset:8272
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[40:43] offset:8224
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[44:47] offset:8240
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[32:35] offset:8192
; GCN-MAXOCC-NEXT:    ds_write_b128 v0, v[36:39] offset:8208
; GCN-MAXOCC-NEXT:    v_mov_b32_e32 v33, s1
; GCN-MAXOCC-NEXT:    ; sched_group_barrier mask(0x00000200) size(8) SyncID(0)
; GCN-MAXOCC-NEXT:    ; sched_barrier mask(0x00000000)
; GCN-MAXOCC-NEXT:    v_mov_b32_e32 v32, v1
; GCN-MAXOCC-NEXT:    ds_read_b128 v[28:31], v1 offset:24688
; GCN-MAXOCC-NEXT:    ds_read_b128 v[24:27], v1 offset:24672
; GCN-MAXOCC-NEXT:    ds_read_b128 v[20:23], v1 offset:24656
; GCN-MAXOCC-NEXT:    ds_read_b128 v[16:19], v1 offset:24640
; GCN-MAXOCC-NEXT:    ds_read_b128 v[0:3], v1 offset:24576
...
; GCN-ILP-NEXT:    ds_write_b128 v0, v[60:63] offset:8304
; GCN-ILP-NEXT:    ds_write_b128 v0, v[48:51] offset:8256
; GCN-ILP-NEXT:    ds_write_b128 v0, v[52:55] offset:8272
; GCN-ILP-NEXT:    ds_write_b128 v0, v[40:43] offset:8224
; GCN-ILP-NEXT:    ds_write_b128 v0, v[44:47] offset:8240
; GCN-ILP-NEXT:    ds_write_b128 v0, v[32:35] offset:8192
; GCN-ILP-NEXT:    ds_write_b128 v0, v[36:39] offset:8208
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000200) size(8) SyncID(0)
; GCN-ILP-NEXT:    ; sched_barrier mask(0x00000000)
; GCN-ILP-NEXT:    ds_read_b128 v[44:47], v1 offset:24624
; GCN-ILP-NEXT:    ds_read_b128 v[40:43], v1 offset:24608
; GCN-ILP-NEXT:    ds_read_b128 v[36:39], v1 offset:24592
; GCN-ILP-NEXT:    ds_read_b128 v[32:35], v1 offset:24576
; GCN-ILP-NEXT:    ds_read_b128 v[48:51], v1 offset:24640
; GCN-ILP-NEXT:    ds_read_b128 v[52:55], v1 offset:24656
; GCN-ILP-NEXT:    ds_read_b128 v[56:59], v1 offset:24672
; GCN-ILP-NEXT:    ds_read_b128 v[60:63], v1 offset:24688
; GCN-ILP-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-ILP-NEXT:    v_mfma_f32_32x32x1f32 v[32:63], a0, a1, v[32:63]
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
; GCN-ILP-NEXT:    s_nop 15
; GCN-ILP-NEXT:    s_nop 2
; GCN-ILP-NEXT:    ds_write_b128 v0, v[60:63] offset:16496
; GCN-ILP-NEXT:    v_mov_b32_e32 v60, s1
; GCN-ILP-NEXT:    ds_write_b128 v60, v[32:35] offset:16384
; GCN-ILP-NEXT:    v_mov_b32_e32 v32, v1
; GCN-ILP-NEXT:    ds_read_b128 v[0:3], v1 offset:49152
...
; GCN-ILP-NEXT:    s_nop 15
; GCN-ILP-NEXT:    s_nop 0
; GCN-ILP-NEXT:    ds_write_b128 v60, v[0:3] offset:24576
; GCN-ILP-NEXT:    ds_read_b128 v[0:3], v32 offset:57344
; GCN-ILP-NEXT:    ds_write_b128 v60, v[4:7] offset:24592
; GCN-ILP-NEXT:    ds_read_b128 v[4:7], v32 offset:57360
; GCN-ILP-NEXT:    ds_write_b128 v60, v[8:11] offset:24608
; GCN-ILP-NEXT:    ds_read_b128 v[8:11], v32 offset:57376
; GCN-ILP-NEXT:    ds_write_b128 v60, v[12:15] offset:24624
; GCN-ILP-NEXT:    ds_read_b128 v[12:15], v32 offset:57392
; GCN-ILP-NEXT:    ds_write_b128 v60, v[16:19] offset:24640
; GCN-ILP-NEXT:    ds_read_b128 v[16:19], v32 offset:57408
; GCN-ILP-NEXT:    ds_write_b128 v60, v[20:23] offset:24656
; GCN-ILP-NEXT:    ds_read_b128 v[20:23], v32 offset:57424
; GCN-ILP-NEXT:    ds_write_b128 v60, v[24:27] offset:24672
; GCN-ILP-NEXT:    ds_read_b128 v[24:27], v32 offset:57440
; GCN-ILP-NEXT:    ds_write_b128 v60, v[28:31] offset:24688
; GCN-ILP-NEXT:    ds_read_b128 v[28:31], v32 offset:57456
; GCN-ILP-NEXT:    ds_write_b128 v60, v[56:59] offset:16480
; GCN-ILP-NEXT:    ds_write_b128 v60, v[52:55] offset:16464
; GCN-ILP-NEXT:    ds_write_b128 v60, v[48:51] offset:16448
; GCN-ILP-NEXT:    ds_write_b128 v60, v[44:47] offset:16432
; GCN-ILP-NEXT:    ds_write_b128 v60, v[40:43] offset:16416
; GCN-ILP-NEXT:    ds_write_b128 v60, v[36:39] offset:16400
; GCN-ILP-NEXT:    s_waitcnt lgkmcnt(6)
; GCN-ILP-NEXT:    v_mfma_f32_32x32x1f32 v[0:31], a0, a1, v[0:31]
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000100) size(8) SyncID(0)
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000200) size(8) SyncID(0)
; GCN-ILP-NEXT:    ; sched_group_barrier mask(0x00000008) size(1) SyncID(0)
