...
; RUN: llc -global-isel -mtriple=amdgpu9.0a < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
; RUN: llc -mtriple=amdgpu9.42 < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
; RUN: llc -global-isel -mtriple=amdgpu9.42 < %s | FileCheck --enable-var-scope --check-prefixes=GCN %s
