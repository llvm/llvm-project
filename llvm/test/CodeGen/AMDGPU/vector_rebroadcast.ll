...
;
; GFX13-LABEL: shuffle_v2i8_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
...
; GFX13-NEXT:    global_load_u16 v0, v[0:1], off
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4i8_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_lshrrev_b32_e32 v0, 8, v0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8i8_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_mov_b32_e32 v7, v0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16i8_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_mov_b32_e32 v15, v0
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32i8_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_dual_mov_b32 v17, v0 :: v_dual_mov_b32 v18, v0
; GFX13-NEXT:    v_dual_mov_b32 v19, v0 :: v_dual_mov_b32 v20, v0
; GFX13-NEXT:    v_dual_mov_b32 v21, v0 :: v_dual_mov_b32 v22, v0
; GFX13-NEXT:    v_dual_mov_b32 v23, v0 :: v_dual_mov_b32 v24, v0
; GFX13-NEXT:    v_dual_mov_b32 v25, v0 :: v_dual_mov_b32 v26, v0
; GFX13-NEXT:    v_dual_mov_b32 v27, v0 :: v_dual_mov_b32 v28, v0
; GFX13-NEXT:    v_dual_mov_b32 v29, v0 :: v_dual_mov_b32 v30, v0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v2i16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    global_load_b32 v0, v[0:1], off
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_perm_b32 v0, v0, v0, 0x7060302
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4i16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8i16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16i16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32i16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v2i32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4i32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8i32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16i32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32i32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v2bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v3bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    global_load_b32 v1, v[0:1], off
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_perm_b32 v0, v1, v1, 0x7060302
; GFX13-NEXT:    v_alignbit_b32 v1, s0, v1, 16
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v6bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32bf16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v2f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v3f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v6f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32f16_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v2f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v3f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    global_load_b96 v[0:2], v[0:1], off
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_mov_b32 v2, v1
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v4f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v6f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_mov_b32 v2, v1
; GFX13-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v4, v1
; GFX13-NEXT:    v_mov_b32_e32 v5, v1
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v8f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_dual_mov_b32 v0, v1 :: v_dual_mov_b32 v2, v1
; GFX13-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v4, v1
; GFX13-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v6, v1
; GFX13-NEXT:    v_mov_b32_e32 v7, v1
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v16f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v4, v1
; GFX13-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v6, v1
; GFX13-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v8, v1
; GFX13-NEXT:    v_dual_mov_b32 v9, v1 :: v_dual_mov_b32 v10, v1
; GFX13-NEXT:    v_dual_mov_b32 v11, v1 :: v_dual_mov_b32 v12, v1
; GFX13-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v14, v1
; GFX13-NEXT:    v_mov_b32_e32 v15, v1
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: shuffle_v32f32_rebroadcast:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    v_dual_mov_b32 v11, v1 :: v_dual_mov_b32 v12, v1
; GFX13-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v14, v1
; GFX13-NEXT:    v_dual_mov_b32 v15, v1 :: v_dual_mov_b32 v16, v1
; GFX13-NEXT:    v_dual_mov_b32 v17, v1 :: v_dual_mov_b32 v18, v1
; GFX13-NEXT:    v_dual_mov_b32 v19, v1 :: v_dual_mov_b32 v20, v1
; GFX13-NEXT:    v_dual_mov_b32 v21, v1 :: v_dual_mov_b32 v22, v1
; GFX13-NEXT:    v_dual_mov_b32 v23, v1 :: v_dual_mov_b32 v24, v1
; GFX13-NEXT:    v_dual_mov_b32 v25, v1 :: v_dual_mov_b32 v26, v1
; GFX13-NEXT:    v_dual_mov_b32 v27, v1 :: v_dual_mov_b32 v28, v1
; GFX13-NEXT:    v_dual_mov_b32 v29, v1 :: v_dual_mov_b32 v30, v1
; GFX13-NEXT:    v_mov_b32_e32 v31, v1
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
entry:
