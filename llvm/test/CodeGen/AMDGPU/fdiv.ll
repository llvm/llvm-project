...
; GFX6-FASTFMA-NEXT:    s_mov_b32 s5, 0
...
; GFX6-SLOWFMA-NEXT:    s_mov_b32 s5, 0
...
; GFX10-NEXT:    v_div_scale_f32 v0, s1, s3, s3, s2
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_cmp_lt_f32_e64 s1, 0x6f800000, |s3|
; GFX10-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0x2f800000, s1
; GFX10-NEXT:    s_mov_b32 s1, 0
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cmp_lt_f32_e64 s1, 0x6f800000, |s3|
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0x2f800000, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; GFX6-SLOWFMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-SLOWFMA-NEXT:    s_mov_b32 s1, 0
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_div_scale_f32 v0, s1, s7, s7, s3
...
; GFX10-NEXT:    v_fma_f32 v0, -v0, v3, v2
; GFX10-NEXT:    s_denorm_mode 12
; GFX10-NEXT:    v_div_scale_f32 v2, s1, s6, s6, s2
; GFX10-NEXT:    v_div_fmas_f32 v0, v0, v1, v3
; GFX10-NEXT:    s_mov_b32 s1, 0
...
; GFX6-FASTFMA-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-FASTFMA-NEXT:    s_mov_b32 s4, s0
; GFX6-FASTFMA-NEXT:    v_div_scale_f32 v0, s[0:1], s2, s2, 1.0
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_mov_b32 s4, s0
; GFX7-NEXT:    v_div_scale_f32 v0, s[0:1], s2, s2, 1.0
...
; GFX10-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    v_div_scale_f32 v0, s1, s2, s2, 1.0
