...
; GFX90A-NEXT:    v_mul_lo_u32 v3, s0, v1
; GFX90A-NEXT:    v_mul_hi_u32 v5, s0, v0
; GFX90A-NEXT:    v_mul_hi_u32 v2, s0, v1
; GFX90A-NEXT:    v_add_co_u32_e32 v3, vcc, v5, v3
; GFX90A-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v2, vcc
; GFX90A-NEXT:    v_mul_hi_u32 v7, s1, v0
; GFX90A-NEXT:    v_mul_lo_u32 v0, s1, v0
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, v3, v0
; GFX90A-NEXT:    v_mul_hi_u32 v5, s1, v1
...
; GFX90A-NEXT:    v_mul_lo_u32 v2, v1, s6
; GFX90A-NEXT:    v_mul_hi_u32 v3, v0, s6
; GFX90A-NEXT:    v_add_u32_e32 v2, v3, v2
; GFX90A-NEXT:    v_mul_lo_u32 v3, v0, s6
; GFX90A-NEXT:    v_mov_b32_e32 v5, s1
; GFX90A-NEXT:    v_sub_co_u32_e32 v3, vcc, s0, v3
; GFX90A-NEXT:    v_subb_co_u32_e32 v2, vcc, v5, v2, vcc
; GFX90A-NEXT:    v_subrev_co_u32_e32 v5, vcc, s6, v3
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v6, vcc, 0, v2, vcc
; GFX90A-NEXT:    s_movk_i32 s6, 0xffe
; GFX90A-NEXT:    v_cmp_lt_u32_e32 vcc, s6, v5
; GFX90A-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v2, -1, v3, vcc
; GFX90A-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v8, v6, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e64 v5, v9, v7, s[0:1]
; GFX90A-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v1, v5, vcc
; GFX90A-NEXT:    v_xor_b32_e32 v0, s8, v0
; GFX90A-NEXT:    v_xor_b32_e32 v1, s8, v1
; GFX90A-NEXT:    v_mov_b32_e32 v3, s8
; GFX90A-NEXT:    v_subrev_co_u32_e32 v2, vcc, s8, v0
...
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v1, vcc, v6, v2, vcc
; GFX90A-NEXT:    v_mul_lo_u32 v2, s14, v1
; GFX90A-NEXT:    v_mul_hi_u32 v3, s14, v0
; GFX90A-NEXT:    v_add_u32_e32 v2, v3, v2
; GFX90A-NEXT:    v_mul_lo_u32 v3, s15, v0
; GFX90A-NEXT:    v_add_u32_e32 v2, v2, v3
; GFX90A-NEXT:    v_mul_lo_u32 v5, s14, v0
; GFX90A-NEXT:    v_sub_u32_e32 v3, s5, v2
; GFX90A-NEXT:    v_mov_b32_e32 v7, s15
; GFX90A-NEXT:    v_sub_co_u32_e64 v5, s[0:1], s4, v5
; GFX90A-NEXT:    v_subb_co_u32_e64 v3, vcc, v3, v7, s[0:1]
; GFX90A-NEXT:    v_subrev_co_u32_e32 v7, vcc, s14, v5
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v3, vcc, 0, v3, vcc
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v3, v8, v7, vcc
...
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[2:3], 0, v3
; GFX90A-NEXT:    v_cndmask_b32_e64 v3, v10, v8, s[2:3]
; GFX90A-NEXT:    v_mov_b32_e32 v8, s5
; GFX90A-NEXT:    v_subb_co_u32_e64 v2, vcc, v8, v2, s[0:1]
; GFX90A-NEXT:    v_cmp_le_u32_e32 vcc, s15, v2
; GFX90A-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; GFX90A-NEXT:    v_cmp_le_u32_e32 vcc, s14, v5
; GFX90A-NEXT:    v_cndmask_b32_e64 v5, 0, -1, vcc
; GFX90A-NEXT:    v_cmp_eq_u32_e32 vcc, s15, v2
; GFX90A-NEXT:    v_cndmask_b32_e32 v2, v8, v5, vcc
; GFX90A-NEXT:    s_xor_b64 s[0:1], s[16:17], s[12:13]
; GFX90A-NEXT:    s_ashr_i32 s4, s11, 31
; GFX90A-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v2
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v9, v7, s[2:3]
...
; GFX90A-NEXT:    s_sub_u32 s2, 0, s10
; GFX90A-NEXT:    v_xor_b32_e32 v1, s1, v1
; GFX90A-NEXT:    v_mac_f32_e32 v2, s18, v3
; GFX90A-NEXT:    v_rcp_f32_e32 v2, v2
; GFX90A-NEXT:    v_mov_b32_e32 v5, s1
; GFX90A-NEXT:    v_subrev_co_u32_e32 v0, vcc, s0, v0
; GFX90A-NEXT:    v_mul_f32_e32 v2, s19, v2
; GFX90A-NEXT:    v_mul_f32_e32 v3, s20, v2
; GFX90A-NEXT:    v_trunc_f32_e32 v3, v3
; GFX90A-NEXT:    v_mac_f32_e32 v2, s21, v3
; GFX90A-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX90A-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX90A-NEXT:    s_subb_u32 s3, 0, s11
...
; GFX90A-NEXT:    v_mul_hi_u32 v6, s10, v2
; GFX90A-NEXT:    v_add_u32_e32 v5, v6, v5
; GFX90A-NEXT:    v_mul_lo_u32 v6, s11, v2
; GFX90A-NEXT:    v_add_u32_e32 v5, v5, v6
; GFX90A-NEXT:    v_mul_lo_u32 v7, s10, v2
...
; GFX90A-NEXT:    v_add_co_u32_e32 v8, vcc, 2, v2
; GFX90A-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v3, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v10, vcc, 1, v2
...
; GFX90A-NEXT:    v_subb_co_u32_e64 v2, vcc, v2, v3, s[0:1]
; GFX90A-NEXT:    v_subrev_co_u32_e64 v5, s[2:3], s12, v0
; GFX90A-NEXT:    v_subbrev_co_u32_e64 v7, vcc, 0, v2, s[2:3]
...
; GFX90A-NEXT:    v_subb_co_u32_e64 v2, vcc, v2, v3, s[2:3]
; GFX90A-NEXT:    v_subrev_co_u32_e32 v3, vcc, s12, v5
; GFX90A-NEXT:    v_subbrev_co_u32_e32 v2, vcc, 0, v2, vcc
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[2:3], 0, v8
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v7, v2, s[2:3]
...
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; GFX90A-NEXT:    v_cndmask_b32_e64 v2, v5, v3, s[2:3]
...
; GFX90A-NEXT:    v_sub_co_u32_e64 v2, s[0:1], s6, v2
; GFX90A-NEXT:    v_subb_co_u32_e64 v5, vcc, v5, v6, s[0:1]
; GFX90A-NEXT:    v_subrev_co_u32_e64 v7, s[2:3], s4, v2
