...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s5, s6, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s5
; GFX6-NEXT:    s_bfe_i32 s5, s6, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s5
; GFX6-NEXT:    s_lshl_b32 s4, s6, 29
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_lshl_b32 s6, s6, 21
; GFX6-NEXT:    s_xor_b32 s4, s4, s6
; GFX6-NEXT:    s_ashr_i32 s4, s4, 30
; GFX6-NEXT:    v_mul_f32_e32 v2, v1, v2
; GFX6-NEXT:    v_trunc_f32_e32 v2, v2
...
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s3, s6, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s3
; GFX6-NEXT:    s_bfe_i32 s3, s6, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s3
; GFX6-NEXT:    s_lshl_b32 s2, s6, 29
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_lshl_b32 s5, s6, 21
...
; GFX9-NEXT:    s_lshl_b32 s0, s2, 29
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX9-NEXT:    s_lshl_b32 s6, s2, 21
...
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GFX6-NEXT:    s_bfe_i32 s7, s10, 0xf0000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s7
; GFX6-NEXT:    s_mov_b32 s0, s8
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_mov_b32 s1, s9
; GFX6-NEXT:    s_lshr_b64 s[8:9], s[4:5], 30
; GFX6-NEXT:    s_lshl_b32 s5, s10, 17
; GFX6-NEXT:    s_lshl_b32 s9, s4, 17
; GFX6-NEXT:    v_mul_f32_e32 v2, v1, v2
...
; GFX6-NEXT:    s_bfe_i32 s7, s4, 0xf000f
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s7
; GFX6-NEXT:    s_bfe_i32 s7, s10, 0xf000f
; GFX6-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s7
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v3, v0
; GFX6-NEXT:    s_lshl_b32 s4, s4, 2
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, s5, v2
; GFX6-NEXT:    s_lshl_b32 s5, s10, 2
; GFX6-NEXT:    v_mul_f32_e32 v3, v1, v3
; GFX6-NEXT:    s_xor_b32 s4, s5, s4
; GFX6-NEXT:    v_trunc_f32_e32 v3, v3
; GFX6-NEXT:    s_ashr_i32 s4, s4, 30
...
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v4, v0
; GFX6-NEXT:    s_lshl_b32 s5, s6, 17
; GFX6-NEXT:    s_lshl_b32 s6, s8, 17
; GFX6-NEXT:    s_xor_b32 s4, s5, s6
; GFX6-NEXT:    v_mul_f32_e32 v4, v1, v4
; GFX6-NEXT:    v_trunc_f32_e32 v4, v4
; GFX6-NEXT:    s_ashr_i32 s4, s4, 30
; GFX6-NEXT:    v_mad_f32 v1, -v4, v0, v1
...
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v3, v0
; GFX9-NEXT:    s_lshl_b32 s3, s2, 17
; GFX9-NEXT:    s_lshl_b32 s7, s6, 17
; GFX9-NEXT:    s_xor_b32 s3, s3, s7
; GFX9-NEXT:    v_mul_f32_e32 v3, v1, v3
; GFX9-NEXT:    v_trunc_f32_e32 v3, v3
...
; GFX9-NEXT:    s_lshl_b32 s3, s2, 2
; GFX9-NEXT:    s_bfe_i32 s2, s2, 0xf000f
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s2
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v4, v0
; GFX9-NEXT:    s_lshl_b32 s5, s6, 2
; GFX9-NEXT:    s_xor_b32 s2, s3, s5
; GFX9-NEXT:    s_ashr_i32 s2, s2, 30
; GFX9-NEXT:    v_mul_f32_e32 v4, v1, v4
; GFX9-NEXT:    v_trunc_f32_e32 v4, v4
; GFX9-NEXT:    v_mad_f32 v1, -v4, v0, v1
...
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s2
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v5, v0
; GFX9-NEXT:    s_lshl_b32 s3, s4, 17
; GFX9-NEXT:    s_lshl_b32 s4, s8, 17
...
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshl_b32 s0, s10, 17
...
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_lshl_b32 s5, s4, 17
; GFX6-NEXT:    s_xor_b32 s0, s0, s5
; GFX6-NEXT:    s_lshr_b64 s[6:7], s[10:11], 30
; GFX6-NEXT:    v_mul_f32_e32 v2, v1, v2
; GFX6-NEXT:    v_trunc_f32_e32 v2, v2
...
; GFX6-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GFX6-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX6-NEXT:    s_lshr_b32 s7, s10, 15
; GFX6-NEXT:    s_and_b32 s11, s6, 0x7fff
; GFX6-NEXT:    s_and_b32 s13, s12, 0x7fff
; GFX6-NEXT:    s_lshr_b32 s14, s4, 15
; GFX6-NEXT:    s_or_b32 s5, s0, 1
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v1|, |v0|
; GFX6-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GFX6-NEXT:    s_cselect_b32 s0, s5, 0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s0, v2
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, s4
; GFX6-NEXT:    s_mov_b32 s0, s8
; GFX6-NEXT:    s_bfe_i32 s8, s4, 0xf000f
; GFX6-NEXT:    s_lshl_b32 s5, s10, 2
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, s10, v0
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s8
; GFX6-NEXT:    s_bfe_i32 s8, s10, 0xf000f
...
; GFX6-NEXT:    v_cvt_i32_f32_e32 v3, v3
; GFX6-NEXT:    s_cselect_b32 s4, s8, 0
; GFX6-NEXT:    s_bfe_i32 s5, s12, 0xf0000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s5
...
; GFX6-NEXT:    s_lshl_b32 s5, s6, 17
; GFX6-NEXT:    s_lshl_b32 s6, s12, 17
; GFX6-NEXT:    s_xor_b32 s4, s5, s6
; GFX6-NEXT:    v_mul_f32_e32 v4, v3, v4
; GFX6-NEXT:    v_trunc_f32_e32 v4, v4
; GFX6-NEXT:    s_ashr_i32 s4, s4, 30
...
; GFX6-NEXT:    v_sub_i32_e32 v3, vcc, s7, v0
; GFX6-NEXT:    v_and_b32_e32 v3, 0x7fff, v3
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, s11, v1
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[0:1], 30
; GFX6-NEXT:    v_and_b32_e32 v2, 0x7fff, v2
; GFX6-NEXT:    v_lshlrev_b32_e32 v3, 15, v3
; GFX6-NEXT:    v_or_b32_e32 v2, v3, v2
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshr_b64 s[4:5], s[2:3], 30
; GFX9-NEXT:    s_bfe_i32 s10, s6, 0xf0000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v0, s10
; GFX9-NEXT:    s_bfe_i32 s10, s2, 0xf0000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s10
; GFX9-NEXT:    s_lshr_b64 s[8:9], s[6:7], 30
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX9-NEXT:    s_lshl_b32 s7, s2, 17
; GFX9-NEXT:    s_lshl_b32 s11, s6, 17
; GFX9-NEXT:    s_xor_b32 s7, s7, s11
; GFX9-NEXT:    v_mul_f32_e32 v2, v1, v2
; GFX9-NEXT:    v_trunc_f32_e32 v2, v2
; GFX9-NEXT:    s_ashr_i32 s7, s7, 30
; GFX9-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GFX9-NEXT:    s_lshr_b32 s3, s2, 15
; GFX9-NEXT:    s_and_b32 s9, s4, 0x7fff
; GFX9-NEXT:    s_and_b32 s12, s8, 0x7fff
; GFX9-NEXT:    s_lshr_b32 s5, s6, 15
; GFX9-NEXT:    s_or_b32 s7, s7, 1
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[10:11], |v1|, |v0|
; GFX9-NEXT:    s_and_b64 s[10:11], s[10:11], exec
; GFX9-NEXT:    s_cselect_b32 s7, s7, 0
; GFX9-NEXT:    s_bfe_i32 s10, s6, 0xf000f
; GFX9-NEXT:    v_cvt_i32_f32_e32 v2, v2
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s10
; GFX9-NEXT:    s_bfe_i32 s10, s2, 0xf000f
; GFX9-NEXT:    v_add_u32_e32 v0, s7, v2
; GFX9-NEXT:    v_cvt_f32_i32_e32 v2, s10
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v3, v1
; GFX9-NEXT:    v_mul_lo_u32 v0, v0, s6
; GFX9-NEXT:    s_lshl_b32 s7, s2, 2
; GFX9-NEXT:    s_lshl_b32 s6, s6, 2
; GFX9-NEXT:    v_mul_f32_e32 v3, v2, v3
...
; GFX9-NEXT:    v_add_u32_e32 v1, s6, v3
; GFX9-NEXT:    s_bfe_i32 s6, s8, 0xf0000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v2, s6
; GFX9-NEXT:    v_mul_lo_u32 v1, v1, s5
; GFX9-NEXT:    s_bfe_i32 s5, s4, 0xf0000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v3, s5
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v4, v2
; GFX9-NEXT:    s_lshl_b32 s4, s4, 17
; GFX9-NEXT:    s_lshl_b32 s6, s8, 17
