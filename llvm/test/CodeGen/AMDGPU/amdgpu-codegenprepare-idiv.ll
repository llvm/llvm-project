...
; GFX9-NEXT:    v_sub_u32_e32 v0, s2, v0
; GFX9-NEXT:    v_sub_u32_e32 v4, s8, v1
...
; GFX6-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX6-NEXT:    s_cselect_b32 s6, s8, 0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s6, v2
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, s4
; GFX6-NEXT:    s_ashr_i32 s4, s4, 16
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GFX6-NEXT:    s_ashr_i32 s8, s10, 16
; GFX6-NEXT:    v_cvt_f32_i32_e32 v2, s8
; GFX6-NEXT:    s_xor_b32 s6, s8, s4
...
; GFX6-NEXT:    v_cvt_i32_f32_e32 v3, v3
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[6:7], |v2|, |v1|
; GFX6-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX6-NEXT:    s_cselect_b32 s6, s9, 0
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, s6, v3
; GFX6-NEXT:    v_mul_lo_u32 v1, v1, s4
...
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[6:7], |v1|, |v2|
; GFX6-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX6-NEXT:    s_cselect_b32 s4, s4, 0
...
; GFX9-NEXT:    v_add_u32_e32 v4, s4, v6
; GFX9-NEXT:    v_mul_lo_u32 v4, v4, s6
; GFX9-NEXT:    v_sub_u32_e32 v5, s2, v1
; GFX9-NEXT:    v_sub_u32_e32 v1, s3, v3
; GFX9-NEXT:    v_and_b32_e32 v1, 0xffff, v1
