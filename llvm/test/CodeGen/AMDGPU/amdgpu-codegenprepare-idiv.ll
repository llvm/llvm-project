...
; GFX6-NEXT:    s_mul_i32 s2, s2, s1
; GFX6-NEXT:    s_sub_i32 s2, s8, s2
; GFX6-NEXT:    s_sub_i32 s3, s2, s1
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GFX6-NEXT:    s_cmp_ge_u32 s2, s1
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
...
; GFX6-NEXT:    s_sub_i32 s3, s2, s1
; GFX6-NEXT:    s_cmp_ge_u32 s2, s1
; GFX6-NEXT:    s_cselect_b32 s1, s3, s2
...
; GFX6-NEXT:    s_lshr_b32 s1, s2, 16
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s1
; GFX6-NEXT:    s_and_b32 s3, s2, 0xffff
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_ashr_i32 s1, s2, 16
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_sext_i32_i16 s0, s2
...
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[2:3], |v2|, |v1|
...
; GFX6-NEXT:    s_ashr_i32 s1, s2, 16
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_sext_i32_i16 s3, s2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s3
; GFX6-NEXT:    s_xor_b32 s3, s3, s1
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
...
; GFX6-NEXT:    s_cselect_b32 s3, s3, 0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s3, v2
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, s1
; GFX6-NEXT:    v_sub_i32_e32 v0, vcc, s2, v0
; GFX6-NEXT:    buffer_store_short v0, off, s[4:7], 0
; GFX6-NEXT:    s_endpgm
...
; GFX9-NEXT:    v_add_u32_e32 v0, s3, v2
; GFX9-NEXT:    v_mul_lo_u32 v0, v0, s1
; GFX9-NEXT:    s_mov_b32 s1, 0
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    v_sub_u32_e32 v0, s2, v0
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x80008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_sext_i32_i8 s0, s2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s0
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_xor_b32 s0, s0, s1
; GFX6-NEXT:    s_ashr_i32 s0, s0, 30
...
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x80008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_sext_i32_i8 s4, s2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GFX6-NEXT:    s_xor_b32 s1, s4, s1
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
...
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s1, s2, 0x80008
; GFX9-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX9-NEXT:    s_sext_i32_i8 s4, s2
...
; GFX9-NEXT:    v_add_u32_e32 v0, s1, v2
...
; GFX9-NEXT:    v_trunc_f32_e32 v1, v1
; GFX9-NEXT:    s_and_b32 s6, s7, 0xffff
; GFX9-NEXT:    v_mad_f32 v3, -v1, v4, v5
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX9-NEXT:    v_sub_u32_e32 v3, s3, v4
; GFX9-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GFX6-NEXT:    s_mov_b32 s1, 0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_sext_i32_i16 s2, s8
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s2
; GFX6-NEXT:    s_sext_i32_i16 s3, s6
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s3
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v4, v4
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v3|, |v1|
; GFX9-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX9-NEXT:    s_cselect_b32 s2, s2, 0
; GFX9-NEXT:    v_add_u32_e32 v1, s2, v4
...
; GFX9-NEXT:    v_cvt_f32_i32_e32 v4, s9
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v5, v3
; GFX9-NEXT:    s_xor_b32 s2, s9, s2
; GFX9-NEXT:    s_ashr_i32 s2, s2, 30
; GFX9-NEXT:    s_or_b32 s2, s2, 1
...
; GFX9-NEXT:    v_sub_u32_e32 v1, s9, v3
; GFX9-NEXT:    v_and_b32_e32 v1, 0xffff, v1
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_u32 s1, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_ubyte0_e32 v0, s1
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v1, v0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_and_b32 s0, s2, 7
...
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_u32 s1, s2, 0x30008
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v0, s1
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v1, v0
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i32 s0, s2, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s0
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_xor_b32 s0, s0, s1
; GFX6-NEXT:    s_ashr_i32 s0, s0, 30
...
; GFX9-NEXT:    s_cselect_b32 s2, s4, 0
; GFX9-NEXT:    v_add_u32_e32 v1, s2, v3
; GFX9-NEXT:    v_and_b32_e32 v1, 7, v1
; GFX9-NEXT:    global_store_byte v0, v1, s[0:1]
; GFX9-NEXT:    s_endpgm
  %r = sdiv i3 %x, %y
  store i3 %r, ptr addrspace(1) %out
...
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX6-NEXT:    s_bfe_i32 s4, s2, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GFX6-NEXT:    s_xor_b32 s1, s4, s1
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX6-NEXT:    s_ashr_i32 s1, s1, 30
...
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_bfe_i32 s1, s2, 0x30008
; GFX9-NEXT:    v_cvt_f32_i32_e32 v0, s1
; GFX9-NEXT:    s_bfe_i32 s4, s2, 0x30000
; GFX9-NEXT:    v_cvt_f32_i32_e32 v1, s4
; GFX9-NEXT:    s_xor_b32 s1, s4, s1
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v2, v0
; GFX9-NEXT:    s_ashr_i32 s1, s1, 30
...
; GFX9-NEXT:    global_store_short v0, v3, s[0:1] offset:4
...
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v2|, v3
; GFX6-NEXT:    v_mul_lo_u32 v1, v1, s10
...
; GFX9-NEXT:    v_trunc_f32_e32 v3, v3
; GFX9-NEXT:    v_mad_f32 v2, -v3, v1, v2
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v2|, |v1|
; GFX9-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX9-NEXT:    s_cselect_b32 s4, s8, 0
; GFX9-NEXT:    s_ashr_i32 s5, s6, 16
; GFX9-NEXT:    v_cvt_i32_f32_e32 v3, v3
...
; GFX9-NEXT:    v_cvt_i32_f32_e32 v5, v5
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[2:3], |v4|, |v1|
; GFX9-NEXT:    s_and_b64 s[2:3], s[2:3], exec
; GFX9-NEXT:    s_cselect_b32 s2, s4, 0
; GFX9-NEXT:    v_add_u32_e32 v1, s2, v5
...
; GFX9-NEXT:    s_ashr_i32 s8, s2, 16
; GFX9-NEXT:    v_cvt_f32_i32_e32 v2, s8
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v3, v1
...
; GFX9-NEXT:    v_sub_u32_e32 v0, s9, v0
; GFX9-NEXT:    v_mov_b32_e32 v3, 0
...
; GFX6-NEXT:    v_mul_hi_u32 v0, s2, v0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    v_sub_i32_e32 v1, vcc, s2, v0
...
; GFX6-NEXT:    v_mov_b32_e32 v0, 0xb2a50881
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s1, 0x12d8fb
; GFX6-NEXT:    s_mov_b32 s5, 0
; GFX6-NEXT:    s_mov_b32 s7, 0xf000
; GFX6-NEXT:    v_mul_hi_u32 v0, s2, v0
; GFX6-NEXT:    s_mov_b32 s6, -1
...
; GFX6-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX6-NEXT:    v_readfirstlane_b32 s1, v0
; GFX6-NEXT:    s_mul_i32 s1, s1, s6
; GFX6-NEXT:    s_sub_i32 s1, s2, s1
; GFX6-NEXT:    s_sub_i32 s2, s1, s6
; GFX6-NEXT:    s_cmp_ge_u32 s1, s6
; GFX6-NEXT:    s_cselect_b32 s1, s2, s1
; GFX6-NEXT:    s_sub_i32 s2, s1, s6
; GFX6-NEXT:    s_cmp_ge_u32 s1, s6
; GFX6-NEXT:    s_cselect_b32 s1, s2, s1
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mul_hi_i32 v0, s2, v0
; GFX6-NEXT:    s_mov_b32 s4, s0
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshl_b32 s1, 0x1000, s3
; GFX6-NEXT:    s_abs_i32 s3, s1
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s3
...
; GFX6-NEXT:    s_mul_i32 s0, s0, s3
; GFX6-NEXT:    s_sub_i32 s0, s8, s0
; GFX6-NEXT:    s_sub_i32 s8, s0, s3
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GFX6-NEXT:    s_cmp_ge_u32 s0, s3
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX6-NEXT:    s_cselect_b32 s0, s8, s0
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GFX6-NEXT:    s_cmp_ge_u32 s0, s3
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX6-NEXT:    s_xor_b32 s0, s2, s1
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GFX6-NEXT:    s_ashr_i32 s0, s0, 31
; GFX6-NEXT:    v_xor_b32_e32 v0, s0, v0
; GFX6-NEXT:    v_subrev_i32_e32 v0, vcc, s0, v0
...
; GFX6-NEXT:    v_cvt_f32_u32_e32 v2, s1
; GFX6-NEXT:    s_sub_i32 s4, 0, s1
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
...
; GFX6-NEXT:    s_lshr_b32 s1, s0, 31
; GFX6-NEXT:    s_ashr_i32 s0, s0, 20
; GFX6-NEXT:    s_add_i32 s0, s0, s1
; GFX6-NEXT:    s_mul_i32 s0, s0, 0x12d8fb
; GFX6-NEXT:    s_sub_i32 s0, s2, s0
; GFX6-NEXT:    v_mov_b32_e32 v0, s0
; GFX6-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GFX6-NEXT:    s_endpgm
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_lshl_b32 s1, 0x1000, s3
; GFX9-NEXT:    s_abs_i32 s3, s1
; GFX9-NEXT:    v_cvt_f32_u32_e32 v0, s3
; GFX9-NEXT:    s_sub_i32 s5, 0, s3
...
; GFX9-NEXT:    s_mul_i32 s4, s4, s5
; GFX9-NEXT:    s_sub_i32 s3, s3, s4
; GFX9-NEXT:    s_sub_i32 s4, s3, s5
; GFX9-NEXT:    s_cmp_ge_u32 s3, s5
; GFX9-NEXT:    s_cselect_b32 s3, s4, s3
; GFX9-NEXT:    s_sub_i32 s4, s3, s5
; GFX9-NEXT:    s_cmp_ge_u32 s3, s5
; GFX9-NEXT:    s_cselect_b32 s3, s4, s3
