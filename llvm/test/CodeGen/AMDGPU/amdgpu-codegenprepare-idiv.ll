...
; CHECK-NEXT:    [[TMP17:%.*]] = select i1 [[TMP16]], i32 [[TMP5]], i32 0
; CHECK-NEXT:    [[TMP18:%.*]] = add i32 [[TMP13]], [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl i32 [[TMP18]], 9
; CHECK-NEXT:    [[TMP20:%.*]] = ashr i32 [[TMP19]], 9
; CHECK-NEXT:    [[TMP21:%.*]] = trunc i32 [[TMP20]] to i23
; CHECK-NEXT:    store i23 [[TMP21]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
  %r = sdiv i23 %x, %y
...
; CHECK-NEXT:    [[TMP14:%.*]] = select i1 [[TMP13]], i32 1, i32 0
; CHECK-NEXT:    [[TMP15:%.*]] = add i32 [[TMP10]], [[TMP14]]
; CHECK-NEXT:    [[TMP16:%.*]] = and i32 [[TMP15]], 4194303
; CHECK-NEXT:    [[TMP17:%.*]] = trunc i32 [[TMP16]] to i22
; CHECK-NEXT:    store i22 [[TMP17]], ptr addrspace(1) [[OUT]], align 4
; CHECK-NEXT:    ret void
;
  %r = udiv i22 %x, %y
