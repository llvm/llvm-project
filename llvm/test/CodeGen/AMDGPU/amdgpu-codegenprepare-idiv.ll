...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_ashr_i32 s3, s2, 16
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s3
; GFX6-NEXT:    s_sext_i32_i16 s4, s2
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i32 s0, s2, 0x80008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_sext_i32_i8 s1, s2
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s1
; GFX6-NEXT:    v_rcp_f32_e32 v2, v0
; GFX6-NEXT:    s_xor_b32 s0, s1, s0
; GFX6-NEXT:    s_ashr_i32 s0, s0, 30
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s3, s2, 0x80008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s3
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i32> [[X:%.*]], <4 x i32> [[Y:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <4 x i16> [[X:%.*]], <4 x i16> [[Y:%.*]]) #[[ATTR0]] {
...
; GFX9-NEXT:    v_sub_u32_e32 v5, s8, v1
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_u32 s0, s2, 0x30008
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_u32 s3, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_ubyte0_e32 v0, s3
; GFX6-NEXT:    v_rcp_f32_e32 v1, v0
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i32 s0, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x30000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s1
; GFX6-NEXT:    v_rcp_f32_e32 v2, v0
; GFX6-NEXT:    s_xor_b32 s0, s1, s0
; GFX6-NEXT:    s_ashr_i32 s0, s0, 30
...
; GFX6-NEXT:    s_mov_b32 s6, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s3, s2, 0x30008
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s3
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i16> [[X:%.*]], <3 x i16> [[Y:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <3 x i15> [[X:%.*]], <3 x i15> [[Y:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i32 [[X:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i32> [[X:%.*]], <2 x i32> [[Y:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i64 [[X:%.*]], i64 [[Y:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]]) #[[ATTR0]] {
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], <2 x i64> [[X:%.*]], <2 x i64> [[Y:%.*]]) #[[ATTR0]] {
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i32 s0, s3, 0x170000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v0, s0
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_bfe_i32 s1, s2, 0x170000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s1
; GFX6-NEXT:    v_rcp_f32_e32 v2, v0
; GFX6-NEXT:    s_xor_b32 s0, s1, s0
; GFX6-NEXT:    s_ashr_i32 s0, s0, 30
...
; GFX6-NEXT:    buffer_store_byte v0, off, s[4:7], 0 offset:2
; GFX6-NEXT:    s_endpgm
;
; GFX9-LABEL: sdiv23:
; GFX9:       ; %bb.0:
...
; GFX6-NEXT:    v_mul_lo_u32 v1, s4, v0
; GFX6-NEXT:    s_mov_b32 s4, s0
; GFX6-NEXT:    s_bfe_i32 s0, s2, 0x180000
; GFX6-NEXT:    s_abs_i32 s2, s0
; GFX6-NEXT:    v_mul_hi_u32 v1, v0, v1
...
; CHECK-SAME: ptr addrspace(1) [[OUT:%.*]], i24 [[X:%.*]], i24 [[Y:%.*]]) #[[ATTR0]] {
