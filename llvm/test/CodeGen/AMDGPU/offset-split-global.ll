...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off offset:0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    s_setpc_b64 s[30:31]
...
; GFX11-NEXT:    global_load_u8 v0, v0, s[0:1] offset:1 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_u8 v0, v0, s[0:1] offset:2047 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 2047
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_u8 v0, v0, s[0:1] offset:-2048 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 -2048
...
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_u8 v0, v0, s[0:1] offset:0 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 -4096
...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s0, -1, s1, s0
...
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s0, 2, s1, s0
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off offset:2047 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 8589936639
...
; GFX11-NEXT:    v_add_co_u32 v0, s0, 0, s0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s0, 2, s1, s0
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off offset:-2048 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 8589936640
...
; GFX11-NEXT:    v_add_co_u32 v0, s0, 0, s0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, s0, 2, s1, s0
; GFX11-NEXT:    global_load_u8 v0, v[0:1], off offset:-1 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 8589938687
...
; GFX11-NEXT:    global_load_u8 v0, v0, s[0:1] glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b8 v[0:1], v0, off
; GFX11-NEXT:    s_endpgm
  %gep = getelementptr i8, i8 addrspace(1)* %p, i64 -9223372036854773761
