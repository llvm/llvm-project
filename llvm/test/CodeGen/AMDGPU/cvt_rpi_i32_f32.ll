...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck -check-prefix=SI-SDAG %s
; RUN: llc -mtriple=amdgpu6.00 -global-isel < %s | FileCheck -check-prefix=SI-GISEL %s
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck -check-prefix=GFX11-SDAG %s
; RUN: llc -mtriple=amdgpu11.00 -global-isel < %s | FileCheck -check-prefix=GFX11-GISEL %s
...
; SI-SDAG-NEXT:    v_cvt_rpi_i32_f32_e32 v0, s2
...
; SI-GISEL-NEXT:    v_cvt_rpi_i32_f32_e32 v0, s2
...
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_cvt_rpi_i32_f32_e64 v0, |s2|
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    v_cvt_rpi_i32_f32_e64 v0, |s2|
; SI-GISEL-NEXT:    s_mov_b32 s2, -1
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
;
...
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    v_mul_f32_e64 v0, -1.0, s2
...
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    v_add_f32_e64 v0, s2, 0.5
