...
; RUN: llc -mtriple=amdgcn -mcpu=gfx600 < %s | FileCheck -check-prefix=SI-SDAG %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx600 -global-isel < %s | FileCheck -check-prefix=SI-GISEL %s
