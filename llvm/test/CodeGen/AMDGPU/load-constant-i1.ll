...
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    global_load_d16_u8 v2, v8, s[2:3]
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v9, 0xffff, v2
; GFX12-TRUE16-NEXT:    v_bfe_u32 v7, v2, 3, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v5, v2, 1, 1
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v4, 1, v2
; GFX12-TRUE16-NEXT:    v_bfe_u32 v6, v2, 2, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v1, v2, 5, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v0, v2, 4, 1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v3, 7, v9
; GFX12-TRUE16-NEXT:    v_bfe_u32 v2, v9, 6, 1
...
; GFX1250-TRUE16-NEXT:    global_load_u8 v2, v8, s[2:3] nv
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    v_and_b32_e32 v6, 0xffff, v2
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v5, v2, 5, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v4, v2, 4, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX1250-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 7, v6
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v6, v6, 6, 1
; GFX1250-TRUE16-NEXT:    v_and_b32_e32 v0, 1, v2
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v2, v2, 2, 1
; GFX1250-TRUE16-NEXT:    s_clause 0x1
; GFX1250-TRUE16-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:16
; GFX1250-TRUE16-NEXT:    global_store_b128 v8, v[0:3], s[0:1]
...
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    global_load_d16_b16 v2, v16, s[2:3]
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_readfirstlane_b32 s2, v2
; GFX12-TRUE16-NEXT:    v_bfe_u32 v13, v2, 13, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v12, v2, 12, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v9, v2, 9, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v10, v2, 10, 1
; GFX12-TRUE16-NEXT:    s_and_b32 s2, 0xffff, s2
; GFX12-TRUE16-NEXT:    v_bfe_u32 v7, v2, 7, 1
; GFX12-TRUE16-NEXT:    s_lshr_b32 s5, s2, 15
; GFX12-TRUE16-NEXT:    s_bfe_u32 s9, s2, 0x1000e
; GFX12-TRUE16-NEXT:    s_bfe_u32 s3, s2, 0x10005
; GFX12-TRUE16-NEXT:    s_bfe_u32 s4, s2, 0x1000b
; GFX12-TRUE16-NEXT:    s_bfe_u32 s6, s2, 0x10002
; GFX12-TRUE16-NEXT:    s_bfe_u32 s7, s2, 0x10006
; GFX12-TRUE16-NEXT:    s_bfe_u32 s8, s2, 0x10004
; GFX12-TRUE16-NEXT:    s_bfe_u32 s2, s2, 0x10008
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v15, s5 :: v_dual_and_b32 v0, 1, v2
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v14, s9 :: v_dual_mov_b32 v11, s4
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v5, s3
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v4, s8
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v6, s7
; GFX12-TRUE16-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v2, s6
; GFX12-TRUE16-NEXT:    s_clause 0x3
; GFX12-TRUE16-NEXT:    global_store_b128 v16, v[12:15], s[0:1] offset:48
; GFX12-TRUE16-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:32
; GFX12-TRUE16-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:16
; GFX12-TRUE16-NEXT:    global_store_b128 v16, v[0:3], s[0:1]
; GFX12-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX1250-TRUE16-LABEL: constant_zextload_v16i1_to_v16i32:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-TRUE16-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-TRUE16-NEXT:    v_nop
; GFX1250-TRUE16-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v16, 0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    global_load_u16 v2, v16, s[2:3] nv
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    v_readfirstlane_b32 s2, v2
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v13, v2, 13, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v12, v2, 12, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v9, v2, 9, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v10, v2, 10, 1
; GFX1250-TRUE16-NEXT:    s_and_b32 s2, 0xffff, s2
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v7, v2, 7, 1
; GFX1250-TRUE16-NEXT:    s_lshr_b32 s5, s2, 15
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s9, s2, 0x1000e
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s3, s2, 0x10005
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s4, s2, 0x1000b
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s6, s2, 0x10002
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s7, s2, 0x10006
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s8, s2, 0x10004
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s2, s2, 0x10008
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v14, s9 :: v_dual_bitop2_b32 v0, 1, v2 bitop3:0x40
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v15, s5 :: v_dual_mov_b32 v8, s2
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v11, s4 :: v_dual_mov_b32 v4, s8
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v6, s7
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v2, s6
; GFX1250-TRUE16-NEXT:    s_clause 0x3
; GFX1250-TRUE16-NEXT:    global_store_b128 v16, v[12:15], s[0:1] offset:48
; GFX1250-TRUE16-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:32
; GFX1250-TRUE16-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:16
; GFX1250-TRUE16-NEXT:    global_store_b128 v16, v[0:3], s[0:1]
; GFX1250-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    v_dual_lshrrev_b32 v2, 1, v2 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_and_b32_e32 v2, 0xffff, v2
...
; GFX1250-NEXT:    v_mov_b32_e32 v3, v5
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v1, 0xffff, v0
; GFX1250-NEXT:    v_bfe_u32 v6, v0, 1, 1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_dual_lshrrev_b32 v2, 2, v1 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
; GFX1250-NEXT:    v_mov_b32_e32 v1, v5
...
; GFX12-TRUE16-NEXT:    global_load_d16_u8 v0, v1, s[2:3]
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_and_b32 v2, 0xffff, v0
...
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 3, v2
...
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_and_b32 v6, 0xffff, v7
; GFX12-TRUE16-NEXT:    s_clause 0x1
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
...
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v7, v1
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    global_load_u8 v0, v1, s[2:3] nv
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff, v0
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v6, v0, 2, 1
; GFX1250-TRUE16-NEXT:    v_bfe_u32 v8, v0, 1, 1
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v2, 3, v2 :: v_dual_bitop2_b32 v4, 1, v0 bitop3:0x40
; GFX1250-TRUE16-NEXT:    v_and_b32_e32 v0, 0xffff, v6
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-TRUE16-NEXT:    v_and_b32_e32 v6, 0xffff, v8
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX1250-TRUE16-LABEL: constant_sextload_v8i1_to_v8i64:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-TRUE16-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-TRUE16-NEXT:    v_nop
...
; GFX1250-TRUE16-NEXT:    global_store_b128 v17, v[4:7], s[0:1] offset:16
; GFX1250-TRUE16-NEXT:    global_store_b128 v17, v[0:3], s[0:1]
; GFX1250-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-FAKE16-NEXT:    v_readfirstlane_b32 s3, v0
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v10, s3
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s2, s3, 6
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s4, s3, 7
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s6, s3, 4
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s8, s3, 5
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s10, s3, 2
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s12, s3, 3
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s14, s3, 1
...
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v13, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v15, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v17, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v19, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v21, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v23, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v7, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v9, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v11, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v25, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v27, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v29, v1
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v31, v1
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    global_load_d16_b16 v0, v1, s[2:3]
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v3, v1
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_and_b32 v16, 1, v0
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v24, 0xffff, v0
; GFX12-TRUE16-NEXT:    v_bfe_u32 v14, v0, 3, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v12, v0, 2, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v18, v0, 1, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v2, v0, 9, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v6, v0, 13, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v10, v0, 7, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v28, v0, 4, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v20, v0, 10, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v8, v0, 6, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v4, v0, 12, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v0, v24, 8, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v22, v24, 11, 1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v26, 15, v24
; GFX12-TRUE16-NEXT:    v_bfe_u32 v30, v24, 5, 1
; GFX12-TRUE16-NEXT:    v_bfe_u32 v24, v24, 14, 1
; GFX12-TRUE16-NEXT:    s_clause 0x7
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[12:15], s[0:1] offset:16
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[16:19], s[0:1]
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:64
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[20:23], s[0:1] offset:80
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[4:7], s[0:1] offset:96
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[24:27], s[0:1] offset:112
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[8:11], s[0:1] offset:48
; GFX12-TRUE16-NEXT:    global_store_b128 v1, v[28:31], s[0:1] offset:32
; GFX12-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v31, v1 :: v_dual_bitop2_b32 v28, 1, v12 bitop3:0x40
...
; GFX1250-NEXT:    v_lshrrev_b32_e32 v10, 15, v22
...
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    global_load_d16_b16 v1, v32, s[2:3]
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v3, 14, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 15, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 12, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v9, 13, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v11, 10, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v13, 11, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v15, 8, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v16, 9, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v12, 6, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v14, 7, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 4, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 1, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, 3, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v10, 2, v1
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v17, 5, v1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v30, v5, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v28, v3, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v26, v9, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v24, v7, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v22, v13, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v20, v11, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v18, v16, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v16, v15, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v14, v14, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v12, v12, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v0, v1, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v2, v2, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v6, v4, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v4, v10, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v10, v17, 0, 1
; GFX12-TRUE16-NEXT:    v_bfe_i32 v8, v8, 0, 1
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v31, 31, v30
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v29, 31, v28
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v27, 31, v26
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v25, 31, v24
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v23, 31, v22
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v21, 31, v20
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v19, 31, v18
...
; GFX12-TRUE16-NEXT:    v_ashrrev_i32_e32 v9, 31, v8
; GFX12-TRUE16-NEXT:    s_clause 0x7
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[28:31], s[0:1] offset:112
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[24:27], s[0:1] offset:96
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[20:23], s[0:1] offset:80
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:64
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[12:15], s[0:1] offset:48
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[8:11], s[0:1] offset:32
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[4:7], s[0:1] offset:16
; GFX12-TRUE16-NEXT:    global_store_b128 v32, v[0:3], s[0:1]
; GFX12-TRUE16-NEXT:    s_endpgm
;
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX1250-TRUE16-LABEL: constant_sextload_v16i1_to_v16i64:
; GFX1250-TRUE16:       ; %bb.0:
; GFX1250-TRUE16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-TRUE16-NEXT:    s_mov_b64 s[64:65], 0
; GFX1250-TRUE16-NEXT:    v_nop
; GFX1250-TRUE16-NEXT:    global_prefetch_b8 v0, s[64:65] scope:SCOPE_SE
; GFX1250-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v33, 0
; GFX1250-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX1250-TRUE16-NEXT:    global_load_u16 v2, v33, s[2:3] nv
; GFX1250-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v28, 14, v2 :: v_dual_lshrrev_b32 v30, 15, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v8, 4, v2 :: v_dual_lshrrev_b32 v4, 1, v2
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v0, v2, 0, 1
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v6, 3, v2 :: v_dual_lshrrev_b32 v10, 2, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v32, 5, v2 :: v_dual_lshrrev_b32 v24, 12, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v26, 13, v2 :: v_dual_lshrrev_b32 v12, 6, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v14, 7, v2 :: v_dual_lshrrev_b32 v20, 10, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v22, 11, v2 :: v_dual_lshrrev_b32 v16, 8, v2
; GFX1250-TRUE16-NEXT:    v_dual_lshrrev_b32 v18, 9, v2 :: v_dual_ashrrev_i32 v1, 31, v0
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v2, v4, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v4, v10, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v10, v32, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v30, v30, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v28, v28, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v14, v14, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v26, v26, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v24, v24, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v18, v18, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v22, v22, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v20, v20, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v16, v16, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v12, v12, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v6, v6, 0, 1
; GFX1250-TRUE16-NEXT:    v_bfe_i32 v8, v8, 0, 1
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v11, 31, v10 :: v_dual_ashrrev_i32 v29, 31, v28
; GFX1250-TRUE16-NEXT:    v_ashrrev_i32_e32 v31, 31, v30
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v15, 31, v14 :: v_dual_ashrrev_i32 v25, 31, v24
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v27, 31, v26 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v19, 31, v18 :: v_dual_ashrrev_i32 v21, 31, v20
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v23, 31, v22 :: v_dual_ashrrev_i32 v17, 31, v16
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v3, 31, v2 :: v_dual_ashrrev_i32 v5, 31, v4
; GFX1250-TRUE16-NEXT:    v_dual_ashrrev_i32 v7, 31, v6 :: v_dual_ashrrev_i32 v9, 31, v8
; GFX1250-TRUE16-NEXT:    s_clause 0x7
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[28:31], s[0:1] offset:112
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[24:27], s[0:1] offset:96
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[20:23], s[0:1] offset:80
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[16:19], s[0:1] offset:64
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[12:15], s[0:1] offset:48
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[8:11], s[0:1] offset:32
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[4:7], s[0:1] offset:16
; GFX1250-TRUE16-NEXT:    global_store_b128 v33, v[0:3], s[0:1]
; GFX1250-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-FAKE16-NEXT:    v_readfirstlane_b32 s3, v0
; GFX1250-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v28, s3
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s2, s3, 14
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s4, s3, 15
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s8, s3, 13
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s10, s3, 10
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s12, s3, 11
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s6, s3, 12
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s14, s3, 8
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s16, s3, 9
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s18, s3, 6
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s20, s3, 7
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s22, s3, 4
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s24, s3, 5
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s26, s3, 2
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s28, s3, 3
; GFX1250-FAKE16-NEXT:    s_lshr_b32 s30, s3, 1
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1250-FAKE16-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v7, s9
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v9, s11
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_mov_b32 v11, s13
; GFX1250-FAKE16-NEXT:    v_mov_b32_e32 v12, s14
...
; GFX8-NEXT:    s_mov_b32 s49, s69
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x0
; GFX8-NEXT:    s_mov_b32 s75, s69
; GFX8-NEXT:    s_mov_b32 s43, s69
; GFX8-NEXT:    s_mov_b32 s63, s69
; GFX8-NEXT:    s_mov_b32 s29, s69
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_lshr_b32 s38, s3, 19
; GFX8-NEXT:    s_lshr_b32 s4, s3, 9
; GFX8-NEXT:    s_lshr_b32 s40, s3, 15
; GFX8-NEXT:    s_lshr_b32 s44, s3, 12
; GFX8-NEXT:    s_lshr_b32 s54, s3, 11
...
; GFX8-NEXT:    s_lshr_b32 s52, s3, 25
; GFX8-NEXT:    s_lshr_b32 s72, s3, 22
; GFX8-NEXT:    s_lshr_b32 s48, s3, 23
; GFX8-NEXT:    s_lshr_b32 s74, s3, 20
; GFX8-NEXT:    s_lshr_b32 s42, s3, 21
; GFX8-NEXT:    s_lshr_b32 s62, s3, 18
; GFX8-NEXT:    s_lshr_b32 s28, s3, 16
; GFX8-NEXT:    s_lshr_b32 s34, s3, 17
; GFX8-NEXT:    s_mov_b32 s35, s69
; GFX8-NEXT:    s_lshr_b32 s36, s3, 14
; GFX8-NEXT:    s_lshr_b32 s18, s3, 8
; GFX8-NEXT:    v_writelane_b32 v62, s5, 1
; GFX8-NEXT:    v_mov_b32_e32 v26, s38
; GFX8-NEXT:    v_mov_b32_e32 v27, s39
; GFX8-NEXT:    s_bfe_i64 s[38:39], s[54:55], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[4:5], s[44:45], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX8-NEXT:    s_lshr_b32 s46, s3, 13
...
; GFX8-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX8-NEXT:    v_mov_b32_e32 v42, s40
; GFX8-NEXT:    v_mov_b32_e32 v28, s4
; GFX8-NEXT:    s_lshr_b32 s4, s2, 7
; GFX8-NEXT:    s_lshr_b32 s40, s2, 4
; GFX8-NEXT:    v_mov_b32_e32 v34, s38
; GFX8-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
; GFX8-NEXT:    s_lshr_b32 s38, s2, 1
; GFX8-NEXT:    s_lshr_b32 s50, s3, 10
...
; GFX8-NEXT:    v_mov_b32_e32 v12, s64
; GFX8-NEXT:    v_mov_b32_e32 v4, s66
; GFX8-NEXT:    v_mov_b32_e32 v0, s70
; GFX8-NEXT:    v_mov_b32_e32 v8, s68
; GFX8-NEXT:    v_mov_b32_e32 v16, s72
; GFX8-NEXT:    v_mov_b32_e32 v20, s74
; GFX8-NEXT:    s_lshr_b32 s82, s2, 29
...
; GFX8-NEXT:    v_mov_b32_e32 v17, s73
; GFX8-NEXT:    v_mov_b32_e32 v19, s49
; GFX8-NEXT:    v_mov_b32_e32 v21, s75
; GFX8-NEXT:    v_mov_b32_e32 v23, s43
; GFX8-NEXT:    v_mov_b32_e32 v25, s63
; GFX8-NEXT:    v_mov_b32_e32 v37, s29
; GFX8-NEXT:    v_mov_b32_e32 v39, s35
; GFX8-NEXT:    v_mov_b32_e32 v41, s37
; GFX8-NEXT:    v_mov_b32_e32 v30, s54
; GFX8-NEXT:    v_mov_b32_e32 v31, s55
; GFX8-NEXT:    v_mov_b32_e32 v32, s50
; GFX8-NEXT:    v_mov_b32_e32 v33, s51
; GFX8-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
...
; GFX8-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[50:51], vcc, 0x10000
; GFX8-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[54:55], s[86:87], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX8-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
...
; GFX8-NEXT:    v_mov_b32_e32 v3, s3
; GFX8-NEXT:    v_mov_b32_e32 v4, s0
; GFX8-NEXT:    flat_store_dwordx4 v[14:15], v[36:39]
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX12-NEXT:    s_mov_b32 s61, 0
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    s_mov_b32 s55, s61
; GFX12-NEXT:    s_mov_b32 s43, s61
; GFX12-NEXT:    s_mov_b32 s51, s61
; GFX12-NEXT:    s_mov_b32 s29, s61
; GFX12-NEXT:    s_mov_b32 s39, s61
; GFX12-NEXT:    s_mov_b32 s17, s61
; GFX12-NEXT:    s_mov_b32 s25, s61
; GFX12-NEXT:    s_mov_b32 s49, s61
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_b64 s[4:5], s[2:3], 0x0
; GFX12-NEXT:    s_mov_b32 s3, s61
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_lshr_b32 s98, s5, 30
; GFX12-NEXT:    s_lshr_b32 s90, s5, 31
; GFX12-NEXT:    s_lshr_b32 s96, s5, 28
; GFX12-NEXT:    s_lshr_b32 s76, s5, 29
; GFX12-NEXT:    s_lshr_b32 s72, s5, 27
; GFX12-NEXT:    s_lshr_b32 s60, s5, 24
; GFX12-NEXT:    s_lshr_b32 s86, s5, 26
; GFX12-NEXT:    s_bfe_i64 s[98:99], s[98:99], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX12-NEXT:    s_lshr_b32 s64, s5, 25
...
; GFX12-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s98
; GFX12-NEXT:    s_lshr_b32 s54, s5, 22
; GFX12-NEXT:    s_lshr_b32 s42, s5, 23
; GFX12-NEXT:    v_dual_mov_b32 v2, s99 :: v_dual_mov_b32 v3, s90
; GFX12-NEXT:    v_dual_mov_b32 v4, s91 :: v_dual_mov_b32 v5, s96
; GFX12-NEXT:    s_bfe_i64 s[86:87], s[86:87], 0x10000
; GFX12-NEXT:    s_lshr_b32 s50, s5, 20
; GFX12-NEXT:    s_lshr_b32 s28, s5, 21
; GFX12-NEXT:    s_lshr_b32 s2, s5, 17
; GFX12-NEXT:    s_lshr_b32 s6, s5, 14
; GFX12-NEXT:    s_lshr_b32 s8, s5, 15
; GFX12-NEXT:    v_dual_mov_b32 v6, s97 :: v_dual_mov_b32 v7, s76
; GFX12-NEXT:    v_dual_mov_b32 v8, s77 :: v_dual_mov_b32 v9, s86
; GFX12-NEXT:    v_dual_mov_b32 v12, s73 :: v_dual_mov_b32 v13, s60
; GFX12-NEXT:    v_mov_b32_e32 v14, s61
; GFX12-NEXT:    s_bfe_i64 s[60:61], s[64:65], 0x10000
; GFX12-NEXT:    s_lshr_b32 s38, s5, 18
; GFX12-NEXT:    s_lshr_b32 s16, s5, 19
; GFX12-NEXT:    s_lshr_b32 s10, s5, 12
; GFX12-NEXT:    s_lshr_b32 s12, s5, 13
; GFX12-NEXT:    v_dual_mov_b32 v10, s87 :: v_dual_mov_b32 v11, s72
; GFX12-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX12-NEXT:    s_lshr_b32 s24, s5, 16
; GFX12-NEXT:    s_lshr_b32 s14, s5, 10
; GFX12-NEXT:    s_lshr_b32 s18, s5, 11
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v15, s60 :: v_dual_mov_b32 v16, s61
; GFX12-NEXT:    v_mov_b32_e32 v17, s54
; GFX12-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
...
; GFX12-NEXT:    s_lshr_b32 s22, s5, 9
; GFX12-NEXT:    v_dual_mov_b32 v18, s55 :: v_dual_mov_b32 v19, s42
; GFX12-NEXT:    v_dual_mov_b32 v20, s43 :: v_dual_mov_b32 v21, s50
; GFX12-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX12-NEXT:    s_lshr_b32 s26, s5, 6
; GFX12-NEXT:    s_lshr_b32 s30, s5, 7
; GFX12-NEXT:    v_dual_mov_b32 v22, s51 :: v_dual_mov_b32 v23, s28
; GFX12-NEXT:    v_dual_mov_b32 v24, s29 :: v_dual_mov_b32 v25, s38
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX12-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    v_dual_mov_b32 v32, s3 :: v_dual_mov_b32 v1, s6
; GFX12-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v3, s8
; GFX12-NEXT:    v_dual_mov_b32 v4, s9 :: v_dual_mov_b32 v5, s10
; GFX12-NEXT:    s_lshr_b32 s34, s5, 4
; GFX12-NEXT:    s_lshr_b32 s36, s5, 5
; GFX12-NEXT:    s_lshr_b32 s40, s5, 2
; GFX12-NEXT:    s_lshr_b32 s44, s5, 3
; GFX12-NEXT:    v_dual_mov_b32 v26, s39 :: v_dual_mov_b32 v27, s16
...
; GFX12-NEXT:    s_lshr_b32 s46, s5, 1
; GFX12-NEXT:    s_mov_b32 s48, s5
; GFX12-NEXT:    v_dual_mov_b32 v30, s25 :: v_dual_mov_b32 v31, s2
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    s_lshr_b32 s52, s4, 30
; GFX12-NEXT:    s_lshr_b32 s56, s4, 31
; GFX12-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v14, s21 :: v_dual_mov_b32 v15, s22
; GFX12-NEXT:    v_dual_mov_b32 v16, s23 :: v_dual_mov_b32 v17, s26
; GFX12-NEXT:    s_lshr_b32 s58, s4, 28
; GFX12-NEXT:    s_lshr_b32 s62, s4, 29
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v18, s27 :: v_dual_mov_b32 v19, s30
; GFX12-NEXT:    v_dual_mov_b32 v20, s31 :: v_dual_mov_b32 v21, s34
; GFX12-NEXT:    s_lshr_b32 s66, s4, 26
; GFX12-NEXT:    s_lshr_b32 s68, s4, 27
; GFX12-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s35 :: v_dual_mov_b32 v23, s36
; GFX12-NEXT:    v_mov_b32_e32 v24, s37
; GFX12-NEXT:    s_clause 0x5
...
; GFX12-NEXT:    v_dual_mov_b32 v3, s44 :: v_dual_mov_b32 v4, s45
; GFX12-NEXT:    v_mov_b32_e32 v5, s48
; GFX12-NEXT:    s_lshr_b32 s70, s4, 24
; GFX12-NEXT:    s_lshr_b32 s74, s4, 25
; GFX12-NEXT:    s_lshr_b32 s78, s4, 22
; GFX12-NEXT:    s_lshr_b32 s80, s4, 23
; GFX12-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s49 :: v_dual_mov_b32 v7, s46
; GFX12-NEXT:    v_dual_mov_b32 v8, s47 :: v_dual_mov_b32 v9, s52
; GFX12-NEXT:    s_lshr_b32 s82, s4, 20
; GFX12-NEXT:    s_lshr_b32 s84, s4, 21
; GFX12-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s53 :: v_dual_mov_b32 v11, s56
; GFX12-NEXT:    v_dual_mov_b32 v12, s57 :: v_dual_mov_b32 v13, s58
; GFX12-NEXT:    s_lshr_b32 s88, s4, 18
; GFX12-NEXT:    s_lshr_b32 s92, s4, 19
...
; GFX12-NEXT:    v_dual_mov_b32 v14, s59 :: v_dual_mov_b32 v15, s62
; GFX12-NEXT:    v_dual_mov_b32 v16, s63 :: v_dual_mov_b32 v17, s66
; GFX12-NEXT:    s_lshr_b32 s94, s4, 16
; GFX12-NEXT:    s_lshr_b32 s100, s4, 17
; GFX12-NEXT:    s_bfe_i64 s[84:85], s[84:85], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[82:83], s[82:83], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v18, s67 :: v_dual_mov_b32 v19, s68
; GFX12-NEXT:    v_dual_mov_b32 v20, s69 :: v_dual_mov_b32 v21, s70
; GFX12-NEXT:    s_lshr_b32 s98, s4, 14
; GFX12-NEXT:    s_lshr_b32 s102, s4, 15
; GFX12-NEXT:    s_lshr_b32 s96, s4, 13
; GFX12-NEXT:    s_lshr_b32 s86, s4, 8
; GFX12-NEXT:    s_lshr_b32 s64, s4, 7
; GFX12-NEXT:    s_lshr_b32 s50, s4, 5
; GFX12-NEXT:    s_lshr_b32 s38, s4, 3
; GFX12-NEXT:    s_lshr_b32 s24, s4, 1
; GFX12-NEXT:    s_bfe_i64 s[92:93], s[92:93], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[88:89], s[88:89], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s71 :: v_dual_mov_b32 v23, s74
...
; GFX12-NEXT:    v_dual_mov_b32 v3, s80 :: v_dual_mov_b32 v4, s81
; GFX12-NEXT:    v_mov_b32_e32 v5, s82
; GFX12-NEXT:    s_lshr_b32 s90, s4, 12
; GFX12-NEXT:    s_lshr_b32 s76, s4, 10
; GFX12-NEXT:    s_lshr_b32 s72, s4, 11
; GFX12-NEXT:    s_bfe_i64 s[100:101], s[100:101], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[94:95], s[94:95], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v6, s83 :: v_dual_mov_b32 v7, s84
; GFX12-NEXT:    v_dual_mov_b32 v8, s85 :: v_dual_mov_b32 v9, s88
; GFX12-NEXT:    s_lshr_b32 s60, s4, 9
; GFX12-NEXT:    s_lshr_b32 s54, s4, 6
; GFX12-NEXT:    s_lshr_b32 s42, s4, 4
; GFX12-NEXT:    s_lshr_b32 s28, s4, 2
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[4:5], 0x10000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[24:25], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[38:39], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[38:39], s[50:51], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[50:51], s[64:65], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[64:65], s[86:87], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[86:87], s[96:97], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[96:97], s[102:103], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[98:99], s[98:99], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s89 :: v_dual_mov_b32 v11, s92
; GFX12-NEXT:    v_dual_mov_b32 v12, s93 :: v_dual_mov_b32 v13, s94
; GFX12-NEXT:    s_bfe_i64 s[72:73], s[72:73], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v14, s95 :: v_dual_mov_b32 v15, s100
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v16, s101 :: v_dual_mov_b32 v17, s98
; GFX12-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v18, s99 :: v_dual_mov_b32 v19, s96
; GFX12-NEXT:    v_dual_mov_b32 v20, s97 :: v_dual_mov_b32 v21, s90
; GFX12-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v22, s91 :: v_dual_mov_b32 v23, s86
...
; GFX12-NEXT:    v_dual_mov_b32 v1, s76 :: v_dual_mov_b32 v2, s77
; GFX12-NEXT:    v_dual_mov_b32 v3, s72 :: v_dual_mov_b32 v4, s73
; GFX12-NEXT:    v_mov_b32_e32 v5, s64
; GFX12-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v6, s65 :: v_dual_mov_b32 v7, s60
; GFX12-NEXT:    v_dual_mov_b32 v8, s61 :: v_dual_mov_b32 v9, s54
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v10, s55 :: v_dual_mov_b32 v11, s50
; GFX12-NEXT:    v_dual_mov_b32 v12, s51 :: v_dual_mov_b32 v13, s42
; GFX12-NEXT:    v_dual_mov_b32 v14, s43 :: v_dual_mov_b32 v15, s38
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v16, s39 :: v_dual_mov_b32 v17, s28
; GFX12-NEXT:    v_dual_mov_b32 v18, s29 :: v_dual_mov_b32 v19, s24
; GFX12-NEXT:    v_dual_mov_b32 v20, s25 :: v_dual_mov_b32 v21, s16
; GFX12-NEXT:    v_dual_mov_b32 v22, s17 :: v_dual_mov_b32 v23, s4
; GFX12-NEXT:    v_mov_b32_e32 v24, s5
; GFX12-NEXT:    s_clause 0x5
