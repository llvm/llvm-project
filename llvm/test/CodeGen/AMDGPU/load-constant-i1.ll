...
; GFX12-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_u16 s3, s[2:3], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v12, s3 :: v_dual_mov_b32 v3, s5
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s3
; GFX12-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v5, s7
; GFX12-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v7, s9
; GFX12-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v9, s11
; GFX12-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v11, s13
...
; GFX12-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v17, s15
; GFX12-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_mov_b32 v19, s17
; GFX12-NEXT:    v_bfe_i32 v12, v12, 0, 1
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX12-NEXT:    v_mov_b32_e32 v16, s14
...
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:112
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:96
; GFX12-NEXT:    v_dual_mov_b32 v0, s18 :: v_dual_mov_b32 v5, s23
; GFX12-NEXT:    v_dual_mov_b32 v1, s19 :: v_dual_mov_b32 v2, s20
; GFX12-NEXT:    v_mov_b32_e32 v7, s25
; GFX12-NEXT:    v_mov_b32_e32 v3, s21
; GFX12-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX12-NEXT:    v_dual_mov_b32 v4, s22 :: v_dual_mov_b32 v21, s27
; GFX12-NEXT:    v_dual_mov_b32 v6, s24 :: v_dual_mov_b32 v23, s29
; GFX12-NEXT:    v_dual_mov_b32 v20, s26 :: v_dual_mov_b32 v15, s31
; GFX12-NEXT:    v_mov_b32_e32 v22, s28
; GFX12-NEXT:    v_ashrrev_i32_e32 v13, 31, v12
; GFX12-NEXT:    v_mov_b32_e32 v14, s30
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX12-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:64
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:48
; GFX12-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:32
; GFX12-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:16
; GFX12-NEXT:    global_store_b128 v24, v[12:15], s[0:1]
; GFX12-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_load_u16 s3, s[2:3], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v12, s3
...
; GFX1250-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX1250-NEXT:    v_bfe_i32 v12, v12, 0, 1
...
; GFX1250-NEXT:    v_dual_mov_b32 v18, s16 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-NEXT:    v_mov_b32_e32 v19, s17
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_mov_b32_e32 v4, s22
; GFX1250-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v5, s23 :: v_dual_mov_b32 v6, s24
; GFX1250-NEXT:    v_dual_mov_b32 v7, s25 :: v_dual_mov_b32 v20, s26
; GFX1250-NEXT:    v_dual_mov_b32 v21, s27 :: v_dual_mov_b32 v22, s28
; GFX1250-NEXT:    v_dual_mov_b32 v23, s29 :: v_dual_mov_b32 v14, s30
; GFX1250-NEXT:    v_mov_b32_e32 v15, s31
; GFX1250-NEXT:    s_clause 0x5
; GFX1250-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v24, v[12:15], s[0:1]
; GFX1250-NEXT:    s_endpgm
  %load = load <16 x i1>, ptr addrspace(4) %in
