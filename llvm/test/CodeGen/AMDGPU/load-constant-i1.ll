...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    global_load_u8 v2, v8, s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_and_b32_e32 v6, 0xffff, v2
; GFX12-NEXT:    v_bfe_u32 v5, v2, 5, 1
; GFX12-NEXT:    v_bfe_u32 v4, v2, 4, 1
; GFX12-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX12-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX12-NEXT:    v_lshrrev_b32_e32 v7, 7, v6
; GFX12-NEXT:    v_bfe_u32 v6, v6, 6, 1
; GFX12-NEXT:    v_and_b32_e32 v0, 1, v2
; GFX12-NEXT:    v_bfe_u32 v2, v2, 2, 1
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_u8 v2, v8, s[2:3]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v0, 1, v2
; GFX1250-NEXT:    v_and_b32_e32 v6, 0xffff, v2
; GFX1250-NEXT:    v_bfe_u32 v5, v2, 5, 1
; GFX1250-NEXT:    v_bfe_u32 v4, v2, 4, 1
; GFX1250-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX1250-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX1250-NEXT:    v_lshrrev_b32_e32 v7, 7, v6
; GFX1250-NEXT:    v_bfe_u32 v6, v6, 6, 1
; GFX1250-NEXT:    v_bfe_u32 v2, v2, 2, 1
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    global_load_u16 v2, v16, s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_and_b32_e32 v17, 0xffff, v2
; GFX12-NEXT:    v_bfe_u32 v13, v2, 13, 1
; GFX12-NEXT:    v_bfe_u32 v12, v2, 12, 1
; GFX12-NEXT:    v_bfe_u32 v9, v2, 9, 1
; GFX12-NEXT:    v_bfe_u32 v10, v2, 10, 1
; GFX12-NEXT:    v_lshrrev_b32_e32 v15, 15, v17
; GFX12-NEXT:    v_bfe_u32 v14, v17, 14, 1
; GFX12-NEXT:    v_bfe_u32 v11, v17, 11, 1
; GFX12-NEXT:    v_bfe_u32 v8, v17, 8, 1
; GFX12-NEXT:    v_bfe_u32 v7, v2, 7, 1
; GFX12-NEXT:    v_bfe_u32 v5, v17, 5, 1
; GFX12-NEXT:    v_bfe_u32 v6, v17, 6, 1
; GFX12-NEXT:    v_bfe_u32 v4, v17, 4, 1
; GFX12-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX12-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX12-NEXT:    v_and_b32_e32 v0, 1, v2
; GFX12-NEXT:    v_bfe_u32 v2, v17, 2, 1
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_u16 v2, v16, s[2:3]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v0, 1, v2
; GFX1250-NEXT:    v_and_b32_e32 v17, 0xffff, v2
; GFX1250-NEXT:    v_bfe_u32 v13, v2, 13, 1
; GFX1250-NEXT:    v_bfe_u32 v12, v2, 12, 1
; GFX1250-NEXT:    v_bfe_u32 v9, v2, 9, 1
; GFX1250-NEXT:    v_bfe_u32 v10, v2, 10, 1
; GFX1250-NEXT:    v_lshrrev_b32_e32 v15, 15, v17
; GFX1250-NEXT:    v_bfe_u32 v14, v17, 14, 1
; GFX1250-NEXT:    v_bfe_u32 v11, v17, 11, 1
; GFX1250-NEXT:    v_bfe_u32 v8, v17, 8, 1
; GFX1250-NEXT:    v_bfe_u32 v7, v2, 7, 1
; GFX1250-NEXT:    v_bfe_u32 v5, v17, 5, 1
; GFX1250-NEXT:    v_bfe_u32 v6, v17, 6, 1
; GFX1250-NEXT:    v_bfe_u32 v4, v17, 4, 1
; GFX1250-NEXT:    v_bfe_u32 v3, v2, 3, 1
; GFX1250-NEXT:    v_bfe_u32 v1, v2, 1, 1
; GFX1250-NEXT:    v_bfe_u32 v2, v17, 2, 1
...
; GFX1250-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:16
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_and_b32_e32 v2, 0xffff, v0
; GFX12-NEXT:    v_bfe_u32 v8, v0, 2, 1
; GFX12-NEXT:    v_bfe_u32 v4, v0, 1, 1
; GFX12-NEXT:    v_and_b32_e32 v9, 1, v0
; GFX12-NEXT:    v_mov_b32_e32 v3, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v2, 3, v2
; GFX12-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_and_b32 v0, 0xffff, v8
; GFX12-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_and_b32 v6, 0xffff, v4
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX12-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX12-NEXT:    v_and_b32_e32 v4, 0xffff, v9
; GFX12-NEXT:    s_clause 0x1
...
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_and_b32_e32 v2, 0xffff, v0
; GFX1250-NEXT:    v_bfe_u32 v8, v0, 2, 1
; GFX1250-NEXT:    v_bfe_u32 v4, v0, 1, 1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX1250-NEXT:    v_dual_lshrrev_b32 v2, 3, v2 :: v_dual_bitop2_b32 v9, 1, v0 bitop3:0x40
; GFX1250-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v3, v1
; GFX1250-NEXT:    v_mov_b32_e32 v5, v1
; GFX1250-NEXT:    v_and_b32_e32 v0, 0xffff, v8
; GFX1250-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX1250-NEXT:    v_and_b32_e32 v6, 0xffff, v4
; GFX1250-NEXT:    v_and_b32_e32 v4, 0xffff, v9
; GFX1250-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_lshrrev_b32_e32 v3, 6, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v5, 7, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v7, 4, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v4, 3, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v8, 2, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v9, 5, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v2, 1, v1
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1250-NEXT:    v_mov_b32_e32 v17, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_u8 v2, v17, s[2:3]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_dual_lshrrev_b32 v8, 6, v2 :: v_dual_lshrrev_b32 v12, 7, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v16, 4, v2 :: v_dual_lshrrev_b32 v4, 1, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v6, 3, v2 :: v_dual_lshrrev_b32 v10, 2, v2
; GFX1250-NEXT:    v_lshrrev_b32_e32 v14, 5, v2
; GFX1250-NEXT:    v_bfe_i32 v0, v2, 0, 1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-NEXT:    v_bfe_i32 v2, v4, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v6, v6, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v4, v10, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v10, v14, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v14, v12, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v12, v8, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v8, v16, 0, 1
; GFX1250-NEXT:    v_dual_ashrrev_i32 v1, 31, v0 :: v_dual_ashrrev_i32 v7, 31, v6
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_dual_ashrrev_i32 v11, 31, v10 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-NEXT:    v_dual_ashrrev_i32 v15, 31, v14 :: v_dual_ashrrev_i32 v9, 31, v8
; GFX1250-NEXT:    v_dual_ashrrev_i32 v5, 31, v4 :: v_dual_ashrrev_i32 v3, 31, v2
; GFX1250-NEXT:    s_clause 0x3
; GFX1250-NEXT:    global_store_b128 v17, v[12:15], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v17, v[8:11], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v17, v[4:7], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v17, v[0:3], s[0:1]
; GFX1250-NEXT:    s_endpgm
  %load = load <8 x i1>, ptr addrspace(4) %in
...
; GFX12-NEXT:    v_mov_b32_e32 v1, 0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    global_load_u16 v12, v1, s[2:3]
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_and_b32 v22, 0xffff, v12
; GFX12-NEXT:    v_and_b32_e32 v28, 1, v12
; GFX12-NEXT:    v_bfe_u32 v0, v12, 10, 1
; GFX12-NEXT:    v_mov_b32_e32 v5, v1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX12-NEXT:    v_bfe_u32 v2, v22, 11, 1
; GFX12-NEXT:    v_mov_b32_e32 v7, v1
; GFX12-NEXT:    v_bfe_u32 v6, v12, 9, 1
; GFX12-NEXT:    v_bfe_u32 v4, v22, 8, 1
; GFX12-NEXT:    v_mov_b32_e32 v9, v1
; GFX12-NEXT:    v_mov_b32_e32 v11, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v10, 15, v22
; GFX12-NEXT:    v_bfe_u32 v8, v22, 14, 1
; GFX12-NEXT:    v_mov_b32_e32 v13, v1
; GFX12-NEXT:    v_mov_b32_e32 v15, v1
; GFX12-NEXT:    v_bfe_u32 v14, v12, 13, 1
; GFX12-NEXT:    v_bfe_u32 v18, v12, 7, 1
; GFX12-NEXT:    v_bfe_u32 v26, v12, 3, 1
; GFX12-NEXT:    v_bfe_u32 v30, v12, 1, 1
; GFX12-NEXT:    v_bfe_u32 v24, v12, 2, 1
; GFX12-NEXT:    v_bfe_u32 v20, v12, 4, 1
; GFX12-NEXT:    v_bfe_u32 v16, v12, 6, 1
; GFX12-NEXT:    v_bfe_u32 v12, v12, 12, 1
...
; GFX12-NEXT:    v_bfe_u32 v22, v22, 5, 1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_lshrrev_b32_e32 v3, 14, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v5, 15, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v7, 12, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v9, 13, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v11, 10, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v13, 11, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v15, 8, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v16, 9, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v12, 6, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v14, 7, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v8, 4, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v2, 1, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v4, 3, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v10, 2, v1
; GFX12-NEXT:    v_lshrrev_b32_e32 v17, 5, v1
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX1250-NEXT:    v_mov_b32_e32 v33, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_u16 v2, v33, s[2:3]
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    v_dual_lshrrev_b32 v28, 14, v2 :: v_dual_lshrrev_b32 v30, 15, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v24, 12, v2 :: v_dual_lshrrev_b32 v14, 7, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v8, 4, v2 :: v_dual_lshrrev_b32 v26, 13, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v20, 10, v2 :: v_dual_lshrrev_b32 v18, 9, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v12, 6, v2 :: v_dual_lshrrev_b32 v22, 11, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v16, 8, v2 :: v_dual_lshrrev_b32 v4, 1, v2
; GFX1250-NEXT:    v_dual_lshrrev_b32 v6, 3, v2 :: v_dual_lshrrev_b32 v10, 2, v2
; GFX1250-NEXT:    v_lshrrev_b32_e32 v32, 5, v2
; GFX1250-NEXT:    v_bfe_i32 v14, v14, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v30, v30, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v28, v28, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v18, v18, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v26, v26, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v24, v24, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v22, v22, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v20, v20, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v16, v16, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v12, v12, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v0, v2, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v2, v4, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v6, v6, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v4, v10, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v10, v32, 0, 1
; GFX1250-NEXT:    v_bfe_i32 v8, v8, 0, 1
; GFX1250-NEXT:    v_dual_ashrrev_i32 v15, 31, v14 :: v_dual_ashrrev_i32 v29, 31, v28
; GFX1250-NEXT:    v_dual_ashrrev_i32 v31, 31, v30 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1250-NEXT:    v_dual_ashrrev_i32 v19, 31, v18 :: v_dual_ashrrev_i32 v25, 31, v24
; GFX1250-NEXT:    v_dual_ashrrev_i32 v27, 31, v26 :: v_dual_ashrrev_i32 v17, 31, v16
; GFX1250-NEXT:    v_dual_ashrrev_i32 v23, 31, v22 :: v_dual_ashrrev_i32 v21, 31, v20
; GFX1250-NEXT:    v_dual_ashrrev_i32 v1, 31, v0 :: v_dual_ashrrev_i32 v3, 31, v2
; GFX1250-NEXT:    v_dual_ashrrev_i32 v7, 31, v6 :: v_dual_ashrrev_i32 v5, 31, v4
; GFX1250-NEXT:    v_dual_ashrrev_i32 v11, 31, v10 :: v_dual_ashrrev_i32 v9, 31, v8
; GFX1250-NEXT:    s_clause 0x7
; GFX1250-NEXT:    global_store_b128 v33, v[28:31], s[0:1] offset:112
; GFX1250-NEXT:    global_store_b128 v33, v[24:27], s[0:1] offset:96
; GFX1250-NEXT:    global_store_b128 v33, v[20:23], s[0:1] offset:80
; GFX1250-NEXT:    global_store_b128 v33, v[16:19], s[0:1] offset:64
; GFX1250-NEXT:    global_store_b128 v33, v[12:15], s[0:1] offset:48
; GFX1250-NEXT:    global_store_b128 v33, v[8:11], s[0:1] offset:32
; GFX1250-NEXT:    global_store_b128 v33, v[4:7], s[0:1] offset:16
; GFX1250-NEXT:    global_store_b128 v33, v[0:3], s[0:1]
; GFX1250-NEXT:    s_endpgm
  %load = load <16 x i1>, ptr addrspace(4) %in
