...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v1, 0xffff, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_lshrrev_b32 v1, 1, v1 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
; GFX1210-NEXT:    global_store_b64 v2, v[0:1], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <2 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_load_u8 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_i32 s3, s2, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x10001
; GFX1210-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v0, s3
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u8 v1, v3, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_dual_lshrrev_b32 v2, 2, v0 :: v_dual_bitop2_b32 v0, 1, v1 bitop3:0x40
; GFX1210-NEXT:    v_bfe_u32 v1, v1, 1, 1
...
; GFX1210-NEXT:    s_load_u8 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_i32 s3, s2, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s4, s2, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x10001
; GFX1210-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v0, s4
; GFX1210-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    global_store_b96 v3, v[0:2], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <3 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u8 v1, v4, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v0, 1, v1
; GFX1210-NEXT:    v_and_b32_e32 v3, 0xffff, v1
; GFX1210-NEXT:    v_bfe_u32 v2, v1, 2, 1
; GFX1210-NEXT:    v_bfe_u32 v1, v1, 1, 1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX1210-NEXT:    v_lshrrev_b32_e32 v3, 3, v3
...
; GFX1210-NEXT:    s_load_u8 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_i32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_i32 s4, s2, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s5, s2, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x10001
; GFX1210-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v0, s5
; GFX1210-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    v_mov_b32_e32 v3, s3
; GFX1210-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <4 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX1210-NEXT:    v_lshrrev_b32_e32 v3, 7, v0
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10005
; GFX1210-NEXT:    s_and_b32 s6, s2, 1
; GFX1210-NEXT:    s_bfe_u32 s7, s2, 0x10002
; GFX1210-NEXT:    s_bfe_u32 s2, s2, 0x10004
; GFX1210-NEXT:    v_bfe_u32 v2, v0, 6, 1
; GFX1210-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s5
; GFX1210-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s4
; GFX1210-NEXT:    v_dual_mov_b32 v6, s7 :: v_dual_mov_b32 v7, s3
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <8 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_bfe_i32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_i32 s4, s2, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s5, s2, 0x10001
; GFX1210-NEXT:    s_bfe_i32 s6, s2, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s7, s2, 0x10007
; GFX1210-NEXT:    s_bfe_i32 s8, s2, 0x10006
; GFX1210-NEXT:    s_bfe_i32 s9, s2, 0x10004
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x10005
; GFX1210-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v0, s9
; GFX1210-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s8
; GFX1210-NEXT:    v_dual_mov_b32 v3, s7 :: v_dual_mov_b32 v4, s6
; GFX1210-NEXT:    v_dual_mov_b32 v5, s5 :: v_dual_mov_b32 v6, s4
; GFX1210-NEXT:    v_mov_b32_e32 v7, s3
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX1210-NEXT:    v_readfirstlane_b32 s2, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    s_and_b32 s6, 0xffff, s2
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s7, s2, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s8, s2, 0x1000d
; GFX1210-NEXT:    s_and_b32 s9, s2, 1
; GFX1210-NEXT:    s_bfe_u32 s10, s2, 0x1000a
; GFX1210-NEXT:    s_bfe_u32 s2, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_u32 s11, s6, 0x10005
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    s_bfe_u32 s12, s6, 0x1000b
; GFX1210-NEXT:    s_lshr_b32 s13, s6, 15
; GFX1210-NEXT:    s_bfe_u32 s14, s6, 0x10002
; GFX1210-NEXT:    s_bfe_u32 s15, s6, 0x10006
; GFX1210-NEXT:    s_bfe_u32 s16, s6, 0x10004
; GFX1210-NEXT:    s_bfe_u32 s17, s6, 0x10008
; GFX1210-NEXT:    s_bfe_u32 s6, s6, 0x1000e
; GFX1210-NEXT:    v_dual_mov_b32 v1, s8 :: v_dual_mov_b32 v5, s7
; GFX1210-NEXT:    v_dual_mov_b32 v15, s3 :: v_dual_mov_b32 v2, s6
; GFX1210-NEXT:    v_dual_mov_b32 v3, s13 :: v_dual_mov_b32 v4, s17
; GFX1210-NEXT:    v_dual_mov_b32 v6, s10 :: v_dual_mov_b32 v11, s5
; GFX1210-NEXT:    v_dual_mov_b32 v7, s12 :: v_dual_mov_b32 v8, s16
; GFX1210-NEXT:    v_dual_mov_b32 v9, s11 :: v_dual_mov_b32 v10, s15
; GFX1210-NEXT:    v_dual_mov_b32 v12, s9 :: v_dual_mov_b32 v13, s4
; GFX1210-NEXT:    v_mov_b32_e32 v14, s14
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v16, v[12:15], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <16 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_u16 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_i32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_i32 s4, s2, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s5, s2, 0x10001
...
; GFX1210-NEXT:    s_bfe_i32 s7, s2, 0x10007
; GFX1210-NEXT:    s_bfe_i32 s8, s2, 0x10006
; GFX1210-NEXT:    s_bfe_i32 s9, s2, 0x10005
; GFX1210-NEXT:    s_bfe_i32 s10, s2, 0x10004
; GFX1210-NEXT:    s_bfe_i32 s11, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_i32 s12, s2, 0x1000a
; GFX1210-NEXT:    s_bfe_i32 s13, s2, 0x10009
; GFX1210-NEXT:    s_bfe_i32 s14, s2, 0x10008
; GFX1210-NEXT:    s_bfe_i32 s15, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_i32 s16, s2, 0x1000e
; GFX1210-NEXT:    s_bfe_i32 s17, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x1000d
; GFX1210-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v0, s17
; GFX1210-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s16
; GFX1210-NEXT:    v_dual_mov_b32 v3, s15 :: v_dual_mov_b32 v4, s14
; GFX1210-NEXT:    v_dual_mov_b32 v5, s13 :: v_dual_mov_b32 v6, s12
; GFX1210-NEXT:    v_dual_mov_b32 v7, s11 :: v_dual_mov_b32 v8, s10
; GFX1210-NEXT:    v_dual_mov_b32 v9, s9 :: v_dual_mov_b32 v10, s8
; GFX1210-NEXT:    v_dual_mov_b32 v11, s7 :: v_dual_mov_b32 v12, s6
; GFX1210-NEXT:    v_dual_mov_b32 v13, s5 :: v_dual_mov_b32 v14, s4
; GFX1210-NEXT:    v_mov_b32_e32 v15, s3
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
...
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s6, s2, 0x10005
; GFX1210-NEXT:    s_bfe_u32 s7, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s8, s2, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s9, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s10, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_u32 s11, s2, 0x10013
; GFX1210-NEXT:    s_bfe_u32 s12, s2, 0x10011
; GFX1210-NEXT:    s_bfe_u32 s13, s2, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s14, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s15, s2, 0x10019
; GFX1210-NEXT:    s_lshr_b32 s16, s2, 31
; GFX1210-NEXT:    s_bfe_u32 s17, s2, 0x1001d
; GFX1210-NEXT:    s_and_b32 s18, s2, 1
; GFX1210-NEXT:    s_bfe_u32 s19, s2, 0x10002
; GFX1210-NEXT:    s_bfe_u32 s20, s2, 0x10006
; GFX1210-NEXT:    s_bfe_u32 s21, s2, 0x10004
; GFX1210-NEXT:    s_bfe_u32 s22, s2, 0x1000a
; GFX1210-NEXT:    s_bfe_u32 s23, s2, 0x10008
; GFX1210-NEXT:    s_bfe_u32 s24, s2, 0x1000e
; GFX1210-NEXT:    s_bfe_u32 s25, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_u32 s26, s2, 0x10012
; GFX1210-NEXT:    s_bfe_u32 s27, s2, 0x10010
; GFX1210-NEXT:    s_bfe_u32 s28, s2, 0x10016
; GFX1210-NEXT:    s_bfe_u32 s29, s2, 0x10015
; GFX1210-NEXT:    s_bfe_u32 s30, s2, 0x10014
; GFX1210-NEXT:    s_bfe_u32 s31, s2, 0x1001a
; GFX1210-NEXT:    s_bfe_u32 s33, s2, 0x10018
; GFX1210-NEXT:    s_bfe_u32 s34, s2, 0x1001c
; GFX1210-NEXT:    s_bfe_u32 s2, s2, 0x1001e
; GFX1210-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s34
; GFX1210-NEXT:    v_dual_mov_b32 v1, s17 :: v_dual_mov_b32 v2, s2
; GFX1210-NEXT:    v_dual_mov_b32 v3, s16 :: v_dual_mov_b32 v4, s33
; GFX1210-NEXT:    v_dual_mov_b32 v5, s15 :: v_dual_mov_b32 v6, s31
; GFX1210-NEXT:    v_dual_mov_b32 v7, s14 :: v_dual_mov_b32 v8, s30
; GFX1210-NEXT:    v_dual_mov_b32 v9, s29 :: v_dual_mov_b32 v10, s28
; GFX1210-NEXT:    v_mov_b32_e32 v11, s13
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:112
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v0, s27 :: v_dual_mov_b32 v1, s12
; GFX1210-NEXT:    v_dual_mov_b32 v2, s26 :: v_dual_mov_b32 v3, s11
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v4, s25 :: v_dual_mov_b32 v5, s10
; GFX1210-NEXT:    v_dual_mov_b32 v6, s24 :: v_dual_mov_b32 v7, s9
; GFX1210-NEXT:    v_dual_mov_b32 v12, s23 :: v_dual_mov_b32 v13, s8
; GFX1210-NEXT:    v_dual_mov_b32 v14, s22 :: v_dual_mov_b32 v15, s7
; GFX1210-NEXT:    v_dual_mov_b32 v16, s21 :: v_dual_mov_b32 v17, s6
; GFX1210-NEXT:    v_dual_mov_b32 v18, s20 :: v_dual_mov_b32 v19, s5
; GFX1210-NEXT:    v_dual_mov_b32 v20, s18 :: v_dual_mov_b32 v21, s4
; GFX1210-NEXT:    v_dual_mov_b32 v22, s19 :: v_dual_mov_b32 v23, s3
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v24, v[20:23], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <32 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_bfe_i32 s15, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_i32 s16, s2, 0x1000e
; GFX1210-NEXT:    s_bfe_i32 s17, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_i32 s18, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_i32 s19, s2, 0x10013
; GFX1210-NEXT:    s_bfe_i32 s20, s2, 0x10012
; GFX1210-NEXT:    s_bfe_i32 s21, s2, 0x10011
; GFX1210-NEXT:    s_bfe_i32 s22, s2, 0x10010
; GFX1210-NEXT:    s_bfe_i32 s23, s2, 0x10017
; GFX1210-NEXT:    s_bfe_i32 s24, s2, 0x10016
; GFX1210-NEXT:    s_bfe_i32 s25, s2, 0x10015
; GFX1210-NEXT:    s_bfe_i32 s26, s2, 0x10014
; GFX1210-NEXT:    s_bfe_i32 s27, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_i32 s28, s2, 0x1001a
; GFX1210-NEXT:    s_bfe_i32 s29, s2, 0x10019
; GFX1210-NEXT:    s_bfe_i32 s30, s2, 0x10018
; GFX1210-NEXT:    s_ashr_i32 s31, s2, 31
; GFX1210-NEXT:    s_bfe_i32 s33, s2, 0x1001e
; GFX1210-NEXT:    s_bfe_i32 s34, s2, 0x1001c
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x1001d
; GFX1210-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s34
; GFX1210-NEXT:    v_dual_mov_b32 v1, s2 :: v_dual_mov_b32 v2, s33
; GFX1210-NEXT:    v_dual_mov_b32 v3, s31 :: v_dual_mov_b32 v4, s30
; GFX1210-NEXT:    v_dual_mov_b32 v5, s29 :: v_dual_mov_b32 v6, s28
; GFX1210-NEXT:    v_dual_mov_b32 v7, s27 :: v_dual_mov_b32 v8, s26
; GFX1210-NEXT:    v_dual_mov_b32 v9, s25 :: v_dual_mov_b32 v10, s24
; GFX1210-NEXT:    v_mov_b32_e32 v11, s23
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:112
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v0, s22 :: v_dual_mov_b32 v1, s21
; GFX1210-NEXT:    v_dual_mov_b32 v2, s20 :: v_dual_mov_b32 v3, s19
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v4, s18 :: v_dual_mov_b32 v5, s17
; GFX1210-NEXT:    v_dual_mov_b32 v6, s16 :: v_dual_mov_b32 v7, s15
; GFX1210-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v13, s13
; GFX1210-NEXT:    v_dual_mov_b32 v14, s12 :: v_dual_mov_b32 v15, s11
; GFX1210-NEXT:    v_dual_mov_b32 v16, s10 :: v_dual_mov_b32 v17, s9
; GFX1210-NEXT:    v_dual_mov_b32 v18, s8 :: v_dual_mov_b32 v19, s7
; GFX1210-NEXT:    v_dual_mov_b32 v20, s6 :: v_dual_mov_b32 v21, s5
; GFX1210-NEXT:    v_dual_mov_b32 v22, s4 :: v_dual_mov_b32 v23, s3
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:48
...
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_lshr_b32 s33, s3, 31
; GFX1210-NEXT:    s_bfe_u32 s34, s3, 0x1001d
; GFX1210-NEXT:    s_bfe_u32 s65, s3, 0x1001c
; GFX1210-NEXT:    s_bfe_u32 s66, s3, 0x1001e
; GFX1210-NEXT:    s_bfe_u32 s30, s3, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s31, s3, 0x10019
; GFX1210-NEXT:    s_bfe_u32 s63, s3, 0x1001a
; GFX1210-NEXT:    s_bfe_u32 s64, s3, 0x10018
; GFX1210-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s65
; GFX1210-NEXT:    s_bfe_u32 s29, s3, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s60, s3, 0x10016
; GFX1210-NEXT:    s_bfe_u32 s61, s3, 0x10015
; GFX1210-NEXT:    s_bfe_u32 s62, s3, 0x10014
; GFX1210-NEXT:    v_dual_mov_b32 v1, s34 :: v_dual_mov_b32 v2, s66
; GFX1210-NEXT:    v_dual_mov_b32 v3, s33 :: v_dual_mov_b32 v4, s64
; GFX1210-NEXT:    s_bfe_u32 s27, s3, 0x10013
; GFX1210-NEXT:    s_bfe_u32 s28, s3, 0x10011
; GFX1210-NEXT:    s_bfe_u32 s58, s3, 0x10012
; GFX1210-NEXT:    s_bfe_u32 s59, s3, 0x10010
; GFX1210-NEXT:    v_dual_mov_b32 v5, s31 :: v_dual_mov_b32 v6, s63
; GFX1210-NEXT:    v_dual_mov_b32 v7, s30 :: v_dual_mov_b32 v8, s62
; GFX1210-NEXT:    v_dual_mov_b32 v9, s61 :: v_dual_mov_b32 v10, s60
; GFX1210-NEXT:    v_dual_mov_b32 v11, s29 :: v_dual_mov_b32 v12, s59
; GFX1210-NEXT:    s_bfe_u32 s19, s3, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s20, s3, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s21, s3, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s22, s3, 0x10005
; GFX1210-NEXT:    s_bfe_u32 s23, s3, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s24, s3, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s25, s3, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s26, s3, 0x1000d
; GFX1210-NEXT:    s_and_b32 s51, s3, 1
; GFX1210-NEXT:    s_bfe_u32 s52, s3, 0x10002
; GFX1210-NEXT:    s_bfe_u32 s53, s3, 0x10006
; GFX1210-NEXT:    s_bfe_u32 s54, s3, 0x10004
; GFX1210-NEXT:    s_bfe_u32 s55, s3, 0x1000a
; GFX1210-NEXT:    s_bfe_u32 s56, s3, 0x10008
; GFX1210-NEXT:    s_bfe_u32 s57, s3, 0x1000e
; GFX1210-NEXT:    v_dual_mov_b32 v13, s28 :: v_dual_mov_b32 v14, s58
; GFX1210-NEXT:    s_bfe_u32 s3, s3, 0x1000c
; GFX1210-NEXT:    v_mov_b32_e32 v15, s27
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:240
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:224
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:208
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v1, s26
; GFX1210-NEXT:    v_dual_mov_b32 v2, s57 :: v_dual_mov_b32 v3, s25
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v4, s56 :: v_dual_mov_b32 v5, s24
; GFX1210-NEXT:    v_dual_mov_b32 v6, s55 :: v_dual_mov_b32 v7, s23
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_mov_b32_e32 v8, s54
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s6, s2, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s7, s2, 0x10005
; GFX1210-NEXT:    s_bfe_u32 s8, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s9, s2, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s10, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s11, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_u32 s12, s2, 0x10013
; GFX1210-NEXT:    s_bfe_u32 s13, s2, 0x10011
; GFX1210-NEXT:    s_bfe_u32 s14, s2, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s15, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s16, s2, 0x10019
; GFX1210-NEXT:    s_lshr_b32 s17, s2, 31
; GFX1210-NEXT:    s_bfe_u32 s18, s2, 0x1001d
; GFX1210-NEXT:    s_and_b32 s35, s2, 1
; GFX1210-NEXT:    s_bfe_u32 s36, s2, 0x10002
; GFX1210-NEXT:    s_bfe_u32 s37, s2, 0x10006
; GFX1210-NEXT:    s_bfe_u32 s38, s2, 0x10004
; GFX1210-NEXT:    s_bfe_u32 s39, s2, 0x1000a
; GFX1210-NEXT:    s_bfe_u32 s40, s2, 0x10008
; GFX1210-NEXT:    s_bfe_u32 s41, s2, 0x1000e
; GFX1210-NEXT:    s_bfe_u32 s42, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_u32 s43, s2, 0x10012
; GFX1210-NEXT:    s_bfe_u32 s44, s2, 0x10010
; GFX1210-NEXT:    s_bfe_u32 s45, s2, 0x10016
; GFX1210-NEXT:    s_bfe_u32 s46, s2, 0x10015
; GFX1210-NEXT:    s_bfe_u32 s47, s2, 0x10014
; GFX1210-NEXT:    s_bfe_u32 s48, s2, 0x1001a
; GFX1210-NEXT:    s_bfe_u32 s49, s2, 0x10018
; GFX1210-NEXT:    s_bfe_u32 s50, s2, 0x1001e
; GFX1210-NEXT:    s_bfe_u32 s2, s2, 0x1001c
; GFX1210-NEXT:    v_dual_mov_b32 v9, s22 :: v_dual_mov_b32 v10, s53
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v11, s21 :: v_dual_mov_b32 v12, s51
; GFX1210-NEXT:    v_dual_mov_b32 v13, s20 :: v_dual_mov_b32 v14, s52
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v15, s19 :: v_dual_mov_b32 v16, s2
; GFX1210-NEXT:    v_dual_mov_b32 v17, s18 :: v_dual_mov_b32 v18, s50
; GFX1210-NEXT:    v_dual_mov_b32 v19, s17 :: v_dual_mov_b32 v20, s49
; GFX1210-NEXT:    v_dual_mov_b32 v21, s16 :: v_dual_mov_b32 v22, s48
; GFX1210-NEXT:    v_mov_b32_e32 v23, s15
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:160
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:144
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:128
; GFX1210-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:112
; GFX1210-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s47 :: v_dual_mov_b32 v1, s46
; GFX1210-NEXT:    v_dual_mov_b32 v2, s45 :: v_dual_mov_b32 v3, s14
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_dual_mov_b32 v4, s44 :: v_dual_mov_b32 v5, s13
; GFX1210-NEXT:    v_dual_mov_b32 v6, s43 :: v_dual_mov_b32 v7, s12
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v8, s42 :: v_dual_mov_b32 v9, s11
; GFX1210-NEXT:    v_dual_mov_b32 v10, s41 :: v_dual_mov_b32 v11, s10
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v12, s40 :: v_dual_mov_b32 v13, s9
; GFX1210-NEXT:    v_dual_mov_b32 v14, s39 :: v_dual_mov_b32 v15, s8
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v16, s38 :: v_dual_mov_b32 v17, s7
; GFX1210-NEXT:    v_dual_mov_b32 v18, s37 :: v_dual_mov_b32 v19, s6
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v20, s35 :: v_dual_mov_b32 v21, s5
; GFX1210-NEXT:    v_dual_mov_b32 v22, s36 :: v_dual_mov_b32 v23, s4
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v24, v[16:19], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v24, v[20:23], s[0:1]
; GFX1210-NEXT:    s_endpgm
...
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_ashr_i32 s63, s3, 31
; GFX1210-NEXT:    s_bfe_i32 s64, s3, 0x1001e
; GFX1210-NEXT:    s_bfe_i32 s65, s3, 0x1001c
; GFX1210-NEXT:    s_bfe_i32 s66, s3, 0x1001d
; GFX1210-NEXT:    s_bfe_i32 s59, s3, 0x1001b
; GFX1210-NEXT:    s_bfe_i32 s60, s3, 0x1001a
; GFX1210-NEXT:    s_bfe_i32 s61, s3, 0x10019
; GFX1210-NEXT:    s_bfe_i32 s62, s3, 0x10018
; GFX1210-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s65
; GFX1210-NEXT:    s_bfe_i32 s55, s3, 0x10017
; GFX1210-NEXT:    s_bfe_i32 s56, s3, 0x10016
; GFX1210-NEXT:    s_bfe_i32 s57, s3, 0x10015
; GFX1210-NEXT:    s_bfe_i32 s58, s3, 0x10014
; GFX1210-NEXT:    v_dual_mov_b32 v1, s66 :: v_dual_mov_b32 v2, s64
; GFX1210-NEXT:    v_dual_mov_b32 v3, s63 :: v_dual_mov_b32 v4, s62
; GFX1210-NEXT:    s_bfe_i32 s51, s3, 0x10013
; GFX1210-NEXT:    s_bfe_i32 s52, s3, 0x10012
; GFX1210-NEXT:    s_bfe_i32 s53, s3, 0x10011
; GFX1210-NEXT:    s_bfe_i32 s54, s3, 0x10010
; GFX1210-NEXT:    v_dual_mov_b32 v5, s61 :: v_dual_mov_b32 v6, s60
; GFX1210-NEXT:    v_dual_mov_b32 v7, s59 :: v_dual_mov_b32 v8, s58
; GFX1210-NEXT:    v_dual_mov_b32 v9, s57 :: v_dual_mov_b32 v10, s56
; GFX1210-NEXT:    v_dual_mov_b32 v11, s55 :: v_dual_mov_b32 v12, s54
; GFX1210-NEXT:    s_bfe_i32 s36, s3, 0x10003
; GFX1210-NEXT:    s_bfe_i32 s37, s3, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s38, s3, 0x10001
; GFX1210-NEXT:    s_bfe_i32 s39, s3, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s40, s3, 0x10007
; GFX1210-NEXT:    s_bfe_i32 s41, s3, 0x10006
; GFX1210-NEXT:    s_bfe_i32 s42, s3, 0x10005
; GFX1210-NEXT:    s_bfe_i32 s43, s3, 0x10004
; GFX1210-NEXT:    s_bfe_i32 s44, s3, 0x1000b
; GFX1210-NEXT:    s_bfe_i32 s45, s3, 0x1000a
; GFX1210-NEXT:    s_bfe_i32 s46, s3, 0x10009
; GFX1210-NEXT:    s_bfe_i32 s47, s3, 0x10008
; GFX1210-NEXT:    s_bfe_i32 s48, s3, 0x1000f
; GFX1210-NEXT:    s_bfe_i32 s49, s3, 0x1000e
; GFX1210-NEXT:    s_bfe_i32 s50, s3, 0x1000d
; GFX1210-NEXT:    v_dual_mov_b32 v13, s53 :: v_dual_mov_b32 v14, s52
; GFX1210-NEXT:    s_bfe_i32 s3, s3, 0x1000c
; GFX1210-NEXT:    v_mov_b32_e32 v15, s51
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:240
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:224
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:208
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v1, s50
; GFX1210-NEXT:    v_dual_mov_b32 v2, s49 :: v_dual_mov_b32 v3, s48
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v4, s47 :: v_dual_mov_b32 v5, s46
; GFX1210-NEXT:    v_dual_mov_b32 v6, s45 :: v_dual_mov_b32 v7, s44
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_mov_b32_e32 v8, s43
; GFX1210-NEXT:    s_bfe_i32 s4, s2, 0x10003
; GFX1210-NEXT:    s_bfe_i32 s5, s2, 0x10002
; GFX1210-NEXT:    s_bfe_i32 s6, s2, 0x10001
; GFX1210-NEXT:    s_bfe_i32 s7, s2, 0x10000
; GFX1210-NEXT:    s_bfe_i32 s8, s2, 0x10007
; GFX1210-NEXT:    s_bfe_i32 s9, s2, 0x10006
; GFX1210-NEXT:    s_bfe_i32 s10, s2, 0x10005
; GFX1210-NEXT:    s_bfe_i32 s11, s2, 0x10004
; GFX1210-NEXT:    s_bfe_i32 s12, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_i32 s13, s2, 0x1000a
; GFX1210-NEXT:    s_bfe_i32 s14, s2, 0x10009
; GFX1210-NEXT:    s_bfe_i32 s15, s2, 0x10008
; GFX1210-NEXT:    s_bfe_i32 s16, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_i32 s17, s2, 0x1000e
; GFX1210-NEXT:    s_bfe_i32 s18, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_i32 s19, s2, 0x1000c
; GFX1210-NEXT:    s_bfe_i32 s20, s2, 0x10013
; GFX1210-NEXT:    s_bfe_i32 s21, s2, 0x10012
; GFX1210-NEXT:    s_bfe_i32 s22, s2, 0x10011
; GFX1210-NEXT:    s_bfe_i32 s23, s2, 0x10010
; GFX1210-NEXT:    s_bfe_i32 s24, s2, 0x10017
; GFX1210-NEXT:    s_bfe_i32 s25, s2, 0x10016
; GFX1210-NEXT:    s_bfe_i32 s26, s2, 0x10015
; GFX1210-NEXT:    s_bfe_i32 s27, s2, 0x10014
; GFX1210-NEXT:    s_bfe_i32 s28, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_i32 s29, s2, 0x1001a
; GFX1210-NEXT:    s_bfe_i32 s30, s2, 0x10019
; GFX1210-NEXT:    s_bfe_i32 s31, s2, 0x10018
; GFX1210-NEXT:    s_ashr_i32 s33, s2, 31
; GFX1210-NEXT:    s_bfe_i32 s34, s2, 0x1001e
; GFX1210-NEXT:    s_bfe_i32 s35, s2, 0x1001d
; GFX1210-NEXT:    s_bfe_i32 s2, s2, 0x1001c
; GFX1210-NEXT:    v_dual_mov_b32 v9, s42 :: v_dual_mov_b32 v10, s41
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v11, s40 :: v_dual_mov_b32 v12, s39
; GFX1210-NEXT:    v_dual_mov_b32 v13, s38 :: v_dual_mov_b32 v14, s37
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v15, s36 :: v_dual_mov_b32 v16, s2
; GFX1210-NEXT:    v_dual_mov_b32 v17, s35 :: v_dual_mov_b32 v18, s34
; GFX1210-NEXT:    v_dual_mov_b32 v19, s33 :: v_dual_mov_b32 v20, s31
; GFX1210-NEXT:    v_dual_mov_b32 v21, s30 :: v_dual_mov_b32 v22, s29
; GFX1210-NEXT:    v_mov_b32_e32 v23, s28
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:160
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:144
...
; GFX1210-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s27 :: v_dual_mov_b32 v1, s26
; GFX1210-NEXT:    v_dual_mov_b32 v2, s25 :: v_dual_mov_b32 v3, s24
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_dual_mov_b32 v4, s23 :: v_dual_mov_b32 v5, s22
; GFX1210-NEXT:    v_dual_mov_b32 v6, s21 :: v_dual_mov_b32 v7, s20
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v8, s19 :: v_dual_mov_b32 v9, s18
; GFX1210-NEXT:    v_dual_mov_b32 v10, s17 :: v_dual_mov_b32 v11, s16
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v12, s15 :: v_dual_mov_b32 v13, s14
; GFX1210-NEXT:    v_dual_mov_b32 v14, s13 :: v_dual_mov_b32 v15, s12
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v16, s11 :: v_dual_mov_b32 v17, s10
; GFX1210-NEXT:    v_dual_mov_b32 v18, s9 :: v_dual_mov_b32 v19, s8
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v20, s7 :: v_dual_mov_b32 v21, s6
; GFX1210-NEXT:    v_dual_mov_b32 v22, s5 :: v_dual_mov_b32 v23, s4
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:48
...
; GFX1210-NEXT:    v_lshrrev_b32_e32 v2, 1, v2
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_lshrrev_b32_e32 v2, 1, v0
...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v1, 0xffff, v0
; GFX1210-NEXT:    v_bfe_u32 v2, v0, 1, 1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX1210-NEXT:    v_dual_lshrrev_b32 v4, 2, v1 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
; GFX1210-NEXT:    v_dual_mov_b32 v1, v5 :: v_dual_mov_b32 v3, v5
; GFX1210-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX1210-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; GFX1210-NEXT:    s_clause 0x1
...
; GFX1210-NEXT:    global_load_u8 v0, v5, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_dual_lshrrev_b32 v2, 2, v0 :: v_dual_lshrrev_b32 v4, 1, v0
; GFX1210-NEXT:    v_bfe_i32 v0, v0, 0, 1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10002
; GFX1210-NEXT:    v_lshrrev_b32_e32 v2, 3, v0
; GFX1210-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1210-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v0, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10001
; GFX1210-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX1210-NEXT:    s_and_b32 s2, s2, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX1210-NEXT:    s_and_b32 s2, 0xffff, s2
...
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_dual_lshrrev_b32 v2, 3, v0 :: v_dual_lshrrev_b32 v4, 2, v0
; GFX1210-NEXT:    v_lshrrev_b32_e32 v8, 1, v0
; GFX1210-NEXT:    v_bfe_i32 v0, v0, 0, 1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1210-NEXT:    v_bfe_i32 v6, v2, 0, 1
...
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u8 v12, v1, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v0, 0xffff, v12
; GFX1210-NEXT:    v_bfe_u32 v6, v12, 5, 1
; GFX1210-NEXT:    v_bfe_u32 v4, v12, 4, 1
; GFX1210-NEXT:    v_bfe_u32 v10, v12, 3, 1
; GFX1210-NEXT:    v_bfe_u32 v8, v12, 2, 1
; GFX1210-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_lshrrev_b32 v2, 7, v0
; GFX1210-NEXT:    v_mov_b32_e32 v5, v1
; GFX1210-NEXT:    v_bfe_u32 v0, v0, 6, 1
; GFX1210-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v9, v1
; GFX1210-NEXT:    v_dual_mov_b32 v11, v1 :: v_dual_mov_b32 v13, v1
; GFX1210-NEXT:    v_mov_b32_e32 v15, v1
; GFX1210-NEXT:    v_bfe_u32 v14, v12, 1, 1
...
; GFX1210-NEXT:    v_mov_b32_e32 v16, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u8 v0, v16, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_readfirstlane_b32 s3, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v10, s3
; GFX1210-NEXT:    s_lshr_b32 s2, s3, 6
; GFX1210-NEXT:    s_lshr_b32 s4, s3, 7
; GFX1210-NEXT:    s_lshr_b32 s6, s3, 4
; GFX1210-NEXT:    s_lshr_b32 s8, s3, 5
; GFX1210-NEXT:    s_lshr_b32 s10, s3, 2
; GFX1210-NEXT:    s_lshr_b32 s12, s3, 3
; GFX1210-NEXT:    s_lshr_b32 s14, s3, 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x10000
; GFX1210-NEXT:    v_bfe_i32 v12, v10, 0, 1
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX1210-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1210-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1210-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
; GFX1210-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v9, s11
; GFX1210-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_mov_b32 v11, s13
; GFX1210-NEXT:    v_dual_mov_b32 v14, s14 :: v_dual_ashrrev_i32 v13, 31, v12
; GFX1210-NEXT:    v_mov_b32_e32 v15, s15
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
...
; GFX1210-NEXT:    v_mov_b32_e32 v1, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u16 v12, v1, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_and_b32_e32 v28, 1, v12
; GFX1210-NEXT:    v_and_b32_e32 v22, 0xffff, v12
; GFX1210-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v5, v1
; GFX1210-NEXT:    v_bfe_u32 v0, v12, 10, 1
; GFX1210-NEXT:    v_dual_mov_b32 v7, v1 :: v_dual_mov_b32 v9, v1
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX1210-NEXT:    v_bfe_u32 v2, v22, 11, 1
; GFX1210-NEXT:    v_bfe_u32 v6, v12, 9, 1
; GFX1210-NEXT:    v_bfe_u32 v4, v22, 8, 1
; GFX1210-NEXT:    v_dual_mov_b32 v11, v1 :: v_dual_mov_b32 v13, v1
; GFX1210-NEXT:    v_dual_mov_b32 v31, v1 :: v_dual_lshrrev_b32 v10, 15, v22
; GFX1210-NEXT:    v_bfe_u32 v8, v22, 14, 1
; GFX1210-NEXT:    v_dual_mov_b32 v15, v1 :: v_dual_mov_b32 v17, v1
; GFX1210-NEXT:    v_bfe_u32 v14, v12, 13, 1
; GFX1210-NEXT:    v_bfe_u32 v18, v12, 7, 1
; GFX1210-NEXT:    v_bfe_u32 v26, v12, 3, 1
; GFX1210-NEXT:    v_bfe_u32 v30, v12, 1, 1
; GFX1210-NEXT:    v_bfe_u32 v24, v12, 2, 1
; GFX1210-NEXT:    v_bfe_u32 v20, v12, 4, 1
; GFX1210-NEXT:    v_bfe_u32 v16, v12, 6, 1
; GFX1210-NEXT:    v_bfe_u32 v12, v12, 12, 1
...
; GFX1210-NEXT:    v_bfe_u32 v22, v22, 5, 1
; GFX1210-NEXT:    s_clause 0x7
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v1, v[4:7], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v1, v[8:11], s[0:1] offset:112
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    v_mov_b32_e32 v32, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    global_load_u16 v0, v32, s[2:3]
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    v_readfirstlane_b32 s3, v0
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v28, s3
; GFX1210-NEXT:    s_lshr_b32 s2, s3, 14
; GFX1210-NEXT:    s_lshr_b32 s4, s3, 15
; GFX1210-NEXT:    s_lshr_b32 s10, s3, 10
; GFX1210-NEXT:    s_lshr_b32 s12, s3, 11
; GFX1210-NEXT:    s_lshr_b32 s6, s3, 12
; GFX1210-NEXT:    s_lshr_b32 s8, s3, 13
; GFX1210-NEXT:    s_lshr_b32 s14, s3, 8
; GFX1210-NEXT:    s_lshr_b32 s16, s3, 9
; GFX1210-NEXT:    s_lshr_b32 s18, s3, 6
; GFX1210-NEXT:    s_lshr_b32 s20, s3, 7
; GFX1210-NEXT:    s_lshr_b32 s22, s3, 4
; GFX1210-NEXT:    s_lshr_b32 s24, s3, 5
; GFX1210-NEXT:    s_lshr_b32 s26, s3, 2
; GFX1210-NEXT:    s_lshr_b32 s28, s3, 3
; GFX1210-NEXT:    s_lshr_b32 s30, s3, 1
; GFX1210-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
...
; GFX1210-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v5, s7
; GFX1210-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v7, s9
; GFX1210-NEXT:    v_dual_mov_b32 v12, s14 :: v_dual_mov_b32 v13, s15
; GFX1210-NEXT:    v_dual_mov_b32 v14, s16 :: v_dual_mov_b32 v15, s17
; GFX1210-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v17, s19
; GFX1210-NEXT:    v_dual_mov_b32 v18, s20 :: v_dual_mov_b32 v19, s21
; GFX1210-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v20, s22 :: v_dual_mov_b32 v21, s23
; GFX1210-NEXT:    v_dual_mov_b32 v22, s24 :: v_dual_mov_b32 v23, s25
; GFX1210-NEXT:    v_dual_mov_b32 v24, s26 :: v_dual_mov_b32 v25, s27
; GFX1210-NEXT:    v_dual_mov_b32 v26, s28 :: v_dual_mov_b32 v27, s29
; GFX1210-NEXT:    v_dual_mov_b32 v30, s30 :: v_dual_mov_b32 v31, s31
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v32, v[0:3], s[0:1] offset:112
; GFX1210-NEXT:    global_store_b128 v32, v[4:7], s[0:1] offset:96
; GFX1210-NEXT:    v_ashrrev_i32_e32 v29, 31, v28
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v32, v[8:11], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v32, v[12:15], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v32, v[16:19], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v32, v[20:23], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v32, v[24:27], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v32, v[28:31], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <16 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1001e
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s3
; GFX1210-NEXT:    s_lshr_b32 s4, s2, 31
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1001d
; GFX1210-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, v1
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1001c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:240
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1001a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:224
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10019
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10018
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:208
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10016
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10014
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10015
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v2, s4
...
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10010
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:144
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000e
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:128
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:112
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10008
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10006
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:64
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10005
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10004
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:48
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10002
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:32
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10001
...
; GFX1210-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_lshr_b32 s34, s2, 30
; GFX1210-NEXT:    s_lshr_b32 s36, s2, 31
; GFX1210-NEXT:    s_lshr_b32 s38, s2, 28
; GFX1210-NEXT:    s_lshr_b32 s40, s2, 29
; GFX1210-NEXT:    s_lshr_b32 s42, s2, 26
; GFX1210-NEXT:    s_lshr_b32 s44, s2, 27
; GFX1210-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s46, s2, 24
; GFX1210-NEXT:    s_lshr_b32 s48, s2, 25
; GFX1210-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v0, s34
; GFX1210-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v1, s35 :: v_dual_mov_b32 v2, s36
; GFX1210-NEXT:    v_dual_mov_b32 v3, s37 :: v_dual_mov_b32 v4, s38
; GFX1210-NEXT:    s_lshr_b32 s26, s2, 22
; GFX1210-NEXT:    s_lshr_b32 s50, s2, 23
; GFX1210-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s39 :: v_dual_mov_b32 v6, s40
; GFX1210-NEXT:    v_dual_mov_b32 v7, s41 :: v_dual_mov_b32 v8, s42
; GFX1210-NEXT:    s_lshr_b32 s52, s2, 20
; GFX1210-NEXT:    s_lshr_b32 s54, s2, 21
; GFX1210-NEXT:    v_dual_mov_b32 v9, s43 :: v_dual_mov_b32 v10, s44
; GFX1210-NEXT:    v_dual_mov_b32 v11, s45 :: v_dual_mov_b32 v12, s46
; GFX1210-NEXT:    s_lshr_b32 s56, s2, 18
; GFX1210-NEXT:    s_lshr_b32 s58, s2, 19
; GFX1210-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v13, s47 :: v_dual_mov_b32 v14, s48
; GFX1210-NEXT:    s_bfe_i64 s[26:27], s[26:27], 0x10000
; GFX1210-NEXT:    v_mov_b32_e32 v15, s49
; GFX1210-NEXT:    s_lshr_b32 s60, s2, 16
; GFX1210-NEXT:    s_lshr_b32 s62, s2, 17
; GFX1210-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s64, s2, 14
; GFX1210-NEXT:    s_lshr_b32 s66, s2, 15
; GFX1210-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1210-NEXT:    s_clause 0x3
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:240
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:224
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:208
; GFX1210-NEXT:    global_store_b128 v24, v[12:15], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v0, s26 :: v_dual_mov_b32 v1, s27
; GFX1210-NEXT:    v_dual_mov_b32 v2, s50 :: v_dual_mov_b32 v3, s51
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_mov_b32_e32 v4, s52
; GFX1210-NEXT:    s_lshr_b32 s30, s2, 12
; GFX1210-NEXT:    s_lshr_b32 s28, s2, 13
; GFX1210-NEXT:    s_lshr_b32 s24, s2, 10
; GFX1210-NEXT:    s_lshr_b32 s22, s2, 11
; GFX1210-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s53 :: v_dual_mov_b32 v6, s54
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v7, s55 :: v_dual_mov_b32 v8, s56
; GFX1210-NEXT:    s_lshr_b32 s20, s2, 8
; GFX1210-NEXT:    s_lshr_b32 s18, s2, 9
; GFX1210-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[64:65], s[64:65], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v9, s57 :: v_dual_mov_b32 v10, s58
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v11, s59 :: v_dual_mov_b32 v12, s60
; GFX1210-NEXT:    s_lshr_b32 s16, s2, 6
; GFX1210-NEXT:    s_lshr_b32 s14, s2, 7
; GFX1210-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v13, s61 :: v_dual_mov_b32 v14, s62
; GFX1210-NEXT:    v_dual_mov_b32 v15, s63 :: v_dual_mov_b32 v16, s64
; GFX1210-NEXT:    s_lshr_b32 s12, s2, 4
; GFX1210-NEXT:    s_lshr_b32 s10, s2, 5
; GFX1210-NEXT:    s_bfe_i64 s[18:19], s[18:19], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v17, s65 :: v_dual_mov_b32 v18, s66
; GFX1210-NEXT:    v_dual_mov_b32 v19, s67 :: v_dual_mov_b32 v20, s30
; GFX1210-NEXT:    s_lshr_b32 s8, s2, 2
; GFX1210-NEXT:    s_lshr_b32 s6, s2, 3
; GFX1210-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v21, s31 :: v_dual_mov_b32 v22, s28
; GFX1210-NEXT:    v_mov_b32_e32 v23, s29
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:160
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:144
...
; GFX1210-NEXT:    global_store_b128 v24, v[20:23], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s24 :: v_dual_mov_b32 v1, s25
; GFX1210-NEXT:    v_dual_mov_b32 v2, s22 :: v_dual_mov_b32 v3, s23
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_mov_b32_e32 v4, s20
; GFX1210-NEXT:    s_lshr_b32 s68, s2, 1
; GFX1210-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s21 :: v_dual_mov_b32 v6, s18
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v7, s19 :: v_dual_mov_b32 v8, s16
; GFX1210-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v9, s17 :: v_dual_mov_b32 v10, s14
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v11, s15 :: v_dual_mov_b32 v12, s12
; GFX1210-NEXT:    s_bfe_i64 s[4:5], s[2:3], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[2:3], s[68:69], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v13, s13 :: v_dual_mov_b32 v14, s10
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v15, s11 :: v_dual_mov_b32 v16, s8
; GFX1210-NEXT:    v_dual_mov_b32 v17, s9 :: v_dual_mov_b32 v18, s6
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v19, s7 :: v_dual_mov_b32 v20, s4
; GFX1210-NEXT:    v_dual_mov_b32 v21, s5 :: v_dual_mov_b32 v22, s2
; GFX1210-NEXT:    v_mov_b32_e32 v23, s3
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v24, v[4:7], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:48
...
; GFX1210-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10014
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GFX1210-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s4
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10015
; GFX1210-NEXT:    s_lshr_b32 s4, s3, 31
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v2, s5 :: v_dual_mov_b32 v3, v1
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1001e
; GFX1210-NEXT:    s_bfe_u32 s6, s2, 0x10004
; GFX1210-NEXT:    s_and_b32 s7, s2, 1
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:416
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x1001d
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1001c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:496
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1001a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:480
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10019
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10018
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:464
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10016
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:448
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10013
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10012
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:432
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10011
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10010
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:400
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1000e
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:384
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x1000d
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1000c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:368
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x1000a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:352
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10008
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:336
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10006
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:320
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10005
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10004
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:304
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s3, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10002
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:288
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_lshr_b32 s4, s2, 31
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1001e
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:272
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1001d
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1001c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:240
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1001b
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1001a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:224
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10019
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10018
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:208
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10017
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10016
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10014
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10015
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v2, s5
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10013
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10012
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:160
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
...
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000f
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1000e
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:128
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000d
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1000c
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:112
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x1000b
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x1000a
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10009
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10008
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_bfe_u32 s4, s2, 0x10007
; GFX1210-NEXT:    s_bfe_u32 s5, s2, 0x10006
; GFX1210-NEXT:    v_mov_b32_e32 v7, v1
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:64
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v2, s4
; GFX1210-NEXT:    s_mov_b32 s4, s3
; GFX1210-NEXT:    s_bfe_u32 s5, s3, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10005
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_mov_b32_e32 v6, s5
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:48
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_bfe_u32 s3, s2, 0x10003
; GFX1210-NEXT:    s_bfe_u32 s6, s2, 0x10001
; GFX1210-NEXT:    s_bfe_u32 s2, s2, 0x10002
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:32
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v2, s3
; GFX1210-NEXT:    s_and_b64 s[2:3], s[4:5], 1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v4, s2 :: v_dual_mov_b32 v5, s3
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:16
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v0, s7 :: v_dual_mov_b32 v2, s6
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v1, v[4:7], s[0:1] offset:256
; GFX1210-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <64 x i1>, ptr addrspace(4) %in
...
; GFX1210-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_load_b64 s[12:13], s[2:3], 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_lshr_b32 s96, s13, 30
; GFX1210-NEXT:    s_lshr_b32 s98, s13, 31
; GFX1210-NEXT:    s_lshr_b32 s92, s13, 28
; GFX1210-NEXT:    s_lshr_b32 s94, s13, 29
; GFX1210-NEXT:    s_lshr_b32 s78, s13, 26
; GFX1210-NEXT:    s_lshr_b32 s88, s13, 27
; GFX1210-NEXT:    s_bfe_i64 s[96:97], s[96:97], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[100:101], s[98:99], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s66, s13, 24
; GFX1210-NEXT:    s_lshr_b32 s74, s13, 25
; GFX1210-NEXT:    s_bfe_i64 s[92:93], s[92:93], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[94:95], s[94:95], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v0, s96
; GFX1210-NEXT:    s_lshr_b32 s56, s13, 22
; GFX1210-NEXT:    s_lshr_b32 s62, s13, 23
; GFX1210-NEXT:    v_dual_mov_b32 v1, s97 :: v_dual_mov_b32 v2, s100
; GFX1210-NEXT:    v_dual_mov_b32 v3, s101 :: v_dual_mov_b32 v4, s92
; GFX1210-NEXT:    s_bfe_i64 s[78:79], s[78:79], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[88:89], s[88:89], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s44, s13, 20
; GFX1210-NEXT:    s_lshr_b32 s52, s13, 21
; GFX1210-NEXT:    s_lshr_b32 s30, s13, 18
; GFX1210-NEXT:    s_lshr_b32 s40, s13, 19
; GFX1210-NEXT:    s_lshr_b32 s18, s13, 16
; GFX1210-NEXT:    s_lshr_b32 s26, s13, 17
; GFX1210-NEXT:    s_lshr_b32 s2, s13, 14
; GFX1210-NEXT:    s_lshr_b32 s4, s13, 15
; GFX1210-NEXT:    v_dual_mov_b32 v5, s93 :: v_dual_mov_b32 v6, s94
; GFX1210-NEXT:    v_dual_mov_b32 v7, s95 :: v_dual_mov_b32 v10, s78
; GFX1210-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[74:75], s[74:75], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s6, s13, 12
; GFX1210-NEXT:    s_lshr_b32 s8, s13, 13
; GFX1210-NEXT:    v_dual_mov_b32 v11, s79 :: v_dual_mov_b32 v12, s88
; GFX1210-NEXT:    v_dual_mov_b32 v13, s89 :: v_dual_mov_b32 v14, s66
; GFX1210-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[62:63], s[62:63], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s10, s13, 10
; GFX1210-NEXT:    s_lshr_b32 s14, s13, 11
; GFX1210-NEXT:    v_dual_mov_b32 v15, s67 :: v_dual_mov_b32 v16, s74
; GFX1210-NEXT:    v_dual_mov_b32 v17, s75 :: v_dual_mov_b32 v18, s56
; GFX1210-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x10000
...
; GFX1210-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s16, s13, 8
; GFX1210-NEXT:    s_lshr_b32 s20, s13, 9
; GFX1210-NEXT:    v_dual_mov_b32 v19, s57 :: v_dual_mov_b32 v20, s62
; GFX1210-NEXT:    v_dual_mov_b32 v21, s63 :: v_dual_mov_b32 v22, s44
; GFX1210-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
; GFX1210-NEXT:    s_lshr_b32 s22, s13, 6
; GFX1210-NEXT:    s_lshr_b32 s24, s13, 7
; GFX1210-NEXT:    v_dual_mov_b32 v23, s45 :: v_dual_mov_b32 v24, s52
; GFX1210-NEXT:    v_dual_mov_b32 v25, s53 :: v_dual_mov_b32 v26, s30
; GFX1210-NEXT:    v_dual_mov_b32 v27, s31 :: v_dual_mov_b32 v28, s40
; GFX1210-NEXT:    v_dual_mov_b32 v29, s41 :: v_dual_mov_b32 v30, s18
; GFX1210-NEXT:    v_dual_mov_b32 v31, s19 :: v_dual_mov_b32 v32, s26
; GFX1210-NEXT:    v_mov_b32_e32 v33, s27
; GFX1210-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
; GFX1210-NEXT:    s_clause 0x7
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:496
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:480
; GFX1210-NEXT:    global_store_b128 v8, v[10:13], s[0:1] offset:464
; GFX1210-NEXT:    global_store_b128 v8, v[14:17], s[0:1] offset:448
; GFX1210-NEXT:    global_store_b128 v8, v[18:21], s[0:1] offset:432
; GFX1210-NEXT:    global_store_b128 v8, v[22:25], s[0:1] offset:416
; GFX1210-NEXT:    global_store_b128 v8, v[26:29], s[0:1] offset:400
; GFX1210-NEXT:    global_store_b128 v8, v[30:33], s[0:1] offset:384
; GFX1210-NEXT:    s_wait_xcnt 0x7
; GFX1210-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s3
; GFX1210-NEXT:    v_dual_mov_b32 v2, s4 :: v_dual_mov_b32 v3, s5
; GFX1210-NEXT:    s_wait_xcnt 0x6
; GFX1210-NEXT:    v_mov_b32_e32 v4, s6
; GFX1210-NEXT:    s_lshr_b32 s28, s13, 4
; GFX1210-NEXT:    s_lshr_b32 s34, s13, 5
; GFX1210-NEXT:    s_lshr_b32 s36, s13, 2
; GFX1210-NEXT:    s_lshr_b32 s38, s13, 3
; GFX1210-NEXT:    s_bfe_i64 s[20:21], s[20:21], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s7 :: v_dual_mov_b32 v6, s8
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v7, s9 :: v_dual_mov_b32 v10, s10
; GFX1210-NEXT:    s_lshr_b32 s42, s13, 1
; GFX1210-NEXT:    s_mov_b32 s46, s13
; GFX1210-NEXT:    s_bfe_i64 s[24:25], s[24:25], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[22:23], s[22:23], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v11, s11 :: v_dual_mov_b32 v12, s14
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_dual_mov_b32 v13, s15 :: v_dual_mov_b32 v14, s16
; GFX1210-NEXT:    s_lshr_b32 s48, s12, 30
; GFX1210-NEXT:    s_lshr_b32 s50, s12, 31
; GFX1210-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[34:35], s[34:35], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v15, s17 :: v_dual_mov_b32 v16, s20
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v17, s21 :: v_dual_mov_b32 v18, s22
; GFX1210-NEXT:    s_lshr_b32 s54, s12, 28
; GFX1210-NEXT:    s_lshr_b32 s58, s12, 29
; GFX1210-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v19, s23 :: v_dual_mov_b32 v20, s24
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v21, s25 :: v_dual_mov_b32 v22, s28
; GFX1210-NEXT:    s_lshr_b32 s60, s12, 26
; GFX1210-NEXT:    s_lshr_b32 s64, s12, 27
; GFX1210-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v23, s29 :: v_dual_mov_b32 v24, s34
; GFX1210-NEXT:    v_mov_b32_e32 v25, s35
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:368
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:352
; GFX1210-NEXT:    global_store_b128 v8, v[10:13], s[0:1] offset:336
; GFX1210-NEXT:    global_store_b128 v8, v[14:17], s[0:1] offset:320
; GFX1210-NEXT:    global_store_b128 v8, v[18:21], s[0:1] offset:304
; GFX1210-NEXT:    global_store_b128 v8, v[22:25], s[0:1] offset:288
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s36 :: v_dual_mov_b32 v1, s37
; GFX1210-NEXT:    v_dual_mov_b32 v2, s38 :: v_dual_mov_b32 v3, s39
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_mov_b32_e32 v4, s46
; GFX1210-NEXT:    s_lshr_b32 s68, s12, 24
; GFX1210-NEXT:    s_lshr_b32 s70, s12, 25
; GFX1210-NEXT:    s_lshr_b32 s72, s12, 22
; GFX1210-NEXT:    s_lshr_b32 s76, s12, 23
; GFX1210-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s47 :: v_dual_mov_b32 v6, s42
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v7, s43 :: v_dual_mov_b32 v10, s48
; GFX1210-NEXT:    s_lshr_b32 s80, s12, 20
; GFX1210-NEXT:    s_lshr_b32 s82, s12, 21
; GFX1210-NEXT:    s_bfe_i64 s[64:65], s[64:65], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v11, s49 :: v_dual_mov_b32 v12, s50
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v13, s51 :: v_dual_mov_b32 v14, s54
; GFX1210-NEXT:    s_lshr_b32 s84, s12, 18
; GFX1210-NEXT:    s_lshr_b32 s86, s12, 19
; GFX1210-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[72:73], s[72:73], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[70:71], s[70:71], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[68:69], s[68:69], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v15, s55 :: v_dual_mov_b32 v16, s58
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v17, s59 :: v_dual_mov_b32 v18, s60
; GFX1210-NEXT:    s_lshr_b32 s90, s12, 16
; GFX1210-NEXT:    s_lshr_b32 s98, s12, 17
; GFX1210-NEXT:    s_bfe_i64 s[82:83], s[82:83], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[80:81], s[80:81], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v19, s61 :: v_dual_mov_b32 v20, s64
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v21, s65 :: v_dual_mov_b32 v22, s68
; GFX1210-NEXT:    s_lshr_b32 s96, s12, 14
; GFX1210-NEXT:    s_lshr_b32 s100, s12, 15
; GFX1210-NEXT:    s_lshr_b32 s94, s12, 13
; GFX1210-NEXT:    s_lshr_b32 s88, s12, 11
; GFX1210-NEXT:    s_lshr_b32 s74, s12, 9
; GFX1210-NEXT:    s_lshr_b32 s62, s12, 7
; GFX1210-NEXT:    s_lshr_b32 s52, s12, 5
; GFX1210-NEXT:    s_lshr_b32 s40, s12, 3
; GFX1210-NEXT:    s_lshr_b32 s26, s12, 1
; GFX1210-NEXT:    s_bfe_i64 s[86:87], s[86:87], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[84:85], s[84:85], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v23, s69 :: v_dual_mov_b32 v24, s70
; GFX1210-NEXT:    v_mov_b32_e32 v25, s71
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:272
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:256
; GFX1210-NEXT:    global_store_b128 v8, v[10:13], s[0:1] offset:240
; GFX1210-NEXT:    global_store_b128 v8, v[14:17], s[0:1] offset:224
; GFX1210-NEXT:    global_store_b128 v8, v[18:21], s[0:1] offset:208
; GFX1210-NEXT:    global_store_b128 v8, v[22:25], s[0:1] offset:192
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s72 :: v_dual_mov_b32 v1, s73
; GFX1210-NEXT:    v_dual_mov_b32 v2, s76 :: v_dual_mov_b32 v3, s77
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    v_mov_b32_e32 v4, s80
; GFX1210-NEXT:    s_lshr_b32 s92, s12, 12
; GFX1210-NEXT:    s_lshr_b32 s78, s12, 10
; GFX1210-NEXT:    s_bfe_i64 s[98:99], s[98:99], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s81 :: v_dual_mov_b32 v6, s82
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v7, s83 :: v_dual_mov_b32 v10, s84
; GFX1210-NEXT:    s_lshr_b32 s66, s12, 8
; GFX1210-NEXT:    s_lshr_b32 s56, s12, 6
; GFX1210-NEXT:    s_lshr_b32 s44, s12, 4
; GFX1210-NEXT:    s_lshr_b32 s30, s12, 2
; GFX1210-NEXT:    s_bfe_i64 s[18:19], s[12:13], 0x10000
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_bfe_i64 s[12:13], s[26:27], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[26:27], s[40:41], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[40:41], s[52:53], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[52:53], s[62:63], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[62:63], s[74:75], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[74:75], s[88:89], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[88:89], s[94:95], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[94:95], s[100:101], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[96:97], s[96:97], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v11, s85 :: v_dual_mov_b32 v12, s86
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    v_dual_mov_b32 v13, s87 :: v_dual_mov_b32 v14, s90
; GFX1210-NEXT:    s_bfe_i64 s[78:79], s[78:79], 0x10000
; GFX1210-NEXT:    s_bfe_i64 s[92:93], s[92:93], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v15, s91 :: v_dual_mov_b32 v16, s98
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v17, s99 :: v_dual_mov_b32 v18, s96
; GFX1210-NEXT:    s_bfe_i64 s[66:67], s[66:67], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v19, s97 :: v_dual_mov_b32 v20, s94
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v21, s95 :: v_dual_mov_b32 v22, s92
; GFX1210-NEXT:    s_bfe_i64 s[56:57], s[56:57], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v23, s93 :: v_dual_mov_b32 v24, s88
; GFX1210-NEXT:    v_mov_b32_e32 v25, s89
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:176
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:160
; GFX1210-NEXT:    global_store_b128 v8, v[10:13], s[0:1] offset:144
; GFX1210-NEXT:    global_store_b128 v8, v[14:17], s[0:1] offset:128
; GFX1210-NEXT:    global_store_b128 v8, v[18:21], s[0:1] offset:112
; GFX1210-NEXT:    global_store_b128 v8, v[22:25], s[0:1] offset:96
; GFX1210-NEXT:    s_wait_xcnt 0x5
; GFX1210-NEXT:    v_dual_mov_b32 v0, s78 :: v_dual_mov_b32 v1, s79
; GFX1210-NEXT:    v_dual_mov_b32 v2, s74 :: v_dual_mov_b32 v3, s75
; GFX1210-NEXT:    s_wait_xcnt 0x4
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_mov_b32_e32 v4, s66
; GFX1210-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v5, s67 :: v_dual_mov_b32 v6, s62
; GFX1210-NEXT:    s_wait_xcnt 0x3
; GFX1210-NEXT:    v_dual_mov_b32 v7, s63 :: v_dual_mov_b32 v10, s56
; GFX1210-NEXT:    s_bfe_i64 s[30:31], s[30:31], 0x10000
; GFX1210-NEXT:    v_dual_mov_b32 v11, s57 :: v_dual_mov_b32 v12, s52
; GFX1210-NEXT:    s_wait_xcnt 0x2
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    v_dual_mov_b32 v13, s53 :: v_dual_mov_b32 v14, s44
; GFX1210-NEXT:    v_dual_mov_b32 v15, s45 :: v_dual_mov_b32 v16, s40
; GFX1210-NEXT:    s_wait_xcnt 0x1
; GFX1210-NEXT:    v_dual_mov_b32 v17, s41 :: v_dual_mov_b32 v18, s30
; GFX1210-NEXT:    v_dual_mov_b32 v19, s31 :: v_dual_mov_b32 v20, s26
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    v_dual_mov_b32 v21, s27 :: v_dual_mov_b32 v22, s18
; GFX1210-NEXT:    v_dual_mov_b32 v23, s19 :: v_dual_mov_b32 v24, s12
; GFX1210-NEXT:    v_mov_b32_e32 v25, s13
; GFX1210-NEXT:    s_clause 0x5
; GFX1210-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:80
; GFX1210-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:64
; GFX1210-NEXT:    global_store_b128 v8, v[10:13], s[0:1] offset:48
; GFX1210-NEXT:    global_store_b128 v8, v[14:17], s[0:1] offset:32
; GFX1210-NEXT:    global_store_b128 v8, v[18:21], s[0:1] offset:16
; GFX1210-NEXT:    global_store_b128 v8, v[22:25], s[0:1]
; GFX1210-NEXT:    s_endpgm
  %load = load <64 x i1>, ptr addrspace(4) %in
