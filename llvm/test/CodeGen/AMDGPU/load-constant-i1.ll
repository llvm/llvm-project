...
; GFX1250-FAKE16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_lshrrev_b32 v3, 7, v0
...
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v8, s54 :: v_dual_mov_b32 v9, s22
; GFX1250-NEXT:    v_dual_mov_b32 v10, s53 :: v_dual_mov_b32 v11, s21
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v12, s51 :: v_dual_mov_b32 v13, s20
; GFX1250-NEXT:    v_mov_b32_e32 v14, s52
...
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v8, s43 :: v_dual_mov_b32 v9, s42
; GFX1250-NEXT:    v_dual_mov_b32 v10, s41 :: v_dual_mov_b32 v11, s40
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v12, s39 :: v_dual_mov_b32 v13, s38
; GFX1250-NEXT:    v_mov_b32_e32 v14, s37
...
; GFX1250-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24 nv
; GFX1250-TRUE16-NEXT:    v_mov_b32_e32 v3, 0
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
...
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s4, s2, 0x10002
; GFX1250-TRUE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v2, s4
; GFX1250-TRUE16-NEXT:    global_store_b128 v3, v[2:5], s[0:1] offset:16
; GFX1250-TRUE16-NEXT:    s_bfe_u32 s2, s2, 0x10001
; GFX1250-TRUE16-NEXT:    s_wait_xcnt 0x0
; GFX1250-TRUE16-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_bitop2_b32 v0, 1, v0 bitop3:0x40
...
; GFX1250-NEXT:    v_mov_b32_e32 v31, s31
; GFX1250-NEXT:    s_clause 0x5
...
; GFX1250-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, s4
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v2, s3 :: v_dual_mov_b32 v0, s4
...
; GFX1250-NEXT:    s_and_b32 s2, s2, 1
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v2, s3 :: v_dual_mov_b32 v0, s2
...
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v4, s52 :: v_dual_mov_b32 v5, s53
; GFX1250-NEXT:    v_dual_mov_b32 v6, s54 :: v_dual_mov_b32 v7, s55
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v8, s56 :: v_dual_mov_b32 v9, s57
; GFX1250-NEXT:    v_mov_b32_e32 v10, s58
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s20 :: v_dual_mov_b32 v5, s21
; GFX1250-NEXT:    v_dual_mov_b32 v6, s18 :: v_dual_mov_b32 v7, s19
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v8, s16 :: v_dual_mov_b32 v9, s17
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v2, s5
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v2, s7
...
; GFX1250-NEXT:    s_bfe_u32 s4, s2, 0x10016
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v2, s4
...
; GFX1250-NEXT:    s_and_b32 s2, s2, 1
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v2, s2
...
; GFX1250-NEXT:    v_dual_mov_b32 v15, s61 :: v_dual_mov_b32 v12, s72
...
; GFX1250-NEXT:    v_mov_b32_e32 v11, s87
; GFX1250-NEXT:    s_clause 0x1
...
; GFX1250-NEXT:    v_dual_mov_b32 v18, s54 :: v_dual_mov_b32 v19, s55
; GFX1250-NEXT:    v_mov_b32_e32 v20, s42
; GFX1250-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x10000
...
; GFX1250-NEXT:    v_mov_b32_e32 v32, s2
; GFX1250-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[16:17], s[16:17], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x10000
...
; GFX1250-NEXT:    v_dual_mov_b32 v7, s13 :: v_dual_mov_b32 v31, s25
; GFX1250-NEXT:    s_clause 0x5
...
; GFX1250-NEXT:    v_dual_mov_b32 v16, s22 :: v_dual_mov_b32 v17, s23
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v18, s26 :: v_dual_mov_b32 v19, s27
; GFX1250-NEXT:    v_mov_b32_e32 v20, s30
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s48 :: v_dual_mov_b32 v5, s49
; GFX1250-NEXT:    v_dual_mov_b32 v6, s46 :: v_dual_mov_b32 v7, s47
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v10, s52 :: v_dual_mov_b32 v11, s53
; GFX1250-NEXT:    v_mov_b32_e32 v12, s56
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s82 :: v_dual_mov_b32 v5, s83
; GFX1250-NEXT:    v_dual_mov_b32 v6, s84 :: v_dual_mov_b32 v7, s85
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v10, s88 :: v_dual_mov_b32 v11, s89
; GFX1250-NEXT:    v_mov_b32_e32 v12, s92
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_mov_b32_e32 v24, s86
; GFX1250-NEXT:    s_bfe_i64 s[72:73], s[72:73], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[76:77], s[76:77], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[90:91], s[90:91], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[60:61], s[60:61], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v21, s97 :: v_dual_mov_b32 v22, s90
; GFX1250-NEXT:    v_dual_mov_b32 v23, s91 :: v_dual_mov_b32 v25, s87
; GFX1250-NEXT:    s_clause 0x5
...
; GFX1250-NEXT:    s_wait_xcnt 0x4
; GFX1250-NEXT:    v_dual_mov_b32 v4, s64 :: v_dual_mov_b32 v5, s65
; GFX1250-NEXT:    v_dual_mov_b32 v6, s60 :: v_dual_mov_b32 v7, s61
; GFX1250-NEXT:    s_wait_xcnt 0x3
; GFX1250-NEXT:    v_dual_mov_b32 v10, s54 :: v_dual_mov_b32 v11, s55
; GFX1250-NEXT:    s_wait_xcnt 0x2
; GFX1250-NEXT:    v_dual_mov_b32 v12, s50 :: v_dual_mov_b32 v16, s38
; GFX1250-NEXT:    s_wait_xcnt 0x1
; GFX1250-NEXT:    v_dual_mov_b32 v20, s24 :: v_dual_mov_b32 v21, s25
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    v_dual_mov_b32 v22, s16 :: v_dual_mov_b32 v23, s17
; GFX1250-NEXT:    v_dual_mov_b32 v24, s4 :: v_dual_mov_b32 v25, s5
; GFX1250-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x10000
; GFX1250-NEXT:    s_bfe_i64 s[28:29], s[28:29], 0x10000
; GFX1250-NEXT:    v_dual_mov_b32 v13, s51 :: v_dual_mov_b32 v14, s42
; GFX1250-NEXT:    v_dual_mov_b32 v15, s43 :: v_dual_mov_b32 v17, s39
; GFX1250-NEXT:    v_dual_mov_b32 v18, s28 :: v_dual_mov_b32 v19, s29
; GFX1250-NEXT:    s_clause 0x5
