...
; GFX9-NEXT:    v_fma_f16 v2, -v3, v2, v1
...
; GFX10-NEXT:    v_fma_f16 v2, -v3, v2, v1
; GFX10-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; GFX11-NEXT:    v_fma_f16 v2, -v3, v2, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; GFX1150-NEXT:    v_fma_f16 v2, v3, v2, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; GFX9-NEXT:    v_fma_f32 v2, -v3, v2, v1
; GFX9-NEXT:    v_bfi_b32 v1, s0, v2, v1
...
; GFX10-NEXT:    v_fma_f32 v2, -v3, v2, v1
; GFX10-NEXT:    v_bfi_b32 v1, 0x7fffffff, v2, v1
...
; GFX11-NEXT:    v_fma_f32 v2, -v3, v2, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fffffff, v2, v1
...
; GFX1150-NEXT:    v_fma_f32 v2, v3, v2, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fffffff, v2, v1
...
; CI-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; CI-NEXT:    v_bfi_b32 v3, s0, v3, v1
; CI-NEXT:    buffer_store_dwordx2 v[2:3], off, s[8:11], 0
; CI-NEXT:    s_endpgm
;
; VI-LABEL: frem_f64:
; VI:       ; %bb.0:
...
; VI-NEXT:    v_fma_f64 v[4:5], -v[6:7], v[4:5], v[2:3]
; VI-NEXT:    v_bfi_b32 v5, s0, v5, v3
...
; GFX9-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX9-NEXT:    v_bfi_b32 v3, s0, v3, v1
; GFX9-NEXT:    global_store_dwordx2 v12, v[2:3], s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX10-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX10-NEXT:    global_store_dwordx2 v12, v[2:3], s[4:5]
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX11-NEXT:    global_store_b64 v12, v[2:3], s[4:5]
; GFX11-NEXT:    s_nop 0
; GFX11-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-NEXT:    s_endpgm
;
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX1150-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX1150-NEXT:    global_store_b64 v12, v[2:3], s[4:5]
; GFX1150-NEXT:    s_nop 0
; GFX1150-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1150-NEXT:    s_endpgm
                      ptr addrspace(1) %in2) #0 {
...
; GFX9-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX9-NEXT:    v_bfi_b32 v3, s0, v3, v1
; GFX9-NEXT:    global_store_dwordx2 v10, v[2:3], s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX10-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX10-NEXT:    global_store_dwordx2 v10, v[2:3], s[4:5]
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX11-NEXT:    global_store_b64 v10, v[2:3], s[4:5]
; GFX11-NEXT:    s_nop 0
; GFX11-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-NEXT:    s_endpgm
;
...
; GFX1150-NEXT:    v_fma_f64 v[2:3], -v[4:5], v[2:3], v[0:1]
; GFX1150-NEXT:    v_bfi_b32 v3, 0x7fffffff, v3, v1
; GFX1150-NEXT:    global_store_b64 v10, v[2:3], s[4:5]
; GFX1150-NEXT:    s_nop 0
; GFX1150-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1150-NEXT:    s_endpgm
                             ptr addrspace(1) %in2) #1 {
...
; SI-NEXT:    v_fma_f32 v2, -v4, v2, v0
; SI-NEXT:    s_brev_b32 s6, -2
; SI-NEXT:    v_bfi_b32 v0, s6, v2, v0
; SI-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; SI-NEXT:    v_cvt_f16_f32_e32 v0, v0
...
; SI-NEXT:    v_trunc_f32_e32 v2, v2
; SI-NEXT:    v_fma_f32 v2, -v2, v3, v1
; SI-NEXT:    v_bfi_b32 v1, s6, v2, v1
...
; CI-NEXT:    v_fma_f32 v2, -v4, v2, v0
; CI-NEXT:    v_div_scale_f32 v4, s[4:5], v3, v3, v1
; CI-NEXT:    v_bfi_b32 v0, s6, v2, v0
...
; CI-NEXT:    v_trunc_f32_e32 v2, v2
; CI-NEXT:    v_fma_f32 v2, -v2, v3, v1
; CI-NEXT:    v_bfi_b32 v1, s6, v2, v1
...
; VI-NEXT:    v_div_fixup_f16 v3, v3, v2, v4
; VI-NEXT:    v_trunc_f16_e32 v3, v3
; VI-NEXT:    v_fma_f16 v3, -v3, v2, v4
; VI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v2
; VI-NEXT:    v_bfi_b32 v3, s0, v3, v4
...
; GFX9-NEXT:    v_fma_f16 v2, -v4, v2, v1
; GFX9-NEXT:    v_bfi_b32 v1, s0, v2, v1
...
; GFX10-NEXT:    v_bfi_b32 v3, 0x7fff, v3, v1
...
; GFX10-NEXT:    v_fma_f16 v2, -v4, v2, v1
; GFX10-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fff, v3, v1
...
; GFX11-NEXT:    v_fma_f16 v2, -v4, v2, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; GFX1150-NEXT:    v_fma_f16 v3, v4, v3, v5
; GFX1150-NEXT:    v_cvt_f32_f16_e32 v4, v2
; GFX1150-NEXT:    v_bfi_b32 v3, 0x7fff, v3, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1150-NEXT:    v_rcp_f32_e32 v4, v4
; GFX1150-NEXT:    v_fma_mixlo_f16 v4, v1, v4, 0 op_sel_hi:[1,0,0]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_div_fixup_f16 v4, v4, v2, v1
; GFX1150-NEXT:    v_trunc_f16_e32 v4, v4
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_xor_b32_e32 v4, 0x8000, v4
; GFX1150-NEXT:    v_fma_f16 v2, v4, v2, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fff, v2, v1
...
; SI-NEXT:    v_fma_f32 v5, -v5, v7, v4
; SI-NEXT:    v_bfi_b32 v4, s6, v5, v4
...
; SI-NEXT:    v_fma_f32 v3, -v3, v6, v2
; SI-NEXT:    v_bfi_b32 v2, s6, v3, v2
...
; CI-NEXT:    v_fma_f32 v5, -v5, v7, v4
; CI-NEXT:    v_bfi_b32 v4, s6, v5, v4
...
; CI-NEXT:    v_fma_f32 v3, -v3, v6, v2
; CI-NEXT:    v_bfi_b32 v2, s6, v3, v2
...
; VI-NEXT:    v_fma_f16 v5, -v7, v5, v3
; VI-NEXT:    v_bfi_b32 v3, s0, v5, v3
...
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v4
; VI-NEXT:    v_cvt_f32_f16_e32 v5, v2
; VI-NEXT:    v_rcp_f32_e32 v6, v6
; VI-NEXT:    v_mul_f32_e32 v5, v5, v6
; VI-NEXT:    v_cvt_f16_f32_e32 v5, v5
; VI-NEXT:    v_div_fixup_f16 v5, v5, v4, v2
; VI-NEXT:    v_trunc_f16_e32 v5, v5
; VI-NEXT:    v_fma_f16 v5, -v5, v4, v2
; VI-NEXT:    v_lshrrev_b32_e32 v4, 16, v4
; VI-NEXT:    v_cvt_f32_f16_e32 v7, v4
; VI-NEXT:    v_bfi_b32 v5, s0, v5, v2
; VI-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v2
; VI-NEXT:    v_rcp_f32_e32 v7, v7
; VI-NEXT:    v_mul_f32_e32 v6, v6, v7
...
; VI-NEXT:    v_trunc_f16_e32 v6, v6
; VI-NEXT:    v_fma_f16 v4, -v6, v4, v2
; VI-NEXT:    v_bfi_b32 v2, s0, v4, v2
; VI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_or_b32_sdwa v2, v5, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_bfi_b32 v5, s0, v5, v1
...
; GFX9-NEXT:    v_fma_f16 v3, -v6, v3, v1
; GFX9-NEXT:    v_bfi_b32 v1, s0, v3, v1
; GFX9-NEXT:    v_cvt_f32_f16_e32 v3, v2
...
; GFX10-NEXT:    v_bfi_b32 v5, 0x7fff, v5, v1
...
; GFX10-NEXT:    v_fma_f16 v3, -v6, v3, v1
; GFX10-NEXT:    v_bfi_b32 v1, 0x7fff, v3, v1
; GFX10-NEXT:    v_cvt_f32_f16_e32 v3, v2
...
; GFX10-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX10-NEXT:    v_bfi_b32 v3, 0x7fff, v3, v0
...
; GFX10-NEXT:    v_trunc_f16_e32 v5, v5
; GFX10-NEXT:    v_fma_f16 v2, -v5, v2, v0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_bfi_b32 v5, 0x7fff, v5, v1
...
; GFX11-NEXT:    v_fma_f16 v3, -v6, v3, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fff, v3, v1
; GFX11-NEXT:    v_cvt_f32_f16_e32 v3, v2
...
; GFX11-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fff, v3, v0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_trunc_f16_e32 v5, v5
; GFX11-NEXT:    v_fma_f16 v2, -v5, v2, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_fma_f16 v5, v6, v5, v7
; GFX1150-NEXT:    v_cvt_f32_f16_e32 v6, v2
; GFX1150-NEXT:    v_bfi_b32 v5, 0x7fff, v5, v7
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1150-NEXT:    v_rcp_f32_e32 v6, v6
; GFX1150-NEXT:    v_fma_mixlo_f16 v6, v0, v6, 0 op_sel_hi:[1,0,0]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_div_fixup_f16 v6, v6, v2, v0
; GFX1150-NEXT:    v_trunc_f16_e32 v6, v6
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_xor_b32_e32 v6, 0x8000, v6
; GFX1150-NEXT:    v_fma_f16 v2, v6, v2, v0
; GFX1150-NEXT:    v_lshrrev_b32_e32 v6, 16, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_bfi_b32 v0, 0x7fff, v2, v0
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_fma_f16 v2, v5, v2, v6
; GFX1150-NEXT:    v_cvt_f32_f16_e32 v5, v3
; GFX1150-NEXT:    v_bfi_b32 v2, 0x7fff, v2, v6
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1150-NEXT:    v_rcp_f32_e32 v5, v5
; GFX1150-NEXT:    v_fma_mixlo_f16 v5, v1, v5, 0 op_sel_hi:[1,0,0]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_div_fixup_f16 v5, v5, v3, v1
; GFX1150-NEXT:    v_trunc_f16_e32 v5, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_xor_b32_e32 v5, 0x8000, v5
; GFX1150-NEXT:    v_fma_f16 v3, v5, v3, v1
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fff, v3, v1
...
; SI-NEXT:    v_trunc_f32_e32 v4, v4
; SI-NEXT:    v_fma_f32 v3, -v4, v3, v1
; SI-NEXT:    s_brev_b32 s6, -2
; SI-NEXT:    v_bfi_b32 v1, s6, v3, v1
...
; CI-NEXT:    v_trunc_f32_e32 v4, v4
; CI-NEXT:    v_fma_f32 v3, -v4, v3, v1
; CI-NEXT:    v_div_scale_f32 v4, s[4:5], v2, v2, v0
; CI-NEXT:    v_bfi_b32 v1, s6, v3, v1
...
; VI-NEXT:    v_fma_f32 v5, -v6, v5, v3
; VI-NEXT:    v_div_scale_f32 v6, s[0:1], v4, v4, v2
; VI-NEXT:    v_bfi_b32 v3, s2, v5, v3
...
; VI-NEXT:    v_fma_f32 v4, -v5, v4, v2
; VI-NEXT:    v_bfi_b32 v2, s2, v4, v2
; VI-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_fma_f32 v3, -v5, v3, v1
...
; GFX9-NEXT:    v_trunc_f32_e32 v3, v3
; GFX9-NEXT:    v_fma_f32 v2, -v3, v2, v0
; GFX9-NEXT:    v_bfi_b32 v0, s2, v2, v0
; GFX9-NEXT:    global_store_dwordx2 v4, v[0:1], s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_fma_f32 v3, -v5, v3, v1
...
; GFX10-NEXT:    v_trunc_f32_e32 v3, v3
; GFX10-NEXT:    v_fma_f32 v2, -v3, v2, v0
...
; GFX11-NEXT:    v_fma_f32 v3, -v5, v3, v1
; GFX11-NEXT:    v_div_scale_f32 v5, null, v2, v2, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fffffff, v3, v1
...
; GFX11-NEXT:    v_trunc_f32_e32 v3, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fma_f32 v2, -v3, v2, v0
...
; GFX1150-NEXT:    v_fma_f32 v3, v5, v3, v1
...
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fffffff, v3, v1
...
; GFX1150-NEXT:    v_xor_b32_e32 v3, 0x80000000, v3
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f32 v2, v3, v2, v0
; GFX1150-NEXT:    v_bfi_b32 v0, 0x7fffffff, v2, v0
; GFX1150-NEXT:    global_store_b64 v4, v[0:1], s[4:5]
; GFX1150-NEXT:    s_nop 0
; GFX1150-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1150-NEXT:    s_endpgm
...
; SI-NEXT:    v_trunc_f32_e32 v8, v8
; SI-NEXT:    v_fma_f32 v7, -v8, v7, v3
; SI-NEXT:    s_brev_b32 s6, -2
; SI-NEXT:    v_bfi_b32 v3, s6, v7, v3
...
; SI-NEXT:    v_fma_f32 v6, -v7, v6, v2
; SI-NEXT:    v_bfi_b32 v2, s6, v6, v2
...
; SI-NEXT:    v_fma_f32 v5, -v6, v5, v1
; SI-NEXT:    v_bfi_b32 v1, s6, v5, v1
...
; SI-NEXT:    v_trunc_f32_e32 v5, v5
; SI-NEXT:    v_fma_f32 v4, -v5, v4, v0
; SI-NEXT:    v_bfi_b32 v0, s6, v4, v0
...
; CI-NEXT:    v_trunc_f32_e32 v8, v8
; CI-NEXT:    v_fma_f32 v7, -v8, v7, v3
; CI-NEXT:    v_div_scale_f32 v8, s[4:5], v6, v6, v2
; CI-NEXT:    v_bfi_b32 v3, s6, v7, v3
...
; CI-NEXT:    v_fma_f32 v6, -v7, v6, v2
; CI-NEXT:    v_div_scale_f32 v7, s[4:5], v5, v5, v1
; CI-NEXT:    v_bfi_b32 v2, s6, v6, v2
...
; CI-NEXT:    v_fma_f32 v5, -v6, v5, v1
; CI-NEXT:    v_div_scale_f32 v6, s[4:5], v4, v4, v0
; CI-NEXT:    v_bfi_b32 v1, s6, v5, v1
...
; CI-NEXT:    v_trunc_f32_e32 v5, v5
; CI-NEXT:    v_fma_f32 v4, -v5, v4, v0
; CI-NEXT:    v_bfi_b32 v0, s6, v4, v0
...
; VI-NEXT:    v_fma_f32 v7, -v10, v7, v3
; VI-NEXT:    v_div_scale_f32 v10, s[0:1], v6, v6, v2
; VI-NEXT:    v_bfi_b32 v3, s2, v7, v3
...
; VI-NEXT:    v_fma_f32 v6, -v7, v6, v2
; VI-NEXT:    v_div_scale_f32 v7, s[0:1], v5, v5, v1
; VI-NEXT:    v_bfi_b32 v2, s2, v6, v2
...
; VI-NEXT:    v_trunc_f32_e32 v6, v6
; VI-NEXT:    v_fma_f32 v5, -v6, v5, v1
; VI-NEXT:    v_div_scale_f32 v6, s[0:1], v4, v4, v0
; VI-NEXT:    v_bfi_b32 v1, s2, v5, v1
...
; VI-NEXT:    v_trunc_f32_e32 v5, v5
; VI-NEXT:    v_fma_f32 v4, -v5, v4, v0
; VI-NEXT:    v_bfi_b32 v0, s2, v4, v0
...
; GFX9-NEXT:    v_fma_f32 v7, -v9, v7, v3
; GFX9-NEXT:    v_div_scale_f32 v9, s[0:1], v6, v6, v2
; GFX9-NEXT:    v_bfi_b32 v3, s2, v7, v3
...
; GFX9-NEXT:    v_fma_f32 v6, -v7, v6, v2
; GFX9-NEXT:    v_div_scale_f32 v7, s[0:1], v5, v5, v1
; GFX9-NEXT:    v_bfi_b32 v2, s2, v6, v2
...
; GFX9-NEXT:    v_fma_f32 v5, -v6, v5, v1
; GFX9-NEXT:    v_div_scale_f32 v6, s[0:1], v4, v4, v0
; GFX9-NEXT:    v_bfi_b32 v1, s2, v5, v1
...
; GFX9-NEXT:    v_trunc_f32_e32 v5, v5
; GFX9-NEXT:    v_fma_f32 v4, -v5, v4, v0
...
; GFX10-NEXT:    v_fma_f32 v7, -v9, v7, v3
; GFX10-NEXT:    v_div_scale_f32 v9, s0, v6, v6, v2
; GFX10-NEXT:    v_bfi_b32 v3, 0x7fffffff, v7, v3
...
; GFX10-NEXT:    v_fma_f32 v6, -v7, v6, v2
; GFX10-NEXT:    v_div_scale_f32 v7, s0, v5, v5, v1
; GFX10-NEXT:    v_bfi_b32 v2, 0x7fffffff, v6, v2
...
; GFX10-NEXT:    v_fma_f32 v5, -v6, v5, v1
...
; GFX10-NEXT:    v_trunc_f32_e32 v5, v5
; GFX10-NEXT:    v_fma_f32 v4, -v5, v4, v0
...
; GFX11-NEXT:    v_fma_f32 v7, -v9, v7, v3
; GFX11-NEXT:    v_div_scale_f32 v9, null, v6, v6, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fffffff, v7, v3
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_fma_f32 v6, -v7, v6, v2
; GFX11-NEXT:    v_div_scale_f32 v7, null, v5, v5, v1
; GFX11-NEXT:    v_bfi_b32 v2, 0x7fffffff, v6, v2
...
; GFX11-NEXT:    v_fma_f32 v5, -v6, v5, v1
...
; GFX11-NEXT:    v_trunc_f32_e32 v5, v5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fma_f32 v4, -v5, v4, v0
...
; GFX1150-NEXT:    v_fma_f32 v7, v9, v7, v3
; GFX1150-NEXT:    v_div_scale_f32 v9, null, v6, v6, v2
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_bfi_b32 v3, 0x7fffffff, v7, v3
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_fma_f32 v6, v7, v6, v2
; GFX1150-NEXT:    v_div_scale_f32 v7, null, v5, v5, v1
; GFX1150-NEXT:    v_bfi_b32 v2, 0x7fffffff, v6, v2
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(TRANS32_DEP_1)
...
; GFX1150-NEXT:    v_fma_f32 v5, v6, v5, v1
; GFX1150-NEXT:    v_div_scale_f32 v6, null, v4, v4, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1150-NEXT:    v_bfi_b32 v1, 0x7fffffff, v5, v1
; GFX1150-NEXT:    v_rcp_f32_e32 v7, v6
...
; GFX1150-NEXT:    v_xor_b32_e32 v5, 0x80000000, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f32 v4, v5, v4, v0
; GFX1150-NEXT:    v_bfi_b32 v0, 0x7fffffff, v4, v0
...
; SI-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; SI-NEXT:    s_brev_b32 s8, -2
; SI-NEXT:    v_bfi_b32 v7, s8, v7, v3
; SI-NEXT:    v_div_scale_f64 v[2:3], s[0:1], v[4:5], v[4:5], v[0:1]
; SI-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; SI-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
...
; SI-NEXT:    v_fma_f64 v[14:15], -v[2:3], v[12:13], v[10:11]
; SI-NEXT:    v_cmp_eq_u32_e32 vcc, v5, v3
; SI-NEXT:    v_cmp_eq_u32_e64 s[0:1], v1, v11
; SI-NEXT:    s_xor_b64 vcc, s[0:1], vcc
; SI-NEXT:    s_nop 1
; SI-NEXT:    v_div_fmas_f64 v[2:3], v[14:15], v[8:9], v[12:13]
; SI-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
...
; SI-NEXT:    v_and_b32_e32 v8, v2, v8
; SI-NEXT:    v_not_b32_e32 v9, s1
; SI-NEXT:    v_and_b32_e32 v3, v3, v9
...
; SI-NEXT:    v_cndmask_b32_e32 v3, v3, v9, vcc
; SI-NEXT:    s_cmp_gt_i32 s10, 51
; SI-NEXT:    s_cselect_b64 vcc, -1, 0
; SI-NEXT:    v_mov_b32_e32 v9, s9
; SI-NEXT:    v_cndmask_b32_e32 v3, v3, v9, vcc
; SI-NEXT:    v_cndmask_b32_e32 v2, v8, v2, vcc
; SI-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; SI-NEXT:    v_bfi_b32 v5, s8, v5, v1
...
; CI-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; CI-NEXT:    v_bfi_b32 v7, s6, v7, v3
; CI-NEXT:    v_div_scale_f64 v[2:3], s[4:5], v[4:5], v[4:5], v[0:1]
; CI-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; CI-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
...
; CI-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[12:13], v[10:11]
; CI-NEXT:    s_nop 1
; CI-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[8:9], v[12:13]
; CI-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; CI-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; CI-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; CI-NEXT:    v_bfi_b32 v5, s6, v5, v1
; CI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0
; CI-NEXT:    s_endpgm
;
; VI-LABEL: frem_v2f64:
; VI:       ; %bb.0:
...
; VI-NEXT:    v_fma_f64 v[6:7], -v[10:11], v[6:7], v[2:3]
; VI-NEXT:    v_bfi_b32 v7, s2, v7, v3
; VI-NEXT:    v_div_scale_f64 v[2:3], s[0:1], v[4:5], v[4:5], v[0:1]
...
; VI-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[14:15], v[12:13]
; VI-NEXT:    s_nop 1
; VI-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[10:11], v[14:15]
; VI-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; VI-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; VI-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
...
; GFX9-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; GFX9-NEXT:    v_bfi_b32 v7, s2, v7, v3
; GFX9-NEXT:    v_div_scale_f64 v[2:3], s[0:1], v[4:5], v[4:5], v[0:1]
; GFX9-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; GFX9-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
...
; GFX9-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[12:13], v[10:11]
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[8:9], v[12:13]
; GFX9-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; GFX9-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; GFX9-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; GFX9-NEXT:    v_bfi_b32 v5, s2, v5, v1
; GFX9-NEXT:    global_store_dwordx4 v16, v[4:7], s[4:5]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; GFX10-NEXT:    v_bfi_b32 v7, 0x7fffffff, v7, v3
; GFX10-NEXT:    v_div_scale_f64 v[2:3], s0, v[4:5], v[4:5], v[0:1]
; GFX10-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; GFX10-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
...
; GFX10-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[12:13], v[10:11]
; GFX10-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[8:9], v[12:13]
; GFX10-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; GFX10-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; GFX10-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; GFX10-NEXT:    v_bfi_b32 v5, 0x7fffffff, v5, v1
; GFX10-NEXT:    global_store_dwordx4 v16, v[4:7], s[4:5]
; GFX10-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v7, 0x7fffffff, v7, v3
; GFX11-NEXT:    v_div_scale_f64 v[2:3], null, v[4:5], v[4:5], v[0:1]
; GFX11-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[12:13], v[10:11]
; GFX11-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[8:9], v[12:13]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; GFX11-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; GFX11-NEXT:    v_bfi_b32 v5, 0x7fffffff, v5, v1
; GFX11-NEXT:    global_store_b128 v16, v[4:7], s[4:5]
; GFX11-NEXT:    s_nop 0
; GFX11-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX11-NEXT:    s_endpgm
;
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f64 v[6:7], -v[8:9], v[6:7], v[2:3]
; GFX1150-NEXT:    v_bfi_b32 v7, 0x7fffffff, v7, v3
; GFX1150-NEXT:    v_div_scale_f64 v[2:3], null, v[4:5], v[4:5], v[0:1]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1150-NEXT:    v_rcp_f64_e32 v[8:9], v[2:3]
; GFX1150-NEXT:    v_fma_f64 v[10:11], -v[2:3], v[8:9], 1.0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f64 v[2:3], -v[2:3], v[12:13], v[10:11]
; GFX1150-NEXT:    v_div_fmas_f64 v[2:3], v[2:3], v[8:9], v[12:13]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_div_fixup_f64 v[2:3], v[2:3], v[4:5], v[0:1]
; GFX1150-NEXT:    v_trunc_f64_e32 v[2:3], v[2:3]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_f64 v[4:5], -v[2:3], v[4:5], v[0:1]
; GFX1150-NEXT:    v_bfi_b32 v5, 0x7fffffff, v5, v1
; GFX1150-NEXT:    global_store_b128 v16, v[4:7], s[4:5]
; GFX1150-NEXT:    s_nop 0
; GFX1150-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1150-NEXT:    s_endpgm
                        ptr addrspace(1) %in2) #0 {
