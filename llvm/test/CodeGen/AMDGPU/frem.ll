...
; SI-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v9
...
; SI-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:64
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_div_scale_f64 v[8:9], s[4:5], v[6:7], v[6:7], v[2:3]
...
; SI-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[10:11], 1.0
; SI-NEXT:    v_fma_f64 v[10:11], v[10:11], v[12:13], v[10:11]
; SI-NEXT:    v_div_scale_f64 v[12:13], s[4:5], v[2:3], v[6:7], v[2:3]
...
; SI-NEXT:    s_bfe_u32 s4, s8, 0xb0014
; SI-NEXT:    s_add_i32 s9, s4, 0xfffffc01
; SI-NEXT:    s_mov_b32 s5, 0xfffff
; SI-NEXT:    s_mov_b32 s4, s2
; SI-NEXT:    s_lshr_b64 s[6:7], s[4:5], s9
; SI-NEXT:    v_not_b32_e32 v10, s6
; SI-NEXT:    v_and_b32_e32 v10, v8, v10
; SI-NEXT:    v_not_b32_e32 v11, s7
; SI-NEXT:    v_and_b32_e32 v9, v9, v11
; SI-NEXT:    s_and_b32 s6, s8, 0x80000000
...
; SI-NEXT:    s_lshr_b64 s[4:5], s[4:5], s7
; SI-NEXT:    v_not_b32_e32 v8, s4
; SI-NEXT:    v_and_b32_e32 v8, v6, v8
; SI-NEXT:    v_not_b32_e32 v9, s5
