...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v7, v3
; GFX11-NEXT:    v_frexp_mant_f32_e32 v3, v3
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v8, v2
...
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v7, v5 :: v_dual_add_nc_u32 v4, -11, v4
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX11-NEXT:    v_add_nc_u32_e32 v4, -10, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v4, 0x7fff, v2, v0
; GFX11-NEXT:  .LBB0_8: ; %Flow19
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v1
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v0|
...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v6, v2
...
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v6, v4 :: v_dual_add_nc_u32 v3, -11, v3
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v4, v4, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB1_5
; GFX11-NEXT:  ; %bb.6: ; %Flow
; GFX11-NEXT:    v_mov_b32_e32 v4, v6
; GFX11-NEXT:  .LBB1_7: ; %frem.loop_exit
; GFX11-NEXT:    v_add_nc_u32_e32 v3, -10, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fff, v1, v0
...
; GFX11-NEXT:    v_ldexp_f32 v6, v3, 11
; GFX11-NEXT:    v_frexp_mant_f32_e32 v3, v2
...
; GFX11-NEXT:    s_waitcnt_depctr 0xfff
; GFX11-NEXT:    v_dual_mul_f32 v6, v7, v4 :: v_dual_add_nc_u32 v5, -11, v5
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v5
; GFX11-NEXT:    v_ldexp_f32 v6, v6, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB2_5
; GFX11-NEXT:  ; %bb.6: ; %Flow
...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v7, v4
; GFX11-NEXT:    v_frexp_mant_f32_e32 v2, v4
; GFX11-NEXT:    v_frexp_mant_f32_e32 v4, v3
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v8, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v5, v2, 11
; GFX11-NEXT:    v_ldexp_f32 v3, v4, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_div_scale_f32 v9, null, v3, v3, 1.0
; GFX11-NEXT:    v_div_scale_f32 v6, vcc_lo, 1.0, v3, 1.0
; GFX11-NEXT:    v_rcp_f32_e32 v10, v9
...
; GFX11-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v2, 0x7fff, v2, v0
; GFX11-NEXT:  .LBB9_8:
...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v10, v7
; GFX11-NEXT:    v_frexp_mant_f32_e32 v5, v7
; GFX11-NEXT:    v_frexp_mant_f32_e32 v7, v6
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v11, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v8, v5, 11
; GFX11-NEXT:    v_ldexp_f32 v6, v7, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v10, v8 :: v_dual_add_nc_u32 v7, -11, v7
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v7
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v8, v8, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB9_13
; GFX11-NEXT:  ; %bb.14: ; %Flow
; GFX11-NEXT:    v_mov_b32_e32 v8, v10
; GFX11-NEXT:  .LBB9_15: ; %frem.loop_exit28
; GFX11-NEXT:    v_add_nc_u32_e32 v7, -10, v7
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v5, 0x7fff, v5, v3
; GFX11-NEXT:  .LBB9_16: ; %Flow54
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v1
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v0|
; GFX11-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v3|
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v2, vcc_lo
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v4
...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v9, v6
; GFX11-NEXT:    v_frexp_mant_f32_e32 v4, v6
; GFX11-NEXT:    v_frexp_mant_f32_e32 v6, v5
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v10, v5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v7, v4, 11
; GFX11-NEXT:    v_ldexp_f32 v5, v6, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v9, v7 :: v_dual_add_nc_u32 v6, -11, v6
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v7, v7, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_5
; GFX11-NEXT:  ; %bb.6: ; %Flow133
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v4, 0x7fff, v4, v0
; GFX11-NEXT:  .LBB10_8:
...
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v12, v9
; GFX11-NEXT:    v_frexp_mant_f32_e32 v7, v9
; GFX11-NEXT:    v_frexp_mant_f32_e32 v9, v8
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v13, v8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v10, v7, 11
; GFX11-NEXT:    v_ldexp_f32 v8, v9, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_div_scale_f32 v14, null, v8, v8, 1.0
; GFX11-NEXT:    v_div_scale_f32 v11, vcc_lo, 1.0, v8, 1.0
...
; GFX11-NEXT:    v_dual_mul_f32 v16, v11, v15 :: v_dual_add_nc_u32 v7, -1, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_not_b32_e32 v9, v7
; GFX11-NEXT:    v_fma_f32 v17, -v14, v16, v11
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_nc_u32_e32 v9, v9, v12
; GFX11-NEXT:    v_fmac_f32_e32 v16, v17, v15
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_fma_f32 v11, -v14, v16, v11
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v11, v11, v15, v16
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_div_fixup_f32 v11, v11, v8, 1.0
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_15
; GFX11-NEXT:  ; %bb.12: ; %frem.loop_body27.preheader
; GFX11-NEXT:    v_sub_nc_u32_e32 v9, v12, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_nc_u32_e32 v9, 11, v9
; GFX11-NEXT:  .LBB10_13: ; %frem.loop_body27
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v12, v10 :: v_dual_add_nc_u32 v9, -11, v9
; GFX11-NEXT:    v_mul_f32_e32 v10, v12, v11
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_rndne_f32_e32 v10, v10
; GFX11-NEXT:    v_fma_f32 v10, -v10, v8, v12
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_cmp_gt_f32_e32 vcc_lo, 0, v10
; GFX11-NEXT:    v_add_f32_e32 v13, v10, v8
; GFX11-NEXT:    v_cndmask_b32_e32 v10, v10, v13, vcc_lo
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v10, v10, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_13
; GFX11-NEXT:  ; %bb.14: ; %Flow129
...
; GFX11-NEXT:    v_mul_f32_e32 v10, v9, v11
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_rndne_f32_e32 v10, v10
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v7, 0x7fff, v7, v5
; GFX11-NEXT:  .LBB10_16:
...
; GFX11-NEXT:  .LBB10_19: ; %frem.compute52
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v13, v10
; GFX11-NEXT:    v_frexp_mant_f32_e32 v8, v10
; GFX11-NEXT:    v_frexp_mant_f32_e32 v10, v9
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v14, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v11, v8, 11
; GFX11-NEXT:    v_ldexp_f32 v9, v10, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_div_fixup_f32 v12, v12, v9, 1.0
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_23
; GFX11-NEXT:  ; %bb.20: ; %frem.loop_body60.preheader
; GFX11-NEXT:    v_sub_nc_u32_e32 v10, v13, v14
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_nc_u32_e32 v10, 11, v10
; GFX11-NEXT:  .LBB10_21: ; %frem.loop_body60
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v13, v11 :: v_dual_add_nc_u32 v10, -11, v10
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v11, v11, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_21
; GFX11-NEXT:  ; %bb.22: ; %Flow125
; GFX11-NEXT:    v_mov_b32_e32 v11, v13
; GFX11-NEXT:  .LBB10_23: ; %frem.loop_exit61
; GFX11-NEXT:    v_add_nc_u32_e32 v10, -10, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v8, 0x7fff, v8, v1
; GFX11-NEXT:  .LBB10_24:
...
; GFX11-NEXT:  .LBB10_27: ; %frem.compute85
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v16, v13
; GFX11-NEXT:    v_frexp_mant_f32_e32 v11, v13
; GFX11-NEXT:    v_frexp_mant_f32_e32 v13, v12
; GFX11-NEXT:    v_frexp_exp_i32_f32_e32 v17, v12
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_ldexp_f32 v14, v11, 11
; GFX11-NEXT:    v_ldexp_f32 v12, v13, 1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
...
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 12, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_div_fixup_f32 v15, v15, v12, 1.0
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_31
; GFX11-NEXT:  ; %bb.28: ; %frem.loop_body93.preheader
; GFX11-NEXT:    v_sub_nc_u32_e32 v13, v16, v17
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_nc_u32_e32 v13, 11, v13
; GFX11-NEXT:  .LBB10_29: ; %frem.loop_body93
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v16, v14 :: v_dual_add_nc_u32 v13, -11, v13
...
; GFX11-NEXT:    v_cmp_lt_i32_e32 vcc_lo, 11, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-NEXT:    v_ldexp_f32 v14, v14, 11
; GFX11-NEXT:    s_cbranch_vccnz .LBB10_29
; GFX11-NEXT:  ; %bb.30: ; %Flow
; GFX11-NEXT:    v_mov_b32_e32 v14, v16
; GFX11-NEXT:  .LBB10_31: ; %frem.loop_exit94
; GFX11-NEXT:    v_add_nc_u32_e32 v13, -10, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_bfi_b32 v11, 0x7fff, v11, v9
; GFX11-NEXT:  .LBB10_32: ; %Flow124
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v2
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v0|
; GFX11-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v5|
; GFX11-NEXT:    v_cndmask_b32_e32 v0, 0x7e00, v4, vcc_lo
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v6
; GFX11-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v1|
; GFX11-NEXT:    v_cndmask_b32_e32 v2, 0x7e00, v7, vcc_lo
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v3
; GFX11-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v0, 0xffff, v0
; GFX11-NEXT:    s_and_b32 vcc_lo, s2, vcc_lo
; GFX11-NEXT:    v_cmp_nle_f16_e64 s2, 0x7c00, |v9|
; GFX11-NEXT:    v_cndmask_b32_e32 v1, 0x7e00, v8, vcc_lo
; GFX11-NEXT:    v_cmp_lg_f16_e32 vcc_lo, 0, v10
; GFX11-NEXT:    v_lshl_or_b32 v0, v2, 16, v0
