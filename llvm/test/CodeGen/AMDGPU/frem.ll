...
; VI-NEXT:    v_mul_f32_e32 v3, v5, v3
...
; VI-NEXT:    v_div_fixup_f16 v6, v6, v5, v7
; VI-NEXT:    v_trunc_f16_e32 v6, v6
; VI-NEXT:    v_fma_f16 v5, -v6, v5, v7
; VI-NEXT:    v_cvt_f32_f16_e32 v6, v4
; VI-NEXT:    v_cvt_f32_f16_e32 v7, v2
; VI-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; VI-NEXT:    v_rcp_f32_e32 v6, v6
; VI-NEXT:    v_mul_f32_e32 v6, v7, v6
; VI-NEXT:    v_cvt_f16_f32_e32 v6, v6
...
; GFX1150-NEXT:    s_waitcnt vmcnt(1)
; GFX1150-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
; GFX1150-NEXT:    s_waitcnt vmcnt(0)
...
; GFX1150-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_mixlo_f16 v6, v1, v6, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
...
; GFX1150-NEXT:    v_fma_f16 v1, v5, v3, v1
; GFX1150-NEXT:    v_cvt_f32_f16_e32 v3, v2
; GFX1150-NEXT:    v_pack_b32_f16 v1, v1, v7
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(TRANS32_DEP_1)
; GFX1150-NEXT:    v_rcp_f32_e32 v3, v3
; GFX1150-NEXT:    v_fma_mixlo_f16 v3, v0, v3, 0 op_sel_hi:[1,0,0]
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_div_fixup_f16 v3, v3, v2, v0
; GFX1150-NEXT:    v_trunc_f16_e32 v3, v3
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_xor_b32_e32 v3, 0x8000, v3
; GFX1150-NEXT:    v_fma_f16 v3, v3, v2, v0
; GFX1150-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_cvt_f32_f16_e32 v5, v2
; GFX1150-NEXT:    v_rcp_f32_e32 v5, v5
; GFX1150-NEXT:    s_delay_alu instid0(TRANS32_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fma_mixlo_f16 v5, v0, v5, 0 op_sel:[1,0,0] op_sel_hi:[1,0,0]
; GFX1150-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX1150-NEXT:    v_div_fixup_f16 v5, v5, v2, v0
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_trunc_f16_e32 v5, v5
; GFX1150-NEXT:    v_xor_b32_e32 v5, 0x8000, v5
; GFX1150-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1150-NEXT:    v_fmac_f16_e32 v0, v5, v2
; GFX1150-NEXT:    v_pack_b32_f16 v0, v3, v0
