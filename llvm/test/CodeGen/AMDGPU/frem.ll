...
; RUN:  llc -amdgpu-scalarize-global-loads=false -enable-misched=0 -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    v_fmac_f16_e64 v1, -v3, v2
...
; GFX11-NEXT:    v_fma_f32 v5, v6, v5, v5
...
; GFX11-NEXT:    v_fmac_f32_e64 v1, -v3, v2
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[0:1], v15, s[6:7]
; GFX11-NEXT:    global_load_b64 v[2:3], v15, s[0:1]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    global_store_b64 v15, v[0:1], s[4:5]
; GFX11-NEXT:    s_endpgm
...
; GFX11-NEXT:    v_fma_f64 v[6:7], -v[2:3], v[4:5], 1.0
; GFX11-NEXT:    v_fma_f64 v[14:15], v[6:7], v[4:5], v[4:5]
; GFX11-NEXT:    v_mul_f64 v[6:7], v[0:1], v[14:15]
; GFX11-NEXT:    v_fma_f64 v[8:9], -v[2:3], v[6:7], v[0:1]
; GFX11-NEXT:    v_fma_f64 v[4:5], v[8:9], v[14:15], v[6:7]
; GFX11-NEXT:    v_trunc_f64_e32 v[4:5], v[4:5]
; GFX11-NEXT:    v_fma_f64 v[0:1], -v[4:5], v[2:3], v[0:1]
...
; GFX11-NEXT:    v_trunc_f16_e32 v3, v3
; GFX11-NEXT:    v_fmac_f16_e64 v4, -v3, v2
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[0:1], v11, s[6:7]
; GFX11-NEXT:    global_load_b64 v[15:16], v11, s[0:1] offset:32
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_cvt_f32_f16_e32 v5, v1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cvt_f32_f16_e32 v6, v16
...
; GFX11-NEXT:    v_cvt_f16_f32_e32 v6, v5
; GFX11-NEXT:    v_div_fixup_f16 v5, v6, v16, v1
; GFX11-NEXT:    v_mov_b32_e32 v6, v1
; GFX11-NEXT:    v_trunc_f16_e32 v5, v5
; GFX11-NEXT:    v_fmac_f16_e64 v6, -v5, v16
; GFX11-NEXT:    v_cvt_f32_f16_e32 v5, v4
; GFX11-NEXT:    v_mul_f32_e32 v5, v5, v7
; GFX11-NEXT:    v_cvt_f32_f16_e32 v7, v2
; GFX11-NEXT:    v_cvt_f16_f32_e32 v10, v5
; GFX11-NEXT:    v_rcp_f32_e32 v7, v7
; GFX11-NEXT:    v_div_fixup_f16 v5, v10, v3, v4
; GFX11-NEXT:    v_trunc_f16_e32 v10, v5
; GFX11-NEXT:    v_fmac_f16_e64 v4, -v10, v3
; GFX11-NEXT:    v_mov_b32_e32 v3, 0xffff
; GFX11-NEXT:    v_and_b32_e32 v5, v3, v6
; GFX11-NEXT:    v_cvt_f32_f16_e32 v6, v15
...
; GFX11-NEXT:    v_div_fixup_f16 v5, v5, v15, v0
; GFX11-NEXT:    v_lshrrev_b32_e32 v0, 16, v0
; GFX11-NEXT:    v_trunc_f16_e32 v5, v5
; GFX11-NEXT:    v_fmac_f16_e64 v6, -v5, v15
; GFX11-NEXT:    v_cvt_f32_f16_e32 v5, v0
; GFX11-NEXT:    v_mul_f32_e32 v5, v5, v7
; GFX11-NEXT:    v_cvt_f16_f32_e32 v5, v5
; GFX11-NEXT:    v_div_fixup_f16 v5, v5, v2, v0
; GFX11-NEXT:    v_trunc_f16_e32 v5, v5
; GFX11-NEXT:    v_fmac_f16_e64 v0, -v5, v2
; GFX11-NEXT:    v_and_b32_e32 v2, v3, v6
; GFX11-NEXT:    v_lshl_or_b32 v0, v0, 16, v2
; GFX11-NEXT:    global_store_b64 v11, v[0:1], s[4:5]
; GFX11-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[0:1], v11, s[6:7]
; GFX11-NEXT:    global_load_b64 v[2:3], v11, s[0:1] offset:32
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    v_fma_f32 v7, v8, v7, v7
; GFX11-NEXT:    v_mul_f32_e32 v8, v5, v7
; GFX11-NEXT:    v_fma_f32 v9, -v6, v8, v5
; GFX11-NEXT:    v_fma_f32 v8, v9, v7, v8
; GFX11-NEXT:    v_fma_f32 v5, -v6, v8, v5
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v6, v5, v7, v8
; GFX11-NEXT:    v_div_scale_f32 v4, vcc_lo, v0, v2, v0
; GFX11-NEXT:    v_div_fixup_f32 v5, v6, v3, v1
; GFX11-NEXT:    v_trunc_f32_e32 v6, v5
; GFX11-NEXT:    v_div_scale_f32 v5, s0, v2, v2, v0
; GFX11-NEXT:    v_fma_f32 v1, v3, -v6, v1
; GFX11-NEXT:    v_rcp_f32_e32 v6, v5
; GFX11-NEXT:    s_denorm_mode 15
; GFX11-NEXT:    v_fma_f32 v7, -v5, v6, 1.0
; GFX11-NEXT:    v_fma_f32 v6, v7, v6, v6
; GFX11-NEXT:    v_mul_f32_e32 v7, v4, v6
; GFX11-NEXT:    v_fma_f32 v8, -v5, v7, v4
; GFX11-NEXT:    v_fma_f32 v7, v8, v6, v7
; GFX11-NEXT:    v_fma_f32 v5, -v5, v7, v4
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v3, v5, v6, v7
; GFX11-NEXT:    v_div_fixup_f32 v3, v3, v2, v0
; GFX11-NEXT:    v_trunc_f32_e32 v3, v3
; GFX11-NEXT:    v_fmac_f32_e64 v0, -v3, v2
; GFX11-NEXT:    global_store_b64 v11, v[0:1], s[4:5]
; GFX11-NEXT:    s_endpgm
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b128 v[15:18], v8, s[6:7]
; GFX11-NEXT:    global_load_b128 v[4:7], v8, s[0:1] offset:64
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_div_scale_f32 v10, s0, v7, v7, v18
; GFX11-NEXT:    v_div_scale_f32 v9, vcc_lo, v18, v7, v18
; GFX11-NEXT:    v_rcp_f32_e32 v11, v10
; GFX11-NEXT:    s_denorm_mode 15
; GFX11-NEXT:    v_fma_f32 v12, -v10, v11, 1.0
; GFX11-NEXT:    v_fma_f32 v11, v12, v11, v11
...
; GFX11-NEXT:    v_div_scale_f32 v0, vcc_lo, v17, v6, v17
; GFX11-NEXT:    v_div_fixup_f32 v9, v9, v7, v18
; GFX11-NEXT:    v_trunc_f32_e32 v9, v9
; GFX11-NEXT:    v_fma_f32 v18, v7, -v9, v18
; GFX11-NEXT:    v_div_scale_f32 v9, s0, v6, v6, v17
; GFX11-NEXT:    v_rcp_f32_e32 v10, v9
; GFX11-NEXT:    s_denorm_mode 15
; GFX11-NEXT:    v_fma_f32 v11, -v9, v10, 1.0
; GFX11-NEXT:    v_fma_f32 v10, v11, v10, v10
; GFX11-NEXT:    v_mul_f32_e32 v11, v0, v10
; GFX11-NEXT:    v_fma_f32 v12, -v9, v11, v0
; GFX11-NEXT:    v_fma_f32 v11, v12, v10, v11
; GFX11-NEXT:    v_fma_f32 v1, -v9, v11, v0
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v7, v1, v10, v11
; GFX11-NEXT:    v_div_fixup_f32 v7, v7, v6, v17
; GFX11-NEXT:    v_trunc_f32_e32 v7, v7
; GFX11-NEXT:    v_fma_f32 v17, v6, -v7, v17
; GFX11-NEXT:    v_div_scale_f32 v7, s0, v5, v5, v16
; GFX11-NEXT:    v_div_scale_f32 v6, vcc_lo, v16, v5, v16
; GFX11-NEXT:    v_rcp_f32_e32 v9, v7
; GFX11-NEXT:    s_denorm_mode 15
; GFX11-NEXT:    v_fma_f32 v10, -v7, v9, 1.0
; GFX11-NEXT:    v_fma_f32 v9, v10, v9, v9
; GFX11-NEXT:    v_mul_f32_e32 v0, v6, v9
; GFX11-NEXT:    v_fma_f32 v11, -v7, v0, v6
; GFX11-NEXT:    v_fma_f32 v0, v11, v9, v0
; GFX11-NEXT:    v_fma_f32 v6, -v7, v0, v6
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v6, v6, v9, v0
; GFX11-NEXT:    v_div_fixup_f32 v6, v6, v5, v16
; GFX11-NEXT:    v_trunc_f32_e32 v6, v6
; GFX11-NEXT:    v_fma_f32 v16, v5, -v6, v16
; GFX11-NEXT:    v_div_scale_f32 v6, s0, v4, v4, v15
; GFX11-NEXT:    v_div_scale_f32 v5, vcc_lo, v15, v4, v15
; GFX11-NEXT:    v_rcp_f32_e32 v7, v6
; GFX11-NEXT:    s_denorm_mode 15
; GFX11-NEXT:    v_fma_f32 v9, -v6, v7, 1.0
; GFX11-NEXT:    v_fma_f32 v7, v9, v7, v7
; GFX11-NEXT:    v_mul_f32_e32 v0, v5, v7
; GFX11-NEXT:    v_fma_f32 v10, -v6, v0, v5
; GFX11-NEXT:    v_fma_f32 v0, v10, v7, v0
; GFX11-NEXT:    v_fma_f32 v5, -v6, v0, v5
; GFX11-NEXT:    s_denorm_mode 12
; GFX11-NEXT:    v_div_fmas_f32 v5, v5, v7, v0
; GFX11-NEXT:    v_div_fixup_f32 v5, v5, v4, v15
; GFX11-NEXT:    v_trunc_f32_e32 v5, v5
; GFX11-NEXT:    v_fmac_f32_e64 v15, -v5, v4
; GFX11-NEXT:    global_store_b128 v8, v[15:18], s[4:5]
; GFX11-NEXT:    s_endpgm
...
; GFX11-NEXT:    global_load_b128 v[18:21], v16, s[0:1] offset:64
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_div_scale_f64 v[8:9], s0, v[20:21], v[20:21], v[2:3]
; GFX11-NEXT:    v_div_scale_f64 v[6:7], s0, v[18:19], v[18:19], v[0:1]
...
; GFX11-NEXT:    v_fma_f64 v[12:13], -v[8:9], v[10:11], 1.0
; GFX11-NEXT:    v_fma_f64 v[10:11], v[10:11], v[12:13], v[10:11]
; GFX11-NEXT:    v_div_scale_f64 v[12:13], vcc_lo, v[2:3], v[20:21], v[2:3]
...
; GFX11-NEXT:    v_div_fixup_f64 v[8:9], v[8:9], v[20:21], v[2:3]
; GFX11-NEXT:    v_trunc_f64_e32 v[8:9], v[8:9]
; GFX11-NEXT:    v_fma_f64 v[2:3], -v[8:9], v[20:21], v[2:3]
...
; GFX11-NEXT:    v_fma_f64 v[10:11], -v[6:7], v[8:9], 1.0
; GFX11-NEXT:    v_fma_f64 v[8:9], v[8:9], v[10:11], v[8:9]
; GFX11-NEXT:    v_div_scale_f64 v[10:11], vcc_lo, v[0:1], v[18:19], v[0:1]
...
; GFX11-NEXT:    v_div_fixup_f64 v[6:7], v[6:7], v[18:19], v[0:1]
; GFX11-NEXT:    v_trunc_f64_e32 v[6:7], v[6:7]
; GFX11-NEXT:    v_fma_f64 v[0:1], -v[6:7], v[18:19], v[0:1]
