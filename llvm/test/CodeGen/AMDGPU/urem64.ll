...
; GCN-IR-NEXT:    v_subb_u32_e64 v5, s[6:7], 0, 0, vcc
...
; GCN-IR-NEXT:    v_lshr_b64 v[14:15], v[0:1], v13
...
; GCN-IR-NEXT:    v_addc_u32_e32 v7, vcc, v7, v12, vcc
...
; GCN-IR-NEXT:    v_or_b32_e32 v10, v14, v8
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_sub_i32_e32 v8, vcc, v11, v10
; GCN-IR-NEXT:    v_subb_u32_e32 v8, vcc, v13, v15, vcc
; GCN-IR-NEXT:    v_or_b32_e32 v4, v16, v4
; GCN-IR-NEXT:    v_add_i32_e32 v16, vcc, 1, v6
; GCN-IR-NEXT:    v_ashrrev_i32_e32 v12, 31, v8
; GCN-IR-NEXT:    v_or_b32_e32 v5, v17, v5
; GCN-IR-NEXT:    v_addc_u32_e32 v17, vcc, 0, v7, vcc
; GCN-IR-NEXT:    v_cmp_lt_u64_e32 vcc, v[16:17], v[6:7]
; GCN-IR-NEXT:    v_mov_b32_e32 v6, v16
; GCN-IR-NEXT:    v_mov_b32_e32 v9, 0
; GCN-IR-NEXT:    v_and_b32_e32 v8, 1, v12
; GCN-IR-NEXT:    v_and_b32_e32 v18, v12, v3
; GCN-IR-NEXT:    v_and_b32_e32 v12, v12, v2
; GCN-IR-NEXT:    v_sub_i32_e64 v14, s[4:5], v10, v12
; GCN-IR-NEXT:    v_mov_b32_e32 v7, v17
...
; GCN-IR-NEXT:    v_lshl_b64 v[4:5], v[4:5], 1
; GCN-IR-NEXT:    v_or_b32_e32 v9, v9, v5
; GCN-IR-NEXT:    v_or_b32_e32 v8, v8, v4
; GCN-IR-NEXT:  BB1_6: ; %Flow4
; GCN-IR-NEXT:    s_or_b64 exec, exec, s[6:7]
; GCN-IR-NEXT:    v_mul_lo_u32 v4, v2, v9
; GCN-IR-NEXT:    v_mul_hi_u32 v5, v2, v8
