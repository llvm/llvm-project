...
; GCN-IR-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[6:7]
; GCN-IR-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-IR-NEXT:    v_readfirstlane_b32 s7, v1
; GCN-IR-NEXT:    s_or_b32 s7, s6, s7
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[10:11]
; GCN-IR-NEXT:    v_or_b32_e32 v0, s7, v0
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v0
; GCN-IR-NEXT:    s_bitcmp1_b32 s7, 0
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
...
; GCN-IR-NEXT:    v_cmp_gt_u64_e64 s[4:5], s[8:9], 63
; GCN-IR-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GCN-IR-NEXT:    v_readfirstlane_b32 s4, v0
; GCN-IR-NEXT:    s_or_b32 s10, s6, s4
; GCN-IR-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[8:9], 63
; GCN-IR-NEXT:    s_bitcmp1_b32 s10, 0
; GCN-IR-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GCN-IR-NEXT:    v_or_b32_e32 v0, s10, v0
; GCN-IR-NEXT:    v_and_b32_e32 v0, 1, v0
; GCN-IR-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
