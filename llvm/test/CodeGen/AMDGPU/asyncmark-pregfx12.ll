...
; RUN: sed 's/.ASYNC/.async/' %s | llc -mtriple=amdgcn -mcpu=gfx900 -o - | FileCheck %s -check-prefixes=WITHASYNC
; RUN: sed 's/.ASYNC//' %s       | llc -mtriple=amdgcn -mcpu=gfx900 -o - | FileCheck %s -check-prefixes=WITHOUT
