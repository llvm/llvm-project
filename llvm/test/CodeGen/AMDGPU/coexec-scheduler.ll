...
; COEXEC-NEXT:    s_load_b32 s6, s[4:5], 0x0 nv
; COEXEC-NEXT:    s_load_b128 s[0:3], s[4:5], 0x8 nv
...
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_mov_b32_e32 v88, s6
; COEXEC-NEXT:    s_add_co_i32 s6, s6, s3
; COEXEC-NEXT:    s_and_b32 s4, s2, exec_lo
; COEXEC-NEXT:    s_cselect_b32 s4, 1, 0
...
; GCN-NEXT:    s_load_b128 s[0:3], s[4:5], 0x8 nv
; GCN-NEXT:    s_load_b32 s6, s[4:5], 0x0 nv
...
; COEXEC-NEXT:    s_clause 0x1
; COEXEC-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0 nv
; COEXEC-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10 nv
; COEXEC-NEXT:    v_mov_b32_e32 v0, 0
; COEXEC-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; COEXEC-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v0
; COEXEC-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v6, v0
...
; COEXEC-NEXT:    v_dual_mov_b32 v27, v0 :: v_dual_mov_b32 v28, v0
; COEXEC-NEXT:    s_wait_kmcnt 0x0
; COEXEC-NEXT:    s_bitcmp1_b32 s6, 0
; COEXEC-NEXT:    v_mov_b32_e32 v29, v0
; COEXEC-NEXT:    s_cselect_b32 s4, -1, 0
; COEXEC-NEXT:    v_mov_b32_e32 v30, v0
; COEXEC-NEXT:    s_xor_b32 s4, s4, -1
; COEXEC-NEXT:    v_mov_b32_e32 v31, v0
; COEXEC-NEXT:  .LBB1_1: ; %loop
; COEXEC-NEXT:    ; =>This Inner Loop Header: Depth=1
; COEXEC-NEXT:    s_add_co_i32 s5, s0, s8
; COEXEC-NEXT:    s_add_co_i32 s6, s1, s8
; COEXEC-NEXT:    s_add_co_i32 s8, s8, s7
; COEXEC-NEXT:    s_and_b32 s9, s4, exec_lo
; COEXEC-NEXT:    s_cselect_b32 s9, 1, 0
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_nop
; COEXEC-NEXT:    v_mov_b32_e32 v124, s5
; COEXEC-NEXT:    s_cmp_lg_u32 s9, 1
; COEXEC-NEXT:    v_mov_b32_e32 v156, s6
...
; COEXEC-NEXT:    v_mov_b32_e32 v32, 0
; COEXEC-NEXT:    s_clause 0x7
; COEXEC-NEXT:    global_store_b128 v32, v[28:31], s[2:3] offset:16
; COEXEC-NEXT:    global_store_b128 v32, v[24:27], s[2:3]
; COEXEC-NEXT:    global_store_b128 v32, v[20:23], s[2:3] offset:144
; COEXEC-NEXT:    global_store_b128 v32, v[16:19], s[2:3] offset:128
; COEXEC-NEXT:    global_store_b128 v32, v[12:15], s[2:3] offset:272
; COEXEC-NEXT:    global_store_b128 v32, v[8:11], s[2:3] offset:256
; COEXEC-NEXT:    global_store_b128 v32, v[4:7], s[2:3] offset:400
; COEXEC-NEXT:    global_store_b128 v32, v[0:3], s[2:3] offset:384
; COEXEC-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; COEXEC-NEXT:    s_endpgm
;
...
; GCN-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    s_load_b64 s[6:7], s[4:5], 0x10 nv
...
; GCN-NEXT:    v_mov_b32_e32 v31, v0
; GCN-NEXT:    s_cselect_b32 s4, -1, 0
; GCN-NEXT:    s_xor_b32 s4, s4, -1
; GCN-NEXT:  .LBB1_1: ; %loop
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    s_add_co_i32 s6, s0, s5
; GCN-NEXT:    s_add_co_i32 s8, s1, s5
; GCN-NEXT:    v_dual_mov_b32 v96, s6 :: v_dual_mov_b32 v97, s8
; GCN-NEXT:    s_add_co_i32 s5, s5, s7
; GCN-NEXT:    s_and_b32 s6, s4, exec_lo
...
; GCN-NEXT:    v_mov_b32_e32 v32, 0
; GCN-NEXT:    s_clause 0x7
; GCN-NEXT:    global_store_b128 v32, v[28:31], s[2:3] offset:16
; GCN-NEXT:    global_store_b128 v32, v[24:27], s[2:3]
; GCN-NEXT:    global_store_b128 v32, v[20:23], s[2:3] offset:144
; GCN-NEXT:    global_store_b128 v32, v[16:19], s[2:3] offset:128
; GCN-NEXT:    global_store_b128 v32, v[12:15], s[2:3] offset:272
; GCN-NEXT:    global_store_b128 v32, v[8:11], s[2:3] offset:256
; GCN-NEXT:    global_store_b128 v32, v[4:7], s[2:3] offset:400
; GCN-NEXT:    global_store_b128 v32, v[0:3], s[2:3] offset:384
; GCN-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GCN-NEXT:    s_endpgm
entry:
