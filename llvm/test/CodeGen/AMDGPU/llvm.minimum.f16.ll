...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f16__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f16__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f16_e32 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7e00
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f16__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f16_e32 v0, v0, v1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f16__nnan_src0:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f16__nnan_src1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f16__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f16__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v2, v0, v1
; GFX942-NEXT:    v_mov_b32_e32 v3, 0x7e00
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f16__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v0, v0, v1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f16__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f16__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v4, v1, v3
; GFX942-NEXT:    v_mov_b32_e32 v5, 0x7e00
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f16__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v0, v0, v2
; GFX942-NEXT:    v_pk_min_f16 v1, v1, v3
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f16__nnan:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v0, v0, v2
; GFX942-NEXT:    v_pk_min_f16 v1, v1, v3
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f16__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v4, v1, v3
; GFX942-NEXT:    v_mov_b32_e32 v5, 0x7e00
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f16__nnan_nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v0, v0, v2
; GFX942-NEXT:    v_pk_min_f16 v1, v1, v3
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v8f16:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v8, v3, v7
...
; GFX942-NEXT:    v_pk_min_f16 v7, v2, v6
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v6, v1, v5
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v5, v0, v4
; GFX942-NEXT:    s_nop 0
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v16f16:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_pk_min_f16 v16, v7, v15
...
; GFX942-NEXT:    v_pk_min_f16 v15, v6, v14
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v14, v5, v13
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v13, v4, v12
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v12, v3, v11
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v11, v2, v10
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v10, v1, v9
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_pk_min_f16 v9, v0, v8
; GFX942-NEXT:    s_nop 0
