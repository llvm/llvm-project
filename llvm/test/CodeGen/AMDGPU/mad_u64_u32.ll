...
; RUN: llc -march=amdgcn -mcpu=gfx1030 --verify-machineinstrs < %s | FileCheck --check-prefixes=GFX10 %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-enable-vopd=0 -amdgpu-enable-delay-alu=0 --verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11 %s
; RUN: llc -march=amdgcn -mcpu=gfx1030 -mattr=+wavefrontsize64 --verify-machineinstrs < %s | FileCheck --check-prefixes=GFX10 %s
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 --verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11 %s
; RUN: llc -march=amdgcn -mcpu=gfx1210 -amdgpu-enable-delay-alu=0 -mattr=+wavefrontsize64 --verify-machineinstrs < %s | FileCheck --check-prefixes=GFX1210 %s
...
;
; GFX1210-LABEL: mad_i32_vvv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, v0, v1, v2
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_sss:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mul_i32 s0, s0, s1
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s2
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_vcv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, v0, 42, v1
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, 42
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_vvs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, v0, v1, s0
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_vsv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, v0, s0, v1
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_svv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, s0, v0, v1
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_vss:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, v0, s0, s1
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_svs:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, s0, v0, s1
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_ssv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mad_u32 v0, s0, s1, v0
; GFX1210-NEXT:    ; return to shader part epilog
  %mul = mul i32 %a, %b
  %add = add i32 %mul, %c
  %cast = bitcast i32 %add to float
...
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: mad_i32_vvv_multiuse:
; GFX1210:       ; %bb.0:
