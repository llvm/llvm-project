...
; VI-NEXT:    s_load_dwordx4 s[8:11], s[0:1], 0x64
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[4:7], s[0:1], 0x64
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x3
; GFX11-NEXT:    s_load_b32 s4, s[0:1], 0x78
; GFX11-NEXT:    s_load_b64 s[2:3], s[0:1], 0x54
; GFX11-NEXT:    s_load_b128 s[8:11], s[0:1], 0x44
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v6, 0 :: v_dual_mov_b32 v5, s4
...
; GFX11-NEXT:    v_bfi_b32 v5, 0x7fffffff, s3, v5
...
; SI-NEXT:    v_bfi_b32 v7, s0, v0, v2
; SI-NEXT:    v_mov_b32_e32 v0, s9
; SI-NEXT:    v_mov_b32_e32 v2, s17
; SI-NEXT:    v_bfi_b32 v5, s0, v0, v2
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x2
; GFX11-NEXT:    s_load_b256 s[4:11], s[0:1], 0x64
; GFX11-NEXT:    s_load_b256 s[12:19], s[0:1], 0x44
; GFX11-NEXT:    s_load_b64 s[0:1], s[0:1], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s7
; GFX11-NEXT:    v_dual_mov_b32 v3, s11 :: v_dual_mov_b32 v2, s18
; GFX11-NEXT:    v_dual_mov_b32 v9, s9 :: v_dual_mov_b32 v4, s12
; GFX11-NEXT:    v_dual_mov_b32 v5, s5 :: v_dual_mov_b32 v0, s16
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_bfi_b32 v7, 0x7fffffff, s15, v1
; GFX11-NEXT:    v_bfi_b32 v3, 0x7fffffff, s19, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX11-NEXT:    v_bfi_b32 v1, 0x7fffffff, s17, v9
