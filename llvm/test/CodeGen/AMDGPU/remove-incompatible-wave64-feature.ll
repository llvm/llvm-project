; RUN: llc -mtriple=amdgpu12.50 -mattr=+wavefrontsize32 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu12.50 -mattr=+wavefrontsize32 < %s

; RUN: llc -mtriple=amdgpu12.00 -mattr=+wavefrontsize32,-wavefrontsize64 -stop-after=amdgpu-remove-incompatible-functions\
; RUN:   -pass-remarks=amdgpu-remove-incompatible-functions < %s 2>%t | FileCheck -check-prefixes=GFX1200 %s
; RUN: llc -mtriple=amdgpu12.00 -mattr=+wavefrontsize32,-wavefrontsize64 < %s
