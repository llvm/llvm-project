...
; RUN: llc < %s -mtriple=amdgpu8.02 -show-mc-encoding | FileCheck -enable-var-scope -check-prefixes=PREGFX10-UNPACKED %s
; RUN: llc < %s -mtriple=amdgpu8.10 | FileCheck -enable-var-scope -check-prefixes=PREGFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu9.00 | FileCheck -enable-var-scope -check-prefixes=PREGFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu10.10 | FileCheck -enable-var-scope -check-prefixes=GFX10-PACKED %s
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -enable-var-scope -check-prefixes=GFX11-PACKED,GFX11-PACKED-REAL16 %s
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -enable-var-scope -check-prefixes=GFX11-PACKED,GFX11-PACKED-FAKE16 %s
; RUN: llc < %s -mtriple=amdgpu12.00 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -enable-var-scope -check-prefixes=GFX12-PACKED,GFX12-PACKED-REAL16 %s
; RUN: llc < %s -mtriple=amdgpu12.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -enable-var-scope -check-prefixes=GFX12-PACKED,GFX12-PACKED-FAKE16 %s
...
; GFX10-PACKED-NEXT:    ; return to shader part epilog
;
; GFX11-PACKED-REAL16-LABEL: tbuffer_load_d16_xyz:
; GFX11-PACKED-REAL16:       ; %bb.0: ; %main_body
; GFX11-PACKED-REAL16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], off, s[0:3], 0 format:[BUF_FMT_32_FLOAT]
; GFX11-PACKED-REAL16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-PACKED-REAL16-NEXT:    v_mov_b16_e32 v0.l, v1.l
; GFX11-PACKED-REAL16-NEXT:    ; return to shader part epilog
;
...
;
; GFX12-PACKED-REAL16-LABEL: tbuffer_load_d16_xyz:
; GFX12-PACKED-REAL16:       ; %bb.0: ; %main_body
; GFX12-PACKED-REAL16-NEXT:    tbuffer_load_d16_format_xyz v[0:1], off, s[0:3], null format:[BUF_FMT_32_FLOAT]
; GFX12-PACKED-REAL16-NEXT:    s_wait_loadcnt 0x0
; GFX12-PACKED-REAL16-NEXT:    v_mov_b16_e32 v0.l, v1.l
; GFX12-PACKED-REAL16-NEXT:    ; return to shader part epilog
;
...
; PREGFX10-UNPACKED-NEXT:    s_mov_b32 s0, 0x1000504 ; encoding: [0xff,0x00,0x80,0xbe,0x04,0x05,0x00,0x01]
; PREGFX10-UNPACKED-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0x70,0x0f,0x8c,0xbf]
; PREGFX10-UNPACKED-NEXT:    v_perm_b32 v0, v2, v3, s0 ; encoding: [0x00,0x00,0xed,0xd1,0x02,0x07,0x02,0x00]
; PREGFX10-UNPACKED-NEXT:    v_lshrrev_b32_e32 v0, 16, v0 ; encoding: [0x90,0x00,0x00,0x20]
; PREGFX10-UNPACKED-NEXT:    ; return to shader part epilog
;
