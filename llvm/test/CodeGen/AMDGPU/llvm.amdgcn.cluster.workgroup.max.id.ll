...
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_x:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    s_bfe_u32 s2, ttmp6, 0x4000c
...
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_x:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    s_bfe_u32 s2, ttmp6, 0x4000c
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_x_optimized:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 4
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_x_optimized:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v0, 4 :: v_dual_mov_b32 v1, 0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v1, v0, s[0:1] scope:SCOPE_SE
; GFX13-GISEL-NEXT:    s_endpgm
  %id = call i32 @llvm.amdgcn.cluster.workgroup.max.id.x()
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_y:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    s_bfe_u32 s2, ttmp6, 0x40010
; GFX13-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_y:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    s_bfe_u32 s2, ttmp6, 0x40010
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s2
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v1, v0, s[0:1] scope:SCOPE_SE
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_y_optimized:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 5
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_y_optimized:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v0, 5 :: v_dual_mov_b32 v1, 0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v1, v0, s[0:1] scope:SCOPE_SE
; GFX13-GISEL-NEXT:    s_endpgm
  %id = call i32 @llvm.amdgcn.cluster.workgroup.max.id.y()
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_z:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    s_bfe_u32 s2, ttmp6, 0x40014
; GFX13-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s2
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_z:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    s_bfe_u32 s2, ttmp6, 0x40014
; GFX13-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s2
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v1, v0, s[0:1] scope:SCOPE_SE
...
; CHECK-G-MESA3D-NEXT:    s_endpgm
;
; GFX13-SDAG-LABEL: test_workgroup_max_id_z_optimized:
; GFX13-SDAG:       ; %bb.0:
; GFX13-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, 6
; GFX13-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX13-SDAG-NEXT:    global_store_b32 v0, v1, s[0:1] scope:SCOPE_SE
; GFX13-SDAG-NEXT:    s_endpgm
;
; GFX13-GISEL-LABEL: test_workgroup_max_id_z_optimized:
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v0, 6 :: v_dual_mov_b32 v1, 0
; GFX13-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX13-GISEL-NEXT:    global_store_b32 v1, v0, s[0:1] scope:SCOPE_SE
; GFX13-GISEL-NEXT:    s_endpgm
  %id = call i32 @llvm.amdgcn.cluster.workgroup.max.id.z()
