...
; RUN: llc < %s -mtriple=amdgpu7.01 | FileCheck %s -check-prefixes=GFX7
; RUN: llc < %s -mtriple=amdgpu8.02 | FileCheck %s -check-prefixes=GFX8
; RUN: llc < %s -mtriple=amdgpu9.00 | FileCheck %s -check-prefixes=GFX9
; RUN: llc < %s -mtriple=amdgpu10.10 | FileCheck %s -check-prefixes=GFX10
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11TRUE16
; RUN: llc < %s -mtriple=amdgpu11.00 -mattr=-real-true16 | FileCheck %s -check-prefixes=GFX11,GFX11FAKE16
...
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_3)
; GFX11TRUE16-NEXT:    v_add_nc_u32_e32 v8, v14, v8
; GFX11TRUE16-NEXT:    s_or_b32 vcc_lo, vcc_lo, s2
; GFX11TRUE16-NEXT:    v_and_b32_e32 v19, 1, v15
...
; GFX11TRUE16-NEXT:    v_dual_cndmask_b32 v10, v10, v16 :: v_dual_add_nc_u32 v9, v15, v9
; GFX11TRUE16-NEXT:    v_cmp_u_f64_e32 vcc_lo, v[2:3], v[2:3]
