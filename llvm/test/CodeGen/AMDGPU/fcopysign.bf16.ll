...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr0_hi16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v1
; GFX11TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11TRUE16-NEXT:    v_bfi_b32 v0, 0x7fff, v2, v0
; GFX11TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11TRUE16-NEXT:    v_mov_b16_e32 v1.l, v0.l
; GFX11TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v2
; GFX11TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr2_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr3_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr4_lo16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr3_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    v_bfi_b32 v1, 0x7fffffff, v1, v3
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr8_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr9_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11TRUE16-NEXT:    ; kill: def $vgpr5_hi16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr4_hi16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11TRUE16-NEXT:    v_bfi_b32 v1, 0x7fff, v1, v5
; GFX11TRUE16-NEXT:    ; kill: def $vgpr1_hi16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr7_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr4_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
...
; GFX11TRUE16-NEXT:    ; kill: def $vgpr10_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr11_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr8_lo16 killed $sgpr0 killed $exec
; GFX11TRUE16-NEXT:    ; kill: def $vgpr9_lo16 killed $sgpr0 killed $exec
