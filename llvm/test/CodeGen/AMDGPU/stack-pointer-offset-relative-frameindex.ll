...
; RUN: llc < %s -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs | FileCheck -check-prefix=MUBUF11 %s
; RUN: llc < %s -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -amdgpu-enable-flat-scratch -verify-machineinstrs | FileCheck -check-prefix=FLATSCR11 %s
...
; MUBUF11-NEXT:    v_mov_b32_e32 v2, 0x4000
; MUBUF11-NEXT:    v_mov_b32_e32 v3, 0
...
; MUBUF11-NEXT:    s_cbranch_execz BB0_2
...
; MUBUF11-NEXT:  BB0_2: ; %shader_eval_surface.exit
...
; FLATSCR11-NEXT:    v_mov_b32_e32 v2, 0x4000
; FLATSCR11-NEXT:    v_mov_b32_e32 v3, 0
...
; FLATSCR11-NEXT:    s_cbranch_execz BB0_2
...
; FLATSCR11-NEXT:  BB0_2: ; %shader_eval_surface.exit
