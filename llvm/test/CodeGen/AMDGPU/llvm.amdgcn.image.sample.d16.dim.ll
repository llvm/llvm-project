...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
