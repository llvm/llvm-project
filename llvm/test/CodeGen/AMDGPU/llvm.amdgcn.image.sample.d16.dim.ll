...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
...
;
; GFX13-LABEL: image_sample_2d_f16:
...
; GFX13-NEXT:    image_sample v0, [v0, v1], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D d16
...
;
; GFX13-TRUE16-LABEL: image_sample_2d_f16_tfe:
; GFX13-TRUE16:       ; %bb.0: ; %main_body
; GFX13-TRUE16-NEXT:    s_mov_b32 s14, exec_lo
...
; GFX13-FAKE16-NEXT:    global_store_b32 v4, v1, s[12:13] scope:SCOPE_SE
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_c_d_1d_v2f16:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_sample_c_d v0, [v0, v1, v2, v3], s[0:7], s[8:11] dmask:0x3 dim:SQ_RSRC_IMG_1D d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_c_d_1d_v2f16_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v5, v0
; GFX13-NEXT:    v_mov_b32_e32 v0, 0
; GFX13-NEXT:    v_mov_b32_e32 v1, v0
; GFX13-NEXT:    image_sample_c_d v[0:1], [v5, v4, v2, v3], s[0:7], s[8:11] dmask:0x3 dim:SQ_RSRC_IMG_1D tfe d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_b_2d_v3f16:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    s_mov_b32 s12, exec_lo
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX13-NEXT:    image_sample_b v[0:1], [v0, v1, v2], s[0:7], s[8:11] dmask:0x7 dim:SQ_RSRC_IMG_2D d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_b_2d_v3f16_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    s_mov_b32 s12, exec_lo
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo
...
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX13-NEXT:    image_sample_b v[0:2], [v5, v4, v3], s[0:7], s[8:11] dmask:0x7 dim:SQ_RSRC_IMG_2D tfe d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_b_2d_v4f16:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    s_mov_b32 s12, exec_lo
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX13-NEXT:    image_sample_b v[0:1], [v0, v1, v2], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: image_sample_b_2d_v4f16_tfe:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    s_mov_b32 s12, exec_lo
; GFX13-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX13-NEXT:    v_dual_mov_b32 v5, v0 :: v_dual_mov_b32 v0, 0
...
; GFX13-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX13-NEXT:    s_and_b32 exec_lo, exec_lo, s12
; GFX13-NEXT:    image_sample_b v[0:2], [v5, v4, v3], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D tfe d16
; GFX13-NEXT:    s_wait_samplecnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
