...
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1200 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc < %s -mtriple=amdgcn -mcpu=gfx1300 -amdgpu-enable-delay-alu=0 -verify-machineinstrs | FileCheck -check-prefixes=GFX12PLUS,GFX13 %s
...
;
; GFX12PLUS-LABEL: image_sample_2d_f16_tfe:
; GFX12PLUS:       ; %bb.0: ; %main_body
; GFX12PLUS-NEXT:    s_mov_b32 s14, exec_lo
; GFX12PLUS-NEXT:    s_wqm_b32 exec_lo, exec_lo
; GFX12PLUS-NEXT:    v_mov_b32_e32 v4, 0
; GFX12PLUS-NEXT:    v_dual_mov_b32 v2, v1 :: v_dual_mov_b32 v3, v0
; GFX12PLUS-NEXT:    v_mov_b32_e32 v5, v4
; GFX12PLUS-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX12PLUS-NEXT:    s_and_b32 exec_lo, exec_lo, s14
; GFX12PLUS-NEXT:    image_sample v[0:1], [v3, v2], s[0:7], s[8:11] dmask:0x1 dim:SQ_RSRC_IMG_2D tfe d16
; GFX12PLUS-NEXT:    s_wait_samplecnt 0x0
; GFX12PLUS-NEXT:    global_store_b32 v4, v1, s[12:13]
; GFX12PLUS-NEXT:    ; return to shader part epilog
main_body:
