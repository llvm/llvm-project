...
; RUN: llc -global-isel=0 -mtriple=amdgpu11.00-amd-amdpal -mattr="-wavefrontsize32,+wavefrontsize64" -o - < %s | FileCheck -check-prefixes=SDAG-W64 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu11.00-amd-amdpal -mattr="-wavefrontsize32,+wavefrontsize64" -o - < %s | FileCheck -check-prefixes=GISEL-W64 %s
; RUN: llc -global-isel=0 -mtriple=amdgpu11.00-amd-amdpal -mattr="+wavefrontsize32,-wavefrontsize64" -o - < %s | FileCheck -check-prefixes=SDAG-W32 %s
; RUN: llc -global-isel=1 -mtriple=amdgpu11.00-amd-amdpal -mattr="+wavefrontsize32,-wavefrontsize64" -o - < %s | FileCheck -check-prefixes=GISEL-W32 %s
...
; SDAG-W64-NEXT:    s_waitcnt_depctr depctr_va_sdst(0)
...
; SDAG-W64-NEXT:    s_waitcnt_depctr depctr_sa_sdst(0)
