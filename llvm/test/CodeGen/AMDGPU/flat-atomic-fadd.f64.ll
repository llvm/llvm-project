...
; RUN: llc -mtriple=amdgpu9.0a -stop-after=finalize-isel < %s | FileCheck -check-prefix=GFX90A_GFX942 %s
; RUN: llc -mtriple=amdgpu9.42 -stop-after=finalize-isel < %s | FileCheck -check-prefix=GFX90A_GFX942 %s
