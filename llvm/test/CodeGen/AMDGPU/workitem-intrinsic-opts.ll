...
; RUN: llc -O3 -mtriple=amdgpu8.03 %s -o - | FileCheck %s --check-prefixes=GFX8,DAGISEL-GFX8
; RUN: llc -O3 -mtriple=amdgpu9.42 %s -o - | FileCheck %s --check-prefixes=GFX942,DAGISEL-GFX942
; RUN: llc -O3 -mtriple=amdgpu12.00 %s -o - | FileCheck %s --check-prefixes=GFX12,DAGISEL-GFX12

; RUN: llc -O3 -global-isel -mtriple=amdgpu8.03 %s -o - | FileCheck %s --check-prefixes=GFX8,GISEL-GFX8
; RUN: llc -O3 -global-isel -mtriple=amdgpu9.42 %s -o - | FileCheck %s --check-prefixes=GFX942,GISEL-GFX942
; RUN: llc -O3 -global-isel -mtriple=amdgpu12.00 %s -o - | FileCheck %s --check-prefixes=GFX12,GISEL-GFX12
...
; DAGISEL-GFX8-NEXT:    s_cselect_b32 s4, 0, 1
...
; DAGISEL-GFX942-NEXT:    s_cselect_b32 s0, 0, 1
