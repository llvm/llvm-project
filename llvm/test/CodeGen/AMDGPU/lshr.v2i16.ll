...
; RUN: llc -mtriple=amdgpu8.02 < %s | FileCheck -enable-var-scope --check-prefix=VI %s
; RUN: llc -mtriple=amdgpu7.04 < %s | FileCheck -enable-var-scope --check-prefix=CI %s
...
; VI-NEXT:    flat_load_dwordx4 v[0:3], v[6:7]
