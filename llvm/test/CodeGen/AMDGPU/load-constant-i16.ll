...
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v9, 0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_clause 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v0, v9, s[0:1] offset:16
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v0, v9, s[0:1] offset:12
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v1, v9, s[0:1] offset:8
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v1, v9, s[0:1] offset:4
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v4, v9, s[0:1] offset:28
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v4, v9, s[0:1] offset:24
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v5, v9, s[0:1] offset:20
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v8, v9, s[0:1]
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x6
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v0.h
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x5
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v1.l
...
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v4.h
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v0.l
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v8.l
; GFX13-TRUE16-NEXT:    s_clause 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v7, v9, s[0:1] offset:30
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v6, v9, s[0:1] offset:26
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v5, v9, s[0:1] offset:22
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v4, v9, s[0:1] offset:18
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v3, v9, s[0:1] offset:14
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v2, v9, s[0:1] offset:10
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v1, v9, s[0:1] offset:6
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v0, v9, s[0:1] offset:2
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x0
...
; GFX13-TRUE16-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-TRUE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v2, s2
...
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-FAKE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v2, s2
...
; GFX13-NEXT:    v_dual_mov_b32 v13, s59 :: v_dual_mov_b32 v14, s54
; GFX13-NEXT:    v_dual_mov_b32 v15, s55 :: v_dual_mov_b32 v16, s52
; GFX13-NEXT:    v_mov_b32_e32 v17, s53
...
; GFX13-NEXT:    v_dual_mov_b32 v2, s50 :: v_dual_mov_b32 v3, s51
; GFX13-NEXT:    v_dual_mov_b32 v4, s12 :: v_dual_mov_b32 v5, s13
; GFX13-NEXT:    v_dual_mov_b32 v6, s56 :: v_dual_mov_b32 v7, s57
; GFX13-NEXT:    v_dual_mov_b32 v8, s48 :: v_dual_mov_b32 v9, s49
; GFX13-NEXT:    v_dual_mov_b32 v10, s44 :: v_dual_mov_b32 v11, s45
; GFX13-NEXT:    v_dual_mov_b32 v12, s46 :: v_dual_mov_b32 v13, s47
