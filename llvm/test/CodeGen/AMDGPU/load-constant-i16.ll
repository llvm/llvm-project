...
; GFX12-NEXT:    s_load_b128 s[4:7], s[2:3], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_and_b32 s2, s7, 0xffff
...
; GFX12-NEXT:    s_lshr_b32 s7, s5, 16
; GFX12-NEXT:    s_and_b32 s5, s5, 0xffff
...
; GFX12-NEXT:    s_load_b512 s[0:15], s[18:19], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s36, s15
; GFX12-NEXT:    s_mov_b32 s50, s1
; GFX12-NEXT:    s_lshr_b32 s52, s14, 16
; GFX12-NEXT:    s_mov_b32 s38, s13
; GFX12-NEXT:    s_bfe_i64 s[68:69], s[14:15], 0x100000
; GFX12-NEXT:    s_ashr_i64 s[14:15], s[14:15], 48
; GFX12-NEXT:    s_bfe_i64 s[36:37], s[36:37], 0x100000
; GFX12-NEXT:    s_lshr_b32 s54, s12, 16
; GFX12-NEXT:    s_ashr_i64 s[30:31], s[0:1], 48
; GFX12-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[50:51], s[50:51], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v40, 0 :: v_dual_mov_b32 v1, s37
; GFX12-NEXT:    s_mov_b32 s40, s11
; GFX12-NEXT:    s_bfe_i64 s[34:35], s[12:13], 0x100000
; GFX12-NEXT:    s_ashr_i64 s[12:13], s[12:13], 48
; GFX12-NEXT:    s_bfe_i64 s[38:39], s[38:39], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v0, s36 :: v_dual_mov_b32 v3, s15
; GFX12-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v5, s39
; GFX12-NEXT:    s_lshr_b32 s56, s10, 16
; GFX12-NEXT:    s_bfe_i64 s[54:55], s[54:55], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v28, s50 :: v_dual_mov_b32 v33, s69
; GFX12-NEXT:    v_dual_mov_b32 v30, s30 :: v_dual_mov_b32 v35, s53
; GFX12-NEXT:    v_dual_mov_b32 v32, s68 :: v_dual_mov_b32 v37, s35
; GFX12-NEXT:    v_dual_mov_b32 v34, s52 :: v_dual_mov_b32 v39, s55
; GFX12-NEXT:    s_mov_b32 s42, s9
; GFX12-NEXT:    s_ashr_i64 s[78:79], s[10:11], 48
; GFX12-NEXT:    s_bfe_i64 s[40:41], s[40:41], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v4, s38 :: v_dual_mov_b32 v7, s13
; GFX12-NEXT:    v_dual_mov_b32 v6, s12 :: v_dual_mov_b32 v9, s41
; GFX12-NEXT:    s_lshr_b32 s58, s8, 16
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[10:11], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[56:57], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v36, s34 :: v_dual_mov_b32 v31, s31
; GFX12-NEXT:    v_mov_b32_e32 v38, s54
; GFX12-NEXT:    s_mov_b32 s44, s7
; GFX12-NEXT:    s_mov_b32 s46, s5
; GFX12-NEXT:    s_ashr_i64 s[76:77], s[8:9], 48
; GFX12-NEXT:    s_bfe_i64 s[42:43], s[42:43], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v8, s40 :: v_dual_mov_b32 v11, s79
; GFX12-NEXT:    v_dual_mov_b32 v10, s78 :: v_dual_mov_b32 v13, s43
; GFX12-NEXT:    s_lshr_b32 s60, s6, 16
; GFX12-NEXT:    s_lshr_b32 s62, s4, 16
; GFX12-NEXT:    s_bfe_i64 s[26:27], s[8:9], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[8:9], s[58:59], 0x100000
; GFX12-NEXT:    s_clause 0x3
; GFX12-NEXT:    global_store_b128 v40, v[0:3], s[16:17] offset:240
; GFX12-NEXT:    global_store_b128 v40, v[32:35], s[16:17] offset:224
; GFX12-NEXT:    global_store_b128 v40, v[4:7], s[16:17] offset:208
; GFX12-NEXT:    global_store_b128 v40, v[36:39], s[16:17] offset:192
; GFX12-NEXT:    v_dual_mov_b32 v0, s28 :: v_dual_mov_b32 v3, s11
; GFX12-NEXT:    v_dual_mov_b32 v1, s29 :: v_dual_mov_b32 v2, s10
; GFX12-NEXT:    v_mov_b32_e32 v5, s27
; GFX12-NEXT:    s_mov_b32 s48, s3
; GFX12-NEXT:    s_ashr_i64 s[72:73], s[4:5], 48
; GFX12-NEXT:    s_ashr_i64 s[74:75], s[6:7], 48
; GFX12-NEXT:    s_bfe_i64 s[46:47], s[46:47], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v12, s42 :: v_dual_mov_b32 v15, s77
; GFX12-NEXT:    v_dual_mov_b32 v14, s76 :: v_dual_mov_b32 v17, s45
; GFX12-NEXT:    s_lshr_b32 s64, s2, 16
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[4:5], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[24:25], s[6:7], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[62:63], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[6:7], s[60:61], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v4, s26 :: v_dual_mov_b32 v7, s9
; GFX12-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v33, s25
; GFX12-NEXT:    s_ashr_i64 s[70:71], s[2:3], 48
; GFX12-NEXT:    s_bfe_i64 s[48:49], s[48:49], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v16, s44 :: v_dual_mov_b32 v19, s75
; GFX12-NEXT:    v_dual_mov_b32 v18, s74 :: v_dual_mov_b32 v21, s47
; GFX12-NEXT:    v_dual_mov_b32 v20, s46 :: v_dual_mov_b32 v23, s73
; GFX12-NEXT:    v_dual_mov_b32 v22, s72 :: v_dual_mov_b32 v25, s49
; GFX12-NEXT:    s_lshr_b32 s66, s0, 16
; GFX12-NEXT:    s_bfe_i64 s[20:21], s[2:3], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[64:65], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v32, s24 :: v_dual_mov_b32 v35, s7
; GFX12-NEXT:    v_mov_b32_e32 v34, s6
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v40, v[8:11], s[16:17] offset:176
; GFX12-NEXT:    global_store_b128 v40, v[0:3], s[16:17] offset:160
; GFX12-NEXT:    global_store_b128 v40, v[12:15], s[16:17] offset:144
; GFX12-NEXT:    global_store_b128 v40, v[4:7], s[16:17] offset:128
; GFX12-NEXT:    global_store_b128 v40, v[16:19], s[16:17] offset:112
; GFX12-NEXT:    global_store_b128 v40, v[32:35], s[16:17] offset:96
; GFX12-NEXT:    v_dual_mov_b32 v1, s23 :: v_dual_mov_b32 v0, s22
; GFX12-NEXT:    v_dual_mov_b32 v3, s5 :: v_dual_mov_b32 v2, s4
; GFX12-NEXT:    v_dual_mov_b32 v5, s21 :: v_dual_mov_b32 v24, s48
; GFX12-NEXT:    v_dual_mov_b32 v27, s71 :: v_dual_mov_b32 v26, s70
; GFX12-NEXT:    v_mov_b32_e32 v29, s51
; GFX12-NEXT:    s_bfe_i64 s[18:19], s[0:1], 0x100000
; GFX12-NEXT:    s_bfe_i64 s[0:1], s[66:67], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v4, s20 :: v_dual_mov_b32 v7, s3
; GFX12-NEXT:    v_dual_mov_b32 v6, s2 :: v_dual_mov_b32 v9, s19
; GFX12-NEXT:    v_dual_mov_b32 v8, s18 :: v_dual_mov_b32 v11, s1
; GFX12-NEXT:    v_mov_b32_e32 v10, s0
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v40, v[20:23], s[16:17] offset:80
; GFX12-NEXT:    global_store_b128 v40, v[0:3], s[16:17] offset:64
; GFX12-NEXT:    global_store_b128 v40, v[24:27], s[16:17] offset:48
; GFX12-NEXT:    global_store_b128 v40, v[4:7], s[16:17] offset:32
; GFX12-NEXT:    global_store_b128 v40, v[28:31], s[16:17] offset:16
; GFX12-NEXT:    global_store_b128 v40, v[8:11], s[16:17]
; GFX12-NEXT:    s_nop 0
; GFX12-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX12-NEXT:    s_endpgm
  %load = load <32 x i16>, ptr addrspace(4) %in
