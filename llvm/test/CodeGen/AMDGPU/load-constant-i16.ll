...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1300 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX13,GFX13-FAKE16 %s
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s5
; GFX13-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v3, s7
; GFX13-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v5, s1
; GFX13-NEXT:    v_dual_mov_b32 v4, s0 :: v_dual_mov_b32 v7, s3
...
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v3, v8, s[0:1] offset:28
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v2, v8, s[0:1] offset:24
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v1, v8, s[0:1] offset:20
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v0, v8, s[0:1] offset:16
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v7, v8, s[0:1] offset:12
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v6, v8, s[0:1] offset:8
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v5, v8, s[0:1] offset:4
; GFX13-TRUE16-NEXT:    global_load_d16_b16 v4, v8, s[0:1]
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v3, v8, s[0:1] offset:30
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v2, v8, s[0:1] offset:26
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v1, v8, s[0:1] offset:22
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v0, v8, s[0:1] offset:18
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v7, v8, s[0:1] offset:14
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v6, v8, s[0:1] offset:10
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v5, v8, s[0:1] offset:6
; GFX13-TRUE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-TRUE16-NEXT:    global_load_d16_hi_b16 v4, v8, s[0:1] offset:2
...
; GFX13-FAKE16-NEXT:    global_load_u16 v3, v8, s[0:1] offset:28
; GFX13-FAKE16-NEXT:    global_load_u16 v2, v8, s[0:1] offset:24
; GFX13-FAKE16-NEXT:    global_load_u16 v1, v8, s[0:1] offset:20
; GFX13-FAKE16-NEXT:    global_load_u16 v0, v8, s[0:1] offset:16
; GFX13-FAKE16-NEXT:    global_load_u16 v7, v8, s[0:1] offset:12
; GFX13-FAKE16-NEXT:    global_load_u16 v6, v8, s[0:1] offset:8
; GFX13-FAKE16-NEXT:    global_load_u16 v5, v8, s[0:1] offset:4
; GFX13-FAKE16-NEXT:    global_load_u16 v4, v8, s[0:1]
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v3, v8, s[0:1] offset:30
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v2, v8, s[0:1] offset:26
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v1, v8, s[0:1] offset:22
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v0, v8, s[0:1] offset:18
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v7, v8, s[0:1] offset:14
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v6, v8, s[0:1] offset:10
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v5, v8, s[0:1] offset:6
; GFX13-FAKE16-NEXT:    s_wait_loadcnt 0x7
; GFX13-FAKE16-NEXT:    global_load_d16_hi_b16 v4, v8, s[0:1] offset:2
...
; GFX13-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s2
...
; GFX13-NEXT:    s_lshr_b32 s2, s2, 16
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s2
; GFX13-NEXT:    v_dual_mov_b32 v0, s5 :: v_dual_mov_b32 v3, s4
...
; GFX13-NEXT:    s_sext_i32_i16 s2, s2
; GFX13-NEXT:    s_sext_i32_i16 s3, s3
; GFX13-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s5
; GFX13-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, s4
; GFX13-NEXT:    v_mov_b32_e32 v2, s3
; GFX13-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX13-NEXT:    s_endpgm
  %load = load <4 x i16>, ptr addrspace(4) %in
...
; GFX13-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s6
; GFX13-NEXT:    v_dual_mov_b32 v0, s9 :: v_dual_mov_b32 v3, s8
; GFX13-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v5, s5
; GFX13-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v7, s2
...
; GFX13-NEXT:    s_sext_i32_i16 s4, s4
; GFX13-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s9
; GFX13-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v3, s8
; GFX13-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v5, s3
; GFX13-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v7, s2
; GFX13-NEXT:    v_mov_b32_e32 v6, s5
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:16
; GFX13-NEXT:    global_store_b128 v8, v[4:7], s[0:1]
; GFX13-NEXT:    s_endpgm
...
; GFX13-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s10
; GFX13-NEXT:    s_lshr_b32 s12, s7, 16
; GFX13-NEXT:    s_and_b32 s7, s7, 0xffff
; GFX13-NEXT:    s_lshr_b32 s13, s6, 16
; GFX13-NEXT:    s_and_b32 s6, s6, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v0, s17 :: v_dual_mov_b32 v3, s16
; GFX13-NEXT:    v_dual_mov_b32 v2, s11 :: v_dual_mov_b32 v5, s15
; GFX13-NEXT:    s_lshr_b32 s2, s5, 16
; GFX13-NEXT:    s_and_b32 s3, s5, 0xffff
; GFX13-NEXT:    s_lshr_b32 s5, s4, 16
; GFX13-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v4, s8 :: v_dual_mov_b32 v7, s14
; GFX13-NEXT:    v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v9, s13
; GFX13-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v11, s12
; GFX13-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v13, s5
; GFX13-NEXT:    v_dual_mov_b32 v12, s4 :: v_dual_mov_b32 v15, s2
; GFX13-NEXT:    v_mov_b32_e32 v14, s3
...
; GFX13-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s17
; GFX13-NEXT:    s_ashr_i32 s12, s7, 16
; GFX13-NEXT:    s_ashr_i32 s13, s6, 16
; GFX13-NEXT:    s_sext_i32_i16 s7, s7
; GFX13-NEXT:    s_sext_i32_i16 s6, s6
; GFX13-NEXT:    v_dual_mov_b32 v0, s10 :: v_dual_mov_b32 v3, s16
; GFX13-NEXT:    v_dual_mov_b32 v2, s11 :: v_dual_mov_b32 v5, s15
; GFX13-NEXT:    s_ashr_i32 s2, s5, 16
; GFX13-NEXT:    s_ashr_i32 s3, s4, 16
; GFX13-NEXT:    s_sext_i32_i16 s5, s5
...
; GFX13-NEXT:    v_dual_mov_b32 v6, s9 :: v_dual_mov_b32 v9, s13
; GFX13-NEXT:    v_dual_mov_b32 v8, s6 :: v_dual_mov_b32 v11, s12
; GFX13-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v13, s3
; GFX13-NEXT:    v_dual_mov_b32 v12, s4 :: v_dual_mov_b32 v15, s2
; GFX13-NEXT:    v_mov_b32_e32 v14, s5
; GFX13-NEXT:    s_clause 0x3
; GFX13-NEXT:    global_store_b128 v16, v[0:3], s[0:1] offset:48
; GFX13-NEXT:    global_store_b128 v16, v[4:7], s[0:1] offset:32
; GFX13-NEXT:    global_store_b128 v16, v[8:11], s[0:1] offset:16
...
; GFX13-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s14
; GFX13-NEXT:    v_dual_mov_b32 v0, s34 :: v_dual_mov_b32 v3, s33
; GFX13-NEXT:    v_dual_mov_b32 v2, s15 :: v_dual_mov_b32 v5, s31
; GFX13-NEXT:    s_lshr_b32 s29, s10, 16
; GFX13-NEXT:    v_dual_mov_b32 v4, s12 :: v_dual_mov_b32 v7, s30
; GFX13-NEXT:    v_dual_mov_b32 v6, s13 :: v_dual_mov_b32 v9, s29
...
; GFX13-NEXT:    s_and_b32 s6, s6, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v11, s28
; GFX13-NEXT:    v_mov_b32_e32 v10, s11
...
; GFX13-NEXT:    v_dual_mov_b32 v1, s27 :: v_dual_mov_b32 v0, s8
; GFX13-NEXT:    v_dual_mov_b32 v3, s26 :: v_dual_mov_b32 v2, s9
; GFX13-NEXT:    v_mov_b32_e32 v5, s25
; GFX13-NEXT:    s_lshr_b32 s20, s3, 16
; GFX13-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX13-NEXT:    s_lshr_b32 s21, s2, 16
; GFX13-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v7, s24
; GFX13-NEXT:    v_dual_mov_b32 v6, s7 :: v_dual_mov_b32 v13, s23
...
; GFX13-NEXT:    v_dual_mov_b32 v12, s4 :: v_dual_mov_b32 v15, s22
; GFX13-NEXT:    v_dual_mov_b32 v14, s5 :: v_dual_mov_b32 v17, s21
; GFX13-NEXT:    v_dual_mov_b32 v16, s2 :: v_dual_mov_b32 v19, s20
; GFX13-NEXT:    v_dual_mov_b32 v18, s3 :: v_dual_mov_b32 v21, s19
; GFX13-NEXT:    v_dual_mov_b32 v20, s0 :: v_dual_mov_b32 v23, s18
; GFX13-NEXT:    v_mov_b32_e32 v22, s1
...
; GFX13-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s34
; GFX13-NEXT:    v_dual_mov_b32 v0, s14 :: v_dual_mov_b32 v3, s33
; GFX13-NEXT:    v_dual_mov_b32 v2, s15 :: v_dual_mov_b32 v5, s31
...
; GFX13-NEXT:    s_and_b32 s13, s13, 0xffff
; GFX13-NEXT:    s_and_b32 s12, s12, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s66
; GFX13-NEXT:    s_lshr_b32 s61, s11, 16
; GFX13-NEXT:    s_lshr_b32 s62, s10, 16
; GFX13-NEXT:    s_and_b32 s11, s11, 0xffff
; GFX13-NEXT:    s_and_b32 s10, s10, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v0, s14 :: v_dual_mov_b32 v3, s65
; GFX13-NEXT:    v_dual_mov_b32 v2, s15 :: v_dual_mov_b32 v5, s64
; GFX13-NEXT:    s_lshr_b32 s59, s9, 16
; GFX13-NEXT:    s_lshr_b32 s60, s8, 16
; GFX13-NEXT:    s_and_b32 s9, s9, 0xffff
; GFX13-NEXT:    s_and_b32 s8, s8, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v4, s12 :: v_dual_mov_b32 v7, s63
; GFX13-NEXT:    v_dual_mov_b32 v6, s13 :: v_dual_mov_b32 v9, s62
; GFX13-NEXT:    v_dual_mov_b32 v8, s10 :: v_dual_mov_b32 v11, s61
; GFX13-NEXT:    v_dual_mov_b32 v10, s11 :: v_dual_mov_b32 v13, s60
; GFX13-NEXT:    s_lshr_b32 s57, s7, 16
; GFX13-NEXT:    s_lshr_b32 s58, s6, 16
; GFX13-NEXT:    s_and_b32 s7, s7, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v12, s8 :: v_dual_mov_b32 v15, s59
; GFX13-NEXT:    v_mov_b32_e32 v14, s9
; GFX13-NEXT:    s_and_b32 s6, s6, 0xffff
...
; GFX13-NEXT:    v_dual_mov_b32 v1, s58 :: v_dual_mov_b32 v0, s6
; GFX13-NEXT:    v_dual_mov_b32 v3, s57 :: v_dual_mov_b32 v2, s7
; GFX13-NEXT:    v_mov_b32_e32 v5, s56
; GFX13-NEXT:    s_lshr_b32 s51, s1, 16
; GFX13-NEXT:    s_lshr_b32 s52, s0, 16
; GFX13-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX13-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v7, s55
; GFX13-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v9, s54
; GFX13-NEXT:    s_lshr_b32 s50, s30, 16
; GFX13-NEXT:    s_and_b32 s31, s31, 0xffff
; GFX13-NEXT:    s_and_b32 s30, s30, 0xffff
; GFX13-NEXT:    v_dual_mov_b32 v8, s2 :: v_dual_mov_b32 v11, s53
; GFX13-NEXT:    v_dual_mov_b32 v10, s3 :: v_dual_mov_b32 v13, s52
...
; GFX13-NEXT:    v_dual_mov_b32 v12, s0 :: v_dual_mov_b32 v15, s51
; GFX13-NEXT:    v_dual_mov_b32 v14, s1 :: v_dual_mov_b32 v17, s50
...
; GFX13-NEXT:    v_dual_mov_b32 v16, s30 :: v_dual_mov_b32 v19, s49
; GFX13-NEXT:    v_dual_mov_b32 v18, s31 :: v_dual_mov_b32 v21, s48
...
; GFX13-NEXT:    v_dual_mov_b32 v20, s28 :: v_dual_mov_b32 v23, s47
; GFX13-NEXT:    v_mov_b32_e32 v22, s29
; GFX13-NEXT:    s_clause 0x5
...
; GFX13-NEXT:    v_dual_mov_b32 v1, s46 :: v_dual_mov_b32 v0, s26
; GFX13-NEXT:    v_dual_mov_b32 v3, s45 :: v_dual_mov_b32 v2, s27
; GFX13-NEXT:    v_mov_b32_e32 v5, s44
...
; GFX13-NEXT:    v_dual_mov_b32 v4, s24 :: v_dual_mov_b32 v7, s43
; GFX13-NEXT:    v_dual_mov_b32 v6, s25 :: v_dual_mov_b32 v9, s42
...
; GFX13-NEXT:    v_dual_mov_b32 v8, s22 :: v_dual_mov_b32 v11, s41
; GFX13-NEXT:    v_dual_mov_b32 v10, s23 :: v_dual_mov_b32 v13, s40
...
; GFX13-NEXT:    v_dual_mov_b32 v12, s20 :: v_dual_mov_b32 v15, s39
; GFX13-NEXT:    v_dual_mov_b32 v14, s21 :: v_dual_mov_b32 v17, s38
; GFX13-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v19, s35
; GFX13-NEXT:    v_dual_mov_b32 v18, s19 :: v_dual_mov_b32 v21, s34
; GFX13-NEXT:    v_dual_mov_b32 v20, s16 :: v_dual_mov_b32 v23, s33
; GFX13-NEXT:    v_mov_b32_e32 v22, s17
; GFX13-NEXT:    s_clause 0x5
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: constant_zextload_v2i16_to_v2i64:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_mov_b32 s3, s2
; GFX13-TRUE16-NEXT:    s_pack_hl_b32_b16 s2, s2, 0
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-TRUE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, s2
; GFX13-TRUE16-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX13-TRUE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v3, v1
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: constant_zextload_v2i16_to_v2i64:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_load_b32 s2, s[2:3], 0x0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_and_b32 s3, 0xffff, s2
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-FAKE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s3
; GFX13-FAKE16-NEXT:    s_pack_hl_b32_b16 s2, s2, 0
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX13-FAKE16-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, v1
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-FAKE16-NEXT:    s_endpgm
  %load = load <2 x i16>, ptr addrspace(4) %in
...
; GFX13-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_mov_b32 v1, s3
; GFX13-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v3, s5
...
; GFX12-FAKE16-NEXT:    s_endpgm
;
; GFX13-TRUE16-LABEL: constant_zextload_v4i16_to_v4i64:
; GFX13-TRUE16:       ; %bb.0:
; GFX13-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    s_mov_b32 s4, s2
; GFX13-TRUE16-NEXT:    s_pack_hl_b32_b16 s2, s2, 0
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, s2
; GFX13-TRUE16-NEXT:    s_and_b32 s4, 0xffff, s4
; GFX13-TRUE16-NEXT:    s_pack_hl_b32_b16 s2, s3, 0
; GFX13-TRUE16-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v3, v1
; GFX13-TRUE16-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v0, s3
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:16
; GFX13-TRUE16-NEXT:    s_endpgm
;
; GFX13-FAKE16-LABEL: constant_zextload_v4i16_to_v4i64:
; GFX13-FAKE16:       ; %bb.0:
; GFX13-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_load_b64 s[2:3], s[2:3], 0x0
; GFX13-FAKE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-FAKE16-NEXT:    s_and_b32 s4, 0xffff, s2
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-FAKE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s4
; GFX13-FAKE16-NEXT:    s_pack_hl_b32_b16 s2, s2, 0
; GFX13-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX13-FAKE16-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, v1
; GFX13-FAKE16-NEXT:    s_pack_hl_b32_b16 s2, s3, 0
; GFX13-FAKE16-NEXT:    s_and_b32 s3, 0xffff, s3
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1]
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v0, s3
; GFX13-FAKE16-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:16
; GFX13-FAKE16-NEXT:    s_endpgm
  %load = load <4 x i16>, ptr addrspace(4) %in
...
; GFX13-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s5
; GFX13-NEXT:    v_dual_mov_b32 v0, s4 :: v_dual_mov_b32 v5, s7
; GFX13-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v7, s9
; GFX13-NEXT:    v_dual_mov_b32 v6, s8 :: v_dual_mov_b32 v3, s3
; GFX13-NEXT:    v_mov_b32_e32 v2, s2
; GFX13-NEXT:    s_clause 0x1
...
; GFX13-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s13
; GFX13-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x100000
; GFX13-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v4, s2 :: v_dual_mov_b32 v9, s15
; GFX13-NEXT:    v_dual_mov_b32 v8, s14 :: v_dual_mov_b32 v11, s17
; GFX13-NEXT:    v_dual_mov_b32 v10, s16 :: v_dual_mov_b32 v3, s7
; GFX13-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v5, s3
; GFX13-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v13, s9
; GFX13-NEXT:    v_dual_mov_b32 v12, s8 :: v_dual_mov_b32 v15, s11
; GFX13-NEXT:    v_dual_mov_b32 v14, s10 :: v_dual_mov_b32 v7, s5
; GFX13-NEXT:    v_mov_b32_e32 v6, s4
; GFX13-NEXT:    s_clause 0x3
...
; GFX13-NEXT:    v_mov_b32_e32 v2, s1
...
; GFX13-NEXT:    s_lshr_b32 s10, s10, 16
; GFX13-NEXT:    s_bfe_i64 s[8:9], s[8:9], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v24, 0 :: v_dual_mov_b32 v1, s29
...
; GFX13-NEXT:    v_dual_mov_b32 v4, s22 :: v_dual_mov_b32 v9, s31
; GFX13-NEXT:    v_dual_mov_b32 v8, s30 :: v_dual_mov_b32 v11, s35
; GFX13-NEXT:    v_dual_mov_b32 v10, s34 :: v_dual_mov_b32 v3, s9
; GFX13-NEXT:    s_bfe_i64 s[16:17], s[6:7], 0x100000
; GFX13-NEXT:    s_lshr_b32 s6, s6, 16
; GFX13-NEXT:    s_bfe_i64 s[10:11], s[10:11], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v0, s28 :: v_dual_mov_b32 v5, s23
; GFX13-NEXT:    v_dual_mov_b32 v2, s8 :: v_dual_mov_b32 v13, s25
...
; GFX13-NEXT:    v_dual_mov_b32 v12, s24 :: v_dual_mov_b32 v15, s27
; GFX13-NEXT:    v_dual_mov_b32 v14, s26 :: v_dual_mov_b32 v7, s11
; GFX13-NEXT:    s_bfe_i64 s[2:3], s[4:5], 0x100000
; GFX13-NEXT:    s_lshr_b32 s4, s4, 16
; GFX13-NEXT:    s_bfe_i64 s[6:7], s[6:7], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v6, s10 :: v_dual_mov_b32 v17, s19
; GFX13-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GFX13-NEXT:    s_bfe_i64 s[14:15], s[14:15], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v16, s18 :: v_dual_mov_b32 v19, s21
; GFX13-NEXT:    v_mov_b32_e32 v18, s20
; GFX13-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GFX13-NEXT:    s_clause 0x1
; GFX13-NEXT:    global_store_b128 v24, v[8:11], s[0:1] offset:80
; GFX13-NEXT:    global_store_b128 v24, v[0:3], s[0:1] offset:64
; GFX13-NEXT:    v_dual_mov_b32 v1, s17 :: v_dual_mov_b32 v0, s16
; GFX13-NEXT:    v_dual_mov_b32 v3, s7 :: v_dual_mov_b32 v2, s6
; GFX13-NEXT:    v_dual_mov_b32 v9, s13 :: v_dual_mov_b32 v8, s12
; GFX13-NEXT:    v_dual_mov_b32 v11, s15 :: v_dual_mov_b32 v10, s14
; GFX13-NEXT:    v_dual_mov_b32 v21, s3 :: v_dual_mov_b32 v20, s2
; GFX13-NEXT:    v_dual_mov_b32 v23, s5 :: v_dual_mov_b32 v22, s4
; GFX13-NEXT:    s_clause 0x5
...
; GFX13-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v3, s15
; GFX13-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GFX13-NEXT:    s_bfe_i64 s[58:59], s[58:59], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v5, s67
; GFX13-NEXT:    v_dual_mov_b32 v4, s66 :: v_dual_mov_b32 v7, s65
; GFX13-NEXT:    s_bfe_i64 s[52:53], s[52:53], 0x100000
; GFX13-NEXT:    v_dual_mov_b32 v6, s64 :: v_dual_mov_b32 v9, s61
; GFX13-NEXT:    v_dual_mov_b32 v8, s60 :: v_dual_mov_b32 v11, s13
; GFX13-NEXT:    v_dual_mov_b32 v10, s12 :: v_dual_mov_b32 v13, s59
; GFX13-NEXT:    v_dual_mov_b32 v12, s58 :: v_dual_mov_b32 v15, s55
; GFX13-NEXT:    v_dual_mov_b32 v14, s54 :: v_dual_mov_b32 v17, s53
; GFX13-NEXT:    v_mov_b32_e32 v16, s52
; GFX13-NEXT:    s_bfe_i64 s[12:13], s[62:63], 0x100000
; GFX13-NEXT:    s_clause 0x3
; GFX13-NEXT:    global_store_b128 v0, v[2:5], s[16:17] offset:240
; GFX13-NEXT:    global_store_b128 v0, v[6:9], s[16:17] offset:224
; GFX13-NEXT:    global_store_b128 v0, v[10:13], s[16:17] offset:208
; GFX13-NEXT:    global_store_b128 v0, v[14:17], s[16:17] offset:192
; GFX13-NEXT:    v_dual_mov_b32 v3, s51 :: v_dual_mov_b32 v2, s50
; GFX13-NEXT:    v_dual_mov_b32 v5, s13 :: v_dual_mov_b32 v4, s12
; GFX13-NEXT:    v_dual_mov_b32 v7, s57 :: v_dual_mov_b32 v6, s56
; GFX13-NEXT:    v_dual_mov_b32 v9, s49 :: v_dual_mov_b32 v8, s48
; GFX13-NEXT:    v_dual_mov_b32 v11, s45 :: v_dual_mov_b32 v10, s44
; GFX13-NEXT:    v_dual_mov_b32 v13, s47 :: v_dual_mov_b32 v12, s46
; GFX13-NEXT:    v_dual_mov_b32 v15, s35 :: v_dual_mov_b32 v14, s34
; GFX13-NEXT:    v_dual_mov_b32 v17, s43 :: v_dual_mov_b32 v16, s42
; GFX13-NEXT:    v_dual_mov_b32 v19, s41 :: v_dual_mov_b32 v18, s40
; GFX13-NEXT:    v_dual_mov_b32 v21, s39 :: v_dual_mov_b32 v20, s38
; GFX13-NEXT:    v_dual_mov_b32 v23, s21 :: v_dual_mov_b32 v22, s20
; GFX13-NEXT:    v_dual_mov_b32 v25, s37 :: v_dual_mov_b32 v24, s36
; GFX13-NEXT:    s_clause 0x5
; GFX13-NEXT:    global_store_b128 v0, v[2:5], s[16:17] offset:176
; GFX13-NEXT:    global_store_b128 v0, v[6:9], s[16:17] offset:160
; GFX13-NEXT:    global_store_b128 v0, v[10:13], s[16:17] offset:144
; GFX13-NEXT:    global_store_b128 v0, v[14:17], s[16:17] offset:128
; GFX13-NEXT:    global_store_b128 v0, v[18:21], s[16:17] offset:112
; GFX13-NEXT:    global_store_b128 v0, v[22:25], s[16:17] offset:96
; GFX13-NEXT:    v_dual_mov_b32 v3, s31 :: v_dual_mov_b32 v2, s30
; GFX13-NEXT:    v_dual_mov_b32 v5, s29 :: v_dual_mov_b32 v4, s28
; GFX13-NEXT:    v_dual_mov_b32 v7, s3 :: v_dual_mov_b32 v6, s2
; GFX13-NEXT:    v_dual_mov_b32 v9, s27 :: v_dual_mov_b32 v8, s26
; GFX13-NEXT:    v_dual_mov_b32 v11, s25 :: v_dual_mov_b32 v10, s24
; GFX13-NEXT:    v_dual_mov_b32 v13, s23 :: v_dual_mov_b32 v12, s22
; GFX13-NEXT:    v_dual_mov_b32 v15, s1 :: v_dual_mov_b32 v14, s0
; GFX13-NEXT:    v_dual_mov_b32 v17, s11 :: v_dual_mov_b32 v16, s10
; GFX13-NEXT:    v_dual_mov_b32 v19, s9 :: v_dual_mov_b32 v18, s8
; GFX13-NEXT:    v_dual_mov_b32 v21, s7 :: v_dual_mov_b32 v20, s6
; GFX13-NEXT:    v_dual_mov_b32 v23, s19 :: v_dual_mov_b32 v22, s18
; GFX13-NEXT:    v_dual_mov_b32 v25, s5 :: v_dual_mov_b32 v24, s4
; GFX13-NEXT:    s_clause 0x5
; GFX13-NEXT:    global_store_b128 v0, v[2:5], s[16:17] offset:80
; GFX13-NEXT:    global_store_b128 v0, v[6:9], s[16:17] offset:64
; GFX13-NEXT:    global_store_b128 v0, v[10:13], s[16:17] offset:48
; GFX13-NEXT:    global_store_b128 v0, v[14:17], s[16:17] offset:32
; GFX13-NEXT:    global_store_b128 v0, v[18:21], s[16:17] offset:16
; GFX13-NEXT:    global_store_b128 v0, v[22:25], s[16:17]
; GFX13-NEXT:    s_endpgm
  %load = load <32 x i16>, ptr addrspace(4) %in
