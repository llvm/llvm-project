...
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[6:7], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[12:13], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[0:1], s[28:29], 0x100000
...
; GCN-HSA-NEXT:    s_add_u32 s16, s8, 0x60
; GCN-HSA-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s18, -1
; GCN-NOHSA-SI-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s56, s15
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s28, s14, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s58, s13
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s30, s12, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s54, s11
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s34, s10, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s46, s9
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s36, s8, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s52, s7
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s40, s6, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s60, s5
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s42, s4, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s62, s3
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s44, s2, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s64, s1
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s48, s0, 16
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s0
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s33, s1, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s0, s15, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s37, s1, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s0
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[0:1], s[64:65], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s2, s13, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v11, s15
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[14:15], s[62:63], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s2
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s45, s5, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s2, s13, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s47, s5, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s2
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[12:13], s[60:61], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s66
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s49, s7, 31
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s67
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[2:3], s[54:55], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s54, s7, 16
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v18, s50
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[2:3], s[48:49], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v19, s51
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[4:5], s[44:45], 0x100000
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v22, s43
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s37
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s33
...
; GCN-HSA-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    s_mov_b32 s26, s5
; GCN-HSA-NEXT:    s_lshr_b32 s28, s4, 16
; GCN-HSA-NEXT:    s_mov_b32 s34, s3
; GCN-HSA-NEXT:    s_lshr_b32 s44, s2, 16
; GCN-HSA-NEXT:    s_mov_b32 s46, s1
; GCN-HSA-NEXT:    s_lshr_b32 s48, s0, 16
; GCN-HSA-NEXT:    s_mov_b32 s50, s7
; GCN-HSA-NEXT:    s_lshr_b32 s52, s6, 16
...
; GCN-HSA-NEXT:    s_lshr_b32 s60, s10, 16
; GCN-HSA-NEXT:    s_ashr_i32 s61, s11, 31
; GCN-HSA-NEXT:    s_ashr_i32 s63, s11, 16
; GCN-HSA-NEXT:    s_mov_b32 s62, s13
; GCN-HSA-NEXT:    s_lshr_b32 s64, s12, 16
; GCN-HSA-NEXT:    s_ashr_i32 s65, s13, 31
; GCN-HSA-NEXT:    s_ashr_i32 s69, s13, 16
; GCN-HSA-NEXT:    s_mov_b32 s68, s15
; GCN-HSA-NEXT:    s_lshr_b32 s70, s14, 16
...
; GCN-HSA-NEXT:    s_bfe_i64 s[66:67], s[12:13], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[72:73], s[14:15], 0x100000
; GCN-HSA-NEXT:    s_ashr_i32 s74, s15, 16
; GCN-HSA-NEXT:    s_bfe_i64 s[0:1], s[48:49], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[4:5], s[46:47], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[6:7], s[44:45], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[8:9], s[34:35], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[10:11], s[28:29], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[12:13], s[26:27], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[14:15], s[52:53], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[26:27], s[50:51], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[28:29], s[56:57], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[34:35], s[54:55], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[44:45], s[60:61], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[46:47], s[58:59], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[48:49], s[64:65], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[50:51], s[62:63], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[52:53], s[70:71], 0x100000
; GCN-HSA-NEXT:    s_bfe_i64 s[54:55], s[68:69], 0x100000
...
; GCN-HSA-NEXT:    s_add_u32 s30, s16, 0xd0
; GCN-HSA-NEXT:    v_mov_b32_e32 v21, s31
; GCN-HSA-NEXT:    s_addc_u32 s31, s17, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v29, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s54
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s55
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s74
; GCN-HSA-NEXT:    v_mov_b32_e32 v3, s71
; GCN-HSA-NEXT:    v_mov_b32_e32 v30, s31
; GCN-HSA-NEXT:    s_add_u32 s30, s16, 0xc0
; GCN-HSA-NEXT:    flat_store_dwordx4 v[25:26], v[0:3]
; GCN-HSA-NEXT:    s_addc_u32 s31, s17, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, s31
; GCN-HSA-NEXT:    s_add_u32 s30, s16, 0xb0
; GCN-HSA-NEXT:    s_addc_u32 s31, s17, 0
...
; GCN-HSA-NEXT:    s_add_u32 s24, s16, 0xa0
; GCN-HSA-NEXT:    v_mov_b32_e32 v12, s66
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v28, s57
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s63
