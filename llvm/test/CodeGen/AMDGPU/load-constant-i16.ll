...
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s10, s2, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[0:1], s[2:3], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s11, s7, 16
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s18, s3, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s19, s3, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[2:3], s[16:17], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s16, s5, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s17, s5, 16
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v14, s31
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s17
; GCN-HSA-NEXT:    flat_store_dwordx4 v[15:16], v[4:7]
; GCN-HSA-NEXT:    flat_store_dwordx4 v[17:18], v[8:11]
; GCN-HSA-NEXT:    v_mov_b32_e32 v15, s30
; GCN-HSA-NEXT:    flat_store_dwordx4 v[0:1], v[12:15]
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, s6
...
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr51
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr53
; GCN-NOHSA-SI-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NOHSA-SI-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; GCN-NOHSA-SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s55, s11, 16
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v6, s57
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s56
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v10, s55
; GCN-NOHSA-SI-NEXT:    ; implicit-def: $sgpr55
...
; GCN-HSA-NEXT:    s_mov_b32 s46, s13
; GCN-HSA-NEXT:    s_mov_b32 s48, s11
; GCN-HSA-NEXT:    s_mov_b32 s50, s9
; GCN-HSA-NEXT:    s_mov_b32 s52, s7
; GCN-HSA-NEXT:    s_mov_b32 s54, s5
...
; GCN-HSA-NEXT:    s_bfe_i64 s[30:31], s[56:57], 0x100000
...
; GCN-HSA-NEXT:    s_add_u32 s46, s16, 0x70
; GCN-HSA-NEXT:    v_mov_b32_e32 v6, s56
; GCN-HSA-NEXT:    s_addc_u32 s47, s17, 0
; GCN-HSA-NEXT:    v_mov_b32_e32 v10, s76
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s72
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s71
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v18, s28
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v19, s29
