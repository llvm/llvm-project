...
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] scope:SCOPE_SE
; GFX13-TRUE16-NEXT:    s_endpgm
;
...
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] scope:SCOPE_SE
; GFX13-FAKE16-NEXT:    s_endpgm
  %load = load <2 x i16>, ptr addrspace(4) %in
...
; GFX13-TRUE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:16 scope:SCOPE_SE
; GFX13-TRUE16-NEXT:    s_endpgm
;
...
; GFX13-FAKE16-NEXT:    global_store_b128 v1, v[0:3], s[0:1] offset:16 scope:SCOPE_SE
; GFX13-FAKE16-NEXT:    s_endpgm
  %load = load <4 x i16>, ptr addrspace(4) %in
