...
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    s_and_b32 s4, 0xffff, s3
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v2, s4
; GFX12-TRUE16-NEXT:    s_pack_hl_b32_b16 s3, s3, 0
; GFX12-TRUE16-NEXT:    v_and_b32_e64 v0, 0xffff, s2
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, s3 :: v_dual_mov_b32 v5, v3
; GFX12-TRUE16-NEXT:    s_pack_hl_b32_b16 s3, s2, 0
...
; GFX12-TRUE16-NEXT:    global_store_b128 v3, v[0:3], s[0:1]
; GFX12-TRUE16-NEXT:    s_endpgm
;
