...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s15, s9
; GCN-NOHSA-SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s25, s13
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s24, s3
; GCN-NOHSA-SI-NEXT:    s_lshr_b32 s16, s2, 16
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s26, s1
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[0:1], s[26:27], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s26, s3, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s27, s3, 16
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[2:3], s[24:25], 0x100000
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s24, s5, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s25, s5, 16
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s4
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s5
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v4, s25
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v5, s24
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s57, s5, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s58, s5, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s59, s7, 31
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s60, s7, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s61, s9, 31
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[40:41], s[50:51], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[42:43], s[48:49], 0x100000
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[44:45], s[44:45], 0x100000
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v14, s12
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v15, s13
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s70
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s69
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v12, s68
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v13, s67
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v16, s66
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v17, s65
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v22, s64
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v23, s61
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v7, s17
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[20:23], off, s[0:3], 0 offset:144
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v8, s60
...
; GCN-HSA-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GCN-HSA-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GCN-HSA-NEXT:    s_mov_b32 s27, 0
; GCN-HSA-NEXT:    s_mov_b32 s51, s27
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    s_load_dwordx16 s[0:15], s[18:19], 0x0
; GCN-HSA-NEXT:    s_mov_b32 s55, s27
; GCN-HSA-NEXT:    s_mov_b32 s31, s27
; GCN-HSA-NEXT:    s_mov_b32 s57, s27
; GCN-HSA-NEXT:    s_mov_b32 s61, s27
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-HSA-NEXT:    s_mov_b32 s65, s27
; GCN-HSA-NEXT:    s_mov_b32 s69, s27
