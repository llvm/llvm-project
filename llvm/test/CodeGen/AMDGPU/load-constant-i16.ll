...
; GCN-HSA-NEXT:    v_mov_b32_e32 v7, s24
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s24, s13
...
; GCN-NOHSA-SI-NEXT:    s_mov_b32 s22, s1
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[26:27], s[22:23], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s24, s15, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s28, s13, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, s35
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s24
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s22
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v24, s36
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[24:25], s[12:13], 0x100000
...
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s20, s11, 16
; GCN-NOHSA-SI-NEXT:    s_ashr_i32 s22, s9, 16
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v9, s31
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v18, s13
...
; GCN-NOHSA-SI-NEXT:    s_bfe_i64 s[22:23], s[6:7], 0x100000
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v25, s37
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s9
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s7
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v20, s22
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[16:19], 0 offset:48
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v1, s27
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s11
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s5
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
...
; GCN-NOHSA-SI-NEXT:    s_waitcnt expcnt(0)
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v0, s36
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[16:19], 0 offset:224
...
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[8:11], off, s[16:19], 0 offset:192
...
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v19, s9
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[12:15], off, s[16:19], 0 offset:160
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[16:19], off, s[16:19], 0 offset:128
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v22, s6
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v23, s7
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[20:23], off, s[16:19], 0 offset:96
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v26, s4
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v27, s5
; GCN-NOHSA-SI-NEXT:    buffer_store_dwordx4 v[24:27], off, s[16:19], 0 offset:64
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v2, s2
; GCN-NOHSA-SI-NEXT:    v_mov_b32_e32 v3, s3
...
; GCN-HSA-NEXT:    s_mov_b32 s56, s13
; GCN-HSA-NEXT:    s_mov_b32 s58, s11
; GCN-HSA-NEXT:    s_mov_b32 s60, s9
; GCN-HSA-NEXT:    s_mov_b32 s42, s7
...
; GCN-HSA-NEXT:    s_add_u32 s52, s16, 0xe0
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v38, s56
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v33, s29
; GCN-HSA-NEXT:    v_mov_b32_e32 v34, s30
; GCN-HSA-NEXT:    v_mov_b32_e32 v35, s31
; GCN-HSA-NEXT:    v_mov_b32_e32 v1, s15
