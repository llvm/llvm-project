...
; W64-O0-NEXT:    v_mov_b32_e32 v7, v4
; W64-O0-NEXT:    s_waitcnt vmcnt(1)
; W64-O0-NEXT:    v_mov_b32_e32 v8, v2
; W64-O0-NEXT:    buffer_store_dword v5, off, s[0:3], s32 offset:4 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; kill: def $vgpr4 killed $vgpr4 def $vgpr4_vgpr5 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr5 killed $vgpr2 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr2 killed $vgpr3 killed $exec
...
; W64-O0-NEXT:    v_mov_b32_e32 v8, v7
...
; W64-O0-NEXT:    v_mov_b32_e32 v15, v9
; W64-O0-NEXT:    v_mov_b32_e32 v16, v13
; W64-O0-NEXT:    v_mov_b32_e32 v17, v8
...
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    v_mov_b32_e32 v14, v3
; W64-O0-NEXT:    v_mov_b32_e32 v15, v5
; W64-O0-NEXT:    v_mov_b32_e32 v16, v6
; W64-O0-NEXT:    v_mov_b32_e32 v17, v4
...
; W64-O0-NEXT:    ; kill: def $vgpr14 killed $vgpr8 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
...
; W64-O0-NEXT:    ; kill: def $vgpr7 killed $vgpr4 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; kill: def $vgpr3 killed $vgpr3 def $vgpr3_vgpr4 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr4 killed $vgpr5 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
...
; W64-O0-NEXT:    buffer_load_dword v4, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_nop 0
...
; W64-O0-NEXT:    v_mov_b32_e32 v7, v0
; W64-O0-NEXT:    s_or_saveexec_b64 s[16:17], -1
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_mov_b64 exec, s[16:17]
; W64-O0-NEXT:    ; implicit-def: $sgpr4
...
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    v_mov_b32_e32 v13, v7
; W64-O0-NEXT:    v_mov_b32_e32 v14, v2
; W64-O0-NEXT:    v_mov_b32_e32 v15, v8
; W64-O0-NEXT:    v_mov_b32_e32 v16, v10
...
; W64-O0-NEXT:    ; kill: def $vgpr9 killed $vgpr10 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; kill: def $vgpr7 killed $vgpr7 def $vgpr7_vgpr8 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr8 killed $vgpr2 killed $exec
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; implicit-def: $sgpr4
; W64-O0-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
