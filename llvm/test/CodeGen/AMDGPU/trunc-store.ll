...
; VI-NEXT:    flat_store_dword v[0:1], v18
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    s_setpc_b64 s[30:31]
...
; SI-NEXT:    v_and_b32_e32 v10, 0xffff, v24
; SI-NEXT:    v_or_b32_e32 v13, v3, v2
...
; SI-NEXT:    buffer_load_dword v17, off, s[0:3], s32 offset:8
...
; SI-NEXT:    s_mov_b32 s4, s6
; SI-NEXT:    s_mov_b32 s5, s6
; SI-NEXT:    v_or_b32_e32 v6, v6, v31
...
; SI-NEXT:    v_or_b32_e32 v19, v17, v16
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_lshlrev_b32_e32 v16, 16, v21
; SI-NEXT:    v_and_b32_e32 v17, 0xffff, v30
; SI-NEXT:    v_or_b32_e32 v18, v17, v16
; SI-NEXT:    v_lshlrev_b32_e32 v16, 16, v29
; SI-NEXT:    v_and_b32_e32 v17, 0xffff, v28
; SI-NEXT:    v_or_b32_e32 v17, v17, v16
; SI-NEXT:    v_lshlrev_b32_e32 v16, 16, v27
; SI-NEXT:    v_and_b32_e32 v20, 0xffff, v26
; SI-NEXT:    v_or_b32_e32 v16, v20, v16
; SI-NEXT:    buffer_store_dwordx4 v[16:19], v[0:1], s[4:7], 0 addr64 offset:48
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s6, 0x1000504
; VI-NEXT:    v_perm_b32 v23, v22, v23, s6
; VI-NEXT:    v_perm_b32 v22, v20, v21, s6
; VI-NEXT:    v_perm_b32 v21, v18, v19, s6
; VI-NEXT:    v_add_u32_e32 v18, vcc, 32, v0
; VI-NEXT:    v_addc_u32_e32 v19, vcc, 0, v1, vcc
; VI-NEXT:    v_perm_b32 v24, v24, v25, s6
; VI-NEXT:    v_perm_b32 v7, v6, v7, s6
; VI-NEXT:    v_perm_b32 v6, v4, v5, s6
; VI-NEXT:    v_add_u32_e32 v4, vcc, 16, v0
; VI-NEXT:    flat_store_dwordx4 v[18:19], v[21:24]
; VI-NEXT:    v_perm_b32 v16, v16, v17, s6
; VI-NEXT:    v_perm_b32 v15, v14, v15, s6
; VI-NEXT:    v_perm_b32 v14, v12, v13, s6
; VI-NEXT:    v_perm_b32 v13, v10, v11, s6
; VI-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; VI-NEXT:    buffer_load_dword v11, off, s[0:3], s32 offset:16
; VI-NEXT:    buffer_load_dword v12, off, s[0:3], s32 offset:12
; VI-NEXT:    flat_store_dwordx4 v[4:5], v[13:16]
; VI-NEXT:    buffer_load_dword v4, off, s[0:3], s32 offset:24
; VI-NEXT:    buffer_load_dword v13, off, s[0:3], s32 offset:20
; VI-NEXT:    buffer_load_dword v14, off, s[0:3], s32 offset:8
; VI-NEXT:    buffer_load_dword v15, off, s[0:3], s32 offset:4
; VI-NEXT:    buffer_load_dword v16, off, s[0:3], s32
; VI-NEXT:    v_perm_b32 v8, v8, v9, s6
; VI-NEXT:    v_perm_b32 v5, v2, v3, s6
; VI-NEXT:    v_add_u32_e32 v9, vcc, 48, v0
; VI-NEXT:    v_perm_b32 v3, v28, v29, s6
; VI-NEXT:    v_perm_b32 v2, v26, v27, s6
; VI-NEXT:    flat_store_dwordx4 v[0:1], v[5:8]
; VI-NEXT:    v_add_u32_e64 v0, s[4:5], 64, v0
; VI-NEXT:    v_addc_u32_e32 v10, vcc, 0, v1, vcc
; VI-NEXT:    v_addc_u32_e64 v1, vcc, 0, v1, s[4:5]
; VI-NEXT:    s_waitcnt vmcnt(4)
; VI-NEXT:    v_perm_b32 v7, v13, v4, s6
; VI-NEXT:    v_perm_b32 v6, v12, v11, s6
; VI-NEXT:    s_waitcnt vmcnt(2)
; VI-NEXT:    v_perm_b32 v5, v15, v14, s6
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_perm_b32 v4, v30, v16, s6
; VI-NEXT:    flat_store_dwordx4 v[9:10], v[2:5]
