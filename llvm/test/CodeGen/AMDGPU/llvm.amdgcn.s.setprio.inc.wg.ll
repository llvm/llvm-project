...
; RUN: llc -march=amdgcn -mcpu=gfx1210 -show-mc-encoding -verify-machineinstrs < %s | FileCheck -check-prefix=GCN %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 -show-mc-encoding -verify-machineinstrs < %s | FileCheck -check-prefix=GCN %s
