...
; RUN: llc -march=amdgcn -mcpu=gfx1300 -mattr=+setprio-inc-wg-inst -show-mc-encoding -verify-machineinstrs < %s | FileCheck -check-prefix=GFX13 %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1300 -mattr=+setprio-inc-wg-inst -show-mc-encoding -verify-machineinstrs < %s | FileCheck -check-prefix=GFX13 %s
