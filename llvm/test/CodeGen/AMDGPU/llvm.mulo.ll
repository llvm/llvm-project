...
; RUN: llc -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs < %s | FileCheck --check-prefix=GFX11 %s
...
; GFX11-NEXT:    v_mul_lo_u32 v5, v0, v3
; GFX11-NEXT:    v_mul_hi_u32 v6, v0, v2
; GFX11-NEXT:    v_mul_hi_u32 v4, v0, v3
; GFX11-NEXT:    v_mul_lo_u32 v8, v1, v2
; GFX11-NEXT:    v_mul_hi_u32 v7, v1, v2
; GFX11-NEXT:    v_mul_hi_u32 v9, v1, v3
; GFX11-NEXT:    v_mul_lo_u32 v1, v1, v3
; GFX11-NEXT:    v_mul_lo_u32 v0, v0, v2
; GFX11-NEXT:    v_add_co_u32_e64 v10, vcc_lo, v6, v5
; GFX11-NEXT:    v_add_co_ci_u32_e32 v4, vcc_lo, 0, v4, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v3, vcc_lo, v10, v8
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, v4, v7, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v4, vcc_lo, 0, v9, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v3, vcc_lo, v3, v1
; GFX11-NEXT:    v_add3_u32 v1, v6, v5, v8
; GFX11-NEXT:    v_add_co_ci_u32_e32 v4, vcc_lo, 0, v4, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[3:4]
...
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-LABEL: smulo_i64_s_s:
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mul_lo_u32 v15, v0, v3
; GFX11-NEXT:    v_mul_hi_u32 v5, v0, v2
; GFX11-NEXT:    v_mul_hi_u32 v6, v0, v3
; GFX11-NEXT:    v_mul_lo_u32 v8, v1, v2
; GFX11-NEXT:    v_mul_hi_u32 v7, v1, v2
; GFX11-NEXT:    v_mul_hi_i32 v9, v1, v3
; GFX11-NEXT:    v_mul_lo_u32 v11, v1, v3
; GFX11-NEXT:    v_add_co_u32_e64 v10, vcc_lo, v5, v15
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, 0, v6, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v10, vcc_lo, v10, v8
; GFX11-NEXT:    v_add_co_ci_u32_e32 v6, vcc_lo, v6, v7, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0, v9, vcc_lo
; GFX11-NEXT:    v_add_co_u32_e64 v11, vcc_lo, v6, v11
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0, v7, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v9, vcc_lo, v11, v2
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v10, vcc_lo, 0, v7, vcc_lo
; GFX11-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 0, v1
; GFX11-NEXT:    v_add3_u32 v1, v5, v15, v8
; GFX11-NEXT:    v_cndmask_b32_e32 v6, v11, v9, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e32 v7, v7, v10, vcc_lo
; GFX11-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GFX11-NEXT:    v_sub_co_u32_e64 v8, vcc_lo, v6, v0
; GFX11-NEXT:    v_mul_lo_u32 v0, v0, v2
...
; GFX11-NEXT:    v_cmp_ne_u64_e64 s3, s[4:5], 0
; GFX11-NEXT:    s_add_i32 s1, s1, s6
; GFX11-NEXT:    s_mul_i32 s0, s0, s2
; GFX11-NEXT:    v_cndmask_b32_e64 v1, s1, 0, s3
; GFX11-NEXT:    v_cndmask_b32_e64 v0, s0, 0, s3
...
; GFX11-NEXT:    v_cmp_lt_i32_e64 vcc_lo, s1, 0
; GFX11-NEXT:    v_mov_b32_e32 v0, s9
; GFX11-NEXT:    v_mov_b32_e32 v1, s10
; GFX11-NEXT:    s_add_i32 s1, s8, s7
; GFX11-NEXT:    s_add_i32 s1, s1, s5
; GFX11-NEXT:    v_cndmask_b32_e32 v0, s4, v0, vcc_lo
; GFX11-NEXT:    v_cndmask_b32_e32 v1, s6, v1, vcc_lo
; GFX11-NEXT:    s_ashr_i32 s4, s1, 31
; GFX11-NEXT:    s_mov_b32 s5, s4
; GFX11-NEXT:    v_sub_co_u32_e64 v2, vcc_lo, v0, s0
; GFX11-NEXT:    s_mul_i32 s0, s0, s2
; GFX11-NEXT:    v_subrev_co_ci_u32_e32 v3, vcc_lo, 0, v1, vcc_lo
; GFX11-NEXT:    v_cmp_lt_i32_e64 vcc_lo, s3, 0
...
; GFX11-NEXT:    v_ashrrev_i64 v[6:7], 2, v[4:5]
