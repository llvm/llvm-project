...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    v_mul_lo_u32 v4, v0, v3
...
; GFX11-NEXT:    v_add_co_u32_e64 v10, vcc_lo, v5, v4
...
; GFX11-NEXT:    v_add_co_u32_e64 v6, vcc_lo, v6, v11
; GFX11-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0, v7, vcc_lo
; GFX11-NEXT:    v_sub_co_u32_e64 v9, vcc_lo, v6, v2
