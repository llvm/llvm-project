...
; RUN: llc -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210-SDAG %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210-GISEL %s
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:0x11
; GCN-NEXT:    ; return to shader part epilog
...
; GCN-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:0x12
; GCN-NEXT:    ; return to shader part epilog
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_bitop3_b32 v0, v0, v1, 0x3e8 bitop3:0x13
; GCN-NEXT:    ; return to shader part epilog
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_bitop3_b16 v0, s0, s1, v0 bitop3:0x11
; GCN-NEXT:    ; return to shader part epilog
...
; GCN-NEXT:    v_mov_b32_e32 v0, s2
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_bitop3_b16 v0, s0, s1, v0 bitop3:0x12
; GCN-NEXT:    ; return to shader part epilog
...
; GCN:       ; %bb.0:
; GCN-NEXT:    v_bitop3_b16 v0, v0, v1, 0x3e8 bitop3:0x13
; GCN-NEXT:    ; return to shader part epilog
