...
; RUN: llc -mtriple=amdgcn -mcpu=gfx950 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX950,GFX950-SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx950 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX950,GFX950-GISEL %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel -mtriple=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1210,GFX1210-GISEL %s
...
;
; GFX1210-LABEL: bitop3_b32_ssv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:0x11
...
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: bitop3_b32_sss:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_bitop3_b32 v0, s0, s1, v0 bitop3:0x12
; GFX1210-NEXT:    ; return to shader part epilog
...
;
; GFX1210-LABEL: bitop3_b32_vvi:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bitop3_b32 v0, v0, v1, 0x3e8 bitop3:0x13
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: bitop3_b32_vii:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_movk_i32 s0, 0x7d0
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, v0, s0, 0x3e8 bitop3:0x14
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: bitop3_b32_vii:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v1, 0x3e8
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bitop3_b32 v0, v0, 0x7d0, v1 bitop3:0x14
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: bitop3_b32_iii:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v0, 0x3e8
; GFX1210-SDAG-NEXT:    s_movk_i32 s0, 0xbb8
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1210-SDAG-NEXT:    v_bitop3_b32 v0, s0, 0x7d0, v0 bitop3:0x15
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: bitop3_b32_iii:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v0, 0x7d0
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v1, 0x3e8
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bitop3_b32 v0, 0xbb8, v0, v1 bitop3:0x15
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
...
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: bitop3_b16_ssv:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bitop3_b16 v0, s0, s1, v0 bitop3:0x11
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX950-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: bitop3_b16_sss:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_mov_b32_e32 v0, s2
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_bitop3_b16 v0, s0, s1, v0 bitop3:0x12
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-LABEL: bitop3_b16_vvi:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_bitop3_b16 v0, v0, v1, 0x3e8 bitop3:0x13
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: bitop3_b16_vii:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_movk_i32 s0, 0x7d0
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-SDAG-NEXT:    v_bitop3_b16 v0, v0, s0, 0x3e8 bitop3:0x14
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: bitop3_b16_vii:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v1, 0x3e8
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bitop3_b16 v0, v0, 0x7d0, v1 bitop3:0x14
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
...
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX1210-SDAG-LABEL: bitop3_b16_iii:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    v_mov_b32_e32 v0, 0x3e8
; GFX1210-SDAG-NEXT:    s_movk_i32 s0, 0xbb8
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instid1(SALU_CYCLE_1)
; GFX1210-SDAG-NEXT:    v_bitop3_b16 v0, s0, 0x7d0, v0 bitop3:0x15
; GFX1210-SDAG-NEXT:    ; return to shader part epilog
;
; GFX1210-GISEL-LABEL: bitop3_b16_iii:
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v0, 0x7d0
; GFX1210-GISEL-NEXT:    v_mov_b32_e32 v1, 0x3e8
; GFX1210-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-GISEL-NEXT:    v_bitop3_b16 v0, 0xbb8, v0, v1 bitop3:0x15
; GFX1210-GISEL-NEXT:    ; return to shader part epilog
