...
; RUN: opt -S -mtriple=amdgpu12.00-- -passes=amdgpu-lower-exec-sync,amdgpu-lower-module-lds < %s 2>&1 | FileCheck %s
; RUN: llc < %s -enable-new-pm -stop-after=amdgpu-lower-module-lds -mtriple=amdgpu12.00-amd-amdhsa | FileCheck %s
