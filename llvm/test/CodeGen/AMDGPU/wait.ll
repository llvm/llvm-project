...
; DEFAULT-NEXT:    s_load_dwordx8 s[0:7], s[6:7], 0x0
; DEFAULT-NEXT:    s_mov_b32 s9, s12
; DEFAULT-NEXT:    s_mov_b32 s8, s11
; DEFAULT-NEXT:    s_waitcnt lgkmcnt(0)
; DEFAULT-NEXT:    buffer_load_format_xyzw v[1:4], v0, s[0:3], 0 idxen
; DEFAULT-NEXT:    ; wave barrier
; DEFAULT-NEXT:    buffer_load_format_xyzw v[4:7], v0, s[4:7], 0 idxen
; DEFAULT-NEXT:    s_load_dword s0, s[8:9], 0x0
; DEFAULT-NEXT:    s_waitcnt lgkmcnt(0)
; DEFAULT-NEXT:    v_mov_b32_e32 v0, s0
; DEFAULT-NEXT:    s_waitcnt vmcnt(1)
; DEFAULT-NEXT:    exp pos0, v1, v2, v3, v0 done
; DEFAULT-NEXT:    s_waitcnt vmcnt(0)
; DEFAULT-NEXT:    exp param0, v4, v5, v6, v7
; DEFAULT-NEXT:    s_endpgm
;
; ILPMAX-LABEL: main:
; ILPMAX:       ; %bb.0: ; %main_body
; ILPMAX-NEXT:    s_load_dwordx8 s[0:7], s[6:7], 0x0
; ILPMAX-NEXT:    s_mov_b32 s9, s12
; ILPMAX-NEXT:    s_mov_b32 s8, s11
; ILPMAX-NEXT:    s_waitcnt lgkmcnt(0)
; ILPMAX-NEXT:    buffer_load_format_xyzw v[1:4], v0, s[0:3], 0 idxen
; ILPMAX-NEXT:    ; wave barrier
; ILPMAX-NEXT:    buffer_load_format_xyzw v[4:7], v0, s[4:7], 0 idxen
; ILPMAX-NEXT:    s_load_dword s0, s[8:9], 0x0
; ILPMAX-NEXT:    s_waitcnt lgkmcnt(0)
; ILPMAX-NEXT:    v_mov_b32_e32 v0, s0
; ILPMAX-NEXT:    s_waitcnt vmcnt(1)
; ILPMAX-NEXT:    exp pos0, v1, v2, v3, v0 done
; ILPMAX-NEXT:    s_waitcnt vmcnt(0)
; ILPMAX-NEXT:    exp param0, v4, v5, v6, v7
; ILPMAX-NEXT:    s_endpgm
main_body:
