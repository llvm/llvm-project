...
; GFX11-TRUE16-NEXT:    s_and_b32 s1, s2, 0x7fff
...
; GFX11-FAKE16-NEXT:    s_and_b32 s1, s2, 0x7fff
...
; GFX11-NEXT:    s_and_b32 s1, s2, 0x7fff7fff
...
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_and_b32 s0, s0, 0xffff
; CI-NEXT:    s_and_b32 s1, s3, 0x7fff7fff
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_and_b32 s0, s0, 0xffff
; VI-NEXT:    s_and_b32 s1, s3, 0x7fff
; VI-NEXT:    s_lshr_b32 s3, s3, 16
; VI-NEXT:    v_mov_b32_e32 v0, s0
; VI-NEXT:    s_and_b32 s0, 0xffff, s1
; VI-NEXT:    s_and_b32 s1, s3, 0x7fff
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_and_b32 s1, s2, 0x7fff
...
; GFX11-NEXT:    v_mul_f32_e64 v0, s1, s2
; GFX11-NEXT:    s_mov_b32 s1, 0
...
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_add_i32_e32 v0, vcc, s2, v0
; CI-NEXT:    v_addc_u32_e64 v1, s[2:3], 0, 0, vcc
; CI-NEXT:    flat_load_dword v2, v[0:1]
; CI-NEXT:    s_load_dword s1, s[8:9], 0x4
; CI-NEXT:    v_mov_b32_e32 v0, s0
; CI-NEXT:    v_mov_b32_e32 v1, 0
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    s_lshl_b32 s0, s1, 16
; CI-NEXT:    s_and_b32 s1, s1, 0xffff0000
; CI-NEXT:    s_waitcnt vmcnt(0)
