...
; RUN: llc -mtriple=amdgpu7.00--amdhsa < %s | FileCheck -enable-var-scope -check-prefixes=CI %s
; RUN: llc -mtriple=amdgpu8.02--amdhsa < %s | FileCheck -enable-var-scope -check-prefixes=VI %s
; RUN: llc -mtriple=amdgpu9.00--amdhsa < %s | FileCheck -enable-var-scope -check-prefixes=GFX9 %s
; RUN: llc -mtriple=amdgpu11.00--amdhsa -mattr=+real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-TRUE16 %s
; RUN: llc -mtriple=amdgpu11.00--amdhsa -mattr=-real-true16 < %s | FileCheck -enable-var-scope -check-prefixes=GFX11,GFX11-FAKE16 %s
...
; GFX11-TRUE16-NEXT:    s_and_b32 s4, s4, 0x7fff
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v1, s4
; GFX11-TRUE16-NEXT:    s_and_b32 s3, s3, 0x7fff
; GFX11-TRUE16-NEXT:    s_and_b32 s4, s5, 0x7fff
; GFX11-TRUE16-NEXT:    v_and_b32_e64 v0, 0x7fff, s2
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s2, s3, s4
...
; GFX11-TRUE16-NEXT:    v_and_b16 v2.l, 0x7fff, v0.h
...
; GFX11-FAKE16-NEXT:    v_mul_f32_e32 v2, v2, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
