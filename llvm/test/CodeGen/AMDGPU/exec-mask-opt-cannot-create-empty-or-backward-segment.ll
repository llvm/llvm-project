...
; CHECK-NEXT:    s_xor_b64 s[14:15], s[6:7], -1
...
; CHECK-NEXT:    s_mov_b64 s[20:21], s[8:9]
; CHECK-NEXT:    s_bitcmp0_b32 s14, 0
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_mov_b64 s[18:19], -1
; CHECK-NEXT:    s_bitcmp0_b32 s20, 0
; CHECK-NEXT:    s_mov_b64 s[20:21], -1
...
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_bitcmp0_b32 s18, 0
