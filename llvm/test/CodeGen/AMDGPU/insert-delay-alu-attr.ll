...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 %s -o - | FileCheck %s
...
define amdgpu_kernel void @delay_alu_waves_1_8() #0 {
...
define amdgpu_kernel void @delay_alu_waves_1_1() #1 {
...
define amdgpu_kernel void @delay_alu_waves_1_1_wgsize() #2 {
...
attributes #0 = { "amdgpu-waves-per-eu"="1,8" }
attributes #1 = { "amdgpu-waves-per-eu"="1,1" }
attributes #2 = { "amdgpu-flat-work-group-size"="1,128" "amdgpu-waves-per-eu"="1,1" }
