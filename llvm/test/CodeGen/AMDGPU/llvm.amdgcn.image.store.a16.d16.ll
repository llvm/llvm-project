...
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %bitcast = bitcast <2 x i32> %val to <4 x half>
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x7 dim:SQ_RSRC_IMG_1D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %bitcast = bitcast <2 x i32> %val to <4 x half>
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0xf dim:SQ_RSRC_IMG_1D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %bitcast = bitcast <2 x i32> %val to <4 x half>
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_2D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %y = extractelement <2 x i16> %coords, i32 1
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0x7 dim:SQ_RSRC_IMG_2D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %y = extractelement <2 x i16> %coords, i32 1
...
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_store v[1:2], v0, s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D scope:SCOPE_SE a16 d16
; GFX13-NEXT:    s_endpgm
main_body:
  %x = extractelement <2 x i16> %coords, i32 0
  %y = extractelement <2 x i16> %coords, i32 1
