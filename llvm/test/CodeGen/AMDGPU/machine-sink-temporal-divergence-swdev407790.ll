...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s5, v44
; CHECK-NEXT:    s_add_i32 s5, s5, 1
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc_lo, s5, v42
; CHECK-NEXT:    ds_write_b8 v0, v45 offset:15364
...
; CHECK-NEXT:    v_or3_b32 v56, s5, v43, s53
; CHECK-NEXT:    v_mov_b32_e32 v57, s53
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_read_u8 v47, v0 offset:15364
...
; CHECK-NEXT:    v_mov_b32_e32 v57, s69
...
; CHECK-NEXT:    v_add_nc_u32_e32 v57, s69, v44
; CHECK-NEXT:    s_mov_b32 s69, s4
; CHECK-NEXT:    ds_read_u8 v0, v57 offset:15364
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s5, v47, v0 src0_sel:BYTE_0 src1_sel:DWORD
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s80
; CHECK-NEXT:    ds_read_u8 v0, v57 offset:15365
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_add_nc_u32_e32 v58, 1, v56
; CHECK-NEXT:    v_add_nc_u32_e32 v46, 1, v46
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s80
; CHECK-NEXT:    ds_read_u8 v0, v57 offset:15366
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v47, v0 src0_sel:BYTE_0 src1_sel:DWORD
; CHECK-NEXT:    s_and_saveexec_b32 s80, s4
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_add_nc_u32_e32 v58, 2, v56
; CHECK-NEXT:    v_add_nc_u32_e32 v46, 1, v46
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s80
; CHECK-NEXT:    ds_read_u8 v0, v57 offset:15367
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v47, v0 src0_sel:BYTE_0 src1_sel:DWORD
; CHECK-NEXT:    s_and_saveexec_b32 s80, s4
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_add_nc_u32_e32 v57, 3, v56
; CHECK-NEXT:    v_add_nc_u32_e32 v46, 1, v46
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CHECK-NEXT:  .LBB0_16: ; %Flow30
; CHECK-NEXT:    ; in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s68
; CHECK-NEXT:  .LBB0_17: ; %Flow31
; CHECK-NEXT:    ; in Loop: Header=BB0_5 Depth=1
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s55
; CHECK-NEXT:    s_mov_b32 s55, exec_lo
; CHECK-NEXT:    v_cmpx_lt_u32_e32 v57, v42
...
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, v57, v42
; CHECK-NEXT:    s_or_b32 s68, vcc_lo, s68
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s68
...
; CHECK-NEXT:    v_or3_b32 v47, s6, v42, s53
; CHECK-NEXT:    v_mov_b32_e32 v56, s53
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_read_u8 v46, v0 offset:15364
; CHECK-NEXT:    s_mov_b32 s4, exec_lo
...
; CHECK-NEXT:    v_add_nc_u32_e32 v47, 4, v47
; CHECK-NEXT:    v_mov_b32_e32 v56, s5
...
; CHECK-NEXT:  ; %bb.4: ; %Flow15
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s6
; CHECK-NEXT:  .LBB1_5: ; %Flow16
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s4
; CHECK-NEXT:    s_mov_b32 s54, exec_lo
; CHECK-NEXT:    v_cmpx_lt_u32_e32 v56, v41
...
attributes #0 = { convergent mustprogress nofree nounwind willreturn memory(none) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+16-bit-insts,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+gfx10-3-insts,+gfx10-insts,+gfx8-insts,+gfx9-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize32" }
attributes #1 = { convergent nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+16-bit-insts,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+gfx10-3-insts,+gfx10-insts,+gfx8-insts,+gfx9-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize32" }
attributes #2 = { convergent norecurse nounwind "amdgpu-flat-work-group-size"="64,64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+16-bit-insts,+ci-insts,+dl-insts,+dot1-insts,+dot10-insts,+dot2-insts,+dot5-insts,+dot6-insts,+dot7-insts,+dpp,+gfx10-3-insts,+gfx10-insts,+gfx8-insts,+gfx9-insts,+s-memrealtime,+s-memtime-inst,+wavefrontsize32" "uniform-work-group-size" }
