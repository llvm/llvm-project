...
; CHECK-NEXT:    s_add_u32 s52, s52, _Z10atomic_incPU3AS3Vj@rel32@lo+4
; CHECK-NEXT:    s_addc_u32 s53, s53, _Z10atomic_incPU3AS3Vj@rel32@hi+12
...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s69, v44
; CHECK-NEXT:    s_lshl_b32 s4, s69, 5
; CHECK-NEXT:    s_add_i32 s68, s69, 1
; CHECK-NEXT:    s_add_i32 s5, s69, 5
; CHECK-NEXT:    v_or3_b32 v57, s4, v43, s68
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_read_u8 v56, v0
; CHECK-NEXT:    v_mov_b32_e32 v58, s68
; CHECK-NEXT:    s_mov_b32 s80, exec_lo
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s83
; CHECK-NEXT:    s_add_i32 s82, s82, 4
; CHECK-NEXT:    s_add_i32 s4, s69, s82
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s82, v57
...
; CHECK-NEXT:    s_or_b32 s81, vcc_lo, s81
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s81
; CHECK-NEXT:    s_cbranch_execz .LBB0_16
; CHECK-NEXT:  .LBB0_8: ; Parent Loop BB0_5 Depth=1
; CHECK-NEXT:    ; => This Inner Loop Header: Depth=2
; CHECK-NEXT:    v_add_nc_u32_e32 v59, s82, v46
; CHECK-NEXT:    v_add_nc_u32_e32 v58, s82, v57
; CHECK-NEXT:    ds_read_u8 v0, v59
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v56, v0 src0_sel:BYTE_0 src1_sel:DWORD
; CHECK-NEXT:    s_and_saveexec_b32 s83, s4
...
; CHECK-NEXT:    s_mov_b32 s69, exec_lo
...
; CHECK-NEXT:    s_or_b32 s80, vcc_lo, s80
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s80
...
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s68, v45
...
; CHECK-NEXT:    s_or_b32 s55, s4, s55
...
; CHECK-NEXT:  ; %bb.26:
; CHECK-NEXT:    s_getpc_b64 s[52:53]
; CHECK-NEXT:    s_add_u32 s52, s52, _Z10atomic_addPU3AS1Vjj@rel32@lo+4
; CHECK-NEXT:    s_addc_u32 s53, s53, _Z10atomic_addPU3AS1Vjj@rel32@hi+12
; CHECK-NEXT:    s_mov_b32 s80, 0
; CHECK-NEXT:    s_getpc_b64 s[54:55]
; CHECK-NEXT:    s_add_u32 s54, s54, _Z10atomic_subPU3AS1Vjj@rel32@lo+4
; CHECK-NEXT:    s_addc_u32 s55, s55, _Z10atomic_subPU3AS1Vjj@rel32@hi+12
; CHECK-NEXT:    s_getpc_b64 s[68:69]
; CHECK-NEXT:    s_add_u32 s68, s68, _Z14get_local_sizej@rel32@lo+4
; CHECK-NEXT:    s_addc_u32 s69, s69, _Z14get_local_sizej@rel32@hi+12
...
; CHECK-NEXT:    s_mov_b32 s81, exec_lo
...
; CHECK-NEXT:    s_add_i32 s55, s4, 1
; CHECK-NEXT:    s_add_i32 s6, s4, 5
; CHECK-NEXT:    v_or3_b32 v47, s5, v42, s55
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_read_u8 v46, v0
; CHECK-NEXT:    v_mov_b32_e32 v56, s55
...
; CHECK-NEXT:    s_and_saveexec_b32 s66, s4
...
; CHECK-NEXT:  ; %bb.12: ; %.32
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s55, v45
; CHECK-NEXT:    v_cmp_lt_u32_e64 s4, 59, v43
; CHECK-NEXT:    s_or_b32 s4, vcc_lo, s4
; CHECK-NEXT:    s_and_b32 s4, exec_lo, s4
; CHECK-NEXT:    s_or_b32 s54, s4, s54
; CHECK-NEXT:    s_mov_b32 s4, s55
