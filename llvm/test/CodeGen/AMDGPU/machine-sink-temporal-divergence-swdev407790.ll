...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    ds_write_b32 v42, v42 offset:15360
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s80, v45
...
; CHECK-NEXT:    s_and_saveexec_b32 s81, s5
...
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s80, v45
; CHECK-NEXT:    ds_read_u8 v0, v0 offset:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_add_nc_u32_e32 v58, 1, v57
; CHECK-NEXT:    v_add_nc_u32_e32 v47, 1, v47
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s81
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s80, v45
; CHECK-NEXT:    ds_read_u8 v0, v0 offset:2
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v56, v0 src0_sel:BYTE_0 src1_sel:DWORD
; CHECK-NEXT:    s_and_saveexec_b32 s81, s4
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_add_nc_u32_e32 v58, 2, v57
; CHECK-NEXT:    v_add_nc_u32_e32 v47, 1, v47
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
...
; CHECK-NEXT:    s_or_b32 exec_lo, exec_lo, s81
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s80, v45
; CHECK-NEXT:    ds_read_u8 v0, v0 offset:3
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v56, v0 src0_sel:BYTE_0 src1_sel:DWORD
...
; CHECK-NEXT:    ; implicit-def: $sgpr15
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_mul_lo_u32 v43, v0, 14
; CHECK-NEXT:    v_mov_b32_e32 v31, v40
; CHECK-NEXT:    v_mov_b32_e32 v0, 1
; CHECK-NEXT:    s_getpc_b64 s[16:17]
; CHECK-NEXT:    s_add_u32 s16, s16, _Z7barrierj@rel32@lo+4
...
; CHECK-NEXT:    s_mov_b32 s13, s50
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    ds_write_b32 v41, v41 offset:15360
; CHECK-NEXT:    v_add_nc_u32_e32 v44, 0x3c04, v43
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
...
; CHECK-NEXT:    ds_write_b8 v43, v45 offset:15364
...
; CHECK-NEXT:    v_add_nc_u32_e32 v45, 1, v45
...
; CHECK-NEXT:    ; Parent Loop BB1_1 Depth=1
; CHECK-NEXT:    ; => This Inner Loop Header: Depth=2
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v43, v57
; CHECK-NEXT:    ds_read_u8 v0, v0 offset:15364
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s53, v46
; CHECK-NEXT:    v_cmp_lt_u32_e64 s4, 59, v45
; CHECK-NEXT:    s_or_b32 s4, vcc_lo, s4
; CHECK-NEXT:    s_and_b32 s4, exec_lo, s4
