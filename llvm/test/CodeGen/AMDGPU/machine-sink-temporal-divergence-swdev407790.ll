...
; CHECK-NEXT:    s_lshl_b32 s5, s55, 5
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s4, v45
; CHECK-NEXT:    s_add_i32 s55, s55, 1
; CHECK-NEXT:    s_add_i32 s4, s4, 5
; CHECK-NEXT:    v_or3_b32 v57, s5, v43, s55
; CHECK-NEXT:    v_mov_b32_e32 v58, s55
...
; CHECK-NEXT:    v_add_nc_u32_e32 v58, s81, v45
; CHECK-NEXT:    s_mov_b32 s81, s4
; CHECK-NEXT:    ds_read_u8 v0, v58
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s5, v56, v0 src0_sel:BYTE_0 src1_sel:DWORD
; CHECK-NEXT:    s_and_saveexec_b32 s82, s5
...
; CHECK-NEXT:    s_and_saveexec_b32 s82, s4
...
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s55, v46
; CHECK-NEXT:    v_cmp_lt_u32_e64 s4, 59, v47
; CHECK-NEXT:    s_or_b32 s4, vcc_lo, s4
; CHECK-NEXT:    s_and_b32 s4, exec_lo, s4
; CHECK-NEXT:    s_or_b32 s68, s4, s68
...
; CHECK-NEXT:    s_mov_b32 s4, s55
; CHECK-NEXT:    s_lshl_b32 s6, s55, 5
; CHECK-NEXT:    v_add_nc_u32_e32 v0, s4, v45
; CHECK-NEXT:    s_add_i32 s55, s55, 1
; CHECK-NEXT:    s_add_i32 s5, s4, 5
; CHECK-NEXT:    v_or3_b32 v56, s6, v42, s55
; CHECK-NEXT:    v_mov_b32_e32 v57, s55
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
