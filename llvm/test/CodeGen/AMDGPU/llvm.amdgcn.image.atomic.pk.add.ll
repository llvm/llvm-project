...
; RUN: llc -mtriple=amdgpu12.00 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -mtriple=amdgpu12.00 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX12 %s
; RUN: llc -mtriple=amdgpu13.10 -global-isel=0 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13 %s
; RUN: llc -mtriple=amdgpu13.10 -global-isel=1 -global-isel-abort=2 < %s | FileCheck -check-prefixes=GFX12PLUS,GFX13 %s
...
;
; GFX13-LABEL: atomic_pk_add_bf16_1d_v2:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_atomic_pk_add_bf16 v0, v1, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-NEXT:    v_dual_mov_b32 v2, 0 :: v_dual_mov_b32 v3, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    flat_store_b32 v[2:3], v0
; GFX13-NEXT:    v_mov_b32_e32 v0, 1.0
...
; GFX12-NEXT:    ; return to shader part epilog
;
; GFX13-LABEL: atomic_pk_add_bf16_1d_v4:
; GFX13:       ; %bb.0: ; %main_body
; GFX13-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_RETURN
; GFX13-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v4, 0
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    flat_store_b64 v[3:4], v[0:1]
; GFX13-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-NEXT:    s_wait_dscnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
main_body:
