...
; RUN: llc -mtriple=amdgcn -global-isel=0 -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX13-SDAG %s
; RUN: llc -mtriple=amdgcn -global-isel=1 -mcpu=gfx1200 -verify-machineinstrs < %s | FileCheck -check-prefix=GFX13-GISEL %s
...
; GFX13-GISEL:       ; %bb.0: ; %main_body
; GFX13-GISEL-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GFX13-GISEL-NEXT:    v_lshrrev_b32_e32 v4, 16, v1
; GFX13-GISEL-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX13-GISEL-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-GISEL-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX13-GISEL-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX13-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-GISEL-NEXT:    v_or_b32_e32 v0, v3, v0
; GFX13-GISEL-NEXT:    v_or_b32_e32 v1, v4, v1
...
; GFX13-SDAG:       ; %bb.0: ; %main_body
; GFX13-SDAG-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GFX13-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX13-GISEL-NEXT:    v_or_b32_e32 v0, v3, v0
; GFX13-GISEL-NEXT:    v_or_b32_e32 v1, v4, v1
; GFX13-GISEL-NEXT:    image_atomic_pk_add_bf16 v[0:1], v2, s[0:7] dmask:0x3 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT_RETURN
; GFX13-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v0, 1.0
; GFX13-GISEL-NEXT:    ; return to shader part epilog
main_body:
