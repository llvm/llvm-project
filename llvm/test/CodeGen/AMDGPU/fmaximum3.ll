...
; GFX942-NEXT:    v_mov_b32_e32 v9, 0x7e00
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, |v1|, |v3| src0_sel:WORD_1 src1_sel:WORD_1
; GFX942-NEXT:    v_pk_max_f16 v6, v6, v8
; GFX942-NEXT:    s_mov_b32 s0, 0x5040100
; GFX942-NEXT:    v_cndmask_b32_sdwa v12, v9, v7, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, |v0|, |v2| src0_sel:WORD_1 src1_sel:WORD_1
; GFX942-NEXT:    v_and_b32_e32 v11, 0x7fff7fff, v4
; GFX942-NEXT:    v_and_b32_e32 v10, 0x7fff7fff, v5
; GFX942-NEXT:    v_cndmask_b32_sdwa v8, v9, v6, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, |v1|, |v3|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v9, v7, vcc
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, |v0|, |v2|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v9, v6, vcc
...
; GFX942-NEXT:    v_perm_b32 v6, v12, v1, s0
; GFX942-NEXT:    v_pk_max_f16 v6, v6, v10
; GFX942-NEXT:    v_cndmask_b32_sdwa v3, v9, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v1, |v5|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v9, v6, vcc
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v0, |v4|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v9, v2, vcc
; GFX942-NEXT:    v_perm_b32 v0, v3, v0, s0
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, |v0|, |v2|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v9, v7, vcc
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, |v1|, |v3|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v9, v6, vcc
...
; GFX942-NEXT:    v_perm_b32 v6, v12, v0, s0
; GFX942-NEXT:    v_pk_max_f16 v6, v6, v10
; GFX942-NEXT:    v_cndmask_b32_sdwa v3, v9, v2, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v12, |v4| src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v7, v9, v6, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v1, |v5|
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v9, v2, vcc
; GFX942-NEXT:    v_cmp_o_f16_e64 vcc, v0, |v4|
...
; GFX942-NEXT:    v_perm_b32 v8, v6, v0, s0
; GFX942-NEXT:    v_pk_max_f16 v8, v8, v2
; GFX942-NEXT:    v_cndmask_b32_sdwa v7, v5, v4, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_sdwa vcc, v6, v2 src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_sdwa v6, v5, v8, vcc dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v1, v3
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v5, v4, vcc
; GFX942-NEXT:    v_cmp_o_f16_e32 vcc, v0, v2
...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v5, v8, vcc
