...
; RUN: llc -mtriple=amdgpu7.04--amdpal -mattr=+load-store-opt < %s | FileCheck -enable-var-scope --check-prefix=CI %s
; RUN: llc -mtriple=amdgpu9.00--amdpal -mattr=+load-store-opt,-unaligned-access-mode < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-ALIGNED %s
; RUN: llc -mtriple=amdgpu9.00--amdpal -mattr=+load-store-opt,+unaligned-access-mode < %s | FileCheck -enable-var-scope -check-prefixes=GFX9,GFX9-UNALIGNED %s
...
; CI-NEXT:    ds_read_u16 v3, v1 offset:34
; CI-NEXT:    ds_read_u16 v4, v1 offset:32
...
; CI-NEXT:    s_mov_b32 m0, -1
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_add_i32_e32 v2, vcc, s2, v1
; CI-NEXT:    v_add_i32_e32 v3, vcc, s3, v0
; CI-NEXT:    v_add_i32_e32 v4, vcc, s4, v1
; CI-NEXT:    v_add_i32_e32 v6, vcc, s5, v0
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_add_u32_e32 v2, s2, v1
; GFX9-NEXT:    v_add_u32_e32 v3, s3, v0
...
; CI-NEXT:    s_mov_b32 s36, s16
; CI-NEXT:    s_mov_b32 s37, s17
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_lshl_add_u32 v41, v0, 2, s38
...
; GFX9-NEXT:    global_store_dword v40, v0, s[36:37]
; GFX9-NEXT:    s_endpgm
