...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -amdgpu-load-store-vectorizer=0 < %s | FileCheck -check-prefixes=GCN,SI %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu7.04 -amdgpu-load-store-vectorizer=0 < %s | FileCheck -check-prefixes=GCN,CI %s
...
; SI-NEXT:    buffer_store_dwordx4 v[3:6], off, s[0:3], 0
; SI-NEXT:    s_endpgm
;
...
; CI-NEXT:    buffer_store_dwordx4 v[3:6], off, s[0:3], 0
; CI-NEXT:    s_endpgm
  %out.gep.1 = getelementptr i32, ptr addrspace(1) %out, i32 1
  %out.gep.2 = getelementptr i32, ptr addrspace(1) %out, i32 2
  %out.gep.3 = getelementptr i32, ptr addrspace(1) %out, i32 3
