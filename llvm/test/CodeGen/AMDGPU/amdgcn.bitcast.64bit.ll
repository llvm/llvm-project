...
;
; GFX13-LABEL: bitcast_i64_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_lshr_b32 s4, s1, 16
; GFX13-NEXT:    s_lshr_b32 s5, s1, 8
; GFX13-NEXT:    s_lshr_b32 s6, s0, 16
; GFX13-NEXT:    s_lshr_b32 s7, s0, 8
...
; GFX13-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s7
; GFX13-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v3, s2
; GFX13-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, s5
; GFX13-NEXT:    v_dual_mov_b32 v6, s4 :: v_dual_mov_b32 v7, s3
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
; GFX13-NEXT:  .LBB25_4:
...
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v4.h, 8, v1.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v3.l, 8, v3.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 8, v5.h
...
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v0.l, v5.l, v4.h, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v1.l, v4.l, v3.h, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v3.h, v2.h, v3.l, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v3.l, 0
...
; GFX13-TRUE16-NEXT:    v_or_b32_e32 v0, v0, v3
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v3.h, v6.l, v2.l, 0xff bitop3:0xec
...
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v0.h, v4.l, 3
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v1.l, v2.h, 3
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.l, 0
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v0.l, v4.h, v0.l, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v0.h, v3.h, v0.h, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v1.l, v3.l, v1.l, 0xff bitop3:0xf8
...
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v3.l, 0x300, v0.h
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v5.h, 0x300, v1.l
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v0.l
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v0.l, v6.l, 3
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v4, 0xffff, v4
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_3)
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v1.l, v2.l, v0.l, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff, v3
; GFX13-TRUE16-NEXT:    v_or_b32_e32 v0, v4, v5
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v5.h, 0x300, v1.l
; GFX13-TRUE16-NEXT:    v_or_b32_e32 v1, v2, v5
; GFX13-TRUE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX13-TRUE16-NEXT:    s_set_pc_i64 s[30:31]
;
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_f64_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
; GFX13-NEXT:    s_lshr_b32 s6, s1, 24
; GFX13-NEXT:    s_lshr_b32 s5, s1, 16
; GFX13-NEXT:    s_lshr_b32 s3, s1, 8
; GFX13-NEXT:    s_lshr_b32 s8, s0, 16
; GFX13-NEXT:    s_lshr_b32 s7, s0, 8
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s4
; GFX13-NEXT:    s_cbranch_vccnz .LBB49_4
; GFX13-NEXT:  .LBB49_2: ; %cmp.true
; GFX13-NEXT:    v_add_f64_e64 v[8:9], s[0:1], 1.0
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; GFX13-NEXT:    v_dual_lshrrev_b32 v7, 24, v9 :: v_dual_lshrrev_b32 v6, 16, v9
; GFX13-NEXT:    v_dual_lshrrev_b32 v5, 8, v9 :: v_dual_lshrrev_b32 v2, 16, v8
; GFX13-NEXT:    v_lshrrev_b32_e32 v1, 8, v8
; GFX13-NEXT:    s_branch .LBB49_5
; GFX13-NEXT:  .LBB49_3:
; GFX13-NEXT:    ; implicit-def: $sgpr7
...
; GFX13-NEXT:    v_dual_mov_b32 v2, s8 :: v_dual_mov_b32 v1, s7
; GFX13-NEXT:    v_dual_mov_b32 v3, s2 :: v_dual_mov_b32 v7, s6
; GFX13-NEXT:    v_dual_mov_b32 v6, s5 :: v_dual_mov_b32 v5, s3
; GFX13-NEXT:  .LBB49_5: ; %end
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX13-NEXT:    v_dual_mov_b32 v0, v8 :: v_dual_mov_b32 v4, v9
; GFX13-NEXT:    s_set_pc_i64 s[30:31]
  %cmp = icmp eq i32 %b, 0
  br i1 %cmp, label %cmp.true, label %cmp.false
...
;
; GFX13-LABEL: bitcast_v2i32_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s8, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB69_4
; GFX13-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
; GFX13-NEXT:    s_lshr_b32 s3, s1, 24
; GFX13-NEXT:    s_lshr_b32 s4, s1, 16
...
; GFX13-NEXT:    s_lshr_b32 s7, s0, 8
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s8
; GFX13-NEXT:    s_cbranch_vccnz .LBB69_3
; GFX13-NEXT:  .LBB69_2: ; %cmp.true
; GFX13-NEXT:    s_add_co_i32 s1, s1, 3
; GFX13-NEXT:    s_add_co_i32 s0, s0, 3
; GFX13-NEXT:    s_lshr_b32 s4, s1, 16
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v2f32_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s8, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB85_4
; GFX13-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
; GFX13-NEXT:    s_lshr_b32 s3, s1, 24
; GFX13-NEXT:    s_lshr_b32 s4, s1, 16
...
; GFX13-NEXT:    s_lshr_b32 s7, s0, 8
; GFX13-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s8
; GFX13-NEXT:    s_cbranch_vccnz .LBB85_3
; GFX13-NEXT:  .LBB85_2: ; %cmp.true
; GFX13-NEXT:    s_add_f32 s1, s1, 1.0
; GFX13-NEXT:    s_add_f32 s0, s0, 1.0
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4i16_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s4, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB97_3
; GFX13-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
; GFX13-NEXT:    s_lshr_b32 s3, s1, 24
; GFX13-NEXT:    s_lshr_b32 s5, s1, 16
...
; GFX13-NEXT:  .LBB97_2: ; %cmp.true
; GFX13-NEXT:    v_pk_add_u16 v9, s1, 3 op_sel_hi:[1,0]
; GFX13-NEXT:    v_pk_add_u16 v8, s0, 3 op_sel_hi:[1,0]
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4f16_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:  .LBB105_2: ; %cmp.true
; GFX13-NEXT:    v_pk_add_f16 v9, 0x200, s1 op_sel_hi:[0,1]
; GFX13-NEXT:    v_pk_add_f16 v8, 0x200, s0 op_sel_hi:[0,1]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_dual_lshrrev_b32 v7, 24, v9 :: v_dual_lshrrev_b32 v6, 16, v9
; GFX13-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; GFX13-NEXT:    v_dual_lshrrev_b32 v5, 8, v9 :: v_dual_lshrrev_b32 v2, 16, v8
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX13-LABEL: bitcast_v4bf16_to_v8i8_scalar:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    s_wait_expcnt 0x0
; GFX13-NEXT:    s_wait_samplecnt 0x0
...
; GFX13-NEXT:    s_cmp_lg_u32 s2, 0
; GFX13-NEXT:    s_mov_b32 s4, 0
; GFX13-NEXT:    s_cbranch_scc0 .LBB109_3
; GFX13-NEXT:  ; %bb.1: ; %cmp.false
; GFX13-NEXT:    s_lshr_b64 s[2:3], s[0:1], 24
; GFX13-NEXT:    s_lshr_b32 s3, s1, 24
; GFX13-NEXT:    s_lshr_b32 s5, s1, 16
...
; GFX13-NEXT:  .LBB109_2: ; %cmp.true
; GFX13-NEXT:    v_pk_add_bf16 v9, 0x40c0, s1 op_sel_hi:[0,1]
; GFX13-NEXT:    v_pk_add_bf16 v8, 0x40c0, s0 op_sel_hi:[0,1]
; GFX13-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX13-NEXT:    v_dual_lshrrev_b32 v7, 24, v9 :: v_dual_lshrrev_b32 v6, 16, v9
; GFX13-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; GFX13-NEXT:    v_dual_lshrrev_b32 v5, 8, v9 :: v_dual_lshrrev_b32 v2, 16, v8
