...
; GFX13-TRUE16-NEXT:    s_wait_rtscnt 0x0
; GFX13-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX13-TRUE16-NEXT:    v_mov_b32_e32 v9, v0
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v7.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v6.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v4.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v3.h, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v7.h, v9.l
; GFX13-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v8
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v10.l, 8, v1.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v8.l, 8, v3.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v5.l, 8, v5.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b16 v3.l, 8, v0.l
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX13-TRUE16-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX13-TRUE16-NEXT:    s_xor_b32 s0, exec_lo, s0
...
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v0, v9, v10, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v1, v2, v8, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v2, v4, v5, 0xff bitop3:0xec
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v3, v6, v3, 0xff bitop3:0xec
...
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr7_hi16
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr10_lo16
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr3_hi16
; GFX13-TRUE16-NEXT:    ; implicit-def: $vgpr8_lo16
...
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v0.l, v7.h, 3
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v1.l, v3.h, 3
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v2.l, v5.h, 3
...
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v0.l, v7.l, 3
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v1, v8, v1, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v2, v5, v2, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v4, v10, v4, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_bitop3_b16 v3, v3, v0, 0xff bitop3:0xf8
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v1.l, 0x300, v1.l
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v2.l, 0x300, v2.l
; GFX13-TRUE16-NEXT:    v_mov_b16_e32 v0.l, v4.l
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_add_nc_u16 v3.l, 0x300, v3.l
; GFX13-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX13-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX13-TRUE16-NEXT:    v_and_b32_e32 v2, 0xffff, v2
