...
; SI-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0, s[2:3]
; SI-NEXT:    v_mov_b32_e32 v2, v1
; SI-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[2:3]
; SI-NEXT:    v_xor_b32_e32 v0, 1, v0
; SI-NEXT:    v_mov_b32_dpp v2, v2 quad_perm:[1,1,1,1] row_mask:0xf bank_mask:0xf bound_ctrl:1
; SI-NEXT:    s_nop 1
; SI-NEXT:    v_subrev_f32_dpp v1, v1, v2 quad_perm:[0,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
; SI-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
...
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0, s[2:3]
...
; GFX9-NEXT:    s_nop 1
; GFX9-NEXT:    v_subrev_f32_dpp v1, v1, v2 quad_perm:[0,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX9-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
...
; GFX10-32-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0, s1
; GFX10-32-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s1
...
; GFX10-32-NEXT:    v_subrev_f32_dpp v1, v1, v2 quad_perm:[0,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX10-32-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
; GFX10-32-NEXT:    s_and_b32 exec_lo, exec_lo, s0
; GFX10-32-NEXT:    v_cmp_neq_f32_e32 vcc_lo, 0, v1
; GFX10-32-NEXT:    v_xor_b32_e32 v0, 1, v0
; GFX10-32-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX10-32-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX10-32-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX10-32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v0
; GFX10-32-NEXT:    s_and_saveexec_b32 s1, vcc_lo
; GFX10-32-NEXT:    s_xor_b32 s1, exec_lo, s1
...
; GFX10-64-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0, s[2:3]
; GFX10-64-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[2:3]
...
; GFX10-64-NEXT:    v_subrev_f32_dpp v1, v1, v2 quad_perm:[0,0,0,0] row_mask:0xf bank_mask:0xf bound_ctrl:1
; GFX10-64-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
; GFX10-64-NEXT:    s_and_b64 exec, exec, s[0:1]
; GFX10-64-NEXT:    v_cmp_neq_f32_e32 vcc, 0, v1
; GFX10-64-NEXT:    v_xor_b32_e32 v0, 1, v0
; GFX10-64-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX10-64-NEXT:    v_or_b32_e32 v0, v0, v1
; GFX10-64-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX10-64-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
; GFX10-64-NEXT:    s_and_saveexec_b64 s[2:3], vcc
; GFX10-64-NEXT:    s_xor_b64 s[2:3], exec, s[2:3]
...
; GFX10-32-NEXT:    v_cndmask_b32_e64 v2, s2, 0, s3
; GFX10-32-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s3
...
; GFX10-32-NEXT:    v_cmp_neq_f32_e32 vcc_lo, 0, v2
; GFX10-32-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX10-32-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX10-32-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX10-32-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 1, v0
...
; GFX10-64-NEXT:    v_cndmask_b32_e64 v2, s6, 0, s[4:5]
...
; GFX10-64-NEXT:    v_cmp_neq_f32_e32 vcc, 0, v2
; GFX10-64-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX10-64-NEXT:    v_or_b32_e32 v0, v0, v2
; GFX10-64-NEXT:    v_and_b32_e32 v0, 1, v0
; GFX10-64-NEXT:    v_cmp_eq_u32_e32 vcc, 1, v0
