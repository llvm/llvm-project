...
; SI-NEXT:    v_cmp_ge_i32_e32 vcc, s10, v1
...
; SI-NEXT:    s_and_saveexec_b64 s[12:13], s[8:9]
; SI-NEXT:    s_xor_b64 s[8:9], exec, s[12:13]
...
; SI-NEXT:    ; in Loop: Header=BB7_5 Depth=1
; SI-NEXT:    s_wqm_b64 s[12:13], s[0:1]
; SI-NEXT:    s_and_b64 exec, exec, s[12:13]
...
; GFX9-NEXT:    s_add_i32 s10, s10, 1
; GFX9-NEXT:    v_cmp_ge_i32_e32 vcc, s10, v1
...
; GFX9-NEXT:    s_and_saveexec_b64 s[12:13], s[8:9]
; GFX9-NEXT:    s_xor_b64 s[8:9], exec, s[12:13]
...
; GFX9-NEXT:    ; in Loop: Header=BB7_5 Depth=1
; GFX9-NEXT:    s_wqm_b64 s[12:13], s[0:1]
; GFX9-NEXT:    s_and_b64 exec, exec, s[12:13]
...
; GFX10-32-NEXT:    s_or_b32 exec_lo, exec_lo, s5
; GFX10-32-NEXT:    s_add_i32 s4, s4, 1
; GFX10-32-NEXT:    v_cmp_ge_i32_e32 vcc_lo, s4, v1
...
; GFX10-32-NEXT:    v_cndmask_b32_e64 v0, s4, 0, s2
...
; GFX10-32-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX10-32-NEXT:    v_cmp_neq_f32_e32 vcc_lo, 0, v0
; GFX10-32-NEXT:    s_or_b32 s5, s3, vcc_lo
; GFX10-32-NEXT:    s_and_saveexec_b32 s6, s5
; GFX10-32-NEXT:    s_xor_b32 s5, exec_lo, s6
...
; GFX10-64-NEXT:    s_or_b64 exec, exec, s[8:9]
; GFX10-64-NEXT:    s_add_i32 s10, s10, 1
; GFX10-64-NEXT:    v_cmp_ge_i32_e32 vcc, s10, v1
...
; GFX10-64-NEXT:    v_cndmask_b32_e64 v0, s10, 0, s[4:5]
...
; GFX10-64-NEXT:    s_and_saveexec_b64 s[12:13], s[8:9]
; GFX10-64-NEXT:    s_xor_b64 s[8:9], exec, s[12:13]
...
; GFX10-64-NEXT:    ; in Loop: Header=BB7_5 Depth=1
; GFX10-64-NEXT:    s_wqm_b64 s[12:13], s[0:1]
; GFX10-64-NEXT:    s_and_b64 exec, exec, s[12:13]
