...
; GFX1010-NEXT:    s_xor_b32 s6, s6, -1
; GFX1010-NEXT:    s_and_b32 s6, s6, 1
; GFX1010-NEXT:    s_add_i32 s7, s5, s6
; GFX1010-NEXT:    s_cmpk_gt_i32 s5, 0xfbe6
; GFX1010-NEXT:    s_mov_b32 s5, s7
; GFX1010-NEXT:    s_cbranch_scc0 .LBB0_4
; GFX1010-NEXT:  .LBB0_2: ; %.a
; GFX1010-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1010-NEXT:    s_cmp_lg_u32 s4, 1
...
; GFX1010-NEXT:    s_xor_b32 s6, s6, -1
; GFX1010-NEXT:    s_and_b32 s6, s6, 1
; GFX1010-NEXT:    s_sub_i32 s7, s5, s6
; GFX1010-NEXT:    s_cmpk_gt_i32 s5, 0xfbe6
; GFX1010-NEXT:    s_mov_b32 s5, s7
...
; GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1100-NEXT:    s_and_b32 s2, s2, 1
; GFX1100-NEXT:    s_sub_i32 s3, s1, s2
; GFX1100-NEXT:    s_cmpk_gt_i32 s1, 0xfbe6
; GFX1100-NEXT:    s_mov_b32 s1, s3
...
; GFX1010-NEXT:    s_and_b32 s5, s5, 1
...
; GFX1010-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1010-NEXT:    s_cmp_lg_u32 s5, 1
; GFX1010-NEXT:    ; implicit-def: $sgpr6
...
; GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1100-NEXT:    s_and_b32 s1, s1, 1
...
; GFX1100-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1100-NEXT:    s_cmp_lg_u32 s1, 1
; GFX1100-NEXT:    ; implicit-def: $sgpr2
...
; GFX1010-NEXT:    s_and_b32 vcc_lo, exec_lo, s7
; GFX1010-NEXT:    s_and_b32 s6, s6, 1
; GFX1010-NEXT:    s_add_i32 s4, s4, s6
...
; GFX1100-NEXT:    s_and_b32 vcc_lo, exec_lo, s3
; GFX1100-NEXT:    s_and_b32 s2, s2, 1
; GFX1100-NEXT:    s_add_i32 s0, s0, s2
...
; GFX1010-NEXT:    s_and_b32 vcc_lo, exec_lo, s7
; GFX1010-NEXT:    s_and_b32 s6, s6, 1
; GFX1010-NEXT:    s_sub_i32 s4, s4, s6
...
; GFX1100-NEXT:    s_and_b32 vcc_lo, exec_lo, s3
; GFX1100-NEXT:    s_and_b32 s2, s2, 1
; GFX1100-NEXT:    s_sub_i32 s0, s0, s2
