...
; GCN-LABEL: load_fma_store:
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    s_load_b32 s0, s[4:5], 0x34
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; def v[0:31]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; def v[32:63]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; def v[64:95]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; def v[96:127]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_bitcmp1_b32 s0, 0
; GCN-NEXT:    s_cselect_b32 s0, -1, 0
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GCN-NEXT:    s_xor_b32 s2, s0, -1
; GCN-NEXT:    s_and_b32 vcc_lo, exec_lo, s2
; GCN-NEXT:    s_cbranch_vccnz .LBB0_4
; GCN-NEXT:  ; %bb.1: ; %bb1.preheader
; GCN-NEXT:    s_load_b32 s0, s[4:5], 0x24
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v158, s0
; GCN-NEXT:    s_load_b64 s[0:1], s[4:5], 0x2c
; GCN-NEXT:    ds_load_2addr_b32 v[132:133], v158 offset0:1 offset1:2
; GCN-NEXT:    ds_load_2addr_b32 v[128:129], v158 offset0:3 offset1:7
; GCN-NEXT:    ds_load_2addr_b32 v[130:131], v158 offset0:11 offset1:15
; GCN-NEXT:    ds_load_2addr_b32 v[134:135], v158 offset0:5 offset1:6
; GCN-NEXT:    ds_load_2addr_b32 v[136:137], v158 offset0:9 offset1:10
; GCN-NEXT:    ds_load_2addr_b32 v[138:139], v158 offset0:13 offset1:14
; GCN-NEXT:    ds_load_2addr_b32 v[140:141], v158 offset0:17 offset1:18
; GCN-NEXT:    ds_load_2addr_b32 v[144:145], v158 offset0:43 offset1:47
; GCN-NEXT:    ds_load_2addr_b32 v[146:147], v158 offset0:51 offset1:55
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_fma_f32 v128, v132, v133, v128
; GCN-NEXT:    ds_load_2addr_b32 v[132:133], v158 offset0:19 offset1:23
; GCN-NEXT:    v_fmac_f32_e32 v129, v134, v135
; GCN-NEXT:    v_fma_f32 v130, v136, v137, v130
; GCN-NEXT:    v_fmac_f32_e32 v131, v138, v139
; GCN-NEXT:    ds_load_2addr_b32 v[136:137], v158 offset0:21 offset1:22
; GCN-NEXT:    ds_load_2addr_b32 v[138:139], v158 offset0:25 offset1:26
; GCN-NEXT:    ds_load_2addr_b32 v[134:135], v158 offset0:27 offset1:31
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_fma_f32 v134, v138, v139, v134
; GCN-NEXT:    ds_load_2addr_b32 v[138:139], v158 offset0:33 offset1:34
; GCN-NEXT:    v_fmac_f32_e32 v133, v136, v137
; GCN-NEXT:    ds_load_2addr_b32 v[136:137], v158 offset0:29 offset1:30
; GCN-NEXT:    v_fma_f32 v132, v140, v141, v132
; GCN-NEXT:    ds_load_2addr_b32 v[140:141], v158 offset0:59 offset1:63
; GCN-NEXT:    ds_load_2addr_b32 v[142:143], v158 offset0:67 offset1:71
; GCN-NEXT:    s_waitcnt lgkmcnt(2)
; GCN-NEXT:    v_fmac_f32_e32 v135, v136, v137
; GCN-NEXT:    ds_load_2addr_b32 v[136:137], v158 offset0:35 offset1:39
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_fma_f32 v136, v138, v139, v136
; GCN-NEXT:    ds_load_2addr_b32 v[138:139], v158 offset0:37 offset1:38
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_dual_fmac_f32 v137, v138, v139 :: v_dual_mov_b32 v138, 0
; GCN-NEXT:    s_clause 0x2
; GCN-NEXT:    global_store_b128 v138, v[128:131], s[0:1]
; GCN-NEXT:    global_store_b128 v138, v[132:135], s[0:1] offset:16
; GCN-NEXT:    global_store_b64 v138, v[136:137], s[0:1] offset:32
; GCN-NEXT:    ds_load_2addr_b32 v[136:137], v158 offset0:75 offset1:79
; GCN-NEXT:    ds_load_2addr_b32 v[138:139], v158 offset0:83 offset1:87
; GCN-NEXT:    ds_load_2addr_b32 v[132:133], v158 offset0:91 offset1:95
; GCN-NEXT:    ds_load_2addr_b32 v[134:135], v158 offset0:99 offset1:103
; GCN-NEXT:    ds_load_2addr_b32 v[128:129], v158 offset0:107 offset1:111
; GCN-NEXT:    ds_load_2addr_b32 v[130:131], v158 offset0:115 offset1:119
; GCN-NEXT:    ds_load_2addr_b32 v[150:151], v158 offset0:41 offset1:42
; GCN-NEXT:    ds_load_2addr_b32 v[148:149], v158 offset0:45 offset1:46
; GCN-NEXT:    ds_load_2addr_b32 v[186:187], v158 offset0:49 offset1:50
; GCN-NEXT:    ds_load_2addr_b32 v[182:183], v158 offset0:53 offset1:54
; GCN-NEXT:    ds_load_2addr_b32 v[184:185], v158 offset0:57 offset1:58
; GCN-NEXT:    ds_load_2addr_b32 v[178:179], v158 offset0:61 offset1:62
; GCN-NEXT:    ds_load_2addr_b32 v[180:181], v158 offset0:65 offset1:66
; GCN-NEXT:    ds_load_2addr_b32 v[174:175], v158 offset0:69 offset1:70
; GCN-NEXT:    ds_load_2addr_b32 v[176:177], v158 offset0:73 offset1:74
; GCN-NEXT:    ds_load_2addr_b32 v[170:171], v158 offset0:77 offset1:78
; GCN-NEXT:    ds_load_2addr_b32 v[172:173], v158 offset0:81 offset1:82
; GCN-NEXT:    ds_load_2addr_b32 v[166:167], v158 offset0:85 offset1:86
; GCN-NEXT:    ds_load_2addr_b32 v[168:169], v158 offset0:89 offset1:90
; GCN-NEXT:    ds_load_2addr_b32 v[162:163], v158 offset0:93 offset1:94
; GCN-NEXT:    ds_load_2addr_b32 v[164:165], v158 offset0:97 offset1:98
; GCN-NEXT:    ds_load_2addr_b32 v[160:161], v158 offset0:101 offset1:102
; GCN-NEXT:    ds_load_2addr_b32 v[152:153], v158 offset0:105 offset1:106
; GCN-NEXT:    ds_load_2addr_b32 v[154:155], v158 offset0:109 offset1:110
; GCN-NEXT:    ds_load_2addr_b32 v[156:157], v158 offset0:113 offset1:114
; GCN-NEXT:    ds_load_2addr_b32 v[158:159], v158 offset0:117 offset1:118
; GCN-NEXT:  .LBB0_2: ; %bb1
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    s_and_b32 s3, exec_lo, s2
; GCN-NEXT:    s_cselect_b32 s3, 1, 0
; GCN-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GCN-NEXT:    s_cmp_lg_u32 s3, 1
; GCN-NEXT:    s_cbranch_scc1 .LBB0_2
; GCN-NEXT:  ; %bb.3: ; %bb2.loopexit
; GCN-NEXT:    s_waitcnt lgkmcnt(19)
; GCN-NEXT:    v_fma_f32 v144, v150, v151, v144
; GCN-NEXT:    s_waitcnt lgkmcnt(18)
; GCN-NEXT:    v_dual_fmac_f32 v145, v148, v149 :: v_dual_mov_b32 v148, 0
; GCN-NEXT:    s_waitcnt lgkmcnt(17)
; GCN-NEXT:    v_fma_f32 v146, v186, v187, v146
; GCN-NEXT:    s_waitcnt lgkmcnt(16)
; GCN-NEXT:    v_fmac_f32_e32 v147, v182, v183
; GCN-NEXT:    s_waitcnt lgkmcnt(15)
; GCN-NEXT:    v_fma_f32 v140, v184, v185, v140
; GCN-NEXT:    s_waitcnt lgkmcnt(14)
; GCN-NEXT:    v_fmac_f32_e32 v141, v178, v179
; GCN-NEXT:    s_waitcnt lgkmcnt(13)
; GCN-NEXT:    v_fma_f32 v142, v180, v181, v142
; GCN-NEXT:    s_waitcnt lgkmcnt(12)
; GCN-NEXT:    v_fmac_f32_e32 v143, v174, v175
; GCN-NEXT:    s_waitcnt lgkmcnt(11)
; GCN-NEXT:    v_fma_f32 v136, v176, v177, v136
; GCN-NEXT:    s_waitcnt lgkmcnt(10)
; GCN-NEXT:    v_fmac_f32_e32 v137, v170, v171
; GCN-NEXT:    s_waitcnt lgkmcnt(9)
; GCN-NEXT:    v_fma_f32 v138, v172, v173, v138
; GCN-NEXT:    s_waitcnt lgkmcnt(8)
; GCN-NEXT:    v_fmac_f32_e32 v139, v166, v167
; GCN-NEXT:    s_waitcnt lgkmcnt(7)
; GCN-NEXT:    v_fma_f32 v132, v168, v169, v132
; GCN-NEXT:    s_waitcnt lgkmcnt(6)
; GCN-NEXT:    v_fmac_f32_e32 v133, v162, v163
; GCN-NEXT:    s_waitcnt lgkmcnt(5)
; GCN-NEXT:    v_fma_f32 v134, v164, v165, v134
; GCN-NEXT:    s_waitcnt lgkmcnt(4)
; GCN-NEXT:    v_fmac_f32_e32 v135, v160, v161
; GCN-NEXT:    s_waitcnt lgkmcnt(3)
; GCN-NEXT:    v_fma_f32 v128, v152, v153, v128
; GCN-NEXT:    s_waitcnt lgkmcnt(2)
; GCN-NEXT:    v_fmac_f32_e32 v129, v154, v155
; GCN-NEXT:    s_waitcnt lgkmcnt(1)
; GCN-NEXT:    v_fma_f32 v130, v156, v157, v130
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_fmac_f32_e32 v131, v158, v159
; GCN-NEXT:    s_clause 0x4
; GCN-NEXT:    global_store_b128 v148, v[144:147], s[0:1] offset:40
; GCN-NEXT:    global_store_b128 v148, v[140:143], s[0:1] offset:56
; GCN-NEXT:    global_store_b128 v148, v[136:139], s[0:1] offset:72
; GCN-NEXT:    global_store_b128 v148, v[132:135], s[0:1] offset:88
; GCN-NEXT:    global_store_b128 v148, v[128:131], s[0:1] offset:104
; GCN-NEXT:  .LBB0_4: ; %bb2
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; use v[0:31]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    v_dual_mov_b32 v0, v32 :: v_dual_mov_b32 v1, v33
; GCN-NEXT:    v_dual_mov_b32 v2, v34 :: v_dual_mov_b32 v3, v35
; GCN-NEXT:    v_dual_mov_b32 v4, v36 :: v_dual_mov_b32 v5, v37
; GCN-NEXT:    v_dual_mov_b32 v6, v38 :: v_dual_mov_b32 v7, v39
; GCN-NEXT:    v_dual_mov_b32 v8, v40 :: v_dual_mov_b32 v9, v41
; GCN-NEXT:    v_dual_mov_b32 v10, v42 :: v_dual_mov_b32 v11, v43
; GCN-NEXT:    v_dual_mov_b32 v12, v44 :: v_dual_mov_b32 v13, v45
; GCN-NEXT:    v_dual_mov_b32 v14, v46 :: v_dual_mov_b32 v15, v47
; GCN-NEXT:    v_dual_mov_b32 v16, v48 :: v_dual_mov_b32 v17, v49
; GCN-NEXT:    v_dual_mov_b32 v18, v50 :: v_dual_mov_b32 v19, v51
; GCN-NEXT:    v_dual_mov_b32 v20, v52 :: v_dual_mov_b32 v21, v53
; GCN-NEXT:    v_dual_mov_b32 v22, v54 :: v_dual_mov_b32 v23, v55
; GCN-NEXT:    v_dual_mov_b32 v24, v56 :: v_dual_mov_b32 v25, v57
; GCN-NEXT:    v_dual_mov_b32 v26, v58 :: v_dual_mov_b32 v27, v59
; GCN-NEXT:    v_dual_mov_b32 v28, v60 :: v_dual_mov_b32 v29, v61
; GCN-NEXT:    v_dual_mov_b32 v30, v62 :: v_dual_mov_b32 v31, v63
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; use v[0:31]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    v_dual_mov_b32 v0, v64 :: v_dual_mov_b32 v1, v65
; GCN-NEXT:    v_dual_mov_b32 v2, v66 :: v_dual_mov_b32 v3, v67
; GCN-NEXT:    v_dual_mov_b32 v4, v68 :: v_dual_mov_b32 v5, v69
; GCN-NEXT:    v_dual_mov_b32 v6, v70 :: v_dual_mov_b32 v7, v71
; GCN-NEXT:    v_dual_mov_b32 v8, v72 :: v_dual_mov_b32 v9, v73
; GCN-NEXT:    v_dual_mov_b32 v10, v74 :: v_dual_mov_b32 v11, v75
; GCN-NEXT:    v_dual_mov_b32 v12, v76 :: v_dual_mov_b32 v13, v77
; GCN-NEXT:    v_dual_mov_b32 v14, v78 :: v_dual_mov_b32 v15, v79
; GCN-NEXT:    v_dual_mov_b32 v16, v80 :: v_dual_mov_b32 v17, v81
; GCN-NEXT:    v_dual_mov_b32 v18, v82 :: v_dual_mov_b32 v19, v83
; GCN-NEXT:    v_dual_mov_b32 v20, v84 :: v_dual_mov_b32 v21, v85
; GCN-NEXT:    v_dual_mov_b32 v22, v86 :: v_dual_mov_b32 v23, v87
; GCN-NEXT:    v_dual_mov_b32 v24, v88 :: v_dual_mov_b32 v25, v89
; GCN-NEXT:    v_dual_mov_b32 v26, v90 :: v_dual_mov_b32 v27, v91
; GCN-NEXT:    v_dual_mov_b32 v28, v92 :: v_dual_mov_b32 v29, v93
; GCN-NEXT:    v_dual_mov_b32 v30, v94 :: v_dual_mov_b32 v31, v95
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; use v[0:31]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    v_dual_mov_b32 v0, v96 :: v_dual_mov_b32 v1, v97
; GCN-NEXT:    v_dual_mov_b32 v2, v98 :: v_dual_mov_b32 v3, v99
; GCN-NEXT:    v_dual_mov_b32 v4, v100 :: v_dual_mov_b32 v5, v101
; GCN-NEXT:    v_dual_mov_b32 v6, v102 :: v_dual_mov_b32 v7, v103
; GCN-NEXT:    v_dual_mov_b32 v8, v104 :: v_dual_mov_b32 v9, v105
; GCN-NEXT:    v_dual_mov_b32 v10, v106 :: v_dual_mov_b32 v11, v107
; GCN-NEXT:    v_dual_mov_b32 v12, v108 :: v_dual_mov_b32 v13, v109
; GCN-NEXT:    v_dual_mov_b32 v14, v110 :: v_dual_mov_b32 v15, v111
; GCN-NEXT:    v_dual_mov_b32 v16, v112 :: v_dual_mov_b32 v17, v113
; GCN-NEXT:    v_dual_mov_b32 v18, v114 :: v_dual_mov_b32 v19, v115
; GCN-NEXT:    v_dual_mov_b32 v20, v116 :: v_dual_mov_b32 v21, v117
; GCN-NEXT:    v_dual_mov_b32 v22, v118 :: v_dual_mov_b32 v23, v119
; GCN-NEXT:    v_dual_mov_b32 v24, v120 :: v_dual_mov_b32 v25, v121
; GCN-NEXT:    v_dual_mov_b32 v26, v122 :: v_dual_mov_b32 v27, v123
; GCN-NEXT:    v_dual_mov_b32 v28, v124 :: v_dual_mov_b32 v29, v125
; GCN-NEXT:    v_dual_mov_b32 v30, v126 :: v_dual_mov_b32 v31, v127
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    ; use v[0:31]
; GCN-NEXT:    ;;#ASMEND
; GCN-NEXT:    s_nop 0
