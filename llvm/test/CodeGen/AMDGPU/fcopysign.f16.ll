...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v0, 0x7c00, v10, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v8, v11, v8 :: v_dual_add_nc_u32 v5, 0xfffffc10, v5
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v2, v8, v2 :: v_dual_add_nc_u32 v11, v11, v13
...
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v0, 0x7c00, v17 :: v_dual_add_nc_u32 v9, v9, v12
...
; GFX11-FAKE16-NEXT:    v_dual_cndmask_b32 v11, v12, v11 :: v_dual_and_b32 v14, 7, v9
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b32_e32 v18, v18, v20
