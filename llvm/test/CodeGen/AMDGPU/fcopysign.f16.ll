...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr2_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr3_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr2_hi16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_bfi_b32 v0, 0x7fff, v2, v0
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr4_lo16 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr0_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr1_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr3_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    v_bfi_b32 v1, 0x7fffffff, v1, v3
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr8_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr9_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr6_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr7_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr4_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr5_lo16 killed $sgpr0 killed $exec
...
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr10_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr11_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr8_lo16 killed $sgpr0 killed $exec
; GFX11-TRUE16-NEXT:    ; kill: def $vgpr9_lo16 killed $sgpr0 killed $exec
