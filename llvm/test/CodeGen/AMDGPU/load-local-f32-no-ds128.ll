; RUN: llc -mtriple=amdgpu6.00 -mattr=-enable-ds128 < %s | FileCheck -check-prefixes=SI,GCN %s
; RUN: llc -mtriple=amdgpu8.02 -mattr=-enable-ds128 < %s | FileCheck -check-prefixes=CIVI,GCN %s
; RUN: llc -mtriple=amdgpu9.00 -mattr=-enable-ds128 < %s | FileCheck -check-prefixes=CIVI,GCN %s
