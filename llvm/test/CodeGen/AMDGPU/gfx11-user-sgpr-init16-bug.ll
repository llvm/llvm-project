...
; WORKAROUND-NEXT:    s_nop 0
; WORKAROUND-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; NOWORKAROUND-NEXT:    s_nop 0
; NOWORKAROUND-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; WORKAROUND-LABEL: queue_ptr:
; WORKAROUND:       ; %bb.0:
; WORKAROUND-NEXT:    v_mov_b32_e32 v0, 0
; WORKAROUND-NEXT:    global_load_u8 v0, v0, s[0:1] glc dlc
; WORKAROUND-NEXT:    s_waitcnt vmcnt(0)
; WORKAROUND-NEXT:    v_mov_b32_e32 v0, s15
; WORKAROUND-NEXT:    global_store_b32 v[0:1], v0, off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    s_nop 0
...
; WORKAROUND-NEXT:    s_endpgm
;
; NOWORKAROUND-LABEL: queue_ptr:
; NOWORKAROUND:       ; %bb.0:
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v0, 0
; NOWORKAROUND-NEXT:    global_load_u8 v0, v0, s[0:1] glc dlc
; NOWORKAROUND-NEXT:    s_waitcnt vmcnt(0)
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v0, s4
; NOWORKAROUND-NEXT:    global_store_b32 v[0:1], v0, off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    s_nop 0
; NOWORKAROUND-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
...
; WORKAROUND-LABEL: all_inputs:
; WORKAROUND:       ; %bb.0:
; WORKAROUND-NEXT:    v_mov_b32_e32 v0, 0
; WORKAROUND-NEXT:    v_mov_b32_e32 v2, s13
; WORKAROUND-NEXT:    v_mov_b32_e32 v3, s14
; WORKAROUND-NEXT:    v_mov_b32_e32 v4, s15
; WORKAROUND-NEXT:    scratch_store_b32 off, v0, off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    s_clause 0x2
; WORKAROUND-NEXT:    global_load_u8 v1, v0, s[0:1] glc dlc
; WORKAROUND-NEXT:    global_load_u8 v1, v0, s[2:3] glc dlc
; WORKAROUND-NEXT:    global_load_u8 v0, v0, s[4:5] glc dlc
; WORKAROUND-NEXT:    s_waitcnt vmcnt(0)
; WORKAROUND-NEXT:    v_mov_b32_e32 v0, s6
; WORKAROUND-NEXT:    v_mov_b32_e32 v1, s7
; WORKAROUND-NEXT:    global_store_b32 v[0:1], v2, off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    global_store_b32 v[0:1], v3, off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    global_store_b32 v[0:1], v4, off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    global_store_b64 v[0:1], v[0:1], off dlc
; WORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; WORKAROUND-NEXT:    s_nop 0
; WORKAROUND-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; WORKAROUND-NEXT:    s_endpgm
;
; NOWORKAROUND-LABEL: all_inputs:
; NOWORKAROUND:       ; %bb.0:
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v0, 0
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v2, s8
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v3, s9
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v4, s10
; NOWORKAROUND-NEXT:    scratch_store_b32 off, v0, off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    s_clause 0x2
; NOWORKAROUND-NEXT:    global_load_u8 v1, v0, s[0:1] glc dlc
; NOWORKAROUND-NEXT:    global_load_u8 v1, v0, s[2:3] glc dlc
; NOWORKAROUND-NEXT:    global_load_u8 v0, v0, s[4:5] glc dlc
; NOWORKAROUND-NEXT:    s_waitcnt vmcnt(0)
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v0, s6
; NOWORKAROUND-NEXT:    v_mov_b32_e32 v1, s7
; NOWORKAROUND-NEXT:    global_store_b32 v[0:1], v2, off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    global_store_b32 v[0:1], v3, off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    global_store_b32 v[0:1], v4, off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    global_store_b64 v[0:1], v[0:1], off dlc
; NOWORKAROUND-NEXT:    s_waitcnt_vscnt null, 0x0
; NOWORKAROUND-NEXT:    s_nop 0
; NOWORKAROUND-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; NOWORKAROUND-NEXT:    s_endpgm
