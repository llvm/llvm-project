...
; GFX10-NEXT:    v_ffbh_u32_e32 v3, v4
; GFX10-NEXT:    v_ffbh_u32_e32 v0, v0
; GFX10-NEXT:    v_add_nc_u32_e32 v2, 32, v3
...
; GFX9-NEXT:    v_ffbh_u32_e32 v0, v0
; GFX9-NEXT:    v_min3_u32 v0, v2, v0, 64
; GFX9-NEXT:    global_store_dwordx2 v1, v[0:1], s[0:1]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_ffbh_u32_e32 v3, v4
; GFX10-NEXT:    v_ffbh_u32_e32 v0, v0
; GFX10-NEXT:    v_add_nc_u32_e64 v2, v3, 32 clamp
; GFX10-NEXT:    v_min3_u32 v0, v2, v0, 64
; GFX10-NEXT:    global_store_dwordx2 v1, v[0:1], s[0:1]
; GFX10-NEXT:    s_endpgm
  %val = load i64, ptr addrspace(1) %arrayidx, align 1
...
; GFX9-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v0, v1, s[2:3] offset:1
; GFX9-NEXT:    global_load_ubyte v2, v1, s[2:3] offset:3
; GFX9-NEXT:    global_load_ubyte v3, v1, s[2:3] offset:5
; GFX9-NEXT:    global_load_ubyte v4, v1, s[2:3] offset:7
; GFX9-NEXT:    global_load_ubyte v5, v1, s[2:3]
; GFX9-NEXT:    global_load_ubyte v6, v1, s[2:3] offset:2
; GFX9-NEXT:    global_load_ubyte v7, v1, s[2:3] offset:4
; GFX9-NEXT:    global_load_ubyte v8, v1, s[2:3] offset:6
; GFX9-NEXT:    s_waitcnt vmcnt(7)
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 8, v0
...
; GFX10-NEXT:    global_load_ubyte v4, v1, s[2:3] offset:4
; GFX10-NEXT:    global_load_ubyte v5, v1, s[2:3] offset:6
; GFX10-NEXT:    global_load_ubyte v6, v1, s[2:3] offset:3
...
; GFX10-NEXT:    s_waitcnt vmcnt(3)
; GFX10-NEXT:    v_or_b32_sdwa v2, v2, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-NEXT:    s_waitcnt vmcnt(2)
; GFX10-NEXT:    v_lshlrev_b32_e32 v4, 8, v6
; GFX10-NEXT:    s_waitcnt vmcnt(1)
; GFX10-NEXT:    v_or_b32_e32 v3, v3, v7
; GFX10-NEXT:    v_or_b32_e32 v0, v2, v0
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_or_b32_sdwa v2, v4, v8 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX10-NEXT:    v_ffbl_b32_e32 v0, v0
; GFX10-NEXT:    v_or_b32_e32 v2, v2, v3
; GFX10-NEXT:    v_add_nc_u32_e32 v0, 32, v0
...
; GFX9-NEXT:    v_add_u32_e64 v2, v2, 32 clamp
; GFX9-NEXT:    v_ffbl_b32_e32 v0, v0
; GFX9-NEXT:    v_min3_u32 v0, v0, v2, 64
; GFX9-NEXT:    global_store_dwordx2 v1, v[0:1], s[0:1]
; GFX9-NEXT:    s_endpgm
;
