...
; GFX13-LABEL: rts_trace_ray_nonblock_test:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    rts_trace_ray_nonblock v0, [v0, v[1:3], v[5:8], v[9:12]], s[0:3] r128
; GFX13-NEXT:    s_wait_rtscnt 0x0
; GFX13-NEXT:    export prim v0, off, off, off done
; GFX13-NEXT:    s_endpgm
...
; GFX13-LABEL: rts_trace_ray_test:
; GFX13:       ; %bb.0:
; GFX13-NEXT:    rts_trace_ray [v0, v[1:3], v[5:8], v[9:12]], s[0:3] r128
; GFX13-NEXT:    s_endpgm
...
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v15, 0
; GFX13-SDAG-NEXT:    rts_trace_ray_nonblock v0, [v0, v[1:3], v[12:15], v[8:11]], s[0:3] r128
...
; GFX13-GISEL:       ; %bb.0:
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v11, v4 :: v_dual_mov_b32 v4, v5
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v5, v6 :: v_dual_mov_b32 v6, v7
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v7, 0
; GFX13-GISEL-NEXT:    rts_trace_ray_nonblock v0, [v0, v[1:3], v[4:7], v[8:11]], s[0:3] r128
...
; GFX13-SDAG-NEXT:    v_dual_mov_b32 v12, v5 :: v_dual_mov_b32 v11, v4
; GFX13-SDAG-NEXT:    v_mov_b32_e32 v15, 0
; GFX13-SDAG-NEXT:    rts_trace_ray [v0, v[1:3], v[12:15], v[8:11]], s[0:3] r128
; GFX13-SDAG-NEXT:    s_endpgm
;
...
; GFX13-GISEL-NEXT:    v_dual_mov_b32 v5, v6 :: v_dual_mov_b32 v6, v7
; GFX13-GISEL-NEXT:    v_mov_b32_e32 v7, 0
; GFX13-GISEL-NEXT:    rts_trace_ray [v0, v[1:3], v[4:7], v[8:11]], s[0:3] r128
; GFX13-GISEL-NEXT:    s_endpgm
