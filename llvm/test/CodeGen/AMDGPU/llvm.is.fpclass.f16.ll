...
; RUN:  llc -global-isel=1 -mtriple=amdgpu7.04 < %s  | FileCheck --check-prefixes=GFX7CHECK,GFX7GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8SELDAG %s
; RUN:  llc -global-isel=1 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9SELDAG %s
; RUN:  llc -global-isel=1 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu10.31 < %s | FileCheck --check-prefixes=GFX10CHECK,GFX10SELDAG %s
; RUN:  llc -global-isel=1 -mtriple=amdgpu10.31 < %s | FileCheck --check-prefixes=GFX10CHECK,GFX10GLISEL %s
...
; RUN:  llc -global-isel=1 -mtriple=amdgpu11.00 -mattr=-real-true16 -amdgpu-enable-delay-alu=0 < %s | FileCheck --check-prefixes=GFX11CHECK,GFX11GLISEL,GFX11GLISEL-FAKE16 %s
...
; GFX7SELDAG-NEXT:    s_and_b32 s0, s2, 0x7fff
; GFX7SELDAG-NEXT:    s_cmpk_gt_i32 s0, 0x7c00
; GFX7SELDAG-NEXT:    s_cselect_b32 s0, -1, 0
; GFX7SELDAG-NEXT:    s_mov_b32 s5, s1
; GFX7SELDAG-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX8SELDAG-NEXT:    v_cmp_class_f16_e64 s[0:1], s2, 3
; GFX8SELDAG-NEXT:    s_and_b64 s[0:1], s[0:1], exec
...
; GFX7GLISEL-NEXT:    v_and_b32_e32 v4, 0x7fff, v1
; GFX7GLISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GFX7GLISEL-NEXT:    v_and_b32_e32 v5, 0x7fff, v1
; GFX7GLISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GFX7GLISEL-NEXT:    v_and_b32_e32 v0, 0x7c00, v0
; GFX7GLISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX7GLISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], v1, v2
...
; GFX7GLISEL-NEXT:    v_mov_b32_e32 v0, 0x7c00
; GFX7GLISEL-NEXT:    v_cmp_gt_u32_e64 s[4:5], v1, v0
; GFX7GLISEL-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX7GLISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GFX7GLISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7GLISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, v1
; GFX7GLISEL-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GFX7GLISEL-NEXT:    v_add_i32_e32 v1, vcc, 0xffff83ff, v0
