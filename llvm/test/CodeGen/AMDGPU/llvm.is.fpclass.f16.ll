...
; RUN:  llc -global-isel=0 -mtriple=amdgpu7.04 < %s  | FileCheck --check-prefixes=GFX7CHECK,GFX7SELDAG %s
; RUN:  llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu7.04 < %s  | FileCheck --check-prefixes=GFX7CHECK,GFX7GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8SELDAG %s
; RUN:  llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu8.03 < %s  | FileCheck --check-prefixes=GFX8CHECK,GFX8GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9SELDAG %s
; RUN:  llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgpu9.08 < %s  | FileCheck --check-prefixes=GFX9CHECK,GFX9GLISEL %s
; RUN:  llc -global-isel=0 -mtriple=amdgpu10.31 < %s | FileCheck --check-prefixes=GFX10CHECK,GFX10SELDAG %s
...
; GFX7CHECK:       ; %bb.0:
; GFX7CHECK-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GFX7CHECK-NEXT:    s_mov_b32 s7, 0xf000
; GFX7CHECK-NEXT:    s_mov_b32 s6, -1
; GFX7CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7CHECK-NEXT:    s_mov_b32 s4, s0
; GFX7CHECK-NEXT:    s_and_b32 s0, s2, 0x7fff
; GFX7CHECK-NEXT:    s_cmpk_gt_i32 s0, 0x7c00
; GFX7CHECK-NEXT:    s_cselect_b32 s0, -1, 0
; GFX7CHECK-NEXT:    s_mov_b32 s5, s1
; GFX7CHECK-NEXT:    v_mov_b32_e32 v0, s0
; GFX7CHECK-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; GFX7CHECK-NEXT:    s_endpgm
;
; GFX8CHECK-LABEL: sgpr_isnan_f16:
; GFX8CHECK:       ; %bb.0:
; GFX8CHECK-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX8CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8CHECK-NEXT:    v_mov_b32_e32 v0, s0
; GFX8CHECK-NEXT:    v_mov_b32_e32 v1, s1
; GFX8CHECK-NEXT:    v_cmp_class_f16_e64 s[0:1], s2, 3
; GFX8CHECK-NEXT:    s_and_b64 s[0:1], s[0:1], exec
; GFX8CHECK-NEXT:    s_cselect_b32 s0, -1, 0
; GFX8CHECK-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX11SELDAG-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
...
; GFX11SELDAG-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
...
; GFX11GLISEL-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
...
; GFX11GLISEL-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
...
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v1, v1
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX8CHECK-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9CHECK:       ; %bb.0:
; GFX9CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9CHECK-NEXT:    v_cmp_u_f16_sdwa s[4:5], v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
; GFX9CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
...
; GFX10CHECK:       ; %bb.0:
; GFX10CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10CHECK-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
; GFX10CHECK-NEXT:    v_cmp_u_f16_sdwa s4, v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
...
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v1, v1
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8CHECK:       ; %bb.0:
; GFX8CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8CHECK-NEXT:    v_lshrrev_b32_e32 v2, 16, v0
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v2, v2
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v1, v1
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8CHECK-NEXT:    v_mov_b32_e32 v1, v3
; GFX8CHECK-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9CHECK-LABEL: isnan_v3f16:
; GFX9CHECK:       ; %bb.0:
; GFX9CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9CHECK-NEXT:    v_cmp_u_f16_sdwa s[4:5], v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
; GFX9CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
...
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v1, v1
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9CHECK-NEXT:    v_mov_b32_e32 v1, v3
; GFX9CHECK-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10CHECK-LABEL: isnan_v3f16:
; GFX10CHECK:       ; %bb.0:
; GFX10CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10CHECK-NEXT:    v_cmp_u_f16_sdwa s4, v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
; GFX10CHECK-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
...
; GFX10CHECK-NEXT:    v_cmp_u_f16_e32 vcc_lo, v1, v1
; GFX10CHECK-NEXT:    v_mov_b32_e32 v1, v3
; GFX10CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX10CHECK-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v2, v2
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v1, v1
; GFX11GLISEL-FAKE16-NEXT:    v_mov_b32_e32 v1, v3
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX8CHECK:       ; %bb.0:
; GFX8CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8CHECK-NEXT:    v_lshrrev_b32_e32 v3, 16, v0
; GFX8CHECK-NEXT:    v_lshrrev_b32_e32 v2, 16, v1
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v3, v3
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v2, v2
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX8CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v1, v1
; GFX8CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8CHECK-NEXT:    v_mov_b32_e32 v1, v4
; GFX8CHECK-NEXT:    s_setpc_b64 s[30:31]
;
; GFX9CHECK-LABEL: isnan_v4f16:
; GFX9CHECK:       ; %bb.0:
; GFX9CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9CHECK-NEXT:    v_cmp_u_f16_sdwa s[4:5], v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
; GFX9CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v0, v0
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[4:5]
; GFX9CHECK-NEXT:    v_cmp_u_f16_sdwa s[4:5], v1, v1 src0_sel:WORD_1 src1_sel:WORD_1
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9CHECK-NEXT:    v_cmp_u_f16_e32 vcc, v1, v1
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[4:5]
; GFX9CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9CHECK-NEXT:    v_mov_b32_e32 v1, v4
; GFX9CHECK-NEXT:    s_setpc_b64 s[30:31]
;
; GFX10CHECK-LABEL: isnan_v4f16:
; GFX10CHECK:       ; %bb.0:
; GFX10CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10CHECK-NEXT:    v_cmp_u_f16_sdwa s4, v0, v0 src0_sel:WORD_1 src1_sel:WORD_1
; GFX10CHECK-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
...
; GFX10CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX10CHECK-NEXT:    v_cmp_u_f16_e32 vcc_lo, v1, v1
; GFX10CHECK-NEXT:    v_cmp_u_f16_sdwa s4, v1, v1 src0_sel:WORD_1 src1_sel:WORD_1
; GFX10CHECK-NEXT:    v_mov_b32_e32 v1, v4
; GFX10CHECK-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX10CHECK-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s4
; GFX10CHECK-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11GLISEL-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v0, v0
; GFX11GLISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v0
; GFX11GLISEL-FAKE16-NEXT:    v_lshrrev_b32_e32 v3, 16, v1
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v1, v1
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v4, v4
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    v_cmp_u_f16_e32 vcc_lo, v3, v3
; GFX11GLISEL-FAKE16-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc_lo
; GFX11GLISEL-FAKE16-NEXT:    s_setpc_b64 s[30:31]
