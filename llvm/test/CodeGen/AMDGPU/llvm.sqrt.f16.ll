...
; GFX12-TRUE16-SDAG-NEXT:    ; implicit-def: $vgpr0_hi16
; GFX12-TRUE16-SDAG-NEXT:    ; implicit-def: $vgpr0_hi16
...
; GFX11-TRUE16-GISEL-NEXT:    ; implicit-def: $vgpr1_hi16
; GFX11-TRUE16-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
;
; GFX11-TRUE16-SDAG-LABEL: sqrt_f16_s:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    v_sqrt_f16_e32 v0.l, s0
; GFX11-TRUE16-SDAG-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-GISEL-LABEL: sqrt_f16_s:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    v_sqrt_f16_e32 v0.l, s0
; GFX11-TRUE16-GISEL-NEXT:    ; implicit-def: $vgpr0_hi16
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-SDAG-LABEL: sqrt_f16_v:
; GFX11-TRUE16-SDAG:       ; %bb.0:
; GFX11-TRUE16-SDAG-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX11-TRUE16-SDAG-NEXT:    ; return to shader part epilog
;
; GFX11-TRUE16-GISEL-LABEL: sqrt_f16_v:
; GFX11-TRUE16-GISEL:       ; %bb.0:
; GFX11-TRUE16-GISEL-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX11-TRUE16-GISEL-NEXT:    ; implicit-def: $vgpr0_hi16
; GFX11-TRUE16-GISEL-NEXT:    ; return to shader part epilog
...
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX12-TRUE16-SDAG-LABEL: sqrt_f16_v:
; GFX12-TRUE16-SDAG:       ; %bb.0:
; GFX12-TRUE16-SDAG-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX12-TRUE16-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-TRUE16-GISEL-LABEL: sqrt_f16_v:
; GFX12-TRUE16-GISEL:       ; %bb.0:
; GFX12-TRUE16-GISEL-NEXT:    v_sqrt_f16_e32 v0.l, v0.l
; GFX12-TRUE16-GISEL-NEXT:    ; implicit-def: $vgpr0_hi16
