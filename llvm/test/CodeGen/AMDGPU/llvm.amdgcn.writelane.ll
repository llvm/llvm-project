...
; GFX802-GISEL:       ; %bb.0:
; GFX802-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GFX802-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX802-GISEL-NEXT:    s_add_i32 s12, s12, s17
; GFX802-GISEL-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX802-GISEL-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX802-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX802-GISEL-NEXT:    v_mov_b32_e32 v1, s3
; GFX802-GISEL-NEXT:    v_add_u32_e32 v0, vcc, s2, v0
...
; GFX802-GISEL:       ; %bb.0:
; GFX802-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[8:9], 0x0
; GFX802-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 4, v0
; GFX802-GISEL-NEXT:    s_add_i32 s12, s12, s17
; GFX802-GISEL-NEXT:    s_mov_b32 flat_scratch_lo, s13
; GFX802-GISEL-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX802-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX802-GISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s2, v2
; GFX802-GISEL-NEXT:    v_mov_b32_e32 v3, s1
; GFX802-GISEL-NEXT:    s_nop 2
; GFX802-GISEL-NEXT:    v_writelane_b32 v1, 0, s2
; GFX802-GISEL-NEXT:    v_writelane_b32 v0, 12, s2
; GFX802-GISEL-NEXT:    v_mov_b32_e32 v2, s0
; GFX802-GISEL-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX802-GISEL-NEXT:    s_endpgm
;
...
; GFX802-GISEL-NEXT:    v_writelane_b32 v0, 0, s2
; GFX802-GISEL-NEXT:    v_writelane_b32 v1, s4, m0
; GFX802-GISEL-NEXT:    v_mov_b32_e32 v2, s0
; GFX802-GISEL-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX802-GISEL-NEXT:    s_endpgm
;
...
; GFX802-GISEL-NEXT:    v_writelane_b32 v2, s4, m0
; GFX802-GISEL-NEXT:    flat_store_dwordx2 v[0:1], v[2:3]
; GFX802-GISEL-NEXT:    s_endpgm
;
...
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s5, v3
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v2
; GFX802-GISEL-NEXT:    s_mov_b32 m0, s4
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v6, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v5, s6, m0
...
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s4, v3
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s5, v4
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s6, v2
; GFX1010-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1010-GISEL-NEXT:    v_writelane_b32 v6, s4, s5
; GFX1010-GISEL-NEXT:    v_writelane_b32 v5, s6, s5
...
; GFX1100-GISEL-NEXT:    v_readfirstlane_b32 s0, v3
...
; GFX1100-GISEL-NEXT:    v_writelane_b32 v5, s2, s1
...
; GFX802-GISEL-NEXT:    flat_load_dwordx3 v[14:16], v[17:18]
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v9
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s8, v5
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s9, v4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s10, v3
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s11, v2
; GFX802-GISEL-NEXT:    s_mov_b32 m0, s4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s5, v8
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v7
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s7, v6
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX802-GISEL-NEXT:    v_writelane_b32 v13, s8, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v12, s9, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v11, s10, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v10, s11, m0
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v16, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v15, s6, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v14, s7, m0
; GFX802-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[10:13]
; GFX802-GISEL-NEXT:    flat_store_dwordx3 v[17:18], v[14:16]
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX1010-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1010-GISEL-NEXT:    s_clause 0x1
; GFX1010-GISEL-NEXT:    global_load_dwordx3 v[14:16], v[0:1], off offset:16
...
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s10, v3
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s11, v2
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s4, v8
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s6, v7
; GFX1010-GISEL-NEXT:    v_readfirstlane_b32 s7, v6
; GFX1010-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX1010-GISEL-NEXT:    v_writelane_b32 v16, s4, s5
; GFX1010-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1010-GISEL-NEXT:    v_writelane_b32 v13, s8, s5
; GFX1010-GISEL-NEXT:    v_writelane_b32 v12, s9, s5
; GFX1010-GISEL-NEXT:    v_writelane_b32 v11, s10, s5
; GFX1010-GISEL-NEXT:    v_writelane_b32 v10, s11, s5
; GFX1010-GISEL-NEXT:    v_writelane_b32 v15, s6, s5
...
; GFX1100-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1100-GISEL-NEXT:    s_clause 0x1
; GFX1100-GISEL-NEXT:    global_load_b96 v[14:16], v[0:1], off offset:16
...
; GFX1100-GISEL-NEXT:    v_readfirstlane_b32 s6, v3
; GFX1100-GISEL-NEXT:    v_readfirstlane_b32 s7, v2
; GFX1100-GISEL-NEXT:    v_readfirstlane_b32 s0, v8
; GFX1100-GISEL-NEXT:    v_readfirstlane_b32 s2, v7
...
; GFX1100-GISEL-NEXT:    v_writelane_b32 v16, s0, s1
; GFX1100-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX1100-GISEL-NEXT:    v_writelane_b32 v13, s4, s1
; GFX1100-GISEL-NEXT:    v_writelane_b32 v12, s5, s1
; GFX1100-GISEL-NEXT:    v_writelane_b32 v11, s6, s1
; GFX1100-GISEL-NEXT:    v_writelane_b32 v10, s7, s1
; GFX1100-GISEL-NEXT:    v_writelane_b32 v15, s2, s1
...
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s7, v3
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s8, v2
; GFX802-GISEL-NEXT:    s_mov_b32 m0, s4
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v10, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v9, s6, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v8, s7, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v7, s8, m0
...
; GFX802-GISEL:       ; %bb.0:
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX802-GISEL-NEXT:    v_add_u32_e32 v13, vcc, 16, v0
; GFX802-GISEL-NEXT:    flat_load_dwordx4 v[9:12], v[0:1]
; GFX802-GISEL-NEXT:    v_addc_u32_e32 v14, vcc, 0, v1, vcc
; GFX802-GISEL-NEXT:    flat_load_dwordx2 v[15:16], v[13:14]
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v8
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s7, v5
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s8, v4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s9, v3
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s10, v2
; GFX802-GISEL-NEXT:    s_mov_b32 m0, s4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s5, v7
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v6
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX802-GISEL-NEXT:    v_writelane_b32 v12, s7, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v11, s8, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v10, s9, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v9, s10, m0
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v16, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v15, s6, m0
; GFX802-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[9:12]
; GFX802-GISEL-NEXT:    flat_store_dwordx2 v[13:14], v[15:16]
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v10
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s9, v5
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s10, v4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s11, v3
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s12, v2
; GFX802-GISEL-NEXT:    s_mov_b32 m0, s4
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s5, v9
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v8
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s7, v7
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s8, v6
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX802-GISEL-NEXT:    v_writelane_b32 v14, s9, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v13, s10, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v12, s11, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v11, s12, m0
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v18, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v17, s6, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v16, s7, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v15, s8, m0
...
; GFX802-GISEL:       ; %bb.0:
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v18
...
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s4, v9
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s10, v15
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s11, v14
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s12, v13
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s13, v12
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s14, v11
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s15, v10
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s9, v16
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX802-GISEL-NEXT:    v_writelane_b32 v21, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v20, s6, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v19, s7, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v18, s8, m0
...
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s6, v7
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s7, v6
; GFX802-GISEL-NEXT:    flat_load_dwordx4 v[6:9], v[0:1]
; GFX802-GISEL-NEXT:    flat_load_dwordx4 v[12:15], v[18:19]
; GFX802-GISEL-NEXT:    v_readfirstlane_b32 s8, v17
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(3)
; GFX802-GISEL-NEXT:    v_writelane_b32 v5, s4, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v4, s5, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v3, s6, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v2, s7, m0
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(1)
; GFX802-GISEL-NEXT:    v_writelane_b32 v9, s8, m0
; GFX802-GISEL-NEXT:    s_waitcnt vmcnt(0)
; GFX802-GISEL-NEXT:    v_writelane_b32 v15, s12, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v14, s13, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v13, s14, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v12, s15, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v8, s9, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v7, s10, m0
; GFX802-GISEL-NEXT:    v_writelane_b32 v6, s11, m0
; GFX802-GISEL-NEXT:    flat_store_dwordx4 v[18:19], v[12:15]
; GFX802-GISEL-NEXT:    flat_store_dwordx4 v[0:1], v[6:9]
