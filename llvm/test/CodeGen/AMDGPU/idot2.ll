...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s9
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
...
; GFX9-DL-NEXT:    v_dot2_u32_u16 v2, s1, v0, v1
...
; GFX9-NODL-NEXT:    s_lshr_b32 s1, s1, 16
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-NODL-NEXT:    v_mul_u32_u24_e32 v0, s5, v0
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
; GFX9-NODL-NEXT:    v_add_u32_e32 v2, s9, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NODL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mul_u32_u24_e32 v0, s5, v0
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
; GFX9-DL-NEXT:    v_add_u32_e32 v2, s9, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    v_add_nc_u32_e32 v2, s8, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
...
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s1, v1, v0
; GFX9-NODL-NEXT:    v_mad_i32_i24 v2, s5, v2, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NODL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s8
; GFX9-DL-NEXT:    v_dot2_i32_i16 v2, s1, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, s5, v2, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-DL-NEXT:    v_mad_i32_i24 v0, s1, v1, v0
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, s5, v2, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s1, s1, v0
; GFX9-NODL-NEXT:    v_mad_u32_u24 v2, s0, s0, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NODL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, s1, v0
; GFX9-DL-NEXT:    v_mad_u32_u24 v2, s0, s0, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    v_mad_u32_u24 v2, s0, s0, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s11
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s11
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s9
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s0
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NODL-NEXT:    v_mad_u32_u24 v1, s5, v1, v0
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-DL-NEXT:    v_mad_u32_u24 v1, s5, v1, v0
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s1, v1, v0
; GFX9-NODL-NEXT:    v_mad_i32_i24 v1, s5, v2, v0
; GFX9-NODL-NEXT:    v_add_u32_e32 v2, v1, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
...
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-DL-NEXT:    v_mad_i32_i24 v0, s1, v1, v0
; GFX9-DL-NEXT:    v_mad_i32_i24 v1, s5, v2, v0
; GFX9-DL-NEXT:    v_add_u32_e32 v2, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
...
; GFX9-NODL-NEXT:    v_mad_u32_u24 v0, s1, v2, v0
; GFX9-NODL-NEXT:    v_mad_u32_u24 v2, s5, v1, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
...
; GFX9-DL-NEXT:    v_mad_u32_u24 v0, s1, v2, v0
; GFX9-DL-NEXT:    v_mad_u32_u24 v2, s5, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
...
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s1, v2, v0
; GFX9-NODL-NEXT:    v_mad_i32_i24 v2, s5, v1, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NODL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    v_mad_i32_i24 v0, s1, v2, v0
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, s5, v1, v0
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    v_mad_i32_i24 v2, s5, s4, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    v_dot2_u32_u16 v2, s4, s5, v2
...
; GFX9-NODL-NEXT:    global_load_ushort v5, v[2:3], off
; GFX9-NODL-NEXT:    s_load_dword s0, s[2:3], 0x0
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-NODL-NEXT:    v_lshrrev_b16_e32 v2, 8, v4
; GFX9-NODL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NODL-NEXT:    v_lshrrev_b16_e32 v3, 8, v5
; GFX9-NODL-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX9-NODL-NEXT:    v_bfe_i32 v3, v3, 0, 8
; GFX9-NODL-NEXT:    v_bfe_i32 v0, v4, 0, 8
; GFX9-NODL-NEXT:    v_bfe_i32 v1, v5, 0, 8
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    v_mad_i32_i24 v2, v3, v2, s0
; GFX9-NODL-NEXT:    v_mad_i32_i24 v2, v1, v0, v2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NODL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-NODL-NEXT:    s_endpgm
...
; GFX9-DL-NEXT:    global_load_ushort v5, v[2:3], off
; GFX9-DL-NEXT:    s_load_dword s0, s[2:3], 0x0
; GFX9-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX9-DL-NEXT:    v_lshrrev_b16_e32 v2, 8, v4
; GFX9-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX9-DL-NEXT:    v_lshrrev_b16_e32 v3, 8, v5
; GFX9-DL-NEXT:    v_bfe_i32 v2, v2, 0, 8
; GFX9-DL-NEXT:    v_bfe_i32 v3, v3, 0, 8
; GFX9-DL-NEXT:    v_bfe_i32 v0, v4, 0, 8
; GFX9-DL-NEXT:    v_bfe_i32 v1, v5, 0, 8
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, v3, v2, s0
; GFX9-DL-NEXT:    v_mad_i32_i24 v2, v1, v0, v2
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX9-DL-NEXT:    s_endpgm
...
; GFX10-DL-NEXT:    global_load_ushort v5, v[2:3], off
; GFX10-DL-NEXT:    s_load_dword s0, s[2:3], 0x0
; GFX10-DL-NEXT:    s_waitcnt vmcnt(1)
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v0, 8, v4
; GFX10-DL-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DL-NEXT:    v_lshrrev_b16_e64 v1, 8, v5
; GFX10-DL-NEXT:    v_bfe_i32 v2, v4, 0, 8
; GFX10-DL-NEXT:    v_bfe_i32 v3, v5, 0, 8
; GFX10-DL-NEXT:    v_bfe_i32 v0, v0, 0, 8
; GFX10-DL-NEXT:    v_bfe_i32 v1, v1, 0, 8
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_mad_i32_i24 v0, v1, v0, s0
; GFX10-DL-NEXT:    v_mad_i32_i24 v2, v3, v2, v0
; GFX10-DL-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-DL-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-DL-NEXT:    global_store_dword v[0:1], v2, off
; GFX10-DL-NEXT:    s_endpgm
