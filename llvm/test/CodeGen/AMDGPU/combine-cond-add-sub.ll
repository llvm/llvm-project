...
; RUN: llc -mtriple=amdgpu9.02  < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
...
; GCN-NEXT:    v_add_i32_e32 v4, vcc, v0, v3
...
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v0, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v1, vcc
; GFX9-NEXT:    global_load_dword v0, v[4:5], off
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    buffer_load_dword v2, v[0:1], s[0:3], 0 addr64
; GCN-NEXT:    v_mov_b32_e32 v3, 0x260
; GCN-NEXT:    v_cmp_class_f32_e32 vcc, s4, v3
; GCN-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    v_cmp_class_f32_e32 vcc, s2, v2
; GFX9-NEXT:    s_waitcnt vmcnt(0)
