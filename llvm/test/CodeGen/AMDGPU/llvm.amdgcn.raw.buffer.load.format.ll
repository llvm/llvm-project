...
; CHECK-NEXT:    buffer_load_format_xyzw v[0:3], off, s[0:3], 0
; CHECK-NEXT:    buffer_load_format_xyzw v[4:7], off, s[0:3], 0 glc
; CHECK-NEXT:    buffer_load_format_xyzw v[8:11], off, s[0:3], 0 slc
...
; CHECK-LABEL: buffer_load_immoffs:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    buffer_load_format_xyzw v[0:3], off, s[0:3], 0 offset:42
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ; return to shader part epilog
main_body:
...
; CHECK-LABEL: buffer_load_immoffs_large:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    s_movk_i32 s4, 0x7ffc
; CHECK-NEXT:    buffer_load_format_xyzw v[0:3], off, s[0:3], 60 offset:4092
; CHECK-NEXT:    buffer_load_format_xyzw v[4:7], off, s[0:3], s4 offset:4092
; CHECK-NEXT:    s_mov_b32 s4, 0x8ffc
; CHECK-NEXT:    buffer_load_format_xyzw v[8:11], off, s[0:3], s4 offset:4
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_add_f32_e32 v0, v8, v0
; CHECK-NEXT:    v_add_f32_e32 v1, v9, v1
; CHECK-NEXT:    v_add_f32_e32 v2, v10, v2
; CHECK-NEXT:    v_add_f32_e32 v3, v11, v3
; CHECK-NEXT:    ; return to shader part epilog
main_body:
...
; CHECK-LABEL: buffer_load_ofs:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    buffer_load_format_xyzw v[0:3], v0, s[0:3], 0 offen
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ; return to shader part epilog
main_body:
...
; CHECK-LABEL: buffer_load_ofs_imm:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    buffer_load_format_xyzw v[0:3], v0, s[0:3], 0 offen offset:60
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ; return to shader part epilog
main_body:
  %ofs = add i32 %1, 60
...
; CHECK-LABEL: buffer_load_x:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    buffer_load_format_x v0, off, s[0:3], 0
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ; return to shader part epilog
main_body:
...
; CHECK-LABEL: buffer_load_xy:
; CHECK:       ; %bb.0: ; %main_body
; CHECK-NEXT:    buffer_load_format_xy v[0:1], off, s[0:3], 0
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ; return to shader part epilog
main_body:
