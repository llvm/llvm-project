...
; SDAG-NEXT:    ; kill: def $agpr1 killed $sgpr4 killed $exec
; SDAG-NEXT:    s_nop 0
...
; GISEL-NEXT:    s_mov_b32 m0, 0
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    ds_gws_init a0 offset:63 gds
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %val = call i32 asm "; def $0", "=a"()
...
; SDAG-NEXT:    ; kill: def $agpr1 killed $sgpr0 killed $exec
; SDAG-NEXT:    s_nop 0
; SDAG-NEXT:    ds_gws_init a0 gds
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    s_endpgm
...
; SDAG-NEXT:    ; kill: def $vgpr1 killed $sgpr0 killed $exec
...
; GISEL-NEXT:    s_mov_b32 m0, 0
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    ds_gws_barrier a0 gds
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %val = call i32 asm "; def $0", "=a"()
...
; GISEL-NEXT:    s_mov_b32 m0, 0
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    ds_gws_barrier a0 offset:63 gds
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %val = call i32 asm "; def $0", "=a"()
...
; GISEL-NEXT:    s_mov_b32 m0, 0
; GISEL-NEXT:    s_nop 0
; GISEL-NEXT:    ds_gws_sema_br a0 gds
; GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %val = call i32 asm "; def $0", "=a"()
