...
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=tahiti < %s | FileCheck -check-prefixes=GCN,SI,GCN-GISEL,SI-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,VI,GCN-SDAG,VI-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=tonga < %s | FileCheck -check-prefixes=GCN,VI,GCN-GISEL,VI-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GFX900,GCN-SDAG,GFX900-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GCN,GFX900,GCN-GISEL,GFX900-GISEL %s
...
; SI-GISEL-NEXT:    s_and_b64 s[10:11], s[4:5], s[6:7]
...
; SI-GISEL-NEXT:    s_mov_b32 s8, 0
; SI-GISEL-NEXT:    s_mov_b32 s9, 0x43300000
; SI-GISEL-NEXT:    s_and_b64 s[12:13], s[10:11], s[6:7]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[0:1], s[0:1], 0
; SI-GISEL-NEXT:    s_and_b64 s[14:15], s[12:13], s[6:7]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[2:3], s[2:3], 0
; SI-GISEL-NEXT:    s_and_b64 s[6:7], s[12:13], s[6:7]
; SI-GISEL-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
...
; SI-GISEL-NEXT:    s_or_b64 s[14:15], s[14:15], s[10:11]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[0:1], s[0:1], 0
; SI-GISEL-NEXT:    s_and_b64 s[16:17], s[14:15], s[8:9]
; SI-GISEL-NEXT:    s_or_b64 s[16:17], s[16:17], s[10:11]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[4:5], s[4:5], 0
; SI-GISEL-NEXT:    s_and_b64 s[8:9], s[14:15], s[8:9]
