...
; SI-SDAG-NEXT:    v_bfi_b32 v7, s26, v10, v5
...
; SI-SDAG-NEXT:    v_mul_f64 v[15:16], v[2:3], s[4:5]
...
; SI-SDAG-NEXT:    v_bfi_b32 v7, s26, v10, v16
; SI-SDAG-NEXT:    v_add_f64 v[17:18], v[15:16], v[6:7]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 vcc, |v[15:16]|, s[6:7]
; SI-SDAG-NEXT:    v_add_f64 v[6:7], v[17:18], -v[6:7]
; SI-SDAG-NEXT:    s_mov_b32 s14, 0xfca7ab0c
; SI-SDAG-NEXT:    s_mov_b32 s15, 0x3e928af3
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v7, v7, v16, vcc
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v6, v6, v15, vcc
; SI-SDAG-NEXT:    s_mov_b32 s12, 0x6a5dcb37
; SI-SDAG-NEXT:    s_mov_b32 s13, 0x3e5ade15
; SI-SDAG-NEXT:    v_mov_b32_e32 v11, s14
; SI-SDAG-NEXT:    v_mov_b32_e32 v12, s15
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[6:7], s[8:9], v[2:3]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], s[12:13], v[11:12]
; SI-SDAG-NEXT:    s_mov_b32 s14, 0x623fde64
; SI-SDAG-NEXT:    s_mov_b32 s15, 0x3ec71dee
; SI-SDAG-NEXT:    v_fma_f64 v[15:16], v[6:7], s[10:11], v[15:16]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[14:15]
; SI-SDAG-NEXT:    s_mov_b32 s16, 0x7c89e6b0
; SI-SDAG-NEXT:    s_mov_b32 s17, 0x3efa0199
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], s[12:13], v[11:12]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[16:17]
; SI-SDAG-NEXT:    s_mov_b32 s18, 0x14761f6e
; SI-SDAG-NEXT:    s_mov_b32 s19, 0x3f2a01a0
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[14:15]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[18:19]
; SI-SDAG-NEXT:    s_mov_b32 s20, 0x1852b7b0
; SI-SDAG-NEXT:    s_mov_b32 s21, 0x3f56c16c
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[16:17]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[20:21]
; SI-SDAG-NEXT:    s_mov_b32 s22, 0x11122322
; SI-SDAG-NEXT:    s_mov_b32 s23, 0x3f811111
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[18:19]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[22:23]
; SI-SDAG-NEXT:    s_mov_b32 s24, 0x555502a1
; SI-SDAG-NEXT:    s_mov_b32 s25, 0x3fa55555
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[20:21]
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[8:9], v[13:14], s[24:25]
; SI-SDAG-NEXT:    s_mov_b32 s4, 0x55555511
; SI-SDAG-NEXT:    s_mov_b32 s5, 0x3fc55555
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[15:16], v[10:11], s[22:23]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], v[8:9], v[13:14], s[4:5]
; SI-SDAG-NEXT:    s_mov_b32 s6, 11
; SI-SDAG-NEXT:    s_mov_b32 s7, 0x3fe00000
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v14, v[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[15:16], v[10:11], s[24:25]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], v[8:9], v[12:13], s[6:7]
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[15:16], v[4:5], s[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[12:13], v[8:9], v[12:13], 1.0
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[15:16], v[4:5], s[6:7]
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[8:9], v[12:13], 1.0
; SI-SDAG-NEXT:    s_mov_b32 s6, 0
; SI-SDAG-NEXT:    s_mov_b32 s7, 0x40900000
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[15:16], v[4:5], 1.0
; SI-SDAG-NEXT:    s_mov_b32 s8, 0
; SI-SDAG-NEXT:    s_mov_b32 s9, 0xc090cc00
; SI-SDAG-NEXT:    v_cvt_i32_f64_e32 v6, v[6:7]
; SI-SDAG-NEXT:    v_ldexp_f64 v[8:9], v[8:9], v14
...
; SI-SDAG-NEXT:    v_fma_f64 v[13:14], v[15:16], v[13:14], s[40:41]
...
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v14, v16, v14, vcc
...
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], -v[14:15], v[22:23], v[0:1]
...
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], -v[14:15], v[26:27], v[24:25]
; SI-GISEL-NEXT:    v_mov_b32_e32 v24, 0x6a5dcb37
; SI-GISEL-NEXT:    v_mov_b32_e32 v25, 0x3e5ade15
...
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v52, v[16:17]
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[20:21], v[10:11], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[10:11], v[20:21], v[10:11], 1.0
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v20, v[14:15]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], -v[16:17], v[22:23], v[2:3]
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], -v[16:17], v[26:27], v[14:15]
; SI-GISEL-NEXT:    v_ldexp_f64 v[10:11], v[10:11], v20
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[24:25], v[28:29]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[30:31]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[12:13]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], v[50:51]
; SI-GISEL-NEXT:    v_fma_f64 v[20:21], v[14:15], v[20:21], 1.0
; SI-GISEL-NEXT:    v_fma_f64 v[14:15], v[14:15], v[20:21], 1.0
...
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[26:27], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[22:23], v[24:25], v[32:33]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[22:23], v[24:25], v[34:35]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[22:23], v[24:25], v[36:37]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[48:49]
; SI-GISEL-NEXT:    v_mov_b32_e32 v28, 0
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[38:39]
; SI-GISEL-NEXT:    v_mov_b32_e32 v29, 0x40900000
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[30:31]
; SI-GISEL-NEXT:    v_cmp_ngt_f64_e32 vcc, v[0:1], v[28:29]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[12:13]
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[22:23], v[24:25], v[48:49]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], v[50:51]
; SI-GISEL-NEXT:    v_cndmask_b32_e32 v53, 0, v10, vcc
; SI-GISEL-NEXT:    v_fma_f64 v[24:25], v[22:23], v[24:25], v[38:39]
; SI-GISEL-NEXT:    v_fma_f64 v[16:17], v[20:21], v[16:17], 1.0
...
; SI-GISEL-NEXT:    v_ldexp_f64 v[10:11], v[16:17], v10
...
; SI-GISEL-NEXT:    v_ldexp_f64 v[14:15], v[14:15], v52
...
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v15, v18, v15, s[4:5]
...
; SI-SDAG-NEXT:    v_mov_b32_e32 v8, s12
; SI-SDAG-NEXT:    v_mov_b32_e32 v9, s13
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[0:1], s[8:9], v[4:5]
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[6:7], s[10:11], v[8:9]
; SI-SDAG-NEXT:    s_mov_b32 s12, 0x623fde64
; SI-SDAG-NEXT:    s_mov_b32 s13, 0x3ec71dee
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[4:5], s[10:11], v[8:9]
; SI-SDAG-NEXT:    v_fma_f64 v[10:11], v[6:7], v[10:11], s[12:13]
; SI-SDAG-NEXT:    s_mov_b32 s14, 0x7c89e6b0
; SI-SDAG-NEXT:    s_mov_b32 s15, 0x3efa0199
; SI-SDAG-NEXT:    v_fma_f64 v[8:9], v[4:5], v[8:9], s[12:13]
...
; SI-GISEL-NEXT:    s_mov_b32 s4, 0
; SI-GISEL-NEXT:    s_mov_b32 s5, 0x43300000
; SI-GISEL-NEXT:    s_and_b64 s[10:11], s[8:9], s[6:7]
; SI-GISEL-NEXT:    s_or_b64 s[10:11], s[10:11], s[4:5]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[8:9], s[8:9], s[10:11]
; SI-GISEL-NEXT:    v_mov_b32_e32 v2, 0xfefa39ef
; SI-GISEL-NEXT:    v_mov_b32_e32 v3, 0x3fe62e42
; SI-GISEL-NEXT:    v_mov_b32_e32 v4, s8
; SI-GISEL-NEXT:    v_mov_b32_e32 v5, s9
...
; SI-GISEL-NEXT:    v_fma_f64 v[4:5], -s[8:9], v[8:9], v[4:5]
...
; SI-GISEL-NEXT:    v_cvt_i32_f64_e32 v14, s[8:9]
; SI-GISEL-NEXT:    v_mov_b32_e32 v6, 0
; SI-GISEL-NEXT:    v_mov_b32_e32 v7, 0xc090cc00
; SI-GISEL-NEXT:    v_ldexp_f64 v[4:5], v[4:5], v14
; SI-GISEL-NEXT:    v_readfirstlane_b32 s8, v4
; SI-GISEL-NEXT:    v_readfirstlane_b32 s9, v5
; SI-GISEL-NEXT:    v_mov_b32_e32 v4, 0
; SI-GISEL-NEXT:    v_mov_b32_e32 v5, 0x40900000
...
; SI-GISEL-NEXT:    s_cselect_b64 s[0:1], s[0:1], 0
; SI-GISEL-NEXT:    s_and_b64 s[6:7], s[8:9], s[6:7]
; SI-GISEL-NEXT:    s_or_b64 s[4:5], s[6:7], s[4:5]
; SI-GISEL-NEXT:    v_add_f64 v[0:1], v[0:1], s[4:5]
...
; SI-GISEL-NEXT:    s_cselect_b64 s[4:5], s[8:9], s[4:5]
...
; SI-SDAG-NEXT:    v_mul_f64 v[4:5], v[0:1], s[4:5]
; SI-SDAG-NEXT:    s_mov_b32 s4, 0x3b39803f
; SI-SDAG-NEXT:    v_bfi_b32 v3, s10, v3, v5
; SI-SDAG-NEXT:    v_add_f64 v[6:7], v[4:5], v[2:3]
; SI-SDAG-NEXT:    v_cmp_gt_f64_e64 vcc, |v[4:5]|, s[6:7]
; SI-SDAG-NEXT:    v_add_f64 v[2:3], v[6:7], -v[2:3]
; SI-SDAG-NEXT:    s_mov_b32 s5, 0xbc7abc9e
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v3, v3, v5, vcc
; SI-SDAG-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[2:3], s[8:9], v[0:1]
; SI-SDAG-NEXT:    v_mov_b32_e32 v6, 0xfca7ab0c
; SI-SDAG-NEXT:    v_fma_f64 v[4:5], v[2:3], s[4:5], v[4:5]
; SI-SDAG-NEXT:    v_mov_b32_e32 v7, 0x3e928af3
; SI-SDAG-NEXT:    s_mov_b32 s4, 0x6a5dcb37
