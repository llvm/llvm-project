...
define i32 @bcnt032_inverse_for_vregs(i32 %val0) {
; CHECK-LABEL: bcnt032_inverse_for_vregs:
; CHECK:       ; %bb.0:
...
define i32 @bcnt064_inverse_for_vregs(i64 %val0) {
; CHECK-LABEL: bcnt064_inverse_for_vregs:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_bcnt_u32_b32 v0, v0, 0
