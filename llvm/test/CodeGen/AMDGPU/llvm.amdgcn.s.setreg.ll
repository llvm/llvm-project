...
; RUN: llc -mtriple=amdgpu6.01 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX6 %s
; RUN: llc -mtriple=amdgpu8.02 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX789 %s
; RUN: llc -mtriple=amdgpu9.00 -show-mc-encoding < %s | FileCheck -check-prefixes=GFX789 %s
