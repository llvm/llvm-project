...
; RUN: opt -mtriple=amdgpu9.0a-- -passes=amdgpu-printf-runtime-binding -S < %s | FileCheck --check-prefix=GCN %s
...
; GCN-SAME: (i32 [[N:%.*]]) {
; GCN-NEXT:  entry:
; GCN-NEXT:    [[CALL:%.*]] = call i32 (ptr, ...) @printf(ptr @str, i32 [[N]]) #[[ATTR1:[0-9]+]]
; GCN-NEXT:    ret void
;
entry:
