...
; GCN-LABEL: test_s_incperflevel:
; GCN:       ; %bb.0:
; GCN-NEXT:    s_incperflevel 0
; GCN-NEXT:    s_incperflevel 1
; GCN-NEXT:    s_incperflevel 2
; GCN-NEXT:    s_incperflevel 3
; GCN-NEXT:    s_incperflevel 4
; GCN-NEXT:    s_incperflevel 5
; GCN-NEXT:    s_incperflevel 6
; GCN-NEXT:    s_incperflevel 7
; GCN-NEXT:    s_incperflevel 8
; GCN-NEXT:    s_incperflevel 9
; GCN-NEXT:    s_incperflevel 10
; GCN-NEXT:    s_incperflevel 11
; GCN-NEXT:    s_incperflevel 12
; GCN-NEXT:    s_incperflevel 13
; GCN-NEXT:    s_incperflevel 14
; GCN-NEXT:    s_incperflevel 15
; GCN-NEXT:    s_endpgm
