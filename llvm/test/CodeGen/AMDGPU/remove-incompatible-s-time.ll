...
; RUN: llc -mtriple=amdgpu10.30 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu10.30 < %s

; RUN: llc -enable-new-pm -mtriple=amdgpu10.30 -stop-after=amdgpu-remove-incompatible-functions\
; RUN:   -pass-remarks=amdgpu-remove-incompatible-functions %s -o - 2>%t | FileCheck -check-prefixes=COMPATIBLE,REALTIME,MEMTIME %s
; RUN: FileCheck -allow-empty --check-prefixes=WARN-REALTIME,WARN-MEMTIME %s < %t

; RUN: llc -mtriple=amdgpu11.02 -stop-after=amdgpu-remove-incompatible-functions\
...
; RUN: llc -mtriple=amdgpu11.02 < %s

; RUN: llc -enable-new-pm -mtriple=amdgpu11.02 -stop-after=amdgpu-remove-incompatible-functions\
; RUN:   -pass-remarks=amdgpu-remove-incompatible-functions %s -o - 2>%t | FileCheck -check-prefixes=INCOMPATIBLE,NOREALTIME,NOMEMTIME %s
; RUN: FileCheck --check-prefixes=WARN-NOREALTIME,WARN-NOMEMTIME %s < %t
