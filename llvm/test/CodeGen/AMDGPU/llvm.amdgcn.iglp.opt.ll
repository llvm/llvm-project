...
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[32:63], v3, v2, a[32:63]
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[128:159], v3, v2, a[128:159]
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[96:127], v3, v2, a[96:127]
...
; GCN-NEXT:    v_mfma_f32_32x32x1f32 a[64:95], v3, v2, a[64:95]
