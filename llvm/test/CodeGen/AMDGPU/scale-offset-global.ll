...
; RUN: llc -march=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,SDAG %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GISEL %s
