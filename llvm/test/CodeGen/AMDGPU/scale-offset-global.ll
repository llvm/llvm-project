...
; RUN: llc -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs < %s | FileCheck --check-prefixes=GCN,GFX1210,GFX1210-GISEL %s
...
; GFX1210-LABEL: global_load_b32_idxprom:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_b32_idx32:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_b32 v0, v0, s[0:1] scale_offset
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
...
; GFX1210-SDAG-LABEL: global_load_b32_idxprom_wrong_stride:
; GFX1210-SDAG:       ; %bb.0: ; %entry
; GFX1210-SDAG-NEXT:    v_ashrrev_i32_e32 v1, 31, v0
; GFX1210-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-SDAG-NEXT:    v_lshl_add_u64 v[0:1], v[0:1], 3, s[0:1]
; GFX1210-SDAG-NEXT:    global_load_b32 v0, v[0:1], off
...
; GFX13-GISEL-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v3, v1, vcc_lo
...
; GFX1210-LABEL: global_load_b16_idxprom_ioffset:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_b64_idxprom:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_b96_idxprom:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_b96_idxpromi_ioffset:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_b128_idxprom:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_atomicrmw_b64_rtn_idxprom:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b64_e32 v[2:3], 1
; GFX1210-NEXT:    global_atomic_add_u64 v[0:1], v0, v[2:3], s[0:1] scale_offset th:TH_ATOMIC_RETURN
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    ; return to shader part epilog
;
...
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    v_mov_b64_e32 v[2:3], 1
; GFX13-NEXT:    global_atomic_add_u64 v[0:1], v0, v[2:3], s[0:1] scale_offset th:TH_ATOMIC_RETURN
; GFX13-NEXT:    s_wait_loadcnt 0x0
; GFX13-NEXT:    ; return to shader part epilog
entry:
  %idxprom = sext i32 %idx to i64
