...
define amdgpu_ps void @raw_buffer_discard(i32 %arg) {
...
define amdgpu_ps void @raw_buffer_discard_imm(i32 %arg) {
...
define amdgpu_ps void @raw_buffer_discard_offen(i32 %arg, i32 %arg1) {
...
define amdgpu_ps void @struct_buffer_discard(i32 %arg, i32 %arg1) {
...
define amdgpu_ps void @struct_buffer_discard_immoffs(i32 %arg, i32 %arg1) {
...
define amdgpu_ps void @struct_buffer_discard_idx(i32 %arg, i32 %arg1) {
