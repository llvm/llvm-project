...
; RUN: llc -global-isel=0 -mtriple=amdgpu8.03--amdhsa < %s | FileCheck -check-prefixes=CHECK,CHECK-SDAG -enable-var-scope %s
; RUN: llc -global-isel=1 -mtriple=amdgpu8.03--amdhsa < %s | FileCheck -check-prefixes=CHECK,CHECK-GISEL -enable-var-scope %s
