...
; RUN: llc -global-isel=1 -global-isel-abort=2 -mtriple=amdgcn--amdhsa -mcpu=fiji < %s | FileCheck -check-prefixes=CHECK,CHECK-GISEL -enable-var-scope %s

define void @test_readfirstlane_p0(ptr addrspace(1) %out, ptr %src) {
; CHECK-LABEL: test_readfirstlane_p0:
; CHECK:       ; %bb.0:
...
; CHECK-LABEL: test_readfirstlane_v3p0:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
