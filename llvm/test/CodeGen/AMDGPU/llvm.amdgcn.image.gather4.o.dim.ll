; RUN: llc -mtriple=amdgpu6.01 < %s | FileCheck -check-prefixes=GCN %s
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -check-prefixes=GCN %s
; RUN: not --crash llc -mtriple=amdgpu11.00 < %s 2>&1 | FileCheck -check-prefixes=GFX11-ERR %s
