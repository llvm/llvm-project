...
; GFX11-TRUE16-NEXT:    v_ashrrev_i32_e32 v4, 31, v2
; GFX11-TRUE16-NEXT:    v_ashrrev_i32_e32 v3, 24, v2
...
; GFX11-TRUE16-NEXT:    v_cls_i32_e32 v5, v4
; GFX11-TRUE16-NEXT:    v_xor_b32_e32 v0, v3, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_bfe_i32 v6, v6, 0, 8
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v7, v7
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v5, -1, v5
; GFX11-TRUE16-NEXT:    v_ashrrev_i32_e32 v0, 31, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v0, 32, v0
; GFX11-TRUE16-NEXT:    v_min_u32_e32 v5, v5, v0
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b64 v[3:4], v5, v[3:4]
; GFX11-TRUE16-NEXT:    v_cvt_f16_i16_e32 v0.l, v0.l
; GFX11-TRUE16-NEXT:    v_bfe_i32 v9, v2, 0, 8
...
; GFX11-TRUE16-NEXT:    v_sub_nc_u32_e32 v4, 32, v5
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v9.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v5, v2
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v2.l, v8.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cvt_f16_i16_e32 v2.h, v3.l
; GFX11-TRUE16-NEXT:    v_pack_b32_f16 v3, v0.h, v1.l
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v5, v5, v4
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v6.l
; GFX11-TRUE16-NEXT:    v_cvt_f16_i16_e32 v1.h, v2.l
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v2.l, v7
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cvt_f16_f32_e32 v4.h, v5
; GFX11-TRUE16-NEXT:    v_cvt_f16_i16_e32 v4.l, v4.l
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v5, 0
; GFX11-TRUE16-NEXT:    v_pack_b32_f16 v1, v0.l, v1.h
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_pack_b32_f16 v0, v4.h, v2.h
; GFX11-TRUE16-NEXT:    v_pack_b32_f16 v2, v2.l, v4.l
...
; GFX11-FAKE16-NEXT:    v_ashrrev_i32_e32 v3, 31, v1
; GFX11-FAKE16-NEXT:    v_ashrrev_i32_e32 v2, 24, v1
; GFX11-FAKE16-NEXT:    v_ashrrev_i32_e32 v6, 24, v0
; GFX11-FAKE16-NEXT:    v_ashrrev_i16 v7, 8, v1
; GFX11-FAKE16-NEXT:    v_bfe_i32 v8, v1, 0, 8
; GFX11-FAKE16-NEXT:    v_cls_i32_e32 v5, v3
; GFX11-FAKE16-NEXT:    v_xor_b32_e32 v4, v2, v3
; GFX11-FAKE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GFX11-FAKE16-NEXT:    v_ashrrev_i16 v9, 8, v0
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v6, v6
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v5, -1, v5
; GFX11-FAKE16-NEXT:    v_ashrrev_i32_e32 v4, 31, v4
...
; GFX11-FAKE16-NEXT:    v_add_nc_u32_e32 v4, 32, v4
; GFX11-FAKE16-NEXT:    v_min_u32_e32 v4, v5, v4
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b64 v[2:3], v4, v[2:3]
; GFX11-FAKE16-NEXT:    v_sub_nc_u32_e32 v4, 32, v4
...
; GFX11-FAKE16-NEXT:    v_bfe_i32 v3, v5, 0, 8
; GFX11-FAKE16-NEXT:    v_cvt_f16_i16_e32 v5, v9
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v2, v2
; GFX11-FAKE16-NEXT:    v_cvt_f16_i16_e32 v9, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v3, v5, v0
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v2, v2, v4
; GFX11-FAKE16-NEXT:    v_cvt_f16_i16_e32 v4, v8
; GFX11-FAKE16-NEXT:    v_cvt_f16_i16_e32 v8, v1
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_cvt_f16_f32_e32 v2, v2
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v1, v7, v4
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v0, v2, v8
; GFX11-FAKE16-NEXT:    v_pack_b32_f16 v2, v6, v9
