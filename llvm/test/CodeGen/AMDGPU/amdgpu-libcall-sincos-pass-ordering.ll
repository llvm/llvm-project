...
; CHECK-SAME: ptr addrspace(1) nofree writeonly captures(none) initializes((0, 8)) [[OUT0:%.*]], ptr addrspace(1) nofree writeonly captures(none) initializes((0, 8)) [[OUT1:%.*]], ptr addrspace(1) nofree writeonly captures(none) initializes((0, 8)) [[OUT2:%.*]], float noundef [[X:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
