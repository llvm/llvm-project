...
;
; GFX9-LABEL: cs_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: cs_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: cs_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: es_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: es_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: es_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: gs_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: gs_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: gs_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: hs_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: hs_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: hs_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: ls_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: ls_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: ls_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: ps_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: ps_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: ps_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
...
; VI-NEXT:    ; return to shader part epilog
;
; GFX9-LABEL: vs_amdpal:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    v_add_f16_e32 v0, 1.0, v0
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX1170-LABEL: vs_amdpal:
; GFX1170:       ; %bb.0:
; GFX1170-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX1170-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: vs_amdpal:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_add_f16_e32 v0.l, 1.0, v0.l
; GFX12-NEXT:    ; return to shader part epilog
  %add = fadd half %arg0, 1.0
