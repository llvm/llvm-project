...
; GFX11-NEXT:    v_cmp_lt_i64_e64 s5, s[6:7], 0
...
; GFX10-NEXT:    global_load_dwordx2 v[2:3], v6, s[14:15]
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_nc_u32_e32 v5, v1, v3
; GFX10-NEXT:    v_add_nc_u32_e32 v4, v0, v2
...
; GFX11-NEXT:    global_load_b64 v[2:3], v6, s[10:11]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_nc_u32_e32 v5, v1, v3
; GFX11-NEXT:    v_add_nc_i32 v1, v1, v3 clamp
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    v_cmp_ne_u32_e64 s0, v5, v1
; GFX11-NEXT:    s_and_b32 s0, s0, 1
; GFX11-NEXT:    v_dual_mov_b32 v1, s0 :: v_dual_add_nc_u32 v4, v0, v2
