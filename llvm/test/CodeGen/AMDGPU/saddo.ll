...
; RUN: llc < %s -amdgpu-scalarize-global-loads=false -march=amdgcn -mcpu=gfx1100 -amdgpu-insert-delay-alu=0 -verify-machineinstrs | FileCheck %s --check-prefix=GFX11
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[9:10], v6, s[8:9]
; GFX11-NEXT:    global_load_b64 v[2:3], v6, s[10:11]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_co_u32_e64 v7, vcc_lo, v9, v2
; GFX11-NEXT:    v_add_co_ci_u32_e32 v8, vcc_lo, v10, v3, vcc_lo
; GFX11-NEXT:    v_cmp_gt_i64_e32 vcc_lo, 0, v[2:3]
; GFX11-NEXT:    v_cmp_lt_i64_e64 s0, v[7:8], v[9:10]
; GFX11-NEXT:    s_xor_b32 s0, vcc_lo, s0
; GFX11-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX11-NEXT:    global_store_b64 v6, v[7:8], s[4:5]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_nc_i32 v5, v1, v3 clamp
; GFX11-NEXT:    v_add_nc_u32_e32 v10, v1, v3
; GFX11-NEXT:    v_add_nc_i32 v6, v0, v2 clamp
; GFX11-NEXT:    v_add_nc_u32_e32 v9, v0, v2
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v10, v5
; GFX11-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc_lo
; GFX11-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v9, v6
; GFX11-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX11-NEXT:    global_store_b64 v4, v[9:10], s[0:1]
