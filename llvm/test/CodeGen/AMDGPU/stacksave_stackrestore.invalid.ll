...
; RUN: not llc -global-isel=1 -mtriple=amdgpu10.30-amd-amdpal -filetype=null %t/stacksave-error.ll 2>&1 | FileCheck -check-prefix=ERR-SAVE-GISEL %s
; RUN: not llc -global-isel=1 -mtriple=amdgpu10.30-amd-amdpal -filetype=null %t/stackrestore-error.ll 2>&1 | FileCheck -check-prefix=ERR-RESTORE-GISEL %s
