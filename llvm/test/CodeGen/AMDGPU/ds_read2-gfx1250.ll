...
; GFX1250-NEXT:    global_store_b32 v2, v0, s[0:1] scale_offset
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v0, 2, v2
; GFX1250-NEXT:    ds_load_2addr_b32 v[0:1], v0 offset1:255
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_store_b32 v2, v0, s[0:1] scale_offset
...
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GFX1250-NEXT:    ds_load_b32 v2, v1
; GFX1250-NEXT:    ds_load_b32 v1, v1 offset:1028
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f32_e32 v1, v2, v1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    v_lshlrev_b32_e32 v2, 2, v4
; GFX1250-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset1:8
; GFX1250-NEXT:    ds_load_2addr_b32 v[2:3], v2 offset0:11 offset1:27
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_dual_add_f32 v0, v0, v1 :: v_dual_add_f32 v1, v2, v3
; GFX1250-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_store_b32 v4, v0, s[0:1] scale_offset
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-NEXT:    ds_load_2addr_b32 v[2:3], v2 offset0:11 offset1:27
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f32_e32 v1, v2, v3
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-NEXT:    global_store_b32 v4, v0, s[0:1] scale_offset
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v2, 2, v4
; GFX1250-NEXT:    ds_load_2addr_b32 v[0:1], v2 offset0:2 offset1:8
; GFX1250-NEXT:    ds_load_2addr_b32 v[2:3], v2 offset0:11 offset1:27
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_dual_add_f32 v0, v0, v1 :: v_dual_add_f32 v1, v2, v3
; GFX1250-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_store_b32 v4, v0, s[0:1] offset:8 scale_offset
; GFX1250-NEXT:    s_endpgm
  %tid.x = tail call i32 @llvm.amdgcn.workitem.id.x() #1
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshl_add_u32 v1, v0, 2, s2
; GFX1250-NEXT:    ds_load_b32 v2, v1
; GFX1250-NEXT:    ds_load_b32 v1, v1 offset:32
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f32_e32 v1, v2, v1
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshl_add_u32 v0, v2, 2, s2
...
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v0, 3, v4
; GFX1250-NEXT:    ds_load_2addr_b64 v[0:3], v0 offset1:8
; GFX1250-NEXT:    s_wait_dscnt 0x0
...
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v0, 3, v4
; GFX1250-NEXT:    ds_load_2addr_b64 v[0:3], v0 offset1:255
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_store_b64 v4, v[0:1], s[0:1] scale_offset
...
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshlrev_b32_e32 v2, 3, v4
; GFX1250-NEXT:    ds_load_b64 v[0:1], v2
; GFX1250-NEXT:    ds_load_b64 v[2:3], v2 offset:2056
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_store_b64 v4, v[0:1], s[0:1] scale_offset
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-NEXT:    v_lshl_add_u32 v2, v4, 3, s2
; GFX1250-NEXT:    ds_load_b64 v[0:1], v2
; GFX1250-NEXT:    ds_load_b64 v[2:3], v2 offset:56
; GFX1250-NEXT:    s_wait_dscnt 0x0
; GFX1250-NEXT:    v_add_f64_e32 v[0:1], v[0:1], v[2:3]
; GFX1250-NEXT:    global_store_b64 v4, v[0:1], s[0:1] scale_offset
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-NEXT:    v_bfe_u32 v0, v0, 10, 10
...
; GFX1250-NEXT:    v_lshlrev_b32_e32 v8, 2, v0
; GFX1250-NEXT:    s_lshl_b32 s0, s0, 2
; GFX1250-NEXT:    v_mov_b32_e32 v1, s0
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX1250-NEXT:    ds_load_b64 v[2:3], v1 offset:3104
; GFX1250-NEXT:    ds_load_b64 v[4:5], v1 offset:3168
; GFX1250-NEXT:    ds_load_b64 v[0:1], v8
; GFX1250-NEXT:    ds_load_b64 v[6:7], v8 offset:128
...
; GFX1250-NEXT:    ds_load_b64 v[2:3], v8 offset:256
; GFX1250-NEXT:    s_wait_dscnt 0x2
...
; GFX1250-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_dual_lshlrev_b32 v1, 4, v1 :: v_dual_lshlrev_b32 v0, 2, v0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    ds_load_b64 v[4:5], v4
