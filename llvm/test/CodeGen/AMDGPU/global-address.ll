...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1250-PAL %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdpal -mcpu=gfx1250 --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1250-PAL %s
...
; RUN: llc -global-isel=0 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1250-HSA %s
; RUN: llc -global-isel=1 -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1250 --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1250-HSA %s
...
; GFX1250-PAL-NEXT:    s_wait_alu 0xfffe
...
; GFX1250-HSA-NEXT:    s_wait_alu 0xfffe
; GFX1250-HSA-NEXT:    s_add_nc_u64 s[0:1], s[0:1], internal_func@GOTPCREL+8
...
; GFX1250-HSA-NEXT:    s_wait_alu 0xfffe
; GFX1250-HSA-NEXT:    s_add_nc_u64 s[12:13], s[12:13], external_func@rel64+8
; GFX1250-HSA-NEXT:    s_wait_alu 0xfffe
