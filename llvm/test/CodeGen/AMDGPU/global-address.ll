...
; GFX1210-PAL-NEXT:    s_mov_b32 s12, ttmp9
; GFX1210-PAL-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1210-PAL-NEXT:    s_mov_b64 s[8:9], s[4:5]
; GFX1210-PAL-NEXT:    s_and_b32 s13, ttmp7, 0xffff
; GFX1210-PAL-NEXT:    s_lshr_b32 s14, ttmp7, 16
; GFX1210-PAL-NEXT:    s_mov_b64 s[16:17], external_func@abs64
; GFX1210-PAL-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX1210-PAL-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX1210-PAL-NEXT:    s_mov_b32 s32, 0
; GFX1210-PAL-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX1210-PAL-NEXT:    s_endpgm
;
...
; GFX1210-HSA-NEXT:    s_mov_b32 s12, ttmp9
; GFX1210-HSA-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1210-HSA-NEXT:    s_mov_b64 s[8:9], s[4:5]
; GFX1210-HSA-NEXT:    s_and_b32 s13, ttmp7, 0xffff
; GFX1210-HSA-NEXT:    s_lshr_b32 s14, ttmp7, 16
; GFX1210-HSA-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX1210-HSA-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX1210-HSA-NEXT:    s_mov_b32 s32, 0
; GFX1210-HSA-NEXT:    s_getpc_b64 s[16:17]
; GFX1210-HSA-NEXT:    s_add_nc_u64 s[16:17], s[16:17], external_func@rel64+4
; GFX1210-HSA-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-HSA-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX1210-HSA-NEXT:    s_endpgm
