...
; GFX12-NEXT:    s_and_b32 s4, s3, 31
; GFX12-NEXT:    s_mov_b32 s3, s2
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[2:3], s4
...
; GFX12-NEXT:    s_and_b32 s3, s3, 31
; GFX12-NEXT:    s_lshr_b64 s[0:1], s[0:1], s2
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[6:7], s3
...
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: rotr_v8i32:
; GFX12:       ; %bb.0: ; %entry
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    s_load_b512 s[8:23], s[4:5], 0x44
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_and_b32 s19, s19, 31
; GFX12-NEXT:    s_mov_b32 s2, s11
; GFX12-NEXT:    s_mov_b32 s3, s11
; GFX12-NEXT:    s_and_b32 s17, s17, 31
; GFX12-NEXT:    s_mov_b32 s4, s9
; GFX12-NEXT:    s_mov_b32 s5, s9
; GFX12-NEXT:    s_and_b32 s16, s16, 31
; GFX12-NEXT:    s_mov_b32 s9, s8
; GFX12-NEXT:    s_lshr_b64 s[2:3], s[2:3], s19
; GFX12-NEXT:    s_lshr_b64 s[4:5], s[4:5], s17
; GFX12-NEXT:    s_and_b32 s23, s23, 31
; GFX12-NEXT:    s_mov_b32 s6, s15
; GFX12-NEXT:    s_mov_b32 s7, s15
; GFX12-NEXT:    s_and_b32 s22, s22, 31
; GFX12-NEXT:    s_mov_b32 s15, s14
; GFX12-NEXT:    s_lshr_b64 s[8:9], s[8:9], s16
; GFX12-NEXT:    s_mov_b32 s16, s13
; GFX12-NEXT:    s_mov_b32 s17, s13
; GFX12-NEXT:    s_and_b32 s3, s20, 31
; GFX12-NEXT:    s_mov_b32 s13, s12
; GFX12-NEXT:    s_and_b32 s5, s21, 31
; GFX12-NEXT:    s_and_b32 s18, s18, 31
; GFX12-NEXT:    s_mov_b32 s11, s10
; GFX12-NEXT:    s_lshr_b64 s[6:7], s[6:7], s23
; GFX12-NEXT:    s_lshr_b64 s[14:15], s[14:15], s22
; GFX12-NEXT:    s_lshr_b64 s[12:13], s[12:13], s3
; GFX12-NEXT:    s_lshr_b64 s[16:17], s[16:17], s5
; GFX12-NEXT:    s_lshr_b64 s[10:11], s[10:11], s18
; GFX12-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s16
; GFX12-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v3, s6
; GFX12-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v5, s4
; GFX12-NEXT:    v_dual_mov_b32 v4, s8 :: v_dual_mov_b32 v7, s2
