...
define amdgpu_kernel void @rotr_i32_sgpr(ptr addrspace(1) %in, i32 inreg %x, i32 inreg %y) {
; R600-LABEL: rotr_i32_sgpr:
; R600:       ; %bb.0: ; %entry
; R600-NEXT:    ALU 2, @4, KC0[CB0:0-32], KC1[]
; R600-NEXT:    MEM_RAT_CACHELESS STORE_RAW T1.X, T0.X, 1
; R600-NEXT:    CF_END
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-GISEL-TRUE16-LABEL: rotr_i32_sgpr:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
; GFX11-GISEL-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v0, s3
...
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
; GFX11-GISEL-FAKE16-LABEL: rotr_i32_sgpr:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-GISEL-FAKE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: rotr_i32_sgpr:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_and_b32 s4, s3, 31
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-GISEL-TRUE16-LABEL: rotr_v2i32:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
...
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
; GFX11-GISEL-FAKE16-LABEL: rotr_v2i32:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
...
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: rotr_v2i32:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b128 s[0:3], s[4:5], 0x2c
; GFX11-SDAG-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_mov_b32 s6, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s7, s1
; GFX11-SDAG-NEXT:    s_and_b32 s2, s2, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s1, s0
; GFX11-SDAG-NEXT:    s_and_b32 s3, s3, 31
; GFX11-SDAG-NEXT:    s_lshr_b64 s[0:1], s[0:1], s2
; GFX11-SDAG-NEXT:    s_lshr_b64 s[2:3], s[6:7], s3
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-GISEL-TRUE16-LABEL: rotr_v4i32:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
; GFX11-GISEL-TRUE16-NEXT:    s_clause 0x1
...
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v1, s13
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v3, s15
...
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
; GFX11-GISEL-FAKE16-LABEL: rotr_v4i32:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    s_clause 0x1
...
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v0, s8, s8, s12
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v1, s9, s9, s13
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v2, s10, s10, s14
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v3, s11, s11, s15
; GFX11-GISEL-FAKE16-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: rotr_v4i32:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b256 s[8:15], s[4:5], 0x34
; GFX11-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_and_b32 s6, s15, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s2, s11
; GFX11-SDAG-NEXT:    s_mov_b32 s3, s11
; GFX11-SDAG-NEXT:    s_and_b32 s7, s14, 31
...
; GFX11-SDAG-NEXT:    s_lshr_b64 s[2:3], s[2:3], s6
; GFX11-SDAG-NEXT:    s_lshr_b64 s[6:7], s[10:11], s7
; GFX11-SDAG-NEXT:    s_lshr_b64 s[8:9], s[8:9], s12
; GFX11-SDAG-NEXT:    s_lshr_b64 s[4:5], s[4:5], s13
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX10-NEXT:    s_endpgm
;
; GFX11-GISEL-TRUE16-LABEL: rotr_v8i32:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
; GFX11-GISEL-TRUE16-NEXT:    s_clause 0x1
; GFX11-GISEL-TRUE16-NEXT:    s_load_b512 s[8:23], s[4:5], 0x44
; GFX11-GISEL-TRUE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-GISEL-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s17
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v0, s16 :: v_dual_mov_b32 v3, s19
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v2, s18 :: v_dual_mov_b32 v5, s21
; GFX11-GISEL-TRUE16-NEXT:    v_dual_mov_b32 v4, s20 :: v_dual_mov_b32 v7, s23
; GFX11-GISEL-TRUE16-NEXT:    v_mov_b32_e32 v6, s22
; GFX11-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v0, s8, s8, v0.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v1, s9, s9, v1.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v2, s10, s10, v2.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v3, s11, s11, v3.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v4, s12, s12, v4.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v5, s13, s13, v5.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v6, s14, s14, v6.l
; GFX11-GISEL-TRUE16-NEXT:    v_alignbit_b32 v7, s15, s15, v7.l
; GFX11-GISEL-TRUE16-NEXT:    s_clause 0x1
; GFX11-GISEL-TRUE16-NEXT:    global_store_b128 v8, v[0:3], s[0:1]
; GFX11-GISEL-TRUE16-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:16
; GFX11-GISEL-TRUE16-NEXT:    s_endpgm
;
; GFX11-GISEL-FAKE16-LABEL: rotr_v8i32:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    s_clause 0x1
; GFX11-GISEL-FAKE16-NEXT:    s_load_b512 s[8:23], s[4:5], 0x44
; GFX11-GISEL-FAKE16-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-GISEL-FAKE16-NEXT:    v_mov_b32_e32 v8, 0
; GFX11-GISEL-FAKE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v0, s8, s8, s16
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v1, s9, s9, s17
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v2, s10, s10, s18
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v3, s11, s11, s19
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v4, s12, s12, s20
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v5, s13, s13, s21
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v6, s14, s14, s22
; GFX11-GISEL-FAKE16-NEXT:    v_alignbit_b32 v7, s15, s15, s23
; GFX11-GISEL-FAKE16-NEXT:    s_clause 0x1
; GFX11-GISEL-FAKE16-NEXT:    global_store_b128 v8, v[0:3], s[0:1]
; GFX11-GISEL-FAKE16-NEXT:    global_store_b128 v8, v[4:7], s[0:1] offset:16
; GFX11-GISEL-FAKE16-NEXT:    s_endpgm
;
; GFX11-SDAG-LABEL: rotr_v8i32:
; GFX11-SDAG:       ; %bb.0: ; %entry
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    s_load_b512 s[8:23], s[4:5], 0x44
; GFX11-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    s_and_b32 s19, s19, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s2, s11
; GFX11-SDAG-NEXT:    s_mov_b32 s3, s11
; GFX11-SDAG-NEXT:    s_and_b32 s17, s17, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s4, s9
; GFX11-SDAG-NEXT:    s_mov_b32 s5, s9
; GFX11-SDAG-NEXT:    s_and_b32 s16, s16, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s9, s8
; GFX11-SDAG-NEXT:    s_lshr_b64 s[2:3], s[2:3], s19
; GFX11-SDAG-NEXT:    s_lshr_b64 s[4:5], s[4:5], s17
; GFX11-SDAG-NEXT:    s_and_b32 s23, s23, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s6, s15
; GFX11-SDAG-NEXT:    s_mov_b32 s7, s15
; GFX11-SDAG-NEXT:    s_and_b32 s22, s22, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s15, s14
; GFX11-SDAG-NEXT:    s_lshr_b64 s[8:9], s[8:9], s16
; GFX11-SDAG-NEXT:    s_mov_b32 s16, s13
; GFX11-SDAG-NEXT:    s_mov_b32 s17, s13
; GFX11-SDAG-NEXT:    s_and_b32 s3, s20, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s13, s12
; GFX11-SDAG-NEXT:    s_and_b32 s5, s21, 31
; GFX11-SDAG-NEXT:    s_and_b32 s18, s18, 31
; GFX11-SDAG-NEXT:    s_mov_b32 s11, s10
; GFX11-SDAG-NEXT:    s_lshr_b64 s[6:7], s[6:7], s23
; GFX11-SDAG-NEXT:    s_lshr_b64 s[14:15], s[14:15], s22
; GFX11-SDAG-NEXT:    s_lshr_b64 s[12:13], s[12:13], s3
; GFX11-SDAG-NEXT:    s_lshr_b64 s[16:17], s[16:17], s5
; GFX11-SDAG-NEXT:    s_lshr_b64 s[10:11], s[10:11], s18
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s16
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v3, s6
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v2, s14 :: v_dual_mov_b32 v5, s4
; GFX11-SDAG-NEXT:    v_dual_mov_b32 v4, s8 :: v_dual_mov_b32 v7, s2
; GFX11-SDAG-NEXT:    v_mov_b32_e32 v6, s10
; GFX11-SDAG-NEXT:    s_clause 0x1
; GFX11-SDAG-NEXT:    global_store_b128 v8, v[0:3], s[0:1] offset:16
; GFX11-SDAG-NEXT:    global_store_b128 v8, v[4:7], s[0:1]
; GFX11-SDAG-NEXT:    s_endpgm
entry:
...
;
; GFX11-GISEL-TRUE16-LABEL: test_rotr_i16:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
...
; GFX11-SDAG-TRUE16-NEXT:    v_lshrrev_b16 v1.l, v2.l, v0.l
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_lshlrev_b16 v0.l, v0.h, v0.l
; GFX11-SDAG-TRUE16-NEXT:    v_or_b16 v0.l, v1.l, v0.l
; GFX11-SDAG-TRUE16-NEXT:    global_store_b16 v[4:5], v0, off offset:8
; GFX11-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
; GFX11-SDAG-FAKE16-LABEL: test_rotr_i16:
...
; GFX11-SDAG-FAKE16-NEXT:    v_lshrrev_b16 v2, v2, v0
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_lshlrev_b16 v0, v1, v0
