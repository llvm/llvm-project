...
; GFX8-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX900-NEXT:    v_lshrrev_b32_e64 v0, 6, s32
; GFX900-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX942-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX10_1-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX10_3-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX11-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
...
; GFX12-NEXT:    ; kill: def $sgpr48_55 killed $sgpr48_55 def $sgpr54
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
