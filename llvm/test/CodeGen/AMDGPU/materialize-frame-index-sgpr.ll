...
; FIXME: GCN Trackers do not track pressure from PhysRegs. This test uses inline
; assembly but GCN trackers do not account for the physical registers, leading to
; out of registers during RA. Hence GCN trackers are disabled for this test.
