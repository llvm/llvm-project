...
; GFX7-LABEL: test_s_unsigned_i64_f32:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-NEXT:    v_trunc_f32_e32 v0, s16
; GFX7-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GFX7-NEXT:    v_floor_f32_e32 v1, v1
; GFX7-NEXT:    s_mov_b32 s4, 0xcf800000
; GFX7-NEXT:    v_cvt_u32_f32_e32 v2, v1
; GFX7-NEXT:    v_fma_f32 v0, v1, s4, v0
; GFX7-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-NEXT:    v_cmp_nge_f32_e64 s[4:5], s16, 0
; GFX7-NEXT:    v_cndmask_b32_e64 v1, v2, 0, s[4:5]
; GFX7-NEXT:    v_mov_b32_e32 v2, 0x5f7fffff
; GFX7-NEXT:    v_cmp_gt_f32_e32 vcc, s16, v2
; GFX7-NEXT:    v_cndmask_b32_e64 v0, v0, 0, s[4:5]
; GFX7-NEXT:    v_cndmask_b32_e64 v1, v1, -1, vcc
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-LABEL: test_s_unsigned_i64_f32:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    s_wait_expcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-NEXT:    s_cmp_gt_f32 s0, 0x5f7fffff
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_cselect_b32 s0, -1, s1
; GFX12-NEXT:    s_cselect_b32 s1, -1, s2
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX7-LABEL: test_s_unsigned_i64_f64:
; GFX7:       ; %bb.0:
; GFX7-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-NEXT:    v_cvt_u32_f64_e32 v4, v[2:3]
; GFX7-NEXT:    v_mov_b32_e32 v2, -1
; GFX7-NEXT:    v_mov_b32_e32 v3, 0x43efffff
; GFX7-NEXT:    v_cmp_nge_f64_e64 s[4:5], s[16:17], 0
; GFX7-NEXT:    v_cmp_gt_f64_e32 vcc, s[16:17], v[2:3]
; GFX7-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-LABEL: test_s_unsigned_i64_f64:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    s_wait_expcnt 0x0
; GFX12-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-NEXT:    v_cmp_nge_f64_e64 s4, s[0:1], 0
; GFX12-NEXT:    s_mov_b32 s2, -1
; GFX12-NEXT:    s_mov_b32 s3, 0x43efffff
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_cmp_gt_f64_e64 s0, s[0:1], s[2:3]
...
; GFX12-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v2, 0, s4
; GFX12-NEXT:    v_cndmask_b32_e64 v1, v1, -1, s0
