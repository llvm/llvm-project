...
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel_hi:[0,1,1]
; SDAG-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX906-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel_hi:[0,1,1]
; SDAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
...
; SDAG-GFX1100-LABEL: v_mad_mix_f32_f16lo_sub_f16lo:
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX906-LABEL: v_mad_mix_f32_f16lo_sub_f16lo:
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GISEL-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX906-LABEL: v_mad_mix_f32_f16lo_sub_f16lo:
; GISEL-GFX906:       ; %bb.0:
; GISEL-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; SDAG-GFX1100-LABEL: v_mad_mix_f32_absf16lo_sub_f16lo:
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, |v0| op_sel_hi:[1,1,1]
; SDAG-GFX1100-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX906-LABEL: v_mad_mix_f32_absf16lo_sub_f16lo:
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX906-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, |v0| op_sel_hi:[1,1,1]
; SDAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
...
; GISEL-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX906-LABEL: v_mad_mix_f32_absf16lo_sub_f16lo:
; GISEL-GFX906:       ; %bb.0:
; GISEL-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; SDAG-GFX1100-LABEL: v_mad_mix_f32_f16hi_fsub_f16hi:
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel:[1,0,1] op_sel_hi:[1,1,1]
; SDAG-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX906-LABEL: v_mad_mix_f32_f16hi_fsub_f16hi:
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX906-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel:[1,0,1] op_sel_hi:[1,1,1]
; SDAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX906-LABEL: v_mad_mix_f32_f16hi_fsub_f16hi:
; GISEL-GFX906:       ; %bb.0:
; GISEL-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_sdwa v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_sdwa v1, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GISEL-GFX906-NEXT:    v_sub_f32_e32 v0, v0, v1
; GISEL-GFX906-NEXT:    s_setpc_b64 s[30:31]
  %src0.hi = lshr i32 %src0, 16
  %src1.hi = lshr i32 %src1, 16
...
; SDAG-GFX1100-LABEL: v_mad_mix_f32_absf16hi_fsub_f16hi:
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, |v0| op_sel:[1,0,1] op_sel_hi:[1,1,1]
; SDAG-GFX1100-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX906-LABEL: v_mad_mix_f32_absf16hi_fsub_f16hi:
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX906-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, |v0| op_sel:[1,0,1] op_sel_hi:[1,1,1]
; SDAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
...
; GISEL-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX906-LABEL: v_mad_mix_f32_absf16hi_fsub_f16hi:
; GISEL-GFX906:       ; %bb.0:
; GISEL-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_sdwa v0, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_sdwa v1, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; SDAG-GFX1100-LABEL: v_mad_mix_f32_f16lo_sub_f16lo_nnan:
; SDAG-GFX1100:       ; %bb.0:
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX1100-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel_hi:[1,1,1]
; SDAG-GFX1100-NEXT:    s_setpc_b64 s[30:31]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; SDAG-GFX906-LABEL: v_mad_mix_f32_f16lo_sub_f16lo_nnan:
; SDAG-GFX906:       ; %bb.0:
; SDAG-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-GFX906-NEXT:    v_fma_mix_f32 v0, -v1, 1.0, v0 op_sel_hi:[1,1,1]
; SDAG-GFX906-NEXT:    s_setpc_b64 s[30:31]
...
; CI-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX1100-LABEL: v_mad_mix_f32_f16lo_sub_f16lo_nnan:
; GISEL-GFX1100:       ; %bb.0:
; GISEL-GFX1100-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX1100-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GISEL-GFX1100-NEXT:    v_cvt_f32_f16_e32 v1, v1
...
; GISEL-GFX1100-NEXT:    s_setpc_b64 s[30:31]
;
; GISEL-GFX906-LABEL: v_mad_mix_f32_f16lo_sub_f16lo_nnan:
; GISEL-GFX906:       ; %bb.0:
; GISEL-GFX906-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GISEL-GFX906-NEXT:    v_cvt_f32_f16_e32 v1, v1
