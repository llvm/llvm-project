...
; GFX950-LABEL: fminnum_v4f16_neg:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-NEXT:    v_pk_min_f16 v0, v0, v2 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_min_f16 v1, v1, v3 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX950-LABEL: fminnum_v8f16_neg:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-NEXT:    v_pk_min_f16 v0, v0, v4 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_min_f16 v1, v1, v5 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_min_f16 v2, v2, v6 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_min_f16 v3, v3, v7 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX950-LABEL: fmaxnum_v4f16_neg:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-NEXT:    v_pk_max_f16 v0, v0, v2 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_max_f16 v1, v1, v3 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX950-LABEL: fmaxnum_v8f16_neg:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX950-NEXT:    v_pk_max_f16 v0, v0, v4 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_max_f16 v1, v1, v5 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_max_f16 v2, v2, v6 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    v_pk_max_f16 v3, v3, v7 neg_lo:[0,1] neg_hi:[0,1]
; GFX950-NEXT:    s_setpc_b64 s[30:31]
;
