...
; GFX-940-NEXT:    s_cselect_b32 s2, s4, s5
...
; GFX-940-NEXT:    s_pack_hh_b32_b16 s0, s0, s2
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    v_cvt_f32_f64_e32 v2, v[2:3]
; GFX1210-NEXT:    v_cvt_f32_f64_e32 v0, v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, v2
; GFX1210-NEXT:    ; return to shader part epilog
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_cvt_f32_f64_e64 v0, -v[0:1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_cvt_pk_bf16_f32 v0, v0, s0
; GFX1210-NEXT:    flat_store_b16 v[2:3], v0
; GFX1210-NEXT:    s_endpgm
