...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu6.00 -global-isel=1 < %s | FileCheck -check-prefixes=SI-GISEL %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu8.03 -global-isel=1 -mattr=-flat-for-global < %s | FileCheck -enable-var-scope -check-prefixes=VI-GISEL %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.00 -global-isel=1 -mattr=-flat-for-global -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX9-GISEL %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu9.50 -global-isel=1 -mattr=-flat-for-global -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX950-GISEL %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu11.00 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX11-GISEL-FAKE16 %s
...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgpu12.50 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-FAKE16 %s
...
; GFX1250-SDAG-TRUE16-NEXT:    global_prefetch_b8 v0, null scope:SCOPE_SE
...
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_bfe_u32 s4, s3, 0xb0014
; SI-GISEL-NEXT:    s_lshr_b32 s5, s3, 8
; SI-GISEL-NEXT:    s_and_b32 s6, s3, 0x1ff
; SI-GISEL-NEXT:    s_addk_i32 s4, 0xfc10
; SI-GISEL-NEXT:    s_and_b32 s5, s5, 0xffe
; SI-GISEL-NEXT:    s_or_b32 s2, s6, s2
; SI-GISEL-NEXT:    s_cselect_b32 s2, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s2, s5, s2
; SI-GISEL-NEXT:    s_cselect_b32 s5, 1, 0
; SI-GISEL-NEXT:    s_sub_i32 s7, 1, s4
; SI-GISEL-NEXT:    s_lshl_b32 s6, s4, 12
; SI-GISEL-NEXT:    s_max_i32 s7, s7, 0
; SI-GISEL-NEXT:    s_or_b32 s6, s2, s6
; SI-GISEL-NEXT:    s_min_i32 s7, s7, 13
; SI-GISEL-NEXT:    s_bitset1_b32 s2, 12
; SI-GISEL-NEXT:    s_lshl_b32 s5, s5, 9
; SI-GISEL-NEXT:    s_lshr_b32 s8, s2, s7
; SI-GISEL-NEXT:    s_or_b32 s5, s5, 0x7c00
; SI-GISEL-NEXT:    s_lshl_b32 s7, s8, s7
; SI-GISEL-NEXT:    s_cmp_lg_u32 s7, s2
; SI-GISEL-NEXT:    s_cselect_b32 s2, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s2, s8, s2
; SI-GISEL-NEXT:    s_cmp_lt_i32 s4, 1
; SI-GISEL-NEXT:    s_cselect_b32 s2, s2, s6
; SI-GISEL-NEXT:    s_and_b32 s6, s2, 7
; SI-GISEL-NEXT:    s_lshr_b32 s2, s2, 2
; SI-GISEL-NEXT:    s_cmp_eq_u32 s6, 3
; SI-GISEL-NEXT:    s_cselect_b32 s7, 1, 0
; SI-GISEL-NEXT:    s_cmp_gt_i32 s6, 5
; SI-GISEL-NEXT:    s_cselect_b32 s6, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s6, s7, s6
; SI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; SI-GISEL-NEXT:    s_cselect_b32 s6, 1, 0
; SI-GISEL-NEXT:    s_add_i32 s2, s2, s6
; SI-GISEL-NEXT:    s_cmp_gt_i32 s4, 30
; SI-GISEL-NEXT:    s_cselect_b32 s2, 0x7c00, s2
; SI-GISEL-NEXT:    s_cmpk_eq_i32 s4, 0x40f
; SI-GISEL-NEXT:    s_cselect_b32 s2, s5, s2
; SI-GISEL-NEXT:    s_lshr_b32 s3, s3, 16
; SI-GISEL-NEXT:    s_and_b32 s3, s3, 0x8000
; SI-GISEL-NEXT:    s_or_b32 s2, s3, s2
...
; SI-GISEL-NEXT:    s_load_dwordx2 s[2:3], s[2:3], 0x0
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    v_cvt_f32_f64_e32 v0, s[2:3]
; SI-GISEL-NEXT:    s_mov_b32 s2, -1
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
...
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; SI-GISEL-NEXT:    s_bfe_u32 s2, s5, 0xb0014
; SI-GISEL-NEXT:    s_lshr_b32 s3, s5, 8
; SI-GISEL-NEXT:    s_and_b32 s8, s5, 0x1ff
; SI-GISEL-NEXT:    s_addk_i32 s2, 0xfc10
; SI-GISEL-NEXT:    s_and_b32 s3, s3, 0xffe
; SI-GISEL-NEXT:    s_or_b32 s4, s8, s4
; SI-GISEL-NEXT:    s_cselect_b32 s4, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s3, s3, s4
; SI-GISEL-NEXT:    s_cselect_b32 s4, 1, 0
; SI-GISEL-NEXT:    s_sub_i32 s9, 1, s2
; SI-GISEL-NEXT:    s_lshl_b32 s8, s2, 12
; SI-GISEL-NEXT:    s_max_i32 s9, s9, 0
; SI-GISEL-NEXT:    s_or_b32 s8, s3, s8
; SI-GISEL-NEXT:    s_min_i32 s9, s9, 13
; SI-GISEL-NEXT:    s_bitset1_b32 s3, 12
; SI-GISEL-NEXT:    s_lshl_b32 s4, s4, 9
; SI-GISEL-NEXT:    s_lshr_b32 s10, s3, s9
; SI-GISEL-NEXT:    s_or_b32 s4, s4, 0x7c00
; SI-GISEL-NEXT:    s_lshl_b32 s9, s10, s9
; SI-GISEL-NEXT:    s_cmp_lg_u32 s9, s3
; SI-GISEL-NEXT:    s_cselect_b32 s3, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s3, s10, s3
; SI-GISEL-NEXT:    s_cmp_lt_i32 s2, 1
; SI-GISEL-NEXT:    s_cselect_b32 s3, s3, s8
; SI-GISEL-NEXT:    s_and_b32 s8, s3, 7
; SI-GISEL-NEXT:    s_lshr_b32 s3, s3, 2
...
; SI-GISEL-NEXT:    s_cselect_b32 s8, 1, 0
; SI-GISEL-NEXT:    s_add_i32 s3, s3, s8
; SI-GISEL-NEXT:    s_cmp_gt_i32 s2, 30
; SI-GISEL-NEXT:    s_cselect_b32 s3, 0x7c00, s3
; SI-GISEL-NEXT:    s_cmpk_eq_i32 s2, 0x40f
; SI-GISEL-NEXT:    s_cselect_b32 s2, s4, s3
; SI-GISEL-NEXT:    s_lshr_b32 s3, s5, 16
; SI-GISEL-NEXT:    s_and_b32 s3, s3, 0x8000
; SI-GISEL-NEXT:    s_or_b32 s2, s3, s2
; SI-GISEL-NEXT:    s_bfe_u32 s3, s7, 0xb0014
; SI-GISEL-NEXT:    s_lshr_b32 s4, s7, 8
; SI-GISEL-NEXT:    s_addk_i32 s3, 0xfc10
; SI-GISEL-NEXT:    s_and_b32 s4, s4, 0xffe
; SI-GISEL-NEXT:    s_and_b32 s5, s7, 0x1ff
; SI-GISEL-NEXT:    s_or_b32 s5, s5, s6
; SI-GISEL-NEXT:    s_cselect_b32 s5, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s4, s4, s5
; SI-GISEL-NEXT:    s_cselect_b32 s5, 1, 0
; SI-GISEL-NEXT:    s_sub_i32 s8, 1, s3
; SI-GISEL-NEXT:    s_lshl_b32 s6, s3, 12
; SI-GISEL-NEXT:    s_max_i32 s8, s8, 0
; SI-GISEL-NEXT:    s_or_b32 s6, s4, s6
; SI-GISEL-NEXT:    s_min_i32 s8, s8, 13
; SI-GISEL-NEXT:    s_bitset1_b32 s4, 12
; SI-GISEL-NEXT:    s_lshl_b32 s5, s5, 9
; SI-GISEL-NEXT:    s_lshr_b32 s9, s4, s8
; SI-GISEL-NEXT:    s_or_b32 s5, s5, 0x7c00
; SI-GISEL-NEXT:    s_lshl_b32 s8, s9, s8
; SI-GISEL-NEXT:    s_cmp_lg_u32 s8, s4
; SI-GISEL-NEXT:    s_cselect_b32 s4, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s4, s9, s4
; SI-GISEL-NEXT:    s_cmp_lt_i32 s3, 1
; SI-GISEL-NEXT:    s_cselect_b32 s4, s4, s6
; SI-GISEL-NEXT:    s_and_b32 s6, s4, 7
; SI-GISEL-NEXT:    s_lshr_b32 s4, s4, 2
; SI-GISEL-NEXT:    s_cmp_eq_u32 s6, 3
; SI-GISEL-NEXT:    s_cselect_b32 s8, 1, 0
; SI-GISEL-NEXT:    s_cmp_gt_i32 s6, 5
; SI-GISEL-NEXT:    s_cselect_b32 s6, 1, 0
; SI-GISEL-NEXT:    s_or_b32 s6, s8, s6
; SI-GISEL-NEXT:    s_cmp_lg_u32 s6, 0
; SI-GISEL-NEXT:    s_cselect_b32 s6, 1, 0
; SI-GISEL-NEXT:    s_add_i32 s4, s4, s6
; SI-GISEL-NEXT:    s_cmp_gt_i32 s3, 30
; SI-GISEL-NEXT:    s_cselect_b32 s4, 0x7c00, s4
; SI-GISEL-NEXT:    s_cmpk_eq_i32 s3, 0x40f
; SI-GISEL-NEXT:    s_cselect_b32 s3, s5, s4
; SI-GISEL-NEXT:    s_lshr_b32 s4, s7, 16
; SI-GISEL-NEXT:    s_and_b32 s4, s4, 0x8000
; SI-GISEL-NEXT:    s_or_b32 s3, s4, s3
; SI-GISEL-NEXT:    s_and_b32 s3, s3, 0xffff
; SI-GISEL-NEXT:    s_and_b32 s2, s2, 0xffff
; SI-GISEL-NEXT:    s_lshl_b32 s3, s3, 16
; SI-GISEL-NEXT:    s_or_b32 s2, s2, s3
; SI-GISEL-NEXT:    v_mov_b32_e32 v0, s2
; SI-GISEL-NEXT:    s_mov_b32 s2, -1
; SI-GISEL-NEXT:    s_mov_b32 s3, 0xf000
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
