...
;  TODO: FIXME-TRUE16 llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1250 -global-isel=0 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-SDAG-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1250 -global-isel=0 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-SDAG-FAKE16 %s
; TODO: FIXME-TRUE16  llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1250 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1250 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX1250-GISEL-FAKE16 %s
; TODO: FIXME-TRUE16 llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1300 -global-isel=0 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX13-SDAG-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1300 -global-isel=0 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX13-SDAG-FAKE16 %s
; TODO: FIXME-TRUE16 llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1300 -global-isel=1 -mattr=-flat-for-global,+real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX13-GISEL-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1300 -global-isel=1 -mattr=-flat-for-global,-real-true16 -denormal-fp-math=preserve-sign -verify-machineinstrs -enable-unsafe-fp-math < %s | FileCheck -enable-var-scope -check-prefixes=GFX13-GISEL-FAKE16 %s
...
define amdgpu_ps float @fptrunc_f32_f32_to_v2f16(float %a, float %b) {
; SI-SDAG-LABEL: fptrunc_f32_f32_to_v2f16:
; SI-SDAG:       ; %bb.0: ; %entry
; SI-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; SI-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; SI-SDAG-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
...
;
; SI-GISEL-LABEL: fptrunc_f32_f32_to_v2f16:
; SI-GISEL:       ; %bb.0: ; %entry
; SI-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; SI-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
...
;
; VI-SDAG-LABEL: fptrunc_f32_f32_to_v2f16:
; VI-SDAG:       ; %bb.0: ; %entry
; VI-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; VI-SDAG-NEXT:    v_cvt_f16_f32_sdwa v1, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-SDAG-NEXT:    v_or_b32_e32 v0, v0, v1
...
;
; VI-GISEL-LABEL: fptrunc_f32_f32_to_v2f16:
; VI-GISEL:       ; %bb.0: ; %entry
; VI-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; VI-GISEL-NEXT:    v_cvt_f16_f32_sdwa v1, v1 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
...
;
; GFX9-SDAG-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX9-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX9-SDAG-NEXT:    v_pack_b32_f16 v0, v0, v1
...
;
; GFX9-GISEL-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX9-GISEL:       ; %bb.0: ; %entry
; GFX9-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX9-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX9-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
...
;
; GFX950-SDAG-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX950-SDAG:       ; %bb.0: ; %entry
; GFX950-SDAG-NEXT:    v_cvt_pk_f16_f32 v0, v0, v1
; GFX950-SDAG-NEXT:    ; return to shader part epilog
;
; GFX950-GISEL-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX950-GISEL:       ; %bb.0: ; %entry
; GFX950-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX950-GISEL-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX950-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
...
;
; GFX11-SDAG-TRUE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.l, v0
; GFX11-SDAG-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.h, v1
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
;
; GFX11-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX11-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX11-SDAG-FAKE16-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX11-SDAG-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
;
; GFX11-GISEL-TRUE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
; GFX11-GISEL-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.l, v0
; GFX11-GISEL-TRUE16-NEXT:    v_cvt_f16_f32_e32 v0.h, v1
; GFX11-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
;
; GFX11-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX11-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
;
; GFX1250-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX1250-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX1250-SDAG-FAKE16-NEXT:    v_cvt_pk_f16_f32 v0, v0, v1
; GFX1250-SDAG-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX1250-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX1250-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX1250-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX1250-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX1250-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
;
; GFX13-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX13-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX13-SDAG-FAKE16-NEXT:    v_cvt_pk_f16_f32 v0, v0, v1
; GFX13-SDAG-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16:
; GFX13-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX13-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX13-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX13-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
entry:
  %a.cvt = fptrunc float %a to half
  %b.cvt = fptrunc float %b to half
  %v2.1 = insertelement <2 x half> undef, half %a.cvt, i32 0
  %v2.2 = insertelement <2 x half> %v2.1, half %b.cvt, i32 1
  %ret = bitcast <2 x half> %v2.2 to float
  ret float %ret
}

define amdgpu_ps float @fptrunc_f32_f32_to_v2f16_mods(float %a, float %b) {
; SI-SDAG-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; SI-SDAG:       ; %bb.0: ; %entry
; SI-SDAG-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; SI-SDAG-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; SI-SDAG-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; SI-SDAG-NEXT:    v_or_b32_e32 v0, v0, v1
; SI-SDAG-NEXT:    ; return to shader part epilog
;
; SI-GISEL-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; SI-GISEL:       ; %bb.0: ; %entry
; SI-GISEL-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; SI-GISEL-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; SI-GISEL-NEXT:    v_or_b32_e32 v0, v0, v1
; SI-GISEL-NEXT:    ; return to shader part epilog
;
; VI-SDAG-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; VI-SDAG:       ; %bb.0: ; %entry
; VI-SDAG-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; VI-SDAG-NEXT:    v_cvt_f16_f32_sdwa v1, |v1| dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-SDAG-NEXT:    v_or_b32_e32 v0, v0, v1
; VI-SDAG-NEXT:    ; return to shader part epilog
;
; VI-GISEL-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; VI-GISEL:       ; %bb.0: ; %entry
...
; VI-GISEL-NEXT:    ; return to shader part epilog
;
; GFX9-SDAG-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX9-SDAG:       ; %bb.0: ; %entry
; GFX9-SDAG-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX9-SDAG-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX9-SDAG-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX9-SDAG-NEXT:    ; return to shader part epilog
;
; GFX9-GISEL-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX9-GISEL:       ; %bb.0: ; %entry
; GFX9-GISEL-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX9-GISEL-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX9-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX9-GISEL-NEXT:    ; return to shader part epilog
;
; GFX950-SDAG-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX950-SDAG:       ; %bb.0: ; %entry
; GFX950-SDAG-NEXT:    v_cvt_pk_f16_f32 v0, -v0, |v1|
; GFX950-SDAG-NEXT:    ; return to shader part epilog
;
; GFX950-GISEL-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX950-GISEL:       ; %bb.0: ; %entry
; GFX950-GISEL-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX950-GISEL-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX950-GISEL-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX950-GISEL-NEXT:    ; return to shader part epilog
;
; GFX11-SDAG-TRUE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX11-SDAG-TRUE16:       ; %bb.0: ; %entry
; GFX11-SDAG-TRUE16-NEXT:    v_cvt_f16_f32_e64 v0.l, -v0
; GFX11-SDAG-TRUE16-NEXT:    v_cvt_f16_f32_e64 v0.h, |v1|
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-TRUE16-NEXT:    v_pack_b32_f16 v0, v0.l, v0.h
; GFX11-SDAG-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX11-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX11-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX11-SDAG-FAKE16-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX11-SDAG-FAKE16-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX11-SDAG-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX11-SDAG-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX11-GISEL-TRUE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX11-GISEL-TRUE16:       ; %bb.0: ; %entry
; GFX11-GISEL-TRUE16-NEXT:    v_cvt_f16_f32_e64 v0.l, -v0
; GFX11-GISEL-TRUE16-NEXT:    v_cvt_f16_f32_e64 v0.h, |v1|
; GFX11-GISEL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-TRUE16-NEXT:    v_pack_b32_f16 v0, v0.l, v0.h
; GFX11-GISEL-TRUE16-NEXT:    ; return to shader part epilog
;
; GFX11-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX11-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX11-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX11-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX11-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX11-GISEL-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX1250-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX1250-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX1250-SDAG-FAKE16-NEXT:    v_cvt_pk_f16_f32 v0, -v0, |v1|
; GFX1250-SDAG-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX1250-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX1250-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX1250-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX1250-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX1250-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX1250-GISEL-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX13-SDAG-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX13-SDAG-FAKE16:       ; %bb.0: ; %entry
; GFX13-SDAG-FAKE16-NEXT:    v_cvt_pk_f16_f32 v0, -v0, |v1|
; GFX13-SDAG-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX13-GISEL-FAKE16-LABEL: fptrunc_f32_f32_to_v2f16_mods:
; GFX13-GISEL-FAKE16:       ; %bb.0: ; %entry
; GFX13-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v0, -v0
; GFX13-GISEL-FAKE16-NEXT:    v_cvt_f16_f32_e64 v1, |v1|
; GFX13-GISEL-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX13-GISEL-FAKE16-NEXT:    v_pack_b32_f16 v0, v0, v1
; GFX13-GISEL-FAKE16-NEXT:    ; return to shader part epilog
entry:
  %a.neg = fneg float %a
  %a.cvt = fptrunc float %a.neg to half
  %b.abs = call float @llvm.fabs.f32(float %b)
  %b.cvt = fptrunc float %b.abs to half
  %v2.1 = insertelement <2 x half> undef, half %a.cvt, i32 0
  %v2.2 = insertelement <2 x half> %v2.1, half %b.cvt, i32 1
  %ret = bitcast <2 x half> %v2.2 to float
  ret float %ret
