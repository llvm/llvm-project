...
; GCN-O0-NEXT:        AMDGPUConditionalDiscard
...
; GCN-O0-NEXT:        SI Insert Scratch Bounds Checks
...
; GCN-O0-NEXT:        SI Resolve Scratch Size Symbols
; GCN-O0-NEXT:        MachineDominator Tree Construction
...
; GCN-O1-NEXT:        AMDGPUConditionalDiscard
; GCN-O1-NEXT:        Post-Dominator Tree Construction
; GCN-O1-NEXT:        Dominator Tree Construction
; GCN-O1-NEXT:        Natural Loop Information
; GCN-O1-NEXT:        Legacy Divergence Analysis
...
; GCN-O1-NEXT:        SI Insert Scratch Bounds Checks
...
; GCN-O1-NEXT:        SI Insert Delay ALU
...
; GCN-O1-OPTS-NEXT:        AMDGPUConditionalDiscard
; GCN-O1-OPTS-NEXT:        Post-Dominator Tree Construction
; GCN-O1-OPTS-NEXT:        Dominator Tree Construction
; GCN-O1-OPTS-NEXT:        Natural Loop Information
; GCN-O1-OPTS-NEXT:        Legacy Divergence Analysis
...
; GCN-O1-OPTS-NEXT:        SI Insert Scratch Bounds Checks
...
; GCN-O1-OPTS-NEXT:        SI Insert Delay ALU
...
; GCN-O2-NEXT:        AMDGPUConditionalDiscard
; GCN-O2-NEXT:        Post-Dominator Tree Construction
; GCN-O2-NEXT:        Dominator Tree Construction
; GCN-O2-NEXT:        Natural Loop Information
; GCN-O2-NEXT:        Legacy Divergence Analysis
...
; GCN-O2-NEXT:        SI Insert Scratch Bounds Checks
...
; GCN-O2-NEXT:        SI Insert Delay ALU
...
; GCN-O3-NEXT:        AMDGPUConditionalDiscard
; GCN-O3-NEXT:        Post-Dominator Tree Construction
; GCN-O3-NEXT:        Dominator Tree Construction
; GCN-O3-NEXT:        Natural Loop Information
; GCN-O3-NEXT:        Legacy Divergence Analysis
...
; GCN-O3-NEXT:        SI Insert Scratch Bounds Checks
...
; GCN-O3-NEXT:        SI Insert Delay ALU
