...
; RUN: llc -global-isel=0 -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs -mattr=+wavefrontsize32,-wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-SDAG %s
; RUN: llc -global-isel=1 -march=amdgcn -mcpu=gfx1210 -verify-machineinstrs -mattr=+wavefrontsize32,-wavefrontsize64 < %s | FileCheck -check-prefixes=GFX1210,GFX1210-GISEL %s

declare <2 x i32>    @llvm.amdgcn.global.load.tr4.v2i32.p1(ptr addrspace(1))
declare <2 x i32>    @llvm.amdgcn.global.load.tr.v2i32.p1(ptr addrspace(1))
declare <3 x i32>    @llvm.amdgcn.global.load.tr6.v3i32.p1(ptr addrspace(1))
...
declare <2 x i32>    @llvm.amdgcn.ds.load.tr4.v2i32.p3(ptr addrspace(3))
declare <2 x i32>    @llvm.amdgcn.ds.load.tr.v2i32.p3(ptr addrspace(3))
declare <3 x i32>    @llvm.amdgcn.ds.load.tr6.v3i32.p3(ptr addrspace(3))
...
entry:
  ...
  %val = call <2 x i32> @llvm.amdgcn.global.load.tr4.v2i32.p1(ptr addrspace(1) %gep)
  store <2 x i32> %val, ptr addrspace(1) %use
  ret void
}

define amdgpu_ps void @global_load_tr4_b64_saddr(ptr addrspace(1) inreg %addr, ptr addrspace(1) %use) {
; GFX1210-LABEL: global_load_tr4_b64_saddr:
; GFX1210:       ; %bb.0: ; %entry
...
; GFX1210-LABEL: global_load_tr8_b64_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_tr_b64 v[0:1], v[0:1], off offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b64 v[2:3], v[0:1], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
...
; GFX1210-LABEL: global_load_tr8_b64_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_tr_b64 v[2:3], v2, s[0:1] offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b64 v[0:1], v[2:3], off
; GFX1210-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1210-NEXT:    s_endpgm
...
; GFX1210-LABEL: global_load_tr6_b96_vaddr:
; GFX1210:       ; %bb.0: ; %entry
...
entry:
  %gep = getelementptr i64, ptr addrspace(1) %addr, i32 4
  %val = call <3 x i32> @llvm.amdgcn.global.load.tr6.v3i32.p1(ptr addrspace(1) %gep)
...
; GFX1210-LABEL: global_load_tr6_b96_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
...
; GFX1210-LABEL: global_load_tr16_b128_v8i16_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_tr_b128 v[4:7], v[0:1], off offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_tr16_b128_v8i16_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_tr_b128 v[2:5], v2, s[0:1] offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-LABEL: global_load_tr16_b128_v8f16_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_tr_b128 v[4:7], v[0:1], off offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b128 v[2:3], v[4:7], off
...
; GFX1210-LABEL: global_load_tr16_b128_v8f16_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_tr_b128 v[2:5], v2, s[0:1] offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
define amdgpu_ps void @global_load_tr16_b128_v8bf16_vaddr(ptr addrspace(1) %addr, ptr addrspace(1) %use) {
; GFX1210-LABEL: global_load_tr16_b128_v8bf16_vaddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    global_load_tr_b128 v[4:7], v[0:1], off offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
; GFX1210-NEXT:    global_store_b128 v[2:3], v[4:7], off
...
; GFX1210-LABEL: global_load_tr16_b128_v8bf16_saddr:
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    v_mov_b32_e32 v2, 0
; GFX1210-NEXT:    global_load_tr_b128 v[2:5], v2, s[0:1] offset:32
; GFX1210-NEXT:    s_wait_loadcnt 0x0
...
; GFX1210-SDAG-LABEL: ds_load_tr4_b64:
...
entry:
  ...
  %val = call <2 x i32> @llvm.amdgcn.ds.load.tr4.v2i32.p3(ptr addrspace(3) %gep)
  store <2 x i32> %val, ptr addrspace(1) %use
  ret void
}

define amdgpu_ps void @ds_load_tr8_b64(ptr addrspace(3) %addr, ptr addrspace(1) %use) {
; GFX1210-SDAG-LABEL: ds_load_tr8_b64:
; GFX1210-SDAG:       ; %bb.0: ; %entry
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v2, v1
...
; GFX1210-SDAG-LABEL: ds_load_tr6_b96:
; GFX1210-SDAG:       ; %bb.0: ; %entry
...
entry:
  %gep = getelementptr i64, ptr addrspace(3) %addr, i32 4
  %val = call <3 x i32> @llvm.amdgcn.ds.load.tr6.v3i32.p3(ptr addrspace(3) %gep)
  store <3 x i32> %val, ptr addrspace(1) %use
  ret void
}

define amdgpu_ps void @ds_load_tr16_b128_v8i16(ptr addrspace(3) %addr, ptr addrspace(1) %use) {
; GFX1210-SDAG-LABEL: ds_load_tr16_b128_v8i16:
; GFX1210-SDAG:       ; %bb.0: ; %entry
; GFX1210-SDAG-NEXT:    v_dual_mov_b32 v5, v2 :: v_dual_mov_b32 v4, v1
