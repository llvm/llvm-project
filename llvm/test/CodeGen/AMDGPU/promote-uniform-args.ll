...
; CHECK-SAME: ptr inreg [[P:%.*]], i32 [[I:%.*]], float inreg [[F:%.*]]) {
...
; CHECK-SAME: i32 inreg [[N:%.*]], ptr inreg [[P:%.*]]) {
...
; CHECK-SAME: ptr inreg [[P0:%.*]], ptr inreg [[P1:%.*]], ptr inreg [[P2:%.*]]) {
; CHECK-NEXT:    ret void
;
  ret void
}
...
; CHECK-SAME: ptr [[P0:%.*]], ptr [[P1:%.*]], ptr [[P2:%.*]]) {
...
; CHECK-SAME: <2 x i32> [[V:%.*]], ptr inreg [[P:%.*]]) {
...
; CHECK-SAME: ptr inreg [[P:%.*]]) #[[ATTR3:[0-9]+]] {
; CHECK-NEXT:    store float 0.000000e+00, ptr [[P]], align 4
; CHECK-NEXT:    ret void
;
  store float 0.000000e+00, ptr %p
