...
; RUN: llc < %s -mtriple=amdgpu9.42 | FileCheck %s -check-prefix=GFX9
...
; GFX11-NEXT:    v_dual_cndmask_b32 v3, v6, v11 :: v_dual_add_nc_u32 v2, 0x7fff, v2
...
; GFX12-NEXT:    v_dual_cndmask_b32 v3, v6, v11 :: v_dual_add_nc_u32 v2, 0x7fff, v2
