; RUN: llc -enable-amdgpu-aa=0 -mtriple=amdgpu8.02 < %s | FileCheck %s
; RUN: llc -enable-amdgpu-aa=0 -mtriple=amdgpu8.02 -misched=gcn-iterative-minreg < %s | FileCheck %s
; RUN: llc -enable-amdgpu-aa=0 -mtriple=amdgpu8.02 -misched=gcn-iterative-max-occupancy-experimental < %s | FileCheck %s
