...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v0, v3, v0, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v4, v0
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v5, v1
; GFX940-NEXT:    s_nop 1
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    v_cmp_gt_f32_e32 vcc, 2.0, v1
...
; GFX940-NEXT:    v_cmp_gt_f32_e32 vcc, 2.0, v0
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v0, v4, v0, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v6, v0
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v0, v3, v0, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v7, v1
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v8, v2
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v0, v4, v0, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v0, v6
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v0, v3, v0, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v1, v7
; GFX940-NEXT:    s_nop 1
...
; GFX940-NEXT:    s_nop 1
; GFX940-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e32 vcc, v2, v8
; GFX940-NEXT:    s_nop 1
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    v_cmp_lt_f32_e64 vcc, |v2|, |v5|
; GFX940-NEXT:    v_mov_b32_e32 v10, 0x7fc00000
...
; GFX940-NEXT:    v_cndmask_b32_e32 v2, v9, v2, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e64 vcc, |v1|, |v4|
...
; GFX940-NEXT:    v_cndmask_b32_e32 v1, v5, v1, vcc
; GFX940-NEXT:    v_cmp_lt_f32_e64 vcc, |v0|, |v3|
...
; GFX940-NEXT:    v_cmp_eq_f32_e32 vcc, 0, v3
; GFX940-NEXT:    v_cmp_lt_f32_e64 s[0:1], v2, |v8|
; GFX940-NEXT:    s_nop 0
; GFX940-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX940-NEXT:    v_cndmask_b32_e64 v3, |v8|, v2, s[0:1]
; GFX940-NEXT:    v_cmp_o_f32_e64 vcc, v2, |v8|
; GFX940-NEXT:    v_cmp_class_f32_e64 s[0:1], |v8|, 32
; GFX940-NEXT:    s_nop 0
; GFX940-NEXT:    v_cndmask_b32_e32 v3, v10, v3, vcc
; GFX940-NEXT:    v_cmp_class_f32_e64 vcc, v2, 32
; GFX940-NEXT:    s_nop 1
...
; GFX940:       ; %bb.0:
; GFX940-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX940-NEXT:    v_cmp_gt_f32_e32 vcc, 2.0, v2
; GFX940-NEXT:    v_mov_b32_e32 v7, 0x7fc00000
; GFX940-NEXT:    s_nop 0
...
; GFX940-NEXT:    v_cmp_gt_f32_e32 vcc, 4.0, v2
; GFX940-NEXT:    s_nop 1
...
; GFX950-NEXT:    v_pk_minimum3_f16 v6, v8, v7, v6
...
; GFX950-NEXT:    v_lshrrev_b32_e32 v7, 16, v0
; GFX950-NEXT:    v_lshrrev_b32_e32 v8, 16, v4
; GFX950-NEXT:    v_pk_minimum3_f16 v6, v7, v6, v8
...
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, 2.0, v2
; GFX950-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX950-NEXT:    v_pk_minimum3_f16 v2, v4, 2.0, v2
...
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, v2, 4.0
; GFX950-NEXT:    v_pk_minimum3_f16 v2, v5, v4, 4.0
...
; GFX950-NEXT:    v_lshrrev_b32_e32 v6, 16, v2
; GFX950-NEXT:    v_lshrrev_b32_e32 v7, 16, v0
; GFX950-NEXT:    v_pk_minimum3_f16 v8, v10, v9, v8
; GFX950-NEXT:    v_lshrrev_b32_e32 v9, 16, v4
; GFX950-NEXT:    v_pk_minimum3_f16 v6, v9, v7, v6
; GFX950-NEXT:    v_pk_minimum3_f16 v1, v5, v1, v3
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v4, v0, v2
...
; GFX950-NEXT:    v_lshrrev_b32_e32 v6, 16, v2
; GFX950-NEXT:    v_lshrrev_b32_e32 v7, 16, v0
; GFX950-NEXT:    v_pk_minimum3_f16 v8, v9, v8, v10
; GFX950-NEXT:    v_lshrrev_b32_e32 v9, 16, v4
; GFX950-NEXT:    v_pk_minimum3_f16 v6, v7, v6, v9
; GFX950-NEXT:    v_pk_minimum3_f16 v1, v1, v3, v5
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, v2, v4
; GFX950-NEXT:    v_pack_b32_f16 v1, v1, v8
; GFX950-NEXT:    v_pack_b32_f16 v0, v0, v6
...
; GFX950-NEXT:    v_and_b32_e32 v2, 0x7fff, v2
; GFX950-NEXT:    v_and_b32_e32 v0, 0x7fff, v0
; GFX950-NEXT:    v_pk_minimum3_f16 v1, v1, v3, v10
...
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, v2, v5
; GFX950-NEXT:    v_and_b32_sdwa v2, s0, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_1
; GFX950-NEXT:    v_pk_minimum3_f16 v3, v9, v8, v3
; GFX950-NEXT:    v_pk_minimum3_f16 v2, v7, v6, v2
...
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, 2.0, v2
; GFX950-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX950-NEXT:    v_pk_minimum3_f16 v3, v5, 2.0, v3
; GFX950-NEXT:    v_pk_minimum3_f16 v2, v4, 2.0, v2
; GFX950-NEXT:    v_pack_b32_f16 v1, v1, v3
; GFX950-NEXT:    v_pack_b32_f16 v0, v0, v2
; GFX950-NEXT:    s_setpc_b64 s[30:31]
...
; GFX950-NEXT:    v_pk_minimum3_f16 v1, v1, v3, 4.0
; GFX950-NEXT:    v_pk_minimum3_f16 v3, v7, v6, 4.0
; GFX950-NEXT:    v_pk_minimum3_f16 v0, v0, v2, 4.0
; GFX950-NEXT:    v_pk_minimum3_f16 v2, v5, v4, 4.0
; GFX950-NEXT:    v_pack_b32_f16 v1, v1, v3
; GFX950-NEXT:    v_pack_b32_f16 v0, v0, v2
