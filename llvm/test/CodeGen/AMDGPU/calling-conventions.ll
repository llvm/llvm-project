...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1250 -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,GFX1250 %s
...
;
; GFX1250-LABEL: ps_ret_cc_f16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_add_f16_e32 v0, 1.0, v0
...
; GFX1250-NEXT:    s_add_nc_u64 s[6:7], s[6:7], coldcc@GOTPCREL+8
...
; GFX1250-NEXT:    s_get_pc_i64 s[6:7]
; GFX1250-NEXT:    s_wait_alu 0xfffe
; GFX1250-NEXT:    s_add_nc_u64 s[6:7], s[6:7], fastcc@GOTPCREL+8
; GFX1250-NEXT:    v_dual_mov_b32 v31, v0 :: v_dual_mov_b32 v0, 1.0
; GFX1250-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
; GFX1250-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 36
; GFX1250-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: ps_mesa_i16:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_add_nc_u16 v0, v0, v0
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: amdgpu_cs_v8i1:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_and_b32_e32 v6, 1, v6
; GFX1250-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX1250-NEXT:    v_lshlrev_b16 v7, 3, v7
; GFX1250-NEXT:    v_lshlrev_b16 v5, 1, v5
; GFX1250-NEXT:    v_lshlrev_b16 v3, 3, v3
; GFX1250-NEXT:    v_lshlrev_b16 v6, 2, v6
; GFX1250-NEXT:    v_lshlrev_b16 v2, 2, v2
; GFX1250-NEXT:    v_lshlrev_b16 v1, 1, v1
; GFX1250-NEXT:    v_bitop3_b16 v4, v4, v5, 1 bitop3:0xec
...
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v1, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v1, v4, v6, 3 bitop3:0xec
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v2, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v1, 4, v1
...
; GFX11-NEXT:    s_endpgm
;
; GFX1250-LABEL: amdgpu_cs_v16i1:
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    v_and_b32_e32 v6, 1, v6
; GFX1250-NEXT:    v_lshlrev_b16 v7, 3, v7
; GFX1250-NEXT:    v_and_b32_e32 v2, 1, v2
; GFX1250-NEXT:    v_lshlrev_b16 v5, 1, v5
; GFX1250-NEXT:    v_lshlrev_b16 v9, 1, v9
; GFX1250-NEXT:    v_lshlrev_b16 v6, 2, v6
; GFX1250-NEXT:    v_and_b32_e32 v8, 1, v8
; GFX1250-NEXT:    v_lshlrev_b16 v11, 3, v11
; GFX1250-NEXT:    v_lshlrev_b16 v13, 1, v13
; GFX1250-NEXT:    v_lshlrev_b16 v3, 3, v3
; GFX1250-NEXT:    v_or_b32_e32 v6, v7, v6
; GFX1250-NEXT:    v_and_b32_e32 v7, 1, v10
; GFX1250-NEXT:    v_and_b32_e32 v10, 1, v14
; GFX1250-NEXT:    v_lshlrev_b16 v14, 3, v15
; GFX1250-NEXT:    v_lshlrev_b16 v2, 2, v2
; GFX1250-NEXT:    v_lshlrev_b16 v1, 1, v1
; GFX1250-NEXT:    v_lshlrev_b16 v7, 2, v7
; GFX1250-NEXT:    v_lshlrev_b16 v10, 2, v10
; GFX1250-NEXT:    v_bitop3_b16 v4, v4, v5, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v5, v8, 3, v9 bitop3:0xc8
; GFX1250-NEXT:    v_bitop3_b16 v9, v12, v13, 1 bitop3:0xec
; GFX1250-NEXT:    v_or_b32_e32 v7, v11, v7
; GFX1250-NEXT:    v_or_b32_e32 v8, v14, v10
; GFX1250-NEXT:    v_or_b32_e32 v2, v3, v2
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v1, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v1, v4, v6, 3 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v3, v5, 15, v7 bitop3:0xc8
; GFX1250-NEXT:    v_bitop3_b16 v4, v9, v8, 3 bitop3:0xec
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v2, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v1, 4, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-NEXT:    v_lshlrev_b16 v2, 8, v3
; GFX1250-NEXT:    v_lshlrev_b16 v3, 12, v4
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v1, 15 bitop3:0xec
; GFX1250-NEXT:    v_or_b32_e32 v1, v3, v2
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX1250-NEXT:    v_and_b32_e32 v6, 1, v10
; GFX1250-NEXT:    v_lshlrev_b16 v5, 1, v9
; GFX1250-NEXT:    v_and_b32_e32 v7, 1, v8
; GFX1250-NEXT:    v_lshlrev_b16 v8, 3, v11
; GFX1250-NEXT:    v_bitop3_b16 v3, v4, v3, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v6, 2, v6
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v1, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v4, v7, 3, v5 bitop3:0xc8
; GFX1250-NEXT:    v_and_b32_e32 v1, 1, v14
; GFX1250-NEXT:    v_lshlrev_b16 v7, 3, v23
; GFX1250-NEXT:    v_or_b32_e32 v5, v8, v6
; GFX1250-NEXT:    v_lshlrev_b16 v6, 3, v15
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v2, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v1, 2, v1
; GFX1250-NEXT:    v_lshlrev_b16 v2, 1, v13
; GFX1250-NEXT:    v_bitop3_b16 v4, v4, 15, v5 bitop3:0xc8
; GFX1250-NEXT:    v_and_b32_e32 v5, 1, v22
; GFX1250-NEXT:    v_and_b32_e32 v9, 1, v26
; GFX1250-NEXT:    v_and_b32_e32 v11, 1, v30
; GFX1250-NEXT:    v_or_b32_e32 v1, v6, v1
; GFX1250-NEXT:    v_bitop3_b16 v2, v12, v2, 1 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v5, 2, v5
; GFX1250-NEXT:    v_and_b32_e32 v6, 1, v18
; GFX1250-NEXT:    v_lshlrev_b16 v10, 1, v25
; GFX1250-NEXT:    v_and_b32_e32 v12, 1, v24
; GFX1250-NEXT:    v_lshlrev_b16 v13, 3, v27
; GFX1250-NEXT:    v_or_b32_e32 v5, v7, v5
; GFX1250-NEXT:    v_lshlrev_b16 v7, 1, v21
; GFX1250-NEXT:    v_lshlrev_b16 v9, 2, v9
; GFX1250-NEXT:    v_lshlrev_b16 v14, 3, v31
; GFX1250-NEXT:    v_lshlrev_b16 v11, 2, v11
; GFX1250-NEXT:    v_lshlrev_b16 v15, 1, v29
; GFX1250-NEXT:    v_bitop3_b16 v1, v2, v1, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v2, 3, v19
; GFX1250-NEXT:    v_lshlrev_b16 v6, 2, v6
; GFX1250-NEXT:    v_lshlrev_b16 v8, 1, v17
; GFX1250-NEXT:    v_bitop3_b16 v7, v20, v7, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v10, v12, 3, v10 bitop3:0xc8
; GFX1250-NEXT:    v_or_b32_e32 v9, v13, v9
; GFX1250-NEXT:    v_or_b32_e32 v11, v14, v11
; GFX1250-NEXT:    v_bitop3_b16 v12, v28, v15, 1 bitop3:0xec
; GFX1250-NEXT:    v_or_b32_e32 v2, v2, v6
; GFX1250-NEXT:    v_bitop3_b16 v6, v16, v8, 1 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v5, v7, v5, 3 bitop3:0xec
; GFX1250-NEXT:    v_bitop3_b16 v7, v10, 15, v9 bitop3:0xc8
; GFX1250-NEXT:    v_bitop3_b16 v8, v12, v11, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v3, 4, v3
; GFX1250-NEXT:    v_lshlrev_b16 v4, 8, v4
; GFX1250-NEXT:    v_lshlrev_b16 v1, 12, v1
; GFX1250-NEXT:    v_bitop3_b16 v2, v6, v2, 3 bitop3:0xec
; GFX1250-NEXT:    v_lshlrev_b16 v5, 4, v5
; GFX1250-NEXT:    v_lshlrev_b16 v6, 8, v7
; GFX1250-NEXT:    v_lshlrev_b16 v7, 12, v8
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v3, 15 bitop3:0xec
; GFX1250-NEXT:    v_or_b32_e32 v1, v1, v4
; GFX1250-NEXT:    v_bitop3_b16 v2, v2, v5, 15 bitop3:0xec
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX1250-NEXT:    v_or_b32_e32 v3, v7, v6
; GFX1250-NEXT:    v_bitop3_b16 v0, v0, v1, 0xff bitop3:0xec
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-NEXT:    v_bitop3_b16 v1, v2, v3, 0xff bitop3:0xec
