...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_mov_b64 s[10:11], s[6:7]
; GFX1210-NEXT:    s_get_pc_i64 s[6:7]
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[6:7], s[6:7], coldcc@GOTPCREL+8
; GFX1210-NEXT:    v_dual_mov_b32 v31, v0 :: v_dual_mov_b32 v0, 1.0
; GFX1210-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
; GFX1210-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 36
; GFX1210-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX1210-NEXT:    s_wait_xcnt 0x0
; GFX1210-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX1210-NEXT:    s_mov_b32 s32, 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_swap_pc_i64 s[30:31], s[12:13]
...
; GFX1210-NEXT:    s_get_pc_i64 s[6:7]
; GFX1210-NEXT:    s_wait_alu 0xfffe
; GFX1210-NEXT:    s_add_nc_u64 s[6:7], s[6:7], fastcc@GOTPCREL+8
; GFX1210-NEXT:    v_dual_mov_b32 v31, v0 :: v_dual_mov_b32 v0, 1.0
; GFX1210-NEXT:    s_load_b64 s[12:13], s[6:7], 0x0
; GFX1210-NEXT:    s_add_nc_u64 s[8:9], s[4:5], 36
; GFX1210-NEXT:    s_mov_b64 s[4:5], s[0:1]
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b32 s0, s[4:5], 0x24
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b32 s0, s[4:5], 0x24
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_u32 s1, s0, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_lshl_b32 s1, s1, 8
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
...
; GFX1210-NEXT:    s_add_co_i32 s3, s0, s0
; GFX1210-NEXT:    s_bfe_u32 s0, s0, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xff
; GFX1210-NEXT:    s_lshl_b32 s0, s0, 8
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 8
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xff
; GFX1210-NEXT:    s_or_b32 s0, s3, s0
; GFX1210-NEXT:    s_or_b32 s1, s1, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s1, s1, 16
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    v_mov_b32_e32 v2, s0
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b32 s0, s[4:5], 0x24
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], 2
; GFX1210-NEXT:    v_mov_b64_e32 v[2:3], 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_bfe_u32 s2, s0, 0x80008
; GFX1210-NEXT:    s_lshr_b32 s1, s0, 16
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 8
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_or_b32 s0, s0, s2
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, s0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b8 v[0:1], v4, off
; GFX1210-NEXT:    global_store_b16 v[2:3], v5, off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210:       ; %bb.0: ; %entry
; GFX1210-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1210-NEXT:    v_mov_b64_e32 v[0:1], 4
; GFX1210-NEXT:    v_mov_b64_e32 v[2:3], 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_lshr_b32 s2, s0, 16
; GFX1210-NEXT:    s_lshr_b32 s3, s0, 24
; GFX1210-NEXT:    s_add_co_i32 s4, s0, s0
; GFX1210-NEXT:    s_bfe_u32 s0, s0, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s3, s3, s3
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_and_b32 s4, s4, 0xff
; GFX1210-NEXT:    s_lshl_b32 s0, s0, 8
; GFX1210-NEXT:    s_lshl_b32 s3, s3, 8
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xff
; GFX1210-NEXT:    s_or_b32 s0, s4, s0
; GFX1210-NEXT:    s_or_b32 s2, s2, s3
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 16
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_or_b32 s0, s0, s2
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v4, s1 :: v_dual_mov_b32 v5, s0
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b8 v[0:1], v4, off
; GFX1210-NEXT:    global_store_b32 v[2:3], v5, off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210-NEXT:    s_bfe_u32 s6, s0, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s7, s1, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s7, s7, s7
; GFX1210-NEXT:    s_add_co_i32 s5, s5, s5
; GFX1210-NEXT:    s_add_co_i32 s4, s4, s4
; GFX1210-NEXT:    s_add_co_i32 s6, s6, s6
; GFX1210-NEXT:    s_add_co_i32 s3, s3, s3
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xff
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_lshl_b32 s7, s7, 8
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 8
; GFX1210-NEXT:    s_and_b32 s4, s4, 0xff
; GFX1210-NEXT:    s_lshl_b32 s6, s6, 8
; GFX1210-NEXT:    s_lshl_b32 s3, s3, 8
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xff
; GFX1210-NEXT:    s_or_b32 s1, s1, s7
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
; GFX1210-NEXT:    s_or_b32 s0, s0, s6
; GFX1210-NEXT:    s_or_b32 s2, s2, s3
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s3, s4, 16
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 16
; GFX1210-NEXT:    s_or_b32 s1, s1, s3
; GFX1210-NEXT:    s_or_b32 s0, s0, s2
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v3, s1 :: v_dual_mov_b32 v2, s0
...
; GFX1210-NEXT:    v_mov_b64_e32 v[4:5], 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX1210-NEXT:    s_bfe_u32 s12, s0, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s13, s1, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s14, s2, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s15, s3, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s11, s11, s11
; GFX1210-NEXT:    s_add_co_i32 s10, s10, s10
; GFX1210-NEXT:    s_add_co_i32 s9, s9, s9
; GFX1210-NEXT:    s_add_co_i32 s8, s8, s8
; GFX1210-NEXT:    s_add_co_i32 s7, s7, s7
; GFX1210-NEXT:    s_add_co_i32 s6, s6, s6
; GFX1210-NEXT:    s_add_co_i32 s3, s3, s3
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_add_co_i32 s15, s15, s15
; GFX1210-NEXT:    s_add_co_i32 s14, s14, s14
; GFX1210-NEXT:    s_lshl_b32 s11, s11, 8
; GFX1210-NEXT:    s_and_b32 s10, s10, 0xff
; GFX1210-NEXT:    s_lshl_b32 s9, s9, 8
; GFX1210-NEXT:    s_and_b32 s8, s8, 0xff
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_add_co_i32 s13, s13, s13
; GFX1210-NEXT:    s_lshl_b32 s7, s7, 8
; GFX1210-NEXT:    s_and_b32 s6, s6, 0xff
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s12, s12, s12
; GFX1210-NEXT:    s_add_co_i32 s5, s5, s5
; GFX1210-NEXT:    s_add_co_i32 s4, s4, s4
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xff
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xff
; GFX1210-NEXT:    s_lshl_b32 s15, s15, 8
; GFX1210-NEXT:    s_or_b32 s10, s10, s11
; GFX1210-NEXT:    s_lshl_b32 s11, s14, 8
; GFX1210-NEXT:    s_or_b32 s8, s8, s9
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xff
; GFX1210-NEXT:    s_lshl_b32 s9, s13, 8
; GFX1210-NEXT:    s_or_b32 s6, s6, s7
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_lshl_b32 s7, s12, 8
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 8
; GFX1210-NEXT:    s_and_b32 s4, s4, 0xff
; GFX1210-NEXT:    s_or_b32 s3, s3, s15
; GFX1210-NEXT:    s_or_b32 s2, s2, s11
; GFX1210-NEXT:    s_or_b32 s1, s1, s9
; GFX1210-NEXT:    s_or_b32 s0, s0, s7
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s10, s10, 16
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s8, s8, 16
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s4, s4, 16
; GFX1210-NEXT:    s_lshl_b32 s5, s6, 16
; GFX1210-NEXT:    s_or_b32 s3, s3, s10
; GFX1210-NEXT:    s_or_b32 s2, s2, s8
; GFX1210-NEXT:    s_or_b32 s0, s0, s4
; GFX1210-NEXT:    s_or_b32 s1, s1, s5
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1210-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
...
; GFX1210-NEXT:    v_mov_b64_e32 v[8:9], 16
; GFX1210-NEXT:    v_mov_b64_e32 v[10:11], 0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    s_lshr_b32 s16, s0, 16
; GFX1210-NEXT:    s_lshr_b32 s17, s0, 24
; GFX1210-NEXT:    s_lshr_b32 s20, s2, 16
; GFX1210-NEXT:    s_lshr_b32 s21, s2, 24
; GFX1210-NEXT:    s_lshr_b32 s14, s7, 16
; GFX1210-NEXT:    s_lshr_b32 s15, s7, 24
; GFX1210-NEXT:    s_bfe_u32 s27, s7, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s17, s17, s17
; GFX1210-NEXT:    s_add_co_i32 s16, s16, s16
; GFX1210-NEXT:    s_lshr_b32 s18, s1, 16
; GFX1210-NEXT:    s_lshr_b32 s19, s1, 24
; GFX1210-NEXT:    s_lshr_b32 s22, s3, 16
; GFX1210-NEXT:    s_lshr_b32 s23, s3, 24
; GFX1210-NEXT:    s_bfe_u32 s29, s1, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s30, s3, 0x80008
; GFX1210-NEXT:    s_add_co_i32 s21, s21, s21
; GFX1210-NEXT:    s_add_co_i32 s20, s20, s20
; GFX1210-NEXT:    s_lshl_b32 s17, s17, 8
; GFX1210-NEXT:    s_and_b32 s16, s16, 0xff
; GFX1210-NEXT:    s_add_co_i32 s7, s7, s7
; GFX1210-NEXT:    s_add_co_i32 s27, s27, s27
; GFX1210-NEXT:    s_add_co_i32 s15, s15, s15
; GFX1210-NEXT:    s_add_co_i32 s14, s14, s14
; GFX1210-NEXT:    s_add_co_i32 s3, s3, s3
; GFX1210-NEXT:    s_add_co_i32 s30, s30, s30
; GFX1210-NEXT:    s_add_co_i32 s23, s23, s23
; GFX1210-NEXT:    s_add_co_i32 s22, s22, s22
; GFX1210-NEXT:    s_lshl_b32 s21, s21, 8
; GFX1210-NEXT:    s_and_b32 s20, s20, 0xff
; GFX1210-NEXT:    s_add_co_i32 s1, s1, s1
; GFX1210-NEXT:    s_add_co_i32 s29, s29, s29
; GFX1210-NEXT:    s_add_co_i32 s19, s19, s19
; GFX1210-NEXT:    s_add_co_i32 s18, s18, s18
...
; GFX1210-NEXT:    s_or_b32 s16, s16, s17
; GFX1210-NEXT:    s_and_b32 s7, s7, 0xff
; GFX1210-NEXT:    s_lshl_b32 s17, s27, 8
; GFX1210-NEXT:    s_lshl_b32 s15, s15, 8
; GFX1210-NEXT:    s_and_b32 s14, s14, 0xff
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xff
; GFX1210-NEXT:    s_lshl_b32 s30, s30, 8
; GFX1210-NEXT:    s_lshl_b32 s23, s23, 8
; GFX1210-NEXT:    s_and_b32 s22, s22, 0xff
; GFX1210-NEXT:    s_or_b32 s20, s20, s21
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xff
; GFX1210-NEXT:    s_lshl_b32 s21, s29, 8
; GFX1210-NEXT:    s_lshl_b32 s19, s19, 8
; GFX1210-NEXT:    s_and_b32 s18, s18, 0xff
; GFX1210-NEXT:    s_lshr_b32 s8, s4, 16
; GFX1210-NEXT:    s_lshr_b32 s9, s4, 24
; GFX1210-NEXT:    s_bfe_u32 s24, s4, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s25, s5, 0x80008
; GFX1210-NEXT:    s_bfe_u32 s26, s6, 0x80008
; GFX1210-NEXT:    s_or_b32 s7, s7, s17
; GFX1210-NEXT:    s_or_b32 s14, s14, s15
; GFX1210-NEXT:    s_add_co_i32 s13, s13, s13
; GFX1210-NEXT:    s_add_co_i32 s12, s12, s12
; GFX1210-NEXT:    s_add_co_i32 s11, s11, s11
; GFX1210-NEXT:    s_add_co_i32 s10, s10, s10
; GFX1210-NEXT:    s_bfe_u32 s28, s0, 0x80008
; GFX1210-NEXT:    s_or_b32 s3, s3, s30
; GFX1210-NEXT:    s_or_b32 s22, s22, s23
; GFX1210-NEXT:    s_bfe_u32 s23, s2, 0x80008
; GFX1210-NEXT:    s_or_b32 s1, s1, s21
; GFX1210-NEXT:    s_or_b32 s18, s18, s19
; GFX1210-NEXT:    s_and_b32 s7, s7, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s14, s14, 16
; GFX1210-NEXT:    s_add_co_i32 s6, s6, s6
; GFX1210-NEXT:    s_add_co_i32 s26, s26, s26
; GFX1210-NEXT:    s_lshl_b32 s13, s13, 8
; GFX1210-NEXT:    s_and_b32 s12, s12, 0xff
; GFX1210-NEXT:    s_add_co_i32 s5, s5, s5
; GFX1210-NEXT:    s_add_co_i32 s25, s25, s25
; GFX1210-NEXT:    s_lshl_b32 s11, s11, 8
; GFX1210-NEXT:    s_and_b32 s10, s10, 0xff
; GFX1210-NEXT:    s_add_co_i32 s4, s4, s4
; GFX1210-NEXT:    s_add_co_i32 s24, s24, s24
; GFX1210-NEXT:    s_add_co_i32 s9, s9, s9
; GFX1210-NEXT:    s_add_co_i32 s8, s8, s8
; GFX1210-NEXT:    s_and_b32 s3, s3, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s22, s22, 16
; GFX1210-NEXT:    s_add_co_i32 s2, s2, s2
; GFX1210-NEXT:    s_add_co_i32 s23, s23, s23
; GFX1210-NEXT:    s_and_b32 s1, s1, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s18, s18, 16
; GFX1210-NEXT:    s_add_co_i32 s0, s0, s0
; GFX1210-NEXT:    s_add_co_i32 s28, s28, s28
; GFX1210-NEXT:    s_or_b32 s7, s7, s14
; GFX1210-NEXT:    s_and_b32 s6, s6, 0xff
; GFX1210-NEXT:    s_lshl_b32 s14, s26, 8
; GFX1210-NEXT:    s_or_b32 s12, s12, s13
; GFX1210-NEXT:    s_and_b32 s5, s5, 0xff
; GFX1210-NEXT:    s_lshl_b32 s13, s25, 8
; GFX1210-NEXT:    s_or_b32 s10, s10, s11
; GFX1210-NEXT:    s_and_b32 s4, s4, 0xff
; GFX1210-NEXT:    s_lshl_b32 s11, s24, 8
; GFX1210-NEXT:    s_lshl_b32 s9, s9, 8
; GFX1210-NEXT:    s_and_b32 s8, s8, 0xff
; GFX1210-NEXT:    s_or_b32 s3, s3, s22
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xff
; GFX1210-NEXT:    s_lshl_b32 s22, s23, 8
; GFX1210-NEXT:    s_or_b32 s1, s1, s18
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_lshl_b32 s18, s28, 8
; GFX1210-NEXT:    s_or_b32 s6, s6, s14
; GFX1210-NEXT:    s_or_b32 s5, s5, s13
; GFX1210-NEXT:    s_or_b32 s4, s4, s11
; GFX1210-NEXT:    s_or_b32 s8, s8, s9
; GFX1210-NEXT:    s_or_b32 s2, s2, s22
; GFX1210-NEXT:    s_or_b32 s0, s0, s18
; GFX1210-NEXT:    s_and_b32 s6, s6, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s12, s12, 16
; GFX1210-NEXT:    s_and_b32 s5, s5, 0xffff
; GFX1210-NEXT:    s_and_b32 s4, s4, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s8, s8, 16
; GFX1210-NEXT:    s_lshl_b32 s9, s10, 16
; GFX1210-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s20, s20, 16
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s16, s16, 16
; GFX1210-NEXT:    s_or_b32 s6, s6, s12
; GFX1210-NEXT:    s_or_b32 s4, s4, s8
; GFX1210-NEXT:    s_or_b32 s5, s5, s9
; GFX1210-NEXT:    s_or_b32 s2, s2, s20
; GFX1210-NEXT:    s_or_b32 s0, s0, s16
...
; GFX1210-NEXT:    s_clause 0x1
; GFX1210-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GFX1210-NEXT:    global_store_b128 v[10:11], v[4:7], off
; GFX1210-NEXT:    s_endpgm
entry:
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_b32 s6, s6, 1
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 1
; GFX1210-NEXT:    s_and_b32 s4, s4, 1
; GFX1210-NEXT:    s_and_b32 s2, s2, 1
; GFX1210-NEXT:    s_lshl_b32 s1, s1, 1
; GFX1210-NEXT:    s_and_b32 s0, s0, 1
; GFX1210-NEXT:    s_lshl_b32 s7, s7, 3
; GFX1210-NEXT:    s_lshl_b32 s6, s6, 2
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
; GFX1210-NEXT:    s_lshl_b32 s3, s3, 3
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 2
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_or_b32 s5, s7, s6
; GFX1210-NEXT:    s_and_b32 s4, s4, 3
; GFX1210-NEXT:    s_or_b32 s1, s3, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 3
; GFX1210-NEXT:    s_or_b32 s2, s4, s5
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_lshl_b32 s1, s2, 4
; GFX1210-NEXT:    s_and_b32 s0, s0, 15
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    v_mov_b32_e32 v0, s0
; GFX1210-NEXT:    global_store_b8 v[0:1], v0, off
...
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_and_b32 s10, s10, 1
; GFX1210-NEXT:    s_lshl_b32 s9, s9, 1
; GFX1210-NEXT:    s_and_b32 s8, s8, 1
; GFX1210-NEXT:    s_and_b32 s6, s6, 1
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 1
; GFX1210-NEXT:    s_and_b32 s4, s4, 1
; GFX1210-NEXT:    s_and_b32 s2, s2, 1
; GFX1210-NEXT:    s_lshl_b32 s1, s1, 1
; GFX1210-NEXT:    s_and_b32 s0, s0, 1
; GFX1210-NEXT:    s_and_b32 s14, s14, 1
; GFX1210-NEXT:    s_lshl_b32 s13, s13, 1
; GFX1210-NEXT:    s_and_b32 s12, s12, 1
; GFX1210-NEXT:    s_lshl_b32 s11, s11, 3
; GFX1210-NEXT:    s_lshl_b32 s10, s10, 2
; GFX1210-NEXT:    s_or_b32 s8, s8, s9
; GFX1210-NEXT:    s_lshl_b32 s7, s7, 3
; GFX1210-NEXT:    s_lshl_b32 s6, s6, 2
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
...
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 2
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_lshl_b32 s15, s15, 3
; GFX1210-NEXT:    s_lshl_b32 s14, s14, 2
; GFX1210-NEXT:    s_or_b32 s12, s12, s13
; GFX1210-NEXT:    s_or_b32 s9, s11, s10
; GFX1210-NEXT:    s_and_b32 s8, s8, 3
; GFX1210-NEXT:    s_or_b32 s5, s7, s6
; GFX1210-NEXT:    s_and_b32 s4, s4, 3
; GFX1210-NEXT:    s_or_b32 s1, s3, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 3
; GFX1210-NEXT:    s_or_b32 s13, s15, s14
; GFX1210-NEXT:    s_and_b32 s12, s12, 3
; GFX1210-NEXT:    s_or_b32 s8, s8, s9
; GFX1210-NEXT:    s_or_b32 s2, s4, s5
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_or_b32 s10, s12, s13
; GFX1210-NEXT:    s_and_b32 s8, s8, 15
; GFX1210-NEXT:    s_lshl_b32 s1, s2, 4
; GFX1210-NEXT:    s_and_b32 s0, s0, 15
; GFX1210-NEXT:    s_lshl_b32 s9, s10, 12
; GFX1210-NEXT:    s_lshl_b32 s2, s8, 8
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_or_b32 s1, s9, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX1210-NEXT:    s_and_b32 s0, s0, 15
; GFX1210-NEXT:    s_lshl_b32 s2, s8, 8
; GFX1210-NEXT:    s_and_b32 s3, s30, 1
; GFX1210-NEXT:    s_lshl_b32 s4, s29, 1
; GFX1210-NEXT:    s_and_b32 s5, s28, 1
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_or_b32 s1, s9, s2
; GFX1210-NEXT:    s_lshl_b32 s2, s31, 3
; GFX1210-NEXT:    s_lshl_b32 s3, s3, 2
; GFX1210-NEXT:    s_or_b32 s4, s5, s4
; GFX1210-NEXT:    s_and_b32 s5, s26, 1
; GFX1210-NEXT:    s_lshl_b32 s6, s25, 1
; GFX1210-NEXT:    s_and_b32 s7, s24, 1
; GFX1210-NEXT:    s_or_b32 s2, s2, s3
; GFX1210-NEXT:    s_and_b32 s3, s4, 3
; GFX1210-NEXT:    s_lshl_b32 s4, s27, 3
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 2
; GFX1210-NEXT:    s_or_b32 s6, s7, s6
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
; GFX1210-NEXT:    s_and_b32 s5, s6, 3
; GFX1210-NEXT:    s_or_b32 s2, s3, s2
; GFX1210-NEXT:    s_or_b32 s3, s5, s4
; GFX1210-NEXT:    s_and_b32 s5, s22, 1
; GFX1210-NEXT:    s_lshl_b32 s6, s21, 1
; GFX1210-NEXT:    s_and_b32 s7, s20, 1
; GFX1210-NEXT:    s_lshl_b32 s4, s23, 3
; GFX1210-NEXT:    s_lshl_b32 s5, s5, 2
; GFX1210-NEXT:    s_or_b32 s6, s7, s6
; GFX1210-NEXT:    s_and_b32 s7, s18, 1
; GFX1210-NEXT:    s_lshl_b32 s8, s17, 1
; GFX1210-NEXT:    s_and_b32 s9, s16, 1
; GFX1210-NEXT:    s_or_b32 s4, s4, s5
; GFX1210-NEXT:    s_and_b32 s5, s6, 3
; GFX1210-NEXT:    s_lshl_b32 s6, s19, 3
; GFX1210-NEXT:    s_lshl_b32 s7, s7, 2
; GFX1210-NEXT:    s_or_b32 s8, s9, s8
; GFX1210-NEXT:    s_or_b32 s6, s6, s7
; GFX1210-NEXT:    s_and_b32 s7, s8, 3
; GFX1210-NEXT:    s_or_b32 s4, s5, s4
; GFX1210-NEXT:    s_or_b32 s5, s7, s6
; GFX1210-NEXT:    s_and_b32 s3, s3, 15
; GFX1210-NEXT:    s_lshl_b32 s4, s4, 4
; GFX1210-NEXT:    s_and_b32 s5, s5, 15
; GFX1210-NEXT:    s_lshl_b32 s2, s2, 12
; GFX1210-NEXT:    s_lshl_b32 s3, s3, 8
; GFX1210-NEXT:    s_or_b32 s4, s5, s4
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xff
; GFX1210-NEXT:    s_or_b32 s2, s2, s3
; GFX1210-NEXT:    s_and_b32 s3, s4, 0xff
; GFX1210-NEXT:    s_or_b32 s0, s0, s1
; GFX1210-NEXT:    s_or_b32 s1, s3, s2
; GFX1210-NEXT:    s_and_b32 s0, s0, 0xffff
; GFX1210-NEXT:    s_lshl_b32 s1, s1, 16
