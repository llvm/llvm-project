...
; GFX1250-NEXT:    s_add_co_i32 s0, s0, 1
; GFX1250-NEXT:    v_dual_mov_b32 v4, s4 :: v_dual_mov_b32 v1, s1
; GFX1250-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v3, s3
; GFX1250-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v7.l, v5.l
...
; GFX1250-TRUE16-NEXT:    v_or_b16 v5.l, v6.l, v5.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v4, v4, v7, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v3, v4, v5, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v1.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v1.l, v1.h, v2.l
...
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v3, v0, v4, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 4, v2.l
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v1, v3, v1, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v0, v1, v0, 15 bitop3:0xec
...
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v5.l, 1, v5.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 3, v7.l
; GFX1250-TRUE16-NEXT:    v_and_b16 v1.h, v10.l, 1
; GFX1250-TRUE16-NEXT:    v_and_b16 v2.l, v2.l, 1
...
; GFX1250-TRUE16-NEXT:    v_or_b16 v5.l, v3.h, v2.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v16, v4, v6, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v4.l, 1, v9.l
; GFX1250-TRUE16-NEXT:    v_and_b16 v6.l, v8.l, 1
; GFX1250-TRUE16-NEXT:    v_and_b16 v2.h, v14.l, 1
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 3, v11.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v4.h, 3, v15.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v4.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v6.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.h, 2, v2.h
; GFX1250-TRUE16-NEXT:    v_or_b16 v4.l, v3.h, v1.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v7, v12, v7, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v1.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v8, v8, 3, v9 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_or_b16 v6.l, v4.h, v2.h
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 2, v2.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v2, v16, v5, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v4, v8, 15, v4 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v5, v7, v6, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v1.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v1.l, v3.l, v1.h
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v4.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v5.l
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v5, v0, v6, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v1.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 4, v2.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v0.h, 8, v3.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 12, v4.l
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v2, v5, v6, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v0.l
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-TRUE16-NEXT:    v_or_b16 v0.l, v1.l, v0.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v1, v2, v3, 15 bitop3:0xec
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v0, v1, v0, 0xff bitop3:0xec
; GFX1250-TRUE16-NEXT:    flat_store_b16 v[0:1], v0
; GFX1250-TRUE16-NEXT:    s_endpgm
;
...
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v5.l, 1, v5.l
; GFX1250-TRUE16-NEXT:    v_and_b16 v3.h, v10.l, 1
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v6.l, 1, v13.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 2, v2.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 3, v7.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.l, 2, v3.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v7, v4, v5, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_and_b16 v4.l, v8.l, 1
; GFX1250-TRUE16-NEXT:    v_and_b16 v4.h, v14.l, 1
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v5.l, 3, v11.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v2.l, v2.l, v3.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.l, 1, v9.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 2, v3.h
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v5.h, 3, v15.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v4.h, 2, v4.h
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v4.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v3.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 1, v1.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v3.l, v5.l, v3.h
; GFX1250-TRUE16-NEXT:    v_or_b16 v4.l, v5.h, v4.h
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v2.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v8, v8, 3, v9 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v6, v12, v6, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v1.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v1.l, v2.h, v1.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v2, v7, v5, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v3, v8, 15, v3 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v4, v6, v4, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v5, v0, v9, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v1.l
...
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v7, v5, v6, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v0.h, 8, v1.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.l, 12, v2.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 1, v21.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 2, v1.h
; GFX1250-TRUE16-NEXT:    v_and_b16 v3.l, v18.l, 1
; GFX1250-TRUE16-NEXT:    v_and_b16 v5.l, v24.l, 1
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v5.h, 3, v31.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v4.l, v2.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v2.l, v3.h, v1.h
; GFX1250-TRUE16-NEXT:    v_and_b16 v1.h, v26.l, 1
; GFX1250-TRUE16-NEXT:    v_and_b16 v3.h, v30.l, 1
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v6.l, 1, v29.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v8, v20, v4, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v4.l, 1, v25.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v4.h, 3, v27.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 2, v1.h
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v3.h, 2, v3.h
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.h, 3, v19.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v9.l, v5.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v4.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v4.l, v4.h, v1.h
; GFX1250-TRUE16-NEXT:    v_or_b16 v5.l, v5.h, v3.h
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v11.l, v2.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v6, v28, v6, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 1, v17.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 2, v3.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v9, v9, 3, v10 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v3, v8, v11, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v5, v6, v5, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v6.l, v2.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v2.l, v2.h, v1.h
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v0.l, 4, v0.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v4, v9, 15, v4 bitop3:0xc8
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.h, 12, v5.l
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v6, v16, v6, 1 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v8.l, v2.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v2.l, 4, v3.l
; GFX1250-TRUE16-NEXT:    v_lshlrev_b16 v1.h, 8, v4.l
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v3.l, v0.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v0.l, v1.l, v0.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v4, v6, v8, 3 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_mov_b16_e32 v5.l, v2.l
; GFX1250-TRUE16-NEXT:    v_or_b16 v1.l, v2.h, v1.h
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v2, v7, v3, 15 bitop3:0xec
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v3, v4, v5, 15 bitop3:0xec
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v0, v2, v0, 0xff bitop3:0xec
; GFX1250-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1250-TRUE16-NEXT:    v_bitop3_b16 v1, v3, v1, 0xff bitop3:0xec
