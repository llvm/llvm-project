...
; G_GFX9-NEXT:    s_cbranch_execnz .LBB1_2
; G_GFX9-NEXT:  ; %bb.1:
; G_GFX9-NEXT:    v_mov_b32_e32 v0, 0
; G_GFX9-NEXT:    v_mov_b32_e32 v2, 0
; G_GFX9-NEXT:    v_mov_b32_e32 v1, 0
; G_GFX9-NEXT:    ds_write_b32 v0, v2 offset:8
; G_GFX9-NEXT:    ds_write_b64 v0, v[0:1]
