...
; RUN: opt -S -mtriple=amdgpu-- -lowerswitch -structurizecfg -si-annotate-control-flow < %s | FileCheck -check-prefix=OPT %s
...
; GCN-NEXT:    ; implicit-def: $sgpr2_3
; GCN-NEXT:    ; implicit-def: $sgpr8_9
; GCN-NEXT:    ; implicit-def: $sgpr6_7
