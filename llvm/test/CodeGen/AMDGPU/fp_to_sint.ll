...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_cvt_i32_f32_e32 v3, s7
; GFX11-NEXT:    v_cvt_i32_f32_e32 v2, s6
; GFX11-NEXT:    v_cvt_i32_f32_e32 v1, s5
; GFX11-NEXT:    v_cvt_i32_f32_e32 v0, s4
...
; GFX11-NEXT:    v_fma_f32 v5, 0xcf800000, v3, |v1|
...
; GFX11-NEXT:    v_xor_b32_e32 v7, v2, v0
; GFX11-NEXT:    v_xor_b32_e32 v4, v4, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_xor_b32_e32 v5, v5, v1
; GFX11-NEXT:    v_xor_b32_e32 v8, v3, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_sub_co_u32 v2, vcc_lo, v4, v0
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v3, null, v7, v0, vcc_lo
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_sub_co_u32 v0, vcc_lo, v5, v1
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v1, null, v8, v1, vcc_lo
...
; GFX11-NEXT:    v_trunc_f32_e32 v2, s3
; GFX11-NEXT:    v_trunc_f32_e32 v3, s2
; GFX11-NEXT:    v_trunc_f32_e32 v1, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_mul_f32_e64 v4, 0x2f800000, |v0|
; GFX11-NEXT:    v_mul_f32_e64 v7, 0x2f800000, |v2|
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_mul_f32_e64 v11, 0x2f800000, |v3|
...
; GFX11-NEXT:    v_floor_f32_e32 v11, v11
; GFX11-NEXT:    v_floor_f32_e32 v6, v6
; GFX11-NEXT:    v_ashrrev_i32_e32 v10, 31, v2
; GFX11-NEXT:    v_fma_f32 v0, 0xcf800000, v4, |v0|
; GFX11-NEXT:    v_fma_f32 v2, 0xcf800000, v7, |v2|
; GFX11-NEXT:    v_ashrrev_i32_e32 v12, 31, v3
; GFX11-NEXT:    v_fma_f32 v3, 0xcf800000, v11, |v3|
; GFX11-NEXT:    v_ashrrev_i32_e32 v9, 31, v1
; GFX11-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX11-NEXT:    v_fma_f32 v1, 0xcf800000, v6, |v1|
; GFX11-NEXT:    v_cvt_u32_f32_e32 v13, v4
; GFX11-NEXT:    v_cvt_u32_f32_e32 v4, v6
; GFX11-NEXT:    v_cvt_u32_f32_e32 v6, v7
; GFX11-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX11-NEXT:    v_cvt_u32_f32_e32 v3, v3
; GFX11-NEXT:    v_xor_b32_e32 v0, v0, v5
; GFX11-NEXT:    v_cvt_u32_f32_e32 v7, v11
; GFX11-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX11-NEXT:    v_xor_b32_e32 v11, v13, v5
; GFX11-NEXT:    v_xor_b32_e32 v13, v4, v9
; GFX11-NEXT:    v_xor_b32_e32 v4, v6, v10
; GFX11-NEXT:    v_xor_b32_e32 v6, v2, v10
; GFX11-NEXT:    v_xor_b32_e32 v15, v3, v12
; GFX11-NEXT:    v_sub_co_u32 v2, vcc_lo, v0, v5
; GFX11-NEXT:    v_xor_b32_e32 v14, v7, v12
; GFX11-NEXT:    v_xor_b32_e32 v1, v1, v9
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v3, null, v11, v5, vcc_lo
; GFX11-NEXT:    v_sub_co_u32 v6, vcc_lo, v6, v10
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v7, null, v4, v10, vcc_lo
; GFX11-NEXT:    v_sub_co_u32 v4, vcc_lo, v15, v12
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v5, null, v14, v12, vcc_lo
; GFX11-NEXT:    v_sub_co_u32 v0, vcc_lo, v1, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_sub_co_ci_u32_e64 v1, null, v13, v9, vcc_lo
; GFX11-NEXT:    s_clause 0x1
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_sint_v2f32_to_v2i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; VI-NEXT:    s_endpgm
;
; GFX11-LABEL: fp_to_sint_f32_to_v2i16:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
