...
; GFX11-GISEL-NEXT:    s_ashr_i32 s4, s2, 31
...
; GFX11-GISEL-NEXT:    s_xor_b64 s[6:7], s[6:7], s[4:5]
; GFX11-GISEL-NEXT:    v_readfirstlane_b32 s8, v0
; GFX11-GISEL-NEXT:    s_sub_u32 s6, s6, s4
; GFX11-GISEL-NEXT:    s_subb_u32 s7, s7, s4
...
; GFX11-GISEL-NEXT:    s_xor_b64 s[4:5], s[8:9], s[2:3]
; GFX11-GISEL-NEXT:    s_sub_u32 s3, s4, s2
; GFX11-GISEL-NEXT:    s_subb_u32 s2, s5, s2
; GFX11-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s3 :: v_dual_mov_b32 v3, s2
; GFX11-GISEL-NEXT:    global_store_b128 v4, v[0:3], s[0:1]
; GFX11-GISEL-NEXT:    s_endpgm
;
...
; GFX11-GISEL-NEXT:    s_sub_u32 s12, s8, s6
; GFX11-GISEL-NEXT:    s_subb_u32 s13, s9, s6
...
; GFX11-GISEL-NEXT:    s_xor_b64 s[8:9], s[10:11], s[0:1]
; GFX11-GISEL-NEXT:    v_cvt_u32_f32_e32 v0, v4
; GFX11-GISEL-NEXT:    s_sub_u32 s10, s8, s0
; GFX11-GISEL-NEXT:    s_subb_u32 s11, s9, s0
; GFX11-GISEL-NEXT:    s_ashr_i32 s0, s2, 31
; GFX11-GISEL-NEXT:    v_readfirstlane_b32 s9, v1
; GFX11-GISEL-NEXT:    s_mov_b32 s1, s0
; GFX11-GISEL-NEXT:    v_readfirstlane_b32 s8, v0
; GFX11-GISEL-NEXT:    s_xor_b64 s[6:7], s[6:7], s[0:1]
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v0, s12 :: v_dual_mov_b32 v1, s13
; GFX11-GISEL-NEXT:    s_sub_u32 s6, s6, s0
; GFX11-GISEL-NEXT:    s_subb_u32 s7, s7, s0
; GFX11-GISEL-NEXT:    s_ashr_i32 s0, s3, 31
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v2, s10 :: v_dual_mov_b32 v3, s11
; GFX11-GISEL-NEXT:    s_mov_b32 s1, s0
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v5, s7
; GFX11-GISEL-NEXT:    s_xor_b64 s[2:3], s[8:9], s[0:1]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
; GFX11-GISEL-NEXT:    s_sub_u32 s1, s2, s0
; GFX11-GISEL-NEXT:    s_subb_u32 s0, s3, s0
; GFX11-GISEL-NEXT:    v_dual_mov_b32 v4, s6 :: v_dual_mov_b32 v7, s0
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v6, s1
; GFX11-GISEL-NEXT:    s_clause 0x1
