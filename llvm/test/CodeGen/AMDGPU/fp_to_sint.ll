...
; SI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s3, 0x2f800000
; SI-NEXT:    s_mov_b32 s7, 0xf000
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    v_trunc_f32_e32 v0, s2
; SI-NEXT:    v_mul_f32_e64 v1, |v0|, s3
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    v_floor_f32_e32 v1, v1
; SI-NEXT:    s_mov_b32 s0, 0xcf800000
; SI-NEXT:    v_fma_f32 v2, v1, s0, |v0|
...
; VI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s3, 0x2f800000
; VI-NEXT:    s_mov_b32 s7, 0xf000
; VI-NEXT:    s_mov_b32 s6, -1
; VI-NEXT:    v_trunc_f32_e32 v0, s2
; VI-NEXT:    v_mul_f32_e64 v1, |v0|, s3
; VI-NEXT:    s_mov_b32 s4, s0
...
; SI-NEXT:    v_mul_f32_e64 v1, |v0|, s8
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    v_floor_f32_e32 v1, v1
; SI-NEXT:    s_mov_b32 s0, 0xcf800000
; SI-NEXT:    v_fma_f32 v2, v1, s0, |v0|
