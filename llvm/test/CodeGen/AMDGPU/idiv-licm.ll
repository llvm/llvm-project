...
; RUN: llc -mtriple=amdgpu9.00 < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -enable-var-scope -check-prefix=GFX10 %s
; RUN: llc -mtriple=amdgpu11.00 < %s | FileCheck -enable-var-scope -check-prefix=GFX11 %s
...
; GFX9-NEXT:    s_mul_hi_u32 s6, s4, s3
...
; GFX9-NEXT:    s_lshl_b64 s[6:7], s[4:5], 2
; GFX9-NEXT:    s_add_u32 s6, s0, s6
; GFX9-NEXT:    s_addc_u32 s7, s1, s7
...
; GFX10-NEXT:    s_mul_hi_u32 s6, s4, s3
...
; GFX10-NEXT:    s_add_u32 s6, s0, s6
; GFX10-NEXT:    s_addc_u32 s7, s1, s7
...
; GFX11-NEXT:    s_mul_hi_u32 s6, s4, s3
...
; GFX11-NEXT:    s_add_i32 s8, s6, 1
; GFX11-NEXT:    s_cmp_ge_u32 s7, s2
; GFX11-NEXT:    s_cselect_b32 s8, s8, s6
; GFX11-NEXT:    s_lshl_b64 s[6:7], s[4:5], 2
...
; GFX11-NEXT:    global_store_b32 v0, v1, s[6:7]
...
; GFX9-NEXT:    s_sub_i32 s7, s6, s2
; GFX9-NEXT:    s_cmp_ge_u32 s6, s2
; GFX9-NEXT:    s_cselect_b32 s8, s7, s6
; GFX9-NEXT:    s_lshl_b64 s[6:7], s[4:5], 2
; GFX9-NEXT:    s_add_u32 s6, s0, s6
; GFX9-NEXT:    s_addc_u32 s7, s1, s7
; GFX9-NEXT:    s_add_i32 s4, s4, 1
...
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_mul_hi_u32 s6, s4, s3
; GFX10-NEXT:    s_mul_i32 s6, s6, s2
; GFX10-NEXT:    s_sub_i32 s6, s4, s6
; GFX10-NEXT:    s_sub_i32 s7, s6, s2
; GFX10-NEXT:    s_cmp_ge_u32 s6, s2
; GFX10-NEXT:    s_cselect_b32 s6, s7, s6
; GFX10-NEXT:    s_sub_i32 s7, s6, s2
; GFX10-NEXT:    s_cmp_ge_u32 s6, s2
; GFX10-NEXT:    s_cselect_b32 s8, s7, s6
; GFX10-NEXT:    s_lshl_b64 s[6:7], s[4:5], 2
; GFX10-NEXT:    v_mov_b32_e32 v1, s8
; GFX10-NEXT:    s_add_u32 s6, s0, s6
; GFX10-NEXT:    s_addc_u32 s7, s1, s7
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_hi_u32 s6, s4, s3
; GFX11-NEXT:    s_mul_i32 s6, s6, s2
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s6, s4, s6
; GFX11-NEXT:    s_sub_i32 s7, s6, s2
; GFX11-NEXT:    s_cmp_ge_u32 s6, s2
; GFX11-NEXT:    s_cselect_b32 s6, s7, s6
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s7, s6, s2
; GFX11-NEXT:    s_cmp_ge_u32 s6, s2
; GFX11-NEXT:    s_cselect_b32 s8, s7, s6
; GFX11-NEXT:    s_lshl_b64 s[6:7], s[4:5], 2
; GFX11-NEXT:    v_mov_b32_e32 v1, s8
; GFX11-NEXT:    s_add_u32 s6, s0, s6
; GFX11-NEXT:    s_addc_u32 s7, s1, s7
