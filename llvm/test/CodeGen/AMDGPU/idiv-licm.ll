...
; GFX10-NEXT:    s_mul_hi_u32 s6, s3, s2
; GFX10-NEXT:    s_mov_b32 s2, 0
; GFX10-NEXT:    s_add_i32 s3, s3, s6
; GFX10-NEXT:  .LBB2_1: ; %bb3
; GFX10-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    s_mul_hi_u32 s6, s2, s3
; GFX10-NEXT:    s_mul_i32 s7, s6, s5
; GFX10-NEXT:    s_add_i32 s8, s6, 1
; GFX10-NEXT:    s_sub_i32 s7, s2, s7
; GFX10-NEXT:    s_sub_i32 s9, s7, s5
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_hi_u32 s6, s3, s2
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_hi_u32 s6, s2, s3
; GFX11-NEXT:    s_mul_i32 s7, s6, s5
; GFX11-NEXT:    s_add_i32 s8, s6, 1
; GFX11-NEXT:    s_sub_i32 s7, s2, s7
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s9, s7, s5
; GFX11-NEXT:    s_cmp_ge_u32 s7, s5
...
; GFX10-NEXT:    global_store_short v3, v4, s[4:5]
...
; GFX10-NEXT:    global_store_short v5, v3, s[0:1]
