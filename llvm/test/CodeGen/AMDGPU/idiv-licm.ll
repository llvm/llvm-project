...
; GFX9-NEXT:    s_not_b32 s9, s7
; GFX9-NEXT:    s_mul_i32 s8, s2, s7
; GFX9-NEXT:    s_mul_i32 s9, s2, s9
; GFX9-NEXT:    s_add_i32 s10, s7, 1
; GFX9-NEXT:    s_sub_i32 s8, s1, s8
; GFX9-NEXT:    s_add_i32 s9, s1, s9
; GFX9-NEXT:    s_cmp_ge_u32 s8, s2
; GFX9-NEXT:    s_cselect_b32 s10, s10, s7
; GFX9-NEXT:    s_cselect_b32 s8, s9, s8
; GFX9-NEXT:    s_add_i32 s9, s10, 1
; GFX9-NEXT:    s_cmp_ge_u32 s8, s2
; GFX9-NEXT:    s_cselect_b32 s10, s9, s10
; GFX9-NEXT:    s_add_u32 s8, s0, s4
; GFX9-NEXT:    s_addc_u32 s9, 0, s5
; GFX9-NEXT:    s_add_i32 s1, s1, 1
; GFX9-NEXT:    s_add_u32 s6, s6, s3
...
; GFX10-NEXT:    s_mul_i32 s4, s4, s3
; GFX10-NEXT:    s_mul_hi_u32 s6, s3, s4
...
; GFX10-NEXT:    s_mul_i32 s8, s2, s7
; GFX10-NEXT:    s_mul_i32 s9, s2, s9
; GFX10-NEXT:    s_sub_i32 s8, s1, s8
; GFX10-NEXT:    s_add_i32 s10, s7, 1
; GFX10-NEXT:    s_add_i32 s9, s1, s9
; GFX10-NEXT:    s_cmp_ge_u32 s8, s2
; GFX10-NEXT:    s_cselect_b32 s10, s10, s7
; GFX10-NEXT:    s_cselect_b32 s8, s9, s8
; GFX10-NEXT:    s_add_i32 s9, s10, 1
; GFX10-NEXT:    s_cmp_ge_u32 s8, s2
; GFX10-NEXT:    s_cselect_b32 s10, s9, s10
; GFX10-NEXT:    s_add_u32 s8, s0, s4
; GFX10-NEXT:    s_addc_u32 s9, 0, s5
; GFX10-NEXT:    s_add_i32 s1, s1, 1
; GFX10-NEXT:    s_add_u32 s6, s6, s3
...
; GFX11-NEXT:    s_mul_i32 s4, s4, s3
; GFX11-NEXT:    s_mul_hi_u32 s6, s3, s4
; GFX11-NEXT:    s_mov_b64 s[4:5], 0
; GFX11-NEXT:    s_add_i32 s3, s3, s6
...
; GFX11-NEXT:    s_mul_i32 s8, s2, s7
; GFX11-NEXT:    s_mul_i32 s9, s2, s9
; GFX11-NEXT:    s_sub_i32 s8, s1, s8
; GFX11-NEXT:    s_add_i32 s10, s7, 1
; GFX11-NEXT:    s_add_i32 s9, s1, s9
; GFX11-NEXT:    s_cmp_ge_u32 s8, s2
; GFX11-NEXT:    s_cselect_b32 s10, s10, s7
; GFX11-NEXT:    s_cselect_b32 s8, s9, s8
; GFX11-NEXT:    s_add_i32 s9, s10, 1
; GFX11-NEXT:    s_cmp_ge_u32 s8, s2
; GFX11-NEXT:    s_cselect_b32 s10, s9, s10
; GFX11-NEXT:    s_add_u32 s8, s0, s4
; GFX11-NEXT:    s_addc_u32 s9, 0, s5
; GFX11-NEXT:    s_add_i32 s1, s1, 1
; GFX11-NEXT:    s_add_u32 s6, s6, s3
...
; GFX9-NEXT:    s_cmp_ge_u32 s8, s2
; GFX9-NEXT:    s_cselect_b32 s8, s9, s8
; GFX9-NEXT:    s_sub_i32 s9, s8, s2
; GFX9-NEXT:    s_cmp_ge_u32 s8, s2
; GFX9-NEXT:    s_cselect_b32 s10, s9, s8
; GFX9-NEXT:    s_add_u32 s8, s0, s4
; GFX9-NEXT:    s_addc_u32 s9, 0, s5
; GFX9-NEXT:    s_add_i32 s1, s1, 1
; GFX9-NEXT:    s_add_u32 s6, s6, s3
...
; GFX10-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_not_b32 s8, s7
; GFX10-NEXT:    s_mul_i32 s9, s2, s7
; GFX10-NEXT:    s_mul_i32 s8, s2, s8
; GFX10-NEXT:    s_sub_i32 s9, s1, s9
; GFX10-NEXT:    s_add_i32 s8, s1, s8
; GFX10-NEXT:    s_cmp_ge_u32 s9, s2
; GFX10-NEXT:    s_cselect_b32 s8, s8, s9
; GFX10-NEXT:    s_sub_i32 s9, s8, s2
; GFX10-NEXT:    s_cmp_ge_u32 s8, s2
; GFX10-NEXT:    s_cselect_b32 s10, s9, s8
; GFX10-NEXT:    s_add_u32 s8, s0, s4
; GFX10-NEXT:    s_addc_u32 s9, 0, s5
; GFX10-NEXT:    s_add_i32 s1, s1, 1
; GFX10-NEXT:    s_add_u32 s6, s6, s3
...
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_not_b32 s8, s7
; GFX11-NEXT:    s_mul_i32 s9, s2, s7
; GFX11-NEXT:    s_mul_i32 s8, s2, s8
; GFX11-NEXT:    s_sub_i32 s9, s1, s9
; GFX11-NEXT:    s_add_i32 s8, s1, s8
; GFX11-NEXT:    s_cmp_ge_u32 s9, s2
; GFX11-NEXT:    s_cselect_b32 s8, s8, s9
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_sub_i32 s9, s8, s2
; GFX11-NEXT:    s_cmp_ge_u32 s8, s2
; GFX11-NEXT:    s_cselect_b32 s10, s9, s8
; GFX11-NEXT:    s_add_u32 s8, s0, s4
; GFX11-NEXT:    s_addc_u32 s9, 0, s5
; GFX11-NEXT:    s_add_i32 s1, s1, 1
; GFX11-NEXT:    s_add_u32 s6, s6, s3
...
; GFX9-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX9-NEXT:    s_mul_hi_u32 s5, s4, s3
...
; GFX10-NEXT:    s_mul_hi_u32 s4, s3, s1
; GFX10-NEXT:    s_mov_b32 s1, 0
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_hi_u32 s4, s3, s1
; GFX11-NEXT:    s_mov_b32 s1, 0
