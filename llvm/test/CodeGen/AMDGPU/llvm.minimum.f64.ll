...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_min_f64 v[0:1], s[6:7], s[16:17]
...
; GFX7-NEXT:    v_cmp_lt_f64_e32 vcc, s[16:17], v[0:1]
; GFX7-NEXT:    v_cmp_o_f64_e64 s[4:5], s[16:17], v[0:1]
; GFX7-NEXT:    v_cmp_class_f64_e64 s[12:13], s[16:17], 32
; GFX7-NEXT:    v_cmp_class_f64_e64 s[14:15], s[20:21], 32
...
; GFX7-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX7-NEXT:    v_cmp_class_f64_e64 s[4:5], s[18:19], 32
; GFX7-NEXT:    s_cselect_b32 s8, s8, 0
...
; GFX8-NEXT:    v_cmp_lt_f64_e32 vcc, s[16:17], v[0:1]
; GFX8-NEXT:    v_cmp_o_f64_e64 s[4:5], s[16:17], v[0:1]
; GFX8-NEXT:    v_cmp_class_f64_e64 s[12:13], s[16:17], 32
; GFX8-NEXT:    v_cmp_class_f64_e64 s[14:15], s[20:21], 32
...
; GFX8-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX8-NEXT:    v_cmp_class_f64_e64 s[4:5], s[18:19], 32
; GFX8-NEXT:    s_cselect_b32 s8, s8, 0
...
; GFX9-NEXT:    v_cmp_lt_f64_e32 vcc, s[16:17], v[0:1]
; GFX9-NEXT:    v_cmp_o_f64_e64 s[4:5], s[16:17], v[0:1]
; GFX9-NEXT:    v_cmp_class_f64_e64 s[12:13], s[16:17], 32
; GFX9-NEXT:    v_cmp_class_f64_e64 s[14:15], s[20:21], 32
...
; GFX9-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX9-NEXT:    v_cmp_class_f64_e64 s[4:5], s[18:19], 32
; GFX9-NEXT:    s_cselect_b32 s8, s8, 0
...
; GFX940-NEXT:    v_cmp_class_f64_e64 s[14:15], s[16:17], 32
...
; GFX940-NEXT:    v_cmp_class_f64_e64 s[12:13], s[0:1], 32
...
; GFX10:       ; %bb.0:
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_cmp_lt_f64_e64 s4, s[16:17], s[20:21]
; GFX10-NEXT:    v_cmp_o_f64_e64 s8, s[16:17], s[20:21]
; GFX10-NEXT:    v_cmp_class_f64_e64 s9, s[16:17], 32
; GFX10-NEXT:    v_cmp_class_f64_e64 s10, s[20:21], 32
; GFX10-NEXT:    v_cmp_lt_f64_e64 s12, s[6:7], s[18:19]
; GFX10-NEXT:    v_cmp_o_f64_e64 s13, s[6:7], s[18:19]
; GFX10-NEXT:    v_cmp_class_f64_e64 s14, s[6:7], 32
; GFX10-NEXT:    v_cmp_class_f64_e64 s15, s[18:19], 32
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_cmp_lt_f64_e64 s4, s[2:3], s[16:17]
; GFX11-NEXT:    v_cmp_o_f64_e64 s8, s[2:3], s[16:17]
; GFX11-NEXT:    v_cmp_class_f64_e64 s9, s[2:3], 32
; GFX11-NEXT:    v_cmp_class_f64_e64 s10, s[16:17], 32
; GFX11-NEXT:    v_cmp_o_f64_e64 s12, s[0:1], s[6:7]
; GFX11-NEXT:    v_cmp_class_f64_e64 s13, s[0:1], 32
; GFX11-NEXT:    v_cmp_class_f64_e64 s14, s[6:7], 32
...
; GFX11-NEXT:    v_cmp_lt_f64_e64 s11, s[0:1], s[6:7]
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_minimum_f64 v[2:3], s[2:3], s[16:17]
; GFX12-NEXT:    v_minimum_f64 v[0:1], s[0:1], s[6:7]
; GFX12-NEXT:    ;;#ASMSTART
