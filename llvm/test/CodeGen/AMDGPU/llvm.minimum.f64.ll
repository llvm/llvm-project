...
;
; GFX942-LABEL: v_minimum_f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[4:5], v[0:1], v[2:3]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f64__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[4:5], v[0:1], v[2:3]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[2:3]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f64__nnan_src0:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_f64__nnan_src1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: s_minimum_f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX942-NEXT:    v_min_f64 v[2:3], s[0:1], v[0:1]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[8:9], v[0:1], v[4:5]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[4:5]
; GFX942-NEXT:    v_min_f64 v[4:5], v[2:3], v[6:7]
; GFX942-NEXT:    s_nop 0
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v2f64__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[8:9], v[0:1], v[4:5]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[4:5]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: s_minimum_v2f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], s[18:19]
; GFX942-NEXT:    v_min_f64 v[2:3], s[2:3], v[0:1]
...
; GFX942-NEXT:    v_min_f64 v[4:5], s[0:1], v[0:1]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[12:13], v[0:1], v[6:7]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[6:7]
; GFX942-NEXT:    v_min_f64 v[6:7], v[2:3], v[8:9]
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_min_f64 v[6:7], v[4:5], v[10:11]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v3f64__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[12:13], v[0:1], v[6:7]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[6:7]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[16:17], v[0:1], v[8:9]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[8:9]
; GFX942-NEXT:    v_min_f64 v[8:9], v[2:3], v[10:11]
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    v_min_f64 v[8:9], v[4:5], v[12:13]
...
; GFX942-NEXT:    v_min_f64 v[8:9], v[6:7], v[14:15]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v4f64__nsz:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    v_min_f64 v[16:17], v[0:1], v[8:9]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[8:9]
...
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: v_minimum_v8f64:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    scratch_load_dword v31, off, s32
; GFX942-NEXT:    v_mov_b32_e32 v54, 0x7ff80000
; GFX942-NEXT:    v_min_f64 v[32:33], v[0:1], v[16:17]
; GFX942-NEXT:    v_cmp_u_f64_e32 vcc, v[0:1], v[16:17]
; GFX942-NEXT:    v_min_f64 v[34:35], v[2:3], v[18:19]
; GFX942-NEXT:    v_min_f64 v[36:37], v[4:5], v[20:21]
...
; GFX942-NEXT:    v_min_f64 v[38:39], v[6:7], v[22:23]
; GFX942-NEXT:    v_min_f64 v[48:49], v[8:9], v[24:25]
...
; GFX942-NEXT:    v_min_f64 v[50:51], v[10:11], v[26:27]
; GFX942-NEXT:    v_min_f64 v[52:53], v[12:13], v[28:29]
...
; GFX942-NEXT:    v_min_f64 v[16:17], v[14:15], v[30:31]
...
; GFX942-NEXT:    v_min_f64 v[58:59], v[2:3], v[36:37]
...
; GFX942-NEXT:    s_waitcnt vmcnt(25)
; GFX942-NEXT:    v_min_f64 v[60:61], v[4:5], v[38:39]
...
; GFX942-NEXT:    s_waitcnt vmcnt(25)
; GFX942-NEXT:    v_min_f64 v[62:63], v[6:7], v[48:49]
...
; GFX942-NEXT:    v_min_f64 v[46:47], v[10:11], v[44:45]
...
; GFX942-NEXT:    v_min_f64 v[44:45], v[12:13], v[42:43]
...
; GFX942-NEXT:    v_min_f64 v[42:43], v[14:15], v[40:41]
...
; GFX942-NEXT:    v_min_f64 v[40:41], v[16:17], v[54:55]
...
; GFX942-NEXT:    v_min_f64 v[54:55], v[18:19], v[52:53]
...
; GFX942-NEXT:    v_min_f64 v[52:53], v[20:21], v[50:51]
...
; GFX942-NEXT:    v_min_f64 v[50:51], v[22:23], v[34:35]
...
; GFX942-NEXT:    v_min_f64 v[34:35], v[24:25], v[32:33]
...
; GFX942-NEXT:    v_min_f64 v[32:33], v[26:27], v[36:37]
...
; GFX942-NEXT:    v_min_f64 v[32:33], v[28:29], v[38:39]
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_min_f64 v[32:33], v[30:31], v[48:49]
