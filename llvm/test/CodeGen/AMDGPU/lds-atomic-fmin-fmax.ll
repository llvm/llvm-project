...
; SI-NEXT:    s_lshl_b32 s2, s4, 4
; SI-NEXT:    s_add_i32 s2, s2, 64
...
; G_SI-NEXT:    s_load_dword s4, s[2:3], 0xb
; G_SI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
...
; G_GFX7-NEXT:    s_load_dword s4, s[2:3], 0xb
; G_GFX7-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x9
...
; G_VI-NEXT:    s_load_dword s4, s[2:3], 0x2c
; G_VI-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; G_GFX9-NEXT:    s_load_dword s4, s[2:3], 0x2c
; G_GFX9-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
...
; G_GFX9-NEXT:    s_lshl_b32 s2, s4, 3
; G_GFX9-NEXT:    v_mov_b32_e32 v0, s2
; G_GFX9-NEXT:    v_mov_b32_e32 v1, 0x42280000
; G_GFX9-NEXT:    ds_min_rtn_f32 v0, v0, v1
; G_GFX9-NEXT:    s_lshl_b32 s2, s4, 4
...
; G_GFX9-NEXT:    v_mov_b32_e32 v1, s0
; G_GFX9-NEXT:    s_waitcnt lgkmcnt(0)
...
; G_GFX10:       ; %bb.0:
; G_GFX10-NEXT:    s_load_dword s0, s[2:3], 0x2c
...
; G_GFX10-NEXT:    s_add_i32 s4, s0, 4
; G_GFX10-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; G_GFX10-NEXT:    s_lshl_b32 s5, s4, 3
; G_GFX10-NEXT:    s_lshl_b32 s2, s4, 4
...
; G_GFX11:       ; %bb.0:
; G_GFX11-NEXT:    s_load_b32 s0, s[2:3], 0x2c
; G_GFX11-NEXT:    v_mov_b32_e32 v1, 0x42280000
; G_GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; G_GFX11-NEXT:    s_add_i32 s4, s0, 4
; G_GFX11-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    buffer_store_dword v1, v3, s[12:15], 0 offen
; SI-NEXT:    buffer_store_dword v0, v2, s[12:15], 0 offen
; SI-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    buffer_store_dword v1, v3, s[12:15], 0 offen
; GFX7-NEXT:    buffer_store_dword v0, v2, s[12:15], 0 offen
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_load_b128 s[0:3], s[2:3], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v5, s1
; GFX11-NEXT:    s_lshl_b32 s3, s2, 3
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(SALU_CYCLE_1)
...
; G_SI-NEXT:    s_waitcnt lgkmcnt(0)
; G_SI-NEXT:    buffer_store_dword v0, v2, s[12:15], 0 offen
; G_SI-NEXT:    buffer_store_dword v1, v3, s[12:15], 0 offen
; G_SI-NEXT:    s_endpgm
;
...
; G_GFX7-NEXT:    buffer_store_dword v1, v3, s[12:15], 0 offen
; G_GFX7-NEXT:    s_endpgm
;
...
; G_GFX9-NEXT:    s_mov_b32 s15, 0xe00000
; G_GFX9-NEXT:    s_add_u32 s12, s12, s9
; G_GFX9-NEXT:    s_mov_b32 s2, 0
; G_GFX9-NEXT:    s_addc_u32 s13, s13, 0
; G_GFX9-NEXT:    s_mov_b32 s3, 0x40450000
; G_GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; G_GFX9-NEXT:    s_add_i32 s4, s4, 4
; G_GFX9-NEXT:    v_mov_b32_e32 v0, s2
; G_GFX9-NEXT:    s_lshl_b32 s2, s4, 3
...
; G_GFX9-NEXT:    s_lshl_b32 s1, s4, 4
...
; G_GFX10-NEXT:    s_load_dword s4, s[2:3], 0x2c
; G_GFX10-NEXT:    s_load_dwordx2 s[0:1], s[2:3], 0x24
; G_GFX10-NEXT:    s_mov_b32 s12, SCRATCH_RSRC_DWORD0
; G_GFX10-NEXT:    s_mov_b32 s13, SCRATCH_RSRC_DWORD1
; G_GFX10-NEXT:    s_mov_b32 s14, -1
...
; G_GFX10-NEXT:    s_add_u32 s12, s12, s9
; G_GFX10-NEXT:    s_addc_u32 s13, s13, 0
; G_GFX10-NEXT:    s_mov_b32 s2, 0
; G_GFX10-NEXT:    s_mov_b32 s3, 0x40450000
; G_GFX10-NEXT:    v_mov_b32_e32 v0, s2
; G_GFX10-NEXT:    v_mov_b32_e32 v1, s3
; G_GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; G_GFX10-NEXT:    s_add_i32 s4, s4, 4
; G_GFX10-NEXT:    v_mov_b32_e32 v5, s1
; G_GFX10-NEXT:    s_lshl_b32 s5, s4, 3
; G_GFX10-NEXT:    s_lshl_b32 s2, s4, 4
; G_GFX10-NEXT:    v_mov_b32_e32 v2, s5
; G_GFX10-NEXT:    v_mov_b32_e32 v4, s2
...
; G_GFX11-NEXT:    s_load_b32 s4, s[2:3], 0x2c
; G_GFX11-NEXT:    s_load_b64 s[0:1], s[2:3], 0x24
; G_GFX11-NEXT:    s_mov_b32 s2, 0
; G_GFX11-NEXT:    s_mov_b32 s3, 0x40450000
; G_GFX11-NEXT:    v_mov_b32_e32 v0, s2
; G_GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; G_GFX11-NEXT:    s_add_i32 s4, s4, 4
; G_GFX11-NEXT:    v_mov_b32_e32 v5, s1
; G_GFX11-NEXT:    s_lshl_b32 s5, s4, 3
