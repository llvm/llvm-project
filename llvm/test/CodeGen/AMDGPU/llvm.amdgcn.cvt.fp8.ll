...
;
; GFX1210-LABEL: test_cvt_f32_bf8_byte0:
; GFX1210:       ; %bb.0:
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_f32_fp8_byte0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_f32_bf8_word0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_f32_bf8_word1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_f32_fp8_word0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_f32_fp8_word1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_bf8_f32_word1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_pk_fp8_f32_word0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_sr_bf8_f32_byte1:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_sr_bf8_f32 v2, v0, v1 op_sel:[0,0,1,0]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, v2
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_sr_bf8_f32_byte2:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_sr_bf8_f32 v2, v0, v1 op_sel:[0,0,0,1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, v2
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_sr_bf8_f32_byte3:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_sr_bf8_f32 v2, v0, v1 op_sel:[0,0,1,1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, v2
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_sr_fp8_f32_byte0:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
; GFX1210-LABEL: test_cvt_sr_fp8_f32_byte3:
; GFX1210:       ; %bb.0:
; GFX1210-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1210-NEXT:    s_wait_kmcnt 0x0
; GFX1210-NEXT:    v_cvt_sr_fp8_f32 v2, v0, v1 op_sel:[0,0,1,1]
; GFX1210-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1210-NEXT:    v_mov_b32_e32 v0, v2
; GFX1210-NEXT:    s_setpc_b64 s[30:31]
