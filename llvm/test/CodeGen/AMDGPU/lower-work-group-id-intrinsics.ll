...
; GFX12-GISEL-NEXT:    buffer_store_b96 v[0:2], off, s[0:3], s0
...
; GFX12-SDAG-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX12-SDAG-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
...
; GFX12-GISEL-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX12-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
