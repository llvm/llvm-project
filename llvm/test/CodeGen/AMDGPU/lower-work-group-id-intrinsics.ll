...
; GFX1250-GISEL-NEXT:    s_bfe_u32 s2, ttmp6, 0x40010
...
; GFX1250-GISEL-NEXT:    s_bfe_u32 s4, ttmp6, 0x40014
; GFX1250-GISEL-NEXT:    s_add_co_i32 s1, s1, s0
; GFX1250-GISEL-NEXT:    s_mul_i32 s0, s3, s2
; GFX1250-GISEL-NEXT:    s_bfe_u32 s2, ttmp6, 0x40004
; GFX1250-GISEL-NEXT:    s_lshr_b32 s5, ttmp7, 16
; GFX1250-GISEL-NEXT:    s_add_co_i32 s4, s4, 1
; GFX1250-GISEL-NEXT:    s_add_co_i32 s2, s2, s0
; GFX1250-GISEL-NEXT:    s_mul_i32 s0, s5, s4
; GFX1250-GISEL-NEXT:    s_bfe_u32 s4, ttmp6, 0x40008
; GFX1250-GISEL-NEXT:    s_getreg_b32 s6, hwreg(HW_REG_IB_STS2, 6, 4)
; GFX1250-GISEL-NEXT:    s_add_co_i32 s4, s4, s0
; GFX1250-GISEL-NEXT:    s_cmp_eq_u32 s6, 0
; GFX1250-GISEL-NEXT:    s_cselect_b32 s0, s5, s4
; GFX1250-GISEL-NEXT:    s_cselect_b32 s1, ttmp9, s1
; GFX1250-GISEL-NEXT:    s_cselect_b32 s2, s3, s2
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s1 :: v_dual_mov_b32 v1, s2
...
; GFX1250-GISEL:       ; %bb.0: ; %.entry
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    s_lshr_b32 s1, ttmp7, 14
; GFX1250-GISEL-NEXT:    s_and_b32 s2, ttmp7, 0xffff
; GFX1250-GISEL-NEXT:    s_and_b32 s0, ttmp6, 15
; GFX1250-GISEL-NEXT:    s_and_b32 s1, s1, 0x3fffc
; GFX1250-GISEL-NEXT:    s_bfe_u32 s3, ttmp6, 0x40008
; GFX1250-GISEL-NEXT:    s_mul_i32 s2, s2, 3
...
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s4
