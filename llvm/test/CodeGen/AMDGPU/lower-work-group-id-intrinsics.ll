...
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1200-SDAG %s
; RUN: llc -mtriple=amdgcn-amd-amdpal -mcpu=gfx1200 -global-isel --verify-machineinstrs < %s | FileCheck -check-prefix=GFX1200-GISEL %s
...
;
; GFX1200-SDAG-LABEL: _amdgpu_cs_main:
; GFX1200-SDAG:       ; %bb.0: ; %.entry
; GFX1200-SDAG-NEXT:    s_lshr_b32 s2, ttmp7, 16
; GFX1200-SDAG-NEXT:    s_and_b32 s1, ttmp7, 0xffff
; GFX1200-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1200-SDAG-NEXT:    v_dual_mov_b32 v0, ttmp9 :: v_dual_mov_b32 v1, s1
; GFX1200-SDAG-NEXT:    v_mov_b32_e32 v2, s2
; GFX1200-SDAG-NEXT:    buffer_store_b96 v[0:2], off, s[0:3], null
; GFX1200-SDAG-NEXT:    s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)
; GFX1200-SDAG-NEXT:    s_endpgm
;
; GFX1200-GISEL-LABEL: _amdgpu_cs_main:
; GFX1200-GISEL:       ; %bb.0: ; %.entry
; GFX1200-GISEL-NEXT:    s_mov_b32 s0, ttmp9
; GFX1200-GISEL-NEXT:    s_and_b32 s1, ttmp7, 0xffff
; GFX1200-GISEL-NEXT:    s_lshr_b32 s2, ttmp7, 16
; GFX1200-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX1200-GISEL-NEXT:    v_mov_b32_e32 v2, s2
; GFX1200-GISEL-NEXT:    buffer_store_b96 v[0:2], off, s[0:3], null
...
; GFX1210-SDAG-NEXT:    buffer_store_b96 v[0:2], off, s[0:3], 0/*Invalid immediate*/
...
; GFX1210-GISEL-NEXT:    buffer_store_b96 v[0:2], off, s[0:3], 0/*Invalid immediate*/
...
; GFX9-GISEL-NEXT:    s_endpgm
;
; GFX1200-SDAG-LABEL: caller:
; GFX1200-SDAG:       ; %bb.0:
; GFX1200-SDAG-NEXT:    s_getpc_b64 s[0:1]
; GFX1200-SDAG-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX1200-SDAG-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
; GFX1200-SDAG-NEXT:    v_mov_b32_e32 v0, ttmp9
; GFX1200-SDAG-NEXT:    s_load_b64 s[0:1], s[0:1], 0x0
; GFX1200-SDAG-NEXT:    s_mov_b32 s32, 0
; GFX1200-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX1200-SDAG-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX1200-SDAG-NEXT:    s_endpgm
;
; GFX1200-GISEL-LABEL: caller:
; GFX1200-GISEL:       ; %bb.0:
; GFX1200-GISEL-NEXT:    s_getpc_b64 s[0:1]
; GFX1200-GISEL-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX1200-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
; GFX1200-GISEL-NEXT:    v_mov_b32_e32 v0, ttmp9
; GFX1200-GISEL-NEXT:    s_load_b64 s[0:1], s[0:1], 0x0
; GFX1200-GISEL-NEXT:    s_mov_b32 s32, 0
; GFX1200-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX1200-GISEL-NEXT:    s_swappc_b64 s[30:31], s[0:1]
; GFX1200-GISEL-NEXT:    s_endpgm
;
; GFX1210-SDAG-LABEL: caller:
; GFX1210-SDAG:       ; %bb.0:
; GFX1210-SDAG-NEXT:    s_getpc_b64 s[0:1]
; GFX1210-SDAG-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX1210-SDAG-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
...
; GFX1210-GISEL:       ; %bb.0:
; GFX1210-GISEL-NEXT:    s_getpc_b64 s[0:1]
; GFX1210-GISEL-NEXT:    s_add_co_u32 s0, s0, callee@gotpcrel32@lo+4
; GFX1210-GISEL-NEXT:    s_add_co_ci_u32 s1, s1, callee@gotpcrel32@hi+12
