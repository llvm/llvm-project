...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v7, 0 :: v_dual_and_b32 v0, 0x3ff, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, 3, v0
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_clause 0x5
; GFX11-TRUE16-NEXT:    global_load_u16 v1, v0, s[2:3] offset:4
; GFX11-TRUE16-NEXT:    global_load_u8 v2, v0, s[2:3] offset:6
; GFX11-TRUE16-NEXT:    global_load_u8 v3, v0, s[2:3] offset:3
; GFX11-TRUE16-NEXT:    global_load_u8 v4, v0, s[2:3] offset:2
; GFX11-TRUE16-NEXT:    global_load_u8 v5, v0, s[2:3] offset:1
; GFX11-TRUE16-NEXT:    global_load_u8 v0, v0, s[2:3]
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(5)
; GFX11-TRUE16-NEXT:    v_cvt_u32_u16_e32 v8, v1.l
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX11-TRUE16-NEXT:    v_cvt_f32_ubyte1_e32 v5, v8
; GFX11-TRUE16-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX11-TRUE16-NEXT:    s_clause 0x1
; GFX11-TRUE16-NEXT:    global_store_b128 v7, v[0:3], s[0:1]
; GFX11-TRUE16-NEXT:    global_store_b96 v7, v[4:6], s[0:1] offset:16
; GFX11-TRUE16-NEXT:    s_endpgm
;
...
; GFX11-FAKE16-NEXT:    global_load_u16 v1, v0, s[2:3] offset:4
; GFX11-FAKE16-NEXT:    global_load_u8 v2, v0, s[2:3] offset:6
; GFX11-FAKE16-NEXT:    global_load_u8 v3, v0, s[2:3] offset:3
; GFX11-FAKE16-NEXT:    global_load_u8 v4, v0, s[2:3] offset:2
; GFX11-FAKE16-NEXT:    global_load_u8 v5, v0, s[2:3] offset:1
...
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v6, v2
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(3)
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v3, v3
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(2)
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v2, v4
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(1)
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v1, v5
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte1_e32 v5, v8
; GFX11-FAKE16-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX11-FAKE16-NEXT:    s_clause 0x1
