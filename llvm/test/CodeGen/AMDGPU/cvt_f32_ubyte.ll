...
; SI-NEXT:    buffer_load_dwordx2 v[8:9], v[3:4], s[8:11], 0 addr64
; SI-NEXT:    s_flbit_i32_b32 s0, 0
; SI-NEXT:    s_min_u32 s6, s0, 32
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_sub_i32 s7, 32, s6
; SI-NEXT:    s_mov_b32 s0, s4
; SI-NEXT:    s_mov_b32 s1, s5
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_lshrrev_b32_e32 v3, 24, v9
; SI-NEXT:    v_lshl_b64 v[3:4], v[3:4], s6
; SI-NEXT:    v_cvt_f32_ubyte3_e32 v7, v8
; SI-NEXT:    v_min_u32_e32 v3, 1, v3
; SI-NEXT:    v_or_b32_e32 v3, v4, v3
; SI-NEXT:    v_cvt_f32_u32_e32 v3, v3
; SI-NEXT:    v_cvt_f32_ubyte2_e32 v6, v8
; SI-NEXT:    v_cvt_f32_ubyte1_e32 v5, v8
; SI-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; SI-NEXT:    v_cvt_f32_ubyte2_e32 v2, v9
; SI-NEXT:    v_cvt_f32_ubyte1_e32 v1, v9
; SI-NEXT:    v_cvt_f32_ubyte0_e32 v0, v9
; SI-NEXT:    v_ldexp_f32_e64 v3, v3, s7
...
; VI-NEXT:    v_add_u32_e32 v0, vcc, s2, v0
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    flat_load_dwordx2 v[3:4], v[0:1]
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_sub_i32 s5, 32, s4
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_lshrrev_b32_e32 v5, 24, v4
; VI-NEXT:    v_cvt_f32_ubyte2_e32 v2, v4
; VI-NEXT:    v_cvt_f32_ubyte1_e32 v1, v4
; VI-NEXT:    v_cvt_f32_ubyte0_e32 v0, v4
; VI-NEXT:    v_lshlrev_b64 v[4:5], s4, v[5:6]
; VI-NEXT:    v_cvt_f32_ubyte3_e32 v7, v3
; VI-NEXT:    v_min_u32_e32 v4, 1, v4
; VI-NEXT:    v_or_b32_e32 v4, v5, v4
; VI-NEXT:    v_cvt_f32_u32_e32 v8, v4
; VI-NEXT:    v_cvt_f32_ubyte2_e32 v6, v3
; VI-NEXT:    v_cvt_f32_ubyte1_e32 v5, v3
; VI-NEXT:    v_cvt_f32_ubyte0_e32 v4, v3
; VI-NEXT:    v_ldexp_f32 v3, v8, s5
...
; GFX10-NEXT:    s_waitcnt_depctr 0xffe3
; GFX10-NEXT:    s_flbit_i32_b32 s2, 0
; GFX10-NEXT:    s_min_u32 s2, s2, 32
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_lshrrev_b32_e32 v10, 24, v9
; GFX10-NEXT:    v_cvt_f32_ubyte3_e32 v7, v8
; GFX10-NEXT:    v_cvt_f32_ubyte2_e32 v6, v8
; GFX10-NEXT:    v_cvt_f32_ubyte1_e32 v5, v8
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX10-NEXT:    v_lshlrev_b64 v[0:1], s2, v[10:11]
...
; GFX10-NEXT:    v_ldexp_f32 v3, v0, s2
; GFX10-NEXT:    v_cvt_f32_ubyte0_e32 v0, v9
; GFX10-NEXT:    global_store_dwordx4 v11, v[4:7], s[0:1]
; GFX10-NEXT:    global_store_dwordx4 v11, v[0:3], s[0:1] offset:16
; GFX10-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    s_flbit_i32_b32 s2, 0
; GFX9-NEXT:    s_min_u32 s2, s2, 32
...
; GFX9-NEXT:    v_cvt_f32_ubyte1_e32 v1, v4
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v0, v4
; GFX9-NEXT:    v_lshlrev_b64 v[4:5], s2, v[7:8]
; GFX9-NEXT:    v_cvt_f32_ubyte3_e32 v7, v3
; GFX9-NEXT:    v_min_u32_e32 v4, 1, v4
; GFX9-NEXT:    v_or_b32_e32 v4, v5, v4
; GFX9-NEXT:    v_cvt_f32_u32_e32 v9, v4
; GFX9-NEXT:    v_cvt_f32_ubyte2_e32 v6, v3
; GFX9-NEXT:    v_cvt_f32_ubyte1_e32 v5, v3
; GFX9-NEXT:    v_cvt_f32_ubyte0_e32 v4, v3
; GFX9-NEXT:    v_ldexp_f32 v3, v9, s3
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GFX11-NEXT:    v_dual_mov_b32 v11, 0 :: v_dual_and_b32 v0, 0x3ff, v0
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_lshrrev_b32_e32 v10, 24, v9
; GFX11-NEXT:    v_cvt_f32_ubyte3_e32 v7, v8
; GFX11-NEXT:    v_cvt_f32_ubyte2_e32 v6, v8
; GFX11-NEXT:    v_cvt_f32_ubyte1_e32 v5, v8
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v4, v8
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], s2, v[10:11]
; GFX11-NEXT:    s_sub_i32 s2, 32, s2
; GFX11-NEXT:    v_cvt_f32_ubyte2_e32 v2, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_min_u32_e32 v0, 1, v0
; GFX11-NEXT:    v_or_b32_e32 v0, v1, v0
; GFX11-NEXT:    v_cvt_f32_ubyte1_e32 v1, v9
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_cvt_f32_u32_e32 v0, v0
; GFX11-NEXT:    v_ldexp_f32 v3, v0, s2
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, v9
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_store_b128 v11, v[4:7], s[0:1]
; GFX11-NEXT:    global_store_b128 v11, v[0:3], s[0:1] offset:16
; GFX11-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
