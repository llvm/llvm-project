...
; GFX11-NEXT:    v_and_b32_e32 v0, 0x3ff, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_lshlrev_b32 v1, 2, v0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    global_load_b32 v0, v1, s[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cvt_f32_ubyte3_e32 v3, v0
...
; SI-NEXT:    buffer_load_ubyte v2, v[6:7], s[8:11], 0 addr64 offset:3
; SI-NEXT:    buffer_load_ubyte v4, v[6:7], s[8:11], 0 addr64 offset:2
; SI-NEXT:    buffer_load_ubyte v5, v[6:7], s[8:11], 0 addr64 offset:1
; SI-NEXT:    buffer_load_ubyte v0, v[6:7], s[8:11], 0 addr64
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
...
; GFX10-NEXT:    global_load_ubyte v1, v3, s[2:3] offset:3
; GFX10-NEXT:    global_load_ubyte v2, v3, s[2:3] offset:2
; GFX10-NEXT:    global_load_ubyte v4, v3, s[2:3] offset:1
; GFX10-NEXT:    global_load_ubyte v5, v3, s[2:3]
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v1, v3, s[2:3] offset:3
; GFX9-NEXT:    global_load_ubyte v2, v3, s[2:3] offset:2
; GFX9-NEXT:    global_load_ubyte v4, v3, s[2:3] offset:1
; GFX9-NEXT:    global_load_ubyte v5, v3, s[2:3]
...
; GFX11-NEXT:    global_load_u8 v1, v3, s[2:3] offset:3
; GFX11-NEXT:    global_load_u8 v2, v3, s[2:3] offset:2
; GFX11-NEXT:    global_load_u8 v4, v3, s[2:3] offset:1
; GFX11-NEXT:    global_load_u8 v0, v3, s[2:3]
...
; SI-NEXT:    buffer_load_ubyte v2, v[6:7], s[12:15], 0 addr64 offset:3
; SI-NEXT:    buffer_load_ubyte v4, v[6:7], s[12:15], 0 addr64 offset:2
; SI-NEXT:    s_mov_b64 s[12:13], s[6:7]
; SI-NEXT:    buffer_load_ubyte v3, v[6:7], s[12:15], 0 addr64 offset:2
...
; GFX10-NEXT:    v_lshlrev_b32_e32 v5, 2, v0
; GFX10-NEXT:    v_mov_b32_e32 v7, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x3
; GFX10-NEXT:    global_load_ubyte v1, v5, s[12:13] offset:2
; GFX10-NEXT:    global_load_ubyte v3, v5, s[12:13] offset:3
; GFX10-NEXT:    global_load_ubyte v2, v5, s[14:15] offset:3
; GFX10-NEXT:    global_load_ubyte v4, v5, s[14:15] offset:2
; GFX10-NEXT:    s_waitcnt vmcnt(2)
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v1, v5, s[12:13] offset:2
; GFX9-NEXT:    global_load_ubyte v3, v5, s[12:13] offset:3
; GFX9-NEXT:    global_load_ubyte v2, v5, s[14:15] offset:3
; GFX9-NEXT:    global_load_ubyte v4, v5, s[14:15] offset:2
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x3
; GFX11-NEXT:    global_load_u8 v1, v4, s[4:5] offset:2
; GFX11-NEXT:    global_load_u8 v3, v4, s[4:5] offset:3
; GFX11-NEXT:    global_load_u8 v2, v4, s[6:7] offset:3
; GFX11-NEXT:    global_load_u8 v0, v4, s[6:7] offset:2
; GFX11-NEXT:    s_waitcnt vmcnt(2)
...
; SI-NEXT:    buffer_load_ubyte v2, v[10:11], s[8:11], 0 addr64 offset:3
; SI-NEXT:    buffer_load_ubyte v4, v[10:11], s[8:11], 0 addr64 offset:2
; SI-NEXT:    buffer_load_ubyte v5, v[10:11], s[8:11], 0 addr64 offset:1
; SI-NEXT:    buffer_load_ubyte v6, v[10:11], s[8:11], 0 addr64
; SI-NEXT:    buffer_load_ubyte v7, v[10:11], s[8:11], 0 addr64 offset:5
; SI-NEXT:    buffer_load_ubyte v8, v[10:11], s[8:11], 0 addr64 offset:4
; SI-NEXT:    buffer_load_ubyte v9, v[10:11], s[8:11], 0 addr64 offset:6
; SI-NEXT:    s_mov_b32 s6, -1
; SI-NEXT:    s_mov_b32 s4, s0
; SI-NEXT:    s_mov_b32 s5, s1
...
; VI-NEXT:    v_add_u32_e32 v0, vcc, s2, v0
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI-NEXT:    v_add_u32_e32 v14, vcc, 5, v0
...
; VI-NEXT:    flat_load_ubyte v2, v[14:15]
; VI-NEXT:    flat_load_ubyte v4, v[16:17]
...
; GFX10-NEXT:    global_load_ubyte v5, v3, s[2:3] offset:6
; GFX10-NEXT:    global_load_ubyte v1, v3, s[2:3] offset:3
; GFX10-NEXT:    global_load_ubyte v2, v3, s[2:3] offset:2
; GFX10-NEXT:    global_load_ubyte v6, v3, s[2:3] offset:1
; GFX10-NEXT:    global_load_short_d16 v4, v3, s[2:3] offset:4
; GFX10-NEXT:    global_load_ubyte v0, v3, s[2:3]
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    global_load_ubyte v1, v4, s[2:3] offset:6
; GFX9-NEXT:    global_load_ushort v2, v4, s[2:3] offset:4
; GFX9-NEXT:    global_load_ubyte v3, v4, s[2:3] offset:3
; GFX9-NEXT:    global_load_ubyte v7, v4, s[2:3] offset:2
; GFX9-NEXT:    global_load_ubyte v8, v4, s[2:3] offset:1
; GFX9-NEXT:    global_load_ubyte v9, v4, s[2:3]
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_dual_mov_b32 v4, 0 :: v_dual_lshlrev_b32 v3, 3, v0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x5
; GFX11-NEXT:    global_load_u8 v5, v3, s[2:3] offset:6
; GFX11-NEXT:    global_load_u8 v1, v3, s[2:3] offset:3
; GFX11-NEXT:    global_load_u8 v2, v3, s[2:3] offset:2
; GFX11-NEXT:    global_load_u8 v6, v3, s[2:3] offset:1
; GFX11-NEXT:    global_load_d16_b16 v4, v3, s[2:3] offset:4
; GFX11-NEXT:    global_load_u8 v0, v3, s[2:3]
...
; GFX11-NEXT:    global_load_b32 v0, v1, s[2:3]
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_add_nc_u32 v0, 2, v0
; GFX11-NEXT:    v_cvt_f32_ubyte0_e32 v0, v0
; GFX11-NEXT:    global_store_b32 v1, v0, s[0:1]
; GFX11-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_clause 0x3
; GFX10-NEXT:    global_load_ubyte v1, v5, s[0:1] offset:1
; GFX10-NEXT:    global_load_ubyte v2, v5, s[0:1] offset:3
; GFX10-NEXT:    global_load_ubyte v3, v5, s[0:1]
; GFX10-NEXT:    global_load_ubyte v4, v5, s[0:1] offset:2
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    global_load_dwordx2 v[8:9], v[0:1], off
; GFX9-NEXT:    s_mov_b32 s0, 0x4020c0c
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_load_ubyte v2, v[8:9], off offset:1
; GFX9-NEXT:    global_load_ubyte v3, v[8:9], off offset:3
; GFX9-NEXT:    global_load_ubyte v4, v[8:9], off
; GFX9-NEXT:    global_load_dword v5, v[8:9], off
; GFX9-NEXT:    global_load_ubyte v6, v[8:9], off offset:2
; GFX9-NEXT:    s_waitcnt vmcnt(4)
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_clause 0x3
; GFX11-NEXT:    global_load_u8 v1, v4, s[0:1] offset:3
; GFX11-NEXT:    global_load_u8 v2, v4, s[0:1] offset:1
; GFX11-NEXT:    global_load_u8 v3, v4, s[0:1] offset:2
; GFX11-NEXT:    global_load_u8 v0, v4, s[0:1]
