...
; VI-SAFE:       ; %bb.0:
; VI-SAFE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v0, v1 src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-SAFE:       ; %bb.0:
; VI-SAFE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v0, v2 src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-SAFE:       ; %bb.0:
; VI-SAFE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v1, v3 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v4, v3, v1, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v0, v2 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v5, v2, v0, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cmp_nle_f16_e32 vcc, v1, v3
; VI-SAFE-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; VI-SAFE-NEXT:    v_cmp_nle_f16_e32 vcc, v0, v2
; VI-SAFE-NEXT:    v_cndmask_b32_e32 v0, v2, v0, vcc
; VI-SAFE-NEXT:    v_or_b32_sdwa v0, v0, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
...
; VI-SAFE:       ; %bb.0:
; VI-SAFE-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v3, v7 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v8, v7, v3, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v2, v6 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v9, v6, v2, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v1, v5 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v10, v5, v1, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cmp_nle_f16 vcc, v0, v4 src0_sel:WORD_1 src1_sel:WORD_1
; VI-SAFE-NEXT:    v_cndmask_b32_sdwa v11, v4, v0, vcc dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
...
; VI-SAFE-NEXT:    v_or_b32_sdwa v0, v0, v11 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-SAFE-NEXT:    v_or_b32_sdwa v1, v1, v10 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-SAFE-NEXT:    v_or_b32_sdwa v2, v2, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-SAFE-NEXT:    v_or_b32_sdwa v3, v3, v8 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; VI-SAFE-NEXT:    s_setpc_b64 s[30:31]
;
