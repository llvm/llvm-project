...
; RUN: llc -mtriple=amdgpu12.50 %s -o - | FileCheck --check-prefixes=CHECK-UNKNOWN %s
; RUN: llc -mtriple=amdgpu12.50-unknown-mesa3d %s -o - | FileCheck -check-prefixes=CHECK-MESA3D %s
; RUN: llc -global-isel -mtriple=amdgpu12.50 %s -o - | FileCheck --check-prefixes=CHECK-G-UNKNOWN %s
; RUN: llc -global-isel -mtriple=amdgpu12.50-unknown-mesa3d %s -o - | FileCheck -check-prefixes=CHECK-G-MESA3D %s
