...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1300 %s -o - | FileCheck --check-prefixes=GFX13-SDAG %s
; RUN: llc -global-isel=1 -mtriple=amdgcn -mcpu=gfx1300 %s -o - | FileCheck --check-prefixes=GFX13-GISEL %s
