...
; RUN: llc -mtriple=amdgcn -mcpu=gfx942 -global-isel=1 -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL-GFX942 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -global-isel=1 -new-reg-bank-select -global-isel-abort=2 < %s | FileCheck -check-prefix=GISEL-GFX1100 %s
...
; GISEL-GFX942-NEXT:    s_load_dword s17, s[4:5], 0x34
; GISEL-GFX942-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x44
; GISEL-GFX942-NEXT:    s_load_dword s12, s[4:5], 0x54
; GISEL-GFX942-NEXT:    s_mov_b32 s16, 0
; GISEL-GFX942-NEXT:    s_mov_b32 s5, s16
; GISEL-GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX942-NEXT:    s_mov_b32 s4, s3
; GISEL-GFX942-NEXT:    s_or_b64 s[6:7], s[4:5], s[16:17]
; GISEL-GFX942-NEXT:    s_mov_b32 s17, s2
; GISEL-GFX942-NEXT:    s_mov_b32 s2, s1
; GISEL-GFX942-NEXT:    s_mov_b32 s3, s16
; GISEL-GFX942-NEXT:    s_or_b64 s[4:5], s[2:3], s[16:17]
; GISEL-GFX942-NEXT:    s_mov_b32 s17, s12
; GISEL-GFX942-NEXT:    s_mov_b32 s2, s11
; GISEL-GFX942-NEXT:    s_or_b64 s[14:15], s[2:3], s[16:17]
; GISEL-GFX942-NEXT:    s_mov_b32 s17, s10
; GISEL-GFX942-NEXT:    s_mov_b32 s2, s9
; GISEL-GFX942-NEXT:    s_or_b64 s[12:13], s[2:3], s[16:17]
...
; GISEL-GFX942-NEXT:    v_mov_b32_e32 v0, s1
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[2:5], v0, s[4:7], 0 offen
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[6:9], v0, s[4:7], 0 offen offset:16
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[10:13], v0, s[4:7], 0 offen offset:32
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[14:17], v0, s[4:7], 0 offen offset:48
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[18:21], v0, s[4:7], 0 offen offset:64
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[22:25], v0, s[4:7], 0 offen offset:80
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[26:29], v0, s[4:7], 0 offen offset:96
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[30:33], v0, s[4:7], 0 offen offset:112
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[34:37], v0, s[4:7], 0 offen offset:128
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[38:41], v0, s[4:7], 0 offen offset:144
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[42:45], v0, s[4:7], 0 offen offset:160
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[46:49], v0, s[4:7], 0 offen offset:176
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[50:53], v0, s[4:7], 0 offen offset:192
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[54:57], v0, s[4:7], 0 offen offset:208
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[58:61], v0, s[4:7], 0 offen offset:224
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 a[0:3], v0, s[4:7], 0 offen offset:240
; GISEL-GFX942-NEXT:    s_add_i32 s1, s8, s16
; GISEL-GFX942-NEXT:    s_addk_i32 s16, 0x100
; GISEL-GFX942-NEXT:    v_mov_b32_e32 v0, s1
; GISEL-GFX942-NEXT:    s_cmpk_lt_u32 s16, 0x2000
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v0, s[12:15], 0 offen
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v0, s[12:15], 0 offen offset:16
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[10:13], v0, s[12:15], 0 offen offset:32
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[14:17], v0, s[12:15], 0 offen offset:48
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[18:21], v0, s[12:15], 0 offen offset:64
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[22:25], v0, s[12:15], 0 offen offset:80
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[26:29], v0, s[12:15], 0 offen offset:96
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[30:33], v0, s[12:15], 0 offen offset:112
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[34:37], v0, s[12:15], 0 offen offset:128
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[38:41], v0, s[12:15], 0 offen offset:144
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[42:45], v0, s[12:15], 0 offen offset:160
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[46:49], v0, s[12:15], 0 offen offset:176
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[50:53], v0, s[12:15], 0 offen offset:192
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[54:57], v0, s[12:15], 0 offen offset:208
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[58:61], v0, s[12:15], 0 offen offset:224
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 a[0:3], v0, s[12:15], 0 offen offset:240
...
; GISEL-GFX1100-NEXT:    s_load_b32 s17, s[4:5], 0x34
; GISEL-GFX1100-NEXT:    s_load_b128 s[8:11], s[4:5], 0x44
; GISEL-GFX1100-NEXT:    s_load_b32 s18, s[4:5], 0x54
; GISEL-GFX1100-NEXT:    s_mov_b32 s16, 0
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_mov_b32 s5, s16
; GISEL-GFX1100-NEXT:    s_mov_b32 s13, s16
; GISEL-GFX1100-NEXT:    s_mov_b32 s15, s16
; GISEL-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX1100-NEXT:    s_mov_b32 s4, s3
; GISEL-GFX1100-NEXT:    s_mov_b32 s12, s1
; GISEL-GFX1100-NEXT:    s_or_b64 s[6:7], s[4:5], s[16:17]
; GISEL-GFX1100-NEXT:    s_mov_b32 s17, s2
; GISEL-GFX1100-NEXT:    s_mov_b32 s14, s11
; GISEL-GFX1100-NEXT:    s_or_b64 s[4:5], s[12:13], s[16:17]
; GISEL-GFX1100-NEXT:    s_mov_b32 s17, s18
; GISEL-GFX1100-NEXT:    s_mov_b32 s2, s9
; GISEL-GFX1100-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; GISEL-GFX1100-NEXT:    s_mov_b32 s17, s10
; GISEL-GFX1100-NEXT:    s_mov_b32 s3, s16
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_or_b64 s[12:13], s[2:3], s[16:17]
...
; GISEL-GFX942:       ; %bb.0:
; GISEL-GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GISEL-GFX942-NEXT:    s_load_dword s13, s[4:5], 0x34
; GISEL-GFX942-NEXT:    s_mov_b32 s12, 0
; GISEL-GFX942-NEXT:    s_mov_b32 s7, s12
; GISEL-GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX942-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX942-NEXT:    s_or_b64 s[10:11], s[6:7], s[12:13]
; GISEL-GFX942-NEXT:    s_mov_b32 s13, s2
; GISEL-GFX942-NEXT:    s_mov_b32 s2, s1
; GISEL-GFX942-NEXT:    s_mov_b32 s3, s12
; GISEL-GFX942-NEXT:    s_or_b64 s[8:9], s[2:3], s[12:13]
...
; GISEL-GFX942-NEXT:    s_mov_b32 s5, s12
; GISEL-GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX942-NEXT:    s_mov_b32 s4, s3
; GISEL-GFX942-NEXT:    s_or_b64 s[6:7], s[4:5], s[12:13]
; GISEL-GFX942-NEXT:    s_mov_b32 s13, s2
; GISEL-GFX942-NEXT:    s_mov_b32 s2, s1
; GISEL-GFX942-NEXT:    s_mov_b32 s3, s12
; GISEL-GFX942-NEXT:    s_or_b64 s[4:5], s[2:3], s[12:13]
...
; GISEL-GFX1100-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GISEL-GFX1100-NEXT:    s_load_b32 s13, s[4:5], 0x34
; GISEL-GFX1100-NEXT:    s_mov_b32 s12, 0
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_mov_b32 s7, s12
; GISEL-GFX1100-NEXT:    s_mov_b32 s9, s12
; GISEL-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX1100-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX1100-NEXT:    s_mov_b32 s8, s1
; GISEL-GFX1100-NEXT:    s_or_b64 s[10:11], s[6:7], s[12:13]
; GISEL-GFX1100-NEXT:    s_mov_b32 s13, s2
; GISEL-GFX1100-NEXT:    v_mov_b32_e32 v4, s0
; GISEL-GFX1100-NEXT:    s_or_b64 s[8:9], s[8:9], s[12:13]
; GISEL-GFX1100-NEXT:    s_clause 0x1
; GISEL-GFX1100-NEXT:    s_load_b32 s13, s[4:5], 0x54
; GISEL-GFX1100-NEXT:    s_load_b128 s[0:3], s[4:5], 0x44
; GISEL-GFX1100-NEXT:    s_mov_b32 s5, s12
; GISEL-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX1100-NEXT:    v_mov_b32_e32 v5, s0
; GISEL-GFX1100-NEXT:    buffer_load_b128 v[0:3], v4, s[8:11], 0 offen
; GISEL-GFX1100-NEXT:    s_mov_b32 s4, s3
; GISEL-GFX1100-NEXT:    s_mov_b32 s3, s12
; GISEL-GFX1100-NEXT:    s_or_b64 s[6:7], s[4:5], s[12:13]
; GISEL-GFX1100-NEXT:    s_mov_b32 s13, s2
; GISEL-GFX1100-NEXT:    s_mov_b32 s2, s1
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_or_b64 s[4:5], s[2:3], s[12:13]
; GISEL-GFX1100-NEXT:    s_waitcnt vmcnt(0)
