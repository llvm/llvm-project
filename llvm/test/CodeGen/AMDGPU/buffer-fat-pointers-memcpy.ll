...
; RUN: llc -mtriple=amdgcn -mcpu=gfx942 -mattr=+unaligned-access-mode -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefix=GISEL-GFX942 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=+unaligned-access-mode -global-isel=1 -new-reg-bank-select < %s | FileCheck -check-prefix=GISEL-GFX1100 %s
