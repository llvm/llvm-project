...
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[0:1], v[26:27], v[2:5]
; CHECK-NEXT:    v_mov_b64_e32 v[28:29], s[0:1]
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_cvt_f16_f32_e32 v24, v6
; CHECK-NEXT:    ;;#ASMSTART
; CHECK-NEXT:    ; def v[16:19]
; CHECK-NEXT:    ;;#ASMEND
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[0:1], v[0:1], v[12:15]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[0:1], v[0:1], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[0:1], v[28:29], v[2:5]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v10, v6
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[0:1], v[0:1], v[12:15]
; CHECK-NEXT:    global_store_short v[0:1], v10, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[20:23], v[0:1], v[0:1], v[16:19]
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[0:1], v[26:27], v[16:19]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[0:1], v[0:1], v[2:5]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[0:1], v[0:1], v[16:19]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v2, v2
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[20:23], v[0:1], v[0:1], v[20:23]
; CHECK-NEXT:    global_store_short v[0:1], v2, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[26:27], v[0:1], v[4:7]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[28:29], v[0:1], v[20:23]
; CHECK-NEXT:    global_store_short v[0:1], v6, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
