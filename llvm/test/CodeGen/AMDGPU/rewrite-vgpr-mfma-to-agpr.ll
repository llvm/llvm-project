...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[0:1], v[0:1], v[8:11]
; CHECK-NEXT:    v_mov_b64_e32 v[6:7], s[0:1]
; CHECK-NEXT:    s_mov_b32 s0, 0x7e007e00
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[0:1], v[0:1], v[2:5]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[0:1], v[6:7], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[14:17], v[0:1], v[0:1], v[2:5]
; CHECK-NEXT:    s_nop 4
; CHECK-NEXT:    v_cvt_f16_f32_e32 v29, v12
; CHECK-NEXT:    v_mov_b64_e32 v[2:3], s[0:1]
; CHECK-NEXT:    v_mov_b64_e32 v[4:5], 0
; CHECK-NEXT:    v_mov_b32_e32 v16, 0x7fc00000
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[0:1], v[2:3], v[8:11]
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[24:27], v[0:1], v[0:1], v[20:23]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v9, v14
; CHECK-NEXT:    v_cvt_f16_f32_e32 v28, v8
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[20:23], v[0:1], v[6:7], v[20:23]
; CHECK-NEXT:    global_store_short v[4:5], v9, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[0:1], v[0:1], v[16:19]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[0:1], v[0:1], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[0:1], v[0:1], v[20:23]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v8, v8
; CHECK-NEXT:    global_store_short v[4:5], v8, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[6:7], v[0:1], v[12:15]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[4:5], v28, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[4:5], v29, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    v_cvt_f16_f32_e32 v10, v6
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[0:1], v[0:1], v[24:27]
; CHECK-NEXT:    global_store_short v[4:5], v10, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[0:3], v[2:3], v[0:1], v[6:9]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    s_nop 3
...
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v32, v[28:31], s[0:1] offset:112
; CHECK-NEXT:    v_accvgpr_read_b32 v61, a33
; CHECK-NEXT:    v_accvgpr_read_b32 v60, a32
...
; CHECK-NEXT:    v_accvgpr_read_b32 v59, a31
; CHECK-NEXT:    v_accvgpr_read_b32 v58, a30
; CHECK-NEXT:    v_mov_b32_e32 v0, 0x41000000
; CHECK-NEXT:    v_mov_b32_e32 v1, 0x41800000
; CHECK-NEXT:    v_accvgpr_read_b32 v57, a29
; CHECK-NEXT:    v_accvgpr_read_b32 v56, a28
; CHECK-NEXT:    v_accvgpr_read_b32 v55, a27
; CHECK-NEXT:    v_accvgpr_read_b32 v54, a26
; CHECK-NEXT:    v_accvgpr_read_b32 v53, a25
; CHECK-NEXT:    v_accvgpr_read_b32 v52, a24
; CHECK-NEXT:    v_accvgpr_read_b32 v51, a23
; CHECK-NEXT:    v_accvgpr_read_b32 v50, a22
; CHECK-NEXT:    v_accvgpr_read_b32 v49, a21
; CHECK-NEXT:    v_accvgpr_read_b32 v48, a20
; CHECK-NEXT:    v_accvgpr_read_b32 v47, a19
; CHECK-NEXT:    v_accvgpr_read_b32 v46, a18
; CHECK-NEXT:    v_accvgpr_read_b32 v45, a17
; CHECK-NEXT:    v_accvgpr_read_b32 v44, a16
; CHECK-NEXT:    v_accvgpr_read_b32 v43, a15
; CHECK-NEXT:    v_accvgpr_read_b32 v42, a14
; CHECK-NEXT:    v_accvgpr_read_b32 v41, a13
; CHECK-NEXT:    v_accvgpr_read_b32 v40, a12
; CHECK-NEXT:    v_accvgpr_read_b32 v39, a11
; CHECK-NEXT:    v_accvgpr_read_b32 v38, a10
...
; CHECK-NEXT:    v_accvgpr_read_b32 v33, a5
; CHECK-NEXT:    v_accvgpr_read_b32 v32, a4
; CHECK-NEXT:    v_accvgpr_read_b32 v31, a3
; CHECK-NEXT:    v_accvgpr_read_b32 v30, a2
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    v_mfma_f32_32x32x1_2b_f32 v[30:61], v0, v1, v[30:61]
; CHECK-NEXT:    s_nop 7
; CHECK-NEXT:    s_nop 7
; CHECK-NEXT:    s_nop 1
; CHECK-NEXT:    global_store_dwordx4 v28, v[54:57], s[2:3] offset:96
; CHECK-NEXT:    global_store_dwordx4 v28, v[58:61], s[2:3] offset:112
; CHECK-NEXT:    global_store_dwordx4 v28, v[46:49], s[2:3] offset:64
; CHECK-NEXT:    global_store_dwordx4 v28, v[50:53], s[2:3] offset:80
; CHECK-NEXT:    global_store_dwordx4 v28, v[38:41], s[2:3] offset:32
; CHECK-NEXT:    global_store_dwordx4 v28, v[42:45], s[2:3] offset:48
; CHECK-NEXT:    global_store_dwordx4 v28, v[30:33], s[2:3]
; CHECK-NEXT:    global_store_dwordx4 v28, v[34:37], s[2:3] offset:16
; CHECK-NEXT:    s_endpgm
