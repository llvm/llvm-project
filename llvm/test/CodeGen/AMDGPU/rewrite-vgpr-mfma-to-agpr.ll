...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[24:25], v[24:25], v[0:3]
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[24:25], v[28:29], v[0:3]
; CHECK-NEXT:    s_nop 5
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[20:23], v[24:25], v[24:25], v[16:19]
...
; CHECK-NEXT:    v_cvt_f16_f32_e32 v2, v4
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[24:25], v[26:27], v[16:19]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[24:25], v[24:25], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[24:25], v[24:25], v[12:15]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v3, v8
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[24:25], v[24:25], v[16:19]
; CHECK-NEXT:    global_store_short v[0:1], v3, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[20:23], v[24:25], v[24:25], v[20:23]
; CHECK-NEXT:    v_cvt_f16_f32_e32 v3, v12
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[0:1], v3, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[26:27], v[24:25], v[16:19]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[0:1], v2, off
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[28:29], v[24:25], v[20:23]
; CHECK-NEXT:    global_store_short v[0:1], v2, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    s_nop 2
; CHECK-NEXT:    v_cvt_f16_f32_e32 v3, v16
; CHECK-NEXT:    global_store_short v[0:1], v3, off
; CHECK-NEXT:    s_endpgm
entry:
