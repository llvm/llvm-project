...
; CHECK-NEXT:    ; kill: def $vgpr7 killed $sgpr0 killed $exec
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_mfma_f32_4x4x1_16b_f32 v[0:3], v0, v1, v[2:5]
; CHECK-NEXT:    ; kill: def $vgpr0 killed $sgpr0 killed $exec
; CHECK-NEXT:    s_nop 3
; CHECK-NEXT:    v_mov_b32_e32 v6, v2
; CHECK-NEXT:    v_pk_mov_b32 v[0:1], v[0:1], v[6:7] op_sel:[1,0]
