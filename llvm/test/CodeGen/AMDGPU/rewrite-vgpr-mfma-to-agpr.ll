...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[20:21], v[20:21], v[0:3]
; CHECK-NEXT:    v_mov_b64_e32 v[22:23], s[0:1]
; CHECK-NEXT:    s_mov_b32 s0, 0x7e007e00
; CHECK-NEXT:    s_mov_b32 s1, s0
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[4:7], v[20:21], v[20:21], v[4:7]
; CHECK-NEXT:    v_mov_b64_e32 v[24:25], s[0:1]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[20:21], v[22:23], v[0:3]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[6:9], v[20:21], v[20:21], v[6:9]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[20:21], v[24:25], v[0:3]
; CHECK-NEXT:    s_nop 5
...
; CHECK-NEXT:    v_cvt_f16_f32_e32 v7, v4
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[20:21], v[8:11]
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[20:21], v[20:21], v[16:19]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[20:21], v[22:23], v[16:19]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[8:11], v[20:21], v[20:21], v[8:11]
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[12:15], v[20:21], v[20:21], v[12:15]
; CHECK-NEXT:    s_nop 5
; CHECK-NEXT:    v_cvt_f16_f32_e32 v6, v8
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[20:21], v[20:21], v[16:19]
; CHECK-NEXT:    global_store_short v[0:1], v6, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[2:5], v[20:21], v[20:21], v[2:5]
; CHECK-NEXT:    v_cvt_f16_f32_e32 v6, v12
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
; CHECK-NEXT:    global_store_short v[0:1], v6, off
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[22:23], v[20:21], v[16:19]
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
...
; CHECK-NEXT:    v_mfma_f32_16x16x16_f16 v[16:19], v[24:25], v[20:21], v[2:5]
; CHECK-NEXT:    global_store_short v[0:1], v6, off
; CHECK-NEXT:    buffer_wbl2 sc0 sc1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_inv sc0 sc1
