...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[4:5], s[0:1] offset:16 sc0 sc1
...
; GFX942-NEXT:    ; def v[0:7]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[6:7], s[0:1] offset:16 sc0 sc1
...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[0:1], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v2, v12
; GFX942-NEXT:    v_mov_b32_e32 v3, v13
; GFX942-NEXT:    global_store_dwordx4 v14, v[2:5], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[8:15]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[0:1], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v4, v14
; GFX942-NEXT:    v_mov_b32_e32 v5, v15
; GFX942-NEXT:    global_store_dwordx4 v16, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[0:7]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[2:3], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    ;;#ASMSTART
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    ; def v[8:15]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[2:3], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v4, v14
; GFX942-NEXT:    v_mov_b32_e32 v5, v15
; GFX942-NEXT:    global_store_dwordx4 v16, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    global_store_dwordx4 v12, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x i64> asm "; def $0", "=v"()
  %vec1 = call <4 x i64> asm "; def $0", "=v"()
...
; GFX942-NEXT:    global_store_dwordx4 v14, v[0:3], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x i64> asm "; def $0", "=v"()
  %vec1 = call <4 x i64> asm "; def $0", "=v"()
...
; GFX942-NEXT:    ; def v[8:15]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[4:5], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v4, v14
; GFX942-NEXT:    v_mov_b32_e32 v5, v15
; GFX942-NEXT:    global_store_dwordx4 v16, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    global_store_dwordx4 v14, v[6:9], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x i64> asm "; def $0", "=v"()
  %vec1 = call <4 x i64> asm "; def $0", "=v"()
...
; GFX942-NEXT:    global_store_dwordx4 v16, v[0:3], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x i64> asm "; def $0", "=v"()
  %vec1 = call <4 x i64> asm "; def $0", "=v"()
...
; GFX942-NEXT:    v_mov_b32_e32 v5, v1
; GFX942-NEXT:    global_store_dwordx2 v16, v[6:7], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    global_store_dwordx4 v16, v[2:5], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
  %vec0 = call <4 x i64> asm "; def $0", "=v"()
  %vec1 = call <4 x i64> asm "; def $0", "=v"()
...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[6:7], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v2, v12
; GFX942-NEXT:    v_mov_b32_e32 v3, v13
; GFX942-NEXT:    global_store_dwordx4 v14, v[2:5], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[8:15]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[8:9], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v4, v14
; GFX942-NEXT:    v_mov_b32_e32 v5, v15
; GFX942-NEXT:    global_store_dwordx4 v16, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[8:9], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v6, v8
; GFX942-NEXT:    v_mov_b32_e32 v7, v9
...
; GFX942-NEXT:    ; def v[0:7]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[10:11], s[0:1] offset:16 sc0 sc1
...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[10:11], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v6, v10
; GFX942-NEXT:    v_mov_b32_e32 v7, v11
; GFX942-NEXT:    global_store_dwordx4 v14, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[0:7]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[12:13], s[0:1] offset:16 sc0 sc1
...
; GFX942-NEXT:    ; def v[6:13]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v14, v[12:13], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v6, v12
; GFX942-NEXT:    v_mov_b32_e32 v7, v13
; GFX942-NEXT:    global_store_dwordx4 v14, v[4:7], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GFX942-NEXT:    ; def v[0:7]
; GFX942-NEXT:    ;;#ASMEND
; GFX942-NEXT:    global_store_dwordx2 v16, v[14:15], s[0:1] offset:16 sc0 sc1
; GFX942-NEXT:    v_mov_b32_e32 v12, v6
; GFX942-NEXT:    v_mov_b32_e32 v13, v7
; GFX942-NEXT:    global_store_dwordx4 v16, v[12:15], s[0:1] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
