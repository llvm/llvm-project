...
; CHECK-LE: w0 = load_acquire((u16 *)(r1 + 0)) # encoding: [0xcb,0x10,0x00,0x00,0x10,0x00,0x00,0x00]
; CHECK-BE: w0 = load_acquire((u16 *)(r1 + 0)) # encoding: [0xcb,0x01,0x00,0x00,0x00,0x00,0x00,0x10]
...
; CHECK-LE: w0 = load_acquire((u32 *)(r1 + 0)) # encoding: [0xc3,0x10,0x00,0x00,0x10,0x00,0x00,0x00]
; CHECK-BE: w0 = load_acquire((u32 *)(r1 + 0)) # encoding: [0xc3,0x01,0x00,0x00,0x00,0x00,0x00,0x10]
...
; CHECK-LE: r0 = load_acquire((u64 *)(r1 + 0)) # encoding: [0xdb,0x10,0x00,0x00,0x10,0x00,0x00,0x00]
; CHECK-BE: r0 = load_acquire((u64 *)(r1 + 0)) # encoding: [0xdb,0x01,0x00,0x00,0x00,0x00,0x00,0x10]
...
; CHECK-LE: store_release((u8 *)(r1 + 0), w2) # encoding: [0xd3,0x21,0x00,0x00,0xb0,0x00,0x00,0x00]
; CHECK-BE: store_release((u8 *)(r1 + 0), w2) # encoding: [0xd3,0x12,0x00,0x00,0x00,0x00,0x00,0xb0]
...
; CHECK-LE: store_release((u16 *)(r1 + 0), w2) # encoding: [0xcb,0x21,0x00,0x00,0xb0,0x00,0x00,0x00]
; CHECK-BE: store_release((u16 *)(r1 + 0), w2) # encoding: [0xcb,0x12,0x00,0x00,0x00,0x00,0x00,0xb0]
...
; CHECK-LE: store_release((u32 *)(r1 + 0), w2) # encoding: [0xc3,0x21,0x00,0x00,0xb0,0x00,0x00,0x00]
; CHECK-BE: store_release((u32 *)(r1 + 0), w2) # encoding: [0xc3,0x12,0x00,0x00,0x00,0x00,0x00,0xb0]
...
; CHECK-LE: store_release((u64 *)(r1 + 0), r2) # encoding: [0xdb,0x21,0x00,0x00,0xb0,0x00,0x00,0x00]
; CHECK-BE: store_release((u64 *)(r1 + 0), r2) # encoding: [0xdb,0x12,0x00,0x00,0x00,0x00,0x00,0xb0]
