...
; ARM-NEXT:    lsrs r4, r4, #16
; ARM-NEXT:    adds r2, r2, r4
; ARM-NEXT:    lsrs r4, r2, #16
; ARM-NEXT:    uxth r2, r2
; ARM-NEXT:    lsrs r6, r6, #16
; ARM-NEXT:    muls r3, r6, r3
; ARM-NEXT:    adds r2, r3, r2
; ARM-NEXT:    str r2, [sp, #20] @ 4-byte Spill
; ARM-NEXT:    lsrs r2, r2, #16
; ARM-NEXT:    adds r2, r4, r2
; ARM-NEXT:    muls r6, r1, r6
; ARM-NEXT:    adds r1, r6, r2
; ARM-NEXT:    ldr r2, [sp, #32] @ 4-byte Reload
; ARM-NEXT:    adds r4, r2, r1
; ARM-NEXT:    adcs r7, r5
; ARM-NEXT:    asrs r1, r7, #31
...
; ARM-NEXT:    lsrs r4, r5, #2
; ARM-NEXT:    adds r2, r2, r4
; ARM-NEXT:    lsls r4, r5, #30
; ARM-NEXT:    ldr r5, [sp, #20] @ 4-byte Reload
; ARM-NEXT:    lsls r5, r5, #16
; ARM-NEXT:    ldr r7, [sp, #24] @ 4-byte Reload
; ARM-NEXT:    uxth r7, r7
; ARM-NEXT:    adds r5, r7, r5
; ARM-NEXT:    lsrs r5, r5, #2
; ARM-NEXT:    adds r7, r4, r5
...
; ARM-NEXT:    mov r4, r7
; ARM-NEXT:  .LBB1_8:
; ARM-NEXT:    adds r7, r1, #1
; ARM-NEXT:    rsbs r6, r7, #0
; ARM-NEXT:    adcs r6, r7
; ARM-NEXT:    mvns r7, r0
; ARM-NEXT:    cmp r3, r7
; ARM-NEXT:    mov r3, r0
...
; ARM-NEXT:    adds r2, r2, r5
; ARM-NEXT:    lsrs r5, r2, #16
; ARM-NEXT:    uxth r2, r2
; ARM-NEXT:    lsrs r4, r4, #16
; ARM-NEXT:    muls r3, r4, r3
; ARM-NEXT:    adds r0, r3, r2
; ARM-NEXT:    str r0, [sp, #12] @ 4-byte Spill
; ARM-NEXT:    lsrs r2, r0, #16
; ARM-NEXT:    adds r2, r5, r2
; ARM-NEXT:    muls r4, r1, r4
; ARM-NEXT:    adds r1, r4, r2
; ARM-NEXT:    ldr r0, [sp, #8] @ 4-byte Reload
...
; ARM-NEXT:    bne .LBB6_7
; ARM-NEXT:  @ %bb.6:
; ARM-NEXT:    ldr r6, [sp] @ 4-byte Reload
; ARM-NEXT:  .LBB6_7:
; ARM-NEXT:    adds r4, r1, #1
; ARM-NEXT:    rsbs r5, r4, #0
; ARM-NEXT:    adcs r5, r4
; ARM-NEXT:    cmp r3, #0
; ARM-NEXT:    mov r3, r7
; ARM-NEXT:    bge .LBB6_9
...
; ARM-NEXT:    cmp r1, r2
; ARM-NEXT:    mov r3, r7
; ARM-NEXT:    blt .LBB6_11
; ARM-NEXT:  @ %bb.10:
; ARM-NEXT:    mov r3, r0
; ARM-NEXT:  .LBB6_11:
; ARM-NEXT:    orrs r3, r5
; ARM-NEXT:    lsls r1, r7, #31
; ARM-NEXT:    cmp r3, #0
; ARM-NEXT:    beq .LBB6_14
; ARM-NEXT:  @ %bb.12:
; ARM-NEXT:    beq .LBB6_15
; ARM-NEXT:  .LBB6_13:
; ARM-NEXT:    add sp, #20
; ARM-NEXT:    pop {r4, r5, r6, r7, pc}
; ARM-NEXT:  .LBB6_14:
; ARM-NEXT:    mov r0, r6
; ARM-NEXT:    bne .LBB6_13
; ARM-NEXT:  .LBB6_15:
