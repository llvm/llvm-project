...
; ARM-NEXT:    bne .LBB6_6
; ARM-NEXT:  .LBB6_5:
; ARM-NEXT:    ldr r3, [sp] @ 4-byte Reload
; ARM-NEXT:  .LBB6_6:
; ARM-NEXT:    adds r7, r1, #1
; ARM-NEXT:    rsbs r6, r7, #0
; ARM-NEXT:    adcs r6, r7
