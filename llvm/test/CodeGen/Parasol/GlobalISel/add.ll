...
; Function Attrs: fhe_program mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
...
attributes #0 = { fhe_program mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" }
