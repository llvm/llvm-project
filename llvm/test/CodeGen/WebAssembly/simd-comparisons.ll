...
; SIMD128-NEXT: v128.const	$push[[R:[0-9]+]]=, -1, -1, -1, -1{{$}}
; SIMD128-NEXT: return   $pop[[R]]{{$}}
...
; SIMD128-NEXT: v128.const $push[[R:[0-9]+]]=, 0, 0, 0, 0{{$}}
; SIMD128-NEXT: return $pop[[R]]{{$}}
...
; SIMD128-NEXT: v128.const $push[[R:[0-9]+]]=, -1, -1{{$}}
; SIMD128-NEXT: return $pop[[R]]{{$}}
...
; SIMD128-NEXT: v128.const $push[[R:[0-9]+]]=, 0, 0{{$}}
; SIMD128-NEXT: return $pop[[R]]{{$}}
