...
; CHECK-NEXT:    i32.gt_s $push1=, $pop5, $pop4
; CHECK-NEXT:    local.get $push7=, 0
; CHECK-NEXT:    local.get $push6=, 1
; CHECK-NEXT:    i32.lt_s $push0=, $pop7, $pop6
...
; CHECK-NEXT:    i64.gt_s $push3=, $pop16, $pop15
...
; CHECK-NEXT:    i64.lt_s $push0=, $pop22, $pop21
