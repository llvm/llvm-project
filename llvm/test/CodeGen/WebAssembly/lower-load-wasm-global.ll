...
@globalF32 = local_unnamed_addr addrspace(1) global float 0.0
@globalF64 = local_unnamed_addr addrspace(1) global double 0.0
...
define double @load_f64_from_f32() {
; CHECK-LABEL: load_f64_from_f32:
...
define float @load_f32_from_f64() {
; CHECK-LABEL: load_f32_from_f64:
