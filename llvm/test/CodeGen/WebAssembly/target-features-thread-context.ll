...
; RUN: llc < %s -mtriple=wasm32-wasip3 -mattr=-libcall-thread-context | FileCheck %s --check-prefix=EXPLICIT-DISABLE
...
; Test that wasip3 target automatically enables libcall-thread-context
...
; WASIP3-NEXT:   .int8   43
; WASIP3-NEXT:   .int8   22
; WASIP3-NEXT:   .ascii  "libcall-thread-context"
...
; EXPLICIT-DISABLE-NEXT:   .int8   22
; EXPLICIT-DISABLE-NEXT:   .ascii  "libcall-thread-context"
...
; WASIP1-NEXT:   .int8   45
; WASIP1-NEXT:   .int8   22
; WASIP1-NEXT:   .ascii  "libcall-thread-context"
...
; WASIP2-NEXT:   .int8   45
; WASIP2-NEXT:   .int8   22
; WASIP2-NEXT:   .ascii  "libcall-thread-context"
