...
; CHECK-NEXT:   call void @__gxx_wasm_personality_v0(ptr %[[EXN]]) {{.*}} [ "funclet"(token %[[CATCHPAD]]) ]
...
; CHECK-NOT:   call void @__gxx_wasm_personality_v0
...
; CHECK-DAG: declare void @__gxx_wasm_personality_v0(ptr)
