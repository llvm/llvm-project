...
; RUN: llc -mcpu=ppc -mtriple powerpc64-ibm-aix-xcoff --code-model=small < %s | FileCheck %s --check-prefix CHECK
...
; RUN: llc -filetype=obj -mcpu=ppc64 -mtriple powerpc64-ibm-aix-xcoff --code-model=small -verify-machineinstrs < %s -o %t64.o
