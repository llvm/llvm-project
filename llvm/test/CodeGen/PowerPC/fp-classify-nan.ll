...
; RUN:   -verify-machineinstrs -ppc-asm-full-reg-names | FileCheck %s --check-prefix=P8-64
...
;
; P8-64-LABEL: test_is_nan_f64:
; P8-64:       # %bb.0:
; P8-64-NEXT:    mffprd r3, f1
; P8-64-NEXT:    li r4, 2047
; P8-64-NEXT:    rldic r4, r4, 52, 1
; P8-64-NEXT:    sradi r5, r4, 63
; P8-64-NEXT:    clrldi r3, r3, 1
; P8-64-NEXT:    rldicl r6, r3, 1, 63
; P8-64-NEXT:    subc r3, r4, r3
; P8-64-NEXT:    adde r3, r6, r5
; P8-64-NEXT:    xori r3, r3, 1
; P8-64-NEXT:    blr
;
...
;
; P8-64-LABEL: test_is_not_nan_f64:
; P8-64:       # %bb.0:
; P8-64-NEXT:    mffprd r3, f1
; P8-64-NEXT:    li r4, 6143
; P8-64-NEXT:    rotldi r4, r4, 52
; P8-64-NEXT:    rldicl r5, r4, 1, 63
; P8-64-NEXT:    clrldi r3, r3, 1
; P8-64-NEXT:    sradi r6, r3, 63
; P8-64-NEXT:    subc r3, r3, r4
; P8-64-NEXT:    adde r3, r5, r6
; P8-64-NEXT:    xori r3, r3, 1
; P8-64-NEXT:    blr
;
...
;
; P8-64-LABEL: test_is_nan_f32:
; P8-64:       # %bb.0:
; P8-64-NEXT:    xscvdpspn vs0, f1
; P8-64-NEXT:    lis r4, 32640
; P8-64-NEXT:    mffprwz r3, f0
; P8-64-NEXT:    clrlwi r3, r3, 1
; P8-64-NEXT:    sub r3, r4, r3
; P8-64-NEXT:    rldicl r3, r3, 1, 63
; P8-64-NEXT:    blr
;
...
;
; P8-64-LABEL: test_is_not_nan_f32:
; P8-64:       # %bb.0:
; P8-64-NEXT:    xscvdpspn vs0, f1
; P8-64-NEXT:    lis r4, 32640
; P8-64-NEXT:    ori r4, r4, 1
; P8-64-NEXT:    mffprwz r3, f0
; P8-64-NEXT:    clrlwi r3, r3, 1
; P8-64-NEXT:    sub r3, r3, r4
; P8-64-NEXT:    rldicl r3, r3, 1, 63
; P8-64-NEXT:    blr
;
