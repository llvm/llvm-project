...
; CHECK-NEXT:    blr
  ...
  %nabs = sub i16 0, %abs
  %trunc = trunc i16 %nabs to i8
  ret i8 %trunc
}

define i16 @abd_ext_i16_to_i32(i16 %a, i16 %b) nounwind {
; CHECK-LABEL: abd_ext_i16_to_i32:
; CHECK:       # %bb.0:
...
; PPC32-NEXT:    bc 4, 20, .LBB25_6
; PPC32-NEXT:  # %bb.1:
; PPC32-NEXT:    bc 4, 20, .LBB25_7
; PPC32-NEXT:  .LBB25_2:
; PPC32-NEXT:    bc 4, 20, .LBB25_8
; PPC32-NEXT:  .LBB25_3:
; PPC32-NEXT:    bc 12, 20, .LBB25_5
; PPC32-NEXT:  .LBB25_4:
; PPC32-NEXT:    mr 6, 10
; PPC32-NEXT:  .LBB25_5:
; PPC32-NEXT:    lwz 30, 8(1) # 4-byte Folded Reload
...
; PPC32-NEXT:  .LBB25_6:
; PPC32-NEXT:    mr 3, 7
; PPC32-NEXT:    bc 12, 20, .LBB25_2
; PPC32-NEXT:  .LBB25_7:
; PPC32-NEXT:    mr 4, 8
; PPC32-NEXT:    bc 12, 20, .LBB25_3
; PPC32-NEXT:  .LBB25_8:
; PPC32-NEXT:    mr 5, 9
; PPC32-NEXT:    bc 4, 20, .LBB25_4
; PPC32-NEXT:    b .LBB25_5
;
