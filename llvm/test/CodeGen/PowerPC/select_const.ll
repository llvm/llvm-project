...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI42_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI42_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI42_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI42_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI43_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI43_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI43_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI43_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI44_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI44_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI44_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI44_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI45_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI45_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI45_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI45_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI46_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI46_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI46_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI46_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI47_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI47_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI47_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI47_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
...
; ISEL:       # %bb.0:
; ISEL-NEXT:    andi. 3, 3, 1
; ISEL-NEXT:    addis 3, 2, .LCPI49_0@toc@ha
; ISEL-NEXT:    addis 4, 2, .LCPI49_1@toc@ha
; ISEL-NEXT:    addi 3, 3, .LCPI49_0@toc@l
; ISEL-NEXT:    addi 4, 4, .LCPI49_1@toc@l
; ISEL-NEXT:    iselgt 3, 4, 3
; ISEL-NEXT:    lfd 1, 0(3)
; ISEL-NEXT:    blr
;
