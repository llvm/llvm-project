...
; LE-NEXT:    vsld 5, 2, 5
; LE-NEXT:    xxland 33, 35, 33
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    vsld 0, 2, 0
; LE-NEXT:    vcmpequd 10, 10, 4
; LE-NEXT:    vcmpequd 1, 1, 4
; LE-NEXT:    xxlandc 2, 40, 39
; LE-NEXT:    xxland 39, 35, 38
; LE-NEXT:    xxlandc 0, 41, 42
; LE-NEXT:    xxlandc 10, 34, 33
; LE-NEXT:    vsld 6, 2, 6
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    xxlxor 2, 10, 2
; LE-NEXT:    xxlandc 1, 32, 39
...
; LE-NEXT:    vsld 8, 2, 8
; LE-NEXT:    vsld 0, 2, 0
; LE-NEXT:    vcmpequd 9, 9, 4
; LE-NEXT:    vupklsw 10, 10
; LE-NEXT:    xxlandc 3, 37, 41
...
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    xxlandc 8, 38, 39
; LE-NEXT:    xxland 39, 35, 9
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    vupklsw 8, 8
; LE-NEXT:    vsld 6, 2, 8
; LE-NEXT:    xxlandc 9, 38, 39
...
; LE-NEXT:    xxland 32, 35, 1
; LE-NEXT:    vcmpequd 0, 0, 4
; LE-NEXT:    xxlandc 1, 37, 32
; LE-NEXT:    lxvd2x 37, 0, 3
...
; LE-NEXT:    vcmpequd 3, 3, 4
; LE-NEXT:    xxlandc 1, 34, 35
...
; LE-NEXT:    vsld 5, 3, 5
; LE-NEXT:    xxlandc 0, 32, 41
; LE-NEXT:    vupklsw 0, 7
; LE-NEXT:    xxland 39, 34, 33
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    xxland 32, 34, 32
; LE-NEXT:    xxlandc 1, 37, 39
; LE-NEXT:    xxland 39, 34, 38
; LE-NEXT:    vsld 5, 3, 8
; LE-NEXT:    vsld 6, 3, 6
; LE-NEXT:    vcmpequd 0, 0, 4
; LE-NEXT:    vcmpequd 7, 7, 4
; LE-NEXT:    xxlandc 13, 35, 32
; LE-NEXT:    xxlandc 2, 37, 39
; LE-NEXT:    vsld 5, 3, 1
...
; LE-NEXT:    vcmpequd 8, 8, 4
; LE-NEXT:    xxlandc 8, 38, 40
; LE-NEXT:    vsld 6, 3, 7
; LE-NEXT:    xxlandc 10, 38, 41
...
; LE-NEXT:    vsld 6, 3, 6
; LE-NEXT:    vupklsw 7, 8
; LE-NEXT:    xxlandc 11, 38, 41
; LE-NEXT:    xxland 38, 34, 12
; LE-NEXT:    vspltisw 8, 14
; LE-NEXT:    vsld 7, 3, 7
; LE-NEXT:    vcmpequd 6, 6, 4
; LE-NEXT:    xxlandc 12, 39, 38
...
; LE-NEXT:    lxvd2x 1, 0, 9
; LE-NEXT:    xxland 34, 34, 1
; LE-NEXT:    vcmpequd 2, 2, 4
; LE-NEXT:    xxlandc 1, 35, 34
; LE-NEXT:    xxlxor 0, 0, 1
; LE-NEXT:    mffprd 9, 0
; LE-NEXT:    sldi 10, 9, 1
; LE-NEXT:    rldicl 9, 9, 63, 1
...
; LE-NEXT:    vsld 0, 4, 0
; LE-NEXT:    xxlandc 0, 39, 34
; LE-NEXT:    xxland 39, 35, 33
; LE-NEXT:    vcmpequd 7, 7, 5
; LE-NEXT:    xxlandc 1, 32, 39
; LE-NEXT:    xxland 39, 35, 38
; LE-NEXT:    vsld 0, 4, 9
; LE-NEXT:    vsld 6, 4, 6
; LE-NEXT:    vcmpequd 7, 7, 5
; LE-NEXT:    xxlandc 2, 32, 39
; LE-NEXT:    vsld 0, 4, 1
; LE-NEXT:    lxvd2x 33, 0, 9
...
; LE-NEXT:    vsld 1, 4, 1
; LE-NEXT:    vcmpequd 9, 9, 5
; LE-NEXT:    xxlandc 5, 32, 41
; LE-NEXT:    lxvd2x 32, 0, 9
...
; LE-NEXT:    vcmpequd 6, 6, 5
; LE-NEXT:    xxlandc 12, 39, 38
; LE-NEXT:    xxland 38, 35, 34
; LE-NEXT:    vcmpequd 6, 6, 5
; LE-NEXT:    xxlandc 13, 36, 38
; LE-NEXT:    vupklsw 8, 8
; LE-NEXT:    vsld 7, 4, 8
; LE-NEXT:    xxlxor 0, 13, 0
; LE-NEXT:    xxlxor 0, 0, 1
...
; LE-NEXT:    vupklsw 6, 9
; LE-NEXT:    vsld 6, 4, 6
; LE-NEXT:    xxlandc 2, 38, 39
; LE-NEXT:    xxland 38, 35, 4
; LE-NEXT:    vcmpequd 6, 6, 5
; LE-NEXT:    xxlandc 4, 33, 38
; LE-NEXT:    lxvd2x 33, 0, 9
...
; LE-NEXT:    lxvd2x 1, 0, 9
; LE-NEXT:    xxland 35, 35, 1
; LE-NEXT:    vcmpequd 3, 3, 5
; LE-NEXT:    xxlandc 1, 36, 35
; LE-NEXT:    xxlxor 0, 0, 1
; LE-NEXT:    mffprd 9, 0
; LE-NEXT:    sldi 10, 9, 1
; LE-NEXT:    rldicl 9, 9, 63, 1
