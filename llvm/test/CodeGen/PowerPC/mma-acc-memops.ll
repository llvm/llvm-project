...
; RUN:   -disable-auto-paired-vec-st=false < %s | FileCheck %s \
; RUN:   --check-prefix=LE-PAIRED-PWR10
...
; RUN:   -ppc-vsr-nums-as-vr -disable-auto-paired-vec-st=false < %s | \
; RUN:   FileCheck %s --check-prefix=BE-PAIRED-PWR10
...
; LE-PAIRED-NEXT:    plxv v3, f@PCREL+64(0), 1
; LE-PAIRED-NEXT:    plxv v5, f@PCREL+96(0), 1
; LE-PAIRED-NEXT:    plxv v2, f@PCREL+80(0), 1
; LE-PAIRED-NEXT:    plxv v4, f@PCREL+112(0), 1
; LE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp36, vsp34, 0
; LE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; LE-PAIRED-NEXT:    pstxv v4, f@PCREL+176(0), 1
; LE-PAIRED-NEXT:    pstxv v5, f@PCREL+160(0), 1
; LE-PAIRED-NEXT:    pstxv v2, f@PCREL+144(0), 1
; LE-PAIRED-NEXT:    pstxv v3, f@PCREL+128(0), 1
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testLdSt:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    plxv vs3, f@PCREL+64(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs2, f@PCREL+80(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs1, f@PCREL+96(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs0, f@PCREL+112(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs0, f@PCREL+176(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs1, f@PCREL+160(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs2, f@PCREL+144(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs3, f@PCREL+128(0), 1
; LE-PAIRED-PWR10-NEXT:    blr
;
; BE-PAIRED-LABEL: testLdSt:
; BE-PAIRED:       # %bb.0: # %entry
; BE-PAIRED-NEXT:    addis r3, r2, f@toc@ha
; BE-PAIRED-NEXT:    addi r3, r3, f@toc@l
; BE-PAIRED-NEXT:    lxv v3, 112(r3)
; BE-PAIRED-NEXT:    lxv v5, 80(r3)
; BE-PAIRED-NEXT:    lxv v2, 96(r3)
; BE-PAIRED-NEXT:    lxv v4, 64(r3)
; BE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp36, vsp34, 0
; BE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; BE-PAIRED-NEXT:    stxv v5, 176(r3)
; BE-PAIRED-NEXT:    stxv v4, 160(r3)
; BE-PAIRED-NEXT:    stxv v3, 144(r3)
; BE-PAIRED-NEXT:    stxv v2, 128(r3)
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testLdSt:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r3, r2, f@toc@ha
; BE-PAIRED-PWR10-NEXT:    addi r3, r3, f@toc@l
; BE-PAIRED-PWR10-NEXT:    lxv vs3, 112(r3)
; BE-PAIRED-PWR10-NEXT:    lxv vs2, 96(r3)
; BE-PAIRED-PWR10-NEXT:    lxv vs1, 80(r3)
; BE-PAIRED-PWR10-NEXT:    lxv vs0, 64(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs1, 144(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs0, 128(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs3, 176(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs2, 160(r3)
; BE-PAIRED-PWR10-NEXT:    blr
;
...
; LE-PAIRED-NEXT:    lxv v5, 32(r6)
; LE-PAIRED-NEXT:    lxv v4, 48(r6)
; LE-PAIRED-NEXT:    sldi r3, r4, 6
; LE-PAIRED-NEXT:    add r4, r5, r3
; LE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp36, vsp34, 0
; LE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; LE-PAIRED-NEXT:    stxvx v3, r5, r3
; LE-PAIRED-NEXT:    stxv v4, 48(r4)
; LE-PAIRED-NEXT:    stxv v5, 32(r4)
; LE-PAIRED-NEXT:    stxv v2, 16(r4)
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testXLdSt:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    paddi r5, 0, f@PCREL, 1
; LE-PAIRED-PWR10-NEXT:    sldi r3, r3, 6
; LE-PAIRED-PWR10-NEXT:    add r6, r5, r3
; LE-PAIRED-PWR10-NEXT:    lxvx vs3, r5, r3
; LE-PAIRED-PWR10-NEXT:    sldi r3, r4, 6
; LE-PAIRED-PWR10-NEXT:    add r4, r5, r3
; LE-PAIRED-PWR10-NEXT:    lxv vs2, 16(r6)
; LE-PAIRED-PWR10-NEXT:    lxv vs1, 32(r6)
; LE-PAIRED-PWR10-NEXT:    lxv vs0, 48(r6)
; LE-PAIRED-PWR10-NEXT:    stxvx vs3, r5, r3
; LE-PAIRED-PWR10-NEXT:    stxv vs0, 48(r4)
; LE-PAIRED-PWR10-NEXT:    stxv vs1, 32(r4)
; LE-PAIRED-PWR10-NEXT:    stxv vs2, 16(r4)
; LE-PAIRED-PWR10-NEXT:    blr
;
...
; BE-PAIRED-NEXT:    lxv v5, 48(r6)
; BE-PAIRED-NEXT:    lxv v3, 16(r6)
; BE-PAIRED-NEXT:    lxv v4, 32(r6)
; BE-PAIRED-NEXT:    sldi r3, r4, 6
; BE-PAIRED-NEXT:    add r4, r5, r3
; BE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp34, vsp36, 0
; BE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; BE-PAIRED-NEXT:    stxvx v2, r5, r3
; BE-PAIRED-NEXT:    stxv v5, 48(r4)
; BE-PAIRED-NEXT:    stxv v4, 32(r4)
; BE-PAIRED-NEXT:    stxv v3, 16(r4)
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testXLdSt:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r5, r2, f@toc@ha
; BE-PAIRED-PWR10-NEXT:    addi r5, r5, f@toc@l
; BE-PAIRED-PWR10-NEXT:    sldi r3, r3, 6
; BE-PAIRED-PWR10-NEXT:    add r6, r5, r3
; BE-PAIRED-PWR10-NEXT:    lxv vs3, 48(r6)
; BE-PAIRED-PWR10-NEXT:    lxv vs2, 32(r6)
; BE-PAIRED-PWR10-NEXT:    lxvx vs0, r5, r3
; BE-PAIRED-PWR10-NEXT:    lxv vs1, 16(r6)
; BE-PAIRED-PWR10-NEXT:    sldi r3, r4, 6
; BE-PAIRED-PWR10-NEXT:    add r4, r5, r3
; BE-PAIRED-PWR10-NEXT:    stxvx vs0, r5, r3
; BE-PAIRED-PWR10-NEXT:    stxv vs1, 16(r4)
; BE-PAIRED-PWR10-NEXT:    stxv vs3, 48(r4)
; BE-PAIRED-PWR10-NEXT:    stxv vs2, 32(r4)
; BE-PAIRED-PWR10-NEXT:    blr
;
...
; LE-PAIRED:       # %bb.0: # %entry
; LE-PAIRED-NEXT:    plxv v3, f@PCREL+11(0), 1
; LE-PAIRED-NEXT:    plxv v5, f@PCREL+43(0), 1
; LE-PAIRED-NEXT:    plxv v2, f@PCREL+27(0), 1
; LE-PAIRED-NEXT:    plxv v4, f@PCREL+59(0), 1
; LE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp36, vsp34, 0
; LE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; LE-PAIRED-NEXT:    pstxv v4, f@PCREL+67(0), 1
; LE-PAIRED-NEXT:    pstxv v5, f@PCREL+51(0), 1
; LE-PAIRED-NEXT:    pstxv v2, f@PCREL+35(0), 1
; LE-PAIRED-NEXT:    pstxv v3, f@PCREL+19(0), 1
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testUnalignedLdSt:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    plxv vs3, f@PCREL+11(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs2, f@PCREL+27(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs1, f@PCREL+43(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs0, f@PCREL+59(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs0, f@PCREL+67(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs1, f@PCREL+51(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs2, f@PCREL+35(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs3, f@PCREL+19(0), 1
; LE-PAIRED-PWR10-NEXT:    blr
;
...
; BE-PAIRED-NEXT:    addis r3, r2, f@toc@ha
; BE-PAIRED-NEXT:    addi r3, r3, f@toc@l
; BE-PAIRED-NEXT:    plxv v3, 59(r3), 0
; BE-PAIRED-NEXT:    plxv v5, 27(r3), 0
; BE-PAIRED-NEXT:    plxv v2, 43(r3), 0
; BE-PAIRED-NEXT:    plxv v4, 11(r3), 0
; BE-PAIRED-NEXT:    dmxxinstdmr512 wacc0, vsp36, vsp34, 0
; BE-PAIRED-NEXT:    dmxxextfdmr512 vsp34, vsp36, wacc0, 0
; BE-PAIRED-NEXT:    pstxv v5, 67(r3), 0
; BE-PAIRED-NEXT:    pstxv v4, 51(r3), 0
; BE-PAIRED-NEXT:    pstxv v3, 35(r3), 0
; BE-PAIRED-NEXT:    pstxv v2, 19(r3), 0
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testUnalignedLdSt:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r3, r2, f@toc@ha
; BE-PAIRED-PWR10-NEXT:    addi r3, r3, f@toc@l
; BE-PAIRED-PWR10-NEXT:    plxv vs3, 59(r3), 0
; BE-PAIRED-PWR10-NEXT:    plxv vs2, 43(r3), 0
; BE-PAIRED-PWR10-NEXT:    plxv vs1, 27(r3), 0
; BE-PAIRED-PWR10-NEXT:    plxv vs0, 11(r3), 0
; BE-PAIRED-PWR10-NEXT:    pstxv vs1, 35(r3), 0
; BE-PAIRED-PWR10-NEXT:    pstxv vs0, 19(r3), 0
; BE-PAIRED-PWR10-NEXT:    pstxv vs3, 67(r3), 0
; BE-PAIRED-PWR10-NEXT:    pstxv vs2, 51(r3), 0
; BE-PAIRED-PWR10-NEXT:    blr
;
...
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testLdStPair:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    plxv vs0, g@PCREL+48(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs1, g@PCREL+32(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs0, g@PCREL+80(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs1, g@PCREL+64(0), 1
; LE-PAIRED-PWR10-NEXT:    blr
;
...
; BE-PAIRED-NEXT:    lxv vs0, 48(r3)
; BE-PAIRED-NEXT:    lxv vs1, 32(r3)
; BE-PAIRED-NEXT:    stxv vs0, 80(r3)
; BE-PAIRED-NEXT:    stxv vs1, 64(r3)
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testLdStPair:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r3, r2, g@toc@ha
; BE-PAIRED-PWR10-NEXT:    addi r3, r3, g@toc@l
; BE-PAIRED-PWR10-NEXT:    lxv vs0, 32(r3)
; BE-PAIRED-PWR10-NEXT:    lxv vs1, 48(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs1, 80(r3)
; BE-PAIRED-PWR10-NEXT:    stxv vs0, 64(r3)
; BE-PAIRED-PWR10-NEXT:    blr
;
...
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testXLdStPair:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    sldi r3, r3, 5
; LE-PAIRED-PWR10-NEXT:    paddi r5, 0, g@PCREL, 1
; LE-PAIRED-PWR10-NEXT:    add r6, r5, r3
; LE-PAIRED-PWR10-NEXT:    lxvx vs0, r5, r3
; LE-PAIRED-PWR10-NEXT:    sldi r3, r4, 5
; LE-PAIRED-PWR10-NEXT:    add r4, r5, r3
; LE-PAIRED-PWR10-NEXT:    lxv vs1, 16(r6)
; LE-PAIRED-PWR10-NEXT:    stxvx vs0, r5, r3
; LE-PAIRED-PWR10-NEXT:    stxv vs1, 16(r4)
; LE-PAIRED-PWR10-NEXT:    blr
;
...
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testXLdStPair:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r5, r2, g@toc@ha
; BE-PAIRED-PWR10-NEXT:    sldi r3, r3, 5
; BE-PAIRED-PWR10-NEXT:    addi r5, r5, g@toc@l
; BE-PAIRED-PWR10-NEXT:    add r6, r5, r3
; BE-PAIRED-PWR10-NEXT:    lxvx vs0, r5, r3
; BE-PAIRED-PWR10-NEXT:    sldi r3, r4, 5
; BE-PAIRED-PWR10-NEXT:    add r4, r5, r3
; BE-PAIRED-PWR10-NEXT:    lxv vs1, 16(r6)
; BE-PAIRED-PWR10-NEXT:    stxvx vs0, r5, r3
; BE-PAIRED-PWR10-NEXT:    stxv vs1, 16(r4)
...
; LE-PAIRED-NEXT:    blr
;
; LE-PAIRED-PWR10-LABEL: testUnalignedLdStPair:
; LE-PAIRED-PWR10:       # %bb.0: # %entry
; LE-PAIRED-PWR10-NEXT:    plxv vs0, g@PCREL+27(0), 1
; LE-PAIRED-PWR10-NEXT:    plxv vs1, g@PCREL+11(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs0, g@PCREL+35(0), 1
; LE-PAIRED-PWR10-NEXT:    pstxv vs1, g@PCREL+19(0), 1
; LE-PAIRED-PWR10-NEXT:    blr
;
...
; BE-PAIRED-NEXT:    addis r3, r2, g@toc@ha
; BE-PAIRED-NEXT:    addi r3, r3, g@toc@l
; BE-PAIRED-NEXT:    plxv vs0, 27(r3), 0
; BE-PAIRED-NEXT:    plxv vs1, 11(r3), 0
; BE-PAIRED-NEXT:    pstxv vs0, 35(r3), 0
; BE-PAIRED-NEXT:    pstxv vs1, 19(r3), 0
; BE-PAIRED-NEXT:    blr
;
; BE-PAIRED-PWR10-LABEL: testUnalignedLdStPair:
; BE-PAIRED-PWR10:       # %bb.0: # %entry
; BE-PAIRED-PWR10-NEXT:    addis r3, r2, g@toc@ha
; BE-PAIRED-PWR10-NEXT:    addi r3, r3, g@toc@l
; BE-PAIRED-PWR10-NEXT:    plxv vs0, 11(r3), 0
