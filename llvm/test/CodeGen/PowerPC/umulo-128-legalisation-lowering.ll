...
; PPC64-NEXT:    addic 3, 5, -1
; PPC64-NEXT:    subfe 5, 3, 5
; PPC64-NEXT:    li 7, 0
; PPC64-NEXT:    or 5, 8, 5
; PPC64-NEXT:    mulhdu 3, 4, 6
; PPC64-NEXT:    addc 3, 3, 10
; PPC64-NEXT:    addze 7, 7
; PPC64-NEXT:    rldicl 7, 7, 0, 63
...
; PPC32-NEXT:    mr 12, 5
; PPC32-NEXT:    cmpwi 2, 12, 0
; PPC32-NEXT:    mulhwu 5, 4, 10
; PPC32-NEXT:    addc 5, 5, 29
...
; PPC32-NEXT:    addc 0, 0, 28
; PPC32-NEXT:    addze 28, 7
; PPC32-NEXT:    mullw 30, 12, 9
; PPC32-NEXT:    addc 0, 30, 0
; PPC32-NEXT:    mulhwu 25, 12, 9
; PPC32-NEXT:    adde 30, 25, 28
; PPC32-NEXT:    addc 0, 0, 24
; PPC32-NEXT:    adde 30, 30, 22
; PPC32-NEXT:    addze 28, 7
; PPC32-NEXT:    andi. 28, 28, 1
; PPC32-NEXT:    crmove 28, 1
; PPC32-NEXT:    mulhwu. 28, 11, 6
; PPC32-NEXT:    mcrf 1, 0
; PPC32-NEXT:    mulhwu. 28, 12, 8
; PPC32-NEXT:    mcrf 5, 0
; PPC32-NEXT:    andi. 12, 26, 1
; PPC32-NEXT:    crmove 20, 1
; PPC32-NEXT:    crnor 21, 10, 26
; PPC32-NEXT:    cmpwi 2, 9, 0
; PPC32-NEXT:    mulhwu. 12, 3, 10
; PPC32-NEXT:    mcrf 6, 0
; PPC32-NEXT:    cmpwi 3, 0
; PPC32-NEXT:    crnor 23, 10, 2
; PPC32-NEXT:    crorc 21, 21, 6
; PPC32-NEXT:    crorc 21, 21, 22
; PPC32-NEXT:    mulhwu. 9, 9, 4
; PPC32-NEXT:    mcrf 1, 0
; PPC32-NEXT:    andi. 9, 29, 1
; PPC32-NEXT:    cror 21, 21, 20
; PPC32-NEXT:    crmove 20, 1
; PPC32-NEXT:    crorc 22, 23, 26
; PPC32-NEXT:    or. 3, 4, 3
; PPC32-NEXT:    mcrf 6, 0
; PPC32-NEXT:    crorc 22, 22, 6
; PPC32-NEXT:    or. 3, 8, 11
; PPC32-NEXT:    cror 20, 22, 20
; PPC32-NEXT:    crnor 22, 2, 26
; PPC32-NEXT:    cror 20, 22, 20
; PPC32-NEXT:    cror 20, 20, 21
; PPC32-NEXT:    crnor 20, 20, 28
