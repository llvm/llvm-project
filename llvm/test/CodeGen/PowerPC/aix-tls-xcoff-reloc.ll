...
; RELOC-NEXT:     Symbol: _$TLSML ([[#NFA+27]])
; RELOC-NEXT:     IsSigned: No
; RELOC-NEXT:     FixupBitValue: 0
; RELOC-NEXT:     Length: 16
; RELOC-NEXT:     Type: R_TOC (0x3)
...
; DIS-NEXT: {{0*}}[[#ADDR + 2]]: R_TOC (idx: [[#NFA+27]]) _$TLSML[TC]
...
; DIS-NEXT:                                      mtlr 0
; DIS-NEXT:                                      blr
; DIS:      00000040 (idx: [[#NFA+9]]) .loadsTGInit:
; DIS-NEXT:                                      mflr 0
; DIS-NEXT:                                      stwu 1, -32(1)
...
; DIS-NEXT:                                      mtlr 0
; DIS-NEXT:                                      blr
; DIS:      00000078 (idx: [[#NFA+13]]) const_ivar:
; DIS-NEXT:       78: 00 00 00 06

; DIS:      Disassembly of section .data:
; DIS:      0000007c  (idx: [[#NFA+17]]) GInit:
; DIS-NEXT:       7c: 00 00 00 01
; DIS:      00000080  (idx: [[#NFA+19]]) storesTIUninit[DS]:
; DIS-NEXT:       80: 00 00 00 00
; DIS-NEXT: 00000080: R_POS (idx: [[#NFA+7]]) .storesTIUninit
; DIS-NEXT:       84: 00 00 00 98
; DIS-NEXT: 00000084: R_POS (idx: [[#NFA+23]]) TOC[TC0]
; DIS-NEXT:       88: 00 00 00 00
; DIS:      0000008c  (idx: [[#NFA+21]]) loadsTGInit[DS]:
; DIS-NEXT:       8c: 00 00 00 40
; DIS-NEXT: 0000008c: R_POS (idx: [[#NFA+9]]) .loadsTGInit
; DIS-NEXT:       90: 00 00 00 98
; DIS-NEXT: 00000090: R_POS (idx: [[#NFA+23]]) TOC[TC0]
; DIS-NEXT:       94: 00 00 00 00
; DIS:      00000098  (idx: [[#NFA+25]]) TIUninit[TC]:
; DIS-NEXT:       98: 00 00 00 00
; DIS-NEXT: 00000098: R_TLS_LD (idx: [[#NFA+39]]) TIUninit[UL]
; DIS:      0000009c (idx: [[#NFA+27]]) _$TLSML[TC]:
; DIS-NEXT:       9c: 00 00 00 00
; DIS-NEXT: 0000009c: R_TLSML (idx: [[#NFA+27]]) _$TLSML[TC]
; DIS:      000000a0  (idx: [[#NFA+29]]) .TGInit[TC]:
; DIS-NEXT:       a0: 00 00 00 00
; DIS-NEXT: 000000a0: R_TLSM (idx: [[#NFA+37]]) TGInit
; DIS:      000000a4  (idx: [[#NFA+31]]) TGInit[TC]:
; DIS-NEXT:       a4: 00 00 00 00
; DIS-NEXT: 000000a4: R_TLS (idx: [[#NFA+37]]) TGInit
; DIS:      000000a8  (idx: [[#NFA+33]]) GInit[TC]:
; DIS-NEXT:       a8: 00 00 00 7c
; DIS-NEXT: 000000a8: R_POS (idx: [[#NFA+17]]) GInit
