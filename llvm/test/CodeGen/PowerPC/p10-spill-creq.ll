...
; CHECK-NEXT:    crand 4*cr7+gt, 4*cr2+lt, 4*cr6+un
; CHECK-NEXT:    # implicit-def: $r5
...
; CHECK-NEXT:    bc 4, 4*cr7+gt, .LBB0_18
...
; CHECK-NEXT:    crand 4*cr7+lt, 4*cr7+eq, 4*cr1+lt
...
; CHECK-NEXT:    crand 4*cr7+gt, 4*cr4+lt, 4*cr7+gt
