...
entry:
  ...
  %add = fsub nsz contract double %mul, %a
  ret double %add
}
...
; CHECK-FAST-NEXT:    blr
;
; CHECK-FAST-NOVSX-LABEL: fma_combine1_safe:
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    fneg 0, 3
; CHECK-FAST-NOVSX-NEXT:    fmsub 1, 0, 2, 1
; CHECK-FAST-NOVSX-NEXT:    blr
;
; CHECK-LABEL: fma_combine1_safe:
; CHECK:       # %bb.0: # %entry
...
; CHECK-FAST-NEXT:    blr
;
; CHECK-FAST-NOVSX-LABEL: fma_combine2_safe:
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    fneg 0, 3
; CHECK-FAST-NOVSX-NEXT:    fmsub 1, 2, 0, 1
; CHECK-FAST-NOVSX-NEXT:    blr
;
; CHECK-LABEL: fma_combine2_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xsnegdp 0, 3
...
; CHECK-FAST-NEXT:    blr
;
; CHECK-FAST-NOVSX-LABEL: fma_combine_one_use_safe:
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    fneg 0, 1
; CHECK-FAST-NOVSX-NEXT:    addis 3, 2, v@toc@ha
; CHECK-FAST-NOVSX-NEXT:    stfd 0, v@toc@l(3)
...
; CHECK-FAST-NOVSX-NEXT:    blr
;
; CHECK-LABEL: fma_combine_one_use_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xsnegdp 0, 1
; CHECK-NEXT:    addis 3, 2, v@toc@ha
; CHECK-NEXT:    stfd 0, v@toc@l(3)
...
; CHECK-NEXT:    blr
  ...
  %tmp11 = fadd nsz contract reassoc float %tmp5, 5.000000e-01
  %tmp12 = fadd nsz contract reassoc float %tmp11, %tmp10
  ret float %tmp12
}
...
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    addis 3, 2, .LCPI10_0@toc@ha
; CHECK-FAST-NOVSX-NEXT:    lfs 1, .LCPI10_0@toc@l(3)
; CHECK-FAST-NOVSX-NEXT:    blr
;
...
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    addis 3, 2, .LCPI11_0@toc@ha
; CHECK-FAST-NOVSX-NEXT:    lfs 1, .LCPI11_0@toc@l(3)
; CHECK-FAST-NOVSX-NEXT:    blr
;
...
; CHECK-FAST:       # %bb.0: # %entry
; CHECK-FAST-NEXT:    addis 3, 2, .LCPI13_0@toc@ha
; CHECK-FAST-NEXT:    lfd 0, .LCPI13_0@toc@l(3)
...
; CHECK-FAST-NOVSX:       # %bb.0: # %entry
; CHECK-FAST-NOVSX-NEXT:    addis 3, 2, .LCPI13_0@toc@ha
; CHECK-FAST-NOVSX-NEXT:    lfd 0, .LCPI13_0@toc@l(3)
...
; CHECK-NEXT:    lfd 0, .LCPI13_0@toc@l(3)
