...
define double @caller() {
  ...
  ; MIR32-NEXT:   $f1 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f2 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $v2 = lr-split XXLXORz
  ; MIR32-NEXT:   $v3 = lr-split XXLXORz
  ; MIR32-NEXT:   $v4 = lr-split XXLXORz
  ; MIR32-NEXT:   $v5 = lr-split XXLXORz
  ; MIR32-NEXT:   $v6 = lr-split XXLXORz
  ; MIR32-NEXT:   $v7 = lr-split XXLXORz
  ; MIR32-NEXT:   $v8 = lr-split XXLXORz
  ; MIR32-NEXT:   $r3 = lr-split LI 128
  ; MIR32-NEXT:   $r4 = lr-split LI 256
  ; MIR32-NEXT:   $v9 = lr-split XXLXORz
  ; MIR32-NEXT:   $v10 = lr-split XXLXORz
  ; MIR32-NEXT:   $v11 = lr-split XXLXORz
  ; MIR32-NEXT:   $v12 = lr-split XXLXORz
  ; MIR32-NEXT:   $v13 = lr-split XXLXORz
  ; MIR32-NEXT:   $f3 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f4 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f5 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f6 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f7 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f8 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f9 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f10 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f11 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f12 = lr-split XXLXORdpz
  ; MIR32-NEXT:   $f13 = lr-split XXLXORdpz
  ...
  ; MIR64-NEXT:   $f1 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f2 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $v2 = lr-split XXLXORz
  ; MIR64-NEXT:   $v3 = lr-split XXLXORz
  ; MIR64-NEXT:   $v4 = lr-split XXLXORz
  ; MIR64-NEXT:   $v5 = lr-split XXLXORz
  ; MIR64-NEXT:   $v6 = lr-split XXLXORz
  ; MIR64-NEXT:   $x3 = lr-split LI8 128
  ; MIR64-NEXT:   $x4 = lr-split LI8 256
  ; MIR64-NEXT:   $v7 = lr-split XXLXORz
  ; MIR64-NEXT:   $v8 = lr-split XXLXORz
  ; MIR64-NEXT:   $v9 = lr-split XXLXORz
  ; MIR64-NEXT:   $v10 = lr-split XXLXORz
  ; MIR64-NEXT:   $v11 = lr-split XXLXORz
  ; MIR64-NEXT:   $v12 = lr-split XXLXORz
  ; MIR64-NEXT:   $v13 = lr-split XXLXORz
  ; MIR64-NEXT:   $f3 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f4 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f5 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f6 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f7 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f8 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f9 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f10 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f11 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f12 = lr-split XXLXORdpz
  ; MIR64-NEXT:   $f13 = lr-split XXLXORdpz
