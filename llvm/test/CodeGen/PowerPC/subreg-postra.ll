...
; CHECK-NEXT:  # %bb.3: # %trace_jbd2_commit_locking.exit
; CHECK-NEXT:    bc 4, 20, .LBB0_26
; CHECK-NEXT:  # %bb.4: # %spin_unlock.exit1146
; CHECK-NEXT:    bc 4, 20, .LBB0_27
; CHECK-NEXT:  # %bb.5: # %trace_jbd2_commit_flushing.exit
; CHECK-NEXT:    bc 4, 20, .LBB0_28
; CHECK-NEXT:  # %bb.6: # %for.end.i
; CHECK-NEXT:    bc 4, 20, .LBB0_30
; CHECK-NEXT:  # %bb.7: # %journal_submit_data_buffers.exit
; CHECK-NEXT:    bc 4, 20, .LBB0_31
; CHECK-NEXT:  # %bb.8: # %if.end103
; CHECK-NEXT:    bc 4, 20, .LBB0_32
; CHECK-NEXT:  # %bb.9: # %trace_jbd2_commit_logging.exit
; CHECK-NEXT:    bc 4, 20, .LBB0_33
; CHECK-NEXT:  # %bb.10: # %for.end.i1287
; CHECK-NEXT:    bc 4, 20, .LBB0_34
; CHECK-NEXT:  # %bb.11: # %journal_finish_inode_data_buffers.exit
; CHECK-NEXT:    bc 4, 20, .LBB0_35
; CHECK-NEXT:  # %bb.12: # %if.end256
; CHECK-NEXT:    cmpdi 1, 4, 0
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_13: # %while.body318
; CHECK-NEXT:    #
; CHECK-NEXT:    bc 4, 6, .LBB0_18
; CHECK-NEXT:  # %bb.14: # %wait_on_buffer.exit
; CHECK-NEXT:    #
; CHECK-NEXT:    bc 4, 1, .LBB0_13
; CHECK-NEXT:  # %bb.15: # %do.body378
; CHECK-NEXT:    bc 4, 8, .LBB0_19
; CHECK-NEXT:  # %bb.16: # %while.end418
; CHECK-NEXT:    bc 4, 8, .LBB0_22
; CHECK-NEXT:  .LBB0_17: # %if.end421
; CHECK-NEXT:  .LBB0_18: # %if.then.i1296
; CHECK-NEXT:  .LBB0_19: # %while.body392.lr.ph
; CHECK-NEXT:    lis 26, 4
; CHECK-NEXT:    mr 27, 5
; CHECK-NEXT:    mr 28, 3
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  .LBB0_20: # %while.body392
; CHECK-NEXT:    #
; CHECK-NEXT:    ld 3, 0(3)
...
; CHECK-NEXT:    nop
; CHECK-NEXT:    bc 4, 9, .LBB0_20
; CHECK-NEXT:  # %bb.21: # %while.end418.loopexit
; CHECK-NEXT:    andi. 3, 25, 1
; CHECK-NEXT:    li 3, -5
; CHECK-NEXT:    mr 5, 27
; CHECK-NEXT:    iselgt 5, 5, 3
; CHECK-NEXT:    mr 3, 28
; CHECK-NEXT:    bc 12, 8, .LBB0_17
; CHECK-NEXT:  .LBB0_22: # %if.then420
; CHECK-NEXT:    extsw 4, 5
; CHECK-NEXT:    bl jbd2_journal_abort
; CHECK-NEXT:    nop
; CHECK-NEXT:  .LBB0_23: # %if.then5
; CHECK-NEXT:  .LBB0_24: # %do.body.i
; CHECK-NEXT:  .LBB0_25: # %do.body5.i1122
...
; CHECK-NO-ISEL-NEXT:  # %bb.3: # %trace_jbd2_commit_locking.exit
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_28
; CHECK-NO-ISEL-NEXT:  # %bb.4: # %spin_unlock.exit1146
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_29
; CHECK-NO-ISEL-NEXT:  # %bb.5: # %trace_jbd2_commit_flushing.exit
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_30
; CHECK-NO-ISEL-NEXT:  # %bb.6: # %for.end.i
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_32
; CHECK-NO-ISEL-NEXT:  # %bb.7: # %journal_submit_data_buffers.exit
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_33
; CHECK-NO-ISEL-NEXT:  # %bb.8: # %if.end103
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_34
; CHECK-NO-ISEL-NEXT:  # %bb.9: # %trace_jbd2_commit_logging.exit
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_35
; CHECK-NO-ISEL-NEXT:  # %bb.10: # %for.end.i1287
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_36
; CHECK-NO-ISEL-NEXT:  # %bb.11: # %journal_finish_inode_data_buffers.exit
; CHECK-NO-ISEL-NEXT:    bc 4, 20, .LBB0_37
; CHECK-NO-ISEL-NEXT:  # %bb.12: # %if.end256
; CHECK-NO-ISEL-NEXT:    cmpdi 1, 4, 0
; CHECK-NO-ISEL-NEXT:    .p2align 4
; CHECK-NO-ISEL-NEXT:  .LBB0_13: # %while.body318
; CHECK-NO-ISEL-NEXT:    #
; CHECK-NO-ISEL-NEXT:    bc 4, 6, .LBB0_18
; CHECK-NO-ISEL-NEXT:  # %bb.14: # %wait_on_buffer.exit
; CHECK-NO-ISEL-NEXT:    #
; CHECK-NO-ISEL-NEXT:    bc 4, 1, .LBB0_13
; CHECK-NO-ISEL-NEXT:  # %bb.15: # %do.body378
; CHECK-NO-ISEL-NEXT:    bc 4, 8, .LBB0_19
; CHECK-NO-ISEL-NEXT:  # %bb.16: # %while.end418
; CHECK-NO-ISEL-NEXT:    bc 4, 8, .LBB0_24
; CHECK-NO-ISEL-NEXT:  .LBB0_17: # %if.end421
; CHECK-NO-ISEL-NEXT:  .LBB0_18: # %if.then.i1296
; CHECK-NO-ISEL-NEXT:  .LBB0_19: # %while.body392.lr.ph
; CHECK-NO-ISEL-NEXT:    lis 26, 4
; CHECK-NO-ISEL-NEXT:    mr 27, 5
; CHECK-NO-ISEL-NEXT:    mr 28, 3
; CHECK-NO-ISEL-NEXT:    .p2align 4
; CHECK-NO-ISEL-NEXT:  .LBB0_20: # %while.body392
; CHECK-NO-ISEL-NEXT:    #
...
; CHECK-NO-ISEL-NEXT:    bc 4, 9, .LBB0_20
; CHECK-NO-ISEL-NEXT:  # %bb.21: # %while.end418.loopexit
; CHECK-NO-ISEL-NEXT:    andi. 3, 25, 1
; CHECK-NO-ISEL-NEXT:    mr 5, 27
; CHECK-NO-ISEL-NEXT:    bc 12, 1, .LBB0_23
; CHECK-NO-ISEL-NEXT:  # %bb.22: # %while.end418.loopexit
; CHECK-NO-ISEL-NEXT:    li 5, -5
; CHECK-NO-ISEL-NEXT:  .LBB0_23: # %while.end418.loopexit
; CHECK-NO-ISEL-NEXT:    mr 3, 28
; CHECK-NO-ISEL-NEXT:    bc 12, 8, .LBB0_17
; CHECK-NO-ISEL-NEXT:  .LBB0_24: # %if.then420
