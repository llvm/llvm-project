...
; RUN:   FileCheck %s
; RUN: llc -verify-machineinstrs -mtriple powerpc64-ibm-aix-xcoff -mcpu=pwr4 -mattr=-altivec --code-model=small -data-sections=false < %s |\
; RUN:   FileCheck %s
...
; RUN: llc -verify-machineinstrs -mtriple powerpc64-ibm-aix-xcoff -mcpu=ppc --code-model=small -filetype=obj %s -o %t64.o
