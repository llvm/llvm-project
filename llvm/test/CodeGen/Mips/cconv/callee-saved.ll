...
; RUN: llc -verify-machineinstrs -mtriple=mips64 -target-abi o32 < %s \
; RUN:   | FileCheck --check-prefixes=ALL,O32 %s
; RUN: llc -verify-machineinstrs -mtriple=mips64el -target-abi o32 < %s \
; RUN:   | FileCheck --check-prefixes=ALL,O32 %s
; RUN: llc -verify-machineinstrs -mtriple=mips64 -target-abi o32 < %s \
; RUN:   | FileCheck --check-prefixes=ALL,O32-INV %s
; RUN: llc -verify-machineinstrs -mtriple=mips64el -target-abi o32 < %s \
; RUN:   | FileCheck --check-prefixes=ALL,O32-INV %s
