...
; MIPS64R6O0-NEXT:    daddu $25, $2, $4
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB0_1
; MIPS64R6O0-NEXT:    nop
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    lld $2, 0($1)
; MIPS64R6O0-NEXT:    dsubu $25, $2, $4
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB1_1
; MIPS64R6O0-NEXT:    nop
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    lld $2, 0($1)
; MIPS64R6O0-NEXT:    and $25, $2, $4
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB2_1
; MIPS64R6O0-NEXT:    nop
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    lld $2, 0($1)
; MIPS64R6O0-NEXT:    or $25, $2, $4
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB3_1
; MIPS64R6O0-NEXT:    nop
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    lld $2, 0($1)
; MIPS64R6O0-NEXT:    xor $25, $2, $4
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB4_1
; MIPS64R6O0-NEXT:    nop
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    lld $2, 0($1)
; MIPS64R6O0-NEXT:    and $25, $2, $4
; MIPS64R6O0-NEXT:    nor $25, $zero, $25
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB5_1
; MIPS64R6O0-NEXT:    nop
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    scd $25, 0($1)
; MIPS64R6O0-NEXT:    beqzc $25, .LBB6_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    daddiu $sp, $sp, 16
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    ld $1, %got_disp(x)($1)
; MIPS64R6O0-NEXT:    ld $25, 16($sp) # 8-byte Folded Reload
...
; MIPS64R6O0-NEXT:    beqzc $3, .LBB7_1
