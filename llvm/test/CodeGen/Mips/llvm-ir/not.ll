...
; GP32:       # %bb.0: # %entry
; GP32-NEXT:    jr $ra
; GP32-NEXT:    xor $2, $4, 255
;
; GP64-LABEL: not_i8:
; GP64:       # %bb.0: # %entry
; GP64-NEXT:    jr $ra
; GP64-NEXT:    xor $2, $4, 255
;
; MM32r3-LABEL: not_i8:
; MM32r3:       # %bb.0: # %entry
; MM32r3-NEXT:    xor16 255, $4
; MM32r3-NEXT:    jrc $ra
;
; MM32r6-LABEL: not_i8:
; MM32r6:       # %bb.0: # %entry
; MM32r6-NEXT:    xor $2, $4, 255
; MM32r6-NEXT:    jrc $ra
entry:
  %r = xor i8 %a, -1
  ret i8 %r
...
; GP32:       # %bb.0: # %entry
; GP32-NEXT:    jr $ra
; GP32-NEXT:    xor $2, $4, 65535
;
; GP64-LABEL: not_i16:
; GP64:       # %bb.0: # %entry
; GP64-NEXT:    jr $ra
; GP64-NEXT:    xor $2, $4, 65535
;
; MM32r3-LABEL: not_i16:
; MM32r3:       # %bb.0: # %entry
; MM32r3-NEXT:    xor16 65535, $4
; MM32r3-NEXT:    jrc $ra
;
; MM32r6-LABEL: not_i16:
; MM32r6:       # %bb.0: # %entry
; MM32r6-NEXT:    xor $2, $4, 65535
; MM32r6-NEXT:    jrc $ra
entry:
  %r = xor i16 %a, -1
  ret i16 %r
