...
; RUN: llc -filetype=asm -mtriple mips64-unknown-linux -target-abi o32 \
; RUN:     %t/no-functions.ll -o - | FileCheck %s -check-prefix=NONE-ASM
...
; The FP64 default of O32 on MIPS64 would normally be spelled out with
; '.module fp=64', but there is no directive for an unset FP ABI.
; NONE-ASM-NOT: .module fp
