...
; MIPS32-NEXT:    clz $3, $3
; MIPS32-NEXT:    subu $2, $2, $3
; MIPS32-NEXT:    addiu $3, $2, 32
; MIPS32-NEXT:    not $2, $4
; MIPS32-NEXT:    addiu $8, $4, -1
; MIPS32-NEXT:    and $8, $2, $8
; MIPS32-NEXT:    ori $2, $zero, 32
; MIPS32-NEXT:    clz $8, $8
; MIPS32-NEXT:    subu $2, $2, $8
; MIPS32-NEXT:    movz $2, $3, $4
; MIPS32-NEXT:    ori $3, $zero, 0
; MIPS32-NEXT:    addiu $2, $2, 1
; MIPS32-NEXT:    sltu $7, $2, $7
; MIPS32-NEXT:    addiu $3, $3, 0
; MIPS32-NEXT:    addu $3, $3, $7
; MIPS32-NEXT:    xori $4, $4, 0
; MIPS32-NEXT:    xori $6, $6, 0
; MIPS32-NEXT:    or $4, $4, $6
; MIPS32-NEXT:    movz $2, $5, $4
