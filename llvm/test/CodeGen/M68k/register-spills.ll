...
; CHECK:         .cfi_startproc
; CHECK-NEXT:  ; %bb.0: ; %start
; CHECK-NEXT:    suba.l #140, %sp
; CHECK-NEXT:    .cfi_def_cfa_offset -144
; CHECK-NEXT:    movem.l %d2-%d7/%a2-%a4, (104,%sp) ; 40-byte Folded Spill
; CHECK-NEXT:    jsr get8
...
; CHECK-NEXT:    move.l %d0, %a3
; CHECK-NEXT:    jsr get16
; CHECK-NEXT:    movem.w %d0, (92,%sp)
; CHECK-NEXT:    jsr get8
; CHECK-NEXT:    movem.w %d0, (90,%sp)
; CHECK-NEXT:    jsr get16
; CHECK-NEXT:    movem.w %d0, (88,%sp)
; CHECK-NEXT:    jsr get32
; CHECK-NEXT:    move.l %d0, %a4
; CHECK-NEXT:    jsr get16
...
; CHECK-NEXT:    movem.w (88,%sp), %d0
; CHECK-NEXT:    move.l %a4, (72,%a0)
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    clr.w %d0
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    move.l %d0, (68,%a0)
; CHECK-NEXT:    movem.w (90,%sp), %d0
; CHECK-NEXT:    and.l #255, %d0
; CHECK-NEXT:    move.l %d0, (64,%a0)
; CHECK-NEXT:    movem.w (92,%sp), %d0
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    clr.w %d0
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    move.l %d0, (60,%a0)
; CHECK-NEXT:    movem.w (94,%sp), %d0
; CHECK-NEXT:    move.l %a3, (56,%a0)
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    clr.w %d0
; CHECK-NEXT:    swap %d0
; CHECK-NEXT:    move.l %d0, (52,%a0)
...
; CHECK-NEXT:    movem.l (104,%sp), %d2-%d7/%a2-%a4 ; 40-byte Folded Reload
; CHECK-NEXT:    adda.l #140, %sp
; CHECK-NEXT:    rts
  start:
    %r0 = call i8 @get8()
    %r1 = call i16 @get16()
