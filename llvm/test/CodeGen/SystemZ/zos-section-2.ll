...
; ESD record, type ED.
; The name is C_WSA64. This is the ED symbol for global data references.
; CHECK-NEXT: 0004b0 03 00 00 01 00 00 00 0e [[ROOTSD]] 00 00 00 00
; CHECK-NEXT: 0004c0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 0004d0 00 00 00 00 00 00 00 00 03 81 00 00 00 00 00 00
; CHECK-NEXT: 0004e0 00 00 00 00 00 00 00 00 00 00 00 00 00 04 01 00
; CHECK-NEXT: 0004f0 00 40 04 00 00 00 00 07 c3 6d e6 e2 c1 f6 f4 00

; ESD record, type LD.
; The name is test#C.
; CHECK-NEXT: 000500 03 00 00 02 [[TESTC:00 00 00 0f]] [[C_CODE64]] 00 00 00 00
; CHECK-NEXT: 000510 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000520 00 00 00 00 00 00 00 00 01 00 00 00 [[TESTS]]
; CHECK-NEXT: 000530 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 02
; CHECK-NEXT: 000540 00 01 20 00 00 00 00 06 a3 85 a2 a3 7b c3 00 00

; ESD record, type ER.
; The name is CELQSTRT.
; CHECK-NEXT: 000550 03 00 00 04 [[CELQSTRT:00 00 00 10]] [[ROOTSD]] 00 00 00 00
; CHECK-NEXT: 000560 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000570 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00
; CHECK-NEXT: 000580 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 00
; CHECK-NEXT: 000590 00 04 00 00 00 00 00 08 c3 c5 d3 d8 e2 e3 d9 e3

; Text record for the code section C_CODE64.
; The regular expression matches the lower byte of the length.
; CHECK-NEXT: 0005a0 03 10 00 00 [[C_CODE64]] 00 00 00 00 00 00 00 00
; CHECK-NEXT: 0005b0 00 00 00 00 00 00 00 {{..}} {{.*}}

; Text record for the section .&ppa2.
; CHECK:      0005f0 03 10 00 00 [[PPA2]] 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000600 00 00 00 00 00 00 00 {{..}} {{.*}}

; Text record for the section data.
; Length is 4, and the content is 0x2a = 42.
; CHECK:      000640 03 10 00 00 [[DATA_PR]] 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000650 00 00 00 00 00 00 00 04 00 00 00 2a 00 00 00 00

; There is no text record for section bss!

; Text record for the section B_IDRL.
; CHECK:      000690 03 10 00 01 [[BIDRL]] 00 00 00 00 00 00 00 00
; CHECK-NEXT: 0006a0 00 00 00 00 00 00 00 {{..}} {{.*}}

; The relocation data directory
; CHECK:      0006e0 03 20 00 00 00 40 00 00 02 00 04 00 00 00 00 00
; CHECK-NEXT: 0006f0 00 0f 00 00 00 02 00 00 00 04 60 00 00 00 04 00
; CHECK-NEXT: 000700 00 00 00 00 00 10 00 00 00 00 08 00 00 00 00 00
; CHECK-NEXT: 000710 00 0f 00 00 00 04 00 00 00 00 60 00 02 00 08 00
; CHECK-NEXT: 000720 00 00 00 00 00 10 00 00 00 00 00 00 00 00 00 00

; End record.
; CHECK:      000730 03 40 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000740 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000750 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000760 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
