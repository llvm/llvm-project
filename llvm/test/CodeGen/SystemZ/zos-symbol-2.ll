...
;  00 is version
; CHECKREL:      0006e0 03 21 00 00 00 60 00 00 02 00 04 00 00 00 00 00
; CHECKREL-NEXT: 0006f0 00 0c 00 00 00 02 00 00 00 4e 60 00 00 00 04 00
; CHECKREL-NEXT: 000700 00 00 00 00 00 0d 00 00 00 00 08 00 00 00 00 00
; CHECKREL-NEXT: 000710 00 0c 00 00 00 04 00 00 00 00 60 00 02 00 08 00
; CHECKREL-NEXT: 000720 00 00 00 00 00 0d 20 00 00 00 08 00 00 00 00 00
; Continuation of relocation data directory.
;  03 is prefix byte
;  2. is header type (RT_RLD)
;  .2 is flag (record is continuation but not continued)
;  00 is version
; CHECKREL-NEXT: 000730 03 22 00 00 07 00 00 00 09 40 00 00 00 08 00 00
; CHECKREL-NEXT: 000740 00 00 00 00 0f 00 00 00 08 00 00 00 00 00 00 00
; CHECKREL-NEXT: 000750 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECKREL-NEXT: 000760 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECKREL-NEXT: 000770 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
