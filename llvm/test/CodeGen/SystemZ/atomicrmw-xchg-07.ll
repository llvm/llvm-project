...
; HARDFP-NEXT:    lg %r1, 8(%r4)
; HARDFP-NEXT:    lg %r0, 0(%r4)
; HARDFP-NEXT:    lg %r4, 8(%r3)
; HARDFP-NEXT:    lg %r5, 0(%r3)
; HARDFP-NEXT:  .LBB0_1: # %atomicrmw.start
; HARDFP-NEXT:    # =>This Inner Loop Header: Depth=1
; HARDFP-NEXT:    lgr %r12, %r5
; HARDFP-NEXT:    lgr %r13, %r4
; HARDFP-NEXT:    cdsg %r12, %r0, 0(%r3)
; HARDFP-NEXT:    stg %r13, 168(%r15)
; HARDFP-NEXT:    stg %r12, 160(%r15)
; HARDFP-NEXT:    lgr %r4, %r13
; HARDFP-NEXT:    lgr %r5, %r12
; HARDFP-NEXT:    jl .LBB0_1
...
; SOFTFP-NEXT:    lg %r1, 8(%r4)
; SOFTFP-NEXT:    lg %r0, 0(%r4)
; SOFTFP-NEXT:    lg %r4, 8(%r3)
; SOFTFP-NEXT:    lg %r5, 0(%r3)
; SOFTFP-NEXT:  .LBB0_1: # %atomicrmw.start
; SOFTFP-NEXT:    # =>This Inner Loop Header: Depth=1
; SOFTFP-NEXT:    lgr %r12, %r5
; SOFTFP-NEXT:    lgr %r13, %r4
; SOFTFP-NEXT:    cdsg %r12, %r0, 0(%r3)
; SOFTFP-NEXT:    lgr %r4, %r13
; SOFTFP-NEXT:    lgr %r5, %r12
; SOFTFP-NEXT:    jl .LBB0_1
; SOFTFP-NEXT:  # %bb.2: # %atomicrmw.end
; SOFTFP-NEXT:    stg %r5, 0(%r2)
; SOFTFP-NEXT:    stg %r4, 8(%r2)
; SOFTFP-NEXT:    lmg %r12, %r15, 96(%r15)
; SOFTFP-NEXT:    br %r14
