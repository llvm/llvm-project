...
; CHECK-Z14-DAG:     vl %v4, 272(%r15)
; CHECK-Z14-DAG:     vl %v5, 240(%r15)
; CHECK-Z14-DAG:     vl %v6, 256(%r15)
; CHECK-Z14-DAG:     vl %v7, 224(%r15)
...
; CHECK-NEXT:    vldeb [[REG7:%v[0-9]+]], [[REG5]]
; CHECK-NEXT:    vldeb [[REG9:%v[0-9]+]], [[REG6]]
