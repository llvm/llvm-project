...
declare <16 x i8> @llvm.cttz.v16i8(<16 x i8> %src, i1 %is_zero_poison)
declare <8 x i16> @llvm.cttz.v8i16(<8 x i16> %src, i1 %is_zero_poison)
declare <4 x i32> @llvm.cttz.v4i32(<4 x i32> %src, i1 %is_zero_poison)
declare <2 x i64> @llvm.cttz.v2i64(<2 x i64> %src, i1 %is_zero_poison)
