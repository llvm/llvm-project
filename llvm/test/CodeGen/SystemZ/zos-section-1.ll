...
; CHECK-NEXT: 0002d0 03 00 00 01 [[GLOBAL:00 00 00 08]] [[ROOTSD]] 00 00 00 00
; CHECK-NEXT: 0002e0 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 0002f0 00 00 00 00 00 00 00 00 03 81 00 00 00 00 00 00
; CHECK-NEXT: 000300 00 00 00 00 00 00 00 00 00 00 00 00 00 04 01 00
; CHECK-NEXT: 000310 00 40 04 00 00 00 00 07 c3 6d e6 e2 c1 f6 f4 00

; ESD record, type LD.
; The name is test#C.
; CHECK-NEXT: 000320 03 00 00 02 [[TESTC:00 00 00 09]] [[C_CODE64]] 00 00 00 00
; CHECK-NEXT: 000330 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000340 00 00 00 00 00 00 00 00 01 00 00 00 [[TESTS]]
; CHECK-NEXT: 000350 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 02
; CHECK-NEXT: 000360 00 01 20 00 00 00 00 06 a3 85 a2 a3 7b c3 00 00

; ESD record, type ER.
; The name is CELQSTRT.
; CHECK-NEXT: 000370 03 00 00 04 [[CELQSTRT:00 00 00 0a]] [[ROOTSD]] 00 00 00 00
; CHECK-NEXT: 000380 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000390 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00
; CHECK-NEXT: 0003a0 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 00
; CHECK-NEXT: 0003b0 00 04 00 00 00 00 00 08 c3 c5 d3 d8 e2 e3 d9 e3

; ESD record, type LD.
; The name is me.
; CHECK-NEXT: 0003c0 03 00 00 02 [[ME:00 00 00 0b]] [[C_CODE64]] 00 00 00 00
; CHECK-NEXT: 0003d0 00 00 00 10 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 0003e0 00 00 00 00 00 00 00 00 01 00 00 00 [[TESTS]]
; CHECK-NEXT: 0003f0 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 02
; CHECK-NEXT: 000400 00 04 20 00 00 00 00 02 94 85 00 00 00 00 00 00

; ESD record, type ER.
; The name is other.
; CHECK-NEXT: 000410 03 00 00 04 [[OTHER:00 00 00 0c]] [[ROOTSD]] 00 00 00 00
; CHECK-NEXT: 000420 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000430 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00
; CHECK-NEXT: 000440 00 00 00 00 00 00 00 00 00 00 00 00 04 00 00 00
; CHECK-NEXT: 000450 00 04 20 00 00 00 00 05 96 a3 88 85 99 00 00 00

; Text record for the code section C_CODE64.
; The regular expression matches the lower byte of the length.
; CHECK-NEXT: 000460 03 11 00 00 [[C_CODE64]] 00 00 00 00 00 00 00 00
; CHECK-NEXT: 000470 00 00 00 00 00 00 00 {{..}} 00 c3 00 c5 00 c5 00 f1
...
; CHECK-NEXT: 000600 00 09 00 00 00 02 00 00 00 5a 60 00 00 00 04 00
; CHECK-NEXT: 000610 00 00 00 00 00 0a 00 00 00 00 08 00 00 00 00 00
; CHECK-NEXT: 000620 00 09 00 00 00 04 00 00 00 00 60 00 02 00 08 00
; CHECK-NEXT: 000630 00 00 00 00 00 0a 20 70 01 00 08 00 00 00 00 00
; Continuation of the relocation data directory.
; CHECK-NEXT: 000640 03 22 00 00 0c 00 00 00 06 c0 00 01 00 08 00 00
