...
entry:
; CHECK-LABEL: ptr32_to_ptr DS 0B
; CHECK:       llgtr 0,2
...
entry:
; CHECK-LABEL: ptr_to_ptr32 DS 0B
; CHECK:       nilh 2,32767
; CHECK-NEXT:  st   2,0(1)
...
entry:
; CHECK-LABEL: ptr32_to_ptr32 DS 0B
; CHECK:       st 2,0(1)
  %p32 = getelementptr inbounds %struct.Foo, ptr %f, i64 0, i32 0
...
entry:
; CHECK-LABEL: test_indexing DS 0B
; CHECK:       l     0,1032
; CHECK:       llgtr 0,0
; CHECK:       stg   0,16(1)
...
entry:
; CHECK-LABEL: test_indexing_2 DS 0B
; CHECK:       lhi   0,16
; CHECK-NEXT:  a     0,1032
...
entry:
; CHECK-LABEL: get_processor_count DS 0B
; CHECK: lhi 0,660
; CHECK-NEXT: a 0,16
; CHECK-NEXT: llgtr 1,0
; CHECK-NEXT: lhi 0,53
...
entry:
; CHECK-LABEL: spill_ptr32_args_to_registers DS 0B
; CHECK:         stmg 6,7,1872(4)
; CHECK-NEXT:    L#stack_update7 DS 0B
; CHECK-NEXT:    aghi 4,-192
; CHECK-NEXT:    *FENCE
; CHECK-NEXT:    L#end_of_prologue7 DS 0B
; CHECK-NEXT:    lgr 2,1
