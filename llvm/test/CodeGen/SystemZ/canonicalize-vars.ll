...
; Z16-NEXT:    .cfi_def_cfa_offset 320
...
define void @canonicalize_ptr_f16(ptr %out) {
; Z16-LABEL: canonicalize_ptr_f16:
; Z16:       # %bb.0:
; Z16-NEXT:    stmg %r13, %r15, 104(%r15)
; Z16-NEXT:    .cfi_offset %r13, -56
; Z16-NEXT:    .cfi_offset %r14, -48
; Z16-NEXT:    .cfi_offset %r15, -40
; Z16-NEXT:    aghi %r15, -160
; Z16-NEXT:    .cfi_def_cfa_offset 320
...
define <8 x half> @canonicalize_v8f16(<8 x half> %a) {
...
; Z16-NEXT:    .cfi_def_cfa_offset 384
...
; Z16-NEXT:    .cfi_offset %f9, -176
; Z16-NEXT:    .cfi_offset %f10, -184
; Z16-NEXT:    .cfi_offset %f11, -192
; Z16-NEXT:    .cfi_offset %f12, -200
; Z16-NEXT:    .cfi_offset %f13, -208
; Z16-NEXT:    .cfi_offset %f14, -216
; Z16-NEXT:    .cfi_offset %f15, -224
...
define void @canonicalize_ptr_v8f16(ptr %out) {
