...
; RUN: sed -e "s/ORDER/acquire/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 | FileCheck %s
; RUN: sed -e "s/ORDER/release/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 | FileCheck %s
; RUN: sed -e "s/ORDER/acq_rel/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 | FileCheck %s
