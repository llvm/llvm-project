; RUN: sed -e "s/ORDER/unordered/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 -disable-hexagon-amodeopt=0 | FileCheck %s
; RUN: sed -e "s/ORDER/monotonic/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 -disable-hexagon-amodeopt=0 | FileCheck %s
; RUN: sed -e "s/ORDER/acquire/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 -disable-hexagon-amodeopt=0 | FileCheck %s
; RUN: sed -e "s/ORDER/seq_cst/" %s | llc -mtriple=hexagon -hexagon-small-data-threshold=8 -disable-hexagon-amodeopt=0 | FileCheck %s
