...
;RUN: llc -mtriple=hexagon -mattr=+hvxv79,+hvx-length64b -hexagon-small-data-threshold=8 < %s -o - | FileCheck %s --check-prefix=CHECK-HVX
;RUN: llc -mtriple=hexagon -mattr=+hvxv79,+hvx-length128b -hexagon-small-data-threshold=8 < %s -o - | FileCheck %s --check-prefix=CHECK-HVX
