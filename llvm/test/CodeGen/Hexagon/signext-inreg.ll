...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r7 = extract(r11,#8,#0)
; CHECK-NEXT:     r6 = sxtb(r10)
; CHECK-NEXT:     memd(r0+#48) = r9:8
; CHECK-NEXT:     memd(r0+#40) = r13:12
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     memd(r0+#32) = r15:14
...
; CHECK-NEXT:     r13:12 = memd(r29+#88)
; CHECK-NEXT:     r15:14 = memd(r29+#80)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r13:12 = vaslh(r13:12,#8)
; CHECK-NEXT:     r15:14 = vaslh(r15:14,#8)
; CHECK-NEXT:     r11:10 = memd(r29+#72)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     r7:6 = memd(r29+#64)
; CHECK-NEXT:     memd(r0+#120) = r7:6
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     memd(r0+#104) = r13:12
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r13:12 = vaslh(r13:12,#8)
; CHECK-NEXT:     r7:6 = vasrh(r7:6,#8)
; CHECK-NEXT:     r15:14 = memd(r29+#40)
; CHECK-NEXT:     memd(r0+#96) = r15:14
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r15:14 = vaslh(r15:14,#8)
; CHECK-NEXT:     r9:8 = vasrh(r9:8,#8)
; CHECK-NEXT:     r11:10 = memd(r29+#32)
; CHECK-NEXT:     memd(r0+#88) = r11:10
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r13:12 = vasrh(r13:12,#8)
; CHECK-NEXT:     r15:14 = vasrh(r15:14,#8)
; CHECK-NEXT:     r7:6 = memd(r29+#0)
; CHECK-NEXT:     memd(r0+#80) = r7:6
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r11:10 = vaslh(r11:10,#8)
; CHECK-NEXT:     r7:6 = vaslh(r7:6,#8)
...
; CHECK-NEXT:     memd(r0+#64) = r13:12
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r13:12 = vaslh(r13:12,#8)
; CHECK-NEXT:     r3:2 = vasrh(r3:2,#8)
; CHECK-NEXT:     r15:14 = memd(r29+#8)
; CHECK-NEXT:     memd(r0+#56) = r15:14
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r15:14 = vaslh(r15:14,#8)
; CHECK-NEXT:     r9:8 = vasrh(r9:8,#8)
; CHECK-NEXT:     memd(r0+#48) = r11:10
; CHECK-NEXT:     memd(r0+#0) = r3:2
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r13:12 = vasrh(r13:12,#8)
...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r11:10 = vasrh(r15:14,#8)
