...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v10 = vsplat(r3)
; CHECK-NEXT:     r7 = #512
; CHECK-NEXT:     v3:2.h = vunpack(v0.b)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v11 = vsplat(r7)
; CHECK-NEXT:     r6 = ##-2147483648
; CHECK-NEXT:     r5 = #159
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r4 = #23
; CHECK-NEXT:     v31:30.h = vunpack(v1.b)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v3:2.w = vunpack(v2.h)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1:0.w = vunpack(v30.h)
; CHECK-NEXT:     v4.w = vabs(v2.w)
; CHECK-NEXT:     v8.w = vabs(v3.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6.w = vabs(v0.w)
; CHECK-NEXT:     v12.w = vabs(v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v7.uw = vcl0(v4.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v13.uw = vcl0(v6.uw)
; CHECK-NEXT:     v7.w = vadd(v7.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v14.uw = vcl0(v12.uw)
; CHECK-NEXT:     v13.w = vadd(v13.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v9.uw = vcl0(v8.uw)
; CHECK-NEXT:     v14.w = vadd(v14.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6 = vsplat(r6)
; CHECK-NEXT:     v16.w = vasl(v6.w,v13.w)
; CHECK-NEXT:     v9.w = vadd(v9.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12.w = vasl(v12.w,v14.w)
; CHECK-NEXT:     v20 = vand(v16,v11)
; CHECK-NEXT:     v19.w = vadd(v16.w,v10.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v15.w = vasl(v4.w,v7.w)
; CHECK-NEXT:     v4 = vxor(v4,v4)
; CHECK-NEXT:     v23.w = vadd(v12.w,v10.w)
; CHECK-NEXT:     v28 = vand(v12,v11)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v17.w = vasl(v8.w,v9.w)
; CHECK-NEXT:     q3 = vcmp.eq(v20.w,v4.w)
; CHECK-NEXT:     q2 = vcmp.gt(v16.uw,v19.uw)
; CHECK-NEXT:     q0 = vcmp.gt(v4.w,v0.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.uw = vlsr(v16.uw,r2)
; CHECK-NEXT:     v30 = vmux(q3,v4,v5)
; CHECK-NEXT:     q3 = vcmp.eq(v28.w,v4.w)
; CHECK-NEXT:     v22 = vand(v17,v11)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v16.uw = vlsr(v19.uw,r2)
; CHECK-NEXT:     v27 = vmux(q3,v4,v5)
; CHECK-NEXT:     q1 = vcmp.eq(v22.w,v4.w)
; CHECK-NEXT:     v24 = vmux(q2,v5,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v31.uw = vlsr(v23.uw,r2)
; CHECK-NEXT:     v22.w = vadd(v16.w,v30.w)
; CHECK-NEXT:     v30.w = vadd(v17.w,v10.w)
; CHECK-NEXT:     q2 = vcmp.eq(v21.w,v16.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v29.uw = vlsr(v12.uw,r2)
; CHECK-NEXT:     v28.w = vadd(v31.w,v27.w)
; CHECK-NEXT:     v10.w = vadd(v15.w,v10.w)
; CHECK-NEXT:     v11 = vand(v15,v11)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v16.uw = vlsr(v16.uw,r0)
; CHECK-NEXT:     q3 = vcmp.eq(v29.w,v31.w)
; CHECK-NEXT:     v18 = vmux(q0,v6,v4)
; CHECK-NEXT:     q0 = vcmp.gt(v4.w,v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v19.uw = vlsr(v31.uw,r0)
; CHECK-NEXT:     v26 = vmux(q1,v4,v5)
; CHECK-NEXT:     v31 = vmux(q0,v6,v4)
; CHECK-NEXT:     q0 = vcmp.gt(v15.uw,v10.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8 = vsplat(r5)
; CHECK-NEXT:     v29.uw = vlsr(v22.uw,r0)
; CHECK-NEXT:     v13.w = vsub(v24.w,v13.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v20.uw = vlsr(v28.uw,r0)
; CHECK-NEXT:     v16 = vmux(q2,v29,v16)
; CHECK-NEXT:     q2 = vcmp.gt(v12.uw,v23.uw)
; CHECK-NEXT:     v13.w = vadd(v13.w,v8.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v25.uw = vlsr(v30.uw,r2)
; CHECK-NEXT:     v19 = vmux(q3,v20,v19)
; CHECK-NEXT:     q3 = vcmp.eq(v11.w,v4.w)
; CHECK-NEXT:     v27 = vmux(q2,v5,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v10.uw = vlsr(v10.uw,r2)
; CHECK-NEXT:     q2 = vcmp.gt(v17.uw,v30.uw)
; CHECK-NEXT:     v28.w = vadd(v25.w,v26.w)
; CHECK-NEXT:     v29 = vmux(q3,v4,v5)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v17.uw = vlsr(v17.uw,r2)
; CHECK-NEXT:     v19 = vor(v31,v19)
; CHECK-NEXT:     v31 = vmux(q2,v5,v4)
; CHECK-NEXT:     v5 = vmux(q0,v5,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v24.uw = vlsr(v15.uw,r2)
; CHECK-NEXT:     v30.w = vadd(v10.w,v29.w)
; CHECK-NEXT:     v5.w = vsub(v5.w,v7.w)
; CHECK-NEXT:     v9.w = vsub(v31.w,v9.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v15.uw = vlsr(v28.uw,r0)
; CHECK-NEXT:     q3 = vcmp.eq(v17.w,v25.w)
; CHECK-NEXT:     v5.w = vadd(v5.w,v8.w)
; CHECK-NEXT:     q0 = vcmp.eq(v24.w,v10.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12.uw = vlsr(v25.uw,r0)
; CHECK-NEXT:     v21.w = vadd(v9.w,v8.w)
; CHECK-NEXT:     v11.w = vsub(v27.w,v14.w)
; CHECK-NEXT:     q2 = vcmp.gt(v4.w,v3.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v22.uw = vlsr(v30.uw,r0)
; CHECK-NEXT:     v12 = vmux(q3,v15,v12)
; CHECK-NEXT:     q3 = vcmp.gt(v4.w,v2.w)
; CHECK-NEXT:     v23 = vmux(q2,v6,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v10.uw = vlsr(v10.uw,r0)
; CHECK-NEXT:     v8.w = vadd(v11.w,v8.w)
; CHECK-NEXT:     v6 = vmux(q3,v6,v4)
; CHECK-NEXT:     v24 = vor(v23,v12)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v7.w = vasl(v21.w,r4)
; CHECK-NEXT:     v9 = vmux(q0,v22,v10)
; CHECK-NEXT:     v16 = vor(v18,v16)
; CHECK-NEXT:     q2 = vcmp.eq(v3.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.w = vasl(v5.w,r4)
; CHECK-NEXT:     v6 = vor(v6,v9)
; CHECK-NEXT:     v7 = vor(v24,v7)
; CHECK-NEXT:     q3 = vcmp.eq(v2.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v13.w = vasl(v13.w,r4)
; CHECK-NEXT:     v5 = vor(v6,v5)
; CHECK-NEXT:     v26 = vmux(q2,v4,v7)
; CHECK-NEXT:     vmem(r1+#1) = v26.new
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v25.w = vasl(v8.w,r4)
; CHECK-NEXT:     v28 = vmux(q3,v4,v5)
; CHECK-NEXT:     q2 = vcmp.eq(v1.w,v4.w)
; CHECK-NEXT:     vmem(r1+#0) = v28.new
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v27 = vor(v19,v25)
; CHECK-NEXT:     v29 = vor(v16,v13)
; CHECK-NEXT:     q3 = vcmp.eq(v0.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v30 = vmux(q2,v4,v27)
; CHECK-NEXT:     v31 = vmux(q3,v4,v29)
...
; CHECK-NEXT:     v5.w = vabs(v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12 = vsplat(r5)
; CHECK-NEXT:     q0 = vcmp.gt(v3.w,v0.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r4 = #23
; CHECK-NEXT:     v6.uw = vcl0(v4.uw)
; CHECK-NEXT:     v11 = vmux(q0,v9,v3)
; CHECK-NEXT:     q0 = vcmp.gt(v3.w,v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8.uw = vcl0(v5.uw)
; CHECK-NEXT:     v27 = vmux(q0,v9,v3)
; CHECK-NEXT:     v6.w = vadd(v6.w,v2.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8.w = vadd(v8.w,v2.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     q1 = vcmp.eq(v13.w,v3.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v14.uw = vlsr(v14.uw,r2)
; CHECK-NEXT:     q3 = vcmp.eq(v10.w,v3.w)
; CHECK-NEXT:     v22 = vmux(q2,v2,v3)
; CHECK-NEXT:     q2 = vcmp.gt(v5.uw,v7.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v7.uw = vlsr(v7.uw,r2)
; CHECK-NEXT:     v23 = vmux(q1,v3,v2)
; CHECK-NEXT:     v24 = vmux(q3,v3,v2)
; CHECK-NEXT:     v2 = vmux(q2,v2,v3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.uw = vlsr(v5.uw,r2)
; CHECK-NEXT:     v5.w = vadd(v14.w,v23.w)
; CHECK-NEXT:     v26.w = vadd(v7.w,v24.w)
; CHECK-NEXT:     v6.w = vsub(v22.w,v6.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v20.uw = vlsr(v4.uw,r2)
; CHECK-NEXT:     v2.w = vsub(v2.w,v8.w)
; CHECK-NEXT:     v6.w = vadd(v6.w,v12.w)
; CHECK-NEXT:     q3 = vcmp.eq(v21.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v25.uw = vlsr(v14.uw,r0)
; CHECK-NEXT:     v2.w = vadd(v2.w,v12.w)
; CHECK-NEXT:     q1 = vcmp.eq(v20.w,v14.w)
...
; CHECK-NEXT:     v5 = vmux(q1,v5,v25)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v4.uw = vlsr(v26.uw,r0)
...
; CHECK-NEXT:     v29 = vor(v5,v6)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v28 = vor(v4,v2)
...
; CHECK-NEXT:     v5:4.w = vunpack(v0.h)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r4 = #159
; CHECK-NEXT:     v5.w = vabs(v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8 = vsplat(r4)
; CHECK-NEXT:     v7 = vsplat(r7)
; CHECK-NEXT:     r2 = #23
; CHECK-NEXT:     q2 = vcmp.gt(v2.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6.uw = vcl0(v5.uw)
; CHECK-NEXT:     v31 = vmux(q2,v7,v2)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v0.w = vadd(v5.w,v28.w)
; CHECK-NEXT:     v3 = vand(v5,v3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.uw = vlsr(v5.uw,r6)
; CHECK-NEXT:     q0 = vcmp.eq(v3.w,v2.w)
; CHECK-NEXT:     q1 = vcmp.gt(v5.uw,v0.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v0.uw = vlsr(v0.uw,r6)
; CHECK-NEXT:     v3 = vmux(q0,v2,v1)
; CHECK-NEXT:     v1 = vmux(q1,v1,v2)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v3.w = vadd(v0.w,v3.w)
; CHECK-NEXT:     v1.w = vsub(v1.w,v6.w)
; CHECK-NEXT:     q3 = vcmp.eq(v5.w,v0.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v29.uw = vlsr(v0.uw,r0)
; CHECK-NEXT:     v1.w = vadd(v1.w,v8.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v30.uw = vlsr(v3.uw,r0)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1.w = vasl(v1.w,r2)
; CHECK-NEXT:     v0 = vmux(q3,v30,v29)
; CHECK-NEXT:     q3 = vcmp.eq(v4.w,v2.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v0 = vor(v31,v0)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     q0 = vcmp.eq(v6.h,v3.h)
; CHECK-NEXT:     q1 = vcmp.gt(v1.uh,v7.uh)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v25.uh = vlsr(v7.uh,r6)
; CHECK-NEXT:     v26 = vmux(q0,v3,v2)
...
; CHECK-NEXT:     v27 = vmux(q0,v10,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.w = vasl(v2.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6.w = vasl(v6.w,v8.w)
; CHECK-NEXT:     v11.w = vadd(v2.w,v5.w)
; CHECK-NEXT:     v12 = vand(v2,v9)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.w = vadd(v6.w,v5.w)
; CHECK-NEXT:     v9 = vand(v6,v9)
; CHECK-NEXT:     q1 = vcmp.eq(v12.w,v4.w)
; CHECK-NEXT:     q2 = vcmp.gt(v2.uw,v11.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v22.uw = vlsr(v11.uw,r2)
; CHECK-NEXT:     q3 = vcmp.eq(v9.w,v4.w)
; CHECK-NEXT:     v23 = vmux(q1,v4,v3)
; CHECK-NEXT:     v14 = vmux(q2,v3,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v24.uw = vlsr(v5.uw,r2)
; CHECK-NEXT:     v11.w = vadd(v22.w,v23.w)
; CHECK-NEXT:     q2 = vcmp.gt(v6.uw,v5.uw)
; CHECK-NEXT:     v25 = vmux(q3,v4,v3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.uw = vlsr(v2.uw,r2)
; CHECK-NEXT:     v5.w = vadd(v24.w,v25.w)
; CHECK-NEXT:     v3 = vmux(q2,v3,v4)
...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.uw = vlsr(v22.uw,r0)
...
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.uw = vlsr(v5.uw,r0)
; CHECK-NEXT:     v2 = vmux(q3,v11,v2)
; CHECK-NEXT:     q3 = vcmp.gt(v4.w,v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v26.uw = vlsr(v24.uw,r0)
; CHECK-NEXT:     v28 = vmux(q3,v10,v4)
...
; CHECK-NEXT:     q1 = vcmp.gt(v1.uw,v8.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     q2 = vcmp.eq(v1.w,v8.w)
...
; CHECK-NEXT:     v31 = vmux(q3,v13,v7)
; CHECK-NEXT:     v3 = vor(v26,v3)
; CHECK-NEXT:     q3 = vcmp.eq(v0.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v30.w = vasl(v6.w,r3)
; CHECK-NEXT:     v1 = vmux(q2,v28,v29)
; CHECK-NEXT:     q2 = vcmp.eq(v2.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.w = vasl(v4.w,r3)
; CHECK-NEXT:     v1 = vor(v31,v1)
; CHECK-NEXT:     v3 = vor(v3,v30)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1 = vor(v1,v2)
...
; CHECK-NEXT:     v8.w = vadd(v4.w,v5.w)
; CHECK-NEXT:     v4 = vxor(v4,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v29.uw = vcl0(v3.uw)
; CHECK-NEXT:     v9.w = vadd(v9.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v13.w = vasl(v0.w,v7.w)
; CHECK-NEXT:     v10.w = vadd(v29.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v11.w = vasl(v2.w,v8.w)
; CHECK-NEXT:     v24 = vand(v13,v14)
; CHECK-NEXT:     v20.w = vadd(v13.w,v6.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12.w = vasl(v3.w,v10.w)
; CHECK-NEXT:     v19 = vand(v11,v14)
; CHECK-NEXT:     q3 = vcmp.eq(v24.w,v4.w)
; CHECK-NEXT:     v18.w = vadd(v11.w,v6.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v15.w = vasl(v1.w,v9.w)
; CHECK-NEXT:     v23 = vand(v12,v14)
; CHECK-NEXT:     v22.w = vadd(v12.w,v6.w)
; CHECK-NEXT:     v30 = vmux(q3,v4,v5)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v14 = vand(v15,v14)
; CHECK-NEXT:     v6.w = vadd(v15.w,v6.w)
; CHECK-NEXT:     q2 = vcmp.eq(v19.w,v4.w)
; CHECK-NEXT:     q0 = vcmp.gt(v13.uw,v20.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.uw = vlsr(v13.uw,r2)
; CHECK-NEXT:     q3 = vcmp.eq(v14.w,v4.w)
; CHECK-NEXT:     q1 = vcmp.eq(v23.w,v4.w)
; CHECK-NEXT:     v31 = vmux(q2,v4,v5)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v14.uw = vlsr(v6.uw,r2)
; CHECK-NEXT:     v26 = vmux(q3,v4,v5)
; CHECK-NEXT:     v28 = vmux(q0,v5,v4)
; CHECK-NEXT:     q3 = vcmp.gt(v12.uw,v22.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v13.uw = vlsr(v20.uw,r2)
; CHECK-NEXT:     v29.w = vadd(v14.w,v26.w)
; CHECK-NEXT:     v7.w = vsub(v28.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v19.uw = vlsr(v18.uw,r2)
; CHECK-NEXT:     v20.w = vadd(v13.w,v30.w)
; CHECK-NEXT:     v30 = vmux(q1,v4,v5)
; CHECK-NEXT:     q1 = vcmp.gt(v11.uw,v18.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v28.uw = vlsr(v22.uw,r2)
; CHECK-NEXT:     v23.w = vadd(v19.w,v31.w)
; CHECK-NEXT:     v22 = vmux(q3,v5,v4)
; CHECK-NEXT:     q3 = vcmp.gt(v15.uw,v6.uw)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v24.uw = vlsr(v29.uw,r0)
; CHECK-NEXT:     v29 = vmux(q1,v5,v4)
; CHECK-NEXT:     v31.w = vadd(v28.w,v30.w)
; CHECK-NEXT:     v5 = vmux(q3,v5,v4)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.uw = vlsr(v23.uw,r0)
; CHECK-NEXT:     v8.w = vsub(v29.w,v8.w)
; CHECK-NEXT:     q0 = vcmp.eq(v21.w,v13.w)
; CHECK-NEXT:     v23.w = vsub(v22.w,v10.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v17.uw = vlsr(v11.uw,r2)
; CHECK-NEXT:     v6.w = vadd(v23.w,v16.w)
; CHECK-NEXT:     v5.w = vsub(v5.w,v9.w)
; CHECK-NEXT:     v8.w = vadd(v8.w,v16.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12.uw = vlsr(v12.uw,r2)
; CHECK-NEXT:     v7.w = vadd(v7.w,v16.w)
; CHECK-NEXT:     q2 = vcmp.eq(v17.w,v19.w)
; CHECK-NEXT:     v5.w = vadd(v5.w,v16.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v25.uw = vlsr(v15.uw,r2)
; CHECK-NEXT:     q3 = vcmp.eq(v12.w,v28.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v18.uw = vlsr(v19.uw,r0)
; CHECK-NEXT:     q1 = vcmp.eq(v25.w,v14.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v30.uw = vlsr(v31.uw,r0)
; CHECK-NEXT:     v23 = vmux(q2,v21,v18)
; CHECK-NEXT:     q2 = vcmp.eq(v3.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v31.uw = vlsr(v28.uw,r0)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v26.uw = vlsr(v14.uw,r0)
; CHECK-NEXT:     v9 = vmux(q3,v30,v31)
; CHECK-NEXT:     q3 = vcmp.eq(v2.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6.w = vasl(v6.w,r4)
...
; CHECK-NEXT:     v6 = vor(v9,v6)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v27.uw = vlsr(v13.uw,r0)
; CHECK-NEXT:     v25 = vor(v23,v8)
; CHECK-NEXT:     v26 = vmux(q2,v4,v6)
; CHECK-NEXT:     vmem(r1+#1) = v26.new
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v20.uw = vlsr(v20.uw,r0)
; CHECK-NEXT:     v28 = vmux(q3,v4,v25)
; CHECK-NEXT:     q2 = vcmp.eq(v1.w,v4.w)
; CHECK-NEXT:     vmem(r1+#0) = v28.new
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     q2 = vcmp.gt(v9.uw,v6.uw)
...
; CHECK-NEXT:     q1 = vcmp.eq(v12.w,v19.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
