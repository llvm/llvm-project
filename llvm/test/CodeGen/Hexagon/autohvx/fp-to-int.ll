...
; CHECK-NEXT:     r5 = #32
; CHECK-NEXT:     v7.w = vasl(v4.w,r4)
; CHECK-NEXT:     v6 = vmem(r0+#1)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8.w = vasl(v6.w,r4)
; CHECK-NEXT:     v12 = vxor(v12,v12)
; CHECK-NEXT:     v7.w = vsub(v7.w,v3.w)
...
; CHECK-NEXT:     v17.w = vsub(v9.w,v3.w)
; CHECK-NEXT:     v7.w = vsub(v10.w,v7.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.w = vasl(v4.w,r2)
; CHECK-NEXT:     v23 = vmux(q0,v3,v20)
; CHECK-NEXT:     v25 = vmux(q1,v3,v20)
; CHECK-NEXT:     v8.w = vsub(v10.w,v8.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v18.w = vasl(v6.w,r2)
; CHECK-NEXT:     v19.w = vmin(v7.w,v13.w)
; CHECK-NEXT:     v5 = vor(v5,v3)
; CHECK-NEXT:     v8.w = vmin(v8.w,v13.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v4.w = vasr(v17.w,r6)
; CHECK-NEXT:     q2 = vcmp.gt(v19.w,v12.w)
; CHECK-NEXT:     v9 = vor(v18,v3)
...
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v21.w = vasl(v0.w,r2)
; CHECK-NEXT:     v2 = vor(v2,v3)
; CHECK-NEXT:     v10.w = vmin(v10.w,v13.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v5.w = vlsr(v5.w,v19.w)
; CHECK-NEXT:     v6 = vor(v21,v3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v8.w = vlsr(v9.w,v8.w)
; CHECK-NEXT:     v22.w = vsub(v12.w,v5.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.w = vlsr(v2.w,v4.w)
; CHECK-NEXT:     v24.w = vsub(v12.w,v8.w)
; CHECK-NEXT:     v5 = vmux(q0,v22,v5)
; CHECK-NEXT:     q0 = vcmp.gt(v12.w,v1.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v6.w = vlsr(v6.w,v10.w)
; CHECK-NEXT:     v8 = vmux(q1,v24,v8)
; CHECK-NEXT:     v26.w = vsub(v12.w,v2.w)
; CHECK-NEXT:     v5 = vmux(q2,v5,v23)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1 = vmux(q3,v8,v25)
; CHECK-NEXT:     v27.w = vsub(v12.w,v6.w)
; CHECK-NEXT:     q3 = vcmp.gt(v12.w,v0.w)
; CHECK-NEXT:     v28 = vmux(q0,v3,v20)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2 = vmux(q0,v26,v2)
; CHECK-NEXT:     q2 = vcmp.gt(v4.w,v12.w)
; CHECK-NEXT:     v29 = vmux(q3,v27,v6)
; CHECK-NEXT:     v3 = vmux(q3,v3,v20)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1.h = vpack(v1.w,v5.w):sat
; CHECK-NEXT:     q3 = vcmp.gt(v10.w,v12.w)
; CHECK-NEXT:     v0 = vmux(q2,v2,v28)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v30 = vmux(q3,v29,v3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v31.h = vpack(v1.w,v0.w):sat
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v0.h = vpack(v30.w,v0.w):sat
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v1.b = vpack(v31.h,v1.h):sat
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v0.b = vpack(v31.h,v0.h):sat
; CHECK-NEXT:    }
; CHECK-NEXT:    {
...
; CHECK-NEXT:     v8.w = vasl(v4.w,r4)
; CHECK-NEXT:     v13 = vxor(v13,v13)
; CHECK-NEXT:     v0 = vmem(r0+#3)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r7 = #64
; CHECK-NEXT:     v9.w = vasl(v6.w,r4)
; CHECK-NEXT:     v8.w = vsub(v8.w,v3.w)
; CHECK-NEXT:     v1 = vmem(r0+#2)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v12.w = vasl(v0.w,r4)
; CHECK-NEXT:     q0 = vcmp.gt(v13.w,v4.w)
; CHECK-NEXT:     v9.w = vsub(v9.w,v3.w)
; CHECK-NEXT:     q3 = vcmp.gt(v13.w,v6.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r4 = #32
...
; CHECK-NEXT:     v4.w = vsub(v14.w,v20.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.w = vasl(v1.w,r2)
; CHECK-NEXT:     v22.w = vsub(v14.w,v12.w)
; CHECK-NEXT:     v4.w = vmin(v4.w,v21.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     r2 = ##2147483647
...
; CHECK-NEXT:     v5 = vmux(q1,v23,v5)
; CHECK-NEXT:     q1 = vcmp.gt(v13.w,v4.w)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v2.w = vlsr(v2.w,v4.w)
; CHECK-NEXT:     v24 = vmux(q2,v23,v7)
; CHECK-NEXT:     q2 = vcmp.gt(v13.w,v10.w)
; CHECK-NEXT:     v25 = vmux(q0,v13,v5)
; CHECK-NEXT:    }
; CHECK-NEXT:    {
; CHECK-NEXT:     v3.w = vlsr(v3.w,v10.w)
; CHECK-NEXT:     v26 = vmux(q3,v13,v24)
; CHECK-NEXT:     v2 = vmux(q1,v23,v2)
