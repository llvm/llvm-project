...
;RUN: llc -mtriple=hexagon -mattr=+hvxv79,+hvx-length64b -hexagon-small-data-threshold=8 < %s -o - | FileCheck %s --check-prefixes=CHECK-64,CHECK-64-128
;RUN: llc -mtriple=hexagon -mattr=+hvxv79,+hvx-length128b -hexagon-small-data-threshold=8 < %s -o - | FileCheck %s --check-prefixes=CHECK-128,CHECK-64-128
