...
; CHECK-NEXT:    vld $vr0, $a1, 0
; CHECK-NEXT:    vld $vr1, $a2, 0
; CHECK-NEXT:    vshuf4i.d $vr0, $vr1, 6
; CHECK-NEXT:    vst $vr0, $a0, 0
; CHECK-NEXT:    ret
  %v0 = load <16 x i8>, ptr %a0
  %v1 = load <16 x i8>, ptr %a1
...
; LA32-LABEL: select_v2f64:
; LA32:       # %bb.0:
; LA32-NEXT:    vld $vr0, $a1, 0
; LA32-NEXT:    vld $vr1, $a2, 0
; LA32-NEXT:    pcalau12i $a1, %pc_hi20(.LCPI12_0)
; LA32-NEXT:    vld $vr2, $a1, %pc_lo12(.LCPI12_0)
; LA32-NEXT:    vbitsel.v $vr0, $vr1, $vr0, $vr2
; LA32-NEXT:    vst $vr0, $a0, 0
; LA32-NEXT:    ret
;
; LA64-LABEL: select_v2f64:
; LA64:       # %bb.0:
; LA64-NEXT:    vld $vr0, $a1, 0
; LA64-NEXT:    vld $vr1, $a2, 0
; LA64-NEXT:    vshuf4i.d $vr0, $vr1, 6
; LA64-NEXT:    vst $vr0, $a0, 0
; LA64-NEXT:    ret
