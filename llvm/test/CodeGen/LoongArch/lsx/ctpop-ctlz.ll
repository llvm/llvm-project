...
define void @ctlo_v16i8(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v16i8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vld $vr0, $a0, 0
...
; CHECK-NEXT:    ret
  %v = load <16 x i8>, ptr %src
  %v.not = xor <16 x i8> %v, splat (i8 -1)
  %res = call <16 x i8> @llvm.ctlz.v16i8(<16 x i8> %v.not, i1 false)
  store <16 x i8> %res, ptr %dst
  ret void
}

define void @ctlo_v8i16(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v8i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vld $vr0, $a0, 0
...
; CHECK-NEXT:    ret
  %v = load <8 x i16>, ptr %src
  %v.not = xor <8 x i16> %v, splat (i16 -1)
  %res = call <8 x i16> @llvm.ctlz.v8i16(<8 x i16> %v.not, i1 false)
  store <8 x i16> %res, ptr %dst
  ret void
}

define void @ctlo_v4i32(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v4i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vld $vr0, $a0, 0
; CHECK-NEXT:    vrepli.b $vr1, -1
; CHECK-NEXT:    vxor.v $vr0, $vr0, $vr1
...
; CHECK-NEXT:    ret
  %v = load <4 x i32>, ptr %src
  %v.not = xor <4 x i32> %v, splat (i32 -1)
  %res = call <4 x i32> @llvm.ctlz.v4i32(<4 x i32> %v.not, i1 false)
  store <4 x i32> %res, ptr %dst
  ret void
}

define void @ctlo_v2i64(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v2i64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vld $vr0, $a0, 0
; CHECK-NEXT:    vrepli.b $vr1, -1
; CHECK-NEXT:    vxor.v $vr0, $vr0, $vr1
...
; CHECK-NEXT:    ret
  %v = load <2 x i64>, ptr %src
  %v.not = xor <2 x i64> %v, splat (i64 -1)
  %res = call <2 x i64> @llvm.ctlz.v2i64(<2 x i64> %v.not, i1 false)
  store <2 x i64> %res, ptr %dst
  ret void
}
