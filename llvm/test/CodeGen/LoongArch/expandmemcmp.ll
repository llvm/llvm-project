...
; RUN: sed 's/iGRLen/i32/g' %s | llc --mtriple=loongarch32 --mattr=+ual,-lsx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA32,LA32-UAL
; RUN: sed 's/iGRLen/i64/g' %s | llc --mtriple=loongarch64 --mattr=+ual,-lsx \
...
; RUN: sed 's/iGRLen/i32/g' %s | llc --mtriple=loongarch32 --mattr=+ual,+lasx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA32,LA32-UAL-V,LA32-UAL-LASX
; RUN: sed 's/iGRLen/i64/g' %s | llc --mtriple=loongarch64 --mattr=+ual,+lasx \
