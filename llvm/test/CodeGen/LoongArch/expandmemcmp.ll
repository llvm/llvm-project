...
; RUN: sed 's/iGRLen/i32/g' %s | opt -passes=expand-memcmp -mtriple=loongarch32 -mattr=+ual,-lsx -S | llc --mtriple=loongarch32 --mattr=+ual,-lsx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA32,LA32-UAL
; RUN: sed 's/iGRLen/i64/g' %s | opt -passes=expand-memcmp -mtriple=loongarch64 -mattr=+ual,-lsx -S | llc --mtriple=loongarch64 --mattr=+ual,-lsx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA64,LA64-UAL
; RUN: sed 's/iGRLen/i32/g' %s | opt -passes=expand-memcmp -mtriple=loongarch32 -mattr=+ual,+lsx -S | llc --mtriple=loongarch32 --mattr=+ual,+lsx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA32,LA32-UAL-V,LA32-UAL-LSX
; RUN: sed 's/iGRLen/i64/g' %s | opt -passes=expand-memcmp -mtriple=loongarch64 -mattr=+ual,+lsx -S | llc --mtriple=loongarch64 --mattr=+ual,+lsx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA64,LA64-UAL-V,LA64-UAL-LSX
; RUN: sed 's/iGRLen/i32/g' %s | opt -passes=expand-memcmp -mtriple=loongarch32 -mattr=+ual,+lasx -S | llc --mtriple=loongarch32 --mattr=+ual,+lasx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA32,LA32-UAL-V,LA32-UAL-LASX
; RUN: sed 's/iGRLen/i64/g' %s | opt -passes=expand-memcmp -mtriple=loongarch64 -mattr=+ual,+lasx -S | llc --mtriple=loongarch64 --mattr=+ual,+lasx \
; RUN:   | FileCheck %s --check-prefixes=CHECK,CHECK-UAL,LA64,LA64-UAL-V,LA64-UAL-LASX
; RUN: sed 's/iGRLen/i32/g' %s | opt -passes=expand-memcmp -mtriple=loongarch32 -mattr=-ual,-lsx -S | llc --mtriple=loongarch32 --mattr=-ual,-lsx \
...
; CHECK-UAL-LABEL: bcmp_size_1:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.bu $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.bu $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_size_2:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.hu $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.hu $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_size_3:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.hu $a2, $a0, 0
; CHECK-UAL-NEXT:    ld.hu $a3, $a1, 0
; CHECK-UAL-NEXT:    ld.bu $a0, $a0, 2
; CHECK-UAL-NEXT:    ld.bu $a1, $a1, 2
; CHECK-UAL-NEXT:    xor $a2, $a2, $a3
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    or $a0, $a2, $a0
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_size_4:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_size_5:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a2, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a3, $a1, 0
; CHECK-UAL-NEXT:    ld.bu $a0, $a0, 4
; CHECK-UAL-NEXT:    ld.bu $a1, $a1, 4
; CHECK-UAL-NEXT:    xor $a2, $a2, $a3
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    or $a0, $a2, $a0
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
...
; CHECK-UAL-LABEL: bcmp_size_6:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a2, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a3, $a1, 0
; CHECK-UAL-NEXT:    ld.hu $a0, $a0, 4
; CHECK-UAL-NEXT:    ld.hu $a1, $a1, 4
; CHECK-UAL-NEXT:    xor $a2, $a2, $a3
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    or $a0, $a2, $a0
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
...
; CHECK-UAL-LABEL: bcmp_size_7:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a2, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a3, $a1, 0
; CHECK-UAL-NEXT:    ld.w $a0, $a0, 3
; CHECK-UAL-NEXT:    ld.w $a1, $a1, 3
; CHECK-UAL-NEXT:    xor $a2, $a2, $a3
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    or $a0, $a2, $a0
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: bcmp_size_8:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a2, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a3, $a1, 0
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 4
; LA32-UAL-V-NEXT:    xor $a2, $a2, $a3
; LA32-UAL-V-NEXT:    xor $a0, $a0, $a1
; LA32-UAL-V-NEXT:    or $a0, $a2, $a0
; LA32-UAL-V-NEXT:    sltu $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: bcmp_size_8:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 0
...
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 11
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 11
; LA32-UAL-V-NEXT:    xor $a2, $a2, $a3
...
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: bcmp_size_15:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 7
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 7
...
; LA32-UAL-LSX-NEXT:    vld $vr0, $a0, 0
; LA32-UAL-LSX-NEXT:    vld $vr1, $a1, 0
; LA32-UAL-LSX-NEXT:    vld $vr2, $a0, 16
; LA32-UAL-LSX-NEXT:    vld $vr3, $a1, 16
; LA32-UAL-LSX-NEXT:    vld $vr4, $a0, 32
; LA32-UAL-LSX-NEXT:    vld $vr5, $a1, 32
; LA32-UAL-LSX-NEXT:    vld $vr6, $a0, 48
; LA32-UAL-LSX-NEXT:    vld $vr7, $a1, 48
; LA32-UAL-LSX-NEXT:    vld $vr8, $a0, 64
; LA32-UAL-LSX-NEXT:    vld $vr9, $a1, 64
; LA32-UAL-LSX-NEXT:    vld $vr10, $a0, 96
; LA32-UAL-LSX-NEXT:    vld $vr11, $a0, 111
; LA32-UAL-LSX-NEXT:    vld $vr12, $a1, 111
; LA32-UAL-LSX-NEXT:    vld $vr13, $a1, 96
; LA32-UAL-LSX-NEXT:    vld $vr14, $a0, 80
; LA32-UAL-LSX-NEXT:    vld $vr15, $a1, 80
; LA32-UAL-LSX-NEXT:    vxor.v $vr11, $vr11, $vr12
; LA32-UAL-LSX-NEXT:    vxor.v $vr10, $vr10, $vr13
; LA32-UAL-LSX-NEXT:    vor.v $vr10, $vr10, $vr11
; LA32-UAL-LSX-NEXT:    vxor.v $vr11, $vr14, $vr15
; LA32-UAL-LSX-NEXT:    vxor.v $vr8, $vr8, $vr9
; LA32-UAL-LSX-NEXT:    vor.v $vr8, $vr8, $vr11
; LA32-UAL-LSX-NEXT:    vor.v $vr8, $vr8, $vr10
; LA32-UAL-LSX-NEXT:    vxor.v $vr6, $vr6, $vr7
; LA32-UAL-LSX-NEXT:    vxor.v $vr4, $vr4, $vr5
; LA32-UAL-LSX-NEXT:    vor.v $vr4, $vr4, $vr6
; LA32-UAL-LSX-NEXT:    vxor.v $vr2, $vr2, $vr3
; LA32-UAL-LSX-NEXT:    vxor.v $vr0, $vr0, $vr1
; LA32-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr2
; LA32-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr4
; LA32-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr8
; LA32-UAL-LSX-NEXT:    vbsrl.v $vr1, $vr0, 8
; LA32-UAL-LSX-NEXT:    vor.v $vr0, $vr1, $vr0
; LA32-UAL-LSX-NEXT:    vbsrl.v $vr1, $vr0, 4
; LA32-UAL-LSX-NEXT:    vor.v $vr0, $vr1, $vr0
...
; LA64-UAL-LSX-NEXT:    vld $vr0, $a0, 0
; LA64-UAL-LSX-NEXT:    vld $vr1, $a1, 0
; LA64-UAL-LSX-NEXT:    vld $vr2, $a0, 16
; LA64-UAL-LSX-NEXT:    vld $vr3, $a1, 16
; LA64-UAL-LSX-NEXT:    vld $vr4, $a0, 32
; LA64-UAL-LSX-NEXT:    vld $vr5, $a1, 32
; LA64-UAL-LSX-NEXT:    vld $vr6, $a0, 48
; LA64-UAL-LSX-NEXT:    vld $vr7, $a1, 48
; LA64-UAL-LSX-NEXT:    vld $vr8, $a0, 64
; LA64-UAL-LSX-NEXT:    vld $vr9, $a1, 64
; LA64-UAL-LSX-NEXT:    vld $vr10, $a0, 96
; LA64-UAL-LSX-NEXT:    vld $vr11, $a0, 111
; LA64-UAL-LSX-NEXT:    vld $vr12, $a1, 111
; LA64-UAL-LSX-NEXT:    vld $vr13, $a1, 96
; LA64-UAL-LSX-NEXT:    vld $vr14, $a0, 80
; LA64-UAL-LSX-NEXT:    vld $vr15, $a1, 80
; LA64-UAL-LSX-NEXT:    vxor.v $vr11, $vr11, $vr12
; LA64-UAL-LSX-NEXT:    vxor.v $vr10, $vr10, $vr13
; LA64-UAL-LSX-NEXT:    vor.v $vr10, $vr10, $vr11
; LA64-UAL-LSX-NEXT:    vxor.v $vr11, $vr14, $vr15
; LA64-UAL-LSX-NEXT:    vxor.v $vr8, $vr8, $vr9
; LA64-UAL-LSX-NEXT:    vor.v $vr8, $vr8, $vr11
; LA64-UAL-LSX-NEXT:    vor.v $vr8, $vr8, $vr10
; LA64-UAL-LSX-NEXT:    vxor.v $vr6, $vr6, $vr7
; LA64-UAL-LSX-NEXT:    vxor.v $vr4, $vr4, $vr5
; LA64-UAL-LSX-NEXT:    vor.v $vr4, $vr4, $vr6
; LA64-UAL-LSX-NEXT:    vxor.v $vr2, $vr2, $vr3
; LA64-UAL-LSX-NEXT:    vxor.v $vr0, $vr0, $vr1
; LA64-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr2
; LA64-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr4
; LA64-UAL-LSX-NEXT:    vor.v $vr0, $vr0, $vr8
; LA64-UAL-LSX-NEXT:    vbsrl.v $vr1, $vr0, 8
; LA64-UAL-LSX-NEXT:    vor.v $vr0, $vr1, $vr0
; LA64-UAL-LSX-NEXT:    vpickve2gr.d $a0, $vr0, 0
; LA64-UAL-LSX-NEXT:    sltu $a0, $zero, $a0
...
; LA32-UAL-LSX-NEXT:    vld $vr9, $a1, 64
; LA32-UAL-LSX-NEXT:    vld $vr10, $a0, 96
; LA32-UAL-LSX-NEXT:    vld $vr11, $a0, 112
; LA32-UAL-LSX-NEXT:    vld $vr12, $a1, 112
; LA32-UAL-LSX-NEXT:    vld $vr13, $a1, 96
; LA32-UAL-LSX-NEXT:    vld $vr14, $a0, 80
; LA32-UAL-LSX-NEXT:    vld $vr15, $a1, 80
; LA32-UAL-LSX-NEXT:    vxor.v $vr11, $vr11, $vr12
...
; LA64-UAL-LSX-NEXT:    vld $vr9, $a1, 64
; LA64-UAL-LSX-NEXT:    vld $vr10, $a0, 96
; LA64-UAL-LSX-NEXT:    vld $vr11, $a0, 112
; LA64-UAL-LSX-NEXT:    vld $vr12, $a1, 112
; LA64-UAL-LSX-NEXT:    vld $vr13, $a1, 96
; LA64-UAL-LSX-NEXT:    vld $vr14, $a0, 80
; LA64-UAL-LSX-NEXT:    vld $vr15, $a1, 80
; LA64-UAL-LSX-NEXT:    vxor.v $vr11, $vr11, $vr12
...
; LA32-UAL-V-NEXT:    vor.v $vr0, $vr1, $vr0
; LA32-UAL-V-NEXT:    vpickve2gr.w $a0, $vr0, 0
; LA32-UAL-V-NEXT:    sltui $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: bcmp_eq_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    vld $vr0, $a0, 0
; LA64-UAL-V-NEXT:    vld $vr1, $a1, 0
; LA64-UAL-V-NEXT:    vxor.v $vr0, $vr0, $vr1
...
; CHECK-UAL-LABEL: bcmp_lt_zero:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    move $a0, $zero
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_le_zero:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    sltu $a0, $zero, $a0
; CHECK-UAL-NEXT:    slti $a0, $a0, 1
; CHECK-UAL-NEXT:    ret
;
...
; CHECK-UAL-LABEL: bcmp_ge_zero:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ori $a0, $zero, 1
; CHECK-UAL-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_1:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.bu $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.bu $a1, $a1, 0
; LA32-UAL-V-NEXT:    sub.w $a0, $a0, $a1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_1:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.bu $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.bu $a1, $a1, 0
; LA64-UAL-V-NEXT:    sub.d $a0, $a0, $a1
; LA64-UAL-V-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_2:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.hu $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.hu $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
; LA32-UAL-V-NEXT:    slli.w $a0, $a0, 8
; LA32-UAL-V-NEXT:    or $a0, $a0, $a2
; LA32-UAL-V-NEXT:    srli.w $a2, $a1, 8
; LA32-UAL-V-NEXT:    slli.w $a1, $a1, 8
; LA32-UAL-V-NEXT:    or $a1, $a1, $a2
; LA32-UAL-V-NEXT:    lu12i.w $a2, 15
; LA32-UAL-V-NEXT:    ori $a2, $a2, 4095
; LA32-UAL-V-NEXT:    and $a0, $a0, $a2
; LA32-UAL-V-NEXT:    and $a1, $a1, $a2
; LA32-UAL-V-NEXT:    sub.w $a0, $a0, $a1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_2:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.h $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.h $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2h $a0, $a0
; LA64-UAL-V-NEXT:    revb.2h $a1, $a1
; LA64-UAL-V-NEXT:    bstrpick.d $a0, $a0, 15, 0
; LA64-UAL-V-NEXT:    bstrpick.d $a1, $a1, 15, 0
; LA64-UAL-V-NEXT:    sub.d $a0, $a0, $a1
; LA64-UAL-V-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_3:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.bu $a2, $a0, 2
; LA32-UAL-V-NEXT:    ld.hu $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.bu $a3, $a1, 2
; LA32-UAL-V-NEXT:    ld.hu $a1, $a1, 0
; LA32-UAL-V-NEXT:    lu12i.w $a4, 15
; LA32-UAL-V-NEXT:    ori $a4, $a4, 3840
; LA32-UAL-V-NEXT:    and $a5, $a0, $a4
; LA32-UAL-V-NEXT:    or $a2, $a5, $a2
; LA32-UAL-V-NEXT:    slli.w $a2, $a2, 8
; LA32-UAL-V-NEXT:    slli.w $a0, $a0, 24
; LA32-UAL-V-NEXT:    or $a0, $a2, $a0
; LA32-UAL-V-NEXT:    and $a2, $a1, $a4
; LA32-UAL-V-NEXT:    or $a2, $a2, $a3
; LA32-UAL-V-NEXT:    slli.w $a2, $a2, 8
; LA32-UAL-V-NEXT:    slli.w $a1, $a1, 24
; LA32-UAL-V-NEXT:    or $a1, $a2, $a1
; LA32-UAL-V-NEXT:    sltu $a2, $a0, $a1
; LA32-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA32-UAL-V-NEXT:    sub.w $a0, $a0, $a2
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_3:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.bu $a2, $a0, 2
; LA64-UAL-V-NEXT:    ld.hu $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.bu $a3, $a1, 2
; LA64-UAL-V-NEXT:    ld.hu $a1, $a1, 0
; LA64-UAL-V-NEXT:    slli.d $a2, $a2, 16
; LA64-UAL-V-NEXT:    or $a0, $a0, $a2
; LA64-UAL-V-NEXT:    slli.d $a2, $a3, 16
; LA64-UAL-V-NEXT:    or $a1, $a1, $a2
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
; LA64-UAL-V-NEXT:    addi.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    revb.2w $a1, $a1
; LA64-UAL-V-NEXT:    addi.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    sltu $a2, $a0, $a1
; LA64-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA64-UAL-V-NEXT:    sub.d $a0, $a0, $a2
; LA64-UAL-V-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_4:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
; LA32-UAL-V-NEXT:    lu12i.w $a3, 15
; LA32-UAL-V-NEXT:    ori $a3, $a3, 3840
; LA32-UAL-V-NEXT:    and $a2, $a2, $a3
; LA32-UAL-V-NEXT:    srli.w $a4, $a0, 24
; LA32-UAL-V-NEXT:    or $a2, $a2, $a4
; LA32-UAL-V-NEXT:    and $a4, $a0, $a3
; LA32-UAL-V-NEXT:    slli.w $a4, $a4, 8
; LA32-UAL-V-NEXT:    slli.w $a0, $a0, 24
; LA32-UAL-V-NEXT:    or $a0, $a0, $a4
; LA32-UAL-V-NEXT:    or $a0, $a0, $a2
; LA32-UAL-V-NEXT:    srli.w $a2, $a1, 8
; LA32-UAL-V-NEXT:    and $a2, $a2, $a3
; LA32-UAL-V-NEXT:    srli.w $a4, $a1, 24
; LA32-UAL-V-NEXT:    or $a2, $a2, $a4
; LA32-UAL-V-NEXT:    and $a3, $a1, $a3
; LA32-UAL-V-NEXT:    slli.w $a3, $a3, 8
; LA32-UAL-V-NEXT:    slli.w $a1, $a1, 24
; LA32-UAL-V-NEXT:    or $a1, $a1, $a3
; LA32-UAL-V-NEXT:    or $a1, $a1, $a2
; LA32-UAL-V-NEXT:    sltu $a2, $a0, $a1
; LA32-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA32-UAL-V-NEXT:    sub.w $a0, $a0, $a2
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_4:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
; LA64-UAL-V-NEXT:    addi.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    revb.2w $a1, $a1
; LA64-UAL-V-NEXT:    addi.w $a1, $a1, 0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_5:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a2, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a3, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a4, $a2, 8
; LA32-UAL-V-NEXT:    lu12i.w $a5, 15
; LA32-UAL-V-NEXT:    ori $a5, $a5, 3840
; LA32-UAL-V-NEXT:    and $a4, $a4, $a5
; LA32-UAL-V-NEXT:    srli.w $a6, $a2, 24
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    and $a6, $a2, $a5
; LA32-UAL-V-NEXT:    slli.w $a6, $a6, 8
; LA32-UAL-V-NEXT:    slli.w $a2, $a2, 24
; LA32-UAL-V-NEXT:    or $a2, $a2, $a6
; LA32-UAL-V-NEXT:    or $a2, $a2, $a4
; LA32-UAL-V-NEXT:    srli.w $a4, $a3, 8
; LA32-UAL-V-NEXT:    and $a4, $a4, $a5
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    and $a5, $a3, $a5
; LA32-UAL-V-NEXT:    slli.w $a5, $a5, 8
; LA32-UAL-V-NEXT:    slli.w $a3, $a3, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a5
; LA32-UAL-V-NEXT:    or $a3, $a3, $a4
; LA32-UAL-V-NEXT:    bne $a2, $a3, .LBB28_2
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.bu $a0, $a0, 4
; LA32-UAL-V-NEXT:    ld.bu $a1, $a1, 4
; LA32-UAL-V-NEXT:    sub.w $a0, $a0, $a1
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB28_2: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_5:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.bu $a2, $a0, 4
; LA64-UAL-V-NEXT:    ld.wu $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.bu $a3, $a1, 4
; LA64-UAL-V-NEXT:    ld.wu $a1, $a1, 0
; LA64-UAL-V-NEXT:    slli.d $a2, $a2, 32
; LA64-UAL-V-NEXT:    or $a0, $a0, $a2
; LA64-UAL-V-NEXT:    slli.d $a2, $a3, 32
; LA64-UAL-V-NEXT:    or $a1, $a1, $a2
; LA64-UAL-V-NEXT:    revb.d $a0, $a0
; LA64-UAL-V-NEXT:    revb.d $a1, $a1
; LA64-UAL-V-NEXT:    sltu $a2, $a0, $a1
; LA64-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA64-UAL-V-NEXT:    sub.d $a0, $a0, $a2
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_6:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    lu12i.w $a2, 15
; LA32-UAL-V-NEXT:    ori $a6, $a2, 3840
; LA32-UAL-V-NEXT:    and $a5, $a5, $a6
; LA32-UAL-V-NEXT:    srli.w $a7, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a7
; LA32-UAL-V-NEXT:    and $a7, $a3, $a6
; LA32-UAL-V-NEXT:    slli.w $a7, $a7, 8
; LA32-UAL-V-NEXT:    slli.w $a3, $a3, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a7
; LA32-UAL-V-NEXT:    or $a3, $a3, $a5
; LA32-UAL-V-NEXT:    srli.w $a5, $a4, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a6
; LA32-UAL-V-NEXT:    srli.w $a7, $a4, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a7
; LA32-UAL-V-NEXT:    and $a6, $a4, $a6
; LA32-UAL-V-NEXT:    slli.w $a6, $a6, 8
; LA32-UAL-V-NEXT:    slli.w $a4, $a4, 24
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB29_3
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.hu $a0, $a0, 4
; LA32-UAL-V-NEXT:    ld.hu $a1, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a3, $a0, 8
; LA32-UAL-V-NEXT:    slli.w $a0, $a0, 8
; LA32-UAL-V-NEXT:    or $a0, $a0, $a3
; LA32-UAL-V-NEXT:    srli.w $a3, $a1, 8
; LA32-UAL-V-NEXT:    slli.w $a1, $a1, 8
; LA32-UAL-V-NEXT:    or $a1, $a1, $a3
; LA32-UAL-V-NEXT:    ori $a2, $a2, 4095
; LA32-UAL-V-NEXT:    and $a3, $a0, $a2
; LA32-UAL-V-NEXT:    and $a4, $a1, $a2
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB29_3
; LA32-UAL-V-NEXT:  # %bb.2:
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB29_3: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_6:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.hu $a2, $a0, 4
; LA64-UAL-V-NEXT:    ld.wu $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.hu $a3, $a1, 4
; LA64-UAL-V-NEXT:    ld.wu $a1, $a1, 0
; LA64-UAL-V-NEXT:    slli.d $a2, $a2, 32
; LA64-UAL-V-NEXT:    or $a0, $a0, $a2
; LA64-UAL-V-NEXT:    slli.d $a2, $a3, 32
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_7:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    lu12i.w $a2, 15
; LA32-UAL-V-NEXT:    ori $a2, $a2, 3840
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
; LA32-UAL-V-NEXT:    and $a6, $a3, $a2
; LA32-UAL-V-NEXT:    slli.w $a6, $a6, 8
; LA32-UAL-V-NEXT:    slli.w $a3, $a3, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a6
; LA32-UAL-V-NEXT:    or $a3, $a3, $a5
; LA32-UAL-V-NEXT:    srli.w $a5, $a4, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a4, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
; LA32-UAL-V-NEXT:    and $a6, $a4, $a2
; LA32-UAL-V-NEXT:    slli.w $a6, $a6, 8
; LA32-UAL-V-NEXT:    slli.w $a4, $a4, 24
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB30_3
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 3
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 3
; LA32-UAL-V-NEXT:    srli.w $a3, $a0, 8
; LA32-UAL-V-NEXT:    and $a3, $a3, $a2
; LA32-UAL-V-NEXT:    srli.w $a4, $a0, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a4
; LA32-UAL-V-NEXT:    and $a4, $a0, $a2
; LA32-UAL-V-NEXT:    slli.w $a4, $a4, 8
; LA32-UAL-V-NEXT:    slli.w $a0, $a0, 24
; LA32-UAL-V-NEXT:    or $a0, $a0, $a4
; LA32-UAL-V-NEXT:    or $a3, $a0, $a3
; LA32-UAL-V-NEXT:    srli.w $a0, $a1, 8
; LA32-UAL-V-NEXT:    and $a0, $a0, $a2
; LA32-UAL-V-NEXT:    srli.w $a4, $a1, 24
; LA32-UAL-V-NEXT:    or $a0, $a0, $a4
; LA32-UAL-V-NEXT:    and $a2, $a1, $a2
; LA32-UAL-V-NEXT:    slli.w $a2, $a2, 8
; LA32-UAL-V-NEXT:    slli.w $a1, $a1, 24
; LA32-UAL-V-NEXT:    or $a1, $a1, $a2
; LA32-UAL-V-NEXT:    or $a4, $a1, $a0
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB30_3
; LA32-UAL-V-NEXT:  # %bb.2:
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB30_3: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_7:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a2, $a2
; LA64-UAL-V-NEXT:    addi.w $a4, $a2, 0
; LA64-UAL-V-NEXT:    revb.2w $a3, $a3
; LA64-UAL-V-NEXT:    addi.w $a5, $a3, 0
; LA64-UAL-V-NEXT:    bne $a4, $a5, .LBB30_3
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 3
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 3
; LA64-UAL-V-NEXT:    revb.2w $a2, $a0
; LA64-UAL-V-NEXT:    addi.w $a0, $a2, 0
; LA64-UAL-V-NEXT:    revb.2w $a3, $a1
; LA64-UAL-V-NEXT:    addi.w $a1, $a3, 0
; LA64-UAL-V-NEXT:    bne $a0, $a1, .LBB30_3
; LA64-UAL-V-NEXT:  # %bb.2:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB30_3: # %res_block
; LA64-UAL-V-NEXT:    addi.w $a0, $a3, 0
; LA64-UAL-V-NEXT:    addi.w $a1, $a2, 0
; LA64-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_8:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB31_3
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a3, $a0, 8
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB31_3: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_8:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a0, $a0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_15:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB32_5
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB32_5
; LA32-UAL-V-NEXT:  # %bb.2: # %loadbb2
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 8
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 8
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a1, $a0
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB32_5
; LA32-UAL-V-NEXT:  # %bb.4:
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB32_5: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_15:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB32_3
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 7
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 7
; LA64-UAL-V-NEXT:    revb.d $a2, $a0
; LA64-UAL-V-NEXT:    revb.d $a3, $a1
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB32_3
; LA64-UAL-V-NEXT:  # %bb.2:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB32_3: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
;
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_16:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB33_5
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB33_5: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_16:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB33_3
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
...
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB33_3: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_31:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.3: # %loadbb3
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 12
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 12
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.4: # %loadbb4
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 16
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 16
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.5: # %loadbb5
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 20
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 20
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.6: # %loadbb6
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 24
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 24
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
; LA32-UAL-V-NEXT:    and $a5, $a5, $a2
; LA32-UAL-V-NEXT:    srli.w $a6, $a3, 24
; LA32-UAL-V-NEXT:    or $a5, $a5, $a6
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.7: # %loadbb7
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 27
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 27
; LA32-UAL-V-NEXT:    srli.w $a3, $a0, 8
; LA32-UAL-V-NEXT:    and $a3, $a3, $a2
; LA32-UAL-V-NEXT:    srli.w $a4, $a0, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a4
...
; LA32-UAL-V-NEXT:    or $a4, $a1, $a0
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB34_9
; LA32-UAL-V-NEXT:  # %bb.8:
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB34_9: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_31:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB34_5
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB34_5
; LA64-UAL-V-NEXT:  # %bb.2: # %loadbb2
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 16
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 16
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB34_5
; LA64-UAL-V-NEXT:  # %bb.3: # %loadbb3
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 23
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 23
; LA64-UAL-V-NEXT:    revb.d $a2, $a0
; LA64-UAL-V-NEXT:    revb.d $a3, $a1
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB34_5
; LA64-UAL-V-NEXT:  # %bb.4:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB34_5: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_size_32:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB35_9
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB35_9
; LA32-UAL-V-NEXT:  # %bb.7: # %loadbb7
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 28
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 28
; LA32-UAL-V-NEXT:    srli.w $a3, $a0, 8
; LA32-UAL-V-NEXT:    and $a3, $a3, $a2
; LA32-UAL-V-NEXT:    srli.w $a4, $a0, 24
; LA32-UAL-V-NEXT:    or $a3, $a3, $a4
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB35_9: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_32:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB35_5
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
...
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB35_5: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_63:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
...
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.3: # %loadbb3
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 24
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 24
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.4: # %loadbb4
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 32
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 32
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.5: # %loadbb5
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 40
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 40
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.6: # %loadbb6
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 48
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 48
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.7: # %loadbb7
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 55
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 55
; LA64-UAL-V-NEXT:    revb.d $a2, $a0
; LA64-UAL-V-NEXT:    revb.d $a3, $a1
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB36_9
; LA64-UAL-V-NEXT:  # %bb.8:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB36_9: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_size_64:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 0
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 0
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB37_9
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
...
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB37_9
; LA64-UAL-V-NEXT:  # %bb.7: # %loadbb7
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 56
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 56
; LA64-UAL-V-NEXT:    revb.d $a2, $a0
; LA64-UAL-V-NEXT:    revb.d $a3, $a1
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB37_9
; LA64-UAL-V-NEXT:  # %bb.8:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB37_9: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_eq_zero:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    vld $vr0, $a0, 0
; LA32-UAL-V-NEXT:    vld $vr1, $a1, 0
; LA32-UAL-V-NEXT:    vxor.v $vr0, $vr0, $vr1
...
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_eq_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    vld $vr0, $a0, 0
; LA64-UAL-V-NEXT:    vld $vr1, $a1, 0
; LA64-UAL-V-NEXT:    vxor.v $vr0, $vr0, $vr1
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_lt_zero:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
...
; LA32-UAL-V-NEXT:    or $a1, $a1, $a3
; LA32-UAL-V-NEXT:    or $a1, $a1, $a2
; LA32-UAL-V-NEXT:    sltu $a0, $a0, $a1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_lt_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_gt_zero:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
...
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_gt_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_le_zero:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
...
; LA32-UAL-V-NEXT:    or $a1, $a1, $a2
; LA32-UAL-V-NEXT:    sltu $a0, $a1, $a0
; LA32-UAL-V-NEXT:    xori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_le_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
...
; LA64-UAL-NEXT:    ret
;
; LA32-UAL-V-LABEL: memcmp_ge_zero:
; LA32-UAL-V:       # %bb.0: # %entry
; LA32-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA32-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA32-UAL-V-NEXT:    srli.w $a2, $a0, 8
...
; LA32-UAL-V-NEXT:    ret
;
; LA64-UAL-V-LABEL: memcmp_ge_zero:
; LA64-UAL-V:       # %bb.0: # %entry
; LA64-UAL-V-NEXT:    ld.w $a0, $a0, 0
; LA64-UAL-V-NEXT:    ld.w $a1, $a1, 0
; LA64-UAL-V-NEXT:    revb.2w $a0, $a0
