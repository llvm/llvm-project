...
; LA32-NEXT:    ret
;
; LA64-LABEL: select_v4i64:
; LA64:       # %bb.0:
; LA64-NEXT:    xvld $xr0, $a1, 0
; LA64-NEXT:    xvld $xr1, $a2, 0
; LA64-NEXT:    xvinsve0.d $xr1, $xr0, 0
...
; LA32-LABEL: select_v4f64:
; LA32:       # %bb.0:
; LA32-NEXT:    xvld $xr0, $a1, 0
; LA32-NEXT:    xvld $xr1, $a2, 0
; LA32-NEXT:    pcalau12i $a1, %pc_hi20(.LCPI11_0)
; LA32-NEXT:    xvld $xr2, $a1, %pc_lo12(.LCPI11_0)
; LA32-NEXT:    xvbitsel.v $xr0, $xr1, $xr0, $xr2
; LA32-NEXT:    xvst $xr0, $a0, 0
; LA32-NEXT:    ret
;
; LA64-LABEL: select_v4f64:
; LA64:       # %bb.0:
; LA64-NEXT:    xvld $xr0, $a1, 0
; LA64-NEXT:    xvld $xr1, $a2, 0
; LA64-NEXT:    pcalau12i $a1, %pc_hi20(.LCPI11_0)
; LA64-NEXT:    xvld $xr2, $a1, %pc_lo12(.LCPI11_0)
