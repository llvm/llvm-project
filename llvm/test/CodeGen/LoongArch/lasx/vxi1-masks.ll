...
; CHECK-NEXT:    xvpickve2gr.w $a3, $xr0, 7
; CHECK-NEXT:    xvpickve2gr.w $a4, $xr0, 5
; CHECK-NEXT:    vrepli.b $vr0, -1
; CHECK-NEXT:    vpickve2gr.h $a5, $vr0, 4
; CHECK-NEXT:    vinsgr2vr.w $vr1, $a5, 0
; CHECK-NEXT:    vinsgr2vr.w $vr1, $a4, 1
; CHECK-NEXT:    vpickve2gr.h $a4, $vr0, 6
; CHECK-NEXT:    vinsgr2vr.w $vr1, $a4, 2
; CHECK-NEXT:    vinsgr2vr.w $vr1, $a3, 3
; CHECK-NEXT:    vpickve2gr.h $a3, $vr0, 0
; CHECK-NEXT:    vinsgr2vr.w $vr2, $a3, 0
; CHECK-NEXT:    vinsgr2vr.w $vr2, $a2, 1
; CHECK-NEXT:    vpickve2gr.h $a2, $vr0, 2
; CHECK-NEXT:    vinsgr2vr.w $vr2, $a2, 2
; CHECK-NEXT:    vinsgr2vr.w $vr2, $a1, 3
; CHECK-NEXT:    xvpermi.q $xr2, $xr1, 2
; CHECK-NEXT:    xvrepli.w $xr0, 1
; CHECK-NEXT:    xvand.v $xr0, $xr2, $xr0
...
; CHECK-NEXT:    vrepli.b $vr0, -1
; CHECK-NEXT:    vpickve2gr.b $t1, $vr0, 0
; CHECK-NEXT:    vinsgr2vr.h $vr1, $t1, 0
; CHECK-NEXT:    vinsgr2vr.h $vr1, $t0, 1
; CHECK-NEXT:    vpickve2gr.b $t0, $vr0, 2
; CHECK-NEXT:    vinsgr2vr.h $vr1, $t0, 2
; CHECK-NEXT:    vinsgr2vr.h $vr1, $a7, 3
; CHECK-NEXT:    vpickve2gr.b $a7, $vr0, 4
; CHECK-NEXT:    vinsgr2vr.h $vr1, $a7, 4
; CHECK-NEXT:    vinsgr2vr.h $vr1, $a6, 5
; CHECK-NEXT:    vpickve2gr.b $a6, $vr0, 6
; CHECK-NEXT:    vinsgr2vr.h $vr1, $a6, 6
; CHECK-NEXT:    vinsgr2vr.h $vr1, $a5, 7
; CHECK-NEXT:    vpickve2gr.b $a5, $vr0, 8
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a5, 0
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a4, 1
; CHECK-NEXT:    vpickve2gr.b $a4, $vr0, 10
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a4, 2
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a3, 3
; CHECK-NEXT:    vpickve2gr.b $a3, $vr0, 12
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a3, 4
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a2, 5
; CHECK-NEXT:    ori $a2, $zero, 255
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a2, 6
; CHECK-NEXT:    vinsgr2vr.h $vr2, $a1, 7
