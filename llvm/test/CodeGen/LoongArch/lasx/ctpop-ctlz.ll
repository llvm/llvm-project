...
define void @ctlo_v32i8(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v32i8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    xvld $xr0, $a0, 0
...
; CHECK-NEXT:    ret
  %v = load <32 x i8>, ptr %src
  %v.not = xor <32 x i8> %v, splat (i8 -1)
  %res = call <32 x i8> @llvm.ctlz.v32i8(<32 x i8> %v.not, i1 false)
  store <32 x i8> %res, ptr %dst
  ret void
}

define void @ctlo_v16i16(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v16i16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    xvld $xr0, $a0, 0
...
; CHECK-NEXT:    ret
  %v = load <16 x i16>, ptr %src
  %v.not = xor <16 x i16> %v, splat (i16 -1)
  %res = call <16 x i16> @llvm.ctlz.v16i16(<16 x i16> %v.not, i1 false)
  store <16 x i16> %res, ptr %dst
  ret void
}

define void @ctlo_v8i32(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v8i32:
; CHECK:       # %bb.0:
; CHECK-NEXT:    xvld $xr0, $a0, 0
; CHECK-NEXT:    xvrepli.b $xr1, -1
; CHECK-NEXT:    xvxor.v $xr0, $xr0, $xr1
...
; CHECK-NEXT:    ret
  %v = load <8 x i32>, ptr %src
  %v.not = xor <8 x i32> %v, splat (i32 -1)
  %res = call <8 x i32> @llvm.ctlz.v8i32(<8 x i32> %v.not, i1 false)
  store <8 x i32> %res, ptr %dst
  ret void
}

define void @ctlo_v4i64(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: ctlo_v4i64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    xvld $xr0, $a0, 0
; CHECK-NEXT:    xvrepli.b $xr1, -1
; CHECK-NEXT:    xvxor.v $xr0, $xr0, $xr1
...
; CHECK-NEXT:    ret
  %v = load <4 x i64>, ptr %src
  %v.not = xor <4 x i64> %v, splat (i64 -1)
  %res = call <4 x i64> @llvm.ctlz.v4i64(<4 x i64> %v.not, i1 false)
  store <4 x i64> %res, ptr %dst
  ret void
}
