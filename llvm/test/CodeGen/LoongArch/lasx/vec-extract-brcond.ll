...
define void @extract_32xi8_br_eq_0(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: extract_32xi8_br_eq_0:
; CHECK:       # %bb.0: # %entry
...
define void @extract_8xi32_br_eq_0(ptr %src, ptr %dst) nounwind {
; CHECK-LABEL: extract_8xi32_br_eq_0:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvld $xr0, $a0, 0
...
define void @extract_4xi64_br_ne_0(ptr %src, ptr %dst) nounwind {
; LA32-LABEL: extract_4xi64_br_ne_0:
; LA32:       # %bb.0: # %entry
; LA32-NEXT:    xvld $xr0, $a0, 0
...
; LA32-NEXT:    ret
;
; LA64-LABEL: extract_4xi64_br_ne_0:
; LA64:       # %bb.0: # %entry
; LA64-NEXT:    xvld $xr0, $a0, 0
...
; LA64-NEXT:    ret
entry:
  %0 = load volatile <4 x i64>, ptr %src
  %1 = extractelement <4 x i64> %0, i64 0
  %2 = icmp ne i64 %1, 0
  br i1 %2, label %bb1, label %bb2
bb1:
  store i8 0, ptr %dst
