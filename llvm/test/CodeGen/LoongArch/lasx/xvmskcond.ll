...
define i16 @xvmsk_sle_allones_i32(<16 x i16 > %a) {
; CHECK-LABEL: xvmsk_sle_allones_i32:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvmskltz.h $xr0, $xr0
; CHECK-NEXT:    xvpickve2gr.wu $a0, $xr0, 0
; CHECK-NEXT:    xvpickve2gr.wu $a1, $xr0, 4
...
define i8 @xvmsk_sle_allones_i16(<8 x i32 > %a) {
; CHECK-LABEL: xvmsk_sle_allones_i16:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvmskltz.w $xr0, $xr0
; CHECK-NEXT:    xvpickve2gr.wu $a0, $xr0, 0
; CHECK-NEXT:    xvpickve2gr.wu $a1, $xr0, 4
...
define i4 @xvmsk_sle_allones_i64(<4 x i64 > %a) {
; CHECK-LABEL: xvmsk_sle_allones_i64:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvmskltz.d $xr0, $xr0
; CHECK-NEXT:    xvpickve2gr.wu $a0, $xr0, 0
; CHECK-NEXT:    xvpickve2gr.wu $a1, $xr0, 4
...
define i32 @xvmsk_ne_allzeros_i8(<32 x i8 > %a) {
; CHECK-LABEL: xvmsk_ne_allzeros_i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvmsknz.b $xr0, $xr0
; CHECK-NEXT:    xvpickve2gr.wu $a0, $xr0, 0
; CHECK-NEXT:    xvpickve2gr.wu $a1, $xr0, 4
...
define i32 @xvmsk_ne_allones_i8(<32 x i8 > %a) {
; CHECK-LABEL: xvmsk_ne_allones_i8:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    xvmsknz.b $xr0, $xr0
; CHECK-NEXT:    xvnor.v $xr0, $xr0, $xr0
; CHECK-NEXT:    xvpickve2gr.wu $a0, $xr0, 0
