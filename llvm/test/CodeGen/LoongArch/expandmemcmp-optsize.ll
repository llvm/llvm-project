...
; CHECK-UAL-LABEL: bcmp_eq_zero:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
; CHECK-UAL-NEXT:    sltui $a0, $a0, 1
; CHECK-UAL-NEXT:    ret
;
...
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB27_3
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
...
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB27_3: # %res_block
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB28_3
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB28_3: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
...
; LA64-UAL-V-NEXT:    bne $a4, $a5, .LBB28_3
...
; LA64-UAL-V-NEXT:    bne $a0, $a1, .LBB28_3
; LA64-UAL-V-NEXT:  # %bb.2:
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB28_3: # %res_block
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB30_5
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB30_5: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
...
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB30_3
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 7
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 7
...
; LA32-UAL-V-NEXT:    or $a4, $a4, $a6
; LA32-UAL-V-NEXT:    or $a4, $a4, $a5
; LA32-UAL-V-NEXT:    bne $a3, $a4, .LBB31_5
; LA32-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA32-UAL-V-NEXT:    ld.w $a3, $a0, 4
; LA32-UAL-V-NEXT:    ld.w $a4, $a1, 4
; LA32-UAL-V-NEXT:    srli.w $a5, $a3, 8
...
; LA32-UAL-V-NEXT:    move $a0, $zero
; LA32-UAL-V-NEXT:    ret
; LA32-UAL-V-NEXT:  .LBB31_5: # %res_block
; LA32-UAL-V-NEXT:    sltu $a0, $a3, $a4
; LA32-UAL-V-NEXT:    sub.w $a0, $zero, $a0
; LA32-UAL-V-NEXT:    ori $a0, $a0, 1
; LA32-UAL-V-NEXT:    ret
...
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB31_3
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a0, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a1, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a0
...
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB31_3: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB32_5
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
...
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB32_5: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
; LA64-UAL-V-NEXT:    revb.d $a3, $a3
; LA64-UAL-V-NEXT:    bne $a2, $a3, .LBB33_5
; LA64-UAL-V-NEXT:  # %bb.1: # %loadbb1
; LA64-UAL-V-NEXT:    ld.d $a2, $a0, 8
; LA64-UAL-V-NEXT:    ld.d $a3, $a1, 8
; LA64-UAL-V-NEXT:    revb.d $a2, $a2
...
; LA64-UAL-V-NEXT:    move $a0, $zero
; LA64-UAL-V-NEXT:    ret
; LA64-UAL-V-NEXT:  .LBB33_5: # %res_block
; LA64-UAL-V-NEXT:    sltu $a0, $a2, $a3
; LA64-UAL-V-NEXT:    sub.d $a0, $zero, $a0
; LA64-UAL-V-NEXT:    ori $a0, $a0, 1
; LA64-UAL-V-NEXT:    ret
...
; CHECK-UAL-LABEL: memcmp_eq_zero:
; CHECK-UAL:       # %bb.0: # %entry
; CHECK-UAL-NEXT:    ld.w $a0, $a0, 0
; CHECK-UAL-NEXT:    ld.w $a1, $a1, 0
; CHECK-UAL-NEXT:    xor $a0, $a0, $a1
