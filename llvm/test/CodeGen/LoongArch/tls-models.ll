...
; LA32PIC-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi0)
...
; LA32DESC-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi0)
...
; LA32PIC-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi1)
; LA32PIC-NEXT:    bl __tls_get_addr
; LA32PIC-NEXT:    ld.w $ra, $sp, 12 # 4-byte Folded Reload
; LA32PIC-NEXT:    addi.w $sp, $sp, 16
; LA32PIC-NEXT:    ret
...
; LA32DESC-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi1)
...
; LA32PIC-NEXT:    ld.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi2)
...
; LA32DESC-NEXT:    ld.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi2)
; LA32DESC-NEXT:    add.w $a0, $a0, $tp
; LA32DESC-NEXT:    ret
;
; LA64DESC-LABEL: f3:
