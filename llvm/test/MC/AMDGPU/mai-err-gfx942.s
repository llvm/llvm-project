// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx942 %s 2>&1 | FileCheck -check-prefix=GFX942 %s
...
// GFX942: :[[@LINE-1]]:{{[0-9]+}}: error: source 2 operand must not partially overlap with dst
