...
// RUN: llvm-mc -triple=amdgpu13.10 -show-encoding < %s | FileCheck -check-prefix=GFX13 %s
// RUN: llvm-mc -triple=amdgpu13.10 -show-encoding < %s | %extract-encodings | llvm-mc -triple=amdgpu13.10 -disassemble -show-encoding | FileCheck -check-prefix=GFX13 %s
