...
// RUN: not llvm-mc -triple=amdgpu11.00 -mattr=+real-true16,+wavefrontsize32 %s -filetype=null 2>&1 | FileCheck --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu11.00 -mattr=+real-true16,+wavefrontsize64 %s -filetype=null 2>&1 | FileCheck --implicit-check-not=error: %s
