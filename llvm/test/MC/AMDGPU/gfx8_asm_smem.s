...
// CHECK: s_atc_probe 0, flat_scratch, s3         ; encoding: [0x33,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, s[100:101], s3
// CHECK: s_atc_probe 0, s[100:101], s3           ; encoding: [0x32,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], 0x7ffff
// CHECK: s_atc_probe 0, s[4:5], 0x7ffff          ; encoding: [0x02,0x00,0x9a,0xc0,0xff,0xff,0x07,0x00]

s_atc_probe 0x0, s[4:5], flat_scratch_hi
// CHECK: s_atc_probe 0, s[4:5], flat_scratch_hi  ; encoding: [0x02,0x00,0x98,0xc0,0x67,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], flat_scratch_lo
// CHECK: s_atc_probe 0, s[4:5], flat_scratch_lo  ; encoding: [0x02,0x00,0x98,0xc0,0x66,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], m0
// CHECK: s_atc_probe 0, s[4:5], m0               ; encoding: [0x02,0x00,0x98,0xc0,0x7c,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], s101
// CHECK: s_atc_probe 0, s[4:5], s101             ; encoding: [0x02,0x00,0x98,0xc0,0x65,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], s3
// CHECK: s_atc_probe 0, s[4:5], s3               ; encoding: [0x02,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], tba_hi
// CHECK: s_atc_probe 0, s[4:5], tba_hi           ; encoding: [0x02,0x00,0x98,0xc0,0x6d,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], tba_lo
// CHECK: s_atc_probe 0, s[4:5], tba_lo           ; encoding: [0x02,0x00,0x98,0xc0,0x6c,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], tma_hi
// CHECK: s_atc_probe 0, s[4:5], tma_hi           ; encoding: [0x02,0x00,0x98,0xc0,0x6f,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], tma_lo
// CHECK: s_atc_probe 0, s[4:5], tma_lo           ; encoding: [0x02,0x00,0x98,0xc0,0x6e,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], ttmp11
// CHECK: s_atc_probe 0, s[4:5], ttmp11           ; encoding: [0x02,0x00,0x98,0xc0,0x7b,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], vcc_hi
// CHECK: s_atc_probe 0, s[4:5], vcc_hi           ; encoding: [0x02,0x00,0x98,0xc0,0x6b,0x00,0x00,0x00]

s_atc_probe 0x0, s[4:5], vcc_lo
// CHECK: s_atc_probe 0, s[4:5], vcc_lo           ; encoding: [0x02,0x00,0x98,0xc0,0x6a,0x00,0x00,0x00]

s_atc_probe 0x0, s[6:7], s3
// CHECK: s_atc_probe 0, s[6:7], s3               ; encoding: [0x03,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, tba, s3
// CHECK: s_atc_probe 0, tba, s3                  ; encoding: [0x36,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, tma, s3
// CHECK: s_atc_probe 0, tma, s3                  ; encoding: [0x37,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, ttmp[10:11], s3
// CHECK: s_atc_probe 0, ttmp[10:11], s3          ; encoding: [0x3d,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x0, vcc, s3
// CHECK: s_atc_probe 0, vcc, s3                  ; encoding: [0x35,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x1, s[4:5], s3
// CHECK: s_atc_probe 1, s[4:5], s3               ; encoding: [0x42,0x00,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe 0x7, s[4:5], s3
// CHECK: s_atc_probe 7, s[4:5], s3               ; encoding: [0xc2,0x01,0x98,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[12:15], s3
// CHECK: s_atc_probe_buffer 0, s[12:15], s3      ; encoding: [0x06,0x00,0x9c,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], 0x7ffff
// CHECK: s_atc_probe_buffer 0, s[8:11], 0x7ffff  ; encoding: [0x04,0x00,0x9e,0xc0,0xff,0xff,0x07,0x00]

s_atc_probe_buffer 0x0, s[8:11], flat_scratch_hi
// CHECK: s_atc_probe_buffer 0, s[8:11], flat_scratch_hi ; encoding: [0x04,0x00,0x9c,0xc0,0x67,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], flat_scratch_lo
// CHECK: s_atc_probe_buffer 0, s[8:11], flat_scratch_lo ; encoding: [0x04,0x00,0x9c,0xc0,0x66,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], m0
// CHECK: s_atc_probe_buffer 0, s[8:11], m0       ; encoding: [0x04,0x00,0x9c,0xc0,0x7c,0x00,0x00,0x00]
...
// CHECK: s_atc_probe_buffer 0, s[8:11], s3       ; encoding: [0x04,0x00,0x9c,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], tba_hi
// CHECK: s_atc_probe_buffer 0, s[8:11], tba_hi   ; encoding: [0x04,0x00,0x9c,0xc0,0x6d,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], tba_lo
// CHECK: s_atc_probe_buffer 0, s[8:11], tba_lo   ; encoding: [0x04,0x00,0x9c,0xc0,0x6c,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], tma_hi
// CHECK: s_atc_probe_buffer 0, s[8:11], tma_hi   ; encoding: [0x04,0x00,0x9c,0xc0,0x6f,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], tma_lo
// CHECK: s_atc_probe_buffer 0, s[8:11], tma_lo   ; encoding: [0x04,0x00,0x9c,0xc0,0x6e,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], ttmp11
// CHECK: s_atc_probe_buffer 0, s[8:11], ttmp11   ; encoding: [0x04,0x00,0x9c,0xc0,0x7b,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], vcc_hi
// CHECK: s_atc_probe_buffer 0, s[8:11], vcc_hi   ; encoding: [0x04,0x00,0x9c,0xc0,0x6b,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[8:11], vcc_lo
// CHECK: s_atc_probe_buffer 0, s[8:11], vcc_lo   ; encoding: [0x04,0x00,0x9c,0xc0,0x6a,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, s[96:99], s3
// CHECK: s_atc_probe_buffer 0, s[96:99], s3      ; encoding: [0x30,0x00,0x9c,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x0, ttmp[8:11], s3
// CHECK: s_atc_probe_buffer 0, ttmp[8:11], s3    ; encoding: [0x3c,0x00,0x9c,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x1, s[8:11], s3
// CHECK: s_atc_probe_buffer 1, s[8:11], s3       ; encoding: [0x44,0x00,0x9c,0xc0,0x03,0x00,0x00,0x00]

s_atc_probe_buffer 0x7, s[8:11], s3
// CHECK: s_atc_probe_buffer 7, s[8:11], s3       ; encoding: [0xc4,0x01,0x9c,0xc0,0x03,0x00,0x00,0x00]
