...
// GFX1210: v_mul_u64_e64 v[4:5], v[2:3], v[8:9] clamp ; encoding: [0x04,0x80,0x2a,0xd5,0x02,0x11,0x02,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], v[2:3], v[4:5]    ; encoding: [0x02,0x09,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[254:255], v[2:3], v[4:5]
// GFX1210: v_mul_i64_e32 v[254:255], v[2:3], v[4:5] ; encoding: [0x02,0x09,0xfc,0x5d]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64_e64 v[4:5], s[2:3], s[4:5]
// GFX1210: v_mul_i64_e64 v[4:5], s[2:3], s[4:5]    ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0x08,0x00,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[254:255], v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], v[254:255], v[4:5] ; encoding: [0xfe,0x09,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], vcc, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], vcc, v[4:5]       ; encoding: [0x6a,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], exec, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], exec, v[4:5]      ; encoding: [0x7e,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], 0, v[4:5]         ; encoding: [0x80,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], -1, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], -1, v[4:5]        ; encoding: [0xc1,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0.5, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], 0.5, v[4:5]       ; encoding: [0xf0,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], -4.0, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], -4.0, v[4:5]      ; encoding: [0xf7,0x08,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0xaf123456, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], 0xaf123456, v[4:5] ; encoding: [0xff,0x08,0x08,0x5c,0x56,0x34,0x12,0xaf]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0x3f717273, v[4:5]
// GFX1210: v_mul_i64_e32 v[4:5], 0x3f717273, v[4:5] ; encoding: [0xff,0x08,0x08,0x5c,0x73,0x72,0x71,0x3f]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], v[254:255]
// GFX1210: v_mul_i64_e32 v[4:5], v[2:3], v[254:255] ; encoding: [0x02,0xfd,0x09,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], v[2:3], v[8:9]    ; encoding: [0x02,0x11,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[254:255], v[2:3], v[8:9]
// GFX1210: v_mul_i64_e32 v[254:255], v[2:3], v[8:9] ; encoding: [0x02,0x11,0xfc,0x5d]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[254:255], v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], v[254:255], v[8:9] ; encoding: [0xfe,0x11,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], vcc, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], vcc, v[8:9]       ; encoding: [0x6a,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], exec, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], exec, v[8:9]      ; encoding: [0x7e,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], 0, v[8:9]         ; encoding: [0x80,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], -1, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], -1, v[8:9]        ; encoding: [0xc1,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], 0.5, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], 0.5, v[8:9]       ; encoding: [0xf0,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], -4.0, v[8:9]
// GFX1210: v_mul_i64_e32 v[4:5], -4.0, v[8:9]      ; encoding: [0xf7,0x10,0x08,0x5c]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
v_mul_i64 v[4:5], v[2:3], vcc
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], vcc       ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0xd5,0x00,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], exec
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], exec      ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0xfd,0x00,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], 0
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], 0         ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0x01,0x01,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], -1
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], -1        ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0x83,0x01,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], 0.5
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], 0.5       ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0xe1,0x01,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], -4.0
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], -4.0      ; encoding: [0x04,0x00,0x2e,0xd5,0x02,0xef,0x01,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_mul_i64 v[4:5], v[2:3], v[8:9] clamp
// GFX1210: v_mul_i64_e64 v[4:5], v[2:3], v[8:9] clamp ; encoding: [0x04,0x80,0x2e,0xd5,0x02,0x11,0x02,0x00]
// GFX1200-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
