...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1210 %s 2>&1 | FileCheck -check-prefixes=GCN-ERR,GFX1210-ERR --implicit-check-not=error: %s
...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1210 -show-encoding %s | FileCheck -check-prefix=GFX1210 %s
...
// GFX1210: s_add_co_i32 s104, s0, s1 ; encoding:
...
// GFX1210: s_add_co_i32 s105, s0, s1 ; encoding:
...
// GFX1210: s_mov_b64 s[104:105], -1 ; encoding:
...
// GFX1210: s_mov_b32 ttmp12, 0 ; encoding:
...
// GFX1210: s_mov_b32 ttmp15, 0 ; encoding:
...
// GFX1210-ERR: :[[@LINE-4]]:{{[0-9]+}}: error: flat_scratch_lo register not available on this GPU
...
// GFX1210-ERR: :[[@LINE-4]]:{{[0-9]+}}: error: flat_scratch_hi register not available on this GPU
...
// GFX1210-ERR: :[[@LINE-4]]:{{[0-9]+}}: error: tma_lo register not available on this GPU
...
// GFX1210-ERR: :[[@LINE-4]]:{{[0-9]+}}: error: tba_lo register not available on this GPU
...
// GFX1210-ERR: :[[@LINE-3]]:{{[0-9]+}}: error: invalid register class: vgpr tuples must be 64 bit aligned
...
// GFX1210: v_mqsad_u32_u8 v[254:257], v[0:1], -4.0, v[2:5] ; encoding: [0xfe,0x00,0x3d,0xd6,0x00,0xef,0x09,0x04]
