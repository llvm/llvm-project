...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1300 %s 2>&1 | FileCheck -check-prefixes=GCN-ERR,GFX1300-ERR --implicit-check-not=error: %s
...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1300 -show-encoding %s | FileCheck -check-prefix=GFX1300 %s
...
// GFX1300-ERR: :[[@LINE-6]]:{{[0-9]+}}: error: register index is out of range
...
// GFX1300-ERR: :[[@LINE-5]]:{{[0-9]+}}: error: flat_scratch_lo register not available on this GPU
...
// GFX1300-ERR: :[[@LINE-5]]:{{[0-9]+}}: error: flat_scratch_hi register not available on this GPU
...
// GFX1300-ERR: :[[@LINE-5]]:{{[0-9]+}}: error: tma_lo register not available on this GPU
...
// GFX1300-ERR: :[[@LINE-5]]:{{[0-9]+}}: error: tba_lo register not available on this GPU
...
// GFX1300: v_cvt_f32_f64_e32 v0, v[255:256]
...
// GFX1300: v_mqsad_u32_u8 v[254:257], v[0:1], -4.0, v[2:5] ; encoding: [0xfe,0x00,0x3d,0xd6,0x00,0xef,0x09,0x04]
