...
// RUN: llvm-mc -triple=amdgcn -mcpu=gfx1300 -show-encoding -mattr=+atomic-minmax-with-payload %s | FileCheck --check-prefixes=GFX13 %s
...
rts_trace_ray [v0, v[1:3],v[5:8], v[9:12]], s[4:7] r128
// GFX13: rts_trace_ray [v0, v[1:3], v[5:8], v[9:12]], s[4:7] r128 ; encoding: [0x10,0x80,0x3c,0xd0,0x00,0x08,0x00,0x00,0x00,0x01,0x05,0x09]

rts_trace_ray_nonblock v14, [v0, v[1:3], v[5:8], v[9:12]], s[4:7] r128
# GFX13: rts_trace_ray_nonblock v14, [v0, v[1:3], v[5:8], v[9:12]], s[4:7] r128 ; encoding: [0x10,0xc0,0x3c,0xd0,0x0e,0x08,0x00,0x00,0x00,0x01,0x05,0x09]
