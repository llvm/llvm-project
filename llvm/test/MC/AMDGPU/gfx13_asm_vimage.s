...
// GFX13: image_store v[0:3], v0, v5 dmask:0xf dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0xc2,0xd3,0x00,0x0a,0x02,0x00,0x00,0x00,0x00,0x00]

image_store v[0:3], v0, s0 dmask:0xf dim:SQ_RSRC_IMG_1D
// GFX13: image_store v[0:3], v0, s0 dmask:0xf dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0xc2,0xd3,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_RT_WB ; encoding: [0x00,0x00,0x42,0xd0,0x00,0x00,0x30,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS ; encoding: [0x00,0x00,0x42,0xd0,0x00,0x00,0x3c,0x00,0x00,0x00,0x00,0x00]

image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_128B
// GFX13: image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_128B ; encoding: [0x00,0x01,0x42,0xd0,0x00,0x00,0x3c,0x00,0x00,0x00,0x00,0x00]

image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_64B
// GFX13: image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_64B ; encoding: [0x00,0x02,0x42,0xd0,0x00,0x00,0x3c,0x00,0x00,0x00,0x00,0x00]

image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_32B
// GFX13: image_store v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_BYPASS scope:SCOPE_SYS cfs:CFS_32B ; encoding: [0x00,0x03,0x42,0xd0,0x00,0x00,0x3c,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_store_mip v[252:255], [v0, v1], s7 dmask:0xf dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x40,0xc2,0xd3,0xfc,0x0e,0x01,0x00,0x00,0x01,0x00,0x00]

image_store_mip v[252:255], [v0, v1], v7 dmask:0xf dim:SQ_RSRC_IMG_1D
// GFX13: image_store_mip v[252:255], [v0, v1], v7 dmask:0xf dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x40,0xc2,0xd3,0xfc,0x0e,0x02,0x00,0x00,0x01,0x00,0x00]
...
// GFX13: image_store_pck v5, v1, v15 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x42,0xd0,0x05,0x1e,0x02,0x00,0x01,0x00,0x00,0x00]

image_store_pck v5, v1, s8 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_store_pck v5, v1, s8 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x42,0xd0,0x05,0x10,0x01,0x00,0x01,0x00,0x00,0x00]
...
// GFX13: image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT ; encoding: [0x00,0x80,0x42,0xd0,0x05,0x10,0x10,0x00,0x01,0x00,0x00,0x00]

image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_128B
// GFX13: image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_128B ; encoding: [0x00,0x81,0x42,0xd0,0x05,0x10,0x10,0x00,0x01,0x00,0x00,0x00]

image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_64B
// GFX13: image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_64B ; encoding: [0x00,0x82,0x42,0xd0,0x05,0x10,0x10,0x00,0x01,0x00,0x00,0x00]

image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_32B
// GFX13: image_store_pck v5, v1, s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_STORE_NT cfs:CFS_32B ; encoding: [0x00,0x83,0x42,0xd0,0x05,0x10,0x10,0x00,0x01,0x00,0x00,0x00]
...
// GFX13: image_atomic_swap v0, v0, s0 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0xc0,0x43,0xd0,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00]

image_atomic_swap v0, v0, v1 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_atomic_swap v0, v0, v1 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0xc0,0x43,0xd0,0x00,0x02,0x02,0x00,0x00,0x00,0x00,0x00]
...
image_atomic_min_u64_in_b128 v[250:253], [v4, v5, v6, v7], s[96:103] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
// GFX13: image_atomic_min_u64_in_b128 v[250:253], [v4, v5, v6, v7], s[96:103] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY ; encoding: [0x07,0x00,0xe2,0xd3,0xfa,0xc0,0x00,0x00,0x04,0x05,0x06,0x07]
...
image_atomic_max_u64_in_b128 v[250:253], [v4, v5, v6, v7], s[96:103] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
// GFX13: image_atomic_max_u64_in_b128 v[250:253], [v4, v5, v6, v7], s[96:103] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY ; encoding: [0x07,0x40,0xe2,0xd3,0xfa,0xc0,0x00,0x00,0x04,0x05,0x06,0x07]
...
// GFX13: image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT ; encoding: [0x00,0x00,0x46,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]

image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_128B
// GFX13: image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_128B ; encoding: [0x00,0x01,0x46,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]

image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_64B
// GFX13: image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_64B ; encoding: [0x00,0x02,0x46,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]

image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_32B
// GFX13: image_atomic_and v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT cfs:CFS_32B ; encoding: [0x00,0x03,0x46,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_atomic_min_num_flt v1, [v2, v3], s[4:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x80,0x47,0xd0,0x01,0x08,0x00,0x00,0x02,0x03,0x00,0x00]

image_atomic_min_flt v4, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_3D
// GFX13: image_atomic_min_num_flt v4, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_3D ; encoding: [0x02,0x80,0x47,0xd0,0x04,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_min_flt v255, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_CUBE
// GFX13: image_atomic_min_num_flt v255, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_CUBE ; encoding: [0x03,0x80,0x47,0xd0,0xff,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_min_flt v[0:1], [v4, v5], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_1D_ARRAY
// GFX13: image_atomic_min_num_flt v[0:1], [v4, v5], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_1D_ARRAY ; encoding: [0x04,0x80,0xc7,0xd0,0x00,0x10,0x00,0x00,0x04,0x05,0x00,0x00]

image_atomic_min_flt v[1:2], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_ARRAY
// GFX13: image_atomic_min_num_flt v[1:2], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_ARRAY ; encoding: [0x05,0x80,0xc7,0xd0,0x01,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_min_flt v[3:4], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA
// GFX13: image_atomic_min_num_flt v[3:4], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA ; encoding: [0x06,0x80,0xc7,0xd0,0x03,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_min_flt v[254:255], [v4, v5, v6, v7], s[96:103] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
// GFX13: image_atomic_min_num_flt v[254:255], [v4, v5, v6, v7], s[96:103] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY ; encoding: [0x07,0x80,0xc7,0xd0,0xfe,0xc0,0x00,0x00,0x04,0x05,0x06,0x07]

image_atomic_min_flt v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT
// GFX13: image_atomic_min_num_flt v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT ; encoding: [0x00,0x80,0x47,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_atomic_max_num_flt v1, [v2, v3], s[4:11] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0xc0,0x47,0xd0,0x01,0x08,0x00,0x00,0x02,0x03,0x00,0x00]

image_atomic_max_flt v4, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_3D
// GFX13: image_atomic_max_num_flt v4, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_3D ; encoding: [0x02,0xc0,0x47,0xd0,0x04,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_max_flt v255, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_CUBE
// GFX13: image_atomic_max_num_flt v255, [v4, v5, v6], s[8:15] dmask:0x1 dim:SQ_RSRC_IMG_CUBE ; encoding: [0x03,0xc0,0x47,0xd0,0xff,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_max_flt v[0:1], [v4, v5], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_1D_ARRAY
// GFX13: image_atomic_max_num_flt v[0:1], [v4, v5], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_1D_ARRAY ; encoding: [0x04,0xc0,0xc7,0xd0,0x00,0x10,0x00,0x00,0x04,0x05,0x00,0x00]

image_atomic_max_flt v[1:2], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_ARRAY
// GFX13: image_atomic_max_num_flt v[1:2], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_ARRAY ; encoding: [0x05,0xc0,0xc7,0xd0,0x01,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_max_flt v[3:4], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA
// GFX13: image_atomic_max_num_flt v[3:4], [v4, v5, v6], s[8:15] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA ; encoding: [0x06,0xc0,0xc7,0xd0,0x03,0x10,0x00,0x00,0x04,0x05,0x06,0x00]

image_atomic_max_flt v[254:255], [v4, v5, v6, v7], s[96:103] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY
// GFX13: image_atomic_max_num_flt v[254:255], [v4, v5, v6, v7], s[96:103] dmask:0x3 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY ; encoding: [0x07,0xc0,0xc7,0xd0,0xfe,0xc0,0x00,0x00,0x04,0x05,0x06,0x07]

image_atomic_max_flt v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT
// GFX13: image_atomic_max_num_flt v0, v0, s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_ATOMIC_NT ; encoding: [0x00,0xc0,0x47,0xd0,0x00,0x00,0x20,0x00,0x00,0x00,0x00,0x00]
...
// GFX13: image_get_resinfo v4, v32, s96 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x43,0xd0,0x04,0xc0,0x01,0x00,0x20,0x00,0x00,0x00]

image_get_resinfo v4, v32, v96 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_get_resinfo v4, v32, v96 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x43,0xd0,0x04,0xc0,0x02,0x00,0x20,0x00,0x00,0x00]
...
// GFX13: image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS ; encoding: [0x00,0x80,0x43,0xd0,0x04,0xc0,0x3c,0x00,0x20,0x00,0x00,0x00]

image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B
// GFX13: image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B ; encoding: [0x00,0x81,0x43,0xd0,0x04,0xc0,0x3c,0x00,0x20,0x00,0x00,0x00]

image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B
// GFX13: image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B ; encoding: [0x00,0x82,0x43,0xd0,0x04,0xc0,0x3c,0x00,0x20,0x00,0x00,0x00]

image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B
// GFX13: image_get_resinfo v4, v32, s[96:103] dmask:0x1 dim:SQ_RSRC_IMG_1D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B ; encoding: [0x00,0x83,0x43,0xd0,0x04,0xc0,0x3c,0x00,0x20,0x00,0x00,0x00]
...
rts_read_packet_info v0, [v1, v2], null r128
// GFX13: encoding: [0x10,0x80,0x3d,0xd0,0x00,0xf8,0x00,0x00,0x01,0x02,0x00,0x00]

rts_read_prim_info v[0:2], [v3, v4, v5], null r128
// GFX13: encoding: [0x10,0xc0,0x3d,0xd0,0x00,0xf8,0x00,0x00,0x03,0x04,0x05,0x00]

rts_read_vertex_coords  v[0:2], [v3, v4, v5], null r128
// GFX13: encoding: [0x10,0x40,0x3d,0xd0,0x00,0xf8,0x00,0x00,0x03,0x04,0x05,0x00]
