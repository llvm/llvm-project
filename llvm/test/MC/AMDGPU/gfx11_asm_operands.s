...
// RUN: llvm-mc -triple=amdgpu10.30 -show-encoding %s | FileCheck --check-prefix=GFX10 %s
// RUN: not llvm-mc -triple=amdgpu11.00 -show-encoding %s | FileCheck --check-prefix=GFX11 %s
// RUN: not llvm-mc -triple=amdgpu11.00 -filetype=null %s 2>&1 | FileCheck --check-prefixes=GFX11-ERR %s
