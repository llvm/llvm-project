// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx942 %s 2>&1 | FileCheck %s --check-prefix=NOGFX942 --implicit-check-not=error:

image_load v[4:6], v[238:241], s[28:35] dmask:0x7 unorm
// NOGFX942: :[[@LINE-1]]:{{[0-9]+}}: error:
...
// NOGFX942: :[[@LINE-1]]:{{[0-9]+}}: error: instruction not supported on this GPU
