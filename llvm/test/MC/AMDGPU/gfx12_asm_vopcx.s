...
// RUN: llvm-mc -triple=amdgpu12.00 -mattr=+wavefrontsize32,+real-true16 -show-encoding %s | FileCheck --check-prefixes=GFX,GFX12 %s
// RUN: llvm-mc -triple=amdgpu12.00 -mattr=+wavefrontsize64,+real-true16 -show-encoding %s | FileCheck --check-prefixes=GFX,GFX12 %s
// RUN: llvm-mc -triple=amdgpu13.10 -mattr=+wavefrontsize32,+real-true16 -show-encoding %s | FileCheck --check-prefixes=GFX,GFX13 %s
// RUN: llvm-mc -triple=amdgpu13.10 -mattr=+wavefrontsize64,+real-true16 -show-encoding %s | FileCheck --check-prefixes=GFX,GFX13 %s
