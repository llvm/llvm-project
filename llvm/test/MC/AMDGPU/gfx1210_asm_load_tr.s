...
global_load_tr_b64 v1, v0, s[0:1]
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: operands are not valid for this GPU or mode
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_tr_b64 v[1:2], s[3:4], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register alignment
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b8 v[1:2], v0, s[0:1]
// GFX1210: encoding: [0x00,0x00,0x16,0xee,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b8 v[1:2], v0, s[0:1] offset:64
// GFX1210: encoding: [0x00,0x00,0x16,0xee,0x01,0x00,0x00,0x00,0x00,0x40,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
...
global_load_b64_tr_b8 v[1:2], v[3:4], off
// GFX1210: encoding: [0x7c,0x00,0x16,0xee,0x01,0x00,0x00,0x00,0x03,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b8 v[1:2], v[3:4], off offset:64
// GFX1210: encoding: [0x7c,0x00,0x16,0xee,0x01,0x00,0x00,0x00,0x03,0x40,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
...
global_load_b64_tr_b8 v1, v0, s[0:1]
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b8 v[1:2], s[3:4], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register alignment
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b4 v[1:2], v0, s[0:1]
// GFX1210: encoding: [0x00,0x00,0x1d,0xee,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b4 v[1:2], v0, s[0:1] offset:64
...
global_load_b64_tr_b4 v[1:2], v[3:4], off
// GFX1210: encoding: [0x7c,0x00,0x1d,0xee,0x01,0x00,0x00,0x00,0x03,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b4 v[1:2], v[3:4], off offset:64
...
global_load_b64_tr_b4 v1, v0, s[0:1]
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b64_tr_b4 v[1:2], s[3:4], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register alignment
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
...
global_load_b128_tr_b16 v[1:4], v0, s[0:1]
// GFX1210: encoding: [0x00,0xc0,0x15,0xee,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b16 v[1:4], v0, s[0:1] offset:64
// GFX1210: encoding: [0x00,0xc0,0x15,0xee,0x01,0x00,0x00,0x00,0x00,0x40,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
...
global_load_b128_tr_b16 v[1:4], v[5:6], off
// GFX1210: encoding: [0x7c,0xc0,0x15,0xee,0x01,0x00,0x00,0x00,0x05,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b16 v[1:4], v[5:6], off offset:64
// GFX1210: encoding: [0x7c,0xc0,0x15,0xee,0x01,0x00,0x00,0x00,0x05,0x40,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
...
global_load_b128_tr_b16 v[1:2], v[5:6], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b16 v[1:4], s[5:6], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register alignment
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b6 v[1:4], v0, s[0:1]
// GFX1210: encoding: [0x00,0x40,0x1d,0xee,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b6 v[1:4], v0, s[0:1] offset:64
...
global_load_b128_tr_b6 v[1:4], v[5:6], off
// GFX1210: encoding: [0x7c,0x40,0x1d,0xee,0x01,0x00,0x00,0x00,0x05,0x00,0x00,0x00]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b6 v[1:4], v[5:6], off offset:64
...
global_load_b128_tr_b6 v[1:2], v[5:6], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

global_load_b128_tr_b6 v[1:4], s[5:6], off
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register alignment
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b8 v[1:2], v0
// GFX1210: encoding: [0x00,0x00,0xf0,0xdb,0x00,0x00,0x00,0x01]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b8 v[1:2], v0 offset:64
...
ds_load_b64_tr_b8 v1, v0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b8 v[1:2], s0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b4 v[1:2], v0
// GFX1210: encoding: [0x00,0x00,0xe8,0xdb,0x00,0x00,0x00,0x01]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b4 v[1:2], v0 offset:64
...
ds_load_b64_tr_b4 v1 v0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b64_tr_b4 v[1:2], s0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b16 v[1:4], v0
// GFX1210: encoding: [0x00,0x00,0xf4,0xdb,0x00,0x00,0x00,0x01]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b16 v[1:4], v0 offset:64
...
ds_load_b128_tr_b16 v[1:2], v0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b16 v[1:4], s0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b6 v[1:4], v0
// GFX1210: encoding: [0x00,0x00,0xec,0xdb,0x00,0x00,0x00,0x01]
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b6 v[1:4], v0 offset:64
...
ds_load_b128_tr_b6 v[1:2], v0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32

ds_load_b128_tr_b6 v[1:4], s0
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// WAVESIZE-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction requires wavesize=32
