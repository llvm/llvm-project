...
// RUN: not llvm-mc -triple=amdgpu11.00 -mattr=+wavefrontsize32,-real-true16 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX11-ERR,W32-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu11.00 -mattr=+wavefrontsize64,-real-true16 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX11-ERR,W64-ERR --implicit-check-not=error: %s
