// RUN: not llvm-mc -triple=amdgpu12.00 -mattr=+wavefrontsize64 -show-encoding %s | FileCheck --check-prefix=GFX12 %s
// RUN: not llvm-mc -triple=amdgpu12.00 -mattr=+wavefrontsize64 %s -filetype=null 2>&1 | FileCheck --check-prefix=GFX12-ERR --implicit-check-not=error: %s
