...
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid register class: vgpr tuples must be 64 bit aligned
...
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: scale_offset is not supported for this instruction
// GFX1210-ERR-NEXT:{{^}}flat_atomic_add v[2:3], v2 scale_offset
// GFX1210-ERR-NEXT:{{^}}                           ^
...
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: scale_offset is not supported for this instruction
// GFX1210-ERR-NEXT:{{^}}global_atomic_add v[2:3], v2, off scale_offset
// GFX1210-ERR-NEXT:{{^}}                                  ^
...
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid th value for store instructions
...
// GFX1210-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid th value for load instructions
