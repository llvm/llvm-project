...
// RUN: not llvm-mc -triple=amdgpu9.06 -filetype=null %s 2>&1 | FileCheck -check-prefix=GFX906-ERR %s
// RUN: not llvm-mc -triple=amdgpu9.42 -filetype=null %s 2>&1 | FileCheck -check-prefix=GFX942-ERR %s
