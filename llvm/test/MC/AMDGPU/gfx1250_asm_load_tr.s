...
// RUN: not llvm-mc -triple=amdgpu12.50 -mattr=-wavefrontsize32,+wavefrontsize64 %s -filetype=null 2>&1 | FileCheck --check-prefix=WAVESIZE-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu12.50 %s -filetype=null 2>&1 | FileCheck --check-prefix=GFX1250-ERR --implicit-check-not=error: %s
