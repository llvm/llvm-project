...
// RUN: not llvm-mc -triple=amdgpu11.00 -mattr=-real-true16 %s -filetype=null 2>&1 | FileCheck %s -check-prefix=GCN-ERR --implicit-check-not=error: --strict-whitespace
// RUN: not llvm-mc -triple=amdgpu12.00 -mattr=-real-true16 %s -filetype=null 2>&1 | FileCheck %s -check-prefix=GCN-ERR --implicit-check-not=error: --strict-whitespace
