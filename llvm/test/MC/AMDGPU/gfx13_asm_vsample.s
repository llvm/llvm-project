...
// GFX13: image_sample v64, v32, s100, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x48,0xe4,0x40,0xc8,0x01,0x32,0x20,0x00,0x00,0x00]

image_sample v64, v32, s100, s104 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample v64, v32, s100, s104 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x48,0xe4,0x40,0xc8,0x01,0x74,0x20,0x00,0x00,0x00]

image_sample v64, v32, v100, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample v64, v32, v100, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x48,0xe4,0x40,0xc8,0x02,0x32,0x20,0x00,0x00,0x00]

image_sample v64, v32, v100, v103 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample v64, v32, v100, v103 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x48,0xe4,0x40,0xc8,0x82,0xb3,0x20,0x00,0x00,0x00]

image_sample v64, v32, s[4:11], v103 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample v64, v32, s[4:11], v103 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x48,0xe4,0x40,0x08,0x80,0xb3,0x20,0x00,0x00,0x00]
...
// GFX13: image_sample_d v64, [v32, v33, v34], s4, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x48,0xe4,0x40,0x08,0x01,0x02,0x20,0x21,0x22,0x00]

image_sample_d v64, [v32, v33, v34], v44, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d v64, [v32, v33, v34], v44, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x48,0xe4,0x40,0x58,0x02,0x02,0x20,0x21,0x22,0x00]

image_sample_d v64, [v32, v33, v34], v44, s4 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d v64, [v32, v33, v34], v44, s4 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x48,0xe4,0x40,0x58,0x02,0x42,0x20,0x21,0x22,0x00]

image_sample_d v64, [v32, v33, v34], v44, v55 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d v64, [v32, v33, v34], v44, v55 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x48,0xe4,0x40,0x58,0x82,0x9b,0x20,0x21,0x22,0x00]
...
// GFX13: image_gather4 v[64:67], [v32, v33], s11, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x50,0xe4,0x40,0x16,0x01,0x02,0x20,0x21,0x00,0x00]

image_gather4 v[64:67], [v32, v33], v5, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D
// GFX13: image_gather4 v[64:67], [v32, v33], v5, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x50,0xe4,0x40,0x0a,0x02,0x02,0x20,0x21,0x00,0x00]

image_gather4 v[64:67], [v32, v33], v5, s4 dmask:0x1 dim:SQ_RSRC_IMG_2D
// GFX13: image_gather4 v[64:67], [v32, v33], v5, s4 dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x50,0xe4,0x40,0x0a,0x02,0x42,0x20,0x21,0x00,0x00]

image_gather4 v[64:67], [v32, v33], v5, v4 dmask:0x1 dim:SQ_RSRC_IMG_2D
// GFX13: image_gather4 v[64:67], [v32, v33], v5, v4 dmask:0x1 dim:SQ_RSRC_IMG_2D ; encoding: [0x01,0x00,0x50,0xe4,0x40,0x0a,0x02,0x82,0x20,0x21,0x00,0x00]
...
// GFX13: image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS ; encoding: [0x01,0x00,0x10,0xe5,0x12,0x30,0x3c,0x2c,0x16,0x17,0x00,0x00]
...
// GFX13: image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_128B ; encoding: [0x01,0x01,0x10,0xe5,0x12,0x30,0x3c,0x2c,0x16,0x17,0x00,0x00]

image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B
// GFX13: image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_64B ; encoding: [0x01,0x02,0x10,0xe5,0x12,0x30,0x3c,0x2c,0x16,0x17,0x00,0x00]

image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B
// GFX13: image_gather4 v[18:21], [v22, v23], s[24:31], s[88:91] dmask:0x4 dim:SQ_RSRC_IMG_2D th:TH_LOAD_BYPASS scope:SCOPE_SYS cfs:CFS_32B ; encoding: [0x01,0x03,0x10,0xe5,0x12,0x30,0x3c,0x2c,0x16,0x17,0x00,0x00]
...
// GFX13: image_get_lod v64, v32, s55, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x58,0xe4,0x40,0x6e,0x01,0x32,0x20,0x00,0x00,0x00]

image_get_lod v64, v32, v45, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_get_lod v64, v32, v45, s[100:103] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x58,0xe4,0x40,0x5a,0x02,0x32,0x20,0x00,0x00,0x00]

image_get_lod v64, v32, v45, s103 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_get_lod v64, v32, v45, s103 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x58,0xe4,0x40,0x5a,0x82,0x73,0x20,0x00,0x00,0x00]

image_get_lod v64, v32, v45, v105 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_get_lod v64, v32, v45, v105 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x00,0x58,0xe4,0x40,0x5a,0x82,0xb4,0x20,0x00,0x00,0x00]
...
// GFX13: image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY ; encoding: [0x05,0x00,0xd8,0xe7,0x40,0x08,0x00,0x32,0x20,0x21,0x22,0x00]

image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_128B
// GFX13: image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_128B ; encoding: [0x05,0x01,0xd8,0xe7,0x40,0x08,0x00,0x32,0x20,0x21,0x22,0x00]

image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_64B
// GFX13: image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_64B ; encoding: [0x05,0x02,0xd8,0xe7,0x40,0x08,0x00,0x32,0x20,0x21,0x22,0x00]

image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_32B
// GFX13: image_get_lod v[64:67], [v32, v33, v34], s[4:11], s[100:103] dmask:0xf dim:SQ_RSRC_IMG_2D_ARRAY cfs:CFS_32B ; encoding: [0x05,0x03,0xd8,0xe7,0x40,0x08,0x00,0x32,0x20,0x21,0x22,0x00]
...
// GFX13: image_sample_d_g16 v64, [v32, v33, v34], s32, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x68,0xe4,0x40,0x40,0x01,0x02,0x20,0x21,0x22,0x00]

image_sample_d_g16 v64, [v32, v33, v34], v35, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d_g16 v64, [v32, v33, v34], v35, s[4:7] dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x68,0xe4,0x40,0x46,0x02,0x02,0x20,0x21,0x22,0x00]

image_sample_d_g16 v64, [v32, v33, v34], s[4:11], s14 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d_g16 v64, [v32, v33, v34], s[4:11], s14 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x68,0xe4,0x40,0x08,0x00,0x47,0x20,0x21,0x22,0x00]

image_sample_d_g16 v64, [v32, v33, v34], s[4:11], v15 dmask:0x1 dim:SQ_RSRC_IMG_1D
// GFX13: image_sample_d_g16 v64, [v32, v33, v34], s[4:11], v15 dmask:0x1 dim:SQ_RSRC_IMG_1D ; encoding: [0x00,0x80,0x68,0xe4,0x40,0x08,0x80,0x87,0x20,0x21,0x22,0x00]
...
// GFX13: image_msaa_load v[1:4], [v5, v6, v7], s15 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA ; encoding: [0x06,0x00,0x60,0xe4,0x01,0x1e,0x01,0x00,0x05,0x06,0x07,0x00]

image_msaa_load v[1:4], [v5, v6, v7], v8 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA
// GFX13: image_msaa_load v[1:4], [v5, v6, v7], v8 dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA ; encoding: [0x06,0x00,0x60,0xe4,0x01,0x10,0x02,0x00,0x05,0x06,0x07,0x00]
