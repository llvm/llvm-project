...
v_cvt_sr_pk_bf16_f32_e64_dpp v5, |v1|, v2, -ttmp15 row_shr:15
// GFX1210: v_cvt_sr_pk_bf16_f32_e64_dpp v5, |v1|, v2, -ttmp15 row_shr:15 row_mask:0xf bank_mask:0xf ; encoding: [0x05,0x01,0x6e,0xd7,0xfa,0x04,0xee,0x81,0x01,0x1f,0x01,0xff]
// GFX12-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
v_cvt_sr_pk_bf16_f32_e64_dpp v5, -v1, v2, |exec_lo| row_ror:15
// GFX1210: v_cvt_sr_pk_bf16_f32_e64_dpp v5, -v1, v2, |exec_lo| row_ror:15 row_mask:0xf bank_mask:0xf ; encoding: [0x05,0x04,0x6e,0xd7,0xfa,0x04,0xfa,0x21,0x01,0x2f,0x01,0xff]
// GFX12-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// GFX1210: v_cvt_sr_pk_bf16_f32_e64_dpp v5, -|v1|, v2, -|-1| mul:2 row_share:15 row_mask:0x0 bank_mask:0x1 ; encoding: [0x05,0x05,0x6e,0xd7,0xfa,0x04,0x06,0xab,0x01,0x5f,0x01,0x01]
// GFX12-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU

v_cvt_sr_pk_bf16_f32_e64_dpp v5, v1, -|v2|, -|0.5| mul:4 row_xmask:0 row_mask:0x1 bank_mask:0x3 bound_ctrl:1 fi:0
// GFX1210: v_cvt_sr_pk_bf16_f32_e64_dpp v5, v1, -|v2|, -|0.5| mul:4 row_xmask:0 row_mask:0x1 bank_mask:0x3 bound_ctrl:1 ; encoding: [0x05,0x06,0x6e,0xd7,0xfa,0x04,0xc2,0xd3,0x01,0x60,0x09,0x13]
// GFX12-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// GFX1210: v_cvt_sr_pk_bf16_f32_e64_dpp v255, -|v255|, -|v255|, -|src_scc| clamp div:2 row_xmask:15 row_mask:0x3 bank_mask:0x0 fi:1 ; encoding: [0xff,0x87,0x6e,0xd7,0xfa,0xfe,0xf7,0xfb,0xff,0x6f,0x05,0x30]
// GFX12-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
