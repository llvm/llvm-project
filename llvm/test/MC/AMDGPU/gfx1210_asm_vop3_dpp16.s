...
// GFX1210: v_lshl_add_u64_e64_dpp v[2:3], v[4:5], v7, v[8:9] quad_perm:[3,2,1,0] row_mask:0xf bank_mask:0xf ; encoding: [0x02,0x00,0x52,0xd6,0xfa,0x0e,0x22,0x04,0x04,0x1b,0x00,0xff]

v_lshl_add_u64 v[2:3], v[4:5], v1, 1 row_mirror
// GFX1210: v_lshl_add_u64_e64_dpp v[2:3], v[4:5], v1, 1 row_mirror row_mask:0xf bank_mask:0xf ; encoding: [0x02,0x00,0x52,0xd6,0xfa,0x02,0x06,0x02,0x04,0x40,0x01,0xff]

v_lshl_add_u64 v[2:3], v[4:5], v3, s[2:3] row_shl:1
// GFX1210: v_lshl_add_u64_e64_dpp v[2:3], v[4:5], v3, s[2:3] row_shl:1 row_mask:0xf bank_mask:0xf ; encoding: [0x02,0x00,0x52,0xd6,0xfa,0x06,0x0a,0x00,0x04,0x01,0x01,0xff]
