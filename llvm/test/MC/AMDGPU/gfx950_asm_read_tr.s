...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx942 %s 2>&1 | FileCheck --check-prefix=GFX942-ERR --implicit-check-not=error: %s

ds_read_b64_tr_b4 v[0:1], v1
// GFX942-ERR: [[@LINE-1]]:{{[0-9]+}}: error: instruction not supported on this GPU
