...
// RUN: llvm-mc -triple=amdgpu12.00 -show-encoding %s | FileCheck --check-prefixes=GFX12,GFX1200 %s
// RUN: not llvm-mc -triple=amdgpu12.50 -show-encoding %s | FileCheck --check-prefix=GFX12 %s
