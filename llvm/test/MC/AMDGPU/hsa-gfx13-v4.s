// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1300 --amdhsa-code-object-version=4 < %s | FileCheck --check-prefixes=ASM,W32 %s
// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1300 --amdhsa-code-object-version=4 -filetype=obj < %s > %t
// RUN: llvm-readelf -S -r -s %t | FileCheck --check-prefix=READOBJ %s
// RUN: llvm-objdump -s -j .rodata %t | FileCheck --check-prefix=OBJDUMP %s
// RUN: not llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1300 -mattr=+wavefrontsize64,-wavefrontsize32 --amdhsa-code-object-version=4 < %s 2>&1 | FileCheck --check-prefix=W64-ERR %s
...
// OBJDUMP-NEXT: 0130 00000ce0 80000000 00040000 00000000
// max_vgprs
...
// OBJDUMP-NEXT: 0170 7f000ce0 80000000 00040000 00000000
// wavegroup_kernel
...
// OBJDUMP-NEXT: 01b0 01000ce0 80000000 00140000 00000000

.text

.amdgcn_target "amdgcn-amd-amdhsa--gfx1300"
// ASM: .amdgcn_target "amdgcn-amd-amdhsa--gfx1300"
