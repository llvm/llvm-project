...
// RUN: not llvm-mc -triple=amdgpu10.10 -show-encoding %s | FileCheck %s --check-prefix=GFX10
// RUN: not llvm-mc -triple=amdgpu10.10 %s -filetype=null 2>&1 | FileCheck %s --check-prefix=NOGFX10 --implicit-check-not=error:
