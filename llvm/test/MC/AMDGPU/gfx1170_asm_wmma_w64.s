// RUN: not llvm-mc -triple=amdgpu11.70 -mattr=+wavefrontsize64 -show-encoding %s | FileCheck --check-prefix=GFX1170 %s
// RUN: not llvm-mc -triple=amdgpu11.70 -mattr=+wavefrontsize64 %s 2>&1 | FileCheck --check-prefix=GFX1170-ERR --implicit-check-not=error: %s
