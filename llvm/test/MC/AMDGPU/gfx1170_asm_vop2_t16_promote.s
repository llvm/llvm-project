...
// RUN: llvm-mc -triple=amdgpu11.70 -mattr=+real-true16 -show-encoding %s 2>&1 | FileCheck --check-prefixes=GFX1170 --implicit-check-not=_e32 %s
// RUN: llvm-mc -triple=amdgpu11.70 -mattr=+real-true16 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu11.70 -mattr=+real-true16 -disassemble -show-encoding | FileCheck --strict-whitespace --check-prefixes=GFX1170 --implicit-check-not=_e32 %s
