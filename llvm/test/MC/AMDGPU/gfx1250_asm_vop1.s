...
// RUN: llvm-mc -triple=amdgpu12.50 -mattr=+real-true16 -show-encoding %s | FileCheck --check-prefixes=GFX1250,GFX1250-ASM %s
// RUN: llvm-mc -triple=amdgpu12.50 -mattr=+real-true16 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu12.50 -mattr=+real-true16 -disassemble -show-encoding | FileCheck --check-prefixes=GFX1250,GFX1250-DIS %s
...
v_rcp_bf16 v5.l, -17
// GFX1250: v_rcp_bf16_e32 v5.l, 0xffef             ; encoding: [0xff,0xf2,0x0a,0x7e,0xef,0xff,0x00,0x00]
