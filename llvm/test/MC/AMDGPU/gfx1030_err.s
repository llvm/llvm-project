...
// RUN: not llvm-mc -triple=amdgpu10.30 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1030,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.31 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1031,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.32 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1032,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.33 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1033,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.34 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1034,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.35 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1035,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.36 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1036,GFX10 --implicit-check-not=error: %s
