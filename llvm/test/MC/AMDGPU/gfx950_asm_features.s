...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx942 %s -filetype=null 2>&1 | FileCheck --check-prefixes=NOT-GFX950 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx90a %s -filetype=null 2>&1 | FileCheck --check-prefixes=NOT-GFX950 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1010 %s -filetype=null 2>&1 | FileCheck --check-prefixes=NOT-GFX950 --implicit-check-not=error: %s
...
// NOT-GFX950: :[[@LINE-2]]:2: error: instruction not supported on this GPU
...
// NOT-GFX950: :[[@LINE-2]]:1: error: instruction not supported on this GPU
