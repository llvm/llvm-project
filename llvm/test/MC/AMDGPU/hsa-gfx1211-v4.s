// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1211 --amdhsa-code-object-version=4 < %s | FileCheck --check-prefixes=ASM,W32 %s
// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1211 --amdhsa-code-object-version=4 -filetype=obj < %s > %t
// RUN: llvm-readelf -S -r -s %t | FileCheck --check-prefix=READOBJ %s
// RUN: llvm-objdump -s -j .rodata %t | FileCheck --check-prefix=OBJDUMP %s
// RUN: not llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1211 -mattr=+wavefrontsize64,-wavefrontsize32 --amdhsa-code-object-version=4 < %s 2>&1 | FileCheck --check-prefix=W64-ERR %s
...
.amdgcn_target "amdgcn-amd-amdhsa--gfx1211"
// ASM: .amdgcn_target "amdgcn-amd-amdhsa--gfx1211"
