...
// RUN: not llvm-mc -triple=amdgpu7.04 -show-encoding %s | FileCheck %s --check-prefixes=GCN,SICI
// RUN: not llvm-mc -triple=amdgpu8.02 -show-encoding %s | FileCheck %s --check-prefixes=GCN,VI
