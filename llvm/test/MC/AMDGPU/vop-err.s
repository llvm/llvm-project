...
// CHECK: :[[@LINE-1]]:36: error: invalid operand (violates constant bus restrictions)

v_add_f32_e64 v0, flat_scratch_hi, s1
// CHECK: :[[@LINE-1]]:36: error: invalid operand (violates constant bus restrictions)

v_add_f32_e64 v0, s0, flat_scratch_lo
// CHECK: :[[@LINE-1]]:23: error: invalid operand (violates constant bus restrictions)

v_add_f32_e64 v0, s0, s1
// CHECK: :[[@LINE-1]]:23: error: invalid operand (violates constant bus restrictions)

v_add_f64 v[0:1], s[0:1], flat_scratch
// CHECK: :[[@LINE-1]]:27: error: invalid operand (violates constant bus restrictions)

v_add_f64 v[0:1], s[0:1], s[2:3]
// CHECK: :[[@LINE-1]]:27: error: invalid operand (violates constant bus restrictions)

v_add_f64 v[0:1], vcc, s[2:3]
// CHECK: :[[@LINE-1]]:24: error: invalid operand (violates constant bus restrictions)

v_addc_u32 v0, vcc, exec_hi, v0, vcc
// CHECK: :[[@LINE-1]]:21: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:43: error: invalid operand (violates constant bus restrictions)

v_cmp_eq_f32_e64 s[0:1], s0, flat_scratch_lo
// CHECK: :[[@LINE-1]]:30: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:34: error: invalid operand (violates constant bus restrictions)

v_cmp_eq_f64_e64 s[0:1], s[0:1], s[2:3]
// CHECK: :[[@LINE-1]]:34: error: invalid operand (violates constant bus restrictions)

v_cmp_eq_f64_e64 s[0:1], vcc, s[2:3]
// CHECK: :[[@LINE-1]]:31: error: invalid operand (violates constant bus restrictions)

v_cndmask_b32 v0, exec_hi, v2, vcc
// CHECK: :[[@LINE-1]]:19: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:44: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:20: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:28: error: invalid operand (violates constant bus restrictions)

v_div_fmas_f32 v0, v1, v2, m0
// CHECK: :[[@LINE-1]]:28: error: invalid operand (violates constant bus restrictions)

v_div_fmas_f32 v0, v2, v3, -s1
// CHECK: :[[@LINE-1]]:29: error: invalid operand (violates constant bus restrictions)

v_div_fmas_f64 v[0:1], s[2:3], v[4:5], v[6:7]
// CHECK: :[[@LINE-1]]:24: error: invalid operand (violates constant bus restrictions)

v_div_fmas_f64 v[0:1], v[2:3], s[4:5], v[6:7]
// CHECK: :[[@LINE-1]]:32: error: invalid operand (violates constant bus restrictions)

v_div_fmas_f64 v[0:1], v[2:3], v[4:5], exec
// CHECK: :[[@LINE-1]]:40: error: invalid operand (violates constant bus restrictions)
...
// CHECK: :[[@LINE-1]]:17: error: invalid operand (violates constant bus restrictions)
