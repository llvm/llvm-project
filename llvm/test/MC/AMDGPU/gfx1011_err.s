...
// RUN: not llvm-mc -triple=amdgpu10.11 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1011,GFX10 --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.12 %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX1212,GFX10 --implicit-check-not=error: %s
