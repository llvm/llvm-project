...
// RUN: sed 's/COV/4/g' %s | not llvm-mc -triple amdgcn-amd-amdpal -mcpu=gfx802 -filetype=null 2>&1 | \
// RUN:   FileCheck %s --check-prefix=ERR

// RUN: sed 's/COV/4/g' %s | not llvm-mc -triple amdgcn-amd-mesa3d -mcpu=gfx802 -filetype=null 2>&1 | \
// RUN:   FileCheck %s --check-prefix=ERR

// RUN: sed 's/COV/4/g' %s | not llvm-mc -triple amdgcn-amd- -mcpu=gfx802 -filetype=null 2>&1 | \
// RUN:   FileCheck %s --check-prefix=ERR
