...
// RUN: llvm-mc -triple=amdgpu11.00 -mattr=+real-true16 -show-encoding %s | FileCheck -check-prefix=GCN %s
// RUN: llvm-mc -triple=amdgpu12.00 -mattr=+real-true16 -show-encoding %s | FileCheck -check-prefix=GCN %s
