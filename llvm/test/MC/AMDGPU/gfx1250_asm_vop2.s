...
// RUN: llvm-mc -triple=amdgpu12.50 -show-encoding %s | FileCheck --check-prefixes=GFX1250,GFX1250-ASM %s
// RUN: llvm-mc -triple=amdgpu12.50 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu12.50 -disassemble -show-encoding | FileCheck --check-prefixes=GFX1250,GFX1250-DIS %s
// RUN: not llvm-mc -triple=amdgpu12.00 %s -filetype=null 2>&1 | FileCheck --check-prefix=GFX1200-ERR --implicit-check-not=error: %s
