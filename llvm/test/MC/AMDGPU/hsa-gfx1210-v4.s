// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1210 --amdhsa-code-object-version=4 < %s | FileCheck --check-prefixes=ASM,W32 %s
// RUN: llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1210 --amdhsa-code-object-version=4 -filetype=obj < %s > %t
// RUN: llvm-readelf -S -r -s %t | FileCheck --check-prefix=READOBJ %s
// RUN: llvm-objdump -s -j .rodata %t | FileCheck --check-prefix=OBJDUMP %s
// RUN: not llvm-mc -triple amdgcn-amd-amdhsa -mcpu=gfx1210 -mattr=+wavefrontsize64,-wavefrontsize32 --amdhsa-code-object-version=4 < %s 2>&1 | FileCheck --check-prefix=W64-ERR %s
...
// OBJDUMP-NEXT: 0030 00000c40 80000000 00000000 00000000
// complete
...
// OBJDUMP-NEXT: 00b0 00000040 80000000 00000000 00000000
// disabled_user_sgpr
...
// OBJDUMP-NEXT: 0170 3f000c40 80000000 00000000 00000000

.text
// ASM: .text

.amdgcn_target "amdgcn-amd-amdhsa--gfx1210"
// ASM: .amdgcn_target "amdgcn-amd-amdhsa--gfx1210"
