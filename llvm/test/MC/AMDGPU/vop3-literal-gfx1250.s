...
// RUN: not llvm-mc -triple=amdgpu12.50 %s -show-encoding -mattr=+real-true16 | FileCheck %s -check-prefixes=GFX1250
// RUN: not llvm-mc -triple=amdgpu12.50 %s -show-encoding -mattr=+real-true16 | %extract-encodings | llvm-mc -triple=amdgpu12.50 -mattr=+real-true16 -disassemble -show-encoding | FileCheck --check-prefixes=GFX1250 %s

// RUN: not llvm-mc -triple=amdgpu12.50 %s -filetype=null -no-warn 2>&1 -mattr=+real-true16 | FileCheck %s -implicit-check-not=error: -check-prefix=GFX1250-ERR
...
v_cmpx_lt_i16_e64 v1.l, 0x3456
// GFX1250: v_cmpx_lt_i16_e64 v1.l, 0x3456          ; encoding: [0x7e,0x00,0xb1,0xd4,0x01,0xff,0x01,0x02,0x56,0x34,0x00,0x00]

v_cmpx_lt_i16_e64 0x3456, v2.l
// GFX1250: v_cmpx_lt_i16_e64 0x3456, v2.l          ; encoding: [0x7e,0x00,0xb1,0xd4,0xff,0x04,0x02,0x02,0x56,0x34,0x00,0x00]
