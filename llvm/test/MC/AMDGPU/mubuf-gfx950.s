...
// RUN: not llvm-mc -triple=amdgpu9.42 -filetype=null %s 2>&1 | FileCheck -check-prefix=ERR %s
// RUN: not llvm-mc -triple=amdgpu8.03 -filetype=null %s 2>&1 | FileCheck -check-prefix=ERR %s
// RUN: not llvm-mc -triple=amdgpu10.30 -filetype=null %s 2>&1 | FileCheck -check-prefix=ERR %s
