...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32,+real-true16 -show-encoding %s | FileCheck --check-prefixes=W32 %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64,+real-true16 -show-encoding %s | FileCheck --check-prefixes=W64 %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32,+real-true16 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize32,+real-true16 -disassemble -show-encoding | FileCheck --strict-whitespace --check-prefixes=W32 %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64,+real-true16 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgcn -mcpu=gfx1100 -mattr=+wavefrontsize64,+real-true16 -disassemble -show-encoding | FileCheck --strict-whitespace --check-prefixes=W64 %s
...
v_cmp_f_f16 vcc, 0x3800, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_f_f16_e32 vcc, 0.5, v2.l          ; encoding: [0xf0,0x04,0x00,0x7c]

v_cmp_f_f16 vcc, 0xfe0b, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_f_f16_e32 vcc, 0xfe0b, v2.l       ; encoding: [0xff,0x04,0x00,0x7c,0x0b,0xfe,0x00,0x00]
...
v_cmp_f_f16 vcc, v1.l, v127.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_f_f16_e32 vcc, v1.l, v127.h       ; encoding: [0x01,0xff,0x01,0x7c]

v_cmp_f_f16 vcc, v1.l, v127.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_f_f16_e32 vcc, v1.l, v127.l       ; encoding: [0x01,0xff,0x00,0x7c]

v_cmp_f_f16 vcc, v1.l, v2.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_f_f16_e32 vcc, v1.l, v2.h         ; encoding: [0x01,0x05,0x01,0x7c]
...
v_cmp_f_f16 vcc_lo, 0x3800, v2.l
// W32: v_cmp_f_f16_e32 vcc_lo, 0.5, v2.l       ; encoding: [0xf0,0x04,0x00,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_f_f16 vcc_lo, 0xfe0b, v2.l
// W32: v_cmp_f_f16_e32 vcc_lo, 0xfe0b, v2.l    ; encoding: [0xff,0x04,0x00,0x7c,0x0b,0xfe,0x00,0x00]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_f_f16 vcc_lo, v1.l, v127.h
// W32: v_cmp_f_f16_e32 vcc_lo, v1.l, v127.h    ; encoding: [0x01,0xff,0x01,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_f_f16 vcc_lo, v1.l, v127.l
// W32: v_cmp_f_f16_e32 vcc_lo, v1.l, v127.l    ; encoding: [0x01,0xff,0x00,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_f_f16 vcc_lo, v1.l, v2.h
// W32: v_cmp_f_f16_e32 vcc_lo, v1.l, v2.h      ; encoding: [0x01,0x05,0x01,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_t_f16 vcc, 0x3800, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, 0.5, v2.l          ; encoding: [0xf0,0x04,0x1e,0x7c]

v_cmp_t_f16 vcc, 0xfe0b, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, 0xfe0b, v2.l       ; encoding: [0xff,0x04,0x1e,0x7c,0x0b,0xfe,0x00,0x00]
...
v_cmp_t_f16 vcc, v1.l, v127.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v127.h       ; encoding: [0x01,0xff,0x1f,0x7c]

v_cmp_t_f16 vcc, v1.l, v127.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v127.l       ; encoding: [0x01,0xff,0x1e,0x7c]

v_cmp_t_f16 vcc, v1.l, v2.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v2.h         ; encoding: [0x01,0x05,0x1f,0x7c]
...
v_cmp_t_f16 vcc_lo, 0x3800, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, 0.5, v2.l       ; encoding: [0xf0,0x04,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_t_f16 vcc_lo, 0xfe0b, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, 0xfe0b, v2.l    ; encoding: [0xff,0x04,0x1e,0x7c,0x0b,0xfe,0x00,0x00]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_t_f16 vcc_lo, v1.l, v127.h
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v127.h    ; encoding: [0x01,0xff,0x1f,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_t_f16 vcc_lo, v1.l, v127.l
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v127.l    ; encoding: [0x01,0xff,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_t_f16 vcc_lo, v1.l, v2.h
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v2.h      ; encoding: [0x01,0x05,0x1f,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_t_f32 vcc_lo, 0xaf123456, v2
...
v_cmp_t_f64 vcc, 0xaf123456, v[2:3]
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_t_f64 vcc, v[1:2], v[254:255]
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_t_f64 vcc_lo, 0xaf123456, v[2:3]
...
v_cmp_t_f64 vcc_lo, v[1:2], v[254:255]
...
v_cmp_tru_f16 vcc, 0.5, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, 0.5, v2.l          ; encoding: [0xf0,0x04,0x1e,0x7c]

v_cmp_tru_f16 vcc, 0x3800, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, 0.5, v2.l          ; encoding: [0xf0,0x04,0x1e,0x7c]

v_cmp_tru_f16 vcc, 0xfe0b, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, 0xfe0b, v2.l       ; encoding: [0xff,0x04,0x1e,0x7c,0x0b,0xfe,0x00,0x00]
...
v_cmp_tru_f16 vcc, src_scc, v2.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, src_scc, v2.l      ; encoding: [0xfd,0x04,0x1e,0x7c]
...
v_cmp_tru_f16 vcc, v1.l, v127.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v127.h       ; encoding: [0x01,0xff,0x1f,0x7c]

v_cmp_tru_f16 vcc, v1.l, v127.l
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v127.l       ; encoding: [0x01,0xff,0x1e,0x7c]

v_cmp_tru_f16 vcc, v1.l, v2.h
// W32-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
// W64: v_cmp_t_f16_e32 vcc, v1.l, v2.h         ; encoding: [0x01,0x05,0x1f,0x7c]
...
v_cmp_tru_f16 vcc_lo, 0.5, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, 0.5, v2.l       ; encoding: [0xf0,0x04,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_tru_f16 vcc_lo, 0x3800, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, 0.5, v2.l       ; encoding: [0xf0,0x04,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_tru_f16 vcc_lo, 0xfe0b, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, 0xfe0b, v2.l    ; encoding: [0xff,0x04,0x1e,0x7c,0x0b,0xfe,0x00,0x00]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_tru_f16 vcc_lo, src_scc, v2.l
// W32: v_cmp_t_f16_e32 vcc_lo, src_scc, v2.l   ; encoding: [0xfd,0x04,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
v_cmp_tru_f16 vcc_lo, v1.l, v127.h
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v127.h    ; encoding: [0x01,0xff,0x1f,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_tru_f16 vcc_lo, v1.l, v127.l
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v127.l    ; encoding: [0x01,0xff,0x1e,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode

v_cmp_tru_f16 vcc_lo, v1.l, v2.h
// W32: v_cmp_t_f16_e32 vcc_lo, v1.l, v2.h      ; encoding: [0x01,0x05,0x1f,0x7c]
// W64-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
