...
// RUN: not llvm-mc -triple=amdgpu13.10 -mattr=+real-true16 -show-encoding %s 2>&1 | FileCheck --check-prefix=GFX13-ERR --implicit-check-not=error: --strict-whitespace %s
