...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx1310 -mattr=+real-true16 -show-encoding %s 2>&1 | FileCheck --check-prefix=GFX13 --implicit-check-not=error %s

v_ceil_f16_e32 v128.l, 0xfe0b
// GFX13: :[[@LINE-1]]:16: error: invalid operand for instruction
...
// GFX13: :[[@LINE-1]]:22: error: invalid operand for instruction
...
// GFX13: :[[@LINE-1]]:15: error: invalid operand for instruction

v_exp_f16_e32 v255.l, v1.l
// GFX13: :[[@LINE-1]]:15: error: invalid operand for instruction

v_exp_f16_e32 v5.l, v199.l
// GFX13: :[[@LINE-1]]:21: error: invalid operand for instruction

v_floor_f16_e32 v128.l, 0xfe0b
// GFX13: :[[@LINE-1]]:17: error: invalid operand for instruction
...
// GFX13: :[[@LINE-1]]:24: error: invalid operand for instruction

v_cos_f16_e32 v5, v199 quad_perm:[3,2,1,0]
// GFX13: :[[@LINE-1]]:24: error: invalid operand for instruction

v_cvt_f16_f32_e32 v128, 0xaf123456 quad_perm:[3,2,1,0]
// GFX13: :[[@LINE-1]]:36: error: invalid operand for instruction

v_cvt_f16_f32_e32 v255, v1 quad_perm:[3,2,1,0]
// GFX13: :[[@LINE-1]]:28: error: invalid operand for instruction

v_cvt_f16_f32_e32 v255, v255 quad_perm:[3,2,1,0]
// GFX13: :[[@LINE-1]]:30: error: invalid operand for instruction
