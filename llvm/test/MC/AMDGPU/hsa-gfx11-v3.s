// RUN: llvm-mc --amdhsa-code-object-version=3 -triple amdgcn-amd-amdhsa -mcpu=gfx1100 < %s | FileCheck --check-prefix=ASM %s
// RUN: llvm-mc --amdhsa-code-object-version=3 -triple amdgcn-amd-amdhsa -mcpu=gfx1100 -filetype=obj < %s > %t
...
// OBJDUMP-NEXT: 0070 01500164 130f007f 5e040000 00000000
...
// ASM-NEXT: .amdhsa_forward_progress 0
