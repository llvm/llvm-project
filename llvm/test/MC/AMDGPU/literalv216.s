...
// GFX10: v_pk_add_f16 v1, 0, v2                  ; encoding: [0x01,0x40,0x0f,0xcc,0x80,0x04,0x02,0x1a]
...
// GFX10: v_pk_add_f16 v1, v2, 0                  ; encoding: [0x01,0x40,0x0f,0xcc,0x02,0x01,0x01,0x1a]
...
// GFX10: v_pk_add_f16 v1, 0xffff, v2             ; encoding: [0x01,0x40,0x0f,0xcc,0xff,0x04,0x02,0x1a,0xff,0xff,0x00,0x00]
...
// GFX10: v_pk_add_f16 v5, v1, 0x12345678         ; encoding: [0x05,0x40,0x0f,0xcc,0x01,0xff,0x01,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported

v_pk_add_f16 v5, 0x12345678, v2
// GFX10: v_pk_add_f16 v5, 0x12345678, v2         ; encoding: [0x05,0x40,0x0f,0xcc,0xff,0x04,0x02,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:18: error: literal operands are not supported

v_pk_add_f16 v5, -256, v2
// GFX10: v_pk_add_f16 v5, 0xffffff00, v2         ; encoding: [0x05,0x40,0x0f,0xcc,0xff,0x04,0x02,0x1a,0x00,0xff,0xff,0xff]
// NOGFX9: :[[@LINE-2]]:18: error: literal operands are not supported

v_pk_add_f16 v5, v1, 256
// GFX10: v_pk_add_f16 v5, v1, 0x100              ; encoding: [0x05,0x40,0x0f,0xcc,0x01,0xff,0x01,0x1a,0x00,0x01,0x00,0x00]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported

v_pk_add_u16 v5, v1, 0x12345678
// GFX10: v_pk_add_u16 v5, v1, 0x12345678         ; encoding: [0x05,0x40,0x0a,0xcc,0x01,0xff,0x01,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported

v_pk_add_u16 v5, 0x12345678, v2
// GFX10: v_pk_add_u16 v5, 0x12345678, v2         ; encoding: [0x05,0x40,0x0a,0xcc,0xff,0x04,0x02,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:18: error: literal operands are not supported

v_pk_add_u16 v5, -256, v2
// GFX10: v_pk_add_u16 v5, 0xffffff00, v2         ; encoding: [0x05,0x40,0x0a,0xcc,0xff,0x04,0x02,0x1a,0x00,0xff,0xff,0xff]
// NOGFX9: :[[@LINE-2]]:18: error: literal operands are not supported

v_pk_add_u16 v5, v1, 256
// GFX10: v_pk_add_u16 v5, v1, 0x100              ; encoding: [0x05,0x40,0x0a,0xcc,0x01,0xff,0x01,0x1a,0x00,0x01,0x00,0x00]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported
...
// GFX10: v_pk_ashrrev_i16 v5, 0x12345678, v2     ; encoding: [0x05,0x40,0x06,0xcc,0xff,0x04,0x02,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported

v_pk_ashrrev_i16 v5, v1, 0x12345678
// GFX10: v_pk_ashrrev_i16 v5, v1, 0x12345678     ; encoding: [0x05,0x40,0x06,0xcc,0x01,0xff,0x01,0x1a,0x78,0x56,0x34,0x12]
// NOGFX9: :[[@LINE-2]]:26: error: literal operands are not supported
...
// GFX10: v_pk_add_f16 v5, v1, 0x2fe6             ; encoding: [0x05,0x40,0x0f,0xcc,0x01,0xff,0x01,0x1a,0xe6,0x2f,0x00,0x00]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported

v_pk_add_u16 v5, v1, 0.1234
// GFX10: v_pk_add_u16 v5, v1, 0x3dfcb924         ; encoding: [0x05,0x40,0x0a,0xcc,0x01,0xff,0x01,0x1a,0x24,0xb9,0xfc,0x3d]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported
...
// GFX10: v_pk_add_u16 v5, v1, 0x47f12000         ; encoding: [0x05,0x40,0x0a,0xcc,0x01,0xff,0x01,0x1a,0x00,0x20,0xf1,0x47]
// NOGFX9: :[[@LINE-2]]:22: error: literal operands are not supported
