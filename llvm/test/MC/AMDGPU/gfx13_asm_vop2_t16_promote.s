// RUN: llvm-mc -triple=amdgcn -mcpu=gfx1300 -show-encoding %s 2>&1 | FileCheck --check-prefix=GFX13 --implicit-check-not=_e32 %s

v_add_f16 v255, v1, v2
// GFX13: v_add_f16_e64

v_fmac_f16 v255, v1, v2
// GFX13: v_fmac_f16_e64

v_ldexp_f16 v255, v1, v2
// GFX13: v_ldexp_f16_e64

v_max_num_f16 v255, v1, v2
// GFX13: v_max_num_f16_e64

v_min_num_f16 v255, v1, v2
// GFX13: v_min_num_f16_e64
