...
// RUN: llvm-mc -triple=amdgpu9.0a -show-encoding %s | FileCheck %s --check-prefix=GFX90A
// RUN: not llvm-mc -triple=amdgpu9.00 %s -filetype=null 2>&1 | FileCheck %s --check-prefix=GFX900 --implicit-check-not=error:

v_ceil_f64 v[0:1], v[2:3] row_newbcast:1
// GFX900: :[[@LINE-1]]:27: error: not a valid operand.
...
// GFX900: :[[@LINE-1]]:28: error: not a valid operand.
...
// GFX900: :[[@LINE-1]]:32: error: not a valid operand.
...
// GFX900: :[[@LINE-1]]:33: error: not a valid operand.
