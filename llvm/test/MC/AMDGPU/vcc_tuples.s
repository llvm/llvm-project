...
// RUN: not llvm-mc -triple=amdgpu7.04 -show-encoding %s | FileCheck -check-prefixes=GFX7 %s
// RUN: not llvm-mc -triple=amdgpu7.04 -show-encoding %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX7-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu8.02 -show-encoding %s | FileCheck -check-prefixes=GFX89 %s
// RUN: not llvm-mc -triple=amdgpu8.02 -show-encoding %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX89-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu8.02 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu8.02 -disassemble -show-encoding | FileCheck --check-prefixes=GFX89 %s
// RUN: not llvm-mc -triple=amdgpu9.00 -show-encoding %s | FileCheck -check-prefixes=GFX89 %s
// RUN: not llvm-mc -triple=amdgpu9.00 -show-encoding %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX89-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu9.00 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu9.00 -disassemble -show-encoding | FileCheck --check-prefixes=GFX89 %s
// RUN: not llvm-mc -triple=amdgpu10.10 -show-encoding %s | FileCheck -check-prefixes=GFX10 %s
// RUN: not llvm-mc -triple=amdgpu10.10 -show-encoding %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX10-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgpu10.10 -show-encoding %s | %extract-encodings | llvm-mc -triple=amdgpu10.10 -disassemble -show-encoding | FileCheck --check-prefixes=GFX10 %s
// RUN: not llvm-mc -triple=amdgpu11.00 -show-encoding %s | FileCheck -check-prefixes=GFX11 %s
