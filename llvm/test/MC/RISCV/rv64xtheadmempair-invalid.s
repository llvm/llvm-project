...
th.ldd t0, t1, (t2)         # CHECK: [[@LINE]]:29: error: too few operands for instruction
...
th.sdd a0, a1, (a2)         # CHECK: [[@LINE]]:29: error: too few operands for instruction
th.sdd a0, a1, (a2), 3, 5   # CHECK: [[@LINE]]:25: error: operand must be constant 4
th.lwud t0, t1, (t2), 5, 4  # CHECK: [[@LINE]]:1: error: invalid instruction
th.lwud t0, t1, (t2)        # CHECK: [[@LINE]]:29: error: too few operands for instruction
th.lwud t0, t1, (t2), 3, 5  # CHECK: [[@LINE]]:26: error: operand must be constant 3
th.lwd a3, a4, (a5), 5, 4   # CHECK: [[@LINE]]:1: error: invalid instruction
th.lwd a3, a4, (a5)         # CHECK: [[@LINE]]:29: error: too few operands for instruction
th.lwd a3, a4, (a5), 3, 5   # CHECK: [[@LINE]]:25: error: operand must be constant 3
th.swd t3, t4, (t5), 5, 4   # CHECK: [[@LINE]]:1: error: invalid instruction
th.swd t3, t4, (t5)         # CHECK: [[@LINE]]:29: error: too few operands for instruction
