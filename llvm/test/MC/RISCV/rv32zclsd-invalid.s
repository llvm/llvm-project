...
## GPRPairC
c.ld t1, 4(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction
c.sd s2, 4(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction

## GPRPairNoX0
c.ldsp  x0, 4(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction
c.ldsp  zero, 4(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction
...
## uimm8_lsb000
c.ld  s0, -8(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction
c.sd  s0, 256(sp) # CHECK: :[[@LINE]]:1: error: invalid instruction
