# RUN: not llvm-mc -triple riscv32 < %s 2>&1 | FileCheck %s --implicit-check-not='note:' --implicit-check-not='error:'

mret 0x10
# CHECK: :[[@LINE-1]]:6: error: unexpected extra operand for instruction

sfence.vma zero, a1, a2
# CHECK: :[[@LINE-1]]:22: error: unexpected extra operand for instruction
...
sfence.inval.ir 0x10
# CHECK: :[[@LINE-1]]:1: error: invalid instruction

hfence.vvma zero, a1, a2
# CHECK: :[[@LINE-1]]:13: error: unexpected extra operand for instruction
...
hinval.vvma zero, a1, a2
# CHECK: :[[@LINE-1]]:1: error: invalid instruction

hinval.vvma a0, 0x10
# CHECK: :[[@LINE-1]]:1: error: invalid instruction

hinval.gvma zero, a1, a2
# CHECK: :[[@LINE-1]]:1: error: invalid instruction
...
hlvx.hu a0, 0x10
# CHECK: :[[@LINE-1]]:17: error: expected '(' after optional integer offset

hlvx.hu a0, a1
# CHECK: :[[@LINE-1]]:13: error: expected '(' or optional integer offset

hlvx.hu a0, 1(a1)
# CHECK: :[[@LINE-1]]:13: error: optional integer offset must be 0
