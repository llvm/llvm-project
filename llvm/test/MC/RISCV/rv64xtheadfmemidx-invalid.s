...
th.flrw 0(fa0), a1, a2, 0  # CHECK: :[[@LINE]]:1: error: invalid instruction
th.flrw fa0, 4(a1), a2, 3  # CHECK: :[[@LINE]]:1: error: invalid instruction
th.fsrd fa0, a1, -1(a2), 0 # CHECK: :[[@LINE]]:1: error: invalid instruction
