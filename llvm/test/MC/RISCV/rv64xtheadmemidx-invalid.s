...
th.ldia		0(a0), (a1), 0, 0  # CHECK: :[[@LINE]]:1: error: invalid instruction
th.ldib		a0, 2(a1), 15, 1   # CHECK: :[[@LINE]]:1: error: invalid instruction
...
th.lrb		-2(a0), a1, a2, 0  # CHECK: :[[@LINE]]:1: error: invalid instruction
th.lrw		a0, 3(a1), a2, 1   # CHECK: :[[@LINE]]:1: error: invalid instruction
th.lrw		a0, a1, 4(a2), 2   # CHECK: :[[@LINE]]:1: error: invalid instruction
