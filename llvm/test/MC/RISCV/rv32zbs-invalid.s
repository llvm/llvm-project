...
# Too few operands
bclr t0, t1 # CHECK: :[[@LINE]]:12: error: too few operands for instruction
# Too few operands
bset t0, t1 # CHECK: :[[@LINE]]:12: error: too few operands for instruction
# Too few operands
binv t0, t1 # CHECK: :[[@LINE]]:12: error: too few operands for instruction
# Too few operands
bext t0, t1 # CHECK: :[[@LINE]]:12: error: too few operands for instruction
# Too few operands
bclri t0, t1 # CHECK: :[[@LINE]]:13: error: too few operands for instruction
...
# Too few operands
bseti t0, t1 # CHECK: :[[@LINE]]:13: error: too few operands for instruction
# Immediate operand out of range
...
# Too few operands
binvi t0, t1 # CHECK: :[[@LINE]]:13: error: too few operands for instruction
# Immediate operand out of range
...
# Too few operands
bexti t0, t1 # CHECK: :[[@LINE]]:13: error: too few operands for instruction
# Immediate operand out of range
