...
fl ft0, 0(sp)
# CHECK-RV32I: did you mean: la, lb, lh, li, lq, lw
# CHECK-RV32IF: did you mean: flw, la, lb, lh, li, lq, lw
# CHECK-RV64I: did you mean: la, lb, ld, lh, li, lq, lw
# CHECK-RV64IF: did you mean: flw, la, lb, ld, lh, li, lq, lw
