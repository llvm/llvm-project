# RUN: llvm-mc %s -triple=riscv32 -M no-aliases -mattr=+experimental-xqccmt -show-encoding \
...
#
# RUN: llvm-mc %s -triple=riscv64 -M no-aliases -mattr=+experimental-xqccmt -show-encoding \
# RUN:     | FileCheck -check-prefixes=CHECK-INST,CHECK-ENC %s
