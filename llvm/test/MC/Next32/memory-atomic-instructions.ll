...
; RUN: llc -mtriple=next32 -mcpu=next32gen2 -filetype=obj -o - %s | llvm-objdump --triple=next32 -d - | FileCheck %s
...
define void @test_atomic_fetch_fadd(half* nocapture noundef %f16, float* nocapture noundef %f32, double* nocapture noundef %f64) {
; CHECK-LABEL: test_atomic_fetch_fadd
; CHECK:    memfa.fadd.16.align[2] r2, r1, tid
; CHECK-NEXT:    memdata r7
; CHECK:    memfa.fadd.32.align[4] r4, r3, r1
; CHECK-NEXT:    memdata r2
; CHECK:    memfa.fadd.64.align[8] r6, r5, r1
; CHECK-NEXT:    memdata r3
; CHECK-NEXT:    memdata r2
entry:
...
define void @test_atomic_fetch_fsub(half* nocapture noundef %f16, float* nocapture noundef %f32, double* nocapture noundef %f64) {
; CHECK-LABEL: test_atomic_fetch_fsub
; CHECK:    memfa.fsub.16.align[2] r2, r1, tid
; CHECK-NEXT:    memdata r7
; CHECK:    memfa.fsub.32.align[4] r4, r3, r1
; CHECK-NEXT:    memdata r2
; CHECK:    memfa.fsub.64.align[8] r6, r5, r1
; CHECK-NEXT:    memdata r3
; CHECK-NEXT:    memdata r2
entry:
