; RUN: llc -mcpu=mvp -filetype=asm %s -mattr=+branch-hinting -o - | FileCheck --check-prefixes=ASM-CHECK %s
; RUN: llc -mcpu=mvp -filetype=asm %s -mattr=-branch-hinting -o - | FileCheck --check-prefixes=ASM-NCHECK %s
; RUN: llc -mcpu=mvp -filetype=asm %s -o - | FileCheck --check-prefixes=ASM-NCHECK %s
; RUN: llc -mcpu=mvp -filetype=obj %s -mattr=+branch-hinting -o - | obj2yaml | FileCheck --check-prefixes=YAML-CHECK %s
; RUN: llc -mcpu=mvp -filetype=obj %s -mattr=-branch-hinting -o - | obj2yaml | FileCheck --check-prefixes=YAML-NCHECK %s
; RUN: llc -mcpu=mvp -filetype=obj %s -o - | obj2yaml | FileCheck --check-prefixes=YAML-NCHECK %s
