...
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .uleb128 .Ltmp0@DEBUGREF
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .int8 1
; C1-DAG:   .uleb128 test1@FUNCINDEX
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .uleb128 .Ltmp1@DEBUGREF
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .int8 0
; C1-DAG:   .uleb128 test2@FUNCINDEX
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .uleb128 .Ltmp2@DEBUGREF
; C1-DAG-NEXT:   .int8 1
; C1-DAG-NEXT:   .int8 0
...
; C2-DAG-NEXT:	.int8	1
; C2-DAG-NEXT:	.uleb128 .Ltmp2@DEBUGREF
; C2-DAG-NEXT:	.int8	1
; C2-DAG-NEXT:	.int8	0
...
; C3-DAG-NEXT:	.int8	1
; C3-DAG-NEXT:	.uleb128 .Ltmp0@DEBUGREF
; C3-DAG-NEXT:	.int8	1
; C3-DAG-NEXT:	.int8	1
; C3-DAG:	.uleb128 test2@FUNCINDEX
; C3-DAG-NEXT:	.int8	1
; C3-DAG-NEXT:	.uleb128 .Ltmp2@DEBUGREF
; C3-DAG-NEXT:	.int8	1
; C3-DAG-NEXT:	.int8	0
