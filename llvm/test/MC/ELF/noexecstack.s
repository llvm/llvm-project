...
## Solaris and Illumos don't use .note.GNU-stack at all.
# RUN: llvm-mc -filetype=obj -triple x86_64-solaris %s | llvm-readelf -S - | FileCheck %s --check-prefix=NOSTACK
# RUN: llvm-mc -filetype=obj -triple x86_64-pc-illumos %s | llvm-readelf -S - | FileCheck %s --check-prefix=NOSTACK
