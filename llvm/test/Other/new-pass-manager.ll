...
; RUN: opt --opaque-pointers=0 -disable-output -disable-verify -verify-cfg-preserved=1 -debug-pass-manager \
...
; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager -passes=print %s 2>&1 \
...
; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager -disable-verify -verify-cfg-preserved=1 -passes='print,verify' %s 2>&1 \
...
; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager -passes='function(print)' %s 2>&1 \
...
; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager -disable-verify -verify-cfg-preserved=1 -passes='function(print,verify)' %s 2>&1 \
...
; RUN: opt --opaque-pointers=0 -S -o - -passes='no-op-module,no-op-module' %s \
...
; RUN: opt --opaque-pointers=0 -f -o - -passes='no-op-module,no-op-module' %s \
; RUN:     | llvm-dis --opaque-pointers=0 \
; RUN:     | FileCheck %s --check-prefix=CHECK-NOOP

; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager -disable-verify -verify-cfg-preserved=1 -passes='no-op-module,function(no-op-function)' %s 2>&1 \
...
; RUN: opt --opaque-pointers=0 -disable-output -debug-pass-manager \
...
; RUN: opt --opaque-pointers=0 -disable-output -disable-verify -verify-cfg-preserved=1 -debug-pass-manager %s 2>&1 \
