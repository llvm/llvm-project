...
define void @main() {
  ...
  %nofpclass_call_valid = call float @callee_fp(), !nofpclass !{i32 3}
  %nofpclass_call_invalid = call float @callee_fp(), !nofpclass !{i32 99}
  %nonnull_align_call_valid = call ptr @callee_ptr(ptr %alloc_ptr), !nonnull !{}, !align !{i32 8}
  %align_call_invalid = call ptr @callee_ptr(ptr null), !align !{i32 8}
...
; CHECK-NEXT:   %nofpclass_call_valid = call float @callee_fp(), !nofpclass !4 => float 0.000000e+00
; CHECK-NEXT: Entering function: callee_fp
; CHECK-NEXT:   ret float 0.000000e+00
; CHECK-NEXT: Exiting function: callee_fp
...
; CHECK-NEXT:   %nonnull_align_call_valid = call ptr @callee_ptr(ptr %alloc_ptr), !nonnull !1, !align !6 => ptr 0x48 [alloc_ptr]
; CHECK-NEXT: Entering function: callee_ptr
; CHECK-NEXT:   ptr %x = ptr 0x0 [nullary]
; CHECK-NEXT:   ret ptr %x
; CHECK-NEXT: Exiting function: callee_ptr
; CHECK-NEXT:   %align_call_invalid = call ptr @callee_ptr(ptr null), !align !6 => ptr 0x0 [nullary]
; CHECK-NEXT: Entering function: callee_ptr
; CHECK-NEXT:   ptr %x = ptr 0x0 [nullary]
; CHECK-NEXT:   ret ptr %x
; CHECK-NEXT: Exiting function: callee_ptr
