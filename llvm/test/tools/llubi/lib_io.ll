...
; CHECK-NEXT:   %puts.str = alloca [13 x i8], align 1 => ptr 0x9 [puts.str]
...
; CHECK-NEXT:   %fmt.str = alloca [18 x i8], align 1 => ptr 0x17 [fmt.str]
; CHECK-NEXT:   store [18 x i8] c"Int: %d, Str: %s\0A\00", ptr %fmt.str, align 1
; CHECK-NEXT:   %arg.str = alloca [5 x i8], align 1 => ptr 0x2B [arg.str]
