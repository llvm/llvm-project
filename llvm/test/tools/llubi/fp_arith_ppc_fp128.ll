...
; CHECK-NEXT:   %add = fadd ppc_fp128 1.500000e+00, 2.500000e+00 => ppc_fp128 4.000000e+00
; CHECK-NEXT:   %sub = fsub ppc_fp128 5.000000e+00, 1.000000e+00 => ppc_fp128 0x80000000000000004010000000000000
; CHECK-NEXT:   %mul = fmul ppc_fp128 2.000000e+00, 3.000000e+00 => ppc_fp128 6.000000e+00
; CHECK-NEXT:   %div = fdiv ppc_fp128 1.000000e+00, 2.000000e+00 => ppc_fp128 5.000000e-01
; CHECK-NEXT:   %neg = fneg ppc_fp128 -1.500000e+00 => ppc_fp128 0x80000000000000003FF8000000000000
; CHECK-NEXT:   %vadd = fadd <2 x ppc_fp128> <ppc_fp128 1.000000e+00, ppc_fp128 2.000000e+00>, <ppc_fp128 3.000000e+00, ppc_fp128 4.000000e+00> => { ppc_fp128 4.000000e+00, ppc_fp128 6.000000e+00 }
; CHECK-NEXT:   %p1 = fadd ppc_fp128 1.000000e+00, poison => poison
; CHECK-NEXT:   %p2 = fneg ppc_fp128 poison => poison
; CHECK-NEXT:   %inf = fdiv ppc_fp128 1.000000e+00, 0.000000e+00 => ppc_fp128 +Inf
; CHECK-NEXT:   %nan = fdiv ppc_fp128 0.000000e+00, 0.000000e+00 => ppc_fp128 NaN
; CHECK-NEXT:   ret void
