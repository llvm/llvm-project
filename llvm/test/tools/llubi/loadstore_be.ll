...
; CHECK-NEXT:   %gep = getelementptr i8, ptr %alloc, i64 1 => ptr 0xD [alloc + 1]
...
; CHECK-NEXT:   %alloc_lifetime = alloca i32, align 4 => ptr 0x14 [alloc_lifetime (dead)]
...
; CHECK-NEXT:   %alloc_vscale = alloca <vscale x 2 x i32>, align 8 => ptr 0x28 [alloc_vscale]
...
; CHECK-NEXT:   %gep3 = getelementptr <vscale x 1 x i32>, ptr %alloc_vscale, i64 1 => ptr 0x38 [alloc_vscale + 16]
...
; CHECK-NEXT:   %alloc_struct_packed = alloca %struct.packed, align 8 => ptr 0x78 [alloc_struct_packed]
...
; CHECK-NEXT:   %alloc_struct_vscale = alloca %struct.vscale, align 8 => ptr 0x88 [alloc_struct_vscale]
; CHECK-NEXT:   store %struct.vscale zeroinitializer, ptr %alloc_struct_vscale, align 4
; CHECK-NEXT:   %gep4 = getelementptr <vscale x 1 x i32>, ptr %alloc_struct_vscale, i32 1 => ptr 0x98 [alloc_struct_vscale + 16]
...
; CHECK-NEXT:   %alloc_array = alloca [2 x i32], align 4 => ptr 0xAC [alloc_array]
...
; CHECK-NEXT:   %alloc_i1_vec = alloca <4 x i1>, align 1 => ptr 0xB5 [alloc_i1_vec]
...
; CHECK-NEXT:   %alloc_padding = alloca i31, align 4 => ptr 0xBC [alloc_padding]
; CHECK-NEXT:   store i32 0, ptr %alloc_padding, align 4
; CHECK-NEXT:   %alloc_padding_vec = alloca i64, align 8 => ptr 0xC8 [alloc_padding_vec]
...
; CHECK-NEXT:   %alloc_struct_padding = alloca { i8, i32 }, align 8 => ptr 0xD8 [alloc_struct_padding]
...
; CHECK-NEXT:   %alloc_ptr = alloca ptr, align 8 => ptr 0xE8 [alloc_ptr]
; CHECK-NEXT:   store ptr %alloc_ptr, ptr %alloc_ptr, align 8
; CHECK-NEXT:   %ptr_with_provenance = load ptr, ptr %alloc_ptr, align 8 => ptr 0xE8 [alloc_ptr]
; CHECK-NEXT:   %addr_bits = load i8, ptr %alloc_ptr, align 1 => i8 0
; CHECK-NEXT:   store i8 %addr_bits, ptr %alloc_ptr, align 1
; CHECK-NEXT:   %ptr_without_provenance = load ptr, ptr %alloc_ptr, align 8 => ptr 0xE8 [nullary]
; CHECK-NEXT:   ret void
