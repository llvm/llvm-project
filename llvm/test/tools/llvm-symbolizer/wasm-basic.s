...
# CHECK-NEXT: bar
# CHECK-NEXT: wasm-basic.s:17
## Byte c is end_function
# CHECK-NEXT: bar
# CHECK-NEXT: wasm-basic.s:18
...
# RUN: llvm-symbolizer --basenames --output-style=GNU -e %t.wasm 0x42 0x43 0x44 0x45 0x46 0x47 0x48 0x49 0x4a 0x4b 0x4c 0x4d | FileCheck --check-prefix=LINKED %s

# LINKED: foo
# LINKED-NEXT: ??:0
# LINKED-NEXT: foo
# LINKED-NEXT: wasm-basic.s:8
# LINKED-NEXT: foo
# LINKED-NEXT: wasm-basic.s:8
# LINKED-NEXT: foo
# LINKED-NEXT: wasm-basic.s:9
# LINKED-NEXT: foo
# LINKED-NEXT: wasm-basic.s:10
# LINKED-NEXT: bar
# LINKED-NEXT: ??:0
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:15
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:15
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:15
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:16
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:17
# LINKED-NEXT: bar
# LINKED-NEXT: wasm-basic.s:18
