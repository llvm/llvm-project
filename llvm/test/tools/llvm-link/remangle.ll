# RUN: llvm-as --opaque-pointers=0 %S/Inputs/remangle1.ll -o %t.remangle1.bc
# RUN: llvm-as --opaque-pointers=0 %S/Inputs/remangle2.ll -o %t.remangle2.bc
# RUN: llvm-link --opaque-pointers=0 %t.remangle1.bc %t.remangle2.bc -o %t.remangle.linked.bc
# RUN: llvm-dis --opaque-pointers=0 %t.remangle.linked.bc -o - | FileCheck %s
