...
; RUN: llvm-ir2vec embeddings --level=bb --ir2vec-kind=flow-aware --ir2vec-vocab-path=%ir2vec_test_vocab_dir/dummy_3D_nonzero_opc_vocab.json %s | FileCheck %s -check-prefix=CHECK-BB-LEVEL-ALL
...
; CHECK-BB-LEVEL-ALL-NEXT: [ 1743.00  1764.00  1785.00 ]
; CHECK-BB-LEVEL-ALL-NEXT: Function: _Z3addiii
; CHECK-BB-LEVEL-ALL-NEXT: [ 3058.00  3095.00  3132.00 ]
; CHECK-BB-LEVEL-ALL-NEXT: Function: _Z3adddd
; CHECK-BB-LEVEL-ALL-NEXT: [ 1749.00  1770.00  1791.00 ]
; CHECK-BB-LEVEL-ALL-NEXT: Function: main
; CHECK-BB-LEVEL-ALL-NEXT: [ 2113.00  2132.00  2151.00 ]
