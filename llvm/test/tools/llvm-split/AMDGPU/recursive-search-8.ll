; RUN: llvm-split -o %t_s3_ %s -j 3 -mtriple amdgpu-amd-amdhsa -amdgpu-module-splitting-max-depth=8
...
; RUN: llvm-split -o %t_s5_ %s -j 5 -mtriple amdgpu-amd-amdhsa -amdgpu-module-splitting-max-depth=8
