...
;--- 1.s
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize32,-wavefrontsize64 -filetype=obj < 1.s > 1.o
...
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize32,-wavefrontsize64 -filetype=obj < 1-disasm.s > 1-disasm.o
...
;--- 2.s
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 2.s > 2.o
...
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 2-disasm.s > 2-disasm.o
...
;--- 3.s
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 3.s > 3.o
...
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 3-disasm.s > 3-disasm.o
...
;--- 4.s
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 4.s > 4.o
...
; RUN: llvm-mc --triple=amdgpu11.00-amd-amdhsa -mattr=+wavefrontsize64,-wavefrontsize32 -filetype=obj < 4-disasm.s > 4-disasm.o
