...
;--- 1.s
; RUN: llvm-mc --triple=amdgpu12.00-amd-amdhsa -mattr=+wavefrontsize32,-wavefrontsize64 -filetype=obj < 1.s > 1.o
...
; RUN: llvm-mc --triple=amdgpu12.00-amd-amdhsa -mattr=+wavefrontsize32,-wavefrontsize64 -filetype=obj < 1-disasm.s > 1-disasm.o
...
;--- 2.s
; RUN: llvm-mc --triple=amdgpu12.00-amd-amdhsa -mattr=-wavefrontsize32,+wavefrontsize64 -filetype=obj < 2.s > 2.o
...
; RUN: llvm-mc --triple=amdgpu12.00-amd-amdhsa -mattr=-wavefrontsize32,+wavefrontsize64 -filetype=obj < 2-disasm.s > 2-disasm.o
