...
# RUN: llvm-mca -mtriple=x86_64-unknown-unknown -mcpu=c86-4g-m8 -timeline -register-file-stats -iterations=1 < %s | FileCheck %s
...
# CHECK:      *  Register File #1 -- C4GM8FpuPRF:
# CHECK-NEXT:    Number of physical registers:     224
# CHECK-NEXT:    Total number of mappings created: 9
# CHECK-NEXT:    Max number of mappings used:      4

# CHECK:      *  Register File #2 -- C4GM8IntegerPRF:
# CHECK-NEXT:    Number of physical registers:     224
...
# CHECK-NEXT:        139   0.2    0.1    1.8       <total>
