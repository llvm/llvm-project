...
# CHECK-NEXT:  1      100   0.17    *             U     cmpsb	%es:(%rdi), (%rsi)
# CHECK-NEXT:  1      100   0.17    *             U     cmpsw	%es:(%rdi), (%rsi)
# CHECK-NEXT:  1      100   0.17    *             U     cmpsl	%es:(%rdi), (%rsi)
# CHECK-NEXT:  1      100   0.17    *             U     cmpsq	%es:(%rdi), (%rsi)
...
# CHECK-NEXT:  1      100   0.17                  U     enter	$7, $4095
...
# CHECK-NEXT:  1      100   0.17    *      *      U     movsb	(%rsi), %es:(%rdi)
# CHECK-NEXT:  1      100   0.17    *      *      U     movsw	(%rsi), %es:(%rdi)
# CHECK-NEXT:  1      100   0.17    *      *      U     movsl	(%rsi), %es:(%rdi)
# CHECK-NEXT:  1      100   0.17    *      *      U     movsq	(%rsi), %es:(%rdi)
...
# CHECK-NEXT:  1      100   0.17           *      U     stosb	%al, %es:(%rdi)
# CHECK-NEXT:  1      100   0.17           *      U     stosw	%ax, %es:(%rdi)
# CHECK-NEXT:  1      100   0.17           *      U     stosl	%eax, %es:(%rdi)
# CHECK-NEXT:  1      100   0.17           *      U     stosq	%rax, %es:(%rdi)
