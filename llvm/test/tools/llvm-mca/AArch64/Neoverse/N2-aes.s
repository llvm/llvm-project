...
# RUN: llvm-mca -mtriple=aarch64 -mcpu=neoverse-n2  -timeline -mattr=aes < %s | FileCheck %s
...
# CHECK-NEXT:  -      -      -      -      -      -      -      -      -      -      -      -      -      -     1.00    -     aesimc	v2.16b, v2.16b
...
# CHECK-NEXT: [0,1]     DeeER.    .    .    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [0,2]     D=eeER    .    .    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [0,3]     D=eeER    .    .    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [1,0]     D==eeER   .    .    .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [1,1]     .D=eeER   .    .    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [1,2]     .D==eeER  .    .    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [1,3]     .D==eeER  .    .    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [2,0]     .D===eeER .    .    .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [2,1]     .D===eeER .    .    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [2,2]     . D===eeER.    .    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [2,3]     . D===eeER.    .    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [3,0]     . D====eeER    .    .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [3,1]     . D====eeER    .    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [3,2]     . D=====eeER   .    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [3,3]     .  D====eeER   .    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [4,0]     .  D=====eeER  .    .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [4,1]     .  D=====eeER  .    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [4,2]     .  D======eeER .    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [4,3]     .  D======eeER .    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [5,0]     .   D======eeER.    .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [5,1]     .   D======eeER.    .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [5,2]     .   D=======eeER    .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [5,3]     .   D=======eeER    .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [6,0]     .   D========eeER   .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [6,1]     .    D=======eeER   .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [6,2]     .    D========eeER  .  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [6,3]     .    D========eeER  .  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [7,0]     .    D=========eeER .  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [7,1]     .    D=========eeER .  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [7,2]     .    .D=========eeER.  .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [7,3]     .    .D=========eeER.  .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [8,0]     .    .D==========eeER  .   aese	v0.16b, v1.16b
# CHECK-NEXT: [8,1]     .    .D==========eeER  .   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [8,2]     .    .D===========eeER .   aesd	v2.16b, v3.16b
# CHECK-NEXT: [8,3]     .    . D==========eeER .   aesimc	v2.16b, v2.16b
# CHECK-NEXT: [9,0]     .    . D===========eeER.   aese	v0.16b, v1.16b
# CHECK-NEXT: [9,1]     .    . D===========eeER.   aesmc	v0.16b, v0.16b
# CHECK-NEXT: [9,2]     .    . D============eeER   aesd	v2.16b, v3.16b
# CHECK-NEXT: [9,3]     .    . D============eeER   aesimc	v2.16b, v2.16b
...
# CHECK-NEXT: 1.     10    6.6    0.0    0.0       aesmc	v0.16b, v0.16b
# CHECK-NEXT: 2.     10    7.4    0.2    0.0       aesd	v2.16b, v3.16b
# CHECK-NEXT: 3.     10    7.2    0.0    0.0       aesimc	v2.16b, v2.16b
# CHECK-NEXT:        40    7.0    0.1    0.0       <total>
