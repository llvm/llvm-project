...
# CHECK-NEXT:  3      6     0.67    *                   ldp	s29, s28, [sp], #252
# CHECK-NEXT:  3      2     0.50           *            stp	s27, s26, [sp], #-256
# CHECK-NEXT:  3      6     0.67    *                   ldp	s1, s2, [x3], #44
# CHECK-NEXT:  3      2     0.50           *            stp	d3, d5, [x9], #504
# CHECK-NEXT:  3      2     0.50           *            stp	d7, d11, [x10], #-512
# CHECK-NEXT:  3      6     0.67    *                   ldp	d2, d3, [x30], #-8
# CHECK-NEXT:  3      2     0.50           *            stp	q3, q5, [sp], #0
# CHECK-NEXT:  3      2     0.50           *            stp	q17, q19, [sp], #1008
...
# CHECK-NEXT:  -      -      -      -     0.67   0.67   0.67   0.25   0.25   0.25   0.25    -      -     ldp	s29, s28, [sp], #252
# CHECK-NEXT:  -      -      -      -      -     0.50   0.50   0.25   0.25   0.25   0.25   0.50   0.50   stp	s27, s26, [sp], #-256
# CHECK-NEXT:  -      -      -      -     0.67   0.67   0.67   0.25   0.25   0.25   0.25    -      -     ldp	s1, s2, [x3], #44
...
# CHECK-NEXT:  -      -      -      -     0.67   0.67   0.67   0.25   0.25   0.25   0.25    -      -     ldp	d2, d3, [x30], #-8
# CHECK-NEXT:  -      -      -      -      -     0.50   0.50   0.25   0.25   0.25   0.25   0.50   0.50   stp	q3, q5, [sp], #0
# CHECK-NEXT:  -      -      -      -      -     0.50   0.50   0.25   0.25   0.25   0.25   0.50   0.50   stp	q17, q19, [sp], #1008
