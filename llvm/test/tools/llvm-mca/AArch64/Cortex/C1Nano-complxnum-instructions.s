...
# RUN: llvm-mca -mtriple=aarch64 -mcpu=c1-nano -instruction-tables < %p/../Inputs/complxnum-instructions.s | FileCheck %s
...
# CHECK-NEXT:  1      4     0.50                        fcadd	v0.2s, v0.2s, v0.2s, #90
# CHECK-NEXT:  1      4     0.50                        fcadd	v0.4s, v0.4s, v0.4s, #270
