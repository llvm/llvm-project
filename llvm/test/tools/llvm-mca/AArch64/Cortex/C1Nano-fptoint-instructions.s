...
# RUN: llvm-mca -mtriple=aarch64 -mcpu=c1-nano -instruction-tables < %p/../Inputs/fptoint-instructions.s | FileCheck %s
...
# CHECK-NEXT:  1      4     0.50                        frint32x	v0.2d, v0.2d
# CHECK-NEXT:  1      4     0.50                        frint32x	v0.2s, v0.2s
# CHECK-NEXT:  1      4     0.50                        frint32x	v0.4s, v0.4s
# CHECK-NEXT:  1      4     0.50                        frint32z	v0.2d, v0.2d
# CHECK-NEXT:  1      4     0.50                        frint32z	v0.2s, v0.2s
# CHECK-NEXT:  1      4     0.50                        frint32z	v0.4s, v0.4s
# CHECK-NEXT:  1      4     0.50                        frint64x	v0.2d, v0.2d
# CHECK-NEXT:  1      4     0.50                        frint64x	v0.2s, v0.2s
# CHECK-NEXT:  1      4     0.50                        frint64x	v0.4s, v0.4s
# CHECK-NEXT:  1      4     0.50                        frint64z	v0.2d, v0.2d
# CHECK-NEXT:  1      4     0.50                        frint64z	v0.2s, v0.2s
