...
# CHECK-NEXT: Instructions:      1000
# CHECK-NEXT: Total Cycles:      711
# CHECK-NEXT: Total uOps:        4400

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.19
# CHECK-NEXT: IPC:               1.41
...
# CHECK-NEXT: IPC:               1.10
# CHECK-NEXT: Block RThroughput: 6.1
...
# CHECK-NEXT: Total uOps:        5600

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    5.55
# CHECK-NEXT: IPC:               0.99
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    5.23
# CHECK-NEXT: IPC:               1.41
...
# CHECK-NEXT: 8.     1     2.0    0.0    0.0       st1	{ v1.8h }, [x27], #16
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    2.0    0.1    0.0       <total>
...
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st1	{ v1.2d }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    2.2    0.1    0.0       <total>
...
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .D=eER  .   st1	{ v1.8h }, [x27], x28
# CHECK-NEXT: [0,5]     .D==eER .   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     4.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    2.5    0.1    0.0       <total>
...
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st1	{ v1.16b, v2.16b }, [x27], #32
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st1	{ v1.1d, v2.1d }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st1	{ v1.2d, v2.2d }, [x27], x28
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.2s, v2.2s }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .   DeER.   st1	{ v1.16b, v2.16b }, [x27], x28
# CHECK-NEXT: [0,9]     .   D=eER   add	x0, x27, #1
...
# CHECK-NEXT: [0,5]     . D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  D=eER .   st1	{ v1.4h, v2.4h, v3.4h }, [x27], #24
# CHECK-NEXT: [0,7]     .  D==eER.   add	x0, x27, #1
...
# CHECK-NEXT: [0,5]     . D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  D=eER .   st1	{ v1.1d, v2.1d, v3.1d }, [x27], x28
# CHECK-NEXT: [0,7]     .  D==eER.   add	x0, x27, #1
...
# CHECK-NEXT: 8.     1     2.0    1.0    0.0       st1	{ v1.4h, v2.4h, v3.4h, v4.4h }, [x27], #32
# CHECK-NEXT: 9.     1     3.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.8    0.3    0.6       <total>
...
# CHECK-NEXT: 8.     1     2.0    2.0    0.0       st1	{ v1.1d, v2.1d, v3.1d, v4.1d }, [x27], x28
# CHECK-NEXT: 9.     1     3.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.6    0.5    0.4       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.23
# CHECK-NEXT: IPC:               1.42
# CHECK-NEXT: Block RThroughput: 7.0
...
# CHECK-NEXT: [0,5]     .  D==eE--R .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .   D=eeE-R .   st1	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], x28
# CHECK-NEXT: [0,7]     .    D=eE-R .   add	x0, x27, #1
...
# CHECK-NEXT: 5.     1     3.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT: 6.     1     2.0    0.0    1.0       st1	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], x28
...
# CHECK-NEXT:        10    1.7    0.3    0.8       <total>
...
# CHECK-NEXT: 9.     1     4.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    2.1    0.3    0.0       <total>
...
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st2	{ v1.2d, v2.2d }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st2	{ v1.2s, v2.2s }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
...
# CHECK-NEXT: [0,1]     D=eER.  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .DeER.  .   st2	{ v1.8h, v2.8h }, [x27], x28
# CHECK-NEXT: [0,3]     .D=eER  .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     . DeER  .   st2	{ v1.16b, v2.16b }, [x27], x28
# CHECK-NEXT: [0,5]     . D=eER .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .  DeER .   st2	{ v1.b, v2.b }[0], [x27], #2
# CHECK-NEXT: [0,7]     .  D=eER.   add	x0, x27, #1
...
# CHECK-NEXT:        6     1.0    0.5    1.2       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.56
# CHECK-NEXT: IPC:               0.99
...
# CHECK-NEXT: [0,3]     .  DeE--R .    .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .   DeeeeeER   .   st3	{ v1.8h, v2.8h, v3.8h }, [x27], #48
# CHECK-NEXT: [0,5]     .    DeE---R   .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .    .DeeeeeER .   st3	{ v1.16b, v2.16b, v3.16b }, [x27], #48
# CHECK-NEXT: [0,7]     .    . DeE---R .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    .  DeeeeeER   st3	{ v1.2d, v2.2d, v3.2d }, [x27], x28
# CHECK-NEXT: [0,9]     .    .   DeE---R   add	x0, x27, #1
...
# CHECK-NEXT:        10    1.0    0.5    1.4       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    5.77
# CHECK-NEXT: IPC:               0.99
...
# CHECK-NEXT: [0,7]     .    . DeE--R  .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    .  DeeeeeER   st3	{ v1.8h, v2.8h, v3.8h }, [x27], x28
# CHECK-NEXT: [0,9]     .    .   DeE---R   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     1.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.0    0.6    1.0       <total>
...
# CHECK-NEXT: Total uOps:        7400

# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    5.67
# CHECK-NEXT: IPC:               0.77
...
# CHECK-NEXT: [0,1]     .DeE--R   .    . .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     . DeeeeeER.    . .   st4	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], #64
# CHECK-NEXT: [0,3]     .   DeE--R.    . .   add	x0, x27, #1
# CHECK-NEXT: [0,4]     .    DeeeeER   . .   st4	{ v1.8b, v2.8b, v3.8b, v4.8b }, [x27], #32
# CHECK-NEXT: [0,5]     .    .DeE--R   . .   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .    . DeeeeeER. .   st4	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], #64
# CHECK-NEXT: [0,7]     .    .   DeE--R. .   add	x0, x27, #1
# CHECK-NEXT: [0,8]     .    .    DeeeeeER   st4	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], #64
# CHECK-NEXT: [0,9]     .    .    . DeE--R   add	x0, x27, #1
...
# CHECK-NEXT:        10    1.0    0.8    1.0       <total>
...
# CHECK-NEXT: [0,5]     .    .DeE--R   ..   add	x0, x27, #1
# CHECK-NEXT: [0,6]     .    . DeeeeeER..   st4	{ v1.4s, v2.4s, v3.4s, v4.4s }, [x27], x28
# CHECK-NEXT: [0,7]     .    .   DeE--R..   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     1.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.0    0.7    1.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.70
# CHECK-NEXT: IPC:               1.24
# CHECK-NEXT: Block RThroughput: 6.8
...
# CHECK:      [0,0]     DeeeeeER  .  .   st4	{ v1.8h, v2.8h, v3.8h, v4.8h }, [x27], x28
# CHECK-NEXT: [0,1]     . DeE--R  .  .   add	x0, x27, #1
# CHECK-NEXT: [0,2]     .  DeeeeeER  .   st4	{ v1.16b, v2.16b, v3.16b, v4.16b }, [x27], x28
# CHECK-NEXT: [0,3]     .    DeE--R  .   add	x0, x27, #1
...
# CHECK-NEXT: 9.     1     2.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.3    0.5    1.0       <total>
...
# CHECK:      Dispatch Width:    8
# CHECK-NEXT: uOps Per Cycle:    6.32
# CHECK-NEXT: IPC:               1.58
# CHECK-NEXT: Block RThroughput: 4.0
...
# CHECK-NEXT: 7.     1     1.0    0.0    2.0       add	x0, x27, #1
# CHECK-NEXT:        8     1.3    0.3    1.0       <total>
...
# CHECK-NEXT: 9.     1     3.0    0.0    0.0       add	x0, x27, #1
# CHECK-NEXT:        10    1.8    0.1    0.0       <total>
