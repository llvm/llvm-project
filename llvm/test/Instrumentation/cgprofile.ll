; RUN: opt < %s -passes='cg-profile<in-lto-post-link>' -S | FileCheck %s --check-prefixes=CHECK
; RUN: opt < %s -passes='cg-profile' -S | FileCheck %s --check-prefixes=CHECK
...
define void @func3.llvm.12345() !guid !4 {
  ret void
}
...
; CHECK: ![[e3]] = !{ptr @freq, ptr @func3.llvm.12345, i64 150}
