...
; CHECK-NEXT:    [[BUF_TAG:%.*]] = xor i8 [[TMP4]], 0
; CHECK-NEXT:    [[TMP19:%.*]] = ptrtoint ptr [[BUF]] to i64
; CHECK-NEXT:    [[TMP20:%.*]] = and i64 [[TMP19]], 72057594037927935
; CHECK-NEXT:    [[TMP21:%.*]] = zext i8 [[BUF_TAG]] to i64
; CHECK-NEXT:    [[TMP22:%.*]] = shl i64 [[TMP21]], 56
; CHECK-NEXT:    [[TMP23:%.*]] = or i64 [[TMP20]], [[TMP22]]
; CHECK-NEXT:    [[BUF_HWASAN:%.*]] = inttoptr i64 [[TMP23]] to ptr
...
; CHECK-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[TMP27]], i8 [[BUF_TAG]], i64 256, i1 false)
...
; CHECK:       while.body:
; CHECK-NEXT:    call void @llvm.hwasan.check.memaccess(ptr [[TMP17]], ptr @stackbuf, i32 19)
...
; CHECK-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[TMP31]], i8 [[HWASAN_UAR_TAG]], i64 256, i1 false)
