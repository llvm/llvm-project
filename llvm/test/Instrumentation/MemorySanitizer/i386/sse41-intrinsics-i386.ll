...
; CHECK-NEXT:    [[TMP7:%.*]] = ashr <2 x i64> [[TMP6]], splat (i64 63)
; CHECK-NEXT:    [[TMP8:%.*]] = trunc <2 x i64> [[TMP7]] to <2 x i1>
; CHECK-NEXT:    [[TMP9:%.*]] = ashr <2 x i64> [[TMP1]], splat (i64 63)
...
; CHECK-NEXT:    [[TMP7:%.*]] = ashr <4 x i32> [[TMP6]], splat (i32 31)
; CHECK-NEXT:    [[TMP8:%.*]] = trunc <4 x i32> [[TMP7]] to <4 x i1>
; CHECK-NEXT:    [[TMP9:%.*]] = ashr <4 x i32> [[TMP1]], splat (i32 31)
...
; CHECK-NEXT:    call void @llvm.donothing()
; CHECK-NEXT:    [[TMP6:%.*]] = ashr <16 x i8> [[A2:%.*]], splat (i8 7)
; CHECK-NEXT:    [[TMP7:%.*]] = trunc <16 x i8> [[TMP6]] to <16 x i1>
; CHECK-NEXT:    [[TMP8:%.*]] = ashr <16 x i8> [[TMP1]], splat (i8 7)
...
; CHECK-NEXT:    br i1 [[_MSCMP]], label [[TMP3:%.*]], label [[TMP5:%.*]], !prof [[PROF1]]
; CHECK:       3:
; CHECK-NEXT:    call void @__msan_warning_noreturn()
; CHECK-NEXT:    unreachable
; CHECK:       4:
