...
; CHECK-NEXT:    [[TMP32:%.*]] = ptrtoint ptr [[TMP28]] to i64
; CHECK-NEXT:    [[TMP12:%.*]] = and i64 [[TMP32]], -2147483649
...
; CHECK-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[TMP24]], align 8
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 inttoptr (i64 add (i64 ptrtoint (ptr @__msan_va_arg_tls to i64), i64 8) to ptr), ptr align 8 [[TMP8]], i64 16, i1 false)
; CHECK-NEXT:    store i32 24, ptr @__msan_va_arg_overflow_size_tls, align 4
; CHECK-NEXT:    store i32 0, ptr @__msan_retval_tls, align 8
...
; CHECK-NEXT:    [[TMP10:%.*]] = and i64 [[TMP9]], -2147483649
; CHECK-NEXT:    [[TMP8:%.*]] = inttoptr i64 [[TMP10]] to ptr
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 8 inttoptr (i64 add (i64 ptrtoint (ptr @__msan_va_arg_tls to i64), i64 8) to ptr), ptr align 8 [[TMP8]], i64 32, i1 false)
; CHECK-NEXT:    store i32 40, ptr @__msan_va_arg_overflow_size_tls, align 4
; CHECK-NEXT:    store i32 0, ptr @__msan_retval_tls, align 8
