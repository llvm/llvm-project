...
; RUN: opt < %s -passes=asan -asan-realign-stack=32 -S | FileCheck %s
; RUN: opt < %s -passes=asan -asan-realign-stack=32 -asan-force-dynamic-shadow -S | FileCheck %s
; RUN: opt < %s -passes=asan -asan-realign-stack=32 -asan-mapping-scale=5 -S | FileCheck %s
; RUN: opt < %s -passes=asan -asan-realign-stack=32 -asan-force-dynamic-shadow -asan-mapping-scale=5 -S | FileCheck %s
