...
; CHECK-INLINE-NEXT:    [[CMP:%.*]] = icmp ne i64 [[SUBADDR]], 0
; CHECK-INLINE-NEXT:    br i1 [[CMP]], label [[EHEXIT1:%.*]], label [[NORETURNCALL:%.*]]
; CHECK-INLINE:       noreturncall:
; CHECK-INLINE-NEXT:    call void @__asan_handle_no_return() [ "funclet"(token [[TMP98]]) ]
; CHECK-INLINE-NEXT:    call void @NoReturn(ptr null, ptr null) #[[ATTR0:[0-9]+]] [ "funclet"(token [[TMP98]]) ]
; CHECK-INLINE-NEXT:    unreachable
; CHECK-INLINE:       ehexit:
...
; CHECK-OUTLINE-NEXT:    call void @NoReturn(ptr null, ptr null) #[[ATTR0:[0-9]+]] [ "funclet"(token [[TMP67]]) ]
; CHECK-OUTLINE-NEXT:    unreachable
; CHECK-OUTLINE:       ehexit:
