...
; CHECK: declare void @__tysan_check(ptr, i32 zeroext, ptr, i32 noext)
; CHECK: declare void @__tysan_instrument_mem_inst(ptr, ptr, i64, i1 zeroext)
; CHECK: declare void @__tysan_instrument_with_shadow_update(ptr, ptr, i1 zeroext, i64, i32 noext)
