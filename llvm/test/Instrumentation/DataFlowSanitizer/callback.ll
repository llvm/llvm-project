...
; CHECK: declare void @__dfsan_conditional_callback_origin(i8 zeroext, i32 zeroext)
; CHECK: declare void @__dfsan_reaches_function_callback(i8 zeroext, ptr, i32 zeroext, ptr)
; CHECK: declare void @__dfsan_reaches_function_callback_origin(i8 zeroext, i32 zeroext, ptr, i32 zeroext, ptr)
