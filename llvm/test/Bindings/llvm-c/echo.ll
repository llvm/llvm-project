; RUN: llvm-as --opaque-pointers=1 < %s | llvm-dis --opaque-pointers=1 > %t.orig
; RUN: llvm-as --opaque-pointers=1 < %s | llvm-c-test --echo > %t.echo
; RUN: diff -w %t.orig %t.echo
;
; RUN: llvm-as --opaque-pointers=1 -opaque-pointers < %s | llvm-dis --opaque-pointers=1 > %t.orig_opaque
; RUN: llvm-as --opaque-pointers=1 -opaque-pointers < %s | llvm-c-test --echo > %t.echo_opaque
