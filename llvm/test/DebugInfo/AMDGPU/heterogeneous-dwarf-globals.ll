...
; RUN: llvm-dwarfdump -debug-info -show-form %t.o | FileCheck --check-prefixes=DWARF %s
; RUN: llvm-objdump -r %t.o | FileCheck --check-prefixes=RELOCS %s
...
; DWARF-NEXT: DW_AT_decl_file [DW_FORM_data1]
; DWARF-NEXT: DW_AT_decl_line [DW_FORM_data1]
; DWARF-NEXT: DW_AT_location [DW_FORM_exprloc] (DW_OP_addr 0x0, DW_OP_stack_value, DW_OP_deref_size 0x4, DW_OP_constu 0x3, DW_OP_LLVM_form_aspace_address)

; DWARF: 0x0000005f: DW_TAG_variable
...
;       0x44 + 0x0d = 0x51
; RELOCS: 0000000000000051 R_AMDGPU_ABS64           FileVarDeviceShared
;       0x5f + 0x0d = 0x6c
; RELOCS: 000000000000006c R_AMDGPU_ABS64           FileVarDeviceConstant
