...
// FIXME: Convert to testing diop-in-diexpression
// XFAIL: *
...
; CHECK: DW_TAG_formal_parameter
; CHECK-ORIG-OPS: DW_AT_location (DW_OP_lit0, DW_OP_lit6, DW_OP_shr, DW_OP_stack_value, DW_OP_deref_size 0x4, DW_OP_constu 0x5, DW_OP_LLVM_form_aspace_address, DW_OP_lit0, DW_OP_LLVM_offset)
; CHECK-USER-OPS: DW_AT_location (DW_OP_lit0, DW_OP_lit6, DW_OP_shr, DW_OP_stack_value, DW_OP_deref_size 0x4, DW_OP_constu 0x5, DW_OP_LLVM_user DW_OP_LLVM_form_aspace_address, DW_OP_lit0, DW_OP_LLVM_user DW_OP_LLVM_offset)
