...
attributes #0 = { noinline nounwind optnone uwtable "min-legal-vector-width"="0" "frame-pointer"="all" "no-jump-tables"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" }
