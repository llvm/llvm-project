...
attributes #0 = { norecurse nounwind readonly safestack uwtable "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2" }
