...
attributes #0 = { sanitize_memory uwtable "frame-pointer"="none" "stack-protector-buffer-size"="8" }
attributes #1 = { nobuiltin "frame-pointer"="none" "stack-protector-buffer-size"="8" }
