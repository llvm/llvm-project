...
attributes #0 = { nounwind "frame-pointer"="none" "no-jump-tables"="false" "stack-protector-buffer-size"="8" "target-features"="+mmx,+sse,+sse2,+x87" }
attributes #1 = { "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-features"="+mmx,+sse,+sse2,+x87" }
