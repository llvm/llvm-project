...
attributes #0 = { noreturn sanitize_address "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
attributes #1 = { sanitize_address "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
attributes #2 = { "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
