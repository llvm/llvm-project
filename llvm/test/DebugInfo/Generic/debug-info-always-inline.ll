...
attributes #0 = { alwaysinline nounwind sspstrong "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
attributes #1 = { nounwind readnone }
attributes #2 = { nounwind sspstrong "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
attributes #3 = { "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" }
