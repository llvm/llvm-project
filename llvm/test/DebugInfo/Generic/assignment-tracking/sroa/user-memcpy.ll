...
; CHECK-NEXT: #dbg_value(<2 x i64> zeroinitializer, ![[point:[0-9]+]], !DIExpression(DW_OP_LLVM_fragment, 0, 128),
...
; CHECK-NEXT: %point.sroa.0.8.vec.insert = insertelement <2 x i64> zeroinitializer, i64 %other.sroa.0.0.copyload, i32 1
