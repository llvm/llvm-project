...
; CHECK-LABEL: @_Z3funv(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 0, metadata [[META104:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META112:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG113:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 0, metadata [[META104]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META114:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG113]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 0, metadata [[META104]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata [[META115:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG113]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 5000, metadata [[META104]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata [[META116:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG117:![0-9]+]]
; CHECK-NEXT:    [[OTHER_SROA_0_0_COPYLOAD:%.*]] = load i64, ptr @__const._Z3funv.other, align 8, !dbg [[DBG118:![0-9]+]]
; CHECK-NEXT:    [[OTHER_SROA_4_0_COPYLOAD:%.*]] = load i64, ptr getelementptr inbounds (i8, ptr @__const._Z3funv.other, i64 8), align 8, !dbg [[DBG118]]
; CHECK-NEXT:    [[OTHER_SROA_5_0_COPYLOAD:%.*]] = load i64, ptr getelementptr inbounds (i8, ptr @__const._Z3funv.other, i64 16), align 8, !dbg [[DBG118]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 [[OTHER_SROA_0_0_COPYLOAD]], metadata [[META111:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META119:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG118]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 [[OTHER_SROA_4_0_COPYLOAD]], metadata [[META111]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META120:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG118]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 [[OTHER_SROA_5_0_COPYLOAD]], metadata [[META111]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata [[META121:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG118]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 [[OTHER_SROA_0_0_COPYLOAD]], metadata [[META104]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META122:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG123:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i64 [[OTHER_SROA_4_0_COPYLOAD]], metadata [[META104]], metadata !DIExpression(DW_OP_LLVM_fragment, 128, 64), metadata [[META124:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG123]]
