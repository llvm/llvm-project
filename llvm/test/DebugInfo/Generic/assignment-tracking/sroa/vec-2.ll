...
; CHECK-LABEL: @_Z1gv(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META15:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META32:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META15]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META34:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META30:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META35:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META30]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META36:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    [[CALL:%.*]] = call { <2 x float>, <2 x float> } @_Z1fv(), !dbg [[DBG37:![0-9]+]]
; CHECK-NEXT:    [[TMP0:%.*]] = extractvalue { <2 x float>, <2 x float> } [[CALL]], 0, !dbg [[DBG37]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP0]], metadata [[META15]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META38:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    [[TMP1:%.*]] = extractvalue { <2 x float>, <2 x float> } [[CALL]], 1, !dbg [[DBG37]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP1]], metadata [[META15]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META39:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP0]], metadata [[META30]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META40:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP1]], metadata [[META30]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META41:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP0]], metadata [[META31:![0-9]+]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META42:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[TMP1]], metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64), metadata [[META43:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META44:![0-9]+]], metadata !DIExpression(), metadata [[META48:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG49:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata ptr undef, metadata [[META44]], metadata !DIExpression(), metadata [[META51:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG49]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META52:![0-9]+]], metadata !DIExpression(), metadata [[META55:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG56:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata ptr undef, metadata [[META52]], metadata !DIExpression(), metadata [[META58:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG56]]
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr @c, align 4, !dbg [[DBG59:![0-9]+]]
; CHECK-NEXT:    [[I_SROA_4_0_VEC_INSERT:%.*]] = insertelement <2 x float> [[TMP1]], float undef, i32 0, !dbg [[DBG61:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.value(metadata <2 x float> [[I_SROA_4_0_VEC_INSERT]], metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg [[DBG33]]
; CHECK-NEXT:    [[I_SROA_4_12_VEC_INSERT:%.*]] = insertelement <2 x float> [[I_SROA_4_0_VEC_INSERT]], float [[TMP2]], i32 1, !dbg [[DBG61]]
; CHECK-NEXT:    call void @llvm.dbg.value(metadata <2 x float> [[I_SROA_4_12_VEC_INSERT]], metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 64)), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> undef, metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 0, 64), metadata [[META62:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata <2 x float> [[I_SROA_4_0_VEC_INSERT]], metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32), metadata [[META63:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata float [[TMP2]], metadata [[META31]], metadata !DIExpression(DW_OP_LLVM_fragment, 96, 32), metadata [[META64:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG33]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META44]], metadata !DIExpression(), metadata [[META69:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG70:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata ptr [[THIS:%.*]], metadata [[META44]], metadata !DIExpression(), metadata [[META71:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG70]]
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata i1 undef, metadata [[META52]], metadata !DIExpression(), metadata [[META73:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG74:![0-9]+]]
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata ptr [[THIS:%.*]], metadata [[META52]], metadata !DIExpression(), metadata [[META75:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG74]]
; CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr @c, align 4, !dbg [[DBG76:![0-9]+]]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [[CLASS_D:%.*]], ptr [[THIS]], i64 0, i32 0, i32 0, i64 3, !dbg [[DBG77:![0-9]+]]
; CHECK-NEXT:    store float [[TMP0]], ptr [[ARRAYIDX]], align 4, !dbg [[DBG78:![0-9]+]]
