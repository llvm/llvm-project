...
; CHECK-NEXT:    br i1 [[TOBOOL]], label [[IF_THEN:%.*]], label [[IF_ELSE:%.*]], !dbg [[DBG38:![0-9]+]]
; CHECK:       if.then:
; CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr @C, align 8, !dbg [[DBG39:![0-9]+]]
; CHECK-NEXT:    store i32 [[A_SROA_0_SROA_0_0_COPYLOAD]], ptr [[TMP1]], align 4, !dbg [[DBG40:![0-9]+]]
; CHECK-NEXT:    [[A_SROA_51_SROA_5_0__SROA_IDX:%.*]] = getelementptr inbounds i8, ptr [[TMP1]], i64 4, !dbg [[DBG40]]
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 4 [[A_SROA_51_SROA_5_0__SROA_IDX]], ptr align 4 [[A_SROA_51_SROA_5]], i64 20, i1 false), !dbg [[DBG40]]
; CHECK-NEXT:    br label [[IF_END:%.*]], !dbg [[DBG40]]
; CHECK:       if.else:
; CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr @C, align 8, !dbg [[DBG41:![0-9]+]]
; CHECK-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds [16 x i32], ptr [[B]], i64 0, i64 8, !dbg [[DBG42:![0-9]+]]
; CHECK-NEXT:    call void @llvm.memmove.p0.p0.i64(ptr align 4 [[TMP2]], ptr align 16 [[ARRAYIDX7]], i64 24, i1 false), !dbg [[DBG43:![0-9]+]]
; CHECK-NEXT:    br label [[IF_END]]
; CHECK:       if.end:
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 64, ptr [[B]]), !dbg [[DBG44:![0-9]+]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 20, ptr [[A_SROA_0_SROA_5]]), !dbg [[DBG44]]
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 20, ptr [[A_SROA_51_SROA_5]]), !dbg [[DBG44]]
