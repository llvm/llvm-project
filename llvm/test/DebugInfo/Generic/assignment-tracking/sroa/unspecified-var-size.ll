...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    call void @llvm.dbg.assign(metadata ptr [[TMP0:%.*]], metadata [[META21:![0-9]+]], metadata !DIExpression(), metadata [[META22:![0-9]+]], metadata ptr undef, metadata !DIExpression()), !dbg [[DBG23:![0-9]+]]
