...
function(llvm_update_compile_flags name)
  ...
  if(NOT (LLVM_REQUIRES_RTTI OR LLVM_ENABLE_RTTI))
    ...
    if (LLVM_COMPILER_IS_GCC_COMPATIBLE)
      set(LLVM_CONFIG_RTTI_CXXFLAG "-fno-rtti" CACHE INTERNAL "")
    elseif (MSVC)
      set(LLVM_CONFIG_RTTI_CXXFLAG "/GR-" CACHE INTERNAL "")
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "XL")
      set(LLVM_CONFIG_RTTI_CXXFLAG "-qnortti" CACHE INTERNAL "")
    else()
      set(LLVM_CONFIG_RTTI_CXXFLAG "" CACHE INTERNAL "")
    endif ()
  else()
  ...
  list(APPEND LLVM_COMPILE_CXXFLAGS ${LLVM_CONFIG_RTTI_CXXFLAG})
