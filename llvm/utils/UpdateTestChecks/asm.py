...
ASM_CONSTANT_RISCV_RE = re.compile(
    r"^\.LCPI(?P<func_num>[\d]+)_(?P<const_num>[\d]+):\n"
    r"(?P<body>(\s+\.(byte|half|word|dword|zero)\s+[\d]+[^\n]*?\n)+)",
    flags=(re.M | re.S),
)
...
# Returns a tuple of a scrub function, a function regex, and a constant pool regex.
# Scrub function is used to alter function body in some way, for example, remove trailing spaces.
# Function regex is used to match function name, body, etc. in raw llc output.
# Constant regex is used to match constant pool outputs
def get_run_handler(triple):
    target_handlers = {
        "i686": (scrub_asm_x86, ASM_FUNCTION_X86_RE, None),
        "x86": (scrub_asm_x86, ASM_FUNCTION_X86_RE, None),
        "i386": (scrub_asm_x86, ASM_FUNCTION_X86_RE, None),
        "arm64_32": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "aarch64": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_RE, None),
        "aarch64-apple-darwin": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "aarch64-apple-ios": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "aarch64-apple-macosx": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "bpf": (scrub_asm_bpf, ASM_FUNCTION_BPF_RE, None),
        "bpfel": (scrub_asm_bpf, ASM_FUNCTION_BPF_RE, None),
        "bpfeb": (scrub_asm_bpf, ASM_FUNCTION_BPF_RE, None),
        "hexagon": (scrub_asm_hexagon, ASM_FUNCTION_HEXAGON_RE, None),
        "r600": (scrub_asm_amdgpu, ASM_FUNCTION_AMDGPU_RE, None),
        "amdgcn": (scrub_asm_amdgpu, ASM_FUNCTION_AMDGPU_RE, None),
        "arm": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_RE, None),
        "arm64": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_RE, None),
        "arm64e": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "arm64ec": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_RE, None),
        "arm64-apple-darwin": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "arm64-apple-ios": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "arm64-apple-macosx": (scrub_asm_arm_eabi, ASM_FUNCTION_AARCH64_DARWIN_RE, None),
        "armv7-apple-ios": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_IOS_RE, None),
        "armv7-apple-darwin": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_DARWIN_RE, None),
        "armv7k-apple-watchos": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_DARWIN_RE, None),
        "thumbv7k-apple-watchos": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_DARWIN_RE, None),
        "thumb": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_RE, None),
        "thumb-macho": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_MACHO_RE, None),
        "thumbv5-macho": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_MACHO_RE, None),
        "thumbv7s-apple-darwin": (scrub_asm_arm_eabi, ASM_FUNCTION_THUMBS_DARWIN_RE, None),
        "thumbv7-apple-darwin": (scrub_asm_arm_eabi, ASM_FUNCTION_THUMB_DARWIN_RE, None),
        "thumbv7-apple-ios": (scrub_asm_arm_eabi, ASM_FUNCTION_ARM_IOS_RE, None),
        "m68k": (scrub_asm_m68k, ASM_FUNCTION_M68K_RE, None),
        "mips": (scrub_asm_mips, ASM_FUNCTION_MIPS_RE, None),
        "msp430": (scrub_asm_msp430, ASM_FUNCTION_MSP430_RE, None),
        "avr": (scrub_asm_avr, ASM_FUNCTION_AVR_RE, None),
        "ppc32": (scrub_asm_powerpc, ASM_FUNCTION_PPC_RE, None),
        "ppc64": (scrub_asm_powerpc, ASM_FUNCTION_PPC_RE, None),
        "powerpc": (scrub_asm_powerpc, ASM_FUNCTION_PPC_RE, None),
        "riscv32": (scrub_asm_riscv, ASM_FUNCTION_RISCV_RE, ASM_CONSTANT_RISCV_RE),
        "riscv32-apple-none-macho": (scrub_asm_riscv, ASM_FUNCTION_RISCV_MACHO_RE, None),
        "riscv64": (scrub_asm_riscv, ASM_FUNCTION_RISCV_RE, ASM_CONSTANT_RISCV_RE),
        "lanai": (scrub_asm_lanai, ASM_FUNCTION_LANAI_RE, None),
        "sparc": (scrub_asm_sparc, ASM_FUNCTION_SPARC_RE, None),
        "spirv": (scrub_asm_spirv, ASM_FUNCTION_SPIRV_RE, None),
        "spirv32": (scrub_asm_spirv, ASM_FUNCTION_SPIRV_RE, None),
        "spirv64": (scrub_asm_spirv, ASM_FUNCTION_SPIRV_RE, None),
        "s390x": (scrub_asm_systemz, ASM_FUNCTION_SYSTEMZ_RE, None),
        "wasm32": (scrub_asm_wasm, ASM_FUNCTION_WASM_RE, None),
        "wasm64": (scrub_asm_wasm, ASM_FUNCTION_WASM_RE, None),
        "ve": (scrub_asm_ve, ASM_FUNCTION_VE_RE, None),
        "xtensa": (scrub_asm_xtensa, ASM_FUNCTION_XTENSA_RE, None),
        "csky": (scrub_asm_csky, ASM_FUNCTION_CSKY_RE, None),
        "nvptx": (scrub_asm_nvptx, ASM_FUNCTION_NVPTX_RE, None),
        "loongarch32": (scrub_asm_loongarch, ASM_FUNCTION_LOONGARCH_RE, None),
        "loongarch64": (scrub_asm_loongarch, ASM_FUNCTION_LOONGARCH_RE, None),
    }
    handler = None
    best_prefix = ""
