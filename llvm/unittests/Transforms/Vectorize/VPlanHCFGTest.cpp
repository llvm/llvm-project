...
compound=true
  ...
  N1 [label =
    "scalar.ph:\l" +
    "  EMIT-SCALAR vp\<%7\> = phi [ vp\<%5\>, middle.block ], [ ir\<0\>, ir-bb\<entry\> ]\l" +
    "Successor(s): ir-bb\<for.body\>\l"
  ]
  N1 -> N3 [ label=""]
  N3 [label =
    "ir-bb\<for.body\>:\l" +
    "  IR   %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ] (extra operand: vp\<%7\> from scalar.ph)\l" +
  ...
  N6 [label =
    "middle.block:\l" +
    "  EMIT vp\<%4\> = extract-last-part ir\<%indvars.iv.next\>\l" +
    "  EMIT vp\<%5\> = extract-last-lane vp\<%4\>\l" +
...
compound=true
  ...
  N3 [label =
    "ir-bb\<loop.header\>:\l" +
    "  IR   %iv = phi i64 [ 0, %entry ], [ %iv.next, %loop.latch ] (extra operand: vp\<%7\> from scalar.ph)\l" +
  ...
  N7 [label =
    "middle.block:\l" +
    "  EMIT vp\<%4\> = extract-last-part ir\<%iv.next\>\l" +
    "  EMIT vp\<%5\> = extract-last-lane vp\<%4\>\l" +
    "  EMIT vp\<%cmp.n\> = icmp eq ir\<%N\>, vp\<%1\>\l" +
    "  EMIT branch-on-cond vp\<%cmp.n\>\l" +
