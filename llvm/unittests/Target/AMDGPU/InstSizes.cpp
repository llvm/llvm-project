...
body: |
  bb.0:
    BUFFER_LOAD_DWORD_LDS_OFFEN $vgpr1, $sgpr8_11, 0, 0, 0, 0, 0, implicit $exec, implicit $m0
    BUFFER_LOAD_DWORD_LDS_OFFSET $sgpr8_11, 0, 0, 0, 0, 0, implicit $exec, implicit $m0
