...
TEST(GSYMV2Test, TestFunctionInfoLargeNameOffset) {
...
TEST(GSYMV2Test, TestInlineInfoLargeNameOffset) {
...
TEST(GSYMV2Test, TestCallSiteInfoLargeMatchRegex) {
...
TEST(GSYMV2Test, TestCallSiteInfoCollectionLargeMatchRegex) {
...
TEST(GSYMV2Test, TestFunctionInfoAllFieldsLargeOffsets) {
...
TEST(GSYMV2Test, TestMergedFunctionsInfoLargeOffsets) {
