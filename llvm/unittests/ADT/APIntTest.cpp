...
TEST(APIntOpsTest, mulx) {
  ...
  EXPECT_EQ(APInt(128, "121FA000A3723A57C24A442FE55618CF", 16), APIntOps::mulxu(u64a, u64b));

  APInt u128a(128, "1234567890ABCDEF1234567890ABCDEF", 16);
  APInt u128b(128, "FEDCBA0987654321FEDCBA0987654321", 16);
  EXPECT_EQ(APInt(256, "121FA000A3723A57E68984312C3A8D7E96B428606E1E6BF5C24A442FE55618CF", 16), APIntOps::mulxu(u128a, u128b));
  ...
  EXPECT_EQ(APInt(128, "014B66DC328E10C1FB99704184EF03A6", 16), APIntOps::mulxs(s64a, s64b));
  EXPECT_EQ(APInt(128, "FFEB498812C66C68C24A442FE55618CF", 16), APIntOps::mulxs(s64a, s64c));
