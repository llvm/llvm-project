...
TEST(APFloatTest, getPromoted) {
  ...
  // Promotions have the expected semantics and preserve the initial value.
  ...
  EXPECT_DEATH(InvalidPromotionTest.getPromoted(APFloat::IEEEdouble()),
               "Target semantics will lose information");
  EXPECT_DEATH(InvalidPromotionTest.getPromoted(APFloat::x87DoubleExtended()),
               "Target semantics will lose information");
  EXPECT_DEATH(
