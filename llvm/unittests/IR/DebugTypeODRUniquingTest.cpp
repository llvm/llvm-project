...
TEST(DebugTypeODRUniquingTest, getODRType) {
  ...
  EXPECT_FALSE(DICompositeType::getODRType(
      ...
      nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagZero, nullptr, 0, nullptr, nullptr, nullptr,
  ...
  EXPECT_EQ(&CT,
            DICompositeType::getODRType(
                ...
                nullptr, nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagZero, nullptr, 0,
  ...
  EXPECT_EQ(&CT, DICompositeType::getODRType(
                     ...
                     nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagZero, nullptr, 0, nullptr,
...
TEST(DebugTypeODRUniquingTest, buildODRType) {
  ...
  auto &CT = *DICompositeType::buildODRType(
      Context, UUID, dwarf::DW_TAG_class_type, nullptr, nullptr, 0, nullptr,
      nullptr, 0, 0, 0, nullptr, 0, APInt(),  DINode::FlagFwdDecl, nullptr, 0, nullptr, nullptr,
      nullptr, nullptr, nullptr, nullptr, nullptr, nullptr);
  EXPECT_EQ(&CT, DICompositeType::getODRTypeIfExists(Context, UUID));
  ...
  EXPECT_EQ(&CT, DICompositeType::buildODRType(
                     ...
                     0, nullptr, nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagFwdDecl, nullptr,
  ...
  EXPECT_EQ(&CT, DICompositeType::buildODRType(
                     Context, UUID, dwarf::DW_TAG_class_type, nullptr, nullptr,
                     0, nullptr, nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagZero, nullptr, 0,
                     nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
                     nullptr, nullptr));
  ...
  EXPECT_EQ(&CT, DICompositeType::buildODRType(
                     Context, UUID, dwarf::DW_TAG_class_type, nullptr, nullptr,
                     111u, nullptr, nullptr, 0, 0, 0, nullptr, 0, APInt(), DINode::FlagZero, nullptr,
                     0, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
                     nullptr, nullptr));
...
TEST(DebugTypeODRUniquingTest, buildODRTypeFields) {
  ...
  auto &CT = *DICompositeType::buildODRType(
      Context, UUID, 0, nullptr, nullptr, 0, nullptr, nullptr, 0, 0, 0, nullptr, 0, APInt(),
...
#undef DO_FOR_FIELD
  ...
  EXPECT_EQ(&CT, DICompositeType::buildODRType(
                     ...
                     SizeInBits, AlignInBits, OffsetInBits, nullptr, NumExtraInhabitants, APInt(),
