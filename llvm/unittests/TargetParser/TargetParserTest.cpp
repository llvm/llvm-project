...
TEST(TargetParserTest, testAMDGPUgetEUsPerCU) {
  ...
  EXPECT_EQ(AMDGPU::getEUsPerCU(AMDGPU::GK_GFX1030, false), 4u);
  EXPECT_EQ(AMDGPU::getEUsPerCU(AMDGPU::GK_GFX600, true), 4u);
  EXPECT_EQ(AMDGPU::getEUsPerCU(AMDGPU::GK_GFX900, false), 4u);
...
TEST(TargetParserTest, testAMDGPUgetMaxWavesPerEU) {
  ...
  EXPECT_EQ(AMDGPU::getMaxWavesPerEU(AMDGPU::GK_GFX600), 10u);
  ...
  EXPECT_EQ(AMDGPU::getMaxWavesPerEU(AMDGPU::GK_GFX1250), 16u);
...
TEST(TargetParserTest, testAMDGPUgetVGPRAllocGranule) {
  ...
  EXPECT_EQ(AMDGPU::getVGPRAllocGranule(AMDGPU::GK_GFX1010, 16, true), 16u);
  EXPECT_EQ(AMDGPU::getVGPRAllocGranule(AMDGPU::GK_GFX1100, 0, true), 24u);
  EXPECT_EQ(AMDGPU::getVGPRAllocGranule(AMDGPU::GK_GFX1100, 0, false), 12u);
  ...
  EXPECT_EQ(AMDGPU::getVGPRAllocGranule(AMDGPU::GK_GFX1010, 0, false), 4u);
...
TEST(TargetParserTest, testAMDGPUgetAddressableNumVGPRs) {
  ...
  EXPECT_EQ(AMDGPU::getAddressableNumArchVGPRs(AMDGPU::GK_GFX1250, true),
            1024u);
  EXPECT_EQ(AMDGPU::getAddressableNumArchVGPRs(AMDGPU::GK_GFX1250, false),
            512u);
  EXPECT_EQ(AMDGPU::getAddressableNumArchVGPRs(AMDGPU::GK_GFX1030, true), 256u);
  ...
  EXPECT_EQ(AMDGPU::getAddressableNumVGPRs(AMDGPU::GK_GFX1200, 16, true),
