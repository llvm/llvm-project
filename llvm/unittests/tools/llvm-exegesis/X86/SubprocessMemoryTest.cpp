...
static constexpr const int MainProcessPID = 0;
...
TEST_F(SubprocessMemoryTest, OneDefinition) {
  testCommon({{"test1", {APInt(8, 0xff), 4096, 0}}});
...
TEST_F(SubprocessMemoryTest, MultipleDefinitions) {
  ...
  checkSharedMemoryDefinition("/0memdef0", 4096, {0xaa});
  checkSharedMemoryDefinition("/0memdef1", 4096, {0xbb});
...
TEST_F(SubprocessMemoryTest, DefinitionFillsCompletely) {
  ...
  checkSharedMemoryDefinition("/0memdef0", 4096, Test1Expected);
  checkSharedMemoryDefinition("/0memdef1", 4096, Test2Expected);
  checkSharedMemoryDefinition("/0memdef2", 4096, Test3Expected);
}
