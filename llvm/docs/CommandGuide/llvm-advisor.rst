...
* Compilation unit metadata (source, object, and command information)
* Results from analysis capabilities
...
.. code-block:: console
  ...
  llvm-advisor capture --capability llvm.remarks.summary --capability llvm.remarks.detail

This captures only optimization remarks results.
...
.. code-block:: console
  ...
  llvm-advisor query --snapshot latest --capability llvm.remarks.summary

Outputs JSON results of the specified capability.

Inspect Remarks Output
~~~~~~~~~~~~~~~~~~~~~~

View optimization remarks for a specific unit:

.. code-block:: console

  llvm-advisor inspect remarks --snapshot latest --unit main.cpp
