...
[Wikipedia](https://en.wikipedia.org/wiki/Control-flow_graph#Reducibility)
...
* The [FixIrreducible](https://llvm.org/doxygen/FixIrreducible_8h.html)
...
[C++](https://eel.is/c++draft/intro.progress#1) have such
...
(loop-terminology-loop-simplify)=
...
[LoopSimplify.h](https://llvm.org/doxygen/LoopSimplify_8h_source.html).
...
[^lcssa-construction] in order to "close" these values inside the loop.
...
for phi nodes, as
[mentioned in the LangRef](LangRef.md#phi-instruction):
...
scan the def-use chain [^def-use-chain] of all instructions in the loop).
...
[^def-use-chain] for each Value, we wouldn't need
...
[getSCEVAtScope()](https://llvm.org/doxygen/classllvm_1_1ScalarEvolution.html#a21d6ee82eed29080d911dbb548a8bb68).
...
[getSCEV()](https://llvm.org/doxygen/classllvm_1_1ScalarEvolution.html#a30bd18ac905eacf3601bc6a553a9ff49).
...
implemented in
[LoopRotation.h](https://llvm.org/doxygen/LoopRotation_8h_source.html).  Example:
