...
[gold linker] which supports LTO via plugins. This is the same mechanism
used by the [GCC LTO] project.
...
[gcc lto]: http://gcc.gnu.org/wiki/LinkTimeOptimization
[gold linker]: http://sourceware.org/binutils
[gold plugin interface]: http://gcc.gnu.org/wiki/whopr/driver
