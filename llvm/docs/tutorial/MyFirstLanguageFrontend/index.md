...
- [Chapter #1: Kaleidoscope language and Lexer](LangImpl01.html) -
...
- [Chapter #5: Extending the Language: Control Flow](LangImpl05.html) - With
  ...
  flow.
- [Chapter #6: Extending the Language: User-defined Operators](LangImpl06.html) - This chapter extends the language to let
...
- [Chapter #7: Extending the Language: Mutable Variables](LangImpl07.html) - This chapter talks about adding user-defined local
