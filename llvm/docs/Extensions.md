...
1. Function Entry Count - Number of times the function was called as taken
...
1. Branch Probabilities - Encoded as raw numerator for branch probability
...
1. Post-Link CFG - When enabled, the PGO Analysis Map will include CFG
...
This section contains the instructions that make up a [CFI jump table].
...
[CFI jump table]: https://clang.llvm.org/docs/ControlFlowIntegrityDesign.html#forward-edge-cfi-for-indirect-function-calls
