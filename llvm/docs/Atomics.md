...
* The C++ `<atomic>` header and C `<stdatomic.h>` headers. These
  ...
  or the unofficial [latest C++ draft]. A [C2x draft] is
...
[C++20 draft standard]: https://isocpp.org/files/papers/N4860.pdf
[latest C++ draft]: https://eel.is/c++draft/
[C2x draft]: https://www.open-std.org/jtc1/sc22/wg14/www/docs/n3047.pdf
[Java Specification]: http://docs.oracle.com/javase/specs/jls/se8/html/jls-17.html
[Description]: https://gcc.gnu.org/onlinedocs/gcc/_005f_005fsync-Builtins.html
...
lead to undefined results in a concurrent environment; see {ref}`NotAtomic`. This
...
ordering; see {ref}`Atomic orderings`.
...
Acquire/Release. (See also {ref}`LangRef Ordering <ordering>`.)
...
: This is intended to match shared variables in C/C++, and to be used in any
  ...
  precise definition is in {ref}`LangRef Memory Model <memmodel>`.)
...
: Introducing loads to shared variables along a codepath where they would not
  ...
  {ref}`Optimization outside atomic`.
...
[GCC's documentation]: https://gcc.gnu.org/wiki/Atomic/GCCMM/LIbrary
...
a function which on older CPUs contains a "magically-restartable" atomic sequence
...
[provides]: https://www.kernel.org/doc/Documentation/arm/kernel_user_helpers.txt
