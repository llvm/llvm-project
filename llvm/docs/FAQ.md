...
[Clang](https://clang.llvm.org/). Many other language frontends have
been written using LLVM; an incomplete list is available at
[projects with LLVM](https://llvm.org/ProjectsWithLLVM/).
...
See {doc}`The Often Misunderstood GEP Instruction <GetElementPtr>`.
