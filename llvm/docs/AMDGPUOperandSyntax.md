...
* - Syntax
  - Description
* - **[Vm**, **Vn**, … **Vk]**
  - A sequence of 32-bit *vector* registers.
...
(amdgpu_synid_exec_lo)=

(amdgpu_synid_exec_hi)=
...
(amdgpu_synid_floating-point_number)=
...
(amdgpu_synid_absolute_expression)=
...
(amdgpu_synid_relocatable_expression)=
...
(amdgpu_synid_expression_bin_op)=
