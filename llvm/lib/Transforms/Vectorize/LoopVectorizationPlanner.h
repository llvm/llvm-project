...
void reportVectorizationFailure(const LoopVectorizeHints *Hints,
...
inline void reportVectorizationFailure(const LoopVectorizeHints *Hints,
                                       const StringRef DebugMsg,
                                       const StringRef ORETag,
                                       OptimizationRemarkEmitter *ORE,
                                       const Loop *TheLoop,
                                       Instruction *I = nullptr) {
  reportVectorizationFailure(Hints, DebugMsg, DebugMsg, ORETag, ORE, TheLoop,
                             I);
}
...
/// remark.
void reportVectorizationInfo(const LoopVectorizeHints *Hints,
                             const StringRef Msg, const StringRef ORETag,
                             OptimizationRemarkEmitter *ORE,
                             const Loop *TheLoop, Instruction *I = nullptr,
                             DebugLoc DL = {});
...
void reportVectorization(const LoopVectorizeHints *Hints,
