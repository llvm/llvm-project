...
static Instruction *processUZExtIdiom(ICmpInst &I, Value *Val,
  ...
  if (Opcode == Instruction::Add) {
    ...
    OverflowCheck = Builder.CreateICmpULT(ArithResult, ResultA, "add.overflow");
  } else {
  ...
  // The original icmp gets replaced with the overflow check, maybe inverted
  if (I.getPredicate() == ICmpInst::ICMP_ULT)
    return BinaryOperator::CreateNot(OverflowCheck);

  // Otherwise, use the icmp directly.
