...
extern const AOT_OFFLOADARCH_TO_STRING AOT_OFFLOADARCHS[] = {
    {AOT_GFX1010, "gfx1010"}, {AOT_GFX1011, "gfx1011"},
    {AOT_GFX1012, "gfx1012"}, {AOT_GFX1030, "gfx1030"},
    {AOT_GFX1031, "gfx1031"}, {AOT_GFX1032, "gfx1032"},
    {AOT_GFX1033, "gfx1033"}, {AOT_GFX700, "gfx700"},
    {AOT_GFX701, "gfx701"},   {AOT_GFX801, "gfx801"},
    {AOT_GFX802, "gfx802"},   {AOT_GFX803, "gfx803"},
    {AOT_GFX900, "gfx900"},   {AOT_GFX902, "gfx902"},
    {AOT_GFX904, "gfx904"},   {AOT_GFX906, "gfx906"},
    {AOT_GFX908, "gfx908"},   {AOT_GFX90A, "gfx90a"},
    {AOT_SM_30, "sm_30"},     {AOT_SM_35, "sm_35"},
    {AOT_SM_50, "sm_50"},     {AOT_SM_60, "sm_60"},
    {AOT_SM_61, "sm_61"},     {AOT_SM_70, "sm_70"},
};
extern const AOT_TABLE_ENTRY AOT_TABLE[] = {
    {0x1002, 0x1304, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1305, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1306, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1307, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1309, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130A, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130B, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130C, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130D, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130E, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x130F, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1310, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1311, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1312, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1313, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1315, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1316, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1317, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x1318, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x131B, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x131C, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x131D, AOT_CN_KAVERI, AOT_GFX700},
    {0x1002, 0x15D8, AOT_CN_RAVEN, AOT_GFX902},
    {0x1002, 0x15DD, AOT_CN_RAVEN, AOT_GFX902},
    {0x1002, 0x1636, AOT_CN_RENOIR, AOT_GFX902},
    {0x1002, 0x1638, AOT_CN_RENOIR, AOT_GFX902},
    {0x1002, 0x163F, AOT_CN_VANGOGH, AOT_GFX1033},
    {0x1002, 0x164C, AOT_CN_RENOIR, AOT_GFX902},
