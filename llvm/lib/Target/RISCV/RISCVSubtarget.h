...
#include "RISCVGenSubtargetInfo.inc"
  ...
  bool hasVInstructionsBF16Minimal() const { return HasStdExtZvfbfmin || HasStdExtZvfbfa; }
  bool hasVInstructionsF32() const { return HasStdExtZve32f; }
  bool hasVInstructionsF64() const { return HasStdExtZve64d; }
  bool hasVInstructionsBF16() const { return HasStdExtZvfbfmin || HasStdExtZvfbfa; }
