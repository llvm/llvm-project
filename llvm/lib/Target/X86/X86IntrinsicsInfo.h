...
static const IntrinsicData IntrinsicsWithoutChain[] = {
    ...
    X86_INTRINSIC_DATA(avx_max_pd_256, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(avx_max_ps_256, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(avx_min_pd_256, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    X86_INTRINSIC_DATA(avx_min_ps_256, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    ...
    X86_INTRINSIC_DATA(avx10_vmaxbf16128, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(avx10_vmaxbf16256, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(avx10_vmaxbf16512, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(avx10_vminbf16128, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    X86_INTRINSIC_DATA(avx10_vminbf16256, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    X86_INTRINSIC_DATA(avx10_vminbf16512, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    ...
    X86_INTRINSIC_DATA(avx512_max_pd_512, INTR_TYPE_2OP_SAE, ISD::PSEUDO_FMAX,
                       X86ISD::FMAX_SAE),
    X86_INTRINSIC_DATA(avx512_max_ps_512, INTR_TYPE_2OP_SAE, ISD::PSEUDO_FMAX,
                       X86ISD::FMAX_SAE),
    X86_INTRINSIC_DATA(avx512_min_pd_512, INTR_TYPE_2OP_SAE, ISD::PSEUDO_FMIN,
                       X86ISD::FMIN_SAE),
    X86_INTRINSIC_DATA(avx512_min_ps_512, INTR_TYPE_2OP_SAE, ISD::PSEUDO_FMIN,
                       X86ISD::FMIN_SAE),
    ...
    X86_INTRINSIC_DATA(avx512fp16_maskz_vfmadd_csh, CFMA_OP_MASKZ,
                       X86ISD::VFMADDCSH, X86ISD::VFMADDCSH_RND),
    X86_INTRINSIC_DATA(avx512fp16_max_ph_128, INTR_TYPE_2OP, ISD::PSEUDO_FMAX,
                       0),
    X86_INTRINSIC_DATA(avx512fp16_max_ph_256, INTR_TYPE_2OP, ISD::PSEUDO_FMAX,
                       0),
    X86_INTRINSIC_DATA(avx512fp16_max_ph_512, INTR_TYPE_2OP_SAE,
                       ISD::PSEUDO_FMAX, X86ISD::FMAX_SAE),
    X86_INTRINSIC_DATA(avx512fp16_min_ph_128, INTR_TYPE_2OP, ISD::PSEUDO_FMIN,
                       0),
    X86_INTRINSIC_DATA(avx512fp16_min_ph_256, INTR_TYPE_2OP, ISD::PSEUDO_FMIN,
                       0),
    X86_INTRINSIC_DATA(avx512fp16_min_ph_512, INTR_TYPE_2OP_SAE,
                       ISD::PSEUDO_FMIN, X86ISD::FMIN_SAE),
    ...
    X86_INTRINSIC_DATA(sse_max_ps, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(sse_max_ss, INTR_TYPE_2OP, X86ISD::FMAXS, 0),
    X86_INTRINSIC_DATA(sse_min_ps, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
    ...
    X86_INTRINSIC_DATA(sse2_max_pd, INTR_TYPE_2OP, ISD::PSEUDO_FMAX, 0),
    X86_INTRINSIC_DATA(sse2_max_sd, INTR_TYPE_2OP, X86ISD::FMAXS, 0),
    X86_INTRINSIC_DATA(sse2_min_pd, INTR_TYPE_2OP, ISD::PSEUDO_FMIN, 0),
