  ...
  if (STI.hasHWMult16()) {
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::MUL_I16, RTLIB::LibcallImpl::Impl___mspabi_mpyi_hw},
        {RTLIB::MUL_I32, RTLIB::LibcallImpl::Impl___mspabi_mpyl_hw32},
        {RTLIB::MUL_I64, RTLIB::LibcallImpl::Impl___mspabi_mpyll_hw32},
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::MUL_I16, RTLIB::LibcallImpl::Impl___mspabi_mpyi_f5hw},
        {RTLIB::MUL_I32, RTLIB::LibcallImpl::Impl___mspabi_mpyl_f5hw},
        {RTLIB::MUL_I64, RTLIB::LibcallImpl::Impl___mspabi_mpyll_f5hw},
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::MUL_I16, RTLIB::LibcallImpl::Impl___mspabi_mpyi},
        {RTLIB::MUL_I32, RTLIB::LibcallImpl::Impl___mspabi_mpyl},
        {RTLIB::MUL_I64, RTLIB::LibcallImpl::Impl___mspabi_mpyll},
