...
public:
  ...
  bool isSImm12addlike() const {
    ...
    bool IsValidKind =
        ...
        VK == ELF::R_LARCH_TLS_LE_LO12_R || VK == ELF::R_LARCH_PCADD_LO12 ||
  ...
  bool isUImm12ori() const {
    ...
    bool IsValidKind =
        ...
        VK == ELF::R_LARCH_TLS_DESC_LO12 || VK == ELF::R_LARCH_PCADD_LO12;
    return IsConstantImm
...
void LoongArchAsmParser::emitLoadAddressGot(MCInst &Inst, SMLoc IDLoc,
  ...
  unsigned LDRel =
      has32S() ? ELF::R_LARCH_GOT_PC_LO12 : ELF::R_LARCH_PCADD_LO12;
...
void LoongArchAsmParser::emitLoadAddressTLSIE(MCInst &Inst, SMLoc IDLoc,
  ...
  unsigned LDRel =
      has32S() ? ELF::R_LARCH_TLS_IE_PC_LO12 : ELF::R_LARCH_PCADD_LO12;
...
void LoongArchAsmParser::emitLoadAddressTLSDesc(MCInst &Inst, SMLoc IDLoc,
  ...
  unsigned ADDIRel =
      has32S() ? ELF::R_LARCH_TLS_DESC_PC_LO12 : ELF::R_LARCH_PCADD_LO12;
  InstSeq Insts;
