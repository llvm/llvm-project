...
performSIGN_EXTEND_INREGCombine(SDNode *N,
  ...
  // We have to do this because the original combiner doesn't work when
  // SEXTLOAD has custom lowering
  ...
  // load has one use. Doing otherwise can block folding the extload with
