...
#include "GISel/WebAssemblyInstructionSelector.h"
...
class WebAssemblySubtarget final : public WebAssemblyGenSubtargetInfo {
  ...
  std::unique_ptr<WebAssemblyCallLowering> CallLowering;
  std::unique_ptr<WebAssemblyInstructionSelector> InstSelector;
  std::unique_ptr<WebAssemblyLegalizerInfo> Legalizer;
  std::unique_ptr<WebAssemblyRegisterBankInfo> RegBankInfo;
...
public:
  ...
  const WebAssemblyCallLowering *getCallLowering() const override {
    return CallLowering.get();
  }

  WebAssemblyInstructionSelector *getInstructionSelector() const override {
    return InstSelector.get();
  }

  const WebAssemblyLegalizerInfo *getLegalizerInfo() const override {
    return Legalizer.get();
  }

  const WebAssemblyRegisterBankInfo *getRegBankInfo() const override {
