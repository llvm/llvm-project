...
SIInstrInfo::getIndirectGPRIDXPseudo(unsigned VecSize,
  ...
  if (IsIndirectSrc) {
    ...
    if (VecSize <= 576) // 72 bytes
      return get(AMDGPU::V_INDIRECT_REG_READ_GPR_IDX_B32_V18);
  ...
  if (VecSize <= 576) // 72 bytes
    return get(AMDGPU::V_INDIRECT_REG_WRITE_GPR_IDX_B32_V18);
  if (VecSize <= 1024) // 128 bytes
...
static unsigned getIndirectVGPRWriteMovRelPseudoOpc(unsigned VecSize) {
  ...
  if (VecSize <= 576) // 72 bytes
    return AMDGPU::V_INDIRECT_REG_WRITE_MOVREL_B32_V18;
  if (VecSize <= 1024) // 128 bytes
...
static unsigned getIndirectSGPRWriteMovRelPseudo32(unsigned VecSize) {
  ...
  if (VecSize <= 576) // 72 bytes
    return AMDGPU::S_INDIRECT_REG_WRITE_MOVREL_B32_V18;
  if (VecSize <= 1024) // 128 bytes
...
static unsigned getAGPRSpillSaveOpcode(unsigned Size) {
  ...
  case 72:
    return AMDGPU::SI_SPILL_A576_SAVE;
  case 128:
...
static unsigned getSGPRSpillRestoreOpcode(unsigned Size) {
  ...
  case 72:
    return AMDGPU::SI_SPILL_S576_RESTORE;
  case 128:
...
static unsigned getVGPRSpillRestoreOpcode(unsigned Size) {
  ...
  case 72:
    return AMDGPU::SI_SPILL_V576_RESTORE;
  case 128:
...
static unsigned getAGPRSpillRestoreOpcode(unsigned Size) {
  ...
  case 72:
    return AMDGPU::SI_SPILL_A576_RESTORE;
  case 128:
...
static unsigned getAVSpillRestoreOpcode(unsigned Size) {
  ...
  case 72:
    return AMDGPU::SI_SPILL_AV576_RESTORE;
  case 128:
...
bool SIInstrInfo::expandPostRAPseudo(MachineInstr &MI) const {
  ...
  case AMDGPU::S_INDIRECT_REG_WRITE_MOVREL_B32_V18:
  ...
  case AMDGPU::V_INDIRECT_REG_WRITE_GPR_IDX_B32_V18:
  ...
  case AMDGPU::V_INDIRECT_REG_READ_GPR_IDX_B32_V18:
...
bool SIInstrInfo::foldImmediate(MachineInstr &UseMI, MachineInstr &DefMI,
  ...
  if (Opc == AMDGPU::V_MAD_F32_e64 || Opc == AMDGPU::V_MAC_F32_e64 ||
    ...
    bool IsF32 = Opc == AMDGPU::V_MAD_F32_e64 || Opc == AMDGPU::V_MAC_F32_e64 ||
                 Opc == AMDGPU::V_FMA_F32_e64 || Opc == AMDGPU::V_FMAC_F32_e64;
    bool IsF64 = Opc == AMDGPU::V_FMA_F64_e64 || Opc == AMDGPU::V_FMAC_F64_e64;
    bool IsFMA =
        Opc == AMDGPU::V_FMA_F32_e64 || Opc == AMDGPU::V_FMAC_F32_e64 ||
        Opc == AMDGPU::V_FMA_F16_e64 || Opc == AMDGPU::V_FMAC_F16_e64 ||
        Opc == AMDGPU::V_FMA_F64_e64 || Opc == AMDGPU::V_FMAC_F64_e64 ||
    ...
    if ((Src0->isReg() && Src0->getReg() == Reg) ||
      ...
      if (Opc == AMDGPU::V_MAC_F32_e64 || Opc == AMDGPU::V_MAC_F16_e64 ||
          Opc == AMDGPU::V_FMAC_F32_e64 || Opc == AMDGPU::V_FMAC_F16_fake16_e64 ||
...
MachineInstr *SIInstrInfo::convertToThreeAddress(MachineInstr &MI,
  ...
  if (!Src0Mods && !Src1Mods && !Src2Mods && !Clamp && !Omod && !IsLegacy &&
      (!IsF64 || (ST.hasFmaakFmamkF64Insts() && IsFMA)) &&
...
SIInstrInfo::legalizeOperands(MachineInstr &MI,
  ...
  case AMDGPU::V_CVT_TO_TENSOR_BF16_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF16_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_BF8_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_F16_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_F16_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_F16_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_F16_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_F16_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_F16_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_F16_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_F16_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_F16_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_FP8_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I4_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I4_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_I4_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I4_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I4_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I4_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_I4_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I4_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I4_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I8_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I8_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_I8_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I8_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I8_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_I8_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_I8_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I8_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_I8_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U4_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F32_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F32_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F32_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U4_F32_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U8_BF16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U8_BF16_4x4x16:
  case AMDGPU::V_CVT_TO_TENSOR_U8_BF16_4x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U8_BF16_8x4x8:
  case AMDGPU::V_CVT_TO_TENSOR_U8_F16_4x2x16:
  case AMDGPU::V_CVT_TO_TENSOR_U8_F16_4x4x16:
