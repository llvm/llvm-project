...
RegBankLegalizeRules::RegBankLegalizeRules(const GCNSubtarget &_ST,
  ...
  addRulesForGOpcs({G_LOAD})
      ...
      .Any({{{UniS16, P1}, !isAlign4 || !isUL}, {{UniInVgprS16}, {SgprP1}}}, usesTrue16 && !hasSMRDSmall) // s16 load to 32-bit load
      ...
      .Any({{{UniS16, P4}, !isAlign4 || !isUL}, {{UniInVgprS16}, {SgprP4}}}, usesTrue16 && !hasSMRDSmall) // s16 load to 32-bit load
