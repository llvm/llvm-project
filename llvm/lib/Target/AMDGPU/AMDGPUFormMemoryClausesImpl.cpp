...
bool AMDGPUFormMemoryClausesImpl::canBundle(const MachineInstr &MI,
                                            const RegUse &Defs,
...
bool AMDGPUFormMemoryClausesImpl::checkPressure(const MachineInstr &MI,
...
void AMDGPUFormMemoryClausesImpl::collectRegUses(const MachineInstr &MI,
                                                 RegUse &Defs,
                                                 RegUse &Uses) const {
  for (const MachineOperand &MO : MI.operands()) {
    if (!MO.isReg())
...
bool AMDGPUFormMemoryClausesImpl::processRegUses(const MachineInstr &MI,
...
bool AMDGPUFormMemoryClausesImpl::run(MachineFunction &MF) {
