...
public:
  ...
  void cvtVOPC64NoDstDPP(MCInst &Inst, const OperandVector &Operands, bool IsDPP8 = false);
  void cvtVOPC64NoDstDPP8(MCInst &Inst, const OperandVector &Operands) { cvtVOPC64NoDstDPP(Inst, Operands, true); }
