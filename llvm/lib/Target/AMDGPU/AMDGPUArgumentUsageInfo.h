...
struct AMDGPUFunctionArgInfo {
  ...
  enum PreloadedValue {
    ...
    CLUSTER_WORKGROUP_ID_X = 18,
    CLUSTER_WORKGROUP_ID_Y = 19,
    CLUSTER_WORKGROUP_ID_Z = 20,
    CLUSTER_WORKGROUP_MAX_ID_X = 21,
    CLUSTER_WORKGROUP_MAX_ID_Y = 22,
    CLUSTER_WORKGROUP_MAX_ID_Z = 23,
    CLUSTER_WORKGROUP_MAX_FLAT_ID = 24,
