...
*/
  // ComplexPattern select helpers.
  bool selectAddrRr(SDValue Addr, SDValue &Base, SDValue &Offset);
  bool selectAddrRi(SDValue Addr, SDValue &Base, SDValue &Offset);
  bool selectAddrRs(SDValue Addr, SDValue &Base, SDValue &Offset);
...
// Helper functions for ComplexPattern.
bool M88kDAGToDAGISel::selectAddrRr(SDValue Addr, SDValue &Base,
                                    SDValue &Offset) {
  return false;
}
...
bool M88kDAGToDAGISel::selectAddrRs(SDValue Addr, SDValue &Base,
                                    SDValue &Offset) {
  return false;
}
