...
SparcTargetLowering::SparcTargetLowering(const TargetMachine &TM,
  ...
  if (Subtarget->hasHardQuad()) {
    ...
    if (Subtarget->is64Bit() && !Subtarget->useSoftFloat()) {
      setLibcallImpl(RTLIB::ADD_F128, RTLIB::LibcallImpl::Impl__Qp_add);
      setLibcallImpl(RTLIB::SUB_F128, RTLIB::LibcallImpl::Impl__Qp_sub);
      setLibcallImpl(RTLIB::MUL_F128, RTLIB::LibcallImpl::Impl__Qp_mul);
      setLibcallImpl(RTLIB::DIV_F128, RTLIB::LibcallImpl::Impl__Qp_div);
      setLibcallImpl(RTLIB::SQRT_F128, RTLIB::LibcallImpl::Impl__Qp_sqrt);
      setLibcallImpl(RTLIB::FPTOSINT_F128_I32,
                     RTLIB::LibcallImpl::Impl__Qp_qtoi);
      setLibcallImpl(RTLIB::FPTOUINT_F128_I32,
                     RTLIB::LibcallImpl::Impl__Qp_qtoui);
      setLibcallImpl(RTLIB::SINTTOFP_I32_F128,
                     RTLIB::LibcallImpl::Impl__Qp_itoq);
      setLibcallImpl(RTLIB::UINTTOFP_I32_F128,
                     RTLIB::LibcallImpl::Impl__Qp_uitoq);
      setLibcallImpl(RTLIB::FPTOSINT_F128_I64,
                     RTLIB::LibcallImpl::Impl__Qp_qtox);
      setLibcallImpl(RTLIB::FPTOUINT_F128_I64,
                     RTLIB::LibcallImpl::Impl__Qp_qtoux);
      setLibcallImpl(RTLIB::SINTTOFP_I64_F128,
                     RTLIB::LibcallImpl::Impl__Qp_xtoq);
      setLibcallImpl(RTLIB::UINTTOFP_I64_F128,
                     RTLIB::LibcallImpl::Impl__Qp_uxtoq);
      setLibcallImpl(RTLIB::FPEXT_F32_F128, RTLIB::LibcallImpl::Impl__Qp_stoq);
      setLibcallImpl(RTLIB::FPEXT_F64_F128, RTLIB::LibcallImpl::Impl__Qp_dtoq);
      setLibcallImpl(RTLIB::FPROUND_F128_F32,
                     RTLIB::LibcallImpl::Impl__Qp_qtos);
      setLibcallImpl(RTLIB::FPROUND_F128_F64,
                     RTLIB::LibcallImpl::Impl__Qp_qtod);
    } else if (!Subtarget->useSoftFloat()) {
      setLibcallImpl(RTLIB::ADD_F128, RTLIB::LibcallImpl::Impl__Q_add);
      setLibcallImpl(RTLIB::SUB_F128, RTLIB::LibcallImpl::Impl__Q_sub);
      setLibcallImpl(RTLIB::MUL_F128, RTLIB::LibcallImpl::Impl__Q_mul);
      setLibcallImpl(RTLIB::DIV_F128, RTLIB::LibcallImpl::Impl__Q_div);
      setLibcallImpl(RTLIB::SQRT_F128, RTLIB::LibcallImpl::Impl__Q_sqrt);
      setLibcallImpl(RTLIB::FPTOSINT_F128_I32,
                     RTLIB::LibcallImpl::Impl__Q_qtoi);
      setLibcallImpl(RTLIB::FPTOUINT_F128_I32,
                     RTLIB::LibcallImpl::Impl__Q_qtou);
      setLibcallImpl(RTLIB::SINTTOFP_I32_F128,
                     RTLIB::LibcallImpl::Impl__Q_itoq);
      setLibcallImpl(RTLIB::UINTTOFP_I32_F128,
                     RTLIB::LibcallImpl::Impl__Q_utoq);
      setLibcallImpl(RTLIB::FPEXT_F32_F128, RTLIB::LibcallImpl::Impl__Q_stoq);
      setLibcallImpl(RTLIB::FPEXT_F64_F128, RTLIB::LibcallImpl::Impl__Q_dtoq);
      setLibcallImpl(RTLIB::FPROUND_F128_F32, RTLIB::LibcallImpl::Impl__Q_qtos);
      setLibcallImpl(RTLIB::FPROUND_F128_F64, RTLIB::LibcallImpl::Impl__Q_qtod);
    }
  }
