...
const llvm::fltSemantics &llvm::getFltSemanticForLLT(LLT Ty) {
  // TODO: strengthen assertion by asserting isFloat() once LLT has transitioned
  // from scalars to integers and floats.
  ...
  // TODO: assert isIEEEFloat() once LLT has transitioned from scalars to
  // integers and floats.
  // assert(Ty.isIEEEFloat() && "Unhandled variant float type");
