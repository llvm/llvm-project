...
LLVM_FUNC_ABI cl::opt<double> CopyWeight("regalloc-copy-weight", cl::init(0.2), cl::Hidden);
LLVM_FUNC_ABI cl::opt<double> LoadWeight("regalloc-load-weight", cl::init(4.0), cl::Hidden);
LLVM_FUNC_ABI cl::opt<double> StoreWeight("regalloc-store-weight", cl::init(1.0), cl::Hidden);
LLVM_FUNC_ABI cl::opt<double> CheapRematWeight("regalloc-cheap-remat-weight", cl::init(0.2),
                                 cl::Hidden);
LLVM_FUNC_ABI cl::opt<double> ExpensiveRematWeight("regalloc-expensive-remat-weight",
