...
static cl::opt<bool> EmitVRMState(
    "mir-emit-vrm", cl::Hidden, cl::init(false),
    cl::desc("Serialize VirtRegMap state (split-from, assigned-phys) into "
             "MIR YAML when a VirtRegMap is available"));
