...
public:
  SQELFObjectWriter(std::unique_ptr<MCSQELFObjectTargetWriter> MOTW, raw_pwrite_stream &OS)
...
uint64_t SQELFObjectWriter::writeObject(MCAssembler &Asm, const MCAsmLayout &Layout) {
    return 0;
}
