...
ModulePassManager PassBuilder::buildThinLTODefaultPipeline(
  ...
  if (ImportSummary) {
    ...
    MPM.addPass(ObjCConstantIvarOffsetPass(ImportSummary));
  }
...
PassBuilder::buildLTODefaultPipeline(OptimizationLevel Level,
  ...
  // Promote ObjC ivar offset globals to constants with pre-sliding.
  MPM.addPass(ObjCConstantIvarOffsetPass(/*ImportSummary=*/nullptr));
