...
#include "mmul_dir.h"
  ...
  real*16, dimension( ldc, * )::c
  real*16 :: alpha, beta, one = 1.0_16
  ...
  real*16   :: temp, temp0, temp1, temp2, temp3
  real*16   :: bufatemp, bufbtemp
  real*16   :: time_start, time_end, ttime, all_time

  integer, parameter :: bufrows = 512, bufcols = 8192
!  integer, parameter :: bufrows = 2, bufcols = 3
!  real*16, dimension( bufrows * bufcols ) :: buffera, bufferb
  real*16, allocatable, dimension(:) :: buffera, bufferb
