...
/** \file
 * \brief F90  MATMUL intrinsics for COMPLEX*16 type
 */
...
void ENTF90(MATMUL_CPLX16, matmul_cplx16)(char *dest_addr, char *s1_addr,
                                          ...
                                          F90_Desc *s1_desc, F90_Desc *s2_desc)
{
  ...
  __CPLX16_T *s1_base;
  __CPLX16_T *s2_base;
  __CPLX16_T *dest_base;
  __CPLX16_T *d_elem_p;
  __CPLX16_T *s1_elem_p;
  __CPLX16_T *s2_elem_p;
  ...
  s1_base = (__CPLX16_T *)s1_addr + F90_LBASE_G(s1_desc) +
            s1_d1_lb * s1_d1_lstride + s1_d2_lb * s1_d2_lstride - 1;
  s2_base = (__CPLX16_T *)s2_addr + F90_LBASE_G(s2_desc) +
            s2_d1_lb * s2_d1_lstride + s2_d2_lb * s2_d2_lstride - 1;
  dest_base = (__CPLX16_T *)dest_addr + F90_LBASE_G(dest_desc) +
  ...
  if ((s1_d1_sstride == 1) && (s2_d1_sstride == 1) && (d_d1_sstride == 1) &&
    ...
    if (s2_rank == 1) {
      F90_MATMUL(cplx16_str1_mxv)( dest_base + d_d1_soffset*d_d1_lstride +
      ...
      F90_MATMUL(cplx16_str1_vxm)( dest_base + d_d1_soffset*d_d1_lstride +
                                            d_d2_soffset*d_d2_lstride,
                                     s1_base + s1_d1_soffset * s1_d1_lstride,
                                     s2_base + s2_d2_soffset * s2_d2_lstride,
                                     &k_extent,&m_extent,
      ...
      F90_MATMUL(cplx16_str1)(dest_base + d_d1_soffset*d_d1_lstride +
                                            d_d2_soffset*d_d2_lstride,
                                     s1_base + s1_d1_soffset * s1_d1_lstride,
                                     s2_base + s2_d2_soffset * s2_d2_lstride,
