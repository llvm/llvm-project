...
/** \file
 * \brief F90  MATMUL intrinsics for real*16 type
 */
...
void ENTF90(MATMUL_REAL16, matmul_real16)(char *dest_addr, char *s1_addr,
                                        ...
                                        F90_Desc *s1_desc, F90_Desc *s2_desc)
{
  ...
  if ((s1_d1_sstride == 1) && (s2_d1_sstride == 1) && (d_d1_sstride == 1) &&
    ...
    if (s2_rank == 1) {
      F90_MATMUL(real16_str1_mxv)(dest_base + d_d1_soffset * d_d1_lstride +
      ...
      F90_MATMUL(real16_str1_vxm)(dest_base + d_d1_soffset * d_d1_lstride +
                                  d_d2_soffset * d_d2_lstride,
                                  s1_base + s1_d1_soffset * s1_d1_lstride,
                                  s2_base + s2_d2_soffset * s2_d2_lstride,
                                  &k_extent, &m_extent,
      ...
      F90_MATMUL(real16_str1)(dest_base + d_d1_soffset * d_d1_lstride +
                              d_d2_soffset * d_d2_lstride,
                              s1_base + s1_d1_soffset * s1_d1_lstride,
                              s2_base + s2_d2_soffset * s2_d2_lstride,
