...
{
  double_complex_t (*fptr)(vrd1_t);
  _MTH_I_INIT();
  _MTH_I_STATS_INC(func_sincos,sv_ds,frp_f);
  fptr = (double_complex_t(*)(vrd1_t))MTH_DISPATCH_TBL[func_sincos][sv_ds][frp_f];
  return (fptr(x));
}
...
MTH_DISPATCH_FUNC(__rd_sincos_1)(vrd1_t x)
{
  ...
  fptr = (double_complex_t(*)(vrd1_t))MTH_DISPATCH_TBL[func_sincos][sv_ds][frp_r];
  return (fptr(x));
}
...
MTH_DISPATCH_FUNC(__pd_sincos_1)(vrd1_t x)
{
  ...
  fptr = (double_complex_t(*)(vrd1_t))MTH_DISPATCH_TBL[func_sincos][sv_ds][frp_p];
  return (fptr(x));
}
