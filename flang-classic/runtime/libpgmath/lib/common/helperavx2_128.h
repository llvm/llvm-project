...
static INLINE vint2 vsll64_vi2_vi2_i(vint2 x, int c) { return _mm_slli_epi64(x, c); }
static INLINE vint2 vsrl64_vi2_vi2_i(vint2 x, int c) { return _mm_srli_epi64(x, c); }
