...
log10_vec(vfloat const a_input)
{
    vfloat m, e, t;
    vint2 u;
    vopmask o;

    m = (vfloat)vsub_vi2_vi2_vi2((vint2)a_input, *(vint2*)MAGIC_F_LEGACY);
    e = (vfloat)vsra_vi2_vi2_i((vint2)m, 23);
    m = (vfloat)vand_vi2_vi2_vi2((vint2)m, *(vint2*)MANTISSA_MASK);
    m = (vfloat)vadd_vi2_vi2_vi2((vint2)m, *(vint2*)MAGIC_F_LEGACY);

    e = vcast_vf_vi2((vint2)e);
    e = vmul_vf_vf_vf(e, *(vfloat*)LOG10_2_F);
    ...
    if (__builtin_expect(!vtestz_i_vo(o), 0)) {
        ...
        m = (vfloat)vsub_vi2_vi2_vi2((vint2)a2p24, *(vint2*)MAGIC_F_LEGACY);
        ...
        den_out = vfma_vf_vf_vf_vf(den_out, m, e);
