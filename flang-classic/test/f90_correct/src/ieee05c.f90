...
!
l1 = .false.
call ieee_set_halting_mode(ieee_underflow, l1)
call ieee_get_halting_mode(ieee_underflow, l2)
call check(l1,l2,1)
!
l1 = .true.
call ieee_set_halting_mode(ieee_underflow, l1)
...
call flush(6)
!
! If check is compiled with -Mchkfpstk, it might clobber the exception bits.
! Annoying?  Yes!
call ieee_set_halting_mode(ieee_underflow, l1)
call ieee_get_halting_mode(ieee_underflow, l2)
call __pgfortran_gen_underflow(a)
call __pgfortran_gen_safe_op(a)
