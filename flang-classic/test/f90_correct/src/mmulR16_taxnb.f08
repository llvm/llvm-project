...
program mtaxnb
    ...
    real(kind=16), dimension(m_extent, k_extent) :: arr2
    ...
    arr4 = 0.0_16
    arr4 = matmul(transpose(arr1(1:mm_extent, 1:mn_extent)), arr2(1:mm_extent, 1:mk_extent))
    call assign_value(401, 700, arr4, result)
    
    arr5 = 0.0_16
    arr5 = matmul(transpose(arr1(1:sm_extent, 1:sn_extent)), arr2(1:sm_extent, 1:sk_extent))
