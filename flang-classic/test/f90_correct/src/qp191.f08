...
program test
  ...
  do i = 1, n
    write(s(i), 100, round='zero') r(i)
  enddo
 
  if(s(1) == "        123.4567891234567891234567891234E+0015") result(1) = 1
  if(s(2) == "        123.4567891234567891234567891234E+0033") result(2) = 1
  if(s(3) == "        123.4567891234567891234567891234E-0003") result(3) = 1
  ...
  if(s(16) == "        192.5929944387235853055977942584E-0036") result(16) = 1
