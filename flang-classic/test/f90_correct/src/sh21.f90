...
! one dimension out of two
	program p
	 ...
	 eopc=eoshift(src, 1, dim=1)	! eoshift, positive, constant
	 eopv=eoshift(src, j, dim=1)	! eoshift, positive, variable
	 eomc=eoshift(src,-1, dim=1)	! eoshift, negative, constant
	 eomv=eoshift(src, k, dim=1)	! eoshift, negative, variable
	  cpc= cshift(src, 1, dim=1)	!  cshift, positive, constant
	  cpv= cshift(src, j, dim=1)	!  cshift, positive, variable
	  cmc= cshift(src,-1, dim=1)	!  cshift, negative, constant
