...
program test
  ...
  if(s(2) == "***********************************") result(2) = 1
  if(s(3) == "***********************************") result(3) = 1
  if(s(4) == "12.3456789123456789123456789123E-18") result(4) = 1
  if(s(5) == " 1.2345678912345678912345678912E+00") result(5) = 1
  if(s(6) == " 1.2345678912345678912345678912E+09") result(6) = 1
  if(s(7) == "-1.2345678912345678912345678912E+99") result(7) = 1
  if(s(8) == " 1.2345678912345678912345678912+999") result(8) = 1
  if(s(9) == "***********************************") result(9) = 1
  if(s(10) == " 1.2345678912345678912345678912E-03") result(10) = 1
  if(s(11) == "-1.2345678912345678912345678912E-33") result(11) = 1
  if(s(12) == " 1.2345678912345678912345678912-333") result(12) = 1
  if(s(13) == "***********************************") result(13) = 1
  if(s(14) == "***********************************") result(14) = 1
  if(s(15) == "***********************************") result(15) = 1
  if(s(16) == "***********************************") result(16) = 1
  if(s(17) == " 0.0000000000000000000000000000E+00") result(17) = 1
  if(s(18) == "-0.0000000000000000000000000000E+00") result(18) = 1
