...
!
! test for plus operation take quad precision
...
program test
  ...
  if (abs((r1 - 3.38348491200000000000000000000000009_16)/r1) <= eps_q) result(1) = 1
  if (abs((r2 - 2.31458443599999999999999999999999996_16)/r2) <= eps_q) result(2) = 1
  if (abs((r3 - 987777.769301165100000000000000000006_16)/r3) <= eps_q) result(3) = 1
  if (abs((r4 - 2.29999999999999999999999999999999985_16)/r4) <= eps_q) result(4) = 1
