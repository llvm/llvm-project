...
program test
  ...
  if(s(1) == " 0.1234567891234567891234567891D+18") result(1) = 1
  if(s(2) == " 0.1234567891234567891234567891D+36") result(2) = 1
  if(s(3) == " 0.1234567891234567891234567891D+00") result(3) = 1
  if(s(4) == " 0.1234567891234567891234567891D-16") result(4) = 1
  if(s(5) == " 0.1234567891234567891234567891D+01") result(5) = 1
  if(s(6) == " 0.1234567891234567891234567891D+10") result(6) = 1
  if(s(7) == "-0.1234567891234567891234567891+100") result(7) = 1
  if(s(8) == "***********************************") result(8) = 1
  if(s(9) == "***********************************") result(9) = 1
  if(s(10) == " 0.1234567891234567891234567891D-02") result(10) = 1
  if(s(11) == "-0.1234567891234567891234567891D-32") result(11) = 1
  if(s(12) == " 0.1234567891234567891234567891-332") result(12) = 1
  if(s(13) == "***********************************") result(13) = 1
  if(s(14) == "***********************************") result(14) = 1
  if(s(15) == "***********************************") result(15) = 1
  if(s(16) == " 0.1925929944387235853055977943D-33") result(16) = 1
  if(s(17) == " 0.0000000000000000000000000000D+00") result(17) = 1
  if(s(18) == "-0.0000000000000000000000000000D+00") result(18) = 1
  if(s(19) == "                           Infinity") result(19) = 1
  if(s(20) == "                          -Infinity") result(20) = 1
  if(s(21) == "                                NaN") result(21) = 1
  if(s(22) == "                                NaN") result(22) = 1
  100 FORMAT('', D35.28, 5X, D35.28)
