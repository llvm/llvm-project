...
program p
  ...
  integer*2, dimension(4,3) :: arr1
  integer*2, dimension(3) :: arr2
  ...
  integer*2, dimension(2:5,3) :: arr8
  integer*2, dimension(2:4) :: arr9
  integer*2, dimension(2:5) :: arr10
  integer*2, dimension(4,2:4) :: arr11
  integer*2, dimension(2:5) :: arr12
