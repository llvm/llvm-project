...
.LBB5_17:
	adrp	x8, DV10pb
	adrp	x9, DV10pe
	ldr	x12, [x8, :lo12:DV10pb]
	ldr	x8, [x9, :lo12:DV10pe]
	cmp	x12, x8
	b.eq	.LBB5_23
// %bb.18:
	sub	x9, x8, x12
...
// %bb.48:
	adrp	x9, DVpb
	ldr	x21, [x9, :lo12:DVpb]
	adrp	x9, DVpe
	ldr	x23, [x9, :lo12:DVpe]
	cmp	x21, x23
	b.eq	.LBB5_55
// %bb.49:                              // %.preheader17
	mov	x9, #70368744177664             // =0x400000000000
...
// %bb.72:
	adrp	x9, DV10pb
	ldr	x21, [x9, :lo12:DV10pb]
	adrp	x9, DV10pe
	ldr	x23, [x9, :lo12:DV10pe]
	cmp	x21, x23
	b.eq	.LBB5_79
// %bb.73:                              // %.preheader11
	mov	x9, #70368744177664             // =0x400000000000
...
.LBB5_95:
	...
	adrp	x22, dMpe
	movk	w9, #4194, lsl #16
	ldr	x19, [x21, :lo12:dMpb]
	ldr	x20, [x22, :lo12:dMpe]
	smull	x8, w8, w9
	cmp	x19, x20
	asr	x8, x8, #39
	add	w8, w8, w8, lsr #31
	str	w8, [x27, :lo12:iterations]
	b.eq	.LBB5_98
...
.LBB5_113:
	...
	adrp	x19, DVpb
	adrp	x20, DVpe
	ldr	x0, [x22, :lo12:DVMpb]
	ldr	x1, [x8, :lo12:DVMpe]
	ldr	x2, [x19, :lo12:DVpb]
	ldr	x3, [x20, :lo12:DVpe]
	adrp	x4, .L.str.34
	...
	adrp	x8, DVMPb
	adrp	x9, DVMPe
	ldr	x2, [x20, :lo12:DVPb]
	mov	x20, x22
	adrp	x22, DVPe
	ldr	x0, [x8, :lo12:DVMPb]
	ldr	x1, [x9, :lo12:DVMPe]
	ldr	x3, [x22, :lo12:DVPe]
	adrp	x4, .L.str.35
	...
	adrp	x26, DV10pb
	adrp	x23, DV10pe
	ldr	x0, [x21, :lo12:DV10Mpb]
	ldr	x1, [x8, :lo12:DV10Mpe]
	ldr	x2, [x26, :lo12:DV10pb]
	ldr	x3, [x23, :lo12:DV10pe]
	adrp	x4, .L.str.36
	...
	adrp	x24, DV10Pb
	adrp	x19, DV10Pe
	ldr	x0, [x8, :lo12:DV10MPb]
	ldr	x1, [x9, :lo12:DV10MPe]
	ldr	x2, [x24, :lo12:DV10Pb]
	ldr	x3, [x19, :lo12:DV10Pe]
	adrp	x4, .L.str.37
	...
	adrp	x21, dMpb
	adrp	x25, dMpe
	ldr	x0, [x21, :lo12:dMpb]
	ldr	x2, [x28, :lo12:dpb]
	lsl	w8, w8, #3
	ldr	x1, [x25, :lo12:dMpe]
	ldr	x3, [x23, :lo12:dpe]
	adrp	x4, .L.str.38
	...
	ldr	x1, [x23, :lo12:DVMpe]
	ldr	x2, [x19, :lo12:DVpb]
	ldr	x3, [x24, :lo12:DVpe]
	adrp	x4, .L.str.40
	...
	adrp	x28, DVPb
	adrp	x8, DVPe
	ldr	x1, [x25, :lo12:DVMPe]
	ldr	x2, [x28, :lo12:DVPb]
	ldr	x3, [x8, :lo12:DVPe]
	adrp	x4, .L.str.41
	...
	adrp	x8, DV10Mpe
	movi	d0, #0000000000000000
	ldr	x0, [x22, :lo12:DV10Mpb]
	ldr	x1, [x8, :lo12:DV10Mpe]
	adrp	x8, DV10pb
	adrp	x4, .L.str.42
	add	x4, x4, :lo12:.L.str.42
	ldr	x2, [x8, :lo12:DV10pb]
	adrp	x8, DV10pe
