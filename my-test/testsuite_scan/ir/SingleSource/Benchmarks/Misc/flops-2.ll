; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-2.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-2.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %5 = load double, ptr @five, align 8, !tbaa !6
  %6 = fneg double %5
  %7 = load double, ptr @one, align 8, !tbaa !6
  %8 = fneg double %7
  br label %9

9:                                                ; preds = %0, %9
  %10 = phi double [ %6, %0 ], [ %13, %9 ]
  %11 = phi i64 [ 1, %0 ], [ %15, %9 ]
  %12 = phi double [ %8, %0 ], [ %14, %9 ]
  %13 = fneg double %10
  %14 = fsub double %12, %10
  %15 = add nuw nsw i64 %11, 1
  %16 = icmp eq i64 %15, 156250001
  br i1 %16, label %17, label %9, !llvm.loop !10

17:                                               ; preds = %9
  %18 = load double, ptr @two, align 8, !tbaa !6
  br label %19

19:                                               ; preds = %17, %19
  %20 = phi double [ %13, %17 ], [ %25, %19 ]
  %21 = phi i64 [ 1, %17 ], [ %30, %19 ]
  %22 = phi double [ %14, %17 ], [ %26, %19 ]
  %23 = phi double [ 0.000000e+00, %17 ], [ %27, %19 ]
  %24 = phi double [ 0.000000e+00, %17 ], [ %29, %19 ]
  %25 = fneg double %20
  %26 = fadd double %22, %18
  %27 = tail call double @llvm.fmuladd.f64(double %20, double %26, double %23)
  %28 = fdiv double %20, %26
  %29 = fsub double %24, %28
  %30 = add nuw nsw i64 %21, 1
  %31 = icmp eq i64 %30, 156250001
  br i1 %31, label %32, label %19, !llvm.loop !12

32:                                               ; preds = %19
  %33 = load double, ptr @four, align 8, !tbaa !6
  %34 = fmul double %29, %33
  %35 = fdiv double %34, %5
  store double %35, ptr @sa, align 8, !tbaa !6
  %36 = fdiv double %5, %27
  %37 = fadd double %36, %35
  store double %37, ptr @sb, align 8, !tbaa !6
  store double 3.125000e+01, ptr @sc, align 8, !tbaa !6
  %38 = fmul double %27, %27
  %39 = fmul double %27, %38
  %40 = fdiv double 3.125000e+01, %39
  %41 = fsub double %37, %40
  store double %41, ptr @piprg, align 8, !tbaa !6
  %42 = load double, ptr @piref, align 8, !tbaa !6
  %43 = fsub double %41, %42
  store double %43, ptr @pierr, align 8, !tbaa !6
  %44 = fmul double %43, 1.000000e-30
  %45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %44, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
