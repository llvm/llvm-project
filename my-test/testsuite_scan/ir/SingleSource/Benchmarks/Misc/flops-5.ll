; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-5.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-5.c"
...
50:                                               ; preds = %50, %0
  ...
  %87 = fdiv <2 x double> %73, %85
  %88 = fdiv <2 x double> %74, %86
...
94:                                               ; preds = %50
  ...
  %112 = fmul double %8, 0x41A2A05F1C000000
  %113 = fmul double %112, %112
  %114 = tail call double @llvm.fmuladd.f64(double %9, double %113, double %10)
  %115 = tail call double @llvm.fmuladd.f64(double %114, double %113, double %11)
  %116 = tail call double @llvm.fmuladd.f64(double %115, double %113, double %12)
  %117 = tail call double @llvm.fmuladd.f64(double %116, double %113, double %13)
  %118 = tail call double @llvm.fmuladd.f64(double %117, double %113, double %14)
  %119 = tail call double @llvm.fmuladd.f64(double %118, double %113, double %15)
  %120 = fmul double %112, %119
  %121 = tail call double @llvm.fmuladd.f64(double %16, double %113, double %17)
  %122 = tail call double @llvm.fmuladd.f64(double %113, double %121, double %18)
  %123 = tail call double @llvm.fmuladd.f64(double %113, double %122, double %19)
  %124 = tail call double @llvm.fmuladd.f64(double %113, double %123, double %20)
  %125 = tail call double @llvm.fmuladd.f64(double %113, double %124, double %21)
  %126 = tail call double @llvm.fmuladd.f64(double %113, double %125, double %15)
  %127 = fdiv double %120, %126
  %128 = fadd double %111, %127
  %129 = fmul double %8, 0x41A2A05F1E000000
  %130 = fmul double %129, %129
  %131 = tail call double @llvm.fmuladd.f64(double %9, double %130, double %10)
  %132 = tail call double @llvm.fmuladd.f64(double %131, double %130, double %11)
  %133 = tail call double @llvm.fmuladd.f64(double %132, double %130, double %12)
  %134 = tail call double @llvm.fmuladd.f64(double %133, double %130, double %13)
  %135 = tail call double @llvm.fmuladd.f64(double %134, double %130, double %14)
  %136 = tail call double @llvm.fmuladd.f64(double %135, double %130, double %15)
  %137 = fmul double %129, %136
  %138 = tail call double @llvm.fmuladd.f64(double %16, double %130, double %17)
  %139 = tail call double @llvm.fmuladd.f64(double %130, double %138, double %18)
  %140 = tail call double @llvm.fmuladd.f64(double %130, double %139, double %19)
  %141 = tail call double @llvm.fmuladd.f64(double %130, double %140, double %20)
  %142 = tail call double @llvm.fmuladd.f64(double %130, double %141, double %21)
  %143 = tail call double @llvm.fmuladd.f64(double %130, double %142, double %15)
  %144 = fdiv double %137, %143
  %145 = fadd double %128, %144
  %146 = fdiv double %5, %6
  %147 = fmul double %146, %146
  %148 = tail call double @llvm.fmuladd.f64(double %9, double %147, double %10)
  %149 = tail call double @llvm.fmuladd.f64(double %148, double %147, double %11)
  %150 = tail call double @llvm.fmuladd.f64(double %149, double %147, double %12)
  %151 = tail call double @llvm.fmuladd.f64(double %150, double %147, double %13)
  %152 = tail call double @llvm.fmuladd.f64(double %151, double %147, double %14)
  %153 = tail call double @llvm.fmuladd.f64(double %152, double %147, double %15)
  %154 = fmul double %146, %153
  %155 = tail call double @llvm.fmuladd.f64(double %16, double %147, double %17)
  %156 = tail call double @llvm.fmuladd.f64(double %147, double %155, double %18)
  %157 = tail call double @llvm.fmuladd.f64(double %147, double %156, double %19)
  %158 = tail call double @llvm.fmuladd.f64(double %147, double %157, double %20)
  %159 = tail call double @llvm.fmuladd.f64(double %147, double %158, double %21)
  %160 = tail call double @llvm.fmuladd.f64(double %147, double %159, double %15)
  %161 = fdiv double %154, %160
  %162 = load double, ptr @two, align 8, !tbaa !6
  %163 = tail call double @llvm.fmuladd.f64(double %162, double %145, double %161)
  %164 = fmul double %8, %163
  %165 = fdiv double %164, %162
  store double %165, ptr @sa, align 8, !tbaa !6
  store double 0x3FE62E42FEFA39EF, ptr @sb, align 8, !tbaa !6
  %166 = fadd double %165, 0xBFE62E42FEFA39EF
  store double %166, ptr @sc, align 8, !tbaa !6
  %167 = fmul double %166, 1.000000e-30
  %168 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %167, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
