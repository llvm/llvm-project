; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-7.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Misc/flops-7.c"
...
6:                                                ; preds = %0, %6
  %7 = phi double [ 0.000000e+00, %0 ], [ %20, %6 ]
  %8 = phi i64 [ 1, %0 ], [ %21, %6 ]
  %9 = uitofp nneg i64 %8 to double
  %10 = fmul double %9, 0x3EA5F9C4FF20F589
  ...
  %18 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %5)
  %19 = fdiv double %11, %18
  %20 = fsub double %17, %19
  %21 = add nuw nsw i64 %8, 1
  %22 = icmp eq i64 %21, 156250000
  br i1 %22, label %23, label %6, !llvm.loop !10

23:                                               ; preds = %6
  %24 = fneg double %5
  %25 = fadd double %5, 0x40599541F7F192A4
  %26 = fdiv double %5, %25
  %27 = fsub double %24, %26
  %28 = fadd double %5, 0x40C473EF42466D8C
  %29 = fdiv double 0x40599541F7F192A4, %28
  %30 = fsub double %27, %29
  %31 = fadd double %5, 0x413059F8E7CAE1C6
  %32 = fdiv double 0x40C473EF42466D8C, %31
  %33 = fsub double %30, %32
  %34 = load double, ptr @two, align 8, !tbaa !6
  %35 = tail call double @llvm.fmuladd.f64(double %34, double %20, double %33)
  %36 = fmul double %35, 0x3EE8B8FD9F05143A
  store double %36, ptr @sa, align 8, !tbaa !6
  %37 = fadd double %36, 5.002000e+02
  store double %37, ptr @sc, align 8, !tbaa !6
  %38 = fmul double %37, 1.000000e-30
  %39 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %38, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
