; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Shootout-C++/heapsort.cpp'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Benchmarks/Shootout-C++/heapsort.cpp"
...
define dso_local noundef double @_Z10gen_randomd(double noundef %0) local_unnamed_addr #0 {
  %2 = load i64, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !6
  %3 = mul nuw nsw i64 %2, 3877
  %4 = add nuw nsw i64 %3, 29573
  %5 = urem i64 %4, 139968
  store i64 %5, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !6
...
define dso_local void @_Z8heapsortiPd(i32 noundef %0, ptr noundef captures(none) %1) local_unnamed_addr #1 {
  %3 = ashr i32 %0, 1
  %4 = add nsw i32 %3, 1
...
16:                                               ; preds = %9
  %17 = load i64, ptr @_ZZ10gen_randomdE4last, align 8
...
19:                                               ; preds = %16, %19
  ...
  br i1 %29, label %30, label %19, !llvm.loop !18

30:                                               ; preds = %19
  store i64 %24, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !6
  br label %31
...
attributes #1 = { mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
attributes #2 = { mustprogress norecurse nounwind uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
