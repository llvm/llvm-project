; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/EH/rethrow-1.cpp'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/EH/rethrow-1.cpp"
...
@.str.2 = private unnamed_addr constant [13 x i8] c"Rethrowing: \00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"Throwing int: \00", align 1
@_ZTIi = external constant ptr
@.str.4 = private unnamed_addr constant [17 x i8] c"Throwing float: \00", align 1
@_ZTIf = external constant ptr
@.str.5 = private unnamed_addr constant [18 x i8] c"Throwing double: \00", align 1
@_ZTId = external constant ptr
@.str.6 = private unnamed_addr constant [12 x i8] c"hello world\00", align 1
@.str.7 = private unnamed_addr constant [23 x i8] c"Throwing std::string: \00", align 1
@_ZTINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE = linkonce_odr dso_local constant { ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), ptr @_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE }, comdat, align 8
@_ZTVN10__cxxabiv117__class_type_infoE = external global [0 x ptr]
@_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE = linkonce_odr dso_local constant [53 x i8] c"NSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE\00", comdat, align 1
@.str.8 = private unnamed_addr constant [12 x i8] c"Throwing A\0A\00", align 1
...
@.str.9 = private unnamed_addr constant [14 x i8] c"Rethrowing A\0A\00", align 1
@.str.10 = private unnamed_addr constant [14 x i8] c"Caught char: \00", align 1
@.str.11 = private unnamed_addr constant [13 x i8] c"Caught int: \00", align 1
@.str.12 = private unnamed_addr constant [15 x i8] c"Caught float: \00", align 1
@.str.13 = private unnamed_addr constant [16 x i8] c"Caught double: \00", align 1
@.str.14 = private unnamed_addr constant [21 x i8] c"Caught std::string: \00", align 1
@.str.15 = private unnamed_addr constant [10 x i8] c"Caught A\0A\00", align 1
...
; Function Attrs: cold mustprogress noinline noreturn uwtable
define dso_local void @_Z12rethrow_charv() local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  invoke void @_Z10throw_charv()
          to label %18 unwind label %1
...
6:                                                ; preds = %1
  ...
  %10 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 12)
...
; Function Attrs: cold mustprogress noinline noreturn uwtable
define dso_local void @_Z11rethrow_intv() local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
...
1:                                                ; preds = %0
  ...
  %3 = extractvalue { ptr, i32 } %2, 1
  %4 = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIi) #15
  %5 = icmp eq i32 %3, %4
  br i1 %5, label %6, label %19
...
11:                                               ; preds = %6
  %12 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %9)
          to label %13 unwind label %16
...
; Function Attrs: cold mustprogress noinline noreturn uwtable
define dso_local void @_Z13rethrow_floatv() local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  invoke void @_Z11throw_floatv()
          to label %19 unwind label %1

1:                                                ; preds = %0
  %2 = landingpad { ptr, i32 }
          catch ptr @_ZTIf
  %3 = extractvalue { ptr, i32 } %2, 1
  %4 = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIf) #15
  %5 = icmp eq i32 %3, %4
...
11:                                               ; preds = %6
  ...
  %13 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef %12)
          to label %14 unwind label %17

14:                                               ; preds = %11
  %15 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %13, ptr noundef nonnull @.str.1, i64 noundef 1)
...
define dso_local void @_Z12throw_doublev() local_unnamed_addr #0 {
  %1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.5)
...
; Function Attrs: cold mustprogress noinline noreturn uwtable
define dso_local void @_Z14rethrow_doublev() local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
...
1:                                                ; preds = %0
  ...
  %3 = extractvalue { ptr, i32 } %2, 1
  %4 = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTId) #15
  %5 = icmp eq i32 %3, %4
  br i1 %5, label %6, label %19
...
11:                                               ; preds = %6
  %12 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef %9)
          to label %13 unwind label %16
...
define dso_local void @_Z12throw_stringv() local_unnamed_addr #7 personality ptr @__gxx_personality_v0 {
  %1 = alloca %"class.std::__cxx11::basic_string", align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #15
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 16
  store ptr %2, ptr %1, align 8, !tbaa !15
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(11) %2, ptr noundef nonnull align 1 dereferenceable(11) @.str.6, i64 11, i1 false)
  %3 = getelementptr inbounds nuw i8, ptr %1, i64 8
  store i64 11, ptr %3, align 8, !tbaa !19
  %4 = getelementptr inbounds nuw i8, ptr %1, i64 27
  store i8 0, ptr %4, align 1, !tbaa !6
  %5 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.7, i64 noundef 22)
...
; Function Attrs: mustprogress noinline noreturn uwtable
define dso_local void @_Z14rethrow_stringv() local_unnamed_addr #7 personality ptr @__gxx_personality_v0 {
  invoke void @_Z12throw_stringv()
          to label %20 unwind label %1

1:                                                ; preds = %0
  %2 = landingpad { ptr, i32 }
          catch ptr @_ZTINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
  %3 = extractvalue { ptr, i32 } %2, 1
  %4 = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE) #15
  %5 = icmp eq i32 %3, %4
...
6:                                                ; preds = %1
  %7 = extractvalue { ptr, i32 } %2, 0
  %8 = tail call ptr @__cxa_begin_catch(ptr %7) #15
  %9 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.2, i64 noundef 12)
...
15:                                               ; preds = %10
  %16 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %14, ptr noundef nonnull @.str.1, i64 noundef 1)
...
define dso_local void @_Z7throw_Av() local_unnamed_addr #0 {
  %1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.8)
...
; Function Attrs: cold mustprogress noinline noreturn uwtable
define dso_local void @_Z9rethrow_Av() local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
  invoke void @_Z7throw_Av()
          to label %13 unwind label %1

1:                                                ; preds = %0
  %2 = landingpad { ptr, i32 }
          catch ptr @_ZTI1A
  %3 = extractvalue { ptr, i32 } %2, 1
  %4 = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTI1A) #15
  %5 = icmp eq i32 %3, %4
...
6:                                                ; preds = %1
  %7 = extractvalue { ptr, i32 } %2, 0
  %8 = tail call ptr @__cxa_begin_catch(ptr %7) #15
  %9 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.9, i64 noundef 13)
...
6:                                                ; preds = %1
  ...
  %8 = tail call ptr @__cxa_begin_catch(ptr %7) #15
  %9 = load i8, ptr %8, align 1, !tbaa !6
  %10 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.10, i64 noundef 13)
          to label %11 unwind label %17
...
24:                                               ; preds = %19
  ...
  %28 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.11, i64 noundef 12)
...
33:                                               ; preds = %31
  tail call void @__cxa_end_catch() #15
  invoke void @_Z13rethrow_floatv()
...
42:                                               ; preds = %37
  ...
  %46 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.12, i64 noundef 14)
...
52:                                               ; preds = %50
  tail call void @__cxa_end_catch() #15
  invoke void @_Z14rethrow_doublev()
...
61:                                               ; preds = %56
  ...
  %65 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.13, i64 noundef 15)
...
70:                                               ; preds = %68
  tail call void @__cxa_end_catch() #15
  invoke void @_Z14rethrow_stringv()
...
79:                                               ; preds = %74
  ...
  %82 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.14, i64 noundef 20)
...
99:                                               ; preds = %94
  ...
  %102 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.15, i64 noundef 9)
...
attributes #6 = { mustprogress uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
attributes #7 = { mustprogress noinline noreturn uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
...
attributes #9 = { noinline noreturn nounwind uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
attributes #10 = { cold nofree noreturn }
attributes #11 = { cold mustprogress norecurse uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
