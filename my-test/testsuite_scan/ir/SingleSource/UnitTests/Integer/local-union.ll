; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/Integer/local-union.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/Integer/local-union.c"
...
define dso_local noundef double @test(ptr noundef readnone captures(none) %0) local_unnamed_addr #0 {
  ret double 0xFFFFFFFFE0000000
}

; Function Attrs: nofree nounwind uwtable
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  %1 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef 0xFFFFFFFFE0000000)
  ret i32 0
}
