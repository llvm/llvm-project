; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/2005-11-29-LongSwitch.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/2005-11-29-LongSwitch.c"
...
define dso_local noundef range(i32 0, 3) i32 @foo(i64 noundef %0) local_unnamed_addr #0 {
  %2 = icmp eq i64 %0, -1
...
define dso_local noundef range(i32 0, 3) i32 @main() local_unnamed_addr #1 {
