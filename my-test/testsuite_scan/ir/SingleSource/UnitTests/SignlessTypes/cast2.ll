; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/cast2.cpp'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/SignlessTypes/cast2.cpp"
...
define dso_local noundef range(i32 17, 43) i32 @_Z3bugh(i8 noundef %0) local_unnamed_addr #0 {
  switch i8 %0, label %2 [
    i8 -1, label %5
    i8 1, label %5
  ]
