; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/SetjmpLongjmp/C/Looping.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/SetjmpLongjmp/C/Looping.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %3 = call i32 @_setjmp(ptr noundef nonnull %1) #6
  %4 = icmp slt i32 %3, 10
  br i1 %4, label %5, label %10

5:                                                ; preds = %0
  %6 = load volatile i32, ptr %2, align 4, !tbaa !6
  %7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6)
  %8 = load volatile i32, ptr %2, align 4, !tbaa !6
  %9 = add i32 %8, 1
  store volatile i32 %9, ptr %2, align 4, !tbaa !6
  call void @longjmp(ptr noundef nonnull %1, i32 noundef %9) #7
  unreachable
