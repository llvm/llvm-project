; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/2003-08-11-VaListArg.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/2003-08-11-VaListArg.c"
...
define dso_local void @test(ptr noundef readonly captures(none) %0, ptr dead_on_return noundef %1) local_unnamed_addr #0 {
...
61:                                               ; preds = %58, %54
  ...
  %64 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %63)
  br label %165
...
78:                                               ; preds = %75, %71
  ...
  %81 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i64 noundef %80)
  br label %165
...
95:                                               ; preds = %92, %88
  ...
  %98 = and i32 %97, 255
  %99 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %98)
  br label %165
...
113:                                              ; preds = %110, %106
  ...
  %119 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %115, i32 noundef %118)
  br label %165
...
133:                                              ; preds = %130, %126
  ...
  %138 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef %135, double noundef %137)
  br label %165
...
152:                                              ; preds = %149, %145
  ...
  %164 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, i32 noundef %155, double noundef %157, i32 noundef %163, i32 noundef %161)
  br label %165
...
168:                                              ; preds = %165, %2
  tail call void @llvm.va_end.p0(ptr %1)
  ret void
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @testVaListArg(ptr noundef readonly captures(none) %0, ...) local_unnamed_addr #0 {
  %2 = alloca %struct.__va_list, align 8
  %3 = alloca %struct.__va_list, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  call void @llvm.va_start.p0(ptr nonnull %2)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %2, i64 32, i1 false), !tbaa.struct !22
  call void @test(ptr noundef %0, ptr dead_on_return noundef nonnull %3)
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @testVaCopyArg(ptr noundef readonly captures(none) %0, ...) local_unnamed_addr #0 {
  %2 = alloca %struct.__va_list, align 8
  %3 = alloca %struct.__va_list, align 8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 32, i1 false), !tbaa.struct !22
  call void @test(ptr noundef %0, ptr dead_on_return noundef nonnull %4)
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %3 = alloca %struct.LargeS_struct, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #5
  store i64 416611827730, ptr %1, align 8
  tail call void (ptr, ...) @testVaListArg(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.10, i32 noundef -123, i32 noundef 97, i32 noundef 123, i32 noundef 6, i32 noundef 7, i32 noundef 8, i32 noundef 9, ptr noundef nonnull @.str.11)
  tail call void (ptr, ...) @testVaCopyArg(ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.10, i32 noundef -123, i32 noundef 97, i32 noundef 123, i32 noundef 6, i32 noundef 7, i32 noundef 8, i32 noundef 9, ptr noundef nonnull @.str.11)
  tail call void (ptr, ...) @testVaListArg(ptr noundef nonnull @.str.12, double noundef 1.000000e+00, double noundef 2.000000e+00, i32 noundef 32764, i64 noundef 12345677823423)
  tail call void (ptr, ...) @testVaCopyArg(ptr noundef nonnull @.str.12, double noundef 1.000000e+00, double noundef 2.000000e+00, i32 noundef 32764, i64 noundef 12345677823423)
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  store <2 x i32> <i32 21, i32 0>, ptr %2, align 8
  %4 = getelementptr inbounds nuw i8, ptr %2, i64 8
  store double 2.200000e+01, ptr %4, align 8, !tbaa !14
  %5 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store ptr %1, ptr %5, align 8, !tbaa !18
  %6 = getelementptr inbounds nuw i8, ptr %2, i64 24
  store <2 x i32> <i32 23, i32 0>, ptr %6, align 8
  call void (ptr, ...) @testVaListArg(ptr noundef nonnull @.str.13, i64 416611827730, [2 x i64] [i64 19, i64 4626322717216342016], ptr dead_on_return noundef nonnull %2)
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #5
  %7 = load i64, ptr %1, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #5
  store <2 x i32> <i32 21, i32 0>, ptr %3, align 8
  %8 = getelementptr inbounds nuw i8, ptr %3, i64 8
  store double 2.200000e+01, ptr %8, align 8, !tbaa !14
  %9 = getelementptr inbounds nuw i8, ptr %3, i64 16
  store ptr %1, ptr %9, align 8, !tbaa !18
  %10 = getelementptr inbounds nuw i8, ptr %3, i64 24
  store <2 x i32> <i32 23, i32 0>, ptr %10, align 8
  call void (ptr, ...) @testVaCopyArg(ptr noundef nonnull @.str.13, i64 %7, [2 x i64] [i64 19, i64 4626322717216342016], ptr dead_on_return noundef nonnull %3)
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #5
...
!22 = !{i64 0, i64 8, !23, i64 8, i64 8, !23, i64 16, i64 8, !23, i64 24, i64 4, !12, i64 28, i64 4, !12}
!23 = !{!11, !11, i64 0}
