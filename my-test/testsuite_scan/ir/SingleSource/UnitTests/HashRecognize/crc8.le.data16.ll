; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.le.data16.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/UnitTests/HashRecognize/crc8.le.data16.c"
...
34:                                               ; preds = %0, %301
  %35 = phi i64 [ 0, %0 ], [ %429, %301 ]
  %36 = phi i32 [ 0, %0 ], [ %428, %301 ]
...
301:                                              ; preds = %46, %34
  %302 = trunc i32 %42 to i8
  %303 = xor i8 %302, %39
  %304 = zext i8 %303 to i64
  %305 = getelementptr inbounds nuw i8, ptr @CRCTable, i64 %304
  %306 = load i8, ptr %305, align 1, !tbaa !10
  %307 = lshr i32 %42, 8
  %308 = trunc i32 %307 to i8
  %309 = xor i8 %306, %308
  %310 = zext i8 %309 to i64
  %311 = getelementptr inbounds nuw i8, ptr @CRCTable, i64 %310
  %312 = load i8, ptr %311, align 1, !tbaa !10
  %313 = lshr i8 %39, 1
  %314 = and i8 %303, 1
  ...
  %358 = xor i8 %355, 29
  %359 = select i1 %357, i8 %355, i8 %358
  %360 = lshr i8 %302, 7
  %361 = lshr i8 %359, 1
  %362 = and i8 %359, 1
  %363 = icmp eq i8 %362, %360
  %364 = xor i8 %361, 29
  %365 = select i1 %363, i8 %361, i8 %364
  %366 = xor i8 %365, %308
  %367 = lshr i8 %365, 1
  %368 = and i8 %366, 1
  ...
  %380 = lshr i16 %43, 10
  %381 = trunc nuw nsw i16 %380 to i8
  %382 = xor i8 %379, %381
  %383 = lshr i8 %379, 1
  %384 = and i8 %382, 1
  ...
  %388 = lshr i16 %43, 11
  %389 = trunc nuw nsw i16 %388 to i8
  %390 = xor i8 %387, %389
  %391 = lshr i8 %387, 1
  %392 = and i8 %390, 1
  %393 = icmp eq i8 %392, 0
  %394 = xor i8 %391, 29
  %395 = select i1 %393, i8 %391, i8 %394
  %396 = lshr i16 %43, 12
  %397 = trunc nuw nsw i16 %396 to i8
  %398 = xor i8 %395, %397
  %399 = lshr i8 %395, 1
  %400 = and i8 %398, 1
  ...
  %412 = lshr i16 %43, 14
  %413 = trunc nuw nsw i16 %412 to i8
  %414 = xor i8 %411, %413
  %415 = lshr i8 %411, 1
  %416 = and i8 %414, 1
  ...
  %420 = lshr i16 %43, 15
  %421 = trunc nuw nsw i16 %420 to i8
  %422 = lshr i8 %419, 1
  %423 = and i8 %419, 1
  %424 = icmp eq i8 %423, %421
  %425 = xor i8 %422, 29
  %426 = select i1 %424, i8 %422, i8 %425
  %427 = icmp eq i8 %312, %426
  %428 = select i1 %427, i32 %36, i32 1
  %429 = add nuw nsw i64 %35, 1
  %430 = icmp eq i64 %429, 8
  br i1 %430, label %33, label %34, !llvm.loop !11
}
