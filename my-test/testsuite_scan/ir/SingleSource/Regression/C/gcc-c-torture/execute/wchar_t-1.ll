; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/wchar_t-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/wchar_t-1.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %2 = icmp ne i32 %1, 196
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @x, i64 4), align 4
  %4 = icmp ne i32 %3, 0
...
7:                                                ; preds = %0
  %8 = load i32, ptr @y, align 4, !tbaa !6
  %9 = icmp eq i32 %8, 196
