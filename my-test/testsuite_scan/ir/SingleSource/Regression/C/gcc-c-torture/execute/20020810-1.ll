; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20020810-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20020810-1.c"
...
define dso_local void @f([2 x i64] %0) local_unnamed_addr #0 {
  %2 = extractvalue [2 x i64] %0, 0
  %3 = load i64, ptr @R, align 8, !tbaa !6
  %4 = icmp eq i64 %2, %3
  %5 = extractvalue [2 x i64] %0, 1
  %6 = load i64, ptr getelementptr inbounds nuw (i8, ptr @R, i64 8), align 8
  %7 = icmp eq i64 %5, %6
...
define dso_local [2 x i64] @g() local_unnamed_addr #2 {
  %1 = load i64, ptr @R, align 8, !tbaa !12
  %2 = load i64, ptr getelementptr inbounds nuw (i8, ptr @R, i64 8), align 8, !tbaa !12
