; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr43269.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr43269.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %1 = load i32, ptr @g_261, align 4, !tbaa !6
  %2 = icmp eq i32 %1, -1
...
define internal fastcc void @func_32() unnamed_addr #1 {
  %1 = load i32, ptr @g_211, align 4, !tbaa !6
  %2 = icmp eq i32 %1, -1
  store i32 -1, ptr @g_261, align 4, !tbaa !6
  br i1 %2, label %3, label %5

3:                                                ; preds = %0
  store i32 1, ptr @g_21, align 4, !tbaa !6
  br label %4
