; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr36321.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr36321.c"
...
define dso_local void @foo(ptr noundef readnone captures(none) %0) local_unnamed_addr #0 {
  ret void
}
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readnone captures(none) %1) local_unnamed_addr #1 {
  %3 = load volatile ptr, ptr @argp, align 8, !tbaa !6
  ret i32 0
}
