; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20000706-2.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20000706-2.c"
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @foo(ptr readnone captures(none) %0, ptr dead_on_return noundef readonly captures(none) %1, ptr readnone captures(none) %2) local_unnamed_addr #0 {
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  call void @foo(ptr poison, ptr dead_on_return noundef nonnull %1, ptr poison)
