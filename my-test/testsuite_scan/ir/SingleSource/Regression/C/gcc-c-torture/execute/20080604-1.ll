; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20080604-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20080604-1.c"
...
3:                                                ; preds = %1
  store ptr @.str, ptr @x, align 8, !tbaa !6
  tail call void @foo()
  store ptr @.str, ptr @x, align 8, !tbaa !6
  br label %5
