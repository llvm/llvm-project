; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20051012-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20051012-1.c"
...
define dso_local range(i32 0, 512) i32 @foo() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds nuw (i8, ptr @t, i64 8), align 8
  %2 = lshr i32 %1, 16
  %3 = and i32 %2, 511
  ret i32 %3
}
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  %1 = load i32, ptr getelementptr inbounds nuw (i8, ptr @t, i64 8), align 8
  %2 = and i32 %1, -33488897
  %3 = or disjoint i32 %2, 524288
  store i32 %3, ptr getelementptr inbounds nuw (i8, ptr @t, i64 8), align 8
  ret i32 0
}
