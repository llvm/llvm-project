; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr57344-4.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr57344-4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-unknown-linux-gnu"

%struct.S = type { [15 x i8], i8 }

@__const.main.t = private unnamed_addr constant { i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8 } { i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 -16, i8 15, i8 25, i8 42, i8 59, i8 76, i8 -35, i8 1, i8 0 }, align 8
...
define dso_local void @foo(i64 noundef %0) local_unnamed_addr #0 {
  %2 = icmp eq i64 %0, -1220975898975746
...
3:                                                ; preds = %0, %3
  %4 = load i120, ptr getelementptr inbounds nuw (i8, ptr @s, i64 16), align 8
  %5 = shl i120 %4, 7
  %6 = ashr i120 %5, 66
  %7 = trunc nsw i120 %6 to i64
...
!6 = !{i64 295}
!7 = !{i64 0, i64 15, !8, i64 15, i64 1, !8}
!8 = !{!9, !9, i64 0}
