; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20080522-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20080522-1.c"
...
define dso_local i32 @foo(ptr noundef writeonly captures(none) initializes((0, 4)) %0) local_unnamed_addr #0 {
...
define dso_local i32 @bar(ptr noundef captures(none) initializes((0, 4)) %0) local_unnamed_addr #1 {
  store i32 2, ptr %0, align 4, !tbaa !6
  store i32 1, ptr @i, align 4, !tbaa !6
...
attributes #1 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
