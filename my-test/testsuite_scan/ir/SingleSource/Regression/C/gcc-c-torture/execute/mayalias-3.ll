; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/mayalias-3.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/mayalias-3.c"
...
define dso_local i32 @g(ptr noundef %0) local_unnamed_addr #0 {
  store ptr %0, ptr @p, align 8, !tbaa !6
  ret i32 undef
}
...
define dso_local noundef i32 @f() local_unnamed_addr #0 {
  ...
  store ptr %1, ptr @p, align 8, !tbaa !6
