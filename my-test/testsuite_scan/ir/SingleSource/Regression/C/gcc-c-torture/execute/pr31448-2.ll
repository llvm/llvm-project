; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr31448-2.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr31448-2.c"
...
define dso_local void @f() local_unnamed_addr #2 {
  %1 = load ptr, ptr @next, align 8, !tbaa !6
  %2 = load i64, ptr %1, align 8
  %3 = and i64 %2, -16777216
  %4 = or disjoint i64 %3, 16711422
  store i64 %4, ptr %1, align 8
  %5 = load ptr, ptr @next, align 8, !tbaa !6
  %6 = load i64, ptr %5, align 8
  %7 = and i64 %6, -281474959933441
  %8 = or disjoint i64 %7, 280371136561152
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  ...
  store ptr %1, ptr @next, align 8, !tbaa !6
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #4
  ret i32 0
}

attributes #0 = { mustprogress nofree norecurse noreturn nosync nounwind willreturn memory(none) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
