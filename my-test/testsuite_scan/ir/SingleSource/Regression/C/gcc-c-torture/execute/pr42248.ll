; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr42248.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr42248.c"
...
define dso_local void @check([4 x double] alignstack(8) %0, [2 x double] noundef alignstack(8) %1) local_unnamed_addr #0 {
  %3 = extractvalue [4 x double] %0, 0
  %4 = extractvalue [4 x double] %0, 1
...
define dso_local void @init(ptr noundef writeonly captures(none) initializes((0, 16)) %0, [2 x double] noundef alignstack(8) %1) local_unnamed_addr #2 {
  %3 = extractvalue [2 x double] %1, 0
  %4 = extractvalue [2 x double] %1, 1
