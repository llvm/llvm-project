; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr34768-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr34768-1.c"
...
define dso_local i32 @test(i32 noundef %0) local_unnamed_addr #2 {
  ...
  tail call void %4() #5, !callees !10
  %5 = load i32, ptr @x, align 4, !tbaa !6
  %6 = add nsw i32 %5, %2
  ret i32 %6
}
