; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr81556.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr81556.c"
...
define dso_local void @foo() local_unnamed_addr #0 {
  %1 = load i64, ptr @d, align 8, !tbaa !6
  %2 = icmp ugt i64 %1, 1
  %3 = load i64, ptr @f, align 8, !tbaa !6
  %4 = and i64 %3, 511
  store i64 %4, ptr @g, align 8, !tbaa !6
  %5 = load i64, ptr @e, align 8, !tbaa !6
  %6 = load i64, ptr @b, align 8, !tbaa !6
  %7 = and i64 %6, 1
  %8 = select i1 %2, i64 %7, i64 0
  %9 = load i64, ptr @c, align 8, !tbaa !6
  %10 = and i64 %9, %5
  %11 = and i64 %10, %8
  store i64 %11, ptr @h, align 8, !tbaa !6
  ret void
}
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  tail call void @foo()
  %1 = load i64, ptr @g, align 8, !tbaa !6
  %2 = icmp ne i64 %1, 1
