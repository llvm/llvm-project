; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr51581-2.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr51581-2.c"
...
1:                                                ; preds = %1, %0
  ...
  %7 = srem <4 x i32> %5, splat (i32 3)
  %8 = srem <4 x i32> %6, splat (i32 3)
...
1:                                                ; preds = %1, %0
  ...
  %5 = load <4 x i32>, ptr %3, align 4, !tbaa !6
  %6 = load <4 x i32>, ptr %4, align 4, !tbaa !6
  %7 = urem <4 x i32> %5, splat (i32 3)
  %8 = urem <4 x i32> %6, splat (i32 3)
...
1:                                                ; preds = %1, %0
  ...
  %5 = load <4 x i32>, ptr %3, align 4, !tbaa !6
  %6 = load <4 x i32>, ptr %4, align 4, !tbaa !6
  %7 = srem <4 x i32> %5, splat (i32 18)
  %8 = srem <4 x i32> %6, splat (i32 18)
  %9 = getelementptr inbounds nuw i32, ptr @c, i64 %2
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16
  store <4 x i32> %7, ptr %9, align 4, !tbaa !6
  store <4 x i32> %8, ptr %10, align 4, !tbaa !6
...
1:                                                ; preds = %1, %0
  ...
  %5 = load <4 x i32>, ptr %3, align 4, !tbaa !6
  %6 = load <4 x i32>, ptr %4, align 4, !tbaa !6
  %7 = urem <4 x i32> %5, splat (i32 18)
  %8 = urem <4 x i32> %6, splat (i32 18)
  %9 = getelementptr inbounds nuw i32, ptr @d, i64 %2
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16
  store <4 x i32> %7, ptr %9, align 4, !tbaa !6
  store <4 x i32> %8, ptr %10, align 4, !tbaa !6
...
1:                                                ; preds = %1, %0
  ...
  %5 = load <4 x i32>, ptr %3, align 4, !tbaa !6
  %6 = load <4 x i32>, ptr %4, align 4, !tbaa !6
  %7 = srem <4 x i32> %5, splat (i32 19)
  %8 = srem <4 x i32> %6, splat (i32 19)
  %9 = getelementptr inbounds nuw i32, ptr @c, i64 %2
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16
  store <4 x i32> %7, ptr %9, align 4, !tbaa !6
  store <4 x i32> %8, ptr %10, align 4, !tbaa !6
...
1:                                                ; preds = %1, %0
  ...
  %5 = load <4 x i32>, ptr %3, align 4, !tbaa !6
  %6 = load <4 x i32>, ptr %4, align 4, !tbaa !6
  %7 = urem <4 x i32> %5, splat (i32 19)
  %8 = urem <4 x i32> %6, splat (i32 19)
  %9 = getelementptr inbounds nuw i32, ptr @d, i64 %2
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16
  store <4 x i32> %7, ptr %9, align 4, !tbaa !6
  store <4 x i32> %8, ptr %10, align 4, !tbaa !6
...
1:                                                ; preds = %1, %0
  ...
  %10 = add <4 x i32> %9, %8
  %11 = mul <4 x i32> %10, splat (i32 -3)
  %12 = add <4 x i32> %11, %4
  %13 = getelementptr inbounds nuw i32, ptr @c, i64 %2
  store <4 x i32> %12, ptr %13, align 4, !tbaa !6
  %14 = add nuw i64 %2, 4
  %15 = icmp eq i64 %14, 4096
  br i1 %15, label %16, label %1, !llvm.loop !19
...
1:                                                ; preds = %1, %0
  ...
  %15 = mul <4 x i32> %13, splat (i32 -3)
  %16 = mul <4 x i32> %14, splat (i32 -3)
  %17 = add <4 x i32> %15, %5
  %18 = add <4 x i32> %16, %6
  %19 = getelementptr inbounds nuw i32, ptr @d, i64 %2
  %20 = getelementptr inbounds nuw i8, ptr %19, i64 16
  store <4 x i32> %17, ptr %19, align 4, !tbaa !6
  store <4 x i32> %18, ptr %20, align 4, !tbaa !6
  %21 = add nuw i64 %2, 8
  %22 = icmp eq i64 %21, 4096
  br i1 %22, label %23, label %1, !llvm.loop !20
...
1:                                                ; preds = %1, %0
  ...
  %12 = mul <4 x i32> %11, splat (i32 -18)
  %13 = add <4 x i32> %12, %4
  %14 = getelementptr inbounds nuw i32, ptr @c, i64 %2
  store <4 x i32> %13, ptr %14, align 4, !tbaa !6
  %15 = add nuw i64 %2, 4
  %16 = icmp eq i64 %15, 4096
  br i1 %16, label %17, label %1, !llvm.loop !21
...
1:                                                ; preds = %1, %0
  ...
  %13 = trunc nuw nsw <4 x i64> %11 to <4 x i32>
  %14 = trunc nuw nsw <4 x i64> %12 to <4 x i32>
  %15 = mul <4 x i32> %13, splat (i32 -18)
  %16 = mul <4 x i32> %14, splat (i32 -18)
  %17 = add <4 x i32> %15, %5
  %18 = add <4 x i32> %16, %6
  %19 = getelementptr inbounds nuw i32, ptr @d, i64 %2
  %20 = getelementptr inbounds nuw i8, ptr %19, i64 16
  ...
  %21 = add nuw i64 %2, 8
  %22 = icmp eq i64 %21, 4096
  br i1 %22, label %23, label %1, !llvm.loop !22
...
1:                                                ; preds = %1, %0
  ...
  %10 = lshr <4 x i32> %4, splat (i32 31)
  %11 = add nsw <4 x i32> %9, %10
  %12 = mul <4 x i32> %11, splat (i32 -19)
  %13 = add <4 x i32> %12, %4
  %14 = getelementptr inbounds nuw i32, ptr @c, i64 %2
  store <4 x i32> %13, ptr %14, align 4, !tbaa !6
  %15 = add nuw i64 %2, 4
  %16 = icmp eq i64 %15, 4096
  br i1 %16, label %17, label %1, !llvm.loop !23
...
1:                                                ; preds = %1, %0
  ...
  %23 = mul <4 x i32> %21, splat (i32 -19)
  %24 = mul <4 x i32> %22, splat (i32 -19)
  %25 = add <4 x i32> %23, %5
  %26 = add <4 x i32> %24, %6
  %27 = getelementptr inbounds nuw i32, ptr @d, i64 %2
  %28 = getelementptr inbounds nuw i8, ptr %27, i64 16
  store <4 x i32> %25, ptr %27, align 4, !tbaa !6
  store <4 x i32> %26, ptr %28, align 4, !tbaa !6
  %29 = add nuw i64 %2, 8
  %30 = icmp eq i64 %29, 4096
  br i1 %30, label %31, label %1, !llvm.loop !24
