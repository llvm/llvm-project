; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20031214-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20031214-1.c"
...
define dso_local void @b(ptr noundef readnone captures(none) %0) local_unnamed_addr #0 {
  ret void
}
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  ...
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @g, i64 8), align 8, !tbaa !6
  %3 = tail call i32 @llvm.smax.i32(i32 %1, i32 %2)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @g, i64 12), align 4, !tbaa !6
