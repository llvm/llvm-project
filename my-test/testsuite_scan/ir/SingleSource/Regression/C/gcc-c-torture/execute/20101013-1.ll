; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20101013-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20101013-1.c"
...
define internal fastcc void @build_ref_for_offset() unnamed_addr #2 {
  ...
  call fastcc void @get_addr_base_and_unit_offset(ptr noundef %1)
...
define internal fastcc void @get_addr_base_and_unit_offset(ptr noundef nonnull writeonly captures(none) initializes((0, 8)) %0) unnamed_addr #4 {
  store i64 0, ptr %0, align 8, !tbaa !6
  ret void
}

; Function Attrs: nofree noinline nounwind uwtable
define internal fastcc void @build_int_cst(i64 noundef range(i64 -9223372036854775804, -9223372036854775808) %0) unnamed_addr #2 {
  %2 = icmp eq i64 %0, 4
