; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr22141-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr22141-1.c"
...
@u = dso_local global %struct.S zeroinitializer, align 4
...
define dso_local void @f1() local_unnamed_addr #2 {
  store <4 x i8> <i8 1, i8 2, i8 3, i8 4>, ptr @u, align 4, !tbaa !13
  ret void
}
...
define dso_local void @f4() local_unnamed_addr #0 {
  ...
  store <4 x i8> <i8 1, i8 2, i8 3, i8 4>, ptr %1, align 4, !tbaa !13
