; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr42269-2.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr42269-2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-unknown-linux-gnu"

@s = dso_local local_unnamed_addr global i16 -1, align 4

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local range(i32 0, 2) i32 @main() local_unnamed_addr #0 {
  %1 = load i16, ptr @s, align 4, !tbaa !6
  %2 = tail call fastcc i64 @foo(i16 noundef %1)
  %3 = icmp ne i64 %2, -1
  %4 = zext i1 %3 to i32
  ret i32 %4
}
...
define internal fastcc range(i64 -32768, 32768) i64 @foo(i16 noundef %0) unnamed_addr #1 {
  %2 = sext i16 %0 to i64
  ret i64 %2
}
