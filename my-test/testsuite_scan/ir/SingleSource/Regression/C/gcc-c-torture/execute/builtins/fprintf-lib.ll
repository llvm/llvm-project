; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/fprintf-lib.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/fprintf-lib.c"
...
define dso_local noundef i32 @fprintf(ptr noundef nonnull captures(none) %0, ptr noundef readonly captures(none) %1, ...) local_unnamed_addr #0 {
...
8:                                                ; preds = %2
  ...
  %9 = call i32 @vfprintf(ptr noundef nonnull %0, ptr noundef %1, ptr dead_on_return noundef nonnull %4) #6
...
; Function Attrs: nofree noinline nounwind uwtable
define dso_local noundef i32 @fprintf_unlocked(ptr noundef captures(none) %0, ptr noundef readonly captures(none) %1, ...) local_unnamed_addr #0 {
  %3 = alloca %struct.__va_list, align 8
  %4 = alloca %struct.__va_list, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #6
  %5 = load i32, ptr @inside_main, align 4, !tbaa !6
...
8:                                                ; preds = %2
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 32, i1 false), !tbaa.struct !10
  %9 = call i32 @vfprintf(ptr noundef %0, ptr noundef %1, ptr dead_on_return noundef nonnull %4) #6
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #6
  call void @llvm.va_end.p0(ptr nonnull %3)
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #6
  ret i32 %9
