; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/strpbrk-lib.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/strpbrk-lib.c"
...
define dso_local noundef ptr @strpbrk(ptr noundef readonly captures(ret: address, provenance) %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
...
27:                                               ; preds = %23, %19, %8, %5
  %28 = phi ptr [ null, %5 ], [ null, %8 ], [ %14, %19 ], [ null, %23 ]
  ret ptr %28
}
