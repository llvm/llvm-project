; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20041112-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20041112-1.c"
...
define dso_local range(i32 0, 2) i32 @bar() local_unnamed_addr #0 {
  %1 = load i32, ptr @global, align 4, !tbaa !6
  %2 = icmp eq i32 %1, 0
  %3 = add nsw i32 %1, 1
  %4 = zext i1 %2 to i32
  store i32 %3, ptr @global, align 4, !tbaa !6
  ret i32 %4
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  store i32 2, ptr @global, align 4, !tbaa !6
  ret i32 0
}
