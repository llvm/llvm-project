; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/usad-run.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/usad-run.c"
...
define dso_local void @bar(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, i32 noundef %2, ptr noundef writeonly captures(none) %3) local_unnamed_addr #0 {
  ...
  %52 = zext <16 x i8> %51 to <16 x i16>
  ...
  %63 = zext <16 x i8> %62 to <16 x i16>
  ...
  %72 = zext <16 x i8> %71 to <16 x i16>
  %73 = load <16 x i8>, ptr %70, align 1, !tbaa !6
  %74 = zext <16 x i8> %73 to <16 x i16>
  ...
  %83 = zext <16 x i8> %82 to <16 x i16>
  ...
  %96 = zext <16 x i8> %95 to <16 x i16>
  ...
  %127 = zext <16 x i8> %126 to <16 x i16>
  %128 = load <16 x i8>, ptr %125, align 1, !tbaa !6
  %129 = zext <16 x i8> %128 to <16 x i16>
  ...
  %138 = zext <16 x i8> %137 to <16 x i16>
  ...
  %149 = zext <16 x i8> %148 to <16 x i16>
  ...
  %162 = zext <16 x i8> %161 to <16 x i16>
  ...
  %171 = zext <16 x i8> %170 to <16 x i16>
  %172 = load <16 x i8>, ptr %169, align 1, !tbaa !6
  %173 = zext <16 x i8> %172 to <16 x i16>
