; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr85156.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr85156.c"
...
define dso_local range(i32 -2147483647, -2147483648) i32 @foo(i32 noundef %0) local_unnamed_addr #0 {
...
define dso_local noundef i32 @main() local_unnamed_addr #1 {
  ...
  tail call void asm sideeffect "", "=*m,=*m,*m,*m"(ptr nonnull elementtype(i32) @x, ptr nonnull elementtype(i32) @y, ptr nonnull elementtype(i32) @x, ptr nonnull elementtype(i32) @y) #3, !srcloc !10
