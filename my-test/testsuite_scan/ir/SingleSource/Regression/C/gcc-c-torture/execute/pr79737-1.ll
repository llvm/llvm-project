; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr79737-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr79737-1.c"
...
@__const.foo.m = private unnamed_addr constant { i8, i8, i8, i8, i8, i8, i8, i8, i8 } { i8 5, i8 0, i8 -40, i8 -1, i8 -1, i8 79, i8 0, i8 20, i8 0 }, align 4
@g = dso_local local_unnamed_addr global i32 0, align 4
@i = dso_local local_unnamed_addr global %struct.S zeroinitializer, align 1

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @foo() local_unnamed_addr #0 {
  store i32 6, ptr @j, align 4, !tbaa !6
  %1 = load i32, ptr @g, align 4, !tbaa !6
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %4, label %3

3:                                                ; preds = %0
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) @i, ptr noundef nonnull align 4 dereferenceable(9) @__const.foo.m, i64 9, i1 false), !tbaa.struct !10
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) @i, ptr noundef nonnull align 4 dereferenceable(9) @__const.foo.m, i64 9, i1 false), !tbaa.struct !10
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(9) @i, ptr noundef nonnull align 4 dereferenceable(9) @__const.foo.m, i64 9, i1 false), !tbaa.struct !10
  br label %4

4:                                                ; preds = %3, %0
  store i32 3, ptr @k, align 4, !tbaa !6
  ret void
}
