; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/strcspn-lib.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/strcspn-lib.c"
...
17:                                               ; preds = %8, %28
  %18 = phi i8 [ %30, %28 ], [ %6, %8 ]
  %19 = phi ptr [ %29, %28 ], [ %0, %8 ]
  br label %24

20:                                               ; preds = %24
  %21 = getelementptr inbounds nuw i8, ptr %26, i64 1
  %22 = load i8, ptr %21, align 1, !tbaa !10
  %23 = icmp eq i8 %22, 0
  br i1 %23, label %28, label %24, !llvm.loop !11

24:                                               ; preds = %17, %20
  %25 = phi i8 [ %9, %17 ], [ %22, %20 ]
  %26 = phi ptr [ %1, %17 ], [ %21, %20 ]
  %27 = icmp eq i8 %18, %25
  br i1 %27, label %32, label %20

28:                                               ; preds = %20
  %29 = getelementptr inbounds nuw i8, ptr %19, i64 1
  %30 = load i8, ptr %29, align 1, !tbaa !10
  %31 = icmp eq i8 %30, 0
  br i1 %31, label %32, label %17, !llvm.loop !13

32:                                               ; preds = %28, %24, %11, %5
  %33 = phi ptr [ %0, %5 ], [ %15, %11 ], [ %19, %24 ], [ %29, %28 ]
