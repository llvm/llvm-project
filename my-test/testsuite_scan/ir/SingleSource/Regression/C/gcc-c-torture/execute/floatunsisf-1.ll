; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/floatunsisf-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/floatunsisf-1.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  %1 = load volatile i32, ptr @u, align 4, !tbaa !6
  %2 = uitofp i32 %1 to float
  store volatile float %2, ptr @f1, align 4, !tbaa !10
  store volatile float 0x41E0000020000000, ptr @f2, align 4, !tbaa !10
  %3 = load volatile float, ptr @f1, align 4, !tbaa !10
  %4 = load volatile float, ptr @f2, align 4, !tbaa !10
