; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr39120.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr39120.c"
...
define dso_local noundef i64 @foo(ptr noundef %0) local_unnamed_addr #0 {
...
define dso_local void @bar() local_unnamed_addr #1 {
  %1 = load ptr, ptr @x, align 8, !tbaa !6
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  ...
  %2 = call i64 @foo(ptr noundef nonnull %1)
  %3 = inttoptr i64 %2 to ptr
  store ptr %3, ptr @x, align 8, !tbaa !14
  call void @bar()
...
attributes #1 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(readwrite, argmem: write, inaccessiblemem: none) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
