; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/lib/strncat.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtins/lib/strncat.c"
...
define dso_local noundef ptr @strncat(ptr noundef returned captures(ret: address, provenance) %0, ptr noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
...
12:                                               ; preds = %9, %18
  %13 = phi i64 [ %21, %18 ], [ %2, %9 ]
  %14 = phi ptr [ %20, %18 ], [ %1, %9 ]
  %15 = phi ptr [ %19, %18 ], [ %11, %9 ]
