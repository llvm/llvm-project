; ModuleID = '/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/zerolen-1.c'
source_filename = "/home/youzhewei.linux/work/llvm-project/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/zerolen-1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-unknown-linux-gnu"

%union.iso_directory_record = type { [4 x i8] }

@entry = dso_local local_unnamed_addr global %union.iso_directory_record zeroinitializer, align 4

; Function Attrs: nofree noreturn nounwind uwtable
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  store i8 1, ptr @entry, align 4, !tbaa !6
  store i8 0, ptr getelementptr inbounds nuw (i8, ptr @entry, i64 1), align 1, !tbaa !6
  tail call void @exit(i32 noundef 0) #3
  unreachable
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define dso_local void @set(ptr noundef writeonly captures(none) initializes((0, 2)) %0) local_unnamed_addr #1 {
