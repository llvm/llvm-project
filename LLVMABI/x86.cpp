...
public:
  ...
  void classify(Type Ty, uint64_t OffsetBase, Class &Lo, Class &Hi, bool isNamedArg, bool isRegCall) const;
...
void X86_64ABIInfo::classify(Type Ty, uint64_t OffsetBase, Class &Lo,
  Class &Hi, bool isNamedArg, bool IsRegCall = true) const {
  Lo = Hi = NoClass;
...
ABIArgInfo
X86_64ABIInfo::classifyReturnType(Type Ty) const {
...
ABIArgInfo
X86_64ABIInfo::classifyArgumentType(Type Ty) const {
// TODO
}
