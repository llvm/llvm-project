...
class TestSwiftArrayType(lldbtest.TestBase):
    ...
    def do_test(self):
        ...
        self.expect("frame variable arrint", substrs=["([Int]) arrint = 0 values {}"])
        ...
        self.expect("frame variable arrfoo", substrs=["Foo]) arrfoo = 0 values {}"])
        self.runCmd("continue")
        self.expect(
        ...
        self.expect(
            "frame variable arrlar", substrs=["LargeDude]) arrlar = 0 values {}"]
        )
        self.runCmd("continue")
        self.expect(
        ...
        self.expect(
            ...
            substrs=["Slice<Int>", "3 values {", "", "[1] = 2", "[2] = 3", "[3] = 4"],
        )
