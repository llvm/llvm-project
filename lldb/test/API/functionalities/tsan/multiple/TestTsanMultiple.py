    ...
    def tsan_tests(self):
        ...
        while (
            ...
            self.assertTrue(
                ...
                or (stop_description == "Use of deallocated memory detected")
                or (stop_description == "Thread leak detected")
                or (
                    stop_description
                    == "Use of an uninitialized or destroyed mutex detected"
                )
                or (
                    stop_description
                    == "Unlock of an unlocked mutex (or by a wrong thread) detected"
                )
            )
