...
class CMTimeDataFormatterTestCase(TestBase):
    ...
    def test_nsindexpath_with_run_command(self):
        ...
        self.expect(
            "frame variable t1",
            substrs=["1 half seconds", "value = 1", "timescale = 2", "epoch = 0"],
        )
        self.expect(
            "frame variable t2",
            substrs=["1 third of a second", "value = 1", "timescale = 3", "epoch = 0"],
        )
        self.expect(
            "frame variable t3",
            substrs=["1 10th of a second", "value = 1", "timescale = 10", "epoch = 0"],
        )
        self.expect(
            "frame variable t4",
