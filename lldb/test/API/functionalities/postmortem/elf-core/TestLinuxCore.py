...
class LinuxCoreTestCase(TestBase):
    ...
    def test_linux_no_exe(self):
        ...
        [  1]                                      0x00007f27db200000 /lib64/libstdc++.so.6
        [  2] AF275675-4671-8B49-24C8-A9A657D74115-C80DEE65 0x00007f27db51b000 /lib64/libm.so.6 (0x00007f27db51b000)
        [  3]                                      0x00007f27db4fe000 /lib64/libgcc_s.so.1
        [  4]                                      0x00007f27dae00000 /lib64/libc.so.6
        [  5]                                      0x00007f27db606000 /lib64/ld-linux-x86-64.so.2
        """
        target = self.dbg.CreateTarget(None)
