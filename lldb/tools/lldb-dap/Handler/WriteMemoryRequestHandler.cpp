...
void WriteMemoryRequestHandler::operator()(
  ...
  llvm::StringRef memoryReference = GetString(arguments, "memoryReference").value_or("");
  ...
  lldb::addr_t address_offset = address + GetInteger<uint64_t>(arguments, "offset").value_or(0);
