...
public:
        ...
        m_temporary_allocation_size(0)
    {
        ...
        m_is_archetype = SwiftASTContext::IsArchetypeType(m_variable_sp->GetType()->GetForwardCompilerType());
    }
...
public:
                       ...
                       Error &err) override
    {
        ...
        {
            SwiftLanguageRuntime *language_runtime = process_sp->GetSwiftLanguageRuntime();
                                             ...
                                             lldb::addr_t frame_top)
{
    ...
    else
    {
        ...
        // Okay now if there's an error and it is not empty, then report that, otherwise report the regular error...
    }
