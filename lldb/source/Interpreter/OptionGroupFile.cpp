...
Error OptionGroupFile::SetOptionValue(CommandInterpreter &interpreter,
                                      uint32_t option_idx,
...
void OptionGroupFile::OptionParsingStarting(CommandInterpreter &interpreter) {
  m_file.Clear();
}
...
Error OptionGroupFileList::SetOptionValue(CommandInterpreter &interpreter,
                                          uint32_t option_idx,
                                          const char *option_arg) {
