//===-- RegisterInfoCommon_riscv64.h -----------------------------*- C++ -*-===//
//
...
#ifndef LLDB_SOURCE_REGISTER_COMMON_REGISTERINFOCOMMON_RISCV64_H
#define LLDB_SOURCE_REGISTER_COMMON_REGISTERINFOCOMMON_RISCV64_H
...
class RegisterInfoCommon_riscv64
...
public:
  ...
  RegisterInfoCommon_riscv64(const lldb_private::ArchSpec &target_arch,
