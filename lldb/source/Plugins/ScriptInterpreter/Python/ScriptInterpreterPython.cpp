...
StructuredData::DictionarySP ScriptInterpreterPython::OSPlugin_RegisterInfo(
  ...
  assert(PythonDictionary::Check(py_return.get()) &&
         "get_register_info returned unknown object type!");
...
StructuredData::ArraySP ScriptInterpreterPython::OSPlugin_ThreadsInfo(
  ...
  assert(PythonList::Check(py_return.get()) &&
         "get_thread_info returned unknown object type!");
...
StructuredData::StringSP ScriptInterpreterPython::OSPlugin_RegisterContextData(
  ...
  assert(PythonBytes::Check(py_return.get()) &&
         "get_register_data returned unknown object type!");
...
StructuredData::DictionarySP ScriptInterpreterPython::OSPlugin_CreateThread(
  ...
  assert(PythonDictionary::Check(py_return.get()) &&
         "create_thread returned unknown object type!");
