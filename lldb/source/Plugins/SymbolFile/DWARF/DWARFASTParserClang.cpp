...
DWARFASTParserClang::ParseSubroutine(const DWARFDIE &die,
  ...
  if (TypeSystemClang::UseRedeclCompletion())
    PrepareContextToReceiveMembers(containing_decl_ctx, decl_ctx_die,
                                   die, attrs.name.GetCString());
...
DWARFASTParserClang::ParseStructureLikeDIE(const SymbolContext &sc,
  ...
  if (!TypeSystemClang::UseRedeclCompletion() || !should_directly_complete) {
