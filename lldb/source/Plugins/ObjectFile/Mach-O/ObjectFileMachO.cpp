                      ...
                      if (is_debug) {
                        ...
                        case N_GSYM:
                          ...
                          if (symbol_name && symbol_name[0] == '_' &&
                              symbol_name[1] == '_' && symbol_name[2] == 'T' &&
                              symbol_name[3] == 'M' && symbol_name[4] == 'd') {
                            add_nlist = false;
                            break;
                          }
        ...
        if (is_debug) {
          ...
          case N_GSYM:
            ...
            if (symbol_name && symbol_name[0] == '_' && symbol_name[1] == '_' &&
                symbol_name[2] == 'T' && symbol_name[3] == 'M' &&
                symbol_name[4] == 'd') {
              add_nlist = false;
              break;
            }
              ...
              if (range.first != range.second) {
                ...
                if (gsym_name) {
                  ...
                  if (pos != N_GSYM_name_to_sym_idx.end()) {
                    ...
                    if (gsym_name[0] == '_' && gsym_name[1] == 'T') {
                      if (gsym_name[2] == 'W' && gsym_name[3] == 'v' &&
                          gsym_name[4] == 'd') {
                        sym[GSYM_sym_idx].SetType(eSymbolTypeIVarOffset);
                      } else if (gsym_name[2] == 'M' && gsym_name[3] != 0) {
                    ...
                    if (symbol_name && symbol_name[0] == '_' &&
                        symbol_name[1] == 'T') {
                      if (symbol_name[2] == 'W' && symbol_name[3] == 'v' &&
                          symbol_name[4] == 'd') {
                        type = eSymbolTypeIVarOffset;
                      } else if (symbol_name[2] == 'M' && symbol_name[3] != 0) {
                        type = eSymbolTypeMetadata;
                      }
                    }
                  }
...
UUID ObjectFileMachO::GetProcessSharedCacheUUID(Process *process) {
  ...
  if (process) {
    ...
    uint32_t version_or_magic =
        process->ReadUnsignedIntegerFromMemory(all_image_infos, 4, -1, err);
    if (version_or_magic != static_cast<uint32_t>(-1) &&
        version_or_magic != MH_MAGIC && version_or_magic != MH_CIGAM &&
        version_or_magic != MH_MAGIC_64 && version_or_magic != MH_CIGAM_64 &&
        version_or_magic >= 13) {
      ...
      if (sharedCacheUUID_address != LLDB_INVALID_ADDRESS) {
        ...
        if (process->ReadMemory(sharedCacheUUID_address, shared_cache_uuid,
