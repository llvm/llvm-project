...
{
    static ConstString g_NSDictionaryClass1("_TtCSs29_NativeDictionaryStorageOwner");
    static ConstString g_NSDictionaryClass2("_TtCs29_NativeDictionaryStorageOwner");
    ...
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSummaries().emplace(g_NSDictionaryClass1, lldb_private::formatters::swift::Dictionary_SummaryProvider);
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSynthetics().emplace(g_NSDictionaryClass1, lldb_private::formatters::swift::DictionarySyntheticFrontEndCreator);
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSummaries().emplace(g_NSDictionaryClass2, lldb_private::formatters::swift::Dictionary_SummaryProvider);
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSynthetics().emplace(g_NSDictionaryClass2, lldb_private::formatters::swift::DictionarySyntheticFrontEndCreator);

    lldb_private::formatters::NSSet_Additionals::GetAdditionalSummaries().emplace(g_NSSetClass1, lldb_private::formatters::swift::Set_SummaryProvider);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSynthetics().emplace(g_NSSetClass1, lldb_private::formatters::swift::SetSyntheticFrontEndCreator);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSummaries().emplace(g_NSSetClass2, lldb_private::formatters::swift::Set_SummaryProvider);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSynthetics().emplace(g_NSSetClass2, lldb_private::formatters::swift::SetSyntheticFrontEndCreator);
...
SwiftLanguage::Terminate()
{
    ...
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSummaries().erase(g_NSDictionaryClass2);
    lldb_private::formatters::NSDictionary_Additionals::GetAdditionalSynthetics().erase(g_NSDictionaryClass2);
    
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSummaries().erase(g_NSSetClass1);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSynthetics().erase(g_NSSetClass1);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSummaries().erase(g_NSSetClass2);
    lldb_private::formatters::NSSet_Additionals::GetAdditionalSynthetics().erase(g_NSSetClass2);
...
SwiftLanguage::GetPluginNameStatic()
{
...
bool
SwiftLanguage::IsTopLevelFunction (Function& function)
{
...
static void
LoadSwiftFormatters (lldb::TypeCategoryImplSP swift_category_sp)
{
    ...
    format_flags.SetCascades(true)
    .SetSkipPointers(true)
    .SetSkipReferences(true);
    
    SyntheticChildren::Flags basic_synth_flags;
    basic_synth_flags.SetCascades(true).SetSkipPointers(true).SetSkipReferences(true);

#ifndef LLDB_DISABLE_PYTHON
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::ObjC_Selector_SummaryProvider, "ObjectiveC.Selector", ConstString("ObjectiveC.Selector"), summary_flags);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Int64", ConstString("Swift.Int64"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Int32", ConstString("Swift.Int32"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Int16", ConstString("Swift.Int16"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Int8", ConstString("Swift.Int8"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Int", ConstString("Swift.Int"), basic_synth_flags);
    
    AddFormat(swift_category_sp, lldb::eFormatDecimal, ConstString("Swift.Int64"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatDecimal, ConstString("Swift.Int32"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatDecimal, ConstString("Swift.Int16"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatDecimal, ConstString("Swift.Int8"),  format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatDecimal, ConstString("Swift.Int"),   format_flags, false);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.UInt64", ConstString("Swift.UInt64"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.UInt32", ConstString("Swift.UInt32"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.UInt16", ConstString("Swift.UInt16"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.UInt8", ConstString("Swift.UInt8"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.UInt", ConstString("Swift.UInt"), basic_synth_flags);
    
    AddFormat(swift_category_sp, lldb::eFormatUnsigned, ConstString("Swift.UInt64"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatUnsigned, ConstString("Swift.UInt32"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatUnsigned, ConstString("Swift.UInt16"), format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatUnsigned, ConstString("Swift.UInt8"),  format_flags, false);
    AddFormat(swift_category_sp, lldb::eFormatUnsigned, ConstString("Swift.UInt"),   format_flags, false);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Float32", ConstString("Swift.Float32"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Float64", ConstString("Swift.Float64"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Float80", ConstString("Swift.Float80"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Float", ConstString("Swift.Float"), basic_synth_flags);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftBasicTypeSyntheticFrontEndCreator, "Swift.Double", ConstString("Swift.Double"), basic_synth_flags);
    ...
    summary_flags.SetSkipPointers(false); // the ContiguousArrayStorage ugliness will come back to us as pointers
    synth_flags.SetSkipPointers(false);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::Array_SummaryProvider, "Swift.Array summary provider",ConstString("^Swift.Array<.+>$"),summary_flags,true);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::Array_SummaryProvider, "Swift.Array summary provider",ConstString("Swift._NSSwiftArray"),summary_flags,false);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::Array_SummaryProvider, "Swift.Array summary provider",ConstString("^Swift.NativeArray<.+>$"),summary_flags,true);
    ...
    AddCXXSummary(swift_category_sp, lldb_private::formatters::NSDictionarySummaryProvider<false>, "Swift.Dictionary synthetic children", ConstString("^_TtGCs29_NativeDictionaryStorageOwner.*_$"), summary_flags, true);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::NSDictionarySummaryProvider<false>, "Swift.Dictionary synthetic children", ConstString("^Swift._NativeDictionaryStorageOwner.*$"), summary_flags, true);

    summary_flags.SetDontShowChildren(true);
    summary_flags.SetSkipPointers(true);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::ArraySyntheticFrontEndCreator, "Swift.Array synthetic children", ConstString("^Swift.Array<.+>$"), synth_flags, true);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::ArraySyntheticFrontEndCreator, "Swift.Array synthetic children", ConstString("Swift._NSSwiftArray"), synth_flags, false);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::ArraySyntheticFrontEndCreator, "Swift.Array synthetic children", ConstString("^Swift.NativeArray<.+>$"), synth_flags, true);
    ...
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::NSDictionarySyntheticFrontEndCreator, "Swift.Dictionary synthetic children", ConstString("^Swift._NativeDictionaryStorageOwner.*$"), synth_flags, true);
    
    //FIXME: _Set and Set seem to be coexisting on different trains - support both for a while
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SetSyntheticFrontEndCreator, "Swift.Set synthetic children", ConstString("^Swift.Set<.+>$"), synth_flags, true);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SetSyntheticFrontEndCreator, "Swift.Set synthetic children", ConstString("^Swift._Set<.+>$"), synth_flags, true);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::NSSetSyntheticFrontEndCreator, "Swift.Set synthetic children", ConstString("^_TtCs22_NativeSetStorageOwner[A-Fa-f0-9]+$"), synth_flags, true);
    ...
    bool (*string_summary_provider)(ValueObject&, Stream&, const TypeSummaryOptions&) = lldb_private::formatters::swift::String_SummaryProvider;
    AddCXXSummary(swift_category_sp, string_summary_provider, "Swift.String summary provider", ConstString("Swift.String"), summary_flags);
    bool (*staticstring_summary_provider)(ValueObject&, Stream&, const TypeSummaryOptions&) = lldb_private::formatters::swift::StaticString_SummaryProvider;
    AddCXXSummary(swift_category_sp, staticstring_summary_provider, "Swift.StaticString summary provider", ConstString("Swift.StaticString"), summary_flags);
    summary_flags.SetSkipPointers(false);
    // this is an ObjC dynamic type - as such it comes in pointer form NSContiguousString* - do not skip pointers here
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::NSContiguousString_SummaryProvider, "NSContiguousString summary provider", ConstString("_NSContiguousString"), summary_flags);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::NSContiguousString_SummaryProvider, "NSContiguousString summary provider", ConstString("_TtCs19_NSContiguousString"), summary_flags);
    summary_flags.SetSkipPointers(true);
    AddCXXSummary(swift_category_sp, lldb_private::formatters::swift::BuiltinObjC_SummaryProvider, "ObjC object pointer summary provider", ConstString("Builtin.ObjCPointer"), summary_flags);
    
    TypeSummaryImpl::Flags optional_summary_flags;
    optional_summary_flags.SetCascades(true)
    .SetDontShowChildren(false) // this one will actually be calculated at runtime, what you pass here doesn't matter
    .SetDontShowValue(true)
    .SetHideItemNames(false)
    .SetShowMembersOneLiner(false)
    .SetSkipPointers(true)
    ...
    TypeSummaryImplSP swift_optional_summary_sp(new lldb_private::formatters::swift::SwiftOptionalSummaryProvider(optional_summary_flags));
    TypeSummaryImplSP swift_unchecked_optional_summary_sp(new lldb_private::formatters::swift::SwiftOptionalSummaryProvider(optional_summary_flags));
    
    // do not move the relative order of these - @unchecked needs to come first or else pain will ensue
    AddSummary(swift_category_sp, swift_unchecked_optional_summary_sp, ConstString("^Swift.ImplicitlyUnwrappedOptional<.+>$"), true);
    AddSummary(swift_category_sp, swift_optional_summary_sp, ConstString("^Swift.Optional<.+>$"), true);
    
    AddSummary(swift_category_sp, swift_unchecked_optional_summary_sp, ConstString("AnyObject!"), false);
    AddSummary(swift_category_sp, swift_optional_summary_sp, ConstString("AnyObject?"), false);
    
    AddSummary(swift_category_sp, swift_unchecked_optional_summary_sp, ConstString("()!"), false);
    AddSummary(swift_category_sp, swift_optional_summary_sp, ConstString("()?"), false);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftUncheckedOptionalSyntheticFrontEndCreator, "Swift.Optional synthetic children", ConstString("^Swift.ImplicitlyUnwrappedOptional<.+>$"), optional_synth_flags, true);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftOptionalSyntheticFrontEndCreator, "Swift.Optional synthetic children", ConstString("^Swift.Optional<.+>$"), optional_synth_flags, true);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftUncheckedOptionalSyntheticFrontEndCreator, "Swift.Optional synthetic children", ConstString("AnyObject!"), optional_synth_flags, false);
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftOptionalSyntheticFrontEndCreator, "Swift.Optional synthetic children", ConstString("AnyObject?"), optional_synth_flags, false);
    
    AddCXXSynthetic(swift_category_sp, lldb_private::formatters::swift::SwiftUncheckedOptionalSyntheticFrontEndCreator, "Swift.Optional synthetic children", ConstString("()!"), optional_synth_flags, false);
        ...
        g_formatters.push_back([](lldb_private::ValueObject& valobj,
            ...
            if (type_flags.AllSet(eTypeIsMetatype | eTypeIsSwift))
            {
                if (!swift_metatype_summary_sp.get())
                {
                    ...
                    flags.SetCascades(true).SetDontShowChildren(true).SetDontShowValue(true).SetHideItemNames(false).SetShowMembersOneLiner(false).SetSkipPointers(false).SetSkipReferences(false);
                    swift_metatype_summary_sp.reset(new CXXFunctionSummaryFormat(flags, lldb_private::formatters::swift::SwiftMetatype_SummaryProvider, "Swift Metatype Summary"));
                }
                return swift_metatype_summary_sp;
            }
            if (valobj.GetName().GetLength() > 12 && valobj.GetName().GetStringRef().startswith("$swift.type.") &&
        ...
        g_formatters.push_back(
                                        [](lldb_private::ValueObject& valobj,
                                           ...
                                           FormatManager&) -> TypeSummaryImpl::SharedPointer {
                                            ...
                                            if (lldb_private::formatters::swift::SwiftOptionSetSummaryProvider::WouldEvenConsiderFormatting(clang_type))
                                            {
                                                TypeSummaryImpl::SharedPointer formatter_sp(new lldb_private::formatters::swift::SwiftOptionSetSummaryProvider(clang_type));
                                                return formatter_sp;
                                            }
                                            return nullptr;
                                        });
...
SwiftLanguage::GetHardcodedSynthetics ()
{
    ...
    std::call_once(g_initialize, [] () -> void {
        g_formatters.push_back([](lldb_private::ValueObject& valobj,
            ...
            {
                if (!swift_enum_synth)
                    swift_enum_synth = lldb::SyntheticChildrenSP(new CXXSyntheticChildren(SyntheticChildren::Flags().SetCascades(true).SetSkipPointers(true).SetSkipReferences(true),
        ...
        g_formatters.push_back([](lldb_private::ValueObject& valobj,
            ...
            struct IsEligible
            {
                       ...
                       const CompilerType& type)
                {
                    ...
                    if (type.IsValid())
                    {
                        ...
                        if (swift_ast_ctx && swift_ast_ctx->IsImportedType(type, nullptr))
                            is_imported = true;
                    }
            ...
            auto category_sp(format_manager.GetCategory(g_runtime_synths_category_name,can_create));
...
SwiftLanguage::GetPossibleFormattersMatches (ValueObject& valobj, lldb::DynamicValueType use_dynamic)
{
    ...
    bool canBeSwiftDynamic = compiler_type.IsPossibleDynamicType(nullptr, check_cpp, check_objc, check_swift);
    ...
    if (canBeSwiftDynamic)
    {
        do {
            ...
            if (!runtime->GetDynamicTypeAndAddress(valobj, use_dynamic, type_and_or_name, address, value_type))
                break;
...
SwiftLanguage::GetStringPrinterEscapingHelper (lldb_private::formatters::StringPrinter::GetPrintableElementType elem_type)
{
    switch (elem_type)
    {
        case lldb_private::formatters::StringPrinter::GetPrintableElementType::UTF8:
            return [this] (uint8_t* buffer, uint8_t* buffer_end, uint8_t*& next) -> lldb_private::formatters::StringPrinter::StringPrinterBufferPointer<> {
                lldb_private::formatters::StringPrinter::StringPrinterBufferPointer<> retval {nullptr};
                ...
                {
                    case 1:
                        return GetStringPrinterEscapingHelper(lldb_private::formatters::StringPrinter::GetPrintableElementType::ASCII)(buffer, buffer_end, next);
                    case 2:
                    ...
                    switch (codepoint)
                    {
                        ...
                        default:
                            ...
                            else
                            {
                                ...
                                unsigned long data_len = sprintf((char*)data,"\\u{%x}",*buffer);
                                retval = {data, data_len, [] (const uint8_t* c) {delete[] c;} };
                                break;
                            }
                    }
        ...
        case lldb_private::formatters::StringPrinter::GetPrintableElementType::ASCII:
            return [] (uint8_t* buffer, uint8_t* buffer_end, uint8_t*& next) -> lldb_private::formatters::StringPrinter::StringPrinterBufferPointer<> {
                lldb_private::formatters::StringPrinter::StringPrinterBufferPointer<> retval = {nullptr};
...
static void
SplitDottedName (llvm::StringRef name,
...
SwiftLanguage::GetTypeScavenger ()
{
                ...
                if (IsValid())
                {
                    ...
                    if (as_type.hasValue() && as_type.getValue())
                    {
                        ...
                        if (SwiftASTContext *swift_ast_ctx = llvm::dyn_cast_or_null<SwiftASTContext>(type_system))
                            swift_ast_ctx->DumpTypeDescription(as_type->GetOpaqueQualType(), &stream, print_help_if_available, true);
                        else
                            as_type->DumpTypeDescription(&stream); // we should always have a swift type here..
                    }
    ...
    protected:
        ...
        typedef std::function<size_t(const char*, ExecutionContextScope*, TypesOrDecls&)> Hoarder;
        ...
        GetHoarders ()
        {
            ...
            std::call_once(g_init, [] () -> void {
                g_hoarders.push_back([] (const char* input, ExecutionContextScope* exe_scope, TypesOrDecls& results) -> size_t {
                    ...
                    if (exe_scope)
                    {
                        ...
                        if (target)
                        {
                            ...
                            Error error;
                            SwiftASTContext *ast_ctx(target->GetScratchSwiftASTContext(error, create_on_demand));
                            if (ast_ctx)
                            {
                                ...
                                {
                                    Error error;
                                    auto candidate = ast_ctx->GetTypeFromMangledTypename(input, error);
                ...
                g_hoarders.push_back([] (const char* input, ExecutionContextScope* exe_scope, TypesOrDecls& results) -> size_t {
                    ...
                    if (exe_scope)
                    {
                        ...
                        if (target && frame)
                        {
                            ...
                            StreamString stream;
                            stream.Printf("typealias __lldb__typelookup_typealias = %s; __lldb__typelookup_typealias.self", input);
                            if (target->EvaluateExpression(stream.GetData(),
                                                           frame,
                                                           result_sp,
                                                           options) == eExpressionCompleted)
                            {
                                if (result_sp
                                    &&
                                    result_sp->GetCompilerType().IsValid())
                                {
                                    CompilerType result_type(result_sp->GetCompilerType());
                                    if (Flags(result_type.GetTypeInfo()).AllSet(eTypeIsSwift | eTypeIsMetatype))
                ...
                g_hoarders.push_back([] (const char* input, ExecutionContextScope* exe_scope, TypesOrDecls& results) -> size_t {
                    ...
                    if (exe_scope)
                    {
                        ...
                        if (ast_ctx)
                        {
                            ...
                            std::function<void(swift::ModuleDecl*)> lookup_func = [ast_ctx, input, name_parts, &results] (swift::ModuleDecl *module) -> void {
                                
                                swift::Module::AccessPathTy access_path;
                                
                                module->forAllVisibleModules(access_path, true, [ast_ctx, input, name_parts, &results](swift::Module::ImportedModule imported_module)->bool {
                                    auto module = imported_module.second;
                                    TypesOrDecls local_results;
                                    ast_ctx->FindTypesOrDecls(input, module, local_results, false);
                                    llvm::Optional<TypeOrDecl> candidate;
                                    if (local_results.empty() && name_parts.size() > 1)
                                    {
                                        size_t idx_of_deeper = 1;
                                        // if you're looking for Swift.Int in module Swift, try looking for Int
                                        if (name_parts.front() == module->getName().str())
                                        {
                                            candidate = ast_ctx->FindTypeOrDecl(name_parts[1].str().c_str(), module);
                                            idx_of_deeper = 2;
                                        }
                                        // this is probably the top-level name of a nested type String.UTF8View
                                        else
                                        {
                                            candidate = ast_ctx->FindTypeOrDecl(name_parts[0].str().c_str(), module);
                                        }
                                        if (candidate.hasValue())
                                        {
                                            TypesOrDecls candidates{candidate.getValue()};
                                            for (; idx_of_deeper < name_parts.size(); idx_of_deeper++)
                                            {
                                                TypesOrDecls new_candidates;
                                                for (auto candidate : candidates)
                                                {
                                                    ast_ctx->FindContainedTypeOrDecl(name_parts[idx_of_deeper],
                                                                                     candidate,
                                                                                     new_candidates);
                                                }
                                    ...
                                    else if (local_results.empty() && module && name_parts.size() == 1 && name_parts.front() == module->getName().str())
                                        results.insert(CompilerType(ast_ctx->GetASTContext(),
                   ...
                   ResultSet &result_set) override
        {
            ...
            {
                any_found = true;
                std::unique_ptr<Language::TypeScavenger::Result> result(new SwiftScavengerResult(type_or_decl));
...
LazyBool
SwiftLanguage::IsLogicalTrue (ValueObject& valobj,
                              Error& error)
{
    ...
    {
        if (type_flags.AllSet(eTypeIsStructUnion) && valobj_type.GetTypeName() == g_SwiftBool)
        {
...
bool
SwiftLanguage::GetFunctionDisplayName (const SymbolContext *sc,
...
//------------------------------------------------------------------
lldb_private::ConstString
SwiftLanguage::GetPluginName()
{
    return GetPluginNameStatic();
}

uint32_t
SwiftLanguage::GetPluginVersion()
{
    return 1;
}
...
//------------------------------------------------------------------
Language *
SwiftLanguage::CreateInstance (lldb::LanguageType language)
{
    switch (language)
    {
