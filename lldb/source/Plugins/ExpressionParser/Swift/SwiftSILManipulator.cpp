...
swift::SILValue SwiftSILManipulator::emitLValueForVariable(swift::VarDecl *var,
                                                           SwiftExpressionParser::SILVariableInfo &info)
{
    ...
    if (info.needs_init)
    {
        ...
        return swift::SILValue(m_builder.createMarkUninitialized(null_loc, address_of_variable, swift::MarkUninitializedInst::Var));
    }
    else
