...
#define kSimDeviceBootEnv                                                      \
  @"env" /* An NSDictionary of "extra" environment key/values */
...
#define kSimDeviceBootDisabledJobs                                             \
  @"disabled_jobs" /* An NSDictionary of NSStrings -> NSNumbers, each string   \
                      is the name of a job, and the value is the corresponding \
                      state (true if disabled) */
