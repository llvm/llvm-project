...
static lldb_private::RegisterInfo g_register_infos_riscv32_csr_xqci_patch[] = {
    DEFINE_CSR32_ALT(qc_mmcr, csr_0x7c0, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mntvec, csr_0x7c3, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mstktopaddr, csr_0x7c4, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mstkbottomaddr, csr_0x7c5, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mscratch0, csr_0x7c6, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mscratch1, csr_0x7c7, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mthreadptr, csr_0x7c8, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpstartaddr0, csr_0x7d0, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpstartaddr1, csr_0x7d1, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpstartaddr2, csr_0x7d2, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpstartaddr3, csr_0x7d3, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpendaddr0, csr_0x7d4, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpendaddr1, csr_0x7d5, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpendaddr2, csr_0x7d6, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mwpendaddr3, csr_0x7d7, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl0, csr_0xbc0, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl1, csr_0xbc1, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl2, csr_0xbc2, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl3, csr_0xbc3, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl4, csr_0xbc4, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl5, csr_0xbc5, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl6, csr_0xbc6, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl7, csr_0xbc7, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl8, csr_0xbc8, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl9, csr_0xbc9, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl10, csr_0xbca, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl11, csr_0xbcb, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl12, csr_0xbcc, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl13, csr_0xbcd, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl14, csr_0xbce, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl15, csr_0xbcf, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl16, csr_0xbd0, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl17, csr_0xbd1, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl18, csr_0xbd2, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl19, csr_0xbd3, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl20, csr_0xbd4, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl21, csr_0xbd5, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl22, csr_0xbd6, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl23, csr_0xbd7, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl24, csr_0xbd8, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl25, csr_0xbd9, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl26, csr_0xbda, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl27, csr_0xbdb, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl28, csr_0xbdc, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl29, csr_0xbdd, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl30, csr_0xbde, LLDB_INVALID_REGNUM),
    DEFINE_CSR32_ALT(qc_mclicilvl31, csr_0xbdf, LLDB_INVALID_REGNUM),
};

static lldb_private::RegisterInfo g_register_infos_riscv32_csr_xqciint_patch[] =
    {
        DEFINE_CSR32_ALT(qc_mnepc, csr_0x7c1, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mncause, csr_0x7c2, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip0, csr_0x7f0, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip1, csr_0x7f1, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip2, csr_0x7f2, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip3, csr_0x7f3, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip4, csr_0x7f4, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip5, csr_0x7f5, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip6, csr_0x7f6, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicip7, csr_0x7f7, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie0, csr_0x7f8, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie1, csr_0x7f9, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie2, csr_0x7fa, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie3, csr_0x7fb, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie4, csr_0x7fc, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie5, csr_0x7fd, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie6, csr_0x7fe, LLDB_INVALID_REGNUM),
        DEFINE_CSR32_ALT(qc_mclicie7, csr_0x7ff, LLDB_INVALID_REGNUM),
};
