...
// Generic,    Process Plugin
    ...
    DEFINE_FPR(f31, nullptr, dwarf_f31_mips64, dwarf_f31_mips64,
               LLDB_INVALID_REGNUM, LLDB_INVALID_REGNUM),
    DEFINE_FPR(fcsr, nullptr, dwarf_fcsr_mips64, dwarf_fcsr_mips64,
               LLDB_INVALID_REGNUM, LLDB_INVALID_REGNUM),
    DEFINE_FPR(fir, nullptr, dwarf_fir_mips64, dwarf_fir_mips64,
               LLDB_INVALID_REGNUM, LLDB_INVALID_REGNUM),
    DEFINE_FPR(config5, nullptr, dwarf_config5_mips64, dwarf_config5_mips64,
               LLDB_INVALID_REGNUM, LLDB_INVALID_REGNUM),
