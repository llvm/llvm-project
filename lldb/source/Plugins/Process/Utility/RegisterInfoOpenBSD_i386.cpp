...
#include "RegisterInfoOpenBSD_i386.h"
...
RegisterInfoOpenBSD_i386::RegisterInfoOpenBSD_i386(
    const ArchSpec &target_arch)
    : RegisterInfoInterface(target_arch) {}

size_t RegisterInfoOpenBSD_i386::GetGPRSize() const { return sizeof(GPR); }

const RegisterInfo *RegisterInfoOpenBSD_i386::GetRegisterInfo() const {
...
uint32_t RegisterInfoOpenBSD_i386::GetRegisterCount() const {
