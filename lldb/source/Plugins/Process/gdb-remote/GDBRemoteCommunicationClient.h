...
public:
  ...
  bool GetWasmGlobal(int frame_index, int index, uint64_t &value);
  bool GetWasmLocal(int frame_index, int index,  uint64_t &value);
  bool GetWasmStackValue(int frame_index, int index, uint64_t &value);
