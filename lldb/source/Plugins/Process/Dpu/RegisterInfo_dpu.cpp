...
static RegisterInfo g_register_infos_dpu[] = {
    ...
    DEFINE_GPR(8, LLDB_INVALID_REGNUM),
    DEFINE_GPR(9, LLDB_INVALID_REGNUM),
    DEFINE_GPR(10, LLDB_INVALID_REGNUM),
    DEFINE_GPR(11, LLDB_INVALID_REGNUM),
    DEFINE_GPR(12, LLDB_INVALID_REGNUM),
    DEFINE_GPR(13, LLDB_INVALID_REGNUM),
    DEFINE_GPR(14, LLDB_INVALID_REGNUM),
    DEFINE_GPR(15, LLDB_INVALID_REGNUM),
