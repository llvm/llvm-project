...
are no syntax errors may indicate that a function was declared but never called.");
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_use_commands(false),
          m_use_script_language(false), m_script_language(eScriptLanguageNone),
          m_use_one_liner(false), m_one_liner(), m_function_name() {}
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_use_dummy(false) {}
    ...
    void OptionParsingStarting() override { m_use_dummy = false; }
