...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_condition(), m_filenames(), m_line_num(0),
          m_column(0), m_func_names(),
          m_func_name_type_mask(eFunctionNameTypeNone), m_func_regexp(),
          m_source_text_regexp(), m_modules(), m_load_addr(), m_ignore_count(0),
          m_thread_id(LLDB_INVALID_THREAD_ID), m_thread_index(UINT32_MAX),
          m_thread_name(), m_queue_name(), m_catch_bp(false), m_throw_bp(true),
          m_hardware(false), m_exception_language(eLanguageTypeUnknown),
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_ignore_count(0),
          m_thread_id(LLDB_INVALID_THREAD_ID), m_thread_id_passed(false),
          m_thread_index(UINT32_MAX), m_thread_index_passed(false),
          m_thread_name(), m_queue_name(), m_condition(), m_one_shot(false),
          m_enable_passed(false), m_enable_value(false), m_name_passed(false),
          m_queue_passed(false), m_condition_passed(false),
          m_one_shot_passed(false), m_use_dummy(false) {}
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_level(lldb::eDescriptionLevelBrief),
          m_use_dummy(false) {}
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_filename(), m_line_num(0) {}
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_use_dummy(false), m_force(false) {}
...
public:
  CommandObjectBreakpointNameAdd(CommandInterpreter &interpreter)
      : CommandObjectParsed(
        ...
        m_name_options(), m_option_group(interpreter) {
