...
public:
  ...
  public:
    ...
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_thread_idx(LLDB_INVALID_THREAD_ID),
...
public:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_from_expression(false) {
      // Keep default values of all options in one place: OptionParsingStarting
      // ()
      OptionParsingStarting();
    }
    ...
    void OptionParsingStarting() override { m_from_expression = false; }
...
public:
  ...
  public:
    ...
    Error SetOptionValue(uint32_t option_idx, const char *option_arg) override {
      ...
      case 'a': {
        ExecutionContext exe_ctx(m_interpreter.GetExecutionContext());
        m_load_addr = Args::StringToAddress(&exe_ctx, option_arg,
