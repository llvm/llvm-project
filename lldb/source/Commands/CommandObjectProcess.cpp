...
public:
  ...
  int HandleArgumentCompletion(Args &input, int &cursor_index,
    ...
    CommandCompletions::InvokeCommonCompletionCallbacks(
        m_interpreter, CommandCompletions::eDiskFileCompletion,
...
public:
  ...
  public:
    ...
    void OptionParsingStarting() override { attach_info.Clear(); }
...
protected:
  ...
  public:
    ...
    void OptionParsingStarting() override { m_ignore = 0; }
...
public:
  ...
  public:
    ...
    void OptionParsingStarting() override { plugin_name.clear(); }
