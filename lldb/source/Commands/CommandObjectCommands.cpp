...
protected:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_start_idx(0), m_stop_idx(0), m_count(0),
          m_clear(false) {}
...
protected:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_stop_on_error(true), m_silent_run(false),
...
protected:
  ...
  public:
    ...
    void OptionParsingStarting() override { m_allow_reload = true; }
...
protected:
  ...
  public:
    CommandOptions(CommandInterpreter &interpreter)
        : Options(interpreter), m_class_name(), m_funct_name(), m_short_help(),
