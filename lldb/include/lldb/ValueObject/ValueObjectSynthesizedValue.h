...
/// ValueObject cannot report for itself. This reports that ValueType and
/// forwards everything else to the ValueObject it presents.
///
/// The presented ValueObject is not a parent. It is the same ValueObject seen
/// differently, so this is a root, and what it presents is reached through
/// GetPresentedValueObject rather than GetParent.
...
public:
  ...
  /// The ValueObject this one presents.
  lldb::ValueObjectSP GetPresentedValueObject() const { return m_valobj_sp; }
