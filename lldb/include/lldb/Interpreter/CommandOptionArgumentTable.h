...
#define LLDB_ENUMS_completion_type
#define LLDB_ENUMS_corefile_save_style
#define LLDB_ENUMS_dependents_enumeration
#define LLDB_ENUMS_description_verbosity_type
#define LLDB_ENUMS_exception_stage
#define LLDB_ENUMS_log_handler_type
#define LLDB_ENUMS_name_match_style
#define LLDB_ENUMS_plugin_domain_values
#define LLDB_ENUMS_resolver_mask_values
#define LLDB_ENUMS_running_mode
#define LLDB_ENUMS_script_option_enumeration
#define LLDB_ENUMS_script_synchro_type
#define LLDB_ENUMS_sort_option_enumeration
#include "lldb/Interpreter/CommandOptionArgumentTableEnums.inc"
