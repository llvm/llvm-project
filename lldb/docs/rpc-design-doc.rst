...
- One that adds the RPC server-side interface code emitters: https://github.com/llvm/llvm-project/pull/138032
- One that adds Python scripts to modify the LLDB private headers for use with RPC: https://github.com/llvm/llvm-project/pull/138028
