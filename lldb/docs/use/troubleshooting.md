...
[Python examples folder](https://github.com/llvm/llvm-project/tree/main/lldb/examples/python).
...
document in the
[Target Description Format](https://sourceware.org/gdb/current/onlinedocs/gdb.html/Target-Description-Format.html).
