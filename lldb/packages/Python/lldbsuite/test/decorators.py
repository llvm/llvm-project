...
def skipUnlessCompilerRt(func):
    ...
    def is_compiler_rt_missing():
        ...
        compilerRtPathXcode = os.path.join(
        ...
        compilerRtPathBuildScript = os.path.join(
            os.path.dirname(__file__),
            "..",
            "..",
            "..",
            ...
            "projects",
            "compiler-rt")
        compiler_rt_exists = os.path.exists(
            compilerRtPathXcode) or os.path.exists(compilerRtPathBuildScript)
