...
class ScriptedSymbolLocator(metaclass=ABCMeta):
    ...
    Configuration::
        ...
        (lldb) settings set plugin.symbol-locator.scripted.script-class \\
...
class LocalCacheSymbolLocator(ScriptedSymbolLocator):
    ...
    Usage::
        ...
        (lldb) settings set plugin.symbol-locator.scripted.script-class \\
                   scripted_symbol_locator.LocalCacheSymbolLocator
        (lldb) script import scripted_symbol_locator
        (lldb) script scripted_symbol_locator.LocalCacheSymbolLocator.cache_dir = "/path/to/cache"
