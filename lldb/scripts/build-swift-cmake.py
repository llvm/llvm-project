...
checkout_git("llvm", "github.com:apple/swift-llvm.git", "stable")
checkout_git("clang", "github.com:apple/swift-clang.git", "stable")
checkout_git("swift", "github.com:apple/swift.git", "master")
# checkout_git("swift/benchmark/PerfTestSuite", "*TODO somewhere*", "master")
checkout_git("cmark", "github.com:apple/swift-cmark.git", "master")
checkout_git("ninja", "git://github.com/martine/ninja.git", "master")
# checkout_git("swig", "*TODO somewhere*", "master")
checkout_git("lldb", "github.com:apple/swift-lldb.git", "master")

if args.package:
    checkout_git("llbuild", "git@github.com:apple/swift-llbuild.git", "master")
    checkout_git("swiftpm", "git@github.com:apple/swift-package-manager.git", "master")
