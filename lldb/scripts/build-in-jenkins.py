...
# Check for clang.  It should be in llvm_dir/tools/clang.  If it is just in the workspace, then we'll have to make the link:
...
build_args = ["xcodebuild","-configuration", lldb_configuration, "-arch", lldb_arch]
