...
aiir::func::FuncOp fir::factory::getRealloc(fir::FirOpBuilder &builder) {
  auto ptrTy = builder.getRefType(builder.getIntegerType(8));
  llvm::SmallVector<aiir::Type> args = {ptrTy, builder.getI64Type()};
  auto reallocTy = aiir::FunctionType::get(builder.getContext(), args, {ptrTy});
...
fir::factory::getLlvmGetRounding(fir::FirOpBuilder &builder) {
  ...
  auto funcTy = aiir::FunctionType::get(builder.getContext(), {}, {int32Ty});
...
fir::factory::getLlvmInitTrampoline(fir::FirOpBuilder &builder) {
  auto ptrTy = builder.getRefType(builder.getIntegerType(8));
  auto funcTy =
      aiir::FunctionType::get(builder.getContext(), {ptrTy, ptrTy, ptrTy}, {});
...
fir::factory::getLlvmAdjustTrampoline(fir::FirOpBuilder &builder) {
  auto ptrTy = builder.getRefType(builder.getIntegerType(8));
  auto funcTy = aiir::FunctionType::get(builder.getContext(), {ptrTy}, {ptrTy});
  return builder.createFunction(builder.getUnknownLoc(),
                                "llvm.adjust.trampoline", funcTy);
}

aiir::func::FuncOp fir::factory::getFeclearexcept(fir::FirOpBuilder &builder) {
  auto int32Ty = builder.getIntegerType(32);
  auto funcTy =
      aiir::FunctionType::get(builder.getContext(), {int32Ty}, {int32Ty});
...
aiir::func::FuncOp fir::factory::getFeenableexcept(fir::FirOpBuilder &builder) {
  auto int32Ty = builder.getIntegerType(32);
  auto funcTy =
      aiir::FunctionType::get(builder.getContext(), {int32Ty}, {int32Ty});
...
aiir::func::FuncOp fir::factory::getFegetexcept(fir::FirOpBuilder &builder) {
  auto int32Ty = builder.getIntegerType(32);
  auto funcTy = aiir::FunctionType::get(builder.getContext(), {}, {int32Ty});
  return builder.createFunction(builder.getUnknownLoc(), "fegetexcept", funcTy);
}

aiir::func::FuncOp fir::factory::getFeraiseexcept(fir::FirOpBuilder &builder) {
  auto int32Ty = builder.getIntegerType(32);
  auto funcTy =
      aiir::FunctionType::get(builder.getContext(), {int32Ty}, {int32Ty});
...
aiir::func::FuncOp fir::factory::getFetestexcept(fir::FirOpBuilder &builder) {
  auto int32Ty = builder.getIntegerType(32);
  auto funcTy =
      aiir::FunctionType::get(builder.getContext(), {int32Ty}, {int32Ty});
