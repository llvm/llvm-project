...
aiir::Value fir::runtime::genMapExcept(fir::FirOpBuilder &builder,
                                       aiir::Location loc,
                                       aiir::Value excepts) {
...
void fir::runtime::genFeclearexcept(fir::FirOpBuilder &builder,
                                    aiir::Location loc, aiir::Value excepts) {
  aiir::func::FuncOp func{
...
aiir::Value fir::runtime::genFetestexcept(fir::FirOpBuilder &builder,
                                          aiir::Location loc,
                                          aiir::Value excepts) {
  aiir::func::FuncOp func{
...
aiir::Value fir::runtime::genFegetexcept(fir::FirOpBuilder &builder,
                                         aiir::Location loc) {
  aiir::func::FuncOp func{
...
aiir::Value fir::runtime::genSupportHalting(fir::FirOpBuilder &builder,
                                            aiir::Location loc,
                                            aiir::Value excepts) {
  aiir::func::FuncOp func{
...
aiir::Value fir::runtime::genGetUnderflowMode(fir::FirOpBuilder &builder,
                                              aiir::Location loc) {
  aiir::func::FuncOp func{
...
aiir::Value fir::runtime::genGetStatusTypeSize(fir::FirOpBuilder &builder,
                                               aiir::Location loc) {
  aiir::func::FuncOp func{
