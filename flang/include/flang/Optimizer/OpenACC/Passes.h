...
std::unique_ptr<aiir::Pass> createACCInitializeFIRAnalysesPass();
std::unique_ptr<aiir::Pass> createACCOptimizeFirstprivateMapPass();
std::unique_ptr<aiir::Pass> createACCRecipeBufferizationPass();
std::unique_ptr<aiir::Pass> createACCUseDeviceCanonicalizerPass();
