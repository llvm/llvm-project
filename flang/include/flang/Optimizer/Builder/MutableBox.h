...
aiir::Value createUnallocatedBox(fir::FirOpBuilder &builder, aiir::Location loc,
                                 aiir::Type boxType,
                                 aiir::ValueRange nonDeferredParams,
...
void associateMutableBox(fir::FirOpBuilder &builder, aiir::Location loc,
...
void disassociateMutableBox(fir::FirOpBuilder &builder, aiir::Location loc,
                            const fir::MutableBoxValue &box,
...
struct MutableBoxReallocation {
  ...
  aiir::Value oldAddress;
  aiir::Value wasReallocated;
  aiir::Value oldAddressWasAllocated;
};
...
genReallocIfNeeded(fir::FirOpBuilder &builder, aiir::Location loc,
                   const fir::MutableBoxValue &box, aiir::ValueRange shape,
                   aiir::ValueRange lenParams,
                   ReallocStorageHandlerFunc storageHandler = {});

void finalizeRealloc(fir::FirOpBuilder &builder, aiir::Location loc,
...
void genFreememIfAllocated(fir::FirOpBuilder &builder, aiir::Location loc,
                           const fir::MutableBoxValue &box);

void genInlinedAllocation(fir::FirOpBuilder &builder, aiir::Location loc,
                          const fir::MutableBoxValue &box,
                          aiir::ValueRange lbounds, aiir::ValueRange extents,
                          aiir::ValueRange lenParams, llvm::StringRef allocName,
...
aiir::Value genFreemem(fir::FirOpBuilder &builder, aiir::Location loc,
                       const fir::MutableBoxValue &box);
...
void syncMutableBoxFromIRBox(fir::FirOpBuilder &builder, aiir::Location loc,
                             const fir::MutableBoxValue &box);
...
/// fill it.
aiir::Value getMutableIRBox(fir::FirOpBuilder &builder, aiir::Location loc,
                            const fir::MutableBoxValue &box);
...
aiir::Value genIsAllocatedOrAssociatedTest(fir::FirOpBuilder &builder,
                                           aiir::Location loc,
                                           const fir::MutableBoxValue &box);

/// Generate allocation or association status test and returns the resulting
/// i1. This is testing this for a valid/non-null base address value.
aiir::Value genIsNotAllocatedOrAssociatedTest(fir::FirOpBuilder &builder,
                                              aiir::Location loc,
                                              const fir::MutableBoxValue &box);
...
aiir::Value genNullBoxStorage(fir::FirOpBuilder &builder, aiir::Location loc,
                              aiir::Type boxTy);
...
aiir::Value getAndEstablishBoxStorage(fir::FirOpBuilder &builder,
                                      aiir::Location loc,
                                      fir::BaseBoxType boxTy, aiir::Value shape,
