...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?xi32>>>, i1, i1, !fir.box<!fir.array<?xi32>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?x?xi32>>>, i1, i1, !fir.box<!fir.array<?x?xi32>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?xf32>>>, i1, i1, !fir.box<!fir.array<?xf32>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?x?xf32>>>, i1, i1, !fir.box<!fir.array<?x?xf32>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?xcomplex<f32>>>>, i1, i1, !fir.box<!fir.array<?xcomplex<f32>>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:          hlfir.copy_out %[[TMP_BOX]], %[[VAL_1]]#1, %[[VAL_1]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?x?xcomplex<f32>>>>, i1, i1, !fir.box<!fir.array<?x?xcomplex<f32>>>) -> ()
! CHECK:          return
! CHECK:        }
...
! CHECK:            hlfir.copy_out %[[TMP_BOX]], %[[VAL_2]]#1, %[[VAL_2]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?xf32>>>, i1, i1, !fir.box<!fir.array<?xf32>>) -> ()
! CHECK:          }
! CHECK:          return
! CHECK:        }
...
! CHECK:            hlfir.copy_out %[[TMP_BOX]], %[[VAL_2]]#1, %[[VAL_2]]#2 to %[[VAL_0]]#0 : (!fir.ref<!fir.box<!fir.array<?x?xf32>>>, i1, i1, !fir.box<!fir.array<?x?xf32>>) -> ()
! CHECK:          }
! CHECK:          return
! CHECK:        }
