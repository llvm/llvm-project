// RUN: fir-opt --mif-convert %s | FileCheck %s
  ...
  func.func @_QQmain() attributes {fir.bindc_name = "TEST"} {
    ...
    hlfir.destroy %22 : !hlfir.expr<?xi32>
    %c1_i32 = arith.constant 1 : i32
    %23 = fir.embox %9#0 : (!fir.ref<i32>) -> !fir.box<i32, corank:2>
    %24 = mif.this_image coarray %23 dim %c1_i32 : (!fir.box<i32, corank:2>, i32) -> i64
    %25 = fir.convert %24 : (i64) -> i32
    hlfir.assign %25 to %14#0 : i32, !fir.ref<!fir.array<2xi32>>
    return
  }
