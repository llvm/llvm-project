...
// CHECK:   cuf.shared_memory[%c0{{.*}} : i32] i32 align 4 {bindc_name = "_lro_private", isStatic, uniq_name = "_lro_private"} -> !fir.ref<i32>
// CHECK:   scf.parallel
// CHECK:     cuf.shared_memory[%c0{{.*}} : i32] i32 align 4 {bindc_name = "_lro_private", isStatic, uniq_name = "_lro_private"} -> !fir.ref<i32>
// CHECK: fir.global internal @_QPreduce_kernel__shared_mem___lro_private {alignment = 4 : i64, data_attr = #cuf.cuda<shared>} : !fir.array<4xi8>
// CHECK-NOT: fir.global internal @_QPreduce_kernel__shared_mem___lro_private
