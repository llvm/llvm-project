...
program omp_default
  ...
  !ERROR: At most one DEFAULT clause can appear on PARALLEL directive
  ...
  !ERROR: At most one DEFAULT clause can appear on TASK directive
  ...
  !ERROR: At most one DEFAULT clause can appear on TASKLOOP directive
  ...
  !$omp parallel
  !ERROR: DEFAULT clause is not allowed on DO directive
