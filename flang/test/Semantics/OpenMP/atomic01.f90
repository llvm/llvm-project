...
!UPDATE
  ...
  !ERROR: At most one RELEASE clause can appear on ATOMIC directive
...
!CAPTURE
  ...
  !ERROR: At most one ACQ_REL clause can appear on ATOMIC directive
...
! At most one hint clause may appear on the construct.
  ...
  !ERROR: At most one HINT clause can appear on ATOMIC directive
