...
program test_atomic_fetch_and
  ...
  !ERROR: 'atom=' argument must be a scalar coarray for intrinsic 'atomic_fetch_and'
  call atomic_fetch_and(non_scalar_coarray, val, old_val)

  !ERROR: 'atom=' argument must be a coarray or a coindexed object for intrinsic 'atomic_fetch_and'
