...
! RUN: bbc --force-aiir-complex -emit-fir -outline-intrinsics %s -o - | FileCheck %s --check-prefixes="CMPLX-FAST"
...
! RUN: %flang_fc1 -emit-fir -mllvm --force-aiir-complex -mllvm -outline-intrinsics %s -o - | FileCheck %s --check-prefixes="CMPLX-FAST"
