...
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_3]]#1, %[[VAL_3]]#2 to %[[VAL_1]]#0 : (!fir.ref<!fir.box<!fir.array<?x?x!fir.char<1,?>>>>, i1, i1, !fir.box<!fir.array<?x?x!fir.char<1,?>>>) -> ()
...
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_2]]#1, %[[VAL_2]]#2 to %[[VAL_1]]#0 : (!fir.ref<!fir.box<!fir.array<?x?x!fir.char<1,?>>>>, i1, i1, !fir.box<!fir.array<?x?x!fir.char<1,?>>>) -> ()
! CHECK:           return
! CHECK:         }
...
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_3]]#1, %[[VAL_3]]#2 to %[[VAL_1]]#0 : (!fir.ref<!fir.class<!fir.array<?x?xnone>>>, i1, i1, !fir.class<!fir.array<?x?xnone>>) -> ()
...
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_2]]#1, %[[VAL_2]]#2 to %[[VAL_1]]#0 : (!fir.ref<!fir.class<!fir.array<?x?xnone>>>, i1, i1, !fir.class<!fir.array<?x?xnone>>) -> ()
! CHECK:           return
! CHECK:         }
