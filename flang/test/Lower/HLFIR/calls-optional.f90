...
! CHECK:    fir.result %[[VAL_5]], %[[VAL_4]]#1, %[[VAL_4]]#2, %[[VAL_1]]#0 : !fir.ref<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.array<?xf32>>
! CHECK:  } else {
...
! CHECK:    fir.result %[[VAL_7]], %[[VAL_8]], %[[VAL_9]], %[[VAL_10]] : !fir.ref<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.array<?xf32>>
! CHECK:  }
! CHECK:  fir.call @_QPtakes_optional_explicit(%[[VAL_3]]#0) {{.*}} : (!fir.ref<!fir.array<?xf32>>) -> ()
! CHECK:  hlfir.copy_out %[[TMP_BOX]], %[[VAL_3]]#1, %[[VAL_3]]#2 to %[[VAL_3]]#3 : (!fir.ref<!fir.box<!fir.array<?xf32>>>, i1, i1, !fir.box<!fir.array<?xf32>>) -> ()
