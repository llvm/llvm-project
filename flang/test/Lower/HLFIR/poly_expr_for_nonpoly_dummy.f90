...
! CHECK:           %[[VAL_29:.*]]:3 = hlfir.copy_in %[[VAL_28]] to %[[TMP_BOX:.*]] : (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>, !fir.ref<!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>>) -> (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>, i1, i1)
! CHECK:           fir.call @_QMtypesPcallee(%[[VAL_29]]#0) fastmath<contract> : (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>) -> ()
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_29]]#1, %[[VAL_29]]#2 : (!fir.ref<!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>>, i1, i1) -> ()
...
! CHECK:           %[[VAL_11:.*]]:3 = hlfir.copy_in %[[VAL_10]] to %[[TMP_BOX:.*]] : (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>, !fir.ref<!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>>) -> (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>, i1, i1)
! CHECK:           fir.call @_QMtypesPcallee(%[[VAL_11]]#0) fastmath<contract> : (!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>) -> ()
! CHECK:           hlfir.copy_out %[[TMP_BOX]], %[[VAL_11]]#1, %[[VAL_11]]#2 : (!fir.ref<!fir.box<!fir.array<?x!fir.type<_QMtypesTt>>>>, i1, i1) -> ()
