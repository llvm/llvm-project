...
! CHECK:    fir.result %[[VAL_5]]#0, %[[VAL_5]]#1, %[[VAL_5]]#2, %[[VAL_2]]#0 : !fir.box<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.array<?xf32>>
! CHECK:  } else {
! CHECK:    %[[VAL_6:.*]] = fir.absent !fir.box<!fir.array<?xf32>>
! CHECK:    %[[VAL_7:.*]] = arith.constant false
! CHECK:    %[[VAL_8:.*]] = arith.constant false
! CHECK:    %[[VAL_9:.*]] = fir.absent !fir.box<!fir.array<?xf32>>
! CHECK:    fir.result %[[VAL_6]], %[[VAL_7]], %[[VAL_8]], %[[VAL_9]] : !fir.box<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.array<?xf32>>
! CHECK:  }
! CHECK:  fir.call @_QPtakes_contiguous_optional(%[[VAL_4]]#0) {{.*}} : (!fir.box<!fir.array<?xf32>>) -> ()
! CHECK:  hlfir.copy_out %[[VAL_1]], %[[VAL_4]]#1, %[[VAL_4]]#2 to %[[VAL_4]]#3 : (!fir.ref<!fir.box<!fir.array<?xf32>>>, i1, i1, !fir.box<!fir.array<?xf32>>) -> ()
! CHECK:  return
! CHECK:}
...
! CHECK:  %[[VAL_7:.*]]:4 = fir.if %[[VAL_6]] -> (!fir.box<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.ptr<!fir.array<?xf32>>>) {
! CHECK:    %[[VAL_8:.*]] = fir.load %[[VAL_2]]#0 : !fir.ref<!fir.box<!fir.ptr<!fir.array<?xf32>>>>
! CHECK:    %[[VAL_9:.*]]:3 = hlfir.copy_in %[[VAL_8]] to %[[VAL_1]] : (!fir.box<!fir.ptr<!fir.array<?xf32>>>, !fir.ref<!fir.box<!fir.ptr<!fir.array<?xf32>>>>) -> (!fir.box<!fir.ptr<!fir.array<?xf32>>>, i1, i1)
! CHECK:    %[[VAL_10:.*]] = fir.rebox %[[VAL_9]]#0 : (!fir.box<!fir.ptr<!fir.array<?xf32>>>) -> !fir.box<!fir.array<?xf32>>
! CHECK:    fir.result %[[VAL_10]], %[[VAL_9]]#1, %[[VAL_9]]#2, %[[VAL_8]] : !fir.box<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.ptr<!fir.array<?xf32>>>
! CHECK:  } else {
! CHECK:    %[[VAL_11:.*]] = fir.absent !fir.box<!fir.array<?xf32>>
! CHECK:    %[[VAL_12:.*]] = arith.constant false
! CHECK:    %[[VAL_13:.*]] = arith.constant false
! CHECK:    %[[VAL_14:.*]] = fir.absent !fir.box<!fir.ptr<!fir.array<?xf32>>>
! CHECK:    fir.result %[[VAL_11]], %[[VAL_12]], %[[VAL_13]], %[[VAL_14]] : !fir.box<!fir.array<?xf32>>, i1, i1, !fir.box<!fir.ptr<!fir.array<?xf32>>>
! CHECK:  }
! CHECK:  fir.call @_QPtakes_contiguous_optional(%[[VAL_7]]#0) {{.*}} : (!fir.box<!fir.array<?xf32>>) -> ()
! CHECK:  hlfir.copy_out %[[VAL_1]], %[[VAL_7]]#1, %[[VAL_7]]#2 to %[[VAL_7]]#3 : (!fir.ref<!fir.box<!fir.ptr<!fir.array<?xf32>>>>, i1, i1, !fir.box<!fir.ptr<!fir.array<?xf32>>>) -> ()
! CHECK:  return
! CHECK:}
