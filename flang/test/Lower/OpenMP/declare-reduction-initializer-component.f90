...
!CHECK: omp.declare_reduction @_QQFtest_component_initadd_member_byref_rec__QFtest_component_initTt byref_element_type({{.*}}) : !fir.ref<!fir.type<_QFtest_component_initTt{member:i32}>>
!CHECK-SAME: alloc {
