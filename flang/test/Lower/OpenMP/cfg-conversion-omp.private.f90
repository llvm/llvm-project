...
! RUN:   -o - test.f90 2>&1 | \
! RUN: fir-opt --cfg-conversion -o test.cfg-conv.aiir
! RUN: FileCheck --input-file=test.cfg-conv.aiir %s --check-prefix="CFGConv"

! RUN: fir-opt --convert-hlfir-to-fir --cfg-conversion --cg-rewrite --fir-to-llvm-ir test.cfg-conv.aiir -o - | \
