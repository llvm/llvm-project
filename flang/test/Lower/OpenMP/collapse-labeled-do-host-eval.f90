...
! as intervening code by the collapsed-loop-nest lowering: doing so emits a
! spurious guard around an otherwise empty "after" region. The CHECK-NOT lines
! below detect that guard directly.
