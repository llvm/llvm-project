...
!--- plain.use.f90
! CHECK: omp.declare_reduction @[[RED1:_QQ[A-Za-z0-9_.]*op\.plus\.[A-Za-z0-9_.]*]] byref_element_type({{.*}}) : !fir.ref
! CHECK: omp.wsloop
...
!--- rename.use.f90
! CHECK: omp.declare_reduction @[[RED2:_QQ[A-Za-z0-9_.]*op\.remote\.[A-Za-z0-9_.]*]] byref_element_type({{.*}}) : !fir.ref
! CHECK: omp.wsloop
...
! CHECK-DAG: omp.declare_reduction @{{_QQ[A-Za-z0-9_.]*addmod[A-Za-z0-9_.]*op\.remote\.[A-Za-z0-9_.]*}} byref_element_type({{.*}}) : !fir.ref
! CHECK-DAG: omp.declare_reduction @{{_QQ[A-Za-z0-9_.]*mulmod[A-Za-z0-9_.]*op\.remote\.[A-Za-z0-9_.]*}} byref_element_type({{.*}}) : !fir.ref
! CHECK-NOT: not yet implemented
program main
  use red_ty, only: t
