...
!CHECK-LABEL: omp.declare_reduction @max_byref_f32 byref_element_type({{.*}}) : !fir.ref<f32>
!CHECK-SAME: alloc {
...
!CHECK-LABEL: omp.declare_reduction @max_byref_i32 byref_element_type({{.*}}) : !fir.ref<i32>
!CHECK-SAME: alloc {
