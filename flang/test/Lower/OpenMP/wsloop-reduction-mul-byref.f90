...
! CHECK-LABEL:   omp.declare_reduction @multiply_reduction_byref_f64 byref_element_type({{.*}}) : !fir.ref<f64>
! CHECK-SAME:    alloc {
...
! CHECK-LABEL:   omp.declare_reduction @multiply_reduction_byref_i64 byref_element_type({{.*}}) : !fir.ref<i64>
! CHECK-SAME:    alloc {
...
! CHECK-LABEL:   omp.declare_reduction @multiply_reduction_byref_f32 byref_element_type({{.*}}) : !fir.ref<f32>
! CHECK-SAME:    alloc {
...
! CHECK-LABEL:   omp.declare_reduction @multiply_reduction_byref_i32 byref_element_type({{.*}}) : !fir.ref<i32>
! CHECK-SAME:    alloc {
