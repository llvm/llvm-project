...
subroutine ivdep_test1 
  ...
  do i=1,10
     ...
     !CHECK: %[[VAL_13:.*]] = arith.addi %[[ARG0:.*]], %[[C1:.*]] overflow<nsw> : index 
     ...
     !CHECK: fir.result %[[VAL_13]], %[[VAL_16]]
  end do     
...
subroutine ivdep_test2
  ...
  do i=1,10
     ...
     !CHECK: %[[VAL_27:.*]] = arith.addi %[[ARG0:.*]], %[[C1:.*]] overflow<nsw> : index 
     ...
     !CHECK: fir.result %[[VAL_27]], %[[VAL_30]] 
  end do
