...
contains
  ...
  ! CHECK:           %[[VAL_0:.*]] = fir.alloca !fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>
  ...
  ! CHECK:           %[[VAL_11:.*]]:3 = hlfir.copy_in %[[VAL_10]] to %[[VAL_0]] : (!fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>, !fir.ref<!fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>>) -> (!fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>, i1, i1)
  ...
  ! CHECK:           hlfir.copy_out %[[VAL_0]], %[[VAL_11]]#1, %[[VAL_11]]#2 : (!fir.ref<!fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>>, i1, i1) -> ()
  ...
  ! CHECK:           hlfir.copy_out %[[VAL_0]], %[[VAL_6]]#1, %[[VAL_6]]#2 : (!fir.ref<!fir.box<!fir.array<2x!fir.type<_QFTp{a:i32}>>>>, i1, i1) -> ()
  ...
  ! CHECK:           %[[VAL_35:.*]]:3 = hlfir.copy_in %[[VAL_34]] to %[[VAL_0:.*]] : (!fir.box<!fir.array<?x!fir.type<_QFTp{a:i32}>>>, !fir.ref<!fir.box<!fir.array<?x!fir.type<_QFTp{a:i32}>>>>) -> (!fir.box<!fir.array<?x!fir.type<_QFTp{a:i32}>>>, i1, i1)
  ...
  ! CHECK:           hlfir.copy_out %[[VAL_0]], %[[VAL_35]]#1, %[[VAL_35]]#2 : (!fir.ref<!fir.box<!fir.array<?x!fir.type<_QFTp{a:i32}>>>>, i1, i1) -> ()
