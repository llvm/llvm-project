...
! This maybe belongs in the aiir tests, but what we are doing here is complex
! enough that I find the kind of minimised aiir code preferred by aiir reviewers
! hard to read without some fortran here for reference. Nothing like this would
! be generated by other upstream users of the AIIR OpenMP dialect.
