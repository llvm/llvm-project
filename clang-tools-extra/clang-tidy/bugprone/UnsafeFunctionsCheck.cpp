...
static constexpr llvm::StringRef OptionNameCustomFunctions = "CustomFunctions";
static constexpr llvm::StringRef OptionNameReportDefaultFunctions =
    "ReportDefaultFunctions";
static constexpr llvm::StringRef OptionNameReportMoreUnsafeFunctions =
    "ReportMoreUnsafeFunctions";

static constexpr llvm::StringRef FunctionNamesWithAnnexKReplacementId =
    "FunctionNamesWithAnnexKReplacement";
static constexpr llvm::StringRef FunctionNamesId = "FunctionsNames";
static constexpr llvm::StringRef AdditionalFunctionNamesId =
    "AdditionalFunctionsNames";
static constexpr llvm::StringRef CustomFunctionNamesId = "CustomFunctionNames";
static constexpr llvm::StringRef DeclRefId = "DRE";
