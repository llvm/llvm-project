...
modern C++. This is clearer, works better with ``auto`` and structured
...
.. note::
   ...
   This check does not provide fix-its because changing the return type
   requires updating all call sites, which may span multiple translation
   units.
