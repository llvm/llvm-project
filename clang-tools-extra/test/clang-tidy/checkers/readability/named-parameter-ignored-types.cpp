...
// function CHECK-FIXES: void f_other(OtherTag /*unused*/) {}
...
// function CHECK-FIXES: void f_int(int /*unused*/) {}
...
// CHECK-MESSAGES: :[[@LINE-1]]:32: warning: all parameters should be named in a
// function CHECK-FIXES: void f_in_place(std::in_place_t /*unused*/) {}
