...
clang-20 -target spir64-unknown-unknown -x cl -emit-llvm -S -o $OUT/vadd.ll inter/test/Integration/Inputs/vadd.cl
...
ocloc compile -file inter/test/Integration/Inputs/vadd.cl -device bmg-g21 -out_dir $OUT/ref -q
