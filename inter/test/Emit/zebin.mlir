...
// RUN: inter-opt %t.slm.mlir --inter-normalize-cf --lift-cf-to-scf --inter-convert-calls --inter-convert-memory --inter-select-to-machine --inter-insert-sync -o %t.slm.xemachine.mlir
...
// RUN: inter-opt %t.atomic.mlir --inter-normalize-cf --lift-cf-to-scf --inter-convert-calls --inter-convert-memory --inter-select-to-machine --inter-insert-sync -o %t.atomic.xemachine.mlir
...
// ZE-COUNT-3: arg_type: arg_bypointer
