...
func.func @k() {
  ...
  // CHECK-NEXT: pc=32 opcode=send exec=1 swsb=0x340 sfid=ugm exdesc=0xff000000 desc=0x6219d500 mask=nomask channel=0 pred=normal dst=grf8 src0=grf4 src1=arf0 len=0 eot=0
  ...
  // CHECK-NEXT: pc=64 opcode=send exec=32 swsb=0x361 sfid=ugm exdesc=0x0 desc=0x8000584 mask=normal channel=0 pred=normal dst=arf0 src0=grf4 src1=grf6 len=2 eot=0
  ...
  // CHECK-NEXT: pc=80 opcode=send exec=1 swsb=0xc2 sfid=gateway exdesc=0x0 desc=0x2000010 mask=nomask channel=0 pred=normal dst=arf0 src0=grf10 src1=arf0 len=0 eot=1
