# Device 0x8046: BarcodeScannerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8046` (32838) |
| **Name** | BarcodeScannerDevice |
| **Group** | Group 5: Peripheral Control (0x803C-0x8047) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8046_barcodescanner.py` |
...
# Get device 0x8046
device = registry.get_device(32838)
