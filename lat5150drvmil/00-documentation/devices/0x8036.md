# Device 0x8036: VolumeManagerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8036` (32822) |
| **Name** | VolumeManagerDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8036_volumemanager.py` |
...
# Get device 0x8036
device = registry.get_device(32822)
