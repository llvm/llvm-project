# Device 0x800e: GeofenceControlDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x800e` (32782) |
| **Name** | GeofenceControlDevice |
| **Group** | Group 1: Extended Security (0x800C-0x8017) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x800e_geofencecontrol.py` |
...
# Get device 0x800e
device = registry.get_device(32782)
