# Device 0x802f: DataFusionDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x802f` (32815) |
| **Name** | DataFusionDevice |
| **Group** | Group 3: Data Processing (0x8024-0x802F) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x802f_datafusion.py` |
...
# Get device 0x802f
device = registry.get_device(32815)
