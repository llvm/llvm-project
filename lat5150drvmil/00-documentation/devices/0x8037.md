# Device 0x8037: SnapshotControlDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8037` (32823) |
| **Name** | SnapshotControlDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8037_snapshotcontrol.py` |

## Description

SnapshotControl (0x8037)
...
# Get device 0x8037
device = registry.get_device(32823)
