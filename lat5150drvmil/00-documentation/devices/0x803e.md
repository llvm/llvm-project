# Device 0x803e: ServoManagerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x803e` (32830) |
| **Name** | ServoManagerDevice |
| **Group** | Group 5: Peripheral Control (0x803C-0x8047) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x803e_servomanager.py` |
...
# Get device 0x803e
device = registry.get_device(32830)
