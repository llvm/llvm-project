# Device 0x8051: ExpertSystemDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8051` (32849) |
| **Name** | ExpertSystemDevice |
| **Group** | Group 6: Training/Simulation (0x8048-0x8053) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8051_expertsystem.py` |
...
# Get device 0x8051
device = registry.get_device(32849)
