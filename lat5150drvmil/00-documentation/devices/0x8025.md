# Device 0x8025: CryptoAccelDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8025` (32805) |
| **Name** | CryptoAccelDevice |
| **Group** | Group 3: Data Processing (0x8024-0x802F) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8025_cryptoaccel.py` |
...
# Get device 0x8025
device = registry.get_device(32805)
