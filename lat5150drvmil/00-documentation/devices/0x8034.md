# Device 0x8034: DataSanitizerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8034` (32820) |
| **Name** | DataSanitizerDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8034_datasanitizer.py` |
...
# Get device 0x8034
device = registry.get_device(32820)
