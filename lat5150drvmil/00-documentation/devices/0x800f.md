# Device 0x800f: KeyManagementDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x800f` (32783) |
| **Name** | KeyManagementDevice |
| **Group** | Group 1: Extended Security (0x800C-0x8017) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x800f_keymanagement.py` |

## Description

KeyManagement (0x800f)
...
# Get device 0x800f
device = registry.get_device(32783)
