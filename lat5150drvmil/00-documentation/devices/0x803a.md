# Device 0x803a: TieringControlDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x803a` (32826) |
| **Name** | TieringControlDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x803a_tieringcontrol.py` |
...
# Get device 0x803a
device = registry.get_device(32826)
