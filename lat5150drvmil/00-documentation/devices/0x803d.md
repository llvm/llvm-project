# Device 0x803d: ActuatorControlDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x803d` (32829) |
| **Name** | ActuatorControlDevice |
| **Group** | Group 5: Peripheral Control (0x803C-0x8047) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x803d_actuatorcontrol.py` |
...
# Get device 0x803d
device = registry.get_device(32829)
