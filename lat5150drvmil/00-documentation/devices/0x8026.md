# Device 0x8026: SignalAnalysisDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8026` (32806) |
| **Name** | SignalAnalysisDevice |
| **Group** | Group 3: Data Processing (0x8024-0x802F) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8026_signalanalysis.py` |
...
# Get device 0x8026
device = registry.get_device(32806)
