# Device 0x8047: RFIDReaderDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8047` (32839) |
| **Name** | RFIDReaderDevice |
| **Group** | Group 5: Peripheral Control (0x803C-0x8047) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8047_rfidreader.py` |
...
# Get device 0x8047
device = registry.get_device(32839)
