# Device 0x8012: VPNControllerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8012` (32786) |
| **Name** | VPNControllerDevice |
| **Group** | Group 1: Extended Security (0x800C-0x8017) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8012_vpncontroller.py` |

## Description

VPNController (0x8012)
...
# Get device 0x8012
device = registry.get_device(32786)
