# Device 0x800d: BiometricAuthDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x800d` (32781) |
| **Name** | BiometricAuthDevice |
| **Group** | Group 1: Extended Security (0x800C-0x8017) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x800d_biometricauth.py` |

## Description

BiometricAuth (0x800d)
...
# Get device 0x800d
device = registry.get_device(32781)
