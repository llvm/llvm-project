# Device 0x8011: TokenManagerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8011` (32785) |
| **Name** | TokenManagerDevice |
| **Group** | Group 1: Extended Security (0x800C-0x8017) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8011_tokenmanager.py` |
...
# Get device 0x8011
device = registry.get_device(32785)
