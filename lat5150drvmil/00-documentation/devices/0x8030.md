# Device 0x8030: StorageEncryptionDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8030` (32816) |
| **Name** | StorageEncryptionDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8030_storageencryption.py` |

## Description

StorageEncryption (0x8030)
...
# Get device 0x8030
device = registry.get_device(32816)
