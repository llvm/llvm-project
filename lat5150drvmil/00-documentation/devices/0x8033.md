# Device 0x8033: BackupManagerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8033` (32819) |
| **Name** | BackupManagerDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8033_backupmanager.py` |

## Description

BackupManager (0x8033)
...
# Get device 0x8033
device = registry.get_device(32819)
