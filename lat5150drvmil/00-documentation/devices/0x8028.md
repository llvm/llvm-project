# Device 0x8028: VideoEncoderDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8028` (32808) |
| **Name** | VideoEncoderDevice |
| **Group** | Group 3: Data Processing (0x8024-0x802F) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8028_videoencoder.py` |
...
# Get device 0x8028
device = registry.get_device(32808)
