# Device 0x8044: GestureRecognitionDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8044` (32836) |
| **Name** | GestureRecognitionDevice |
| **Group** | Group 5: Peripheral Control (0x803C-0x8047) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8044_gesturerecognition.py` |
...
# Get device 0x8044
device = registry.get_device(32836)
