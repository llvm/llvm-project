# Device 0x8032: RAIDControllerDevice

## Device Information

| Property | Value |
|----------|-------|
| **Device ID** | `0x8032` (32818) |
| **Name** | RAIDControllerDevice |
| **Group** | Group 4: Storage Management (0x8030-0x803B) |
| **Risk Level** | 🟢 SAFE |
| **Total Operations** | 7 |
| **Total Registers** | 2 |
| **Implementation File** | `device_0x8032_raidcontroller.py` |
...
# Get device 0x8032
device = registry.get_device(32818)
