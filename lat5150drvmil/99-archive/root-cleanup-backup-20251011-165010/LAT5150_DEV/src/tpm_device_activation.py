...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(os.environ.get("DSMIL_HOME", os.path.expanduser("~")), "Documents", "LAT5150DRVMIL", "", "tpm_activation.log")),
...
class TPMActivation:
    ...
    def load_kernel_module(self):
        ...
        module_path = Path(os.path.join(os.environ.get("DSMIL_HOME", os.path.expanduser("~")), "Documents", "LAT5150DRVMIL", "", "01-source/kernel/dsmil-72dev.ko"))
    ...
    def create_rollback_point(self):
        ...
        # Save rollback point
        rollback_file = Path(os.path.join(os.environ.get("DSMIL_HOME", os.path.expanduser("~")), "Documents", "LAT5150DRVMIL", "", "tpm_rollback.json"))
    ...
    def save_activation_report(self):
        ...
        report_file = Path(os.path.join(os.environ.get("DSMIL_HOME", os.path.expanduser("~")), "Documents", "LAT5150DRVMIL", "", "tpm_activation_report.json"))
