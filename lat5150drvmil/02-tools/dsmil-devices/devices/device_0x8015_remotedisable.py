#!/usr/bin/env python3
"""
Device 0x8015: RemoteDisable

Group 1 Device 9 - RemoteDisable
...
class RemoteDisableDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32789,
                 name: str = "RemoteDisableDevice",
                 description: str = "Group 1 Device 9 - RemoteDisable"):
