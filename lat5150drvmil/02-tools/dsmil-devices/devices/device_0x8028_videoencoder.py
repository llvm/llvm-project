#!/usr/bin/env python3
"""
Device 0x8028: VideoEncoder

Group 3 Device 4 - VideoEncoder
...
class VideoEncoderDevice(DSMILDeviceBase):
    """VideoEncoder (0x8028)"""
    ...
    def __init__(self, device_id: int = 32808,
                 name: str = "VideoEncoderDevice",
                 description: str = "Group 3 Device 4 - VideoEncoder"):
