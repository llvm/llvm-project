#!/usr/bin/env python3
"""
Device 0x8042: AudioOutput

Group 5 Device 6 - AudioOutput
...
class AudioOutputDevice(DSMILDeviceBase):
    """AudioOutput (0x8042)"""
    ...
    def __init__(self, device_id: int = 32834,
                 name: str = "AudioOutputDevice",
                 description: str = "Group 5 Device 6 - AudioOutput"):
