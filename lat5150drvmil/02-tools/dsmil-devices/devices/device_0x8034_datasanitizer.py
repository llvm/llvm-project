#!/usr/bin/env python3
"""
Device 0x8034: DataSanitizer

Group 4 Device 4 - DataSanitizer
...
class DataSanitizerDevice(DSMILDeviceBase):
    """DataSanitizer (0x8034)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32820,
                 name: str = "DataSanitizerDevice",
                 description: str = "Group 4 Device 4 - DataSanitizer"):
