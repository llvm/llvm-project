#!/usr/bin/env python3
"""
Device 0x8044: GestureRecognition

Group 5 Device 8 - GestureRecognition
...
class GestureRecognitionDevice(DSMILDeviceBase):
    """GestureRecognition (0x8044)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32836,
                 name: str = "GestureRecognitionDevice",
                 description: str = "Group 5 Device 8 - GestureRecognition"):
