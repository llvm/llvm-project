#!/usr/bin/env python3
"""
Device 0x8020: FrequencyHop

Group 2 Device 8 - FrequencyHop
...
class FrequencyHopDevice(DSMILDeviceBase):
    """FrequencyHop (0x8020)"""
    ...
    def __init__(self, device_id: int = 32800,
                 name: str = "FrequencyHopDevice",
                 description: str = "Group 2 Device 8 - FrequencyHop"):
