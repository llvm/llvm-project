#!/usr/bin/env python3
"""
Device 0x8021: SystemReset

Group 2 Device 9 - SystemReset
...
class SystemResetDevice(DSMILDeviceBase):
    """SystemReset (0x8021)"""
    ...
    def __init__(self, device_id: int = 32801,
                 name: str = "SystemResetDevice",
                 description: str = "Group 2 Device 9 - SystemReset"):
