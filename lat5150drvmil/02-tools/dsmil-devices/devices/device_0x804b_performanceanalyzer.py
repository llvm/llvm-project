#!/usr/bin/env python3
"""
Device 0x804b: PerformanceAnalyzer

Group 6 Device 3 - PerformanceAnalyzer
...
class PerformanceAnalyzerDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32843,
                 name: str = "PerformanceAnalyzerDevice",
                 description: str = "Group 6 Device 3 - PerformanceAnalyzer"):
