#!/usr/bin/env python3
"""
Device 0x8023: PacketFilter

Group 2 Device 11 - PacketFilter
...
class PacketFilterDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32803,
                 name: str = "PacketFilterDevice",
                 description: str = "Group 2 Device 11 - PacketFilter"):
