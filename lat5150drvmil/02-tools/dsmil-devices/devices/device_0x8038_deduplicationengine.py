#!/usr/bin/env python3
"""
Device 0x8038: DeduplicationEngine

Group 4 Device 8 - DeduplicationEngine
...
class DeduplicationEngineDevice(DSMILDeviceBase):
    """DeduplicationEngine (0x8038)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32824,
                 name: str = "DeduplicationEngineDevice",
                 description: str = "Group 4 Device 8 - DeduplicationEngine"):
