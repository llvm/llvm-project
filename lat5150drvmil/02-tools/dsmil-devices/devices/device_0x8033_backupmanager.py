#!/usr/bin/env python3
"""
Device 0x8033: BackupManager

Group 4 Device 3 - BackupManager
...
class BackupManagerDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32819,
                 name: str = "BackupManagerDevice",
                 description: str = "Group 4 Device 3 - BackupManager"):
