#!/usr/bin/env python3
"""
Device 0x8027: ImageProcessor

Group 3 Device 3 - ImageProcessor
...
class ImageProcessorDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32807,
                 name: str = "ImageProcessorDevice",
                 description: str = "Group 3 Device 3 - ImageProcessor"):
