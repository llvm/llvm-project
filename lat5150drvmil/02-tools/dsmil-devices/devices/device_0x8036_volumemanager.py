#!/usr/bin/env python3
"""
Device 0x8036: VolumeManager

Group 4 Device 6 - VolumeManager
...
class VolumeManagerDevice(DSMILDeviceBase):
    """VolumeManager (0x8036)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32822,
                 name: str = "VolumeManagerDevice",
                 description: str = "Group 4 Device 6 - VolumeManager"):
