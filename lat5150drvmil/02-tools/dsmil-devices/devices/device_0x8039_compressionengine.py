#!/usr/bin/env python3
"""
Device 0x8039: CompressionEngine

Group 4 Device 9 - CompressionEngine
...
class CompressionEngineDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32825,
                 name: str = "CompressionEngineDevice",
                 description: str = "Group 4 Device 9 - CompressionEngine"):
