#!/usr/bin/env python3
"""
Device 0x804f: CollaborationHub

Group 6 Device 7 - CollaborationHub
...
class CollaborationHubDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32847,
                 name: str = "CollaborationHubDevice",
                 description: str = "Group 6 Device 7 - CollaborationHub"):
