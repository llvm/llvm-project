#!/usr/bin/env python3
"""
Device 0x801c: DataLink

Group 2 Device 4 - DataLink
...
class DataLinkDevice(DSMILDeviceBase):
    """DataLink (0x801c)"""
    ...
    def __init__(self, device_id: int = 32796,
                 name: str = "DataLinkDevice",
                 description: str = "Group 2 Device 4 - DataLink"):
