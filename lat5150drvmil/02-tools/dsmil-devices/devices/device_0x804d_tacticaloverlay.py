#!/usr/bin/env python3
"""
Device 0x804d: TacticalOverlay

Group 6 Device 5 - TacticalOverlay
...
class TacticalOverlayDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32845,
                 name: str = "TacticalOverlayDevice",
                 description: str = "Group 6 Device 5 - TacticalOverlay"):
