#!/usr/bin/env python3
"""
Device 0x801d: SatelliteComm

Group 2 Device 5 - SatelliteComm
...
class SatelliteCommDevice(DSMILDeviceBase):
    """SatelliteComm (0x801d)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32797,
                 name: str = "SatelliteCommDevice",
                 description: str = "Group 2 Device 5 - SatelliteComm"):
