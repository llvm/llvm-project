#!/usr/bin/env python3
"""
Device 0x803d: ActuatorControl

Group 5 Device 1 - ActuatorControl
...
class ActuatorControlDevice(DSMILDeviceBase):
    """ActuatorControl (0x803d)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32829,
                 name: str = "ActuatorControlDevice",
                 description: str = "Group 5 Device 1 - ActuatorControl"):
