#!/usr/bin/env python3
"""
Device 0x804e: DecisionSupport

Group 6 Device 6 - DecisionSupport
...
class DecisionSupportDevice(DSMILDeviceBase):
    """DecisionSupport (0x804e)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32846,
                 name: str = "DecisionSupportDevice",
                 description: str = "Group 6 Device 6 - DecisionSupport"):
