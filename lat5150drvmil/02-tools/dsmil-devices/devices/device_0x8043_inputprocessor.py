#!/usr/bin/env python3
"""
Device 0x8043: InputProcessor

Group 5 Device 7 - InputProcessor
...
class InputProcessorDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32835,
                 name: str = "InputProcessorDevice",
                 description: str = "Group 5 Device 7 - InputProcessor"):
