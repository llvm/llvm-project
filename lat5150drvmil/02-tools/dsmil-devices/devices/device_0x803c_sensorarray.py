#!/usr/bin/env python3
"""
Device 0x803c: SensorArray

Group 5 Device 0 - SensorArray
...
class SensorArrayDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32828,
                 name: str = "SensorArrayDevice",
                 description: str = "Group 5 Device 0 - SensorArray"):
