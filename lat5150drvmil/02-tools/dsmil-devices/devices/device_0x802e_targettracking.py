#!/usr/bin/env python3
"""
Device 0x802e: TargetTracking

Group 3 Device 10 - TargetTracking
...
class TargetTrackingDevice(DSMILDeviceBase):
    """TargetTracking (0x802e)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32814,
                 name: str = "TargetTrackingDevice",
                 description: str = "Group 3 Device 10 - TargetTracking"):
