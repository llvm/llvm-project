#!/usr/bin/env python3
"""
Device 0x8052: AdaptiveLearning

Group 6 Device 10 - AdaptiveLearning
...
class AdaptiveLearningDevice(DSMILDeviceBase):
    """AdaptiveLearning (0x8052)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32850,
                 name: str = "AdaptiveLearningDevice",
                 description: str = "Group 6 Device 10 - AdaptiveLearning"):
