#!/usr/bin/env python3
"""
Device 0x803f: MotionControl

Group 5 Device 3 - MotionControl
...
class MotionControlDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32831,
                 name: str = "MotionControlDevice",
                 description: str = "Group 5 Device 3 - MotionControl"):
