#!/usr/bin/env python3
"""
Device 0x800d: BiometricAuth

Group 1 Device 1 - BiometricAuth
...
class BiometricAuthDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32781,
                 name: str = "BiometricAuthDevice",
                 description: str = "Group 1 Device 1 - BiometricAuth"):
