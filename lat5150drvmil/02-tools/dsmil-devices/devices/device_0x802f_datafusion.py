#!/usr/bin/env python3
"""
Device 0x802f: DataFusion

Group 3 Device 11 - DataFusion
...
class DataFusionDevice(DSMILDeviceBase):
    """DataFusion (0x802f)"""
    ...
    def __init__(self, device_id: int = 32815,
                 name: str = "DataFusionDevice",
                 description: str = "Group 3 Device 11 - DataFusion"):
