#!/usr/bin/env python3
"""
Device 0x803e: ServoManager

Group 5 Device 2 - ServoManager
...
class ServoManagerDevice(DSMILDeviceBase):
    """ServoManager (0x803e)"""
    ...
    def __init__(self, device_id: int = 32830,
                 name: str = "ServoManagerDevice",
                 description: str = "Group 5 Device 2 - ServoManager"):
