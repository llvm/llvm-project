#!/usr/bin/env python3
"""
Device 0x8030: StorageEncryption

Group 4 Device 0 - StorageEncryption
...
class StorageEncryptionDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32816,
                 name: str = "StorageEncryptionDevice",
                 description: str = "Group 4 Device 0 - StorageEncryption"):
