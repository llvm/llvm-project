#!/usr/bin/env python3
"""
Device 0x8032: RAIDController

Group 4 Device 2 - RAIDController
...
class RAIDControllerDevice(DSMILDeviceBase):
    """RAIDController (0x8032)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32818,
                 name: str = "RAIDControllerDevice",
                 description: str = "Group 4 Device 2 - RAIDController"):
