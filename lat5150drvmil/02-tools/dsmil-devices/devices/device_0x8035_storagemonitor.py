#!/usr/bin/env python3
"""
Device 0x8035: StorageMonitor

Group 4 Device 5 - StorageMonitor
...
class StorageMonitorDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32821,
                 name: str = "StorageMonitorDevice",
                 description: str = "Group 4 Device 5 - StorageMonitor"):
