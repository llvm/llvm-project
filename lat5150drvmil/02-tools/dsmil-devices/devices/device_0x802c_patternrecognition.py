#!/usr/bin/env python3
"""
Device 0x802c: PatternRecognition

Group 3 Device 8 - PatternRecognition
...
class PatternRecognitionDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32812,
                 name: str = "PatternRecognitionDevice",
                 description: str = "Group 3 Device 8 - PatternRecognition"):
