#!/usr/bin/env python3
"""
Device 0x803a: TieringControl

Group 4 Device 10 - TieringControl
...
class TieringControlDevice(DSMILDeviceBase):
    """TieringControl (0x803a)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32826,
                 name: str = "TieringControlDevice",
                 description: str = "Group 4 Device 10 - TieringControl"):
