#!/usr/bin/env python3
"""
Device 0x8025: CryptoAccel

Group 3 Device 1 - CryptoAccel
...
class CryptoAccelDevice(DSMILDeviceBase):
    """CryptoAccel (0x8025)"""
    ...
    def __init__(self, device_id: int = 32805,
                 name: str = "CryptoAccelDevice",
                 description: str = "Group 3 Device 1 - CryptoAccel"):
