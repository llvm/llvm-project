#!/usr/bin/env python3
"""
Device 0x8048: SimulationEngine

Group 6 Device 0 - SimulationEngine
...
class SimulationEngineDevice(DSMILDeviceBase):
    """SimulationEngine (0x8048)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32840,
                 name: str = "SimulationEngineDevice",
                 description: str = "Group 6 Device 0 - SimulationEngine"):
