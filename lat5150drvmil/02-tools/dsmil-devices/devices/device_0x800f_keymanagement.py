#!/usr/bin/env python3
"""
Device 0x800f: KeyManagement

Group 1 Device 3 - KeyManagement
...
class KeyManagementDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32783,
                 name: str = "KeyManagementDevice",
                 description: str = "Group 1 Device 3 - KeyManagement"):
