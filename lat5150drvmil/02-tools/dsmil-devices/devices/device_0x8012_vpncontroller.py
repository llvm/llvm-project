#!/usr/bin/env python3
"""
Device 0x8012: VPNController

Group 1 Device 6 - VPNController
...
class VPNControllerDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32786,
                 name: str = "VPNControllerDevice",
                 description: str = "Group 1 Device 6 - VPNController"):
