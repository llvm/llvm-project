#!/usr/bin/env python3
"""
Device 0x800c: IntrusionDetection

Group 1 Device 0 - IntrusionDetection
...
class IntrusionDetectionDevice(DSMILDeviceBase):
    """IntrusionDetection (0x800c)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32780,
                 name: str = "IntrusionDetectionDevice",
                 description: str = "Group 1 Device 0 - IntrusionDetection"):
