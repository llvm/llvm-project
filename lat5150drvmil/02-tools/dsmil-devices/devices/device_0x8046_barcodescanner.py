#!/usr/bin/env python3
"""
Device 0x8046: BarcodeScanner

Group 5 Device 10 - BarcodeScanner
...
class BarcodeScannerDevice(DSMILDeviceBase):
    """BarcodeScanner (0x8046)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32838,
                 name: str = "BarcodeScannerDevice",
                 description: str = "Group 5 Device 10 - BarcodeScanner"):
