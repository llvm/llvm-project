#!/usr/bin/env python3
"""
Device 0x8024: DataProcessor

Group 3 Device 0 - DataProcessor
...
class DataProcessorDevice(DSMILDeviceBase):
    """DataProcessor (0x8024)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32804,
                 name: str = "DataProcessorDevice",
                 description: str = "Group 3 Device 0 - DataProcessor"):
