#!/usr/bin/env python3
"""
Device 0x802d: ThreatAnalysis

Group 3 Device 9 - ThreatAnalysis
...
class ThreatAnalysisDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32813,
                 name: str = "ThreatAnalysisDevice",
                 description: str = "Group 3 Device 9 - ThreatAnalysis"):
