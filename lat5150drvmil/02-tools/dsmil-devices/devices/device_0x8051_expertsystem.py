#!/usr/bin/env python3
"""
Device 0x8051: ExpertSystem

Group 6 Device 9 - ExpertSystem
...
class ExpertSystemDevice(DSMILDeviceBase):
    """ExpertSystem (0x8051)"""
    ...
    def __init__(self, device_id: int = 32849,
                 name: str = "ExpertSystemDevice",
                 description: str = "Group 6 Device 9 - ExpertSystem"):
