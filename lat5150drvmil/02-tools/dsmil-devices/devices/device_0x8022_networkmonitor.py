#!/usr/bin/env python3
"""
Device 0x8022: NetworkMonitor

Group 2 Device 10 - NetworkMonitor
...
class NetworkMonitorDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32802,
                 name: str = "NetworkMonitorDevice",
                 description: str = "Group 2 Device 10 - NetworkMonitor"):
