#!/usr/bin/env python3
"""
Device 0x8040: HapticFeedback

Group 5 Device 4 - HapticFeedback
...
class HapticFeedbackDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32832,
                 name: str = "HapticFeedbackDevice",
                 description: str = "Group 5 Device 4 - HapticFeedback"):
