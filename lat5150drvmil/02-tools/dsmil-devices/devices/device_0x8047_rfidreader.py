#!/usr/bin/env python3
"""
Device 0x8047: RFIDReader

Group 5 Device 11 - RFIDReader
...
class RFIDReaderDevice(DSMILDeviceBase):
    """RFIDReader (0x8047)"""
    ...
    def __init__(self, device_id: int = 32839,
                 name: str = "RFIDReaderDevice",
                 description: str = "Group 5 Device 11 - RFIDReader"):
