#!/usr/bin/env python3
"""
Device 0x804a: TrainingRecorder

Group 6 Device 2 - TrainingRecorder
...
class TrainingRecorderDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32842,
                 name: str = "TrainingRecorderDevice",
                 description: str = "Group 6 Device 2 - TrainingRecorder"):
