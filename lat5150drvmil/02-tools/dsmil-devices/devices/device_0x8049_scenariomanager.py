#!/usr/bin/env python3
"""
Device 0x8049: ScenarioManager

Group 6 Device 1 - ScenarioManager
...
class ScenarioManagerDevice(DSMILDeviceBase):
    """ScenarioManager (0x8049)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32841,
                 name: str = "ScenarioManagerDevice",
                 description: str = "Group 6 Device 1 - ScenarioManager"):
