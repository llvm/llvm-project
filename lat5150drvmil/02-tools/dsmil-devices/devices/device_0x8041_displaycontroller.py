#!/usr/bin/env python3
"""
Device 0x8041: DisplayController

Group 5 Device 5 - DisplayController
...
class DisplayControllerDevice(DSMILDeviceBase):
    """DisplayController (0x8041)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32833,
                 name: str = "DisplayControllerDevice",
                 description: str = "Group 5 Device 5 - DisplayController"):
