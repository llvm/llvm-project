#!/usr/bin/env python3
"""
Device 0x8037: SnapshotControl

Group 4 Device 7 - SnapshotControl
...
class SnapshotControlDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32823,
                 name: str = "SnapshotControlDevice",
                 description: str = "Group 4 Device 7 - SnapshotControl"):
