#!/usr/bin/env python3
"""
Device 0x803b: CacheOptimizer

Group 4 Device 11 - CacheOptimizer
...
class CacheOptimizerDevice(DSMILDeviceBase):
    """CacheOptimizer (0x803b)"""

    # Register map
    REG_STATUS = 0x00
    REG_CONTROL = 0x04

    def __init__(self, device_id: int = 32827,
                 name: str = "CacheOptimizerDevice",
                 description: str = "Group 4 Device 11 - CacheOptimizer"):
