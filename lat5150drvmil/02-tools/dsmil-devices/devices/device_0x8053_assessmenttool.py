#!/usr/bin/env python3
"""
Device 0x8053: AssessmentTool

Group 6 Device 11 - AssessmentTool
...
class AssessmentToolDevice(DSMILDeviceBase):
    ...
    def __init__(self, device_id: int = 32851,
                 name: str = "AssessmentToolDevice",
                 description: str = "Group 6 Device 11 - AssessmentTool"):
