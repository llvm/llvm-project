...
fn print_banner() {
    ...
    println!(
        "{}",
        "║              DSMIL SECURITY CHAOS TESTING FRAMEWORK             ║".cyan()
    );
    println!(
        "{}",
        "║                          Version 1.0.0                          ║".cyan()
    ...
    println!(
        "{}",
        "║        Military-Grade Security Validation and Testing           ║".cyan()
    );
    println!(
        "{}",
        "║              84-Device DSMIL System Protection                   ║".cyan()
    );
    println!(
        "{}",
        "╚══════════════════════════════════════════════════════════════════╝".cyan()
...
async fn show_status(
    ...
    // Recent activity (placeholder – no persistence yet)
    println!();
