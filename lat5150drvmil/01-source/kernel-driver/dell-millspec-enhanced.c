...
#define MILSPEC_VERSION "2.1"
#define LOG_BUFFER_SIZE 65536
#define MILSPEC_API_VERSION 0x020100
...
/* DSMIL subsystem structure - 84 total across 7 groups */
#define DSMIL_GROUPS 7
#define DSMIL_DEVICES_PER_GROUP 12
#define DSMIL_TOTAL_SUBSYSTEMS (DSMIL_GROUPS * DSMIL_DEVICES_PER_GROUP)

struct dsmil_subsystem {
    char name[16];              /* e.g., "DSMIL0D0" */
    u8 group;                   /* 0-6 (Group 0-6) */
