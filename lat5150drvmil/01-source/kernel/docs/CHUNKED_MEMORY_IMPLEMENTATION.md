...
## Overview
The Dell MIL-SPEC 84-device DSMIL kernel module has been updated to use chunked memory mapping instead of trying to map the entire 360MB region at once. This resolves the ENOMEM error that was occurring due to the large single allocation.
...
version:        2.0.0
description:    Dell MIL-SPEC 84-Device DSMIL Driver
