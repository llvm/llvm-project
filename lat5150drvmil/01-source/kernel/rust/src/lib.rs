...
/// Global static registry wrapped in UnsafeCell for interior mutability
struct GlobalCell<T> {
    inner: UnsafeCell<T>,
}
...
static DEVICE_REGISTRY: GlobalCell<DeviceRegistry> = GlobalCell::new(DeviceRegistry::new());
