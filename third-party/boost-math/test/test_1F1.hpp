...
void test_spots6(T, const char* type_name)
{
   static const std::array<std::array<T, 4>, 189> hypergeometric_1F1_bugs = { {
        ...
        { { static_cast<T>(17955.561660766602), static_cast<T>(17956.061660766602), static_cast<T>(82.406154185533524), SC_(613117565438499794408370861624072730.553215432) }},
        { { static_cast<T>(2.9127331452327709e-07), static_cast<T>(-0.99999970872668542), static_cast<T>(0.15018942760070786), SC_(0.987526018990506843793601092932108059727149508) }},
        { { static_cast<T>(-2.9127331452327709e-07), static_cast<T>(-1.0000002912733146), static_cast<T>(0.15018942760070786), SC_(0.987526120661366412484942089372497015837368389) }},
        { { static_cast<T>(6.7191087900739423e-13), static_cast<T>(-0.99999999999932809), static_cast<T>(0.0011913633891253994), SC_(0.999999289758605006762757201699750974296453229) }},
        { { static_cast<T>(6.7191087900739423e-13), static_cast<T>(-0.99999999999932809), static_cast<T>(-0.0011913633891253994), SC_(0.999999290885918468326416221021126912154021802) }},
        { { static_cast<T>(-6.7191087900739423e-13), static_cast<T>(-1.0000000000006719), static_cast<T>(0.0011913633891253994), SC_(0.999999289758606609651292394510404091049823243) }},
        { { static_cast<T>(-6.7191087900739423e-13), static_cast<T>(-1.0000000000006719), static_cast<T>(-0.0011913633891253994), SC_(0.999999290885916869252591036674587894145399498) }},
        { { static_cast<T>(1.2860067365774887e-17), static_cast<T>(6.2442285664031425e-16), static_cast<T>(-2539.60133934021), SC_(0.979404874070484696999110600576068012417904384) }},
        { { static_cast<T>(1.2860067365774887e-17), static_cast<T>(-6.2442285664031425e-16), static_cast<T>(-2539.60133934021), SC_(1.0205951259295150865252112924093487321207727) }},
        { { static_cast<T>(-1.2860067365774887e-17), static_cast<T>(6.2442285664031425e-16), static_cast<T>(-2539.60133934021), SC_(1.02059512592951530745923325071510441026202975) }},
        { { static_cast<T>(-1.2860067365774887e-17), static_cast<T>(-6.2442285664031425e-16), static_cast<T>(-2539.60133934021), SC_(0.979404874070484909016444856299500644331897735) }},
        { { static_cast<T>(1.2860067365774887e-17), static_cast<T>(1), static_cast<T>(-2539.60133934021), SC_(0.999999999999999891757095137551552220860540801) }},
        { { static_cast<T>(-1.2860067365774887e-17), static_cast<T>(1), static_cast<T>(-2539.60133934021), SC_(1.00000000000000010824290486244845922375479178) }},
        { { static_cast<T>(1.2860067365774887e-17), static_cast<T>(0.5), static_cast<T>(-2539.60133934021), SC_(0.999999999999999873931788919689096760455570214) }},
        { { static_cast<T>(-1.2860067365774887e-17), static_cast<T>(0.5), static_cast<T>(-2539.60133934021), SC_(1.0000000000000001260682110803109183167444166) }},
        { { static_cast<T>(1.2860067365774887e-17), static_cast<T>(-0.5), static_cast<T>(-2539.60133934021), SC_(0.999999999999999899656990458526368219886894767) }},
        { { static_cast<T>(-1.2860067365774887e-17), static_cast<T>(-0.5), static_cast<T>(-2539.60133934021), SC_(1.00000000000000010034300954147364037131355735) }},
        { { static_cast<T>(1.9561377367172441e-13), static_cast<T>(-0.99999999999980438), static_cast<T>(0.53720525559037924), SC_(0.791950585963666119273677451162365759080483409) }},
        { { static_cast<T>(1.9561377367172441e-13), static_cast<T>(-0.99999999999980438), static_cast<T>(-0.53720525559037924), SC_(0.898314630992769591673208399706587643905527327) }},
        { { static_cast<T>(-1.9561377367172441e-13), static_cast<T>(-1.0000000000001956), static_cast<T>(0.53720525559037924), SC_(0.791950585964025761367113514279915403442035074) }},
        { { static_cast<T>(-1.9561377367172441e-13), static_cast<T>(-1.0000000000001956), static_cast<T>(-0.53720525559037924), SC_(0.898314630992646771749564140770704893561753597) }},
        { { static_cast<T>(5.1851756946064858e-12), static_cast<T>(-0.99999999999481481), static_cast<T>(-774.06985878944397), SC_(1.91306610467163858324476828831735612399803649e-06) }},
        { { static_cast<T>(-5.1851756946064858e-12), static_cast<T>(-1.0000000000051852), static_cast<T>(-774.06985878944397), SC_(1.91306610479516297551035931150910859922270467e-06) }},

        {{ static_cast<T>(4.782769898853794e-15), static_cast<T>(1.0000000000000049), static_cast<T>(43.289540141820908), SC_(715.678254892476818206948251991084031658534788) }},
        { { static_cast<T>(-4.782769898853794e-15), static_cast<T>(0.99999999999999523), static_cast<T>(43.289540141820908), SC_(-713.67825489247727251051792450091274703212426) }},
        { { static_cast<T>(4.782769898853794e-15), static_cast<T>(0.50000000000000477), static_cast<T>(43.289540141820908), SC_(8235.578376364917373771471380274179857713986) }},
        { { static_cast<T>(-4.782769898853794e-15), static_cast<T>(0.49999999999999523), static_cast<T>(43.289540141820908), SC_(-8233.57837636502669085205930058992320862281194) }},
        { { static_cast<T>(4.782769898853794e-15), static_cast<T>(-0.49999999999999523), static_cast<T>(43.289540141820908), SC_(-696269.800378137841948029488304613132151506346) }},
        { { static_cast<T>(-4.782769898853794e-15), static_cast<T>(-0.50000000000000477), static_cast<T>(43.289540141820908), SC_(696271.8003781336298001417038674968935893361) }},
        { { static_cast<T>(8.1104991963343309e-05), static_cast<T>(-0.99991889500803666), static_cast<T>(-289.12455415725708), SC_(7.89625448009377635153307897651433007437615965e-124) }},
        { { static_cast<T>(-8.1104991963343309e-05), static_cast<T>(-1.0000811049919633), static_cast<T>(-289.12455415725708), SC_(7.8949781467741574268884621364833028722017032e-124) }},

         {{ static_cast<T>(-1.98018241448205767), static_cast<T>(1.98450573845762079), static_cast<T>(54.4977916804564302), SC_(2972026581564772.790187123046255523239732028) }},

         { { static_cast<T>(-7.8238229420435346e-05), static_cast<T>(-0.50007823822942044), static_cast<T>(-1896.0561106204987), SC_(1.00058778866237037053151236215058095904086972) }},

         // Unexpected high error : 2.48268e+91 Found : -9.61305e+268 Expected : -1.74382e+193
         { { static_cast<T>(5.9981750131794866e-15), static_cast<T>(-230.70702263712883), static_cast<T>(240.42092034220695), SC_(-1.74381782591884817018404492963109914357365958e+193) }},
         ...
         { { static_cast<T>(-5.9981750131794866e-15), static_cast<T>(-230.70702263712883), static_cast<T>(240.42092034220695), SC_(1.74381782591870734495565763481520223752372107e+193) }},
         //Unexpected exception : Error in function boost::math::hypergeometric_pFq<long T> : Cancellation is so severe that no bits in the result are correct, last result was - 13497.312248525042
         { { static_cast<T>(-0.00023636552788275367), static_cast<T>(0.49976363447211725), static_cast<T>(-55.448519088327885), SC_(1.00141219419064760011631555641142295011268795) }},
         // Unexpected exception: Error in function boost::math::hypergeometric_pFq<long T>: Cancellation is so severe that no bits in the result are correct, last result was -13497.312248525042
         {{ static_cast<T>(-0.00023636552788275367), static_cast<T>(-0.50023636552788275), static_cast<T>(-55.448519088327885), SC_(1.00093463146763986302362749764017215184711625) }},
         // Unexpected exception : Error in function boost::math::hypergeometric_pFq<long T> : Cancellation is so severe that no bits in the result are correct, last result was - 1.3871133003351527e+47
         { { static_cast<T>(-1.6548533913638905e-10), static_cast<T>(0.49999999983451465), static_cast<T>(-169.20843148231506), SC_(1.00000000117356793527360151094991866549128017) }},
         // Unexpected exception: Error in function boost::math::hypergeometric_pFq<long T>: Cancellation is so severe that no bits in the result are correct, last result was -1.3871133003351527e+47
         {{ static_cast<T>(-1.6548533913638905e-10), static_cast<T>(-0.50000000016548529), static_cast<T>(-169.20843148231506), SC_(1.00000000084161045914716192484600809610013447) }},
         ...
         { { static_cast<T>(-2.0211181797563725e-14), static_cast<T>(-1.0000000000000202), static_cast<T>(-25.653068032115698), SC_(-0.000253525216374277055047768086884693917115210113) }},
         // Unexpected high error: 1.79769e+308 Found: -inf Expected: -2.63233e-197
         {{ static_cast<T>(235.44106131792068), static_cast<T>(-2.250966744069919e-13), static_cast<T>(-974.28781914710999), SC_(-2.63233018990922939037251029961929844581862228e-197) }},
         ...
         { { static_cast<T>(-235.44106131792068), static_cast<T>(-2.250966744069919e-13), static_cast<T>(974.28781914710999), SC_(-3.53316570137147343919975579872097464691424847e+226) }},
         // Unexpected high error : 2.48268e+91 Found : -9.61305e+268 Expected : -1.74382e+193
         { { static_cast<T>(5.9981750131794866e-15), static_cast<T>(-230.70702263712883), static_cast<T>(240.42092034220695), SC_(-1.74381782591884817018404492963109914357365958e+193) }},
         // Unexpected high error : 1.79769313486231570814527423731704356798070568e+308 Found : -9.61305077326281580724540507004198316499661687e+268 Expected : 1.74381782591870724567837900957146707932623893e+193
         { { static_cast<T>(-5.9981750131794866e-15), static_cast<T>(-230.70702263712883), static_cast<T>(240.42092034220695), SC_(1.74381782591870734495565763481520223752372107e+193) }},
         // Unexpected exception : Error in function boost::math::hypergeometric_pFq<long T> : Cancellation is so severe that no bits in the result are correct, last result was 3.0871891698197084e+73
         { { static_cast<T>(-5.9981750131794866e-15), static_cast<T>(0.499999999999994), static_cast<T>(-240.42092034220695), SC_(1.00000000000004464930530925572237133417488137) }},
         // Unexpected exception : Error in function boost::math::hypergeometric_pFq<long T> : Cancellation is so severe that no bits in the result are correct, last result was 3.0871891698197084e+73
         { { static_cast<T>(-5.9981750131794866e-15), static_cast<T>(-0.500000000000006), static_cast<T>(-240.42092034220695), SC_(1.00000000000003262784934420226963147689063665) }},
         ...
         { { static_cast<T>(6.772927684190258e-10), static_cast<T>(-0.99999999932270722), static_cast<T>(-483.69576895236969), SC_(1.32865406166941679958876322759721528297325713e-08) }},
         // Unexpected high error: 1.79769e+308 Found: -nan(ind) Expected: 5.31173e-38
         {{ static_cast<T>(6763.4877452850342), static_cast<T>(3.6834977949762315e-08), static_cast<T>(-210.20976513624191), SC_(5.31173132667573457976877380237496445775181141e-38) }},
         ...
         { { static_cast<T>(-6763.4877452850342), static_cast<T>(3.6834977949762315e-08), static_cast<T>(210.20976513624191), SC_(1.04274264437409861991447530452939035771734596e+54) }},
         ...
         {{ static_cast<T>(76763.042617797852), static_cast<T>(-21.722407214343548), static_cast<T>(-0.60326536209322512), SC_(14198882672502153010712531896984.8126667697959) }},
         ...
         {{ static_cast<T>(-1.8857404964801872e-09), static_cast<T>(-226.52341184020042), static_cast<T>(160.86221924424171), SC_(2.39521645877950946848639784331327651190093595e+124) }},
         ...
         { { static_cast<T>(-7.5220323642510769e-13), static_cast<T>(-1.0000000000007523), static_cast<T>(-17.948102783411741), SC_(0.00011181062589552829441403260197223627311023229) }},
         ...
         {{ static_cast<T>(5.6136137469239618e-15), static_cast<T>(-0.99999999999999434), static_cast<T>(-1989.8742001056671), SC_(0.00856985180985659334965068576732515544478559175) }},
         ...
         { { static_cast<T>(-5.6136137469239618e-15), static_cast<T>(-0.50000000000000566), static_cast<T>(-1989.8742001056671), SC_(1.00000000000004243096226509338784935080089269) }},
         ...
         {{ static_cast<T>(-6.8543290253728628), static_cast<T>(607.72073245607316), static_cast<T>(253.26409819535911), SC_(0.024418741483258497441042709681531519387974841769189) }},
        ...
        //
         { {-1, -1, SC_(0.9999999999990905052982270717620850), SC_(1.9999999999990905052982270717620850)} }, 
         { { -2, -2, SC_(0.9999999999990905052982270717620850), SC_(2.4999999999981810105964545571144762) } }, 
         { { -3, -3, SC_(0.9999999999990905052982270717620850), SC_(2.6666666666643929299122351732524916) } }, 
      { { -4, -4, SC_(0.9999999999990905052982270717620850), SC_(2.7083333333309080141286065586746589) } }, 
      { { -5, -5, SC_(0.9999999999990905052982270717620850), SC_(2.7166666666642034518493660889297968) } }, 
      { { -6, -6, SC_(0.9999999999990905052982270717620850), SC_(2.7180555555530847616157402206496325) } }, 
      { { -7, -7, SC_(0.9999999999990905052982270717620850), SC_(2.7182539682514961968413528410609673) } }, 
      { { -8, -8, SC_(0.9999999999990905052982270717620850), SC_(2.7182787698387976036876421724036051) } }, 
      { { -9, -9, SC_(0.9999999999990905052982270717620850), SC_(2.7182815255707199797197951818652022) } }, 
      { { -10, -10, SC_(0.9999999999990905052982270717620850), SC_(2.7182818011439122170723781245206092) } }, 
      { { -11, -11, SC_(0.9999999999990905052982270717620850), SC_(2.7182818261960206022634645412810530) } }, 
      { { -12, -12, SC_(0.9999999999990905052982270717620850), SC_(2.7182818282836963010274896793573756) } }, 
      { { -13, -13, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284442867393938070953642430) } }, 
      { { -14, -14, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284557574849913907639252443) } }, 
      { { -15, -15, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565222013645623129904880) } }, 
      { { -16, -16, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565699961378854913379726) } }, 
      { { -17, -17, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565728075951397933896427)} }, 
      { { -18, -18, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729637872094766949018) } }, 
      { { -19, -19, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729720078447231771757) } }, 
      { { -20, -20, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724188764855009155) } }, 
      { { -21, -21, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724384494265639330) } }, 
      { { -22, -22, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393391057031602) } }, 
      { { -23, -23, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393777874048657) } }, 
      { { -24, -24, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393793991424368) } }, 
      { { -25, -25, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794636119396) } }, 
      { { -26, -26, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794660915359) } }, 
      { { -27, -27, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794661833728) } }, 
      { { -28, -28, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794661866527) } }, 
      { { -29, -29, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794661867658) } }, 
      { { -30, -30, SC_(0.9999999999990905052982270717620850), SC_(2.7182818284565729724393794661867696) } },
   ...
   static const std::array<std::array<T, 4>, 2> hypergeometric_1F1_big_bugs = { {
         ...
         {{ static_cast<T>(7.8238229420435346e-05), static_cast<T>(-5485.3222503662109), static_cast<T>(1896.0561106204987), BOOST_MATH_HUGE_CONSTANT(T, 1000, 4.33129800901478785957996719992774682013355926e+668) }},
         {{ static_cast<T>(-7.8238229420435346e-05), static_cast<T>(-5485.3222503662109), static_cast<T>(1896.0561106204987), BOOST_MATH_HUGE_CONSTANT(T, 1000, -4.3248750673398590673783317624407455467680038e+668) }},
#else
   { { static_cast<T>(7.8238229420435346e-05), static_cast<T>(-5485.3222503662109), static_cast<T>(1896.0561106204987), SC_(4.33129800901478785957996719992774682013355926e+668) } },
   { { static_cast<T>(-7.8238229420435346e-05), static_cast<T>(-5485.3222503662109), static_cast<T>(1896.0561106204987), SC_(-4.3248750673398590673783317624407455467680038e+668) } },
#endif
   } };
...
template <class T>
void test_spots8(T, const char* type_name)
{
   BOOST_CHECK_THROW(boost::math::hypergeometric_1F1(static_cast<T>(2), static_cast<T>(-100), static_cast<T>(0.5)), std::domain_error);
   BOOST_CHECK_THROW(boost::math::hypergeometric_1F1(static_cast<T>(-100.1), static_cast<T>(-100), static_cast<T>(0.5)), std::domain_error);
   BOOST_CHECK_THROW(boost::math::hypergeometric_1F1(static_cast<T>(-102), static_cast<T>(-100), static_cast<T>(0.5)), std::domain_error);
   BOOST_CHECK_THROW(boost::math::hypergeometric_1F1(static_cast<T>(-50.25), static_cast<T>(-100), static_cast<T>(0.5)), std::domain_error);
}
