...
main:                                   # @main
.Lfunc_begin0:
	.file	1 "dwarf4-duplicate-types-test" "main.cpp"
...
# %bb.0:
	...
	movq	%rsi, -16(%rbp)
.Ltmp0:
	.loc	1 8 2 prologue_end              # main.cpp:8:2
	xorl	%eax, %eax
	.loc	1 8 2 epilogue_begin is_stmt 0  # main.cpp:8:2
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Ltmp1:
...
.Ldebug_info_start1:
	...
	.long	.debug_abbrev                   # Offset Into Abbrev. Section
	.byte	8                               # Address Size (in bytes)
	.byte	6                               # Abbrev [6] 0xb:0x85 DW_TAG_compile_unit
	...
	.byte	7                               # Abbrev [7] 0x2a:0x44 DW_TAG_subprogram
	.quad	.Lfunc_begin0                   # DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0       # DW_AT_high_pc
	...
	.long	122                             # DW_AT_type
	.byte	4                               # Abbrev [4] 0x7a:0x5 DW_TAG_pointer_type
	.long	127                             # DW_AT_type
	.byte	5                               # Abbrev [5] 0x7f:0x7 DW_TAG_base_type
	.long	.Linfo_string7                  # DW_AT_name
	.byte	6                               # DW_AT_encoding
	.byte	1                               # DW_AT_byte_size
	.byte	10                              # Abbrev [10] 0x86:0x9 DW_TAG_structure_type
                                        # DW_AT_declaration
...
.Linfo_string2:
	.asciz	"dwarf4-duplicate-types-test" # string offset=155
.Linfo_string3:
	.asciz	"main"                          # string offset=221
.Linfo_string4:
	.asciz	"int"                           # string offset=226
.Linfo_string5:
	.asciz	"argc"                          # string offset=230
.Linfo_string6:
	.asciz	"argv"                          # string offset=235
.Linfo_string7:
	.asciz	"char"                          # string offset=240
.Linfo_string8:
	.asciz	"f"                             # string offset=245
.Linfo_string9:
	.asciz	"c1"                            # string offset=247
.Linfo_string10:
	.asciz	"c2"                            # string offset=250
.Linfo_string11:
	.asciz	"c3"                            # string offset=253
.Linfo_string12:
	.asciz	"Foo"                           # string offset=256
