...
// print(format_hex(m));
LIBC_INLINE_VAR constexpr Float128 LOG_2(Sign::POS,
...
[[maybe_unused]] LIBC_INLINE static constexpr double log1p_accurate(
    int e_x, int index, fputil::DoubleDouble m_x) {
...
LIBC_INLINE static constexpr double log1p(double x) {
