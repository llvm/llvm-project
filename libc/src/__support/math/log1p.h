...
// print(format_hex(m));
LIBC_INLINE_VAR
LIBC_CONSTEXPR Float128 LOG_2(Sign::POS,
...
LIBC_INLINE_VAR LIBC_CONSTEXPR Float128 LOG_R1[129] = {
    {Sign::POS, 0, 0_u128},
...
//         format_hex(m), "},");
LIBC_INLINE_VAR LIBC_CONSTEXPR Float128 LOG_R2[198] = {
...
//   print("{Sign::POS," if (s == -1) else "{Sign::NEG,", e, ",
//         format_hex(m), "},");
LIBC_INLINE_VAR LIBC_CONSTEXPR Float128 LOG_R3[139] = {
