...
// 8-entry table for 2^(j/8) as DoubleDouble {lo, hi} (128 bytes total)
// Shared between exp(double) and pow(double, double) when small tables are
// used.
LIBC_INLINE_VAR constexpr fputil::DoubleDouble EXP2_MID_8[8] = {
    {0x0.0p+0, 0x1.0000000000000p+0},               // 2^(0/8)
    {-0x1.19041b9d78a76p-55, 0x1.172b83c7d517bp+0}, // 2^(1/8)
    {0x1.6f46ad23182e4p-55, 0x1.306fe0a31b715p+0},  // 2^(2/8)
    {0x1.d4397afec42e2p-56, 0x1.4bfdad5362a27p+0},  // 2^(3/8)
    {-0x1.bdd3413b26456p-54, 0x1.6a09e667f3bcdp+0}, // 2^(4/8)
    {0x1.6e9f156864b27p-54, 0x1.8ace5422aa0dbp+0},  // 2^(5/8)
    {0x1.7a1cd345dcc81p-54, 0x1.ae89f995ad3adp+0},  // 2^(6/8)
    {0x1.2ed02d75b3707p-55, 0x1.d5818dcfba487p+0},  // 2^(7/8)
};
