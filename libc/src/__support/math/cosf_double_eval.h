...
///
/// \file
/// Double-precision implementation of cosf.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC___SUPPORT_MATH_COSF_DOUBLE_EVAL_H
#define LLVM_LIBC_SRC___SUPPORT_MATH_COSF_DOUBLE_EVAL_H
...
#endif // LLVM_LIBC_SRC___SUPPORT_MATH_COSF_DOUBLE_EVAL_H
