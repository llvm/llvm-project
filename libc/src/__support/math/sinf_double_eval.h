...
///
/// \file
/// Double-precision implementation of sinf.
///
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIBC_SRC___SUPPORT_MATH_SINF_DOUBLE_EVAL_H
#define LLVM_LIBC_SRC___SUPPORT_MATH_SINF_DOUBLE_EVAL_H
...
#endif // LLVM_LIBC_SRC___SUPPORT_MATH_SINF_DOUBLE_EVAL_H
