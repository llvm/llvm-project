...
// print(format_hex(m));
LIBC_INLINE_VAR constexpr Float128 LOG10_2(Sign::POS,
...
// -2^-8 <= m_x < 2^-7
LIBC_INLINE static constexpr double log10_accurate(
...
LIBC_INLINE static constexpr double log10(double x) {
