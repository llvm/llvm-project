...
//  print(format_hex(m));
LIBC_INLINE_VAR
LIBC_CONSTEXPR Float128 LOG_2(Sign::POS, /*exponent=*/-128, /*mantissa=*/
                              0xb17217f7'd1cf79ab'c9e3b398'03f2f6af_u128);

alignas(16) LIBC_INLINE_VAR LIBC_CONSTEXPR LogRR LOG_TABLE = {
...
// 0x1.99a3...p-121
LIBC_INLINE_VAR LIBC_CONSTEXPR Float128 BIG_COEFFS[3]{
...
// -2^-8 <= m_x < 2^-7
#ifndef LIBC_MATH_HAS_SKIP_ACCURATE_PASS
LIBC_INLINE LIBC_CONSTEXPR double log_accurate(int e_x, int index, double m_x) {
