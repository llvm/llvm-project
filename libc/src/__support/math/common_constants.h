...
// 16-entry range reduction constants for double-precision log2/pow small
// tables.
LIBC_INLINE_VAR constexpr double RD_16[16] = {
    0x1.0000000000000p+0, // idx 0
    0x1.d400000000000p-1, // idx 1
    0x1.bc00000000000p-1, // idx 2
    0x1.a400000000000p-1, // idx 3
    0x1.9000000000000p-1, // idx 4
    0x1.7c00000000000p-1, // idx 5
    0x1.6c00000000000p-1, // idx 6
    0x1.5c00000000000p-1, // idx 7
    0x1.5000000000000p-1, // idx 8
    0x1.4000000000000p-1, // idx 9
    0x1.3400000000000p-1, // idx 10
    0x1.2800000000000p-1, // idx 11
    0x1.2000000000000p-1, // idx 12
    0x1.1400000000000p-1, // idx 13
    0x1.0c00000000000p-1, // idx 14
    0x1.0000000000000p-1, // idx 15
};

LIBC_INLINE_VAR constexpr fputil::DoubleDouble LOG_R1_16[16] = {
    {0.0, 0.0},
    {-0x1.72566212cdd05p-61, 0x1.700d30aeac0e1p-4}, // -ln(0.9140625)
    {-0x1.6e38161051d69p-57, 0x1.23d712a49c202p-3}, // -ln(0.8671875)
    {0x1.142c507fb7a3dp-58, 0x1.95a5adcf7017fp-3},  // -ln(0.8203125)
    {0x1.f665066f980a2p-57, 0x1.f991c6cb3b379p-3},  // -ln(0.78125)
    {-0x1.3d69909e5c3dcp-56, 0x1.314f1e1d35ce4p-2}, // -ln(0.7421875)
    {-0x1.6541148cbb8a2p-56, 0x1.5d5bddf595f30p-2}, // -ln(0.7109375)
    {-0x1.70f2f38238303p-56, 0x1.8b639a88b2df5p-2}, // -ln(0.6796875)
    {0x1.9d56c45dd3e86p-56, 0x1.af5295248cdd0p-2},  // -ln(0.65625)
    {-0x1.ac81cc8a4dfb8p-56, 0x1.e148a1a2726cep-2}, // -ln(0.625)
    {-0x1.17f9e54e78104p-57, 0x1.04360be7603adp-1}, // -ln(0.6015625)
    {0x1.89df1568ca0b0p-55, 0x1.188ee40f23ca6p-1},  // -ln(0.578125)
    {0x1.e0efadd9db02bp-55, 0x1.269621134db92p-1},  // -ln(0.5625)
    {0x1.1930603d87b6ep-56, 0x1.3c6080c36bfb5p-1},  // -ln(0.5390625)
    {0x1.c457b531506f6p-55, 0x1.4b6fd6f970c1fp-1},  // -ln(0.5234375)
    {0.0, 0.0},
};
