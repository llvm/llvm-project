...
LIBC_INLINE_VAR constexpr DoubleDouble ATAN_I[17] = {
    {0.0, 0.0},
...
[[maybe_unused]] LIBC_INLINE DoubleDouble atan_eval(const DoubleDouble &x) {
  ...
  double c2 = fputil::multiply_add(x_hi_sq, 0x1.3b13b13b13b14p-4,
                                   -0x1.745d1745d1746p-4);
  double x_hi_3 = x_hi_sq * x.hi;
  double x_hi_4 = x_hi_sq * x_hi_sq;
  double d0 =
      fputil::multiply_add(x_hi_4, fputil::multiply_add(x_hi_4, c2, c1), c0);
