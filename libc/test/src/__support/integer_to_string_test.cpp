...
TEST(LlvmLibcIntegerToStringTest, UINT128_Base_16) {
  ...
  EXPECT(type, 0x12340000000000000000000000000000_u128,
         "12340000000000000000000000000000");
  EXPECT(type, 0x00000000000000001234000000000000_u128,
         "00000000000000001234000000000000");
  EXPECT(type, 0x00000000000000012340000000000000_u128,
