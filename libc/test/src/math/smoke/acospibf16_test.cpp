...
class LlvmLibcAcospiBf16Test : public LIBC_NAMESPACE::testing::FEnvSafeTest {
  DECLARE_SPECIAL_CONSTANTS(bfloat16)
public:
  void test_special_numbers() {
    EXPECT_FP_EQ_ALL_ROUNDING(aNaN, LIBC_NAMESPACE::acospibf16(aNaN));
    EXPECT_MATH_ERRNO(0);
    ...
    EXPECT_FP_EQ_ALL_ROUNDING(bfloat16(0.5),
                              LIBC_NAMESPACE::acospibf16(neg_zero));
    EXPECT_MATH_ERRNO(0);
...
TEST_F(LlvmLibcAcospiBf16Test, SpecialNumbers) { test_special_numbers(); }
