...
TEST_F(LlvmLibcLlistxattrTest, NoExtendedAttributes) {
  constexpr const char *TEST_FILE_NAME = "testdata/llistxattr_no_xattrs.txt";
...
TEST_F(LlvmLibcLlistxattrTest, WithUserExtendedAttribute) {
  constexpr const char *TEST_FILE_NAME =
      "testdata/llistxattr_with_user_xattr.txt";
  constexpr const char *TEST_SYMLINK_TARGET = "llistxattr_with_user_xattr.txt";
  constexpr const char *TEST_SYMLINK_NAME = "testdata/llistxattr_symlink.txt";
