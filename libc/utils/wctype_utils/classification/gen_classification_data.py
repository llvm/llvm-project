...
def read_unicode_data(filename: str) -> list[UnicodeEntry]:
    """Reads Unicode data from file and return list of entries."""
...
def get_props(entry: UnicodeEntry) -> int:
    ...
    # Number
        ...
        # In C.UTF8, non ASCII digits and letter numbers are considered alpha
...
def build_lookup_tables(properties: defaultdict[int, int]) -> StagedLookupTable:
    """Builds two-level lookup tables with block sharing."""
