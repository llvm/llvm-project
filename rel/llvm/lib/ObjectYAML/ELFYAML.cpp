...
#if LLPC_BUILD_GFX12
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX115F, EF_AMDGPU_MACH);
#endif /* LLPC_BUILD_GFX12 */
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1200, EF_AMDGPU_MACH);
#if LLPC_BUILD_GFX12
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX120F, EF_AMDGPU_MACH);
#endif /* LLPC_BUILD_GFX12 */
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX1201, EF_AMDGPU_MACH);
#if LLPC_BUILD_GFX12
    BCaseMask(EF_AMDGPU_MACH_AMDGCN_GFX120E, EF_AMDGPU_MACH);
#endif /* LLPC_BUILD_GFX12 */
