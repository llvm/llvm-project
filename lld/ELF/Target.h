...
public:
  ...
  // postScanRelocations processes symbol flags. Targets may override
  // this to perform single-threaded fixups that cannot run during
  // parallel scanning (e.g. symbol table modifications).
