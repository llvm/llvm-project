...
## Verify the .riscv.jvt section size only accounts for all the first 32 entries.
## TODO: test >224 cm.jalt candidates to verify truncation of the cm.jalt table.

# RUN: llvm-mc -filetype=obj -triple=riscv32 -mattr=+relax,+zcmt -asm-macro-max-nesting-depth=35 %s -o %t.rv32.o
# RUN: llvm-mc -filetype=obj -triple=riscv64 -mattr=+relax,+zcmt -asm-macro-max-nesting-depth=35 %s -o %t.rv64.o
...
# RUN:   --defsym t32=0x100200 --defsym t33=0x100210 \
# RUN:   -o %t.rv32
...
## Only the first 32 entries appears in the final table: 32 * 4 = 0x80; 32 * 8 = 0x100.
## t32 and t33 are dropped by their later order.
