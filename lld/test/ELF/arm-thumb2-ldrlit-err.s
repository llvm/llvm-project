...
low:
 ...
 .thumb_func
_start:
// CHECK: error: {{.*}}.o:(.text.1+0x0): relocation R_ARM_THM_PC12 out of range: 4098 is not in [0, 4095]
/// ldr.w r0, low - 4091
 .inst.w 0xf85f0fff
 .reloc 0, R_ARM_THM_PC12, low
// CHECK: error: {{.*}}.o:(.text.1+0x4): relocation R_ARM_THM_PC12 out of range: 4096 is not in [0, 4095]
/// ldr.w r0, high + 4091
 .inst.w 0xf8df0ff7
