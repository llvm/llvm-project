...
# RUN: %lld -arch arm64 -lSystem -e _main -o %t/compr.out %t/a.o --bp-compression-sort-section=__TEXT__text
...
# STARTUP-ONLY-VERBOSE: Sections for compression: 0
# STARTUP-ONLY-VERBOSE: Compression groups: 0

## Startup sort + compression sort: startup functions first, then non-cold
## functions, then cold functions.
# RUN: %lld -arch arm64 -lSystem -e _main -o %t/startup-compr.out %t/a.o --irpgo-profile=%t/a.profdata --bp-startup-sort=function --bp-compression-sort-section=__TEXT__text --verbose-bp-section-orderer 2> %t/startup-compr-verbose.txt
...
# STARTUP-COMPR-VERBOSE: Sections for compression: 5
# STARTUP-COMPR-VERBOSE: Compression groups: 2
# STARTUP-COMPR-VERBOSE: __TEXT__text: 3 sections
# STARTUP-COMPR-VERBOSE: __TEXT__text::cold: 2 sections
...
# RUN: %lld -arch arm64 -lSystem -e _main -o %t/order.out %t/a.o --bp-compression-sort-section=__TEXT__text -order_file %t/a.orderfile
