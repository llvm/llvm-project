...
void numThreadsStrictError() { __builtin_trap(); }
...
__kmpc_parallel_spmd_impl(IdentTy *ident, int32_t num_threads, void *fn,
...
[[clang::always_inline]] void
__kmpc_parallel_spmd_60(IdentTy *ident, int32_t num_threads, void *fn,
                        void **args, const int64_t nargs,
                        int32_t nt_strict = false) {
  return __kmpc_parallel_spmd_impl(ident, num_threads, fn, args, nargs,
                                   nt_strict);
...
[[clang::always_inline]] void
__kmpc_parallel_impl(IdentTy *ident, int32_t, int32_t if_expr,
...
__kmpc_parallel_60(IdentTy *ident, int32_t id, int32_t if_expr,
                   ...
                   int32_t nt_strict = false) {
  return __kmpc_parallel_impl(ident, id, if_expr, num_threads, proc_bind, fn,
                              wrapper_fn, args, nargs, nt_strict);
}
