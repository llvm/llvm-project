...
#define FTN_GET_DYN_GPRIVATE_PTR omp_get_dyn_gprivate_ptr
#define FTN_GET_DYN_GPRIVATE_NOFB_PTR omp_get_dyn_gprivate_nofb_ptr
#define FTN_GET_DYN_GPRIVATE_SIZE omp_get_dyn_gprivate_size
#define FTN_GET_DYN_GPRIVATE_MEMSPACE omp_get_dyn_gprivate_memspace
#define FTN_GET_GPRIVATE_LIMIT omp_get_gprivate_limit
...
#define FTN_GET_DYN_GPRIVATE_PTR omp_get_dyn_gprivate_ptr_
#define FTN_GET_DYN_GPRIVATE_NOFB_PTR omp_get_dyn_gprivate_nofb_ptr_
#define FTN_GET_DYN_GPRIVATE_SIZE omp_get_dyn_gprivate_size_
#define FTN_GET_DYN_GPRIVATE_MEMSPACE omp_get_dyn_gprivate_memspace_
#define FTN_GET_GPRIVATE_LIMIT omp_get_gprivate_limit_
