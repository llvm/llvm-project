...
struct Next32KernelTy : public GenericKernelTy {
  ...
  Error launchImpl(GenericDeviceTy &GenericDevice, uint32_t NumThreads,
    ...
    bool Status =
        llns_execute_function(FuncHandle, reinterpret_cast<void **>(Args),
...
struct Next32DeviceTy : public GenericDeviceTy {
  ...
  Next32DeviceTy(int32_t DeviceId, int32_t NumDevices)
      : GenericDeviceTy(DeviceId, NumDevices, Next32GridValues) {}
  ...
  Expected<GenericKernelTy &> constructKernel(const char *Name) override {
    ...
    Next32KernelTy *Next32Kernel = Plugin::get().allocate<Next32KernelTy>();
    if (!Next32Kernel)
  ...
  Expected<DeviceImageTy *> loadBinaryImpl(const __tgt_device_image *TgtImage,
    ...
    Next32DeviceImageTy *Image = Plugin::get().allocate<Next32DeviceImageTy>();
...
GenericPluginTy *Plugin::createPlugin() { return new Next32PluginTy(); }

GenericDeviceTy *Plugin::createDevice(int32_t DeviceId, int32_t NumDevices) {
  return new Next32DeviceTy(DeviceId, NumDevices);
}
