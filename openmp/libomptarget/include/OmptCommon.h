//===-------- OmptCommon.h - Common definitions for OMPT --*- C++ -*-------===//
//
...
#ifndef OPENMP_LIBOMPTARGET_OMPTCOMMON_H
#define OPENMP_LIBOMPTARGET_OMPTCOMMON_H
...
#endif // OPENMP_LIBOMPTARGET_OMPTCOMMON_H
