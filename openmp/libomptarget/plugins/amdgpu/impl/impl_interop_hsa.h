//===--- amdgpu/impl/impl_interop_hsa.h --------------------------- C++ -*-===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef INCLUDE_IMPL_INTEROP_HSA_H_
#define INCLUDE_IMPL_INTEROP_HSA_H_
...
/** \defgroup interop_hsa_functions IMPL-HSA Interop
 *  @{
 */
 ...
 * of the @p impl_module_register functions.
 *
 * @param[in] place The IMPL memory place
 *
 ...
 * invalid
 * location in the current node, or if IMPL is not initialized.
 */
...
#endif // INCLUDE_IMPL_INTEROP_HSA_H_
