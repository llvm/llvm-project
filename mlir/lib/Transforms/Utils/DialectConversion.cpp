...
struct ConversionPatternRewriterImpl : public RewriterBase::Listener {
  ...
  /// A set of erased blocks. This set is utilized only if `allowPatternRollback`
  /// is set to "false".
...
OperationLegalizer::legalizeWithPattern(Operation *op,
  ...
  LogicalResult status =
      applicator.matchAndRewrite(op, rewriter, canApply, onFailure, onSuccess);
  return status;
}
...
static LogicalResult legalizeUnresolvedMaterialization(
    RewriterBase &rewriter, UnrealizedConversionCastOp op,
