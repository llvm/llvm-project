...
class PassManager:
    ...
    def emit_kokkos(self, module: _ir.Module, cxx_source_file: str, py_source_file: str) -> None: ...
    def emit_kokkos_sparse(self, module: _ir.Module, cxx_source_file: str, py_source_file: str, useHierarchical: bool, isLastKernel: bool) -> None: ...
    @property
