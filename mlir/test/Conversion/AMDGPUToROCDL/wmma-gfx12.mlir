...
func.func @wmma_to_rocdl(%arg0 : vector<8xf16>, %arg1 : vector<4xf16>,
  ...
  // CHECK: rocdl.wmma.i32.16x16x16.iu8{{.*}} <signA = true, signB = true, clamp = true> : (vector<2xi32>, vector<2xi32>, vector<8xi32>) -> vector<8xi32>
  ...
  // CHECK: rocdl.wmma.i32.16x16x32.iu4{{.*}} <signA = true, signB = true, clamp = true> : (vector<2xi32>, vector<2xi32>, vector<8xi32>) -> vector<8xi32>
  amdgpu.wmma 16x16x32 %arg14 * %arg14 + %arg12 clamp : vector<16xi4>, vector<16xi4>, vector<8xi32>
  // CHECK: rocdl.wmma.i32.16x16x32.iu4{{.*}} <signA = true, signB = true, clamp = true> : (i32, i32, vector<4xi32>) -> vector<4xi32>
  amdgpu.wmma 16x16x32 %arg15 * %arg15 + %arg13 clamp : vector<8xi4>, vector<8xi4>, vector<4xi32>

  // CHECK: rocdl.wmma.i32.16x16x16.iu4{{.*}} <signA = true, signB = true, clamp = true> : (i32, i32, vector<8xi32>) -> vector<8xi32>
  amdgpu.wmma 16x16x16 %arg15 * %arg15 + %arg12 clamp : vector<8xi4>, vector<8xi4>, vector<8xi32>
  // CHECK: rocdl.wmma.i32.16x16x16.iu4{{.*}} <signA = true, signB = true, clamp = true> : (i32, i32, vector<4xi32>) -> vector<4xi32>
