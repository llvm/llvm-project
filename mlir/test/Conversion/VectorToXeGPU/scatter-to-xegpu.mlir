...
gpu.func @store_dynamic_layout_operands(%vec: vector<8x16xf32>, %source: memref<?x?xf32>,
    ...
    %indices: vector<8x16xindex>, %mask: vector<8x16xi1>) {
  vector.scatter %source[%off0, %off1][%indices], %mask, %vec {
        layout_operand_3 = #xegpu.layout<sg_layout = [0]>,
        layout_operand_4 = #xegpu.layout<sg_layout = [1]>,
        layout_operand_5 = #xegpu.layout<sg_layout = [2]>
  } : memref<?x?xf32>, vector<8x16xindex>, vector<8x16xi1>, vector<8x16xf32>
  gpu.return
}
...
gpu.module @xevm_module {
gpu.func @store_dynamic_layout_mixed(%source: memref<?x?x?xf32>,
    %off0: index, %off1: index, %off2: index,
    %mask: vector<8x16xi1>) {
  %vec = arith.constant {layout_operand_0 = #xegpu.layout<sg_layout = [0]>} dense<1.000000e+00> : vector<8x16xf32>
  ...
  vector.scatter %source[%off0, %off1, %off2][%2], %mask, %vec {
        layout_operand_5 = #xegpu.layout<sg_layout = [6]>
  } : memref<?x?x?xf32>, vector<8x16xindex>, vector<8x16xi1>, vector<8x16xf32>
  gpu.return
}
...
gpu.module @xevm_module {
gpu.func @store_static_layout_mixed(%source: memref<8x16x32xf32>,
    %off0: index, %off1: index, %off2: index,
    %mask: vector<8x16xi1>) {
  %vec = arith.constant {layout_operand_0 = #xegpu.layout<sg_layout = [0]>} dense<1.000000e+00> : vector<8x16xf32>
  %cst_1 = arith.constant {layout_result_0 = #xegpu.layout<sg_layout = [1]>} dense<[[0], [32], [64], [96], [128], [160], [192], [224]]> : vector<8x1xindex>
...
gpu.module @xevm_module {
gpu.func @store_dynamic_layout_mixed_override(%source: memref<?x?x?xf32>,
    %off0: index, %off1: index, %off2: index,
    %mask: vector<8x16xi1>) {
  %vec = arith.constant {layout_operand_0 = #xegpu.layout<sg_layout = [0]>} dense<1.000000e+00> : vector<8x16xf32>
  %cst_1 = arith.constant {layout_result_0 = #xegpu.layout<sg_layout = [1]>} dense<[[0], [32], [64], [96], [128], [160], [192], [224]]> : vector<8x1xindex>
  ...
  vector.scatter %source[%off0, %off1, %off2][%2], %mask, %vec {
        layout_operand_4 = #xegpu.layout<sg_layout = [99]>,
        layout_operand_5 = #xegpu.layout<sg_layout = [6]>
  } : memref<?x?x?xf32>, vector<8x16xindex>, vector<8x16xi1>, vector<8x16xf32>
  gpu.return
}
