...
func.func @main() {
  ...
  %static_buffer = bufferization.to_memref %result_static : !tensor_type -> !memref_type
  ...
  %dynamic_buffer = bufferization.to_memref %result_dynamic : tensor<?x?x?x?xf32> -> memref<?x?x?x?xf32>
