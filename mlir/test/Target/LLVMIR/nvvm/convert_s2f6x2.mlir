...
llvm.func @convert_f32x2_to_s2f6x2_scale(%srcA : f32, %srcB : f32, %scale : i16) -> i16 {
  ...
  // CHECK-NEXT: }
  %res1 = nvvm.convert.f32x2.to.s2f6x2 %srcA, %srcB scale_factor = %scale : i16
  %res2 = nvvm.convert.f32x2.to.s2f6x2 %srcA, %srcB scale_factor = %scale relu = true : i16
...
llvm.func @convert_f32x2_to_s2f6x2_vector_scale(%srcA : f32, %srcB : f32, %scale : i16) -> vector<2xi8> {
  ...
  // CHECK-NEXT: }
  %res1 = nvvm.convert.f32x2.to.s2f6x2 %srcA, %srcB scale_factor = %scale : vector<2xi8>
  llvm.return %res1 : vector<2xi8>
}
...
llvm.func @convert_bf16x2_to_s2f6x2_scale(%srcA : vector<2xbf16>, %scale : i16) -> i16 {
  ...
  // CHECK-NEXT: ret i16 %5
  // CHECK-NEXT: }
  %res1 = nvvm.convert.bf16x2.to.s2f6x2 %srcA scale_factor = %scale : vector<2xbf16> -> i16
  %res2 = nvvm.convert.bf16x2.to.s2f6x2 %srcA scale_factor = %scale relu = true : vector<2xbf16> -> i16
...
llvm.func @convert_bf16x2_to_s2f6x2_vector_scale(%srcA : vector<2xbf16>, %scale : i16) -> vector<2xi8> {
  ...
  // CHECK-NEXT: ret <2 x i8> %4
  // CHECK-NEXT: }
  %res1 = nvvm.convert.bf16x2.to.s2f6x2 %srcA scale_factor = %scale : vector<2xbf16> -> vector<2xi8>
  llvm.return %res1 : vector<2xi8>
}
...
llvm.func @convert_s2f6x2_to_bf16x2_scale(%src : vector<2xi8>, %scale : i16) -> vector<2xbf16> {
  ...
  // CHECK-NEXT: }
  %res = nvvm.convert.s2f6x2.to.bf16x2 %src scale_factor = %scale : vector<2xi8> -> vector<2xbf16>
  llvm.return %res : vector<2xbf16>
}
...
llvm.func @convert_s2f6x2_to_bf16x2_scale_relu(%src : vector<2xi8>, %scale : i16) -> vector<2xbf16> {
  ...
  // CHECK-NEXT: ret <2 x bfloat> %4
  // CHECK-NEXT: }
  %res = nvvm.convert.s2f6x2.to.bf16x2 %src scale_factor = %scale relu = true : vector<2xi8> -> vector<2xbf16>
  llvm.return %res : vector<2xbf16>
}
...
llvm.func @convert_s2f6x2_to_bf16x2_scale_satfinite(%src : vector<2xi8>, %scale : i16) -> vector<2xbf16> {
  ...
  // CHECK-NEXT: ret <2 x bfloat> %4
  // CHECK-NEXT: }
  %res = nvvm.convert.s2f6x2.to.bf16x2 %src scale_factor = %scale sat = <satfinite> : vector<2xi8> -> vector<2xbf16>
  llvm.return %res : vector<2xbf16>
}
...
llvm.func @convert_s2f6x2_to_bf16x2_scale_relu_satfinite(%src : vector<2xi8>, %scale : i16) -> vector<2xbf16> {
  ...
  // CHECK-NEXT: ret <2 x bfloat> %4
  // CHECK-NEXT: }
  %res = nvvm.convert.s2f6x2.to.bf16x2 %src scale_factor = %scale sat = <satfinite> relu = true : vector<2xi8> -> vector<2xbf16>
  llvm.return %res : vector<2xbf16>
}
