...
gpu.module @valid_f16x2_rs_sm_100a [#nvvm.target<chip = "sm_100a">] {
  func.func @convert_rs() {
    ...
    %res = nvvm.convert.f32x2.to.f16x2 %f1, %f2 random_bits = %rbits rnd = <rs> : vector<2xf16>
    return
  }
}
...
gpu.module @valid_bf16x2_rs_sm_103a [#nvvm.target<chip = "sm_103a">] {
  func.func @convert_rs() {
    ...
    %res = nvvm.convert.f32x2.to.bf16x2 %f1, %f2 random_bits = %rbits rnd = <rs> : vector<2xbf16>
    return
  }
}
