...
llvm.func @llvm_nvvm_tcgen05_commit_generic(%barrier : !llvm.ptr,
  ...
  nvvm.tcgen05.commit %barrier  group = <cta_2> : !llvm.ptr
  ...
  nvvm.tcgen05.commit %barrier, multicast_mask = %cta_mask  group = <cta_2> : !llvm.ptr, i16
  ...
  nvvm.tcgen05.commit %barrier, multicast_mask = %cta_mask_32  group = <cta_2> : !llvm.ptr, i32
  llvm.return
}
...
llvm.func @llvm_nvvm_tcgen05_commit_shared(%barrier : !llvm.ptr<3>,
  ...
  nvvm.tcgen05.commit %barrier  group = <cta_2> : !llvm.ptr<3>
  ...
  nvvm.tcgen05.commit %barrier, multicast_mask = %cta_mask  group = <cta_2> : !llvm.ptr<3>, i16
  ...
  nvvm.tcgen05.commit %barrier, multicast_mask = %cta_mask_32  group = <cta_2> : !llvm.ptr<3>, i32
  llvm.return
}
