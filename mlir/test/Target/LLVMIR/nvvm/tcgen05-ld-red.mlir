...
llvm.func @nvvm_tcgen05_ld_32x32b_min(%addr : !llvm.ptr<6>) {
  ...
  %data, %redval = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<2 x i32>, i32

  %data1, %redval1 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<4 x i32>, i32

  %data2, %redval2 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<8 x i32>, i32

  %data3, %redval3 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<16 x i32>, i32

  %data4, %redval4 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<32 x i32>, i32

  %data5, %redval5 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<64 x i32>, i32

  %data6, %redval6 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<128 x i32>, i32

  %data7, %redval7 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_32x32b_max(%addr : !llvm.ptr<6>) {
  ...
  %data, %redval = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<2 x i32>, i32

  %data1, %redval1 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<4 x i32>, i32

  %data2, %redval2 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<8 x i32>, i32

  %data3, %redval3 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<16 x i32>, i32

  %data4, %redval4 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<32 x i32>, i32

  %data5, %redval5 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<64 x i32>, i32

  %data6, %redval6 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<128 x i32>, i32

  %data7, %redval7 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_32x32b_min_abs_nan(%addr : !llvm.ptr<6>) {
  ...
  %data7, %redval7 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red min %addr  shape = shape_32x32b abs nan : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_32x32b_max_abs_nan(%addr : !llvm.ptr<6>) {
  ...
  %data7, %redval7 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red max %addr  shape = shape_32x32b abs nan : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_16x32bx2_min(%addr : !llvm.ptr<6>) {
  ...
  %data, %redval = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<2 x i32>, i32

  %data1, %redval1 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<4 x i32>, i32

  %data2, %redval2 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<8 x i32>, i32

  %data3, %redval3 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<16 x i32>, i32

  %data4, %redval4 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<32 x i32>, i32

  %data5, %redval5 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<64 x i32>, i32

  %data6, %redval6 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<128 x i32>, i32

  %data7, %redval7 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_16x32bx2_max(%addr : !llvm.ptr<6>) {
  ...
  %data, %redval = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<2 x i32>, i32

  %data1, %redval1 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<4 x i32>, i32

  %data2, %redval2 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<8 x i32>, i32

  %data3, %redval3 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<16 x i32>, i32

  %data4, %redval4 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<32 x i32>, i32

  %data5, %redval5 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<64 x i32>, i32

  %data6, %redval6 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<128 x i32>, i32

  %data7, %redval7 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_16x32bx2_min_nan_abs(%addr : !llvm.ptr<6>) {
  ...
  %data7, %redval7 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red min %addr, %offset  shape = shape_16x32bx2 abs nan : vector<128 x f32>, f32
  llvm.return
}
...
llvm.func @nvvm_tcgen05_ld_16x32bx2_max_nan_abs(%addr : !llvm.ptr<6>) {
  ...
  %data7, %redval7 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<2 x f32>, f32

  %data8, %redval8 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<4 x f32>, f32

  %data9, %redval9 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<8 x f32>, f32

  %data10, %redval10 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<16 x f32>, f32

  %data11, %redval11 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<32 x f32>, f32

  %data12, %redval12 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<64 x f32>, f32

  %data13, %redval13 = nvvm.tcgen05.ld.red max %addr, %offset  shape = shape_16x32bx2 abs nan : vector<128 x f32>, f32
  llvm.return
}
