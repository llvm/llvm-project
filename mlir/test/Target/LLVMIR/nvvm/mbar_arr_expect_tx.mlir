...
llvm.func @mbarrier_arrive_expect_tx_generic(%barrier: !llvm.ptr, %txcount : i32) {
  ...
  %1 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta : !llvm.ptr, i32 -> i64
  %2 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster : !llvm.ptr, i32 -> i64

  %3 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  relaxed = true : !llvm.ptr, i32 -> i64
  %4 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta relaxed = true : !llvm.ptr, i32 -> i64
  %5 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster relaxed = true : !llvm.ptr, i32 -> i64
  llvm.return
}
...
llvm.func @mbarrier_arrive_expect_tx_shared(%barrier: !llvm.ptr<3>, %txcount : i32) {
  ...
  %1 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta : !llvm.ptr<3>, i32 -> i64
  %2 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster : !llvm.ptr<3>, i32 -> i64

  %3 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  relaxed = true : !llvm.ptr<3>, i32 -> i64
  %4 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta relaxed = true : !llvm.ptr<3>, i32 -> i64
  %5 = nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster relaxed = true : !llvm.ptr<3>, i32 -> i64
  llvm.return
}
...
llvm.func @mbarrier_arrive_expect_tx_shared_cluster(%barrier: !llvm.ptr<7>, %txcount : i32) {
  ...
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta : !llvm.ptr<7>, i32
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster : !llvm.ptr<7>, i32

  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  relaxed = true : !llvm.ptr<7>, i32
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cta relaxed = true : !llvm.ptr<7>, i32
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount  scope = cluster relaxed = true : !llvm.ptr<7>, i32
  llvm.return
}
