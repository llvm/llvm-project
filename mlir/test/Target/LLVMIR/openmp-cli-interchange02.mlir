...
// CHECK-NEXT:    %[[OMP_INTERCHANGE0_CMP:.*]] = icmp ult i32 %[[OMP_INTERCHANGE0_IV]], %[[VAL_1:.*]]
...
// CHECK-NEXT:    %[[OMP_INTERCHANGE1_CMP:.*]] = icmp ult i32 %[[OMP_INTERCHANGE1_IV]], %[[VAL_2:.*]]
...
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_BODY2:.*]]
// CHECK-EMPTY:
// CHECK-NEXT:  [[OMP_INTERCHANGE1_BODY2]]:
...
// CHECK-NEXT:    %[[VAL_3:.*]] = getelementptr inbounds float, ptr %[[VAL_0:.*]], i32 %[[OMP_INTERCHANGE0_IV]]
...
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_AFTER2:.*]]
// CHECK-EMPTY:
// CHECK-NEXT:  [[OMP_INTERCHANGE0_AFTER2]]:
