...
llvm.func @interchange_loop_composition(%baseptr: !llvm.ptr, %tc1: i32, %tc2: i32) -> () {
  %cli_outer = omp.new_cli
  %cli_inner = omp.new_cli
  %interchanged1 = omp.new_cli
  %interchanged2 = omp.new_cli
  ...
  omp.interchange (%interchanged1, %interchanged2) <- (%cli_outer, %cli_inner) {permutation = [2 : i32, 1 : i32]}
  omp.interchange (%interchanged3, %interchanged4) <- (%interchanged1, %interchanged2) {permutation = [2 : i32, 1 : i32]}
  llvm.return
}


// CHECK-LABEL: define void @interchange_loop_composition(
...
// CHECK-NEXT:    [[OMP_OMP_LOOP_CMP:%.*]] = icmp ult i32 [[OMP_INTERCHANGE0_IV20:%.*]], [[TMP1]]
...
// CHECK-NEXT:    [[OMP_OMP_LOOP_CMP9:%.*]] = icmp ult i32 [[OMP_INTERCHANGE1_IV30:%.*]], [[TMP2]]
// CHECK-NEXT:    br i1 [[OMP_OMP_LOOP_CMP9]], label %[[OMP_OMP_LOOP_BODY4:.*]], label %[[OMP_OMP_LOOP_EXIT6:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_PREHEADER]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_PREHEADER13:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_HEADER:.*]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE0_IV:%.*]] = phi i32 [ [[OMP_INTERCHANGE0_NEXT:%.*]], %[[OMP_INTERCHANGE0_INC:.*]] ]
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_COND:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_COND]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE0_CMP:%.*]] = icmp ult i32 [[OMP_INTERCHANGE1_IV30]], [[TMP2]]
...
// CHECK-NEXT:    [[OMP_INTERCHANGE1_CMP:%.*]] = icmp ult i32 [[OMP_INTERCHANGE0_IV20]], [[TMP1]]
// CHECK-NEXT:    br i1 [[OMP_INTERCHANGE1_CMP]], label %[[OMP_INTERCHANGE1_BODY:.*]], label %[[OMP_INTERCHANGE1_EXIT:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_PREHEADER13]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_HEADER14:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_HEADER14]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE0_IV20]] = phi i32 [ 0, %[[OMP_INTERCHANGE0_PREHEADER13]] ], [ [[OMP_INTERCHANGE0_NEXT22:%.*]], %[[OMP_INTERCHANGE0_INC17:.*]] ]
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_COND15:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_COND15]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE0_CMP21:%.*]] = icmp ult i32 [[OMP_INTERCHANGE0_IV20]], [[TMP1]]
// CHECK-NEXT:    br i1 [[OMP_INTERCHANGE0_CMP21]], label %[[OMP_INTERCHANGE0_BODY16:.*]], label %[[OMP_INTERCHANGE0_EXIT18:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_BODY16]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_PREHEADER23:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_PREHEADER23]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_HEADER24:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_HEADER24]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE1_IV30]] = phi i32 [ 0, %[[OMP_INTERCHANGE1_PREHEADER23]] ], [ [[OMP_INTERCHANGE1_NEXT32:%.*]], %[[OMP_INTERCHANGE1_INC27:.*]] ]
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_COND25:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_COND25]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE1_CMP31:%.*]] = icmp ult i32 [[OMP_INTERCHANGE1_IV30]], [[TMP2]]
// CHECK-NEXT:    br i1 [[OMP_INTERCHANGE1_CMP31]], label %[[OMP_INTERCHANGE1_BODY26:.*]], label %[[OMP_INTERCHANGE1_EXIT28:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_BODY26]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_BODY]]
// CHECK-EMPTY:
...
// CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds float, ptr [[TMP0]], i32 [[OMP_INTERCHANGE0_IV20]]
// CHECK-NEXT:    store float 4.200000e+01, ptr [[TMP4]], align 4
// CHECK-NEXT:    br label %[[OMP_REGION_CONT11:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_REGION_CONT11]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_INC27]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_INC27]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE1_NEXT32]] = add nuw i32 [[OMP_INTERCHANGE1_IV30]], 1
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_HEADER24]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_EXIT28]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE1_AFTER29:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE1_AFTER29]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_INC17]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_INC17]]:
// CHECK-NEXT:    [[OMP_INTERCHANGE0_NEXT22]] = add nuw i32 [[OMP_INTERCHANGE0_IV20]], 1
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_HEADER14]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_EXIT18]]:
// CHECK-NEXT:    br label %[[OMP_INTERCHANGE0_AFTER19:.*]]
// CHECK-EMPTY:
// CHECK:       [[OMP_INTERCHANGE0_AFTER19]]:
...
// CHECK-NEXT:    [[OMP_INTERCHANGE0_NEXT]] = add nuw i32 [[OMP_INTERCHANGE1_IV30]], 1
...
// CHECK-NEXT:    [[OMP_OMP_LOOP_NEXT]] = add nuw i32 [[OMP_INTERCHANGE0_IV20]], 1
