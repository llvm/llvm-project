...
llvm.func @rocdl.raw.ptr.buffer(%rsrc : !llvm.ptr<8>,
  ...
  rocdl.raw.ptr.buffer.store %vdata1, %rsrc, %offset, %soffset, 0, %scope : i32
  rocdl.raw.ptr.buffer.store %vdata2, %rsrc, %offset, %soffset, 0, %scope : vector<2xi32>
  rocdl.raw.ptr.buffer.store %vdata4, %rsrc, %offset, %soffset, 0, %scope : vector<4xi32>
...
llvm.func @rocdl.raw.ptr.buffer.atomic.f32(%rsrc : !llvm.ptr<8>,
  ...
  %fadd = rocdl.raw.ptr.buffer.atomic.fadd %vdata1, %rsrc, %offset, %soffset, 0, %scope : f32
  %fmax = rocdl.raw.ptr.buffer.atomic.fmax %vdata1, %rsrc, %offset, %soffset, 0, %scope : f32
...
llvm.func @rocdl.raw.ptr.buffer.atomic.cmpswap(%rsrc : !llvm.ptr<8>,
  ...
  %val = rocdl.raw.ptr.buffer.atomic.cmpswap %src, %cmp, %rsrc, %offset, %soffset, 0, %scope : i32
  llvm.return %val : i32
}
