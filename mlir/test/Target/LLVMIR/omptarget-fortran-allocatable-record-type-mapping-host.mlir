...
module attributes {omp.is_target_device = false, omp.target_triples = ["amdgcn-amd-amdhsa"]} {
  llvm.func @omp_map_derived_type_allocatable_member(%arg0: !llvm.ptr) {
    ...
    %6 = omp.map.info var_ptr(%4 : !llvm.ptr, i32) map_clauses(tofrom) capture(ByRef) var_ptr_ptr(%5 : !llvm.ptr)   bounds(%3) -> !llvm.ptr {name = ""}
  ...
  llvm.func @omp_allocatable_derived_type_member_map(%arg0: !llvm.ptr) {
    ...
    %14 = omp.map.info var_ptr(%12 : !llvm.ptr, i32) map_clauses(tofrom) capture(ByRef) var_ptr_ptr(%13 : !llvm.ptr)   bounds(%8) -> !llvm.ptr {name = ""}
  ...
  llvm.func @omp_alloca_nested_derived_type_map(%arg0: !llvm.ptr) {
    ...
    %17 = omp.map.info var_ptr(%15 : !llvm.ptr, i32) map_clauses(tofrom) capture(ByRef) var_ptr_ptr(%16 : !llvm.ptr)   bounds(%10) -> !llvm.ptr {name = ""}
...
// CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [10 x i64] [i64 32, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 1688849860263939, i64 1688849860263939, i64 1688849860263939, i64 1688849860263939]
// CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant [10 x i64] [i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 48, i64 0, i64 4]
// CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [10 x i64] [i64 32, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 281474976710659, i64 1688849860263939, i64 1688849860263939, i64 1688849860263939, i64 1688849860263939]
// CHECK: @.offload_sizes{{.*}} = private unnamed_addr constant [3 x i64] [i64 0, i64 48, i64 0]
// CHECK: @.offload_maptypes{{.*}} = private unnamed_addr constant [3 x i64] [i64 32, i64 281474976710659, i64 281474976710659]
...
// CHECK:  store i64 %[[DTYPE_SIZE2_SEGMENT_CALC_3]], ptr %[[OFFLOAD_SIZES]], align 8
...
// CHECK:  store i64 %[[DTYPE_SIZE3_SEGMENT_CALC_3]], ptr %[[OFFLOAD_SIZES]], align 8
...
// CHECK:  store i64 %[[DTYPE_SIZE4_SEGMENT_CALC_4]], ptr %[[OFFLOAD_SIZES]], align 8
...
// CHECK: %[[DTYPE_SIZE_SEGMENT_CALC_1:.*]] = getelementptr i32, ptr %[[ARR_OFFSET]], i64 1
// CHECK: %[[DTYPE_SIZE_SEGMENT_CALC_2:.*]] = ptrtoaddr ptr %[[DTYPE_SIZE_SEGMENT_CALC_1]] to i64
// CHECK: %[[DTYPE_SIZE_SEGMENT_CALC_3:.*]] = ptrtoaddr ptr %[[NESTED_ALLOCATABLE_MEMBER_GEP]] to i64
// CHECK: %[[DTYPE_SIZE_SEGMENT_CALC_4:.*]] = sub i64 %[[DTYPE_SIZE_SEGMENT_CALC_2]], %[[DTYPE_SIZE_SEGMENT_CALC_3]]
