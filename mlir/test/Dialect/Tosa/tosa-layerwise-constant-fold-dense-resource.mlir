...
func.func @transpose_fold_dense_resource() -> tensor<2x2xf32> {
  ...
  %2 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf32>) -> tensor<2x2xf32>
...
func.func @transpose_fold_dense_resource_f8e4m3fn() -> tensor<2x2xf8E4M3FN> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf8E4M3FN>) -> tensor<2x2xf8E4M3FN>
  // CHECK: return %[[CST]]
...
func.func @transpose_fold_dense_resource_f8e5m2() -> tensor<2x2xf8E5M2> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf8E5M2>) -> tensor<2x2xf8E5M2>
  // CHECK: return %[[CST]]
...
func.func @transpose_fold_dense_resource_f4e2m1fn() -> tensor<2x2xf4E2M1FN> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf4E2M1FN>) -> tensor<2x2xf4E2M1FN>
  // CHECK: return %[[CST]]
...
func.func @transpose_fold_dense_resource_f16() -> tensor<2x2xf16> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf16>) -> tensor<2x2xf16>
  // CHECK: return %[[CST]]
...
func.func @transpose_fold_dense_resource_bf16() -> tensor<2x2xbf16> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xbf16>) -> tensor<2x2xbf16>
  // CHECK: return %[[CST]]
...
func.func @transpose_fold_dense_resource_f64() -> tensor<2x2xf64> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]): (tensor<2x2xf64>) -> tensor<2x2xf64>
  // CHECK: return %[[CST]]
