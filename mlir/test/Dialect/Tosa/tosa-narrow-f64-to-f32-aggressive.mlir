...
func.func @test_f64_add(%arg0: tensor<13x21x1xf64>, %arg1: tensor<13x21x3xf64>) -> tensor<13x21x3xf64> {
  // DEFAULT-DAG: %[[CAST0:.*]] = tosa.cast %[[IN0]] input_unsigned(false) : (tensor<13x21x1xf64>) -> tensor<13x21x1xf32>
  // DEFAULT-DAG: %[[CAST1:.*]] = tosa.cast %[[IN1]] input_unsigned(false) : (tensor<13x21x3xf64>) -> tensor<13x21x3xf32>
  ...
  // DEFAULT: %[[OUT:.*]] = tosa.cast %[[ADD]] input_unsigned(false) : (tensor<13x21x3xf32>) -> tensor<13x21x3xf64>
...
func.func @test_f64_regions(%arg0: tensor<1xf64>, %arg1: tensor<1xf64>, %arg2: tensor<i1>) -> tensor<1xf64> {
  // DEFAULT-DAG: %[[CAST0:.*]] = tosa.cast %[[IN0]] input_unsigned(false) : (tensor<1xf64>) -> tensor<1xf32>
  // DEFAULT-DAG: %[[CAST1:.*]] = tosa.cast %[[IN1]] input_unsigned(false) : (tensor<1xf64>) -> tensor<1xf32>
  ...
  // DEFAULT: %[[OUT:.*]] = tosa.cast %[[IF]] input_unsigned(false) : (tensor<1xf32>) -> tensor<1xf64>
...
func.func @test_convert_input_parameters(%arg0: tensor<1x3xf64>) -> tensor<1x3xf32> {
  // DEFAULT: %[[CAST_IN:.*]] = tosa.cast %[[IN]] input_unsigned(false) : (tensor<1x3xf64>) -> tensor<1x3xf32>
...
func.func @test_f64_const() -> tensor<2xf64> {
  ...
  // DEFAULT: %[[OUT:.*]] = tosa.cast %[[CONST]] input_unsigned(false) : (tensor<2xf32>) -> tensor<2xf64>
...
func.func @test_dense_ressource_f64() -> tensor<1x2xf64> {
  ...
  // DEFAULT: %[[OUT_CAST:.*]] = tosa.cast %[[CONST]] input_unsigned(false) : (tensor<1x2xf32>) -> tensor<1x2xf64>
