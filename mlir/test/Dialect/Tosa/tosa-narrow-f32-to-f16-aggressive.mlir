...
func.func @test_f32_add(%arg0: tensor<13x21x1xf32>, %arg1: tensor<13x21x3xf32>) -> tensor<13x21x3xf32> {
  // DEFAULT-DAG: %[[CAST0:.*]] = tosa.cast %[[IN0]] input_unsigned(false) : (tensor<13x21x1xf32>) -> tensor<13x21x1xf16>
  // DEFAULT-DAG: %[[CAST1:.*]] = tosa.cast %[[IN1]] input_unsigned(false) : (tensor<13x21x3xf32>) -> tensor<13x21x3xf16>
  ...
  // DEFAULT: %[[OUT:.*]] = tosa.cast %[[ADD]] input_unsigned(false) : (tensor<13x21x3xf16>) -> tensor<13x21x3xf32>
...
func.func @test_f32_regions(%arg0: tensor<1xf32>, %arg1: tensor<1xf32>, %arg2: tensor<i1>) -> tensor<1xf32> {
  // DEFAULT-DAG: %[[CAST0:.*]] = tosa.cast %[[IN0]] input_unsigned(false) : (tensor<1xf32>) -> tensor<1xf16>
  // DEFAULT-DAG: %[[CAST1:.*]] = tosa.cast %[[IN1]] input_unsigned(false) : (tensor<1xf32>) -> tensor<1xf16>
  ...
  // DEFAULT: %[[OUT:.*]] = tosa.cast %[[IF]] input_unsigned(false) : (tensor<1xf16>) -> tensor<1xf32>
...
func.func @test_convert_input_parameters(%arg0: tensor<1x3xf32>) -> tensor<1x3xf16> {
  // DEFAULT: %[[CAST_IN:.*]] = tosa.cast %[[IN]] input_unsigned(false) : (tensor<1x3xf32>) -> tensor<1x3xf16>
...
func.func @test_f32_accumulator(%arg0: tensor<1x4x4x1xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>) -> tensor<1x3x3x1xf32> {
  ...
  %0 = tosa.avg_pool2d %arg0, %arg1, %arg2 kernel([2, 2]) stride([1, 1]) pad([0, 0, 0, 0]) acc_type(f32) : (tensor<1x4x4x1xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x3x3x1xf32>
...
func.func @test_f32_conv2d_accumulator(%arg0: tensor<1x4x4x1xf32>, %arg1: tensor<1x2x2x1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1xf32>, %arg4: tensor<1xf32>) -> tensor<1x3x3x1xf32> {
  ...
  %0 = tosa.conv2d %arg0, %arg1, %arg2, %arg3, %arg4 pad([0, 0, 0, 0]) stride([1, 1]) dilation([1, 1]) acc_type(f32) : (tensor<1x4x4x1xf32>, tensor<1x2x2x1xf32>, tensor<1xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x3x3x1xf32>
  return %0 : tensor<1x3x3x1xf32>
}
...
func.func @test_accumulator_only_f32(%arg0: tensor<1x4x4x1xf16>, %arg1: tensor<1xf16>, %arg2: tensor<1xf16>) -> tensor<1x3x3x1xf16> {
  ...
  // FUNCBOUND-SAME: acc_type(f32)
  // CONVERT-ACC-SAME: acc_type(f16)
  %0 = tosa.avg_pool2d %arg0, %arg1, %arg2 kernel([2, 2]) stride([1, 1]) pad([0, 0, 0, 0]) acc_type(f32) : (tensor<1x4x4x1xf16>, tensor<1xf16>, tensor<1xf16>) -> tensor<1x3x3x1xf16>
