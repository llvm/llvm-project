...
func.func @test_transpose_tracks_to_nullifying_single_step(%arg0: tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32> {
  %0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x3x4x2xi32>
  %ceil = tosa.ceil %0 : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  %1 = tosa.transpose %ceil perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
...
func.func @test_transpose_tracks_to_nullifying_multi_unary_step(%arg0: tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32> {
  %0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x3x4x2xi32>
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(1 : i32) : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  ...
  %1 = tosa.transpose %bitwise_not perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
  return %1 : tensor<1x2x3x4xi32>
}
...
func.func @test_transpose_tracks_to_nullifying_diverging_binary(%arg0: tensor<1x2x3x4xi32>, %arg1: tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32> {
  ...
  %transpose1 = tosa.transpose %arg1 perms([0, 2, 3, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x3x4x2xi32>
  ...
  %result = tosa.transpose %add perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
...
func.func @test_transpose_tracks_to_nullifying_diverging_binary_with_broadcasting(%arg0: tensor<1x2x3x4xi32>, %arg1: tensor<1x2x1x4xi32>) -> tensor<1x2x3x4xi32> {
  %transpose0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x3x4x2xi32>
  %transpose1 = tosa.transpose %arg1 perms([0, 2, 3, 1]) : (tensor<1x2x1x4xi32>) -> tensor<1x1x4x2xi32>
  %clamp = tosa.clamp %transpose0 min_val(0 : i32) max_val(1 : i32) : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
...
func.func @test_transpose_tracks_to_nullifying__converging_binary(%arg0: tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32> {
  ...
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
  return %1 : tensor<1x2x3x4xi32>
}
...
func.func @test_torch_conv2d_with_elementwise_in_between(%arg0: tensor<3x3x10x10xf32>) -> tensor<3x3x7x7xf32> {
    ...
    %8 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<3x3x10x10xf32>) -> tensor<3x10x10x3xf32>
    %9 = tosa.transpose %4 perms([0, 2, 3, 1]) : (tensor<3x3x2x2xf32>) -> tensor<3x2x2x3xf32>
    %10 = tosa.conv2d %8, %9, %5, %input_zp, %weight_zp pad([0, 0, 0, 0]) stride([1, 1]) dilation([1, 1]) acc_type(f32) : (tensor<3x10x10x3xf32>, tensor<3x2x2x3xf32>, tensor<3xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<3x9x9x3xf32>
    %11 = tosa.transpose %10 perms([0, 3, 1, 2]) : (tensor<3x9x9x3xf32>) -> tensor<3x3x9x9xf32>
    %12 = tosa.ceil %11 : (tensor<3x3x9x9xf32>) -> tensor<3x3x9x9xf32>
    %13 = tosa.transpose %12 perms([0, 2, 3, 1]) : (tensor<3x3x9x9xf32>) -> tensor<3x9x9x3xf32>
    %14 = tosa.transpose %3 perms([0, 2, 3, 1]) : (tensor<3x3x2x2xf32>) -> tensor<3x2x2x3xf32>
    %15 = tosa.conv2d %13, %14, %2, %input_zp, %weight_zp pad([0, 0, 0, 0]) stride([1, 1]) dilation([1, 1]) acc_type(f32) : (tensor<3x9x9x3xf32>, tensor<3x2x2x3xf32>, tensor<3xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<3x8x8x3xf32>
    %16 = tosa.transpose %15 perms([0, 3, 1, 2]) : (tensor<3x8x8x3xf32>) -> tensor<3x3x8x8xf32>
    %17 = tosa.floor %16 : (tensor<3x3x8x8xf32>) -> tensor<3x3x8x8xf32>
    %18 = tosa.transpose %17 perms([0, 2, 3, 1]) : (tensor<3x3x8x8xf32>) -> tensor<3x8x8x3xf32>
    %19 = tosa.transpose %1 perms([0, 2, 3, 1]) : (tensor<3x3x2x2xf32>) -> tensor<3x2x2x3xf32>
    %20 = tosa.conv2d %18, %19, %0, %input_zp, %weight_zp pad([0, 0, 0, 0]) stride([1, 1]) dilation([1, 1]) acc_type(f32) : (tensor<3x8x8x3xf32>, tensor<3x2x2x3xf32>, tensor<3xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<3x7x7x3xf32>
    %21 = tosa.transpose %20 perms([0, 3, 1, 2]) : (tensor<3x7x7x3xf32>) -> tensor<3x3x7x7xf32>
...
func.func @test_mulop_conversion(%arg0: tensor<1x2x3x4xi32>, %arg1: tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32> {
  ...
  %result = tosa.transpose %mul perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
  return %result : tensor<1x2x3x4xi32>
}
...
// CHECK: tosa.transpose %[[RESHAPED]] perms([0, 2, 1]) : (tensor<1x3x2xi32>) -> tensor<1x2x3xi32>
func.func @test_basic_non_broadcasting_reshape(%arg0: tensor<2x3xi32>) -> tensor<1x2x3xi32> {
  ...
  %2 = tosa.transpose %1 perms([0, 2, 1]) : (tensor<1x3x2xi32>) -> tensor<1x2x3xi32>
...
func.func @test_dynamic_broadcasting_reshape(%arg0: tensor<?xi32>) -> tensor<1x1x?xi32> {
  ...
  %2 = tosa.transpose %1 perms([0, 2, 1]) : (tensor<1x?x1xi32>) -> tensor<1x1x?xi32>
...
func.func @test_reshape_for_broadcast(%arg0: tensor<4x3x2xi32>) -> tensor<4x3x2xi32> {
  ...
  %transpose0 = tosa.transpose %arg0 perms([2, 1, 0]) : (tensor<4x3x2xi32>) -> tensor<2x3x4xi32>
  %add = tosa.add %transpose0, %reshape : (tensor<2x3x4xi32>, tensor<1x1x4xi32>) -> tensor<2x3x4xi32>
  %transpose1 = tosa.transpose %add perms([2, 1, 0]) : (tensor<2x3x4xi32>) -> tensor<4x3x2xi32>
...
func.func @test_multi_dim_reshape_for_broadcast(%arg0: tensor<1x4x1xi32>, %arg1: tensor<4x3x2xi32>) -> tensor<4x3x2xi32> {
  ...
  %transpose0 = tosa.transpose %arg1 perms([2, 1, 0]): (tensor<4x3x2xi32>) -> tensor<2x3x4xi32>
  %add = tosa.add %transpose0, %reshape : (tensor<2x3x4xi32>, tensor<1x1x4xi32>) -> tensor<2x3x4xi32>
  %transpose1 = tosa.transpose %add perms([2, 1, 0]): (tensor<2x3x4xi32>) -> tensor<4x3x2xi32>
  return %transpose1 : tensor<4x3x2xi32>
}
...
// CHECK-DAG: %[[VAL_22:.*]] = tosa.clamp %[[VAL_21]] min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<1x112x112x64xf32>) -> tensor<1x112x112x64xf32>
func.func @test_resnet18_common_case(%arg0: tensor<64xf32>, %arg1: tensor<64xf32>, %74: tensor<1x112x112x64xf32>) -> tensor<1x112x112x64xf32> {
    ...
    %75 = tosa.transpose %74 perms([0, 3, 1, 2]) : (tensor<1x112x112x64xf32>) -> tensor<1x64x112x112xf32>
    ...
    %87 = tosa.clamp %86 min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<1x64x112x112xf32>) -> tensor<1x64x112x112xf32>
    %88 = tosa.transpose %87 perms([0, 2, 3, 1]) : (tensor<1x64x112x112xf32>) -> tensor<1x112x112x64xf32>
...
// CHECK: %[[RES:.*]] = tosa.transpose %arg0 perms([1, 0])
// CHECK: return %[[RES]]
func.func @test_back_to_back_nullifiers(%arg0: tensor<2x3xi32>) -> tensor<3x2xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<2x3xi32>) -> tensor<3x2xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<3x2xi32>) -> tensor<2x3xi32>
  %2 = tosa.transpose %1 perms([1, 0]) : (tensor<2x3xi32>) -> tensor<3x2xi32>
...
// CHECK: %[[RES:.*]] = tosa.transpose %arg0 perms([0, 2, 3, 1])
// CHECK: return %[[RES]]
func.func @test_back_to_back_nullifiers_different_transposes(%arg0: tensor<2x3x4x5xi32>) -> tensor<2x4x5x3xi32> {
  %0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<2x3x4x5xi32>) -> tensor<2x4x5x3xi32>
  %1 = tosa.transpose %0 perms([0, 3, 1, 2]) : (tensor<2x4x5x3xi32>) -> tensor<2x3x4x5xi32>
  %2 = tosa.transpose %1 perms([0, 2, 3, 1]) : (tensor<2x3x4x5xi32>) -> tensor<2x4x5x3xi32>
...
func.func @test_no_transform_if_outside_fan_in_cone(%arg0: tensor<3x3x3x3xi32>) -> (tensor<3x3x3x3xi32>, tensor<3x3x3x3xi32>) {
  %0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(2147483647 : i32) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
...
func.func @test_two_different_downstream_converge_to_reshape_same_perms(%arg0: tensor<64xf32>) -> (tensor<1x1x64xf32>, tensor<1x1x64xf32>) {
  ...
  %2 = tosa.clamp %1 min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<1x64x1xf32>) -> tensor<1x64x1xf32>
  %3 = tosa.transpose %1 perms([0, 2, 1]) : (tensor<1x64x1xf32>) -> tensor<1x1x64xf32>
  %4 = tosa.transpose %2 perms([0, 2, 1]) : (tensor<1x64x1xf32>) -> tensor<1x1x64xf32>
...
func.func @test_two_different_downstream_converge_to_reshape_different_perms(%arg0: tensor<64xf32>) -> (tensor<1x1x64xf32>, tensor<64x1x1xf32>) {
  ...
  %3 = tosa.clamp %2 min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<1x64x1xf32>) -> tensor<1x64x1xf32>
  %4 = tosa.transpose %2 perms([0, 2, 1]) : (tensor<1x64x1xf32>) -> tensor<1x1x64xf32>
  %5 = tosa.transpose %3 perms([1, 2, 0]) : (tensor<1x64x1xf32>) -> tensor<64x1x1xf32>
...
func.func @test_outside_perms_usage_of_fan_in(%arg0: tensor<2x3xf32>, %arg1: tensor<3x2xf32>) -> (tensor<2x3xf32>, tensor<3x2xf32>) {
  %1 = tosa.transpose %arg0 perms([1, 0]) : (tensor<2x3xf32>) -> tensor<3x2xf32>
  %2 = tosa.clamp %1 min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<3x2xf32>) -> tensor<3x2xf32>
  %3 = tosa.transpose %2 perms([1, 0]) : (tensor<3x2xf32>) -> tensor<2x3xf32>
...
func.func @test_use_present_in_another_valid_perms_fan_in(%arg0: tensor<2x3xf32>, %arg1: tensor<2x3xf32>) -> (tensor<2x3xf32>, tensor<2x3xf32>) {
  ...
  %2 = tosa.clamp %1 min_val(0.000000e+00 : f32) max_val(3.40282347E+38 : f32) : (tensor<3x2xf32>) -> tensor<3x2xf32>
  %3 = tosa.transpose %2 perms([1, 0]) : (tensor<3x2xf32>) -> tensor<2x3xf32>
  %4 = tosa.transpose %arg1 perms([1, 0]) : (tensor<2x3xf32>) -> tensor<3x2xf32>
  %5 = tosa.add %4, %2 : (tensor<3x2xf32>, tensor<3x2xf32>) -> tensor<3x2xf32>
  %6 = tosa.transpose %5 perms([1, 0]) : (tensor<3x2xf32>) -> tensor<2x3xf32>
...
func.func @test_two_same_perms_fan_in_but_one_doesnt_convert_dependents(%arg0: tensor<2x3xi32>, %arg1: tensor<3x2xi32>) -> (tensor<2x3xi32>, tensor<2x3xi32>) {
  %1 = tosa.transpose %arg0 perms([1, 0]) : (tensor<2x3xi32>) -> tensor<3x2xi32>
  %2 = tosa.ceil %1 : (tensor<3x2xi32>) -> tensor<3x2xi32>
  %3 = tosa.add %2, %arg1 : (tensor<3x2xi32>, tensor<3x2xi32>) -> tensor<3x2xi32>
  %4 = tosa.transpose %2 perms([1, 0]) : (tensor<3x2xi32>) -> tensor<2x3xi32>
  %5 = tosa.transpose %3 perms([1, 0]) : (tensor<3x2xi32>) -> tensor<2x3xi32>
...
func.func @test_direct_use_in_other_transpose_with_same_perms(%arg0: tensor<3x3x3x3xi32>) -> (tensor<3x3x3x3xi32>, tensor<3x3x3x3xi32>) {
  ...
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(2147483647 : i32) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %2 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
...
// CHECK: %[[NEW_CLAMP:.*]] = tosa.clamp %[[NEW_CONST]] min_val(0 : i32) max_val(2147483647 : i32) : (tensor<1x2x3x4xi32>) -> tensor<1x2x3x4xi32>
// CHECK-NOT: tosa.transpose
...
func.func @test_transpose_tracks_to_const_single_step() -> tensor<1x2x3x4xi32> {
  ...
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(2147483647 : i32) : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
  return %1 : tensor<1x2x3x4xi32>
}
...
func.func @test_multi_downstream_one_nullifies_upstream_other_does_not(%arg0: tensor<3x3x3x3xi32>) -> (tensor<3x3x3x3xi32>, tensor<3x3x3x3xi32>) {
  ...
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(2147483647 : i32) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  %2 = tosa.transpose %clamp perms([0, 2, 3, 1]) : (tensor<3x3x3x3xi32>) -> tensor<3x3x3x3xi32>
  return %1, %2 : tensor<3x3x3x3xi32>, tensor<3x3x3x3xi32>
}
...
func.func @test_unknown_dim_inner_replacement_matches(%arg0: tensor<3x2xi32>) -> tensor<3x2xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<3x2xi32>) -> tensor<?x3xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<?x3xi32>) -> tensor<3x2xi32>
...
func.func @test_unknown_dim_outer_replacement_matches(%arg0: tensor<3x?xi32>) -> tensor<3x?xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<3x?xi32>) -> tensor<2x3xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<2x3xi32>) -> tensor<3x?xi32>
...
func.func @test_transpose_tracks_to_nullifying_diverging_binary_unknown_dim_replacements_match(%arg0: tensor<1x?x3x4xi32>, %arg1: tensor<1x2x?x4xi32>) -> tensor<1x2x3x4xi32> {
  %transpose0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<1x?x3x4xi32>) -> tensor<?x3x4x?xi32>
  %transpose1 = tosa.transpose %arg1 perms([0, 2, 3, 1]) : (tensor<1x2x?x4xi32>) -> tensor<1x?x?x2xi32>
...
func.func @test_unimplemented_transpose_tracks_to_non_nullifying_transpose_single_step(%arg0: tensor<1x2x3x4xi32>) -> tensor<1x2x4x3xi32> {
  %0 = tosa.transpose %arg0 perms([0, 3, 2, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x4x3x2xi32>
  %clamp = tosa.clamp %0 min_val(0 : i32) max_val(1 : i32) : (tensor<1x4x3x2xi32>) -> tensor<1x4x3x2xi32>
  %1 = tosa.transpose %clamp perms([0, 3, 1, 2]) : (tensor<1x4x3x2xi32>) -> tensor<1x2x4x3xi32>
...
func.func @test_unimplemented_unknown_dim_input_nullifying_pair(%arg0: tensor<3x?xi32>) -> tensor<3x2xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<3x?xi32>) -> tensor<2x3xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<2x3xi32>) -> tensor<3x2xi32>
  return %1 : tensor<3x2xi32>
}
...
func.func @test_unimplemented_unknown_dim_replacement_does_not_match(%arg0: tensor<3x?xi32>) -> tensor<?x?xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<3x?xi32>) -> tensor<?x3xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<?x3xi32>) -> tensor<?x?xi32>
...
func.func @test_unimplemented_unranked_tensors_present(%arg0: tensor<3x2xi32>) -> tensor<*xi32> {
  %0 = tosa.transpose %arg0 perms([0, 1]) : (tensor<3x2xi32>) -> tensor<*xi32>
  %1 = tosa.transpose %0 perms([0, 1]) : (tensor<*xi32>) -> tensor<*xi32>
...
func.func @test_unimplemented_unranked_everything(%arg0: tensor<*xi32>) -> tensor<*xi32> {
  %0 = tosa.transpose %arg0 perms([1, 0]) : (tensor<*xi32>) -> tensor<*xi32>
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<*xi32>) -> tensor<*xi32>
  return %1 : tensor<*xi32>
}
...
func.func @test_unimplemented_static_diverges_to_one_nullifying_one_non_nullifying(%arg0: tensor<1x2x3x4xi32>, %arg1: tensor<1x2x4x3xi32>) -> tensor<1x2x3x4xi32> {
  %transpose0 = tosa.transpose %arg0 perms([0, 2, 3, 1]) : (tensor<1x2x3x4xi32>) -> tensor<1x3x4x2xi32>
  %transpose1 = tosa.transpose %arg1 perms([0, 3, 2, 1]) : (tensor<1x2x4x3xi32>) -> tensor<1x3x4x2xi32>
  %clamp = tosa.clamp %transpose0 min_val(0 : i32) max_val(1 : i32) : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  %abs = tosa.abs %transpose1 : (tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  %add = tosa.add %clamp, %abs : (tensor<1x3x4x2xi32>, tensor<1x3x4x2xi32>) -> tensor<1x3x4x2xi32>
  %result = tosa.transpose %add perms([0, 3, 1, 2]) : (tensor<1x3x4x2xi32>) -> tensor<1x2x3x4xi32>
...
func.func @test_transpose_bool() -> tensor<3x2xi1> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<2x3xi1>) -> tensor<3x2xi1>
...
func.func @test_transpose_i4() -> tensor<3x2xi4> {
  ...
  %1 = tosa.transpose %0 perms([1, 0]) : (tensor<2x3xi4>) -> tensor<3x2xi4>
