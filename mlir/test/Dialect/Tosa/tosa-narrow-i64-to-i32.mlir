...
func.func @test_concat(%arg0: tensor<13x21x3xi64>, %arg1: tensor<13x21x3xi64>) -> tensor<26x21x3xi64> {
  // COMMON: tosa.concat %{{.*}}, %{{.*}} axis(0) : (tensor<13x21x3xi32>, tensor<13x21x3xi32>) -> tensor<26x21x3xi32>
  %0 = tosa.concat %arg0, %arg1 axis(0) : (tensor<13x21x3xi64>, tensor<13x21x3xi64>) -> tensor<26x21x3xi64>
...
func.func @test_reverse(%arg0: tensor<13x21x3xi64>) -> tensor<13x21x3xi64> {
  // COMMON: tosa.reverse %{{.*}} axis(0) : (tensor<13x21x3xi32>) -> tensor<13x21x3xi32>
  %0 = tosa.reverse %arg0 axis(0) : (tensor<13x21x3xi64>) -> tensor<13x21x3xi64>
  return %0 : tensor<13x21x3xi64>
}
...
func.func @test_slice(%arg0: tensor<13x21x3xi64>) -> tensor<4x11x1xi64> {
  ...
  %2 = tosa.slice %arg0, %start, %size : (tensor<13x21x3xi64>, !tosa.shape<3>, !tosa.shape<3>) -> tensor<4x11x1xi64>
...
func.func @test_transpose(%arg0: tensor<13x21x3xi64>) -> tensor<3x13x21xi64> {
  // COMMON: tosa.transpose %{{.*}} perms([2, 0, 1]) : (tensor<13x21x3xi32>) -> tensor<3x13x21xi32>
  %1 = tosa.transpose %arg0 perms([2, 0, 1]) : (tensor<13x21x3xi64>) -> tensor<3x13x21xi64>
...
func.func @test_clamp(%arg0: tensor<100xi64>) -> tensor<100xi64> {
  ...
  %1 = tosa.clamp %arg0 min_val(-2147483648 : i64) max_val(2147483647 : i64) : (tensor<100xi64>) -> tensor<100xi64>
...
func.func @test_clamp_max_outside_i32_range(%arg0: tensor<100xi64>) -> tensor<100xi64> {
  ...
  %1 = tosa.clamp %arg0 min_val(-2147483648 : i64) max_val(2147483648 : i64) : (tensor<100xi64>) -> tensor<100xi64>
  return %1 : tensor<100xi64>
}
...
func.func @test_clamp_min_outside_i32_range(%arg0: tensor<100xi64>) -> tensor<100xi64> {
  // expected-error@+1 {{failed to legalize operation 'tosa.clamp'}}
  %1 = tosa.clamp %arg0 min_val(-2147483649 : i64) max_val(2147483647 : i64) : (tensor<100xi64>) -> tensor<100xi64>
  return %1 : tensor<100xi64>
}
