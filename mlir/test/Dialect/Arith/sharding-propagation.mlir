...
// CHECK-NEXT: [[v1:%.*]] = linalg.elementwise <add> indexing_maps = {{.*}} ins([[vsharded_4]], [[vcst_0]] : tensor<1024x1024xf32>, f32) outs([[vsharded_6]] : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
...
func.func @test_shard_constant() -> (tensor<1024x1024xf32>) attributes {llvm.emit_c_interface} {
    ...
    %res = linalg.elementwise <add> indexing_maps = [#id, #sc, #id] ins(%sharded_1, %ci : tensor<1024x1024xf32>, f32) outs(%o1 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
...
func.func @test_shard_constant_back() -> (tensor<1024x1024xf32>) attributes {llvm.emit_c_interface} {
    ...
    %ci = arith.constant 43.4e+00 : f32
    %o1 = tensor.empty() : tensor<1024x1024xf32>
    %res = linalg.elementwise <add> indexing_maps = [#id, #sc, #id] ins(%cst_1, %ci : tensor<1024x1024xf32>, f32) outs(%o1 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
    %sharding_1 = shard.sharding @grid4x4 split_axes = [[0]] : !shard.sharding
