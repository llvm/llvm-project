...
// -----
// CHECK-LABEL: gpu.func @test_uddate_nd_offset_1d(
...
gpu.module @test {
gpu.func @test_uddate_nd_offset_1d(%arg0: memref<256xf32>){
  %c0 = arith.constant 0 : index
...
// -----
// CHECK-LABEL: gpu.func @test_uddate_nd_offset_2d
...
gpu.module @test {
gpu.func @test_uddate_nd_offset_2d(%arg0: memref<256x256xf32>){
  %c0 = arith.constant 0 : index
  %c32 = arith.constant 32 : index
