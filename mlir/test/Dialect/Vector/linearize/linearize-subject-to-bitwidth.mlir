// RUN: mlir-opt %s -split-input-file -test-bit-width-constrained-vector-linearize=target-vector-bitwidth=2048 | FileCheck %s --check-prefixes=ALL,BW-2048
...
// BW-2048: arith.constant {{.*}} vector<4xf32>
// BW-2048: math.sin {{.*}} vector<4xf32>
...
func.func @test_result_bitwidth_64(%arg0: vector<2x2xf32>) -> vector<2x2xf32> {
  ...
  %1 = arith.addf %arg0, %0 : vector<2x2xf32>
  %2 = math.sin %1 : vector<2x2xf32>
...
// BW-2048: %[[ADD:.*]] = arith.addi {{.*}} : vector<2x2xindex>
...
// BW-2048-DAG: %[[ARG_SRC:.*]] = vector.shape_cast %[[SRC]] : vector<8x4xf32> to vector<32xf32>
// BW-2048-DAG: %[[ARG_DEST:.*]] = vector.shape_cast %[[DEST]] : vector<2x8x4xf32> to vector<64xf32>
//     BW-2048: %[[SHUFFLE:.*]] = vector.shuffle %[[ARG_DEST]], %[[ARG_SRC]]
//     BW-2048: %[[RES:.*]] = vector.shape_cast %[[SHUFFLE]] : vector<64xf32> to vector<2x8x4xf32>
//     BW-2048: return %[[RES]] : vector<2x8x4xf32>

// BW-128-DAG: %[[ARG_SRC:.*]] = vector.shape_cast %[[SRC]] : vector<8x4xf32> to vector<32xf32>
// BW-128-DAG: %[[ARG_DEST:.*]] = vector.shape_cast %[[DEST]] : vector<2x8x4xf32> to vector<2x32xf32>
//     BW-128: %[[INSERT:.*]] = vector.insert %[[ARG_SRC]], %[[ARG_DEST]] [0] : vector<32xf32> into vector<2x32xf32>
//     BW-128: %[[RES:.*]] = vector.shape_cast %[[INSERT]] : vector<2x32xf32> to vector<2x8x4xf32>
