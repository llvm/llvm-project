...
func.func @negative_input_acc_many_users(%arg0: memref<16x64x32xbf16>, %arg1: memref<16x32x64xbf16>,
                             %arg2: memref<64x64xf32>) -> memref<64x64xf32> {
  %0 = ub.poison : f32
  %1 = ub.poison : bf16
  %c0 = arith.constant 0 : index
  ...
  scf.for %arg3 = %c0 to %c64 step %c1 {
    scf.for %arg4 = %c0 to %c64 step %c32 {
      ...
      %7 = arith.addf %4#1, %2 : vector<1x16xf32>
      vector.transfer_write %7, %subview[%c0, %c16] {in_bounds = [true, true]}
                        : !vecC, !memrefC
      %8 = arith.addf %4#0, %3 : vector<1x16xf32>
      vector.transfer_write %8, %subview[%c0, %c0] {in_bounds = [true, true]}
                        : !vecC, !memrefC
    }
  }
...
// CHECK-LABEL: @negative_input_acc_many_users
// CHECK-NOT: %[[CST:.*]] = arith.constant dense<0.000000e+00> : vector<1x16xf32>
// CHECK: scf.for
// CHECK-NEXT: scf.for
// CHECK: memref.subview
