...
func.func @lod_sample_int_argument(%arg0 : !spirv.sampled_image<!spirv.image<f32, Dim2D, NoDepth, NonArrayed, SingleSampled, NeedSampler, Rgba8>>, %arg1 : vector<2xf32>, %arg2 : i32) -> () {
  // expected-error @+1 {{for fetch operations, Lod must be an integer type scalar}}
  %0 = spirv.ImageSampleExplicitLod %arg0, %arg1 ["Lod"](%arg2) : !spirv.sampled_image<!spirv.image<f32, Dim2D, NoDepth, NonArrayed, SingleSampled, NeedSampler, Rgba8>>, vector<2xf32> (i32) -> vector<4xf32>
  spirv.Return
}

// TODO: Add similar test for a fetch operation once it's available.
