...
func.func @fold_gpu_subgroup_mma_load_matrix_expand_shape(%src: memref<4096xf32>, %i: index, %j: index) -> !gpu.mma_matrix<16x16xf16, "COp"> {
  ...
  %matrix = gpu.subgroup_mma_load_matrix %expand[%i, %j] leadDimension 64 : memref<64x64xf32> -> !gpu.mma_matrix<16x16xf16, "COp">
  return %matrix: !gpu.mma_matrix<16x16xf16, "COp">
}
...
//      CHECK:   %[[LOAD:.+]] = gpu.subgroup_mma_load_matrix %[[SRC]][%[[LIN]]] leadDimension 64
//      CHECK:   return %[[LOAD]]
...
func.func @fold_gpu_subgroup_mma_store_matrix_expand_shape(%dst: memref<4096xf32>, %i: index, %j: index, %matrix: !gpu.mma_matrix<16x16xf16, "COp">) {
  ...
  gpu.subgroup_mma_store_matrix %matrix, %expand[%i, %j] leadDimension 64 : !gpu.mma_matrix<16x16xf16, "COp">, memref<64x64xf32>
  return
}
...
//      CHECK:   %[[LIN:.+]] = affine.linearize_index disjoint [%[[I]], %[[J]]] by (64, 64)
//      CHECK:   gpu.subgroup_mma_store_matrix %[[MATRIX]], %[[DST]][%[[LIN]]] leadDimension 64
//      CHECK:   return
