...
// CHECK-SAME: -> tensor<2xi8> {
  ...
  %s0 = mesh.sharding @mesh_1d split_axis = [[]] : !mesh.sharding
  %0 = mesh.shard %arg0 to %s0  : tensor<2xi8>
  %s1 = mesh.sharding @mesh_1d split_axis = [[]] : !mesh.sharding
...
// CHECK-SAME: ) -> tensor<2xf32> {
  ...
  %ssharding_annotated = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %sharding_annotated = mesh.shard %arg0 to %ssharding_annotated  : tensor<2xf32>
  %ssharding_annotated_0 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %sharding_annotated_0 = mesh.shard %sharding_annotated to %ssharding_annotated_0  annotate_for_users : tensor<2xf32>
  %ssharding_annotated_1 = mesh.sharding @mesh_1d split_axis = [[]] : !mesh.sharding
...
// CHECK-SAME: -> tensor<2x1xi8> {
  ...
  %s1 = mesh.sharding @mesh_1d split_axis = [[], [0]] : !mesh.sharding
...
// CHECK-SAME: -> tensor<1xi8> {
  ...
  %s3 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %3 = mesh.shard %2 to %s3  : tensor<2xi8>
  %s4 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
...
// CHECK-SAME: -> tensor<2xi8> {
  ...
  %s3 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %3 = mesh.shard %2 to %s3  : tensor<2xi8>
  %s4 = mesh.sharding @mesh_1d split_axis = [[]] : !mesh.sharding
  %4 = mesh.shard %3 to %s4  annotate_for_users : tensor<2xi8>
...
// CHECK-SAME: -> tensor<1xi8> {
  ...
  %sarg0_sharded = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %arg0_sharded = mesh.shard %arg0 to %sarg0_sharded  : tensor<2xi8>
  %sop_arg0 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %op_arg0 = mesh.shard %arg0_sharded to %sop_arg0  annotate_for_users : tensor<2xi8>
  %sarg1_sharded = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %arg1_sharded = mesh.shard %arg1 to %sarg1_sharded  : tensor<2xi8>
  %sop_arg1 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  ...
  %sop_res_sharded = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
  %op_res_sharded = mesh.shard %op_res to %sop_res_sharded  : tensor<2xi8>
  %sres = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
...
// CHECK-SAME: -> tensor<1xi8> {
  ...
  // CHECK-SAME: tensor<2xi8> -> tensor<1xi8>
  %s6 = mesh.sharding @mesh_1d split_axis = [[]] : !mesh.sharding
  %6 = mesh.shard %5 to %s6  : tensor<2xi8>
  %s7 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
...
// CHECK-SAME: -> tensor<4x16xf32> {
  ...
  %s2 = mesh.sharding @mesh_1d split_axis = [[0]] : !mesh.sharding
...
func.func @update_halo_static(
  ...
  %sin1_sharded1 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
...
func.func @update_halo_dynamic_mesh(
  ...
  %sin1_sharded1 = mesh.sharding @mesh_1d_dyn split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  %in1_sharded1 = mesh.shard %in1 to %sin1_sharded1  : tensor<32x16xi8>
  %in1_sharded2 = mesh.shard %in1_sharded1 to %sin1_sharded1 annotate_for_users force : tensor<32x16xi8>
  // CHECK: return %[[RES]] : tensor<?x16xi8>
  return %in1_sharded2 : tensor<32x16xi8>
...
func.func @ew_chain_with_halo(
  ...
  // CHECK-SAME: -> tensor<5x16xf32>
   -> tensor<8x16xf32> {
  %ssharding_annotated = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  ...
  %ssharding_annotated_0 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  %sharding_annotated_0 = mesh.shard %0 to %ssharding_annotated_0  : tensor<8x16xf32>
  %ssharding_annotated_1 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  ...
  %ssharding_annotated_2 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  %sharding_annotated_2 = mesh.shard %1 to %ssharding_annotated_2  : tensor<8x16xf32>
  %ssharding_annotated_4 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  ...
  %ssharding_annotated_5 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
  %sharding_annotated_5 = mesh.shard %2 to %ssharding_annotated_5  : tensor<8x16xf32>
  %ssharding_annotated_6 = mesh.sharding @mesh_1d_4 split_axis = [[0]] halo_sizes = [2, 1] : !mesh.sharding
