...
func.func @memref_subview(%arg0: memref<8x16x4xf32, strided<[64, 4, 1]>>, %arg1: memref<1x128x1x32x1xf32, strided<[4096, 32, 32, 1, 1]>>, %arg2: memref<8x16x4xf32, strided<[1, 64, 8], offset: 16>>, %arg3: index, %arg4: index, %arg5: index) {
  ...
  // CHECK-SAME: offset = [{unsigned : [1, 1] signed : [1, 1] overflow<nsw, nuw>}]
  ...
  // CHECK-SAME: strides = [{unsigned : [64, 64] signed : [64, 64] overflow<nsw, nuw>}, {unsigned : [4, 4] signed : [4, 4] overflow<nsw, nuw>}, {unsigned : [1, 1] signed : [1, 1] overflow<nsw, nuw>}]
  ...
  // CHECK-NEXT: result[0]: strided_metadata<
  // CHECK-SAME: offset = [{unsigned : [346, 484] signed : [346, 484] overflow<nsw, nuw>}]
  // CHECK-SAME: sizes = [{unsigned : [2, 2] signed : [2, 2]}, {unsigned : [2, 2] signed : [2, 2]}, {unsigned : [2, 2] signed : [2, 2]}]
  // CHECK-SAME: strides = [{unsigned : [704, 832] signed : [704, 832] overflow<nsw, nuw>}, {unsigned : [44, 52] signed : [44, 52] overflow<nsw, nuw>}, {unsigned : [11, 13] signed : [11, 13] overflow<nsw, nuw>}]
  ...
  // CHECK-NEXT: result[0]: strided_metadata<
  // CHECK-SAME: offset = [{unsigned : [368, 510] signed : [368, 510] overflow<nsw, nuw>}]
  // CHECK-SAME: sizes = [{unsigned : [2, 2] signed : [2, 2]}, {unsigned : [2, 2] signed : [2, 2]}, {unsigned : [2, 2] signed : [2, 2]}]
  // CHECK-SAME: strides = [{unsigned : [704, 832] signed : [704, 832] overflow<nsw, nuw>}, {unsigned : [44, 52] signed : [44, 52] overflow<nsw, nuw>}, {unsigned : [11, 13] signed : [11, 13] overflow<nsw, nuw>}]
  ...
  // CHECK-SAME: strides = [{unsigned : [0, 18446744073709551615] signed : [-9223372036854775808, 9223372036854775807]}, {unsigned : [0, 18446744073709551615] signed : [-9223372036854775808, 9223372036854775807] overflow<nsw, nuw>}]
  ...
  // CHECK-NEXT: result[0]: strided_metadata<
  // CHECK-SAME: offset = [{unsigned : [0, 18446744073709551615] signed : [-9223372036854775808, 9223372036854775807]}]
  // CHECK-SAME: sizes = [{unsigned : [5, 7] signed : [5, 7] overflow<nsw, nuw>}]
  ...
  // CHECK-NEXT: result[0]: strided_metadata<
  // CHECK-SAME: offset = [{unsigned : [32, 32] signed : [32, 32] overflow<nsw, nuw>}]
  // CHECK-SAME: sizes = [{unsigned : [11, 13] signed : [11, 13] overflow<nsw, nuw>}, {unsigned : [5, 7] signed : [5, 7] overflow<nsw, nuw>}, {unsigned : [0, 18446744073709551615] signed : [-9223372036854775808, 9223372036854775807]}]
  // CHECK-SAME: strides = [{unsigned : [1, 1] signed : [1, 1] overflow<nsw, nuw>}, {unsigned : [64, 64] signed : [64, 64] overflow<nsw, nuw>}, {unsigned : [8, 8] signed : [8, 8] overflow<nsw, nuw>}]
...
// CHECK: Op: %[[SV6:.*]] = memref.subview %arg0[%c0] [%0] [%c1] : memref<32xf32, strided<[1]>> to memref<?xf32, strided<[?], offset: ?>>
// CHECK-NEXT: result[0]: strided_metadata<
// CHECK-SAME: offset = [{unsigned : [0, 0] signed : [0, 0] overflow<nsw, nuw>}]
// CHECK-SAME: sizes = [{unsigned : [5, 7] signed : [5, 7] overflow<nsw, nuw>}]
// CHECK-SAME: strides = [{unsigned : [1, 1] signed : [1, 1] overflow<nsw, nuw>}]
...
func.func @memref_subview_bounded_size(%arg0: memref<32xf32, strided<[1]>>) {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %size = test.with_bounds {smax = 7 : index, smin = 5 : index, umax = 7 : index, umin = 5 : index} : index
  %subview = memref.subview %arg0[%c0] [%size] [%c1] : memref<32xf32, strided<[1]>> to memref<?xf32, strided<[?], offset: ?>>
  return
}
