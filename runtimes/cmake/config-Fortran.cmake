...
#
# RUNTIMES_FORTRAN_MODULESS - Whether to build Flang modules and emit them
...
# the build directory. Most relevant when RUNTIMES_FORTRAN_MODULESS is ON.
#
...
# RUNTIMES_FORTRAN_MODULESS is ON.
...
set(RUNTIMES_FORTRAN_MODULESS_default OFF)
if (CMAKE_Fortran_COMPILER_ID STREQUAL "LLVMFlang")
  set(RUNTIMES_FORTRAN_MODULESS_default ON)
else ()
  set(RUNTIMES_FORTRAN_MODULESS_default OFF)
endif ()
option(RUNTIMES_FORTRAN_MODULESS "Make Fortran .mod files available to Flang; should only be enabled if compiling with a matching version of Flang" "${RUNTIMES_FORTRAN_MODULESS_default}")


# Determine the paths for Fortran .mod files.
if (RUNTIMES_FORTRAN_MODULESS)
