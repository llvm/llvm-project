...
def _setup_from_libc_dev_package(repository_ctx):
    ...
    repository_ctx.download_and_extract(
        url = "https://snapshot.debian.org/archive/debian-security/20260806T175946Z/pool/updates/main/l/linux/linux-libc-dev_6.12.101-1_all.deb",
        sha256 = "e776ef48b89af0409c6bcd2e8a7e14a3d75d0842b9fd3dc767b7822a0b0950e2",
    )
...
def _linux_uapi_setup_impl(repository_ctx):
    ...
    if include_dir:
        _setup_from_system(repository_ctx, include_dir)
    else:
        _setup_from_libc_dev_package(repository_ctx)
