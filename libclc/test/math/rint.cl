...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call half @llvm.rint.f16(half noundef [[X]]) #[[ATTR2:[0-9]+]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call float @llvm.rint.f32(float noundef [[X]]) #[[ATTR2]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call double @llvm.rint.f64(double noundef [[X]]) #[[ATTR2]]
