...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call half @llvm.ceil.f16(half noundef [[X]]) #[[ATTR2:[0-9]+]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call float @llvm.ceil.f32(float noundef [[X]]) #[[ATTR2]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call double @llvm.ceil.f64(double noundef [[X]]) #[[ATTR2]]
