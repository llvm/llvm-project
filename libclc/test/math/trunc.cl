...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call half @llvm.trunc.f16(half noundef [[X]]) #[[ATTR2:[0-9]+]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call float @llvm.trunc.f32(float noundef [[X]]) #[[ATTR2]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call double @llvm.trunc.f64(double noundef [[X]]) #[[ATTR2]]
