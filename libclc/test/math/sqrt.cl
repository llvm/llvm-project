...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call half @llvm.sqrt.f16(half noundef [[X]]) #[[ATTR2:[0-9]+]], !fpmath [[META12:![0-9]+]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call float @llvm.sqrt.f32(float noundef [[X]]) #[[ATTR2]], !fpmath [[META13:![0-9]+]]
...
// AMDGCN-NEXT:  [[ENTRY:.*:]]
// AMDGCN-NEXT:    [[CALL:%.*]] = tail call double @llvm.sqrt.f64(double noundef [[X]]) #[[ATTR2]]
