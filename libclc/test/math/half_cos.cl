...
// AMDGCN-NEXT:    [[DOTNEG_I_I_I_I_I:%.*]] = xor i32 [[TMP82]], -1
...
// AMDGCN-NEXT:    [[DOTNEG3_I_I_I_I_I:%.*]] = sub nuw nsw i32 [[DOTNEG_I_I_I_I_I]], [[TMP92]]
// AMDGCN-NEXT:    [[TMP95:%.*]] = lshr i32 [[TMP94]], 9
// AMDGCN-NEXT:    [[DOTNEG4_I_I_I_I_I:%.*]] = shl nsw i32 [[DOTNEG3_I_I_I_I_I]], 23
// AMDGCN-NEXT:    [[TMP96:%.*]] = add nsw i32 [[DOTNEG4_I_I_I_I_I]], 864026624
...
// AMDGCN-NEXT:    br label %[[_Z8HALF_COSF_EXIT:.*]]
// AMDGCN:       [[BB108]]:
...
// AMDGCN-NEXT:    br label %[[_Z8HALF_COSF_EXIT]]
// AMDGCN:       [[_Z8HALF_COSF_EXIT]]:
// AMDGCN-NEXT:    [[DOTSINK_I_I_I_I_I:%.*]] = phi float [ [[TMP113]], %[[BB108]] ], [ [[TMP105]], %[[BB4]] ]
// AMDGCN-NEXT:    [[TMP115:%.*]] = phi i32 [ [[TMP114]], %[[BB108]] ], [ [[TMP107]], %[[BB4]] ]
// AMDGCN-NEXT:    [[TMP116:%.*]] = fmul float [[DOTSINK_I_I_I_I_I]], [[DOTSINK_I_I_I_I_I]]
...
// AMDGCN-NEXT:    [[TMP120:%.*]] = tail call noundef float @llvm.fmuladd.f32(float [[DOTSINK_I_I_I_I_I]], float [[TMP119]], float [[DOTSINK_I_I_I_I_I]])
