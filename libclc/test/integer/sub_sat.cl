...
// RUN: %clang -target %libclc_target -x cl -cl-std=CL3.0 -Xclang -fdeclare-opencl-builtins -Xclang -finclude-default-header -O2 -emit-llvm -S -o - %s | FileCheck %s --check-prefix=%check_prefix
