...
// CHECK: cv.dotup.sc.h
uint32_t test_simd_dotup_sc_h(uint32_t a0, uint16_t a1) {
  return __riscv_cv_simd_dotup_sc_h(a0, a1);
}

// CHECK-LABEL: test_simd_dotup_sc_b:
// CHECK: cv.dotup.sc.b
uint32_t test_simd_dotup_sc_b(uint32_t a0, uint8_t a1) {
...
int32_t test_simd_dotusp_sc_h(uint32_t a0, int16_t a1) {
  return __riscv_cv_simd_dotusp_sc_h(a0, a1);
}

// CHECK-LABEL: test_simd_dotusp_sc_b:
// CHECK: cv.dotusp.sc.b
int32_t test_simd_dotusp_sc_b(uint32_t a0, int8_t a1) {
...
// CHECK: cv.dotsp.sc.h
int32_t test_simd_dotsp_sc_h(uint32_t a0, int16_t a1) {
  return __riscv_cv_simd_dotsp_sc_h(a0, a1);
}

// CHECK-LABEL: test_simd_dotsp_sc_b:
// CHECK: cv.dotsp.sc.b
int32_t test_simd_dotsp_sc_b(uint32_t a0, int8_t a1) {
...
uint32_t test_simd_sdotup_sc_h(uint32_t a0, uint16_t a1, uint32_t a2) {
  return __riscv_cv_simd_sdotup_sc_h(a0, a1, a2);
}

// CHECK-LABEL: test_simd_sdotup_sc_b:
// CHECK: cv.sdotup.sc.b
uint32_t test_simd_sdotup_sc_b(uint32_t a0, uint8_t a1, uint32_t a2) {
...
int32_t test_simd_sdotusp_sc_h(uint32_t a0, int16_t a1, int32_t a2) {
  return __riscv_cv_simd_sdotusp_sc_h(a0, a1, a2);
}

// CHECK-LABEL: test_simd_sdotusp_sc_b:
// CHECK: cv.sdotusp.sc.b
int32_t test_simd_sdotusp_sc_b(uint32_t a0, int8_t a1, int32_t a2) {
...
int32_t test_simd_sdotsp_sc_h(uint32_t a0, int16_t a1, int32_t a2) {
  return __riscv_cv_simd_sdotsp_sc_h(a0, a1, a2);
}

// CHECK-LABEL: test_simd_sdotsp_sc_b:
// CHECK: cv.sdotsp.sc.b
int32_t test_simd_sdotsp_sc_b(uint32_t a0, int8_t a1, int32_t a2) {
