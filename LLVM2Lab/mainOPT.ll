...
entry:
  ...
  store i32 5, i32* %arg, align 4
  store i64 0, i64* %i, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i64, i64* %i, align 8
  %cmp = icmp ult i64 %0, 10000000000
...
!1 = !{!"clang version 11.0.0 (https://github.com/381706-2AntipinAleksandr/llvm-project.git 0980c9c6f155d8a06ad839d530636bf109aae34b)"}
