...
#else
template <class _InputIterator>
using __iter_key_type _LIBCPP_NODEBUG = __remove_const_t<__iter_traits_value_type<_InputIterator>::first_type>;

template <class _InputIterator>
using __iter_mapped_type _LIBCPP_NODEBUG = __iter_traits_value_type<_InputIterator>::second_type;

template <class _InputIterator>
using __iter_to_alloc_type _LIBCPP_NODEBUG =
    pair<const __iter_traits_value_type<_InputIterator>::first_type,
         __iter_traits_value_type<_InputIterator>::second_type>;
