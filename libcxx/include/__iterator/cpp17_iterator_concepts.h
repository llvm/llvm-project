...
concept __cpp17_iterator =
    ...
    (is_signed_v<typename iterator_traits<_Iter>::difference_type> ||
     is_void_v<typename iterator_traits<_Iter>::difference_type>) &&
...
concept __cpp17_random_access_iterator =
    __cpp17_bidirectional_iterator<_Iter> &&
    requires(_Iter __iter, typename iterator_traits<_Iter>::difference_type __n) {
      ...
      { __iter - __iter } -> same_as<typename iterator_traits<_Iter>::difference_type>;
      { std::as_const(__iter) - __iter } -> same_as<typename iterator_traits<_Iter>::difference_type>;
      { __iter - std::as_const(__iter) } -> same_as<typename iterator_traits<_Iter>::difference_type>;
      { std::as_const(__iter) - std::as_const(__iter) } -> same_as<typename iterator_traits<_Iter>::difference_type>;
