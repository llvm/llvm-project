...
template <>
constexpr std::strong_ordering std::type_order_v<int, int> = std::strong_ordering::less;
// expected-error@-1 {{cannot be specialized}}

template <class T>
constexpr std::strong_ordering std::type_order_v<T, int> = std::strong_ordering::less;
// expected-error@-1 {{cannot be specialized}}
#  endif
#endif
