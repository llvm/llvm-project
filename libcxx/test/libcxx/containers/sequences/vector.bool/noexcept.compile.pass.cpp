...
static_assert(std::is_nothrow_constructible<vec, const std::allocator<bool>&>::value);
...
using vec = std::vector<bool, test_allocator<bool>>;

static_assert(std::is_nothrow_constructible<vec>::value);
static_assert(std::is_nothrow_constructible<vec, const test_allocator<bool>&>::value);
static_assert(std::is_nothrow_constructible<vec, vec&&>::value);
