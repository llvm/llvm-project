...
BENCHMARK_CAPTURE(BM_sprintf, C string len = 6, c_string_6_characters);
FORMAT_BENCHMARKS(C string len = 6, c_string_6_characters)
FORMAT_BENCHMARKS(string len = 6, string_6_characters)
FORMAT_BENCHMARKS(string_view len = 6, string_view_6_characters)

BENCHMARK_CAPTURE(BM_sprintf, C string len = 60, c_string_60_characters);
FORMAT_BENCHMARKS(C string len = 60, c_string_60_characters)
FORMAT_BENCHMARKS(string len = 60, string_60_characters)
FORMAT_BENCHMARKS(string_view len = 60, string_view_60_characters)

BENCHMARK_CAPTURE(BM_sprintf, C string len = 6000, c_string_6000_characters);
FORMAT_BENCHMARKS(C string len = 6000, c_string_6000_characters)
FORMAT_BENCHMARKS(string len = 6000, string_6000_characters)
FORMAT_BENCHMARKS(string_view len = 6000, string_view_6000_characters)
