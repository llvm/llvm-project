...
static_assert(sfinae_test_find_end<int, int*, int*, int*, int*>);
static_assert(!sfinae_test_find_end<std::execution::parallel_policy, int*, int*, int*, int*>);
...
struct Test {
  ...
  void operator()(ExecutionPolicy&& policy) {
    { // Check the return type
      ...
      int b[] = {0};
      auto res =
          std::find_end(policy, Iter1(std::begin(a)), Iter1(std::end(a)), Iter2(std::begin(b)), Iter2(std::end(b)));
    ...
    { // Empty haystack, empty needle
      ...
      int b[] = {0};
      auto res =
          std::find_end(policy, Iter1(std::begin(a)), Iter1(std::begin(a)), Iter2(std::begin(b)), Iter2(std::begin(b)));
    ...
    { // Empty haystack, non-empty needle
      ...
      int b[] = {0};
      auto res =
          std::find_end(policy, Iter1(std::begin(a)), Iter1(std::begin(a)), Iter2(std::begin(b)), Iter2(std::end(b)));
      assert(res == Iter1(std::begin(a)));
    }
    { // Non-empty haystack, empty needle
      ...
      int b[] = {0};
      auto res =
          std::find_end(policy, Iter1(std::begin(a)), Iter1(std::end(a)), Iter2(std::begin(b)), Iter2(std::begin(b)));
