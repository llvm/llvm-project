...
#    ifdef __cpp_lib_quoted_string_io
#      error                                                                                                           \
          "__cpp_lib_quoted_string_io should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_HAS_LOCALIZATION' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_shared_timed_mutex
#      error                                                                                                           \
          "__cpp_lib_shared_timed_mutex should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_HAS_THREADS' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_filesystem
#      error                                                                                                           \
          "__cpp_lib_filesystem should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_FILESYSTEM && _LIBCPP_AVAILABILITY_HAS_FILESYSTEM_LIBRARY)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_hardware_interference_size
#      error                                                                                                           \
          "__cpp_lib_hardware_interference_size should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (defined(__GCC_DESTRUCTIVE_SIZE) && defined(__GCC_CONSTRUCTIVE_SIZE))' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_memory_resource
#      error                                                                                                           \
          "__cpp_lib_memory_resource should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_AVAILABILITY_HAS_PMR' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_scoped_lock
#      error                                                                                                           \
          "__cpp_lib_scoped_lock should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_HAS_THREADS' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_shared_mutex
#      error                                                                                                           \
          "__cpp_lib_shared_mutex should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_HAS_THREADS' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_atomic_wait
#      error                                                                                                           \
          "__cpp_lib_atomic_wait should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_AVAILABILITY_HAS_SYNC' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_barrier
#      error                                                                                                           \
          "__cpp_lib_barrier should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_THREADS && _LIBCPP_AVAILABILITY_HAS_SYNC)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_destroying_delete
#      error                                                                                                           \
          "__cpp_lib_destroying_delete should not be defined when the requirement 'TEST_STD_VER > 17 && defined(__cpp_impl_destroying_delete) && __cpp_impl_destroying_delete >= 201806L' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_format
#      error                                                                                                           \
          "__cpp_lib_format should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_AVAILABILITY_HAS_TO_CHARS_FLOATING_POINT' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_jthread
#      error                                                                                                           \
          "__cpp_lib_jthread should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_THREADS && _LIBCPP_AVAILABILITY_HAS_SYNC)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_latch
#      error                                                                                                           \
          "__cpp_lib_latch should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_THREADS && _LIBCPP_AVAILABILITY_HAS_SYNC)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_polymorphic_allocator
#      error                                                                                                           \
          "__cpp_lib_polymorphic_allocator should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_AVAILABILITY_HAS_PMR' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_semaphore
#      error                                                                                                           \
          "__cpp_lib_semaphore should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_THREADS && _LIBCPP_AVAILABILITY_HAS_SYNC)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_syncbuf
#      error                                                                                                           \
          "__cpp_lib_syncbuf should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_HAS_EXPERIMENTAL_SYNCSTREAM' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_is_implicit_lifetime
#      error                                                                                                           \
          "__cpp_lib_is_implicit_lifetime should not be defined when the requirement '__has_builtin(__builtin_is_implicit_lifetime)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_print
#      error                                                                                                           \
          "__cpp_lib_print should not be defined when the requirement '!defined(_LIBCPP_VERSION) || _LIBCPP_AVAILABILITY_HAS_TO_CHARS_FLOATING_POINT' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_associative_heterogeneous_insertion
#      error                                                                                                           \
          "__cpp_lib_associative_heterogeneous_insertion should not be defined because it is unimplemented in libc++!"
#    endif
#  endif
...
#    ifdef __cpp_lib_constexpr_new
#      error                                                                                                           \
          "__cpp_lib_constexpr_new should not be defined when the requirement '!defined(_LIBCPP_ABI_VCRUNTIME)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_default_template_type_for_algorithm_values
#      error                                                                                                           \
          "__cpp_lib_default_template_type_for_algorithm_values should not be defined because it is unimplemented in libc++!"
#    endif
#  endif
...
#    ifdef __cpp_lib_fstream_native_handle
#      error                                                                                                           \
          "__cpp_lib_fstream_native_handle should not be defined when the requirement '!defined(_LIBCPP_VERSION) || (_LIBCPP_HAS_FILESYSTEM && _LIBCPP_HAS_LOCALIZATION)' is not met!"
#    endif
#  endif
...
#    ifdef __cpp_lib_is_virtual_base_of
#      error                                                                                                           \
          "__cpp_lib_is_virtual_base_of should not be defined when the requirement '__has_builtin(__builtin_is_virtual_base_of)' is not met!"
#    endif
#  endif
