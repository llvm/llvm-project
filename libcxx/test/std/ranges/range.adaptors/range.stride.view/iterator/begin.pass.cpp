...
constexpr bool iterator_concept_test() {
  {
    ...
    auto rav =
        BasicTestView<random_access_iterator<int*>>(random_access_iterator(arr), random_access_iterator(arr + 3));
    auto str = std::ranges::stride_view<BasicTestView<random_access_iterator<int*>>>(rav, 1);
...

  {
    ...
    auto rav =
        BasicTestView<bidirectional_iterator<int*>>(bidirectional_iterator(arr), bidirectional_iterator(arr + 3));
    auto str = std::ranges::stride_view<BasicTestView<bidirectional_iterator<int*>>>(rav, 1);
...

  {
    ...
    auto rav = BasicTestView<forward_iterator<int*>>(forward_iterator(arr), forward_iterator(arr + 3));
    auto str = std::ranges::stride_view<BasicTestView<forward_iterator<int*>>>(rav, 1);
...

  {
    ...
    auto rav = BasicTestView<cpp17_input_iterator<int*>>(cpp17_input_iterator(arr), cpp17_input_iterator(arr + 3));
    auto str = std::ranges::stride_view<BasicTestView<cpp17_input_iterator<int*>>>(rav, 1);
