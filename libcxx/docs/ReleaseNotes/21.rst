...
- P2546R5: Debugging support (`Github <https://github.com/llvm/llvm-project/issues/99937>`__)
- P2810R4: ``is_debugger_present`` is_replaceable(`Github <https://github.com/llvm/llvm-project/issues/99937>`__)
