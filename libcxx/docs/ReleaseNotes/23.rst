...
- P2164R9: ``views::enumerate`` (`Github <https://llvm.org/PR105251>`__)- P2322R6 (partial): ``ranges::fold_left_first``, ``ranges::fold_left_first_with_iter``, ``ranges::fold_right`` are
