...
- P2869R4: Remove Deprecated ``shared_ptr`` Atomic Access APIs from C++26 (`Github <https://github.com/llvm/llvm-project/issues/105412>`__)
...
- P3793R2: Better shifting (`Github <https://llvm.org/PR219389>`__) (no ``std::simd`` overloads)
- P0040R3: Extending memory management tools (`Github <https://github.com/llvm/llvm-project/issues/103640>`__)
