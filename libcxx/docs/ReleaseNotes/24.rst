...
- P2830R10: Standardized Constexpr Type Ordering (`Github <https://llvm.org/TBD>`__)
- P3778R0: Fix for ``type_order`` template definition (`Github <https://llvm.org/TBD>`__)
- P4140R0: Proposed resolution for US70-126: allow incomplete types in type_order (`Github <https://llvm.org/TBD>`__)
