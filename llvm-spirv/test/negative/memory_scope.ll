...
;kernel void test_scope(global atomic_intptr_t *a, global ptrdiff_t *b, int x) {
;  memory_scope scope;
;  if (x)
;    scope = memory_scope_device;
;  else
;    scope = memory_scope_work_group;
;  atomic_fetch_add_explicit(a, *b, memory_order_relaxed, scope);
;}

; CHECK: error: memory_scope argument needs to be constant

; ModuleID = 'mem_scope.cl'
target datalayout = "e-p:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "spir-unknown-unknown"

; Function Attrs: convergent noinline nounwind optnone
define dso_local spir_kernel void @test_scope(i32 addrspace(1)* %a, i32 addrspace(1)* %b, i32 %x) #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
entry:
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call = call spir_func i32 @_Z25atomic_fetch_add_explicitPU3AS4VU7_Atomicii12memory_order12memory_scope(i32 addrspace(4)* %2, i32 %4, i32 0, i32 %5) #2
  ret void
}
