...
unsigned isl_local_space_offset(__isl_keep isl_local_space *ls,
  ...
  case isl_dim_out:
  case isl_dim_div:
    return 1 + isl_local_space_var_offset(ls, type);
  default:
    return 0;
  }
}
 ...
 */
__isl_keep isl_local *
isl_local_space_get_local(__isl_keep isl_local_space *ls) {
 ...
 * The only exception is that isl_local_space_free can be called instead.
 */
static __isl_give isl_local *
isl_local_space_take_local(__isl_keep isl_local_space *ls) {
  isl_local *local;
...
isl_local_space_restore_local(__isl_take isl_local_space *ls,
