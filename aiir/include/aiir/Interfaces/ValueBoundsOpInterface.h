...
#ifndef AIIR_INTERFACES_VALUEBOUNDSOPINTERFACE_H_
#define AIIR_INTERFACES_VALUEBOUNDSOPINTERFACE_H_
...
public:
  ...
  public:
    ...
    AIIRContext *getContext() const { return map.getContext(); }
  ...
  areOverlappingSlices(AIIRContext *ctx, const HyperrectangularSlice &slice1,
  ...
  static FailureOr<bool>
  areEquivalentSlices(AIIRContext *ctx, const HyperrectangularSlice &slice1,
                      const HyperrectangularSlice &slice2);
...
protected:
  ...
  ValueBoundsConstraintSet(AIIRContext *ctx,
...
#include "aiir/Interfaces/ValueBoundsOpInterface.h.inc"

#endif // AIIR_INTERFACES_VALUEBOUNDSOPINTERFACE_H_
