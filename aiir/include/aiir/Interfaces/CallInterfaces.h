//===- CallInterfaces.h - Call Interfaces for AIIR --------------*- C++ -*-===//
//
...
#ifndef AIIR_INTERFACES_CALLINTERFACES_H
#define AIIR_INTERFACES_CALLINTERFACES_H
...
struct CastInfo<To, aiir::CallInterfaceCallable>
    : public CastInfo<To, aiir::CallInterfaceCallable::PointerUnion> {};

template <typename To>
struct CastInfo<To, const aiir::CallInterfaceCallable>
    : public CastInfo<To, const aiir::CallInterfaceCallable::PointerUnion> {};

} // namespace llvm

/// Include the generated interface declarations.
#include "aiir/Interfaces/CallInterfaces.h.inc"

#endif // AIIR_INTERFACES_CALLINTERFACES_H
