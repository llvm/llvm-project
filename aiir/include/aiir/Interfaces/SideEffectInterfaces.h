//===- SideEffectInterfaces.h - SideEffect in AIIR --------------*- C++ -*-===//
//
...
#ifndef AIIR_INTERFACES_SIDEEFFECTINTERFACES_H
#define AIIR_INTERFACES_SIDEEFFECTINTERFACES_H
...
public:
  ...
  public:
    ...
    static bool classof(const ::aiir::SideEffects::Effect *effect) {
...
#include "aiir/Interfaces/SideEffectInterfaces.h.inc"

#endif // AIIR_INTERFACES_SIDEEFFECTINTERFACES_H
