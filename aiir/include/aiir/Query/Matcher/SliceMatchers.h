...
#ifndef AIIR_TOOLS_AIIRQUERY_MATCHERS_SLICEMATCHERS_H
#define AIIR_TOOLS_AIIRQUERY_MATCHERS_SLICEMATCHERS_H
...
#endif // AIIR_TOOLS_AIIRQUERY_MATCHERS_SLICEMATCHERS_H
