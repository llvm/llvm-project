...
#ifndef AIIR_TOOLS_AIIRQUERY_MATCHER_MATCHERSINTERNAL_H
#define AIIR_TOOLS_AIIRQUERY_MATCHER_MATCHERSINTERNAL_H
...
// Generic interface for matchers on an AIIR operation.
...
#endif // AIIR_TOOLS_AIIRQUERY_MATCHER_MATCHERSINTERNAL_H
