...
#ifndef AIIR_TOOLS_PDLL_AST_NODES_H_
#define AIIR_TOOLS_PDLL_AST_NODES_H_
...
/// This expression represents a literal AIIR Attribute, and contains the
...
/// This expression represents the structural form of an AIIR Operation. It
...
public:
  ...
  RangeType getType() const { return aiir::cast<RangeType>(Base::getType()); }
...
public:
  ...
  TupleType getType() const { return aiir::cast<TupleType>(Base::getType()); }
...
/// This expression represents a literal AIIR Type, and contains the textual
...
#endif // AIIR_TOOLS_PDLL_AST_NODES_H_
