...
#ifndef AIIR_TOOLS_PDLL_AST_TYPES_H_
#define AIIR_TOOLS_PDLL_AST_TYPES_H_
...
/// This class represents a PDLL type that corresponds to an aiir::Attribute.
...
/// type has no AIIR C++ API correspondance.
...
/// This class represents a PDLL type that corresponds to an aiir::Operation.
...
/// This class represents a PDLL type that corresponds to an aiir::TypeRange.
...
/// This class represents a PDLL type that corresponds to an aiir::ValueRange.
...
/// This type has no AIIR C++ API correspondance.
...
/// This class represents a PDLL type that corresponds to an aiir::Type.
...
/// This class represents a PDLL type that corresponds to an aiir::Value.
...
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::AttributeTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::ConstraintTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::OperationTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::RangeTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::RewriteTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::TupleTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::TypeTypeStorage)
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::pdll::ast::detail::ValueTypeStorage)

namespace llvm {
template <>
struct DenseMapInfo<aiir::pdll::ast::Type> {
  static aiir::pdll::ast::Type getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::pdll::ast::Type(
        static_cast<aiir::pdll::ast::Type::Storage *>(pointer));
  }
  static aiir::pdll::ast::Type getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::pdll::ast::Type(
        static_cast<aiir::pdll::ast::Type::Storage *>(pointer));
  }
  static unsigned getHashValue(aiir::pdll::ast::Type val) {
    return llvm::hash_value(val.getImpl());
  }
  static bool isEqual(aiir::pdll::ast::Type lhs, aiir::pdll::ast::Type rhs) {
    return lhs == rhs;
  }
};

/// Add support for llvm style casts.
/// We provide a cast between To and From if From is aiir::pdll::ast::Type or
/// derives from it
template <typename To, typename From>
struct CastInfo<
    To, From,
    std::enable_if_t<
        std::is_same_v<aiir::pdll::ast::Type, std::remove_const_t<From>> ||
        std::is_base_of_v<aiir::pdll::ast::Type, From>>>
    : NullableValueCastFailed<To>,
      DefaultDoCastIfPossible<To, From, CastInfo<To, From>> {
  static inline bool isPossible(aiir::pdll::ast::Type ty) {
  ...
  static inline To doCast(aiir::pdll::ast::Type ty) { return To(ty.getImpl()); }
};
} // namespace llvm

#endif // AIIR_TOOLS_PDLL_AST_TYPES_H_
