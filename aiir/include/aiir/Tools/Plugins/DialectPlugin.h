//===- aiir/Tools/Plugins/DialectPlugin.h - Public Plugin API -------------===//
//
...
#ifndef AIIR_TOOLS_PLUGINS_DIALECTPLUGIN_H
#define AIIR_TOOLS_PLUGINS_DIALECTPLUGIN_H
...
/// to be filled out by plugin implementors. AIIR-side users of a plugin are
...
///
/// ```
/// extern "C" ::aiir::DialectPluginLibraryInfo LLVM_ATTRIBUTE_WEAK
/// aiirGetDialectPluginInfo() {
///   return {
///     AIIR_PLUGIN_API_VERSION, "MyPlugin", "v0.1", [](DialectRegistry) { ... }
///   };
/// }
/// ```
extern "C" ::aiir::DialectPluginLibraryInfo LLVM_ATTRIBUTE_WEAK
...
#endif /* AIIR_TOOLS_PLUGINS_DIALECTPLUGIN_H */
