//===- aiir/Tools/Plugins/PassPlugin.h - Public Plugin API ----------------===//
//
...
#ifndef AIIR_TOOLS_PLUGINS_PASSPLUGIN_H
#define AIIR_TOOLS_PLUGINS_PASSPLUGIN_H
...
#define AIIR_PLUGIN_API_VERSION 1
...
///
/// ```
/// extern "C" ::aiir::PassPluginLibraryInfo LLVM_ATTRIBUTE_WEAK
/// aiirGetPassPluginInfo() {
///   return {
///     AIIR_PLUGIN_API_VERSION, "MyPlugin", "v0.1", []() { ... }
///   };
/// }
/// ```
extern "C" ::aiir::PassPluginLibraryInfo LLVM_ATTRIBUTE_WEAK
...
#endif /* AIIR_TOOLS_PLUGINS_PASSPLUGIN_H */
