//===- ParseUtilities.h - AIIR Tool Parse Utilities -------------*- C++ -*-===//
//
...
// behaviour for AIIR tools.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TOOLS_PARSEUTILITIES_H
#define AIIR_TOOLS_PARSEUTILITIES_H
...
#endif // AIIR_TOOLS_PARSEUTILITIES_H
