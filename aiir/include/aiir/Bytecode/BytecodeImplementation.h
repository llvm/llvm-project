//===- BytecodeImplementation.h - AIIR Bytecode Implementation --*- C++ -*-===//
//
...
#ifndef AIIR_BYTECODE_BYTECODEIMPLEMENTATION_H
#define AIIR_BYTECODE_BYTECODEIMPLEMENTATION_H
...
public:
  ...
  virtual AIIRContext *getContext() const = 0;
...
template <typename T, typename... Ts>
auto get(AIIRContext *context, Ts &&...params) {
...
/// `getChecked(emitError, params...)` without a leading `AIIRContext*` (e.g.
...
#endif // AIIR_BYTECODE_BYTECODEIMPLEMENTATION_H
