//===- BytecodeWriter.h - AIIR Bytecode Writer ------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header defines interfaces to write AIIR bytecode files/streams.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_BYTECODE_BYTECODEWRITER_H
#define AIIR_BYTECODE_BYTECODEWRITER_H
...
/// A class to interact with the attributes and types printer when emitting AIIR
/// bytecode.
template <class T>
...
public:
  ...
  /// serialization.
  BytecodeWriterConfig(StringRef producer = "AIIR" LLVM_VERSION_STRING);
  ...
  BytecodeWriterConfig(FallbackAsmResourceMap &map,
                       StringRef producer = "AIIR" LLVM_VERSION_STRING);
...
#endif // AIIR_BYTECODE_BYTECODEWRITER_H
