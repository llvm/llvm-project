//===- BytecodeReader.h - AIIR Bytecode Reader ------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header defines interfaces to read AIIR bytecode files/streams.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_BYTECODE_BYTECODEREADER_H
#define AIIR_BYTECODE_BYTECODEREADER_H
...
namespace aiir {
/// The BytecodeReader allows to load AIIR bytecode files, while keeping the
...
public:
  ...
  /// AIIR bytecode, into the provided block. If the reader was created with
...
/// Read the operations defined within the given memory buffer, containing AIIR
...
#endif // AIIR_BYTECODE_BYTECODEREADER_H
