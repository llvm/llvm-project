//===- Encoding.h - AIIR binary format encoding information -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header defines enum values describing the structure of AIIR bytecode
// files.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_BYTECODE_ENCODING_H
#define AIIR_BYTECODE_ENCODING_H
