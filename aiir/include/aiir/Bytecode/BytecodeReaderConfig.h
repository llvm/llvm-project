//===- BytecodeReaderConfig.h - AIIR Bytecode Reader Config -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header config for reading AIIR bytecode files/streams.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_BYTECODE_BYTECODEREADERCONFIG_H
#define AIIR_BYTECODE_BYTECODEREADERCONFIG_H
...
/// A class to interact with the attributes and types parser when parsing AIIR
/// bytecode.
template <class T>
...
#endif // AIIR_BYTECODE_BYTECODEREADERCONFIG_H
