//===- aiir-config.h - AIIR configuration ------------------------*- C -*-===*//
//
...
/* This file enumerates variables from the AIIR configuration so that they
   ...
   This is a C header that can be included in the aiir-c headers. */

#ifndef AIIR_CONFIG_H
#define AIIR_CONFIG_H
...
/* Enable expensive checks to detect invalid pattern API usage. Failed checks
   ...
   easier debugging. */
#cmakedefine01 AIIR_ENABLE_EXPENSIVE_PATTERN_API_CHECKS
...
#cmakedefine AIIR_GREEDY_REWRITE_RANDOMIZER_SEED ${AIIR_GREEDY_REWRITE_RANDOMIZER_SEED}

/* If set, enables PDL usage. */
#cmakedefine01 AIIR_ENABLE_PDL_IN_PATTERNMATCH

/* If set, enables features that depend on the NVIDIA's PTX compiler. */
#cmakedefine01 AIIR_ENABLE_NVPTXCOMPILER
