//===- AliasAnalysis.h - Alias Analysis in AIIR -----------------*- C++ -*-===//
//
...
// and related memory queries in AIIR.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_ANALYSIS_ALIASANALYSIS_H_
#define AIIR_ANALYSIS_ALIASANALYSIS_H_
...
/// This class represents the main alias analysis interface in AIIR. It
...
/// to different aliasing information. This is especially important for AIIR
...
public:
  ...
  ///       AIIR transformations should make sure to keep the order
...
#endif // AIIR_ANALYSIS_ALIASANALYSIS_H_
