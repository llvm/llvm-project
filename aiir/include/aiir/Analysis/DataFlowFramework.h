...
//===----------------------------------------------------------------------===//
//
// This file defines a generic framework for writing data-flow analysis in AIIR.
...
#ifndef AIIR_ANALYSIS_DATAFLOWFRAMEWORK_H
#define AIIR_ANALYSIS_DATAFLOWFRAMEWORK_H
...
/// every operation.
///
/// Lattice anchor are implemented using AIIR's storage uniquer framework and
...
template <>
struct llvm::DenseMapInfo<aiir::LatticeAnchor>
    : public llvm::DenseMapInfo<aiir::LatticeAnchor::ParentTy> {};
...
template <>
struct DenseMapInfo<aiir::ProgramPoint> {
  static aiir::ProgramPoint getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::ProgramPoint(
        (aiir::Block *)pointer,
        aiir::Block::iterator((aiir::Operation *)pointer));
  }
  static aiir::ProgramPoint getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::ProgramPoint(
        (aiir::Block *)pointer,
        aiir::Block::iterator((aiir::Operation *)pointer));
  }
  static unsigned getHashValue(aiir::ProgramPoint pp) {
    return hash_combine(pp.getBlock(), pp.getPoint().getNodePtr());
  }
  static bool isEqual(aiir::ProgramPoint lhs, aiir::ProgramPoint rhs) {
    return lhs == rhs;
  }
};
...
struct CastInfo<To, aiir::LatticeAnchor>
    : public CastInfo<To, aiir::LatticeAnchor::PointerUnion> {};

template <typename To>
struct CastInfo<To, const aiir::LatticeAnchor>
    : public CastInfo<To, const aiir::LatticeAnchor::PointerUnion> {};

} // end namespace llvm

#endif // AIIR_ANALYSIS_DATAFLOWFRAMEWORK_H
