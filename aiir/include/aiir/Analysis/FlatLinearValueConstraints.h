...
#ifndef AIIR_ANALYSIS_FLATLINEARVALUECONSTRAINTS_H
#define AIIR_ANALYSIS_FLATLINEARVALUECONSTRAINTS_H
...
public:
  ...
  getConstantBoundOnDimSize(AIIRContext *context, unsigned pos,
  ...
  IntegerSet getAsIntegerSet(AIIRContext *context) const;
  ...
  void getSliceBounds(unsigned offset, unsigned num, AIIRContext *context,
  ...
  getLowerAndUpperBound(unsigned pos, unsigned offset, unsigned num,
                        ...
                        AIIRContext *context, bool closedUB = false) const;
...
protected:
  ...
  /// from AIIR integer sets, maps, or expressions where local vars were
...
#endif // AIIR_ANALYSIS_FLATLINEARVALUECONSTRAINTS_H
