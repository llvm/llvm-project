...
// However, since values are immutable in AIIR, a sparse analysis, which will
...
#ifndef AIIR_ANALYSIS_DATAFLOW_LIVENESSANALYSIS_H
#define AIIR_ANALYSIS_DATAFLOW_LIVENESSANALYSIS_H
...
struct Liveness : public AbstractSparseLattice {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(Liveness)
...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(RunLivenessAnalysis)
...
} // end namespace aiir::dataflow

#endif // AIIR_ANALYSIS_DATAFLOW_LIVENESSANALYSIS_H
