//===- Fraction.h - AIIR Fraction Class -------------------------*- C++ -*-===//
//
...
#ifndef AIIR_ANALYSIS_PRESBURGER_FRACTION_H
#define AIIR_ANALYSIS_PRESBURGER_FRACTION_H
...
#endif // AIIR_ANALYSIS_PRESBURGER_FRACTION_H
