...
#ifndef AIIR_ANALYSIS_PRESBURGER_GENERATINGFUNCTION_H
#define AIIR_ANALYSIS_PRESBURGER_GENERATINGFUNCTION_H

#include "aiir/Analysis/Presburger/Fraction.h"
...
#endif // AIIR_ANALYSIS_PRESBURGER_GENERATINGFUNCTION_H
