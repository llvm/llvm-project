//===- PWMAFunction.h - AIIR PWMAFunction Class------------------*- C++ -*-===//
//
...
#ifndef AIIR_ANALYSIS_PRESBURGER_PWMAFUNCTION_H
#define AIIR_ANALYSIS_PRESBURGER_PWMAFUNCTION_H
...
#endif // AIIR_ANALYSIS_PRESBURGER_PWMAFUNCTION_H
