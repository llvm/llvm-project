//===- PresburgerSpace.h - AIIR PresburgerSpace Class -----------*- C++ -*-===//
//
...
#ifndef AIIR_ANALYSIS_PRESBURGER_PRESBURGERSPACE_H
#define AIIR_ANALYSIS_PRESBURGER_PRESBURGERSPACE_H
...
#endif // AIIR_ANALYSIS_PRESBURGER_PRESBURGERSPACE_H
