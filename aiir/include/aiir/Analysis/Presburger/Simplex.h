//===- Simplex.h - AIIR Simplex Class ---------------------------*- C++ -*-===//
//
...
#ifndef AIIR_ANALYSIS_PRESBURGER_SIMPLEX_H
#define AIIR_ANALYSIS_PRESBURGER_SIMPLEX_H
...
#endif // AIIR_ANALYSIS_PRESBURGER_SIMPLEX_H
