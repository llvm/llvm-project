//===- IntegerRelation.h - AIIR IntegerRelation Class ---------*- C++ -*---===//
//
...
#ifndef AIIR_ANALYSIS_PRESBURGER_INTEGERRELATION_H
#define AIIR_ANALYSIS_PRESBURGER_INTEGERRELATION_H
...
#endif // AIIR_ANALYSIS_PRESBURGER_INTEGERRELATION_H
