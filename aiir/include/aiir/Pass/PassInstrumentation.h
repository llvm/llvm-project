...
#ifndef AIIR_PASS_PASSINSTRUMENTATION_H_
#define AIIR_PASS_PASSINSTRUMENTATION_H_
...
namespace llvm {
template <>
struct DenseMapInfo<aiir::PassInstrumentation::PipelineParentInfo> {
  using T = aiir::PassInstrumentation::PipelineParentInfo;
  using PairInfo = DenseMapInfo<std::pair<uint64_t, void *>>;

  static T getEmptyKey() {
    auto pair = PairInfo::getEmptyKey();
    return {pair.first, reinterpret_cast<aiir::Pass *>(pair.second)};
  }
...
#endif // AIIR_PASS_PASSINSTRUMENTATION_H_
