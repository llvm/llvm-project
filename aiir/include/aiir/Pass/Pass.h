...
#ifndef AIIR_PASS_PASS_H
#define AIIR_PASS_PASS_H
...
protected:
  ...
  /// Return the AIIR context for the current operation being transformed.
  AIIRContext &getContext() { return *getOperation()->getContext(); }
  ...
  virtual LogicalResult initialize(AIIRContext *context) { return success(); }
...
AIIR_DECLARE_EXPLICIT_TYPE_ID(::aiir::PassExecutionAction)

#endif // AIIR_PASS_PASS_H
