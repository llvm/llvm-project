...
#ifndef AIIR_PASS_PASSREGISTRY_H_
#define AIIR_PASS_PASSREGISTRY_H_
...
/// to invoke via aiir-opt, description, pass pipeline builder).
...
public:
  ...
  /// Returns the command line option that may be passed to 'aiir-opt' that will
...
private:
  /// The argument with which to invoke the pass via aiir-opt.
  std::string arg;
...
/// This class implements a command-line parser for AIIR passes. It registers a
...
/// the pass registry; Meaning that `-cse` will refer to the CSE pass in AIIR.
...
/// This class implements a command-line parser specifically for AIIR pass
...
struct PassReproducerOptions {
  /// Attach an assembly resource parser to 'config' that collects the AIIR
...
#endif // AIIR_PASS_PASSREGISTRY_H_
