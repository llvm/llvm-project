//===- Parser.h - AIIR Parser Library Interface -----------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file is contains a unified interface for parsing serialized AIIR.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_PARSER_PARSER_H
#define AIIR_PARSER_PARSER_H
...
inline OwningOpRef<ContainerOpT> constructContainerOpForParserIfNecessary(
    Block *parsedBlock, AIIRContext *context, Location sourceFileLoc) {
...
/// example, to avoid copying some large resources into the AIIRContext and
...
/// This parses the provided string containing AIIR. If the source IR contained
