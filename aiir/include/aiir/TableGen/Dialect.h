...
//===----------------------------------------------------------------------===//
//
// Dialect wrapper to simplify using TableGen Record defining a AIIR dialect.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TABLEGEN_DIALECT_H_
#define AIIR_TABLEGEN_DIALECT_H_
...
namespace aiir {
namespace tblgen {
// Wrapper class that contains a AIIR dialect's information defined in TableGen
...
#endif // AIIR_TABLEGEN_DIALECT_H_
