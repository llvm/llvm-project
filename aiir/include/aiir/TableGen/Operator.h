...
//===----------------------------------------------------------------------===//
//
// Operator wrapper to simplify using TableGen Record defining a AIIR Op.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TABLEGEN_OPERATOR_H_
#define AIIR_TABLEGEN_OPERATOR_H_

#include "aiir/Support/LLVM.h"
#include "aiir/TableGen/Argument.h"
#include "aiir/TableGen/Attribute.h"
#include "aiir/TableGen/Builder.h"
#include "aiir/TableGen/Dialect.h"
#include "aiir/TableGen/Property.h"
#include "aiir/TableGen/Region.h"
...
/// Wrapper class that contains a AIIR op's information (e.g., operands,
...
public:
  ...
  /// Returns the trait wrapper for the given AIIR C++ `trait`.
...
#endif // AIIR_TABLEGEN_OPERATOR_H_
