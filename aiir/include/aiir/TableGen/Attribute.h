...
//===----------------------------------------------------------------------===//
//
// Attribute wrapper to simplify using TableGen Record defining a AIIR
// Attribute.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TABLEGEN_ATTRIBUTE_H_
#define AIIR_TABLEGEN_ATTRIBUTE_H_
...
// Wrapper class providing helper methods for accessing AIIR Attribute defined
...
// Wrapper class providing helper methods for accessing AIIR constant attribute
...
#endif // AIIR_TABLEGEN_ATTRIBUTE_H_
