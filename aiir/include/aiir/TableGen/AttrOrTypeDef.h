...
// Record defining a AIIR attributes and types.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TABLEGEN_ATTRORTYPEDEF_H
#define AIIR_TABLEGEN_ATTRORTYPEDEF_H
...
public:
  ...
  /// Returns true if this builder is able to infer the AIIRContext parameter.
...
// represents a parameter of aiir::Type that is the value type of an AttrDef.
...
#endif // AIIR_TABLEGEN_ATTRORTYPEDEF_H
