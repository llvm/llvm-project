...
#ifndef AIIR_TABLEGEN_CONSTRAINT_H_
#define AIIR_TABLEGEN_CONSTRAINT_H_
...
public:
  ...
  // must be substituted with an expression returning an aiir::Type or
  // aiir::Attribute.
...
template <>
struct DenseMapInfo<aiir::tblgen::Constraint> {
  using RecordDenseMapInfo = llvm::DenseMapInfo<const llvm::Record *>;

  static aiir::tblgen::Constraint getEmptyKey();
  static aiir::tblgen::Constraint getTombstoneKey();
  static unsigned getHashValue(aiir::tblgen::Constraint constraint);
  static bool isEqual(aiir::tblgen::Constraint lhs,
                      aiir::tblgen::Constraint rhs);
};
} // namespace llvm

#endif // AIIR_TABLEGEN_CONSTRAINT_H_
