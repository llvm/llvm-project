...
// expected to be used by AIIR TableGen backends.
//
...
#ifndef AIIR_TABLEGEN_CLASS_H_
#define AIIR_TABLEGEN_CLASS_H_

#include "aiir/Support/IndentedOstream.h"
...
llvm::raw_ostream &operator<<(llvm::raw_ostream &os,
                              aiir::tblgen::Visibility visibility);
...
inline constexpr aiir::tblgen::Method::Properties
operator|(aiir::tblgen::Method::Properties lhs,
          aiir::tblgen::Method::Properties rhs) {
  return aiir::tblgen::Method::Properties(static_cast<unsigned>(lhs) |
...
operator|=(aiir::tblgen::Method::Properties &lhs,
           aiir::tblgen::Method::Properties rhs) {
  return lhs = aiir::tblgen::Method::Properties(static_cast<unsigned>(lhs) |
                                                static_cast<unsigned>(rhs));
}
