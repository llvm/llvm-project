...
#ifndef AIIR_TABLEGEN_PROPERTY_H_
#define AIIR_TABLEGEN_PROPERTY_H_
...
// Wrapper class providing helper methods for accessing AIIR Property defined
...
public:
  ...
  Property(const llvm::Record *maybeDef, StringRef summary,
           ...
           StringRef writeToAiirBytecodeCall, StringRef hashPropertyCall,
  ...
  // Returns the method call which parses this property from textual AIIR.
  ...
  // Returns the method call which prints this property to textual AIIR.
  ...
  StringRef getReadFromAiirBytecodeCall() const {
    return readFromAiirBytecodeCall;
  }

  // Returns the method call which write this property's
  // to the the bytecode.
  StringRef getWriteToAiirBytecodeCall() const {
    return writeToAiirBytecodeCall;
  }
...
#endif // AIIR_TABLEGEN_PROPERTY_H_
