...
#ifndef AIIR_BINDINGS_PYTHON_IRINTERFACES_H
#define AIIR_BINDINGS_PYTHON_IRINTERFACES_H
...
/// CRTP base class for Python classes representing AIIR Op interfaces.
...
public:
  ...
  PyConcreteOpInterface(nanobind::object object,
    ...
    if (operation != nullptr) {
      if (!aiirOperationImplementsInterface(*operation,
      ...
      AiirIdentifier identifier = aiirOperationGetName(*operation);
      AiirStringRef stringRef = aiirIdentifierStr(identifier);
      ...
      if (!aiirOperationImplementsInterfaceStatic(
              aiirStringRefCreate(opName.data(), opName.length()),
  ...
  static void bind(nanobind::module_ &m) {
    ...
    cls.def(nanobind::init<nanobind::object, DefaultingPyAiirContext>(),
            nanobind::arg("object"),
...
#endif // AIIR_BINDINGS_PYTHON_IRINTERFACES_H
