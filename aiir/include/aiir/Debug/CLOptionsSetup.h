...
#ifndef AIIR_DEBUG_CLOPTIONSSETUP_H
#define AIIR_DEBUG_CLOPTIONSSETUP_H
...
public:
  ...
  /// able to intercept AIIR Actions.
...
public:
  InstallDebugHandler(AIIRContext &context, const DebugConfig &config);
  ~InstallDebugHandler();
...
#endif // AIIR_DEBUG_CLOPTIONSSETUP_H
