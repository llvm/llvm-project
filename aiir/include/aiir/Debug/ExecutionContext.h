...
#ifndef AIIR_TRACING_EXECUTIONCONTEXT_H
#define AIIR_TRACING_EXECUTIONCONTEXT_H
...
/// acts as a handler in the AIIRContext for executing an Action. When an action
...
public:
  ...
  struct Observer {
    ...
    /// when AIIR multi-threading is enabled.
  ...
  /// Process the given action. This is the operator called by AIIRContext on
  /// `executeAction()`.
...
#endif // AIIR_TRACING_EXECUTIONCONTEXT_H
