//===- GPUCommonPass.h - AIIR GPU runtime support -------------------------===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_CONVERSION_GPUCOMMON_GPUCOMMONPASS_H_
#define AIIR_CONVERSION_GPUCOMMON_GPUCOMMONPASS_H_
...
#endif // AIIR_CONVERSION_GPUCOMMON_GPUCOMMONPASS_H_
