...
#ifndef AIIR_CONVERSION_ARITHCOMMON_ATTRTOLLVMCONVERTER_H
#define AIIR_CONVERSION_ARITHCOMMON_ATTRTOLLVMCONVERTER_H
...
getLLVMDefaultFPExceptionBehavior(AIIRContext &context);
...
public:
  AttrConvertOverflowToLLVM(SourceOp srcOp) {
    ...
    if (auto arithAttr = dyn_cast_if_present<arith::IntegerOverflowFlagsAttr>(
      ...
      // attribute.)
      AIIRContext *ctx = srcOp.getOperation()->getContext();
      Builder b(ctx);
...
#endif // AIIR_CONVERSION_ARITHCOMMON_ATTRTOLLVMCONVERTER_H
