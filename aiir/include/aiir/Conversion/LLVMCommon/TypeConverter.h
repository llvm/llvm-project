...
#ifndef AIIR_CONVERSION_LLVMCOMMON_TYPECONVERTER_H
#define AIIR_CONVERSION_LLVMCOMMON_TYPECONVERTER_H
...
public:
  ...
  LLVMTypeConverter(AIIRContext *ctx,
  ...
  LLVMTypeConverter(AIIRContext *ctx, const LowerToLLVMOptions &options,
                    const DataLayoutAnalysis *analysis = nullptr);
...
#endif // AIIR_CONVERSION_LLVMCOMMON_TYPECONVERTER_H
