...
#ifndef AIIR_CONVERSION_LLVMCOMMON_LOWERINGOPTIONS_H
#define AIIR_CONVERSION_LLVMCOMMON_LOWERINGOPTIONS_H
...
public:
  explicit LowerToLLVMOptions(AIIRContext *ctx);
  LowerToLLVMOptions(AIIRContext *ctx, const DataLayout &dl);
  ...
  // TODO: this should be replaced by AIIR data layout when one exists.
...
#endif // AIIR_CONVERSION_LLVMCOMMON_LOWERINGOPTIONS_H
