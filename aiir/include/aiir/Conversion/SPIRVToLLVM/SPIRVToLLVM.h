...
#ifndef AIIR_CONVERSION_SPIRVTOLLVM_SPIRVTOLLVM_H
#define AIIR_CONVERSION_SPIRVTOLLVM_SPIRVTOLLVM_H
...
public:
  SPIRVToLLVMConversion(AIIRContext *context,
...
#endif // AIIR_CONVERSION_SPIRVTOLLVM_SPIRVTOLLVM_H
