...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_CONVERSION_GPUTOROCDL_GPUTOROCDLPASS_H_
#define AIIR_CONVERSION_GPUTOROCDL_GPUTOROCDLPASS_H_

#include "aiir/Conversion/GPUToROCDL/Runtimes.h"
...
#endif // AIIR_CONVERSION_GPUTOROCDL_GPUTOROCDLPASS_H_
