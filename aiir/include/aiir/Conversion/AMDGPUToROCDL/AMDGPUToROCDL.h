...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_CONVERSION_AMDGPUTOROCDL_AMDGPUTOROCDL_H_
#define AIIR_CONVERSION_AMDGPUTOROCDL_AMDGPUTOROCDL_H_
...
#endif // AIIR_CONVERSION_AMDGPUTOROCDL_AMDGPUTOROCDL_H_
