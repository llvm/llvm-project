...
#ifndef AIIR_CONVERSION_MEMREFTOSPIRV_MEMREFTOSPIRV_H
#define AIIR_CONVERSION_MEMREFTOSPIRV_MEMREFTOSPIRV_H
...
getMemorySpaceToStorageClassTarget(AIIRContext &);
...
#endif // AIIR_CONVERSION_MEMREFTOSPIRV_MEMREFTOSPIRV_H
