...
#ifndef AIIR_SUPPORT_INDENTEDOSTREAM_H_
#define AIIR_SUPPORT_INDENTEDOSTREAM_H_
...
aiir::raw_indented_ostream::printReindented(StringRef str,
                                            StringRef extraPrefix) {
...
inline void aiir::raw_indented_ostream::write_impl(const char *ptr,
                                                   size_t size) {
...
#endif // AIIR_SUPPORT_INDENTEDOSTREAM_H_
