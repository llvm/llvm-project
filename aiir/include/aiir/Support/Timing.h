...
#ifndef AIIR_SUPPORT_TIMING_H
#define AIIR_SUPPORT_TIMING_H
...
/// default `DefaultTimingManager` implementation in AIIR. Implementations
...
///
/// This is AIIR's default implementation of a `TimingManager`. Prints an
