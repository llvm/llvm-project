//===- InterfaceSupport.h - AIIR Interface Support Classes ------*- C++ -*-===//
//
...
#ifndef AIIR_SUPPORT_INTERFACESUPPORT_H
#define AIIR_SUPPORT_INTERFACESUPPORT_H
...
template <typename T>
struct DenseMapInfo<T, std::enable_if_t<aiir::detail::IsInterface<T>::value>> {
