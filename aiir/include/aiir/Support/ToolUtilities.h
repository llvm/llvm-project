//===- ToolUtilities.h - AIIR Tool Utilities --------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares common utilities for implementing AIIR tools.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_SUPPORT_TOOLUTILITIES_H
#define AIIR_SUPPORT_TOOLUTILITIES_H
...
#endif // AIIR_SUPPORT_TOOLUTILITIES_H
