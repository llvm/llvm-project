//===- ADTExtras.h - Extra ADTs for use in AIIR -----------------*- C++ -*-===//
//
...
#ifndef AIIR_SUPPORT_ADTEXTRAS_H
#define AIIR_SUPPORT_ADTEXTRAS_H
...
// modification. This is for use in the aiir::<Type>::Builders.
template <typename T>
