...
// AIIR wants to use unqualified.
//
// Note that most of these are forward declared and then imported into the AIIR
...
#ifndef AIIR_SUPPORT_LLVM_H
#define AIIR_SUPPORT_LLVM_H

// We include this header because it cannot be practically forward
// declared, and are effectively language features.
#include "llvm/Support/Casting.h"

// We include this header because large portions of aiir would have to include
// it anyway.
