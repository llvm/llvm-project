//===- CodeComplete.h - AIIR Asm CodeComplete Context -----------*- C++ -*-===//
//
...
#ifndef AIIR_ASMPARSER_CODECOMPLETE_H
#define AIIR_ASMPARSER_CODECOMPLETE_H
...
/// language tooling for AIIR, general clients should not need to use this
/// class.
...
#endif // AIIR_ASMPARSER_CODECOMPLETE_H
