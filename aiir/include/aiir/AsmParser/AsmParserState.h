...
#ifndef AIIR_ASMPARSER_ASMPARSERSTATE_H
#define AIIR_ASMPARSER_ASMPARSERSTATE_H
...
/// This class represents state from a parsed AIIR textual format string. It is
/// useful for building additional analysis and language utilities on top of
/// textual AIIR. This should generally not be used for traditional compilation.
...
#endif // AIIR_ASMPARSER_ASMPARSERSTATE_H
