...
#ifndef AIIR_TARGET_SPIRV_SERIALIZATION_H
#define AIIR_TARGET_SPIRV_SERIALIZATION_H
...
/// reports errors to the error handler registered with the AIIR context for
/// `moduleOp`.
...
#endif // AIIR_TARGET_SPIRV_SERIALIZATION_H
