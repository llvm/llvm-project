//===- Export.h - AIIR to LLVM IR translation entry point -------*- C++ -*-===//
//
...
#ifndef AIIR_TARGET_LLVMIR_EXPORT_H
#define AIIR_TARGET_LLVMIR_EXPORT_H
...
#endif // AIIR_TARGET_LLVMIR_EXPORT_H
