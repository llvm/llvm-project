...
#ifndef AIIR_CAPI_EXECUTIONENGINE_H
#define AIIR_CAPI_EXECUTIONENGINE_H

#include "aiir-c/ExecutionEngine.h"
#include "aiir/CAPI/Wrap.h"
#include "aiir/ExecutionEngine/ExecutionEngine.h"

DEFINE_C_API_PTR_METHODS(AiirExecutionEngine, aiir::ExecutionEngine)

#endif // AIIR_CAPI_EXECUTIONENGINE_H
