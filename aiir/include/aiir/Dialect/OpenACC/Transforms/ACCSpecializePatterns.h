...
#ifndef AIIR_DIALECT_OPENACC_TRANSFORMS_ACCSPECIALIZEPATTERNS_H
#define AIIR_DIALECT_OPENACC_TRANSFORMS_ACCSPECIALIZEPATTERNS_H
...
#endif // AIIR_DIALECT_OPENACC_TRANSFORMS_ACCSPECIALIZEPATTERNS_H
