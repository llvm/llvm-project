...
#ifndef AIIR_DIALECT_UB_IR_UBMATCHERS_H
#define AIIR_DIALECT_UB_IR_UBMATCHERS_H
...
struct poison_attr_matcher {
  ...
  bool match(Operation *op) {
    Attribute attr;
    if (!::aiir::detail::constant_op_binder<Attribute>(&attr).match(op))
      return false;
    return match(attr);
  }
};
...
#endif // AIIR_DIALECT_UB_IR_UBMATCHERS_H
