...
//===----------------------------------------------------------------------===//
//
// This file defines op interfaces for the WasmSSA dialect in AIIR.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_DIALECT_WasmSSA_IR_WasmSSAINTERFACES_H_
#define AIIR_DIALECT_WasmSSA_IR_WasmSSAINTERFACES_H_
...
LogicalResult verifyLabelLevelInterfaceIsTerminator() {
  static_assert(OpType::template hasTrait<::aiir::OpTrait::IsTerminator>(),
...
#include "aiir/Dialect/WasmSSA/IR/WasmSSAInterfaces.h.inc"

#endif // AIIR_DIALECT_WasmSSA_IR_WasmSSAINTERFACES_H_
