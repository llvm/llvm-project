...
#ifndef AIIR_DIALECT_GPU_IR_COMPILATIONINTERFACES_H
#define AIIR_DIALECT_GPU_IR_COMPILATIONINTERFACES_H
...
/// `classof` method as well as using the macros `AIIR_*_EXPLICIT_TYPE_ID` to
...
public:
  SerializedObject(::aiir::SmallVector<char, 0> object,
...
AIIR_DECLARE_EXPLICIT_TYPE_ID(::aiir::gpu::TargetOptions)

#include "aiir/Dialect/GPU/IR/CompilationAttrInterfaces.h.inc"

#endif // AIIR_DIALECT_GPU_IR_COMPILATIONINTERFACES_H
