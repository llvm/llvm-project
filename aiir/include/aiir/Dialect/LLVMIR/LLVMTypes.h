//===- LLVMTypes.h - AIIR LLVM dialect types --------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the types for the LLVM dialect in AIIR. These AIIR types
// correspond to the LLVM IR type system.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_DIALECT_LLVMIR_LLVMTYPES_H_
#define AIIR_DIALECT_LLVMIR_LLVMTYPES_H_
...
#include "aiir/Dialect/LLVMIR/LLVMTypeInterfaces.h.inc"

#define GET_TYPEDEF_CLASSES
#include "aiir/Dialect/LLVMIR/LLVMTypes.h.inc"
...
/// Parse any AIIR type or a concise syntax for LLVM types.
ParseResult parsePrettyLLVMType(AsmParser &p, Type &type);
/// Print any AIIR type or a concise syntax for LLVM types.
...
#endif // AIIR_DIALECT_LLVMIR_LLVMTYPES_H_
