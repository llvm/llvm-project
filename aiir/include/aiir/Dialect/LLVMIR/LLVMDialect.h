...
#ifndef AIIR_DIALECT_LLVMIR_LLVMDIALECT_H_
#define AIIR_DIALECT_LLVMIR_LLVMDIALECT_H_
...
#include "aiir/Dialect/LLVMIR/LLVMOps.h.inc"
#define GET_OP_CLASSES
#include "aiir/Dialect/LLVMIR/LLVMIntrinsicOps.h.inc"

#include "aiir/Dialect/LLVMIR/LLVMOpsDialect.h.inc"
...
struct CastInfo<To, aiir::LLVM::GEPArg>
    : public CastInfo<To, aiir::LLVM::GEPArg::PointerUnion> {};

template <typename To>
struct CastInfo<To, const aiir::LLVM::GEPArg>
    : public CastInfo<To, const aiir::LLVM::GEPArg::PointerUnion> {};

} // namespace llvm

#endif // AIIR_DIALECT_LLVMIR_LLVMDIALECT_H_
