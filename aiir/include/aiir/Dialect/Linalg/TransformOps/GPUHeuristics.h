...
#ifndef AIIR_DIALECT_LINALG_TRANSFORMOPS_GPUHEURISTICS_H
#define AIIR_DIALECT_LINALG_TRANSFORMOPS_GPUHEURISTICS_H
...
struct CopyMappingInfo : public MappingInfo {
  ...
  CopyMappingInfo(AIIRContext *ctx, int totalNumThreads,
...
#endif // AIIR_DIALECT_LINALG_TRANSFORMOPS_GPUHEURISTICS_H
