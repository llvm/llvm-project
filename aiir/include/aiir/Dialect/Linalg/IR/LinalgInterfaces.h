...
#ifndef AIIR_DIALECT_LINALG_IR_LINALGINTERFACES_H_
#define AIIR_DIALECT_LINALG_IR_LINALGINTERFACES_H_
...
bool isContractionBody(Block &block,
                       ...
                       llvm::raw_ostream &errs = aiir::thread_safe_nulls());
...
#include "aiir/Dialect/Linalg/IR/LinalgInterfaces.h.inc"

/// Include the generated relayout interface declarations.
#include "aiir/Dialect/Linalg/IR/RelayoutOpInterface.h.inc"

#endif // AIIR_DIALECT_LINALG_IR_LINALGINTERFACES_H_
