...
#ifndef AIIR_DIALECT_LINALG_TRANSFORMS_TRANSFORMS_H
#define AIIR_DIALECT_LINALG_TRANSFORMS_TRANSFORMS_H
...
struct LinalgSpecializationPattern : public OpRewritePattern<GenericOp> {
  ...
  LinalgSpecializationPattern(
      AIIRContext *context, const GenericOpSpecializationOptions &options = {},
...
struct DecomposePadOpPattern : public OpRewritePattern<tensor::PadOp> {
  DecomposePadOpPattern(AIIRContext *context, PatternBenefit benefit = 1)
...
struct ExtractSliceOfPadTensorSwapPattern
  ...
  ExtractSliceOfPadTensorSwapPattern(AIIRContext *context,
...
#endif // AIIR_DIALECT_LINALG_TRANSFORMS_TRANSFORMS_H
