...
#ifndef AIIR_DIALECT_FUNC_UTILS_H
#define AIIR_DIALECT_FUNC_UTILS_H
...
aiir::FailureOr<aiir::func::FuncOp> replaceFuncWithNewMapping(
    aiir::RewriterBase &rewriter, aiir::func::FuncOp funcOp,
...
aiir::func::CallOp replaceCallOpWithNewMapping(
    aiir::RewriterBase &rewriter, aiir::func::CallOp callOp,
    ArrayRef<int> oldArgIdxToNewArgIdx, ArrayRef<int> oldResIdxToNewResIdx);
...
aiir::FailureOr<std::pair<aiir::func::FuncOp, aiir::func::CallOp>>
deduplicateArgsOfFuncOp(aiir::RewriterBase &rewriter, aiir::func::FuncOp funcOp,
                        aiir::ModuleOp moduleOp);
...
#endif // AIIR_DIALECT_FUNC_UTILS_H
