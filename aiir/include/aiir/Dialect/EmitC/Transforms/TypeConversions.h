...
#ifndef AIIR_DIALECT_EMITC_TRANSFORMS_TYPECONVERSIONS_H
#define AIIR_DIALECT_EMITC_TRANSFORMS_TYPECONVERSIONS_H
...
#endif // AIIR_DIALECT_EMITC_TRANSFORMS_TYPECONVERSIONS_H
