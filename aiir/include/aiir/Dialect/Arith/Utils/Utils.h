...
#ifndef AIIR_DIALECT_ARITH_UTILS_UTILS_H
#define AIIR_DIALECT_ARITH_UTILS_UTILS_H
...
// floating-point type.
FloatType parseFloatType(AIIRContext *ctx, StringRef name);

} // namespace arith
} // namespace aiir

#endif // AIIR_DIALECT_ARITH_UTILS_UTILS_H
