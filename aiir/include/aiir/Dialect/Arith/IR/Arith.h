...
#ifndef AIIR_DIALECT_ARITH_IR_ARITH_H_
#define AIIR_DIALECT_ARITH_IR_ARITH_H_
...
#include "aiir/Dialect/Arith/IR/ArithOpsDialect.h.inc"

//===----------------------------------------------------------------------===//
// Arith Dialect Enum Attributes
//===----------------------------------------------------------------------===//

#include "aiir/Dialect/Arith/IR/ArithOpsEnums.h.inc"
#define GET_ATTRDEF_CLASSES
#include "aiir/Dialect/Arith/IR/ArithOpsAttributes.h.inc"

//===----------------------------------------------------------------------===//
// Arith Interfaces
//===----------------------------------------------------------------------===//
#include "aiir/Dialect/Arith/IR/ArithOpsInterfaces.h.inc"
...
#include "aiir/Dialect/Arith/IR/ArithOps.h.inc"
...
public:
  ...
  static ::aiir::TypeID resolveTypeID() { return TypeID::get<ConstantOp>(); }
...
#endif // AIIR_DIALECT_ARITH_IR_ARITH_H_
