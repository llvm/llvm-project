...
#ifndef AIIR_DIALECT_SCF_UTILS_UTILS_H_
#define AIIR_DIALECT_SCF_UTILS_UTILS_H_
...
getConstLoopBounds(aiir::LoopLikeOpInterface loopOp);
...
getConstLoopTripCounts(aiir::LoopLikeOpInterface loopOp);

} // namespace aiir

#endif // AIIR_DIALECT_SCF_UTILS_UTILS_H_
