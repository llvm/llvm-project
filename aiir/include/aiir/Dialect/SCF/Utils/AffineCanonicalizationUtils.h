...
#ifndef AIIR_DIALECT_SCF_UTILS_AFFINECANONICALIZATIONUTILS_H_
#define AIIR_DIALECT_SCF_UTILS_AFFINECANONICALIZATIONUTILS_H_
...
#endif // AIIR_DIALECT_SCF_UTILS_AFFINECANONICALIZATIONUTILS_H_
