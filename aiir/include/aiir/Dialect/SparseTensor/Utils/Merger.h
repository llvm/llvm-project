...
#ifndef AIIR_DIALECT_SPARSETENSOR_UTILS_MERGER_H_
#define AIIR_DIALECT_SPARSETENSOR_UTILS_MERGER_H_
...
/// Tensor expression. Represents an AIIR expression in tensor index notation.
...
#endif // AIIR_DIALECT_SPARSETENSOR_UTILS_MERGER_H_
