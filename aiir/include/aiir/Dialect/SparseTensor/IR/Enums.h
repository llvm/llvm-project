...
//===----------------------------------------------------------------------===//
//
// Typedefs and enums shared between AIIR code for manipulating the
...
// runtime library itself, this file must not depend on any AIIR internals
// (e.g., operators, attributes, ArrayRefs, etc) lest the runtime library
// inherit those dependencies.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_DIALECT_SPARSETENSOR_IR_ENUMS_H
#define AIIR_DIALECT_SPARSETENSOR_IR_ENUMS_H

// NOTE: Client code will need to include "aiir/ExecutionEngine/Float16bits.h"
// if they want to use the `AIIR_SPARSETENSOR_FOREVERY_V` macro.
...
/// This type is used in the public API at all places where AIIR expects
...
#define AIIR_SPARSETENSOR_FOREVERY_FIXED_O(DO)                                 \
  DO(64, uint64_t)                                                             \
  DO(32, uint32_t)                                                             \
  DO(16, uint16_t)                                                             \
  DO(8, uint8_t)
...
#define AIIR_SPARSETENSOR_FOREVERY_V(DO)                                       \
  DO(F64, double)                                                              \
  DO(F32, float)                                                               \
  DO(F16, f16)                                                                 \
  DO(BF16, bf16)                                                               \
...
#define AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, ...)                              \
...
#define AIIR_SPARSETENSOR_FOREVERY_V_O(DO)                                     \
  AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, 64, uint64_t)                           \
  AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, 32, uint32_t)                           \
  AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, 16, uint16_t)                           \
  AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, 8, uint8_t)                             \
  AIIR_SPARSETENSOR_FOREVERY_V_VAR(DO, 0, index_type)
...
inline std::string toAIIRString(LevelType lt) { return lt.toAIIRString(); }
...
#endif // AIIR_DIALECT_SPARSETENSOR_IR_ENUMS_H
