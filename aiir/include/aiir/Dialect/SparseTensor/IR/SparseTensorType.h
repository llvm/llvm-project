...
#ifndef AIIR_DIALECT_SPARSETENSOR_IR_SPARSETENSORTYPE_H_
#define AIIR_DIALECT_SPARSETENSOR_IR_SPARSETENSORTYPE_H_
...
public:
  ...
  AIIRContext *getContext() const { return rtp.getContext(); }
  ...
  /// Returns the coordinate-overhead AIIR type, defaulting to `IndexType`.
  Type getCrdType() const { return enc.getCrdElemType(); }

  /// Returns the position-overhead AIIR type, defaulting to `IndexType`.
...
#endif // AIIR_DIALECT_SPARSETENSOR_IR_SPARSETENSORTYPE_H_
