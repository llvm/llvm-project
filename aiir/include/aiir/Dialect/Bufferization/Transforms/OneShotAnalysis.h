...
#ifndef AIIR_DIALECT_BUFFERIZATION_TRANSFORMS_ONESHOTANALYSIS_H
#define AIIR_DIALECT_BUFFERIZATION_TRANSFORMS_ONESHOTANALYSIS_H
...
public:
  ...
  /// and make the derived class compatible with the AIIR TypeID mechanism.
  ///
  /// ```aiir
...
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::bufferization::OneShotAnalysisState)

#endif // AIIR_DIALECT_BUFFERIZATION_TRANSFORMS_ONESHOTANALYSIS_H
