...
#ifndef AIIR_DIALECT_BUFFERIZATION_IR_BUFFERIZABLEOPINTERFACE_H_
#define AIIR_DIALECT_BUFFERIZATION_IR_BUFFERIZABLEOPINTERFACE_H_
...
#include "aiir/Dialect/Bufferization/IR/BufferizationEnums.h.inc"
...
public:
  ...
  /// The logic defers to `aiir::insideMutuallyExclusiveRegions`, but the
  /// result is cached.
...
/// propagated i.e. asMemRefType(aiir::failure()) returns aiir::failure().
...
AIIR_DECLARE_EXPLICIT_TYPE_ID(aiir::bufferization::AnalysisState)

//===----------------------------------------------------------------------===//
// Bufferization Interfaces
//===----------------------------------------------------------------------===//

#include "aiir/Dialect/Bufferization/IR/BufferizableOpInterface.h.inc"

#endif // AIIR_DIALECT_BUFFERIZATION_IR_BUFFERIZABLEOPINTERFACE_H_
