...
#ifndef AIIR_DIALECT_UTILS_INDEXINGUTILS_H
#define AIIR_DIALECT_UTILS_INDEXINGUTILS_H
...
/// Self-explicit.
AffineExpr computeSum(AIIRContext *ctx, ArrayRef<AffineExpr> basis);

/// Self-explicit.
AffineExpr computeProduct(AIIRContext *ctx, ArrayRef<AffineExpr> basis);
...
inline AffineExpr computeMaxLinearIndex(AIIRContext *ctx,
...
///
/// `basis` elements are expected to bind to non-negative values.
AffineExpr linearize(AIIRContext *ctx, ArrayRef<AffineExpr> offsets,
                     ArrayRef<AffineExpr> basis);
AffineExpr linearize(AIIRContext *ctx, ArrayRef<AffineExpr> offsets,
...
#endif // AIIR_DIALECT_UTILS_INDEXINGUTILS_H
