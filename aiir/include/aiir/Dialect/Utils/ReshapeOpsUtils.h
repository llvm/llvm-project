...
#ifndef AIIR_DIALECT_UTILS_RESHAPEOPSUTILS_H
#define AIIR_DIALECT_UTILS_RESHAPEOPSUTILS_H
...
public:
  ...
  SmallVector<Range> getExtractSliceParams(AIIRContext *ctx,
  ...
  SmallVector<Range> getInsertSliceParams(AIIRContext *ctx,
...
#endif // AIIR_DIALECT_UTILS_RESHAPEOPSUTILS_H
