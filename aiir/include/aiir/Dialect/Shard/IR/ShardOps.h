...
#ifndef AIIR_DIALECT_SHARD_IR_SHARDOPS_H
#define AIIR_DIALECT_SHARD_IR_SHARDOPS_H
...
#include "aiir/Dialect/Shard/IR/ShardEnums.h.inc"

#define GET_ATTRDEF_CLASSES
#include "aiir/Dialect/Shard/IR/ShardAttributes.h.inc"
...
public:
  Sharding(::aiir::FlatSymbolRefAttr grid_ = nullptr);
  Sharding(Value rhs);
  static Sharding get(::aiir::FlatSymbolRefAttr grid_,
  ...
  ::aiir::FlatSymbolRefAttr getGridAttr() const { return grid; }
...
#include "aiir/Dialect/Shard/IR/ShardTypes.h.inc"

#define GET_OP_CLASSES
#include "aiir/Dialect/Shard/IR/ShardOps.h.inc"
...
#endif // AIIR_DIALECT_SHARD_IR_SHARDOPS_H
