...
#ifndef AIIR_DIALECT_VECTOR_TRANSFORMS_LOWERINGPATTERNS_H
#define AIIR_DIALECT_VECTOR_TRANSFORMS_LOWERINGPATTERNS_H
...
#endif // AIIR_DIALECT_VECTOR_TRANSFORMS_LOWERINGPATTERNS_H
