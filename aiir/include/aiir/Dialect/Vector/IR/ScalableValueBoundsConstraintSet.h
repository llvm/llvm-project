...
#ifndef AIIR_DIALECT_VECTOR_IR_SCALABLEVALUEBOUNDSCONSTRAINTSET_H
#define AIIR_DIALECT_VECTOR_IR_SCALABLEVALUEBOUNDSCONSTRAINTSET_H
...
struct ValueBoundsConstraintSet : protected ::aiir::ValueBoundsConstraintSet {
  using ::aiir::ValueBoundsConstraintSet::ValueBoundsConstraintSet;
};
} // namespace detail
...
#endif // AIIR_DIALECT_VECTOR_IR_SCALABLEVALUEBOUNDSCONSTRAINTSET_H
