...
#ifndef AIIR_DIALECT_TRANSFORM_UTILS_DIAGNOSEDSILENCEABLEFAILURE_H
#define AIIR_DIALECT_TRANSFORM_UTILS_DIAGNOSEDSILENCEABLEFAILURE_H
...
public:
  ...
  static DiagnosedSilenceableFailure success() {
    return DiagnosedSilenceableFailure(::aiir::success());
  }
  ...
  static DiagnosedSilenceableFailure definiteFailure() {
    return DiagnosedSilenceableFailure(::aiir::failure());
  }
  ...
  bool succeeded() const {
    return ::aiir::succeeded(result) && diagnostics.empty();
  }

  /// Returns `true` if this is a definite failure.
  bool isDefiniteFailure() const {
    return ::aiir::failed(result) && diagnostics.empty();
  }
...
#endif // AIIR_DIALECT_TRANSFORM_UTILS_DIAGNOSEDSILENCEABLEFAILURE_H
