...
#ifndef AIIR_DIALECT_TRANSFORM_INTERFACES_TRANSFORMINTERFACES_H
#define AIIR_DIALECT_TRANSFORM_INTERFACES_TRANSFORMINTERFACES_H

#include "aiir/Dialect/Transform/Utils/DiagnosedSilenceableFailure.h"
#include "aiir/Dialect/Transform/Utils/RaggedArray.h"
#include "aiir/IR/OpDefinition.h"
#include "aiir/IR/PatternMatch.h"
#include "aiir/Interfaces/SideEffectInterfaces.h"
#include "aiir/Transforms/DialectConversion.h"

#include "aiir/Dialect/Transform/Interfaces/TransformTypeInterfaces.h.inc"
...
#include "aiir/Dialect/Transform/Interfaces/TransformInterfaces.h.inc"
...
public:
  ...
  /// derived class compatible with the AIIR TypeID mechanism:
  ///
  /// ```aiir
...
protected:
  ...
  explicit TransformRewriter(AIIRContext *ctx,
...
aiir::transform::TransformEachOpTrait<OpTy>::apply(
...
template <typename OpTy>
llvm::LogicalResult
aiir::transform::TransformEachOpTrait<OpTy>::verifyTrait(Operation *op) {
