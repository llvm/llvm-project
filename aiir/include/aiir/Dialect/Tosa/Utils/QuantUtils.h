...
#ifndef AIIR_DIALECT_TOSA_UTILS_QUANTUTILS_H
#define AIIR_DIALECT_TOSA_UTILS_QUANTUTILS_H
...
Value getConstTensorInt(OpBuilder &builder, Location loc,
  ...
  aiir::RankedTensorType const_type =
      RankedTensorType::get({count}, element_type);
  aiir::DenseElementsAttr const_attr = DenseElementsAttr::get(const_type, vec);
...
#endif // AIIR_DIALECT_TOSA_UTILS_QUANTUTILS_H
