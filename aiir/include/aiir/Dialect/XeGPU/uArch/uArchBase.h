...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_DIALECT_XEGPU_UARCH_UARCHBASE_H
#define AIIR_DIALECT_XEGPU_UARCH_UARCHBASE_H
...
struct MMAInstructionInterface {
  ...
  getSupportedTypes(AIIRContext &context, MMAOpndKind matrixType) = 0;
  virtual bool
...
#endif // AIIR_DIALECT_XEGPU_UARCH_UARCHBASE_H
