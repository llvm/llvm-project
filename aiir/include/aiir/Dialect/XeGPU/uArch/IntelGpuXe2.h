...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_DIALECT_XEGPU_UARCH_INTELGPUXE2_H
#define AIIR_DIALECT_XEGPU_UARCH_INTELGPUXE2_H
...
using namespace aiir::xegpu::uArch;
...
struct SubgroupMatrixMultiplyAcc : public Instruction,
  ...
  getSupportedTypes(AIIRContext &context, MMAOpndKind matrixType) override;
  virtual bool
...
SubgroupMatrixMultiplyAcc::getSupportedTypes(AIIRContext &context,
                                             MMAOpndKind matrixType) {
...
#endif // AIIR_DIALECT_XEGPU_UARCH_INTELGPUXE2_H
