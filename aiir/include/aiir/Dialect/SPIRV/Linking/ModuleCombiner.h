//===- ModuleCombiner.h - AIIR SPIR-V Module Combiner -----------*- C++ -*-===//
//
...
#ifndef AIIR_DIALECT_SPIRV_LINKING_MODULECOMBINER_H_
#define AIIR_DIALECT_SPIRV_LINKING_MODULECOMBINER_H_
...
#endif // AIIR_DIALECT_SPIRV_LINKING_MODULECOMBINER_H_
