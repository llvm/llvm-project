//===- SPIRVEnums.h - AIIR SPIR-V Enums -------------------------*- C++ -*-===//
//
...
#ifndef AIIR_DIALECT_SPIRV_IR_SPIRVENUMS_H_
#define AIIR_DIALECT_SPIRV_IR_SPIRVENUMS_H_
...
#include "aiir/Dialect/SPIRV/IR/SPIRVEnums.h.inc"

// Pull in all enum type availability query function declarations
#include "aiir/Dialect/SPIRV/IR/SPIRVEnumAvailability.h.inc"
...
/// representation for use in AIIR attributes.
std::string getDecorationString(Decoration decoration);

} // namespace spirv
} // namespace aiir

#endif // AIIR_DIALECT_SPIRV_IR_SPIRVENUMS_H_
