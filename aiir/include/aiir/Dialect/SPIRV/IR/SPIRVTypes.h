//===- SPIRVTypes.h - AIIR SPIR-V Types -------------------------*- C++ -*-===//
//
...
#ifndef AIIR_DIALECT_SPIRV_IR_SPIRVTYPES_H_
#define AIIR_DIALECT_SPIRV_IR_SPIRVTYPES_H_
...
/// };
///
/// would be represented in AIIR as:
///
...
public:
  ...
  static StructType getIdentified(AIIRContext *context, StringRef identifier);
  ...
  static StructType getEmpty(AIIRContext *context, StringRef identifier = "");
...
#endif // AIIR_DIALECT_SPIRV_IR_SPIRVTYPES_H_
