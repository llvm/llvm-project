...
#ifndef AIIR_DIALECT_SPIRV_IR_TARGETANDABI_H
#define AIIR_DIALECT_SPIRV_IR_TARGETANDABI_H
...
public:
  ...
  /// Returns the AIIRContext.
  AIIRContext *getContext() const;
...
EntryPointABIAttr getEntryPointABIAttr(AIIRContext *context,
...
ResourceLimitsAttr getDefaultResourceLimits(AIIRContext *context);
...
TargetEnvAttr getDefaultTargetEnv(AIIRContext *context);
...
#endif // AIIR_DIALECT_SPIRV_IR_TARGETANDABI_H
