//===-- MMAUtils.h - AIIR NVGPU dialect utilities for MMA operations-------===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_DIALECT_NVGPU_UTILS_MMAUTILS_H
#define AIIR_DIALECT_NVGPU_UTILS_MMAUTILS_H
...
#endif // AIIR_DIALECT_NVGPU_UTILS_MMAUTILS_H
