...
#ifndef AIIR_DIALECT_AFFINE_LOOPUTILS_H
#define AIIR_DIALECT_AFFINE_LOOPUTILS_H
...
/// Explicit copy / DMA generation options for aiir::affineDataCopyGenerate.
...
#endif // AIIR_DIALECT_AFFINE_LOOPUTILS_H
