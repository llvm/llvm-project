...
#ifndef AIIR_DIALECT_AFFINE_UTILS_H
#define AIIR_DIALECT_AFFINE_UTILS_H
...
/// (aiir::isLoopParallel can be used to detect a parallel affine.for op.) The
...
#endif // AIIR_DIALECT_AFFINE_UTILS_H
