...
#ifndef AIIR_DIALECT_AFFINE_ANALYSIS_UTILS_H
#define AIIR_DIALECT_AFFINE_ANALYSIS_UTILS_H
...
aiir::Block *findInnermostCommonBlockInScope(aiir::Operation *a,
                                             aiir::Operation *b);

} // namespace affine
} // namespace aiir

#endif // AIIR_DIALECT_AFFINE_ANALYSIS_UTILS_H
