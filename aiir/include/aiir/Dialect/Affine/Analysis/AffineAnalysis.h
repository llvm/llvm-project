...
#ifndef AIIR_DIALECT_AFFINE_ANALYSIS_AFFINEANALYSIS_H
#define AIIR_DIALECT_AFFINE_ANALYSIS_AFFINEANALYSIS_H
...
struct MemRefAccess {
  ...
  /// reference. For example, given the AIIR code:
  ///
  ...
  /// aiir::getIndexSet and aiir::getRelationFromMap for these cases).
...
#endif // AIIR_DIALECT_AFFINE_ANALYSIS_AFFINEANALYSIS_H
