//===- AffineValueMap.h - AIIR Affine Value Map Class -----------*- C++ -*-===//
//
...
#ifndef AIIR_DIALECT_AFFINE_IR_AFFINEVALUEMAP_H
#define AIIR_DIALECT_AFFINE_IR_AFFINEVALUEMAP_H
...
#endif // AIIR_DIALECT_AFFINE_IR_AFFINEVALUEMAP_H
