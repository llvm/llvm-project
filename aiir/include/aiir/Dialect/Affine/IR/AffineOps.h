//===- AffineOps.h - AIIR Affine Operations -------------------------------===//
//
...
// in the AIIR operation set.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_DIALECT_AFFINE_IR_AFFINEOPS_H
#define AIIR_DIALECT_AFFINE_IR_AFFINEOPS_H
...
#include "aiir/Dialect/Affine/IR/AffineOpsDialect.h.inc"

#define GET_OP_CLASSES
#include "aiir/Dialect/Affine/IR/AffineOps.h.inc"
