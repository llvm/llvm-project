...
#ifndef AIIR_DIALECT_QUANT_UTILS_FAKEQUANTSUPPORT_H_
#define AIIR_DIALECT_QUANT_UTILS_FAKEQUANTSUPPORT_H_
...
#endif // AIIR_DIALECT_QUANT_UTILS_FAKEQUANTSUPPORT_H_
