...
#ifndef AIIR_DIALECT_IRDL_IR_IRDLTRAITS_H_
#define AIIR_DIALECT_IRDL_IR_IRDLTRAITS_H_
...
public:
  ...
  public:
    static LogicalResult verifyTrait(Operation *op) {
      static_assert(
          ConcreteType::template hasTrait<::aiir::OpTrait::OneRegion>(),
...
#endif // AIIR_DIALECT_IRDL_IR_IRDLTRAITS_H_
