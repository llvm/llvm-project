...
#ifndef AIIR_DIALECT_IRDL_IRDLVERIFIERS_H
#define AIIR_DIALECT_IRDL_IRDLVERIFIERS_H
...
/// `TypeAttr` attribute happens before conversion, at the AIIR level.
class Constraint {
public:
...
struct RegionConstraint {
  ...
  /// constraints.
  LogicalResult verify(aiir::Region &region,
...
#endif // AIIR_DIALECT_IRDL_IRDLVERIFIERS_H
