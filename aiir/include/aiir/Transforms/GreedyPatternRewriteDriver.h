...
#ifndef AIIR_TRANSFORMS_GREEDYPATTERNREWRITEDRIVER_H_
#define AIIR_TRANSFORMS_GREEDYPATTERNREWRITEDRIVER_H_
...
#endif // AIIR_TRANSFORMS_GREEDYPATTERNREWRITEDRIVER_H_
