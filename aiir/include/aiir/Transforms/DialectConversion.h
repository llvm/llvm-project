//===- DialectConversion.h - AIIR dialect conversion pass -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares a generic pass for converting between AIIR dialects.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_TRANSFORMS_DIALECTCONVERSION_H_
#define AIIR_TRANSFORMS_DIALECTCONVERSION_H_
...
public:
  ...
  OpConversionPattern(AIIRContext *context, PatternBenefit benefit = 1)
      : ConversionPattern(SourceOp::getOperationName(), benefit, context) {}
  OpConversionPattern(const TypeConverter &typeConverter, AIIRContext *context,
...
public:
  ...
  OpInterfaceConversionPattern(AIIRContext *context, PatternBenefit benefit = 1)
...
public:
  ...
  OpTraitConversionPattern(AIIRContext *context, PatternBenefit benefit = 1)
...
private:
  ...
  explicit ConversionPatternRewriter(AIIRContext *ctx,
...
public:
  ...
  ConversionTarget(AIIRContext &ctx) : ctx(ctx) {}
...
struct ConversionConfig {
  ...
  /// `-DAIIR_ENABLE_EXPENSIVE_PATTERN_API_CHECKS=ON` (ideally together with
...
#endif // AIIR_TRANSFORMS_DIALECTCONVERSION_H_
