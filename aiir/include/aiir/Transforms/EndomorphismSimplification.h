...
#ifndef AIIR_TRANSFORMS_SIMPLIFY_ENDOMORPHISM_H_
#define AIIR_TRANSFORMS_SIMPLIFY_ENDOMORPHISM_H_

#include "aiir/Transforms/HomomorphismSimplification.h"
...
#endif // AIIR_TRANSFORMS_SIMPLIFY_ENDOMORPHISM_H_
