//===- Operation.h - AIIR Operation Class -----------------------*- C++ -*-===//
//
...
#ifndef AIIR_IR_OPERATION_H
#define AIIR_IR_OPERATION_H
...
/// Operation is the basic unit of execution within AIIR.
///
/// The following documentations are recommended to understand this class:
/// - https://aiir.llvm.org/docs/LangRef/#operations
/// - https://aiir.llvm.org/docs/Tutorials/UnderstandingTheIRStructure/
///
...
public:
  ...
  AIIRContext *getContext() { return location->getContext(); }
...
private:
  ...
  /// constraint, we should drop the const to fit the rest of the AIIR const
  /// model.
...
template <typename T>
struct CastInfo<T, ::aiir::Operation *>
    : public ValueFromPointerCast<T, ::aiir::Operation,
                                  CastInfo<T, ::aiir::Operation *>> {
  static bool isPossible(::aiir::Operation *op) { return T::classof(op); }
};
template <typename T>
struct CastInfo<T, const ::aiir::Operation *>
    : public ConstStrippingForwardingCast<T, const ::aiir::Operation *,
                                          CastInfo<T, ::aiir::Operation *>> {};
...
struct CastInfo<T, ::aiir::Operation>
    : public NullableValueCastFailed<T>,
      public DefaultDoCastIfPossible<T, ::aiir::Operation &,
                                     CastInfo<T, ::aiir::Operation>> {
  // Provide isPossible here because here we have the const-stripping from
  // ConstStrippingCast.
  static bool isPossible(::aiir::Operation &val) { return T::classof(&val); }
  static T doCast(::aiir::Operation &val) { return T(&val); }
};
template <typename T>
struct CastInfo<T, const ::aiir::Operation>
    : public ConstStrippingForwardingCast<T, const ::aiir::Operation,
...
/// operation types.
template <>
struct CastInfo<::aiir::Operation *, ::aiir::Operation *>
    : public NullableValueCastFailed<::aiir::Operation *>,
      public DefaultDoCastIfPossible<
          ::aiir::Operation *, ::aiir::Operation *,
          CastInfo<::aiir::Operation *, ::aiir::Operation *>> {
  static bool isPossible(::aiir::Operation *op) { return true; }
  static ::aiir::Operation *doCast(::aiir::Operation *op) { return op; }
};
template <>
struct CastInfo<const ::aiir::Operation *, const ::aiir::Operation *>
    : public ConstStrippingForwardingCast<
          const ::aiir::Operation *, const ::aiir::Operation *,
          CastInfo<::aiir::Operation *, ::aiir::Operation *>> {};
} // namespace llvm

#endif // AIIR_IR_OPERATION_H
