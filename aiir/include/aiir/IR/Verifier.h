//===- Verifier.h - Verifier analysis for AIIR structures -------*- C++ -*-===//
//
...
#ifndef AIIR_IR_VERIFIER_H
#define AIIR_IR_VERIFIER_H
...
/// reports the error through the AIIRContext and returns failure. If
