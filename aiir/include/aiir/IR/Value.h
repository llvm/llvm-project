...
#ifndef AIIR_IR_VALUE_H
#define AIIR_IR_VALUE_H

#include "aiir/IR/Types.h"
#include "aiir/IR/UseDefLists.h"
...
/// This class represents an instance of an SSA value in the AIIR system,
...
public:
  ...
  /// Utility to get the associated AIIRContext that this value is defined in.
  AIIRContext *getContext() const { return getType().getContext(); }
...
template <typename Ty, typename Value = aiir::Value>
/// If Ty is aiir::Type this will select `Value` instead of having a wrapper
/// around it. This helps resolve ambiguous conversion issues.
using TypedValue = std::conditional_t<std::is_same_v<Ty, aiir::Type>,
                                      aiir::Value, detail::TypedValue<Ty>>;
...
template <>
struct DenseMapInfo<aiir::Value> {
  static aiir::Value getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::Value::getFromOpaquePointer(pointer);
  }
  static aiir::Value getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::Value::getFromOpaquePointer(pointer);
  }
  static unsigned getHashValue(aiir::Value val) {
    return aiir::hash_value(val);
  }
  static bool isEqual(aiir::Value lhs, aiir::Value rhs) { return lhs == rhs; }
};
template <>
struct DenseMapInfo<aiir::BlockArgument> : public DenseMapInfo<aiir::Value> {
  static aiir::BlockArgument getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return reinterpret_cast<aiir::detail::BlockArgumentImpl *>(pointer);
  }
  static aiir::BlockArgument getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return reinterpret_cast<aiir::detail::BlockArgumentImpl *>(pointer);
  }
};
template <>
struct DenseMapInfo<aiir::OpResult> : public DenseMapInfo<aiir::Value> {
  static aiir::OpResult getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return reinterpret_cast<aiir::detail::OpResultImpl *>(pointer);
  }
  static aiir::OpResult getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return reinterpret_cast<aiir::detail::OpResultImpl *>(pointer);
  }
};
template <typename T>
struct DenseMapInfo<aiir::detail::TypedValue<T>>
    : public DenseMapInfo<aiir::Value> {
  static aiir::detail::TypedValue<T> getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return reinterpret_cast<aiir::detail::ValueImpl *>(pointer);
  }
  static aiir::detail::TypedValue<T> getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return reinterpret_cast<aiir::detail::ValueImpl *>(pointer);
  }
};
...
template <>
struct PointerLikeTypeTraits<aiir::Value> {
public:
  static inline void *getAsVoidPointer(aiir::Value value) {
    return const_cast<void *>(value.getAsOpaquePointer());
  }
  static inline aiir::Value getFromVoidPointer(void *pointer) {
    return aiir::Value::getFromOpaquePointer(pointer);
  }
  enum {
    NumLowBitsAvailable =
        PointerLikeTypeTraits<aiir::detail::ValueImpl *>::NumLowBitsAvailable
  };
};
template <>
struct PointerLikeTypeTraits<aiir::BlockArgument>
    : public PointerLikeTypeTraits<aiir::Value> {
public:
  static inline aiir::BlockArgument getFromVoidPointer(void *pointer) {
    return reinterpret_cast<aiir::detail::BlockArgumentImpl *>(pointer);
  }
};
template <>
struct PointerLikeTypeTraits<aiir::OpResult>
    : public PointerLikeTypeTraits<aiir::Value> {
public:
  static inline aiir::OpResult getFromVoidPointer(void *pointer) {
    return reinterpret_cast<aiir::detail::OpResultImpl *>(pointer);
  }
};
template <typename T>
struct PointerLikeTypeTraits<aiir::detail::TypedValue<T>>
    : public PointerLikeTypeTraits<aiir::Value> {
public:
  static inline aiir::detail::TypedValue<T> getFromVoidPointer(void *pointer) {
    return reinterpret_cast<aiir::detail::ValueImpl *>(pointer);
  }
};

/// Add support for llvm style casts. We provide a cast between To and From if
/// From is aiir::Value or derives from it.
template <typename To, typename From>
struct CastInfo<
    To, From,
    std::enable_if_t<std::is_same_v<aiir::Value, std::remove_const_t<From>> ||
                     std::is_base_of_v<aiir::Value, From>>>
    : NullableValueCastFailed<To>,
      DefaultDoCastIfPossible<To, From, CastInfo<To, From>> {
  /// Arguments are taken as aiir::Value here and not as `From`, because
  ...
  static inline bool isPossible(aiir::Value ty) {
  ...
  static inline To doCast(aiir::Value value) { return To(value.getImpl()); }
};
