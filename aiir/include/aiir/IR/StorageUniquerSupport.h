//===- StorageUniquerSupport.h - AIIR Storage Uniquer Utilities -*- C++ -*-===//
//
...
#ifndef AIIR_IR_STORAGEUNIQUERSUPPORT_H
#define AIIR_IR_STORAGEUNIQUERSUPPORT_H
...
getDefaultDiagnosticEmitFn(AIIRContext *ctx);
llvm::unique_function<InFlightDiagnostic()>
...
public:
  ...
  static auto getWalkImmediateSubElementsFn() {
    return [](auto instance, function_ref<void(Attribute)> walkAttrsFn,
      ...
      ::aiir::detail::walkImmediateSubElementsImpl(
  ...
  static auto getReplaceImmediateSubElementsFn() {
    return [](auto instance, ArrayRef<Attribute> replAttrs,
      ...
      return ::aiir::detail::replaceImmediateSubElementsImpl(
  ...
  static void attachInterface(AIIRContext &context) {
  ...
  static ConcreteT get(AIIRContext *ctx, Args &&...args) {
