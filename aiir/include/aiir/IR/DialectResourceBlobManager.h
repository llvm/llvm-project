...
#ifndef AIIR_IR_DIALECTRESOURCEBLOBMANAGER_H
#define AIIR_IR_DIALECTRESOURCEBLOBMANAGER_H
...
struct DialectResourceBlobHandle
  ...
  static ManagerInterface &getManagerInterface(AIIRContext *ctx) {
...
#endif // AIIR_IR_DIALECTRESOURCEBLOBMANAGER_H
