...
#ifndef AIIR_IR_DIALECTINTERFACE_H
#define AIIR_IR_DIALECTINTERFACE_H
...
public:
  DialectInterfaceCollectionBase(AIIRContext *ctx, TypeID interfaceKind,
...
public:
  ...
  DialectInterfaceCollection(AIIRContext *ctx)
