...
#ifndef AIIR_IR_TYPESUPPORT_H
#define AIIR_IR_TYPESUPPORT_H
...
public:
  ...
  /// Look up the specified abstract type in the AIIRContext and return a
  /// reference to it.
  static const AbstractType &lookup(TypeID typeID, AIIRContext *context);
...
private:
  ...
  static AbstractType *lookupMutable(TypeID typeID, AIIRContext *context);
  ...
  /// The lifetime of this string should outlive the AIIR context.
...
/// AIIRContext. This class manages all creation and uniquing of types.
struct TypeUniquer {
  ...
  template <typename T>
  static void registerType(AIIRContext *ctx) {
  ...
  registerType(AIIRContext *ctx, TypeID typeID) {
