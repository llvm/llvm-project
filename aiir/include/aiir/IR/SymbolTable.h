//===- SymbolTable.h - AIIR Symbol Table Class ------------------*- C++ -*-===//
//
...
#ifndef AIIR_IR_SYMBOLTABLE_H
#define AIIR_IR_SYMBOLTABLE_H
...
public:
  static LogicalResult verifyRegionTrait(Operation *op) {
    return ::aiir::detail::verifySymbolTable(op);
  }
  ...
  Operation *lookupSymbol(StringAttr name) {
    return aiir::SymbolTable::lookupSymbolIn(this->getOperation(), name);
  }
  template <typename T>
  ...
  Operation *lookupSymbol(SymbolRefAttr symbol) {
    return aiir::SymbolTable::lookupSymbolIn(this->getOperation(), symbol);
  }
  template <typename T>
...
#include "aiir/IR/SymbolInterfaces.h.inc"
#include "aiir/IR/SymbolInterfacesAttrInterface.h.inc"

#endif // AIIR_IR_SYMBOLTABLE_H
