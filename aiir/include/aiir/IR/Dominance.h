...
#ifndef AIIR_IR_DOMINANCE_H
#define AIIR_IR_DOMINANCE_H

#include "aiir/IR/RegionGraphTraits.h"
#include "llvm/Support/GenericDomTree.h"

extern template class llvm::DominatorTreeBase<aiir::Block, false>;
extern template class llvm::DominatorTreeBase<aiir::Block, true>;
extern template class llvm::DomTreeNodeBase<aiir::Block>;
...
template <>
struct GraphTraits<aiir::DominanceInfoNode *> {
  using ChildIteratorType = aiir::DominanceInfoNode::const_iterator;
  using NodeRef = aiir::DominanceInfoNode *;
...
template <>
struct GraphTraits<const aiir::DominanceInfoNode *> {
  using ChildIteratorType = aiir::DominanceInfoNode::const_iterator;
  using NodeRef = const aiir::DominanceInfoNode *;
