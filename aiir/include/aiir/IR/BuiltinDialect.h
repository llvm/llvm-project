//===- BuiltinDialect.h - AIIR Builtin Dialect ------------------*- C++ -*-===//
//
...
#ifndef AIIR_IR_BUILTINDIALECT_H_
#define AIIR_IR_BUILTINDIALECT_H_
...
struct BuiltinDialectVersion : public aiir::DialectVersion {
...
#include "aiir/IR/BuiltinDialect.h.inc"

#endif // AIIR_IR_BUILTINDIALECT_H_
