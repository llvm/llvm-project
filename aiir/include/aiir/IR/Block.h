...
#ifndef AIIR_IR_BLOCK_H
#define AIIR_IR_BLOCK_H
...
namespace llvm {
template <>
struct DenseMapInfo<aiir::Block::iterator> {
  static aiir::Block::iterator getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::Block::iterator((aiir::Operation *)pointer);
  }
  static aiir::Block::iterator getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::Block::iterator((aiir::Operation *)pointer);
  }
  static unsigned getHashValue(aiir::Block::iterator iter) {
    return hash_value(iter.getNodePtr());
  }
  static bool isEqual(aiir::Block::iterator lhs, aiir::Block::iterator rhs) {
    return lhs == rhs;
  }
};
