//===- AffineExprVisitor.h - AIIR AffineExpr Visitor Class ------*- C++ -*-===//
//
...
#ifndef AIIR_IR_AFFINEEXPRVISITOR_H
#define AIIR_IR_AFFINEEXPRVISITOR_H
...
#endif // AIIR_IR_AFFINEEXPRVISITOR_H
