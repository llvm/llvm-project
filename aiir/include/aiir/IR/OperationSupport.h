...
#ifndef AIIR_IR_OPERATIONSUPPORT_H
#define AIIR_IR_OPERATIONSUPPORT_H
...
protected:
  ...
  struct UnregisteredOpModel : public Impl {
    ...
    void getCanonicalizationPatterns(RewritePatternSet &, AIIRContext *) final;
...
public:
  OperationName(StringRef name, AIIRContext *context);
  ...
  AIIRContext *getContext() { return getIdentifier().getContext(); }
...
private:
  ...
  friend AIIRContextImpl;
  friend DenseMapInfo<aiir::OperationName>;
  friend DenseMapInfo<aiir::RegisteredOperationName>;
};
...
public:
  ...
  DictionaryAttr getDictionary(AIIRContext *context) const;
...
#pragma clang diagnostic pop
  ...
  AIIRContext *getContext() const { return location->getContext(); }
};
...
namespace llvm {
template <>
struct DenseMapInfo<aiir::OperationName> {
  static aiir::OperationName getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::OperationName::getFromOpaquePointer(pointer);
  }
  static aiir::OperationName getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::OperationName::getFromOpaquePointer(pointer);
  }
  static unsigned getHashValue(aiir::OperationName val) {
    return DenseMapInfo<void *>::getHashValue(val.getAsOpaquePointer());
  }
  static bool isEqual(aiir::OperationName lhs, aiir::OperationName rhs) {
    return lhs == rhs;
  }
};
template <>
struct DenseMapInfo<aiir::RegisteredOperationName>
    : public DenseMapInfo<aiir::OperationName> {
  static aiir::RegisteredOperationName getEmptyKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::RegisteredOperationName::getFromOpaquePointer(pointer);
  }
  static aiir::RegisteredOperationName getTombstoneKey() {
    void *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::RegisteredOperationName::getFromOpaquePointer(pointer);
  }
};
...
template <>
struct PointerLikeTypeTraits<aiir::OperationName> {
  static inline void *getAsVoidPointer(aiir::OperationName I) {
    return const_cast<void *>(I.getAsOpaquePointer());
  }
  static inline aiir::OperationName getFromVoidPointer(void *P) {
    return aiir::OperationName::getFromOpaquePointer(P);
  }
  static constexpr int NumLowBitsAvailable =
      PointerLikeTypeTraits<void *>::NumLowBitsAvailable;
};
template <>
struct PointerLikeTypeTraits<aiir::RegisteredOperationName>
    : public PointerLikeTypeTraits<aiir::OperationName> {
  static inline aiir::RegisteredOperationName getFromVoidPointer(void *P) {
    return aiir::RegisteredOperationName::getFromOpaquePointer(P);
  }
};
