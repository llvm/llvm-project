...
#ifndef AIIR_IR_ATTRIBUTESUPPORT_H
#define AIIR_IR_ATTRIBUTESUPPORT_H
...
public:
  ...
  /// Look up the specified abstract attribute in the AIIRContext and return a
  /// reference to it.
  static const AbstractAttribute &lookup(TypeID typeID, AIIRContext *context);

  /// Look up the specified abstract attribute in the AIIRContext and return a
  /// reference to it if it exists.
  static std::optional<std::reference_wrapper<const AbstractAttribute>>
  lookup(StringRef name, AIIRContext *context);
...
private:
  ...
  static AbstractAttribute *lookupMutable(TypeID typeID, AIIRContext *context);
  ...
  /// so the lifetime of this string should outlive the AIIR context.
...
protected:
  ...
  void initialize(AIIRContext *context) {}
...
// AIIRContext. This class manages all creation and uniquing of attributes.
class AttributeUniquer {
public:
  /// Get an uniqued instance of an attribute T.
  template <typename T, typename... Args>
  static T get(AIIRContext *ctx, Args &&...args) {
  ...
  getWithTypeID(AIIRContext *ctx, TypeID typeID, Args &&...args) {
#ifndef NDEBUG
  ...
  static std::enable_if_t<
      std::is_same<typename T::ImplType, AttributeStorage>::value, T>
  getWithTypeID(AIIRContext *ctx, TypeID typeID) {
#ifndef NDEBUG
  ...
  template <typename T, typename... Args>
  static LogicalResult mutate(AIIRContext *ctx, typename T::ImplType *impl,
                              Args &&...args) {
  ...
  template <typename T>
  static void registerAttribute(AIIRContext *ctx) {
  ...
  registerAttribute(AIIRContext *ctx, TypeID typeID) {
