...
#ifndef AIIR_IR_OPIMPLEMENTATION_H
#define AIIR_IR_OPIMPLEMENTATION_H
...
public:
  ...
  /// custom dialects. Usage in upstream AIIR dialects is currently disallowed.
...
public:
  ...
  /// dimensions/symbol identifiers according to aiir::isValidDim/Symbol.
...
#include "aiir/IR/OpAsmOpInterface.h.inc"
...
#include "aiir/IR/OpAsmDialectInterface.h.inc"

namespace llvm {
template <>
struct DenseMapInfo<aiir::AsmDialectResourceHandle> {
  static inline aiir::AsmDialectResourceHandle getEmptyKey() {
    return {DenseMapInfo<void *>::getEmptyKey(),
            DenseMapInfo<aiir::TypeID>::getEmptyKey(), nullptr};
  }
  static inline aiir::AsmDialectResourceHandle getTombstoneKey() {
    return {DenseMapInfo<void *>::getTombstoneKey(),
            DenseMapInfo<aiir::TypeID>::getTombstoneKey(), nullptr};
  }
  static unsigned getHashValue(const aiir::AsmDialectResourceHandle &handle) {
    return DenseMapInfo<void *>::getHashValue(handle.getResource());
  }
  static bool isEqual(const aiir::AsmDialectResourceHandle &lhs,
                      const aiir::AsmDialectResourceHandle &rhs) {
