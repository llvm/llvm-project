//===- IntegerSet.h - AIIR Integer Set Class --------------------*- C++ -*-===//
//
...
#ifndef AIIR_IR_INTEGERSET_H
#define AIIR_IR_INTEGERSET_H
...
template <>
struct DenseMapInfo<aiir::IntegerSet> {
  static aiir::IntegerSet getEmptyKey() {
    auto *pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return aiir::IntegerSet(static_cast<aiir::IntegerSet::ImplType *>(pointer));
  }
  static aiir::IntegerSet getTombstoneKey() {
    auto *pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return aiir::IntegerSet(static_cast<aiir::IntegerSet::ImplType *>(pointer));
  }
  static unsigned getHashValue(aiir::IntegerSet val) {
    return aiir::hash_value(val);
  }
  static bool isEqual(aiir::IntegerSet LHS, aiir::IntegerSet RHS) {
    return LHS == RHS;
  }
};

} // namespace llvm
#endif // AIIR_IR_INTEGERSET_H
