//===- BuiltinAttributes.h - AIIR Builtin Attribute Classes -----*- C++ -*-===//
//
...
#ifndef AIIR_IR_BUILTINATTRIBUTES_H
#define AIIR_IR_BUILTINATTRIBUTES_H
...
#include "aiir/IR/BuiltinAttributes.h.inc"
...
public:
  ...
  static DenseArrayAttrImpl get(AIIRContext *context, ArrayRef<T> content);
...
public:
  ...
  static BoolAttr get(AIIRContext *context, bool value);
...
public:
  ...
  static FlatSymbolRefAttr get(AIIRContext *ctx, StringRef value) {
...
template <>
struct DenseMapInfo<aiir::StringAttr> : public DenseMapInfo<aiir::Attribute> {
  static aiir::StringAttr getEmptyKey() {
    const void *pointer = llvm::DenseMapInfo<const void *>::getEmptyKey();
    return aiir::StringAttr::getFromOpaquePointer(pointer);
  }
  static aiir::StringAttr getTombstoneKey() {
    const void *pointer = llvm::DenseMapInfo<const void *>::getTombstoneKey();
    return aiir::StringAttr::getFromOpaquePointer(pointer);
  }
};
template <>
struct PointerLikeTypeTraits<aiir::StringAttr>
    : public PointerLikeTypeTraits<aiir::Attribute> {
  static inline aiir::StringAttr getFromVoidPointer(void *p) {
    return aiir::StringAttr::getFromOpaquePointer(p);
  }
};

template <>
struct PointerLikeTypeTraits<aiir::IntegerAttr>
    : public PointerLikeTypeTraits<aiir::Attribute> {
  static inline aiir::IntegerAttr getFromVoidPointer(void *p) {
    return aiir::IntegerAttr::getFromOpaquePointer(p);
  }
};

template <>
struct PointerLikeTypeTraits<aiir::SymbolRefAttr>
    : public PointerLikeTypeTraits<aiir::Attribute> {
  static inline aiir::SymbolRefAttr getFromVoidPointer(void *ptr) {
    return aiir::SymbolRefAttr::getFromOpaquePointer(ptr);
  }
};

} // namespace llvm

#endif // AIIR_IR_BUILTINATTRIBUTES_H
