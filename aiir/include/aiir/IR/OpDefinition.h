...
#ifndef AIIR_IR_OPDEFINITION_H
#define AIIR_IR_OPDEFINITION_H
...
// Temporarily exit the AIIR namespace to add casting support as later code in
...
struct CastInfo<To, aiir::OpFoldResult>
    : public CastInfo<To, aiir::OpFoldResult::PointerUnion> {};

template <typename To>
struct CastInfo<To, const aiir::OpFoldResult>
    : public CastInfo<To, const aiir::OpFoldResult::PointerUnion> {};
...
public:
  ...
  public:
    aiir::TypedValue<ResultType> getResult() {
      return cast<aiir::TypedValue<ResultType>>(
          this->getOperation()->getResult(0));
    }

    /// If the operation returns a single value, then the Op can be implicitly
    /// converted to a Value. This yields the value of the only result.
    operator aiir::TypedValue<ResultType>() { return getResult(); }
...
struct SingleBlockImplicitTerminator {
  ...
  public:
    ...
    static void ensureTerminator(Region &region, Builder &builder,
                                 Location loc) {
      ::aiir::impl::ensureRegionTerminator(region, builder, loc,
                                           buildTerminator);
    }
...
public:
  ...
  static LogicalResult verifyTrait(Operation *op) {
    return ::aiir::OpTrait::impl::verifyOperandSizeAttr(
...
public:
  ...
  static LogicalResult verifyTrait(Operation *op) {
    return ::aiir::OpTrait::impl::verifyResultSizeAttr(
...
struct NoRegionArguments : public TraitBase<ConcrentType, NoRegionArguments> {
  static LogicalResult verifyTrait(Operation *op) {
    return ::aiir::OpTrait::impl::verifyNoRegionArguments(op);
  }
};
...
struct Elementwise : public TraitBase<ConcreteType, Elementwise> {
  static LogicalResult verifyTrait(Operation *op) {
    return ::aiir::OpTrait::impl::verifyElementwise(op);
  }
};
...
public:
  ...
  template <typename PropertiesTy>
  static Attribute getPropertiesAsAttr(AIIRContext *ctx,
...
public:
  ...
  template <typename T>
  static void printProperties(AIIRContext *ctx, OpAsmPrinter &p,
                              const T &properties,
                              ArrayRef<StringRef> elidedProps = {}) {
  ...
  static ParseResult parseProperties(OpAsmParser &parser,
    ...
    auto emitError = [&]() {
      return aiir::emitError(result.location, "invalid properties ")
...
struct DenseMapInfo<T,
                    std::enable_if_t<std::is_base_of<aiir::OpState, T>::value &&
