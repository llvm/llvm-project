...
#ifndef AIIR_IR_PATTERNMATCH_H
#define AIIR_IR_PATTERNMATCH_H
...
public:
  ...
  /// Return the AIIRContext used to create this pattern.
...
protected:
  ...
  Pattern(StringRef rootName, PatternBenefit benefit, AIIRContext *context,
  ...
  Pattern(MatchAnyOpTypeTag tag, PatternBenefit benefit, AIIRContext *context,
          ArrayRef<StringRef> generatedNames = {});
  ...
  Pattern(MatchTraitOpTypeTag tag, TypeID traitID, PatternBenefit benefit,
          AIIRContext *context, ArrayRef<StringRef> generatedNames = {});
...
private:
  ...
  llvm::PointerIntPair<AIIRContext *, 1, bool> contextAndHasBoundedRecursion;
...
struct OpRewritePattern
    : public aiir::detail::OpOrInterfaceRewritePatternBase<SourceOp> {
  ...
  /// ops.
  OpRewritePattern(AIIRContext *context, PatternBenefit benefit = 1,
                   ArrayRef<StringRef> generatedNames = {})
      : aiir::detail::OpOrInterfaceRewritePatternBase<SourceOp>(
...
struct OpInterfaceRewritePattern
  ...
  OpInterfaceRewritePattern(AIIRContext *context, PatternBenefit benefit = 1)
      : aiir::detail::OpOrInterfaceRewritePatternBase<SourceOp>(
...
public:
  ...
  OpTraitRewritePattern(AIIRContext *context, PatternBenefit benefit = 1)
...
protected:
  ...
  explicit RewriterBase(AIIRContext *ctx,
...
public:
  explicit IRRewriter(AIIRContext *ctx, OpBuilder::Listener *listener = nullptr)
...
public:
  explicit PatternRewriter(AIIRContext *ctx) : RewriterBase(ctx) {}
...
public:
  RewritePatternSet(AIIRContext *context) : context(context) {}

  /// Construct a RewritePatternSet populated with the given pattern.
  RewritePatternSet(AIIRContext *context,
  ...
  add(LogicalResult (*implFn)(OpType, PatternRewriter &rewriter),
    ...
    struct FnPattern final : public OpRewritePattern<OpType> {
      FnPattern(LogicalResult (*implFn)(OpType, PatternRewriter &rewriter),
                AIIRContext *context, PatternBenefit benefit,
                ArrayRef<StringRef> generatedNames)
