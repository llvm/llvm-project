...
#ifndef AIIR_IR_BLOCKSUPPORT_H
#define AIIR_IR_BLOCKSUPPORT_H
...
template <>
struct DenseMapInfo<aiir::SuccessorRange> {
  static aiir::SuccessorRange getEmptyKey() {
    auto *pointer = llvm::DenseMapInfo<aiir::BlockOperand *>::getEmptyKey();
    return aiir::SuccessorRange(pointer, 0);
  }
  static aiir::SuccessorRange getTombstoneKey() {
    auto *pointer = llvm::DenseMapInfo<aiir::BlockOperand *>::getTombstoneKey();
    return aiir::SuccessorRange(pointer, 0);
  }
  static unsigned getHashValue(aiir::SuccessorRange value) {
    return llvm::hash_combine_range(value);
  }
  static bool isEqual(aiir::SuccessorRange lhs, aiir::SuccessorRange rhs) {
...
// dependence.
template <>
struct SpecificNodeAccess<compute_node_options<::aiir::Operation>::type>
    : NodeAccess {
protected:
  using OptionsT = compute_node_options<aiir::Operation>::type;
...
template <>
struct ilist_traits<::aiir::Operation> {
  using Operation = ::aiir::Operation;
...
template <>
struct ilist_traits<::aiir::Block> : public ilist_alloc_traits<::aiir::Block> {
  using Block = ::aiir::Block;
  using block_iterator = simple_ilist<::aiir::Block>::iterator;
...
private:
  aiir::Region *getParentRegion();
};

} // namespace llvm

#endif // AIIR_IR_BLOCKSUPPORT_H
