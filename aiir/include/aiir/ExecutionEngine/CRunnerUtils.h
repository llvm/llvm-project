//===- CRunnerUtils.h - Utils for debugging AIIR execution ----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares basic classes and functions to manipulate structured AIIR
...
#ifndef AIIR_EXECUTIONENGINE_CRUNNERUTILS_H
#define AIIR_EXECUTIONENGINE_CRUNNERUTILS_H

#ifdef _WIN32
#ifndef AIIR_CRUNNERUTILS_EXPORT
#ifdef aiir_c_runner_utils_EXPORTS
// We are building this library
#define AIIR_CRUNNERUTILS_EXPORT __declspec(dllexport)
#define AIIR_CRUNNERUTILS_DEFINE_FUNCTIONS
#else
// We are using this library
#define AIIR_CRUNNERUTILS_EXPORT __declspec(dllimport)
#endif // aiir_c_runner_utils_EXPORTS
#endif // AIIR_CRUNNERUTILS_EXPORT
#else  // _WIN32
// Non-windows: use visibility attributes.
#define AIIR_CRUNNERUTILS_EXPORT __attribute__((visibility("default")))
#define AIIR_CRUNNERUTILS_DEFINE_FUNCTIONS
#endif // _WIN32
...
template <typename T, int Dim>
struct Vector<T, Dim>
    : public aiir::detail::Vector1D<T, Dim,
                                    aiir::detail::isPowerOf2(sizeof(T[Dim]))> {
};
...
//===----------------------------------------------------------------------===//
extern "C" AIIR_CRUNNERUTILS_EXPORT void
...
//===----------------------------------------------------------------------===//
extern "C" AIIR_CRUNNERUTILS_EXPORT void printI64(int64_t i);
extern "C" AIIR_CRUNNERUTILS_EXPORT void printU64(uint64_t u);
extern "C" AIIR_CRUNNERUTILS_EXPORT void printF32(float f);
extern "C" AIIR_CRUNNERUTILS_EXPORT void printF64(double d);
extern "C" AIIR_CRUNNERUTILS_EXPORT void printString(char const *s);
extern "C" AIIR_CRUNNERUTILS_EXPORT void printOpen();
extern "C" AIIR_CRUNNERUTILS_EXPORT void printClose();
extern "C" AIIR_CRUNNERUTILS_EXPORT void printComma();
extern "C" AIIR_CRUNNERUTILS_EXPORT void printNewline();

//===----------------------------------------------------------------------===//
// Small runtime support library for timing execution and printing GFLOPS
//===----------------------------------------------------------------------===//
extern "C" AIIR_CRUNNERUTILS_EXPORT void printFlops(double flops);
extern "C" AIIR_CRUNNERUTILS_EXPORT double rtclock();
...
extern "C" AIIR_CRUNNERUTILS_EXPORT void *rtsrand(uint64_t s);
// Uses a random number generator g and returns a random number
// in the range of [0, m).
extern "C" AIIR_CRUNNERUTILS_EXPORT uint64_t rtrand(void *g, uint64_t m);
// Deletes the random number generator.
extern "C" AIIR_CRUNNERUTILS_EXPORT void rtdrand(void *g);
...
extern "C" AIIR_CRUNNERUTILS_EXPORT void
_aiir_ciface_shuffle(StridedMemRefType<uint64_t, 1> *mref, void *g);

//===----------------------------------------------------------------------===//
// Runtime support library to allow the use of std::sort in AIIR program.
//===----------------------------------------------------------------------===//
extern "C" AIIR_CRUNNERUTILS_EXPORT void
_aiir_ciface_stdSortI64(uint64_t n, StridedMemRefType<int64_t, 1> *vref);
extern "C" AIIR_CRUNNERUTILS_EXPORT void
_aiir_ciface_stdSortF64(uint64_t n, StridedMemRefType<double, 1> *vref);
extern "C" AIIR_CRUNNERUTILS_EXPORT void
_aiir_ciface_stdSortF32(uint64_t n, StridedMemRefType<float, 1> *vref);
#endif // AIIR_EXECUTIONENGINE_CRUNNERUTILS_H
