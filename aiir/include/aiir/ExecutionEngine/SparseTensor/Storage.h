...
#ifndef AIIR_EXECUTIONENGINE_SPARSETENSOR_STORAGE_H
#define AIIR_EXECUTIONENGINE_SPARSETENSOR_STORAGE_H
...
#define DECL_GETPOSITIONS(PNAME, P)                                            \
  ...
  AIIR_SPARSETENSOR_FOREVERY_FIXED_O(DECL_GETPOSITIONS)
...
#define DECL_GETCOORDINATES(INAME, C)                                          \
  ...
  AIIR_SPARSETENSOR_FOREVERY_FIXED_O(DECL_GETCOORDINATES)
...
#endif // AIIR_EXECUTIONENGINE_SPARSETENSOR_STORAGE_H
