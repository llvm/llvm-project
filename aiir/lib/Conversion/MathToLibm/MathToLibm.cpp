...
public:
  using OpRewritePattern<Op>::OpRewritePattern;
  ScalarOpToLibmCall(AIIRContext *context, PatternBenefit benefit,
...
void populatePatternsForOp(RewritePatternSet &patterns, PatternBenefit benefit,
                           AIIRContext *ctx, StringRef floatFunc,
...
void aiir::populateMathToLibmConversionPatterns(RewritePatternSet &patterns,
