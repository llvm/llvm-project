...
struct ScfToSPIRVContextImpl {
  // Map between the spirv region control flow operation (spirv.aiir.loop or
  // spirv.aiir.selection) to the VariableOp created to store the region
...
/// spirv.aiir.loop/spirv.aiir.selection currently don't yield value. Right
...
public:
  SCFToSPIRVPattern(AIIRContext *context, const SPIRVTypeConverter &converter,
                    ScfToSPIRVContextImpl *scfToSPIRVContext)
...
void aiir::populateSCFToSPIRVPatterns(const SPIRVTypeConverter &typeConverter,
                                      ScfToSPIRVContext &scfToSPIRVContext,
