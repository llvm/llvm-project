...
static Type inferIntrinsicResultType(Type vectorResultType) {
  AIIRContext *ctx = vectorResultType.getContext();
...
static bool isMbarrierShared(nvgpu::MBarrierGroupType barrierType) {
  return (aiir::nvgpu::NVGPUDialect::isSharedMemoryAddressSpace(
      barrierType.getMemorySpace()));
}

/// Returns the memory space attribute of the mbarrier object.
Attribute nvgpu::getMbarrierMemorySpace(AIIRContext *context,
...
/// MBarrierGroupType.
MemRefType nvgpu::getMBarrierMemrefType(AIIRContext *context,
                                        nvgpu::MBarrierGroupType barrierType) {
...
struct ConvertNVGPUToNVVMPass
  ...
  void runOnOperation() override {
    ...
    target.addLegalDialect<::aiir::arith::ArithDialect>();
    target.addLegalDialect<::aiir::memref::MemRefDialect>();
    target.addLegalDialect<::aiir::NVVM::NVVMDialect>();
...
struct NVGPUWarpgroupMmaOpLowering
  ...
  class WarpgroupGemm {
    ...
    /// Generates WGMMATypesAttr from AIIR Type
...
struct NVGPUWarpgroupMmaStoreOpLowering
  ...
  void storeFragmentedMatrix(ImplicitLocOpBuilder &b, Value matrixD,
    ...
    auto makeExtractAndStore = [&](int i, Value wgmmaResult, Value x, Value y,
                                   TypedValue<::aiir::MemRefType> memref) {
...
struct NVGPUTmaFenceOpLowering
  ...
  matchAndRewrite(nvgpu::TmaFenceOp op, OpAdaptor adaptor,
    ...
    auto memscope =
        NVVM::MemScopeKindAttr::get(ctx, ::aiir::NVVM::MemScopeKind::SYS);
...
struct NVGPUTmaPrefetchOpLowering
  ...
  matchAndRewrite(nvgpu::TmaPrefetchOp op, OpAdaptor adaptor,
    ...
    rewriter.replaceOpWithNewOp<NVVM::PrefetchOp>(
        ...
        /* Tensormap UnitAttr */ aiir::UnitAttr::get(op.getContext()));
    return success();
  }
};
...
void aiir::nvgpu::populateCommonGPUTypeAndAttributeConversions(
...
void aiir::populateNVGPUToNVVMConversionPatterns(
