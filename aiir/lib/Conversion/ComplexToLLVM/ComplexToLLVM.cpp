...
void aiir::populateComplexToLLVMConversionPatterns(
...
void aiir::registerConvertComplexToLLVMInterface(DialectRegistry &registry) {
  registry.addExtension(
      +[](AIIRContext *ctx, complex::ComplexDialect *dialect) {
