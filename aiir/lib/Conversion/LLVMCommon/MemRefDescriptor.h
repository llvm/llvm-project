...
#ifndef AIIR_LIB_CONVERSION_LLVMCOMMON_MEMREFDESCRIPTOR_H
#define AIIR_LIB_CONVERSION_LLVMCOMMON_MEMREFDESCRIPTOR_H
...
#endif // AIIR_LIB_CONVERSION_LLVMCOMMON_MEMREFDESCRIPTOR_H
