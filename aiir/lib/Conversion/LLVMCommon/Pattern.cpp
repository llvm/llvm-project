...
ConvertToLLVMPattern::ConvertToLLVMPattern(
    StringRef rootOpName, AIIRContext *context,
...
Value ConvertToLLVMPattern::getSizeInBytes(
  ...
  // Compute the size of an individual element. This emits the AIIR equivalent
...
LogicalResult aiir::LLVM::decomposeValue(OpBuilder &builder, Location loc,
...
Value aiir::LLVM::composeValue(OpBuilder &builder, Location loc, ValueRange src,
                               Type dstType) {
...
Value aiir::LLVM::getStridedElementPtr(OpBuilder &builder, Location loc,
