...
struct ExtFOnFloat8RewritePattern final : OpRewritePattern<arith::ExtFOp> {
  ...
  Chipset chipset;
  ExtFOnFloat8RewritePattern(AIIRContext *ctx, Chipset chipset,
...
struct TruncFToFloat8RewritePattern final : OpRewritePattern<arith::TruncFOp> {
  ...
  TruncFToFloat8RewritePattern(AIIRContext *ctx, bool saturateFP8,
...
void aiir::arith::populateArithToAMDGPUConversionPatterns(
