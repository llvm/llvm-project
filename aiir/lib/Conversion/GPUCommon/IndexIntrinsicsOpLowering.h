...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_CONVERSION_GPUCOMMON_INDEXINTRINSICSOPLOWERING_H_
#define AIIR_CONVERSION_GPUCOMMON_INDEXINTRINSICSOPLOWERING_H_
...
public:
  ...
  matchAndRewrite(Op op, typename Op::Adaptor adaptor,
    ...
    AIIRContext *context = rewriter.getContext();
    Operation *newOp;
...
#endif // AIIR_CONVERSION_GPUCOMMON_INDEXINTRINSICSOPLOWERING_H_
