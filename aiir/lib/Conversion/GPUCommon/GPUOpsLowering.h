...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_CONVERSION_GPUCOMMON_GPUOPSLOWERING_H_
#define AIIR_CONVERSION_GPUCOMMON_GPUOPSLOWERING_H_
...
/// to deal with %s (even if there were first-class strings in AIIR, they're not
...
#endif // AIIR_CONVERSION_GPUCOMMON_GPUOPSLOWERING_H_
