...
struct ParallelOpLowering : public OpRewritePattern<scf::ParallelOp> {
  ...
  ParallelOpLowering(AIIRContext *context,
  ...
  LogicalResult matchAndRewrite(scf::ParallelOp parallelOp,
    ...
    for (auto [x, y, rD] : llvm::zip_equal(
      ...
      aiir::OpBuilder builder(rewriter.getContext());
        ...
        /* reduction_syms = */ ArrayAttr{});
    {
      ...
      // Replace the loop.
      {
        ...
        // variables.
        llvm::SmallVector<aiir::Type> reductionTypes;
        ...
        rewriter.createBlock(
            ...
            llvm::SmallVector<aiir::Location>(reductionVariables.size(),
                                              parallelOp.getLoc()));
        ...
        aiir::Block &loopOpEntryBlock = loopOp.getRegion().front();
