//===- LowerGpuOpsToNVVMOps.cpp - AIIR GPU to NVVM lowering passes --------===//
//
...
void aiir::configureGpuToNVVMConversionLegality(ConversionTarget &target) {
...
void aiir::configureGpuToNVVMTypeConverter(LLVMTypeConverter &converter) {
...
void aiir::populateGpuSubgroupReduceOpLoweringPattern(
    const LLVMTypeConverter &converter, RewritePatternSet &patterns,
    PatternBenefit benefit) {
  patterns.add<GPUSubgroupReduceOpLowering>(converter, benefit);
}

void aiir::populateGpuToNVVMConversionPatterns(
    const LLVMTypeConverter &converter, RewritePatternSet &patterns,
    PatternBenefit benefit) {
...
void aiir::NVVM::registerConvertGpuToNVVMInterface(DialectRegistry &registry) {
