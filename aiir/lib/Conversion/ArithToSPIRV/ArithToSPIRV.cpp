...
struct ConstantCompositeOpPattern final
  ...
  matchAndRewrite(arith::ConstantOp constOp, OpAdaptor adaptor,
    ...
    // arith.constant should only have vector or tensor types. This is a AIIR
    ...
    aiir::DenseElementsAttr dstElementsAttr;
...
void aiir::arith::populateArithToSPIRVPatterns(
