...
LLVM::FastmathFlags
aiir::arith::convertArithFastMathFlagsToLLVM(arith::FastMathFlags arithFMF) {
...
aiir::arith::convertArithFastMathAttrToLLVM(arith::FastMathFlagsAttr fmfAttr) {
...
LLVM::IntegerOverflowFlags aiir::arith::convertArithOverflowFlagsToLLVM(
...
LLVM::RoundingMode
aiir::arith::convertArithRoundingModeToLLVM(arith::RoundingMode roundingMode) {
  switch (roundingMode) {
...
LLVM::RoundingModeAttr aiir::arith::convertArithRoundingModeAttrToLLVM(
...
aiir::arith::getLLVMDefaultFPExceptionBehavior(AIIRContext &context) {
