...
void aiir::populateGpuWMMAToSPIRVCoopMatrixKHRConversionPatterns(
...
void aiir::populateMMAToSPIRVCoopMatrixTypeConversion(
    aiir::SPIRVTypeConverter &typeConverter) {
