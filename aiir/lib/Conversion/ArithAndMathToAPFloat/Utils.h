...
#ifndef AIIR_CONVERSION_ARITHANDMATHTOAPFLOAT_UTILS_H_
#define AIIR_CONVERSION_ARITHANDMATHTOAPFLOAT_UTILS_H_
...
Value forEachScalarValue(aiir::RewriterBase &rewriter, Location loc,
...
#endif // AIIR_CONVERSION_ARITHANDMATHTOAPFLOAT_UTILS_H_
