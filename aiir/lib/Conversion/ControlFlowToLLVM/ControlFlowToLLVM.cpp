...
//===----------------------------------------------------------------------===//
//
// This file implements a pass to convert AIIR standard and builtin dialects
...
#include "aiir/Conversion/LLVMCommon/PrintCallHelper.h"
...
void aiir::cf::populateControlFlowToLLVMConversionPatterns(
...
void aiir::cf::populateAssertToLLVMConversionPattern(
    const LLVMTypeConverter &converter, RewritePatternSet &patterns,
...
namespace {
/// A pass converting AIIR operations into the LLVM IR dialect.
struct ConvertControlFlowToLLVM
  ...
  void runOnOperation() override {
    ...
    aiir::cf::populateControlFlowToLLVMConversionPatterns(converter, patterns);
...
struct ControlFlowToLLVMDialectInterface
  ...
  void populateConvertToLLVMConversionPatterns(
    ...
    aiir::cf::populateControlFlowToLLVMConversionPatterns(typeConverter,
                                                          patterns);
    aiir::cf::populateAssertToLLVMConversionPattern(typeConverter, patterns);
  }
};
} // namespace

void aiir::cf::registerConvertControlFlowToLLVMInterface(
