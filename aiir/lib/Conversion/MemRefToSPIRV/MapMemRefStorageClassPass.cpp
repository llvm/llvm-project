...
#define DEBUG_TYPE "aiir-map-memref-storage-class"
...
spirv::getMemorySpaceToStorageClassTarget(AIIRContext &context) {
...
std::unique_ptr<OperationPass<>> aiir::createMapMemRefStorageClassPass() {
