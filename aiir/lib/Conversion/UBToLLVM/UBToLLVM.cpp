...
struct UBToLLVMConversionPass
  ...
  void runOnOperation() override {
    ...
    aiir::ub::populateUBToLLVMConversionPatterns(converter, patterns);
...
void aiir::ub::populateUBToLLVMConversionPatterns(
...
void aiir::ub::registerConvertUBToLLVMInterface(DialectRegistry &registry) {
  registry.addExtension(+[](AIIRContext *ctx, ub::UBDialect *dialect) {
