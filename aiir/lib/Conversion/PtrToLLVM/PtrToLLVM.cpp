...
createMemRefMetadataType(MemRefType type,
  ...
  AIIRContext *context = type.getContext();
...
LogicalResult TypeOffsetOpConversion::matchAndRewrite(
  ...
  // TODO: Use AIIR's data layout. We don't use it because overall support is
  // still flaky.
...
void aiir::ptr::populatePtrToLLVMConversionPatterns(
...
void aiir::ptr::registerConvertPtrToLLVMInterface(DialectRegistry &registry) {
