...
struct VectorToSCFPattern : public OpRewritePattern<OpTy> {
  explicit VectorToSCFPattern(AIIRContext *context,
...
/// `outOfBoundsCase`. The AIIR type of the return value must be specified in
/// `resultTypes`.
template <typename OpTy>
...
void aiir::populateVectorToSCFConversionPatterns(
...
struct ConvertVectorToSCFPass
  ...
  void runOnOperation() override {
    ...
    aiir::vector::populateVectorTransferPermutationMapLoweringPatterns(
...
std::unique_ptr<Pass>
aiir::createConvertVectorToSCFPass(const VectorTransferToSCFOptions &options) {
