...
getLibraryCallSymbolRef(Operation *op, PatternRewriter &rewriter) {
  ...
  // corresponding `_aiir_ciface_xxx` interface so that external libraries see
...
LogicalResult aiir::linalg::LinalgOpToLibraryCallRewrite::matchAndRewrite(
...
void aiir::linalg::populateLinalgToStandardConversionPatterns(
