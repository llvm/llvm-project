...
/// correctly at a high level in AIIR.
///
...
void aiir::configureArmSMEToLLVMConversionLegality(ConversionTarget &target) {
...
void aiir::populateArmSMEToLLVMConversionPatterns(LLVMTypeConverter &converter,
...
std::unique_ptr<Pass>
aiir::createConvertArmSMEToLLVMPass(bool dumpTileLiveRanges) {
