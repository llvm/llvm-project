...
static constexpr const char *kAddRef = "aiirAsyncRuntimeAddRef";
static constexpr const char *kDropRef = "aiirAsyncRuntimeDropRef";
static constexpr const char *kCreateToken = "aiirAsyncRuntimeCreateToken";
static constexpr const char *kCreateValue = "aiirAsyncRuntimeCreateValue";
static constexpr const char *kCreateGroup = "aiirAsyncRuntimeCreateGroup";
static constexpr const char *kEmplaceToken = "aiirAsyncRuntimeEmplaceToken";
static constexpr const char *kEmplaceValue = "aiirAsyncRuntimeEmplaceValue";
static constexpr const char *kSetTokenError = "aiirAsyncRuntimeSetTokenError";
static constexpr const char *kSetValueError = "aiirAsyncRuntimeSetValueError";
static constexpr const char *kIsTokenError = "aiirAsyncRuntimeIsTokenError";
static constexpr const char *kIsValueError = "aiirAsyncRuntimeIsValueError";
static constexpr const char *kIsGroupError = "aiirAsyncRuntimeIsGroupError";
static constexpr const char *kAwaitToken = "aiirAsyncRuntimeAwaitToken";
static constexpr const char *kAwaitValue = "aiirAsyncRuntimeAwaitValue";
static constexpr const char *kAwaitGroup = "aiirAsyncRuntimeAwaitAllInGroup";
static constexpr const char *kExecute = "aiirAsyncRuntimeExecute";
static constexpr const char *kGetValueStorage =
    "aiirAsyncRuntimeGetValueStorage";
static constexpr const char *kAddTokenToGroup =
    "aiirAsyncRuntimeAddTokenToGroup";
static constexpr const char *kAwaitTokenAndExecute =
    "aiirAsyncRuntimeAwaitTokenAndExecute";
static constexpr const char *kAwaitValueAndExecute =
    "aiirAsyncRuntimeAwaitValueAndExecute";
static constexpr const char *kAwaitAllAndExecute =
    "aiirAsyncRuntimeAwaitAllInGroupAndExecute";
...
struct AsyncAPI {
  ...
  static LLVM::LLVMPointerType opaquePointerType(AIIRContext *ctx) {
    return LLVM::LLVMPointerType::get(ctx);
  }

  static LLVM::LLVMTokenType tokenType(AIIRContext *ctx) {
    return LLVM::LLVMTokenType::get(ctx);
  }

  static FunctionType addOrDropRefFunctionType(AIIRContext *ctx) {
    auto ref = opaquePointerType(ctx);
    auto count = IntegerType::get(ctx, 64);
    return FunctionType::get(ctx, {ref, count}, {});
  }

  static FunctionType createTokenFunctionType(AIIRContext *ctx) {
    return FunctionType::get(ctx, {}, {TokenType::get(ctx)});
  }

  static FunctionType createValueFunctionType(AIIRContext *ctx) {
    auto i64 = IntegerType::get(ctx, 64);
    auto value = opaquePointerType(ctx);
    return FunctionType::get(ctx, {i64}, {value});
  }

  static FunctionType createGroupFunctionType(AIIRContext *ctx) {
    auto i64 = IntegerType::get(ctx, 64);
    return FunctionType::get(ctx, {i64}, {GroupType::get(ctx)});
  }

  static FunctionType getValueStorageFunctionType(AIIRContext *ctx) {
    auto ptrType = opaquePointerType(ctx);
    return FunctionType::get(ctx, {ptrType}, {ptrType});
  }

  static FunctionType emplaceTokenFunctionType(AIIRContext *ctx) {
    return FunctionType::get(ctx, {TokenType::get(ctx)}, {});
  }

  static FunctionType emplaceValueFunctionType(AIIRContext *ctx) {
    auto value = opaquePointerType(ctx);
    return FunctionType::get(ctx, {value}, {});
  }

  static FunctionType setTokenErrorFunctionType(AIIRContext *ctx) {
    return FunctionType::get(ctx, {TokenType::get(ctx)}, {});
  }

  static FunctionType setValueErrorFunctionType(AIIRContext *ctx) {
    auto value = opaquePointerType(ctx);
    return FunctionType::get(ctx, {value}, {});
  }

  static FunctionType isTokenErrorFunctionType(AIIRContext *ctx) {
    auto i1 = IntegerType::get(ctx, 1);
    return FunctionType::get(ctx, {TokenType::get(ctx)}, {i1});
  }

  static FunctionType isValueErrorFunctionType(AIIRContext *ctx) {
    auto value = opaquePointerType(ctx);
    auto i1 = IntegerType::get(ctx, 1);
    return FunctionType::get(ctx, {value}, {i1});
  }

  static FunctionType isGroupErrorFunctionType(AIIRContext *ctx) {
    auto i1 = IntegerType::get(ctx, 1);
    return FunctionType::get(ctx, {GroupType::get(ctx)}, {i1});
  }

  static FunctionType awaitTokenFunctionType(AIIRContext *ctx) {
    return FunctionType::get(ctx, {TokenType::get(ctx)}, {});
  }

  static FunctionType awaitValueFunctionType(AIIRContext *ctx) {
    auto value = opaquePointerType(ctx);
    return FunctionType::get(ctx, {value}, {});
  }

  static FunctionType awaitGroupFunctionType(AIIRContext *ctx) {
    return FunctionType::get(ctx, {GroupType::get(ctx)}, {});
  }

  static FunctionType executeFunctionType(AIIRContext *ctx) {
    auto ptrType = opaquePointerType(ctx);
    return FunctionType::get(ctx, {ptrType, ptrType}, {});
  }

  static FunctionType addTokenToGroupFunctionType(AIIRContext *ctx) {
    auto i64 = IntegerType::get(ctx, 64);
    return FunctionType::get(ctx, {TokenType::get(ctx), GroupType::get(ctx)},
                             {i64});
  }

  static FunctionType awaitTokenAndExecuteFunctionType(AIIRContext *ctx) {
    auto ptrType = opaquePointerType(ctx);
    return FunctionType::get(ctx, {TokenType::get(ctx), ptrType, ptrType}, {});
  }

  static FunctionType awaitValueAndExecuteFunctionType(AIIRContext *ctx) {
    auto ptrType = opaquePointerType(ctx);
    return FunctionType::get(ctx, {ptrType, ptrType, ptrType}, {});
  }

  static FunctionType awaitAllAndExecuteFunctionType(AIIRContext *ctx) {
    auto ptrType = opaquePointerType(ctx);
    return FunctionType::get(ctx, {GroupType::get(ctx), ptrType, ptrType}, {});
  }

  static FunctionType getNumWorkerThreads(AIIRContext *ctx) {
    return FunctionType::get(ctx, {}, {IndexType::get(ctx)});
  }

  // Auxiliary coroutine resume intrinsic wrapper.
  static Type resumeFunctionType(AIIRContext *ctx) {
...
public:
  explicit RefCountingOpLowering(const TypeConverter &converter,
                                 AIIRContext *ctx, StringRef apiFunctionName)
...
void aiir::populateAsyncStructuralTypeConversionsAndLegality(
