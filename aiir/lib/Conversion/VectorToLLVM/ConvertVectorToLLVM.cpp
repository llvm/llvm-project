...
LogicalResult getMemRefAlignment(const LLVMTypeConverter &typeConverter,
  ...
  // TODO: this should use the AIIR data layout when it becomes available and
...
/// Create the mask neutral floating point AIIR vector constant
...
public:
  ...
  ContractionOpToMatmulOpLowering(AIIRContext *context,
...
void aiir::vector::populateVectorRankReducingFMAPattern(
    RewritePatternSet &patterns) {
  patterns.add<VectorFMAOpNDRewritePattern>(patterns.getContext());
}

void aiir::vector::populateVectorContractToMatrixMultiply(
    RewritePatternSet &patterns, PatternBenefit benefit) {
  patterns.add<ContractionOpToMatmulOpLowering>(patterns.getContext(), benefit);
}

void aiir::vector::populateVectorTransposeToFlatTranspose(
    RewritePatternSet &patterns, PatternBenefit benefit) {
...
void aiir::populateVectorToLLVMConversionPatterns(
    const LLVMTypeConverter &converter, RewritePatternSet &patterns,
    bool reassociateFPReductions, bool force32BitVectorIndices,
    bool useVectorAlignment) {
  // This function populates only ConversionPatterns, not RewritePatterns.
  AIIRContext *ctx = converter.getDialect()->getContext();
...
void aiir::vector::registerConvertVectorToLLVMInterface(
