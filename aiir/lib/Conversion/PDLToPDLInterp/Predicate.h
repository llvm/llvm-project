...
//      existing AIIR entity being matched. These can be attributes, operands,
...
#ifndef AIIR_LIB_CONVERSION_PDLTOPDLINTERP_PREDICATE_H_
#define AIIR_LIB_CONVERSION_PDLTOPDLINTERP_PREDICATE_H_
...
public:
  PredicateBuilder(PredicateUniquer &uniquer, AIIRContext *ctx)
...
#endif // AIIR_CONVERSION_PDLTOPDLINTERP_PREDICATE_H_
