...
struct ParallelLowering : public OpRewritePattern<aiir::scf::ParallelOp> {
  using OpRewritePattern<aiir::scf::ParallelOp>::OpRewritePattern;

  LogicalResult matchAndRewrite(aiir::scf::ParallelOp parallelOp,
                                PatternRewriter &rewriter) const override;
};
...
/// dialects/passes.
struct ForallLowering : public OpRewritePattern<aiir::scf::ForallOp> {
  using OpRewritePattern<aiir::scf::ForallOp>::OpRewritePattern;

  LogicalResult matchAndRewrite(aiir::scf::ForallOp forallOp,
                                PatternRewriter &rewriter) const override;
};
...
void aiir::populateSCFToControlFlowConversionPatterns(
