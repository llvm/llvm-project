...
public:
  ...
  matchAndRewrite(memref::CopyOp op, OpAdaptor adaptor,
    ...
    auto isContiguousMemrefType = [&](BaseMemRefType type) {
      auto memrefType = dyn_cast<aiir::MemRefType>(type);
...
///   1. An `llvm.aiir.undef` operation to create a memref descriptor
...
void aiir::populateFinalizeMemRefToLLVMConversionPatterns(
...
void aiir::registerConvertMemRefToLLVMInterface(DialectRegistry &registry) {
