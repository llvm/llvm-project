...
//
// Instead of attaching cache control as AIIR attributes and handling them
...
///
/// This is the AIIR-level equivalent of handleDecorationCacheControl() from
...
static LLVM::CallOp createDeviceFunctionCall(
    ...
    aiir::ArrayRef<std::pair<unsigned, aiir::StringRef>> paramAttrs,
...
void ::aiir::populateXeVMToLLVMConversionPatterns(ConversionTarget &target,
