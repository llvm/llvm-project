...
#include "aiir/IR/BuiltinAttributeInterfaces.cpp.inc"
...
LogicalResult aiir::detail::verifyAffineMapAsLayout(
...
LogicalResult aiir::detail::getAffineMapStridesAndOffset(
