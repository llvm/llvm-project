...
Region *llvm::ilist_traits<::aiir::Block>::getParentRegion() {
  size_t offset(
...
void llvm::ilist_traits<::aiir::Block>::addNodeToList(Block *block) {
...
void llvm::ilist_traits<::aiir::Block>::removeNodeFromList(Block *block) {
...
void llvm::ilist_traits<::aiir::Block>::transferNodesFromList(
...
llvm::raw_ostream &aiir::operator<<(llvm::raw_ostream &os, Region &region) {
