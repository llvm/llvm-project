//===- AffineExprDetail.h - AIIR Affine Expr storage details ----*- C++ -*-===//
//
...
// exposed and would be kept local to AffineExpr.cpp however, AIIRContext.cpp
// needs to know the sizes for placement-new style Allocation.
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_IR_AFFINEEXPRDETAIL_H_
#define AIIR_IR_AFFINEEXPRDETAIL_H_
...
#endif // AIIR_IR_AFFINEEXPRDETAIL_H_
