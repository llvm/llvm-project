...
#include "aiir/IR/BuiltinTypeInterfaces.cpp.inc"

//===----------------------------------------------------------------------===//
// DenseElementTypeInterface implementations for float types
//===----------------------------------------------------------------------===//

size_t aiir::detail::getFloatTypeDenseElementBitSize(Type type) {
  return cast<FloatType>(type).getWidth();
}

Attribute aiir::detail::convertFloatTypeToAttribute(Type type,
...
LogicalResult
aiir::detail::convertFloatTypeFromAttribute(Type type, Attribute attr,
