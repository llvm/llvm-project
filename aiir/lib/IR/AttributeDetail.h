//===- AttributeDetail.h - AIIR Affine Map details Class --------*- C++ -*-===//
//
...
struct StringAttrStorage : public AttributeStorage {
  ...
  /// Initialize the storage given an AIIRContext.
...
public:
  ...
  static T get(AIIRContext *context, Args &&...args) {
...
private:
  ...
  static DistinctAttrStorage *allocateStorage(AIIRContext *context,
                                              Attribute referencedAttr);
};
