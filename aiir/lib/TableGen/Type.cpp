...
//===----------------------------------------------------------------------===//
//
// Type wrapper to simplify using TableGen Record defining a AIIR Type.
//
//===----------------------------------------------------------------------===//

#include "aiir/TableGen/Type.h"
#include "aiir/TableGen/Dialect.h"
...
// Return the C++ type for this type (which may just be ::aiir::Type).
