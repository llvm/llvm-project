...
//===----------------------------------------------------------------------===//
//
// This file implements AIIR to byte-code generation and the interpreter.
//
//===----------------------------------------------------------------------===//
...
PDLByteCodePattern PDLByteCodePattern::create(pdl_interp::RecordMatchOp matchOp,
  ...
  AIIRContext *ctx = matchOp.getContext();
...
class Generator {
public:
  Generator(AIIRContext *ctx, std::vector<const void *> &uniquedData,
