...
#include "aiir/Dialect/Async/Transforms.h"
...
public:
  AsyncParallelForRewrite(
      AIIRContext *ctx, bool asyncDispatch, int32_t numWorkerThreads,
...
//
// Function pseudocode (mix of C++ and AIIR):
//
//   func @async_dispatch(%block_start : index, %block_end : index, ...) {
//
//     // Keep splitting block range until we reached a range of size 1.
...
void aiir::async::populateAsyncParallelForPatterns(
