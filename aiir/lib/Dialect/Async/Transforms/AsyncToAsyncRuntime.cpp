...
outlineExecuteOp(SymbolTable &symbolTable, ExecuteOp execute) {
  ...
  AIIRContext *ctx = module.getContext();
  ...
  SetVector<aiir::Value> functionInputs(llvm::from_range,
...
public:
  AsyncFuncOpLowering(AIIRContext *ctx, FuncCoroMapPtr coros)
...
public:
  AsyncCallOpLowering(AIIRContext *ctx)
...
public:
  AsyncReturnOpLowering(AIIRContext *ctx, FuncCoroMapPtr coros)
...
public:
  AwaitOpLoweringBase(AIIRContext *ctx, FuncCoroMapPtr coros,
...
public:
  YieldOpLowering(AIIRContext *ctx, FuncCoroMapPtr coros)
...
public:
  AssertOpLowering(AIIRContext *ctx, FuncCoroMapPtr coros)
...
//===----------------------------------------------------------------------===//
void aiir::populateAsyncFuncToAsyncRuntimeConversionPatterns(
