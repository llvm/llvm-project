//===- Async.cpp - AIIR Async Operations ----------------------------------===//
//
...
#include "aiir/Dialect/Async/IR/AsyncOpsDialect.cpp.inc"

void AsyncDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/Async/IR/AsyncOps.cpp.inc"
      >();
  addTypes<
#define GET_TYPEDEF_LIST
#include "aiir/Dialect/Async/IR/AsyncOpsTypes.cpp.inc"
      >();
}
...
ParseResult ExecuteOp::parse(OpAsmParser &parser, OperationState &result) {
  AIIRContext *ctx = result.getContext();
...
Type ValueType::parse(aiir::AsmParser &parser) {
  Type ty;
