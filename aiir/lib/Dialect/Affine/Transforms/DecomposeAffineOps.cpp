...
void aiir::affine::reorderOperandsByHoistability(RewriterBase &rewriter,
                                                 AffineApplyOp op) {
...
static AffineApplyOp createSubApply(RewriterBase &rewriter,
  ...
  AIIRContext *ctx = originalOp->getContext();
...
FailureOr<AffineApplyOp> aiir::affine::decompose(RewriterBase &rewriter,
                                                 AffineApplyOp op) {
