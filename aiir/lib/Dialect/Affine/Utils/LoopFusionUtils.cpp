...
FusionResult aiir::affine::canFuseLoops(AffineForOp srcForOp,
                                        AffineForOp dstForOp,
...
void aiir::affine::fuseLoops(AffineForOp srcForOp, AffineForOp dstForOp,
...
/// returns false otherwise.
bool aiir::affine::getLoopNestStats(AffineForOp forOpRoot,
                                    LoopNestStats *stats) {
...
int64_t aiir::affine::getComputeCost(AffineForOp forOp, LoopNestStats &stats) {
...
bool aiir::affine::getFusionComputeCost(AffineForOp srcForOp,
...
/// 'dstOps'.
void aiir::affine::gatherProducerConsumerMemrefs(
