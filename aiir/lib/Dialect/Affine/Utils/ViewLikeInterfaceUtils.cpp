...
#include "aiir/Dialect/Affine/ViewLikeInterfaceUtils.h"
...
LogicalResult aiir::affine::mergeOffsetsSizesAndStrides(
...
void aiir::affine::resolveIndicesIntoOpWithOffsetsAndStrides(
...
void aiir::affine::resolveSizesIntoOpWithSizes(
