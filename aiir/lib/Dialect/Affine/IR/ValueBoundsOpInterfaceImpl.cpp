...
void aiir::affine::registerValueBoundsOpInterfaceExternalModels(
    DialectRegistry &registry) {
  registry.addExtension(+[](AIIRContext *ctx, AffineDialect *dialect) {
...
FailureOr<int64_t>
aiir::affine::fullyComposeAndComputeConstantDelta(Value value1, Value value2) {
