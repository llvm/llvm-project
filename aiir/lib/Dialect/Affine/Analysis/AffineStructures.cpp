//===- AffineStructures.cpp - AIIR Affine Structures Class-----------------===//
//
...
LogicalResult aiir::affine::getRelationFromMap(AffineMap &map,
                                               IntegerRelation &rel) {
...
LogicalResult aiir::affine::getRelationFromMap(const AffineValueMap &map,
                                               IntegerRelation &rel) {
