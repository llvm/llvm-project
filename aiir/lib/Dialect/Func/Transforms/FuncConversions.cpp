...
void aiir::populateCallOpTypeConversionPattern(RewritePatternSet &patterns,
...
public:
  ...
  BranchOpInterfaceTypeConversion(
      const TypeConverter &typeConverter, AIIRContext *ctx,
...
void aiir::populateBranchOpInterfaceTypeConversionPattern(
...
bool aiir::isLegalForBranchOpInterfaceTypeConversionPattern(
...
void aiir::populateReturnOpTypeConversionPattern(
    RewritePatternSet &patterns, const TypeConverter &typeConverter,
    PatternBenefit benefit) {
...
bool aiir::isLegalForReturnOpTypeConversionPattern(
...
bool aiir::isNotBranchOpInterfaceOrReturnLikeOp(Operation *op) {
