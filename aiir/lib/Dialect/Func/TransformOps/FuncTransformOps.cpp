...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(FuncTransformDialectExtension)
...
#define GET_OP_LIST
#include "aiir/Dialect/Func/TransformOps/FuncTransformOps.cpp.inc"
        >();
  }
};
} // namespace
...
void aiir::func::registerTransformDialectExtension(DialectRegistry &registry) {
