...
aiir::quant::fakeQuantAttrsToType(Location loc, unsigned numBits, double rmin,
                                  double rmax, bool narrowRange,
                                  Type expressedType, bool isSigned) {
  AIIRContext *ctx = expressedType.getContext();
...
UniformQuantizedPerAxisType aiir::quant::fakeQuantAttrsToType(
