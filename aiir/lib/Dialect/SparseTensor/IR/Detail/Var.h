...
#ifndef AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_VAR_H
#define AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_VAR_H
...
private:
  StringRef name;              // The bare-id used in the AIIR source.
...
#endif // AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_VAR_H
