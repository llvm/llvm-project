...
#ifndef AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_DIMLVLMAP_H
#define AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_DIMLVLMAP_H
...
public:
  ...
  AIIRContext *tryGetContext() const {
...
protected:
  // Variant of `aiir::AsmPrinter::Impl::BindingStrength`
...
public:
  ...
  AIIRContext *tryGetContext() const { return expr.tryGetContext(); }
...
public:
  ...
  AIIRContext *getContext() const {
    AIIRContext *ctx = expr.tryGetContext();
    assert(ctx);
    return ctx;
  }
...
public:
  ...
  AffineMap getDimToLvlMap(AIIRContext *context) const;
  AffineMap getLvlToDimMap(AIIRContext *context) const;
...
#endif // AIIR_DIALECT_SPARSETENSOR_IR_DETAIL_DIMLVLMAP_H
