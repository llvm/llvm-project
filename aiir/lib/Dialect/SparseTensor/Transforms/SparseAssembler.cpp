...
// externally into AIIR sparse tensors before calling the original method.
//
...
struct SparseFuncAssembler : public OpRewritePattern<func::FuncOp> {
  ...
  SparseFuncAssembler(AIIRContext *context, bool dO)
  ...
  LogicalResult matchAndRewrite(func::FuncOp funcOp,
    ...
    AIIRContext *context = modOp.getContext();
...
void aiir::populateSparseAssembler(RewritePatternSet &patterns,
                                   bool directOut) {
