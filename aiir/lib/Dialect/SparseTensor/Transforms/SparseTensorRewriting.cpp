...
void aiir::populatePreSparsificationRewriting(RewritePatternSet &patterns) {
...
void aiir::populateLowerSparseOpsToForeachPatterns(RewritePatternSet &patterns,
                                                   bool enableRT,
                                                   bool enableConvert) {
...
void aiir::populateLowerForeachToSCFPatterns(RewritePatternSet &patterns) {
