...
/// This class abstracts over the API of `_aiir_ciface_newSparseTensor`:
...
public:
  ...
  /// AIIR buffers as needed, and returning `this` for method chaining.
...
aiir::SparseTensorTypeToPtrConverter::SparseTensorTypeToPtrConverter() {
...
void aiir::populateSparseTensorConversionPatterns(
