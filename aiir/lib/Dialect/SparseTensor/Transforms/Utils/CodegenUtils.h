//===- CodegenUtils.h - Utilities for generating AIIR -----------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header file defines utilities for generating AIIR.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_DIALECT_SPARSETENSOR_TRANSFORMS_UTILS_CODEGENUTILS_H_
#define AIIR_DIALECT_SPARSETENSOR_TRANSFORMS_UTILS_CODEGENUTILS_H_
...
/// Converts the internal type-encoding for overhead storage to an aiir::Type.
...
/// execution engine.
Type getOpaquePointerType(AIIRContext *ctx);
...
#endif // AIIR_DIALECT_SPARSETENSOR_TRANSFORMS_UTILS_CODEGENUTILS_H_
