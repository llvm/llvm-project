...
// several levels). It also holds the common storage to hold the aiir::Values
...
aiir::sparse_tensor::SparseIterationSpace::SparseIterationSpace(
...
SparseIterationSpace aiir::sparse_tensor::SparseIterationSpace::fromValues(
