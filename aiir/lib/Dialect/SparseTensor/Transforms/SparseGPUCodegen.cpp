...
static Value genLaunchGPUFunc(OpBuilder &builder, gpu::GPUFuncOp gpuFunc,
  ...
  Value none = TypedValue<::aiir::IntegerType>{};
...
struct ForallRewriter : public OpRewritePattern<scf::ParallelOp> {
  ...
  ForallRewriter(AIIRContext *context, unsigned nT)
...
struct LinalgOpRewriter : public OpRewritePattern<linalg::GenericOp> {
  ...
  LinalgOpRewriter(AIIRContext *context, bool rt)
...
void aiir::populateSparseGPUCodegenPatterns(RewritePatternSet &patterns,
                                            unsigned numThreads) {
  patterns.add<ForallRewriter>(patterns.getContext(), numThreads);
}

void aiir::populateSparseGPULibgenPatterns(RewritePatternSet &patterns,
                                           bool enableRT) {
