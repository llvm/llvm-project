...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SCFTransformDialectExtension)
...
#define GET_OP_LIST
#include "aiir/Dialect/SCF/TransformOps/SCFTransformOps.cpp.inc"
        >();
  }
};
} // namespace
...
void aiir::scf::registerTransformDialectExtension(DialectRegistry &registry) {
