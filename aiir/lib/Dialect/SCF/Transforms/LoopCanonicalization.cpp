...
#include "aiir/Dialect/SCF/Utils/AffineCanonicalizationUtils.h"
...
struct SCFForLoopCanonicalization
  ...
  void runOnOperation() override {
    ...
    AIIRContext *ctx = parentOp->getContext();
...
void aiir::scf::populateSCFForLoopCanonicalizationPatterns(
    RewritePatternSet &patterns) {
  AIIRContext *ctx = patterns.getContext();
  patterns
...
std::unique_ptr<Pass> aiir::createSCFForLoopCanonicalizationPass() {
