...
LogicalResult aiir::scf::peelForLoopAndSimplifyBounds(RewriterBase &rewriter,
                                                      ForOp forOp,
                                                      ForOp &partialIteration) {
...
LogicalResult aiir::scf::peelForLoopFirstIteration(RewriterBase &b, ForOp forOp,
...
struct ForLoopPeelingPattern : public OpRewritePattern<ForOp> {
  ForLoopPeelingPattern(AIIRContext *ctx, bool peelFront, bool skipPartial)
...
std::unique_ptr<Pass> aiir::createParallelLoopSpecializationPass() {
  return std::make_unique<ParallelLoopSpecialization>();
}

std::unique_ptr<Pass> aiir::createForLoopSpecializationPass() {
