...
aiir::scf::tileUsingSCF(RewriterBase &rewriter, TilingInterface op,
                        const scf::SCFTilingOptions &options) {
...
FailureOr<scf::SCFTilingResult>
aiir::scf::tileReductionUsingScf(RewriterBase &b,
...
aiir::scf::tileAndFuseProducerOfSlice(
  ...
  tensor::ExtractSliceOp clonedCandidateSliceOp =
      aiir::clone(rewriter, candidateSliceOp,
...
FailureOr<SmallVector<Operation *>> aiir::scf::yieldReplacementForFusedProducer(
...
aiir::scf::tileConsumerAndFuseProducersUsingSCF(
...
aiir::scf::tileAndFuseConsumerOfSlices(
...
FailureOr<scf::SCFFuseConsumerOfSliceResult>
aiir::scf::tileAndFuseConsumer(RewriterBase &rewriter, Operation *consumer,
                               MutableArrayRef<LoopLikeOpInterface> loops) {
  ...
  if (consumerFusableOperands.empty()) {
    return aiir::scf::SCFFuseConsumerOfSliceResult{consumerFusableOperands,
...
aiir::scf::lowerToLoopsUsingSCFForOp(RewriterBase &rewriter,
                                     TilingInterface op) {
