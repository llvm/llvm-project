...
FailureOr<OpFoldResult> aiir::arith::reifyValueBound(
...
FailureOr<OpFoldResult> aiir::arith::reifyShapedValueDimBound(
...
FailureOr<OpFoldResult> aiir::arith::reifyIndexValueBound(
    OpBuilder &b, Location loc, presburger::BoundType type, Value value,
