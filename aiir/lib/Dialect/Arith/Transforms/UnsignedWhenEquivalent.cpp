...
struct ConvertOpToUnsigned final : OpRewritePattern<Signed> {
  ConvertOpToUnsigned(AIIRContext *context, DataFlowSolver &s)
...
struct ConvertCmpIToUnsigned final : OpRewritePattern<CmpIOp> {
  ConvertCmpIToUnsigned(AIIRContext *context, DataFlowSolver &s)
...
void aiir::arith::populateUnsignedWhenEquivalentPatterns(
