//===- ComplexDialect.cpp - AIIR Complex Dialect --------------------------===//
//
...
#include "aiir/Dialect/Complex/IR/ComplexOpsDialect.cpp.inc"
...
void complex::ComplexDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/Complex/IR/ComplexOps.cpp.inc"
      >();
  addAttributes<
#define GET_ATTRDEF_LIST
#include "aiir/Dialect/Complex/IR/ComplexAttributes.cpp.inc"
      >();
...
LogicalResult complex::NumberAttr::verify(
    ...
    ::llvm::APFloat real, ::llvm::APFloat imag, ::aiir::Type type) {
