...
using namespace aiir::pdl_interp;

#include "aiir/Dialect/PDLInterp/IR/PDLInterpOpsDialect.cpp.inc"
...
void PDLInterpDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/PDLInterp/IR/PDLInterpOps.cpp.inc"
      >();
}
...
void ForEachOp::build(::aiir::OpBuilder &builder, ::aiir::OperationState &state,
