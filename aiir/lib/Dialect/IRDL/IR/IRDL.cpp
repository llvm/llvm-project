...
#include "aiir/Dialect/IRDL/IR/IRDL.cpp.inc"

#include "aiir/Dialect/IRDL/IR/IRDLDialect.cpp.inc"

void IRDLDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/IRDL/IR/IRDLOps.cpp.inc"
      >();
  addTypes<
#define GET_TYPEDEF_LIST
#include "aiir/Dialect/IRDL/IR/IRDLTypesGen.cpp.inc"
      >();
  addAttributes<
#define GET_ATTRDEF_LIST
#include "aiir/Dialect/IRDL/IR/IRDLAttributes.cpp.inc"
      >();
}
...
static llvm::LogicalResult isValidName(llvm::StringRef in, aiir::Operation *loc,
                                       const Twine &label) {
  if (in.empty())
...
parseValueWithVariadicity(OpAsmParser &p,
  ...
  AIIRContext *ctx = p.getBuilder().getContext();
...
#include "aiir/Dialect/IRDL/IR/IRDLInterfaces.cpp.inc"

#define GET_TYPEDEF_CLASSES
#include "aiir/Dialect/IRDL/IR/IRDLTypesGen.cpp.inc"

#include "aiir/Dialect/IRDL/IR/IRDLEnums.cpp.inc"
