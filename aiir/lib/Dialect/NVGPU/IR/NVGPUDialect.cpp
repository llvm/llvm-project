//===- NVGPUDialect.cpp - AIIR NVGPU ops implementation -------------------===//
//
...
#include "aiir/Dialect/NVGPU/IR/NVGPUDialect.cpp.inc"

void NVGPUDialect::initialize() {
  addTypes<
#define GET_TYPEDEF_LIST
#include "aiir/Dialect/NVGPU/IR/NVGPUTypeDefs.cpp.inc"
      >();
  addAttributes<
#define GET_ATTRDEF_LIST
#include "aiir/Dialect/NVGPU/IR/NVGPUAttrDefs.cpp.inc"
      >();
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/NVGPU/IR/NVGPUOps.cpp.inc"
      >();
}
...
// NVGPU_MmaSyncOp
//===----------------------------------------------------------------------===//
void MmaSyncOp::build(::aiir::OpBuilder &odsBuilder,
                      ::aiir::OperationState &odsState, Value matrixA,
...
//===----------------------------------------------------------------------===//
void MmaSparseSyncOp::build(::aiir::OpBuilder &odsBuilder,
                            ::aiir::OperationState &odsState, Value matrixA,
...
#include "aiir/Dialect/NVGPU/IR/NVGPUEnums.cpp.inc"
