...
#include "aiir/Dialect/NVGPU/Transforms/Utils.h"
...
llvm::LogicalResult
aiir::nvgpu::optimizeSharedMemoryReadsAndWrites(Operation *parentOp,
                                                Value memrefValue) {
...
std::unique_ptr<Pass> aiir::nvgpu::createOptimizeSharedMemoryPass() {
