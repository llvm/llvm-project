...
LogicalResult aiir::verifyDynamicDimensionCount(Operation *op, ShapedType type,
...
LogicalResult aiir::verifyRanksMatch(Operation *op, ShapedType lhs,
...
LogicalResult aiir::verifyElementTypesMatch(Operation *op, ShapedType lhs,
                                            ShapedType rhs, StringRef lhsName,
                                            StringRef rhsName) {
