//===- SPIRVTypes.cpp - AIIR SPIR-V Types ---------------------------------===//
//
...
StructType StructType::getIdentified(AIIRContext *context,
                                     StringRef identifier) {
...
StructType StructType::getEmpty(AIIRContext *context, StringRef identifier) {
