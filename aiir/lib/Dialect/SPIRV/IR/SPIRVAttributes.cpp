...
spirv::InterfaceVarABIAttr::get(IntegerAttr descriptorSet, IntegerAttr binding,
  ...
  AIIRContext *context = descriptorSet.getContext();
...
spirv::VerCapExtAttr spirv::VerCapExtAttr::get(
    ...
    ArrayRef<spirv::Extension> extensions, AIIRContext *context) {
  Builder b(context);
...
spirv::VerCapExtAttr spirv::VerCapExtAttr::get(IntegerAttr version,
  ...
  AIIRContext *context = version.getContext();
...
spirv::TargetEnvAttr spirv::TargetEnvAttr::get(
  ...
  AIIRContext *context = triple.getContext();
...
#include "aiir/Dialect/SPIRV/IR/SPIRVAttributes.cpp.inc"
