...
AIIRContext *spirv::TargetEnv::getContext() const {
...
spirv::EntryPointABIAttr spirv::getEntryPointABIAttr(
    AIIRContext *context, ArrayRef<int32_t> workgroupSize,
...
spirv::getDefaultResourceLimits(AIIRContext *context) {
...
spirv::TargetEnvAttr spirv::getDefaultTargetEnv(AIIRContext *context) {
