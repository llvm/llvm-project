//===- SPIRVOpAvailability.cpp - AIIR SPIR-V Availability Implementation --===//
//
...
// capabilities.
#include "aiir/Dialect/SPIRV/IR/SPIRVAvailability.cpp.inc"

namespace aiir::spirv {
// TableGen'erated operation availability interface implementations.
#include "aiir/Dialect/SPIRV/IR/SPIRVOpAvailabilityImpl.inc"
} // namespace aiir::spirv
