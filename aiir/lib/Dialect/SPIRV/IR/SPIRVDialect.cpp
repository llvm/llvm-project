//===- LLVMDialect.cpp - AIIR SPIR-V dialect ------------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the SPIR-V dialect in AIIR.
//
//===----------------------------------------------------------------------===//
...
#include "aiir/Dialect/SPIRV/IR/SPIRVOpsDialect.cpp.inc"
...
struct SPIRVInlinerInterface : public DialectInlinerInterface {
  ...
  bool isLegalToInline(Region *dest, Region *src, bool wouldBeCloned,
    ...
    // Return true here when inlining into spirv.func, spirv.aiir.selection, and
    // spirv.aiir.loop operations.
