...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TensorTransformDialectExtension)
...
#define GET_OP_LIST
#include "aiir/Dialect/Tensor/TransformOps/TensorTransformOps.cpp.inc"
        >();
  }
};
} // namespace
...
void aiir::tensor::registerTransformDialectExtension(
    DialectRegistry &registry) {
