...
LogicalResult aiir::tensor::getCollapsedExtractSliceInfo(
...
LogicalResult aiir::tensor::getExpandedExtractSliceInfo(
    OpBuilder &b, tensor::ExtractSliceOp sliceOp,
...
void aiir::tensor::populateReassociativeReshapeFoldingPatterns(
...
void aiir::tensor::populateBubbleUpExpandShapePatterns(
    RewritePatternSet &patterns) {
  patterns.add<BubbleUpExpandThroughParallelCollapse>(patterns.getContext());
}

void aiir::tensor::populateBubbleUpExtractSliceOpPatterns(
    RewritePatternSet &patterns) {
