...
struct FoldEmptyTensorWithReshapeOp : public OpRewritePattern<ReshapeOp> {
  FoldEmptyTensorWithReshapeOp(AIIRContext *ctx, PatternBenefit benefit = 1,
...
struct FoldEmptyTensorWithExtractSliceOp
  ...
  FoldEmptyTensorWithExtractSliceOp(AIIRContext *ctx,
...
void aiir::tensor::populateFoldTensorEmptyPatterns(RewritePatternSet &patterns,
