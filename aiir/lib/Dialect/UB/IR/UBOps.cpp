...
#include "aiir/Dialect/UB/IR/UBOpsDialect.cpp.inc"

using namespace aiir;
using namespace aiir::ub;
...
void UBDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/UB/IR/UBOps.cpp.inc"
      >();
  addAttributes<
#define GET_ATTRDEF_LIST
#include "aiir/Dialect/UB/IR/UBOpsAttributes.cpp.inc"
      >();
...
#include "aiir/Dialect/UB/IR/UBOpsInterfaces.cpp.inc"
