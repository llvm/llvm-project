...
struct MultiReduceToContract
  ...
  LogicalResult matchAndRewrite(vector::MultiDimReductionOp reduceOp,
    ...
    rewriter.replaceOpWithNewOp<aiir::vector::ContractionOp>(
        ...
        rewriter.getArrayAttr(llvm::map_to_vector(
            iteratorTypes, [&](IteratorType t) -> aiir::Attribute {
...
struct CombineContractResultTranspose final
  ...
  LogicalResult matchAndRewrite(vector::TransposeOp resTOp,
    ...
    AIIRContext *context = contractOp.getContext();
...
FailureOr<Value> combineContractAndBroadcast(vector::ContractionOp contractOp,
  ...
  if (maskingOp) {
    ...
    newOp = aiir::vector::maskOperation(rewriter, newOp, mask);
  }
...
public:
  BreakDownVectorBitCast(AIIRContext *context,
...
public:
  explicit MaterializeTransferMask(AIIRContext *context, bool enableIndexOpt,
                                   PatternBenefit benefit = 1)
      : aiir::OpRewritePattern<ConcreteOp>(context, benefit),
...
public:
  explicit VectorCreateMaskOpConversion(AIIRContext *context,
                                        bool enableIndexOpt,
                                        PatternBenefit benefit = 1)
      : aiir::OpRewritePattern<vector::CreateMaskOp>(context, benefit),
        force32BitVectorIndices(enableIndexOpt) {}
...
struct CanonicalizeContractMatmulToMMT final
  ...
  CanonicalizeContractMatmulToMMT(AIIRContext *context, PatternBenefit benefit,
...
/// extensions on its operands. Please aiir snippets below for more details.
/// ```aiir
...
struct BreakDownVectorReduction final : OpRewritePattern<vector::ReductionOp> {
  BreakDownVectorReduction(AIIRContext *context,
...
void aiir::vector::populateFoldArithExtensionPatterns(
...
void aiir::vector::populateVectorMaskMaterializationPatterns(
...
void aiir::vector::populateDropUnitDimWithShapeCastPatterns(
...
void aiir::vector::populateBubbleVectorBitCastOpPatterns(
    RewritePatternSet &patterns, PatternBenefit benefit) {
...
void aiir::vector::populateBreakDownVectorBitCastOpPatterns(
    RewritePatternSet &patterns,
...
void aiir::vector::populateVectorContractCanonicalizeMatmulToMMT(
    RewritePatternSet &patterns,
...
void aiir::vector::populateVectorReductionToContractPatterns(
    RewritePatternSet &patterns, PatternBenefit benefit) {
...
void aiir::vector::populateDropInnerMostUnitDimsXferOpPatterns(
    RewritePatternSet &patterns, PatternBenefit benefit) {
...
void aiir::vector::populateSinkVectorOpsPatterns(RewritePatternSet &patterns,
                                                 PatternBenefit benefit) {
...
void aiir::vector::populateSinkVectorMemOpsPatterns(RewritePatternSet &patterns,
                                                    PatternBenefit benefit) {
...
void aiir::vector::populateChainedVectorReductionFoldingPatterns(
    RewritePatternSet &patterns, PatternBenefit benefit) {
...
void aiir::vector::populateBreakDownVectorReductionPatterns(
...
void aiir::vector::populateElementwiseToVectorOpsPatterns(
    RewritePatternSet &patterns) {
...
#include "aiir/Dialect/Vector/Transforms/VectorTransformsEnums.cpp.inc"
