...
FailureOr<Value>
aiir::vector::castAwayContractionLeadingOneDim(vector::ContractionOp contractOp,
  ...
  if (maskingOp) {
    ...
    newOp = aiir::vector::maskOperation(rewriter, newOp, newMask);
  }
...
public:
  CastAwayElementwiseLeadingOneDim(AIIRContext *context,
...
void aiir::vector::populateCastAwayVectorLeadingOneDimPatterns(
