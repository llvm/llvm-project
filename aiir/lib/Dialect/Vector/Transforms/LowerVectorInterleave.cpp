...
public:
  UnrollInterleaveOp(int64_t targetRank, AIIRContext *context,
...
public:
  UnrollDeinterleaveOp(int64_t targetRank, AIIRContext *context,
                       PatternBenefit benefit = 1)
      : OpRewritePattern(context, benefit), targetRank(targetRank) {};
...
void aiir::vector::populateVectorInterleaveLoweringPatterns(
...
void aiir::vector::populateVectorInterleaveToShufflePatterns(
