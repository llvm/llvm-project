  ...
  matchAndRewriteMaskableOp(vector::TransferReadOp transferReadOp,
    ...
    if (maskingOp) {
      ...
      auto shapeCastMask = rewriter.createOrFold<vector::ShapeCastOp>(
          ...
          maskingOp.getMask());
      newTransferReadOp = aiir::vector::maskOperation(
  ...
  matchAndRewriteMaskableOp(vector::TransferWriteOp transferWriteOp,
    ...
    if (maskingOp) {
      ...
      auto shapeCastMask = rewriter.createOrFold<vector::ShapeCastOp>(
          ...
          maskingOp.getMask());
      newXferWrite =
          aiir::vector::maskOperation(rewriter, newXferWrite, shapeCastMask);
    }
...
static Value collapseInnerDims(PatternRewriter &rewriter, aiir::Location loc,
...
public:
  FlattenContiguousRowMajorTransferReadPattern(AIIRContext *context,
...
public:
  FlattenContiguousRowMajorTransferWritePattern(AIIRContext *context,
                                                unsigned vectorBitwidth,
                                                PatternBenefit benefit)
...
public:
  RewriteScalarExtractOfTransferRead(AIIRContext *context,
                                     PatternBenefit benefit,
...
void aiir::vector::transferOpflowOpt(RewriterBase &rewriter,
                                     Operation *rootOp) {
...
void aiir::vector::populateScalarVectorTransferLoweringPatterns(
...
void aiir::vector::populateVectorTransferDropUnitDimsPatterns(
    RewritePatternSet &patterns, PatternBenefit benefit) {
  patterns
...
void aiir::vector::populateFlattenVectorTransferPatterns(
