...
void aiir::vector::populateVectorTransferPermutationMapLoweringPatterns(
...
struct TransferReadToVectorLoadLowering
    : public MaskableOpRewritePattern<vector::TransferReadOp> {
  TransferReadToVectorLoadLowering(AIIRContext *context,
...
struct TransferWriteToVectorStoreLowering
    : public MaskableOpRewritePattern<vector::TransferWriteOp> {
  TransferWriteToVectorStoreLowering(AIIRContext *context,
                                     std::optional<unsigned> maxRank,
                                     PatternBenefit benefit = 1)
...
void aiir::vector::populateVectorTransferLoweringPatterns(
