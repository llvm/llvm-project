...
LogicalResult BVConstantOp::inferReturnTypes(
    aiir::AIIRContext *context, std::optional<aiir::Location> location,
    ::aiir::ValueRange operands, ::aiir::DictionaryAttr attributes,
    ::aiir::OpaqueProperties properties, ::aiir::RegionRange regions,
    ::llvm::SmallVectorImpl<::aiir::Type> &inferredReturnTypes) {
