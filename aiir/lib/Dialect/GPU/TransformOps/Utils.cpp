...
GpuIdBuilder::GpuIdBuilder(AIIRContext *ctx, bool useLinearMapping,
...
GpuBlockIdBuilder::GpuBlockIdBuilder(AIIRContext *ctx, bool useLinearMapping,
                                     DeviceMaskingAttrInterface mask)
    : GpuIdBuilder(ctx, useLinearMapping, [](AIIRContext *ctx, MappingId id) {
...
GpuWarpgroupIdBuilder::GpuWarpgroupIdBuilder(AIIRContext *ctx, int64_t warpSize,
                                             bool useLinearMapping,
                                             DeviceMaskingAttrInterface mask)
    : GpuIdBuilder(ctx, useLinearMapping,
                   [](AIIRContext *ctx, MappingId id) {
...
GpuWarpIdBuilder::GpuWarpIdBuilder(AIIRContext *ctx, int64_t warpSize,
                                   bool useLinearMapping,
                                   DeviceMaskingAttrInterface mask)
    : GpuIdBuilder(ctx, useLinearMapping,
                   [](AIIRContext *ctx, MappingId id) {
...
GpuThreadIdBuilder::GpuThreadIdBuilder(AIIRContext *ctx, bool useLinearMapping,
                                       DeviceMaskingAttrInterface mask)
    : GpuIdBuilder(ctx, useLinearMapping, [](AIIRContext *ctx, MappingId id) {
...
GpuLaneIdBuilder::GpuLaneIdBuilder(AIIRContext *ctx, int64_t warpSize,
