...
public:
  ...
  FoldConstantBase(AIIRContext *context, const ControlFusionFn &controlFn,
  ...
  LogicalResult matchAndRewrite(LinalgOp linalgOp,
    ...
    // unify the following cases but they have lifetime as the AIIRContext.
...
void aiir::linalg::populateConstantFoldLinalgOperations(
