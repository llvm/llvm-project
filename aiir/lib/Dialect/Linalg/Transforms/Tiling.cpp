...
aiir::linalg::makeTiledLoopRanges(RewriterBase &b, Location loc, AffineMap map,
...
void aiir::linalg::transformIndexOps(
...
aiir::linalg::computeStaticContinuousTileSizes(LinalgOp op, unsigned dimension,
                                               unsigned targetSize) {
...
aiir::linalg::computeContinuousTileSizes(OpBuilder &builder, TilingInterface op,
                                         unsigned dimension,
...
aiir::linalg::computeStaticMultiTileSizes(LinalgOp op, unsigned dimension,
...
aiir::linalg::computeMultiTileSizes(OpBuilder &builder, LinalgOp op,
...
aiir::linalg::tileLinalgOp(RewriterBase &b, LinalgOp op,
                           const LinalgTilingOptions &options) {
...
void aiir::linalg::populateLinalgTilingCanonicalizationPatterns(
