...
FailureOr<Operation *> aiir::linalg::transposeMatmul(RewriterBase &rewriter,
...
FailureOr<Operation *>
aiir::linalg::transposeBatchMatmul(RewriterBase &rewriter,
...
struct TransposeMatmul final : public OpRewritePattern<linalg::MatmulOp> {
  TransposeMatmul(AIIRContext *ctx, bool transposeLHS)
...
struct TransposeBatchMatmul final
  ...
  TransposeBatchMatmul(AIIRContext *ctx, bool transposeLHS)
      : OpRewritePattern(ctx), transposeLHS(transposeLHS) {}
...
void aiir::linalg::populateTransposeMatmulPatterns(RewritePatternSet &patterns,
                                                   bool transposeLHS) {
