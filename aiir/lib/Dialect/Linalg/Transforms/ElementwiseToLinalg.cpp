...
struct ConvertAnyElementwiseMappableOpOnRankedTensors : public RewritePattern {
  ConvertAnyElementwiseMappableOpOnRankedTensors(AIIRContext *context)
...
void aiir::linalg::populateElementwiseToLinalgConversionPatterns(
...
class ConvertElementwiseToLinalgPass
  ...
  void runOnOperation() final {
    ...
    aiir::linalg::populateElementwiseToLinalgConversionPatterns(patterns);
