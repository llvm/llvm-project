...
void attachInterface(AIIRContext *ctx) {
...
void aiir::linalg::registerRuntimeVerifiableOpInterfaceExternalModels(
    DialectRegistry &registry) {
  registry.addExtension(+[](AIIRContext *ctx, LinalgDialect *) {
    attachInterface<
#define GET_OP_LIST
