...
FailureOr<PromotionInfo> aiir::linalg::promoteSubviewAsNewBuffer(
...
LogicalResult
aiir::linalg::promoteSubviewsPrecondition(Operation *op,
...
FailureOr<LinalgOp>
aiir::linalg::promoteSubViews(OpBuilder &builder, LinalgOp linalgOp,
                              const LinalgPromotionOptions &options) {
...
std::optional<Value> aiir::linalg::allocateWorkgroupMemory(
    OpBuilder &builder, memref::SubViewOp subview, ArrayRef<Value> sizeBounds,
    DataLayout &) {
...
LogicalResult aiir::linalg::deallocateWorkgroupMemory(OpBuilder &,
                                                      Value /*buffer*/) {
  return success();
}
...
LogicalResult aiir::linalg::copyToWorkgroupMemory(OpBuilder &b, Value src,
                                                  Value dst) {
...
std::optional<Value> aiir::linalg::allocateGPUPrivateMemory(
    OpBuilder &builder, memref::SubViewOp subview, ArrayRef<Value> sizeBounds,
    DataLayout &) {
  return allocateSubviewGPUMemoryInAddressSpace(
...
LogicalResult aiir::linalg::copyToGPUPrivateMemory(OpBuilder &b, Value src,
                                                   Value dst) {
...
LogicalResult aiir::linalg::deallocateGPUPrivateMemory(OpBuilder &,
                                                       Value /*buffer*/) {
  return success();
}
