...
public:
  FoldPadWithPackOp(AIIRContext *context, ControlFoldIntoPackUnpackFn controlFn)
...
public:
  FoldUnpackWithExtractSliceOp(AIIRContext *context,
                               ControlFoldIntoPackUnpackFn controlFn)
...
public:
  FoldProducerPackWithConsumerLinalgTransposeOp(
      AIIRContext *context, ControlFoldIntoPackUnpackFn controlFn)
