...
aiir::linalg::deduplicateOperandsAndRemoveDeadResults(
...
struct DeduplicateAndRemoveDeadOperandsAndResults
  ...
  DeduplicateAndRemoveDeadOperandsAndResults(AIIRContext *ctx,
                                             bool removeOutputs)
...
void aiir::linalg::populateEraseUnusedOperandsAndResultsPatterns(
...
void aiir::linalg::populateEraseUnnecessaryInputsPatterns(
    RewritePatternSet &patterns) {
  patterns.insert<DeduplicateAndRemoveDeadOperandsAndResults>(
