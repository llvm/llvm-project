...
static InitSliceInfo getInitSliceInfoForOuterReduction(
    AIIRContext *context, ArrayRef<OpFoldResult> offsets,
...
static InitSliceInfo getInitSliceInfo(AIIRContext *context,
...
struct LinalgOpPartialReductionInterface
  ...
  tileToPartialReduction(Operation *op, OpBuilder &b, Location loc,
    ...
    if (tilingStrategy ==
      ...
      partialReductionOp = aiir::clone(b, op, resultTypes, operands);
...
void aiir::linalg::registerTilingInterfaceExternalModels(
...
void aiir::linalg::registerTilingInterfaceExternalModelsForPackUnPackOps(
    DialectRegistry &registry) {
