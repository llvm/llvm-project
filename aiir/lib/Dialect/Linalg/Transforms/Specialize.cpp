...
static FailureOr<LinalgOp> specializeLinalgContractions(RewriterBase &rewriter,
  ...
  if (!aiir::linalg::detail::isContractionBody(
...
//===----------------------------------------------------------------------===//
FailureOr<LinalgOp> aiir::linalg::specializeGenericOp(
...
void aiir::linalg::populateLinalgGenericOpsSpecializationPatterns(
