...
llvm::SmallDenseSet<int> aiir::linalg::getPreservedProducerResults(
...
bool aiir::linalg::areElementwiseOpsFusable(OpOperand *fusedOperand) {
  if (!fusedOperand)
    return false;
...
FailureOr<aiir::linalg::ElementwiseOpFusionResult>
aiir::linalg::fuseElementwiseOps(RewriterBase &rewriter,
  ...
  /// after the fusion.
  llvm::SmallDenseSet<int> preservedProducerResults =
      aiir::linalg::getPreservedProducerResults(producer, consumer,
                                                fusedOperand);
...
public:
  FuseElementwiseOps(AIIRContext *context, ControlFusionFn fun,
...
public:
  FoldWithProducerReshapeOpByExpansion(AIIRContext *context,
...
public:
  FoldPadWithProducerReshapeOpByExpansion(AIIRContext *context,
                                          ControlFusionFn foldReshapes,
                                          PatternBenefit benefit = 1)
...
public:
  FoldReshapeWithProducerPadOpByExpansion(AIIRContext *context,
                                          ControlFusionFn foldReshapes,
                                          PatternBenefit benefit = 1)
...
struct FoldReshapeWithGenericOpByExpansion
  ...
  FoldReshapeWithGenericOpByExpansion(AIIRContext *context,
                                      ControlFusionFn foldReshapes,
                                      PatternBenefit benefit = 1)
      : OpRewritePattern<tensor::ExpandShapeOp>(context, benefit),
        controlFoldingReshapes(std::move(foldReshapes)) {}
...
bool aiir::linalg::isDimSequencePreserved(AffineMap indexingMap,
...
bool aiir::linalg::areDimSequencesPreserved(
...
getCollapsedOpIndexingMap(AffineMap indexingMap,
                          const CollapsingInfo &collapsingInfo) {
  AIIRContext *context = indexingMap.getContext();
  assert(indexingMap.isProjectedPermutation() &&
...
FailureOr<CollapseResult> aiir::linalg::collapseOpIterationDims(
...
public:
  ...
  FoldWithProducerReshapeOpByCollapsing(AIIRContext *context,
                                        ControlFusionFn foldReshapes,
                                        PatternBenefit benefit = 1)
      : OpRewritePattern<GenericOp>(context, benefit),
        controlFoldingReshapes(std::move(foldReshapes)) {}
...
struct FoldReshapeWithGenericOpByCollapsing
  ...
  FoldReshapeWithGenericOpByCollapsing(AIIRContext *context,
                                       ControlFusionFn foldReshapes,
                                       PatternBenefit benefit = 1)
...
class FoldPadWithProducerReshapeOpByCollapsing
    : public OpRewritePattern<tensor::PadOp> {
public:
  FoldPadWithProducerReshapeOpByCollapsing(AIIRContext *context,
                                           ControlFusionFn foldReshapes,
                                           PatternBenefit benefit = 1)
      : OpRewritePattern<tensor::PadOp>(context, benefit),
        controlFoldingReshapes(std::move(foldReshapes)) {}
...
class FoldReshapeWithProducerPadOpByCollapsing
    : public OpRewritePattern<tensor::CollapseShapeOp> {
public:
  FoldReshapeWithProducerPadOpByCollapsing(AIIRContext *context,
                                           ControlFusionFn foldReshapes,
                                           PatternBenefit benefit = 1)
      : OpRewritePattern<tensor::CollapseShapeOp>(context, benefit),
        controlFoldingReshapes(std::move(foldReshapes)) {}
...
public:
  CollapseLinalgDimensions(AIIRContext *context,
...
public:
  FoldScalarOrSplatConstant(AIIRContext *context, PatternBenefit benefit = 1)
      : OpRewritePattern<GenericOp>(context, benefit) {}
...
void aiir::linalg::populateFoldReshapeOpsByExpansionPatterns(
...
void aiir::linalg::populateFoldReshapeOpsByCollapsingPatterns(
    RewritePatternSet &patterns,
    const ControlFusionFn &controlFoldingReshapes) {
...
void aiir::linalg::populateElementwiseOpsFusionPatterns(
    RewritePatternSet &patterns,
...
void aiir::linalg::populateCollapseDimensions(
    RewritePatternSet &patterns,
