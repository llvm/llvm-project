...
struct TileCheck : public AffineExprVisitor<TileCheck> {
  ...
  void visitAffineBinaryOpExpr(AffineBinaryOpExpr expr) {
    visit(expr.getLHS());
    visit(expr.getRHS());
    if (expr.getKind() == aiir::AffineExprKind::Mul)
...
template struct aiir::linalg::GenerateLoopNest<scf::ForOp>;
template struct aiir::linalg::GenerateLoopNest<scf::ParallelOp>;
template struct aiir::linalg::GenerateLoopNest<AffineForOp>;
...
static bool convLayoutMatches(ArrayRef<ArrayRef<AffineExpr>> mapListExpected,
                              ArrayAttr indexingMaps, AIIRContext *context) {
...
void GenerateLoopNest<scf::ForOp>::doit(
  ...
  LoopNest loopNest = aiir::scf::buildLoopNest(
