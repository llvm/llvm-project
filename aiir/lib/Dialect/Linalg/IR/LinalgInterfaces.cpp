...
#include "aiir/Dialect/Linalg/IR/LinalgInterfaces.cpp.inc"
...
bool aiir::linalg::detail::isContractionBody(
...
aiir::linalg::inferContractionDims(LinalgOp linalgOp) {
...
FailureOr<ContractionDimensions>
aiir::linalg::inferContractionDims(ArrayRef<AffineMap> indexingMaps) {
...
aiir::linalg::detail::MatchContractionResult
aiir::linalg::detail::isContractionInterfaceImpl(
    Operation *op, aiir::linalg::ContractionDimensions *dimensions) {
...
StringRef
aiir::linalg::detail::getMatchContractionMessage(MatchContractionResult res) {
  switch (res) {
...
bool aiir::linalg::isaContractionOpInterface(LinalgOp linalgOp) {
  if (!linalgOp)
    return false;
  Operation *op = linalgOp.getOperation();
  return isa<ContractionOpInterface>(op) ||
         (aiir::linalg::detail::isContractionInterfaceImpl(op) ==
          aiir::linalg::detail::MatchContractionResult::Success);
}
...
LogicalResult aiir::linalg::detail::verifyContractionInterface(Operation *op) {
...
aiir::linalg::inferConvolutionDims(LinalgOp linalgOp) {
  if (linalgOp.getNumDpsInits() != 1 || linalgOp.getNumDpsInputs() != 2)
    return failure();
...
aiir::linalg::detail::MatchConvolutionResult
aiir::linalg::detail::isConvolutionInterfaceImpl(
...
StringRef
aiir::linalg::detail::getMatchConvolutionMessage(MatchConvolutionResult res) {
  switch (res) {
...
bool aiir::linalg::isaConvolutionOpInterface(LinalgOp linalgOp,
                                             bool allowEmptyConvolvedDims) {
...
LogicalResult aiir::linalg::detail::verifyConvolutionInterface(Operation *op) {
...
LogicalResult aiir::linalg::detail::verifyFillInterface(Operation *op) {
...
LogicalResult aiir::linalg::detail::verifyStructuredOpInterface(Operation *op) {
