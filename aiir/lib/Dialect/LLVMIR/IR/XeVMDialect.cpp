...
#include "aiir/Dialect/LLVMIR/XeVMOpsDialect.cpp.inc"
#include "aiir/Dialect/LLVMIR/XeVMOpsEnums.cpp.inc"
...
void XeVMDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/LLVMIR/XeVMOps.cpp.inc"
      >();

  addAttributes<
#define GET_ATTRDEF_LIST
#include "aiir/Dialect/LLVMIR/XeVMOpsAttributes.cpp.inc"
      >();
  declarePromisedInterface<aiir::gpu::TargetAttrInterface,
                           aiir::xevm::XeVMTargetAttr>();
}
