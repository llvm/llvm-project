...
static constexpr llvm::StringRef kGenericAlloc = "_aiir_memref_to_llvm_alloc";
static constexpr llvm::StringRef kGenericAlignedAlloc =
    "_aiir_memref_to_llvm_aligned_alloc";
static constexpr llvm::StringRef kGenericFree = "_aiir_memref_to_llvm_free";
...
aiir::LLVM::lookupOrCreateFn(OpBuilder &b, Operation *moduleOp, StringRef name,
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintI64Fn(OpBuilder &b, Operation *moduleOp,
                                     SymbolTableCollection *symbolTables) {
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintU64Fn(OpBuilder &b, Operation *moduleOp,
                                     SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintF16Fn(OpBuilder &b, Operation *moduleOp,
                                     SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintBF16Fn(OpBuilder &b, Operation *moduleOp,
                                      SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintF32Fn(OpBuilder &b, Operation *moduleOp,
                                     SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintF64Fn(OpBuilder &b, Operation *moduleOp,
                                     SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateApFloatPrintFn(OpBuilder &b, Operation *moduleOp,
                                         SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
static LLVM::LLVMPointerType getCharPtr(AIIRContext *context) {
  return LLVM::LLVMPointerType::get(context);
}

static LLVM::LLVMPointerType getVoidPtr(AIIRContext *context) {
  // A char pointer and void ptr are the same in LLVM IR.
  return getCharPtr(context);
}

FailureOr<LLVM::LLVMFuncOp> aiir::LLVM::lookupOrCreatePrintStringFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintOpenFn(OpBuilder &b, Operation *moduleOp,
                                      SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintCloseFn(OpBuilder &b, Operation *moduleOp,
                                       SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintCommaFn(OpBuilder &b, Operation *moduleOp,
                                       SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreatePrintNewlineFn(OpBuilder &b, Operation *moduleOp,
                                         SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateMallocFn(OpBuilder &b, Operation *moduleOp,
                                   Type indexType,
                                   SymbolTableCollection *symbolTables) {
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateAlignedAllocFn(OpBuilder &b, Operation *moduleOp,
                                         Type indexType,
                                         SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateFreeFn(OpBuilder &b, Operation *moduleOp,
                                 SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateGenericAllocFn(OpBuilder &b, Operation *moduleOp,
                                         Type indexType,
                                         SymbolTableCollection *symbolTables) {
...
FailureOr<LLVM::LLVMFuncOp> aiir::LLVM::lookupOrCreateGenericAlignedAllocFn(
...
FailureOr<LLVM::LLVMFuncOp>
aiir::LLVM::lookupOrCreateGenericFreeFn(OpBuilder &b, Operation *moduleOp,
                                        SymbolTableCollection *symbolTables) {
  return lookupOrCreateReservedFn(
...
FailureOr<LLVM::LLVMFuncOp> aiir::LLVM::lookupOrCreateMemRefCopyFn(
    OpBuilder &b, Operation *moduleOp, Type indexType,
