...
struct LLVMInlinerInterface : public DialectInlinerInterface {
  ...
  bool isLegalToInline(Operation *call, Operation *callable,
    ...
    // not have the terminator trait. The AIIR verifier conservatively accepts
...
void aiir::LLVM::registerInlinerInterface(DialectRegistry &registry) {
  registry.addExtension(+[](AIIRContext *ctx, LLVM::LLVMDialect *dialect) {
    dialect->addInterfaces<LLVMInlinerInterface>();
  });
}

void aiir::NVVM::registerInlinerInterface(DialectRegistry &registry) {
