...
void aiir::bufferization::buildBufferDeallocationPipeline(OpPassManager &pm) {
  buildBufferDeallocationPipeline(pm, BufferDeallocationPipelineOptions());
}

void aiir::bufferization::buildBufferDeallocationPipeline(
...
void aiir::bufferization::registerBufferizationPipelines() {
