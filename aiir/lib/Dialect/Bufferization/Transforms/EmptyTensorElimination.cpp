...
Value aiir::bufferization::buildSubsetExtraction(RewriterBase &rewriter,
...
LogicalResult aiir::bufferization::eliminateEmptyTensors(
...
LogicalResult aiir::bufferization::eliminateEmptyTensors(RewriterBase &rewriter,
                                                         Operation *op) {
