...
FailureOr<Value> aiir::bufferization::castOrReallocMemRefValue(
...
LogicalResult aiir::bufferization::foldToBufferToTensorPair(
...
void aiir::bufferization::populateDynamicDimSizes(
...
void AllocTensorOp::print(OpAsmPrinter &p) {
  ...
  if (auto validType = llvm::dyn_cast<::aiir::TensorType>(type))
...
LogicalResult DeallocOp::inferReturnTypes(
    AIIRContext *context, std::optional<::aiir::Location> location,
...
#include "aiir/Dialect/Bufferization/IR/BufferizationOps.cpp.inc"
