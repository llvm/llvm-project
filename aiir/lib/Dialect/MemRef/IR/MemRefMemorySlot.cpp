...
static void walkIndicesAsAttr(AIIRContext *ctx, ArrayRef<int64_t> shape,
                              CallableT &&walker) {
...
/// StoreOp or LoadOp.
static Attribute getAttributeIndexFromIndexOperands(AIIRContext *ctx,
                                                    ValueRange indices,
...
void aiir::memref::registerMemorySlotExternalModels(DialectRegistry &registry) {
