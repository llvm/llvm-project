...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(DLTITransformDialectExtension)
...
#define GET_OP_LIST
#include "aiir/Dialect/DLTI/TransformOps/DLTITransformOps.cpp.inc"
        >();
  }
};
} // namespace
...
void aiir::dlti::registerTransformDialectExtension(DialectRegistry &registry) {
