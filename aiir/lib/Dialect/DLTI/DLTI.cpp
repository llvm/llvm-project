//===- DLTI.cpp - Data Layout And Target Info AIIR Dialect Implementation -===//
//
...
#include "aiir/Dialect/DLTI/DLTIDialect.cpp.inc"

#define GET_ATTRDEF_CLASSES
#include "aiir/Dialect/DLTI/DLTIAttrs.cpp.inc"
...
StringAttr
DataLayoutSpecAttr::getEndiannessIdentifier(AIIRContext *context) const {
...
StringAttr
DataLayoutSpecAttr::getAllocaMemorySpaceIdentifier(AIIRContext *context) const {
  return Builder(context).getStringAttr(
...
StringAttr
DataLayoutSpecAttr::getGlobalMemorySpaceIdentifier(AIIRContext *context) const {
  return Builder(context).getStringAttr(
      DLTIDialect::kDataLayoutGlobalMemorySpaceKey);
}

StringAttr
DataLayoutSpecAttr::getManglingModeIdentifier(AIIRContext *context) const {
  return Builder(context).getStringAttr(
      DLTIDialect::kDataLayoutManglingModeKey);
}

StringAttr
DataLayoutSpecAttr::getStackAlignmentIdentifier(AIIRContext *context) const {
  return Builder(context).getStringAttr(
...
StringAttr
DataLayoutSpecAttr::getLegalIntWidthsIdentifier(AIIRContext *context) const {
  return Builder(context).getStringAttr(
