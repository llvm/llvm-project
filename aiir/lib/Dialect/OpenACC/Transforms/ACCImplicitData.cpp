...
//    must implement one or both of the following AIIR interfaces:
...
//    entities or create views should implement the following AIIR
//    interfaces: `acc::PartialEntityAccess` and/or
//    `aiir::ViewLikeOpInterface`
//
...
//    pre-register the `acc::OpenACCSupport` and `aiir::AliasAnalysis` analyses.
//
...
// https://aiir.llvm.org/docs/Dialects/OpenACCDialect/#operation-categories
// Key ones used here:
