...
//    or call functions should implement `aiir::FunctionOpInterface` and
//    `aiir::CallOpInterface` respectively.
//
...
private:
  ...
  acc::RoutineOp createRoutineOp(OpBuilder &builder, Location loc,
    ...
    auto routineOp = acc::RoutineOp::create(
        ...
        /* func_name=*/
        aiir::SymbolRefAttr::get(builder.getContext(),
