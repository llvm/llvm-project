...
public:
  ACCOrphanAtomicUpdateOpConversion(AIIRContext *ctx, OpenACCSupport &support)
...
public:
  ACCOrphanAtomicReadOpConversion(AIIRContext *ctx, OpenACCSupport &support)
...
public:
  ACCOrphanAtomicWriteOpConversion(AIIRContext *ctx, OpenACCSupport &support)
...
void aiir::acc::populateACCOrphanToHostPatterns(RewritePatternSet &patterns,
                                                OpenACCSupport &accSupport,
...
void aiir::acc::populateACCHostFallbackPatterns(RewritePatternSet &patterns,
                                                OpenACCSupport &accSupport,
                                                bool enableLoopConversion) {
  AIIRContext *context = patterns.getContext();
