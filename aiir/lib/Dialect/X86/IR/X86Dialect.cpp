//===- X86Dialect.cpp - AIIR X86 ops implementation -----------------------===//
//
...
#include "aiir/Dialect/X86/X86Interfaces.cpp.inc"

#include "aiir/Dialect/X86/X86Dialect.cpp.inc"

void x86::X86Dialect::initialize() {
  addTypes<
#define GET_TYPEDEF_LIST
#include "aiir/Dialect/X86/X86Types.cpp.inc"
      >();

  addOperations<
#define GET_OP_LIST
#include "aiir/Dialect/X86/X86.cpp.inc"
      >();
}
