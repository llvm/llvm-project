...
using namespace aiir::x86::avx2;
using namespace aiir::x86::avx2::inline_asm;
using namespace aiir::x86::avx2::intrin;

Value aiir::x86::avx2::inline_asm::mm256BlendPsAsm(ImplicitLocOpBuilder &b,
                                                   Value v1, Value v2,
                                                   uint8_t mask) {
  auto asmDialectAttr =
...
Value aiir::x86::avx2::intrin::mm256UnpackLoPs(ImplicitLocOpBuilder &b,
                                               Value v1, Value v2) {
  return vector::ShuffleOp::create(b, v1, v2,
                                   ArrayRef<int64_t>{0, 8, 1, 9, 4, 12, 5, 13});
}

Value aiir::x86::avx2::intrin::mm256UnpackHiPs(ImplicitLocOpBuilder &b,
                                               Value v1, Value v2) {
...
Value aiir::x86::avx2::intrin::mm256ShufflePs(ImplicitLocOpBuilder &b, Value v1,
...
Value aiir::x86::avx2::intrin::mm256Permute2f128Ps(ImplicitLocOpBuilder &b,
                                                   Value v1, Value v2,
                                                   uint8_t mask) {
  SmallVector<int64_t> shuffleMask;
...
Value aiir::x86::avx2::intrin::mm256BlendPs(ImplicitLocOpBuilder &b, Value v1,
                                            Value v2, uint8_t mask) {
...
void aiir::x86::avx2::transpose4x8xf32(ImplicitLocOpBuilder &ib,
...
void aiir::x86::avx2::transpose8x8xf32(ImplicitLocOpBuilder &ib,
                                       MutableArrayRef<Value> vs) {
  auto vt = VectorType::get({8}, Float32Type::get(ib.getContext()));
  (void)vt;
...
public:
  ...
  TransposeOpLowering(LoweringOptions loweringOptions, AIIRContext *context,
                      int benefit)
  ...
  LogicalResult matchAndRewrite(vector::TransposeOp op,
    ...
    auto srcGtOneDims = aiir::vector::isTranspose2DSlice(op);
...
void aiir::x86::avx2::populateSpecializedTransposeLoweringPatterns(
