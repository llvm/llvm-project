...
static LogicalResult convertFPowIOp(math::FPowIOp op,
  ...
  if (isNegative) {
    auto &sem = dyn_cast<aiir::FloatType>(getElementTypeOrSelf(baseType))
                    .getFloatSemantics();
    Value zero =
...
static LogicalResult convertPowfOp(math::PowFOp op, PatternRewriter &rewriter) {
  ...
  auto &sem =
      cast<aiir::FloatType>(getElementTypeOrSelf(typeB)).getFloatSemantics();
  APFloat valueB(sem);
...
void aiir::math::populateExpansionPatterns(RewritePatternSet &patterns,
