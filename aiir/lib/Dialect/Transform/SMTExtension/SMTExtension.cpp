...
#include "aiir/Dialect/Transform/SMTExtension/SMTExtensionOps.h"
...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SMTExtension)

  SMTExtension() {
    registerTransformOps<
#define GET_OP_LIST
#include "aiir/Dialect/Transform/SMTExtension/SMTExtensionOps.cpp.inc"
        >();
  }
};
} // namespace

void aiir::transform::registerSMTExtension(DialectRegistry &dialectRegistry) {
