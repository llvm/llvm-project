...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PDLExtension)
...
#include "aiir/Dialect/Transform/PDLExtension/PDLExtensionOps.cpp.inc"
    ...
    addCustomInitializationStep([](AIIRContext *context) {
...
void aiir::transform::registerPDLExtension(DialectRegistry &dialectRegistry) {
