...
transform::TransformRewriter::TransformRewriter(
    AIIRContext *ctx, ErrorCheckingTrackingListener *listener)
...
transform::detail::checkApplyToOne(Operation *transformOp,
  ...
  auto emitDiag = [&]() {
    auto diag = aiir::emitError(transformOpLoc);
...
#include "aiir/Dialect/Transform/Interfaces/TransformInterfaces.cpp.inc"
#include "aiir/Dialect/Transform/Interfaces/TransformTypeInterfaces.cpp.inc"
