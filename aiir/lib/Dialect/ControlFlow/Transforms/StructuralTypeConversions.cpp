...
void aiir::cf::populateCFStructuralTypeConversions(
...
void aiir::cf::populateCFStructuralTypeConversionTarget(
...
void aiir::cf::populateCFStructuralTypeConversionsAndLegality(
    const TypeConverter &typeConverter, RewritePatternSet &patterns,
