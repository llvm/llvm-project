...
static xegpu::LayoutAttr createLayoutAttr(
    AIIRContext *ctx, ArrayRef<int32_t> sgLayout, ArrayRef<int32_t> sgData,
...
getLayoutAttrFromOperands(AIIRContext *ctx, transform::TransformState &state,
                          TransformOpInterface transformOp,
                          ArrayRef<::aiir::OpFoldResult> mixedSgLayout,
                          ArrayRef<::aiir::OpFoldResult> mixedSgData,
                          ArrayRef<::aiir::OpFoldResult> mixedInstData,
...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(XeGPUTransformDialectExtension)
...
#define GET_OP_LIST
#include "aiir/Dialect/XeGPU/TransformOps/XeGPUTransformOps.cpp.inc"
      >();
}
} // namespace
...
void aiir::xegpu::registerTransformDialectExtension(DialectRegistry &registry) {
