//===---- XeGPULayoutImpl.cpp - AIIR Utilities for XeGPUOps
//------------------===//
//
...
template void
xegpu::removeLayoutAttr<aiir::OpResult>(const aiir::OpResult &result);

// Explicit instantiation for OpOperand
template void
xegpu::removeLayoutAttr<aiir::OpOperand>(const aiir::OpOperand &operand);
...
static xegpu::DistributeLayoutAttr setupGenericLoadAnchorLayout(
    xegpu::LayoutKind layoutKind, aiir::AIIRContext *context,
...
setupGenericStoreAnchorLayout(xegpu::LayoutKind layoutKind,
                              aiir::AIIRContext *context, bool isChunkedStore,
