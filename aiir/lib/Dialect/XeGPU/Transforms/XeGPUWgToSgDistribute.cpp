...
struct WgToSgElementwiseOp : public ConversionPattern {
  WgToSgElementwiseOp(AIIRContext *ctx)
...
struct UnrealizedConversionCastOpPattern
    : public OpConversionPattern<aiir::UnrealizedConversionCastOp> {
  using OpConversionPattern<
      aiir::UnrealizedConversionCastOp>::OpConversionPattern;

  aiir::LogicalResult
  matchAndRewrite(aiir::UnrealizedConversionCastOp op, OneToNOpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
