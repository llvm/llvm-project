//===- ToolUtilities.cpp - AIIR Tool Utilities ----------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines common utilities for implementing AIIR tools.
//
//===----------------------------------------------------------------------===//
...
LogicalResult
aiir::splitAndProcessBuffer(std::unique_ptr<llvm::MemoryBuffer> originalBuffer,
