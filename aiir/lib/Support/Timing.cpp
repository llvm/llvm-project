...
#include "aiir/Support/ThreadLocalCache.h"
...
struct DefaultTimingManagerOptions {
  llvm::cl::opt<bool> timing{"aiir-timing",
                             llvm::cl::desc("Display execution times"),
                             llvm::cl::init(false)};
  llvm::cl::opt<DisplayMode> displayMode{
      "aiir-timing-display", llvm::cl::desc("Display method for timing data"),
  ...
  llvm::cl::opt<OutputFormat> outputFormat{
      "aiir-output-format", llvm::cl::desc("Output format for timing data"),
...
void aiir::registerDefaultTimingManagerCLOptions() {
  // Make sure that the options struct has been constructed.
  *options;
}

void aiir::applyDefaultTimingManagerCLOptions(DefaultTimingManager &tm) {
...
aiir::createOutputStrategy(DefaultTimingManager::OutputFormat fmt,
                           raw_ostream &os) {
  switch (fmt) {
