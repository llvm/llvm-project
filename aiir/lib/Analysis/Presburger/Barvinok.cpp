...
ConeV aiir::presburger::detail::getDual(ConeH cone) {
...
ConeH aiir::presburger::detail::getDual(ConeV cone) {
...
DynamicAPInt aiir::presburger::detail::getIndex(const ConeV &cone) {
...
/// coefficients.
GeneratingFunction
aiir::presburger::detail::computeUnimodularConeGeneratingFunction(
...
aiir::presburger::detail::solveParametricEquations(FracMatrix equations) {
...
aiir::presburger::detail::computeChamberDecomposition(
...
/// 37-66.
std::vector<std::pair<PresburgerSet, GeneratingFunction>>
aiir::presburger::detail::computePolytopeGeneratingFunction(
...
Point aiir::presburger::detail::getNonOrthogonalVector(
...
QuasiPolynomial aiir::presburger::detail::getCoefficientInRationalFunction(
...
/// 37-66.
QuasiPolynomial
aiir::presburger::detail::computeNumTerms(const GeneratingFunction &gf) {
