...
void aiir::getForwardSlice(Operation *op, SetVector<Operation *> *forwardSlice,
...
void aiir::getForwardSlice(Value root, SetVector<Operation *> *forwardSlice,
...
LogicalResult aiir::getBackwardSlice(Operation *op,
                                     SetVector<Operation *> *backwardSlice,
                                     const BackwardSliceOptions &options) {
  DenseSet<Operation *> visited;
  visited.insert(op);
...
LogicalResult aiir::getBackwardSlice(Value root,
                                     SetVector<Operation *> *backwardSlice,
                                     const BackwardSliceOptions &options) {
...
SetVector<Operation *>
aiir::getSlice(Operation *op, const BackwardSliceOptions &backwardSliceOptions,
...
/// matching reductions without pre-defined semantics in core AIIR. It's up to
...
Value aiir::matchReduction(ArrayRef<BlockArgument> iterCarriedArgs,
                           unsigned redPos,
