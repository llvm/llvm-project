...
LogicalResult aiir::getFlattenedAffineExpr(
...
LogicalResult aiir::getFlattenedAffineExprs(
...
static bool detectAsMod(const FlatLinearConstraints &cst, unsigned pos,
                        ...
                        int64_t ubConst, AIIRContext *context,
...
std::pair<AffineMap, AffineMap> FlatLinearConstraints::getLowerAndUpperBound(
    ...
    ArrayRef<AffineExpr> localExprs, AIIRContext *context,
    bool closedUB) const {
...
static bool detectAsExpr(const FlatLinearConstraints &cst, unsigned pos,
                         unsigned idx, AIIRContext *context,
                         SmallVectorImpl<AffineExpr> &exprs) {
...
static void computeUnknownVars(const FlatLinearConstraints &cst,
                               AIIRContext *context, unsigned offset,
                               unsigned num,
                               SmallVectorImpl<AffineExpr> &memo) {
...
static std::optional<AffineExpr> getAsExpr(const FlatLinearConstraints &cst,
                                           unsigned pos, AIIRContext *context,
...
std::optional<int64_t> FlatLinearConstraints::getConstantBoundOnDimSize(
    AIIRContext *context, unsigned pos, AffineMap *lb, AffineMap *ub,
...
IntegerSet FlatLinearConstraints::getAsIntegerSet(AIIRContext *context) const {
...
AffineMap aiir::alignAffineMapWithValues(AffineMap map, ValueRange operands,
...
LogicalResult
aiir::getMultiAffineFunctionFromMap(AffineMap map,
