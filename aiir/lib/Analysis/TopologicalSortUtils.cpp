...
bool aiir::computeTopologicalSorting(
...
SetVector<Block *> aiir::getBlocksSortedByDominance(Region &region) {
...
SetVector<Operation *>
aiir::topologicalSort(const SetVector<Operation *> &toSort) {
