...
FailureOr<std::unique_ptr<AIIRRemarkStreamerBase>>
LLVMRemarkStreamer::createToFile(llvm::StringRef path,
  ...
  return std::unique_ptr<AIIRRemarkStreamerBase>(std::move(impl));
}
