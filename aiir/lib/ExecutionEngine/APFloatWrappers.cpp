...
//===----------------------------------------------------------------------===//
//
// This file exposes the APFloat infrastructure to AIIR programs as a runtime
// library. APFloat is a software implementation of floating point arithmetics.
//
// On the AIIR side, floating-point values must be bitcasted to 64-bit integers
...
#ifdef _WIN32
#ifndef AIIR_APFLOAT_WRAPPERS_EXPORT
#ifdef aiir_apfloat_wrappers_EXPORTS
// We are building this library
#define AIIR_APFLOAT_WRAPPERS_EXPORT __declspec(dllexport)
#else
// We are using this library
#define AIIR_APFLOAT_WRAPPERS_EXPORT __declspec(dllimport)
#endif // aiir_apfloat_wrappers_EXPORTS
#endif // AIIR_APFLOAT_WRAPPERS_EXPORT
#else
// Non-windows: use visibility attributes.
#define AIIR_APFLOAT_WRAPPERS_EXPORT __attribute__((visibility("default")))
#endif // _WIN32

/// Binary operations without rounding mode.
#define APFLOAT_BINARY_OP(OP)                                                  \
  AIIR_APFLOAT_WRAPPERS_EXPORT int64_t _aiir_apfloat_##OP(                     \
...
#define APFLOAT_BINARY_OP_ROUNDING_MODE(OP, ROUNDING_MODE)                     \
  AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t _aiir_apfloat_##OP(                    \
      int32_t semantics, uint64_t a, uint64_t b) {                             \
    const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(        \
        static_cast<llvm::APFloatBase::Semantics>(semantics));                 \
    unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);           \
...
AIIR_APFLOAT_WRAPPERS_EXPORT void printApFloat(int32_t semantics, uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t
_aiir_apfloat_convert(int32_t inSemantics, int32_t outSemantics, uint64_t a) {
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t _aiir_apfloat_convert_to_int(
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t _aiir_apfloat_convert_from_int(
...
AIIR_APFLOAT_WRAPPERS_EXPORT int8_t _aiir_apfloat_compare(int32_t semantics,
                                                          uint64_t a,
                                                          uint64_t b) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t _aiir_apfloat_neg(int32_t semantics,
                                                        uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t _aiir_apfloat_abs(int32_t semantics,
                                                        uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT bool _aiir_apfloat_isfinite(int32_t semantics,
                                                         uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT bool _aiir_apfloat_isinfinite(int32_t semantics,
                                                           uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT bool _aiir_apfloat_isnormal(int32_t semantics,
                                                         uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT bool _aiir_apfloat_isnan(int32_t semantics,
                                                      uint64_t a) {
  const llvm::fltSemantics &sem = llvm::APFloatBase::EnumToSemantics(
      static_cast<llvm::APFloatBase::Semantics>(semantics));
  unsigned bitWidth = llvm::APFloatBase::semanticsSizeInBits(sem);
...
AIIR_APFLOAT_WRAPPERS_EXPORT uint64_t
_aiir_apfloat_fused_multiply_add(int32_t semantics, uint64_t operand,
