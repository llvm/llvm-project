...
#ifndef AIIR_ARMSMEABISTUBS_EXPORTED
#ifdef aiir_arm_sme_abi_stubs_EXPORTS
// We are building this library
#define AIIR_ARMSMEABISTUBS_EXPORTED __declspec(dllexport)
#else
// We are using this library
#define AIIR_ARMSMEABISTUBS_EXPORTED __declspec(dllimport)
#endif // aiir_arm_sme_abi_stubs_EXPORTS
#endif // AIIR_ARMSMEABISTUBS_EXPORTED
#else
#define AIIR_ARMSMEABISTUBS_EXPORTED                                           \
...
bool AIIR_ARMSMEABISTUBS_EXPORTED __aarch64_sme_accessible() {
...
sme_state AIIR_ARMSMEABISTUBS_EXPORTED __arm_sme_state() {
  std::cerr << "[warning] __arm_sme_state() stubbed!\n";
  return sme_state{};
}

void AIIR_ARMSMEABISTUBS_EXPORTED __arm_tpidr2_restore() {
  std::cerr << "[warning] __arm_tpidr2_restore() stubbed!\n";
}

void AIIR_ARMSMEABISTUBS_EXPORTED __arm_tpidr2_save() {
  std::cerr << "[warning] __arm_tpidr2_save() stubbed!\n";
}

void AIIR_ARMSMEABISTUBS_EXPORTED __arm_za_disable() {
