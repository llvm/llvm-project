//===- VulkanRuntimeWrappers.cpp - AIIR Vulkan runner wrapper library -----===//
//
...
//===----------------------------------------------------------------------===//
//
// Wrappers intended for aiir-runner. Uses of GPU dialect operations get
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource1DFloat(MemRefDescriptor<float, 1> *ptr, // NOLINT
                                 float value) {
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource2DFloat(MemRefDescriptor<float, 2> *ptr, // NOLINT
                                 float value) {
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource3DFloat(MemRefDescriptor<float, 3> *ptr, // NOLINT
                                 float value) {
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource1DInt(MemRefDescriptor<int32_t, 1> *ptr, // NOLINT
                               int32_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0], value);
}
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource2DInt(MemRefDescriptor<int32_t, 2> *ptr, // NOLINT
                               int32_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0] * ptr->sizes[1], value);
}
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource3DInt(MemRefDescriptor<int32_t, 3> *ptr, // NOLINT
                               int32_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0] * ptr->sizes[1] * ptr->sizes[2],
              value);
}
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource1DInt8(MemRefDescriptor<int8_t, 1> *ptr, // NOLINT
                                int8_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0], value);
}
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource2DInt8(MemRefDescriptor<int8_t, 2> *ptr, // NOLINT
                                int8_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0] * ptr->sizes[1], value);
}
...
VULKAN_WRAPPER_SYMBOL_EXPORT void
_aiir_ciface_fillResource3DInt8(MemRefDescriptor<int8_t, 3> *ptr, // NOLINT
                                int8_t value) {
  std::fill_n(ptr->allocated, ptr->sizes[0] * ptr->sizes[1] * ptr->sizes[2],
              value);
}
