//===- CudaRuntimeWrappers.cpp - AIIR CUDA API wrapper library ------------===//
//
...
// Also adds some debugging helpers that are helpful when writing AIIR code to
// run on GPUs.
//
//===----------------------------------------------------------------------===//
...
#ifdef AIIR_ENABLE_CUDA_CUSPARSE
#include "cusparse.h"
#ifdef AIIR_ENABLE_CUDA_CUSPARSELT
#include "cusparseLt.h"
#endif // AIIR_ENABLE_CUDA_CUSPARSELT
#endif // AIIR_ENABLE_CUDA_CUSPARSE

#ifdef _WIN32
#include <malloc.h>
#define AIIR_CUDA_WRAPPERS_EXPORT __declspec(dllexport)
#else
#define AIIR_CUDA_WRAPPERS_EXPORT __attribute__((visibility("default")))
#endif // _WIN32
...
static bool isDebugEnabled() {
  const char *kDebugEnvironmentVariable = "AIIR_CUDA_DEBUG";
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT CUmodule
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT CUmodule mgpuModuleLoadJIT(void *data,
                                                                int optLevel) {
  ScopedContext scopedContext;
  CUmodule module = nullptr;
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuModuleUnload(CUmodule module) {
  CUDA_REPORT_IF_ERROR(cuModuleUnload(module));
}

extern "C" AIIR_CUDA_WRAPPERS_EXPORT CUfunction
...
// generated AIIR code.
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT CUstream mgpuStreamCreate() {
  ScopedContext scopedContext;
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuStreamDestroy(CUstream stream) {
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuStreamWaitEvent(CUstream stream,
                                                              CUevent event) {
  CUDA_REPORT_IF_ERROR(cuStreamWaitEvent(stream, event, /*flags=*/0));
}

extern "C" AIIR_CUDA_WRAPPERS_EXPORT CUevent mgpuEventCreate() {
  ScopedContext scopedContext;
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuEventDestroy(CUevent event) {
  CUDA_REPORT_IF_ERROR(cuEventDestroy(event));
}

extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuEventSynchronize(CUevent event) {
  CUDA_REPORT_IF_ERROR(cuEventSynchronize(event));
}

extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuEventRecord(CUevent event,
                                                          CUstream stream) {
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuMemFree(void *ptr,
                                                      CUstream /*stream*/) {
...
///
/// Helper functions for writing aiir example code
///
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuMemHostUnregister(void *ptr) {
  ScopedContext scopedContext;
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuSetDefaultDevice(int32_t device) {
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuLaunchClusterKernel(
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuTensorMapEncodeTiled(
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void *mgpuTensorMapEncodeTiledMemref(
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuCreateSparseEnv() {
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuDestroySparseEnv() {
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT intptr_t mgpuSpMVBufferSize(
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuSpMV(int32_t ma, void *a, void *x,
                                                   void *y, int32_t ctp,
                                                   void *buf,
                                                   CUstream /*stream*/) {
  assert(cusparse_env && "client did not call mgpuCreateSparseEnv()");
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT intptr_t
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuSpMM(int32_t ma, int32_t mb,
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuSDDMM(int32_t ma, int32_t mb,
                                                    void *a, void *b, void *c,
                                                    int32_t ctp, void *buf,
                                                    CUstream /*stream*/) {
  assert(cusparse_env && "client did not call mgpuCreateSparseEnv()");
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT intptr_t mgpuSpGEMMWorkEstimation(
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuCreateSparseLtEnv() {
  // ScopedContext is for cuda initialization.
  ScopedContext scopedContext;
...
extern "C" AIIR_CUDA_WRAPPERS_EXPORT void mgpuDestroySparseLtEnv() {
