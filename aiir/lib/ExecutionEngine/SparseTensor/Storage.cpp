...
AIIR_SPARSETENSOR_FOREVERY_FIXED_O(IMPL_GETPOSITIONS)
...
AIIR_SPARSETENSOR_FOREVERY_FIXED_O(IMPL_GETCOORDINATES)
...
AIIR_SPARSETENSOR_FOREVERY_FIXED_O(IMPL_GETCOORDINATESBUFFER)
...
AIIR_SPARSETENSOR_FOREVERY_V(IMPL_GETVALUES)
