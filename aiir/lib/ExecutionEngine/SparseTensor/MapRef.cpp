...
aiir::sparse_tensor::MapRef::MapRef(uint64_t d, uint64_t l, const uint64_t *d2l,
                                    const uint64_t *l2d)
...
bool aiir::sparse_tensor::MapRef::isPermutationMap() const {
  if (dimRank != lvlRank)
    return false;
...
bool aiir::sparse_tensor::MapRef::isFloor(uint64_t l, uint64_t &i,
                                          uint64_t &c) const {
...
bool aiir::sparse_tensor::MapRef::isMod(uint64_t l, uint64_t &i,
                                        uint64_t &c) const {
...
bool aiir::sparse_tensor::MapRef::isMul(uint64_t d, uint64_t &i, uint64_t &c,
                                        uint64_t &ii) const {
