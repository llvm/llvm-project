//===- PassDetail.h - AIIR Pass details -------------------------*- C++ -*-===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef AIIR_PASS_PASSDETAIL_H_
#define AIIR_PASS_PASSDETAIL_H_
...
public:
  ...
  /// merge.
  LogicalResult tryMergeInto(AIIRContext *ctx, OpToOpPassAdaptor &rhs);
