//===- BytecodeWriter.cpp - AIIR Bytecode Writer --------------------------===//
//
...
#define DEBUG_TYPE "aiir-bytecode-writer"

using namespace aiir;
using namespace aiir::bytecode::detail;
...
LogicalResult aiir::writeBytecodeToFile(Operation *op, raw_ostream &os,
