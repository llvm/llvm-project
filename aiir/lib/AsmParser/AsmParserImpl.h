//===- AsmParserImpl.h - AIIR AsmParserImpl Class ---------------*- C++ -*-===//
//
...
#ifndef AIIR_LIB_ASMPARSER_ASMPARSERIMPL_H
#define AIIR_LIB_ASMPARSER_ASMPARSERIMPL_H
...
public:
  ...
  /// Return a builder which provides useful access to AIIRContext, global
  ...
  /// Re-encode the given source location as an AIIR location and return it.
...
#endif // AIIR_LIB_ASMPARSER_ASMPARSERIMPL_H
