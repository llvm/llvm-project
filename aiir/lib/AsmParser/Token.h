//===- Token.h - AIIR Token Interface ---------------------------*- C++ -*-===//
//
...
#ifndef AIIR_LIB_PARSER_TOKEN_H
#define AIIR_LIB_PARSER_TOKEN_H
...
/// This represents a token in the AIIR syntax.
class Token {
public:
  enum Kind {
