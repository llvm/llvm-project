//===- DialectSymbolParser.cpp - AIIR Dialect Symbol Parser  --------------===//
//
...
/// hooking into the main AIIR parsing logic.
...
Attribute aiir::parseAttribute(StringRef attrStr, AIIRContext *context,
...
Type aiir::parseType(StringRef typeStr, AIIRContext *context, size_t *numRead,
                     bool isKnownNullTerminated) {
