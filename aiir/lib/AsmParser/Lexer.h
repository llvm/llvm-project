//===- Lexer.h - AIIR Lexer Interface ---------------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the AIIR Lexer class.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_LIB_ASMPARSER_LEXER_H
#define AIIR_LIB_ASMPARSER_LEXER_H
...
class Lexer {
public:
  explicit Lexer(const llvm::SourceMgr &sourceMgr, AIIRContext *context,
...
#endif // AIIR_LIB_ASMPARSER_LEXER_H
