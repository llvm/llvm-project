//===- Parser.h - AIIR Base Parser Class ------------------------*- C++ -*-===//
//
...
#ifndef AIIR_LIB_ASMPARSER_PARSER_H
#define AIIR_LIB_ASMPARSER_PARSER_H
...
public:
  ...
  AIIRContext *getContext() const { return state.config.getContext(); }
...
#endif // AIIR_LIB_ASMPARSER_PARSER_H
