...
static LogicalResult generateLocationsFromIR(StringRef fileName, Operation *op,
  ...
  if (filepath.empty()) {
    if (std::error_code error = llvm::sys::fs::createTemporaryFile(
            "aiir_snapshot", "tmp.aiir", filepath)) {
      return op->emitError()
...
void aiir::generateLocationsFromIR(raw_ostream &os, StringRef fileName,
...
/// IR to the given file, and using the printed locations within that file. If
/// `filename` is empty, a temporary file is generated instead.
LogicalResult aiir::generateLocationsFromIR(StringRef fileName, Operation *op,
                                            OpPrintingFlags flags) {
...
/// IR to the given file, and using the printed locations within that file. If
/// `filename` is empty, a temporary file is generated instead.
LogicalResult aiir::generateLocationsFromIR(StringRef fileName, StringRef tag,
                                            Operation *op,
                                            OpPrintingFlags flags) {
