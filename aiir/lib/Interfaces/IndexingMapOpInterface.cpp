...
#include "aiir/Interfaces/IndexingMapOpInterface.h"

using namespace aiir;

namespace aiir {
#include "aiir/Interfaces/IndexingMapOpInterface.cpp.inc"
} // namespace aiir
...
LogicalResult aiir::IndexingMapOpInterface::verifyImpl() {
