...
ConstantIntRanges
aiir::intrange::inferIndexOp(const InferRangeFn &inferFn,
...
ConstantIntRanges aiir::intrange::extRange(const ConstantIntRanges &range,
...
ConstantIntRanges aiir::intrange::extUIRange(const ConstantIntRanges &range,
                                             unsigned destWidth) {
  APInt umin = range.umin().zext(destWidth);
  APInt umax = range.umax().zext(destWidth);
...
ConstantIntRanges aiir::intrange::extSIRange(const ConstantIntRanges &range,
                                             unsigned destWidth) {
  APInt smin = range.smin().sext(destWidth);
  APInt smax = range.smax().sext(destWidth);
...
ConstantIntRanges aiir::intrange::truncRange(const ConstantIntRanges &range,
                                             unsigned int destWidth) {
...
ConstantIntRanges
aiir::intrange::inferAdd(ArrayRef<ConstantIntRanges> argRanges,
...
ConstantIntRanges
aiir::intrange::inferSub(ArrayRef<ConstantIntRanges> argRanges,
                         OverflowFlags ovfFlags) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferMul(ArrayRef<ConstantIntRanges> argRanges,
                         OverflowFlags ovfFlags) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferDivU(ArrayRef<ConstantIntRanges> argRanges) {
...
ConstantIntRanges
aiir::intrange::inferCeilDivU(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferDivS(ArrayRef<ConstantIntRanges> argRanges) {
...
ConstantIntRanges
aiir::intrange::inferCeilDivS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferFloorDivS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferRemS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
  const APInt &lhsMin = lhs.smin(), &lhsMax = lhs.smax(), &rhsMin = rhs.smin(),
              &rhsMax = rhs.smax();
...
ConstantIntRanges
aiir::intrange::inferRemU(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferMaxS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferMaxU(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferMinS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferMinU(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferAnd(ArrayRef<ConstantIntRanges> argRanges) {
...
ConstantIntRanges
aiir::intrange::inferOr(ArrayRef<ConstantIntRanges> argRanges) {
  auto [lhsZeros, lhsOnes] = widenBitwiseBounds(argRanges[0]);
  auto [rhsZeros, rhsOnes] = widenBitwiseBounds(argRanges[1]);
...
ConstantIntRanges
aiir::intrange::inferXor(ArrayRef<ConstantIntRanges> argRanges) {
...
ConstantIntRanges
aiir::intrange::inferShl(ArrayRef<ConstantIntRanges> argRanges,
                         OverflowFlags ovfFlags) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferShrS(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
ConstantIntRanges
aiir::intrange::inferShrU(ArrayRef<ConstantIntRanges> argRanges) {
  const ConstantIntRanges &lhs = argRanges[0], &rhs = argRanges[1];
...
std::optional<bool> aiir::intrange::evaluatePred(CmpPredicate pred,
                                                 const ConstantIntRanges &lhs,
                                                 const ConstantIntRanges &rhs) {
...
ConstantIntRanges
aiir::intrange::inferShapedDimOpInterface(ShapedDimOpInterface op,
...
ConstantIntRanges
aiir::intrange::inferAffineExpr(AffineExpr expr,
