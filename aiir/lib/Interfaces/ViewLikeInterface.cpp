//===- ViewLikeInterface.cpp - View-like operations in AIIR ---------------===//
//
...
#include "aiir/Interfaces/ViewLikeInterface.cpp.inc"

LogicalResult aiir::verifyListOfOperandsOrIntegers(Operation *op,
                                                   StringRef name,
...
SliceBoundsVerificationResult aiir::verifyInBoundsSlice(
...
LogicalResult
aiir::detail::verifyOffsetSizeAndStrideOp(OffsetSizeAndStrideOpInterface op) {
...
void aiir::printDynamicIndexList(OpAsmPrinter &printer, Operation *op,
                                 OperandRange values,
...
ParseResult aiir::parseDynamicIndexList(
    OpAsmParser &parser,
...
bool aiir::detail::sameOffsetsSizesAndStrides(
...
unsigned aiir::detail::getNumDynamicEntriesUpToIdx(ArrayRef<int64_t> staticVals,
                                                   unsigned idx) {
