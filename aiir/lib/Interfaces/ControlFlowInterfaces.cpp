...
#include "aiir/Interfaces/ControlFlowInterfaces.cpp.inc"
...
bool aiir::insideMutuallyExclusiveRegions(Operation *a, Operation *b) {
...
Region *aiir::getEnclosingRepetitiveRegion(Operation *op) {
...
Region *aiir::getEnclosingRepetitiveRegion(Value value) {
...
struct MakeRegionBranchOpSuccessorInputsDead : public RewritePattern {
  MakeRegionBranchOpSuccessorInputsDead(AIIRContext *context, StringRef name,
...
struct RemoveDeadRegionBranchOpSuccessorInputs : public RewritePattern {
  RemoveDeadRegionBranchOpSuccessorInputs(AIIRContext *context, StringRef name,
                                          PatternBenefit benefit = 1)
      : RewritePattern(name, benefit, context) {}
...
struct RemoveDuplicateSuccessorInputUses : public RewritePattern {
  RemoveDuplicateSuccessorInputUses(AIIRContext *context, StringRef name,
                                    PatternBenefit benefit = 1)
      : RewritePattern(name, benefit, context) {}
...
struct InlineRegionBranchOp : public RewritePattern {
  InlineRegionBranchOp(AIIRContext *context, StringRef name,
...
void aiir::populateRegionBranchOpInterfaceCanonicalizationPatterns(
...
void aiir::populateRegionBranchOpInterfaceInliningPattern(
