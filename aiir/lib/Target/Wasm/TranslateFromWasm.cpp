...
#include "aiir/Target/Wasm/WasmBinaryEncoding.h"
...
public:
  ...
  FailureOr<LimitType> parseLimit(AIIRContext *ctx) {
  ...
  FailureOr<Type> parseValueType(AIIRContext *ctx) {
  ...
  FailureOr<GlobalTypeRecord> parseGlobalType(AIIRContext *ctx) {
  ...
  FailureOr<TupleType> parseResultType(AIIRContext *ctx) {
  ...
  FailureOr<FunctionType> parseFunctionType(AIIRContext *ctx) {
    FileLineColLoc typeLoc = getLocation();
  ...
  FailureOr<TableType> parseTableType(AIIRContext *ctx) {
  ...
  FailureOr<ImportDesc> parseImportDesc(AIIRContext *ctx) {
  ...
  llvm::FailureOr<BlockTypeParseResult> parseBlockType(AIIRContext *ctx) {
...
public:
  WasmBinaryParser(llvm::SourceMgr &sourceMgr, AIIRContext *ctx)
      : builder{ctx}, ctx{ctx} {
