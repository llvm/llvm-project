//===- DataLayoutImporter.cpp - LLVM to AIIR data layout conversion -------===//
//
...
FloatType aiir::LLVM::detail::getFloatType(AIIRContext *context,
                                           unsigned width) {
  switch (width) {
  case 16:
...
aiir::translateDataLayout(const llvm::DataLayout &dataLayout,
                          AIIRContext *context) {
