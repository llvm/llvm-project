...
//===----------------------------------------------------------------------===//
//
// This file implements the translation between an AIIR loop annotations and
// the corresponding LLVMIR metadata representation.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_LIB_TARGET_LLVMIR_LOOPANNOTATIONTRANSLATION_H_
#define AIIR_LIB_TARGET_LLVMIR_LOOPANNOTATIONTRANSLATION_H_
...
public:
  ...
  /// Returns the LLVM metadata corresponding to an aiir LLVM dialect access
  /// group attribute.
...
#endif // AIIR_LIB_TARGET_LLVMIR_LOOPANNOTATIONTRANSLATION_H_
