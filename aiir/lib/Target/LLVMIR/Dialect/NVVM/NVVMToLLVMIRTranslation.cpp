...
//===----------------------------------------------------------------------===//
//
// This file implements a translation between the AIIR NVVM dialect and
// LLVM IR.
//
//===----------------------------------------------------------------------===//
...
using aiir::LLVM::detail::createIntrinsicCall;
...
static llvm::Intrinsic::ID
getTcgen05LdIntrinsicID(aiir::NVVM::Tcgen05LdStShape shape, uint32_t num) {
...
static llvm::Intrinsic::ID
getTcgen05StIntrinsicID(aiir::NVVM::Tcgen05LdStShape shape, uint32_t num) {
  llvm::Intrinsic::ID Shape16x64b[] = {
...
public:
  ...
  convertOperation(Operation *op, llvm::IRBuilderBase &builder,
    ...
    Operation &opInst = *op;
#include "aiir/Dialect/LLVMIR/NVVMConversions.inc"
...
void aiir::registerNVVMDialectTranslation(DialectRegistry &registry) {
...
void aiir::registerNVVMDialectTranslation(AIIRContext &context) {
