//===- OpenMPCommon.cpp - Utils for translating AIIR dialect to LLVM IR----===//
//
...
llvm::Constant *
aiir::LLVM::createSourceLocStrFromLocation(Location loc,
...
llvm::Constant *
aiir::LLVM::createMappingInformation(Location loc,
                                     llvm::OpenMPIRBuilder &builder) {
  uint32_t strLen;
