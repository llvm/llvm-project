...
LogicalResult aiir::LLVMImportInterface::convertUnregisteredIntrinsic(
  ...
  SmallVector<Value> aiirOperands;
  SmallVector<NamedAttribute> aiirAttrs;
  if (failed(moduleImport.convertIntrinsicArguments(
          llvmOperands, llvmOpBundles, /*requiresOpBundles=*/false,
          /*immArgPositions=*/{}, /*immArgAttrNames=*/{}, aiirOperands,
          aiirAttrs)))
    return failure();
  ...
  auto op = CallIntrinsicOp::create(
      ...
      ValueRange{aiirOperands}, FastmathFlagsAttr{});
...
LogicalResult aiir::LLVMImportInterface::convertIntrinsic(
    OpBuilder &builder, llvm::CallInst *inst,
