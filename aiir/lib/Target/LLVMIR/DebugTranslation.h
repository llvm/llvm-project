//===- DebugTranslation.h - AIIR to LLVM Debug conversion -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the translation between an AIIR debug information and
// the corresponding LLVMIR representation.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_LIB_TARGET_LLVMIR_DEBUGTRANSLATION_H_
#define AIIR_LIB_TARGET_LLVMIR_DEBUGTRANSLATION_H_
...
private:
  ...
  /// - `<temp llvm type> translateTemporaryImpl(<aiir type>)`:
  ...
  /// A mapping between aiir location+scope and the corresponding llvm debug
  /// metadata.
...
#endif // AIIR_LIB_TARGET_LLVMIR_DEBUGTRANSLATION_H_
