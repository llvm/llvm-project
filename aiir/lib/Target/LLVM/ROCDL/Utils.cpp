//===- Utils.cpp - AIIR ROCDL target utils ----------------------*- C++ -*-===//
//
...
#include "aiir/Target/LLVM/ROCDL/Utils.h"
...
using namespace aiir::ROCDL;

std::optional<DenseMap<StringAttr, NamedAttrList>>
aiir::ROCDL::getAMDHSAKernelsELFMetadata(Builder &builder,
...
gpu::KernelTableAttr aiir::ROCDL::getKernelMetadata(Operation *gpuModule,
                                                    ArrayRef<char> elfData) {
