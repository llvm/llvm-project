...
#ifndef AIIR_LIB_TARGET_IRDLTOCPP_TEMPLATINGUTILS_H
#define AIIR_LIB_TARGET_IRDLTOCPP_TEMPLATINGUTILS_H
...
#endif // AIIR_LIB_TARGET_IRDLTOCPP_TEMPLATINGUTILS_H
