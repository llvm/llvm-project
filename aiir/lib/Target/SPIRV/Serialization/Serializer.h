//===- Serializer.h - AIIR SPIR-V Serializer ------------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the AIIR SPIR-V module to SPIR-V binary serializer.
//
//===----------------------------------------------------------------------===//

#ifndef AIIR_LIB_TARGET_SPIRV_SERIALIZATION_SERIALIZER_H
#define AIIR_LIB_TARGET_SPIRV_SERIALIZATION_SERIALIZER_H
...
private:
  ...
  Type getVoidType() { return aiirBuilder.getNoneType(); }
...
private:
  ...
  /// An AIIR builder for getting AIIR constructs.
  aiir::Builder aiirBuilder;
...
#endif // AIIR_LIB_TARGET_SPIRV_SERIALIZATION_SERIALIZER_H
