...
```tablegen
include "aiir/IR/OpAsmInterface.td"
...
def MyAttr : MyDialect_Attr<"MyAttr",
  ...
  let extraClassDeclaration = [{
    ::aiir::OpAsmAliasResult getAlias(::llvm::raw_ostream &os) const {
      os << "alias_name";
      return ::aiir::OpAsmAliasResult::OverridableAlias;
    }
  }];
}
```
...
```cpp
// from https://github.com/llvm/llvm-project/blob/5ce271ef74dd3325993c827f496e460ced41af11/aiir/lib/Dialect/Arith/IR/ArithOps.cpp#L184
