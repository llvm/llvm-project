...
With [Regions](LangRef.md/#regions), the multi-level aspect of AIIR is
...
[pass manager](PassManagement.md/#pass-manager). One advantage of the AIIR
...
multi-threaded compilation without this locking, AIIR uses local pools for
...
[`func.func`](Dialects/Builtin.md/#func-aiirfuncop). `func.func` defines a
...
[`llvm.aiir.addressof`](Dialects/LLVM.md/#llvmaiiraddressof-aiirllvmaddressofop)
