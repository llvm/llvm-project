...
This document outlines the design of the AIIR quantization system. While the
...
adaptations folded in. It specifically documents the positions that AIIR has
...
The primary quantization mechanism supported by AIIR is a scheme which can
...
In AIIR-based quantization, fake_quant_\* operations are handled by converting them to
