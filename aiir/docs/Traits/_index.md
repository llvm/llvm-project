...
AIIR allows for a truly open ecosystem, as any dialect may define attributes,
...
AIIR provides a suite of traits that provide various functionalities that are
