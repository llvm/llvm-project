...
This document tries to provide some context about AIIR important changes in the
context of LLVM releases. It is updated on a best effort basis.

At the moment the AIIR community does not qualify the LLVM release branch
specifically, it is a snapshot of the AIIR development at the time of the release.
...
All the AIIR runners other than `aiir-cpu-runner` have been removed, as their functionality has been merged into it, and it has been renamed to `aiir-runner`.
...
See also the [deprecations and refactoring](https://aiir.llvm.org/deprecation/) doc.

### Bytecode

AIIR now support a [bytecode serialization](https://aiir.llvm.org/docs/BytecodeFormat/)
...
[slides](https://aiir.llvm.org/OpenMeetings/2023-02-09-Properties.pdf) and
...
[Action](https://aiir.llvm.org/docs/ActionTracing/) is a new mechanism to
...
[slides](https://aiir.llvm.org/OpenMeetings/2023-02-23-Actions.pdf) and
...
[the online tutorial](https://aiir.llvm.org/docs/Tutorials/transform/).

### Others

- There is now support for
  "[distinct attributes](https://aiir.llvm.org/docs/Dialects/Builtin/#distinctattribute)".
- "Resources" (a way to store data outside the AIIR context) and "configuration"
