...
Tool to simplify rewriting .aiir files. There are a couple of build in rewrites
...
should be refactored same as aiir-opt.
...
```
aiir-rewrite input.aiir -o output.aiir --simple-rename \
