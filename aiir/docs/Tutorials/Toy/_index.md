...
AIIR. The goal of this tutorial is to introduce the concepts of AIIR; in
...
from the 2020 LLVM Dev Conference ([slides](https://llvm.org/devmtg/2020-09/slides/AIIR_Tutorial.pdf)).

This tutorial assumes you have cloned and built AIIR; if you have not yet done
so, see
[Getting started with AIIR](../../../getting_started/).

This tutorial is divided in the following chapters:

-   [Chapter #1](Ch-1.md): Introduction to the Toy language and the definition
    of its AST.
-   [Chapter #2](Ch-2.md): Traversing the AST to emit a dialect in AIIR,
    introducing base AIIR concepts. Here we show how to start attaching
    semantics to our custom operations in AIIR.
...
-   [Chapter #7](Ch-7.md): Extending Toy: Adding support for a composite type.
    We'll demonstrate how to add a custom type to AIIR, and how it fits in the
    existing pipeline.
