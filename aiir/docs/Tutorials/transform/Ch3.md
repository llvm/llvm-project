...
def ChangeCallTargetOp : Op<Transform_Dialect, "my.change_call_target",
  ...
  let extraClassDeclaration = [{
    ::aiir::DiagnosedSilenceableFailure applyToOne(
        ::aiir::transform::TransformRewriter &rewriter,
        ::aiir::func::CallOp call,
        ::aiir::transform::ApplyToEachResultList &results,
...
```c++
::aiir::DiagnosedSilenceableFailure ChangeCallTargetOp::applyToOne(
    ::aiir::transform::TransformRewriter &rewriter,
    ::aiir::func::CallOp call,
    ::aiir::transform::ApplyToEachResultList &results,
    ::aiir::transform::TransformState &state) {
...
aiir::transform::CallOpInterfaceHandleType::checkPayload(
...
We can then add the following code to `sequence.aiir` and run it with the interpreter.
...
::aiir::DiagnosedSilenceableFailure CallToOp::applyToOne(
    ::aiir::transform::TransformRewriter &rewriter,
    ::aiir::CallOpInterface call,
    ::aiir::transform::ApplyToEachResultList &results,
    ::aiir::transform::TransformState &state) {
...
```c++
::aiir::DiagnosedSilenceableFailure SomeOtherOp::apply(
    ::aiir::transform::TransformRewriter &rewriter,
