...
The NVVM dialect is AIIR's LLVM-IR-based, NVIDIA-specific backend dialect. It
models NVVM intrinsics and public ISA functionality and introduces NVIDIA
extensions to the AIIR/LLVM type system and address spaces (e.g., global,
...
All operations in the NVIDIA's instruction set have a custom form in AIIR. The mnemonic
