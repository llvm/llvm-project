...
using the pattern infrastructure or any other relevant AIIR component.
...
The Transform dialect relies on AIIR side effect modelling to enable
...
to the AIIR infrastructure. It aims to be minimally intrusive and opt-in.
