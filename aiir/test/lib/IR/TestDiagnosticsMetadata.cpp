...
struct TestDiagnosticMetadataPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestDiagnosticMetadataPass)
  ...
  void runOnOperation() override {
    ...
    ScopedDiagnosticHandler handler(&getContext(), [](aiir::Diagnostic &diag) {
      return aiir::success(
          llvm::none_of(diag.getMetadata(), [](aiir::DiagnosticArgument &arg) {
            return arg.getKind() == aiir::DiagnosticArgument::
