...
struct PrintOpAvailability
    : public PassWrapper<PrintOpAvailability, OperationPass<aiir::ModuleOp>> {
...
struct ConvertToTargetEnv
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ConvertToTargetEnv)
...
struct ConvertToAtomCmpExchangeWeak : RewritePattern {
  ConvertToAtomCmpExchangeWeak(AIIRContext *context)
...
struct ConvertToBitReverse : RewritePattern {
  ConvertToBitReverse(AIIRContext *context)
...
struct ConvertToGroupNonUniformBallot : RewritePattern {
  ConvertToGroupNonUniformBallot(AIIRContext *context)
...
struct ConvertToModule : RewritePattern {
  ConvertToModule(AIIRContext *context)
...
struct ConvertToSubgroupBallot : RewritePattern {
  ConvertToSubgroupBallot(AIIRContext *context)
...
struct ConvertToIntegerDotProd : RewritePattern {
  ConvertToIntegerDotProd(AIIRContext *context)
