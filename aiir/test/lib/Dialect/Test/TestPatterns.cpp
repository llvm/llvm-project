...
#include "aiir/Dialect/ControlFlow/Transforms/StructuralTypeConversions.h"
...
// the returned value in the AIIR output.
...
public:
  FoldingPattern(AIIRContext *context)
...
struct MakeOpEligible : public RewritePattern {
  MakeOpEligible(AIIRContext *context)
...
struct MoveBeforeParentOp : public RewritePattern {
  MoveBeforeParentOp(AIIRContext *context)
...
struct MoveAfterParentOp : public RewritePattern {
  MoveAfterParentOp(AIIRContext *context)
...
struct InlineBlocksIntoParent : public RewritePattern {
  InlineBlocksIntoParent(AIIRContext *context)
...
struct SplitBlockHere : public RewritePattern {
  SplitBlockHere(AIIRContext *context)
...
struct CloneRegionBeforeOp : public RewritePattern {
  CloneRegionBeforeOp(AIIRContext *context)
...
public:
  EraseFirstBlock(AIIRContext *context)
...
struct TestGreedyPatternDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestGreedyPatternDriver)
...
public:
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestStrictPatternDriver)
...
private:
  ...
  public:
    InsertSameOp(AIIRContext *context)
  ...
  public:
    ChangeBlockOp(AIIRContext *context)
  ...
  public:
    ImplicitChangeOp(AIIRContext *context)
...
struct TestWalkPatternDriver final
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestWalkPatternDriver)
...
struct TestReturnTypeDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestReturnTypeDriver)
...
struct TestDerivedAttributeDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestDerivedAttributeDriver)
...
struct TestDetachedSignatureConversion : public ConversionPattern {
  TestDetachedSignatureConversion(AIIRContext *ctx)
...
struct TestRegionRewriteBlockMovement : public ConversionPattern {
  TestRegionRewriteBlockMovement(AIIRContext *ctx)
...
struct TestRegionRewriteUndo : public RewritePattern {
  TestRegionRewriteUndo(AIIRContext *ctx)
...
struct TestCreateBlock : public RewritePattern {
  TestCreateBlock(AIIRContext *ctx)
...
struct TestCreateIllegalBlock : public RewritePattern {
  TestCreateIllegalBlock(AIIRContext *ctx)
...
struct TestValueReplace : public ConversionPattern {
  TestValueReplace(AIIRContext *ctx, const TypeConverter &converter)
...
struct TestUndoMoveOpBefore : public ConversionPattern {
  TestUndoMoveOpBefore(AIIRContext *ctx)
...
struct TestUndoBlockErase : public ConversionPattern {
  TestUndoBlockErase(AIIRContext *ctx)
...
struct TestUndoPropertiesModification : public ConversionPattern {
  TestUndoPropertiesModification(AIIRContext *ctx)
...
struct TestUndoMoveDetachedBlock : public ConversionPattern {
  TestUndoMoveDetachedBlock(AIIRContext *ctx)
...
struct TestDropOpSignatureConversion : public ConversionPattern {
  TestDropOpSignatureConversion(AIIRContext *ctx,
...
struct TestPassthroughInvalidOp : public ConversionPattern {
  TestPassthroughInvalidOp(AIIRContext *ctx, const TypeConverter &converter)
...
struct TestDropAndReplaceInvalidOp : public ConversionPattern {
  TestDropAndReplaceInvalidOp(AIIRContext *ctx, const TypeConverter &converter)
...
struct TestSplitReturnType : public ConversionPattern {
  TestSplitReturnType(AIIRContext *ctx)
...
struct TestChangeProducerTypeI32ToF32 : public ConversionPattern {
  TestChangeProducerTypeI32ToF32(AIIRContext *ctx)
...
struct TestChangeProducerTypeF32ToF64 : public ConversionPattern {
  TestChangeProducerTypeF32ToF64(AIIRContext *ctx)
      : ConversionPattern("test.type_producer", 1, ctx) {}
  LogicalResult
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
                  ConversionPatternRewriter &rewriter) const final {
...
struct TestChangeProducerTypeF32ToInvalid : public ConversionPattern {
  TestChangeProducerTypeF32ToInvalid(AIIRContext *ctx)
...
struct TestUpdateConsumerType : public ConversionPattern {
  TestUpdateConsumerType(AIIRContext *ctx)
...
struct TestNonRootReplacement : public RewritePattern {
  TestNonRootReplacement(AIIRContext *ctx)
...
public:
  TestEraseOp(AIIRContext *ctx) : ConversionPattern("test.erase_op", 1, ctx) {}
  LogicalResult
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
                  ConversionPatternRewriter &rewriter) const final {
...
public:
  TestReplaceWithValidProducer(AIIRContext *ctx)
...
public:
  TestReplaceWithValidConsumer(AIIRContext *ctx, const TypeConverter &converter)
      : ConversionPattern(converter, "test.replace_with_valid_consumer", 1,
                          ctx) {}
  TestReplaceWithValidConsumer(AIIRContext *ctx)
...
public:
  TestRepetitive1ToNConsumer(AIIRContext *ctx)
...
public:
  TestMultiple1ToNReplacement(AIIRContext *ctx, const TypeConverter &converter)
...
public:
  TestTypeConsumerOpPattern(AIIRContext *ctx, const TypeConverter &converter)
...
public:
  TestPostOrderLegalization(AIIRContext *ctx, const TypeConverter &converter)
...
struct TestLegalizePatternDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestLegalizePatternDriver)
  ...
  void runOnOperation() override {
    ...
    aiir::populateAnyFunctionOpInterfaceTypeConversionPattern(patterns,
                                                              converter);
    aiir::populateCallOpTypeConversionPattern(patterns, converter);
...
struct TestRemappedValue
    : public aiir::PassWrapper<TestRemappedValue, OperationPass<>> {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestRemappedValue)
  ...
  void runOnOperation() override {
    ...
    if (failed(aiir::applyFullConversion(getOperation(), target,
                                         std::move(patterns)))) {
      signalPassFailure();
    }
  }
...
struct RemoveTestDialectOps : public RewritePattern {
  RemoveTestDialectOps(AIIRContext *context)
...
struct TestUnknownRootOpDriver
    : public aiir::PassWrapper<TestUnknownRootOpDriver, OperationPass<>> {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestUnknownRootOpDriver)
...
struct RewriteDynamicOp : public RewritePattern {
  RewriteDynamicOp(AIIRContext *context)
...
struct TestRewriteDynamicOpDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestRewriteDynamicOpDriver)
...
struct TestReplaceWithLegalOp : public ConversionPattern {
  TestReplaceWithLegalOp(const TypeConverter &converter, AIIRContext *ctx)
...
struct TestTypeConversionDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestTypeConversionDriver)
  ...
  void runOnOperation() override {
    ...
    aiir::cf::populateCFStructuralTypeConversionsAndLegality(converter,
                                                             patterns, target);
...
struct TestUndoBlocksMerge : public ConversionPattern {
  TestUndoBlocksMerge(AIIRContext *ctx)
...
struct TestMergeBlocksPatternDriver
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestMergeBlocksPatternDriver)
...
struct TestFoldTypeConvertingOp
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestFoldTypeConvertingOp)
