//===- TestDialect.cpp - AIIR Dialect for Testing -------------------------===//
//
...
DictionaryAttr
test::getPropertiesAsAttribute(AIIRContext *ctx,
...
Attribute MyPropStruct::asAttribute(AIIRContext *ctx) const {
...
LogicalResult test::readFromAiirBytecode(DialectBytecodeReader &reader,
                                         MyPropStruct &prop) {
  StringRef str;
...
void test::writeToAiirBytecode(DialectBytecodeWriter &writer,
                               MyPropStruct &prop) {
...
DictionaryAttr test::getPropertiesAsAttribute(AIIRContext *ctx,
