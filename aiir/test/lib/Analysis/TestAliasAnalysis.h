//===- TestAliasAnalysis.h - AIIR Test Utility ------------------*- C++ -*-===//
//
...
#ifndef AIIR_TEST_LIB_ANALYSIS_ALIASANALYSIS_H
#define AIIR_TEST_LIB_ANALYSIS_ALIASANALYSIS_H
...
#endif // AIIR_TEST_LIB_ANALYSIS_ALIASANALYSIS_H
