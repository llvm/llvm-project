...
struct TestAliasAnalysisPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestAliasAnalysisPass)
...
struct TestAliasAnalysisModRefPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestAliasAnalysisModRefPass)
...
static bool isFuncArg(Value val) {
  ...
  return aiir::isa_and_nonnull<FunctionOpInterface>(
...
static bool isRestrict(Value val) {
  ...
  auto func =
      aiir::cast<FunctionOpInterface>(blockArg.getOwner()->getParentOp());
...
struct TestAliasAnalysisExtendingPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(TestAliasAnalysisExtendingPass)
