# RUN: env AIIR_RUNNER_UTILS=%aiir_runner_utils AIIR_C_RUNNER_UTILS=%aiir_c_runner_utils %PYTHON %s 2>&1 | FileCheck %s
...
AIIR_RUNNER_UTILS = os.getenv(
    "AIIR_RUNNER_UTILS", "../../../../lib/libaiir_runner_utils.so"
)
AIIR_C_RUNNER_UTILS = os.getenv(
    "AIIR_C_RUNNER_UTILS", "../../../../lib/libaiir_c_runner_utils.so"
)
...
llvm.func @none() {
  llvm.return
    ...
    """
        ...
        # CHECK: aiir.execution_engine.ExecutionEngine._CAPIPtr
        ...
        # CHECK: _aiirExecutionEngine.ExecutionEngine
    ...
    with Context():
      ...
      func.func private @printMemrefF32(memref<*xf32>) attributes { llvm.emit_c_interface }
        ...
        if sys.platform == "win32":
            shared_libs = [
                "../../../../bin/aiir_runner_utils.dll",
                "../../../../bin/aiir_c_runner_utils.dll",
            ]
        elif sys.platform == "darwin":
            shared_libs = [
                "../../../../lib/libaiir_runner_utils.dylib",
                "../../../../lib/libaiir_c_runner_utils.dylib",
            ]
        else:
            shared_libs = [
                AIIR_RUNNER_UTILS,
    ...
    try:
        with Context():
            ...
            execution_engine = ExecutionEngine(
                lowerToLLVM(module),
                opt_level=3,
                # Loading AIIR_C_RUNNER_UTILS is necessary even though we don't actually run the code (i.e., call printF32)
                ...
                shared_libs=[AIIR_C_RUNNER_UTILS],
                enable_pic=True,
            )
