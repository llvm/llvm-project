...
import aiir.dialects.memref as memref
import aiir.extras.types as T
from aiir.dialects.memref import _infer_memref_subview_result_type
from aiir.ir import *
    ...
    with Context() as ctx, Location.unknown(ctx):
        ...
        with InsertionPoint(module.body):
            ...
            try:
                ...
                # CHECK: Only inferring from python or aiir integer constant is supported
                print(e)
