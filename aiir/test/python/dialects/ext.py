...
def testExtDialectWithAttrInOp():
    ...
    with Context(), Location.unknown():
        ...
        # CHECK:   }
        # CHECK: }
        print(TestAttrInOp._aiir_module)
