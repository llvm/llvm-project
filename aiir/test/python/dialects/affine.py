...
from aiir.ir import *
from aiir.dialects import func
from aiir.dialects import arith
from aiir.dialects import memref
from aiir.dialects import affine
import aiir.extras.types as T
...
def test_double_AtomicRMWKindAttr_registration():
    from aiir.dialects import _affine_enum_gen
