...
from aiir.ir import Context, Location, Module, IntegerType, InsertionPoint
...
TESTS_TO_SKIP = [
    ...
    "test_execution_engine__testInvalidModule_multi_threaded",  # aiirExecutionEngineCreate calls thread-unsafe llvm::raw_ostream
    ...
    "test_dialects_transform_interpreter__include_multi_threaded",  # aiir::transform::PrintOp::apply(aiir::transform::TransformRewriter...) calls thread-unsafe llvm::raw_ostream
    "test_dialects_transform_interpreter__transform_options_multi_threaded",  # aiir::transform::PrintOp::apply(aiir::transform::TransformRewriter...) calls thread-unsafe llvm::raw_ostream
    "test_dialects_transform_interpreter__print_self_multi_threaded",  # aiir::transform::PrintOp::apply(aiir::transform::TransformRewriter...) call thread-unsafe llvm::raw_ostream
    "test_ir_diagnostic_handler__testDiagnosticCallbackException_multi_threaded",  # aiirEmitError calls thread-unsafe llvm::raw_ostream
    "test_ir_module__testParseSuccess_multi_threaded",  # aiirOperationDump calls thread-unsafe llvm::raw_ostream
...
TESTS_TO_XFAIL = [
    ...
    "test_dialects_transform_interpreter__print_other_multi_threaded",  # Fatal Python error: Aborted or aiir::transform::PrintOp::apply(aiir::transform::TransformRewriter...) is not thread-safe
