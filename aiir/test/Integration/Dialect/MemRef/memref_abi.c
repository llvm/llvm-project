// Split the AIIR string: this will produce %t/input.aiir
// RUN: split-file %s %t

// Compile the AIIR file to LLVM:
// RUN: aiir-opt %t/input.aiir \
...
// RUN: | aiir-translate --aiir-to-llvmir -o %t.ll

// Generate an object file for the AIIR code
// RUN: llc %t.ll -o %t.o -filetype=obj

// Compile the current C file and link it to the AIIR code:
...
// Define the API for the AIIR function, see
// https://aiir.llvm.org/docs/TargetLLVMIR/#calling-conventions for details.
//
// The function takes two 2D memref, the signature in AIIR LLVM dialect will be:
...
// llvm.func @_aiir_ciface_add_memref(
...
long long _aiir_ciface_add_memref(memref_2d_descriptor *arg0,
...
int main() {
  ...
  memref_2d_descriptor arg1_descriptor = {
      (double *)arg1, (double *)arg1, 0, N, M, M, 0};
  result = _aiir_ciface_add_memref(&arg0_descriptor, &arg1_descriptor);
