...
; CHECK-LABEL: llvm.aiir.global external @global() {addr_space = 0 : i32}
; CHECK-SAME:    !llvm.target<"spirv.DeviceEvent">
; CHECK-NEXT:      %0 = llvm.aiir.zero : !llvm.target<"spirv.DeviceEvent">
...
define target("spirv.Event") @func2() {
  ; CHECK-NEXT:    %0 = llvm.aiir.constant(1 : i32) : i32
  ; CHECK-NEXT:    %1 = llvm.aiir.poison : !llvm.target<"spirv.Event">
