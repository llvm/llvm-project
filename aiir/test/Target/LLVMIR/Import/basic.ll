...
; RUN: aiir-translate -import-llvm -aiir-print-debuginfo %s | FileCheck %s --check-prefix=CHECK-DBG
...
; CHECK: %[[c2:[0-9]+]] = llvm.aiir.constant(2 : i32) : i32
; CHECK: %[[c1:[0-9]+]] = llvm.aiir.constant(true) : i1
; CHECK: %[[c43:[0-9]+]] = llvm.aiir.constant(43 : i32) : i32
; CHECK: %[[c42:[0-9]+]] = llvm.aiir.constant(42 : i32) : i32
define internal dso_local i32 @f1(i64 %a) norecurse {
entry:
; CHECK: %{{[0-9]+}} = llvm.inttoptr %arg0 : i64 to !llvm.ptr
  %aa = inttoptr i64 %a to ptr
; CHECK-DBG: llvm.aiir.addressof @global : !llvm.ptr loc(#[[UNKNOWN_LOC]])
; %[[addrof:[0-9]+]] = llvm.aiir.addressof @global : !llvm.ptr
; %[[addrof2:[0-9]+]] = llvm.aiir.addressof @global : !llvm.ptr
