...
; CHECK: llvm.aiir.global external @foo(42 : i64) comdat(@__llvm_global_comdat::@foo)
@foo = global i64 42, comdat
; CHECK: llvm.aiir.global external @bar(42 : i64) comdat(@__llvm_global_comdat::@foo)
...
; CHECK: llvm.aiir.global external @foobar
; CHECK-NOT: llvm.comdat
