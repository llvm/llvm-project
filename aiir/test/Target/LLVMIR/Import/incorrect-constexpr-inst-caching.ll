...
; CHECK-DAG: llvm.aiir.constant(8 : i32) : i32
; CHECK-DAG: llvm.aiir.addressof @str0 : !llvm.ptr
; CHECK-DAG: llvm.aiir.constant(0 : i32) : i32
; CHECK-DAG: llvm.aiir.constant(1 : i32) : i32
; CHECK-DAG: llvm.getelementptr
; CHECK-DAG: llvm.aiir.undef : !llvm.struct<"my_struct", (i32, ptr)>
; CHECK-DAG: llvm.insertvalue
; CHECK-DAG: llvm.insertvalue
; CHECK-DAG: llvm.aiir.constant(7 : i32) : i32
; CHECK-DAG: llvm.aiir.addressof @str1 : !llvm.ptr
; CHECK-DAG: llvm.aiir.constant(2 : i32) : i32
; CHECK-DAG: llvm.aiir.constant(3 : i32) : i32
; CHECK-DAG: llvm.getelementptr
; CHECK-DAG: llvm.aiir.undef : !llvm.struct<"my_struct", (i32, ptr)>
; CHECK-DAG: llvm.insertvalue
; CHECK-DAG: llvm.insertvalue
; CHECK-DAG: llvm.aiir.undef : !llvm.array<2 x struct<"my_struct", (i32, ptr)>>
; CHECK-DAG: llvm.insertvalue
; CHECK-DAG: llvm.insertvalue
