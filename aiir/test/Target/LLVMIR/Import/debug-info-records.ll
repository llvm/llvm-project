; RUN: aiir-translate -import-llvm -aiir-print-debuginfo -convert-debug-rec-to-intrinsics -emit-expensive-warnings -split-input-file %s 2>&1 | FileCheck %s
; RUN: aiir-translate -import-llvm -aiir-print-debuginfo -emit-expensive-warnings -split-input-file %s 2>&1 | FileCheck %s
...
define void @func_with_debug(i64 %0) !dbg !3 {
  ...
  ; CHECK: %[[CST:.*]] = llvm.aiir.constant(1 : i32) : i32
...
!0 = distinct !DICompileUnit(language: DW_LANG_C, file: !1, producer: "AIIR", isOptimized: true, runtimeVersion: 0, splitDebugFilename: "test.dwo", emissionKind: FullDebug, nameTableKind: None)
!1 = !DIFile(filename: "foo.aiir", directory: "/test/")
