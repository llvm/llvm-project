...
; CHECK: llvm.aiir.ifunc external @foo : !llvm.func<void (ptr, i32)>, !llvm.ptr @resolve_foo {dso_local}
...
; CHECK: [[FPTR:%[0-9]+]] = llvm.aiir.addressof @foo
...
; CHECK-DAG: llvm.aiir.ifunc external @ifunc : !llvm.func<f32 (i64)>, !llvm.ptr @resolver_alias
@ifunc = ifunc float (i64), ptr @resolver_alias
; CHECK-DAG: llvm.aiir.ifunc external @ifunc2 : !llvm.func<f32 (i64)>, !llvm.ptr @resolver_alias_alias
...
; CHECK: llvm.aiir.ifunc linkonce_odr hidden @ifunc
...
; CHECK: llvm.aiir.ifunc private @ifunc {{.*}} {dso_local}
...
; CHECK: llvm.aiir.ifunc weak @ifunc
