; RUN: aiir-translate -import-llvm -split-input-file -verify-diagnostics %s | FileCheck %s
...
; CHECK-SAME: #llvm.aiir.module_flag<error, "wchar_size", 4 : i32>,
; CHECK-SAME: #llvm.aiir.module_flag<min, "PIC Level", 2 : i32>,
; CHECK-SAME: #llvm.aiir.module_flag<max, "PIE Level", 2 : i32>,
; CHECK-SAME: #llvm.aiir.module_flag<max, "uwtable", 2 : i32>,
; CHECK-SAME: #llvm.aiir.module_flag<max, "frame-pointer", 1 : i32>,
; CHECK-SAME: #llvm.aiir.module_flag<override, "probe-stack", "inline-asm">]
...
; CHECK: llvm.module_flags [#llvm.aiir.module_flag<append, "CG Profile", [
...
; CHECK: llvm.module_flags [#llvm.aiir.module_flag<error, "ProfileSummary",
