; RUN: aiir-translate -import-llvm -aiir-print-debuginfo -split-input-file %s | FileCheck %s
...
; CHECK: llvm.aiir.global external @data() {{{.*}}dbg_exprs = [#[[EXP1]], #[[EXP2]]]} : i64
