...
from aiir import ir
from aiir.dialects import gpu, scf, nvgpu, nvvm
...
def gemm_warp_specialized(a, b, d, num_stages):
    ...
    @NVDSL.aiir_gpu_launch(grid=grid, block=block, smem=smem_size_in_bytes)
...
if os.getenv("AIIR_NVDSL_PRINT_IR") != "1":
    # Verify AIIR with reference computation
