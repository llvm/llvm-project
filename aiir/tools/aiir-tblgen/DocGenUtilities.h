//===- DocGenUtilities.h - AIIR doc gen utilities ---------------*- C++ -*-===//
//
...
#ifndef AIIR_TOOLS_AIIRTBLGEN_DOCGENUTILITIES_H_
#define AIIR_TOOLS_AIIRTBLGEN_DOCGENUTILITIES_H_
...
#endif // AIIR_TOOLS_AIIRTBLGEN_DOCGENUTILITIES_H_
