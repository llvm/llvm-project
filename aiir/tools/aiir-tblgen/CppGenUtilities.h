//===- CppGenUtilities.h - AIIR cpp gen utilities ---------------*- C++ -*-===//
//
...
#ifndef AIIR_TOOLS_AIIRTBLGEN_CPPGENUTILITIES_H_
#define AIIR_TOOLS_AIIRTBLGEN_CPPGENUTILITIES_H_
...
#endif // AIIR_TOOLS_AIIRTBLGEN_CPPGENUTILITIES_H_
