...
bool aiir::tblgen::shouldEmitSpaceBefore(StringRef value,
...
bool aiir::tblgen::canFormatStringAsKeyword(
...
bool aiir::tblgen::isValidLiteral(StringRef value,
...
llvm::cl::opt<bool> aiir::tblgen::formatErrorIsFatal(
