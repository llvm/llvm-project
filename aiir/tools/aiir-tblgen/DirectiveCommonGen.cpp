...
// LLVM has multiple places (Clang, Flang, AIIR) where information about
...
// These can be represented as a Enum Attributes (EnumAttrDef) in AIIR
...
// Registers the generator to aiir-tblgen.
static aiir::GenRegistration genDirectiveDecls(
    "gen-directive-decl",
