...
// intrinsics to TableGen definitions for AIIR operations.
//
//===----------------------------------------------------------------------===//
...
public:
  ...
  /// Get the name of the operation to be used in AIIR.  Uses the appropriate
...
/// class and generates AIIR ODS definitions for those intrinsics that have
...
static bool emitIntrinsics(const RecordKeeper &records, llvm::raw_ostream &os) {
  ...
  os << "include \"aiir/Dialect/LLVMIR/LLVMOpBase.td\"\n";
  os << "include \"aiir/Interfaces/SideEffectInterfaces.td\"\n\n";
...
static aiir::GenRegistration genLLVMIRIntrinsics("gen-llvmir-intrinsics",
