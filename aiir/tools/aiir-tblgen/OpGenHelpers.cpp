//===- OpGenHelpers.cpp - AIIR operation generator helpers ----------------===//
//
...
aiir::tblgen::getRequestedOpDefinitions(const RecordKeeper &records) {
...
bool aiir::tblgen::isPythonReserved(StringRef str) {
...
void aiir::tblgen::shardOpDefinitions(
