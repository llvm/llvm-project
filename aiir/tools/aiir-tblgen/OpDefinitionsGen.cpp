//===- OpDefinitionsGen.cpp - AIIR op definitions generator ---------------===//
//
...
static const char *const subrangeGetAttr =
    "::aiir::impl::get{4}AttrFromSortedRange({3}.begin() + {1}, {3}.end() - "
    "{2}, {0})";
...
static const char *const parseTextualSegmentSizeFormat = R"(
  size_t i = 0;
  auto parseElem = [&]() -> ::aiir::ParseResult {
    if (i >= {0})
  ...
  if (failed($_parser.parseCommaSeparatedList(
      ::aiir::AsmParser::Delimeter::Square, parseElem)))
    return failure();
  if (i < {0})
    return $_parser.emitError($_parser.getCurrentLocation(),
...
static const char *const readBytecodeSegmentSizeLegacy = R"(
  if ($_reader.getBytecodeVersion() < /*kNativePropertiesODSSegmentSize=*/6) {
    ...
    ::aiir::DenseI32ArrayAttr attr;
    if (::aiir::failed($_reader.readAttribute(attr))) return ::aiir::failure();
...
if ($_writer.getBytecodeVersion() < /*kNativePropertiesODSSegmentSize=*/6) {
  auto &$_storage = prop.$_propName;
  $_writer.writeAttribute(::aiir::DenseI32ArrayAttr::get($_ctxt, $_storage));
}
)";
...
static const char *const inlineCreateBody = R"(
  ::aiir::OperationState __state__({0}, getOperationName());
...
void OpOrAdaptorHelper::computeAttrMetadata() {
  ...
  auto makeProperty = [&](StringRef storageType, StringRef parserCall) {
    return Property(/*maybeDef=*/nullptr,
                    ...
                    "return ::aiir::DenseI32ArrayAttr::get($_ctxt, $_storage);",
                    /*convertFromAttributeCall=*/
                    "return convertFromAttribute($_storage, $_attr, $_diag);",
                    /*parserCall=*/parserCall,
                    /*optionalParserCall=*/"",
                    /*printerCall=*/printTextualSegmentSize,
                    /*readFromAiirBytecodeCall=*/readBytecodeSegmentSizeNative,
                    /*writeToAiirBytecodeCall=*/writeBytecodeSegmentSizeNative,
                    /*hashPropertyCall=*/
  ...
  if (op.getTrait("::aiir::OpTrait::AttrSizedResultSegments")) {
...
private:
  ...
  enum class AttrParamKind {
    WrappedAttr,    // A wrapped AIIR Attribute instance.
    UnwrappedValue, // A raw value without AIIR Attribute wrapper.
  };
...
void OpEmitter::genAttrNameGetters() {
  ...
  // Emit the getAttributeNameForIndex methods.
  {
    auto *method = opClass.addInlineMethod<Method::Private>(
        "::aiir::StringAttr", "getAttributeNameForIndex",
  ...
  }
  {
    auto *method = opClass.addStaticInlineMethod<Method::Private>(
        "::aiir::StringAttr", "getAttributeNameForIndex",
        MethodParameter("::aiir::OperationName", "name"),
        MethodParameter("unsigned", "index"));
    ERROR_IF_PRUNED(method, "getAttributeNameForIndex", op);
  ...
  for (auto [index, attr] :
    ...
    {
      auto *method = opClass.addInlineMethod("::aiir::StringAttr", methodName);
...
void OpEmitter::genPropertiesSupport() {
  ...
  auto &setPropMethod =
      opClass
          .addStaticMethod(
              ...
              MethodParameter("::aiir::Attribute", "attr"),
              MethodParameter(
                  "::llvm::function_ref<::aiir::InFlightDiagnostic()>",
                  "emitError"))
          ->body();
  auto &getPropMethod =
      opClass
          .addStaticMethod("::aiir::Attribute", "getPropertiesAsAttr",
                           MethodParameter("::aiir::AIIRContext *", "ctx"),
  ...
  auto &getInherentAttrMethod =
      opClass
          .addStaticMethod("std::optional<aiir::Attribute>", "getInherentAttr",
                           MethodParameter("::aiir::AIIRContext *", "ctx"),
                           MethodParameter("const Properties &", "prop"),
  ...
  auto &setInherentAttrMethod =
      opClass
          .addStaticMethod("void", "setInherentAttr",
                           MethodParameter("Properties &", "prop"),
                           MethodParameter("llvm::StringRef", "name"),
                           MethodParameter("aiir::Attribute", "value"))
          ->body();
  auto &populateInherentAttrsMethod =
      opClass
          .addStaticMethod("void", "populateInherentAttrs",
                           MethodParameter("::aiir::AIIRContext *", "ctx"),
                           MethodParameter("const Properties &", "prop"),
                           MethodParameter("::aiir::NamedAttrList &", "attrs"))
          ->body();
  auto &verifyInherentAttrsMethod =
      opClass
          .addStaticMethod(
              "::llvm::LogicalResult", "verifyInherentAttrs",
              MethodParameter("::aiir::OperationName", "opName"),
              MethodParameter("::aiir::NamedAttrList &", "attrs"),
              MethodParameter(
                  "llvm::function_ref<::aiir::InFlightDiagnostic()>",
                  "emitError"))
  ...
  const char *attrGetNoDefaultFmt = R"decl(;
      if (attr && ::aiir::failed(setFromAttr(prop.{0}, attr, emitError)))
        return ::aiir::failure();
)decl";
  const char *attrGetDefaultFmt = R"decl(;
      if (attr) {{
        if (::aiir::failed(setFromAttr(prop.{0}, attr, emitError)))
          return ::aiir::failure();
      } else {{
        prop.{0} = {1};
      }
  ...
  setPropMethod << "  return ::aiir::success();\n";

  // Convert the attribute form to the property.

  getPropMethod << "    ::aiir::SmallVector<::aiir::NamedAttribute> attrs;\n"
                << "    ::aiir::Builder odsBuilder{ctx};\n";
  const char *propToAttrFmt = R"decl(
    {
      const auto &propStorage = prop.{0};
      auto attr = [&]() -> ::aiir::Attribute {{
        {1}
      }();
  ...
  for (const auto &attrOrProp : attrOrProperties) {
    ...
    getInherentAttrMethod << "[&]() -> ::aiir::Attribute { "
    ...
    setInherentAttrMethod << formatv(R"decl(
       auto arrAttr = ::llvm::dyn_cast_or_null<::aiir::DenseI32ArrayAttr>(value);
       if (!arrAttr) return;
    ...
    if (name == operandSegmentAttrName) {
      populateInherentAttrsMethod << formatv(
          "  attrs.append(\"{0}\", [&]() -> ::aiir::Attribute { {1} }());\n",
          operandSegmentAttrName,
          tgfmt(prop.getConvertToAttributeCall(), &fctx));
    } else {
      populateInherentAttrsMethod << formatv(
  ...
  for (const auto &attrOrProp : attrOrProperties) {
    ...
    if (canEmitAttrVerifier(attr,
      ...
      verifyInherentAttrsMethod
          << formatv(R"(
    {{
      ::aiir::Attribute attr = attrs.get({0}AttrName(opName));
      if (attr && ::aiir::failed({1}(attr, "{2}", emitError)))
        return ::aiir::failure();
    }
)",
  ...
  verifyInherentAttrsMethod << "    return ::aiir::success();";
...
void OpEmitter::genPropertiesSupportForBytecode(
  ...
  if (op.useCustomPropertiesEncoding()) {
    opClass.declareStaticMethod(
        ...
        MethodParameter("::aiir::DialectBytecodeReader &", "reader"),
        MethodParameter("::aiir::OperationState &", "state"));
    opClass.declareMethod(
        "void", "writeProperties",
        MethodParameter("::aiir::DialectBytecodeWriter &", "writer"));
    return;
  }
  ...
  {{
    ...
    if (::aiir::failed(readProp()))
      return ::aiir::failure();
  }
)",
          name,
          tgfmt(namedProperty->prop.getReadFromAiirBytecodeCall(), &fctx));
  ...
  {{
    ...
    {1};
          ...
          name, tgfmt(namedProperty->prop.getWriteToAiirBytecodeCall(), &fctx));
      continue;
    }
  ...
  if (::aiir::failed(reader.readAttribute(prop.{0})))
    return ::aiir::failure();
)",
                                      name);
      ...
      readPropertiesMethod << formatv(R"(
  if (::aiir::failed(reader.readOptionalAttribute(prop.{0})))
    return ::aiir::failure();
)",
                                      name);
  ...
  readPropertiesMethod << "  return ::aiir::success();";
}
...
void OpEmitter::genAttrGetters() {
  FmtContext fctx;
  fctx.withBuilder("::aiir::Builder((*this)->getContext())");
  ...
  opClass.addTrait("::aiir::DerivedAttributeOpInterface::Trait");
  ...
  {
    auto *method = opClass.addMethod("::aiir::DictionaryAttr",
    ...
    body << "  ::aiir::AIIRContext* ctx = getContext();\n";
    body << "  ::aiir::Builder odsBuilder(ctx); (void)odsBuilder;\n";
    body << "  return ::aiir::DictionaryAttr::get(";
    body << "  ctx, {\n";
    interleave(
        derivedAttrs, body,
        [&](const NamedAttribute &namedAttr) {
...
void OpEmitter::genOptionalAttrRemovers() {
  ...
  auto emitRemoveAttr = [&](StringRef name) {
    auto *method = opClass.addInlineMethod("::aiir::Attribute",
...
static std::string generateTypeForGetter(const NamedTypeConstraint &value) {
  return llvm::formatv("::aiir::TypedValue<{0}>", value.constraint.getCppType())
      .str();
}
...
generateNamedOperandGetters(const Operator &op, Class &opClass,
  ...
  const auto *sameVariadicSize =
      op.getTrait("::aiir::OpTrait::SameVariadicOperandSize");
  ...
  for (int i = 0; i != numOperands; ++i) {
    ...
    if (operand.isOptional()) {
      ...
      m = opClass.addInlineMethod("::aiir::OperandRangeRange", name);
      ERROR_IF_PRUNED(m, name, op);
...
void OpEmitter::genNamedOperandGetters() {
  ...
  generateNamedOperandGetters(
      ...
      /*rangeType=*/"::aiir::Operation::operand_range",
      /*rangeElementType=*/"::aiir::Value",
...
void OpEmitter::genNamedOperandSetters() {
  ...
  for (int i = 0, e = op.getNumOperands(); i != e; ++i) {
    ...
    if (operand.isVariadicOfVariadic()) {
      returnType = "::aiir::MutableOperandRangeRange";
    } else if (operand.isVariableLength()) {
      returnType = "::aiir::MutableOperandRange";
    } else {
      returnType = "::aiir::OpOperand &";
    }
    ...
    body << "  auto mutableRange = "
            "::aiir::MutableOperandRange(getOperation(), "
            "range.first, range.second";
    if (attrSizedOperands) {
      if (emitHelper.hasProperties())
        body << formatv(", ::aiir::MutableOperandRange::OperandSegment({0}u, "
                        "{{getOperandSegmentSizesAttrName(), "
                        "::aiir::DenseI32ArrayAttr::get(getContext(), "
                        "getProperties().operandSegmentSizes)})",
                        i);
      else
        body << formatv(
            ", ::aiir::MutableOperandRange::OperandSegment({0}u, *{1})", i,
...
void OpEmitter::genNamedResultGetters() {
  ...
  const auto *sameVariadicSize =
      op.getTrait("::aiir::OpTrait::SameVariadicResultSize");
  ...
  // The implementation of this method is trivial and it is very load-bearing.
  // Generate it inline.
  auto *m = opClass.addInlineMethod("::aiir::Operation::result_range",
                                    "getODSResults",
                                    MethodParameter("unsigned", "index"));
  ...
  for (int i = 0; i != numResults; ++i) {
    ...
    if (result.isOptional()) {
      ...
      m = opClass.addInlineMethod("::aiir::Operation::result_range", name);
      ERROR_IF_PRUNED(m, name, op);
  ...
  for (unsigned i = 0; i < numRegions; ++i) {
    ...
    if (region.isVariadic()) {
      auto *m = opClass.addInlineMethod(
          "::aiir::MutableArrayRef<::aiir::Region>", name);
      ERROR_IF_PRUNED(m, name, op);
    ...
    auto *m = opClass.addInlineMethod("::aiir::Region &", name);
    ERROR_IF_PRUNED(m, name, op);
...
void OpEmitter::genNamedSuccessorGetters() {
  ...
  for (unsigned i = 0; i < numSuccessors; ++i) {
    ...
    if (successor.isVariadic()) {
      auto *m = opClass.addInlineMethod("::aiir::SuccessorRange", name);
      ERROR_IF_PRUNED(m, name, op);
      m->body() << formatv(
    ...
    auto *m = opClass.addInlineMethod("::aiir::Block *", name);
    ERROR_IF_PRUNED(m, name, op);
...
static bool canGenerateUnwrappedBuilder(const Operator &op) {
  ...
  // different from the wrapped aiir::Attribute type to avoid redefining
...
void OpEmitter::genInlineCreateBody(
  ...
  createParamListOpBuilder.emplace_back("::aiir::OpBuilder &", "builder");
  createParamListImplicitLocOpBuilder.emplace_back(
      "::aiir::ImplicitLocOpBuilder &", "builder");
  ...
  createParamListOpBuilder.emplace_back("::aiir::Location", locParamName);

  for (auto &param : paramList) {
    if (param.getType() == "::aiir::OpBuilder &" ||
        param.getType() == "::aiir::OperationState &")
      continue;
...
void OpEmitter::genSeparateArgParamBuilder() {
  ...
  auto emit = [&](AttrParamKind attrType, TypeParamKind paramKind,
    ...
    if (inferType) {
      ...
      body << formatv(R"(
        ::llvm::SmallVector<::aiir::Type, 2> inferredReturnTypes;
        if (::aiir::succeeded({0}::inferReturnTypes(odsBuilder.getContext(),
          ...
          ::aiir::detail::reportFatalInferReturnTypesError({1});
        )",
        ...
        interleaveComma(
            llvm::seq<int>(0, op.getNumResults()), body, [&](int i) {
              ...
              if (!result.isVariableLength()) {
                ...
                // AIIR, hence it can only be a simple variadic.
...
void OpEmitter::genUseOperandAsResultTypeCollectiveParamBuilder(
  ...
  // Signature
  SmallVector<MethodParameter> paramList;
  paramList.emplace_back("::aiir::OpBuilder &", "odsBuilder");
  paramList.emplace_back("::aiir::OperationState &", builderOpState);
  paramList.emplace_back("::aiir::ValueRange", "operands");
  ...
  StringRef attributesName = kind == CollectiveBuilderKind::PropStruct
                                 ...
                                 : "attributes";
  paramList.emplace_back("::llvm::ArrayRef<::aiir::NamedAttribute>",
...
void OpEmitter::genPopulateDefaultAttributes() {
  ...
  if (emitHelper.hasProperties()) {
    SmallVector<MethodParameter> paramList;
    paramList.emplace_back("::aiir::OperationName", "opName");
    ...
    auto &body = m->body();
    body.indent();
    body << "::aiir::Builder " << odsBuilder << "(opName.getContext());\n";
    for (const NamedAttribute &namedAttr : op.getAttributes()) {
  ...
  SmallVector<MethodParameter> paramList;
  paramList.emplace_back("const ::aiir::OperationName &", "opName");
  paramList.emplace_back("::aiir::NamedAttrList &", "attributes");
...
void OpEmitter::genInferredTypeCollectiveParamBuilder(
  ...
  if (emitHelper.hasNonEmptyPropertiesStruct() &&
    ...
    body << formatv(R"(
  if (!attributes.empty()) {
    ::aiir::OpaqueProperties properties =
      &{1}.getOrAddProperties<{0}::Properties>();
    std::optional<::aiir::RegisteredOperationName> info =
...
void OpEmitter::genUseAttrAsResultTypeCollectiveParamBuilder(
  ...
  if (namedAttr.attr.isTypeAttr()) {
    resultType = "::llvm::cast<::aiir::TypeAttr>(typeAttr).getValue()";
  } else {
    resultType = "::llvm::cast<::aiir::TypedAttr>(typeAttr).getType()";
  }

  if (kind == CollectiveBuilderKind::PropStruct) {
    body << "  ::aiir::Attribute typeAttr = properties."
         << op.getGetterName(namedAttr.name) << "();\n";
  } else {
    body << "  ::aiir::Attribute typeAttr;\n"
...
getBuilderSignature(const Builder &builder) {
  ...
  arguments.emplace_back("::aiir::OpBuilder &", odsBuilder);
  arguments.emplace_back("::aiir::OperationState &", builderOpState);
...
void OpEmitter::genBuilder() {
  ...
  if (op.getNumVariableLengthResults() == 0) {
    if (op.getTrait("::aiir::OpTrait::SameOperandsAndResultType")) {
    ...
    if (op.getTrait("::aiir::OpTrait::FirstAttrDerivedResultType")) {
...
void OpEmitter::genCollectiveParamBuilder(CollectiveBuilderKind kind) {
  ...
  SmallVector<MethodParameter> paramList;
  paramList.emplace_back("::aiir::OpBuilder &", "");
  paramList.emplace_back("::aiir::OperationState &", builderOpState);
  paramList.emplace_back("::aiir::TypeRange", "resultTypes");
  paramList.emplace_back("::aiir::ValueRange", "operands");
  if (kind == CollectiveBuilderKind::PropStruct)
    paramList.emplace_back("const Properties &", "properties");
  // Provide default value for `attributes` when its the last parameter
...
void OpEmitter::buildParamList(SmallVectorImpl<MethodParameter> &paramList,
  ...
  case TypeParamKind::Separate: {
    ...
    for (int i = 0; i < numResults; ++i) {
      ...
      StringRef type =
          result.isVariadic() ? "::aiir::TypeRange" : "::aiir::Type";
  ...
  for (int i = 0, e = op.getNumArgs(), numOperands = 0; i < e; ++i) {
    ...
    if (const auto *operand =
      ...
      StringRef type;
      if (operand->isVariadicOfVariadic())
        type = "::llvm::ArrayRef<::aiir::ValueRange>";
      else if (operand->isVariadic())
        type = "::aiir::ValueRange";
      else
        type = "::aiir::Value";
  ...
  for (const NamedSuccessor &succ : op.getSuccessors()) {
    StringRef type =
        succ.isVariadic() ? "::aiir::BlockRange" : "::aiir::Block *";
    ...
    interleaveComma(llvm::seq<int>(0, op.getNumOperands()), body, [&](int i) {
      ...
      if (operand.isOptional()) {
        ...
        body << llvm::formatv(
            ...
            "[](int32_t curSum, ::aiir::ValueRange range) {{ return curSum + "
...
void OpEmitter::genCanonicalizerDecls() {
  ...
  if (hasCanonicalizeMethod) {
    ...
    paramList.emplace_back("::aiir::PatternRewriter &", "rewriter");
  ...
  SmallVector<MethodParameter> paramList;
  paramList.emplace_back("::aiir::RewritePatternSet &", "results");
  paramList.emplace_back("::aiir::AIIRContext *", "context");
...
void OpEmitter::genFolderDecls() {
  ...
  if (hasSingleResult) {
    retType = "::aiir::OpFoldResult";
  } else {
    paramList.emplace_back("::llvm::SmallVectorImpl<::aiir::OpFoldResult> &",
                           "results");
...
void OpEmitter::genSideEffectInterfaceMethods() {
  ...
  for (auto &it : interfaceEffects) {
    ...
    std::string type = llvm::formatv("::llvm::SmallVectorImpl<::aiir::"
...
void OpEmitter::genTypeInterfaceMethods() {
  ...
  const auto *trait =
      cast<InterfaceTrait>(op.getTrait("::aiir::InferTypeOpInterface::Trait"));
  ...
  body << "  ::aiir::Builder odsBuilder(context);\n";
    ...
    for (int i = 0, e = op.getNumResults(); i != e; ++i) {
      ...
      if (infer.isArg()) {
        ...
        if (arg.kind() == Operator::OperandAttrOrProp::Kind::Operand) {
          ...
          body << "  ::aiir::TypedAttr odsInferredTypeAttr" << inferredTypeIdx
               << " = (properties ? properties.as<Properties *>()->"
               << attr->name
               << " : ::llvm::dyn_cast_or_null<::aiir::TypedAttr>(attributes."
                  "get(\""
               << attr->name << "\")));\n"
      ...
      body << "  ::aiir::Type odsInferredType" << inferredTypeIdx++ << " = "
...
void OpEmitter::genParser() {
  ...
  auto *method = opClass.declareStaticMethod("::aiir::ParseResult", "parse",
                                             std::move(paramList));
...
void OpEmitter::genPrinter() {
  ...
  auto *method = opClass.declareMethod(
      "void", "print", MethodParameter("::aiir::OpAsmPrinter &", "p"));
...
void OpEmitter::genVerifier() {
  ...
  // see if we should use the aiir::verify() instead.
  ...
  if (def.getValueAsBit("hasVerifier")) {
    body << "  if(::aiir::succeeded(verifyInvariantsImpl()) && "
            "::aiir::succeeded(verify()))\n";
    body << "    return ::aiir::success();\n";
    body << "  return ::aiir::failure();";
  } else {
...
void OpEmitter::genOperandResultVerifier(MethodBody &body,
  ...
  const char *const verifyValues = R"(
    for (auto v : valueGroup{0}) {
      if (::aiir::failed({1}(*this, v.getType(), "{2}", index++)))
        return ::aiir::failure();
    }
)";
  ...
  for (const auto &staticValue : llvm::enumerate(values)) {
    ...
    if (isOptional) {
      ...
      body << formatv(
          "    if (::aiir::failed(::aiir::OpTrait::impl::verifyValueSizeAttr("
...
void OpEmitter::genRegionVerifier(MethodBody &body) {
  ...
  const char *const verifyRegion = R"(
    for (auto &region : {0})
      if (::aiir::failed({1}(*this, region, "{2}", index++)))
        return ::aiir::failure();
)";
  /// Get a single region.
  ///
...
void OpEmitter::genSuccessorVerifier(MethodBody &body) {
  const char *const verifySuccessor = R"(
    for (auto *successor : {0})
      if (::aiir::failed({1}(*this, successor, "{2}", index++)))
        return ::aiir::failure();
)";
...
static void addSizeCountTrait(OpClass &opClass, StringRef traitKind,
  ...
  if (numVariadic != 0) {
    if (numTotal == numVariadic)
      opClass.addTrait("::aiir::OpTrait::Variadic" + traitKind + "s");
    else
      opClass.addTrait("::aiir::OpTrait::AtLeastN" + traitKind + "s<" +
                       Twine(numTotal - numVariadic) + ">::Impl");
    return;
  }
  switch (numTotal) {
  case 0:
    opClass.addTrait("::aiir::OpTrait::Zero" + traitKind + "s");
    break;
  case 1:
    opClass.addTrait("::aiir::OpTrait::One" + traitKind);
    break;
  default:
    opClass.addTrait("::aiir::OpTrait::N" + traitKind + "s<" + Twine(numTotal) +
                     ">::Impl");
    break;
  }
}
...
void OpEmitter::genTraits() {
  ...
  if (numResults == 1 && numVariadicResults == 0) {
    ...
    opClass.addTrait("::aiir::OpTrait::OneTypedResult<" + cppName + ">::Impl");
  }
  ...
  opClass.addTrait("::aiir::OpTrait::OpInvariants");

  if (emitHelper.hasNonEmptyPropertiesStruct())
    opClass.addTrait("::aiir::BytecodeOpInterface::Trait");
...
void OpEmitter::genOpAsmInterface() {
  ...
  int numResults = op.getNumResults();
  if (numResults <= 1 || op.getTrait("::aiir::OpAsmOpInterface::Trait"))
    return;
...
//   with 'aiir::ValueRange' as template parameter. It adds a constructor from
...
OpOperandAdaptorEmitter::OpOperandAdaptorEmitter(
  ...
  if (useProperties) {
    ...
    void set{1}({0} propValue) {
      ...
      if (attr) {
        ...
        storageType = "::aiir::DenseI32ArrayAttr";
      }
  ...
  genericAdaptorBase.declare<Field>("::aiir::DictionaryAttr", "odsAttrs");
  genericAdaptorBase.declare<Field>("::std::optional<::aiir::OperationName>",
                                    "odsOpName");
  if (useProperties)
    genericAdaptorBase.declare<Field>("Properties", "properties");
  genericAdaptorBase.declare<Field>("::aiir::RegionRange", "odsRegions");
      ...
      op.getTrait("::aiir::OpTrait::AttrSizedOperandSegments");
  {
    ...
    if (useProperties) {
      ...
      // here.
      paramList.emplace_back("::aiir::DictionaryAttr", "attrs");
      paramList.emplace_back("const Properties &", "properties");
    } else {
      paramList.emplace_back("::aiir::DictionaryAttr", "attrs", "{}");
      paramList.emplace_back("const ::aiir::EmptyProperties &", "properties",
                             "{}");
    }
    paramList.emplace_back("::aiir::RegionRange", "regions", "{}");
    ...
    paramList[1] = MethodParameter("::aiir::DictionaryAttr", "attrs");
    paramList[2] = MethodParameter("::aiir::OpaqueProperties", "properties");
    ...
    if (useProperties) {
      ...
      opaquePropertiesConstructor->addMemberInitializer(
          ...
          "values, "
          "attrs, "
          "(properties ? *properties.as<::aiir::EmptyProperties *>() : "
          "::aiir::EmptyProperties{}), "
          "regions");
    }
  ...
  // and the value range from the parameter.
  {
    ...
    if (useProperties) {
      ...
      constructor = genericAdaptorBase.addConstructor<Method::Inline>(
          MethodParameter("::aiir::Operation *", "op"));
    }
  ...
  fctx.withBuilder("::aiir::Builder(odsAttrs.getContext())");
  ...
  {
    auto *m = genericAdaptorBase.addInlineMethod("::aiir::DictionaryAttr",
                                                 "getAttributes");
  ...
  for (unsigned i = 0; i < numRegions; ++i) {
    ...
    std::string name = op.getGetterName(region.name);
    if (region.isVariadic()) {
      auto *m = genericAdaptorBase.addInlineMethod("::aiir::RegionRange", name);
      ERROR_IF_PRUNED(m, "Adaptor::" + name, op);
      m->body() << formatv("  return odsRegions.drop_front({0});", i);
      continue;
    }

    auto *m = genericAdaptorBase.addInlineMethod("::aiir::Region &", name);
    ERROR_IF_PRUNED(m, "Adaptor::" + name, op);
  ...
  if (numRegions > 0) {
    ...
    // here already.
    if (auto *m = genericAdaptorBase.addInlineMethod("::aiir::RegionRange",
                                                     "getRegions"))
  ...
  adaptor.addParent(ParentClass(genericAdaptorClassName))
      .addTemplateParam("::aiir::ValueRange");
...
void OpOperandAdaptorEmitter::addVerification() {
  auto *method = adaptor.addMethod("::llvm::LogicalResult", "verify",
                                   MethodParameter("::aiir::Location", "loc"));
  ERROR_IF_PRUNED(method, "verify", op);
  auto &body = method->body();
  bool useProperties = emitHelper.hasProperties();
  ...
  for (auto *def : defs) {
    ...
    if (emitDecl) {
      ...
      if (!op.getCppNamespace().empty())
        os << "AIIR_DECLARE_EXPLICIT_TYPE_ID(" << op.getCppNamespace()
           << "::" << op.getCppClassName() << ")\n\n";
    } else {
      {
        NamespaceEmitter emitter(os, op.getCppNamespace());
      ...
      // Emit the TypeID explicit specialization to have a single definition.
      if (!op.getCppNamespace().empty())
        os << "AIIR_DEFINE_EXPLICIT_TYPE_ID(" << op.getCppNamespace()
           << "::" << op.getCppClassName() << ")\n\n";
    }
  }
}
...
static void emitOpDefShard(const RecordKeeper &records,
  ...
  for (const Record *def : defs) {
    os << formatv("  ::aiir::RegisteredOperationName::insert<{0}>(*dialect);\n",
...
static aiir::GenRegistration genOpDefs("gen-op-defs", "Generate op definitions",
