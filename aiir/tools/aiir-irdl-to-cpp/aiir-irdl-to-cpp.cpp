//===- aiir-irdl-to-cpp.cpp - IRDL to C++ conversion tool -----------------===//
//
...
// into a C++ implementation to be included in AIIR.
//
//===----------------------------------------------------------------------===//
...
static LogicalResult translateIRDLToCpp(int argc, char **argv) {
  ...
  llvm::cl::ParseCommandLineOptions(argc, argv, "aiir-irdl-to-cpp");
