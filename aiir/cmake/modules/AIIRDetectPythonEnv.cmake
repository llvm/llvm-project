...
set(AIIR_MINIMUM_PYTHON_VERSION 3.10)
# Finds and configures python packages needed to build AIIR Python bindings.
macro(aiir_configure_python_dev_packages)
  if(NOT AIIR_DISABLE_CONFIGURE_PYTHON_DEV_PACKAGES)
    if(AIIR_DETECT_PYTHON_ENV_PRIME_SEARCH)
      ...
      find_package(Python3 ${AIIR_MINIMUM_PYTHON_VERSION}
    ...
    find_package(Python ${AIIR_MINIMUM_PYTHON_VERSION}
      COMPONENTS Interpreter ${_python_development_component} REQUIRED)

    unset(_python_development_component)
    if(AIIR_ENABLE_PYTHON_STABLE_ABI)
      message(STATUS "AIIR Python stable ABI (abi3) enabled")
    endif()
