...
# the moment these are used when configuring AIIR integration tests.
...
# For the given group of e2e tests (defined by the `aiir_e2e_tests` flag),
...
# )
#
# aiir_e2e_tests  - AIIR CMake variables corresponding to the group of e2e tests
#                   to check
...
# EXAMPLES:
#
#  check_emulator(AIIR_RUN_ARM_SVE_TESTS "HWCAP_SVE" ARM_EMULATOR_EXECUTABLE)
#
function(check_emulator aiir_e2e_tests hwcap_spec emulator_exec)
  if (NOT ${aiir_e2e_tests})
    return()
  endif()
  ...
  if (${emulator_exec} STREQUAL "")
    message(FATAL_ERROR "${aiir_e2e_tests} requires an emulator, but ${emulator_exec} is not set")
  endif()
