...
// identify extensions.
class MyExtension
    : public ::aiir::transform::TransformDialectExtension<MyExtension> {
public:
  // The TypeID of this extension.
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(MyExtension)
...
static void updateCallee(aiir::func::CallOp call, llvm::StringRef newTarget) {
...
void aiir::transform::ChangeCallTargetOp::getEffects(
