...
struct ShapeInferencePass
    : public aiir::PassWrapper<ShapeInferencePass, OperationPass<toy::FuncOp>> {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ShapeInferencePass)
  ...
  void runOnOperation() override {
    ...
    llvm::SmallPtrSet<aiir::Operation *, 16> opWorklist;
    f.walk([&](aiir::Operation *op) {
