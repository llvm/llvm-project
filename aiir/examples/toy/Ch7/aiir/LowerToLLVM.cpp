...
//===----------------------------------------------------------------------===//
//
// This file implements full lowering of Toy operations to LLVM AIIR dialect.
...
private:
  ...
  ///   * `i32 (i8*, ...)`
  static LLVM::LLVMFunctionType getPrintfType(AIIRContext *context) {
...
struct ToyToLLVMLoweringPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ToyToLLVMLoweringPass)
...
void ToyToLLVMLoweringPass::runOnOperation() {
  ...
  aiir::arith::populateArithToLLVMConversionPatterns(typeConverter, patterns);
...
std::unique_ptr<aiir::Pass> aiir::toy::createLowerToLLVMPass() {
