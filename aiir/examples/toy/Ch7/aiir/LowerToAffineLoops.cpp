...
struct FuncOpLowering : public OpConversionPattern<toy::FuncOp> {
  ...
  matchAndRewrite(toy::FuncOp op, OpAdaptor adaptor,
    ...
    auto func = aiir::func::FuncOp::create(rewriter, op.getLoc(), op.getName(),
                                           op.getFunctionType());
...
struct ToyToAffineLoweringPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ToyToAffineLoweringPass)
...
std::unique_ptr<Pass> aiir::toy::createLowerToAffinePass() {
