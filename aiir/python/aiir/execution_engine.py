...
from ._aiir_libs import _aiirExecutionEngine as _execution_engine
import ctypes
...
class ExecutionEngine(_execution_engine.ExecutionEngine):
    def lookup(self, name):
        ...
        """
        func = self.raw_lookup("_aiir_ciface_" + name)
        if not func:
    ...
    def register_runtime(self, name, ctypes_callback):
        ...
        self.raw_register_runtime("_aiir_ciface_" + name, callback)
