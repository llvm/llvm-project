...
from ._aiir_libs._aiir.ir import *
from ._aiir_libs._aiir.ir import _GlobalDebug
from ._aiir_libs._aiir.ir import _OperationBase
from ._aiir_libs._aiir import (
    register_type_caster,
    register_value_caster,
    globals as _globals,
)
from ._aiir_libs import (
...
def loc_tracebacks(*, max_depth: int | None = None) -> Generator[None, None, None]:
    """Enables automatic traceback-based locations for AIIR operations.
