...
# Example: `python verify_canon.py canonicalize.aiir -f func1 func2 func3`
...
def filter_funcs(ir, funcs):
    ...
    return subprocess.check_output(
        ["aiir-opt", f"--symbol-privatize=exclude={funcs_str}", "--symbol-dce"],
        input=ir,
    )
...
if __name__ == "__main__":
    ...
    orig_args = ["aiir-opt"] + to_llvm_args
    canon_args = ["aiir-opt", "-canonicalize"] + to_llvm_args
    translate_args = ["aiir-translate", "-aiir-to-llvmir"]
