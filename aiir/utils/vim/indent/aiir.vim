...
setlocal indentexpr=GetAIIRIndent()

if exists("*GetAIIRIndent")
  finish
endif
...
function! GetAIIRIndent()
  ...
  while prev_lnum > 0 && synIDattr(synID(prev_lnum, 1 + indent(prev_lnum), 0), "name") == "aiirComment"
