...
# <filename> is required, which is the file name of AIIR SPIR-V op definitions
# spec.
...
case $baseclass in
  ...
  *)
    ...
    echo "<filename> is the file name of AIIR SPIR-V op definitions spec"
...
python3 ${current_dir}/gen_spirv_dialect.py \
  --op-td-path \
  ${current_dir}/../../include/aiir/Dialect/SPIRV/IR/${file_name} \
