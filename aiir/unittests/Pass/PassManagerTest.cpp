...
#include "aiir/Pass/PassInstrumentation.h"
...
struct GenericAnalysis {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(GenericAnalysis)
...
struct AnnotateFunctionPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(AnnotateFunctionPass)
...
struct AddAttrFunctionPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(AddAttrFunctionPass)
...
struct AddSecondAttrFunctionPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(AddSecondAttrFunctionPass)
...
TEST(PassManagerTest, ExecutionAction) {
  ...
  // Register the execution context in the AIIRContext.
...
struct InvalidPass : Pass {
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(InvalidPass)
...
struct InitializeCheckingPass
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(InitializeCheckingPass)
  LogicalResult initialize(AIIRContext *ctx) final {
    initialized = true;
    return success();
  }
