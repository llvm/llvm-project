...
TEST(EnumsGenTest, GeneratedIntAttributeClass) {
  ...
  aiir::Type intType = aiir::IntegerType::get(&ctx, 32);
  aiir::Attribute intAttr = aiir::IntegerAttr::get(intType, 5);
...
TEST(EnumsGenTest, GeneratedBitAttributeClass) {
  ...
  aiir::Type intType = aiir::IntegerType::get(&ctx, 32);
  aiir::Attribute intAttr = aiir::IntegerAttr::get(
      intType,
