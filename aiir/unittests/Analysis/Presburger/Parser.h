...
#ifndef AIIR_UNITTESTS_ANALYSIS_PRESBURGER_PARSER_H
#define AIIR_UNITTESTS_ANALYSIS_PRESBURGER_PARSER_H
...
inline IntegerPolyhedron parseIntegerPolyhedron(StringRef str) {
  AIIRContext context(AIIRContext::Threading::DISABLED);
...
#endif // AIIR_UNITTESTS_ANALYSIS_PRESBURGER_PARSER_H
