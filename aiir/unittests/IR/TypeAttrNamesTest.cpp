...
struct FooType : Type::TypeBase<FooType, Type, TypeStorage> {
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(FooType)
};
...
struct BarAttr : Attribute::AttrBase<BarAttr, Attribute, AttributeStorage> {
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(BarAttr)
};
...
struct FakeDialect : Dialect {
  ...
  AIIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(FakeDialect)
};
} // namespace
