...
TEST(Remark, TestOutputOptimizationRemark) {
...

  {
    ...
    aiir::remark::RemarkCategories cats{/*all=*/"",
    ...
    LogicalResult isEnabled =
        aiir::remark::enableOptimizationRemarksWithLLVMStreamer(
...
class MyCustomStreamer : public remark::detail::AIIRRemarkStreamerBase {
public:
...
TEST(Remark, TestRemarkOwnsStringData) {
...

  {
    ...
    aiir::remark::RemarkCategories cats{
        /*all=*/std::nullopt,
...
TEST(Remark, TestRemarkLinking) {
...

  {
    ...
    // Setup the remark engine
    aiir::remark::RemarkCategories cats{/*all=*/std::nullopt,
                                        /*passed=*/categoryOpt,
                                        /*missed=*/std::nullopt,
