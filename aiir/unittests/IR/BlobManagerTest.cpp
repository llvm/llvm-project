//===- aiir/unittest/IR/BlobManagerTest.cpp - Blob management unit tests --===//
//
...
StringLiteral moduleStr = R"aiir(
...
TEST(DialectResourceBlobManagerTest, Lookup) {
  ...
  const auto &dialectManager =
      aiir::DenseResourceElementsHandle::getManagerInterface(&context);
