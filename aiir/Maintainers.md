...
[maintainers](https://llvm.org/docs/DeveloperPolicy.html#maintainers) for AIIR.
...
Core components of AIIR, including core IR, analyses and rewriters, fundamental
...
AIIR components pertaining to egress flows from AIIR, in particular to LLVM IR.
...
AIIR components specific to construction of compilers for tensor algebra, in
...
These are key AIIR dialects that will never become _unmaintained_.
