// RUN: tr-opt %s --tr-emit-gpu-kernels --tr-split-host-device --tr-lower-device-to-nvvm | FileCheck %s

// Milestone 29 device path: gpu.func -> NVVM / LLVM dialect.
// Host launch_func stays in func.func. Workgroup memrefs and barriers
// become NVVM address spaces / nvvm.barrier.
...
// CHECK-DAG: nvvm.read.ptx.sreg.laneid
