...
payload = {"title": "Fix for issue #204213", "body": "Closes #204213\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-204213", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/llvm/llvm-project/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
