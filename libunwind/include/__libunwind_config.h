...
#ifdef LIBUNWIND_CONTEXT_PADDING
#  define _LIBUNWIND_BASE_CONTEXT_SIZE _LIBUNWIND_CONTEXT_SIZE
#  undef _LIBUNWIND_CONTEXT_SIZE
#  define _LIBUNWIND_CONTEXT_SIZE (_LIBUNWIND_BASE_CONTEXT_SIZE + LIBUNWIND_CONTEXT_PADDING)
#  undef _LIBUNWIND_BASE_CONTEXT_SIZE
#endif

#ifdef LIBUNWIND_CURSOR_PADDING
#  define _LIBUNWIND_BASE_CURSOR_SIZE _LIBUNWIND_CURSOR_SIZE
#  undef _LIBUNWIND_CURSOR_SIZE
#  define _LIBUNWIND_CURSOR_SIZE (_LIBUNWIND_BASE_CURSOR_SIZE + LIBUNWIND_CURSOR_PADDING)
#  undef _LIBUNWIND_BASE_CURSOR_SIZE
#endif
