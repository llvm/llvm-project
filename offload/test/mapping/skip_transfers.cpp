...
int main() {
    ...
    // CHECK: omptarget device 0 info: Copying data from device to host, TgtPtr=0x{{.*}}, HstPtr=0x{{.*}}, Size=4, Name=unknown
    #pragma omp target map(from: DataStack)
    {
        DataStack = 1;
    }

    // CHECK: omptarget device 0 info: Copying data from host to device, HstPtr=0x{{.*}}, TgtPtr=0x{{.*}}, Size=4, Name=unknown
    ...
    // CHECK: omptarget device 0 info: Copying data from host to device, HstPtr=0x{{.*}}, TgtPtr=0x{{.*}}, Size=8, Name=unknown
    // CHECK: omptarget device 0 info: Copying data from device to host, TgtPtr=0x{{.*}}, HstPtr=0x{{.*}}, Size=8, Name=unknown
    #pragma omp target map(tofrom: Data[0:1])
    {
        Data[0] = 1;
    }

    // CHECK: omptarget device 0 info: Copying data from host to device, HstPtr=0x{{.*}}, TgtPtr=0x{{.*}}, Size=16, Name=unknown
    // CHECK: omptarget device 0 info: Copying data from device to host, TgtPtr=0x{{.*}}, HstPtr=0x{{.*}}, Size=16, Name=unknown
    ...
    // CHECK: omptarget device 0 info: Copying data from host to device, HstPtr=0x{{.*}}, TgtPtr=0x{{.*}}, Size=40, Name=unknown
    ...
    // CHECK: omptarget device 0 info: Copying data from host to device, HstPtr=0x{{.*}}, TgtPtr=0x{{.*}}, Size=48, Name=unknown
    // CHECK: omptarget device 0 info: Copying data from device to host, TgtPtr=0x{{.*}}, HstPtr=0x{{.*}}, Size=48, Name=unknown
