...
TEST(InternalUtility, MakeHexString_PointerValues) {
  ...
  EXPECT_EQ(util::makeHexString(0, /*IsPointer=*/true), "(nil)");
  EXPECT_EQ(util::makeHexString(0, /*IsPointer=*/false), "0x0");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true), "0xff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/false), "0xff");
}

TEST(InternalUtility, MakeHexString_MinimumBytes) {
  // Return a minimum length, based on the (minimum) requested bytes
  EXPECT_EQ(util::makeHexString(15, /*IsPointer=*/true, /*MinBytes=*/0), "0xf");
  EXPECT_EQ(util::makeHexString(15, /*IsPointer=*/true, /*MinBytes=*/1),
            "0x0f");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/0),
            "0xff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/1),
            "0xff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/2),
            "0x00ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/3),
            "0x0000ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/4),
            "0x000000ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/5),
            "0x00000000ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/6),
            "0x0000000000ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/7),
            "0x000000000000ff");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/8),
            "0x00000000000000ff");

  // Default to four bytes, if request exceeds eight byte range
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true, /*MinBytes=*/9),
            "0x000000ff");

  // Disregard requested minimum byte width, if actual value exceeds it
  EXPECT_EQ(util::makeHexString(1024, /*IsPointer=*/true, /*MinBytes=*/1),
            "0x400");
}

TEST(InternalUtility, MakeHexString_HexBase) {
  // Cut off "0x" when requested
  EXPECT_EQ(util::makeHexString(0, /*IsPointer=*/true, /*MinBytes=*/0,
                                /*ShowHexBase=*/false),
            "(nil)");
  EXPECT_EQ(util::makeHexString(0, /*IsPointer=*/false, /*MinBytes=*/0,
                                /*ShowHexBase=*/false),
            "0");
  EXPECT_EQ(util::makeHexString(0, /*IsPointer=*/false, /*MinBytes=*/1,
                                /*ShowHexBase=*/false),
            "00");
  EXPECT_EQ(util::makeHexString(255, /*IsPointer=*/true,
                                /*MinBytes=*/2,
                                /*ShowHexBase=*/false),
            "00ff");
}
