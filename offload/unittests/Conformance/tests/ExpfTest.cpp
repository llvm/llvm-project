...
///
/// \file
/// This file contains the conformance test of the expf function.
///
//===----------------------------------------------------------------------===//
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the expf function");
  ...
  bool Passed = runTests<expf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
