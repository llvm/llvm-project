...
///
/// \file
/// This file contains the conformance test of the exp2f function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<exp2f> {
  static constexpr llvm::StringRef Name = "exp2f";
  static constexpr llvm::StringRef KernelName = "exp2fKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the exp2f function");
  ...
  bool Passed = runTests<exp2f>(Generator, Configs, DeviceBinaryDir, IsVerbose);
