...
///
/// \file
/// This file contains the conformance test of the tanf function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<tanf> {
  static constexpr llvm::StringRef Name = "tanf";
  static constexpr llvm::StringRef KernelName = "tanfKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the tanf function");
  ...
  bool Passed = runTests<tanf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
