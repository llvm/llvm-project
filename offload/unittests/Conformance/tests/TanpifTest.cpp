...
///
/// \file
/// This file contains the conformance test of the tanpif function.
///
//===----------------------------------------------------------------------===//
...
extern "C" float tanpif(float);

namespace mathtest {

template <> struct FunctionConfig<tanpif> {
  static constexpr llvm::StringRef Name = "tanpif";
  static constexpr llvm::StringRef KernelName = "tanpifKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the tanpif function");
  ...
  bool Passed =
      runTests<tanpif>(Generator, Configs, DeviceBinaryDir, IsVerbose);
