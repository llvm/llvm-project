...
///
/// \file
/// This file contains the conformance test of the sinpif function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<sinpif> {
  static constexpr llvm::StringRef Name = "sinpif";
  static constexpr llvm::StringRef KernelName = "sinpifKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the sinpif function");
  ...
  bool Passed =
      runTests<sinpif>(Generator, Configs, DeviceBinaryDir, IsVerbose);
