...
///
/// \file
/// This file contains the conformance test of the sinhf function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<sinhf> {
  static constexpr llvm::StringRef Name = "sinhf";
  static constexpr llvm::StringRef KernelName = "sinhfKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the sinhf function");
  ...
  bool Passed = runTests<sinhf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
